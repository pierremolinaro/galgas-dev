...
category_method__literalUInt64ExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_literalUInt64ExpressionAST * operand_17700,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17700 != NULL) {
    var_cas_outExpression = GGS_literalUInt64ExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mUInt64Type, operand_17700->mValue COMMA_SOURCE_FILE_AT_LINE (334)) ;
  }
}
...
category_method__literalSIntExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_literalSIntExpressionAST * operand_18117,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18117 != NULL) {
    var_cas_outExpression = GGS_literalSIntExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mSIntType, operand_18117->mValue COMMA_SOURCE_FILE_AT_LINE (344)) ;
  }
}
...
category_method__literalSInt64ExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_literalSInt64ExpressionAST * operand_18532,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18532 != NULL) {
    var_cas_outExpression = GGS_literalSInt64ExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mSInt64Type, operand_18532->mValue COMMA_SOURCE_FILE_AT_LINE (354)) ;
  }
}
...
category_method__constructorExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_constructorExpressionAST * operand_18949,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & var_cas_ioVariableMap,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18949 != NULL) {
    ...
    GGS_bool automatic_var_19221_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_19221_1 ;
    GGS_typeKindEnum automatic_var_19221_2 ;
    GGS_typedAttributeList  automatic_var_19221_3 ;
    GGS_attributeMap  automatic_var_19221_4 ;
    GGS_typedAttributeList  automatic_var_19221_5 ;
    GGS_readerMap  automatic_var_19221_6 ;
    GGS_modifierMap  automatic_var_19221_7 ;
    GGS_instanceMethodMap  automatic_var_19221_8 ;
    GGS_classMethodMap  automatic_var_19221_9 ;
    GGS_enumerationDescriptorList  automatic_var_19221_10 ;
    GGS_uint  automatic_var_19221_11 ;
    GGS_unifiedTypeMapProxyList  automatic_var_19221_12 ;
    GGS_unifiedTypeMapProxyList  automatic_var_19221_13 ;
    GGS_nativeAttributeList  automatic_var_19221_14 ;
    GGS_lstringlist  automatic_var_19221_15 ;
    GGS_typedAttributeList  automatic_var_19221_16 ;
    GGS_mapSearchMethodListAST  automatic_var_19221_17 ;
    GGS_mapSearchMethodListAST  automatic_var_19221_18 ;
    const GGS_unifiedTypeMap  temp_19184 = var_cas_inSemanticContext.mTypeMap ;
    if (temp_19184.isBuilt ()) {
      temp_19184 (HERE)->method_searchKey (inLexique, operand_18949->mTypeName, automatic_var_19221_0, automatic_var_19221_1, automatic_var_19221_2, automatic_var_19221_3, automatic_var_19221_4, automatic_var_19221_5, var_cas_constructorMap, automatic_var_19221_6, automatic_var_19221_7, automatic_var_19221_8, automatic_var_19221_9, automatic_var_19221_10, automatic_var_19221_11, automatic_var_19221_12, automatic_var_19221_13, automatic_var_19221_14, automatic_var_19221_15, automatic_var_19221_16, automatic_var_19221_17, automatic_var_19221_18 COMMA_SOURCE_FILE_AT_LINE (366)) ;
    }
    ...
    const GGS_constructorMap  temp_19405 = var_cas_constructorMap ;
    if (temp_19405.isBuilt ()) {
      temp_19405 (HERE)->method_searchKey (inLexique, operand_18949->mConstructorName, var_cas_constructorFormalArgumentTypeList, var_cas_hasCompilerArgument, var_cas_returnedType COMMA_SOURCE_FILE_AT_LINE (371)) ;
    }
    const GGS_bool cond_19891 = (operand_18949->mExpressions.reader_length ()).operator_isNotEqual (var_cas_constructorFormalArgumentTypeList.reader_length ()) ;
    if (cond_19891.isBuiltAndTrue ()) {
      operand_18949->mConstructorName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((((((GGS_string ("calling the '")).operator_concat (operand_18949->mConstructorName)).operator_concat (GGS_string ("' constructor of '@"))).operator_concat (operand_18949->mTypeName)).operator_concat (GGS_string ("' requires "))).operator_concat (var_cas_constructorFormalArgumentTypeList.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (375)))).operator_concat (GGS_string (" parameter(s), while this call has "))).operator_concat (operand_18949->mExpressions.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (376)))).operator_concat (GGS_string (" parameter(s)")) COMMA_SOURCE_FILE_AT_LINE (377)) ;
      var_cas_outExpression.drop () ;
      ...
      {
        GGS_semanticExpressionListAST::cEnumerator enumerator_20005 (operand_18949->mExpressions, true) ;
        const GGS_semanticExpressionListAST::cElement * operand_20005 = NULL ;
        GGS_unifiedTypeMapProxyList::cEnumerator enumerator_20040 (var_cas_constructorFormalArgumentTypeList, true) ;
        const GGS_unifiedTypeMapProxyList::cElement * operand_20040 = NULL ;
        while (((operand_20005 = enumerator_20005.nextObject ()))
            && ((operand_20040 = enumerator_20040.nextObject ()))) {
          macroValidPointer (operand_20005) ;
          macroValidPointer (operand_20040) ;
          GGS_semanticExpressionForGeneration  var_cas_exp ;
          const GGS_semanticExpressionAST  temp_20133 = operand_20005->mExpression ;
          if (temp_20133.isBuilt ()) {
            typeCategoryMethod__semanticExpressionAST__analyzeSemanticExpression method = findCategoryMethod__semanticExpressionAST__analyzeSemanticExpression (temp_20133.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, temp_20133 (HERE), var_cas_inSemanticContext, var_cas_ioVariableMap, var_cas_exp COMMA_SOURCE_FILE_AT_LINE (381)) ;
            }
          }
          ::routine_checkAssignmentTypes (inLexique,  operand_20040->mType,  var_cas_exp.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (382)),  operand_20005->mEndOfExpressionLocation COMMA_SOURCE_FILE_AT_LINE (382)) ;
          var_cas_constructorEffectiveParameterList.addAssign_operation (var_cas_exp) ;
        }
      }
      var_cas_outExpression = GGS_constructorExpressionForGeneration ::constructor_new (inLexique, var_cas_returnedType, operand_18949->mConstructorName, var_cas_constructorEffectiveParameterList COMMA_SOURCE_FILE_AT_LINE (385)) ;
    }
  }
}
...
category_method__readerCallExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_readerCallExpressionAST * operand_20622,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20622 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (396)) ;
...
category_method__optionExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_optionExpressionAST * operand_21082,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21082 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (407)) ;
...
category_method__concatExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_concatExpressionAST * operand_21538,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21538 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (418)) ;
...
category_method__orExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_orExpressionAST * operand_21990,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_21990 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (429)) ;
...
category_method__xorExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_xorExpressionAST * operand_22439,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22439 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (440)) ;
...
category_method__andExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_andExpressionAST * operand_22889,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22889 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (451)) ;
...
category_method__equalExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_equalExpressionAST * operand_23341,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_23341 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (462)) ;
...
category_method__notEqualExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_notEqualExpressionAST * operand_23798,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_23798 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (473)) ;
...
category_method__lowerOrEqualExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_lowerOrEqualExpressionAST * operand_24262,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24262 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (484)) ;
...
category_method__greaterOrEqualExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_greaterOrEqualExpressionAST * operand_24732,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24732 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (495)) ;
...
category_method__strictGreaterExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_strictGreaterExpressionAST * operand_25203,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25203 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (506)) ;
...
category_method__strictLowerExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_strictLowerExpressionAST * operand_25671,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25671 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (517)) ;
...
category_method__rightShiftExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_rightShiftExpressionAST * operand_26136,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_26136 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (528)) ;
...
category_method__leftShiftExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_leftShiftExpressionAST * operand_26599,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_26599 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (539)) ;
...
category_method__addExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_addExpressionAST * operand_27055,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_27055 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (550)) ;
...
category_method__subExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_subExpressionAST * operand_27505,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_27505 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (561)) ;
...
category_method__multiplicationExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_multiplicationExpressionAST * operand_27966,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_27966 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (572)) ;
...
category_method__divisionExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_divisionExpressionAST * operand_28432,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_28432 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (583)) ;
...
category_method__moduloExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_moduloExpressionAST * operand_28890,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_28890 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (594)) ;
...
category_method__unaryMinusExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_unaryMinusExpressionAST * operand_29350,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_29350 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (605)) ;
...
category_method__notExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_notExpressionAST * operand_29807,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_29807 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (616)) ;
...
category_method__negateExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_negateExpressionAST * operand_30260,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_30260 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (627)) ;
...
category_method__ifExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_ifExpressionAST * operand_30712,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_30712 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (638)) ;
...
category_method__functionCallExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_functionCallExpressionAST * operand_31170,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_31170 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (649)) ;
...
category_method__varInExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_varInExpressionAST * operand_31631,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_31631 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (660)) ;
...
category_method__literalTypeInExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_literalTypeInExpressionAST * operand_32093,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_32093 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (671)) ;
...
category_method__castInExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_castInExpressionAST * operand_32556,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_32556 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (682)) ;
...
category_method__filewrapperObjectInstanciationInExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_filewrapperObjectInstanciationInExpressionAST * operand_33038,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_33038 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (693)) ;
...
category_method__filewrapperInExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_filewrapperInExpressionAST * operand_33527,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_33527 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (704)) ;
...
category_method__filewrapperTemplateInExpressionAST__analyzeSemanticExpression (C_Compiler & inLexique,
                                const cPtr_filewrapperTemplateInExpressionAST * operand_34005,
                                const GGS_semanticContextForInstructionAnalysis  var_cas_inSemanticContext,
                                GGS_variableMap  & /* var_cas_ioVariableMap */,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_34005 != NULL) {
    var_cas_outExpression = GGS_trueExpressionForGeneration ::constructor_new (inLexique, var_cas_inSemanticContext.mBoolType COMMA_SOURCE_FILE_AT_LINE (715)) ;
