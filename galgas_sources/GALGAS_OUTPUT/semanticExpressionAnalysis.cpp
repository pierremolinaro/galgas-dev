...
static void categoryMethod_testDynamicClassInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1722)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1728)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1728)).isValid ()) {
      uint32_t variant_80891 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1728)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1728)).uintValue () ;
      bool loop_80891 = true ;
      while (loop_80891) {
        loop_80891 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1729)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1729)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1729)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1729)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1729)).isValid () ;
        if (loop_80891) {
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1775)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1775)).isValid ()) {
      uint32_t variant_82543 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1775)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1775)).uintValue () ;
      bool loop_82543 = true ;
      while (loop_82543) {
        loop_82543 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).isValid () ;
        if (loop_82543) {
          loop_82543 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).boolValue () ;
        }
        if (loop_82543 && (0 == variant_82543)) {
          loop_82543 = false ;
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstringlist joker_84224_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_84227_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_84230_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_84233_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_84224_0, joker_84227_0, joker_84230_0, joker_84233_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1822)) ;
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_84984_0 ; // Joker input parameter
  GALGAS_lstringlist joker_84987_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_84990_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_84993_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_84984_0, joker_84987_0, joker_84990_0, joker_84993_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1841)) ;
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  GALGAS_lstring joker_85156_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_85156_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1844)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_semanticExpressionListAST enumerator_85743 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_85762 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_85743.hasCurrentObject () && enumerator_85762.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_85743.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1857)) ;
      {
      routine_checkAssignmentTypes (enumerator_85762.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1858)), enumerator_85743.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1858)) ;
      }
      var_effectiveParameterList.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1859)) ;
      enumerator_85743.gotoNextObject () ;
      enumerator_85762.gotoNextObject () ;
    }
  }
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_87292_0 ; // Joker input parameter
  GALGAS_lstringlist joker_87299_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_87359_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_87292_0, joker_87299_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87359_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1893)) ;
  ...
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1903)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1903)).isValid ()) {
    uint32_t variant_87422 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1903)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1903)).uintValue () ;
    bool loop_87422 = true ;
    while (loop_87422) {
      loop_87422 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1904)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValid () ;
      if (loop_87422) {
        loop_87422 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1904)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolValue () ;
      }
      if (loop_87422 && (0 == variant_87422)) {
        loop_87422 = false ;
  ...
  if (kBoolTrue == test_6) {
    GALGAS_string joker_88250_0 ; // Joker input parameter
    GALGAS_uint joker_88265_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1923)), joker_88250_0, var_isTextFile, joker_88265_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1923)) ;
  }else if (kBoolFalse == test_6) {
...
static void categoryMethod_lexiqueIntrospectionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_terminalMap joker_89330_3 ; // Joker input parameter
  GALGAS_indexingListAST joker_89330_2 ; // Joker input parameter
  GALGAS_lstring joker_89330_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (object->mAttribute_mLexiqueComponentName, joker_89330_3, joker_89330_2, joker_89330_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1951)) ;
