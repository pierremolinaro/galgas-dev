...
void routine_analyzeConstructorInvocation (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  if (NULL != objectArray_32625) {
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_constructorMap.reader_count (SOURCE_FILE_AT_LINE (515)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
    if (test_0.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      ...
      if (GALGAS_bool (kIsStrictSup, var_constructorMap.reader_count (SOURCE_FILE_AT_LINE (531)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).isValidAndTrue ()) {
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_4 (GALGAS_bool (kIsNotEqual, constinArgument_inConstuctorEffectiveParameterExpressions.reader_length (SOURCE_FILE_AT_LINE (538)).objectCompare (var_constructorFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (538))))) ;
...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  GALGAS_string result_string ; // Returned variable
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (constinArgument_inSuperClass.reader_isNull (SOURCE_FILE_AT_LINE (782))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
                                  ...
                                  COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (constinArgument_inOperandIsHandled.operator_not (SOURCE_FILE_AT_LINE (969))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (var_ok.operator_not (SOURCE_FILE_AT_LINE (981))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_2 (constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (983)).reader_hasKey (constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (983)) COMMA_SOURCE_FILE_AT_LINE (983))) ;
      ...
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_3 (var_ok.operator_not (SOURCE_FILE_AT_LINE (1011))) ;
...
static void categoryMethod_readerCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (NULL != objectArray_36364) {
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, objectArray_36364->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ()))) ;
    if (test_0.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (GALGAS_bool (kIsEqual, var_receiverType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (615)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (615))))) ;
    if (test_2.isValidAndTrue ()) {
      //-------- @assignmentInstructionForGeneration
      ...
      while (enumerator_37023.hasCurrentObject ()) {
        ...
        if (NULL != objectArray_37363) {
          ...
          //-------- @ifInstructionForGeneration
          const GALGAS_bool test_3 (GALGAS_bool (kIsNotEqual, objectArray_37363->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ()))) ;
          if (test_3.isValidAndTrue ()) {
            //-------- @errorInstructionForGeneration
      ...
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_9 (GALGAS_bool (kIsEqual, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (654)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
      if (test_9.isValidAndTrue ()) {
        ...
        if (GALGAS_bool (kIsStrictSup, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (670)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).isValidAndTrue ()) {
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_13 (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (677)).objectCompare (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (677))))) ;
...
static void categoryMethod_thisReaderCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (ioArgument_ioVariableMap.reader_hasKey (function_selfMarkName (inCompiler COMMA_SOURCE_FILE_AT_LINE (711)) COMMA_SOURCE_FILE_AT_LINE (711))) ;
  if (test_0.isValidAndTrue ()) {
  ...
  if (NULL != objectArray_41468) {
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsEqual, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (729)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_superReaderCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (ioArgument_ioVariableMap.reader_hasKey (function_selfMarkName (inCompiler COMMA_SOURCE_FILE_AT_LINE (807)) COMMA_SOURCE_FILE_AT_LINE (807))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_thisTypeProxy ;
    { //-------- @modifierCallInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (var_thisTypeProxy.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (810)).reader_isNull (SOURCE_FILE_AT_LINE (810))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
  ...
  if (NULL != objectArray_45508) {
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_4 (GALGAS_bool (kIsEqual, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (836)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
    if (test_4.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      ...
      if (GALGAS_bool (kIsStrictSup, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (852)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).isValidAndTrue ()) {
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_8 (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (859)).objectCompare (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (859))))) ;
  if (test_8.isValidAndTrue ()) {
    ...
    inCompiler->emitSemanticError (location_9, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (860)) COMMA_SOURCE_FILE_AT_LINE (860)).operator_concat (GALGAS_string ("' reader of '@") COMMA_SOURCE_FILE_AT_LINE (860)).operator_concat (var_superTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (860)) COMMA_SOURCE_FILE_AT_LINE (860)).operator_concat (GALGAS_string ("' requires ") COMMA_SOURCE_FILE_AT_LINE (860)).operator_concat (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (861)).reader_string (SOURCE_FILE_AT_LINE (861)) COMMA_SOURCE_FILE_AT_LINE (861)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (861)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (862)).reader_string (SOURCE_FILE_AT_LINE (862)) COMMA_SOURCE_FILE_AT_LINE (862)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (862)) COMMA_SOURCE_FILE_AT_LINE (860)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
...
static void categoryMethod_optionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (var_found.operator_not (SOURCE_FILE_AT_LINE (901))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_1 (var_found.operator_not (SOURCE_FILE_AT_LINE (905))) ;
  if (test_1.isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
  ...
  if (test_2.isValidAndTrue ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_3 (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (910)).objectCompare (GALGAS_string ("value")))) ;
    if (test_3.isValidAndTrue ()) {
      //-------- @assignmentInstructionForGeneration
      ...
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_4 (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (917)).objectCompare (GALGAS_string ("char")))) ;
      if (test_4.isValidAndTrue ()) {
        //-------- @assignmentInstructionForGeneration
        ...
        //-------- @ifInstructionForGeneration
        const GALGAS_bool test_5 (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (924)).objectCompare (GALGAS_string ("string")))) ;
        if (test_5.isValidAndTrue ()) {
          //-------- @assignmentInstructionForGeneration
          ...
          //-------- @ifInstructionForGeneration
          const GALGAS_bool test_6 (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (931)).objectCompare (GALGAS_string ("comment")))) ;
...
static void categoryMethod_equalExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1167)).reader_string (SOURCE_FILE_AT_LINE (1167)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1167)).reader_string (SOURCE_FILE_AT_LINE (1167))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_notEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1199)).reader_string (SOURCE_FILE_AT_LINE (1199)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1199)).reader_string (SOURCE_FILE_AT_LINE (1199))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_lowerOrEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1231)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1231)) COMMA_SOURCE_FILE_AT_LINE (1231)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1236)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1236))))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_greaterOrEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1268)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1268)) COMMA_SOURCE_FILE_AT_LINE (1268)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1273)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1273))))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_strictGreaterExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1305)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1305)) COMMA_SOURCE_FILE_AT_LINE (1305)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1310)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1310))))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_strictLowerExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1342)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1342)) COMMA_SOURCE_FILE_AT_LINE (1342)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1347)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1347))))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_rightShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1379)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1379)) COMMA_SOURCE_FILE_AT_LINE (1379)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1384)).objectCompare (GALGAS_string ("uint")))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_leftShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1416)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1416)) COMMA_SOURCE_FILE_AT_LINE (1416)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1421)).objectCompare (GALGAS_string ("uint")))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_unaryMinusExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1609)).operator_and (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1609)) COMMA_SOURCE_FILE_AT_LINE (1609)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_notExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1636)).operator_and (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1636)) COMMA_SOURCE_FILE_AT_LINE (1636)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_structFieldAccessExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1663)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (1663))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_complementExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1689)).operator_and (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1689)) COMMA_SOURCE_FILE_AT_LINE (1689)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_ifExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_if_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1721)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1721)).objectCompare (GALGAS_string ("bool")))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_then_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1726)).objectCompare (var_else_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1726))))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_functionSignature.reader_length (SOURCE_FILE_AT_LINE (1755)).objectCompare (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1755))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1828)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1828)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (1828))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (var_found.operator_not (SOURCE_FILE_AT_LINE (1837))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_3 (GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1842)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1842)).objectCompare (GALGAS_string ("object")))) ;
    if (test_3.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
  ...
  if (test_4.isValidAndTrue ()) {
    ...
    if (NULL != objectArray_84974) {
      ...
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_5 (GALGAS_bool (kIsNotEqual, objectArray_84974->mAttribute_mArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (1854)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
      if (test_5.isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        ...
        //-------- @ifInstructionForGeneration
        const GALGAS_bool test_6 (GALGAS_bool (kIsNotEqual, objectArray_84974->mAttribute_mReturnedType.objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType))) ;
        if (test_6.isValidAndTrue ()) {
          //-------- @errorInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_7 (GALGAS_bool (kIsEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1884)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1884)).objectCompare (GALGAS_string ("object")))) ;
  if (test_7.isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1938)).objectCompare (var_templateSignature.reader_length (SOURCE_FILE_AT_LINE (1938))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (1973)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1975)).objectCompare (GALGAS_char (TO_UNICODE (47))))) ;
    if (test_2.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
  ...
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1987)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1987)).isValid ()) {
    ...
    while (loop_90766) {
      ...
      if (loop_90766) {
        ...
        //-------- @ifInstructionForGeneration
        const GALGAS_bool test_4 (var_filewrapperDirectoryMap.reader_hasKey (var_directoryName COMMA_SOURCE_FILE_AT_LINE (1992))) ;
        if (test_4.isValidAndTrue ()) {
          //-------- @methodCallInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_6 (var_filewrapperFileMap.reader_hasKey (var_fileName COMMA_SOURCE_FILE_AT_LINE (2005))) ;
  if (test_6.isValidAndTrue ()) {
    //-------- @methodCallInstructionForGeneration
