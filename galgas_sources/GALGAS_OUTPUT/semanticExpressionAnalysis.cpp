...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1712)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1712)).isValid ()) {
      PMUInt32 variant_79875 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1712)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1712)).uintValue () ;
      bool loop_79875 = true ;
      while (loop_79875) {
        loop_79875 = var_found.operator_not (SOURCE_FILE_AT_LINE (1713)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1713)).reader_isNull (SOURCE_FILE_AT_LINE (1713)).operator_not (SOURCE_FILE_AT_LINE (1713)) COMMA_SOURCE_FILE_AT_LINE (1713)).isValid () ;
        if (loop_79875) {
          loop_79875 = var_found.operator_not (SOURCE_FILE_AT_LINE (1713)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1713)).reader_isNull (SOURCE_FILE_AT_LINE (1713)).operator_not (SOURCE_FILE_AT_LINE (1713)) COMMA_SOURCE_FILE_AT_LINE (1713)).boolValue () ;
        }
        if (loop_79875 && (0 == variant_79875)) {
          loop_79875 = false ;
    ...
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1722)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1722)).objectCompare (GALGAS_string ("object"))).boolEnum () ;
    if (kBoolTrue == test_3) {
      inCompiler->emitSemanticError (var_expression.reader_mLocation (SOURCE_FILE_AT_LINE (1723)), GALGAS_string ("cast expression should be an @object or a class instance: it is an @").operator_concat (var_expression.reader_mType (SOURCE_FILE_AT_LINE (1724)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1724)) COMMA_SOURCE_FILE_AT_LINE (1724)).operator_concat (GALGAS_string (" instance") COMMA_SOURCE_FILE_AT_LINE (1724)) COMMA_SOURCE_FILE_AT_LINE (1723)) ;
    }
  }
  GALGAS_semanticExpressionForGeneration var_errorLocationExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mErrorLocationExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_errorLocationExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1728)) ;
  GALGAS_bool var_useLocationReader = GALGAS_bool (kIsNotEqual, var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1730)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType)) ;
  const enumGalgasBool test_4 = var_useLocationReader.boolEnum () ;
  if (kBoolTrue == test_4) {
    GALGAS_readerMap var_readerMap = var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1732)).reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1732)) ;
    const cMapElement_readerMap * objectArray_81028 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (GALGAS_string ("location")) ;
    if (NULL != objectArray_81028) {
        macroValidSharedObject (objectArray_81028, const cMapElement_readerMap) ;
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, objectArray_81028->mAttribute_mArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (1734)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorLocationExpression, GALGAS_string ("the error location expression type is '@").operator_concat (var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1736)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1736)) COMMA_SOURCE_FILE_AT_LINE (1736)).operator_concat (GALGAS_string ("' and defines a 'location' reader with arguments; it should be either of the '@location' type, either defines a 'location' reader without argument that"
          " returns an '@location' object") COMMA_SOURCE_FILE_AT_LINE (1737)) COMMA_SOURCE_FILE_AT_LINE (1735)) ;
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, objectArray_81028->mAttribute_mReturnedType.objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType)).boolEnum () ;
        if (kBoolTrue == test_6) {
          inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorLocationExpression, GALGAS_string ("the error location expression type is '@").operator_concat (var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1741)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1741)) COMMA_SOURCE_FILE_AT_LINE (1741)).operator_concat (GALGAS_string ("' and defines a 'location' reader that returns an '@") COMMA_SOURCE_FILE_AT_LINE (1742)).operator_concat (objectArray_81028->mAttribute_mReturnedType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1742)) COMMA_SOURCE_FILE_AT_LINE (1742)).operator_concat (GALGAS_string ("' object; it should be either of the '@location' type, either defines a 'location' reader without argument that returns an '@location' object") COMMA_SOURCE_FILE_AT_LINE (1743)) COMMA_SOURCE_FILE_AT_LINE (1740)) ;
        }
      }
      var_errorLocationExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType, object->mAttribute_mEndOfErrorLocationExpression, objectArray_81028->mAttribute_mKind, var_errorLocationExpression, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1751)), GALGAS_string ("location"), GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1753)), objectArray_81028->mAttribute_mHasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1746)) ;
    }else{
      inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorLocationExpression, GALGAS_string ("the error location expression type is '@").operator_concat (var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1758)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1758)) COMMA_SOURCE_FILE_AT_LINE (1758)).operator_concat (GALGAS_string ("' and does not define a 'location' reader; it should be either of the '@location' type, either defines a 'location' reader without argument that return"
        "s an '@location' object") COMMA_SOURCE_FILE_AT_LINE (1759)) COMMA_SOURCE_FILE_AT_LINE (1757)) ;
    }
  }
  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1764)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1764)).objectCompare (GALGAS_string ("object"))).boolEnum () ;
  if (kBoolTrue == test_7) {
    outArgument_outExpression = GALGAS_extractObjectInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mEndOfReceiverExpression, var_expression, object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1769)), var_errorLocationExpression COMMA_SOURCE_FILE_AT_LINE (1765)) ;
  }else if (kBoolFalse == test_7) {
    outArgument_outExpression = GALGAS_castInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (1775)), var_expression, object->mAttribute_mUseKindOfClass, object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1778)), var_errorLocationExpression COMMA_SOURCE_FILE_AT_LINE (1773)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstringlist joker_83648_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_83651_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_83654_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_83657_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_83648_0, joker_83651_0, joker_83654_0, joker_83657_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1793)) ;
  outArgument_outExpression = GALGAS_filewrapperInExpressionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("filewrapper"), object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1796)) COMMA_SOURCE_FILE_AT_LINE (1796)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1796)), object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1797)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1798)), var_filewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1799)) COMMA_SOURCE_FILE_AT_LINE (1795)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_84408_0 ; // Joker input parameter
  GALGAS_lstringlist joker_84411_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_84414_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_84417_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_84408_0, joker_84411_0, joker_84414_0, joker_84417_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1812)) ;
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  GALGAS_lstring joker_84580_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_84580_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1815)) ;
  GALGAS_semanticExpressionListForGeneration var_effectiveParameterList ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1818)).objectCompare (var_templateSignature.reader_length (SOURCE_FILE_AT_LINE (1818)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mFilewrapperTemplateName.reader_string (SOURCE_FILE_AT_LINE (1820)) COMMA_SOURCE_FILE_AT_LINE (1820)).operator_concat (GALGAS_string ("' template of '") COMMA_SOURCE_FILE_AT_LINE (1820)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1820)) COMMA_SOURCE_FILE_AT_LINE (1820)).operator_concat (GALGAS_string ("' filewrapper requires ") COMMA_SOURCE_FILE_AT_LINE (1820)).operator_concat (var_templateSignature.reader_length (SOURCE_FILE_AT_LINE (1821)).reader_string (SOURCE_FILE_AT_LINE (1821)) COMMA_SOURCE_FILE_AT_LINE (1821)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (1821)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1822)).reader_string (SOURCE_FILE_AT_LINE (1822)) COMMA_SOURCE_FILE_AT_LINE (1822)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (1822)) COMMA_SOURCE_FILE_AT_LINE (1819)) ;
    var_effectiveParameterList.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    var_effectiveParameterList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1825)) ;
    cEnumerator_semanticExpressionListAST enumerator_85167 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_85188 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_85167.hasCurrentObject () && enumerator_85188.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_85167.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (1828)) ;
      {
      routine_checkAssignmentTypes (enumerator_85188.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (1829)), enumerator_85167.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1829)) ;
      }
      var_effectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (1830)) ;
      enumerator_85167.gotoNextObject () ;
      enumerator_85188.gotoNextObject () ;
    }
  }
  outArgument_outExpression = GALGAS_filewrapperTemplateInExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1836)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1837)), object->mAttribute_mFilewrapperTemplateName.reader_string (SOURCE_FILE_AT_LINE (1838)), var_effectiveParameterList COMMA_SOURCE_FILE_AT_LINE (1834)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (1853)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("path is empty") COMMA_SOURCE_FILE_AT_LINE (1854)) ;
    var_directoryList.drop () ; // Release error dropped variable
    var_fileName.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1855)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the path should not begin with '/'") COMMA_SOURCE_FILE_AT_LINE (1856)) ;
      var_directoryList.drop () ; // Release error dropped variable
      var_fileName.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      var_directoryList = object->mAttribute_mFilewrapperPath.mAttribute_string.reader_componentsSeparatedByString (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1858)) ;
      {
      var_directoryList.modifier_popLast (var_fileName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1859)) ;
      }
    }
  }
  GALGAS_wrapperFileMap var_filewrapperFileMap ;
  GALGAS_wrapperDirectoryMap var_filewrapperDirectoryMap ;
  GALGAS_lstring joker_86716_0 ; // Joker input parameter
  GALGAS_lstringlist joker_86723_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_86783_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_86716_0, joker_86723_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_86783_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1864)) ;
  GALGAS_string var_builtPath = GALGAS_string::makeEmptyString () ;
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1874)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1874)).isValid ()) {
    PMUInt32 variant_86847 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1874)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1874)).uintValue () ;
    bool loop_86847 = true ;
    while (loop_86847) {
      loop_86847 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1875)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_86847) {
        loop_86847 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1875)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_86847 && (0 == variant_86847)) {
        loop_86847 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (1874)) ;
      }
      if (loop_86847) {
        variant_86847 -- ;
        GALGAS_string var_directoryName ;
        {
        var_directoryList.modifier_popFirst (var_directoryName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1877)) ;
        }
        var_builtPath.dotAssign_operation (var_directoryName.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1878)) COMMA_SOURCE_FILE_AT_LINE (1878)) ;
        const enumGalgasBool test_4 = var_filewrapperDirectoryMap.reader_hasKey (var_directoryName COMMA_SOURCE_FILE_AT_LINE (1879)).boolEnum () ;
        if (kBoolTrue == test_4) {
          GALGAS_uint joker_87252_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1881)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87252_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1880)) ;
        }else if (kBoolFalse == test_4) {
          GALGAS_location location_5 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("the '").operator_concat (var_builtPath COMMA_SOURCE_FILE_AT_LINE (1887)).operator_concat (GALGAS_string ("' path does not exists for the '") COMMA_SOURCE_FILE_AT_LINE (1887)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1887)) COMMA_SOURCE_FILE_AT_LINE (1887)).operator_concat (GALGAS_string ("' filewrapper") COMMA_SOURCE_FILE_AT_LINE (1887)) COMMA_SOURCE_FILE_AT_LINE (1887)) ;
          var_filewrapperFileMap.drop () ; // Release error dropped variable
          var_directoryList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1888)) ;
        }
      }
    }
  }
  ...
  const enumGalgasBool test_6 = var_filewrapperFileMap.reader_hasKey (var_fileName COMMA_SOURCE_FILE_AT_LINE (1893)).boolEnum () ;
  if (kBoolTrue == test_6) {
    GALGAS_string joker_87672_0 ; // Joker input parameter
    GALGAS_uint joker_87687_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1894)), joker_87672_0, var_isTextFile, joker_87687_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1894)) ;
  }else if (kBoolFalse == test_6) {
    GALGAS_location location_7 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (var_fileName COMMA_SOURCE_FILE_AT_LINE (1897)).operator_concat (GALGAS_string ("' file does not exist in the '") COMMA_SOURCE_FILE_AT_LINE (1897)).operator_concat (var_builtPath COMMA_SOURCE_FILE_AT_LINE (1897)).operator_concat (GALGAS_string ("' directory of '") COMMA_SOURCE_FILE_AT_LINE (1897)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1897)) COMMA_SOURCE_FILE_AT_LINE (1897)).operator_concat (GALGAS_string ("' filewrapper") COMMA_SOURCE_FILE_AT_LINE (1897)) COMMA_SOURCE_FILE_AT_LINE (1896)) ;
  ...
  if (kBoolTrue == test_9) {
    ...
    temp_8 = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("data"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1905)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1905)) ;
  }
  outArgument_outExpression = GALGAS_filewrapperStaticPathInExpressionForGeneration::constructor_new (temp_8, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1907)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1908)), var_fileIndex, var_isTextFile COMMA_SOURCE_FILE_AT_LINE (1902)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexiqueIntrospectionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (object->mAttribute_mLexiqueComponentName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1922)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("unknown reader") COMMA_SOURCE_FILE_AT_LINE (1927)) ;
  }
  outArgument_outExpression = GALGAS_lexiqueIntrospectionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_string ("stringlist").reader_nowhere (SOURCE_FILE_AT_LINE (1931)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1931)), object->mAttribute_mLexiqueComponentName.mAttribute_location, object->mAttribute_mLexiqueComponentName.mAttribute_string, object->mAttribute_mLexiqueReaderName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1930)) ;
}
//---------------------------------------------------------------------------*
