...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  const enumGalgasBool test_0 = constinArgument_inSuperClass.reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 759)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    constinArgument_inSuperClass.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 763)).method_searchKey (constinArgument_inReaderName, joker_44545_5, joker_44545_4, joker_44545_3, joker_44545_2, joker_44545_1, var_qualifier, joker_44560_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 763)) ;
    if (var_qualifier.isValid ()) {
      ...
      case GALGAS_methodQualifier::kEnum_isBasic: case GALGAS_methodQualifier::kEnum_isBasicFinal: case GALGAS_methodQualifier::kEnum_isOverriding: {
        result_outResult = constinArgument_inSuperClass.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 768)) ;
        } break ;
      case GALGAS_methodQualifier::kEnum_isInherited: case GALGAS_methodQualifier::kEnum_isOverridingAbstract: {
        result_outResult = function_checkReaderImplementationInSuperClasses (constinArgument_inReaderName, constinArgument_inSuperClass.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 770)), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 770)) ;
        } break ;
      }
    }
  }
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
                                  ...
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  const enumGalgasBool test_0 = constinArgument_inOperandIsHandled.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 866)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (constinArgument_inErrorLocation, GALGAS_string ("left operand type is '@").operator_concat (constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 868))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 868)).operator_concat (GALGAS_string ("' and does not accept '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 868)).operator_concat (constinArgument_inOperatorNameForErrorMessage  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 868)).operator_concat (GALGAS_string ("' operator (right operand type is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 868)).operator_concat (constinArgument_inRightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 868))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 868)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 868))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 867)) ;
  }else if (kBoolFalse == test_0) {
    ...
    if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 873)).isValid ()) {
      uint32_t variant_48715 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 873)).uintValue () ;
      bool loop_48715 = true ;
      while (loop_48715) {
        loop_48715 = var_ok.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 873)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 873)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 873)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 873)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 873)).isValid () ;
        if (loop_48715) {
          loop_48715 = var_ok.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 873)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 873)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 873)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 873)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 873)).boolValue () ;
        }
        if (loop_48715 && (0 == variant_48715)) {
          loop_48715 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 873)) ;
        }
        if (loop_48715) {
          variant_48715 -- ;
          var_rightType = var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 874)) ;
          var_ok = GALGAS_bool (kIsEqual, constinArgument_inLeftType.objectCompare (var_rightType)) ;
        }
      }
    }
    const enumGalgasBool test_1 = var_ok.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 878)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 880)).reader_hasKey (constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 880)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 880)).boolEnum () ;
      if (kBoolTrue == test_2) {
        ...
        GALGAS_location joker_49294_0 ; // Joker input parameter
        GALGAS_methodQualifier joker_49362_2 ; // Joker input parameter
        GALGAS_string joker_49362_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 884)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 885)), var_kind, var_argumentTypeList, joker_49294_0, var_hasCompilerArgument, var_returnedType, joker_49362_2, joker_49362_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 884)) ;
        var_ok = GALGAS_bool (kIsEqual, var_argumentTypeList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 893)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsEqual, var_returnedType.objectCompare (constinArgument_inLeftType)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 893)) ;
        GALGAS_semanticExpressionForGeneration var_conversionExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (constinArgument_inLeftType, constinArgument_inErrorLocation, var_kind, ioArgument_ioRightExpression, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 900)), constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 901)), GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 902)), var_hasCompilerArgument  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 895)) ;
        ioArgument_ioRightExpression = var_conversionExpression ;
      }
      const enumGalgasBool test_3 = var_ok.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 907)).boolEnum () ;
      if (kBoolTrue == test_3) {
        inCompiler->emitSemanticError (constinArgument_inErrorLocation, GALGAS_string ("left operand type of '").operator_concat (constinArgument_inOperatorNameForErrorMessage  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 909)).operator_concat (GALGAS_string ("' operator is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 909)).operator_concat (constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 909))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 909)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 909)).operator_concat (constinArgument_inRightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 910))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 910)).operator_concat (GALGAS_string ("', it should be either the same, either inherits from left operand type, either have a '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 910)).operator_concat (constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 912))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 911)).operator_concat (GALGAS_string ("' reader without argument that returns a '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 912)).operator_concat (constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 912))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 912)).operator_concat (GALGAS_string ("' object")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 912))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 908)) ;
      }
    }
  }
}
...
static void categoryMethod_constructorExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool var_hasCompilerArgument ;
  {
  routine_analyzeConstructorInvocation (constinArgument_inAnalysisContext, ioArgument_ioVariableMap, object->mAttribute_mTypeName, object->mAttribute_mConstructorName, object->mAttribute_mExpressions, var_returnedType, var_constructorType, var_constructorEffectiveParameterList, var_hasCompilerArgument, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 616)) ;
  }
  outArgument_outExpression = GALGAS_constructorExpressionForGeneration::constructor_new (var_returnedType, object->mAttribute_mConstructorName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 630)), var_constructorType, object->mAttribute_mConstructorName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 632)), var_constructorEffectiveParameterList, var_hasCompilerArgument  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 628)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_readerCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mReceiver.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_receiverExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 647)) ;
  GALGAS_unifiedTypeMapProxy var_receiverType = var_receiverExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 648)) ;
  GALGAS_readerMap var_readerMap = var_receiverType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 650)) ;
  GALGAS_unifiedTypeMapProxyAndParameterList var_readerFormalArgumentTypeList ;
  GALGAS_methodKind var_kind ;
  GALGAS_bool var_hasCompilerArgument ;
  GALGAS_unifiedTypeMapProxy var_returnedType ;
  GALGAS_stringlist var_fieldList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 656)) ;
  const cMapElement_readerMap * objectArray_40079 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 657))) ;
  if (NULL != objectArray_40079) {
    ...
    if (kBoolTrue == test_0) {
      ...
      inCompiler->emitSemanticError (location_1, objectArray_40079->mAttribute_mErrorMessage  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 663)) ;
    }
  }else{
    GALGAS_uint var_matchingReaderCount = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_receiverType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 667)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 667)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      var_readerFormalArgumentTypeList = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 668)) ;
      var_hasCompilerArgument = GALGAS_bool (true) ;
      var_returnedType = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 670)) ;
      var_kind = GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 671)) ;
      cEnumerator_typedAttributeList enumerator_40766 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 672)), kEnumeration_up) ;
      while (enumerator_40766.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_attributeType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (enumerator_40766.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 673)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 673)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 673)) ;
        GALGAS_readerMap var_aMap = var_attributeType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 674)) ;
        const cMapElement_readerMap * objectArray_40995 = (const cMapElement_readerMap *) var_aMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 675))) ;
        if (NULL != objectArray_40995) {
            macroValidSharedObject (objectArray_40995, cMapElement_readerMap) ;
          var_matchingReaderCount.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 676)) ;
          ...
          var_fieldList.addAssign_operation (enumerator_40766.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 681))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 681)) ;
          ...
          if (kBoolTrue == test_3) {
            ...
            inCompiler->emitSemanticError (location_4, objectArray_40995->mAttribute_mErrorMessage  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 683)) ;
          }
        }
      ...
      if (kBoolTrue == test_5) {
        ...
        inCompiler->emitSemanticError (location_6, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 689))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 689)).operator_concat (GALGAS_string ("' struct type does not define the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 689)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 689))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 689)).operator_concat (GALGAS_string ("' reader, and none of its fields defines it")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 689))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 688)) ;
        ...
        if (kBoolTrue == test_7) {
          ...
          while (enumerator_41853.hasCurrentObject ()) {
            var_s.dotAssign_operation (enumerator_41853.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 696)) ;
            if (enumerator_41853.hasNextObject ()) {
              var_s.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 697)) ;
            }
          ...
          inCompiler->emitSemanticError (location_8, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 700))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 700)).operator_concat (GALGAS_string ("' struct type does not define the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 700)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 700))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 700)).operator_concat (GALGAS_string ("' reader, and several of its fields defines it:")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 700)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 701)).operator_concat (GALGAS_string (" (exactly one field should define it)")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 701))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 699)) ;
          var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
          var_hasCompilerArgument.drop () ; // Release error dropped variable
          var_returnedType.drop () ; // Release error dropped variable
          var_kind.drop () ; // Release error dropped variable
      ...
      const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, var_readerMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 705)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_9) {
        GALGAS_location location_10 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_10, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 707))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 707)).operator_concat (GALGAS_string ("' type does not define any reader")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 707))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 706)) ;
        var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
        var_hasCompilerArgument.drop () ; // Release error dropped variable
        var_returnedType.drop () ; // Release error dropped variable
        var_kind.drop () ; // Release error dropped variable
        ...
        while (enumerator_42551.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_42551.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 713))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 713))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 713)) ;
          ...
          while (enumerator_42619.hasCurrentObject ()) {
            var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_42619.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 715))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 715))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 715)) ;
            enumerator_42619.gotoNextObject () ;
          }
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_42551.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 717))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 717))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 717)) ;
          enumerator_42551.gotoNextObject () ;
        }
        GALGAS_string temp_11 ;
        const enumGalgasBool test_12 = GALGAS_bool (kIsStrictSup, var_readerMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 721)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
        ...
        inCompiler->emitSemanticError (location_13, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 720))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 720)).operator_concat (GALGAS_string ("' type does not define the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 720)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 720))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 720)).operator_concat (GALGAS_string ("' reader; available ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 720)).operator_concat (temp_11  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 720)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 721)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 722))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 719)) ;
        var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
        var_hasCompilerArgument.drop () ; // Release error dropped variable
        var_returnedType.drop () ; // Release error dropped variable
        var_kind.drop () ; // Release error dropped variable
  ...
  const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 728)).objectCompare (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 728)))).boolEnum () ;
  if (kBoolTrue == test_14) {
    GALGAS_location location_15 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_15, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 729))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 729)).operator_concat (GALGAS_string ("' reader of '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 729)).operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 729))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 729)).operator_concat (GALGAS_string ("' requires ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 729)).operator_concat (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 730)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 730))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 729)).operator_concat (GALGAS_string (" parameter(s), while this call has ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 730)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 731)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 731))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 730)).operator_concat (GALGAS_string (" parameter(s)")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 731))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 729)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_14) {
    GALGAS_semanticExpressionListForGeneration var_constructorEffectiveParameterList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 733)) ;
    ...
    while (enumerator_43573.hasCurrentObject () && enumerator_43603.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_43573.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 736)) ;
      {
      routine_checkAssignmentTypes (enumerator_43603.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 737)), enumerator_43573.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 737)) ;
      }
      var_constructorEffectiveParameterList.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 738)) ;
      enumerator_43573.gotoNextObject () ;
      enumerator_43603.gotoNextObject () ;
    }
    outArgument_outExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (var_returnedType, object->mAttribute_mReaderName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 742)), var_kind, var_receiverExpression, var_fieldList, object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 746)), var_constructorEffectiveParameterList, var_hasCompilerArgument  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 740)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_optionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mOptionComponentMapForSemanticAnalysis.method_searchKey (object->mAttribute_mOptionComponentName, var_optionComponentIsPredefined, var_boolOptionMap, var_uintOptionMap, var_stringOptionMap, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 785)) ;
  GALGAS_bool var_found = var_boolOptionMap.reader_hasKey (object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 792)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 792)) ;
  ...
  const enumGalgasBool test_0 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 794)).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_found = var_uintOptionMap.reader_hasKey (object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 795)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 795)) ;
    var_returnedType = constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType ;
  }
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 798)).boolEnum () ;
  if (kBoolTrue == test_1) {
    var_found = var_stringOptionMap.reader_hasKey (object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 799)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 799)) ;
  ...
  if (kBoolTrue == test_2) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 803)).objectCompare (GALGAS_string ("value"))).boolEnum () ;
    if (kBoolTrue == test_3) {
      outArgument_outExpression = GALGAS_optionValueExpressionForGeneration::constructor_new (var_returnedType, object->mAttribute_mOptionComponentName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 806)), var_optionComponentIsPredefined, object->mAttribute_mOptionComponentName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 808)), object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 809))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 804)) ;
    }else if (kBoolFalse == test_3) {
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 811)).objectCompare (GALGAS_string ("char"))).boolEnum () ;
      if (kBoolTrue == test_4) {
        outArgument_outExpression = GALGAS_optionCharExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mCharType, object->mAttribute_mOptionComponentName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 814)), var_optionComponentIsPredefined, object->mAttribute_mOptionComponentName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 816)), object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 817))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 812)) ;
      }else if (kBoolFalse == test_4) {
        const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 819)).objectCompare (GALGAS_string ("string"))).boolEnum () ;
        if (kBoolTrue == test_5) {
          outArgument_outExpression = GALGAS_optionStringExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType, object->mAttribute_mOptionComponentName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 822)), var_optionComponentIsPredefined, object->mAttribute_mOptionComponentName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 824)), object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 825))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 820)) ;
        }else if (kBoolFalse == test_5) {
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 827)).objectCompare (GALGAS_string ("comment"))).boolEnum () ;
          if (kBoolTrue == test_6) {
            outArgument_outExpression = GALGAS_optionCommentExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType, object->mAttribute_mOptionComponentName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 830)), var_optionComponentIsPredefined, object->mAttribute_mOptionComponentName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 832)), object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 833))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 828)) ;
          }else if (kBoolFalse == test_6) {
            GALGAS_location location_7 (object->mAttribute_mOptionReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_7, GALGAS_string ("only the 'value', 'char', 'string' and 'comment' readers are defined for an option")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 836)) ;
            outArgument_outExpression.drop () ; // Release error dropped variable
          }
        }
      }
    ...
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_commandLineOptionMap enumerator_47542 (var_boolOptionMap, kEnumeration_up) ;
    while (enumerator_47542.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47542.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 841))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 841)).operator_concat (GALGAS_string ("' @bool option;")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 841))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 841)) ;
      enumerator_47542.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_47638 (var_uintOptionMap, kEnumeration_up) ;
    while (enumerator_47638.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47638.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 844))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 844)).operator_concat (GALGAS_string ("' @uint option;")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 844))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 844)) ;
      enumerator_47638.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_47736 (var_stringOptionMap, kEnumeration_up) ;
    while (enumerator_47736.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47736.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 847))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 847)).operator_concat (GALGAS_string ("' @string option;")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 847))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 847)) ;
    ...
    inCompiler->emitSemanticError (location_8, GALGAS_string ("the '").operator_concat (object->mAttribute_mOptionComponentName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 850))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 850)).operator_concat (GALGAS_string ("' option component does not define the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 850)).operator_concat (object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 850))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 850)).operator_concat (GALGAS_string ("' option; available options:")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 850)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 850))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 849)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_concatExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 928)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 931)) ;
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 933)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 936)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 937)).operator_and (function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 937)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 937)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("."), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 934)) ;
  }
  outArgument_outExpression = GALGAS_concatExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 943)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_orExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 960)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 963)) ;
...
static void categoryMethod_andExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 992)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 995)) ;
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 997)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1000)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1001)).operator_and (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1001)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1001)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("&"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 998)) ;
  }
  outArgument_outExpression = GALGAS_andExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1007)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_xorExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1024)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1027)) ;
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1029)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1032)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1033)).operator_and (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1033)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1033)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("^"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1030)) ;
  }
  outArgument_outExpression = GALGAS_xorExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1039)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_equalExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1056)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1059)) ;
  ...
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1062)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1063)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1063)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1063)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1063)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1065)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1065))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1065)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1065)).operator_concat (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1065)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1065))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1065)).operator_concat (GALGAS_string ("': '==' operator requires the types are the same")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1065))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1064)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    outArgument_outExpression = GALGAS_equalExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1070)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_notEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1088)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1091)) ;
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1093)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1094)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1095)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1095)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1095)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1095)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1097))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1097)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1097)).operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1097))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1097)).operator_concat (GALGAS_string ("': '!=' operator requires the types are the same")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1097))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1096)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    outArgument_outExpression = GALGAS_notEqualExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1102)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_lowerOrEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1120)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1123)) ;
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1125)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1126)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1127)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1127)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1127)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1129))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1129)).operator_concat (GALGAS_string ("' and does not support the '<=' operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1129))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1128)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1132)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1132)))).boolEnum () ;
    if (kBoolTrue == test_1) {
...
static void categoryMethod_greaterOrEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1157)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1160)) ;
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1162)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1163)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1164)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1164)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1164)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1166))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1166)).operator_concat (GALGAS_string ("' and does not support the '>=' operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1166))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1165)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1169)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1169)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1171))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1171)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1171)).operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1171))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1171)).operator_concat (GALGAS_string ("': '>=' operator requires the types are the same")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1171))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1170)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_greaterOrEqualExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1176)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_strictGreaterExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1194)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1197)) ;
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1199)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1200)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1201)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1201)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1201)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1203))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1203)).operator_concat (GALGAS_string ("' and does not support the '>' operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1203))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1202)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1206)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1206)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1208))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1208)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1208)).operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1208))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1208)).operator_concat (GALGAS_string ("': '>' operator requires the types are the same")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1208))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1207)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_strictGreaterExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1213)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_strictLowerExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1231)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1234)) ;
...
static void categoryMethod_rightShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1268)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1271)) ;
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1273)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1274)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1275)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1275)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1275)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1277))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1277)).operator_concat (GALGAS_string ("' and does not support a shift operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1277))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1276)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1280)).objectCompare (GALGAS_string ("uint"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("for a shift operator, right operand type should be '@uint': it is '@").operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1282))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1282)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1282))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1281)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_rightShiftExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1287)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_leftShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1305)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1308)) ;
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1310)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1311)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1312)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1312)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1312)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1314))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1314)).operator_concat (GALGAS_string ("' and does not support a shift operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1314))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1313)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1317)).objectCompare (GALGAS_string ("uint"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("for a shift operator, right operand type should be '@uint': it is '@").operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1319))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1319)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1319))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1318)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_leftShiftExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1324)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_addExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1342)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1345)) ;
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1347)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1350)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1351)).operator_and (function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1351)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1351)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("+"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1348)) ;
  }
  outArgument_outExpression = GALGAS_addExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1357)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_subExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1374)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1377)) ;
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1379)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1382)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1383)).operator_and (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1383)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1383)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("-"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1380)) ;
  }
  outArgument_outExpression = GALGAS_subExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1389)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_multiplicationExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1406)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1409)) ;
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1411)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1414)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1415)).operator_and (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1415)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1415)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("*"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1412)) ;
  }
  outArgument_outExpression = GALGAS_multiplicationExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1421)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_divisionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1438)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1441)) ;
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1443)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1446)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1447)).operator_and (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1447)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1447)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("/"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1444)) ;
  }
  outArgument_outExpression = GALGAS_divisionExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1453)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_moduloExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1470)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1473)) ;
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1475)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1478)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1479)).operator_and (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1479)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1479)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("mod"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1476)) ;
  }
  outArgument_outExpression = GALGAS_moduloExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1485)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_unaryMinusExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1502)) ;
  GALGAS_unifiedTypeMapProxy var_type = var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1504)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1505)).operator_and (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1505)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1505)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("operand type is '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1507))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1507)).operator_concat (GALGAS_string ("' and does not support the unary minus operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1507))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1506)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    outArgument_outExpression = GALGAS_unaryMinusExpressionForGeneration::constructor_new (var_type, object->mAttribute_mOperatorLocation, var_expression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1512)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_notExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1529)) ;
  GALGAS_unifiedTypeMapProxy var_type = var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1531)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1532)).operator_and (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1532)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1532)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("operand type is '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1534))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1534)).operator_concat (GALGAS_string ("' and does not support the 'not' operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1534))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1533)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    outArgument_outExpression = GALGAS_notExpressionForGeneration::constructor_new (var_type, object->mAttribute_mOperatorLocation, var_expression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1539)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structFieldAccessExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1556)) ;
  GALGAS_unifiedTypeMapProxy var_type = var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1558)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1559)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1559)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mStructFieldName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '->' operator requires the receiver to be a struct")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1560)) ;
  }
  GALGAS_attributeMap var_attributeMap = var_type.reader_mAttributeMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1562)) ;
  var_attributeMap.method_searchKey (object->mAttribute_mStructFieldName, var_type, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1563)) ;
  outArgument_outExpression = GALGAS_structFieldAccessExpressionForGeneration::constructor_new (var_type, object->mAttribute_mOperatorLocation, var_expression, object->mAttribute_mStructFieldName.mAttribute_string  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1565)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_complementExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1582)) ;
  GALGAS_unifiedTypeMapProxy var_type = var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1584)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1585)).operator_and (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1585)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1585)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("operand type is '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1587))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1587)).operator_concat (GALGAS_string ("' and does not support the '~' operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1587))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1586)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    outArgument_outExpression = GALGAS_tildeExpressionForGeneration::constructor_new (var_type, object->mAttribute_mOperatorLocation, var_expression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1592)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_ifExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mIfExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_if_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1609)) ;
  GALGAS_semanticExpressionForGeneration var_then_5F_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mThenExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_then_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1612)) ;
  GALGAS_semanticExpressionForGeneration var_else_5F_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mElseExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_else_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1615)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_if_5F_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1617)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1617)).objectCompare (GALGAS_string ("bool"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("the test expression type is '@").operator_concat (var_if_5F_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1619)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1619))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1619)).operator_concat (GALGAS_string ("', it should be '@bool'")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1619))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1618)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_then_5F_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1622)).objectCompare (var_else_5F_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1622)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("operand expression types are '@").operator_concat (var_then_5F_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1624)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1624))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1624)).operator_concat (GALGAS_string ("' and '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1624)).operator_concat (var_else_5F_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1624)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1624))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1624)).operator_concat (GALGAS_string ("': they should be the same")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1624))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1623)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_ifExpressionForGeneration::constructor_new (var_then_5F_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1630)), object->mAttribute_mOperatorLocation, var_if_5F_expression, var_then_5F_expression, var_else_5F_expression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1629)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFunctionMap.method_searchKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultType, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1649)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_functionSignature.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1651)).objectCompare (object->mAttribute_mExpressions.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1651)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mFunctionName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mFunctionName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1653))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1653)).operator_concat (GALGAS_string ("' function header declares ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1653)).operator_concat (var_functionSignature.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1653)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1653))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1653)).operator_concat (GALGAS_string (" formal parameter(s), but this function call names ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1653)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1654)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1654))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1654)).operator_concat (GALGAS_string (" effective argument(s)")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1654))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1652)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    GALGAS_semanticExpressionListForGeneration var_semanticExpressionListForGeneration = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1659)) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_78154 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_semanticExpressionListAST enumerator_78168 (object->mAttribute_mExpressions, kEnumeration_up) ;
    while (enumerator_78154.hasCurrentObject () && enumerator_78168.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_expression ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_78168.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1662)) ;
      {
      routine_checkAssignmentTypes (enumerator_78154.current_mType (HERE), var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1663)), enumerator_78168.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1663)) ;
      }
      var_semanticExpressionListForGeneration.addAssign_operation (var_expression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1664)) ;
      enumerator_78154.gotoNextObject () ;
      enumerator_78168.gotoNextObject () ;
    }
    outArgument_outExpression = GALGAS_functionCallExpressionForGeneration::constructor_new (var_resultType, object->mAttribute_mFunctionName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1668)), object->mAttribute_mFunctionName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1669)), var_semanticExpressionListForGeneration  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1666)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_varInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  {
  ioArgument_ioVariableMap.modifier_searchForReadAccess (object->mAttribute_mVarName, var_type, var_sourceVariableCppName, var_nameForCheckingFormalParameterUsing, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1685)) ;
  }
  outArgument_outExpression = GALGAS_varInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mVarName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1688)), var_sourceVariableCppName, var_nameForCheckingFormalParameterUsing  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1686)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool joker_79769_28 ; // Joker input parameter
  GALGAS_bool joker_79769_27 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_79769_26 ; // Joker input parameter
  GALGAS_typeKindEnum joker_79769_25 ; // Joker input parameter
  GALGAS_typedAttributeList joker_79769_24 ; // Joker input parameter
  GALGAS_attributeMap joker_79769_23 ; // Joker input parameter
  GALGAS_typedAttributeList joker_79769_22 ; // Joker input parameter
  GALGAS_constructorMap joker_79769_21 ; // Joker input parameter
  GALGAS_readerMap joker_79769_20 ; // Joker input parameter
  GALGAS_modifierMap joker_79769_19 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_79769_18 ; // Joker input parameter
  GALGAS_classMethodMap joker_79769_17 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_79769_16 ; // Joker input parameter
  GALGAS_stringlist joker_79769_15 ; // Joker input parameter
  GALGAS_uint joker_79769_14 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_79769_13 ; // Joker input parameter
  GALGAS_stringset joker_79769_12 ; // Joker input parameter
  GALGAS_lstringlist joker_79769_11 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_79769_10 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_79769_9 ; // Joker input parameter
  GALGAS_withAccessorMap joker_79769_8 ; // Joker input parameter
  GALGAS_bool joker_79769_7 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_79769_6 ; // Joker input parameter
  GALGAS_string joker_79769_5 ; // Joker input parameter
  GALGAS_string joker_79769_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_79769_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_79769_2 ; // Joker input parameter
  GALGAS_stringlist joker_79769_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_79769_28, joker_79769_27, joker_79769_26, joker_79769_25, joker_79769_24, joker_79769_23, joker_79769_22, joker_79769_21, joker_79769_20, joker_79769_19, joker_79769_18, joker_79769_17, joker_79769_16, joker_79769_15, joker_79769_14, joker_79769_13, joker_79769_12, joker_79769_11, joker_79769_10, joker_79769_9, joker_79769_8, joker_79769_7, joker_79769_6, joker_79769_5, joker_79769_4, joker_79769_3, joker_79769_2, joker_79769_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1702)) ;
  outArgument_outExpression = GALGAS_literalTypeInExpressionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("type"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1705)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1705)), object->mAttribute_mLiteralTypeName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1706)), object->mAttribute_mLiteralTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1707))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1704)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_testDynamicClassInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mReceiverExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1720)) ;
  GALGAS_unifiedTypeMapProxy var_castType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1722)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1724)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1724)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1724)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_unifiedTypeMapProxy var_t = var_castType ;
    GALGAS_bool var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1727)))) ;
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1728)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1728)).isValid ()) {
      uint32_t variant_80899 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1728)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1728)).uintValue () ;
      bool loop_80899 = true ;
      while (loop_80899) {
        loop_80899 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1729)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1729)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1729)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1729)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1729)).isValid () ;
        if (loop_80899) {
          loop_80899 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1729)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1729)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1729)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1729)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1729)).boolValue () ;
        }
        if (loop_80899 && (0 == variant_80899)) {
          loop_80899 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1728)) ;
        }
        if (loop_80899) {
          variant_80899 -- ;
          var_t = var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1730)) ;
          var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1731)))) ;
        }
      }
    }
    const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1733)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1735))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1735)).operator_concat (GALGAS_string ("' is not a descendant of the '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1735)).operator_concat (var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1735)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1735))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1735)).operator_concat (GALGAS_string ("' type of the cast expression")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1735))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1734)) ;
    }
  }else if (kBoolFalse == test_0) {
    inCompiler->emitSemanticError (var_expression.reader_mLocation (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1739)), GALGAS_string ("expression should be a class instance: it is an @").operator_concat (var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1740)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1740))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1739)).operator_concat (GALGAS_string (" instance")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1740))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1739)) ;
  }
  outArgument_outExpression = GALGAS_testDynamicClassInExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1745)), var_expression, object->mAttribute_mTypeComparisonKind, var_castType  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1743)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mReceiverExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1760)) ;
  GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1766)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1771)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1771)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1771)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_unifiedTypeMapProxy var_t = var_type ;
    GALGAS_bool var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1774)))) ;
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1775)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1775)).isValid ()) {
      uint32_t variant_82541 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1775)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1775)).uintValue () ;
      bool loop_82541 = true ;
      while (loop_82541) {
        loop_82541 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).isValid () ;
        if (loop_82541) {
          loop_82541 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1776)).boolValue () ;
        }
        if (loop_82541 && (0 == variant_82541)) {
          loop_82541 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1775)) ;
        }
        if (loop_82541) {
          variant_82541 -- ;
          var_t = var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1777)) ;
          var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1778)))) ;
        }
      }
    }
    const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1780)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1782))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1782)).operator_concat (GALGAS_string ("' is not a descendant of the '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1782)).operator_concat (var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1783)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1783))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1782)).operator_concat (GALGAS_string ("' type of the cast expression")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1783))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1781)) ;
    }
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1786)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1786)).objectCompare (GALGAS_string ("object"))).boolEnum () ;
    if (kBoolTrue == test_3) {
      inCompiler->emitSemanticError (var_expression.reader_mLocation (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1791)), GALGAS_string ("cast expression should be a class instance or an @object instance: it is an @").operator_concat (var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1793)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1793))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1792)).operator_concat (GALGAS_string (" instance")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1793))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1791)) ;
    }
  }
  const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1796)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1796)).objectCompare (GALGAS_string ("object"))).boolEnum () ;
  if (kBoolTrue == test_4) {
    outArgument_outExpression = GALGAS_extractObjectInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mEndOfReceiverExpression, var_expression, object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1801))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1797)) ;
  }else if (kBoolFalse == test_4) {
    outArgument_outExpression = GALGAS_castInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1806)), var_expression, object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1808))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1804)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstringlist joker_84222_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_84225_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_84228_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_84231_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_84222_0, joker_84225_0, joker_84228_0, joker_84231_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1822)) ;
  outArgument_outExpression = GALGAS_filewrapperInExpressionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("filewrapper"), object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1825))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1825)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1825)), object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1826)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1827)), var_filewrapperPath.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1828))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1824)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_84982_0 ; // Joker input parameter
  GALGAS_lstringlist joker_84985_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_84988_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_84991_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_84982_0, joker_84985_0, joker_84988_0, joker_84991_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1841)) ;
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  GALGAS_lstring joker_85154_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_85154_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1844)) ;
  GALGAS_semanticExpressionListForGeneration var_effectiveParameterList ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1847)).objectCompare (var_templateSignature.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1847)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mFilewrapperTemplateName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1849))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1849)).operator_concat (GALGAS_string ("' template of '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1849)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1849))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1849)).operator_concat (GALGAS_string ("' filewrapper requires ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1849)).operator_concat (var_templateSignature.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1850)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1850))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1849)).operator_concat (GALGAS_string (" parameter(s), while this call has ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1850)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1851)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1851))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1850)).operator_concat (GALGAS_string (" parameter(s)")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1851))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1848)) ;
    var_effectiveParameterList.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    var_effectiveParameterList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)) ;
    cEnumerator_semanticExpressionListAST enumerator_85741 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_85760 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_85741.hasCurrentObject () && enumerator_85760.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_85741.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1857)) ;
      {
      routine_checkAssignmentTypes (enumerator_85760.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1858)), enumerator_85741.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1858)) ;
      }
      var_effectiveParameterList.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1859)) ;
      enumerator_85741.gotoNextObject () ;
      enumerator_85760.gotoNextObject () ;
    }
  }
  outArgument_outExpression = GALGAS_filewrapperTemplateInExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1865)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1866)), object->mAttribute_mFilewrapperTemplateName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1867)), var_effectiveParameterList  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1863)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1882)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("path is empty")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1883)) ;
    var_directoryList.drop () ; // Release error dropped variable
    var_fileName.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_firstCharacterOrNul (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1884)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the path should not begin with '/'")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1885)) ;
      var_directoryList.drop () ; // Release error dropped variable
      var_fileName.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      var_directoryList = object->mAttribute_mFilewrapperPath.mAttribute_string.reader_componentsSeparatedByString (GALGAS_string ("/") COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1887)) ;
      {
      var_directoryList.modifier_popLast (var_fileName, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1888)) ;
      }
    }
  }
  GALGAS_wrapperFileMap var_filewrapperFileMap ;
  GALGAS_wrapperDirectoryMap var_filewrapperDirectoryMap ;
  GALGAS_lstring joker_87290_0 ; // Joker input parameter
  GALGAS_lstringlist joker_87297_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_87357_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_87290_0, joker_87297_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87357_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1893)) ;
  GALGAS_string var_builtPath = GALGAS_string::makeEmptyString () ;
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1903)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1903)).isValid ()) {
    uint32_t variant_87420 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1903)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1903)).uintValue () ;
    bool loop_87420 = true ;
    while (loop_87420) {
      loop_87420 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1904)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValid () ;
      if (loop_87420) {
        loop_87420 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1904)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolValue () ;
      }
      if (loop_87420 && (0 == variant_87420)) {
        loop_87420 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1903)) ;
      }
      if (loop_87420) {
        variant_87420 -- ;
        GALGAS_string var_directoryName ;
        {
        var_directoryList.modifier_popFirst (var_directoryName, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1906)) ;
        }
        var_builtPath.dotAssign_operation (var_directoryName.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1907))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1907)) ;
        const enumGalgasBool test_4 = var_filewrapperDirectoryMap.reader_hasKey (var_directoryName COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1908)).boolEnum () ;
        if (kBoolTrue == test_4) {
          GALGAS_uint joker_87828_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1910)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87828_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1909)) ;
        }else if (kBoolFalse == test_4) {
          GALGAS_location location_5 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("the '").operator_concat (var_builtPath  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1916)).operator_concat (GALGAS_string ("' path does not exists for the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1916)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1916))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1916)).operator_concat (GALGAS_string ("' filewrapper")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1916))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1916)) ;
          var_filewrapperFileMap.drop () ; // Release error dropped variable
          var_directoryList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1917)) ;
        }
      }
    }
  }
  ...
  const enumGalgasBool test_6 = var_filewrapperFileMap.reader_hasKey (var_fileName COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1922)).boolEnum () ;
  if (kBoolTrue == test_6) {
    GALGAS_string joker_88248_0 ; // Joker input parameter
    GALGAS_uint joker_88263_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1923)), joker_88248_0, var_isTextFile, joker_88263_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1923)) ;
  }else if (kBoolFalse == test_6) {
    GALGAS_location location_7 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (var_fileName  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1926)).operator_concat (GALGAS_string ("' file does not exist in the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1926)).operator_concat (var_builtPath  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1926)).operator_concat (GALGAS_string ("' directory of '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1926)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1926))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1926)).operator_concat (GALGAS_string ("' filewrapper")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1926))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1925)) ;
  ...
  if (kBoolTrue == test_9) {
    ...
    temp_8 = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("data"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1934)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1934)) ;
  }
  outArgument_outExpression = GALGAS_filewrapperStaticPathInExpressionForGeneration::constructor_new (temp_8, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1936)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1937)), var_fileIndex, var_isTextFile  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1931)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_lexiqueIntrospectionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_terminalMap joker_89328_3 ; // Joker input parameter
  GALGAS_indexingListAST joker_89328_2 ; // Joker input parameter
  GALGAS_lstring joker_89328_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (object->mAttribute_mLexiqueComponentName, joker_89328_3, joker_89328_2, joker_89328_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1951)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("unknown reader")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1957)) ;
  }
  outArgument_outExpression = GALGAS_lexiqueIntrospectionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_string ("stringlist").reader_nowhere (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1961)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1961)), object->mAttribute_mLexiqueComponentName.mAttribute_location, object->mAttribute_mLexiqueComponentName.mAttribute_string, object->mAttribute_mLexiqueReaderName.mAttribute_string  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1960)) ;
}
//-----------------------------------------------------------------------------*
