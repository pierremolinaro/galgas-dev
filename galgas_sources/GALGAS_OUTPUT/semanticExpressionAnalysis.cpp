...
void routine_analyzeConstructorInvocation (const GALGAS_unifiedTypeMap_2D_proxy constinArgument_inType,
  ...
  if (kBoolTrue == test_0) {
    outArgument_outConstructorType = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, constinArgument_inTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 556)) ;
  }
  const enumGalgasBool test_1 = outArgument_outConstructorType.reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 558)).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_location location_2 (constinArgument_inTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("cannot infer type")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 559)) ;
    ...
    GALGAS_constructorMap var_constructorMap = outArgument_outConstructorType.reader_mConstructorMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 562)) ;
    GALGAS_functionSignature var_constructorFormalArgumentTypeList ;
    const cMapElement_constructorMap * objectArray_36327 = (const cMapElement_constructorMap *) var_constructorMap.readAccessForWithInstruction (constinArgument_inConstructorName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 565))) ;
    if (NULL != objectArray_36327) {
        macroValidSharedObject (objectArray_36327, cMapElement_constructorMap) ;
      var_constructorFormalArgumentTypeList = objectArray_36327->mAttribute_mArgumentTypeList ;
      outArgument_outHasCompilerArgument = objectArray_36327->mAttribute_mHasCompilerArgument ;
      outArgument_outReturnedType = objectArray_36327->mAttribute_mReturnedType ;
    }else{
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_constructorMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 570)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (constinArgument_inConstructorName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the '@").operator_concat (outArgument_outConstructorType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 572))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 572)).operator_concat (GALGAS_string ("' type does not define any constructor")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 572))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 571)) ;
        var_constructorFormalArgumentTypeList.drop () ; // Release error dropped variable
        outArgument_outHasCompilerArgument.drop () ; // Release error dropped variable
        outArgument_outReturnedType.drop () ; // Release error dropped variable
      }else if (kBoolFalse == test_3) {
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_constructorMap enumerator_36873 (var_constructorMap, kEnumeration_up) ;
        while (enumerator_36873.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_36873.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 578))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 578))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 578)) ;
          cEnumerator_functionSignature enumerator_36945 (enumerator_36873.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          while (enumerator_36945.hasCurrentObject ()) {
            GALGAS_string temp_5 ;
            const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_36945.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_6) {
              temp_5 = enumerator_36945.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 580)) ;
            }else if (kBoolFalse == test_6) {
              temp_5 = GALGAS_string::makeEmptyString () ;
            }
            var_s.dotAssign_operation (GALGAS_string (" \?").add_operation (temp_5, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 580)).add_operation (GALGAS_string ("@"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 580)).operator_concat (enumerator_36945.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 580))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 580))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 580)) ;
            enumerator_36945.gotoNextObject () ;
          }
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_36873.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 582))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 582))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 582)) ;
          enumerator_36873.gotoNextObject () ;
        }
        GALGAS_string temp_7 ;
        const enumGalgasBool test_8 = GALGAS_bool (kIsStrictSup, var_constructorMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 586)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
        if (kBoolTrue == test_8) {
        ...
        inCompiler->emitSemanticError (location_9, GALGAS_string ("the '@").operator_concat (constinArgument_inTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 585))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 585)).operator_concat (GALGAS_string ("' type does not define the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 585)).operator_concat (constinArgument_inConstructorName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 585))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 585)).operator_concat (GALGAS_string ("' constructor; ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 585)).operator_concat (temp_7  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 585)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 586)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 587))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 584)) ;
        var_constructorFormalArgumentTypeList.drop () ; // Release error dropped variable
        outArgument_outHasCompilerArgument.drop () ; // Release error dropped variable
        outArgument_outReturnedType.drop () ; // Release error dropped variable
      }
    }
    const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, constinArgument_inConstuctorEffectiveParameterExpressions.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 593)).objectCompare (var_constructorFormalArgumentTypeList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 593)))).boolEnum () ;
    if (kBoolTrue == test_10) {
      GALGAS_location location_11 (constinArgument_inConstructorName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_11, GALGAS_string ("calling the '").operator_concat (constinArgument_inConstructorName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 595))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 595)).operator_concat (GALGAS_string ("' constructor of '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 595)).operator_concat (constinArgument_inTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 595))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 595)).operator_concat (GALGAS_string ("' requires ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 595)).operator_concat (var_constructorFormalArgumentTypeList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 596)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 596))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 595)).operator_concat (GALGAS_string (" parameter(s), while this call has ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 596)).operator_concat (constinArgument_inConstuctorEffectiveParameterExpressions.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 597)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 597))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 596)).operator_concat (GALGAS_string (" parameter(s)")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 597))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 594)) ;
    }
    outArgument_outConstructorEffectiveParameterList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 599)) ;
    cEnumerator_actualOutputExpressionList enumerator_38182 (constinArgument_inConstuctorEffectiveParameterExpressions, kEnumeration_up) ;
    cEnumerator_functionSignature enumerator_38217 (var_constructorFormalArgumentTypeList, kEnumeration_up) ;
    while (enumerator_38182.hasCurrentObject () && enumerator_38217.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_38182.current_mExpression (HERE).ptr (), enumerator_38217.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 602)) ;
      {
      routine_checkAssignmentTypes (enumerator_38217.current_mFormalArgumentType (HERE), var_exp.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 603)), enumerator_38182.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 603)) ;
      }
      const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_38217.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_38182.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_12) {
        GALGAS_string temp_13 ;
        const enumGalgasBool test_14 = GALGAS_bool (kIsNotEqual, enumerator_38217.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_14) {
          temp_13 = enumerator_38217.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 605)) ;
        }else if (kBoolFalse == test_14) {
          temp_13 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_15 (enumerator_38182.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_15, GALGAS_string ("the selector should be '!").operator_concat (temp_13.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 605))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 605))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 605)) ;
      }
      outArgument_outConstructorEffectiveParameterList.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 607)) ;
...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  const enumGalgasBool test_0 = constinArgument_inSuperClass.reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 796)).boolEnum () ;
  if (kBoolTrue == test_0) {
    result_outResult = GALGAS_string::makeEmptyString () ;
  }else if (kBoolFalse == test_0) {
    GALGAS_methodQualifier var_qualifier ;
    GALGAS_methodKind joker_46388_5 ; // Joker input parameter
    GALGAS_functionSignature joker_46388_4 ; // Joker input parameter
    GALGAS_location joker_46388_3 ; // Joker input parameter
    GALGAS_bool joker_46388_2 ; // Joker input parameter
    GALGAS_unifiedTypeMap_2D_proxy joker_46388_1 ; // Joker input parameter
    GALGAS_string joker_46403 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 800)).method_searchKey (constinArgument_inReaderName, joker_46388_5, joker_46388_4, joker_46388_3, joker_46388_2, joker_46388_1, var_qualifier, joker_46403, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 800)) ;
    if (var_qualifier.isValid ()) {
      ...
      case GALGAS_methodQualifier::kEnum_isBasic: case GALGAS_methodQualifier::kEnum_isBasicFinal: case GALGAS_methodQualifier::kEnum_isOverriding: {
        result_outResult = constinArgument_inSuperClass.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 805)) ;
        } break ;
      case GALGAS_methodQualifier::kEnum_isInherited: case GALGAS_methodQualifier::kEnum_isOverridingAbstract: {
        result_outResult = function_checkReaderImplementationInSuperClasses (constinArgument_inReaderName, constinArgument_inSuperClass.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 807)), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 807)) ;
        } break ;
      }
    }
  }
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMap_2D_proxy constinArgument_inLeftType,
                                  ...
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  const enumGalgasBool test_0 = constinArgument_inOperandIsHandled.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (constinArgument_inErrorLocation, GALGAS_string ("left operand type is '@").operator_concat (constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 906))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 906)).operator_concat (GALGAS_string ("' and does not accept '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 906)).operator_concat (constinArgument_inOperatorNameForErrorMessage  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 906)).operator_concat (GALGAS_string ("' operator (right operand type is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 906)).operator_concat (constinArgument_inRightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 906))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 906)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 906))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 905)) ;
  }else if (kBoolFalse == test_0) {
    ...
    if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 911)).isValid ()) {
      uint32_t variant_50603 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 911)).uintValue () ;
      bool loop_50603 = true ;
      while (loop_50603) {
        loop_50603 = var_ok.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 911)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 911)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 911)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 911)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 911)).isValid () ;
        if (loop_50603) {
          loop_50603 = var_ok.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 911)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 911)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 911)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 911)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 911)).boolValue () ;
        }
        if (loop_50603 && (0 == variant_50603)) {
          loop_50603 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 911)) ;
        }
        if (loop_50603) {
          variant_50603 -- ;
          var_rightType = var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 912)) ;
          var_ok = GALGAS_bool (kIsEqual, constinArgument_inLeftType.objectCompare (var_rightType)) ;
        }
      }
    }
    const enumGalgasBool test_1 = var_ok.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 916)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 918)).reader_hasKey (constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 918)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 918)).boolEnum () ;
      if (kBoolTrue == test_2) {
        ...
        GALGAS_location joker_51165 ; // Joker input parameter
        GALGAS_methodQualifier joker_51233_2 ; // Joker input parameter
        GALGAS_string joker_51233_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 922)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 923)), var_kind, var_argumentTypeList, joker_51165, var_hasCompilerArgument, var_returnedType, joker_51233_2, joker_51233_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 922)) ;
        var_ok = GALGAS_bool (kIsEqual, var_argumentTypeList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 931)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsEqual, var_returnedType.objectCompare (constinArgument_inLeftType)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 931)) ;
        GALGAS_semanticExpressionForGeneration var_conversionExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (constinArgument_inLeftType, constinArgument_inErrorLocation, var_kind, ioArgument_ioRightExpression, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 938)), constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 939)), GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 940)), var_hasCompilerArgument  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 933)) ;
        ioArgument_ioRightExpression = var_conversionExpression ;
      }
      const enumGalgasBool test_3 = var_ok.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 945)).boolEnum () ;
      if (kBoolTrue == test_3) {
        inCompiler->emitSemanticError (constinArgument_inErrorLocation, GALGAS_string ("left operand type of '").operator_concat (constinArgument_inOperatorNameForErrorMessage  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 947)).operator_concat (GALGAS_string ("' operator is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 947)).operator_concat (constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 947))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 947)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 947)).operator_concat (constinArgument_inRightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 948))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 948)).operator_concat (GALGAS_string ("', it should be either the same, either inherits from left operand type, either have a '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 948)).operator_concat (constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 950))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 949)).operator_concat (GALGAS_string ("' reader without argument that returns a '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 950)).operator_concat (constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 950))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 950)).operator_concat (GALGAS_string ("' object")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 950))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 946)) ;
      }
    }
  }
}
...
static void categoryMethod_literalStringExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
  cEnumerator_stringlist enumerator_32582 (object->mAttribute_mStringSequence, kEnumeration_up) ;
  while (enumerator_32582.hasCurrentObject ()) {
    var_s.dotAssign_operation (enumerator_32582.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 476)) ;
...
static void categoryMethod_literalUInt_36__34_ExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  outArgument_outExpression = GALGAS_literalUInt_36__34_ExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUInt_36__34_Type, object->mAttribute_mValue.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 513)), object->mAttribute_mValue.reader_uint_36__34_ (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 514))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 511)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_literalSIntExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  outArgument_outExpression = GALGAS_literalSIntExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mSIntType, object->mAttribute_mValue.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 526)), object->mAttribute_mValue.reader_sint (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 526))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 526)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_literalSInt_36__34_ExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  outArgument_outExpression = GALGAS_literalSInt_36__34_ExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mSInt_36__34_Type, object->mAttribute_mValue.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 537)), object->mAttribute_mValue.reader_sint_36__34_ (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 537))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 537)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_defaultConstructorExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    var_type = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 622)) ;
  }
  const enumGalgasBool test_1 = var_type.reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 624)).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_location location_2 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("cannot infer type")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 625)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_1) {
    const enumGalgasBool test_3 = var_type.reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 628)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 628)).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_location location_4 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, GALGAS_string ("an abstract class does not support the default constructor")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 629)) ;
    }else if (kBoolFalse == test_3) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, var_type.reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 630)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_5) {
        GALGAS_location location_6 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_6, GALGAS_string ("this class does not support the default constructor")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 631)) ;
      }
    }
    outArgument_outExpression = GALGAS_defaultConstructorExpressionForGeneration::constructor_new (var_type, object->mAttribute_mTypeName.mAttribute_location  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 634)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_constructorExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool var_hasCompilerArgument ;
  {
  routine_analyzeConstructorInvocation (constinArgument_inType, constinArgument_inAnalysisContext, ioArgument_ioVariableMap, object->mAttribute_mTypeName, object->mAttribute_mConstructorName, object->mAttribute_mExpressions, var_returnedType, var_constructorType, var_constructorEffectiveParameterList, var_hasCompilerArgument, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 649)) ;
  }
  outArgument_outExpression = GALGAS_constructorExpressionForGeneration::constructor_new (var_returnedType, object->mAttribute_mConstructorName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 664)), var_constructorType, object->mAttribute_mConstructorName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 666)), var_constructorEffectiveParameterList, var_hasCompilerArgument  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 662)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_readerCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mReceiver.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 682)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_receiverExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 682)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_receiverType = var_receiverExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 683)) ;
  GALGAS_readerMap var_readerMap = var_receiverType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 685)) ;
  GALGAS_functionSignature var_readerFormalArgumentTypeList ;
  GALGAS_methodKind var_kind ;
  GALGAS_bool var_hasCompilerArgument ;
  GALGAS_unifiedTypeMap_2D_proxy var_returnedType ;
  GALGAS_stringlist var_fieldList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 691)) ;
  const cMapElement_readerMap * objectArray_41612 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 692))) ;
  if (NULL != objectArray_41612) {
      macroValidSharedObject (objectArray_41612, cMapElement_readerMap) ;
    var_readerFormalArgumentTypeList = objectArray_41612->mAttribute_mArgumentTypeList ;
    var_hasCompilerArgument = objectArray_41612->mAttribute_mHasCompilerArgument ;
    var_returnedType = objectArray_41612->mAttribute_mReturnedType ;
    var_kind = objectArray_41612->mAttribute_mKind ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, objectArray_41612->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, objectArray_41612->mAttribute_mErrorMessage  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 698)) ;
    }
  }else{
    GALGAS_uint var_matchingReaderCount = GALGAS_uint ((uint32_t) 0U) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_receiverType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 702)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 702)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      var_readerFormalArgumentTypeList = GALGAS_functionSignature::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 703)) ;
      var_hasCompilerArgument = GALGAS_bool (true) ;
      var_returnedType = GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 705)) ;
      var_kind = GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 706)) ;
      cEnumerator_typedAttributeList enumerator_42254 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 707)), kEnumeration_up) ;
      while (enumerator_42254.hasCurrentObject ()) {
        GALGAS_unifiedTypeMap_2D_proxy var_attributeType = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (enumerator_42254.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 708)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 708)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 708)) ;
        GALGAS_readerMap var_aMap = var_attributeType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 709)) ;
        const cMapElement_readerMap * objectArray_42484 = (const cMapElement_readerMap *) var_aMap.readAccessForWithInstruction (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 710))) ;
        if (NULL != objectArray_42484) {
            macroValidSharedObject (objectArray_42484, cMapElement_readerMap) ;
          var_matchingReaderCount.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 711)) ;
          var_readerFormalArgumentTypeList = objectArray_42484->mAttribute_mArgumentTypeList ;
          var_hasCompilerArgument = objectArray_42484->mAttribute_mHasCompilerArgument ;
          var_returnedType = objectArray_42484->mAttribute_mReturnedType ;
          var_kind = objectArray_42484->mAttribute_mKind ;
          var_fieldList.addAssign_operation (enumerator_42254.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 716))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 716)) ;
          const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, objectArray_42484->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_location location_4 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_4, objectArray_42484->mAttribute_mErrorMessage  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 718)) ;
          }
        }
      ...
      if (kBoolTrue == test_5) {
        ...
        inCompiler->emitSemanticError (location_6, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 724))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 724)).operator_concat (GALGAS_string ("' struct type does not define the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 724)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 724))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 724)).operator_concat (GALGAS_string ("' reader, and none of its fields defines it")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 724))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 723)) ;
        ...
        if (kBoolTrue == test_7) {
          GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
          cEnumerator_stringlist enumerator_43342 (var_fieldList, kEnumeration_up) ;
          while (enumerator_43342.hasCurrentObject ()) {
            var_s.dotAssign_operation (enumerator_43342.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 731)) ;
            if (enumerator_43342.hasNextObject ()) {
              var_s.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 732)) ;
            }
            enumerator_43342.gotoNextObject () ;
          }
          GALGAS_location location_8 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_8, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 735))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 735)).operator_concat (GALGAS_string ("' struct type does not define the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 735)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 735))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 735)).operator_concat (GALGAS_string ("' reader, and several of its fields defines it:")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 735)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 736)).operator_concat (GALGAS_string (" (exactly one field should define it)")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 736))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 734)) ;
          var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
          var_hasCompilerArgument.drop () ; // Release error dropped variable
          var_returnedType.drop () ; // Release error dropped variable
          var_kind.drop () ; // Release error dropped variable
      ...
      const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, var_readerMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 740)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_9) {
        GALGAS_location location_10 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_10, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 742))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 742)).operator_concat (GALGAS_string ("' type does not define any reader")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 742))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 741)) ;
        var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
        var_hasCompilerArgument.drop () ; // Release error dropped variable
        var_returnedType.drop () ; // Release error dropped variable
        var_kind.drop () ; // Release error dropped variable
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_readerMap enumerator_44040 (var_readerMap, kEnumeration_up) ;
        while (enumerator_44040.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_44040.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 748))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 748))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 748)) ;
          cEnumerator_functionSignature enumerator_44108 (enumerator_44040.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          while (enumerator_44108.hasCurrentObject ()) {
            GALGAS_string temp_11 ;
            const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_44108.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_12) {
              temp_11 = enumerator_44108.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 750)) ;
            }else if (kBoolFalse == test_12) {
              temp_11 = GALGAS_string::makeEmptyString () ;
            }
            var_s.dotAssign_operation (GALGAS_string (" \?").add_operation (temp_11, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 750)).add_operation (GALGAS_string ("@"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 750)).operator_concat (enumerator_44108.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 750))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 750))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 750)) ;
            enumerator_44108.gotoNextObject () ;
          }
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_44040.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 752))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 752))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 752)) ;
          enumerator_44040.gotoNextObject () ;
        }
        GALGAS_string temp_13 ;
        const enumGalgasBool test_14 = GALGAS_bool (kIsStrictSup, var_readerMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 756)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
        if (kBoolTrue == test_14) {
        ...
        inCompiler->emitSemanticError (location_15, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 755))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 755)).operator_concat (GALGAS_string ("' type does not define the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 755)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 755))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 755)).operator_concat (GALGAS_string ("' reader; available ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 755)).operator_concat (temp_13  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 755)).operator_concat (GALGAS_string (":")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 756)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 757))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 754)) ;
        var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
        var_hasCompilerArgument.drop () ; // Release error dropped variable
        var_returnedType.drop () ; // Release error dropped variable
        var_kind.drop () ; // Release error dropped variable
  ...
  const enumGalgasBool test_16 = GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 763)).objectCompare (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 763)))).boolEnum () ;
  if (kBoolTrue == test_16) {
    GALGAS_location location_17 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_17, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 764))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 764)).operator_concat (GALGAS_string ("' reader of '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 764)).operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 764))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 764)).operator_concat (GALGAS_string ("' requires ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 764)).operator_concat (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 765)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 765))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 764)).operator_concat (GALGAS_string (" parameter(s), while this call has ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 765)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 766)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 766))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 765)).operator_concat (GALGAS_string (" parameter(s)")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 766))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 764)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_16) {
    GALGAS_semanticExpressionListForGeneration var_constructorEffectiveParameterList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 768)) ;
    cEnumerator_actualOutputExpressionList enumerator_45163 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_functionSignature enumerator_45193 (var_readerFormalArgumentTypeList, kEnumeration_up) ;
    while (enumerator_45163.hasCurrentObject () && enumerator_45193.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_45163.current_mExpression (HERE).ptr (), enumerator_45193.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 770)) ;
      const enumGalgasBool test_18 = GALGAS_bool (kIsNotEqual, enumerator_45193.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_45163.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_18) {
        GALGAS_string temp_19 ;
        const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_45193.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_20) {
          temp_19 = GALGAS_string (":") ;
        }else if (kBoolFalse == test_20) {
          temp_19 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_21 (enumerator_45163.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_21, GALGAS_string ("the selector should be '!").operator_concat (enumerator_45193.current_mFormalSelector (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 772))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 772)).operator_concat (temp_19.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 772))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 772))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 772)) ;
      }
      {
      routine_checkAssignmentTypes (enumerator_45193.current_mFormalArgumentType (HERE), var_exp.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 774)), enumerator_45163.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 774)) ;
      }
      var_constructorEffectiveParameterList.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 775)) ;
      enumerator_45163.gotoNextObject () ;
      enumerator_45193.gotoNextObject () ;
    }
    outArgument_outExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (var_returnedType, object->mAttribute_mReaderName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 779)), var_kind, var_receiverExpression, var_fieldList, object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 783)), var_constructorEffectiveParameterList, var_hasCompilerArgument  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 777)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_optionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mOptionComponentMapForSemanticAnalysis.method_searchKey (object->mAttribute_mOptionComponentName, var_optionComponentIsPredefined, var_boolOptionMap, var_uintOptionMap, var_stringOptionMap, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 823)) ;
  GALGAS_bool var_found = var_boolOptionMap.reader_hasKey (object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 830)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 830)) ;
  ...
  const enumGalgasBool test_0 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 832)).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_found = var_uintOptionMap.reader_hasKey (object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 833)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 833)) ;
    var_returnedType = constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType ;
  }
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 836)).boolEnum () ;
  if (kBoolTrue == test_1) {
    var_found = var_stringOptionMap.reader_hasKey (object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 837)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 837)) ;
  ...
  if (kBoolTrue == test_2) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 841)).objectCompare (GALGAS_string ("value"))).boolEnum () ;
    if (kBoolTrue == test_3) {
      outArgument_outExpression = GALGAS_optionValueExpressionForGeneration::constructor_new (var_returnedType, object->mAttribute_mOptionComponentName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 844)), var_optionComponentIsPredefined, object->mAttribute_mOptionComponentName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 846)), object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 847))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 842)) ;
    }else if (kBoolFalse == test_3) {
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 849)).objectCompare (GALGAS_string ("char"))).boolEnum () ;
      if (kBoolTrue == test_4) {
        outArgument_outExpression = GALGAS_optionCharExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mCharType, object->mAttribute_mOptionComponentName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 852)), var_optionComponentIsPredefined, object->mAttribute_mOptionComponentName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 854)), object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 855))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 850)) ;
      }else if (kBoolFalse == test_4) {
        const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 857)).objectCompare (GALGAS_string ("string"))).boolEnum () ;
        if (kBoolTrue == test_5) {
          outArgument_outExpression = GALGAS_optionStringExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType, object->mAttribute_mOptionComponentName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 860)), var_optionComponentIsPredefined, object->mAttribute_mOptionComponentName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 862)), object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 863))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 858)) ;
        }else if (kBoolFalse == test_5) {
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 865)).objectCompare (GALGAS_string ("comment"))).boolEnum () ;
          if (kBoolTrue == test_6) {
            outArgument_outExpression = GALGAS_optionCommentExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType, object->mAttribute_mOptionComponentName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 868)), var_optionComponentIsPredefined, object->mAttribute_mOptionComponentName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 870)), object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 871))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 866)) ;
          }else if (kBoolFalse == test_6) {
            GALGAS_location location_7 (object->mAttribute_mOptionReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_7, GALGAS_string ("only the 'value', 'char', 'string' and 'comment' readers are defined for an option")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 874)) ;
            outArgument_outExpression.drop () ; // Release error dropped variable
          }
        }
      }
    ...
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_commandLineOptionMap enumerator_49427 (var_boolOptionMap, kEnumeration_up) ;
    while (enumerator_49427.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_49427.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 879))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 879)).operator_concat (GALGAS_string ("' @bool option;")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 879))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 879)) ;
      enumerator_49427.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_49523 (var_uintOptionMap, kEnumeration_up) ;
    while (enumerator_49523.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_49523.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 882))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 882)).operator_concat (GALGAS_string ("' @uint option;")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 882))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 882)) ;
      enumerator_49523.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_49621 (var_stringOptionMap, kEnumeration_up) ;
    while (enumerator_49621.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_49621.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 885))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 885)).operator_concat (GALGAS_string ("' @string option;")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 885))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 885)) ;
    ...
    inCompiler->emitSemanticError (location_8, GALGAS_string ("the '").operator_concat (object->mAttribute_mOptionComponentName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 888))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 888)).operator_concat (GALGAS_string ("' option component does not define the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 888)).operator_concat (object->mAttribute_mOptionEntryName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 888))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 888)).operator_concat (GALGAS_string ("' option; available options:")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 888)).operator_concat (var_s  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 888))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 887)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_concatExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 967)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 967)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 970)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 970)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 972)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 975)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 976)).operator_and (function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 976)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 976)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("."), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 973)) ;
  }
  outArgument_outExpression = GALGAS_concatExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 982)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_orExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1000)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1000)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1003)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1003)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1005)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1008)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1009)).operator_and (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1009)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1009)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("|"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1006)) ;
  }
  outArgument_outExpression = GALGAS_orExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1015)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_orShortExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1033)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1033)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1036)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1036)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1038)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1041)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1042)).operator_and (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1042)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1042)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("|"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1039)) ;
  }
  outArgument_outExpression = GALGAS_orShortExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1048)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_andExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1066)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1066)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1069)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1069)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1071)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1074)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1075)).operator_and (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1075)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1075)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("&"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1072)) ;
  }
  outArgument_outExpression = GALGAS_andExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1081)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_andShortExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1099)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1099)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1102)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1102)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1104)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1107)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1108)).operator_and (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1108)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1108)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("&"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1105)) ;
  }
  outArgument_outExpression = GALGAS_andShortExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1114)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_xorExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1132)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1132)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1135)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1135)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1137)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1140)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1141)).operator_and (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1141)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1141)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("^"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1138)) ;
  }
  outArgument_outExpression = GALGAS_xorExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1147)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_equalExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1165)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1165)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1168)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1168)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1170)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1171)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1172)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1172)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1172)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1172)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1174)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1174))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1174)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1174)).operator_concat (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1174)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1174))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1174)).operator_concat (GALGAS_string ("': '==' operator requires the types are the same")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1174))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1173)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    outArgument_outExpression = GALGAS_equalExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1179)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_notEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1198)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1198)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1201)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1201)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1203)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1204)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1205)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1205)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1205)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1205)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1207))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1207)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1207)).operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1207))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1207)).operator_concat (GALGAS_string ("': '!=' operator requires the types are the same")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1207))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1206)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    outArgument_outExpression = GALGAS_notEqualExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1212)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_lowerOrEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1231)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1231)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1234)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1234)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1236)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1237)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1238)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1238)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1238)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1240))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1240)).operator_concat (GALGAS_string ("' and does not support the '<=' operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1240))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1239)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1243)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1243)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1245))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1245)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1245)).operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1245))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1245)).operator_concat (GALGAS_string ("': '<=' operator requires the types are the same")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1245))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1244)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_lowerOrEqualExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1250)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_greaterOrEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1269)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1269)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1272)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1272)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1274)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1275)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1276)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1276)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1276)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1278))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1278)).operator_concat (GALGAS_string ("' and does not support the '>=' operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1278))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1277)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1281)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1281)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1283))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1283)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1283)).operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1283))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1283)).operator_concat (GALGAS_string ("': '>=' operator requires the types are the same")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1283))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1282)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_greaterOrEqualExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1288)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_strictGreaterExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1307)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1307)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1310)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1310)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1312)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1313)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1314)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1314)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1314)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1316))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1316)).operator_concat (GALGAS_string ("' and does not support the '>' operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1316))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1315)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1319)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1319)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1321))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1321)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1321)).operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1321))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1321)).operator_concat (GALGAS_string ("': '>' operator requires the types are the same")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1321))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1320)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_strictGreaterExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1326)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_strictLowerExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1345)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1345)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1348)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1348)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1350)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1351)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1352)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1352)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1352)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1354))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1354)).operator_concat (GALGAS_string ("' and does not support the '<' operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1354))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1353)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1357)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1357)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1359))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1359)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1359)).operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1359))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1359)).operator_concat (GALGAS_string ("': '<' operator requires the types are the same")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1359))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1358)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_strictLowerExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1364)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_rightShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1383)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1383)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1386)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1386)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1388)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1389)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1390)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1390)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1390)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1392))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1392)).operator_concat (GALGAS_string ("' and does not support a shift operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1392))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1391)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1395)).objectCompare (GALGAS_string ("uint"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("for a shift operator, right operand type should be '@uint': it is '@").operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1397))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1397)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1397))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1396)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_rightShiftExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1402)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_leftShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1421)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1421)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1424)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1424)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1426)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1427)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1428)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1428)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1428)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1430))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1430)).operator_concat (GALGAS_string ("' and does not support a shift operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1430))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1429)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1433)).objectCompare (GALGAS_string ("uint"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("for a shift operator, right operand type should be '@uint': it is '@").operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1435))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1435)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1435))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1434)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_leftShiftExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1440)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_addExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1459)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1459)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1462)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1462)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1464)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1467)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1468)).operator_and (function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1468)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1468)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("+"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1465)) ;
  }
  outArgument_outExpression = GALGAS_addExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1474)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_subExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1492)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1492)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1495)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1495)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1497)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1500)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1501)).operator_and (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1501)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1501)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("-"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1498)) ;
  }
  outArgument_outExpression = GALGAS_subExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1507)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_multiplicationExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1525)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1525)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1528)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1528)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1530)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1533)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1534)).operator_and (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1534)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1534)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("*"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1531)) ;
  }
  outArgument_outExpression = GALGAS_multiplicationExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1540)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_divisionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1558)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1558)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1561)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1561)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1563)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1566)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1567)).operator_and (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1567)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1567)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("/"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1564)) ;
  }
  outArgument_outExpression = GALGAS_divisionExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1573)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_moduloExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mLeftExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1591)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1591)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mRightExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1594)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1594)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1596)) ;
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1599)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1600)).operator_and (function_binaryModOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1600)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1600)).objectCompare (GALGAS_uint ((uint32_t) 0U))), GALGAS_string ("mod"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1597)) ;
  }
  outArgument_outExpression = GALGAS_moduloExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1606)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_unaryMinusExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1624)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1624)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_type = var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1626)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1627)).operator_and (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1627)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1627)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("operand type is '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1629))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1629)).operator_concat (GALGAS_string ("' and does not support the unary minus operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1629))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1628)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    outArgument_outExpression = GALGAS_unaryMinusExpressionForGeneration::constructor_new (var_type, object->mAttribute_mOperatorLocation, var_expression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1634)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_notExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1652)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1652)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_type = var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1654)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1655)).operator_and (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1655)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1655)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("operand type is '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1657))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1657)).operator_concat (GALGAS_string ("' and does not support the 'not' operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1657))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1656)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    outArgument_outExpression = GALGAS_notExpressionForGeneration::constructor_new (var_type, object->mAttribute_mOperatorLocation, var_expression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1662)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_structFieldAccessExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1680)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1679)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_type = var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1686)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1687)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1687)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mStructFieldName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '.' operator requires the receiver to be a struct")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1688)) ;
  }
  GALGAS_attributeMap var_attributeMap = var_type.reader_mAttributeMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1690)) ;
  var_attributeMap.method_searchKey (object->mAttribute_mStructFieldName, var_type, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1691)) ;
  outArgument_outExpression = GALGAS_structFieldAccessExpressionForGeneration::constructor_new (var_type, object->mAttribute_mOperatorLocation, var_expression, object->mAttribute_mStructFieldName.mAttribute_string  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1697)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_complementExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1715)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1715)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_type = var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1717)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1718)).operator_and (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1718)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1718)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("operand type is '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1720))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1720)).operator_concat (GALGAS_string ("' and does not support the '~' operator")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1720))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1719)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    outArgument_outExpression = GALGAS_tildeExpressionForGeneration::constructor_new (var_type, object->mAttribute_mOperatorLocation, var_expression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1725)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_ifExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mIfExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1743)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_if_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1743)) ;
  GALGAS_semanticExpressionForGeneration var_then_5F_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mThenExpression.ptr (), constinArgument_inType, constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_then_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1746)) ;
  GALGAS_semanticExpressionForGeneration var_else_5F_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mElseExpression.ptr (), constinArgument_inType, constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_else_5F_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1749)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_if_5F_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1751)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1751)).objectCompare (GALGAS_string ("bool"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("the test expression type is '@").operator_concat (var_if_5F_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1753)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1753))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1753)).operator_concat (GALGAS_string ("', it should be '@bool'")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1753))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1752)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_then_5F_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1756)).objectCompare (var_else_5F_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1756)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("operand expression types are '@").operator_concat (var_then_5F_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1758)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1758))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1758)).operator_concat (GALGAS_string ("' and '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1758)).operator_concat (var_else_5F_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1758)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1758))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1758)).operator_concat (GALGAS_string ("': they should be the same")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1758))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1757)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_ifExpressionForGeneration::constructor_new (var_then_5F_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1764)), object->mAttribute_mOperatorLocation, var_if_5F_expression, var_then_5F_expression, var_else_5F_expression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1763)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFunctionMap.method_searchKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultType, var_isInternal, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1782)) ;
  const enumGalgasBool test_0 = var_isInternal.boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location var_procDeclarationLocation = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFunctionMap.reader_locationForKey (object->mAttribute_mFunctionName.mAttribute_string, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1790)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, object->mAttribute_mFunctionName.mAttribute_location.reader_file (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1791)).objectCompare (var_procDeclarationLocation.reader_file (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1791)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (object->mAttribute_mFunctionName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("this proc is internal to '").operator_concat (var_procDeclarationLocation.reader_file (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1792))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1792)).operator_concat (GALGAS_string ("' file")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1792))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1792)) ;
    }
  }
  const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_functionSignature.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1796)).objectCompare (object->mAttribute_mExpressionList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1796)))).boolEnum () ;
  if (kBoolTrue == test_3) {
    GALGAS_location location_4 (object->mAttribute_mFunctionName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_4, GALGAS_string ("the '").operator_concat (object->mAttribute_mFunctionName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1798))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1798)).operator_concat (GALGAS_string ("' function header declares ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1798)).operator_concat (var_functionSignature.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1798)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1798))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1798)).operator_concat (GALGAS_string (" formal parameter(s), but this function call names ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1798)).operator_concat (object->mAttribute_mExpressionList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1799)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1799))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1799)).operator_concat (GALGAS_string (" effective argument(s)")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1799))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1797)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_3) {
    GALGAS_semanticExpressionListForGeneration var_semanticExpressionListForGeneration = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1804)) ;
    cEnumerator_functionSignature enumerator_85269 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_actualOutputExpressionList enumerator_85286 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    while (enumerator_85269.hasCurrentObject () && enumerator_85286.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_expression ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_85286.current_mExpression (HERE).ptr (), enumerator_85269.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1806)) ;
      {
      routine_checkAssignmentTypes (enumerator_85269.current_mFormalArgumentType (HERE), var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1812)), enumerator_85286.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1812)) ;
      }
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_85269.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_85286.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_5) {
        GALGAS_string temp_6 ;
        const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, enumerator_85269.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_7) {
          temp_6 = enumerator_85269.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1814)) ;
        }else if (kBoolFalse == test_7) {
          temp_6 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_8 (enumerator_85286.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_8, GALGAS_string ("the selector should be '!").operator_concat (temp_6.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1814))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1814))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1814)) ;
      }
      var_semanticExpressionListForGeneration.addAssign_operation (var_expression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1816)) ;
      enumerator_85269.gotoNextObject () ;
      enumerator_85286.gotoNextObject () ;
    }
    outArgument_outExpression = GALGAS_functionCallExpressionForGeneration::constructor_new (var_resultType, object->mAttribute_mFunctionName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1820)), object->mAttribute_mFunctionName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1821)), var_semanticExpressionListForGeneration  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1818)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_varInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  {
  ioArgument_ioVariableMap.modifier_searchForReadAccess (object->mAttribute_mVarName, var_type, var_sourceVariableCppName, var_nameForCheckingFormalParameterUsing, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1835)) ;
  }
  outArgument_outExpression = GALGAS_varInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mVarName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1843)), var_sourceVariableCppName, var_nameForCheckingFormalParameterUsing  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1841)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool joker_87207_26 ; // Joker input parameter
  GALGAS_bool joker_87207_25 ; // Joker input parameter
  GALGAS_unifiedTypeMap_2D_proxy joker_87207_24 ; // Joker input parameter
  GALGAS_typeKindEnum joker_87207_23 ; // Joker input parameter
  GALGAS_bool joker_87207_22 ; // Joker input parameter
  GALGAS_typedAttributeList joker_87207_21 ; // Joker input parameter
  GALGAS_attributeMap joker_87207_20 ; // Joker input parameter
  GALGAS_typedAttributeList joker_87207_19 ; // Joker input parameter
  GALGAS_constructorMap joker_87207_18 ; // Joker input parameter
  GALGAS_readerMap joker_87207_17 ; // Joker input parameter
  GALGAS_modifierMap joker_87207_16 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_87207_15 ; // Joker input parameter
  GALGAS_classMethodMap joker_87207_14 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_87207_13 ; // Joker input parameter
  GALGAS_stringlist joker_87207_12 ; // Joker input parameter
  GALGAS_uint joker_87207_11 ; // Joker input parameter
  GALGAS_functionSignature joker_87207_10 ; // Joker input parameter
  GALGAS_constantIndexMap joker_87207_9 ; // Joker input parameter
  GALGAS_enumConstantList joker_87207_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_87207_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_87207_6 ; // Joker input parameter
  GALGAS_bool joker_87207_5 ; // Joker input parameter
  GALGAS_unifiedTypeMap_2D_proxy joker_87207_4 ; // Joker input parameter
  GALGAS_string joker_87207_3 ; // Joker input parameter
  GALGAS_string joker_87207_2 ; // Joker input parameter
  GALGAS_headerKind joker_87207_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_87207_26, joker_87207_25, joker_87207_24, joker_87207_23, joker_87207_22, joker_87207_21, joker_87207_20, joker_87207_19, joker_87207_18, joker_87207_17, joker_87207_16, joker_87207_15, joker_87207_14, joker_87207_13, joker_87207_12, joker_87207_11, joker_87207_10, joker_87207_9, joker_87207_8, joker_87207_7, joker_87207_6, joker_87207_5, joker_87207_4, joker_87207_3, joker_87207_2, joker_87207_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1858)) ;
  outArgument_outExpression = GALGAS_literalTypeInExpressionForGeneration::constructor_new (GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("type"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1861)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1861)), object->mAttribute_mLiteralTypeName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1862)), object->mAttribute_mLiteralTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1863))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1860)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_testDynamicClassInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mReceiverExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1877)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1877)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_castType = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1879)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1881)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1881)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1881)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_unifiedTypeMap_2D_proxy var_t = var_castType ;
    GALGAS_bool var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1884)))) ;
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1885)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1885)).isValid ()) {
      uint32_t variant_88422 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1885)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1885)).uintValue () ;
      bool loop_88422 = true ;
      while (loop_88422) {
        loop_88422 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1886)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1886)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1886)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1886)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1886)).isValid () ;
        if (loop_88422) {
          loop_88422 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1886)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1886)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1886)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1886)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1886)).boolValue () ;
        }
        if (loop_88422 && (0 == variant_88422)) {
          loop_88422 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1885)) ;
        }
        if (loop_88422) {
          variant_88422 -- ;
          var_t = var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1887)) ;
          var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1888)))) ;
        }
      }
    }
    const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1890)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1892))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1892)).operator_concat (GALGAS_string ("' is not a descendant of the '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1892)).operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1892)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1892))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1892)).operator_concat (GALGAS_string ("' type of the cast expression")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1892))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1891)) ;
    }
  }else if (kBoolFalse == test_0) {
    inCompiler->emitSemanticError (var_expression.reader_mLocation (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1896)), GALGAS_string ("expression should be a class instance: it is an @").operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1897)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1897))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1896)).operator_concat (GALGAS_string (" instance")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1897))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1896)) ;
  }
  outArgument_outExpression = GALGAS_testDynamicClassInExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1902)), var_expression, object->mAttribute_mTypeComparisonKind, var_castType  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1900)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mReceiverExpression.ptr (), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1919)), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1918)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_type = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1925)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1930)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1930)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1930)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_unifiedTypeMap_2D_proxy var_t = var_type ;
    GALGAS_bool var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1933)))) ;
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1934)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1934)).isValid ()) {
      uint32_t variant_90170 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1934)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1934)).uintValue () ;
      bool loop_90170 = true ;
      while (loop_90170) {
        loop_90170 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1935)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1935)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1935)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1935)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1935)).isValid () ;
        if (loop_90170) {
          loop_90170 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1935)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1935)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1935)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1935)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1935)).boolValue () ;
        }
        if (loop_90170 && (0 == variant_90170)) {
          loop_90170 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1934)) ;
        }
        if (loop_90170) {
          variant_90170 -- ;
          var_t = var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1936)) ;
          var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1937)))) ;
        }
      }
    }
    const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1939)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1941))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1941)).operator_concat (GALGAS_string ("' is not a descendant of the '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1941)).operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1942)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1942))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1941)).operator_concat (GALGAS_string ("' type of the cast expression")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1942))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1940)) ;
    }
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1945)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1945)).objectCompare (GALGAS_string ("object"))).boolEnum () ;
    if (kBoolTrue == test_3) {
      inCompiler->emitSemanticError (var_expression.reader_mLocation (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1950)), GALGAS_string ("cast expression should be a class instance or an @object instance: it is an @").operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1952)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1952))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1951)).operator_concat (GALGAS_string (" instance")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1952))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1950)) ;
    }
  }
  const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1955)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1955)).objectCompare (GALGAS_string ("object"))).boolEnum () ;
  if (kBoolTrue == test_4) {
    outArgument_outExpression = GALGAS_extractObjectInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mEndOfReceiverExpression, var_expression, object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1960))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1956)) ;
  }else if (kBoolFalse == test_4) {
    outArgument_outExpression = GALGAS_castInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1965)), var_expression, object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1967))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1963)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool var_isInternal ;
  GALGAS_lstringlist joker_91920_4 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_91920_3 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_91920_2 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_91920_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_91920_4, joker_91920_3, joker_91920_2, joker_91920_1, var_isInternal, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1981)) ;
  const enumGalgasBool test_0 = var_isInternal.boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location var_filewrapperDeclarationLocation = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.reader_locationForKey (object->mAttribute_mFilewrapperName.mAttribute_string, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1989)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, object->mAttribute_mFilewrapperName.mAttribute_location.reader_file (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1990)).objectCompare (var_filewrapperDeclarationLocation.reader_file (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1990)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (object->mAttribute_mFilewrapperName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("this filewrapper is internal to '").operator_concat (var_filewrapperDeclarationLocation.reader_file (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1991))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1991)).operator_concat (GALGAS_string ("' file")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1991))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1991)) ;
    }
  }
  outArgument_outExpression = GALGAS_filewrapperInExpressionForGeneration::constructor_new (GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("filewrapper"), object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1996))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1996)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1996)), object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1997)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1998)), var_filewrapperPath.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1999))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1995)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool var_isInternal ;
  GALGAS_lstring joker_93112_4 ; // Joker input parameter
  GALGAS_lstringlist joker_93112_3 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_93112_2 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_93112_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_93112_4, joker_93112_3, joker_93112_2, joker_93112_1, var_filewrapperTemplateMap, var_isInternal, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2012)) ;
  const enumGalgasBool test_0 = var_isInternal.boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location var_filewrapperDeclarationLocation = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.reader_locationForKey (object->mAttribute_mFilewrapperName.mAttribute_string, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2020)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, object->mAttribute_mFilewrapperName.mAttribute_location.reader_file (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2021)).objectCompare (var_filewrapperDeclarationLocation.reader_file (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2021)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (object->mAttribute_mFilewrapperName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("this filewrapper is internal to '").operator_concat (var_filewrapperDeclarationLocation.reader_file (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2022))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2022)).operator_concat (GALGAS_string ("' file")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2022))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2022)) ;
    }
  }
  GALGAS_functionSignature var_templateSignature ;
  GALGAS_lstring joker_93721 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_93721, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2026)) ;
  GALGAS_semanticExpressionListForGeneration var_effectiveParameterList ;
  const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2029)).objectCompare (var_templateSignature.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2029)))).boolEnum () ;
  if (kBoolTrue == test_3) {
    ...
    inCompiler->emitSemanticError (location_4, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mFilewrapperTemplateName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2031))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2031)).operator_concat (GALGAS_string ("' template of '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2031)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2031))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2031)).operator_concat (GALGAS_string ("' filewrapper requires ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2031)).operator_concat (var_templateSignature.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2032)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2032))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2031)).operator_concat (GALGAS_string (" parameter(s), while this call has ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2032)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2033)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2033))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2032)).operator_concat (GALGAS_string (" parameter(s)")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2033))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2030)) ;
    var_effectiveParameterList.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_3) {
    var_effectiveParameterList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2036)) ;
    cEnumerator_actualOutputExpressionList enumerator_94308 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_functionSignature enumerator_94327 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_94308.hasCurrentObject () && enumerator_94327.hasCurrentObject ()) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_94327.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_94308.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_5) {
        GALGAS_string temp_6 ;
        const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, enumerator_94327.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_7) {
          temp_6 = GALGAS_string (":") ;
        }else if (kBoolFalse == test_7) {
          temp_6 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_8 (enumerator_94308.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_8, GALGAS_string ("the selector should be '!").operator_concat (enumerator_94327.current_mFormalSelector (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2039))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2039)).operator_concat (temp_6.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2039))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2039))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2039)) ;
      }
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_94308.current_mExpression (HERE).ptr (), enumerator_94327.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2041)) ;
      {
      routine_checkAssignmentTypes (enumerator_94327.current_mFormalArgumentType (HERE), var_exp.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2042)), enumerator_94308.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2042)) ;
      }
      var_effectiveParameterList.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2043)) ;
      enumerator_94308.gotoNextObject () ;
      enumerator_94327.gotoNextObject () ;
    }
  }
  outArgument_outExpression = GALGAS_filewrapperTemplateInExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2049)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2050)), object->mAttribute_mFilewrapperTemplateName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2051)), var_effectiveParameterList  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2047)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2067)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("path is empty")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2068)) ;
    var_directoryList.drop () ; // Release error dropped variable
    var_fileName.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_firstCharacterOrNul (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2069)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the path should not begin with '/'")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2070)) ;
      var_directoryList.drop () ; // Release error dropped variable
      var_fileName.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      var_directoryList = object->mAttribute_mFilewrapperPath.mAttribute_string.reader_componentsSeparatedByString (GALGAS_string ("/") COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2072)) ;
      {
      var_directoryList.modifier_popLast (var_fileName, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2073)) ;
      }
    }
  }
  ...
  GALGAS_bool var_isInternal ;
  GALGAS_lstring joker_96061 ; // Joker input parameter
  GALGAS_lstringlist joker_96068 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_96165 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_96061, joker_96068, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_96165, var_isInternal, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2076)) ;
  const enumGalgasBool test_4 = var_isInternal.boolEnum () ;
  if (kBoolTrue == test_4) {
    GALGAS_location var_filewrapperDeclarationLocation = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.reader_locationForKey (object->mAttribute_mFilewrapperName.mAttribute_string, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2087)) ;
    const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, object->mAttribute_mFilewrapperName.mAttribute_location.reader_file (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2088)).objectCompare (var_filewrapperDeclarationLocation.reader_file (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2088)))).boolEnum () ;
    if (kBoolTrue == test_5) {
      GALGAS_location location_6 (object->mAttribute_mFilewrapperName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_6, GALGAS_string ("this filewrapper is internal to '").operator_concat (var_filewrapperDeclarationLocation.reader_file (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2089))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2089)).operator_concat (GALGAS_string ("' file")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2089))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2089)) ;
    }
  }
  GALGAS_string var_builtPath = GALGAS_string::makeEmptyString () ;
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2094)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2094)).isValid ()) {
    uint32_t variant_96665 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2094)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2094)).uintValue () ;
    bool loop_96665 = true ;
    while (loop_96665) {
      loop_96665 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2095)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValid () ;
      if (loop_96665) {
        loop_96665 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2095)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolValue () ;
      }
      if (loop_96665 && (0 == variant_96665)) {
        loop_96665 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2094)) ;
      }
      if (loop_96665) {
        variant_96665 -- ;
        GALGAS_string var_directoryName ;
        {
        var_directoryList.modifier_popFirst (var_directoryName, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2097)) ;
        }
        var_builtPath.dotAssign_operation (var_directoryName.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2098))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2098)) ;
        const enumGalgasBool test_7 = var_filewrapperDirectoryMap.reader_hasKey (var_directoryName COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2099)).boolEnum () ;
        if (kBoolTrue == test_7) {
          GALGAS_uint joker_97073 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2101)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_97073, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2100)) ;
        }else if (kBoolFalse == test_7) {
          GALGAS_location location_8 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_8, GALGAS_string ("the '").operator_concat (var_builtPath  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2107)).operator_concat (GALGAS_string ("' path does not exists for the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2107)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2107))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2107)).operator_concat (GALGAS_string ("' filewrapper")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2107))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2107)) ;
          var_filewrapperFileMap.drop () ; // Release error dropped variable
          var_directoryList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2108)) ;
        }
      }
    }
  }
  ...
  const enumGalgasBool test_9 = var_filewrapperFileMap.reader_hasKey (var_fileName COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2113)).boolEnum () ;
  if (kBoolTrue == test_9) {
    GALGAS_string joker_97493 ; // Joker input parameter
    GALGAS_uint joker_97508 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2114)), joker_97493, var_isTextFile, joker_97508, var_fileIndex, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2114)) ;
  }else if (kBoolFalse == test_9) {
    GALGAS_location location_10 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_10, GALGAS_string ("the '").operator_concat (var_fileName  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2117)).operator_concat (GALGAS_string ("' file does not exist in the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2117)).operator_concat (var_builtPath  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2117)).operator_concat (GALGAS_string ("' directory of '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2117)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2117))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2117)).operator_concat (GALGAS_string ("' filewrapper")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2117))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2116)) ;
  ...
  if (kBoolTrue == test_12) {
    ...
    temp_11 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("data"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2125)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2125)) ;
  }
  outArgument_outExpression = GALGAS_filewrapperStaticPathInExpressionForGeneration::constructor_new (temp_11, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2127)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2128)), var_fileIndex, var_isTextFile  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2122)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_lexiqueIntrospectionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_terminalMap joker_98614_3 ; // Joker input parameter
  GALGAS_indexingListAST joker_98614_2 ; // Joker input parameter
  GALGAS_lstring joker_98614_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (object->mAttribute_mLexiqueComponentName, joker_98614_3, joker_98614_2, joker_98614_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2143)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("unknown reader")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2149)) ;
  }
  outArgument_outExpression = GALGAS_lexiqueIntrospectionForGeneration::constructor_new (GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_string ("stringlist").reader_nowhere (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2153)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2153)), object->mAttribute_mLexiqueComponentName.mAttribute_location, object->mAttribute_mLexiqueComponentName.mAttribute_string, object->mAttribute_mLexiqueReaderName.mAttribute_string  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2152)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_expressionCollectionValue_analyze (const cPtr_abstractCollectionValueElement * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), constinArgument_inElementType, constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2179)) ;
  {
  routine_checkAssignmentTypes (constinArgument_inElementType, var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2186)), object->mAttribute_mExpressionLocation, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2186)) ;
  }
  ioArgument_ioCollectionValueElementListForGeneration.addAssign_operation (GALGAS_expressionCollectionValueForGeneration::constructor_new (object->mAttribute_mExpressionLocation, var_expression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2188))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2188)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_expressionListCollectionValue_analyze (const cPtr_abstractCollectionValueElement * inObject,
  ...
  GALGAS_functionSignature var_formalParameterTypeList = constinArgument_inElementType.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2199)) ;
  GALGAS_semanticExpressionListForGeneration var_semanticExpressionListForGeneration ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_formalParameterTypeList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2201)).objectCompare (object->mAttribute_mExpressionList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2201)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfExpressionLocation, GALGAS_string ("element of of '@").operator_concat (constinArgument_inElementType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2202))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2202)).operator_concat (GALGAS_string ("' requires ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2202)).operator_concat (var_formalParameterTypeList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2203)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2202))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2202)).operator_concat (GALGAS_string (" parameter(s), while this list has ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2203)).operator_concat (object->mAttribute_mExpressionList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2204)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2203))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2203)).operator_concat (GALGAS_string (" element(s)")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2204))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2202)) ;
    var_semanticExpressionListForGeneration.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    var_semanticExpressionListForGeneration = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2206)) ;
    cEnumerator_actualOutputExpressionList enumerator_101209 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    cEnumerator_functionSignature enumerator_101234 (var_formalParameterTypeList, kEnumeration_up) ;
    while (enumerator_101209.hasCurrentObject () && enumerator_101234.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_101209.current_mExpression (HERE).ptr (), enumerator_101234.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2208)) ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_101234.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_101209.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string temp_2 ;
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_101234.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_3) {
          temp_2 = GALGAS_string (":") ;
        }else if (kBoolFalse == test_3) {
          temp_2 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_4 (enumerator_101209.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the selector should be '!").operator_concat (enumerator_101234.current_mFormalSelector (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2210))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2210)).operator_concat (temp_2.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2210))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2210))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2210)) ;
      }
      {
      routine_checkAssignmentTypes (enumerator_101234.current_mFormalArgumentType (HERE), var_exp.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2212)), enumerator_101209.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2212)) ;
      }
      var_semanticExpressionListForGeneration.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2213)) ;
      enumerator_101209.gotoNextObject () ;
      enumerator_101234.gotoNextObject () ;
    }
    ioArgument_ioCollectionValueElementListForGeneration.addAssign_operation (GALGAS_expressionListCollectionForGeneration::constructor_new (object->mAttribute_mEndOfExpressionLocation, var_semanticExpressionListForGeneration  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2215))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2215)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_collectionValueAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    var_targetType = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2265)) ;
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_targetType.objectCompare (GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2268)))).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_location location_2 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("Cannot infer type")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2269)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_1) {
    const enumGalgasBool test_3 = var_targetType.reader_mSupportCollectionValue (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2270)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2270)).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_location location_4 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, GALGAS_string ("the @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2271))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2271)).operator_concat (GALGAS_string (" type does not support collection value")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2271))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2271)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_3) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, object->mAttribute_mElementList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2273)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        outArgument_outExpression = GALGAS_defaultConstructorExpressionForGeneration::constructor_new (var_targetType, object->mAttribute_mTypeName.mAttribute_location  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2274)) ;
      }else if (kBoolFalse == test_5) {
        GALGAS_collectionValueElementListForGeneration var_collectionValueElementListForGeneration = GALGAS_collectionValueElementListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2279)) ;
        cEnumerator_collectionValueElementList enumerator_104153 (object->mAttribute_mElementList, kEnumeration_up) ;
        while (enumerator_104153.hasCurrentObject ()) {
          callCategoryMethod_analyze ((const cPtr_abstractCollectionValueElement *) enumerator_104153.current_mElement (HERE).ptr (), constinArgument_inAnalysisContext, var_targetType, ioArgument_ioVariableMap, var_collectionValueElementListForGeneration, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2281)) ;
          enumerator_104153.gotoNextObject () ;
        }
        outArgument_outExpression = GALGAS_expressionCollectionForGeneration::constructor_new (var_targetType, object->mAttribute_mEndOfCollectionValue, var_collectionValueElementListForGeneration  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2288)) ;
      }
    }
  }
}
