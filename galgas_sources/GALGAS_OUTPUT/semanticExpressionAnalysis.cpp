...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (868)).isValid ()) {
      uint32_t variant_48527 = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (868)).uintValue () ;
      bool loop_48527 = true ;
      while (loop_48527) {
        loop_48527 = var_ok.operator_not (SOURCE_FILE_AT_LINE (868)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (868)).reader_isNull (SOURCE_FILE_AT_LINE (868)).operator_not (SOURCE_FILE_AT_LINE (868)) COMMA_SOURCE_FILE_AT_LINE (868)).isValid () ;
        if (loop_48527) {
          loop_48527 = var_ok.operator_not (SOURCE_FILE_AT_LINE (868)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (868)).reader_isNull (SOURCE_FILE_AT_LINE (868)).operator_not (SOURCE_FILE_AT_LINE (868)) COMMA_SOURCE_FILE_AT_LINE (868)).boolValue () ;
        }
        if (loop_48527 && (0 == variant_48527)) {
          loop_48527 = false ;
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        GALGAS_location joker_49106_0 ; // Joker input parameter
        GALGAS_methodQualifier joker_49174_2 ; // Joker input parameter
        GALGAS_string joker_49174_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (879)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (880)), var_kind, var_argumentTypeList, joker_49106_0, var_hasCompilerArgument, var_returnedType, joker_49174_2, joker_49174_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (879)) ;
...
static void categoryMethod_optionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_commandLineOptionMap enumerator_47354 (var_boolOptionMap, kEnumeration_up) ;
    while (enumerator_47354.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47354.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (836)) COMMA_SOURCE_FILE_AT_LINE (836)).operator_concat (GALGAS_string ("' @bool option;") COMMA_SOURCE_FILE_AT_LINE (836)) COMMA_SOURCE_FILE_AT_LINE (836)) ;
      enumerator_47354.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_47450 (var_uintOptionMap, kEnumeration_up) ;
    while (enumerator_47450.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47450.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (839)) COMMA_SOURCE_FILE_AT_LINE (839)).operator_concat (GALGAS_string ("' @uint option;") COMMA_SOURCE_FILE_AT_LINE (839)) COMMA_SOURCE_FILE_AT_LINE (839)) ;
      enumerator_47450.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_47548 (var_stringOptionMap, kEnumeration_up) ;
    while (enumerator_47548.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47548.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (842)) COMMA_SOURCE_FILE_AT_LINE (842)).operator_concat (GALGAS_string ("' @string option;") COMMA_SOURCE_FILE_AT_LINE (842)) COMMA_SOURCE_FILE_AT_LINE (842)) ;
      enumerator_47548.gotoNextObject () ;
    }
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_unifiedTypeMapProxyList enumerator_77966 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_semanticExpressionListAST enumerator_77980 (object->mAttribute_mExpressions, kEnumeration_up) ;
    while (enumerator_77966.hasCurrentObject () && enumerator_77980.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_expression ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_77980.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1657)) ;
      {
      routine_checkAssignmentTypes (enumerator_77966.current_mType (HERE), var_expression.reader_mType (SOURCE_FILE_AT_LINE (1658)), enumerator_77980.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1658)) ;
      }
      var_semanticExpressionListForGeneration.addAssign_operation (var_expression COMMA_SOURCE_FILE_AT_LINE (1659)) ;
      enumerator_77966.gotoNextObject () ;
      enumerator_77980.gotoNextObject () ;
    }
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool joker_79581_23 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_79581_22 ; // Joker input parameter
  GALGAS_typeKindEnum joker_79581_21 ; // Joker input parameter
  GALGAS_typedAttributeList joker_79581_20 ; // Joker input parameter
  GALGAS_attributeMap joker_79581_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_79581_18 ; // Joker input parameter
  GALGAS_constructorMap joker_79581_17 ; // Joker input parameter
  GALGAS_readerMap joker_79581_16 ; // Joker input parameter
  GALGAS_modifierMap joker_79581_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_79581_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_79581_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_79581_12 ; // Joker input parameter
  GALGAS_stringlist joker_79581_11 ; // Joker input parameter
  GALGAS_uint joker_79581_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_79581_9 ; // Joker input parameter
  GALGAS_stringset joker_79581_8 ; // Joker input parameter
  GALGAS_lstringlist joker_79581_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_79581_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_79581_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_79581_4 ; // Joker input parameter
  GALGAS_bool joker_79581_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_79581_2 ; // Joker input parameter
  GALGAS_string joker_79581_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_79581_23, joker_79581_22, joker_79581_21, joker_79581_20, joker_79581_19, joker_79581_18, joker_79581_17, joker_79581_16, joker_79581_15, joker_79581_14, joker_79581_13, joker_79581_12, joker_79581_11, joker_79581_10, joker_79581_9, joker_79581_8, joker_79581_7, joker_79581_6, joker_79581_5, joker_79581_4, joker_79581_3, joker_79581_2, joker_79581_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1697)) ;
...
static void categoryMethod_testDynamicClassInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1723)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1723)).isValid ()) {
      uint32_t variant_80703 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1723)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1723)).uintValue () ;
      bool loop_80703 = true ;
      while (loop_80703) {
        loop_80703 = var_found.operator_not (SOURCE_FILE_AT_LINE (1724)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1724)).reader_isNull (SOURCE_FILE_AT_LINE (1724)).operator_not (SOURCE_FILE_AT_LINE (1724)) COMMA_SOURCE_FILE_AT_LINE (1724)).isValid () ;
        if (loop_80703) {
          loop_80703 = var_found.operator_not (SOURCE_FILE_AT_LINE (1724)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1724)).reader_isNull (SOURCE_FILE_AT_LINE (1724)).operator_not (SOURCE_FILE_AT_LINE (1724)) COMMA_SOURCE_FILE_AT_LINE (1724)).boolValue () ;
        }
        if (loop_80703 && (0 == variant_80703)) {
          loop_80703 = false ;
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1770)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1770)).isValid ()) {
      uint32_t variant_82355 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1770)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1770)).uintValue () ;
      bool loop_82355 = true ;
      while (loop_82355) {
        loop_82355 = var_found.operator_not (SOURCE_FILE_AT_LINE (1771)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1771)).reader_isNull (SOURCE_FILE_AT_LINE (1771)).operator_not (SOURCE_FILE_AT_LINE (1771)) COMMA_SOURCE_FILE_AT_LINE (1771)).isValid () ;
        if (loop_82355) {
          loop_82355 = var_found.operator_not (SOURCE_FILE_AT_LINE (1771)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1771)).reader_isNull (SOURCE_FILE_AT_LINE (1771)).operator_not (SOURCE_FILE_AT_LINE (1771)) COMMA_SOURCE_FILE_AT_LINE (1771)).boolValue () ;
        }
        if (loop_82355 && (0 == variant_82355)) {
          loop_82355 = false ;
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstringlist joker_84036_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_84039_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_84042_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_84045_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_84036_0, joker_84039_0, joker_84042_0, joker_84045_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1817)) ;
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_84796_0 ; // Joker input parameter
  GALGAS_lstringlist joker_84799_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_84802_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_84805_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_84796_0, joker_84799_0, joker_84802_0, joker_84805_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1836)) ;
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  GALGAS_lstring joker_84968_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_84968_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1839)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_semanticExpressionListAST enumerator_85555 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_85574 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_85555.hasCurrentObject () && enumerator_85574.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_85555.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (1852)) ;
      {
      routine_checkAssignmentTypes (enumerator_85574.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (1853)), enumerator_85555.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1853)) ;
      }
      var_effectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (1854)) ;
      enumerator_85555.gotoNextObject () ;
      enumerator_85574.gotoNextObject () ;
    }
  }
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_87104_0 ; // Joker input parameter
  GALGAS_lstringlist joker_87111_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_87171_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_87104_0, joker_87111_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87171_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1888)) ;
  ...
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1898)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1898)).isValid ()) {
    uint32_t variant_87234 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1898)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1898)).uintValue () ;
    bool loop_87234 = true ;
    while (loop_87234) {
      loop_87234 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1899)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValid () ;
      if (loop_87234) {
        loop_87234 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1899)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolValue () ;
      }
      if (loop_87234 && (0 == variant_87234)) {
        loop_87234 = false ;
      ...
      if (loop_87234) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_uint joker_87642_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1905)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87642_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1904)) ;
        }else if (kBoolFalse == test_4) {
  ...
  if (kBoolTrue == test_6) {
    GALGAS_string joker_88062_0 ; // Joker input parameter
    GALGAS_uint joker_88077_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1918)), joker_88062_0, var_isTextFile, joker_88077_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1918)) ;
  }else if (kBoolFalse == test_6) {
