...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_46161_5 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_46161_4 ; // Joker input parameter
    GALGAS_location joker_46161_3 ; // Joker input parameter
    GALGAS_bool joker_46161_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_46161_1 ; // Joker input parameter
    GALGAS_string joker_46176_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (811)).method_searchKey (constinArgument_inReaderName, joker_46161_5, joker_46161_4, joker_46161_3, joker_46161_2, joker_46161_1, var_qualifier, joker_46176_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (811)) ;
    //-------- END @methodCallInstructionForGeneration
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1001)).isValid ()) {
      PMUInt32 variant_53833 = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (1001)).uintValue () ;
      bool loop_53833 = true ;
      while (loop_53833) {
        loop_53833 = var_ok.operator_not (SOURCE_FILE_AT_LINE (1001)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1001)).reader_isNull (SOURCE_FILE_AT_LINE (1001)).operator_not (SOURCE_FILE_AT_LINE (1001)) COMMA_SOURCE_FILE_AT_LINE (1001)).isValid () ;
        if (loop_53833) {
          loop_53833 = var_ok.operator_not (SOURCE_FILE_AT_LINE (1001)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1001)).reader_isNull (SOURCE_FILE_AT_LINE (1001)).operator_not (SOURCE_FILE_AT_LINE (1001)) COMMA_SOURCE_FILE_AT_LINE (1001)).boolValue () ;
        }
        if (loop_53833 && (0 == variant_53833)) {
          loop_53833 = false ;
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        //-------- @methodCallInstructionForGeneration
        GALGAS_location joker_54432_0 ; // Joker input parameter
        GALGAS_methodQualifier joker_54500_2 ; // Joker input parameter
        GALGAS_string joker_54500_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1013)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1014)), var_isCategory, var_argumentTypeList, joker_54432_0, var_hasCompilerArgument, var_returnedType, joker_54500_2, joker_54500_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1013)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_readerCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (NULL != objectArray_38585) {
    ...
    //-------- @assignmentInstructionForGeneration
    var_isCategory = objectArray_38585->mAttribute_mIsCategory ;
    //-------- @ifInstructionForGeneration
    ...
    if (kBoolTrue == test_2) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_typedAttributeList enumerator_39244 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (643)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_39244.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_unifiedTypeMapProxy var_attributeType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (enumerator_39244.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (644)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (644)), inCompiler COMMA_SOURCE_FILE_AT_LINE (644)) ;
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_readerMap var_aMap = var_attributeType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (645)) ;
        //-------- @readOnlyWithInstructionForGeneration
        const cMapElement_readerMap * objectArray_39483 = (const cMapElement_readerMap *) var_aMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (646))) ;
        if (NULL != objectArray_39483) {
            macroValidSharedObject (objectArray_39483, const cMapElement_readerMap) ;
          //-------- @incrementInstructionForGeneration
          var_matchingReaderCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (647)) ;
          //-------- @assignmentInstructionForGeneration
          var_readerFormalArgumentTypeList = objectArray_39483->mAttribute_mArgumentTypeList ;
          //-------- @assignmentInstructionForGeneration
          var_hasCompilerArgument = objectArray_39483->mAttribute_mHasCompilerArgument ;
          //-------- @assignmentInstructionForGeneration
          var_returnedType = objectArray_39483->mAttribute_mReturnedType ;
          //-------- @assignmentInstructionForGeneration
          var_isCategory = objectArray_39483->mAttribute_mIsCategory ;
          //-------- @addAssignInstructionForGeneration
          var_fieldList.addAssign_operation (enumerator_39244.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (652)) COMMA_SOURCE_FILE_AT_LINE (652)) ;
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, objectArray_39483->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_3) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_4 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_4, objectArray_39483->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (654)) ;
          }
        }
        enumerator_39244.gotoNextObject () ;
      }
      //-------- @ifInstructionForGeneration
      ...
      if (kBoolTrue == test_5) {
        ...
        if (kBoolTrue == test_7) {
          ...
          GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_stringlist enumerator_40367 (var_fieldList, kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_40367.hasCurrentObject ()) {
            //-------- @appendInstructionForGeneration
            var_s.dotAssign_operation (enumerator_40367.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (667)) ;
            if (enumerator_40367.hasNextObject ()) {
              //-------- @appendInstructionForGeneration
      ...
      if (kBoolTrue == test_9) {
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_readerMap enumerator_41067 (var_readerMap, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_41067.hasCurrentObject ()) {
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_41067.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (684)) COMMA_SOURCE_FILE_AT_LINE (684)) COMMA_SOURCE_FILE_AT_LINE (684)) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_unifiedTypeMapProxyList enumerator_41135 (enumerator_41067.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_41135.hasCurrentObject ()) {
            //-------- @appendInstructionForGeneration
            var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_41135.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (686)) COMMA_SOURCE_FILE_AT_LINE (686)) COMMA_SOURCE_FILE_AT_LINE (686)) ;
            enumerator_41135.gotoNextObject () ;
          }
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_41067.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (688)) COMMA_SOURCE_FILE_AT_LINE (688)) COMMA_SOURCE_FILE_AT_LINE (688)) ;
  ...
  if (kBoolTrue == test_14) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_42093 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_42125 (var_readerFormalArgumentTypeList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_42093.hasCurrentObject () && enumerator_42125.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_exp ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_42093.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (707)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_42125.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (708)), enumerator_42093.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (708)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      ...
      enumerator_42125.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (var_returnedType, object->mAttribute_mReaderName.reader_location (SOURCE_FILE_AT_LINE (713)), var_isCategory, var_receiverExpression, var_fieldList, object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (717)), var_constructorEffectiveParameterList, var_hasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (711)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_thisReaderCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_returnedType ;
  //-------- @readOnlyWithInstructionForGeneration
  const cMapElement_readerMap * objectArray_43663 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (747))) ;
  if (NULL != objectArray_43663) {
      macroValidSharedObject (objectArray_43663, const cMapElement_readerMap) ;
    //-------- @assignmentInstructionForGeneration
    var_readerFormalArgumentTypeList = objectArray_43663->mAttribute_mArgumentTypeList ;
    //-------- @assignmentInstructionForGeneration
    var_hasCompilerArgument = objectArray_43663->mAttribute_mHasCompilerArgument ;
    //-------- @assignmentInstructionForGeneration
    var_returnedType = objectArray_43663->mAttribute_mReturnedType ;
    //-------- @assignmentInstructionForGeneration
    var_isCategory = objectArray_43663->mAttribute_mIsCategory ;
  }else{
    //-------- @ifInstructionForGeneration
    ...
    if (kBoolTrue == test_1) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_readerMap enumerator_44163 (var_readerMap, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_44163.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_44163.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (761)) COMMA_SOURCE_FILE_AT_LINE (761)) COMMA_SOURCE_FILE_AT_LINE (761)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_unifiedTypeMapProxyList enumerator_44231 (enumerator_44163.current_mArgumentTypeList (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_44231.hasCurrentObject ()) {
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_44231.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (763)) COMMA_SOURCE_FILE_AT_LINE (763)) COMMA_SOURCE_FILE_AT_LINE (763)) ;
          enumerator_44231.gotoNextObject () ;
        }
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_44163.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (765)) COMMA_SOURCE_FILE_AT_LINE (765)) COMMA_SOURCE_FILE_AT_LINE (765)) ;
        enumerator_44163.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      //--- @ifExpressionForGeneration
  ...
  if (kBoolTrue == test_6) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_45191 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_45223 (var_readerFormalArgumentTypeList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_45191.hasCurrentObject () && enumerator_45223.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_exp ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_45191.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (784)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_45223.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (785)), enumerator_45191.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (785)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_constructorEffectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (786)) ;
      enumerator_45191.gotoNextObject () ;
      enumerator_45223.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_thisReaderCallExpressionForGeneration::constructor_new (var_returnedType, object->mAttribute_mReaderName.reader_location (SOURCE_FILE_AT_LINE (790)), var_currentObjectCppPointer, var_isCategory, object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (793)), var_constructorEffectiveParameterList, var_hasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (788)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_superReaderCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_string joker_47076_0 ; // Joker input parameter
    GALGAS_string joker_47079_0 ; // Joker input parameter
    ioArgument_ioVariableMap.modifier_searchForReadAccess (GALGAS_lstring::constructor_new (function_selfMarkName (inCompiler COMMA_SOURCE_FILE_AT_LINE (834)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (834)), var_thisTypeProxy, joker_47076_0, joker_47079_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (834)) ;
  ...
  //-------- @readOnlyWithInstructionForGeneration
  const cMapElement_readerMap * objectArray_47730 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (851))) ;
  if (NULL != objectArray_47730) {
      macroValidSharedObject (objectArray_47730, const cMapElement_readerMap) ;
    //-------- @assignmentInstructionForGeneration
    var_readerFormalArgumentTypeList = objectArray_47730->mAttribute_mArgumentTypeList ;
    //-------- @assignmentInstructionForGeneration
    var_hasCompilerArgument = objectArray_47730->mAttribute_mHasCompilerArgument ;
    //-------- @assignmentInstructionForGeneration
    var_returnedType = objectArray_47730->mAttribute_mReturnedType ;
    //-------- @assignmentInstructionForGeneration
    var_isCategory = objectArray_47730->mAttribute_mIsCategory ;
    //-------- @assignmentInstructionForGeneration
    ...
    if (kBoolTrue == test_4) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_readerMap enumerator_48536 (var_readerMap, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_48536.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_48536.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_unifiedTypeMapProxyList enumerator_48604 (enumerator_48536.current_mArgumentTypeList (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_48604.hasCurrentObject ()) {
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_48604.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (871)) COMMA_SOURCE_FILE_AT_LINE (871)) COMMA_SOURCE_FILE_AT_LINE (871)) ;
          enumerator_48604.gotoNextObject () ;
        }
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_48536.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (873)) COMMA_SOURCE_FILE_AT_LINE (873)) COMMA_SOURCE_FILE_AT_LINE (873)) ;
  ...
  if (kBoolTrue == test_9) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_49598 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_49630 (var_readerFormalArgumentTypeList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_49598.hasCurrentObject () && enumerator_49630.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_exp ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_49598.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (892)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_49630.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (893)), enumerator_49598.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (893)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_constructorEffectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (894)) ;
      enumerator_49598.gotoNextObject () ;
      enumerator_49630.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_superReaderCallExpressionForGeneration::constructor_new (var_returnedType, object->mAttribute_mReaderName.reader_location (SOURCE_FILE_AT_LINE (898)), var_isCategory, var_superClassThatImplementsReader, object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (901)), var_constructorEffectiveParameterList, var_hasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (896)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_optionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_52661 (var_boolOptionMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_52661.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_52661.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (969)) COMMA_SOURCE_FILE_AT_LINE (969)).operator_concat (GALGAS_string ("' @bool option;") COMMA_SOURCE_FILE_AT_LINE (969)) COMMA_SOURCE_FILE_AT_LINE (969)) ;
      enumerator_52661.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_52757 (var_uintOptionMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_52757.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_52757.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (972)) COMMA_SOURCE_FILE_AT_LINE (972)).operator_concat (GALGAS_string ("' @uint option;") COMMA_SOURCE_FILE_AT_LINE (972)) COMMA_SOURCE_FILE_AT_LINE (972)) ;
      enumerator_52757.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_52855 (var_stringOptionMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_52855.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_52855.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (975)) COMMA_SOURCE_FILE_AT_LINE (975)).operator_concat (GALGAS_string ("' @string option;") COMMA_SOURCE_FILE_AT_LINE (975)) COMMA_SOURCE_FILE_AT_LINE (975)) ;
      enumerator_52855.gotoNextObject () ;
    }
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_unifiedTypeMapProxyList enumerator_83298 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_semanticExpressionListAST enumerator_83314 (object->mAttribute_mExpressions, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_83298.hasCurrentObject () && enumerator_83314.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_expression ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_83314.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1791)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_83298.current_mType (HERE), var_expression.reader_mType (SOURCE_FILE_AT_LINE (1792)), enumerator_83314.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1792)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_semanticExpressionListForGeneration.addAssign_operation (var_expression COMMA_SOURCE_FILE_AT_LINE (1793)) ;
      enumerator_83298.gotoNextObject () ;
      enumerator_83314.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_84914_21 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_84914_20 ; // Joker input parameter
  GALGAS_typeKindEnum joker_84914_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_84914_18 ; // Joker input parameter
  GALGAS_attributeMap joker_84914_17 ; // Joker input parameter
  GALGAS_typedAttributeList joker_84914_16 ; // Joker input parameter
  GALGAS_constructorMap joker_84914_15 ; // Joker input parameter
  GALGAS_readerMap joker_84914_14 ; // Joker input parameter
  GALGAS_modifierMap joker_84914_13 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_84914_12 ; // Joker input parameter
  GALGAS_classMethodMap joker_84914_11 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_84914_10 ; // Joker input parameter
  GALGAS_stringlist joker_84914_9 ; // Joker input parameter
  GALGAS_uint joker_84914_8 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_84914_7 ; // Joker input parameter
  GALGAS_stringset joker_84914_6 ; // Joker input parameter
  GALGAS_lstringlist joker_84914_5 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_84914_4 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_84914_3 ; // Joker input parameter
  GALGAS_withAccessorMap joker_84914_2 ; // Joker input parameter
  GALGAS_bool joker_84914_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_84914_21, joker_84914_20, joker_84914_19, joker_84914_18, joker_84914_17, joker_84914_16, joker_84914_15, joker_84914_14, joker_84914_13, joker_84914_12, joker_84914_11, joker_84914_10, joker_84914_9, joker_84914_8, joker_84914_7, joker_84914_6, joker_84914_5, joker_84914_4, joker_84914_3, joker_84914_2, joker_84914_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1831)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1857)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1857)).isValid ()) {
      PMUInt32 variant_86041 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1857)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1857)).uintValue () ;
      bool loop_86041 = true ;
      while (loop_86041) {
        loop_86041 = var_found.operator_not (SOURCE_FILE_AT_LINE (1858)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1858)).reader_isNull (SOURCE_FILE_AT_LINE (1858)).operator_not (SOURCE_FILE_AT_LINE (1858)) COMMA_SOURCE_FILE_AT_LINE (1858)).isValid () ;
        if (loop_86041) {
          loop_86041 = var_found.operator_not (SOURCE_FILE_AT_LINE (1858)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1858)).reader_isNull (SOURCE_FILE_AT_LINE (1858)).operator_not (SOURCE_FILE_AT_LINE (1858)) COMMA_SOURCE_FILE_AT_LINE (1858)).boolValue () ;
        }
        if (loop_86041 && (0 == variant_86041)) {
          loop_86041 = false ;
  ...
  if (kBoolTrue == test_4) {
    ...
    //-------- @readOnlyWithInstructionForGeneration
    const cMapElement_readerMap * objectArray_87196 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (GALGAS_string ("location")) ;
    if (NULL != objectArray_87196) {
        macroValidSharedObject (objectArray_87196, const cMapElement_readerMap) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, objectArray_87196->mAttribute_mArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (1879)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        //-------- @errorInstructionForGeneration
        ...
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, objectArray_87196->mAttribute_mReturnedType.objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType)).boolEnum () ;
        if (kBoolTrue == test_6) {
          //-------- @errorInstructionForGeneration
          inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorLocationExpression, GALGAS_string ("the error location expression type is '@").operator_concat (var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1886)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1886)) COMMA_SOURCE_FILE_AT_LINE (1886)).operator_concat (GALGAS_string ("' and defines a 'location' reader that returns an '@") COMMA_SOURCE_FILE_AT_LINE (1887)).operator_concat (objectArray_87196->mAttribute_mReturnedType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1887)) COMMA_SOURCE_FILE_AT_LINE (1887)).operator_concat (GALGAS_string ("' object; it should be either of the '@location' type, either defines a 'location' reader without argument that returns an '@location' object") COMMA_SOURCE_FILE_AT_LINE (1888)) COMMA_SOURCE_FILE_AT_LINE (1885)) ;
        }
      }
      //-------- @assignmentInstructionForGeneration
      var_errorLocationExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType, object->mAttribute_mEndOfErrorLocationExpression, GALGAS_bool (false), var_errorLocationExpression, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1896)), GALGAS_string ("location"), GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1898)), objectArray_87196->mAttribute_mHasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1891)) ;
    }else{
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstringlist joker_89816_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_89819_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_89822_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_89825_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_89816_0, joker_89819_0, joker_89822_0, joker_89825_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1938)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_90576_0 ; // Joker input parameter
  GALGAS_lstringlist joker_90579_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_90582_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_90585_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_90576_0, joker_90579_0, joker_90582_0, joker_90585_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1957)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_90748_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_90748_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1960)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_91335 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_91356 (var_templateSignature, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_91335.hasCurrentObject () && enumerator_91356.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_exp ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_91335.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (1973)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_91356.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (1974)), enumerator_91335.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1974)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_effectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (1975)) ;
      enumerator_91335.gotoNextObject () ;
      enumerator_91356.gotoNextObject () ;
    }
  }
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_92876_0 ; // Joker input parameter
  GALGAS_lstringlist joker_92879_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_92927_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_92876_0, joker_92879_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_92927_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2009)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (2012)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2012)).isValid ()) {
    PMUInt32 variant_92988 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (2012)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (2012)).uintValue () ;
    bool loop_92988 = true ;
    while (loop_92988) {
      loop_92988 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (2013)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_92988) {
        loop_92988 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (2013)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_92988 && (0 == variant_92988)) {
        loop_92988 = false ;
      ...
      if (loop_92988) {
        ...
        if (kBoolTrue == test_4) {
          //-------- @methodCallInstructionForGeneration
          GALGAS_uint joker_93395_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2019)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_93395_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2018)) ;
          //-------- END @methodCallInstructionForGeneration
        }else if (kBoolFalse == test_4) {
          //-------- @errorInstructionForGeneration
  ...
  if (kBoolTrue == test_6) {
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_93794_3 ; // Joker input parameter
    GALGAS_bool joker_93794_2 ; // Joker input parameter
    GALGAS_uint joker_93794_1 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2031)), joker_93794_3, joker_93794_2, joker_93794_1, var_fileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2031)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_6) {
    //-------- @errorInstructionForGeneration
