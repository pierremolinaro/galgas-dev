...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_methodKind joker_44826_5 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_44826_4 ; // Joker input parameter
    GALGAS_location joker_44826_3 ; // Joker input parameter
    GALGAS_bool joker_44826_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_44826_1 ; // Joker input parameter
    GALGAS_string joker_44841_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (764)).method_searchKey (constinArgument_inReaderName, joker_44826_5, joker_44826_4, joker_44826_3, joker_44826_2, joker_44826_1, var_qualifier, joker_44841_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (764)) ;
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (869)).isValid ()) {
      uint32_t variant_48821 = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (869)).uintValue () ;
      bool loop_48821 = true ;
      while (loop_48821) {
        loop_48821 = var_ok.operator_not (SOURCE_FILE_AT_LINE (869)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (869)).reader_isNull (SOURCE_FILE_AT_LINE (869)).operator_not (SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)).isValid () ;
        if (loop_48821) {
          loop_48821 = var_ok.operator_not (SOURCE_FILE_AT_LINE (869)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (869)).reader_isNull (SOURCE_FILE_AT_LINE (869)).operator_not (SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)).boolValue () ;
        }
        if (loop_48821 && (0 == variant_48821)) {
          loop_48821 = false ;
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        GALGAS_location joker_49400_0 ; // Joker input parameter
        GALGAS_methodQualifier joker_49468_2 ; // Joker input parameter
        GALGAS_string joker_49468_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (880)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (881)), var_kind, var_argumentTypeList, joker_49400_0, var_hasCompilerArgument, var_returnedType, joker_49468_2, joker_49468_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (880)) ;
...
static void categoryMethod_readerCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const cMapElement_readerMap * objectArray_40360 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (657))) ;
  if (NULL != objectArray_40360) {
      macroValidSharedObject (objectArray_40360, cMapElement_readerMap) ;
    var_readerFormalArgumentTypeList = objectArray_40360->mAttribute_mArgumentTypeList ;
    var_hasCompilerArgument = objectArray_40360->mAttribute_mHasCompilerArgument ;
    var_returnedType = objectArray_40360->mAttribute_mReturnedType ;
    var_kind = objectArray_40360->mAttribute_mKind ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, objectArray_40360->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, objectArray_40360->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (663)) ;
    }
  }else{
    ...
    if (kBoolTrue == test_2) {
      ...
      while (enumerator_41047.hasCurrentObject ()) {
        ...
        const cMapElement_readerMap * objectArray_41276 = (const cMapElement_readerMap *) var_aMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (675))) ;
        if (NULL != objectArray_41276) {
            macroValidSharedObject (objectArray_41276, cMapElement_readerMap) ;
          var_matchingReaderCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (676)) ;
          var_readerFormalArgumentTypeList = objectArray_41276->mAttribute_mArgumentTypeList ;
          var_hasCompilerArgument = objectArray_41276->mAttribute_mHasCompilerArgument ;
          var_returnedType = objectArray_41276->mAttribute_mReturnedType ;
          var_kind = objectArray_41276->mAttribute_mKind ;
          ...
          const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, objectArray_41276->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_location location_4 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_4, objectArray_41276->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (683)) ;
          }
        }
      ...
      if (kBoolTrue == test_5) {
        ...
        if (kBoolTrue == test_7) {
          GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
          cEnumerator_stringlist enumerator_42134 (var_fieldList, kEnumeration_up) ;
          while (enumerator_42134.hasCurrentObject ()) {
            var_s.dotAssign_operation (enumerator_42134.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (696)) ;
            if (enumerator_42134.hasNextObject ()) {
              var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (697)) ;
            }
            enumerator_42134.gotoNextObject () ;
          }
      ...
      if (kBoolTrue == test_9) {
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_readerMap enumerator_42832 (var_readerMap, kEnumeration_up) ;
        while (enumerator_42832.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_42832.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (713)) COMMA_SOURCE_FILE_AT_LINE (713)) COMMA_SOURCE_FILE_AT_LINE (713)) ;
          cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_42900 (enumerator_42832.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          while (enumerator_42900.hasCurrentObject ()) {
            var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_42900.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (715)) COMMA_SOURCE_FILE_AT_LINE (715)) COMMA_SOURCE_FILE_AT_LINE (715)) ;
            enumerator_42900.gotoNextObject () ;
          }
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_42832.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (717)) COMMA_SOURCE_FILE_AT_LINE (717)) COMMA_SOURCE_FILE_AT_LINE (717)) ;
  ...
  if (kBoolTrue == test_14) {
    ...
    cEnumerator_semanticExpressionListAST enumerator_43854 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_43884 (var_readerFormalArgumentTypeList, kEnumeration_up) ;
    while (enumerator_43854.hasCurrentObject () && enumerator_43884.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_43854.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (736)) ;
      {
      routine_checkAssignmentTypes (enumerator_43884.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (737)), enumerator_43854.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (737)) ;
      }
...
static void categoryMethod_optionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_commandLineOptionMap enumerator_47648 (var_boolOptionMap, kEnumeration_up) ;
    while (enumerator_47648.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47648.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (837)) COMMA_SOURCE_FILE_AT_LINE (837)).operator_concat (GALGAS_string ("' @bool option;") COMMA_SOURCE_FILE_AT_LINE (837)) COMMA_SOURCE_FILE_AT_LINE (837)) ;
      enumerator_47648.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_47744 (var_uintOptionMap, kEnumeration_up) ;
    while (enumerator_47744.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47744.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (840)).operator_concat (GALGAS_string ("' @uint option;") COMMA_SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (840)) ;
      enumerator_47744.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_47842 (var_stringOptionMap, kEnumeration_up) ;
    while (enumerator_47842.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47842.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (843)) COMMA_SOURCE_FILE_AT_LINE (843)).operator_concat (GALGAS_string ("' @string option;") COMMA_SOURCE_FILE_AT_LINE (843)) COMMA_SOURCE_FILE_AT_LINE (843)) ;
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_unifiedTypeMapProxyList enumerator_78260 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_semanticExpressionListAST enumerator_78274 (object->mAttribute_mExpressions, kEnumeration_up) ;
    while (enumerator_78260.hasCurrentObject () && enumerator_78274.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_expression ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_78274.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1658)) ;
      {
      routine_checkAssignmentTypes (enumerator_78260.current_mType (HERE), var_expression.reader_mType (SOURCE_FILE_AT_LINE (1659)), enumerator_78274.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1659)) ;
      }
      ...
      enumerator_78274.gotoNextObject () ;
    }
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool joker_79875_23 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_79875_22 ; // Joker input parameter
  GALGAS_typeKindEnum joker_79875_21 ; // Joker input parameter
  GALGAS_typedAttributeList joker_79875_20 ; // Joker input parameter
  GALGAS_attributeMap joker_79875_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_79875_18 ; // Joker input parameter
  GALGAS_constructorMap joker_79875_17 ; // Joker input parameter
  GALGAS_readerMap joker_79875_16 ; // Joker input parameter
  GALGAS_modifierMap joker_79875_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_79875_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_79875_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_79875_12 ; // Joker input parameter
  GALGAS_stringlist joker_79875_11 ; // Joker input parameter
  GALGAS_uint joker_79875_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_79875_9 ; // Joker input parameter
  GALGAS_stringset joker_79875_8 ; // Joker input parameter
  GALGAS_lstringlist joker_79875_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_79875_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_79875_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_79875_4 ; // Joker input parameter
  GALGAS_bool joker_79875_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_79875_2 ; // Joker input parameter
  GALGAS_string joker_79875_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_79875_23, joker_79875_22, joker_79875_21, joker_79875_20, joker_79875_19, joker_79875_18, joker_79875_17, joker_79875_16, joker_79875_15, joker_79875_14, joker_79875_13, joker_79875_12, joker_79875_11, joker_79875_10, joker_79875_9, joker_79875_8, joker_79875_7, joker_79875_6, joker_79875_5, joker_79875_4, joker_79875_3, joker_79875_2, joker_79875_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1698)) ;
...
static void categoryMethod_testDynamicClassInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1724)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1724)).isValid ()) {
      uint32_t variant_80997 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1724)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1724)).uintValue () ;
      bool loop_80997 = true ;
      while (loop_80997) {
        loop_80997 = var_found.operator_not (SOURCE_FILE_AT_LINE (1725)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1725)).reader_isNull (SOURCE_FILE_AT_LINE (1725)).operator_not (SOURCE_FILE_AT_LINE (1725)) COMMA_SOURCE_FILE_AT_LINE (1725)).isValid () ;
        if (loop_80997) {
          loop_80997 = var_found.operator_not (SOURCE_FILE_AT_LINE (1725)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1725)).reader_isNull (SOURCE_FILE_AT_LINE (1725)).operator_not (SOURCE_FILE_AT_LINE (1725)) COMMA_SOURCE_FILE_AT_LINE (1725)).boolValue () ;
        }
        if (loop_80997 && (0 == variant_80997)) {
          loop_80997 = false ;
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1771)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1771)).isValid ()) {
      uint32_t variant_82649 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1771)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1771)).uintValue () ;
      bool loop_82649 = true ;
      while (loop_82649) {
        loop_82649 = var_found.operator_not (SOURCE_FILE_AT_LINE (1772)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1772)).reader_isNull (SOURCE_FILE_AT_LINE (1772)).operator_not (SOURCE_FILE_AT_LINE (1772)) COMMA_SOURCE_FILE_AT_LINE (1772)).isValid () ;
        if (loop_82649) {
          loop_82649 = var_found.operator_not (SOURCE_FILE_AT_LINE (1772)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1772)).reader_isNull (SOURCE_FILE_AT_LINE (1772)).operator_not (SOURCE_FILE_AT_LINE (1772)) COMMA_SOURCE_FILE_AT_LINE (1772)).boolValue () ;
        }
        if (loop_82649 && (0 == variant_82649)) {
          loop_82649 = false ;
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_unifiedTypeMapProxyList enumerator_85868 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_85849.hasCurrentObject () && enumerator_85868.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      ...
      {
      routine_checkAssignmentTypes (enumerator_85868.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (1854)), enumerator_85849.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1854)) ;
      }
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1899)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1899)).isValid ()) {
    uint32_t variant_87528 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1899)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1899)).uintValue () ;
    bool loop_87528 = true ;
    while (loop_87528) {
      loop_87528 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1900)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValid () ;
      if (loop_87528) {
        loop_87528 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1900)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolValue () ;
      }
      if (loop_87528 && (0 == variant_87528)) {
        loop_87528 = false ;
