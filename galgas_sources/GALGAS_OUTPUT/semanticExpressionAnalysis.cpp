...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_methodKind joker_46110_5 ; // Joker input parameter
    GALGAS_functionSignature joker_46110_4 ; // Joker input parameter
    GALGAS_location joker_46110_3 ; // Joker input parameter
    GALGAS_bool joker_46110_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_46110_1 ; // Joker input parameter
    GALGAS_string joker_46125_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 793)).method_searchKey (constinArgument_inReaderName, joker_46110_5, joker_46110_4, joker_46110_3, joker_46110_2, joker_46110_1, var_qualifier, joker_46125_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 793)) ;
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).isValid ()) {
      uint32_t variant_50320 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).uintValue () ;
      bool loop_50320 = true ;
      while (loop_50320) {
        loop_50320 = var_ok.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).isValid () ;
        if (loop_50320) {
          loop_50320 = var_ok.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).boolValue () ;
        }
        if (loop_50320 && (0 == variant_50320)) {
          loop_50320 = false ;
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        GALGAS_location joker_50881_0 ; // Joker input parameter
        GALGAS_methodQualifier joker_50949_2 ; // Joker input parameter
        GALGAS_string joker_50949_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 915)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 916)), var_kind, var_argumentTypeList, joker_50881_0, var_hasCompilerArgument, var_returnedType, joker_50949_2, joker_50949_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 915)) ;
...
static void categoryMethod_readerCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_receiverType = var_receiverExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 676)) ;
  ...
  const cMapElement_readerMap * objectArray_41337 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 685))) ;
  if (NULL != objectArray_41337) {
      macroValidSharedObject (objectArray_41337, cMapElement_readerMap) ;
    var_readerFormalArgumentTypeList = objectArray_41337->mAttribute_mArgumentTypeList ;
    var_hasCompilerArgument = objectArray_41337->mAttribute_mHasCompilerArgument ;
    var_returnedType = objectArray_41337->mAttribute_mReturnedType ;
    var_kind = objectArray_41337->mAttribute_mKind ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, objectArray_41337->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, objectArray_41337->mAttribute_mErrorMessage  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 691)) ;
    }
  }else{
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_typedAttributeList enumerator_41978 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 700)), kEnumeration_up) ;
      while (enumerator_41978.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_attributeType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (enumerator_41978.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 701)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 701)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 701)) ;
        ...
        const cMapElement_readerMap * objectArray_42207 = (const cMapElement_readerMap *) var_aMap.readAccessForWithInstruction (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 703))) ;
        if (NULL != objectArray_42207) {
            macroValidSharedObject (objectArray_42207, cMapElement_readerMap) ;
          var_matchingReaderCount.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 704)) ;
          var_readerFormalArgumentTypeList = objectArray_42207->mAttribute_mArgumentTypeList ;
          var_hasCompilerArgument = objectArray_42207->mAttribute_mHasCompilerArgument ;
          var_returnedType = objectArray_42207->mAttribute_mReturnedType ;
          var_kind = objectArray_42207->mAttribute_mKind ;
          var_fieldList.addAssign_operation (enumerator_41978.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 709))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 709)) ;
          const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, objectArray_42207->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_location location_4 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_4, objectArray_42207->mAttribute_mErrorMessage  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 711)) ;
          }
        }
        enumerator_41978.gotoNextObject () ;
      }
      ...
      if (kBoolTrue == test_5) {
        ...
        if (kBoolTrue == test_7) {
          GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
          cEnumerator_stringlist enumerator_43065 (var_fieldList, kEnumeration_up) ;
          while (enumerator_43065.hasCurrentObject ()) {
            var_s.dotAssign_operation (enumerator_43065.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 724)) ;
            if (enumerator_43065.hasNextObject ()) {
      ...
      if (kBoolTrue == test_9) {
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_readerMap enumerator_43763 (var_readerMap, kEnumeration_up) ;
        while (enumerator_43763.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_43763.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 741))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 741))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 741)) ;
          cEnumerator_functionSignature enumerator_43831 (enumerator_43763.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          while (enumerator_43831.hasCurrentObject ()) {
            GALGAS_string temp_11 ;
            const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_43831.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_12) {
              temp_11 = enumerator_43831.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 743)) ;
            }else if (kBoolFalse == test_12) {
              temp_11 = GALGAS_string::makeEmptyString () ;
            }
            var_s.dotAssign_operation (GALGAS_string (" \?").add_operation (temp_11, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 743)).add_operation (GALGAS_string ("@"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 743)).operator_concat (enumerator_43831.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 743))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 743))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 743)) ;
            enumerator_43831.gotoNextObject () ;
          }
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_43763.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 745))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 745))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 745)) ;
  ...
  if (kBoolTrue == test_16) {
    ...
    cEnumerator_actualOutputExpressionList enumerator_44886 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_functionSignature enumerator_44916 (var_readerFormalArgumentTypeList, kEnumeration_up) ;
    while (enumerator_44886.hasCurrentObject () && enumerator_44916.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_44886.current_mExpression (HERE).ptr (), enumerator_44916.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 763)) ;
      const enumGalgasBool test_18 = GALGAS_bool (kIsNotEqual, enumerator_44916.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_44886.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_18) {
        GALGAS_string temp_19 ;
        const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_44916.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_20) {
          temp_19 = GALGAS_string (":") ;
        }else if (kBoolFalse == test_20) {
          temp_19 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_21 (enumerator_44886.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_21, GALGAS_string ("the selector should be '!").operator_concat (enumerator_44916.current_mFormalSelector (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 765))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 765)).operator_concat (temp_19.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 765))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 765))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 765)) ;
      }
      {
      routine_checkAssignmentTypes (enumerator_44916.current_mFormalArgumentType (HERE), var_exp.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 767)), enumerator_44886.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 767)) ;
      }
...
static void categoryMethod_equalExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1097)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1098)) ;
...
static void categoryMethod_notEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1130)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1131)) ;
...
static void categoryMethod_lowerOrEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1163)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1164)) ;
...
static void categoryMethod_greaterOrEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1201)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1202)) ;
...
static void categoryMethod_strictGreaterExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1239)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1240)) ;
...
static void categoryMethod_strictLowerExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1277)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1278)) ;
...
static void categoryMethod_rightShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1315)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1316)) ;
...
static void categoryMethod_leftShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1353)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1354)) ;
...
static void categoryMethod_unaryMinusExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_type = var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1553)) ;
...
static void categoryMethod_notExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_type = var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1581)) ;
...
static void categoryMethod_structFieldAccessExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_type = var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1609)) ;
...
static void categoryMethod_complementExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_type = var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1636)) ;
...
static void categoryMethod_ifExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_if_5F_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1670)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1670)).objectCompare (GALGAS_string ("bool"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("the test expression type is '@").operator_concat (var_if_5F_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1672)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1672))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1672)).operator_concat (GALGAS_string ("', it should be '@bool'")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1672))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1671)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_then_5F_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1675)).objectCompare (var_else_5F_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1675)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("operand expression types are '@").operator_concat (var_then_5F_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1677)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1677))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1677)).operator_concat (GALGAS_string ("' and '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1677)).operator_concat (var_else_5F_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1677)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1677))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1677)).operator_concat (GALGAS_string ("': they should be the same")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1677))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1676)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_ifExpressionForGeneration::constructor_new (var_then_5F_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1683)), object->mAttribute_mOperatorLocation, var_if_5F_expression, var_then_5F_expression, var_else_5F_expression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1682)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_functionSignature enumerator_82425 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_actualOutputExpressionList enumerator_82442 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    while (enumerator_82425.hasCurrentObject () && enumerator_82442.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_expression ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_82442.current_mExpression (HERE).ptr (), enumerator_82425.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1725)) ;
      {
      routine_checkAssignmentTypes (enumerator_82425.current_mFormalArgumentType (HERE), var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1731)), enumerator_82442.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1731)) ;
      }
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_82425.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_82442.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_5) {
        GALGAS_string temp_6 ;
        const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, enumerator_82425.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_7) {
          temp_6 = enumerator_82425.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1733)) ;
        }else if (kBoolFalse == test_7) {
          temp_6 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_8 (enumerator_82442.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_82425.gotoNextObject () ;
      enumerator_82442.gotoNextObject () ;
    }
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool joker_84360_26 ; // Joker input parameter
  GALGAS_bool joker_84360_25 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_84360_24 ; // Joker input parameter
  GALGAS_typeKindEnum joker_84360_23 ; // Joker input parameter
  GALGAS_bool joker_84360_22 ; // Joker input parameter
  GALGAS_typedAttributeList joker_84360_21 ; // Joker input parameter
  GALGAS_attributeMap joker_84360_20 ; // Joker input parameter
  GALGAS_typedAttributeList joker_84360_19 ; // Joker input parameter
  GALGAS_constructorMap joker_84360_18 ; // Joker input parameter
  GALGAS_readerMap joker_84360_17 ; // Joker input parameter
  GALGAS_modifierMap joker_84360_16 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_84360_15 ; // Joker input parameter
  GALGAS_classMethodMap joker_84360_14 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_84360_13 ; // Joker input parameter
  GALGAS_stringlist joker_84360_12 ; // Joker input parameter
  GALGAS_uint joker_84360_11 ; // Joker input parameter
  GALGAS_functionSignature joker_84360_10 ; // Joker input parameter
  GALGAS_constantIndexMap joker_84360_9 ; // Joker input parameter
  GALGAS_enumConstantList joker_84360_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_84360_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_84360_6 ; // Joker input parameter
  GALGAS_bool joker_84360_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_84360_4 ; // Joker input parameter
  GALGAS_string joker_84360_3 ; // Joker input parameter
  GALGAS_string joker_84360_2 ; // Joker input parameter
  GALGAS_headerKind joker_84360_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_84360_26, joker_84360_25, joker_84360_24, joker_84360_23, joker_84360_22, joker_84360_21, joker_84360_20, joker_84360_19, joker_84360_18, joker_84360_17, joker_84360_16, joker_84360_15, joker_84360_14, joker_84360_13, joker_84360_12, joker_84360_11, joker_84360_10, joker_84360_9, joker_84360_8, joker_84360_7, joker_84360_6, joker_84360_5, joker_84360_4, joker_84360_3, joker_84360_2, joker_84360_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1777)) ;
...
static void categoryMethod_testDynamicClassInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1800)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1800)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1800)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_unifiedTypeMapProxy var_t = var_castType ;
    GALGAS_bool var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1803)))) ;
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1804)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1804)).isValid ()) {
      uint32_t variant_85570 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1804)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1804)).uintValue () ;
      bool loop_85570 = true ;
      while (loop_85570) {
        loop_85570 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1805)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1805)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1805)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1805)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1805)).isValid () ;
        if (loop_85570) {
        ...
        if (loop_85570) {
          ...
          var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1807)))) ;
        }
      }
    }
    ...
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1811))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1811)).operator_concat (GALGAS_string ("' is not a descendant of the '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1811)).operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1811)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1811))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1811)).operator_concat (GALGAS_string ("' type of the cast expression")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1811))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1810)) ;
    }
  }else if (kBoolFalse == test_0) {
    inCompiler->emitSemanticError (var_expression.reader_mLocation (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1815)), GALGAS_string ("expression should be a class instance: it is an @").operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1816)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1816))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1815)).operator_concat (GALGAS_string (" instance")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1816))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1815)) ;
  }
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1849)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1849)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1849)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_unifiedTypeMapProxy var_t = var_type ;
    GALGAS_bool var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1852)))) ;
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1853)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1853)).isValid ()) {
      uint32_t variant_87314 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1853)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1853)).uintValue () ;
      bool loop_87314 = true ;
      while (loop_87314) {
        loop_87314 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).isValid () ;
        if (loop_87314) {
          loop_87314 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).boolValue () ;
        }
        if (loop_87314 && (0 == variant_87314)) {
          loop_87314 = false ;
        ...
        if (loop_87314) {
          ...
          var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1856)))) ;
        }
      }
    }
    ...
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1860))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1860)).operator_concat (GALGAS_string ("' is not a descendant of the '@")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1860)).operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1861)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1861))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1860)).operator_concat (GALGAS_string ("' type of the cast expression")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1861))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1859)) ;
    }
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1864)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1864)).objectCompare (GALGAS_string ("object"))).boolEnum () ;
    if (kBoolTrue == test_3) {
      inCompiler->emitSemanticError (var_expression.reader_mLocation (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1869)), GALGAS_string ("cast expression should be a class instance or an @object instance: it is an @").operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1871)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1871))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1870)).operator_concat (GALGAS_string (" instance")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1871))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1869)) ;
    }
  }
  const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1874)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1874)).objectCompare (GALGAS_string ("object"))).boolEnum () ;
  if (kBoolTrue == test_4) {
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool var_isInternal ;
  GALGAS_lstringlist joker_89063_4 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_89063_3 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_89063_2 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_89063_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_89063_4, joker_89063_3, joker_89063_2, joker_89063_1, var_isInternal, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1900)) ;
  const enumGalgasBool test_0 = var_isInternal.boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool var_isInternal ;
  GALGAS_lstring joker_90253_4 ; // Joker input parameter
  GALGAS_lstringlist joker_90253_3 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_90253_2 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_90253_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_90253_4, joker_90253_3, joker_90253_2, joker_90253_1, var_filewrapperTemplateMap, var_isInternal, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1931)) ;
  const enumGalgasBool test_0 = var_isInternal.boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  GALGAS_lstring joker_90862_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_90862_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1945)) ;
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_actualOutputExpressionList enumerator_91449 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_functionSignature enumerator_91468 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_91449.hasCurrentObject () && enumerator_91468.hasCurrentObject ()) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_91468.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_91449.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_5) {
        GALGAS_string temp_6 ;
        const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, enumerator_91468.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_7) {
          temp_6 = GALGAS_string (":") ;
        }else if (kBoolFalse == test_7) {
          temp_6 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_8 (enumerator_91449.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_8, GALGAS_string ("the selector should be '!").operator_concat (enumerator_91468.current_mFormalSelector (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1958))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1958)).operator_concat (temp_6.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1958))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1958))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1958)) ;
      }
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_91449.current_mExpression (HERE).ptr (), enumerator_91468.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1960)) ;
      {
      routine_checkAssignmentTypes (enumerator_91468.current_mFormalArgumentType (HERE), var_exp.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1961)), enumerator_91449.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1961)) ;
      }
      var_effectiveParameterList.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1962)) ;
      enumerator_91449.gotoNextObject () ;
      enumerator_91468.gotoNextObject () ;
    }
  }
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool var_isInternal ;
  GALGAS_lstring joker_93201_0 ; // Joker input parameter
  GALGAS_lstringlist joker_93208_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_93305_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_93201_0, joker_93208_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_93305_0, var_isInternal, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1995)) ;
  ...
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2013)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2013)).isValid ()) {
    uint32_t variant_93805 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2013)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2013)).uintValue () ;
    bool loop_93805 = true ;
    while (loop_93805) {
      loop_93805 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2014)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValid () ;
      if (loop_93805) {
        loop_93805 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2014)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolValue () ;
      }
      if (loop_93805 && (0 == variant_93805)) {
        loop_93805 = false ;
  ...
  if (kBoolTrue == test_9) {
    GALGAS_string joker_94633_0 ; // Joker input parameter
    GALGAS_uint joker_94648_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2033)), joker_94633_0, var_isTextFile, joker_94648_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2033)) ;
  }else if (kBoolFalse == test_9) {
...
static void categoryMethod_lexiqueIntrospectionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_terminalMap joker_95752_3 ; // Joker input parameter
  GALGAS_indexingListAST joker_95752_2 ; // Joker input parameter
  GALGAS_lstring joker_95752_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (object->mAttribute_mLexiqueComponentName, joker_95752_3, joker_95752_2, joker_95752_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2062)) ;
...
static void categoryMethod_expressionCollectionValue_analyze (const cPtr_abstractCollectionValueElement * inObject,
  ...
  {
  routine_checkAssignmentTypes (constinArgument_inElementType, var_expression.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2105)), object->mAttribute_mExpressionLocation, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2105)) ;
  }
...
static void categoryMethod_expressionListCollectionValue_analyze (const cPtr_abstractCollectionValueElement * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_actualOutputExpressionList enumerator_98343 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    cEnumerator_functionSignature enumerator_98368 (var_formalParameterTypeList, kEnumeration_up) ;
    while (enumerator_98343.hasCurrentObject () && enumerator_98368.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_98343.current_mExpression (HERE).ptr (), enumerator_98368.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2127)) ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_98368.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_98343.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string temp_2 ;
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_98368.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_3) {
          temp_2 = GALGAS_string (":") ;
        }else if (kBoolFalse == test_3) {
          temp_2 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_4 (enumerator_98343.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the selector should be '!").operator_concat (enumerator_98368.current_mFormalSelector (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2129))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2129)).operator_concat (temp_2.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2129))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2129))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2129)) ;
      }
      {
      routine_checkAssignmentTypes (enumerator_98368.current_mFormalArgumentType (HERE), var_exp.reader_mResultType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2131)), enumerator_98343.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2131)) ;
      }
      ...
      enumerator_98343.gotoNextObject () ;
      enumerator_98368.gotoNextObject () ;
    }
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_3) {
      ...
      if (kBoolTrue == test_5) {
        ...
        cEnumerator_collectionValueElementList enumerator_101283 (object->mAttribute_mElementList, kEnumeration_up) ;
        while (enumerator_101283.hasCurrentObject ()) {
          callCategoryMethod_analyze ((const cPtr_abstractCollectionValueElement *) enumerator_101283.current_mElement (HERE).ptr (), constinArgument_inAnalysisContext, var_targetType, ioArgument_ioVariableMap, var_collectionValueElementListForGeneration, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2200)) ;
          enumerator_101283.gotoNextObject () ;
        }
