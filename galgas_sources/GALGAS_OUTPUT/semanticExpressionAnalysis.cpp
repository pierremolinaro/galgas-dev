...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  GALGAS_string result_string ; // Returned variable
  //-------- @ifInstructionForGeneration
  if (constinArgument_inSuperClass.reader_isNull (SOURCE_FILE_AT_LINE (785)).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_formalParameterSignature joker_44167_0 ; // Joker input parameter
    GALGAS_bool joker_44170_0 ; // Joker input parameter
    GALGAS_string joker_44184_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (789)).method_searchKey (constinArgument_inReaderName, joker_44167_0, joker_44170_0, var_qualifier, joker_44184_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (789)) ;
    //-------- END @methodCallInstructionForGeneration
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
                                  ...
                                  COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @ifInstructionForGeneration
  if (constinArgument_inOperandIsHandled.operator_not (SOURCE_FILE_AT_LINE (972)).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    if (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (979)).isValid ()) {
      PMUInt32 variant_51841 = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (979)).uintValue () ;
      bool loop_51841 = true ;
      while (loop_51841) {
        loop_51841 = var_ok.operator_not (SOURCE_FILE_AT_LINE (979)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (979)).reader_isNull (SOURCE_FILE_AT_LINE (979)).operator_not (SOURCE_FILE_AT_LINE (979)) COMMA_SOURCE_FILE_AT_LINE (979)).isValid () ;
        if (loop_51841) {
          loop_51841 = var_ok.operator_not (SOURCE_FILE_AT_LINE (979)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (979)).reader_isNull (SOURCE_FILE_AT_LINE (979)).operator_not (SOURCE_FILE_AT_LINE (979)) COMMA_SOURCE_FILE_AT_LINE (979)).boolValue () ;
        }
        if (loop_51841 && (0 == variant_51841)) {
          loop_51841 = false ;
    ...
    //-------- @ifInstructionForGeneration
    if (var_ok.operator_not (SOURCE_FILE_AT_LINE (984)).isValidAndTrue ()) {
      //-------- @ifInstructionForGeneration
      if (constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (986)).reader_hasKey (constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (986)) COMMA_SOURCE_FILE_AT_LINE (986)).isValidAndTrue ()) {
        //-------- @localVariableDeclarationForGeneration
        ...
        //-------- @methodCallInstructionForGeneration
        GALGAS_location joker_52440_0 ; // Joker input parameter
        GALGAS_methodQualifier joker_52508_2 ; // Joker input parameter
        GALGAS_string joker_52508_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (991)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (992)), var_isCategory, var_argumentTypeList, joker_52440_0, var_hasCompilerArgument, var_returnedType, joker_52508_2, joker_52508_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (991)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @assignmentInstructionForGeneration
      ...
      //-------- @ifInstructionForGeneration
      if (var_ok.operator_not (SOURCE_FILE_AT_LINE (1014)).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
...
static void categoryMethod_readerCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (NULL != objectArray_36594) {
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, objectArray_36594->mAttribute_mErrorMessage.objectCompare (GALGAS_string (""))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_0 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_0, objectArray_36594->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (614)) ;
    }
  }else{
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_uint var_matchingReaderCount = GALGAS_uint ((PMUInt32) 0U) ;
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, var_receiverType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (618)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (618)))).isValidAndTrue ()) {
      //-------- @assignmentInstructionForGeneration
      var_readerFormalArgumentTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (619)) ;
      //-------- @assignmentInstructionForGeneration
      var_hasCompilerArgument = GALGAS_bool (true) ;
      //-------- @assignmentInstructionForGeneration
      var_returnedType = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (621)) ;
      //-------- @assignmentInstructionForGeneration
      var_isCategory = GALGAS_bool (true) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_typedAttributeList enumerator_37253 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (623)), true) ;
      //--- simple foreach instruction
      while (enumerator_37253.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_unifiedTypeMapProxy var_attributeType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (enumerator_37253.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (624)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (624)), inCompiler COMMA_SOURCE_FILE_AT_LINE (624)) ;
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_readerMap var_aMap = var_attributeType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (625)) ;
        //-------- @readOnlyWithInstructionForGeneration
        const cMapElement_readerMap * objectArray_37593 = (const cMapElement_readerMap *) var_aMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (627))) ;
        if (NULL != objectArray_37593) {
            macroValidSharedObject (objectArray_37593, const cMapElement_readerMap) ;
          //-------- @incrementInstructionForGeneration
          var_matchingReaderCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (628)) ;
          //-------- @assignmentInstructionForGeneration
          var_readerFormalArgumentTypeList = objectArray_37593->mAttribute_mArgumentTypeList ;
          //-------- @assignmentInstructionForGeneration
          var_hasCompilerArgument = objectArray_37593->mAttribute_mHasCompilerArgument ;
          //-------- @assignmentInstructionForGeneration
          var_returnedType = objectArray_37593->mAttribute_mReturnedType ;
          //-------- @assignmentInstructionForGeneration
          var_isCategory = objectArray_37593->mAttribute_mIsCategory ;
          //-------- @addAssignInstructionForGeneration
          var_fieldList.addAssign_operation (enumerator_37253.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (633)) COMMA_SOURCE_FILE_AT_LINE (633)) ;
          //-------- @ifInstructionForGeneration
          if (GALGAS_bool (kIsNotEqual, objectArray_37593->mAttribute_mErrorMessage.objectCompare (GALGAS_string (""))).isValidAndTrue ()) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_1 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_1, objectArray_37593->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (635)) ;
          }
        }
        enumerator_37253.gotoNextObject () ;
      }
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsEqual, var_matchingReaderCount.objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
        ...
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (641)) COMMA_SOURCE_FILE_AT_LINE (641)).operator_concat (GALGAS_string ("' struct type does not define the '") COMMA_SOURCE_FILE_AT_LINE (641)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (641)) COMMA_SOURCE_FILE_AT_LINE (641)).operator_concat (GALGAS_string ("' reader, and none of its fields defines it") COMMA_SOURCE_FILE_AT_LINE (642)) COMMA_SOURCE_FILE_AT_LINE (640)) ;
        ...
        if (GALGAS_bool (kIsStrictSup, var_matchingReaderCount.objectCompare (GALGAS_uint ((PMUInt32) 1U))).isValidAndTrue ()) {
          ...
          GALGAS_string var_s = GALGAS_string ("") ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_stringlist enumerator_38477 (var_fieldList, true) ;
          //--- simple foreach instruction
          while (enumerator_38477.hasCurrentObject ()) {
            //-------- @appendInstructionForGeneration
            var_s.dotAssign_operation (enumerator_38477.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (648)) ;
          ...
          inCompiler->emitSemanticError (location_3, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (652)) COMMA_SOURCE_FILE_AT_LINE (652)).operator_concat (GALGAS_string ("' struct type does not define the '") COMMA_SOURCE_FILE_AT_LINE (652)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (652)) COMMA_SOURCE_FILE_AT_LINE (652)).operator_concat (GALGAS_string ("' reader, and several of its fields defines it:") COMMA_SOURCE_FILE_AT_LINE (653)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (653)).operator_concat (GALGAS_string (" (exactly one field should define it)") COMMA_SOURCE_FILE_AT_LINE (653)) COMMA_SOURCE_FILE_AT_LINE (651)) ;
          var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
          var_hasCompilerArgument.drop () ; // Release error dropped variable
          var_returnedType.drop () ; // Release error dropped variable
          var_isCategory.drop () ; // Release error dropped variable
      ...
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsEqual, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (657)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_4 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (659)) COMMA_SOURCE_FILE_AT_LINE (659)).operator_concat (GALGAS_string ("' type does not define any reader") COMMA_SOURCE_FILE_AT_LINE (659)) COMMA_SOURCE_FILE_AT_LINE (658)) ;
        var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
        var_hasCompilerArgument.drop () ; // Release error dropped variable
        var_returnedType.drop () ; // Release error dropped variable
        var_isCategory.drop () ; // Release error dropped variable
        ...
        GALGAS_string var_s = GALGAS_string ("") ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_readerMap enumerator_39177 (var_readerMap, true) ;
        //--- simple foreach instruction
        while (enumerator_39177.hasCurrentObject ()) {
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_39177.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (665)) COMMA_SOURCE_FILE_AT_LINE (665)) COMMA_SOURCE_FILE_AT_LINE (665)) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_unifiedTypeMapProxyList enumerator_39245 (enumerator_39177.current_mArgumentTypeList (HERE), true) ;
          //--- simple foreach instruction
          while (enumerator_39245.hasCurrentObject ()) {
            //-------- @appendInstructionForGeneration
            var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_39245.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (667)) COMMA_SOURCE_FILE_AT_LINE (667)) COMMA_SOURCE_FILE_AT_LINE (667)) ;
            enumerator_39245.gotoNextObject () ;
          }
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_39177.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (669)) COMMA_SOURCE_FILE_AT_LINE (669)) COMMA_SOURCE_FILE_AT_LINE (669)) ;
          enumerator_39177.gotoNextObject () ;
        }
        //-------- @errorInstructionForGeneration
        //--- @ifExpressionForGeneration
        GALGAS_string temp_5 ;
        if (GALGAS_bool (kIsStrictSup, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (673)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).isValidAndTrue ()) {
        ...
        inCompiler->emitSemanticError (location_6, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (672)) COMMA_SOURCE_FILE_AT_LINE (672)).operator_concat (GALGAS_string ("' type does not define the '") COMMA_SOURCE_FILE_AT_LINE (672)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (672)) COMMA_SOURCE_FILE_AT_LINE (672)).operator_concat (GALGAS_string ("' reader; available ") COMMA_SOURCE_FILE_AT_LINE (672)).operator_concat (temp_5 COMMA_SOURCE_FILE_AT_LINE (673)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (674)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (674)) COMMA_SOURCE_FILE_AT_LINE (671)) ;
        var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
        var_hasCompilerArgument.drop () ; // Release error dropped variable
        var_returnedType.drop () ; // Release error dropped variable
        var_isCategory.drop () ; // Release error dropped variable
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (680)).objectCompare (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (680)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_7 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_7, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (681)) COMMA_SOURCE_FILE_AT_LINE (681)).operator_concat (GALGAS_string ("' reader of '@") COMMA_SOURCE_FILE_AT_LINE (681)).operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (681)) COMMA_SOURCE_FILE_AT_LINE (681)).operator_concat (GALGAS_string ("' requires ") COMMA_SOURCE_FILE_AT_LINE (681)).operator_concat (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (682)).reader_string (SOURCE_FILE_AT_LINE (682)) COMMA_SOURCE_FILE_AT_LINE (682)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (682)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (683)).reader_string (SOURCE_FILE_AT_LINE (683)) COMMA_SOURCE_FILE_AT_LINE (683)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (683)) COMMA_SOURCE_FILE_AT_LINE (681)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else{
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_semanticExpressionListForGeneration var_constructorEffectiveParameterList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (685)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_40203 (object->mAttribute_mExpressions, true) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_40235 (var_readerFormalArgumentTypeList, true) ;
    //--- simple foreach instruction
    while (enumerator_40203.hasCurrentObject () && enumerator_40235.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_exp ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_40203.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (688)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_40235.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (689)), enumerator_40203.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (689)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_constructorEffectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (690)) ;
      enumerator_40203.gotoNextObject () ;
      enumerator_40235.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (var_returnedType, object->mAttribute_mReaderName.reader_location (SOURCE_FILE_AT_LINE (694)), var_isCategory, var_receiverExpression, var_fieldList, object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (698)), var_constructorEffectiveParameterList, var_hasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (692)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_thisReaderCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (ioArgument_ioVariableMap.reader_hasKey (function_selfMarkName (inCompiler COMMA_SOURCE_FILE_AT_LINE (714)) COMMA_SOURCE_FILE_AT_LINE (714)).isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
    GALGAS_string joker_41313_0 ; // Joker input parameter
    GALGAS_string joker_41316_0 ; // Joker input parameter
    ioArgument_ioVariableMap.modifier_searchForReadAccess (GALGAS_lstring::constructor_new (function_selfMarkName (inCompiler COMMA_SOURCE_FILE_AT_LINE (715)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (715)), var_thisTypeProxy, joker_41313_0, joker_41316_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (715)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }else{
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mLocation, GALGAS_string ("'this' can be used only in methods, modifiers and readers") COMMA_SOURCE_FILE_AT_LINE (717)) ;
    var_thisTypeProxy.drop () ; // Release error dropped variable
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_readerMap var_readerMap = var_thisTypeProxy.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (720)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxyList var_readerFormalArgumentTypeList ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_bool var_isCategory ;
  ...
  GALGAS_unifiedTypeMapProxy var_returnedType ;
  //-------- @readOnlyWithInstructionForGeneration
  const cMapElement_readerMap * objectArray_41698 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (726))) ;
  if (NULL != objectArray_41698) {
      macroValidSharedObject (objectArray_41698, const cMapElement_readerMap) ;
    //-------- @assignmentInstructionForGeneration
    var_readerFormalArgumentTypeList = objectArray_41698->mAttribute_mArgumentTypeList ;
    //-------- @assignmentInstructionForGeneration
    var_hasCompilerArgument = objectArray_41698->mAttribute_mHasCompilerArgument ;
    //-------- @assignmentInstructionForGeneration
    var_returnedType = objectArray_41698->mAttribute_mReturnedType ;
    //-------- @assignmentInstructionForGeneration
    var_isCategory = objectArray_41698->mAttribute_mIsCategory ;
  }else{
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (732)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_0 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_0, GALGAS_string ("the '@").operator_concat (var_thisTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (734)) COMMA_SOURCE_FILE_AT_LINE (734)).operator_concat (GALGAS_string ("' type does not define any reader") COMMA_SOURCE_FILE_AT_LINE (734)) COMMA_SOURCE_FILE_AT_LINE (733)) ;
      var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
      var_hasCompilerArgument.drop () ; // Release error dropped variable
      var_returnedType.drop () ; // Release error dropped variable
      var_isCategory.drop () ; // Release error dropped variable
      ...
      GALGAS_string var_s = GALGAS_string ("") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_readerMap enumerator_42198 (var_readerMap, true) ;
      //--- simple foreach instruction
      while (enumerator_42198.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_42198.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (740)) COMMA_SOURCE_FILE_AT_LINE (740)) COMMA_SOURCE_FILE_AT_LINE (740)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_unifiedTypeMapProxyList enumerator_42266 (enumerator_42198.current_mArgumentTypeList (HERE), true) ;
        //--- simple foreach instruction
        while (enumerator_42266.hasCurrentObject ()) {
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_42266.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (742)) COMMA_SOURCE_FILE_AT_LINE (742)) COMMA_SOURCE_FILE_AT_LINE (742)) ;
          enumerator_42266.gotoNextObject () ;
        }
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_42198.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (744)) COMMA_SOURCE_FILE_AT_LINE (744)) COMMA_SOURCE_FILE_AT_LINE (744)) ;
        enumerator_42198.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      //--- @ifExpressionForGeneration
      GALGAS_string temp_1 ;
      if (GALGAS_bool (kIsStrictSup, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (748)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).isValidAndTrue ()) {
        temp_1 = GALGAS_string ("readers are") ;
      }else{
        temp_1 = GALGAS_string ("reader is") ;
      }
      GALGAS_location location_2 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '@").operator_concat (var_thisTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (747)) COMMA_SOURCE_FILE_AT_LINE (747)).operator_concat (GALGAS_string ("' type does not define the '") COMMA_SOURCE_FILE_AT_LINE (747)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (747)) COMMA_SOURCE_FILE_AT_LINE (747)).operator_concat (GALGAS_string ("' reader; available ") COMMA_SOURCE_FILE_AT_LINE (747)).operator_concat (temp_1 COMMA_SOURCE_FILE_AT_LINE (748)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (749)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (749)) COMMA_SOURCE_FILE_AT_LINE (746)) ;
      var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
      var_hasCompilerArgument.drop () ; // Release error dropped variable
      var_returnedType.drop () ; // Release error dropped variable
      var_isCategory.drop () ; // Release error dropped variable
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (755)).objectCompare (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (755)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_3 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (756)) COMMA_SOURCE_FILE_AT_LINE (756)).operator_concat (GALGAS_string ("' reader of '@") COMMA_SOURCE_FILE_AT_LINE (756)).operator_concat (var_thisTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (756)) COMMA_SOURCE_FILE_AT_LINE (756)).operator_concat (GALGAS_string ("' requires ") COMMA_SOURCE_FILE_AT_LINE (756)).operator_concat (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (757)).reader_string (SOURCE_FILE_AT_LINE (757)) COMMA_SOURCE_FILE_AT_LINE (757)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (757)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (758)).reader_string (SOURCE_FILE_AT_LINE (758)) COMMA_SOURCE_FILE_AT_LINE (758)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (758)) COMMA_SOURCE_FILE_AT_LINE (756)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else{
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_semanticExpressionListForGeneration var_constructorEffectiveParameterList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (760)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_43226 (object->mAttribute_mExpressions, true) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_43258 (var_readerFormalArgumentTypeList, true) ;
    //--- simple foreach instruction
    while (enumerator_43226.hasCurrentObject () && enumerator_43258.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_exp ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_43226.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (763)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_43258.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (764)), enumerator_43226.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (764)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_constructorEffectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (765)) ;
      enumerator_43226.gotoNextObject () ;
      enumerator_43258.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_thisReaderCallExpressionForGeneration::constructor_new (var_returnedType, object->mAttribute_mReaderName.reader_location (SOURCE_FILE_AT_LINE (769)), var_isCategory, object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (771)), var_constructorEffectiveParameterList, var_hasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (767)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_superReaderCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (ioArgument_ioVariableMap.reader_hasKey (function_selfMarkName (inCompiler COMMA_SOURCE_FILE_AT_LINE (810)) COMMA_SOURCE_FILE_AT_LINE (810)).isValidAndTrue ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_thisTypeProxy ;
    { //-------- @modifierCallInstructionForGeneration
    GALGAS_string joker_45084_0 ; // Joker input parameter
    GALGAS_string joker_45087_0 ; // Joker input parameter
    ioArgument_ioVariableMap.modifier_searchForReadAccess (GALGAS_lstring::constructor_new (function_selfMarkName (inCompiler COMMA_SOURCE_FILE_AT_LINE (812)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (812)), var_thisTypeProxy, joker_45084_0, joker_45087_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (812)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @ifInstructionForGeneration
    if (var_thisTypeProxy.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (813)).reader_isNull (SOURCE_FILE_AT_LINE (813)).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
  ...
  //-------- @readOnlyWithInstructionForGeneration
  const cMapElement_readerMap * objectArray_45738 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (829))) ;
  if (NULL != objectArray_45738) {
      macroValidSharedObject (objectArray_45738, const cMapElement_readerMap) ;
    //-------- @assignmentInstructionForGeneration
    var_readerFormalArgumentTypeList = objectArray_45738->mAttribute_mArgumentTypeList ;
    //-------- @assignmentInstructionForGeneration
    var_hasCompilerArgument = objectArray_45738->mAttribute_mHasCompilerArgument ;
    //-------- @assignmentInstructionForGeneration
    var_returnedType = objectArray_45738->mAttribute_mReturnedType ;
    //-------- @assignmentInstructionForGeneration
    var_isCategory = objectArray_45738->mAttribute_mIsCategory ;
    //-------- @assignmentInstructionForGeneration
    ...
    if (GALGAS_bool (kIsEqual, var_superClassThatImplementsReader.objectCompare (GALGAS_string (""))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_0 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (836)) COMMA_SOURCE_FILE_AT_LINE (836)).operator_concat (GALGAS_string ("' reader is not implemented by super class(es)") COMMA_SOURCE_FILE_AT_LINE (836)) COMMA_SOURCE_FILE_AT_LINE (836)) ;
    }
  }else{
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (839)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (var_superTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (841)) COMMA_SOURCE_FILE_AT_LINE (841)).operator_concat (GALGAS_string ("' type does not define any reader") COMMA_SOURCE_FILE_AT_LINE (841)) COMMA_SOURCE_FILE_AT_LINE (840)) ;
      var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
      var_hasCompilerArgument.drop () ; // Release error dropped variable
      var_returnedType.drop () ; // Release error dropped variable
      var_isCategory.drop () ; // Release error dropped variable
      ...
      GALGAS_string var_s = GALGAS_string ("") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_readerMap enumerator_46544 (var_readerMap, true) ;
      //--- simple foreach instruction
      while (enumerator_46544.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_46544.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (847)) COMMA_SOURCE_FILE_AT_LINE (847)) COMMA_SOURCE_FILE_AT_LINE (847)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_unifiedTypeMapProxyList enumerator_46612 (enumerator_46544.current_mArgumentTypeList (HERE), true) ;
        //--- simple foreach instruction
        while (enumerator_46612.hasCurrentObject ()) {
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_46612.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (849)) COMMA_SOURCE_FILE_AT_LINE (849)) COMMA_SOURCE_FILE_AT_LINE (849)) ;
          enumerator_46612.gotoNextObject () ;
        }
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_46544.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (851)) COMMA_SOURCE_FILE_AT_LINE (851)) COMMA_SOURCE_FILE_AT_LINE (851)) ;
        enumerator_46544.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      //--- @ifExpressionForGeneration
      GALGAS_string temp_2 ;
      if (GALGAS_bool (kIsStrictSup, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (855)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).isValidAndTrue ()) {
        temp_2 = GALGAS_string ("readers are") ;
      }else{
        temp_2 = GALGAS_string ("reader is") ;
      }
      GALGAS_location location_3 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '@").operator_concat (var_superTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (854)) COMMA_SOURCE_FILE_AT_LINE (854)).operator_concat (GALGAS_string ("' type does not define the '") COMMA_SOURCE_FILE_AT_LINE (854)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (854)) COMMA_SOURCE_FILE_AT_LINE (854)).operator_concat (GALGAS_string ("' reader; available ") COMMA_SOURCE_FILE_AT_LINE (854)).operator_concat (temp_2 COMMA_SOURCE_FILE_AT_LINE (855)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (856)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (856)) COMMA_SOURCE_FILE_AT_LINE (853)) ;
      var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
      var_hasCompilerArgument.drop () ; // Release error dropped variable
      var_returnedType.drop () ; // Release error dropped variable
      var_isCategory.drop () ; // Release error dropped variable
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (862)).objectCompare (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (862)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_4 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_4, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (863)) COMMA_SOURCE_FILE_AT_LINE (863)).operator_concat (GALGAS_string ("' reader of '@") COMMA_SOURCE_FILE_AT_LINE (863)).operator_concat (var_superTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (863)) COMMA_SOURCE_FILE_AT_LINE (863)).operator_concat (GALGAS_string ("' requires ") COMMA_SOURCE_FILE_AT_LINE (863)).operator_concat (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (864)).reader_string (SOURCE_FILE_AT_LINE (864)) COMMA_SOURCE_FILE_AT_LINE (864)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (864)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (865)).reader_string (SOURCE_FILE_AT_LINE (865)) COMMA_SOURCE_FILE_AT_LINE (865)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (865)) COMMA_SOURCE_FILE_AT_LINE (863)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else{
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_47606 (object->mAttribute_mExpressions, true) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_47638 (var_readerFormalArgumentTypeList, true) ;
    //--- simple foreach instruction
    while (enumerator_47606.hasCurrentObject () && enumerator_47638.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_exp ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_47606.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (870)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_47638.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (871)), enumerator_47606.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (871)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_constructorEffectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (872)) ;
      enumerator_47606.gotoNextObject () ;
...
static void categoryMethod_optionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (var_found.operator_not (SOURCE_FILE_AT_LINE (904)).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  if (var_found.operator_not (SOURCE_FILE_AT_LINE (908)).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
  ...
  if (var_found.isValidAndTrue ()) {
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (913)).objectCompare (GALGAS_string ("value"))).isValidAndTrue ()) {
      //-------- @assignmentInstructionForGeneration
      ...
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (920)).objectCompare (GALGAS_string ("char"))).isValidAndTrue ()) {
        //-------- @assignmentInstructionForGeneration
        ...
        //-------- @ifInstructionForGeneration
        if (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (927)).objectCompare (GALGAS_string ("string"))).isValidAndTrue ()) {
          //-------- @assignmentInstructionForGeneration
          ...
          //-------- @ifInstructionForGeneration
          if (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (934)).objectCompare (GALGAS_string ("comment"))).isValidAndTrue ()) {
            //-------- @assignmentInstructionForGeneration
            ...
            inCompiler->emitSemanticError (location_0, GALGAS_string ("only the 'value', 'char', 'string' and 'comment' readers are defined for an option") COMMA_SOURCE_FILE_AT_LINE (942)) ;
            outArgument_outExpression.drop () ; // Release error dropped variable
          }
        }
      }
    ...
    GALGAS_string var_s = GALGAS_string ("") ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_50669 (var_boolOptionMap, true) ;
    //--- simple foreach instruction
    while (enumerator_50669.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_50669.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (947)) COMMA_SOURCE_FILE_AT_LINE (947)).operator_concat (GALGAS_string ("' @bool option;") COMMA_SOURCE_FILE_AT_LINE (947)) COMMA_SOURCE_FILE_AT_LINE (947)) ;
      enumerator_50669.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_50765 (var_uintOptionMap, true) ;
    //--- simple foreach instruction
    while (enumerator_50765.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_50765.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (950)) COMMA_SOURCE_FILE_AT_LINE (950)).operator_concat (GALGAS_string ("' @uint option;") COMMA_SOURCE_FILE_AT_LINE (950)) COMMA_SOURCE_FILE_AT_LINE (950)) ;
      enumerator_50765.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_50863 (var_stringOptionMap, true) ;
    //--- simple foreach instruction
    while (enumerator_50863.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_50863.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (953)) COMMA_SOURCE_FILE_AT_LINE (953)).operator_concat (GALGAS_string ("' @string option;") COMMA_SOURCE_FILE_AT_LINE (953)) COMMA_SOURCE_FILE_AT_LINE (953)) ;
...
static void categoryMethod_equalExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1170)).reader_string (SOURCE_FILE_AT_LINE (1170)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1170)).reader_string (SOURCE_FILE_AT_LINE (1170)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_notEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1202)).reader_string (SOURCE_FILE_AT_LINE (1202)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1202)).reader_string (SOURCE_FILE_AT_LINE (1202)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_lowerOrEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1234)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1234)) COMMA_SOURCE_FILE_AT_LINE (1234)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1239)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1239)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_greaterOrEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1271)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1271)) COMMA_SOURCE_FILE_AT_LINE (1271)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1276)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1276)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_strictGreaterExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1308)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1308)) COMMA_SOURCE_FILE_AT_LINE (1308)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1313)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1313)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_strictLowerExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1345)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1345)) COMMA_SOURCE_FILE_AT_LINE (1345)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1350)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1350)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_rightShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1382)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1382)) COMMA_SOURCE_FILE_AT_LINE (1382)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1387)).objectCompare (GALGAS_string ("uint"))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_leftShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1419)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1419)) COMMA_SOURCE_FILE_AT_LINE (1419)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1424)).objectCompare (GALGAS_string ("uint"))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_unaryMinusExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1612)).operator_and (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1612)) COMMA_SOURCE_FILE_AT_LINE (1612)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_notExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1639)).operator_and (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1639)) COMMA_SOURCE_FILE_AT_LINE (1639)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_complementExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1666)).operator_and (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1666)) COMMA_SOURCE_FILE_AT_LINE (1666)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("operand type is '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1668)) COMMA_SOURCE_FILE_AT_LINE (1668)).operator_concat (GALGAS_string ("' and does not support the '~' operator") COMMA_SOURCE_FILE_AT_LINE (1668)) COMMA_SOURCE_FILE_AT_LINE (1667)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else{
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_tildeExpressionForGeneration::constructor_new (var_type, object->mAttribute_mOperatorLocation, var_expression COMMA_SOURCE_FILE_AT_LINE (1673)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ifExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mIfExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_if_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1690)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticExpressionForGeneration var_then_5F_expression ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mThenExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_then_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1693)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticExpressionForGeneration var_else_5F_expression ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mElseExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_else_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1696)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, var_if_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1698)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1698)).objectCompare (GALGAS_string ("bool"))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("the test expression type is '@").operator_concat (var_if_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1700)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1700)) COMMA_SOURCE_FILE_AT_LINE (1700)).operator_concat (GALGAS_string ("', it should be '@bool'") COMMA_SOURCE_FILE_AT_LINE (1700)) COMMA_SOURCE_FILE_AT_LINE (1699)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else{
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_then_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1703)).objectCompare (var_else_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1703)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("operand expression types are '@").operator_concat (var_then_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1705)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1705)) COMMA_SOURCE_FILE_AT_LINE (1705)).operator_concat (GALGAS_string ("' and '@") COMMA_SOURCE_FILE_AT_LINE (1705)).operator_concat (var_else_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1705)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1705)) COMMA_SOURCE_FILE_AT_LINE (1705)).operator_concat (GALGAS_string ("': they should be the same") COMMA_SOURCE_FILE_AT_LINE (1705)) COMMA_SOURCE_FILE_AT_LINE (1704)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else{
      //-------- @assignmentInstructionForGeneration
      outArgument_outExpression = GALGAS_ifExpressionForGeneration::constructor_new (var_then_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1711)), object->mAttribute_mOperatorLocation, var_if_5F_expression, var_then_5F_expression, var_else_5F_expression COMMA_SOURCE_FILE_AT_LINE (1710)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFunctionMap.method_searchKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultType, inCompiler COMMA_SOURCE_FILE_AT_LINE (1730)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, var_functionSignature.reader_length (SOURCE_FILE_AT_LINE (1732)).objectCompare (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1732)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_0 (object->mAttribute_mFunctionName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (object->mAttribute_mFunctionName.reader_string (SOURCE_FILE_AT_LINE (1734)) COMMA_SOURCE_FILE_AT_LINE (1734)).operator_concat (GALGAS_string ("' function header declares ") COMMA_SOURCE_FILE_AT_LINE (1734)).operator_concat (var_functionSignature.reader_length (SOURCE_FILE_AT_LINE (1734)).reader_string (SOURCE_FILE_AT_LINE (1734)) COMMA_SOURCE_FILE_AT_LINE (1734)).operator_concat (GALGAS_string (" formal parameter(s), but this function call names ") COMMA_SOURCE_FILE_AT_LINE (1735)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1735)).reader_string (SOURCE_FILE_AT_LINE (1735)) COMMA_SOURCE_FILE_AT_LINE (1735)).operator_concat (GALGAS_string (" effective argument(s)") COMMA_SOURCE_FILE_AT_LINE (1736)) COMMA_SOURCE_FILE_AT_LINE (1733)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else{
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_semanticExpressionListForGeneration var_semanticExpressionListForGeneration = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1740)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_unifiedTypeMapProxyList enumerator_80316 (var_functionSignature, true) ;
    cEnumerator_semanticExpressionListAST enumerator_80332 (object->mAttribute_mExpressions, true) ;
    //--- simple foreach instruction
    while (enumerator_80316.hasCurrentObject () && enumerator_80332.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_expression ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_80332.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1743)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_80316.current_mType (HERE), var_expression.reader_mType (SOURCE_FILE_AT_LINE (1744)), enumerator_80332.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1744)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_semanticExpressionListForGeneration.addAssign_operation (var_expression COMMA_SOURCE_FILE_AT_LINE (1745)) ;
      enumerator_80316.gotoNextObject () ;
      enumerator_80332.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_functionCallExpressionForGeneration::constructor_new (var_resultType, object->mAttribute_mFunctionName.reader_location (SOURCE_FILE_AT_LINE (1749)), object->mAttribute_mFunctionName.reader_string (SOURCE_FILE_AT_LINE (1750)), var_semanticExpressionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1747)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_varInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioVariableMap.modifier_searchForReadAccess (object->mAttribute_mVarName, var_type, var_sourceVariableCppName, var_nameForCheckingFormalParameterUsing, inCompiler COMMA_SOURCE_FILE_AT_LINE (1766)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_81387 (object->mAttribute_mStructFieldList, true) ;
  //--- simple foreach instruction
  while (enumerator_81387.hasCurrentObject ()) {
    ...
    //-------- @methodCallInstructionForGeneration
    var_attributeMap.method_searchKey (enumerator_81387.current_mValue (HERE), var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (1769)) ;
    //-------- END @methodCallInstructionForGeneration
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_82108_20 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_82108_19 ; // Joker input parameter
  GALGAS_typeKindEnum joker_82108_18 ; // Joker input parameter
  GALGAS_typedAttributeList joker_82108_17 ; // Joker input parameter
  GALGAS_attributeMap joker_82108_16 ; // Joker input parameter
  GALGAS_typedAttributeList joker_82108_15 ; // Joker input parameter
  GALGAS_constructorMap joker_82108_14 ; // Joker input parameter
  GALGAS_readerMap joker_82108_13 ; // Joker input parameter
  GALGAS_modifierMap joker_82108_12 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_82108_11 ; // Joker input parameter
  GALGAS_classMethodMap joker_82108_10 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_82108_9 ; // Joker input parameter
  GALGAS_uint joker_82108_8 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_82108_7 ; // Joker input parameter
  GALGAS_stringset joker_82108_6 ; // Joker input parameter
  GALGAS_lstringlist joker_82108_5 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_82108_4 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_82108_3 ; // Joker input parameter
  GALGAS_withAccessorMap joker_82108_2 ; // Joker input parameter
  GALGAS_bool joker_82108_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_82108_20, joker_82108_19, joker_82108_18, joker_82108_17, joker_82108_16, joker_82108_15, joker_82108_14, joker_82108_13, joker_82108_12, joker_82108_11, joker_82108_10, joker_82108_9, joker_82108_8, joker_82108_7, joker_82108_6, joker_82108_5, joker_82108_4, joker_82108_3, joker_82108_2, joker_82108_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1788)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1810)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1810)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (1810)))).isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1814)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1814)).isValid ()) {
      PMUInt32 variant_83235 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1814)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1814)).uintValue () ;
      bool loop_83235 = true ;
      while (loop_83235) {
        loop_83235 = var_found.operator_not (SOURCE_FILE_AT_LINE (1815)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1815)).reader_isNull (SOURCE_FILE_AT_LINE (1815)).operator_not (SOURCE_FILE_AT_LINE (1815)) COMMA_SOURCE_FILE_AT_LINE (1815)).isValid () ;
        if (loop_83235) {
          loop_83235 = var_found.operator_not (SOURCE_FILE_AT_LINE (1815)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1815)).reader_isNull (SOURCE_FILE_AT_LINE (1815)).operator_not (SOURCE_FILE_AT_LINE (1815)) COMMA_SOURCE_FILE_AT_LINE (1815)).boolValue () ;
        }
        if (loop_83235 && (0 == variant_83235)) {
          loop_83235 = false ;
    ...
    //-------- @ifInstructionForGeneration
    if (var_found.operator_not (SOURCE_FILE_AT_LINE (1819)).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1824)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1824)).objectCompare (GALGAS_string ("object"))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
  ...
  if (var_useLocationReader.isValidAndTrue ()) {
    ...
    //-------- @readOnlyWithInstructionForGeneration
    const cMapElement_readerMap * objectArray_84390 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (GALGAS_string ("location")) ;
    if (NULL != objectArray_84390) {
        macroValidSharedObject (objectArray_84390, const cMapElement_readerMap) ;
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsNotEqual, objectArray_84390->mAttribute_mArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (1836)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        ...
        //-------- @ifInstructionForGeneration
        if (GALGAS_bool (kIsNotEqual, objectArray_84390->mAttribute_mReturnedType.objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType)).isValidAndTrue ()) {
          //-------- @errorInstructionForGeneration
          inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorLocationExpression, GALGAS_string ("the error location expression type is '@").operator_concat (var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1843)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1843)) COMMA_SOURCE_FILE_AT_LINE (1843)).operator_concat (GALGAS_string ("' and defines a 'location' reader that returns an '@") COMMA_SOURCE_FILE_AT_LINE (1844)).operator_concat (objectArray_84390->mAttribute_mReturnedType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1844)) COMMA_SOURCE_FILE_AT_LINE (1844)).operator_concat (GALGAS_string ("' object; it should be either of the '@location' type, either defines a 'location' reader without argument that returns an '@location' object") COMMA_SOURCE_FILE_AT_LINE (1845)) COMMA_SOURCE_FILE_AT_LINE (1842)) ;
        }
      }
      //-------- @assignmentInstructionForGeneration
      var_errorLocationExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType, object->mAttribute_mEndOfErrorLocationExpression, GALGAS_bool (false), var_errorLocationExpression, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1853)), GALGAS_string ("location"), GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1855)), objectArray_84390->mAttribute_mHasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1848)) ;
    }else{
      //-------- @errorInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1866)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1866)).objectCompare (GALGAS_string ("object"))).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstringlist joker_87010_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_87013_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_87016_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_87019_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_87010_0, joker_87013_0, joker_87016_0, joker_87019_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1895)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_87770_0 ; // Joker input parameter
  GALGAS_lstringlist joker_87773_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_87776_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_87779_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_87770_0, joker_87773_0, joker_87776_0, joker_87779_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1914)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_87942_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_87942_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1917)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticExpressionListForGeneration var_effectiveParameterList ;
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1920)).objectCompare (var_templateSignature.reader_length (SOURCE_FILE_AT_LINE (1920)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_88529 (object->mAttribute_mExpressions, true) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_88550 (var_templateSignature, true) ;
    //--- simple foreach instruction
    while (enumerator_88529.hasCurrentObject () && enumerator_88550.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_exp ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_88529.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (1930)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_88550.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (1931)), enumerator_88529.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1931)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_effectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (1932)) ;
      enumerator_88529.gotoNextObject () ;
      enumerator_88550.gotoNextObject () ;
    }
  }
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (1955)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_0 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("path is empty") COMMA_SOURCE_FILE_AT_LINE (1956)) ;
    var_directoryList.drop () ; // Release error dropped variable
    var_fileName.drop () ; // Release error dropped variable
  }else{
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1957)).objectCompare (GALGAS_char (TO_UNICODE (47)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the path should not begin with '/'") COMMA_SOURCE_FILE_AT_LINE (1958)) ;
      var_directoryList.drop () ; // Release error dropped variable
      var_fileName.drop () ; // Release error dropped variable
    }else{
      //-------- @assignmentInstructionForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_90070_0 ; // Joker input parameter
  GALGAS_lstringlist joker_90073_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_90121_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_90070_0, joker_90073_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_90121_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1966)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1969)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1969)).isValid ()) {
    PMUInt32 variant_90182 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1969)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1969)).uintValue () ;
    bool loop_90182 = true ;
    while (loop_90182) {
      loop_90182 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1970)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_90182) {
        loop_90182 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1970)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_90182 && (0 == variant_90182)) {
        loop_90182 = false ;
      ...
      if (loop_90182) {
        ...
        //-------- @ifInstructionForGeneration
        if (var_filewrapperDirectoryMap.reader_hasKey (var_directoryName COMMA_SOURCE_FILE_AT_LINE (1974)).isValidAndTrue ()) {
          //-------- @methodCallInstructionForGeneration
          GALGAS_uint joker_90589_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1976)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_90589_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1975)) ;
          //-------- END @methodCallInstructionForGeneration
        }else{
          //-------- @errorInstructionForGeneration
          GALGAS_location location_2 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (var_builtPath COMMA_SOURCE_FILE_AT_LINE (1982)).operator_concat (GALGAS_string ("' path does not exists for the '") COMMA_SOURCE_FILE_AT_LINE (1982)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1982)) COMMA_SOURCE_FILE_AT_LINE (1982)).operator_concat (GALGAS_string ("' filewrapper") COMMA_SOURCE_FILE_AT_LINE (1982)) COMMA_SOURCE_FILE_AT_LINE (1982)) ;
  ...
  //-------- @ifInstructionForGeneration
  if (var_filewrapperFileMap.reader_hasKey (var_fileName COMMA_SOURCE_FILE_AT_LINE (1987)).isValidAndTrue ()) {
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_90988_0 ; // Joker input parameter
    GALGAS_uint joker_90991_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1988)), joker_90988_0, joker_90991_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1988)) ;
    //-------- END @methodCallInstructionForGeneration
  }else{
    //-------- @errorInstructionForGeneration
    GALGAS_location location_3 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (var_fileName COMMA_SOURCE_FILE_AT_LINE (1991)).operator_concat (GALGAS_string ("' file does not exist in the '") COMMA_SOURCE_FILE_AT_LINE (1991)).operator_concat (var_builtPath COMMA_SOURCE_FILE_AT_LINE (1991)).operator_concat (GALGAS_string ("' directory of '") COMMA_SOURCE_FILE_AT_LINE (1991)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1991)) COMMA_SOURCE_FILE_AT_LINE (1991)).operator_concat (GALGAS_string ("' filewrapper") COMMA_SOURCE_FILE_AT_LINE (1991)) COMMA_SOURCE_FILE_AT_LINE (1990)) ;
