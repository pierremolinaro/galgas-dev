...
void routine_analyzeConstructorInvocation (const GALGAS_unifiedTypeMapProxy constinArgument_inType,
  ...
  if (kBoolTrue == test_1) {
    ...
    if (NULL != objectArray_36291) {
      ...
      if (kBoolTrue == test_3) {
        ...
        while (enumerator_36837.hasCurrentObject ()) {
          ...
          cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_36909 (enumerator_36837.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          while (enumerator_36909.hasCurrentObject ()) {
            var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_36909.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 576))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 576))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 576)) ;
    ...
    cEnumerator_actualOutputExpressionList enumerator_38045 (constinArgument_inConstuctorEffectiveParameterExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_38080 (var_constructorFormalArgumentTypeList, kEnumeration_up) ;
    while (enumerator_38045.hasCurrentObject () && enumerator_38080.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_38045.current_mExpression (HERE).ptr (), enumerator_38080.current_mType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 598)) ;
      {
      routine_checkAssignmentTypes (enumerator_38080.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 599)), enumerator_38045.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 599)) ;
      }
      ...
      enumerator_38045.gotoNextObject () ;
...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_methodKind joker_45676_5 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_45676_4 ; // Joker input parameter
    GALGAS_location joker_45676_3 ; // Joker input parameter
    GALGAS_bool joker_45676_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_45676_1 ; // Joker input parameter
    GALGAS_string joker_45691_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 790)).method_searchKey (constinArgument_inReaderName, joker_45676_5, joker_45676_4, joker_45676_3, joker_45676_2, joker_45676_1, var_qualifier, joker_45691_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 790)) ;
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 901)).isValid ()) {
      uint32_t variant_49886 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 901)).uintValue () ;
      bool loop_49886 = true ;
      while (loop_49886) {
        loop_49886 = var_ok.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 901)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 901)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 901)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 901)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 901)).isValid () ;
        if (loop_49886) {
          loop_49886 = var_ok.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 901)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 901)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 901)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 901)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 901)).boolValue () ;
        }
        if (loop_49886 && (0 == variant_49886)) {
          loop_49886 = false ;
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        GALGAS_location joker_50465_0 ; // Joker input parameter
        GALGAS_methodQualifier joker_50533_2 ; // Joker input parameter
        GALGAS_string joker_50533_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 912)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 913)), var_kind, var_argumentTypeList, joker_50465_0, var_hasCompilerArgument, var_returnedType, joker_50533_2, joker_50533_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 912)) ;
...
static void categoryMethod_readerCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const cMapElement_readerMap * objectArray_41214 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 685))) ;
  if (NULL != objectArray_41214) {
      macroValidSharedObject (objectArray_41214, cMapElement_readerMap) ;
    var_readerFormalArgumentTypeList = objectArray_41214->mAttribute_mArgumentTypeList ;
    var_hasCompilerArgument = objectArray_41214->mAttribute_mHasCompilerArgument ;
    var_returnedType = objectArray_41214->mAttribute_mReturnedType ;
    var_kind = objectArray_41214->mAttribute_mKind ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, objectArray_41214->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, objectArray_41214->mAttribute_mErrorMessage  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 691)) ;
    }
  }else{
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_typedAttributeList enumerator_41901 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 700)), kEnumeration_up) ;
      while (enumerator_41901.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_attributeType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (enumerator_41901.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 701)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 701)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 701)) ;
        ...
        const cMapElement_readerMap * objectArray_42130 = (const cMapElement_readerMap *) var_aMap.readAccessForWithInstruction (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 703))) ;
        if (NULL != objectArray_42130) {
            macroValidSharedObject (objectArray_42130, cMapElement_readerMap) ;
          var_matchingReaderCount.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 704)) ;
          var_readerFormalArgumentTypeList = objectArray_42130->mAttribute_mArgumentTypeList ;
          var_hasCompilerArgument = objectArray_42130->mAttribute_mHasCompilerArgument ;
          var_returnedType = objectArray_42130->mAttribute_mReturnedType ;
          var_kind = objectArray_42130->mAttribute_mKind ;
          var_fieldList.addAssign_operation (enumerator_41901.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 709))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 709)) ;
          const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, objectArray_42130->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_location location_4 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_4, objectArray_42130->mAttribute_mErrorMessage  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 711)) ;
          }
        }
      ...
      if (kBoolTrue == test_5) {
        ...
        if (kBoolTrue == test_7) {
          GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
          cEnumerator_stringlist enumerator_42988 (var_fieldList, kEnumeration_up) ;
          while (enumerator_42988.hasCurrentObject ()) {
            var_s.dotAssign_operation (enumerator_42988.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 724)) ;
            if (enumerator_42988.hasNextObject ()) {
              var_s.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 725)) ;
            }
            enumerator_42988.gotoNextObject () ;
          }
      ...
      if (kBoolTrue == test_9) {
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_readerMap enumerator_43686 (var_readerMap, kEnumeration_up) ;
        while (enumerator_43686.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_43686.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 741))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 741))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 741)) ;
          cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_43754 (enumerator_43686.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          while (enumerator_43754.hasCurrentObject ()) {
            var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_43754.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 743))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 743))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 743)) ;
            enumerator_43754.gotoNextObject () ;
          }
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_43686.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 745))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 745))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 745)) ;
          enumerator_43686.gotoNextObject () ;
        }
  ...
  if (kBoolTrue == test_14) {
    ...
    cEnumerator_actualOutputExpressionList enumerator_44708 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_44738 (var_readerFormalArgumentTypeList, kEnumeration_up) ;
    while (enumerator_44708.hasCurrentObject () && enumerator_44738.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_44708.current_mExpression (HERE).ptr (), enumerator_44738.current_mType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 763)) ;
      {
      routine_checkAssignmentTypes (enumerator_44738.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 764)), enumerator_44708.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 764)) ;
      }
      ...
      enumerator_44708.gotoNextObject () ;
      enumerator_44738.gotoNextObject () ;
    }
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_functionSignature enumerator_81739 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_actualOutputExpressionList enumerator_81756 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    while (enumerator_81739.hasCurrentObject () && enumerator_81756.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_expression ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_81756.current_mExpression (HERE).ptr (), enumerator_81739.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1722)) ;
      {
      routine_checkAssignmentTypes (enumerator_81739.current_mFormalArgumentType (HERE), var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1728)), enumerator_81756.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1728)) ;
      }
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_81739.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_81756.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_5) {
        GALGAS_string temp_6 ;
        const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, enumerator_81739.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_7) {
          temp_6 = enumerator_81739.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1730)) ;
        }else if (kBoolFalse == test_7) {
          temp_6 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_8 (enumerator_81756.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_81739.gotoNextObject () ;
      enumerator_81756.gotoNextObject () ;
    }
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool joker_83668_26 ; // Joker input parameter
  GALGAS_bool joker_83668_25 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_83668_24 ; // Joker input parameter
  GALGAS_typeKindEnum joker_83668_23 ; // Joker input parameter
  GALGAS_bool joker_83668_22 ; // Joker input parameter
  GALGAS_typedAttributeList joker_83668_21 ; // Joker input parameter
  GALGAS_attributeMap joker_83668_20 ; // Joker input parameter
  GALGAS_typedAttributeList joker_83668_19 ; // Joker input parameter
  GALGAS_constructorMap joker_83668_18 ; // Joker input parameter
  GALGAS_readerMap joker_83668_17 ; // Joker input parameter
  GALGAS_modifierMap joker_83668_16 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_83668_15 ; // Joker input parameter
  GALGAS_classMethodMap joker_83668_14 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_83668_13 ; // Joker input parameter
  GALGAS_stringlist joker_83668_12 ; // Joker input parameter
  GALGAS_uint joker_83668_11 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_83668_10 ; // Joker input parameter
  GALGAS_stringset joker_83668_9 ; // Joker input parameter
  GALGAS_lstringlist joker_83668_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_83668_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_83668_6 ; // Joker input parameter
  GALGAS_bool joker_83668_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_83668_4 ; // Joker input parameter
  GALGAS_string joker_83668_3 ; // Joker input parameter
  GALGAS_string joker_83668_2 ; // Joker input parameter
  GALGAS_headerKind joker_83668_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_83668_26, joker_83668_25, joker_83668_24, joker_83668_23, joker_83668_22, joker_83668_21, joker_83668_20, joker_83668_19, joker_83668_18, joker_83668_17, joker_83668_16, joker_83668_15, joker_83668_14, joker_83668_13, joker_83668_12, joker_83668_11, joker_83668_10, joker_83668_9, joker_83668_8, joker_83668_7, joker_83668_6, joker_83668_5, joker_83668_4, joker_83668_3, joker_83668_2, joker_83668_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1774)) ;
...
static void categoryMethod_testDynamicClassInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1801)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1801)).isValid ()) {
      uint32_t variant_84866 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1801)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1801)).uintValue () ;
      bool loop_84866 = true ;
      while (loop_84866) {
        loop_84866 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1802)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1802)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1802)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1802)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1802)).isValid () ;
        if (loop_84866) {
          loop_84866 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1802)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1802)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1802)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1802)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1802)).boolValue () ;
        }
        if (loop_84866 && (0 == variant_84866)) {
          loop_84866 = false ;
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1850)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1850)).isValid ()) {
      uint32_t variant_86580 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1850)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1850)).uintValue () ;
      bool loop_86580 = true ;
      while (loop_86580) {
        loop_86580 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1851)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1851)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1851)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1851)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1851)).isValid () ;
        if (loop_86580) {
          loop_86580 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1851)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1851)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1851)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1851)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1851)).boolValue () ;
        }
        if (loop_86580 && (0 == variant_86580)) {
          loop_86580 = false ;
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool var_isInternal ;
  GALGAS_lstringlist joker_88293_4 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_88293_3 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_88293_2 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_88293_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_88293_4, joker_88293_3, joker_88293_2, joker_88293_1, var_isInternal, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1897)) ;
  const enumGalgasBool test_0 = var_isInternal.boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool var_isInternal ;
  GALGAS_lstring joker_89483_4 ; // Joker input parameter
  GALGAS_lstringlist joker_89483_3 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_89483_2 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_89483_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_89483_4, joker_89483_3, joker_89483_2, joker_89483_1, var_filewrapperTemplateMap, var_isInternal, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1928)) ;
  const enumGalgasBool test_0 = var_isInternal.boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  GALGAS_lstring joker_90098_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_90098_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1942)) ;
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_actualOutputExpressionList enumerator_90685 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_90704 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_90685.hasCurrentObject () && enumerator_90704.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_90685.current_mExpression (HERE).ptr (), enumerator_90704.current_mType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1955)) ;
      {
      routine_checkAssignmentTypes (enumerator_90704.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1956)), enumerator_90685.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1956)) ;
      }
      var_effectiveParameterList.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1957)) ;
      enumerator_90685.gotoNextObject () ;
      enumerator_90704.gotoNextObject () ;
    }
  }
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool var_isInternal ;
  GALGAS_lstring joker_92192_0 ; // Joker input parameter
  GALGAS_lstringlist joker_92199_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_92296_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_92192_0, joker_92199_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_92296_0, var_isInternal, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1990)) ;
  ...
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2008)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2008)).isValid ()) {
    uint32_t variant_92796 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2008)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2008)).uintValue () ;
    bool loop_92796 = true ;
    while (loop_92796) {
      loop_92796 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2009)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValid () ;
      if (loop_92796) {
        loop_92796 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2009)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolValue () ;
      }
      if (loop_92796 && (0 == variant_92796)) {
        loop_92796 = false ;
  ...
  if (kBoolTrue == test_9) {
    GALGAS_string joker_93624_0 ; // Joker input parameter
    GALGAS_uint joker_93639_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2028)), joker_93624_0, var_isTextFile, joker_93639_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2028)) ;
  }else if (kBoolFalse == test_9) {
...
static void categoryMethod_lexiqueIntrospectionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_terminalMap joker_94743_3 ; // Joker input parameter
  GALGAS_indexingListAST joker_94743_2 ; // Joker input parameter
  GALGAS_lstring joker_94743_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (object->mAttribute_mLexiqueComponentName, joker_94743_3, joker_94743_2, joker_94743_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2057)) ;
...
static void categoryMethod_expressionListCollectionValue_analyze (const cPtr_abstractCollectionValueElement * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_actualOutputExpressionList enumerator_97346 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_97371 (var_formalParameterTypeList, kEnumeration_up) ;
    while (enumerator_97346.hasCurrentObject () && enumerator_97371.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_97346.current_mExpression (HERE).ptr (), enumerator_97371.current_mType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2122)) ;
      {
      routine_checkAssignmentTypes (enumerator_97371.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2123)), enumerator_97346.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2123)) ;
      }
      ...
      enumerator_97346.gotoNextObject () ;
      enumerator_97371.gotoNextObject () ;
    }
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_3) {
      ...
      if (kBoolTrue == test_5) {
        ...
        cEnumerator_collectionValueElementList enumerator_100030 (object->mAttribute_mElementList, kEnumeration_up) ;
        while (enumerator_100030.hasCurrentObject ()) {
          callCategoryMethod_analyze ((const cPtr_abstractCollectionValueElement *) enumerator_100030.current_mElement (HERE).ptr (), constinArgument_inAnalysisContext, var_targetType, ioArgument_ioVariableMap, var_collectionValueElementListForGeneration, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2192)) ;
          enumerator_100030.gotoNextObject () ;
        }
