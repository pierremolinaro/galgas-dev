...
void routine_analyzeConstructorInvocation (const GALGAS_unifiedTypeMapProxy constinArgument_inType,
  ...
  if (kBoolTrue == test_1) {
    ...
    const cMapElement_constructorMap * objectArray_36273 = (const cMapElement_constructorMap *) var_constructorMap.readAccessForWithInstruction (constinArgument_inConstructorName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 561))) ;
    if (NULL != objectArray_36273) {
        macroValidSharedObject (objectArray_36273, cMapElement_constructorMap) ;
      var_constructorFormalArgumentTypeList = objectArray_36273->mAttribute_mArgumentTypeList ;
      outArgument_outHasCompilerArgument = objectArray_36273->mAttribute_mHasCompilerArgument ;
      outArgument_outReturnedType = objectArray_36273->mAttribute_mReturnedType ;
    }else{
      ...
      if (kBoolTrue == test_3) {
        ...
        cEnumerator_constructorMap enumerator_36819 (var_constructorMap, kEnumeration_up) ;
        while (enumerator_36819.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_36819.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 574))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 574))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 574)) ;
          cEnumerator_functionSignature enumerator_36891 (enumerator_36819.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          while (enumerator_36891.hasCurrentObject ()) {
            GALGAS_string temp_5 ;
            const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, enumerator_36891.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_6) {
              temp_5 = enumerator_36891.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 576)) ;
            }else if (kBoolFalse == test_6) {
              temp_5 = GALGAS_string::makeEmptyString () ;
            }
            var_s.dotAssign_operation (GALGAS_string (" \?").add_operation (temp_5, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 576)).add_operation (GALGAS_string ("@"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 576)).operator_concat (enumerator_36891.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 576))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 576))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 576)) ;
            enumerator_36891.gotoNextObject () ;
          }
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_36819.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 578))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 578))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 578)) ;
    ...
    cEnumerator_actualOutputExpressionList enumerator_38128 (constinArgument_inConstuctorEffectiveParameterExpressions, kEnumeration_up) ;
    cEnumerator_functionSignature enumerator_38163 (var_constructorFormalArgumentTypeList, kEnumeration_up) ;
    while (enumerator_38128.hasCurrentObject () && enumerator_38163.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_38128.current_mExpression (HERE).ptr (), enumerator_38163.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 598)) ;
      {
      routine_checkAssignmentTypes (enumerator_38163.current_mFormalArgumentType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 599)), enumerator_38128.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 599)) ;
      }
...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_methodKind joker_46074_5 ; // Joker input parameter
    GALGAS_functionSignature joker_46074_4 ; // Joker input parameter
    GALGAS_location joker_46074_3 ; // Joker input parameter
    GALGAS_bool joker_46074_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_46074_1 ; // Joker input parameter
    GALGAS_string joker_46089_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 793)).method_searchKey (constinArgument_inReaderName, joker_46074_5, joker_46074_4, joker_46074_3, joker_46074_2, joker_46074_1, var_qualifier, joker_46089_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 793)) ;
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (GALGAS_uint::constructor_max (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).isValid ()) {
      uint32_t variant_50284 = GALGAS_uint::constructor_max (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).uintValue () ;
      bool loop_50284 = true ;
      while (loop_50284) {
        loop_50284 = var_ok.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).isValid () ;
        if (loop_50284) {
          loop_50284 = var_ok.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 904)).boolValue () ;
        }
        if (loop_50284 && (0 == variant_50284)) {
          loop_50284 = false ;
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        GALGAS_location joker_50845_0 ; // Joker input parameter
        GALGAS_methodQualifier joker_50913_2 ; // Joker input parameter
        GALGAS_string joker_50913_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 915)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 916)), var_kind, var_argumentTypeList, joker_50845_0, var_hasCompilerArgument, var_returnedType, joker_50913_2, joker_50913_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 915)) ;
...
static void categoryMethod_readerCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const cMapElement_readerMap * objectArray_41307 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 685))) ;
  if (NULL != objectArray_41307) {
      macroValidSharedObject (objectArray_41307, cMapElement_readerMap) ;
    var_readerFormalArgumentTypeList = objectArray_41307->mAttribute_mArgumentTypeList ;
    var_hasCompilerArgument = objectArray_41307->mAttribute_mHasCompilerArgument ;
    var_returnedType = objectArray_41307->mAttribute_mReturnedType ;
    var_kind = objectArray_41307->mAttribute_mKind ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, objectArray_41307->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, objectArray_41307->mAttribute_mErrorMessage  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 691)) ;
    }
  }else{
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_typedAttributeList enumerator_41948 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 700)), kEnumeration_up) ;
      while (enumerator_41948.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_attributeType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (enumerator_41948.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 701)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 701)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 701)) ;
        ...
        const cMapElement_readerMap * objectArray_42177 = (const cMapElement_readerMap *) var_aMap.readAccessForWithInstruction (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 703))) ;
        if (NULL != objectArray_42177) {
            macroValidSharedObject (objectArray_42177, cMapElement_readerMap) ;
          var_matchingReaderCount.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 704)) ;
          var_readerFormalArgumentTypeList = objectArray_42177->mAttribute_mArgumentTypeList ;
          var_hasCompilerArgument = objectArray_42177->mAttribute_mHasCompilerArgument ;
          var_returnedType = objectArray_42177->mAttribute_mReturnedType ;
          var_kind = objectArray_42177->mAttribute_mKind ;
          var_fieldList.addAssign_operation (enumerator_41948.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 709))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 709)) ;
          const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, objectArray_42177->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_location location_4 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_4, objectArray_42177->mAttribute_mErrorMessage  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 711)) ;
          }
        }
        enumerator_41948.gotoNextObject () ;
      }
      ...
      if (kBoolTrue == test_5) {
        ...
        if (kBoolTrue == test_7) {
          GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
          cEnumerator_stringlist enumerator_43035 (var_fieldList, kEnumeration_up) ;
          while (enumerator_43035.hasCurrentObject ()) {
            var_s.dotAssign_operation (enumerator_43035.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 724)) ;
            if (enumerator_43035.hasNextObject ()) {
              var_s.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 725)) ;
            }
            enumerator_43035.gotoNextObject () ;
          }
      ...
      if (kBoolTrue == test_9) {
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_readerMap enumerator_43733 (var_readerMap, kEnumeration_up) ;
        while (enumerator_43733.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_43733.current_lkey (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 741))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 741))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 741)) ;
          cEnumerator_functionSignature enumerator_43801 (enumerator_43733.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          while (enumerator_43801.hasCurrentObject ()) {
            GALGAS_string temp_11 ;
            const enumGalgasBool test_12 = GALGAS_bool (kIsNotEqual, enumerator_43801.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_12) {
              temp_11 = enumerator_43801.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 743)) ;
            }else if (kBoolFalse == test_12) {
              temp_11 = GALGAS_string::makeEmptyString () ;
            }
            var_s.dotAssign_operation (GALGAS_string (" \?").add_operation (temp_11, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 743)).add_operation (GALGAS_string ("@"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 743)).operator_concat (enumerator_43801.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 743))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 743))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 743)) ;
            enumerator_43801.gotoNextObject () ;
          }
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_43733.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 745))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 745))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 745)) ;
  ...
  if (kBoolTrue == test_16) {
    ...
    cEnumerator_actualOutputExpressionList enumerator_44856 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_functionSignature enumerator_44886 (var_readerFormalArgumentTypeList, kEnumeration_up) ;
    while (enumerator_44856.hasCurrentObject () && enumerator_44886.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_44856.current_mExpression (HERE).ptr (), enumerator_44886.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 763)) ;
      const enumGalgasBool test_18 = GALGAS_bool (kIsNotEqual, enumerator_44886.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_44856.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_18) {
        GALGAS_string temp_19 ;
        const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_44886.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_20) {
          temp_19 = GALGAS_string (":") ;
        }else if (kBoolFalse == test_20) {
          temp_19 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_21 (enumerator_44856.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_21, GALGAS_string ("the selector should be '!").operator_concat (enumerator_44886.current_mFormalSelector (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 765))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 765)).operator_concat (temp_19.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 765))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 765))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 765)) ;
      }
      {
      routine_checkAssignmentTypes (enumerator_44886.current_mFormalArgumentType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 767)), enumerator_44856.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 767)) ;
      }
      ...
      enumerator_44856.gotoNextObject () ;
      enumerator_44886.gotoNextObject () ;
    }
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_functionSignature enumerator_82119 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_actualOutputExpressionList enumerator_82136 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    while (enumerator_82119.hasCurrentObject () && enumerator_82136.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_expression ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_82136.current_mExpression (HERE).ptr (), enumerator_82119.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1725)) ;
      {
      routine_checkAssignmentTypes (enumerator_82119.current_mFormalArgumentType (HERE), var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1731)), enumerator_82136.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1731)) ;
      }
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_82119.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_82136.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_5) {
        GALGAS_string temp_6 ;
        const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, enumerator_82119.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_7) {
          temp_6 = enumerator_82119.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1733)) ;
        }else if (kBoolFalse == test_7) {
          temp_6 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_8 (enumerator_82136.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      enumerator_82119.gotoNextObject () ;
      enumerator_82136.gotoNextObject () ;
    }
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool joker_84048_26 ; // Joker input parameter
  GALGAS_bool joker_84048_25 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_84048_24 ; // Joker input parameter
  GALGAS_typeKindEnum joker_84048_23 ; // Joker input parameter
  GALGAS_bool joker_84048_22 ; // Joker input parameter
  GALGAS_typedAttributeList joker_84048_21 ; // Joker input parameter
  GALGAS_attributeMap joker_84048_20 ; // Joker input parameter
  GALGAS_typedAttributeList joker_84048_19 ; // Joker input parameter
  GALGAS_constructorMap joker_84048_18 ; // Joker input parameter
  GALGAS_readerMap joker_84048_17 ; // Joker input parameter
  GALGAS_modifierMap joker_84048_16 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_84048_15 ; // Joker input parameter
  GALGAS_classMethodMap joker_84048_14 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_84048_13 ; // Joker input parameter
  GALGAS_stringlist joker_84048_12 ; // Joker input parameter
  GALGAS_uint joker_84048_11 ; // Joker input parameter
  GALGAS_functionSignature joker_84048_10 ; // Joker input parameter
  GALGAS_stringset joker_84048_9 ; // Joker input parameter
  GALGAS_lstringlist joker_84048_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_84048_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_84048_6 ; // Joker input parameter
  GALGAS_bool joker_84048_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_84048_4 ; // Joker input parameter
  GALGAS_string joker_84048_3 ; // Joker input parameter
  GALGAS_string joker_84048_2 ; // Joker input parameter
  GALGAS_headerKind joker_84048_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_84048_26, joker_84048_25, joker_84048_24, joker_84048_23, joker_84048_22, joker_84048_21, joker_84048_20, joker_84048_19, joker_84048_18, joker_84048_17, joker_84048_16, joker_84048_15, joker_84048_14, joker_84048_13, joker_84048_12, joker_84048_11, joker_84048_10, joker_84048_9, joker_84048_8, joker_84048_7, joker_84048_6, joker_84048_5, joker_84048_4, joker_84048_3, joker_84048_2, joker_84048_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1777)) ;
...
static void categoryMethod_testDynamicClassInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1804)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1804)).isValid ()) {
      uint32_t variant_85246 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1804)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1804)).uintValue () ;
      bool loop_85246 = true ;
      while (loop_85246) {
        loop_85246 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1805)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1805)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1805)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1805)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1805)).isValid () ;
        if (loop_85246) {
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1853)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1853)).isValid ()) {
      uint32_t variant_86960 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1853)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1853)).uintValue () ;
      bool loop_86960 = true ;
      while (loop_86960) {
        loop_86960 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).isValid () ;
        if (loop_86960) {
          loop_86960 = var_found.operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).reader_isNull (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)) COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1854)).boolValue () ;
        }
        if (loop_86960 && (0 == variant_86960)) {
          loop_86960 = false ;
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool var_isInternal ;
  GALGAS_lstringlist joker_88673_4 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_88673_3 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_88673_2 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_88673_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_88673_4, joker_88673_3, joker_88673_2, joker_88673_1, var_isInternal, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1900)) ;
  const enumGalgasBool test_0 = var_isInternal.boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool var_isInternal ;
  GALGAS_lstring joker_89863_4 ; // Joker input parameter
  GALGAS_lstringlist joker_89863_3 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_89863_2 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_89863_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_89863_4, joker_89863_3, joker_89863_2, joker_89863_1, var_filewrapperTemplateMap, var_isInternal, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1931)) ;
  const enumGalgasBool test_0 = var_isInternal.boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  GALGAS_lstring joker_90478_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_90478_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1945)) ;
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_actualOutputExpressionList enumerator_91065 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_91084 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_91065.hasCurrentObject () && enumerator_91084.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_91065.current_mExpression (HERE).ptr (), enumerator_91084.current_mType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1958)) ;
      {
      routine_checkAssignmentTypes (enumerator_91084.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1959)), enumerator_91065.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1959)) ;
      }
      var_effectiveParameterList.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1960)) ;
      enumerator_91065.gotoNextObject () ;
      enumerator_91084.gotoNextObject () ;
    }
  }
  outArgument_outExpression = GALGAS_filewrapperTemplateInExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1966)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1967)), object->mAttribute_mFilewrapperTemplateName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1968)), var_effectiveParameterList  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1964)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1984)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("path is empty")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1985)) ;
    var_directoryList.drop () ; // Release error dropped variable
    var_fileName.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_firstCharacterOrNul (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1986)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the path should not begin with '/'")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1987)) ;
      var_directoryList.drop () ; // Release error dropped variable
      var_fileName.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      var_directoryList = object->mAttribute_mFilewrapperPath.mAttribute_string.reader_componentsSeparatedByString (GALGAS_string ("/") COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1989)) ;
      {
      var_directoryList.modifier_popLast (var_fileName, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1990)) ;
      }
    }
  }
  ...
  GALGAS_bool var_isInternal ;
  GALGAS_lstring joker_92572_0 ; // Joker input parameter
  GALGAS_lstringlist joker_92579_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_92676_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_92572_0, joker_92579_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_92676_0, var_isInternal, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 1993)) ;
  const enumGalgasBool test_4 = var_isInternal.boolEnum () ;
  if (kBoolTrue == test_4) {
    GALGAS_location var_filewrapperDeclarationLocation = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.reader_locationForKey (object->mAttribute_mFilewrapperName.mAttribute_string, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2004)) ;
    const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, object->mAttribute_mFilewrapperName.mAttribute_location.reader_file (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2005)).objectCompare (var_filewrapperDeclarationLocation.reader_file (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2005)))).boolEnum () ;
    if (kBoolTrue == test_5) {
      GALGAS_location location_6 (object->mAttribute_mFilewrapperName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_6, GALGAS_string ("this filewrapper is internal to '").operator_concat (var_filewrapperDeclarationLocation.reader_file (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2006))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2006)).operator_concat (GALGAS_string ("' file")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2006))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2006)) ;
    }
  }
  GALGAS_string var_builtPath = GALGAS_string::makeEmptyString () ;
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2011)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2011)).isValid ()) {
    uint32_t variant_93176 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2011)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2011)).uintValue () ;
    bool loop_93176 = true ;
    while (loop_93176) {
      loop_93176 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2012)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValid () ;
      if (loop_93176) {
        loop_93176 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2012)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolValue () ;
      }
      if (loop_93176 && (0 == variant_93176)) {
        loop_93176 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2011)) ;
      }
      if (loop_93176) {
        variant_93176 -- ;
        GALGAS_string var_directoryName ;
        {
        var_directoryList.modifier_popFirst (var_directoryName, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2014)) ;
        }
        var_builtPath.dotAssign_operation (var_directoryName.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2015))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2015)) ;
        const enumGalgasBool test_7 = var_filewrapperDirectoryMap.reader_hasKey (var_directoryName COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2016)).boolEnum () ;
        if (kBoolTrue == test_7) {
          GALGAS_uint joker_93584_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2018)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_93584_0, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2017)) ;
        }else if (kBoolFalse == test_7) {
          GALGAS_location location_8 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_8, GALGAS_string ("the '").operator_concat (var_builtPath  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2024)).operator_concat (GALGAS_string ("' path does not exists for the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2024)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2024))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2024)).operator_concat (GALGAS_string ("' filewrapper")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2024))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2024)) ;
          var_filewrapperFileMap.drop () ; // Release error dropped variable
          var_directoryList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2025)) ;
        }
      }
    }
  }
  ...
  const enumGalgasBool test_9 = var_filewrapperFileMap.reader_hasKey (var_fileName COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2030)).boolEnum () ;
  if (kBoolTrue == test_9) {
    GALGAS_string joker_94004_0 ; // Joker input parameter
    GALGAS_uint joker_94019_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2031)), joker_94004_0, var_isTextFile, joker_94019_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2031)) ;
  }else if (kBoolFalse == test_9) {
    GALGAS_location location_10 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_10, GALGAS_string ("the '").operator_concat (var_fileName  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2034)).operator_concat (GALGAS_string ("' file does not exist in the '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2034)).operator_concat (var_builtPath  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2034)).operator_concat (GALGAS_string ("' directory of '")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2034)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2034))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2034)).operator_concat (GALGAS_string ("' filewrapper")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2034))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2033)) ;
  ...
  if (kBoolTrue == test_12) {
    ...
    temp_11 = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("data"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2042)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2042)) ;
  }
  outArgument_outExpression = GALGAS_filewrapperStaticPathInExpressionForGeneration::constructor_new (temp_11, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2044)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2045)), var_fileIndex, var_isTextFile  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2039)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_lexiqueIntrospectionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_terminalMap joker_95123_3 ; // Joker input parameter
  GALGAS_indexingListAST joker_95123_2 ; // Joker input parameter
  GALGAS_lstring joker_95123_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (object->mAttribute_mLexiqueComponentName, joker_95123_3, joker_95123_2, joker_95123_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2060)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("unknown reader")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2066)) ;
  }
  outArgument_outExpression = GALGAS_lexiqueIntrospectionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_string ("stringlist").reader_nowhere (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2070)), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2070)), object->mAttribute_mLexiqueComponentName.mAttribute_location, object->mAttribute_mLexiqueComponentName.mAttribute_string, object->mAttribute_mLexiqueReaderName.mAttribute_string  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2069)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_expressionCollectionValue_analyze (const cPtr_abstractCollectionValueElement * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mExpression.ptr (), constinArgument_inElementType, constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2096)) ;
  {
  routine_checkAssignmentTypes (constinArgument_inElementType, var_expression.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2103)), object->mAttribute_mExpressionLocation, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2103)) ;
  }
  ioArgument_ioCollectionValueElementListForGeneration.addAssign_operation (GALGAS_expressionCollectionValueForGeneration::constructor_new (object->mAttribute_mExpressionLocation, var_expression  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2105))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2105)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_expressionListCollectionValue_analyze (const cPtr_abstractCollectionValueElement * inObject,
  ...
  GALGAS_functionSignature var_formalParameterTypeList = constinArgument_inElementType.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2116)) ;
  GALGAS_semanticExpressionListForGeneration var_semanticExpressionListForGeneration ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_formalParameterTypeList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2118)).objectCompare (object->mAttribute_mExpressionList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2118)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfExpressionLocation, GALGAS_string ("element of of '@").operator_concat (constinArgument_inElementType.reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2119))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2119)).operator_concat (GALGAS_string ("' requires ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2119)).operator_concat (var_formalParameterTypeList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2120)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2119))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2119)).operator_concat (GALGAS_string (" parameter(s), while this list has ")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2120)).operator_concat (object->mAttribute_mExpressionList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2121)).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2120))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2120)).operator_concat (GALGAS_string (" element(s)")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2121))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2119)) ;
    var_semanticExpressionListForGeneration.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    var_semanticExpressionListForGeneration = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2123)) ;
    cEnumerator_actualOutputExpressionList enumerator_97708 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    cEnumerator_functionSignature enumerator_97733 (var_formalParameterTypeList, kEnumeration_up) ;
    while (enumerator_97708.hasCurrentObject () && enumerator_97733.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_97708.current_mExpression (HERE).ptr (), enumerator_97733.current_mFormalArgumentType (HERE), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2125)) ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_97733.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_97708.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string temp_2 ;
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_97733.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_3) {
          temp_2 = GALGAS_string (":") ;
        }else if (kBoolFalse == test_3) {
          temp_2 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_4 (enumerator_97708.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the selector should be '!").operator_concat (enumerator_97733.current_mFormalSelector (HERE).reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2127))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2127)).operator_concat (temp_2.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2127))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2127))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2127)) ;
      }
      {
      routine_checkAssignmentTypes (enumerator_97733.current_mFormalArgumentType (HERE), var_exp.reader_mType (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2129)), enumerator_97708.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2129)) ;
      }
      var_semanticExpressionListForGeneration.addAssign_operation (var_exp  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2130)) ;
      enumerator_97708.gotoNextObject () ;
      enumerator_97733.gotoNextObject () ;
    }
    ioArgument_ioCollectionValueElementListForGeneration.addAssign_operation (GALGAS_expressionListCollectionForGeneration::constructor_new (object->mAttribute_mEndOfExpressionLocation, var_semanticExpressionListForGeneration  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2132))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2132)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_collectionValueAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    var_targetType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2182)) ;
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_targetType.objectCompare (GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2185)))).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_location location_2 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("Cannot infer type")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2186)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_1) {
    const enumGalgasBool test_3 = var_targetType.reader_mSupportCollectionValue (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2187)).operator_not (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2187)).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_location location_4 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, GALGAS_string ("the @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2188))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2188)).operator_concat (GALGAS_string (" type does not support collection value")  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2188))  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2188)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_3) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, object->mAttribute_mElementList.reader_length (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2190)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        outArgument_outExpression = GALGAS_defaultConstructorExpressionForGeneration::constructor_new (var_targetType, object->mAttribute_mTypeName.mAttribute_location  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2191)) ;
      }else if (kBoolFalse == test_5) {
        GALGAS_collectionValueElementListForGeneration var_collectionValueElementListForGeneration = GALGAS_collectionValueElementListForGeneration::constructor_emptyList (SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2196)) ;
        cEnumerator_collectionValueElementList enumerator_100642 (object->mAttribute_mElementList, kEnumeration_up) ;
        while (enumerator_100642.hasCurrentObject ()) {
          callCategoryMethod_analyze ((const cPtr_abstractCollectionValueElement *) enumerator_100642.current_mElement (HERE).ptr (), constinArgument_inAnalysisContext, var_targetType, ioArgument_ioVariableMap, var_collectionValueElementListForGeneration, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2198)) ;
          enumerator_100642.gotoNextObject () ;
        }
        outArgument_outExpression = GALGAS_expressionCollectionForGeneration::constructor_new (var_targetType, object->mAttribute_mEndOfCollectionValue, var_collectionValueElementListForGeneration  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2205)) ;
      }
    }
  }
}
