...
void routine_analyzeConstructorInvocation (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  const cMapElement_constructorMap * objectArray_35801 = (const cMapElement_constructorMap *) var_constructorMap.readAccessForWithInstruction_hasKey (constinArgument_inConstructorName.reader_string (SOURCE_FILE_AT_LINE (541))) ;
  if (NULL != objectArray_35801) {
      macroValidSharedObject (objectArray_35801, const cMapElement_constructorMap) ;
    var_constructorFormalArgumentTypeList = objectArray_35801->mAttribute_mArgumentTypeList ;
    outArgument_outHasCompilerArgument = objectArray_35801->mAttribute_mHasCompilerArgument ;
    outArgument_outReturnedType = objectArray_35801->mAttribute_mReturnedType ;
  }else{
    ...
    if (kBoolTrue == test_0) {
      ...
      cEnumerator_constructorMap enumerator_36297 (var_constructorMap, kEnumeration_up) ;
      while (enumerator_36297.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_36297.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (554)) COMMA_SOURCE_FILE_AT_LINE (554)) COMMA_SOURCE_FILE_AT_LINE (554)) ;
        cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_36365 (enumerator_36297.current_mArgumentTypeList (HERE), kEnumeration_up) ;
        while (enumerator_36365.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_36365.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (556)) COMMA_SOURCE_FILE_AT_LINE (556)) COMMA_SOURCE_FILE_AT_LINE (556)) ;
          enumerator_36365.gotoNextObject () ;
        }
        var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_36297.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (558)) COMMA_SOURCE_FILE_AT_LINE (558)) COMMA_SOURCE_FILE_AT_LINE (558)) ;
  ...
  cEnumerator_semanticExpressionListAST enumerator_37457 (constinArgument_inConstuctorEffectiveParameterExpressions, kEnumeration_up) ;
  cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_37494 (var_constructorFormalArgumentTypeList, kEnumeration_up) ;
  while (enumerator_37457.hasCurrentObject () && enumerator_37494.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_exp ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_37457.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (578)) ;
    {
    routine_checkAssignmentTypes (enumerator_37494.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (579)), enumerator_37457.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (579)) ;
    }
    outArgument_outConstructorEffectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (580)) ;
    enumerator_37457.gotoNextObject () ;
    enumerator_37494.gotoNextObject () ;
  }
}
...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_methodKind joker_44832_5 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_44832_4 ; // Joker input parameter
    GALGAS_location joker_44832_3 ; // Joker input parameter
    GALGAS_bool joker_44832_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_44832_1 ; // Joker input parameter
    GALGAS_string joker_44847_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (764)).method_searchKey (constinArgument_inReaderName, joker_44832_5, joker_44832_4, joker_44832_3, joker_44832_2, joker_44832_1, var_qualifier, joker_44847_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (764)) ;
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (869)).isValid ()) {
      PMUInt32 variant_48828 = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (869)).uintValue () ;
      bool loop_48828 = true ;
      while (loop_48828) {
        loop_48828 = var_ok.operator_not (SOURCE_FILE_AT_LINE (869)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (869)).reader_isNull (SOURCE_FILE_AT_LINE (869)).operator_not (SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)).isValid () ;
        if (loop_48828) {
          loop_48828 = var_ok.operator_not (SOURCE_FILE_AT_LINE (869)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (869)).reader_isNull (SOURCE_FILE_AT_LINE (869)).operator_not (SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)).boolValue () ;
        }
        if (loop_48828 && (0 == variant_48828)) {
          loop_48828 = false ;
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        GALGAS_location joker_49406_0 ; // Joker input parameter
        GALGAS_methodQualifier joker_49474_2 ; // Joker input parameter
        GALGAS_string joker_49474_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (880)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (881)), var_kind, var_argumentTypeList, joker_49406_0, var_hasCompilerArgument, var_returnedType, joker_49474_2, joker_49474_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (880)) ;
        var_ok = GALGAS_bool (kIsEqual, var_argumentTypeList.reader_length (SOURCE_FILE_AT_LINE (889)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (kIsEqual, var_returnedType.objectCompare (constinArgument_inLeftType)) COMMA_SOURCE_FILE_AT_LINE (889)) ;
...
static void categoryMethod_readerCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const cMapElement_readerMap * objectArray_40367 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (657))) ;
  if (NULL != objectArray_40367) {
      macroValidSharedObject (objectArray_40367, const cMapElement_readerMap) ;
    var_readerFormalArgumentTypeList = objectArray_40367->mAttribute_mArgumentTypeList ;
    var_hasCompilerArgument = objectArray_40367->mAttribute_mHasCompilerArgument ;
    var_returnedType = objectArray_40367->mAttribute_mReturnedType ;
    var_kind = objectArray_40367->mAttribute_mKind ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, objectArray_40367->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, objectArray_40367->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (663)) ;
    }
  }else{
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_typedAttributeList enumerator_41047 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (672)), kEnumeration_up) ;
      while (enumerator_41047.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_attributeType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (enumerator_41047.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (673)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (673)), inCompiler COMMA_SOURCE_FILE_AT_LINE (673)) ;
        GALGAS_readerMap var_aMap = var_attributeType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (674)) ;
        const cMapElement_readerMap * objectArray_41286 = (const cMapElement_readerMap *) var_aMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (675))) ;
        if (NULL != objectArray_41286) {
            macroValidSharedObject (objectArray_41286, const cMapElement_readerMap) ;
          var_matchingReaderCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (676)) ;
          var_readerFormalArgumentTypeList = objectArray_41286->mAttribute_mArgumentTypeList ;
          var_hasCompilerArgument = objectArray_41286->mAttribute_mHasCompilerArgument ;
          var_returnedType = objectArray_41286->mAttribute_mReturnedType ;
          var_kind = objectArray_41286->mAttribute_mKind ;
          var_fieldList.addAssign_operation (enumerator_41047.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (681)) COMMA_SOURCE_FILE_AT_LINE (681)) ;
          const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, objectArray_41286->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_location location_4 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_4, objectArray_41286->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (683)) ;
          }
        }
      ...
      if (kBoolTrue == test_5) {
        ...
        if (kBoolTrue == test_7) {
          GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
          cEnumerator_stringlist enumerator_42152 (var_fieldList, kEnumeration_up) ;
          while (enumerator_42152.hasCurrentObject ()) {
            var_s.dotAssign_operation (enumerator_42152.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (696)) ;
            if (enumerator_42152.hasNextObject ()) {
              var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (697)) ;
            }
            enumerator_42152.gotoNextObject () ;
          }
      ...
      if (kBoolTrue == test_9) {
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_readerMap enumerator_42840 (var_readerMap, kEnumeration_up) ;
        while (enumerator_42840.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_42840.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (713)) COMMA_SOURCE_FILE_AT_LINE (713)) COMMA_SOURCE_FILE_AT_LINE (713)) ;
          cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_42908 (enumerator_42840.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          while (enumerator_42908.hasCurrentObject ()) {
            var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_42908.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (715)) COMMA_SOURCE_FILE_AT_LINE (715)) COMMA_SOURCE_FILE_AT_LINE (715)) ;
            enumerator_42908.gotoNextObject () ;
          }
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_42840.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (717)) COMMA_SOURCE_FILE_AT_LINE (717)) COMMA_SOURCE_FILE_AT_LINE (717)) ;
          enumerator_42840.gotoNextObject () ;
        }
        //--- @ifExpressionForGeneration
  ...
  if (kBoolTrue == test_14) {
    ...
    cEnumerator_semanticExpressionListAST enumerator_43860 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_43892 (var_readerFormalArgumentTypeList, kEnumeration_up) ;
    while (enumerator_43860.hasCurrentObject () && enumerator_43892.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_43860.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (736)) ;
      {
      routine_checkAssignmentTypes (enumerator_43892.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (737)), enumerator_43860.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (737)) ;
      }
      ...
      enumerator_43892.gotoNextObject () ;
    }
...
static void categoryMethod_optionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_commandLineOptionMap enumerator_47656 (var_boolOptionMap, kEnumeration_up) ;
    while (enumerator_47656.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47656.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (837)) COMMA_SOURCE_FILE_AT_LINE (837)).operator_concat (GALGAS_string ("' @bool option;") COMMA_SOURCE_FILE_AT_LINE (837)) COMMA_SOURCE_FILE_AT_LINE (837)) ;
      enumerator_47656.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_47752 (var_uintOptionMap, kEnumeration_up) ;
    while (enumerator_47752.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47752.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (840)).operator_concat (GALGAS_string ("' @uint option;") COMMA_SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (840)) ;
      enumerator_47752.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_47850 (var_stringOptionMap, kEnumeration_up) ;
    while (enumerator_47850.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47850.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (843)) COMMA_SOURCE_FILE_AT_LINE (843)).operator_concat (GALGAS_string ("' @string option;") COMMA_SOURCE_FILE_AT_LINE (843)) COMMA_SOURCE_FILE_AT_LINE (843)) ;
...
static void categoryMethod_orExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mType (SOURCE_FILE_AT_LINE (964)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (965)).operator_and (function_binaryOrOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (965)) COMMA_SOURCE_FILE_AT_LINE (965)).objectCompare (GALGAS_uint ((PMUInt32) 0U))), GALGAS_string ("|"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (962)) ;
  }
...
static void categoryMethod_andExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mType (SOURCE_FILE_AT_LINE (996)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (997)).operator_and (function_binaryAndOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (997)) COMMA_SOURCE_FILE_AT_LINE (997)).objectCompare (GALGAS_uint ((PMUInt32) 0U))), GALGAS_string ("&"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (994)) ;
  }
...
static void categoryMethod_xorExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mType (SOURCE_FILE_AT_LINE (1028)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1029)).operator_and (function_binaryXorOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1029)) COMMA_SOURCE_FILE_AT_LINE (1029)).objectCompare (GALGAS_uint ((PMUInt32) 0U))), GALGAS_string ("^"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1026)) ;
  }
...
static void categoryMethod_lowerOrEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1123)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1123)) COMMA_SOURCE_FILE_AT_LINE (1123)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_strictGreaterExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1197)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1197)) COMMA_SOURCE_FILE_AT_LINE (1197)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_rightShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1271)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1271)) COMMA_SOURCE_FILE_AT_LINE (1271)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_leftShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1308)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1308)) COMMA_SOURCE_FILE_AT_LINE (1308)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_addExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mType (SOURCE_FILE_AT_LINE (1346)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1347)).operator_and (function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1347)) COMMA_SOURCE_FILE_AT_LINE (1347)).objectCompare (GALGAS_uint ((PMUInt32) 0U))), GALGAS_string ("+"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1344)) ;
  }
...
static void categoryMethod_subExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mType (SOURCE_FILE_AT_LINE (1378)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1379)).operator_and (function_binarySubOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1379)) COMMA_SOURCE_FILE_AT_LINE (1379)).objectCompare (GALGAS_uint ((PMUInt32) 0U))), GALGAS_string ("-"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1376)) ;
  }
...
static void categoryMethod_multiplicationExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mType (SOURCE_FILE_AT_LINE (1410)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1411)).operator_and (function_binaryMulOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1411)) COMMA_SOURCE_FILE_AT_LINE (1411)).objectCompare (GALGAS_uint ((PMUInt32) 0U))), GALGAS_string ("*"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1408)) ;
  }
...
static void categoryMethod_divisionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  {
  routine_checkDiadicOperator (var_leftType, var_rightExpression.reader_mType (SOURCE_FILE_AT_LINE (1442)), GALGAS_bool (kIsNotEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1443)).operator_and (function_binaryDivOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1443)) COMMA_SOURCE_FILE_AT_LINE (1443)).objectCompare (GALGAS_uint ((PMUInt32) 0U))), GALGAS_string ("/"), object->mAttribute_mOperatorLocation, var_rightExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1440)) ;
  }
...
static void categoryMethod_unaryMinusExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1501)).operator_and (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1501)) COMMA_SOURCE_FILE_AT_LINE (1501)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_notExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1528)).operator_and (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1528)) COMMA_SOURCE_FILE_AT_LINE (1528)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_complementExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1581)).operator_and (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1581)) COMMA_SOURCE_FILE_AT_LINE (1581)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_unifiedTypeMapProxyList enumerator_78266 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_semanticExpressionListAST enumerator_78282 (object->mAttribute_mExpressions, kEnumeration_up) ;
    while (enumerator_78266.hasCurrentObject () && enumerator_78282.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_expression ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_78282.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1658)) ;
      {
      routine_checkAssignmentTypes (enumerator_78266.current_mType (HERE), var_expression.reader_mType (SOURCE_FILE_AT_LINE (1659)), enumerator_78282.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1659)) ;
      }
      var_semanticExpressionListForGeneration.addAssign_operation (var_expression COMMA_SOURCE_FILE_AT_LINE (1660)) ;
      enumerator_78266.gotoNextObject () ;
      enumerator_78282.gotoNextObject () ;
    }
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool joker_79882_23 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_79882_22 ; // Joker input parameter
  GALGAS_typeKindEnum joker_79882_21 ; // Joker input parameter
  GALGAS_typedAttributeList joker_79882_20 ; // Joker input parameter
  GALGAS_attributeMap joker_79882_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_79882_18 ; // Joker input parameter
  GALGAS_constructorMap joker_79882_17 ; // Joker input parameter
  GALGAS_readerMap joker_79882_16 ; // Joker input parameter
  GALGAS_modifierMap joker_79882_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_79882_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_79882_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_79882_12 ; // Joker input parameter
  GALGAS_stringlist joker_79882_11 ; // Joker input parameter
  GALGAS_uint joker_79882_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_79882_9 ; // Joker input parameter
  GALGAS_stringset joker_79882_8 ; // Joker input parameter
  GALGAS_lstringlist joker_79882_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_79882_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_79882_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_79882_4 ; // Joker input parameter
  GALGAS_bool joker_79882_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_79882_2 ; // Joker input parameter
  GALGAS_string joker_79882_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_79882_23, joker_79882_22, joker_79882_21, joker_79882_20, joker_79882_19, joker_79882_18, joker_79882_17, joker_79882_16, joker_79882_15, joker_79882_14, joker_79882_13, joker_79882_12, joker_79882_11, joker_79882_10, joker_79882_9, joker_79882_8, joker_79882_7, joker_79882_6, joker_79882_5, joker_79882_4, joker_79882_3, joker_79882_2, joker_79882_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1698)) ;
...
static void categoryMethod_testDynamicClassInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1724)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1724)).isValid ()) {
      PMUInt32 variant_81001 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1724)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1724)).uintValue () ;
      bool loop_81001 = true ;
      while (loop_81001) {
        loop_81001 = var_found.operator_not (SOURCE_FILE_AT_LINE (1725)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1725)).reader_isNull (SOURCE_FILE_AT_LINE (1725)).operator_not (SOURCE_FILE_AT_LINE (1725)) COMMA_SOURCE_FILE_AT_LINE (1725)).isValid () ;
        if (loop_81001) {
          loop_81001 = var_found.operator_not (SOURCE_FILE_AT_LINE (1725)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1725)).reader_isNull (SOURCE_FILE_AT_LINE (1725)).operator_not (SOURCE_FILE_AT_LINE (1725)) COMMA_SOURCE_FILE_AT_LINE (1725)).boolValue () ;
        }
        if (loop_81001 && (0 == variant_81001)) {
          loop_81001 = false ;
    ...
    inCompiler->emitSemanticError (var_expression.reader_mLocation (SOURCE_FILE_AT_LINE (1735)), GALGAS_string ("expression should be a class instance: it is an @").operator_concat (var_expression.reader_mType (SOURCE_FILE_AT_LINE (1736)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1736)) COMMA_SOURCE_FILE_AT_LINE (1736)).operator_concat (GALGAS_string (" instance") COMMA_SOURCE_FILE_AT_LINE (1736)) COMMA_SOURCE_FILE_AT_LINE (1735)) ;
  }
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1771)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1771)).isValid ()) {
      PMUInt32 variant_82650 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1771)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1771)).uintValue () ;
      bool loop_82650 = true ;
      while (loop_82650) {
        loop_82650 = var_found.operator_not (SOURCE_FILE_AT_LINE (1772)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1772)).reader_isNull (SOURCE_FILE_AT_LINE (1772)).operator_not (SOURCE_FILE_AT_LINE (1772)) COMMA_SOURCE_FILE_AT_LINE (1772)).isValid () ;
        if (loop_82650) {
          loop_82650 = var_found.operator_not (SOURCE_FILE_AT_LINE (1772)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1772)).reader_isNull (SOURCE_FILE_AT_LINE (1772)).operator_not (SOURCE_FILE_AT_LINE (1772)) COMMA_SOURCE_FILE_AT_LINE (1772)).boolValue () ;
        }
        if (loop_82650 && (0 == variant_82650)) {
          loop_82650 = false ;
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstringlist joker_84330_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_84333_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_84336_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_84339_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_84330_0, joker_84333_0, joker_84336_0, joker_84339_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1818)) ;
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_85090_0 ; // Joker input parameter
  GALGAS_lstringlist joker_85093_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_85096_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_85099_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_85090_0, joker_85093_0, joker_85096_0, joker_85099_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1837)) ;
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  GALGAS_lstring joker_85262_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_85262_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1840)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_semanticExpressionListAST enumerator_85849 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_85870 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_85849.hasCurrentObject () && enumerator_85870.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_85849.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (1853)) ;
      {
      routine_checkAssignmentTypes (enumerator_85870.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (1854)), enumerator_85849.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1854)) ;
      }
      var_effectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (1855)) ;
      enumerator_85849.gotoNextObject () ;
      enumerator_85870.gotoNextObject () ;
    }
  }
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_87398_0 ; // Joker input parameter
  GALGAS_lstringlist joker_87405_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_87465_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_87398_0, joker_87405_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87465_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1889)) ;
  ...
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1899)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1899)).isValid ()) {
    PMUInt32 variant_87529 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1899)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1899)).uintValue () ;
    bool loop_87529 = true ;
    while (loop_87529) {
      loop_87529 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1900)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_87529) {
        loop_87529 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1900)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_87529 && (0 == variant_87529)) {
        loop_87529 = false ;
      ...
      if (loop_87529) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_uint joker_87936_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1906)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87936_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1905)) ;
        }else if (kBoolFalse == test_4) {
  ...
  if (kBoolTrue == test_6) {
    GALGAS_string joker_88356_0 ; // Joker input parameter
    GALGAS_uint joker_88371_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1919)), joker_88356_0, var_isTextFile, joker_88371_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1919)) ;
  }else if (kBoolFalse == test_6) {
