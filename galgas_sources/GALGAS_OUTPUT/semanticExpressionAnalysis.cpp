...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mErrorLocationExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_errorLocationExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1779)) ;
  GALGAS_bool var_useLocationReader = GALGAS_bool (kIsNotEqual, var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1786)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType)) ;
  const enumGalgasBool test_4 = var_useLocationReader.boolEnum () ;
  if (kBoolTrue == test_4) {
    GALGAS_readerMap var_readerMap = var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1789)).reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1789)) ;
    const cMapElement_readerMap * objectArray_82817 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (GALGAS_string ("location")) ;
    if (NULL != objectArray_82817) {
        macroValidSharedObject (objectArray_82817, const cMapElement_readerMap) ;
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, objectArray_82817->mAttribute_mArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (1791)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorLocationExpression, GALGAS_string ("the error location expression type is '@").operator_concat (var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1793)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1793)) COMMA_SOURCE_FILE_AT_LINE (1793)).operator_concat (GALGAS_string ("' and defines a 'location' reader with arguments; it should be either of the '@location' type, either defines a 'location' reader without argument that"
          " returns an '@location' object") COMMA_SOURCE_FILE_AT_LINE (1794)) COMMA_SOURCE_FILE_AT_LINE (1792)) ;
      }else if (kBoolFalse == test_5) {
        const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, objectArray_82817->mAttribute_mReturnedType.objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType)).boolEnum () ;
        if (kBoolTrue == test_6) {
          inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorLocationExpression, GALGAS_string ("the error location expression type is '@").operator_concat (var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1798)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1798)) COMMA_SOURCE_FILE_AT_LINE (1798)).operator_concat (GALGAS_string ("' and defines a 'location' reader that returns an '@") COMMA_SOURCE_FILE_AT_LINE (1799)).operator_concat (objectArray_82817->mAttribute_mReturnedType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1799)) COMMA_SOURCE_FILE_AT_LINE (1799)).operator_concat (GALGAS_string ("' object; it should be either of the '@location' type, either defines a 'location' reader without argument that returns an '@location' object") COMMA_SOURCE_FILE_AT_LINE (1800)) COMMA_SOURCE_FILE_AT_LINE (1797)) ;
        }
      }
      var_errorLocationExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType, object->mAttribute_mEndOfErrorLocationExpression, objectArray_82817->mAttribute_mKind, var_errorLocationExpression, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1808)), GALGAS_string ("location"), GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1810)), objectArray_82817->mAttribute_mHasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1803)) ;
    }else{
      inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorLocationExpression, GALGAS_string ("the error location expression type is '@").operator_concat (var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1815)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1815)) COMMA_SOURCE_FILE_AT_LINE (1815)).operator_concat (GALGAS_string ("' and does not define a 'location' reader; it should be either of the '@location' type, either defines a 'location' reader without argument that return"
        "s an '@location' object") COMMA_SOURCE_FILE_AT_LINE (1816)) COMMA_SOURCE_FILE_AT_LINE (1814)) ;
    }
  }
  GALGAS_semanticExpressionForGeneration var_errorMessageExpression ;
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mErrorMessageExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_errorMessageExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1821)) ;
  const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, var_errorMessageExpression.reader_mType (SOURCE_FILE_AT_LINE (1827)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType)).boolEnum () ;
  if (kBoolTrue == test_7) {
    inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorMessageExpression, GALGAS_string ("the error message should be an @string expression") COMMA_SOURCE_FILE_AT_LINE (1828)) ;
  }
  const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1831)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1831)).objectCompare (GALGAS_string ("object"))).boolEnum () ;
  if (kBoolTrue == test_8) {
    outArgument_outExpression = GALGAS_extractObjectInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mEndOfReceiverExpression, var_expression, object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1836)), var_errorLocationExpression, var_errorMessageExpression COMMA_SOURCE_FILE_AT_LINE (1832)) ;
  }else if (kBoolFalse == test_8) {
    outArgument_outExpression = GALGAS_castInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (1843)), var_expression, object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1845)), var_errorLocationExpression, var_errorMessageExpression COMMA_SOURCE_FILE_AT_LINE (1841)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstringlist joker_85921_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_85924_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_85927_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_85930_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_85921_0, joker_85924_0, joker_85927_0, joker_85930_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1861)) ;
  outArgument_outExpression = GALGAS_filewrapperInExpressionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("filewrapper"), object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1864)) COMMA_SOURCE_FILE_AT_LINE (1864)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1864)), object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1865)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1866)), var_filewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1867)) COMMA_SOURCE_FILE_AT_LINE (1863)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_86681_0 ; // Joker input parameter
  GALGAS_lstringlist joker_86684_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_86687_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_86690_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_86681_0, joker_86684_0, joker_86687_0, joker_86690_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1880)) ;
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  GALGAS_lstring joker_86853_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_86853_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1883)) ;
  GALGAS_semanticExpressionListForGeneration var_effectiveParameterList ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1886)).objectCompare (var_templateSignature.reader_length (SOURCE_FILE_AT_LINE (1886)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mFilewrapperTemplateName.reader_string (SOURCE_FILE_AT_LINE (1888)) COMMA_SOURCE_FILE_AT_LINE (1888)).operator_concat (GALGAS_string ("' template of '") COMMA_SOURCE_FILE_AT_LINE (1888)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1888)) COMMA_SOURCE_FILE_AT_LINE (1888)).operator_concat (GALGAS_string ("' filewrapper requires ") COMMA_SOURCE_FILE_AT_LINE (1888)).operator_concat (var_templateSignature.reader_length (SOURCE_FILE_AT_LINE (1889)).reader_string (SOURCE_FILE_AT_LINE (1889)) COMMA_SOURCE_FILE_AT_LINE (1889)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (1889)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1890)).reader_string (SOURCE_FILE_AT_LINE (1890)) COMMA_SOURCE_FILE_AT_LINE (1890)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (1890)) COMMA_SOURCE_FILE_AT_LINE (1887)) ;
    var_effectiveParameterList.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    var_effectiveParameterList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1893)) ;
    cEnumerator_semanticExpressionListAST enumerator_87440 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_87461 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_87440.hasCurrentObject () && enumerator_87461.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_87440.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (1896)) ;
      {
      routine_checkAssignmentTypes (enumerator_87461.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (1897)), enumerator_87440.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1897)) ;
      }
      var_effectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (1898)) ;
      enumerator_87440.gotoNextObject () ;
      enumerator_87461.gotoNextObject () ;
    }
  }
  outArgument_outExpression = GALGAS_filewrapperTemplateInExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1904)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1905)), object->mAttribute_mFilewrapperTemplateName.reader_string (SOURCE_FILE_AT_LINE (1906)), var_effectiveParameterList COMMA_SOURCE_FILE_AT_LINE (1902)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (1921)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("path is empty") COMMA_SOURCE_FILE_AT_LINE (1922)) ;
    var_directoryList.drop () ; // Release error dropped variable
    var_fileName.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1923)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the path should not begin with '/'") COMMA_SOURCE_FILE_AT_LINE (1924)) ;
      var_directoryList.drop () ; // Release error dropped variable
      var_fileName.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      var_directoryList = object->mAttribute_mFilewrapperPath.mAttribute_string.reader_componentsSeparatedByString (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1926)) ;
      {
      var_directoryList.modifier_popLast (var_fileName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1927)) ;
      }
    }
  }
  GALGAS_wrapperFileMap var_filewrapperFileMap ;
  GALGAS_wrapperDirectoryMap var_filewrapperDirectoryMap ;
  GALGAS_lstring joker_88989_0 ; // Joker input parameter
  GALGAS_lstringlist joker_88996_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_89056_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_88989_0, joker_88996_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_89056_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1932)) ;
  GALGAS_string var_builtPath = GALGAS_string::makeEmptyString () ;
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1942)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1942)).isValid ()) {
    PMUInt32 variant_89120 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1942)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1942)).uintValue () ;
    bool loop_89120 = true ;
    while (loop_89120) {
      loop_89120 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1943)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_89120) {
        loop_89120 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1943)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_89120 && (0 == variant_89120)) {
        loop_89120 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (1942)) ;
      }
      if (loop_89120) {
        variant_89120 -- ;
        GALGAS_string var_directoryName ;
        {
        var_directoryList.modifier_popFirst (var_directoryName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1945)) ;
        }
        var_builtPath.dotAssign_operation (var_directoryName.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1946)) COMMA_SOURCE_FILE_AT_LINE (1946)) ;
        const enumGalgasBool test_4 = var_filewrapperDirectoryMap.reader_hasKey (var_directoryName COMMA_SOURCE_FILE_AT_LINE (1947)).boolEnum () ;
        if (kBoolTrue == test_4) {
          GALGAS_uint joker_89525_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1949)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_89525_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1948)) ;
        }else if (kBoolFalse == test_4) {
          GALGAS_location location_5 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("the '").operator_concat (var_builtPath COMMA_SOURCE_FILE_AT_LINE (1955)).operator_concat (GALGAS_string ("' path does not exists for the '") COMMA_SOURCE_FILE_AT_LINE (1955)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1955)) COMMA_SOURCE_FILE_AT_LINE (1955)).operator_concat (GALGAS_string ("' filewrapper") COMMA_SOURCE_FILE_AT_LINE (1955)) COMMA_SOURCE_FILE_AT_LINE (1955)) ;
          var_filewrapperFileMap.drop () ; // Release error dropped variable
          var_directoryList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1956)) ;
        }
      }
    }
  }
  ...
  const enumGalgasBool test_6 = var_filewrapperFileMap.reader_hasKey (var_fileName COMMA_SOURCE_FILE_AT_LINE (1961)).boolEnum () ;
  if (kBoolTrue == test_6) {
    GALGAS_string joker_89945_0 ; // Joker input parameter
    GALGAS_uint joker_89960_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1962)), joker_89945_0, var_isTextFile, joker_89960_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1962)) ;
  }else if (kBoolFalse == test_6) {
    GALGAS_location location_7 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (var_fileName COMMA_SOURCE_FILE_AT_LINE (1965)).operator_concat (GALGAS_string ("' file does not exist in the '") COMMA_SOURCE_FILE_AT_LINE (1965)).operator_concat (var_builtPath COMMA_SOURCE_FILE_AT_LINE (1965)).operator_concat (GALGAS_string ("' directory of '") COMMA_SOURCE_FILE_AT_LINE (1965)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1965)) COMMA_SOURCE_FILE_AT_LINE (1965)).operator_concat (GALGAS_string ("' filewrapper") COMMA_SOURCE_FILE_AT_LINE (1965)) COMMA_SOURCE_FILE_AT_LINE (1964)) ;
  ...
  if (kBoolTrue == test_9) {
    ...
    temp_8 = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("data"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1973)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1973)) ;
  }
  outArgument_outExpression = GALGAS_filewrapperStaticPathInExpressionForGeneration::constructor_new (temp_8, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1975)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1976)), var_fileIndex, var_isTextFile COMMA_SOURCE_FILE_AT_LINE (1970)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexiqueIntrospectionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (object->mAttribute_mLexiqueComponentName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1990)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("unknown reader") COMMA_SOURCE_FILE_AT_LINE (1995)) ;
  }
  outArgument_outExpression = GALGAS_lexiqueIntrospectionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_string ("stringlist").reader_nowhere (SOURCE_FILE_AT_LINE (1999)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1999)), object->mAttribute_mLexiqueComponentName.mAttribute_location, object->mAttribute_mLexiqueComponentName.mAttribute_string, object->mAttribute_mLexiqueReaderName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1998)) ;
}
//---------------------------------------------------------------------------*
