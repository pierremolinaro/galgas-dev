...
//                    november 23th, 2010, at 12h55'19"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  GALGAS_string result_string ; // Returned variable
  //-------- @ifInstructionForGeneration
  if (constinArgument_inSuperClass.reader_isNull (SOURCE_FILE_AT_LINE (784)).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_formalParameterSignature joker_44146_0 ; // Joker input parameter
    GALGAS_bool joker_44149_0 ; // Joker input parameter
    GALGAS_string joker_44163_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mModifierMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (788)).method_searchKey (constinArgument_inReaderName, joker_44146_0, joker_44149_0, var_qualifier, joker_44163_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (788)) ;
    //-------- END @methodCallInstructionForGeneration
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
                                  ...
                                  COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @ifInstructionForGeneration
  if (constinArgument_inOperandIsHandled.operator_not (SOURCE_FILE_AT_LINE (971)).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    if (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (978)).isValid ()) {
      PMUInt32 variant_51820 = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (978)).uintValue () ;
      bool loop_51820 = true ;
      while (loop_51820) {
        loop_51820 = var_ok.operator_not (SOURCE_FILE_AT_LINE (978)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (978)).reader_isNull (SOURCE_FILE_AT_LINE (978)).operator_not (SOURCE_FILE_AT_LINE (978)) COMMA_SOURCE_FILE_AT_LINE (978)).isValid () ;
        if (loop_51820) {
          loop_51820 = var_ok.operator_not (SOURCE_FILE_AT_LINE (978)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (978)).reader_isNull (SOURCE_FILE_AT_LINE (978)).operator_not (SOURCE_FILE_AT_LINE (978)) COMMA_SOURCE_FILE_AT_LINE (978)).boolValue () ;
        }
        if (loop_51820 && (0 == variant_51820)) {
          loop_51820 = false ;
    ...
    //-------- @ifInstructionForGeneration
    if (var_ok.operator_not (SOURCE_FILE_AT_LINE (983)).isValidAndTrue ()) {
      //-------- @ifInstructionForGeneration
      if (constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (985)).reader_hasKey (constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (985)) COMMA_SOURCE_FILE_AT_LINE (985)).isValidAndTrue ()) {
        //-------- @localVariableDeclarationForGeneration
        ...
        //-------- @methodCallInstructionForGeneration
        GALGAS_location joker_52419_0 ; // Joker input parameter
        GALGAS_methodQualifier joker_52487_2 ; // Joker input parameter
        GALGAS_string joker_52487_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (990)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (991)), var_isCategory, var_argumentTypeList, joker_52419_0, var_hasCompilerArgument, var_returnedType, joker_52487_2, joker_52487_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (990)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @assignmentInstructionForGeneration
      ...
      //-------- @ifInstructionForGeneration
      if (var_ok.operator_not (SOURCE_FILE_AT_LINE (1013)).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
...
static void categoryMethod_constructorExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool var_hasCompilerArgument ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeConstructorInvocation (constinArgument_inAnalysisContext, ioArgument_ioVariableMap, object->mAttribute_mTypeName, object->mAttribute_mConstructorName, object->mAttribute_mExpressions, var_returnedType, var_constructorType, var_constructorEffectiveParameterList, var_hasCompilerArgument, inCompiler COMMA_SOURCE_FILE_AT_LINE (566)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outExpression = GALGAS_constructorExpressionForGeneration::constructor_new (var_returnedType, object->mAttribute_mConstructorName.reader_location (SOURCE_FILE_AT_LINE (580)), var_constructorType, object->mAttribute_mConstructorName.reader_string (SOURCE_FILE_AT_LINE (582)), var_constructorEffectiveParameterList, var_hasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (578)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_readerCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mReceiver.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_receiverExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (597)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_unifiedTypeMapProxy var_receiverType = var_receiverExpression.reader_mType (SOURCE_FILE_AT_LINE (598)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_readerMap var_readerMap = var_receiverType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
  //-------- @localVariableDeclarationForGeneration
  ...
  GALGAS_stringlist var_fieldList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (606)) ;
  //-------- @readOnlyWithInstructionForGeneration
  const cMapElement_readerMap * objectArray_36573 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (607))) ;
  if (NULL != objectArray_36573) {
      macroValidSharedObject (objectArray_36573, const cMapElement_readerMap) ;
    //-------- @assignmentInstructionForGeneration
    var_readerFormalArgumentTypeList = objectArray_36573->mAttribute_mArgumentTypeList ;
    //-------- @assignmentInstructionForGeneration
    var_hasCompilerArgument = objectArray_36573->mAttribute_mHasCompilerArgument ;
    //-------- @assignmentInstructionForGeneration
    var_returnedType = objectArray_36573->mAttribute_mReturnedType ;
    //-------- @assignmentInstructionForGeneration
    var_isCategory = objectArray_36573->mAttribute_mIsCategory ;
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, objectArray_36573->mAttribute_mErrorMessage.objectCompare (GALGAS_string (""))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_0 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_0, objectArray_36573->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (613)) ;
    }
  }else{
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_uint var_matchingReaderCount = GALGAS_uint ((PMUInt32) 0U) ;
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, var_receiverType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (617)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (617)))).isValidAndTrue ()) {
      //-------- @assignmentInstructionForGeneration
      var_readerFormalArgumentTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (618)) ;
      //-------- @assignmentInstructionForGeneration
      var_hasCompilerArgument = GALGAS_bool (true) ;
      //-------- @assignmentInstructionForGeneration
      var_returnedType = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (620)) ;
      //-------- @assignmentInstructionForGeneration
      var_isCategory = GALGAS_bool (true) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_typedAttributeList enumerator_37232 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (622)), true) ;
      //--- simple foreach instruction
      while (enumerator_37232.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_unifiedTypeMapProxy var_attributeType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (enumerator_37232.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (623)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (623)), inCompiler COMMA_SOURCE_FILE_AT_LINE (623)) ;
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_readerMap var_aMap = var_attributeType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (624)) ;
        //-------- @readOnlyWithInstructionForGeneration
        const cMapElement_readerMap * objectArray_37572 = (const cMapElement_readerMap *) var_aMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (626))) ;
        if (NULL != objectArray_37572) {
            macroValidSharedObject (objectArray_37572, const cMapElement_readerMap) ;
          //-------- @incrementInstructionForGeneration
          var_matchingReaderCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (627)) ;
          //-------- @assignmentInstructionForGeneration
          var_readerFormalArgumentTypeList = objectArray_37572->mAttribute_mArgumentTypeList ;
          //-------- @assignmentInstructionForGeneration
          var_hasCompilerArgument = objectArray_37572->mAttribute_mHasCompilerArgument ;
          //-------- @assignmentInstructionForGeneration
          var_returnedType = objectArray_37572->mAttribute_mReturnedType ;
          //-------- @assignmentInstructionForGeneration
          var_isCategory = objectArray_37572->mAttribute_mIsCategory ;
          //-------- @addAssignInstructionForGeneration
          var_fieldList.addAssign_operation (enumerator_37232.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (632)) COMMA_SOURCE_FILE_AT_LINE (632)) ;
          //-------- @ifInstructionForGeneration
          if (GALGAS_bool (kIsNotEqual, objectArray_37572->mAttribute_mErrorMessage.objectCompare (GALGAS_string (""))).isValidAndTrue ()) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_1 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_1, objectArray_37572->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (634)) ;
          }
        }
      ...
      if (GALGAS_bool (kIsEqual, var_matchingReaderCount.objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
        ...
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (640)) COMMA_SOURCE_FILE_AT_LINE (640)).operator_concat (GALGAS_string ("' struct type does not define the '") COMMA_SOURCE_FILE_AT_LINE (640)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (640)) COMMA_SOURCE_FILE_AT_LINE (640)).operator_concat (GALGAS_string ("' reader, and none of its fields defines it") COMMA_SOURCE_FILE_AT_LINE (641)) COMMA_SOURCE_FILE_AT_LINE (639)) ;
        ...
        if (GALGAS_bool (kIsStrictSup, var_matchingReaderCount.objectCompare (GALGAS_uint ((PMUInt32) 1U))).isValidAndTrue ()) {
          ...
          GALGAS_string var_s = GALGAS_string ("") ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_stringlist enumerator_38456 (var_fieldList, true) ;
          //--- simple foreach instruction
          while (enumerator_38456.hasCurrentObject ()) {
            //-------- @appendInstructionForGeneration
            var_s.dotAssign_operation (enumerator_38456.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (647)) ;
            if (enumerator_38456.hasNextObject ()) {
              //-------- @appendInstructionForGeneration
          ...
          inCompiler->emitSemanticError (location_3, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (651)) COMMA_SOURCE_FILE_AT_LINE (651)).operator_concat (GALGAS_string ("' struct type does not define the '") COMMA_SOURCE_FILE_AT_LINE (651)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (651)) COMMA_SOURCE_FILE_AT_LINE (651)).operator_concat (GALGAS_string ("' reader, and several of its fields defines it:") COMMA_SOURCE_FILE_AT_LINE (652)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (652)).operator_concat (GALGAS_string (" (exactly one field should define it)") COMMA_SOURCE_FILE_AT_LINE (652)) COMMA_SOURCE_FILE_AT_LINE (650)) ;
          var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
          var_hasCompilerArgument.drop () ; // Release error dropped variable
          var_returnedType.drop () ; // Release error dropped variable
          var_isCategory.drop () ; // Release error dropped variable
      ...
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsEqual, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (656)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_4 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (658)) COMMA_SOURCE_FILE_AT_LINE (658)).operator_concat (GALGAS_string ("' type does not define any reader") COMMA_SOURCE_FILE_AT_LINE (658)) COMMA_SOURCE_FILE_AT_LINE (657)) ;
        var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
        var_hasCompilerArgument.drop () ; // Release error dropped variable
        var_returnedType.drop () ; // Release error dropped variable
        var_isCategory.drop () ; // Release error dropped variable
        ...
        GALGAS_string var_s = GALGAS_string ("") ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_readerMap enumerator_39156 (var_readerMap, true) ;
        //--- simple foreach instruction
        while (enumerator_39156.hasCurrentObject ()) {
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_39156.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (664)) COMMA_SOURCE_FILE_AT_LINE (664)) COMMA_SOURCE_FILE_AT_LINE (664)) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_unifiedTypeMapProxyList enumerator_39224 (enumerator_39156.current_mArgumentTypeList (HERE), true) ;
          //--- simple foreach instruction
          while (enumerator_39224.hasCurrentObject ()) {
            //-------- @appendInstructionForGeneration
            var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_39224.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (666)) COMMA_SOURCE_FILE_AT_LINE (666)) COMMA_SOURCE_FILE_AT_LINE (666)) ;
            enumerator_39224.gotoNextObject () ;
          }
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_39156.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (668)) COMMA_SOURCE_FILE_AT_LINE (668)) COMMA_SOURCE_FILE_AT_LINE (668)) ;
          enumerator_39156.gotoNextObject () ;
        }
        //-------- @errorInstructionForGeneration
        //--- @ifExpressionForGeneration
        GALGAS_string temp_5 ;
        if (GALGAS_bool (kIsStrictSup, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (672)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).isValidAndTrue ()) {
          temp_5 = GALGAS_string ("readers are") ;
        }else{
          temp_5 = GALGAS_string ("reader is") ;
        }
        GALGAS_location location_6 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_6, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (671)) COMMA_SOURCE_FILE_AT_LINE (671)).operator_concat (GALGAS_string ("' type does not define the '") COMMA_SOURCE_FILE_AT_LINE (671)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (671)) COMMA_SOURCE_FILE_AT_LINE (671)).operator_concat (GALGAS_string ("' reader; available ") COMMA_SOURCE_FILE_AT_LINE (671)).operator_concat (temp_5 COMMA_SOURCE_FILE_AT_LINE (672)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (673)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (673)) COMMA_SOURCE_FILE_AT_LINE (670)) ;
        var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
        var_hasCompilerArgument.drop () ; // Release error dropped variable
        var_returnedType.drop () ; // Release error dropped variable
        var_isCategory.drop () ; // Release error dropped variable
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (679)).objectCompare (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (679)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_7 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_7, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (680)) COMMA_SOURCE_FILE_AT_LINE (680)).operator_concat (GALGAS_string ("' reader of '@") COMMA_SOURCE_FILE_AT_LINE (680)).operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (680)) COMMA_SOURCE_FILE_AT_LINE (680)).operator_concat (GALGAS_string ("' requires ") COMMA_SOURCE_FILE_AT_LINE (680)).operator_concat (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (681)).reader_string (SOURCE_FILE_AT_LINE (681)) COMMA_SOURCE_FILE_AT_LINE (681)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (681)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (682)).reader_string (SOURCE_FILE_AT_LINE (682)) COMMA_SOURCE_FILE_AT_LINE (682)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (682)) COMMA_SOURCE_FILE_AT_LINE (680)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else{
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_semanticExpressionListForGeneration var_constructorEffectiveParameterList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (684)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_40182 (object->mAttribute_mExpressions, true) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_40214 (var_readerFormalArgumentTypeList, true) ;
    //--- simple foreach instruction
    while (enumerator_40182.hasCurrentObject () && enumerator_40214.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_exp ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_40182.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (687)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_40214.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (688)), enumerator_40182.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (688)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_constructorEffectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (689)) ;
      enumerator_40182.gotoNextObject () ;
      enumerator_40214.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (var_returnedType, object->mAttribute_mReaderName.reader_location (SOURCE_FILE_AT_LINE (693)), var_isCategory, var_receiverExpression, var_fieldList, object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (697)), var_constructorEffectiveParameterList, var_hasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (691)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_thisReaderCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (ioArgument_ioVariableMap.reader_hasKey (function_selfMarkName (inCompiler COMMA_SOURCE_FILE_AT_LINE (713)) COMMA_SOURCE_FILE_AT_LINE (713)).isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
    GALGAS_string joker_41292_0 ; // Joker input parameter
    GALGAS_string joker_41295_0 ; // Joker input parameter
    ioArgument_ioVariableMap.modifier_searchForReadAccess (GALGAS_lstring::constructor_new (function_selfMarkName (inCompiler COMMA_SOURCE_FILE_AT_LINE (714)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (714)), var_thisTypeProxy, joker_41292_0, joker_41295_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (714)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }else{
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mLocation, GALGAS_string ("'this' can be used only in methods, modifiers and readers") COMMA_SOURCE_FILE_AT_LINE (716)) ;
  ...
  GALGAS_unifiedTypeMapProxy var_returnedType ;
  //-------- @readOnlyWithInstructionForGeneration
  const cMapElement_readerMap * objectArray_41677 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (725))) ;
  if (NULL != objectArray_41677) {
      macroValidSharedObject (objectArray_41677, const cMapElement_readerMap) ;
    //-------- @assignmentInstructionForGeneration
    var_readerFormalArgumentTypeList = objectArray_41677->mAttribute_mArgumentTypeList ;
    //-------- @assignmentInstructionForGeneration
    var_hasCompilerArgument = objectArray_41677->mAttribute_mHasCompilerArgument ;
    //-------- @assignmentInstructionForGeneration
    var_returnedType = objectArray_41677->mAttribute_mReturnedType ;
    //-------- @assignmentInstructionForGeneration
    var_isCategory = objectArray_41677->mAttribute_mIsCategory ;
  }else{
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (731)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_0 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_0, GALGAS_string ("the '@").operator_concat (var_thisTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (733)) COMMA_SOURCE_FILE_AT_LINE (733)).operator_concat (GALGAS_string ("' type does not define any reader") COMMA_SOURCE_FILE_AT_LINE (733)) COMMA_SOURCE_FILE_AT_LINE (732)) ;
      var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
      var_hasCompilerArgument.drop () ; // Release error dropped variable
      var_returnedType.drop () ; // Release error dropped variable
      var_isCategory.drop () ; // Release error dropped variable
      ...
      GALGAS_string var_s = GALGAS_string ("") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_readerMap enumerator_42177 (var_readerMap, true) ;
      //--- simple foreach instruction
      while (enumerator_42177.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_42177.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (739)) COMMA_SOURCE_FILE_AT_LINE (739)) COMMA_SOURCE_FILE_AT_LINE (739)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_unifiedTypeMapProxyList enumerator_42245 (enumerator_42177.current_mArgumentTypeList (HERE), true) ;
        //--- simple foreach instruction
        while (enumerator_42245.hasCurrentObject ()) {
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_42245.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (741)) COMMA_SOURCE_FILE_AT_LINE (741)) COMMA_SOURCE_FILE_AT_LINE (741)) ;
          enumerator_42245.gotoNextObject () ;
        }
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_42177.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (743)) COMMA_SOURCE_FILE_AT_LINE (743)) COMMA_SOURCE_FILE_AT_LINE (743)) ;
        enumerator_42177.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      //--- @ifExpressionForGeneration
      GALGAS_string temp_1 ;
      if (GALGAS_bool (kIsStrictSup, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (747)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).isValidAndTrue ()) {
        temp_1 = GALGAS_string ("readers are") ;
      }else{
        temp_1 = GALGAS_string ("reader is") ;
      }
      GALGAS_location location_2 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '@").operator_concat (var_thisTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (746)) COMMA_SOURCE_FILE_AT_LINE (746)).operator_concat (GALGAS_string ("' type does not define the '") COMMA_SOURCE_FILE_AT_LINE (746)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (746)) COMMA_SOURCE_FILE_AT_LINE (746)).operator_concat (GALGAS_string ("' reader; available ") COMMA_SOURCE_FILE_AT_LINE (746)).operator_concat (temp_1 COMMA_SOURCE_FILE_AT_LINE (747)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (748)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (748)) COMMA_SOURCE_FILE_AT_LINE (745)) ;
      var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
      var_hasCompilerArgument.drop () ; // Release error dropped variable
      var_returnedType.drop () ; // Release error dropped variable
      var_isCategory.drop () ; // Release error dropped variable
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (754)).objectCompare (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (754)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_3 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (755)) COMMA_SOURCE_FILE_AT_LINE (755)).operator_concat (GALGAS_string ("' reader of '@") COMMA_SOURCE_FILE_AT_LINE (755)).operator_concat (var_thisTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (755)) COMMA_SOURCE_FILE_AT_LINE (755)).operator_concat (GALGAS_string ("' requires ") COMMA_SOURCE_FILE_AT_LINE (755)).operator_concat (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (756)).reader_string (SOURCE_FILE_AT_LINE (756)) COMMA_SOURCE_FILE_AT_LINE (756)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (756)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (757)).reader_string (SOURCE_FILE_AT_LINE (757)) COMMA_SOURCE_FILE_AT_LINE (757)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (757)) COMMA_SOURCE_FILE_AT_LINE (755)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else{
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_43205 (object->mAttribute_mExpressions, true) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_43237 (var_readerFormalArgumentTypeList, true) ;
    //--- simple foreach instruction
    while (enumerator_43205.hasCurrentObject () && enumerator_43237.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_exp ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_43205.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (762)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_43237.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (763)), enumerator_43205.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (763)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_constructorEffectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (764)) ;
      enumerator_43205.gotoNextObject () ;
      enumerator_43237.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_thisReaderCallExpressionForGeneration::constructor_new (var_returnedType, object->mAttribute_mReaderName.reader_location (SOURCE_FILE_AT_LINE (768)), var_isCategory, object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (770)), var_constructorEffectiveParameterList, var_hasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (766)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_superReaderCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (ioArgument_ioVariableMap.reader_hasKey (function_selfMarkName (inCompiler COMMA_SOURCE_FILE_AT_LINE (809)) COMMA_SOURCE_FILE_AT_LINE (809)).isValidAndTrue ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_thisTypeProxy ;
    { //-------- @modifierCallInstructionForGeneration
    GALGAS_string joker_45063_0 ; // Joker input parameter
    GALGAS_string joker_45066_0 ; // Joker input parameter
    ioArgument_ioVariableMap.modifier_searchForReadAccess (GALGAS_lstring::constructor_new (function_selfMarkName (inCompiler COMMA_SOURCE_FILE_AT_LINE (811)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (811)), var_thisTypeProxy, joker_45063_0, joker_45066_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (811)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @ifInstructionForGeneration
    if (var_thisTypeProxy.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (812)).reader_isNull (SOURCE_FILE_AT_LINE (812)).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
  ...
  //-------- @readOnlyWithInstructionForGeneration
  const cMapElement_readerMap * objectArray_45717 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (828))) ;
  if (NULL != objectArray_45717) {
      macroValidSharedObject (objectArray_45717, const cMapElement_readerMap) ;
    //-------- @assignmentInstructionForGeneration
    var_readerFormalArgumentTypeList = objectArray_45717->mAttribute_mArgumentTypeList ;
    //-------- @assignmentInstructionForGeneration
    var_hasCompilerArgument = objectArray_45717->mAttribute_mHasCompilerArgument ;
    //-------- @assignmentInstructionForGeneration
    var_returnedType = objectArray_45717->mAttribute_mReturnedType ;
    //-------- @assignmentInstructionForGeneration
    var_isCategory = objectArray_45717->mAttribute_mIsCategory ;
    //-------- @assignmentInstructionForGeneration
    ...
    if (GALGAS_bool (kIsEqual, var_superClassThatImplementsReader.objectCompare (GALGAS_string (""))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_0 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (835)) COMMA_SOURCE_FILE_AT_LINE (835)).operator_concat (GALGAS_string ("' reader is not implemented by super class(es)") COMMA_SOURCE_FILE_AT_LINE (835)) COMMA_SOURCE_FILE_AT_LINE (835)) ;
    }
  }else{
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (838)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (var_superTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (840)).operator_concat (GALGAS_string ("' type does not define any reader") COMMA_SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (839)) ;
      var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
      var_hasCompilerArgument.drop () ; // Release error dropped variable
      var_returnedType.drop () ; // Release error dropped variable
      var_isCategory.drop () ; // Release error dropped variable
      ...
      GALGAS_string var_s = GALGAS_string ("") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_readerMap enumerator_46523 (var_readerMap, true) ;
      //--- simple foreach instruction
      while (enumerator_46523.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_46523.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (846)) COMMA_SOURCE_FILE_AT_LINE (846)) COMMA_SOURCE_FILE_AT_LINE (846)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_unifiedTypeMapProxyList enumerator_46591 (enumerator_46523.current_mArgumentTypeList (HERE), true) ;
        //--- simple foreach instruction
        while (enumerator_46591.hasCurrentObject ()) {
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_46591.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (848)) COMMA_SOURCE_FILE_AT_LINE (848)) COMMA_SOURCE_FILE_AT_LINE (848)) ;
          enumerator_46591.gotoNextObject () ;
        }
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_46523.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (850)) COMMA_SOURCE_FILE_AT_LINE (850)) COMMA_SOURCE_FILE_AT_LINE (850)) ;
        enumerator_46523.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      //--- @ifExpressionForGeneration
      GALGAS_string temp_2 ;
      if (GALGAS_bool (kIsStrictSup, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (854)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).isValidAndTrue ()) {
        temp_2 = GALGAS_string ("readers are") ;
      }else{
        temp_2 = GALGAS_string ("reader is") ;
      }
      GALGAS_location location_3 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '@").operator_concat (var_superTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (853)) COMMA_SOURCE_FILE_AT_LINE (853)).operator_concat (GALGAS_string ("' type does not define the '") COMMA_SOURCE_FILE_AT_LINE (853)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (853)) COMMA_SOURCE_FILE_AT_LINE (853)).operator_concat (GALGAS_string ("' reader; available ") COMMA_SOURCE_FILE_AT_LINE (853)).operator_concat (temp_2 COMMA_SOURCE_FILE_AT_LINE (854)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (855)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (855)) COMMA_SOURCE_FILE_AT_LINE (852)) ;
      var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
      var_hasCompilerArgument.drop () ; // Release error dropped variable
      var_returnedType.drop () ; // Release error dropped variable
      var_isCategory.drop () ; // Release error dropped variable
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (861)).objectCompare (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (861)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_4 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_4, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (862)) COMMA_SOURCE_FILE_AT_LINE (862)).operator_concat (GALGAS_string ("' reader of '@") COMMA_SOURCE_FILE_AT_LINE (862)).operator_concat (var_superTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (862)) COMMA_SOURCE_FILE_AT_LINE (862)).operator_concat (GALGAS_string ("' requires ") COMMA_SOURCE_FILE_AT_LINE (862)).operator_concat (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (863)).reader_string (SOURCE_FILE_AT_LINE (863)) COMMA_SOURCE_FILE_AT_LINE (863)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (863)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (864)).reader_string (SOURCE_FILE_AT_LINE (864)) COMMA_SOURCE_FILE_AT_LINE (864)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (864)) COMMA_SOURCE_FILE_AT_LINE (862)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else{
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_47585 (object->mAttribute_mExpressions, true) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_47617 (var_readerFormalArgumentTypeList, true) ;
    //--- simple foreach instruction
    while (enumerator_47585.hasCurrentObject () && enumerator_47617.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_exp ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_47585.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (869)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_47617.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (870)), enumerator_47585.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (870)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_constructorEffectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (871)) ;
      enumerator_47585.gotoNextObject () ;
...
static void categoryMethod_optionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (var_found.operator_not (SOURCE_FILE_AT_LINE (903)).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  if (var_found.operator_not (SOURCE_FILE_AT_LINE (907)).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
  ...
  if (var_found.isValidAndTrue ()) {
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (912)).objectCompare (GALGAS_string ("value"))).isValidAndTrue ()) {
      //-------- @assignmentInstructionForGeneration
      ...
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (919)).objectCompare (GALGAS_string ("char"))).isValidAndTrue ()) {
        //-------- @assignmentInstructionForGeneration
        ...
        //-------- @ifInstructionForGeneration
        if (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (926)).objectCompare (GALGAS_string ("string"))).isValidAndTrue ()) {
          //-------- @assignmentInstructionForGeneration
          ...
          //-------- @ifInstructionForGeneration
          if (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (933)).objectCompare (GALGAS_string ("comment"))).isValidAndTrue ()) {
            //-------- @assignmentInstructionForGeneration
            ...
            inCompiler->emitSemanticError (location_0, GALGAS_string ("only the 'value', 'char', 'string' and 'comment' readers are defined for an option") COMMA_SOURCE_FILE_AT_LINE (941)) ;
            outArgument_outExpression.drop () ; // Release error dropped variable
          }
        }
      }
    ...
    GALGAS_string var_s = GALGAS_string ("") ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_50648 (var_boolOptionMap, true) ;
    //--- simple foreach instruction
    while (enumerator_50648.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_50648.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (946)) COMMA_SOURCE_FILE_AT_LINE (946)).operator_concat (GALGAS_string ("' @bool option;") COMMA_SOURCE_FILE_AT_LINE (946)) COMMA_SOURCE_FILE_AT_LINE (946)) ;
      enumerator_50648.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_50744 (var_uintOptionMap, true) ;
    //--- simple foreach instruction
    while (enumerator_50744.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_50744.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (949)) COMMA_SOURCE_FILE_AT_LINE (949)).operator_concat (GALGAS_string ("' @uint option;") COMMA_SOURCE_FILE_AT_LINE (949)) COMMA_SOURCE_FILE_AT_LINE (949)) ;
      enumerator_50744.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_50842 (var_stringOptionMap, true) ;
    //--- simple foreach instruction
    while (enumerator_50842.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_50842.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (952)) COMMA_SOURCE_FILE_AT_LINE (952)).operator_concat (GALGAS_string ("' @string option;") COMMA_SOURCE_FILE_AT_LINE (952)) COMMA_SOURCE_FILE_AT_LINE (952)) ;
...
static void categoryMethod_equalExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1169)).reader_string (SOURCE_FILE_AT_LINE (1169)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1169)).reader_string (SOURCE_FILE_AT_LINE (1169)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_notEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1201)).reader_string (SOURCE_FILE_AT_LINE (1201)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1201)).reader_string (SOURCE_FILE_AT_LINE (1201)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_lowerOrEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1233)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1233)) COMMA_SOURCE_FILE_AT_LINE (1233)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1238)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1238)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_greaterOrEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1270)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1270)) COMMA_SOURCE_FILE_AT_LINE (1270)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1275)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1275)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_strictGreaterExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1307)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1307)) COMMA_SOURCE_FILE_AT_LINE (1307)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1312)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1312)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_strictLowerExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1344)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1344)) COMMA_SOURCE_FILE_AT_LINE (1344)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1349)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1349)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_rightShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1381)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1381)) COMMA_SOURCE_FILE_AT_LINE (1381)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1386)).objectCompare (GALGAS_string ("uint"))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_leftShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1418)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1418)) COMMA_SOURCE_FILE_AT_LINE (1418)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1423)).objectCompare (GALGAS_string ("uint"))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_unaryMinusExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1611)).operator_and (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1611)) COMMA_SOURCE_FILE_AT_LINE (1611)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_notExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1638)).operator_and (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1638)) COMMA_SOURCE_FILE_AT_LINE (1638)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_complementExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1665)).operator_and (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1665)) COMMA_SOURCE_FILE_AT_LINE (1665)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("operand type is '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1667)) COMMA_SOURCE_FILE_AT_LINE (1667)).operator_concat (GALGAS_string ("' and does not support the '~' operator") COMMA_SOURCE_FILE_AT_LINE (1667)) COMMA_SOURCE_FILE_AT_LINE (1666)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else{
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_tildeExpressionForGeneration::constructor_new (var_type, object->mAttribute_mOperatorLocation, var_expression COMMA_SOURCE_FILE_AT_LINE (1672)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ifExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mIfExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_if_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1689)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticExpressionForGeneration var_then_5F_expression ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mThenExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_then_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1692)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticExpressionForGeneration var_else_5F_expression ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mElseExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_else_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1695)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, var_if_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1697)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1697)).objectCompare (GALGAS_string ("bool"))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("the test expression type is '@").operator_concat (var_if_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1699)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1699)) COMMA_SOURCE_FILE_AT_LINE (1699)).operator_concat (GALGAS_string ("', it should be '@bool'") COMMA_SOURCE_FILE_AT_LINE (1699)) COMMA_SOURCE_FILE_AT_LINE (1698)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else{
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_then_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1702)).objectCompare (var_else_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1702)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("operand expression types are '@").operator_concat (var_then_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1704)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1704)) COMMA_SOURCE_FILE_AT_LINE (1704)).operator_concat (GALGAS_string ("' and '@") COMMA_SOURCE_FILE_AT_LINE (1704)).operator_concat (var_else_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1704)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1704)) COMMA_SOURCE_FILE_AT_LINE (1704)).operator_concat (GALGAS_string ("': they should be the same") COMMA_SOURCE_FILE_AT_LINE (1704)) COMMA_SOURCE_FILE_AT_LINE (1703)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else{
      //-------- @assignmentInstructionForGeneration
      outArgument_outExpression = GALGAS_ifExpressionForGeneration::constructor_new (var_then_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1710)), object->mAttribute_mOperatorLocation, var_if_5F_expression, var_then_5F_expression, var_else_5F_expression COMMA_SOURCE_FILE_AT_LINE (1709)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFunctionMap.method_searchKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultType, inCompiler COMMA_SOURCE_FILE_AT_LINE (1729)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, var_functionSignature.reader_length (SOURCE_FILE_AT_LINE (1731)).objectCompare (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1731)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_0 (object->mAttribute_mFunctionName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (object->mAttribute_mFunctionName.reader_string (SOURCE_FILE_AT_LINE (1733)) COMMA_SOURCE_FILE_AT_LINE (1733)).operator_concat (GALGAS_string ("' function header declares ") COMMA_SOURCE_FILE_AT_LINE (1733)).operator_concat (var_functionSignature.reader_length (SOURCE_FILE_AT_LINE (1733)).reader_string (SOURCE_FILE_AT_LINE (1733)) COMMA_SOURCE_FILE_AT_LINE (1733)).operator_concat (GALGAS_string (" formal parameter(s), but this function call names ") COMMA_SOURCE_FILE_AT_LINE (1734)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1734)).reader_string (SOURCE_FILE_AT_LINE (1734)) COMMA_SOURCE_FILE_AT_LINE (1734)).operator_concat (GALGAS_string (" effective argument(s)") COMMA_SOURCE_FILE_AT_LINE (1735)) COMMA_SOURCE_FILE_AT_LINE (1732)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else{
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_semanticExpressionListForGeneration var_semanticExpressionListForGeneration = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1739)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_unifiedTypeMapProxyList enumerator_80295 (var_functionSignature, true) ;
    cEnumerator_semanticExpressionListAST enumerator_80311 (object->mAttribute_mExpressions, true) ;
    //--- simple foreach instruction
    while (enumerator_80295.hasCurrentObject () && enumerator_80311.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_expression ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_80311.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1742)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_80295.current_mType (HERE), var_expression.reader_mType (SOURCE_FILE_AT_LINE (1743)), enumerator_80311.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1743)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_semanticExpressionListForGeneration.addAssign_operation (var_expression COMMA_SOURCE_FILE_AT_LINE (1744)) ;
      enumerator_80295.gotoNextObject () ;
      enumerator_80311.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_functionCallExpressionForGeneration::constructor_new (var_resultType, object->mAttribute_mFunctionName.reader_location (SOURCE_FILE_AT_LINE (1748)), object->mAttribute_mFunctionName.reader_string (SOURCE_FILE_AT_LINE (1749)), var_semanticExpressionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1746)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_varInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioVariableMap.modifier_searchForReadAccess (object->mAttribute_mVarName, var_type, var_sourceVariableCppName, var_nameForCheckingFormalParameterUsing, inCompiler COMMA_SOURCE_FILE_AT_LINE (1765)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_81366 (object->mAttribute_mStructFieldList, true) ;
  //--- simple foreach instruction
  while (enumerator_81366.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeMap var_attributeMap = var_type.reader_mAttributeMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1767)) ;
    //-------- @methodCallInstructionForGeneration
    var_attributeMap.method_searchKey (enumerator_81366.current_mValue (HERE), var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (1768)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_81366.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outExpression = GALGAS_varInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mVarName.reader_location (SOURCE_FILE_AT_LINE (1772)), var_sourceVariableCppName, var_nameForCheckingFormalParameterUsing, object->mAttribute_mStructFieldList COMMA_SOURCE_FILE_AT_LINE (1770)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_82087_20 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_82087_19 ; // Joker input parameter
  GALGAS_typeKindEnum joker_82087_18 ; // Joker input parameter
  GALGAS_typedAttributeList joker_82087_17 ; // Joker input parameter
  GALGAS_attributeMap joker_82087_16 ; // Joker input parameter
  GALGAS_typedAttributeList joker_82087_15 ; // Joker input parameter
  GALGAS_constructorMap joker_82087_14 ; // Joker input parameter
  GALGAS_readerMap joker_82087_13 ; // Joker input parameter
  GALGAS_modifierMap joker_82087_12 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_82087_11 ; // Joker input parameter
  GALGAS_classMethodMap joker_82087_10 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_82087_9 ; // Joker input parameter
  GALGAS_uint joker_82087_8 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_82087_7 ; // Joker input parameter
  GALGAS_stringset joker_82087_6 ; // Joker input parameter
  GALGAS_lstringlist joker_82087_5 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_82087_4 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_82087_3 ; // Joker input parameter
  GALGAS_withAccessorMap joker_82087_2 ; // Joker input parameter
  GALGAS_bool joker_82087_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_82087_20, joker_82087_19, joker_82087_18, joker_82087_17, joker_82087_16, joker_82087_15, joker_82087_14, joker_82087_13, joker_82087_12, joker_82087_11, joker_82087_10, joker_82087_9, joker_82087_8, joker_82087_7, joker_82087_6, joker_82087_5, joker_82087_4, joker_82087_3, joker_82087_2, joker_82087_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1787)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outExpression = GALGAS_literalTypeInExpressionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("type"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1790)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1790)), object->mAttribute_mLiteralTypeName.reader_location (SOURCE_FILE_AT_LINE (1791)), object->mAttribute_mLiteralTypeName.reader_string (SOURCE_FILE_AT_LINE (1792)) COMMA_SOURCE_FILE_AT_LINE (1789)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mReceiverExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1805)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1807)) ;
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1809)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1809)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (1809)))).isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_unifiedTypeMapProxy var_t = var_type ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mType (SOURCE_FILE_AT_LINE (1812)))) ;
    //-------- @loopInstructionForGeneration
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1813)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1813)).isValid ()) {
      PMUInt32 variant_83214 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1813)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1813)).uintValue () ;
      bool loop_83214 = true ;
      while (loop_83214) {
        loop_83214 = var_found.operator_not (SOURCE_FILE_AT_LINE (1814)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1814)).reader_isNull (SOURCE_FILE_AT_LINE (1814)).operator_not (SOURCE_FILE_AT_LINE (1814)) COMMA_SOURCE_FILE_AT_LINE (1814)).isValid () ;
        if (loop_83214) {
          loop_83214 = var_found.operator_not (SOURCE_FILE_AT_LINE (1814)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1814)).reader_isNull (SOURCE_FILE_AT_LINE (1814)).operator_not (SOURCE_FILE_AT_LINE (1814)) COMMA_SOURCE_FILE_AT_LINE (1814)).boolValue () ;
        }
        if (loop_83214 && (0 == variant_83214)) {
          loop_83214 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (1813)) ;
        }
        if (loop_83214) {
          variant_83214 -- ;
          //-------- @assignmentInstructionForGeneration
          var_t = var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1815)) ;
          //-------- @assignmentInstructionForGeneration
          var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mType (SOURCE_FILE_AT_LINE (1816)))) ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    if (var_found.operator_not (SOURCE_FILE_AT_LINE (1818)).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_0 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_0, GALGAS_string ("the '@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1820)) COMMA_SOURCE_FILE_AT_LINE (1820)).operator_concat (GALGAS_string ("' is not a descendant of the '@") COMMA_SOURCE_FILE_AT_LINE (1820)).operator_concat (var_expression.reader_mType (SOURCE_FILE_AT_LINE (1820)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1820)) COMMA_SOURCE_FILE_AT_LINE (1820)).operator_concat (GALGAS_string ("' type of the cast expression") COMMA_SOURCE_FILE_AT_LINE (1820)) COMMA_SOURCE_FILE_AT_LINE (1819)) ;
    }
  }else{
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1823)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1823)).objectCompare (GALGAS_string ("object"))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (var_expression.reader_mLocation (SOURCE_FILE_AT_LINE (1824)), GALGAS_string ("cast expression should be an @object or a class instance: it is an @").operator_concat (var_expression.reader_mType (SOURCE_FILE_AT_LINE (1825)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1825)) COMMA_SOURCE_FILE_AT_LINE (1825)).operator_concat (GALGAS_string (" instance") COMMA_SOURCE_FILE_AT_LINE (1825)) COMMA_SOURCE_FILE_AT_LINE (1824)) ;
    }
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticExpressionForGeneration var_errorLocationExpression ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mErrorLocationExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_errorLocationExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1829)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_useLocationReader = GALGAS_bool (kIsNotEqual, var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1831)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType)) ;
  //-------- @ifInstructionForGeneration
  if (var_useLocationReader.isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_readerMap var_readerMap = var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1833)).reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1833)) ;
    //-------- @readOnlyWithInstructionForGeneration
    const cMapElement_readerMap * objectArray_84369 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (GALGAS_string ("location")) ;
    if (NULL != objectArray_84369) {
        macroValidSharedObject (objectArray_84369, const cMapElement_readerMap) ;
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsNotEqual, objectArray_84369->mAttribute_mArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (1835)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorLocationExpression, GALGAS_string ("the error location expression type is '@").operator_concat (var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1837)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1837)) COMMA_SOURCE_FILE_AT_LINE (1837)).operator_concat (GALGAS_string ("' and defines a 'location' reader with arguments; it should be either of the '@location' type, either defines a 'location' reader without argument that"
          " returns an '@location' object") COMMA_SOURCE_FILE_AT_LINE (1838)) COMMA_SOURCE_FILE_AT_LINE (1836)) ;
      }else{
        //-------- @ifInstructionForGeneration
        if (GALGAS_bool (kIsNotEqual, objectArray_84369->mAttribute_mReturnedType.objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType)).isValidAndTrue ()) {
          //-------- @errorInstructionForGeneration
          inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorLocationExpression, GALGAS_string ("the error location expression type is '@").operator_concat (var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1842)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1842)) COMMA_SOURCE_FILE_AT_LINE (1842)).operator_concat (GALGAS_string ("' and defines a 'location' reader that returns an '@") COMMA_SOURCE_FILE_AT_LINE (1843)).operator_concat (objectArray_84369->mAttribute_mReturnedType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1843)) COMMA_SOURCE_FILE_AT_LINE (1843)).operator_concat (GALGAS_string ("' object; it should be either of the '@location' type, either defines a 'location' reader without argument that returns an '@location' object") COMMA_SOURCE_FILE_AT_LINE (1844)) COMMA_SOURCE_FILE_AT_LINE (1841)) ;
        }
      }
      //-------- @assignmentInstructionForGeneration
      var_errorLocationExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType, object->mAttribute_mEndOfErrorLocationExpression, GALGAS_bool (false), var_errorLocationExpression, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1852)), GALGAS_string ("location"), GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1854)), objectArray_84369->mAttribute_mHasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1847)) ;
    }else{
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorLocationExpression, GALGAS_string ("the error location expression type is '@").operator_concat (var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1859)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1859)) COMMA_SOURCE_FILE_AT_LINE (1859)).operator_concat (GALGAS_string ("' and does not define a 'location' reader; it should be either of the '@location' type, either defines a 'location' reader without argument that return"
        "s an '@location' object") COMMA_SOURCE_FILE_AT_LINE (1860)) COMMA_SOURCE_FILE_AT_LINE (1858)) ;
    }
  }
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1865)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1865)).objectCompare (GALGAS_string ("object"))).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_extractObjectInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mEndOfReceiverExpression, var_expression, object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1870)), var_errorLocationExpression COMMA_SOURCE_FILE_AT_LINE (1866)) ;
  }else{
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_castInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (1876)), var_expression, object->mAttribute_mUseKindOfClass, object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1879)), var_errorLocationExpression COMMA_SOURCE_FILE_AT_LINE (1874)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstringlist joker_86989_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_86992_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_86995_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_86998_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_86989_0, joker_86992_0, joker_86995_0, joker_86998_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1894)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outExpression = GALGAS_filewrapperInExpressionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("filewrapper"), object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1897)) COMMA_SOURCE_FILE_AT_LINE (1897)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1897)), object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1898)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1899)), var_filewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1900)) COMMA_SOURCE_FILE_AT_LINE (1896)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_87749_0 ; // Joker input parameter
  GALGAS_lstringlist joker_87752_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_87755_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_87758_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_87749_0, joker_87752_0, joker_87755_0, joker_87758_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1913)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_87921_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_87921_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1916)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticExpressionListForGeneration var_effectiveParameterList ;
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1919)).objectCompare (var_templateSignature.reader_length (SOURCE_FILE_AT_LINE (1919)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_0, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mFilewrapperTemplateName.reader_string (SOURCE_FILE_AT_LINE (1921)) COMMA_SOURCE_FILE_AT_LINE (1921)).operator_concat (GALGAS_string ("' template of '") COMMA_SOURCE_FILE_AT_LINE (1921)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1921)) COMMA_SOURCE_FILE_AT_LINE (1921)).operator_concat (GALGAS_string ("' filewrapper requires ") COMMA_SOURCE_FILE_AT_LINE (1921)).operator_concat (var_templateSignature.reader_length (SOURCE_FILE_AT_LINE (1922)).reader_string (SOURCE_FILE_AT_LINE (1922)) COMMA_SOURCE_FILE_AT_LINE (1922)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (1922)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1923)).reader_string (SOURCE_FILE_AT_LINE (1923)) COMMA_SOURCE_FILE_AT_LINE (1923)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (1923)) COMMA_SOURCE_FILE_AT_LINE (1920)) ;
    var_effectiveParameterList.drop () ; // Release error dropped variable
  }else{
    //-------- @assignmentInstructionForGeneration
    var_effectiveParameterList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1926)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_88508 (object->mAttribute_mExpressions, true) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_88529 (var_templateSignature, true) ;
    //--- simple foreach instruction
    while (enumerator_88508.hasCurrentObject () && enumerator_88529.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_exp ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_88508.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (1929)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_88529.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (1930)), enumerator_88508.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1930)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_effectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (1931)) ;
      enumerator_88508.gotoNextObject () ;
      enumerator_88529.gotoNextObject () ;
    }
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outExpression = GALGAS_filewrapperTemplateInExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1937)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1938)), object->mAttribute_mFilewrapperTemplateName.reader_string (SOURCE_FILE_AT_LINE (1939)), var_effectiveParameterList COMMA_SOURCE_FILE_AT_LINE (1935)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (1954)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_0 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("path is empty") COMMA_SOURCE_FILE_AT_LINE (1955)) ;
    var_directoryList.drop () ; // Release error dropped variable
    var_fileName.drop () ; // Release error dropped variable
  }else{
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1956)).objectCompare (GALGAS_char (TO_UNICODE (47)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the path should not begin with '/'") COMMA_SOURCE_FILE_AT_LINE (1957)) ;
      var_directoryList.drop () ; // Release error dropped variable
      var_fileName.drop () ; // Release error dropped variable
    }else{
      //-------- @assignmentInstructionForGeneration
      var_directoryList = object->mAttribute_mFilewrapperPath.mAttribute_string.reader_componentsSeparatedByString (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1959)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_directoryList.modifier_popLast (var_fileName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1960)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_90049_0 ; // Joker input parameter
  GALGAS_lstringlist joker_90052_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_90100_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_90049_0, joker_90052_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_90100_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1965)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_builtPath = GALGAS_string ("") ;
  //-------- @loopInstructionForGeneration
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1968)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1968)).isValid ()) {
    PMUInt32 variant_90161 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1968)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1968)).uintValue () ;
    bool loop_90161 = true ;
    while (loop_90161) {
      loop_90161 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1969)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_90161) {
        loop_90161 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1969)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_90161 && (0 == variant_90161)) {
        loop_90161 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (1968)) ;
      }
      if (loop_90161) {
        variant_90161 -- ;
        //-------- @localVariableDeclarationForGeneration
        ...
        { //-------- @modifierCallInstructionForGeneration
        var_directoryList.modifier_popFirst (var_directoryName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1971)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @appendInstructionForGeneration
        var_builtPath.dotAssign_operation (var_directoryName.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1972)) COMMA_SOURCE_FILE_AT_LINE (1972)) ;
        //-------- @ifInstructionForGeneration
        if (var_filewrapperDirectoryMap.reader_hasKey (var_directoryName COMMA_SOURCE_FILE_AT_LINE (1973)).isValidAndTrue ()) {
          //-------- @methodCallInstructionForGeneration
          GALGAS_uint joker_90568_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1975)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_90568_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1974)) ;
          //-------- END @methodCallInstructionForGeneration
        }else{
          //-------- @errorInstructionForGeneration
          GALGAS_location location_2 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (var_builtPath COMMA_SOURCE_FILE_AT_LINE (1981)).operator_concat (GALGAS_string ("' path does not exists for the '") COMMA_SOURCE_FILE_AT_LINE (1981)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1981)) COMMA_SOURCE_FILE_AT_LINE (1981)).operator_concat (GALGAS_string ("' filewrapper") COMMA_SOURCE_FILE_AT_LINE (1981)) COMMA_SOURCE_FILE_AT_LINE (1981)) ;
          var_filewrapperFileMap.drop () ; // Release error dropped variable
          //-------- @assignmentInstructionForGeneration
          var_directoryList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1982)) ;
        }
      }
    }
  }
  ...
  //-------- @ifInstructionForGeneration
  if (var_filewrapperFileMap.reader_hasKey (var_fileName COMMA_SOURCE_FILE_AT_LINE (1986)).isValidAndTrue ()) {
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_90967_0 ; // Joker input parameter
    GALGAS_uint joker_90970_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1987)), joker_90967_0, joker_90970_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1987)) ;
    //-------- END @methodCallInstructionForGeneration
  }else{
    //-------- @errorInstructionForGeneration
    GALGAS_location location_3 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (var_fileName COMMA_SOURCE_FILE_AT_LINE (1990)).operator_concat (GALGAS_string ("' file does not exist in the '") COMMA_SOURCE_FILE_AT_LINE (1990)).operator_concat (var_builtPath COMMA_SOURCE_FILE_AT_LINE (1990)).operator_concat (GALGAS_string ("' directory of '") COMMA_SOURCE_FILE_AT_LINE (1990)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1990)) COMMA_SOURCE_FILE_AT_LINE (1990)).operator_concat (GALGAS_string ("' filewrapper") COMMA_SOURCE_FILE_AT_LINE (1990)) COMMA_SOURCE_FILE_AT_LINE (1989)) ;
    var_fileIndex.drop () ; // Release error dropped variable
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outExpression = GALGAS_filewrapperStaticPathInExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1997)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1998)), var_fileIndex COMMA_SOURCE_FILE_AT_LINE (1995)) ;
}
//---------------------------------------------------------------------------*
