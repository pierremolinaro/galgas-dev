...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_85893_0 ; // Joker input parameter
  GALGAS_lstringlist joker_85896_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_85944_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_85893_0, joker_85896_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_85944_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1843)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1846)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1846)).isValid ()) {
    PMUInt32 variant_86005 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1846)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1846)).uintValue () ;
    bool loop_86005 = true ;
    while (loop_86005) {
      loop_86005 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1847)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_86005) {
        loop_86005 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1847)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_86005 && (0 == variant_86005)) {
        loop_86005 = false ;
      ...
      if (loop_86005) {
        ...
        if (kBoolTrue == test_4) {
          //-------- @methodCallInstructionForGeneration
          GALGAS_uint joker_86410_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1853)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_86410_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1852)) ;
          //-------- END @methodCallInstructionForGeneration
        }else if (kBoolFalse == test_4) {
          //-------- @errorInstructionForGeneration
  ...
  if (kBoolTrue == test_6) {
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_86809_3 ; // Joker input parameter
    GALGAS_bool joker_86809_2 ; // Joker input parameter
    GALGAS_uint joker_86809_1 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1865)), joker_86809_3, joker_86809_2, joker_86809_1, var_fileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1865)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_6) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_lexiqueIntrospectionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (object->mAttribute_mLexiqueComponentName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1889)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("unknown reader") COMMA_SOURCE_FILE_AT_LINE (1894)) ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outExpression = GALGAS_lexiqueIntrospectionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_string ("stringlist").reader_nowhere (SOURCE_FILE_AT_LINE (1898)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1898)), object->mAttribute_mLexiqueComponentName.mAttribute_location, object->mAttribute_mLexiqueComponentName.mAttribute_string, object->mAttribute_mLexiqueReaderName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1897)) ;
}
//---------------------------------------------------------------------------*
