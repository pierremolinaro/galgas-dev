...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_6) {
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_91678_3 ; // Joker input parameter
    GALGAS_bool joker_91678_2 ; // Joker input parameter
    GALGAS_uint joker_91678_1 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2009)), joker_91678_3, joker_91678_2, joker_91678_1, var_fileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2009)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_6) {
    //-------- @errorInstructionForGeneration
