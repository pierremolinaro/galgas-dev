...
static void categoryMethod_thisReaderCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (NULL != objectArray_41543) {
    ...
    if (kBoolTrue == test_1) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_readerMap enumerator_42043 (var_readerMap, true) ;
      //--- simple foreach instruction
      while (enumerator_42043.hasCurrentObject ()) {
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_unifiedTypeMapProxyList enumerator_42111 (enumerator_42043.current_mArgumentTypeList (HERE), true) ;
        //--- simple foreach instruction
  ...
  if (kBoolTrue == test_6) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_43071 (object->mAttribute_mExpressions, true) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_43103 (var_readerFormalArgumentTypeList, true) ;
    //--- simple foreach instruction
...
static void categoryMethod_superReaderCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (NULL != objectArray_45614) {
    ...
    if (kBoolTrue == test_4) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_readerMap enumerator_46420 (var_readerMap, true) ;
      //--- simple foreach instruction
      while (enumerator_46420.hasCurrentObject ()) {
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_unifiedTypeMapProxyList enumerator_46488 (enumerator_46420.current_mArgumentTypeList (HERE), true) ;
        //--- simple foreach instruction
  ...
  if (kBoolTrue == test_9) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_47482 (object->mAttribute_mExpressions, true) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_47514 (var_readerFormalArgumentTypeList, true) ;
    //--- simple foreach instruction
...
static void categoryMethod_optionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_50545 (var_boolOptionMap, true) ;
    //--- simple foreach instruction
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_50641 (var_uintOptionMap, true) ;
    //--- simple foreach instruction
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_50739 (var_stringOptionMap, true) ;
    //--- simple foreach instruction
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_unifiedTypeMapProxyList enumerator_81182 (var_functionSignature, true) ;
    cEnumerator_semanticExpressionListAST enumerator_81198 (object->mAttribute_mExpressions, true) ;
    //--- simple foreach instruction
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_82798_20 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_82798_19 ; // Joker input parameter
  GALGAS_typeKindEnum joker_82798_18 ; // Joker input parameter
  GALGAS_typedAttributeList joker_82798_17 ; // Joker input parameter
  GALGAS_attributeMap joker_82798_16 ; // Joker input parameter
  GALGAS_typedAttributeList joker_82798_15 ; // Joker input parameter
  GALGAS_constructorMap joker_82798_14 ; // Joker input parameter
  GALGAS_readerMap joker_82798_13 ; // Joker input parameter
  GALGAS_modifierMap joker_82798_12 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_82798_11 ; // Joker input parameter
  GALGAS_classMethodMap joker_82798_10 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_82798_9 ; // Joker input parameter
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_89219 (object->mAttribute_mExpressions, true) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_89240 (var_templateSignature, true) ;
    //--- simple foreach instruction
