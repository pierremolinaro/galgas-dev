...
//                    november 23th, 2010, at 23h10'29"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  GALGAS_string result_string ; // Returned variable
  //-------- @ifInstructionForGeneration
  if (constinArgument_inSuperClass.reader_isNull (SOURCE_FILE_AT_LINE (783)).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
                                  ...
                                  COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @ifInstructionForGeneration
  if (constinArgument_inOperandIsHandled.operator_not (SOURCE_FILE_AT_LINE (970)).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (var_ok.operator_not (SOURCE_FILE_AT_LINE (982)).isValidAndTrue ()) {
      //-------- @ifInstructionForGeneration
      if (constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (984)).reader_hasKey (constinArgument_inLeftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (984)) COMMA_SOURCE_FILE_AT_LINE (984)).isValidAndTrue ()) {
        //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @ifInstructionForGeneration
      if (var_ok.operator_not (SOURCE_FILE_AT_LINE (1012)).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
...
static void categoryMethod_readerCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (NULL != objectArray_36529) {
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, objectArray_36529->mAttribute_mErrorMessage.objectCompare (GALGAS_string (""))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_0 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_0, objectArray_36529->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (612)) ;
    }
  }else{
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_uint var_matchingReaderCount = GALGAS_uint ((PMUInt32) 0U) ;
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, var_receiverType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (616)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (616)))).isValidAndTrue ()) {
      //-------- @assignmentInstructionForGeneration
      ...
      while (enumerator_37188.hasCurrentObject ()) {
        ...
        if (NULL != objectArray_37528) {
          ...
          //-------- @ifInstructionForGeneration
          if (GALGAS_bool (kIsNotEqual, objectArray_37528->mAttribute_mErrorMessage.objectCompare (GALGAS_string (""))).isValidAndTrue ()) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_1 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_1, objectArray_37528->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (633)) ;
          }
        }
      ...
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsEqual, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (655)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_4 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (657)) COMMA_SOURCE_FILE_AT_LINE (657)).operator_concat (GALGAS_string ("' type does not define any reader") COMMA_SOURCE_FILE_AT_LINE (657)) COMMA_SOURCE_FILE_AT_LINE (656)) ;
        var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
        var_hasCompilerArgument.drop () ; // Release error dropped variable
        var_returnedType.drop () ; // Release error dropped variable
        var_isCategory.drop () ; // Release error dropped variable
        ...
        inCompiler->emitSemanticError (location_6, GALGAS_string ("the '@").operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (670)) COMMA_SOURCE_FILE_AT_LINE (670)).operator_concat (GALGAS_string ("' type does not define the '") COMMA_SOURCE_FILE_AT_LINE (670)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (670)) COMMA_SOURCE_FILE_AT_LINE (670)).operator_concat (GALGAS_string ("' reader; available ") COMMA_SOURCE_FILE_AT_LINE (670)).operator_concat (temp_5 COMMA_SOURCE_FILE_AT_LINE (671)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (672)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (672)) COMMA_SOURCE_FILE_AT_LINE (669)) ;
        var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
        var_hasCompilerArgument.drop () ; // Release error dropped variable
        var_returnedType.drop () ; // Release error dropped variable
        var_isCategory.drop () ; // Release error dropped variable
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (678)).objectCompare (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (678)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_7 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_7, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (679)) COMMA_SOURCE_FILE_AT_LINE (679)).operator_concat (GALGAS_string ("' reader of '@") COMMA_SOURCE_FILE_AT_LINE (679)).operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (679)) COMMA_SOURCE_FILE_AT_LINE (679)).operator_concat (GALGAS_string ("' requires ") COMMA_SOURCE_FILE_AT_LINE (679)).operator_concat (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (680)).reader_string (SOURCE_FILE_AT_LINE (680)) COMMA_SOURCE_FILE_AT_LINE (680)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (680)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (681)).reader_string (SOURCE_FILE_AT_LINE (681)) COMMA_SOURCE_FILE_AT_LINE (681)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (681)) COMMA_SOURCE_FILE_AT_LINE (679)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else{
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_thisReaderCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (ioArgument_ioVariableMap.reader_hasKey (function_selfMarkName (inCompiler COMMA_SOURCE_FILE_AT_LINE (712)) COMMA_SOURCE_FILE_AT_LINE (712)).isValidAndTrue ()) {
  ...
  if (NULL != objectArray_41633) {
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (730)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_0 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_0, GALGAS_string ("the '@").operator_concat (var_thisTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (732)) COMMA_SOURCE_FILE_AT_LINE (732)).operator_concat (GALGAS_string ("' type does not define any reader") COMMA_SOURCE_FILE_AT_LINE (732)) COMMA_SOURCE_FILE_AT_LINE (731)) ;
      var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
      var_hasCompilerArgument.drop () ; // Release error dropped variable
      var_returnedType.drop () ; // Release error dropped variable
      var_isCategory.drop () ; // Release error dropped variable
      ...
      GALGAS_location location_2 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '@").operator_concat (var_thisTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (745)) COMMA_SOURCE_FILE_AT_LINE (745)).operator_concat (GALGAS_string ("' type does not define the '") COMMA_SOURCE_FILE_AT_LINE (745)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (745)) COMMA_SOURCE_FILE_AT_LINE (745)).operator_concat (GALGAS_string ("' reader; available ") COMMA_SOURCE_FILE_AT_LINE (745)).operator_concat (temp_1 COMMA_SOURCE_FILE_AT_LINE (746)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (747)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (747)) COMMA_SOURCE_FILE_AT_LINE (744)) ;
      var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
      var_hasCompilerArgument.drop () ; // Release error dropped variable
      var_returnedType.drop () ; // Release error dropped variable
      var_isCategory.drop () ; // Release error dropped variable
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (753)).objectCompare (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (753)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_3 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (754)) COMMA_SOURCE_FILE_AT_LINE (754)).operator_concat (GALGAS_string ("' reader of '@") COMMA_SOURCE_FILE_AT_LINE (754)).operator_concat (var_thisTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (754)) COMMA_SOURCE_FILE_AT_LINE (754)).operator_concat (GALGAS_string ("' requires ") COMMA_SOURCE_FILE_AT_LINE (754)).operator_concat (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (755)).reader_string (SOURCE_FILE_AT_LINE (755)) COMMA_SOURCE_FILE_AT_LINE (755)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (755)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (756)).reader_string (SOURCE_FILE_AT_LINE (756)) COMMA_SOURCE_FILE_AT_LINE (756)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (756)) COMMA_SOURCE_FILE_AT_LINE (754)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else{
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_superReaderCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (ioArgument_ioVariableMap.reader_hasKey (function_selfMarkName (inCompiler COMMA_SOURCE_FILE_AT_LINE (808)) COMMA_SOURCE_FILE_AT_LINE (808)).isValidAndTrue ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_thisTypeProxy ;
    { //-------- @modifierCallInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (var_thisTypeProxy.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (811)).reader_isNull (SOURCE_FILE_AT_LINE (811)).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
  ...
  if (NULL != objectArray_45673) {
    ...
    if (GALGAS_bool (kIsEqual, var_superClassThatImplementsReader.objectCompare (GALGAS_string (""))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_0 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (834)) COMMA_SOURCE_FILE_AT_LINE (834)).operator_concat (GALGAS_string ("' reader is not implemented by super class(es)") COMMA_SOURCE_FILE_AT_LINE (834)) COMMA_SOURCE_FILE_AT_LINE (834)) ;
    }
  }else{
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (837)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (var_superTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (839)) COMMA_SOURCE_FILE_AT_LINE (839)).operator_concat (GALGAS_string ("' type does not define any reader") COMMA_SOURCE_FILE_AT_LINE (839)) COMMA_SOURCE_FILE_AT_LINE (838)) ;
      var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
      var_hasCompilerArgument.drop () ; // Release error dropped variable
      var_returnedType.drop () ; // Release error dropped variable
      var_isCategory.drop () ; // Release error dropped variable
      ...
      GALGAS_location location_3 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '@").operator_concat (var_superTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (852)) COMMA_SOURCE_FILE_AT_LINE (852)).operator_concat (GALGAS_string ("' type does not define the '") COMMA_SOURCE_FILE_AT_LINE (852)).operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (852)) COMMA_SOURCE_FILE_AT_LINE (852)).operator_concat (GALGAS_string ("' reader; available ") COMMA_SOURCE_FILE_AT_LINE (852)).operator_concat (temp_2 COMMA_SOURCE_FILE_AT_LINE (853)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (854)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (854)) COMMA_SOURCE_FILE_AT_LINE (851)) ;
      var_readerFormalArgumentTypeList.drop () ; // Release error dropped variable
      var_hasCompilerArgument.drop () ; // Release error dropped variable
      var_returnedType.drop () ; // Release error dropped variable
      var_isCategory.drop () ; // Release error dropped variable
...
static void categoryMethod_optionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (var_found.operator_not (SOURCE_FILE_AT_LINE (906)).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
  ...
  if (var_found.isValidAndTrue ()) {
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (911)).objectCompare (GALGAS_string ("value"))).isValidAndTrue ()) {
      //-------- @assignmentInstructionForGeneration
      ...
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (918)).objectCompare (GALGAS_string ("char"))).isValidAndTrue ()) {
        //-------- @assignmentInstructionForGeneration
        ...
        //-------- @ifInstructionForGeneration
        if (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (925)).objectCompare (GALGAS_string ("string"))).isValidAndTrue ()) {
          //-------- @assignmentInstructionForGeneration
          ...
          //-------- @ifInstructionForGeneration
          if (GALGAS_bool (kIsEqual, object->mAttribute_mOptionReaderName.reader_string (SOURCE_FILE_AT_LINE (932)).objectCompare (GALGAS_string ("comment"))).isValidAndTrue ()) {
            //-------- @assignmentInstructionForGeneration
            ...
            inCompiler->emitSemanticError (location_0, GALGAS_string ("only the 'value', 'char', 'string' and 'comment' readers are defined for an option") COMMA_SOURCE_FILE_AT_LINE (940)) ;
            outArgument_outExpression.drop () ; // Release error dropped variable
          }
        }
      }
...
static void categoryMethod_equalExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1168)).reader_string (SOURCE_FILE_AT_LINE (1168)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1168)).reader_string (SOURCE_FILE_AT_LINE (1168)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_notEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1200)).reader_string (SOURCE_FILE_AT_LINE (1200)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1200)).reader_string (SOURCE_FILE_AT_LINE (1200)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_lowerOrEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1232)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1232)) COMMA_SOURCE_FILE_AT_LINE (1232)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1237)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1237)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_greaterOrEqualExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1269)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1269)) COMMA_SOURCE_FILE_AT_LINE (1269)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1274)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1274)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_strictGreaterExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1306)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1306)) COMMA_SOURCE_FILE_AT_LINE (1306)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1311)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1311)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_strictLowerExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1343)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1343)) COMMA_SOURCE_FILE_AT_LINE (1343)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1348)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1348)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_rightShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1380)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1380)) COMMA_SOURCE_FILE_AT_LINE (1380)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1385)).objectCompare (GALGAS_string ("uint"))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_leftShiftExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1417)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1417)) COMMA_SOURCE_FILE_AT_LINE (1417)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1422)).objectCompare (GALGAS_string ("uint"))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_unaryMinusExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1610)).operator_and (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1610)) COMMA_SOURCE_FILE_AT_LINE (1610)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_notExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1637)).operator_and (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1637)) COMMA_SOURCE_FILE_AT_LINE (1637)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_complementExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1664)).operator_and (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1664)) COMMA_SOURCE_FILE_AT_LINE (1664)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_ifExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, var_if_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1696)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1696)).objectCompare (GALGAS_string ("bool"))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_then_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1701)).objectCompare (var_else_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1701)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, var_functionSignature.reader_length (SOURCE_FILE_AT_LINE (1730)).objectCompare (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1730)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1808)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1808)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (1808)))).isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (var_found.operator_not (SOURCE_FILE_AT_LINE (1817)).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1822)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1822)).objectCompare (GALGAS_string ("object"))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
  ...
  if (var_useLocationReader.isValidAndTrue ()) {
    ...
    if (NULL != objectArray_84325) {
      ...
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsNotEqual, objectArray_84325->mAttribute_mArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (1834)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        ...
        //-------- @ifInstructionForGeneration
        if (GALGAS_bool (kIsNotEqual, objectArray_84325->mAttribute_mReturnedType.objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType)).isValidAndTrue ()) {
          //-------- @errorInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1864)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1864)).objectCompare (GALGAS_string ("object"))).isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1918)).objectCompare (var_templateSignature.reader_length (SOURCE_FILE_AT_LINE (1918)))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (1953)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_0 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("path is empty") COMMA_SOURCE_FILE_AT_LINE (1954)) ;
    var_directoryList.drop () ; // Release error dropped variable
    var_fileName.drop () ; // Release error dropped variable
  }else{
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1955)).objectCompare (GALGAS_char (TO_UNICODE (47)))).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the path should not begin with '/'") COMMA_SOURCE_FILE_AT_LINE (1956)) ;
      var_directoryList.drop () ; // Release error dropped variable
      var_fileName.drop () ; // Release error dropped variable
    }else{
      //-------- @assignmentInstructionForGeneration
  ...
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1967)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1967)).isValid ()) {
    ...
    while (loop_90117) {
      ...
      if (loop_90117) {
        ...
        //-------- @ifInstructionForGeneration
        if (var_filewrapperDirectoryMap.reader_hasKey (var_directoryName COMMA_SOURCE_FILE_AT_LINE (1972)).isValidAndTrue ()) {
          //-------- @methodCallInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  if (var_filewrapperFileMap.reader_hasKey (var_fileName COMMA_SOURCE_FILE_AT_LINE (1985)).isValidAndTrue ()) {
    //-------- @methodCallInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (var_fileName COMMA_SOURCE_FILE_AT_LINE (1989)).operator_concat (GALGAS_string ("' file does not exist in the '") COMMA_SOURCE_FILE_AT_LINE (1989)).operator_concat (var_builtPath COMMA_SOURCE_FILE_AT_LINE (1989)).operator_concat (GALGAS_string ("' directory of '") COMMA_SOURCE_FILE_AT_LINE (1989)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1989)) COMMA_SOURCE_FILE_AT_LINE (1989)).operator_concat (GALGAS_string ("' filewrapper") COMMA_SOURCE_FILE_AT_LINE (1989)) COMMA_SOURCE_FILE_AT_LINE (1988)) ;
