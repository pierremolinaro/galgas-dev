...
static void categoryMethod_complementExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1663)).operator_and (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1663)) COMMA_SOURCE_FILE_AT_LINE (1663)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("operand type is '@").operator_concat (var_type.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1665)) COMMA_SOURCE_FILE_AT_LINE (1665)).operator_concat (GALGAS_string ("' and does not support the '~' operator") COMMA_SOURCE_FILE_AT_LINE (1665)) COMMA_SOURCE_FILE_AT_LINE (1664)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (test_0.isValid ()) {
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_tildeExpressionForGeneration::constructor_new (var_type, object->mAttribute_mOperatorLocation, var_expression COMMA_SOURCE_FILE_AT_LINE (1670)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_ifExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mIfExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_if_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1687)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticExpressionForGeneration var_then_5F_expression ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mThenExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_then_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1690)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticExpressionForGeneration var_else_5F_expression ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mElseExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_else_5F_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1693)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_if_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1695)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1695)).objectCompare (GALGAS_string ("bool")))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("the test expression type is '@").operator_concat (var_if_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1697)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1697)) COMMA_SOURCE_FILE_AT_LINE (1697)).operator_concat (GALGAS_string ("', it should be '@bool'") COMMA_SOURCE_FILE_AT_LINE (1697)) COMMA_SOURCE_FILE_AT_LINE (1696)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (test_0.isValid ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_then_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1700)).objectCompare (var_else_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1700))))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("operand expression types are '@").operator_concat (var_then_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1702)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1702)) COMMA_SOURCE_FILE_AT_LINE (1702)).operator_concat (GALGAS_string ("' and '@") COMMA_SOURCE_FILE_AT_LINE (1702)).operator_concat (var_else_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1702)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1702)) COMMA_SOURCE_FILE_AT_LINE (1702)).operator_concat (GALGAS_string ("': they should be the same") COMMA_SOURCE_FILE_AT_LINE (1702)) COMMA_SOURCE_FILE_AT_LINE (1701)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (test_1.isValid ()) {
      //-------- @assignmentInstructionForGeneration
      outArgument_outExpression = GALGAS_ifExpressionForGeneration::constructor_new (var_then_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (1708)), object->mAttribute_mOperatorLocation, var_if_5F_expression, var_then_5F_expression, var_else_5F_expression COMMA_SOURCE_FILE_AT_LINE (1707)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFunctionMap.method_searchKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultType, inCompiler COMMA_SOURCE_FILE_AT_LINE (1727)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_functionSignature.reader_length (SOURCE_FILE_AT_LINE (1729)).objectCompare (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1729))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mFunctionName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mFunctionName.reader_string (SOURCE_FILE_AT_LINE (1731)) COMMA_SOURCE_FILE_AT_LINE (1731)).operator_concat (GALGAS_string ("' function header declares ") COMMA_SOURCE_FILE_AT_LINE (1731)).operator_concat (var_functionSignature.reader_length (SOURCE_FILE_AT_LINE (1731)).reader_string (SOURCE_FILE_AT_LINE (1731)) COMMA_SOURCE_FILE_AT_LINE (1731)).operator_concat (GALGAS_string (" formal parameter(s), but this function call names ") COMMA_SOURCE_FILE_AT_LINE (1732)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1732)).reader_string (SOURCE_FILE_AT_LINE (1732)) COMMA_SOURCE_FILE_AT_LINE (1732)).operator_concat (GALGAS_string (" effective argument(s)") COMMA_SOURCE_FILE_AT_LINE (1733)) COMMA_SOURCE_FILE_AT_LINE (1730)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (test_0.isValid ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_semanticExpressionListForGeneration var_semanticExpressionListForGeneration = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1737)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_unifiedTypeMapProxyList enumerator_80086 (var_functionSignature, true) ;
    cEnumerator_semanticExpressionListAST enumerator_80102 (object->mAttribute_mExpressions, true) ;
    //--- simple foreach instruction
    while (enumerator_80086.hasCurrentObject () && enumerator_80102.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_expression ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_80102.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1740)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_80086.current_mType (HERE), var_expression.reader_mType (SOURCE_FILE_AT_LINE (1741)), enumerator_80102.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1741)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_semanticExpressionListForGeneration.addAssign_operation (var_expression COMMA_SOURCE_FILE_AT_LINE (1742)) ;
      enumerator_80086.gotoNextObject () ;
      enumerator_80102.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_functionCallExpressionForGeneration::constructor_new (var_resultType, object->mAttribute_mFunctionName.reader_location (SOURCE_FILE_AT_LINE (1746)), object->mAttribute_mFunctionName.reader_string (SOURCE_FILE_AT_LINE (1747)), var_semanticExpressionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1744)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_varInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioVariableMap.modifier_searchForReadAccess (object->mAttribute_mVarName, var_type, var_sourceVariableCppName, var_nameForCheckingFormalParameterUsing, inCompiler COMMA_SOURCE_FILE_AT_LINE (1763)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_81157 (object->mAttribute_mStructFieldList, true) ;
  //--- simple foreach instruction
  while (enumerator_81157.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1765)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (1765))))) ;
    if (test_0.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_81157.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '->' operator requires the receiver to be a struct") COMMA_SOURCE_FILE_AT_LINE (1766)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeMap var_attributeMap = var_type.reader_mAttributeMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1768)) ;
    //-------- @methodCallInstructionForGeneration
    var_attributeMap.method_searchKey (enumerator_81157.current_mValue (HERE), var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (1769)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_81157.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outExpression = GALGAS_varInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mVarName.reader_location (SOURCE_FILE_AT_LINE (1773)), var_sourceVariableCppName, var_nameForCheckingFormalParameterUsing, object->mAttribute_mStructFieldList COMMA_SOURCE_FILE_AT_LINE (1771)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_82032_20 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_82032_19 ; // Joker input parameter
  GALGAS_typeKindEnum joker_82032_18 ; // Joker input parameter
  GALGAS_typedAttributeList joker_82032_17 ; // Joker input parameter
  GALGAS_attributeMap joker_82032_16 ; // Joker input parameter
  GALGAS_typedAttributeList joker_82032_15 ; // Joker input parameter
  GALGAS_constructorMap joker_82032_14 ; // Joker input parameter
  GALGAS_readerMap joker_82032_13 ; // Joker input parameter
  GALGAS_modifierMap joker_82032_12 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_82032_11 ; // Joker input parameter
  GALGAS_classMethodMap joker_82032_10 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_82032_9 ; // Joker input parameter
  GALGAS_uint joker_82032_8 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_82032_7 ; // Joker input parameter
  GALGAS_stringset joker_82032_6 ; // Joker input parameter
  GALGAS_lstringlist joker_82032_5 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_82032_4 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_82032_3 ; // Joker input parameter
  GALGAS_withAccessorMap joker_82032_2 ; // Joker input parameter
  GALGAS_bool joker_82032_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_82032_20, joker_82032_19, joker_82032_18, joker_82032_17, joker_82032_16, joker_82032_15, joker_82032_14, joker_82032_13, joker_82032_12, joker_82032_11, joker_82032_10, joker_82032_9, joker_82032_8, joker_82032_7, joker_82032_6, joker_82032_5, joker_82032_4, joker_82032_3, joker_82032_2, joker_82032_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1788)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outExpression = GALGAS_literalTypeInExpressionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("type"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1791)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1791)), object->mAttribute_mLiteralTypeName.reader_location (SOURCE_FILE_AT_LINE (1792)), object->mAttribute_mLiteralTypeName.reader_string (SOURCE_FILE_AT_LINE (1793)) COMMA_SOURCE_FILE_AT_LINE (1790)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mReceiverExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1806)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unifiedTypeMapProxy var_type = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1808)) ;
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1810)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1810)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (1810))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_unifiedTypeMapProxy var_t = var_type ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mType (SOURCE_FILE_AT_LINE (1813)))) ;
    //-------- @loopInstructionForGeneration
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1814)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1814)).isValid ()) {
      PMUInt32 variant_83159 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1814)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1814)).uintValue () ;
      bool loop_83159 = true ;
      while (loop_83159) {
        loop_83159 = var_found.operator_not (SOURCE_FILE_AT_LINE (1815)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1815)).reader_isNull (SOURCE_FILE_AT_LINE (1815)).operator_not (SOURCE_FILE_AT_LINE (1815)) COMMA_SOURCE_FILE_AT_LINE (1815)).isValid () ;
        if (loop_83159) {
          loop_83159 = var_found.operator_not (SOURCE_FILE_AT_LINE (1815)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1815)).reader_isNull (SOURCE_FILE_AT_LINE (1815)).operator_not (SOURCE_FILE_AT_LINE (1815)) COMMA_SOURCE_FILE_AT_LINE (1815)).boolValue () ;
        }
        if (loop_83159 && (0 == variant_83159)) {
          loop_83159 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (1814)) ;
        }
        if (loop_83159) {
          variant_83159 -- ;
          //-------- @assignmentInstructionForGeneration
          var_t = var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1816)) ;
          //-------- @assignmentInstructionForGeneration
          var_found = GALGAS_bool (kIsEqual, var_t.objectCompare (var_expression.reader_mType (SOURCE_FILE_AT_LINE (1817)))) ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (var_found.operator_not (SOURCE_FILE_AT_LINE (1819))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_2 (object->mAttribute_mTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the '@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1821)) COMMA_SOURCE_FILE_AT_LINE (1821)).operator_concat (GALGAS_string ("' is not a descendant of the '@") COMMA_SOURCE_FILE_AT_LINE (1821)).operator_concat (var_expression.reader_mType (SOURCE_FILE_AT_LINE (1821)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1821)) COMMA_SOURCE_FILE_AT_LINE (1821)).operator_concat (GALGAS_string ("' type of the cast expression") COMMA_SOURCE_FILE_AT_LINE (1821)) COMMA_SOURCE_FILE_AT_LINE (1820)) ;
    }
  }else if (test_0.isValid ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_3 (GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1824)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1824)).objectCompare (GALGAS_string ("object")))) ;
    if (test_3.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (var_expression.reader_mLocation (SOURCE_FILE_AT_LINE (1825)), GALGAS_string ("cast expression should be an @object or a class instance: it is an @").operator_concat (var_expression.reader_mType (SOURCE_FILE_AT_LINE (1826)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1826)) COMMA_SOURCE_FILE_AT_LINE (1826)).operator_concat (GALGAS_string (" instance") COMMA_SOURCE_FILE_AT_LINE (1826)) COMMA_SOURCE_FILE_AT_LINE (1825)) ;
    }
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticExpressionForGeneration var_errorLocationExpression ;
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) object->mAttribute_mErrorLocationExpression.ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_errorLocationExpression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1830)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_useLocationReader = GALGAS_bool (kIsNotEqual, var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1832)).objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType)) ;
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_4 (var_useLocationReader) ;
  if (test_4.isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_readerMap var_readerMap = var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1834)).reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (1834)) ;
    //-------- @readOnlyWithInstructionForGeneration
    const cMapElement_readerMap * objectArray_84314 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (GALGAS_string ("location")) ;
    if (NULL != objectArray_84314) {
        macroValidSharedObject (objectArray_84314, const cMapElement_readerMap) ;
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_5 (GALGAS_bool (kIsNotEqual, objectArray_84314->mAttribute_mArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (1836)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
      if (test_5.isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorLocationExpression, GALGAS_string ("the error location expression type is '@").operator_concat (var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1838)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1838)) COMMA_SOURCE_FILE_AT_LINE (1838)).operator_concat (GALGAS_string ("' and defines a 'location' reader with arguments; it should be either of the '@location' type, either defines a 'location' reader without argument that"
          " returns an '@location' object") COMMA_SOURCE_FILE_AT_LINE (1839)) COMMA_SOURCE_FILE_AT_LINE (1837)) ;
      }else if (test_5.isValid ()) {
        //-------- @ifInstructionForGeneration
        const GALGAS_bool test_6 (GALGAS_bool (kIsNotEqual, objectArray_84314->mAttribute_mReturnedType.objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType))) ;
        if (test_6.isValidAndTrue ()) {
          //-------- @errorInstructionForGeneration
          inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorLocationExpression, GALGAS_string ("the error location expression type is '@").operator_concat (var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1843)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1843)) COMMA_SOURCE_FILE_AT_LINE (1843)).operator_concat (GALGAS_string ("' and defines a 'location' reader that returns an '@") COMMA_SOURCE_FILE_AT_LINE (1844)).operator_concat (objectArray_84314->mAttribute_mReturnedType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1844)) COMMA_SOURCE_FILE_AT_LINE (1844)).operator_concat (GALGAS_string ("' object; it should be either of the '@location' type, either defines a 'location' reader without argument that returns an '@location' object") COMMA_SOURCE_FILE_AT_LINE (1845)) COMMA_SOURCE_FILE_AT_LINE (1842)) ;
        }
      }
      //-------- @assignmentInstructionForGeneration
      var_errorLocationExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType, object->mAttribute_mEndOfErrorLocationExpression, GALGAS_bool (false), var_errorLocationExpression, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1853)), GALGAS_string ("location"), GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1855)), objectArray_84314->mAttribute_mHasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1848)) ;
    }else{
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorLocationExpression, GALGAS_string ("the error location expression type is '@").operator_concat (var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1860)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1860)) COMMA_SOURCE_FILE_AT_LINE (1860)).operator_concat (GALGAS_string ("' and does not define a 'location' reader; it should be either of the '@location' type, either defines a 'location' reader without argument that return"
        "s an '@location' object") COMMA_SOURCE_FILE_AT_LINE (1861)) COMMA_SOURCE_FILE_AT_LINE (1859)) ;
    }
  }
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_7 (GALGAS_bool (kIsEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1866)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1866)).objectCompare (GALGAS_string ("object")))) ;
  if (test_7.isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_extractObjectInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mEndOfReceiverExpression, var_expression, object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1871)), var_errorLocationExpression COMMA_SOURCE_FILE_AT_LINE (1867)) ;
  }else if (test_7.isValid ()) {
    //-------- @assignmentInstructionForGeneration
    outArgument_outExpression = GALGAS_castInExpressionForGeneration::constructor_new (var_type, object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (1877)), var_expression, object->mAttribute_mUseKindOfClass, object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (1880)), var_errorLocationExpression COMMA_SOURCE_FILE_AT_LINE (1875)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstringlist joker_86934_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_86937_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_86940_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_86943_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_86934_0, joker_86937_0, joker_86940_0, joker_86943_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1895)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outExpression = GALGAS_filewrapperInExpressionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("filewrapper"), object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1898)) COMMA_SOURCE_FILE_AT_LINE (1898)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1898)), object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1899)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1900)), var_filewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1901)) COMMA_SOURCE_FILE_AT_LINE (1897)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_87694_0 ; // Joker input parameter
  GALGAS_lstringlist joker_87697_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_87700_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_87703_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_87694_0, joker_87697_0, joker_87700_0, joker_87703_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1914)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_87866_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_87866_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1917)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticExpressionListForGeneration var_effectiveParameterList ;
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1920)).objectCompare (var_templateSignature.reader_length (SOURCE_FILE_AT_LINE (1920))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mFilewrapperTemplateName.reader_string (SOURCE_FILE_AT_LINE (1922)) COMMA_SOURCE_FILE_AT_LINE (1922)).operator_concat (GALGAS_string ("' template of '") COMMA_SOURCE_FILE_AT_LINE (1922)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1922)) COMMA_SOURCE_FILE_AT_LINE (1922)).operator_concat (GALGAS_string ("' filewrapper requires ") COMMA_SOURCE_FILE_AT_LINE (1922)).operator_concat (var_templateSignature.reader_length (SOURCE_FILE_AT_LINE (1923)).reader_string (SOURCE_FILE_AT_LINE (1923)) COMMA_SOURCE_FILE_AT_LINE (1923)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (1923)).operator_concat (object->mAttribute_mExpressions.reader_length (SOURCE_FILE_AT_LINE (1924)).reader_string (SOURCE_FILE_AT_LINE (1924)) COMMA_SOURCE_FILE_AT_LINE (1924)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (1924)) COMMA_SOURCE_FILE_AT_LINE (1921)) ;
    var_effectiveParameterList.drop () ; // Release error dropped variable
  }else if (test_0.isValid ()) {
    //-------- @assignmentInstructionForGeneration
    var_effectiveParameterList = GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1927)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_88453 (object->mAttribute_mExpressions, true) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_88474 (var_templateSignature, true) ;
    //--- simple foreach instruction
    while (enumerator_88453.hasCurrentObject () && enumerator_88474.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_exp ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_88453.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (1930)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_88474.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (1931)), enumerator_88453.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1931)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_effectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (1932)) ;
      enumerator_88453.gotoNextObject () ;
      enumerator_88474.gotoNextObject () ;
    }
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outExpression = GALGAS_filewrapperTemplateInExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1938)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1939)), object->mAttribute_mFilewrapperTemplateName.reader_string (SOURCE_FILE_AT_LINE (1940)), var_effectiveParameterList COMMA_SOURCE_FILE_AT_LINE (1936)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_length (SOURCE_FILE_AT_LINE (1955)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("path is empty") COMMA_SOURCE_FILE_AT_LINE (1956)) ;
    var_directoryList.drop () ; // Release error dropped variable
    var_fileName.drop () ; // Release error dropped variable
  }else if (test_0.isValid ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.mAttribute_string.reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1957)).objectCompare (GALGAS_char (TO_UNICODE (47))))) ;
    if (test_2.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the path should not begin with '/'") COMMA_SOURCE_FILE_AT_LINE (1958)) ;
      var_directoryList.drop () ; // Release error dropped variable
      var_fileName.drop () ; // Release error dropped variable
    }else if (test_2.isValid ()) {
      //-------- @assignmentInstructionForGeneration
      var_directoryList = object->mAttribute_mFilewrapperPath.mAttribute_string.reader_componentsSeparatedByString (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1960)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_directoryList.modifier_popLast (var_fileName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1961)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_89994_0 ; // Joker input parameter
  GALGAS_lstringlist joker_89997_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_90045_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_89994_0, joker_89997_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_90045_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1966)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_builtPath = GALGAS_string::makeEmptyString () ;
  //-------- @loopInstructionForGeneration
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1969)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1969)).isValid ()) {
    PMUInt32 variant_90106 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1969)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1969)).uintValue () ;
    bool loop_90106 = true ;
    while (loop_90106) {
      loop_90106 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1970)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_90106) {
        loop_90106 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1970)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_90106 && (0 == variant_90106)) {
        loop_90106 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (1969)) ;
      }
      if (loop_90106) {
        variant_90106 -- ;
        //-------- @localVariableDeclarationForGeneration
        ...
        { //-------- @modifierCallInstructionForGeneration
        var_directoryList.modifier_popFirst (var_directoryName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1972)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @appendInstructionForGeneration
        var_builtPath.dotAssign_operation (var_directoryName.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1973)) COMMA_SOURCE_FILE_AT_LINE (1973)) ;
        //-------- @ifInstructionForGeneration
        const GALGAS_bool test_4 (var_filewrapperDirectoryMap.reader_hasKey (var_directoryName COMMA_SOURCE_FILE_AT_LINE (1974))) ;
        if (test_4.isValidAndTrue ()) {
          //-------- @methodCallInstructionForGeneration
          GALGAS_uint joker_90513_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1976)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_90513_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1975)) ;
          //-------- END @methodCallInstructionForGeneration
        }else if (test_4.isValid ()) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("the '").operator_concat (var_builtPath COMMA_SOURCE_FILE_AT_LINE (1982)).operator_concat (GALGAS_string ("' path does not exists for the '") COMMA_SOURCE_FILE_AT_LINE (1982)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1982)) COMMA_SOURCE_FILE_AT_LINE (1982)).operator_concat (GALGAS_string ("' filewrapper") COMMA_SOURCE_FILE_AT_LINE (1982)) COMMA_SOURCE_FILE_AT_LINE (1982)) ;
          var_filewrapperFileMap.drop () ; // Release error dropped variable
          //-------- @assignmentInstructionForGeneration
          var_directoryList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1983)) ;
        }
      }
    }
  }
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_6 (var_filewrapperFileMap.reader_hasKey (var_fileName COMMA_SOURCE_FILE_AT_LINE (1987))) ;
  if (test_6.isValidAndTrue ()) {
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_90912_0 ; // Joker input parameter
    GALGAS_uint joker_90915_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1988)), joker_90912_0, joker_90915_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1988)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (test_6.isValid ()) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_7 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (var_fileName COMMA_SOURCE_FILE_AT_LINE (1991)).operator_concat (GALGAS_string ("' file does not exist in the '") COMMA_SOURCE_FILE_AT_LINE (1991)).operator_concat (var_builtPath COMMA_SOURCE_FILE_AT_LINE (1991)).operator_concat (GALGAS_string ("' directory of '") COMMA_SOURCE_FILE_AT_LINE (1991)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1991)) COMMA_SOURCE_FILE_AT_LINE (1991)).operator_concat (GALGAS_string ("' filewrapper") COMMA_SOURCE_FILE_AT_LINE (1991)) COMMA_SOURCE_FILE_AT_LINE (1990)) ;
    var_fileIndex.drop () ; // Release error dropped variable
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outExpression = GALGAS_filewrapperStaticPathInExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mStringType, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1998)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1999)), var_fileIndex COMMA_SOURCE_FILE_AT_LINE (1996)) ;
}
//---------------------------------------------------------------------------*
