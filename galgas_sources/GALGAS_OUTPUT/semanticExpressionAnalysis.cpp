...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_string joker_46388 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 796)).method_searchKey (constinArgument_inReaderName, joker_46373_5, joker_46373_4, joker_46373_3, joker_46373_2, joker_46373_1, var_qualifier, joker_46388, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 796)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        GALGAS_location joker_51150 ; // Joker input parameter
        GALGAS_methodQualifier joker_51218_2 ; // Joker input parameter
        GALGAS_string joker_51218_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 918)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 919)), var_kind, var_argumentTypeList, joker_51150, var_hasCompilerArgument, var_returnedType, joker_51218_2, joker_51218_1, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 918)) ;
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_93669 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_93669, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2014)) ;
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool var_isInternal ;
  GALGAS_lstring joker_96009 ; // Joker input parameter
  GALGAS_lstringlist joker_96016 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_96113 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_96009, joker_96016, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_96113, var_isInternal, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2064)) ;
  ...
  if (kBoolTrue == test_9) {
    GALGAS_string joker_97441 ; // Joker input parameter
    GALGAS_uint joker_97456 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here ()  COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2102)), joker_97441, var_isTextFile, joker_97456, var_fileIndex, inCompiler COMMA_SOURCE_FILE ("semanticExpressionAnalysis.gSemantics", 2102)) ;
  }else if (kBoolFalse == test_9) {
