...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_methodKind joker_42870_5 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_42870_4 ; // Joker input parameter
    GALGAS_location joker_42870_3 ; // Joker input parameter
    GALGAS_bool joker_42870_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_42870_1 ; // Joker input parameter
    GALGAS_string joker_42885_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (730)).method_searchKey (constinArgument_inReaderName, joker_42870_5, joker_42870_4, joker_42870_3, joker_42870_2, joker_42870_1, var_qualifier, joker_42885_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (730)) ;
    //-------- END @methodCallInstructionForGeneration
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (835)).isValid ()) {
      PMUInt32 variant_46866 = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (835)).uintValue () ;
      bool loop_46866 = true ;
      while (loop_46866) {
        loop_46866 = var_ok.operator_not (SOURCE_FILE_AT_LINE (835)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (835)).reader_isNull (SOURCE_FILE_AT_LINE (835)).operator_not (SOURCE_FILE_AT_LINE (835)) COMMA_SOURCE_FILE_AT_LINE (835)).isValid () ;
        if (loop_46866) {
          loop_46866 = var_ok.operator_not (SOURCE_FILE_AT_LINE (835)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (835)).reader_isNull (SOURCE_FILE_AT_LINE (835)).operator_not (SOURCE_FILE_AT_LINE (835)) COMMA_SOURCE_FILE_AT_LINE (835)).boolValue () ;
        }
        if (loop_46866 && (0 == variant_46866)) {
          loop_46866 = false ;
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        //-------- @methodCallInstructionForGeneration
        GALGAS_location joker_47457_0 ; // Joker input parameter
        GALGAS_methodQualifier joker_47525_2 ; // Joker input parameter
        GALGAS_string joker_47525_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (847)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (848)), var_kind, var_argumentTypeList, joker_47457_0, var_hasCompilerArgument, var_returnedType, joker_47525_2, joker_47525_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (847)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_readerCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @readOnlyWithInstructionForGeneration
  const cMapElement_readerMap * objectArray_38417 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (623))) ;
  if (NULL != objectArray_38417) {
      macroValidSharedObject (objectArray_38417, const cMapElement_readerMap) ;
    //-------- @assignmentInstructionForGeneration
    var_readerFormalArgumentTypeList = objectArray_38417->mAttribute_mArgumentTypeList ;
    //-------- @assignmentInstructionForGeneration
    var_hasCompilerArgument = objectArray_38417->mAttribute_mHasCompilerArgument ;
    //-------- @assignmentInstructionForGeneration
    var_returnedType = objectArray_38417->mAttribute_mReturnedType ;
    //-------- @assignmentInstructionForGeneration
    var_kind = objectArray_38417->mAttribute_mKind ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, objectArray_38417->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, objectArray_38417->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (629)) ;
    }
  }else{
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    if (kBoolTrue == test_2) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_typedAttributeList enumerator_39085 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (638)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_39085.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_unifiedTypeMapProxy var_attributeType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (enumerator_39085.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (639)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (639)), inCompiler COMMA_SOURCE_FILE_AT_LINE (639)) ;
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_readerMap var_aMap = var_attributeType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (640)) ;
        //-------- @readOnlyWithInstructionForGeneration
        const cMapElement_readerMap * objectArray_39324 = (const cMapElement_readerMap *) var_aMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (641))) ;
        if (NULL != objectArray_39324) {
            macroValidSharedObject (objectArray_39324, const cMapElement_readerMap) ;
          //-------- @incrementInstructionForGeneration
          var_matchingReaderCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (642)) ;
          //-------- @assignmentInstructionForGeneration
          var_readerFormalArgumentTypeList = objectArray_39324->mAttribute_mArgumentTypeList ;
          //-------- @assignmentInstructionForGeneration
          var_hasCompilerArgument = objectArray_39324->mAttribute_mHasCompilerArgument ;
          //-------- @assignmentInstructionForGeneration
          var_returnedType = objectArray_39324->mAttribute_mReturnedType ;
          //-------- @assignmentInstructionForGeneration
          var_kind = objectArray_39324->mAttribute_mKind ;
          //-------- @plusEqualnstructionForGeneration
          var_fieldList.addAssign_operation (enumerator_39085.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (647)) COMMA_SOURCE_FILE_AT_LINE (647)) ;
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, objectArray_39324->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_3) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_4 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_4, objectArray_39324->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (649)) ;
          }
        }
      ...
      if (kBoolTrue == test_5) {
        ...
        if (kBoolTrue == test_7) {
          ...
          GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_stringlist enumerator_40190 (var_fieldList, kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_40190.hasCurrentObject ()) {
            //-------- @concatInstructionForGeneration
            var_s.dotAssign_operation (enumerator_40190.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (662)) ;
            if (enumerator_40190.hasNextObject ()) {
              //-------- @concatInstructionForGeneration
              var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (663)) ;
            }
            enumerator_40190.gotoNextObject () ;
          }
          //-------- @errorInstructionForGeneration
      ...
      if (kBoolTrue == test_9) {
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_readerMap enumerator_40878 (var_readerMap, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_40878.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_40878.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (679)) COMMA_SOURCE_FILE_AT_LINE (679)) COMMA_SOURCE_FILE_AT_LINE (679)) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_unifiedTypeMapProxyList enumerator_40946 (enumerator_40878.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_40946.hasCurrentObject ()) {
            //-------- @concatInstructionForGeneration
            var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_40946.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (681)) COMMA_SOURCE_FILE_AT_LINE (681)) COMMA_SOURCE_FILE_AT_LINE (681)) ;
            enumerator_40946.gotoNextObject () ;
          }
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_40878.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (683)) COMMA_SOURCE_FILE_AT_LINE (683)) COMMA_SOURCE_FILE_AT_LINE (683)) ;
          enumerator_40878.gotoNextObject () ;
        }
        //-------- @errorInstructionForGeneration
        //--- @ifExpressionForGeneration
  ...
  if (kBoolTrue == test_14) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_41898 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_41930 (var_readerFormalArgumentTypeList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_41898.hasCurrentObject () && enumerator_41930.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_exp ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_41898.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (702)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_41930.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (703)), enumerator_41898.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (703)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_constructorEffectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (704)) ;
      enumerator_41898.gotoNextObject () ;
...
static void categoryMethod_optionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_45694 (var_boolOptionMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_45694.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_45694.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (803)) COMMA_SOURCE_FILE_AT_LINE (803)).operator_concat (GALGAS_string ("' @bool option;") COMMA_SOURCE_FILE_AT_LINE (803)) COMMA_SOURCE_FILE_AT_LINE (803)) ;
      enumerator_45694.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_45790 (var_uintOptionMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_45790.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_45790.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (806)) COMMA_SOURCE_FILE_AT_LINE (806)).operator_concat (GALGAS_string ("' @uint option;") COMMA_SOURCE_FILE_AT_LINE (806)) COMMA_SOURCE_FILE_AT_LINE (806)) ;
      enumerator_45790.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_45888 (var_stringOptionMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_45888.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_45888.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (809)) COMMA_SOURCE_FILE_AT_LINE (809)).operator_concat (GALGAS_string ("' @string option;") COMMA_SOURCE_FILE_AT_LINE (809)) COMMA_SOURCE_FILE_AT_LINE (809)) ;
      enumerator_45888.gotoNextObject () ;
    }
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_unifiedTypeMapProxyList enumerator_76317 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_semanticExpressionListAST enumerator_76333 (object->mAttribute_mExpressions, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_76317.hasCurrentObject () && enumerator_76333.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_expression ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_76333.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1625)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_76317.current_mType (HERE), var_expression.reader_mType (SOURCE_FILE_AT_LINE (1626)), enumerator_76333.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1626)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_semanticExpressionListForGeneration.addAssign_operation (var_expression COMMA_SOURCE_FILE_AT_LINE (1627)) ;
      enumerator_76317.gotoNextObject () ;
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_77933_23 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_77933_22 ; // Joker input parameter
  GALGAS_typeKindEnum joker_77933_21 ; // Joker input parameter
  GALGAS_typedAttributeList joker_77933_20 ; // Joker input parameter
  GALGAS_attributeMap joker_77933_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_77933_18 ; // Joker input parameter
  GALGAS_constructorMap joker_77933_17 ; // Joker input parameter
  GALGAS_readerMap joker_77933_16 ; // Joker input parameter
  GALGAS_modifierMap joker_77933_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_77933_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_77933_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_77933_12 ; // Joker input parameter
  GALGAS_stringlist joker_77933_11 ; // Joker input parameter
  GALGAS_uint joker_77933_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_77933_9 ; // Joker input parameter
  GALGAS_stringset joker_77933_8 ; // Joker input parameter
  GALGAS_lstringlist joker_77933_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_77933_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_77933_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_77933_4 ; // Joker input parameter
  GALGAS_bool joker_77933_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_77933_2 ; // Joker input parameter
  GALGAS_string joker_77933_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_77933_23, joker_77933_22, joker_77933_21, joker_77933_20, joker_77933_19, joker_77933_18, joker_77933_17, joker_77933_16, joker_77933_15, joker_77933_14, joker_77933_13, joker_77933_12, joker_77933_11, joker_77933_10, joker_77933_9, joker_77933_8, joker_77933_7, joker_77933_6, joker_77933_5, joker_77933_4, joker_77933_3, joker_77933_2, joker_77933_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1665)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1691)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1691)).isValid ()) {
      PMUInt32 variant_79060 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1691)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1691)).uintValue () ;
      bool loop_79060 = true ;
      while (loop_79060) {
        loop_79060 = var_found.operator_not (SOURCE_FILE_AT_LINE (1692)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1692)).reader_isNull (SOURCE_FILE_AT_LINE (1692)).operator_not (SOURCE_FILE_AT_LINE (1692)) COMMA_SOURCE_FILE_AT_LINE (1692)).isValid () ;
        if (loop_79060) {
          loop_79060 = var_found.operator_not (SOURCE_FILE_AT_LINE (1692)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1692)).reader_isNull (SOURCE_FILE_AT_LINE (1692)).operator_not (SOURCE_FILE_AT_LINE (1692)) COMMA_SOURCE_FILE_AT_LINE (1692)).boolValue () ;
        }
        if (loop_79060 && (0 == variant_79060)) {
          loop_79060 = false ;
  ...
  if (kBoolTrue == test_4) {
    ...
    //-------- @readOnlyWithInstructionForGeneration
    const cMapElement_readerMap * objectArray_80213 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (GALGAS_string ("location")) ;
    if (NULL != objectArray_80213) {
        macroValidSharedObject (objectArray_80213, const cMapElement_readerMap) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, objectArray_80213->mAttribute_mArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (1713)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_5) {
        //-------- @errorInstructionForGeneration
        ...
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, objectArray_80213->mAttribute_mReturnedType.objectCompare (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType)).boolEnum () ;
        if (kBoolTrue == test_6) {
          //-------- @errorInstructionForGeneration
          inCompiler->emitSemanticError (object->mAttribute_mEndOfErrorLocationExpression, GALGAS_string ("the error location expression type is '@").operator_concat (var_errorLocationExpression.reader_mType (SOURCE_FILE_AT_LINE (1720)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1720)) COMMA_SOURCE_FILE_AT_LINE (1720)).operator_concat (GALGAS_string ("' and defines a 'location' reader that returns an '@") COMMA_SOURCE_FILE_AT_LINE (1721)).operator_concat (objectArray_80213->mAttribute_mReturnedType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1721)) COMMA_SOURCE_FILE_AT_LINE (1721)).operator_concat (GALGAS_string ("' object; it should be either of the '@location' type, either defines a 'location' reader without argument that returns an '@location' object") COMMA_SOURCE_FILE_AT_LINE (1722)) COMMA_SOURCE_FILE_AT_LINE (1719)) ;
        }
      }
      //-------- @assignmentInstructionForGeneration
      var_errorLocationExpression = GALGAS_readerCallExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mLocationType, object->mAttribute_mEndOfErrorLocationExpression, objectArray_80213->mAttribute_mKind, var_errorLocationExpression, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1730)), GALGAS_string ("location"), GALGAS_semanticExpressionListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1732)), objectArray_80213->mAttribute_mHasCompilerArgument COMMA_SOURCE_FILE_AT_LINE (1725)) ;
    }else{
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstringlist joker_82833_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_82836_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_82839_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_82842_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_82833_0, joker_82836_0, joker_82839_0, joker_82842_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1772)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_83593_0 ; // Joker input parameter
  GALGAS_lstringlist joker_83596_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_83599_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_83602_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_83593_0, joker_83596_0, joker_83599_0, joker_83602_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1791)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_83765_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_83765_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1794)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticExpressionListAST enumerator_84352 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_84373 (var_templateSignature, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_84352.hasCurrentObject () && enumerator_84373.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_semanticExpressionForGeneration var_exp ;
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_84352.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (1807)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @routineCallInstructionForGeneration
      routine_checkAssignmentTypes (enumerator_84373.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (1808)), enumerator_84352.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1808)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_effectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (1809)) ;
      enumerator_84352.gotoNextObject () ;
      enumerator_84373.gotoNextObject () ;
    }
  }
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_lstring joker_85901_0 ; // Joker input parameter
  GALGAS_lstringlist joker_85908_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_85968_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_85901_0, joker_85908_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_85968_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1843)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_builtPath = GALGAS_string::makeEmptyString () ;
  //-------- @loopInstructionForGeneration
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1853)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1853)).isValid ()) {
    PMUInt32 variant_86032 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1853)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1853)).uintValue () ;
    bool loop_86032 = true ;
    while (loop_86032) {
      loop_86032 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1854)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_86032) {
        loop_86032 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1854)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_86032 && (0 == variant_86032)) {
        loop_86032 = false ;
      ...
      if (loop_86032) {
        ...
        { //-------- @modifierCallInstructionForGeneration
        var_directoryList.modifier_popFirst (var_directoryName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1856)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @concatInstructionForGeneration
        var_builtPath.dotAssign_operation (var_directoryName.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1857)) COMMA_SOURCE_FILE_AT_LINE (1857)) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_4 = var_filewrapperDirectoryMap.reader_hasKey (var_directoryName COMMA_SOURCE_FILE_AT_LINE (1858)).boolEnum () ;
        if (kBoolTrue == test_4) {
          //-------- @methodCallInstructionForGeneration
          GALGAS_uint joker_86437_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1860)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_86437_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1859)) ;
          //-------- END @methodCallInstructionForGeneration
        }else if (kBoolFalse == test_4) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("the '").operator_concat (var_builtPath COMMA_SOURCE_FILE_AT_LINE (1866)).operator_concat (GALGAS_string ("' path does not exists for the '") COMMA_SOURCE_FILE_AT_LINE (1866)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1866)) COMMA_SOURCE_FILE_AT_LINE (1866)).operator_concat (GALGAS_string ("' filewrapper") COMMA_SOURCE_FILE_AT_LINE (1866)) COMMA_SOURCE_FILE_AT_LINE (1866)) ;
          var_filewrapperFileMap.drop () ; // Release error dropped variable
          //-------- @assignmentInstructionForGeneration
          var_directoryList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1867)) ;
        }
      }
    }
  }
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_6 = var_filewrapperFileMap.reader_hasKey (var_fileName COMMA_SOURCE_FILE_AT_LINE (1872)).boolEnum () ;
  if (kBoolTrue == test_6) {
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_86857_0 ; // Joker input parameter
    GALGAS_uint joker_86872_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1873)), joker_86857_0, var_isTextFile, joker_86872_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1873)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_6) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_7 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_7, GALGAS_string ("the '").operator_concat (var_fileName COMMA_SOURCE_FILE_AT_LINE (1876)).operator_concat (GALGAS_string ("' file does not exist in the '") COMMA_SOURCE_FILE_AT_LINE (1876)).operator_concat (var_builtPath COMMA_SOURCE_FILE_AT_LINE (1876)).operator_concat (GALGAS_string ("' directory of '") COMMA_SOURCE_FILE_AT_LINE (1876)).operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1876)) COMMA_SOURCE_FILE_AT_LINE (1876)).operator_concat (GALGAS_string ("' filewrapper") COMMA_SOURCE_FILE_AT_LINE (1876)) COMMA_SOURCE_FILE_AT_LINE (1875)) ;
  ...
  if (kBoolTrue == test_9) {
    ...
    temp_8 = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("data"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1884)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1884)) ;
  }
  outArgument_outExpression = GALGAS_filewrapperStaticPathInExpressionForGeneration::constructor_new (temp_8, object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (1886)), object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (1887)), var_fileIndex, var_isTextFile COMMA_SOURCE_FILE_AT_LINE (1881)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_lexiqueIntrospectionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mLexiqueComponentMapForSemanticAnalysis.method_searchKey (object->mAttribute_mLexiqueComponentName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1901)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("unknown reader") COMMA_SOURCE_FILE_AT_LINE (1906)) ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outExpression = GALGAS_lexiqueIntrospectionForGeneration::constructor_new (GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_string ("stringlist").reader_nowhere (SOURCE_FILE_AT_LINE (1910)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1910)), object->mAttribute_mLexiqueComponentName.mAttribute_location, object->mAttribute_mLexiqueComponentName.mAttribute_string, object->mAttribute_mLexiqueReaderName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1909)) ;
}
//---------------------------------------------------------------------------*
