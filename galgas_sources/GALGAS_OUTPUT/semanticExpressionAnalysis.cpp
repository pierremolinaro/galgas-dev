...
void routine_checkAssignmentTypes (const GALGAS_unifiedTypeMapProxy constinArgument_inTargetType,
  ...
  if (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (343)).isValid ()) {
    PMUInt32 variant_27268 = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (343)).uintValue () ;
    bool loop_27268 = true ;
    while (loop_27268) {
      loop_27268 = var_ok.operator_not (SOURCE_FILE_AT_LINE (343)).operator_and (var_sourceType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (343)).reader_isNull (SOURCE_FILE_AT_LINE (343)).operator_not (SOURCE_FILE_AT_LINE (343)) COMMA_SOURCE_FILE_AT_LINE (343)).isValid () ;
      if (loop_27268) {
        loop_27268 = var_ok.operator_not (SOURCE_FILE_AT_LINE (343)).operator_and (var_sourceType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (343)).reader_isNull (SOURCE_FILE_AT_LINE (343)).operator_not (SOURCE_FILE_AT_LINE (343)) COMMA_SOURCE_FILE_AT_LINE (343)).boolValue () ;
      }
...
void routine_analyzeConstructorInvocation (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  const cMapElement_constructorMap * objectArray_35786 = (const cMapElement_constructorMap *) var_constructorMap.readAccessForWithInstruction_hasKey (constinArgument_inConstructorName.reader_string (SOURCE_FILE_AT_LINE (541))) ;
  if (NULL != objectArray_35786) {
      macroValidSharedObject (objectArray_35786, const cMapElement_constructorMap) ;
    var_constructorFormalArgumentTypeList = objectArray_35786->mAttribute_mArgumentTypeList ;
    outArgument_outHasCompilerArgument = objectArray_35786->mAttribute_mHasCompilerArgument ;
    outArgument_outReturnedType = objectArray_35786->mAttribute_mReturnedType ;
  }else{
    ...
    if (kBoolTrue == test_0) {
      ...
      cEnumerator_constructorMap enumerator_36294 (var_constructorMap, kEnumeration_up) ;
      while (enumerator_36294.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_36294.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (554)) COMMA_SOURCE_FILE_AT_LINE (554)) COMMA_SOURCE_FILE_AT_LINE (554)) ;
        cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_36362 (enumerator_36294.current_mArgumentTypeList (HERE), kEnumeration_up) ;
        while (enumerator_36362.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_36362.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (556)) COMMA_SOURCE_FILE_AT_LINE (556)) COMMA_SOURCE_FILE_AT_LINE (556)) ;
          enumerator_36362.gotoNextObject () ;
        }
        var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_36294.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (558)) COMMA_SOURCE_FILE_AT_LINE (558)) COMMA_SOURCE_FILE_AT_LINE (558)) ;
        enumerator_36294.gotoNextObject () ;
      }
  ...
  cEnumerator_semanticExpressionListAST enumerator_37456 (constinArgument_inConstuctorEffectiveParameterExpressions, kEnumeration_up) ;
  cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_37491 (var_constructorFormalArgumentTypeList, kEnumeration_up) ;
  while (enumerator_37456.hasCurrentObject () && enumerator_37491.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_exp ;
    callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_37456.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (578)) ;
    {
    routine_checkAssignmentTypes (enumerator_37491.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (579)), enumerator_37456.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (579)) ;
    }
    outArgument_outConstructorEffectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (580)) ;
    enumerator_37456.gotoNextObject () ;
...
GALGAS_string function_checkReaderImplementationInSuperClasses (const GALGAS_lstring & constinArgument_inReaderName,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_methodKind joker_44831_5 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_44831_4 ; // Joker input parameter
    GALGAS_location joker_44831_3 ; // Joker input parameter
    GALGAS_bool joker_44831_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_44831_1 ; // Joker input parameter
    GALGAS_string joker_44846_0 ; // Joker input parameter
    constinArgument_inSuperClass.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (764)).method_searchKey (constinArgument_inReaderName, joker_44831_5, joker_44831_4, joker_44831_3, joker_44831_2, joker_44831_1, var_qualifier, joker_44846_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (764)) ;
...
void routine_checkDiadicOperator (const GALGAS_unifiedTypeMapProxy constinArgument_inLeftType,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (869)).isValid ()) {
      PMUInt32 variant_48826 = GALGAS_uint::constructor_max (SOURCE_FILE_AT_LINE (869)).uintValue () ;
      bool loop_48826 = true ;
      while (loop_48826) {
        loop_48826 = var_ok.operator_not (SOURCE_FILE_AT_LINE (869)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (869)).reader_isNull (SOURCE_FILE_AT_LINE (869)).operator_not (SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)).isValid () ;
        if (loop_48826) {
          loop_48826 = var_ok.operator_not (SOURCE_FILE_AT_LINE (869)).operator_and (var_rightType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (869)).reader_isNull (SOURCE_FILE_AT_LINE (869)).operator_not (SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)).boolValue () ;
        }
        if (loop_48826 && (0 == variant_48826)) {
          loop_48826 = false ;
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        GALGAS_location joker_49405_0 ; // Joker input parameter
        GALGAS_methodQualifier joker_49473_2 ; // Joker input parameter
        GALGAS_string joker_49473_1 ; // Joker input parameter
        constinArgument_inRightType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (880)).method_searchKey (constinArgument_inLeftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (881)), var_kind, var_argumentTypeList, joker_49405_0, var_hasCompilerArgument, var_returnedType, joker_49473_2, joker_49473_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (880)) ;
...
static void categoryMethod_literalStringExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
  cEnumerator_stringlist enumerator_32556 (object->mAttribute_mStringSequence, kEnumeration_up) ;
  while (enumerator_32556.hasCurrentObject ()) {
    var_s.dotAssign_operation (enumerator_32556.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (468)) ;
...
static void categoryMethod_readerCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  const cMapElement_readerMap * objectArray_40357 = (const cMapElement_readerMap *) var_readerMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (657))) ;
  if (NULL != objectArray_40357) {
      macroValidSharedObject (objectArray_40357, const cMapElement_readerMap) ;
    var_readerFormalArgumentTypeList = objectArray_40357->mAttribute_mArgumentTypeList ;
    var_hasCompilerArgument = objectArray_40357->mAttribute_mHasCompilerArgument ;
    var_returnedType = objectArray_40357->mAttribute_mReturnedType ;
    var_kind = objectArray_40357->mAttribute_mKind ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, objectArray_40357->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, objectArray_40357->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (663)) ;
    }
  }else{
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_typedAttributeList enumerator_41044 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (672)), kEnumeration_up) ;
      while (enumerator_41044.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_attributeType = GALGAS_unifiedTypeMapProxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (enumerator_41044.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (673)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (673)), inCompiler COMMA_SOURCE_FILE_AT_LINE (673)) ;
        GALGAS_readerMap var_aMap = var_attributeType.reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (674)) ;
        const cMapElement_readerMap * objectArray_41281 = (const cMapElement_readerMap *) var_aMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (675))) ;
        if (NULL != objectArray_41281) {
            macroValidSharedObject (objectArray_41281, const cMapElement_readerMap) ;
          var_matchingReaderCount.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (676)) ;
          var_readerFormalArgumentTypeList = objectArray_41281->mAttribute_mArgumentTypeList ;
          var_hasCompilerArgument = objectArray_41281->mAttribute_mHasCompilerArgument ;
          var_returnedType = objectArray_41281->mAttribute_mReturnedType ;
          var_kind = objectArray_41281->mAttribute_mKind ;
          var_fieldList.addAssign_operation (enumerator_41044.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (681)) COMMA_SOURCE_FILE_AT_LINE (681)) ;
          const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, objectArray_41281->mAttribute_mErrorMessage.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_location location_4 (object->mAttribute_mReaderName.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_4, objectArray_41281->mAttribute_mErrorMessage COMMA_SOURCE_FILE_AT_LINE (683)) ;
          }
        }
        enumerator_41044.gotoNextObject () ;
      }
      ...
      if (kBoolTrue == test_5) {
        ...
        if (kBoolTrue == test_7) {
          GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
          cEnumerator_stringlist enumerator_42139 (var_fieldList, kEnumeration_up) ;
          while (enumerator_42139.hasCurrentObject ()) {
            var_s.dotAssign_operation (enumerator_42139.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (696)) ;
            if (enumerator_42139.hasNextObject ()) {
              var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (697)) ;
            }
            enumerator_42139.gotoNextObject () ;
          }
      ...
      if (kBoolTrue == test_9) {
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_readerMap enumerator_42837 (var_readerMap, kEnumeration_up) ;
        while (enumerator_42837.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_42837.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (713)) COMMA_SOURCE_FILE_AT_LINE (713)) COMMA_SOURCE_FILE_AT_LINE (713)) ;
          cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_42905 (enumerator_42837.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          while (enumerator_42905.hasCurrentObject ()) {
            var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_42905.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (715)) COMMA_SOURCE_FILE_AT_LINE (715)) COMMA_SOURCE_FILE_AT_LINE (715)) ;
            enumerator_42905.gotoNextObject () ;
          }
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_42837.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (717)) COMMA_SOURCE_FILE_AT_LINE (717)) COMMA_SOURCE_FILE_AT_LINE (717)) ;
          enumerator_42837.gotoNextObject () ;
        }
        //--- @ifExpressionForGeneration
  ...
  if (kBoolTrue == test_14) {
    ...
    cEnumerator_semanticExpressionListAST enumerator_43859 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_43889 (var_readerFormalArgumentTypeList, kEnumeration_up) ;
    while (enumerator_43859.hasCurrentObject () && enumerator_43889.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_43859.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (736)) ;
      {
      routine_checkAssignmentTypes (enumerator_43889.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (737)), enumerator_43859.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (737)) ;
      }
      var_constructorEffectiveParameterList.addAssign_operation (var_exp COMMA_SOURCE_FILE_AT_LINE (738)) ;
      enumerator_43859.gotoNextObject () ;
      enumerator_43889.gotoNextObject () ;
    }
...
static void categoryMethod_optionExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_commandLineOptionMap enumerator_47653 (var_boolOptionMap, kEnumeration_up) ;
    while (enumerator_47653.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47653.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (837)) COMMA_SOURCE_FILE_AT_LINE (837)).operator_concat (GALGAS_string ("' @bool option;") COMMA_SOURCE_FILE_AT_LINE (837)) COMMA_SOURCE_FILE_AT_LINE (837)) ;
      enumerator_47653.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_47749 (var_uintOptionMap, kEnumeration_up) ;
    while (enumerator_47749.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47749.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (840)).operator_concat (GALGAS_string ("' @uint option;") COMMA_SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (840)) ;
      enumerator_47749.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_47847 (var_stringOptionMap, kEnumeration_up) ;
    while (enumerator_47847.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_47847.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (843)) COMMA_SOURCE_FILE_AT_LINE (843)).operator_concat (GALGAS_string ("' @string option;") COMMA_SOURCE_FILE_AT_LINE (843)) COMMA_SOURCE_FILE_AT_LINE (843)) ;
...
static void categoryMethod_functionCallExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_unifiedTypeMapProxyList enumerator_78265 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_semanticExpressionListAST enumerator_78279 (object->mAttribute_mExpressions, kEnumeration_up) ;
    while (enumerator_78265.hasCurrentObject () && enumerator_78279.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_expression ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_78279.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1658)) ;
      {
      routine_checkAssignmentTypes (enumerator_78265.current_mType (HERE), var_expression.reader_mType (SOURCE_FILE_AT_LINE (1659)), enumerator_78279.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1659)) ;
      }
      ...
      enumerator_78279.gotoNextObject () ;
    }
...
static void categoryMethod_literalTypeInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_bool joker_79880_23 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_79880_22 ; // Joker input parameter
  GALGAS_typeKindEnum joker_79880_21 ; // Joker input parameter
  GALGAS_typedAttributeList joker_79880_20 ; // Joker input parameter
  GALGAS_attributeMap joker_79880_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_79880_18 ; // Joker input parameter
  GALGAS_constructorMap joker_79880_17 ; // Joker input parameter
  GALGAS_readerMap joker_79880_16 ; // Joker input parameter
  GALGAS_modifierMap joker_79880_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_79880_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_79880_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_79880_12 ; // Joker input parameter
  GALGAS_stringlist joker_79880_11 ; // Joker input parameter
  GALGAS_uint joker_79880_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_79880_9 ; // Joker input parameter
  GALGAS_stringset joker_79880_8 ; // Joker input parameter
  GALGAS_lstringlist joker_79880_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_79880_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_79880_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_79880_4 ; // Joker input parameter
  GALGAS_bool joker_79880_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_79880_2 ; // Joker input parameter
  GALGAS_string joker_79880_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mLiteralTypeName, joker_79880_23, joker_79880_22, joker_79880_21, joker_79880_20, joker_79880_19, joker_79880_18, joker_79880_17, joker_79880_16, joker_79880_15, joker_79880_14, joker_79880_13, joker_79880_12, joker_79880_11, joker_79880_10, joker_79880_9, joker_79880_8, joker_79880_7, joker_79880_6, joker_79880_5, joker_79880_4, joker_79880_3, joker_79880_2, joker_79880_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1698)) ;
...
static void categoryMethod_testDynamicClassInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1724)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1724)).isValid ()) {
      PMUInt32 variant_80999 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1724)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1724)).uintValue () ;
      bool loop_80999 = true ;
      while (loop_80999) {
        loop_80999 = var_found.operator_not (SOURCE_FILE_AT_LINE (1725)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1725)).reader_isNull (SOURCE_FILE_AT_LINE (1725)).operator_not (SOURCE_FILE_AT_LINE (1725)) COMMA_SOURCE_FILE_AT_LINE (1725)).isValid () ;
        if (loop_80999) {
          loop_80999 = var_found.operator_not (SOURCE_FILE_AT_LINE (1725)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1725)).reader_isNull (SOURCE_FILE_AT_LINE (1725)).operator_not (SOURCE_FILE_AT_LINE (1725)) COMMA_SOURCE_FILE_AT_LINE (1725)).boolValue () ;
        }
        if (loop_80999 && (0 == variant_80999)) {
          loop_80999 = false ;
...
static void categoryMethod_castInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1771)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1771)).isValid ()) {
      PMUInt32 variant_82648 = constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.reader_count (SOURCE_FILE_AT_LINE (1771)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1771)).uintValue () ;
      bool loop_82648 = true ;
      while (loop_82648) {
        loop_82648 = var_found.operator_not (SOURCE_FILE_AT_LINE (1772)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1772)).reader_isNull (SOURCE_FILE_AT_LINE (1772)).operator_not (SOURCE_FILE_AT_LINE (1772)) COMMA_SOURCE_FILE_AT_LINE (1772)).isValid () ;
        if (loop_82648) {
          loop_82648 = var_found.operator_not (SOURCE_FILE_AT_LINE (1772)).operator_and (var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE_AT_LINE (1772)).reader_isNull (SOURCE_FILE_AT_LINE (1772)).operator_not (SOURCE_FILE_AT_LINE (1772)) COMMA_SOURCE_FILE_AT_LINE (1772)).boolValue () ;
        }
        if (loop_82648 && (0 == variant_82648)) {
          loop_82648 = false ;
...
static void categoryMethod_filewrapperObjectInstanciationInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstringlist joker_84329_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_84332_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_84335_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_84338_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, var_filewrapperPath, joker_84329_0, joker_84332_0, joker_84335_0, joker_84338_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1818)) ;
...
static void categoryMethod_filewrapperTemplateInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_85089_0 ; // Joker input parameter
  GALGAS_lstringlist joker_85092_0 ; // Joker input parameter
  GALGAS_wrapperFileMap joker_85095_0 ; // Joker input parameter
  GALGAS_wrapperDirectoryMap joker_85098_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_85089_0, joker_85092_0, joker_85095_0, joker_85098_0, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1837)) ;
  GALGAS_unifiedTypeMapProxyList var_templateSignature ;
  GALGAS_lstring joker_85261_0 ; // Joker input parameter
  var_filewrapperTemplateMap.method_searchKey (object->mAttribute_mFilewrapperTemplateName, var_templateSignature, joker_85261_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1840)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_semanticExpressionListAST enumerator_85848 (object->mAttribute_mExpressions, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_85867 (var_templateSignature, kEnumeration_up) ;
    while (enumerator_85848.hasCurrentObject () && enumerator_85867.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_analyzeSemanticExpression ((const cPtr_semanticExpressionAST *) enumerator_85848.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioVariableMap, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (1853)) ;
      {
      routine_checkAssignmentTypes (enumerator_85867.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (1854)), enumerator_85848.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1854)) ;
      }
...
static void categoryMethod_filewrapperInExpressionAST_analyzeSemanticExpression (const cPtr_semanticExpressionAST * inObject,
  ...
  GALGAS_lstring joker_87397_0 ; // Joker input parameter
  GALGAS_lstringlist joker_87404_0 ; // Joker input parameter
  GALGAS_filewrapperTemplateMap joker_87464_0 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mFilewrapperMap.method_searchKey (object->mAttribute_mFilewrapperName, joker_87397_0, joker_87404_0, var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87464_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1889)) ;
  ...
  if (var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1899)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1899)).isValid ()) {
    PMUInt32 variant_87527 = var_filewrapperDirectoryMap.reader_count (SOURCE_FILE_AT_LINE (1899)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1899)).uintValue () ;
    bool loop_87527 = true ;
    while (loop_87527) {
      loop_87527 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1900)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_87527) {
        loop_87527 = GALGAS_bool (kIsStrictSup, var_directoryList.reader_length (SOURCE_FILE_AT_LINE (1900)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_87527 && (0 == variant_87527)) {
        loop_87527 = false ;
      ...
      if (loop_87527) {
        ...
        if (kBoolTrue == test_4) {
          GALGAS_uint joker_87935_0 ; // Joker input parameter
          var_filewrapperDirectoryMap.method_searchKey (GALGAS_lstring::constructor_new (var_directoryName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1906)), var_filewrapperFileMap, var_filewrapperDirectoryMap, joker_87935_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1905)) ;
        }else if (kBoolFalse == test_4) {
  ...
  if (kBoolTrue == test_6) {
    GALGAS_string joker_88355_0 ; // Joker input parameter
    GALGAS_uint joker_88370_0 ; // Joker input parameter
    var_filewrapperFileMap.method_searchKey (GALGAS_lstring::constructor_new (var_fileName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1919)), joker_88355_0, var_isTextFile, joker_88370_0, var_fileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1919)) ;
  }else if (kBoolFalse == test_6) {
