...
void routine_compileLexiqueComponent (C_Compiler & _inLexique,
  ...
  var_cas_lexicalAttributeMap = GGS_lexicalAttributeMap ::constructor_emptyMap (_inLexique COMMA_HERE) ;
  {
    ...
    while (((operand_2418 = (GGS_lexicalAttributeList::cElement *) enumerator_2418.nextObject ()))) {
      ...
      if ((var_cas_allowedLexicalTypeNameSet.reader_hasKey (_inLexique, operand_2418->mTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (46)) COMMA_SOURCE_FILE_AT_LINE (46))).isBuiltAndTrue ()) {
        ...
        {
          GGS_stringset::cEnumerator enumerator_2812 (var_cas_allowedLexicalTypeNameSet, true) ;
          const GGS_stringset::cElement * operand_2812 = (GGS_stringset::cElement *) enumerator_2812.nextObject () ;
          if ((operand_2812 != NULL)) {
            bool _foreach_loop_2812 ;
            do{
              macroValidPointer (operand_2812) ;
              var_cas_m.writeString (" @") ;
              var_cas_m._dotAssign_operation (operand_2812->mKey) ;
              operand_2812 = enumerator_2812.nextObject () ;
              _foreach_loop_2812 = ((operand_2812 != NULL)) ;
              if (_foreach_loop_2812) {
                var_cas_m.writeString (",") ;
              }
            }while (_foreach_loop_2812) ;
          }
        }
  ...
  {
    GGS_terminalDeclarationList::cEnumerator enumerator_3082 (var_cas_lexiqueComponentRoot.reader_mTerminalDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (63)), true) ;
    const GGS_terminalDeclarationList::cElement * operand_3082 = NULL ;
    while (((operand_3082 = (GGS_terminalDeclarationList::cElement *) enumerator_3082.nextObject ()))) {
      ...
      {
        GGS_lstringlist::cEnumerator enumerator_3244 (operand_3082->mSentAttributeList, true) ;
        const GGS_lstringlist::cElement * operand_3244 = NULL ;
        while (((operand_3244 = (GGS_lstringlist::cElement *) enumerator_3244.nextObject ()))) {
          macroValidPointer (operand_3244) ;
          GGS_string var_cas_attributeTypeName ;
          const GGS_lexicalAttributeMap  _temp_3353 = var_cas_lexicalAttributeMap ;
          if (_temp_3353._isBuilt ()) {
            _temp_3353 (HERE)->method_searchKey (_inLexique, operand_3244->mValue, var_cas_attributeTypeName COMMA_SOURCE_FILE_AT_LINE (67)) ;
          }
          var_cas_argumentTypeList._addAssign_operation (var_cas_attributeTypeName) ;
        }
      }
      var_cas_terminalMap.modifier_insertKey (_inLexique, operand_3082->mName, var_cas_argumentTypeList COMMA_SOURCE_FILE_AT_LINE (70)) ;
    }
  }
  {
    GGS_lexicalListDeclarationList::cEnumerator enumerator_3549 (var_cas_lexiqueComponentRoot.reader_mLexicalListDeclarationList (_inLexique COMMA_SOURCE_FILE_AT_LINE (72)), true) ;
    const GGS_lexicalListDeclarationList::cElement * operand_3549 = NULL ;
    while (((operand_3549 = (GGS_lexicalListDeclarationList::cElement *) enumerator_3549.nextObject ()))) {
      macroValidPointer (operand_3549) ;
      GGS_stringlist  var_cas_argumentTypeList ;
      var_cas_argumentTypeList = GGS_stringlist ::constructor_emptyList (_inLexique COMMA_HERE) ;
      {
        GGS_lstringlist::cEnumerator enumerator_3732 (operand_3549->mSentAttributeList, true) ;
        const GGS_lstringlist::cElement * operand_3732 = NULL ;
        while (((operand_3732 = (GGS_lstringlist::cElement *) enumerator_3732.nextObject ()))) {
          macroValidPointer (operand_3732) ;
          GGS_string var_cas_attributeTypeName ;
          const GGS_lexicalAttributeMap  _temp_3841 = var_cas_lexicalAttributeMap ;
          if (_temp_3841._isBuilt ()) {
            _temp_3841 (HERE)->method_searchKey (_inLexique, operand_3732->mValue, var_cas_attributeTypeName COMMA_SOURCE_FILE_AT_LINE (76)) ;
          }
          var_cas_argumentTypeList._addAssign_operation (var_cas_attributeTypeName) ;
        }
      }
      {
        GGS_lexicalListEntryList::cEnumerator enumerator_3966 (operand_3549->mEntryList, true) ;
        const GGS_lexicalListEntryList::cElement * operand_3966 = NULL ;
        while (((operand_3966 = (GGS_lexicalListEntryList::cElement *) enumerator_3966.nextObject ()))) {
          macroValidPointer (operand_3966) ;
          var_cas_terminalMap.modifier_insertKey (_inLexique, operand_3966->mTerminalSpelling, var_cas_argumentTypeList COMMA_SOURCE_FILE_AT_LINE (80)) ;
        }
      }
    }
  }
