...
void routine_programRule_5F__37_ (const GALGAS_lstring constinArgument_inProjectSourceFile,
  ...
  cEnumerator_qualifiedFeatureList enumerator_8733 (var_projectComponentAST.mAttribute_mQualifiedFeatureList, kEnumeration_up) ;
  while (enumerator_8733.hasCurrentObject ()) {
    {
    var_projectQualifiedFeatureMap.modifier_insertKey (enumerator_8733.current_mFeatureName (HERE), enumerator_8733.current_mFeatureValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (207)) ;
    }
  ...
  cEnumerator_projectSourceList enumerator_9329 (var_projectComponentAST.reader_mProjectSourceList (SOURCE_FILE_AT_LINE (223)), kEnumeration_up) ;
  while (enumerator_9329.hasCurrentObject ()) {
    GALGAS_string var_extension = enumerator_9329.current_mFilePath (HERE).mAttribute_string.reader_pathExtension (SOURCE_FILE_AT_LINE (224)) ;
    GALGAS_lstring var_componentName = GALGAS_lstring::constructor_new (enumerator_9329.current_mFilePath (HERE).mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (226)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (226)), enumerator_9329.current_mFilePath (HERE).reader_location (SOURCE_FILE_AT_LINE (227)) COMMA_SOURCE_FILE_AT_LINE (225)) ;
    GALGAS_lstring var_fullFilePath = GALGAS_lstring::constructor_new (constinArgument_inProjectSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (230)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (230)).operator_concat (enumerator_9329.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (230)) COMMA_SOURCE_FILE_AT_LINE (230)), enumerator_9329.current_mFilePath (HERE).reader_location (SOURCE_FILE_AT_LINE (231)) COMMA_SOURCE_FILE_AT_LINE (229)) ;
    if (enumerator_9329.current_mSourceKind (HERE).isValid ()) {
      switch (enumerator_9329.current_mSourceKind (HERE).enumValue ()) {
      ...
      case GALGAS_sourceFileKind::kEnum_guiSourceFile: {
        ...
        if (kBoolTrue == test_4) {
          ...
          GALGAS_location location_6 (enumerator_9329.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      case GALGAS_sourceFileKind::kEnum_lexiqueSourceFile: {
        ...
        if (kBoolTrue == test_7) {
          ...
          GALGAS_location location_9 (enumerator_9329.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      case GALGAS_sourceFileKind::kEnum_optionSourceFile: {
        ...
        if (kBoolTrue == test_10) {
          ...
          {
          cGrammar_optionLL_31_grammar::_performSourceFileParsing_ (inCompiler, var_fullFilePath, var_optionComponentAST COMMA_SOURCE_FILE_AT_LINE (263)) ;
          }
          ...
          GALGAS_location location_12 (enumerator_9329.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      case GALGAS_sourceFileKind::kEnum_semanticsSourceFile: {
        ...
        if (kBoolTrue == test_13) {
          ...
          GALGAS_location location_15 (enumerator_9329.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      case GALGAS_sourceFileKind::kEnum_syntaxSourceFile: {
        ...
        if (kBoolTrue == test_16) {
          ...
          GALGAS_location location_18 (enumerator_9329.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      case GALGAS_sourceFileKind::kEnum_grammarSourceFile: {
        ...
        if (kBoolTrue == test_19) {
          ...
          GALGAS_location location_21 (enumerator_9329.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      case GALGAS_sourceFileKind::kEnum_programSourceFile: {
        ...
        if (kBoolTrue == test_22) {
          ...
          GALGAS_location location_24 (enumerator_9329.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  if (kBoolTrue == test_25) {
    cEnumerator_parsedLexiqueComponentMap enumerator_14337 (var_parsedComponentStruct.mAttribute_mParsedLexiqueComponentMap, kEnumeration_up) ;
    while (enumerator_14337.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_26) {
        inCompiler->printMessage (GALGAS_string ("*** Compiling '").operator_concat (enumerator_14337.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (335)) COMMA_SOURCE_FILE_AT_LINE (335)).operator_concat (GALGAS_string (".gLexique'\n") COMMA_SOURCE_FILE_AT_LINE (335)) COMMA_SOURCE_FILE_AT_LINE (335)) ;
      }
      {
      routine_compileLexiqueComponentFromAST (enumerator_14337.current_lkey (HERE).mAttribute_string, var_outputDirectory, enumerator_14337.current_mLexiqueComponentAST (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (337)) ;
      }
      enumerator_14337.gotoNextObject () ;
    }
    cEnumerator_parsedGuiComponentMap enumerator_14680 (var_parsedComponentStruct.mAttribute_mParsedGuiComponentMap, kEnumeration_up) ;
    while (enumerator_14680.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_27) {
        inCompiler->printMessage (GALGAS_string ("*** Compiling '").operator_concat (enumerator_14680.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (346)) COMMA_SOURCE_FILE_AT_LINE (346)).operator_concat (GALGAS_string (".gGui'\n") COMMA_SOURCE_FILE_AT_LINE (346)) COMMA_SOURCE_FILE_AT_LINE (346)) ;
      }
      {
      routine_compileGuiComponentFromAST (enumerator_14680.current_mSourceFullFilePath (HERE), var_outputDirectory, enumerator_14680.current_mGuiComponentAST (HERE), var_parsedComponentStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (348)) ;
      }
      enumerator_14680.gotoNextObject () ;
    }
    cEnumerator_parsedOptionComponentMap enumerator_15056 (var_parsedComponentStruct.mAttribute_mParsedOptionComponentMap, kEnumeration_up) ;
    while (enumerator_15056.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_28) {
        inCompiler->printMessage (GALGAS_string ("*** Compiling '").operator_concat (enumerator_15056.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)).operator_concat (GALGAS_string (".gOption'\n") COMMA_SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)) ;
      }
      {
      routine_compileOptionComponentAST (var_outputDirectory, enumerator_15056.current_lkey (HERE), enumerator_15056.current_mBoolOptionMap (HERE), enumerator_15056.current_mUIntOptionMap (HERE), enumerator_15056.current_mStringOptionMap (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (360)) ;
      }
      enumerator_15056.gotoNextObject () ;
    }
    cEnumerator_parsedSemanticsComponentMap enumerator_15440 (var_parsedComponentStruct.mAttribute_mParsedSemanticsComponentMap, kEnumeration_up) ;
    while (enumerator_15440.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_29) {
        inCompiler->printMessage (GALGAS_string ("*** Compiling '").operator_concat (enumerator_15440.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (371)).operator_concat (GALGAS_string (".gSemantics'\n") COMMA_SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (371)) ;
      }
      {
      routine_compileSemanticsComponentAST (enumerator_15440.current_mSourceFullFilePath (HERE), var_outputDirectory, enumerator_15440.current_mSemanticComponentRoot (HERE), var_parsedComponentStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (373)) ;
      }
      enumerator_15440.gotoNextObject () ;
    }
    cEnumerator_parsedSyntaxComponentMap enumerator_15830 (var_parsedComponentStruct.mAttribute_mParsedSyntaxComponentMap, kEnumeration_up) ;
    while (enumerator_15830.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_30) {
        inCompiler->printMessage (GALGAS_string ("*** Compiling '").operator_concat (enumerator_15830.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (383)) COMMA_SOURCE_FILE_AT_LINE (383)).operator_concat (GALGAS_string (".gSyntax'\n") COMMA_SOURCE_FILE_AT_LINE (383)) COMMA_SOURCE_FILE_AT_LINE (383)) ;
      }
      {
      routine_compileSyntaxComponentFromAST (enumerator_15830.current_mSourceFullFilePath (HERE), var_outputDirectory, enumerator_15830.current_mSyntaxComponentRoot (HERE), var_parsedComponentStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (385)) ;
      }
      enumerator_15830.gotoNextObject () ;
    }
    cEnumerator_parsedGrammarComponentMap enumerator_16218 (var_parsedComponentStruct.mAttribute_mParsedGrammarComponentMap, kEnumeration_up) ;
    while (enumerator_16218.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_31) {
        inCompiler->printMessage (GALGAS_string ("*** Compiling '").operator_concat (enumerator_16218.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (395)) COMMA_SOURCE_FILE_AT_LINE (395)).operator_concat (GALGAS_string (".gGrammar'\n") COMMA_SOURCE_FILE_AT_LINE (395)) COMMA_SOURCE_FILE_AT_LINE (395)) ;
      }
      {
      routine_compileGrammarComponentFromAST (enumerator_16218.current_mSourceFullFilePath (HERE), var_outputDirectory, enumerator_16218.current_mGrammarComponentRoot (HERE), var_parsedComponentStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (397)) ;
      }
      enumerator_16218.gotoNextObject () ;
    }
    cEnumerator_parsedProgramComponentMap enumerator_16609 (var_parsedComponentStruct.mAttribute_mParsedProgramComponentMap, kEnumeration_up) ;
    while (enumerator_16609.hasCurrentObject ()) {
      cEnumerator_programRuleList enumerator_16662 (enumerator_16609.current_mProgramComponentAST (HERE).mAttribute_mProgramRules, kEnumeration_up) ;
      while (enumerator_16662.hasCurrentObject ()) {
        var_handledExtensionSet.addAssign_operation (enumerator_16662.current_mSourceFileExtension (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (407)) ;
      ...
      if (kBoolTrue == test_32) {
        inCompiler->printMessage (GALGAS_string ("*** Compiling '").operator_concat (enumerator_16609.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (410)) COMMA_SOURCE_FILE_AT_LINE (410)).operator_concat (GALGAS_string (".gProgram'\n") COMMA_SOURCE_FILE_AT_LINE (410)) COMMA_SOURCE_FILE_AT_LINE (410)) ;
      }
      {
      routine_compileProgramComponentFromAST (enumerator_16609.current_mSourceFullFilePath (HERE), var_outputDirectory, enumerator_16609.current_mProgramComponentAST (HERE), var_parsedComponentStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (412)) ;
      }
...
void routine_programRule_5F__38_ (const GALGAS_lstring constinArgument_inSourceFile,
                                  ...
                                  COMMA_UNUSED_LOCATION_ARGS) {
  {
  GALGAS_templateInstructionListAST joker_18546_0 ; // Joker input parameter
  cGrammar_templateGrammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, joker_18546_0 COMMA_SOURCE_FILE_AT_LINE (458)) ;
  }
}
