...
void routine_compileProject (const GALGAS_lstring constinArgument_inProjectSourceFile,
  ...
  if (kBoolTrue == test_8) {
    ...
    var_semanticDeclarationSortedListForGeneration = GALGAS_semanticDeclarationSortedListForGeneration::constructor_emptySortedList (SOURCE_FILE ("galgas_prgm.gProgram", 611)) ;
  }
  GALGAS_lexiqueComponentGenerationList var_lexiqueComponentGenerationList = GALGAS_lexiqueComponentGenerationList::constructor_emptyList (SOURCE_FILE ("galgas_prgm.gProgram", 614)) ;
  const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("galgas_prgm.gProgram", 615)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_9) {
    cEnumerator_galgas_33_LexiqueComponentListAST enumerator_27437 (var_declarationAST.mAttribute_mLexiqueComponentList, kEnumeration_up) ;
    while (enumerator_27437.hasCurrentObject ()) {
      {
      routine_compileLexiqueComponentGalgas_33_ (enumerator_27437.current (HERE), var_lexiqueComponentGenerationList, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 617)) ;
      }
      enumerator_27437.gotoNextObject () ;
    }
  }
  GALGAS_parsedSyntaxComponentMap var_parsedSyntaxComponentMap = GALGAS_parsedSyntaxComponentMap::constructor_emptyMap (SOURCE_FILE ("galgas_prgm.gProgram", 624)) ;
  GALGAS_syntaxListForGeneration var_syntaxListForGeneration = GALGAS_syntaxListForGeneration::constructor_emptyList (SOURCE_FILE ("galgas_prgm.gProgram", 625)) ;
  const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("galgas_prgm.gProgram", 626)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_10) {
    {
    routine_compileAllSyntaxComponentsGalgas_33_ (var_declarationAST.mAttribute_mSyntaxComponentList, var_semanticContext, var_parsedSyntaxComponentMap, var_syntaxListForGeneration, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 627)) ;
    }
  }
  GALGAS_grammarComponentGenerationList var_grammarGenerationList = GALGAS_grammarComponentGenerationList::constructor_emptyList (SOURCE_FILE ("galgas_prgm.gProgram", 635)) ;
  const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("galgas_prgm.gProgram", 636)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_11) {
    cEnumerator_galgas_33_GrammarComponentListAST enumerator_28229 (var_declarationAST.mAttribute_mGrammarComponentList, kEnumeration_up) ;
    while (enumerator_28229.hasCurrentObject ()) {
      {
      routine_compileGrammarComponentGalgas_33_ (var_productDirectory, enumerator_28229.current (HERE), var_parsedSyntaxComponentMap, var_semanticContext, var_grammarGenerationList, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 638)) ;
      }
...
void routine_projectGeneration (const GALGAS_string constinArgument_inProductDirectory,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (gOption_galgas_5F_builtin_5F_options_verbose_5F_output.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->printMessage (GALGAS_string ("*** Generating files\n")  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 709)) ;
  }
  GALGAS_stringlist var_toolCppFileList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas_prgm.gProgram", 711)) ;
  GALGAS_stringset var_allProductFileSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas_prgm.gProgram", 712)) ;
  {
  routine_generateProgramComponentGalgas_33_ (constinArgument_inProductDirectory, constinArgument_inProgramHeaderContents, constinArgument_inProgramCppContents, var_toolCppFileList, var_allProductFileSet, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 714)) ;
  }
  {
  routine_generateGrammarComponentGalgas_33_ (constinArgument_inProductDirectory, constinArgument_inGrammarGenerationList, var_toolCppFileList, var_allProductFileSet, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 722)) ;
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("galgas_prgm.gProgram", 729)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    routine_generateLexiqueComponentsGalgas_33_ (constinArgument_inProductDirectory, constinArgument_inLexiqueComponentGenerationList, var_toolCppFileList, var_appProductFileList, var_allProductFileSet, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 730)) ;
    }
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("galgas_prgm.gProgram", 739)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    cEnumerator_optionComponentMapForSemanticAnalysis enumerator_31866 (constinArgument_inSemanticContext.mAttribute_mOptionComponentMapForSemanticAnalysis, kEnumeration_up) ;
    while (enumerator_31866.hasCurrentObject ()) {
      const enumGalgasBool test_3 = enumerator_31866.current_mIsPredefined (HERE).operator_not (SOURCE_FILE ("galgas_prgm.gProgram", 741)).boolEnum () ;
      if (kBoolTrue == test_3) {
        {
        routine_generateOptionComponentGalgas_33_ (constinArgument_inProductDirectory, enumerator_31866.current_lkey (HERE).mAttribute_string, enumerator_31866.current_mBoolOptionMap (HERE), enumerator_31866.current_mUIntOptionMap (HERE), enumerator_31866.current_mStringOptionMap (HERE), var_toolCppFileList, var_appProductFileList, var_allProductFileSet, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 742)) ;
        }
      }
      enumerator_31866.gotoNextObject () ;
    }
  }
  const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, GALGAS_uint ((uint32_t) 0U).objectCompare (GALGAS_uint::constructor_errorCount (SOURCE_FILE ("galgas_prgm.gProgram", 756)))).boolEnum () ;
  if (kBoolTrue == test_4) {
    cEnumerator_syntaxListForGeneration enumerator_32353 (constinArgument_inSyntaxListForGeneration, kEnumeration_up) ;
    while (enumerator_32353.hasCurrentObject ()) {
      {
      routine_generateSyntaxComponentGalgas_33_ (constinArgument_inProductDirectory, enumerator_32353.current (HERE), constinArgument_inSemanticContext, var_toolCppFileList, var_allProductFileSet, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 758)) ;
      }
      enumerator_32353.gotoNextObject () ;
    }
  }
  {
  routine_generateSemanticDeclarationsGalgas_33_ (constinArgument_inProductDirectory, constinArgument_inSemanticContext, constinArgument_inSemanticDeclarationSortedListForGeneration, var_toolCppFileList, var_allProductFileSet, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 768)) ;
  }
  const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, GALGAS_uint ((uint32_t) 0U).objectCompare (GALGAS_uint::constructor_errorCount (SOURCE_FILE ("galgas_prgm.gProgram", 776)))).boolEnum () ;
  if (kBoolTrue == test_5) {
    GALGAS_stringset var_handledExtensionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas_prgm.gProgram", 777)) ;
    cEnumerator_programRuleList enumerator_32955 (constinArgument_inSourceRuleList, kEnumeration_up) ;
    while (enumerator_32955.hasCurrentObject ()) {
      var_handledExtensionSet.addAssign_operation (enumerator_32955.current_mSourceFileExtension (HERE).mAttribute_string  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 779)) ;
      enumerator_32955.gotoNextObject () ;
    }
    GALGAS_stringset var_ignoredFeatureSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas_prgm.gProgram", 782)) ;
    var_ignoredFeatureSet.addAssign_operation (GALGAS_string ("tool-source")  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 783)) ;
    var_ignoredFeatureSet.addAssign_operation (GALGAS_string ("tool-link")  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 784)) ;
    var_ignoredFeatureSet.addAssign_operation (GALGAS_string ("app-source")  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 785)) ;
    GALGAS_projectQualifiedFeatureMap var_projectQualifiedFeatureMap = GALGAS_projectQualifiedFeatureMap::constructor_emptyMap (SOURCE_FILE ("galgas_prgm.gProgram", 786)) ;
    cEnumerator_galgas_33_QualifiedFeatureList enumerator_33373 (constinArgument_inProjectComponentAST.mAttribute_mQualifiedFeatureList, kEnumeration_up) ;
    while (enumerator_33373.hasCurrentObject ()) {
      const enumGalgasBool test_6 = var_ignoredFeatureSet.reader_hasKey (enumerator_33373.current_mFeatureName (HERE).mAttribute_string COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 788)).operator_not (SOURCE_FILE ("galgas_prgm.gProgram", 788)).boolEnum () ;
      if (kBoolTrue == test_6) {
        {
        var_projectQualifiedFeatureMap.modifier_insertKey (enumerator_33373.current_mFeatureName (HERE), enumerator_33373.current_mFeatureValue (HERE), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 789)) ;
        }
      }
      enumerator_33373.gotoNextObject () ;
    }
    {
    routine_updateGalgas_33_Targets (constinArgument_inProjectSourceFile, constinArgument_inProjectComponentAST.mAttribute_mTargetName.mAttribute_string, constinArgument_inProjectComponentAST.mAttribute_mEndOfSourceFile, constinArgument_inProjectComponentAST.mAttribute_mMajorVersion.mAttribute_uint.reader_string (SOURCE_FILE ("galgas_prgm.gProgram", 799)).operator_concat (GALGAS_string (".")  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 799)).operator_concat (constinArgument_inProjectComponentAST.mAttribute_mMinorVersion.mAttribute_uint.reader_string (SOURCE_FILE ("galgas_prgm.gProgram", 799))  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 799)).operator_concat (GALGAS_string (".")  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 799)).operator_concat (constinArgument_inProjectComponentAST.mAttribute_mRevisionVersion.mAttribute_uint.reader_string (SOURCE_FILE ("galgas_prgm.gProgram", 799))  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 799)), var_projectQualifiedFeatureMap, constinArgument_inProjectComponentAST.mAttribute_mGenerationFeatureList, var_toolCppFileList, var_appProductFileList, constinArgument_inHandCodedSourceToolFileList, constinArgument_inHandCodedSourceDirectorySet, var_handledExtensionSet, constinArgument_inHandCodedLinkToolFileList, var_allProductFileSet, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 795)) ;
    }
  }
  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, GALGAS_uint ((uint32_t) 0U).objectCompare (GALGAS_uint::constructor_errorCount (SOURCE_FILE ("galgas_prgm.gProgram", 812)))).boolEnum () ;
  if (kBoolTrue == test_7) {
    GALGAS_stringset var_allActualFileSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("galgas_prgm.gProgram", 813)) ;
    cEnumerator_stringlist enumerator_34409 (constinArgument_inProductDirectory.reader_regularFiles (GALGAS_bool (false) COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 814)), kEnumeration_up) ;
    while (enumerator_34409.hasCurrentObject ()) {
      var_allActualFileSet.addAssign_operation (enumerator_34409.current_mValue (HERE)  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 815)) ;
      enumerator_34409.gotoNextObject () ;
    }
    GALGAS_stringset var_uselessFileSet = var_allActualFileSet.substract_operation (var_allProductFileSet, inCompiler COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 817)) ;
    cEnumerator_stringset enumerator_34560 (var_uselessFileSet, kEnumeration_up) ;
    while (enumerator_34560.hasCurrentObject ()) {
      {
      GALGAS_string::class_method_deleteFile (constinArgument_inProductDirectory.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 819)).operator_concat (enumerator_34560.current_key (HERE)  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 819)), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 819)) ;
      }
...
void routine_programRule_5F__31__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                      C_Compiler * inCompiler
                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_parentDirectory = constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas_prgm.gProgram", 835)).reader_stringByDeletingLastPathComponent (SOURCE_FILE ("galgas_prgm.gProgram", 835)) ;
  GALGAS_stringlist temp_0 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("galgas_prgm.gProgram", 836)) ;
  temp_0.addAssign_operation (GALGAS_string ("galgasProject")  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 836)) ;
  GALGAS_stringlist var_candidateProjectFiles = var_parentDirectory.reader_regularFilesWithExtensions (GALGAS_bool (false), temp_0 COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 836)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_candidateProjectFiles.reader_length (SOURCE_FILE ("galgas_prgm.gProgram", 837)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_location location_2 (constinArgument_inSourceFile.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("no project file in parent directory of source file")  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 838)) ;
  }else if (kBoolFalse == test_1) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_candidateProjectFiles.reader_length (SOURCE_FILE ("galgas_prgm.gProgram", 839)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_s = GALGAS_string ("several project files in source file parent directory:") ;
      cEnumerator_stringlist enumerator_35731 (var_candidateProjectFiles, kEnumeration_up) ;
      while (enumerator_35731.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").add_operation (enumerator_35731.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 842))  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 842)) ;
        enumerator_35731.gotoNextObject () ;
      }
      GALGAS_location location_4 (constinArgument_inSourceFile.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 844)) ;
    }else if (kBoolFalse == test_3) {
      GALGAS_string var_projectFilePath = var_parentDirectory.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 846)).add_operation (var_candidateProjectFiles.reader_mValueAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 846)), inCompiler COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 846)) ;
      {
      routine_compileProject (GALGAS_lstring::constructor_new (var_projectFilePath, constinArgument_inSourceFile.mAttribute_location  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 847)), constinArgument_inSourceFile.mAttribute_string, inCompiler  COMMA_SOURCE_FILE ("galgas_prgm.gProgram", 847)) ;
      }
    }
  }
}
