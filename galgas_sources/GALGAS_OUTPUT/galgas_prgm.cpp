...
GALGAS_table_2E_element cEnumerator_table::current (LOCATION_ARGS) const {
  const cMapElement_table * p = (const cMapElement_table *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_table) ;
  return GALGAS_table_2E_element (p->mAttribute_lkey, p->mAttribute_mAnAttribute) ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_table_2E_element ("table.element",
                                         NULL) ;

//-----------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_table_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_table_2E_element ;
}

//-----------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_table_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_table_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_table_2E_element GALGAS_table_2E_element::extractObject (const GALGAS_object & inObject,
                                                                C_Compiler * inCompiler
                                                                COMMA_LOCATION_ARGS) {
  GALGAS_table_2E_element result ;
  const GALGAS_table_2E_element * p = (const GALGAS_table_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_table_2E_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_table_2E_element::GALGAS_table_2E_element (void) :
mAttribute_lkey (),
...
GALGAS_table_2E_element::GALGAS_table_2E_element (const GALGAS_lstring & inOperand0,
...
GALGAS_table_2E_element GALGAS_table_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_table_2E_element (GALGAS_lstring::constructor_default (HERE),
                                  GALGAS_uint::constructor_default (HERE)) ;
}

//-----------------------------------------------------------------------------*

GALGAS_table_2E_element GALGAS_table_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                  const GALGAS_uint & inOperand1 
                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_table_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_table_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_table_2E_element::objectCompare (const GALGAS_table_2E_element & inOperand) const {
...
bool GALGAS_table_2E_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mAnAttribute.isValid () ;
}

//-----------------------------------------------------------------------------*

void GALGAS_table_2E_element::drop (void) {
...
void GALGAS_table_2E_element::description (C_String & ioString,
...
GALGAS_lstring GALGAS_table_2E_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//-----------------------------------------------------------------------------*

GALGAS_uint GALGAS_table_2E_element::reader_mAnAttribute (UNUSED_LOCATION_ARGS) const {
