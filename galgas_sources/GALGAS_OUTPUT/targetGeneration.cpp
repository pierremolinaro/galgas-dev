...
void routine_updateTargets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
  ...
  if (NULL != objectArray_10095) {
      macroValidSharedObject (objectArray_10095, const cMapElement_projectQualifiedFeatureMap) ;
  ...
  if (kBoolTrue == test_43) {
    ...
    if (NULL != objectArray_20166) {
        macroValidSharedObject (objectArray_20166, const cMapElement_projectQualifiedFeatureMap) ;
    ...
    if (NULL != objectArray_21431) {
        macroValidSharedObject (objectArray_21431, const cMapElement_projectQualifiedFeatureMap) ;
      ...
      if (NULL != objectArray_23181) {
          macroValidSharedObject (objectArray_23181, const cMapElement_projectQualifiedFeatureMap) ;
