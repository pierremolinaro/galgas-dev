...
void routine_generateXcodeProjectTarget (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (40)) ;
  }
  GGS_bool automatic_var_2020_0 ;
  const GGS_string temp_1982 = GGS_string (gWrapperFileContent_27_targetGenerationFileWrapper) ;
  if (temp_1982.isBuilt ()) {
    temp_1982 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/xcode-project/Info.plist")), automatic_var_2020_0 COMMA_SOURCE_FILE_AT_LINE (41)) ;
  }
  const GGS_string temp_2062 = (var_cas_dir).operator_concat (GGS_string ("/English.lproj")) ;
  if (temp_2062.isBuilt ()) {
    temp_2062 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (42)) ;
  }
  const GGS_string var_cas_InfoPlist_strings_path = (var_cas_dir).operator_concat (GGS_string ("/xcode-project/English.lproj/InfoPlist.strings")) ;
  const GGS_bool cond_2353 = (var_cas_InfoPlist_strings_path.reader_fileExists ()).operator_not () ;
  if (cond_2353.isBuiltAndTrue ()) {
    const GGS_string temp_2320 = GGS_string (gWrapperFileContent_29_targetGenerationFileWrapper) ;
    if (temp_2320.isBuilt ()) {
      temp_2320 (HERE)->method_writeToFile (inLexique, var_cas_InfoPlist_strings_path COMMA_SOURCE_FILE_AT_LINE (45)) ;
    }
  }
  const GGS_string var_cas_Credits_rtf_path = (var_cas_dir).operator_concat (GGS_string ("/xcode-project/English.lproj/Credits.rtf")) ;
  const GGS_bool cond_2616 = (var_cas_Credits_rtf_path.reader_fileExists ()).operator_not () ;
  if (cond_2616.isBuiltAndTrue ()) {
    const GGS_string temp_2589 = GGS_string (gWrapperFileContent_28_targetGenerationFileWrapper) ;
    if (temp_2589.isBuilt ()) {
      temp_2589 (HERE)->method_writeToFile (inLexique, var_cas_Credits_rtf_path COMMA_SOURCE_FILE_AT_LINE (49)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateMsysOnWin32Target (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (60)) ;
  }
  GGS_bool automatic_var_3040_0 ;
  const GGS_string temp_3017 = GGS_string (gWrapperFileContent_20_targetGenerationFileWrapper) ;
  if (temp_3017.isBuilt ()) {
    temp_3017 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.bat")), automatic_var_3040_0 COMMA_SOURCE_FILE_AT_LINE (61)) ;
  }
  GGS_bool automatic_var_3178_0 ;
  const GGS_string temp_3155 = GGS_string (gWrapperFileContent_21_targetGenerationFileWrapper) ;
  if (temp_3155.isBuilt ()) {
    temp_3155 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.bat")), automatic_var_3178_0 COMMA_SOURCE_FILE_AT_LINE (62)) ;
  }
  GGS_bool automatic_var_3320_0 ;
  const GGS_string temp_3295 = GGS_string (gWrapperFileContent_22_targetGenerationFileWrapper) ;
  if (temp_3295.isBuilt ()) {
    temp_3295 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/install.bat")), automatic_var_3320_0 COMMA_SOURCE_FILE_AT_LINE (63)) ;
  }
  GGS_bool automatic_var_3469_0 ;
  const GGS_string temp_3447 = template_filewrapper_targetGenerationFileWrapper_makefile_msys_on_win32_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_3447.isBuilt ()) {
    temp_3447 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_3469_0 COMMA_SOURCE_FILE_AT_LINE (64)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateMinGWOnMacOSXTarget (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (74)) ;
  }
  GGS_bool automatic_var_3914_0 ;
  const GGS_string temp_3887 = GGS_string (gWrapperFileContent_18_targetGenerationFileWrapper) ;
  if (temp_3887.isBuilt ()) {
    temp_3887 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.command")), automatic_var_3914_0 COMMA_SOURCE_FILE_AT_LINE (75)) ;
  }
  GGS_bool automatic_var_4072_0 ;
  const GGS_string temp_4045 = GGS_string (gWrapperFileContent_19_targetGenerationFileWrapper) ;
  if (temp_4045.isBuilt ()) {
    temp_4045 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.command")), automatic_var_4072_0 COMMA_SOURCE_FILE_AT_LINE (76)) ;
  }
  GGS_bool automatic_var_4223_0 ;
  const GGS_string temp_4201 = template_filewrapper_targetGenerationFileWrapper_makefile_mingw_on_macosx_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_4201.isBuilt ()) {
    temp_4201 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_4223_0 COMMA_SOURCE_FILE_AT_LINE (77)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateMakefileMacOSXTarget (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (87)) ;
  }
  GGS_bool automatic_var_4651_0 ;
  const GGS_string temp_4624 = GGS_string (gWrapperFileContent_2_targetGenerationFileWrapper) ;
  if (temp_4624.isBuilt ()) {
    temp_4624 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.command")), automatic_var_4651_0 COMMA_SOURCE_FILE_AT_LINE (88)) ;
  }
  GGS_bool automatic_var_4800_0 ;
  const GGS_string temp_4773 = GGS_string (gWrapperFileContent_4_targetGenerationFileWrapper) ;
  if (temp_4773.isBuilt ()) {
    temp_4773 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.command")), automatic_var_4800_0 COMMA_SOURCE_FILE_AT_LINE (89)) ;
  }
  GGS_bool automatic_var_4953_0 ;
  const GGS_string temp_4924 = GGS_string (gWrapperFileContent_3_targetGenerationFileWrapper) ;
  if (temp_4924.isBuilt ()) {
    temp_4924 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build64.command")), automatic_var_4953_0 COMMA_SOURCE_FILE_AT_LINE (90)) ;
  }
  GGS_bool automatic_var_5106_0 ;
  const GGS_string temp_5077 = GGS_string (gWrapperFileContent_5_targetGenerationFileWrapper) ;
  if (temp_5077.isBuilt ()) {
    temp_5077 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean64.command")), automatic_var_5106_0 COMMA_SOURCE_FILE_AT_LINE (91)) ;
  }
  GGS_bool automatic_var_5248_0 ;
  const GGS_string temp_5226 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_5226.isBuilt ()) {
    temp_5226 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_5248_0 COMMA_SOURCE_FILE_AT_LINE (92)) ;
  }
  GGS_bool automatic_var_5394_0 ;
  const GGS_string temp_5370 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_makefile64 (inLexique, var_cas_inProjectName) ;
  if (temp_5370.isBuilt ()) {
    temp_5370 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile64")), automatic_var_5394_0 COMMA_SOURCE_FILE_AT_LINE (93)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateMakefileIntelMacOSXTarget (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (103)) ;
  }
  GGS_bool automatic_var_5839_0 ;
  const GGS_string temp_5812 = GGS_string (gWrapperFileContent_6_targetGenerationFileWrapper) ;
  if (temp_5812.isBuilt ()) {
    temp_5812 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.command")), automatic_var_5839_0 COMMA_SOURCE_FILE_AT_LINE (104)) ;
  }
  GGS_bool automatic_var_5994_0 ;
  const GGS_string temp_5967 = GGS_string (gWrapperFileContent_8_targetGenerationFileWrapper) ;
  if (temp_5967.isBuilt ()) {
    temp_5967 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.command")), automatic_var_5994_0 COMMA_SOURCE_FILE_AT_LINE (105)) ;
  }
  GGS_bool automatic_var_6153_0 ;
  const GGS_string temp_6124 = GGS_string (gWrapperFileContent_7_targetGenerationFileWrapper) ;
  if (temp_6124.isBuilt ()) {
    temp_6124 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build64.command")), automatic_var_6153_0 COMMA_SOURCE_FILE_AT_LINE (106)) ;
  }
  GGS_bool automatic_var_6312_0 ;
  const GGS_string temp_6283 = GGS_string (gWrapperFileContent_9_targetGenerationFileWrapper) ;
  if (temp_6283.isBuilt ()) {
    temp_6283 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean64.command")), automatic_var_6312_0 COMMA_SOURCE_FILE_AT_LINE (107)) ;
  }
  GGS_bool automatic_var_6460_0 ;
  const GGS_string temp_6438 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_intel_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_6438.isBuilt ()) {
    temp_6438 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_6460_0 COMMA_SOURCE_FILE_AT_LINE (108)) ;
  }
  GGS_bool automatic_var_6612_0 ;
  const GGS_string temp_6588 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_intel_makefile64 (inLexique, var_cas_inProjectName) ;
  if (temp_6588.isBuilt ()) {
    temp_6588 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile64")), automatic_var_6612_0 COMMA_SOURCE_FILE_AT_LINE (109)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateMakefilePPCMacOSXTarget (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (119)) ;
  }
  GGS_bool automatic_var_7051_0 ;
  const GGS_string temp_7024 = GGS_string (gWrapperFileContent_10_targetGenerationFileWrapper) ;
  if (temp_7024.isBuilt ()) {
    temp_7024 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.command")), automatic_var_7051_0 COMMA_SOURCE_FILE_AT_LINE (120)) ;
  }
  GGS_bool automatic_var_7204_0 ;
  const GGS_string temp_7177 = GGS_string (gWrapperFileContent_12_targetGenerationFileWrapper) ;
  if (temp_7177.isBuilt ()) {
    temp_7177 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.command")), automatic_var_7204_0 COMMA_SOURCE_FILE_AT_LINE (121)) ;
  }
  GGS_bool automatic_var_7361_0 ;
  const GGS_string temp_7332 = GGS_string (gWrapperFileContent_11_targetGenerationFileWrapper) ;
  if (temp_7332.isBuilt ()) {
    temp_7332 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build64.command")), automatic_var_7361_0 COMMA_SOURCE_FILE_AT_LINE (122)) ;
  }
  GGS_bool automatic_var_7518_0 ;
  const GGS_string temp_7489 = GGS_string (gWrapperFileContent_13_targetGenerationFileWrapper) ;
  if (temp_7489.isBuilt ()) {
    temp_7489 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean64.command")), automatic_var_7518_0 COMMA_SOURCE_FILE_AT_LINE (123)) ;
  }
  GGS_bool automatic_var_7664_0 ;
  const GGS_string temp_7642 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_ppc_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_7642.isBuilt ()) {
    temp_7642 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_7664_0 COMMA_SOURCE_FILE_AT_LINE (124)) ;
  }
  GGS_bool automatic_var_7814_0 ;
  const GGS_string temp_7790 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_ppc_makefile64 (inLexique, var_cas_inProjectName) ;
  if (temp_7790.isBuilt ()) {
    temp_7790 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile64")), automatic_var_7814_0 COMMA_SOURCE_FILE_AT_LINE (125)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateMakefileUniversalMacOSXTarget (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (135)) ;
  }
  GGS_bool automatic_var_8271_0 ;
  const GGS_string temp_8244 = GGS_string (gWrapperFileContent_14_targetGenerationFileWrapper) ;
  if (temp_8244.isBuilt ()) {
    temp_8244 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.command")), automatic_var_8271_0 COMMA_SOURCE_FILE_AT_LINE (136)) ;
  }
  GGS_bool automatic_var_8430_0 ;
  const GGS_string temp_8403 = GGS_string (gWrapperFileContent_16_targetGenerationFileWrapper) ;
  if (temp_8403.isBuilt ()) {
    temp_8403 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.command")), automatic_var_8430_0 COMMA_SOURCE_FILE_AT_LINE (137)) ;
  }
  GGS_bool automatic_var_8593_0 ;
  const GGS_string temp_8564 = GGS_string (gWrapperFileContent_15_targetGenerationFileWrapper) ;
  if (temp_8564.isBuilt ()) {
    temp_8564 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build64.command")), automatic_var_8593_0 COMMA_SOURCE_FILE_AT_LINE (138)) ;
  }
  GGS_bool automatic_var_8756_0 ;
  const GGS_string temp_8727 = GGS_string (gWrapperFileContent_17_targetGenerationFileWrapper) ;
  if (temp_8727.isBuilt ()) {
    temp_8727 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean64.command")), automatic_var_8756_0 COMMA_SOURCE_FILE_AT_LINE (139)) ;
  }
  GGS_bool automatic_var_8908_0 ;
  const GGS_string temp_8886 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_universal_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_8886.isBuilt ()) {
    temp_8886 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_8908_0 COMMA_SOURCE_FILE_AT_LINE (140)) ;
  }
  GGS_bool automatic_var_9064_0 ;
  const GGS_string temp_9040 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_universal_makefile64 (inLexique, var_cas_inProjectName) ;
  if (temp_9040.isBuilt ()) {
    temp_9040 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile64")), automatic_var_9064_0 COMMA_SOURCE_FILE_AT_LINE (141)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateMakefileUnixTarget (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (151)) ;
  }
  GGS_bool automatic_var_9486_0 ;
  const GGS_string temp_9459 = GGS_string (gWrapperFileContent_23_targetGenerationFileWrapper) ;
  if (temp_9459.isBuilt ()) {
    temp_9459 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.command")), automatic_var_9486_0 COMMA_SOURCE_FILE_AT_LINE (152)) ;
  }
  GGS_bool automatic_var_9633_0 ;
  const GGS_string temp_9606 = GGS_string (gWrapperFileContent_25_targetGenerationFileWrapper) ;
  if (temp_9606.isBuilt ()) {
    temp_9606 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.command")), automatic_var_9633_0 COMMA_SOURCE_FILE_AT_LINE (153)) ;
  }
  GGS_bool automatic_var_9784_0 ;
  const GGS_string temp_9755 = GGS_string (gWrapperFileContent_24_targetGenerationFileWrapper) ;
  if (temp_9755.isBuilt ()) {
    temp_9755 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build64.command")), automatic_var_9784_0 COMMA_SOURCE_FILE_AT_LINE (154)) ;
  }
  GGS_bool automatic_var_9935_0 ;
  const GGS_string temp_9906 = GGS_string (gWrapperFileContent_26_targetGenerationFileWrapper) ;
  if (temp_9906.isBuilt ()) {
    temp_9906 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean64.command")), automatic_var_9935_0 COMMA_SOURCE_FILE_AT_LINE (155)) ;
  }
  GGS_bool automatic_var_10075_0 ;
  const GGS_string temp_10053 = template_filewrapper_targetGenerationFileWrapper_makefile_unix_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_10053.isBuilt ()) {
    temp_10053 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_10075_0 COMMA_SOURCE_FILE_AT_LINE (156)) ;
  }
  GGS_bool automatic_var_10219_0 ;
  const GGS_string temp_10195 = template_filewrapper_targetGenerationFileWrapper_makefile_unix_makefile64 (inLexique, var_cas_inProjectName) ;
  if (temp_10195.isBuilt ()) {
    temp_10195 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile64")), automatic_var_10219_0 COMMA_SOURCE_FILE_AT_LINE (157)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateI386LinuxOnMacOSXTarget (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (167)) ;
  }
  GGS_bool automatic_var_10678_0 ;
  const GGS_string temp_10651 = GGS_string (gWrapperFileContent_0_targetGenerationFileWrapper) ;
  if (temp_10651.isBuilt ()) {
    temp_10651 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.command")), automatic_var_10678_0 COMMA_SOURCE_FILE_AT_LINE (168)) ;
  }
  GGS_bool automatic_var_10841_0 ;
  const GGS_string temp_10814 = GGS_string (gWrapperFileContent_1_targetGenerationFileWrapper) ;
  if (temp_10814.isBuilt ()) {
    temp_10814 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.command")), automatic_var_10841_0 COMMA_SOURCE_FILE_AT_LINE (169)) ;
  }
  GGS_bool automatic_var_10997_0 ;
  const GGS_string temp_10975 = template_filewrapper_targetGenerationFileWrapper_makefile_i386_linux_on_macosx_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_10975.isBuilt ()) {
    temp_10975 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_10997_0 COMMA_SOURCE_FILE_AT_LINE (170)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
