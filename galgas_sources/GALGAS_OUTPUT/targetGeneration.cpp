...
template_filewrapper_targetGenerationFileWrapper_makefile_file_list (C_CompilerEx & /* inLexique */,
  ...
  if (isBuilt) {
    ...
    result << "\n"
      ...
      "\n"
      "#--- Hand-coded files ---------------------\n" ;
    GGS_stringlist::cEnumerator enumerator_5803 (var_cas_HAND_CODED_SOURCE_FILE_LIST, true) ;
    const GGS_stringlist::cElement * operand_5803 = NULL ;
    while (((operand_5803 = enumerator_5803.nextObject ()))) {
      macroValidPointer (operand_5803) ;
      result << "SOURCES += " ;
      result << operand_5803->mValue ;
      result << "\n" ;
    }
    result << "\n"
      "#--- Files generated by GALGAS ------------\n" ;
    GGS_stringlist::cEnumerator enumerator_5920 (var_cas_MAKEFILE_FILE_LIST, true) ;
    const GGS_stringlist::cElement * operand_5920 = NULL ;
    while (((operand_5920 = enumerator_5920.nextObject ()))) {
      macroValidPointer (operand_5920) ;
      result << "SOURCES += " ;
      result << operand_5920->mValue ;
      result << "\n" ;
    }
    result << "\n"
      "\n"
