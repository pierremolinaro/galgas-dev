...
static const cRegularFileWrapper * gWrapperAllFiles_updaterApplicationFileWrapper_0 [1] = {
  NULL
} ;

//--- All sub-directories of '' directory

static const cDirectoryWrapper * gWrapperAllDirectories_updaterApplicationFileWrapper_0 [1] = {
  NULL
} ;

//--- Directory ''

const cDirectoryWrapper gWrapperDirectory_0_updaterApplicationFileWrapper (
  "",
  0,
  gWrapperAllFiles_updaterApplicationFileWrapper_0,
  0,
  gWrapperAllDirectories_updaterApplicationFileWrapper_0
) ;
...
static const cRegularFileWrapper * gWrapperAllFiles_updaterToolFileWrapper_0 [1] = {
  NULL
} ;

//--- All sub-directories of '' directory

static const cDirectoryWrapper * gWrapperAllDirectories_updaterToolFileWrapper_0 [1] = {
  NULL
} ;

//--- Directory ''

const cDirectoryWrapper gWrapperDirectory_0_updaterToolFileWrapper (
  "",
  0,
  gWrapperAllFiles_updaterToolFileWrapper_0,
  0,
  gWrapperAllDirectories_updaterToolFileWrapper_0
) ;
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGenerationFileWrapper_1 [1] = {
  NULL
} ;
...
const char * gWrapperFileContent_0_targetGenerationFileWrapper = "PATH=C:\\msys\\1.0\\bin;C:\\MinGW\\bin;%PATH%\n"
  "sh -c \"make --warn-undefined-variables\"\n"
  "pause\n" ;

const cRegularFileWrapper gWrapperFile_0_targetGenerationFileWrapper (
  "build.bat",
  "bat",
  true, // Text file
  87, // Text length
...
const char * gWrapperFileContent_1_targetGenerationFileWrapper = "PATH=C:\\msys\\1.0\\bin;C:\\MinGW\\bin;%PATH%\n"
  "sh -c \"make clean --warn-undefined-variables\"\n"
  "pause\n" ;

const cRegularFileWrapper gWrapperFile_1_targetGenerationFileWrapper (
  "clean.bat",
  "bat",
  true, // Text file
  93, // Text length
...
const char * gWrapperFileContent_2_targetGenerationFileWrapper = "PATH=C:\\msys\\1.0\\bin;C:\\MinGW\\bin;%PATH%\n"
  "sh -c \"make install --warn-undefined-variables\"\n"
  "pause\n" ;

const cRegularFileWrapper gWrapperFile_2_targetGenerationFileWrapper (
  "install.bat",
  "bat",
  true, // Text file
  95, // Text length
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGenerationFileWrapper_3 [1] = {
  NULL
} ;
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGenerationFileWrapper_4 [1] = {
  NULL
} ;
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGenerationFileWrapper_5 [1] = {
  NULL
} ;
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGenerationFileWrapper_6 [1] = {
  NULL
} ;
...
const cRegularFileWrapper gWrapperFile_3_targetGenerationFileWrapper (
  "build.command",
  "command",
  true, // Text file
  88, // Text length
...
const cRegularFileWrapper gWrapperFile_4_targetGenerationFileWrapper (
  "clean.command",
  "command",
  true, // Text file
  72, // Text length
...
const cRegularFileWrapper gWrapperFile_5_targetGenerationFileWrapper (
  "build.command",
  "command",
  true, // Text file
  93, // Text length
...
const cRegularFileWrapper gWrapperFile_6_targetGenerationFileWrapper (
  "clean.command",
  "command",
  true, // Text file
  72, // Text length
...
const cRegularFileWrapper gWrapperFile_7_targetGenerationFileWrapper (
  "install.command",
  "command",
  true, // Text file
  97, // Text length
...
const cRegularFileWrapper gWrapperFile_8_targetGenerationFileWrapper (
  "build.command",
  "command",
  true, // Text file
  88, // Text length
...
const cRegularFileWrapper gWrapperFile_9_targetGenerationFileWrapper (
  "clean.command",
  "command",
  true, // Text file
  72, // Text length
...
const char * gWrapperFileContent_10_targetGenerationFileWrapper = "PATH=C:\\msys\\1.0\\bin;C:\\MinGW\\bin;%PATH%\n"
  "sh -c \"make --warn-undefined-variables\"\n"
  "pause\n" ;

const cRegularFileWrapper gWrapperFile_10_targetGenerationFileWrapper (
  "build.bat",
  "bat",
  true, // Text file
  87, // Text length
...
const char * gWrapperFileContent_11_targetGenerationFileWrapper = "PATH=C:\\msys\\1.0\\bin;C:\\MinGW\\bin;%PATH%\n"
  "sh -c \"make clean --warn-undefined-variables\"\n"
  "pause\n" ;

const cRegularFileWrapper gWrapperFile_11_targetGenerationFileWrapper (
  "clean.bat",
  "bat",
  true, // Text file
  93, // Text length
...
const char * gWrapperFileContent_12_targetGenerationFileWrapper = "PATH=C:\\msys\\1.0\\bin;C:\\MinGW\\bin;%PATH%\n"
  "sh -c \"make install --warn-undefined-variables\"\n"
  "pause\n" ;

const cRegularFileWrapper gWrapperFile_12_targetGenerationFileWrapper (
  "install.bat",
  "bat",
  true, // Text file
  95, // Text length
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGenerationFileWrapper_10 [4] = {
...
const cRegularFileWrapper gWrapperFile_13_targetGenerationFileWrapper (
  "build.command",
  "command",
  true, // Text file
  65, // Text length
...
const cRegularFileWrapper gWrapperFile_14_targetGenerationFileWrapper (
  "clean.command",
  "command",
  true, // Text file
  72, // Text length
...
const cRegularFileWrapper gWrapperFile_15_targetGenerationFileWrapper (
  "install.command",
  "command",
  true, // Text file
  74, // Text length
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGenerationFileWrapper_11 [4] = {
...
const cRegularFileWrapper gWrapperFile_16_targetGenerationFileWrapper (
  "build.command",
  "command",
  true, // Text file
  88, // Text length
...
const cRegularFileWrapper gWrapperFile_17_targetGenerationFileWrapper (
  "clean.command",
  "command",
  true, // Text file
  72, // Text length
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGenerationFileWrapper_12 [3] = {
...
static const cDirectoryWrapper * gWrapperAllDirectories_targetGenerationFileWrapper_12 [1] = {
  NULL
} ;

//--- Directory 'makefile_x86_64_linux_on_macosx'

const cDirectoryWrapper gWrapperDirectory_12_targetGenerationFileWrapper (
  "makefile_x86_64_linux_on_macosx",
  2,
  gWrapperAllFiles_targetGenerationFileWrapper_12,
  0,
  gWrapperAllDirectories_targetGenerationFileWrapper_12
) ;

//--- File 'project_xcode/adding-icons-to-your-application.rtf'

const char * gWrapperFileContent_18_targetGenerationFileWrapper = "{\\rtf1\\ansi\\ansicpg1252\\cocoartf1138\\cocoasubrtf510\n"
...
const cRegularFileWrapper gWrapperFile_18_targetGenerationFileWrapper (
...
const cRegularFileWrapper gWrapperFile_19_targetGenerationFileWrapper (
  "build.command",
  "command",
  true, // Text file
  75, // Text length
...
const char * gWrapperFileContent_20_targetGenerationFileWrapper = "{\\rtf1\\mac\\ansicpg10000\\cocoartf824\\cocoasubrtf380\n"
...
const cRegularFileWrapper gWrapperFile_20_targetGenerationFileWrapper (
  "Credits.rtf",
  "rtf",
  true, // Text file
  310, // Text length
...
static const cRegularFileWrapper * gWrapperAllFiles_targetGenerationFileWrapper_14 [2] = {
...
static const cDirectoryWrapper * gWrapperAllDirectories_targetGenerationFileWrapper_14 [1] = {
  NULL
} ;

//--- Directory 'English.lproj'

const cDirectoryWrapper gWrapperDirectory_14_targetGenerationFileWrapper (
  "English.lproj",
  1,
  gWrapperAllFiles_targetGenerationFileWrapper_14,
  0,
  gWrapperAllDirectories_targetGenerationFileWrapper_14
) ;

//--- All files of 'project_xcode' directory

static const cRegularFileWrapper * gWrapperAllFiles_targetGenerationFileWrapper_13 [3] = {
...
static const cDirectoryWrapper * gWrapperAllDirectories_targetGenerationFileWrapper_13 [2] = {
  & gWrapperDirectory_14_targetGenerationFileWrapper,
  NULL
} ;

//--- Directory 'project_xcode'

const cDirectoryWrapper gWrapperDirectory_13_targetGenerationFileWrapper (
  "project_xcode",
  2,
  gWrapperAllFiles_targetGenerationFileWrapper_13,
  1,
  gWrapperAllDirectories_targetGenerationFileWrapper_13
) ;
...
static const cDirectoryWrapper * gWrapperAllDirectories_targetGenerationFileWrapper_0 [14] = {
  ...
  & gWrapperDirectory_12_targetGenerationFileWrapper,
  & gWrapperDirectory_13_targetGenerationFileWrapper,
  NULL
} ;
...
GALGAS_string filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_file_5F_list (C_Compiler * /* inCompiler */,
  ...
  if (in_HAND_5F_CODED_5F_SOURCE_5F_DIR_5F_SET.isValid ()) {
    cEnumerator_stringset enumerator_704 (in_HAND_5F_CODED_5F_SOURCE_5F_DIR_5F_SET, kEnumeration_up) ;
    while (enumerator_704.hasCurrentObject ()) {
      result << "SOURCES_DIR += " ;
      result << enumerator_704.current_key (HERE).stringValue () ;
      result << "\n" ;
  ...
  if (in_HAND_5F_CODED_5F_SOURCE_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_1325 (in_HAND_5F_CODED_5F_SOURCE_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1325.hasCurrentObject ()) {
      result << "SOURCES += " ;
      result << enumerator_1325.current_mValue (HERE).stringValue () ;
      result << "\n" ;
  ...
  if (in_MAKEFILE_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_1436 (in_MAKEFILE_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1436.hasCurrentObject ()) {
      result << "SOURCES += " ;
      result << enumerator_1436.current_mValue (HERE).stringValue () ;
      result << "\n" ;
...
void routine_generateMsysOnWin_33__32_Target (const GALGAS_string constinArgument_inProjectDirectory,
                                              ...
                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile_msys_on_win32")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 124)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 125)) ;
  GALGAS_bool joker_4781 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_10_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.bat")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 126)), joker_4781, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 126)) ;
  GALGAS_bool joker_4919 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_11_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.bat")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 127)), joker_4919, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 127)) ;
  GALGAS_bool joker_5061 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_12_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.bat")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 128)), joker_5061, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 128)) ;
  GALGAS_bool joker_5210 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_msys_5F_on_5F_win_33__32__5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 129))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 129)), joker_5210, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 129)) ;
}
...
void routine_generateMinGWOnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                          ...
                                          C_Compiler * inCompiler
                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile_mingw_on_macosx")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 138)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 139)) ;
  GALGAS_bool joker_5655 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_8_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 140)), joker_5655, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 140)) ;
  GALGAS_bool joker_5813 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_9_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 141)), joker_5813, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 141)) ;
  GALGAS_bool joker_5964 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_mingw_5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 142))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 142)), joker_5964, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 142)) ;
}
...
void routine_generateMakefileMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                           ...
                                           C_Compiler * inCompiler
                                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile_macosx")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 151)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 152)) ;
  GALGAS_bool joker_6392 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_5_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 153)), joker_6392, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 153)) ;
  GALGAS_bool joker_6541 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_6_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 154)), joker_6541, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 154)) ;
  GALGAS_bool joker_6694 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_7_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 155)), joker_6694, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 155)) ;
  GALGAS_bool joker_6836 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 156))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 156)), joker_6836, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 156)) ;
}
...
void routine_generateMakefileUnixTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                         ...
                                         C_Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile_unix")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 165)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 166)) ;
  GALGAS_bool joker_7258 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_13_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 167)), joker_7258, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 167)) ;
  GALGAS_bool joker_7409 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_15_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 168)), joker_7409, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 168)) ;
  GALGAS_bool joker_7556 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_14_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 169)), joker_7556, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 169)) ;
  GALGAS_bool joker_7696 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_unix_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 170))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 170)), joker_7696, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 170)) ;
}
...
void routine_generateI_33__38__36_LinuxOnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                       ...
                                                       C_Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile_i386_linux_on_macosx")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 179)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 180)) ;
  GALGAS_bool joker_8155 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_3_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 181)), joker_8155, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 181)) ;
  GALGAS_bool joker_8318 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_4_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 182)), joker_8318, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 182)) ;
  GALGAS_bool joker_8474 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_i_33__38__36__5F_linux_5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 183))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 183)), joker_8474, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 183)) ;
}
...
void routine_generateX_38__36__5F__36__34_LinuxOnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                               ...
                                                               C_Compiler * inCompiler
                                                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile_x86_64_linux_on_macosx")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 192)) ;
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 193)) ;
  GALGAS_bool joker_8939 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_16_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 194)), joker_8939, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 194)) ;
  GALGAS_bool joker_9104 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_17_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 195)), joker_9104, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 195)) ;
  GALGAS_bool joker_9262 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_x_38__36__5F__36__34__5F_linux_5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 196))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 196)), joker_9262, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 196)) ;
}
...
void routine_updateTargets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
                            ...
                            C_Compiler * inCompiler
                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_projectDirectory = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 211)).reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 211)) ;
  GALGAS_bool joker_10071 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_project_5F_header (inCompiler, constinArgument_inProjectVersionString COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 213))).method_writeToFileWhenDifferentContents (constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 214)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/project_header.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 214)), joker_10071, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 213)) ;
  GALGAS_string var_libpmPath ;
  const cMapElement_projectQualifiedFeatureMap * objectArray_10125 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("libpmAtPath")) ;
  if (NULL != objectArray_10125) {
      macroValidSharedObject (objectArray_10125, cMapElement_projectQualifiedFeatureMap) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, objectArray_10125->mAttribute_mFeatureValue.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (objectArray_10125->mAttribute_mFeatureValue.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the libpm path should not be empty")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 221)) ;
      var_libpmPath.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_0) {
      var_libpmPath = objectArray_10125->mAttribute_mFeatureValue.mAttribute_string ;
    }
  }else{
    {
    routine_updateLIBPMatPath (constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 226)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/libpm")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 226)), inCompiler  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 226)) ;
    }
    var_libpmPath = GALGAS_string ("../galgas_sources/GALGAS_OUTPUT/libpm") ;
    GALGAS_string var_libpmAbsolutePath = var_libpmPath.reader_absolutePathFromPath (constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 228)) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 228)) ;
    const enumGalgasBool test_2 = var_libpmAbsolutePath.reader_directoryExists (SOURCE_FILE ("targetGeneration.gSemantics", 229)).operator_not (SOURCE_FILE ("targetGeneration.gSemantics", 229)).boolEnum () ;
    if (kBoolTrue == test_2) {
      inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE ("targetGeneration.gSemantics", 230)), GALGAS_string ("the '").operator_concat (var_libpmAbsolutePath  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 230)).operator_concat (GALGAS_string ("'  LIBPM directory does not exists")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 230))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 230)) ;
    }
  }
  GALGAS_stringset var_externSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 234)) ;
  GALGAS_stringset var_guiSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 235)) ;
  GALGAS_stringset var_scannerSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 236)) ;
  GALGAS_stringset var_optionSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 237)) ;
  GALGAS_stringset var_semanticsSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 238)) ;
  GALGAS_stringset var_syntaxSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 239)) ;
  GALGAS_stringset var_grammarSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 240)) ;
  GALGAS_stringset var_programSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 241)) ;
  GALGAS_stringset var_externSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 243)) ;
  GALGAS_stringset var_guiSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 244)) ;
  GALGAS_stringset var_sourceFileSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 246)) ;
  GALGAS_stringlist var_generatedFileListForMakefile = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("targetGeneration.gSemantics", 247)) ;
  GALGAS_stringlist var_handCodedSourceList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("targetGeneration.gSemantics", 248)) ;
  GALGAS_stringset var_handCodedSourceDirectorySet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 249)) ;
  cEnumerator_projectSourceList enumerator_11644 (constinArgument_inProjectSourceList, kEnumeration_up) ;
  while (enumerator_11644.hasCurrentObject ()) {
    GALGAS_string var_baseName = enumerator_11644.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 251)).reader_lastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 251)).reader_stringByDeletingPathExtension (SOURCE_FILE ("targetGeneration.gSemantics", 251)) ;
    GALGAS_string var_pathExtension = enumerator_11644.current_mFilePath (HERE).mAttribute_string.reader_pathExtension (SOURCE_FILE ("targetGeneration.gSemantics", 252)) ;
    GALGAS_string var_cppFile = var_baseName.operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 253)) ;
    const enumGalgasBool test_3 = var_sourceFileSet.reader_hasKey (var_baseName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 255)).operator_and (GALGAS_bool (kIsNotEqual, var_pathExtension.objectCompare (GALGAS_string ("h"))) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 255)).operator_and (GALGAS_bool (kIsNotEqual, var_pathExtension.objectCompare (GALGAS_string ("xib"))) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 255)).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_location location_4 (enumerator_11644.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, GALGAS_string ("there is already a file with '").operator_concat (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 256)).operator_concat (GALGAS_string ("' as base name in the project")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 256))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 256)) ;
    }
    var_sourceFileSet.addAssign_operation (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 258)) ;
    if (enumerator_11644.current_mSourceKind (HERE).isValid ()) {
      switch (enumerator_11644.current_mSourceKind (HERE).enumValue ()) {
      case GALGAS_sourceFileKind::kNotBuilt:
        break ;
      case GALGAS_sourceFileKind::kEnum_externSourceFile: {
        const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("cpp"))).operator_or (GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("mm"))) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 262)).boolEnum () ;
        if (kBoolTrue == test_5) {
          var_externSourceSet_5F_tool.addAssign_operation (enumerator_11644.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 263))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 263)) ;
          var_handCodedSourceList.addAssign_operation (enumerator_11644.current_mFilePath (HERE).mAttribute_string.reader_lastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 264))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 264)) ;
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_11644.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 265)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_6) {
            var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 266)) ;
          }else if (kBoolFalse == test_6) {
            var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11644.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 268))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 268))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 268)) ;
          }
        }else if (kBoolFalse == test_5) {
          const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("framework"))).boolEnum () ;
          if (kBoolTrue == test_7) {
            var_externSourceSet_5F_tool.addAssign_operation (enumerator_11644.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 271))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 271)) ;
            var_externSourceSet_5F_app.addAssign_operation (enumerator_11644.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 272))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 272)) ;
            const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_11644.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 273)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_8) {
              var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 274)) ;
            }else if (kBoolFalse == test_8) {
              var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11644.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 276))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 276))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 276)) ;
            }
          }else if (kBoolFalse == test_7) {
            const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("m"))).boolEnum () ;
            if (kBoolTrue == test_9) {
              var_externSourceSet_5F_app.addAssign_operation (enumerator_11644.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 279))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 279)) ;
              const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_11644.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 280)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_10) {
                var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 281)) ;
              }else if (kBoolFalse == test_10) {
                var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11644.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 283))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 283))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 283)) ;
              }
            }else if (kBoolFalse == test_9) {
              const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("h"))).boolEnum () ;
              if (kBoolTrue == test_11) {
                var_externSourceSet_5F_tool.addAssign_operation (enumerator_11644.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 286))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 286)) ;
                const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_11644.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 287)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_12) {
                  var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 288)) ;
                }else if (kBoolFalse == test_12) {
                  var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11644.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 290))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 290))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 290)) ;
                }
              }else if (kBoolFalse == test_11) {
                const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, var_pathExtension.objectCompare (GALGAS_string ("xib"))).boolEnum () ;
                if (kBoolTrue == test_13) {
                  var_externSourceSet_5F_app.addAssign_operation (enumerator_11644.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 293))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 293)) ;
                  const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_11644.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 294)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                  if (kBoolTrue == test_14) {
                    var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 295)) ;
                  }else if (kBoolFalse == test_14) {
                    var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11644.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 297))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 297))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 297)) ;
                  }
                }else if (kBoolFalse == test_13) {
                  GALGAS_location location_15 (enumerator_11644.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_15, GALGAS_string ("unhandled extension")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 300)) ;
                }
              }
            }
          }
      ...
      case GALGAS_sourceFileKind::kEnum_lexiqueSourceFile: {
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 303)) ;
        var_scannerSourceSet_5F_tool.addAssign_operation (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 304)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_syntaxSourceFile: {
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 306)) ;
        var_syntaxSourceSet_5F_tool.addAssign_operation (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 307)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_semanticsSourceFile: {
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 309)) ;
        var_semanticsSourceSet_5F_tool.addAssign_operation (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 310)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_grammarSourceFile: {
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 312)) ;
        var_grammarSourceSet_5F_tool.addAssign_operation (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 313)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_programSourceFile: {
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 315)) ;
        var_programSourceSet_5F_tool.addAssign_operation (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 316)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_optionSourceFile: {
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 318)) ;
        var_optionSourceSet_5F_tool.addAssign_operation (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 319)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_guiSourceFile: {
        var_guiSourceSet_5F_app.addAssign_operation (var_baseName.add_operation (GALGAS_string (".m"), inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 321))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 321)) ;
        } break ;
      }
    }
  ...
  if (kBoolTrue == test_16) {
    inCompiler->printMessage (GALGAS_string ("*** Updating targets\n")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 326)) ;
  }
  GALGAS_stringset var_availableGenerationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 328)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_macosx")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 329)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_unix")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 330)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_i386_linux_on_macosx")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 331)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_x86_64_linux_on_macosx")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 332)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_mingw_on_macosx")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 333)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_msys_on_win32")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 334)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("SnowLeopard")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 335)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Lion")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 336)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("MountainLion")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 337)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Mavericks")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 338)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Yosemite")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 339)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("LatestMacOS")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 340)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("multi-threading")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 341)) ;
  GALGAS_stringset var_generationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 342)) ;
  ...
  cEnumerator_lstringlist enumerator_16208 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_16208.hasCurrentObject ()) {
    const enumGalgasBool test_17 = var_availableGenerationFeatures.reader_hasKey (enumerator_16208.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 348)) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 348)).boolEnum () ;
    if (kBoolTrue == test_17) {
      const enumGalgasBool test_18 = var_generationFeatures.reader_hasKey (enumerator_16208.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 349)) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 349)).boolEnum () ;
      if (kBoolTrue == test_18) {
        GALGAS_location location_19 (enumerator_16208.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_19, GALGAS_string ("duplicate '").operator_concat (enumerator_16208.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 350))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 350)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 350))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 350)) ;
      }
      const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_16208.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_20) {
        const enumGalgasBool test_21 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_21) {
          GALGAS_location location_22 (enumerator_16208.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_22, GALGAS_string ("duplicate '").operator_concat (enumerator_16208.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 355))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 355)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 355))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 355)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_20) {
        const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, enumerator_16208.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_23) {
          ...
          if (kBoolTrue == test_24) {
            GALGAS_location location_25 (enumerator_16208.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_25, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 361)) ;
          }
          var_SDK = GALGAS_string ("macosx10.6") ;
        }else if (kBoolFalse == test_23) {
          const enumGalgasBool test_26 = GALGAS_bool (kIsEqual, enumerator_16208.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_26) {
            ...
            if (kBoolTrue == test_27) {
              GALGAS_location location_28 (enumerator_16208.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_28, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 367)) ;
            }
            var_SDK = GALGAS_string ("macosx10.7") ;
            var_usesARC = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_26) {
            const enumGalgasBool test_29 = GALGAS_bool (kIsEqual, enumerator_16208.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_29) {
              const enumGalgasBool test_30 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_30) {
                GALGAS_location location_31 (enumerator_16208.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_31, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 374)) ;
              }
              var_SDK = GALGAS_string ("macosx10.8") ;
              var_usesARC = GALGAS_bool (true) ;
            }else if (kBoolFalse == test_29) {
              const enumGalgasBool test_32 = GALGAS_bool (kIsEqual, enumerator_16208.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Mavericks"))).boolEnum () ;
              if (kBoolTrue == test_32) {
                const enumGalgasBool test_33 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_33) {
                  GALGAS_location location_34 (enumerator_16208.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_34, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 381)) ;
                }
                var_SDK = GALGAS_string ("macosx10.9") ;
                var_usesARC = GALGAS_bool (true) ;
              }else if (kBoolFalse == test_32) {
                const enumGalgasBool test_35 = GALGAS_bool (kIsEqual, enumerator_16208.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Yosemite"))).boolEnum () ;
                if (kBoolTrue == test_35) {
                  ...
                  if (kBoolTrue == test_36) {
                    GALGAS_location location_37 (enumerator_16208.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_37, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 388)) ;
                  }
                  var_SDK = GALGAS_string ("macosx10.10") ;
                  var_usesARC = GALGAS_bool (true) ;
                }else if (kBoolFalse == test_35) {
                  const enumGalgasBool test_38 = GALGAS_bool (kIsEqual, enumerator_16208.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("LatestMacOS"))).boolEnum () ;
                  if (kBoolTrue == test_38) {
                    ...
                    if (kBoolTrue == test_39) {
                      GALGAS_location location_40 (enumerator_16208.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                      inCompiler->emitSemanticError (location_40, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 395)) ;
                    }
                    var_SDK = GALGAS_string ("macosx") ;
                    var_usesARC = GALGAS_bool (true) ;
                  }else if (kBoolFalse == test_38) {
                    var_generationFeatures.addAssign_operation (enumerator_16208.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 400))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 400)) ;
                  }
                }
              }
            }
      ...
      cEnumerator_stringset enumerator_18607 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_18607.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_18607.current_key (HERE)  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 405)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 405))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 405)) ;
        enumerator_18607.gotoNextObject () ;
      }
      GALGAS_location location_41 (enumerator_16208.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_41, GALGAS_string ("unknown '").operator_concat (enumerator_16208.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 407))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 407)).operator_concat (GALGAS_string ("' feature; available features are:")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 407)).operator_concat (var_s  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 407))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 407)) ;
    }
    enumerator_16208.gotoNextObject () ;
  }
  const enumGalgasBool test_42 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).operator_and (constinArgument_inProjectQualifiedFeatureMap.reader_hasKey (GALGAS_string ("applicationBundleBase") COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 411)).operator_not (SOURCE_FILE ("targetGeneration.gSemantics", 411)) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 411)).boolEnum () ;
  if (kBoolTrue == test_42) {
    GALGAS_location location_43 (constinArgument_inProjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticWarning (location_43, GALGAS_string ("For a Cocoa project, the \"applicationBundleBase\" feature should be set; for example: 'feature applicationBundleBase : \"fr.what\" ;'")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 412)) ;
  }
  const enumGalgasBool test_44 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_macosx") COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 415)).boolEnum () ;
  if (kBoolTrue == test_44) {
    {
    routine_generateMakefileMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 416)) ;
    }
  }
  const enumGalgasBool test_45 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_unix") COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 418)).boolEnum () ;
  if (kBoolTrue == test_45) {
    {
    routine_generateMakefileUnixTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 419)) ;
    }
  }
  const enumGalgasBool test_46 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_i386_linux_on_macosx") COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 421)).boolEnum () ;
  if (kBoolTrue == test_46) {
    {
    routine_generateI_33__38__36_LinuxOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 422)) ;
    }
  }
  const enumGalgasBool test_47 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_x86_64_linux_on_macosx") COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 424)).boolEnum () ;
  if (kBoolTrue == test_47) {
    {
    routine_generateX_38__36__5F__36__34_LinuxOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 425)) ;
    }
  }
  const enumGalgasBool test_48 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_mingw_on_macosx") COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 427)).boolEnum () ;
  if (kBoolTrue == test_48) {
    {
    routine_generateMinGWOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 428)) ;
    }
  }
  const enumGalgasBool test_49 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_msys_on_win32") COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 430)).boolEnum () ;
  if (kBoolTrue == test_49) {
    {
    routine_generateMsysOnWin_33__32_Target (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 431)) ;
    }
  }
  GALGAS_string temp_50 ;
  const enumGalgasBool test_51 = var_multiThreadingEnabled.boolEnum () ;
  if (kBoolTrue == test_51) {
    temp_50 = GALGAS_string ("1") ;
  }else if (kBoolFalse == test_51) {
    temp_50 = GALGAS_string ("0") ;
  }
  GALGAS_string var_newFileListContents = GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_file_5F_list (inCompiler, var_handCodedSourceDirectorySet, var_handCodedSourceList, var_generatedFileListForMakefile, var_libpmPath, temp_50 COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 434))) ;
  GALGAS_string var_fileListPath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 441)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/file_list.mak")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 441)) ;
  GALGAS_bool joker_20442 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_20442, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 442)) ;
  GALGAS_string var_previousFileListPath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 443)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/file_list.mke")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 443)) ;
  {
  GALGAS_string::class_method_deleteFileIfExists (var_previousFileListPath, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 444)) ;
  }
  const enumGalgasBool test_52 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_52) {
    GALGAS_string var_dir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 447)) ;
    var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 448)) ;
    GALGAS_string var_icon_5F_help_5F_file_5F_path = var_dir.operator_concat (GALGAS_string ("/adding-icons-to-your-application.rtf")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 450)) ;
    GALGAS_bool joker_21034 ; // Joker input parameter
    GALGAS_string (gWrapperFileContent_18_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_icon_5F_help_5F_file_5F_path, joker_21034, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 451)) ;
    GALGAS_string var_applicationBundleBase ;
    const cMapElement_projectQualifiedFeatureMap * objectArray_21101 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_21101) {
        macroValidSharedObject (objectArray_21101, cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_21101->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
      var_applicationBundleBase = GALGAS_string ("fr.irccyn") ;
    }
    GALGAS_string var_InfoPlistContents = GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_info_5F_plist (inCompiler, constinArgument_inTargetName, var_applicationBundleBase, constinArgument_inProjectVersionString, constinArgument_inHandledExtensionSet COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 459))) ;
    GALGAS_bool joker_21577 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 465)), joker_21577, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 465)) ;
    const enumGalgasBool test_53 = var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 467)).reader_fileExists (SOURCE_FILE ("targetGeneration.gSemantics", 467)).operator_not (SOURCE_FILE ("targetGeneration.gSemantics", 467)).boolEnum () ;
    if (kBoolTrue == test_53) {
      GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_build_5F_xcode (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 468))).method_writeToExecutableFile (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 468)), inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 468)) ;
    }
    var_dir.operator_concat (GALGAS_string ("/English.lproj")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 471)).method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 471)) ;
    GALGAS_string var_InfoPlist_5F_strings_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/InfoPlist.strings")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 472)) ;
    GALGAS_bool joker_22064 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 473))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_22064, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 473)) ;
    GALGAS_string var_Credits_5F_rtf_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/Credits.rtf")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 474)) ;
    const enumGalgasBool test_54 = var_Credits_5F_rtf_5F_path.reader_fileExists (SOURCE_FILE ("targetGeneration.gSemantics", 475)).operator_not (SOURCE_FILE ("targetGeneration.gSemantics", 475)).boolEnum () ;
    if (kBoolTrue == test_54) {
      GALGAS_string (gWrapperFileContent_20_targetGenerationFileWrapper).method_writeToFile (var_Credits_5F_rtf_5F_path, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 476)) ;
    }
    const cMapElement_projectQualifiedFeatureMap * objectArray_22366 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_22366) {
        macroValidSharedObject (objectArray_22366, cMapElement_projectQualifiedFeatureMap) ;
      GALGAS_string var_applicationUpdateDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/cocoa-application-update/application")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 480)) ;
      var_applicationUpdateDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 481)) ;
      GALGAS_bool joker_22746 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 482))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 482)), joker_22746, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 482)) ;
      GALGAS_bool joker_23046 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, constinArgument_inTargetName, objectArray_22366->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 483))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 488)), joker_23046, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 483)) ;
      GALGAS_bool joker_23244 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_nib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 491))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 491)), joker_23244, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 491)) ;
      GALGAS_bool joker_23398 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 492))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 492)), joker_23398, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 492)) ;
      GALGAS_bool joker_23560 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 493))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 493)), joker_23560, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 493)) ;
      GALGAS_bool joker_23714 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 494))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 494)), joker_23714, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 494)) ;
      GALGAS_bool joker_23876 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 495))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 495)), joker_23876, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 495)) ;
      GALGAS_bool joker_24046 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 496))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 496)), joker_24046, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 496)) ;
      GALGAS_string var_codeSignIdentity ;
      const cMapElement_projectQualifiedFeatureMap * objectArray_24116 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_24116) {
          macroValidSharedObject (objectArray_24116, cMapElement_projectQualifiedFeatureMap) ;
        var_codeSignIdentity = objectArray_24116->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
        var_codeSignIdentity = GALGAS_string::makeEmptyString () ;
      }
      GALGAS_string var_updaterToolDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/cocoa-application-update/updater-tool")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 504)) ;
      var_updaterToolDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 505)) ;
      GALGAS_bool joker_24585 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_protocol (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 506))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerProtocol.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 506)), joker_24585, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 506)) ;
      GALGAS_bool joker_24735 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 507))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 507)), joker_24735, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 507)) ;
      GALGAS_bool joker_24893 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_implementation (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 508))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 508)), joker_24893, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 508)) ;
      GALGAS_bool joker_25151 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_tool_5F_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 509))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Info.plist")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 514)), joker_25151, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 509)) ;
      GALGAS_bool joker_25395 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_tool_5F_launchd_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 517))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Launchd.plist")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 521)), joker_25395, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 517)) ;
      GALGAS_bool joker_25625 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_main (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 524))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-main.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 528)), joker_25625, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 524)) ;
      GALGAS_string var_updaterApplicationDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/cocoa-application-update/updater-application")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 532)) ;
      var_updaterApplicationDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 533)) ;
      GALGAS_bool joker_25996 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 534))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 534)), joker_25996, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 534)) ;
      GALGAS_bool joker_26175 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 535))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 535)), joker_26175, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 535)) ;
      GALGAS_bool joker_26358 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 536))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 536)), joker_26358, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 536)) ;
      GALGAS_bool joker_26527 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 537))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 537)), joker_26527, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 537)) ;
      GALGAS_bool joker_26774 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 538))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 542)), joker_26774, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 538)) ;
      GALGAS_bool joker_27030 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 544))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 549)), joker_27030, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 544)) ;
      GALGAS_bool joker_27179 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 551))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 551)), joker_27179, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 551)) ;
      GALGAS_bool joker_27327 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_prefix (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 552))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Prefix.pch")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 552)), joker_27327, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 552)) ;
    }
    GALGAS_string var_userResourceDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/userResources")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 555)) ;
    var_userResourceDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 556)) ;
    GALGAS_stringlist var_extensionList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("targetGeneration.gSemantics", 557)) ;
    var_extensionList.addAssign_operation (GALGAS_string ("icns")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 558)) ;
    GALGAS_stringlist var_resourceFiles = var_userResourceDir.reader_regularFilesWithExtensions (GALGAS_bool (false), var_extensionList COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 559)) ;
    GALGAS_string var_xcodeProjectPath = var_dir.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 561)).operator_concat (constinArgument_inTargetName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 561)).operator_concat (GALGAS_string (".xcodeproj")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 561)) ;
    GALGAS_string var_intermediateFilePath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 562)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/file_list_for_xcode_project.txt")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 562)) ;
    var_xcodeProjectPath.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 564)) ;
    GALGAS_stringset var_all_5F_h_5F_cpp_5F_files = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 566)) ;
    cEnumerator_stringset enumerator_28324 (var_guiSourceSet_5F_tool.operator_or (var_scannerSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_or (var_optionSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_or (var_semanticsSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_or (var_syntaxSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_or (var_grammarSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_or (var_programSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)), kEnumeration_up) ;
    while (enumerator_28324.hasCurrentObject ()) {
      var_all_5F_h_5F_cpp_5F_files.addAssign_operation (enumerator_28324.current (HERE).add_operation (GALGAS_string (".h"), inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 568))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 568)) ;
      var_all_5F_h_5F_cpp_5F_files.addAssign_operation (enumerator_28324.current (HERE).add_operation (GALGAS_string (".cpp"), inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 569))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 569)) ;
      enumerator_28324.gotoNextObject () ;
    }
    {
    routine_generateXcodeProject (var_externSourceSet_5F_tool, var_all_5F_h_5F_cpp_5F_files, GALGAS_string ("../galgas_sources/GALGAS_OUTPUT"), var_externSourceSet_5F_app, var_guiSourceSet_5F_app, constinArgument_inTargetName, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("targetGeneration.gSemantics", 579)), var_xcodeProjectPath, var_resourceFiles, var_intermediateFilePath, var_SDK, var_libpmPath, GALGAS_string::makeEmptyString (), var_multiThreadingEnabled, var_usesARC, constinArgument_inProjectQualifiedFeatureMap, inCompiler  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 572)) ;
    }
  }
}
