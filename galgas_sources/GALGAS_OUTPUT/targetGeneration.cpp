...
void routine_updateTargets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
  ...
  while (enumerator_11892.hasCurrentObject ()) {
    ...
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = var_sourceFileSet.reader_hasKey (var_baseName COMMA_SOURCE_FILE_AT_LINE (261)).operator_and (GALGAS_bool (kIsNotEqual, var_extension.objectCompare (GALGAS_string ("h"))) COMMA_SOURCE_FILE_AT_LINE (261)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @errorInstructionForGeneration
    ...
    if (enumerator_11892.current_mSourceKind (HERE).isValid ()) {
        ...
        if (kBoolTrue == test_5) {
          ...
          if (kBoolTrue == test_7) {
            ...
            if (kBoolTrue == test_9) {
              ...
              //-------- @errorInstructionForGeneration
              GALGAS_location location_11 (enumerator_11892.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_11, GALGAS_string ("unhandled extension") COMMA_SOURCE_FILE_AT_LINE (291)) ;
            }
          }
        }
        } break ;
      case GALGAS_sourceFileKind::kEnum_lexiqueSourceFile: {
        //-------- @plusEqualnstructionForGeneration
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile COMMA_SOURCE_FILE_AT_LINE (294)) ;
        //-------- @plusEqualnstructionForGeneration
        var_scannerSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (295)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_syntaxSourceFile: {
        //-------- @plusEqualnstructionForGeneration
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile COMMA_SOURCE_FILE_AT_LINE (297)) ;
        //-------- @plusEqualnstructionForGeneration
        var_syntaxSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (298)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_semanticsSourceFile: {
        //-------- @plusEqualnstructionForGeneration
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile COMMA_SOURCE_FILE_AT_LINE (300)) ;
        //-------- @plusEqualnstructionForGeneration
        var_semanticsSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (301)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_grammarSourceFile: {
        //-------- @plusEqualnstructionForGeneration
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile COMMA_SOURCE_FILE_AT_LINE (303)) ;
        //-------- @plusEqualnstructionForGeneration
        var_grammarSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (304)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_programSourceFile: {
        //-------- @plusEqualnstructionForGeneration
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile COMMA_SOURCE_FILE_AT_LINE (306)) ;
        //-------- @plusEqualnstructionForGeneration
        var_programSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (307)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_optionSourceFile: {
        ...
        //-------- @plusEqualnstructionForGeneration
        var_optionSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (310)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_guiSourceFile: {
        //-------- @plusEqualnstructionForGeneration
        var_guiSourceSet_5F_app.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (312)) ;
        } break ;
      }
    }
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_availableGenerationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (319)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_macosx") COMMA_SOURCE_FILE_AT_LINE (320)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_unix") COMMA_SOURCE_FILE_AT_LINE (321)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_i386_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (322)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_x86_64_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (323)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_mingw_on_macosx") COMMA_SOURCE_FILE_AT_LINE (324)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_msys_on_win32") COMMA_SOURCE_FILE_AT_LINE (325)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("SnowLeopard") COMMA_SOURCE_FILE_AT_LINE (326)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Lion") COMMA_SOURCE_FILE_AT_LINE (327)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("MountainLion") COMMA_SOURCE_FILE_AT_LINE (328)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_generationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (330)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_15471 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_15471.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_13 = var_availableGenerationFeatures.reader_hasKey (enumerator_15471.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (336)) COMMA_SOURCE_FILE_AT_LINE (336)).boolEnum () ;
    if (kBoolTrue == test_13) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_14 = var_generationFeatures.reader_hasKey (enumerator_15471.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (337)) COMMA_SOURCE_FILE_AT_LINE (337)).boolEnum () ;
      if (kBoolTrue == test_14) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_15 (enumerator_15471.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_15, GALGAS_string ("duplicate '").operator_concat (enumerator_15471.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (338)) COMMA_SOURCE_FILE_AT_LINE (338)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (338)) COMMA_SOURCE_FILE_AT_LINE (338)) ;
      }
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_16 = GALGAS_bool (kIsEqual, enumerator_15471.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_16) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_17 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_17) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_18 (enumerator_15471.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_18, GALGAS_string ("duplicate '").operator_concat (enumerator_15471.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (343)) COMMA_SOURCE_FILE_AT_LINE (343)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (343)) COMMA_SOURCE_FILE_AT_LINE (343)) ;
        }
        //-------- @assignmentInstructionForGeneration
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_16) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_19 = GALGAS_bool (kIsEqual, enumerator_15471.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_19) {
          ...
          if (kBoolTrue == test_20) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_21 (enumerator_15471.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_21, GALGAS_string ("the \"SnowLeopard\", \"Lion\" and \"MountainLion\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (349)) ;
          }
          //-------- @assignmentInstructionForGeneration
          var_SDK = GALGAS_string ("macosx10.6") ;
        }else if (kBoolFalse == test_19) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_22 = GALGAS_bool (kIsEqual, enumerator_15471.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_22) {
            ...
            if (kBoolTrue == test_23) {
              //-------- @errorInstructionForGeneration
              GALGAS_location location_24 (enumerator_15471.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_24, GALGAS_string ("the \"SnowLeopard\", \"Lion\" and \"MountainLion\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (355)) ;
            }
            //-------- @assignmentInstructionForGeneration
            ...
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_25 = GALGAS_bool (kIsEqual, enumerator_15471.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_25) {
              ...
              if (kBoolTrue == test_26) {
                //-------- @errorInstructionForGeneration
                GALGAS_location location_27 (enumerator_15471.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_27, GALGAS_string ("the \"SnowLeopard\", \"Lion\" and \"MountainLion\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (362)) ;
              }
              //-------- @assignmentInstructionForGeneration
              ...
              //-------- @plusEqualnstructionForGeneration
              var_generationFeatures.addAssign_operation (enumerator_15471.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (367)) COMMA_SOURCE_FILE_AT_LINE (367)) ;
            }
          }
        }
      }
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_16813 (var_availableGenerationFeatures, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_16813.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_16813.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (372)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (372)) COMMA_SOURCE_FILE_AT_LINE (372)) ;
        enumerator_16813.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_28 (enumerator_15471.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_28, GALGAS_string ("unknown '").operator_concat (enumerator_15471.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (374)) COMMA_SOURCE_FILE_AT_LINE (374)).operator_concat (GALGAS_string ("' feature; available features are:") COMMA_SOURCE_FILE_AT_LINE (374)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (374)) COMMA_SOURCE_FILE_AT_LINE (374)) ;
    }
    enumerator_15471.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_29 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).operator_and (constinArgument_inProjectQualifiedFeatureMap.reader_hasKey (GALGAS_string ("applicationBundleBase") COMMA_SOURCE_FILE_AT_LINE (378)).operator_not (SOURCE_FILE_AT_LINE (378)) COMMA_SOURCE_FILE_AT_LINE (378)).boolEnum () ;
  if (kBoolTrue == test_29) {
    ...
    inCompiler->emitSemanticWarning (location_30, GALGAS_string ("For a Cocoa project, the \"applicationBundleBase\" feature should be set; for example: 'feature applicationBundleBase : \"fr.what\" ;'") COMMA_SOURCE_FILE_AT_LINE (379)) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_31 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_macosx") COMMA_SOURCE_FILE_AT_LINE (382)).boolEnum () ;
  if (kBoolTrue == test_31) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateMakefileMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (383)) ;
    } //-------- @routineCallInstructionForGeneration
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_32 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_unix") COMMA_SOURCE_FILE_AT_LINE (385)).boolEnum () ;
  if (kBoolTrue == test_32) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateMakefileUnixTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (386)) ;
    } //-------- @routineCallInstructionForGeneration
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_33 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_i386_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (388)).boolEnum () ;
  if (kBoolTrue == test_33) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateI_33__38__36_LinuxOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (389)) ;
    } //-------- @routineCallInstructionForGeneration
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_34 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_x86_64_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (391)).boolEnum () ;
  if (kBoolTrue == test_34) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateX_38__36__5F__36__34_LinuxOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (392)) ;
    } //-------- @routineCallInstructionForGeneration
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_35 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_mingw_on_macosx") COMMA_SOURCE_FILE_AT_LINE (394)).boolEnum () ;
  if (kBoolTrue == test_35) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateMinGWOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (395)) ;
    } //-------- @routineCallInstructionForGeneration
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_36 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_msys_on_win32") COMMA_SOURCE_FILE_AT_LINE (397)).boolEnum () ;
  if (kBoolTrue == test_36) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateMsysOnWin_33__32_Target (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (398)) ;
    } //-------- @routineCallInstructionForGeneration
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  GALGAS_string var_newFileListContents = GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_file_5F_list (inCompiler, var_handCodedSourceDirectorySet, var_handCodedSourceList, var_generatedFileListForMakefile, var_libpmPath, temp_37 COMMA_SOURCE_FILE_AT_LINE (401))) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_fileListPath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (408)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/file_list.mak") COMMA_SOURCE_FILE_AT_LINE (408)) ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_18646_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_18646_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (409)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_previousFileListPath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (410)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/file_list.mke") COMMA_SOURCE_FILE_AT_LINE (410)) ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_string::class_method_deleteFileIfExists (var_previousFileListPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (411)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_39 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_39) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_dir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode") COMMA_SOURCE_FILE_AT_LINE (414)) ;
    //-------- @methodCallInstructionForGeneration
    var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (415)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_icon_5F_help_5F_file_5F_path = var_dir.operator_concat (GALGAS_string ("/adding-icons-to-your-application.rtf") COMMA_SOURCE_FILE_AT_LINE (417)) ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_19238_0 ; // Joker input parameter
    GALGAS_string (gWrapperFileContent_15_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_icon_5F_help_5F_file_5F_path, joker_19238_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (418)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_string var_applicationBundleBase ;
    //-------- @readOnlyWithInstructionForGeneration
    const cMapElement_projectQualifiedFeatureMap * objectArray_19333 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_19333) {
        macroValidSharedObject (objectArray_19333, const cMapElement_projectQualifiedFeatureMap) ;
      //-------- @assignmentInstructionForGeneration
      var_applicationBundleBase = objectArray_19333->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
      //-------- @assignmentInstructionForGeneration
      var_applicationBundleBase = GALGAS_string ("fr.irccyn") ;
    }
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_InfoPlistContents = GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_info_5F_plist (inCompiler, constinArgument_inTargetName, var_applicationBundleBase, constinArgument_inProjectVersionString, constinArgument_inHandledExtensionSet COMMA_SOURCE_FILE_AT_LINE (426))) ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_19781_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist") COMMA_SOURCE_FILE_AT_LINE (432)), joker_19781_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (432)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_40 = var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (434)).reader_fileExists (SOURCE_FILE_AT_LINE (434)).operator_not (SOURCE_FILE_AT_LINE (434)).boolEnum () ;
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_20268_0 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (440))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_20268_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (440)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_41 = var_Credits_5F_rtf_5F_path.reader_fileExists (SOURCE_FILE_AT_LINE (442)).operator_not (SOURCE_FILE_AT_LINE (442)).boolEnum () ;
    if (kBoolTrue == test_41) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string (gWrapperFileContent_17_targetGenerationFileWrapper).method_writeToFile (var_Credits_5F_rtf_5F_path, inCompiler COMMA_SOURCE_FILE_AT_LINE (443)) ;
      //-------- END @methodCallInstructionForGeneration
    }
    //-------- @readOnlyWithInstructionForGeneration
    const cMapElement_projectQualifiedFeatureMap * objectArray_20598 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_20598) {
        macroValidSharedObject (objectArray_20598, const cMapElement_projectQualifiedFeatureMap) ;
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_applicationUpdateDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/cocoa-application-update/application") COMMA_SOURCE_FILE_AT_LINE (447)) ;
      //-------- @methodCallInstructionForGeneration
      var_applicationUpdateDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (448)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_20950_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (449))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h") COMMA_SOURCE_FILE_AT_LINE (449)), joker_20950_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (449)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_21250_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, constinArgument_inTargetName, objectArray_20598->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE_AT_LINE (450))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m") COMMA_SOURCE_FILE_AT_LINE (455)), joker_21250_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (450)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_21448_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_nib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (458))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib") COMMA_SOURCE_FILE_AT_LINE (458)), joker_21448_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (458)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_21602_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (459))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h") COMMA_SOURCE_FILE_AT_LINE (459)), joker_21602_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (459)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_21764_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (460))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m") COMMA_SOURCE_FILE_AT_LINE (460)), joker_21764_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (460)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_21918_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (461))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h") COMMA_SOURCE_FILE_AT_LINE (461)), joker_21918_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (461)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_22080_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (462))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m") COMMA_SOURCE_FILE_AT_LINE (462)), joker_22080_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (462)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_22250_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (463))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h") COMMA_SOURCE_FILE_AT_LINE (463)), joker_22250_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (463)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_string var_codeSignIdentity ;
      //-------- @readOnlyWithInstructionForGeneration
      const cMapElement_projectQualifiedFeatureMap * objectArray_22348 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_22348) {
          macroValidSharedObject (objectArray_22348, const cMapElement_projectQualifiedFeatureMap) ;
        //-------- @assignmentInstructionForGeneration
        var_codeSignIdentity = objectArray_22348->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
        //-------- @assignmentInstructionForGeneration
        var_codeSignIdentity = GALGAS_string::makeEmptyString () ;
      }
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_updaterToolDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/cocoa-application-update/updater-tool") COMMA_SOURCE_FILE_AT_LINE (471)) ;
      //-------- @methodCallInstructionForGeneration
      var_updaterToolDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (472)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_22789_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_protocol (inCompiler COMMA_SOURCE_FILE_AT_LINE (473))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerProtocol.h") COMMA_SOURCE_FILE_AT_LINE (473)), joker_22789_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (473)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_22939_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (474))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.h") COMMA_SOURCE_FILE_AT_LINE (474)), joker_22939_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (474)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_23097_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (475))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.m") COMMA_SOURCE_FILE_AT_LINE (475)), joker_23097_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (475)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_23355_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_tool_5F_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE_AT_LINE (476))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Info.plist") COMMA_SOURCE_FILE_AT_LINE (481)), joker_23355_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (476)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_23599_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_tool_5F_launchd_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (484))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Launchd.plist") COMMA_SOURCE_FILE_AT_LINE (488)), joker_23599_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (484)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_23829_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_main (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (491))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-main.m") COMMA_SOURCE_FILE_AT_LINE (495)), joker_23829_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (491)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_updaterApplicationDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/cocoa-application-update/updater-application") COMMA_SOURCE_FILE_AT_LINE (499)) ;
      //-------- @methodCallInstructionForGeneration
      var_updaterApplicationDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (500)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_24200_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE_AT_LINE (501))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf") COMMA_SOURCE_FILE_AT_LINE (501)), joker_24200_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (501)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_24379_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE_AT_LINE (502))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings") COMMA_SOURCE_FILE_AT_LINE (502)), joker_24379_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (502)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_24562_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (503))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib") COMMA_SOURCE_FILE_AT_LINE (503)), joker_24562_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (503)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_24731_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (504))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h") COMMA_SOURCE_FILE_AT_LINE (504)), joker_24731_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (504)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_24978_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (505))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m") COMMA_SOURCE_FILE_AT_LINE (509)), joker_24978_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (505)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_25234_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE_AT_LINE (511))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist") COMMA_SOURCE_FILE_AT_LINE (516)), joker_25234_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (511)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_25383_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE_AT_LINE (518))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m") COMMA_SOURCE_FILE_AT_LINE (518)), joker_25383_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (518)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_25531_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_prefix (inCompiler COMMA_SOURCE_FILE_AT_LINE (519))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Prefix.pch") COMMA_SOURCE_FILE_AT_LINE (519)), joker_25531_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (519)) ;
      //-------- END @methodCallInstructionForGeneration
    }
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_userResourceDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/userResources") COMMA_SOURCE_FILE_AT_LINE (522)) ;
    //-------- @methodCallInstructionForGeneration
    var_userResourceDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (523)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringlist var_extensionList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (524)) ;
    //-------- @plusEqualnstructionForGeneration
    var_extensionList.addAssign_operation (GALGAS_string ("icns") COMMA_SOURCE_FILE_AT_LINE (525)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_stringlist var_resourceFiles = var_userResourceDir.reader_regularFilesWithExtensions (GALGAS_bool (false), var_extensionList COMMA_SOURCE_FILE_AT_LINE (526)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_xcodeProjectPath = var_dir.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (528)).operator_concat (constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (528)).operator_concat (GALGAS_string (".xcodeproj") COMMA_SOURCE_FILE_AT_LINE (528)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_intermediateFilePath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (529)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/file_list_for_xcode_project.txt") COMMA_SOURCE_FILE_AT_LINE (529)) ;
    //-------- @methodCallInstructionForGeneration
    var_xcodeProjectPath.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (531)) ;
    //-------- END @methodCallInstructionForGeneration
    { //-------- @routineCallInstructionForGeneration
