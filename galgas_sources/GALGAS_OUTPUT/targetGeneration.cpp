...
void routine_generateMsysOnWin_33__32_Target (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile_msys_on_win32") COMMA_SOURCE_FILE_AT_LINE (123)) ;
  //-------- @methodCallInstructionForGeneration
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (124)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_4694_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_7_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.bat") COMMA_SOURCE_FILE_AT_LINE (125)), joker_4694_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (125)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_4832_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_8_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.bat") COMMA_SOURCE_FILE_AT_LINE (126)), joker_4832_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_4974_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_9_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.bat") COMMA_SOURCE_FILE_AT_LINE (127)), joker_4974_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (127)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_5123_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_msys_5F_on_5F_win_33__32__5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (128))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile") COMMA_SOURCE_FILE_AT_LINE (128)), joker_5123_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (128)) ;
  //-------- END @methodCallInstructionForGeneration
}
...
void routine_generateMinGWOnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                          ...
                                          COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile_mingw_on_macosx") COMMA_SOURCE_FILE_AT_LINE (137)) ;
  //-------- @methodCallInstructionForGeneration
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (138)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_5574_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_5_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (139)), joker_5574_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (139)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_5732_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_6_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command") COMMA_SOURCE_FILE_AT_LINE (140)), joker_5732_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (140)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_5883_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_mingw_5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (141))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile") COMMA_SOURCE_FILE_AT_LINE (141)), joker_5883_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (141)) ;
  //-------- END @methodCallInstructionForGeneration
}
...
void routine_generateMakefileMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                           ...
                                           COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile_macosx") COMMA_SOURCE_FILE_AT_LINE (150)) ;
  //-------- @methodCallInstructionForGeneration
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (151)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_6317_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_2_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (152)), joker_6317_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (152)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_6466_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_3_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command") COMMA_SOURCE_FILE_AT_LINE (153)), joker_6466_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (153)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_6619_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_4_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.command") COMMA_SOURCE_FILE_AT_LINE (154)), joker_6619_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (154)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_6761_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (155))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile") COMMA_SOURCE_FILE_AT_LINE (155)), joker_6761_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (155)) ;
  //-------- END @methodCallInstructionForGeneration
}
...
void routine_generateMakefileUnixTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                         ...
                                         COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile_unix") COMMA_SOURCE_FILE_AT_LINE (164)) ;
  //-------- @methodCallInstructionForGeneration
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (165)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_7189_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_10_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (166)), joker_7189_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (166)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_7340_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_12_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.command") COMMA_SOURCE_FILE_AT_LINE (167)), joker_7340_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (167)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_7487_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_11_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command") COMMA_SOURCE_FILE_AT_LINE (168)), joker_7487_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_7627_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_unix_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (169))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile") COMMA_SOURCE_FILE_AT_LINE (169)), joker_7627_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (169)) ;
  //-------- END @methodCallInstructionForGeneration
}
...
void routine_generateI_33__38__36_LinuxOnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                       ...
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile_i386_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (178)) ;
  //-------- @methodCallInstructionForGeneration
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (179)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_8092_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_0_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (180)), joker_8092_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (180)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_8255_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_1_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command") COMMA_SOURCE_FILE_AT_LINE (181)), joker_8255_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (181)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_8411_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_i_33__38__36__5F_linux_5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (182))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile") COMMA_SOURCE_FILE_AT_LINE (182)), joker_8411_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (182)) ;
  //-------- END @methodCallInstructionForGeneration
}
...
void routine_generateX_38__36__5F__36__34_LinuxOnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
                                                               ...
                                                               COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_dir = constinArgument_inProjectDirectory.operator_concat (GALGAS_string ("/makefile_x86_64_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (191)) ;
  //-------- @methodCallInstructionForGeneration
  var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (192)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_8882_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_13_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (193)), joker_8882_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (193)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_9047_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_14_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command") COMMA_SOURCE_FILE_AT_LINE (194)), joker_9047_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (194)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_9205_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_x_38__36__5F__36__34__5F_linux_5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (195))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile") COMMA_SOURCE_FILE_AT_LINE (195)), joker_9205_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (195)) ;
  //-------- END @methodCallInstructionForGeneration
}
...
void routine_updateTargets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
                            ...
                            COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_projectDirectory = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (210)).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (210)) ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_10014_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_project_5F_header (inCompiler, constinArgument_inProjectVersionString COMMA_SOURCE_FILE_AT_LINE (212))).method_writeToFileWhenDifferentContents (constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (213)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/project_header.h") COMMA_SOURCE_FILE_AT_LINE (213)), joker_10014_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (212)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_string var_libpmPath ;
  //-------- @readOnlyWithInstructionForGeneration
  const cMapElement_projectQualifiedFeatureMap * objectArray_10096 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("libpmAtPath")) ;
  if (NULL != objectArray_10096) {
      macroValidSharedObject (objectArray_10096, const cMapElement_projectQualifiedFeatureMap) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, objectArray_10096->mAttribute_mFeatureValue.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (objectArray_10096->mAttribute_mFeatureValue.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the libpm path should not be empty") COMMA_SOURCE_FILE_AT_LINE (220)) ;
      var_libpmPath.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_libpmPath = objectArray_10096->mAttribute_mFeatureValue.mAttribute_string ;
    }
  }else{
    { //-------- @routineCallInstructionForGeneration
    routine_updateLIBPMatPath (constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (225)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/libpm") COMMA_SOURCE_FILE_AT_LINE (225)), inCompiler COMMA_SOURCE_FILE_AT_LINE (225)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_libpmPath = GALGAS_string ("../galgas_sources/GALGAS_OUTPUT/libpm") ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_libpmAbsolutePath = var_libpmPath.reader_absolutePathFromPath (constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (227)) COMMA_SOURCE_FILE_AT_LINE (227)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_libpmAbsolutePath.reader_directoryExists (SOURCE_FILE_AT_LINE (228)).operator_not (SOURCE_FILE_AT_LINE (228)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE_AT_LINE (229)), GALGAS_string ("the '").operator_concat (var_libpmAbsolutePath COMMA_SOURCE_FILE_AT_LINE (229)).operator_concat (GALGAS_string ("'  LIBPM directory does not exists") COMMA_SOURCE_FILE_AT_LINE (229)) COMMA_SOURCE_FILE_AT_LINE (229)) ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_externSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (233)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_guiSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (234)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_scannerSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (235)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_optionSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (236)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_semanticsSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (237)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_syntaxSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (238)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_grammarSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (239)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_programSourceSet_5F_tool = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (240)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_externSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (242)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_guiSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (243)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_scannerSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (244)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_optionSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (245)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_semanticsSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (246)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_syntaxSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (247)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_grammarSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (248)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_programSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (249)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_sourceFileSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (251)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringlist var_generatedFileListForMakefile = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (252)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringlist var_handCodedSourceList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (253)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_handCodedSourceDirectorySet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (254)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_projectSourceList enumerator_11864 (constinArgument_inProjectSourceList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_11864.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_baseName = enumerator_11864.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (256)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (256)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (256)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_extension = enumerator_11864.current_mFilePath (HERE).mAttribute_string.reader_pathExtension (SOURCE_FILE_AT_LINE (257)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_cppFile = var_baseName.operator_concat (GALGAS_string (".cpp") COMMA_SOURCE_FILE_AT_LINE (258)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = var_sourceFileSet.reader_hasKey (var_baseName COMMA_SOURCE_FILE_AT_LINE (260)).operator_and (GALGAS_bool (kIsNotEqual, var_extension.objectCompare (GALGAS_string ("h"))) COMMA_SOURCE_FILE_AT_LINE (260)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_11864.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, GALGAS_string ("there is already a file with '").operator_concat (var_baseName COMMA_SOURCE_FILE_AT_LINE (261)).operator_concat (GALGAS_string ("' as base name in the project") COMMA_SOURCE_FILE_AT_LINE (261)) COMMA_SOURCE_FILE_AT_LINE (261)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_sourceFileSet.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (263)) ;
    //------- @switchInstructionForGeneration
    if (enumerator_11864.current_mSourceKind (HERE).isValid ()) {
      switch (enumerator_11864.current_mSourceKind (HERE).enumValue ()) {
      case GALGAS_sourceFileKind::kNotBuilt:
        break ;
      case GALGAS_sourceFileKind::kEnum_externSourceFile: {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("cpp"))).operator_or (GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("mm"))) COMMA_SOURCE_FILE_AT_LINE (267)).operator_or (GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("framework"))) COMMA_SOURCE_FILE_AT_LINE (267)).boolEnum () ;
        if (kBoolTrue == test_5) {
          //-------- @plusEqualnstructionForGeneration
          var_externSourceSet_5F_tool.addAssign_operation (enumerator_11864.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (268)) COMMA_SOURCE_FILE_AT_LINE (268)) ;
          //-------- @plusEqualnstructionForGeneration
          var_handCodedSourceList.addAssign_operation (enumerator_11864.current_mFilePath (HERE).mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (269)) COMMA_SOURCE_FILE_AT_LINE (269)) ;
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_11864.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (270)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_6) {
            //-------- @plusEqualnstructionForGeneration
            var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources") COMMA_SOURCE_FILE_AT_LINE (271)) ;
          }else if (kBoolFalse == test_6) {
            //-------- @plusEqualnstructionForGeneration
            var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11864.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (273)) COMMA_SOURCE_FILE_AT_LINE (273)) COMMA_SOURCE_FILE_AT_LINE (273)) ;
          }
          ...
          if (kBoolTrue == test_7) {
            //-------- @plusEqualnstructionForGeneration
            var_externSourceSet_5F_app.addAssign_operation (enumerator_11864.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (276)) COMMA_SOURCE_FILE_AT_LINE (276)) ;
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_11864.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (277)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_8) {
              //-------- @plusEqualnstructionForGeneration
              var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources") COMMA_SOURCE_FILE_AT_LINE (278)) ;
            }else if (kBoolFalse == test_8) {
              //-------- @plusEqualnstructionForGeneration
              var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11864.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (280)) COMMA_SOURCE_FILE_AT_LINE (280)) COMMA_SOURCE_FILE_AT_LINE (280)) ;
            }
            ...
            if (kBoolTrue == test_9) {
              //-------- @plusEqualnstructionForGeneration
              var_externSourceSet_5F_tool.addAssign_operation (enumerator_11864.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (283)) COMMA_SOURCE_FILE_AT_LINE (283)) ;
              //-------- @ifInstructionForGeneration
              const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_11864.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (284)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_10) {
                //-------- @plusEqualnstructionForGeneration
                var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources") COMMA_SOURCE_FILE_AT_LINE (285)) ;
              }else if (kBoolFalse == test_10) {
                //-------- @plusEqualnstructionForGeneration
                var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11864.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (287)) COMMA_SOURCE_FILE_AT_LINE (287)) COMMA_SOURCE_FILE_AT_LINE (287)) ;
              }
            }else if (kBoolFalse == test_9) {
              //-------- @errorInstructionForGeneration
              GALGAS_location location_11 (enumerator_11864.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_11, GALGAS_string ("unhandled extension") COMMA_SOURCE_FILE_AT_LINE (290)) ;
            }
          }
        }
        } break ;
      case GALGAS_sourceFileKind::kEnum_lexiqueSourceFile: {
        //-------- @plusEqualnstructionForGeneration
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile COMMA_SOURCE_FILE_AT_LINE (293)) ;
        //-------- @plusEqualnstructionForGeneration
        var_scannerSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (294)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_syntaxSourceFile: {
        //-------- @plusEqualnstructionForGeneration
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile COMMA_SOURCE_FILE_AT_LINE (296)) ;
        //-------- @plusEqualnstructionForGeneration
        var_syntaxSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (297)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_semanticsSourceFile: {
        //-------- @plusEqualnstructionForGeneration
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile COMMA_SOURCE_FILE_AT_LINE (299)) ;
        //-------- @plusEqualnstructionForGeneration
        var_semanticsSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (300)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_grammarSourceFile: {
        //-------- @plusEqualnstructionForGeneration
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile COMMA_SOURCE_FILE_AT_LINE (302)) ;
        //-------- @plusEqualnstructionForGeneration
        var_grammarSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (303)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_programSourceFile: {
        //-------- @plusEqualnstructionForGeneration
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile COMMA_SOURCE_FILE_AT_LINE (305)) ;
        //-------- @plusEqualnstructionForGeneration
        var_programSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (306)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_optionSourceFile: {
        //-------- @plusEqualnstructionForGeneration
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile COMMA_SOURCE_FILE_AT_LINE (308)) ;
        //-------- @plusEqualnstructionForGeneration
        var_optionSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (309)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_guiSourceFile: {
        //-------- @plusEqualnstructionForGeneration
        var_guiSourceSet_5F_app.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (311)) ;
        } break ;
      }
    }
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_availableGenerationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (318)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_macosx") COMMA_SOURCE_FILE_AT_LINE (319)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_unix") COMMA_SOURCE_FILE_AT_LINE (320)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_i386_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (321)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_x86_64_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (322)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_mingw_on_macosx") COMMA_SOURCE_FILE_AT_LINE (323)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_msys_on_win32") COMMA_SOURCE_FILE_AT_LINE (324)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("SnowLeopard") COMMA_SOURCE_FILE_AT_LINE (325)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Lion") COMMA_SOURCE_FILE_AT_LINE (326)) ;
  //-------- @plusEqualnstructionForGeneration
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("MountainLion") COMMA_SOURCE_FILE_AT_LINE (327)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_generationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (329)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_15443 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_15443.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_13 = var_availableGenerationFeatures.reader_hasKey (enumerator_15443.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (335)) COMMA_SOURCE_FILE_AT_LINE (335)).boolEnum () ;
    if (kBoolTrue == test_13) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_14 = var_generationFeatures.reader_hasKey (enumerator_15443.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (336)) COMMA_SOURCE_FILE_AT_LINE (336)).boolEnum () ;
      if (kBoolTrue == test_14) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_15 (enumerator_15443.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_15, GALGAS_string ("duplicate '").operator_concat (enumerator_15443.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (337)) COMMA_SOURCE_FILE_AT_LINE (337)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (337)) COMMA_SOURCE_FILE_AT_LINE (337)) ;
      }
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_16 = GALGAS_bool (kIsEqual, enumerator_15443.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_16) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_17 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_17) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_18 (enumerator_15443.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_18, GALGAS_string ("duplicate '").operator_concat (enumerator_15443.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (342)) COMMA_SOURCE_FILE_AT_LINE (342)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (342)) COMMA_SOURCE_FILE_AT_LINE (342)) ;
        }
        //-------- @assignmentInstructionForGeneration
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_16) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_19 = GALGAS_bool (kIsEqual, enumerator_15443.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_19) {
          ...
          if (kBoolTrue == test_20) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_21 (enumerator_15443.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_21, GALGAS_string ("the \"SnowLeopard\", \"Lion\" and \"MountainLion\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (348)) ;
          }
          //-------- @assignmentInstructionForGeneration
          var_SDK = GALGAS_string ("macosx10.6") ;
        }else if (kBoolFalse == test_19) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_22 = GALGAS_bool (kIsEqual, enumerator_15443.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_22) {
            ...
            if (kBoolTrue == test_23) {
              //-------- @errorInstructionForGeneration
              GALGAS_location location_24 (enumerator_15443.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_24, GALGAS_string ("the \"SnowLeopard\", \"Lion\" and \"MountainLion\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (354)) ;
            }
            //-------- @assignmentInstructionForGeneration
            ...
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_25 = GALGAS_bool (kIsEqual, enumerator_15443.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_25) {
              ...
              if (kBoolTrue == test_26) {
                //-------- @errorInstructionForGeneration
                GALGAS_location location_27 (enumerator_15443.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_27, GALGAS_string ("the \"SnowLeopard\", \"Lion\" and \"MountainLion\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (361)) ;
              }
              //-------- @assignmentInstructionForGeneration
              ...
              //-------- @plusEqualnstructionForGeneration
              var_generationFeatures.addAssign_operation (enumerator_15443.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (366)) COMMA_SOURCE_FILE_AT_LINE (366)) ;
            }
          }
        }
      }
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_16785 (var_availableGenerationFeatures, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_16785.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_16785.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (371)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (371)) ;
        enumerator_16785.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_28 (enumerator_15443.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_28, GALGAS_string ("unknown '").operator_concat (enumerator_15443.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (373)) COMMA_SOURCE_FILE_AT_LINE (373)).operator_concat (GALGAS_string ("' feature; available features are:") COMMA_SOURCE_FILE_AT_LINE (373)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (373)) COMMA_SOURCE_FILE_AT_LINE (373)) ;
    }
    enumerator_15443.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_29 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).operator_and (constinArgument_inProjectQualifiedFeatureMap.reader_hasKey (GALGAS_string ("applicationBundleBase") COMMA_SOURCE_FILE_AT_LINE (377)).operator_not (SOURCE_FILE_AT_LINE (377)) COMMA_SOURCE_FILE_AT_LINE (377)).boolEnum () ;
  if (kBoolTrue == test_29) {
    ...
    inCompiler->emitSemanticWarning (location_30, GALGAS_string ("For a Cocoa project, the \"applicationBundleBase\" feature should be set; for example: 'feature applicationBundleBase : \"fr.what\" ;'") COMMA_SOURCE_FILE_AT_LINE (378)) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_31 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_macosx") COMMA_SOURCE_FILE_AT_LINE (381)).boolEnum () ;
  if (kBoolTrue == test_31) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateMakefileMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (382)) ;
    } //-------- @routineCallInstructionForGeneration
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_32 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_unix") COMMA_SOURCE_FILE_AT_LINE (384)).boolEnum () ;
  if (kBoolTrue == test_32) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateMakefileUnixTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (385)) ;
    } //-------- @routineCallInstructionForGeneration
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_33 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_i386_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (387)).boolEnum () ;
  if (kBoolTrue == test_33) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateI_33__38__36_LinuxOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (388)) ;
    } //-------- @routineCallInstructionForGeneration
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_34 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_x86_64_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (390)).boolEnum () ;
  if (kBoolTrue == test_34) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateX_38__36__5F__36__34_LinuxOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (391)) ;
    } //-------- @routineCallInstructionForGeneration
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_35 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_mingw_on_macosx") COMMA_SOURCE_FILE_AT_LINE (393)).boolEnum () ;
  if (kBoolTrue == test_35) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateMinGWOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (394)) ;
    } //-------- @routineCallInstructionForGeneration
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_36 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_msys_on_win32") COMMA_SOURCE_FILE_AT_LINE (396)).boolEnum () ;
  if (kBoolTrue == test_36) {
    { //-------- @routineCallInstructionForGeneration
    routine_generateMsysOnWin_33__32_Target (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (397)) ;
    } //-------- @routineCallInstructionForGeneration
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  GALGAS_string var_newFileListContents = GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_file_5F_list (inCompiler, var_handCodedSourceDirectorySet, var_handCodedSourceList, var_generatedFileListForMakefile, var_libpmPath, temp_37 COMMA_SOURCE_FILE_AT_LINE (400))) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_fileListPath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (407)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/file_list.mak") COMMA_SOURCE_FILE_AT_LINE (407)) ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_18618_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_18618_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (408)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_previousFileListPath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (409)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/file_list.mke") COMMA_SOURCE_FILE_AT_LINE (409)) ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_string::class_method_deleteFileIfExists (var_previousFileListPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (410)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_39 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_39) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_dir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode") COMMA_SOURCE_FILE_AT_LINE (413)) ;
    //-------- @methodCallInstructionForGeneration
    var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (414)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_icon_5F_help_5F_file_5F_path = var_dir.operator_concat (GALGAS_string ("/adding-icons-to-your-application.rtf") COMMA_SOURCE_FILE_AT_LINE (416)) ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_19210_0 ; // Joker input parameter
    GALGAS_string (gWrapperFileContent_15_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_icon_5F_help_5F_file_5F_path, joker_19210_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (417)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_string var_applicationBundleBase ;
    //-------- @readOnlyWithInstructionForGeneration
    const cMapElement_projectQualifiedFeatureMap * objectArray_19305 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_19305) {
        macroValidSharedObject (objectArray_19305, const cMapElement_projectQualifiedFeatureMap) ;
      //-------- @assignmentInstructionForGeneration
      var_applicationBundleBase = objectArray_19305->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
      //-------- @assignmentInstructionForGeneration
      var_applicationBundleBase = GALGAS_string ("fr.irccyn") ;
    }
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_InfoPlistContents = GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_info_5F_plist (inCompiler, constinArgument_inTargetName, var_applicationBundleBase, constinArgument_inHandledExtensionSet COMMA_SOURCE_FILE_AT_LINE (425))) ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_19723_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist") COMMA_SOURCE_FILE_AT_LINE (430)), joker_19723_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (430)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_40 = var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (432)).reader_fileExists (SOURCE_FILE_AT_LINE (432)).operator_not (SOURCE_FILE_AT_LINE (432)).boolEnum () ;
    if (kBoolTrue == test_40) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_build_5F_xcode (inCompiler COMMA_SOURCE_FILE_AT_LINE (433))).method_writeToExecutableFile (var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (433)), inCompiler COMMA_SOURCE_FILE_AT_LINE (433)) ;
      //-------- END @methodCallInstructionForGeneration
    }
    //-------- @methodCallInstructionForGeneration
    var_dir.operator_concat (GALGAS_string ("/English.lproj") COMMA_SOURCE_FILE_AT_LINE (436)).method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (436)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_InfoPlist_5F_strings_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/InfoPlist.strings") COMMA_SOURCE_FILE_AT_LINE (437)) ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_20210_0 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (438))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_20210_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (438)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_Credits_5F_rtf_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/Credits.rtf") COMMA_SOURCE_FILE_AT_LINE (439)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_41 = var_Credits_5F_rtf_5F_path.reader_fileExists (SOURCE_FILE_AT_LINE (440)).operator_not (SOURCE_FILE_AT_LINE (440)).boolEnum () ;
    if (kBoolTrue == test_41) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string (gWrapperFileContent_17_targetGenerationFileWrapper).method_writeToFile (var_Credits_5F_rtf_5F_path, inCompiler COMMA_SOURCE_FILE_AT_LINE (441)) ;
      //-------- END @methodCallInstructionForGeneration
    }
    //-------- @readOnlyWithInstructionForGeneration
    const cMapElement_projectQualifiedFeatureMap * objectArray_20540 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_20540) {
        macroValidSharedObject (objectArray_20540, const cMapElement_projectQualifiedFeatureMap) ;
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_applicationUpdateDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/cocoa-application-update/application") COMMA_SOURCE_FILE_AT_LINE (445)) ;
      //-------- @methodCallInstructionForGeneration
      var_applicationUpdateDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (446)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_20892_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (447))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h") COMMA_SOURCE_FILE_AT_LINE (447)), joker_20892_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (447)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_21192_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, constinArgument_inTargetName, objectArray_20540->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE_AT_LINE (448))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m") COMMA_SOURCE_FILE_AT_LINE (453)), joker_21192_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (448)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_21390_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_nib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (456))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib") COMMA_SOURCE_FILE_AT_LINE (456)), joker_21390_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (456)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_21544_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (457))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h") COMMA_SOURCE_FILE_AT_LINE (457)), joker_21544_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (457)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_21706_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (458))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m") COMMA_SOURCE_FILE_AT_LINE (458)), joker_21706_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (458)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_21860_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (459))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h") COMMA_SOURCE_FILE_AT_LINE (459)), joker_21860_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (459)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_22022_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (460))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m") COMMA_SOURCE_FILE_AT_LINE (460)), joker_22022_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (460)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_22192_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (461))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h") COMMA_SOURCE_FILE_AT_LINE (461)), joker_22192_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (461)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_string var_codeSignIdentity ;
      //-------- @readOnlyWithInstructionForGeneration
      const cMapElement_projectQualifiedFeatureMap * objectArray_22290 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_22290) {
          macroValidSharedObject (objectArray_22290, const cMapElement_projectQualifiedFeatureMap) ;
        //-------- @assignmentInstructionForGeneration
        var_codeSignIdentity = objectArray_22290->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
        //-------- @assignmentInstructionForGeneration
        var_codeSignIdentity = GALGAS_string::makeEmptyString () ;
      }
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_updaterToolDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/cocoa-application-update/updater-tool") COMMA_SOURCE_FILE_AT_LINE (469)) ;
      //-------- @methodCallInstructionForGeneration
      var_updaterToolDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (470)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_22731_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_protocol (inCompiler COMMA_SOURCE_FILE_AT_LINE (471))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerProtocol.h") COMMA_SOURCE_FILE_AT_LINE (471)), joker_22731_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (471)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_22881_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (472))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.h") COMMA_SOURCE_FILE_AT_LINE (472)), joker_22881_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (472)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_23039_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (473))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.m") COMMA_SOURCE_FILE_AT_LINE (473)), joker_23039_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (473)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_23297_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_tool_5F_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE_AT_LINE (474))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Info.plist") COMMA_SOURCE_FILE_AT_LINE (479)), joker_23297_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (474)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_23541_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_tool_5F_launchd_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (482))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Launchd.plist") COMMA_SOURCE_FILE_AT_LINE (486)), joker_23541_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (482)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_23771_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_main (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (489))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-main.m") COMMA_SOURCE_FILE_AT_LINE (493)), joker_23771_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (489)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_updaterApplicationDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/cocoa-application-update/updater-application") COMMA_SOURCE_FILE_AT_LINE (497)) ;
      //-------- @methodCallInstructionForGeneration
      var_updaterApplicationDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (498)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_24142_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE_AT_LINE (499))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf") COMMA_SOURCE_FILE_AT_LINE (499)), joker_24142_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (499)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_24321_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE_AT_LINE (500))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings") COMMA_SOURCE_FILE_AT_LINE (500)), joker_24321_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (500)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_24504_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (501))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib") COMMA_SOURCE_FILE_AT_LINE (501)), joker_24504_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (501)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_24673_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (502))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h") COMMA_SOURCE_FILE_AT_LINE (502)), joker_24673_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (502)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_24920_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (503))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m") COMMA_SOURCE_FILE_AT_LINE (507)), joker_24920_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (503)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_25176_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE_AT_LINE (509))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist") COMMA_SOURCE_FILE_AT_LINE (514)), joker_25176_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (509)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_25325_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE_AT_LINE (516))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m") COMMA_SOURCE_FILE_AT_LINE (516)), joker_25325_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (516)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_25473_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_prefix (inCompiler COMMA_SOURCE_FILE_AT_LINE (517))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Prefix.pch") COMMA_SOURCE_FILE_AT_LINE (517)), joker_25473_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (517)) ;
      //-------- END @methodCallInstructionForGeneration
    }
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_userResourceDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/userResources") COMMA_SOURCE_FILE_AT_LINE (520)) ;
    //-------- @methodCallInstructionForGeneration
    var_userResourceDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (521)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringlist var_extensionList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (522)) ;
    //-------- @plusEqualnstructionForGeneration
    var_extensionList.addAssign_operation (GALGAS_string ("icns") COMMA_SOURCE_FILE_AT_LINE (523)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_stringlist var_resourceFiles = var_userResourceDir.reader_regularFilesWithExtensions (GALGAS_bool (false), var_extensionList COMMA_SOURCE_FILE_AT_LINE (524)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_xcodeProjectPath = var_dir.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (526)).operator_concat (constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (526)).operator_concat (GALGAS_string (".xcodeproj") COMMA_SOURCE_FILE_AT_LINE (526)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_intermediateFilePath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (527)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/file_list_for_xcode_project.txt") COMMA_SOURCE_FILE_AT_LINE (527)) ;
    //-------- @methodCallInstructionForGeneration
    var_xcodeProjectPath.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (529)) ;
    //-------- END @methodCallInstructionForGeneration
    { //-------- @routineCallInstructionForGeneration
