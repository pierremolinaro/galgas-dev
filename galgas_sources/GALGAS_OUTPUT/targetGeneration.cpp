...
void routine_updateTargets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
  ...
  while (enumerator_11892.hasCurrentObject ()) {
    ...
    if (enumerator_11892.current_mSourceKind (HERE).isValid ()) {
      ...
      case GALGAS_sourceFileKind::kEnum_externSourceFile: {
        const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("cpp"))).operator_or (GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("mm"))) COMMA_SOURCE_FILE_AT_LINE (268)).operator_or (GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("framework"))) COMMA_SOURCE_FILE_AT_LINE (268)).boolEnum () ;
        if (kBoolTrue == test_5) {
          ...
          if (kBoolTrue == test_7) {
            var_externSourceSet_5F_app.addAssign_operation (enumerator_11892.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (277)) ;
            const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_11892.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (278)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_8) {
              var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources") COMMA_SOURCE_FILE_AT_LINE (279)) ;
            }else if (kBoolFalse == test_8) {
              var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11892.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (281)) COMMA_SOURCE_FILE_AT_LINE (281)) COMMA_SOURCE_FILE_AT_LINE (281)) ;
            }
          }else if (kBoolFalse == test_7) {
            const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("h"))).boolEnum () ;
            if (kBoolTrue == test_9) {
              var_externSourceSet_5F_tool.addAssign_operation (enumerator_11892.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (284)) COMMA_SOURCE_FILE_AT_LINE (284)) ;
              const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_11892.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (285)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_10) {
                var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources") COMMA_SOURCE_FILE_AT_LINE (286)) ;
              }else if (kBoolFalse == test_10) {
                var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11892.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (288)) COMMA_SOURCE_FILE_AT_LINE (288)) COMMA_SOURCE_FILE_AT_LINE (288)) ;
              }
            }else if (kBoolFalse == test_9) {
              const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("xib"))).boolEnum () ;
              if (kBoolTrue == test_11) {
                var_externSourceSet_5F_app.addAssign_operation (enumerator_11892.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (291)) COMMA_SOURCE_FILE_AT_LINE (291)) ;
                const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_11892.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (292)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_12) {
                  var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources") COMMA_SOURCE_FILE_AT_LINE (293)) ;
                }else if (kBoolFalse == test_12) {
                  var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11892.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (295)) COMMA_SOURCE_FILE_AT_LINE (295)) COMMA_SOURCE_FILE_AT_LINE (295)) ;
                }
              }else if (kBoolFalse == test_11) {
                GALGAS_location location_13 (enumerator_11892.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_13, GALGAS_string ("unhandled extension") COMMA_SOURCE_FILE_AT_LINE (298)) ;
              }
            }
          }
        }
      ...
      case GALGAS_sourceFileKind::kEnum_lexiqueSourceFile: {
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile COMMA_SOURCE_FILE_AT_LINE (301)) ;
        var_scannerSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (302)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_syntaxSourceFile: {
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile COMMA_SOURCE_FILE_AT_LINE (304)) ;
        var_syntaxSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (305)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_semanticsSourceFile: {
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile COMMA_SOURCE_FILE_AT_LINE (307)) ;
        var_semanticsSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (308)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_grammarSourceFile: {
        ...
        var_grammarSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (311)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_programSourceFile: {
        ...
        var_programSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (314)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_optionSourceFile: {
        ...
        var_optionSourceSet_5F_tool.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (317)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_guiSourceFile: {
        var_guiSourceSet_5F_app.addAssign_operation (var_baseName COMMA_SOURCE_FILE_AT_LINE (319)) ;
        } break ;
      }
    }
  ...
  GALGAS_stringset var_availableGenerationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (326)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_macosx") COMMA_SOURCE_FILE_AT_LINE (327)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_unix") COMMA_SOURCE_FILE_AT_LINE (328)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_i386_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (329)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_x86_64_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (330)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_mingw_on_macosx") COMMA_SOURCE_FILE_AT_LINE (331)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_msys_on_win32") COMMA_SOURCE_FILE_AT_LINE (332)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("SnowLeopard") COMMA_SOURCE_FILE_AT_LINE (333)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Lion") COMMA_SOURCE_FILE_AT_LINE (334)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("MountainLion") COMMA_SOURCE_FILE_AT_LINE (335)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("multi-threading") COMMA_SOURCE_FILE_AT_LINE (336)) ;
  GALGAS_stringset var_generationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (337)) ;
  ...
  cEnumerator_lstringlist enumerator_15865 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_15865.hasCurrentObject ()) {
    const enumGalgasBool test_15 = var_availableGenerationFeatures.reader_hasKey (enumerator_15865.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (343)) COMMA_SOURCE_FILE_AT_LINE (343)).boolEnum () ;
    if (kBoolTrue == test_15) {
      const enumGalgasBool test_16 = var_generationFeatures.reader_hasKey (enumerator_15865.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (344)) COMMA_SOURCE_FILE_AT_LINE (344)).boolEnum () ;
      if (kBoolTrue == test_16) {
        GALGAS_location location_17 (enumerator_15865.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_17, GALGAS_string ("duplicate '").operator_concat (enumerator_15865.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (345)) COMMA_SOURCE_FILE_AT_LINE (345)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (345)) COMMA_SOURCE_FILE_AT_LINE (345)) ;
      }
      const enumGalgasBool test_18 = GALGAS_bool (kIsEqual, enumerator_15865.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_18) {
        const enumGalgasBool test_19 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_19) {
          GALGAS_location location_20 (enumerator_15865.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_20, GALGAS_string ("duplicate '").operator_concat (enumerator_15865.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (350)) COMMA_SOURCE_FILE_AT_LINE (350)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (350)) COMMA_SOURCE_FILE_AT_LINE (350)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_18) {
        const enumGalgasBool test_21 = GALGAS_bool (kIsEqual, enumerator_15865.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_21) {
          ...
          if (kBoolTrue == test_22) {
            GALGAS_location location_23 (enumerator_15865.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_23, GALGAS_string ("the \"SnowLeopard\", \"Lion\" and \"MountainLion\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (356)) ;
          }
          var_SDK = GALGAS_string ("macosx10.6") ;
        }else if (kBoolFalse == test_21) {
          const enumGalgasBool test_24 = GALGAS_bool (kIsEqual, enumerator_15865.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_24) {
            ...
            if (kBoolTrue == test_25) {
              GALGAS_location location_26 (enumerator_15865.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_26, GALGAS_string ("the \"SnowLeopard\", \"Lion\" and \"MountainLion\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (362)) ;
            }
            var_SDK = GALGAS_string ("macosx10.7") ;
            var_usesARC = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_24) {
            const enumGalgasBool test_27 = GALGAS_bool (kIsEqual, enumerator_15865.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_27) {
              const enumGalgasBool test_28 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_28) {
                GALGAS_location location_29 (enumerator_15865.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_29, GALGAS_string ("the \"SnowLeopard\", \"Lion\" and \"MountainLion\" are exclusive") COMMA_SOURCE_FILE_AT_LINE (369)) ;
              }
              var_SDK = GALGAS_string ("macosx10.8") ;
              var_usesARC = GALGAS_bool (true) ;
            }else if (kBoolFalse == test_27) {
              var_generationFeatures.addAssign_operation (enumerator_15865.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (374)) COMMA_SOURCE_FILE_AT_LINE (374)) ;
            }
          }
        }
      }
      ...
      cEnumerator_stringset enumerator_17207 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_17207.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_17207.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (379)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (379)) COMMA_SOURCE_FILE_AT_LINE (379)) ;
        enumerator_17207.gotoNextObject () ;
      }
      GALGAS_location location_30 (enumerator_15865.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_30, GALGAS_string ("unknown '").operator_concat (enumerator_15865.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (381)) COMMA_SOURCE_FILE_AT_LINE (381)).operator_concat (GALGAS_string ("' feature; available features are:") COMMA_SOURCE_FILE_AT_LINE (381)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (381)) COMMA_SOURCE_FILE_AT_LINE (381)) ;
    }
    enumerator_15865.gotoNextObject () ;
  }
  const enumGalgasBool test_31 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).operator_and (constinArgument_inProjectQualifiedFeatureMap.reader_hasKey (GALGAS_string ("applicationBundleBase") COMMA_SOURCE_FILE_AT_LINE (385)).operator_not (SOURCE_FILE_AT_LINE (385)) COMMA_SOURCE_FILE_AT_LINE (385)).boolEnum () ;
  if (kBoolTrue == test_31) {
    GALGAS_location location_32 (constinArgument_inProjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticWarning (location_32, GALGAS_string ("For a Cocoa project, the \"applicationBundleBase\" feature should be set; for example: 'feature applicationBundleBase : \"fr.what\" ;'") COMMA_SOURCE_FILE_AT_LINE (386)) ;
  }
  const enumGalgasBool test_33 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_macosx") COMMA_SOURCE_FILE_AT_LINE (389)).boolEnum () ;
  if (kBoolTrue == test_33) {
    {
    routine_generateMakefileMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (390)) ;
    }
  }
  const enumGalgasBool test_34 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_unix") COMMA_SOURCE_FILE_AT_LINE (392)).boolEnum () ;
  if (kBoolTrue == test_34) {
    {
    routine_generateMakefileUnixTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (393)) ;
    }
  }
  const enumGalgasBool test_35 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_i386_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (395)).boolEnum () ;
  if (kBoolTrue == test_35) {
    {
    routine_generateI_33__38__36_LinuxOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (396)) ;
    }
  }
  const enumGalgasBool test_36 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_x86_64_linux_on_macosx") COMMA_SOURCE_FILE_AT_LINE (398)).boolEnum () ;
  if (kBoolTrue == test_36) {
    {
    routine_generateX_38__36__5F__36__34_LinuxOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (399)) ;
    }
  }
  const enumGalgasBool test_37 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_mingw_on_macosx") COMMA_SOURCE_FILE_AT_LINE (401)).boolEnum () ;
  if (kBoolTrue == test_37) {
    {
    routine_generateMinGWOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (402)) ;
    }
  }
  const enumGalgasBool test_38 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_msys_on_win32") COMMA_SOURCE_FILE_AT_LINE (404)).boolEnum () ;
  if (kBoolTrue == test_38) {
    {
    routine_generateMsysOnWin_33__32_Target (var_projectDirectory, constinArgument_inTargetName, inCompiler COMMA_SOURCE_FILE_AT_LINE (405)) ;
    }
  }
  //--- @ifExpressionForGeneration
  GALGAS_string temp_39 ;
  const enumGalgasBool test_40 = var_multiThreadingEnabled.boolEnum () ;
  if (kBoolTrue == test_40) {
    temp_39 = GALGAS_string ("1") ;
  }else if (kBoolFalse == test_40) {
    temp_39 = GALGAS_string ("0") ;
  }
  GALGAS_string var_newFileListContents = GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_file_5F_list (inCompiler, var_handCodedSourceDirectorySet, var_handCodedSourceList, var_generatedFileListForMakefile, var_libpmPath, temp_39 COMMA_SOURCE_FILE_AT_LINE (408))) ;
  GALGAS_string var_fileListPath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (415)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/file_list.mak") COMMA_SOURCE_FILE_AT_LINE (415)) ;
  GALGAS_bool joker_19040_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_19040_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (416)) ;
  GALGAS_string var_previousFileListPath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (417)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/file_list.mke") COMMA_SOURCE_FILE_AT_LINE (417)) ;
  {
  GALGAS_string::class_method_deleteFileIfExists (var_previousFileListPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (418)) ;
  }
  const enumGalgasBool test_41 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_41) {
    GALGAS_string var_dir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode") COMMA_SOURCE_FILE_AT_LINE (421)) ;
    var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (422)) ;
    GALGAS_string var_icon_5F_help_5F_file_5F_path = var_dir.operator_concat (GALGAS_string ("/adding-icons-to-your-application.rtf") COMMA_SOURCE_FILE_AT_LINE (424)) ;
    GALGAS_bool joker_19632_0 ; // Joker input parameter
    GALGAS_string (gWrapperFileContent_15_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_icon_5F_help_5F_file_5F_path, joker_19632_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (425)) ;
    GALGAS_string var_applicationBundleBase ;
    const cMapElement_projectQualifiedFeatureMap * objectArray_19727 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_19727) {
        macroValidSharedObject (objectArray_19727, const cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_19727->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
      var_applicationBundleBase = GALGAS_string ("fr.irccyn") ;
    }
    GALGAS_string var_InfoPlistContents = GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_info_5F_plist (inCompiler, constinArgument_inTargetName, var_applicationBundleBase, constinArgument_inProjectVersionString, constinArgument_inHandledExtensionSet COMMA_SOURCE_FILE_AT_LINE (433))) ;
    GALGAS_bool joker_20175_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist") COMMA_SOURCE_FILE_AT_LINE (439)), joker_20175_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (439)) ;
    const enumGalgasBool test_42 = var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (441)).reader_fileExists (SOURCE_FILE_AT_LINE (441)).operator_not (SOURCE_FILE_AT_LINE (441)).boolEnum () ;
    if (kBoolTrue == test_42) {
      GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_build_5F_xcode (inCompiler COMMA_SOURCE_FILE_AT_LINE (442))).method_writeToExecutableFile (var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (442)), inCompiler COMMA_SOURCE_FILE_AT_LINE (442)) ;
    }
    var_dir.operator_concat (GALGAS_string ("/English.lproj") COMMA_SOURCE_FILE_AT_LINE (445)).method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (445)) ;
    GALGAS_string var_InfoPlist_5F_strings_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/InfoPlist.strings") COMMA_SOURCE_FILE_AT_LINE (446)) ;
    GALGAS_bool joker_20662_0 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (447))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_20662_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (447)) ;
    GALGAS_string var_Credits_5F_rtf_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/Credits.rtf") COMMA_SOURCE_FILE_AT_LINE (448)) ;
    const enumGalgasBool test_43 = var_Credits_5F_rtf_5F_path.reader_fileExists (SOURCE_FILE_AT_LINE (449)).operator_not (SOURCE_FILE_AT_LINE (449)).boolEnum () ;
    if (kBoolTrue == test_43) {
      GALGAS_string (gWrapperFileContent_17_targetGenerationFileWrapper).method_writeToFile (var_Credits_5F_rtf_5F_path, inCompiler COMMA_SOURCE_FILE_AT_LINE (450)) ;
    }
    const cMapElement_projectQualifiedFeatureMap * objectArray_20992 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_20992) {
        macroValidSharedObject (objectArray_20992, const cMapElement_projectQualifiedFeatureMap) ;
      GALGAS_string var_applicationUpdateDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/cocoa-application-update/application") COMMA_SOURCE_FILE_AT_LINE (454)) ;
      var_applicationUpdateDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (455)) ;
      GALGAS_bool joker_21344_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (456))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h") COMMA_SOURCE_FILE_AT_LINE (456)), joker_21344_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (456)) ;
      GALGAS_bool joker_21644_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, constinArgument_inTargetName, objectArray_20992->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE_AT_LINE (457))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m") COMMA_SOURCE_FILE_AT_LINE (462)), joker_21644_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (457)) ;
      GALGAS_bool joker_21842_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_nib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (465))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib") COMMA_SOURCE_FILE_AT_LINE (465)), joker_21842_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (465)) ;
      GALGAS_bool joker_21996_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (466))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h") COMMA_SOURCE_FILE_AT_LINE (466)), joker_21996_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (466)) ;
      GALGAS_bool joker_22158_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (467))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m") COMMA_SOURCE_FILE_AT_LINE (467)), joker_22158_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (467)) ;
      GALGAS_bool joker_22312_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (468))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h") COMMA_SOURCE_FILE_AT_LINE (468)), joker_22312_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (468)) ;
      GALGAS_bool joker_22474_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (469))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m") COMMA_SOURCE_FILE_AT_LINE (469)), joker_22474_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (469)) ;
      GALGAS_bool joker_22644_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (470))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h") COMMA_SOURCE_FILE_AT_LINE (470)), joker_22644_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (470)) ;
      GALGAS_string var_codeSignIdentity ;
      const cMapElement_projectQualifiedFeatureMap * objectArray_22742 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_22742) {
          macroValidSharedObject (objectArray_22742, const cMapElement_projectQualifiedFeatureMap) ;
        var_codeSignIdentity = objectArray_22742->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
        var_codeSignIdentity = GALGAS_string::makeEmptyString () ;
      }
      GALGAS_string var_updaterToolDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/cocoa-application-update/updater-tool") COMMA_SOURCE_FILE_AT_LINE (478)) ;
      var_updaterToolDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (479)) ;
      GALGAS_bool joker_23183_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_protocol (inCompiler COMMA_SOURCE_FILE_AT_LINE (480))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerProtocol.h") COMMA_SOURCE_FILE_AT_LINE (480)), joker_23183_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (480)) ;
      GALGAS_bool joker_23333_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (481))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.h") COMMA_SOURCE_FILE_AT_LINE (481)), joker_23333_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (481)) ;
      GALGAS_bool joker_23491_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (482))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.m") COMMA_SOURCE_FILE_AT_LINE (482)), joker_23491_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (482)) ;
      GALGAS_bool joker_23749_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_tool_5F_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE_AT_LINE (483))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Info.plist") COMMA_SOURCE_FILE_AT_LINE (488)), joker_23749_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (483)) ;
      GALGAS_bool joker_23993_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_tool_5F_launchd_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (491))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Launchd.plist") COMMA_SOURCE_FILE_AT_LINE (495)), joker_23993_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (491)) ;
      GALGAS_bool joker_24223_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_main (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (498))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-main.m") COMMA_SOURCE_FILE_AT_LINE (502)), joker_24223_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (498)) ;
      GALGAS_string var_updaterApplicationDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/cocoa-application-update/updater-application") COMMA_SOURCE_FILE_AT_LINE (506)) ;
      var_updaterApplicationDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (507)) ;
      GALGAS_bool joker_24594_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE_AT_LINE (508))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf") COMMA_SOURCE_FILE_AT_LINE (508)), joker_24594_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (508)) ;
      GALGAS_bool joker_24773_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE_AT_LINE (509))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings") COMMA_SOURCE_FILE_AT_LINE (509)), joker_24773_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (509)) ;
      GALGAS_bool joker_24956_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (510))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib") COMMA_SOURCE_FILE_AT_LINE (510)), joker_24956_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (510)) ;
      GALGAS_bool joker_25125_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (511))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h") COMMA_SOURCE_FILE_AT_LINE (511)), joker_25125_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (511)) ;
      GALGAS_bool joker_25372_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (512))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m") COMMA_SOURCE_FILE_AT_LINE (516)), joker_25372_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (512)) ;
      GALGAS_bool joker_25628_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE_AT_LINE (518))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist") COMMA_SOURCE_FILE_AT_LINE (523)), joker_25628_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (518)) ;
      GALGAS_bool joker_25777_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE_AT_LINE (525))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m") COMMA_SOURCE_FILE_AT_LINE (525)), joker_25777_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (525)) ;
      GALGAS_bool joker_25925_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_prefix (inCompiler COMMA_SOURCE_FILE_AT_LINE (526))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Prefix.pch") COMMA_SOURCE_FILE_AT_LINE (526)), joker_25925_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (526)) ;
    }
    GALGAS_string var_userResourceDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/userResources") COMMA_SOURCE_FILE_AT_LINE (529)) ;
    var_userResourceDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (530)) ;
    GALGAS_stringlist var_extensionList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (531)) ;
    var_extensionList.addAssign_operation (GALGAS_string ("icns") COMMA_SOURCE_FILE_AT_LINE (532)) ;
    GALGAS_stringlist var_resourceFiles = var_userResourceDir.reader_regularFilesWithExtensions (GALGAS_bool (false), var_extensionList COMMA_SOURCE_FILE_AT_LINE (533)) ;
    GALGAS_string var_xcodeProjectPath = var_dir.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (535)).operator_concat (constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (535)).operator_concat (GALGAS_string (".xcodeproj") COMMA_SOURCE_FILE_AT_LINE (535)) ;
    GALGAS_string var_intermediateFilePath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (536)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/file_list_for_xcode_project.txt") COMMA_SOURCE_FILE_AT_LINE (536)) ;
    var_xcodeProjectPath.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (538)) ;
    {
