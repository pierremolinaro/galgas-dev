...
GALGAS_string filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_file_5F_list (C_Compiler * /* inCompiler */,
  ...
  if (in_HAND_5F_CODED_5F_SOURCE_5F_DIR_5F_SET.isValid ()) {
    cEnumerator_stringset enumerator_612 (in_HAND_5F_CODED_5F_SOURCE_5F_DIR_5F_SET, kEnumeration_up) ;
    while (enumerator_612.hasCurrentObject ()) {
      result << "SOURCES_DIR += " ;
      result << enumerator_612.current_key (HERE).stringValue () ;
      result << "\n" ;
  ...
  if (in_HAND_5F_CODED_5F_SOURCE_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_1149 (in_HAND_5F_CODED_5F_SOURCE_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1149.hasCurrentObject ()) {
      result << "SOURCES += " ;
      result << enumerator_1149.current_mValue (HERE).stringValue () ;
      result << "\n" ;
  ...
  if (in_MAKEFILE_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_1266 (in_MAKEFILE_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1266.hasCurrentObject ()) {
      result << "SOURCES += " ;
      result << enumerator_1266.current_mValue (HERE).stringValue () ;
      result << "\n" ;
