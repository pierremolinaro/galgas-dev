...
void routine_updateTargets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
  ...
  cEnumerator_projectSourceList enumerator_11896 (constinArgument_inProjectSourceList, kEnumeration_up) ;
  while (enumerator_11896.hasCurrentObject ()) {
    GALGAS_string var_baseName = enumerator_11896.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (257)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (257)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (257)) ;
    GALGAS_string var_extension = enumerator_11896.current_mFilePath (HERE).mAttribute_string.reader_pathExtension (SOURCE_FILE_AT_LINE (258)) ;
    ...
    if (kBoolTrue == test_3) {
      GALGAS_location location_4 (enumerator_11896.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (enumerator_11896.current_mSourceKind (HERE).isValid ()) {
      switch (enumerator_11896.current_mSourceKind (HERE).enumValue ()) {
      ...
      case GALGAS_sourceFileKind::kEnum_externSourceFile: {
        ...
        if (kBoolTrue == test_5) {
          var_externSourceSet_5F_tool.addAssign_operation (enumerator_11896.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (269)) COMMA_SOURCE_FILE_AT_LINE (269)) ;
          var_handCodedSourceList.addAssign_operation (enumerator_11896.current_mFilePath (HERE).mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (270)) COMMA_SOURCE_FILE_AT_LINE (270)) ;
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_11896.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (271)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_6) {
            var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources") COMMA_SOURCE_FILE_AT_LINE (272)) ;
          }else if (kBoolFalse == test_6) {
            var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11896.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (274)) COMMA_SOURCE_FILE_AT_LINE (274)) COMMA_SOURCE_FILE_AT_LINE (274)) ;
          }
        }else if (kBoolFalse == test_5) {
          const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("framework"))).boolEnum () ;
          if (kBoolTrue == test_7) {
            var_externSourceSet_5F_tool.addAssign_operation (enumerator_11896.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (277)) ;
            var_externSourceSet_5F_app.addAssign_operation (enumerator_11896.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (278)) COMMA_SOURCE_FILE_AT_LINE (278)) ;
            const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_11896.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (280)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_8) {
              var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources") COMMA_SOURCE_FILE_AT_LINE (281)) ;
            }else if (kBoolFalse == test_8) {
              var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11896.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (283)) COMMA_SOURCE_FILE_AT_LINE (283)) COMMA_SOURCE_FILE_AT_LINE (283)) ;
            }
          }else if (kBoolFalse == test_7) {
            const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("m"))).boolEnum () ;
            if (kBoolTrue == test_9) {
              var_externSourceSet_5F_app.addAssign_operation (enumerator_11896.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (286)) COMMA_SOURCE_FILE_AT_LINE (286)) ;
              const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_11896.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (287)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_10) {
                ...
                var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11896.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (290)) COMMA_SOURCE_FILE_AT_LINE (290)) COMMA_SOURCE_FILE_AT_LINE (290)) ;
              }
            }else if (kBoolFalse == test_9) {
              const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("h"))).boolEnum () ;
              if (kBoolTrue == test_11) {
                var_externSourceSet_5F_tool.addAssign_operation (enumerator_11896.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (293)) COMMA_SOURCE_FILE_AT_LINE (293)) ;
                const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_11896.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (294)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_12) {
                  ...
                  var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11896.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (297)) COMMA_SOURCE_FILE_AT_LINE (297)) COMMA_SOURCE_FILE_AT_LINE (297)) ;
                }
              }else if (kBoolFalse == test_11) {
                const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("xib"))).boolEnum () ;
                if (kBoolTrue == test_13) {
                  var_externSourceSet_5F_app.addAssign_operation (enumerator_11896.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (300)) COMMA_SOURCE_FILE_AT_LINE (300)) ;
                  const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_11896.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (301)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                  if (kBoolTrue == test_14) {
                    ...
                    var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11896.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (304)) COMMA_SOURCE_FILE_AT_LINE (304)) COMMA_SOURCE_FILE_AT_LINE (304)) ;
                  }
                }else if (kBoolFalse == test_13) {
                  GALGAS_location location_15 (enumerator_11896.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  cEnumerator_lstringlist enumerator_16482 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_16482.hasCurrentObject ()) {
    const enumGalgasBool test_17 = var_availableGenerationFeatures.reader_hasKey (enumerator_16482.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (355)) COMMA_SOURCE_FILE_AT_LINE (355)).boolEnum () ;
    if (kBoolTrue == test_17) {
      const enumGalgasBool test_18 = var_generationFeatures.reader_hasKey (enumerator_16482.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)).boolEnum () ;
      if (kBoolTrue == test_18) {
        GALGAS_location location_19 (enumerator_16482.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_19, GALGAS_string ("duplicate '").operator_concat (enumerator_16482.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (357)) COMMA_SOURCE_FILE_AT_LINE (357)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (357)) COMMA_SOURCE_FILE_AT_LINE (357)) ;
      }
      const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_16482.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_20) {
        const enumGalgasBool test_21 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_21) {
          GALGAS_location location_22 (enumerator_16482.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_22, GALGAS_string ("duplicate '").operator_concat (enumerator_16482.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (362)) COMMA_SOURCE_FILE_AT_LINE (362)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (362)) COMMA_SOURCE_FILE_AT_LINE (362)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_20) {
        const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, enumerator_16482.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_23) {
          ...
          if (kBoolTrue == test_24) {
            GALGAS_location location_25 (enumerator_16482.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          const enumGalgasBool test_26 = GALGAS_bool (kIsEqual, enumerator_16482.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_26) {
            ...
            if (kBoolTrue == test_27) {
              GALGAS_location location_28 (enumerator_16482.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            ...
            const enumGalgasBool test_29 = GALGAS_bool (kIsEqual, enumerator_16482.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_29) {
              ...
              if (kBoolTrue == test_30) {
                GALGAS_location location_31 (enumerator_16482.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              ...
              const enumGalgasBool test_32 = GALGAS_bool (kIsEqual, enumerator_16482.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Mavericks"))).boolEnum () ;
              if (kBoolTrue == test_32) {
                ...
                if (kBoolTrue == test_33) {
                  GALGAS_location location_34 (enumerator_16482.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                ...
                const enumGalgasBool test_35 = GALGAS_bool (kIsEqual, enumerator_16482.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Yosemite"))).boolEnum () ;
                if (kBoolTrue == test_35) {
                  ...
                  if (kBoolTrue == test_36) {
                    GALGAS_location location_37 (enumerator_16482.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  ...
                  const enumGalgasBool test_38 = GALGAS_bool (kIsEqual, enumerator_16482.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("LatestMacOS"))).boolEnum () ;
                  if (kBoolTrue == test_38) {
                    ...
                    if (kBoolTrue == test_39) {
                      GALGAS_location location_40 (enumerator_16482.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    ...
                    var_generationFeatures.addAssign_operation (enumerator_16482.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (407)) COMMA_SOURCE_FILE_AT_LINE (407)) ;
                  }
                }
              }
            }
      ...
      cEnumerator_stringset enumerator_18881 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_18881.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_18881.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (412)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (412)) COMMA_SOURCE_FILE_AT_LINE (412)) ;
        enumerator_18881.gotoNextObject () ;
      }
      GALGAS_location location_41 (enumerator_16482.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_41, GALGAS_string ("unknown '").operator_concat (enumerator_16482.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (414)) COMMA_SOURCE_FILE_AT_LINE (414)).operator_concat (GALGAS_string ("' feature; available features are:") COMMA_SOURCE_FILE_AT_LINE (414)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (414)) COMMA_SOURCE_FILE_AT_LINE (414)) ;
    }
  ...
  GALGAS_bool joker_20716_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_20716_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (449)) ;
  ...
  if (kBoolTrue == test_52) {
    ...
    GALGAS_bool joker_21308_0 ; // Joker input parameter
    GALGAS_string (gWrapperFileContent_15_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_icon_5F_help_5F_file_5F_path, joker_21308_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (458)) ;
    GALGAS_string var_applicationBundleBase ;
    const cMapElement_projectQualifiedFeatureMap * objectArray_21375 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_21375) {
        macroValidSharedObject (objectArray_21375, cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_21375->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
    ...
    GALGAS_bool joker_21851_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist") COMMA_SOURCE_FILE_AT_LINE (472)), joker_21851_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (472)) ;
    ...
    GALGAS_bool joker_22338_0 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (480))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_22338_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (480)) ;
    ...
    const cMapElement_projectQualifiedFeatureMap * objectArray_22640 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_22640) {
        macroValidSharedObject (objectArray_22640, cMapElement_projectQualifiedFeatureMap) ;
      ...
      GALGAS_bool joker_23020_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (489))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h") COMMA_SOURCE_FILE_AT_LINE (489)), joker_23020_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (489)) ;
      GALGAS_bool joker_23320_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, constinArgument_inTargetName, objectArray_22640->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE_AT_LINE (490))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m") COMMA_SOURCE_FILE_AT_LINE (495)), joker_23320_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (490)) ;
      GALGAS_bool joker_23518_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_nib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (498))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib") COMMA_SOURCE_FILE_AT_LINE (498)), joker_23518_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (498)) ;
      GALGAS_bool joker_23672_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (499))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h") COMMA_SOURCE_FILE_AT_LINE (499)), joker_23672_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (499)) ;
      GALGAS_bool joker_23834_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (500))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m") COMMA_SOURCE_FILE_AT_LINE (500)), joker_23834_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (500)) ;
      GALGAS_bool joker_23988_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (501))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h") COMMA_SOURCE_FILE_AT_LINE (501)), joker_23988_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (501)) ;
      GALGAS_bool joker_24150_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (502))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m") COMMA_SOURCE_FILE_AT_LINE (502)), joker_24150_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (502)) ;
      GALGAS_bool joker_24320_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (503))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h") COMMA_SOURCE_FILE_AT_LINE (503)), joker_24320_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (503)) ;
      GALGAS_string var_codeSignIdentity ;
      const cMapElement_projectQualifiedFeatureMap * objectArray_24390 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_24390) {
          macroValidSharedObject (objectArray_24390, cMapElement_projectQualifiedFeatureMap) ;
        var_codeSignIdentity = objectArray_24390->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
      ...
      GALGAS_bool joker_24859_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_protocol (inCompiler COMMA_SOURCE_FILE_AT_LINE (513))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerProtocol.h") COMMA_SOURCE_FILE_AT_LINE (513)), joker_24859_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (513)) ;
      GALGAS_bool joker_25009_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (514))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.h") COMMA_SOURCE_FILE_AT_LINE (514)), joker_25009_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (514)) ;
      GALGAS_bool joker_25167_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (515))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.m") COMMA_SOURCE_FILE_AT_LINE (515)), joker_25167_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (515)) ;
      GALGAS_bool joker_25425_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_tool_5F_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE_AT_LINE (516))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Info.plist") COMMA_SOURCE_FILE_AT_LINE (521)), joker_25425_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (516)) ;
      GALGAS_bool joker_25669_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_tool_5F_launchd_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (524))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Launchd.plist") COMMA_SOURCE_FILE_AT_LINE (528)), joker_25669_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (524)) ;
      GALGAS_bool joker_25899_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_main (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (531))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-main.m") COMMA_SOURCE_FILE_AT_LINE (535)), joker_25899_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (531)) ;
      ...
      GALGAS_bool joker_26270_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE_AT_LINE (541))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf") COMMA_SOURCE_FILE_AT_LINE (541)), joker_26270_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (541)) ;
      GALGAS_bool joker_26449_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE_AT_LINE (542))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings") COMMA_SOURCE_FILE_AT_LINE (542)), joker_26449_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (542)) ;
      GALGAS_bool joker_26632_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (543))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib") COMMA_SOURCE_FILE_AT_LINE (543)), joker_26632_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (543)) ;
      GALGAS_bool joker_26801_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (544))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h") COMMA_SOURCE_FILE_AT_LINE (544)), joker_26801_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (544)) ;
      GALGAS_bool joker_27048_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (545))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m") COMMA_SOURCE_FILE_AT_LINE (549)), joker_27048_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (545)) ;
      GALGAS_bool joker_27304_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE_AT_LINE (551))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist") COMMA_SOURCE_FILE_AT_LINE (556)), joker_27304_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (551)) ;
      GALGAS_bool joker_27453_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE_AT_LINE (558))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m") COMMA_SOURCE_FILE_AT_LINE (558)), joker_27453_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (558)) ;
      GALGAS_bool joker_27601_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_prefix (inCompiler COMMA_SOURCE_FILE_AT_LINE (559))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Prefix.pch") COMMA_SOURCE_FILE_AT_LINE (559)), joker_27601_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (559)) ;
    }
