...
void routine_updateTargets (C_CompilerEx & inLexique,
  ...
  GGS_stringset  var_cas_handCodedSourceDirectorySet = GGS_stringset ::constructor_emptySet () ;
  {
    ...
    while (((operand_12039 = enumerator_12039.nextObject ()))) {
      ...
      const GGS_string var_cas_fullFilePath = ((var_cas_inProjectSourceFilePath.ggs_string ().reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/"))).operator_concat (operand_12039->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202))) ;
      const GGS_string var_cas_baseName = operand_12039->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (203)).reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
      const GGS_string var_cas_cppFile = (var_cas_baseName).operator_concat (GGS_string (".cpp")) ;
      const GGS_bool cond_12506 = var_cas_sourceFileSet.reader_hasKey (var_cas_baseName) ;
      if (cond_12506.isBuiltAndTrue ()) {
        operand_12039->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("there is already a file with '")).operator_concat (var_cas_baseName)).operator_concat (GGS_string ("' as base name in the project")) COMMA_SOURCE_FILE_AT_LINE (208)) ;
      }
      ...
      case GGS_sourceFileKind::enum_externSourceFile:
        {
        var_cas_externSourceSet_tool.addAssign_operation (var_cas_fullFilePath) ;
        var_cas_externSourceSet_app.addAssign_operation (var_cas_fullFilePath) ;
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_14698 (var_cas_inTargetFeatureList, true) ;
    const GGS_lstringlist::cElement * operand_14698 = NULL ;
    while (((operand_14698 = enumerator_14698.nextObject ()))) {
      macroValidPointer (operand_14698) ;
      const GGS_bool cond_14958 = var_cas_availableGenerationFeatures.reader_hasKey (operand_14698->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (260))) ;
      if (cond_14958.isBuiltAndTrue ()) {
        const GGS_bool cond_14897 = var_cas_generationFeatures.reader_hasKey (operand_14698->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (261))) ;
        if (cond_14897.isBuiltAndTrue ()) {
          operand_14698->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("duplicate '")).operator_concat (operand_14698->mValue)).operator_concat (GGS_string ("' feature")) COMMA_SOURCE_FILE_AT_LINE (263)) ;
        }
        var_cas_generationFeatures.addAssign_operation (operand_14698->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (264))) ;
      }else if (cond_14958.isBuiltAndFalse ()) {
        GGS_string var_cas_s = GGS_string ("") ;
        {
          GGS_stringset::cEnumerator enumerator_15024 (var_cas_availableGenerationFeatures, true) ;
          while (enumerator_15024.hasCurrentObject ()) {
            var_cas_s.appendCString ("\n"
              "  - '") ;
            var_cas_s.dotAssign_operation (enumerator_15024._key (HERE)) ;
            var_cas_s.appendCString ("'") ;
            enumerator_15024.next () ;
          }
        }
        operand_14698->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("unknown '")).operator_concat (operand_14698->mValue)).operator_concat (GGS_string ("' feature; avalaible features are:"))).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (271)) ;
      }
    }
  }
  const GGS_bool cond_15553 = (var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-universal"))).operator_and ((var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-ppc"))).operator_not ()) ;
  if (cond_15553.isBuiltAndTrue ()) {
    var_cas_inProjectName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("'feature makefile-macosx-ppc' implicitly added, due to 'feature makefile-macosx-universal'") COMMA_SOURCE_FILE_AT_LINE (275)) ;
    var_cas_generationFeatures.addAssign_operation (GGS_string ("makefile-macosx-ppc")) ;
  }
  const GGS_bool cond_15868 = (var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-universal"))).operator_and ((var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-intel"))).operator_not ()) ;
  if (cond_15868.isBuiltAndTrue ()) {
    var_cas_inProjectName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("'feature makefile-macosx-intel' implicitly added, due to 'feature makefile-macosx-universal'") COMMA_SOURCE_FILE_AT_LINE (279)) ;
    var_cas_generationFeatures.addAssign_operation (GGS_string ("makefile-macosx-intel")) ;
  }
  const GGS_bool cond_16033 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-ppc")) ;
  if (cond_16033.isBuiltAndTrue ()) {
    ::routine_generateMakefilePPCMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (284)) ;
  }
  const GGS_bool cond_16179 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-intel")) ;
  if (cond_16179.isBuiltAndTrue ()) {
    ::routine_generateMakefileIntelMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (287)) ;
  }
  const GGS_bool cond_16333 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-universal")) ;
  if (cond_16333.isBuiltAndTrue ()) {
    ::routine_generateMakefileUniversalMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (290)) ;
  }
  const GGS_bool cond_16468 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx")) ;
  if (cond_16468.isBuiltAndTrue ()) {
    ::routine_generateMakefileMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (293)) ;
  }
  const GGS_bool cond_16599 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-unix")) ;
  if (cond_16599.isBuiltAndTrue ()) {
    ::routine_generateMakefileUnixTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (296)) ;
  }
  const GGS_bool cond_16751 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-i386-linux-on-macosx")) ;
  if (cond_16751.isBuiltAndTrue ()) {
    ::routine_generateI386LinuxOnMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (299)) ;
  }
  const GGS_bool cond_16894 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-mingw-on-macosx")) ;
  if (cond_16894.isBuiltAndTrue ()) {
    ::routine_generateMinGWOnMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (302)) ;
  }
  const GGS_bool cond_17033 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-msys-on-win32")) ;
  if (cond_17033.isBuiltAndTrue ()) {
    ::routine_generateMsysOnWin32Target (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (305)) ;
  }
  ...
  GGS_bool automatic_var_17487_0 ;
  if (var_cas_newFileListContents.isBuilt ()) {
    var_cas_newFileListContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_17487_0 COMMA_SOURCE_FILE_AT_LINE (315)) ;
  }
  const GGS_bool cond_20180 = var_cas_generationFeatures.reader_hasKey (GGS_string ("xcode-project")) ;
  if (cond_20180.isBuiltAndTrue ()) {
    const GGS_string var_cas_dir = (var_cas_projectDirectory).operator_concat (GGS_string ("/xcode-project")) ;
    if (var_cas_dir.isBuilt ()) {
      var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (319)) ;
    }
    GGS_bool automatic_var_17815_0 ;
    const GGS_string temp_17791 = template_filewrapper_targetGenerationFileWrapper_makefile_info_plist (inLexique, var_cas_inTargetName) ;
    if (temp_17791.isBuilt ()) {
      temp_17791 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/Info.plist")), automatic_var_17815_0 COMMA_SOURCE_FILE_AT_LINE (320)) ;
    }
    const GGS_string temp_17862 = (var_cas_dir).operator_concat (GGS_string ("/English.lproj")) ;
    if (temp_17862.isBuilt ()) {
      temp_17862 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (322)) ;
    }
    const GGS_string var_cas_InfoPlist_strings_path = (var_cas_dir).operator_concat (GGS_string ("/English.lproj/InfoPlist.strings")) ;
    const GGS_bool cond_18147 = (var_cas_InfoPlist_strings_path.reader_fileExists ()).operator_not () ;
    if (cond_18147.isBuiltAndTrue ()) {
      const GGS_string temp_18112 = GGS_string (gWrapperFileContent_28_targetGenerationFileWrapper) ;
      if (temp_18112.isBuilt ()) {
        temp_18112 (HERE)->method_writeToFile (inLexique, var_cas_InfoPlist_strings_path COMMA_SOURCE_FILE_AT_LINE (325)) ;
      }
    }
    const GGS_string var_cas_Credits_rtf_path = (var_cas_dir).operator_concat (GGS_string ("/English.lproj/Credits.rtf")) ;
    const GGS_bool cond_18404 = (var_cas_Credits_rtf_path.reader_fileExists ()).operator_not () ;
    if (cond_18404.isBuiltAndTrue ()) {
      const GGS_string temp_18375 = GGS_string (gWrapperFileContent_27_targetGenerationFileWrapper) ;
      if (temp_18375.isBuilt ()) {
        temp_18375 (HERE)->method_writeToFile (inLexique, var_cas_Credits_rtf_path COMMA_SOURCE_FILE_AT_LINE (329)) ;
      }
    }
    const GGS_string var_cas_libpmPosixPath = GGS_string::constructor_stringWithEnvironmentVariable (inLexique, GGS_string ("LIBPM_PATH") COMMA_SOURCE_FILE_AT_LINE (332)).reader_unixPathWithNativePath () ;
    const GGS_string var_cas_symbLinkPath = (var_cas_dir).operator_concat (GGS_string ("/libpm")) ;
    const GGS_bool cond_18723 = (var_cas_symbLinkPath.reader_isSymbolicLink ()).operator_not () ;
    if (cond_18723.isBuiltAndTrue ()) {
      if (var_cas_symbLinkPath.isBuilt ()) {
        var_cas_symbLinkPath (HERE)->method_makeSymbolicLinkWithPath (inLexique, var_cas_libpmPosixPath COMMA_SOURCE_FILE_AT_LINE (335)) ;
      }
    }else if (cond_18723.isBuiltAndFalse ()) {
      const GGS_bool cond_18916 = (GGS_string::constructor_stringWithSymbolicLinkContents (inLexique, var_cas_symbLinkPath COMMA_SOURCE_FILE_AT_LINE (336))).operator_isNotEqual (var_cas_libpmPosixPath) ;
      if (cond_18916.isBuiltAndTrue ()) {
        GGS_string::class_method_deleteFile (inLexique, var_cas_symbLinkPath COMMA_SOURCE_FILE_AT_LINE (337)) ;
        if (var_cas_symbLinkPath.isBuilt ()) {
          var_cas_symbLinkPath (HERE)->method_makeSymbolicLinkWithPath (inLexique, var_cas_libpmPosixPath COMMA_SOURCE_FILE_AT_LINE (338)) ;
        }
      }
    }
    ...
    if (var_cas_xcodeProjectPath.isBuilt ()) {
      var_cas_xcodeProjectPath (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (346)) ;
    }
