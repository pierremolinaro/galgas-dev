...
void routine_updateTargets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
  ...
  cEnumerator_lstringlist enumerator_16330 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_16330.hasCurrentObject ()) {
    const enumGalgasBool test_17 = var_availableGenerationFeatures.reader_hasKey (enumerator_16330.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (352)) COMMA_SOURCE_FILE_AT_LINE (352)).boolEnum () ;
    if (kBoolTrue == test_17) {
      const enumGalgasBool test_18 = var_generationFeatures.reader_hasKey (enumerator_16330.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (353)) COMMA_SOURCE_FILE_AT_LINE (353)).boolEnum () ;
      if (kBoolTrue == test_18) {
        GALGAS_location location_19 (enumerator_16330.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_19, GALGAS_string ("duplicate '").operator_concat (enumerator_16330.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (354)) COMMA_SOURCE_FILE_AT_LINE (354)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (354)) COMMA_SOURCE_FILE_AT_LINE (354)) ;
      }
      const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_16330.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_20) {
        const enumGalgasBool test_21 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_21) {
          GALGAS_location location_22 (enumerator_16330.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_22, GALGAS_string ("duplicate '").operator_concat (enumerator_16330.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (359)) COMMA_SOURCE_FILE_AT_LINE (359)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (359)) COMMA_SOURCE_FILE_AT_LINE (359)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_20) {
        const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, enumerator_16330.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_23) {
          ...
          if (kBoolTrue == test_24) {
            GALGAS_location location_25 (enumerator_16330.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          const enumGalgasBool test_26 = GALGAS_bool (kIsEqual, enumerator_16330.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_26) {
            ...
            if (kBoolTrue == test_27) {
              GALGAS_location location_28 (enumerator_16330.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            ...
            const enumGalgasBool test_29 = GALGAS_bool (kIsEqual, enumerator_16330.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_29) {
              ...
              if (kBoolTrue == test_30) {
                GALGAS_location location_31 (enumerator_16330.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              ...
              var_generationFeatures.addAssign_operation (enumerator_16330.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (383)) COMMA_SOURCE_FILE_AT_LINE (383)) ;
            }
          }
        }
      }
      ...
      cEnumerator_stringset enumerator_17672 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_17672.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_17672.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (388)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (388)) COMMA_SOURCE_FILE_AT_LINE (388)) ;
        enumerator_17672.gotoNextObject () ;
      }
      GALGAS_location location_32 (enumerator_16330.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_32, GALGAS_string ("unknown '").operator_concat (enumerator_16330.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (390)) COMMA_SOURCE_FILE_AT_LINE (390)).operator_concat (GALGAS_string ("' feature; available features are:") COMMA_SOURCE_FILE_AT_LINE (390)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (390)) COMMA_SOURCE_FILE_AT_LINE (390)) ;
    }
  ...
  if (kBoolTrue == test_43) {
    ...
    const cMapElement_projectQualifiedFeatureMap * objectArray_20166 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_20166) {
        macroValidSharedObject (objectArray_20166, cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_20166->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
    ...
    const cMapElement_projectQualifiedFeatureMap * objectArray_21431 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_21431) {
        macroValidSharedObject (objectArray_21431, cMapElement_projectQualifiedFeatureMap) ;
      ...
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, constinArgument_inTargetName, objectArray_21431->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE_AT_LINE (466))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m") COMMA_SOURCE_FILE_AT_LINE (471)), joker_22111_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (466)) ;
      ...
      const cMapElement_projectQualifiedFeatureMap * objectArray_23181 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction_hasKey (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_23181) {
          macroValidSharedObject (objectArray_23181, cMapElement_projectQualifiedFeatureMap) ;
        var_codeSignIdentity = objectArray_23181->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
