...
void routine_updateTargets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
  ...
  while (enumerator_11644.hasCurrentObject ()) {
    ...
    GALGAS_string var_extension = enumerator_11644.current_mFilePath (HERE).mAttribute_string.reader_pathExtension (SOURCE_FILE ("targetGeneration.gSemantics", 252)) ;
    ...
    const enumGalgasBool test_3 = var_sourceFileSet.reader_hasKey (var_baseName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 255)).operator_and (GALGAS_bool (kIsNotEqual, var_extension.objectCompare (GALGAS_string ("h"))) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 255)).operator_and (GALGAS_bool (kIsNotEqual, var_extension.objectCompare (GALGAS_string ("xib"))) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 255)).boolEnum () ;
    if (kBoolTrue == test_3) {
    ...
    if (enumerator_11644.current_mSourceKind (HERE).isValid ()) {
      ...
      case GALGAS_sourceFileKind::kEnum_externSourceFile: {
        const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("cpp"))).operator_or (GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("mm"))) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 262)).boolEnum () ;
        if (kBoolTrue == test_5) {
          ...
          if (kBoolTrue == test_7) {
            ...
            const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("m"))).boolEnum () ;
            if (kBoolTrue == test_9) {
              ...
              const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("h"))).boolEnum () ;
              if (kBoolTrue == test_11) {
                ...
                const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("xib"))).boolEnum () ;
  ...
  cEnumerator_lstringlist enumerator_16172 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_16172.hasCurrentObject ()) {
    const enumGalgasBool test_17 = var_availableGenerationFeatures.reader_hasKey (enumerator_16172.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 348)) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 348)).boolEnum () ;
    if (kBoolTrue == test_17) {
      const enumGalgasBool test_18 = var_generationFeatures.reader_hasKey (enumerator_16172.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 349)) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 349)).boolEnum () ;
      if (kBoolTrue == test_18) {
        GALGAS_location location_19 (enumerator_16172.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_19, GALGAS_string ("duplicate '").operator_concat (enumerator_16172.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 350))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 350)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 350))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 350)) ;
      }
      const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_16172.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_20) {
        const enumGalgasBool test_21 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_21) {
          GALGAS_location location_22 (enumerator_16172.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_22, GALGAS_string ("duplicate '").operator_concat (enumerator_16172.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 355))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 355)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 355))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 355)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_20) {
        const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, enumerator_16172.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_23) {
          ...
          if (kBoolTrue == test_24) {
            GALGAS_location location_25 (enumerator_16172.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          const enumGalgasBool test_26 = GALGAS_bool (kIsEqual, enumerator_16172.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_26) {
            ...
            if (kBoolTrue == test_27) {
              GALGAS_location location_28 (enumerator_16172.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            ...
            const enumGalgasBool test_29 = GALGAS_bool (kIsEqual, enumerator_16172.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_29) {
              ...
              if (kBoolTrue == test_30) {
                GALGAS_location location_31 (enumerator_16172.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              ...
              const enumGalgasBool test_32 = GALGAS_bool (kIsEqual, enumerator_16172.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Mavericks"))).boolEnum () ;
              if (kBoolTrue == test_32) {
                ...
                if (kBoolTrue == test_33) {
                  GALGAS_location location_34 (enumerator_16172.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                ...
                const enumGalgasBool test_35 = GALGAS_bool (kIsEqual, enumerator_16172.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Yosemite"))).boolEnum () ;
                if (kBoolTrue == test_35) {
                  ...
                  if (kBoolTrue == test_36) {
                    GALGAS_location location_37 (enumerator_16172.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  ...
                  const enumGalgasBool test_38 = GALGAS_bool (kIsEqual, enumerator_16172.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("LatestMacOS"))).boolEnum () ;
                  if (kBoolTrue == test_38) {
                    ...
                    if (kBoolTrue == test_39) {
                      GALGAS_location location_40 (enumerator_16172.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    ...
                    var_generationFeatures.addAssign_operation (enumerator_16172.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 400))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 400)) ;
                  }
                }
              }
            }
      ...
      cEnumerator_stringset enumerator_18571 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_18571.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_18571.current_key (HERE)  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 405)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 405))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 405)) ;
        enumerator_18571.gotoNextObject () ;
      }
      GALGAS_location location_41 (enumerator_16172.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_41, GALGAS_string ("unknown '").operator_concat (enumerator_16172.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 407))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 407)).operator_concat (GALGAS_string ("' feature; available features are:")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 407)).operator_concat (var_s  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 407))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 407)) ;
    }
  ...
  GALGAS_bool joker_20406 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_20406, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 442)) ;
  ...
  if (kBoolTrue == test_52) {
    ...
    GALGAS_bool joker_20998 ; // Joker input parameter
    GALGAS_string (gWrapperFileContent_18_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_icon_5F_help_5F_file_5F_path, joker_20998, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 451)) ;
    GALGAS_string var_applicationBundleBase ;
    const cMapElement_projectQualifiedFeatureMap * objectArray_21065 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_21065) {
        macroValidSharedObject (objectArray_21065, cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_21065->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
    ...
    GALGAS_bool joker_21541 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 465)), joker_21541, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 465)) ;
    ...
    GALGAS_bool joker_22028 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 473))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_22028, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 473)) ;
    ...
    const cMapElement_projectQualifiedFeatureMap * objectArray_22330 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_22330) {
        macroValidSharedObject (objectArray_22330, cMapElement_projectQualifiedFeatureMap) ;
      ...
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 482))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 482)), joker_22710, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 482)) ;
      GALGAS_bool joker_23010 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, constinArgument_inTargetName, objectArray_22330->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 483))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 488)), joker_23010, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 483)) ;
      GALGAS_bool joker_23208 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_nib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 491))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 491)), joker_23208, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 491)) ;
      GALGAS_bool joker_23362 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 492))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 492)), joker_23362, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 492)) ;
      GALGAS_bool joker_23524 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 493))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 493)), joker_23524, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 493)) ;
      GALGAS_bool joker_23678 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 494))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 494)), joker_23678, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 494)) ;
      GALGAS_bool joker_23840 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 495))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 495)), joker_23840, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 495)) ;
      GALGAS_bool joker_24010 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 496))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 496)), joker_24010, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 496)) ;
      GALGAS_string var_codeSignIdentity ;
      const cMapElement_projectQualifiedFeatureMap * objectArray_24080 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_24080) {
          macroValidSharedObject (objectArray_24080, cMapElement_projectQualifiedFeatureMap) ;
        var_codeSignIdentity = objectArray_24080->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
      ...
      GALGAS_bool joker_25960 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 534))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 534)), joker_25960, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 534)) ;
      GALGAS_bool joker_26139 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 535))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 535)), joker_26139, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 535)) ;
      GALGAS_bool joker_26322 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 536))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 536)), joker_26322, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 536)) ;
      GALGAS_bool joker_26491 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 537))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 537)), joker_26491, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 537)) ;
      GALGAS_bool joker_26738 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 538))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 542)), joker_26738, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 538)) ;
      GALGAS_bool joker_26994 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 544))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 549)), joker_26994, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 544)) ;
      GALGAS_bool joker_27143 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 551))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 551)), joker_27143, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 551)) ;
      GALGAS_bool joker_27291 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_prefix (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 552))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Prefix.pch")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 552)), joker_27291, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 552)) ;
    }
    ...
    cEnumerator_stringset enumerator_28288 (var_guiSourceSet_5F_tool.operator_or (var_scannerSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_or (var_optionSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_or (var_semanticsSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_or (var_syntaxSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_or (var_grammarSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_or (var_programSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)), kEnumeration_up) ;
    while (enumerator_28288.hasCurrentObject ()) {
      var_all_5F_h_5F_cpp_5F_files.addAssign_operation (enumerator_28288.current (HERE).add_operation (GALGAS_string (".h"), inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 568))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 568)) ;
      var_all_5F_h_5F_cpp_5F_files.addAssign_operation (enumerator_28288.current (HERE).add_operation (GALGAS_string (".cpp"), inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 569))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 569)) ;
