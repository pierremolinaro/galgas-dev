...
void routine_updateTargets (C_CompilerEx & inLexique,
  ...
  GGS_stringset  var_cas_handCodedSourceDirectorySet = GGS_stringset ::constructor_emptySet () ;
  {
    ...
    while (((operand_12140 = enumerator_12140.nextObject ()))) {
      ...
      case GGS_sourceFileKind::enum_externSourceFile:
        {
        var_cas_externSourceSet_tool.addAssign_operation (operand_12140->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (214))) ;
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_14908 (var_cas_inTargetFeatureList, true) ;
    const GGS_lstringlist::cElement * operand_14908 = NULL ;
    while (((operand_14908 = enumerator_14908.nextObject ()))) {
      macroValidPointer (operand_14908) ;
      const GGS_bool cond_15168 = var_cas_availableGenerationFeatures.reader_hasKey (operand_14908->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (265))) ;
      if (cond_15168.isBuiltAndTrue ()) {
        const GGS_bool cond_15107 = var_cas_generationFeatures.reader_hasKey (operand_14908->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (266))) ;
        if (cond_15107.isBuiltAndTrue ()) {
          operand_14908->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("duplicate '")).operator_concat (operand_14908->mValue)).operator_concat (GGS_string ("' feature")) COMMA_SOURCE_FILE_AT_LINE (268)) ;
        }
        var_cas_generationFeatures.addAssign_operation (operand_14908->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (269))) ;
      }else if (cond_15168.isBuiltAndFalse ()) {
        GGS_string var_cas_s = GGS_string ("") ;
        {
          GGS_stringset::cEnumerator enumerator_15234 (var_cas_availableGenerationFeatures, true) ;
          while (enumerator_15234.hasCurrentObject ()) {
            var_cas_s.appendCString ("\n"
              "  - '") ;
            var_cas_s.dotAssign_operation (enumerator_15234._key (HERE)) ;
            var_cas_s.appendCString ("'") ;
            enumerator_15234.next () ;
          }
        }
        operand_14908->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("unknown '")).operator_concat (operand_14908->mValue)).operator_concat (GGS_string ("' feature; avalaible features are:"))).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (276)) ;
      }
    }
  }
  const GGS_bool cond_15769 = (var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-universal"))).operator_and ((var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-ppc"))).operator_not ()) ;
  if (cond_15769.isBuiltAndTrue ()) {
    var_cas_inProjectName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("'feature \"makefile-macosx-ppc\" ;' implicitly added, due to 'feature makefile-macosx-universal'") COMMA_SOURCE_FILE_AT_LINE (280)) ;
    var_cas_generationFeatures.addAssign_operation (GGS_string ("makefile-macosx-ppc")) ;
  }
  const GGS_bool cond_16090 = (var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-universal"))).operator_and ((var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-intel"))).operator_not ()) ;
  if (cond_16090.isBuiltAndTrue ()) {
    var_cas_inProjectName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("'feature \"makefile-macosx-intel\" ;' implicitly added, due to 'feature makefile-macosx-universal'") COMMA_SOURCE_FILE_AT_LINE (284)) ;
  ...
  const GGS_bool cond_16276 = var_cas_generationFeatures.reader_hasKey (GGS_string ("xcode-arch:i386")) ;
  if (cond_16276.isBuiltAndTrue ()) {
    var_cas_architectureList.addAssign_operation (GGS_string ("i386")) ;
  }
  const GGS_bool cond_16383 = var_cas_generationFeatures.reader_hasKey (GGS_string ("xcode-arch:x86_64")) ;
  if (cond_16383.isBuiltAndTrue ()) {
    var_cas_architectureList.addAssign_operation (GGS_string ("x86_64")) ;
  }
  const GGS_bool cond_16488 = var_cas_generationFeatures.reader_hasKey (GGS_string ("xcode-arch:ppc64")) ;
  if (cond_16488.isBuiltAndTrue ()) {
    var_cas_architectureList.addAssign_operation (GGS_string ("ppc64")) ;
  }
  const GGS_bool cond_16598 = var_cas_generationFeatures.reader_hasKey (GGS_string ("xcode-arch:ppc")) ;
  if (cond_16598.isBuiltAndTrue ()) {
    var_cas_architectureList.addAssign_operation (GGS_string ("ppc7400")) ;
  }
  const GGS_bool cond_16838 = (var_cas_generationFeatures.reader_hasKey (GGS_string ("xcode-project"))).operator_and ((var_cas_architectureList.reader_length ()).operator_isEqual (GGS_uint (0U))) ;
  if (cond_16838.isBuiltAndTrue ()) {
    var_cas_inProjectName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("'feature \"xcode-arch:i386\" ;' implicitly added, due to 'xcode-project'") COMMA_SOURCE_FILE_AT_LINE (302)) ;
    var_cas_architectureList.addAssign_operation (GGS_string ("i386")) ;
  }
  const GGS_bool cond_17037 = ((var_cas_architectureList.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and ((var_cas_generationFeatures.reader_hasKey (GGS_string ("xcode-project"))).operator_not ()) ;
  if (cond_17037.isBuiltAndTrue ()) {
    var_cas_inProjectName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'a 'xcode-arch:...' feature requires the 'xcode-project' feature") COMMA_SOURCE_FILE_AT_LINE (307)) ;
  }
  const GGS_bool cond_17202 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-ppc")) ;
  if (cond_17202.isBuiltAndTrue ()) {
    ::routine_generateMakefilePPCMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (310)) ;
  }
  const GGS_bool cond_17348 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-intel")) ;
  if (cond_17348.isBuiltAndTrue ()) {
    ::routine_generateMakefileIntelMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (313)) ;
  }
  const GGS_bool cond_17502 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-universal")) ;
  if (cond_17502.isBuiltAndTrue ()) {
    ::routine_generateMakefileUniversalMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (316)) ;
  }
  const GGS_bool cond_17637 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx")) ;
  if (cond_17637.isBuiltAndTrue ()) {
    ::routine_generateMakefileMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (319)) ;
  }
  const GGS_bool cond_17768 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-unix")) ;
  if (cond_17768.isBuiltAndTrue ()) {
    ::routine_generateMakefileUnixTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (322)) ;
  }
  const GGS_bool cond_17920 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-i386-linux-on-macosx")) ;
  if (cond_17920.isBuiltAndTrue ()) {
    ::routine_generateI386LinuxOnMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (325)) ;
  }
  const GGS_bool cond_18063 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-mingw-on-macosx")) ;
  if (cond_18063.isBuiltAndTrue ()) {
    ::routine_generateMinGWOnMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (328)) ;
  }
  const GGS_bool cond_18202 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-msys-on-win32")) ;
  if (cond_18202.isBuiltAndTrue ()) {
    ::routine_generateMsysOnWin32Target (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (331)) ;
  }
  ...
  GGS_bool automatic_var_18656_0 ;
  if (var_cas_newFileListContents.isBuilt ()) {
    var_cas_newFileListContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_18656_0 COMMA_SOURCE_FILE_AT_LINE (341)) ;
  }
  const GGS_bool cond_21497 = var_cas_generationFeatures.reader_hasKey (GGS_string ("xcode-project")) ;
  if (cond_21497.isBuiltAndTrue ()) {
    const GGS_string var_cas_dir = (var_cas_projectDirectory).operator_concat (GGS_string ("/xcode-project")) ;
    if (var_cas_dir.isBuilt ()) {
      var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (345)) ;
    }
    const GGS_string var_cas_icon_help_file_path = (var_cas_dir).operator_concat (GGS_string ("/adding-icons-to-your-application.rtf")) ;
    GGS_bool automatic_var_19093_0 ;
    const GGS_string temp_19068 = GGS_string (gWrapperFileContent_27_targetGenerationFileWrapper) ;
    if (temp_19068.isBuilt ()) {
      temp_19068 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_icon_help_file_path, automatic_var_19093_0 COMMA_SOURCE_FILE_AT_LINE (348)) ;
    }
    const GGS_bool cond_19268 = ((var_cas_dir).operator_concat (GGS_string ("/Info.plist")).reader_fileExists ()).operator_not () ;
    if (cond_19268.isBuiltAndTrue ()) {
      const GGS_string temp_19237 = template_filewrapper_targetGenerationFileWrapper_makefile_info_plist (inLexique, var_cas_inTargetName) ;
      if (temp_19237.isBuilt ()) {
        temp_19237 (HERE)->method_writeToFile (inLexique, (var_cas_dir).operator_concat (GGS_string ("/Info.plist")) COMMA_SOURCE_FILE_AT_LINE (351)) ;
      }
    }
    const GGS_string temp_19316 = (var_cas_dir).operator_concat (GGS_string ("/English.lproj")) ;
    if (temp_19316.isBuilt ()) {
      temp_19316 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (354)) ;
    }
    const GGS_string var_cas_InfoPlist_strings_path = (var_cas_dir).operator_concat (GGS_string ("/English.lproj/InfoPlist.strings")) ;
    GGS_bool automatic_var_19555_0 ;
    const GGS_string temp_19527 = template_filewrapper_targetGenerationFileWrapper_makefile_info_plist_strings (inLexique, var_cas_inTargetName) ;
    if (temp_19527.isBuilt ()) {
      temp_19527 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_InfoPlist_strings_path, automatic_var_19555_0 COMMA_SOURCE_FILE_AT_LINE (356)) ;
    }
    const GGS_string var_cas_Credits_rtf_path = (var_cas_dir).operator_concat (GGS_string ("/English.lproj/Credits.rtf")) ;
    const GGS_bool cond_19809 = (var_cas_Credits_rtf_path.reader_fileExists ()).operator_not () ;
    if (cond_19809.isBuiltAndTrue ()) {
      const GGS_string temp_19780 = GGS_string (gWrapperFileContent_28_targetGenerationFileWrapper) ;
      if (temp_19780.isBuilt ()) {
        temp_19780 (HERE)->method_writeToFile (inLexique, var_cas_Credits_rtf_path COMMA_SOURCE_FILE_AT_LINE (359)) ;
      }
    }
    const GGS_string var_cas_libpmPosixPath = GGS_string::constructor_stringWithEnvironmentVariable (inLexique, GGS_string ("LIBPM_PATH") COMMA_SOURCE_FILE_AT_LINE (362)).reader_unixPathWithNativePath () ;
    const GGS_string var_cas_symbLinkPath = (var_cas_dir).operator_concat (GGS_string ("/libpm")) ;
    const GGS_bool cond_20128 = (var_cas_symbLinkPath.reader_isSymbolicLink ()).operator_not () ;
    if (cond_20128.isBuiltAndTrue ()) {
      if (var_cas_symbLinkPath.isBuilt ()) {
        var_cas_symbLinkPath (HERE)->method_makeSymbolicLinkWithPath (inLexique, var_cas_libpmPosixPath COMMA_SOURCE_FILE_AT_LINE (365)) ;
      }
    }else if (cond_20128.isBuiltAndFalse ()) {
      const GGS_bool cond_20321 = (GGS_string::constructor_stringWithSymbolicLinkContents (inLexique, var_cas_symbLinkPath COMMA_SOURCE_FILE_AT_LINE (366))).operator_isNotEqual (var_cas_libpmPosixPath) ;
      if (cond_20321.isBuiltAndTrue ()) {
        GGS_string::class_method_deleteFile (inLexique, var_cas_symbLinkPath COMMA_SOURCE_FILE_AT_LINE (367)) ;
        if (var_cas_symbLinkPath.isBuilt ()) {
          var_cas_symbLinkPath (HERE)->method_makeSymbolicLinkWithPath (inLexique, var_cas_libpmPosixPath COMMA_SOURCE_FILE_AT_LINE (368)) ;
        }
      }
    }
