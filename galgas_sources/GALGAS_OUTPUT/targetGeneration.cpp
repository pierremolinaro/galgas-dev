...
void routine_generateMsysOnWin_33__32_Target (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_string (gWrapperFileContent_7_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.bat") COMMA_SOURCE_FILE_AT_LINE (126)), joker_4691_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) ;
  GALGAS_bool joker_4829_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_8_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.bat") COMMA_SOURCE_FILE_AT_LINE (127)), joker_4829_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (127)) ;
  GALGAS_bool joker_4971_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_9_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.bat") COMMA_SOURCE_FILE_AT_LINE (128)), joker_4971_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (128)) ;
  GALGAS_bool joker_5120_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_msys_5F_on_5F_win_33__32__5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (129))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile") COMMA_SOURCE_FILE_AT_LINE (129)), joker_5120_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (129)) ;
}
...
void routine_generateMinGWOnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_string (gWrapperFileContent_5_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (140)), joker_5565_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (140)) ;
  GALGAS_bool joker_5723_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_6_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command") COMMA_SOURCE_FILE_AT_LINE (141)), joker_5723_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (141)) ;
  GALGAS_bool joker_5874_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_mingw_5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (142))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile") COMMA_SOURCE_FILE_AT_LINE (142)), joker_5874_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (142)) ;
}
...
void routine_generateMakefileMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_string (gWrapperFileContent_2_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (153)), joker_6302_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (153)) ;
  GALGAS_bool joker_6451_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_3_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command") COMMA_SOURCE_FILE_AT_LINE (154)), joker_6451_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (154)) ;
  GALGAS_bool joker_6604_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_4_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.command") COMMA_SOURCE_FILE_AT_LINE (155)), joker_6604_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (155)) ;
  GALGAS_bool joker_6746_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (156))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile") COMMA_SOURCE_FILE_AT_LINE (156)), joker_6746_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (156)) ;
}
...
void routine_generateMakefileUnixTarget (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_string (gWrapperFileContent_10_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (167)), joker_7168_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (167)) ;
  GALGAS_bool joker_7319_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_12_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.command") COMMA_SOURCE_FILE_AT_LINE (168)), joker_7319_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) ;
  GALGAS_bool joker_7466_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_11_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command") COMMA_SOURCE_FILE_AT_LINE (169)), joker_7466_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (169)) ;
  GALGAS_bool joker_7606_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_unix_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (170))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile") COMMA_SOURCE_FILE_AT_LINE (170)), joker_7606_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (170)) ;
}
...
void routine_generateI_33__38__36_LinuxOnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_string (gWrapperFileContent_0_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (181)), joker_8065_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (181)) ;
  GALGAS_bool joker_8228_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_1_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command") COMMA_SOURCE_FILE_AT_LINE (182)), joker_8228_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (182)) ;
  GALGAS_bool joker_8384_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_i_33__38__36__5F_linux_5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (183))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile") COMMA_SOURCE_FILE_AT_LINE (183)), joker_8384_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (183)) ;
}
...
void routine_generateX_38__36__5F__36__34_LinuxOnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_string (gWrapperFileContent_13_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command") COMMA_SOURCE_FILE_AT_LINE (194)), joker_8849_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (194)) ;
  GALGAS_bool joker_9014_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_14_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command") COMMA_SOURCE_FILE_AT_LINE (195)), joker_9014_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (195)) ;
  GALGAS_bool joker_9172_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_x_38__36__5F__36__34__5F_linux_5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE_AT_LINE (196))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile") COMMA_SOURCE_FILE_AT_LINE (196)), joker_9172_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (196)) ;
}
...
void routine_updateTargets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
  ...
  while (enumerator_11836.hasCurrentObject ()) {
    GALGAS_string var_baseName = enumerator_11836.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (257)).reader_lastPathComponent (SOURCE_FILE_AT_LINE (257)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (257)) ;
    GALGAS_string var_extension = enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_pathExtension (SOURCE_FILE_AT_LINE (258)) ;
    ...
    if (enumerator_11836.current_mSourceKind (HERE).isValid ()) {
      ...
      case GALGAS_sourceFileKind::kEnum_externSourceFile: {
        ...
        if (kBoolTrue == test_5) {
          var_externSourceSet_5F_tool.addAssign_operation (enumerator_11836.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (269)) COMMA_SOURCE_FILE_AT_LINE (269)) ;
          var_handCodedSourceList.addAssign_operation (enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (270)) COMMA_SOURCE_FILE_AT_LINE (270)) ;
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (271)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_6) {
            var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources") COMMA_SOURCE_FILE_AT_LINE (272)) ;
          }else if (kBoolFalse == test_6) {
            var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (274)) COMMA_SOURCE_FILE_AT_LINE (274)) COMMA_SOURCE_FILE_AT_LINE (274)) ;
          }
        }else if (kBoolFalse == test_5) {
          const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("framework"))).boolEnum () ;
          if (kBoolTrue == test_7) {
            var_externSourceSet_5F_tool.addAssign_operation (enumerator_11836.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (277)) ;
            var_externSourceSet_5F_app.addAssign_operation (enumerator_11836.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (278)) COMMA_SOURCE_FILE_AT_LINE (278)) ;
            const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (279)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_8) {
              var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources") COMMA_SOURCE_FILE_AT_LINE (280)) ;
            }else if (kBoolFalse == test_8) {
              var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (282)) COMMA_SOURCE_FILE_AT_LINE (282)) COMMA_SOURCE_FILE_AT_LINE (282)) ;
            }
          }else if (kBoolFalse == test_7) {
            const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("m"))).boolEnum () ;
            if (kBoolTrue == test_9) {
              var_externSourceSet_5F_app.addAssign_operation (enumerator_11836.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (285)) COMMA_SOURCE_FILE_AT_LINE (285)) ;
              const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (286)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_10) {
                ...
                var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (289)) COMMA_SOURCE_FILE_AT_LINE (289)) COMMA_SOURCE_FILE_AT_LINE (289)) ;
              }
            }else if (kBoolFalse == test_9) {
              const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("h"))).boolEnum () ;
              if (kBoolTrue == test_11) {
                var_externSourceSet_5F_tool.addAssign_operation (enumerator_11836.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (292)) COMMA_SOURCE_FILE_AT_LINE (292)) ;
                const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (293)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_12) {
                  ...
                  var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (296)) COMMA_SOURCE_FILE_AT_LINE (296)) COMMA_SOURCE_FILE_AT_LINE (296)) ;
                }
              }else if (kBoolFalse == test_11) {
                const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("xib"))).boolEnum () ;
                if (kBoolTrue == test_13) {
                  var_externSourceSet_5F_app.addAssign_operation (enumerator_11836.current_mFilePath (HERE).reader_string (SOURCE_FILE_AT_LINE (299)) COMMA_SOURCE_FILE_AT_LINE (299)) ;
                  const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (300)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                  if (kBoolTrue == test_14) {
                    ...
                    var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (303)) COMMA_SOURCE_FILE_AT_LINE (303)) COMMA_SOURCE_FILE_AT_LINE (303)) ;
                  }
  ...
  while (enumerator_16357.hasCurrentObject ()) {
    const enumGalgasBool test_17 = var_availableGenerationFeatures.reader_hasKey (enumerator_16357.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (354)) COMMA_SOURCE_FILE_AT_LINE (354)).boolEnum () ;
    if (kBoolTrue == test_17) {
      const enumGalgasBool test_18 = var_generationFeatures.reader_hasKey (enumerator_16357.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (355)) COMMA_SOURCE_FILE_AT_LINE (355)).boolEnum () ;
      if (kBoolTrue == test_18) {
        ...
        inCompiler->emitSemanticError (location_19, GALGAS_string ("duplicate '").operator_concat (enumerator_16357.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)) ;
      }
      ...
      if (kBoolTrue == test_20) {
        ...
        if (kBoolTrue == test_21) {
          ...
          inCompiler->emitSemanticError (location_22, GALGAS_string ("duplicate '").operator_concat (enumerator_16357.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (361)).operator_concat (GALGAS_string ("' feature") COMMA_SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (361)) ;
        }
              ...
              if (kBoolTrue == test_32) {
                ...
                if (kBoolTrue == test_35) {
                  ...
                  if (kBoolTrue == test_38) {
                    ...
                    var_generationFeatures.addAssign_operation (enumerator_16357.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (406)) COMMA_SOURCE_FILE_AT_LINE (406)) ;
                  }
                }
              }
            }
      ...
      while (enumerator_18756.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_18756.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (411)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (411)) COMMA_SOURCE_FILE_AT_LINE (411)) ;
      ...
      inCompiler->emitSemanticError (location_41, GALGAS_string ("unknown '").operator_concat (enumerator_16357.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (413)) COMMA_SOURCE_FILE_AT_LINE (413)).operator_concat (GALGAS_string ("' feature; available features are:") COMMA_SOURCE_FILE_AT_LINE (413)).operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (413)) COMMA_SOURCE_FILE_AT_LINE (413)) ;
    }
  ...
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_20591_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (448)) ;
  ...
  if (kBoolTrue == test_52) {
    ...
    GALGAS_string (gWrapperFileContent_15_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_icon_5F_help_5F_file_5F_path, joker_21183_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (457)) ;
    ...
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist") COMMA_SOURCE_FILE_AT_LINE (471)), joker_21726_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (471)) ;
    ...
    GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (479))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_22213_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (479)) ;
    ...
    if (NULL != objectArray_22515) {
      ...
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (488))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h") COMMA_SOURCE_FILE_AT_LINE (488)), joker_22895_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (488)) ;
      GALGAS_bool joker_23195_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, constinArgument_inTargetName, objectArray_22515->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE_AT_LINE (489))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m") COMMA_SOURCE_FILE_AT_LINE (494)), joker_23195_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (489)) ;
      GALGAS_bool joker_23393_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_nib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE_AT_LINE (497))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib") COMMA_SOURCE_FILE_AT_LINE (497)), joker_23393_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (497)) ;
      GALGAS_bool joker_23547_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (498))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h") COMMA_SOURCE_FILE_AT_LINE (498)), joker_23547_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (498)) ;
      GALGAS_bool joker_23709_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (499))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m") COMMA_SOURCE_FILE_AT_LINE (499)), joker_23709_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (499)) ;
      GALGAS_bool joker_23863_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (500))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h") COMMA_SOURCE_FILE_AT_LINE (500)), joker_23863_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (500)) ;
      GALGAS_bool joker_24025_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE_AT_LINE (501))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m") COMMA_SOURCE_FILE_AT_LINE (501)), joker_24025_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (501)) ;
      GALGAS_bool joker_24195_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE_AT_LINE (502))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h") COMMA_SOURCE_FILE_AT_LINE (502)), joker_24195_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (502)) ;
