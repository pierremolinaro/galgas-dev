...
void routine_generateMsysOnWin32Target (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (54)) ;
  }
  GGS_bool automatic_var_2560_0 ;
  const GGS_string temp_2537 = GGS_string (gWrapperFileContent_20_targetGenerationFileWrapper) ;
  if (temp_2537.isBuilt ()) {
    temp_2537 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.bat")), automatic_var_2560_0 COMMA_SOURCE_FILE_AT_LINE (55)) ;
  }
  GGS_bool automatic_var_2698_0 ;
  const GGS_string temp_2675 = GGS_string (gWrapperFileContent_21_targetGenerationFileWrapper) ;
  if (temp_2675.isBuilt ()) {
    temp_2675 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.bat")), automatic_var_2698_0 COMMA_SOURCE_FILE_AT_LINE (56)) ;
  }
  GGS_bool automatic_var_2840_0 ;
  const GGS_string temp_2815 = GGS_string (gWrapperFileContent_22_targetGenerationFileWrapper) ;
  if (temp_2815.isBuilt ()) {
    temp_2815 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/install.bat")), automatic_var_2840_0 COMMA_SOURCE_FILE_AT_LINE (57)) ;
  }
  GGS_bool automatic_var_2989_0 ;
  const GGS_string temp_2967 = template_filewrapper_targetGenerationFileWrapper_makefile_msys_on_win32_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_2967.isBuilt ()) {
    temp_2967 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_2989_0 COMMA_SOURCE_FILE_AT_LINE (58)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateMinGWOnMacOSXTarget (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (68)) ;
  }
  GGS_bool automatic_var_3434_0 ;
  const GGS_string temp_3407 = GGS_string (gWrapperFileContent_18_targetGenerationFileWrapper) ;
  if (temp_3407.isBuilt ()) {
    temp_3407 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.command")), automatic_var_3434_0 COMMA_SOURCE_FILE_AT_LINE (69)) ;
  }
  GGS_bool automatic_var_3592_0 ;
  const GGS_string temp_3565 = GGS_string (gWrapperFileContent_19_targetGenerationFileWrapper) ;
  if (temp_3565.isBuilt ()) {
    temp_3565 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.command")), automatic_var_3592_0 COMMA_SOURCE_FILE_AT_LINE (70)) ;
  }
  GGS_bool automatic_var_3743_0 ;
  const GGS_string temp_3721 = template_filewrapper_targetGenerationFileWrapper_makefile_mingw_on_macosx_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_3721.isBuilt ()) {
    temp_3721 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_3743_0 COMMA_SOURCE_FILE_AT_LINE (71)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateMakefileMacOSXTarget (C_CompilerEx & inLexique,
  ...
  GGS_bool automatic_var_4171_0 ;
  const GGS_string temp_4144 = GGS_string (gWrapperFileContent_2_targetGenerationFileWrapper) ;
  if (temp_4144.isBuilt ()) {
    temp_4144 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.command")), automatic_var_4171_0 COMMA_SOURCE_FILE_AT_LINE (82)) ;
  }
  GGS_bool automatic_var_4320_0 ;
  const GGS_string temp_4293 = GGS_string (gWrapperFileContent_4_targetGenerationFileWrapper) ;
  if (temp_4293.isBuilt ()) {
    temp_4293 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.command")), automatic_var_4320_0 COMMA_SOURCE_FILE_AT_LINE (83)) ;
  }
  GGS_bool automatic_var_4473_0 ;
  const GGS_string temp_4444 = GGS_string (gWrapperFileContent_3_targetGenerationFileWrapper) ;
  if (temp_4444.isBuilt ()) {
    temp_4444 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build64.command")), automatic_var_4473_0 COMMA_SOURCE_FILE_AT_LINE (84)) ;
  }
  GGS_bool automatic_var_4626_0 ;
  const GGS_string temp_4597 = GGS_string (gWrapperFileContent_5_targetGenerationFileWrapper) ;
  if (temp_4597.isBuilt ()) {
    temp_4597 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean64.command")), automatic_var_4626_0 COMMA_SOURCE_FILE_AT_LINE (85)) ;
  }
  GGS_bool automatic_var_4768_0 ;
  const GGS_string temp_4746 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_4746.isBuilt ()) {
    temp_4746 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_4768_0 COMMA_SOURCE_FILE_AT_LINE (86)) ;
  }
  GGS_bool automatic_var_4914_0 ;
  const GGS_string temp_4890 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_makefile64 (inLexique, var_cas_inProjectName) ;
  if (temp_4890.isBuilt ()) {
    temp_4890 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile64")), automatic_var_4914_0 COMMA_SOURCE_FILE_AT_LINE (87)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateMakefileIntelMacOSXTarget (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (97)) ;
  }
  GGS_bool automatic_var_5359_0 ;
  const GGS_string temp_5332 = GGS_string (gWrapperFileContent_6_targetGenerationFileWrapper) ;
  if (temp_5332.isBuilt ()) {
    temp_5332 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.command")), automatic_var_5359_0 COMMA_SOURCE_FILE_AT_LINE (98)) ;
  }
  GGS_bool automatic_var_5514_0 ;
  const GGS_string temp_5487 = GGS_string (gWrapperFileContent_8_targetGenerationFileWrapper) ;
  if (temp_5487.isBuilt ()) {
    temp_5487 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.command")), automatic_var_5514_0 COMMA_SOURCE_FILE_AT_LINE (99)) ;
  }
  GGS_bool automatic_var_5673_0 ;
  const GGS_string temp_5644 = GGS_string (gWrapperFileContent_7_targetGenerationFileWrapper) ;
  if (temp_5644.isBuilt ()) {
    temp_5644 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build64.command")), automatic_var_5673_0 COMMA_SOURCE_FILE_AT_LINE (100)) ;
  }
  GGS_bool automatic_var_5832_0 ;
  const GGS_string temp_5803 = GGS_string (gWrapperFileContent_9_targetGenerationFileWrapper) ;
  if (temp_5803.isBuilt ()) {
    temp_5803 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean64.command")), automatic_var_5832_0 COMMA_SOURCE_FILE_AT_LINE (101)) ;
  }
  GGS_bool automatic_var_5980_0 ;
  const GGS_string temp_5958 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_intel_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_5958.isBuilt ()) {
    temp_5958 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_5980_0 COMMA_SOURCE_FILE_AT_LINE (102)) ;
  }
  GGS_bool automatic_var_6132_0 ;
  const GGS_string temp_6108 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_intel_makefile64 (inLexique, var_cas_inProjectName) ;
  if (temp_6108.isBuilt ()) {
    temp_6108 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile64")), automatic_var_6132_0 COMMA_SOURCE_FILE_AT_LINE (103)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateMakefilePPCMacOSXTarget (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (113)) ;
  }
  GGS_bool automatic_var_6571_0 ;
  const GGS_string temp_6544 = GGS_string (gWrapperFileContent_10_targetGenerationFileWrapper) ;
  if (temp_6544.isBuilt ()) {
    temp_6544 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.command")), automatic_var_6571_0 COMMA_SOURCE_FILE_AT_LINE (114)) ;
  }
  GGS_bool automatic_var_6724_0 ;
  const GGS_string temp_6697 = GGS_string (gWrapperFileContent_12_targetGenerationFileWrapper) ;
  if (temp_6697.isBuilt ()) {
    temp_6697 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.command")), automatic_var_6724_0 COMMA_SOURCE_FILE_AT_LINE (115)) ;
  }
  GGS_bool automatic_var_6881_0 ;
  const GGS_string temp_6852 = GGS_string (gWrapperFileContent_11_targetGenerationFileWrapper) ;
  if (temp_6852.isBuilt ()) {
    temp_6852 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build64.command")), automatic_var_6881_0 COMMA_SOURCE_FILE_AT_LINE (116)) ;
  }
  GGS_bool automatic_var_7038_0 ;
  const GGS_string temp_7009 = GGS_string (gWrapperFileContent_13_targetGenerationFileWrapper) ;
  if (temp_7009.isBuilt ()) {
    temp_7009 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean64.command")), automatic_var_7038_0 COMMA_SOURCE_FILE_AT_LINE (117)) ;
  }
  GGS_bool automatic_var_7184_0 ;
  const GGS_string temp_7162 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_ppc_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_7162.isBuilt ()) {
    temp_7162 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_7184_0 COMMA_SOURCE_FILE_AT_LINE (118)) ;
  }
  GGS_bool automatic_var_7334_0 ;
  const GGS_string temp_7310 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_ppc_makefile64 (inLexique, var_cas_inProjectName) ;
  if (temp_7310.isBuilt ()) {
    temp_7310 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile64")), automatic_var_7334_0 COMMA_SOURCE_FILE_AT_LINE (119)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateMakefileUniversalMacOSXTarget (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (129)) ;
  }
  GGS_bool automatic_var_7791_0 ;
  const GGS_string temp_7764 = GGS_string (gWrapperFileContent_14_targetGenerationFileWrapper) ;
  if (temp_7764.isBuilt ()) {
    temp_7764 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.command")), automatic_var_7791_0 COMMA_SOURCE_FILE_AT_LINE (130)) ;
  }
  GGS_bool automatic_var_7950_0 ;
  const GGS_string temp_7923 = GGS_string (gWrapperFileContent_16_targetGenerationFileWrapper) ;
  if (temp_7923.isBuilt ()) {
    temp_7923 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.command")), automatic_var_7950_0 COMMA_SOURCE_FILE_AT_LINE (131)) ;
  }
  GGS_bool automatic_var_8113_0 ;
  const GGS_string temp_8084 = GGS_string (gWrapperFileContent_15_targetGenerationFileWrapper) ;
  if (temp_8084.isBuilt ()) {
    temp_8084 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build64.command")), automatic_var_8113_0 COMMA_SOURCE_FILE_AT_LINE (132)) ;
  }
  GGS_bool automatic_var_8276_0 ;
  const GGS_string temp_8247 = GGS_string (gWrapperFileContent_17_targetGenerationFileWrapper) ;
  if (temp_8247.isBuilt ()) {
    temp_8247 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean64.command")), automatic_var_8276_0 COMMA_SOURCE_FILE_AT_LINE (133)) ;
  }
  GGS_bool automatic_var_8428_0 ;
  const GGS_string temp_8406 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_universal_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_8406.isBuilt ()) {
    temp_8406 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_8428_0 COMMA_SOURCE_FILE_AT_LINE (134)) ;
  }
  GGS_bool automatic_var_8584_0 ;
  const GGS_string temp_8560 = template_filewrapper_targetGenerationFileWrapper_makefile_macosx_universal_makefile64 (inLexique, var_cas_inProjectName) ;
  if (temp_8560.isBuilt ()) {
    temp_8560 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile64")), automatic_var_8584_0 COMMA_SOURCE_FILE_AT_LINE (135)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateMakefileUnixTarget (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (145)) ;
  }
  GGS_bool automatic_var_9006_0 ;
  const GGS_string temp_8979 = GGS_string (gWrapperFileContent_23_targetGenerationFileWrapper) ;
  if (temp_8979.isBuilt ()) {
    temp_8979 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.command")), automatic_var_9006_0 COMMA_SOURCE_FILE_AT_LINE (146)) ;
  }
  GGS_bool automatic_var_9153_0 ;
  const GGS_string temp_9126 = GGS_string (gWrapperFileContent_25_targetGenerationFileWrapper) ;
  if (temp_9126.isBuilt ()) {
    temp_9126 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.command")), automatic_var_9153_0 COMMA_SOURCE_FILE_AT_LINE (147)) ;
  }
  GGS_bool automatic_var_9304_0 ;
  const GGS_string temp_9275 = GGS_string (gWrapperFileContent_24_targetGenerationFileWrapper) ;
  if (temp_9275.isBuilt ()) {
    temp_9275 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build64.command")), automatic_var_9304_0 COMMA_SOURCE_FILE_AT_LINE (148)) ;
  }
  GGS_bool automatic_var_9455_0 ;
  const GGS_string temp_9426 = GGS_string (gWrapperFileContent_26_targetGenerationFileWrapper) ;
  if (temp_9426.isBuilt ()) {
    temp_9426 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean64.command")), automatic_var_9455_0 COMMA_SOURCE_FILE_AT_LINE (149)) ;
  }
  GGS_bool automatic_var_9595_0 ;
  const GGS_string temp_9573 = template_filewrapper_targetGenerationFileWrapper_makefile_unix_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_9573.isBuilt ()) {
    temp_9573 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_9595_0 COMMA_SOURCE_FILE_AT_LINE (150)) ;
  }
  GGS_bool automatic_var_9739_0 ;
  const GGS_string temp_9715 = template_filewrapper_targetGenerationFileWrapper_makefile_unix_makefile64 (inLexique, var_cas_inProjectName) ;
  if (temp_9715.isBuilt ()) {
    temp_9715 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile64")), automatic_var_9739_0 COMMA_SOURCE_FILE_AT_LINE (151)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generateI386LinuxOnMacOSXTarget (C_CompilerEx & inLexique,
  ...
  if (var_cas_dir.isBuilt ()) {
    var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (161)) ;
  }
  GGS_bool automatic_var_10198_0 ;
  const GGS_string temp_10171 = GGS_string (gWrapperFileContent_0_targetGenerationFileWrapper) ;
  if (temp_10171.isBuilt ()) {
    temp_10171 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/build.command")), automatic_var_10198_0 COMMA_SOURCE_FILE_AT_LINE (162)) ;
  }
  GGS_bool automatic_var_10361_0 ;
  const GGS_string temp_10334 = GGS_string (gWrapperFileContent_1_targetGenerationFileWrapper) ;
  if (temp_10334.isBuilt ()) {
    temp_10334 (HERE)->method_writeToExecutableFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/clean.command")), automatic_var_10361_0 COMMA_SOURCE_FILE_AT_LINE (163)) ;
  }
  GGS_bool automatic_var_10517_0 ;
  const GGS_string temp_10495 = template_filewrapper_targetGenerationFileWrapper_makefile_i386_linux_on_macosx_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_10495.isBuilt ()) {
    temp_10495 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/makefile")), automatic_var_10517_0 COMMA_SOURCE_FILE_AT_LINE (164)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_updateTargets (C_CompilerEx & inLexique,
  ...
  {
    GGS_projectSourceList::cEnumerator enumerator_12039 (var_cas_inProjectSourceList, true) ;
    const GGS_projectSourceList::cElement * operand_12039 = NULL ;
    while (((operand_12039 = enumerator_12039.nextObject ()))) {
      macroValidPointer (operand_12039) ;
      const GGS_string var_cas_baseName = operand_12039->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202)).reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
      const GGS_string var_cas_cppFile = (var_cas_baseName).operator_concat (GGS_string (".cpp")) ;
      const GGS_bool cond_12383 = var_cas_sourceFileSet.reader_hasKey (var_cas_baseName) ;
      if (cond_12383.isBuiltAndTrue ()) {
        operand_12039->mFilePath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("there is already a file with '")).operator_concat (var_cas_baseName)).operator_concat (GGS_string ("' as base name in the project")) COMMA_SOURCE_FILE_AT_LINE (207)) ;
      }
      var_cas_sourceFileSet.addAssign_operation (var_cas_baseName) ;
      switch (operand_12039->mSourceKind.enumValue ()) {
      case GGS_sourceFileKind::enum_externSourceFile:
        {
        var_cas_externSourceSet_tool.addAssign_operation (operand_12039->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (212))) ;
        var_cas_externSourceSet_app.addAssign_operation (operand_12039->mFilePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (213))) ;
        var_cas_handCodedSourceList.addAssign_operation (operand_12039->mFilePath.ggs_string ().reader_lastPathComponent ()) ;
        var_cas_handCodedSourceDirectorySet.addAssign_operation ((GGS_string ("../hand_coded_sources/")).operator_concat (operand_12039->mFilePath.ggs_string ().reader_stringByDeletingLastPathComponent ())) ;
        }
        break ;
      case GGS_sourceFileKind::enum_lexiqueSourceFile:
        ...
        var_cas_scannerSourceSet_app.addAssign_operation (var_cas_baseName) ;
        }
        break ;
      case GGS_sourceFileKind::enum_syntaxSourceFile:
        ...
        var_cas_syntaxSourceSet_app.addAssign_operation (var_cas_baseName) ;
        }
        break ;
      case GGS_sourceFileKind::enum_semanticsSourceFile:
        ...
        var_cas_semanticsSourceSet_app.addAssign_operation (var_cas_baseName) ;
        }
        break ;
      case GGS_sourceFileKind::enum_grammarSourceFile:
        ...
        var_cas_grammarSourceSet_app.addAssign_operation (var_cas_baseName) ;
        }
        break ;
      case GGS_sourceFileKind::enum_programSourceFile:
        ...
        var_cas_programSourceSet_app.addAssign_operation (var_cas_baseName) ;
        }
        break ;
      case GGS_sourceFileKind::enum_optionSourceFile:
        ...
        var_cas_optionSourceSet_app.addAssign_operation (var_cas_baseName) ;
        }
        break ;
      case GGS_sourceFileKind::enum_guiSourceFile:
        {
        var_cas_guiSourceSet_tool.addAssign_operation (var_cas_baseName) ;
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_14806 (var_cas_inTargetFeatureList, true) ;
    const GGS_lstringlist::cElement * operand_14806 = NULL ;
    while (((operand_14806 = enumerator_14806.nextObject ()))) {
      macroValidPointer (operand_14806) ;
      const GGS_bool cond_15066 = var_cas_availableGenerationFeatures.reader_hasKey (operand_14806->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (263))) ;
      if (cond_15066.isBuiltAndTrue ()) {
        const GGS_bool cond_15005 = var_cas_generationFeatures.reader_hasKey (operand_14806->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (264))) ;
        if (cond_15005.isBuiltAndTrue ()) {
          operand_14806->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("duplicate '")).operator_concat (operand_14806->mValue)).operator_concat (GGS_string ("' feature")) COMMA_SOURCE_FILE_AT_LINE (266)) ;
        }
        var_cas_generationFeatures.addAssign_operation (operand_14806->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (267))) ;
      }else if (cond_15066.isBuiltAndFalse ()) {
        GGS_string var_cas_s = GGS_string ("") ;
        {
          GGS_stringset::cEnumerator enumerator_15132 (var_cas_availableGenerationFeatures, true) ;
          while (enumerator_15132.hasCurrentObject ()) {
            var_cas_s.appendCString ("\n"
              "  - '") ;
            var_cas_s.dotAssign_operation (enumerator_15132._key (HERE)) ;
            var_cas_s.appendCString ("'") ;
            enumerator_15132.next () ;
          }
        }
        operand_14806->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((GGS_string ("unknown '")).operator_concat (operand_14806->mValue)).operator_concat (GGS_string ("' feature; avalaible features are:"))).operator_concat (var_cas_s) COMMA_SOURCE_FILE_AT_LINE (274)) ;
      }
    }
  }
  const GGS_bool cond_15661 = (var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-universal"))).operator_and ((var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-ppc"))).operator_not ()) ;
  if (cond_15661.isBuiltAndTrue ()) {
    var_cas_inProjectName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("'feature makefile-macosx-ppc' implicitly added, due to 'feature makefile-macosx-universal'") COMMA_SOURCE_FILE_AT_LINE (278)) ;
    var_cas_generationFeatures.addAssign_operation (GGS_string ("makefile-macosx-ppc")) ;
  }
  const GGS_bool cond_15976 = (var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-universal"))).operator_and ((var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-intel"))).operator_not ()) ;
  if (cond_15976.isBuiltAndTrue ()) {
    var_cas_inProjectName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("'feature makefile-macosx-intel' implicitly added, due to 'feature makefile-macosx-universal'") COMMA_SOURCE_FILE_AT_LINE (282)) ;
  ...
  const GGS_bool cond_16162 = var_cas_generationFeatures.reader_hasKey (GGS_string ("xcode-arch:i386")) ;
  if (cond_16162.isBuiltAndTrue ()) {
    var_cas_architectureList.addAssign_operation (GGS_string ("i386")) ;
  }
  const GGS_bool cond_16269 = var_cas_generationFeatures.reader_hasKey (GGS_string ("xcode-arch:x86_64")) ;
  if (cond_16269.isBuiltAndTrue ()) {
    var_cas_architectureList.addAssign_operation (GGS_string ("x86_64")) ;
  }
  const GGS_bool cond_16374 = var_cas_generationFeatures.reader_hasKey (GGS_string ("xcode-arch:ppc64")) ;
  if (cond_16374.isBuiltAndTrue ()) {
    var_cas_architectureList.addAssign_operation (GGS_string ("ppc64")) ;
  }
  const GGS_bool cond_16484 = var_cas_generationFeatures.reader_hasKey (GGS_string ("xcode-arch:ppc")) ;
  if (cond_16484.isBuiltAndTrue ()) {
    var_cas_architectureList.addAssign_operation (GGS_string ("ppc7400")) ;
  }
  const GGS_bool cond_16719 = (var_cas_generationFeatures.reader_hasKey (GGS_string ("xcode-project"))).operator_and ((var_cas_architectureList.reader_length ()).operator_isEqual (GGS_uint (0U))) ;
  if (cond_16719.isBuiltAndTrue ()) {
    var_cas_inProjectName.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("'feature 'xcode-arch:i386' implicitly added, due to 'xcode-project'") COMMA_SOURCE_FILE_AT_LINE (300)) ;
    var_cas_architectureList.addAssign_operation (GGS_string ("i386")) ;
  }
  const GGS_bool cond_16918 = ((var_cas_architectureList.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and ((var_cas_generationFeatures.reader_hasKey (GGS_string ("xcode-project"))).operator_not ()) ;
  if (cond_16918.isBuiltAndTrue ()) {
    var_cas_inProjectName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'a 'xcode-arch:...' feature requires the 'xcode-project' feature") COMMA_SOURCE_FILE_AT_LINE (305)) ;
  }
  const GGS_bool cond_17083 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-ppc")) ;
  if (cond_17083.isBuiltAndTrue ()) {
    ::routine_generateMakefilePPCMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (308)) ;
  }
  const GGS_bool cond_17229 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-intel")) ;
  if (cond_17229.isBuiltAndTrue ()) {
    ::routine_generateMakefileIntelMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (311)) ;
  }
  const GGS_bool cond_17383 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx-universal")) ;
  if (cond_17383.isBuiltAndTrue ()) {
    ::routine_generateMakefileUniversalMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (314)) ;
  }
  const GGS_bool cond_17518 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-macosx")) ;
  if (cond_17518.isBuiltAndTrue ()) {
    ::routine_generateMakefileMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (317)) ;
  }
  const GGS_bool cond_17649 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-unix")) ;
  if (cond_17649.isBuiltAndTrue ()) {
    ::routine_generateMakefileUnixTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (320)) ;
  }
  const GGS_bool cond_17801 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-i386-linux-on-macosx")) ;
  if (cond_17801.isBuiltAndTrue ()) {
    ::routine_generateI386LinuxOnMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (323)) ;
  }
  const GGS_bool cond_17944 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-mingw-on-macosx")) ;
  if (cond_17944.isBuiltAndTrue ()) {
    ::routine_generateMinGWOnMacOSXTarget (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (326)) ;
  }
  const GGS_bool cond_18083 = var_cas_generationFeatures.reader_hasKey (GGS_string ("makefile-msys-on-win32")) ;
  if (cond_18083.isBuiltAndTrue ()) {
    ::routine_generateMsysOnWin32Target (inLexique,  var_cas_projectDirectory,  var_cas_inTargetName COMMA_SOURCE_FILE_AT_LINE (329)) ;
  }
  ...
  GGS_bool automatic_var_18537_0 ;
  if (var_cas_newFileListContents.isBuilt ()) {
    var_cas_newFileListContents (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_18537_0 COMMA_SOURCE_FILE_AT_LINE (339)) ;
  }
  const GGS_bool cond_21142 = var_cas_generationFeatures.reader_hasKey (GGS_string ("xcode-project")) ;
  if (cond_21142.isBuiltAndTrue ()) {
    ...
    if (var_cas_dir.isBuilt ()) {
      var_cas_dir (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (343)) ;
    }
    GGS_bool automatic_var_18865_0 ;
    const GGS_string temp_18841 = template_filewrapper_targetGenerationFileWrapper_makefile_info_plist (inLexique, var_cas_inTargetName) ;
    if (temp_18841.isBuilt ()) {
      temp_18841 (HERE)->method_writeToFileWhenDifferentContents (inLexique, (var_cas_dir).operator_concat (GGS_string ("/Info.plist")), automatic_var_18865_0 COMMA_SOURCE_FILE_AT_LINE (344)) ;
    }
    const GGS_string temp_18912 = (var_cas_dir).operator_concat (GGS_string ("/English.lproj")) ;
    if (temp_18912.isBuilt ()) {
      temp_18912 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (346)) ;
    }
    const GGS_string var_cas_InfoPlist_strings_path = (var_cas_dir).operator_concat (GGS_string ("/English.lproj/InfoPlist.strings")) ;
    const GGS_bool cond_19197 = (var_cas_InfoPlist_strings_path.reader_fileExists ()).operator_not () ;
    if (cond_19197.isBuiltAndTrue ()) {
      const GGS_string temp_19162 = GGS_string (gWrapperFileContent_28_targetGenerationFileWrapper) ;
      if (temp_19162.isBuilt ()) {
        temp_19162 (HERE)->method_writeToFile (inLexique, var_cas_InfoPlist_strings_path COMMA_SOURCE_FILE_AT_LINE (349)) ;
      }
    }
    const GGS_string var_cas_Credits_rtf_path = (var_cas_dir).operator_concat (GGS_string ("/English.lproj/Credits.rtf")) ;
    const GGS_bool cond_19454 = (var_cas_Credits_rtf_path.reader_fileExists ()).operator_not () ;
    if (cond_19454.isBuiltAndTrue ()) {
      const GGS_string temp_19425 = GGS_string (gWrapperFileContent_27_targetGenerationFileWrapper) ;
      if (temp_19425.isBuilt ()) {
        temp_19425 (HERE)->method_writeToFile (inLexique, var_cas_Credits_rtf_path COMMA_SOURCE_FILE_AT_LINE (353)) ;
      }
    }
    const GGS_string var_cas_libpmPosixPath = GGS_string::constructor_stringWithEnvironmentVariable (inLexique, GGS_string ("LIBPM_PATH") COMMA_SOURCE_FILE_AT_LINE (356)).reader_unixPathWithNativePath () ;
    const GGS_string var_cas_symbLinkPath = (var_cas_dir).operator_concat (GGS_string ("/libpm")) ;
    const GGS_bool cond_19773 = (var_cas_symbLinkPath.reader_isSymbolicLink ()).operator_not () ;
    if (cond_19773.isBuiltAndTrue ()) {
      if (var_cas_symbLinkPath.isBuilt ()) {
        var_cas_symbLinkPath (HERE)->method_makeSymbolicLinkWithPath (inLexique, var_cas_libpmPosixPath COMMA_SOURCE_FILE_AT_LINE (359)) ;
      }
    }else if (cond_19773.isBuiltAndFalse ()) {
      const GGS_bool cond_19966 = (GGS_string::constructor_stringWithSymbolicLinkContents (inLexique, var_cas_symbLinkPath COMMA_SOURCE_FILE_AT_LINE (360))).operator_isNotEqual (var_cas_libpmPosixPath) ;
      if (cond_19966.isBuiltAndTrue ()) {
        GGS_string::class_method_deleteFile (inLexique, var_cas_symbLinkPath COMMA_SOURCE_FILE_AT_LINE (361)) ;
        if (var_cas_symbLinkPath.isBuilt ()) {
          var_cas_symbLinkPath (HERE)->method_makeSymbolicLinkWithPath (inLexique, var_cas_libpmPosixPath COMMA_SOURCE_FILE_AT_LINE (362)) ;
        }
      }
    }
