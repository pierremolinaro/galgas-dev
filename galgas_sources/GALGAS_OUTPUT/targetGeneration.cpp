...
GALGAS_string filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_file_5F_list (C_Compiler * /* inCompiler */,
  ...
  if (in_HAND_5F_CODED_5F_SOURCE_5F_DIR_5F_SET.isValid ()) {
    cEnumerator_stringset enumerator_702 (in_HAND_5F_CODED_5F_SOURCE_5F_DIR_5F_SET, kEnumeration_up) ;
    while (enumerator_702.hasCurrentObject ()) {
      result << "SOURCES_DIR += " ;
      result << enumerator_702.current_key (HERE).stringValue () ;
      result << "\n" ;
  ...
  if (in_HAND_5F_CODED_5F_SOURCE_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_1321 (in_HAND_5F_CODED_5F_SOURCE_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1321.hasCurrentObject ()) {
      result << "SOURCES += " ;
      result << enumerator_1321.current_mValue (HERE).stringValue () ;
      result << "\n" ;
  ...
  GALGAS_uint index_1430_ (0) ;
  if (in_MAKEFILE_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_1430 (in_MAKEFILE_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1430.hasCurrentObject ()) {
      result << "SOURCES += " ;
      result << enumerator_1430.current_mValue (HERE).stringValue () ;
      result << "\n" ;
      index_1430_.increment () ;
      enumerator_1430.gotoNextObject () ;
    }
  }
  result << "\n"
    "\n"
...
void routine_generateMsysOnWin_33__32_Target (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_bool joker_4691_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_10_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.bat")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 126)), joker_4691_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 126)) ;
  GALGAS_bool joker_4829_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_11_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.bat")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 127)), joker_4829_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 127)) ;
  GALGAS_bool joker_4971_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_12_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.bat")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 128)), joker_4971_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 128)) ;
  GALGAS_bool joker_5120_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_msys_5F_on_5F_win_33__32__5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 129))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 129)), joker_5120_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 129)) ;
}
...
void routine_generateMinGWOnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_bool joker_5565_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_8_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 140)), joker_5565_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 140)) ;
  GALGAS_bool joker_5723_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_9_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 141)), joker_5723_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 141)) ;
  GALGAS_bool joker_5874_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_mingw_5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 142))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 142)), joker_5874_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 142)) ;
}
...
void routine_generateMakefileMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_string (gWrapperFileContent_5_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 153)), joker_6302_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 153)) ;
  GALGAS_bool joker_6451_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_6_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 154)), joker_6451_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 154)) ;
  GALGAS_bool joker_6604_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_7_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 155)), joker_6604_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 155)) ;
  GALGAS_bool joker_6746_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 156))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 156)), joker_6746_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 156)) ;
}
...
void routine_generateMakefileUnixTarget (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_bool joker_7168_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_13_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 167)), joker_7168_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 167)) ;
  GALGAS_bool joker_7319_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_15_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/install.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 168)), joker_7319_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 168)) ;
  GALGAS_bool joker_7466_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_14_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 169)), joker_7466_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 169)) ;
  GALGAS_bool joker_7606_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_unix_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 170))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 170)), joker_7606_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 170)) ;
}
...
void routine_generateI_33__38__36_LinuxOnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_bool joker_8065_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_3_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 181)), joker_8065_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 181)) ;
  GALGAS_bool joker_8228_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_4_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 182)), joker_8228_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 182)) ;
  GALGAS_bool joker_8384_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_i_33__38__36__5F_linux_5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 183))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 183)), joker_8384_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 183)) ;
}
...
void routine_generateX_38__36__5F__36__34_LinuxOnMacOSXTarget (const GALGAS_string constinArgument_inProjectDirectory,
  ...
  GALGAS_bool joker_8849_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_16_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 194)), joker_8849_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 194)) ;
  GALGAS_bool joker_9014_0 ; // Joker input parameter
  GALGAS_string (gWrapperFileContent_17_targetGenerationFileWrapper).method_writeToExecutableFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/clean.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 195)), joker_9014_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 195)) ;
  GALGAS_bool joker_9172_0 ; // Joker input parameter
  GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_x_38__36__5F__36__34__5F_linux_5F_on_5F_macosx_5F_makefile (inCompiler, constinArgument_inProjectName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 196))).method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/makefile")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 196)), joker_9172_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 196)) ;
}
...
void routine_updateTargets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
  ...
  if (NULL != objectArray_10035) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (objectArray_10035->mAttribute_mFeatureValue.reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      var_libpmPath = objectArray_10035->mAttribute_mFeatureValue.mAttribute_string ;
    }
  }else{
    {
  ...
  cEnumerator_projectSourceList enumerator_11554 (constinArgument_inProjectSourceList, kEnumeration_up) ;
  while (enumerator_11554.hasCurrentObject ()) {
    GALGAS_string var_baseName = enumerator_11554.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 251)).reader_lastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 251)).reader_stringByDeletingPathExtension (SOURCE_FILE ("targetGeneration.gSemantics", 251)) ;
    GALGAS_string var_extension = enumerator_11554.current_mFilePath (HERE).mAttribute_string.reader_pathExtension (SOURCE_FILE ("targetGeneration.gSemantics", 252)) ;
    ...
    if (kBoolTrue == test_3) {
      GALGAS_location location_4 (enumerator_11554.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (enumerator_11554.current_mSourceKind (HERE).isValid ()) {
      switch (enumerator_11554.current_mSourceKind (HERE).enumValue ()) {
      ...
      case GALGAS_sourceFileKind::kEnum_externSourceFile: {
        ...
        if (kBoolTrue == test_5) {
          var_externSourceSet_5F_tool.addAssign_operation (enumerator_11554.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 263))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 263)) ;
          var_handCodedSourceList.addAssign_operation (enumerator_11554.current_mFilePath (HERE).mAttribute_string.reader_lastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 264))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 264)) ;
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_11554.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 265)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_6) {
            ...
            var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11554.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 268))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 268))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 268)) ;
          }
        }else if (kBoolFalse == test_5) {
          const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("framework"))).boolEnum () ;
          if (kBoolTrue == test_7) {
            var_externSourceSet_5F_tool.addAssign_operation (enumerator_11554.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 271))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 271)) ;
            var_externSourceSet_5F_app.addAssign_operation (enumerator_11554.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 272))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 272)) ;
            const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_11554.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 273)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_8) {
            ...
            if (kBoolTrue == test_9) {
              var_externSourceSet_5F_app.addAssign_operation (enumerator_11554.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 279))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 279)) ;
              const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_11554.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 280)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              ...
              if (kBoolTrue == test_11) {
                var_externSourceSet_5F_tool.addAssign_operation (enumerator_11554.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 286))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 286)) ;
                const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_11554.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 287)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                ...
                if (kBoolTrue == test_13) {
                  var_externSourceSet_5F_app.addAssign_operation (enumerator_11554.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 293))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 293)) ;
                  const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_11554.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 294)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                  ...
                  GALGAS_location location_15 (enumerator_11554.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  cEnumerator_lstringlist enumerator_16082 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_16082.hasCurrentObject ()) {
    const enumGalgasBool test_17 = var_availableGenerationFeatures.reader_hasKey (enumerator_16082.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 348)) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 348)).boolEnum () ;
    if (kBoolTrue == test_17) {
      const enumGalgasBool test_18 = var_generationFeatures.reader_hasKey (enumerator_16082.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 349)) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 349)).boolEnum () ;
      if (kBoolTrue == test_18) {
        GALGAS_location location_19 (enumerator_16082.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_19, GALGAS_string ("duplicate '").operator_concat (enumerator_16082.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 350))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 350)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 350))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 350)) ;
      }
      const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_16082.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_20) {
        const enumGalgasBool test_21 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_21) {
          GALGAS_location location_22 (enumerator_16082.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_22, GALGAS_string ("duplicate '").operator_concat (enumerator_16082.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 355))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 355)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 355))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 355)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_20) {
        const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, enumerator_16082.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_23) {
          ...
          if (kBoolTrue == test_24) {
            GALGAS_location location_25 (enumerator_16082.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          ...
          const enumGalgasBool test_26 = GALGAS_bool (kIsEqual, enumerator_16082.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_26) {
            ...
            if (kBoolTrue == test_27) {
              GALGAS_location location_28 (enumerator_16082.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            ...
            const enumGalgasBool test_29 = GALGAS_bool (kIsEqual, enumerator_16082.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_29) {
              ...
              if (kBoolTrue == test_30) {
                GALGAS_location location_31 (enumerator_16082.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              ...
              const enumGalgasBool test_32 = GALGAS_bool (kIsEqual, enumerator_16082.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Mavericks"))).boolEnum () ;
              if (kBoolTrue == test_32) {
                ...
                if (kBoolTrue == test_33) {
                  GALGAS_location location_34 (enumerator_16082.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                ...
                const enumGalgasBool test_35 = GALGAS_bool (kIsEqual, enumerator_16082.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Yosemite"))).boolEnum () ;
                if (kBoolTrue == test_35) {
                  ...
                  if (kBoolTrue == test_36) {
                    GALGAS_location location_37 (enumerator_16082.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  ...
                  const enumGalgasBool test_38 = GALGAS_bool (kIsEqual, enumerator_16082.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("LatestMacOS"))).boolEnum () ;
                  if (kBoolTrue == test_38) {
                    ...
                    if (kBoolTrue == test_39) {
                      GALGAS_location location_40 (enumerator_16082.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    ...
                    var_generationFeatures.addAssign_operation (enumerator_16082.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 400))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 400)) ;
                  }
                }
              }
            }
      ...
      cEnumerator_stringset enumerator_18481 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_18481.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_18481.current_key (HERE)  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 405)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 405))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 405)) ;
        enumerator_18481.gotoNextObject () ;
      }
      GALGAS_location location_41 (enumerator_16082.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_41, GALGAS_string ("unknown '").operator_concat (enumerator_16082.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 407))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 407)).operator_concat (GALGAS_string ("' feature; available features are:")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 407)).operator_concat (var_s  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 407))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 407)) ;
    }
  ...
  GALGAS_bool joker_20316_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_20316_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 442)) ;
  ...
  if (kBoolTrue == test_52) {
    ...
    GALGAS_bool joker_20908_0 ; // Joker input parameter
    GALGAS_string (gWrapperFileContent_18_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_icon_5F_help_5F_file_5F_path, joker_20908_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 451)) ;
    GALGAS_string var_applicationBundleBase ;
    const cMapElement_projectQualifiedFeatureMap * objectArray_20975 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("applicationBundleBase")) ;
    if (NULL != objectArray_20975) {
        macroValidSharedObject (objectArray_20975, cMapElement_projectQualifiedFeatureMap) ;
      var_applicationBundleBase = objectArray_20975->mAttribute_mFeatureValue.mAttribute_string ;
    }else{
    ...
    GALGAS_bool joker_21451_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 465)), joker_21451_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 465)) ;
    ...
    GALGAS_bool joker_21938_0 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 473))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_21938_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 473)) ;
    ...
    const cMapElement_projectQualifiedFeatureMap * objectArray_22240 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("repositoryURL")) ;
    if (NULL != objectArray_22240) {
        macroValidSharedObject (objectArray_22240, cMapElement_projectQualifiedFeatureMap) ;
      ...
      GALGAS_bool joker_22620_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 482))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 482)), joker_22620_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 482)) ;
      GALGAS_bool joker_22920_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, constinArgument_inTargetName, objectArray_22240->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 483))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 488)), joker_22920_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 483)) ;
      GALGAS_bool joker_23118_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_nib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 491))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 491)), joker_23118_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 491)) ;
      GALGAS_bool joker_23272_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 492))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 492)), joker_23272_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 492)) ;
      GALGAS_bool joker_23434_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 493))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 493)), joker_23434_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 493)) ;
      GALGAS_bool joker_23588_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 494))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 494)), joker_23588_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 494)) ;
      GALGAS_bool joker_23750_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 495))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 495)), joker_23750_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 495)) ;
      GALGAS_bool joker_23920_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_compatibility_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 496))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMSnowLeopardLionCompatibility.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 496)), joker_23920_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 496)) ;
      GALGAS_string var_codeSignIdentity ;
      const cMapElement_projectQualifiedFeatureMap * objectArray_23990 = (const cMapElement_projectQualifiedFeatureMap *) constinArgument_inProjectQualifiedFeatureMap.readAccessForWithInstruction (GALGAS_string ("codeSigning")) ;
      if (NULL != objectArray_23990) {
          macroValidSharedObject (objectArray_23990, cMapElement_projectQualifiedFeatureMap) ;
        var_codeSignIdentity = objectArray_23990->mAttribute_mFeatureValue.mAttribute_string ;
      }else{
      ...
      GALGAS_bool joker_24459_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_protocol (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 506))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerProtocol.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 506)), joker_24459_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 506)) ;
      GALGAS_bool joker_24609_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 507))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 507)), joker_24609_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 507)) ;
      GALGAS_bool joker_24767_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_implementation (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 508))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 508)), joker_24767_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 508)) ;
      GALGAS_bool joker_25025_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_tool_5F_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 509))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Info.plist")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 514)), joker_25025_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 509)) ;
      GALGAS_bool joker_25269_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_tool_5F_launchd_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 517))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Launchd.plist")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 521)), joker_25269_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 517)) ;
      GALGAS_bool joker_25499_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_main (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 524))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-main.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 528)), joker_25499_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 524)) ;
      ...
      GALGAS_bool joker_25870_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 534))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 534)), joker_25870_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 534)) ;
      GALGAS_bool joker_26049_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 535))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 535)), joker_26049_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 535)) ;
      GALGAS_bool joker_26232_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 536))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 536)), joker_26232_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 536)) ;
      GALGAS_bool joker_26401_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 537))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 537)), joker_26401_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 537)) ;
      GALGAS_bool joker_26648_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 538))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 542)), joker_26648_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 538)) ;
      GALGAS_bool joker_26904_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 544))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 549)), joker_26904_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 544)) ;
      GALGAS_bool joker_27053_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 551))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 551)), joker_27053_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 551)) ;
      GALGAS_bool joker_27201_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_prefix (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 552))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Prefix.pch")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 552)), joker_27201_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 552)) ;
    }
    ...
    cEnumerator_stringset enumerator_28198 (var_guiSourceSet_5F_tool.operator_or (var_scannerSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_or (var_optionSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_or (var_semanticsSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_or (var_syntaxSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_or (var_grammarSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_or (var_programSourceSet_5F_tool COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)), kEnumeration_up) ;
    while (enumerator_28198.hasCurrentObject ()) {
      var_all_5F_h_5F_cpp_5F_files.addAssign_operation (enumerator_28198.current (HERE).add_operation (GALGAS_string (".h"), inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 568))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 568)) ;
      var_all_5F_h_5F_cpp_5F_files.addAssign_operation (enumerator_28198.current (HERE).add_operation (GALGAS_string (".cpp"), inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 569))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 569)) ;
