...
void routine_updateTargets (const GALGAS_lstring constinArgument_inProjectSourceFilePath,
  ...
  GALGAS_stringset var_scannerSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 245)) ;
  GALGAS_stringset var_optionSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 246)) ;
  GALGAS_stringset var_semanticsSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 247)) ;
  GALGAS_stringset var_syntaxSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 248)) ;
  GALGAS_stringset var_grammarSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 249)) ;
  GALGAS_stringset var_programSourceSet_5F_app = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 250)) ;
  GALGAS_stringset var_sourceFileSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 252)) ;
  GALGAS_stringlist var_generatedFileListForMakefile = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("targetGeneration.gSemantics", 253)) ;
  GALGAS_stringlist var_handCodedSourceList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("targetGeneration.gSemantics", 254)) ;
  GALGAS_stringset var_handCodedSourceDirectorySet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 255)) ;
  cEnumerator_projectSourceList enumerator_11836 (constinArgument_inProjectSourceList, kEnumeration_up) ;
  while (enumerator_11836.hasCurrentObject ()) {
    GALGAS_string var_baseName = enumerator_11836.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 257)).reader_lastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 257)).reader_stringByDeletingPathExtension (SOURCE_FILE ("targetGeneration.gSemantics", 257)) ;
    GALGAS_string var_extension = enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_pathExtension (SOURCE_FILE ("targetGeneration.gSemantics", 258)) ;
    GALGAS_string var_cppFile = var_baseName.operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 259)) ;
    const enumGalgasBool test_3 = var_sourceFileSet.reader_hasKey (var_baseName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 261)).operator_and (GALGAS_bool (kIsNotEqual, var_extension.objectCompare (GALGAS_string ("h"))) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 261)).operator_and (GALGAS_bool (kIsNotEqual, var_extension.objectCompare (GALGAS_string ("xib"))) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 261)).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_location location_4 (enumerator_11836.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, GALGAS_string ("there is already a file with '").operator_concat (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 262)).operator_concat (GALGAS_string ("' as base name in the project")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 262))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 262)) ;
    }
    var_sourceFileSet.addAssign_operation (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 264)) ;
    if (enumerator_11836.current_mSourceKind (HERE).isValid ()) {
      switch (enumerator_11836.current_mSourceKind (HERE).enumValue ()) {
      case GALGAS_sourceFileKind::kNotBuilt:
        break ;
      case GALGAS_sourceFileKind::kEnum_externSourceFile: {
        const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("cpp"))).operator_or (GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("mm"))) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 268)).boolEnum () ;
        if (kBoolTrue == test_5) {
          var_externSourceSet_5F_tool.addAssign_operation (enumerator_11836.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 269))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 269)) ;
          var_handCodedSourceList.addAssign_operation (enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_lastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 270))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 270)) ;
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 271)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_6) {
            var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 272)) ;
          }else if (kBoolFalse == test_6) {
            var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 274))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 274))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 274)) ;
          }
        }else if (kBoolFalse == test_5) {
          const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("framework"))).boolEnum () ;
          if (kBoolTrue == test_7) {
            var_externSourceSet_5F_tool.addAssign_operation (enumerator_11836.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 277))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 277)) ;
            var_externSourceSet_5F_app.addAssign_operation (enumerator_11836.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 278))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 278)) ;
            const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 279)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
            if (kBoolTrue == test_8) {
              var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 280)) ;
            }else if (kBoolFalse == test_8) {
              var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 282))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 282))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 282)) ;
            }
          }else if (kBoolFalse == test_7) {
            const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("m"))).boolEnum () ;
            if (kBoolTrue == test_9) {
              var_externSourceSet_5F_app.addAssign_operation (enumerator_11836.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 285))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 285)) ;
              const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 286)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_10) {
                var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 287)) ;
              }else if (kBoolFalse == test_10) {
                var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 289))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 289))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 289)) ;
              }
            }else if (kBoolFalse == test_9) {
              const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("h"))).boolEnum () ;
              if (kBoolTrue == test_11) {
                var_externSourceSet_5F_tool.addAssign_operation (enumerator_11836.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 292))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 292)) ;
                const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 293)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                if (kBoolTrue == test_12) {
                  var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 294)) ;
                }else if (kBoolFalse == test_12) {
                  var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 296))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 296))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 296)) ;
                }
              }else if (kBoolFalse == test_11) {
                const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, var_extension.objectCompare (GALGAS_string ("xib"))).boolEnum () ;
                if (kBoolTrue == test_13) {
                  var_externSourceSet_5F_app.addAssign_operation (enumerator_11836.current_mFilePath (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 299))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 299)) ;
                  const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 300)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                  if (kBoolTrue == test_14) {
                    var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 301)) ;
                  }else if (kBoolFalse == test_14) {
                    var_handCodedSourceDirectorySet.addAssign_operation (GALGAS_string ("../hand_coded_sources/").operator_concat (enumerator_11836.current_mFilePath (HERE).mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 303))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 303))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 303)) ;
                  }
                }else if (kBoolFalse == test_13) {
                  GALGAS_location location_15 (enumerator_11836.current_mFilePath (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_15, GALGAS_string ("unhandled extension")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 306)) ;
                }
              }
            }
          }
      ...
      case GALGAS_sourceFileKind::kEnum_lexiqueSourceFile: {
        ...
        var_scannerSourceSet_5F_tool.addAssign_operation (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 310)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_syntaxSourceFile: {
        ...
        var_syntaxSourceSet_5F_tool.addAssign_operation (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 313)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_semanticsSourceFile: {
        ...
        var_semanticsSourceSet_5F_tool.addAssign_operation (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 316)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_grammarSourceFile: {
        ...
        var_grammarSourceSet_5F_tool.addAssign_operation (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 319)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_programSourceFile: {
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 321)) ;
        var_programSourceSet_5F_tool.addAssign_operation (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 322)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_optionSourceFile: {
        var_generatedFileListForMakefile.addAssign_operation (var_cppFile  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 324)) ;
        var_optionSourceSet_5F_tool.addAssign_operation (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 325)) ;
        } break ;
      case GALGAS_sourceFileKind::kEnum_guiSourceFile: {
        var_guiSourceSet_5F_app.addAssign_operation (var_baseName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 327)) ;
        } break ;
      }
    }
  ...
  if (kBoolTrue == test_16) {
    inCompiler->printMessage (GALGAS_string ("*** Updating targets\n")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 332)) ;
  }
  GALGAS_stringset var_availableGenerationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 334)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_macosx")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 335)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_unix")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 336)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_i386_linux_on_macosx")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 337)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_x86_64_linux_on_macosx")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 338)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_mingw_on_macosx")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 339)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("makefile_msys_on_win32")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 340)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("SnowLeopard")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 341)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Lion")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 342)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("MountainLion")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 343)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Mavericks")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 344)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("Yosemite")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 345)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("LatestMacOS")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 346)) ;
  var_availableGenerationFeatures.addAssign_operation (GALGAS_string ("multi-threading")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 347)) ;
  GALGAS_stringset var_generationFeatures = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("targetGeneration.gSemantics", 348)) ;
  ...
  cEnumerator_lstringlist enumerator_16357 (constinArgument_inTargetFeatureList, kEnumeration_up) ;
  while (enumerator_16357.hasCurrentObject ()) {
    const enumGalgasBool test_17 = var_availableGenerationFeatures.reader_hasKey (enumerator_16357.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 354)) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 354)).boolEnum () ;
    if (kBoolTrue == test_17) {
      const enumGalgasBool test_18 = var_generationFeatures.reader_hasKey (enumerator_16357.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 355)) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 355)).boolEnum () ;
      if (kBoolTrue == test_18) {
        GALGAS_location location_19 (enumerator_16357.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_19, GALGAS_string ("duplicate '").operator_concat (enumerator_16357.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 356))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 356)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 356))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 356)) ;
      }
      const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_16357.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("multi-threading"))).boolEnum () ;
      if (kBoolTrue == test_20) {
        const enumGalgasBool test_21 = var_multiThreadingEnabled.boolEnum () ;
        if (kBoolTrue == test_21) {
          GALGAS_location location_22 (enumerator_16357.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_22, GALGAS_string ("duplicate '").operator_concat (enumerator_16357.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 361))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 361)).operator_concat (GALGAS_string ("' feature")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 361))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 361)) ;
        }
        var_multiThreadingEnabled = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_20) {
        const enumGalgasBool test_23 = GALGAS_bool (kIsEqual, enumerator_16357.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("SnowLeopard"))).boolEnum () ;
        if (kBoolTrue == test_23) {
          ...
          if (kBoolTrue == test_24) {
            GALGAS_location location_25 (enumerator_16357.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_25, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 367)) ;
          }
          var_SDK = GALGAS_string ("macosx10.6") ;
        }else if (kBoolFalse == test_23) {
          const enumGalgasBool test_26 = GALGAS_bool (kIsEqual, enumerator_16357.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Lion"))).boolEnum () ;
          if (kBoolTrue == test_26) {
            ...
            if (kBoolTrue == test_27) {
              GALGAS_location location_28 (enumerator_16357.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_28, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 373)) ;
            }
            var_SDK = GALGAS_string ("macosx10.7") ;
            var_usesARC = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_26) {
            const enumGalgasBool test_29 = GALGAS_bool (kIsEqual, enumerator_16357.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("MountainLion"))).boolEnum () ;
            if (kBoolTrue == test_29) {
              ...
              if (kBoolTrue == test_30) {
                GALGAS_location location_31 (enumerator_16357.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_31, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 380)) ;
              }
              var_SDK = GALGAS_string ("macosx10.8") ;
              var_usesARC = GALGAS_bool (true) ;
            }else if (kBoolFalse == test_29) {
              const enumGalgasBool test_32 = GALGAS_bool (kIsEqual, enumerator_16357.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Mavericks"))).boolEnum () ;
              if (kBoolTrue == test_32) {
                ...
                if (kBoolTrue == test_33) {
                  GALGAS_location location_34 (enumerator_16357.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                  inCompiler->emitSemanticError (location_34, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 387)) ;
                }
                var_SDK = GALGAS_string ("macosx10.9") ;
                var_usesARC = GALGAS_bool (true) ;
              }else if (kBoolFalse == test_32) {
                const enumGalgasBool test_35 = GALGAS_bool (kIsEqual, enumerator_16357.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("Yosemite"))).boolEnum () ;
                if (kBoolTrue == test_35) {
                  ...
                  if (kBoolTrue == test_36) {
                    GALGAS_location location_37 (enumerator_16357.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                    inCompiler->emitSemanticError (location_37, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 394)) ;
                  }
                  var_SDK = GALGAS_string ("macosx10.10") ;
                  var_usesARC = GALGAS_bool (true) ;
                }else if (kBoolFalse == test_35) {
                  const enumGalgasBool test_38 = GALGAS_bool (kIsEqual, enumerator_16357.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("LatestMacOS"))).boolEnum () ;
                  if (kBoolTrue == test_38) {
                    ...
                    if (kBoolTrue == test_39) {
                      GALGAS_location location_40 (enumerator_16357.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
                      inCompiler->emitSemanticError (location_40, GALGAS_string ("the \"SnowLeopard\", \"Lion\", \"MountainLion\", \"Mavericks\" and \"Yosemite\", \"LatestMacOS\" are exclusive")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 401)) ;
                    }
                    var_SDK = GALGAS_string ("macosx") ;
                    var_usesARC = GALGAS_bool (true) ;
                  }else if (kBoolFalse == test_38) {
                    var_generationFeatures.addAssign_operation (enumerator_16357.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 406))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 406)) ;
                  }
                }
              }
            }
      ...
      cEnumerator_stringset enumerator_18756 (var_availableGenerationFeatures, kEnumeration_up) ;
      while (enumerator_18756.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (enumerator_18756.current_key (HERE)  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 411)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 411))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 411)) ;
        enumerator_18756.gotoNextObject () ;
      }
      GALGAS_location location_41 (enumerator_16357.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_41, GALGAS_string ("unknown '").operator_concat (enumerator_16357.current_mValue (HERE).reader_string (SOURCE_FILE ("targetGeneration.gSemantics", 413))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 413)).operator_concat (GALGAS_string ("' feature; available features are:")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 413)).operator_concat (var_s  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 413))  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 413)) ;
    }
    enumerator_16357.gotoNextObject () ;
  }
  const enumGalgasBool test_42 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).operator_and (constinArgument_inProjectQualifiedFeatureMap.reader_hasKey (GALGAS_string ("applicationBundleBase") COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 417)).operator_not (SOURCE_FILE ("targetGeneration.gSemantics", 417)) COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 417)).boolEnum () ;
  if (kBoolTrue == test_42) {
    GALGAS_location location_43 (constinArgument_inProjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticWarning (location_43, GALGAS_string ("For a Cocoa project, the \"applicationBundleBase\" feature should be set; for example: 'feature applicationBundleBase : \"fr.what\" ;'")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 418)) ;
  }
  const enumGalgasBool test_44 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_macosx") COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 421)).boolEnum () ;
  if (kBoolTrue == test_44) {
    {
    routine_generateMakefileMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 422)) ;
    }
  }
  const enumGalgasBool test_45 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_unix") COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 424)).boolEnum () ;
  if (kBoolTrue == test_45) {
    {
    routine_generateMakefileUnixTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 425)) ;
    }
  }
  const enumGalgasBool test_46 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_i386_linux_on_macosx") COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 427)).boolEnum () ;
  if (kBoolTrue == test_46) {
    {
    routine_generateI_33__38__36_LinuxOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 428)) ;
    }
  }
  const enumGalgasBool test_47 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_x86_64_linux_on_macosx") COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 430)).boolEnum () ;
  if (kBoolTrue == test_47) {
    {
    routine_generateX_38__36__5F__36__34_LinuxOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 431)) ;
    }
  }
  const enumGalgasBool test_48 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_mingw_on_macosx") COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 433)).boolEnum () ;
  if (kBoolTrue == test_48) {
    {
    routine_generateMinGWOnMacOSXTarget (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 434)) ;
    }
  }
  const enumGalgasBool test_49 = var_generationFeatures.reader_hasKey (GALGAS_string ("makefile_msys_on_win32") COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 436)).boolEnum () ;
  if (kBoolTrue == test_49) {
    {
    routine_generateMsysOnWin_33__32_Target (var_projectDirectory, constinArgument_inTargetName, inCompiler  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 437)) ;
    }
  }
  ...
  GALGAS_string var_newFileListContents = GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_file_5F_list (inCompiler, var_handCodedSourceDirectorySet, var_handCodedSourceList, var_generatedFileListForMakefile, var_libpmPath, temp_50 COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 440))) ;
  GALGAS_string var_fileListPath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 447)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/file_list.mak")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 447)) ;
  GALGAS_bool joker_20591_0 ; // Joker input parameter
  var_newFileListContents.method_writeToFileWhenDifferentContents (var_fileListPath, joker_20591_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 448)) ;
  GALGAS_string var_previousFileListPath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 449)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/file_list.mke")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 449)) ;
  {
  GALGAS_string::class_method_deleteFileIfExists (var_previousFileListPath, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 450)) ;
  }
  const enumGalgasBool test_52 = GALGAS_bool (kIsNotEqual, var_SDK.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_52) {
    GALGAS_string var_dir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 453)) ;
    var_dir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 454)) ;
    GALGAS_string var_icon_5F_help_5F_file_5F_path = var_dir.operator_concat (GALGAS_string ("/adding-icons-to-your-application.rtf")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 456)) ;
    GALGAS_bool joker_21183_0 ; // Joker input parameter
    GALGAS_string (gWrapperFileContent_18_targetGenerationFileWrapper).method_writeToFileWhenDifferentContents (var_icon_5F_help_5F_file_5F_path, joker_21183_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 457)) ;
    ...
    GALGAS_string var_InfoPlistContents = GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_info_5F_plist (inCompiler, constinArgument_inTargetName, var_applicationBundleBase, constinArgument_inProjectVersionString, constinArgument_inHandledExtensionSet COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 465))) ;
    GALGAS_bool joker_21726_0 ; // Joker input parameter
    var_InfoPlistContents.method_writeToFileWhenDifferentContents (var_dir.operator_concat (GALGAS_string ("/Info.plist")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 471)), joker_21726_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 471)) ;
    const enumGalgasBool test_53 = var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 473)).reader_fileExists (SOURCE_FILE ("targetGeneration.gSemantics", 473)).operator_not (SOURCE_FILE ("targetGeneration.gSemantics", 473)).boolEnum () ;
    if (kBoolTrue == test_53) {
      GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_build_5F_xcode (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 474))).method_writeToExecutableFile (var_dir.operator_concat (GALGAS_string ("/build.command")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 474)), inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 474)) ;
    }
    var_dir.operator_concat (GALGAS_string ("/English.lproj")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 477)).method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 477)) ;
    GALGAS_string var_InfoPlist_5F_strings_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/InfoPlist.strings")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 478)) ;
    GALGAS_bool joker_22213_0 ; // Joker input parameter
    GALGAS_string (filewrapperTemplate_targetGenerationFileWrapper_makefile_5F_info_5F_plist_5F_strings (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 479))).method_writeToFileWhenDifferentContents (var_InfoPlist_5F_strings_5F_path, joker_22213_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 479)) ;
    GALGAS_string var_Credits_5F_rtf_5F_path = var_dir.operator_concat (GALGAS_string ("/English.lproj/Credits.rtf")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 480)) ;
    const enumGalgasBool test_54 = var_Credits_5F_rtf_5F_path.reader_fileExists (SOURCE_FILE ("targetGeneration.gSemantics", 481)).operator_not (SOURCE_FILE ("targetGeneration.gSemantics", 481)).boolEnum () ;
    if (kBoolTrue == test_54) {
      GALGAS_string (gWrapperFileContent_20_targetGenerationFileWrapper).method_writeToFile (var_Credits_5F_rtf_5F_path, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 482)) ;
    }
    ...
    if (NULL != objectArray_22515) {
      ...
      var_applicationUpdateDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 487)) ;
      GALGAS_bool joker_22895_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 488))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 488)), joker_22895_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 488)) ;
      GALGAS_bool joker_23195_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_implementation (inCompiler, constinArgument_inTargetName, objectArray_22515->mAttribute_mFeatureValue.mAttribute_string, var_applicationBundleBase COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 489))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMApplicationUpdate.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 494)), joker_23195_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 489)) ;
      GALGAS_bool joker_23393_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_application_5F_update_5F_nib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 497))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/English.lproj/PMApplicationUpdate.xib")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 497)), joker_23393_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 497)) ;
      GALGAS_bool joker_23547_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 498))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 498)), joker_23547_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 498)) ;
      GALGAS_bool joker_23709_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_data_5F_implementation (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 499))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadData.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 499)), joker_23709_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 499)) ;
      GALGAS_bool joker_23863_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 500))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 500)), joker_23863_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 500)) ;
      GALGAS_bool joker_24025_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_applicationUpdateFileWrapper_download_5F_file_5F_implementation (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 501))).method_writeToFileWhenDifferentContents (var_applicationUpdateDir.operator_concat (GALGAS_string ("/PMDownloadFile.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 501)), joker_24025_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 501)) ;
      ...
      GALGAS_string var_updaterToolDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/cocoa-application-update/updater-tool")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 510)) ;
      var_updaterToolDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 511)) ;
      GALGAS_bool joker_24734_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_protocol (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 512))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerProtocol.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 512)), joker_24734_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 512)) ;
      GALGAS_bool joker_24884_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 513))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 513)), joker_24884_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 513)) ;
      GALGAS_bool joker_25042_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_implementation (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 514))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/PMUpdaterServerObject.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 514)), joker_25042_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 514)) ;
      GALGAS_bool joker_25300_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_tool_5F_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 515))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Info.plist")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 520)), joker_25300_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 515)) ;
      GALGAS_bool joker_25544_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_tool_5F_launchd_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 523))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-Launchd.plist")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 527)), joker_25544_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 523)) ;
      GALGAS_bool joker_25774_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterToolFileWrapper_updater_5F_object_5F_main (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 530))).method_writeToFileWhenDifferentContents (var_updaterToolDir.operator_concat (GALGAS_string ("/updater-tool-main.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 534)), joker_25774_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 530)) ;
      GALGAS_string var_updaterApplicationDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/cocoa-application-update/updater-application")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 538)) ;
      var_updaterApplicationDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 539)) ;
      GALGAS_bool joker_26145_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_credits (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 540))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppCredits.rtf")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 540)), joker_26145_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 540)) ;
      GALGAS_bool joker_26324_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist_5F_strings (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 541))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppInfoPlist.strings")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 541)), joker_26324_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 541)) ;
      GALGAS_bool joker_26507_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main_5F_menu_5F_xib (inCompiler, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 542))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/English.lproj/UpdaterAppMainMenu.xib")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 542)), joker_26507_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 542)) ;
      GALGAS_bool joker_26676_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_header (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 543))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.h")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 543)), joker_26676_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 543)) ;
      GALGAS_bool joker_26923_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_application_5F_delegate_5F_implementation (inCompiler, var_applicationBundleBase, constinArgument_inTargetName COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 544))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/PMUpdaterAppDelegate.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 548)), joker_26923_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 544)) ;
      GALGAS_bool joker_27179_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_info_5F_plist (inCompiler, var_applicationBundleBase, constinArgument_inTargetName, var_codeSignIdentity COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 550))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Info.plist")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 555)), joker_27179_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 550)) ;
      GALGAS_bool joker_27328_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_main (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 557))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-main.m")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 557)), joker_27328_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 557)) ;
      GALGAS_bool joker_27476_0 ; // Joker input parameter
      GALGAS_string (filewrapperTemplate_updaterApplicationFileWrapper_prefix (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 558))).method_writeToFileWhenDifferentContents (var_updaterApplicationDir.operator_concat (GALGAS_string ("/updater-app-Prefix.pch")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 558)), joker_27476_0, inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 558)) ;
    }
    GALGAS_string var_userResourceDir = var_projectDirectory.operator_concat (GALGAS_string ("/project_xcode/userResources")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 561)) ;
    var_userResourceDir.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 562)) ;
    GALGAS_stringlist var_extensionList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("targetGeneration.gSemantics", 563)) ;
    var_extensionList.addAssign_operation (GALGAS_string ("icns")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 564)) ;
    GALGAS_stringlist var_resourceFiles = var_userResourceDir.reader_regularFilesWithExtensions (GALGAS_bool (false), var_extensionList COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 565)) ;
    GALGAS_string var_xcodeProjectPath = var_dir.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_concat (constinArgument_inTargetName  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)).operator_concat (GALGAS_string (".xcodeproj")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 567)) ;
    GALGAS_string var_intermediateFilePath = constinArgument_inProjectSourceFilePath.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("targetGeneration.gSemantics", 568)).operator_concat (GALGAS_string ("/GALGAS_OUTPUT/file_list_for_xcode_project.txt")  COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 568)) ;
    var_xcodeProjectPath.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("targetGeneration.gSemantics", 570)) ;
    {
