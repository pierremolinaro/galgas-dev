...
pr_galgas_component_ggs_LL1_compile_component_135_23_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_s)._operator_isNotEqual (var_cas_sourceFileName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (146)))).isBuiltAndTrue ()) {
    var_cas_sourceFileName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string ("the project name ('"))._operator_concat (var_cas_sourceFileName))._operator_concat (GGS_string ("') should be the file base name '")))._operator_concat (var_cas_s))._operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (148)) ;
  }
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_ggs_LL1_compile_component_0 (_inLexique)) {
        case 2 : {
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_3 = true ;
                while (syntaxRepeat_3) {
                    ...
                    if (((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (192)))._operator_isEqual (GGS_string ("xcode"))).isBuiltAndTrue ()) {
                      var_cas_targetName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the target \"xcode\" name is obsolete: use \"xcode_tool\" and/or \"xcode_app\"") COMMA_SOURCE_FILE_AT_LINE (194)) ;
                    }else if (((((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (194)))._operator_isNotEqual (GGS_string ("makefile")))._operator_and ((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (194)))._operator_isNotEqual (GGS_string ("xcode_tool"))))._operator_and ((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (194)))._operator_isNotEqual (GGS_string ("xcode_app")))).isBuiltAndTrue ()) {
                      var_cas_targetName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("the target name should be \"makefile\", \"xcode_tool\" or \"xcode_app\"") COMMA_SOURCE_FILE_AT_LINE (196)) ;
                    }
          ...
          if (((GGS_bool (_inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (201))))._operator_and ((var_cas_sourceFileKind)._operator_isNotEqual (GGS_EXsourceFileKind::constructor_externSourceFile (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
            _inLexique.printMessage (((GGS_string ("------ Compile file '"))._operator_concat (var_cas_fileName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (202))))._operator_concat (GGS_string ("'\n")) COMMA_SOURCE_FILE_AT_LINE (202)) ;
          }
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (213)))).isBuiltAndTrue ()) {
    _inLexique.printMessage (GGS_string ("------ Project\n") COMMA_SOURCE_FILE_AT_LINE (214)) ;
  }
  GGS_stringlist  var_cas_makefileFiles ;
  var_cas_makefileFiles = var_cas_targetFileListMap.reader_listForKey (_inLexique, GGS_string ("makefile") COMMA_SOURCE_FILE_AT_LINE (217)) ;
  if (((var_cas_makefileFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (218)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    var_cas_pathSet._addAssign_operation (GGS_string ("SOURCES_DIR += ../hand_coded_sources\n")) ;
    {
      ...
      while (((operand_8935 = enumerator_8935.nextObject ()))) {
        ...
        if (((var_cas_sourceKind)._operator_isEqual (GGS_EXsourceFileKind::constructor_externSourceFile (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
          if (((var_cas_filePath.reader_firstCharacterOrNul (_inLexique COMMA_SOURCE_FILE_AT_LINE (229)))._operator_isEqual (GGS_char (TO_UNICODE ('/')))).isBuiltAndTrue ()) {
    ...
    var_cas_fileListPath = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (248)))._operator_concat (GGS_string ("/GALGAS_OUTPUT/file_list.mke")) ;
  ...
  var_cas_oldCommonFile = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (252)).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (252)))._operator_concat (GGS_string ("/common_files_for_make/makefile.mke")) ;
  if (((var_cas_oldCommonFile.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (253)))._operator_and ((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U)))).isBuiltAndTrue ()) {
    _inLexique.printMessage (GGS_string ("**** Converting old-style makefile ****\n") COMMA_SOURCE_FILE_AT_LINE (254)) ;
    ...
    var_cas_projectDirectories = var_cas_projectDir.reader_directories (_inLexique, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (256)) ;
    GGS_bool var_cas_ok ;
    var_cas_ok = GGS_bool (true) ;
    {
      ...
      while (((operand_10805 = enumerator_10805.nextObject ()))) {
        ...
        if ((((operand_10805->mValue)._operator_isNotEqual (GGS_string ("common_files_for_make")))._operator_and ((operand_10805->mValue)._operator_isNotEqual (GGS_string ("makefile_macosx_universal")))).isBuiltAndTrue ()) {
          GGS_string var_cas_fullDirPath ;
          var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string ("/")))._operator_concat (operand_10805->mValue))._operator_concat (GGS_string ("/")) ;
          GGS_string var_cas_makefilePath ;
          var_cas_makefilePath = (var_cas_fullDirPath)._operator_concat (GGS_string ("makefile")) ;
          if ((var_cas_makefilePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (263))).isBuiltAndTrue ()) {
            ...
            var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefilePath COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string ("include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (264)) ;
            if (((var_cas_c.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (265)))._operator_isEqual (GGS_uint (2U))).isBuiltAndTrue ()) {
              _inLexique.printMessage (((GGS_string ("  ok: '"))._operator_concat (var_cas_makefilePath))._operator_concat (GGS_string ("' can be converted\n")) COMMA_SOURCE_FILE_AT_LINE (266)) ;
            }else{
              _inLexique.printMessage (((GGS_string ("  error: '"))._operator_concat (var_cas_makefilePath))._operator_concat (GGS_string ("' cannot be converted\n")) COMMA_SOURCE_FILE_AT_LINE (268)) ;
              var_cas_ok = GGS_bool (false) ;
            }
          }
          GGS_string var_cas_makefile64Path ;
          var_cas_makefile64Path = (var_cas_fullDirPath)._operator_concat (GGS_string ("makefile64")) ;
          if ((var_cas_makefile64Path.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (274))).isBuiltAndTrue ()) {
            GGS_stringlist  var_cas_c ;
            var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefile64Path COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string ("include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (275)) ;
            if (((var_cas_c.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (276)))._operator_isEqual (GGS_uint (2U))).isBuiltAndTrue ()) {
              _inLexique.printMessage (((GGS_string ("  ok: '"))._operator_concat (var_cas_makefile64Path))._operator_concat (GGS_string ("' can be converted\n")) COMMA_SOURCE_FILE_AT_LINE (277)) ;
            }else{
              _inLexique.printMessage (((GGS_string ("  error: '"))._operator_concat (var_cas_makefile64Path))._operator_concat (GGS_string ("' cannot be converted\n")) COMMA_SOURCE_FILE_AT_LINE (279)) ;
              var_cas_ok = GGS_bool (false) ;
            }
          }
          GGS_string var_cas_makefileMkePath ;
          var_cas_makefileMkePath = (var_cas_fullDirPath)._operator_concat (GGS_string ("makefile.mke")) ;
          if ((var_cas_makefileMkePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (285))).isBuiltAndTrue ()) {
            GGS_stringlist  var_cas_c ;
            var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefileMkePath COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string ("include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (286)) ;
            if (((var_cas_c.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (287)))._operator_isEqual (GGS_uint (2U))).isBuiltAndTrue ()) {
              _inLexique.printMessage (((GGS_string ("  ok: '"))._operator_concat (var_cas_makefileMkePath))._operator_concat (GGS_string ("' can be converted\n")) COMMA_SOURCE_FILE_AT_LINE (288)) ;
            }else{
              _inLexique.printMessage (((GGS_string ("  error: '"))._operator_concat (var_cas_makefileMkePath))._operator_concat (GGS_string ("' cannot be converted\n")) COMMA_SOURCE_FILE_AT_LINE (290)) ;
              var_cas_ok = GGS_bool (false) ;
            }
          }
        }
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      _inLexique.printMessage (GGS_string ("Perform conversion...\n") COMMA_SOURCE_FILE_AT_LINE (297)) ;
      GGS_string var_cas_projectDir ;
      ...
      GGS_stringlist  var_cas_projectDirectories ;
      var_cas_projectDirectories = var_cas_projectDir.reader_directories (_inLexique, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (299)) ;
      {
        ...
        while (((operand_12955 = enumerator_12955.nextObject ()))) {
          ...
          if ((((operand_12955->mValue)._operator_isNotEqual (GGS_string ("common_files_for_make")))._operator_and ((operand_12955->mValue)._operator_isNotEqual (GGS_string ("makefile_macosx_universal")))).isBuiltAndTrue ()) {
            GGS_string var_cas_fullDirPath ;
            var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string ("/")))._operator_concat (operand_12955->mValue))._operator_concat (GGS_string ("/")) ;
            GGS_string var_cas_makefilePath ;
            var_cas_makefilePath = (var_cas_fullDirPath)._operator_concat (GGS_string ("makefile")) ;
            if ((var_cas_makefilePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (305))).isBuiltAndTrue ()) {
              _inLexique.printMessage (((GGS_string ("  converting '"))._operator_concat (var_cas_makefilePath))._operator_concat (GGS_string ("'...\n")) COMMA_SOURCE_FILE_AT_LINE (306)) ;
              GGS_stringlist  var_cas_c ;
              var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefilePath COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string ("include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (307)) ;
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string ("include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
            ...
            if ((var_cas_makefile64Path.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (313))).isBuiltAndTrue ()) {
              _inLexique.printMessage (((GGS_string ("  converting '"))._operator_concat (var_cas_makefile64Path))._operator_concat (GGS_string ("'...\n")) COMMA_SOURCE_FILE_AT_LINE (314)) ;
              GGS_stringlist  var_cas_c ;
              var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefile64Path COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string ("include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (315)) ;
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string ("include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
            ...
            if ((var_cas_makefileMkePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (321))).isBuiltAndTrue ()) {
              _inLexique.printMessage (((GGS_string ("  converting '"))._operator_concat (var_cas_makefileMkePath))._operator_concat (GGS_string ("'...\n")) COMMA_SOURCE_FILE_AT_LINE (322)) ;
              GGS_stringlist  var_cas_c ;
              var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefileMkePath COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string ("include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (323)) ;
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string ("include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
      ...
      _inLexique.printMessage (((GGS_string ("  Removing directory '"))._operator_concat (var_cas_oldDir))._operator_concat (GGS_string ("' and its contents...\n")) COMMA_SOURCE_FILE_AT_LINE (331)) ;
      GGS_string::class_method_removeDirectoryRecursively (_inLexique, var_cas_oldDir COMMA_SOURCE_FILE_AT_LINE (332)) ;
      _inLexique.printMessage (GGS_string ("**** Conversion done with success *****\n") COMMA_SOURCE_FILE_AT_LINE (333)) ;
    }else{
      _inLexique.printMessage (GGS_string ("****** No conversion performed ********\n") COMMA_SOURCE_FILE_AT_LINE (335)) ;
    }
  }
  if (((GGS_bool (_inLexique.boolOptionValueFromKeys ("galgas_cli_options", "doNotGenerateXcodeProject" COMMA_SOURCE_FILE_AT_LINE (339))))._operator_not ()).isBuiltAndTrue ()) {
    GGS_stringlist  var_cas_xcode_tool_files ;
    var_cas_xcode_tool_files = var_cas_targetFileListMap.reader_listForKey (_inLexique, GGS_string ("xcode_tool") COMMA_SOURCE_FILE_AT_LINE (340)) ;
    GGS_stringlist  var_cas_xcode_app_files ;
    var_cas_xcode_app_files = var_cas_targetFileListMap.reader_listForKey (_inLexique, GGS_string ("xcode_app") COMMA_SOURCE_FILE_AT_LINE (341)) ;
    if (((((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U)))._operator_and ((var_cas_xcode_tool_files.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (342)))._operator_strictSup (GGS_uint (0U))))._operator_and ((var_cas_xcode_app_files.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (342)))._operator_strictSup (GGS_uint (0U)))).isBuiltAndTrue ()) {
      GGS_string var_cas_XcodeProjectDir ;
      var_cas_XcodeProjectDir = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (343)).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (343)))._operator_concat (GGS_string ("/project_xcode")) ;
      GGS_stringlist  var_cas_iconFiles ;
      var_cas_iconFiles = var_cas_XcodeProjectDir.reader_regularFilesWithExtensions (_inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("icns")) COMMA_SOURCE_FILE_AT_LINE (345)) ;
      GGS_stringlist  var_cas_xcodeProjects ;
      var_cas_xcodeProjects = var_cas_XcodeProjectDir.reader_directoriesWithExtensions (_inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("xcodeproj")) COMMA_SOURCE_FILE_AT_LINE (346)) ;
      if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (348)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      }else if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (350)))._operator_strictSup (GGS_uint (1U))).isBuiltAndTrue ()) {
      ...
      }else if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (352)))._operator_isEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
        ...
        var_cas_intermediateFilePath = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (356)))._operator_concat (GGS_string ("/GALGAS_OUTPUT/file_list_for_xcode_project.txt")) ;
...
pr_galgas_component_ggs_LL1_compile_component_658_23_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (670)))).isBuiltAndTrue ()) {
    _inLexique.printMessage (((GGS_string ("------ Compile file '"))._operator_concat (var_cas_fileName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (671))))._operator_concat (GGS_string ("'\n")) COMMA_SOURCE_FILE_AT_LINE (671)) ;
  }
  const GGS_string _depExtension = GGS_string ("galgas-dep") ;
  const GGS_string _depPath = GGS_string ("DEPENDENCIES") ;
  if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
