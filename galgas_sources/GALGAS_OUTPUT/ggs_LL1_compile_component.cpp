...
pr_galgas_component_ggs_LL1_compile_component_135_23_ (galgas_scanner & _inLexique,
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    var_cas_XcodeProjectDir = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (324)).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (324)))._operator_concat (GGS_string (true, "/Z")) ;
    GGS_stringlist  var_cas_xcodeProjects ;
    var_cas_xcodeProjects = var_cas_XcodeProjectDir.reader_regularFilesWithExtensions (_inLexique, GGS_bool (true, true), GGS_stringlist ::constructor_listWithValue (GGS_string (true, "pbxproj")) COMMA_SOURCE_FILE_AT_LINE (326)) ;
    if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (328)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
      GGS_string var_cas_name ;
      const GGS_stringlist  _temp_14745 = var_cas_xcodeProjects ;
      if (_temp_14745._isBuilt ()) {
        _temp_14745 (HERE)->method_first (_inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (329)) ;
      }
      ...
      var_cas_xcodeFiles = var_cas_targetFileListMap.reader_listForKey (_inLexique, GGS_string (true, "xcode") COMMA_SOURCE_FILE_AT_LINE (339)) ;
      {
        GGS_stringlist::cEnumerator enumerator_15286 (var_cas_xcodeFiles, true) ;
        const GGS_stringlist::cElement * operand_15286 = NULL ;
        while (((operand_15286 = enumerator_15286.nextObject ()))) {
          macroValidPointer (operand_15286) ;
          GGS_string var_cas_fullPath ;
          GGS_sourceFileKind var_cas_sourceKind ;
          const GGS_sourceFileMap  _temp_15386 = var_cas_sourceFileMap ;
          if (_temp_15386._isBuilt ()) {
            _temp_15386 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_15286->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (343)) ;
          }
          switch (var_cas_sourceKind.enumValue ()) {
          case GGS_sourceFileKind::enum_externSourceFile:
            {
            var_cas_externSourceSet._addAssign_operation ((operand_15286->mValue)._operator_concat (GGS_string (true, ".cpp"))) ;
            }
            break ;
          case GGS_sourceFileKind::enum_lexiqueSourceFile:
            {
            var_cas_scannerSourceSet._addAssign_operation (operand_15286->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_guiSourceFile:
            {
            var_cas_guiSourceSet._addAssign_operation (operand_15286->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_optionSourceFile:
            {
            var_cas_optionSourceSet._addAssign_operation (operand_15286->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_syntaxSourceFile:
            {
            var_cas_syntaxSourceSet._addAssign_operation (operand_15286->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_semanticsSourceFile:
            {
            var_cas_semanticsSourceSet._addAssign_operation (operand_15286->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_grammarSourceFile:
            {
            var_cas_grammarSourceSet._addAssign_operation (operand_15286->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_programSourceFile:
            {
            var_cas_programSourceSet._addAssign_operation (operand_15286->mValue) ;
            }
            break ;
      ...
      ::routine_generateXcodeProject (_inLexique,  var_cas_externSourceSet,  var_cas_guiSourceSet,  var_cas_scannerSourceSet,  var_cas_optionSourceSet,  var_cas_semanticsSourceSet,  var_cas_syntaxSourceSet,  var_cas_grammarSourceSet,  var_cas_programSourceSet,  var_cas_name.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (372)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (372)),  var_cas_fullXcodePath.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (373)) COMMA_SOURCE_FILE_AT_LINE (363)) ;
    }
  }
}
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_580_23_ (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (592)))).isBuiltAndTrue ()) {
    _inLexique.printMessage (((GGS_string (true, "------ Compile file '"))._operator_concat (var_cas_fileName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (593))))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (593)) ;
  }
  galgas_LL1_grammar::_performSourceFileParsing_compileFile (_inLexique,
                                  NULL,
                                  var_cas_fileName
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_580_23_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_580_23_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_580_23_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_580_23_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
                                GGS_stringset  &/* var_cas_ioImportedSemanticsComponentNameSet */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_580_23_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_639_34_ (galgas_scanner & _inLexique,
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_639_34_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_654_33_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext) {
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_654_33_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_671_44_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_671_44_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_690_43_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_690_43_parse (galgas_scanner & /* _inLexique */) {
}
