  ...
  if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("galgas_cli_options", "doNotGenerateXcodeProject" COMMA_SOURCE_FILE_AT_LINE (339))))._operator_not ()).isBuiltAndTrue ()) {
    ...
    if (((((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_xcode_tool_files.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (342)))._operator_strictSup (GGS_uint (true, 0U))))._operator_and ((var_cas_xcode_app_files.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (342)))._operator_strictSup (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
      ...
      if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (348)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        ...
        {
          GGS_stringlist::cEnumerator enumerator_17234 (var_cas_xcode_tool_files, true) ;
          const GGS_stringlist::cElement * operand_17234 = NULL ;
          while (((operand_17234 = enumerator_17234.nextObject ()))) {
            macroValidPointer (operand_17234) ;
            GGS_string var_cas_fullPath ;
            GGS_EXsourceFileKind var_cas_sourceKind ;
            const GGS_EXsourceFileMap  _temp_17336 = var_cas_sourceFileMap ;
            if (_temp_17336._isBuilt ()) {
              _temp_17336 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_17234->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (368)) ;
            }
            ...
            case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
              {
              var_cas_scannerSourceSet_tool._addAssign_operation (operand_17234->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_guiSourceFile:
              {
              var_cas_guiSourceSet_tool._addAssign_operation (operand_17234->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_optionSourceFile:
              {
              var_cas_optionSourceSet_tool._addAssign_operation (operand_17234->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_syntaxSourceFile:
              {
              var_cas_syntaxSourceSet_tool._addAssign_operation (operand_17234->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_semanticsSourceFile:
              {
              var_cas_semanticsSourceSet_tool._addAssign_operation (operand_17234->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_grammarSourceFile:
              {
              var_cas_grammarSourceSet_tool._addAssign_operation (operand_17234->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_programSourceFile:
              {
              var_cas_programSourceSet_tool._addAssign_operation (operand_17234->mValue) ;
              }
              break ;
        ...
        {
          GGS_stringlist::cEnumerator enumerator_18508 (var_cas_xcode_app_files, true) ;
          const GGS_stringlist::cElement * operand_18508 = NULL ;
          while (((operand_18508 = enumerator_18508.nextObject ()))) {
            macroValidPointer (operand_18508) ;
            GGS_string var_cas_fullPath ;
            GGS_EXsourceFileKind var_cas_sourceKind ;
            const GGS_EXsourceFileMap  _temp_18610 = var_cas_sourceFileMap ;
            if (_temp_18610._isBuilt ()) {
              _temp_18610 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_18508->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (399)) ;
            }
            switch (var_cas_sourceKind.enumValue ()) {
            case GGS_EXsourceFileKind::enum_externSourceFile:
              {
            ...
            case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
              {
              var_cas_scannerSourceSet_app._addAssign_operation (operand_18508->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_guiSourceFile:
              {
              var_cas_guiSourceSet_app._addAssign_operation (operand_18508->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_optionSourceFile:
              {
              var_cas_optionSourceSet_app._addAssign_operation (operand_18508->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_syntaxSourceFile:
              {
              var_cas_syntaxSourceSet_app._addAssign_operation (operand_18508->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_semanticsSourceFile:
              {
              var_cas_semanticsSourceSet_app._addAssign_operation (operand_18508->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_grammarSourceFile:
              {
              var_cas_grammarSourceSet_app._addAssign_operation (operand_18508->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_programSourceFile:
              {
              var_cas_programSourceSet_app._addAssign_operation (operand_18508->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::kNotBuilt:
              break ;
