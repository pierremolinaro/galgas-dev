...
pr_galgas_component_ggs_LL1_compile_component_141_23_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_6615 = (var_cas_s).operator_isNotEqual (var_cas_sourceFileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (152))) ;
    ...
    while (syntaxRepeat_0) {
      switch (select_ggs_LL1_compile_component_0 (inLexique)) {
        case 2 : {
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_3 = true ;
                while (syntaxRepeat_3) {
                    ...
                    const GGS_bool cond_8149 = (var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (198))).operator_isEqual (GGS_string ("xcode")) ;
                    if (cond_8149.isBuiltAndTrue ()) {
                    ...
                    }else if (cond_8149.isBuiltAndFalse ()) {
                      const GGS_bool cond_8385 = (((var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (200))).operator_isNotEqual (GGS_string ("makefile"))).operator_and ((var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (200))).operator_isNotEqual (GGS_string ("xcode_tool")))).operator_and ((var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (200))).operator_isNotEqual (GGS_string ("xcode_app"))) ;
          ...
          const GGS_bool cond_8630 = (gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value ()).operator_and ((var_cas_sourceFileKind).operator_isNotEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE))) ;
          if (cond_8630.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_9211 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_optionSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gOption"))) ;
          if (cond_9211.isBuiltAndTrue ()) {
          ...
          }else if (cond_9211.isBuiltAndFalse ()) {
            const GGS_bool cond_9763 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_lexiqueSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gLexique"))) ;
            if (cond_9763.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_10488 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_guiSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gGui"))) ;
              if (cond_10488.isBuiltAndTrue ()) {
                GGS_string var_cas_s2 = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/GALGAS_OUTPUT")) ;
                GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
              ...
              }else if (cond_10488.isBuiltAndFalse ()) {
                const GGS_bool cond_11347 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_grammarSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gGrammar"))) ;
                ...
                }else if (cond_11347.isBuiltAndFalse ()) {
                  const GGS_bool cond_11522 = (var_cas_sourceFileKind).operator_isNotEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
                  if (cond_11522.isBuiltAndTrue ()) {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  const GGS_bool cond_11664 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
  if (cond_11664.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_13316 = (var_cas_makefileFiles.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_13316.isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_12035 (var_cas_makefileFiles, true) ;
      ...
      while (((operand_12035 = enumerator_12035.nextObject ()))) {
        ...
        const GGS_EXsourceFileMap  temp_12131 = var_cas_sourceFileMap ;
        if (temp_12131.isBuilt ()) {
          temp_12131 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_12035->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (275)) ;
        }
        GGS_string var_cas_filePath = var_cas_fullPath.reader_stringByDeletingLastPathComponent () ;
        const GGS_bool cond_12668 = (var_cas_sourceKind).operator_isEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
        if (cond_12668.isBuiltAndTrue ()) {
          const GGS_bool cond_12452 = (var_cas_filePath.reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
          ...
          }else if (cond_12452.isBuiltAndFalse ()) {
            const GGS_bool cond_12566 = (var_cas_filePath).operator_isNotEqual (GGS_string ("")) ;
    ...
    {
      GGS_stringset::cEnumerator enumerator_12872 (var_cas_pathSet, true) ;
      while (enumerator_12872.hasCurrentObject ()) {
        var_cas_pathesString.dotAssign_operation (enumerator_12872._key (HERE)) ;
        enumerator_12872.next () ;
      }
    }
    ...
    GGS_bool automatic_var_13308_0 ;
    const GGS_string temp_13290 = var_cas_newFileListContents ;
    if (temp_13290.isBuilt ()) {
      temp_13290 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_13308_0 COMMA_SOURCE_FILE_AT_LINE (298)) ;
    }
  }
  const GGS_bool cond_18184 = (gOption_galgas_5F_cli_5F_options_doNotGenerateXcodeProject.reader_value ()).operator_not () ;
  if (cond_18184.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_18173 = (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and ((var_cas_xcode_tool_files.reader_length ()).operator_strictSup (GGS_uint (0U)))).operator_and ((var_cas_xcode_app_files.reader_length ()).operator_strictSup (GGS_uint (0U))) ;
    if (cond_18173.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_14316 = (var_cas_xcodeProjects.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
      if (cond_14316.isBuiltAndTrue ()) {
      }else if (cond_14316.isBuiltAndFalse ()) {
        const GGS_bool cond_14491 = (var_cas_xcodeProjects.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
        if (cond_14491.isBuiltAndTrue ()) {
        ...
        }else if (cond_14491.isBuiltAndFalse ()) {
          const GGS_bool cond_18162 = (var_cas_xcodeProjects.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
          if (cond_18162.isBuiltAndTrue ()) {
            GGS_string var_cas_name ;
            const GGS_stringlist  temp_14566 = var_cas_xcodeProjects ;
            if (temp_14566.isBuilt ()) {
              temp_14566 (HERE)->method_first (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (315)) ;
            }
            ...
            {
              GGS_stringlist::cEnumerator enumerator_15292 (var_cas_xcode_tool_files, true) ;
              const GGS_stringlist::cElement * operand_15292 = NULL ;
              while (((operand_15292 = enumerator_15292.nextObject ()))) {
                macroValidPointer (operand_15292) ;
                GGS_string var_cas_fullPath ;
                GGS_EXsourceFileKind var_cas_sourceKind ;
                const GGS_EXsourceFileMap  temp_15394 = var_cas_sourceFileMap ;
                if (temp_15394.isBuilt ()) {
                  temp_15394 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_15292->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (330)) ;
                }
                ...
                case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                  {
                  var_cas_scannerSourceSet_tool.addAssign_operation (operand_15292->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_guiSourceFile:
                  {
                  var_cas_guiSourceSet_tool.addAssign_operation (operand_15292->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_optionSourceFile:
                  {
                  var_cas_optionSourceSet_tool.addAssign_operation (operand_15292->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                  {
                  var_cas_syntaxSourceSet_tool.addAssign_operation (operand_15292->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                  {
                  var_cas_semanticsSourceSet_tool.addAssign_operation (operand_15292->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_grammarSourceFile:
                  {
                  var_cas_grammarSourceSet_tool.addAssign_operation (operand_15292->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_programSourceFile:
                  {
                  var_cas_programSourceSet_tool.addAssign_operation (operand_15292->mValue) ;
                  }
                  break ;
            ...
            {
              GGS_stringlist::cEnumerator enumerator_16566 (var_cas_xcode_app_files, true) ;
              const GGS_stringlist::cElement * operand_16566 = NULL ;
              while (((operand_16566 = enumerator_16566.nextObject ()))) {
                macroValidPointer (operand_16566) ;
                GGS_string var_cas_fullPath ;
                GGS_EXsourceFileKind var_cas_sourceKind ;
                const GGS_EXsourceFileMap  temp_16668 = var_cas_sourceFileMap ;
                if (temp_16668.isBuilt ()) {
                  temp_16668 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_16566->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (361)) ;
                }
                switch (var_cas_sourceKind.enumValue ()) {
                case GGS_EXsourceFileKind::enum_externSourceFile:
                  {
                ...
                case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                  {
                  var_cas_scannerSourceSet_app.addAssign_operation (operand_16566->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_guiSourceFile:
                  {
                  var_cas_guiSourceSet_app.addAssign_operation (operand_16566->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_optionSourceFile:
                  {
                  var_cas_optionSourceSet_app.addAssign_operation (operand_16566->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                  {
                  var_cas_syntaxSourceSet_app.addAssign_operation (operand_16566->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                  {
                  var_cas_semanticsSourceSet_app.addAssign_operation (operand_16566->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_grammarSourceFile:
                  {
                  var_cas_grammarSourceSet_app.addAssign_operation (operand_16566->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_programSourceFile:
                  {
                  var_cas_programSourceSet_app.addAssign_operation (operand_16566->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::kNotBuilt:
                  break ;
...
pr_galgas_component_ggs_LL1_compile_component_620_23_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  const GGS_bool cond_22246 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
  if (cond_22246.isBuiltAndTrue ()) {
