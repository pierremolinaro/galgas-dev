...
void ggs_LL1_compile_component::rule_ggs_5F_LL_31__5F_compile_5F_component_galgas_5F_component_i0_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_string var_cas_s = GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
  const GGS_bool cond_6490 = (var_cas_s).operator_isNotEqual (var_cas_sourceFileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (146))) ;
  if (cond_6490.isBuiltAndTrue ()) {
    var_cas_sourceFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the project name ('")).operator_concat (var_cas_sourceFileName)).operator_concat (GGS_string ("') should be the file base name '"))).operator_concat (var_cas_s)).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (148)) ;
  }
    ...
    while (syntaxRepeat_0) {
      switch (select_ggs_5F_LL_31__5F_compile_5F_component_0 (inLexique)) {
        case 2 : {
          ...
          GGS_string var_cas_baseName = var_cas_fileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (182)).reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
          var_cas_sourceFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_baseName, var_cas_fileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (184)) COMMA_HERE), var_cas_fileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (184)), var_cas_sourceFileKind COMMA_SOURCE_FILE_AT_LINE (184)) ;
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_3 = true ;
                while (syntaxRepeat_3) {
                    ...
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
                    var_cas_targetFileListMap.addAssign_operation (var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (191)), var_cas_baseName) ;
                    const GGS_bool cond_8024 = (var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (192))).operator_isEqual (GGS_string ("xcode")) ;
                    if (cond_8024.isBuiltAndTrue ()) {
                      var_cas_targetName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the target \"xcode\" name is obsolete: use \"xcode_tool\" and/or \"xcode_app\"") COMMA_SOURCE_FILE_AT_LINE (194)) ;
                    }else if (cond_8024.isBuiltAndFalse ()) {
                      const GGS_bool cond_8260 = (((var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (194))).operator_isNotEqual (GGS_string ("makefile"))).operator_and ((var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (194))).operator_isNotEqual (GGS_string ("xcode_tool")))).operator_and ((var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (194))).operator_isNotEqual (GGS_string ("xcode_app"))) ;
                      if (cond_8260.isBuiltAndTrue ()) {
                        var_cas_targetName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the target name should be \"makefile\", \"xcode_tool\" or \"xcode_app\"") COMMA_SOURCE_FILE_AT_LINE (196)) ;
                      }
                    }
          ...
          const GGS_bool cond_8505 = (gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value ()).operator_and ((var_cas_sourceFileKind).operator_isNotEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE))) ;
          if (cond_8505.isBuiltAndTrue ()) {
            inLexique.printMessage (((GGS_string ("------ Compile file '")).operator_concat (var_cas_fileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202)))).operator_concat (GGS_string ("'\n")) COMMA_SOURCE_FILE_AT_LINE (202)) ;
          }
          const GGS_bool cond_9086 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_optionSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gOption"))) ;
          if (cond_9086.isBuiltAndTrue ()) {
            ...
            ::routine_compileOptionComponent (inLexique,  var_cas_fileName,  var_cas_s2,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (213)) ;
          }else if (cond_9086.isBuiltAndFalse ()) {
            const GGS_bool cond_9638 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_lexiqueSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gLexique"))) ;
            if (cond_9638.isBuiltAndTrue ()) {
              GGS_string var_cas_s2 = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/GALGAS_OUTPUT")) ;
              GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
              ::routine_compileLexiqueComponent (inLexique,  var_cas_fileName,  var_cas_s2,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (222)) ;
            }else if (cond_9638.isBuiltAndFalse ()) {
              const GGS_bool cond_10363 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_guiSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gGui"))) ;
              if (cond_10363.isBuiltAndTrue ()) {
                GGS_string var_cas_s2 = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/GALGAS_OUTPUT")) ;
                GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
                ...
                ::routine_compileGuiComponent (inLexique,  GGS_lstring ::constructor_new (inLexique, var_cas_absoluteFilePath, var_cas_fileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (232)) COMMA_HERE),  var_cas_s2,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (232)) ;
              }else if (cond_10363.isBuiltAndFalse ()) {
                const GGS_bool cond_11222 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_grammarSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gGrammar"))) ;
                if (cond_11222.isBuiltAndTrue ()) {
                  ...
                  ::routine_compileGrammarComponent (inLexique,  GGS_lstring ::constructor_new (inLexique, var_cas_absoluteFilePath, var_cas_fileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (243)) COMMA_HERE),  var_cas_s2,  GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (),  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (242)) ;
                }else if (cond_11222.isBuiltAndFalse ()) {
                  const GGS_bool cond_11397 = (var_cas_sourceFileKind).operator_isNotEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
                  if (cond_11397.isBuiltAndTrue ()) {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_project) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  const GGS_bool cond_11539 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
  if (cond_11539.isBuiltAndTrue ()) {
    inLexique.printMessage (GGS_string ("------ Project\n") COMMA_SOURCE_FILE_AT_LINE (257)) ;
  }
  GGS_stringlist  var_cas_makefileFiles = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("makefile") COMMA_SOURCE_FILE_AT_LINE (260)) ;
  const GGS_bool cond_13191 = (var_cas_makefileFiles.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_13191.isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_11910 (var_cas_makefileFiles, true) ;
      const GGS_stringlist::cElement * operand_11910 = NULL ;
      while (((operand_11910 = enumerator_11910.nextObject ()))) {
        ...
        const GGS_EXsourceFileMap  temp_12006 = var_cas_sourceFileMap ;
        if (temp_12006.isBuilt ()) {
          temp_12006 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_11910->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (269)) ;
        }
        GGS_string var_cas_filePath = var_cas_fullPath.reader_stringByDeletingLastPathComponent () ;
        const GGS_bool cond_12543 = (var_cas_sourceKind).operator_isEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
        if (cond_12543.isBuiltAndTrue ()) {
          const GGS_bool cond_12327 = (var_cas_filePath.reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
          if (cond_12327.isBuiltAndTrue ()) {
            var_cas_pathSet.addAssign_operation (((GGS_string ("SOURCES_DIR += ")).operator_concat (var_cas_filePath)).operator_concat (GGS_string ("\n"))) ;
          }else if (cond_12327.isBuiltAndFalse ()) {
            const GGS_bool cond_12441 = (var_cas_filePath).operator_isNotEqual (GGS_string ("")) ;
        ...
        }else if (cond_12543.isBuiltAndFalse ()) {
    ...
    {
      GGS_stringset::cEnumerator enumerator_12747 (var_cas_pathSet, true) ;
      while (enumerator_12747.hasCurrentObject ()) {
        var_cas_pathesString.dotAssign_operation (enumerator_12747._key (HERE)) ;
        enumerator_12747.next () ;
      }
    }
    ...
    GGS_bool automatic_var_13183_0 ;
    const GGS_string temp_13165 = var_cas_newFileListContents ;
    if (temp_13165.isBuilt ()) {
      temp_13165 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_13183_0 COMMA_SOURCE_FILE_AT_LINE (292)) ;
    }
  }
  const GGS_bool cond_18059 = (gOption_galgas_5F_cli_5F_options_doNotGenerateXcodeProject.reader_value ()).operator_not () ;
  if (cond_18059.isBuiltAndTrue ()) {
    GGS_stringlist  var_cas_xcode_tool_files = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("xcode_tool") COMMA_SOURCE_FILE_AT_LINE (296)) ;
    GGS_stringlist  var_cas_xcode_app_files = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("xcode_app") COMMA_SOURCE_FILE_AT_LINE (297)) ;
    const GGS_bool cond_18048 = (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and ((var_cas_xcode_tool_files.reader_length ()).operator_strictSup (GGS_uint (0U)))).operator_and ((var_cas_xcode_app_files.reader_length ()).operator_strictSup (GGS_uint (0U))) ;
    if (cond_18048.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_14191 = (var_cas_xcodeProjects.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
      if (cond_14191.isBuiltAndTrue ()) {
      }else if (cond_14191.isBuiltAndFalse ()) {
        const GGS_bool cond_14366 = (var_cas_xcodeProjects.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
        if (cond_14366.isBuiltAndTrue ()) {
        ...
        }else if (cond_14366.isBuiltAndFalse ()) {
          const GGS_bool cond_18037 = (var_cas_xcodeProjects.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
          if (cond_18037.isBuiltAndTrue ()) {
            GGS_string var_cas_name ;
            const GGS_stringlist  temp_14441 = var_cas_xcodeProjects ;
            if (temp_14441.isBuilt ()) {
              temp_14441 (HERE)->method_first (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (309)) ;
            }
            ...
            {
              GGS_stringlist::cEnumerator enumerator_15167 (var_cas_xcode_tool_files, true) ;
              ...
              while (((operand_15167 = enumerator_15167.nextObject ()))) {
                ...
                GGS_string var_cas_fullPath ;
                GGS_EXsourceFileKind var_cas_sourceKind ;
                const GGS_EXsourceFileMap  temp_15269 = var_cas_sourceFileMap ;
                if (temp_15269.isBuilt ()) {
                  temp_15269 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_15167->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (324)) ;
                }
                ...
                case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                  {
                  var_cas_scannerSourceSet_tool.addAssign_operation (operand_15167->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_guiSourceFile:
                  {
                  var_cas_guiSourceSet_tool.addAssign_operation (operand_15167->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_optionSourceFile:
                  {
                  var_cas_optionSourceSet_tool.addAssign_operation (operand_15167->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                  {
                  var_cas_syntaxSourceSet_tool.addAssign_operation (operand_15167->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                  {
                  var_cas_semanticsSourceSet_tool.addAssign_operation (operand_15167->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_grammarSourceFile:
                  {
                  var_cas_grammarSourceSet_tool.addAssign_operation (operand_15167->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_programSourceFile:
                  {
                  var_cas_programSourceSet_tool.addAssign_operation (operand_15167->mValue) ;
                  }
                  break ;
            ...
            {
              GGS_stringlist::cEnumerator enumerator_16441 (var_cas_xcode_app_files, true) ;
              const GGS_stringlist::cElement * operand_16441 = NULL ;
              while (((operand_16441 = enumerator_16441.nextObject ()))) {
                macroValidPointer (operand_16441) ;
                GGS_string var_cas_fullPath ;
                GGS_EXsourceFileKind var_cas_sourceKind ;
                const GGS_EXsourceFileMap  temp_16543 = var_cas_sourceFileMap ;
                if (temp_16543.isBuilt ()) {
                  temp_16543 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_16441->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (355)) ;
                }
                switch (var_cas_sourceKind.enumValue ()) {
                case GGS_EXsourceFileKind::enum_externSourceFile:
                  {
                ...
                case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                  {
                  var_cas_scannerSourceSet_app.addAssign_operation (operand_16441->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_guiSourceFile:
                  {
                  var_cas_guiSourceSet_app.addAssign_operation (operand_16441->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_optionSourceFile:
                  {
                  var_cas_optionSourceSet_app.addAssign_operation (operand_16441->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                  {
                  var_cas_syntaxSourceSet_app.addAssign_operation (operand_16441->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                  {
                  var_cas_semanticsSourceSet_app.addAssign_operation (operand_16441->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_grammarSourceFile:
                  {
                  var_cas_grammarSourceSet_app.addAssign_operation (operand_16441->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_programSourceFile:
                  {
                  var_cas_programSourceSet_app.addAssign_operation (operand_16441->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::kNotBuilt:
                  break ;
