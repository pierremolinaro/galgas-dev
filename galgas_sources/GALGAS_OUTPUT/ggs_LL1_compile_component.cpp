...
pr_galgas_component_ggs_LL1_compile_component_141_23_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_6607 = (var_cas_s).operator_isNotEqual (var_cas_sourceFileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (152))) ;
    ...
    while (syntaxRepeat_0) {
      switch (select_ggs_LL1_compile_component_0 (inLexique)) {
        case 2 : {
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_3 = true ;
                while (syntaxRepeat_3) {
                    ...
                    const GGS_bool cond_8141 = (var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (198))).operator_isEqual (GGS_string ("xcode")) ;
                    if (cond_8141.isBuiltAndTrue ()) {
                    ...
                    }else if (cond_8141.isBuiltAndFalse ()) {
                      const GGS_bool cond_8377 = (((var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (200))).operator_isNotEqual (GGS_string ("makefile"))).operator_and ((var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (200))).operator_isNotEqual (GGS_string ("xcode_tool")))).operator_and ((var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (200))).operator_isNotEqual (GGS_string ("xcode_app"))) ;
                      if (cond_8377.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_8622 = (gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value ()).operator_and ((var_cas_sourceFileKind).operator_isNotEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE))) ;
          if (cond_8622.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_9203 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_optionSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gOption"))) ;
          if (cond_9203.isBuiltAndTrue ()) {
          ...
          }else if (cond_9203.isBuiltAndFalse ()) {
            const GGS_bool cond_9755 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_lexiqueSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gLexique"))) ;
            if (cond_9755.isBuiltAndTrue ()) {
              GGS_string var_cas_s2 = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/GALGAS_OUTPUT")) ;
              GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ...
            }else if (cond_9755.isBuiltAndFalse ()) {
              const GGS_bool cond_10480 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_guiSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gGui"))) ;
              if (cond_10480.isBuiltAndTrue ()) {
              ...
              }else if (cond_10480.isBuiltAndFalse ()) {
                const GGS_bool cond_11339 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_grammarSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gGrammar"))) ;
                if (cond_11339.isBuiltAndTrue ()) {
                ...
                }else if (cond_11339.isBuiltAndFalse ()) {
                  const GGS_bool cond_11514 = (var_cas_sourceFileKind).operator_isNotEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
                  if (cond_11514.isBuiltAndTrue ()) {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  const GGS_bool cond_11656 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
  ...
  const GGS_bool cond_13308 = (var_cas_makefileFiles.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_13308.isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_12027 (var_cas_makefileFiles, true) ;
      ...
      while (((operand_12027 = enumerator_12027.nextObject ()))) {
        ...
        const GGS_EXsourceFileMap  temp_12123 = var_cas_sourceFileMap ;
        if (temp_12123.isBuilt ()) {
          temp_12123 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_12027->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (275)) ;
        }
        GGS_string var_cas_filePath = var_cas_fullPath.reader_stringByDeletingLastPathComponent () ;
        const GGS_bool cond_12660 = (var_cas_sourceKind).operator_isEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
        if (cond_12660.isBuiltAndTrue ()) {
          const GGS_bool cond_12444 = (var_cas_filePath.reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
          ...
          }else if (cond_12444.isBuiltAndFalse ()) {
            const GGS_bool cond_12558 = (var_cas_filePath).operator_isNotEqual (GGS_string ("")) ;
            if (cond_12558.isBuiltAndTrue ()) {
        ...
        }else if (cond_12660.isBuiltAndFalse ()) {
    ...
    {
      GGS_stringset::cEnumerator enumerator_12864 (var_cas_pathSet, true) ;
      while (enumerator_12864.hasCurrentObject ()) {
        var_cas_pathesString.dotAssign_operation (enumerator_12864._key (HERE)) ;
        enumerator_12864.next () ;
      }
    }
    ...
    GGS_bool automatic_var_13300_0 ;
    const GGS_string temp_13282 = var_cas_newFileListContents ;
    if (temp_13282.isBuilt ()) {
      temp_13282 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_13300_0 COMMA_SOURCE_FILE_AT_LINE (298)) ;
    }
  }
  const GGS_bool cond_18176 = (gOption_galgas_5F_cli_5F_options_doNotGenerateXcodeProject.reader_value ()).operator_not () ;
  if (cond_18176.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_18165 = (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and ((var_cas_xcode_tool_files.reader_length ()).operator_strictSup (GGS_uint (0U)))).operator_and ((var_cas_xcode_app_files.reader_length ()).operator_strictSup (GGS_uint (0U))) ;
    if (cond_18165.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_14308 = (var_cas_xcodeProjects.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
      if (cond_14308.isBuiltAndTrue ()) {
      }else if (cond_14308.isBuiltAndFalse ()) {
        const GGS_bool cond_14483 = (var_cas_xcodeProjects.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
        if (cond_14483.isBuiltAndTrue ()) {
        ...
        }else if (cond_14483.isBuiltAndFalse ()) {
          const GGS_bool cond_18154 = (var_cas_xcodeProjects.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
          if (cond_18154.isBuiltAndTrue ()) {
            GGS_string var_cas_name ;
            const GGS_stringlist  temp_14558 = var_cas_xcodeProjects ;
            if (temp_14558.isBuilt ()) {
              temp_14558 (HERE)->method_first (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (315)) ;
            }
            ...
            {
              GGS_stringlist::cEnumerator enumerator_15284 (var_cas_xcode_tool_files, true) ;
              const GGS_stringlist::cElement * operand_15284 = NULL ;
              while (((operand_15284 = enumerator_15284.nextObject ()))) {
                macroValidPointer (operand_15284) ;
                GGS_string var_cas_fullPath ;
                GGS_EXsourceFileKind var_cas_sourceKind ;
                const GGS_EXsourceFileMap  temp_15386 = var_cas_sourceFileMap ;
                if (temp_15386.isBuilt ()) {
                  temp_15386 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_15284->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (330)) ;
                }
                ...
                case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                  {
                  var_cas_scannerSourceSet_tool.addAssign_operation (operand_15284->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_guiSourceFile:
                  {
                  var_cas_guiSourceSet_tool.addAssign_operation (operand_15284->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_optionSourceFile:
                  {
                  var_cas_optionSourceSet_tool.addAssign_operation (operand_15284->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                  {
                  var_cas_syntaxSourceSet_tool.addAssign_operation (operand_15284->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                  {
                  var_cas_semanticsSourceSet_tool.addAssign_operation (operand_15284->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_grammarSourceFile:
                  {
                  var_cas_grammarSourceSet_tool.addAssign_operation (operand_15284->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_programSourceFile:
                  {
                  var_cas_programSourceSet_tool.addAssign_operation (operand_15284->mValue) ;
                  }
                  break ;
            ...
            {
              GGS_stringlist::cEnumerator enumerator_16558 (var_cas_xcode_app_files, true) ;
              const GGS_stringlist::cElement * operand_16558 = NULL ;
              while (((operand_16558 = enumerator_16558.nextObject ()))) {
                macroValidPointer (operand_16558) ;
                GGS_string var_cas_fullPath ;
                GGS_EXsourceFileKind var_cas_sourceKind ;
                const GGS_EXsourceFileMap  temp_16660 = var_cas_sourceFileMap ;
                if (temp_16660.isBuilt ()) {
                  temp_16660 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_16558->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (361)) ;
                }
                switch (var_cas_sourceKind.enumValue ()) {
                case GGS_EXsourceFileKind::enum_externSourceFile:
                  {
                ...
                case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                  {
                  var_cas_scannerSourceSet_app.addAssign_operation (operand_16558->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_guiSourceFile:
                  {
                  var_cas_guiSourceSet_app.addAssign_operation (operand_16558->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_optionSourceFile:
                  {
                  var_cas_optionSourceSet_app.addAssign_operation (operand_16558->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                  {
                  var_cas_syntaxSourceSet_app.addAssign_operation (operand_16558->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                  {
                  var_cas_semanticsSourceSet_app.addAssign_operation (operand_16558->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_grammarSourceFile:
                  {
                  var_cas_grammarSourceSet_app.addAssign_operation (operand_16558->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_programSourceFile:
                  {
                  var_cas_programSourceSet_app.addAssign_operation (operand_16558->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::kNotBuilt:
                  break ;
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_620_34_ (galgas_scanner & inLexique,
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_620_34_parse (galgas_scanner & inLexique) {
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_635_33_ (galgas_scanner & inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext) {
  const GGS_string _depExtension = GGS_string ("") ;
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_635_33_parse (galgas_scanner & inLexique) {
  GGS_lstring::constructor_retrieveAndResetTemplateString (inLexique COMMA_HERE) ;
}
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_652_44_ (galgas_scanner & inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_652_44_parse (galgas_scanner & inLexique) {
  GGS_lstring::constructor_retrieveAndResetTemplateString (inLexique COMMA_HERE) ;
}
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_671_43_ (galgas_scanner & inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
  const GGS_string _depExtension = GGS_string ("") ;
  const GGS_string _depPath = GGS_string ("") ;
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_671_43_parse (galgas_scanner & inLexique) {
  GGS_lstring::constructor_retrieveAndResetTemplateString (inLexique COMMA_HERE) ;
}
