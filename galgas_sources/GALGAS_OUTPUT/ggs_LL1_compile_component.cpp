...
pr_galgas_component_ggs_LL1_compile_component_140_23_ (galgas_scanner & inLexique,
  ...
  GGS_string var_cas_s = GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (150)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (150)) ;
  const GGS_bool cond_6530 = (var_cas_s).operator_isNotEqual (var_cas_sourceFileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (151))) ;
  if (cond_6530.isBuiltAndTrue ()) {
    var_cas_sourceFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the project name ('")).operator_concat (var_cas_sourceFileName)).operator_concat (GGS_string ("') should be the file base name '"))).operator_concat (var_cas_s)).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (153)) ;
  }
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_ggs_LL1_compile_component_0 (inLexique)) {
        case 2 : {
          ...
          GGS_string var_cas_baseName = var_cas_fileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (187)).reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (187)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (187)) ;
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_3 = true ;
                while (syntaxRepeat_3) {
                    ...
                    const GGS_bool cond_8064 = (var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (197))).operator_isEqual (GGS_string ("xcode")) ;
                    ...
                    }else if (cond_8064.isBuiltAndFalse ()) {
                      const GGS_bool cond_8300 = (((var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (199))).operator_isNotEqual (GGS_string ("makefile"))).operator_and ((var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (199))).operator_isNotEqual (GGS_string ("xcode_tool")))).operator_and ((var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (199))).operator_isNotEqual (GGS_string ("xcode_app"))) ;
                      if (cond_8300.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_8538 = (gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).operator_and ((var_cas_sourceFileKind).operator_isNotEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE))) ;
          if (cond_8538.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_9119 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_optionSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (210))).operator_isEqual (GGS_string ("gOption"))) ;
          if (cond_9119.isBuiltAndTrue ()) {
            GGS_string var_cas_s2 = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (211))).operator_concat (GGS_string ("/GALGAS_OUTPUT")) ;
          ...
          }else if (cond_9119.isBuiltAndFalse ()) {
            const GGS_bool cond_9671 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_lexiqueSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (219))).operator_isEqual (GGS_string ("gLexique"))) ;
            if (cond_9671.isBuiltAndTrue ()) {
              GGS_string var_cas_s2 = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (220))).operator_concat (GGS_string ("/GALGAS_OUTPUT")) ;
              GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ...
            }else if (cond_9671.isBuiltAndFalse ()) {
              const GGS_bool cond_10396 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_guiSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (228))).operator_isEqual (GGS_string ("gGui"))) ;
              if (cond_10396.isBuiltAndTrue ()) {
                GGS_string var_cas_s2 = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (229))).operator_concat (GGS_string ("/GALGAS_OUTPUT")) ;
                GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
                GGS_string var_cas_absoluteFilePath = var_cas_fileName.ggs_string ().reader_absolutePathFromPath (inLexique, GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (236)) COMMA_SOURCE_FILE_AT_LINE (236)) ;
              ...
              }else if (cond_10396.isBuiltAndFalse ()) {
                const GGS_bool cond_10571 = (var_cas_sourceFileKind).operator_isNotEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  const GGS_bool cond_10707 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.value () ;
  if (cond_10707.isBuiltAndTrue ()) {
    inLexique.printMessage (GGS_string ("------ Project\n") COMMA_SOURCE_FILE_AT_LINE (247)) ;
  }
  GGS_stringlist  var_cas_makefileFiles = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("makefile") COMMA_SOURCE_FILE_AT_LINE (250)) ;
  const GGS_bool cond_12359 = (var_cas_makefileFiles.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (251))).operator_strictSup (GGS_uint (0U)) ;
  if (cond_12359.isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_11078 (var_cas_makefileFiles, true) ;
      const GGS_stringlist::cElement * operand_11078 = NULL ;
      while (((operand_11078 = enumerator_11078.nextObject ()))) {
        macroValidPointer (operand_11078) ;
        GGS_string var_cas_fullPath ;
        GGS_EXsourceFileKind var_cas_sourceKind ;
        const GGS_EXsourceFileMap  temp_11174 = var_cas_sourceFileMap ;
        if (temp_11174.isBuilt ()) {
          temp_11174 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_11078->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (259)) ;
        }
        GGS_string var_cas_filePath = var_cas_fullPath.reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (260)) ;
        const GGS_bool cond_11711 = (var_cas_sourceKind).operator_isEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
        if (cond_11711.isBuiltAndTrue ()) {
          const GGS_bool cond_11495 = (var_cas_filePath.reader_firstCharacterOrNul (inLexique COMMA_SOURCE_FILE_AT_LINE (262))).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
          if (cond_11495.isBuiltAndTrue ()) {
            var_cas_pathSet.addAssign_operation (((GGS_string ("SOURCES_DIR += ")).operator_concat (var_cas_filePath)).operator_concat (GGS_string ("\n"))) ;
          }else if (cond_11495.isBuiltAndFalse ()) {
            const GGS_bool cond_11609 = (var_cas_filePath).operator_isNotEqual (GGS_string ("")) ;
          ...
          var_cas_externSourceFileList.dotAssign_operation (var_cas_fullPath.reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (267))) ;
          var_cas_externSourceFileList.appendCString ("\n") ;
        }else if (cond_11711.isBuiltAndFalse ()) {
          var_cas_galgasSourceList.appendCString ("SOURCES += ") ;
          var_cas_galgasSourceList.dotAssign_operation (var_cas_fullPath.reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (269)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (269))) ;
    ...
    {
      GGS_stringset::cEnumerator enumerator_11915 (var_cas_pathSet, true) ;
      while (enumerator_11915.hasCurrentObject ()) {
        var_cas_pathesString.dotAssign_operation (enumerator_11915._key (HERE)) ;
        enumerator_11915.next () ;
      }
    }
    ...
    GGS_string var_cas_fileListPath = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (281))).operator_concat (GGS_string ("/GALGAS_OUTPUT/file_list.mke")) ;
    GGS_bool automatic_var_0 ;
    const GGS_string temp_12333 = var_cas_newFileListContents ;
    if (temp_12333.isBuilt ()) {
      temp_12333 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (282)) ;
    }
  }
  const GGS_bool cond_17221 = (gOption_galgas_5F_cli_5F_options_doNotGenerateXcodeProject.value ()).operator_not () ;
  if (cond_17221.isBuiltAndTrue ()) {
    GGS_stringlist  var_cas_xcode_tool_files = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("xcode_tool") COMMA_SOURCE_FILE_AT_LINE (286)) ;
    GGS_stringlist  var_cas_xcode_app_files = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("xcode_app") COMMA_SOURCE_FILE_AT_LINE (287)) ;
    const GGS_bool cond_17210 = (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and ((var_cas_xcode_tool_files.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (288))).operator_strictSup (GGS_uint (0U)))).operator_and ((var_cas_xcode_app_files.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (288))).operator_strictSup (GGS_uint (0U))) ;
    if (cond_17210.isBuiltAndTrue ()) {
      GGS_string var_cas_XcodeProjectDir = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (289)).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (289))).operator_concat (GGS_string ("/project_xcode")) ;
      GGS_stringlist  var_cas_iconFiles = var_cas_XcodeProjectDir.reader_regularFilesWithExtensions (inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("icns")) COMMA_SOURCE_FILE_AT_LINE (291)) ;
      GGS_stringlist  var_cas_xcodeProjects = var_cas_XcodeProjectDir.reader_directoriesWithExtensions (inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("xcodeproj")) COMMA_SOURCE_FILE_AT_LINE (292)) ;
      const GGS_bool cond_13353 = (var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (294))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_13353.isBuiltAndTrue ()) {
      }else if (cond_13353.isBuiltAndFalse ()) {
        const GGS_bool cond_13528 = (var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (296))).operator_strictSup (GGS_uint (1U)) ;
        if (cond_13528.isBuiltAndTrue ()) {
        ...
        }else if (cond_13528.isBuiltAndFalse ()) {
          const GGS_bool cond_17199 = (var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (298))).operator_isEqual (GGS_uint (1U)) ;
          if (cond_17199.isBuiltAndTrue ()) {
            GGS_string var_cas_name ;
            const GGS_stringlist  temp_13603 = var_cas_xcodeProjects ;
            if (temp_13603.isBuilt ()) {
              temp_13603 (HERE)->method_first (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (299)) ;
            }
            ...
            GGS_string var_cas_intermediateFilePath = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (302))).operator_concat (GGS_string ("/GALGAS_OUTPUT/file_list_for_xcode_project.txt")) ;
            ...
            {
              GGS_stringlist::cEnumerator enumerator_14329 (var_cas_xcode_tool_files, true) ;
              const GGS_stringlist::cElement * operand_14329 = NULL ;
              while (((operand_14329 = enumerator_14329.nextObject ()))) {
                macroValidPointer (operand_14329) ;
                GGS_string var_cas_fullPath ;
                GGS_EXsourceFileKind var_cas_sourceKind ;
                const GGS_EXsourceFileMap  temp_14431 = var_cas_sourceFileMap ;
                if (temp_14431.isBuilt ()) {
                  temp_14431 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_14329->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (314)) ;
                }
                ...
                case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                  {
                  var_cas_scannerSourceSet_tool.addAssign_operation (operand_14329->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_guiSourceFile:
                  {
                  var_cas_guiSourceSet_tool.addAssign_operation (operand_14329->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_optionSourceFile:
                  {
                  var_cas_optionSourceSet_tool.addAssign_operation (operand_14329->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                  {
                  var_cas_syntaxSourceSet_tool.addAssign_operation (operand_14329->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                  {
                  var_cas_semanticsSourceSet_tool.addAssign_operation (operand_14329->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_grammarSourceFile:
                  {
                  var_cas_grammarSourceSet_tool.addAssign_operation (operand_14329->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_programSourceFile:
                  {
                  var_cas_programSourceSet_tool.addAssign_operation (operand_14329->mValue) ;
                  }
                  break ;
            ...
            {
              GGS_stringlist::cEnumerator enumerator_15603 (var_cas_xcode_app_files, true) ;
              const GGS_stringlist::cElement * operand_15603 = NULL ;
              while (((operand_15603 = enumerator_15603.nextObject ()))) {
                macroValidPointer (operand_15603) ;
                GGS_string var_cas_fullPath ;
                GGS_EXsourceFileKind var_cas_sourceKind ;
                const GGS_EXsourceFileMap  temp_15705 = var_cas_sourceFileMap ;
                if (temp_15705.isBuilt ()) {
                  temp_15705 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_15603->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (345)) ;
                }
                switch (var_cas_sourceKind.enumValue ()) {
                case GGS_EXsourceFileKind::enum_externSourceFile:
                  {
                ...
                case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                  {
                  var_cas_scannerSourceSet_app.addAssign_operation (operand_15603->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_guiSourceFile:
                  {
                  var_cas_guiSourceSet_app.addAssign_operation (operand_15603->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_optionSourceFile:
                  {
                  var_cas_optionSourceSet_app.addAssign_operation (operand_15603->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                  {
                  var_cas_syntaxSourceSet_app.addAssign_operation (operand_15603->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                  {
                  var_cas_semanticsSourceSet_app.addAssign_operation (operand_15603->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_grammarSourceFile:
                  {
                  var_cas_grammarSourceSet_app.addAssign_operation (operand_15603->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_programSourceFile:
                  {
                  var_cas_programSourceSet_app.addAssign_operation (operand_15603->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::kNotBuilt:
                  break ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_140_23_importGrammarForSemantics (galgas_scanner & inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_140_23_importLexique (galgas_scanner & inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A_) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_140_23_importOptions (galgas_scanner & inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A_) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_140_23_importSemantics (galgas_scanner & inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_140_23_importSyntax (galgas_scanner & inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_604_23_ (galgas_scanner & inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  const GGS_bool cond_21277 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.value () ;
  if (cond_21277.isBuiltAndTrue ()) {
    inLexique.printMessage (((GGS_string ("------ Compile file '")).operator_concat (var_cas_fileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (617)))).operator_concat (GGS_string ("'\n")) COMMA_SOURCE_FILE_AT_LINE (617)) ;
  }
  const GGS_string _depExtension = GGS_string ("galgas-dep") ;
  const GGS_string _depPath = GGS_string ("DEPENDENCIES") ;
  if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_604_23_importGrammarForSemantics (galgas_scanner & inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_604_23_importLexique (galgas_scanner & inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_604_23_importOptions (galgas_scanner & inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_604_23_importSemantics (galgas_scanner & inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
                                GGS_stringset  &/* var_cas_ioImportedSemanticsComponentNameSet */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_604_23_importSyntax (galgas_scanner & inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_663_34_ (galgas_scanner & inLexique,
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_663_34_parse (galgas_scanner & /* inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_678_33_ (galgas_scanner & inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext) {
  const GGS_string _depExtension = GGS_string ("") ;
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_678_33_parse (galgas_scanner & /* inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_695_44_ (galgas_scanner & inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_695_44_parse (galgas_scanner & /* inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_714_43_ (galgas_scanner & inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
  const GGS_string _depExtension = GGS_string ("") ;
  const GGS_string _depPath = GGS_string ("") ;
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_714_43_parse (galgas_scanner & /* inLexique */) {
}
