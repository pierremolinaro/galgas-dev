    ...
    if (((((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U)))._operator_and ((var_cas_xcode_tool_files.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (342)))._operator_strictSup (GGS_uint (0U))))._operator_and ((var_cas_xcode_app_files.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (342)))._operator_strictSup (GGS_uint (0U)))).isBuiltAndTrue ()) {
      ...
      if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (348)))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
        ...
        if (_temp_16581.isBuilt ()) {
          _temp_16581 (HERE)->method_first (_inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (353)) ;
        }
        ...
        var_cas_programSourceSet_tool = GGS_stringset ::constructor_emptySet () ;
        {
          ...
          while (((operand_17307 = enumerator_17307.nextObject ()))) {
            ...
            if (_temp_17409.isBuilt ()) {
              _temp_17409 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_17307->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (368)) ;
            }
        ...
        var_cas_programSourceSet_app = GGS_stringset ::constructor_emptySet () ;
        {
          ...
          while (((operand_18581 = enumerator_18581.nextObject ()))) {
            ...
            if (_temp_18683.isBuilt ()) {
              _temp_18683 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_18581->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (399)) ;
            }
            switch (var_cas_sourceKind.enumValue ()) {
            case GGS_EXsourceFileKind::enum_externSourceFile:
              {
