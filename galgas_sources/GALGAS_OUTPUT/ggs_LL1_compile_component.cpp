...
pr_galgas_component_ggs_LL1_compile_component_107_4_ (galgas_scanner & _inLexique,
      ...
      switch (select_repeat_ggs_LL1_compile_component_0 (_inLexique)) {
        case 2 : {
          ...
          if ((var_cas_externSourceSet.reader_hasKey (_inLexique, var_cas_inExternSourceName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124))).isBuiltAndTrue ()) {
            var_cas_inExternSourceName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (var_cas_inExternSourceName))._operator_concat (GGS_string (true, "' is already declared as extern")) COMMA_SOURCE_FILE_AT_LINE (125)) ;
          }
        ...
        case 3 : {
          ...
          if ((var_cas_galgasSourceSet.reader_hasKey (_inLexique, var_cas_fileName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (133)) COMMA_SOURCE_FILE_AT_LINE (133))).isBuiltAndTrue ()) {
            var_cas_fileName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (var_cas_fileName))._operator_concat (GGS_string (true, "' is already declared as compiled")) COMMA_SOURCE_FILE_AT_LINE (134)) ;
          }
  ...
  if ((var_cas_handCodedFilesDir.reader_directoryExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (156))).isBuiltAndTrue ()) {
    ...
    var_cas_actualHandCodedFileList = var_cas_handCodedFilesDir.reader_regularFilesWithExtensions (_inLexique, GGS_bool (true, true), var_cas_extensionList COMMA_SOURCE_FILE_AT_LINE (160)) ;
    {
      GGS_stringlist::cEnumerator enumerator_6878 (var_cas_actualHandCodedFileList, true) ;
      const GGS_stringlist::cElement * operand_6878 = NULL ;
      while (((operand_6878 = enumerator_6878.nextObject ()))) {
        macroValidPointer (operand_6878) ;
        var_cas_externSourceFileList.writeString ("SOURCES += ") ;
        var_cas_externSourceFileList._dotAssign_operation (operand_6878->mValue.reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (162))) ;
        var_cas_externSourceFileList.writeString ("\n") ;
        GGS_string var_cas_path ;
        var_cas_path = operand_6878->mValue.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (163)) ;
        if (((var_cas_path.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (164)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
  ...
  {
    GGS_stringset::cEnumerator enumerator_7345 (var_cas_handCodedSourcesSubPathSet, true) ;
    while (enumerator_7345.hc ()) {
      var_cas_handCodedSubPathesString.writeString ("SOURCES_DIR += ../hand_coded_sources") ;
      var_cas_handCodedSubPathesString._dotAssign_operation (enumerator_7345._key (HERE)) ;
      var_cas_handCodedSubPathesString.writeString ("\n") ;
      enumerator_7345.next () ;
    }
  }
  ...
  var_cas_fileListPath = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (182)))._operator_concat (GGS_string (true, "/GALGAS_OUTPUT/file_list.mke")) ;
  const GGS_string _temp_7829 = var_cas_newFileListContents ;
  if (_temp_7829._isBuilt ()) {
    _temp_7829 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_fileListPath COMMA_SOURCE_FILE_AT_LINE (183)) ;
  }
  GGS_string var_cas_oldCommonFile ;
  var_cas_oldCommonFile = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (185)).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (185)))._operator_concat (GGS_string (true, "/common_files_for_make/makefile.mke")) ;
  if (((var_cas_oldCommonFile.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (186)))._operator_and ((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
    ...
    var_cas_projectDir = GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (188)).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (188)) ;
    GGS_stringlist  var_cas_projectDirectories ;
    var_cas_projectDirectories = var_cas_projectDir.reader_directories (_inLexique, GGS_bool (true, false) COMMA_SOURCE_FILE_AT_LINE (189)) ;
    GGS_bool var_cas_ok ;
    var_cas_ok = GGS_bool (true, true) ;
    {
      GGS_stringlist::cEnumerator enumerator_8444 (var_cas_projectDirectories, true) ;
      const GGS_stringlist::cElement * operand_8444 = NULL ;
      while (((operand_8444 = enumerator_8444.nextObject ()))) {
        macroValidPointer (operand_8444) ;
        if ((((operand_8444->mValue)._operator_isNotEqual (GGS_string (true, "common_files_for_make")))._operator_and ((operand_8444->mValue)._operator_isNotEqual (GGS_string (true, "makefile_macosx_universal")))).isBuiltAndTrue ()) {
          GGS_string var_cas_fullDirPath ;
          var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_8444->mValue))._operator_concat (GGS_string (true, "/")) ;
          GGS_string var_cas_makefilePath ;
          var_cas_makefilePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile")) ;
          if ((var_cas_makefilePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (196))).isBuiltAndTrue ()) {
            GGS_stringlist  var_cas_c ;
            var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefilePath COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string (true, "include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (197)) ;
            if (((var_cas_c.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (198)))._operator_isEqual (GGS_uint (true, 2U))).isBuiltAndTrue ()) {
          ...
          if ((var_cas_makefile64Path.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (207))).isBuiltAndTrue ()) {
            GGS_stringlist  var_cas_c ;
            var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefile64Path COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string (true, "include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (208)) ;
            if (((var_cas_c.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (209)))._operator_isEqual (GGS_uint (true, 2U))).isBuiltAndTrue ()) {
          ...
          if ((var_cas_makefileMkePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (218))).isBuiltAndTrue ()) {
            GGS_stringlist  var_cas_c ;
            var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefileMkePath COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string (true, "include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (219)) ;
            if (((var_cas_c.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (220)))._operator_isEqual (GGS_uint (true, 2U))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      GGS_string var_cas_projectDir ;
      var_cas_projectDir = GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (231)).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ;
      GGS_stringlist  var_cas_projectDirectories ;
      var_cas_projectDirectories = var_cas_projectDir.reader_directories (_inLexique, GGS_bool (true, false) COMMA_SOURCE_FILE_AT_LINE (232)) ;
      {
        GGS_stringlist::cEnumerator enumerator_10594 (var_cas_projectDirectories, true) ;
        const GGS_stringlist::cElement * operand_10594 = NULL ;
        while (((operand_10594 = enumerator_10594.nextObject ()))) {
          macroValidPointer (operand_10594) ;
          if ((((operand_10594->mValue)._operator_isNotEqual (GGS_string (true, "common_files_for_make")))._operator_and ((operand_10594->mValue)._operator_isNotEqual (GGS_string (true, "makefile_macosx_universal")))).isBuiltAndTrue ()) {
            GGS_string var_cas_fullDirPath ;
            var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_10594->mValue))._operator_concat (GGS_string (true, "/")) ;
            GGS_string var_cas_makefilePath ;
            var_cas_makefilePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile")) ;
            if ((var_cas_makefilePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (238))).isBuiltAndTrue ()) {
              ...
              GGS_stringlist  var_cas_c ;
              var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefilePath COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string (true, "include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (240)) ;
              ...
              const GGS_string _temp_11285 = var_cas_newContents ;
              if (_temp_11285._isBuilt ()) {
                _temp_11285 (HERE)->method_writeToFile (_inLexique, var_cas_makefilePath COMMA_SOURCE_FILE_AT_LINE (242)) ;
              }
            }
            GGS_string var_cas_makefile64Path ;
            var_cas_makefile64Path = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile64")) ;
            if ((var_cas_makefile64Path.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (246))).isBuiltAndTrue ()) {
              ...
              GGS_stringlist  var_cas_c ;
              var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefile64Path COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string (true, "include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (248)) ;
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string (true, "include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
              const GGS_string _temp_11855 = var_cas_newContents ;
              if (_temp_11855._isBuilt ()) {
                _temp_11855 (HERE)->method_writeToFile (_inLexique, var_cas_makefile64Path COMMA_SOURCE_FILE_AT_LINE (250)) ;
              }
            }
            GGS_string var_cas_makefileMkePath ;
            var_cas_makefileMkePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile.mke")) ;
            if ((var_cas_makefileMkePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (254))).isBuiltAndTrue ()) {
              ...
              GGS_stringlist  var_cas_c ;
              var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefileMkePath COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string (true, "include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (256)) ;
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string (true, "include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
              const GGS_string _temp_12435 = var_cas_newContents ;
              if (_temp_12435._isBuilt ()) {
                _temp_12435 (HERE)->method_writeToFile (_inLexique, var_cas_makefileMkePath COMMA_SOURCE_FILE_AT_LINE (258)) ;
              }
            }
          }
        }
      ...
      var_cas_oldDir = var_cas_oldCommonFile.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (263)) ;
      ...
      GGS_string::class_method_removeDirectoryRecursively (_inLexique, var_cas_oldDir COMMA_SOURCE_FILE_AT_LINE (265)) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_107_4_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_107_4_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_107_4_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_107_4_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_107_4_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  { bool syntaxRepeat_0 = true ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_369_4_ (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (381)))).isBuiltAndTrue ()) {
    _inLexique.printMessage (((GGS_string (true, "------ Compile file '"))._operator_concat (var_cas_fileName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (382))))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (382)) ;
  }
  galgas_LL1_grammar::_performSourceFileParsing_compileFile (_inLexique,
                                  NULL,
                                  var_cas_fileName
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_369_4_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_369_4_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_369_4_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_369_4_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
                                GGS_stringset  &/* var_cas_ioImportedSemanticsComponentNameSet */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_369_4_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_428_4_ (galgas_scanner & _inLexique,
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_428_4_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_443_4_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext) {
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_443_4_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_460_4_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_460_4_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_479_4_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_479_4_parse (galgas_scanner & /* _inLexique */) {
}
