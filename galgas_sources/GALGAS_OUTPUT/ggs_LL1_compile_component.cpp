...
pr_galgas_component_ggs_LL1_compile_component_135_23_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_ggs_LL1_compile_component_0 (_inLexique)) {
        case 2 : {
          ...
          if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (193))))._operator_and ((var_cas_sourceFileKind)._operator_isNotEqual (GGS_sourceFileKind::constructor_externSourceFile (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_makefileFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (210)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_8309 (var_cas_makefileFiles, true) ;
      const GGS_stringlist::cElement * operand_8309 = NULL ;
      while (((operand_8309 = enumerator_8309.nextObject ()))) {
        macroValidPointer (operand_8309) ;
        GGS_string var_cas_fullPath ;
        GGS_sourceFileKind var_cas_sourceKind ;
        const GGS_sourceFileMap  _temp_8403 = var_cas_sourceFileMap ;
        if (_temp_8403._isBuilt ()) {
          _temp_8403 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_8309->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (218)) ;
        }
    ...
    {
      GGS_stringset::cEnumerator enumerator_9142 (var_cas_pathSet, true) ;
      while (enumerator_9142.hc ()) {
        var_cas_pathesString._dotAssign_operation (enumerator_9142._key (HERE)) ;
        enumerator_9142.next () ;
      }
    }
    ...
    const GGS_string _temp_9556 = var_cas_newFileListContents ;
    if (_temp_9556._isBuilt ()) {
      _temp_9556 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_fileListPath COMMA_SOURCE_FILE_AT_LINE (241)) ;
    }
  }
  ...
  if (((var_cas_oldCommonFile.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (245)))._operator_and ((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_10168 (var_cas_projectDirectories, true) ;
      const GGS_stringlist::cElement * operand_10168 = NULL ;
      while (((operand_10168 = enumerator_10168.nextObject ()))) {
        macroValidPointer (operand_10168) ;
        if ((((operand_10168->mValue)._operator_isNotEqual (GGS_string (true, "common_files_for_make")))._operator_and ((operand_10168->mValue)._operator_isNotEqual (GGS_string (true, "makefile_macosx_universal")))).isBuiltAndTrue ()) {
          GGS_string var_cas_fullDirPath ;
          var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_10168->mValue))._operator_concat (GGS_string (true, "/")) ;
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_12318 (var_cas_projectDirectories, true) ;
        const GGS_stringlist::cElement * operand_12318 = NULL ;
        while (((operand_12318 = enumerator_12318.nextObject ()))) {
          macroValidPointer (operand_12318) ;
          if ((((operand_12318->mValue)._operator_isNotEqual (GGS_string (true, "common_files_for_make")))._operator_and ((operand_12318->mValue)._operator_isNotEqual (GGS_string (true, "makefile_macosx_universal")))).isBuiltAndTrue ()) {
            GGS_string var_cas_fullDirPath ;
            var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_12318->mValue))._operator_concat (GGS_string (true, "/")) ;
            GGS_string var_cas_makefilePath ;
            var_cas_makefilePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile")) ;
            if ((var_cas_makefilePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (297))).isBuiltAndTrue ()) {
              ...
              const GGS_string _temp_13002 = var_cas_newContents ;
              if (_temp_13002._isBuilt ()) {
                _temp_13002 (HERE)->method_writeToFile (_inLexique, var_cas_makefilePath COMMA_SOURCE_FILE_AT_LINE (301)) ;
              }
            }
            GGS_string var_cas_makefile64Path ;
            var_cas_makefile64Path = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile64")) ;
            if ((var_cas_makefile64Path.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (305))).isBuiltAndTrue ()) {
              ...
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string (true, "include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
              const GGS_string _temp_13572 = var_cas_newContents ;
              if (_temp_13572._isBuilt ()) {
                _temp_13572 (HERE)->method_writeToFile (_inLexique, var_cas_makefile64Path COMMA_SOURCE_FILE_AT_LINE (309)) ;
              }
            }
            GGS_string var_cas_makefileMkePath ;
            var_cas_makefileMkePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile.mke")) ;
            if ((var_cas_makefileMkePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (313))).isBuiltAndTrue ()) {
              ...
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string (true, "include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
              const GGS_string _temp_14152 = var_cas_newContents ;
              if (_temp_14152._isBuilt ()) {
                _temp_14152 (HERE)->method_writeToFile (_inLexique, var_cas_makefileMkePath COMMA_SOURCE_FILE_AT_LINE (317)) ;
              }
            }
          }
        }
  ...
  if ((((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))._operator_and (GGS_bool (true, _inLexique.boolOptionValueFromKeys ("galgas_cli_options", "generate_xcode_project" COMMA_SOURCE_FILE_AT_LINE (331))))).isBuiltAndTrue ()) {
    GGS_string var_cas_XcodeProjectDir ;
    var_cas_XcodeProjectDir = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (332)).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (332)))._operator_concat (GGS_string (true, "/project_xcode")) ;
    GGS_stringlist  var_cas_iconFiles ;
    var_cas_iconFiles = var_cas_XcodeProjectDir.reader_regularFilesWithExtensions (_inLexique, GGS_bool (true, false), GGS_stringlist ::constructor_listWithValue (GGS_string (true, "icns")) COMMA_SOURCE_FILE_AT_LINE (334)) ;
    GGS_stringlist  var_cas_xcodeProjects ;
    var_cas_xcodeProjects = var_cas_XcodeProjectDir.reader_directoriesWithExtensions (_inLexique, GGS_bool (true, false), GGS_stringlist ::constructor_listWithValue (GGS_string (true, "xcodeproj")) COMMA_SOURCE_FILE_AT_LINE (335)) ;
    if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (337)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    }else if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (339)))._operator_strictSup (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
    ...
    }else if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (341)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
      GGS_string var_cas_name ;
      const GGS_stringlist  _temp_15614 = var_cas_xcodeProjects ;
      if (_temp_15614._isBuilt ()) {
        _temp_15614 (HERE)->method_first (_inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (342)) ;
      }
      ...
      var_cas_xcodeFiles = var_cas_targetFileListMap.reader_listForKey (_inLexique, GGS_string (true, "xcode") COMMA_SOURCE_FILE_AT_LINE (352)) ;
      {
        GGS_stringlist::cEnumerator enumerator_16176 (var_cas_xcodeFiles, true) ;
        const GGS_stringlist::cElement * operand_16176 = NULL ;
        while (((operand_16176 = enumerator_16176.nextObject ()))) {
          macroValidPointer (operand_16176) ;
          GGS_string var_cas_fullPath ;
          GGS_sourceFileKind var_cas_sourceKind ;
          const GGS_sourceFileMap  _temp_16276 = var_cas_sourceFileMap ;
          if (_temp_16276._isBuilt ()) {
            _temp_16276 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_16176->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (356)) ;
          }
          ...
          case GGS_sourceFileKind::enum_lexiqueSourceFile:
            {
            var_cas_scannerSourceSet._addAssign_operation (operand_16176->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_guiSourceFile:
            {
            var_cas_guiSourceSet._addAssign_operation (operand_16176->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_optionSourceFile:
            {
            var_cas_optionSourceSet._addAssign_operation (operand_16176->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_syntaxSourceFile:
            {
            var_cas_syntaxSourceSet._addAssign_operation (operand_16176->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_semanticsSourceFile:
            {
            var_cas_semanticsSourceSet._addAssign_operation (operand_16176->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_grammarSourceFile:
            {
            var_cas_grammarSourceSet._addAssign_operation (operand_16176->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_programSourceFile:
            {
            var_cas_programSourceSet._addAssign_operation (operand_16176->mValue) ;
            }
            break ;
      ...
      ::routine_generateXcodeProject (_inLexique,  var_cas_externSourceSet,  var_cas_guiSourceSet,  var_cas_scannerSourceSet,  var_cas_optionSourceSet,  var_cas_semanticsSourceSet,  var_cas_syntaxSourceSet,  var_cas_grammarSourceSet,  var_cas_programSourceSet,  var_cas_name.reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (385)),  var_cas_fullXcodePath.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (386)),  var_cas_iconFiles COMMA_SOURCE_FILE_AT_LINE (376)) ;
    }
  }
}
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_594_23_ (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (606)))).isBuiltAndTrue ()) {
    _inLexique.printMessage (((GGS_string (true, "------ Compile file '"))._operator_concat (var_cas_fileName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (607))))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (607)) ;
  }
  galgas_LL1_grammar::_performSourceFileParsing_compileFile (_inLexique,
                                  NULL,
                                  var_cas_fileName
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_594_23_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_594_23_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_594_23_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_594_23_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
                                GGS_stringset  &/* var_cas_ioImportedSemanticsComponentNameSet */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_594_23_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_653_34_ (galgas_scanner & _inLexique,
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_653_34_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_668_33_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext) {
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_668_33_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_685_44_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_685_44_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_704_43_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_704_43_parse (galgas_scanner & /* _inLexique */) {
}
