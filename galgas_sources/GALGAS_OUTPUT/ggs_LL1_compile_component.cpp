...
//                    december 14th, 2009, at 18h42'50"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
const char * gWrapperFileContent_0_EXfileListTemplateFileWrapper = // 1571 bytes
  "#---------------------------------------------------------------*\n"
  "\n"
  "#--- Lib PM directory\n"
...
pr_galgas_component_ggs_LL1_compile_component_141_23_ (galgas_scanner & inLexique,
    ...
    while (syntaxRepeat_0) {
      switch (select_ggs_LL1_compile_component_0 (inLexique)) {
        case 2 : {
          ...
          GGS_string var_cas_baseName = var_cas_fileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (188)).reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
          ...
          const GGS_bool cond_8618 = (gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value ()).operator_and ((var_cas_sourceFileKind).operator_isNotEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE))) ;
          if (cond_8618.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_9199 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_optionSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gOption"))) ;
          if (cond_9199.isBuiltAndTrue ()) {
          ...
          }else if (cond_9199.isBuiltAndFalse ()) {
            const GGS_bool cond_9751 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_lexiqueSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gLexique"))) ;
            if (cond_9751.isBuiltAndTrue ()) {
              GGS_string var_cas_s2 = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/GALGAS_OUTPUT")) ;
              GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ...
            }else if (cond_9751.isBuiltAndFalse ()) {
              const GGS_bool cond_10476 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_guiSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gGui"))) ;
              if (cond_10476.isBuiltAndTrue ()) {
                GGS_string var_cas_s2 = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/GALGAS_OUTPUT")) ;
                GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
              ...
              }else if (cond_10476.isBuiltAndFalse ()) {
                const GGS_bool cond_11335 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_grammarSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gGrammar"))) ;
                if (cond_11335.isBuiltAndTrue ()) {
                  ...
                  ::routine_compileGrammarComponent (inLexique,  GGS_lstring ::constructor_new (inLexique, var_cas_absoluteFilePath, var_cas_fileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (249)) COMMA_HERE),  var_cas_s2,  GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (),  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (248)) ;
                }else if (cond_11335.isBuiltAndFalse ()) {
                  const GGS_bool cond_11510 = (var_cas_sourceFileKind).operator_isNotEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
                  if (cond_11510.isBuiltAndTrue ()) {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  const GGS_bool cond_11652 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
  ...
  const GGS_bool cond_13304 = (var_cas_makefileFiles.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_13304.isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_12023 (var_cas_makefileFiles, true) ;
      const GGS_stringlist::cElement * operand_12023 = NULL ;
      while (((operand_12023 = enumerator_12023.nextObject ()))) {
        macroValidPointer (operand_12023) ;
        GGS_string var_cas_fullPath ;
        GGS_EXsourceFileKind var_cas_sourceKind ;
        const GGS_EXsourceFileMap  temp_12119 = var_cas_sourceFileMap ;
        if (temp_12119.isBuilt ()) {
          temp_12119 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_12023->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (275)) ;
        }
        GGS_string var_cas_filePath = var_cas_fullPath.reader_stringByDeletingLastPathComponent () ;
        const GGS_bool cond_12656 = (var_cas_sourceKind).operator_isEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
        if (cond_12656.isBuiltAndTrue ()) {
          const GGS_bool cond_12440 = (var_cas_filePath.reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
          if (cond_12440.isBuiltAndTrue ()) {
            var_cas_pathSet.addAssign_operation (((GGS_string ("SOURCES_DIR += ")).operator_concat (var_cas_filePath)).operator_concat (GGS_string ("\n"))) ;
          }else if (cond_12440.isBuiltAndFalse ()) {
            const GGS_bool cond_12554 = (var_cas_filePath).operator_isNotEqual (GGS_string ("")) ;
            if (cond_12554.isBuiltAndTrue ()) {
    ...
    {
      GGS_stringset::cEnumerator enumerator_12860 (var_cas_pathSet, true) ;
      while (enumerator_12860.hasCurrentObject ()) {
        var_cas_pathesString.dotAssign_operation (enumerator_12860._key (HERE)) ;
        enumerator_12860.next () ;
      }
    }
    ...
    GGS_bool automatic_var_13296_0 ;
    const GGS_string temp_13278 = var_cas_newFileListContents ;
    if (temp_13278.isBuilt ()) {
      temp_13278 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_13296_0 COMMA_SOURCE_FILE_AT_LINE (298)) ;
    }
  }
  const GGS_bool cond_18172 = (gOption_galgas_5F_cli_5F_options_doNotGenerateXcodeProject.reader_value ()).operator_not () ;
  if (cond_18172.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_18161 = (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and ((var_cas_xcode_tool_files.reader_length ()).operator_strictSup (GGS_uint (0U)))).operator_and ((var_cas_xcode_app_files.reader_length ()).operator_strictSup (GGS_uint (0U))) ;
    if (cond_18161.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_14304 = (var_cas_xcodeProjects.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
      if (cond_14304.isBuiltAndTrue ()) {
      }else if (cond_14304.isBuiltAndFalse ()) {
        const GGS_bool cond_14479 = (var_cas_xcodeProjects.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
        ...
        }else if (cond_14479.isBuiltAndFalse ()) {
          const GGS_bool cond_18150 = (var_cas_xcodeProjects.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
          if (cond_18150.isBuiltAndTrue ()) {
            GGS_string var_cas_name ;
            const GGS_stringlist  temp_14554 = var_cas_xcodeProjects ;
            if (temp_14554.isBuilt ()) {
              temp_14554 (HERE)->method_first (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (315)) ;
            }
            ...
            {
              GGS_stringlist::cEnumerator enumerator_15280 (var_cas_xcode_tool_files, true) ;
              const GGS_stringlist::cElement * operand_15280 = NULL ;
              while (((operand_15280 = enumerator_15280.nextObject ()))) {
                macroValidPointer (operand_15280) ;
                GGS_string var_cas_fullPath ;
                GGS_EXsourceFileKind var_cas_sourceKind ;
                const GGS_EXsourceFileMap  temp_15382 = var_cas_sourceFileMap ;
                if (temp_15382.isBuilt ()) {
                  temp_15382 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_15280->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (330)) ;
                }
                ...
                case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                  {
                  var_cas_scannerSourceSet_tool.addAssign_operation (operand_15280->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_guiSourceFile:
                  {
                  var_cas_guiSourceSet_tool.addAssign_operation (operand_15280->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_optionSourceFile:
                  {
                  var_cas_optionSourceSet_tool.addAssign_operation (operand_15280->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                  {
                  var_cas_syntaxSourceSet_tool.addAssign_operation (operand_15280->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                  {
                  var_cas_semanticsSourceSet_tool.addAssign_operation (operand_15280->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_grammarSourceFile:
                  {
                  var_cas_grammarSourceSet_tool.addAssign_operation (operand_15280->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_programSourceFile:
                  {
                  var_cas_programSourceSet_tool.addAssign_operation (operand_15280->mValue) ;
                  }
                  break ;
            ...
            {
              GGS_stringlist::cEnumerator enumerator_16554 (var_cas_xcode_app_files, true) ;
              const GGS_stringlist::cElement * operand_16554 = NULL ;
              while (((operand_16554 = enumerator_16554.nextObject ()))) {
                macroValidPointer (operand_16554) ;
                GGS_string var_cas_fullPath ;
                GGS_EXsourceFileKind var_cas_sourceKind ;
                const GGS_EXsourceFileMap  temp_16656 = var_cas_sourceFileMap ;
                if (temp_16656.isBuilt ()) {
                  temp_16656 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_16554->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (361)) ;
                }
                switch (var_cas_sourceKind.enumValue ()) {
                case GGS_EXsourceFileKind::enum_externSourceFile:
                  {
                ...
                case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                  {
                  var_cas_scannerSourceSet_app.addAssign_operation (operand_16554->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_guiSourceFile:
                  {
                  var_cas_guiSourceSet_app.addAssign_operation (operand_16554->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_optionSourceFile:
                  {
                  var_cas_optionSourceSet_app.addAssign_operation (operand_16554->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                  {
                  var_cas_syntaxSourceSet_app.addAssign_operation (operand_16554->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                  {
                  var_cas_semanticsSourceSet_app.addAssign_operation (operand_16554->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_grammarSourceFile:
                  {
                  var_cas_grammarSourceSet_app.addAssign_operation (operand_16554->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_programSourceFile:
                  {
                  var_cas_programSourceSet_app.addAssign_operation (operand_16554->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::kNotBuilt:
                  break ;
...
pr_galgas_component_ggs_LL1_compile_component_620_23_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  const GGS_bool cond_22234 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
  if (cond_22234.isBuiltAndTrue ()) {
