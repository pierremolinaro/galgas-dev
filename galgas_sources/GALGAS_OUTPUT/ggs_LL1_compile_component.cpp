...
pr_galgas_component_ggs_LL1_compile_component_135_23_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_makefileFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (218)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_8949 (var_cas_makefileFiles, true) ;
      ...
      while (((operand_8949 = enumerator_8949.nextObject ()))) {
        ...
        const GGS_EXsourceFileMap  _temp_9045 = var_cas_sourceFileMap ;
        if (_temp_9045._isBuilt ()) {
          _temp_9045 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_8949->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (226)) ;
        }
    ...
    {
      GGS_stringset::cEnumerator enumerator_9786 (var_cas_pathSet, true) ;
      while (enumerator_9786.hc ()) {
        var_cas_pathesString._dotAssign_operation (enumerator_9786._key (HERE)) ;
        enumerator_9786.next () ;
      }
    }
    ...
    const GGS_string _temp_10204 = var_cas_newFileListContents ;
    if (_temp_10204._isBuilt ()) {
      _temp_10204 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (249)) ;
    }
  }
  ...
  if (((var_cas_oldCommonFile.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (253)))._operator_and ((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_10819 (var_cas_projectDirectories, true) ;
      const GGS_stringlist::cElement * operand_10819 = NULL ;
      while (((operand_10819 = enumerator_10819.nextObject ()))) {
        macroValidPointer (operand_10819) ;
        if ((((operand_10819->mValue)._operator_isNotEqual (GGS_string (true, "common_files_for_make")))._operator_and ((operand_10819->mValue)._operator_isNotEqual (GGS_string (true, "makefile_macosx_universal")))).isBuiltAndTrue ()) {
          GGS_string var_cas_fullDirPath ;
          var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_10819->mValue))._operator_concat (GGS_string (true, "/")) ;
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_12969 (var_cas_projectDirectories, true) ;
        const GGS_stringlist::cElement * operand_12969 = NULL ;
        while (((operand_12969 = enumerator_12969.nextObject ()))) {
          macroValidPointer (operand_12969) ;
          if ((((operand_12969->mValue)._operator_isNotEqual (GGS_string (true, "common_files_for_make")))._operator_and ((operand_12969->mValue)._operator_isNotEqual (GGS_string (true, "makefile_macosx_universal")))).isBuiltAndTrue ()) {
            GGS_string var_cas_fullDirPath ;
            var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_12969->mValue))._operator_concat (GGS_string (true, "/")) ;
            GGS_string var_cas_makefilePath ;
            var_cas_makefilePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile")) ;
            if ((var_cas_makefilePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (305))).isBuiltAndTrue ()) {
              ...
              const GGS_string _temp_13653 = var_cas_newContents ;
              if (_temp_13653._isBuilt ()) {
                _temp_13653 (HERE)->method_writeToFile (_inLexique, var_cas_makefilePath COMMA_SOURCE_FILE_AT_LINE (309)) ;
              }
            }
            GGS_string var_cas_makefile64Path ;
            var_cas_makefile64Path = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile64")) ;
            if ((var_cas_makefile64Path.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (313))).isBuiltAndTrue ()) {
              ...
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string (true, "include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
              const GGS_string _temp_14223 = var_cas_newContents ;
              if (_temp_14223._isBuilt ()) {
                _temp_14223 (HERE)->method_writeToFile (_inLexique, var_cas_makefile64Path COMMA_SOURCE_FILE_AT_LINE (317)) ;
              }
            }
            GGS_string var_cas_makefileMkePath ;
            var_cas_makefileMkePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile.mke")) ;
            if ((var_cas_makefileMkePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (321))).isBuiltAndTrue ()) {
              ...
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string (true, "include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
              const GGS_string _temp_14803 = var_cas_newContents ;
              if (_temp_14803._isBuilt ()) {
                _temp_14803 (HERE)->method_writeToFile (_inLexique, var_cas_makefileMkePath COMMA_SOURCE_FILE_AT_LINE (325)) ;
              }
            }
          }
        }
  ...
  if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("galgas_cli_options", "doNotGenerateXcodeProject" COMMA_SOURCE_FILE_AT_LINE (339))))._operator_not ()).isBuiltAndTrue ()) {
    ...
    if (((((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_xcode_tool_files.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (342)))._operator_strictSup (GGS_uint (true, 0U))))._operator_and ((var_cas_xcode_app_files.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (342)))._operator_strictSup (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
      ...
      if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (348)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        ...
        const GGS_stringlist  _temp_16508 = var_cas_xcodeProjects ;
        if (_temp_16508._isBuilt ()) {
          _temp_16508 (HERE)->method_first (_inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (353)) ;
        }
        ...
        {
          GGS_stringlist::cEnumerator enumerator_16744 (var_cas_xcode_tool_files, true) ;
          const GGS_stringlist::cElement * operand_16744 = NULL ;
          while (((operand_16744 = enumerator_16744.nextObject ()))) {
            macroValidPointer (operand_16744) ;
            var_cas_intermediateString._dotAssign_operation (operand_16744->mValue) ;
            var_cas_intermediateString.appendCstring ("\n") ;
          }
        }
        var_cas_intermediateString.appendCstring ("::\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_16880 (var_cas_xcode_app_files, true) ;
          const GGS_stringlist::cElement * operand_16880 = NULL ;
          while (((operand_16880 = enumerator_16880.nextObject ()))) {
            macroValidPointer (operand_16880) ;
            var_cas_intermediateString._dotAssign_operation (operand_16880->mValue) ;
            var_cas_intermediateString.appendCstring ("\n") ;
          }
        }
        GGS_stringlist  var_cas_cpp_and_h_fileList ;
        ::routine_getGALGAS_source_file_list (_inLexique,  var_cas_cpp_and_h_fileList COMMA_SOURCE_FILE_AT_LINE (365)) ;
        var_cas_intermediateString.appendCstring ("::\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_17114 (var_cas_cpp_and_h_fileList, true) ;
          const GGS_stringlist::cElement * operand_17114 = NULL ;
          while (((operand_17114 = enumerator_17114.nextObject ()))) {
            macroValidPointer (operand_17114) ;
            var_cas_intermediateString._dotAssign_operation (operand_17114->mValue) ;
            var_cas_intermediateString.appendCstring ("\n") ;
          }
        }
        GGS_bool var_cas_written ;
        var_cas_written = GGS_bool (true, false) ;
        GGS_string var_cas_intermediateFilePath ;
        var_cas_intermediateFilePath = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (372)))._operator_concat (GGS_string (true, "/GALGAS_OUTPUT/file_list_for_xcode_project.txt")) ;
        if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          const GGS_string _temp_17509 = var_cas_intermediateString ;
          if (_temp_17509._isBuilt ()) {
            _temp_17509 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_intermediateFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (374)) ;
          }
        }else{
          GGS_string::class_method_deleteFileIfExists (_inLexique, var_cas_intermediateFilePath COMMA_SOURCE_FILE_AT_LINE (376)) ;
        }
        if (((var_cas_written)._operator_or ((var_cas_fullXcodePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (379)))._operator_not ())).isBuiltAndTrue ()) {
          ...
          {
            GGS_stringlist::cEnumerator enumerator_18254 (var_cas_xcode_tool_files, true) ;
            const GGS_stringlist::cElement * operand_18254 = NULL ;
            while (((operand_18254 = enumerator_18254.nextObject ()))) {
              macroValidPointer (operand_18254) ;
              GGS_string var_cas_fullPath ;
              GGS_EXsourceFileKind var_cas_sourceKind ;
              const GGS_EXsourceFileMap  _temp_18362 = var_cas_sourceFileMap ;
              if (_temp_18362._isBuilt ()) {
                _temp_18362 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_18254->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (391)) ;
              }
              ...
              case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                {
                var_cas_scannerSourceSet_tool._addAssign_operation (operand_18254->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_guiSourceFile:
                {
                var_cas_guiSourceSet_tool._addAssign_operation (operand_18254->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_optionSourceFile:
                {
                var_cas_optionSourceSet_tool._addAssign_operation (operand_18254->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                {
                var_cas_syntaxSourceSet_tool._addAssign_operation (operand_18254->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                {
                var_cas_semanticsSourceSet_tool._addAssign_operation (operand_18254->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_grammarSourceFile:
                {
                var_cas_grammarSourceSet_tool._addAssign_operation (operand_18254->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_programSourceFile:
                {
                var_cas_programSourceSet_tool._addAssign_operation (operand_18254->mValue) ;
                }
                break ;
          ...
          {
            GGS_stringlist::cEnumerator enumerator_19590 (var_cas_xcode_app_files, true) ;
            const GGS_stringlist::cElement * operand_19590 = NULL ;
            while (((operand_19590 = enumerator_19590.nextObject ()))) {
              macroValidPointer (operand_19590) ;
              GGS_string var_cas_fullPath ;
              GGS_EXsourceFileKind var_cas_sourceKind ;
              const GGS_EXsourceFileMap  _temp_19698 = var_cas_sourceFileMap ;
              if (_temp_19698._isBuilt ()) {
                _temp_19698 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_19590->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (422)) ;
              }
              switch (var_cas_sourceKind.enumValue ()) {
              case GGS_EXsourceFileKind::enum_externSourceFile:
                {
              ...
              case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                {
                var_cas_scannerSourceSet_app._addAssign_operation (operand_19590->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_guiSourceFile:
                {
                var_cas_guiSourceSet_app._addAssign_operation (operand_19590->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_optionSourceFile:
                {
                var_cas_optionSourceSet_app._addAssign_operation (operand_19590->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                {
                var_cas_syntaxSourceSet_app._addAssign_operation (operand_19590->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                {
                var_cas_semanticsSourceSet_app._addAssign_operation (operand_19590->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_grammarSourceFile:
                {
                var_cas_grammarSourceSet_app._addAssign_operation (operand_19590->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_programSourceFile:
                {
                var_cas_programSourceSet_app._addAssign_operation (operand_19590->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::kNotBuilt:
                break ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_681_23_ (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (693)))).isBuiltAndTrue ()) {
    _inLexique.printMessage (((GGS_string (true, "------ Compile file '"))._operator_concat (var_cas_fileName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (694))))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (694)) ;
  }
  const GGS_string _depExtension = GGS_string (true, "galgas-dep") ;
  const GGS_string _depPath = GGS_string (true, "GALGAS_OUTPUT/DEPENDENCIES") ;
  if (_depExtension._isBuilt () && _depPath._isBuilt ()) {
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_681_23_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_681_23_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_681_23_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_681_23_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
                                GGS_stringset  &/* var_cas_ioImportedSemanticsComponentNameSet */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_681_23_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_740_34_ (galgas_scanner & _inLexique,
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_740_34_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_755_33_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext) {
  const GGS_string _depExtension = GGS_string (true, "") ;
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_755_33_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_772_44_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_772_44_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_791_43_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
  const GGS_string _depExtension = GGS_string (true, "") ;
  const GGS_string _depPath = GGS_string (true, "") ;
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_791_43_parse (galgas_scanner & /* _inLexique */) {
}
