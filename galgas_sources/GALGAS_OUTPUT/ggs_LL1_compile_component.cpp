...
pr_galgas_component_ggs_LL1_compile_component_135_23_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_makefileFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (210)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_8347 (var_cas_makefileFiles, true) ;
      const GGS_stringlist::cElement * operand_8347 = NULL ;
      while (((operand_8347 = enumerator_8347.nextObject ()))) {
        macroValidPointer (operand_8347) ;
        GGS_string var_cas_fullPath ;
        GGS_EXsourceFileKind var_cas_sourceKind ;
        const GGS_EXsourceFileMap  _temp_8443 = var_cas_sourceFileMap ;
        if (_temp_8443._isBuilt ()) {
          _temp_8443 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_8347->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (218)) ;
        }
    ...
    {
      GGS_stringset::cEnumerator enumerator_9184 (var_cas_pathSet, true) ;
      while (enumerator_9184.hc ()) {
        var_cas_pathesString._dotAssign_operation (enumerator_9184._key (HERE)) ;
        enumerator_9184.next () ;
      }
    }
    ...
    const GGS_string _temp_9602 = var_cas_newFileListContents ;
    if (_temp_9602._isBuilt ()) {
      _temp_9602 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (241)) ;
    }
  }
  ...
  if (((var_cas_oldCommonFile.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (245)))._operator_and ((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_10217 (var_cas_projectDirectories, true) ;
      const GGS_stringlist::cElement * operand_10217 = NULL ;
      while (((operand_10217 = enumerator_10217.nextObject ()))) {
        macroValidPointer (operand_10217) ;
        if ((((operand_10217->mValue)._operator_isNotEqual (GGS_string (true, "common_files_for_make")))._operator_and ((operand_10217->mValue)._operator_isNotEqual (GGS_string (true, "makefile_macosx_universal")))).isBuiltAndTrue ()) {
          GGS_string var_cas_fullDirPath ;
          var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_10217->mValue))._operator_concat (GGS_string (true, "/")) ;
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_12367 (var_cas_projectDirectories, true) ;
        const GGS_stringlist::cElement * operand_12367 = NULL ;
        while (((operand_12367 = enumerator_12367.nextObject ()))) {
          macroValidPointer (operand_12367) ;
          if ((((operand_12367->mValue)._operator_isNotEqual (GGS_string (true, "common_files_for_make")))._operator_and ((operand_12367->mValue)._operator_isNotEqual (GGS_string (true, "makefile_macosx_universal")))).isBuiltAndTrue ()) {
            GGS_string var_cas_fullDirPath ;
            var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_12367->mValue))._operator_concat (GGS_string (true, "/")) ;
            GGS_string var_cas_makefilePath ;
            var_cas_makefilePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile")) ;
            if ((var_cas_makefilePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (297))).isBuiltAndTrue ()) {
              ...
              const GGS_string _temp_13051 = var_cas_newContents ;
              if (_temp_13051._isBuilt ()) {
                _temp_13051 (HERE)->method_writeToFile (_inLexique, var_cas_makefilePath COMMA_SOURCE_FILE_AT_LINE (301)) ;
              }
            }
            GGS_string var_cas_makefile64Path ;
            var_cas_makefile64Path = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile64")) ;
            if ((var_cas_makefile64Path.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (305))).isBuiltAndTrue ()) {
              ...
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string (true, "include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
              const GGS_string _temp_13621 = var_cas_newContents ;
              if (_temp_13621._isBuilt ()) {
                _temp_13621 (HERE)->method_writeToFile (_inLexique, var_cas_makefile64Path COMMA_SOURCE_FILE_AT_LINE (309)) ;
              }
            }
            GGS_string var_cas_makefileMkePath ;
            var_cas_makefileMkePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile.mke")) ;
            if ((var_cas_makefileMkePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (313))).isBuiltAndTrue ()) {
              ...
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string (true, "include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
              const GGS_string _temp_14201 = var_cas_newContents ;
              if (_temp_14201._isBuilt ()) {
                _temp_14201 (HERE)->method_writeToFile (_inLexique, var_cas_makefileMkePath COMMA_SOURCE_FILE_AT_LINE (317)) ;
              }
            }
          }
        }
  ...
  if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("galgas_cli_options", "doNotGenerateXcodeProject" COMMA_SOURCE_FILE_AT_LINE (331))))._operator_not ()).isBuiltAndTrue ()) {
    ...
    if ((((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_xcodeFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (333)))._operator_strictSup (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
      ...
      if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (339)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        ...
        const GGS_stringlist  _temp_15776 = var_cas_xcodeProjects ;
        if (_temp_15776._isBuilt ()) {
          _temp_15776 (HERE)->method_first (_inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (344)) ;
        }
        ...
        {
          GGS_stringlist::cEnumerator enumerator_16377 (var_cas_xcodeFiles, true) ;
          const GGS_stringlist::cElement * operand_16377 = NULL ;
          while (((operand_16377 = enumerator_16377.nextObject ()))) {
            macroValidPointer (operand_16377) ;
            var_cas_intermediateString._dotAssign_operation (operand_16377->mValue) ;
        ...
        const GGS_string _temp_16723 = var_cas_intermediateString ;
        if (_temp_16723._isBuilt ()) {
          _temp_16723 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_intermediateFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (362)) ;
        }
        if ((var_cas_written).isBuiltAndTrue ()) {
          {
            GGS_stringlist::cEnumerator enumerator_16869 (var_cas_xcodeFiles, true) ;
            const GGS_stringlist::cElement * operand_16869 = NULL ;
            while (((operand_16869 = enumerator_16869.nextObject ()))) {
              macroValidPointer (operand_16869) ;
              GGS_string var_cas_fullPath ;
              GGS_EXsourceFileKind var_cas_sourceKind ;
              const GGS_EXsourceFileMap  _temp_16977 = var_cas_sourceFileMap ;
              if (_temp_16977._isBuilt ()) {
                _temp_16977 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_16869->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (368)) ;
              }
              ...
              case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                {
                var_cas_scannerSourceSet._addAssign_operation (operand_16869->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_guiSourceFile:
                {
                var_cas_guiSourceSet._addAssign_operation (operand_16869->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_optionSourceFile:
                {
                var_cas_optionSourceSet._addAssign_operation (operand_16869->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                {
                var_cas_syntaxSourceSet._addAssign_operation (operand_16869->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                {
                var_cas_semanticsSourceSet._addAssign_operation (operand_16869->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_grammarSourceFile:
                {
                var_cas_grammarSourceSet._addAssign_operation (operand_16869->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_programSourceFile:
                {
                var_cas_programSourceSet._addAssign_operation (operand_16869->mValue) ;
                }
                break ;
