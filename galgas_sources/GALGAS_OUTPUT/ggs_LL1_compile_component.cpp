...
pr_galgas_component_ggs_LL1_compile_component_137_23_ (galgas_scanner & inLexique,
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_ggs_LL1_compile_component_0 (inLexique)) {
        case 2 : {
          ...
          if (((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_optionSourceFile (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
            GGS_string var_cas_s ;
  ...
  if (((var_cas_makefileFiles.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (223))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_9306 (var_cas_makefileFiles, true) ;
      const GGS_stringlist::cElement * operand_9306 = NULL ;
      while (((operand_9306 = enumerator_9306.nextObject ()))) {
        macroValidPointer (operand_9306) ;
        GGS_string var_cas_fullPath ;
        GGS_EXsourceFileKind var_cas_sourceKind ;
        const GGS_EXsourceFileMap  _temp_9402 = var_cas_sourceFileMap ;
        if (_temp_9402.isBuilt ()) {
          _temp_9402 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_9306->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (231)) ;
        }
    ...
    {
      GGS_stringset::cEnumerator enumerator_10143 (var_cas_pathSet, true) ;
      while (enumerator_10143.hc ()) {
        var_cas_pathesString.dotAssign_operation (enumerator_10143._key (HERE)) ;
        enumerator_10143.next () ;
      }
    }
    ...
    const GGS_string _temp_10561 = var_cas_newFileListContents ;
    if (_temp_10561.isBuilt ()) {
      _temp_10561 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (254)) ;
    }
  }
  if (((GGS_bool (inLexique.boolOptionValueFromKeys ("galgas_cli_options", "doNotGenerateXcodeProject" COMMA_SOURCE_FILE_AT_LINE (344)))).operator_not ()).isBuiltAndTrue ()) {
    ...
    if (((((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and ((var_cas_xcode_tool_files.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (347))).operator_strictSup (GGS_uint (0U)))).operator_and ((var_cas_xcode_app_files.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (347))).operator_strictSup (GGS_uint (0U)))).isBuiltAndTrue ()) {
      ...
      if (((var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (353))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
        ...
        const GGS_stringlist  _temp_16952 = var_cas_xcodeProjects ;
        if (_temp_16952.isBuilt ()) {
          _temp_16952 (HERE)->method_first (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (358)) ;
        }
        ...
        {
          GGS_stringlist::cEnumerator enumerator_17678 (var_cas_xcode_tool_files, true) ;
          const GGS_stringlist::cElement * operand_17678 = NULL ;
          while (((operand_17678 = enumerator_17678.nextObject ()))) {
            macroValidPointer (operand_17678) ;
            GGS_string var_cas_fullPath ;
            GGS_EXsourceFileKind var_cas_sourceKind ;
            const GGS_EXsourceFileMap  _temp_17780 = var_cas_sourceFileMap ;
            if (_temp_17780.isBuilt ()) {
              _temp_17780 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_17678->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (373)) ;
            }
            ...
            case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
              {
              var_cas_scannerSourceSet_tool._addAssign_operation (operand_17678->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_guiSourceFile:
              {
              var_cas_guiSourceSet_tool._addAssign_operation (operand_17678->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_optionSourceFile:
              {
              var_cas_optionSourceSet_tool._addAssign_operation (operand_17678->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_syntaxSourceFile:
              {
              var_cas_syntaxSourceSet_tool._addAssign_operation (operand_17678->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_semanticsSourceFile:
              {
              var_cas_semanticsSourceSet_tool._addAssign_operation (operand_17678->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_grammarSourceFile:
              {
              var_cas_grammarSourceSet_tool._addAssign_operation (operand_17678->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_programSourceFile:
              {
              var_cas_programSourceSet_tool._addAssign_operation (operand_17678->mValue) ;
              }
              break ;
        ...
        {
          GGS_stringlist::cEnumerator enumerator_18952 (var_cas_xcode_app_files, true) ;
          const GGS_stringlist::cElement * operand_18952 = NULL ;
          while (((operand_18952 = enumerator_18952.nextObject ()))) {
            macroValidPointer (operand_18952) ;
            GGS_string var_cas_fullPath ;
            GGS_EXsourceFileKind var_cas_sourceKind ;
            const GGS_EXsourceFileMap  _temp_19054 = var_cas_sourceFileMap ;
            if (_temp_19054.isBuilt ()) {
              _temp_19054 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_18952->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (404)) ;
            }
            switch (var_cas_sourceKind.enumValue ()) {
            case GGS_EXsourceFileKind::enum_externSourceFile:
              {
            ...
            case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
              {
              var_cas_scannerSourceSet_app._addAssign_operation (operand_18952->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_guiSourceFile:
              {
              var_cas_guiSourceSet_app._addAssign_operation (operand_18952->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_optionSourceFile:
              {
              var_cas_optionSourceSet_app._addAssign_operation (operand_18952->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_syntaxSourceFile:
              {
              var_cas_syntaxSourceSet_app._addAssign_operation (operand_18952->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_semanticsSourceFile:
              {
              var_cas_semanticsSourceSet_app._addAssign_operation (operand_18952->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_grammarSourceFile:
              {
              var_cas_grammarSourceSet_app._addAssign_operation (operand_18952->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_programSourceFile:
              {
              var_cas_programSourceSet_app._addAssign_operation (operand_18952->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::kNotBuilt:
              break ;
