...
pr_galgas_component_ggs_LL1_compile_component_135_23_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_ggs_LL1_compile_component_0 (_inLexique)) {
        case 2 : {
              ...
              { bool syntaxRepeat_3 = true ;
                while (syntaxRepeat_3) {
                    ...
                    if ((((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (186)))._operator_isNotEqual (GGS_string (true, "makefile")))._operator_and ((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (186)))._operator_isNotEqual (GGS_string (true, "xcode")))).isBuiltAndTrue ()) {
                      var_cas_targetName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the traget name should be \"makefile\" or \"xcode\"") COMMA_SOURCE_FILE_AT_LINE (188)) ;
                    }
          ...
          if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (193)))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_makefileFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (210)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_8252 (var_cas_makefileFiles, true) ;
      const GGS_stringlist::cElement * operand_8252 = NULL ;
      while (((operand_8252 = enumerator_8252.nextObject ()))) {
        macroValidPointer (operand_8252) ;
        GGS_string var_cas_fullPath ;
        GGS_sourceFileKind var_cas_sourceKind ;
        const GGS_sourceFileMap  _temp_8346 = var_cas_sourceFileMap ;
        if (_temp_8346._isBuilt ()) {
          _temp_8346 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_8252->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (218)) ;
        }
    ...
    {
      GGS_stringset::cEnumerator enumerator_9085 (var_cas_pathSet, true) ;
      while (enumerator_9085.hc ()) {
        var_cas_pathesString._dotAssign_operation (enumerator_9085._key (HERE)) ;
        enumerator_9085.next () ;
      }
    }
    ...
    const GGS_string _temp_9499 = var_cas_newFileListContents ;
    if (_temp_9499._isBuilt ()) {
      _temp_9499 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_fileListPath COMMA_SOURCE_FILE_AT_LINE (241)) ;
    }
  }
  ...
  if (((var_cas_oldCommonFile.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (245)))._operator_and ((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_10111 (var_cas_projectDirectories, true) ;
      const GGS_stringlist::cElement * operand_10111 = NULL ;
      while (((operand_10111 = enumerator_10111.nextObject ()))) {
        macroValidPointer (operand_10111) ;
        if ((((operand_10111->mValue)._operator_isNotEqual (GGS_string (true, "common_files_for_make")))._operator_and ((operand_10111->mValue)._operator_isNotEqual (GGS_string (true, "makefile_macosx_universal")))).isBuiltAndTrue ()) {
          GGS_string var_cas_fullDirPath ;
          var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_10111->mValue))._operator_concat (GGS_string (true, "/")) ;
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_12261 (var_cas_projectDirectories, true) ;
        const GGS_stringlist::cElement * operand_12261 = NULL ;
        while (((operand_12261 = enumerator_12261.nextObject ()))) {
          macroValidPointer (operand_12261) ;
          if ((((operand_12261->mValue)._operator_isNotEqual (GGS_string (true, "common_files_for_make")))._operator_and ((operand_12261->mValue)._operator_isNotEqual (GGS_string (true, "makefile_macosx_universal")))).isBuiltAndTrue ()) {
            GGS_string var_cas_fullDirPath ;
            var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_12261->mValue))._operator_concat (GGS_string (true, "/")) ;
            GGS_string var_cas_makefilePath ;
            var_cas_makefilePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile")) ;
            if ((var_cas_makefilePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (297))).isBuiltAndTrue ()) {
              ...
              const GGS_string _temp_12945 = var_cas_newContents ;
              if (_temp_12945._isBuilt ()) {
                _temp_12945 (HERE)->method_writeToFile (_inLexique, var_cas_makefilePath COMMA_SOURCE_FILE_AT_LINE (301)) ;
              }
            }
            GGS_string var_cas_makefile64Path ;
            var_cas_makefile64Path = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile64")) ;
            if ((var_cas_makefile64Path.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (305))).isBuiltAndTrue ()) {
              ...
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string (true, "include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
              const GGS_string _temp_13515 = var_cas_newContents ;
              if (_temp_13515._isBuilt ()) {
                _temp_13515 (HERE)->method_writeToFile (_inLexique, var_cas_makefile64Path COMMA_SOURCE_FILE_AT_LINE (309)) ;
              }
            }
            GGS_string var_cas_makefileMkePath ;
            var_cas_makefileMkePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile.mke")) ;
            if ((var_cas_makefileMkePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (313))).isBuiltAndTrue ()) {
              ...
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string (true, "include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
              const GGS_string _temp_14095 = var_cas_newContents ;
              if (_temp_14095._isBuilt ()) {
                _temp_14095 (HERE)->method_writeToFile (_inLexique, var_cas_makefileMkePath COMMA_SOURCE_FILE_AT_LINE (317)) ;
              }
            }
          }
        }
  ...
  if ((((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))._operator_and (GGS_bool (true, _inLexique.boolOptionValueFromKeys ("galgas_cli_options", "generate_xcode_project" COMMA_SOURCE_FILE_AT_LINE (331))))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (337)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
      GGS_string var_cas_name ;
      const GGS_stringlist  _temp_15217 = var_cas_xcodeProjects ;
      if (_temp_15217._isBuilt ()) {
        _temp_15217 (HERE)->method_first (_inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (338)) ;
      }
      ...
      var_cas_xcodeFiles = var_cas_targetFileListMap.reader_listForKey (_inLexique, GGS_string (true, "xcode") COMMA_SOURCE_FILE_AT_LINE (348)) ;
      {
        GGS_stringlist::cEnumerator enumerator_15779 (var_cas_xcodeFiles, true) ;
        const GGS_stringlist::cElement * operand_15779 = NULL ;
        while (((operand_15779 = enumerator_15779.nextObject ()))) {
          macroValidPointer (operand_15779) ;
          GGS_string var_cas_fullPath ;
          GGS_sourceFileKind var_cas_sourceKind ;
          const GGS_sourceFileMap  _temp_15879 = var_cas_sourceFileMap ;
          if (_temp_15879._isBuilt ()) {
            _temp_15879 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_15779->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (352)) ;
          }
          ...
          case GGS_sourceFileKind::enum_lexiqueSourceFile:
            {
            var_cas_scannerSourceSet._addAssign_operation (operand_15779->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_guiSourceFile:
            {
            var_cas_guiSourceSet._addAssign_operation (operand_15779->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_optionSourceFile:
            {
            var_cas_optionSourceSet._addAssign_operation (operand_15779->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_syntaxSourceFile:
            {
            var_cas_syntaxSourceSet._addAssign_operation (operand_15779->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_semanticsSourceFile:
            {
            var_cas_semanticsSourceSet._addAssign_operation (operand_15779->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_grammarSourceFile:
            {
            var_cas_grammarSourceSet._addAssign_operation (operand_15779->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_programSourceFile:
            {
            var_cas_programSourceSet._addAssign_operation (operand_15779->mValue) ;
            }
            break ;
      ...
      ::routine_generateXcodeProject (_inLexique,  var_cas_externSourceSet,  var_cas_guiSourceSet,  var_cas_scannerSourceSet,  var_cas_optionSourceSet,  var_cas_semanticsSourceSet,  var_cas_syntaxSourceSet,  var_cas_grammarSourceSet,  var_cas_programSourceSet,  var_cas_name.reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (381)),  var_cas_fullXcodePath.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (382)),  var_cas_iconFiles COMMA_SOURCE_FILE_AT_LINE (372)) ;
    }
  }
}
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_590_23_ (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (602)))).isBuiltAndTrue ()) {
    _inLexique.printMessage (((GGS_string (true, "------ Compile file '"))._operator_concat (var_cas_fileName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (603))))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (603)) ;
  }
  galgas_LL1_grammar::_performSourceFileParsing_compileFile (_inLexique,
                                  NULL,
                                  var_cas_fileName
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_590_23_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_590_23_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_590_23_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_590_23_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
                                GGS_stringset  &/* var_cas_ioImportedSemanticsComponentNameSet */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_590_23_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_649_34_ (galgas_scanner & _inLexique,
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_649_34_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_664_33_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext) {
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_664_33_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_681_44_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_681_44_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_700_43_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_700_43_parse (galgas_scanner & /* _inLexique */) {
}
