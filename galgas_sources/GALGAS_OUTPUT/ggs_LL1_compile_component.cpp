...
pr_galgas_component_ggs_LL1_compile_component_143_23_ (galgas_scanner & inLexique,
  ...
  GGS_string var_cas_s = GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (153)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (153)) ;
  const GGS_bool cond_6665 = (var_cas_s).operator_isNotEqual (var_cas_sourceFileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (154))) ;
  if (cond_6665.isBuiltAndTrue ()) {
    var_cas_sourceFileName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the project name ('")).operator_concat (var_cas_sourceFileName)).operator_concat (GGS_string ("') should be the file base name '"))).operator_concat (var_cas_s)).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (156)) ;
  }
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_ggs_LL1_compile_component_0 (inLexique)) {
        case 2 : {
          ...
          GGS_string var_cas_baseName = var_cas_fileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (190)).reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (190)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (190)) ;
          var_cas_sourceFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_baseName, var_cas_fileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (192)) COMMA_HERE), var_cas_fileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (192)), var_cas_sourceFileKind COMMA_SOURCE_FILE_AT_LINE (192)) ;
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_3 = true ;
                while (syntaxRepeat_3) {
                    ...
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
                    var_cas_targetFileListMap.addAssign_operation (var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (199)), var_cas_baseName) ;
                    const GGS_bool cond_8199 = (var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (200))).operator_isEqual (GGS_string ("xcode")) ;
                    if (cond_8199.isBuiltAndTrue ()) {
                      var_cas_targetName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the target \"xcode\" name is obsolete: use \"xcode_tool\" and/or \"xcode_app\"") COMMA_SOURCE_FILE_AT_LINE (202)) ;
                    }else if (cond_8199.isBuiltAndFalse ()) {
                      const GGS_bool cond_8435 = (((var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202))).operator_isNotEqual (GGS_string ("makefile"))).operator_and ((var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202))).operator_isNotEqual (GGS_string ("xcode_tool")))).operator_and ((var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202))).operator_isNotEqual (GGS_string ("xcode_app"))) ;
                      if (cond_8435.isBuiltAndTrue ()) {
                        var_cas_targetName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the target name should be \"makefile\", \"xcode_tool\" or \"xcode_app\"") COMMA_SOURCE_FILE_AT_LINE (204)) ;
                      }
                    }
          ...
          const GGS_bool cond_8673 = (gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).operator_and ((var_cas_sourceFileKind).operator_isNotEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE))) ;
          if (cond_8673.isBuiltAndTrue ()) {
            inLexique.printMessage (((GGS_string ("------ Compile file '")).operator_concat (var_cas_fileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (210)))).operator_concat (GGS_string ("'\n")) COMMA_SOURCE_FILE_AT_LINE (210)) ;
          }
          const GGS_bool cond_9254 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_optionSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (213))).operator_isEqual (GGS_string ("gOption"))) ;
          if (cond_9254.isBuiltAndTrue ()) {
            GGS_string var_cas_s2 = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (214))).operator_concat (GGS_string ("/GALGAS_OUTPUT")) ;
            ...
            ::routine_compileOptionComponent (inLexique,  var_cas_fileName,  var_cas_s2,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (221)) ;
          }else if (cond_9254.isBuiltAndFalse ()) {
            const GGS_bool cond_9806 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_lexiqueSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (222))).operator_isEqual (GGS_string ("gLexique"))) ;
            if (cond_9806.isBuiltAndTrue ()) {
              GGS_string var_cas_s2 = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (223))).operator_concat (GGS_string ("/GALGAS_OUTPUT")) ;
              GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
              ::routine_compileLexiqueComponent (inLexique,  var_cas_fileName,  var_cas_s2,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (230)) ;
            }else if (cond_9806.isBuiltAndFalse ()) {
              const GGS_bool cond_10531 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_guiSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (231))).operator_isEqual (GGS_string ("gGui"))) ;
              if (cond_10531.isBuiltAndTrue ()) {
                GGS_string var_cas_s2 = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (232))).operator_concat (GGS_string ("/GALGAS_OUTPUT")) ;
                GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
                GGS_string var_cas_absoluteFilePath = var_cas_fileName.ggs_string ().reader_absolutePathFromPath (inLexique, GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (239)) COMMA_SOURCE_FILE_AT_LINE (239)) ;
                ::routine_compileGuiComponent (inLexique,  GGS_lstring ::constructor_new (inLexique, var_cas_absoluteFilePath, var_cas_fileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (240)) COMMA_HERE),  var_cas_s2,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (240)) ;
              }else if (cond_10531.isBuiltAndFalse ()) {
                const GGS_bool cond_10706 = (var_cas_sourceFileKind).operator_isNotEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  const GGS_bool cond_10842 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.value () ;
  if (cond_10842.isBuiltAndTrue ()) {
    inLexique.printMessage (GGS_string ("------ Project\n") COMMA_SOURCE_FILE_AT_LINE (250)) ;
  }
  GGS_stringlist  var_cas_makefileFiles = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("makefile") COMMA_SOURCE_FILE_AT_LINE (253)) ;
  const GGS_bool cond_12494 = (var_cas_makefileFiles.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (254))).operator_strictSup (GGS_uint (0U)) ;
  if (cond_12494.isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_11213 (var_cas_makefileFiles, true) ;
      const GGS_stringlist::cElement * operand_11213 = NULL ;
      while (((operand_11213 = enumerator_11213.nextObject ()))) {
        macroValidPointer (operand_11213) ;
        GGS_string var_cas_fullPath ;
        GGS_EXsourceFileKind var_cas_sourceKind ;
        const GGS_EXsourceFileMap  temp_11309 = var_cas_sourceFileMap ;
        if (temp_11309.isBuilt ()) {
          temp_11309 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_11213->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (262)) ;
        }
        GGS_string var_cas_filePath = var_cas_fullPath.reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (263)) ;
        const GGS_bool cond_11846 = (var_cas_sourceKind).operator_isEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE)) ;
        if (cond_11846.isBuiltAndTrue ()) {
          const GGS_bool cond_11630 = (var_cas_filePath.reader_firstCharacterOrNul (inLexique COMMA_SOURCE_FILE_AT_LINE (265))).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
          ...
          }else if (cond_11630.isBuiltAndFalse ()) {
            const GGS_bool cond_11744 = (var_cas_filePath).operator_isNotEqual (GGS_string ("")) ;
        ...
        }else if (cond_11846.isBuiltAndFalse ()) {
    ...
    {
      GGS_stringset::cEnumerator enumerator_12050 (var_cas_pathSet, true) ;
      while (enumerator_12050.hasCurrentObject ()) {
        var_cas_pathesString.dotAssign_operation (enumerator_12050._key (HERE)) ;
        enumerator_12050.next () ;
      }
    }
    ...
    GGS_string var_cas_fileListPath = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (284))).operator_concat (GGS_string ("/GALGAS_OUTPUT/file_list.mke")) ;
    GGS_bool automatic_var_0 ;
    const GGS_string temp_12468 = var_cas_newFileListContents ;
    if (temp_12468.isBuilt ()) {
      temp_12468 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (285)) ;
    }
  }
  const GGS_bool cond_17356 = (gOption_galgas_5F_cli_5F_options_doNotGenerateXcodeProject.value ()).operator_not () ;
  if (cond_17356.isBuiltAndTrue ()) {
    GGS_stringlist  var_cas_xcode_tool_files = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("xcode_tool") COMMA_SOURCE_FILE_AT_LINE (289)) ;
    GGS_stringlist  var_cas_xcode_app_files = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("xcode_app") COMMA_SOURCE_FILE_AT_LINE (290)) ;
    const GGS_bool cond_17345 = (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and ((var_cas_xcode_tool_files.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (291))).operator_strictSup (GGS_uint (0U)))).operator_and ((var_cas_xcode_app_files.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (291))).operator_strictSup (GGS_uint (0U))) ;
    if (cond_17345.isBuiltAndTrue ()) {
      GGS_string var_cas_XcodeProjectDir = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (292)).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (292))).operator_concat (GGS_string ("/project_xcode")) ;
      GGS_stringlist  var_cas_iconFiles = var_cas_XcodeProjectDir.reader_regularFilesWithExtensions (inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("icns")) COMMA_SOURCE_FILE_AT_LINE (294)) ;
      GGS_stringlist  var_cas_xcodeProjects = var_cas_XcodeProjectDir.reader_directoriesWithExtensions (inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("xcodeproj")) COMMA_SOURCE_FILE_AT_LINE (295)) ;
      const GGS_bool cond_13488 = (var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (297))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_13488.isBuiltAndTrue ()) {
      }else if (cond_13488.isBuiltAndFalse ()) {
        const GGS_bool cond_13663 = (var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (299))).operator_strictSup (GGS_uint (1U)) ;
        ...
        }else if (cond_13663.isBuiltAndFalse ()) {
          const GGS_bool cond_17334 = (var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (301))).operator_isEqual (GGS_uint (1U)) ;
          if (cond_17334.isBuiltAndTrue ()) {
            GGS_string var_cas_name ;
            const GGS_stringlist  temp_13738 = var_cas_xcodeProjects ;
            if (temp_13738.isBuilt ()) {
              temp_13738 (HERE)->method_first (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (302)) ;
            }
            ...
            GGS_string var_cas_intermediateFilePath = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (305))).operator_concat (GGS_string ("/GALGAS_OUTPUT/file_list_for_xcode_project.txt")) ;
            ...
            {
              GGS_stringlist::cEnumerator enumerator_14464 (var_cas_xcode_tool_files, true) ;
              const GGS_stringlist::cElement * operand_14464 = NULL ;
              while (((operand_14464 = enumerator_14464.nextObject ()))) {
                macroValidPointer (operand_14464) ;
                GGS_string var_cas_fullPath ;
                GGS_EXsourceFileKind var_cas_sourceKind ;
                const GGS_EXsourceFileMap  temp_14566 = var_cas_sourceFileMap ;
                if (temp_14566.isBuilt ()) {
                  temp_14566 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_14464->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (317)) ;
                }
                ...
                case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                  {
                  var_cas_scannerSourceSet_tool.addAssign_operation (operand_14464->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_guiSourceFile:
                  {
                  var_cas_guiSourceSet_tool.addAssign_operation (operand_14464->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_optionSourceFile:
                  {
                  var_cas_optionSourceSet_tool.addAssign_operation (operand_14464->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                  {
                  var_cas_syntaxSourceSet_tool.addAssign_operation (operand_14464->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                  {
                  var_cas_semanticsSourceSet_tool.addAssign_operation (operand_14464->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_grammarSourceFile:
                  {
                  var_cas_grammarSourceSet_tool.addAssign_operation (operand_14464->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_programSourceFile:
                  {
                  var_cas_programSourceSet_tool.addAssign_operation (operand_14464->mValue) ;
                  }
                  break ;
            ...
            {
              GGS_stringlist::cEnumerator enumerator_15738 (var_cas_xcode_app_files, true) ;
              const GGS_stringlist::cElement * operand_15738 = NULL ;
              while (((operand_15738 = enumerator_15738.nextObject ()))) {
                macroValidPointer (operand_15738) ;
                GGS_string var_cas_fullPath ;
                GGS_EXsourceFileKind var_cas_sourceKind ;
                const GGS_EXsourceFileMap  temp_15840 = var_cas_sourceFileMap ;
                if (temp_15840.isBuilt ()) {
                  temp_15840 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_15738->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (348)) ;
                }
                switch (var_cas_sourceKind.enumValue ()) {
                case GGS_EXsourceFileKind::enum_externSourceFile:
                  {
                ...
                case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                  {
                  var_cas_scannerSourceSet_app.addAssign_operation (operand_15738->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_guiSourceFile:
                  {
                  var_cas_guiSourceSet_app.addAssign_operation (operand_15738->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_optionSourceFile:
                  {
                  var_cas_optionSourceSet_app.addAssign_operation (operand_15738->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                  {
                  var_cas_syntaxSourceSet_app.addAssign_operation (operand_15738->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                  {
                  var_cas_semanticsSourceSet_app.addAssign_operation (operand_15738->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_grammarSourceFile:
                  {
                  var_cas_grammarSourceSet_app.addAssign_operation (operand_15738->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::enum_programSourceFile:
                  {
                  var_cas_programSourceSet_app.addAssign_operation (operand_15738->mValue) ;
                  }
                  break ;
                case GGS_EXsourceFileKind::kNotBuilt:
                  break ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_143_23_importForGrammarAnalysis (galgas_scanner & inLexique,
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_143_23_importGrammarForSemantics (galgas_scanner & inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_143_23_importLexique (galgas_scanner & inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A_) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_143_23_importOptions (galgas_scanner & inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A_) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_143_23_importSemantics (galgas_scanner & inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_143_23_importSyntax (galgas_scanner & inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_647_23_ (galgas_scanner & inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  const GGS_bool cond_21980 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.value () ;
  if (cond_21980.isBuiltAndTrue ()) {
    inLexique.printMessage (((GGS_string ("------ Compile file '")).operator_concat (var_cas_fileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (660)))).operator_concat (GGS_string ("'\n")) COMMA_SOURCE_FILE_AT_LINE (660)) ;
  }
  const GGS_string _depExtension = GGS_string ("galgas-dep") ;
  const GGS_string _depPath = GGS_string ("DEPENDENCIES") ;
  if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_647_23_importForGrammarAnalysis (galgas_scanner & inLexique,
                                GGS_syntaxRuleList  &/* var_cas_ioSyntaxRuleList */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_647_23_importGrammarForSemantics (galgas_scanner & inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_647_23_importLexique (galgas_scanner & inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_647_23_importOptions (galgas_scanner & inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_647_23_importSemantics (galgas_scanner & inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
                                GGS_stringset  &/* var_cas_ioImportedSemanticsComponentNameSet */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_647_23_importSyntax (galgas_scanner & inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_712_34_ (galgas_scanner & inLexique,
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_712_34_parse (galgas_scanner & /* inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_727_33_ (galgas_scanner & inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext) {
  const GGS_string _depExtension = GGS_string ("") ;
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_727_33_parse (galgas_scanner & /* inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_744_44_ (galgas_scanner & inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_744_44_parse (galgas_scanner & /* inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_763_43_ (galgas_scanner & inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
  const GGS_string _depExtension = GGS_string ("") ;
  const GGS_string _depPath = GGS_string ("") ;
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_763_43_parse (galgas_scanner & /* inLexique */) {
}
