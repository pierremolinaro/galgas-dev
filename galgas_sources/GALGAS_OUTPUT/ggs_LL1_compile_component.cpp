...
//                    november 14th, 2009, at 16h54'37"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_galgas_component_ggs_LL1_compile_component_141_23_ (galgas_scanner & inLexique,
    ...
    while (syntaxRepeat_0) {
      switch (select_ggs_LL1_compile_component_0 (inLexique)) {
        case 2 : {
          ...
          const GGS_bool cond_9192 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_optionSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gOption"))) ;
          if (cond_9192.isBuiltAndTrue ()) {
            ...
            const GGS_bool cond_9744 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_lexiqueSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gLexique"))) ;
            if (cond_9744.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_10469 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_guiSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gGui"))) ;
              if (cond_10469.isBuiltAndTrue ()) {
                ...
                const GGS_bool cond_11328 = ((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_grammarSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension ()).operator_isEqual (GGS_string ("gGrammar"))) ;
  ...
  const GGS_bool cond_13291 = (var_cas_makefileFiles.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
    ...
    var_cas_pathSet.addAssign_operation (GGS_string ("SOURCES_DIR += ../hand_coded_sources\n")) ;
    {
      ...
      while (((operand_12010 = enumerator_12010.nextObject ()))) {
        ...
        if (cond_12643.isBuiltAndTrue ()) {
          const GGS_bool cond_12427 = (var_cas_filePath.reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
  ...
  if (cond_18153.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_18142 = (((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and ((var_cas_xcode_tool_files.reader_length ()).operator_strictSup (GGS_uint (0U)))).operator_and ((var_cas_xcode_app_files.reader_length ()).operator_strictSup (GGS_uint (0U))) ;
    if (cond_18142.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_14285 = (var_cas_xcodeProjects.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
      if (cond_14285.isBuiltAndTrue ()) {
      }else if (cond_14285.isBuiltAndFalse ()) {
        const GGS_bool cond_14460 = (var_cas_xcodeProjects.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
        if (cond_14460.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_18131 = (var_cas_xcodeProjects.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
