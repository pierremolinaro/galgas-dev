...
pr_galgas_component_ggs_LL1_compile_component_137_23_ (galgas_scanner & inLexique,
      ...
      switch (select_repeat_ggs_LL1_compile_component_0 (inLexique)) {
        case 2 : {
          ...
          if ((((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_optionSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (207))).operator_isEqual (GGS_string ("gOption")))).isBuiltAndTrue ()) {
            ...
            ::routine_compileOptionComponent (inLexique,  var_cas_fileName,  var_cas_s,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (214)) ;
  ...
  var_cas_makefileFiles = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("makefile") COMMA_SOURCE_FILE_AT_LINE (227)) ;
  if (((var_cas_makefileFiles.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (228))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_9582 (var_cas_makefileFiles, true) ;
      const GGS_stringlist::cElement * operand_9582 = NULL ;
      while (((operand_9582 = enumerator_9582.nextObject ()))) {
        macroValidPointer (operand_9582) ;
        GGS_string var_cas_fullPath ;
        GGS_EXsourceFileKind var_cas_sourceKind ;
        const GGS_EXsourceFileMap  temp_9678 = var_cas_sourceFileMap ;
        if (temp_9678.isBuilt ()) {
          temp_9678 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_9582->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (236)) ;
        }
        GGS_string var_cas_filePath ;
        var_cas_filePath = var_cas_fullPath.reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (237)) ;
        if (((var_cas_sourceKind).operator_isEqual (GGS_EXsourceFileKind::constructor_externSourceFile (inLexique COMMA_HERE))).isBuiltAndTrue ()) {
          if (((var_cas_filePath.reader_firstCharacterOrNul (inLexique COMMA_SOURCE_FILE_AT_LINE (239))).operator_isEqual (GGS_char (TO_UNICODE ('/')))).isBuiltAndTrue ()) {
          ...
          var_cas_externSourceFileList.dotAssign_operation (var_cas_fullPath.reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (244))) ;
          var_cas_externSourceFileList.appendCString ("\n") ;
        }else{
          var_cas_galgasSourceList.appendCString ("SOURCES += ") ;
          var_cas_galgasSourceList.dotAssign_operation (var_cas_fullPath.reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (246)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (246))) ;
    ...
    {
      GGS_stringset::cEnumerator enumerator_10419 (var_cas_pathSet, true) ;
      while (enumerator_10419.hasCurrentObject ()) {
        var_cas_pathesString.dotAssign_operation (enumerator_10419._key (HERE)) ;
        enumerator_10419.next () ;
      }
    }
    ...
    var_cas_fileListPath = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (258))).operator_concat (GGS_string ("/GALGAS_OUTPUT/file_list.mke")) ;
    GGS_bool automatic_var_0 ;
    const GGS_string temp_10837 = var_cas_newFileListContents ;
    if (temp_10837.isBuilt ()) {
      temp_10837 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (259)) ;
    }
  }
  if (((gOption_galgas_5F_cli_5F_options_doNotGenerateXcodeProject.value ()).operator_not ()).isBuiltAndTrue ()) {
    ...
    var_cas_xcode_tool_files = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("xcode_tool") COMMA_SOURCE_FILE_AT_LINE (263)) ;
    GGS_stringlist  var_cas_xcode_app_files ;
    var_cas_xcode_app_files = var_cas_targetFileListMap.reader_listForKey (inLexique, GGS_string ("xcode_app") COMMA_SOURCE_FILE_AT_LINE (264)) ;
    if (((((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and ((var_cas_xcode_tool_files.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (265))).operator_strictSup (GGS_uint (0U)))).operator_and ((var_cas_xcode_app_files.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (265))).operator_strictSup (GGS_uint (0U)))).isBuiltAndTrue ()) {
      GGS_string var_cas_XcodeProjectDir ;
      var_cas_XcodeProjectDir = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (266)).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (266))).operator_concat (GGS_string ("/project_xcode")) ;
      GGS_stringlist  var_cas_iconFiles ;
      var_cas_iconFiles = var_cas_XcodeProjectDir.reader_regularFilesWithExtensions (inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("icns")) COMMA_SOURCE_FILE_AT_LINE (268)) ;
      GGS_stringlist  var_cas_xcodeProjects ;
      var_cas_xcodeProjects = var_cas_XcodeProjectDir.reader_directoriesWithExtensions (inLexique, GGS_bool (false), GGS_stringlist ::constructor_listWithValue (GGS_string ("xcodeproj")) COMMA_SOURCE_FILE_AT_LINE (269)) ;
      if (((var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (271))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      }else if (((var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (273))).operator_strictSup (GGS_uint (1U))).isBuiltAndTrue ()) {
      ...
      }else if (((var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (275))).operator_isEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
        GGS_string var_cas_name ;
        const GGS_stringlist  temp_12107 = var_cas_xcodeProjects ;
        if (temp_12107.isBuilt ()) {
          temp_12107 (HERE)->method_first (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (276)) ;
        }
        ...
        var_cas_intermediateFilePath = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (279))).operator_concat (GGS_string ("/GALGAS_OUTPUT/file_list_for_xcode_project.txt")) ;
        ...
        {
          GGS_stringlist::cEnumerator enumerator_12833 (var_cas_xcode_tool_files, true) ;
          const GGS_stringlist::cElement * operand_12833 = NULL ;
          while (((operand_12833 = enumerator_12833.nextObject ()))) {
            macroValidPointer (operand_12833) ;
            GGS_string var_cas_fullPath ;
            GGS_EXsourceFileKind var_cas_sourceKind ;
            const GGS_EXsourceFileMap  temp_12935 = var_cas_sourceFileMap ;
            if (temp_12935.isBuilt ()) {
              temp_12935 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_12833->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (291)) ;
            }
            ...
            case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
              {
              var_cas_scannerSourceSet_tool._addAssign_operation (operand_12833->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_guiSourceFile:
              {
              var_cas_guiSourceSet_tool._addAssign_operation (operand_12833->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_optionSourceFile:
              {
              var_cas_optionSourceSet_tool._addAssign_operation (operand_12833->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_syntaxSourceFile:
              {
              var_cas_syntaxSourceSet_tool._addAssign_operation (operand_12833->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_semanticsSourceFile:
              {
              var_cas_semanticsSourceSet_tool._addAssign_operation (operand_12833->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_grammarSourceFile:
              {
              var_cas_grammarSourceSet_tool._addAssign_operation (operand_12833->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_programSourceFile:
              {
              var_cas_programSourceSet_tool._addAssign_operation (operand_12833->mValue) ;
              }
              break ;
        ...
        {
          GGS_stringlist::cEnumerator enumerator_14107 (var_cas_xcode_app_files, true) ;
          const GGS_stringlist::cElement * operand_14107 = NULL ;
          while (((operand_14107 = enumerator_14107.nextObject ()))) {
            macroValidPointer (operand_14107) ;
            GGS_string var_cas_fullPath ;
            GGS_EXsourceFileKind var_cas_sourceKind ;
            const GGS_EXsourceFileMap  temp_14209 = var_cas_sourceFileMap ;
            if (temp_14209.isBuilt ()) {
              temp_14209 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_14107->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (322)) ;
            }
            switch (var_cas_sourceKind.enumValue ()) {
            case GGS_EXsourceFileKind::enum_externSourceFile:
              {
            ...
            case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
              {
              var_cas_scannerSourceSet_app._addAssign_operation (operand_14107->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_guiSourceFile:
              {
              var_cas_guiSourceSet_app._addAssign_operation (operand_14107->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_optionSourceFile:
              {
              var_cas_optionSourceSet_app._addAssign_operation (operand_14107->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_syntaxSourceFile:
              {
              var_cas_syntaxSourceSet_app._addAssign_operation (operand_14107->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_semanticsSourceFile:
              {
              var_cas_semanticsSourceSet_app._addAssign_operation (operand_14107->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_grammarSourceFile:
              {
              var_cas_grammarSourceSet_app._addAssign_operation (operand_14107->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_programSourceFile:
              {
              var_cas_programSourceSet_app._addAssign_operation (operand_14107->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::kNotBuilt:
              break ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_581_23_ (galgas_scanner & inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  if ((gOption_galgas_5F_cli_5F_options_verbose_5F_output.value ()).isBuiltAndTrue ()) {
    inLexique.printMessage (((GGS_string ("------ Compile file '")).operator_concat (var_cas_fileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (594)))).operator_concat (GGS_string ("'\n")) COMMA_SOURCE_FILE_AT_LINE (594)) ;
  }
  const GGS_string _depExtension = GGS_string ("galgas-dep") ;
  const GGS_string _depPath = GGS_string ("DEPENDENCIES") ;
  if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_581_23_importGrammarForSemantics (galgas_scanner & inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_581_23_importLexique (galgas_scanner & inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_581_23_importOptions (galgas_scanner & inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_581_23_importSemantics (galgas_scanner & inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
                                GGS_stringset  &/* var_cas_ioImportedSemanticsComponentNameSet */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_581_23_importSyntax (galgas_scanner & inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_640_34_ (galgas_scanner & inLexique,
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_640_34_parse (galgas_scanner & /* inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_655_33_ (galgas_scanner & inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext) {
  const GGS_string _depExtension = GGS_string ("") ;
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_655_33_parse (galgas_scanner & /* inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_672_44_ (galgas_scanner & inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_672_44_parse (galgas_scanner & /* inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_691_43_ (galgas_scanner & inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
  const GGS_string _depExtension = GGS_string ("") ;
  const GGS_string _depPath = GGS_string ("") ;
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_691_43_parse (galgas_scanner & /* inLexique */) {
}
