            ...
            case 2 : {
              ...
              { bool syntaxRepeat_3 = true ;
                while (syntaxRepeat_3) {
                    ...
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
                    var_cas_targetFileListMap._addAssign_operation (var_cas_targetName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (195)), var_cas_baseName) ;
      ...
      if (((var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (293))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
        ...
        var_cas_programSourceSet_tool = GGS_stringset ::constructor_emptySet () ;
        {
          ...
          while (((operand_14290 = enumerator_14290.nextObject ()))) {
            ...
            case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
              {
              var_cas_scannerSourceSet_tool._addAssign_operation (operand_14290->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_guiSourceFile:
              {
              var_cas_guiSourceSet_tool._addAssign_operation (operand_14290->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_optionSourceFile:
              {
              var_cas_optionSourceSet_tool._addAssign_operation (operand_14290->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_syntaxSourceFile:
              {
              var_cas_syntaxSourceSet_tool._addAssign_operation (operand_14290->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_semanticsSourceFile:
              {
              var_cas_semanticsSourceSet_tool._addAssign_operation (operand_14290->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_grammarSourceFile:
              {
              var_cas_grammarSourceSet_tool._addAssign_operation (operand_14290->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_programSourceFile:
              {
              var_cas_programSourceSet_tool._addAssign_operation (operand_14290->mValue) ;
              }
              break ;
        ...
        var_cas_programSourceSet_app = GGS_stringset ::constructor_emptySet () ;
        {
          ...
          while (((operand_15564 = enumerator_15564.nextObject ()))) {
            ...
            case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
              {
              var_cas_scannerSourceSet_app._addAssign_operation (operand_15564->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_guiSourceFile:
              {
              var_cas_guiSourceSet_app._addAssign_operation (operand_15564->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_optionSourceFile:
              {
              var_cas_optionSourceSet_app._addAssign_operation (operand_15564->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_syntaxSourceFile:
              {
              var_cas_syntaxSourceSet_app._addAssign_operation (operand_15564->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_semanticsSourceFile:
              {
              var_cas_semanticsSourceSet_app._addAssign_operation (operand_15564->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_grammarSourceFile:
              {
              var_cas_grammarSourceSet_app._addAssign_operation (operand_15564->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_programSourceFile:
              {
              var_cas_programSourceSet_app._addAssign_operation (operand_15564->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::kNotBuilt:
              break ;
