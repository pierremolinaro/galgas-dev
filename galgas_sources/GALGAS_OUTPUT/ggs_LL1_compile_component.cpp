...
pr_galgas_component_ggs_LL1_compile_component_135_23_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_makefileFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (218)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_8901 (var_cas_makefileFiles, true) ;
      const GGS_stringlist::cElement * operand_8901 = NULL ;
      while (((operand_8901 = enumerator_8901.nextObject ()))) {
        ...
        const GGS_EXsourceFileMap  _temp_8997 = var_cas_sourceFileMap ;
        if (_temp_8997._isBuilt ()) {
          _temp_8997 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_8901->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (226)) ;
        }
    ...
    {
      GGS_stringset::cEnumerator enumerator_9738 (var_cas_pathSet, true) ;
      while (enumerator_9738.hc ()) {
        var_cas_pathesString._dotAssign_operation (enumerator_9738._key (HERE)) ;
        enumerator_9738.next () ;
      }
    }
    ...
    const GGS_string _temp_10156 = var_cas_newFileListContents ;
    if (_temp_10156._isBuilt ()) {
      _temp_10156 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (249)) ;
    }
  }
  if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("galgas_cli_options", "doNotGenerateXcodeProject" COMMA_SOURCE_FILE_AT_LINE (339))))._operator_not ()).isBuiltAndTrue ()) {
    ...
    if (((((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_xcode_tool_files.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (342)))._operator_strictSup (GGS_uint (true, 0U))))._operator_and ((var_cas_xcode_app_files.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (342)))._operator_strictSup (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
      ...
      if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (348)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        ...
        const GGS_stringlist  _temp_16542 = var_cas_xcodeProjects ;
        if (_temp_16542._isBuilt ()) {
          _temp_16542 (HERE)->method_first (_inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (353)) ;
        }
        ...
        {
          GGS_stringlist::cEnumerator enumerator_16778 (var_cas_xcode_tool_files, true) ;
          const GGS_stringlist::cElement * operand_16778 = NULL ;
          while (((operand_16778 = enumerator_16778.nextObject ()))) {
            macroValidPointer (operand_16778) ;
            var_cas_intermediateString._dotAssign_operation (operand_16778->mValue) ;
            var_cas_intermediateString.appendCstring ("\n") ;
          }
        }
        var_cas_intermediateString.appendCstring ("::\n") ;
        {
          GGS_stringlist::cEnumerator enumerator_16914 (var_cas_xcode_app_files, true) ;
          const GGS_stringlist::cElement * operand_16914 = NULL ;
          while (((operand_16914 = enumerator_16914.nextObject ()))) {
            macroValidPointer (operand_16914) ;
            var_cas_intermediateString._dotAssign_operation (operand_16914->mValue) ;
            var_cas_intermediateString.appendCstring ("\n") ;
          }
        }
        GGS_string var_cas_intermediateFilePath ;
        var_cas_intermediateFilePath = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (365)))._operator_concat (GGS_string (true, "/DEPENDENCIES/file_list_for_xcode_project.txt")) ;
        GGS_bool var_cas_written ;
        const GGS_string _temp_17259 = var_cas_intermediateString ;
        if (_temp_17259._isBuilt ()) {
          _temp_17259 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_intermediateFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (367)) ;
        }
        if ((var_cas_written).isBuiltAndTrue ()) {
          ...
          {
            GGS_stringlist::cEnumerator enumerator_17838 (var_cas_xcode_tool_files, true) ;
            ...
            while (((operand_17838 = enumerator_17838.nextObject ()))) {
              ...
              GGS_string var_cas_fullPath ;
              GGS_EXsourceFileKind var_cas_sourceKind ;
              const GGS_EXsourceFileMap  _temp_17946 = var_cas_sourceFileMap ;
              if (_temp_17946._isBuilt ()) {
                _temp_17946 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_17838->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (381)) ;
              }
              ...
              case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                {
                var_cas_scannerSourceSet_tool._addAssign_operation (operand_17838->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_guiSourceFile:
                {
                var_cas_guiSourceSet_tool._addAssign_operation (operand_17838->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_optionSourceFile:
                {
                var_cas_optionSourceSet_tool._addAssign_operation (operand_17838->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                {
                var_cas_syntaxSourceSet_tool._addAssign_operation (operand_17838->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                {
                var_cas_semanticsSourceSet_tool._addAssign_operation (operand_17838->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_grammarSourceFile:
                {
                var_cas_grammarSourceSet_tool._addAssign_operation (operand_17838->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_programSourceFile:
                {
                var_cas_programSourceSet_tool._addAssign_operation (operand_17838->mValue) ;
                }
                break ;
          ...
          {
            GGS_stringlist::cEnumerator enumerator_19174 (var_cas_xcode_app_files, true) ;
            const GGS_stringlist::cElement * operand_19174 = NULL ;
            while (((operand_19174 = enumerator_19174.nextObject ()))) {
              macroValidPointer (operand_19174) ;
              GGS_string var_cas_fullPath ;
              GGS_EXsourceFileKind var_cas_sourceKind ;
              const GGS_EXsourceFileMap  _temp_19282 = var_cas_sourceFileMap ;
              if (_temp_19282._isBuilt ()) {
                _temp_19282 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_19174->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (412)) ;
              }
              switch (var_cas_sourceKind.enumValue ()) {
              case GGS_EXsourceFileKind::enum_externSourceFile:
                {
              ...
              case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                {
                var_cas_scannerSourceSet_app._addAssign_operation (operand_19174->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_guiSourceFile:
                {
                var_cas_guiSourceSet_app._addAssign_operation (operand_19174->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_optionSourceFile:
                {
                var_cas_optionSourceSet_app._addAssign_operation (operand_19174->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                {
                var_cas_syntaxSourceSet_app._addAssign_operation (operand_19174->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                {
                var_cas_semanticsSourceSet_app._addAssign_operation (operand_19174->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_grammarSourceFile:
                {
                var_cas_grammarSourceSet_app._addAssign_operation (operand_19174->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_programSourceFile:
                {
                var_cas_programSourceSet_app._addAssign_operation (operand_19174->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::kNotBuilt:
                break ;
