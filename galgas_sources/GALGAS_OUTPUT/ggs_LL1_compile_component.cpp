...
//                    november 13th, 2008, at 20h23'35"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_galgas_component_ggs_LL1_compile_component_135_23_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_makefileFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (210)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    if (_temp_9556._isBuilt ()) {
      _temp_9556 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (241)) ;
    }
  }
  ...
  if (((var_cas_oldCommonFile.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (245)))._operator_and ((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_10171 (var_cas_projectDirectories, true) ;
      ...
      while (((operand_10171 = enumerator_10171.nextObject ()))) {
        ...
        if ((((operand_10171->mValue)._operator_isNotEqual (GGS_string (true, "common_files_for_make")))._operator_and ((operand_10171->mValue)._operator_isNotEqual (GGS_string (true, "makefile_macosx_universal")))).isBuiltAndTrue ()) {
          GGS_string var_cas_fullDirPath ;
          var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_10171->mValue))._operator_concat (GGS_string (true, "/")) ;
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_12321 (var_cas_projectDirectories, true) ;
        const GGS_stringlist::cElement * operand_12321 = NULL ;
        while (((operand_12321 = enumerator_12321.nextObject ()))) {
          macroValidPointer (operand_12321) ;
          if ((((operand_12321->mValue)._operator_isNotEqual (GGS_string (true, "common_files_for_make")))._operator_and ((operand_12321->mValue)._operator_isNotEqual (GGS_string (true, "makefile_macosx_universal")))).isBuiltAndTrue ()) {
            GGS_string var_cas_fullDirPath ;
            var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_12321->mValue))._operator_concat (GGS_string (true, "/")) ;
            GGS_string var_cas_makefilePath ;
            var_cas_makefilePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile")) ;
            if ((var_cas_makefilePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (297))).isBuiltAndTrue ()) {
              ...
              const GGS_string _temp_13005 = var_cas_newContents ;
              if (_temp_13005._isBuilt ()) {
                _temp_13005 (HERE)->method_writeToFile (_inLexique, var_cas_makefilePath COMMA_SOURCE_FILE_AT_LINE (301)) ;
              }
            }
            GGS_string var_cas_makefile64Path ;
            var_cas_makefile64Path = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile64")) ;
            if ((var_cas_makefile64Path.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (305))).isBuiltAndTrue ()) {
              ...
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string (true, "include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
              const GGS_string _temp_13575 = var_cas_newContents ;
              if (_temp_13575._isBuilt ()) {
                _temp_13575 (HERE)->method_writeToFile (_inLexique, var_cas_makefile64Path COMMA_SOURCE_FILE_AT_LINE (309)) ;
              }
            }
            GGS_string var_cas_makefileMkePath ;
            var_cas_makefileMkePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile.mke")) ;
            if ((var_cas_makefileMkePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (313))).isBuiltAndTrue ()) {
              ...
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string (true, "include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
              const GGS_string _temp_14155 = var_cas_newContents ;
              if (_temp_14155._isBuilt ()) {
                _temp_14155 (HERE)->method_writeToFile (_inLexique, var_cas_makefileMkePath COMMA_SOURCE_FILE_AT_LINE (317)) ;
              }
            }
          }
        }
  ...
  if ((((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))._operator_and (GGS_bool (true, _inLexique.boolOptionValueFromKeys ("galgas_cli_options", "generate_xcode_project" COMMA_SOURCE_FILE_AT_LINE (331))))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (337)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      ...
      const GGS_stringlist  _temp_15617 = var_cas_xcodeProjects ;
      if (_temp_15617._isBuilt ()) {
        _temp_15617 (HERE)->method_first (_inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (342)) ;
      }
      ...
      {
        GGS_stringlist::cEnumerator enumerator_16179 (var_cas_xcodeFiles, true) ;
        const GGS_stringlist::cElement * operand_16179 = NULL ;
        while (((operand_16179 = enumerator_16179.nextObject ()))) {
          macroValidPointer (operand_16179) ;
          GGS_string var_cas_fullPath ;
          GGS_sourceFileKind var_cas_sourceKind ;
          const GGS_sourceFileMap  _temp_16279 = var_cas_sourceFileMap ;
          if (_temp_16279._isBuilt ()) {
            _temp_16279 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_16179->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (356)) ;
          }
          ...
          case GGS_sourceFileKind::enum_lexiqueSourceFile:
            {
            var_cas_scannerSourceSet._addAssign_operation (operand_16179->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_guiSourceFile:
            {
            var_cas_guiSourceSet._addAssign_operation (operand_16179->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_optionSourceFile:
            {
            var_cas_optionSourceSet._addAssign_operation (operand_16179->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_syntaxSourceFile:
            {
            var_cas_syntaxSourceSet._addAssign_operation (operand_16179->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_semanticsSourceFile:
            {
            var_cas_semanticsSourceSet._addAssign_operation (operand_16179->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_grammarSourceFile:
            {
            var_cas_grammarSourceSet._addAssign_operation (operand_16179->mValue) ;
            }
            break ;
          case GGS_sourceFileKind::enum_programSourceFile:
            {
            var_cas_programSourceSet._addAssign_operation (operand_16179->mValue) ;
            }
            break ;
