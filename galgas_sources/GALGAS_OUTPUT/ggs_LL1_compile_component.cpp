...
pr_galgas_component_ggs_LL1_compile_component_140_23_ (galgas_scanner & inLexique,
      ...
      switch (select_repeat_ggs_LL1_compile_component_0 (inLexique)) {
        case 2 : {
          ...
          if ((((var_cas_sourceFileKind).operator_isEqual (GGS_EXsourceFileKind::constructor_optionSourceFile (inLexique COMMA_HERE))).operator_and ((var_cas_fileName.ggs_string ().reader_pathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (210))).operator_isEqual (GGS_string ("gOption")))).isBuiltAndTrue ()) {
            GGS_string var_cas_s = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (211))).operator_concat (GGS_string ("/GALGAS_OUTPUT")) ;
            ...
            ::routine_compileOptionComponent (inLexique,  var_cas_fileName,  var_cas_s,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (218)) ;
            ...
            GGS_string var_cas_s = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (220))).operator_concat (GGS_string ("/GALGAS_OUTPUT")) ;
            GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ::routine_compileLexiqueComponent (inLexique,  var_cas_fileName,  var_cas_s,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (227)) ;
            ...
            GGS_string var_cas_s = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (229))).operator_concat (GGS_string ("/GALGAS_OUTPUT")) ;
            GGS_parsedComponentStruct var_cas_parsedComponentStruct = GGS_parsedComponentStruct::constructor_new (GGS_parsedSemanticsComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedLexiqueComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedSyntaxComponentMap ::constructor_emptyMap (inLexique COMMA_HERE), GGS_parsedOptionComponentMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
            ...
            ::routine_compileGuiComponent (inLexique,  GGS_lstring ::constructor_new (inLexique, var_cas_absoluteFilePath, var_cas_fileName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (237)) COMMA_HERE),  var_cas_s,  var_cas_parsedComponentStruct COMMA_SOURCE_FILE_AT_LINE (237)) ;
  ...
  if (((var_cas_makefileFiles.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (251))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_11072 (var_cas_makefileFiles, true) ;
      const GGS_stringlist::cElement * operand_11072 = NULL ;
      while (((operand_11072 = enumerator_11072.nextObject ()))) {
        ...
        const GGS_EXsourceFileMap  temp_11168 = var_cas_sourceFileMap ;
        if (temp_11168.isBuilt ()) {
          temp_11168 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_11072->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (259)) ;
        }
    ...
    {
      GGS_stringset::cEnumerator enumerator_11909 (var_cas_pathSet, true) ;
      while (enumerator_11909.hasCurrentObject ()) {
        var_cas_pathesString.dotAssign_operation (enumerator_11909._key (HERE)) ;
        enumerator_11909.next () ;
      }
    }
    ...
    const GGS_string temp_12327 = var_cas_newFileListContents ;
    if (temp_12327.isBuilt ()) {
      temp_12327 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (282)) ;
    }
  }
  if (((gOption_galgas_5F_cli_5F_options_doNotGenerateXcodeProject.value ()).operator_not ()).isBuiltAndTrue ()) {
    ...
    if (((((GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U))).operator_and ((var_cas_xcode_tool_files.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (288))).operator_strictSup (GGS_uint (0U)))).operator_and ((var_cas_xcode_app_files.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (288))).operator_strictSup (GGS_uint (0U)))).isBuiltAndTrue ()) {
      ...
      if (((var_cas_xcodeProjects.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (294))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
        ...
        const GGS_stringlist  temp_13597 = var_cas_xcodeProjects ;
        if (temp_13597.isBuilt ()) {
          temp_13597 (HERE)->method_first (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (299)) ;
        }
        ...
        {
          GGS_stringlist::cEnumerator enumerator_14323 (var_cas_xcode_tool_files, true) ;
          const GGS_stringlist::cElement * operand_14323 = NULL ;
          while (((operand_14323 = enumerator_14323.nextObject ()))) {
            macroValidPointer (operand_14323) ;
            GGS_string var_cas_fullPath ;
            GGS_EXsourceFileKind var_cas_sourceKind ;
            const GGS_EXsourceFileMap  temp_14425 = var_cas_sourceFileMap ;
            if (temp_14425.isBuilt ()) {
              temp_14425 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_14323->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (314)) ;
            }
            ...
            case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
              {
              var_cas_scannerSourceSet_tool.addAssign_operation (operand_14323->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_guiSourceFile:
              {
              var_cas_guiSourceSet_tool.addAssign_operation (operand_14323->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_optionSourceFile:
              {
              var_cas_optionSourceSet_tool.addAssign_operation (operand_14323->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_syntaxSourceFile:
              {
              var_cas_syntaxSourceSet_tool.addAssign_operation (operand_14323->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_semanticsSourceFile:
              {
              var_cas_semanticsSourceSet_tool.addAssign_operation (operand_14323->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_grammarSourceFile:
              {
              var_cas_grammarSourceSet_tool.addAssign_operation (operand_14323->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_programSourceFile:
              {
              var_cas_programSourceSet_tool.addAssign_operation (operand_14323->mValue) ;
              }
              break ;
        ...
        {
          GGS_stringlist::cEnumerator enumerator_15597 (var_cas_xcode_app_files, true) ;
          const GGS_stringlist::cElement * operand_15597 = NULL ;
          while (((operand_15597 = enumerator_15597.nextObject ()))) {
            macroValidPointer (operand_15597) ;
            GGS_string var_cas_fullPath ;
            GGS_EXsourceFileKind var_cas_sourceKind ;
            const GGS_EXsourceFileMap  temp_15699 = var_cas_sourceFileMap ;
            if (temp_15699.isBuilt ()) {
              temp_15699 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_15597->mValue, GGS_location (inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (345)) ;
            }
            switch (var_cas_sourceKind.enumValue ()) {
            case GGS_EXsourceFileKind::enum_externSourceFile:
              {
            ...
            case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
              {
              var_cas_scannerSourceSet_app.addAssign_operation (operand_15597->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_guiSourceFile:
              {
              var_cas_guiSourceSet_app.addAssign_operation (operand_15597->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_optionSourceFile:
              {
              var_cas_optionSourceSet_app.addAssign_operation (operand_15597->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_syntaxSourceFile:
              {
              var_cas_syntaxSourceSet_app.addAssign_operation (operand_15597->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_semanticsSourceFile:
              {
              var_cas_semanticsSourceSet_app.addAssign_operation (operand_15597->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_grammarSourceFile:
              {
              var_cas_grammarSourceSet_app.addAssign_operation (operand_15597->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::enum_programSourceFile:
              {
              var_cas_programSourceSet_app.addAssign_operation (operand_15597->mValue) ;
              }
              break ;
            case GGS_EXsourceFileKind::kNotBuilt:
              break ;
