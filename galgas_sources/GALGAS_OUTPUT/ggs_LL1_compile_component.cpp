...
pr_galgas_component_ggs_LL1_compile_component_135_23_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_ggs_LL1_compile_component_0 (_inLexique)) {
        case 2 : {
            ...
            case 2 : {
              ...
              { bool syntaxRepeat_3 = true ;
                while (syntaxRepeat_3) {
                    ...
                    if ((((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (186)))._operator_isNotEqual (GGS_string (true, "makefile")))._operator_and ((var_cas_targetName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (186)))._operator_isNotEqual (GGS_string (true, "xcode")))).isBuiltAndTrue ()) {
                      var_cas_targetName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the target name should be \"makefile\" or \"xcode\"") COMMA_SOURCE_FILE_AT_LINE (188)) ;
                    }
          ...
          if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (193))))._operator_and ((var_cas_sourceFileKind)._operator_isNotEqual (GGS_EXsourceFileKind::constructor_externSourceFile (_inLexique COMMA_HERE)))).isBuiltAndTrue ()) {
            _inLexique.printMessage (((GGS_string (true, "------ Compile file '"))._operator_concat (var_cas_fileName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (194))))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (194)) ;
          }
          if (((var_cas_sourceFileKind)._operator_isNotEqual (GGS_EXsourceFileKind::constructor_externSourceFile (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
            galgas_LL1_grammar::_performSourceFileParsing_compileFile (_inLexique,
                                            (var_cas_fileName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (198)))._operator_concat (GGS_string (true, ".dep")),
                                            NULL,
                                            var_cas_fileName
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_project) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (205)))).isBuiltAndTrue ()) {
    _inLexique.printMessage (GGS_string (true, "------ Project\n") COMMA_SOURCE_FILE_AT_LINE (206)) ;
  }
  GGS_stringlist  var_cas_makefileFiles ;
  var_cas_makefileFiles = var_cas_targetFileListMap.reader_listForKey (_inLexique, GGS_string (true, "makefile") COMMA_SOURCE_FILE_AT_LINE (209)) ;
  if (((var_cas_makefileFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (210)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    {
      GGS_stringlist::cEnumerator enumerator_8376 (var_cas_makefileFiles, true) ;
      const GGS_stringlist::cElement * operand_8376 = NULL ;
      while (((operand_8376 = enumerator_8376.nextObject ()))) {
        ...
        const GGS_EXsourceFileMap  _temp_8472 = var_cas_sourceFileMap ;
        if (_temp_8472._isBuilt ()) {
          _temp_8472 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_8376->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (218)) ;
        }
        GGS_string var_cas_filePath ;
        var_cas_filePath = var_cas_fullPath.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (219)) ;
        if (((var_cas_sourceKind)._operator_isEqual (GGS_EXsourceFileKind::constructor_externSourceFile (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
          if (((var_cas_filePath.reader_firstCharacterOrNul (_inLexique COMMA_SOURCE_FILE_AT_LINE (221)))._operator_isEqual (GGS_char (true, '/'))).isBuiltAndTrue ()) {
          ...
          var_cas_externSourceFileList._dotAssign_operation (var_cas_fullPath.reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (226))) ;
          var_cas_externSourceFileList.appendCstring ("\n") ;
        }else{
          var_cas_galgasSourceList.appendCstring ("SOURCES += ") ;
          var_cas_galgasSourceList._dotAssign_operation (var_cas_fullPath.reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (228)).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (228))) ;
    ...
    {
      GGS_stringset::cEnumerator enumerator_9213 (var_cas_pathSet, true) ;
      while (enumerator_9213.hc ()) {
        var_cas_pathesString._dotAssign_operation (enumerator_9213._key (HERE)) ;
        enumerator_9213.next () ;
      }
    }
    ...
    var_cas_fileListPath = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (240)))._operator_concat (GGS_string (true, "/GALGAS_OUTPUT/file_list.mke")) ;
    GGS_bool automatic_var_0 ;
    const GGS_string _temp_9631 = var_cas_newFileListContents ;
    if (_temp_9631._isBuilt ()) {
      _temp_9631 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (241)) ;
    }
  }
  GGS_string var_cas_oldCommonFile ;
  var_cas_oldCommonFile = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (244)).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (244)))._operator_concat (GGS_string (true, "/common_files_for_make/makefile.mke")) ;
  if (((var_cas_oldCommonFile.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (245)))._operator_and ((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
    ...
    var_cas_projectDir = GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (247)).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (247)) ;
    GGS_stringlist  var_cas_projectDirectories ;
    var_cas_projectDirectories = var_cas_projectDir.reader_directories (_inLexique, GGS_bool (true, false) COMMA_SOURCE_FILE_AT_LINE (248)) ;
    GGS_bool var_cas_ok ;
    var_cas_ok = GGS_bool (true, true) ;
    {
      GGS_stringlist::cEnumerator enumerator_10246 (var_cas_projectDirectories, true) ;
      const GGS_stringlist::cElement * operand_10246 = NULL ;
      while (((operand_10246 = enumerator_10246.nextObject ()))) {
        macroValidPointer (operand_10246) ;
        if ((((operand_10246->mValue)._operator_isNotEqual (GGS_string (true, "common_files_for_make")))._operator_and ((operand_10246->mValue)._operator_isNotEqual (GGS_string (true, "makefile_macosx_universal")))).isBuiltAndTrue ()) {
          GGS_string var_cas_fullDirPath ;
          var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_10246->mValue))._operator_concat (GGS_string (true, "/")) ;
          GGS_string var_cas_makefilePath ;
          var_cas_makefilePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile")) ;
          if ((var_cas_makefilePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (255))).isBuiltAndTrue ()) {
            GGS_stringlist  var_cas_c ;
            var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefilePath COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string (true, "include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (256)) ;
            if (((var_cas_c.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (257)))._operator_isEqual (GGS_uint (true, 2U))).isBuiltAndTrue ()) {
          ...
          if ((var_cas_makefile64Path.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (266))).isBuiltAndTrue ()) {
            GGS_stringlist  var_cas_c ;
            var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefile64Path COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string (true, "include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (267)) ;
            if (((var_cas_c.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (268)))._operator_isEqual (GGS_uint (true, 2U))).isBuiltAndTrue ()) {
          ...
          if ((var_cas_makefileMkePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (277))).isBuiltAndTrue ()) {
            GGS_stringlist  var_cas_c ;
            var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefileMkePath COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string (true, "include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (278)) ;
            if (((var_cas_c.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (279)))._operator_isEqual (GGS_uint (true, 2U))).isBuiltAndTrue ()) {
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ...
      GGS_string var_cas_projectDir ;
      var_cas_projectDir = GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (290)).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (290)) ;
      GGS_stringlist  var_cas_projectDirectories ;
      var_cas_projectDirectories = var_cas_projectDir.reader_directories (_inLexique, GGS_bool (true, false) COMMA_SOURCE_FILE_AT_LINE (291)) ;
      {
        GGS_stringlist::cEnumerator enumerator_12396 (var_cas_projectDirectories, true) ;
        const GGS_stringlist::cElement * operand_12396 = NULL ;
        while (((operand_12396 = enumerator_12396.nextObject ()))) {
          macroValidPointer (operand_12396) ;
          if ((((operand_12396->mValue)._operator_isNotEqual (GGS_string (true, "common_files_for_make")))._operator_and ((operand_12396->mValue)._operator_isNotEqual (GGS_string (true, "makefile_macosx_universal")))).isBuiltAndTrue ()) {
            GGS_string var_cas_fullDirPath ;
            var_cas_fullDirPath = (((var_cas_projectDir)._operator_concat (GGS_string (true, "/")))._operator_concat (operand_12396->mValue))._operator_concat (GGS_string (true, "/")) ;
            GGS_string var_cas_makefilePath ;
            var_cas_makefilePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile")) ;
            if ((var_cas_makefilePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (297))).isBuiltAndTrue ()) {
              ...
              GGS_stringlist  var_cas_c ;
              var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefilePath COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string (true, "include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (299)) ;
              ...
              const GGS_string _temp_13080 = var_cas_newContents ;
              if (_temp_13080._isBuilt ()) {
                _temp_13080 (HERE)->method_writeToFile (_inLexique, var_cas_makefilePath COMMA_SOURCE_FILE_AT_LINE (301)) ;
              }
            }
            GGS_string var_cas_makefile64Path ;
            var_cas_makefile64Path = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile64")) ;
            if ((var_cas_makefile64Path.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (305))).isBuiltAndTrue ()) {
              ...
              GGS_stringlist  var_cas_c ;
              var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefile64Path COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string (true, "include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (307)) ;
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string (true, "include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
              const GGS_string _temp_13650 = var_cas_newContents ;
              if (_temp_13650._isBuilt ()) {
                _temp_13650 (HERE)->method_writeToFile (_inLexique, var_cas_makefile64Path COMMA_SOURCE_FILE_AT_LINE (309)) ;
              }
            }
            GGS_string var_cas_makefileMkePath ;
            var_cas_makefileMkePath = (var_cas_fullDirPath)._operator_concat (GGS_string (true, "makefile.mke")) ;
            if ((var_cas_makefileMkePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (313))).isBuiltAndTrue ()) {
              ...
              GGS_stringlist  var_cas_c ;
              var_cas_c = GGS_string::constructor_stringWithContentsOfFile (_inLexique, var_cas_makefileMkePath COMMA_HERE).reader_componentsSeparatedByString (_inLexique, GGS_string (true, "include ../common_files_for_make/makefile.mke") COMMA_SOURCE_FILE_AT_LINE (315)) ;
              GGS_string var_cas_newContents ;
              var_cas_newContents = GGS_string::constructor_componentsJoinedByString (_inLexique, var_cas_c, GGS_string (true, "include ../galgas_sources/GALGAS_OUTPUT/file_list.mke") COMMA_HERE) ;
              const GGS_string _temp_14230 = var_cas_newContents ;
              if (_temp_14230._isBuilt ()) {
                _temp_14230 (HERE)->method_writeToFile (_inLexique, var_cas_makefileMkePath COMMA_SOURCE_FILE_AT_LINE (317)) ;
              }
            }
          }
        }
      ...
      var_cas_oldDir = var_cas_oldCommonFile.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (322)) ;
      ...
      GGS_string::class_method_removeDirectoryRecursively (_inLexique, var_cas_oldDir COMMA_SOURCE_FILE_AT_LINE (324)) ;
  ...
  if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("galgas_cli_options", "doNotGenerateXcodeProject" COMMA_SOURCE_FILE_AT_LINE (331))))._operator_not ()).isBuiltAndTrue ()) {
    GGS_stringlist  var_cas_xcodeFiles ;
    var_cas_xcodeFiles = var_cas_targetFileListMap.reader_listForKey (_inLexique, GGS_string (true, "xcode") COMMA_SOURCE_FILE_AT_LINE (332)) ;
    if ((((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_xcodeFiles.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (333)))._operator_strictSup (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
      GGS_string var_cas_XcodeProjectDir ;
      var_cas_XcodeProjectDir = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (334)).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (334)))._operator_concat (GGS_string (true, "/project_xcode")) ;
      GGS_stringlist  var_cas_iconFiles ;
      var_cas_iconFiles = var_cas_XcodeProjectDir.reader_regularFilesWithExtensions (_inLexique, GGS_bool (true, false), GGS_stringlist ::constructor_listWithValue (GGS_string (true, "icns")) COMMA_SOURCE_FILE_AT_LINE (336)) ;
      GGS_stringlist  var_cas_xcodeProjects ;
      var_cas_xcodeProjects = var_cas_XcodeProjectDir.reader_directoriesWithExtensions (_inLexique, GGS_bool (true, false), GGS_stringlist ::constructor_listWithValue (GGS_string (true, "xcodeproj")) COMMA_SOURCE_FILE_AT_LINE (337)) ;
      if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (339)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
      ...
      }else if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (341)))._operator_strictSup (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
      ...
      }else if (((var_cas_xcodeProjects.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (343)))._operator_isEqual (GGS_uint (true, 1U))).isBuiltAndTrue ()) {
        GGS_string var_cas_name ;
        const GGS_stringlist  _temp_15805 = var_cas_xcodeProjects ;
        if (_temp_15805._isBuilt ()) {
          _temp_15805 (HERE)->method_first (_inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (344)) ;
        }
        ...
        {
          GGS_stringlist::cEnumerator enumerator_16406 (var_cas_xcodeFiles, true) ;
          const GGS_stringlist::cElement * operand_16406 = NULL ;
          while (((operand_16406 = enumerator_16406.nextObject ()))) {
            macroValidPointer (operand_16406) ;
            var_cas_intermediateString._dotAssign_operation (operand_16406->mValue) ;
            var_cas_intermediateString.appendCstring ("\n") ;
          }
        }
        GGS_string var_cas_intermediateFilePath ;
        var_cas_intermediateFilePath = (GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (360)))._operator_concat (GGS_string (true, "/GALGAS_OUTPUT/file_list_for_xcode_project.txt")) ;
        GGS_bool var_cas_written ;
        const GGS_string _temp_16752 = var_cas_intermediateString ;
        if (_temp_16752._isBuilt ()) {
          _temp_16752 (HERE)->method_writeToFileWhenDifferentContents (_inLexique, var_cas_intermediateFilePath, var_cas_written COMMA_SOURCE_FILE_AT_LINE (362)) ;
        }
        if ((var_cas_written).isBuiltAndTrue ()) {
          {
            GGS_stringlist::cEnumerator enumerator_16898 (var_cas_xcodeFiles, true) ;
            const GGS_stringlist::cElement * operand_16898 = NULL ;
            while (((operand_16898 = enumerator_16898.nextObject ()))) {
              macroValidPointer (operand_16898) ;
              GGS_string var_cas_fullPath ;
              GGS_EXsourceFileKind var_cas_sourceKind ;
              const GGS_EXsourceFileMap  _temp_17006 = var_cas_sourceFileMap ;
              if (_temp_17006._isBuilt ()) {
                _temp_17006 (HERE)->method_searchKey (_inLexique, GGS_lstring ::constructor_new (_inLexique, operand_16898->mValue, GGS_location (_inLexique) COMMA_HERE), var_cas_fullPath, var_cas_sourceKind COMMA_SOURCE_FILE_AT_LINE (368)) ;
              }
              ...
              case GGS_EXsourceFileKind::enum_lexiqueSourceFile:
                {
                var_cas_scannerSourceSet._addAssign_operation (operand_16898->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_guiSourceFile:
                {
                var_cas_guiSourceSet._addAssign_operation (operand_16898->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_optionSourceFile:
                {
                var_cas_optionSourceSet._addAssign_operation (operand_16898->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_syntaxSourceFile:
                {
                var_cas_syntaxSourceSet._addAssign_operation (operand_16898->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_semanticsSourceFile:
                {
                var_cas_semanticsSourceSet._addAssign_operation (operand_16898->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_grammarSourceFile:
                {
                var_cas_grammarSourceSet._addAssign_operation (operand_16898->mValue) ;
                }
                break ;
              case GGS_EXsourceFileKind::enum_programSourceFile:
                {
                var_cas_programSourceSet._addAssign_operation (operand_16898->mValue) ;
                }
                break ;
          ...
          ::routine_generateXcodeProject (_inLexique,  var_cas_externSourceSet,  var_cas_guiSourceSet,  var_cas_scannerSourceSet,  var_cas_optionSourceSet,  var_cas_semanticsSourceSet,  var_cas_syntaxSourceSet,  var_cas_grammarSourceSet,  var_cas_programSourceSet,  var_cas_name.reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (398)),  var_cas_fullXcodePath.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (399)),  var_cas_iconFiles COMMA_SOURCE_FILE_AT_LINE (389)) ;
        }
      }
    }
  }
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_609_23_ (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (621)))).isBuiltAndTrue ()) {
    _inLexique.printMessage (((GGS_string (true, "------ Compile file '"))._operator_concat (var_cas_fileName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (622))))._operator_concat (GGS_string (true, "'\n")) COMMA_SOURCE_FILE_AT_LINE (622)) ;
  }
  galgas_LL1_grammar::_performSourceFileParsing_compileFile (_inLexique,
                                  (var_cas_fileName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (624)))._operator_concat (GGS_string (true, ".dep")),
                                  NULL,
                                  var_cas_fileName
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_609_23_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_609_23_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_609_23_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_609_23_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
                                GGS_stringset  &/* var_cas_ioImportedSemanticsComponentNameSet */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_galgas_component_ggs_LL1_compile_component_609_23_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_compile) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_668_34_ (galgas_scanner & _inLexique,
...
void ggs_LL1_compile_component::
pr_parse_lexique_for_importing_ggs_LL1_compile_component_668_34_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_683_33_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext) {
...
void ggs_LL1_compile_component::
pr_parse_syntax_for_importing_ggs_LL1_compile_component_683_33_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_700_44_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
...
void ggs_LL1_compile_component::
pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_700_44_parse (galgas_scanner & /* _inLexique */) {
}
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_719_43_ (galgas_scanner & _inLexique,
                                const GGS_lstring  var_cas_inFileName,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
...
void ggs_LL1_compile_component::
pr_parse_option_component_for_importing_ggs_LL1_compile_component_719_43_parse (galgas_scanner & /* _inLexique */) {
}
