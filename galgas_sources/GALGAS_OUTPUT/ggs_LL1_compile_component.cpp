...
//                    november 26th, 2009, at 17h10'54"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_galgas_component_ggs_LL1_compile_component_141_23_ (galgas_scanner & inLexique,
  ...
  if (cond_13304.isBuiltAndTrue ()) {
    ...
    if (temp_13278.isBuilt ()) {
      temp_13278 (HERE)->method_writeToFileWhenDifferentContents (inLexique, var_cas_fileListPath, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (298)) ;
    }
  }
