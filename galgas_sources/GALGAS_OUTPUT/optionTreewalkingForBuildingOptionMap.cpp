...
_treewalking_routine_optionComponentRoot (C_Compiler & _inLexique,
  ...
  { GGS__list_commandLineOption::element_type * _ptr = _currentObject->mOptions.firstObject () ;
    while (_ptr != NULL) {
...
_treewalking_routine_commandLineOption (C_Compiler & _inLexique,
  ...
  if ((var_cas_ioOptionNameSet.reader_hasKey (_inLexique, _currentObject->mOptionInternalName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (51)) COMMA_SOURCE_FILE_AT_LINE (51))).isBuiltAndTrue ()) {
    _currentObject->mOptionInternalName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "the '"))._operator_concat (_currentObject->mOptionInternalName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (52))))._operator_concat (GGS_string (true, "' command line option has been already declared")) COMMA_SOURCE_FILE_AT_LINE (53)) ;
    ...
    _currentObject->mOptionTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only the @bool, @uint or @string types are allowed here") COMMA_SOURCE_FILE_AT_LINE (76)) ;
  }
