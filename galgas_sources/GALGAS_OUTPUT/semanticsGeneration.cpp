...
result << var_cas_TYPE_NAME ;
result << " * & ioResult" ;
GGS_attributeList::cEnumerator enumerator_2215 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_2215 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2215 = enumerator_2215.nextObject ()))) {
macroValidPointer (operand_2215) ;
result << ",\n"
  "                                   const GALGAS_" ;
result << operand_2215->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (51)) ;
result << " * inOperand" ;
...
result << var_cas_TYPE_NAME ;
result << " * & ioResult" ;
GGS_attributeList::cEnumerator enumerator_2475 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_2475 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2475 = enumerator_2475.nextObject ()))) {
macroValidPointer (operand_2475) ;
result << ",\n"
  "                                    GALGAS_" ;
result << operand_2475->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (57)) ;
result << " * & outOperand" ;
...
result << var_cas_TYPE_NAME ;
result << " * & ioResult" ;
GGS_attributeList::cEnumerator enumerator_2847 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_2847 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2847 = enumerator_2847.nextObject ()))) {
macroValidPointer (operand_2847) ;
result << ",\n"
  "                                    GALGAS_" ;
result << operand_2847->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (64)) ;
result << " * & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (64)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << var_cas_TYPE_NAME ;
result << " * inList" ;
GGS_attributeList::cEnumerator enumerator_3216 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_3216 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3216 = enumerator_3216.nextObject ()))) {
macroValidPointer (operand_3216) ;
result << ",\n"
  "                               GALGAS_" ;
result << operand_3216->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (71)) ;
result << " * & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (71)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << var_cas_TYPE_NAME ;
result << " * inList" ;
GGS_attributeList::cEnumerator enumerator_3570 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_3570 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3570 = enumerator_3570.nextObject ()))) {
macroValidPointer (operand_3570) ;
result << ",\n"
  "                               GALGAS_" ;
result << operand_3570->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (78)) ;
result << " * & outOperand" ;
...
result << " * inEnumeratedObject,\n"
  ...
  "  \n"
  "  //--- Attribute access\n" ;
GGS_attributeList::cEnumerator enumerator_4093 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_4093 = NULL ;
while (((operand_4093 = enumerator_4093.nextObject ()))) {
macroValidPointer (operand_4093) ;
result << "    public : const GALGAS_" ;
result << operand_4093->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (91)) ;
result << " * attribute_" ;
result << operand_4093->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (91)) ;
result << " (void) const ;\n" ;
}
result << "  } ;\n"
  "} ;\n"
...
result << var_cas_TYPE_NAME ;
result << " * & ioResult" ;
GGS_attributeList::cEnumerator enumerator_4595 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_4595 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4595 = enumerator_4595.nextObject ()))) {
macroValidPointer (operand_4595) ;
result << ",\n"
  "                          const GALGAS_" ;
result << operand_4595->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (104)) ;
result << " * inOperand" ;
...
result << var_cas_TYPE_NAME ;
result << " * & ioResult,\n" ;
GGS_attributeList::cEnumerator enumerator_4836 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_4836 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4836 = enumerator_4836.nextObject ()))) {
macroValidPointer (operand_4836) ;
result << "                           GALGAS_" ;
result << operand_4836->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (111)) ;
result << " * & outOperand" ;
...
result << var_cas_TYPE_NAME ;
result << " * & ioResult,\n" ;
GGS_attributeList::cEnumerator enumerator_5171 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_5171 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5171 = enumerator_5171.nextObject ()))) {
macroValidPointer (operand_5171) ;
result << "                          GALGAS_" ;
result << operand_5171->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (119)) ;
result << " * & outOperand" ;
...
macroValidPointer (operand_5501) ;
result << "                      GALGAS_" ;
result << operand_5501->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (128)) ;
result << " * & outOperand" ;
...
result << var_cas_TYPE_NAME ;
result << " * inList,\n" ;
GGS_attributeList::cEnumerator enumerator_5818 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_5818 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5818 = enumerator_5818.nextObject ()))) {
macroValidPointer (operand_5818) ;
result << "                      GALGAS_" ;
result << operand_5818->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (136)) ;
result << " * & outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (136)) ;
result << ",\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
result << var_cas_ATTRIBUTE_LIST.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (13)) ;
...
result << " ;\n"
  ...
  "PMSInt32 GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << "::compareSortedListElements (const AC_GALGAS__root * inLeftAttributeList [],\n"
  "                                                         const AC_GALGAS__root * inRightAttributeList []) {\n"
  "  PMSInt32 result = 0 ;\n" ;
GGS_sortDescriptorList::cEnumerator enumerator_1345 (var_cas_SORT_ATTRIBUTE_LIST, true) ;
const GGS_sortDescriptorList::cElement * operand_1345 = NULL ;
while (((operand_1345 = enumerator_1345.nextObject ()))) {
macroValidPointer (operand_1345) ;
result << "  if (result == 0) {\n"
  "    result = " ;
if (operand_1345->mAscendingOrder.boolValue ()) {
}else {
result << "- " ;
}
result << "inLeftAttributeList [" ;
result << operand_1345->mAttributeIndex.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (29)) ;
...
result << "::constructor_sortedListWithValue (" ;
const GGS_string var_cas_COL0 = GGS_string::stringWithColumnCount (result) ;
GGS_attributeList::cEnumerator enumerator_2548 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_2548 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2548 = enumerator_2548.nextObject ()))) {
macroValidPointer (operand_2548) ;
result << "const GALGAS_" ;
result << operand_2548->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (60)) ;
result << " * inOperand" ;
...
result << "::constructor_emptySortedList (THERE) ;\n"
  "  const AC_GALGAS__root * attributeArray [" ;
result << var_cas_ATTRIBUTE_LIST.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (65)) ;
result << "] = {" ;
GGS_attributeList::cEnumerator enumerator_2924 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_2924 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2924 = enumerator_2924.nextObject ()))) {
macroValidPointer (operand_2924) ;
result << "inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (67)) ;
if (enumerator_2924.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << var_cas_TYPE_NAME ;
result << " * & ioResult" ;
GGS_attributeList::cEnumerator enumerator_3223 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_3223 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3223 = enumerator_3223.nextObject ()))) {
macroValidPointer (operand_3223) ;
result << ",\n"
  "                          const GALGAS_" ;
result << operand_3223->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (79)) ;
result << " * inOperand" ;
...
result << "] = {" ;
GGS_attributeList::cEnumerator enumerator_3575 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_3575 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3575 = enumerator_3575.nextObject ()))) {
macroValidPointer (operand_3575) ;
result << "inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (86)) ;
if (enumerator_3575.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << var_cas_TYPE_NAME ;
result << " * & ioResult,\n" ;
GGS_attributeList::cEnumerator enumerator_3876 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_3876 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3876 = enumerator_3876.nextObject ()))) {
macroValidPointer (operand_3876) ;
result << "                           GALGAS_" ;
result << operand_3876->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (98)) ;
result << " * & outOperand" ;
...
result << "                           C_Compiler * inCompiler\n"
  "                           COMMA_LOCATION_ARGS) {\n" ;
GGS_attributeList::cEnumerator enumerator_4154 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_4154 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "::insulate (ioResult COMMA_HERE) ;\n"
  "    const AC_GALGAS__root * attributeArray [" ;
result << var_cas_ATTRIBUTE_LIST.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (108)) ;
result << "] = {" ;
GGS_attributeList::cEnumerator enumerator_4441 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_4441 = NULL ;
...
GGS_attributeList::cEnumerator enumerator_4597 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_4597 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4597 = enumerator_4597.nextObject ()))) {
macroValidPointer (operand_4597) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (115)) ;
result << " = (GALGAS_" ;
result << operand_4597->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (115)) ;
result << " *) attributeArray [" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (115)) ;
result << "] ;\n"
  "    macroValidObjectThere (outOperand" ;
...
result << ", GALGAS_" ;
result << operand_4597->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (116)) ;
result << ") ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << var_cas_TYPE_NAME ;
result << " * & ioResult,\n" ;
GGS_attributeList::cEnumerator enumerator_5053 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_5053 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_5053 = enumerator_5053.nextObject ()))) {
macroValidPointer (operand_5053) ;
result << "                        GALGAS_" ;
result << operand_5053->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
result << " * & outOperand" ;
...
result << "                        C_Compiler * inCompiler\n"
  "                        COMMA_LOCATION_ARGS) {\n" ;
GGS_attributeList::cEnumerator enumerator_5322 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_5322 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "] = {" ;
GGS_attributeList::cEnumerator enumerator_5609 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_5609 = NULL ;
...
GGS_attributeList::cEnumerator enumerator_5765 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_5765 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = (GALGAS_" ;
result << operand_5765->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (142)) ;
result << " *) attributeArray [" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (142)) ;
result << "] ;\n"
  "    macroValidObjectThere (outOperand" ;
...
result << ", GALGAS_" ;
result << operand_5765->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
result << ") ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << var_cas_TYPE_NAME ;
result << " * inList,\n" ;
GGS_attributeList::cEnumerator enumerator_7249 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_7249 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7249 = enumerator_7249.nextObject ()))) {
macroValidPointer (operand_7249) ;
result << "                      GALGAS_" ;
result << operand_7249->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (177)) ;
result << " * & outOperand" ;
...
result << "                      C_Compiler * inCompiler\n"
  "                      COMMA_LOCATION_ARGS) {\n" ;
GGS_attributeList::cEnumerator enumerator_7512 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_7512 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "  if (inList != NULL) {\n"
  "    const AC_GALGAS__root * attributeArray [" ;
result << var_cas_ATTRIBUTE_LIST.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (186)) ;
result << "] = {" ;
GGS_attributeList::cEnumerator enumerator_7739 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_7739 = NULL ;
while (((operand_7739 = enumerator_7739.nextObject ()))) {
macroValidPointer (operand_7739) ;
result << "NULL" ;
if (enumerator_7739.hasNextObject ()) {
result << ", " ;
}
}
result << "} ;\n"
  "    inList->smallestObjectAttributeList (attributeArray, inCompiler COMMA_THERE) ;\n" ;
GGS_attributeList::cEnumerator enumerator_7898 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_7898 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7898 = enumerator_7898.nextObject ()))) {
macroValidPointer (operand_7898) ;
result << "    outOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (193)) ;
result << " = (GALGAS_" ;
result << operand_7898->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (193)) ;
result << " *) attributeArray [" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (193)) ;
result << "] ;\n"
  "    macroValidObjectThere (outOperand" ;
...
result << ", GALGAS_" ;
result << operand_7898->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (194)) ;
result << ") ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << var_cas_TYPE_NAME ;
result << " * inList,\n" ;
GGS_attributeList::cEnumerator enumerator_8351 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_8351 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8351 = enumerator_8351.nextObject ()))) {
macroValidPointer (operand_8351) ;
result << "                      GALGAS_" ;
result << operand_8351->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
result << " * & outOperand" ;
...
result << "                      C_Compiler * inCompiler\n"
  "                      COMMA_LOCATION_ARGS) {\n" ;
GGS_attributeList::cEnumerator enumerator_8614 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_8614 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_8614 = enumerator_8614.nextObject ()))) {
macroValidPointer (operand_8614) ;
result << "  macroReleaseObject (outOperand" ;
...
result << "  if (inList != NULL) {\n"
  "    const AC_GALGAS__root * attributeArray [" ;
result << var_cas_ATTRIBUTE_LIST.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (212)) ;
result << "] = {" ;
GGS_attributeList::cEnumerator enumerator_8841 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_8841 = NULL ;
while (((operand_8841 = enumerator_8841.nextObject ()))) {
macroValidPointer (operand_8841) ;
result << "NULL" ;
if (enumerator_8841.hasNextObject ()) {
result << ", " ;
}
}
result << "} ;\n"
  "    inList->greatestObjectAttributeList (attributeArray, inCompiler COMMA_THERE) ;\n" ;
GGS_attributeList::cEnumerator enumerator_9000 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_9000 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << " = (GALGAS_" ;
result << operand_9000->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (219)) ;
result << " *) attributeArray [" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (219)) ;
result << "] ;\n"
  "    macroValidObjectThere (outOperand" ;
...
result << ", GALGAS_" ;
result << operand_9000->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
result << ") ;\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
...
result << " * inEnumeratedObject,\n"
  ...
  "}\n"
  "\n" ;
GGS_attributeList::cEnumerator enumerator_9581 (var_cas_ATTRIBUTE_LIST, true) ;
const GGS_attributeList::cElement * operand_9581 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "const GALGAS_" ;
result << operand_9581->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (235)) ;
result << " * GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << "::cEnumerator::attribute_" ;
result << operand_9581->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (235)) ;
result << " (void) const {\n"
  "  const GALGAS_" ;
result << operand_9581->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (236)) ;
result << " * result = (const GALGAS_" ;
result << operand_9581->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (236)) ;
result << " *) directAccess (" ;
...
result << " COMMA_HERE) ;\n"
  "  macroValidObject (result, const GALGAS_" ;
result << operand_9581->mAttributeTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (237)) ;
result << ") ;\n"
  "  return result ;\n"
  "}\n" ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
