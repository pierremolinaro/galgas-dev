...
// At index 19 : <select_optionSyntax_0>, in file 'optionSyntax.ggs', line 35
, END_PRODUCTION
// At index 20 : <select_optionSyntax_0>, in file 'optionSyntax.ggs', line 35
, NONTERMINAL (1) // <option>
, NONTERMINAL (2) // <select_optionSyntax_0>
, END_PRODUCTION
// At index 23 : <select_optionSyntax_1>, in file 'optionSyntax.ggs', line 61
, END_PRODUCTION
// At index 24 : <select_optionSyntax_1>, in file 'optionSyntax.ggs', line 61
, TERMINAL (C_Lexique_galgas_5F_scanner::kToken_default) // $default$
, NONTERMINAL (4) // <select_optionSyntax_2>
, END_PRODUCTION
// At index 27 : <select_optionSyntax_2>, in file 'optionSyntax.ggs', line 65
, TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) // $literal_string$
, END_PRODUCTION
// At index 29 : <select_optionSyntax_2>, in file 'optionSyntax.ggs', line 65
...
19, // index 2 : <select_optionSyntax_0>, in file 'optionSyntax.ggs', line 35
20, // index 3 : <select_optionSyntax_0>, in file 'optionSyntax.ggs', line 35
23, // index 4 : <select_optionSyntax_1>, in file 'optionSyntax.ggs', line 61
24, // index 5 : <select_optionSyntax_1>, in file 'optionSyntax.ggs', line 61
27, // index 6 : <select_optionSyntax_2>, in file 'optionSyntax.ggs', line 65
29, // index 7 : <select_optionSyntax_2>, in file 'optionSyntax.ggs', line 65
...
void cGrammar_optionLL_31_grammar::nt_option_5F_component_5F_start_5F_symbol_parse (C_Lexique_galgas_5F_scanner * inLexique) {
  rule_optionSyntax_option_5F_component_5F_start_5F_symbol_i0_parse(inLexique) ;
}
...
void cGrammar_optionLL_31_grammar::nt_option_5F_component_5F_start_5F_symbol_ (GALGAS_optionComponentAST & parameter_1,
  ...
  rule_optionSyntax_option_5F_component_5F_start_5F_symbol_i0_(parameter_1, inLexique) ;
}
    ...
    macroMyNew (scanner, C_Lexique_galgas_5F_scanner (inCompiler, "", "", inCompiler->ioParametersPtr (), filePath COMMA_HERE)) ;
      if (scanner->sourceText () != NULL) {
        ...
        if (ok && ! scanner->mParseOnlyFlag) {
          cGrammar_optionLL_31_grammar grammar ;
          grammar.nt_option_5F_component_5F_start_5F_symbol_ (parameter_1, scanner) ;
        }
      }else{
        C_String message ;
...
void cGrammar_optionLL_31_grammar::nt_option_parse (C_Lexique_galgas_5F_scanner * inLexique) {
  rule_optionSyntax_option_i1_parse(inLexique) ;
}
...
void cGrammar_optionLL_31_grammar::nt_option_ (GALGAS_commandLineOptionListAST & parameter_1,
                                C_Lexique_galgas_5F_scanner * inLexique) {
  rule_optionSyntax_option_i1_(parameter_1, inLexique) ;
}
