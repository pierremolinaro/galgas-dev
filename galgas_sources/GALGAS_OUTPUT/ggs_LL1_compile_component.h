...
class ggs_LL1_compile_component {
  ...
  protected : void pr_galgas_component_ggs_LL1_compile_component_658_23_ (galgas_scanner &,
                                GGS_M_lexiqueComponents  &,
                                GGS_M_semanticsComponents  &,
                                GGS_M_syntaxComponents  &,
                                GGS_M_grammarComponents  &,
  ...
  protected : void pr_galgas_component_ggs_LL1_compile_component_658_23_importGrammarForSemantics (galgas_scanner &,
                                GGS_M_grammarComponents  &,
                                GGS_M_optionComponents  &,
                                GGS_EXsemanticContext &) ;

  protected : void pr_galgas_component_ggs_LL1_compile_component_658_23_importLexique (galgas_scanner &,
                                GGS_M_lexiqueComponents  &) ;

  protected : void pr_galgas_component_ggs_LL1_compile_component_658_23_importOptions (galgas_scanner &,
                                GGS_M_optionComponents  &) ;

  protected : void pr_galgas_component_ggs_LL1_compile_component_658_23_importSemantics (galgas_scanner &,
                                GGS_M_semanticsComponents  &,
                                GGS_EXsemanticContext &,
                                GGS_stringset  &) ;

  protected : void pr_galgas_component_ggs_LL1_compile_component_658_23_importSyntax (galgas_scanner &,
                                GGS_M_syntaxComponents  &,
                                GGS_EXsemanticContext &) ;

  protected : void pr_parse_lexique_for_importing_ggs_LL1_compile_component_717_34_ (galgas_scanner &,
                                const GGS_lstring  ,
                                GGS_M_lexiqueComponents  &) ;
