...
class ggs_LL1_compile_component {
  ...
  protected : void pr_parse_lexique_for_importing_ggs_LL1_compile_component_614_34_ (galgas_scanner &,
                                const GGS_lstring  ,
                                GGS_M_lexiqueComponents  &) ;

  protected : void pr_parse_lexique_for_importing_ggs_LL1_compile_component_614_34_parse (galgas_scanner & inLexique) ;

  protected : void pr_parse_syntax_for_importing_ggs_LL1_compile_component_629_33_ (galgas_scanner &,
                                const GGS_lstring  ,
                                GGS_M_syntaxComponents  &,
                                GGS_EXsemanticContext &) ;

  protected : void pr_parse_syntax_for_importing_ggs_LL1_compile_component_629_33_parse (galgas_scanner & inLexique) ;

  protected : void pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_646_44_ (galgas_scanner &,
                                const GGS_lstring  ,
                                GGS_M_grammarComponents  &,
                                GGS_M_optionComponents  &,
                                GGS_EXsemanticContext &) ;

  protected : void pr_parse_grammar_component_for_importing_ggs_LL1_compile_component_646_44_parse (galgas_scanner & inLexique) ;

  protected : void pr_parse_option_component_for_importing_ggs_LL1_compile_component_665_43_ (galgas_scanner &,
                                const GGS_lstring  ,
                                GGS_M_optionComponents  &) ;

  protected : void pr_parse_option_component_for_importing_ggs_LL1_compile_component_665_43_parse (galgas_scanner & inLexique) ;
