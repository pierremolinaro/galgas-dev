...
void routine_addTypeList (C_Compiler &,
                                ...
                                const GGS_lstring  ,
                                GGS_unifiedTypeMap  & COMMA_LOCATION_ARGS) ;

//---------------------------------------------------------------------------*
//                                                                           *
//                     Routine 'addPredefinedTypeList'                       *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_addPredefinedTypeList (C_Compiler &,
                                const GGS_string ,
                                GGS_unifiedTypeMap  & COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Map Enumerator
  ...
  //--- Iterator method
    ...
    public : /* const */ GGS_semanticDeclarationAST   & _mDeclarationAbstractSyntaxTree (LOCATION_ARGS) const ;
  } ;
} ;
...
class e_collectedTypeMap {
  public : GGS_semanticDeclarationAST  mDeclarationAbstractSyntaxTree ;

  public : e_collectedTypeMap (void) ;
} ;
