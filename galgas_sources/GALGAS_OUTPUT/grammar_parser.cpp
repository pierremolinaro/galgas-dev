...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_100_6_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
        ...
        switch (select_grammar_parser_1 (_inLexique)) {
          case 1 : {
            ...
            var_cas_optionComponentsMap.modifier_insertKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (152)) ;
            } break ;
          case 2 : {
                ...
                while ((operand_8207 != NULL)) {
                  ...
                  if (((operand_8207->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (202))) != (GGS_string (true, "parse"))).isBuiltAndTrue ()) {
                    ...
                    if (var_cas_altSignatureMap._isBuilt ()) {
                      var_cas_altSignatureMap (HERE)->method_searchKey (_inLexique, operand_8207->mKey, automatic_var_0, automatic_var_1 SOURCE_FILE_AT_LINE (203)) ;
                    }
                  }
                  operand_8207 = operand_8207->nextObject () ;
                }
              }else{
                var_cas_nonterminalSymbolsMapForGrammar.modifier_insertKey (_inLexique, operand_7346->mKey, operand_7346->mInfo.mNonterminalSymbolParametersMap SOURCE_FILE_AT_LINE (207)) ;
              }
        ...
        switch (select_grammar_parser_5 (_inLexique)) {
          ...
          case 2 : {
            ...
            if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
              var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_returnedMetamodelName, var_cas_returnedEntityName, automatic_var_2, automatic_var_3 SOURCE_FILE_AT_LINE (232)) ;
            }
            var_cas_startSymbolEntityAndMetamodelMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_returnedEntityName, var_cas_returnedMetamodelName SOURCE_FILE_AT_LINE (233)) ;
            } break ;
          default :
            break ;
        }
        var_cas_grammarAltMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_signature, var_cas_returnedEntityName SOURCE_FILE_AT_LINE (235)) ;
  ...
  if (var_cas_nonterminalSymbolsMapForGrammar._isBuilt ()) {
    var_cas_nonterminalSymbolsMapForGrammar (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_startSymbolName, var_cas_startSymbolIndex, var_cas_startSymbolAltMap SOURCE_FILE_AT_LINE (244)) ;
  }
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_9983 = var_cas_startSymbolAltMap.firstObject () ;
  while ((operand_9983 != NULL)) {
    macroValidPointer (operand_9983) ;
    GGS_L_signature  var_cas_altMap ;
    GGS_lstring  var_cas_returnedEntity ;
    if (var_cas_grammarAltMap._isBuilt ()) {
      var_cas_grammarAltMap (HERE)->method_searchKey (_inLexique, operand_9983->mKey, var_cas_altMap, var_cas_returnedEntity SOURCE_FILE_AT_LINE (249)) ;
    }
    ::routine_checkSignature_ForGrammarComponent (_inLexique,  operand_9983->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (_inLexique),  operand_9983->mKey.reader_location (_inLexique SOURCE_FILE_AT_LINE (250)) SOURCE_FILE_AT_LINE (250)) ;
    if (((var_cas_returnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (251))) != (operand_9983->mInfo.mReturnedEntityTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (251)))).isBuiltAndTrue ()) {
    }
    operand_9983 = operand_9983->nextObject () ;
  }
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_10386 = var_cas_grammarAltMap.firstObject () ;
  while ((operand_10386 != NULL)) {
    macroValidPointer (operand_10386) ;
    GGS_L_signature  automatic_var_4 ;
    GGS_lstring  automatic_var_5 ;
    if (var_cas_startSymbolAltMap._isBuilt ()) {
      var_cas_startSymbolAltMap (HERE)->method_searchKey (_inLexique, operand_10386->mKey, automatic_var_4, automatic_var_5 SOURCE_FILE_AT_LINE (256)) ;
    }
    operand_10386 = operand_10386->nextObject () ;
  }
  if (var_cas_grammarName._isBuilt () &&
    ...
    ::routine_analyzeGrammar (_inLexique,  var_cas_grammarName,  var_cas_grammarClass,  var_cas_startSymbolIndex,  var_cas_lexiqueName,  GGS_location (_inLexique),  var_cas_terminalSymbolMap,  var_cas_syntaxComponentsList,  var_cas_nonterminalSymbolsMapForGrammar,  var_cas_startSymbolEntityAndMetamodelMap SOURCE_FILE_AT_LINE (259)) ;
  }
  var_cas_ioGrammarComponentsMap.modifier_insertKey (_inLexique, var_cas_grammarName, var_cas_startSymbolAltMap, var_cas_lexiqueName, var_cas_optionComponentsMap SOURCE_FILE_AT_LINE (271)) ;
...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_100_6_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_100_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_100_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_constraintComponents  &/* var_cas_ioConstraintComponentMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_100_6_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_constraintComponents  &/* var_cas_ioConstraintComponentMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
    ...
    while (syntaxRepeat) {
        ...
        switch (select_grammar_parser_1 (_inLexique)) {
          case 1 : {
            ...
            switch (select_grammar_parser_2 (_inLexique)) {
              case 1 : {
                if (var_cas_optionComponentsMap._isBuilt ()) {
                  var_cas_optionComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (457)) ;
                }
                } break ;
              case 2 : {
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_in) COMMA_HERE) ;
                ...
                nt_parse_option_component_for_importing_ (_inLexique, var_cas_fileName, var_cas_importedOptionComponentsMap) ;
                if (var_cas_importedOptionComponentsMap._isBuilt ()) {
                  var_cas_importedOptionComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (467)) ;
                }
                } break ;
              default :
                break ;
            ...
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
            var_cas_optionComponentsMap.modifier_insertKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (470)) ;
            } break ;
          case 2 : {
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_syntax) COMMA_HERE) ;
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_grammarAltMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_signature, var_cas_returnedMetamodelName SOURCE_FILE_AT_LINE (497)) ;
      switch (select_repeat_grammar_parser_4 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_label) COMMA_HERE) ;
          _inLexique._assignFromAttribute_tokenString (var_cas_altName) ;
  ...
  var_cas_ioGrammarComponentsMap.modifier_insertKey (_inLexique, var_cas_grammarName, var_cas_grammarAltMap, var_cas_lexiqueName, var_cas_optionComponentsMap SOURCE_FILE_AT_LINE (506)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_100_6_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
