...
void grammar_parser::
pr_galgas_component_grammar_parser_218_23_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  }
  {
    ...
    while (((operand_16390 = enumerator_16390.nextObject ()))) {
      ...
      GGS_signatureForGrammarAnalysis  automatic_var_16435_0 ;
      const GGS_nonterminalSymbolLabelMapForGrammarAnalysis  temp_16426 = var_cas_startSymbolAltMap ;
      if (temp_16426.isBuilt ()) {
        temp_16426 (HERE)->method_searchKey (inLexique, operand_16390->mKey, automatic_var_16435_0 COMMA_SOURCE_FILE_AT_LINE (411)) ;
      }
    }
  }
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_8 = true ;
            while (syntaxRepeat_8) {
                ...
                inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_non_5F_terminal_5F_symbol) COMMA_HERE) ;
                GGS_uint  var_cas_nonterminalIndex ;
                GGS_nonterminalSymbolLabelMapForGrammarAnalysis  automatic_var_16807_0 ;
                const GGS_nonTerminalSymbolMapForGrammarAnalysis  temp_16762 = var_cas_nonterminalSymbolsMapForGrammar ;
                if (temp_16762.isBuilt ()) {
                  temp_16762 (HERE)->method_searchKey (inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalIndex, automatic_var_16807_0 COMMA_SOURCE_FILE_AT_LINE (421)) ;
                }
  ...
  if (var_cas_grammarName.isBuilt () &&
      ...
      (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/GALGAS_OUTPUT")).isBuilt () &&
      GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent ().isBuilt ()) {
    ::routine_analyzeGrammar (inLexique,  var_cas_grammarName,  var_cas_grammarClass,  var_cas_startSymbolIndex,  var_cas_lexiqueName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (433)),  GGS_location (inLexique),  var_cas_actuallyUsedTerminalSymbolMap,  var_cas_syntaxComponentsListWithFixedInfos,  var_cas_nonterminalSymbolsMapForGrammar,  var_cas_unusedNonTerminalSymbolsForGrammar,  (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/GALGAS_OUTPUT")),  GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent () COMMA_SOURCE_FILE_AT_LINE (429)) ;
  }
...
void grammar_parser::
pr_galgas_component_grammar_parser_218_23_importGrammarForSemantics (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_grammar) COMMA_HERE) ;
    ...
    while (syntaxRepeat_1) {
        ...
        switch (select_grammar_5F_parser_2 (inLexique)) {
          case 1 : {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
            const GGS_bool cond_22854 = (var_cas_ioOptionsComponentsMap.reader_hasKey (var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (699)))).operator_not () ;
...
void grammar_parser::
pr_galgas_component_grammar_parser_218_23_importLexique (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_grammar) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
...
void grammar_parser::
pr_galgas_component_grammar_parser_218_23_importOptions (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_grammar) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
...
void grammar_parser::
pr_galgas_component_grammar_parser_218_23_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
...
void grammar_parser::
pr_galgas_component_grammar_parser_218_23_importSyntax (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_grammar) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
