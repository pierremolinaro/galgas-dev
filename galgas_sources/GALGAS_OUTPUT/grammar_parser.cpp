              ...
              while (((operand_12712 = enumerator_12712.nextObject ()))) {
                ...
                if (cond_13630.isBuiltAndTrue ()) {
                  ...
                  if (var_cas_nonterminalSymbolsMapForGrammar.isBuilt ()) {
                    var_cas_nonterminalSymbolsMapForGrammar (HERE)->method_searchKey (inLexique, operand_12712->mKey, automatic_var_12968_0, var_cas_altSignatureMap COMMA_SOURCE_FILE_AT_LINE (326)) ;
                  }
                  {
                    ...
                    while (((operand_13004 = enumerator_13004.nextObject ()))) {
                      ...
                      if (var_cas_temp.isBuilt ()) {
                        var_cas_temp (HERE)->method_searchKey (inLexique, operand_13004->mKey, var_cas_importedAltSignature COMMA_SOURCE_FILE_AT_LINE (330)) ;
                      }
                    ...
                    while (((operand_13440 = enumerator_13440.nextObject ()))) {
                      ...
                      if (cond_13588.isBuiltAndTrue ()) {
                        ...
                        if (var_cas_altSignatureMap.isBuilt ()) {
                          var_cas_altSignatureMap (HERE)->method_searchKey (inLexique, operand_13440->mKey, automatic_var_13570_0 COMMA_SOURCE_FILE_AT_LINE (335)) ;
                        }
                      }
                    }
                  }
    ...
    while (((operand_15059 = enumerator_15059.nextObject ()))) {
      ...
      GGS_productionRuleListForGrammarAnalysis  var_cas_fixedProductionRuleList = GGS_productionRuleListForGrammarAnalysis ::constructor_emptyList () ;
      {
        ...
        while (((operand_15175 = enumerator_15175.nextObject ()))) {
          ...
          if (var_cas_nonterminalSymbolsMapForGrammar.isBuilt ()) {
            var_cas_nonterminalSymbolsMapForGrammar (HERE)->method_searchKey (inLexique, operand_15175->mLeftNonterminalSymbol, var_cas_nonTerminalIndex, automatic_var_15585_0 COMMA_SOURCE_FILE_AT_LINE (388)) ;
          }
  ...
  }
  {
    ...
    while (((operand_16192 = enumerator_16192.nextObject ()))) {
      ...
      if (var_cas_grammarAltMap.isBuilt ()) {
        var_cas_grammarAltMap (HERE)->method_searchKey (inLexique, operand_16192->mKey, var_cas_altMap COMMA_SOURCE_FILE_AT_LINE (408)) ;
      }
  ...
  }
  {
    ...
    while (((operand_16416 = enumerator_16416.nextObject ()))) {
      ...
      if (var_cas_startSymbolAltMap.isBuilt ()) {
        var_cas_startSymbolAltMap (HERE)->method_searchKey (inLexique, operand_16416->mKey, automatic_var_16461_0 COMMA_SOURCE_FILE_AT_LINE (412)) ;
      }
    }
  }
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_8 = true ;
            while (syntaxRepeat_8) {
                ...
                if (var_cas_nonterminalSymbolsMapForGrammar.isBuilt ()) {
                  var_cas_nonterminalSymbolsMapForGrammar (HERE)->method_searchKey (inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalIndex, automatic_var_16833_0 COMMA_SOURCE_FILE_AT_LINE (422)) ;
                }
