...
pr_galgas_component_grammar_parser_100_24_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
        ...
        switch (select_grammar_parser_5 (_inLexique)) {
          ...
          case 2 : {
            ...
            GGS_M_semanticsEntitiesForUse  var_cas_9404 ;
            GGS_entityToImplementMap  var_cas_9407 ;
            GGS_stringset  var_cas_9410 ;
            if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
              var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_returnedMetamodelName, var_cas_returnedEntityName, var_cas_9404, var_cas_9407, var_cas_9410 SOURCE_FILE_AT_LINE (234)) ;
            }
  ...
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_9993 = var_cas_startSymbolAltMap.firstObject () ;
  while ((operand_9993 != NULL)) {
    ...
    if (var_cas_grammarAltMap._isBuilt ()) {
      var_cas_grammarAltMap (HERE)->method_searchKey (_inLexique, operand_9993->mKey, var_cas_altMap, var_cas_returnedEntity SOURCE_FILE_AT_LINE (251)) ;
    }
    ::routine_checkSignature_ForGrammarComponent (_inLexique,  operand_9993->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (_inLexique),  operand_9993->mKey.reader_location (_inLexique SOURCE_FILE_AT_LINE (252)) SOURCE_FILE_AT_LINE (252)) ;
    if (((var_cas_returnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (253))) != (operand_9993->mInfo.mReturnedEntityTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (253)))).isBuiltAndTrue ()) {
    }
    operand_9993 = operand_9993->nextObject () ;
  }
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_10396 = var_cas_grammarAltMap.firstObject () ;
  while ((operand_10396 != NULL)) {
    macroValidPointer (operand_10396) ;
    GGS_L_signature  var_cas_10472 ;
    GGS_lstring  var_cas_10475 ;
    if (var_cas_startSymbolAltMap._isBuilt ()) {
      var_cas_startSymbolAltMap (HERE)->method_searchKey (_inLexique, operand_10396->mKey, var_cas_10472, var_cas_10475 SOURCE_FILE_AT_LINE (258)) ;
    }
    operand_10396 = operand_10396->nextObject () ;
  }
