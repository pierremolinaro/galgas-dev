...
pr_galgas_component_grammar_parser_101_23_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_4730 = (var_cas_grammarName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (114))).operator_isNotEqual (var_cas_basename) ;
    ...
    while (syntaxRepeat_1) {
        ...
        switch (select_grammar_parser_2 (inLexique)) {
          case 1 : {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
            const GGS_bool cond_6360 = (var_cas_ioOptionsComponentsMap.reader_hasKey (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (165)) COMMA_SOURCE_FILE_AT_LINE (165))).operator_not () ;
            if (cond_6360.isBuiltAndTrue ()) {
          ...
          case 2 : {
            ...
            const GGS_bool cond_7534 = (var_cas_lexiqueName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (197))).operator_isNotEqual (var_cas_importedLexiqueComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (197))) ;
            if (cond_7534.isBuiltAndTrue ()) {
            ...
            var_cas_syntaxComponentsList.addAssign_operation (var_cas_importedNonterminalSymbolsMap, var_cas_importedProductionRulesList, var_cas_syntaxComponentName) ;
            {
              ...
              while (((operand_7862 = enumerator_7862.nextObject ()))) {
                ...
                const GGS_bool cond_8741 = var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (inLexique, operand_7862->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) COMMA_SOURCE_FILE_AT_LINE (206)) ;
                if (cond_8741.isBuiltAndTrue ()) {
                  GGS_M_nonterminalSymbolAltsForGrammar  var_cas_altSignatureMap ;
                  const GGS_M_nonTerminalSymbolsForGrammar  temp_8076 = var_cas_nonterminalSymbolsMapForGrammar ;
                  if (temp_8076.isBuilt ()) {
                    temp_8076 (HERE)->method_searchKey (inLexique, operand_7862->mKey, var_cas_altSignatureMap COMMA_SOURCE_FILE_AT_LINE (208)) ;
                  }
                  {
                    GGS_M_nonterminalSymbolAltsForGrammar::cEnumerator enumerator_8141 (var_cas_altSignatureMap, true) ;
                    const GGS_M_nonterminalSymbolAltsForGrammar::cElement * operand_8141 = NULL ;
                    while (((operand_8141 = enumerator_8141.nextObject ()))) {
                      macroValidPointer (operand_8141) ;
                      ...
                      const GGS_M_nonterminalSymbolAltsForGrammar  temp_8315 = var_cas_temp ;
                      if (temp_8315.isBuilt ()) {
                        temp_8315 (HERE)->method_searchKey (inLexique, operand_8141->mKey, var_cas_importedAltSignature COMMA_SOURCE_FILE_AT_LINE (212)) ;
                      }
                      ::routine_checkSignature_ForGrammarComponent (inLexique,  var_cas_importedAltSignature,  operand_8141->mInfo.mFormalParametersList,  operand_8141->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (213)),  operand_8141->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (213)) COMMA_SOURCE_FILE_AT_LINE (213)) ;
                    }
                  }
                  {
                    GGS_M_nonterminalSymbolAltsForGrammar::cEnumerator enumerator_8551 (operand_7862->mInfo.mNonterminalSymbolParametersMap, true) ;
                    const GGS_M_nonterminalSymbolAltsForGrammar::cElement * operand_8551 = NULL ;
                    while (((operand_8551 = enumerator_8551.nextObject ()))) {
                      macroValidPointer (operand_8551) ;
                      const GGS_bool cond_8699 = (operand_8551->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (216))).operator_isNotEqual (GGS_string ("parse")) ;
                      if (cond_8699.isBuiltAndTrue ()) {
                        GGS_L_signature  automatic_var_0 ;
                        const GGS_M_nonterminalSymbolAltsForGrammar  temp_8665 = var_cas_altSignatureMap ;
                        if (temp_8665.isBuilt ()) {
                          temp_8665 (HERE)->method_searchKey (inLexique, operand_8551->mKey, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (217)) ;
                        }
                      }
                    }
                  }
                }else if (cond_8741.isBuiltAndFalse ()) {
  ...
  const GGS_M_nonTerminalSymbolsForGrammar  temp_9593 = var_cas_nonterminalSymbolsMapForGrammar ;
  if (temp_9593.isBuilt ()) {
    temp_9593 (HERE)->method_searchKeyGetID (inLexique, var_cas_startSymbolName, var_cas_startSymbolIndex, var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (246)) ;
  }
  {
    GGS_M_nonterminalSymbolAltsForGrammar::cEnumerator enumerator_9718 (var_cas_startSymbolAltMap, true) ;
    const GGS_M_nonterminalSymbolAltsForGrammar::cElement * operand_9718 = NULL ;
    while (((operand_9718 = enumerator_9718.nextObject ()))) {
      macroValidPointer (operand_9718) ;
      GGS_L_signature  var_cas_altMap ;
      const GGS_M_nonterminalSymbolAltsForGrammar  temp_9776 = var_cas_grammarAltMap ;
      if (temp_9776.isBuilt ()) {
        temp_9776 (HERE)->method_searchKey (inLexique, operand_9718->mKey, var_cas_altMap COMMA_SOURCE_FILE_AT_LINE (250)) ;
      }
      ::routine_checkSignature_ForGrammarComponent (inLexique,  operand_9718->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (inLexique),  operand_9718->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (251)) COMMA_SOURCE_FILE_AT_LINE (251)) ;
    }
  }
  {
    GGS_M_nonterminalSymbolAltsForGrammar::cEnumerator enumerator_9926 (var_cas_grammarAltMap, true) ;
    const GGS_M_nonterminalSymbolAltsForGrammar::cElement * operand_9926 = NULL ;
    while (((operand_9926 = enumerator_9926.nextObject ()))) {
      macroValidPointer (operand_9926) ;
      GGS_L_signature  automatic_var_1 ;
      const GGS_M_nonterminalSymbolAltsForGrammar  temp_9962 = var_cas_startSymbolAltMap ;
      if (temp_9962.isBuilt ()) {
        temp_9962 (HERE)->method_searchKey (inLexique, operand_9926->mKey, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (254)) ;
      }
    }
  }
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_7 = true ;
            while (syntaxRepeat_7) {
                ...
                const GGS_M_nonTerminalSymbolsForGrammar  temp_10296 = var_cas_nonterminalSymbolsMapForGrammar ;
                if (temp_10296.isBuilt ()) {
                  temp_10296 (HERE)->method_searchKeyGetID (inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalIndex, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (264)) ;
                }
    ...
    while (syntaxRepeat_1) {
        ...
        switch (select_grammar_parser_2 (inLexique)) {
          case 1 : {
            ...
            switch (select_grammar_parser_3 (inLexique)) {
              case 1 : {
                const GGS_M_optionComponents  temp_15198 = var_cas_ioOptionsComponentsMap ;
                if (temp_15198.isBuilt ()) {
                  temp_15198 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (512)) ;
                }
                } break ;
              case 2 : {
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_in) COMMA_HERE) ;
                ...
                GGS_M_optionComponents  var_cas_importedOptionComponentsMap = GGS_M_optionComponents ::constructor_emptyMap (inLexique COMMA_HERE) ;
                nt_parse_option_component_for_importing_ (inLexique, var_cas_fileName, var_cas_importedOptionComponentsMap) ;
                const GGS_M_optionComponents  temp_15595 = var_cas_importedOptionComponentsMap ;
                if (temp_15595.isBuilt ()) {
                  temp_15595 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (522)) ;
                }
                } break ;
              default :
                break ;
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
            const GGS_bool cond_15908 = (var_cas_ioOptionsComponentsMap.reader_hasKey (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (525)) COMMA_SOURCE_FILE_AT_LINE (525))).operator_not () ;
            if (cond_15908.isBuiltAndTrue ()) {
