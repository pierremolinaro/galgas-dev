...
void grammar_parser::
pr_galgas_component_grammar_parser_92_24_ (galgas_scanner & lexique_var_,
    ...
    while (syntaxRepeat) {
        ...
        switch (select_grammar_parser_1 (lexique_var_)) {
          case 1 : {
            ...
            var_cas_optionComponentsMap.methode_insertKey (lexique_var_, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap) ;
            } break ;
          case 2 : {
            ...
            GGS_M_nonTerminalSymbolsForGrammar::element_type * operand_6806 = var_cas_importedNonterminalSymbolsMap.firstObject () ;
            while ((operand_6806 != NULL)) {
              macroValidPointer (operand_6806) ;
              if ((var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (operand_6806->mKey.reader_value ())).isBuiltAndTrue ()) {
                GGS_M_nonterminalSymbolAltsForGrammar  var_cas_altSignatureMap ;
                var_cas_nonterminalSymbolsMapForGrammar.methode_searchKey (lexique_var_, operand_6806->mKey, var_cas_altSignatureMap) ;
                GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_7149 = var_cas_altSignatureMap.firstObject () ;
                while ((operand_7149 != NULL)) {
                  macroValidPointer (operand_7149) ;
                  GGS_M_nonterminalSymbolAltsForGrammar  var_cas_temp ;
                  var_cas_temp = operand_6806->mInfo.mNonterminalSymbolParametersMap ;
                  GGS_L_signature_ForGrammarComponent  var_cas_importedAltSignature ;
                  var_cas_temp.methode_searchKey (lexique_var_, operand_7149->mKey, var_cas_importedAltSignature) ;
                  ::routine_checkSignature_ForGrammarComponent (lexique_var_,  var_cas_importedAltSignature,  operand_7149->mInfo.mFormalParametersList,  operand_7149->mKey.reader_location ()) ;
                  operand_7149 = operand_7149->nextObject () ;
                }
                GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_7606 = operand_6806->mInfo.mNonterminalSymbolParametersMap.firstObject () ;
                while ((operand_7606 != NULL)) {
                  macroValidPointer (operand_7606) ;
                  if (((operand_7606->mKey.reader_value ()) != (GGS_string (true, "parse"))).isBuiltAndTrue ()) {
                    GGS_L_signature_ForGrammarComponent  var_cas_7811 ;
                    var_cas_altSignatureMap.methode_searchKey (lexique_var_, operand_7606->mKey, var_cas_7811) ;
                  }
                  operand_7606 = operand_7606->nextObject () ;
                }
              }else{
                var_cas_nonterminalSymbolsMapForGrammar.methode_insertKey (lexique_var_, operand_6806->mKey, operand_6806->mInfo.mNonterminalSymbolParametersMap) ;
              }
              operand_6806 = operand_6806->nextObject () ;
            }
            } break ;
          default :
            break ;
  ...
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_8846 = var_cas_startSymbolAltMap.firstObject () ;
  while ((operand_8846 != NULL)) {
    macroValidPointer (operand_8846) ;
    GGS_L_signature_ForGrammarComponent  var_cas_altMap ;
    var_cas_grammarAltMap.methode_searchKey (lexique_var_, operand_8846->mKey, var_cas_altMap) ;
    ::routine_checkSignature_ForGrammarComponent (lexique_var_,  operand_8846->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (lexique_var_)) ;
    operand_8846 = operand_8846->nextObject () ;
  }
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_9123 = var_cas_grammarAltMap.firstObject () ;
  while ((operand_9123 != NULL)) {
    macroValidPointer (operand_9123) ;
    GGS_L_signature_ForGrammarComponent  var_cas_9203 ;
    var_cas_startSymbolAltMap.methode_searchKey (lexique_var_, operand_9123->mKey, var_cas_9203) ;
    operand_9123 = operand_9123->nextObject () ;
  }
...
void grammar_parser::
pr_galgas_component_grammar_parser_92_24_importLexique (galgas_scanner & lexique_var_,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_grammar) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
...
void grammar_parser::
pr_galgas_component_grammar_parser_92_24_importSyntax (galgas_scanner & lexique_var_,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_grammar) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
...
void grammar_parser::
pr_galgas_component_grammar_parser_92_24_importSemantics (galgas_scanner & lexique_var_,
...
void grammar_parser::
pr_galgas_component_grammar_parser_92_24_importGrammarForSemantics (galgas_scanner & lexique_var_,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_grammar) ;
  GGS_lstring  var_cas_grammarName ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
    ...
    while (syntaxRepeat) {
        ...
        switch (select_grammar_parser_1 (lexique_var_)) {
          case 1 : {
            ...
            switch (select_grammar_parser_2 (lexique_var_)) {
              case 1 : {
                var_cas_optionComponentsMap.methode_searchKey (lexique_var_, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap) ;
                } break ;
              case 2 : {
                lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_in) ;
                GGS_lstring  var_cas_fileName ;
...
void grammar_parser::
pr_galgas_component_grammar_parser_92_24_importOptions (galgas_scanner & lexique_var_,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_grammar) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
