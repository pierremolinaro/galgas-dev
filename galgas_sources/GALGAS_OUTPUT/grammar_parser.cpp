...
//                    february 28th, 2008, at 21h42'51"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_galgas_component_grammar_parser_109_4_ (galgas_scanner & _inLexique,
        ...
        switch (select_grammar_parser_1 (_inLexique)) {
            ...
            switch (select_grammar_parser_2 (_inLexique)) {
              case 1 : {
                if (var_cas_ioOptionsComponentsMap._isBuilt ()) {
                  var_cas_ioOptionsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (148)) ;
                }
                } break ;
              case 2 : {
                ...
                if (var_cas_importedOptionComponentsMap._isBuilt ()) {
                  var_cas_importedOptionComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (158)) ;
                }
                } break ;
              default :
                break ;
          ...
          case 2 : {
            ...
            if (var_cas_syntaxComponentsMap._isBuilt ()) {
              var_cas_syntaxComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_syntaxComponentName, var_cas_importedNonterminalSymbolsMap, var_cas_importedProductionRulesList, var_cas_importedLexiqueComponentName COMMA_SOURCE_FILE_AT_LINE (189)) ;
            }
            ...
            while (((operand_7926 = (GGS_M_nonTerminalSymbolsForGrammar::cElement *) enumerator_7926.nextObject ()))) {
              ...
              if ((var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (_inLexique, operand_7926->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (204)) COMMA_SOURCE_FILE_AT_LINE (204))).isBuiltAndTrue ()) {
                ...
                if (var_cas_nonterminalSymbolsMapForGrammar._isBuilt ()) {
                  var_cas_nonterminalSymbolsMapForGrammar (HERE)->method_searchKey (_inLexique, operand_7926->mKey, var_cas_altSignatureMap COMMA_SOURCE_FILE_AT_LINE (206)) ;
                }
                ...
                while (((operand_8278 = (GGS_M_nonterminalSymbolAltsForGrammar::cElement *) enumerator_8278.nextObject ()))) {
                  ...
                  if (var_cas_temp._isBuilt ()) {
                    var_cas_temp (HERE)->method_searchKey (_inLexique, operand_8278->mKey, var_cas_importedAltSignature, var_cas_importedReturnedType COMMA_SOURCE_FILE_AT_LINE (211)) ;
                  }
                ...
                while (((operand_8792 = (GGS_M_nonterminalSymbolAltsForGrammar::cElement *) enumerator_8792.nextObject ()))) {
                  ...
                  if (((operand_8792->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (215)))._operator_isNotEqual (GGS_string (true, "parse"))).isBuiltAndTrue ()) {
                    ...
                    if (var_cas_altSignatureMap._isBuilt ()) {
                      var_cas_altSignatureMap (HERE)->method_searchKey (_inLexique, operand_8792->mKey, automatic_var_0, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (216)) ;
                    }
                  }
                }
        ...
        switch (select_grammar_parser_5 (_inLexique)) {
          ...
          case 2 : {
            ...
            if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
              var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_returnedMetamodelName, var_cas_returnedEntityName, automatic_var_2, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (245)) ;
            }
  ...
  if (var_cas_nonterminalSymbolsMapForGrammar._isBuilt ()) {
    var_cas_nonterminalSymbolsMapForGrammar (HERE)->method_searchKeyGetID (_inLexique, var_cas_startSymbolName, var_cas_startSymbolIndex, var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (257)) ;
  }
  ...
  while (((operand_10570 = (GGS_M_nonterminalSymbolAltsForGrammar::cElement *) enumerator_10570.nextObject ()))) {
    ...
    if (var_cas_grammarAltMap._isBuilt ()) {
      var_cas_grammarAltMap (HERE)->method_searchKey (_inLexique, operand_10570->mKey, var_cas_altMap, var_cas_returnedEntity COMMA_SOURCE_FILE_AT_LINE (262)) ;
    }
  ...
  while (((operand_10977 = (GGS_M_nonterminalSymbolAltsForGrammar::cElement *) enumerator_10977.nextObject ()))) {
    ...
    if (var_cas_startSymbolAltMap._isBuilt ()) {
      var_cas_startSymbolAltMap (HERE)->method_searchKey (_inLexique, operand_10977->mKey, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (269)) ;
    }
  }
        ...
        switch (select_grammar_parser_1 (_inLexique)) {
          case 1 : {
            ...
            switch (select_grammar_parser_2 (_inLexique)) {
              case 1 : {
                if (var_cas_ioOptionsComponentsMap._isBuilt ()) {
                  var_cas_ioOptionsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (474)) ;
                }
                } break ;
              case 2 : {
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_in) COMMA_HERE) ;
                ...
                nt_parse_option_component_for_importing_ (_inLexique, var_cas_fileName, var_cas_importedOptionComponentsMap) ;
                if (var_cas_importedOptionComponentsMap._isBuilt ()) {
                  var_cas_importedOptionComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (484)) ;
                }
                } break ;
              default :
                break ;
    ...
    while (syntaxRepeat_4) {
        ...
        switch (select_grammar_parser_5 (_inLexique)) {
          ...
          case 2 : {
            ...
            if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
              var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_returnedMetamodelName, var_cas_returnedEntityName, automatic_var_6, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (516)) ;
            }
            } break ;
          default :
            break ;
