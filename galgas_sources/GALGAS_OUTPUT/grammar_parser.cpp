...
pr_galgas_component_grammar_parser_100_24_ (galgas_scanner & _inLexique,
        ...
        switch (select_grammar_parser_1 (_inLexique)) {
          ...
          case 2 : {
            ...
            if (((var_cas_lexiqueName.reader_value ()) != (var_cas_importedLexiqueComponentName.reader_value ())).isBuiltAndTrue ()) {
                var_cas_syntaxComponentName.reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "this component does not use the previously declared lexique") SOURCE_FILE_AT_LINE (183)) ;
            }
            ...
            while ((operand_7331 != NULL)) {
              ...
              if ((var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (operand_7331->mKey.reader_value ())).isBuiltAndTrue ()) {
                ...
                while ((operand_7674 != NULL)) {
                  ...
                  ::routine_checkSignature_ForGrammarComponent (_inLexique,  var_cas_importedAltSignature,  operand_7674->mInfo.mFormalParametersList,  operand_7331->mKey.reader_location (),  operand_7674->mKey.reader_location () SOURCE_FILE_AT_LINE (199)) ;
  ...
  while ((operand_9996 != NULL)) {
    ...
    ::routine_checkSignature_ForGrammarComponent (_inLexique,  operand_9996->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (_inLexique),  operand_9996->mKey.reader_location () SOURCE_FILE_AT_LINE (252)) ;
