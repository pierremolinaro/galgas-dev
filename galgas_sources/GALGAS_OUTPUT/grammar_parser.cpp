...
pr_galgas_component_grammar_parser_100_24_ (galgas_scanner & _inLexique,
          ...
          case 2 : {
            ...
            while ((operand_7344 != NULL)) {
              ...
              if ((var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (_inLexique, operand_7344->mKey.reader_value (_inLexique SOURCE_FILE_AT_LINE (191)) SOURCE_FILE_AT_LINE (191))).isBuiltAndTrue ()) {
                ...
                while ((operand_7685 != NULL)) {
                  macroValidPointer (operand_7685) ;
                  ...
                  operand_7685 = operand_7685->nextObject () ;
                }
                GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_8214 = operand_7344->mInfo.mNonterminalSymbolParametersMap.firstObject () ;
                while ((operand_8214 != NULL)) {
                  ...
                  operand_8214 = operand_8214->nextObject () ;
                }
              }else{
                var_cas_nonterminalSymbolsMapForGrammar.method_insertKey (_inLexique, operand_7344->mKey, operand_7344->mInfo.mNonterminalSymbolParametersMap SOURCE_FILE_AT_LINE (207)) ;
              }
              operand_7344 = operand_7344->nextObject () ;
            }
            } break ;
          default :
            break ;
  ...
  while ((operand_10005 != NULL)) {
    ...
    if (((var_cas_returnedEntity.reader_value (_inLexique SOURCE_FILE_AT_LINE (253))) != (operand_10005->mInfo.mReturnedEntityTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (253)))).isBuiltAndTrue ()) {
    }
    operand_10005 = operand_10005->nextObject () ;
  }
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_10412 = var_cas_grammarAltMap.firstObject () ;
  while ((operand_10412 != NULL)) {
