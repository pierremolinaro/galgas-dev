...
pr_galgas_component_grammar_parser_100_24_ (galgas_scanner & _inLexique,
          ...
          case 2 : {
            ...
            while ((operand_7346 != NULL)) {
              ...
              if ((var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (_inLexique, operand_7346->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (191)) SOURCE_FILE_AT_LINE (191))).isBuiltAndTrue ()) {
                ...
                GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_7688 = var_cas_altSignatureMap.firstObject () ;
                while ((operand_7688 != NULL)) {
                  ...
                  if (var_cas_temp._isBuilt ()) {
                    var_cas_temp (HERE)->method_searchKey (_inLexique, operand_7688->mKey, var_cas_importedAltSignature, var_cas_importedReturnedType SOURCE_FILE_AT_LINE (198)) ;
                  }
                  ::routine_checkSignature_ForGrammarComponent (_inLexique,  var_cas_importedAltSignature,  operand_7688->mInfo.mFormalParametersList,  operand_7346->mKey.reader_location (_inLexique SOURCE_FILE_AT_LINE (199)),  operand_7688->mKey.reader_location (_inLexique SOURCE_FILE_AT_LINE (199)) SOURCE_FILE_AT_LINE (199)) ;
                  operand_7688 = operand_7688->nextObject () ;
                }
                GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_8217 = operand_7346->mInfo.mNonterminalSymbolParametersMap.firstObject () ;
                while ((operand_8217 != NULL)) {
                  macroValidPointer (operand_8217) ;
                  if (((operand_8217->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (202))) != (GGS_string (true, "parse"))).isBuiltAndTrue ()) {
                    GGS_L_signature  var_cas_8405 ;
                    GGS_lstring  var_cas_8408 ;
                    if (var_cas_altSignatureMap._isBuilt ()) {
                      var_cas_altSignatureMap (HERE)->method_searchKey (_inLexique, operand_8217->mKey, var_cas_8405, var_cas_8408 SOURCE_FILE_AT_LINE (203)) ;
                    }
                  }
                  operand_8217 = operand_8217->nextObject () ;
                }
              }else{
    ...
    while (syntaxRepeat) {
        ...
        switch (select_grammar_parser_5 (_inLexique)) {
          ...
          case 2 : {
            ...
            GGS_M_semanticsEntitiesForUse  var_cas_9420 ;
            GGS_entityToImplementMap  var_cas_9423 ;
            GGS_stringset  var_cas_9426 ;
            if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
              var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_returnedMetamodelName, var_cas_returnedEntityName, var_cas_9420, var_cas_9423, var_cas_9426 SOURCE_FILE_AT_LINE (234)) ;
            }
  ...
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_10009 = var_cas_startSymbolAltMap.firstObject () ;
  while ((operand_10009 != NULL)) {
    macroValidPointer (operand_10009) ;
    GGS_L_signature  var_cas_altMap ;
    GGS_lstring  var_cas_returnedEntity ;
    if (var_cas_grammarAltMap._isBuilt ()) {
      var_cas_grammarAltMap (HERE)->method_searchKey (_inLexique, operand_10009->mKey, var_cas_altMap, var_cas_returnedEntity SOURCE_FILE_AT_LINE (251)) ;
    }
    ::routine_checkSignature_ForGrammarComponent (_inLexique,  operand_10009->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (_inLexique),  operand_10009->mKey.reader_location (_inLexique SOURCE_FILE_AT_LINE (252)) SOURCE_FILE_AT_LINE (252)) ;
    if (((var_cas_returnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (253))) != (operand_10009->mInfo.mReturnedEntityTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (253)))).isBuiltAndTrue ()) {
    }
    operand_10009 = operand_10009->nextObject () ;
  }
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_10418 = var_cas_grammarAltMap.firstObject () ;
  while ((operand_10418 != NULL)) {
    macroValidPointer (operand_10418) ;
    GGS_L_signature  var_cas_10500 ;
    GGS_lstring  var_cas_10503 ;
    if (var_cas_startSymbolAltMap._isBuilt ()) {
      var_cas_startSymbolAltMap (HERE)->method_searchKey (_inLexique, operand_10418->mKey, var_cas_10500, var_cas_10503 SOURCE_FILE_AT_LINE (258)) ;
    }
    operand_10418 = operand_10418->nextObject () ;
  }
