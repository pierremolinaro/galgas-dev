...
pr_galgas_component_grammar_parser_91_24_ (galgas_scanner & lexique_var_,
    ...
    while (syntaxRepeat) {
        ...
        switch (select_grammar_parser_1 (lexique_var_)) {
          ...
          case 2 : {
            ...
            GGS_M_nonTerminalSymbolsForGrammar::element_type * operand_6776 = var_cas_importedNonterminalSymbolsMap.firstObject () ;
            while ((operand_6776 != NULL)) {
              macroValidPointer (operand_6776) ;
              if ((var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (operand_6776->mKey.reader_value ())).isBuiltAndTrue ()) {
                GGS_M_nonterminalSymbolAltsForGrammar  var_cas_altSignatureMap ;
                if (var_cas_nonterminalSymbolsMapForGrammar.isBuilt ()) {
                  var_cas_nonterminalSymbolsMapForGrammar ()->methode_searchKey (lexique_var_, operand_6776->mKey, var_cas_altSignatureMap) ;
                }
                GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_7119 = var_cas_altSignatureMap.firstObject () ;
                while ((operand_7119 != NULL)) {
                  macroValidPointer (operand_7119) ;
                  GGS_M_nonterminalSymbolAltsForGrammar  var_cas_temp ;
                  var_cas_temp = operand_6776->mInfo.mNonterminalSymbolParametersMap ;
                  GGS_L_signature_ForGrammarComponent  var_cas_importedAltSignature ;
                  if (var_cas_temp.isBuilt ()) {
                    var_cas_temp ()->methode_searchKey (lexique_var_, operand_7119->mKey, var_cas_importedAltSignature) ;
                  }
                  ::routine_checkSignature_ForGrammarComponent (lexique_var_,  var_cas_importedAltSignature,  operand_7119->mInfo.mFormalParametersList,  operand_7119->mKey.reader_location ()) ;
                  operand_7119 = operand_7119->nextObject () ;
                }
                GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_7576 = operand_6776->mInfo.mNonterminalSymbolParametersMap.firstObject () ;
                while ((operand_7576 != NULL)) {
                  macroValidPointer (operand_7576) ;
                  if (((operand_7576->mKey.reader_value ()) != (GGS_string (true, "parse"))).isBuiltAndTrue ()) {
                    GGS_L_signature_ForGrammarComponent  var_cas_7781 ;
                    if (var_cas_altSignatureMap.isBuilt ()) {
                      var_cas_altSignatureMap ()->methode_searchKey (lexique_var_, operand_7576->mKey, var_cas_7781) ;
                    }
                  }
                  operand_7576 = operand_7576->nextObject () ;
                }
              }else{
                if (var_cas_nonterminalSymbolsMapForGrammar.isBuilt ()) {
                  var_cas_nonterminalSymbolsMapForGrammar ()->methode_insertKey (lexique_var_, operand_6776->mKey, operand_6776->mInfo.mNonterminalSymbolParametersMap) ;
                }
              }
              operand_6776 = operand_6776->nextObject () ;
            }
            } break ;
          default :
            break ;
  ...
  while ((operand_8816 != NULL)) {
    macroValidPointer (operand_8816) ;
    GGS_L_signature_ForGrammarComponent  var_cas_altMap ;
    if (var_cas_grammarAltMap.isBuilt ()) {
      var_cas_grammarAltMap ()->methode_searchKey (lexique_var_, operand_8816->mKey, var_cas_altMap) ;
    }
    ::routine_checkSignature_ForGrammarComponent (lexique_var_,  operand_8816->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (lexique_var_)) ;
    operand_8816 = operand_8816->nextObject () ;
  }
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_9093 = var_cas_grammarAltMap.firstObject () ;
  while ((operand_9093 != NULL)) {
    macroValidPointer (operand_9093) ;
    GGS_L_signature_ForGrammarComponent  var_cas_9173 ;
    if (var_cas_startSymbolAltMap.isBuilt ()) {
      var_cas_startSymbolAltMap ()->methode_searchKey (lexique_var_, operand_9093->mKey, var_cas_9173) ;
    }
    operand_9093 = operand_9093->nextObject () ;
  }
