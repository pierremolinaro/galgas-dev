...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_101_6_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
        ...
        switch (select_grammar_parser_1 (_inLexique)) {
          case 1 : {
            ...
            switch (select_grammar_parser_2 (_inLexique)) {
              case 1 : {
                if (var_cas_ioOptionsComponentsMap._isBuilt ()) {
                  var_cas_ioOptionsComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (140)) ;
                }
                } break ;
              case 2 : {
                ...
                if (var_cas_importedOptionComponentsMap._isBuilt ()) {
                  var_cas_importedOptionComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (150)) ;
                }
                } break ;
              default :
                break ;
            ...
            var_cas_optionComponentsMap.modifier_insertKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (153)) ;
            } break ;
          case 2 : {
            ...
            if (var_cas_syntaxComponentsMap._isBuilt ()) {
              var_cas_syntaxComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_syntaxComponentName, var_cas_importedNonterminalSymbolsMap, var_cas_importedProductionRulesList, var_cas_importedLexiqueComponentName SOURCE_FILE_AT_LINE (177)) ;
            }
            if (((var_cas_lexiqueName.reader_string (_inLexique SOURCE_FILE_AT_LINE (183))) != (var_cas_importedLexiqueComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (183)))).isBuiltAndTrue ()) {
              var_cas_syntaxComponentName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this component does not use the previously declared lexique") SOURCE_FILE_AT_LINE (185)) ;
            }
            ...
            GGS_M_nonTerminalSymbolsForGrammar::element_type * operand_7459 = var_cas_importedNonterminalSymbolsMap.firstObject () ;
            while ((operand_7459 != NULL)) {
              macroValidPointer (operand_7459) ;
              if ((var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (_inLexique, operand_7459->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (192)) SOURCE_FILE_AT_LINE (192))).isBuiltAndTrue ()) {
                GGS_M_nonterminalSymbolAltsForGrammar  var_cas_altSignatureMap ;
                if (var_cas_nonterminalSymbolsMapForGrammar._isBuilt ()) {
                  var_cas_nonterminalSymbolsMapForGrammar (HERE)->method_searchKey (_inLexique, operand_7459->mKey, var_cas_altSignatureMap SOURCE_FILE_AT_LINE (194)) ;
                }
                GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_7797 = var_cas_altSignatureMap.firstObject () ;
                while ((operand_7797 != NULL)) {
                  macroValidPointer (operand_7797) ;
                  GGS_M_nonterminalSymbolAltsForGrammar  var_cas_temp ;
                  var_cas_temp = operand_7459->mInfo.mNonterminalSymbolParametersMap ;
                  GGS_L_signature  var_cas_importedAltSignature ;
                  GGS_lstring  var_cas_importedReturnedType ;
                  if (var_cas_temp._isBuilt ()) {
                    var_cas_temp (HERE)->method_searchKey (_inLexique, operand_7797->mKey, var_cas_importedAltSignature, var_cas_importedReturnedType SOURCE_FILE_AT_LINE (199)) ;
                  }
                  ::routine_checkSignature_ForGrammarComponent (_inLexique, var_cas_importedAltSignature, operand_7797->mInfo.mFormalParametersList, operand_7459->mKey.reader_location (_inLexique SOURCE_FILE_AT_LINE (200)), operand_7797->mKey.reader_location (_inLexique SOURCE_FILE_AT_LINE (200)) SOURCE_FILE_AT_LINE (200)) ;
                  operand_7797 = operand_7797->nextObject () ;
                }
                GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_8320 = operand_7459->mInfo.mNonterminalSymbolParametersMap.firstObject () ;
                while ((operand_8320 != NULL)) {
                  macroValidPointer (operand_8320) ;
                  if (((operand_8320->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (203))) != (GGS_string (true, "parse"))).isBuiltAndTrue ()) {
                    GGS_L_signature  automatic_var_0 ;
                    GGS_lstring  automatic_var_1 ;
                    if (var_cas_altSignatureMap._isBuilt ()) {
                      var_cas_altSignatureMap (HERE)->method_searchKey (_inLexique, operand_8320->mKey, automatic_var_0, automatic_var_1 SOURCE_FILE_AT_LINE (204)) ;
                    }
                  }
                  operand_8320 = operand_8320->nextObject () ;
                }
              }else{
                var_cas_nonterminalSymbolsMapForGrammar.modifier_insertKey (_inLexique, operand_7459->mKey, operand_7459->mInfo.mNonterminalSymbolParametersMap SOURCE_FILE_AT_LINE (208)) ;
              }
        ...
        switch (select_grammar_parser_5 (_inLexique)) {
          ...
          case 2 : {
            ...
            if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
              var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_returnedMetamodelName, var_cas_returnedEntityName, automatic_var_2, automatic_var_3 SOURCE_FILE_AT_LINE (233)) ;
            }
            var_cas_startSymbolEntityAndMetamodelMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_returnedEntityName, var_cas_returnedMetamodelName SOURCE_FILE_AT_LINE (234)) ;
            } break ;
          default :
            break ;
        }
        var_cas_grammarAltMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_signature, var_cas_returnedEntityName SOURCE_FILE_AT_LINE (236)) ;
  ...
  if (var_cas_nonterminalSymbolsMapForGrammar._isBuilt ()) {
    var_cas_nonterminalSymbolsMapForGrammar (HERE)->method_searchKeyGetIndex (_inLexique, var_cas_startSymbolName, var_cas_startSymbolIndex, var_cas_startSymbolAltMap SOURCE_FILE_AT_LINE (245)) ;
  }
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_10096 = var_cas_startSymbolAltMap.firstObject () ;
  while ((operand_10096 != NULL)) {
    macroValidPointer (operand_10096) ;
    GGS_L_signature  var_cas_altMap ;
    GGS_lstring  var_cas_returnedEntity ;
    if (var_cas_grammarAltMap._isBuilt ()) {
      var_cas_grammarAltMap (HERE)->method_searchKey (_inLexique, operand_10096->mKey, var_cas_altMap, var_cas_returnedEntity SOURCE_FILE_AT_LINE (250)) ;
    }
    ::routine_checkSignature_ForGrammarComponent (_inLexique, operand_10096->mInfo.mFormalParametersList, var_cas_altMap, GGS_location (_inLexique), operand_10096->mKey.reader_location (_inLexique SOURCE_FILE_AT_LINE (251)) SOURCE_FILE_AT_LINE (251)) ;
    if (((var_cas_returnedEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (252))) != (operand_10096->mInfo.mReturnedEntityTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (252)))).isBuiltAndTrue ()) {
    }
    operand_10096 = operand_10096->nextObject () ;
  }
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_10499 = var_cas_grammarAltMap.firstObject () ;
  while ((operand_10499 != NULL)) {
    ...
    if (var_cas_startSymbolAltMap._isBuilt ()) {
      var_cas_startSymbolAltMap (HERE)->method_searchKey (_inLexique, operand_10499->mKey, automatic_var_4, automatic_var_5 SOURCE_FILE_AT_LINE (257)) ;
    }
    operand_10499 = operand_10499->nextObject () ;
  }
  if (var_cas_grammarName._isBuilt () &&
    ...
    ::routine_analyzeGrammar (_inLexique,  var_cas_grammarName,  var_cas_grammarClass,  var_cas_startSymbolIndex,  var_cas_lexiqueName,  GGS_location (_inLexique),  var_cas_terminalSymbolMap,  var_cas_syntaxComponentsList,  var_cas_nonterminalSymbolsMapForGrammar,  var_cas_startSymbolEntityAndMetamodelMap SOURCE_FILE_AT_LINE (260)) ;
  }
  var_cas_ioGrammarComponentsMap.modifier_insertKey (_inLexique, var_cas_grammarName, var_cas_startSymbolAltMap, var_cas_lexiqueName, var_cas_optionComponentsMap SOURCE_FILE_AT_LINE (272)) ;
...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_101_6_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_101_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_101_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_constraintComponents  &/* var_cas_ioConstraintComponentMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_101_6_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_constraintComponents  &/* var_cas_ioConstraintComponentMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
    ...
    while (syntaxRepeat) {
        ...
        switch (select_grammar_parser_1 (_inLexique)) {
          case 1 : {
            ...
            switch (select_grammar_parser_2 (_inLexique)) {
              case 1 : {
                if (var_cas_optionComponentsMap._isBuilt ()) {
                  var_cas_optionComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (458)) ;
                }
                } break ;
              case 2 : {
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_in) COMMA_HERE) ;
                ...
                nt_parse_option_component_for_importing_ (_inLexique, var_cas_fileName, var_cas_importedOptionComponentsMap) ;
                if (var_cas_importedOptionComponentsMap._isBuilt ()) {
                  var_cas_importedOptionComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (468)) ;
                }
                } break ;
              default :
                break ;
            ...
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
            var_cas_optionComponentsMap.modifier_insertKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (471)) ;
            } break ;
          case 2 : {
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_syntax) COMMA_HERE) ;
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_grammarAltMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_signature, var_cas_returnedMetamodelName SOURCE_FILE_AT_LINE (498)) ;
      switch (select_repeat_grammar_parser_4 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_label) COMMA_HERE) ;
          _inLexique._assignFromAttribute_tokenString (var_cas_altName) ;
  ...
  var_cas_ioGrammarComponentsMap.modifier_insertKey (_inLexique, var_cas_grammarName, var_cas_grammarAltMap, var_cas_lexiqueName, var_cas_optionComponentsMap SOURCE_FILE_AT_LINE (507)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_101_6_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
