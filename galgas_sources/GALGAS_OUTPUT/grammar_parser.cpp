...
pr_galgas_component_grammar_parser_91_24_ (galgas_scanner & lexique_var_,
    ...
    while (syntaxRepeat) {
        ...
        switch (select_grammar_parser_1 (lexique_var_)) {
          ...
          case 2 : {
            ...
            GGS_M_nonTerminalSymbolsForGrammar::element_type * operand_6774 = var_cas_importedNonterminalSymbolsMap.firstObject () ;
            while ((operand_6774 != NULL)) {
              macroValidPointer (operand_6774) ;
              if ((var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (operand_6774->mKey.reader_value ())).isBuiltAndTrue ()) {
                GGS_M_nonterminalSymbolAltsForGrammar  var_cas_altSignatureMap ;
                if (var_cas_nonterminalSymbolsMapForGrammar.isBuilt ()) {
                  var_cas_nonterminalSymbolsMapForGrammar ()->methode_searchKey (lexique_var_, operand_6774->mKey, var_cas_altSignatureMap) ;
                }
                GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_7117 = var_cas_altSignatureMap.firstObject () ;
                while ((operand_7117 != NULL)) {
                  macroValidPointer (operand_7117) ;
                  GGS_M_nonterminalSymbolAltsForGrammar  var_cas_temp ;
                  var_cas_temp = operand_6774->mInfo.mNonterminalSymbolParametersMap ;
                  GGS_L_signature_ForGrammarComponent  var_cas_importedAltSignature ;
                  if (var_cas_temp.isBuilt ()) {
                    var_cas_temp ()->methode_searchKey (lexique_var_, operand_7117->mKey, var_cas_importedAltSignature) ;
                  }
                  ::routine_checkSignature_ForGrammarComponent (lexique_var_,  var_cas_importedAltSignature,  operand_7117->mInfo.mFormalParametersList,  operand_7117->mKey.reader_location ()) ;
                  operand_7117 = operand_7117->nextObject () ;
                }
                GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_7574 = operand_6774->mInfo.mNonterminalSymbolParametersMap.firstObject () ;
                while ((operand_7574 != NULL)) {
                  macroValidPointer (operand_7574) ;
                  if (((operand_7574->mKey.reader_value ()) != (GGS_string (true, "parse"))).isBuiltAndTrue ()) {
                    GGS_L_signature_ForGrammarComponent  var_cas_7779 ;
                    if (var_cas_altSignatureMap.isBuilt ()) {
                      var_cas_altSignatureMap ()->methode_searchKey (lexique_var_, operand_7574->mKey, var_cas_7779) ;
                    }
                  }
                  operand_7574 = operand_7574->nextObject () ;
                }
              }else{
                if (var_cas_nonterminalSymbolsMapForGrammar.isBuilt ()) {
                  var_cas_nonterminalSymbolsMapForGrammar ()->methode_insertKey (lexique_var_, operand_6774->mKey, operand_6774->mInfo.mNonterminalSymbolParametersMap) ;
                }
              }
              operand_6774 = operand_6774->nextObject () ;
            }
            } break ;
          default :
            break ;
  ...
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_8814 = var_cas_startSymbolAltMap.firstObject () ;
  while ((operand_8814 != NULL)) {
    macroValidPointer (operand_8814) ;
    GGS_L_signature_ForGrammarComponent  var_cas_altMap ;
    if (var_cas_grammarAltMap.isBuilt ()) {
      var_cas_grammarAltMap ()->methode_searchKey (lexique_var_, operand_8814->mKey, var_cas_altMap) ;
    }
    ::routine_checkSignature_ForGrammarComponent (lexique_var_,  operand_8814->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (lexique_var_)) ;
    operand_8814 = operand_8814->nextObject () ;
  }
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_9091 = var_cas_grammarAltMap.firstObject () ;
  while ((operand_9091 != NULL)) {
    macroValidPointer (operand_9091) ;
    GGS_L_signature_ForGrammarComponent  var_cas_9171 ;
    if (var_cas_startSymbolAltMap.isBuilt ()) {
      var_cas_startSymbolAltMap ()->methode_searchKey (lexique_var_, operand_9091->mKey, var_cas_9171) ;
    }
    operand_9091 = operand_9091->nextObject () ;
  }
  ...
  if (var_cas_ioGrammarComponentsMap.isBuilt ()) {
