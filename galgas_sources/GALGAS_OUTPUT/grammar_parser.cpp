...
pr_galgas_component_grammar_parser_218_23_ (galgas_scanner & inLexique,
  ...
  GGS_string var_cas_basename = GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (230)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (230)) ;
  const GGS_bool cond_9552 = (var_cas_grammarName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (231))).operator_isNotEqual (var_cas_basename) ;
        ...
        switch (select_grammar_parser_2 (inLexique)) {
          case 1 : {
            ...
            switch (select_grammar_parser_3 (inLexique)) {
              case 1 : {
                const GGS_M_optionComponents  temp_10488 = var_cas_ioOptionsComponentsMap ;
                if (temp_10488.isBuilt ()) {
                  temp_10488 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (269)) ;
                }
                } break ;
              case 2 : {
                ...
                const GGS_M_optionComponents  temp_10885 = var_cas_importedOptionComponentsMap ;
                if (temp_10885.isBuilt ()) {
                  temp_10885 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (279)) ;
                }
                } break ;
              default :
                break ;
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
            const GGS_bool cond_11198 = (var_cas_ioOptionsComponentsMap.reader_hasKey (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) COMMA_SOURCE_FILE_AT_LINE (282))).operator_not () ;
            if (cond_11198.isBuiltAndTrue ()) {
          ...
          case 2 : {
            ...
            const GGS_M_syntaxComponents  temp_12009 = var_cas_syntaxComponentsMap ;
            if (temp_12009.isBuilt ()) {
              temp_12009 (HERE)->method_searchKey (inLexique, var_cas_syntaxComponentName, var_cas_importedNonterminalSymbolsMap, var_cas_importedProductionRulesList, var_cas_importedLexiqueComponentName COMMA_SOURCE_FILE_AT_LINE (308)) ;
            }
            const GGS_bool cond_12379 = (var_cas_lexiqueName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (314))).operator_isNotEqual (var_cas_importedLexiqueComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (314))) ;
            if (cond_12379.isBuiltAndTrue ()) {
            ...
            {
              GGS_nonTerminalSymbolMapForGrammarAnalysis::cEnumerator enumerator_12638 (var_cas_importedNonterminalSymbolsMap, true) ;
              const GGS_nonTerminalSymbolMapForGrammarAnalysis::cElement * operand_12638 = NULL ;
              while (((operand_12638 = enumerator_12638.nextObject ()))) {
                macroValidPointer (operand_12638) ;
                const GGS_bool cond_13556 = var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (inLexique, operand_12638->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (324)) COMMA_SOURCE_FILE_AT_LINE (324)) ;
                if (cond_13556.isBuiltAndTrue ()) {
                  GGS_nonterminalSymbolLabelMapForGrammarAnalysis  var_cas_altSignatureMap ;
                  GGS_uint  automatic_var_1 ;
                  const GGS_nonTerminalSymbolMapForGrammarAnalysis  temp_12862 = var_cas_nonterminalSymbolsMapForGrammar ;
                  if (temp_12862.isBuilt ()) {
                    temp_12862 (HERE)->method_searchKey (inLexique, operand_12638->mKey, automatic_var_1, var_cas_altSignatureMap COMMA_SOURCE_FILE_AT_LINE (326)) ;
                  }
                  {
                    GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cEnumerator enumerator_12930 (var_cas_altSignatureMap, true) ;
                    const GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cElement * operand_12930 = NULL ;
                    while (((operand_12930 = enumerator_12930.nextObject ()))) {
                      macroValidPointer (operand_12930) ;
                      GGS_nonterminalSymbolLabelMapForGrammarAnalysis  var_cas_temp = operand_12638->mInfo.mNonterminalSymbolParametersMap ;
                      GGS_signatureForGrammarAnalysis  var_cas_importedAltSignature ;
                      const GGS_nonterminalSymbolLabelMapForGrammarAnalysis  temp_13130 = var_cas_temp ;
                      if (temp_13130.isBuilt ()) {
                        temp_13130 (HERE)->method_searchKey (inLexique, operand_12930->mKey, var_cas_importedAltSignature COMMA_SOURCE_FILE_AT_LINE (330)) ;
                      }
                      ::routine_checkSignature_ForGrammarComponent (inLexique,  var_cas_importedAltSignature,  operand_12930->mInfo.mFormalParametersList,  operand_12930->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (331)),  operand_12930->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (331)) COMMA_SOURCE_FILE_AT_LINE (331)) ;
                    }
                  }
                  {
                    GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cEnumerator enumerator_13366 (operand_12638->mInfo.mNonterminalSymbolParametersMap, true) ;
                    const GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cElement * operand_13366 = NULL ;
                    while (((operand_13366 = enumerator_13366.nextObject ()))) {
                      macroValidPointer (operand_13366) ;
                      const GGS_bool cond_13514 = (operand_13366->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (334))).operator_isNotEqual (GGS_string ("parse")) ;
                      if (cond_13514.isBuiltAndTrue ()) {
                        GGS_signatureForGrammarAnalysis  automatic_var_2 ;
                        const GGS_nonterminalSymbolLabelMapForGrammarAnalysis  temp_13480 = var_cas_altSignatureMap ;
                        if (temp_13480.isBuilt ()) {
                          temp_13480 (HERE)->method_searchKey (inLexique, operand_13366->mKey, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (335)) ;
                        }
                      }
                    }
                  }
                }else if (cond_13556.isBuiltAndFalse ()) {
                  var_cas_nonterminalSymbolsMapForGrammar.modifier_insertKey (inLexique, operand_12638->mKey, var_cas_nonterminalSymbolsMapForGrammar.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (339)), operand_12638->mInfo.mNonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (339)) ;
                }
              }
            }
            } break ;
  ...
  { bool syntaxRepeat_5 = true ;
    while (syntaxRepeat_5) {
        ...
        var_cas_grammarAltMap.modifier_insertKey (inLexique, var_cas_altName, var_cas_signature COMMA_SOURCE_FILE_AT_LINE (355)) ;
  ...
  {
    GGS_syntaxComponentListForGrammarAnalysis::cEnumerator enumerator_14597 (var_cas_syntaxComponentsList, true) ;
    const GGS_syntaxComponentListForGrammarAnalysis::cElement * operand_14597 = NULL ;
    while (((operand_14597 = enumerator_14597.nextObject ()))) {
      macroValidPointer (operand_14597) ;
      ...
      {
        GGS_productionRuleListForGrammarAnalysis::cEnumerator enumerator_14713 (operand_14597->mProductionRulesList, true) ;
        const GGS_productionRuleListForGrammarAnalysis::cElement * operand_14713 = NULL ;
        while (((operand_14713 = enumerator_14713.nextObject ()))) {
          macroValidPointer (operand_14713) ;
          GGS_syntaxInstructionListForGrammarAnalysis  var_cas_fixedInstructionList ;
          ::routine_fixSyntaxInstructionList_V1 (inLexique,  operand_14713->mInstructionList,  var_cas_actuallyUsedTerminalSymbolMap,  var_cas_nonterminalSymbolsMapForGrammar,  var_cas_addedNonTerminalCount,  var_cas_fixedInstructionList COMMA_SOURCE_FILE_AT_LINE (369)) ;
          GGS_uint  var_cas_nonTerminalIndex ;
          GGS_nonterminalSymbolLabelMapForGrammarAnalysis  automatic_var_3 ;
          const GGS_nonTerminalSymbolMapForGrammarAnalysis  temp_15077 = var_cas_nonterminalSymbolsMapForGrammar ;
          if (temp_15077.isBuilt ()) {
            temp_15077 (HERE)->method_searchKey (inLexique, operand_14713->mLeftNonterminalSymbol, var_cas_nonTerminalIndex, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (377)) ;
          }
          var_cas_fixedProductionRuleList.addAssign_operation (operand_14713->mLeftNonterminalSymbol, var_cas_nonTerminalIndex, var_cas_fixedInstructionList) ;
        }
      }
      var_cas_syntaxComponentsListWithFixedInfos.addAssign_operation (var_cas_fixedProductionRuleList, operand_14597->mSyntaxComponentName) ;
    }
  }
  GGS_nonterminalSymbolLabelMapForGrammarAnalysis  var_cas_startSymbolAltMap ;
  GGS_uint  var_cas_startSymbolIndex ;
  const GGS_nonTerminalSymbolMapForGrammarAnalysis  temp_15579 = var_cas_nonterminalSymbolsMapForGrammar ;
  if (temp_15579.isBuilt ()) {
    temp_15579 (HERE)->method_searchKey (inLexique, var_cas_startSymbolName, var_cas_startSymbolIndex, var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (392)) ;
  }
  {
    GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cEnumerator enumerator_15704 (var_cas_startSymbolAltMap, true) ;
    const GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cElement * operand_15704 = NULL ;
    while (((operand_15704 = enumerator_15704.nextObject ()))) {
      ...
      const GGS_nonterminalSymbolLabelMapForGrammarAnalysis  temp_15778 = var_cas_grammarAltMap ;
      if (temp_15778.isBuilt ()) {
        temp_15778 (HERE)->method_searchKey (inLexique, operand_15704->mKey, var_cas_altMap COMMA_SOURCE_FILE_AT_LINE (396)) ;
      }
      ::routine_checkSignature_ForGrammarComponent (inLexique,  operand_15704->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (inLexique),  operand_15704->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (397)) COMMA_SOURCE_FILE_AT_LINE (397)) ;
    }
  }
  {
    GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cEnumerator enumerator_15928 (var_cas_grammarAltMap, true) ;
    const GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cElement * operand_15928 = NULL ;
    while (((operand_15928 = enumerator_15928.nextObject ()))) {
      macroValidPointer (operand_15928) ;
      GGS_signatureForGrammarAnalysis  automatic_var_4 ;
      const GGS_nonterminalSymbolLabelMapForGrammarAnalysis  temp_15964 = var_cas_startSymbolAltMap ;
      if (temp_15964.isBuilt ()) {
        temp_15964 (HERE)->method_searchKey (inLexique, operand_15928->mKey, automatic_var_4 COMMA_SOURCE_FILE_AT_LINE (400)) ;
      }
    }
  }
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_7 = true ;
            while (syntaxRepeat_7) {
                ...
                const GGS_nonTerminalSymbolMapForGrammarAnalysis  temp_16300 = var_cas_nonterminalSymbolsMapForGrammar ;
                if (temp_16300.isBuilt ()) {
                  temp_16300 (HERE)->method_searchKey (inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalIndex, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (410)) ;
                }
                var_cas_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (411)) ;
  ...
  if (var_cas_grammarName.isBuilt () &&
      ...
      var_cas_lexiqueName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (422)).isBuilt () &&
      ...
      GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (428)).isBuilt ()) {
    ::routine_analyzeGrammar (inLexique,  var_cas_grammarName,  var_cas_grammarClass,  var_cas_startSymbolIndex,  var_cas_lexiqueName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (422)),  GGS_location (inLexique),  var_cas_actuallyUsedTerminalSymbolMap,  var_cas_syntaxComponentsListWithFixedInfos,  var_cas_nonterminalSymbolsMapForGrammar,  var_cas_unusedNonTerminalSymbolsForGrammar,  GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (428)) COMMA_SOURCE_FILE_AT_LINE (418)) ;
  }
  var_cas_ioGrammarComponentsMap.modifier_insertKey (inLexique, var_cas_grammarName, var_cas_startSymbolAltMap, var_cas_lexiqueName, var_cas_ioOptionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (431)) ;
...
pr_galgas_component_grammar_parser_218_23_importGrammarForSemantics (galgas_scanner & inLexique,
    ...
    while (syntaxRepeat_1) {
        ...
        switch (select_grammar_parser_2 (inLexique)) {
          case 1 : {
            ...
            switch (select_grammar_parser_3 (inLexique)) {
              case 1 : {
                const GGS_M_optionComponents  temp_21320 = var_cas_ioOptionsComponentsMap ;
                if (temp_21320.isBuilt ()) {
                  temp_21320 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (659)) ;
                }
                } break ;
              case 2 : {
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_in) COMMA_HERE) ;
                ...
                GGS_M_optionComponents  var_cas_importedOptionComponentsMap = GGS_M_optionComponents ::constructor_emptyMap (inLexique COMMA_HERE) ;
                nt_parse_option_component_for_importing_ (inLexique, var_cas_fileName, var_cas_importedOptionComponentsMap) ;
                const GGS_M_optionComponents  temp_21717 = var_cas_importedOptionComponentsMap ;
                if (temp_21717.isBuilt ()) {
                  temp_21717 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (669)) ;
                }
                } break ;
              default :
                break ;
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
            const GGS_bool cond_22030 = (var_cas_ioOptionsComponentsMap.reader_hasKey (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (672)) COMMA_SOURCE_FILE_AT_LINE (672))).operator_not () ;
            if (cond_22030.isBuiltAndTrue ()) {
              var_cas_ioOptionsComponentsMap.modifier_insertKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (673)) ;
            }
            } break ;
          case 2 : {
            inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_syntax) COMMA_HERE) ;
  ...
  { bool syntaxRepeat_5 = true ;
    while (syntaxRepeat_5) {
        GGS_signatureForGrammarAnalysis  var_cas_signature ;
        nt_formal_arguments_list_importGrammarForSemantics (inLexique, var_cas_signature) ;
        var_cas_grammarAltMap.modifier_insertKey (inLexique, var_cas_altName, var_cas_signature COMMA_SOURCE_FILE_AT_LINE (694)) ;
      switch (select_repeat_grammar_parser_5 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_label) COMMA_HERE) ;
          inLexique.assignFromAttribute_tokenString (var_cas_altName) ;
  ...
  var_cas_ioGrammarComponentsMap.modifier_insertKey (inLexique, var_cas_grammarName, var_cas_grammarAltMap, var_cas_lexiqueName, var_cas_ioOptionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (702)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  { bool syntaxRepeat_6 = true ;
    while (syntaxRepeat_6) {
      switch (select_repeat_grammar_parser_6 (inLexique)) {
