...
pr_galgas_component_grammar_parser_91_24_ (galgas_scanner & lexique_var_,
  ...
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_8658 = var_cas_startSymbolAltMap.firstObject () ;
  while ((operand_8658 != NULL)) {
    macroValidPointer (operand_8658) ;
    GGS_L_signature  var_cas_altMap ;
    var_cas_grammarAltMap.methode_searchKey (lexique_var_, operand_8658->mKey, var_cas_altMap) ;
    ::routine_checkSignature_ForGrammarComponent (lexique_var_,  operand_8658->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (lexique_var_)) ;
    operand_8658 = operand_8658->nextObject () ;
  }
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_8895 = var_cas_grammarAltMap.firstObject () ;
  while ((operand_8895 != NULL)) {
    macroValidPointer (operand_8895) ;
    GGS_L_signature  var_cas_8975 ;
    var_cas_startSymbolAltMap.methode_searchKey (lexique_var_, operand_8895->mKey, var_cas_8975) ;
    operand_8895 = operand_8895->nextObject () ;
  }
