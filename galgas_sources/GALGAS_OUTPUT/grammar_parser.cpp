...
void grammar_parser::
pr_galgas_component_grammar_parser_94_24_ (galgas_scanner & lexique_var_,
    ...
    while (syntaxRepeat) {
        ...
        switch (select_grammar_parser_1 (lexique_var_)) {
          ...
          case 2 : {
            ...
            GGS_M_nonTerminalSymbolsForGrammar::element_type * operand_6878 = var_cas_importedNonterminalSymbolsMap.firstObject () ;
            while ((operand_6878 != NULL)) {
              macroValidPointer (operand_6878) ;
              if ((var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (operand_6878->mKey.reader_value ())).isBuiltAndTrue ()) {
                GGS_M_nonterminalSymbolAltsForGrammar  var_cas_altSignatureMap ;
                var_cas_nonterminalSymbolsMapForGrammar.methode_searchKey (lexique_var_, operand_6878->mKey, var_cas_altSignatureMap) ;
                GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_7221 = var_cas_altSignatureMap.firstObject () ;
                while ((operand_7221 != NULL)) {
                  macroValidPointer (operand_7221) ;
                  GGS_M_nonterminalSymbolAltsForGrammar  var_cas_temp ;
                  var_cas_temp = operand_6878->mInfo.mNonterminalSymbolParametersMap ;
                  GGS_L_signature  var_cas_importedAltSignature ;
                  var_cas_temp.methode_searchKey (lexique_var_, operand_7221->mKey, var_cas_importedAltSignature) ;
                  ::routine_checkSignature_ForGrammarComponent (lexique_var_,  var_cas_importedAltSignature,  operand_7221->mInfo.mFormalParametersList,  operand_7221->mKey.reader_location ()) ;
                  operand_7221 = operand_7221->nextObject () ;
                }
                GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_7638 = operand_6878->mInfo.mNonterminalSymbolParametersMap.firstObject () ;
                while ((operand_7638 != NULL)) {
                  macroValidPointer (operand_7638) ;
                  if (((operand_7638->mKey.reader_value ()) != (GGS_string (true, "parse"))).isBuiltAndTrue ()) {
                    GGS_L_signature  var_cas_7823 ;
                    var_cas_altSignatureMap.methode_searchKey (lexique_var_, operand_7638->mKey, var_cas_7823) ;
                  }
                  operand_7638 = operand_7638->nextObject () ;
                }
              }else{
                var_cas_nonterminalSymbolsMapForGrammar.methode_insertKey (lexique_var_, operand_6878->mKey, operand_6878->mInfo.mNonterminalSymbolParametersMap) ;
              }
              operand_6878 = operand_6878->nextObject () ;
            }
            } break ;
          default :
            break ;
  ...
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_8837 = var_cas_startSymbolAltMap.firstObject () ;
  while ((operand_8837 != NULL)) {
    macroValidPointer (operand_8837) ;
    GGS_L_signature  var_cas_altMap ;
    var_cas_grammarAltMap.methode_searchKey (lexique_var_, operand_8837->mKey, var_cas_altMap) ;
    ::routine_checkSignature_ForGrammarComponent (lexique_var_,  operand_8837->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (lexique_var_)) ;
    operand_8837 = operand_8837->nextObject () ;
  }
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_9074 = var_cas_grammarAltMap.firstObject () ;
  while ((operand_9074 != NULL)) {
    macroValidPointer (operand_9074) ;
    GGS_L_signature  var_cas_9154 ;
    var_cas_startSymbolAltMap.methode_searchKey (lexique_var_, operand_9074->mKey, var_cas_9154) ;
...
void grammar_parser::
pr_galgas_component_grammar_parser_94_24_importLexique (galgas_scanner & lexique_var_,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_grammar) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
...
void grammar_parser::
pr_galgas_component_grammar_parser_94_24_importSyntax (galgas_scanner & lexique_var_,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_grammar) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
...
void grammar_parser::
pr_galgas_component_grammar_parser_94_24_importSemantics (galgas_scanner & lexique_var_,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_grammar) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
...
void grammar_parser::
pr_galgas_component_grammar_parser_94_24_importGrammarForSemantics (galgas_scanner & lexique_var_,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_grammar) ;
  GGS_lstring  var_cas_grammarName ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
...
void grammar_parser::
pr_galgas_component_grammar_parser_94_24_importOptions (galgas_scanner & lexique_var_,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_grammar) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
...
void grammar_parser::
pr_galgas_component_grammar_parser_94_24_importMetamodels (galgas_scanner & lexique_var_,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_grammar) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
