...
pr_galgas_component_grammar_parser_109_4_ (galgas_scanner & _inLexique,
        ...
        switch (select_grammar_parser_1 (_inLexique)) {
          case 1 : {
            ...
            switch (select_grammar_parser_2 (_inLexique)) {
              case 1 : {
                const GGS_M_optionComponents  _temp_5663 = var_cas_ioOptionsComponentsMap ;
                if (_temp_5663._isBuilt ()) {
                  _temp_5663 (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (148)) ;
                }
                } break ;
              case 2 : {
                ...
                const GGS_M_optionComponents  _temp_6060 = var_cas_importedOptionComponentsMap ;
                if (_temp_6060._isBuilt ()) {
                  _temp_6060 (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (158)) ;
                }
                } break ;
              default :
                break ;
          ...
          case 2 : {
            ...
            switch (select_grammar_parser_3 (_inLexique)) {
              ...
              case 2 : {
                ...
                nt_parse_syntax_for_importing_ (_inLexique, var_cas_fileName, var_cas_syntaxComponentsMap, var_cas_ioMetamodelComponentMap, var_cas_ioTreewalkingComponentMap, var_cas_ioFileWrappers) ;
                } break ;
              default :
                break ;
            }
            ...
            const GGS_M_syntaxComponents  _temp_7248 = var_cas_syntaxComponentsMap ;
            if (_temp_7248._isBuilt ()) {
              _temp_7248 (HERE)->method_searchKey (_inLexique, var_cas_syntaxComponentName, var_cas_importedNonterminalSymbolsMap, var_cas_importedProductionRulesList, var_cas_importedLexiqueComponentName COMMA_SOURCE_FILE_AT_LINE (189)) ;
            }
            ...
            GGS_M_nonTerminalSymbolsForGrammar::cEnumerator enumerator_7926 (var_cas_importedNonterminalSymbolsMap, true) ;
            const GGS_M_nonTerminalSymbolsForGrammar::cElement * operand_7926 = NULL ;
            while (((operand_7926 = (GGS_M_nonTerminalSymbolsForGrammar::cElement *) enumerator_7926.nextObject ()))) {
              macroValidPointer (operand_7926) ;
              if ((var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (_inLexique, operand_7926->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (204)) COMMA_SOURCE_FILE_AT_LINE (204))).isBuiltAndTrue ()) {
                GGS_M_nonterminalSymbolAltsForGrammar  var_cas_altSignatureMap ;
                const GGS_M_nonTerminalSymbolsForGrammar  _temp_8220 = var_cas_nonterminalSymbolsMapForGrammar ;
                if (_temp_8220._isBuilt ()) {
                  _temp_8220 (HERE)->method_searchKey (_inLexique, operand_7926->mKey, var_cas_altSignatureMap COMMA_SOURCE_FILE_AT_LINE (206)) ;
                }
                GGS_M_nonterminalSymbolAltsForGrammar::cEnumerator enumerator_8278 (var_cas_altSignatureMap, true) ;
                const GGS_M_nonterminalSymbolAltsForGrammar::cElement * operand_8278 = NULL ;
                while (((operand_8278 = (GGS_M_nonterminalSymbolAltsForGrammar::cElement *) enumerator_8278.nextObject ()))) {
                  macroValidPointer (operand_8278) ;
                  GGS_M_nonterminalSymbolAltsForGrammar  var_cas_temp ;
                  var_cas_temp = operand_7926->mInfo.mNonterminalSymbolParametersMap ;
                  GGS_L_signature  var_cas_importedAltSignature ;
                  GGS_lstring  var_cas_importedReturnedType ;
                  const GGS_M_nonterminalSymbolAltsForGrammar  _temp_8558 = var_cas_temp ;
                  if (_temp_8558._isBuilt ()) {
                    _temp_8558 (HERE)->method_searchKey (_inLexique, operand_8278->mKey, var_cas_importedAltSignature, var_cas_importedReturnedType COMMA_SOURCE_FILE_AT_LINE (211)) ;
                  }
                  ::routine_checkSignature_ForGrammarComponent (_inLexique,  var_cas_importedAltSignature,  operand_8278->mInfo.mFormalParametersList,  operand_7926->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (212)),  operand_8278->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (212)) COMMA_SOURCE_FILE_AT_LINE (211)) ;
                }
                enumerator_8278.reset () ;
                GGS_M_nonterminalSymbolAltsForGrammar::cEnumerator enumerator_8792 (operand_7926->mInfo.mNonterminalSymbolParametersMap, true) ;
                const GGS_M_nonterminalSymbolAltsForGrammar::cElement * operand_8792 = NULL ;
                while (((operand_8792 = (GGS_M_nonterminalSymbolAltsForGrammar::cElement *) enumerator_8792.nextObject ()))) {
                  macroValidPointer (operand_8792) ;
                  if (((operand_8792->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (215)))._operator_isNotEqual (GGS_string (true, "parse"))).isBuiltAndTrue ()) {
                    GGS_L_signature  automatic_var_0 ;
                    GGS_lstring  automatic_var_1 ;
                    const GGS_M_nonterminalSymbolAltsForGrammar  _temp_8969 = var_cas_altSignatureMap ;
                    if (_temp_8969._isBuilt ()) {
                      _temp_8969 (HERE)->method_searchKey (_inLexique, operand_8792->mKey, automatic_var_0, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (216)) ;
                    }
                  }
                }
                enumerator_8792.reset () ;
              }else{
                var_cas_nonterminalSymbolsMapForGrammar.modifier_insertKey (_inLexique, operand_7926->mKey, operand_7926->mInfo.mNonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (220)) ;
              }
            }
            enumerator_7926.reset () ;
            } break ;
          default :
            break ;
        }
    ...
    while (syntaxRepeat_4) {
        ...
        switch (select_grammar_parser_5 (_inLexique)) {
          ...
          case 2 : {
            ...
            const GGS_M_metamodelsComponents  _temp_9951 = var_cas_ioMetamodelComponentMap ;
            if (_temp_9951._isBuilt ()) {
              _temp_9951 (HERE)->method_searchKey (_inLexique, var_cas_returnedMetamodelName, var_cas_returnedEntityName, automatic_var_2, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (245)) ;
            }
  ...
  const GGS_M_nonTerminalSymbolsForGrammar  _temp_10448 = var_cas_nonterminalSymbolsMapForGrammar ;
  if (_temp_10448._isBuilt ()) {
    _temp_10448 (HERE)->method_searchKeyGetID (_inLexique, var_cas_startSymbolName, var_cas_startSymbolIndex, var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (257)) ;
  }
  GGS_M_nonterminalSymbolAltsForGrammar::cEnumerator enumerator_10570 (var_cas_startSymbolAltMap, true) ;
  const GGS_M_nonterminalSymbolAltsForGrammar::cElement * operand_10570 = NULL ;
  while (((operand_10570 = (GGS_M_nonterminalSymbolAltsForGrammar::cElement *) enumerator_10570.nextObject ()))) {
    macroValidPointer (operand_10570) ;
    GGS_L_signature  var_cas_altMap ;
    GGS_lstring  var_cas_returnedEntity ;
    const GGS_M_nonterminalSymbolAltsForGrammar  _temp_10735 = var_cas_grammarAltMap ;
    if (_temp_10735._isBuilt ()) {
      _temp_10735 (HERE)->method_searchKey (_inLexique, operand_10570->mKey, var_cas_altMap, var_cas_returnedEntity COMMA_SOURCE_FILE_AT_LINE (262)) ;
    }
    ::routine_checkSignature_ForGrammarComponent (_inLexique,  operand_10570->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (_inLexique),  operand_10570->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (263)) COMMA_SOURCE_FILE_AT_LINE (262)) ;
    if (((var_cas_returnedEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (264)))._operator_isNotEqual (operand_10570->mInfo.mReturnedEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (264)))).isBuiltAndTrue ()) {
    }
  }
  enumerator_10570.reset () ;
  GGS_M_nonterminalSymbolAltsForGrammar::cEnumerator enumerator_10977 (var_cas_grammarAltMap, true) ;
  const GGS_M_nonterminalSymbolAltsForGrammar::cElement * operand_10977 = NULL ;
  while (((operand_10977 = (GGS_M_nonterminalSymbolAltsForGrammar::cElement *) enumerator_10977.nextObject ()))) {
    macroValidPointer (operand_10977) ;
    GGS_L_signature  automatic_var_4 ;
    GGS_lstring  automatic_var_5 ;
    const GGS_M_nonterminalSymbolAltsForGrammar  _temp_11042 = var_cas_startSymbolAltMap ;
    if (_temp_11042._isBuilt ()) {
      _temp_11042 (HERE)->method_searchKey (_inLexique, operand_10977->mKey, automatic_var_4, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (269)) ;
    }
  }
  enumerator_10977.reset () ;
    ...
    while (syntaxRepeat_0) {
        ...
        switch (select_grammar_parser_1 (_inLexique)) {
          case 1 : {
            ...
            switch (select_grammar_parser_2 (_inLexique)) {
              case 1 : {
                const GGS_M_optionComponents  _temp_15408 = var_cas_ioOptionsComponentsMap ;
                if (_temp_15408._isBuilt ()) {
                  _temp_15408 (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (474)) ;
                }
                } break ;
              case 2 : {
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_in) COMMA_HERE) ;
                ...
                var_cas_importedOptionComponentsMap = GGS_M_optionComponents::constructor_emptyMap (_inLexique COMMA_HERE) ;
                nt_parse_option_component_for_importing_ (_inLexique, var_cas_fileName, var_cas_importedOptionComponentsMap) ;
                const GGS_M_optionComponents  _temp_15805 = var_cas_importedOptionComponentsMap ;
                if (_temp_15805._isBuilt ()) {
                  _temp_15805 (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (484)) ;
                }
                } break ;
              default :
                break ;
    ...
    while (syntaxRepeat_4) {
        ...
        switch (select_grammar_parser_5 (_inLexique)) {
          ...
          case 2 : {
            ...
            const GGS_M_metamodelsComponents  _temp_16795 = var_cas_ioMetamodelComponentMap ;
            if (_temp_16795._isBuilt ()) {
              _temp_16795 (HERE)->method_searchKey (_inLexique, var_cas_returnedMetamodelName, var_cas_returnedEntityName, automatic_var_6, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (516)) ;
            }
            } break ;
          default :
            break ;
