...
pr_galgas_component_grammar_parser_101_23_ (galgas_scanner & inLexique,
            ...
            var_cas_syntaxComponentsList.addAssign_operation (var_cas_importedNonterminalSymbolsMap, var_cas_importedProductionRulesList, var_cas_syntaxComponentName) ;
            {
              ...
              while (((operand_7862 = enumerator_7862.nextObject ()))) {
                ...
                if ((var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (inLexique, operand_7862->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (206)) COMMA_SOURCE_FILE_AT_LINE (206))).isBuiltAndTrue ()) {
                  ...
                  const GGS_M_nonTerminalSymbolsForGrammar  temp_8137 = var_cas_nonterminalSymbolsMapForGrammar ;
                  if (temp_8137.isBuilt ()) {
                    temp_8137 (HERE)->method_searchKey (inLexique, operand_7862->mKey, var_cas_altSignatureMap COMMA_SOURCE_FILE_AT_LINE (208)) ;
                  }
                  {
                    GGS_M_nonterminalSymbolAltsForGrammar::cEnumerator enumerator_8201 (var_cas_altSignatureMap, true) ;
                    const GGS_M_nonterminalSymbolAltsForGrammar::cElement * operand_8201 = NULL ;
                    while (((operand_8201 = enumerator_8201.nextObject ()))) {
                      macroValidPointer (operand_8201) ;
                      GGS_M_nonterminalSymbolAltsForGrammar  var_cas_temp ;
                      var_cas_temp = operand_7862->mInfo.mNonterminalSymbolParametersMap ;
                      GGS_L_signature  var_cas_importedAltSignature ;
                      const GGS_M_nonterminalSymbolAltsForGrammar  temp_8407 = var_cas_temp ;
                      if (temp_8407.isBuilt ()) {
                        temp_8407 (HERE)->method_searchKey (inLexique, operand_8201->mKey, var_cas_importedAltSignature COMMA_SOURCE_FILE_AT_LINE (212)) ;
                      }
                      ::routine_checkSignature_ForGrammarComponent (inLexique,  var_cas_importedAltSignature,  operand_8201->mInfo.mFormalParametersList,  operand_7862->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (213)),  operand_8201->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (213)) COMMA_SOURCE_FILE_AT_LINE (213)) ;
                    }
                  }
                  {
                    GGS_M_nonterminalSymbolAltsForGrammar::cEnumerator enumerator_8634 (operand_7862->mInfo.mNonterminalSymbolParametersMap, true) ;
                    const GGS_M_nonterminalSymbolAltsForGrammar::cElement * operand_8634 = NULL ;
                    while (((operand_8634 = enumerator_8634.nextObject ()))) {
                      macroValidPointer (operand_8634) ;
                      if (((operand_8634->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (216))).operator_isNotEqual (GGS_string ("parse"))).isBuiltAndTrue ()) {
                        GGS_L_signature  automatic_var_0 ;
                        const GGS_M_nonterminalSymbolAltsForGrammar  temp_8795 = var_cas_altSignatureMap ;
                        if (temp_8795.isBuilt ()) {
                          temp_8795 (HERE)->method_searchKey (inLexique, operand_8634->mKey, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (217)) ;
                        }
                      }
                    }
                  }
  ...
  const GGS_M_nonTerminalSymbolsForGrammar  temp_9714 = var_cas_nonterminalSymbolsMapForGrammar ;
  if (temp_9714.isBuilt ()) {
    temp_9714 (HERE)->method_searchKeyGetID (inLexique, var_cas_startSymbolName, var_cas_startSymbolIndex, var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (246)) ;
  }
  {
    GGS_M_nonterminalSymbolAltsForGrammar::cEnumerator enumerator_9839 (var_cas_startSymbolAltMap, true) ;
    const GGS_M_nonterminalSymbolAltsForGrammar::cElement * operand_9839 = NULL ;
    while (((operand_9839 = enumerator_9839.nextObject ()))) {
      macroValidPointer (operand_9839) ;
      GGS_L_signature  var_cas_altMap ;
      const GGS_M_nonterminalSymbolAltsForGrammar  temp_9942 = var_cas_grammarAltMap ;
      if (temp_9942.isBuilt ()) {
        temp_9942 (HERE)->method_searchKey (inLexique, operand_9839->mKey, var_cas_altMap COMMA_SOURCE_FILE_AT_LINE (250)) ;
      }
      ::routine_checkSignature_ForGrammarComponent (inLexique,  operand_9839->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (inLexique),  operand_9839->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (251)) COMMA_SOURCE_FILE_AT_LINE (251)) ;
    }
  }
  {
    GGS_M_nonterminalSymbolAltsForGrammar::cEnumerator enumerator_10094 (var_cas_grammarAltMap, true) ;
    const GGS_M_nonterminalSymbolAltsForGrammar::cElement * operand_10094 = NULL ;
    while (((operand_10094 = enumerator_10094.nextObject ()))) {
      macroValidPointer (operand_10094) ;
      GGS_L_signature  automatic_var_1 ;
      const GGS_M_nonterminalSymbolAltsForGrammar  temp_10156 = var_cas_startSymbolAltMap ;
      if (temp_10156.isBuilt ()) {
        temp_10156 (HERE)->method_searchKey (inLexique, operand_10094->mKey, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (254)) ;
      }
    }
  }
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_7 = true ;
            while (syntaxRepeat_7) {
                ...
                const GGS_M_nonTerminalSymbolsForGrammar  temp_10497 = var_cas_nonterminalSymbolsMapForGrammar ;
                if (temp_10497.isBuilt ()) {
                  temp_10497 (HERE)->method_searchKeyGetID (inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalIndex, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (264)) ;
                }
    ...
    while (syntaxRepeat_1) {
        ...
        switch (select_grammar_parser_2 (inLexique)) {
          case 1 : {
            ...
            switch (select_grammar_parser_3 (inLexique)) {
              case 1 : {
                const GGS_M_optionComponents  temp_15399 = var_cas_ioOptionsComponentsMap ;
                if (temp_15399.isBuilt ()) {
                  temp_15399 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (512)) ;
                }
                } break ;
              case 2 : {
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_in) COMMA_HERE) ;
                ...
                var_cas_importedOptionComponentsMap = GGS_M_optionComponents ::constructor_emptyMap (inLexique COMMA_HERE) ;
                nt_parse_option_component_for_importing_ (inLexique, var_cas_fileName, var_cas_importedOptionComponentsMap) ;
                const GGS_M_optionComponents  temp_15796 = var_cas_importedOptionComponentsMap ;
                if (temp_15796.isBuilt ()) {
                  temp_15796 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (522)) ;
                }
                } break ;
              default :
                break ;
