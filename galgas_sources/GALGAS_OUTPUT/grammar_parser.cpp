...
void routine_fixSyntaxInstructionList_V1 (C_CompilerEx & inLexique,
                                ...
                                GGS_syntaxInstructionListForGrammarAnalysis  & var_cas_outSyntaxInstructionList
  ...
  var_cas_outSyntaxInstructionList = GGS_syntaxInstructionListForGrammarAnalysis ::constructor_emptyList () ;
  {
    ...
    while (((operand_2776 = enumerator_2776.nextObject ()))) {
      ...
      { typeCategoryMethod__abstractSyntaxInstructionForGrammarAnalysis__fixSyntaxInstructionList_V1 method = findCategoryMethod__abstractSyntaxInstructionForGrammarAnalysis__fixSyntaxInstructionList_V1 (operand_2776->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_2776->mInstruction (HERE), var_cas_ioActuallyUsedTerminalSymbolMap, var_cas_inNonTerminalSymbolMap, var_cas_ioAddedNonTerminalIndex, var_cas_outSyntaxInstructionList COMMA_SOURCE_FILE_AT_LINE (50)) ;
        }
      }
    }
  }
...
category_method__nonTerminalInstructionForGrammarAnalysis__fixSyntaxInstructionList_V1 (C_CompilerEx & inLexique,
  ...
  if (operand_4087 != NULL) {
    ...
    if (var_cas_inNonTerminalSymbolMap.isBuilt ()) {
      var_cas_inNonTerminalSymbolMap (HERE)->method_searchKey (inLexique, operand_4087->mNonterminalSymbolName, var_cas_nonTerminalSymbolIndex, automatic_var_4468_0 COMMA_SOURCE_FILE_AT_LINE (90)) ;
    }
...
void grammar_parser::rule_grammar_5F_parser_galgas_5F_component_i0_ (C_Lexique_galgas_5F_scanner & inLexique,
        ...
        switch (select_grammar_5F_parser_2 (inLexique)) {
            ...
            switch (select_grammar_5F_parser_3 (inLexique)) {
              case 1 : {
                if (var_cas_ioOptionsComponentsMap.isBuilt ()) {
                  var_cas_ioOptionsComponentsMap (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (269)) ;
                }
                } break ;
              case 2 : {
                ...
                if (var_cas_importedOptionComponentsMap.isBuilt ()) {
                  var_cas_importedOptionComponentsMap (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (279)) ;
                }
                } break ;
              default :
                break ;
          ...
          case 2 : {
            ...
            if (var_cas_syntaxComponentsMap.isBuilt ()) {
              var_cas_syntaxComponentsMap (HERE)->method_searchKey (inLexique, var_cas_syntaxComponentName, var_cas_importedNonterminalSymbolsMap, var_cas_importedProductionRulesList, var_cas_importedLexiqueComponentName COMMA_SOURCE_FILE_AT_LINE (308)) ;
            }
            ...
            var_cas_syntaxComponentsList.addAssign_operation (var_cas_importedProductionRulesList, var_cas_syntaxComponentName) ;
            {
              ...
              while (((operand_12712 = enumerator_12712.nextObject ()))) {
                ...
                const GGS_bool cond_13637 = var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (operand_12712->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (324))) ;
                if (cond_13637.isBuiltAndTrue ()) {
                  GGS_nonterminalSymbolLabelMapForGrammarAnalysis  var_cas_altSignatureMap ;
                  GGS_uint  automatic_var_12970_0 ;
                  if (var_cas_nonterminalSymbolsMapForGrammar.isBuilt ()) {
                    var_cas_nonterminalSymbolsMapForGrammar (HERE)->method_searchKey (inLexique, operand_12712->mKey, automatic_var_12970_0, var_cas_altSignatureMap COMMA_SOURCE_FILE_AT_LINE (326)) ;
                  }
                  {
                    GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cEnumerator enumerator_13006 (var_cas_altSignatureMap, true) ;
                    const GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cElement * operand_13006 = NULL ;
                    while (((operand_13006 = enumerator_13006.nextObject ()))) {
                      ...
                      if (var_cas_temp.isBuilt ()) {
                        var_cas_temp (HERE)->method_searchKey (inLexique, operand_13006->mKey, var_cas_importedAltSignature COMMA_SOURCE_FILE_AT_LINE (330)) ;
                      }
                      ::routine_checkSignature_ForGrammarComponent (inLexique,  var_cas_importedAltSignature,  operand_13006->mInfo.mFormalParametersList,  operand_13006->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (331)),  operand_13006->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (331)) COMMA_SOURCE_FILE_AT_LINE (331)) ;
                    }
                  }
                  {
                    GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cEnumerator enumerator_13445 (operand_12712->mInfo.mNonterminalSymbolParametersMap, true) ;
                    const GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cElement * operand_13445 = NULL ;
                    while (((operand_13445 = enumerator_13445.nextObject ()))) {
                      macroValidPointer (operand_13445) ;
                      const GGS_bool cond_13595 = (operand_13445->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (334))).operator_isNotEqual (GGS_string ("parse")) ;
                      if (cond_13595.isBuiltAndTrue ()) {
                        GGS_signatureForGrammarAnalysis  automatic_var_13577_0 ;
                        if (var_cas_altSignatureMap.isBuilt ()) {
                          var_cas_altSignatureMap (HERE)->method_searchKey (inLexique, operand_13445->mKey, automatic_var_13577_0 COMMA_SOURCE_FILE_AT_LINE (335)) ;
                        }
                      }
                    }
                  }
                }else if (cond_13637.isBuiltAndFalse ()) {
        ...
        case 2 : {
          ...
          switch (select_grammar_5F_parser_6 (inLexique)) {
            ...
            case 2 : {
              ...
              const GGS_bool cond_14679 = var_cas_startSymbolHasParseLabel ;
              if (cond_14679.isBuiltAndTrue ()) {
  ...
  {
    GGS_syntaxComponentListForGrammarAnalysis::cEnumerator enumerator_15067 (var_cas_syntaxComponentsList, true) ;
    const GGS_syntaxComponentListForGrammarAnalysis::cElement * operand_15067 = NULL ;
    while (((operand_15067 = enumerator_15067.nextObject ()))) {
      macroValidPointer (operand_15067) ;
      ...
      {
        GGS_productionRuleListForGrammarAnalysis::cEnumerator enumerator_15183 (operand_15067->mProductionRulesList, true) ;
        const GGS_productionRuleListForGrammarAnalysis::cElement * operand_15183 = NULL ;
        while (((operand_15183 = enumerator_15183.nextObject ()))) {
          macroValidPointer (operand_15183) ;
          GGS_syntaxInstructionListForGrammarAnalysis  var_cas_fixedInstructionList ;
          ::routine_fixSyntaxInstructionList_V1 (inLexique,  operand_15183->mInstructionList,  var_cas_actuallyUsedTerminalSymbolMap,  var_cas_nonterminalSymbolsMapForGrammar,  var_cas_addedNonTerminalCount,  var_cas_fixedInstructionList COMMA_SOURCE_FILE_AT_LINE (380)) ;
          GGS_uint  var_cas_nonTerminalIndex ;
          GGS_nonterminalSymbolLabelMapForGrammarAnalysis  automatic_var_15593_0 ;
          if (var_cas_nonterminalSymbolsMapForGrammar.isBuilt ()) {
            var_cas_nonterminalSymbolsMapForGrammar (HERE)->method_searchKey (inLexique, operand_15183->mLeftNonterminalSymbol, var_cas_nonTerminalIndex, automatic_var_15593_0 COMMA_SOURCE_FILE_AT_LINE (388)) ;
          }
          var_cas_fixedProductionRuleList.addAssign_operation (operand_15183->mLeftNonterminalSymbol, var_cas_nonTerminalIndex, var_cas_fixedInstructionList, operand_15183->mProductionIndex) ;
        }
      }
      var_cas_syntaxComponentsListWithFixedInfos.addAssign_operation (var_cas_fixedProductionRuleList, operand_15067->mSyntaxComponentName) ;
    }
  }
  GGS_nonterminalSymbolLabelMapForGrammarAnalysis  var_cas_startSymbolAltMap ;
  GGS_uint  var_cas_startSymbolIndex ;
  if (var_cas_nonterminalSymbolsMapForGrammar.isBuilt ()) {
    var_cas_nonterminalSymbolsMapForGrammar (HERE)->method_searchKey (inLexique, var_cas_startSymbolName, var_cas_startSymbolIndex, var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (404)) ;
  }
  {
    GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cEnumerator enumerator_16200 (var_cas_startSymbolAltMap, true) ;
    const GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cElement * operand_16200 = NULL ;
    while (((operand_16200 = enumerator_16200.nextObject ()))) {
      macroValidPointer (operand_16200) ;
      GGS_signatureForGrammarAnalysis  var_cas_altMap ;
      if (var_cas_grammarAltMap.isBuilt ()) {
        var_cas_grammarAltMap (HERE)->method_searchKey (inLexique, operand_16200->mKey, var_cas_altMap COMMA_SOURCE_FILE_AT_LINE (408)) ;
      }
      ::routine_checkSignature_ForGrammarComponent (inLexique,  operand_16200->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (inLexique),  operand_16200->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (409)) COMMA_SOURCE_FILE_AT_LINE (409)) ;
    }
  }
  {
    GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cEnumerator enumerator_16426 (var_cas_grammarAltMap, true) ;
    const GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cElement * operand_16426 = NULL ;
    while (((operand_16426 = enumerator_16426.nextObject ()))) {
      macroValidPointer (operand_16426) ;
      GGS_signatureForGrammarAnalysis  automatic_var_16472_0 ;
      if (var_cas_startSymbolAltMap.isBuilt ()) {
        var_cas_startSymbolAltMap (HERE)->method_searchKey (inLexique, operand_16426->mKey, automatic_var_16472_0 COMMA_SOURCE_FILE_AT_LINE (412)) ;
      }
    }
  }
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_8 = true ;
            while (syntaxRepeat_8) {
                ...
                inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_non_5F_terminal_5F_symbol) COMMA_HERE) ;
                GGS_uint  var_cas_nonterminalIndex ;
                GGS_nonterminalSymbolLabelMapForGrammarAnalysis  automatic_var_16844_0 ;
                if (var_cas_nonterminalSymbolsMapForGrammar.isBuilt ()) {
                  var_cas_nonterminalSymbolsMapForGrammar (HERE)->method_searchKey (inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalIndex, automatic_var_16844_0 COMMA_SOURCE_FILE_AT_LINE (422)) ;
                }
...
void grammar_parser::rule_grammar_5F_parser_galgas_5F_component_i0_importGrammarForSemantics (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_nonterminalSymbolLabelMapForGrammarAnalysis  var_cas_grammarAltMap = GGS_nonterminalSymbolLabelMapForGrammarAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (677)) ;
  { bool syntaxRepeat_1 = true ;
    while (syntaxRepeat_1) {
        inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_import) COMMA_HERE) ;
        switch (select_grammar_5F_parser_2 (inLexique)) {
          case 1 : {
            ...
            switch (select_grammar_5F_parser_3 (inLexique)) {
              case 1 : {
                if (var_cas_ioOptionsComponentsMap.isBuilt ()) {
                  var_cas_ioOptionsComponentsMap (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (688)) ;
                }
                } break ;
              case 2 : {
                inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_in) COMMA_HERE) ;
                ...
                inLexique.assignFromAttribute_tokenString (var_cas_fileName) ;
                inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
                GGS_M_optionComponents  var_cas_importedOptionComponentsMap = GGS_M_optionComponents ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (693)) ;
                nt_parse_5F_option_5F_component_5F_for_5F_importing_ (inLexique, var_cas_fileName, var_cas_importedOptionComponentsMap) ;
                if (var_cas_importedOptionComponentsMap.isBuilt ()) {
                  var_cas_importedOptionComponentsMap (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (698)) ;
                }
                } break ;
              default :
                break ;
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
            const GGS_bool cond_22975 = (var_cas_ioOptionsComponentsMap.reader_hasKey (var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (701)))).operator_not () ;
            if (cond_22975.isBuiltAndTrue ()) {
              var_cas_ioOptionsComponentsMap.modifier_insertKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (702)) ;
            }
            } break ;
          case 2 : {
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_syntax) COMMA_HERE) ;
  ...
  GGS_signatureForGrammarAnalysis  var_cas_signature ;
  nt_formal_5F_arguments_5F_list_importGrammarForSemantics (inLexique, var_cas_signature) ;
  var_cas_grammarAltMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (723)), var_cas_signature COMMA_SOURCE_FILE_AT_LINE (722)) ;
  { bool syntaxRepeat_5 = true ;
    while (syntaxRepeat_5) {
      switch (select_grammar_5F_parser_5 (inLexique)) {
        case 2 : {
          ...
          switch (select_grammar_5F_parser_6 (inLexique)) {
            case 1 : {
              ...
              GGS_signatureForGrammarAnalysis  var_cas_signature ;
              nt_formal_5F_arguments_5F_list_importGrammarForSemantics (inLexique, var_cas_signature) ;
              var_cas_grammarAltMap.modifier_insertKey (inLexique, var_cas_altName, var_cas_signature COMMA_SOURCE_FILE_AT_LINE (733)) ;
              } break ;
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_parse) COMMA_HERE) ;
              var_cas_startSymbolHasParseLabel = GGS_bool (true) ;
  ...
  var_cas_ioGrammarComponentsMap.modifier_insertKey (inLexique, var_cas_grammarName, var_cas_grammarAltMap, var_cas_lexiqueName, var_cas_ioOptionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (742)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
  { bool syntaxRepeat_7 = true ;
    while (syntaxRepeat_7) {
      switch (select_grammar_5F_parser_7 (inLexique)) {
