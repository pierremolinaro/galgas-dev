...
pr_galgas_component_grammar_parser_100_24_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioGrammarComponentsMap.modifier_insertKey (_inLexique, var_cas_grammarName, var_cas_startSymbolAltMap, var_cas_lexiqueName, var_cas_optionComponentsMap SOURCE_FILE_AT_LINE (274)) ;
...
pr_galgas_component_grammar_parser_100_24_importGrammarForSemantics (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_grammarAltMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_signature, var_cas_returnedMetamodelName SOURCE_FILE_AT_LINE (508)) ;
      switch (select_repeat_grammar_parser_4 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_label) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
