...
pr_galgas_component_grammar_parser_91_24_ (galgas_scanner & lexique_var_,
        ...
        switch (select_grammar_parser_1 (lexique_var_)) {
          ...
          case 2 : {
            ...
            while ((operand_6793 != NULL)) {
              ...
              if ((var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (operand_6793->mKey.reader_value ())).isBuiltAndTrue ()) {
                ...
                searchKey_M_nonTerminalSymbolsForGrammar (lexique_var_,
                                                ...
                                                NULL) ;
                GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_7140 = var_cas_altSignatureMap.firstObject () ;
                while ((operand_7140 != NULL)) {
                  ...
                  searchKey_M_nonterminalSymbolAltsForGrammar (lexique_var_,
                                                  ...
                                                  NULL) ;
                  ::routine_checkSignature_ForGrammarComponent (lexique_var_,  var_cas_importedAltSignature,  operand_7140->mInfo.mFormalParametersList,  operand_7140->mKey.reader_location ()) ;
                  operand_7140 = operand_7140->nextObject () ;
                }
                GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_7601 = operand_6793->mInfo.mNonterminalSymbolParametersMap.firstObject () ;
                while ((operand_7601 != NULL)) {
                  macroValidPointer (operand_7601) ;
                  if (((operand_7601->mKey.reader_value ()) != (GGS_string (true, "parse"))).isBuiltAndTrue ()) {
                    searchKey_M_nonterminalSymbolAltsForGrammar (lexique_var_,
                                                    var_cas_altSignatureMap,
                                                    operand_7601->mKey,
                                                    NULL,
                  ...
                  operand_7601 = operand_7601->nextObject () ;
                }
              }else{
  ...
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_9057 = var_cas_startSymbolAltMap.firstObject () ;
  while ((operand_9057 != NULL)) {
    ...
    searchKey_M_nonterminalSymbolAltsForGrammar (lexique_var_,
                                    ...
                                    & var_cas_altMap,
                                    NULL) ;
    ::routine_checkSignature_ForGrammarComponent (lexique_var_,  operand_9057->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (lexique_var_)) ;
    operand_9057 = operand_9057->nextObject () ;
  }
  GGS_M_nonterminalSymbolAltsForGrammar::element_type * operand_9338 = var_cas_grammarAltMap.firstObject () ;
  while ((operand_9338 != NULL)) {
    ...
    searchKey_M_nonterminalSymbolAltsForGrammar (lexique_var_,
                                    ...
                                    NULL,
                                    NULL) ;
    operand_9338 = operand_9338->nextObject () ;
  }
