...
pr_galgas_component_grammar_parser_97_24_ (galgas_scanner & lexique_var_,
          ...
          case 2 : {
            ...
            while ((operand_7112 != NULL)) {
              ...
              if ((var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (operand_7112->mKey.reader_value ())).isBuiltAndTrue ()) {
                ...
                var_cas_nonterminalSymbolsMapForGrammar.methode_searchKey (lexique_var_, operand_7112->mKey, var_cas_altSignatureMap) ;
                ...
                while ((operand_7455 != NULL)) {
                  ...
                  var_cas_temp.methode_searchKey (lexique_var_, operand_7455->mKey, var_cas_importedAltSignature, var_cas_importedReturnedType) ;
                  ::routine_checkSignature_ForGrammarComponent (lexique_var_,  var_cas_importedAltSignature,  operand_7455->mInfo.mFormalParametersList,  operand_7455->mKey.reader_location ()) ;
                ...
                while ((operand_7965 != NULL)) {
                  ...
                  if (((operand_7965->mKey.reader_value ()) != (GGS_string (true, "parse"))).isBuiltAndTrue ()) {
                    ...
                    var_cas_altSignatureMap.methode_searchKey (lexique_var_, operand_7965->mKey, var_cas_8154, var_cas_8157) ;
                  }
                  operand_7965 = operand_7965->nextObject () ;
                }
              }else{
                var_cas_nonterminalSymbolsMapForGrammar.methode_insertKey (lexique_var_, operand_7112->mKey, operand_7112->mInfo.mNonterminalSymbolParametersMap) ;
              }
    ...
    while (syntaxRepeat) {
        ...
        switch (select_grammar_parser_5 (lexique_var_)) {
          ...
          case 2 : {
            ...
            var_cas_ioMetamodelComponentMap.methode_searchKey (lexique_var_, var_cas_returnedMetamodelName, var_cas_returnedEntityName, var_cas_9165) ;
            var_cas_startSymbolEntityAndMetamodelMap.methode_insertKey (lexique_var_, var_cas_altName, var_cas_returnedEntityName, var_cas_returnedMetamodelName) ;
            } break ;
          default :
            break ;
        }
        var_cas_grammarAltMap.methode_insertKey (lexique_var_, var_cas_altName, var_cas_signature, var_cas_returnedEntityName) ;
  ...
  while ((operand_9750 != NULL)) {
    ...
    var_cas_grammarAltMap.methode_searchKey (lexique_var_, operand_9750->mKey, var_cas_altMap, var_cas_returnedEntity) ;
    ::routine_checkSignature_ForGrammarComponent (lexique_var_,  operand_9750->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (lexique_var_)) ;
  ...
  while ((operand_10136 != NULL)) {
    ...
    var_cas_startSymbolAltMap.methode_searchKey (lexique_var_, operand_10136->mKey, var_cas_10220, var_cas_10223) ;
  ...
  if (var_cas_grammarName.isBuilt () &&
    ...
    ::routine_analyzeGrammar (lexique_var_,  var_cas_grammarName,  var_cas_grammarClass,  var_cas_startSymbolIndex,  var_cas_lexiqueName,  GGS_location (lexique_var_),  var_cas_terminalSymbolMap,  var_cas_syntaxComponentsList,  var_cas_nonterminalSymbolsMapForGrammar,  var_cas_startSymbolEntityAndMetamodelMap) ;
  }
...
pr_galgas_component_grammar_parser_97_24_importGrammarForSemantics (galgas_scanner & lexique_var_,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_grammarAltMap.methode_insertKey (lexique_var_, var_cas_altName, var_cas_signature, var_cas_returnedMetamodelName) ;
      switch (select_repeat_grammar_parser_4 (lexique_var_)) {
        case 2 : {
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_label) ;
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
