    ...
    while (syntaxRepeat_1) {
        ...
        switch (select_grammar_5F_parser_2 (inLexique)) {
          case 1 : {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3B_) COMMA_HERE) ;
            const GGS_bool cond_22891 = (var_cas_ioOptionsComponentsMap.reader_hasKey (var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (700)))).operator_not () ;
            if (cond_22891.isBuiltAndTrue ()) {
