...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_100_8_ (galgas_scanner & _inLexique,
        ...
        switch (select_grammar_parser_5 (_inLexique)) {
          ...
          case 2 : {
            ...
            if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
              var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_returnedMetamodelName, var_cas_returnedEntityName, automatic_var_2, automatic_var_3 SOURCE_FILE_AT_LINE (234)) ;
            }
            var_cas_startSymbolEntityAndMetamodelMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_returnedEntityName, var_cas_returnedMetamodelName SOURCE_FILE_AT_LINE (235)) ;
            } break ;
          default :
            break ;
        }
        var_cas_grammarAltMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_signature, var_cas_returnedEntityName SOURCE_FILE_AT_LINE (237)) ;
  ...
  while ((operand_10393 != NULL)) {
    ...
    if (var_cas_startSymbolAltMap._isBuilt ()) {
      var_cas_startSymbolAltMap (HERE)->method_searchKey (_inLexique, operand_10393->mKey, automatic_var_4, automatic_var_5 SOURCE_FILE_AT_LINE (258)) ;
    }
  ...
  if (var_cas_grammarName._isBuilt () &&
    ...
    ::routine_analyzeGrammar (_inLexique,  var_cas_grammarName,  var_cas_grammarClass,  var_cas_startSymbolIndex,  var_cas_lexiqueName,  GGS_location (_inLexique),  var_cas_terminalSymbolMap,  var_cas_syntaxComponentsList,  var_cas_nonterminalSymbolsMapForGrammar,  var_cas_startSymbolEntityAndMetamodelMap SOURCE_FILE_AT_LINE (261)) ;
  }
  var_cas_ioGrammarComponentsMap.modifier_insertKey (_inLexique, var_cas_grammarName, var_cas_startSymbolAltMap, var_cas_lexiqueName, var_cas_optionComponentsMap SOURCE_FILE_AT_LINE (273)) ;
...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_100_8_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_100_8_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_100_8_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_constraintComponents  &/* var_cas_ioConstraintComponentMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_100_8_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_constraintComponents  &/* var_cas_ioConstraintComponentMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
    ...
    while (syntaxRepeat) {
        ...
        switch (select_grammar_parser_1 (_inLexique)) {
          case 1 : {
            ...
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
            var_cas_optionComponentsMap.modifier_insertKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (478)) ;
            } break ;
          case 2 : {
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_syntax) COMMA_HERE) ;
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        var_cas_grammarAltMap.modifier_insertKey (_inLexique, var_cas_altName, var_cas_signature, var_cas_returnedMetamodelName SOURCE_FILE_AT_LINE (507)) ;
      switch (select_repeat_grammar_parser_4 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_label) COMMA_HERE) ;
          _inLexique._assignFromAttribute_tokenString (var_cas_altName) ;
  ...
  var_cas_ioGrammarComponentsMap.modifier_insertKey (_inLexique, var_cas_grammarName, var_cas_grammarAltMap, var_cas_lexiqueName, var_cas_optionComponentsMap SOURCE_FILE_AT_LINE (516)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_end) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
...
void grammar_parser::
grammar_parser::
pr_galgas_component_grammar_parser_100_8_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_grammar) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
