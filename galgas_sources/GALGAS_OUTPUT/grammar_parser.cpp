...
//                    november 12th, 2009, at 14h16'32"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_galgas_component_grammar_parser_218_23_ (galgas_scanner & inLexique,
    ...
    while (syntaxRepeat_1) {
        ...
        switch (select_grammar_parser_2 (inLexique)) {
          case 1 : {
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
            const GGS_bool cond_11272 = (var_cas_ioOptionsComponentsMap.reader_hasKey (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (282)) COMMA_SOURCE_FILE_AT_LINE (282))).operator_not () ;
          ...
          case 2 : {
            ...
            var_cas_syntaxComponentsList.addAssign_operation (var_cas_importedProductionRulesList, var_cas_syntaxComponentName) ;
            {
              ...
              while (((operand_12712 = enumerator_12712.nextObject ()))) {
                ...
                const GGS_bool cond_13630 = var_cas_nonterminalSymbolsMapForGrammar.reader_hasKey (inLexique, operand_12712->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (324)) COMMA_SOURCE_FILE_AT_LINE (324)) ;
                if (cond_13630.isBuiltAndTrue ()) {
                  ...
                  if (temp_12936.isBuilt ()) {
                    temp_12936 (HERE)->method_searchKey (inLexique, operand_12712->mKey, automatic_var_1, var_cas_altSignatureMap COMMA_SOURCE_FILE_AT_LINE (326)) ;
                  }
                  {
                    ...
                    while (((operand_13440 = enumerator_13440.nextObject ()))) {
                      ...
                      if (cond_13588.isBuiltAndTrue ()) {
                        ...
                        if (temp_13554.isBuilt ()) {
                          temp_13554 (HERE)->method_searchKey (inLexique, operand_13440->mKey, automatic_var_2 COMMA_SOURCE_FILE_AT_LINE (335)) ;
                        }
                      }
                    }
                  }
                }else if (cond_13630.isBuiltAndFalse ()) {
                  var_cas_nonterminalSymbolsMapForGrammar.modifier_insertKey (inLexique, operand_12712->mKey, var_cas_nonterminalSymbolsMapForGrammar.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (339)), operand_12712->mInfo.mNonterminalSymbolParametersMap COMMA_SOURCE_FILE_AT_LINE (339)) ;
                }
              }
            }
            } break ;
  ...
  var_cas_grammarAltMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), var_cas_signature COMMA_SOURCE_FILE_AT_LINE (354)) ;
      ...
      GGS_productionRuleListForGrammarAnalysis  var_cas_fixedProductionRuleList = GGS_productionRuleListForGrammarAnalysis ::constructor_emptyList () ;
      {
        ...
        while (((operand_15175 = enumerator_15175.nextObject ()))) {
          ...
          if (temp_15539.isBuilt ()) {
            temp_15539 (HERE)->method_searchKey (inLexique, operand_15175->mLeftNonterminalSymbol, var_cas_nonTerminalIndex, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (388)) ;
          }
          var_cas_fixedProductionRuleList.addAssign_operation (operand_15175->mLeftNonterminalSymbol, var_cas_nonTerminalIndex, var_cas_fixedInstructionList) ;
        }
      }
  ...
  const GGS_nonTerminalSymbolMapForGrammarAnalysis  temp_16041 = var_cas_nonterminalSymbolsMapForGrammar ;
  if (temp_16041.isBuilt ()) {
    temp_16041 (HERE)->method_searchKey (inLexique, var_cas_startSymbolName, var_cas_startSymbolIndex, var_cas_startSymbolAltMap COMMA_SOURCE_FILE_AT_LINE (403)) ;
  }
  {
    GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cEnumerator enumerator_16166 (var_cas_startSymbolAltMap, true) ;
    const GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cElement * operand_16166 = NULL ;
    while (((operand_16166 = enumerator_16166.nextObject ()))) {
      macroValidPointer (operand_16166) ;
      GGS_signatureForGrammarAnalysis  var_cas_altMap ;
      const GGS_nonterminalSymbolLabelMapForGrammarAnalysis  temp_16240 = var_cas_grammarAltMap ;
      if (temp_16240.isBuilt ()) {
        temp_16240 (HERE)->method_searchKey (inLexique, operand_16166->mKey, var_cas_altMap COMMA_SOURCE_FILE_AT_LINE (407)) ;
      }
      ::routine_checkSignature_ForGrammarComponent (inLexique,  operand_16166->mInfo.mFormalParametersList,  var_cas_altMap,  GGS_location (inLexique),  operand_16166->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (408)) COMMA_SOURCE_FILE_AT_LINE (408)) ;
    }
  }
  {
    GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cEnumerator enumerator_16390 (var_cas_grammarAltMap, true) ;
    const GGS_nonterminalSymbolLabelMapForGrammarAnalysis::cElement * operand_16390 = NULL ;
    while (((operand_16390 = enumerator_16390.nextObject ()))) {
      macroValidPointer (operand_16390) ;
      GGS_signatureForGrammarAnalysis  automatic_var_4 ;
      const GGS_nonterminalSymbolLabelMapForGrammarAnalysis  temp_16426 = var_cas_startSymbolAltMap ;
      if (temp_16426.isBuilt ()) {
        temp_16426 (HERE)->method_searchKey (inLexique, operand_16390->mKey, automatic_var_4 COMMA_SOURCE_FILE_AT_LINE (411)) ;
      }
    }
  }
        ...
        case 2 : {
          ...
          { bool syntaxRepeat_8 = true ;
            while (syntaxRepeat_8) {
                ...
                const GGS_nonTerminalSymbolMapForGrammarAnalysis  temp_16762 = var_cas_nonterminalSymbolsMapForGrammar ;
                if (temp_16762.isBuilt ()) {
                  temp_16762 (HERE)->method_searchKey (inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalIndex, automatic_var_5 COMMA_SOURCE_FILE_AT_LINE (421)) ;
                }
                var_cas_unusedNonTerminalSymbolsForGrammar.modifier_insertKey (inLexique, var_cas_nonterminalSymbolName, var_cas_nonterminalIndex COMMA_SOURCE_FILE_AT_LINE (422)) ;
  ...
  if (var_cas_grammarName.isBuilt () &&
      ...
      var_cas_lexiqueName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (433)).isBuilt () &&
      ...
      (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (439))).operator_concat (GGS_string ("/GALGAS_OUTPUT")).isBuilt () &&
      GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (440)).isBuilt ()) {
    ::routine_analyzeGrammar (inLexique,  var_cas_grammarName,  var_cas_grammarClass,  var_cas_startSymbolIndex,  var_cas_lexiqueName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (433)),  GGS_location (inLexique),  var_cas_actuallyUsedTerminalSymbolMap,  var_cas_syntaxComponentsListWithFixedInfos,  var_cas_nonterminalSymbolsMapForGrammar,  var_cas_unusedNonTerminalSymbolsForGrammar,  (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (439))).operator_concat (GGS_string ("/GALGAS_OUTPUT")),  GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (429)) ;
  }
  var_cas_ioGrammarComponentsMap.modifier_insertKey (inLexique, var_cas_grammarName, var_cas_startSymbolAltMap, var_cas_lexiqueName, var_cas_ioOptionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (443)) ;
...
pr_galgas_component_grammar_parser_218_23_importGrammarForSemantics (galgas_scanner & inLexique,
    ...
    while (syntaxRepeat_1) {
        ...
        switch (select_grammar_parser_2 (inLexique)) {
          case 1 : {
            ...
            switch (select_grammar_parser_3 (inLexique)) {
              case 1 : {
                const GGS_M_optionComponents  temp_22144 = var_cas_ioOptionsComponentsMap ;
                if (temp_22144.isBuilt ()) {
                  temp_22144 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (686)) ;
                }
                } break ;
              case 2 : {
                inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_in) COMMA_HERE) ;
                ...
                GGS_M_optionComponents  var_cas_importedOptionComponentsMap = GGS_M_optionComponents ::constructor_emptyMap (inLexique COMMA_HERE) ;
                nt_parse_option_component_for_importing_ (inLexique, var_cas_fileName, var_cas_importedOptionComponentsMap) ;
                const GGS_M_optionComponents  temp_22541 = var_cas_importedOptionComponentsMap ;
                if (temp_22541.isBuilt ()) {
                  temp_22541 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (696)) ;
                }
                } break ;
              default :
                break ;
            ...
            inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
            const GGS_bool cond_22854 = (var_cas_ioOptionsComponentsMap.reader_hasKey (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (699)) COMMA_SOURCE_FILE_AT_LINE (699))).operator_not () ;
            if (cond_22854.isBuiltAndTrue ()) {
              var_cas_ioOptionsComponentsMap.modifier_insertKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (700)) ;
            }
            } break ;
          case 2 : {
            inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_syntax) COMMA_HERE) ;
  ...
  GGS_signatureForGrammarAnalysis  var_cas_signature ;
  nt_formal_arguments_list_importGrammarForSemantics (inLexique, var_cas_signature) ;
  var_cas_grammarAltMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), var_cas_signature COMMA_SOURCE_FILE_AT_LINE (720)) ;
  { bool syntaxRepeat_5 = true ;
    while (syntaxRepeat_5) {
      switch (select_grammar_parser_5 (inLexique)) {
        case 2 : {
          ...
          switch (select_grammar_parser_6 (inLexique)) {
            case 1 : {
              ...
              GGS_signatureForGrammarAnalysis  var_cas_signature ;
              nt_formal_arguments_list_importGrammarForSemantics (inLexique, var_cas_signature) ;
              var_cas_grammarAltMap.modifier_insertKey (inLexique, var_cas_altName, var_cas_signature COMMA_SOURCE_FILE_AT_LINE (731)) ;
              } break ;
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_parse) COMMA_HERE) ;
              var_cas_startSymbolHasParseLabel = GGS_bool (true) ;
  ...
  var_cas_ioGrammarComponentsMap.modifier_insertKey (inLexique, var_cas_grammarName, var_cas_grammarAltMap, var_cas_lexiqueName, var_cas_ioOptionsComponentsMap COMMA_SOURCE_FILE_AT_LINE (740)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  { bool syntaxRepeat_7 = true ;
    while (syntaxRepeat_7) {
      switch (select_grammar_parser_7 (inLexique)) {
