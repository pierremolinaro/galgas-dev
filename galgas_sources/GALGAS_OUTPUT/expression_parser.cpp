...
pr_factor_expression_parser_1132_13_ (galgas_scanner & inLexique,
  ...
  GGS_lstring  automatic_var_44727_0 ;
  nt_read_access_ (inLexique, automatic_var_44727_0, var_cas_nomCppEntite1, var_cas_outResultType, var_cas_ioVariablesMap) ;
...
pr_factor_expression_parser_1152_13_ (galgas_scanner & inLexique,
  ...
  { const GGS_AC_galgasType _var_46359 = var_cas_castExpressionType ; // CAST instruction
    if (_var_46359.getPtr () != NULL) {
      macroValidPointer (_var_46359.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgasClassType *> (_var_46359.getPtr ()) != NULL) {
        const GGS_typeGalgasClassType var_cas_aClass (_var_46359.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeGalgas_object *> (_var_46359.getPtr ()) != NULL) {
  ...
  switch (select_expression_parser_6 (inLexique)) {
    case 1 : {
      ...
      const GGS_bool cond_46567 = var_cas_isObjectCast ;
      if (cond_46567.isBuiltAndTrue ()) {
  ...
  const GGS_M_semanticsEntitiesForUse  temp_46825 = var_cas_inEntitiesMap ;
  if (temp_46825.isBuilt ()) {
    temp_46825 (HERE)->method_searchKey (inLexique, var_cas_castedTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1202)) ;
  }
  ...
  const GGS_bool cond_48070 = (var_cas_isObjectCast).operator_not () ;
  if (cond_48070.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_47529 = (var_cas_classMessage.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
    if (cond_47529.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_47887 = (var_cas_checkForKindOfClass).operator_not () ;
    if (cond_47887.isBuiltAndTrue ()) {
      const GGS_bool cond_47872 = ((var_cas_castedTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1216))).operator_isNotEqual (var_cas_kSourceExpressionClassName)).operator_and ((var_cas_superClassMap.reader_hasKey (var_cas_kSourceExpressionClassName)).operator_not ()) ;
      if (cond_47872.isBuiltAndTrue ()) {
    ...
    }else if (cond_47887.isBuiltAndFalse ()) {
      const GGS_bool cond_48059 = (var_cas_superClassMap.reader_hasKey (var_cas_kSourceExpressionClassName)).operator_not () ;
      if (cond_48059.isBuiltAndTrue ()) {
  ...
  const GGS_AC_galgasType  temp_48529 = var_cas_errorLocationExpressionType ;
  if (temp_48529.isBuilt ()) {
    temp_48529 (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (1236)) ;
  }
  const GGS_bool cond_48723 = var_cas_isObjectCast ;
...
void expression_parser::
pr_factor_expression_parser_1510_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_inEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1510_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_double) COMMA_HERE) ;
  GGS_lstring::constructor_retrieveAndResetTemplateString (inLexique COMMA_HERE) ;
}
...
void expression_parser::
pr_factor_expression_parser_1530_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_inEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1530_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_here) COMMA_HERE) ;
  GGS_lstring::constructor_retrieveAndResetTemplateString (inLexique COMMA_HERE) ;
}
...
void expression_parser::
pr_factor_expression_parser_1549_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  GGS_AC_semanticsEntity  automatic_var_61364_0 ;
  const GGS_M_semanticsEntitiesForUse  temp_61350 = var_cas_inEntitiesMap ;
  if (temp_61350.isBuilt ()) {
    temp_61350 (HERE)->method_searchKey (inLexique, var_cas_typeName, automatic_var_61364_0 COMMA_SOURCE_FILE_AT_LINE (1559)) ;
  }
...
void expression_parser::
pr_factor_expression_parser_1549_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__60_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  GGS_lstring::constructor_retrieveAndResetTemplateString (inLexique COMMA_HERE) ;
}
...
pr_factor_expression_parser_1570_13_ (galgas_scanner & inLexique,
  ...
  GGS_typeGalgas_bool  var_cas_gb = GGS_typeGalgas_bool::castFrom (inLexique, var_cas_ifExpressionType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1591)) ;
  ...
  ::routine_checkAssignmentTypesCompatibility (inLexique,  var_cas_outResultType,  var_cas_elseExpressionType,  var_cas_errorLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1617)) ;
...
void expression_parser::
pr_factor_expression_parser_1642_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  ::routine_handleReaderCall (inLexique,  var_cas_inEntitiesMap,  var_cas_inSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1672)),  var_cas_expressionType,  var_cas_methodName,  var_cas_accessorsTypeList,  var_cas_outResultType,  var_cas_conversionMethod,  var_cas_categoryReaderClassBaseName,  var_cas_hasLexiqueAndLocationArguments COMMA_SOURCE_FILE_AT_LINE (1670)) ;
...
void expression_parser::
pr_factor_expression_parser_1642_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  nt_expression_parse (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void expression_parser::
pr_factor_expression_parser_1710_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  const GGS_M_semanticsEntitiesForUse  temp_66492 = var_cas_inEntitiesMap ;
  if (temp_66492.isBuilt ()) {
    temp_66492 (HERE)->method_searchKey (inLexique, var_cas_typeName, var_cas_e COMMA_SOURCE_FILE_AT_LINE (1723)) ;
  }
  GGS_AC_galgasType  var_cas_type = GGS_typeEntiteType::castFrom (inLexique, var_cas_e.getPtr (), true, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (1724)).reader_aDefType (inLexique COMMA_SOURCE_FILE_AT_LINE (1724)) ;
  ...
  GGS_bool var_cas_hasLexiqueAndLocationArguments ;
  const GGS_AC_galgasType  temp_66824 = var_cas_type ;
  if (temp_66824.isBuilt ()) {
    temp_66824 (HERE)->method_handleConstructorInvocation (inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques, var_cas_hasLexiqueAndLocationArguments, var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1730)) ;
  }
  GGS_typeExpressionList  var_cas_expressionList ;
  ...
  var_cas_outExpression = GGS_typeConstructorExpression ::constructor_new (inLexique, var_cas_type, var_cas_mClassMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1743)), var_cas_hasLexiqueAndLocationArguments, var_cas_expressionList COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5D_) COMMA_HERE) ;
}
...
void expression_parser::
pr_factor_expression_parser_1710_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  nt_output_expression_list_parse (inLexique) ;
...
void expression_parser::
pr_factor_expression_parser_1759_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_inEntitiesMap */,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
  ...
  switch (select_expression_parser_8 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      const GGS_bool cond_68487 = (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1772))).operator_isNotEqual (GGS_string ("verbose_output")) ;
      if (cond_68487.isBuiltAndTrue ()) {
        var_cas_optionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this option name does not correspond to a builtin option") COMMA_SOURCE_FILE_AT_LINE (1774)) ;
      }
      GGS_lstring  var_cas_readerName ;
      inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      const GGS_bool cond_68633 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1776))).operator_isEqual (GGS_string ("value")) ;
      if (cond_68633.isBuiltAndTrue ()) {
        var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_HERE) ;
      }else if (cond_68633.isBuiltAndFalse ()) {
        const GGS_bool cond_68726 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1778))).operator_isEqual (GGS_string ("char")) ;
        if (cond_68726.isBuiltAndTrue ()) {
          var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_HERE) ;
        }else if (cond_68726.isBuiltAndFalse ()) {
          const GGS_bool cond_68821 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1780))).operator_isEqual (GGS_string ("string")) ;
          if (cond_68821.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_HERE) ;
          }else if (cond_68821.isBuiltAndFalse ()) {
            const GGS_bool cond_68918 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1782))).operator_isEqual (GGS_string ("comment")) ;
            if (cond_68918.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
            }else if (cond_68918.isBuiltAndFalse ()) {
              var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'value', 'char', 'string' and 'comment' readers are defined") COMMA_SOURCE_FILE_AT_LINE (1786)) ;
              var_cas_outResultType.drop () ;
            }
          }
        }
      }
      var_cas_outExpression = GGS_typeOptionAccess ::constructor_new (inLexique, GGS_string ("galgas_cli_options"), var_cas_optionName, var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1787)) COMMA_HERE) ;
      } break ;
    case 2 : {
      ...
      const GGS_M_optionComponents  temp_69353 = var_cas_inOptionsComponentsMapForUse ;
      if (temp_69353.isBuilt ()) {
        temp_69353 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1793)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E_) COMMA_HERE) ;
      GGS_lstring  var_cas_optionName ;
      inLexique.assignFromAttribute_tokenString (var_cas_optionName) ;
      ...
      inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      const GGS_bool cond_70096 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1797))).operator_isEqual (GGS_string ("value")) ;
      if (cond_70096.isBuiltAndTrue ()) {
        const GGS_bool cond_69681 = var_cas_boolOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1798))) ;
        if (cond_69681.isBuiltAndTrue ()) {
          var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_HERE) ;
        }else if (cond_69681.isBuiltAndFalse ()) {
          const GGS_bool cond_69793 = var_cas_uintOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1800))) ;
          if (cond_69793.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_HERE) ;
          }else if (cond_69793.isBuiltAndFalse ()) {
            const GGS_bool cond_69908 = var_cas_stringOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1802))) ;
            if (cond_69908.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
            }else if (cond_69908.isBuiltAndFalse ()) {
              var_cas_optionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1805)))).operator_concat (GGS_string ("' option component has no '"))).operator_concat (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1805)))).operator_concat (GGS_string ("' option")) COMMA_SOURCE_FILE_AT_LINE (1807)) ;
              var_cas_outResultType.drop () ;
            }
          }
        }
      }else if (cond_70096.isBuiltAndFalse ()) {
        const GGS_bool cond_70189 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1808))).operator_isEqual (GGS_string ("char")) ;
        if (cond_70189.isBuiltAndTrue ()) {
          var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_HERE) ;
        }else if (cond_70189.isBuiltAndFalse ()) {
          const GGS_bool cond_70286 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1810))).operator_isEqual (GGS_string ("string")) ;
          if (cond_70286.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
          }else if (cond_70286.isBuiltAndFalse ()) {
            const GGS_bool cond_70383 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1812))).operator_isEqual (GGS_string ("comment")) ;
            if (cond_70383.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
            }else if (cond_70383.isBuiltAndFalse ()) {
              var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'value', 'char', 'string' and 'comment' readers are defined") COMMA_SOURCE_FILE_AT_LINE (1816)) ;
              var_cas_outResultType.drop () ;
            }
          }
        }
      }
      var_cas_outExpression = GGS_typeOptionAccess ::constructor_new (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1817)), var_cas_optionName, var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1817)) COMMA_HERE) ;
      } break ;
    default :
      break ;
  }
...
void expression_parser::
pr_factor_expression_parser_1759_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_option) COMMA_HERE) ;
  switch (select_expression_parser_8 (inLexique)) {
    case 1 : {
...
void expression_parser::
pr_factor_expression_parser_1832_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  const GGS_M_filewrappers  temp_71875 = var_cas_inSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (1847)) ;
  if (temp_71875.isBuilt ()) {
    temp_71875 (HERE)->method_searchKey (inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1847)) ;
  }
    ...
    case 2 : {
      ...
      switch (select_expression_parser_10 (inLexique)) {
        case 1 : {
          ...
          const GGS_filewrapperTemplateMap  temp_72283 = var_cas_templateMap ;
          if (temp_72283.isBuilt ()) {
            temp_72283 (HERE)->method_searchKey (inLexique, var_cas_templateName, var_cas_formalAttributeList COMMA_SOURCE_FILE_AT_LINE (1859)) ;
          }
          GGS_typeExpressionList  var_cas_expressionList ;
        ...
        case 2 : {
          ...
          GGS_uint  automatic_var_72943_0 ;
          const GGS_M_regularFiles  temp_72915 = var_cas_regularFileMap ;
          if (temp_72915.isBuilt ()) {
            temp_72915 (HERE)->method_searchKey (inLexique, var_cas_path, automatic_var_72943_0, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1879)) ;
          }
...
void expression_parser::
pr_factor_expression_parser_1832_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_filewrapper) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  switch (select_expression_parser_9 (inLexique)) {
...
void expression_parser::
pr_factor_expression_parser_1894_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_74071 = var_cas_inEntitiesMap ;
  if (temp_74071.isBuilt ()) {
    temp_74071 (HERE)->method_searchKey (inLexique, var_cas_functionName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1907)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_74651 = var_cas_entite ; // CAST instruction
    if (_var_74651.getPtr () != NULL) {
      macroValidPointer (_var_74651.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteFonction *> (_var_74651.getPtr ()) != NULL) {
        const GGS_typeEntiteFonction var_cas_r (_var_74651.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_r.reader_aListeArgumentsFormels (inLexique COMMA_SOURCE_FILE_AT_LINE (1911)) ;
        var_cas_outResultType = var_cas_r.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1912)) ;
        var_cas_isExternActionCall = GGS_bool (false) ;
      }else if (dynamic_cast <cPtr_typeEntiteFonctionExterne *> (_var_74651.getPtr ()) != NULL) {
        const GGS_typeEntiteFonctionExterne var_cas_ae (_var_74651.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_ae.reader_aSignature (inLexique COMMA_SOURCE_FILE_AT_LINE (1915)) ;
        var_cas_outResultType = var_cas_ae.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1916)) ;
        var_cas_isExternActionCall = GGS_bool (true) ;
      }else{
        var_cas_functionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'")).operator_concat (var_cas_functionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1920)))).operator_concat (GGS_string ("' should name a function or an extern function")) COMMA_SOURCE_FILE_AT_LINE (1923)) ;
  ...
  {
    GGS_L_EXsignature::cEnumerator enumerator_74819 (var_cas_signatureRoutine, true) ;
    const GGS_L_EXsignature::cElement * operand_74819 = NULL ;
    while (((operand_74819 = enumerator_74819.nextObject ()))) {
      macroValidPointer (operand_74819) ;
      var_cas_listeAttributsSemantiques.addAssign_operation (operand_74819->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  nt_output_expression_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
...
void expression_parser::
pr_factor_expression_parser_1894_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  nt_output_expression_list_parse (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5D_) COMMA_HERE) ;
...
void expression_parser::
pr_read_access_expression_parser_1949_18_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1956)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_read_access_expression_parser_1949_18_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  GGS_lstring::constructor_retrieveAndResetTemplateString (inLexique COMMA_HERE) ;
}
...
void expression_parser::
pr_read_access_expression_parser_1965_18_ (galgas_scanner & inLexique,
                                GGS_lstring  &var_cas_nomVariable,
                                GGS_typeCplusPlusName  &var_cas_nomCppEntite,
                                GGS_AC_galgasType  &var_cas_typeEntite,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
  const GGS_bool cond_76620 = var_cas_ioVariablesMap.reader_hasKey (GGS_string ("self")) ;
  if (cond_76620.isBuiltAndTrue ()) {
    var_cas_nomVariable = GGS_lstring ::constructor_new (inLexique, GGS_string ("self"), GGS_location (inLexique) COMMA_HERE) ;
    var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1974)) ;
  }else if (cond_76620.isBuiltAndFalse ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'self' is not defined in this context") COMMA_SOURCE_FILE_AT_LINE (1978)) ;
...
void expression_parser::
pr_read_access_expression_parser_1965_18_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
  GGS_lstring::constructor_retrieveAndResetTemplateString (inLexique COMMA_HERE) ;
}
...
void expression_parser::
pr_output_expression_list_expression_parser_1987_29_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_78181 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictInf (var_cas_effectiveTypesList.reader_length ()) ;
  if (cond_78181.isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("too much expressions") COMMA_SOURCE_FILE_AT_LINE (2018)) ;
  }else if (cond_78181.isBuiltAndFalse ()) {
    const GGS_bool cond_78321 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictSup (var_cas_effectiveTypesList.reader_length ()) ;
    if (cond_78321.isBuiltAndTrue ()) {
      var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more expressions missing") COMMA_SOURCE_FILE_AT_LINE (2020)) ;
    }else if (cond_78321.isBuiltAndFalse ()) {
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_78356 (var_cas_inFormalAttributesList, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_78356 = NULL ;
        GGS_typeTypesList::cEnumerator enumerator_78376 (var_cas_effectiveTypesList, true) ;
        const GGS_typeTypesList::cElement * operand_78376 = NULL ;
        while (((operand_78356 = enumerator_78356.nextObject ()))
            && ((operand_78376 = enumerator_78376.nextObject ()))) {
          macroValidPointer (operand_78356) ;
          macroValidPointer (operand_78376) ;
          ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_78356->mAttributType,  operand_78376->mType,  operand_78376->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (2022)) ;
        }
      }
    }
  }
...
void expression_parser::
pr_output_expression_list_expression_parser_1987_29_parse (galgas_scanner & inLexique) {
  { bool syntaxRepeat_11 = true ;
    while (syntaxRepeat_11) {
      switch (select_expression_parser_11 (inLexique)) {
        case 2 : {
...
void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_2033_44_ (galgas_scanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
        ...
        case 2 : {
          switch (select_expression_parser_13 (inLexique)) {
            ...
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2A_) COMMA_HERE) ;
              GGS_uint  var_cas_jokerCount = var_cas_jokerCountWithLocation.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2060)) ;
              GGS_uint _variant_79949 = var_cas_jokerCount.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (2061)) ;
              GGS_bool _condition_79949 (_variant_79949.isBuilt (), true) ;
              while (_condition_79949.isBuiltAndTrue ()) {
                _condition_79949 = (var_cas_jokerCount).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_79949.isBuiltAndTrue ()) {
                  if (_variant_79949.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2065)) ;
                    _condition_79949 = GGS_bool (false) ;
                  }else{
                    _variant_79949.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_argumentsList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
                    var_cas_jokerCount.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (2064)) ;
                  }
                }
              }
              } break ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__29_) COMMA_HERE) ;
  ::routine_buildMapWithLocalConstants (inLexique,  var_cas_inEnumeratorNewStyle,  var_cas_argumentsList,  var_cas_inFormalArgumentsList,  var_cas_ioVariablesMap,  var_cas_inVarLocation,  var_cas_inLocalConstantStyle,  var_cas_ellipsisFound COMMA_SOURCE_FILE_AT_LINE (2077)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_2033_44_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28_) COMMA_HERE) ;
  { bool syntaxRepeat_12 = true ;
    while (syntaxRepeat_12) {
      switch (select_expression_parser_12 (inLexique)) {
