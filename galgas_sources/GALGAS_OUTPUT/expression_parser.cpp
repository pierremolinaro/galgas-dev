      ...
      if ((operand_8067 != NULL) && (operand_8092 != NULL)) {
        ...
        if ((operand_8067 != NULL) && (operand_8092 != NULL)) {
          ...
          if ((operand_8067 != NULL) && (operand_8092 != NULL)) {
            ...
            cPtr_typeGalgas_double * operand_8067 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_8067) ;
            cPtr_typeGalgas_double * operand_8092 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_8092) ;
            if ((operand_8067 != NULL) && (operand_8092 != NULL)) {
            }else{
