...
//                    november 12th, 2005, at 18h22'31"                      *
//                                                                           *
...
void routine_matchOrOperator (C_Lexique & lexique_var_,
                                ...
                                GGS_AC_galgasType  & var_cas_outResultType) {
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_5672 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_5697 = var_cas_inRightExpressionType (HERE) ;
...
void routine_matchConcatOperator (C_Lexique & lexique_var_,
                                ...
                                GGS_AC_galgasType  & var_cas_outResultType) {
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_6592 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_6617 = var_cas_inRightExpressionType (HERE) ;
...
void routine_comparison_types_check (C_Lexique & lexique_var_,
                                ...
                                const GGS_AC_galgasType  & var_cas_inRightExpressionType) {
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_8100 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_8125 = var_cas_inRightExpressionType (HERE) ;
