              ...
              if ((operand_9241 != NULL) && (operand_9266 != NULL)) {
                ...
                if ((operand_9241 != NULL) && (operand_9266 != NULL)) {
                  if (((operand_9241->mEnumTypeName.reader_value ()) != (operand_9266->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "comparison between a '@")) + (operand_9241->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' enumeration and a '@")))) + (operand_9266->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' is not valid")))) ;
                  }
                }else{
    ...
    while (syntaxRepeat) {
      switch (select_repeat_expression_parser_1 (lexique_var_)) {
        ...
        case 3 : {
          ...
          GGS_AC_galgasType  var_cas_secondOperandType ;
          nt_relation_term_ (lexique_var_, var_cas_ioEntitiesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_rightOperand, var_cas_secondOperandType) ;
          var_cas_outExpression = GGS_typeMinusOperation::constructor_new (var_cas_leftOperand, var_cas_rightOperand) ;
          ::routine_matchMinusOperator (lexique_var_,  var_cas_firstOperandType,  var_cas_secondOperandType,  var_cas_outResultType) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
...
pr_factor_expression_parser_769_14_ (galgas_scanner & lexique_var_,
  ...
  switch (select_expression_parser_4 (lexique_var_)) {
    ...
    case 2 : {
      ...
      var_cas_ioEntitiesMap.methode_searchKey (lexique_var_, var_cas_className, var_cas_entity) ;
    ...
    case 3 : {
      ...
      var_cas_ioOptionsComponentsMapForUse.methode_searchKey (lexique_var_, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap) ;
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__2E) ;
      ...
      if ((var_cas_boolOptionsMap.reader_hasKey (var_cas_optionName.reader_value ())).isBuiltAndTrue ()) {
        ...
        var_cas_outExpression = GGS_typeStringOption::constructor_new (var_cas_optionComponentName, var_cas_optionName) ;
        var_cas_outResultType = GGS_typeGalgas_uint::constructor_new () ;
      }else{
...
pr_read_access_expression_parser_860_19_ (galgas_scanner & lexique_var_,
  ...
  var_cas_ioVariablesMap.methode_searchForReadOnlyAccess (lexique_var_, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite) ;
}
...
pr_output_expression_list_expression_parser_876_30_ (galgas_scanner & lexique_var_,
  ...
  if (((var_cas_inFormalAttributesList.reader_length ()) < (var_cas_effectiveTypesList.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_34218 = var_cas_inFormalAttributesList.firstObject () ;
    GGS_typeTypesList::element_type * operand_34313 = var_cas_effectiveTypesList.firstObject () ;
    while ((operand_34218 != NULL)
        && (operand_34313 != NULL)) {
      macroValidPointer (operand_34218) ;
      macroValidPointer (operand_34313) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34218->mAttributType,  operand_34313->mType,  operand_34313->mEndOfExpressionLocation) ;
      operand_34218 = operand_34218->nextObject () ;
      operand_34313 = operand_34313->nextObject () ;
    }
  }
}
...
pr_parse_effective_input_parameters_list_expression_parser_921_45_ (galgas_scanner & lexique_var_,
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
  ::routine_buildMapWithLocalConstants (lexique_var_,  var_cas_argumentsList,  var_cas_inFormalArgumentsList,  var_cas_ioVariablesMap,  var_cas_inVarLocation,  var_cas_inLocalConstantStyle,  var_cas_ellipsisFound) ;
}
