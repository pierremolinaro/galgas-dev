...
pr_output_expression_list_expression_parser_828_30_ (galgas_scanner & lexique_var_,
  ...
  if (((var_cas_inFormalAttributesList.reader_length ()) < (var_cas_effectiveTypesList.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_32329 = var_cas_inFormalAttributesList.firstObject () ;
    GGS_typeTypesList::element_type * operand_32410 = var_cas_effectiveTypesList.firstObject () ;
    while ((operand_32329 != NULL) && (operand_32410 != NULL)) {
      macroValidPointer (operand_32329) ;
      macroValidPointer (operand_32410) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_32329->mAttributType,  operand_32410->mType,  operand_32410->mEndOfExpressionLocation) ;
      operand_32329 = operand_32329->nextObject () ;
