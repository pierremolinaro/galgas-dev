...
//                    november 15th, 2009, at 13h34'37"                      *
//                                                                           *
//---------------------------------------------------------------------------*
                                      ...
                                      if ((operand_13278 != NULL) && (operand_13302 != NULL)) {
                                        ...
                                        if ((operand_13278 != NULL) && (operand_13302 != NULL)) {
                                          ...
                                          if ((operand_13278 != NULL) && (operand_13302 != NULL)) {
                                            ...
                                            if ((operand_13278 != NULL) && (operand_13302 != NULL)) {
                                              const GGS_bool cond_14857 = (operand_13278->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (337))).operator_isNotEqual (operand_13302->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (337))) ;
                                              ...
                                              if ((operand_13278 != NULL) && (operand_13302 != NULL)) {
                                                const GGS_bool cond_15204 = (operand_13278->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (342))).operator_isNotEqual (operand_13302->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (342))) ;
                                                if (cond_15204.isBuiltAndTrue ()) {
                                                ...
                                                if ((operand_13278 != NULL) && (operand_13302 != NULL)) {
                                                  const GGS_bool cond_15548 = (operand_13278->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (348))).operator_isNotEqual (operand_13302->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (348))) ;
                                                  if (cond_15548.isBuiltAndTrue ()) {
                                                  ...
                                                  if ((operand_13278 != NULL) && (operand_13302 != NULL)) {
                                                    const GGS_bool cond_15892 = (operand_13278->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (355))).operator_isNotEqual (operand_13302->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (355))) ;
                                                    if (cond_15892.isBuiltAndTrue ()) {
                ...
                if ((operand_16648 != NULL) && (operand_16672 != NULL)) {
                  ...
                  if ((operand_16648 != NULL) && (operand_16672 != NULL)) {
                    ...
                    if ((operand_16648 != NULL) && (operand_16672 != NULL)) {
                      ...
                      if ((operand_16648 != NULL) && (operand_16672 != NULL)) {
                        const GGS_bool cond_17528 = (operand_16648->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (386))).operator_isNotEqual (operand_16672->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (386))) ;
...
pr_factor_expression_parser_1139_13_ (galgas_scanner & inLexique,
  ...
  { const GGS_AC_galgasType _var_45692 = var_cas_castExpressionType ; // CAST instruction
    if (_var_45692.getPtr () != NULL) {
      macroValidPointer (_var_45692.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgasClassType *> (_var_45692.getPtr ()) != NULL) {
        const GGS_typeGalgasClassType var_cas_aClass (_var_45692.getPtr ()) ;
        var_cas_kSourceExpressionClassName = var_cas_aClass.reader_mClassTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (1164)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1164)) ;
        var_cas_isObjectCast = GGS_bool (false) ;
      }else if (dynamic_cast <cPtr_typeGalgas_object *> (_var_45692.getPtr ()) != NULL) {
        var_cas_kSourceExpressionClassName = GGS_string ("object") ;
        var_cas_isObjectCast = GGS_bool (true) ;
      }else{
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the cast expression should be an instance of an object type, or an instance of a class type") COMMA_SOURCE_FILE_AT_LINE (1171)) ;
  ...
  switch (select_expression_parser_6 (inLexique)) {
    case 1 : {
      ...
      const GGS_bool cond_45900 = var_cas_isObjectCast ;
      if (cond_45900.isBuiltAndTrue ()) {
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("casting an object instance requires the '==' operator") COMMA_SOURCE_FILE_AT_LINE (1179)) ;
      }
      } break ;
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3D__3D_) COMMA_HERE) ;
  ...
  const GGS_M_semanticsEntitiesForUse  temp_46158 = var_cas_inEntitiesMap ;
  if (temp_46158.isBuilt ()) {
    temp_46158 (HERE)->method_searchKey (inLexique, var_cas_castedTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1189)) ;
  }
  var_cas_outResultType = GGS_typeEntiteType::castFrom (inLexique, var_cas_entite.getPtr (), true, var_cas_castedTypeName COMMA_SOURCE_FILE_AT_LINE (1190)).reader_aDefType (inLexique COMMA_SOURCE_FILE_AT_LINE (1190)) ;
  const GGS_bool cond_47403 = (var_cas_isObjectCast).operator_not () ;
  if (cond_47403.isBuiltAndTrue ()) {
    GGS_typeGalgasClassType  var_cas_resultClassType = GGS_typeGalgasClassType::castFrom (inLexique, var_cas_outResultType.getPtr (), true, var_cas_castedTypeName COMMA_SOURCE_FILE_AT_LINE (1194)) ;
    GGS_typeSuperClassesMap  var_cas_superClassMap = var_cas_resultClassType.reader_mAncestorClassesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1195)) ;
    GGS_string var_cas_classMessage = var_cas_resultClassType.reader_mClassMessage (inLexique COMMA_SOURCE_FILE_AT_LINE (1196)) ;
    const GGS_bool cond_46862 = (var_cas_classMessage.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
    if (cond_46862.isBuiltAndTrue ()) {
      var_cas_castedTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("in order to be used in a cast expression, the '@")).operator_concat (var_cas_castedTypeName)).operator_concat (GGS_string ("' class should define a class message")) COMMA_SOURCE_FILE_AT_LINE (1200)) ;
    }
    const GGS_bool cond_47220 = (var_cas_checkForKindOfClass).operator_not () ;
    if (cond_47220.isBuiltAndTrue ()) {
      const GGS_bool cond_47205 = ((var_cas_castedTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1203))).operator_isNotEqual (var_cas_kSourceExpressionClassName)).operator_and ((var_cas_superClassMap.reader_hasKey (var_cas_kSourceExpressionClassName)).operator_not ()) ;
      if (cond_47205.isBuiltAndTrue ()) {
        var_cas_castedTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("This class is not '@")).operator_concat (var_cas_kSourceExpressionClassName)).operator_concat (GGS_string ("' and does inherit from it")) COMMA_SOURCE_FILE_AT_LINE (1205)) ;
      }
    }else if (cond_47220.isBuiltAndFalse ()) {
      const GGS_bool cond_47392 = (var_cas_superClassMap.reader_hasKey (var_cas_kSourceExpressionClassName)).operator_not () ;
      if (cond_47392.isBuiltAndTrue ()) {
        var_cas_castedTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("This class does not inherit from '@")).operator_concat (var_cas_kSourceExpressionClassName)).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1208)) ;
      }
    }
  }
  ...
  const GGS_AC_galgasType  temp_47862 = var_cas_errorLocationExpressionType ;
  if (temp_47862.isBuilt ()) {
    temp_47862 (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (1223)) ;
  }
  const GGS_bool cond_48056 = var_cas_isObjectCast ;
  if (cond_48056.isBuiltAndTrue ()) {
  ...
  }else if (cond_48056.isBuiltAndFalse ()) {
...
void expression_parser::
pr_factor_expression_parser_1248_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void expression_parser::
pr_factor_expression_parser_1248_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28_) COMMA_HERE) ;
  nt_expression_parse (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__29_) COMMA_HERE) ;
}
...
void expression_parser::
pr_factor_expression_parser_1274_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  ::routine_checkNotOperator (inLexique,  var_cas_operandType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1295)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_factor_expression_parser_1274_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_not) COMMA_HERE) ;
  nt_factor_parse (inLexique) ;
}
...
void expression_parser::
pr_factor_expression_parser_1304_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  ::routine_checkLogicalNegateOperator (inLexique,  var_cas_operandType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1325)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_factor_expression_parser_1304_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7E_) COMMA_HERE) ;
  nt_factor_parse (inLexique) ;
}
...
void expression_parser::
pr_factor_expression_parser_1353_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_inEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1353_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_false) COMMA_HERE) ;
}
...
void expression_parser::
pr_factor_expression_parser_1372_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_inEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
  ...
  { bool syntaxRepeat_7 = true ;
    while (syntaxRepeat_7) {
        ...
        var_cas_literalStringList.addAssign_operation (var_cas_literalString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1384))) ;
...
void expression_parser::
pr_factor_expression_parser_1372_13_parse (galgas_scanner & inLexique) {
  { bool syntaxRepeat_7 = true ;
    while (syntaxRepeat_7) {
        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
      switch (select_expression_parser_7 (inLexique)) {
...
void expression_parser::
pr_factor_expression_parser_1397_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_inEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1397_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
}
...
void expression_parser::
pr_factor_expression_parser_1417_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_inEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1417_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_signed_5F_literal_5F_integer) COMMA_HERE) ;
}
...
void expression_parser::
pr_factor_expression_parser_1437_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_inEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1437_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5F_literal_5F_integer_36__34_) COMMA_HERE) ;
}
...
void expression_parser::
pr_factor_expression_parser_1457_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_inEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1457_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_signed_5F_literal_5F_integer_36__34_) COMMA_HERE) ;
}
...
void expression_parser::
pr_factor_expression_parser_1477_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_inEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1477_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_char) COMMA_HERE) ;
}
...
void expression_parser::
pr_factor_expression_parser_1497_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_inEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1497_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_double) COMMA_HERE) ;
}
...
void expression_parser::
pr_factor_expression_parser_1517_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_inEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1517_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_here) COMMA_HERE) ;
}
...
void expression_parser::
pr_factor_expression_parser_1536_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
  ...
  const GGS_M_semanticsEntitiesForUse  temp_60683 = var_cas_inEntitiesMap ;
  if (temp_60683.isBuilt ()) {
    temp_60683 (HERE)->method_searchKey (inLexique, var_cas_typeName, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (1546)) ;
  }
...
void expression_parser::
pr_factor_expression_parser_1536_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__60_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
}
...
void expression_parser::
pr_factor_expression_parser_1557_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_typeGalgas_bool  var_cas_gb = GGS_typeGalgas_bool::castFrom (inLexique, var_cas_ifExpressionType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1578)) ;
  ...
  ::routine_checkAssignmentTypesCompatibility (inLexique,  var_cas_outResultType,  var_cas_elseExpressionType,  var_cas_errorLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1604)) ;
...
void expression_parser::
pr_factor_expression_parser_1557_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_if) COMMA_HERE) ;
  nt_expression_parse (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_then) COMMA_HERE) ;
  nt_expression_parse (inLexique) ;
...
void expression_parser::
pr_factor_expression_parser_1629_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  switch (select_expression_parser_8 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_handleReaderCall (inLexique,  var_cas_inEntitiesMap,  var_cas_inSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1664)),  var_cas_expressionType,  var_cas_methodName,  var_cas_accessorsTypeList,  var_cas_outResultType,  var_cas_conversionMethod,  var_cas_categoryReaderClassBaseName,  var_cas_hasLexiqueAndLocationArguments COMMA_SOURCE_FILE_AT_LINE (1662)) ;
...
void expression_parser::
pr_factor_expression_parser_1629_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  nt_expression_parse (inLexique) ;
  switch (select_expression_parser_8 (inLexique)) {
    case 1 : {
...
void expression_parser::
pr_factor_expression_parser_1703_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  const GGS_M_semanticsEntitiesForUse  temp_66077 = var_cas_inEntitiesMap ;
  if (temp_66077.isBuilt ()) {
    temp_66077 (HERE)->method_searchKey (inLexique, var_cas_typeName, var_cas_e COMMA_SOURCE_FILE_AT_LINE (1716)) ;
  }
  GGS_AC_galgasType  var_cas_type = GGS_typeEntiteType::castFrom (inLexique, var_cas_e.getPtr (), true, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (1717)).reader_aDefType (inLexique COMMA_SOURCE_FILE_AT_LINE (1717)) ;
  ...
  GGS_bool var_cas_hasLexiqueAndLocationArguments ;
  const GGS_AC_galgasType  temp_66409 = var_cas_type ;
  if (temp_66409.isBuilt ()) {
    temp_66409 (HERE)->method_handleConstructorInvocation (inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques, var_cas_hasLexiqueAndLocationArguments, var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1723)) ;
  }
  GGS_typeExpressionList  var_cas_expressionList ;
  ...
  var_cas_outExpression = GGS_typeConstructorExpression ::constructor_new (inLexique, var_cas_type, var_cas_mClassMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1736)), var_cas_hasLexiqueAndLocationArguments, var_cas_expressionList COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5D_) COMMA_HERE) ;
}
...
void expression_parser::
pr_factor_expression_parser_1703_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  nt_output_expression_list_parse (inLexique) ;
...
void expression_parser::
pr_factor_expression_parser_1752_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_inEntitiesMap */,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
  ...
  switch (select_expression_parser_9 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      const GGS_bool cond_68089 = (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1766))).operator_isNotEqual (GGS_string ("verbose_output")) ;
      if (cond_68089.isBuiltAndTrue ()) {
        var_cas_optionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this option name does not correspond to a builtin option") COMMA_SOURCE_FILE_AT_LINE (1768)) ;
      }
    ...
    case 2 : {
      ...
      const GGS_M_optionComponents  temp_68456 = var_cas_inOptionsComponentsMapForUse ;
      if (temp_68456.isBuilt ()) {
        temp_68456 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1777)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E_) COMMA_HERE) ;
      GGS_lstring  var_cas_optionName ;
      inLexique.assignFromAttribute_tokenString (var_cas_optionName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      const GGS_bool cond_68801 = var_cas_boolOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1781))) ;
      if (cond_68801.isBuiltAndTrue ()) {
        var_cas_outExpression = GGS_typeBoolOption ::constructor_new (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1782)), var_cas_optionName COMMA_HERE) ;
        var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_HERE) ;
      }else if (cond_68801.isBuiltAndFalse ()) {
        const GGS_bool cond_68998 = var_cas_uintOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1784))) ;
        if (cond_68998.isBuiltAndTrue ()) {
          var_cas_outExpression = GGS_typeUIntOption ::constructor_new (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1785)), var_cas_optionName COMMA_HERE) ;
          var_cas_outResultType = GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_HERE) ;
        }else if (cond_68998.isBuiltAndFalse ()) {
          const GGS_bool cond_69200 = var_cas_stringOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1787))) ;
          if (cond_69200.isBuiltAndTrue ()) {
            var_cas_outExpression = GGS_typeStringOption ::constructor_new (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1788)), var_cas_optionName COMMA_HERE) ;
            var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
          }else if (cond_69200.isBuiltAndFalse ()) {
            var_cas_optionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1791)))).operator_concat (GGS_string ("' option component has no '"))).operator_concat (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1791)))).operator_concat (GGS_string ("' option")) COMMA_SOURCE_FILE_AT_LINE (1793)) ;
...
void expression_parser::
pr_factor_expression_parser_1752_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_option) COMMA_HERE) ;
  switch (select_expression_parser_9 (inLexique)) {
    case 1 : {
...
void expression_parser::
pr_factor_expression_parser_1808_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  const GGS_M_filewrappers  temp_70644 = var_cas_inSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (1823)) ;
  if (temp_70644.isBuilt ()) {
    temp_70644 (HERE)->method_searchKey (inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1823)) ;
  }
    ...
    case 2 : {
      ...
      switch (select_expression_parser_11 (inLexique)) {
        case 1 : {
          ...
          const GGS_filewrapperTemplateMap  temp_71052 = var_cas_templateMap ;
          if (temp_71052.isBuilt ()) {
            temp_71052 (HERE)->method_searchKey (inLexique, var_cas_templateName, var_cas_formalAttributeList COMMA_SOURCE_FILE_AT_LINE (1835)) ;
          }
          GGS_typeExpressionList  var_cas_expressionList ;
        ...
        case 2 : {
          ...
          const GGS_M_regularFiles  temp_71684 = var_cas_regularFileMap ;
          if (temp_71684.isBuilt ()) {
            temp_71684 (HERE)->method_searchKey (inLexique, var_cas_path, automatic_var_2, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1855)) ;
          }
...
void expression_parser::
pr_factor_expression_parser_1808_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_filewrapper) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  switch (select_expression_parser_10 (inLexique)) {
...
void expression_parser::
pr_factor_expression_parser_1870_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_72840 = var_cas_inEntitiesMap ;
  if (temp_72840.isBuilt ()) {
    temp_72840 (HERE)->method_searchKey (inLexique, var_cas_functionName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1883)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_73420 = var_cas_entite ; // CAST instruction
    if (_var_73420.getPtr () != NULL) {
      macroValidPointer (_var_73420.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteFonction *> (_var_73420.getPtr ()) != NULL) {
        const GGS_typeEntiteFonction var_cas_r (_var_73420.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_r.reader_aListeArgumentsFormels (inLexique COMMA_SOURCE_FILE_AT_LINE (1887)) ;
        var_cas_outResultType = var_cas_r.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1888)) ;
        var_cas_isExternActionCall = GGS_bool (false) ;
      }else if (dynamic_cast <cPtr_typeEntiteFonctionExterne *> (_var_73420.getPtr ()) != NULL) {
        const GGS_typeEntiteFonctionExterne var_cas_ae (_var_73420.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_ae.reader_aSignature (inLexique COMMA_SOURCE_FILE_AT_LINE (1891)) ;
        var_cas_outResultType = var_cas_ae.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1892)) ;
        var_cas_isExternActionCall = GGS_bool (true) ;
      }else{
        var_cas_functionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'")).operator_concat (var_cas_functionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1896)))).operator_concat (GGS_string ("' should name a function or an extern function")) COMMA_SOURCE_FILE_AT_LINE (1899)) ;
  ...
  {
    GGS_L_EXsignature::cEnumerator enumerator_73588 (var_cas_signatureRoutine, true) ;
    const GGS_L_EXsignature::cElement * operand_73588 = NULL ;
    while (((operand_73588 = enumerator_73588.nextObject ()))) {
      macroValidPointer (operand_73588) ;
      var_cas_listeAttributsSemantiques.addAssign_operation (operand_73588->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  nt_output_expression_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
...
void expression_parser::
pr_factor_expression_parser_1870_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  nt_output_expression_list_parse (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5D_) COMMA_HERE) ;
...
void expression_parser::
pr_read_access_expression_parser_1925_18_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1932)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_read_access_expression_parser_1925_18_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
}
...
void expression_parser::
pr_read_access_expression_parser_1941_18_ (galgas_scanner & inLexique,
                                GGS_lstring  &var_cas_nomVariable,
                                GGS_typeCplusPlusName  &var_cas_nomCppEntite,
                                GGS_AC_galgasType  &var_cas_typeEntite,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
  const GGS_bool cond_75389 = var_cas_ioVariablesMap.reader_hasKey (GGS_string ("self")) ;
  if (cond_75389.isBuiltAndTrue ()) {
    var_cas_nomVariable = GGS_lstring ::constructor_new (inLexique, GGS_string ("self"), GGS_location (inLexique) COMMA_HERE) ;
    var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1950)) ;
  }else if (cond_75389.isBuiltAndFalse ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'self' is not defined in this context") COMMA_SOURCE_FILE_AT_LINE (1954)) ;
...
void expression_parser::
pr_read_access_expression_parser_1941_18_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
}
...
void expression_parser::
pr_output_expression_list_expression_parser_1963_29_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_76950 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictInf (var_cas_effectiveTypesList.reader_length ()) ;
  if (cond_76950.isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("too much expressions") COMMA_SOURCE_FILE_AT_LINE (1994)) ;
  }else if (cond_76950.isBuiltAndFalse ()) {
    const GGS_bool cond_77090 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictSup (var_cas_effectiveTypesList.reader_length ()) ;
    if (cond_77090.isBuiltAndTrue ()) {
      var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more expressions missing") COMMA_SOURCE_FILE_AT_LINE (1996)) ;
    }else if (cond_77090.isBuiltAndFalse ()) {
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_77125 (var_cas_inFormalAttributesList, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_77125 = NULL ;
        GGS_typeTypesList::cEnumerator enumerator_77145 (var_cas_effectiveTypesList, true) ;
        const GGS_typeTypesList::cElement * operand_77145 = NULL ;
        while (((operand_77125 = enumerator_77125.nextObject ()))
            && ((operand_77145 = enumerator_77145.nextObject ()))) {
          macroValidPointer (operand_77125) ;
          macroValidPointer (operand_77145) ;
          ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_77125->mAttributType,  operand_77145->mType,  operand_77145->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1998)) ;
        }
      }
    }
  }
...
void expression_parser::
pr_output_expression_list_expression_parser_1963_29_parse (galgas_scanner & inLexique) {
  { bool syntaxRepeat_12 = true ;
    while (syntaxRepeat_12) {
      switch (select_expression_parser_12 (inLexique)) {
        case 2 : {
...
void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_2009_44_ (galgas_scanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
        ...
        case 2 : {
          switch (select_expression_parser_14 (inLexique)) {
            ...
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2A_) COMMA_HERE) ;
              GGS_uint  var_cas_jokerCount = var_cas_jokerCountWithLocation.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2036)) ;
              GGS_uint _variant_78718 = var_cas_jokerCount.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (2037)) ;
              GGS_bool _condition_78718 (_variant_78718.isBuilt (), true) ;
              while (_condition_78718.isBuiltAndTrue ()) {
                _condition_78718 = (var_cas_jokerCount).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_78718.isBuiltAndTrue ()) {
                  if (_variant_78718.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2041)) ;
                    _condition_78718 = GGS_bool (false) ;
                  }else{
                    _variant_78718.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_argumentsList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
                    var_cas_jokerCount.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (2040)) ;
                  }
                }
              }
              } break ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__29_) COMMA_HERE) ;
  ::routine_buildMapWithLocalConstants (inLexique,  var_cas_inEnumeratorNewStyle,  var_cas_argumentsList,  var_cas_inFormalArgumentsList,  var_cas_ioVariablesMap,  var_cas_inVarLocation,  var_cas_inLocalConstantStyle,  var_cas_ellipsisFound COMMA_SOURCE_FILE_AT_LINE (2053)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_2009_44_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28_) COMMA_HERE) ;
  { bool syntaxRepeat_13 = true ;
    while (syntaxRepeat_13) {
      switch (select_expression_parser_13 (inLexique)) {
