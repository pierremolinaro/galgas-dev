...
//                    november 26th, 2009, at 16h28'51"                      *
//                                                                           *
//---------------------------------------------------------------------------*
    ...
    case 1 : {
      ...
      if (cond_68149.isBuiltAndTrue ()) {
        ...
        if (cond_68242.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_68336 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1770))).operator_isEqual (GGS_string ("string")) ;
          if (cond_68336.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_HERE) ;
          }else if (cond_68336.isBuiltAndFalse ()) {
            var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'value', 'char' and 'string' readers are defined") COMMA_SOURCE_FILE_AT_LINE (1774)) ;
            var_cas_outResultType.drop () ;
          }
        }
      }
      var_cas_outExpression = GGS_typeOptionAccess ::constructor_new (inLexique, GGS_string ("galgas_cli_options"), var_cas_optionName, var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1775)) COMMA_HERE) ;
      } break ;
    case 2 : {
      ...
      const GGS_M_optionComponents  temp_68760 = var_cas_inOptionsComponentsMapForUse ;
      if (temp_68760.isBuilt ()) {
        temp_68760 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1781)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E_) COMMA_HERE) ;
      GGS_lstring  var_cas_optionName ;
      inLexique.assignFromAttribute_tokenString (var_cas_optionName) ;
      ...
      inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      const GGS_bool cond_69503 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1785))).operator_isEqual (GGS_string ("value")) ;
      if (cond_69503.isBuiltAndTrue ()) {
        const GGS_bool cond_69088 = var_cas_boolOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1786))) ;
        if (cond_69088.isBuiltAndTrue ()) {
          var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_HERE) ;
        }else if (cond_69088.isBuiltAndFalse ()) {
          const GGS_bool cond_69200 = var_cas_uintOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1788))) ;
          if (cond_69200.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_HERE) ;
          }else if (cond_69200.isBuiltAndFalse ()) {
            const GGS_bool cond_69315 = var_cas_stringOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1790))) ;
            if (cond_69315.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
            }else if (cond_69315.isBuiltAndFalse ()) {
              var_cas_optionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1793)))).operator_concat (GGS_string ("' option component has no '"))).operator_concat (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1793)))).operator_concat (GGS_string ("' option")) COMMA_SOURCE_FILE_AT_LINE (1795)) ;
              var_cas_outResultType.drop () ;
            }
          }
        }
      }else if (cond_69503.isBuiltAndFalse ()) {
        const GGS_bool cond_69596 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1796))).operator_isEqual (GGS_string ("char")) ;
        if (cond_69596.isBuiltAndTrue ()) {
          var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_HERE) ;
        }else if (cond_69596.isBuiltAndFalse ()) {
          const GGS_bool cond_69690 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1798))).operator_isEqual (GGS_string ("string")) ;
          if (cond_69690.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_HERE) ;
          }else if (cond_69690.isBuiltAndFalse ()) {
            var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'value', 'char' and 'string' readers are defined") COMMA_SOURCE_FILE_AT_LINE (1802)) ;
            var_cas_outResultType.drop () ;
          }
        }
      }
      var_cas_outExpression = GGS_typeOptionAccess ::constructor_new (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1803)), var_cas_optionName, var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1803)) COMMA_HERE) ;
      } break ;
    default :
      break ;
  }
...
void expression_parser::
pr_factor_expression_parser_1818_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  const GGS_M_filewrappers  temp_71171 = var_cas_inSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (1833)) ;
  if (temp_71171.isBuilt ()) {
    temp_71171 (HERE)->method_searchKey (inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1833)) ;
  }
    ...
    case 2 : {
      ...
      switch (select_expression_parser_10 (inLexique)) {
        case 1 : {
          ...
          const GGS_filewrapperTemplateMap  temp_71579 = var_cas_templateMap ;
          if (temp_71579.isBuilt ()) {
            temp_71579 (HERE)->method_searchKey (inLexique, var_cas_templateName, var_cas_formalAttributeList COMMA_SOURCE_FILE_AT_LINE (1845)) ;
          }
          GGS_typeExpressionList  var_cas_expressionList ;
        ...
        case 2 : {
          ...
          const GGS_M_regularFiles  temp_72211 = var_cas_regularFileMap ;
          if (temp_72211.isBuilt ()) {
            temp_72211 (HERE)->method_searchKey (inLexique, var_cas_path, automatic_var_2, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1865)) ;
          }
...
void expression_parser::
pr_factor_expression_parser_1818_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_filewrapper) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  switch (select_expression_parser_9 (inLexique)) {
...
void expression_parser::
pr_factor_expression_parser_1880_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_73367 = var_cas_inEntitiesMap ;
  if (temp_73367.isBuilt ()) {
    temp_73367 (HERE)->method_searchKey (inLexique, var_cas_functionName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1893)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_73947 = var_cas_entite ; // CAST instruction
    if (_var_73947.getPtr () != NULL) {
      macroValidPointer (_var_73947.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteFonction *> (_var_73947.getPtr ()) != NULL) {
        const GGS_typeEntiteFonction var_cas_r (_var_73947.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_r.reader_aListeArgumentsFormels (inLexique COMMA_SOURCE_FILE_AT_LINE (1897)) ;
        var_cas_outResultType = var_cas_r.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1898)) ;
        var_cas_isExternActionCall = GGS_bool (false) ;
      }else if (dynamic_cast <cPtr_typeEntiteFonctionExterne *> (_var_73947.getPtr ()) != NULL) {
        const GGS_typeEntiteFonctionExterne var_cas_ae (_var_73947.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_ae.reader_aSignature (inLexique COMMA_SOURCE_FILE_AT_LINE (1901)) ;
        var_cas_outResultType = var_cas_ae.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1902)) ;
        var_cas_isExternActionCall = GGS_bool (true) ;
      }else{
        var_cas_functionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'")).operator_concat (var_cas_functionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1906)))).operator_concat (GGS_string ("' should name a function or an extern function")) COMMA_SOURCE_FILE_AT_LINE (1909)) ;
  ...
  {
    GGS_L_EXsignature::cEnumerator enumerator_74115 (var_cas_signatureRoutine, true) ;
    const GGS_L_EXsignature::cElement * operand_74115 = NULL ;
    while (((operand_74115 = enumerator_74115.nextObject ()))) {
      macroValidPointer (operand_74115) ;
      var_cas_listeAttributsSemantiques.addAssign_operation (operand_74115->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  nt_output_expression_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
...
void expression_parser::
pr_factor_expression_parser_1880_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  nt_output_expression_list_parse (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5D_) COMMA_HERE) ;
...
void expression_parser::
pr_read_access_expression_parser_1935_18_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1942)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_read_access_expression_parser_1935_18_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
}
...
void expression_parser::
pr_read_access_expression_parser_1951_18_ (galgas_scanner & inLexique,
                                GGS_lstring  &var_cas_nomVariable,
                                GGS_typeCplusPlusName  &var_cas_nomCppEntite,
                                GGS_AC_galgasType  &var_cas_typeEntite,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
  const GGS_bool cond_75916 = var_cas_ioVariablesMap.reader_hasKey (GGS_string ("self")) ;
  if (cond_75916.isBuiltAndTrue ()) {
  ...
  }else if (cond_75916.isBuiltAndFalse ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'self' is not defined in this context") COMMA_SOURCE_FILE_AT_LINE (1964)) ;
...
void expression_parser::
pr_read_access_expression_parser_1951_18_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
}
...
void expression_parser::
pr_output_expression_list_expression_parser_1973_29_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_77477 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictInf (var_cas_effectiveTypesList.reader_length ()) ;
  if (cond_77477.isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("too much expressions") COMMA_SOURCE_FILE_AT_LINE (2004)) ;
  }else if (cond_77477.isBuiltAndFalse ()) {
    const GGS_bool cond_77617 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictSup (var_cas_effectiveTypesList.reader_length ()) ;
    if (cond_77617.isBuiltAndTrue ()) {
      var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more expressions missing") COMMA_SOURCE_FILE_AT_LINE (2006)) ;
    }else if (cond_77617.isBuiltAndFalse ()) {
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_77652 (var_cas_inFormalAttributesList, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_77652 = NULL ;
        GGS_typeTypesList::cEnumerator enumerator_77672 (var_cas_effectiveTypesList, true) ;
        const GGS_typeTypesList::cElement * operand_77672 = NULL ;
        while (((operand_77652 = enumerator_77652.nextObject ()))
            && ((operand_77672 = enumerator_77672.nextObject ()))) {
          macroValidPointer (operand_77652) ;
          macroValidPointer (operand_77672) ;
          ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_77652->mAttributType,  operand_77672->mType,  operand_77672->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (2008)) ;
        }
      }
    }
  }
...
void expression_parser::
pr_output_expression_list_expression_parser_1973_29_parse (galgas_scanner & inLexique) {
  { bool syntaxRepeat_11 = true ;
    while (syntaxRepeat_11) {
      switch (select_expression_parser_11 (inLexique)) {
        case 2 : {
...
void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_2019_44_ (galgas_scanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
        ...
        case 2 : {
          switch (select_expression_parser_13 (inLexique)) {
            ...
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2A_) COMMA_HERE) ;
              GGS_uint  var_cas_jokerCount = var_cas_jokerCountWithLocation.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2046)) ;
              GGS_uint _variant_79245 = var_cas_jokerCount.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (2047)) ;
              GGS_bool _condition_79245 (_variant_79245.isBuilt (), true) ;
              while (_condition_79245.isBuiltAndTrue ()) {
                _condition_79245 = (var_cas_jokerCount).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_79245.isBuiltAndTrue ()) {
                  if (_variant_79245.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2051)) ;
                    _condition_79245 = GGS_bool (false) ;
                  }else{
                    _variant_79245.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_argumentsList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
                    var_cas_jokerCount.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (2050)) ;
                  }
                }
              }
              } break ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__29_) COMMA_HERE) ;
  ::routine_buildMapWithLocalConstants (inLexique,  var_cas_inEnumeratorNewStyle,  var_cas_argumentsList,  var_cas_inFormalArgumentsList,  var_cas_ioVariablesMap,  var_cas_inVarLocation,  var_cas_inLocalConstantStyle,  var_cas_ellipsisFound COMMA_SOURCE_FILE_AT_LINE (2063)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_2019_44_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28_) COMMA_HERE) ;
  { bool syntaxRepeat_12 = true ;
    while (syntaxRepeat_12) {
      switch (select_expression_parser_12 (inLexique)) {
