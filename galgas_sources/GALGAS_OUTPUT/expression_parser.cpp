        ...
        case 2 : {
          switch (select_expression_parser_16 (_inLexique)) {
            ...
            case 3 : {
              ...
              GGS_uint _variant_69612 = var_cas_jokerCount._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (1770)) ;
              GGS_bool _condition_69612 (_variant_69612._isBuilt (), true) ;
              while (_condition_69612.isBuiltAndTrue ()) {
                _condition_69612 = (var_cas_jokerCount)._operator_strictSup (GGS_uint (true, 0U)) ;
                if (_condition_69612.isBuiltAndTrue ()) {
                  if (_variant_69612.uintValue () == 0) {
                    _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1773)) ;
                    _condition_69612 = GGS_bool (true, false) ;
                  }else{
                    _variant_69612._decrement_operation (_inLexique COMMA_HERE) ;
                    var_cas_argumentsList._addAssign_operation (GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE), GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
