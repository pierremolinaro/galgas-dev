...
pr_output_expression_list_expression_parser_828_30_ (galgas_scanner & lexique_var_,
  ...
  if (((var_cas_inFormalAttributesList.reader_length ()) < (var_cas_effectiveTypesList.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_32299 = var_cas_inFormalAttributesList.firstObject () ;
    GGS_typeTypesList::element_type * operand_32394 = var_cas_effectiveTypesList.firstObject () ;
    while ((operand_32299 != NULL)
        && (operand_32394 != NULL)) {
      macroValidPointer (operand_32299) ;
      macroValidPointer (operand_32394) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_32299->mAttributType,  operand_32394->mType,  operand_32394->mEndOfExpressionLocation) ;
      operand_32299 = operand_32299->nextObject () ;
      operand_32394 = operand_32394->nextObject () ;
    }
  }
}
