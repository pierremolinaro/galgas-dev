                                                  ...
                                                  if ((operand_13551 != NULL) && (operand_13575 != NULL)) {
                                                    ...
                                                    if ((operand_13551 != NULL) && (operand_13575 != NULL)) {
                                                      ...
                                                      if ((operand_13551 != NULL) && (operand_13575 != NULL)) {
                                                        ...
                                                        if ((operand_13551 != NULL) && (operand_13575 != NULL)) {
                                                          const GGS_bool cond_16348 = (operand_13551->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (368))).operator_isNotEqual (operand_13575->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (368))) ;
                                                          if (cond_16348.isBuiltAndTrue ()) {
                                                            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("I was expecting the class type '@")).operator_concat (operand_13551->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (369)))).operator_concat (GGS_string ("', I have got the class type '@"))).operator_concat (operand_13575->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (370)))).operator_concat (GGS_string ("\"")) COMMA_SOURCE_FILE_AT_LINE (371)) ;
                                                          }
                                                        }else{
                                                          GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("comparison between ")).operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (373)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (374)))).operator_concat (GGS_string (" is not valid")) COMMA_SOURCE_FILE_AT_LINE (375)) ;
                                                        }
                                                      }
                                                    }
                                                  }
...
void routine_magnitude_comparison_types_check (C_Compiler & inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_17104 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_17128 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_stringset * operand_17104 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_17104) ;
    cPtr_typeGalgas_stringset * operand_17128 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_17128) ;
    if ((operand_17104 != NULL) && (operand_17128 != NULL)) {
    }else{
      cPtr_typeGalgas_bool * operand_17104 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_17104) ;
      cPtr_typeGalgas_bool * operand_17128 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_17128) ;
      if ((operand_17104 != NULL) && (operand_17128 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_17104 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_17104) ;
        cPtr_typeGalgas_char * operand_17128 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_17128) ;
        if ((operand_17104 != NULL) && (operand_17128 != NULL)) {
        }else{
          cPtr_typeGalgas_uint * operand_17104 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17104) ;
          cPtr_typeGalgas_uint * operand_17128 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17128) ;
          if ((operand_17104 != NULL) && (operand_17128 != NULL)) {
          }else{
            cPtr_typeGalgas_sint * operand_17104 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_17104) ;
            cPtr_typeGalgas_sint * operand_17128 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_17128) ;
            if ((operand_17104 != NULL) && (operand_17128 != NULL)) {
            }else{
              cPtr_typeGalgas_uint64 * operand_17104 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_17104) ;
              cPtr_typeGalgas_uint64 * operand_17128 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_17128) ;
              if ((operand_17104 != NULL) && (operand_17128 != NULL)) {
              }else{
                cPtr_typeGalgas_sint64 * operand_17104 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_17104) ;
                cPtr_typeGalgas_sint64 * operand_17128 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_17128) ;
                if ((operand_17104 != NULL) && (operand_17128 != NULL)) {
                }else{
                  cPtr_typeGalgas_double * operand_17104 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_17104) ;
                  cPtr_typeGalgas_double * operand_17128 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_17128) ;
                  if ((operand_17104 != NULL) && (operand_17128 != NULL)) {
                  }else{
                    cPtr_typeGalgas_string * operand_17104 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_17104) ;
                    cPtr_typeGalgas_string * operand_17128 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_17128) ;
                    if ((operand_17104 != NULL) && (operand_17128 != NULL)) {
                    }else{
                      cPtr_typeGalgas_enum * operand_17104 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_17104) ;
                      cPtr_typeGalgas_enum * operand_17128 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_17128) ;
                      if ((operand_17104 != NULL) && (operand_17128 != NULL)) {
                        const GGS_bool cond_17984 = (operand_17104->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (399))).operator_isNotEqual (operand_17128->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (399))) ;
                        if (cond_17984.isBuiltAndTrue ()) {
                          GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("comparison between an '@")).operator_concat (operand_17104->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (400)))).operator_concat (GGS_string ("' enumeration and an '@"))).operator_concat (operand_17128->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (401)))).operator_concat (GGS_string ("' enumeration is not valid")) COMMA_SOURCE_FILE_AT_LINE (402)) ;
                        }
                      }else{
                        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("comparison between ")).operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (404)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (405)))).operator_concat (GGS_string (" is not valid")) COMMA_SOURCE_FILE_AT_LINE (406)) ;
                      }
                    }
                  }
                }
...
void routine_left_shift_types_check (C_Compiler & inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_18762 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_18786 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_binaryset * operand_18762 = dynamic_cast <cPtr_typeGalgas_binaryset *> (ptr_18762) ;
    cPtr_typeGalgas_uint * operand_18786 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18786) ;
    if ((operand_18762 != NULL) && (operand_18786 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_uint * operand_18762 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18762) ;
      cPtr_typeGalgas_uint * operand_18786 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18786) ;
      if ((operand_18762 != NULL) && (operand_18786 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_sint * operand_18762 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_18762) ;
        cPtr_typeGalgas_uint * operand_18786 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18786) ;
        if ((operand_18762 != NULL) && (operand_18786 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_uint64 * operand_18762 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_18762) ;
          cPtr_typeGalgas_uint * operand_18786 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18786) ;
          if ((operand_18762 != NULL) && (operand_18786 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_sint64 * operand_18762 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_18762) ;
            cPtr_typeGalgas_uint * operand_18786 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18786) ;
            if ((operand_18762 != NULL) && (operand_18786 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
              GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("shift between ")).operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (432)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (433)))).operator_concat (GGS_string (" is not valid")) COMMA_SOURCE_FILE_AT_LINE (436)) ;
              var_cas_outResultType.drop () ;
            }
          }
        }
...
void routine_right_shift_types_check (C_Compiler & inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_19767 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_19791 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_binaryset * operand_19767 = dynamic_cast <cPtr_typeGalgas_binaryset *> (ptr_19767) ;
    cPtr_typeGalgas_uint * operand_19791 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_19791) ;
    if ((operand_19767 != NULL) && (operand_19791 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_uint * operand_19767 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_19767) ;
      cPtr_typeGalgas_uint * operand_19791 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_19791) ;
      if ((operand_19767 != NULL) && (operand_19791 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_sint * operand_19767 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_19767) ;
        cPtr_typeGalgas_uint * operand_19791 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_19791) ;
        if ((operand_19767 != NULL) && (operand_19791 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_uint64 * operand_19767 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_19767) ;
          cPtr_typeGalgas_uint * operand_19791 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_19791) ;
          if ((operand_19767 != NULL) && (operand_19791 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_sint64 * operand_19767 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_19767) ;
            cPtr_typeGalgas_uint * operand_19791 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_19791) ;
            if ((operand_19767 != NULL) && (operand_19791 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
              GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("shift between ")).operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (458)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (459)))).operator_concat (GGS_string (" is not valid")) COMMA_SOURCE_FILE_AT_LINE (462)) ;
              var_cas_outResultType.drop () ;
            }
          }
        }
...
void routine_addition_types_check (C_Compiler & inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_21081 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_21105 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_21081 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_21081) ;
    cPtr_typeGalgas_uint * operand_21105 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_21105) ;
    if ((operand_21081 != NULL) && (operand_21105 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_21081 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_21081) ;
      cPtr_typeGalgas_sint * operand_21105 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_21105) ;
      if ((operand_21081 != NULL) && (operand_21105 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_21081 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_21081) ;
        cPtr_typeGalgas_uint64 * operand_21105 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_21105) ;
        if ((operand_21081 != NULL) && (operand_21105 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_21081 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_21081) ;
          cPtr_typeGalgas_sint64 * operand_21105 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_21105) ;
          if ((operand_21081 != NULL) && (operand_21105 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_double * operand_21081 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_21081) ;
            cPtr_typeGalgas_double * operand_21105 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_21105) ;
            if ((operand_21081 != NULL) && (operand_21105 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
              GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("addition between ")).operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (488)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (489)))).operator_concat (GGS_string (" is not valid")) COMMA_SOURCE_FILE_AT_LINE (492)) ;
              var_cas_outResultType.drop () ;
            }
          }
        }
...
void routine_substraction_types_check (C_Compiler & inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_22408 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_22432 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_22408 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_22408) ;
    cPtr_typeGalgas_uint * operand_22432 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_22432) ;
    if ((operand_22408 != NULL) && (operand_22432 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_22408 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_22408) ;
      cPtr_typeGalgas_sint * operand_22432 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_22432) ;
      if ((operand_22408 != NULL) && (operand_22432 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_22408 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_22408) ;
        cPtr_typeGalgas_uint64 * operand_22432 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_22432) ;
        if ((operand_22408 != NULL) && (operand_22432 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_22408 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_22408) ;
          cPtr_typeGalgas_sint64 * operand_22432 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_22432) ;
          if ((operand_22408 != NULL) && (operand_22432 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_stringset * operand_22408 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_22408) ;
            cPtr_typeGalgas_stringset * operand_22432 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_22432) ;
            if ((operand_22408 != NULL) && (operand_22432 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
              cPtr_typeGalgas_double * operand_22408 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_22408) ;
              cPtr_typeGalgas_double * operand_22432 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_22432) ;
              if ((operand_22408 != NULL) && (operand_22432 != NULL)) {
                var_cas_outResultType = var_cas_inLeftExpressionType ;
              }else{
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("substraction between ")).operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (520)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (521)))).operator_concat (GGS_string (" is not valid")) COMMA_SOURCE_FILE_AT_LINE (524)) ;
                var_cas_outResultType.drop () ;
              }
            }
          }
...
void routine_multiply_types_check (C_Compiler & inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_23841 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_23865 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_23841 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_23841) ;
    cPtr_typeGalgas_uint * operand_23865 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_23865) ;
    if ((operand_23841 != NULL) && (operand_23865 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_23841 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_23841) ;
      cPtr_typeGalgas_sint * operand_23865 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_23865) ;
      if ((operand_23841 != NULL) && (operand_23865 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_23841 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_23841) ;
        cPtr_typeGalgas_uint64 * operand_23865 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_23865) ;
        if ((operand_23841 != NULL) && (operand_23865 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_23841 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_23841) ;
          cPtr_typeGalgas_sint64 * operand_23865 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_23865) ;
          if ((operand_23841 != NULL) && (operand_23865 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_double * operand_23841 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_23841) ;
            cPtr_typeGalgas_double * operand_23865 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_23865) ;
            if ((operand_23841 != NULL) && (operand_23865 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
              GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("multiplication between ")).operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (550)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (551)))).operator_concat (GGS_string (" is not valid")) COMMA_SOURCE_FILE_AT_LINE (554)) ;
              var_cas_outResultType.drop () ;
            }
          }
        }
...
void routine_divide_types_check (C_Compiler & inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_25168 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_25192 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_25168 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_25168) ;
    cPtr_typeGalgas_uint * operand_25192 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_25192) ;
    if ((operand_25168 != NULL) && (operand_25192 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_25168 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_25168) ;
      cPtr_typeGalgas_sint * operand_25192 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_25192) ;
      if ((operand_25168 != NULL) && (operand_25192 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_25168 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_25168) ;
        cPtr_typeGalgas_uint64 * operand_25192 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_25192) ;
        if ((operand_25168 != NULL) && (operand_25192 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_25168 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_25168) ;
          cPtr_typeGalgas_sint64 * operand_25192 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_25192) ;
          if ((operand_25168 != NULL) && (operand_25192 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_double * operand_25168 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_25168) ;
            cPtr_typeGalgas_double * operand_25192 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_25192) ;
            if ((operand_25168 != NULL) && (operand_25192 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
              GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("division between ")).operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (580)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (581)))).operator_concat (GGS_string (" is not valid")) COMMA_SOURCE_FILE_AT_LINE (584)) ;
              var_cas_outResultType.drop () ;
            }
          }
        }
...
void routine_modulo_types_check (C_Compiler & inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_26489 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_26513 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_26489 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_26489) ;
    cPtr_typeGalgas_uint * operand_26513 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_26513) ;
    if ((operand_26489 != NULL) && (operand_26513 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_26489 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_26489) ;
      cPtr_typeGalgas_sint * operand_26513 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_26513) ;
      if ((operand_26489 != NULL) && (operand_26513 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_26489 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_26489) ;
        cPtr_typeGalgas_uint64 * operand_26513 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_26513) ;
        if ((operand_26489 != NULL) && (operand_26513 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_26489 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_26489) ;
          cPtr_typeGalgas_sint64 * operand_26513 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_26513) ;
          if ((operand_26489 != NULL) && (operand_26513 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("modulo between ")).operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (608)))).operator_concat (GGS_string (" and "))).operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (609)))).operator_concat (GGS_string (" is not valid")) COMMA_SOURCE_FILE_AT_LINE (612)) ;
            var_cas_outResultType.drop () ;
          }
        }
      }
...
void routine_unary_minus_type_check (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_AC_galgasType _var_28012 = var_cas_inExpressionType ; // CAST instruction
    if (_var_28012.getPtr () != NULL) {
      macroValidPointer (_var_28012.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgas_sint *> (_var_28012.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inExpressionType ;
      }else if (dynamic_cast <cPtr_typeGalgas_sint64 *> (_var_28012.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inExpressionType ;
      }else if (dynamic_cast <cPtr_typeGalgas_double *> (_var_28012.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inExpressionType ;
      }else{
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("unary minus for ")).operator_concat (var_cas_inExpressionType.reader_messageGalgasType (inLexique COMMA_SOURCE_FILE_AT_LINE (633)))).operator_concat (GGS_string (" is not valid")) COMMA_SOURCE_FILE_AT_LINE (637)) ;
        var_cas_outResultType.drop () ;
      }
    }
  }
    ...
    while (syntaxRepeat_0) {
      switch (select_expression_5F_parser_0 (inLexique)) {
        case 2 : {
          ...
          var_cas_outExpression = GGS_typeConcatOperation ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_SOURCE_FILE_AT_LINE (678)) ;
          ::routine_matchConcatOperator (inLexique,  var_cas_firstOperandType,  var_cas_secondOperandType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (679)) ;
          } break ;
        default :
    ...
    while (syntaxRepeat_1) {
      switch (select_expression_5F_parser_1 (inLexique)) {
        case 2 : {
          ...
          var_cas_outExpression = GGS_typeOrOperation ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_SOURCE_FILE_AT_LINE (725)) ;
          ::routine_matchOrOperator (inLexique,  var_cas_firstOperandType,  var_cas_secondOperandType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (726)) ;
          } break ;
        case 3 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_AC_galgasType  var_cas_secondOperandType ;
          nt_relation_5F_term_ (inLexique, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_rightOperand, var_cas_secondOperandType) ;
          var_cas_outExpression = GGS_typeXorOperation ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_SOURCE_FILE_AT_LINE (746)) ;
          ::routine_matchXorOperator (inLexique,  var_cas_firstOperandType,  var_cas_secondOperandType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (747)) ;
          } break ;
        default :
    ...
    while (syntaxRepeat_2) {
      switch (select_expression_5F_parser_2 (inLexique)) {
        case 2 : {
          ...
          var_cas_outExpression = GGS_typeAndOperation ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftOperand, var_cas_rightOperand COMMA_SOURCE_FILE_AT_LINE (793)) ;
          ::routine_matchAndOperator (inLexique,  var_cas_firstOperandType,  var_cas_secondOperandType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (794)) ;
          } break ;
        default :
...
void expression_parser::rule_expression_5F_parser_relation_5F_factor_i3_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_expression_5F_parser_3 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_comparison_types_check (inLexique,  var_cas_leftType,  var_cas_rightType COMMA_SOURCE_FILE_AT_LINE (839)) ;
      var_cas_outExpression = GGS_typeEqualTest ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (840)) ;
      var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (841)) ;
      } break ;
    case 3 : {
      GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
      ...
      GGS_AC_galgasType  var_cas_rightType ;
      nt_simple_5F_expression_ (inLexique, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
      ::routine_comparison_types_check (inLexique,  var_cas_leftType,  var_cas_rightType COMMA_SOURCE_FILE_AT_LINE (857)) ;
      var_cas_outExpression = GGS_typeNonEqualTest ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (858)) ;
      var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (859)) ;
      } break ;
    case 4 : {
      GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
      ...
      GGS_AC_galgasType  var_cas_rightType ;
      nt_simple_5F_expression_ (inLexique, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
      ::routine_magnitude_comparison_types_check (inLexique,  var_cas_leftType,  var_cas_rightType COMMA_SOURCE_FILE_AT_LINE (875)) ;
      var_cas_outExpression = GGS_typeInfOrEqualTest ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (876)) ;
      var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (877)) ;
      } break ;
    case 5 : {
      GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
      ...
      GGS_AC_galgasType  var_cas_rightType ;
      nt_simple_5F_expression_ (inLexique, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
      ::routine_magnitude_comparison_types_check (inLexique,  var_cas_leftType,  var_cas_rightType COMMA_SOURCE_FILE_AT_LINE (893)) ;
      var_cas_outExpression = GGS_typeSupOrEqualTest ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (894)) ;
      var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (895)) ;
      } break ;
    case 6 : {
      GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
      ...
      GGS_AC_galgasType  var_cas_rightType ;
      nt_simple_5F_expression_ (inLexique, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
      ::routine_magnitude_comparison_types_check (inLexique,  var_cas_leftType,  var_cas_rightType COMMA_SOURCE_FILE_AT_LINE (911)) ;
      var_cas_outExpression = GGS_typeStrictSupTest ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (912)) ;
      var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (913)) ;
      } break ;
    case 7 : {
      GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
      ...
      GGS_AC_galgasType  var_cas_rightType ;
      nt_simple_5F_expression_ (inLexique, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
      ::routine_magnitude_comparison_types_check (inLexique,  var_cas_leftType,  var_cas_rightType COMMA_SOURCE_FILE_AT_LINE (929)) ;
      var_cas_outExpression = GGS_typeStrictInfTest ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (930)) ;
      var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (931)) ;
      } break ;
    default :
      break ;
  }
    ...
    while (syntaxRepeat_4) {
      switch (select_expression_5F_parser_4 (inLexique)) {
        case 2 : {
          ...
          ::routine_left_shift_types_check (inLexique,  var_cas_leftType,  var_cas_rightType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (973)) ;
          var_cas_outExpression = GGS_typeLeftShiftOperation ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (974)) ;
          } break ;
        case 3 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_AC_galgasType  var_cas_rightType ;
          nt_term_ (inLexique, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
          ::routine_right_shift_types_check (inLexique,  var_cas_leftType,  var_cas_rightType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (990)) ;
          var_cas_outExpression = GGS_typeRightShiftOperation ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (991)) ;
          } break ;
        case 4 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_AC_galgasType  var_cas_rightType ;
          nt_term_ (inLexique, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
          ::routine_addition_types_check (inLexique,  var_cas_leftType,  var_cas_rightType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1007)) ;
          var_cas_outExpression = GGS_typeAddOperation ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1008)) ;
          } break ;
        case 5 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_AC_galgasType  var_cas_rightType ;
          nt_term_ (inLexique, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
          ::routine_substraction_types_check (inLexique,  var_cas_leftType,  var_cas_rightType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1024)) ;
          var_cas_outExpression = GGS_typeSubOperation ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1025)) ;
          } break ;
        default :
    ...
    while (syntaxRepeat_5) {
      switch (select_expression_5F_parser_5 (inLexique)) {
        case 2 : {
          ...
          ::routine_multiply_types_check (inLexique,  var_cas_leftType,  var_cas_rightType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1067)) ;
          var_cas_outExpression = GGS_typeMultiplyOperation ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1068)) ;
          } break ;
        case 3 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_AC_galgasType  var_cas_rightType ;
          nt_factor_ (inLexique, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
          ::routine_divide_types_check (inLexique,  var_cas_leftType,  var_cas_rightType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1084)) ;
          var_cas_outExpression = GGS_typeDivideOperation ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1085)) ;
          } break ;
        case 4 : {
          GGS_location  var_cas_operatorLocation = GGS_location (inLexique) ;
          ...
          GGS_AC_galgasType  var_cas_rightType ;
          nt_factor_ (inLexique, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
          ::routine_modulo_types_check (inLexique,  var_cas_leftType,  var_cas_rightType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1101)) ;
          var_cas_outExpression = GGS_typeModuloOperation ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1102)) ;
          } break ;
        default :
...
void expression_parser::rule_expression_5F_parser_factor_i6_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  ::routine_unary_minus_type_check (inLexique,  var_cas_type,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1132)) ;
  var_cas_outExpression = GGS_typeUnaryMinusOperation ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (1133)) ;
}
    ...
    while (syntaxRepeat_6) {
      switch (select_expression_5F_parser_6 (inLexique)) {
        case 2 : {
          ...
          { const GGS_AC_galgasType _var_45644 = var_cas_outResultType ; // CAST instruction
            if (_var_45644.getPtr () != NULL) {
              macroValidPointer (_var_45644.getPtr ()) ;
              if (typeid (cPtr_typeGalgasStructType) == typeid (* (_var_45644.getPtr ()))) {
                const GGS_typeGalgasStructType var_cas_st (_var_45644.getPtr ()) ;
                GGS_bool var_cas_found = GGS_bool (false) ;
                {
                  GGS_typeListeAttributsSemantiques::cEnumerator enumerator_45184 (var_cas_st.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1165)), true) ;
                  const GGS_typeListeAttributsSemantiques::cElement * operand_45184 = NULL ;
                  while (((operand_45184 = enumerator_45184.nextObject ()))
                      && ((var_cas_found).operator_not ().isBuiltAndTrue ())) {
                    macroValidPointer (operand_45184) ;
                    var_cas_found = (var_cas_fieldName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1166))).operator_isEqual (operand_45184->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1166))) ;
                    var_cas_outResultType = operand_45184->mAttributType ;
                  }
                }
                const GGS_bool cond_45463 = var_cas_found ;
                if (cond_45463.isBuiltAndTrue ()) {
                  var_cas_outExpression = GGS_typeFieldAccessOperation ::constructor_new (inLexique, var_cas_outExpression, var_cas_fieldName COMMA_SOURCE_FILE_AT_LINE (1170)) ;
                }else if (cond_45463.isBuiltAndFalse ()) {
                  var_cas_fieldName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("this structure does have a '")).operator_concat (var_cas_fieldName)).operator_concat (GGS_string ("' field")) COMMA_SOURCE_FILE_AT_LINE (1173)) ;
                }
              }else{
                var_cas_fieldName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only a structure accepts field access") COMMA_SOURCE_FILE_AT_LINE (1176)) ;
              }
            }
          }
          } break ;
...
void expression_parser::rule_expression_5F_parser_factor_i8_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_typeTestComplement ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_ifCondition COMMA_SOURCE_FILE_AT_LINE (1206)) ;
  ::routine_checkNotOperator (inLexique,  var_cas_operandType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1207)) ;
}
...
void expression_parser::rule_expression_5F_parser_factor_i9_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_AC_galgasType  var_cas_operandType ;
  nt_factor_ (inLexique, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap, var_cas_ifCondition, var_cas_operandType) ;
  var_cas_outExpression = GGS_typeLogicalNegate ::constructor_new (inLexique, var_cas_operatorLocation, var_cas_ifCondition COMMA_SOURCE_FILE_AT_LINE (1236)) ;
  ::routine_checkLogicalNegateOperator (inLexique,  var_cas_operandType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1237)) ;
}
...
void expression_parser::rule_expression_5F_parser_primary_i10_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_lstring  automatic_var_48595_0 ;
  nt_read_5F_access_ (inLexique, automatic_var_48595_0, var_cas_nomCppEntite1, var_cas_outResultType, var_cas_ioVariablesMap) ;
  var_cas_outExpression = GGS_typeVarInExpression ::constructor_new (inLexique, var_cas_nomCppEntite1, GGS_lstringlist ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (1256)) ;
}
...
void expression_parser::rule_expression_5F_parser_primary_i11_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  { const GGS_AC_galgasType _var_50227 = var_cas_castExpressionType ; // CAST instruction
    if (_var_50227.getPtr () != NULL) {
      macroValidPointer (_var_50227.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgasClassType *> (_var_50227.getPtr ()) != NULL) {
        const GGS_typeGalgasClassType var_cas_aClass (_var_50227.getPtr ()) ;
        var_cas_kSourceExpressionClassName = var_cas_aClass.reader_mClassTypeName (inLexique COMMA_SOURCE_FILE_AT_LINE (1291)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1291)) ;
        var_cas_isObjectCast = GGS_bool (false) ;
      }else if (dynamic_cast <cPtr_typeGalgas_object *> (_var_50227.getPtr ()) != NULL) {
        var_cas_kSourceExpressionClassName = GGS_string ("object") ;
        var_cas_isObjectCast = GGS_bool (true) ;
      }else{
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the cast expression should be an instance of an object type, or an instance of a class type") COMMA_SOURCE_FILE_AT_LINE (1298)) ;
  ...
  switch (select_expression_5F_parser_7 (inLexique)) {
    case 1 : {
      ...
      const GGS_bool cond_50435 = var_cas_isObjectCast ;
      if (cond_50435.isBuiltAndTrue ()) {
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("casting an object instance requires the '==' operator") COMMA_SOURCE_FILE_AT_LINE (1306)) ;
      }
      } break ;
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__3D__3D_) COMMA_HERE) ;
  ...
  const GGS_M_semanticsEntitiesForUse  temp_50693 = var_cas_inEntitiesMap ;
  if (temp_50693.isBuilt ()) {
    temp_50693 (HERE)->method_searchKey (inLexique, var_cas_castedTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1316)) ;
  }
  var_cas_outResultType = GGS_typeEntiteType::castFrom (inLexique, var_cas_entite.getPtr (), true, var_cas_castedTypeName COMMA_SOURCE_FILE_AT_LINE (1317)).reader_aDefType (inLexique COMMA_SOURCE_FILE_AT_LINE (1317)) ;
  const GGS_bool cond_51938 = (var_cas_isObjectCast).operator_not () ;
  if (cond_51938.isBuiltAndTrue ()) {
    GGS_typeGalgasClassType  var_cas_resultClassType = GGS_typeGalgasClassType::castFrom (inLexique, var_cas_outResultType.getPtr (), true, var_cas_castedTypeName COMMA_SOURCE_FILE_AT_LINE (1321)) ;
    GGS_typeSuperClassesMap  var_cas_superClassMap = var_cas_resultClassType.reader_mAncestorClassesMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1322)) ;
    GGS_string var_cas_classMessage = var_cas_resultClassType.reader_mClassMessage (inLexique COMMA_SOURCE_FILE_AT_LINE (1323)) ;
    const GGS_bool cond_51397 = (var_cas_classMessage.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
    if (cond_51397.isBuiltAndTrue ()) {
      var_cas_castedTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("in order to be used in a cast expression, the '@")).operator_concat (var_cas_castedTypeName)).operator_concat (GGS_string ("' class should define a class message")) COMMA_SOURCE_FILE_AT_LINE (1327)) ;
    }
    const GGS_bool cond_51755 = (var_cas_checkForKindOfClass).operator_not () ;
    if (cond_51755.isBuiltAndTrue ()) {
      const GGS_bool cond_51740 = ((var_cas_castedTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1330))).operator_isNotEqual (var_cas_kSourceExpressionClassName)).operator_and ((var_cas_superClassMap.reader_hasKey (var_cas_kSourceExpressionClassName)).operator_not ()) ;
      if (cond_51740.isBuiltAndTrue ()) {
        var_cas_castedTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("This class is not '@")).operator_concat (var_cas_kSourceExpressionClassName)).operator_concat (GGS_string ("' and does inherit from it")) COMMA_SOURCE_FILE_AT_LINE (1332)) ;
      }
    }else if (cond_51755.isBuiltAndFalse ()) {
      const GGS_bool cond_51927 = (var_cas_superClassMap.reader_hasKey (var_cas_kSourceExpressionClassName)).operator_not () ;
      if (cond_51927.isBuiltAndTrue ()) {
        var_cas_castedTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("This class does not inherit from '@")).operator_concat (var_cas_kSourceExpressionClassName)).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1335)) ;
      }
    }
  }
  ...
  const GGS_AC_galgasType  temp_52397 = var_cas_errorLocationExpressionType ;
  if (temp_52397.isBuilt ()) {
    temp_52397 (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (1350)) ;
  }
  const GGS_bool cond_52591 = var_cas_isObjectCast ;
  if (cond_52591.isBuiltAndTrue ()) {
    var_cas_outExpression = GGS_objectCastInExpression ::constructor_new (inLexique, var_cas_castedExpression, var_cas_castedTypeName, var_cas_errorLocationExpression COMMA_SOURCE_FILE_AT_LINE (1353)) ;
  }else if (cond_52591.isBuiltAndFalse ()) {
    var_cas_outExpression = GGS_typeCastInExpression ::constructor_new (inLexique, var_cas_castedExpression, var_cas_checkForKindOfClass, var_cas_castedTypeName, var_cas_errorLocationExpression COMMA_SOURCE_FILE_AT_LINE (1359)) ;
  }
...
void expression_parser::rule_expression_5F_parser_primary_i13_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_typeTrueBool ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1410)) ;
  var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1411)) ;
}
...
void expression_parser::rule_expression_5F_parser_primary_i14_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_typeFalseBool ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1429)) ;
  var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1430)) ;
}
...
void expression_parser::rule_expression_5F_parser_primary_i15_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  { bool syntaxRepeat_8 = true ;
    while (syntaxRepeat_8) {
        ...
        var_cas_literalStringList.addAssign_operation (var_cas_literalString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1451))) ;
  ...
  var_cas_outExpression = GGS_typeLiteralStringExpression ::constructor_new (inLexique, var_cas_literalStringList COMMA_SOURCE_FILE_AT_LINE (1454)) ;
  var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1455)) ;
}
...
void expression_parser::rule_expression_5F_parser_primary_i16_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_typeLiteralUIntExpression ::constructor_new (inLexique, var_cas_literalInt COMMA_SOURCE_FILE_AT_LINE (1474)) ;
  var_cas_outResultType = GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1475)) ;
}
...
void expression_parser::rule_expression_5F_parser_primary_i17_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_typeLiteralSIntExpression ::constructor_new (inLexique, var_cas_literalInt COMMA_SOURCE_FILE_AT_LINE (1494)) ;
  var_cas_outResultType = GGS_typeGalgas_sint ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1495)) ;
}
...
void expression_parser::rule_expression_5F_parser_primary_i18_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_typeLiteralUInt64Expression ::constructor_new (inLexique, var_cas_literalInt COMMA_SOURCE_FILE_AT_LINE (1514)) ;
  var_cas_outResultType = GGS_typeGalgas_uint64 ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1515)) ;
}
...
void expression_parser::rule_expression_5F_parser_primary_i19_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_typeLiteralSInt64Expression ::constructor_new (inLexique, var_cas_literalInt COMMA_SOURCE_FILE_AT_LINE (1534)) ;
  var_cas_outResultType = GGS_typeGalgas_sint64 ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1535)) ;
}
...
void expression_parser::rule_expression_5F_parser_primary_i20_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_typeLiteralCharExpression ::constructor_new (inLexique, var_cas_literalChar COMMA_SOURCE_FILE_AT_LINE (1553)) ;
  var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1554)) ;
}
...
void expression_parser::rule_expression_5F_parser_primary_i21_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_typeLiteralDoubleExpression ::constructor_new (inLexique, var_cas_literalDouble COMMA_SOURCE_FILE_AT_LINE (1573)) ;
  var_cas_outResultType = GGS_typeGalgas_double ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1574)) ;
}
...
void expression_parser::rule_expression_5F_parser_primary_i22_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  var_cas_outExpression = GGS_typeHereExpression ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1592)) ;
  var_cas_outResultType = GGS_typeGalgas_location ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1593)) ;
}
...
void expression_parser::rule_expression_5F_parser_primary_i23_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_type_5F_name) COMMA_HERE) ;
  GGS_AC_semanticsEntity  automatic_var_63101_0 ;
  const GGS_M_semanticsEntitiesForUse  temp_63087 = var_cas_inEntitiesMap ;
  if (temp_63087.isBuilt ()) {
    temp_63087 (HERE)->method_searchKey (inLexique, var_cas_typeName, automatic_var_63101_0 COMMA_SOURCE_FILE_AT_LINE (1612)) ;
  }
  var_cas_outExpression = GGS_typeClassToTypeOperand ::constructor_new (inLexique, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (1613)) ;
  var_cas_outResultType = GGS_typeGalgas_type ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1614)) ;
}
...
void expression_parser::rule_expression_5F_parser_primary_i24_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_typeGalgas_bool  var_cas_gb = GGS_typeGalgas_bool::castFrom (inLexique, var_cas_ifExpressionType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1644)) ;
  ...
  ::routine_checkAssignmentTypesCompatibility (inLexique,  var_cas_outResultType,  var_cas_elseExpressionType,  var_cas_errorLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1670)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_end) COMMA_HERE) ;
  var_cas_outExpression = GGS_typeIfThenElseExpression ::constructor_new (inLexique, var_cas_ifExpression, var_cas_thenExpression, var_cas_elseExpression COMMA_SOURCE_FILE_AT_LINE (1679)) ;
}
...
void expression_parser::rule_expression_5F_parser_primary_i25_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  ::routine_handleReaderCall (inLexique,  var_cas_inEntitiesMap,  var_cas_inSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1724)),  var_cas_expressionType,  var_cas_methodName,  var_cas_accessorsTypeList,  var_cas_outResultType,  var_cas_conversionMethod,  var_cas_categoryReaderClassBaseName,  var_cas_hasLexiqueAndLocationArguments COMMA_SOURCE_FILE_AT_LINE (1722)) ;
  ...
  var_cas_outExpression = GGS_typeReaderCallInExpression ::constructor_new (inLexique, var_cas_expressionValue, var_cas_methodName, var_cas_expressionList, var_cas_conversionMethod, var_cas_categoryReaderClassBaseName, var_cas_hasLexiqueAndLocationArguments COMMA_SOURCE_FILE_AT_LINE (1743)) ;
...
void expression_parser::rule_expression_5F_parser_primary_i26_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_M_semanticsEntitiesForUse  temp_68151 = var_cas_inEntitiesMap ;
  if (temp_68151.isBuilt ()) {
    temp_68151 (HERE)->method_searchKey (inLexique, var_cas_typeName, var_cas_e COMMA_SOURCE_FILE_AT_LINE (1775)) ;
  }
  GGS_AC_galgasType  var_cas_type = GGS_typeEntiteType::castFrom (inLexique, var_cas_e.getPtr (), true, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (1776)).reader_aDefType (inLexique COMMA_SOURCE_FILE_AT_LINE (1776)) ;
  ...
  GGS_bool var_cas_hasLexiqueAndLocationArguments ;
  const GGS_AC_galgasType  temp_68483 = var_cas_type ;
  if (temp_68483.isBuilt ()) {
    temp_68483 (HERE)->method_handleConstructorInvocation (inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques, var_cas_hasLexiqueAndLocationArguments, var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1782)) ;
  }
  GGS_typeExpressionList  var_cas_expressionList ;
  ...
  var_cas_outExpression = GGS_typeConstructorExpression ::constructor_new (inLexique, var_cas_type, var_cas_mClassMethodName, var_cas_hasLexiqueAndLocationArguments, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (1793)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5D_) COMMA_HERE) ;
}
...
void expression_parser::rule_expression_5F_parser_primary_i27_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_expression_5F_parser_9 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
      const GGS_bool cond_70138 = (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1824))).operator_isNotEqual (GGS_string ("verbose_output")) ;
      if (cond_70138.isBuiltAndTrue ()) {
        var_cas_optionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this option name does not correspond to a builtin option") COMMA_SOURCE_FILE_AT_LINE (1826)) ;
      }
      GGS_lstring  var_cas_readerName ;
      inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
      const GGS_bool cond_70284 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1828))).operator_isEqual (GGS_string ("value")) ;
      if (cond_70284.isBuiltAndTrue ()) {
        var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1829)) ;
      }else if (cond_70284.isBuiltAndFalse ()) {
        const GGS_bool cond_70377 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1830))).operator_isEqual (GGS_string ("char")) ;
        if (cond_70377.isBuiltAndTrue ()) {
          var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1831)) ;
        }else if (cond_70377.isBuiltAndFalse ()) {
          const GGS_bool cond_70472 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1832))).operator_isEqual (GGS_string ("string")) ;
          if (cond_70472.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1833)) ;
          }else if (cond_70472.isBuiltAndFalse ()) {
            const GGS_bool cond_70569 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1834))).operator_isEqual (GGS_string ("comment")) ;
            if (cond_70569.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1835)) ;
            }else if (cond_70569.isBuiltAndFalse ()) {
              var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'value', 'char', 'string' and 'comment' readers are defined") COMMA_SOURCE_FILE_AT_LINE (1838)) ;
              var_cas_outResultType.drop () ;
            }
          }
        }
      }
      var_cas_outExpression = GGS_typeOptionAccess ::constructor_new (inLexique, GGS_string ("galgas_cli_options"), var_cas_optionName, var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1839)) COMMA_SOURCE_FILE_AT_LINE (1839)) ;
      } break ;
    case 2 : {
      ...
      const GGS_M_optionComponents  temp_71003 = var_cas_inOptionsComponentsMapForUse ;
      if (temp_71003.isBuilt ()) {
        temp_71003 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1845)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2E_) COMMA_HERE) ;
      GGS_lstring  var_cas_optionName ;
      inLexique.assignFromAttribute_tokenString (var_cas_optionName) ;
      ...
      inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
      const GGS_bool cond_71745 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1849))).operator_isEqual (GGS_string ("value")) ;
      if (cond_71745.isBuiltAndTrue ()) {
        const GGS_bool cond_71331 = var_cas_boolOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1850))) ;
        if (cond_71331.isBuiltAndTrue ()) {
          var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1851)) ;
        }else if (cond_71331.isBuiltAndFalse ()) {
          const GGS_bool cond_71443 = var_cas_uintOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1852))) ;
          if (cond_71443.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1853)) ;
          }else if (cond_71443.isBuiltAndFalse ()) {
            const GGS_bool cond_71558 = var_cas_stringOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1854))) ;
            if (cond_71558.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1855)) ;
            }else if (cond_71558.isBuiltAndFalse ()) {
              var_cas_optionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1857)))).operator_concat (GGS_string ("' option component has no '"))).operator_concat (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1857)))).operator_concat (GGS_string ("' option")) COMMA_SOURCE_FILE_AT_LINE (1859)) ;
              var_cas_outResultType.drop () ;
            }
          }
        }
      }else if (cond_71745.isBuiltAndFalse ()) {
        const GGS_bool cond_71838 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1860))).operator_isEqual (GGS_string ("char")) ;
        if (cond_71838.isBuiltAndTrue ()) {
          var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1861)) ;
        }else if (cond_71838.isBuiltAndFalse ()) {
          const GGS_bool cond_71935 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1862))).operator_isEqual (GGS_string ("string")) ;
          if (cond_71935.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1863)) ;
          }else if (cond_71935.isBuiltAndFalse ()) {
            const GGS_bool cond_72032 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1864))).operator_isEqual (GGS_string ("comment")) ;
            if (cond_72032.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1865)) ;
            }else if (cond_72032.isBuiltAndFalse ()) {
              var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'value', 'char', 'string' and 'comment' readers are defined") COMMA_SOURCE_FILE_AT_LINE (1868)) ;
              var_cas_outResultType.drop () ;
            }
          }
        }
      }
      var_cas_outExpression = GGS_typeOptionAccess ::constructor_new (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1869)), var_cas_optionName, var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1869)) COMMA_SOURCE_FILE_AT_LINE (1869)) ;
      } break ;
    default :
      break ;
  }
...
void expression_parser::rule_expression_5F_parser_primary_i28_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_M_filewrappers  temp_73526 = var_cas_inSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (1899)) ;
  if (temp_73526.isBuilt ()) {
    temp_73526 (HERE)->method_searchKey (inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1899)) ;
  }
  switch (select_expression_5F_parser_10 (inLexique)) {
    case 1 : {
      var_cas_outExpression = GGS_typeFileWrapperObjectInstanciation ::constructor_new (inLexique, var_cas_filewrapperName COMMA_SOURCE_FILE_AT_LINE (1901)) ;
      var_cas_outResultType = GGS_typeGalgas_filewrapper ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1902)) ;
      } break ;
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2E_) COMMA_HERE) ;
      switch (select_expression_5F_parser_11 (inLexique)) {
        case 1 : {
          ...
          const GGS_filewrapperTemplateMapEX  temp_73934 = var_cas_templateMap ;
          if (temp_73934.isBuilt ()) {
            temp_73934 (HERE)->method_searchKey (inLexique, var_cas_templateName, var_cas_formalAttributeList COMMA_SOURCE_FILE_AT_LINE (1911)) ;
          }
          GGS_typeExpressionList  var_cas_expressionList ;
          ...
          var_cas_outExpression = GGS_typeFileWrapperTemplateCall ::constructor_new (inLexique, var_cas_filewrapperName, var_cas_templateName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (1923)) ;
          var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1924)) ;
          } break ;
        case 2 : {
          ...
          GGS_uint  automatic_var_74594_0 ;
          const GGS_M_regularFiles  temp_74566 = var_cas_regularFileMap ;
          if (temp_74566.isBuilt ()) {
            temp_74566 (HERE)->method_searchKey (inLexique, var_cas_path, automatic_var_74594_0, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1931)) ;
          }
          var_cas_outExpression = GGS_typeFileWrapperWithStaticPath ::constructor_new (inLexique, var_cas_filewrapperName, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1932)) ;
          var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1933)) ;
          } break ;
        default :
          break ;
      }
...
void expression_parser::rule_expression_5F_parser_primary_i29_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_75723 = var_cas_inEntitiesMap ;
  if (temp_75723.isBuilt ()) {
    temp_75723 (HERE)->method_searchKey (inLexique, var_cas_functionName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1959)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_76302 = var_cas_entite ; // CAST instruction
    if (_var_76302.getPtr () != NULL) {
      macroValidPointer (_var_76302.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteFonction *> (_var_76302.getPtr ()) != NULL) {
        const GGS_typeEntiteFonction var_cas_r (_var_76302.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_r.reader_aListeArgumentsFormels (inLexique COMMA_SOURCE_FILE_AT_LINE (1963)) ;
        var_cas_outResultType = var_cas_r.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1964)) ;
        var_cas_isExternActionCall = GGS_bool (false) ;
      }else if (dynamic_cast <cPtr_typeEntiteFonctionExterne *> (_var_76302.getPtr ()) != NULL) {
        const GGS_typeEntiteFonctionExterne var_cas_ae (_var_76302.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_ae.reader_aSignature (inLexique COMMA_SOURCE_FILE_AT_LINE (1967)) ;
        var_cas_outResultType = var_cas_ae.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1968)) ;
        var_cas_isExternActionCall = GGS_bool (true) ;
      }else{
        var_cas_functionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'")).operator_concat (var_cas_functionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1972)))).operator_concat (GGS_string ("' should name a function or an extern function")) COMMA_SOURCE_FILE_AT_LINE (1975)) ;
  ...
  {
    GGS_L_EXsignature::cEnumerator enumerator_76470 (var_cas_signatureRoutine, true) ;
    const GGS_L_EXsignature::cElement * operand_76470 = NULL ;
    while (((operand_76470 = enumerator_76470.nextObject ()))) {
      macroValidPointer (operand_76470) ;
      var_cas_listeAttributsSemantiques.addAssign_operation (operand_76470->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1980))) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5B_) COMMA_HERE) ;
  nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5D_) COMMA_HERE) ;
  var_cas_outExpression = GGS_typeFunctionCall ::constructor_new (inLexique, var_cas_functionName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (1992)) ;
}
...
void expression_parser::rule_expression_5F_parser_read_5F_access_i30_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (2008)) ;
}
...
void expression_parser::rule_expression_5F_parser_read_5F_access_i31_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_78271 = var_cas_ioVariablesMap.reader_hasKey (GGS_string ("self")) ;
  if (cond_78271.isBuiltAndTrue ()) {
    var_cas_nomVariable = GGS_lstring ::constructor_new (inLexique, GGS_string ("self"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2025)) ;
    var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (2026)) ;
  }else if (cond_78271.isBuiltAndFalse ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'self' is not defined in this context") COMMA_SOURCE_FILE_AT_LINE (2030)) ;
...
void expression_parser::rule_expression_5F_parser_output_5F_expression_5F_list_i32_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_79831 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictInf (var_cas_effectiveTypesList.reader_length ()) ;
  if (cond_79831.isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("too much expressions") COMMA_SOURCE_FILE_AT_LINE (2070)) ;
  }else if (cond_79831.isBuiltAndFalse ()) {
    const GGS_bool cond_79971 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictSup (var_cas_effectiveTypesList.reader_length ()) ;
    if (cond_79971.isBuiltAndTrue ()) {
      var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more expressions missing") COMMA_SOURCE_FILE_AT_LINE (2072)) ;
    }else if (cond_79971.isBuiltAndFalse ()) {
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_80006 (var_cas_inFormalAttributesList, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_80006 = NULL ;
        GGS_typeTypesList::cEnumerator enumerator_80026 (var_cas_effectiveTypesList, true) ;
        const GGS_typeTypesList::cElement * operand_80026 = NULL ;
        while (((operand_80006 = enumerator_80006.nextObject ()))
            && ((operand_80026 = enumerator_80026.nextObject ()))) {
          macroValidPointer (operand_80006) ;
          macroValidPointer (operand_80026) ;
          ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_80006->mAttributType,  operand_80026->mType,  operand_80026->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (2074)) ;
        }
      }
    }
  }
...
void expression_parser::rule_expression_5F_parser_parse_5F_effective_5F_input_5F_parameters_5F_list_i33_ (C_Lexique_galgas_5F_scanner & inLexique,
      ...
      switch (select_expression_5F_parser_13 (inLexique)) {
        case 2 : {
          switch (select_expression_5F_parser_14 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2A_) COMMA_HERE) ;
              var_cas_argumentsList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2107)), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2107))) ;
              } break ;
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2A_) COMMA_HERE) ;
              GGS_uint  var_cas_jokerCount = var_cas_jokerCountWithLocation.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2112)) ;
              GGS_uint _variant_81599 = var_cas_jokerCount.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (2113)) ;
              GGS_bool _condition_81599 (_variant_81599.isBuilt (), true) ;
              while (_condition_81599.isBuiltAndTrue ()) {
                _condition_81599 = (var_cas_jokerCount).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_81599.isBuiltAndTrue ()) {
                  if (_variant_81599.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2117)) ;
                    _condition_81599 = GGS_bool (false) ;
                  }else{
                    _variant_81599.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_argumentsList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2115)), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2115))) ;
                    var_cas_jokerCount.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (2116)) ;
                  }
                }
              }
              } break ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__29_) COMMA_HERE) ;
  ::routine_buildMapWithLocalConstants (inLexique,  var_cas_inEnumeratorNewStyle,  var_cas_argumentsList,  var_cas_inFormalArgumentsList,  var_cas_ioVariablesMap,  var_cas_inVarLocation,  var_cas_inLocalConstantStyle,  var_cas_ellipsisFound COMMA_SOURCE_FILE_AT_LINE (2129)) ;
}
