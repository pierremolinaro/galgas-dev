...
void expression_parser::rule_expression_5F_parser_read_5F_access_i31_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_78906 = var_cas_ioVariablesMap.reader_hasKey (GGS_string ("self")) ;
  if (cond_78906.isBuiltAndTrue ()) {
  ...
  }else if (cond_78906.isBuiltAndFalse ()) {
...
void expression_parser::rule_expression_5F_parser_output_5F_expression_5F_list_i32_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_80470 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictInf (var_cas_effectiveTypesList.reader_length ()) ;
  if (cond_80470.isBuiltAndTrue ()) {
  ...
  }else if (cond_80470.isBuiltAndFalse ()) {
    const GGS_bool cond_80610 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictSup (var_cas_effectiveTypesList.reader_length ()) ;
    if (cond_80610.isBuiltAndTrue ()) {
    ...
    }else if (cond_80610.isBuiltAndFalse ()) {
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_80645 (var_cas_inFormalAttributesList, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_80645 = NULL ;
        GGS_typeTypesList::cEnumerator enumerator_80665 (var_cas_effectiveTypesList, true) ;
        const GGS_typeTypesList::cElement * operand_80665 = NULL ;
        while (((operand_80645 = enumerator_80645.nextObject ()))
            && ((operand_80665 = enumerator_80665.nextObject ()))) {
          macroValidPointer (operand_80645) ;
          macroValidPointer (operand_80665) ;
          ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_80645->mAttributType,  operand_80665->mType,  operand_80665->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (2085)) ;
        }
      }
    }
  }
        ...
        case 2 : {
          switch (select_expression_5F_parser_14 (inLexique)) {
            ...
            case 3 : {
              ...
              GGS_uint _variant_82238 = var_cas_jokerCount.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (2124)) ;
              GGS_bool _condition_82238 (_variant_82238.isBuilt (), true) ;
              while (_condition_82238.isBuiltAndTrue ()) {
                _condition_82238 = (var_cas_jokerCount).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_82238.isBuiltAndTrue ()) {
                  if (_variant_82238.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2128)) ;
                    _condition_82238 = GGS_bool (false) ;
                  }else{
                    _variant_82238.decrement_operation (inLexique COMMA_HERE) ;
