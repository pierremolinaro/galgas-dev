...
pr_factor_expression_parser_979_14_ (galgas_scanner & _inLexique,
  ...
  switch (select_expression_parser_6 (_inLexique)) {
    case 1 : {
      ...
      var_cas_outExpression = GGS_typeReaderCallInExpression::constructor_new (var_cas_expressionValue, var_cas_methodName, var_cas_expressionList, GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    case 2 : {
    ...
    case 3 : {
      ...
      if ((var_cas_boolOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1047)) SOURCE_FILE_AT_LINE (1047))).isBuiltAndTrue ()) {
        var_cas_outExpression = GGS_typeBoolOption::constructor_new (var_cas_optionComponentName, var_cas_optionName COMMA_HERE) ;
        var_cas_outResultType = GGS_typeGalgas_bool::constructor_new (HERE) ;
      }else if ((var_cas_uintOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1050)) SOURCE_FILE_AT_LINE (1050))).isBuiltAndTrue ()) {
        var_cas_outExpression = GGS_typeUIntOption::constructor_new (var_cas_optionComponentName, var_cas_optionName COMMA_HERE) ;
        var_cas_outResultType = GGS_typeGalgas_uint::constructor_new (HERE) ;
      }else if ((var_cas_stringOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1053)) SOURCE_FILE_AT_LINE (1053))).isBuiltAndTrue ()) {
        var_cas_outExpression = GGS_typeStringOption::constructor_new (var_cas_optionComponentName, var_cas_optionName COMMA_HERE) ;
        var_cas_outResultType = GGS_typeGalgas_uint::constructor_new (HERE) ;
      }else{
          var_cas_optionName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "the '")) + (var_cas_optionComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1057))))) + (GGS_string (true, "' option component has no '")))) + (var_cas_optionName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1057))))) + (GGS_string (true, "' option"))) SOURCE_FILE_AT_LINE (1057)) ;
      }
      } break ;
    default :
      break ;
...
pr_output_expression_list_expression_parser_1086_30_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inFormalAttributesList.reader_length (_inLexique SOURCE_FILE_AT_LINE (1113))) < (var_cas_effectiveTypesList.reader_length (_inLexique SOURCE_FILE_AT_LINE (1113)))).isBuiltAndTrue ()) {
      var_cas_endOfListLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much expressions") SOURCE_FILE_AT_LINE (1114)) ;
  }else if (((var_cas_inFormalAttributesList.reader_length (_inLexique SOURCE_FILE_AT_LINE (1115))) > (var_cas_effectiveTypesList.reader_length (_inLexique SOURCE_FILE_AT_LINE (1115)))).isBuiltAndTrue ()) {
      var_cas_endOfListLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more expressions missing") SOURCE_FILE_AT_LINE (1116)) ;
  }else{
    GGS_typeListeAttributsSemantiques::element_type * operand_42206 = var_cas_inFormalAttributesList.firstObject () ;
    GGS_typeTypesList::element_type * operand_42301 = var_cas_effectiveTypesList.firstObject () ;
    while ((operand_42206 != NULL)
        && (operand_42301 != NULL)) {
      macroValidPointer (operand_42206) ;
      macroValidPointer (operand_42301) ;
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_42206->mAttributType,  operand_42301->mType,  operand_42301->mEndOfExpressionLocation SOURCE_FILE_AT_LINE (1120)) ;
      operand_42206 = operand_42206->nextObject () ;
      operand_42301 = operand_42301->nextObject () ;
    }
  }
}
