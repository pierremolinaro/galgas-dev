...
void expression_parser::
pr_factor_expression_parser_1504_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  switch (select_expression_parser_9 (inLexique)) {
    case 1 : {
      ...
      const GGS_M_filewrappers  temp_60272 = var_cas_inSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (1520)) ;
      if (temp_60272.isBuilt ()) {
        temp_60272 (HERE)->method_searchKey (inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1520)) ;
      }
        ...
        case 2 : {
          ...
          switch (select_expression_parser_11 (inLexique)) {
            case 1 : {
              ...
              const GGS_filewrapperTemplateMap  temp_60704 = var_cas_templateMap ;
              if (temp_60704.isBuilt ()) {
                temp_60704 (HERE)->method_searchKey (inLexique, var_cas_templateName, var_cas_formalAttributeList COMMA_SOURCE_FILE_AT_LINE (1532)) ;
              }
            ...
            case 2 : {
              ...
              const GGS_M_regularFiles  temp_61376 = var_cas_regularFileMap ;
              if (temp_61376.isBuilt ()) {
                temp_61376 (HERE)->method_searchKey (inLexique, var_cas_path, automatic_var_1, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1552)) ;
              }
    ...
    case 2 : {
      ...
      switch (select_expression_parser_12 (inLexique)) {
        ...
        case 2 : {
          ...
          ::routine_handleReaderCall (inLexique,  var_cas_inEntitiesMap,  var_cas_inSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1583)),  var_cas_expressionType,  var_cas_methodName,  var_cas_accessorsTypeList,  var_cas_outResultType,  var_cas_conversionMethod,  var_cas_categoryReaderClassBaseName COMMA_SOURCE_FILE_AT_LINE (1581)) ;
          GGS_typeExpressionList  var_cas_expressionList ;
    ...
    case 3 : {
      ...
      const GGS_M_semanticsEntitiesForUse  temp_63301 = var_cas_inEntitiesMap ;
      if (temp_63301.isBuilt ()) {
        temp_63301 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_e COMMA_SOURCE_FILE_AT_LINE (1611)) ;
      }
      var_cas_outResultType = GGS_typeEntiteType::castFrom (inLexique, var_cas_e.getPtr (), true, var_cas_className COMMA_SOURCE_FILE_AT_LINE (1612)).reader_aDefType (inLexique COMMA_SOURCE_FILE_AT_LINE (1612)) ;
      GGS_typeListeAttributsSemantiques  var_cas_listeAttributsSemantiques ;
      GGS_bool var_cas_hasLexiqueAndLocationArguments ;
      const GGS_AC_galgasType  temp_63551 = var_cas_outResultType ;
      if (temp_63551.isBuilt ()) {
        temp_63551 (HERE)->method_handleConstructorCall (inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques, var_cas_hasLexiqueAndLocationArguments COMMA_SOURCE_FILE_AT_LINE (1615)) ;
      }
      GGS_typeExpressionList  var_cas_expressionList ;
      ...
      var_cas_outExpression = GGS_typeConstructorExpression ::constructor_new (inLexique, var_cas_outResultType, var_cas_mClassMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1628)), var_cas_hasLexiqueAndLocationArguments, var_cas_expressionList COMMA_HERE) ;
      } break ;
    case 4 : {
      ...
      switch (select_expression_parser_13 (inLexique)) {
        case 1 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          if (((var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1638))).operator_isNotEqual (GGS_string ("verbose_output"))).isBuiltAndTrue ()) {
            var_cas_optionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this option name does not correspond to a builtin option") COMMA_SOURCE_FILE_AT_LINE (1640)) ;
          }
        ...
        case 2 : {
          ...
          const GGS_M_optionComponents  temp_64716 = var_cas_inOptionsComponentsMapForUse ;
          if (temp_64716.isBuilt ()) {
            temp_64716 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1649)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E_) COMMA_HERE) ;
          GGS_lstring  var_cas_optionName ;
          inLexique.assignFromAttribute_tokenString (var_cas_optionName) ;
...
void expression_parser::
pr_factor_expression_parser_1504_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  switch (select_expression_parser_9 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_filewrapper) COMMA_HERE) ;
...
void expression_parser::
pr_factor_expression_parser_1678_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_66658 = var_cas_inEntitiesMap ;
  if (temp_66658.isBuilt ()) {
    temp_66658 (HERE)->method_searchKey (inLexique, var_cas_functionName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1691)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_67238 = var_cas_entite ; // CAST instruction
    if (_var_67238.getPtr () != NULL) {
      macroValidPointer (_var_67238.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteFonction *> (_var_67238.getPtr ()) != NULL) {
        const GGS_typeEntiteFonction var_cas_r (_var_67238.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_r.reader_aListeArgumentsFormels (inLexique COMMA_SOURCE_FILE_AT_LINE (1695)) ;
        var_cas_outResultType = var_cas_r.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1696)) ;
        var_cas_isExternActionCall = GGS_bool (false) ;
      }else if (dynamic_cast <cPtr_typeEntiteFonctionExterne *> (_var_67238.getPtr ()) != NULL) {
        const GGS_typeEntiteFonctionExterne var_cas_ae (_var_67238.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_ae.reader_aSignature (inLexique COMMA_SOURCE_FILE_AT_LINE (1699)) ;
        var_cas_outResultType = var_cas_ae.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1700)) ;
        var_cas_isExternActionCall = GGS_bool (true) ;
      }else{
        var_cas_functionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'")).operator_concat (var_cas_functionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1704)))).operator_concat (GGS_string ("' should name a function or an extern function")) COMMA_SOURCE_FILE_AT_LINE (1707)) ;
  ...
  {
    GGS_L_EXsignature::cEnumerator enumerator_67406 (var_cas_signatureRoutine, true) ;
    const GGS_L_EXsignature::cElement * operand_67406 = NULL ;
    while (((operand_67406 = enumerator_67406.nextObject ()))) {
      macroValidPointer (operand_67406) ;
      var_cas_listeAttributsSemantiques._addAssign_operation (operand_67406->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28_) COMMA_HERE) ;
  nt_output_expression_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
...
void expression_parser::
pr_factor_expression_parser_1678_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28_) COMMA_HERE) ;
  nt_output_expression_list_parse (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__29_) COMMA_HERE) ;
...
void expression_parser::
pr_read_access_expression_parser_1733_18_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1740)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_read_access_expression_parser_1733_18_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
}
...
void expression_parser::
pr_read_access_expression_parser_1749_18_ (galgas_scanner & inLexique,
                                GGS_lstring  &var_cas_nomVariable,
                                GGS_typeCplusPlusName  &var_cas_nomCppEntite,
                                GGS_AC_galgasType  &var_cas_typeEntite,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
  if ((var_cas_ioVariablesMap.reader_hasKey (inLexique, GGS_string ("self") COMMA_SOURCE_FILE_AT_LINE (1756))).isBuiltAndTrue ()) {
    var_cas_nomVariable = GGS_lstring ::constructor_new (inLexique, GGS_string ("self"), GGS_location (inLexique) COMMA_HERE) ;
    var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1758)) ;
  }else{
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'self' is not defined in this context") COMMA_SOURCE_FILE_AT_LINE (1762)) ;
...
void expression_parser::
pr_read_access_expression_parser_1749_18_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
}
...
void expression_parser::
pr_output_expression_list_expression_parser_1771_29_ (galgas_scanner & inLexique,
  ...
  if (((var_cas_inFormalAttributesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1800))).operator_strictInf (var_cas_effectiveTypesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1800)))).isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("too much expressions") COMMA_SOURCE_FILE_AT_LINE (1802)) ;
  }else if (((var_cas_inFormalAttributesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1802))).operator_strictSup (var_cas_effectiveTypesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1802)))).isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more expressions missing") COMMA_SOURCE_FILE_AT_LINE (1804)) ;
  }else{
    {
      GGS_typeListeAttributsSemantiques::cEnumerator enumerator_70943 (var_cas_inFormalAttributesList, true) ;
      const GGS_typeListeAttributsSemantiques::cElement * operand_70943 = NULL ;
      GGS_typeTypesList::cEnumerator enumerator_71034 (var_cas_effectiveTypesList, true) ;
      const GGS_typeTypesList::cElement * operand_71034 = NULL ;
      while (((operand_70943 = enumerator_70943.nextObject ()))
          && ((operand_71034 = enumerator_71034.nextObject ()))) {
        macroValidPointer (operand_70943) ;
        macroValidPointer (operand_71034) ;
        ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_70943->mAttributType,  operand_71034->mType,  operand_71034->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1807)) ;
      }
    }
  }
}
...
void expression_parser::
pr_output_expression_list_expression_parser_1771_29_parse (galgas_scanner & inLexique) {
  { bool syntaxRepeat_14 = true ;
    while (syntaxRepeat_14) {
      switch (select_repeat_expression_parser_14 (inLexique)) {
        case 2 : {
...
void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_1818_44_ (galgas_scanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
        ...
        case 2 : {
          switch (select_expression_parser_16 (inLexique)) {
            ...
            case 3 : {
              ...
              var_cas_jokerCount = var_cas_jokerCountWithLocation.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1845)) ;
              GGS_uint _variant_72661 = var_cas_jokerCount.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1846)) ;
              GGS_bool _condition_72661 (_variant_72661.isBuilt (), true) ;
              while (_condition_72661.isBuiltAndTrue ()) {
                _condition_72661 = (var_cas_jokerCount).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_72661.isBuiltAndTrue ()) {
                  if (_variant_72661.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1850)) ;
                    _condition_72661 = GGS_bool (false) ;
                  }else{
                    _variant_72661.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_argumentsList._addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
                    var_cas_jokerCount.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1849)) ;
                  }
                }
              }
              } break ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__29_) COMMA_HERE) ;
  ::routine_buildMapWithLocalConstants (inLexique,  var_cas_inEnumeratorNewStyle,  var_cas_argumentsList,  var_cas_inFormalArgumentsList,  var_cas_ioVariablesMap,  var_cas_inVarLocation,  var_cas_inLocalConstantStyle,  var_cas_ellipsisFound COMMA_SOURCE_FILE_AT_LINE (1862)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_1818_44_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28_) COMMA_HERE) ;
  { bool syntaxRepeat_15 = true ;
    while (syntaxRepeat_15) {
      switch (select_repeat_expression_parser_15 (inLexique)) {
