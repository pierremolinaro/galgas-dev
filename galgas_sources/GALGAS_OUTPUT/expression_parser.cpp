...
//---------------------------------------------------------------------------*
  ...
  static const char gGGSsourceFile [] = "/Volumes/developpements/mes_prgms/galgas/galgas_sources/expression_parser.ggs" ;
    ...
    if ((operand_4756 != NULL) && (operand_4781 != NULL)) {
      ...
      if ((operand_4756 != NULL) && (operand_4781 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
          ...
          GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "operand type error : (")) + (var_cas_inLeftExpressionType.reader_messageGalgasType ()))) + (GGS_string (true, " & ")))) + (var_cas_inRightExpressionType.reader_messageGalgasType ()))) + (GGS_string (true, ") is not valid"))) SOURCE_FILE_AT_LINE (137)) ;
      }
    }
  }
}
    ...
    if ((operand_5778 != NULL) && (operand_5803 != NULL)) {
      ...
      if ((operand_5778 != NULL) && (operand_5803 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
          ...
          GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "operand type error : (")) + (var_cas_inLeftExpressionType.reader_messageGalgasType ()))) + (GGS_string (true, " | ")))) + (var_cas_inRightExpressionType.reader_messageGalgasType ()))) + (GGS_string (true, ") is not valid"))) SOURCE_FILE_AT_LINE (160)) ;
      }
    }
  }
}
...
void routine_matchMinusOperator (C_Lexique & lexique_var_,
                                const GGS_AC_galgasType  & var_cas_inLeftExpressionType,
                                const GGS_AC_galgasType  & var_cas_inRightExpressionType,
                                GGS_AC_galgasType  & var_cas_outResultType COMMA_UNUSED_LOCATION_ARGS) {
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    ...
    if ((operand_6803 != NULL) && (operand_6828 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
        ...
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "operand type error : (")) + (var_cas_inLeftExpressionType.reader_messageGalgasType ()))) + (GGS_string (true, " | ")))) + (var_cas_inRightExpressionType.reader_messageGalgasType ()))) + (GGS_string (true, ") is not valid"))) SOURCE_FILE_AT_LINE (181)) ;
    }
  }
}
  ...
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    ...
    if ((operand_7733 != NULL) && (operand_7758 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
        ...
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "operand type error : (")) + (var_cas_inLeftExpressionType.reader_messageGalgasType ()))) + (GGS_string (true, " . ")))) + (var_cas_inRightExpressionType.reader_messageGalgasType ()))) + (GGS_string (true, ") is not valid"))) SOURCE_FILE_AT_LINE (202)) ;
    }
  }
}
  ...
  { cPtr_typeGalgas_bool * ptrExtraire_ = dynamic_cast <cPtr_typeGalgas_bool *> (var_cas_inOperandType.getPtr ()) ;
    if (ptrExtraire_ == NULL) {
      if (var_cas_inOperandType.getPtr () != NULL) {
        ...
        GGS_location (lexique_var_).signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (217)) ;
      }
    }else{
              ...
              if ((operand_9241 != NULL) && (operand_9266 != NULL)) {
                ...
                if ((operand_9241 != NULL) && (operand_9266 != NULL)) {
                  if (((operand_9241->mEnumTypeName.reader_value ()) != (operand_9266->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "comparison between a '@")) + (operand_9241->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' enumeration and a '@")))) + (operand_9266->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' is not valid"))) SOURCE_FILE_AT_LINE (241)) ;
                  }
                }else{
                    GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "comparison between ")) + (var_cas_inLeftExpressionType.reader_messageGalgasType ()))) + (GGS_string (true, " and ")))) + (var_cas_inRightExpressionType.reader_messageGalgasType ()))) + (GGS_string (true, " is not valid"))) SOURCE_FILE_AT_LINE (245)) ;
                }
              }
            }
          }
...
expression_parser::
pr_expression_expression_parser_255_18_ (galgas_scanner & lexique_var_,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_expression_parser_0 (lexique_var_)) {
        case 2 : {
          ...
          ::routine_matchConcatOperator (lexique_var_,  var_cas_firstOperandType,  var_cas_secondOperandType,  var_cas_outResultType SOURCE_FILE_AT_LINE (285)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
...
void expression_parser::
pr_expression_expression_parser_255_18_parse (galgas_scanner & lexique_var_) {
...
void expression_parser::
expression_parser::
pr_concatenation_term_expression_parser_298_26_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeExpression  &var_cas_outExpression,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_expression_parser_1 (lexique_var_)) {
        case 2 : {
          ...
          ::routine_matchOrOperator (lexique_var_,  var_cas_firstOperandType,  var_cas_secondOperandType,  var_cas_outResultType SOURCE_FILE_AT_LINE (328)) ;
          } break ;
        case 3 : {
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__2D) ;
          GGS_typeExpression  var_cas_leftOperand ;
          var_cas_leftOperand = var_cas_outExpression ;
          GGS_typeExpression  var_cas_rightOperand ;
          GGS_AC_galgasType  var_cas_firstOperandType ;
          ...
          ::routine_matchMinusOperator (lexique_var_,  var_cas_firstOperandType,  var_cas_secondOperandType,  var_cas_outResultType SOURCE_FILE_AT_LINE (347)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
...
void expression_parser::
pr_concatenation_term_expression_parser_298_26_parse (galgas_scanner & lexique_var_) {
...
void expression_parser::
expression_parser::
pr_relation_term_expression_parser_360_21_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeExpression  &var_cas_outExpression,
    ...
    while (syntaxRepeat) {
      switch (select_repeat_expression_parser_2 (lexique_var_)) {
        case 2 : {
          ...
          ::routine_matchAndOperator (lexique_var_,  var_cas_firstOperandType,  var_cas_secondOperandType,  var_cas_outResultType SOURCE_FILE_AT_LINE (390)) ;
          } break ;
        default :
          syntaxRepeat = false ;
          break ;
...
void expression_parser::
pr_relation_term_expression_parser_360_21_parse (galgas_scanner & lexique_var_) {
...
void expression_parser::
expression_parser::
pr_relation_factor_expression_parser_403_23_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeExpression  &var_cas_outExpression,
  ...
  switch (select_expression_parser_3 (lexique_var_)) {
    ...
    case 2 : {
      ...
      ::routine_comparison_types_check (lexique_var_,  var_cas_leftType,  var_cas_rightType SOURCE_FILE_AT_LINE (430)) ;
    ...
    case 3 : {
      ...
      GGS_AC_galgasType  var_cas_rightType ;
      nt_simple_expression_ (lexique_var_, var_cas_ioEntitiesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
      ::routine_comparison_types_check (lexique_var_,  var_cas_leftType,  var_cas_rightType SOURCE_FILE_AT_LINE (446)) ;
    ...
    case 4 : {
      ...
      GGS_AC_galgasType  var_cas_rightType ;
      nt_simple_expression_ (lexique_var_, var_cas_ioEntitiesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
      ::routine_comparison_types_check (lexique_var_,  var_cas_leftType,  var_cas_rightType SOURCE_FILE_AT_LINE (462)) ;
    ...
    case 5 : {
      ...
      GGS_AC_galgasType  var_cas_rightType ;
      nt_simple_expression_ (lexique_var_, var_cas_ioEntitiesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
      ::routine_comparison_types_check (lexique_var_,  var_cas_leftType,  var_cas_rightType SOURCE_FILE_AT_LINE (478)) ;
    ...
    case 6 : {
      ...
      GGS_AC_galgasType  var_cas_rightType ;
      nt_simple_expression_ (lexique_var_, var_cas_ioEntitiesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
      ::routine_comparison_types_check (lexique_var_,  var_cas_leftType,  var_cas_rightType SOURCE_FILE_AT_LINE (494)) ;
    ...
    case 7 : {
      ...
      GGS_AC_galgasType  var_cas_rightType ;
      nt_simple_expression_ (lexique_var_, var_cas_ioEntitiesMap, var_cas_ioOptionsComponentsMapForUse, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
      ::routine_comparison_types_check (lexique_var_,  var_cas_leftType,  var_cas_rightType SOURCE_FILE_AT_LINE (510)) ;
...
void expression_parser::
pr_relation_factor_expression_parser_403_23_parse (galgas_scanner & lexique_var_) {
...
void expression_parser::
expression_parser::
pr_simple_expression_expression_parser_522_25_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeExpression  &var_cas_outExpression,
...
void expression_parser::
pr_simple_expression_expression_parser_522_25_parse (galgas_scanner & lexique_var_) {
...
void expression_parser::
expression_parser::
pr_term_expression_parser_544_12_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeExpression  &var_cas_outExpression,
...
void expression_parser::
pr_term_expression_parser_544_12_parse (galgas_scanner & lexique_var_) {
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_566_14_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioEntitiesMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeExpression  &var_cas_outExpression,
...
void expression_parser::
pr_factor_expression_parser_566_14_parse (galgas_scanner & lexique_var_) {
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_585_14_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeExpression  &var_cas_outExpression,
...
void expression_parser::
pr_factor_expression_parser_585_14_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__28) ;
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_609_14_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeExpression  &var_cas_outExpression,
  ...
  ::routine_checkNotOperator (lexique_var_,  var_cas_operandType,  var_cas_outResultType SOURCE_FILE_AT_LINE (627)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_factor_expression_parser_609_14_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_not) ;
  nt_factor_parse (lexique_var_) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_636_14_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioEntitiesMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
                                GGS_typeExpression  &var_cas_outExpression,
...
void expression_parser::
pr_factor_expression_parser_636_14_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_true) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_654_14_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioEntitiesMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
                                GGS_typeExpression  &var_cas_outExpression,
...
void expression_parser::
pr_factor_expression_parser_654_14_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_false) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_672_14_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioEntitiesMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
                                GGS_typeExpression  &var_cas_outExpression,
...
void expression_parser::
pr_factor_expression_parser_672_14_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fstring) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_691_14_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioEntitiesMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
                                GGS_typeExpression  &var_cas_outExpression,
...
void expression_parser::
pr_factor_expression_parser_691_14_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_710_14_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioEntitiesMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
                                GGS_typeExpression  &var_cas_outExpression,
...
void expression_parser::
pr_factor_expression_parser_710_14_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_signed_5Fliteral_5Finteger) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_729_14_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioEntitiesMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
                                GGS_typeExpression  &var_cas_outExpression,
...
void expression_parser::
pr_factor_expression_parser_729_14_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_literal_5Fchar) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_748_14_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioEntitiesMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
                                GGS_typeExpression  &var_cas_outExpression,
...
void expression_parser::
pr_factor_expression_parser_748_14_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_here) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_769_14_ (galgas_scanner & lexique_var_,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeExpression  &var_cas_outExpression,
  ...
  switch (select_expression_parser_4 (lexique_var_)) {
    case 1 : {
      ...
      ::routine_handleReaderCall (lexique_var_,  var_cas_expressionType,  var_cas_methodName,  var_cas_accessorsTypeList,  var_cas_outResultType SOURCE_FILE_AT_LINE (793)) ;
    ...
    case 2 : {
      ...
      var_cas_ioEntitiesMap.methode_searchKey (lexique_var_, var_cas_className, var_cas_e SOURCE_FILE_AT_LINE (812)) ;
      { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_e.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          ...
          if (var_cas_e.getPtr () != NULL) {
            ...
            var_cas_className.signalExtractError (lexique_var_, message1_, message2_ SOURCE_FILE_AT_LINE (813)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
      ...
      if (var_cas_outResultType.isBuilt ()) {
        var_cas_outResultType (HERE)->methode_handleConstructorCall (lexique_var_, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques) ;
      }
      GGS_typeExpressionList  var_cas_expressionList ;
    ...
    case 3 : {
      ...
      var_cas_ioOptionsComponentsMapForUse.methode_searchKey (lexique_var_, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (833)) ;
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__2E) ;
      ...
      if ((var_cas_boolOptionsMap.reader_hasKey (var_cas_optionName.reader_value ())).isBuiltAndTrue ()) {
        ...
        var_cas_outResultType = GGS_typeGalgas_uint::constructor_new (HERE) ;
          ...
          var_cas_optionName.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "the '")) + (var_cas_optionComponentName.reader_value ()))) + (GGS_string (true, "' option component has no '")))) + (var_cas_optionName.reader_value ()))) + (GGS_string (true, "' option"))) SOURCE_FILE_AT_LINE (847)) ;
      }
      } break ;
    default :
      break ;
...
void expression_parser::
pr_factor_expression_parser_769_14_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__5B) ;
  switch (select_expression_parser_4 (lexique_var_)) {
    case 1 : {
      nt_expression_parse (lexique_var_) ;
...
void expression_parser::
expression_parser::
pr_read_access_expression_parser_860_19_ (galgas_scanner & lexique_var_,
  ...
  var_cas_ioVariablesMap.methode_searchForReadOnlyAccess (lexique_var_, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite SOURCE_FILE_AT_LINE (867)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_read_access_expression_parser_860_19_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
}
...
void expression_parser::
expression_parser::
pr_output_expression_list_expression_parser_876_30_ (galgas_scanner & lexique_var_,
  ...
  if (((var_cas_inFormalAttributesList.reader_length ()) < (var_cas_effectiveTypesList.reader_length ())).isBuiltAndTrue ()) {
      var_cas_endOfListLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "too much expressions") SOURCE_FILE_AT_LINE (904)) ;
  }else if (((var_cas_inFormalAttributesList.reader_length ()) > (var_cas_effectiveTypesList.reader_length ())).isBuiltAndTrue ()) {
      var_cas_endOfListLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "one or more expressions missing") SOURCE_FILE_AT_LINE (906)) ;
  }else{
    GGS_typeListeAttributsSemantiques::element_type * operand_34203 = var_cas_inFormalAttributesList.firstObject () ;
    GGS_typeTypesList::element_type * operand_34298 = var_cas_effectiveTypesList.firstObject () ;
    while ((operand_34203 != NULL)
        && (operand_34298 != NULL)) {
      macroValidPointer (operand_34203) ;
      macroValidPointer (operand_34298) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34203->mAttributType,  operand_34298->mType,  operand_34298->mEndOfExpressionLocation SOURCE_FILE_AT_LINE (910)) ;
      operand_34203 = operand_34203->nextObject () ;
      operand_34298 = operand_34298->nextObject () ;
    }
  }
}
...
void expression_parser::
pr_output_expression_list_expression_parser_876_30_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_expression_parser_5 (lexique_var_)) {
        case 2 : {
...
void expression_parser::
expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_921_45_ (galgas_scanner & lexique_var_,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  switch (select_expression_parser_8 (lexique_var_)) {
    case 1 : {
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
  ::routine_buildMapWithLocalConstants (lexique_var_,  var_cas_argumentsList,  var_cas_inFormalArgumentsList,  var_cas_ioVariablesMap,  var_cas_inVarLocation,  var_cas_inLocalConstantStyle,  var_cas_ellipsisFound SOURCE_FILE_AT_LINE (954)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_921_45_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_expression_parser_6 (lexique_var_)) {
