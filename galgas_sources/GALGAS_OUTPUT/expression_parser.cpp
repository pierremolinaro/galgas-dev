...
void expression_parser::rule_expression_5F_parser_primary_i11_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_M_semanticsEntitiesForUse  temp_51082 = var_cas_inEntitiesMap ;
  if (temp_51082.isBuilt ()) {
    temp_51082 (HERE)->method_searchKey (inLexique, var_cas_castedTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1322)) ;
  }
  ...
  const GGS_AC_galgasType  temp_52786 = var_cas_errorLocationExpressionType ;
  if (temp_52786.isBuilt ()) {
    temp_52786 (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (1356)) ;
  }
...
void expression_parser::rule_expression_5F_parser_primary_i23_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_M_semanticsEntitiesForUse  temp_63476 = var_cas_inEntitiesMap ;
  if (temp_63476.isBuilt ()) {
    temp_63476 (HERE)->method_searchKey (inLexique, var_cas_typeName, automatic_var_63490_0 COMMA_SOURCE_FILE_AT_LINE (1618)) ;
  }
...
void expression_parser::rule_expression_5F_parser_primary_i26_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_M_semanticsEntitiesForUse  temp_68540 = var_cas_inEntitiesMap ;
  if (temp_68540.isBuilt ()) {
    temp_68540 (HERE)->method_searchKey (inLexique, var_cas_typeName, var_cas_e COMMA_SOURCE_FILE_AT_LINE (1781)) ;
  }
  ...
  GGS_bool var_cas_hasLexiqueAndLocationArguments ;
  const GGS_AC_galgasType  temp_68872 = var_cas_type ;
  if (temp_68872.isBuilt ()) {
    temp_68872 (HERE)->method_handleConstructorInvocation (inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques, var_cas_hasLexiqueAndLocationArguments, var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1788)) ;
  }
  GGS_typeExpressionList  var_cas_expressionList ;
...
void expression_parser::rule_expression_5F_parser_primary_i27_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_expression_5F_parser_9 (inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_M_optionComponents  temp_71392 = var_cas_inOptionsComponentsMapForUse ;
      if (temp_71392.isBuilt ()) {
        temp_71392 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1851)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2E_) COMMA_HERE) ;
      GGS_lstring  var_cas_optionName ;
      inLexique.assignFromAttribute_tokenString (var_cas_optionName) ;
...
void expression_parser::rule_expression_5F_parser_primary_i28_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_M_filewrappers  temp_73915 = var_cas_inSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (1905)) ;
  if (temp_73915.isBuilt ()) {
    temp_73915 (HERE)->method_searchKey (inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1905)) ;
  }
    ...
    case 2 : {
      ...
      switch (select_expression_5F_parser_11 (inLexique)) {
        case 1 : {
          ...
          const GGS_filewrapperTemplateMapEX  temp_74323 = var_cas_templateMap ;
          if (temp_74323.isBuilt ()) {
            temp_74323 (HERE)->method_searchKey (inLexique, var_cas_templateName, var_cas_formalAttributeList COMMA_SOURCE_FILE_AT_LINE (1917)) ;
          }
          GGS_typeExpressionList  var_cas_expressionList ;
        ...
        case 2 : {
          ...
          GGS_uint  automatic_var_74983_0 ;
          const GGS_M_regularFiles  temp_74955 = var_cas_regularFileMap ;
          if (temp_74955.isBuilt ()) {
            temp_74955 (HERE)->method_searchKey (inLexique, var_cas_path, automatic_var_74983_0, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1937)) ;
          }
...
void expression_parser::rule_expression_5F_parser_primary_i29_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_76112 = var_cas_inEntitiesMap ;
  if (temp_76112.isBuilt ()) {
    temp_76112 (HERE)->method_searchKey (inLexique, var_cas_functionName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1965)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_76691 = var_cas_entite ; // CAST instruction
    if (_var_76691.getPtr () != NULL) {
      macroValidPointer (_var_76691.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteFonction *> (_var_76691.getPtr ()) != NULL) {
        const GGS_typeEntiteFonction var_cas_r (_var_76691.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeEntiteFonctionExterne *> (_var_76691.getPtr ()) != NULL) {
        const GGS_typeEntiteFonctionExterne var_cas_ae (_var_76691.getPtr ()) ;
  ...
  {
    GGS_L_EXsignature::cEnumerator enumerator_76859 (var_cas_signatureRoutine, true) ;
    const GGS_L_EXsignature::cElement * operand_76859 = NULL ;
    while (((operand_76859 = enumerator_76859.nextObject ()))) {
      macroValidPointer (operand_76859) ;
      var_cas_listeAttributsSemantiques.addAssign_operation (operand_76859->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1986))) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5B_) COMMA_HERE) ;
  nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
...
void expression_parser::rule_expression_5F_parser_read_5F_access_i31_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_78660 = var_cas_ioVariablesMap.reader_hasKey (GGS_string ("self")) ;
  if (cond_78660.isBuiltAndTrue ()) {
  ...
  }else if (cond_78660.isBuiltAndFalse ()) {
...
void expression_parser::rule_expression_5F_parser_output_5F_expression_5F_list_i32_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_80220 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictInf (var_cas_effectiveTypesList.reader_length ()) ;
  if (cond_80220.isBuiltAndTrue ()) {
  ...
  }else if (cond_80220.isBuiltAndFalse ()) {
    const GGS_bool cond_80360 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictSup (var_cas_effectiveTypesList.reader_length ()) ;
    if (cond_80360.isBuiltAndTrue ()) {
    ...
    }else if (cond_80360.isBuiltAndFalse ()) {
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_80395 (var_cas_inFormalAttributesList, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_80395 = NULL ;
        GGS_typeTypesList::cEnumerator enumerator_80415 (var_cas_effectiveTypesList, true) ;
        const GGS_typeTypesList::cElement * operand_80415 = NULL ;
        while (((operand_80395 = enumerator_80395.nextObject ()))
            && ((operand_80415 = enumerator_80415.nextObject ()))) {
          macroValidPointer (operand_80395) ;
          macroValidPointer (operand_80415) ;
          ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_80395->mAttributType,  operand_80415->mType,  operand_80415->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (2080)) ;
        }
      }
    }
  }
        ...
        case 2 : {
          switch (select_expression_5F_parser_14 (inLexique)) {
            ...
            case 3 : {
              ...
              GGS_uint _variant_81988 = var_cas_jokerCount.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (2119)) ;
              GGS_bool _condition_81988 (_variant_81988.isBuilt (), true) ;
              while (_condition_81988.isBuiltAndTrue ()) {
                _condition_81988 = (var_cas_jokerCount).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_81988.isBuiltAndTrue ()) {
                  if (_variant_81988.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2123)) ;
                    _condition_81988 = GGS_bool (false) ;
                  }else{
                    _variant_81988.decrement_operation (inLexique COMMA_HERE) ;
