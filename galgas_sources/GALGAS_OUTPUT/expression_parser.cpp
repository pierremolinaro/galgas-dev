  ...
  switch (select_expression_parser_6 (_inLexique)) {
    ...
    case 3 : {
      ...
      if (var_cas_ioOptionsComponentsMapForUse._isBuilt ()) {
        var_cas_ioOptionsComponentsMapForUse (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (1298)) ;
      }
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2E) ;
      GGS_lstring  var_cas_optionName ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
      var_cas_optionName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
      if ((var_cas_boolOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1302)) SOURCE_FILE_AT_LINE (1302))).isBuiltAndTrue ()) {
        ...
        var_cas_outResultType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
      }else if ((var_cas_uintOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1305)) SOURCE_FILE_AT_LINE (1305))).isBuiltAndTrue ()) {
        ...
        var_cas_outResultType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
      }else if ((var_cas_stringOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1308)) SOURCE_FILE_AT_LINE (1308))).isBuiltAndTrue ()) {
        ...
        var_cas_optionName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "the '")) + (var_cas_optionComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1312))))) + (GGS_string (true, "' option component has no '")))) + (var_cas_optionName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1312))))) + (GGS_string (true, "' option"))) SOURCE_FILE_AT_LINE (1314)) ;
...
void expression_parser::
expression_parser::
pr_read_access_expression_parser_1325_19_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.method_searchForReadOnlyAccess (_inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite SOURCE_FILE_AT_LINE (1332)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_read_access_expression_parser_1325_19_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
}
...
void expression_parser::
expression_parser::
pr_read_access_expression_parser_1341_19_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_nomVariable,
                                GGS_typeCplusPlusName  &var_cas_nomCppEntite,
                                GGS_AC_galgasType  &var_cas_typeEntite,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_self) ;
  if ((var_cas_ioVariablesMap.reader_hasKey (_inLexique, GGS_string (true, "self") SOURCE_FILE_AT_LINE (1348))).isBuiltAndTrue ()) {
    ...
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'self' is not defined in this context") SOURCE_FILE_AT_LINE (1354)) ;
...
void expression_parser::
pr_read_access_expression_parser_1341_19_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_self) ;
}
...
void expression_parser::
expression_parser::
pr_output_expression_list_expression_parser_1363_30_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inFormalAttributesList.reader_length (_inLexique SOURCE_FILE_AT_LINE (1390))) < (var_cas_effectiveTypesList.reader_length (_inLexique SOURCE_FILE_AT_LINE (1390)))).isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much expressions") SOURCE_FILE_AT_LINE (1392)) ;
  }else if (((var_cas_inFormalAttributesList.reader_length (_inLexique SOURCE_FILE_AT_LINE (1392))) > (var_cas_effectiveTypesList.reader_length (_inLexique SOURCE_FILE_AT_LINE (1392)))).isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more expressions missing") SOURCE_FILE_AT_LINE (1394)) ;
  }else{
    GGS_typeListeAttributsSemantiques::element_type * operand_53458 = var_cas_inFormalAttributesList.firstObject () ;
    GGS_typeTypesList::element_type * operand_53553 = var_cas_effectiveTypesList.firstObject () ;
    while ((operand_53458 != NULL)
        && (operand_53553 != NULL)) {
      macroValidPointer (operand_53458) ;
      macroValidPointer (operand_53553) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_53458->mAttributType,  operand_53553->mType,  operand_53553->mEndOfExpressionLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (1397)) ;
      operand_53458 = operand_53458->nextObject () ;
      operand_53553 = operand_53553->nextObject () ;
    }
  }
}
...
void expression_parser::
pr_output_expression_list_expression_parser_1363_30_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_expression_parser_7 (_inLexique)) {
        case 2 : {
...
void expression_parser::
expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_1408_45_ (galgas_scanner & _inLexique,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
  ::routine_buildMapWithLocalConstants (_inLexique,  var_cas_argumentsList,  var_cas_inFormalArgumentsList,  var_cas_ioVariablesMap,  var_cas_inVarLocation,  var_cas_inLocalConstantStyle,  var_cas_ellipsisFound SOURCE_FILE_AT_LINE (1441)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_1408_45_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_expression_parser_8 (_inLexique)) {
