...
pr_factor_expression_parser_1831_13_ (galgas_scanner & inLexique,
  ...
  const GGS_M_filewrappers  temp_71849 = var_cas_inSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (1846)) ;
  if (temp_71849.isBuilt ()) {
    temp_71849 (HERE)->method_searchKey (inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1846)) ;
  }
    ...
    case 2 : {
      ...
      switch (select_expression_parser_10 (inLexique)) {
        case 1 : {
          ...
          const GGS_filewrapperTemplateMap  temp_72257 = var_cas_templateMap ;
          if (temp_72257.isBuilt ()) {
            temp_72257 (HERE)->method_searchKey (inLexique, var_cas_templateName, var_cas_formalAttributeList COMMA_SOURCE_FILE_AT_LINE (1858)) ;
          }
          GGS_typeExpressionList  var_cas_expressionList ;
        ...
        case 2 : {
          ...
          GGS_uint  automatic_var_72917_0 ;
          const GGS_M_regularFiles  temp_72889 = var_cas_regularFileMap ;
          if (temp_72889.isBuilt ()) {
            temp_72889 (HERE)->method_searchKey (inLexique, var_cas_path, automatic_var_72917_0, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1878)) ;
          }
...
pr_factor_expression_parser_1893_13_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_74045 = var_cas_inEntitiesMap ;
  if (temp_74045.isBuilt ()) {
    temp_74045 (HERE)->method_searchKey (inLexique, var_cas_functionName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1906)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_74625 = var_cas_entite ; // CAST instruction
    if (_var_74625.getPtr () != NULL) {
      macroValidPointer (_var_74625.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteFonction *> (_var_74625.getPtr ()) != NULL) {
        const GGS_typeEntiteFonction var_cas_r (_var_74625.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeEntiteFonctionExterne *> (_var_74625.getPtr ()) != NULL) {
        const GGS_typeEntiteFonctionExterne var_cas_ae (_var_74625.getPtr ()) ;
  ...
  {
    GGS_L_EXsignature::cEnumerator enumerator_74793 (var_cas_signatureRoutine, true) ;
    const GGS_L_EXsignature::cElement * operand_74793 = NULL ;
    while (((operand_74793 = enumerator_74793.nextObject ()))) {
      macroValidPointer (operand_74793) ;
      var_cas_listeAttributsSemantiques.addAssign_operation (operand_74793->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  nt_output_expression_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
...
pr_read_access_expression_parser_1964_18_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_76594 = var_cas_ioVariablesMap.reader_hasKey (GGS_string ("self")) ;
  if (cond_76594.isBuiltAndTrue ()) {
  ...
  }else if (cond_76594.isBuiltAndFalse ()) {
...
pr_output_expression_list_expression_parser_1986_29_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_78155 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictInf (var_cas_effectiveTypesList.reader_length ()) ;
  if (cond_78155.isBuiltAndTrue ()) {
  ...
  }else if (cond_78155.isBuiltAndFalse ()) {
    const GGS_bool cond_78295 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictSup (var_cas_effectiveTypesList.reader_length ()) ;
    if (cond_78295.isBuiltAndTrue ()) {
    ...
    }else if (cond_78295.isBuiltAndFalse ()) {
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_78330 (var_cas_inFormalAttributesList, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_78330 = NULL ;
        GGS_typeTypesList::cEnumerator enumerator_78350 (var_cas_effectiveTypesList, true) ;
        const GGS_typeTypesList::cElement * operand_78350 = NULL ;
        while (((operand_78330 = enumerator_78330.nextObject ()))
            && ((operand_78350 = enumerator_78350.nextObject ()))) {
          macroValidPointer (operand_78330) ;
          macroValidPointer (operand_78350) ;
          ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_78330->mAttributType,  operand_78350->mType,  operand_78350->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (2021)) ;
        }
      }
    }
  }
        ...
        case 2 : {
          switch (select_expression_parser_13 (inLexique)) {
            ...
            case 3 : {
              ...
              GGS_uint _variant_79923 = var_cas_jokerCount.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (2060)) ;
              GGS_bool _condition_79923 (_variant_79923.isBuilt (), true) ;
              while (_condition_79923.isBuiltAndTrue ()) {
                _condition_79923 = (var_cas_jokerCount).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_79923.isBuiltAndTrue ()) {
                  if (_variant_79923.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2064)) ;
                    _condition_79923 = GGS_bool (false) ;
                  }else{
                    _variant_79923.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_argumentsList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
