...
pr_factor_expression_parser_1132_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_expression_parser_6 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_M_semanticsEntitiesForUse  _temp_45479 = var_cas_ioEntitiesMap ;
      if (_temp_45479._isBuilt ()) {
        _temp_45479 (HERE)->method_searchKey (_inLexique, var_cas_castedTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1178)) ;
      }
      ...
      const GGS_AC_galgasType  _temp_47213 = var_cas_errorLocationExpressionType ;
      if (_temp_47213._isBuilt ()) {
        _temp_47213 (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1210)) ;
      }
...
pr_factor_expression_parser_1496_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_expression_parser_9 (_inLexique)) {
    case 1 : {
      ...
      const GGS_M_filewrappers  _temp_59739 = var_cas_inSemanticContext.reader_mFilewrappers (_inLexique COMMA_SOURCE_FILE_AT_LINE (1513)) ;
      if (_temp_59739._isBuilt ()) {
        _temp_59739 (HERE)->method_searchKey (_inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1513)) ;
      }
        ...
        case 2 : {
          ...
          switch (select_expression_parser_11 (_inLexique)) {
            case 1 : {
              ...
              const GGS_filewrapperTemplateMap  _temp_60171 = var_cas_templateMap ;
              if (_temp_60171._isBuilt ()) {
                _temp_60171 (HERE)->method_searchKey (_inLexique, var_cas_templateName, var_cas_formalAttributeList COMMA_SOURCE_FILE_AT_LINE (1525)) ;
              }
            ...
            case 2 : {
              ...
              const GGS_M_regularFiles  _temp_60843 = var_cas_regularFileMap ;
              if (_temp_60843._isBuilt ()) {
                _temp_60843 (HERE)->method_searchKey (_inLexique, var_cas_path, automatic_var_1, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1545)) ;
              }
    ...
    case 3 : {
      ...
      const GGS_M_semanticsEntitiesForUse  _temp_62510 = var_cas_ioEntitiesMap ;
      if (_temp_62510._isBuilt ()) {
        _temp_62510 (HERE)->method_searchKey (_inLexique, var_cas_className, var_cas_e COMMA_SOURCE_FILE_AT_LINE (1594)) ;
      }
      ...
      const GGS_AC_galgasType  _temp_62705 = var_cas_outResultType ;
      if (_temp_62705._isBuilt ()) {
        _temp_62705 (HERE)->method_handleConstructorCall (_inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques COMMA_SOURCE_FILE_AT_LINE (1597)) ;
      }
      GGS_typeExpressionList  var_cas_expressionList ;
    ...
    case 4 : {
      ...
      switch (select_expression_parser_13 (_inLexique)) {
        ...
        case 2 : {
          ...
          const GGS_M_optionComponents  _temp_63812 = var_cas_inOptionsComponentsMapForUse ;
          if (_temp_63812._isBuilt ()) {
            _temp_63812 (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1630)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E) COMMA_HERE) ;
          GGS_lstring  var_cas_optionName ;
          _inLexique._assignFromAttribute_tokenString (var_cas_optionName) ;
...
pr_output_expression_list_expression_parser_1696_4_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inFormalAttributesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1725)))._operator_strictInf (var_cas_effectiveTypesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1725)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_typeListeAttributsSemantiques::cEnumerator enumerator_67982 (var_cas_inFormalAttributesList, true) ;
      const GGS_typeListeAttributsSemantiques::cElement * operand_67982 = NULL ;
      GGS_typeTypesList::cEnumerator enumerator_68065 (var_cas_effectiveTypesList, true) ;
      const GGS_typeTypesList::cElement * operand_68065 = NULL ;
      while (((operand_67982 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_67982.nextObject ()))
          && ((operand_68065 = enumerator_68065.nextObject ()))) {
        macroValidPointer (operand_67982) ;
        macroValidPointer (operand_68065) ;
        ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_67982->mAttributType,  operand_68065->mType,  operand_68065->mEndOfExpressionLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (1731)) ;
      }
    }
  }
}
        ...
        case 2 : {
          switch (select_expression_parser_16 (_inLexique)) {
            ...
            case 3 : {
              ...
              GGS_uint _variant_69683 = var_cas_jokerCount._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (1770)) ;
              GGS_bool _condition_69683 (_variant_69683._isBuilt (), true) ;
              while (_condition_69683.isBuiltAndTrue ()) {
                _condition_69683 = (var_cas_jokerCount)._operator_strictSup (GGS_uint (true, 0U)) ;
                if (_condition_69683.isBuiltAndTrue ()) {
                  if (_variant_69683.uintValue () == 0) {
                    _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1773)) ;
                    _condition_69683 = GGS_bool (true, false) ;
                  }else{
                    _variant_69683._decrement_operation (_inLexique COMMA_HERE) ;
                    var_cas_argumentsList._addAssign_operation (GGS_lstring ::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE), GGS_lstring ::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
