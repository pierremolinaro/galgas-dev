...
void routine_matchAndOperator (C_Lexique & lexique_var_,
  ...
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_4756 = var_cas_inLeftExpressionType () ;
    cPtr_AC_galgasType * ptr_4781 = var_cas_inRightExpressionType () ;
...
void routine_matchOrOperator (C_Lexique & lexique_var_,
                                ...
                                GGS_AC_galgasType  & var_cas_outResultType) {
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_5672 = var_cas_inLeftExpressionType () ;
    cPtr_AC_galgasType * ptr_5697 = var_cas_inRightExpressionType () ;
    cPtr_typeGalgas_bool * operand_5672 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_5672) ;
    cPtr_typeGalgas_bool * operand_5697 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_5697) ;
    if ((operand_5672 != NULL) && (operand_5697 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "operand type error : (")) + (var_cas_inLeftExpressionType.reader_messageGalgasType ()))) + (GGS_string (true, " | ")))) + (var_cas_inRightExpressionType.reader_messageGalgasType ()))) + (GGS_string (true, ") is not valid")))) ;
    }
...
void routine_matchConcatOperator (C_Lexique & lexique_var_,
                                ...
                                GGS_AC_galgasType  & var_cas_outResultType) {
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_6592 = var_cas_inLeftExpressionType () ;
    cPtr_AC_galgasType * ptr_6617 = var_cas_inRightExpressionType () ;
    cPtr_typeGalgas_string * operand_6592 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_6592) ;
    cPtr_typeGalgas_string * operand_6617 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_6617) ;
    if ((operand_6592 != NULL) && (operand_6617 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
        GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "operand type error : (")) + (var_cas_inLeftExpressionType.reader_messageGalgasType ()))) + (GGS_string (true, " . ")))) + (var_cas_inRightExpressionType.reader_messageGalgasType ()))) + (GGS_string (true, ") is not valid")))) ;
    }
...
void routine_comparison_types_check (C_Lexique & lexique_var_,
                                ...
                                const GGS_AC_galgasType  & var_cas_inRightExpressionType) {
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    cPtr_AC_galgasType * ptr_8100 = var_cas_inLeftExpressionType () ;
    cPtr_AC_galgasType * ptr_8125 = var_cas_inRightExpressionType () ;
    cPtr_typeGalgas_bool * operand_8100 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_8100) ;
    cPtr_typeGalgas_bool * operand_8125 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_8125) ;
    if ((operand_8100 != NULL) && (operand_8125 != NULL)) {
    }else{
      cPtr_typeGalgas_char * operand_8100 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_8100) ;
      cPtr_typeGalgas_char * operand_8125 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_8125) ;
      if ((operand_8100 != NULL) && (operand_8125 != NULL)) {
      }else{
        cPtr_typeGalgas_uint * operand_8100 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_8100) ;
        cPtr_typeGalgas_uint * operand_8125 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_8125) ;
        if ((operand_8100 != NULL) && (operand_8125 != NULL)) {
        }else{
          cPtr_typeGalgas_sint * operand_8100 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_8100) ;
          cPtr_typeGalgas_sint * operand_8125 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_8125) ;
          if ((operand_8100 != NULL) && (operand_8125 != NULL)) {
          }else{
            cPtr_typeGalgas_double * operand_8100 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_8100) ;
            cPtr_typeGalgas_double * operand_8125 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_8125) ;
            if ((operand_8100 != NULL) && (operand_8125 != NULL)) {
            }else{
              cPtr_typeGalgas_string * operand_8100 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_8100) ;
              cPtr_typeGalgas_string * operand_8125 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_8125) ;
              if ((operand_8100 != NULL) && (operand_8125 != NULL)) {
              }else{
                cPtr_typeGalgas_enum * operand_8100 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_8100) ;
                cPtr_typeGalgas_enum * operand_8125 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_8125) ;
                if ((operand_8100 != NULL) && (operand_8125 != NULL)) {
                  if (((operand_8100->mEnumTypeName.reader_value ()) != (operand_8125->mEnumTypeName.reader_value ())).isBuiltAndTrue ()) {
                      GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "comparison between a '@")) + (operand_8100->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' enumeration and a '@")))) + (operand_8125->mEnumTypeName.reader_value ()))) + (GGS_string (true, "' is not valid")))) ;
                  }
                }else{
...
pr_output_expression_list_expression_parser_828_30_ (galgas_scanner & lexique_var_,
  ...
  if (((var_cas_inFormalAttributesList.reader_length ()) < (var_cas_effectiveTypesList.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_32303 = var_cas_inFormalAttributesList.firstObject () ;
    GGS_typeTypesList::element_type * operand_32398 = var_cas_effectiveTypesList.firstObject () ;
    while ((operand_32303 != NULL)
        && (operand_32398 != NULL)) {
      macroValidPointer (operand_32303) ;
      macroValidPointer (operand_32398) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_32303->mAttributType,  operand_32398->mType,  operand_32398->mEndOfExpressionLocation) ;
      operand_32303 = operand_32303->nextObject () ;
      operand_32398 = operand_32398->nextObject () ;
    }
  }
}
...
void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_873_45_ (galgas_scanner & lexique_var_,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_873_45_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_expression_parser_6 (lexique_var_)) {
