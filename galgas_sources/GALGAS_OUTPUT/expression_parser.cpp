...
pr_factor_expression_parser_1495_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_expression_parser_9 (_inLexique)) {
    case 1 : {
      ...
      const GGS_M_filewrappers  _temp_59542 = var_cas_inSemanticContext.reader_mFilewrappers (_inLexique COMMA_SOURCE_FILE_AT_LINE (1511)) ;
      if (_temp_59542._isBuilt ()) {
        _temp_59542 (HERE)->method_searchKey (_inLexique, var_cas_filewrapperName, var_cas_regularFileMap COMMA_SOURCE_FILE_AT_LINE (1511)) ;
      }
      switch (select_expression_parser_10 (_inLexique)) {
        ...
        case 2 : {
          ...
          const GGS_M_regularFiles  _temp_59891 = var_cas_regularFileMap ;
          if (_temp_59891._isBuilt ()) {
            _temp_59891 (HERE)->method_searchKey (_inLexique, var_cas_path, automatic_var_1, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1522)) ;
          }
    ...
    case 3 : {
      ...
      const GGS_M_semanticsEntitiesForUse  _temp_61535 = var_cas_ioEntitiesMap ;
      if (_temp_61535._isBuilt ()) {
        _temp_61535 (HERE)->method_searchKey (_inLexique, var_cas_className, var_cas_e COMMA_SOURCE_FILE_AT_LINE (1570)) ;
      }
      ...
      const GGS_AC_galgasType  _temp_61730 = var_cas_outResultType ;
      if (_temp_61730._isBuilt ()) {
        _temp_61730 (HERE)->method_handleConstructorCall (_inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques COMMA_SOURCE_FILE_AT_LINE (1573)) ;
      }
      GGS_typeExpressionList  var_cas_expressionList ;
    ...
    case 4 : {
      ...
      switch (select_expression_parser_12 (_inLexique)) {
        ...
        case 2 : {
          ...
          const GGS_M_optionComponents  _temp_62842 = var_cas_inOptionsComponentsMapForUse ;
          if (_temp_62842._isBuilt ()) {
            _temp_62842 (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1606)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E) COMMA_HERE) ;
          GGS_lstring  var_cas_optionName ;
          _inLexique._assignFromAttribute_tokenString (var_cas_optionName) ;
...
pr_output_expression_list_expression_parser_1672_4_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inFormalAttributesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1701)))._operator_strictInf (var_cas_effectiveTypesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1701)))).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_67010 (var_cas_inFormalAttributesList, true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_67010 = NULL ;
    GGS_typeTypesList::cEnumerator enumerator_67093 (var_cas_effectiveTypesList, true) ;
    const GGS_typeTypesList::cElement * operand_67093 = NULL ;
    while (((operand_67010 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_67010.nextObject ()))
        && ((operand_67093 = enumerator_67093.nextObject ()))) {
      macroValidPointer (operand_67010) ;
      macroValidPointer (operand_67093) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_67010->mAttributType,  operand_67093->mType,  operand_67093->mEndOfExpressionLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (1707)) ;
    }
    enumerator_67010.reset () ;
    enumerator_67093.reset () ;
  }
}
        ...
        case 2 : {
          switch (select_expression_parser_15 (_inLexique)) {
            ...
            case 3 : {
              ...
              GGS_uint _variant_68710 = var_cas_jokerCount._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (1746)) ;
              GGS_bool _condition_68710 (_variant_68710._isBuilt (), true) ;
              while (_condition_68710.isBuiltAndTrue ()) {
                _condition_68710 = (var_cas_jokerCount)._operator_strictSup (GGS_uint (true, 0U)) ;
                if (_condition_68710.isBuiltAndTrue ()) {
                  if (_variant_68710.uintValue () == 0) {
                    _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1749)) ;
                    _condition_68710 = GGS_bool (true, false) ;
                  }else{
                    _variant_68710._decrement_operation (_inLexique COMMA_HERE) ;
                    var_cas_argumentsList._addAssign_operation (GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE), GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
