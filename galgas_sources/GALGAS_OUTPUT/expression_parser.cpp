    ...
    if ((operand_4756 != NULL) && (operand_4781 != NULL)) {
      ...
      if ((operand_4756 != NULL) && (operand_4781 != NULL)) {
        ...
        if ((operand_4756 != NULL) && (operand_4781 != NULL)) {
          ...
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "operand type error : (")) + (var_cas_inLeftExpressionType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (138))))) + (GGS_string (true, " & ")))) + (var_cas_inRightExpressionType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (139))))) + (GGS_string (true, ") is not valid"))) SOURCE_FILE_AT_LINE (141)) ;
    ...
    if ((operand_5874 != NULL) && (operand_5899 != NULL)) {
      ...
      if ((operand_5874 != NULL) && (operand_5899 != NULL)) {
        ...
        if ((operand_5874 != NULL) && (operand_5899 != NULL)) {
          ...
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "operand type error : (")) + (var_cas_inLeftExpressionType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (163))))) + (GGS_string (true, " | ")))) + (var_cas_inRightExpressionType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (164))))) + (GGS_string (true, ") is not valid"))) SOURCE_FILE_AT_LINE (166)) ;
          var_cas_outResultType.drop_operation () ;
        }
      }
    }
  ...
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    ...
    if ((operand_6993 != NULL) && (operand_7018 != NULL)) {
      ...
      if ((operand_6993 != NULL) && (operand_7018 != NULL)) {
        ...
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "operand type error : (")) + (var_cas_inLeftExpressionType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (186))))) + (GGS_string (true, " | ")))) + (var_cas_inRightExpressionType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (187))))) + (GGS_string (true, ") is not valid"))) SOURCE_FILE_AT_LINE (189)) ;
        var_cas_outResultType.drop_operation () ;
      }
    }
  }
...
void routine_matchConcatOperator (C_Lexique & _inLexique,
  ...
  if (var_cas_inLeftExpressionType.isBuilt () && var_cas_inRightExpressionType.isBuilt ()) {
    ...
    if ((operand_8009 != NULL) && (operand_8034 != NULL)) {
      ...
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "operand type error : (")) + (var_cas_inLeftExpressionType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (207))))) + (GGS_string (true, " . ")))) + (var_cas_inRightExpressionType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (208))))) + (GGS_string (true, ") is not valid"))) SOURCE_FILE_AT_LINE (210)) ;
      var_cas_outResultType.drop_operation () ;
    }
  }
}
...
void routine_unary_minus_type_check (C_Lexique & _inLexique,
  ...
  if (var_cas_inExpressionType.isBuilt ()) {
    if (dynamic_cast <cPtr_typeGalgas_sint *> (var_cas_inExpressionType.getPtr ()) != NULL) {
      ...
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "unary minus for ")) + (var_cas_inExpressionType.reader_messageGalgasType (_inLexique SOURCE_FILE_AT_LINE (659))))) + (GGS_string (true, " is not valid"))) SOURCE_FILE_AT_LINE (663)) ;
      var_cas_outResultType.drop_operation () ;
    }
  }
}
  ...
  switch (select_expression_parser_6 (_inLexique)) {
    ...
    case 3 : {
      ...
      if ((var_cas_boolOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1092)) SOURCE_FILE_AT_LINE (1092))).isBuiltAndTrue ()) {
        ...
        var_cas_optionName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "the '")) + (var_cas_optionComponentName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1102))))) + (GGS_string (true, "' option component has no '")))) + (var_cas_optionName.reader_value (_inLexique SOURCE_FILE_AT_LINE (1102))))) + (GGS_string (true, "' option"))) SOURCE_FILE_AT_LINE (1104)) ;
...
pr_read_access_expression_parser_1131_19_ (galgas_scanner & _inLexique,
  ...
  if ((var_cas_ioVariablesMap.reader_hasKey (_inLexique, GGS_string (true, "self") SOURCE_FILE_AT_LINE (1138))).isBuiltAndTrue ()) {
    ...
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'self' is not defined in this context") SOURCE_FILE_AT_LINE (1144)) ;
...
pr_output_expression_list_expression_parser_1153_30_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inFormalAttributesList.reader_length (_inLexique SOURCE_FILE_AT_LINE (1180))) < (var_cas_effectiveTypesList.reader_length (_inLexique SOURCE_FILE_AT_LINE (1180)))).isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much expressions") SOURCE_FILE_AT_LINE (1182)) ;
    ...
    var_cas_endOfListLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more expressions missing") SOURCE_FILE_AT_LINE (1184)) ;
  }else{
    ...
    while ((operand_44784 != NULL)
      ...
      ::routine_verifierCompatibiliteTypesSemantiques (_inLexique,  operand_44784->mAttributType,  operand_44879->mType,  operand_44879->mEndOfExpressionLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (1187)) ;
