...
pr_factor_expression_parser_1504_13_ (galgas_scanner & inLexique,
  ...
  switch (select_expression_parser_9 (inLexique)) {
    ...
    case 3 : {
      ...
      const GGS_M_semanticsEntitiesForUse  temp_63270 = var_cas_inEntitiesMap ;
      if (temp_63270.isBuilt ()) {
        temp_63270 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_e COMMA_SOURCE_FILE_AT_LINE (1611)) ;
      }
      ...
      const GGS_AC_galgasType  temp_63520 = var_cas_outResultType ;
      if (temp_63520.isBuilt ()) {
        temp_63520 (HERE)->method_handleConstructorCall (inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques, var_cas_hasLexiqueAndLocationArguments COMMA_SOURCE_FILE_AT_LINE (1615)) ;
      }
      GGS_typeExpressionList  var_cas_expressionList ;
    ...
    case 4 : {
      ...
      switch (select_expression_parser_13 (inLexique)) {
        ...
        case 2 : {
          ...
          const GGS_M_optionComponents  temp_64685 = var_cas_inOptionsComponentsMapForUse ;
          if (temp_64685.isBuilt ()) {
            temp_64685 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1649)) ;
          }
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E_) COMMA_HERE) ;
          GGS_lstring  var_cas_optionName ;
          inLexique.assignFromAttribute_tokenString (var_cas_optionName) ;
...
pr_factor_expression_parser_1678_13_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_66627 = var_cas_inEntitiesMap ;
  if (temp_66627.isBuilt ()) {
    temp_66627 (HERE)->method_searchKey (inLexique, var_cas_functionName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1691)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_67207 = var_cas_entite ; // CAST instruction
    if (_var_67207.getPtr () != NULL) {
      macroValidPointer (_var_67207.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteFonction *> (_var_67207.getPtr ()) != NULL) {
        const GGS_typeEntiteFonction var_cas_r (_var_67207.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeEntiteFonctionExterne *> (_var_67207.getPtr ()) != NULL) {
        const GGS_typeEntiteFonctionExterne var_cas_ae (_var_67207.getPtr ()) ;
  ...
  {
    GGS_L_EXsignature::cEnumerator enumerator_67375 (var_cas_signatureRoutine, true) ;
    const GGS_L_EXsignature::cElement * operand_67375 = NULL ;
    while (((operand_67375 = enumerator_67375.nextObject ()))) {
      macroValidPointer (operand_67375) ;
      var_cas_listeAttributsSemantiques._addAssign_operation (operand_67375->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28_) COMMA_HERE) ;
  nt_output_expression_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
...
pr_output_expression_list_expression_parser_1771_29_ (galgas_scanner & inLexique,
  ...
  if (((var_cas_inFormalAttributesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1800))).operator_strictInf (var_cas_effectiveTypesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1800)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_typeListeAttributsSemantiques::cEnumerator enumerator_70912 (var_cas_inFormalAttributesList, true) ;
      const GGS_typeListeAttributsSemantiques::cElement * operand_70912 = NULL ;
      GGS_typeTypesList::cEnumerator enumerator_71003 (var_cas_effectiveTypesList, true) ;
      const GGS_typeTypesList::cElement * operand_71003 = NULL ;
      while (((operand_70912 = enumerator_70912.nextObject ()))
          && ((operand_71003 = enumerator_71003.nextObject ()))) {
        macroValidPointer (operand_70912) ;
        macroValidPointer (operand_71003) ;
        ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_70912->mAttributType,  operand_71003->mType,  operand_71003->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1807)) ;
      }
    }
  }
}
        ...
        case 2 : {
          switch (select_expression_parser_16 (inLexique)) {
            ...
            case 3 : {
              ...
              GGS_uint _variant_72630 = var_cas_jokerCount.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1846)) ;
              GGS_bool _condition_72630 (_variant_72630.isBuilt (), true) ;
              while (_condition_72630.isBuiltAndTrue ()) {
                _condition_72630 = (var_cas_jokerCount).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_72630.isBuiltAndTrue ()) {
                  if (_variant_72630.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1850)) ;
                    _condition_72630 = GGS_bool (false) ;
                  }else{
                    _variant_72630.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_argumentsList._addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
