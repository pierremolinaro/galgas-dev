    ...
    if ((operand_9733 != NULL) && (operand_9758 != NULL)) {
      ...
      if ((operand_9733 != NULL) && (operand_9758 != NULL)) {
        ...
        if ((operand_9733 != NULL) && (operand_9758 != NULL)) {
          ...
          cPtr_typeGalgas_multipleReferenceEntity * operand_9733 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (ptr_9733) ;
          cPtr_typeGalgas_multipleReferenceEntity * operand_9758 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (ptr_9758) ;
          if ((operand_9733 != NULL) && (operand_9758 != NULL)) {
            if (((operand_9733->mEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (249)))._operator_isNotEqual (operand_9758->mEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (249)))).isBuiltAndTrue ()) {
              GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "concatenation operator error: multiple references should refer the same type (here '@"))._operator_concat (operand_9733->mEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (251))))._operator_concat (GGS_string (true, "' is different from '@")))._operator_concat (operand_9758->mEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (251))))._operator_concat (GGS_string (true, "')")) COMMA_SOURCE_FILE_AT_LINE (251)) ;
            }
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_checkLogicalNegateOperator (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_AC_galgasType _var_12675 = var_cas_inOperandType ; // CAST instruction
    if (_var_12675.getPtr () != NULL) {
      macroValidPointer (_var_12675.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgas_binaryset *> (_var_12675.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inOperandType ;
      }else if (dynamic_cast <cPtr_typeGalgas_uint *> (_var_12675.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inOperandType ;
      }else if (dynamic_cast <cPtr_typeGalgas_sint *> (_var_12675.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inOperandType ;
      }else if (dynamic_cast <cPtr_typeGalgas_uint64 *> (_var_12675.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inOperandType ;
      }else if (dynamic_cast <cPtr_typeGalgas_sint64 *> (_var_12675.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inOperandType ;
      }else{
...
void routine_comparison_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_13237 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_13262 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_binaryset * operand_13237 = dynamic_cast <cPtr_typeGalgas_binaryset *> (ptr_13237) ;
    cPtr_typeGalgas_binaryset * operand_13262 = dynamic_cast <cPtr_typeGalgas_binaryset *> (ptr_13262) ;
    if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
    }else{
      cPtr_typeGalgas_stringset * operand_13237 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_13237) ;
      cPtr_typeGalgas_stringset * operand_13262 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_13262) ;
      if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
      }else{
        cPtr_typeGalgas_bool * operand_13237 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_13237) ;
        cPtr_typeGalgas_bool * operand_13262 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_13262) ;
        if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_13237 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_13237) ;
          cPtr_typeGalgas_char * operand_13262 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_13262) ;
          if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
          }else{
            cPtr_typeGalgas_uint * operand_13237 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_13237) ;
            cPtr_typeGalgas_uint * operand_13262 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_13262) ;
            if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
            }else{
              cPtr_typeGalgas_sint * operand_13237 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_13237) ;
              cPtr_typeGalgas_sint * operand_13262 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_13262) ;
              if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
              }else{
                cPtr_typeGalgas_uint64 * operand_13237 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_13237) ;
                cPtr_typeGalgas_uint64 * operand_13262 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_13262) ;
                if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                }else{
                  cPtr_typeGalgas_sint64 * operand_13237 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_13237) ;
                  cPtr_typeGalgas_sint64 * operand_13262 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_13262) ;
                  if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                  }else{
                    cPtr_typeGalgas_double * operand_13237 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_13237) ;
                    cPtr_typeGalgas_double * operand_13262 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_13262) ;
                    if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                    }else{
                      cPtr_typeGalgas_string * operand_13237 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_13237) ;
                      cPtr_typeGalgas_string * operand_13262 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_13262) ;
                      if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lbool * operand_13237 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_13237) ;
                        cPtr_typeGalgas_lbool * operand_13262 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_13262) ;
                        if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lchar * operand_13237 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_13237) ;
                          cPtr_typeGalgas_lchar * operand_13262 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_13262) ;
                          if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                          }else{
                            cPtr_typeGalgas_luint * operand_13237 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_13237) ;
                            cPtr_typeGalgas_luint * operand_13262 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_13262) ;
                            if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lsint * operand_13237 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_13237) ;
                              cPtr_typeGalgas_lsint * operand_13262 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_13262) ;
                              if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                              }else{
                                cPtr_typeGalgas_luint64 * operand_13237 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_13237) ;
                                cPtr_typeGalgas_luint64 * operand_13262 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_13262) ;
                                if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                                }else{
                                  cPtr_typeGalgas_lsint64 * operand_13237 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_13237) ;
                                  cPtr_typeGalgas_lsint64 * operand_13262 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_13262) ;
                                  if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                                  }else{
                                    cPtr_typeGalgas_ldouble * operand_13237 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_13237) ;
                                    cPtr_typeGalgas_ldouble * operand_13262 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_13262) ;
                                    if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                                    }else{
                                      cPtr_typeGalgas_lstring * operand_13237 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_13237) ;
                                      cPtr_typeGalgas_lstring * operand_13262 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_13262) ;
                                      if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                                      }else{
                                        cPtr_typeGalgas_location * operand_13237 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_13237) ;
                                        cPtr_typeGalgas_location * operand_13262 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_13262) ;
                                        if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                                        }else{
                                          cPtr_typeGalgas_filewrapper * operand_13237 = dynamic_cast <cPtr_typeGalgas_filewrapper *> (ptr_13237) ;
                                          cPtr_typeGalgas_filewrapper * operand_13262 = dynamic_cast <cPtr_typeGalgas_filewrapper *> (ptr_13262) ;
                                          if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                                          }else{
                                            cPtr_typeGalgas_enum * operand_13237 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_13237) ;
                                            cPtr_typeGalgas_enum * operand_13262 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_13262) ;
                                            if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                                              if (((operand_13237->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (335)))._operator_isNotEqual (operand_13262->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (335)))).isBuiltAndTrue ()) {
                                                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "comparison between an '@"))._operator_concat (operand_13237->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (336))))._operator_concat (GGS_string (true, "' enumeration and an '@")))._operator_concat (operand_13262->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (337))))._operator_concat (GGS_string (true, "' enumeration is not valid")) COMMA_SOURCE_FILE_AT_LINE (337)) ;
                                              }
                                            }else{
                                              cPtr_typeGalgasUndefinedListType * operand_13237 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_13237) ;
                                              cPtr_typeGalgasUndefinedListType * operand_13262 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_13262) ;
                                              if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                                                if (((operand_13237->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (340)))._operator_isNotEqual (operand_13262->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (340)))).isBuiltAndTrue ()) {
                                                  GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "I was expecting the list type '@"))._operator_concat (operand_13237->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (341))))._operator_concat (GGS_string (true, "', I have got the list type '@")))._operator_concat (operand_13262->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (342))))._operator_concat (GGS_string (true, "\"")) COMMA_SOURCE_FILE_AT_LINE (342)) ;
                                                }
                                              }else{
                                                cPtr_typeGalgasUndefinedMapType * operand_13237 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_13237) ;
                                                cPtr_typeGalgasUndefinedMapType * operand_13262 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_13262) ;
                                                if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                                                  if (((operand_13237->mMapTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (346)))._operator_isNotEqual (operand_13262->mMapTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (346)))).isBuiltAndTrue ()) {
                                                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "I was expecting the map type '@"))._operator_concat (operand_13237->mMapTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (347))))._operator_concat (GGS_string (true, "', I have got the map type '@")))._operator_concat (operand_13262->mMapTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (348))))._operator_concat (GGS_string (true, "\"")) COMMA_SOURCE_FILE_AT_LINE (348)) ;
                                                  }
                                                }else{
                                                  cPtr_typeGalgasUndefinedClassType * operand_13237 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_13237) ;
                                                  cPtr_typeGalgasUndefinedClassType * operand_13262 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_13262) ;
                                                  if ((operand_13237 != NULL) && (operand_13262 != NULL)) {
                                                    if (((operand_13237->mClassTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (353)))._operator_isNotEqual (operand_13262->mClassTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (353)))).isBuiltAndTrue ()) {
                                                      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "I was expecting the class type '@"))._operator_concat (operand_13237->mClassTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (354))))._operator_concat (GGS_string (true, "', I have got the class type '@")))._operator_concat (operand_13262->mClassTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (355))))._operator_concat (GGS_string (true, "\"")) COMMA_SOURCE_FILE_AT_LINE (355)) ;
                                                    }
                                                  }else{
...
void routine_magnitude_comparison_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_16607 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_16632 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_stringset * operand_16607 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_16607) ;
    cPtr_typeGalgas_stringset * operand_16632 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_16632) ;
    if ((operand_16607 != NULL) && (operand_16632 != NULL)) {
    }else{
      cPtr_typeGalgas_bool * operand_16607 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_16607) ;
      cPtr_typeGalgas_bool * operand_16632 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_16632) ;
      if ((operand_16607 != NULL) && (operand_16632 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_16607 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_16607) ;
        cPtr_typeGalgas_char * operand_16632 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_16632) ;
        if ((operand_16607 != NULL) && (operand_16632 != NULL)) {
        }else{
          cPtr_typeGalgas_uint * operand_16607 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_16607) ;
          cPtr_typeGalgas_uint * operand_16632 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_16632) ;
          if ((operand_16607 != NULL) && (operand_16632 != NULL)) {
          }else{
            cPtr_typeGalgas_sint * operand_16607 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_16607) ;
            cPtr_typeGalgas_sint * operand_16632 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_16632) ;
            if ((operand_16607 != NULL) && (operand_16632 != NULL)) {
            }else{
              cPtr_typeGalgas_uint64 * operand_16607 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_16607) ;
              cPtr_typeGalgas_uint64 * operand_16632 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_16632) ;
              if ((operand_16607 != NULL) && (operand_16632 != NULL)) {
              }else{
                cPtr_typeGalgas_sint64 * operand_16607 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_16607) ;
                cPtr_typeGalgas_sint64 * operand_16632 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_16632) ;
                if ((operand_16607 != NULL) && (operand_16632 != NULL)) {
                }else{
                  cPtr_typeGalgas_double * operand_16607 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_16607) ;
                  cPtr_typeGalgas_double * operand_16632 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_16632) ;
                  if ((operand_16607 != NULL) && (operand_16632 != NULL)) {
                  }else{
                    cPtr_typeGalgas_string * operand_16607 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_16607) ;
                    cPtr_typeGalgas_string * operand_16632 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_16632) ;
                    if ((operand_16607 != NULL) && (operand_16632 != NULL)) {
                    }else{
                      cPtr_typeGalgas_enum * operand_16607 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_16607) ;
                      cPtr_typeGalgas_enum * operand_16632 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_16632) ;
                      if ((operand_16607 != NULL) && (operand_16632 != NULL)) {
                        if (((operand_16607->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (384)))._operator_isNotEqual (operand_16632->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (384)))).isBuiltAndTrue ()) {
                          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "comparison between an '@"))._operator_concat (operand_16607->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (385))))._operator_concat (GGS_string (true, "' enumeration and an '@")))._operator_concat (operand_16632->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (386))))._operator_concat (GGS_string (true, "' enumeration is not valid")) COMMA_SOURCE_FILE_AT_LINE (386)) ;
                        }
                      }else{
...
void routine_left_shift_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_18265 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_18290 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_binaryset * operand_18265 = dynamic_cast <cPtr_typeGalgas_binaryset *> (ptr_18265) ;
    cPtr_typeGalgas_uint * operand_18290 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18290) ;
    if ((operand_18265 != NULL) && (operand_18290 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      ...
      if ((operand_18265 != NULL) && (operand_18290 != NULL)) {
        ...
        cPtr_typeGalgas_sint * operand_18265 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_18265) ;
        cPtr_typeGalgas_uint * operand_18290 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18290) ;
        if ((operand_18265 != NULL) && (operand_18290 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_uint64 * operand_18265 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_18265) ;
          cPtr_typeGalgas_uint * operand_18290 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18290) ;
          if ((operand_18265 != NULL) && (operand_18290 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_sint64 * operand_18265 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_18265) ;
            cPtr_typeGalgas_uint * operand_18290 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18290) ;
            if ((operand_18265 != NULL) && (operand_18290 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
...
void routine_right_shift_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_19271 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_19296 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_binaryset * operand_19271 = dynamic_cast <cPtr_typeGalgas_binaryset *> (ptr_19271) ;
    cPtr_typeGalgas_uint * operand_19296 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_19296) ;
    if ((operand_19271 != NULL) && (operand_19296 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      ...
      if ((operand_19271 != NULL) && (operand_19296 != NULL)) {
        ...
        cPtr_typeGalgas_sint * operand_19271 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_19271) ;
        cPtr_typeGalgas_uint * operand_19296 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_19296) ;
        if ((operand_19271 != NULL) && (operand_19296 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_uint64 * operand_19271 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_19271) ;
          cPtr_typeGalgas_uint * operand_19296 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_19296) ;
          if ((operand_19271 != NULL) && (operand_19296 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_sint64 * operand_19271 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_19271) ;
            cPtr_typeGalgas_uint * operand_19296 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_19296) ;
            if ((operand_19271 != NULL) && (operand_19296 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
...
void routine_addition_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_20586 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_20611 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_20586 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_20586) ;
    cPtr_typeGalgas_uint * operand_20611 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_20611) ;
    if ((operand_20586 != NULL) && (operand_20611 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_20586 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_20586) ;
      cPtr_typeGalgas_sint * operand_20611 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_20611) ;
      if ((operand_20586 != NULL) && (operand_20611 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_20586 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_20586) ;
        cPtr_typeGalgas_uint64 * operand_20611 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_20611) ;
        if ((operand_20586 != NULL) && (operand_20611 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_20586 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_20586) ;
          cPtr_typeGalgas_sint64 * operand_20611 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_20611) ;
          if ((operand_20586 != NULL) && (operand_20611 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_substraction_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_21811 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_21836 = var_cas_inRightExpressionType (HERE) ;
    ...
    if ((operand_21811 != NULL) && (operand_21836 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      ...
      if ((operand_21811 != NULL) && (operand_21836 != NULL)) {
        ...
        if ((operand_21811 != NULL) && (operand_21836 != NULL)) {
          ...
          if ((operand_21811 != NULL) && (operand_21836 != NULL)) {
            ...
            cPtr_typeGalgas_stringset * operand_21836 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_21836) ;
            if ((operand_21811 != NULL) && (operand_21836 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
...
void routine_multiply_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_23142 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_23167 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_23142 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_23142) ;
    cPtr_typeGalgas_uint * operand_23167 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_23167) ;
    if ((operand_23142 != NULL) && (operand_23167 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_23142 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_23142) ;
      cPtr_typeGalgas_sint * operand_23167 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_23167) ;
      if ((operand_23142 != NULL) && (operand_23167 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_23142 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_23142) ;
        cPtr_typeGalgas_uint64 * operand_23167 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_23167) ;
        if ((operand_23142 != NULL) && (operand_23167 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_23142 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_23142) ;
          cPtr_typeGalgas_sint64 * operand_23167 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_23167) ;
          if ((operand_23142 != NULL) && (operand_23167 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_divide_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_24367 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_24392 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_24367 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_24367) ;
    cPtr_typeGalgas_uint * operand_24392 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_24392) ;
    if ((operand_24367 != NULL) && (operand_24392 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_24367 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_24367) ;
      cPtr_typeGalgas_sint * operand_24392 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_24392) ;
      if ((operand_24367 != NULL) && (operand_24392 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_24367 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_24367) ;
        cPtr_typeGalgas_uint64 * operand_24392 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_24392) ;
        if ((operand_24367 != NULL) && (operand_24392 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_24367 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_24367) ;
          cPtr_typeGalgas_sint64 * operand_24392 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_24392) ;
          if ((operand_24367 != NULL) && (operand_24392 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_modulo_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_25586 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_25611 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_25586 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_25586) ;
    cPtr_typeGalgas_uint * operand_25611 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_25611) ;
    if ((operand_25586 != NULL) && (operand_25611 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_25586 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_25586) ;
      cPtr_typeGalgas_sint * operand_25611 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_25611) ;
      if ((operand_25586 != NULL) && (operand_25611 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_25586 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_25586) ;
        cPtr_typeGalgas_uint64 * operand_25611 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_25611) ;
        if ((operand_25586 != NULL) && (operand_25611 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_25586 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_25586) ;
          cPtr_typeGalgas_sint64 * operand_25611 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_25611) ;
          if ((operand_25586 != NULL) && (operand_25611 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_unary_minus_type_check (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_AC_galgasType _var_27036 = var_cas_inExpressionType ; // CAST instruction
    if (_var_27036.getPtr () != NULL) {
      macroValidPointer (_var_27036.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgas_sint *> (_var_27036.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inExpressionType ;
      }else if (dynamic_cast <cPtr_typeGalgas_sint64 *> (_var_27036.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inExpressionType ;
      }else{
...
pr_factor_expression_parser_1138_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_expression_parser_6 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_M_semanticsEntitiesForUse  _temp_45919 = var_cas_ioEntitiesMap ;
      if (_temp_45919._isBuilt ()) {
        _temp_45919 (HERE)->method_searchKey (_inLexique, var_cas_castedTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1184)) ;
      }
      ...
      const GGS_AC_galgasType  _temp_47653 = var_cas_errorLocationExpressionType ;
      if (_temp_47653._isBuilt ()) {
        _temp_47653 (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1216)) ;
      }
...
pr_factor_expression_parser_1502_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_expression_parser_9 (_inLexique)) {
    case 1 : {
      ...
      const GGS_M_filewrappers  _temp_60179 = var_cas_inSemanticContext.reader_mFilewrappers (_inLexique COMMA_SOURCE_FILE_AT_LINE (1519)) ;
      if (_temp_60179._isBuilt ()) {
        _temp_60179 (HERE)->method_searchKey (_inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1519)) ;
      }
        ...
        case 2 : {
          ...
          switch (select_expression_parser_11 (_inLexique)) {
            case 1 : {
              ...
              const GGS_filewrapperTemplateMap  _temp_60611 = var_cas_templateMap ;
              if (_temp_60611._isBuilt ()) {
                _temp_60611 (HERE)->method_searchKey (_inLexique, var_cas_templateName, var_cas_formalAttributeList COMMA_SOURCE_FILE_AT_LINE (1531)) ;
              }
            ...
            case 2 : {
              ...
              const GGS_M_regularFiles  _temp_61283 = var_cas_regularFileMap ;
              if (_temp_61283._isBuilt ()) {
                _temp_61283 (HERE)->method_searchKey (_inLexique, var_cas_path, automatic_var_1, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1551)) ;
              }
    ...
    case 3 : {
      ...
      const GGS_M_semanticsEntitiesForUse  _temp_62950 = var_cas_ioEntitiesMap ;
      if (_temp_62950._isBuilt ()) {
        _temp_62950 (HERE)->method_searchKey (_inLexique, var_cas_className, var_cas_e COMMA_SOURCE_FILE_AT_LINE (1600)) ;
      }
      ...
      const GGS_AC_galgasType  _temp_63145 = var_cas_outResultType ;
      if (_temp_63145._isBuilt ()) {
        _temp_63145 (HERE)->method_handleConstructorCall (_inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques COMMA_SOURCE_FILE_AT_LINE (1603)) ;
      }
      GGS_typeExpressionList  var_cas_expressionList ;
    ...
    case 4 : {
      ...
      switch (select_expression_parser_13 (_inLexique)) {
        ...
        case 2 : {
          ...
          const GGS_M_optionComponents  _temp_64252 = var_cas_inOptionsComponentsMapForUse ;
          if (_temp_64252._isBuilt ()) {
            _temp_64252 (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1636)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E) COMMA_HERE) ;
          GGS_lstring  var_cas_optionName ;
          _inLexique._assignFromAttribute_tokenString (var_cas_optionName) ;
...
pr_output_expression_list_expression_parser_1702_4_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inFormalAttributesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1731)))._operator_strictInf (var_cas_effectiveTypesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1731)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_typeListeAttributsSemantiques::cEnumerator enumerator_68422 (var_cas_inFormalAttributesList, true) ;
      const GGS_typeListeAttributsSemantiques::cElement * operand_68422 = NULL ;
      GGS_typeTypesList::cEnumerator enumerator_68505 (var_cas_effectiveTypesList, true) ;
      const GGS_typeTypesList::cElement * operand_68505 = NULL ;
      while (((operand_68422 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_68422.nextObject ()))
          && ((operand_68505 = enumerator_68505.nextObject ()))) {
        macroValidPointer (operand_68422) ;
        macroValidPointer (operand_68505) ;
        ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_68422->mAttributType,  operand_68505->mType,  operand_68505->mEndOfExpressionLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (1737)) ;
      }
    }
  }
}
        ...
        case 2 : {
          switch (select_expression_parser_16 (_inLexique)) {
            ...
            case 3 : {
              ...
              GGS_uint _variant_70123 = var_cas_jokerCount._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (1776)) ;
              GGS_bool _condition_70123 (_variant_70123._isBuilt (), true) ;
              while (_condition_70123.isBuiltAndTrue ()) {
                _condition_70123 = (var_cas_jokerCount)._operator_strictSup (GGS_uint (true, 0U)) ;
                if (_condition_70123.isBuiltAndTrue ()) {
                  if (_variant_70123.uintValue () == 0) {
                    _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1779)) ;
                    _condition_70123 = GGS_bool (true, false) ;
                  }else{
                    _variant_70123._decrement_operation (_inLexique COMMA_HERE) ;
                    var_cas_argumentsList._addAssign_operation (GGS_lstring ::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE), GGS_lstring ::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
