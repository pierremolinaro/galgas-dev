...
pr_factor_expression_parser_1635_13_ (galgas_scanner & inLexique,
  ...
  const GGS_M_semanticsEntitiesForUse  temp_63924 = var_cas_inEntitiesMap ;
  if (temp_63924.isBuilt ()) {
    temp_63924 (HERE)->method_searchKey (inLexique, var_cas_typeName, var_cas_e COMMA_SOURCE_FILE_AT_LINE (1648)) ;
  }
  GGS_AC_galgasType  var_cas_type = GGS_typeEntiteType::castFrom (inLexique, var_cas_e.getPtr (), true, var_cas_typeName COMMA_SOURCE_FILE_AT_LINE (1649)).reader_aDefType (inLexique COMMA_SOURCE_FILE_AT_LINE (1649)) ;
  ...
  const GGS_AC_galgasType  temp_64256 = var_cas_type ;
  if (temp_64256.isBuilt ()) {
    temp_64256 (HERE)->method_handleConstructorInvocation (inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques, var_cas_hasLexiqueAndLocationArguments, var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1655)) ;
  }
  GGS_typeExpressionList  var_cas_expressionList ;
  ...
  var_cas_outExpression = GGS_typeConstructorExpression ::constructor_new (inLexique, var_cas_type, var_cas_mClassMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1668)), var_cas_hasLexiqueAndLocationArguments, var_cas_expressionList COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5D_) COMMA_HERE) ;
}
...
pr_factor_expression_parser_1684_13_ (galgas_scanner & inLexique,
  ...
  switch (select_expression_parser_10 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      const GGS_bool cond_65936 = (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1698))).operator_isNotEqual (GGS_string ("verbose_output")) ;
      if (cond_65936.isBuiltAndTrue ()) {
    ...
    case 2 : {
      ...
      const GGS_M_optionComponents  temp_66303 = var_cas_inOptionsComponentsMapForUse ;
      if (temp_66303.isBuilt ()) {
        temp_66303 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1709)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E_) COMMA_HERE) ;
      GGS_lstring  var_cas_optionName ;
      inLexique.assignFromAttribute_tokenString (var_cas_optionName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      const GGS_bool cond_66648 = var_cas_boolOptionsMap.reader_hasKey (inLexique, var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1713)) COMMA_SOURCE_FILE_AT_LINE (1713)) ;
      if (cond_66648.isBuiltAndTrue ()) {
        ...
        var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_HERE) ;
      }else if (cond_66648.isBuiltAndFalse ()) {
        const GGS_bool cond_66845 = var_cas_uintOptionsMap.reader_hasKey (inLexique, var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1716)) COMMA_SOURCE_FILE_AT_LINE (1716)) ;
        if (cond_66845.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_67047 = var_cas_stringOptionsMap.reader_hasKey (inLexique, var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1719)) COMMA_SOURCE_FILE_AT_LINE (1719)) ;
          if (cond_67047.isBuiltAndTrue ()) {
            ...
            var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
          }else if (cond_67047.isBuiltAndFalse ()) {
...
pr_factor_expression_parser_1740_13_ (galgas_scanner & inLexique,
  ...
  const GGS_M_filewrappers  temp_68491 = var_cas_inSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (1755)) ;
  if (temp_68491.isBuilt ()) {
    temp_68491 (HERE)->method_searchKey (inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1755)) ;
  }
    ...
    case 2 : {
      ...
      switch (select_expression_parser_12 (inLexique)) {
        case 1 : {
          ...
          const GGS_filewrapperTemplateMap  temp_68899 = var_cas_templateMap ;
          if (temp_68899.isBuilt ()) {
            temp_68899 (HERE)->method_searchKey (inLexique, var_cas_templateName, var_cas_formalAttributeList COMMA_SOURCE_FILE_AT_LINE (1767)) ;
          }
          GGS_typeExpressionList  var_cas_expressionList ;
        ...
        case 2 : {
          ...
          const GGS_M_regularFiles  temp_69531 = var_cas_regularFileMap ;
          if (temp_69531.isBuilt ()) {
            temp_69531 (HERE)->method_searchKey (inLexique, var_cas_path, automatic_var_1, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1787)) ;
          }
...
pr_factor_expression_parser_1802_13_ (galgas_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_70687 = var_cas_inEntitiesMap ;
  if (temp_70687.isBuilt ()) {
    temp_70687 (HERE)->method_searchKey (inLexique, var_cas_functionName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1815)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_71267 = var_cas_entite ; // CAST instruction
    if (_var_71267.getPtr () != NULL) {
      macroValidPointer (_var_71267.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteFonction *> (_var_71267.getPtr ()) != NULL) {
        const GGS_typeEntiteFonction var_cas_r (_var_71267.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeEntiteFonctionExterne *> (_var_71267.getPtr ()) != NULL) {
        const GGS_typeEntiteFonctionExterne var_cas_ae (_var_71267.getPtr ()) ;
  ...
  {
    GGS_L_EXsignature::cEnumerator enumerator_71435 (var_cas_signatureRoutine, true) ;
    const GGS_L_EXsignature::cElement * operand_71435 = NULL ;
    while (((operand_71435 = enumerator_71435.nextObject ()))) {
      macroValidPointer (operand_71435) ;
      var_cas_listeAttributsSemantiques.addAssign_operation (operand_71435->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  nt_output_expression_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
...
pr_read_access_expression_parser_1873_18_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_73236 = var_cas_ioVariablesMap.reader_hasKey (inLexique, GGS_string ("self") COMMA_SOURCE_FILE_AT_LINE (1880)) ;
  if (cond_73236.isBuiltAndTrue ()) {
  ...
  }else if (cond_73236.isBuiltAndFalse ()) {
...
pr_output_expression_list_expression_parser_1895_29_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_74797 = (var_cas_inFormalAttributesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1924))).operator_strictInf (var_cas_effectiveTypesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1924))) ;
  if (cond_74797.isBuiltAndTrue ()) {
  ...
  }else if (cond_74797.isBuiltAndFalse ()) {
    const GGS_bool cond_74937 = (var_cas_inFormalAttributesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1926))).operator_strictSup (var_cas_effectiveTypesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1926))) ;
    if (cond_74937.isBuiltAndTrue ()) {
    ...
    }else if (cond_74937.isBuiltAndFalse ()) {
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_74972 (var_cas_inFormalAttributesList, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_74972 = NULL ;
        GGS_typeTypesList::cEnumerator enumerator_74992 (var_cas_effectiveTypesList, true) ;
        const GGS_typeTypesList::cElement * operand_74992 = NULL ;
        while (((operand_74972 = enumerator_74972.nextObject ()))
            && ((operand_74992 = enumerator_74992.nextObject ()))) {
          macroValidPointer (operand_74972) ;
          macroValidPointer (operand_74992) ;
          ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_74972->mAttributType,  operand_74992->mType,  operand_74992->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1930)) ;
        }
      }
    }
  }
...
void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_1941_44_ (galgas_scanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
        ...
        case 2 : {
          switch (select_expression_parser_15 (inLexique)) {
            ...
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2A_) COMMA_HERE) ;
              GGS_uint  var_cas_jokerCount = var_cas_jokerCountWithLocation.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1968)) ;
              GGS_uint _variant_76565 = var_cas_jokerCount.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1969)) ;
              GGS_bool _condition_76565 (_variant_76565.isBuilt (), true) ;
              while (_condition_76565.isBuiltAndTrue ()) {
                _condition_76565 = (var_cas_jokerCount).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_76565.isBuiltAndTrue ()) {
                  if (_variant_76565.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1973)) ;
                    _condition_76565 = GGS_bool (false) ;
                  }else{
                    _variant_76565.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_argumentsList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
                    var_cas_jokerCount.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1972)) ;
                  }
                }
              }
              } break ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__29_) COMMA_HERE) ;
  ::routine_buildMapWithLocalConstants (inLexique,  var_cas_inEnumeratorNewStyle,  var_cas_argumentsList,  var_cas_inFormalArgumentsList,  var_cas_ioVariablesMap,  var_cas_inVarLocation,  var_cas_inLocalConstantStyle,  var_cas_ellipsisFound COMMA_SOURCE_FILE_AT_LINE (1985)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_1941_44_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28_) COMMA_HERE) ;
  { bool syntaxRepeat_14 = true ;
    while (syntaxRepeat_14) {
      switch (select_expression_parser_14 (inLexique)) {
