...
pr_factor_expression_parser_769_14_ (galgas_scanner & lexique_var_,
  ...
  switch (select_expression_parser_4 (lexique_var_)) {
    ...
    case 2 : {
      ...
      var_cas_ioEntitiesMap.methode_searchKey (lexique_var_, var_cas_className, var_cas_e) ;
...
pr_output_expression_list_expression_parser_876_30_ (galgas_scanner & lexique_var_,
  ...
  if (((var_cas_inFormalAttributesList.reader_length ()) < (var_cas_effectiveTypesList.reader_length ())).isBuiltAndTrue ()) {
    ...
    while ((operand_34203 != NULL)
      ...
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_34203->mAttributType,  operand_34298->mType,  operand_34298->mEndOfExpressionLocation) ;
