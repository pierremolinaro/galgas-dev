                                    ...
                                    if ((operand_12735 != NULL) && (operand_12760 != NULL)) {
                                      ...
                                      if ((operand_12735 != NULL) && (operand_12760 != NULL)) {
                                        ...
                                        if ((operand_12735 != NULL) && (operand_12760 != NULL)) {
                                          ...
                                          if ((operand_12735 != NULL) && (operand_12760 != NULL)) {
                                            if (((operand_12735->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (328)))._operator_isNotEqual (operand_12760->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (328)))).isBuiltAndTrue ()) {
                                              GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "comparison between an '@"))._operator_concat (operand_12735->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (329))))._operator_concat (GGS_string (true, "' enumeration and an '@")))._operator_concat (operand_12760->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (330))))._operator_concat (GGS_string (true, "' enumeration is not valid")) COMMA_SOURCE_FILE_AT_LINE (330)) ;
                                            }
                                          }else{
                                            ...
                                            if ((operand_12735 != NULL) && (operand_12760 != NULL)) {
                                              if (((operand_12735->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (333)))._operator_isNotEqual (operand_12760->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (333)))).isBuiltAndTrue ()) {
                                                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "I was expecting the list type '@"))._operator_concat (operand_12735->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (334))))._operator_concat (GGS_string (true, "', I have got the list type '@")))._operator_concat (operand_12760->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (335))))._operator_concat (GGS_string (true, "\"")) COMMA_SOURCE_FILE_AT_LINE (335)) ;
                                              }
                                            }else{
                                              ...
                                              if ((operand_12735 != NULL) && (operand_12760 != NULL)) {
                                                if (((operand_12735->mMapTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (339)))._operator_isNotEqual (operand_12760->mMapTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (339)))).isBuiltAndTrue ()) {
                                                  GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "I was expecting the map type '@"))._operator_concat (operand_12735->mMapTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (340))))._operator_concat (GGS_string (true, "', I have got the map type '@")))._operator_concat (operand_12760->mMapTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (341))))._operator_concat (GGS_string (true, "\"")) COMMA_SOURCE_FILE_AT_LINE (341)) ;
                                                }
                                              }else{
                                                ...
                                                if ((operand_12735 != NULL) && (operand_12760 != NULL)) {
                                                  if (((operand_12735->mClassTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (346)))._operator_isNotEqual (operand_12760->mClassTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (346)))).isBuiltAndTrue ()) {
                                                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "I was expecting the class type '@"))._operator_concat (operand_12735->mClassTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (347))))._operator_concat (GGS_string (true, "', I have got the class type '@")))._operator_concat (operand_12760->mClassTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (348))))._operator_concat (GGS_string (true, "\"")) COMMA_SOURCE_FILE_AT_LINE (348)) ;
                                                  }
                                                }else{
                                                  GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "comparison between "))._operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (351))))._operator_concat (GGS_string (true, " and ")))._operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (352))))._operator_concat (GGS_string (true, " is not valid")) COMMA_SOURCE_FILE_AT_LINE (352)) ;
                                                }
                                              }
                                            }
                                          }
...
void routine_magnitude_comparison_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_16001 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_16026 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_stringset * operand_16001 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_16001) ;
    cPtr_typeGalgas_stringset * operand_16026 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_16026) ;
    if ((operand_16001 != NULL) && (operand_16026 != NULL)) {
    }else{
      cPtr_typeGalgas_bool * operand_16001 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_16001) ;
      cPtr_typeGalgas_bool * operand_16026 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_16026) ;
      if ((operand_16001 != NULL) && (operand_16026 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_16001 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_16001) ;
        cPtr_typeGalgas_char * operand_16026 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_16026) ;
        if ((operand_16001 != NULL) && (operand_16026 != NULL)) {
        }else{
          cPtr_typeGalgas_uint * operand_16001 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_16001) ;
          cPtr_typeGalgas_uint * operand_16026 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_16026) ;
          if ((operand_16001 != NULL) && (operand_16026 != NULL)) {
          }else{
            cPtr_typeGalgas_sint * operand_16001 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_16001) ;
            cPtr_typeGalgas_sint * operand_16026 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_16026) ;
            if ((operand_16001 != NULL) && (operand_16026 != NULL)) {
            }else{
              cPtr_typeGalgas_uint64 * operand_16001 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_16001) ;
              cPtr_typeGalgas_uint64 * operand_16026 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_16026) ;
              if ((operand_16001 != NULL) && (operand_16026 != NULL)) {
              }else{
                cPtr_typeGalgas_sint64 * operand_16001 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_16001) ;
                cPtr_typeGalgas_sint64 * operand_16026 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_16026) ;
                if ((operand_16001 != NULL) && (operand_16026 != NULL)) {
                }else{
                  cPtr_typeGalgas_double * operand_16001 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_16001) ;
                  cPtr_typeGalgas_double * operand_16026 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_16026) ;
                  if ((operand_16001 != NULL) && (operand_16026 != NULL)) {
                  }else{
                    cPtr_typeGalgas_string * operand_16001 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_16001) ;
                    cPtr_typeGalgas_string * operand_16026 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_16026) ;
                    if ((operand_16001 != NULL) && (operand_16026 != NULL)) {
                    }else{
                      cPtr_typeGalgas_enum * operand_16001 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_16001) ;
                      cPtr_typeGalgas_enum * operand_16026 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_16026) ;
                      if ((operand_16001 != NULL) && (operand_16026 != NULL)) {
                        if (((operand_16001->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (377)))._operator_isNotEqual (operand_16026->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (377)))).isBuiltAndTrue ()) {
                          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "comparison between an '@"))._operator_concat (operand_16001->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (378))))._operator_concat (GGS_string (true, "' enumeration and an '@")))._operator_concat (operand_16026->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (379))))._operator_concat (GGS_string (true, "' enumeration is not valid")) COMMA_SOURCE_FILE_AT_LINE (379)) ;
                        }
                      }else{
                        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "comparison between "))._operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (382))))._operator_concat (GGS_string (true, " and ")))._operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (383))))._operator_concat (GGS_string (true, " is not valid")) COMMA_SOURCE_FILE_AT_LINE (383)) ;
                      }
                    }
                  }
                }
...
void routine_left_shift_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_17659 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_17684 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_binaryset * operand_17659 = dynamic_cast <cPtr_typeGalgas_binaryset *> (ptr_17659) ;
    cPtr_typeGalgas_uint * operand_17684 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17684) ;
    if ((operand_17659 != NULL) && (operand_17684 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_uint * operand_17659 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17659) ;
      cPtr_typeGalgas_uint * operand_17684 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17684) ;
      if ((operand_17659 != NULL) && (operand_17684 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_sint * operand_17659 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_17659) ;
        cPtr_typeGalgas_uint * operand_17684 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17684) ;
        if ((operand_17659 != NULL) && (operand_17684 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_uint64 * operand_17659 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_17659) ;
          cPtr_typeGalgas_uint * operand_17684 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17684) ;
          if ((operand_17659 != NULL) && (operand_17684 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_sint64 * operand_17659 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_17659) ;
            cPtr_typeGalgas_uint * operand_17684 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17684) ;
            if ((operand_17659 != NULL) && (operand_17684 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
              GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "shift between "))._operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (410))))._operator_concat (GGS_string (true, " and ")))._operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (411))))._operator_concat (GGS_string (true, " is not valid")) COMMA_SOURCE_FILE_AT_LINE (413)) ;
              var_cas_outResultType._drop_operation () ;
            }
          }
        }
...
void routine_right_shift_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_18665 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_18690 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_binaryset * operand_18665 = dynamic_cast <cPtr_typeGalgas_binaryset *> (ptr_18665) ;
    cPtr_typeGalgas_uint * operand_18690 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18690) ;
    if ((operand_18665 != NULL) && (operand_18690 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_uint * operand_18665 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18665) ;
      cPtr_typeGalgas_uint * operand_18690 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18690) ;
      if ((operand_18665 != NULL) && (operand_18690 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_sint * operand_18665 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_18665) ;
        cPtr_typeGalgas_uint * operand_18690 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18690) ;
        if ((operand_18665 != NULL) && (operand_18690 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_uint64 * operand_18665 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_18665) ;
          cPtr_typeGalgas_uint * operand_18690 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18690) ;
          if ((operand_18665 != NULL) && (operand_18690 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_sint64 * operand_18665 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_18665) ;
            cPtr_typeGalgas_uint * operand_18690 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18690) ;
            if ((operand_18665 != NULL) && (operand_18690 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
              GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "shift between "))._operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (436))))._operator_concat (GGS_string (true, " and ")))._operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (437))))._operator_concat (GGS_string (true, " is not valid")) COMMA_SOURCE_FILE_AT_LINE (439)) ;
              var_cas_outResultType._drop_operation () ;
            }
          }
        }
...
void routine_addition_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_19980 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_20005 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_19980 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_19980) ;
    cPtr_typeGalgas_uint * operand_20005 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_20005) ;
    if ((operand_19980 != NULL) && (operand_20005 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_19980 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_19980) ;
      cPtr_typeGalgas_sint * operand_20005 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_20005) ;
      if ((operand_19980 != NULL) && (operand_20005 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_19980 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_19980) ;
        cPtr_typeGalgas_uint64 * operand_20005 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_20005) ;
        if ((operand_19980 != NULL) && (operand_20005 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_19980 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_19980) ;
          cPtr_typeGalgas_sint64 * operand_20005 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_20005) ;
          if ((operand_19980 != NULL) && (operand_20005 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "addition between "))._operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (464))))._operator_concat (GGS_string (true, " and ")))._operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (465))))._operator_concat (GGS_string (true, " is not valid")) COMMA_SOURCE_FILE_AT_LINE (467)) ;
            var_cas_outResultType._drop_operation () ;
          }
        }
      }
...
void routine_substraction_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_21205 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_21230 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_21205 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_21205) ;
    cPtr_typeGalgas_uint * operand_21230 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_21230) ;
    if ((operand_21205 != NULL) && (operand_21230 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_21205 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_21205) ;
      cPtr_typeGalgas_sint * operand_21230 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_21230) ;
      if ((operand_21205 != NULL) && (operand_21230 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_21205 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_21205) ;
        cPtr_typeGalgas_uint64 * operand_21230 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_21230) ;
        if ((operand_21205 != NULL) && (operand_21230 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_21205 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_21205) ;
          cPtr_typeGalgas_sint64 * operand_21230 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_21230) ;
          if ((operand_21205 != NULL) && (operand_21230 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_stringset * operand_21205 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_21205) ;
            cPtr_typeGalgas_stringset * operand_21230 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_21230) ;
            if ((operand_21205 != NULL) && (operand_21230 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
              GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "substraction between "))._operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (494))))._operator_concat (GGS_string (true, " and ")))._operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (495))))._operator_concat (GGS_string (true, " is not valid")) COMMA_SOURCE_FILE_AT_LINE (497)) ;
              var_cas_outResultType._drop_operation () ;
            }
          }
        }
...
void routine_multiply_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_22536 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_22561 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_22536 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_22536) ;
    cPtr_typeGalgas_uint * operand_22561 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_22561) ;
    if ((operand_22536 != NULL) && (operand_22561 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_22536 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_22536) ;
      cPtr_typeGalgas_sint * operand_22561 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_22561) ;
      if ((operand_22536 != NULL) && (operand_22561 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_22536 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_22536) ;
        cPtr_typeGalgas_uint64 * operand_22561 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_22561) ;
        if ((operand_22536 != NULL) && (operand_22561 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_22536 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_22536) ;
          cPtr_typeGalgas_sint64 * operand_22561 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_22561) ;
          if ((operand_22536 != NULL) && (operand_22561 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "multiplication between "))._operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (522))))._operator_concat (GGS_string (true, " and ")))._operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (523))))._operator_concat (GGS_string (true, " is not valid")) COMMA_SOURCE_FILE_AT_LINE (525)) ;
            var_cas_outResultType._drop_operation () ;
          }
        }
      }
...
void routine_divide_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_23761 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_23786 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_23761 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_23761) ;
    cPtr_typeGalgas_uint * operand_23786 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_23786) ;
    if ((operand_23761 != NULL) && (operand_23786 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_23761 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_23761) ;
      cPtr_typeGalgas_sint * operand_23786 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_23786) ;
      if ((operand_23761 != NULL) && (operand_23786 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_23761 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_23761) ;
        cPtr_typeGalgas_uint64 * operand_23786 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_23786) ;
        if ((operand_23761 != NULL) && (operand_23786 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_23761 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_23761) ;
          cPtr_typeGalgas_sint64 * operand_23786 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_23786) ;
          if ((operand_23761 != NULL) && (operand_23786 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "division between "))._operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (550))))._operator_concat (GGS_string (true, " and ")))._operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (551))))._operator_concat (GGS_string (true, " is not valid")) COMMA_SOURCE_FILE_AT_LINE (553)) ;
            var_cas_outResultType._drop_operation () ;
          }
        }
      }
...
void routine_modulo_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_24980 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_25005 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_24980 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_24980) ;
    cPtr_typeGalgas_uint * operand_25005 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_25005) ;
    if ((operand_24980 != NULL) && (operand_25005 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_24980 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_24980) ;
      cPtr_typeGalgas_sint * operand_25005 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_25005) ;
      if ((operand_24980 != NULL) && (operand_25005 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_24980 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_24980) ;
        cPtr_typeGalgas_uint64 * operand_25005 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_25005) ;
        if ((operand_24980 != NULL) && (operand_25005 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_24980 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_24980) ;
          cPtr_typeGalgas_sint64 * operand_25005 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_25005) ;
          if ((operand_24980 != NULL) && (operand_25005 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "modulo between "))._operator_concat (var_cas_inLeftExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (578))))._operator_concat (GGS_string (true, " and ")))._operator_concat (var_cas_inRightExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (579))))._operator_concat (GGS_string (true, " is not valid")) COMMA_SOURCE_FILE_AT_LINE (581)) ;
            var_cas_outResultType._drop_operation () ;
          }
        }
      }
...
void routine_unary_minus_type_check (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_AC_galgasType _var_26430 = var_cas_inExpressionType ; // CAST instruction
    if (_var_26430.getPtr () != NULL) {
      macroValidPointer (_var_26430.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgas_sint *> (_var_26430.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inExpressionType ;
      }else if (dynamic_cast <cPtr_typeGalgas_sint64 *> (_var_26430.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inExpressionType ;
      }else{
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "unary minus for "))._operator_concat (var_cas_inExpressionType.reader_messageGalgasType (_inLexique COMMA_SOURCE_FILE_AT_LINE (601))))._operator_concat (GGS_string (true, " is not valid")) COMMA_SOURCE_FILE_AT_LINE (604)) ;
        var_cas_outResultType._drop_operation () ;
      }
    }
  }
...
expression_parser::
pr_expression_expression_parser_614_4_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_expression_parser_0 (_inLexique)) {
        case 2 : {
          ...
          ::routine_matchConcatOperator (_inLexique,  var_cas_firstOperandType,  var_cas_secondOperandType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (646)) ;
          } break ;
        default :
...
void expression_parser::
pr_expression_expression_parser_614_4_parse (galgas_scanner & _inLexique) {
...
void expression_parser::
expression_parser::
pr_concatenation_term_expression_parser_661_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_M_filewrappers  var_cas_inFileWrappers,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
    ...
    while (syntaxRepeat_1) {
      switch (select_repeat_expression_parser_1 (_inLexique)) {
        case 2 : {
          ...
          ::routine_matchOrOperator (_inLexique,  var_cas_firstOperandType,  var_cas_secondOperandType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (693)) ;
          } break ;
        case 3 : {
          GGS_location  var_cas_operatorLocation ;
          var_cas_operatorLocation = GGS_location (_inLexique) ;
          ...
          ::routine_matchXorOperator (_inLexique,  var_cas_firstOperandType,  var_cas_secondOperandType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (714)) ;
          } break ;
        default :
...
void expression_parser::
pr_concatenation_term_expression_parser_661_4_parse (galgas_scanner & _inLexique) {
...
void expression_parser::
expression_parser::
pr_relation_term_expression_parser_729_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_M_filewrappers  var_cas_inFileWrappers,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
    ...
    while (syntaxRepeat_2) {
      switch (select_repeat_expression_parser_2 (_inLexique)) {
        case 2 : {
          ...
          ::routine_matchAndOperator (_inLexique,  var_cas_firstOperandType,  var_cas_secondOperandType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (761)) ;
          } break ;
        default :
...
void expression_parser::
pr_relation_term_expression_parser_729_4_parse (galgas_scanner & _inLexique) {
...
void expression_parser::
expression_parser::
pr_relation_factor_expression_parser_776_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_M_filewrappers  var_cas_inFileWrappers,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  switch (select_expression_parser_3 (_inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_comparison_types_check (_inLexique,  var_cas_leftType,  var_cas_rightType COMMA_SOURCE_FILE_AT_LINE (806)) ;
    ...
    case 3 : {
      ...
      GGS_AC_galgasType  var_cas_rightType ;
      nt_simple_expression_ (_inLexique, var_cas_ioEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inFileWrappers, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
      ::routine_comparison_types_check (_inLexique,  var_cas_leftType,  var_cas_rightType COMMA_SOURCE_FILE_AT_LINE (824)) ;
    ...
    case 4 : {
      ...
      GGS_AC_galgasType  var_cas_rightType ;
      nt_simple_expression_ (_inLexique, var_cas_ioEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inFileWrappers, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
      ::routine_magnitude_comparison_types_check (_inLexique,  var_cas_leftType,  var_cas_rightType COMMA_SOURCE_FILE_AT_LINE (842)) ;
    ...
    case 6 : {
      ...
      GGS_AC_galgasType  var_cas_rightType ;
      nt_simple_expression_ (_inLexique, var_cas_ioEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inFileWrappers, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
      ::routine_magnitude_comparison_types_check (_inLexique,  var_cas_leftType,  var_cas_rightType COMMA_SOURCE_FILE_AT_LINE (878)) ;
    ...
    case 7 : {
      ...
      GGS_AC_galgasType  var_cas_rightType ;
      nt_simple_expression_ (_inLexique, var_cas_ioEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inFileWrappers, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
      ::routine_magnitude_comparison_types_check (_inLexique,  var_cas_leftType,  var_cas_rightType COMMA_SOURCE_FILE_AT_LINE (896)) ;
...
void expression_parser::
pr_relation_factor_expression_parser_776_4_parse (galgas_scanner & _inLexique) {
...
void expression_parser::
expression_parser::
pr_simple_expression_expression_parser_909_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_M_filewrappers  var_cas_inFileWrappers,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
    ...
    while (syntaxRepeat_4) {
      switch (select_repeat_expression_parser_4 (_inLexique)) {
        case 2 : {
          ...
          ::routine_left_shift_types_check (_inLexique,  var_cas_leftType,  var_cas_rightType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (940)) ;
        ...
        case 3 : {
          ...
          GGS_AC_galgasType  var_cas_rightType ;
          nt_term_ (_inLexique, var_cas_ioEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inFileWrappers, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
          ::routine_right_shift_types_check (_inLexique,  var_cas_leftType,  var_cas_rightType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (957)) ;
        ...
        case 4 : {
          ...
          GGS_AC_galgasType  var_cas_rightType ;
          nt_term_ (_inLexique, var_cas_ioEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inFileWrappers, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
          ::routine_addition_types_check (_inLexique,  var_cas_leftType,  var_cas_rightType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (974)) ;
        ...
        case 5 : {
          ...
          GGS_AC_galgasType  var_cas_rightType ;
          nt_term_ (_inLexique, var_cas_ioEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inFileWrappers, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
          ::routine_substraction_types_check (_inLexique,  var_cas_leftType,  var_cas_rightType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (991)) ;
...
void expression_parser::
pr_simple_expression_expression_parser_909_4_parse (galgas_scanner & _inLexique) {
...
void expression_parser::
expression_parser::
pr_term_expression_parser_1003_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_M_filewrappers  var_cas_inFileWrappers,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
    ...
    while (syntaxRepeat_5) {
      switch (select_repeat_expression_parser_5 (_inLexique)) {
        case 2 : {
          ...
          ::routine_multiply_types_check (_inLexique,  var_cas_leftType,  var_cas_rightType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1034)) ;
        ...
        case 3 : {
          ...
          GGS_AC_galgasType  var_cas_rightType ;
          nt_factor_ (_inLexique, var_cas_ioEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inFileWrappers, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
          ::routine_divide_types_check (_inLexique,  var_cas_leftType,  var_cas_rightType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1051)) ;
        ...
        case 4 : {
          ...
          GGS_AC_galgasType  var_cas_rightType ;
          nt_factor_ (_inLexique, var_cas_ioEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inFileWrappers, var_cas_ioVariablesMap, var_cas_rightExpression, var_cas_rightType) ;
          ::routine_modulo_types_check (_inLexique,  var_cas_leftType,  var_cas_rightType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1068)) ;
...
void expression_parser::
pr_term_expression_parser_1003_4_parse (galgas_scanner & _inLexique) {
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1080_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_M_filewrappers  var_cas_inFileWrappers,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  ::routine_unary_minus_type_check (_inLexique,  var_cas_type,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1099)) ;
...
void expression_parser::
pr_factor_expression_parser_1080_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2D) COMMA_HERE) ;
  nt_factor_parse (_inLexique) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1110_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_ioEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_M_filewrappers  /* var_cas_inFileWrappers */,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void expression_parser::
pr_factor_expression_parser_1110_4_parse (galgas_scanner & _inLexique) {
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1131_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_M_filewrappers  var_cas_inFileWrappers,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  switch (select_expression_parser_6 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_kSourceExpresionClassName = GGS_typeGalgasClassType::_castFrom (_inLexique, var_cas_castExpressionType.getPtr (), true, GGS_location (_inLexique) COMMA_SOURCE_FILE_AT_LINE (1162)).reader_mClassTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (1162)) ;
      ...
      if (var_cas_ioEntitiesMap._isBuilt ()) {
        var_cas_ioEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_castedTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1177)) ;
      }
      var_cas_outResultType = GGS_typeEntiteType::_castFrom (_inLexique, var_cas_entite.getPtr (), true, var_cas_castedTypeName COMMA_SOURCE_FILE_AT_LINE (1178)).reader_aDefType (_inLexique COMMA_SOURCE_FILE_AT_LINE (1178)) ;
      GGS_typeGalgasClassType  var_cas_resultClassType ;
      var_cas_resultClassType = GGS_typeGalgasClassType::_castFrom (_inLexique, var_cas_outResultType.getPtr (), true, var_cas_castedTypeName COMMA_SOURCE_FILE_AT_LINE (1180)) ;
      GGS_typeSuperClassesMap  var_cas_superClassMap ;
      var_cas_superClassMap = var_cas_resultClassType.reader_mAncestorClassesMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (1181)) ;
      GGS_string var_cas_classMessage ;
      var_cas_classMessage = var_cas_resultClassType.reader_mClassMessage (_inLexique COMMA_SOURCE_FILE_AT_LINE (1182)) ;
      if (((var_cas_classMessage.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1184)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        var_cas_castedTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "in order to be used in a cast expression, the '@"))._operator_concat (var_cas_castedTypeName))._operator_concat (GGS_string (true, "' class should define a class message")) COMMA_SOURCE_FILE_AT_LINE (1185)) ;
      }
      GGS_string var_cas_sourceExpressionTypeNameString ;
      var_cas_sourceExpressionTypeNameString = var_cas_kSourceExpresionClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1188)) ;
      if (((var_cas_checkForKindOfClass)._operator_not ()).isBuiltAndTrue ()) {
        if ((((var_cas_castedTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1190)))._operator_isNotEqual (var_cas_sourceExpressionTypeNameString))._operator_and ((var_cas_superClassMap.reader_hasKey (_inLexique, var_cas_sourceExpressionTypeNameString COMMA_SOURCE_FILE_AT_LINE (1190)))._operator_not ())).isBuiltAndTrue ()) {
          var_cas_castedTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "This class is not '@"))._operator_concat (var_cas_sourceExpressionTypeNameString))._operator_concat (GGS_string (true, "' and does inherit from it")) COMMA_SOURCE_FILE_AT_LINE (1191)) ;
        }
      }else if (((var_cas_superClassMap.reader_hasKey (_inLexique, var_cas_sourceExpressionTypeNameString COMMA_SOURCE_FILE_AT_LINE (1193)))._operator_not ()).isBuiltAndTrue ()) {
        var_cas_castedTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "This class does not inherit from '@"))._operator_concat (var_cas_sourceExpressionTypeNameString))._operator_concat (GGS_string (true, "'")) COMMA_SOURCE_FILE_AT_LINE (1194)) ;
      }
      ...
      if (var_cas_errorLocationExpressionType._isBuilt ()) {
        var_cas_errorLocationExpressionType (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1209)) ;
      }
...
void expression_parser::
pr_factor_expression_parser_1131_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28) COMMA_HERE) ;
  switch (select_expression_parser_6 (_inLexique)) {
    case 1 : {
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1227_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_M_filewrappers  var_cas_inFileWrappers,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  ::routine_checkNotOperator (_inLexique,  var_cas_operandType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1247)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_factor_expression_parser_1227_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_not) COMMA_HERE) ;
  nt_factor_parse (_inLexique) ;
}
...
pr_factor_expression_parser_1257_4_ (galgas_scanner & _inLexique,
  ...
  ::routine_checkLogicalNegateOperator (_inLexique,  var_cas_operandType,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1277)) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1287_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_ioEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_M_filewrappers  /* var_cas_inFileWrappers */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1287_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_true) COMMA_HERE) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1306_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_ioEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_M_filewrappers  /* var_cas_inFileWrappers */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1306_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_false) COMMA_HERE) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1325_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_ioEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_M_filewrappers  /* var_cas_inFileWrappers */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
  ...
  { bool syntaxRepeat_8 = true ;
    while (syntaxRepeat_8) {
        ...
        var_cas_literalStringList._addAssign_operation (var_cas_literalString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1337))) ;
...
void expression_parser::
pr_factor_expression_parser_1325_4_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat_8 = true ;
    while (syntaxRepeat_8) {
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
      switch (select_repeat_expression_parser_8 (_inLexique)) {
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1350_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_ioEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_M_filewrappers  /* var_cas_inFileWrappers */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1350_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1370_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_ioEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_M_filewrappers  /* var_cas_inFileWrappers */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1370_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_signed_5Fliteral_5Finteger) COMMA_HERE) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1390_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_ioEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_M_filewrappers  /* var_cas_inFileWrappers */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1390_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger64) COMMA_HERE) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1410_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_ioEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_M_filewrappers  /* var_cas_inFileWrappers */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1410_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_signed_5Fliteral_5Finteger64) COMMA_HERE) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1430_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_ioEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_M_filewrappers  /* var_cas_inFileWrappers */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1430_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fchar) COMMA_HERE) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1450_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_ioEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_M_filewrappers  /* var_cas_inFileWrappers */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1450_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fdouble) COMMA_HERE) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1470_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_ioEntitiesMap */,
                                const GGS_M_optionComponents  /* var_cas_inOptionsComponentsMapForUse */,
                                const GGS_M_filewrappers  /* var_cas_inFileWrappers */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
...
void expression_parser::
pr_factor_expression_parser_1470_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_here) COMMA_HERE) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1493_4_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_ioEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_M_filewrappers  var_cas_inFileWrappers,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  switch (select_expression_parser_9 (_inLexique)) {
    case 1 : {
      ...
      switch (select_expression_parser_10 (_inLexique)) {
        ...
        case 2 : {
          ...
          ::routine_handleReaderCall (_inLexique,  var_cas_expressionType,  var_cas_methodName,  var_cas_accessorsTypeList,  var_cas_outResultType,  var_cas_conversionMethod COMMA_SOURCE_FILE_AT_LINE (1524)) ;
    ...
    case 2 : {
      ...
      if (var_cas_ioEntitiesMap._isBuilt ()) {
        var_cas_ioEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_className, var_cas_e COMMA_SOURCE_FILE_AT_LINE (1546)) ;
      }
      var_cas_outResultType = GGS_typeEntiteType::_castFrom (_inLexique, var_cas_e.getPtr (), true, var_cas_className COMMA_SOURCE_FILE_AT_LINE (1547)).reader_aDefType (_inLexique COMMA_SOURCE_FILE_AT_LINE (1547)) ;
      GGS_typeListeAttributsSemantiques  var_cas_listeAttributsSemantiques ;
      if (var_cas_outResultType._isBuilt ()) {
        var_cas_outResultType (HERE)->method_handleConstructorCall (_inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques COMMA_SOURCE_FILE_AT_LINE (1549)) ;
      }
      GGS_typeExpressionList  var_cas_expressionList ;
      ...
      var_cas_outExpression = GGS_typeConstructorExpression::constructor_new (_inLexique, var_cas_className.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1561)), var_cas_mClassMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1562)), var_cas_expressionList COMMA_HERE) ;
      } break ;
    case 3 : {
      ...
      switch (select_expression_parser_11 (_inLexique)) {
        case 1 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          if (((var_cas_optionName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1571)))._operator_isNotEqual (GGS_string (true, "verbose_output"))).isBuiltAndTrue ()) {
            var_cas_optionName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this option name does not correspond to a builtin option") COMMA_SOURCE_FILE_AT_LINE (1572)) ;
          }
        ...
        case 2 : {
          ...
          if (var_cas_inOptionsComponentsMapForUse._isBuilt ()) {
            var_cas_inOptionsComponentsMapForUse (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1582)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E) COMMA_HERE) ;
          GGS_lstring  var_cas_optionName ;
          _inLexique._assignFromAttribute_tokenString (var_cas_optionName) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          if ((var_cas_boolOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1586)) COMMA_SOURCE_FILE_AT_LINE (1586))).isBuiltAndTrue ()) {
            var_cas_outExpression = GGS_typeBoolOption::constructor_new (_inLexique, var_cas_optionComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1587)), var_cas_optionName COMMA_HERE) ;
            var_cas_outResultType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
          }else if ((var_cas_uintOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1589)) COMMA_SOURCE_FILE_AT_LINE (1589))).isBuiltAndTrue ()) {
            var_cas_outExpression = GGS_typeUIntOption::constructor_new (_inLexique, var_cas_optionComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1590)), var_cas_optionName COMMA_HERE) ;
            var_cas_outResultType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
          }else if ((var_cas_stringOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1592)) COMMA_SOURCE_FILE_AT_LINE (1592))).isBuiltAndTrue ()) {
            var_cas_outExpression = GGS_typeStringOption::constructor_new (_inLexique, var_cas_optionComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1593)), var_cas_optionName COMMA_HERE) ;
            var_cas_outResultType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          }else{
            var_cas_optionName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '"))._operator_concat (var_cas_optionComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1596))))._operator_concat (GGS_string (true, "' option component has no '")))._operator_concat (var_cas_optionName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1596))))._operator_concat (GGS_string (true, "' option")) COMMA_SOURCE_FILE_AT_LINE (1597)) ;
...
void expression_parser::
pr_factor_expression_parser_1493_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B) COMMA_HERE) ;
  switch (select_expression_parser_9 (_inLexique)) {
    case 1 : {
      nt_expression_parse (_inLexique) ;
...
void expression_parser::
expression_parser::
pr_read_access_expression_parser_1610_4_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (_inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1617)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_read_access_expression_parser_1610_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
}
...
void expression_parser::
expression_parser::
pr_read_access_expression_parser_1626_4_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_nomVariable,
                                GGS_typeCplusPlusName  &var_cas_nomCppEntite,
                                GGS_AC_galgasType  &var_cas_typeEntite,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
  if ((var_cas_ioVariablesMap.reader_hasKey (_inLexique, GGS_string (true, "self") COMMA_SOURCE_FILE_AT_LINE (1633))).isBuiltAndTrue ()) {
    var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, GGS_string (true, "self"), GGS_location (_inLexique) COMMA_HERE) ;
    var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (_inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1635)) ;
  }else{
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'self' is not defined in this context") COMMA_SOURCE_FILE_AT_LINE (1638)) ;
...
void expression_parser::
pr_read_access_expression_parser_1626_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
}
...
void expression_parser::
expression_parser::
pr_output_expression_list_expression_parser_1648_4_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inFormalAttributesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1677)))._operator_strictInf (var_cas_effectiveTypesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1677)))).isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much expressions") COMMA_SOURCE_FILE_AT_LINE (1678)) ;
  }else if (((var_cas_inFormalAttributesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1679)))._operator_strictSup (var_cas_effectiveTypesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1679)))).isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more expressions missing") COMMA_SOURCE_FILE_AT_LINE (1680)) ;
  }else{
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_65832 (var_cas_inFormalAttributesList, true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_65832 = NULL ;
    GGS_typeTypesList::cEnumerator enumerator_65915 (var_cas_effectiveTypesList, true) ;
    const GGS_typeTypesList::cElement * operand_65915 = NULL ;
    while (((operand_65832 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_65832.nextObject ()))
        && ((operand_65915 = enumerator_65915.nextObject ()))) {
      macroValidPointer (operand_65832) ;
      macroValidPointer (operand_65915) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_65832->mAttributType,  operand_65915->mType,  operand_65915->mEndOfExpressionLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (1683)) ;
    }
    enumerator_65832.reset () ;
    enumerator_65915.reset () ;
  }
}
...
void expression_parser::
pr_output_expression_list_expression_parser_1648_4_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat_12 = true ;
    while (syntaxRepeat_12) {
      switch (select_repeat_expression_parser_12 (_inLexique)) {
        case 2 : {
...
void expression_parser::
expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_1695_4_ (galgas_scanner & _inLexique,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
        ...
        case 2 : {
          switch (select_expression_parser_14 (_inLexique)) {
            ...
            case 3 : {
              ...
              var_cas_jokerCount = var_cas_jokerCountWithLocation.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1721)) ;
              GGS_uint _variant_67532 = var_cas_jokerCount._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (1722)) ;
              GGS_bool _condition_67532 (_variant_67532._isBuilt (), true) ;
              while (_condition_67532.isBuiltAndTrue ()) {
                _condition_67532 = (var_cas_jokerCount)._operator_strictSup (GGS_uint (true, 0U)) ;
                if (_condition_67532.isBuiltAndTrue ()) {
                  if (_variant_67532.uintValue () == 0) {
                    _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1725)) ;
                    _condition_67532 = GGS_bool (true, false) ;
                  }else{
                    _variant_67532._decrement_operation (_inLexique COMMA_HERE) ;
                    var_cas_argumentsList._addAssign_operation (GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE), GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
                    var_cas_jokerCount._decrement_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1725)) ;
                  }
                }
              }
              } break ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__29) COMMA_HERE) ;
  ::routine_buildMapWithLocalConstants (_inLexique,  var_cas_argumentsList,  var_cas_inFormalArgumentsList,  var_cas_ioVariablesMap,  var_cas_inVarLocation,  var_cas_inLocalConstantStyle,  var_cas_ellipsisFound COMMA_SOURCE_FILE_AT_LINE (1737)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_1695_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat_13 = true ;
    while (syntaxRepeat_13) {
      switch (select_repeat_expression_parser_13 (_inLexique)) {
