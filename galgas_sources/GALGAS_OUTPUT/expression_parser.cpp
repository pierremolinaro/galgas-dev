...
pr_factor_expression_parser_1684_13_ (galgas_scanner & inLexique,
  ...
  switch (select_expression_parser_10 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      const GGS_bool cond_65931 = (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1698))).operator_isNotEqual (GGS_string ("verbose_output")) ;
    ...
    case 2 : {
      ...
      inLexique.assignFromAttribute_tokenString (var_cas_optionName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      const GGS_bool cond_66643 = var_cas_boolOptionsMap.reader_hasKey (inLexique, var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1713)) COMMA_SOURCE_FILE_AT_LINE (1713)) ;
      if (cond_66643.isBuiltAndTrue ()) {
        ...
        var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_HERE) ;
      }else if (cond_66643.isBuiltAndFalse ()) {
        const GGS_bool cond_66840 = var_cas_uintOptionsMap.reader_hasKey (inLexique, var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1716)) COMMA_SOURCE_FILE_AT_LINE (1716)) ;
        if (cond_66840.isBuiltAndTrue ()) {
          ...
          var_cas_outResultType = GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_HERE) ;
        }else if (cond_66840.isBuiltAndFalse ()) {
          const GGS_bool cond_67042 = var_cas_stringOptionsMap.reader_hasKey (inLexique, var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1719)) COMMA_SOURCE_FILE_AT_LINE (1719)) ;
          if (cond_67042.isBuiltAndTrue ()) {
            ...
            var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
          }else if (cond_67042.isBuiltAndFalse ()) {
...
pr_read_access_expression_parser_1873_18_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_73231 = var_cas_ioVariablesMap.reader_hasKey (inLexique, GGS_string ("self") COMMA_SOURCE_FILE_AT_LINE (1880)) ;
  if (cond_73231.isBuiltAndTrue ()) {
  ...
  }else if (cond_73231.isBuiltAndFalse ()) {
...
pr_output_expression_list_expression_parser_1895_29_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_74792 = (var_cas_inFormalAttributesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1924))).operator_strictInf (var_cas_effectiveTypesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1924))) ;
  if (cond_74792.isBuiltAndTrue ()) {
  ...
  }else if (cond_74792.isBuiltAndFalse ()) {
    const GGS_bool cond_74932 = (var_cas_inFormalAttributesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1926))).operator_strictSup (var_cas_effectiveTypesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1926))) ;
    if (cond_74932.isBuiltAndTrue ()) {
    ...
    }else if (cond_74932.isBuiltAndFalse ()) {
      {
        ...
        GGS_typeTypesList::cEnumerator enumerator_74987 (var_cas_effectiveTypesList, true) ;
        const GGS_typeTypesList::cElement * operand_74987 = NULL ;
        while (((operand_74967 = enumerator_74967.nextObject ()))
            && ((operand_74987 = enumerator_74987.nextObject ()))) {
          macroValidPointer (operand_74967) ;
          macroValidPointer (operand_74987) ;
          ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_74967->mAttributType,  operand_74987->mType,  operand_74987->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1930)) ;
        }
      }
    }
  }
        ...
        case 2 : {
          switch (select_expression_parser_15 (inLexique)) {
            ...
            case 3 : {
              ...
              GGS_uint _variant_76560 = var_cas_jokerCount.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1969)) ;
              GGS_bool _condition_76560 (_variant_76560.isBuilt (), true) ;
              while (_condition_76560.isBuiltAndTrue ()) {
                _condition_76560 = (var_cas_jokerCount).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_76560.isBuiltAndTrue ()) {
                  if (_variant_76560.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1973)) ;
                    _condition_76560 = GGS_bool (false) ;
                  }else{
                    _variant_76560.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_argumentsList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
