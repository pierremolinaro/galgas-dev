...
void expression_parser::rule_expression_5F_parser_primary_i27_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  switch (select_expression_5F_parser_9 (inLexique)) {
    case 1 : {
      ...
      var_cas_outExpression = GGS_typeOptionAccess ::constructor_new (inLexique, var_cas_outResultType, GGS_string ("galgas_cli_options"), var_cas_optionName, var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1845)) COMMA_SOURCE_FILE_AT_LINE (1845)) ;
      } break ;
    case 2 : {
      ...
      inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
      const GGS_bool cond_72149 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1855))).operator_isEqual (GGS_string ("value")) ;
      if (cond_72149.isBuiltAndTrue ()) {
        const GGS_bool cond_71735 = var_cas_boolOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1856))) ;
        if (cond_71735.isBuiltAndTrue ()) {
          var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1857)) ;
        }else if (cond_71735.isBuiltAndFalse ()) {
          const GGS_bool cond_71847 = var_cas_uintOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1858))) ;
          if (cond_71847.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1859)) ;
          }else if (cond_71847.isBuiltAndFalse ()) {
            const GGS_bool cond_71962 = var_cas_stringOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1860))) ;
            if (cond_71962.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1861)) ;
            }else if (cond_71962.isBuiltAndFalse ()) {
      ...
      }else if (cond_72149.isBuiltAndFalse ()) {
        const GGS_bool cond_72242 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1866))).operator_isEqual (GGS_string ("char")) ;
        if (cond_72242.isBuiltAndTrue ()) {
          var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1867)) ;
        }else if (cond_72242.isBuiltAndFalse ()) {
          const GGS_bool cond_72339 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1868))).operator_isEqual (GGS_string ("string")) ;
          if (cond_72339.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1869)) ;
          }else if (cond_72339.isBuiltAndFalse ()) {
            const GGS_bool cond_72436 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1870))).operator_isEqual (GGS_string ("comment")) ;
            if (cond_72436.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1871)) ;
            }else if (cond_72436.isBuiltAndFalse ()) {
      ...
      var_cas_outExpression = GGS_typeOptionAccess ::constructor_new (inLexique, var_cas_outResultType, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1875)), var_cas_optionName, var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1875)) COMMA_SOURCE_FILE_AT_LINE (1875)) ;
      } break ;
    default :
      break ;
  }
...
void expression_parser::rule_expression_5F_parser_primary_i28_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_M_filewrappersEX  temp_73947 = var_cas_inSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (1905)) ;
  if (temp_73947.isBuilt ()) {
    temp_73947 (HERE)->method_searchKey (inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1905)) ;
  }
    ...
    case 2 : {
      ...
      switch (select_expression_5F_parser_11 (inLexique)) {
        ...
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
          const GGS_bool cond_75078 = (var_cas_path.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
          if (cond_75078.isBuiltAndTrue ()) {
            var_cas_path.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((GGS_string ("compatibility with GALGAS V2: the '")).operator_concat (var_cas_path)).operator_concat (GGS_string ("' path should not begin by '/'")) COMMA_SOURCE_FILE_AT_LINE (1936)) ;
          }else if (cond_75078.isBuiltAndFalse ()) {
            var_cas_path = GGS_lstring ::constructor_new (inLexique, (GGS_string ("/")).operator_concat (var_cas_path), var_cas_path.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1938)) COMMA_SOURCE_FILE_AT_LINE (1938)) ;
          }
          GGS_uint  var_cas_wrapperFileIndex ;
          GGS_uint  automatic_var_75256_0 ;
          if (var_cas_regularFileMap.isBuilt ()) {
            var_cas_regularFileMap (HERE)->method_searchKey (inLexique, var_cas_path, automatic_var_75256_0, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1942)) ;
          }
          var_cas_outExpression = GGS_typeFileWrapperWithStaticPath ::constructor_new (inLexique, var_cas_filewrapperName, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1943)) ;
          var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1944)) ;
          } break ;
        default :
          break ;
      }
...
void expression_parser::rule_expression_5F_parser_primary_i29_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  if (var_cas_inEntitiesMap.isBuilt ()) {
    var_cas_inEntitiesMap (HERE)->method_searchKey (inLexique, var_cas_functionName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1970)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_76964 = var_cas_entite ; // CAST instruction
    if (_var_76964.getPtr () != NULL) {
      macroValidPointer (_var_76964.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteFonction *> (_var_76964.getPtr ()) != NULL) {
        const GGS_typeEntiteFonction var_cas_r (_var_76964.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_r.reader_aListeArgumentsFormels (inLexique COMMA_SOURCE_FILE_AT_LINE (1974)) ;
        var_cas_outResultType = var_cas_r.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1975)) ;
        var_cas_isExternActionCall = GGS_bool (false) ;
      }else if (dynamic_cast <cPtr_typeEntiteFonctionExterne *> (_var_76964.getPtr ()) != NULL) {
        const GGS_typeEntiteFonctionExterne var_cas_ae (_var_76964.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_ae.reader_aSignature (inLexique COMMA_SOURCE_FILE_AT_LINE (1978)) ;
        var_cas_outResultType = var_cas_ae.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1979)) ;
        var_cas_isExternActionCall = GGS_bool (true) ;
      }else{
        var_cas_functionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'")).operator_concat (var_cas_functionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1983)))).operator_concat (GGS_string ("' should name a function or an extern function")) COMMA_SOURCE_FILE_AT_LINE (1986)) ;
  ...
  {
    GGS_L_EXsignature::cEnumerator enumerator_77132 (var_cas_signatureRoutine, true) ;
    const GGS_L_EXsignature::cElement * operand_77132 = NULL ;
    while (((operand_77132 = enumerator_77132.nextObject ()))) {
      macroValidPointer (operand_77132) ;
      var_cas_listeAttributsSemantiques.addAssign_operation (operand_77132->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1991))) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5B_) COMMA_HERE) ;
  nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5D_) COMMA_HERE) ;
  var_cas_outExpression = GGS_typeFunctionCall ::constructor_new (inLexique, var_cas_functionName, var_cas_expressionList COMMA_SOURCE_FILE_AT_LINE (2003)) ;
}
...
void expression_parser::rule_expression_5F_parser_read_5F_access_i30_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
  var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (2019)) ;
}
...
void expression_parser::rule_expression_5F_parser_read_5F_access_i31_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_78936 = var_cas_ioVariablesMap.reader_hasKey (GGS_string ("self")) ;
  if (cond_78936.isBuiltAndTrue ()) {
    var_cas_nomVariable = GGS_lstring ::constructor_new (inLexique, GGS_string ("self"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2036)) ;
    var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (2037)) ;
  }else if (cond_78936.isBuiltAndFalse ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'selfcopy' is not defined in this context") COMMA_SOURCE_FILE_AT_LINE (2041)) ;
...
void expression_parser::rule_expression_5F_parser_output_5F_expression_5F_list_i32_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_80500 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictInf (var_cas_effectiveTypesList.reader_length ()) ;
  if (cond_80500.isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("too much expressions") COMMA_SOURCE_FILE_AT_LINE (2081)) ;
  }else if (cond_80500.isBuiltAndFalse ()) {
    const GGS_bool cond_80640 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictSup (var_cas_effectiveTypesList.reader_length ()) ;
    if (cond_80640.isBuiltAndTrue ()) {
      var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more expressions missing") COMMA_SOURCE_FILE_AT_LINE (2083)) ;
    }else if (cond_80640.isBuiltAndFalse ()) {
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_80675 (var_cas_inFormalAttributesList, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_80675 = NULL ;
        GGS_typeTypesList::cEnumerator enumerator_80695 (var_cas_effectiveTypesList, true) ;
        const GGS_typeTypesList::cElement * operand_80695 = NULL ;
        while (((operand_80675 = enumerator_80675.nextObject ()))
            && ((operand_80695 = enumerator_80695.nextObject ()))) {
          macroValidPointer (operand_80675) ;
          macroValidPointer (operand_80695) ;
          ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_80675->mAttributType,  operand_80695->mType,  operand_80695->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (2085)) ;
        }
      }
    }
  }
...
void expression_parser::rule_expression_5F_parser_parse_5F_effective_5F_input_5F_parameters_5F_list_i33_ (C_Lexique_galgas_5F_scanner & inLexique,
      ...
      switch (select_expression_5F_parser_13 (inLexique)) {
        case 2 : {
          switch (select_expression_5F_parser_14 (inLexique)) {
            ...
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2A_) COMMA_HERE) ;
              var_cas_argumentsList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2118)), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2118))) ;
              } break ;
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__2A_) COMMA_HERE) ;
              GGS_uint  var_cas_jokerCount = var_cas_jokerCountWithLocation.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2123)) ;
              GGS_uint _variant_82268 = var_cas_jokerCount.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (2124)) ;
              GGS_bool _condition_82268 (_variant_82268.isBuilt (), true) ;
              while (_condition_82268.isBuiltAndTrue ()) {
                _condition_82268 = (var_cas_jokerCount).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_82268.isBuiltAndTrue ()) {
                  if (_variant_82268.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2128)) ;
                    _condition_82268 = GGS_bool (false) ;
                  }else{
                    _variant_82268.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_argumentsList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2126)), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2126))) ;
                    var_cas_jokerCount.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (2127)) ;
                  }
                }
              }
              } break ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__29_) COMMA_HERE) ;
  ::routine_buildMapWithLocalConstants (inLexique,  var_cas_inEnumeratorNewStyle,  var_cas_argumentsList,  var_cas_inFormalArgumentsList,  var_cas_ioVariablesMap,  var_cas_inVarLocation,  var_cas_inLocalConstantStyle,  var_cas_ellipsisFound COMMA_SOURCE_FILE_AT_LINE (2140)) ;
}
