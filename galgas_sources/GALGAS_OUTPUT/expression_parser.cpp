      ...
      if ((operand_9717 != NULL) && (operand_9742 != NULL)) {
        ...
        if ((operand_9717 != NULL) && (operand_9742 != NULL)) {
          if (((operand_9717->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (243)))._operator_isNotEqual (operand_9742->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (243)))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "concatenation operator error: lists should have the same type (here '@"))._operator_concat (operand_9717->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (245))))._operator_concat (GGS_string (true, "' and '@")))._operator_concat (operand_9742->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (245))))._operator_concat (GGS_string (true, "')")) COMMA_SOURCE_FILE_AT_LINE (245)) ;
          }
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
...
void routine_checkLogicalNegateOperator (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_AC_galgasType _var_12205 = var_cas_inOperandType ; // CAST instruction
    if (_var_12205.getPtr () != NULL) {
      macroValidPointer (_var_12205.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgas_binaryset *> (_var_12205.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inOperandType ;
      }else if (dynamic_cast <cPtr_typeGalgas_uint *> (_var_12205.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inOperandType ;
      }else if (dynamic_cast <cPtr_typeGalgas_sint *> (_var_12205.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inOperandType ;
      }else if (dynamic_cast <cPtr_typeGalgas_uint64 *> (_var_12205.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inOperandType ;
      }else if (dynamic_cast <cPtr_typeGalgas_sint64 *> (_var_12205.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inOperandType ;
      }else{
...
void routine_comparison_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_12767 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_12792 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_binaryset * operand_12767 = dynamic_cast <cPtr_typeGalgas_binaryset *> (ptr_12767) ;
    cPtr_typeGalgas_binaryset * operand_12792 = dynamic_cast <cPtr_typeGalgas_binaryset *> (ptr_12792) ;
    if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
    }else{
      cPtr_typeGalgas_stringset * operand_12767 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_12767) ;
      cPtr_typeGalgas_stringset * operand_12792 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_12792) ;
      if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
      }else{
        cPtr_typeGalgas_bool * operand_12767 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_12767) ;
        cPtr_typeGalgas_bool * operand_12792 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_12792) ;
        if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
        }else{
          cPtr_typeGalgas_char * operand_12767 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_12767) ;
          cPtr_typeGalgas_char * operand_12792 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_12792) ;
          if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
          }else{
            cPtr_typeGalgas_uint * operand_12767 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_12767) ;
            cPtr_typeGalgas_uint * operand_12792 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_12792) ;
            if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
            }else{
              cPtr_typeGalgas_sint * operand_12767 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_12767) ;
              cPtr_typeGalgas_sint * operand_12792 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_12792) ;
              if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
              }else{
                cPtr_typeGalgas_uint64 * operand_12767 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_12767) ;
                cPtr_typeGalgas_uint64 * operand_12792 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_12792) ;
                if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                }else{
                  cPtr_typeGalgas_sint64 * operand_12767 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_12767) ;
                  cPtr_typeGalgas_sint64 * operand_12792 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_12792) ;
                  if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                  }else{
                    cPtr_typeGalgas_double * operand_12767 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_12767) ;
                    cPtr_typeGalgas_double * operand_12792 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_12792) ;
                    if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                    }else{
                      cPtr_typeGalgas_string * operand_12767 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_12767) ;
                      cPtr_typeGalgas_string * operand_12792 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_12792) ;
                      if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                      }else{
                        cPtr_typeGalgas_lbool * operand_12767 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_12767) ;
                        cPtr_typeGalgas_lbool * operand_12792 = dynamic_cast <cPtr_typeGalgas_lbool *> (ptr_12792) ;
                        if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                        }else{
                          cPtr_typeGalgas_lchar * operand_12767 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_12767) ;
                          cPtr_typeGalgas_lchar * operand_12792 = dynamic_cast <cPtr_typeGalgas_lchar *> (ptr_12792) ;
                          if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                          }else{
                            cPtr_typeGalgas_luint * operand_12767 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_12767) ;
                            cPtr_typeGalgas_luint * operand_12792 = dynamic_cast <cPtr_typeGalgas_luint *> (ptr_12792) ;
                            if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                            }else{
                              cPtr_typeGalgas_lsint * operand_12767 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_12767) ;
                              cPtr_typeGalgas_lsint * operand_12792 = dynamic_cast <cPtr_typeGalgas_lsint *> (ptr_12792) ;
                              if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                              }else{
                                cPtr_typeGalgas_luint64 * operand_12767 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_12767) ;
                                cPtr_typeGalgas_luint64 * operand_12792 = dynamic_cast <cPtr_typeGalgas_luint64 *> (ptr_12792) ;
                                if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                                }else{
                                  cPtr_typeGalgas_lsint64 * operand_12767 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_12767) ;
                                  cPtr_typeGalgas_lsint64 * operand_12792 = dynamic_cast <cPtr_typeGalgas_lsint64 *> (ptr_12792) ;
                                  if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                                  }else{
                                    cPtr_typeGalgas_ldouble * operand_12767 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_12767) ;
                                    cPtr_typeGalgas_ldouble * operand_12792 = dynamic_cast <cPtr_typeGalgas_ldouble *> (ptr_12792) ;
                                    if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                                    }else{
                                      cPtr_typeGalgas_lstring * operand_12767 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_12767) ;
                                      cPtr_typeGalgas_lstring * operand_12792 = dynamic_cast <cPtr_typeGalgas_lstring *> (ptr_12792) ;
                                      if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                                      }else{
                                        cPtr_typeGalgas_location * operand_12767 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_12767) ;
                                        cPtr_typeGalgas_location * operand_12792 = dynamic_cast <cPtr_typeGalgas_location *> (ptr_12792) ;
                                        if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                                        }else{
                                          cPtr_typeGalgas_filewrapper * operand_12767 = dynamic_cast <cPtr_typeGalgas_filewrapper *> (ptr_12767) ;
                                          cPtr_typeGalgas_filewrapper * operand_12792 = dynamic_cast <cPtr_typeGalgas_filewrapper *> (ptr_12792) ;
                                          if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                                          }else{
                                            cPtr_typeGalgas_enum * operand_12767 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_12767) ;
                                            cPtr_typeGalgas_enum * operand_12792 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_12792) ;
                                            if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                                              if (((operand_12767->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (329)))._operator_isNotEqual (operand_12792->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (329)))).isBuiltAndTrue ()) {
                                                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "comparison between an '@"))._operator_concat (operand_12767->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (330))))._operator_concat (GGS_string (true, "' enumeration and an '@")))._operator_concat (operand_12792->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (331))))._operator_concat (GGS_string (true, "' enumeration is not valid")) COMMA_SOURCE_FILE_AT_LINE (331)) ;
                                              }
                                            }else{
                                              cPtr_typeGalgasUndefinedListType * operand_12767 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_12767) ;
                                              cPtr_typeGalgasUndefinedListType * operand_12792 = dynamic_cast <cPtr_typeGalgasUndefinedListType *> (ptr_12792) ;
                                              if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                                                if (((operand_12767->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (334)))._operator_isNotEqual (operand_12792->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (334)))).isBuiltAndTrue ()) {
                                                  GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "I was expecting the list type '@"))._operator_concat (operand_12767->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (335))))._operator_concat (GGS_string (true, "', I have got the list type '@")))._operator_concat (operand_12792->mListTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (336))))._operator_concat (GGS_string (true, "\"")) COMMA_SOURCE_FILE_AT_LINE (336)) ;
                                                }
                                              }else{
                                                cPtr_typeGalgasUndefinedMapType * operand_12767 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_12767) ;
                                                cPtr_typeGalgasUndefinedMapType * operand_12792 = dynamic_cast <cPtr_typeGalgasUndefinedMapType *> (ptr_12792) ;
                                                if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                                                  if (((operand_12767->mMapTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (340)))._operator_isNotEqual (operand_12792->mMapTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (340)))).isBuiltAndTrue ()) {
                                                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "I was expecting the map type '@"))._operator_concat (operand_12767->mMapTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (341))))._operator_concat (GGS_string (true, "', I have got the map type '@")))._operator_concat (operand_12792->mMapTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (342))))._operator_concat (GGS_string (true, "\"")) COMMA_SOURCE_FILE_AT_LINE (342)) ;
                                                  }
                                                }else{
                                                  cPtr_typeGalgasUndefinedClassType * operand_12767 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_12767) ;
                                                  cPtr_typeGalgasUndefinedClassType * operand_12792 = dynamic_cast <cPtr_typeGalgasUndefinedClassType *> (ptr_12792) ;
                                                  if ((operand_12767 != NULL) && (operand_12792 != NULL)) {
                                                    if (((operand_12767->mClassTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (347)))._operator_isNotEqual (operand_12792->mClassTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (347)))).isBuiltAndTrue ()) {
                                                      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "I was expecting the class type '@"))._operator_concat (operand_12767->mClassTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (348))))._operator_concat (GGS_string (true, "', I have got the class type '@")))._operator_concat (operand_12792->mClassTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (349))))._operator_concat (GGS_string (true, "\"")) COMMA_SOURCE_FILE_AT_LINE (349)) ;
                                                    }
                                                  }else{
...
void routine_magnitude_comparison_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_16137 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_16162 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_stringset * operand_16137 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_16137) ;
    cPtr_typeGalgas_stringset * operand_16162 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_16162) ;
    if ((operand_16137 != NULL) && (operand_16162 != NULL)) {
    }else{
      cPtr_typeGalgas_bool * operand_16137 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_16137) ;
      cPtr_typeGalgas_bool * operand_16162 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_16162) ;
      if ((operand_16137 != NULL) && (operand_16162 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_16137 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_16137) ;
        cPtr_typeGalgas_char * operand_16162 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_16162) ;
        if ((operand_16137 != NULL) && (operand_16162 != NULL)) {
        }else{
          cPtr_typeGalgas_uint * operand_16137 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_16137) ;
          cPtr_typeGalgas_uint * operand_16162 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_16162) ;
          if ((operand_16137 != NULL) && (operand_16162 != NULL)) {
          }else{
            cPtr_typeGalgas_sint * operand_16137 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_16137) ;
            cPtr_typeGalgas_sint * operand_16162 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_16162) ;
            if ((operand_16137 != NULL) && (operand_16162 != NULL)) {
            }else{
              cPtr_typeGalgas_uint64 * operand_16137 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_16137) ;
              cPtr_typeGalgas_uint64 * operand_16162 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_16162) ;
              if ((operand_16137 != NULL) && (operand_16162 != NULL)) {
              }else{
                cPtr_typeGalgas_sint64 * operand_16137 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_16137) ;
                cPtr_typeGalgas_sint64 * operand_16162 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_16162) ;
                if ((operand_16137 != NULL) && (operand_16162 != NULL)) {
                }else{
                  cPtr_typeGalgas_double * operand_16137 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_16137) ;
                  cPtr_typeGalgas_double * operand_16162 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_16162) ;
                  if ((operand_16137 != NULL) && (operand_16162 != NULL)) {
                  }else{
                    cPtr_typeGalgas_string * operand_16137 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_16137) ;
                    cPtr_typeGalgas_string * operand_16162 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_16162) ;
                    if ((operand_16137 != NULL) && (operand_16162 != NULL)) {
                    }else{
                      cPtr_typeGalgas_enum * operand_16137 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_16137) ;
                      cPtr_typeGalgas_enum * operand_16162 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_16162) ;
                      if ((operand_16137 != NULL) && (operand_16162 != NULL)) {
                        if (((operand_16137->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (378)))._operator_isNotEqual (operand_16162->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (378)))).isBuiltAndTrue ()) {
                          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "comparison between an '@"))._operator_concat (operand_16137->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (379))))._operator_concat (GGS_string (true, "' enumeration and an '@")))._operator_concat (operand_16162->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (380))))._operator_concat (GGS_string (true, "' enumeration is not valid")) COMMA_SOURCE_FILE_AT_LINE (380)) ;
                        }
                      }else{
...
void routine_left_shift_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_17795 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_17820 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_binaryset * operand_17795 = dynamic_cast <cPtr_typeGalgas_binaryset *> (ptr_17795) ;
    cPtr_typeGalgas_uint * operand_17820 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17820) ;
    if ((operand_17795 != NULL) && (operand_17820 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_uint * operand_17795 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17795) ;
      cPtr_typeGalgas_uint * operand_17820 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17820) ;
      if ((operand_17795 != NULL) && (operand_17820 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_sint * operand_17795 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_17795) ;
        cPtr_typeGalgas_uint * operand_17820 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17820) ;
        if ((operand_17795 != NULL) && (operand_17820 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_uint64 * operand_17795 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_17795) ;
          cPtr_typeGalgas_uint * operand_17820 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17820) ;
          if ((operand_17795 != NULL) && (operand_17820 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_sint64 * operand_17795 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_17795) ;
            cPtr_typeGalgas_uint * operand_17820 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17820) ;
            if ((operand_17795 != NULL) && (operand_17820 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
...
void routine_right_shift_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_18801 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_18826 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_binaryset * operand_18801 = dynamic_cast <cPtr_typeGalgas_binaryset *> (ptr_18801) ;
    cPtr_typeGalgas_uint * operand_18826 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18826) ;
    if ((operand_18801 != NULL) && (operand_18826 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_uint * operand_18801 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18801) ;
      cPtr_typeGalgas_uint * operand_18826 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18826) ;
      if ((operand_18801 != NULL) && (operand_18826 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_sint * operand_18801 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_18801) ;
        cPtr_typeGalgas_uint * operand_18826 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18826) ;
        if ((operand_18801 != NULL) && (operand_18826 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_uint64 * operand_18801 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_18801) ;
          cPtr_typeGalgas_uint * operand_18826 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18826) ;
          if ((operand_18801 != NULL) && (operand_18826 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_sint64 * operand_18801 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_18801) ;
            cPtr_typeGalgas_uint * operand_18826 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18826) ;
            if ((operand_18801 != NULL) && (operand_18826 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
...
void routine_addition_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_20116 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_20141 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_20116 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_20116) ;
    cPtr_typeGalgas_uint * operand_20141 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_20141) ;
    if ((operand_20116 != NULL) && (operand_20141 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_20116 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_20116) ;
      cPtr_typeGalgas_sint * operand_20141 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_20141) ;
      if ((operand_20116 != NULL) && (operand_20141 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_20116 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_20116) ;
        cPtr_typeGalgas_uint64 * operand_20141 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_20141) ;
        if ((operand_20116 != NULL) && (operand_20141 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_20116 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_20116) ;
          cPtr_typeGalgas_sint64 * operand_20141 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_20141) ;
          if ((operand_20116 != NULL) && (operand_20141 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_substraction_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_21341 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_21366 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_21341 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_21341) ;
    cPtr_typeGalgas_uint * operand_21366 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_21366) ;
    if ((operand_21341 != NULL) && (operand_21366 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_21341 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_21341) ;
      cPtr_typeGalgas_sint * operand_21366 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_21366) ;
      if ((operand_21341 != NULL) && (operand_21366 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_21341 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_21341) ;
        cPtr_typeGalgas_uint64 * operand_21366 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_21366) ;
        if ((operand_21341 != NULL) && (operand_21366 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_21341 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_21341) ;
          cPtr_typeGalgas_sint64 * operand_21366 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_21366) ;
          if ((operand_21341 != NULL) && (operand_21366 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_stringset * operand_21341 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_21341) ;
            cPtr_typeGalgas_stringset * operand_21366 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_21366) ;
            if ((operand_21341 != NULL) && (operand_21366 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
...
void routine_multiply_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_22672 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_22697 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_22672 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_22672) ;
    cPtr_typeGalgas_uint * operand_22697 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_22697) ;
    if ((operand_22672 != NULL) && (operand_22697 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_22672 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_22672) ;
      cPtr_typeGalgas_sint * operand_22697 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_22697) ;
      if ((operand_22672 != NULL) && (operand_22697 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_22672 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_22672) ;
        cPtr_typeGalgas_uint64 * operand_22697 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_22697) ;
        if ((operand_22672 != NULL) && (operand_22697 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_22672 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_22672) ;
          cPtr_typeGalgas_sint64 * operand_22697 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_22697) ;
          if ((operand_22672 != NULL) && (operand_22697 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_divide_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_23897 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_23922 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_23897 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_23897) ;
    cPtr_typeGalgas_uint * operand_23922 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_23922) ;
    if ((operand_23897 != NULL) && (operand_23922 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_23897 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_23897) ;
      cPtr_typeGalgas_sint * operand_23922 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_23922) ;
      if ((operand_23897 != NULL) && (operand_23922 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_23897 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_23897) ;
        cPtr_typeGalgas_uint64 * operand_23922 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_23922) ;
        if ((operand_23897 != NULL) && (operand_23922 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_23897 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_23897) ;
          cPtr_typeGalgas_sint64 * operand_23922 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_23922) ;
          if ((operand_23897 != NULL) && (operand_23922 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_modulo_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_25116 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_25141 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_25116 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_25116) ;
    cPtr_typeGalgas_uint * operand_25141 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_25141) ;
    if ((operand_25116 != NULL) && (operand_25141 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_25116 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_25116) ;
      cPtr_typeGalgas_sint * operand_25141 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_25141) ;
      if ((operand_25116 != NULL) && (operand_25141 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_25116 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_25116) ;
        cPtr_typeGalgas_uint64 * operand_25141 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_25141) ;
        if ((operand_25116 != NULL) && (operand_25141 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_25116 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_25116) ;
          cPtr_typeGalgas_sint64 * operand_25141 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_25141) ;
          if ((operand_25116 != NULL) && (operand_25141 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_unary_minus_type_check (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_AC_galgasType _var_26566 = var_cas_inExpressionType ; // CAST instruction
    if (_var_26566.getPtr () != NULL) {
      macroValidPointer (_var_26566.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgas_sint *> (_var_26566.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inExpressionType ;
      }else if (dynamic_cast <cPtr_typeGalgas_sint64 *> (_var_26566.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inExpressionType ;
      }else{
...
pr_factor_expression_parser_1132_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_expression_parser_6 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_M_semanticsEntitiesForUse  _temp_45431 = var_cas_ioEntitiesMap ;
      if (_temp_45431._isBuilt ()) {
        _temp_45431 (HERE)->method_searchKey (_inLexique, var_cas_castedTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1178)) ;
      }
      ...
      const GGS_AC_galgasType  _temp_47165 = var_cas_errorLocationExpressionType ;
      if (_temp_47165._isBuilt ()) {
        _temp_47165 (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1210)) ;
      }
...
pr_factor_expression_parser_1496_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_expression_parser_9 (_inLexique)) {
    case 1 : {
      ...
      const GGS_M_filewrappers  _temp_59665 = var_cas_inSemanticContext.reader_mFilewrappers (_inLexique COMMA_SOURCE_FILE_AT_LINE (1513)) ;
      if (_temp_59665._isBuilt ()) {
        _temp_59665 (HERE)->method_searchKey (_inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1513)) ;
      }
        ...
        case 2 : {
          ...
          switch (select_expression_parser_11 (_inLexique)) {
            case 1 : {
              ...
              const GGS_filewrapperTemplateMap  _temp_60097 = var_cas_templateMap ;
              if (_temp_60097._isBuilt ()) {
                _temp_60097 (HERE)->method_searchKey (_inLexique, var_cas_templateName, var_cas_formalAttributeList COMMA_SOURCE_FILE_AT_LINE (1525)) ;
              }
            ...
            case 2 : {
              ...
              const GGS_M_regularFiles  _temp_60769 = var_cas_regularFileMap ;
              if (_temp_60769._isBuilt ()) {
                _temp_60769 (HERE)->method_searchKey (_inLexique, var_cas_path, automatic_var_1, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1545)) ;
              }
    ...
    case 3 : {
      ...
      const GGS_M_semanticsEntitiesForUse  _temp_62436 = var_cas_ioEntitiesMap ;
      if (_temp_62436._isBuilt ()) {
        _temp_62436 (HERE)->method_searchKey (_inLexique, var_cas_className, var_cas_e COMMA_SOURCE_FILE_AT_LINE (1594)) ;
      }
      ...
      const GGS_AC_galgasType  _temp_62631 = var_cas_outResultType ;
      if (_temp_62631._isBuilt ()) {
        _temp_62631 (HERE)->method_handleConstructorCall (_inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques COMMA_SOURCE_FILE_AT_LINE (1597)) ;
      }
      GGS_typeExpressionList  var_cas_expressionList ;
      ...
      var_cas_outExpression = GGS_typeConstructorExpression::constructor_new (_inLexique, var_cas_className.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1609)), var_cas_mClassMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1610)), var_cas_expressionList COMMA_HERE) ;
      } break ;
    case 4 : {
      ...
      switch (select_expression_parser_13 (_inLexique)) {
        case 1 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          if (((var_cas_optionName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1619)))._operator_isNotEqual (GGS_string (true, "verbose_output"))).isBuiltAndTrue ()) {
            var_cas_optionName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this option name does not correspond to a builtin option") COMMA_SOURCE_FILE_AT_LINE (1620)) ;
          }
        ...
        case 2 : {
          ...
          const GGS_M_optionComponents  _temp_63743 = var_cas_inOptionsComponentsMapForUse ;
          if (_temp_63743._isBuilt ()) {
            _temp_63743 (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1630)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E) COMMA_HERE) ;
          GGS_lstring  var_cas_optionName ;
          _inLexique._assignFromAttribute_tokenString (var_cas_optionName) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
          if ((var_cas_boolOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1634)) COMMA_SOURCE_FILE_AT_LINE (1634))).isBuiltAndTrue ()) {
            var_cas_outExpression = GGS_typeBoolOption::constructor_new (_inLexique, var_cas_optionComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1635)), var_cas_optionName COMMA_HERE) ;
            var_cas_outResultType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
          }else if ((var_cas_uintOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1637)) COMMA_SOURCE_FILE_AT_LINE (1637))).isBuiltAndTrue ()) {
            var_cas_outExpression = GGS_typeUIntOption::constructor_new (_inLexique, var_cas_optionComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1638)), var_cas_optionName COMMA_HERE) ;
            var_cas_outResultType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
          }else if ((var_cas_stringOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1640)) COMMA_SOURCE_FILE_AT_LINE (1640))).isBuiltAndTrue ()) {
            var_cas_outExpression = GGS_typeStringOption::constructor_new (_inLexique, var_cas_optionComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1641)), var_cas_optionName COMMA_HERE) ;
            var_cas_outResultType = GGS_typeGalgas_string::constructor_new (_inLexique COMMA_HERE) ;
          }else{
            var_cas_optionName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '"))._operator_concat (var_cas_optionComponentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1644))))._operator_concat (GGS_string (true, "' option component has no '")))._operator_concat (var_cas_optionName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1644))))._operator_concat (GGS_string (true, "' option")) COMMA_SOURCE_FILE_AT_LINE (1645)) ;
...
void expression_parser::
expression_parser::
pr_read_access_expression_parser_1658_4_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (_inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1665)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_read_access_expression_parser_1658_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
}
...
void expression_parser::
expression_parser::
pr_read_access_expression_parser_1674_4_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_nomVariable,
                                GGS_typeCplusPlusName  &var_cas_nomCppEntite,
                                GGS_AC_galgasType  &var_cas_typeEntite,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
  if ((var_cas_ioVariablesMap.reader_hasKey (_inLexique, GGS_string (true, "self") COMMA_SOURCE_FILE_AT_LINE (1681))).isBuiltAndTrue ()) {
    var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, GGS_string (true, "self"), GGS_location (_inLexique) COMMA_HERE) ;
    var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (_inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1683)) ;
  }else{
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'self' is not defined in this context") COMMA_SOURCE_FILE_AT_LINE (1686)) ;
...
void expression_parser::
pr_read_access_expression_parser_1674_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
}
...
void expression_parser::
expression_parser::
pr_output_expression_list_expression_parser_1696_4_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inFormalAttributesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1725)))._operator_strictInf (var_cas_effectiveTypesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1725)))).isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much expressions") COMMA_SOURCE_FILE_AT_LINE (1726)) ;
  }else if (((var_cas_inFormalAttributesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1727)))._operator_strictSup (var_cas_effectiveTypesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1727)))).isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more expressions missing") COMMA_SOURCE_FILE_AT_LINE (1728)) ;
  }else{
    GGS_typeListeAttributsSemantiques::cEnumerator enumerator_67911 (var_cas_inFormalAttributesList, true) ;
    const GGS_typeListeAttributsSemantiques::cElement * operand_67911 = NULL ;
    GGS_typeTypesList::cEnumerator enumerator_67994 (var_cas_effectiveTypesList, true) ;
    const GGS_typeTypesList::cElement * operand_67994 = NULL ;
    while (((operand_67911 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_67911.nextObject ()))
        && ((operand_67994 = enumerator_67994.nextObject ()))) {
      macroValidPointer (operand_67911) ;
      macroValidPointer (operand_67994) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_67911->mAttributType,  operand_67994->mType,  operand_67994->mEndOfExpressionLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (1731)) ;
    }
    enumerator_67911.reset () ;
    enumerator_67994.reset () ;
  }
}
...
void expression_parser::
pr_output_expression_list_expression_parser_1696_4_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat_14 = true ;
    while (syntaxRepeat_14) {
      switch (select_repeat_expression_parser_14 (_inLexique)) {
        case 2 : {
...
void expression_parser::
expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_1743_4_ (galgas_scanner & _inLexique,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
        ...
        case 2 : {
          switch (select_expression_parser_16 (_inLexique)) {
            ...
            case 3 : {
              ...
              var_cas_jokerCount = var_cas_jokerCountWithLocation.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (1769)) ;
              GGS_uint _variant_69611 = var_cas_jokerCount._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (1770)) ;
              GGS_bool _condition_69611 (_variant_69611._isBuilt (), true) ;
              while (_condition_69611.isBuiltAndTrue ()) {
                _condition_69611 = (var_cas_jokerCount)._operator_strictSup (GGS_uint (true, 0U)) ;
                if (_condition_69611.isBuiltAndTrue ()) {
                  if (_variant_69611.uintValue () == 0) {
                    _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1773)) ;
                    _condition_69611 = GGS_bool (true, false) ;
                  }else{
                    _variant_69611._decrement_operation (_inLexique COMMA_HERE) ;
                    var_cas_argumentsList._addAssign_operation (GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE), GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
                    var_cas_jokerCount._decrement_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1773)) ;
                  }
                }
              }
              } break ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__29) COMMA_HERE) ;
  ::routine_buildMapWithLocalConstants (_inLexique,  var_cas_argumentsList,  var_cas_inFormalArgumentsList,  var_cas_ioVariablesMap,  var_cas_inVarLocation,  var_cas_inLocalConstantStyle,  var_cas_ellipsisFound COMMA_SOURCE_FILE_AT_LINE (1785)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_1743_4_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28) COMMA_HERE) ;
  { bool syntaxRepeat_15 = true ;
    while (syntaxRepeat_15) {
      switch (select_repeat_expression_parser_15 (_inLexique)) {
