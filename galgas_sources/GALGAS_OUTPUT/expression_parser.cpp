...
//                    september 29th, 2006, at 16h34'47"                     *
//                                                                           *
//---------------------------------------------------------------------------*
                ...
                if ((operand_11366 != NULL) && (operand_11391 != NULL)) {
                  ...
                  if ((operand_11366 != NULL) && (operand_11391 != NULL)) {
                    ...
                    if ((operand_11366 != NULL) && (operand_11391 != NULL)) {
                      ...
                      if ((operand_11366 != NULL) && (operand_11391 != NULL)) {
                        if (((operand_11366->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (292))) != (operand_11391->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (292)))).isBuiltAndTrue ()) {
                          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "comparison between a '@")) + (operand_11366->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (293))))) + (GGS_string (true, "' enumeration and a '@")))) + (operand_11391->mEnumTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (294))))) + (GGS_string (true, "' is not valid"))) SOURCE_FILE_AT_LINE (295)) ;
                        }
                      }else{
...
void routine_shift_types_check (C_Lexique & _inLexique,
                                ...
                                GGS_AC_galgasType  & var_cas_outResultType COMMA_UNUSED_LOCATION_ARGS) {
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_21425 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_21450 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_21425 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_21425) ;
    cPtr_typeGalgas_uint * operand_21450 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_21450) ;
    if ((operand_21425 != NULL) && (operand_21450 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_21425 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_21425) ;
      cPtr_typeGalgas_uint * operand_21450 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_21450) ;
      if ((operand_21425 != NULL) && (operand_21450 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_21425 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_21425) ;
        cPtr_typeGalgas_uint * operand_21450 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_21450) ;
        if ((operand_21425 != NULL) && (operand_21450 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_21425 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_21425) ;
          cPtr_typeGalgas_uint * operand_21450 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_21450) ;
          if ((operand_21425 != NULL) && (operand_21450 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_addition_types_check (C_Lexique & _inLexique,
                                ...
                                GGS_AC_galgasType  & var_cas_outResultType COMMA_UNUSED_LOCATION_ARGS) {
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_22639 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_22664 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_22639 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_22639) ;
    cPtr_typeGalgas_uint * operand_22664 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_22664) ;
    if ((operand_22639 != NULL) && (operand_22664 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_22639 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_22639) ;
      cPtr_typeGalgas_sint * operand_22664 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_22664) ;
      if ((operand_22639 != NULL) && (operand_22664 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_22639 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_22639) ;
        cPtr_typeGalgas_uint64 * operand_22664 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_22664) ;
        if ((operand_22639 != NULL) && (operand_22664 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_22639 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_22639) ;
          cPtr_typeGalgas_sint64 * operand_22664 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_22664) ;
          if ((operand_22639 != NULL) && (operand_22664 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_substraction_types_check (C_Lexique & _inLexique,
                                ...
                                GGS_AC_galgasType  & var_cas_outResultType COMMA_UNUSED_LOCATION_ARGS) {
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_23864 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_23889 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_23864 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_23864) ;
    cPtr_typeGalgas_uint * operand_23889 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_23889) ;
    if ((operand_23864 != NULL) && (operand_23889 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_23864 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_23864) ;
      cPtr_typeGalgas_sint * operand_23889 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_23889) ;
      if ((operand_23864 != NULL) && (operand_23889 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_23864 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_23864) ;
        cPtr_typeGalgas_uint64 * operand_23889 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_23889) ;
        if ((operand_23864 != NULL) && (operand_23889 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_23864 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_23864) ;
          cPtr_typeGalgas_sint64 * operand_23889 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_23889) ;
          if ((operand_23864 != NULL) && (operand_23889 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_stringset * operand_23864 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_23864) ;
            cPtr_typeGalgas_stringset * operand_23889 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_23889) ;
            if ((operand_23864 != NULL) && (operand_23889 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
...
void routine_multiply_types_check (C_Lexique & _inLexique,
  ...
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    ...
    if ((operand_25195 != NULL) && (operand_25220 != NULL)) {
      ...
      cPtr_typeGalgas_sint * operand_25220 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_25220) ;
      if ((operand_25195 != NULL) && (operand_25220 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_25195 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_25195) ;
        cPtr_typeGalgas_uint64 * operand_25220 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_25220) ;
        if ((operand_25195 != NULL) && (operand_25220 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_25195 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_25195) ;
          cPtr_typeGalgas_sint64 * operand_25220 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_25220) ;
          if ((operand_25195 != NULL) && (operand_25220 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_divide_types_check (C_Lexique & _inLexique,
                                ...
                                GGS_AC_galgasType  & var_cas_outResultType COMMA_UNUSED_LOCATION_ARGS) {
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_26420 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_26445 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_26420 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_26420) ;
    cPtr_typeGalgas_uint * operand_26445 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_26445) ;
    if ((operand_26420 != NULL) && (operand_26445 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_26420 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_26420) ;
      cPtr_typeGalgas_sint * operand_26445 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_26445) ;
      if ((operand_26420 != NULL) && (operand_26445 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_26420 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_26420) ;
        cPtr_typeGalgas_uint64 * operand_26445 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_26445) ;
        if ((operand_26420 != NULL) && (operand_26445 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_26420 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_26420) ;
          cPtr_typeGalgas_sint64 * operand_26445 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_26445) ;
          if ((operand_26420 != NULL) && (operand_26445 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_modulo_types_check (C_Lexique & _inLexique,
                                ...
                                GGS_AC_galgasType  & var_cas_outResultType COMMA_UNUSED_LOCATION_ARGS) {
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_27639 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_27664 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_27639 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27639) ;
    cPtr_typeGalgas_uint * operand_27664 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_27664) ;
    if ((operand_27639 != NULL) && (operand_27664 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_27639 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27639) ;
      cPtr_typeGalgas_sint * operand_27664 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_27664) ;
      if ((operand_27639 != NULL) && (operand_27664 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_27639 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_27639) ;
        cPtr_typeGalgas_uint64 * operand_27664 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_27664) ;
        if ((operand_27639 != NULL) && (operand_27664 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_27639 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_27639) ;
          cPtr_typeGalgas_sint64 * operand_27664 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_27664) ;
          if ((operand_27639 != NULL) && (operand_27664 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
pr_factor_expression_parser_948_14_ (galgas_scanner & _inLexique,
  ...
  GGS_lstring  var_cas_35691 ;
  nt_read_access_ (_inLexique, var_cas_35691, var_cas_nomCppEntite1, var_cas_outResultType, var_cas_ioVariablesMap) ;
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1213_14_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &/* var_cas_ioEntitiesMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMapForUse */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
                                GGS_typeExpression  &var_cas_outExpression,
...
void expression_parser::
pr_factor_expression_parser_1213_14_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_here) ;
}
...
void expression_parser::
expression_parser::
pr_factor_expression_parser_1234_14_ (galgas_scanner & _inLexique,
                                GGS_M_semanticsEntitiesForUse  &var_cas_ioEntitiesMap,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMapForUse,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
                                GGS_typeExpression  &var_cas_outExpression,
  ...
  switch (select_expression_parser_6 (_inLexique)) {
    case 1 : {
      ...
      ::routine_handleReaderCall (_inLexique,  var_cas_expressionType,  var_cas_methodName,  var_cas_accessorsTypeList,  var_cas_outResultType SOURCE_FILE_AT_LINE (1258)) ;
    ...
    case 2 : {
      ...
      if (var_cas_ioEntitiesMap._isBuilt ()) {
        var_cas_ioEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_className, var_cas_e SOURCE_FILE_AT_LINE (1277)) ;
      }
      { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_e.getPtr ()) ;
        if (ptrExtraire_ == NULL) {
          ...
          if (var_cas_e.getPtr () != NULL) {
            ...
            var_cas_className.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (1278)) ;
          }
        }else{
          macroValidPointer (ptrExtraire_) ;
      ...
      if (var_cas_outResultType._isBuilt ()) {
        var_cas_outResultType (HERE)->method_handleConstructorCall (_inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques SOURCE_FILE_AT_LINE (1280)) ;
      }
      GGS_typeExpressionList  var_cas_expressionList ;
    ...
    case 3 : {
      ...
      switch (select_expression_parser_7 (_inLexique)) {
        case 1 : {
          ...
          if (((var_cas_optionName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1297))) != (GGS_string (true, "verbose_output"))).isBuiltAndTrue ()) {
            var_cas_optionName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this option name does not correspond to a builtin option") SOURCE_FILE_AT_LINE (1299)) ;
          }
        ...
        case 2 : {
          ...
          if (var_cas_ioOptionsComponentsMapForUse._isBuilt ()) {
            var_cas_ioOptionsComponentsMapForUse (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap SOURCE_FILE_AT_LINE (1308)) ;
          }
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__2E) ;
          GGS_lstring  var_cas_optionName ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
          var_cas_optionName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
          if ((var_cas_boolOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1312)) SOURCE_FILE_AT_LINE (1312))).isBuiltAndTrue ()) {
            var_cas_outExpression = GGS_typeBoolOption::constructor_new (_inLexique, var_cas_optionComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1313)), var_cas_optionName COMMA_HERE) ;
            var_cas_outResultType = GGS_typeGalgas_bool::constructor_new (_inLexique COMMA_HERE) ;
          }else if ((var_cas_uintOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1315)) SOURCE_FILE_AT_LINE (1315))).isBuiltAndTrue ()) {
            var_cas_outExpression = GGS_typeUIntOption::constructor_new (_inLexique, var_cas_optionComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1316)), var_cas_optionName COMMA_HERE) ;
            var_cas_outResultType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
          }else if ((var_cas_stringOptionsMap.reader_hasKey (_inLexique, var_cas_optionName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1318)) SOURCE_FILE_AT_LINE (1318))).isBuiltAndTrue ()) {
            var_cas_outExpression = GGS_typeStringOption::constructor_new (_inLexique, var_cas_optionComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1319)), var_cas_optionName COMMA_HERE) ;
            var_cas_outResultType = GGS_typeGalgas_uint::constructor_new (_inLexique COMMA_HERE) ;
          }else{
            var_cas_optionName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((((((GGS_string (true, "the '")) + (var_cas_optionComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1322))))) + (GGS_string (true, "' option component has no '")))) + (var_cas_optionName.reader_string (_inLexique SOURCE_FILE_AT_LINE (1322))))) + (GGS_string (true, "' option"))) SOURCE_FILE_AT_LINE (1324)) ;
...
void expression_parser::
pr_factor_expression_parser_1234_14_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__5B) ;
  switch (select_expression_parser_6 (_inLexique)) {
    case 1 : {
      nt_expression_parse (_inLexique) ;
...
void expression_parser::
expression_parser::
pr_read_access_expression_parser_1336_19_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioVariablesMap.method_searchForReadOnlyAccess (_inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite SOURCE_FILE_AT_LINE (1343)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_read_access_expression_parser_1336_19_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
}
...
void expression_parser::
expression_parser::
pr_read_access_expression_parser_1352_19_ (galgas_scanner & _inLexique,
                                GGS_lstring  &var_cas_nomVariable,
                                GGS_typeCplusPlusName  &var_cas_nomCppEntite,
                                GGS_AC_galgasType  &var_cas_typeEntite,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_self) ;
  if ((var_cas_ioVariablesMap.reader_hasKey (_inLexique, GGS_string (true, "self") SOURCE_FILE_AT_LINE (1359))).isBuiltAndTrue ()) {
    var_cas_nomVariable = GGS_lstring::constructor_new (_inLexique, GGS_string (true, "self"), GGS_location (_inLexique) COMMA_HERE) ;
    var_cas_ioVariablesMap.method_searchForReadOnlyAccess (_inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite SOURCE_FILE_AT_LINE (1361)) ;
  }else{
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "'self' is not defined in this context") SOURCE_FILE_AT_LINE (1365)) ;
...
void expression_parser::
pr_read_access_expression_parser_1352_19_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_self) ;
}
...
void expression_parser::
expression_parser::
pr_output_expression_list_expression_parser_1374_30_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inFormalAttributesList.reader_length (_inLexique SOURCE_FILE_AT_LINE (1401))) < (var_cas_effectiveTypesList.reader_length (_inLexique SOURCE_FILE_AT_LINE (1401)))).isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much expressions") SOURCE_FILE_AT_LINE (1403)) ;
  }else if (((var_cas_inFormalAttributesList.reader_length (_inLexique SOURCE_FILE_AT_LINE (1403))) > (var_cas_effectiveTypesList.reader_length (_inLexique SOURCE_FILE_AT_LINE (1403)))).isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more expressions missing") SOURCE_FILE_AT_LINE (1405)) ;
  }else{
    GGS_typeListeAttributsSemantiques::element_type * operand_53932 = var_cas_inFormalAttributesList.firstObject () ;
    GGS_typeTypesList::element_type * operand_54027 = var_cas_effectiveTypesList.firstObject () ;
    while ((operand_53932 != NULL)
        && (operand_54027 != NULL)) {
      macroValidPointer (operand_53932) ;
      macroValidPointer (operand_54027) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_53932->mAttributType,  operand_54027->mType,  operand_54027->mEndOfExpressionLocation,  GGS_bool (true, true) SOURCE_FILE_AT_LINE (1408)) ;
      operand_53932 = operand_53932->nextObject () ;
      operand_54027 = operand_54027->nextObject () ;
    }
  }
}
...
void expression_parser::
pr_output_expression_list_expression_parser_1374_30_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_expression_parser_8 (_inLexique)) {
        case 2 : {
...
void expression_parser::
expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_1419_45_ (galgas_scanner & _inLexique,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__29) ;
  ::routine_buildMapWithLocalConstants (_inLexique,  var_cas_argumentsList,  var_cas_inFormalArgumentsList,  var_cas_ioVariablesMap,  var_cas_inVarLocation,  var_cas_inLocalConstantStyle,  var_cas_ellipsisFound SOURCE_FILE_AT_LINE (1452)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_1419_45_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_expression_parser_9 (_inLexique)) {
