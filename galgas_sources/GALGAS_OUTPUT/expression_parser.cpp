...
pr_factor_expression_parser_1503_13_ (galgas_scanner & inLexique,
  ...
  switch (select_expression_parser_9 (inLexique)) {
    ...
    case 3 : {
      ...
      var_cas_outResultType = GGS_typeEntiteType::castFrom (inLexique, var_cas_e.getPtr (), true, var_cas_className COMMA_SOURCE_FILE_AT_LINE (1601)).reader_aDefType (inLexique COMMA_SOURCE_FILE_AT_LINE (1601)) ;
