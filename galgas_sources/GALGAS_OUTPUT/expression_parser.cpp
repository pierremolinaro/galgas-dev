  ...
  switch (select_expression_parser_6 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_ioEntitiesMap._isBuilt ()) {
        var_cas_ioEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_castedTypeName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1178)) ;
      }
      ...
      if (var_cas_errorLocationExpressionType._isBuilt ()) {
        var_cas_errorLocationExpressionType (HERE)->method_checkAbilityToBeSilentlyConvertedToLocation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1210)) ;
      }
...
pr_factor_expression_parser_1495_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_expression_parser_9 (_inLexique)) {
    case 1 : {
      ...
      if (var_cas_inFileWrappers._isBuilt ()) {
        var_cas_inFileWrappers (HERE)->method_searchKey (_inLexique, var_cas_filewrapperName, var_cas_regularFileMap COMMA_SOURCE_FILE_AT_LINE (1511)) ;
      }
      switch (select_expression_parser_10 (_inLexique)) {
        ...
        case 2 : {
          ...
          if (var_cas_regularFileMap._isBuilt ()) {
            var_cas_regularFileMap (HERE)->method_searchKey (_inLexique, var_cas_path, automatic_var_1, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1522)) ;
          }
    ...
    case 3 : {
      ...
      if (var_cas_ioEntitiesMap._isBuilt ()) {
        var_cas_ioEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_className, var_cas_e COMMA_SOURCE_FILE_AT_LINE (1570)) ;
      }
      ...
      if (var_cas_outResultType._isBuilt ()) {
        var_cas_outResultType (HERE)->method_handleConstructorCall (_inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques COMMA_SOURCE_FILE_AT_LINE (1573)) ;
      }
      GGS_typeExpressionList  var_cas_expressionList ;
      ...
      switch (select_expression_parser_12 (_inLexique)) {
        ...
        case 2 : {
          ...
          if (var_cas_inOptionsComponentsMapForUse._isBuilt ()) {
            var_cas_inOptionsComponentsMapForUse (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1606)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E) COMMA_HERE) ;
          GGS_lstring  var_cas_optionName ;
          _inLexique._assignFromAttribute_tokenString (var_cas_optionName) ;
