...
//                    december 14th, 2009, at 18h42'45"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_factor_expression_parser_1122_13_ (galgas_scanner & inLexique,
  ...
  GGS_lstring  automatic_var_44243_0 ;
  nt_read_access_ (inLexique, automatic_var_44243_0, var_cas_nomCppEntite1, var_cas_outResultType, var_cas_ioVariablesMap) ;
...
pr_factor_expression_parser_1539_13_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  GGS_AC_semanticsEntity  automatic_var_60880_0 ;
  const GGS_M_semanticsEntitiesForUse  temp_60866 = var_cas_inEntitiesMap ;
  if (temp_60866.isBuilt ()) {
    temp_60866 (HERE)->method_searchKey (inLexique, var_cas_typeName, automatic_var_60880_0 COMMA_SOURCE_FILE_AT_LINE (1549)) ;
  }
...
pr_factor_expression_parser_1749_13_ (galgas_scanner & inLexique,
  ...
  switch (select_expression_parser_8 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      const GGS_bool cond_68003 = (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1762))).operator_isNotEqual (GGS_string ("verbose_output")) ;
      if (cond_68003.isBuiltAndTrue ()) {
        var_cas_optionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this option name does not correspond to a builtin option") COMMA_SOURCE_FILE_AT_LINE (1764)) ;
      }
      GGS_lstring  var_cas_readerName ;
      inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      const GGS_bool cond_68149 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1766))).operator_isEqual (GGS_string ("value")) ;
      if (cond_68149.isBuiltAndTrue ()) {
        var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_HERE) ;
      }else if (cond_68149.isBuiltAndFalse ()) {
        const GGS_bool cond_68242 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1768))).operator_isEqual (GGS_string ("char")) ;
        if (cond_68242.isBuiltAndTrue ()) {
          var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_HERE) ;
        }else if (cond_68242.isBuiltAndFalse ()) {
          const GGS_bool cond_68337 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1770))).operator_isEqual (GGS_string ("string")) ;
          if (cond_68337.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_HERE) ;
          }else if (cond_68337.isBuiltAndFalse ()) {
            const GGS_bool cond_68434 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1772))).operator_isEqual (GGS_string ("comment")) ;
            if (cond_68434.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
            }else if (cond_68434.isBuiltAndFalse ()) {
              var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'value', 'char', 'string' and 'comment' readers are defined") COMMA_SOURCE_FILE_AT_LINE (1776)) ;
              var_cas_outResultType.drop () ;
            }
          }
        }
      }
      var_cas_outExpression = GGS_typeOptionAccess ::constructor_new (inLexique, GGS_string ("galgas_cli_options"), var_cas_optionName, var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1777)) COMMA_HERE) ;
      } break ;
    case 2 : {
      ...
      const GGS_M_optionComponents  temp_68869 = var_cas_inOptionsComponentsMapForUse ;
      if (temp_68869.isBuilt ()) {
        temp_68869 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1783)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E_) COMMA_HERE) ;
      GGS_lstring  var_cas_optionName ;
      inLexique.assignFromAttribute_tokenString (var_cas_optionName) ;
      ...
      inLexique.assignFromAttribute_tokenString (var_cas_readerName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      const GGS_bool cond_69612 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1787))).operator_isEqual (GGS_string ("value")) ;
      if (cond_69612.isBuiltAndTrue ()) {
        const GGS_bool cond_69197 = var_cas_boolOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1788))) ;
        if (cond_69197.isBuiltAndTrue ()) {
          var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_HERE) ;
        }else if (cond_69197.isBuiltAndFalse ()) {
          const GGS_bool cond_69309 = var_cas_uintOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1790))) ;
          if (cond_69309.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_HERE) ;
          }else if (cond_69309.isBuiltAndFalse ()) {
            const GGS_bool cond_69424 = var_cas_stringOptionsMap.reader_hasKey (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1792))) ;
            if (cond_69424.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
            }else if (cond_69424.isBuiltAndFalse ()) {
              var_cas_optionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1795)))).operator_concat (GGS_string ("' option component has no '"))).operator_concat (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1795)))).operator_concat (GGS_string ("' option")) COMMA_SOURCE_FILE_AT_LINE (1797)) ;
              var_cas_outResultType.drop () ;
            }
          }
        }
      }else if (cond_69612.isBuiltAndFalse ()) {
        const GGS_bool cond_69705 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1798))).operator_isEqual (GGS_string ("char")) ;
        if (cond_69705.isBuiltAndTrue ()) {
          var_cas_outResultType = GGS_typeGalgas_char ::constructor_new (inLexique COMMA_HERE) ;
        }else if (cond_69705.isBuiltAndFalse ()) {
          const GGS_bool cond_69802 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1800))).operator_isEqual (GGS_string ("string")) ;
          if (cond_69802.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
          }else if (cond_69802.isBuiltAndFalse ()) {
            const GGS_bool cond_69899 = (var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1802))).operator_isEqual (GGS_string ("comment")) ;
            if (cond_69899.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
            }else if (cond_69899.isBuiltAndFalse ()) {
              var_cas_readerName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the 'value', 'char', 'string' and 'comment' readers are defined") COMMA_SOURCE_FILE_AT_LINE (1806)) ;
              var_cas_outResultType.drop () ;
            }
          }
        }
      }
      var_cas_outExpression = GGS_typeOptionAccess ::constructor_new (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1807)), var_cas_optionName, var_cas_readerName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1807)) COMMA_HERE) ;
      } break ;
    default :
      break ;
  }
...
void expression_parser::
pr_factor_expression_parser_1822_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  const GGS_M_filewrappers  temp_71391 = var_cas_inSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (1837)) ;
  if (temp_71391.isBuilt ()) {
    temp_71391 (HERE)->method_searchKey (inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1837)) ;
  }
    ...
    case 2 : {
      ...
      switch (select_expression_parser_10 (inLexique)) {
        case 1 : {
          ...
          const GGS_filewrapperTemplateMap  temp_71799 = var_cas_templateMap ;
          if (temp_71799.isBuilt ()) {
            temp_71799 (HERE)->method_searchKey (inLexique, var_cas_templateName, var_cas_formalAttributeList COMMA_SOURCE_FILE_AT_LINE (1849)) ;
          }
          GGS_typeExpressionList  var_cas_expressionList ;
        ...
        case 2 : {
          ...
          GGS_uint  automatic_var_72459_0 ;
          const GGS_M_regularFiles  temp_72431 = var_cas_regularFileMap ;
          if (temp_72431.isBuilt ()) {
            temp_72431 (HERE)->method_searchKey (inLexique, var_cas_path, automatic_var_72459_0, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1869)) ;
          }
...
void expression_parser::
pr_factor_expression_parser_1822_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_filewrapper) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  switch (select_expression_parser_9 (inLexique)) {
...
void expression_parser::
pr_factor_expression_parser_1884_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_73587 = var_cas_inEntitiesMap ;
  if (temp_73587.isBuilt ()) {
    temp_73587 (HERE)->method_searchKey (inLexique, var_cas_functionName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1897)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_74167 = var_cas_entite ; // CAST instruction
    if (_var_74167.getPtr () != NULL) {
      macroValidPointer (_var_74167.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteFonction *> (_var_74167.getPtr ()) != NULL) {
        const GGS_typeEntiteFonction var_cas_r (_var_74167.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_r.reader_aListeArgumentsFormels (inLexique COMMA_SOURCE_FILE_AT_LINE (1901)) ;
        var_cas_outResultType = var_cas_r.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1902)) ;
        var_cas_isExternActionCall = GGS_bool (false) ;
      }else if (dynamic_cast <cPtr_typeEntiteFonctionExterne *> (_var_74167.getPtr ()) != NULL) {
        const GGS_typeEntiteFonctionExterne var_cas_ae (_var_74167.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_ae.reader_aSignature (inLexique COMMA_SOURCE_FILE_AT_LINE (1905)) ;
        var_cas_outResultType = var_cas_ae.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1906)) ;
        var_cas_isExternActionCall = GGS_bool (true) ;
      }else{
        var_cas_functionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'")).operator_concat (var_cas_functionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1910)))).operator_concat (GGS_string ("' should name a function or an extern function")) COMMA_SOURCE_FILE_AT_LINE (1913)) ;
  ...
  {
    GGS_L_EXsignature::cEnumerator enumerator_74335 (var_cas_signatureRoutine, true) ;
    const GGS_L_EXsignature::cElement * operand_74335 = NULL ;
    while (((operand_74335 = enumerator_74335.nextObject ()))) {
      macroValidPointer (operand_74335) ;
      var_cas_listeAttributsSemantiques.addAssign_operation (operand_74335->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  nt_output_expression_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
...
void expression_parser::
pr_factor_expression_parser_1884_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  nt_output_expression_list_parse (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5D_) COMMA_HERE) ;
...
void expression_parser::
pr_read_access_expression_parser_1939_18_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1946)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_read_access_expression_parser_1939_18_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  GGS_lstring::constructor_retrieveAndResetTemplateString (inLexique COMMA_HERE) ;
}
...
void expression_parser::
pr_read_access_expression_parser_1955_18_ (galgas_scanner & inLexique,
                                GGS_lstring  &var_cas_nomVariable,
                                GGS_typeCplusPlusName  &var_cas_nomCppEntite,
                                GGS_AC_galgasType  &var_cas_typeEntite,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
  const GGS_bool cond_76136 = var_cas_ioVariablesMap.reader_hasKey (GGS_string ("self")) ;
  if (cond_76136.isBuiltAndTrue ()) {
    var_cas_nomVariable = GGS_lstring ::constructor_new (inLexique, GGS_string ("self"), GGS_location (inLexique) COMMA_HERE) ;
    var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1964)) ;
  }else if (cond_76136.isBuiltAndFalse ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'self' is not defined in this context") COMMA_SOURCE_FILE_AT_LINE (1968)) ;
...
void expression_parser::
pr_read_access_expression_parser_1955_18_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
  GGS_lstring::constructor_retrieveAndResetTemplateString (inLexique COMMA_HERE) ;
}
...
void expression_parser::
pr_output_expression_list_expression_parser_1977_29_ (galgas_scanner & inLexique,
  ...
  const GGS_bool cond_77697 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictInf (var_cas_effectiveTypesList.reader_length ()) ;
  if (cond_77697.isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("too much expressions") COMMA_SOURCE_FILE_AT_LINE (2008)) ;
  }else if (cond_77697.isBuiltAndFalse ()) {
    const GGS_bool cond_77837 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictSup (var_cas_effectiveTypesList.reader_length ()) ;
    if (cond_77837.isBuiltAndTrue ()) {
      var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more expressions missing") COMMA_SOURCE_FILE_AT_LINE (2010)) ;
    }else if (cond_77837.isBuiltAndFalse ()) {
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_77872 (var_cas_inFormalAttributesList, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_77872 = NULL ;
        GGS_typeTypesList::cEnumerator enumerator_77892 (var_cas_effectiveTypesList, true) ;
        const GGS_typeTypesList::cElement * operand_77892 = NULL ;
        while (((operand_77872 = enumerator_77872.nextObject ()))
            && ((operand_77892 = enumerator_77892.nextObject ()))) {
          macroValidPointer (operand_77872) ;
          macroValidPointer (operand_77892) ;
          ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_77872->mAttributType,  operand_77892->mType,  operand_77892->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (2012)) ;
        }
      }
    }
  }
...
void expression_parser::
pr_output_expression_list_expression_parser_1977_29_parse (galgas_scanner & inLexique) {
  { bool syntaxRepeat_11 = true ;
    while (syntaxRepeat_11) {
      switch (select_expression_parser_11 (inLexique)) {
        case 2 : {
...
void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_2023_44_ (galgas_scanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
        ...
        case 2 : {
          switch (select_expression_parser_13 (inLexique)) {
            ...
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2A_) COMMA_HERE) ;
              GGS_uint  var_cas_jokerCount = var_cas_jokerCountWithLocation.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (2050)) ;
              GGS_uint _variant_79465 = var_cas_jokerCount.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (2051)) ;
              GGS_bool _condition_79465 (_variant_79465.isBuilt (), true) ;
              while (_condition_79465.isBuiltAndTrue ()) {
                _condition_79465 = (var_cas_jokerCount).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_79465.isBuiltAndTrue ()) {
                  if (_variant_79465.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2055)) ;
                    _condition_79465 = GGS_bool (false) ;
                  }else{
                    _variant_79465.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_argumentsList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
                    var_cas_jokerCount.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (2054)) ;
                  }
                }
              }
              } break ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__29_) COMMA_HERE) ;
  ::routine_buildMapWithLocalConstants (inLexique,  var_cas_inEnumeratorNewStyle,  var_cas_argumentsList,  var_cas_inFormalArgumentsList,  var_cas_ioVariablesMap,  var_cas_inVarLocation,  var_cas_inLocalConstantStyle,  var_cas_ellipsisFound COMMA_SOURCE_FILE_AT_LINE (2067)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_2023_44_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28_) COMMA_HERE) ;
  { bool syntaxRepeat_12 = true ;
    while (syntaxRepeat_12) {
      switch (select_expression_parser_12 (inLexique)) {
