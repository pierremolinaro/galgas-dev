...
pr_factor_expression_parser_1111_4_ (galgas_scanner & _inLexique,
  ...
  var_cas_outExpression = GGS_typeVarInExpression ::constructor_new (_inLexique, var_cas_nomCppEntite1, GGS_lstringlist ::constructor_emptyList (_inLexique COMMA_HERE) COMMA_HERE) ;
}
...
pr_factor_expression_parser_1496_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_expression_parser_9 (_inLexique)) {
    ...
    case 3 : {
      ...
      const GGS_AC_galgasType  _temp_62731 = var_cas_outResultType ;
      if (_temp_62731._isBuilt ()) {
        _temp_62731 (HERE)->method_handleConstructorCall (_inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques COMMA_SOURCE_FILE_AT_LINE (1597)) ;
      }
      GGS_typeExpressionList  var_cas_expressionList ;
      ...
      var_cas_outExpression = GGS_typeConstructorExpression ::constructor_new (_inLexique, var_cas_outResultType, var_cas_mClassMethodName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1610)), var_cas_expressionList COMMA_HERE) ;
      } break ;
    case 4 : {
      ...
      switch (select_expression_parser_13 (_inLexique)) {
        ...
        case 2 : {
          ...
          const GGS_M_optionComponents  _temp_63838 = var_cas_inOptionsComponentsMapForUse ;
          if (_temp_63838._isBuilt ()) {
            _temp_63838 (HERE)->method_searchKey (_inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1630)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E) COMMA_HERE) ;
          GGS_lstring  var_cas_optionName ;
          _inLexique._assignFromAttribute_tokenString (var_cas_optionName) ;
...
pr_output_expression_list_expression_parser_1696_4_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inFormalAttributesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1725)))._operator_strictInf (var_cas_effectiveTypesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1725)))).isBuiltAndTrue ()) {
    ...
    {
      GGS_typeListeAttributsSemantiques::cEnumerator enumerator_68008 (var_cas_inFormalAttributesList, true) ;
      const GGS_typeListeAttributsSemantiques::cElement * operand_68008 = NULL ;
      GGS_typeTypesList::cEnumerator enumerator_68091 (var_cas_effectiveTypesList, true) ;
      const GGS_typeTypesList::cElement * operand_68091 = NULL ;
      while (((operand_68008 = (GGS_typeListeAttributsSemantiques::cElement *) enumerator_68008.nextObject ()))
          && ((operand_68091 = enumerator_68091.nextObject ()))) {
        macroValidPointer (operand_68008) ;
        macroValidPointer (operand_68091) ;
        ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_68008->mAttributType,  operand_68091->mType,  operand_68091->mEndOfExpressionLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (1731)) ;
      }
    }
  }
}
        ...
        case 2 : {
          switch (select_expression_parser_16 (_inLexique)) {
            ...
            case 3 : {
              ...
              GGS_uint _variant_69709 = var_cas_jokerCount._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (1770)) ;
              GGS_bool _condition_69709 (_variant_69709._isBuilt (), true) ;
              while (_condition_69709.isBuiltAndTrue ()) {
                _condition_69709 = (var_cas_jokerCount)._operator_strictSup (GGS_uint (true, 0U)) ;
                if (_condition_69709.isBuiltAndTrue ()) {
                  if (_variant_69709.uintValue () == 0) {
                    _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1773)) ;
                    _condition_69709 = GGS_bool (true, false) ;
                  }else{
                    _variant_69709._decrement_operation (_inLexique COMMA_HERE) ;
                    var_cas_argumentsList._addAssign_operation (GGS_lstring ::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE), GGS_lstring ::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
