...
pr_factor_expression_parser_769_14_ (galgas_scanner & lexique_var_,
  ...
  switch (select_expression_parser_4 (lexique_var_)) {
    ...
    case 3 : {
      ...
      var_cas_ioOptionsComponentsMapForUse.methode_searchKey (lexique_var_, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap) ;
      lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__2E) ;
...
void expression_parser::
pr_read_access_expression_parser_856_19_ (galgas_scanner & lexique_var_,
...
void expression_parser::
pr_read_access_expression_parser_856_19_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
}
...
void expression_parser::
pr_output_expression_list_expression_parser_872_30_ (galgas_scanner & lexique_var_,
  ...
  if (((var_cas_inFormalAttributesList.reader_length ()) < (var_cas_effectiveTypesList.reader_length ())).isBuiltAndTrue ()) {
    ...
    GGS_typeListeAttributsSemantiques::element_type * operand_33971 = var_cas_inFormalAttributesList.firstObject () ;
    GGS_typeTypesList::element_type * operand_34066 = var_cas_effectiveTypesList.firstObject () ;
    while ((operand_33971 != NULL)
        && (operand_34066 != NULL)) {
      macroValidPointer (operand_33971) ;
      macroValidPointer (operand_34066) ;
      ::routine_verifierCompatibiliteTypesSemantiques (lexique_var_,  operand_33971->mAttributType,  operand_34066->mType,  operand_34066->mEndOfExpressionLocation) ;
      operand_33971 = operand_33971->nextObject () ;
      operand_34066 = operand_34066->nextObject () ;
    }
  }
}
...
void expression_parser::
pr_output_expression_list_expression_parser_872_30_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_expression_parser_5 (lexique_var_)) {
        case 2 : {
...
void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_917_45_ (galgas_scanner & lexique_var_,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
...
void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_917_45_parse (galgas_scanner & lexique_var_) {
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__28) ;
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_expression_parser_6 (lexique_var_)) {
