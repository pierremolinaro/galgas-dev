    ...
    case 2 : {
      ...
      switch (select_expression_5F_parser_11 (inLexique)) {
        ...
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_literal_5F_string) COMMA_HERE) ;
          const GGS_bool cond_75048 = (var_cas_path.ggs_string ().reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
          if (cond_75048.isBuiltAndTrue ()) {
          ...
          }else if (cond_75048.isBuiltAndFalse ()) {
          ...
          GGS_uint  automatic_var_75226_0 ;
          if (var_cas_regularFileMap.isBuilt ()) {
            var_cas_regularFileMap (HERE)->method_searchKey (inLexique, var_cas_path, automatic_var_75226_0, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1942)) ;
          }
...
void expression_parser::rule_expression_5F_parser_primary_i29_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  { const GGS_AC_semanticsEntity _var_76934 = var_cas_entite ; // CAST instruction
    if (_var_76934.getPtr () != NULL) {
      macroValidPointer (_var_76934.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteFonction *> (_var_76934.getPtr ()) != NULL) {
        const GGS_typeEntiteFonction var_cas_r (_var_76934.getPtr ()) ;
      ...
      }else if (dynamic_cast <cPtr_typeEntiteFonctionExterne *> (_var_76934.getPtr ()) != NULL) {
        const GGS_typeEntiteFonctionExterne var_cas_ae (_var_76934.getPtr ()) ;
  ...
  {
    GGS_L_EXsignature::cEnumerator enumerator_77102 (var_cas_signatureRoutine, true) ;
    const GGS_L_EXsignature::cElement * operand_77102 = NULL ;
    while (((operand_77102 = enumerator_77102.nextObject ()))) {
      macroValidPointer (operand_77102) ;
      var_cas_listeAttributsSemantiques.addAssign_operation (operand_77102->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1991))) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__5B_) COMMA_HERE) ;
  nt_output_5F_expression_5F_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
...
void expression_parser::rule_expression_5F_parser_read_5F_access_i31_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_78907 = var_cas_ioVariablesMap.reader_hasKey (GGS_string ("self")) ;
  if (cond_78907.isBuiltAndTrue ()) {
  ...
  }else if (cond_78907.isBuiltAndFalse ()) {
...
void expression_parser::rule_expression_5F_parser_output_5F_expression_5F_list_i32_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_80471 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictInf (var_cas_effectiveTypesList.reader_length ()) ;
  if (cond_80471.isBuiltAndTrue ()) {
  ...
  }else if (cond_80471.isBuiltAndFalse ()) {
    const GGS_bool cond_80611 = (var_cas_inFormalAttributesList.reader_length ()).operator_strictSup (var_cas_effectiveTypesList.reader_length ()) ;
    if (cond_80611.isBuiltAndTrue ()) {
    ...
    }else if (cond_80611.isBuiltAndFalse ()) {
      {
        GGS_typeListeAttributsSemantiques::cEnumerator enumerator_80646 (var_cas_inFormalAttributesList, true) ;
        const GGS_typeListeAttributsSemantiques::cElement * operand_80646 = NULL ;
        GGS_typeTypesList::cEnumerator enumerator_80666 (var_cas_effectiveTypesList, true) ;
        const GGS_typeTypesList::cElement * operand_80666 = NULL ;
        while (((operand_80646 = enumerator_80646.nextObject ()))
            && ((operand_80666 = enumerator_80666.nextObject ()))) {
          macroValidPointer (operand_80646) ;
          macroValidPointer (operand_80666) ;
          ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_80646->mAttributType,  operand_80666->mType,  operand_80666->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (2085)) ;
        }
      }
    }
  }
        ...
        case 2 : {
          switch (select_expression_5F_parser_14 (inLexique)) {
            ...
            case 3 : {
              ...
              GGS_uint _variant_82239 = var_cas_jokerCount.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (2124)) ;
              GGS_bool _condition_82239 (_variant_82239.isBuilt (), true) ;
              while (_condition_82239.isBuiltAndTrue ()) {
                _condition_82239 = (var_cas_jokerCount).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_82239.isBuiltAndTrue ()) {
                  if (_variant_82239.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2128)) ;
                    _condition_82239 = GGS_bool (false) ;
                  }else{
                    _variant_82239.decrement_operation (inLexique COMMA_HERE) ;
