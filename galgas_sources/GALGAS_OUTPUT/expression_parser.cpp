...
void routine_magnitude_comparison_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_15805 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_15830 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_stringset * operand_15805 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_15805) ;
    cPtr_typeGalgas_stringset * operand_15830 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_15830) ;
    if ((operand_15805 != NULL) && (operand_15830 != NULL)) {
    }else{
      cPtr_typeGalgas_bool * operand_15805 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_15805) ;
      cPtr_typeGalgas_bool * operand_15830 = dynamic_cast <cPtr_typeGalgas_bool *> (ptr_15830) ;
      if ((operand_15805 != NULL) && (operand_15830 != NULL)) {
      }else{
        cPtr_typeGalgas_char * operand_15805 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_15805) ;
        cPtr_typeGalgas_char * operand_15830 = dynamic_cast <cPtr_typeGalgas_char *> (ptr_15830) ;
        if ((operand_15805 != NULL) && (operand_15830 != NULL)) {
        }else{
          cPtr_typeGalgas_uint * operand_15805 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_15805) ;
          cPtr_typeGalgas_uint * operand_15830 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_15830) ;
          if ((operand_15805 != NULL) && (operand_15830 != NULL)) {
          }else{
            cPtr_typeGalgas_sint * operand_15805 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_15805) ;
            cPtr_typeGalgas_sint * operand_15830 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_15830) ;
            if ((operand_15805 != NULL) && (operand_15830 != NULL)) {
            }else{
              cPtr_typeGalgas_uint64 * operand_15805 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_15805) ;
              cPtr_typeGalgas_uint64 * operand_15830 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_15830) ;
              if ((operand_15805 != NULL) && (operand_15830 != NULL)) {
              }else{
                cPtr_typeGalgas_sint64 * operand_15805 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_15805) ;
                cPtr_typeGalgas_sint64 * operand_15830 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_15830) ;
                if ((operand_15805 != NULL) && (operand_15830 != NULL)) {
                }else{
                  cPtr_typeGalgas_double * operand_15805 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_15805) ;
                  cPtr_typeGalgas_double * operand_15830 = dynamic_cast <cPtr_typeGalgas_double *> (ptr_15830) ;
                  if ((operand_15805 != NULL) && (operand_15830 != NULL)) {
                  }else{
                    cPtr_typeGalgas_string * operand_15805 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_15805) ;
                    cPtr_typeGalgas_string * operand_15830 = dynamic_cast <cPtr_typeGalgas_string *> (ptr_15830) ;
                    if ((operand_15805 != NULL) && (operand_15830 != NULL)) {
                    }else{
                      cPtr_typeGalgas_enum * operand_15805 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_15805) ;
                      cPtr_typeGalgas_enum * operand_15830 = dynamic_cast <cPtr_typeGalgas_enum *> (ptr_15830) ;
                      if ((operand_15805 != NULL) && (operand_15830 != NULL)) {
                        if (((operand_15805->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (370)))._operator_isNotEqual (operand_15830->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (370)))).isBuiltAndTrue ()) {
                          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "comparison between an '@"))._operator_concat (operand_15805->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (371))))._operator_concat (GGS_string (true, "' enumeration and an '@")))._operator_concat (operand_15830->mEnumTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (372))))._operator_concat (GGS_string (true, "' enumeration is not valid")) COMMA_SOURCE_FILE_AT_LINE (372)) ;
                        }
                      }else{
...
void routine_left_shift_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_17463 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_17488 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_binaryset * operand_17463 = dynamic_cast <cPtr_typeGalgas_binaryset *> (ptr_17463) ;
    cPtr_typeGalgas_uint * operand_17488 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17488) ;
    if ((operand_17463 != NULL) && (operand_17488 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_uint * operand_17463 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17463) ;
      cPtr_typeGalgas_uint * operand_17488 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17488) ;
      if ((operand_17463 != NULL) && (operand_17488 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_sint * operand_17463 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_17463) ;
        cPtr_typeGalgas_uint * operand_17488 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17488) ;
        if ((operand_17463 != NULL) && (operand_17488 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_uint64 * operand_17463 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_17463) ;
          cPtr_typeGalgas_uint * operand_17488 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17488) ;
          if ((operand_17463 != NULL) && (operand_17488 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_sint64 * operand_17463 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_17463) ;
            cPtr_typeGalgas_uint * operand_17488 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_17488) ;
            if ((operand_17463 != NULL) && (operand_17488 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
...
void routine_right_shift_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_18469 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_18494 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_binaryset * operand_18469 = dynamic_cast <cPtr_typeGalgas_binaryset *> (ptr_18469) ;
    cPtr_typeGalgas_uint * operand_18494 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18494) ;
    if ((operand_18469 != NULL) && (operand_18494 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_uint * operand_18469 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18469) ;
      cPtr_typeGalgas_uint * operand_18494 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18494) ;
      if ((operand_18469 != NULL) && (operand_18494 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_sint * operand_18469 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_18469) ;
        cPtr_typeGalgas_uint * operand_18494 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18494) ;
        if ((operand_18469 != NULL) && (operand_18494 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_uint64 * operand_18469 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_18469) ;
          cPtr_typeGalgas_uint * operand_18494 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18494) ;
          if ((operand_18469 != NULL) && (operand_18494 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_sint64 * operand_18469 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_18469) ;
            cPtr_typeGalgas_uint * operand_18494 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_18494) ;
            if ((operand_18469 != NULL) && (operand_18494 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
...
void routine_addition_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_19784 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_19809 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_19784 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_19784) ;
    cPtr_typeGalgas_uint * operand_19809 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_19809) ;
    if ((operand_19784 != NULL) && (operand_19809 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_19784 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_19784) ;
      cPtr_typeGalgas_sint * operand_19809 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_19809) ;
      if ((operand_19784 != NULL) && (operand_19809 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_19784 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_19784) ;
        cPtr_typeGalgas_uint64 * operand_19809 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_19809) ;
        if ((operand_19784 != NULL) && (operand_19809 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_19784 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_19784) ;
          cPtr_typeGalgas_sint64 * operand_19809 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_19809) ;
          if ((operand_19784 != NULL) && (operand_19809 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_substraction_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_21009 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_21034 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_21009 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_21009) ;
    cPtr_typeGalgas_uint * operand_21034 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_21034) ;
    if ((operand_21009 != NULL) && (operand_21034 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_21009 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_21009) ;
      cPtr_typeGalgas_sint * operand_21034 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_21034) ;
      if ((operand_21009 != NULL) && (operand_21034 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_21009 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_21009) ;
        cPtr_typeGalgas_uint64 * operand_21034 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_21034) ;
        if ((operand_21009 != NULL) && (operand_21034 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_21009 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_21009) ;
          cPtr_typeGalgas_sint64 * operand_21034 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_21034) ;
          if ((operand_21009 != NULL) && (operand_21034 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
            cPtr_typeGalgas_stringset * operand_21009 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_21009) ;
            cPtr_typeGalgas_stringset * operand_21034 = dynamic_cast <cPtr_typeGalgas_stringset *> (ptr_21034) ;
            if ((operand_21009 != NULL) && (operand_21034 != NULL)) {
              var_cas_outResultType = var_cas_inLeftExpressionType ;
            }else{
...
void routine_multiply_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_22340 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_22365 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_22340 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_22340) ;
    cPtr_typeGalgas_uint * operand_22365 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_22365) ;
    if ((operand_22340 != NULL) && (operand_22365 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_22340 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_22340) ;
      cPtr_typeGalgas_sint * operand_22365 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_22365) ;
      if ((operand_22340 != NULL) && (operand_22365 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_22340 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_22340) ;
        cPtr_typeGalgas_uint64 * operand_22365 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_22365) ;
        if ((operand_22340 != NULL) && (operand_22365 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_22340 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_22340) ;
          cPtr_typeGalgas_sint64 * operand_22365 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_22365) ;
          if ((operand_22340 != NULL) && (operand_22365 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_divide_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_23565 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_23590 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_23565 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_23565) ;
    cPtr_typeGalgas_uint * operand_23590 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_23590) ;
    if ((operand_23565 != NULL) && (operand_23590 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_23565 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_23565) ;
      cPtr_typeGalgas_sint * operand_23590 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_23590) ;
      if ((operand_23565 != NULL) && (operand_23590 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_23565 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_23565) ;
        cPtr_typeGalgas_uint64 * operand_23590 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_23590) ;
        if ((operand_23565 != NULL) && (operand_23590 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_23565 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_23565) ;
          cPtr_typeGalgas_sint64 * operand_23590 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_23590) ;
          if ((operand_23565 != NULL) && (operand_23590 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_modulo_types_check (C_Compiler & _inLexique,
  ...
  #endif
  if (var_cas_inLeftExpressionType._isBuilt () && var_cas_inRightExpressionType._isBuilt ()) {
    cPtr_AC_galgasType * ptr_24784 = var_cas_inLeftExpressionType (HERE) ;
    cPtr_AC_galgasType * ptr_24809 = var_cas_inRightExpressionType (HERE) ;
    cPtr_typeGalgas_uint * operand_24784 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_24784) ;
    cPtr_typeGalgas_uint * operand_24809 = dynamic_cast <cPtr_typeGalgas_uint *> (ptr_24809) ;
    if ((operand_24784 != NULL) && (operand_24809 != NULL)) {
      var_cas_outResultType = var_cas_inLeftExpressionType ;
    }else{
      cPtr_typeGalgas_sint * operand_24784 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_24784) ;
      cPtr_typeGalgas_sint * operand_24809 = dynamic_cast <cPtr_typeGalgas_sint *> (ptr_24809) ;
      if ((operand_24784 != NULL) && (operand_24809 != NULL)) {
        var_cas_outResultType = var_cas_inLeftExpressionType ;
      }else{
        cPtr_typeGalgas_uint64 * operand_24784 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_24784) ;
        cPtr_typeGalgas_uint64 * operand_24809 = dynamic_cast <cPtr_typeGalgas_uint64 *> (ptr_24809) ;
        if ((operand_24784 != NULL) && (operand_24809 != NULL)) {
          var_cas_outResultType = var_cas_inLeftExpressionType ;
        }else{
          cPtr_typeGalgas_sint64 * operand_24784 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_24784) ;
          cPtr_typeGalgas_sint64 * operand_24809 = dynamic_cast <cPtr_typeGalgas_sint64 *> (ptr_24809) ;
          if ((operand_24784 != NULL) && (operand_24809 != NULL)) {
            var_cas_outResultType = var_cas_inLeftExpressionType ;
          }else{
...
void routine_unary_minus_type_check (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_AC_galgasType _var_26234 = var_cas_inExpressionType ; // CAST instruction
    if (_var_26234.getPtr () != NULL) {
      macroValidPointer (_var_26234.getPtr ()) ;
      if (dynamic_cast <cPtr_typeGalgas_sint *> (_var_26234.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inExpressionType ;
      }else if (dynamic_cast <cPtr_typeGalgas_sint64 *> (_var_26234.getPtr ()) != NULL) {
        var_cas_outResultType = var_cas_inExpressionType ;
      }else{
...
pr_output_expression_list_expression_parser_1588_4_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_inFormalAttributesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1615)))._operator_strictInf (var_cas_effectiveTypesList.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1615)))).isBuiltAndTrue ()) {
    ...
    const GGS_typeListeAttributsSemantiques _var_64133 = var_cas_inFormalAttributesList ;
    const GGS_typeListeAttributsSemantiques::element_type * operand_64133 = _var_64133.firstObject () ;
    const GGS_typeTypesList _var_64216 = var_cas_effectiveTypesList ;
    const GGS_typeTypesList::element_type * operand_64216 = _var_64216.firstObject () ;
    while ((operand_64133 != NULL)
        && (operand_64216 != NULL)) {
      macroValidPointer (operand_64133) ;
      macroValidPointer (operand_64216) ;
      ::routine_checkAssignmentTypesCompatibility (_inLexique,  operand_64133->mAttributType,  operand_64216->mType,  operand_64216->mEndOfExpressionLocation,  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (1621)) ;
      operand_64133 = operand_64133->nextObject () ;
      operand_64216 = operand_64216->nextObject () ;
    }
  }
}
        ...
        case 2 : {
          switch (select_expression_parser_14 (_inLexique)) {
            ...
            case 3 : {
              ...
              GGS_uint _variant_65833 = var_cas_jokerCount._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (1660)) ;
              GGS_bool _condition_65833 (_variant_65833._isBuilt (), true) ;
              while (_condition_65833.isBuiltAndTrue ()) {
                _condition_65833 = (var_cas_jokerCount)._operator_strictSup (GGS_uint (true, 0U)) ;
                if (_condition_65833.isBuiltAndTrue ()) {
                  if (_variant_65833.uintValue () == 0) {
                    _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1663)) ;
                    _condition_65833 = GGS_bool (true, false) ;
                  }else{
                    _variant_65833._decrement_operation (_inLexique COMMA_HERE) ;
                    var_cas_argumentsList._addAssign_operation (GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE), GGS_lstring::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE)) ;
