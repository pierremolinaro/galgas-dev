...
pr_factor_expression_parser_1498_13_ (galgas_scanner & inLexique,
  ...
  GGS_typeGalgas_bool  var_cas_gb ;
  var_cas_gb = GGS_typeGalgas_bool::castFrom (inLexique, var_cas_ifExpressionType.getPtr (), true, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1519)) ;
        ...
        case 2 : {
          switch (select_expression_parser_15 (inLexique)) {
            ...
            case 3 : {
              ...
              var_cas_jokerCount = var_cas_jokerCountWithLocation.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1969)) ;
