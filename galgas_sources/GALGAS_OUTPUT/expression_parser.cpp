...
pr_factor_expression_parser_1500_13_ (galgas_scanner & inLexique,
  ...
  switch (select_expression_parser_9 (inLexique)) {
    ...
    case 2 : {
      ...
      ::routine_handleReaderCall (inLexique,  var_cas_inEntitiesMap,  var_cas_inSemanticContext.reader_mCategoryReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1534)),  var_cas_expressionType,  var_cas_methodName,  var_cas_accessorsTypeList,  var_cas_outResultType,  var_cas_conversionMethod,  var_cas_categoryReaderClassBaseName COMMA_SOURCE_FILE_AT_LINE (1532)) ;
...
void expression_parser::
pr_factor_expression_parser_1565_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  const GGS_M_semanticsEntitiesForUse  temp_62112 = var_cas_inEntitiesMap ;
  if (temp_62112.isBuilt ()) {
    temp_62112 (HERE)->method_searchKey (inLexique, var_cas_className, var_cas_e COMMA_SOURCE_FILE_AT_LINE (1581)) ;
  }
  var_cas_outResultType = GGS_typeEntiteType::castFrom (inLexique, var_cas_e.getPtr (), true, var_cas_className COMMA_SOURCE_FILE_AT_LINE (1582)).reader_aDefType (inLexique COMMA_SOURCE_FILE_AT_LINE (1582)) ;
  GGS_typeListeAttributsSemantiques  var_cas_listeAttributsSemantiques ;
  GGS_bool var_cas_hasLexiqueAndLocationArguments ;
  const GGS_AC_galgasType  temp_62354 = var_cas_outResultType ;
  if (temp_62354.isBuilt ()) {
    temp_62354 (HERE)->method_handleConstructorCall (inLexique, var_cas_mClassMethodName, var_cas_listeAttributsSemantiques, var_cas_hasLexiqueAndLocationArguments COMMA_SOURCE_FILE_AT_LINE (1585)) ;
  }
  GGS_typeExpressionList  var_cas_expressionList ;
  ...
  var_cas_outExpression = GGS_typeConstructorExpression ::constructor_new (inLexique, var_cas_outResultType, var_cas_mClassMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1598)), var_cas_hasLexiqueAndLocationArguments, var_cas_expressionList COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5D_) COMMA_HERE) ;
}
...
void expression_parser::
pr_factor_expression_parser_1565_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  nt_output_expression_list_parse (inLexique) ;
...
void expression_parser::
pr_factor_expression_parser_1614_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  /* var_cas_inEntitiesMap */,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext /* var_cas_inSemanticContext */,
                                GGS_typeVariablesMap  &/* var_cas_ioVariablesMap */,
  ...
  switch (select_expression_parser_10 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      if (((var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1628))).operator_isNotEqual (GGS_string ("verbose_output"))).isBuiltAndTrue ()) {
        var_cas_optionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this option name does not correspond to a builtin option") COMMA_SOURCE_FILE_AT_LINE (1630)) ;
      }
    ...
    case 2 : {
      ...
      GGS_lstring  var_cas_collectionName ;
      inLexique.assignFromAttribute_tokenString (var_cas_collectionName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      if (((var_cas_collectionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1637))).operator_isEqual (GGS_string ("boolOptionIdentifierList"))).isBuiltAndTrue ()) {
        var_cas_outExpression = GGS_typeOptionCollection ::constructor_new (inLexique, GGS_string ("galgas_cli_options"), var_cas_collectionName COMMA_HERE) ;
        ::routine_build_stringlist_type (inLexique,  var_cas_outResultType COMMA_SOURCE_FILE_AT_LINE (1639)) ;
      }else{
        var_cas_collectionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this collection name does not exist") COMMA_SOURCE_FILE_AT_LINE (1642)) ;
    ...
    case 3 : {
      ...
      const GGS_M_optionComponents  temp_64799 = var_cas_inOptionsComponentsMapForUse ;
      if (temp_64799.isBuilt ()) {
        temp_64799 (HERE)->method_searchKey (inLexique, var_cas_optionComponentName, var_cas_boolOptionsMap, var_cas_uintOptionsMap, var_cas_stringOptionsMap COMMA_SOURCE_FILE_AT_LINE (1649)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2E_) COMMA_HERE) ;
      GGS_lstring  var_cas_optionName ;
      inLexique.assignFromAttribute_tokenString (var_cas_optionName) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
      if ((var_cas_boolOptionsMap.reader_hasKey (inLexique, var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1653)) COMMA_SOURCE_FILE_AT_LINE (1653))).isBuiltAndTrue ()) {
        var_cas_outExpression = GGS_typeBoolOption ::constructor_new (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1654)), var_cas_optionName COMMA_HERE) ;
        var_cas_outResultType = GGS_typeGalgas_bool ::constructor_new (inLexique COMMA_HERE) ;
      }else if ((var_cas_uintOptionsMap.reader_hasKey (inLexique, var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1656)) COMMA_SOURCE_FILE_AT_LINE (1656))).isBuiltAndTrue ()) {
        var_cas_outExpression = GGS_typeUIntOption ::constructor_new (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1657)), var_cas_optionName COMMA_HERE) ;
        var_cas_outResultType = GGS_typeGalgas_uint ::constructor_new (inLexique COMMA_HERE) ;
      }else if ((var_cas_stringOptionsMap.reader_hasKey (inLexique, var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1659)) COMMA_SOURCE_FILE_AT_LINE (1659))).isBuiltAndTrue ()) {
        var_cas_outExpression = GGS_typeStringOption ::constructor_new (inLexique, var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)), var_cas_optionName COMMA_HERE) ;
        var_cas_outResultType = GGS_typeGalgas_string ::constructor_new (inLexique COMMA_HERE) ;
      }else{
        var_cas_optionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (var_cas_optionComponentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)))).operator_concat (GGS_string ("' option component has no '"))).operator_concat (var_cas_optionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)))).operator_concat (GGS_string ("' option")) COMMA_SOURCE_FILE_AT_LINE (1665)) ;
        var_cas_outExpression.drop () ;
        var_cas_outResultType.drop () ;
      }
      } break ;
...
void expression_parser::
pr_factor_expression_parser_1614_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_option) COMMA_HERE) ;
  switch (select_expression_parser_10 (inLexique)) {
    case 1 : {
...
void expression_parser::
pr_factor_expression_parser_1680_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  const GGS_M_filewrappers  temp_66987 = var_cas_inSemanticContext.reader_mFilewrappers (inLexique COMMA_SOURCE_FILE_AT_LINE (1695)) ;
  if (temp_66987.isBuilt ()) {
    temp_66987 (HERE)->method_searchKey (inLexique, var_cas_filewrapperName, var_cas_regularFileMap, var_cas_templateMap COMMA_SOURCE_FILE_AT_LINE (1695)) ;
  }
    ...
    case 2 : {
      ...
      switch (select_expression_parser_12 (inLexique)) {
        case 1 : {
          ...
          const GGS_filewrapperTemplateMap  temp_67395 = var_cas_templateMap ;
          if (temp_67395.isBuilt ()) {
            temp_67395 (HERE)->method_searchKey (inLexique, var_cas_templateName, var_cas_formalAttributeList COMMA_SOURCE_FILE_AT_LINE (1707)) ;
          }
          GGS_typeExpressionList  var_cas_expressionList ;
        ...
        case 2 : {
          ...
          const GGS_M_regularFiles  temp_68027 = var_cas_regularFileMap ;
          if (temp_68027.isBuilt ()) {
            temp_68027 (HERE)->method_searchKey (inLexique, var_cas_path, automatic_var_1, var_cas_wrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1727)) ;
          }
...
void expression_parser::
pr_factor_expression_parser_1680_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_filewrapper) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  switch (select_expression_parser_11 (inLexique)) {
...
void expression_parser::
pr_factor_expression_parser_1742_13_ (galgas_scanner & inLexique,
                                const GGS_M_semanticsEntitiesForUse  var_cas_inEntitiesMap,
                                const GGS_M_optionComponents  var_cas_inOptionsComponentsMapForUse,
                                const GGS_EXsemanticContext var_cas_inSemanticContext,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
  ...
  GGS_AC_semanticsEntity  var_cas_entite ;
  const GGS_M_semanticsEntitiesForUse  temp_69183 = var_cas_inEntitiesMap ;
  if (temp_69183.isBuilt ()) {
    temp_69183 (HERE)->method_searchKey (inLexique, var_cas_functionName, var_cas_entite COMMA_SOURCE_FILE_AT_LINE (1755)) ;
  }
  GGS_bool var_cas_isExternActionCall ;
  { const GGS_AC_semanticsEntity _var_69763 = var_cas_entite ; // CAST instruction
    if (_var_69763.getPtr () != NULL) {
      macroValidPointer (_var_69763.getPtr ()) ;
      if (dynamic_cast <cPtr_typeEntiteFonction *> (_var_69763.getPtr ()) != NULL) {
        const GGS_typeEntiteFonction var_cas_r (_var_69763.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_r.reader_aListeArgumentsFormels (inLexique COMMA_SOURCE_FILE_AT_LINE (1759)) ;
        var_cas_outResultType = var_cas_r.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1760)) ;
        var_cas_isExternActionCall = GGS_bool (false) ;
      }else if (dynamic_cast <cPtr_typeEntiteFonctionExterne *> (_var_69763.getPtr ()) != NULL) {
        const GGS_typeEntiteFonctionExterne var_cas_ae (_var_69763.getPtr ()) ;
        var_cas_signatureRoutine = var_cas_ae.reader_aSignature (inLexique COMMA_SOURCE_FILE_AT_LINE (1763)) ;
        var_cas_outResultType = var_cas_ae.reader_mReturnedType (inLexique COMMA_SOURCE_FILE_AT_LINE (1764)) ;
        var_cas_isExternActionCall = GGS_bool (true) ;
      }else{
        var_cas_functionName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'")).operator_concat (var_cas_functionName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1768)))).operator_concat (GGS_string ("' should name a function or an extern function")) COMMA_SOURCE_FILE_AT_LINE (1771)) ;
  ...
  {
    GGS_L_EXsignature::cEnumerator enumerator_69931 (var_cas_signatureRoutine, true) ;
    const GGS_L_EXsignature::cElement * operand_69931 = NULL ;
    while (((operand_69931 = enumerator_69931.nextObject ()))) {
      macroValidPointer (operand_69931) ;
      var_cas_listeAttributsSemantiques._addAssign_operation (operand_69931->mType, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
    }
  }
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28_) COMMA_HERE) ;
  nt_output_expression_list_ (inLexique, var_cas_expressionList, var_cas_listeAttributsSemantiques, var_cas_inEntitiesMap, var_cas_inOptionsComponentsMapForUse, var_cas_inSemanticContext, var_cas_ioVariablesMap) ;
...
void expression_parser::
pr_factor_expression_parser_1742_13_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28_) COMMA_HERE) ;
  nt_output_expression_list_parse (inLexique) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__29_) COMMA_HERE) ;
...
void expression_parser::
pr_read_access_expression_parser_1797_18_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1804)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_read_access_expression_parser_1797_18_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
}
...
void expression_parser::
pr_read_access_expression_parser_1813_18_ (galgas_scanner & inLexique,
                                GGS_lstring  &var_cas_nomVariable,
                                GGS_typeCplusPlusName  &var_cas_nomCppEntite,
                                GGS_AC_galgasType  &var_cas_typeEntite,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
  if ((var_cas_ioVariablesMap.reader_hasKey (inLexique, GGS_string ("self") COMMA_SOURCE_FILE_AT_LINE (1820))).isBuiltAndTrue ()) {
    var_cas_nomVariable = GGS_lstring ::constructor_new (inLexique, GGS_string ("self"), GGS_location (inLexique) COMMA_HERE) ;
    var_cas_ioVariablesMap.modifier_searchForReadOnlyAccess (inLexique, var_cas_nomVariable, var_cas_typeEntite, var_cas_nomCppEntite COMMA_SOURCE_FILE_AT_LINE (1822)) ;
  }else{
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("'self' is not defined in this context") COMMA_SOURCE_FILE_AT_LINE (1826)) ;
...
void expression_parser::
pr_read_access_expression_parser_1813_18_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_self) COMMA_HERE) ;
}
...
void expression_parser::
pr_output_expression_list_expression_parser_1835_29_ (galgas_scanner & inLexique,
  ...
  if (((var_cas_inFormalAttributesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1864))).operator_strictInf (var_cas_effectiveTypesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1864)))).isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("too much expressions") COMMA_SOURCE_FILE_AT_LINE (1866)) ;
  }else if (((var_cas_inFormalAttributesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1866))).operator_strictSup (var_cas_effectiveTypesList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (1866)))).isBuiltAndTrue ()) {
    var_cas_endOfListLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("one or more expressions missing") COMMA_SOURCE_FILE_AT_LINE (1868)) ;
  }else{
    {
      GGS_typeListeAttributsSemantiques::cEnumerator enumerator_73468 (var_cas_inFormalAttributesList, true) ;
      const GGS_typeListeAttributsSemantiques::cElement * operand_73468 = NULL ;
      GGS_typeTypesList::cEnumerator enumerator_73559 (var_cas_effectiveTypesList, true) ;
      const GGS_typeTypesList::cElement * operand_73559 = NULL ;
      while (((operand_73468 = enumerator_73468.nextObject ()))
          && ((operand_73559 = enumerator_73559.nextObject ()))) {
        macroValidPointer (operand_73468) ;
        macroValidPointer (operand_73559) ;
        ::routine_checkAssignmentTypesCompatibility (inLexique,  operand_73468->mAttributType,  operand_73559->mType,  operand_73559->mEndOfExpressionLocation,  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1871)) ;
      }
    }
  }
}
...
void expression_parser::
pr_output_expression_list_expression_parser_1835_29_parse (galgas_scanner & inLexique) {
  { bool syntaxRepeat_13 = true ;
    while (syntaxRepeat_13) {
      switch (select_repeat_expression_parser_13 (inLexique)) {
        case 2 : {
...
void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_1882_44_ (galgas_scanner & inLexique,
                                GGS_typeVariablesMap  &var_cas_ioVariablesMap,
        ...
        case 2 : {
          switch (select_expression_parser_15 (inLexique)) {
            ...
            case 3 : {
              ...
              var_cas_jokerCount = var_cas_jokerCountWithLocation.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (1909)) ;
              GGS_uint _variant_75186 = var_cas_jokerCount.add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1910)) ;
              GGS_bool _condition_75186 (_variant_75186.isBuilt (), true) ;
              while (_condition_75186.isBuiltAndTrue ()) {
                _condition_75186 = (var_cas_jokerCount).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_75186.isBuiltAndTrue ()) {
                  if (_variant_75186.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1914)) ;
                    _condition_75186 = GGS_bool (false) ;
                  }else{
                    _variant_75186.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_argumentsList._addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE)) ;
                    var_cas_jokerCount.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1913)) ;
                  }
                }
              }
              } break ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__29_) COMMA_HERE) ;
  ::routine_buildMapWithLocalConstants (inLexique,  var_cas_inEnumeratorNewStyle,  var_cas_argumentsList,  var_cas_inFormalArgumentsList,  var_cas_ioVariablesMap,  var_cas_inVarLocation,  var_cas_inLocalConstantStyle,  var_cas_ellipsisFound COMMA_SOURCE_FILE_AT_LINE (1926)) ;
}

//---------------------------------------------------------------------------*

void expression_parser::
pr_parse_effective_input_parameters_list_expression_parser_1882_44_parse (galgas_scanner & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__28_) COMMA_HERE) ;
  { bool syntaxRepeat_14 = true ;
    while (syntaxRepeat_14) {
      switch (select_repeat_expression_parser_14 (inLexique)) {
