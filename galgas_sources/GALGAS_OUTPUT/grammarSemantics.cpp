...
void GGS_nonterminalSymbolLabelMapForGrammarAnalysis::modifier_insertFakeKey (C_CompilerEx & inCompiler,
...
GGS_nonterminalSymbolLabelMapForGrammarAnalysis GGS_nonterminalSymbolLabelMapForGrammarAnalysis::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_signatureForGrammarAnalysis & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_nonterminalSymbolLabelMapForGrammarAnalysis result = constructor_emptyMap (inLexique COMMA_THERE) ;
...
GGS_location  GGS_abstractSyntaxInstructionForGrammarAnalysis::
reader_mStartLocation (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_location   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_abstractSyntaxInstructionForGrammarAnalysis *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_abstractSyntaxInstructionForGrammarAnalysis *) mPointer)->mStartLocation ;
  }
  return result ;
}
...
GGS_uint  GGS_productionRuleListForGrammarAnalysis::
reader_mProductionIndexAtIndex (C_CompilerEx & inLexique, const GGS_uint & inIndex COMMA_LOCATION_ARGS) const {
  GGS_uint  result ;
  if (isBuilt () && inIndex.isBuilt ()) {
    cElement * object = (cElement *) objectAtIndex (inLexique, inIndex.uintValue () COMMA_THERE) ;
    if (object != NULL) {
...
void GGS_productionRuleListForGrammarAnalysis::
modifier_setMProductionIndexAtIndex (C_CompilerEx & inLexique,
                              const GGS_uint  & inObject,
                              const GGS_uint & inIndex
                              COMMA_LOCATION_ARGS) const {
  if (isBuilt () && inIndex.isBuilt ()) {
...
void GGS_unusedNonTerminalSymbolMapForGrammarAnalysis::modifier_insertFakeKey (C_CompilerEx & inCompiler,
                         const GGS_string & inKey,
                         const GGS_location & inHelperMessageErrorLocation,
                         const GGS_string & inHelperMessage
                         COMMA_LOCATION_ARGS) {
...
GGS_unusedNonTerminalSymbolMapForGrammarAnalysis GGS_unusedNonTerminalSymbolMapForGrammarAnalysis::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_uint & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_unusedNonTerminalSymbolMapForGrammarAnalysis result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
void GGS_nonTerminalSymbolMapForGrammarAnalysis::modifier_insertFakeKey (C_CompilerEx & inCompiler,
                         const GGS_string & inKey,
                         const GGS_location & inHelperMessageErrorLocation,
                         const GGS_string & inHelperMessage
                         COMMA_LOCATION_ARGS) {
...
GGS_nonTerminalSymbolMapForGrammarAnalysis GGS_nonTerminalSymbolMapForGrammarAnalysis::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_uint & inValue0,
                                             const GGS_nonterminalSymbolLabelMapForGrammarAnalysis & inValue1
                                             COMMA_LOCATION_ARGS) {
  GGS_nonTerminalSymbolMapForGrammarAnalysis result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
//---------------------------------------------------------------------------*
//                                                                           *
//     Element of list '@nonTerminalSymbolSortedListForGrammarAnalysis'      *
//                                                                           *
//---------------------------------------------------------------------------*

elementOf_GGS_nonTerminalSymbolSortedListForGrammarAnalysis::
elementOf_GGS_nonTerminalSymbolSortedListForGrammarAnalysis (const GGS_lstring & argument_0,
                                const GGS_uint & argument_1,
                                const GGS_nonterminalSymbolLabelMapForGrammarAnalysis & argument_2):
mNonTerminalSymbol (argument_0),
mNonTerminalIndex (argument_1),
mNonterminalSymbolParametersMap (argument_2) {
}

//---------------------------------------------------------------------------*

bool elementOf_GGS_nonTerminalSymbolSortedListForGrammarAnalysis::
isEqualToObject (const cSortedListElement * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const elementOf_GGS_nonTerminalSymbolSortedListForGrammarAnalysis * ptr = dynamic_cast <const elementOf_GGS_nonTerminalSymbolSortedListForGrammarAnalysis *> (inOperand) ;
    macroValidPointer (ptr) ;
    equal = mNonTerminalSymbol.operator_isEqual (ptr->mNonTerminalSymbol).boolValue ()
         && mNonTerminalIndex.operator_isEqual (ptr->mNonTerminalIndex).boolValue ()
...
PMSInt32 elementOf_GGS_nonTerminalSymbolSortedListForGrammarAnalysis::
compareForSorting (const cSortedListElement * inOperand) const {
  const elementOf_GGS_nonTerminalSymbolSortedListForGrammarAnalysis * operand = (const elementOf_GGS_nonTerminalSymbolSortedListForGrammarAnalysis *) inOperand ;
  PMSInt32 result = mNonTerminalIndex.genericObjectCompare (operand->mNonTerminalIndex) ;
  return result ;
}

//---------------------------------------------------------------------------*

void elementOf_GGS_nonTerminalSymbolSortedListForGrammarAnalysis::
appendForDescription (C_String & ioString,
                      const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mNonTerminalSymbol.reader_description (inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mNonTerminalIndex.reader_description (inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mNonterminalSymbolParametersMap.reader_description (inIndentation) ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//       Sorted list '@nonTerminalSymbolSortedListForGrammarAnalysis'        *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptorEX kTypeDescriptor_GGS_nonTerminalSymbolSortedListForGrammarAnalysis ("nonTerminalSymbolSortedListForGrammarAnalysis", false, NULL) ;

//---------------------------------------------------------------------------*

GGS_nonTerminalSymbolSortedListForGrammarAnalysis::GGS_nonTerminalSymbolSortedListForGrammarAnalysis (void): AC_GGS_sortedlist () { // Default Constructor
}

//---------------------------------------------------------------------------*

GGS_nonTerminalSymbolSortedListForGrammarAnalysis::
GGS_nonTerminalSymbolSortedListForGrammarAnalysis (const GGS_nonTerminalSymbolSortedListForGrammarAnalysis & inSource): AC_GGS_sortedlist (inSource) {
}

//---------------------------------------------------------------------------*

GGS_bool GGS_nonTerminalSymbolSortedListForGrammarAnalysis::
operator_isEqual (const GGS_nonTerminalSymbolSortedListForGrammarAnalysis & inOperand) const {
...
GGS_bool GGS_nonTerminalSymbolSortedListForGrammarAnalysis::
operator_isNotEqual (const GGS_nonTerminalSymbolSortedListForGrammarAnalysis & inOperand) const {
  return GGS_bool (isBuilt () && inOperand.isBuilt (), ! isEqualToList (inOperand)) ;
}

//---------------------------------------------------------------------------*

void GGS_nonTerminalSymbolSortedListForGrammarAnalysis::
internalAppendValues (const GGS_lstring & argument_0,
                    const GGS_uint & argument_1,
                    const GGS_nonterminalSymbolLabelMapForGrammarAnalysis & argument_2) {
  cElement * newElement = (cElement *) NULL ;
...
GGS_nonTerminalSymbolSortedListForGrammarAnalysis GGS_nonTerminalSymbolSortedListForGrammarAnalysis::
operator_concat (const GGS_nonTerminalSymbolSortedListForGrammarAnalysis & inOperand) const {
  GGS_nonTerminalSymbolSortedListForGrammarAnalysis result = * this ;
  result.dotAssign_operation (inOperand) ;
  return result ;
}
...
void GGS_nonTerminalSymbolSortedListForGrammarAnalysis::
dotAssign_operation (const GGS_nonTerminalSymbolSortedListForGrammarAnalysis inOperand) {
  if (isBuilt () && inOperand.isBuilt ()) {
    if (count () == 0) {
      *this = inOperand ;
    }else{
      if (inOperand.count () > 0) {
        insulateList () ;
        elementOf_GGS_nonTerminalSymbolSortedListForGrammarAnalysis * p = inOperand.firstObject () ;
        while (p != NULL) {
          macroValidPointer (p) ;
          GGS_lstring  p_0 = p->mNonTerminalSymbol ;
          GGS_uint  p_1 = p->mNonTerminalIndex ;
          GGS_nonterminalSymbolLabelMapForGrammarAnalysis  p_2 = p->mNonterminalSymbolParametersMap ;
...
insulateList (void) {
  if (isShared ()) {
    ...
    while (ptr != NULL) {
      macroValidPointer (ptr) ;
      internalAppendValues (ptr->mNonTerminalSymbol,
                                ptr->mNonTerminalIndex,
                                ptr->mNonterminalSymbolParametersMap) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
GGS_string GGS_nonTerminalSymbolSortedListForGrammarAnalysis::
reader_description (const PMSInt32 inIndentation) const {
  return performDescription ("@nonTerminalSymbolSortedListForGrammarAnalysis", inIndentation) ;
}
...
method_smallest (C_CompilerEx & inLexique,
                 GGS_lstring & _out_0,
                 GGS_uint & _out_1,
                 GGS_nonterminalSymbolLabelMapForGrammarAnalysis & _out_2
                 COMMA_LOCATION_ARGS) const {
  cElement * ptr = NULL ;
  if (isBuilt ()) {
    ptr = firstObject () ;
  ...
  if (ptr != NULL) {
    _out_0 = ptr->mNonTerminalSymbol ;
    _out_1 = ptr->mNonTerminalIndex ;
    _out_2 = ptr->mNonterminalSymbolParametersMap ;
  }else{
    _out_0.drop () ;
    _out_1.drop () ;
    _out_2.drop () ;
...
/* const */ GGS_lstring  & GGS_nonTerminalSymbolSortedListForGrammarAnalysis::cEnumerator::_mNonTerminalSymbol (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((/* const */ cElement *) mCurrentEnumeratedObject)->mNonTerminalSymbol ;
}

//---------------------------------------------------------------------------*

/* const */ GGS_uint  & GGS_nonTerminalSymbolSortedListForGrammarAnalysis::cEnumerator::_mNonTerminalIndex (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((/* const */ cElement *) mCurrentEnumeratedObject)->mNonTerminalIndex ;
}

//---------------------------------------------------------------------------*

/* const */ GGS_nonterminalSymbolLabelMapForGrammarAnalysis  & GGS_nonTerminalSymbolSortedListForGrammarAnalysis::cEnumerator::_mNonterminalSymbolParametersMap (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((/* const */ cElement *) mCurrentEnumeratedObject)->mNonterminalSymbolParametersMap ;
}

//---------------------------------------------------------------------------*

GGS_object GGS_nonTerminalSymbolSortedListForGrammarAnalysis::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_nonTerminalSymbolSortedListForGrammarAnalysis * p = NULL ;
    macroMyNew (p, GGS_nonTerminalSymbolSortedListForGrammarAnalysis (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_nonTerminalSymbolSortedListForGrammarAnalysis GGS_nonTerminalSymbolSortedListForGrammarAnalysis::castFromObject (C_CompilerEx & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_nonTerminalSymbolSortedListForGrammarAnalysis result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_nonTerminalSymbolSortedListForGrammarAnalysis * p = dynamic_cast <const GGS_nonTerminalSymbolSortedListForGrammarAnalysis *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_nonTerminalSymbolSortedListForGrammarAnalysis, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_nonTerminalSymbolSortedListForGrammarAnalysis::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_nonTerminalSymbolSortedListForGrammarAnalysis ;
}
...
GGS_lstring  GGS_terminalInstructionForGrammarAnalysis::
reader_mTerminalSymbolName (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_terminalInstructionForGrammarAnalysis *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_terminalInstructionForGrammarAnalysis *) mPointer)->mTerminalSymbolName ;
  }
  return result ;
}
...
GGS_uint  GGS_terminalInstructionForGrammarAnalysis::
reader_mTerminalSymbolIndex (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_uint   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_terminalInstructionForGrammarAnalysis *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_terminalInstructionForGrammarAnalysis *) mPointer)->mTerminalSymbolIndex ;
  }
  return result ;
}
...
GGS_lstring  GGS_nonTerminalInstructionForGrammarAnalysis::
reader_mNonterminalSymbolName (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_nonTerminalInstructionForGrammarAnalysis *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_nonTerminalInstructionForGrammarAnalysis *) mPointer)->mNonterminalSymbolName ;
  }
  return result ;
}
...
GGS_uint  GGS_nonTerminalInstructionForGrammarAnalysis::
reader_mNonterminalSymbolIndex (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_uint   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_nonTerminalInstructionForGrammarAnalysis *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_nonTerminalInstructionForGrammarAnalysis *) mPointer)->mNonterminalSymbolIndex ;
  }
  return result ;
}
...
GGS_branchListForGrammarAnalysis  GGS_selectInstructionForGrammarAnalysis::
reader_mSelectBranchList (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_branchListForGrammarAnalysis   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_selectInstructionForGrammarAnalysis *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_selectInstructionForGrammarAnalysis *) mPointer)->mSelectBranchList ;
  }
  return result ;
}
...
GGS_uint  GGS_selectInstructionForGrammarAnalysis::
reader_mAddedNonTerminalSymbolIndex (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_uint   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_selectInstructionForGrammarAnalysis *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_selectInstructionForGrammarAnalysis *) mPointer)->mAddedNonTerminalSymbolIndex ;
  }
  return result ;
}
...
GGS_branchListForGrammarAnalysis  GGS_repeatInstructionForGrammarAnalysis::
reader_mRepeatBranchList (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_branchListForGrammarAnalysis   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_repeatInstructionForGrammarAnalysis *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_repeatInstructionForGrammarAnalysis *) mPointer)->mRepeatBranchList ;
  }
  return result ;
}
...
GGS_uint  GGS_repeatInstructionForGrammarAnalysis::
reader_mAddedNonTerminalSymbolIndex (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_uint   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_repeatInstructionForGrammarAnalysis *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_repeatInstructionForGrammarAnalysis *) mPointer)->mAddedNonTerminalSymbolIndex ;
  }
  return result ;
}
...
void GGS_terminalSymbolsMapForGrammarAnalysis::modifier_insertFakeKey (C_CompilerEx & inCompiler,
                         const GGS_string & inKey,
                         const GGS_location & inHelperMessageErrorLocation,
                         const GGS_string & inHelperMessage
                         COMMA_LOCATION_ARGS) {
...
GGS_terminalSymbolsMapForGrammarAnalysis GGS_terminalSymbolsMapForGrammarAnalysis::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_uint & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_terminalSymbolsMapForGrammarAnalysis result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
