...
cCollectionElement_signatureForGrammarAnalysis * GALGAS_signatureForGrammarAnalysis::makeElement (const GALGAS_formalArgumentPassingModeAST & in_mFormalArgumentPassingModeForGrammarAnalysis,
                                                                                                  const GALGAS_lstring & in_mGalgasTypeNameForGrammarAnalysis
                                                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement_signatureForGrammarAnalysis * result = NULL ;
  macroMyNew (result, cCollectionElement_signatureForGrammarAnalysis (in_mFormalArgumentPassingModeForGrammarAnalysis,
...
cCollectionElement_syntaxInstructionListForGrammarAnalysis * GALGAS_syntaxInstructionListForGrammarAnalysis::makeElement (const GALGAS_abstractSyntaxInstructionForGrammarAnalysis & in_mInstruction
                                                                                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_syntaxInstructionListForGrammarAnalysis * result = NULL ;
  macroMyNew (result, cCollectionElement_syntaxInstructionListForGrammarAnalysis (in_mInstruction COMMA_THERE)) ;
  return result ;
}
...
cCollectionElement_productionRuleListForGrammarAnalysis * GALGAS_productionRuleListForGrammarAnalysis::makeElement (const GALGAS_lstring & in_mLeftNonterminalSymbol,
                                                                                                                    const GALGAS_uint & in_mLeftNonterminalSymbolIndex,
                                                                                                                    const GALGAS_syntaxInstructionListForGrammarAnalysis & in_mInstructionList,
                                                                                                                    const GALGAS_uint & in_mProductionIndex
                                                                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_productionRuleListForGrammarAnalysis * result = NULL ;
  macroMyNew (result, cCollectionElement_productionRuleListForGrammarAnalysis (in_mLeftNonterminalSymbol,
...
cCollectionElement_branchListForGrammarAnalysis * GALGAS_branchListForGrammarAnalysis::makeElement (const GALGAS_syntaxInstructionListForGrammarAnalysis & in_mSyntaxInstructionList
                                                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_branchListForGrammarAnalysis * result = NULL ;
  macroMyNew (result, cCollectionElement_branchListForGrammarAnalysis (in_mSyntaxInstructionList COMMA_THERE)) ;
  return result ;
}
...
cCollectionElement_syntaxComponentListForGrammarAnalysis * GALGAS_syntaxComponentListForGrammarAnalysis::makeElement (const GALGAS_productionRuleListForGrammarAnalysis & in_mProductionRulesList,
                                                                                                                      const GALGAS_lstring & in_mSyntaxComponentName
                                                                                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement_syntaxComponentListForGrammarAnalysis * result = NULL ;
  macroMyNew (result, cCollectionElement_syntaxComponentListForGrammarAnalysis (in_mProductionRulesList,
