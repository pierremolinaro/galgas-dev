...
#ifndef typeModifierCallInstruction_DEFINED
#define typeModifierCallInstruction_DEFINED
...
/* class GGG_typeModifierCallInstruction : public GGG_typeInstruction {
  private : typedef GGG_typeInstruction inherited ;
  public : GGG_typeModifierCallInstruction (const GGS_typeCplusPlusName & ,
                                const GGS_lstring & ,
                                const GGS_typeExpressionList &  COMMA_LOCATION_ARGS) ;
} ; */
