...
category_reader__lexicalSelectInstruction__generateInstructionCode (C_Compiler & inLexique,
  ...
  if (operand_11953 != NULL) {
    ...
    const GGS_bool cond_12990 = (operand_11953->mDefaultInstructionList.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (312))).operator_strictSup (GGS_uint (0U)) ;
...
category_reader__lexicalImplicitRule__generateCode (C_Compiler & inLexique,
  ...
  if (operand_16635 != NULL) {
    ...
    if (temp_16847.isBuilt ()) {
      temp_16847 (HERE)->method_searchKey (inLexique, operand_16635->mListName, automatic_var_0, var_cas_tokenSortedList, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (420)) ;
    }
    var_cas_outGeneratedCode = GGS_string ("") ;
    {
      ...
      while (((operand_16923 = enumerator_16923.nextObject ()))) {
        ...
        var_cas_outGeneratedCode.dotAssign_operation (operand_16923->mName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (424))) ;
        var_cas_outGeneratedCode.appendCString (", ") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_16923->mName.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (426)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (426))) ;
        var_cas_outGeneratedCode.appendCString (", true)) {\n") ;
        var_cas_outGeneratedCode.appendCString ("  token.mTokenCode = ") ;
        var_cas_outGeneratedCode.dotAssign_operation (var_cas_inScannerClassName) ;
        var_cas_outGeneratedCode.appendCString ("_1_") ;
        var_cas_outGeneratedCode.dotAssign_operation (operand_16923->mTerminalName.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (428))) ;
        var_cas_outGeneratedCode.appendCString (" ;\n") ;
        var_cas_outGeneratedCode.appendCString ("  enterToken (token) ;\n") ;
        var_cas_outGeneratedCode.appendCString ("}else ") ;
      }
