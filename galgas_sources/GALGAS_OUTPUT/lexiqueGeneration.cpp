...
static GALGAS_string categoryReader_lexicalFunctionInputArgumentAST_generateRoutineOrFunctionArgument (const cPtr_lexicalRoutineOrFunctionFormalInputArgumentAST * inObject,
  ...
  cEnumerator_lexicalFunctionCallActualArgumentListAST enumerator_6491 (object->mAttribute_mFunctionActualArgumentList, kEnumeration_up) ;
...
static GALGAS_string categoryReader_lexicalStructuredSendInstructionAST_generateInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string::makeEmptyString () ;
  cEnumerator_lexicalSendSearchListAST enumerator_9378 (object->mAttribute_mLexicalSendSearchList, kEnumeration_up) ;
...
static GALGAS_string categoryReader_lexicalRepeatInstructionAST_generateInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  cEnumerator_lexicalInstructionListAST enumerator_10755 (object->mAttribute_mRepeatedInstructionList, kEnumeration_up) ;
  while (enumerator_10755.hasCurrentObject ()) {
    result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_10755.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (260)) COMMA_SOURCE_FILE_AT_LINE (260)) ;
    enumerator_10755.gotoNextObject () ;
  }
  cEnumerator_lexicalWhileBranchListAST enumerator_10926 (object->mAttribute_mLexicalWhileBranchList, kEnumeration_up) ;
  while (enumerator_10926.hasCurrentObject ()) {
    ...
    result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateConditionCode ((const cPtr_lexicalExpressionAST *) enumerator_10926.current_mWhileExpression (HERE).ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (266)) COMMA_SOURCE_FILE_AT_LINE (266)) ;
    ...
    cEnumerator_lexicalInstructionListAST enumerator_11168 (enumerator_10926.current_mWhileInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_11168.hasCurrentObject ()) {
      result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_11168.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (270)) COMMA_SOURCE_FILE_AT_LINE (270)) ;
...
static GALGAS_string categoryReader_lexicalSelectInstructionAST_generateInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string::makeEmptyString () ;
  cEnumerator_lexicalSelectBranchListAST enumerator_11989 (object->mAttribute_mLexicalSelectBranchList, kEnumeration_up) ;
  while (enumerator_11989.hasCurrentObject ()) {
    ...
    result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateConditionCode ((const cPtr_lexicalExpressionAST *) enumerator_11989.current_mSelectExpression (HERE).ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (296)) COMMA_SOURCE_FILE_AT_LINE (296)) ;
    ...
    cEnumerator_lexicalInstructionListAST enumerator_12233 (enumerator_11989.current_mSelectInstructionList (HERE), kEnumeration_up) ;
    while (enumerator_12233.hasCurrentObject ()) {
      result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_12233.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (300)) COMMA_SOURCE_FILE_AT_LINE (300)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lexicalInstructionListAST enumerator_12658 (object->mAttribute_mDefaultInstructionList, kEnumeration_up) ;
    while (enumerator_12658.hasCurrentObject ()) {
      result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_12658.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (311)) COMMA_SOURCE_FILE_AT_LINE (311)) ;
...
static GALGAS_string categoryReader_lexicalRoutineInstructionAST_generateInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  cEnumerator_lexicalRoutineCallActualArgumentListAST enumerator_13271 (object->mAttribute_mActualArgumentList, kEnumeration_up) ;
  ...
  cEnumerator_lstringlist enumerator_13407 (object->mAttribute_mErrorMessageList, kEnumeration_up) ;
  while (enumerator_13407.hasCurrentObject ()) {
    result_outGeneratedCode.dotAssign_operation (GALGAS_string (", gLexicalMessage_").operator_concat (enumerator_13407.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (330)) COMMA_SOURCE_FILE_AT_LINE (330)) COMMA_SOURCE_FILE_AT_LINE (330)) ;
...
static GALGAS_string categoryReader_lexicalImplicitRuleAST_generateCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string::makeEmptyString () ;
  cEnumerator_tokenSortedlist enumerator_16811 (var_tokenSortedList, kEnumeration_down) ;
  while (enumerator_16811.hasCurrentObject ()) {
    ...
    result_outGeneratedCode.dotAssign_operation (enumerator_16811.current_mName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (419)) COMMA_SOURCE_FILE_AT_LINE (419)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (420)) ;
    result_outGeneratedCode.dotAssign_operation (enumerator_16811.current_mName (HERE).reader_length (SOURCE_FILE_AT_LINE (421)).reader_string (SOURCE_FILE_AT_LINE (421)) COMMA_SOURCE_FILE_AT_LINE (421)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string (", true)) {\n") COMMA_SOURCE_FILE_AT_LINE (422)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("  token.mTokenCode = kToken_").operator_concat (enumerator_16811.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (423)) COMMA_SOURCE_FILE_AT_LINE (423)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (423)) COMMA_SOURCE_FILE_AT_LINE (423)) ;
...
static GALGAS_string categoryReader_lexicalExplicitRuleAST_generateCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  cEnumerator_lexicalInstructionListAST enumerator_17771 (object->mAttribute_mInstructionList, kEnumeration_up) ;
  while (enumerator_17771.hasCurrentObject ()) {
    result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_17771.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (441)) COMMA_SOURCE_FILE_AT_LINE (441)) ;
