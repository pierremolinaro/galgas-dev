...
static GALGAS_string categoryReader_lexicalImplicitRuleAST_generateCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  GALGAS_lexicalExplicitTokenListMap joker_17544_0 ; // Joker input parameter
  GALGAS_bool joker_17564_0 ; // Joker input parameter
  inArgument_inLexiqueAnalysisContext.reader_mLexicalTokenListMap (SOURCE_FILE ("lexiqueGeneration.gSemantics", 420)).method_searchKey (object->mAttribute_mListName, joker_17544_0, var_tokenSortedList, joker_17564_0, inCompiler COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 420)) ;
  result_outGeneratedCode = GALGAS_string::makeEmptyString () ;
