...
static GALGAS_string categoryReader_lexicalImplicitRuleAST_generateCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  GALGAS_lexicalExplicitTokenListMap joker_17126_0 ; // Joker input parameter
  GALGAS_bool joker_17146_0 ; // Joker input parameter
  inArgument_inLexiqueAnalysisContext.reader_mLexicalTokenListMap (SOURCE_FILE ("lexiqueGeneration.gSemantics", 419)).method_searchKey (object->mAttribute_mListName, joker_17126_0, var_tokenSortedList, joker_17146_0, inCompiler COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 419)) ;
  result_outGeneratedCode = GALGAS_string::makeEmptyString () ;
  cEnumerator_tokenSortedlist enumerator_17205 (var_tokenSortedList, kEnumeration_down) ;
  while (enumerator_17205.hasCurrentObject ()) {
    ...
    result_outGeneratedCode.dotAssign_operation (enumerator_17205.current_mName (HERE).reader_identifierRepresentation (SOURCE_FILE ("lexiqueGeneration.gSemantics", 423))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 423)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 424)) ;
    result_outGeneratedCode.dotAssign_operation (enumerator_17205.current_mName (HERE).reader_length (SOURCE_FILE ("lexiqueGeneration.gSemantics", 425)).reader_string (SOURCE_FILE ("lexiqueGeneration.gSemantics", 425))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 425)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string (", true)) {\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 426)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("  token.mTokenCode = kToken_").operator_concat (enumerator_17205.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE ("lexiqueGeneration.gSemantics", 427))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 427)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 427))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 427)) ;
    ...
    enumerator_17205.gotoNextObject () ;
  }
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalExplicitRuleAST_generateCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  cEnumerator_lexicalInstructionListAST enumerator_18165 (object->mAttribute_mInstructionList, kEnumeration_up) ;
  while (enumerator_18165.hasCurrentObject ()) {
    result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_18165.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 445))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 445)) ;
