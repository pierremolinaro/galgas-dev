...
static GALGAS_string categoryReader_lexicalImplicitRuleAST_generateCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  while (enumerator_16815.hasCurrentObject ()) {
    ...
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (enumerator_16815.current_mName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (419)) COMMA_SOURCE_FILE_AT_LINE (419)) ;
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (420)) ;
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (enumerator_16815.current_mName (HERE).reader_length (SOURCE_FILE_AT_LINE (421)).reader_string (SOURCE_FILE_AT_LINE (421)) COMMA_SOURCE_FILE_AT_LINE (421)) ;
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (GALGAS_string (", true)) {\n") COMMA_SOURCE_FILE_AT_LINE (422)) ;
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (GALGAS_string ("  token.mTokenCode = kToken_").operator_concat (enumerator_16815.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (423)) COMMA_SOURCE_FILE_AT_LINE (423)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (423)) COMMA_SOURCE_FILE_AT_LINE (423)) ;
    //-------- @appendInstructionForGeneration
...
static GALGAS_string categoryReader_lexicalExplicitRuleAST_generateCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  while (enumerator_17775.hasCurrentObject ()) {
    //-------- @appendInstructionForGeneration
    result_string.dotAssign_operation (callCategoryReader_generateInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_17775.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (441)) COMMA_SOURCE_FILE_AT_LINE (441)) ;
