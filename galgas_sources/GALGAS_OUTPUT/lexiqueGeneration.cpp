...
static GALGAS_string categoryReader_lexicalRewindInstructionAST_generateInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string ("mCurrentLocation = locationForTag_").operator_concat (object->mAttribute_mLexicalTagName.reader_string (SOURCE_FILE ("lexiqueGeneration.gSemantics", 382))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 382)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 382)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("token.mTokenCode = kToken_").operator_concat (object->mAttribute_mTerminalName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexiqueGeneration.gSemantics", 383))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 383)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 383))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 383)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("enterToken (token) ;\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 384)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalImplicitRuleAST_generateCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  inArgument_inLexiqueAnalysisContext.reader_mLexicalTokenListMap (SOURCE_FILE ("lexiqueGeneration.gSemantics", 415)).method_searchKey (object->mAttribute_mListName, joker_16729_0, var_tokenSortedList, joker_16749_0, inCompiler COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 415)) ;
  result_outGeneratedCode = GALGAS_string::makeEmptyString () ;
  ...
  while (enumerator_16808.hasCurrentObject ()) {
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("if (testForInputUTF32String (kUnicodeString_")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 418)) ;
    result_outGeneratedCode.dotAssign_operation (enumerator_16808.current_mName (HERE).reader_identifierRepresentation (SOURCE_FILE ("lexiqueGeneration.gSemantics", 419))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 419)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 420)) ;
    result_outGeneratedCode.dotAssign_operation (enumerator_16808.current_mName (HERE).reader_length (SOURCE_FILE ("lexiqueGeneration.gSemantics", 421)).reader_string (SOURCE_FILE ("lexiqueGeneration.gSemantics", 421))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 421)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string (", true)) {\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 422)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("  token.mTokenCode = kToken_").operator_concat (enumerator_16808.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE ("lexiqueGeneration.gSemantics", 423))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 423)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 423))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 423)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("  enterToken (token) ;\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 424)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("}else ")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 425)) ;
...
static GALGAS_string categoryReader_lexicalExplicitRuleAST_generateCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateConditionCode ((const cPtr_lexicalExpressionAST *) object->mAttribute_mLexicalRuleExpression.ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 437))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 437)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string (") {\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 438)) ;
  {
  result_outGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 439)) ;
  }
  ...
  {
  result_outGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 443)) ;
  }
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("}else ")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 444)) ;
//---
  return result_outGeneratedCode ;
}
