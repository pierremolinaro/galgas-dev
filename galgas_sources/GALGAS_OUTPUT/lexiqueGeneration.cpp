...
static GALGAS_string categoryReader_lexicalSelectInstructionAST_generateInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  while (enumerator_11984.hasCurrentObject ()) {
    ...
    result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateConditionCode ((const cPtr_lexicalExpressionAST *) enumerator_11984.current_mSelectExpression (HERE).ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 296))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 296)) ;
...
static GALGAS_string categoryReader_lexicalRoutineInstructionAST_generateInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  while (enumerator_13404.hasCurrentObject ()) {
    result_outGeneratedCode.dotAssign_operation (GALGAS_string (", gLexicalMessage_").operator_concat (enumerator_13404.current_mValue (HERE).reader_string (SOURCE_FILE ("lexiqueGeneration.gSemantics", 330))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 330))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 330)) ;
...
static GALGAS_string categoryReader_lexicalTagInstructionAST_generateInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string ("const C_LocationInSource locationForTag_").operator_concat (object->mAttribute_mLexicalTagName.reader_string (SOURCE_FILE ("lexiqueGeneration.gSemantics", 372))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 372)).operator_concat (GALGAS_string (" = mCurrentLocation ;\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 372)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("const utf32 currentCharForTag_").operator_concat (object->mAttribute_mLexicalTagName.reader_string (SOURCE_FILE ("lexiqueGeneration.gSemantics", 373))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 373)).operator_concat (GALGAS_string (" = mCurrentChar ;\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 373))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 373)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalRewindInstructionAST_generateInstructionCode (const cPtr_lexicalInstructionAST * inObject,
  ...
  result_outGeneratedCode = GALGAS_string ("mCurrentLocation = locationForTag_").operator_concat (object->mAttribute_mLexicalTagName.reader_string (SOURCE_FILE ("lexiqueGeneration.gSemantics", 383))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 383)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 383)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("mCurrentChar = currentCharForTag_").operator_concat (object->mAttribute_mLexicalTagName.reader_string (SOURCE_FILE ("lexiqueGeneration.gSemantics", 384))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 384)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 384))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 384)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("token.mTokenCode = kToken_").operator_concat (object->mAttribute_mTerminalName.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("lexiqueGeneration.gSemantics", 385))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 385)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 385))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 385)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("enterToken (token) ;\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 386)) ;
//---
  return result_outGeneratedCode ;
}
...
static GALGAS_string categoryReader_lexicalImplicitRuleAST_generateCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  GALGAS_lexicalExplicitTokenListMap joker_16915_0 ; // Joker input parameter
  GALGAS_bool joker_16935_0 ; // Joker input parameter
  inArgument_inLexiqueAnalysisContext.reader_mLexicalTokenListMap (SOURCE_FILE ("lexiqueGeneration.gSemantics", 417)).method_searchKey (object->mAttribute_mListName, joker_16915_0, var_tokenSortedList, joker_16935_0, inCompiler COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 417)) ;
  result_outGeneratedCode = GALGAS_string::makeEmptyString () ;
  cEnumerator_tokenSortedlist enumerator_16994 (var_tokenSortedList, kEnumeration_down) ;
  while (enumerator_16994.hasCurrentObject ()) {
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("if (testForInputUTF32String (kUnicodeString_")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 420)) ;
    result_outGeneratedCode.dotAssign_operation (enumerator_16994.current_mName (HERE).reader_identifierRepresentation (SOURCE_FILE ("lexiqueGeneration.gSemantics", 421))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 421)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 422)) ;
    result_outGeneratedCode.dotAssign_operation (enumerator_16994.current_mName (HERE).reader_length (SOURCE_FILE ("lexiqueGeneration.gSemantics", 423)).reader_string (SOURCE_FILE ("lexiqueGeneration.gSemantics", 423))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 423)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string (", true)) {\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 424)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("  token.mTokenCode = kToken_").operator_concat (enumerator_16994.current_mTerminalName (HERE).reader_identifierRepresentation (SOURCE_FILE ("lexiqueGeneration.gSemantics", 425))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 425)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 425))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 425)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("  enterToken (token) ;\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 426)) ;
    result_outGeneratedCode.dotAssign_operation (GALGAS_string ("}else ")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 427)) ;
...
static GALGAS_string categoryReader_lexicalExplicitRuleAST_generateCode (const cPtr_abstractLexicalRuleAST * inObject,
  ...
  result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateConditionCode ((const cPtr_lexicalExpressionAST *) object->mAttribute_mLexicalRuleExpression.ptr (), inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 439))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 439)) ;
  result_outGeneratedCode.dotAssign_operation (GALGAS_string (") {\n")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 440)) ;
  {
  result_outGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 441)) ;
  }
  cEnumerator_lexicalInstructionListAST enumerator_17954 (object->mAttribute_mInstructionList, kEnumeration_up) ;
  while (enumerator_17954.hasCurrentObject ()) {
    result_outGeneratedCode.dotAssign_operation (callCategoryReader_generateInstructionCode ((const cPtr_lexicalInstructionAST *) enumerator_17954.current_mInstruction (HERE).ptr (), inArgument_inScannerClassName, inArgument_inLexiqueAnalysisContext, inCompiler COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 443))  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 443)) ;
    enumerator_17954.gotoNextObject () ;
  }
  {
  result_outGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 445)) ;
  }
  result_outGeneratedCode.dotAssign_operation (GALGAS_string ("}else ")  COMMA_SOURCE_FILE ("lexiqueGeneration.gSemantics", 446)) ;
//---
  return result_outGeneratedCode ;
}
