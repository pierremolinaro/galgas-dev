...
template_filewrapper_programFileGenerationTemplate_programFileImplementation (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "      NULL\n"
      ...
      "        PMSInt16 r = 0 ;\n"
      "        " ;
    GGS_programRuleList::cEnumerator enumerator_4183 (var_cas_PROGRAM_RULE_LIST, true) ;
    const GGS_programRuleList::cElement * operand_4183 = NULL ;
    { GGS_uint var_cas_IDX (true, 0) ;
  while (((operand_4183 = enumerator_4183.nextObject ()))) {
    macroValidPointer (operand_4183) ;
    result << "if (fileExtension == " ;
    result << operand_4183->mSourceFileExtension.ggs_string ().reader_utf8Representation () ;
    result << ") {\n"
      "          routine_" ;
