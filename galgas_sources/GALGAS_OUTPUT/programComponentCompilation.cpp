...
//                    september 24th, 2010, at 15h21'54"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
const GGS_bool cond_12416 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (278))).operator_isEqual (GGS_uint (0U)) ;
if (cond_12416.isBuiltAndTrue ()) {
GGS_string var_cas_implementationString = template_filewrapper_programFileGenerationTemplate_programFileImplementation (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (280)), var_cas_implementationIncludeList, var_cas_programComponentAST.reader_mProgramRules (inLexique COMMA_SOURCE_FILE_AT_LINE (282))) ;
{
  ...
  while (((operand_12016 = enumerator_12016.nextObject ()))) {
    ...
    var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_12016->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12016->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (285)))) ;
    var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_12016->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12016->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (286)))) ;
  }
}
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (290))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
