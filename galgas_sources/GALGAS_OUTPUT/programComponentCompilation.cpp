...
GALGAS_string filewrapperTemplate_programFileGenerationTemplate_programFileImplementation (C_Compiler * /* inCompiler */,
  ...
  if (in_PROGRAM_5F_RULE_5F_LIST.isValid ()) {
    cEnumerator_programRuleList enumerator_2882 (in_PROGRAM_5F_RULE_5F_LIST, true) ;
  ...
  if (in_PROGRAM_5F_RULE_5F_LIST.isValid ()) {
    cEnumerator_programRuleList enumerator_3050 (in_PROGRAM_5F_RULE_5F_LIST, true) ;
  ...
  if (in_PROGRAM_5F_RULE_5F_LIST.isValid ()) {
    cEnumerator_programRuleList enumerator_4958 (in_PROGRAM_5F_RULE_5F_LIST, true) ;
...
void routine_compileProgramComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_2) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_11149 (var_decoratedDeclarationListForGeneration, true) ;
    //--- simple foreach instruction
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_11278 (var_decoratedDeclarationListForGeneration, true) ;
    //--- simple foreach instruction
  ...
  if (kBoolTrue == test_3) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_12017 (var_decoratedDeclarationListForGeneration, true) ;
    //--- simple foreach instruction
