...
void routine_compileProgramComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_2) {
    ...
    while (enumerator_12159.hasCurrentObject ()) {
      ...
      callCategoryMethod_appendDeclaration_31_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_12159.current_mDeclaration (HERE).ptr (), var_unusedInclusionSet, var_code, inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 301)) ;
    ...
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_12393 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    while (enumerator_12393.hasCurrentObject ()) {
      ...
      callCategoryMethod_appendDeclaration_32_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_12393.current_mDeclaration (HERE).ptr (), GALGAS_bool (false), constinArgument_inOutputDirectory, var_inclusionSet_32_, var_headerString_32_, inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 306)) ;
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_13293 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    while (enumerator_13293.hasCurrentObject ()) {
      var_implementationString.dotAssign_operation (callCategoryReader_appendTypeGenericImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_13293.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 329))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 329)) ;
      var_implementationString.dotAssign_operation (callCategoryReader_appendSpecificImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_13293.current_mDeclaration (HERE).ptr (), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 330))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 330)) ;
...
void routine_compileProgramComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_lstring joker_14339_0 ; // Joker input parameter
    ioArgument_ioParsedComponentStruct.mAttribute_mParsedProgramComponentMap.method_searchKey (var_basenameKey, joker_14339_0, var_programComponentAST, inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 356)) ;
  }else if (kBoolFalse == test_0) {
    var_programComponentAST.drop () ;
    C_String syntaxDirectedTranslationResult_14401 ;
    cGrammar_programSLRgrammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_14401, constinArgument_inSourceFile, var_programComponentAST  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 358)) ;
    {
...
void routine_compileProgramComponentGalgas_33_ (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  if (kBoolTrue == test_0) {
    ...
    while (enumerator_16745.hasCurrentObject ()) {
      ...
      GALGAS_string var_code ;
      callCategoryMethod_appendDeclaration_31_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_16745.current_mDeclaration (HERE).ptr (), var_inclusionSet, var_code, inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 429)) ;
      ...
      if (kBoolTrue == test_2) {
        cEnumerator_stringset enumerator_16938 (var_inclusionSet, kEnumeration_up) ;
        while (enumerator_16938.hasCurrentObject ()) {
          var_headerString.dotAssign_operation (GALGAS_string ("#include \"").operator_concat (enumerator_16938.current_key (HERE)  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 432)).operator_concat (GALGAS_string (".h\"\n")  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 432))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 432)) ;
    ...
    while (enumerator_17128.hasCurrentObject ()) {
      ...
      GALGAS_string var_headerString_32_ ;
      callCategoryMethod_appendDeclaration_32_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_17128.current_mDeclaration (HERE).ptr (), GALGAS_bool (true), constinArgument_inOutputDirectory, var_inclusionSet_32_, var_headerString_32_, inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 439)) ;
      ...
      if (kBoolTrue == test_3) {
        cEnumerator_stringset enumerator_17358 (var_inclusionSet_32_, kEnumeration_up) ;
        while (enumerator_17358.hasCurrentObject ()) {
          var_headerString.dotAssign_operation (GALGAS_string ("#include \"").operator_concat (enumerator_17358.current_key (HERE)  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 442)).operator_concat (GALGAS_string (".h\"\n")  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 442))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 442)) ;
  ...
  if (kBoolTrue == test_4) {
    ...
    cEnumerator_optionComponentMapForSemanticAnalysis enumerator_18051 (constinArgument_inSemanticContext.mAttribute_mOptionComponentMapForSemanticAnalysis, kEnumeration_up) ;
    while (enumerator_18051.hasCurrentObject ()) {
      const enumGalgasBool test_5 = enumerator_18051.current_mIsPredefined (HERE).operator_not (SOURCE_FILE ("programComponentCompilation.gSemantics", 463)).boolEnum () ;
      if (kBoolTrue == test_5) {
        var_implementationIncludeList.addAssign_operation (GALGAS_string ("option-").operator_concat (enumerator_18051.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 464))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 464)) ;
      }
      enumerator_18051.gotoNextObject () ;
    }
    cEnumerator_grammarMap enumerator_18224 (constinArgument_inSemanticContext.mAttribute_mGrammarMap, kEnumeration_up) ;
    while (enumerator_18224.hasCurrentObject ()) {
      var_implementationIncludeList.addAssign_operation (GALGAS_string ("grammar-").operator_concat (enumerator_18224.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 468))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 468)) ;
    ...
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_18565 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    while (enumerator_18565.hasCurrentObject ()) {
      var_implementationString.dotAssign_operation (callCategoryReader_appendTypeGenericImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_18565.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 477))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 477)) ;
      var_implementationString.dotAssign_operation (callCategoryReader_appendSpecificImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_18565.current_mDeclaration (HERE).ptr (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 478))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 478)) ;
      enumerator_18565.gotoNextObject () ;
    }
    ioArgument_ioAllProductFileSet.addAssign_operation (var_programFileName.add_operation (GALGAS_string (".cpp"), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 480))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 480)) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_programFileName.operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 483)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_implementationString, GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 481)) ;
    }
  }
}
