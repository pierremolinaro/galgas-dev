...
template_filewrapper_programFileGenerationTemplate_programFileImplementation (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    GGS_programRuleList::cEnumerator enumerator_1824 (var_cas_PROGRAM_RULE_LIST, true) ;
    const GGS_programRuleList::cElement * operand_1824 = NULL ;
    while (((operand_1824 = enumerator_1824.nextObject ()))) {
      macroValidPointer (operand_1824) ;
      result << "      " ;
      result << operand_1824->mSourceFileExtension.ggs_string ().reader_utf8Representation () ;
      result << ",\n" ;
    }
    result << "      NULL\n"
      "    } ;    \n"
      "    const char * helpMessages [] = {\n" ;
    GGS_programRuleList::cEnumerator enumerator_1992 (var_cas_PROGRAM_RULE_LIST, true) ;
    const GGS_programRuleList::cElement * operand_1992 = NULL ;
    while (((operand_1992 = enumerator_1992.nextObject ()))) {
      macroValidPointer (operand_1992) ;
      result << "      " ;
      result << operand_1992->mSourceFileHelp.ggs_string ().reader_utf8Representation () ;
      result << ",\n" ;
    }
    result << "      NULL\n"
      "    } ;    \n"
      ...
      "        PMSInt16 r = 0 ;\n"
      "        " ;
    GGS_programRuleList::cEnumerator enumerator_4010 (var_cas_PROGRAM_RULE_LIST, true) ;
    const GGS_programRuleList::cElement * operand_4010 = NULL ;
    { GGS_uint var_cas_IDX (true, 0) ;
  while (((operand_4010 = enumerator_4010.nextObject ()))) {
    macroValidPointer (operand_4010) ;
    result << "if (fileExtension == " ;
    result << operand_4010->mSourceFileExtension.ggs_string ().reader_utf8Representation () ;
    result << ") {\n"
      "          routine_" ;
    result << (GGS_string ("programRule_")).operator_concat (var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (100))).reader_identifierRepresentation () ;
    result << " (sourceFilePath, commonLexique COMMA_HERE) ;\n" ;
    if (enumerator_4010.hasNextObject ()) {
      result << "        }else " ;
    }
