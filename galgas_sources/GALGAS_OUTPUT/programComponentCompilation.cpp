...
GALGAS_string filewrapperTemplate_programFileGenerationTemplate_programFileImplementation (C_Compiler * /* inCompiler */,
  ...
  result << "  NULL\n"
    ...
    "        PMSInt16 r = 0 ;\n"
    "        " ;
  GALGAS_uint index_4352_IDX (0) ;
  if (in_PROGRAM_5F_RULE_5F_LIST.isValid ()) {
    cEnumerator_programRuleList enumerator_4352 (in_PROGRAM_5F_RULE_5F_LIST, kEnumeration_up) ;
    while (enumerator_4352.hasCurrentObject ()) {
      result << "if (fileExtension == " ;
      result << enumerator_4352.current_mSourceFileExtension (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (109)).stringValue () ;
      result << ") {\n" ;
      const enumGalgasBool test_0 = in_HAS_5F_INDEXING.boolEnum () ;
      if (kBoolTrue == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_4352.current_mIndexingGrammar (HERE).reader_string (SOURCE_FILE_AT_LINE (111)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_1) {
          result << "          if (! executionModeIsIndexing ()) {\n"
            "            routine_" ;
          result << GALGAS_string ("programRule_").operator_concat (index_4352_IDX.reader_string (SOURCE_FILE_AT_LINE (113)) COMMA_SOURCE_FILE_AT_LINE (113)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (113)).stringValue () ;
          result << " (sourceFilePath, commonLexique COMMA_HERE) ;\n"
            "          }\n" ;
        }else if (kBoolFalse == test_1) {
          result << "          if (executionModeIsIndexing ()) {\n"
            "            cGrammar_" ;
          result << enumerator_4352.current_mIndexingGrammar (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (117)).stringValue () ;
          result << "::performIndexing (commonLexique, sourceFilesArray (i COMMA_HERE)) ;\n"
            "          }else{\n"
            "            routine_" ;
          result << GALGAS_string ("programRule_").operator_concat (index_4352_IDX.reader_string (SOURCE_FILE_AT_LINE (119)) COMMA_SOURCE_FILE_AT_LINE (119)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (119)).stringValue () ;
          result << " (sourceFilePath, commonLexique COMMA_HERE) ;\n"
            "          }\n" ;
        }
      }else if (kBoolFalse == test_0) {
        result << "          routine_" ;
        result << GALGAS_string ("programRule_").operator_concat (index_4352_IDX.reader_string (SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (123)).stringValue () ;
        result << " (sourceFilePath, commonLexique COMMA_HERE) ;\n" ;
      }
      if (enumerator_4352.hasNextObject ()) {
        result << "        }else " ;
      }
      index_4352_IDX.increment () ;
...
void routine_compileAfterClause (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      routine_analyzeRoutineBody (constinArgument_inAnalysisContext, GALGAS_formalParameterListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (166)), GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE_AT_LINE (167)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (168)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (169)), GALGAS_string::makeEmptyString (), constinArgument_inProgramComponentAST.reader_mEpilogueList (SOURCE_FILE_AT_LINE (171)).reader_mInstructionListAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (171)), constinArgument_inProgramComponentAST.reader_mEpilogueList (SOURCE_FILE_AT_LINE (172)).reader_mEndOfInstructionListAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (172)), var_semanticInstructionListForGeneration, joker_8230_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (164)) ;
      }
    }
  }
