...
//                    september 22th, 2010, at 20h53'22"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
template_filewrapper_programFileGenerationTemplate_programFileImplementation (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "      NULL\n"
      ...
      "        PMSInt16 r = 0 ;\n"
      "        " ;
    GGS_programRuleList::cEnumerator enumerator_4068 (var_cas_PROGRAM_RULE_LIST, true) ;
    const GGS_programRuleList::cElement * operand_4068 = NULL ;
    { GGS_uint var_cas_IDX (true, 0) ;
  while (((operand_4068 = enumerator_4068.nextObject ()))) {
    macroValidPointer (operand_4068) ;
    result << "if (fileExtension == " ;
    result << operand_4068->mSourceFileExtension.ggs_string ().reader_utf8Representation () ;
    result << ") {\n"
      "          routine_" ;
    result << (GGS_string ("programRule_")).operator_concat (var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (101))).reader_identifierRepresentation () ;
    result << " (sourceFilePath, commonLexique COMMA_HERE) ;\n" ;
    if (enumerator_4068.hasNextObject ()) {
      result << "        }else " ;
    }
...
GGS_semanticDeclarationListAST  var_cas_semanticDeclarationList = var_cas_programComponentAST.reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (186)) ;
...
::routine_performSemanticAnalysis (inLexique,  var_cas_programComponentAST.reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (227)),  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (226)) ;
...
const GGS_bool cond_11671 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (255))).operator_isEqual (GGS_uint (0U)) ;
...
{
  GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11229 (var_cas_decoratedDeclarationListForGeneration, true) ;
  const GGS_semanticDeclarationListForGeneration::cElement * operand_11229 = NULL ;
  while (((operand_11229 = enumerator_11229.nextObject ()))) {
    macroValidPointer (operand_11229) ;
    var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassDeclaration (operand_11229->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11229->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (262)))) ;
  }
}
{
  GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11373 (var_cas_decoratedDeclarationListForGeneration, true) ;
  const GGS_semanticDeclarationListForGeneration::cElement * operand_11373 = NULL ;
  while (((operand_11373 = enumerator_11373.nextObject ()))) {
    macroValidPointer (operand_11373) ;
    var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_11373->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11373->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (265)))) ;
  }
}
...
const GGS_bool cond_12500 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (278))).operator_isEqual (GGS_uint (0U)) ;
...
{
  GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_12016 (var_cas_decoratedDeclarationListForGeneration, true) ;
  const GGS_semanticDeclarationListForGeneration::cElement * operand_12016 = NULL ;
  while (((operand_12016 = enumerator_12016.nextObject ()))) {
    macroValidPointer (operand_12016) ;
    var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassImplementation (operand_12016->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12016->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (285)))) ;
    var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_12016->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12016->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (286)))) ;
    var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_12016->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12016->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (287)))) ;
  }
}
