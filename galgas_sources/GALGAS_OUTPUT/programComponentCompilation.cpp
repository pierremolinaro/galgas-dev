...
template_filewrapper_programFileGenerationTemplate_programFileImplementation (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "      NULL\n"
      ...
      "        GALGASap_string sfp = GALGAS_string::constructor_new (sourceFilesArray (i COMMA_HERE) COMMA_HERE) ;\n"
      "        GALGASap_location location = commonLexique->here (HERE) ;\n"
      "        GALGASap_lstring sourceFilePath = GALGAS_lstring::constructor_new (sfp, location COMMA_HERE) ;\n"
      "        PMSInt16 r = 0 ;\n"
      "        " ;
    GGS_programRuleList::cEnumerator enumerator_4179 (var_cas_PROGRAM_RULE_LIST, true) ;
    const GGS_programRuleList::cElement * operand_4179 = NULL ;
    { GGS_uint var_cas_IDX (true, 0) ;
  while (((operand_4179 = enumerator_4179.nextObject ()))) {
    macroValidPointer (operand_4179) ;
    result << "if (fileExtension == " ;
    result << operand_4179->mSourceFileExtension.ggs_string ().reader_utf8Representation () ;
    result << ") {\n"
      "          routine_" ;
    result << (GGS_string ("programRule_")).operator_concat (var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (105))).reader_identifierRepresentation () ;
