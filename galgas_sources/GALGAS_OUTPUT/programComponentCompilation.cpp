...
void routine_compileProgramComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_2) {
    ...
    while (enumerator_12393.hasCurrentObject ()) {
      var_headerString.dotAssign_operation (callCategoryReader_appendDeclaration_32_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_12393.current_mDeclaration (HERE).ptr (), constinArgument_inOutputDirectory, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 305))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 305)) ;
      enumerator_12393.gotoNextObject () ;
    }
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_componentName.reader_string (SOURCE_FILE ("programComponentCompilation.gSemantics", 309)).operator_concat (GALGAS_string (".h")  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 309)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_headerString, GALGAS_string ("\n"
      "\n"), GALGAS_string ("#endif\n"), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 307)) ;
    }
  }
  const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("programComponentCompilation.gSemantics", 318)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_3) {
    GALGAS_string var_implementationString = GALGAS_string (filewrapperTemplate_programFileGenerationTemplate_programFileImplementation (inCompiler, var_componentName.reader_string (SOURCE_FILE ("programComponentCompilation.gSemantics", 320)), var_implementationIncludeList, constinArgument_inProgramComponentAST.reader_mProgramRules (SOURCE_FILE ("programComponentCompilation.gSemantics", 322)), var_hasIndexing COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 319))) ;
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_13095 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    while (enumerator_13095.hasCurrentObject ()) {
      var_implementationString.dotAssign_operation (callCategoryReader_appendTypeGenericImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_13095.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 326))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 326)) ;
      var_implementationString.dotAssign_operation (callCategoryReader_appendSpecificImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_13095.current_mDeclaration (HERE).ptr (), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 327))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 327)) ;
      enumerator_13095.gotoNextObject () ;
    }
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_componentName.reader_string (SOURCE_FILE ("programComponentCompilation.gSemantics", 331)).operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 331)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_implementationString, GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 329)) ;
    }
  }
}
...
void routine_compileProgramComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
                                                    ...
                                                    C_Compiler * inCompiler
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_basename = constinArgument_inSourceFile.mAttribute_string.reader_lastPathComponent (SOURCE_FILE ("programComponentCompilation.gSemantics", 349)).reader_stringByDeletingPathExtension (SOURCE_FILE ("programComponentCompilation.gSemantics", 349)) ;
  GALGAS_lstring var_basenameKey = GALGAS_lstring::constructor_new (var_basename, inCompiler->here ()  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 350)) ;
  GALGAS_programComponentAST var_programComponentAST ;
  const enumGalgasBool test_0 = ioArgument_ioParsedComponentStruct.mAttribute_mParsedProgramComponentMap.reader_hasKey (var_basename COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 352)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_lstring joker_14141_0 ; // Joker input parameter
    ioArgument_ioParsedComponentStruct.mAttribute_mParsedProgramComponentMap.method_searchKey (var_basenameKey, joker_14141_0, var_programComponentAST, inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 353)) ;
  }else if (kBoolFalse == test_0) {
    var_programComponentAST.drop () ;
    C_String syntaxDirectedTranslationResult_14203 ;
    cGrammar_programSLRgrammar::_performSourceFileParsing_ (inCompiler, syntaxDirectedTranslationResult_14203, constinArgument_inSourceFile, var_programComponentAST  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 355)) ;
    {
    ioArgument_ioParsedComponentStruct.mAttribute_mParsedProgramComponentMap.modifier_insertKey (var_basenameKey, constinArgument_inSourceFile, var_programComponentAST, inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 356)) ;
    }
  }
  {
  routine_compileProgramComponentFromAST (constinArgument_inSourceFile, constinArgument_inOutputDirectory, var_programComponentAST, ioArgument_ioParsedComponentStruct, inCompiler  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 359)) ;
  }
}
...
void routine_compileProgramComponentGalgas_33_ (const GALGAS_string constinArgument_inOutputDirectory,
                                                ...
                                                C_Compiler * inCompiler
                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, function_buildPredefinedTypes (constinArgument_inSemanticContext, inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 385)), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("programComponentCompilation.gSemantics", 386)), GALGAS_string::makeEmptyString (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("programComponentCompilation.gSemantics", 388))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 383)) ;
  GALGAS_semanticDeclarationSortedListForGeneration var_decoratedDeclarationListForGeneration = GALGAS_semanticDeclarationSortedListForGeneration::constructor_emptySortedList (SOURCE_FILE ("programComponentCompilation.gSemantics", 391)) ;
  {
  routine_compileBeforeClause (var_analysisContext, constinArgument_inPrologueList, var_decoratedDeclarationListForGeneration, inCompiler  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 392)) ;
  }
  GALGAS_bool var_hasIndexing = GALGAS_bool (false) ;
  {
  routine_compileProgramRules (var_analysisContext, constinArgument_inProgramRules, var_decoratedDeclarationListForGeneration, var_hasIndexing, inCompiler  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 399)) ;
  }
  {
  routine_compileAfterClause (var_analysisContext, constinArgument_inEpilogueList, var_decoratedDeclarationListForGeneration, inCompiler  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 406)) ;
  }
  GALGAS_string var_programFileName = GALGAS_string ("program") ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("programComponentCompilation.gSemantics", 413)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_stringlist var_headerIncludeList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("programComponentCompilation.gSemantics", 414)) ;
    var_headerIncludeList.addAssign_operation (GALGAS_string ("all-declarations")  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 415)) ;
    GALGAS_string var_headerString = GALGAS_string (filewrapperTemplate_programFileGenerationTemplate_programFileHeader (inCompiler, var_programFileName, var_headerIncludeList, constinArgument_inSemanticContext.mAttribute_mTypeMap.reader_allKeyList (SOURCE_FILE ("programComponentCompilation.gSemantics", 419)) COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 416))) ;
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_16474 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    while (enumerator_16474.hasCurrentObject ()) {
      GALGAS_stringset var_inclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("programComponentCompilation.gSemantics", 422)) ;
      GALGAS_string var_code ;
      callCategoryMethod_appendDeclaration_31_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_16474.current_mDeclaration (HERE).ptr (), var_inclusionSet, var_code, inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 423)) ;
      cEnumerator_stringset enumerator_16629 (var_inclusionSet, kEnumeration_up) ;
      while (enumerator_16629.hasCurrentObject ()) {
        var_headerString.dotAssign_operation (GALGAS_string ("#include \"").operator_concat (enumerator_16629.current_key (HERE)  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 425)).operator_concat (GALGAS_string (".h\"\n")  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 425))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 425)) ;
        enumerator_16629.gotoNextObject () ;
      }
      var_headerString.dotAssign_operation (var_code  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 427)) ;
      enumerator_16474.gotoNextObject () ;
    }
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_16800 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    while (enumerator_16800.hasCurrentObject ()) {
      var_headerString.dotAssign_operation (callCategoryReader_appendDeclaration_32_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_16800.current_mDeclaration (HERE).ptr (), constinArgument_inOutputDirectory, GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 430))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 430)) ;
      enumerator_16800.gotoNextObject () ;
    }
    ioArgument_ioAllProductFileSet.addAssign_operation (var_programFileName.add_operation (GALGAS_string (".h"), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 432))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 432)) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_programFileName.add_operation (GALGAS_string (".h"), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 435)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_headerString, GALGAS_string ("\n"
      "\n"), GALGAS_string ("#endif\n"), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 433)) ;
    }
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("programComponentCompilation.gSemantics", 444)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    ioArgument_ioToolProductFileList.addAssign_operation (var_programFileName.operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 445))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 445)) ;
    GALGAS_stringlist var_implementationIncludeList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("programComponentCompilation.gSemantics", 446)) ;
    cEnumerator_optionComponentMapForSemanticAnalysis enumerator_17448 (constinArgument_inSemanticContext.mAttribute_mOptionComponentMapForSemanticAnalysis, kEnumeration_up) ;
    while (enumerator_17448.hasCurrentObject ()) {
      const enumGalgasBool test_2 = enumerator_17448.current_mIsPredefined (HERE).operator_not (SOURCE_FILE ("programComponentCompilation.gSemantics", 448)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_implementationIncludeList.addAssign_operation (GALGAS_string ("option-").operator_concat (enumerator_17448.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 449))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 449)) ;
      }
      enumerator_17448.gotoNextObject () ;
    }
    cEnumerator_grammarMap enumerator_17621 (constinArgument_inSemanticContext.mAttribute_mGrammarMap, kEnumeration_up) ;
    while (enumerator_17621.hasCurrentObject ()) {
      var_implementationIncludeList.addAssign_operation (GALGAS_string ("grammar-").operator_concat (enumerator_17621.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 453))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 453)) ;
      enumerator_17621.gotoNextObject () ;
    }
    GALGAS_string var_implementationString = GALGAS_string (filewrapperTemplate_programFileGenerationTemplate_programFileImplementation (inCompiler, var_programFileName, var_implementationIncludeList, constinArgument_inProgramRules, var_hasIndexing COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 455))) ;
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_17962 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    while (enumerator_17962.hasCurrentObject ()) {
      var_implementationString.dotAssign_operation (callCategoryReader_appendTypeGenericImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_17962.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 462))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 462)) ;
      var_implementationString.dotAssign_operation (callCategoryReader_appendSpecificImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_17962.current_mDeclaration (HERE).ptr (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 463))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 463)) ;
      enumerator_17962.gotoNextObject () ;
    }
    ioArgument_ioAllProductFileSet.addAssign_operation (var_programFileName.add_operation (GALGAS_string (".cpp"), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 465))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 465)) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_programFileName.operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 468)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_implementationString, GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 466)) ;
    }
  }
}
