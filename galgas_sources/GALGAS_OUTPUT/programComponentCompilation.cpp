...
template_filewrapper_programFileGenerationTemplate_programFileImplementation (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << "      NULL\n"
      ...
      "          PMSInt16 r = 0 ;\n"
      "          " ;
    GGS_programRuleList::cEnumerator enumerator_4127 (var_cas_PROGRAM_RULE_LIST, true) ;
    const GGS_programRuleList::cElement * operand_4127 = NULL ;
    { GGS_uint var_cas_IDX (true, 0) ;
  while (((operand_4127 = enumerator_4127.nextObject ()))) {
    macroValidPointer (operand_4127) ;
    result << "if (fileExtension == " ;
    result << operand_4127->mSourceFileExtension.ggs_string ().reader_utf8Representation () ;
    result << ") {\n"
      "            routine_" ;
    ...
    if (enumerator_4127.hasNextObject ()) {
      result << "          }else " ;
    }
