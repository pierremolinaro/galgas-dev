...
GALGAS_string filewrapperTemplate_programFileGenerationTemplate_programFileHeader (C_Compiler * /* inCompiler */,
  ...
  if (in_TYPE_5F_PREDECLARATION_5F_LIST.isValid ()) {
    cEnumerator_lstringlist enumerator_485 (in_TYPE_5F_PREDECLARATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_485.hasCurrentObject ()) {
      result << "class GALGAS_" ;
      result << enumerator_485.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (17)).stringValue () ;
      result << " ;\n" ;
...
GALGAS_string filewrapperTemplate_programFileGenerationTemplate_programFileImplementation (C_Compiler * /* inCompiler */,
  ...
  if (in_IMPORTED_5F_COMPONENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_546 (in_IMPORTED_5F_COMPONENT_5F_LIST, kEnumeration_up) ;
    while (enumerator_546.hasCurrentObject ()) {
      result << "#include \"" ;
      result << enumerator_546.current_mValue (HERE).stringValue () ;
      result << ".h\"\n" ;
  ...
  GALGAS_uint index_1613_ (0) ;
  if (in_PROGRAM_5F_RULE_5F_LIST.isValid ()) {
    cEnumerator_programRuleList enumerator_1613 (in_PROGRAM_5F_RULE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1613.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_1613.current_mSourceFileExtension (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (42)).stringValue () ;
      result << ",\n" ;
      index_1613_.increment () ;
  ...
  if (in_PROGRAM_5F_RULE_5F_LIST.isValid ()) {
    cEnumerator_programRuleList enumerator_1858 (in_PROGRAM_5F_RULE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1858.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_1858.current_mSourceFileHelp (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (52)).stringValue () ;
      result << ",\n" ;
