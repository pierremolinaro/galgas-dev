...
//                    november 30th, 2010, at 17h44'34"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_compileProgramComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_componentName.reader_string (SOURCE_FILE_AT_LINE (182)).objectCompare (var_basename))) ;
  if (test_0.isValidAndTrue ()) {
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_2 (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (263)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_3 (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (286)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
...
void routine_compileProgramComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (ioArgument_ioParsedComponentStruct.mAttribute_mParsedProgramComponentMap.reader_hasKey (var_basename COMMA_SOURCE_FILE_AT_LINE (321))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @methodCallInstructionForGeneration
