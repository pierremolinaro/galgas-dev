...
void routine_compileProgramComponentGalgas_33_ (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  if (kBoolTrue == test_0) {
    ...
    var_headerIncludeList.addAssign_operation (GALGAS_string ("AZERTYUIOP")  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 413)) ;
    ...
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_16370 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    while (enumerator_16370.hasCurrentObject ()) {
      var_headerString.dotAssign_operation (callCategoryReader_appendDeclaration_31_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_16370.current_mDeclaration (HERE).ptr (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 420))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 420)) ;
      enumerator_16370.gotoNextObject () ;
    }
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_16505 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    while (enumerator_16505.hasCurrentObject ()) {
      var_headerString.dotAssign_operation (callCategoryReader_appendDeclaration_32_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_16505.current_mDeclaration (HERE).ptr (), constinArgument_inOutputDirectory, GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 423))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 423)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_optionComponentMapForSemanticAnalysis enumerator_17153 (constinArgument_inSemanticContext.mAttribute_mOptionComponentMapForSemanticAnalysis, kEnumeration_up) ;
    while (enumerator_17153.hasCurrentObject ()) {
      const enumGalgasBool test_2 = enumerator_17153.current_mIsPredefined (HERE).operator_not (SOURCE_FILE ("programComponentCompilation.gSemantics", 441)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_implementationIncludeList.addAssign_operation (GALGAS_string ("option-").operator_concat (enumerator_17153.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 442))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 442)) ;
      }
      enumerator_17153.gotoNextObject () ;
    }
    cEnumerator_grammarMap enumerator_17326 (constinArgument_inSemanticContext.mAttribute_mGrammarMap, kEnumeration_up) ;
    while (enumerator_17326.hasCurrentObject ()) {
      var_implementationIncludeList.addAssign_operation (GALGAS_string ("grammar-").operator_concat (enumerator_17326.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 446))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 446)) ;
    ...
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_17667 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    while (enumerator_17667.hasCurrentObject ()) {
      var_implementationString.dotAssign_operation (callCategoryReader_appendTypeGenericImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_17667.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 455))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 455)) ;
      var_implementationString.dotAssign_operation (callCategoryReader_appendSpecificImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_17667.current_mDeclaration (HERE).ptr (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 456))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 456)) ;
