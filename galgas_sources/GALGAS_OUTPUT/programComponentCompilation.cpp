...
//                    september 26th, 2010, at 17h37'40"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
const GGS_bool cond_11527 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (255))).operator_isEqual (GGS_uint (0U)) ;
if (cond_11527.isBuiltAndTrue ()) {
GGS_string var_cas_headerString = template_filewrapper_programFileGenerationTemplate_programFileHeader (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (257)), var_cas_headerIncludeList, var_cas_semanticContext.mTypeMap.reader_allKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (259))) ;
{
  ...
  while (((operand_11229 = enumerator_11229.nextObject ()))) {
    ...
    var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_11229->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11229->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (262)))) ;
  }
}
...
const GGS_bool cond_12272 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (275))).operator_isEqual (GGS_uint (0U)) ;
...
{
  GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11872 (var_cas_decoratedDeclarationListForGeneration, true) ;
  const GGS_semanticDeclarationListForGeneration::cElement * operand_11872 = NULL ;
  while (((operand_11872 = enumerator_11872.nextObject ()))) {
    macroValidPointer (operand_11872) ;
    var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_11872->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11872->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (282)))) ;
    var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_11872->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11872->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (283)))) ;
  }
}
