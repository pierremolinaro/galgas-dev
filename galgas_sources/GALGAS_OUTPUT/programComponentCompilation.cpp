...
::routine_buildSemanticContext (inLexique,  var_cas_inSourceFile.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (210)),  var_cas_semanticDeclarationListWithPredefinedTypes,  var_cas_programComponentAST.reader_mEndOfSourceFile (inLexique COMMA_SOURCE_FILE_AT_LINE (212)),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (209)) ;
::routine_buildGrammarComponentMapForSemanticAnalysis (inLexique,  var_cas_grammarComponentASTList,  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (216)) ;
::routine_buildOptionComponentMapForSemanticAnalysis (inLexique,  var_cas_optionComponentFileNameList,  var_cas_ioParsedComponentStruct,  var_cas_semanticContext.mOptionComponentMapForSemanticAnalysis COMMA_SOURCE_FILE_AT_LINE (221)) ;
GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
::routine_performSemanticAnalysis (inLexique,  var_cas_programComponentAST.reader_mSemanticDeclarationList (inLexique COMMA_SOURCE_FILE_AT_LINE (229)),  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (228)) ;
const GGS_predefinedTypes var_cas_predefinedTypes = function_buildPredefinedTypes (inLexique, var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (234)) ;
::routine_compileBeforeClause (inLexique,  var_cas_semanticContext,  var_cas_predefinedTypes,  var_cas_programComponentAST,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (236)) ;
::routine_compileProgramRules (inLexique,  var_cas_semanticContext,  var_cas_predefinedTypes,  var_cas_programComponentAST,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (243)) ;
::routine_compileAfterClause (inLexique,  var_cas_semanticContext,  var_cas_predefinedTypes,  var_cas_programComponentAST,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (250)) ;
const GGS_bool cond_11705 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (257))).operator_isEqual (GGS_uint (0U)) ;
if (cond_11705.isBuiltAndTrue ()) {
GGS_string var_cas_headerString = template_filewrapper_programFileGenerationTemplate_programFileHeader (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (259)), var_cas_headerIncludeList, var_cas_semanticContext.mTypeMap.reader_allKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (261))) ;
{
  ...
  while (((operand_11277 = enumerator_11277.nextObject ()))) {
    ...
    var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration1 (operand_11277->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11277->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (264)))) ;
  }
}
{
  GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11406 (var_cas_decoratedDeclarationListForGeneration, true) ;
  const GGS_semanticDeclarationListForGeneration::cElement * operand_11406 = NULL ;
  while (((operand_11406 = enumerator_11406.nextObject ()))) {
    macroValidPointer (operand_11406) ;
    var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration2 (operand_11406->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11406->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (267)))) ;
  }
}
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (271))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
  "\n"), var_cas_headerString, GGS_string ("\n"
  "\n"), GGS_string ("#endif\n") COMMA_SOURCE_FILE_AT_LINE (269)) ;
}
const GGS_bool cond_12503 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (280))).operator_isEqual (GGS_uint (0U)) ;
if (cond_12503.isBuiltAndTrue ()) {
GGS_string var_cas_implementationString = template_filewrapper_programFileGenerationTemplate_programFileImplementation (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (282)), var_cas_implementationIncludeList, var_cas_programComponentAST.reader_mProgramRules (inLexique COMMA_SOURCE_FILE_AT_LINE (284)), var_cas_programComponentAST.reader_mVersionString (inLexique COMMA_SOURCE_FILE_AT_LINE (285)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (285))) ;
{
  GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_12103 (var_cas_decoratedDeclarationListForGeneration, true) ;
  const GGS_semanticDeclarationListForGeneration::cElement * operand_12103 = NULL ;
  while (((operand_12103 = enumerator_12103.nextObject ()))) {
    macroValidPointer (operand_12103) ;
    var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_12103->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12103->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (288)))) ;
    var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_12103->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12103->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (289)))) ;
  }
}
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (293))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
