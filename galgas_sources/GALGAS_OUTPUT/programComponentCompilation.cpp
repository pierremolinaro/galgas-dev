...
void routine_compileProgramComponentGalgas_33_ (const GALGAS_string constinArgument_inOutputDirectory,
                                                ...
                                                C_Compiler * inCompiler
                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (constinArgument_inSemanticContext, function_buildPredefinedTypes (constinArgument_inSemanticContext, inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 388)), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("programComponentCompilation.gSemantics", 389)), GALGAS_string::makeEmptyString (), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("programComponentCompilation.gSemantics", 391))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 386)) ;
  GALGAS_semanticDeclarationSortedListForGeneration var_decoratedDeclarationListForGeneration = GALGAS_semanticDeclarationSortedListForGeneration::constructor_emptySortedList (SOURCE_FILE ("programComponentCompilation.gSemantics", 394)) ;
  {
  routine_compileBeforeClause (var_analysisContext, constinArgument_inPrologueList, var_decoratedDeclarationListForGeneration, inCompiler  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 395)) ;
  }
  GALGAS_bool var_hasIndexing = GALGAS_bool (false) ;
  {
  routine_compileProgramRules (var_analysisContext, constinArgument_inProgramRules, var_decoratedDeclarationListForGeneration, var_hasIndexing, inCompiler  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 402)) ;
  }
  {
  routine_compileAfterClause (var_analysisContext, constinArgument_inEpilogueList, var_decoratedDeclarationListForGeneration, inCompiler  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 409)) ;
  }
  GALGAS_string var_programFileName = GALGAS_string ("program") ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("programComponentCompilation.gSemantics", 416)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_stringlist var_headerIncludeList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("programComponentCompilation.gSemantics", 417)) ;
    ...
    while (enumerator_16672.hasCurrentObject ()) {
      ...
      GALGAS_string var_code ;
      callCategoryMethod_appendDeclaration_31_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_16672.current_mDeclaration (HERE).ptr (), var_inclusionSet, var_code, inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 426)) ;
      cEnumerator_stringset enumerator_16827 (var_inclusionSet, kEnumeration_up) ;
      while (enumerator_16827.hasCurrentObject ()) {
        var_headerString.dotAssign_operation (GALGAS_string ("#include \"").operator_concat (enumerator_16827.current_key (HERE)  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 428)).operator_concat (GALGAS_string (".h\"\n")  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 428))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 428)) ;
        enumerator_16827.gotoNextObject () ;
      }
      var_headerString.dotAssign_operation (var_code  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 430)) ;
      enumerator_16672.gotoNextObject () ;
    }
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_16998 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    while (enumerator_16998.hasCurrentObject ()) {
      GALGAS_stringset var_inclusionSet_32_ = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("programComponentCompilation.gSemantics", 433)) ;
      GALGAS_string var_headerString_32_ ;
      callCategoryMethod_appendDeclaration_32_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_16998.current_mDeclaration (HERE).ptr (), GALGAS_bool (true), constinArgument_inOutputDirectory, var_inclusionSet_32_, var_headerString_32_, inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 434)) ;
      cEnumerator_stringset enumerator_17190 (var_inclusionSet_32_, kEnumeration_up) ;
      while (enumerator_17190.hasCurrentObject ()) {
        var_headerString.dotAssign_operation (GALGAS_string ("#include \"").operator_concat (enumerator_17190.current_key (HERE)  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 436)).operator_concat (GALGAS_string (".h\"\n")  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 436))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 436)) ;
        enumerator_17190.gotoNextObject () ;
      }
      var_headerString.dotAssign_operation (var_headerString_32_  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 438)) ;
      enumerator_16998.gotoNextObject () ;
    }
    ioArgument_ioAllProductFileSet.addAssign_operation (var_programFileName.add_operation (GALGAS_string (".h"), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 441))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 441)) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_programFileName.add_operation (GALGAS_string (".h"), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 444)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_headerString, GALGAS_string ("\n"
      "\n"), GALGAS_string ("#endif\n"), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 442)) ;
    }
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("programComponentCompilation.gSemantics", 453)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    ioArgument_ioToolProductFileList.addAssign_operation (var_programFileName.operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 454))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 454)) ;
    GALGAS_stringlist var_implementationIncludeList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("programComponentCompilation.gSemantics", 455)) ;
    cEnumerator_optionComponentMapForSemanticAnalysis enumerator_17948 (constinArgument_inSemanticContext.mAttribute_mOptionComponentMapForSemanticAnalysis, kEnumeration_up) ;
    while (enumerator_17948.hasCurrentObject ()) {
      const enumGalgasBool test_2 = enumerator_17948.current_mIsPredefined (HERE).operator_not (SOURCE_FILE ("programComponentCompilation.gSemantics", 457)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_implementationIncludeList.addAssign_operation (GALGAS_string ("option-").operator_concat (enumerator_17948.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 458))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 458)) ;
      }
      enumerator_17948.gotoNextObject () ;
    }
    cEnumerator_grammarMap enumerator_18121 (constinArgument_inSemanticContext.mAttribute_mGrammarMap, kEnumeration_up) ;
    while (enumerator_18121.hasCurrentObject ()) {
      var_implementationIncludeList.addAssign_operation (GALGAS_string ("grammar-").operator_concat (enumerator_18121.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 462))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 462)) ;
      enumerator_18121.gotoNextObject () ;
    }
    GALGAS_string var_implementationString = GALGAS_string (filewrapperTemplate_programFileGenerationTemplate_programFileImplementation (inCompiler, var_programFileName, var_implementationIncludeList, constinArgument_inProgramRules, var_hasIndexing COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 464))) ;
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_18462 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    while (enumerator_18462.hasCurrentObject ()) {
      var_implementationString.dotAssign_operation (callCategoryReader_appendTypeGenericImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_18462.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 471))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 471)) ;
      var_implementationString.dotAssign_operation (callCategoryReader_appendSpecificImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_18462.current_mDeclaration (HERE).ptr (), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 472))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 472)) ;
      enumerator_18462.gotoNextObject () ;
    }
    ioArgument_ioAllProductFileSet.addAssign_operation (var_programFileName.add_operation (GALGAS_string (".cpp"), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 474))  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 474)) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_programFileName.operator_concat (GALGAS_string (".cpp")  COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 477)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_implementationString, GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("programComponentCompilation.gSemantics", 475)) ;
    }
  }
}
