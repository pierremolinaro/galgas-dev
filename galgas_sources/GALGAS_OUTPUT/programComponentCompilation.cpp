...
void routine_compileProgramComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  { //-------- @routineCallInstructionForGeneration
  routine_performSemanticAnalysis (constinArgument_inProgramComponentAST.reader_mSemanticDeclarationList (SOURCE_FILE_AT_LINE (259)), var_semanticContext, constinArgument_inProgramComponentAST.reader_mEndOfSourceFile (SOURCE_FILE_AT_LINE (261)), var_decoratedDeclarationListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (258)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  { //-------- @routineCallInstructionForGeneration
  routine_compileBeforeClause (var_analysisContext, constinArgument_inProgramComponentAST, var_decoratedDeclarationListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (273)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_hasIndexing = GALGAS_bool (false) ;
  { //-------- @routineCallInstructionForGeneration
  routine_compileProgramRules (var_analysisContext, constinArgument_inProgramComponentAST, var_decoratedDeclarationListForGeneration, var_hasIndexing, inCompiler COMMA_SOURCE_FILE_AT_LINE (280)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_compileAfterClause (var_analysisContext, constinArgument_inProgramComponentAST, var_decoratedDeclarationListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (287)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (293)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_12842 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_12842.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      var_headerString.dotAssign_operation (callCategoryReader_appendDeclaration_31_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_12842.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (300)) COMMA_SOURCE_FILE_AT_LINE (300)) ;
      enumerator_12842.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_12971 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_12971.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      var_headerString.dotAssign_operation (callCategoryReader_appendDeclaration_32_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_12971.current_mDeclaration (HERE).ptr (), constinArgument_inOutputDirectory, inCompiler COMMA_SOURCE_FILE_AT_LINE (303)) COMMA_SOURCE_FILE_AT_LINE (303)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (316)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_3) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_13666 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_13666.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      var_implementationString.dotAssign_operation (callCategoryReader_appendTypeGenericImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_13666.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (324)) COMMA_SOURCE_FILE_AT_LINE (324)) ;
      //-------- @concatInstructionForGeneration
      var_implementationString.dotAssign_operation (callCategoryReader_appendSpecificImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_13666.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (325)) COMMA_SOURCE_FILE_AT_LINE (325)) ;
...
void routine_compileProgramComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    GALGAS_lstring joker_14708_0 ; // Joker input parameter
    ioArgument_ioParsedComponentStruct.mAttribute_mParsedProgramComponentMap.method_searchKey (var_basenameKey, joker_14708_0, var_programComponentAST, inCompiler COMMA_SOURCE_FILE_AT_LINE (351)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    { //-------- @grammarInstructionWithSourceFileForGeneration
    cGrammar_programSLRgrammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, var_programComponentAST COMMA_SOURCE_FILE_AT_LINE (353)) ;
