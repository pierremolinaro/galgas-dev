...
GALGAS_string filewrapperTemplate_programFileGenerationTemplate_programFileHeader (C_Compiler * /* inCompiler */,
  ...
  if (in_TYPE_5F_PREDECLARATION_5F_LIST.isValid ()) {
    cEnumerator_lstringlist enumerator_491 (in_TYPE_5F_PREDECLARATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_491.hasCurrentObject ()) {
      result << "class GALGAS_" ;
      result << enumerator_491.current_mValue (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (17)).stringValue () ;
      result << " ;\n" ;
...
GALGAS_string filewrapperTemplate_programFileGenerationTemplate_programFileImplementation (C_Compiler * /* inCompiler */,
  ...
  if (in_PROGRAM_5F_RULE_5F_LIST.isValid ()) {
    cEnumerator_programRuleList enumerator_1627 (in_PROGRAM_5F_RULE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1627.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_1627.current_mSourceFileExtension (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (42)).stringValue () ;
      result << ",\n" ;
  ...
  if (in_PROGRAM_5F_RULE_5F_LIST.isValid ()) {
    cEnumerator_programRuleList enumerator_1874 (in_PROGRAM_5F_RULE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1874.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_1874.current_mSourceFileHelp (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (52)).stringValue () ;
      result << ",\n" ;
  ...
  result << "  NULL\n"
    ...
    "        int16_t r = 0 ;\n"
    "        " ;
  GALGAS_uint index_4349_IDX (0) ;
  if (in_PROGRAM_5F_RULE_5F_LIST.isValid ()) {
    cEnumerator_programRuleList enumerator_4349 (in_PROGRAM_5F_RULE_5F_LIST, kEnumeration_up) ;
    while (enumerator_4349.hasCurrentObject ()) {
      result << "if (fileExtension == " ;
      result << enumerator_4349.current_mSourceFileExtension (HERE).mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (109)).stringValue () ;
      result << ") {\n" ;
      const enumGalgasBool test_0 = in_HAS_5F_INDEXING.boolEnum () ;
      if (kBoolTrue == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_4349.current_mIndexingGrammar (HERE).reader_string (SOURCE_FILE_AT_LINE (111)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_1) {
          result << "          if (! executionModeIsIndexing ()) {\n"
            "            routine_" ;
          result << GALGAS_string ("programRule_").operator_concat (index_4349_IDX.reader_string (SOURCE_FILE_AT_LINE (113)) COMMA_SOURCE_FILE_AT_LINE (113)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (113)).stringValue () ;
          result << " (sourceFilePath, commonLexique COMMA_HERE) ;\n"
            "          }\n" ;
        }else if (kBoolFalse == test_1) {
          result << "          if (executionModeIsIndexing ()) {\n"
            "            cGrammar_" ;
          result << enumerator_4349.current_mIndexingGrammar (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (117)).stringValue () ;
          result << "::performIndexing (commonLexique, sourceFilesArray (i COMMA_HERE)) ;\n"
            "          }else{\n"
            "            routine_" ;
          result << GALGAS_string ("programRule_").operator_concat (index_4349_IDX.reader_string (SOURCE_FILE_AT_LINE (119)) COMMA_SOURCE_FILE_AT_LINE (119)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (119)).stringValue () ;
          result << " (sourceFilePath, commonLexique COMMA_HERE) ;\n"
            "          }\n" ;
        }
      }else if (kBoolFalse == test_0) {
        result << "          routine_" ;
        result << GALGAS_string ("programRule_").operator_concat (index_4349_IDX.reader_string (SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (123)).stringValue () ;
        result << " (sourceFilePath, commonLexique COMMA_HERE) ;\n" ;
      }
      if (enumerator_4349.hasNextObject ()) {
        result << "        }else " ;
      }
      index_4349_IDX.increment () ;
...
void routine_compileProgramRules (const GALGAS_analysisContext constinArgument_inAnalysisContext,
  ...
  while (enumerator_5044.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_grammarLabelMap joker_5232_0 ; // Joker input parameter
      constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mGrammarMap.method_searchKey (enumerator_5044.current_mIndexingGrammar (HERE), joker_5232_0, var_hasIndexing, inCompiler COMMA_SOURCE_FILE_AT_LINE (107)) ;
      ...
      if (kBoolTrue == test_1) {
        ...
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (enumerator_5044.current_mIndexingGrammar (HERE).reader_string (SOURCE_FILE_AT_LINE (109)) COMMA_SOURCE_FILE_AT_LINE (109)).operator_concat (GALGAS_string ("' grammar does not enable indexing") COMMA_SOURCE_FILE_AT_LINE (109)) COMMA_SOURCE_FILE_AT_LINE (109)) ;
      }
    }
    ...
    var_argumentList.addAssign_operation (GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (114)), GALGAS_lstring::constructor_new (GALGAS_string ("lstring"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (115)), enumerator_5044.current_mSourceFileVariableName (HERE), enumerator_5044.current_mSourceFileVariableNameIsUnused (HERE) COMMA_SOURCE_FILE_AT_LINE (113)) ;
    GALGAS_semanticInstructionListForGeneration var_semanticInstructionListForGeneration ;
    GALGAS_formalParameterListForGeneration var_routineSignature ;
    {
    routine_analyzeRoutineBody (constinArgument_inAnalysisContext, var_argumentList, GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE_AT_LINE (124)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (125)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (126)), GALGAS_string::makeEmptyString (), enumerator_5044.current_mInstructionList (HERE), enumerator_5044.current_mEndOfInstructionList (HERE), var_semanticInstructionListForGeneration, var_routineSignature, inCompiler COMMA_SOURCE_FILE_AT_LINE (121)) ;
    }
...
void routine_compileAfterClause (const GALGAS_analysisContext constinArgument_inAnalysisContext,
                                 ...
                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_semanticInstructionListForGeneration var_semanticInstructionListForGeneration ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inProgramComponentAST.reader_mEpilogueList (SOURCE_FILE_AT_LINE (158)).reader_length (SOURCE_FILE_AT_LINE (158)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location var_locationOfSecondItem = constinArgument_inProgramComponentAST.reader_mEpilogueList (SOURCE_FILE_AT_LINE (159)).reader_mEndOfInstructionListAtIndex (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (159)) ;
    ...
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, constinArgument_inProgramComponentAST.reader_mEpilogueList (SOURCE_FILE_AT_LINE (161)).reader_length (SOURCE_FILE_AT_LINE (161)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_1) {
      ...
      {
      GALGAS_formalParameterListForGeneration joker_8230_0 ; // Joker input parameter
      routine_analyzeRoutineBody (constinArgument_inAnalysisContext, GALGAS_formalParameterListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (166)), GALGAS_localConstantList::constructor_emptyList (SOURCE_FILE_AT_LINE (167)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (168)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (169)), GALGAS_string::makeEmptyString (), constinArgument_inProgramComponentAST.reader_mEpilogueList (SOURCE_FILE_AT_LINE (171)).reader_mInstructionListAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (171)), constinArgument_inProgramComponentAST.reader_mEpilogueList (SOURCE_FILE_AT_LINE (172)).reader_mEndOfInstructionListAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (172)), var_semanticInstructionListForGeneration, joker_8230_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (164)) ;
      }
    }
  }
...
void routine_compileProgramComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticWarning (location_1, GALGAS_string ("GALGAS checks the component name ('").operator_concat (var_componentName.reader_string (SOURCE_FILE_AT_LINE (205)) COMMA_SOURCE_FILE_AT_LINE (205)).operator_concat (GALGAS_string ("') against the source file base name ('") COMMA_SOURCE_FILE_AT_LINE (205)).operator_concat (var_basename COMMA_SOURCE_FILE_AT_LINE (206)).operator_concat (GALGAS_string ("'): they should be identical") COMMA_SOURCE_FILE_AT_LINE (206)) COMMA_SOURCE_FILE_AT_LINE (204)) ;
  }
  ...
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (292)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    ...
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_12793 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    while (enumerator_12793.hasCurrentObject ()) {
      var_headerString.dotAssign_operation (callCategoryReader_appendDeclaration_31_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_12793.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (299)) COMMA_SOURCE_FILE_AT_LINE (299)) ;
      enumerator_12793.gotoNextObject () ;
    }
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_12922 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    while (enumerator_12922.hasCurrentObject ()) {
      var_headerString.dotAssign_operation (callCategoryReader_appendDeclaration_32_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_12922.current_mDeclaration (HERE).ptr (), constinArgument_inOutputDirectory, inCompiler COMMA_SOURCE_FILE_AT_LINE (302)) COMMA_SOURCE_FILE_AT_LINE (302)) ;
  ...
  const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (315)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_13617 (var_decoratedDeclarationListForGeneration, kEnumeration_up) ;
    while (enumerator_13617.hasCurrentObject ()) {
      var_implementationString.dotAssign_operation (callCategoryReader_appendTypeGenericImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_13617.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (323)) COMMA_SOURCE_FILE_AT_LINE (323)) ;
      var_implementationString.dotAssign_operation (callCategoryReader_appendSpecificImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_13617.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (324)) COMMA_SOURCE_FILE_AT_LINE (324)) ;
...
void routine_compileProgramComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_lstring joker_14661_0 ; // Joker input parameter
    ioArgument_ioParsedComponentStruct.mAttribute_mParsedProgramComponentMap.method_searchKey (var_basenameKey, joker_14661_0, var_programComponentAST, inCompiler COMMA_SOURCE_FILE_AT_LINE (350)) ;
  }else if (kBoolFalse == test_0) {
    {
