...
template_filewrapper_programFileGenerationTemplate_programFileImplementation (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << ".h\"\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_stringlist::cEnumerator enumerator_709 (var_cas_IMPORTED_COMPONENT_LIST, true) ;
    const GGS_stringlist::cElement * operand_709 = NULL ;
    while (((operand_709 = enumerator_709.nextObject ()))) {
      macroValidPointer (operand_709) ;
      result << "#include \"" ;
      result << operand_709->mValue ;
      result << ".h\"\n" ;
    }
    result << "\n"
      "//---------------------------------------------------------------------------*\n"
    ...
    GGS_programRuleList::cEnumerator enumerator_1957 (var_cas_PROGRAM_RULE_LIST, true) ;
    const GGS_programRuleList::cElement * operand_1957 = NULL ;
    while (((operand_1957 = enumerator_1957.nextObject ()))) {
      macroValidPointer (operand_1957) ;
      result << "      " ;
      result << operand_1957->mSourceFileExtension.ggs_string ().reader_utf8Representation () ;
      result << ",\n" ;
    }
    result << "      NULL\n"
      "    } ;    \n"
      "    const char * helpMessages [] = {\n" ;
    GGS_programRuleList::cEnumerator enumerator_2125 (var_cas_PROGRAM_RULE_LIST, true) ;
    const GGS_programRuleList::cElement * operand_2125 = NULL ;
    while (((operand_2125 = enumerator_2125.nextObject ()))) {
      macroValidPointer (operand_2125) ;
      result << "      " ;
      result << operand_2125->mSourceFileHelp.ggs_string ().reader_utf8Representation () ;
      result << ",\n" ;
    }
    result << "      NULL\n"
      "    } ;    \n"
      ...
      "          PMSInt16 r = 0 ;\n"
      "          " ;
    GGS_programRuleList::cEnumerator enumerator_4087 (var_cas_PROGRAM_RULE_LIST, true) ;
    const GGS_programRuleList::cElement * operand_4087 = NULL ;
    { GGS_uint var_cas_IDX (true, 0) ;
  while (((operand_4087 = enumerator_4087.nextObject ()))) {
    macroValidPointer (operand_4087) ;
    result << "if (fileExtension == " ;
    result << operand_4087->mSourceFileExtension.ggs_string ().reader_utf8Representation () ;
    result << ") {\n"
      "            routine_" ;
    ...
    if (enumerator_4087.hasNextObject ()) {
      result << "          }else " ;
    }
