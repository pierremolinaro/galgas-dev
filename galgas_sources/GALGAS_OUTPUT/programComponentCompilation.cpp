...
GALGAS_string filewrapperTemplate_programFileGenerationTemplate_programFileImplementation (C_Compiler * /* inCompiler */,
  ...
  if (in_PROGRAM_5F_RULE_5F_LIST.isValid ()) {
    ...
    while (enumerator_4458.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_4458.current_mIndexingGrammar (HERE).reader_string (SOURCE_FILE_AT_LINE (112)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_2) {
...
void routine_compileProgramComponentFromAST (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  { //-------- @routineCallInstructionForGeneration
  routine_recursivelyImportSemanticComponent (ioArgument_ioParsedComponentStruct, var_optionComponentFileNameList, var_grammarComponentASTList, var_semanticDeclarationList, var_parsedFileSet, var_headerIncludeList, var_implementationIncludeList, constinArgument_inProgramComponentAST.reader_mImportedComponentFileNameList (SOURCE_FILE_AT_LINE (203)), constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (204)), inCompiler COMMA_SOURCE_FILE_AT_LINE (195)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_semanticDeclarationListAST var_semanticDeclarationListWithPredefinedTypes = var_semanticDeclarationList ;
  { //-------- @routineCallInstructionForGeneration
  routine_appendPredefinedTypesASTs (var_semanticDeclarationListWithPredefinedTypes, inCompiler COMMA_SOURCE_FILE_AT_LINE (208)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticContext var_semanticContext ;
  { //-------- @routineCallInstructionForGeneration
  routine_buildSemanticContext (constinArgument_inSourceFile.reader_string (SOURCE_FILE_AT_LINE (212)), var_semanticDeclarationListWithPredefinedTypes, constinArgument_inProgramComponentAST.reader_mEndOfSourceFile (SOURCE_FILE_AT_LINE (214)), var_semanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (211)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_buildGrammarComponentMapForSemanticAnalysis (var_grammarComponentASTList, var_semanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (218)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_buildOptionComponentMapForSemanticAnalysis (var_optionComponentFileNameList, ioArgument_ioParsedComponentStruct, var_semanticContext.mAttribute_mOptionComponentMapForSemanticAnalysis, inCompiler COMMA_SOURCE_FILE_AT_LINE (223)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_semanticDeclarationSortedListForGeneration var_decoratedDeclarationListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_performSemanticAnalysis (constinArgument_inProgramComponentAST.reader_mSemanticDeclarationList (SOURCE_FILE_AT_LINE (231)), var_semanticContext, constinArgument_inProgramComponentAST.reader_mEndOfSourceFile (SOURCE_FILE_AT_LINE (233)), var_decoratedDeclarationListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (230)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_analysisContext var_analysisContext = GALGAS_analysisContext::constructor_new (var_semanticContext, function_buildPredefinedTypes (var_semanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (239)), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (240)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (237)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_compileBeforeClause (var_analysisContext, constinArgument_inProgramComponentAST, var_decoratedDeclarationListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (244)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_hasIndexing = GALGAS_bool (false) ;
  { //-------- @routineCallInstructionForGeneration
  routine_compileProgramRules (var_analysisContext, constinArgument_inProgramComponentAST, var_decoratedDeclarationListForGeneration, var_hasIndexing, inCompiler COMMA_SOURCE_FILE_AT_LINE (251)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_compileAfterClause (var_analysisContext, constinArgument_inProgramComponentAST, var_decoratedDeclarationListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (258)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (264)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_headerString = GALGAS_string (filewrapperTemplate_programFileGenerationTemplate_programFileHeader (inCompiler, var_componentName.reader_string (SOURCE_FILE_AT_LINE (266)), var_headerIncludeList, var_semanticContext.mAttribute_mTypeMap.reader_allKeyList (SOURCE_FILE_AT_LINE (268)) COMMA_SOURCE_FILE_AT_LINE (265))) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_11093 (var_decoratedDeclarationListForGeneration, true) ;
    //--- simple foreach instruction
    while (enumerator_11093.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      var_headerString.dotAssign_operation (callCategoryReader_appendDeclaration_31_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_11093.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (271)) COMMA_SOURCE_FILE_AT_LINE (271)) ;
      enumerator_11093.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_11222 (var_decoratedDeclarationListForGeneration, true) ;
    //--- simple foreach instruction
    while (enumerator_11222.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      var_headerString.dotAssign_operation (callCategoryReader_appendDeclaration_32_ ((const cPtr_semanticDeclarationForGeneration *) enumerator_11222.current_mDeclaration (HERE).ptr (), constinArgument_inOutputDirectory, inCompiler COMMA_SOURCE_FILE_AT_LINE (274)) COMMA_SOURCE_FILE_AT_LINE (274)) ;
      enumerator_11222.gotoNextObject () ;
    }
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_componentName.reader_string (SOURCE_FILE_AT_LINE (278)).operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (278)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_headerString, GALGAS_string ("\n"
      "\n"), GALGAS_string ("#endif\n"), inCompiler COMMA_SOURCE_FILE_AT_LINE (276)) ;
    } //-------- @routineCallInstructionForGeneration
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (287)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_3) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_implementationString = GALGAS_string (filewrapperTemplate_programFileGenerationTemplate_programFileImplementation (inCompiler, var_componentName.reader_string (SOURCE_FILE_AT_LINE (289)), var_implementationIncludeList, constinArgument_inProgramComponentAST.reader_mProgramRules (SOURCE_FILE_AT_LINE (291)), constinArgument_inProgramComponentAST.reader_mVersionString (SOURCE_FILE_AT_LINE (292)).reader_string (SOURCE_FILE_AT_LINE (292)), var_hasIndexing COMMA_SOURCE_FILE_AT_LINE (288))) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_semanticDeclarationSortedListForGeneration enumerator_11961 (var_decoratedDeclarationListForGeneration, true) ;
    //--- simple foreach instruction
    while (enumerator_11961.hasCurrentObject ()) {
      //-------- @appendInstructionForGeneration
      var_implementationString.dotAssign_operation (callCategoryReader_appendTypeGenericImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_11961.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (296)) COMMA_SOURCE_FILE_AT_LINE (296)) ;
      //-------- @appendInstructionForGeneration
      var_implementationString.dotAssign_operation (callCategoryReader_appendSpecificImplementation ((const cPtr_semanticDeclarationForGeneration *) enumerator_11961.current_mDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (297)) COMMA_SOURCE_FILE_AT_LINE (297)) ;
      enumerator_11961.gotoNextObject () ;
    }
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_componentName.reader_string (SOURCE_FILE_AT_LINE (301)).operator_concat (GALGAS_string (".cpp") COMMA_SOURCE_FILE_AT_LINE (301)), GALGAS_string ("//"), GALGAS_string ("\n"
...
void routine_compileProgramComponentFromSourceFile (const GALGAS_lstring constinArgument_inSourceFile,
                                                    ...
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_basename = constinArgument_inSourceFile.mAttribute_string.reader_lastPathComponent (SOURCE_FILE_AT_LINE (319)).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (319)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_basenameKey = GALGAS_lstring::constructor_new (var_basename, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (320)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_programComponentAST var_programComponentAST ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = ioArgument_ioParsedComponentStruct.mAttribute_mParsedProgramComponentMap.reader_hasKey (var_basename COMMA_SOURCE_FILE_AT_LINE (322)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    GALGAS_lstring joker_12992_0 ; // Joker input parameter
    ioArgument_ioParsedComponentStruct.mAttribute_mParsedProgramComponentMap.method_searchKey (var_basenameKey, joker_12992_0, var_programComponentAST, inCompiler COMMA_SOURCE_FILE_AT_LINE (323)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    { //-------- @grammarInstructionWithSourceFileForGeneration
    cGrammar_programSLRgrammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, var_programComponentAST COMMA_SOURCE_FILE_AT_LINE (325)) ;
    } //-------- END @grammarInstructionWithSourceFileForGeneration
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioParsedComponentStruct.mAttribute_mParsedProgramComponentMap.modifier_insertKey (var_basenameKey, constinArgument_inSourceFile, var_programComponentAST, inCompiler COMMA_SOURCE_FILE_AT_LINE (326)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  { //-------- @routineCallInstructionForGeneration
  routine_compileProgramComponentFromAST (constinArgument_inSourceFile, constinArgument_inOutputDirectory, var_programComponentAST, ioArgument_ioParsedComponentStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (329)) ;
  } //-------- @routineCallInstructionForGeneration
}
