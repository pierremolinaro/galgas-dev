...
//                    september 27th, 2010, at 10h12'35"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
const GGS_bool cond_11548 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (256))).operator_isEqual (GGS_uint (0U)) ;
if (cond_11548.isBuiltAndTrue ()) {
GGS_string var_cas_headerString = template_filewrapper_programFileGenerationTemplate_programFileHeader (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (258)), var_cas_headerIncludeList, var_cas_semanticContext.mTypeMap.reader_allKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (260))) ;
{
  ...
  while (((operand_11250 = enumerator_11250.nextObject ()))) {
    ...
    var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_11250->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11250->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (263)))) ;
  }
}
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (267))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
  "\n"), var_cas_headerString, GGS_string ("\n"
  "\n"), GGS_string ("#endif\n") COMMA_SOURCE_FILE_AT_LINE (265)) ;
}
const GGS_bool cond_12346 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (276))).operator_isEqual (GGS_uint (0U)) ;
if (cond_12346.isBuiltAndTrue ()) {
GGS_string var_cas_implementationString = template_filewrapper_programFileGenerationTemplate_programFileImplementation (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (278)), var_cas_implementationIncludeList, var_cas_programComponentAST.reader_mProgramRules (inLexique COMMA_SOURCE_FILE_AT_LINE (280)), var_cas_programComponentAST.reader_mVersionString (inLexique COMMA_SOURCE_FILE_AT_LINE (281)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (281))) ;
{
  GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11946 (var_cas_decoratedDeclarationListForGeneration, true) ;
  const GGS_semanticDeclarationListForGeneration::cElement * operand_11946 = NULL ;
  while (((operand_11946 = enumerator_11946.nextObject ()))) {
    macroValidPointer (operand_11946) ;
    var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_11946->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11946->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (284)))) ;
    var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_11946->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11946->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (285)))) ;
  }
}
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (289))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
