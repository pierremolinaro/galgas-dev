...
template_filewrapper_programFileGenerationTemplate_programFileImplementation (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << ",\n"
      ...
      "        PMSInt16 r = 0 ;\n"
      "        " ;
    GGS_programRuleList::cEnumerator enumerator_3951 (var_cas_PROGRAM_RULE_LIST, true) ;
    const GGS_programRuleList::cElement * operand_3951 = NULL ;
    { GGS_uint var_cas_IDX (true, 0) ;
  while (((operand_3951 = enumerator_3951.nextObject ()))) {
    macroValidPointer (operand_3951) ;
    result << "if (fileExtension == " ;
    result << operand_3951->mSourceFileExtension.ggs_string ().reader_utf8Representation () ;
    result << ") {\n"
      "          routine_" ;
