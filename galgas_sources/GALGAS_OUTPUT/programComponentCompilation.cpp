...
template_filewrapper_programFileGenerationTemplate_programFileImplementation (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    result << ".h\"\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_stringlist::cEnumerator enumerator_798 (var_cas_IMPORTED_COMPONENT_LIST, true) ;
    const GGS_stringlist::cElement * operand_798 = NULL ;
    while (((operand_798 = enumerator_798.nextObject ()))) {
      macroValidPointer (operand_798) ;
      result << "#include \"" ;
      result << operand_798->mValue ;
      result << ".h\"\n" ;
    }
    result << "\n"
      "//---------------------------------------------------------------------------*\n"
    ...
    result << ".gProgram\", line\n"
      ...
      "  C_BDD::setANDcacheSize (17) ;\n"
      "  C_BDD::forAllOnBitsGreaterCacheSize (18) ;\n"
      "  {\n"
      "  //--- Input/output parameters\n"
      "    const char * extensions [] = {\n" ;
    GGS_programRuleList::cEnumerator enumerator_1969 (var_cas_PROGRAM_RULE_LIST, true) ;
    const GGS_programRuleList::cElement * operand_1969 = NULL ;
    while (((operand_1969 = enumerator_1969.nextObject ()))) {
      macroValidPointer (operand_1969) ;
      result << "      " ;
      result << operand_1969->mSourceFileExtension.ggs_string ().reader_utf8Representation () ;
      result << ",\n" ;
    }
    result << "      NULL\n"
      "    } ;    \n"
      "    const char * helpMessages [] = {\n" ;
    GGS_programRuleList::cEnumerator enumerator_2137 (var_cas_PROGRAM_RULE_LIST, true) ;
    const GGS_programRuleList::cElement * operand_2137 = NULL ;
    while (((operand_2137 = enumerator_2137.nextObject ()))) {
      macroValidPointer (operand_2137) ;
      result << "      " ;
      result << operand_2137->mSourceFileHelp.ggs_string ().reader_utf8Representation () ;
      result << ",\n" ;
    }
    result << "      NULL\n"
      "    } ;    \n"
      ...
      "        PMSInt16 r = 0 ;\n"
      "        " ;
    GGS_programRuleList::cEnumerator enumerator_4155 (var_cas_PROGRAM_RULE_LIST, true) ;
    const GGS_programRuleList::cElement * operand_4155 = NULL ;
    { GGS_uint var_cas_IDX (true, 0) ;
  while (((operand_4155 = enumerator_4155.nextObject ()))) {
    macroValidPointer (operand_4155) ;
    result << "if (fileExtension == " ;
    result << operand_4155->mSourceFileExtension.ggs_string ().reader_utf8Representation () ;
    result << ") {\n"
      "          routine_" ;
    result << (GGS_string ("programRule_")).operator_concat (var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (104))).reader_identifierRepresentation () ;
    result << " (sourceFilePath, commonLexique COMMA_HERE) ;\n" ;
    if (enumerator_4155.hasNextObject ()) {
      result << "        }else " ;
    }
...
const GGS_bool cond_11719 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (255))).operator_isEqual (GGS_uint (0U)) ;
if (cond_11719.isBuiltAndTrue ()) {
GGS_string var_cas_headerString = template_filewrapper_programFileGenerationTemplate_programFileHeader (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (257)), var_cas_headerIncludeList, var_cas_semanticContext.mTypeMap.reader_allKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (259))) ;
{
  ...
  while (((operand_11277 = enumerator_11277.nextObject ()))) {
    ...
    var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassDeclaration (operand_11277->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11277->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (262)))) ;
  }
}
{
  GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11421 (var_cas_decoratedDeclarationListForGeneration, true) ;
  const GGS_semanticDeclarationListForGeneration::cElement * operand_11421 = NULL ;
  while (((operand_11421 = enumerator_11421.nextObject ()))) {
    macroValidPointer (operand_11421) ;
    var_cas_headerString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_11421->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11421->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (265)))) ;
  }
}
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (269))).operator_concat (GGS_string (".h")), GGS_string ("//"), GGS_string ("\n"
  "\n"), var_cas_headerString, GGS_string ("\n"
  "\n"), GGS_string ("#endif\n") COMMA_SOURCE_FILE_AT_LINE (267)) ;
}
const GGS_bool cond_12548 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (278))).operator_isEqual (GGS_uint (0U)) ;
if (cond_12548.isBuiltAndTrue ()) {
GGS_string var_cas_implementationString = template_filewrapper_programFileGenerationTemplate_programFileImplementation (inLexique, var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (280)), var_cas_implementationIncludeList, var_cas_programComponentAST.reader_mProgramRules (inLexique COMMA_SOURCE_FILE_AT_LINE (282))) ;
{
  GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_12064 (var_cas_decoratedDeclarationListForGeneration, true) ;
  const GGS_semanticDeclarationListForGeneration::cElement * operand_12064 = NULL ;
  while (((operand_12064 = enumerator_12064.nextObject ()))) {
    macroValidPointer (operand_12064) ;
    var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassImplementation (operand_12064->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12064->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (285)))) ;
    var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_12064->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12064->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (286)))) ;
    var_cas_implementationString.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_12064->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12064->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (287)))) ;
  }
}
GGS_string::class_method_generateFile (inLexique, var_cas_inOutputDirectory, (var_cas_componentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (291))).operator_concat (GGS_string (".cpp")), GGS_string ("//"), GGS_string ("\n"
