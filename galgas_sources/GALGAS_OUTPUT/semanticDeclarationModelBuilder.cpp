...
pr_semantic_declaration_semanticDeclarationModelBuilder_779_27_ (galgas_scanner & inLexique,
          ...
          case 1 : {
            { bool syntaxRepeat_27 = true ;
              while (syntaxRepeat_27) {
                ...
                switch (select_semanticDeclarationModelBuilder_27 (inLexique)) {
                  case 2 : {
                    inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C_) COMMA_HERE) ;
                    } break ;
                  default :
  ...
  { bool syntaxRepeat_29 = true ;
    while (syntaxRepeat_29) {
      switch (select_semanticDeclarationModelBuilder_29 (inLexique)) {
        case 2 : {
...
pr_semantic_declaration_semanticDeclarationModelBuilder_843_27_ (galgas_scanner & inLexique,
    ...
    case 2 : {
      { bool syntaxRepeat_31 = true ;
        while (syntaxRepeat_31) {
          ...
          switch (select_semanticDeclarationModelBuilder_31 (inLexique)) {
            case 2 : {
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C_) COMMA_HERE) ;
              } break ;
            default :
  ...
  { bool syntaxRepeat_32 = true ;
    while (syntaxRepeat_32) {
      switch (select_semanticDeclarationModelBuilder_32 (inLexique)) {
        case 2 : {
