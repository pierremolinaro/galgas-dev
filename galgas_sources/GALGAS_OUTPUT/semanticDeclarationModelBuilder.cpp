  ...
  { bool syntaxRepeat_12 = true ;
    while (syntaxRepeat_12) {
      switch (select_repeat_semanticDeclarationModelBuilder_12 (inLexique)) {
        ...
        case 8 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_message) COMMA_HERE) ;
          const GGS_bool cond_14749 = (var_cas_mClassMessage.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (456))).operator_strictSup (GGS_uint (0U)) ;
          if (cond_14749.isBuiltAndTrue ()) {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
          const GGS_bool cond_14942 = (var_cas_classMessage.ggs_string ().reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (461))).operator_isEqual (GGS_uint (0U)) ;
          if (cond_14942.isBuiltAndTrue ()) {
...
pr_enum_modifier_semanticDeclarationModelBuilder_661_20_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_21336 = (var_cas_typeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (666))).operator_isNotEqual (GGS_string ("location")) ;
  if (cond_21336.isBuiltAndTrue ()) {
...
pr_enum_method_semanticDeclarationModelBuilder_696_18_ (galgas_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_typeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_22430 = (var_cas_typeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (701))).operator_isNotEqual (GGS_string ("location")) ;
  if (cond_22430.isBuiltAndTrue ()) {
...
pr_enum_operator_semanticDeclarationModelBuilder_729_20_ (galgas_scanner & inLexique,
  ...
  inLexique.assignFromAttribute_tokenString (var_cas_typeName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5F_name) COMMA_HERE) ;
  const GGS_bool cond_23396 = (var_cas_typeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (734))).operator_isNotEqual (GGS_string ("location")) ;
  if (cond_23396.isBuiltAndTrue ()) {
