...
//                    november 14th, 2009, at 16h23'58"                      *
//                                                                           *
//---------------------------------------------------------------------------*
  ...
  { bool syntaxRepeat_14 = true ;
    while (syntaxRepeat_14) {
      switch (select_semanticDeclarationModelBuilder_14 (inLexique)) {
        ...
        case 8 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_message) COMMA_HERE) ;
          const GGS_bool cond_14985 = (var_cas_mClassMessage.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
          const GGS_bool cond_15178 = (var_cas_classMessage.ggs_string ().reader_length ()).operator_isEqual (GGS_uint (0U)) ;
