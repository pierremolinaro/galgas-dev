...
GALGAS_commandLineOptionMap_3A_element cEnumerator_commandLineOptionMap::current (LOCATION_ARGS) const {
  const cMapElement_commandLineOptionMap * p = (const cMapElement_commandLineOptionMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_commandLineOptionMap) ;
  return GALGAS_commandLineOptionMap_3A_element (p->mAttribute_lkey, p->mAttribute_mOptionChar, p->mAttribute_mOptionString, p->mAttribute_mComment, p->mAttribute_mDefaultValue) ;
}
...
GALGAS_commandLineOptionMap_3A_element::GALGAS_commandLineOptionMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_commandLineOptionMap_3A_element::GALGAS_commandLineOptionMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_commandLineOptionMap_3A_element & GALGAS_commandLineOptionMap_3A_element::operator = (const GALGAS_commandLineOptionMap_3A_element & inOperand) {
  ...
  mAttribute_mDefaultValue = inOperand.mAttribute_mDefaultValue ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_commandLineOptionMap_3A_element GALGAS_commandLineOptionMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                const GALGAS_char & inOperand1,
                                                                                                const GALGAS_string & inOperand2,
                                                                                                const GALGAS_string & inOperand3,
                                                                                                const GALGAS_string & inOperand4 
                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_commandLineOptionMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_commandLineOptionMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_commandLineOptionMap_3A_element::objectCompare (const GALGAS_commandLineOptionMap_3A_element & inOperand) const {
...
bool GALGAS_commandLineOptionMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mOptionChar.isValid () && mAttribute_mOptionString.isValid () && mAttribute_mComment.isValid () && mAttribute_mDefaultValue.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_commandLineOptionMap_3A_element::drop (void) {
...
void GALGAS_commandLineOptionMap_3A_element::description (C_String & ioString,
...
GALGAS_lstring GALGAS_commandLineOptionMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_char GALGAS_commandLineOptionMap_3A_element::reader_mOptionChar (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOptionChar ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_commandLineOptionMap_3A_element::reader_mOptionString (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOptionString ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_commandLineOptionMap_3A_element::reader_mComment (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mComment ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_commandLineOptionMap_3A_element::reader_mDefaultValue (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_commandLineOptionMap_3A_element ("commandLineOptionMap:element",
                                                        NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_commandLineOptionMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_commandLineOptionMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_commandLineOptionMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_commandLineOptionMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_commandLineOptionMap_3A_element GALGAS_commandLineOptionMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                              C_Compiler * inCompiler,
                                                                                              const GALGAS_location & inErrorLocation
                                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_commandLineOptionMap_3A_element result ;
  const GALGAS_commandLineOptionMap_3A_element * p = (const GALGAS_commandLineOptionMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_commandLineOptionMap_3A_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "commandLineOptionMap:element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
