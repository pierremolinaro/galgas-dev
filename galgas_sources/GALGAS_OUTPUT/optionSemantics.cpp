...
void GGS_commandLineOptionMap::modifier_insertFakeKey (C_CompilerEx & inCompiler,
...
/* const */ GGS_char & GGS_commandLineOptionMap::cEnumerator::_mOptionChar (LOCATION_ARGS) const {
  return ((cElement *) mObjectArray (mCurrentIndex COMMA_THERE))->mInfo.mOptionChar ;
}

//---------------------------------------------------------------------------*

/* const */ GGS_string & GGS_commandLineOptionMap::cEnumerator::_mOptionString (LOCATION_ARGS) const {
  return ((cElement *) mObjectArray (mCurrentIndex COMMA_THERE))->mInfo.mOptionString ;
}

//---------------------------------------------------------------------------*

/* const */ GGS_string & GGS_commandLineOptionMap::cEnumerator::_mComment (LOCATION_ARGS) const {
...
GGS_commandLineOptionMap GGS_commandLineOptionMap::constructor_mapWithKeyAndValue (C_CompilerEx & inLexique,
                                             ...
                                             COMMA_LOCATION_ARGS) {
  GGS_commandLineOptionMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
