...
void GGS_commandLineOptionMap::
modifier_setMOptionCharForKey (C_Compiler & inLexique,                        const GGS_lchar & inValue,
...
void GGS_commandLineOptionMap::
modifier_setMOptionStringForKey (C_Compiler & inLexique,                        const GGS_lstring & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
...
void GGS_commandLineOptionMap::
modifier_setMCommentForKey (C_Compiler & inLexique,                        const GGS_lstring & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) {
  if (_isBuilt () && inValue._isBuilt () && inKey._isBuilt ()) {
    insulateMap () ;
