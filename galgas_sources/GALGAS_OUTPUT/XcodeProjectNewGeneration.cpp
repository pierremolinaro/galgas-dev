...
GALGAS_string filewrapperTemplate_xcodeProjectGenerationFilewrapper_xcodeproj (C_Compiler * /* inCompiler */,
  ...
  if (in_HEADER_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator__32_stringlist enumerator_1167 (in_HEADER_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1167.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_1167.current_mValue_30_ (HERE).stringValue () ;
      result << " /* " ;
      result << enumerator_1167.current_mValue_31_ (HERE).stringValue () ;
      result << " */ = {\n"
        "    isa = PBXFileReference;\n"
        "    fileEncoding = 4;\n"
        "    lastKnownFileType = sourcecode.c.h;\n"
        "    name = " ;
      result << enumerator_1167.current_mValue_31_ (HERE).reader_lastPathComponent (SOURCE_FILE ("project.pbxproj.gTemplate", 45)).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 45)).stringValue () ;
      result << ";\n"
        "    path = " ;
      result << enumerator_1167.current_mValue_31_ (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 46)).stringValue () ;
      result << ";\n"
        "    sourceTree = \"<group>\";\n"
        "  };\n"
        "\n" ;
  ...
  if (in_FRAMEWORK_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator__32_stringlist enumerator_1503 (in_FRAMEWORK_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1503.hasCurrentObject ()) {
      ...
      result << " */ = {\n"
        ...
        "    name = " ;
      result << enumerator_1503.current_mValue_31_ (HERE).reader_lastPathComponent (SOURCE_FILE ("project.pbxproj.gTemplate", 54)).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 54)).stringValue () ;
      result << ";\n"
        "    path = " ;
      result << enumerator_1503.current_mValue_31_ (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 55)).stringValue () ;
      result << ";\n"
        "    sourceTree = \"<group>\";\n"
        "  };\n"
        "\n" ;
  ...
  if (in_TOOL_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeToolTargetList enumerator_1813 (in_TOOL_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_1813.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_1813.current_mProductFileReference (HERE).stringValue () ;
      result << " = {\n"
        "    isa = PBXFileReference;\n"
        "    explicitFileType = \"compiled.mach-o.executable\";\n"
        "    includeInIndex = 0;\n"
        "    path = " ;
      result << enumerator_1813.current_mProductFileName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 64)).stringValue () ;
      result << ";\n"
  ...
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_2107 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_2107.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_2107.current_mProductFileReference (HERE).stringValue () ;
      result << " = {\n"
        "    isa = PBXFileReference;\n"
        "    explicitFileType = \"compiled.mach-o.executable\";\n"
        "    includeInIndex = 0;\n"
        "    path = " ;
      result << enumerator_2107.current_mProductFileName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 73)).stringValue () ;
      result << ";\n"
        "    sourceTree = BUILT_PRODUCTS_DIR;\n"
        "  };\n"
        "\n" ;
  ...
  if (in_PLIST_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator__32_stringlist enumerator_2401 (in_PLIST_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_2401.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_2401.current_mValue_30_ (HERE).stringValue () ;
      result << " = {\n"
        "    isa = PBXFileReference;\n"
        "    fileEncoding = 4;\n"
        "    lastKnownFileType = text.plist;\n"
        "    name = " ;
      result << enumerator_2401.current_mValue_31_ (HERE).reader_lastPathComponent (SOURCE_FILE ("project.pbxproj.gTemplate", 82)).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 82)).stringValue () ;
      result << ";\n"
        "    path = " ;
      result << enumerator_2401.current_mValue_31_ (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 83)).stringValue () ;
      result << ";\n"
        "    sourceTree = \"<group>\";\n"
        "  };\n"
        "\n" ;
  ...
  GALGAS_uint index_2710_ (0) ;
  if (in_XIB_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator__32_stringlist enumerator_2710 (in_XIB_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_2710.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_2710.current_mValue_30_ (HERE).stringValue () ;
      result << " = {\n"
        "    isa = PBXFileReference;\n"
        "    fileEncoding = 4;\n"
        "    lastKnownFileType = wrapper.xib;\n"
        "    name = " ;
      result << enumerator_2710.current_mValue_31_ (HERE).reader_lastPathComponent (SOURCE_FILE ("project.pbxproj.gTemplate", 92)).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 92)).stringValue () ;
      result << ";\n"
        "    path = " ;
      result << enumerator_2710.current_mValue_31_ (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 93)).stringValue () ;
      result << ";\n"
        "    sourceTree = \"<group>\";\n"
        "  };\n"
        "\n" ;
      index_2710_.increment () ;
      enumerator_2710.gotoNextObject () ;
    }
  }
  GALGAS_uint index_3021_ (0) ;
  if (in_TIFF_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator__32_stringlist enumerator_3021 (in_TIFF_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_3021.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_3021.current_mValue_30_ (HERE).stringValue () ;
      result << " = {\n"
        "    isa = PBXFileReference;\n"
        "    lastKnownFileType = image.tiff;\n"
        "    name = " ;
      result << enumerator_3021.current_mValue_31_ (HERE).reader_lastPathComponent (SOURCE_FILE ("project.pbxproj.gTemplate", 101)).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 101)).stringValue () ;
      result << ";\n"
        "    path = " ;
      result << enumerator_3021.current_mValue_31_ (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 102)).stringValue () ;
      result << ";\n"
        "    sourceTree = \"<group>\";\n"
        "  };\n"
        "\n" ;
  ...
  if (in_ICNS_5F_FILE_5F_LIST.isValid ()) {
    cEnumerator__32_stringlist enumerator_3305 (in_ICNS_5F_FILE_5F_LIST, kEnumeration_up) ;
    while (enumerator_3305.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_3305.current_mValue_30_ (HERE).stringValue () ;
      result << " = {\n"
        "    isa = PBXFileReference;\n"
        "    lastKnownFileType = image.icns;\n"
        "    name = " ;
      result << enumerator_3305.current_mValue_31_ (HERE).reader_lastPathComponent (SOURCE_FILE ("project.pbxproj.gTemplate", 110)).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 110)).stringValue () ;
      result << ";\n"
        "    path = " ;
      result << enumerator_3305.current_mValue_31_ (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 111)).stringValue () ;
      result << ";\n"
        "    sourceTree = \"<group>\";\n"
        "  };\n"
        "\n" ;
  ...
  result << "  /*------------------------------------------------------------------ PBXFrameworksBuildPhase */\n"
    "\n" ;
  GALGAS_uint index_3692_ (0) ;
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_3692 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_3692.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_3692.current_mFrameworkBuildPhaseRef (HERE).stringValue () ;
      result << " = {\n"
        "    isa = PBXFrameworksBuildPhase;\n"
        "    buildActionMask = 2147483647;\n"
        "    files = (\n" ;
      GALGAS_uint index_3860_ (0) ;
      if (enumerator_3692.current_mFrameworksFileRefList (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_3860 (enumerator_3692.current_mFrameworksFileRefList (HERE), kEnumeration_up) ;
        while (enumerator_3860.hasCurrentObject ()) {
          result << "      " ;
          result << enumerator_3860.current_mValue (HERE).stringValue () ;
          result << ",\n" ;
          index_3860_.increment () ;
  ...
  if (in_GROUPS.isValid ()) {
    cEnumerator_XCodeGroupList enumerator_4073 (in_GROUPS, kEnumeration_up) ;
    while (enumerator_4073.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_4073.current_mGroupReference (HERE).stringValue () ;
      result << " /* " ;
      result << enumerator_4073.current_mGroupName (HERE).stringValue () ;
      result << " */ = {\n"
        "    isa = PBXGroup;\n"
        "    children = (\n" ;
      GALGAS_uint index_4194_ (0) ;
      if (enumerator_4073.current_mChildrenRefs (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_4194 (enumerator_4073.current_mChildrenRefs (HERE), kEnumeration_up) ;
        while (enumerator_4194.hasCurrentObject ()) {
          result << "      " ;
          result << enumerator_4194.current_mValue (HERE).stringValue () ;
          result << ", \n" ;
      ...
      result << "    );\n"
        "    name = " ;
      result << enumerator_4073.current_mGroupName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 140)).stringValue () ;
      result << ";\n"
        "    path = " ;
      result << enumerator_4073.current_mGroupPath (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 141)).stringValue () ;
      result << ";\n"
        "    sourceTree = \"<group>\";\n"
        "  };\n" ;
  ...
  if (in_MAIN_5F_GROUP_5F_CHILDREN_5F_REFS.isValid ()) {
    cEnumerator_stringlist enumerator_4500 (in_MAIN_5F_GROUP_5F_CHILDREN_5F_REFS, kEnumeration_up) ;
    while (enumerator_4500.hasCurrentObject ()) {
      result << "      " ;
      result << enumerator_4500.current_mValue (HERE).stringValue () ;
      result << ",\n" ;
  ...
  if (in_TOOL_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeToolTargetList enumerator_4691 (in_TOOL_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_4691.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_4691.current_mTargetRef (HERE).stringValue () ;
      result << " /* " ;
      result << enumerator_4691.current_mTargetName (HERE).stringValue () ;
      result << " */ = {\n"
        "   isa = PBXNativeTarget;\n"
        "   buildConfigurationList = " ;
      result << enumerator_4691.current_mBuildConfigurationListRef (HERE).stringValue () ;
      result << " ;\n"
        "   buildPhases = (\n"
        "    " ;
      result << enumerator_4691.current_mBuildPhaseRef (HERE).stringValue () ;
      result << " ,\n"
        "   );\n"
        "   buildRules = (\n"
        "   );\n"
        ...
        "   );\n"
        "   name = " ;
      result << enumerator_4691.current_mTargetName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 170)).stringValue () ;
      result << ";\n"
        "   productInstallPath = \"$(HOME)/bin\";\n"
        "   productName = " ;
      result << enumerator_4691.current_mTargetName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 172)).stringValue () ;
      result << ";\n"
        "   productReference = " ;
      result << enumerator_4691.current_mProductFileReference (HERE).stringValue () ;
      result << " ;\n"
  ...
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_5197 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_5197.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_5197.current_mTargetRef (HERE).stringValue () ;
      result << " /* " ;
      result << enumerator_5197.current_mTargetName (HERE).stringValue () ;
      result << " */ = {\n"
        "    isa = PBXNativeTarget;\n"
        "    buildConfigurationList = " ;
      result << enumerator_5197.current_mBuildConfigurationListRef (HERE).stringValue () ;
      result << " ;\n"
        "    buildPhases = (\n"
        "      " ;
      result << enumerator_5197.current_mResourceBuildRef (HERE).stringValue () ;
      result << " , /* Resources */\n"
        "      " ;
      result << enumerator_5197.current_mFrameworkBuildPhaseRef (HERE).stringValue () ;
      result << " , /* Frameworks */\n"
        "      " ;
      result << enumerator_5197.current_mBuildPhaseRef (HERE).stringValue () ;
      result << " , /* Sources */\n"
        "    );\n"
        "    buildRules = (\n"
        "    );\n"
        "    dependencies = (\n" ;
      GALGAS_uint index_5571_ (0) ;
      if (enumerator_5197.current_mDependentTargets (HERE).isValid ()) {
        cEnumerator__32_stringlist enumerator_5571 (enumerator_5197.current_mDependentTargets (HERE), kEnumeration_up) ;
        while (enumerator_5571.hasCurrentObject ()) {
          result << "      " ;
          result << enumerator_5571.current_mValue_30_ (HERE).stringValue () ;
          result << " ,\n" ;
          index_5571_.increment () ;
          enumerator_5571.gotoNextObject () ;
        }
      }
      result << "    );\n"
        "    name = " ;
      result << enumerator_5197.current_mTargetName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 196)).stringValue () ;
      result << ";\n"
        "    productInstallPath = \"$(HOME)/bin\";\n"
        "    productName = " ;
      result << enumerator_5197.current_mTargetName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 198)).stringValue () ;
      result << ";\n"
        "    productReference = " ;
      result << enumerator_5197.current_mProductFileReference (HERE).stringValue () ;
      result << " ;\n"
  ...
  if (in_TOOL_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeToolTargetList enumerator_6332 (in_TOOL_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_6332.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6332.current_mTargetRef (HERE).stringValue () ;
      result << ", \n" ;
      index_6332_.increment () ;
      enumerator_6332.gotoNextObject () ;
    }
  }
  GALGAS_uint index_6389_ (0) ;
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_6389 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_6389.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6389.current_mTargetRef (HERE).stringValue () ;
      result << ", \n" ;
  ...
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_6559 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_6559.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_6559.current_mResourceBuildRef (HERE).stringValue () ;
      result << " /* Resources */ = {\n"
        "    isa = PBXResourcesBuildPhase;\n"
        "    buildActionMask = 2147483647;\n"
        "    files = (\n" ;
      GALGAS_uint index_6736_ (0) ;
      if (enumerator_6559.current_mResourceFileBuildRefs (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_6736 (enumerator_6559.current_mResourceFileBuildRefs (HERE), kEnumeration_up) ;
        while (enumerator_6736.hasCurrentObject ()) {
          result << "      " ;
          result << enumerator_6736.current_mValue (HERE).stringValue () ;
          result << ",\n" ;
          index_6736_.increment () ;
  ...
  if (in_TOOL_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeToolTargetList enumerator_6963 (in_TOOL_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_6963.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6963.current_mBuildPhaseRef (HERE).stringValue () ;
      result << " /* Sources */ = {\n"
        "      isa = PBXSourcesBuildPhase;\n"
        "      buildActionMask = 2147483647;\n"
        "      files = (\n" ;
      GALGAS_uint index_7124_ (0) ;
      if (enumerator_6963.current_mBuildPhaseRefList (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_7124 (enumerator_6963.current_mBuildPhaseRefList (HERE), kEnumeration_up) ;
        while (enumerator_7124.hasCurrentObject ()) {
          result << "        " ;
          result << enumerator_7124.current_mValue (HERE).stringValue () ;
          result << ",\n" ;
          index_7124_.increment () ;
  ...
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_7248 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_7248.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_7248.current_mBuildPhaseRef (HERE).stringValue () ;
      result << " /* Sources */ = {\n"
        "      isa = PBXSourcesBuildPhase;\n"
        "      buildActionMask = 2147483647;\n"
        "      files = (\n" ;
      GALGAS_uint index_7409_ (0) ;
      if (enumerator_7248.current_mBuildPhaseRefList (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_7409 (enumerator_7248.current_mBuildPhaseRefList (HERE), kEnumeration_up) ;
        while (enumerator_7409.hasCurrentObject ()) {
          result << "        " ;
          result << enumerator_7409.current_mValue (HERE).stringValue () ;
          result << ",\n" ;
          index_7409_.increment () ;
  ...
  result << "\n"
    ...
    "  /*------------------------------------------------------------------ PBXTargetDependency */\n"
    " \n" ;
  GALGAS_uint index_7634_ (0) ;
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_7634 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_7634.hasCurrentObject ()) {
      GALGAS_uint index_7667_ (0) ;
      if (enumerator_7634.current_mDependentTargets (HERE).isValid ()) {
        cEnumerator__32_stringlist enumerator_7667 (enumerator_7634.current_mDependentTargets (HERE), kEnumeration_up) ;
        while (enumerator_7667.hasCurrentObject ()) {
          result << "  " ;
          result << enumerator_7667.current_mValue_30_ (HERE).stringValue () ;
          result << " = {\n"
            "    isa = PBXTargetDependency;\n"
            "    target = " ;
          result << enumerator_7667.current_mValue_31_ (HERE).stringValue () ;
          result << ";\n"
            "  };\n"
            "\n" ;
  ...
  result << " /* Default */ = {\n"
    ...
    "      buildSettings = {\n" ;
  GALGAS_uint index_8138_ (0) ;
  if (in_DEFAULT_5F_CONFIGURATION_5F_SETTING_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_8138 (in_DEFAULT_5F_CONFIGURATION_5F_SETTING_5F_LIST, kEnumeration_up) ;
    while (enumerator_8138.hasCurrentObject ()) {
      result << "      " ;
      result << enumerator_8138.current_mValue (HERE).stringValue () ;
      result << " ;\n" ;
  ...
  if (in_TOOL_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeToolTargetList enumerator_8230 (in_TOOL_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_8230.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8230.current_mBuildConfigurationRef (HERE).stringValue () ;
      result << " /* Default */ = {\n"
        "      isa = XCBuildConfiguration;\n"
        "      buildSettings = {\n" ;
      GALGAS_uint index_8392_ (0) ;
      if (enumerator_8230.current_mBuildConfigurationSettingList (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_8392 (enumerator_8230.current_mBuildConfigurationSettingList (HERE), kEnumeration_up) ;
        while (enumerator_8392.hasCurrentObject ()) {
          result << "      " ;
          result << enumerator_8392.current_mValue (HERE).stringValue () ;
          result << " ;\n" ;
      ...
      result << "      PRODUCT_NAME = " ;
      result << enumerator_8230.current_mProductFileName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 305)).stringValue () ;
      result << " ;\n"
        "    };\n"
        "    name = Default;\n"
        "  };\n"
  ...
  GALGAS_uint index_8565_ (0) ;
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_8565 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_8565.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8565.current_mBuildConfigurationRef (HERE).stringValue () ;
      result << " /* Default */ = {\n"
        "      isa = XCBuildConfiguration;\n"
        "      buildSettings = {\n" ;
      GALGAS_uint index_8727_ (0) ;
      if (enumerator_8565.current_mBuildConfigurationSettingList (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_8727 (enumerator_8565.current_mBuildConfigurationSettingList (HERE), kEnumeration_up) ;
      ...
      result << "      INFOPLIST_FILE = \"Info.plist\";\n"
        "      PRODUCT_NAME = " ;
      result << enumerator_8565.current_mProductFileName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 318)).stringValue () ;
      result << " ;\n"
        "    };\n"
        "    name = Default;\n"
        "  };\n"
  ...
  result << " /* Default */,\n"
    ...
    "    };\n"
    "\n" ;
  GALGAS_uint index_9360_ (0) ;
  if (in_TOOL_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeToolTargetList enumerator_9360 (in_TOOL_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_9360.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_9360.current_mBuildConfigurationListRef (HERE).stringValue () ;
      result << " /* Default */ = {\n"
        "      isa = XCConfigurationList;\n"
        "      buildConfigurations = (\n"
        "        " ;
      result << enumerator_9360.current_mBuildConfigurationRef (HERE).stringValue () ;
      result << " /* Default */,\n"
        "      );\n"
        "      defaultConfigurationIsVisible = 0;\n"
        "      defaultConfigurationName = Default;\n"
        "    };\n"
        "\n" ;
      index_9360_.increment () ;
      enumerator_9360.gotoNextObject () ;
    }
  }
  GALGAS_uint index_9660_ (0) ;
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_9660 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_9660.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_9660.current_mBuildConfigurationListRef (HERE).stringValue () ;
      result << " /* Default */ = {\n"
        "      isa = XCConfigurationList;\n"
        "      buildConfigurations = (\n"
        "        " ;
      result << enumerator_9660.current_mBuildConfigurationRef (HERE).stringValue () ;
      result << " /* Default */,\n"
        "      );\n"
        "      defaultConfigurationIsVisible = 0;\n"
        "      defaultConfigurationName = Default;\n"
...
void categoryModifier_addCppFile (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  ioObject.mAttribute_mCppFileList.addAssign_operation (outArgument_outFileRef, constinArgument_inFileName  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 70)) ;
}
...
void categoryModifier_addHeaderFile (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  ioObject.mAttribute_mHeaderFileList.addAssign_operation (outArgument_outFileRef, constinArgument_inFileName  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 80)) ;
}
...
void categoryModifier_addBuildFile (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outBuildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 90)) ;
  }
  ioObject.mAttribute_mBuildFileList.addAssign_operation (constinArgument_inFileReference, constinArgument_inFileName, outArgument_outBuildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 91)) ;
}
...
void categoryModifier_addToolTarget (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outProductFileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 104)) ;
  }
  GALGAS_string var_buildPhaseRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_buildPhaseRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 105)) ;
  }
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outTargetRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 106)) ;
  }
  GALGAS_string var_buildConfigurationListRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_buildConfigurationListRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 107)) ;
  }
  GALGAS_string var_buildConfigurationRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_buildConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 108)) ;
  }
  ioObject.mAttribute_mToolTargetList.addAssign_operation (outArgument_outTargetRef, constinArgument_inTargetName, outArgument_outProductFileRef, constinArgument_inProductFileName, constinArgument_inSourceList, var_buildPhaseRef, var_buildConfigurationListRef, constinArgument_inBuildConfigurationSettingList, var_buildConfigurationRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 109)) ;
}
...
void categoryModifier_addAppTarget (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  outArgument_outProductFileRef.drop () ; // Release 'out' argument
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outProductFileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 135)) ;
  }
  GALGAS_string var_buildPhaseRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_buildPhaseRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 136)) ;
  }
  GALGAS_string var_targetRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_targetRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 137)) ;
  }
  GALGAS_string var_buildConfigurationListRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_buildConfigurationListRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 138)) ;
  }
  GALGAS_string var_buildConfigurationRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_buildConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 139)) ;
  }
  GALGAS_string var_frameworkBuildRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_frameworkBuildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 140)) ;
  }
  GALGAS_string var_resourceBuildRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_resourceBuildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 141)) ;
  }
  GALGAS__32_stringlist var_dependentTargets = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 142)) ;
  cEnumerator_stringlist enumerator_4731 (constinArgument_inDependentTargetRefList, kEnumeration_up) ;
  while (enumerator_4731.hasCurrentObject ()) {
    GALGAS_string var_dependencyBuildRef ;
    {
    categoryModifier_getReferenceKey (ioObject, var_dependencyBuildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 144)) ;
    }
    var_dependentTargets.addAssign_operation (var_dependencyBuildRef, enumerator_4731.current_mValue (HERE)  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 145)) ;
    enumerator_4731.gotoNextObject () ;
  }
  GALGAS_stringlist var_resourceFileBuildRefs = constinArgument_inResourceFileBuildRefs ;
  cEnumerator__32_stringlist enumerator_4956 (constinArgument_inProductCopyList, kEnumeration_up) ;
  while (enumerator_4956.hasCurrentObject ()) {
    GALGAS_string var_buildRef ;
    {
    categoryModifier_addBuildFile (ioObject, enumerator_4956.current_mValue_30_ (HERE), enumerator_4956.current_mValue_31_ (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 149)) ;
    }
    var_resourceFileBuildRefs.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 150)) ;
    enumerator_4956.gotoNextObject () ;
  }
  ioObject.mAttribute_mAppTargetList.addAssign_operation (var_targetRef, constinArgument_inTargetName, outArgument_outProductFileRef, constinArgument_inProductFileName, constinArgument_inSourceList, var_buildPhaseRef, var_buildConfigurationListRef, constinArgument_inBuildConfigurationSettingList, var_buildConfigurationRef, constinArgument_inFrameworksFileRefList, var_frameworkBuildRef, var_dependentTargets, var_resourceBuildRef, var_resourceFileBuildRefs  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 152)) ;
}
...
void categoryModifier_addGroup (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  if (kBoolTrue == test_0) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mDefaultConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 179)) ;
    }
  }
  ...
  if (kBoolTrue == test_1) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mProjectBuildConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 182)) ;
    }
  }
  ...
  if (kBoolTrue == test_2) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mMainGroupReference, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 185)) ;
    }
  }
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outGroupRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 187)) ;
  }
  ioObject.mAttribute_mGroupList.addAssign_operation (outArgument_outGroupRef, constinArgument_inGroupName, constinArgument_inGroupPath, constinArgument_inChildrenRefs  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 188)) ;
}
...
void categoryModifier_addGroupWithFiles (GALGAS_XcodeProjectDescriptor & ioObject,
                                         const GALGAS_string constinArgument_inGroupName,
                                         const GALGAS_string constinArgument_inGroupPath,
                                         const GALGAS_stringlist constinArgument_inSubgroupRefs,
  ...
  if (kBoolTrue == test_0) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mDefaultConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 205)) ;
    }
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, ioObject.mAttribute_mProjectBuildConfigurationRef.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mProjectBuildConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 208)) ;
    }
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, ioObject.mAttribute_mMainGroupReference.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_2) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mMainGroupReference, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 211)) ;
    }
  }
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outGroupRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 213)) ;
  }
  GALGAS_stringlist var_childrenRefs = constinArgument_inSubgroupRefs ;
  cEnumerator_stringset enumerator_7189 (constinArgument_inFileNames, kEnumeration_up) ;
  while (enumerator_7189.hasCurrentObject ()) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_7189.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 217)).objectCompare (GALGAS_string ("cpp"))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_cppFileRef ;
      {
      categoryModifier_addCppFile (ioObject, enumerator_7189.current_key (HERE), var_cppFileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 218)) ;
      }
      var_childrenRefs.addAssign_operation (var_cppFileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 219)) ;
      GALGAS_string var_buildRef ;
      {
      categoryModifier_addBuildFile (ioObject, var_cppFileRef, enumerator_7189.current_key (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 220)) ;
      }
      ioArgument_ioCppFileBuildRefs.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 221)) ;
    }else if (kBoolFalse == test_3) {
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_7189.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 222)).objectCompare (GALGAS_string ("h"))).boolEnum () ;
      if (kBoolTrue == test_4) {
        GALGAS_string var_headerFileRef ;
        {
        categoryModifier_addHeaderFile (ioObject, enumerator_7189.current_key (HERE), var_headerFileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 223)) ;
        }
        var_childrenRefs.addAssign_operation (var_headerFileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 224)) ;
      }else if (kBoolFalse == test_4) {
        const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_7189.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 225)).objectCompare (GALGAS_string ("m"))).boolEnum () ;
        if (kBoolTrue == test_5) {
          GALGAS_string var_m_5F_FileRef ;
          {
          categoryModifier_addMFile (ioObject, enumerator_7189.current_key (HERE), var_m_5F_FileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 226)) ;
          }
          GALGAS_string var_buildRef ;
          {
          categoryModifier_addBuildFile (ioObject, var_m_5F_FileRef, enumerator_7189.current_key (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 227)) ;
          }
          var_childrenRefs.addAssign_operation (var_m_5F_FileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 228)) ;
          ioArgument_ioMFileBuildRefs.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 229)) ;
        }else if (kBoolFalse == test_5) {
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_7189.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 230)).objectCompare (GALGAS_string ("framework"))).boolEnum () ;
          if (kBoolTrue == test_6) {
            GALGAS_string var_framework_5F_FileRef ;
            {
            categoryModifier_addFrameworkFile (ioObject, enumerator_7189.current_key (HERE), var_framework_5F_FileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 231)) ;
            }
            GALGAS_string var_buildRef ;
            {
            categoryModifier_addBuildFile (ioObject, var_framework_5F_FileRef, enumerator_7189.current_key (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 232)) ;
            }
            var_childrenRefs.addAssign_operation (var_framework_5F_FileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 233)) ;
            ioArgument_ioFrameWorkFileBuildRefs.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 234)) ;
          }else if (kBoolFalse == test_6) {
            const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_7189.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 235)).objectCompare (GALGAS_string ("plist"))).boolEnum () ;
            if (kBoolTrue == test_7) {
              GALGAS_string var_resource_5F_FileRef ;
              {
              categoryModifier_addInfoPlistFile (ioObject, enumerator_7189.current_key (HERE), var_resource_5F_FileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 236)) ;
              }
              var_childrenRefs.addAssign_operation (var_resource_5F_FileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 237)) ;
            }else if (kBoolFalse == test_7) {
              const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_7189.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 238)).objectCompare (GALGAS_string ("xib"))).boolEnum () ;
              if (kBoolTrue == test_8) {
                GALGAS_string var_resource_5F_FileRef ;
                {
                categoryModifier_addXIBFile (ioObject, enumerator_7189.current_key (HERE), var_resource_5F_FileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 239)) ;
                }
                var_childrenRefs.addAssign_operation (var_resource_5F_FileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 240)) ;
                GALGAS_string var_buildRef ;
                {
                categoryModifier_addBuildFile (ioObject, var_resource_5F_FileRef, enumerator_7189.current_key (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 241)) ;
                }
                ioArgument_ioResourceFileBuildRefs.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 242)) ;
              }else if (kBoolFalse == test_8) {
                const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_7189.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 243)).objectCompare (GALGAS_string ("tiff"))).boolEnum () ;
                if (kBoolTrue == test_9) {
                  GALGAS_string var_resource_5F_FileRef ;
                  {
                  categoryModifier_addTIFF_5F_file (ioObject, enumerator_7189.current_key (HERE), var_resource_5F_FileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 244)) ;
                  }
                  var_childrenRefs.addAssign_operation (var_resource_5F_FileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 245)) ;
                  GALGAS_string var_buildRef ;
                  {
                  categoryModifier_addBuildFile (ioObject, var_resource_5F_FileRef, enumerator_7189.current_key (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 246)) ;
                  }
                  ioArgument_ioResourceFileBuildRefs.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 247)) ;
                }else if (kBoolFalse == test_9) {
                  const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_7189.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 248)).objectCompare (GALGAS_string ("icns"))).boolEnum () ;
                  if (kBoolTrue == test_10) {
                    GALGAS_string var_resource_5F_FileRef ;
                    {
                    categoryModifier_addICNS_5F_file (ioObject, enumerator_7189.current_key (HERE), var_resource_5F_FileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 249)) ;
                    }
                    var_childrenRefs.addAssign_operation (var_resource_5F_FileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 250)) ;
                    GALGAS_string var_buildRef ;
                    {
                    categoryModifier_addBuildFile (ioObject, var_resource_5F_FileRef, enumerator_7189.current_key (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 251)) ;
                    }
                    ioArgument_ioResourceFileBuildRefs.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 252)) ;
                  }else if (kBoolFalse == test_10) {
                    inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 254)), GALGAS_string ("unhandled extension for file '").add_operation (enumerator_7189.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 254)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 254))  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 254)) ;
                  }
                }
              }
            }
  ...
  ioObject.mAttribute_mGroupList.addAssign_operation (outArgument_outGroupRef, constinArgument_inGroupName, constinArgument_inGroupPath, var_childrenRefs  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 257)) ;
}
...
void categoryModifier_placeGroupAsMainGroup (GALGAS_XcodeProjectDescriptor & ioObject,
                                             ...
                                             C_Compiler * /* inCompiler */
                                             COMMA_UNUSED_LOCATION_ARGS) {
  ioObject.mAttribute_mMainGroupChildrenRefs.addAssign_operation (constinArgument_inGroupRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 265)) ;
}
...
void categoryModifier_addSettingsToDefaultConfiguration (GALGAS_XcodeProjectDescriptor & ioObject,
                                                         ...
                                                         C_Compiler * /* inCompiler */
                                                         COMMA_UNUSED_LOCATION_ARGS) {
  ioObject.mAttribute_mDefaultConfigurationSettingList.dotAssign_operation (constinArgument_inSettingList  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 273)) ;
}
...
void categoryModifier_getReferenceKey (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  if (kBoolTrue == test_0) {
    ioObject.mAttribute_mProjectObjectReference = ioObject.mAttribute_mSequenceNumber.reader_string (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 332)).reader_md_35_ (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 332)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 332)) ;
    ioObject.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 333)) ;
  }
  outArgument_outRef = ioObject.mAttribute_mSequenceNumber.reader_string (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 335)).reader_md_35_ (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 335)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 335)) ;
  ioObject.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 336)) ;
}
...
mAttribute_mInfoPlistFileList (inOperand15),
mAttribute_mXIB_5F_fileList (inOperand16),
mAttribute_mTIFF_5F_fileList (inOperand17),
mAttribute_mICNS_5F_fileList (inOperand18) {
}
...
GALGAS_XcodeProjectDescriptor GALGAS_XcodeProjectDescriptor::constructor_new (const GALGAS_uint & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid () && inOperand9.isValid () && inOperand10.isValid () && inOperand11.isValid () && inOperand12.isValid () && inOperand13.isValid () && inOperand14.isValid () && inOperand15.isValid () && inOperand16.isValid () && inOperand17.isValid () && inOperand18.isValid ()) {
    result = GALGAS_XcodeProjectDescriptor (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8, inOperand9, inOperand10, inOperand11, inOperand12, inOperand13, inOperand14, inOperand15, inOperand16, inOperand17, inOperand18) ;
  }
  return result ;
}
...
void categoryMethod_generateAtPath (const GALGAS_XcodeProjectDescriptor inObject,
                                    ...
                                    C_Compiler * inCompiler
                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_contents = GALGAS_string (filewrapperTemplate_xcodeProjectGenerationFilewrapper_xcodeproj (inCompiler, inObject.mAttribute_mProjectObjectReference, inObject.mAttribute_mMainGroupReference, inObject.mAttribute_mGroupList, inObject.mAttribute_mMainGroupChildrenRefs, inObject.mAttribute_mToolTargetList, inObject.mAttribute_mAppTargetList, inObject.mAttribute_mCppFileList, inObject.mAttribute_m_5F_M_5F_FileList, inObject.mAttribute_mFrameworkFileList, inObject.mAttribute_mHeaderFileList, inObject.mAttribute_mInfoPlistFileList, inObject.mAttribute_mTIFF_5F_fileList, inObject.mAttribute_mICNS_5F_fileList, inObject.mAttribute_mXIB_5F_fileList, inObject.mAttribute_mBuildFileList, inObject.mAttribute_mDefaultConfigurationRef, inObject.mAttribute_mDefaultConfigurationSettingList, inObject.mAttribute_mProjectBuildConfigurationRef COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 398))) ;
  GALGAS_string var_projectCoreFile = constinArgument_inPath.add_operation (GALGAS_string ("/project.pbxproj"), inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 418)) ;
  GALGAS_bool test_0 = var_projectCoreFile.reader_fileExists (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 419)).operator_not (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 419)) ;
  if (kBoolTrue != test_0.boolEnum ()) {
    test_0 = constinArgument_inCacheFilePath.reader_fileExists (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 419)).operator_not (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 419)) ;
  }
  GALGAS_bool test_1 = test_0 ;
  if (kBoolTrue != test_1.boolEnum ()) {
    test_1 = GALGAS_bool (kIsNotEqual, GALGAS_string::constructor_stringWithContentsOfFile (constinArgument_inCacheFilePath, inCompiler  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 419)).objectCompare (var_contents)) ;
  }
  const enumGalgasBool test_2 = test_1.boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_bool joker_14592 ; // Joker input parameter
    var_contents.method_writeToFileWhenDifferentContents (constinArgument_inCacheFilePath, joker_14592, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 420)) ;
    var_contents.method_makeDirectoryAndWriteToFile (var_projectCoreFile, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 421)) ;
  }
}
