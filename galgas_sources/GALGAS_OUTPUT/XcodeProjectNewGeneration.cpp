...
GALGAS_string filewrapperTemplate_xcodeProjectGenerationFilewrapper_xcodeproj (C_Compiler * /* inCompiler */,
  ...
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_3408 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_3408.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_3408.current_mFrameworkBuildPhaseRef (HERE).stringValue () ;
      result << " = {\n"
        "    isa = PBXFrameworksBuildPhase;\n"
        "    buildActionMask = 2147483647;\n"
        "    files = (\n" ;
      GALGAS_uint index_3576_ (0) ;
      if (enumerator_3408.current_mFrameworksFileRefList (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_3576 (enumerator_3408.current_mFrameworksFileRefList (HERE), kEnumeration_up) ;
        while (enumerator_3576.hasCurrentObject ()) {
          result << "      " ;
          result << enumerator_3576.current_mValue (HERE).stringValue () ;
          result << ",\n" ;
  ...
  GALGAS_uint index_3789_ (0) ;
  if (in_GROUPS.isValid ()) {
    cEnumerator_XCodeGroupList enumerator_3789 (in_GROUPS, kEnumeration_up) ;
    while (enumerator_3789.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_3789.current_mGroupReference (HERE).stringValue () ;
      result << " /* " ;
      result << enumerator_3789.current_mGroupName (HERE).stringValue () ;
      result << " */ = {\n"
        "    isa = PBXGroup;\n"
        "    children = (\n" ;
      GALGAS_uint index_3910_ (0) ;
      if (enumerator_3789.current_mChildrenRefs (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_3910 (enumerator_3789.current_mChildrenRefs (HERE), kEnumeration_up) ;
        while (enumerator_3910.hasCurrentObject ()) {
          result << "      " ;
          result << enumerator_3910.current_mValue (HERE).stringValue () ;
          result << ", \n" ;
      ...
      result << "    );\n"
        "    name = " ;
      result << enumerator_3789.current_mGroupName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 131)).stringValue () ;
      result << ";\n"
        "    path = " ;
      result << enumerator_3789.current_mGroupPath (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 132)).stringValue () ;
      result << ";\n"
        "    sourceTree = \"<group>\";\n"
        "  };\n" ;
      index_3789_.increment () ;
  ...
  if (in_MAIN_5F_GROUP_5F_CHILDREN_5F_REFS.isValid ()) {
    cEnumerator_stringlist enumerator_4216 (in_MAIN_5F_GROUP_5F_CHILDREN_5F_REFS, kEnumeration_up) ;
    while (enumerator_4216.hasCurrentObject ()) {
      result << "      " ;
      result << enumerator_4216.current_mValue (HERE).stringValue () ;
      result << ",\n" ;
  ...
  if (in_TOOL_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeToolTargetList enumerator_4407 (in_TOOL_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_4407.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_4407.current_mTargetRef (HERE).stringValue () ;
      result << " /* " ;
      result << enumerator_4407.current_mTargetName (HERE).stringValue () ;
      result << " */ = {\n"
        "   isa = PBXNativeTarget;\n"
        "   buildConfigurationList = " ;
      result << enumerator_4407.current_mBuildConfigurationListRef (HERE).stringValue () ;
      result << " ;\n"
        "   buildPhases = (\n"
        "    " ;
      result << enumerator_4407.current_mBuildPhaseRef (HERE).stringValue () ;
      result << " ,\n"
        "   );\n"
        "   buildRules = (\n"
        "   );\n"
        ...
        "   );\n"
        "   name = " ;
      result << enumerator_4407.current_mTargetName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 161)).stringValue () ;
      result << ";\n"
        "   productInstallPath = \"$(HOME)/bin\";\n"
        "   productName = " ;
      result << enumerator_4407.current_mTargetName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 163)).stringValue () ;
      result << ";\n"
        "   productReference = " ;
      result << enumerator_4407.current_mProductFileReference (HERE).stringValue () ;
      result << " ;\n"
  ...
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_4913 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_4913.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_4913.current_mTargetRef (HERE).stringValue () ;
      result << " /* " ;
      result << enumerator_4913.current_mTargetName (HERE).stringValue () ;
      result << " */ = {\n"
        "    isa = PBXNativeTarget;\n"
        "    buildConfigurationList = " ;
      result << enumerator_4913.current_mBuildConfigurationListRef (HERE).stringValue () ;
      result << " ;\n"
        "    buildPhases = (\n"
        "      " ;
      result << enumerator_4913.current_mResourceBuildRef (HERE).stringValue () ;
      result << " , /* Resources */\n"
        "      " ;
      result << enumerator_4913.current_mFrameworkBuildPhaseRef (HERE).stringValue () ;
      result << " , /* Frameworks */\n"
        "      " ;
      result << enumerator_4913.current_mBuildPhaseRef (HERE).stringValue () ;
      result << " , /* Sources */\n"
        "    );\n"
        "    buildRules = (\n"
        "    );\n"
        "    dependencies = (\n" ;
      GALGAS_uint index_5287_ (0) ;
      if (enumerator_4913.current_mDependentTargets (HERE).isValid ()) {
        cEnumerator__32_stringlist enumerator_5287 (enumerator_4913.current_mDependentTargets (HERE), kEnumeration_up) ;
        while (enumerator_5287.hasCurrentObject ()) {
          result << "      " ;
          result << enumerator_5287.current_mValue_30_ (HERE).stringValue () ;
          result << " ,\n" ;
          index_5287_.increment () ;
          enumerator_5287.gotoNextObject () ;
        }
      }
      result << "    );\n"
        "    name = " ;
      result << enumerator_4913.current_mTargetName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 187)).stringValue () ;
      result << ";\n"
        "    productInstallPath = \"$(HOME)/bin\";\n"
        "    productName = " ;
      result << enumerator_4913.current_mTargetName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 189)).stringValue () ;
      result << ";\n"
        "    productReference = " ;
      result << enumerator_4913.current_mProductFileReference (HERE).stringValue () ;
      result << " ;\n"
  ...
  if (in_TOOL_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeToolTargetList enumerator_6048 (in_TOOL_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_6048.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6048.current_mTargetRef (HERE).stringValue () ;
      result << ", \n" ;
  ...
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_6105 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_6105.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6105.current_mTargetRef (HERE).stringValue () ;
      result << ", \n" ;
  ...
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_6275 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_6275.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_6275.current_mResourceBuildRef (HERE).stringValue () ;
      result << " /* Resources */ = {\n"
        "    isa = PBXResourcesBuildPhase;\n"
        "    buildActionMask = 2147483647;\n"
        "    files = (\n" ;
      GALGAS_uint index_6452_ (0) ;
      if (enumerator_6275.current_mResourceFileBuildRefs (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_6452 (enumerator_6275.current_mResourceFileBuildRefs (HERE), kEnumeration_up) ;
        while (enumerator_6452.hasCurrentObject ()) {
          result << "      " ;
          result << enumerator_6452.current_mValue (HERE).stringValue () ;
          result << ",\n" ;
          index_6452_.increment () ;
  ...
  if (in_TOOL_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeToolTargetList enumerator_6679 (in_TOOL_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_6679.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6679.current_mBuildPhaseRef (HERE).stringValue () ;
      result << " /* Sources */ = {\n"
        "      isa = PBXSourcesBuildPhase;\n"
        "      buildActionMask = 2147483647;\n"
        "      files = (\n" ;
      GALGAS_uint index_6840_ (0) ;
      if (enumerator_6679.current_mBuildPhaseRefList (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_6840 (enumerator_6679.current_mBuildPhaseRefList (HERE), kEnumeration_up) ;
        while (enumerator_6840.hasCurrentObject ()) {
          result << "        " ;
          result << enumerator_6840.current_mValue (HERE).stringValue () ;
          result << ",\n" ;
          index_6840_.increment () ;
  ...
  GALGAS_uint index_6964_ (0) ;
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_6964 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_6964.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6964.current_mBuildPhaseRef (HERE).stringValue () ;
      result << " /* Sources */ = {\n"
        "      isa = PBXSourcesBuildPhase;\n"
        "      buildActionMask = 2147483647;\n"
        "      files = (\n" ;
      GALGAS_uint index_7125_ (0) ;
      if (enumerator_6964.current_mBuildPhaseRefList (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_7125 (enumerator_6964.current_mBuildPhaseRefList (HERE), kEnumeration_up) ;
        while (enumerator_7125.hasCurrentObject ()) {
          result << "        " ;
          result << enumerator_7125.current_mValue (HERE).stringValue () ;
          result << ",\n" ;
  ...
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_7350 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_7350.hasCurrentObject ()) {
      GALGAS_uint index_7383_ (0) ;
      if (enumerator_7350.current_mDependentTargets (HERE).isValid ()) {
        cEnumerator__32_stringlist enumerator_7383 (enumerator_7350.current_mDependentTargets (HERE), kEnumeration_up) ;
        while (enumerator_7383.hasCurrentObject ()) {
          result << "  " ;
          result << enumerator_7383.current_mValue_30_ (HERE).stringValue () ;
          result << " = {\n"
            "    isa = PBXTargetDependency;\n"
            "    target = " ;
          result << enumerator_7383.current_mValue_31_ (HERE).stringValue () ;
          result << ";\n"
            "  };\n"
            "\n" ;
  ...
  result << " /* Default */ = {\n"
    ...
    "      buildSettings = {\n" ;
  GALGAS_uint index_7854_ (0) ;
  if (in_DEFAULT_5F_CONFIGURATION_5F_SETTING_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_7854 (in_DEFAULT_5F_CONFIGURATION_5F_SETTING_5F_LIST, kEnumeration_up) ;
    while (enumerator_7854.hasCurrentObject ()) {
      result << "      " ;
      result << enumerator_7854.current_mValue (HERE).stringValue () ;
      result << " ;\n" ;
      index_7854_.increment () ;
  ...
  result << "    };\n"
    ...
    "  };\n"
    "\n" ;
  GALGAS_uint index_7946_ (0) ;
  if (in_TOOL_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeToolTargetList enumerator_7946 (in_TOOL_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_7946.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_7946.current_mBuildConfigurationRef (HERE).stringValue () ;
      result << " /* Default */ = {\n"
        "      isa = XCBuildConfiguration;\n"
        "      buildSettings = {\n" ;
      GALGAS_uint index_8108_ (0) ;
      if (enumerator_7946.current_mBuildConfigurationSettingList (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_8108 (enumerator_7946.current_mBuildConfigurationSettingList (HERE), kEnumeration_up) ;
        while (enumerator_8108.hasCurrentObject ()) {
          result << "      " ;
          result << enumerator_8108.current_mValue (HERE).stringValue () ;
          result << " ;\n" ;
          index_8108_.increment () ;
          enumerator_8108.gotoNextObject () ;
        }
      }
      result << "      PRODUCT_NAME = " ;
      result << enumerator_7946.current_mProductFileName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 296)).stringValue () ;
      result << " ;\n"
        "    };\n"
        "    name = Default;\n"
        "  };\n"
  ...
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_8281 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_8281.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8281.current_mBuildConfigurationRef (HERE).stringValue () ;
      result << " /* Default */ = {\n"
        "      isa = XCBuildConfiguration;\n"
        "      buildSettings = {\n" ;
      GALGAS_uint index_8443_ (0) ;
      if (enumerator_8281.current_mBuildConfigurationSettingList (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_8443 (enumerator_8281.current_mBuildConfigurationSettingList (HERE), kEnumeration_up) ;
        while (enumerator_8443.hasCurrentObject ()) {
          result << "      " ;
          result << enumerator_8443.current_mValue (HERE).stringValue () ;
          result << " ;\n" ;
      ...
      result << "      INFOPLIST_FILE = \"Info.plist\";\n"
        "      PRODUCT_NAME = " ;
      result << enumerator_8281.current_mProductFileName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 309)).stringValue () ;
      result << " ;\n"
        "    };\n"
        "    name = Default;\n"
        "  };\n"
  ...
  if (in_TOOL_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeToolTargetList enumerator_9076 (in_TOOL_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_9076.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_9076.current_mBuildConfigurationListRef (HERE).stringValue () ;
      result << " /* Default */ = {\n"
        "      isa = XCConfigurationList;\n"
        "      buildConfigurations = (\n"
        "        " ;
      result << enumerator_9076.current_mBuildConfigurationRef (HERE).stringValue () ;
      result << " /* Default */,\n"
        "      );\n"
        "      defaultConfigurationIsVisible = 0;\n"
        "      defaultConfigurationName = Default;\n"
  ...
  if (in_APP_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeAppTargetList enumerator_9376 (in_APP_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_9376.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_9376.current_mBuildConfigurationListRef (HERE).stringValue () ;
      result << " /* Default */ = {\n"
        "      isa = XCConfigurationList;\n"
        "      buildConfigurations = (\n"
        "        " ;
      result << enumerator_9376.current_mBuildConfigurationRef (HERE).stringValue () ;
      result << " /* Default */,\n"
        "      );\n"
        "      defaultConfigurationIsVisible = 0;\n"
        "      defaultConfigurationName = Default;\n"
...
void categoryModifier_addTIFF_5F_file (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  ioObject.mAttribute_mTIFF_5F_fileList.addAssign_operation (outArgument_outFileRef, constinArgument_inFileName  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 10)) ;
}
...
void categoryModifier_addInfoPlistFile (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  ioObject.mAttribute_mInfoPlistFileList.addAssign_operation (outArgument_outFileRef, constinArgument_inFileName  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 20)) ;
}
...
void categoryModifier_addXIBFile (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  ioObject.mAttribute_mXIB_5F_fileList.addAssign_operation (outArgument_outFileRef, constinArgument_inFileName  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 30)) ;
}
...
void categoryModifier_addFrameworkFile (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  ioObject.mAttribute_mFrameworkFileList.addAssign_operation (outArgument_outFileRef, constinArgument_inFileName  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 40)) ;
}
...
void categoryModifier_addMFile (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  ioObject.mAttribute_m_5F_M_5F_FileList.addAssign_operation (outArgument_outFileRef, constinArgument_inFileName  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 50)) ;
}
...
void categoryModifier_addCppFile (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  ioObject.mAttribute_mCppFileList.addAssign_operation (outArgument_outFileRef, constinArgument_inFileName  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 60)) ;
}
...
void categoryModifier_addHeaderFile (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  ioObject.mAttribute_mHeaderFileList.addAssign_operation (outArgument_outFileRef, constinArgument_inFileName  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 70)) ;
}
...
void categoryModifier_addBuildFile (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outBuildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 80)) ;
  }
  ioObject.mAttribute_mBuildFileList.addAssign_operation (constinArgument_inFileReference, constinArgument_inFileName, outArgument_outBuildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 81)) ;
}
...
void categoryModifier_addToolTarget (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outProductFileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 94)) ;
  }
  GALGAS_string var_buildPhaseRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_buildPhaseRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 95)) ;
  }
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outTargetRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 96)) ;
  }
  GALGAS_string var_buildConfigurationListRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_buildConfigurationListRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 97)) ;
  }
  GALGAS_string var_buildConfigurationRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_buildConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 98)) ;
  }
  ioObject.mAttribute_mToolTargetList.addAssign_operation (outArgument_outTargetRef, constinArgument_inTargetName, outArgument_outProductFileRef, constinArgument_inProductFileName, constinArgument_inSourceList, var_buildPhaseRef, var_buildConfigurationListRef, constinArgument_inBuildConfigurationSettingList, var_buildConfigurationRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 99)) ;
}
...
void categoryModifier_addAppTarget (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  outArgument_outProductFileRef.drop () ; // Release 'out' argument
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outProductFileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 125)) ;
  }
  GALGAS_string var_buildPhaseRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_buildPhaseRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 126)) ;
  }
  GALGAS_string var_targetRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_targetRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 127)) ;
  }
  GALGAS_string var_buildConfigurationListRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_buildConfigurationListRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 128)) ;
  }
  GALGAS_string var_buildConfigurationRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_buildConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 129)) ;
  }
  GALGAS_string var_frameworkBuildRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_frameworkBuildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 130)) ;
  }
  GALGAS_string var_resourceBuildRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_resourceBuildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 131)) ;
  }
  GALGAS__32_stringlist var_dependentTargets = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 132)) ;
  cEnumerator_stringlist enumerator_4435 (constinArgument_inDependentTargetRefList, kEnumeration_up) ;
  while (enumerator_4435.hasCurrentObject ()) {
    GALGAS_string var_dependencyBuildRef ;
    {
    categoryModifier_getReferenceKey (ioObject, var_dependencyBuildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 134)) ;
    }
    var_dependentTargets.addAssign_operation (var_dependencyBuildRef, enumerator_4435.current_mValue (HERE)  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 135)) ;
    enumerator_4435.gotoNextObject () ;
  }
  GALGAS_stringlist var_resourceFileBuildRefs = constinArgument_inResourceFileBuildRefs ;
  cEnumerator__32_stringlist enumerator_4660 (constinArgument_inProductCopyList, kEnumeration_up) ;
  while (enumerator_4660.hasCurrentObject ()) {
    GALGAS_string var_buildRef ;
    {
    categoryModifier_addBuildFile (ioObject, enumerator_4660.current_mValue_30_ (HERE), enumerator_4660.current_mValue_31_ (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 139)) ;
    }
    var_resourceFileBuildRefs.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 140)) ;
    enumerator_4660.gotoNextObject () ;
  }
  ioObject.mAttribute_mAppTargetList.addAssign_operation (var_targetRef, constinArgument_inTargetName, outArgument_outProductFileRef, constinArgument_inProductFileName, constinArgument_inSourceList, var_buildPhaseRef, var_buildConfigurationListRef, constinArgument_inBuildConfigurationSettingList, var_buildConfigurationRef, constinArgument_inFrameworksFileRefList, var_frameworkBuildRef, var_dependentTargets, var_resourceBuildRef, var_resourceFileBuildRefs  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 142)) ;
}
...
void categoryModifier_addGroup (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  if (kBoolTrue == test_0) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mDefaultConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 169)) ;
    }
  }
  ...
  if (kBoolTrue == test_1) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mProjectBuildConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 172)) ;
    }
  }
  ...
  if (kBoolTrue == test_2) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mMainGroupReference, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 175)) ;
    }
  }
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outGroupRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 177)) ;
  }
  ioObject.mAttribute_mGroupList.addAssign_operation (outArgument_outGroupRef, constinArgument_inGroupName, constinArgument_inGroupPath, constinArgument_inChildrenRefs  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 178)) ;
}
...
void categoryModifier_addGroupWithFiles (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  if (kBoolTrue == test_0) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mDefaultConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 195)) ;
    }
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, ioObject.mAttribute_mProjectBuildConfigurationRef.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mProjectBuildConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 198)) ;
    }
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, ioObject.mAttribute_mMainGroupReference.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_2) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mMainGroupReference, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 201)) ;
    }
  }
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outGroupRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 203)) ;
  }
  GALGAS_stringlist var_childrenRefs = constinArgument_inSubgroupRefs ;
  cEnumerator_stringset enumerator_6893 (constinArgument_inFileNames, kEnumeration_up) ;
  while (enumerator_6893.hasCurrentObject ()) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_6893.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 207)).objectCompare (GALGAS_string ("cpp"))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_cppFileRef ;
      {
      categoryModifier_addCppFile (ioObject, enumerator_6893.current_key (HERE), var_cppFileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 208)) ;
      }
      var_childrenRefs.addAssign_operation (var_cppFileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 209)) ;
      GALGAS_string var_buildRef ;
      {
      categoryModifier_addBuildFile (ioObject, var_cppFileRef, enumerator_6893.current_key (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 210)) ;
      }
      ioArgument_ioCppFileBuildRefs.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 211)) ;
    }else if (kBoolFalse == test_3) {
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_6893.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 212)).objectCompare (GALGAS_string ("h"))).boolEnum () ;
      if (kBoolTrue == test_4) {
        GALGAS_string var_headerFileRef ;
        {
        categoryModifier_addHeaderFile (ioObject, enumerator_6893.current_key (HERE), var_headerFileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 213)) ;
        }
        var_childrenRefs.addAssign_operation (var_headerFileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 214)) ;
      }else if (kBoolFalse == test_4) {
        const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_6893.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 215)).objectCompare (GALGAS_string ("m"))).boolEnum () ;
        if (kBoolTrue == test_5) {
          GALGAS_string var_m_5F_FileRef ;
          {
          categoryModifier_addMFile (ioObject, enumerator_6893.current_key (HERE), var_m_5F_FileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 216)) ;
          }
          GALGAS_string var_buildRef ;
          {
          categoryModifier_addBuildFile (ioObject, var_m_5F_FileRef, enumerator_6893.current_key (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 217)) ;
          }
          var_childrenRefs.addAssign_operation (var_m_5F_FileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 218)) ;
          ioArgument_ioMFileBuildRefs.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 219)) ;
        }else if (kBoolFalse == test_5) {
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_6893.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 220)).objectCompare (GALGAS_string ("framework"))).boolEnum () ;
          if (kBoolTrue == test_6) {
            GALGAS_string var_framework_5F_FileRef ;
            {
            categoryModifier_addFrameworkFile (ioObject, enumerator_6893.current_key (HERE), var_framework_5F_FileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 221)) ;
            }
            GALGAS_string var_buildRef ;
            {
            categoryModifier_addBuildFile (ioObject, var_framework_5F_FileRef, enumerator_6893.current_key (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 222)) ;
            }
            var_childrenRefs.addAssign_operation (var_framework_5F_FileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 223)) ;
            ioArgument_ioFrameWorkFileBuildRefs.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 224)) ;
          }else if (kBoolFalse == test_6) {
            const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_6893.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 225)).objectCompare (GALGAS_string ("plist"))).boolEnum () ;
            if (kBoolTrue == test_7) {
              GALGAS_string var_resource_5F_FileRef ;
              {
              categoryModifier_addInfoPlistFile (ioObject, enumerator_6893.current_key (HERE), var_resource_5F_FileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 226)) ;
              }
              var_childrenRefs.addAssign_operation (var_resource_5F_FileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 227)) ;
            }else if (kBoolFalse == test_7) {
              const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_6893.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 228)).objectCompare (GALGAS_string ("xib"))).boolEnum () ;
              if (kBoolTrue == test_8) {
                GALGAS_string var_resource_5F_FileRef ;
                {
                categoryModifier_addXIBFile (ioObject, enumerator_6893.current_key (HERE), var_resource_5F_FileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 229)) ;
                }
                var_childrenRefs.addAssign_operation (var_resource_5F_FileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 230)) ;
                GALGAS_string var_buildRef ;
                {
                categoryModifier_addBuildFile (ioObject, var_resource_5F_FileRef, enumerator_6893.current_key (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 231)) ;
                }
                ioArgument_ioResourceFileBuildRefs.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 232)) ;
              }else if (kBoolFalse == test_8) {
                const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_6893.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 233)).objectCompare (GALGAS_string ("tiff"))).boolEnum () ;
                if (kBoolTrue == test_9) {
                  GALGAS_string var_resource_5F_FileRef ;
                  {
                  categoryModifier_addTIFF_5F_file (ioObject, enumerator_6893.current_key (HERE), var_resource_5F_FileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 234)) ;
                  }
                  var_childrenRefs.addAssign_operation (var_resource_5F_FileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 235)) ;
                  GALGAS_string var_buildRef ;
                  {
                  categoryModifier_addBuildFile (ioObject, var_resource_5F_FileRef, enumerator_6893.current_key (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 236)) ;
                  }
                  ioArgument_ioResourceFileBuildRefs.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 237)) ;
                }else if (kBoolFalse == test_9) {
                  inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 239)), GALGAS_string ("unhandled extension for file '").add_operation (enumerator_6893.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 239)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 239))  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 239)) ;
                }
              }
            }
          }
  ...
  ioObject.mAttribute_mGroupList.addAssign_operation (outArgument_outGroupRef, constinArgument_inGroupName, constinArgument_inGroupPath, var_childrenRefs  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 242)) ;
}
...
void categoryModifier_placeGroupAsMainGroup (GALGAS_XcodeProjectDescriptor & ioObject,
                                             ...
                                             C_Compiler * /* inCompiler */
                                             COMMA_UNUSED_LOCATION_ARGS) {
  ioObject.mAttribute_mMainGroupChildrenRefs.addAssign_operation (constinArgument_inGroupRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 250)) ;
}
...
void categoryModifier_addSettingsToDefaultConfiguration (GALGAS_XcodeProjectDescriptor & ioObject,
                                                         ...
                                                         C_Compiler * /* inCompiler */
                                                         COMMA_UNUSED_LOCATION_ARGS) {
  ioObject.mAttribute_mDefaultConfigurationSettingList.dotAssign_operation (constinArgument_inSettingList  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 258)) ;
}
...
void categoryModifier_getReferenceKey (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  if (kBoolTrue == test_0) {
    ioObject.mAttribute_mProjectObjectReference = ioObject.mAttribute_mSequenceNumber.reader_string (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 317)).reader_md_35_ (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 317)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 317)) ;
    ioObject.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 318)) ;
  }
  outArgument_outRef = ioObject.mAttribute_mSequenceNumber.reader_string (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 320)).reader_md_35_ (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 320)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 320)) ;
  ioObject.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 321)) ;
}
...
GALGAS_XcodeProjectDescriptor GALGAS_XcodeProjectDescriptor::constructor_new (const GALGAS_uint & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid () && inOperand9.isValid () && inOperand10.isValid () && inOperand11.isValid () && inOperand12.isValid () && inOperand13.isValid () && inOperand14.isValid () && inOperand15.isValid () && inOperand16.isValid () && inOperand17.isValid ()) {
    result = GALGAS_XcodeProjectDescriptor (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8, inOperand9, inOperand10, inOperand11, inOperand12, inOperand13, inOperand14, inOperand15, inOperand16, inOperand17) ;
  }
  return result ;
}
...
void categoryMethod_generateAtPath (const GALGAS_XcodeProjectDescriptor inObject,
                                    ...
                                    C_Compiler * inCompiler
                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_contents = GALGAS_string (filewrapperTemplate_xcodeProjectGenerationFilewrapper_xcodeproj (inCompiler, inObject.mAttribute_mProjectObjectReference, inObject.mAttribute_mMainGroupReference, inObject.mAttribute_mGroupList, inObject.mAttribute_mMainGroupChildrenRefs, inObject.mAttribute_mToolTargetList, inObject.mAttribute_mAppTargetList, inObject.mAttribute_mCppFileList, inObject.mAttribute_m_5F_M_5F_FileList, inObject.mAttribute_mFrameworkFileList, inObject.mAttribute_mHeaderFileList, inObject.mAttribute_mInfoPlistFileList, inObject.mAttribute_mTIFF_5F_fileList, inObject.mAttribute_mXIB_5F_fileList, inObject.mAttribute_mBuildFileList, inObject.mAttribute_mDefaultConfigurationRef, inObject.mAttribute_mDefaultConfigurationSettingList, inObject.mAttribute_mProjectBuildConfigurationRef COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 381))) ;
  GALGAS_bool test_0 = constinArgument_inCacheFilePath.reader_fileExists (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 400)) ;
  if (kBoolTrue == test_0.boolEnum ()) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string::constructor_stringWithContentsOfFile (constinArgument_inCacheFilePath, inCompiler  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 400)).objectCompare (var_contents)) ;
  }
  const enumGalgasBool test_1 = test_0.operator_not (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 400)).boolEnum () ;
  if (kBoolTrue == test_1) {
    var_contents.method_writeToFile (constinArgument_inCacheFilePath, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 401)) ;
    var_contents.method_makeDirectoryAndWriteToFile (constinArgument_inPath.add_operation (GALGAS_string ("/project.pbxproj"), inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 402)), inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 402)) ;
  }
}
