...
void categoryMethod_generateAtPath (const GALGAS_XcodeProjectDescriptor inObject,
  ...
  if (kBoolTrue == test_2) {
    GALGAS_bool joker_15481 ; // Joker input parameter
    var_contents.method_writeToFileWhenDifferentContents (constinArgument_inCacheFilePath, joker_15481, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 444)) ;
