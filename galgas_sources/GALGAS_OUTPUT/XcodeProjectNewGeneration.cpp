...
void categoryMethod_generateAtPath (const GALGAS_XcodeProjectDescriptor inObject,
  ...
  if (kBoolTrue == test_2) {
    GALGAS_bool joker_15361 ; // Joker input parameter
    var_contents.method_writeToFileWhenDifferentContents (constinArgument_inCacheFilePath, joker_15361, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 444)) ;
