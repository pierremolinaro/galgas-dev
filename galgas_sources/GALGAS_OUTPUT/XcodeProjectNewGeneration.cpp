...
GALGAS_string filewrapperTemplate_xcodeProjectGenerationFilewrapper_xcodeproj (C_Compiler * /* inCompiler */,
  ...
  if (in_MACH_5F_O_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeMachOTargetList enumerator_1552 (in_MACH_5F_O_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_1552.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_1552.current_mProductFileReference (HERE).stringValue () ;
      result << " = {\n"
        "    isa = PBXFileReference;\n"
        "    explicitFileType = \"compiled.mach-o.executable\";\n"
        "    includeInIndex = 0;\n"
        "    path = " ;
      result << enumerator_1552.current_mProductFileName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 55)).stringValue () ;
      result << ";\n"
  ...
  if (in_GROUPS.isValid ()) {
    cEnumerator_XCodeGroupList enumerator_2140 (in_GROUPS, kEnumeration_up) ;
    while (enumerator_2140.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_2140.current_mGroupReference (HERE).stringValue () ;
      result << " /* " ;
      result << enumerator_2140.current_mGroupName (HERE).stringValue () ;
      result << " */ = {\n"
        "    isa = PBXGroup;\n"
        "    children = (\n" ;
      GALGAS_uint index_2261_ (0) ;
      if (enumerator_2140.current_mChildrenRefs (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_2261 (enumerator_2140.current_mChildrenRefs (HERE), kEnumeration_up) ;
      ...
      result << "    );\n"
        "    name = " ;
      result << enumerator_2140.current_mGroupName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 71)).stringValue () ;
      result << ";\n"
        "    path = " ;
      result << enumerator_2140.current_mGroupPath (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 72)).stringValue () ;
      result << ";\n"
        "    sourceTree = \"<group>\";\n"
        "  };\n" ;
  ...
  result << " /* Main Group */ = {\n"
    "    isa = PBXGroup;\n"
    "    children = (\n" ;
  GALGAS_uint index_2567_ (0) ;
  if (in_MAIN_5F_GROUP_5F_CHILDREN_5F_REFS.isValid ()) {
    cEnumerator_stringlist enumerator_2567 (in_MAIN_5F_GROUP_5F_CHILDREN_5F_REFS, kEnumeration_up) ;
    while (enumerator_2567.hasCurrentObject ()) {
      result << "      " ;
      result << enumerator_2567.current_mValue (HERE).stringValue () ;
      result << ",\n" ;
      index_2567_.increment () ;
  ...
  if (in_MACH_5F_O_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeMachOTargetList enumerator_2815 (in_MACH_5F_O_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_2815.hasCurrentObject ()) {
      result << "  " ;
      result << enumerator_2815.current_mTargetRef (HERE).stringValue () ;
      result << " /* " ;
      result << enumerator_2815.current_mTargetName (HERE).stringValue () ;
      result << " */ = {\n"
        "   isa = PBXNativeTarget;\n"
        "   buildConfigurationList = " ;
      result << enumerator_2815.current_mBuildConfigurationListRef (HERE).stringValue () ;
      result << " ;\n"
        "   buildPhases = (\n"
        "    " ;
      result << enumerator_2815.current_mBuildPhaseRef (HERE).stringValue () ;
      result << " ,\n"
        "   );\n"
        "   buildRules = (\n"
        "   );\n"
        ...
        "   );\n"
        "   name = " ;
      result << enumerator_2815.current_mTargetName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 101)).stringValue () ;
      result << ";\n"
        "   productInstallPath = \"$(HOME)/bin\";\n"
        "   productName = \"essai\";\n"
        "   productReference = " ;
      result << enumerator_2815.current_mProductFileReference (HERE).stringValue () ;
      result << " ;\n"
  ...
  result << ";\n"
    ...
    "   projectRoot = \"\";\n"
    "   targets = (\n" ;
  GALGAS_uint index_3783_ (0) ;
  if (in_MACH_5F_O_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeMachOTargetList enumerator_3783 (in_MACH_5F_O_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_3783.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_3783.current_mTargetRef (HERE).stringValue () ;
      result << ", \n" ;
      index_3783_.increment () ;
  ...
  if (in_MACH_5F_O_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeMachOTargetList enumerator_4161 (in_MACH_5F_O_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_4161.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_4161.current_mBuildPhaseRef (HERE).stringValue () ;
      result << " /* Sources */ = {\n"
        "      isa = PBXSourcesBuildPhase;\n"
        "      buildActionMask = 2147483647;\n"
        "      files = (\n" ;
      GALGAS_uint index_4322_ (0) ;
      if (enumerator_4161.current_mBuildPhaseRefList (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_4322 (enumerator_4161.current_mBuildPhaseRefList (HERE), kEnumeration_up) ;
        while (enumerator_4322.hasCurrentObject ()) {
          result << "        " ;
          result << enumerator_4322.current_mValue (HERE).stringValue () ;
          result << ",\n" ;
  ...
  if (in_DEFAULT_5F_CONFIGURATION_5F_SETTING_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_5027 (in_DEFAULT_5F_CONFIGURATION_5F_SETTING_5F_LIST, kEnumeration_up) ;
    while (enumerator_5027.hasCurrentObject ()) {
      result << "      " ;
      result << enumerator_5027.current_mValue (HERE).stringValue () ;
      result << " ;\n" ;
  ...
  result << "    };\n"
    ...
    "  };\n"
    "\n" ;
  GALGAS_uint index_5121_ (0) ;
  if (in_MACH_5F_O_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeMachOTargetList enumerator_5121 (in_MACH_5F_O_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_5121.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_5121.current_mBuildConfigurationRef (HERE).stringValue () ;
      result << " /* Default */ = {\n"
        "      isa = XCBuildConfiguration;\n"
        "      buildSettings = {\n" ;
      GALGAS_uint index_5283_ (0) ;
      if (enumerator_5121.current_mBuildConfigurationSettingList (HERE).isValid ()) {
        cEnumerator_stringlist enumerator_5283 (enumerator_5121.current_mBuildConfigurationSettingList (HERE), kEnumeration_up) ;
      ...
      result << "      PRODUCT_NAME = " ;
      result << enumerator_5121.current_mProductFileName (HERE).reader_utf_38_Representation (SOURCE_FILE ("project.pbxproj.gTemplate", 170)).stringValue () ;
      result << " ;\n"
        "    };\n"
        "    name = Default;\n"
        "  };\n"
        "\n" ;
      index_5121_.increment () ;
  ...
  if (in_MACH_5F_O_5F_TARGET_5F_LIST.isValid ()) {
    cEnumerator_XCodeMachOTargetList enumerator_5931 (in_MACH_5F_O_5F_TARGET_5F_LIST, kEnumeration_up) ;
    while (enumerator_5931.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_5931.current_mBuildConfigurationListRef (HERE).stringValue () ;
      result << " /* Default */ = {\n"
        "      isa = XCConfigurationList;\n"
        "      buildConfigurations = (\n"
        "        " ;
      result << enumerator_5931.current_mBuildConfigurationRef (HERE).stringValue () ;
      result << " /* Default */,\n"
        "      );\n"
        "      defaultConfigurationIsVisible = 0;\n"
        "      defaultConfigurationName = Default;\n"
...
void categoryModifier_addMFile (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  ioObject.mAttribute_m_5F_M_5F_FileList.addAssign_operation (outArgument_outFileRef, constinArgument_inFileName  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 10)) ;
}
...
void categoryModifier_addCppFile (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  ioObject.mAttribute_mCppFileList.addAssign_operation (outArgument_outFileRef, constinArgument_inFileName  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 20)) ;
}
...
void categoryModifier_addHeaderFile (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  ioObject.mAttribute_mHeaderFileList.addAssign_operation (outArgument_outFileRef, constinArgument_inFileName  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 30)) ;
}
...
void categoryModifier_addBuildFile (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outBuildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 40)) ;
  }
  ioObject.mAttribute_mBuildFileList.addAssign_operation (constinArgument_inFileReference, constinArgument_inFileName, outArgument_outBuildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 41)) ;
}
...
void categoryModifier_addMachOTarget (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outProductFileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 53)) ;
  }
  GALGAS_string var_buildPhaseRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_buildPhaseRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 54)) ;
  }
  GALGAS_string var_targetRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_targetRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 55)) ;
  }
  GALGAS_string var_buildConfigurationListRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_buildConfigurationListRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 56)) ;
  }
  GALGAS_string var_buildConfigurationRef ;
  {
  categoryModifier_getReferenceKey (ioObject, var_buildConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 57)) ;
  }
  ioObject.mAttribute_mMachOTargetList.addAssign_operation (var_targetRef, constinArgument_inTargetName, outArgument_outProductFileRef, constinArgument_inProductFileName, constinArgument_inSourceList, var_buildPhaseRef, var_buildConfigurationListRef, constinArgument_inBuildConfigurationSettingList, var_buildConfigurationRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 58)) ;
}
...
void categoryModifier_addGroup (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  if (kBoolTrue == test_0) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mDefaultConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 80)) ;
    }
  }
  ...
  if (kBoolTrue == test_1) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mProjectBuildConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 83)) ;
    }
  }
  ...
  if (kBoolTrue == test_2) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mMainGroupReference, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 86)) ;
    }
  }
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outGroupRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 88)) ;
  }
  ioObject.mAttribute_mGroupList.addAssign_operation (outArgument_outGroupRef, constinArgument_inGroupName, constinArgument_inGroupPath, constinArgument_inChildrenRefs  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 89)) ;
}
...
void categoryModifier_addGroupWithFiles (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  if (kBoolTrue == test_0) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mDefaultConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 103)) ;
    }
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, ioObject.mAttribute_mProjectBuildConfigurationRef.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mProjectBuildConfigurationRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 106)) ;
    }
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, ioObject.mAttribute_mMainGroupReference.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_2) {
    {
    categoryModifier_getReferenceKey (ioObject, ioObject.mAttribute_mMainGroupReference, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 109)) ;
    }
  }
  {
  categoryModifier_getReferenceKey (ioObject, outArgument_outGroupRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 111)) ;
  }
  GALGAS_stringlist var_childrenRefs = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 113)) ;
  cEnumerator_stringset enumerator_3707 (constinArgument_inFileNames, kEnumeration_up) ;
  while (enumerator_3707.hasCurrentObject ()) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_3707.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 115)).objectCompare (GALGAS_string ("cpp"))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_cppFileRef ;
      {
      categoryModifier_addCppFile (ioObject, enumerator_3707.current_key (HERE), var_cppFileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 116)) ;
      }
      var_childrenRefs.addAssign_operation (var_cppFileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 117)) ;
      GALGAS_string var_buildRef ;
      {
      categoryModifier_addBuildFile (ioObject, var_cppFileRef, enumerator_3707.current_key (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 118)) ;
      }
      ioArgument_ioCppFileBuildRefs.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 119)) ;
    }else if (kBoolFalse == test_3) {
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_3707.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 120)).objectCompare (GALGAS_string ("h"))).boolEnum () ;
      if (kBoolTrue == test_4) {
        GALGAS_string var_headerFileRef ;
        {
        categoryModifier_addHeaderFile (ioObject, enumerator_3707.current_key (HERE), var_headerFileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 121)) ;
        }
        var_childrenRefs.addAssign_operation (var_headerFileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 122)) ;
      }else if (kBoolFalse == test_4) {
        const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_3707.current_key (HERE).reader_pathExtension (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 123)).objectCompare (GALGAS_string ("m"))).boolEnum () ;
        if (kBoolTrue == test_5) {
          GALGAS_string var_m_5F_FileRef ;
          {
          categoryModifier_addMFile (ioObject, enumerator_3707.current_key (HERE), var_m_5F_FileRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 124)) ;
          }
          GALGAS_string var_buildRef ;
          {
          categoryModifier_addBuildFile (ioObject, var_m_5F_FileRef, enumerator_3707.current_key (HERE), var_buildRef, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 125)) ;
          }
          var_childrenRefs.addAssign_operation (var_m_5F_FileRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 126)) ;
          ioArgument_ioMFileBuildRefs.addAssign_operation (var_buildRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 127)) ;
        }else if (kBoolFalse == test_5) {
          inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 129)), GALGAS_string ("unhandled extension for file '").add_operation (enumerator_3707.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 129)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 129))  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 129)) ;
        }
      }
    }
    enumerator_3707.gotoNextObject () ;
  }
  ioObject.mAttribute_mGroupList.addAssign_operation (outArgument_outGroupRef, constinArgument_inGroupName, constinArgument_inGroupPath, var_childrenRefs  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 132)) ;
}
...
void categoryModifier_placeGroupAsMainGroup (GALGAS_XcodeProjectDescriptor & ioObject,
                                             ...
                                             C_Compiler * /* inCompiler */
                                             COMMA_UNUSED_LOCATION_ARGS) {
  ioObject.mAttribute_mMainGroupChildrenRefs.addAssign_operation (constinArgument_inGroupRef  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 140)) ;
}
...
void categoryModifier_addSettingsToDefaultConfiguration (GALGAS_XcodeProjectDescriptor & ioObject,
                                                         ...
                                                         C_Compiler * /* inCompiler */
                                                         COMMA_UNUSED_LOCATION_ARGS) {
  ioObject.mAttribute_mDefaultConfigurationSettingList.dotAssign_operation (constinArgument_inSettingList  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 148)) ;
}
...
void categoryModifier_getReferenceKey (GALGAS_XcodeProjectDescriptor & ioObject,
  ...
  if (kBoolTrue == test_0) {
    ioObject.mAttribute_mProjectObjectReference = ioObject.mAttribute_mSequenceNumber.reader_string (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 188)).reader_md_35_ (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 188)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 188)) ;
    ioObject.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 189)) ;
  }
  outArgument_outRef = ioObject.mAttribute_mSequenceNumber.reader_string (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 191)).reader_md_35_ (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 191)).reader_rightSubString (GALGAS_uint ((uint32_t) 24U) COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 191)) ;
  ioObject.mAttribute_mSequenceNumber.increment_operation (inCompiler  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 192)) ;
}
...
GALGAS_XcodeProjectDescriptor::GALGAS_XcodeProjectDescriptor (const GALGAS_uint & inOperand0,
                                                              ...
                                                              const GALGAS_BuildFileList & inOperand9,
...
mAttribute_m_5F_M_5F_FileList (inOperand7),
mAttribute_mHeaderFileList (inOperand8),
mAttribute_mBuildFileList (inOperand9),
mAttribute_mDefaultConfigurationRef (inOperand10),
mAttribute_mDefaultConfigurationSettingList (inOperand11),
mAttribute_mProjectBuildConfigurationRef (inOperand12) {
}
...
GALGAS_XcodeProjectDescriptor GALGAS_XcodeProjectDescriptor::constructor_new (const GALGAS_uint & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid () && inOperand9.isValid () && inOperand10.isValid () && inOperand11.isValid () && inOperand12.isValid ()) {
    result = GALGAS_XcodeProjectDescriptor (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8, inOperand9, inOperand10, inOperand11, inOperand12) ;
  }
  return result ;
}
...
void categoryMethod_generateAtPath (const GALGAS_XcodeProjectDescriptor inObject,
                                    ...
                                    C_Compiler * inCompiler
                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_contents = GALGAS_string (filewrapperTemplate_xcodeProjectGenerationFilewrapper_xcodeproj (inCompiler, inObject.mAttribute_mProjectObjectReference, inObject.mAttribute_mMainGroupReference, inObject.mAttribute_mGroupList, inObject.mAttribute_mMainGroupChildrenRefs, inObject.mAttribute_mMachOTargetList, inObject.mAttribute_mCppFileList, inObject.mAttribute_m_5F_M_5F_FileList, inObject.mAttribute_mHeaderFileList, inObject.mAttribute_mBuildFileList, inObject.mAttribute_mDefaultConfigurationRef, inObject.mAttribute_mDefaultConfigurationSettingList, inObject.mAttribute_mProjectBuildConfigurationRef COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 241))) ;
  GALGAS_bool test_0 = constinArgument_inCacheFilePath.reader_fileExists (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 255)) ;
  if (kBoolTrue == test_0.boolEnum ()) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string::constructor_stringWithContentsOfFile (constinArgument_inCacheFilePath, inCompiler  COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 255)).objectCompare (var_contents)) ;
  }
  const enumGalgasBool test_1 = test_0.operator_not (SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 255)).boolEnum () ;
  if (kBoolTrue == test_1) {
    var_contents.method_writeToFile (constinArgument_inCacheFilePath, inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 256)) ;
    var_contents.method_makeDirectoryAndWriteToFile (constinArgument_inPath.add_operation (GALGAS_string ("/project.pbxproj"), inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 257)), inCompiler COMMA_SOURCE_FILE ("XcodeProjectNewGeneration.gSemantics", 257)) ;
  }
}
