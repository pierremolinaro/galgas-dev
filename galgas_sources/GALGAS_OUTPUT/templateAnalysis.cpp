...
//                    december 22th, 2013, at 11h57'19"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_templateInstructionListAnalysis (const GALGAS_templateAnalysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_templateInstructionListAST enumerator_50276 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_50276.hasCurrentObject ()) {
    callCategoryMethod_templateInstructionAnalysis ((const cPtr_templateInstructionAST *) enumerator_50276.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1267)) ;
    enumerator_50276.gotoNextObject () ;
  }
}
...
static void categoryMethod_templateLiteralStringExpressionAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
  cEnumerator_stringlist enumerator_17329 (object->mAttribute_mLiteralStringList, kEnumeration_up) ;
  while (enumerator_17329.hasCurrentObject ()) {
    var_s.dotAssign_operation (enumerator_17329.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (414)) ;
...
static void categoryMethod_templateOptionAccessAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_commandLineOptionMap enumerator_25780 (var_boolOptionMap, kEnumeration_up) ;
    while (enumerator_25780.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_25780.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (647)) COMMA_SOURCE_FILE_AT_LINE (647)).operator_concat (GALGAS_string ("' @bool option;") COMMA_SOURCE_FILE_AT_LINE (647)) COMMA_SOURCE_FILE_AT_LINE (647)) ;
      enumerator_25780.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_25876 (var_uintOptionMap, kEnumeration_up) ;
    while (enumerator_25876.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_25876.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (650)) COMMA_SOURCE_FILE_AT_LINE (650)).operator_concat (GALGAS_string ("' @uint option;") COMMA_SOURCE_FILE_AT_LINE (650)) COMMA_SOURCE_FILE_AT_LINE (650)) ;
      enumerator_25876.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_25974 (var_stringOptionMap, kEnumeration_up) ;
    while (enumerator_25974.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_25974.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (653)) COMMA_SOURCE_FILE_AT_LINE (653)).operator_concat (GALGAS_string ("' @string option;") COMMA_SOURCE_FILE_AT_LINE (653)) COMMA_SOURCE_FILE_AT_LINE (653)) ;
...
static void categoryMethod_templateFunctionCallAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_unifiedTypeMapProxyList enumerator_27386 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_templateExpressionListAST enumerator_27405 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    while (enumerator_27386.hasCurrentObject () && enumerator_27405.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_expression ;
      callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) enumerator_27405.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (686)) ;
      {
      routine_checkAssignmentTypes (enumerator_27386.current_mType (HERE), var_expression.reader_mType (SOURCE_FILE_AT_LINE (687)), enumerator_27405.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (687)) ;
      }
      var_semanticExpressionListForGeneration.addAssign_operation (var_expression COMMA_SOURCE_FILE_AT_LINE (688)) ;
      enumerator_27386.gotoNextObject () ;
      enumerator_27405.gotoNextObject () ;
    }
...
static void categoryMethod_templateClassToTypeOperandAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_bool joker_49142_23 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_49142_22 ; // Joker input parameter
  GALGAS_typeKindEnum joker_49142_21 ; // Joker input parameter
  GALGAS_typedAttributeList joker_49142_20 ; // Joker input parameter
  GALGAS_attributeMap joker_49142_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_49142_18 ; // Joker input parameter
  GALGAS_constructorMap joker_49142_17 ; // Joker input parameter
  GALGAS_readerMap joker_49142_16 ; // Joker input parameter
  GALGAS_modifierMap joker_49142_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_49142_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_49142_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_49142_12 ; // Joker input parameter
  GALGAS_stringlist joker_49142_11 ; // Joker input parameter
  GALGAS_uint joker_49142_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_49142_9 ; // Joker input parameter
  GALGAS_stringset joker_49142_8 ; // Joker input parameter
  GALGAS_lstringlist joker_49142_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_49142_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_49142_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_49142_4 ; // Joker input parameter
  GALGAS_bool joker_49142_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_49142_2 ; // Joker input parameter
  GALGAS_string joker_49142_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mTypeName, joker_49142_23, joker_49142_22, joker_49142_21, joker_49142_20, joker_49142_19, joker_49142_18, joker_49142_17, joker_49142_16, joker_49142_15, joker_49142_14, joker_49142_13, joker_49142_12, joker_49142_11, joker_49142_10, joker_49142_9, joker_49142_8, joker_49142_7, joker_49142_6, joker_49142_5, joker_49142_4, joker_49142_3, joker_49142_2, joker_49142_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1239)) ;
...
static void categoryMethod_templateInstructionForeachAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  cEnumerator_enumerationDescriptorList enumerator_54565 (var_enumerationDescriptor, kEnumeration_up) ;
  while (enumerator_54565.hasCurrentObject ()) {
    {
    var_doVariableMap.modifier_insertKey (GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.operator_concat (enumerator_54565.current_mEnumerationName (HERE) COMMA_SOURCE_FILE_AT_LINE (1354)), var_expression.reader_mLocation (SOURCE_FILE_AT_LINE (1354)) COMMA_SOURCE_FILE_AT_LINE (1354)), enumerator_54565.current_mEnumeratedType (HERE), var_enumeratorCppName.operator_concat (GALGAS_string (".current_") COMMA_SOURCE_FILE_AT_LINE (1356)).operator_concat (enumerator_54565.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1356)) COMMA_SOURCE_FILE_AT_LINE (1356)).operator_concat (GALGAS_string (" (HERE)") COMMA_SOURCE_FILE_AT_LINE (1356)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1353)) ;
    }
