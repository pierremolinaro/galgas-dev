...
void routine_templateInstructionListAnalysis (const GALGAS_templateAnalysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_templateInstructionListAST enumerator_51003 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_51003.hasCurrentObject ()) {
    callCategoryMethod_templateInstructionAnalysis ((const cPtr_templateInstructionAST *) enumerator_51003.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioInstructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1288)) ;
    enumerator_51003.gotoNextObject () ;
  }
}
...
static void categoryMethod_templateReaderCallInExpressionAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_location joker_4109_0 ; // Joker input parameter
    GALGAS_methodQualifier joker_4165_2 ; // Joker input parameter
    GALGAS_string joker_4165_1 ; // Joker input parameter
    var_readerMap.method_searchKey (object->mAttribute_mReaderName, var_kind, var_readerFormalArgumentTypeList, joker_4109_0, var_hasCompilerArgument, var_returnedType, joker_4165_2, joker_4165_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (78)) ;
    ...
    if (kBoolTrue == test_1) {
      var_readerFormalArgumentTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (89)) ;
      ...
      cEnumerator_typedAttributeList enumerator_4559 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (93)), kEnumeration_up) ;
      while (enumerator_4559.hasCurrentObject ()) {
        GALGAS_readerMap var_aMap = enumerator_4559.current_mAttributeTypeProxy (HERE).reader_mReaderMap (inCompiler COMMA_SOURCE_FILE_AT_LINE (94)) ;
        const cMapElement_readerMap * objectArray_4645 = (const cMapElement_readerMap *) var_aMap.readAccessForWithInstruction_hasKey (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (95))) ;
        if (NULL != objectArray_4645) {
          ...
          var_fieldList.addAssign_operation (enumerator_4559.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (101)) COMMA_SOURCE_FILE_AT_LINE (101)) ;
        }
      ...
      if (kBoolTrue == test_2) {
        ...
        if (kBoolTrue == test_4) {
          ...
          while (enumerator_5406.hasCurrentObject ()) {
            var_s.dotAssign_operation (enumerator_5406.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (113)) ;
      ...
      if (kBoolTrue == test_6) {
        ...
        while (enumerator_6094.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_6094.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (130)) COMMA_SOURCE_FILE_AT_LINE (130)) COMMA_SOURCE_FILE_AT_LINE (130)) ;
          ...
          while (enumerator_6162.hasCurrentObject ()) {
            var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_6162.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (132)) COMMA_SOURCE_FILE_AT_LINE (132)) COMMA_SOURCE_FILE_AT_LINE (132)) ;
            enumerator_6162.gotoNextObject () ;
          }
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_6094.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (134)) COMMA_SOURCE_FILE_AT_LINE (134)) COMMA_SOURCE_FILE_AT_LINE (134)) ;
  ...
  if (kBoolTrue == test_11) {
    ...
    cEnumerator_templateExpressionListAST enumerator_7121 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_7153 (var_readerFormalArgumentTypeList, kEnumeration_up) ;
    while (enumerator_7121.hasCurrentObject () && enumerator_7153.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) enumerator_7121.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (153)) ;
      {
      routine_checkAssignmentTypes (enumerator_7153.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (154)), enumerator_7121.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (154)) ;
      }
      ...
      enumerator_7153.gotoNextObject () ;
    }
...
static void categoryMethod_templateConstructorAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  const cMapElement_constructorMap * objectArray_8545 = (const cMapElement_constructorMap *) var_constructorMap.readAccessForWithInstruction_hasKey (object->mAttribute_mConstructorName.reader_string (SOURCE_FILE_AT_LINE (185))) ;
  if (NULL != objectArray_8545) {
      macroValidSharedObject (objectArray_8545, const cMapElement_constructorMap) ;
    var_constructorFormalArgumentTypeList = objectArray_8545->mAttribute_mArgumentTypeList ;
    var_hasCompilerArgument = objectArray_8545->mAttribute_mHasCompilerArgument ;
    var_returnedType = objectArray_8545->mAttribute_mReturnedType ;
  }else{
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_constructorMap enumerator_9026 (var_constructorMap, kEnumeration_up) ;
      while (enumerator_9026.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_9026.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (198)) COMMA_SOURCE_FILE_AT_LINE (198)) COMMA_SOURCE_FILE_AT_LINE (198)) ;
        cEnumerator_unifiedTypeMapProxyList enumerator_9094 (enumerator_9026.current_mArgumentTypeList (HERE), kEnumeration_up) ;
        while (enumerator_9094.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_9094.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (200)) COMMA_SOURCE_FILE_AT_LINE (200)) COMMA_SOURCE_FILE_AT_LINE (200)) ;
          enumerator_9094.gotoNextObject () ;
        }
        var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_9026.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (202)) COMMA_SOURCE_FILE_AT_LINE (202)) COMMA_SOURCE_FILE_AT_LINE (202)) ;
  ...
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_templateExpressionListAST enumerator_10209 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_10246 (var_constructorFormalArgumentTypeList, kEnumeration_up) ;
    while (enumerator_10209.hasCurrentObject () && enumerator_10246.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) enumerator_10209.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, var_exp, inCompiler COMMA_SOURCE_FILE_AT_LINE (224)) ;
      {
      routine_checkAssignmentTypes (enumerator_10246.current_mType (HERE), var_exp.reader_mType (SOURCE_FILE_AT_LINE (225)), enumerator_10209.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (225)) ;
      }
...
static void categoryMethod_templateLiteralStringExpressionAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
  cEnumerator_stringlist enumerator_18056 (object->mAttribute_mLiteralStringList, kEnumeration_up) ;
  while (enumerator_18056.hasCurrentObject ()) {
    var_s.dotAssign_operation (enumerator_18056.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (435)) ;
...
static void categoryMethod_templateOptionAccessAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_commandLineOptionMap enumerator_26507 (var_boolOptionMap, kEnumeration_up) ;
    while (enumerator_26507.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_26507.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (668)) COMMA_SOURCE_FILE_AT_LINE (668)).operator_concat (GALGAS_string ("' @bool option;") COMMA_SOURCE_FILE_AT_LINE (668)) COMMA_SOURCE_FILE_AT_LINE (668)) ;
      enumerator_26507.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_26603 (var_uintOptionMap, kEnumeration_up) ;
    while (enumerator_26603.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_26603.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (671)) COMMA_SOURCE_FILE_AT_LINE (671)).operator_concat (GALGAS_string ("' @uint option;") COMMA_SOURCE_FILE_AT_LINE (671)) COMMA_SOURCE_FILE_AT_LINE (671)) ;
      enumerator_26603.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_26701 (var_stringOptionMap, kEnumeration_up) ;
    while (enumerator_26701.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_26701.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (674)) COMMA_SOURCE_FILE_AT_LINE (674)).operator_concat (GALGAS_string ("' @string option;") COMMA_SOURCE_FILE_AT_LINE (674)) COMMA_SOURCE_FILE_AT_LINE (674)) ;
      enumerator_26701.gotoNextObject () ;
    }
...
static void categoryMethod_templateFunctionCallAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_unifiedTypeMapProxyList enumerator_28113 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_templateExpressionListAST enumerator_28132 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    while (enumerator_28113.hasCurrentObject () && enumerator_28132.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_expression ;
      callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) enumerator_28132.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (707)) ;
      {
      routine_checkAssignmentTypes (enumerator_28113.current_mType (HERE), var_expression.reader_mType (SOURCE_FILE_AT_LINE (708)), enumerator_28132.current_mEndOfExpressionLocation (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (708)) ;
      }
...
static void categoryMethod_templateClassToTypeOperandAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_bool joker_49869_23 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_49869_22 ; // Joker input parameter
  GALGAS_typeKindEnum joker_49869_21 ; // Joker input parameter
  GALGAS_typedAttributeList joker_49869_20 ; // Joker input parameter
  GALGAS_attributeMap joker_49869_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_49869_18 ; // Joker input parameter
  GALGAS_constructorMap joker_49869_17 ; // Joker input parameter
  GALGAS_readerMap joker_49869_16 ; // Joker input parameter
  GALGAS_modifierMap joker_49869_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_49869_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_49869_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_49869_12 ; // Joker input parameter
  GALGAS_stringlist joker_49869_11 ; // Joker input parameter
  GALGAS_uint joker_49869_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_49869_9 ; // Joker input parameter
  GALGAS_stringset joker_49869_8 ; // Joker input parameter
  GALGAS_lstringlist joker_49869_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_49869_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_49869_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_49869_4 ; // Joker input parameter
  GALGAS_bool joker_49869_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_49869_2 ; // Joker input parameter
  GALGAS_string joker_49869_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mTypeName, joker_49869_23, joker_49869_22, joker_49869_21, joker_49869_20, joker_49869_19, joker_49869_18, joker_49869_17, joker_49869_16, joker_49869_15, joker_49869_14, joker_49869_13, joker_49869_12, joker_49869_11, joker_49869_10, joker_49869_9, joker_49869_8, joker_49869_7, joker_49869_6, joker_49869_5, joker_49869_4, joker_49869_3, joker_49869_2, joker_49869_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1260)) ;
...
static void categoryMethod_templateInstructionForeachAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  cEnumerator_enumerationDescriptorList enumerator_55292 (var_enumerationDescriptor, kEnumeration_up) ;
  while (enumerator_55292.hasCurrentObject ()) {
    {
    var_doVariableMap.modifier_insertKey (GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.operator_concat (enumerator_55292.current_mEnumerationName (HERE) COMMA_SOURCE_FILE_AT_LINE (1375)), var_expression.reader_mLocation (SOURCE_FILE_AT_LINE (1375)) COMMA_SOURCE_FILE_AT_LINE (1375)), enumerator_55292.current_mEnumeratedType (HERE), var_enumeratorCppName.operator_concat (GALGAS_string (".current_") COMMA_SOURCE_FILE_AT_LINE (1377)).operator_concat (enumerator_55292.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1377)) COMMA_SOURCE_FILE_AT_LINE (1377)).operator_concat (GALGAS_string (" (HERE)") COMMA_SOURCE_FILE_AT_LINE (1377)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1374)) ;
    }
...
static void categoryMethod_templateInstructionIfAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  cEnumerator_templateInstructionIfBranchListAST enumerator_56953 (object->mAttribute_mTemplateInstructionIfBranchList, kEnumeration_up) ;
  while (enumerator_56953.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_expression ;
    callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) enumerator_56953.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, var_expression, inCompiler COMMA_SOURCE_FILE_AT_LINE (1415)) ;
    ...
    {
    routine_templateInstructionListAnalysis (constinArgument_inAnalysisContext, enumerator_56953.current_mInstructionList (HERE), var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1420)) ;
    }
    ...
    enumerator_56953.gotoNextObject () ;
  }
...
static void categoryMethod_templateInstructionSwitchAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  cEnumerator_templateInstructionSwitchBranchListAST enumerator_58795 (object->mAttribute_mTemplateInstructionSwitchBranchList, kEnumeration_up) ;
  while (enumerator_58795.hasCurrentObject ()) {
    cEnumerator_lstringlist enumerator_58824 (enumerator_58795.current_mConstantList (HERE), kEnumeration_up) ;
    while (enumerator_58824.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantSet.reader_hasKey (enumerator_58824.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1451)) COMMA_SOURCE_FILE_AT_LINE (1451)).operator_not (SOURCE_FILE_AT_LINE (1451)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_location location_2 (enumerator_58824.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (enumerator_58824.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1452)) COMMA_SOURCE_FILE_AT_LINE (1452)).operator_concat (GALGAS_string ("' is not a contant of '@") COMMA_SOURCE_FILE_AT_LINE (1452)).operator_concat (var_switchExpression.reader_mType (SOURCE_FILE_AT_LINE (1452)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1452)) COMMA_SOURCE_FILE_AT_LINE (1452)).operator_concat (GALGAS_string ("' enumeration type") COMMA_SOURCE_FILE_AT_LINE (1452)) COMMA_SOURCE_FILE_AT_LINE (1452)) ;
      }
      const enumGalgasBool test_3 = var_namedConstantSet.reader_hasKey (enumerator_58824.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1454)) COMMA_SOURCE_FILE_AT_LINE (1454)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_58824.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the '").operator_concat (enumerator_58824.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1455)) COMMA_SOURCE_FILE_AT_LINE (1455)).operator_concat (GALGAS_string ("' constant is already named in the switch instruction") COMMA_SOURCE_FILE_AT_LINE (1455)) COMMA_SOURCE_FILE_AT_LINE (1455)) ;
      }
      var_namedConstantSet.addAssign_operation (enumerator_58824.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1457)) COMMA_SOURCE_FILE_AT_LINE (1457)) ;
      enumerator_58824.gotoNextObject () ;
    }
    ...
    {
    routine_templateInstructionListAnalysis (constinArgument_inAnalysisContext, enumerator_58795.current_mInstructionList (HERE), var_instructionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1460)) ;
    }
    var_templateInstructionSwitchBranchList.addAssign_operation (enumerator_58795.current_mConstantList (HERE), var_instructionList COMMA_SOURCE_FILE_AT_LINE (1461)) ;
  ...
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_stringset enumerator_59808 (var_missingConstants, kEnumeration_up) ;
    while (enumerator_59808.hasCurrentObject ()) {
      var_m.dotAssign_operation (GALGAS_string ("\n"
        "  - '").operator_concat (enumerator_59808.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (1468)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1468)) COMMA_SOURCE_FILE_AT_LINE (1468)) ;
      enumerator_59808.gotoNextObject () ;
    }
