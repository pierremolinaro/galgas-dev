...
//                                         september 24th, 2014, at 18h29'22"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateClassToTypeOperandAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_stringset joker_49358_9 ; // Joker input parameter
...
static void categoryMethod_templateInstructionSwitchAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  GALGAS_stringset var_enumConstantSet = var_switchExpression.reader_mType (SOURCE_FILE ("templateAnalysis.gSemantics", 1415)).reader_mEnumConstantSet (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1415)) ;
  ...
  cEnumerator_templateInstructionSwitchBranchListAST enumerator_58286 (object->mAttribute_mTemplateInstructionSwitchBranchList, kEnumeration_up) ;
  while (enumerator_58286.hasCurrentObject ()) {
    cEnumerator_lstringlist enumerator_58315 (enumerator_58286.current_mConstantList (HERE), kEnumeration_up) ;
    while (enumerator_58315.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantSet.reader_hasKey (enumerator_58315.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1421)) COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1421)).operator_not (SOURCE_FILE ("templateAnalysis.gSemantics", 1421)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_location location_2 (enumerator_58315.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (enumerator_58315.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1422))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422)).operator_concat (GALGAS_string ("' is not a contant of '@")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422)).operator_concat (var_switchExpression.reader_mType (SOURCE_FILE ("templateAnalysis.gSemantics", 1422)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422)).operator_concat (GALGAS_string ("' enumeration type")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422)) ;
      }
      const enumGalgasBool test_3 = var_namedConstantSet.reader_hasKey (enumerator_58315.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1424)) COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1424)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_58315.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the '").operator_concat (enumerator_58315.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1425))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1425)).operator_concat (GALGAS_string ("' constant is already named in the switch instruction")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1425))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1425)) ;
      }
      var_namedConstantSet.addAssign_operation (enumerator_58315.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1427))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1427)) ;
      enumerator_58315.gotoNextObject () ;
    }
    ...
    {
    routine_templateInstructionListAnalysis (constinArgument_inAnalysisContext, enumerator_58286.current_mInstructionList (HERE), var_instructionList, inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1430)) ;
    }
    var_templateInstructionSwitchBranchList.addAssign_operation (enumerator_58286.current_mConstantList (HERE), var_instructionList  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1431)) ;
    enumerator_58286.gotoNextObject () ;
  }
  GALGAS_stringset var_missingConstants = var_enumConstantSet.substract_operation (var_namedConstantSet, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1434)) ;
  ...
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_stringset enumerator_59299 (var_missingConstants, kEnumeration_up) ;
    while (enumerator_59299.hasCurrentObject ()) {
      var_m.dotAssign_operation (GALGAS_string ("\n"
        "  - '").operator_concat (enumerator_59299.current_key (HERE)  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1438)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1438))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1438)) ;
      enumerator_59299.gotoNextObject () ;
    }
