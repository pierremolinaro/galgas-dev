...
void routine_templateInstructionListAnalysis (const GALGAS_templateAnalysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_templateInstructionListAST enumerator_51015 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_51015.hasCurrentObject ()) {
    callCategoryMethod_templateInstructionAnalysis ((const cPtr_templateInstructionAST *) enumerator_51015.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioInstructionList, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1264)) ;
    enumerator_51015.gotoNextObject () ;
  }
}
...
static void categoryMethod_structFieldAccessTemplateExpressionAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mExpression.ptr (), constinArgument_inAnalysisContext, var_expression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 925)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_type = var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 927)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 928)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE ("templateAnalysis.gSemantics", 928)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mStructFieldName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '.' operator requires the receiver to be a struct")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 929)) ;
  }
  GALGAS_attributeMap var_attributeMap = var_type.reader_mAttributeMap (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 931)) ;
  var_attributeMap.method_searchKey (object->mAttribute_mStructFieldName, var_type, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 932)) ;
  outArgument_outExpression = GALGAS_structFieldAccessExpressionForGeneration::constructor_new (var_type, object->mAttribute_mOperatorLocation, var_expression, object->mAttribute_mStructFieldName.mAttribute_string  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 941)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 959)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 962)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 964)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 965)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 966)).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 966)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 966)).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 966)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 968)).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 968))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 968)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 968)).operator_concat (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 968)).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 968))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 968)).operator_concat (GALGAS_string ("': '==' operator requires the types are the same")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 968))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 967)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    outArgument_outExpression = GALGAS_equalExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 973)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateNonEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 990)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 993)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 995)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 996)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 997)).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 997)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 997)).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 997)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 999))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 999)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 999)).operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 999))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 999)).operator_concat (GALGAS_string ("': '!=' operator requires the types are the same")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 999))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 998)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    outArgument_outExpression = GALGAS_notEqualExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1004)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateStrictInfTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1021)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1024)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1026)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1027)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1028)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1028)) COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1028)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1030))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1030)).operator_concat (GALGAS_string ("' and does not support the '<' operator")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1030))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1029)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1033)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1033)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1035))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1035)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1035)).operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1035))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1035)).operator_concat (GALGAS_string ("': '<' operator requires the types are the same")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1035))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1034)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_strictLowerExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1040)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateInfOrEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1057)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1060)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1062)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1063)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1064)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1064)) COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1064)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1066))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1066)).operator_concat (GALGAS_string ("' and does not support the '<=' operator")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1066))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1065)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1069)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1069)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1071))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1071)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1071)).operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1071))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1071)).operator_concat (GALGAS_string ("': '<=' operator requires the types are the same")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1071))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1070)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_lowerOrEqualExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1076)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateStrictSupTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1093)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1096)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1098)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1099)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1100)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1100)) COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1100)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1102))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1102)).operator_concat (GALGAS_string ("' and does not support the '>' operator")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1102))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1101)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1105)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1105)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1107))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1107)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1107)).operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1107))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1107)).operator_concat (GALGAS_string ("': '>' operator requires the types are the same")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1107))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1106)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_strictGreaterExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1112)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateSupOrEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1129)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1132)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1134)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1135)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1136)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1136)) COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1136)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1138))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1138)).operator_concat (GALGAS_string ("' and does not support the '>=' operator")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1138))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1137)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1141)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1141)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1143))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1143)).operator_concat (GALGAS_string ("', right operand type is '@")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1143)).operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1143))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1143)).operator_concat (GALGAS_string ("': '>=' operator requires the types are the same")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1143))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1142)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_greaterOrEqualExpressionForGeneration::constructor_new (constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mBoolType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1148)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateLeftShiftOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1165)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1168)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1170)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1171)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1172)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1172)) COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1172)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1174))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1174)).operator_concat (GALGAS_string ("' and does not support a shift operator")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1174))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1173)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1177)).objectCompare (GALGAS_string ("uint"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("for a shift operator, right operand type should be '@uint': it is '@").operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1179))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1179)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1179))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1178)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_leftShiftExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1184)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateRightShiftOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_leftExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mLeftExpression.ptr (), constinArgument_inAnalysisContext, var_leftExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1201)) ;
  GALGAS_semanticExpressionForGeneration var_rightExpression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mRightExpression.ptr (), constinArgument_inAnalysisContext, var_rightExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1204)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1206)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1207)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1208)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1208)) COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1208)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("left operand type is '@").operator_concat (var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1210))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1210)).operator_concat (GALGAS_string ("' and does not support a shift operator")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1210))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1209)) ;
    outArgument_outExpression.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1213)).objectCompare (GALGAS_string ("uint"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->emitSemanticError (object->mAttribute_mOperatorLocation, GALGAS_string ("for a shift operator, right operand type should be '@uint': it is '@").operator_concat (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1215))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1215)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1215))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1214)) ;
      outArgument_outExpression.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      outArgument_outExpression = GALGAS_rightShiftExpressionForGeneration::constructor_new (var_leftType, object->mAttribute_mOperatorLocation, var_leftExpression, var_rightExpression  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1220)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateClassToTypeOperandAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_bool joker_49881_26 ; // Joker input parameter
  GALGAS_bool joker_49881_25 ; // Joker input parameter
  GALGAS_unifiedTypeMap_2D_proxy joker_49881_24 ; // Joker input parameter
  GALGAS_typeKindEnum joker_49881_23 ; // Joker input parameter
  GALGAS_bool joker_49881_22 ; // Joker input parameter
  GALGAS_typedAttributeList joker_49881_21 ; // Joker input parameter
  GALGAS_attributeMap joker_49881_20 ; // Joker input parameter
  GALGAS_typedAttributeList joker_49881_19 ; // Joker input parameter
  GALGAS_constructorMap joker_49881_18 ; // Joker input parameter
  GALGAS_readerMap joker_49881_17 ; // Joker input parameter
  GALGAS_modifierMap joker_49881_16 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_49881_15 ; // Joker input parameter
  GALGAS_classMethodMap joker_49881_14 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_49881_13 ; // Joker input parameter
  GALGAS_stringlist joker_49881_12 ; // Joker input parameter
  GALGAS_uint joker_49881_11 ; // Joker input parameter
  GALGAS_functionSignature joker_49881_10 ; // Joker input parameter
  GALGAS_constantIndexMap joker_49881_9 ; // Joker input parameter
  GALGAS_enumConstantList joker_49881_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_49881_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_49881_6 ; // Joker input parameter
  GALGAS_bool joker_49881_5 ; // Joker input parameter
  GALGAS_unifiedTypeMap_2D_proxy joker_49881_4 ; // Joker input parameter
  GALGAS_string joker_49881_3 ; // Joker input parameter
  GALGAS_string joker_49881_2 ; // Joker input parameter
  GALGAS_headerKind joker_49881_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mTypeName, joker_49881_26, joker_49881_25, joker_49881_24, joker_49881_23, joker_49881_22, joker_49881_21, joker_49881_20, joker_49881_19, joker_49881_18, joker_49881_17, joker_49881_16, joker_49881_15, joker_49881_14, joker_49881_13, joker_49881_12, joker_49881_11, joker_49881_10, joker_49881_9, joker_49881_8, joker_49881_7, joker_49881_6, joker_49881_5, joker_49881_4, joker_49881_3, joker_49881_2, joker_49881_1, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1236)) ;
  outArgument_outExpression = GALGAS_literalTypeInExpressionForGeneration::constructor_new (GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("type"), inCompiler->here ()  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1239)), inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1239)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("templateAnalysis.gSemantics", 1240)), object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1241))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1238)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateInstructionStringAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_templateInstructionStringForGeneration::constructor_new (object->mAttribute_mTemplateString  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1274))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1274)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateInstructionExpressionAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mExpression.ptr (), constinArgument_inAnalysisContext, var_expression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1284)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1285)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1285)).objectCompare (GALGAS_string ("string"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mLocation, GALGAS_string ("expression type should be '@string' (it is '@").operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1286)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1286))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1286)).operator_concat (GALGAS_string ("')")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1286))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1286)) ;
  }
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_templateInstructionExpressionForGeneration::constructor_new (var_expression  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1288))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1288)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateBlockInstructionAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mExpression.ptr (), constinArgument_inAnalysisContext, var_expression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1298)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1299)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1299)).objectCompare (GALGAS_string ("uint"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mLocation, GALGAS_string ("expression type should be '@uint' (it is '@").operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1300)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1300))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1300)).operator_concat (GALGAS_string ("')")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1300))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1300)) ;
  }
  GALGAS_templateInstructionListForGeneration var_blockInstructionList = GALGAS_templateInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("templateAnalysis.gSemantics", 1302)) ;
  {
  routine_templateInstructionListAnalysis (constinArgument_inAnalysisContext, object->mAttribute_mBlockInstructionList, var_blockInstructionList, inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1303)) ;
  }
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_templateBlockInstructionForGeneration::constructor_new (var_expression, object->mAttribute_mLocation, var_blockInstructionList  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1304))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1304)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateInstructionGetColumnLocationAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * /* inObject */,
                                                                                                ...
                                                                                                C_Compiler * /* inCompiler */
                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_templateInstructionGetColumnLocationForGeneration::constructor_new (SOURCE_FILE ("templateAnalysis.gSemantics", 1313))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1313)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateInstructionGotoColumnLocationAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * /* inObject */,
                                                                                                 ...
                                                                                                 C_Compiler * /* inCompiler */
                                                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_templateInstructionGotoColumnLocationForGeneration::constructor_new (SOURCE_FILE ("templateAnalysis.gSemantics", 1322))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1322)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateInstructionForeachAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  GALGAS_semanticExpressionForGeneration var_expression ;
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mExpression.ptr (), constinArgument_inAnalysisContext, var_expression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1333)) ;
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1335)).reader_mEnumerationDescriptor (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1335)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_enumerationDescriptor.reader_length (SOURCE_FILE ("templateAnalysis.gSemantics", 1336)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (var_expression.reader_mLocation (SOURCE_FILE ("templateAnalysis.gSemantics", 1337)), GALGAS_string ("expression of '@").operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1337)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1337))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1337)).operator_concat (GALGAS_string ("' cannot be enumerated")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1337))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1337)) ;
  }
  GALGAS_templateInstructionListForGeneration var_beforeInstructionList = GALGAS_templateInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("templateAnalysis.gSemantics", 1340)) ;
  {
  routine_templateInstructionListAnalysis (constinArgument_inAnalysisContext, object->mAttribute_mBeforeInstructionList, var_beforeInstructionList, inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1341)) ;
  }
  GALGAS_string var_enumeratorCppName = GALGAS_string ("enumerator_").operator_concat (object->mAttribute_mIndexIdentifier.reader_location (SOURCE_FILE ("templateAnalysis.gSemantics", 1343)).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1343)).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1343))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1343)) ;
  GALGAS_templateVariableMap var_doVariableMap = constinArgument_inAnalysisContext.mAttribute_mTemplateVariableMap ;
  GALGAS_string var_cppIndexVarName = GALGAS_string ("index_").operator_concat (object->mAttribute_mIndexIdentifier.reader_location (SOURCE_FILE ("templateAnalysis.gSemantics", 1345)).reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1345)).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1345))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1345)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1345)).operator_concat (object->mAttribute_mIndexIdentifier.reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1345)).reader_identifierRepresentation (SOURCE_FILE ("templateAnalysis.gSemantics", 1345))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1345)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, object->mAttribute_mIndexIdentifier.reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1346)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    var_doVariableMap.modifier_insertKey (object->mAttribute_mIndexIdentifier, constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes.mAttribute_mUIntType, var_cppIndexVarName, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1347)) ;
    }
  }
  cEnumerator_enumerationDescriptorList enumerator_55340 (var_enumerationDescriptor, kEnumeration_up) ;
  while (enumerator_55340.hasCurrentObject ()) {
    {
    var_doVariableMap.modifier_insertKey (GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.operator_concat (enumerator_55340.current_mEnumerationName (HERE)  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1351)), var_expression.reader_mLocation (SOURCE_FILE ("templateAnalysis.gSemantics", 1351))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1351)), enumerator_55340.current_mEnumeratedType (HERE), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1353)).operator_concat (enumerator_55340.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("templateAnalysis.gSemantics", 1353))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1353)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1353)), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1350)) ;
    }
    enumerator_55340.gotoNextObject () ;
  }
  GALGAS_templateAnalysisContext var_doAnalysisContext = GALGAS_templateAnalysisContext::constructor_new (constinArgument_inAnalysisContext.mAttribute_mSemanticContext, constinArgument_inAnalysisContext.mAttribute_mPredefinedTypes, var_doVariableMap  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1356)) ;
  GALGAS_templateInstructionListForGeneration var_doInstructionList = GALGAS_templateInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("templateAnalysis.gSemantics", 1361)) ;
  {
  routine_templateInstructionListAnalysis (var_doAnalysisContext, object->mAttribute_mDoInstructionList, var_doInstructionList, inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1362)) ;
  }
  GALGAS_templateInstructionListForGeneration var_betweenInstructionList = GALGAS_templateInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("templateAnalysis.gSemantics", 1364)) ;
  {
  routine_templateInstructionListAnalysis (constinArgument_inAnalysisContext, object->mAttribute_mBetweenInstructionList, var_betweenInstructionList, inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1365)) ;
  }
  GALGAS_templateInstructionListForGeneration var_afterInstructionList = GALGAS_templateInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("templateAnalysis.gSemantics", 1367)) ;
  {
  routine_templateInstructionListAnalysis (constinArgument_inAnalysisContext, object->mAttribute_mAfterInstructionList, var_afterInstructionList, inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1368)) ;
  }
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_templateInstructionForeachForGeneration::constructor_new (object->mAttribute_mIsAscending, var_expression, var_enumeratorCppName, var_beforeInstructionList, var_doInstructionList, var_cppIndexVarName, var_betweenInstructionList, var_afterInstructionList  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1370))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1370)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateInstructionIfAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  GALGAS_templateInstructionIfBranchListForGeneration var_templateInstructionIfBranchList = GALGAS_templateInstructionIfBranchListForGeneration::constructor_emptyList (SOURCE_FILE ("templateAnalysis.gSemantics", 1388)) ;
  cEnumerator_templateInstructionIfBranchListAST enumerator_57004 (object->mAttribute_mTemplateInstructionIfBranchList, kEnumeration_up) ;
  while (enumerator_57004.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_expression ;
    callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) enumerator_57004.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, var_expression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1391)) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1392)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1392)).objectCompare (GALGAS_string ("bool"))).boolEnum () ;
    if (kBoolTrue == test_0) {
      inCompiler->emitSemanticError (var_expression.reader_mLocation (SOURCE_FILE ("templateAnalysis.gSemantics", 1393)), GALGAS_string ("'if' expression type should be '@bool' (it is '@").operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1393)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1393))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1393)).operator_concat (GALGAS_string ("')")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1393))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1393)) ;
    }
    GALGAS_templateInstructionListForGeneration var_instructionList = GALGAS_templateInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("templateAnalysis.gSemantics", 1395)) ;
    {
    routine_templateInstructionListAnalysis (constinArgument_inAnalysisContext, enumerator_57004.current_mInstructionList (HERE), var_instructionList, inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1396)) ;
    }
    var_templateInstructionIfBranchList.addAssign_operation (var_expression, var_instructionList  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1397)) ;
    enumerator_57004.gotoNextObject () ;
  }
  GALGAS_templateInstructionListForGeneration var_elseInstructionList = GALGAS_templateInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("templateAnalysis.gSemantics", 1400)) ;
  {
  routine_templateInstructionListAnalysis (constinArgument_inAnalysisContext, object->mAttribute_mElseInstructionList, var_elseInstructionList, inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1401)) ;
  }
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_templateInstructionIfForGeneration::constructor_new (var_templateInstructionIfBranchList, var_elseInstructionList  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1403))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1403)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateInstructionSwitchAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) object->mAttribute_mSwitchExpression.ptr (), constinArgument_inAnalysisContext, var_switchExpression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1417)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_switchExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1418)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1418)).objectCompare (GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE ("templateAnalysis.gSemantics", 1418)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (var_switchExpression.reader_mLocation (SOURCE_FILE ("templateAnalysis.gSemantics", 1419)), GALGAS_string ("'switch' expression type should be an enumeration (it is a ").operator_concat (categoryReader_kind (var_switchExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1419)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1419)), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1419))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1419)).operator_concat (GALGAS_string (" type)")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1419))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1419)) ;
  }
  GALGAS_constantIndexMap var_enumConstantMap = var_switchExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1421)).reader_mEnumConstantMap (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1421)) ;
  GALGAS_templateInstructionSwitchBranchListForGeneration var_templateInstructionSwitchBranchList = GALGAS_templateInstructionSwitchBranchListForGeneration::constructor_emptyList (SOURCE_FILE ("templateAnalysis.gSemantics", 1423)) ;
  GALGAS_stringset var_namedConstantSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("templateAnalysis.gSemantics", 1424)) ;
  cEnumerator_templateInstructionSwitchBranchListAST enumerator_58865 (object->mAttribute_mTemplateInstructionSwitchBranchList, kEnumeration_up) ;
  while (enumerator_58865.hasCurrentObject ()) {
    cEnumerator_lstringlist enumerator_58894 (enumerator_58865.current_mConstantList (HERE), kEnumeration_up) ;
    while (enumerator_58894.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantMap.reader_hasKey (enumerator_58894.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1427)) COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1427)).operator_not (SOURCE_FILE ("templateAnalysis.gSemantics", 1427)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_location location_2 (enumerator_58894.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (enumerator_58894.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1428))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1428)).operator_concat (GALGAS_string ("' is not a contant of '@")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1428)).operator_concat (var_switchExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1428)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1428))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1428)).operator_concat (GALGAS_string ("' enumeration type")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1428))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1428)) ;
      }
      const enumGalgasBool test_3 = var_namedConstantSet.reader_hasKey (enumerator_58894.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1430)) COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1430)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_58894.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the '").operator_concat (enumerator_58894.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1431))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1431)).operator_concat (GALGAS_string ("' constant is already named in the switch instruction")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1431))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1431)) ;
      }
      var_namedConstantSet.addAssign_operation (enumerator_58894.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1433))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1433)) ;
      enumerator_58894.gotoNextObject () ;
    }
    GALGAS_templateInstructionListForGeneration var_instructionList = GALGAS_templateInstructionListForGeneration::constructor_emptyList (SOURCE_FILE ("templateAnalysis.gSemantics", 1435)) ;
    {
    routine_templateInstructionListAnalysis (constinArgument_inAnalysisContext, enumerator_58865.current_mInstructionList (HERE), var_instructionList, inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1436)) ;
    }
    var_templateInstructionSwitchBranchList.addAssign_operation (enumerator_58865.current_mConstantList (HERE), var_instructionList  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1437)) ;
    enumerator_58865.gotoNextObject () ;
  }
  GALGAS_stringset var_missingConstants = var_enumConstantMap.reader_keySet (SOURCE_FILE ("templateAnalysis.gSemantics", 1440)).substract_operation (var_namedConstantSet, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1440)) ;
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, var_missingConstants.reader_count (SOURCE_FILE ("templateAnalysis.gSemantics", 1441)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_stringset enumerator_59893 (var_missingConstants, kEnumeration_up) ;
    while (enumerator_59893.hasCurrentObject ()) {
      var_m.dotAssign_operation (GALGAS_string ("\n"
        "  - '").operator_concat (enumerator_59893.current_key (HERE)  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1444)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1444))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1444)) ;
      enumerator_59893.gotoNextObject () ;
    }
    inCompiler->emitSemanticError (object->mAttribute_mSwitchExpressionEndLocation, var_m  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1446)) ;
  }
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_templateInstructionSwitchForGeneration::constructor_new (var_switchExpression, var_templateInstructionSwitchBranchList  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1449))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1449)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
