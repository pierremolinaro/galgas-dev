...
void GGS_templateVariableMap::modifier_insertFakeKey (C_CompilerEx & inCompiler,
...
category_method__templateClassToTypeOperandAST__templateExpressionAnalysis (C_CompilerEx & inLexique,
  ...
  if (operand_49267 != NULL) {
    ...
    GGS_stringset  automatic_var_49481_14 ;
    GGS_lstringlist  automatic_var_49481_15 ;
    GGS_mapSearchMethodListAST  automatic_var_49481_16 ;
    GGS_mapSearchMethodListAST  automatic_var_49481_17 ;
    GGS_withAccessorMap  automatic_var_49481_18 ;
    GGS_bool automatic_var_49481_19 ;
    if (var_cas_inAnalysisContext.mSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_inAnalysisContext.mSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_49267->mTypeName, automatic_var_49481_0, automatic_var_49481_1, automatic_var_49481_2, automatic_var_49481_3, automatic_var_49481_4, automatic_var_49481_5, automatic_var_49481_6, automatic_var_49481_7, automatic_var_49481_8, automatic_var_49481_9, automatic_var_49481_10, automatic_var_49481_11, automatic_var_49481_12, automatic_var_49481_13, automatic_var_49481_14, automatic_var_49481_15, automatic_var_49481_16, automatic_var_49481_17, automatic_var_49481_18, automatic_var_49481_19 COMMA_SOURCE_FILE_AT_LINE (1240)) ;
    }
...
category_method__templateInstructionIfAST__templateInstructionAnalysis (C_CompilerEx & inLexique,
                                const cPtr_templateInstructionIfAST * operand_56314,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_templateInstructionListForGeneration  & var_cas_ioInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_56314 != NULL) {
    ...
    {
      GGS_templateInstructionIfBranchListAST::cEnumerator enumerator_56560 (operand_56314->mTemplateInstructionIfBranchList, true) ;
      const GGS_templateInstructionIfBranchListAST::cElement * operand_56560 = NULL ;
      while (((operand_56560 = enumerator_56560.nextObject ()))) {
        macroValidPointer (operand_56560) ;
        GGS_semanticExpressionForGeneration  var_cas_expression ;
        { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_56560->mExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_56560->mExpression (HERE), var_cas_inAnalysisContext, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (1395)) ;
          }
        }
        const GGS_bool cond_56870 = (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1396)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1396))).operator_isNotEqual (GGS_string ("bool")) ;
        if (cond_56870.isBuiltAndTrue ()) {
        ...
        ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_56560->mInstructionList,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1400)) ;
    ...
    ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_56314->mElseInstructionList,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (1405)) ;
...
category_method__templateInstructionSwitchAST__templateInstructionAnalysis (C_CompilerEx & inLexique,
                                const cPtr_templateInstructionSwitchAST * operand_57609,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_templateInstructionListForGeneration  & var_cas_ioInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57609 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_switchExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_57609->mSwitchExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_57609->mSwitchExpression (HERE), var_cas_inAnalysisContext, var_cas_switchExpression COMMA_SOURCE_FILE_AT_LINE (1421)) ;
      }
    }
    const GGS_bool cond_58116 = (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1422)).reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1422))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1422))) ;
    if (cond_58116.isBuiltAndTrue ()) {
    ...
    {
      GGS_templateInstructionSwitchBranchListAST::cEnumerator enumerator_58402 (operand_57609->mTemplateInstructionSwitchBranchList, true) ;
      const GGS_templateInstructionSwitchBranchListAST::cElement * operand_58402 = NULL ;
      while (((operand_58402 = enumerator_58402.nextObject ()))) {
        macroValidPointer (operand_58402) ;
        {
          GGS_lstringlist::cEnumerator enumerator_58431 (operand_58402->mConstantList, true) ;
          const GGS_lstringlist::cElement * operand_58431 = NULL ;
          while (((operand_58431 = enumerator_58431.nextObject ()))) {
            macroValidPointer (operand_58431) ;
            const GGS_bool cond_58631 = (var_cas_enumConstantSet.reader_hasKey (operand_58431->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1431)))).operator_not () ;
            if (cond_58631.isBuiltAndTrue ()) {
              operand_58431->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (operand_58431->mValue)).operator_concat (GGS_string ("' is not a contant of '@"))).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1432)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1432)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1433)) ;
            }
            const GGS_bool cond_58803 = var_cas_namedConstantSet.reader_hasKey (operand_58431->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1434))) ;
            if (cond_58803.isBuiltAndTrue ()) {
              operand_58431->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_58431->mValue)).operator_concat (GGS_string ("' constant is already named in the switch instruction")) COMMA_SOURCE_FILE_AT_LINE (1436)) ;
            }
            var_cas_namedConstantSet.addAssign_operation (operand_58431->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1437))) ;
          }
        }
        GGS_templateInstructionListForGeneration  var_cas_instructionList = GGS_templateInstructionListForGeneration ::constructor_emptyList () ;
        ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_58402->mInstructionList,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1440)) ;
        var_cas_templateInstructionSwitchBranchList.addAssign_operation (operand_58402->mConstantList, var_cas_instructionList) ;
      }
    }
    ...
    const GGS_bool cond_59498 = (var_cas_missingConstants.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_59498.isBuiltAndTrue ()) {
      ...
      {
        GGS_stringset::cEnumerator enumerator_59415 (var_cas_missingConstants, true) ;
        while (enumerator_59415.hasCurrentObject ()) {
          var_cas_m.appendCString ("\n"
            "  - '") ;
          var_cas_m.dotAssign_operation (enumerator_59415._key (HERE)) ;
          var_cas_m.appendCString ("'") ;
          enumerator_59415.next () ;
        }
      }
