...
category_method__templateVarInExpressionAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateVarInExpressionAST * operand_29624,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_29624 != NULL) {
    ...
    if (var_cas_inAnalysisContext.mTemplateVariableMap.isBuilt ()) {
      var_cas_inAnalysisContext.mTemplateVariableMap (HERE)->method_searchKey (inLexique, operand_29624->mVarName, var_cas_type, var_cas_sourceVariableCppName COMMA_SOURCE_FILE_AT_LINE (737)) ;
    }
    {
      GGS_lstringlist::cEnumerator enumerator_29961 (operand_29624->mStructAttributeList, true) ;
      const GGS_lstringlist::cElement * operand_29961 = NULL ;
      while (((operand_29961 = enumerator_29961.nextObject ()))) {
        macroValidPointer (operand_29961) ;
        const GGS_attributeMap  var_cas_attributeMap = var_cas_type.reader_mAttributeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (739)) ;
        if (var_cas_attributeMap.isBuilt ()) {
          var_cas_attributeMap (HERE)->method_searchKey (inLexique, operand_29961->mValue, var_cas_type COMMA_SOURCE_FILE_AT_LINE (740)) ;
        }
      }
    }
    var_cas_outExpression = GGS_varInExpressionForGeneration ::constructor_new (inLexique, var_cas_type, operand_29624->mVarName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (744)), var_cas_sourceVariableCppName, var_cas_sourceVariableCppName, operand_29624->mStructAttributeList COMMA_SOURCE_FILE_AT_LINE (742)) ;
  }
}
...
category_method__templateAddOperationAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateAddOperationAST * operand_30580,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_30580 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_leftExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_30580->mLeftExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_30580->mLeftExpression (HERE), var_cas_inAnalysisContext, var_cas_leftExpression COMMA_SOURCE_FILE_AT_LINE (761)) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_rightExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_30580->mRightExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_30580->mRightExpression (HERE), var_cas_inAnalysisContext, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (764)) ;
      }
    }
    const GGS_unifiedTypeMapProxy  var_cas_leftType = var_cas_leftExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (766)) ;
    ::routine_checkDiadicOperator (inLexique,  var_cas_leftType,  var_cas_rightExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (769)),  ((var_cas_leftType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (770))).operator_and (function_binaryAddOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (770)))).operator_isNotEqual (GGS_uint (0U)),  GGS_string ("+"),  operand_30580->mOperatorLocation,  var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (767)) ;
    var_cas_outExpression = GGS_addExpressionForGeneration ::constructor_new (inLexique, var_cas_leftType, operand_30580->mOperatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (776)) ;
  }
}
...
category_method__templateSubOperationAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateSubOperationAST * operand_31785,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_31785 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_leftExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_31785->mLeftExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_31785->mLeftExpression (HERE), var_cas_inAnalysisContext, var_cas_leftExpression COMMA_SOURCE_FILE_AT_LINE (794)) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_rightExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_31785->mRightExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_31785->mRightExpression (HERE), var_cas_inAnalysisContext, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (797)) ;
      }
    }
    const GGS_unifiedTypeMapProxy  var_cas_leftType = var_cas_leftExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (799)) ;
    ::routine_checkDiadicOperator (inLexique,  var_cas_leftType,  var_cas_rightExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (802)),  ((var_cas_leftType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (803))).operator_and (function_binarySubOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (803)))).operator_isNotEqual (GGS_uint (0U)),  GGS_string ("-"),  operand_31785->mOperatorLocation,  var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (800)) ;
    var_cas_outExpression = GGS_subExpressionForGeneration ::constructor_new (inLexique, var_cas_leftType, operand_31785->mOperatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (809)) ;
  }
}
...
category_method__templateMultiplyOperationAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateMultiplyOperationAST * operand_32995,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_32995 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_leftExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_32995->mLeftExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_32995->mLeftExpression (HERE), var_cas_inAnalysisContext, var_cas_leftExpression COMMA_SOURCE_FILE_AT_LINE (827)) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_rightExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_32995->mRightExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_32995->mRightExpression (HERE), var_cas_inAnalysisContext, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (830)) ;
      }
    }
    const GGS_unifiedTypeMapProxy  var_cas_leftType = var_cas_leftExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (832)) ;
    ::routine_checkDiadicOperator (inLexique,  var_cas_leftType,  var_cas_rightExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (835)),  ((var_cas_leftType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (836))).operator_and (function_binaryMulOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (836)))).operator_isNotEqual (GGS_uint (0U)),  GGS_string ("*"),  operand_32995->mOperatorLocation,  var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (833)) ;
    var_cas_outExpression = GGS_multiplicationExpressionForGeneration ::constructor_new (inLexique, var_cas_leftType, operand_32995->mOperatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (842)) ;
  }
}
...
category_method__templateDivideOperationAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateDivideOperationAST * operand_34214,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_34214 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_leftExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_34214->mLeftExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_34214->mLeftExpression (HERE), var_cas_inAnalysisContext, var_cas_leftExpression COMMA_SOURCE_FILE_AT_LINE (860)) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_rightExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_34214->mRightExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_34214->mRightExpression (HERE), var_cas_inAnalysisContext, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (863)) ;
      }
    }
    const GGS_unifiedTypeMapProxy  var_cas_leftType = var_cas_leftExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (865)) ;
    ::routine_checkDiadicOperator (inLexique,  var_cas_leftType,  var_cas_rightExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (868)),  ((var_cas_leftType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (869))).operator_and (function_binaryDivOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (869)))).operator_isNotEqual (GGS_uint (0U)),  GGS_string ("/"),  operand_34214->mOperatorLocation,  var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (866)) ;
    var_cas_outExpression = GGS_divisionExpressionForGeneration ::constructor_new (inLexique, var_cas_leftType, operand_34214->mOperatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (875)) ;
  }
}
...
category_method__templateModuloOperationAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateModuloOperationAST * operand_35427,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_35427 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_leftExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_35427->mLeftExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_35427->mLeftExpression (HERE), var_cas_inAnalysisContext, var_cas_leftExpression COMMA_SOURCE_FILE_AT_LINE (893)) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_rightExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_35427->mRightExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_35427->mRightExpression (HERE), var_cas_inAnalysisContext, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (896)) ;
      }
    }
    const GGS_unifiedTypeMapProxy  var_cas_leftType = var_cas_leftExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (898)) ;
    ::routine_checkDiadicOperator (inLexique,  var_cas_leftType,  var_cas_rightExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (901)),  ((var_cas_leftType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (902))).operator_and (function_binaryModOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (902)))).operator_isNotEqual (GGS_uint (0U)),  GGS_string ("mod"),  operand_35427->mOperatorLocation,  var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (899)) ;
    var_cas_outExpression = GGS_moduloExpressionForGeneration ::constructor_new (inLexique, var_cas_leftType, operand_35427->mOperatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (908)) ;
  }
}
...
category_method__templateUnaryMinusOperationAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateUnaryMinusOperationAST * operand_36644,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_36644 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_expression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_36644->mExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_36644->mExpression (HERE), var_cas_inAnalysisContext, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (926)) ;
      }
    }
    const GGS_unifiedTypeMapProxy  var_cas_type = var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (928)) ;
    const GGS_bool cond_37205 = ((var_cas_type.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (929))).operator_and (function_unaryMinusOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (929)))).operator_isEqual (GGS_uint (0U)) ;
    if (cond_37205.isBuiltAndTrue ()) {
      operand_36644->mOperatorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("operand type is '@")).operator_concat (var_cas_type.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (931)))).operator_concat (GGS_string ("' and does not support the unary minus operator")) COMMA_SOURCE_FILE_AT_LINE (934)) ;
      var_cas_outExpression.drop () ;
    }else if (cond_37205.isBuiltAndFalse ()) {
      var_cas_outExpression = GGS_unaryMinusExpressionForGeneration ::constructor_new (inLexique, var_cas_type, operand_36644->mOperatorLocation, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (936)) ;
    }
  }
}
...
category_method__templateEqualTestAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateEqualTestAST * operand_37681,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_37681 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_leftExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_37681->mLeftExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_37681->mLeftExpression (HERE), var_cas_inAnalysisContext, var_cas_leftExpression COMMA_SOURCE_FILE_AT_LINE (954)) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_rightExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_37681->mRightExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_37681->mRightExpression (HERE), var_cas_inAnalysisContext, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (957)) ;
      }
    }
    const GGS_unifiedTypeMapProxy  var_cas_leftType = var_cas_leftExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (959)) ;
    const GGS_unifiedTypeMapProxy  var_cas_rightType = var_cas_rightExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (960)) ;
    const GGS_bool cond_38561 = (var_cas_leftType.reader_lkey (inLexique COMMA_SOURCE_FILE_AT_LINE (961)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (961))).operator_isNotEqual (var_cas_rightType.reader_lkey (inLexique COMMA_SOURCE_FILE_AT_LINE (961)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (961))) ;
    if (cond_38561.isBuiltAndTrue ()) {
      operand_37681->mOperatorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("left operand type is '@")).operator_concat (var_cas_leftType.reader_lkey (inLexique COMMA_SOURCE_FILE_AT_LINE (963)))).operator_concat (GGS_string ("', right operand type is '@"))).operator_concat (var_cas_rightType.reader_lkey (inLexique COMMA_SOURCE_FILE_AT_LINE (963)))).operator_concat (GGS_string ("': '==' operator requires the types are the same")) COMMA_SOURCE_FILE_AT_LINE (966)) ;
      var_cas_outExpression.drop () ;
    }else if (cond_38561.isBuiltAndFalse ()) {
      var_cas_outExpression = GGS_equalExpressionForGeneration ::constructor_new (inLexique, var_cas_inAnalysisContext.mPredefinedTypes.mBoolType, operand_37681->mOperatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (968)) ;
    }
  }
}
...
category_method__templateNonEqualTestAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateNonEqualTestAST * operand_38948,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_38948 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_leftExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_38948->mLeftExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_38948->mLeftExpression (HERE), var_cas_inAnalysisContext, var_cas_leftExpression COMMA_SOURCE_FILE_AT_LINE (985)) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_rightExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_38948->mRightExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_38948->mRightExpression (HERE), var_cas_inAnalysisContext, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (988)) ;
      }
    }
    const GGS_unifiedTypeMapProxy  var_cas_leftType = var_cas_leftExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (990)) ;
    const GGS_unifiedTypeMapProxy  var_cas_rightType = var_cas_rightExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (991)) ;
    const GGS_bool cond_39826 = (var_cas_leftType.reader_lkey (inLexique COMMA_SOURCE_FILE_AT_LINE (992)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (992))).operator_isNotEqual (var_cas_rightType.reader_lkey (inLexique COMMA_SOURCE_FILE_AT_LINE (992)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (992))) ;
    if (cond_39826.isBuiltAndTrue ()) {
      operand_38948->mOperatorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("left operand type is '@")).operator_concat (var_cas_leftType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (994)))).operator_concat (GGS_string ("', right operand type is '@"))).operator_concat (var_cas_rightType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (994)))).operator_concat (GGS_string ("': '!=' operator requires the types are the same")) COMMA_SOURCE_FILE_AT_LINE (997)) ;
      var_cas_outExpression.drop () ;
    }else if (cond_39826.isBuiltAndFalse ()) {
      var_cas_outExpression = GGS_notEqualExpressionForGeneration ::constructor_new (inLexique, var_cas_inAnalysisContext.mPredefinedTypes.mBoolType, operand_38948->mOperatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (999)) ;
    }
  }
}
...
category_method__templateStrictInfTestAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateStrictInfTestAST * operand_40217,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_40217 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_leftExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_40217->mLeftExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_40217->mLeftExpression (HERE), var_cas_inAnalysisContext, var_cas_leftExpression COMMA_SOURCE_FILE_AT_LINE (1016)) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_rightExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_40217->mRightExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_40217->mRightExpression (HERE), var_cas_inAnalysisContext, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1019)) ;
      }
    }
    ...
    const GGS_unifiedTypeMapProxy  var_cas_rightType = var_cas_rightExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1022)) ;
    const GGS_bool cond_41041 = ((var_cas_leftType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (1023))).operator_and (function_isComparable (inLexique COMMA_SOURCE_FILE_AT_LINE (1023)))).operator_isEqual (GGS_uint (0U)) ;
    if (cond_41041.isBuiltAndTrue ()) {
      operand_40217->mOperatorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("left operand type is '@")).operator_concat (var_cas_leftType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1025)))).operator_concat (GGS_string ("' and does not support the '<' operator")) COMMA_SOURCE_FILE_AT_LINE (1028)) ;
      var_cas_outExpression.drop () ;
    }else if (cond_41041.isBuiltAndFalse ()) {
      const GGS_bool cond_41291 = (var_cas_leftType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1028))).operator_isNotEqual (var_cas_rightType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1028))) ;
      if (cond_41291.isBuiltAndTrue ()) {
        operand_40217->mOperatorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("left operand type is '@")).operator_concat (var_cas_leftType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1030)))).operator_concat (GGS_string ("', right operand type is '@"))).operator_concat (var_cas_rightType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1030)))).operator_concat (GGS_string ("': '<' operator requires the types are the same")) COMMA_SOURCE_FILE_AT_LINE (1033)) ;
        var_cas_outExpression.drop () ;
      }else if (cond_41291.isBuiltAndFalse ()) {
        var_cas_outExpression = GGS_strictLowerExpressionForGeneration ::constructor_new (inLexique, var_cas_inAnalysisContext.mPredefinedTypes.mBoolType, operand_40217->mOperatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1035)) ;
      }
    }
  }
}
...
category_method__templateInfOrEqualTestAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateInfOrEqualTestAST * operand_41686,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_41686 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_leftExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_41686->mLeftExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_41686->mLeftExpression (HERE), var_cas_inAnalysisContext, var_cas_leftExpression COMMA_SOURCE_FILE_AT_LINE (1052)) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_rightExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_41686->mRightExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_41686->mRightExpression (HERE), var_cas_inAnalysisContext, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1055)) ;
      }
    }
    ...
    const GGS_bool cond_42511 = ((var_cas_leftType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (1059))).operator_and (function_isComparable (inLexique COMMA_SOURCE_FILE_AT_LINE (1059)))).operator_isEqual (GGS_uint (0U)) ;
    if (cond_42511.isBuiltAndTrue ()) {
      operand_41686->mOperatorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("left operand type is '@")).operator_concat (var_cas_leftType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1061)))).operator_concat (GGS_string ("' and does not support the '<=' operator")) COMMA_SOURCE_FILE_AT_LINE (1064)) ;
      var_cas_outExpression.drop () ;
    }else if (cond_42511.isBuiltAndFalse ()) {
      const GGS_bool cond_42762 = (var_cas_leftType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1064))).operator_isNotEqual (var_cas_rightType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1064))) ;
      if (cond_42762.isBuiltAndTrue ()) {
        operand_41686->mOperatorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("left operand type is '@")).operator_concat (var_cas_leftType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1066)))).operator_concat (GGS_string ("', right operand type is '@"))).operator_concat (var_cas_rightType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1066)))).operator_concat (GGS_string ("': '<=' operator requires the types are the same")) COMMA_SOURCE_FILE_AT_LINE (1069)) ;
        var_cas_outExpression.drop () ;
      }else if (cond_42762.isBuiltAndFalse ()) {
        var_cas_outExpression = GGS_lowerOrEqualExpressionForGeneration ::constructor_new (inLexique, var_cas_inAnalysisContext.mPredefinedTypes.mBoolType, operand_41686->mOperatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1071)) ;
      }
    }
  }
}
...
category_method__templateStrictSupTestAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateStrictSupTestAST * operand_43157,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_43157 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_leftExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_43157->mLeftExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_43157->mLeftExpression (HERE), var_cas_inAnalysisContext, var_cas_leftExpression COMMA_SOURCE_FILE_AT_LINE (1088)) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_rightExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_43157->mRightExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_43157->mRightExpression (HERE), var_cas_inAnalysisContext, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1091)) ;
      }
    }
    const GGS_unifiedTypeMapProxy  var_cas_leftType = var_cas_leftExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1093)) ;
    const GGS_unifiedTypeMapProxy  var_cas_rightType = var_cas_rightExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1094)) ;
    const GGS_bool cond_43981 = ((var_cas_leftType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (1095))).operator_and (function_isComparable (inLexique COMMA_SOURCE_FILE_AT_LINE (1095)))).operator_isEqual (GGS_uint (0U)) ;
    if (cond_43981.isBuiltAndTrue ()) {
      operand_43157->mOperatorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("left operand type is '@")).operator_concat (var_cas_leftType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1097)))).operator_concat (GGS_string ("' and does not support the '>' operator")) COMMA_SOURCE_FILE_AT_LINE (1100)) ;
      var_cas_outExpression.drop () ;
    }else if (cond_43981.isBuiltAndFalse ()) {
      const GGS_bool cond_44231 = (var_cas_leftType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1100))).operator_isNotEqual (var_cas_rightType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1100))) ;
      if (cond_44231.isBuiltAndTrue ()) {
        operand_43157->mOperatorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("left operand type is '@")).operator_concat (var_cas_leftType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1102)))).operator_concat (GGS_string ("', right operand type is '@"))).operator_concat (var_cas_rightType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1102)))).operator_concat (GGS_string ("': '>' operator requires the types are the same")) COMMA_SOURCE_FILE_AT_LINE (1105)) ;
        var_cas_outExpression.drop () ;
      }else if (cond_44231.isBuiltAndFalse ()) {
        var_cas_outExpression = GGS_strictGreaterExpressionForGeneration ::constructor_new (inLexique, var_cas_inAnalysisContext.mPredefinedTypes.mBoolType, operand_43157->mOperatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1107)) ;
      }
    }
  }
}
...
category_method__templateSupOrEqualTestAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateSupOrEqualTestAST * operand_44628,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_44628 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_leftExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_44628->mLeftExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_44628->mLeftExpression (HERE), var_cas_inAnalysisContext, var_cas_leftExpression COMMA_SOURCE_FILE_AT_LINE (1124)) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_rightExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_44628->mRightExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_44628->mRightExpression (HERE), var_cas_inAnalysisContext, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1127)) ;
      }
    }
    ...
    const GGS_bool cond_45453 = ((var_cas_leftType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (1131))).operator_and (function_isComparable (inLexique COMMA_SOURCE_FILE_AT_LINE (1131)))).operator_isEqual (GGS_uint (0U)) ;
    if (cond_45453.isBuiltAndTrue ()) {
      operand_44628->mOperatorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("left operand type is '@")).operator_concat (var_cas_leftType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1133)))).operator_concat (GGS_string ("' and does not support the '>=' operator")) COMMA_SOURCE_FILE_AT_LINE (1136)) ;
      var_cas_outExpression.drop () ;
    }else if (cond_45453.isBuiltAndFalse ()) {
      const GGS_bool cond_45704 = (var_cas_leftType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1136))).operator_isNotEqual (var_cas_rightType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1136))) ;
      if (cond_45704.isBuiltAndTrue ()) {
        operand_44628->mOperatorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("left operand type is '@")).operator_concat (var_cas_leftType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1138)))).operator_concat (GGS_string ("', right operand type is '@"))).operator_concat (var_cas_rightType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1138)))).operator_concat (GGS_string ("': '>=' operator requires the types are the same")) COMMA_SOURCE_FILE_AT_LINE (1141)) ;
        var_cas_outExpression.drop () ;
      }else if (cond_45704.isBuiltAndFalse ()) {
        var_cas_outExpression = GGS_greaterOrEqualExpressionForGeneration ::constructor_new (inLexique, var_cas_inAnalysisContext.mPredefinedTypes.mBoolType, operand_44628->mOperatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1143)) ;
      }
    }
  }
}
...
category_method__templateLeftShiftOperationAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateLeftShiftOperationAST * operand_46106,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_46106 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_leftExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_46106->mLeftExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_46106->mLeftExpression (HERE), var_cas_inAnalysisContext, var_cas_leftExpression COMMA_SOURCE_FILE_AT_LINE (1160)) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_rightExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_46106->mRightExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_46106->mRightExpression (HERE), var_cas_inAnalysisContext, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1163)) ;
      }
    }
    ...
    const GGS_unifiedTypeMapProxy  var_cas_rightType = var_cas_rightExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1166)) ;
    const GGS_bool cond_46937 = ((var_cas_leftType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (1167))).operator_and (function_binaryShiftOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1167)))).operator_isEqual (GGS_uint (0U)) ;
    if (cond_46937.isBuiltAndTrue ()) {
      operand_46106->mOperatorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("left operand type is '@")).operator_concat (var_cas_leftType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1169)))).operator_concat (GGS_string ("' and does not support a shift operator")) COMMA_SOURCE_FILE_AT_LINE (1172)) ;
      var_cas_outExpression.drop () ;
    }else if (cond_46937.isBuiltAndFalse ()) {
      const GGS_bool cond_47129 = (var_cas_rightType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1172))).operator_isNotEqual (GGS_string ("uint")) ;
      if (cond_47129.isBuiltAndTrue ()) {
        operand_46106->mOperatorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("for a shift operator, right operand type should be '@uint': it is '@")).operator_concat (var_cas_rightType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1174)))).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1177)) ;
        var_cas_outExpression.drop () ;
      }else if (cond_47129.isBuiltAndFalse ()) {
        var_cas_outExpression = GGS_leftShiftExpressionForGeneration ::constructor_new (inLexique, var_cas_leftType, operand_46106->mOperatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1179)) ;
      }
    }
  }
}
...
category_method__templateRightShiftOperationAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateRightShiftOperationAST * operand_47489,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_47489 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_leftExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_47489->mLeftExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_47489->mLeftExpression (HERE), var_cas_inAnalysisContext, var_cas_leftExpression COMMA_SOURCE_FILE_AT_LINE (1196)) ;
      }
    }
    GGS_semanticExpressionForGeneration  var_cas_rightExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_47489->mRightExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_47489->mRightExpression (HERE), var_cas_inAnalysisContext, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1199)) ;
      }
    }
    const GGS_unifiedTypeMapProxy  var_cas_leftType = var_cas_leftExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1201)) ;
    const GGS_unifiedTypeMapProxy  var_cas_rightType = var_cas_rightExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1202)) ;
    const GGS_bool cond_48320 = ((var_cas_leftType.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (1203))).operator_and (function_binaryShiftOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1203)))).operator_isEqual (GGS_uint (0U)) ;
    if (cond_48320.isBuiltAndTrue ()) {
      operand_47489->mOperatorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("left operand type is '@")).operator_concat (var_cas_leftType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1205)))).operator_concat (GGS_string ("' and does not support a shift operator")) COMMA_SOURCE_FILE_AT_LINE (1208)) ;
      var_cas_outExpression.drop () ;
    }else if (cond_48320.isBuiltAndFalse ()) {
      const GGS_bool cond_48512 = (var_cas_rightType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1208))).operator_isNotEqual (GGS_string ("uint")) ;
      if (cond_48512.isBuiltAndTrue ()) {
        operand_47489->mOperatorLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("for a shift operator, right operand type should be '@uint': it is '@")).operator_concat (var_cas_rightType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1210)))).operator_concat (GGS_string ("'")) COMMA_SOURCE_FILE_AT_LINE (1213)) ;
        var_cas_outExpression.drop () ;
      }else if (cond_48512.isBuiltAndFalse ()) {
        var_cas_outExpression = GGS_rightShiftExpressionForGeneration ::constructor_new (inLexique, var_cas_leftType, operand_47489->mOperatorLocation, var_cas_leftExpression, var_cas_rightExpression COMMA_SOURCE_FILE_AT_LINE (1215)) ;
      }
    }
  }
}
...
category_method__templateClassToTypeOperandAST__templateExpressionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateClassToTypeOperandAST * operand_48873,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_semanticExpressionForGeneration  & var_cas_outExpression
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_48873 != NULL) {
    GGS_bool automatic_var_49087_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_49087_1 ;
    GGS_typeKindEnum automatic_var_49087_2 ;
    GGS_typedAttributeList  automatic_var_49087_3 ;
    GGS_attributeMap  automatic_var_49087_4 ;
    GGS_typedAttributeList  automatic_var_49087_5 ;
    GGS_constructorMap  automatic_var_49087_6 ;
    GGS_readerMap  automatic_var_49087_7 ;
    GGS_modifierMap  automatic_var_49087_8 ;
    GGS_instanceMethodMap  automatic_var_49087_9 ;
    GGS_classMethodMap  automatic_var_49087_10 ;
    GGS_enumerationDescriptorList  automatic_var_49087_11 ;
    GGS_uint  automatic_var_49087_12 ;
    GGS_unifiedTypeMapProxyList  automatic_var_49087_13 ;
    GGS_nativeAttributeList  automatic_var_49087_14 ;
    GGS_stringset  automatic_var_49087_15 ;
    GGS_lstringlist  automatic_var_49087_16 ;
    GGS_typedAttributeList  automatic_var_49087_17 ;
    GGS_mapSearchMethodListAST  automatic_var_49087_18 ;
    GGS_mapSearchMethodListAST  automatic_var_49087_19 ;
    GGS_withAccessorMap  automatic_var_49087_20 ;
    if (var_cas_inAnalysisContext.mSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_inAnalysisContext.mSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_48873->mTypeName, automatic_var_49087_0, automatic_var_49087_1, automatic_var_49087_2, automatic_var_49087_3, automatic_var_49087_4, automatic_var_49087_5, automatic_var_49087_6, automatic_var_49087_7, automatic_var_49087_8, automatic_var_49087_9, automatic_var_49087_10, automatic_var_49087_11, automatic_var_49087_12, automatic_var_49087_13, automatic_var_49087_14, automatic_var_49087_15, automatic_var_49087_16, automatic_var_49087_17, automatic_var_49087_18, automatic_var_49087_19, automatic_var_49087_20 COMMA_SOURCE_FILE_AT_LINE (1231)) ;
    }
    var_cas_outExpression = GGS_literalTypeInExpressionForGeneration ::constructor_new (inLexique, GGS_unifiedTypeMapProxy ::constructor_searchKey (inLexique, var_cas_inAnalysisContext.mSemanticContext.mTypeMap, GGS_lstring ::constructor_new (inLexique, GGS_string ("type"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1234)) COMMA_SOURCE_FILE_AT_LINE (1234)), operand_48873->mTypeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1235)), operand_48873->mTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1236)) COMMA_SOURCE_FILE_AT_LINE (1233)) ;
  }
}
...
void routine_templateInstructionListAnalysis (C_Compiler & inLexique,
  ...
  #endif
  {
    GGS_templateInstructionListAST::cEnumerator enumerator_50216 (var_cas_inInstructionList, true) ;
    const GGS_templateInstructionListAST::cElement * operand_50216 = NULL ;
    while (((operand_50216 = enumerator_50216.nextObject ()))) {
      macroValidPointer (operand_50216) ;
      { typeCategoryMethod__templateInstructionAST__templateInstructionAnalysis method = findCategoryMethod__templateInstructionAST__templateInstructionAnalysis (operand_50216->mInstruction.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_50216->mInstruction (HERE), var_cas_inAnalysisContext, var_cas_ioInstructionList COMMA_SOURCE_FILE_AT_LINE (1259)) ;
        }
      }
    }
  }
...
category_method__templateInstructionStringAST__templateInstructionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateInstructionStringAST * operand_50491,
                                const GGS_templateAnalysisContext  /* var_cas_inAnalysisContext */,
                                GGS_templateInstructionListForGeneration  & var_cas_ioInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_50491 != NULL) {
    var_cas_ioInstructionList.addAssign_operation (GGS_templateInstructionStringForGeneration ::constructor_new (inLexique, operand_50491->mTemplateString COMMA_SOURCE_FILE_AT_LINE (1269))) ;
  }
}
...
category_method__templateInstructionExpressionAST__templateInstructionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateInstructionExpressionAST * operand_50867,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_templateInstructionListForGeneration  & var_cas_ioInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_50867 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_expression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_50867->mExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_50867->mExpression (HERE), var_cas_inAnalysisContext, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (1279)) ;
      }
    }
    const GGS_bool cond_51257 = (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1280)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1280))).operator_isNotEqual (GGS_string ("string")) ;
    if (cond_51257.isBuiltAndTrue ()) {
      operand_50867->mLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("expression type should be '@string' (it is '@")).operator_concat (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1281)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1281)))).operator_concat (GGS_string ("')")) COMMA_SOURCE_FILE_AT_LINE (1282)) ;
    }
    var_cas_ioInstructionList.addAssign_operation (GGS_templateInstructionExpressionForGeneration ::constructor_new (inLexique, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (1283))) ;
  }
}
...
category_method__templateBlockInstructionAST__templateInstructionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateBlockInstructionAST * operand_51516,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_templateInstructionListForGeneration  & var_cas_ioInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_51516 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_expression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_51516->mExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_51516->mExpression (HERE), var_cas_inAnalysisContext, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (1293)) ;
      }
    }
    const GGS_bool cond_51902 = (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1294)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1294))).operator_isNotEqual (GGS_string ("uint")) ;
    if (cond_51902.isBuiltAndTrue ()) {
      operand_51516->mLocation.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("expression type should be '@uint' (it is '@")).operator_concat (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1295)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1295)))).operator_concat (GGS_string ("')")) COMMA_SOURCE_FILE_AT_LINE (1296)) ;
    }
    ...
    ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_51516->mBlockInstructionList,  var_cas_blockInstructionList COMMA_SOURCE_FILE_AT_LINE (1298)) ;
    var_cas_ioInstructionList.addAssign_operation (GGS_templateBlockInstructionForGeneration ::constructor_new (inLexique, var_cas_expression, operand_51516->mLocation, var_cas_blockInstructionList COMMA_SOURCE_FILE_AT_LINE (1299))) ;
  }
}
...
category_method__templateInstructionGetColumnLocationAST__templateInstructionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateInstructionGetColumnLocationAST * operand_52377,
                                const GGS_templateAnalysisContext  /* var_cas_inAnalysisContext */,
                                GGS_templateInstructionListForGeneration  & var_cas_ioInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_52377 != NULL) {
    var_cas_ioInstructionList.addAssign_operation (GGS_templateInstructionGetColumnLocationForGeneration ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1308))) ;
  }
}
...
category_method__templateInstructionGotoColumnLocationAST__templateInstructionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateInstructionGotoColumnLocationAST * operand_52755,
                                const GGS_templateAnalysisContext  /* var_cas_inAnalysisContext */,
                                GGS_templateInstructionListForGeneration  & var_cas_ioInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_52755 != NULL) {
    var_cas_ioInstructionList.addAssign_operation (GGS_templateInstructionGotoColumnLocationForGeneration ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (1317))) ;
  }
}
...
category_method__templateInstructionForeachAST__templateInstructionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateInstructionForeachAST * operand_53123,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_templateInstructionListForGeneration  & var_cas_ioInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_53123 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_expression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_53123->mExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_53123->mExpression (HERE), var_cas_inAnalysisContext, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (1328)) ;
      }
    }
    const GGS_enumerationDescriptorList  var_cas_enumerationDescriptor = var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1330)).reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (1330)) ;
    const GGS_bool cond_53721 = (var_cas_enumerationDescriptor.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
    if (cond_53721.isBuiltAndTrue ()) {
      var_cas_expression.reader_mLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (1332)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("expression of '@")).operator_concat (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1332)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1332)))).operator_concat (GGS_string ("' cannot be enumerated")) COMMA_SOURCE_FILE_AT_LINE (1333)) ;
    }
    ...
    ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_53123->mBeforeInstructionList,  var_cas_beforeInstructionList COMMA_SOURCE_FILE_AT_LINE (1336)) ;
    const GGS_string var_cas_enumeratorCppName = (GGS_string ("enumerator_")).operator_concat (operand_53123->mIndexIdentifier.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1338)).reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1338)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1338))) ;
    GGS_templateVariableMap  var_cas_doVariableMap = var_cas_inAnalysisContext.mTemplateVariableMap ;
    const GGS_string var_cas_cppIndexVarName = (((GGS_string ("index_")).operator_concat (operand_53123->mIndexIdentifier.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1340)).reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1340)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1340)))).operator_concat (GGS_string ("_"))).operator_concat (operand_53123->mIndexIdentifier.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1340)).reader_identifierRepresentation ()) ;
    const GGS_bool cond_54468 = (operand_53123->mIndexIdentifier.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1341))).operator_isNotEqual (GGS_string ("")) ;
    if (cond_54468.isBuiltAndTrue ()) {
      var_cas_doVariableMap.modifier_insertKey (inLexique, operand_53123->mIndexIdentifier, var_cas_inAnalysisContext.mPredefinedTypes.mUIntType, var_cas_cppIndexVarName COMMA_SOURCE_FILE_AT_LINE (1342)) ;
    }
    {
      GGS_enumerationDescriptorList::cEnumerator enumerator_54505 (var_cas_enumerationDescriptor, true) ;
      const GGS_enumerationDescriptorList::cElement * operand_54505 = NULL ;
      while (((operand_54505 = enumerator_54505.nextObject ()))) {
        macroValidPointer (operand_54505) ;
        var_cas_doVariableMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (operand_53123->mPrefix).operator_concat (operand_54505->mEnumerationName), var_cas_expression.reader_mLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (1346)) COMMA_SOURCE_FILE_AT_LINE (1346)), operand_54505->mEnumeratedType, (((var_cas_enumeratorCppName).operator_concat (GGS_string (".current_"))).operator_concat (operand_54505->mEnumerationName.reader_identifierRepresentation ())).operator_concat (GGS_string (" ()")) COMMA_SOURCE_FILE_AT_LINE (1345)) ;
      }
    }
    ...
    ::routine_templateInstructionListAnalysis (inLexique,  var_cas_doAnalysisContext,  operand_53123->mDoInstructionList,  var_cas_doInstructionList COMMA_SOURCE_FILE_AT_LINE (1357)) ;
    ...
    ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_53123->mBetweenInstructionList,  var_cas_betweenInstructionList COMMA_SOURCE_FILE_AT_LINE (1360)) ;
    ...
    ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_53123->mAfterInstructionList,  var_cas_afterInstructionList COMMA_SOURCE_FILE_AT_LINE (1363)) ;
    var_cas_ioInstructionList.addAssign_operation (GGS_templateInstructionForeachForGeneration ::constructor_new (inLexique, operand_53123->mIsAscending, var_cas_expression, var_cas_enumeratorCppName, var_cas_beforeInstructionList, var_cas_doInstructionList, operand_53123->mIndexIdentifier.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1371)), var_cas_betweenInstructionList, var_cas_afterInstructionList COMMA_SOURCE_FILE_AT_LINE (1365))) ;
  }
}
...
category_method__templateInstructionIfAST__templateInstructionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateInstructionIfAST * operand_55926,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_templateInstructionListForGeneration  & var_cas_ioInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_55926 != NULL) {
    ...
    {
      GGS_templateInstructionIfBranchListAST::cEnumerator enumerator_56172 (operand_55926->mTemplateInstructionIfBranchList, true) ;
      const GGS_templateInstructionIfBranchListAST::cElement * operand_56172 = NULL ;
      while (((operand_56172 = enumerator_56172.nextObject ()))) {
        macroValidPointer (operand_56172) ;
        GGS_semanticExpressionForGeneration  var_cas_expression ;
        { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_56172->mExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_56172->mExpression (HERE), var_cas_inAnalysisContext, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (1386)) ;
          }
        }
        const GGS_bool cond_56482 = (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1387)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1387))).operator_isNotEqual (GGS_string ("bool")) ;
        if (cond_56482.isBuiltAndTrue ()) {
          var_cas_expression.reader_mLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (1388)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'if' expression type should be '@bool' (it is '@")).operator_concat (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1388)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1388)))).operator_concat (GGS_string ("')")) COMMA_SOURCE_FILE_AT_LINE (1389)) ;
        }
        ...
        ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_56172->mInstructionList,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1391)) ;
    ...
    ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_55926->mElseInstructionList,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (1396)) ;
    var_cas_ioInstructionList.addAssign_operation (GGS_templateInstructionIfForGeneration ::constructor_new (inLexique, var_cas_templateInstructionIfBranchList, var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (1398))) ;
  }
}
...
category_method__templateInstructionSwitchAST__templateInstructionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateInstructionSwitchAST * operand_57221,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_templateInstructionListForGeneration  & var_cas_ioInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57221 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_switchExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_57221->mSwitchExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_57221->mSwitchExpression (HERE), var_cas_inAnalysisContext, var_cas_switchExpression COMMA_SOURCE_FILE_AT_LINE (1412)) ;
      }
    }
    const GGS_bool cond_57728 = (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1413)).reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1413))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1413))) ;
    if (cond_57728.isBuiltAndTrue ()) {
      var_cas_switchExpression.reader_mLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (1414)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'switch' expression type should be an enumeration (it is a ")).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1414)).reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1414)).reader_kind (inLexique COMMA_SOURCE_FILE_AT_LINE (1414)))).operator_concat (GGS_string (" type)")) COMMA_SOURCE_FILE_AT_LINE (1415)) ;
    }
    const GGS_stringset  var_cas_enumConstantSet = var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1416)).reader_mEnumConstantSet (inLexique COMMA_SOURCE_FILE_AT_LINE (1416)) ;
    ...
    {
      GGS_templateInstructionSwitchBranchListAST::cEnumerator enumerator_58014 (operand_57221->mTemplateInstructionSwitchBranchList, true) ;
      const GGS_templateInstructionSwitchBranchListAST::cElement * operand_58014 = NULL ;
      while (((operand_58014 = enumerator_58014.nextObject ()))) {
        macroValidPointer (operand_58014) ;
        {
          GGS_lstringlist::cEnumerator enumerator_58043 (operand_58014->mConstantList, true) ;
          const GGS_lstringlist::cElement * operand_58043 = NULL ;
          while (((operand_58043 = enumerator_58043.nextObject ()))) {
            macroValidPointer (operand_58043) ;
            const GGS_bool cond_58243 = (var_cas_enumConstantSet.reader_hasKey (operand_58043->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1422)))).operator_not () ;
            if (cond_58243.isBuiltAndTrue ()) {
              operand_58043->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (operand_58043->mValue)).operator_concat (GGS_string ("' is not a contant of '@"))).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1423)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1423)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1424)) ;
            }
            const GGS_bool cond_58415 = var_cas_namedConstantSet.reader_hasKey (operand_58043->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1425))) ;
            if (cond_58415.isBuiltAndTrue ()) {
              operand_58043->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_58043->mValue)).operator_concat (GGS_string ("' constant is already named in the switch instruction")) COMMA_SOURCE_FILE_AT_LINE (1427)) ;
            }
            var_cas_namedConstantSet.addAssign_operation (operand_58043->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1428))) ;
          }
        }
        GGS_templateInstructionListForGeneration  var_cas_instructionList = GGS_templateInstructionListForGeneration ::constructor_emptyList () ;
        ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_58014->mInstructionList,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1431)) ;
        var_cas_templateInstructionSwitchBranchList.addAssign_operation (operand_58014->mConstantList, var_cas_instructionList) ;
      }
    }
    GGS_stringset  var_cas_missingConstants = var_cas_enumConstantSet.substract_operation (inLexique, var_cas_namedConstantSet COMMA_SOURCE_FILE_AT_LINE (1435)) ;
    const GGS_bool cond_59110 = (var_cas_missingConstants.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_59110.isBuiltAndTrue ()) {
      ...
      {
        GGS_stringset::cEnumerator enumerator_59027 (var_cas_missingConstants, true) ;
        while (enumerator_59027.hasCurrentObject ()) {
          var_cas_m.appendCString ("\n"
            "  - '") ;
          var_cas_m.dotAssign_operation (enumerator_59027._key (HERE)) ;
          var_cas_m.appendCString ("'") ;
          enumerator_59027.next () ;
        }
      }
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_m COMMA_SOURCE_FILE_AT_LINE (1442)) ;
    }
    var_cas_ioInstructionList.addAssign_operation (GGS_templateInstructionSwitchForGeneration ::constructor_new (inLexique, var_cas_switchExpression, var_cas_templateInstructionSwitchBranchList COMMA_SOURCE_FILE_AT_LINE (1444))) ;
  }
}
