...
//                    november 11th, 2010, at 12h16'27"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__templateInstructionIfAST__templateInstructionAnalysis (C_CompilerEx & inLexique,
                                const cPtr_templateInstructionIfAST * operand_56310,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_templateInstructionListForGeneration  & var_cas_ioInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_56310 != NULL) {
    ...
    {
      GGS_templateInstructionIfBranchListAST::cEnumerator enumerator_56556 (operand_56310->mTemplateInstructionIfBranchList, true) ;
      const GGS_templateInstructionIfBranchListAST::cElement * operand_56556 = NULL ;
      while (((operand_56556 = enumerator_56556.nextObject ()))) {
        macroValidPointer (operand_56556) ;
        GGS_semanticExpressionForGeneration  var_cas_expression ;
        { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_56556->mExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_56556->mExpression (HERE), var_cas_inAnalysisContext, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (1395)) ;
          }
        }
        const GGS_bool cond_56866 = (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1396)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1396))).operator_isNotEqual (GGS_string ("bool")) ;
        if (cond_56866.isBuiltAndTrue ()) {
        ...
        ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_56556->mInstructionList,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1400)) ;
    ...
    ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_56310->mElseInstructionList,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (1405)) ;
...
category_method__templateInstructionSwitchAST__templateInstructionAnalysis (C_CompilerEx & inLexique,
                                const cPtr_templateInstructionSwitchAST * operand_57605,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_templateInstructionListForGeneration  & var_cas_ioInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57605 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_switchExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_57605->mSwitchExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_57605->mSwitchExpression (HERE), var_cas_inAnalysisContext, var_cas_switchExpression COMMA_SOURCE_FILE_AT_LINE (1421)) ;
      }
    }
    const GGS_bool cond_58112 = (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1422)).reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1422))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1422))) ;
    if (cond_58112.isBuiltAndTrue ()) {
    ...
    {
      GGS_templateInstructionSwitchBranchListAST::cEnumerator enumerator_58398 (operand_57605->mTemplateInstructionSwitchBranchList, true) ;
      const GGS_templateInstructionSwitchBranchListAST::cElement * operand_58398 = NULL ;
      while (((operand_58398 = enumerator_58398.nextObject ()))) {
        macroValidPointer (operand_58398) ;
        {
          GGS_lstringlist::cEnumerator enumerator_58427 (operand_58398->mConstantList, true) ;
          const GGS_lstringlist::cElement * operand_58427 = NULL ;
          while (((operand_58427 = enumerator_58427.nextObject ()))) {
            macroValidPointer (operand_58427) ;
            const GGS_bool cond_58627 = (var_cas_enumConstantSet.reader_hasKey (operand_58427->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1431)))).operator_not () ;
            if (cond_58627.isBuiltAndTrue ()) {
              operand_58427->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (operand_58427->mValue)).operator_concat (GGS_string ("' is not a contant of '@"))).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1432)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1432)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1433)) ;
            }
            const GGS_bool cond_58799 = var_cas_namedConstantSet.reader_hasKey (operand_58427->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1434))) ;
            if (cond_58799.isBuiltAndTrue ()) {
              operand_58427->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_58427->mValue)).operator_concat (GGS_string ("' constant is already named in the switch instruction")) COMMA_SOURCE_FILE_AT_LINE (1436)) ;
            }
            var_cas_namedConstantSet.addAssign_operation (operand_58427->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1437))) ;
          }
        }
        GGS_templateInstructionListForGeneration  var_cas_instructionList = GGS_templateInstructionListForGeneration ::constructor_emptyList () ;
        ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_58398->mInstructionList,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1440)) ;
        var_cas_templateInstructionSwitchBranchList.addAssign_operation (operand_58398->mConstantList, var_cas_instructionList) ;
      }
    }
    ...
    const GGS_bool cond_59494 = (var_cas_missingConstants.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_59494.isBuiltAndTrue ()) {
      ...
      {
        GGS_stringset::cEnumerator enumerator_59411 (var_cas_missingConstants, true) ;
        while (enumerator_59411.hasCurrentObject ()) {
          var_cas_m.appendCString ("\n"
            "  - '") ;
          var_cas_m.dotAssign_operation (enumerator_59411._key (HERE)) ;
          var_cas_m.appendCString ("'") ;
          enumerator_59411.next () ;
        }
      }
