...
static void categoryMethod_templateInstructionForeachAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_enumeratorCppName = GALGAS_string ("enumerator_").operator_concat (object->mAttribute_mIndexIdentifier.reader_location (SOURCE_FILE_AT_LINE (1343)).reader_locationIndex (SOURCE_FILE_AT_LINE (1343)).reader_string (SOURCE_FILE_AT_LINE (1343)) COMMA_SOURCE_FILE_AT_LINE (1343)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_templateVariableMap var_doVariableMap = constinArgument_inAnalysisContext.mAttribute_mTemplateVariableMap ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_cppIndexVarName = GALGAS_string ("index_").operator_concat (object->mAttribute_mIndexIdentifier.reader_location (SOURCE_FILE_AT_LINE (1345)).reader_locationIndex (SOURCE_FILE_AT_LINE (1345)).reader_string (SOURCE_FILE_AT_LINE (1345)) COMMA_SOURCE_FILE_AT_LINE (1345)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (1345)).operator_concat (object->mAttribute_mIndexIdentifier.reader_string (SOURCE_FILE_AT_LINE (1345)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (1345)) COMMA_SOURCE_FILE_AT_LINE (1345)) ;
  //-------- @ifInstructionForGeneration
