...
category_method__templateInstructionForeachAST__templateInstructionAnalysis (C_Compiler & inLexique,
  ...
  if (operand_51184 != NULL) {
    ...
    const GGS_enumerationDescriptorList  var_cas_enumerationDescriptor = var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1291)).reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (1291)) ;
    const GGS_bool cond_51782 = (var_cas_enumerationDescriptor.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
    if (cond_51782.isBuiltAndTrue ()) {
      var_cas_expression.reader_mLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (1293)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("expression of '@")).operator_concat (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1293)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1293)))).operator_concat (GGS_string ("' cannot be enumerated")) COMMA_SOURCE_FILE_AT_LINE (1294)) ;
    }
    ...
    ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_51184->mBeforeInstructionList,  var_cas_beforeInstructionList COMMA_SOURCE_FILE_AT_LINE (1297)) ;
    const GGS_string var_cas_enumeratorCppName = (GGS_string ("enumerator_")).operator_concat (operand_51184->mIndexIdentifier.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1299)).reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1299)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1299))) ;
    GGS_templateVariableMap  var_cas_doVariableMap = var_cas_inAnalysisContext.mTemplateVariableMap ;
    const GGS_string var_cas_cppIndexVarName = (((GGS_string ("index_")).operator_concat (operand_51184->mIndexIdentifier.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1301)).reader_locationIndex (inLexique COMMA_SOURCE_FILE_AT_LINE (1301)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1301)))).operator_concat (GGS_string ("_"))).operator_concat (operand_51184->mIndexIdentifier.ggs_string ().reader_identifierRepresentation ()) ;
    var_cas_doVariableMap.modifier_insertKey (inLexique, operand_51184->mIndexIdentifier, var_cas_inAnalysisContext.mPredefinedTypes.mUIntType, var_cas_cppIndexVarName COMMA_SOURCE_FILE_AT_LINE (1302)) ;
    {
      GGS_enumerationDescriptorList::cEnumerator enumerator_52502 (var_cas_enumerationDescriptor, true) ;
      const GGS_enumerationDescriptorList::cElement * operand_52502 = NULL ;
      while (((operand_52502 = enumerator_52502.nextObject ()))) {
        macroValidPointer (operand_52502) ;
        var_cas_doVariableMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_52502->mEnumerationName, var_cas_expression.reader_mLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (1305)) COMMA_SOURCE_FILE_AT_LINE (1305)), operand_52502->mEnumeratedType, (((var_cas_enumeratorCppName).operator_concat (GGS_string (".current_"))).operator_concat (operand_52502->mEnumerationName.reader_identifierRepresentation ())).operator_concat (GGS_string (" ()")) COMMA_SOURCE_FILE_AT_LINE (1304)) ;
      }
    }
    ...
    ::routine_templateInstructionListAnalysis (inLexique,  var_cas_doAnalysisContext,  operand_51184->mDoInstructionList,  var_cas_doInstructionList COMMA_SOURCE_FILE_AT_LINE (1316)) ;
    ...
    ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_51184->mBetweenInstructionList,  var_cas_betweenInstructionList COMMA_SOURCE_FILE_AT_LINE (1319)) ;
    ...
    ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_51184->mAfterInstructionList,  var_cas_afterInstructionList COMMA_SOURCE_FILE_AT_LINE (1322)) ;
    var_cas_ioInstructionList.addAssign_operation (GGS_templateInstructionForeachForGeneration ::constructor_new (inLexique, operand_51184->mIsAscending, var_cas_expression, var_cas_enumeratorCppName, var_cas_beforeInstructionList, var_cas_doInstructionList, operand_51184->mIndexIdentifier.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1330)), var_cas_betweenInstructionList, var_cas_afterInstructionList COMMA_SOURCE_FILE_AT_LINE (1324))) ;
  }
}
...
category_method__templateInstructionIfAST__templateInstructionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateInstructionIfAST * operand_53913,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_templateInstructionListForGeneration  & var_cas_ioInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_53913 != NULL) {
    ...
    {
      GGS_templateInstructionIfBranchListAST::cEnumerator enumerator_54159 (operand_53913->mTemplateInstructionIfBranchList, true) ;
      const GGS_templateInstructionIfBranchListAST::cElement * operand_54159 = NULL ;
      while (((operand_54159 = enumerator_54159.nextObject ()))) {
        macroValidPointer (operand_54159) ;
        GGS_semanticExpressionForGeneration  var_cas_expression ;
        { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_54159->mExpression.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, operand_54159->mExpression (HERE), var_cas_inAnalysisContext, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (1345)) ;
          }
        }
        const GGS_bool cond_54469 = (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1346)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1346))).operator_isNotEqual (GGS_string ("bool")) ;
        if (cond_54469.isBuiltAndTrue ()) {
          var_cas_expression.reader_mLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (1347)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'if' expression type should be '@bool' (it is '@")).operator_concat (var_cas_expression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1347)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1347)))).operator_concat (GGS_string ("')")) COMMA_SOURCE_FILE_AT_LINE (1348)) ;
        }
        ...
        ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_54159->mInstructionList,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1350)) ;
    ...
    ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_53913->mElseInstructionList,  var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (1355)) ;
    var_cas_ioInstructionList.addAssign_operation (GGS_templateInstructionIfForGeneration ::constructor_new (inLexique, var_cas_templateInstructionIfBranchList, var_cas_elseInstructionList COMMA_SOURCE_FILE_AT_LINE (1357))) ;
  }
}
...
category_method__templateInstructionSwitchAST__templateInstructionAnalysis (C_Compiler & inLexique,
                                const cPtr_templateInstructionSwitchAST * operand_55208,
                                const GGS_templateAnalysisContext  var_cas_inAnalysisContext,
                                GGS_templateInstructionListForGeneration  & var_cas_ioInstructionList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_55208 != NULL) {
    GGS_semanticExpressionForGeneration  var_cas_switchExpression ;
    { typeCategoryMethod__templateExpressionAST__templateExpressionAnalysis method = findCategoryMethod__templateExpressionAST__templateExpressionAnalysis (operand_55208->mSwitchExpression.galgasObjectRunTimeInfo ()) ;
      if (method != NULL) {
        method (inLexique, operand_55208->mSwitchExpression (HERE), var_cas_inAnalysisContext, var_cas_switchExpression COMMA_SOURCE_FILE_AT_LINE (1371)) ;
      }
    }
    const GGS_bool cond_55715 = (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1372)).reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1372))).operator_isNotEqual (GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1372))) ;
    if (cond_55715.isBuiltAndTrue ()) {
      var_cas_switchExpression.reader_mLocation (inLexique COMMA_SOURCE_FILE_AT_LINE (1373)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("'switch' expression type should be an enumeration (it is a ")).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1373)).reader_mTypeKindEnum (inLexique COMMA_SOURCE_FILE_AT_LINE (1373)).reader_kind (inLexique COMMA_SOURCE_FILE_AT_LINE (1373)))).operator_concat (GGS_string (" type)")) COMMA_SOURCE_FILE_AT_LINE (1374)) ;
    }
    const GGS_stringset  var_cas_enumConstantSet = var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1375)).reader_mEnumConstantSet (inLexique COMMA_SOURCE_FILE_AT_LINE (1375)) ;
    ...
    {
      GGS_templateInstructionSwitchBranchListAST::cEnumerator enumerator_56001 (operand_55208->mTemplateInstructionSwitchBranchList, true) ;
      const GGS_templateInstructionSwitchBranchListAST::cElement * operand_56001 = NULL ;
      while (((operand_56001 = enumerator_56001.nextObject ()))) {
        macroValidPointer (operand_56001) ;
        {
          GGS_lstringlist::cEnumerator enumerator_56030 (operand_56001->mConstantList, true) ;
          const GGS_lstringlist::cElement * operand_56030 = NULL ;
          while (((operand_56030 = enumerator_56030.nextObject ()))) {
            macroValidPointer (operand_56030) ;
            const GGS_bool cond_56230 = (var_cas_enumConstantSet.reader_hasKey (operand_56030->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1381)))).operator_not () ;
            if (cond_56230.isBuiltAndTrue ()) {
              operand_56030->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((((GGS_string ("the '")).operator_concat (operand_56030->mValue)).operator_concat (GGS_string ("' is not a contant of '@"))).operator_concat (var_cas_switchExpression.reader_mType (inLexique COMMA_SOURCE_FILE_AT_LINE (1382)).reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1382)))).operator_concat (GGS_string ("' enumeration type")) COMMA_SOURCE_FILE_AT_LINE (1383)) ;
            }
            const GGS_bool cond_56402 = var_cas_namedConstantSet.reader_hasKey (operand_56030->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1384))) ;
            if (cond_56402.isBuiltAndTrue ()) {
              operand_56030->mValue.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_56030->mValue)).operator_concat (GGS_string ("' constant is already named in the switch instruction")) COMMA_SOURCE_FILE_AT_LINE (1386)) ;
            }
            var_cas_namedConstantSet.addAssign_operation (operand_56030->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1387))) ;
          }
        }
        GGS_templateInstructionListForGeneration  var_cas_instructionList = GGS_templateInstructionListForGeneration ::constructor_emptyList () ;
        ::routine_templateInstructionListAnalysis (inLexique,  var_cas_inAnalysisContext,  operand_56001->mInstructionList,  var_cas_instructionList COMMA_SOURCE_FILE_AT_LINE (1390)) ;
        var_cas_templateInstructionSwitchBranchList.addAssign_operation (operand_56001->mConstantList, var_cas_instructionList) ;
      }
    }
    GGS_stringset  var_cas_missingConstants = var_cas_enumConstantSet.substract_operation (inLexique, var_cas_namedConstantSet COMMA_SOURCE_FILE_AT_LINE (1394)) ;
    const GGS_bool cond_57097 = (var_cas_missingConstants.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_57097.isBuiltAndTrue ()) {
      ...
      {
        GGS_stringset::cEnumerator enumerator_57014 (var_cas_missingConstants, true) ;
        while (enumerator_57014.hasCurrentObject ()) {
          var_cas_m.appendCString ("\n"
            "  - '") ;
          var_cas_m.dotAssign_operation (enumerator_57014._key (HERE)) ;
          var_cas_m.appendCString ("'") ;
          enumerator_57014.next () ;
        }
      }
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_m COMMA_SOURCE_FILE_AT_LINE (1401)) ;
    }
    var_cas_ioInstructionList.addAssign_operation (GGS_templateInstructionSwitchForGeneration ::constructor_new (inLexique, var_cas_switchExpression, var_cas_templateInstructionSwitchBranchList COMMA_SOURCE_FILE_AT_LINE (1403))) ;
  }
}
