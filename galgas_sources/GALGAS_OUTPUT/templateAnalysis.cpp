...
void routine_templateInstructionListAnalysis (const GALGAS_templateAnalysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_templateInstructionListAST enumerator_51294 (constinArgument_inInstructionList, kEnumeration_up) ;
...
static void categoryMethod_templateReaderCallInExpressionAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  if (NULL != objectArray_3980) {
    ...
    if (kBoolTrue == test_0) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_typedAttributeList enumerator_4552 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE_AT_LINE (89)), kEnumeration_up) ;
      //--- simple foreach instruction
      ...
      if (kBoolTrue == test_1) {
        ...
        if (kBoolTrue == test_3) {
          ...
          //-------- @foreachInstructionForGeneration
          cEnumerator_stringlist enumerator_5671 (var_fieldList, kEnumeration_up) ;
          //--- simple foreach instruction
      ...
      if (kBoolTrue == test_5) {
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_readerMap enumerator_6371 (var_readerMap, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_6371.hasCurrentObject ()) {
          ...
          //-------- @foreachInstructionForGeneration
          cEnumerator_unifiedTypeMapProxyList enumerator_6439 (enumerator_6371.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          //--- simple foreach instruction
  ...
  if (kBoolTrue == test_10) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_templateExpressionListAST enumerator_7406 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_7438 (var_readerFormalArgumentTypeList, kEnumeration_up) ;
    //--- simple foreach instruction
...
static void categoryMethod_templateConstructorAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  if (NULL != objectArray_8836) {
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_constructorMap enumerator_9317 (var_constructorMap, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_9317.hasCurrentObject ()) {
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_unifiedTypeMapProxyList enumerator_9385 (enumerator_9317.current_mArgumentTypeList (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
  ...
  if (kBoolTrue == test_5) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_templateExpressionListAST enumerator_10500 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    cEnumerator_unifiedTypeMapProxyList enumerator_10537 (var_constructorFormalArgumentTypeList, kEnumeration_up) ;
    //--- simple foreach instruction
...
static void categoryMethod_templateLiteralStringExpressionAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_18347 (object->mAttribute_mLiteralStringList, kEnumeration_up) ;
  //--- simple foreach instruction
...
static void categoryMethod_templateOptionAccessAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_26798 (var_boolOptionMap, kEnumeration_up) ;
    //--- simple foreach instruction
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_26894 (var_uintOptionMap, kEnumeration_up) ;
    //--- simple foreach instruction
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_commandLineOptionMap enumerator_26992 (var_stringOptionMap, kEnumeration_up) ;
    //--- simple foreach instruction
...
static void categoryMethod_templateFunctionCallAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_unifiedTypeMapProxyList enumerator_28404 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_templateExpressionListAST enumerator_28423 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    //--- simple foreach instruction
...
static void categoryMethod_templateClassToTypeOperandAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_50160_21 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_50160_20 ; // Joker input parameter
  GALGAS_typeKindEnum joker_50160_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_50160_18 ; // Joker input parameter
  GALGAS_attributeMap joker_50160_17 ; // Joker input parameter
  GALGAS_typedAttributeList joker_50160_16 ; // Joker input parameter
  GALGAS_constructorMap joker_50160_15 ; // Joker input parameter
  GALGAS_readerMap joker_50160_14 ; // Joker input parameter
  GALGAS_modifierMap joker_50160_13 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_50160_12 ; // Joker input parameter
  GALGAS_classMethodMap joker_50160_11 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_50160_10 ; // Joker input parameter
  GALGAS_stringlist joker_50160_9 ; // Joker input parameter
...
static void categoryMethod_templateInstructionForeachAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_enumerationDescriptorList enumerator_55583 (var_enumerationDescriptor, kEnumeration_up) ;
  //--- simple foreach instruction
...
static void categoryMethod_templateInstructionIfAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_templateInstructionIfBranchListAST enumerator_57244 (object->mAttribute_mTemplateInstructionIfBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
...
static void categoryMethod_templateInstructionSwitchAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_templateInstructionSwitchBranchListAST enumerator_59086 (object->mAttribute_mTemplateInstructionSwitchBranchList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_59086.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_59115 (enumerator_59086.current_mConstantList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
  ...
  if (kBoolTrue == test_5) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringset enumerator_60099 (var_missingConstants, kEnumeration_up) ;
    //--- simple foreach instruction
