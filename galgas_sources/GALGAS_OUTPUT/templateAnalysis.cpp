...
//                    november 26th, 2010, at 18h34'26"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
static void categoryMethod_templateUnaryMinusOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (934)).operator_and (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (934)) COMMA_SOURCE_FILE_AT_LINE (934)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (966)).reader_string (SOURCE_FILE_AT_LINE (966)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (966)).reader_string (SOURCE_FILE_AT_LINE (966))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateNonEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (997)).reader_string (SOURCE_FILE_AT_LINE (997)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (997)).reader_string (SOURCE_FILE_AT_LINE (997))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateStrictInfTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1028)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1028)) COMMA_SOURCE_FILE_AT_LINE (1028)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1033)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1033))))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateInfOrEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1064)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1064)) COMMA_SOURCE_FILE_AT_LINE (1064)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1069)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1069))))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateStrictSupTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1100)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1100)) COMMA_SOURCE_FILE_AT_LINE (1100)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1105)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1105))))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateSupOrEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1136)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1136)) COMMA_SOURCE_FILE_AT_LINE (1136)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1141)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1141))))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateLeftShiftOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1172)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1172)) COMMA_SOURCE_FILE_AT_LINE (1172)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1177)).objectCompare (GALGAS_string ("uint")))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateRightShiftOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1208)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1208)) COMMA_SOURCE_FILE_AT_LINE (1208)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1213)).objectCompare (GALGAS_string ("uint")))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateInstructionExpressionAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1285)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1285)).objectCompare (GALGAS_string ("string")))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateBlockInstructionAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1299)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1299)).objectCompare (GALGAS_string ("uint")))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateInstructionForeachAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_enumerationDescriptor.reader_length (SOURCE_FILE_AT_LINE (1336)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, object->mAttribute_mIndexIdentifier.reader_string (SOURCE_FILE_AT_LINE (1346)).objectCompare (GALGAS_string::makeEmptyString ()))) ;
  if (test_1.isValidAndTrue ()) {
...
static void categoryMethod_templateInstructionIfAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  while (enumerator_56311.hasCurrentObject ()) {
    ...
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1392)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1392)).objectCompare (GALGAS_string ("bool")))) ;
    if (test_0.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateInstructionSwitchAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_switchExpression.reader_mType (SOURCE_FILE_AT_LINE (1418)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1418)).objectCompare (GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE_AT_LINE (1418))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
  ...
  while (enumerator_58153.hasCurrentObject ()) {
    ...
    while (enumerator_58182.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_1 (var_enumConstantSet.reader_hasKey (enumerator_58182.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1427)) COMMA_SOURCE_FILE_AT_LINE (1427)).operator_not (SOURCE_FILE_AT_LINE (1427))) ;
      if (test_1.isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_2 (enumerator_58182.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (enumerator_58182.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1428)) COMMA_SOURCE_FILE_AT_LINE (1428)).operator_concat (GALGAS_string ("' is not a contant of '@") COMMA_SOURCE_FILE_AT_LINE (1428)).operator_concat (var_switchExpression.reader_mType (SOURCE_FILE_AT_LINE (1428)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1428)) COMMA_SOURCE_FILE_AT_LINE (1428)).operator_concat (GALGAS_string ("' enumeration type") COMMA_SOURCE_FILE_AT_LINE (1428)) COMMA_SOURCE_FILE_AT_LINE (1428)) ;
      }
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_3 (var_namedConstantSet.reader_hasKey (enumerator_58182.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1430)) COMMA_SOURCE_FILE_AT_LINE (1430))) ;
      if (test_3.isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_4 (enumerator_58182.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the '").operator_concat (enumerator_58182.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1431)) COMMA_SOURCE_FILE_AT_LINE (1431)).operator_concat (GALGAS_string ("' constant is already named in the switch instruction") COMMA_SOURCE_FILE_AT_LINE (1431)) COMMA_SOURCE_FILE_AT_LINE (1431)) ;
      }
      //-------- @addAssignInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_5 (GALGAS_bool (kIsStrictSup, var_missingConstants.reader_count (SOURCE_FILE_AT_LINE (1441)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_5.isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
