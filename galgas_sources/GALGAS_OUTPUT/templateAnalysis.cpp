...
static void categoryMethod_templateReaderCallInExpressionAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  if (NULL != objectArray_3980) {
    ...
    const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_receiverType.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (84)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (84))))) ;
    if (test_0.isValidAndTrue ()) {
      ...
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_1 (GALGAS_bool (kIsEqual, var_matchingReaderCount.objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
      if (test_1.isValidAndTrue ()) {
        ...
        //-------- @ifInstructionForGeneration
        const GALGAS_bool test_3 (GALGAS_bool (kIsStrictSup, var_matchingReaderCount.objectCompare (GALGAS_uint ((PMUInt32) 1U)))) ;
      ...
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_5 (GALGAS_bool (kIsEqual, var_readerMap.reader_count (SOURCE_FILE_AT_LINE (120)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_9 (GALGAS_bool (kIsNotEqual, object->mAttribute_mExpressionList.reader_length (SOURCE_FILE_AT_LINE (143)).objectCompare (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (143))))) ;
  if (test_9.isValidAndTrue ()) {
    ...
    inCompiler->emitSemanticError (location_10, GALGAS_string ("calling the '").operator_concat (object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (144)) COMMA_SOURCE_FILE_AT_LINE (144)).operator_concat (GALGAS_string ("' reader of '@") COMMA_SOURCE_FILE_AT_LINE (144)).operator_concat (var_receiverType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (144)) COMMA_SOURCE_FILE_AT_LINE (144)).operator_concat (GALGAS_string ("' requires ") COMMA_SOURCE_FILE_AT_LINE (144)).operator_concat (var_readerFormalArgumentTypeList.reader_length (SOURCE_FILE_AT_LINE (145)).reader_string (SOURCE_FILE_AT_LINE (145)) COMMA_SOURCE_FILE_AT_LINE (145)).operator_concat (GALGAS_string (" parameter(s), while this call has ") COMMA_SOURCE_FILE_AT_LINE (145)).operator_concat (object->mAttribute_mExpressionList.reader_length (SOURCE_FILE_AT_LINE (146)).reader_string (SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146)).operator_concat (GALGAS_string (" parameter(s)") COMMA_SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (144)) ;
...
static void categoryMethod_templateConstructorAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  if (NULL != objectArray_8836) {
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_constructorMap.reader_count (SOURCE_FILE_AT_LINE (188)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
    if (test_0.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateIfThenElseExpressionAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_if_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (532)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (532)).objectCompare (GALGAS_string ("bool")))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_then_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (537)).objectCompare (var_else_5F_expression.reader_mType (SOURCE_FILE_AT_LINE (537))))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateNotOperatorAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (565)).operator_and (function_unaryNotOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (565)) COMMA_SOURCE_FILE_AT_LINE (565)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateLogicalNegateAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (591)).operator_and (function_unaryTildeOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (591)) COMMA_SOURCE_FILE_AT_LINE (591)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateOptionAccessAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (var_found.operator_not (SOURCE_FILE_AT_LINE (623))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_1 (var_found.operator_not (SOURCE_FILE_AT_LINE (627))) ;
  if (test_1.isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
  ...
  if (test_2.isValidAndTrue ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_3 (GALGAS_bool (kIsEqual, object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (632)).objectCompare (GALGAS_string ("value")))) ;
    if (test_3.isValidAndTrue ()) {
      //-------- @assignmentInstructionForGeneration
      ...
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_4 (GALGAS_bool (kIsEqual, object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (639)).objectCompare (GALGAS_string ("char")))) ;
      if (test_4.isValidAndTrue ()) {
        //-------- @assignmentInstructionForGeneration
        ...
        //-------- @ifInstructionForGeneration
        const GALGAS_bool test_5 (GALGAS_bool (kIsEqual, object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (646)).objectCompare (GALGAS_string ("string")))) ;
        if (test_5.isValidAndTrue ()) {
          //-------- @assignmentInstructionForGeneration
          ...
          //-------- @ifInstructionForGeneration
          const GALGAS_bool test_6 (GALGAS_bool (kIsEqual, object->mAttribute_mReaderName.reader_string (SOURCE_FILE_AT_LINE (653)).objectCompare (GALGAS_string ("comment")))) ;
...
static void categoryMethod_templateFunctionCallAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_functionSignature.reader_length (SOURCE_FILE_AT_LINE (694)).objectCompare (object->mAttribute_mExpressionList.reader_length (SOURCE_FILE_AT_LINE (694))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateUnaryMinusOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_type.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (929)).operator_and (function_unaryMinusOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (929)) COMMA_SOURCE_FILE_AT_LINE (929)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_structFieldAccessTemplateExpressionAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_type.reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (957)).objectCompare (GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (957))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (988)).reader_string (SOURCE_FILE_AT_LINE (988)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (988)).reader_string (SOURCE_FILE_AT_LINE (988))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateNonEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_leftType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1019)).reader_string (SOURCE_FILE_AT_LINE (1019)).objectCompare (var_rightType.reader_lkey (inCompiler COMMA_SOURCE_FILE_AT_LINE (1019)).reader_string (SOURCE_FILE_AT_LINE (1019))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateStrictInfTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1050)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1050)) COMMA_SOURCE_FILE_AT_LINE (1050)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1055)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1055))))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateInfOrEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1086)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1086)) COMMA_SOURCE_FILE_AT_LINE (1086)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1091)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1091))))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateStrictSupTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1122)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1122)) COMMA_SOURCE_FILE_AT_LINE (1122)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1127)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1127))))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateSupOrEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1158)).operator_and (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1158)) COMMA_SOURCE_FILE_AT_LINE (1158)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_leftType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1163)).objectCompare (var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1163))))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateLeftShiftOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1194)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1194)) COMMA_SOURCE_FILE_AT_LINE (1194)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1199)).objectCompare (GALGAS_string ("uint")))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateRightShiftOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_leftType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE_AT_LINE (1230)).operator_and (function_binaryShiftOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (1230)) COMMA_SOURCE_FILE_AT_LINE (1230)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, var_rightType.reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1235)).objectCompare (GALGAS_string ("uint")))) ;
    if (test_1.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateInstructionExpressionAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1307)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1307)).objectCompare (GALGAS_string ("string")))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateBlockInstructionAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1321)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1321)).objectCompare (GALGAS_string ("uint")))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateInstructionForeachAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, var_enumerationDescriptor.reader_length (SOURCE_FILE_AT_LINE (1358)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_1 (GALGAS_bool (kIsNotEqual, object->mAttribute_mIndexIdentifier.reader_string (SOURCE_FILE_AT_LINE (1368)).objectCompare (GALGAS_string::makeEmptyString ()))) ;
  if (test_1.isValidAndTrue ()) {
...
static void categoryMethod_templateInstructionIfAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  while (enumerator_57244.hasCurrentObject ()) {
    ...
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_expression.reader_mType (SOURCE_FILE_AT_LINE (1414)).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1414)).objectCompare (GALGAS_string ("bool")))) ;
    if (test_0.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
...
static void categoryMethod_templateInstructionSwitchAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_switchExpression.reader_mType (SOURCE_FILE_AT_LINE (1440)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE_AT_LINE (1440)).objectCompare (GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE_AT_LINE (1440))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
  ...
  while (enumerator_59086.hasCurrentObject ()) {
    ...
    while (enumerator_59115.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_1 (var_enumConstantSet.reader_hasKey (enumerator_59115.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1449)) COMMA_SOURCE_FILE_AT_LINE (1449)).operator_not (SOURCE_FILE_AT_LINE (1449))) ;
      if (test_1.isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
      ...
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_3 (var_namedConstantSet.reader_hasKey (enumerator_59115.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1452)) COMMA_SOURCE_FILE_AT_LINE (1452))) ;
      if (test_3.isValidAndTrue ()) {
        //-------- @errorInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_5 (GALGAS_bool (kIsStrictSup, var_missingConstants.reader_count (SOURCE_FILE_AT_LINE (1463)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_5.isValidAndTrue ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
