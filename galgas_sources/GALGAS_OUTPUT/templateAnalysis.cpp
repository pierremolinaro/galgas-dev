...
//                                         september 27th, 2014, at 13h33'44"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
void routine_templateInstructionListAnalysis (const GALGAS_templateAnalysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_templateInstructionListAST enumerator_50773 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_50773.hasCurrentObject ()) {
    callCategoryMethod_templateInstructionAnalysis ((const cPtr_templateInstructionAST *) enumerator_50773.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioInstructionList, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1258)) ;
    enumerator_50773.gotoNextObject () ;
  }
}
...
static void categoryMethod_templateReaderCallInExpressionAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_receiverType = var_receiverExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 68)) ;
  ...
  if (kBoolTrue == test_0) {
    GALGAS_location joker_4108_0 ; // Joker input parameter
    GALGAS_methodQualifier joker_4164_2 ; // Joker input parameter
    GALGAS_string joker_4164_1 ; // Joker input parameter
    var_readerMap.method_searchKey (object->mAttribute_mReaderName, var_kind, var_readerFormalArgumentTypeList, joker_4108_0, var_hasCompilerArgument, var_returnedType, joker_4164_2, joker_4164_1, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 78)) ;
    ...
    if (kBoolTrue == test_1) {
      ...
      cEnumerator_typedAttributeList enumerator_4521 (var_receiverType.reader_mCurrentTypedAttributeList (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 93)), kEnumeration_up) ;
      while (enumerator_4521.hasCurrentObject ()) {
        GALGAS_readerMap var_aMap = enumerator_4521.current_mAttributeTypeProxy (HERE).reader_mReaderMap (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 94)) ;
        const cMapElement_readerMap * objectArray_4605 = (const cMapElement_readerMap *) var_aMap.readAccessForWithInstruction (object->mAttribute_mReaderName.reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 95))) ;
        if (NULL != objectArray_4605) {
            macroValidSharedObject (objectArray_4605, cMapElement_readerMap) ;
          var_matchingReaderCount.increment_operation (inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 96)) ;
          var_readerFormalArgumentTypeList = objectArray_4605->mAttribute_mArgumentTypeList ;
          var_hasCompilerArgument = objectArray_4605->mAttribute_mHasCompilerArgument ;
          var_returnedType = objectArray_4605->mAttribute_mReturnedType ;
          var_kind = objectArray_4605->mAttribute_mKind ;
          var_fieldList.addAssign_operation (enumerator_4521.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 101))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 101)) ;
        }
      ...
      if (kBoolTrue == test_2) {
        ...
        if (kBoolTrue == test_4) {
          ...
          cEnumerator_stringlist enumerator_5358 (var_fieldList, kEnumeration_up) ;
          while (enumerator_5358.hasCurrentObject ()) {
            var_s.dotAssign_operation (enumerator_5358.current_mValue (HERE)  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 113)) ;
            if (enumerator_5358.hasNextObject ()) {
      ...
      if (kBoolTrue == test_6) {
        ...
        GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
        cEnumerator_readerMap enumerator_6056 (var_readerMap, kEnumeration_up) ;
        while (enumerator_6056.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").operator_concat (enumerator_6056.current_lkey (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 130))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 130))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 130)) ;
          cEnumerator_functionSignature enumerator_6124 (enumerator_6056.current_mArgumentTypeList (HERE), kEnumeration_up) ;
          while (enumerator_6124.hasCurrentObject ()) {
            var_s.dotAssign_operation (GALGAS_string (" \?@").operator_concat (enumerator_6124.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 132))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 132))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 132)) ;
            enumerator_6124.gotoNextObject () ;
          }
          var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_6056.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 134))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 134))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 134)) ;
  ...
  if (kBoolTrue == test_11) {
    ...
    cEnumerator_templateExpressionListAST enumerator_7099 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    cEnumerator_functionSignature enumerator_7129 (var_readerFormalArgumentTypeList, kEnumeration_up) ;
    while (enumerator_7099.hasCurrentObject () && enumerator_7129.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) enumerator_7099.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, var_exp, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 152)) ;
      const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_7129.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_7099.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_13) {
        GALGAS_string temp_14 ;
        const enumGalgasBool test_15 = GALGAS_bool (kIsNotEqual, enumerator_7129.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_15) {
          temp_14 = GALGAS_string (":") ;
        }else if (kBoolFalse == test_15) {
          temp_14 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_16 (enumerator_7099.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_16, GALGAS_string ("the selector should be '!").operator_concat (enumerator_7129.current_mFormalSelector (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 154))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 154)).operator_concat (temp_14.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 154))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 154))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 154)) ;
      }
      {
      routine_checkAssignmentTypes (enumerator_7129.current_mFormalArgumentType (HERE), var_exp.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 156)), enumerator_7099.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 156)) ;
      }
...
static void categoryMethod_templateConstructorAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  const cMapElement_constructorMap * objectArray_8734 = (const cMapElement_constructorMap *) var_constructorMap.readAccessForWithInstruction (object->mAttribute_mConstructorName.reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 187))) ;
  if (NULL != objectArray_8734) {
      macroValidSharedObject (objectArray_8734, cMapElement_constructorMap) ;
    var_constructorFormalArgumentTypeList = objectArray_8734->mAttribute_mArgumentTypeList ;
    var_hasCompilerArgument = objectArray_8734->mAttribute_mHasCompilerArgument ;
    var_returnedType = objectArray_8734->mAttribute_mReturnedType ;
  }else{
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_constructorMap enumerator_9227 (var_constructorMap, kEnumeration_up) ;
      while (enumerator_9227.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - ").operator_concat (enumerator_9227.current_lkey (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 200))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 200))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 200)) ;
        cEnumerator_functionSignature enumerator_9295 (enumerator_9227.current_mArgumentTypeList (HERE), kEnumeration_up) ;
        while (enumerator_9295.hasCurrentObject ()) {
          GALGAS_string temp_2 ;
          const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_9295.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_3) {
            temp_2 = enumerator_9295.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 202)) ;
          }else if (kBoolFalse == test_3) {
            temp_2 = GALGAS_string::makeEmptyString () ;
          }
          var_s.dotAssign_operation (GALGAS_string (" \?").add_operation (temp_2, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 202)).add_operation (GALGAS_string ("@"), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 202)).operator_concat (enumerator_9295.current_mFormalArgumentType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 202))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 202))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 202)) ;
          enumerator_9295.gotoNextObject () ;
        }
        var_s.dotAssign_operation (GALGAS_string (" -> @").operator_concat (enumerator_9227.current_mReturnedType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 204))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 204))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 204)) ;
  ...
  if (kBoolTrue == test_7) {
    ...
    cEnumerator_templateExpressionListAST enumerator_10513 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    cEnumerator_functionSignature enumerator_10548 (var_constructorFormalArgumentTypeList, kEnumeration_up) ;
    while (enumerator_10513.hasCurrentObject () && enumerator_10548.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_exp ;
      callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) enumerator_10513.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, var_exp, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 226)) ;
      const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, enumerator_10548.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_10513.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_9) {
        GALGAS_string temp_10 ;
        const enumGalgasBool test_11 = GALGAS_bool (kIsNotEqual, enumerator_10548.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_11) {
          temp_10 = GALGAS_string (":") ;
        }else if (kBoolFalse == test_11) {
          temp_10 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_12 (enumerator_10513.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_12, GALGAS_string ("the selector should be '!").operator_concat (enumerator_10548.current_mFormalSelector (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 228))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 228)).operator_concat (temp_10.add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 228))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 228))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 228)) ;
      }
      {
      routine_checkAssignmentTypes (enumerator_10548.current_mFormalArgumentType (HERE), var_exp.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 230)), enumerator_10513.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 230)) ;
      }
...
static void categoryMethod_templateAndOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 282)) ;
  {
...
static void categoryMethod_templateOrOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 313)) ;
  {
...
static void categoryMethod_templateXorOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 344)) ;
  {
...
static void categoryMethod_templateLiteralStringExpressionAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
  cEnumerator_stringlist enumerator_16814 (object->mAttribute_mLiteralStringList, kEnumeration_up) ;
  while (enumerator_16814.hasCurrentObject ()) {
    var_s.dotAssign_operation (enumerator_16814.current_mValue (HERE)  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 388)) ;
...
static void categoryMethod_templateNotOperatorAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_type = var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 519)) ;
...
static void categoryMethod_templateLogicalNegateAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_type = var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 545)) ;
...
static void categoryMethod_templateOptionAccessAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
    cEnumerator_commandLineOptionMap enumerator_25506 (var_boolOptionMap, kEnumeration_up) ;
    while (enumerator_25506.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_25506.current_lkey (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 626))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 626)).operator_concat (GALGAS_string ("' @bool option;")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 626))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 626)) ;
      enumerator_25506.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_25602 (var_uintOptionMap, kEnumeration_up) ;
    while (enumerator_25602.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_25602.current_lkey (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 629))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 629)).operator_concat (GALGAS_string ("' @uint option;")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 629))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 629)) ;
      enumerator_25602.gotoNextObject () ;
    }
    cEnumerator_commandLineOptionMap enumerator_25700 (var_stringOptionMap, kEnumeration_up) ;
    while (enumerator_25700.hasCurrentObject ()) {
      var_s.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (enumerator_25700.current_lkey (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 632))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 632)).operator_concat (GALGAS_string ("' @string option;")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 632))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 632)) ;
...
static void categoryMethod_templateFunctionCallAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_functionSignature enumerator_27485 (var_functionSignature, kEnumeration_up) ;
    cEnumerator_templateExpressionListAST enumerator_27502 (object->mAttribute_mExpressionList, kEnumeration_up) ;
    while (enumerator_27485.hasCurrentObject () && enumerator_27502.hasCurrentObject ()) {
      GALGAS_semanticExpressionForGeneration var_expression ;
      callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) enumerator_27502.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, var_expression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 674)) ;
      {
      routine_checkAssignmentTypes (enumerator_27485.current_mFormalArgumentType (HERE), var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 675)), enumerator_27502.current_mEndOfExpressionLocation (HERE), inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 675)) ;
      }
      ...
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, enumerator_27485.current_mFormalSelector (HERE).mAttribute_string.objectCompare (enumerator_27502.current_mActualSelector (HERE).mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_5) {
        GALGAS_string temp_6 ;
        const enumGalgasBool test_7 = GALGAS_bool (kIsNotEqual, enumerator_27485.current_mFormalSelector (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_7) {
          temp_6 = enumerator_27485.current_mFormalSelector (HERE).mAttribute_string.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 678)) ;
        }else if (kBoolFalse == test_7) {
          temp_6 = GALGAS_string::makeEmptyString () ;
        }
        GALGAS_location location_8 (enumerator_27502.current_mActualSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
...
static void categoryMethod_templateAddOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 738)) ;
  {
...
static void categoryMethod_templateSubOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 771)) ;
  {
...
static void categoryMethod_templateMultiplyOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 804)) ;
  {
...
static void categoryMethod_templateDivideOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 837)) ;
  {
...
static void categoryMethod_templateModuloOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 870)) ;
  {
...
static void categoryMethod_templateUnaryMinusOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_type = var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 900)) ;
...
static void categoryMethod_structFieldAccessTemplateExpressionAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_type = var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 928)) ;
...
static void categoryMethod_templateEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 958)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 959)) ;
...
static void categoryMethod_templateNonEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 989)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 990)) ;
...
static void categoryMethod_templateStrictInfTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1020)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1021)) ;
...
static void categoryMethod_templateInfOrEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1056)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1057)) ;
...
static void categoryMethod_templateStrictSupTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1092)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1093)) ;
...
static void categoryMethod_templateSupOrEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1128)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1129)) ;
...
static void categoryMethod_templateLeftShiftOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1164)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1165)) ;
...
static void categoryMethod_templateRightShiftOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1200)) ;
  GALGAS_unifiedTypeMapProxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1201)) ;
...
static void categoryMethod_templateClassToTypeOperandAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_bool joker_49640_26 ; // Joker input parameter
  GALGAS_bool joker_49640_25 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_49640_24 ; // Joker input parameter
  GALGAS_typeKindEnum joker_49640_23 ; // Joker input parameter
  GALGAS_bool joker_49640_22 ; // Joker input parameter
  GALGAS_typedAttributeList joker_49640_21 ; // Joker input parameter
  GALGAS_attributeMap joker_49640_20 ; // Joker input parameter
  GALGAS_typedAttributeList joker_49640_19 ; // Joker input parameter
  GALGAS_constructorMap joker_49640_18 ; // Joker input parameter
  GALGAS_readerMap joker_49640_17 ; // Joker input parameter
  GALGAS_modifierMap joker_49640_16 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_49640_15 ; // Joker input parameter
  GALGAS_classMethodMap joker_49640_14 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_49640_13 ; // Joker input parameter
  GALGAS_stringlist joker_49640_12 ; // Joker input parameter
  GALGAS_uint joker_49640_11 ; // Joker input parameter
  GALGAS_functionSignature joker_49640_10 ; // Joker input parameter
  GALGAS_constantIndexMap joker_49640_9 ; // Joker input parameter
  GALGAS_enumConstantList joker_49640_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_49640_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_49640_6 ; // Joker input parameter
  GALGAS_bool joker_49640_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_49640_4 ; // Joker input parameter
  GALGAS_string joker_49640_3 ; // Joker input parameter
  GALGAS_string joker_49640_2 ; // Joker input parameter
  GALGAS_headerKind joker_49640_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mTypeName, joker_49640_26, joker_49640_25, joker_49640_24, joker_49640_23, joker_49640_22, joker_49640_21, joker_49640_20, joker_49640_19, joker_49640_18, joker_49640_17, joker_49640_16, joker_49640_15, joker_49640_14, joker_49640_13, joker_49640_12, joker_49640_11, joker_49640_10, joker_49640_9, joker_49640_8, joker_49640_7, joker_49640_6, joker_49640_5, joker_49640_4, joker_49640_3, joker_49640_2, joker_49640_1, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1230)) ;
...
static void categoryMethod_templateInstructionExpressionAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1279)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1279)).objectCompare (GALGAS_string ("string"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mLocation, GALGAS_string ("expression type should be '@string' (it is '@").operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1280)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1280))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1280)).operator_concat (GALGAS_string ("')")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1280))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1280)) ;
  }
...
static void categoryMethod_templateBlockInstructionAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1293)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1293)).objectCompare (GALGAS_string ("uint"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mLocation, GALGAS_string ("expression type should be '@uint' (it is '@").operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1294)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1294))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1294)).operator_concat (GALGAS_string ("')")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1294))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1294)) ;
  }
...
static void categoryMethod_templateInstructionForeachAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1329)).reader_mEnumerationDescriptor (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1329)) ;
  ...
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (var_expression.reader_mLocation (SOURCE_FILE ("templateAnalysis.gSemantics", 1331)), GALGAS_string ("expression of '@").operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1331)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1331))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1331)).operator_concat (GALGAS_string ("' cannot be enumerated")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1331))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1331)) ;
  }
  ...
  cEnumerator_enumerationDescriptorList enumerator_55098 (var_enumerationDescriptor, kEnumeration_up) ;
  while (enumerator_55098.hasCurrentObject ()) {
    {
    var_doVariableMap.modifier_insertKey (GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.operator_concat (enumerator_55098.current_mEnumerationName (HERE)  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1345)), var_expression.reader_mLocation (SOURCE_FILE ("templateAnalysis.gSemantics", 1345))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1345)), enumerator_55098.current_mEnumeratedType (HERE), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1347)).operator_concat (enumerator_55098.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("templateAnalysis.gSemantics", 1347))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1347)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1347)), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1344)) ;
    }
    enumerator_55098.gotoNextObject () ;
  }
...
static void categoryMethod_templateInstructionIfAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  cEnumerator_templateInstructionIfBranchListAST enumerator_56762 (object->mAttribute_mTemplateInstructionIfBranchList, kEnumeration_up) ;
  while (enumerator_56762.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_expression ;
    callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) enumerator_56762.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, var_expression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1385)) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1386)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1386)).objectCompare (GALGAS_string ("bool"))).boolEnum () ;
    if (kBoolTrue == test_0) {
      inCompiler->emitSemanticError (var_expression.reader_mLocation (SOURCE_FILE ("templateAnalysis.gSemantics", 1387)), GALGAS_string ("'if' expression type should be '@bool' (it is '@").operator_concat (var_expression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1387)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1387))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1387)).operator_concat (GALGAS_string ("')")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1387))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1387)) ;
    }
    ...
    {
    routine_templateInstructionListAnalysis (constinArgument_inAnalysisContext, enumerator_56762.current_mInstructionList (HERE), var_instructionList, inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1390)) ;
    }
    ...
    enumerator_56762.gotoNextObject () ;
  }
...
static void categoryMethod_templateInstructionSwitchAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  cEnumerator_templateInstructionSwitchBranchListAST enumerator_58623 (object->mAttribute_mTemplateInstructionSwitchBranchList, kEnumeration_up) ;
  while (enumerator_58623.hasCurrentObject ()) {
    cEnumerator_lstringlist enumerator_58652 (enumerator_58623.current_mConstantList (HERE), kEnumeration_up) ;
    while (enumerator_58652.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantMap.reader_hasKey (enumerator_58652.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1421)) COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1421)).operator_not (SOURCE_FILE ("templateAnalysis.gSemantics", 1421)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_location location_2 (enumerator_58652.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (enumerator_58652.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1422))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422)).operator_concat (GALGAS_string ("' is not a contant of '@")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422)).operator_concat (var_switchExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1422)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422)).operator_concat (GALGAS_string ("' enumeration type")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422)) ;
      }
      const enumGalgasBool test_3 = var_namedConstantSet.reader_hasKey (enumerator_58652.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1424)) COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1424)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_58652.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the '").operator_concat (enumerator_58652.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1425))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1425)).operator_concat (GALGAS_string ("' constant is already named in the switch instruction")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1425))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1425)) ;
      }
      var_namedConstantSet.addAssign_operation (enumerator_58652.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1427))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1427)) ;
    ...
    {
    routine_templateInstructionListAnalysis (constinArgument_inAnalysisContext, enumerator_58623.current_mInstructionList (HERE), var_instructionList, inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1430)) ;
    }
    var_templateInstructionSwitchBranchList.addAssign_operation (enumerator_58623.current_mConstantList (HERE), var_instructionList  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1431)) ;
    enumerator_58623.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_stringset enumerator_59651 (var_missingConstants, kEnumeration_up) ;
    while (enumerator_59651.hasCurrentObject ()) {
      var_m.dotAssign_operation (GALGAS_string ("\n"
        "  - '").operator_concat (enumerator_59651.current_key (HERE)  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1438)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1438))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1438)) ;
      enumerator_59651.gotoNextObject () ;
    }
