...
void routine_templateInstructionListAnalysis (const GALGAS_templateAnalysisContext constinArgument_inAnalysisContext,
  ...
  cEnumerator_templateInstructionListAST enumerator_50812 (constinArgument_inInstructionList, kEnumeration_up) ;
  while (enumerator_50812.hasCurrentObject ()) {
    callCategoryMethod_templateInstructionAnalysis ((const cPtr_templateInstructionAST *) enumerator_50812.current_mInstruction (HERE).ptr (), constinArgument_inAnalysisContext, ioArgument_ioInstructionList, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1258)) ;
    enumerator_50812.gotoNextObject () ;
  }
}
...
static void categoryMethod_templateReaderCallInExpressionAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_location joker_4111_0 ; // Joker input parameter
    GALGAS_methodQualifier joker_4167_2 ; // Joker input parameter
    GALGAS_string joker_4167_1 ; // Joker input parameter
    var_readerMap.method_searchKey (object->mAttribute_mReaderName, var_kind, var_readerFormalArgumentTypeList, joker_4111_0, var_hasCompilerArgument, var_returnedType, joker_4167_2, joker_4167_1, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 78)) ;
...
static void categoryMethod_templateEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 958)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 959)) ;
...
static void categoryMethod_templateNonEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 989)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 990)) ;
...
static void categoryMethod_templateStrictInfTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1020)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1021)) ;
...
static void categoryMethod_templateInfOrEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1056)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1057)) ;
...
static void categoryMethod_templateStrictSupTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1092)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1093)) ;
...
static void categoryMethod_templateSupOrEqualTestAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1128)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1129)) ;
...
static void categoryMethod_templateLeftShiftOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1164)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1165)) ;
...
static void categoryMethod_templateRightShiftOperationAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_leftType = var_leftExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1200)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_rightType = var_rightExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1201)) ;
...
static void categoryMethod_templateClassToTypeOperandAST_templateExpressionAnalysis (const cPtr_templateExpressionAST * inObject,
  ...
  GALGAS_bool joker_49678_26 ; // Joker input parameter
  GALGAS_bool joker_49678_25 ; // Joker input parameter
  GALGAS_unifiedTypeMap_2D_proxy joker_49678_24 ; // Joker input parameter
  GALGAS_typeKindEnum joker_49678_23 ; // Joker input parameter
  GALGAS_bool joker_49678_22 ; // Joker input parameter
  GALGAS_typedAttributeList joker_49678_21 ; // Joker input parameter
  GALGAS_attributeMap joker_49678_20 ; // Joker input parameter
  GALGAS_typedAttributeList joker_49678_19 ; // Joker input parameter
  GALGAS_constructorMap joker_49678_18 ; // Joker input parameter
  GALGAS_readerMap joker_49678_17 ; // Joker input parameter
  GALGAS_modifierMap joker_49678_16 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_49678_15 ; // Joker input parameter
  GALGAS_classMethodMap joker_49678_14 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_49678_13 ; // Joker input parameter
  GALGAS_stringlist joker_49678_12 ; // Joker input parameter
  GALGAS_uint joker_49678_11 ; // Joker input parameter
  GALGAS_functionSignature joker_49678_10 ; // Joker input parameter
  GALGAS_constantIndexMap joker_49678_9 ; // Joker input parameter
  GALGAS_enumConstantList joker_49678_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_49678_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_49678_6 ; // Joker input parameter
  GALGAS_bool joker_49678_5 ; // Joker input parameter
  GALGAS_unifiedTypeMap_2D_proxy joker_49678_4 ; // Joker input parameter
  GALGAS_string joker_49678_3 ; // Joker input parameter
  GALGAS_string joker_49678_2 ; // Joker input parameter
  GALGAS_headerKind joker_49678_1 ; // Joker input parameter
  constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mTypeName, joker_49678_26, joker_49678_25, joker_49678_24, joker_49678_23, joker_49678_22, joker_49678_21, joker_49678_20, joker_49678_19, joker_49678_18, joker_49678_17, joker_49678_16, joker_49678_15, joker_49678_14, joker_49678_13, joker_49678_12, joker_49678_11, joker_49678_10, joker_49678_9, joker_49678_8, joker_49678_7, joker_49678_6, joker_49678_5, joker_49678_4, joker_49678_3, joker_49678_2, joker_49678_1, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1230)) ;
  outArgument_outExpression = GALGAS_literalTypeInExpressionForGeneration::constructor_new (GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inAnalysisContext.mAttribute_mSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (GALGAS_string ("type"), inCompiler->here ()  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1233)), inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1233)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("templateAnalysis.gSemantics", 1234)), object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1235))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1232)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_templateInstructionForeachAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  cEnumerator_enumerationDescriptorList enumerator_55137 (var_enumerationDescriptor, kEnumeration_up) ;
  while (enumerator_55137.hasCurrentObject ()) {
    {
    var_doVariableMap.modifier_insertKey (GALGAS_lstring::constructor_new (object->mAttribute_mPrefix.operator_concat (enumerator_55137.current_mEnumerationName (HERE)  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1345)), var_expression.reader_mLocation (SOURCE_FILE ("templateAnalysis.gSemantics", 1345))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1345)), enumerator_55137.current_mEnumeratedType (HERE), var_enumeratorCppName.operator_concat (GALGAS_string (".current_")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1347)).operator_concat (enumerator_55137.current_mEnumerationName (HERE).reader_identifierRepresentation (SOURCE_FILE ("templateAnalysis.gSemantics", 1347))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1347)).operator_concat (GALGAS_string (" (HERE)")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1347)), inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1344)) ;
    }
    enumerator_55137.gotoNextObject () ;
  }
...
static void categoryMethod_templateInstructionIfAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  cEnumerator_templateInstructionIfBranchListAST enumerator_56801 (object->mAttribute_mTemplateInstructionIfBranchList, kEnumeration_up) ;
  while (enumerator_56801.hasCurrentObject ()) {
    GALGAS_semanticExpressionForGeneration var_expression ;
    callCategoryMethod_templateExpressionAnalysis ((const cPtr_templateExpressionAST *) enumerator_56801.current_mExpression (HERE).ptr (), constinArgument_inAnalysisContext, var_expression, inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1385)) ;
    ...
    {
    routine_templateInstructionListAnalysis (constinArgument_inAnalysisContext, enumerator_56801.current_mInstructionList (HERE), var_instructionList, inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1390)) ;
    }
    ...
    enumerator_56801.gotoNextObject () ;
  }
...
static void categoryMethod_templateInstructionSwitchAST_templateInstructionAnalysis (const cPtr_templateInstructionAST * inObject,
  ...
  cEnumerator_templateInstructionSwitchBranchListAST enumerator_58662 (object->mAttribute_mTemplateInstructionSwitchBranchList, kEnumeration_up) ;
  while (enumerator_58662.hasCurrentObject ()) {
    cEnumerator_lstringlist enumerator_58691 (enumerator_58662.current_mConstantList (HERE), kEnumeration_up) ;
    while (enumerator_58691.hasCurrentObject ()) {
      const enumGalgasBool test_1 = var_enumConstantMap.reader_hasKey (enumerator_58691.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1421)) COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1421)).operator_not (SOURCE_FILE ("templateAnalysis.gSemantics", 1421)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_location location_2 (enumerator_58691.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (enumerator_58691.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1422))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422)).operator_concat (GALGAS_string ("' is not a contant of '@")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422)).operator_concat (var_switchExpression.reader_mResultType (SOURCE_FILE ("templateAnalysis.gSemantics", 1422)).reader_key (inCompiler COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422)).operator_concat (GALGAS_string ("' enumeration type")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1422)) ;
      }
      const enumGalgasBool test_3 = var_namedConstantSet.reader_hasKey (enumerator_58691.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1424)) COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1424)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_58691.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_4, GALGAS_string ("the '").operator_concat (enumerator_58691.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1425))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1425)).operator_concat (GALGAS_string ("' constant is already named in the switch instruction")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1425))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1425)) ;
      }
      var_namedConstantSet.addAssign_operation (enumerator_58691.current_mValue (HERE).reader_string (SOURCE_FILE ("templateAnalysis.gSemantics", 1427))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1427)) ;
    ...
    {
    routine_templateInstructionListAnalysis (constinArgument_inAnalysisContext, enumerator_58662.current_mInstructionList (HERE), var_instructionList, inCompiler  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1430)) ;
    }
    var_templateInstructionSwitchBranchList.addAssign_operation (enumerator_58662.current_mConstantList (HERE), var_instructionList  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1431)) ;
  ...
  if (kBoolTrue == test_5) {
    ...
    cEnumerator_stringset enumerator_59690 (var_missingConstants, kEnumeration_up) ;
    while (enumerator_59690.hasCurrentObject ()) {
      var_m.dotAssign_operation (GALGAS_string ("\n"
        "  - '").operator_concat (enumerator_59690.current_key (HERE)  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1438)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1438))  COMMA_SOURCE_FILE ("templateAnalysis.gSemantics", 1438)) ;
      enumerator_59690.gotoNextObject () ;
    }
