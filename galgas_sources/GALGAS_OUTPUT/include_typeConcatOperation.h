//---------------------------------------------------------------------------*
//                                                                           *
//                   File 'include_typeConcatOperation.h'                    *
...
#ifndef typeConcatOperation_DEFINED
#define typeConcatOperation_DEFINED
...
/* class GGG_typeConcatOperation : public GGG_typeExpression {
  private : typedef GGG_typeExpression inherited ;
  public : GGG_typeConcatOperation (const GGS_typeExpression & ,
                                const GGS_typeExpression &  COMMA_LOCATION_ARGS) ;
} ; */
