...
//--- Enumeration
  public : enum enumeration {kNotBuilt, enum_classType, enum_enumType, enum_listMapType, enum_listType, enum_mapProxyType, enum_mapType, enum_primitiveType, enum_sortedListType, enum_structType} ;
