...
//---------------------------------------------------------------------------*
//                                                                           *
//                     Function 'concatAssignOperator'                       *
//                                                                           *
//---------------------------------------------------------------------------*

extern const C_galgas_function_descriptorEX kFunction_descriptor_concatAssignOperator ;

//---------------------------------------------------------------------------*

GGS_uint  function_concatAssignOperator (C_Compiler & COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Map Enumerator
  ...
  //--- Iterator method
    ...
    public : /* const */ GGS_unifiedTypeMapIndexList   & _mAddAssignOperatorArguments (LOCATION_ARGS) const ;
    public : /* const */ GGS_unifiedTypeMapIndexList   & _mMinusAssignOperatorArguments (LOCATION_ARGS) const ;
    public : /* const */ GGS_nativeAttributeList   & _mNativeAttributeList (LOCATION_ARGS) const ;
    public : /* const */ GGS_string  & _mSuperClassForCodeGeneration (LOCATION_ARGS) const ;
    public : /* const */ GGS_semanticDeclarationAST   & _mDeclarationAST (LOCATION_ARGS) const ;
  } ;
} ;
...
//--- Attribute access
  ...
  public : GGS_unifiedTypeMapIndexList  reader_mAddAssignOperatorArguments (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
  public : GGS_unifiedTypeMapIndexList  reader_mMinusAssignOperatorArguments (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
  public : GGS_nativeAttributeList  reader_mNativeAttributeList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
  public : GGS_string reader_mSuperClassForCodeGeneration (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
  public : GGS_semanticDeclarationAST  reader_mDeclarationAST (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
//--- Constructors from map readers
  public : static GGS_unifiedTypeMapIndex constructor_searchKey (C_Compiler & inLexique,
...
typedef void (*typeCategoryMethod__predefinedTypeAST__getMinusAssignArgumentList)  (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * inObjectPtr,
                                GGS_unifiedTypeMap  & var_cas_ioUnifiedTypeMap,
                                GGS_unifiedTypeMapIndexList  & var_cas_outAddAssignArgumentList
                                COMMA_LOCATION_ARGS) ;
...
class e_unifiedTypeMap {
  ...
  public : GGS_unifiedTypeMapIndexList  mAddAssignOperatorArguments ;
  public : GGS_unifiedTypeMapIndexList  mMinusAssignOperatorArguments ;
  public : GGS_nativeAttributeList  mNativeAttributeList ;
  public : GGS_string mSuperClassForCodeGeneration ;
  public : GGS_semanticDeclarationAST  mDeclarationAST ;
