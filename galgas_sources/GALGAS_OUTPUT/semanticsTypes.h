...
class GGS_enumeratedItemsWithForeachInstruction ;
...
class GGS_unifiedTypeMapIndexList : public AC_galgas_list {
...
class elementOf_GGS_methodMap ;

extern const C_galgas_type_descriptorEX kTypeDescriptor_GGS_methodMap ;

//---------------------------------------------------------------------------*

class GGS_methodMap : public AC_galgas_map {
//--- Element Class
  public : typedef elementOf_GGS_methodMap cElement ;
...
//--- Comparison methods
  public : GGS_bool operator_isEqual (const GGS_methodMap & inOperand) const ;
  public : GGS_bool operator_isNotEqual (const GGS_methodMap & inOperand) const ;
...
//--- Introspection
  ...
  public : static GGS_methodMap castFromObject (C_Compiler & inLexique,
                                           const GGS_object & inObject,
                                           const GGS_location & inErrorLocation
                                           COMMA_LOCATION_ARGS) ;
...
//--- Get object pointer (for method call)
  public : inline GGS_methodMap * operator () (UNUSED_LOCATION_ARGS) { return this ; }
  public : inline const GGS_methodMap * operator () (UNUSED_LOCATION_ARGS) const { return this ; }

//--- 'emptyMap' constructor
  public : static GGS_methodMap constructor_emptyMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) ;
...
//--- Internal method for searching for an element
  protected : void searchElement (C_Compiler & inLexique,
                                   ...
                                   COMMA_LOCATION_ARGS) const ;
  public : virtual GGS_string reader_description (const PMSInt32 inIndentation = 0) const ;
  public : static GGS_methodMap constructor_mapWithMapToOverride (C_Compiler & inLexique,
                                            const GGS_methodMap & inMapToOverride
                                            COMMA_LOCATION_ARGS) ;
  public : GGS_methodMap reader_overriddenMap (C_Compiler & inLexique
                                            COMMA_LOCATION_ARGS) const ;
//--------------------------------- Map Enumerator
  public : class cEnumerator : public cAbstractMapEnumerator {
  //--- Constructors
    public : inline cEnumerator (const GGS_methodMap & inMap,
                                 const bool inAscending) :
    cAbstractMapEnumerator (inMap, inAscending) {
    }
    public : inline cEnumerator (const GGS_methodMap & inMap) :
...
class elementOf_GGS_enumeratedItemsWithForeachInstruction ;

//---------------------------------------------------------------------------*

extern const C_galgas_type_descriptorEX kTypeDescriptor_GGS_enumeratedItemsWithForeachInstruction ;

//---------------------------------------------------------------------------*

class GGS_enumeratedItemsWithForeachInstruction : public AC_galgas_list {
  public : typedef elementOf_GGS_enumeratedItemsWithForeachInstruction cElement ;

//--- Constructor 'emptyList'
  public : static GGS_enumeratedItemsWithForeachInstruction constructor_emptyList (void) ;
  public : static GGS_enumeratedItemsWithForeachInstruction constructor_listWithValue (const GGS_unifiedTypeMapIndex & argument_0,
...
//--- Get sublist
  ...
  public : GGS_enumeratedItemsWithForeachInstruction
  reader_subListWithRange (C_Compiler & inLexique,
                           const GGS_uint & inFirstIndex,
                           const GGS_uint & inCount
                           COMMA_LOCATION_ARGS) const ;
...
//--- Operator () used for method call
  public : const GGS_enumeratedItemsWithForeachInstruction * operator () (UNUSED_LOCATION_ARGS) const { return this ;} 
//--- Method 'first'
  public : void method_first (C_Compiler & inLexique,
                              GGS_unifiedTypeMapIndex & _out_0,
                              GGS_string& _out_1
...
//--- Modifier 'popFirst'
  public : void modifier_popFirst (C_Compiler & inLexique,
                                 ...
                                 COMMA_LOCATION_ARGS) ;
//--- Handle '.=' operator
  public : void dotAssign_operation (const GGS_enumeratedItemsWithForeachInstruction inOperand) ;

//--- Handling '+=' GALGAS operator
  public : void addAssign_operation (const GGS_unifiedTypeMapIndex & argument_0,
                                const GGS_string& argument_1) ;
//--- Handling '.' GALGAS operator
  public : GGS_enumeratedItemsWithForeachInstruction operator_concat (const GGS_enumeratedItemsWithForeachInstruction & inOperand) const ;
  public : void modifier_prependValue (C_Compiler & inLexique,
                                const GGS_unifiedTypeMapIndex & argument_0,
                                const GGS_string& argument_1
                                COMMA_LOCATION_ARGS) ;
...
//--- Introspection
  ...
  public : static GGS_enumeratedItemsWithForeachInstruction castFromObject (C_Compiler & inLexique,
                                           const GGS_object & inObject,
                                           const GGS_location & inErrorLocation
                                           COMMA_LOCATION_ARGS) ;
...
//--------------------------------- List Enumerator
  public : class cEnumerator : public cAbstractListEnumerator {
  //--- Constructor
    public : inline cEnumerator (const GGS_enumeratedItemsWithForeachInstruction & inList,
                                 const bool inAscending) :
    cAbstractListEnumerator (inList, inAscending) {
    }
  //--- Iterator method
...
//--------------------------------- Map Enumerator
  ...
  //--- Iterator method
    ...
    public : /* const */ GGS_bool  & _mIsAbstract (LOCATION_ARGS) const ;
    ...
    public : /* const */ GGS_methodMap   & _mMethodMap (LOCATION_ARGS) const ;
    public : /* const */ GGS_classMethodMap   & _mClassMethodMap (LOCATION_ARGS) const ;
    public : /* const */ GGS_enumeratedItemsWithForeachInstruction   & _mEnumeratedItemsWithForeachInstruction (LOCATION_ARGS) const ;
  } ;
} ;
...
class GGS_unifiedTypeMapIndex : public AC_galgas_mapindex {
//--- 'null' constructor
...
//--- Attribute access
  ...
  public : GGS_methodMap  reader_mMethodMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
  public : GGS_classMethodMap  reader_mClassMethodMap (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
  public : GGS_enumeratedItemsWithForeachInstruction  reader_mEnumeratedItemsWithForeachInstruction (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
} ;
...
class elementOf_GGS_unifiedTypeMapIndexList : public AC_galgas_list::cListElement {
//--- Attributes
...
class e_methodMap {
  ...
  public : e_methodMap (void) ;
} ;

//---------------------------------------------------------------------------*

class elementOf_GGS_methodMap : public AC_galgas_map_element {
//--- Constructor
  public : elementOf_GGS_methodMap (const GGS_lstring & inKey,
                                     const PMSInt32 inIndex,
                                     const e_methodMap & inInfo) ;
//--- Get pointers
  public : inline elementOf_GGS_methodMap * nextObject (void) const { return (elementOf_GGS_methodMap *) mNextItem ; }
  public : inline elementOf_GGS_methodMap * infObject (void) const { return (elementOf_GGS_methodMap *) mInfPtr ; }
  public : inline elementOf_GGS_methodMap * supObject (void) const { return (elementOf_GGS_methodMap *) mSupPtr ; }
//--- Comparison
  protected : virtual bool isEqualToMapElement (const AC_galgas_map_element * inOperand) const ;
//--- Data member
  public : e_methodMap mInfo ;
//--- Method for 'description' reader
  public : void appendForMapDescription (const PMSInt32 inElementIndex,
                                         C_String & ioString,
                                         const PMSInt32 inIndentation) const ;
...
class elementOf_GGS_enumeratedItemsWithForeachInstruction : public AC_galgas_list::cListElement {
//--- Attributes
  public : GGS_unifiedTypeMapIndex  mEnumeratedType ;
  public : GGS_string mEnumerationName ;
//--- Constructor
  public : elementOf_GGS_enumeratedItemsWithForeachInstruction (const GGS_unifiedTypeMapIndex & ,
                                const GGS_string& 
                                COMMA_LOCATION_ARGS) ;

//--- Access to next
  public : inline elementOf_GGS_enumeratedItemsWithForeachInstruction * nextObject (void) const { return (elementOf_GGS_enumeratedItemsWithForeachInstruction *) internalNextItem () ; }

//--- Access to previous
  public : inline elementOf_GGS_enumeratedItemsWithForeachInstruction * previousObject (void) const { return (elementOf_GGS_enumeratedItemsWithForeachInstruction *) internalPreviousItem () ; }
...
//--- Friend class declaration
  friend class GGS_enumeratedItemsWithForeachInstruction ;
} ;
...
class e_unifiedTypeMap {
  ...
  public : GGS_methodMap  mMethodMap ;
  public : GGS_classMethodMap  mClassMethodMap ;
  public : GGS_enumeratedItemsWithForeachInstruction  mEnumeratedItemsWithForeachInstruction ;
