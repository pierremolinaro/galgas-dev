...
//--- Enumeration
  public : enum enumeration {kNotBuilt, enum_classType, enum_enumType, enum_listMapType, enum_listType, enum_mapProxyType, enum_mapType, enum_predefined_binaryset, enum_predefined_bool, enum_predefined_char, enum_predefined_data, enum_predefined_double, enum_predefined_function, enum_predefined_location, enum_predefined_sint, enum_predefined_sint64, enum_predefined_string, enum_predefined_stringset, enum_predefined_type, enum_predefined_uint, enum_predefined_uint64, enum_sortedListType, enum_structType} ;
...
//--- Construction from GALGAS constructor
  ...
  public : static inline GGS_typeKindEnum  constructor_predefined_binaryset (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_typeKindEnum (enum_predefined_binaryset) ;
  }
  public : static inline GGS_typeKindEnum  constructor_predefined_bool (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_typeKindEnum (enum_predefined_bool) ;
  }
  public : static inline GGS_typeKindEnum  constructor_predefined_char (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_typeKindEnum (enum_predefined_char) ;
  }
  public : static inline GGS_typeKindEnum  constructor_predefined_data (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_typeKindEnum (enum_predefined_data) ;
  }
  public : static inline GGS_typeKindEnum  constructor_predefined_double (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_typeKindEnum (enum_predefined_double) ;
  }
  public : static inline GGS_typeKindEnum  constructor_predefined_function (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_typeKindEnum (enum_predefined_function) ;
  }
  public : static inline GGS_typeKindEnum  constructor_predefined_location (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_typeKindEnum (enum_predefined_location) ;
  }
  public : static inline GGS_typeKindEnum  constructor_predefined_sint (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_typeKindEnum (enum_predefined_sint) ;
  }
  public : static inline GGS_typeKindEnum  constructor_predefined_sint64 (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_typeKindEnum (enum_predefined_sint64) ;
  }
  public : static inline GGS_typeKindEnum  constructor_predefined_string (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_typeKindEnum (enum_predefined_string) ;
  }
  public : static inline GGS_typeKindEnum  constructor_predefined_stringset (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_typeKindEnum (enum_predefined_stringset) ;
  }
  public : static inline GGS_typeKindEnum  constructor_predefined_type (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_typeKindEnum (enum_predefined_type) ;
  }
  public : static inline GGS_typeKindEnum  constructor_predefined_uint (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_typeKindEnum (enum_predefined_uint) ;
  }
  public : static inline GGS_typeKindEnum  constructor_predefined_uint64 (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_typeKindEnum (enum_predefined_uint64) ;
  }
