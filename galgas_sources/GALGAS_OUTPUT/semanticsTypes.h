...
//--- Enumeration
  public : enum enumeration {kNotBuilt, enum_classType, enum_enumType, enum_listMapType, enum_listType, enum_mapProxyType, enum_mapType, enum_predefinedType, enum_sortedListType, enum_structType, enum_uniqueMapType} ;
...
//--- Construction from GALGAS constructor
  ...
  public : static inline GGS_typeKindEnum  constructor_uniqueMapType (C_CompilerEx & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_typeKindEnum (enum_uniqueMapType) ;
  }
