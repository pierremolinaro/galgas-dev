...
//--------------------------------- Introspection
  public : VIRTUAL_IN_DEBUG const C_galgas_type_descriptor * staticTypeDescriptor (void) const ;
  public : VIRTUAL_IN_DEBUG cMapElement_withAccessorMap * readWriteAccessForWithInstruction (C_Compiler * inCompiler,
                                                                                             const GALGAS_string & inKey
                                                                                             COMMA_LOCATION_ARGS) ;
...
//--- Current element access
  public : class GALGAS_withAccessorMap_2D_element current (LOCATION_ARGS) const ;
} ;
...
//--------------------------------- Setters
  public : VIRTUAL_IN_DEBUG void modifier_insertKey (class GALGAS_lstring constinArgument0,
                                                     ...
                                                     class GALGAS_unifiedTypeMapProxyAndParameterList constinArgument22,
                                                     class GALGAS_withAccessorMap constinArgument23,
                                                     class GALGAS_bool constinArgument24,
                                                     class GALGAS_unifiedTypeMapProxy constinArgument25,
                                                     class GALGAS_string constinArgument26,
                                                     class GALGAS_string constinArgument27,
                                                     class GALGAS_headerKind constinArgument28,
                                                     C_Compiler * inCompiler
                                                     COMMA_LOCATION_ARGS) ;
  ...
  public : VIRTUAL_IN_DEBUG void modifier_setMWithAccessorParameterListForKey (class GALGAS_unifiedTypeMapProxyAndParameterList constinArgument0,
                                                                               class GALGAS_string constinArgument1,
                                                                               C_Compiler * inCompiler
                                                                               COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Instance Methods
  public : VIRTUAL_IN_DEBUG void method_searchKey (class GALGAS_lstring constinArgument0,
                                                   ...
                                                   class GALGAS_unifiedTypeMapProxyAndParameterList & outArgument22,
                                                   class GALGAS_withAccessorMap & outArgument23,
                                                   class GALGAS_bool & outArgument24,
                                                   class GALGAS_unifiedTypeMapProxy & outArgument25,
                                                   class GALGAS_string & outArgument26,
                                                   class GALGAS_string & outArgument27,
                                                   class GALGAS_headerKind & outArgument28,
                                                   C_Compiler * inCompiler
                                                   COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- Getters
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_unifiedTypeMapProxyAndParameterList reader_mWithAccessorParameterListForKey (const class GALGAS_string & constinOperand0,
                                                                                                                      C_Compiler * inCompiler
                                                                                                                      COMMA_LOCATION_ARGS) const ;
...
//--- Current element access
  ...
  public : class GALGAS_unifiedTypeMapProxyAndParameterList current_mWithAccessorParameterList (LOCATION_ARGS) const ;
...
//--------------------------------- Getters
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_unifiedTypeMapProxyAndParameterList reader_mWithAccessorParameterList (C_Compiler * inCompiler
                                                                                                                COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- Native constructor
  public : GALGAS_formalParameterSignature_2D_element (const GALGAS_unifiedTypeMapProxy & in_mFormalArgumentType,
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_formalParameterSignature_2D_element constructor_new (const class GALGAS_unifiedTypeMapProxy & inOperand0,
                                                                              const class GALGAS_formalArgumentPassingModeAST & inOperand1,
                                                                              const class GALGAS_string & inOperand2
                                                                              COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Default GALGAS constructor
  public : static GALGAS_instanceMethodMap_2D_element constructor_default (LOCATION_ARGS) ;
...
//-----------------------------------------------------------------------------*
//                                                                             *
//                     @withAccessorMap_2D_element struct                      *
//                                                                             *
//-----------------------------------------------------------------------------*

class GALGAS_withAccessorMap_2D_element : public AC_GALGAS_root {
//--------------------------------- Public data members
  public : GALGAS_lstring mAttribute_lkey ;
...
//--------------------------------- Default GALGAS constructor
  public : static GALGAS_withAccessorMap_2D_element constructor_default (LOCATION_ARGS) ;

//--------------------------------- Default constructor
  public : GALGAS_withAccessorMap_2D_element (void) ;

//--------------------------------- Virtual destructor (in debug mode)
  public : VIRTUAL_IN_DEBUG ~ GALGAS_withAccessorMap_2D_element (void) ;

//--------------------------------- Native constructor
  public : GALGAS_withAccessorMap_2D_element (const GALGAS_lstring & in_lkey,
...
//--------------------------------- Object extraction
  public : static GALGAS_withAccessorMap_2D_element extractObject (const GALGAS_object & inObject,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static GALGAS_withAccessorMap_2D_element constructor_new (const class GALGAS_lstring & inOperand0,
                                                                     const class GALGAS_unifiedTypeMapProxy & inOperand1
                                                                     COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Implementation of reader 'description'
  public : VIRTUAL_IN_DEBUG void description (C_String & ioString,
                                              const int32_t inIndentation) const ;
//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_withAccessorMap_2D_element & inOperand) const ;
...
} ; // End of GALGAS_withAccessorMap_2D_element class


//-----------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_withAccessorMap_2D_element ;
...
//--- Map attributes
  ...
  public : GALGAS_unifiedTypeMapProxyAndParameterList mAttribute_mWithAccessorParameterList ;
