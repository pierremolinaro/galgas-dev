...
//--- Enumeration
  public : enum enumeration {kNotBuilt, enum_predefined_binaryset, enum_predefined_bool, enum_predefined_char, enum_predefined_data, enum_predefined_double, enum_predefined_function, enum_predefined_location, enum_predefined_object, enum_predefined_sint, enum_predefined_sint64, enum_predefined_string, enum_predefined_stringset, enum_predefined_type, enum_predefined_uint, enum_predefined_uint64} ;
...
extern const C_galgas_function_descriptorEX kFunction_descriptor_autoBoxing ;

//---------------------------------------------------------------------------*

GGS_uint  function_autoBoxing (C_Compiler & COMMA_LOCATION_ARGS) ;

//---------------------------------------------------------------------------*
//                                                                           *
//Function 'generateCppConstructorWithNativeAttributeListInAutoPointerClass' *
//                                                                           *
//---------------------------------------------------------------------------*

extern const C_galgas_function_descriptorEX kFunction_descriptor_generateCppConstructorWithNativeAttributeListInAutoPointerClass ;

//---------------------------------------------------------------------------*

GGS_uint  function_generateCppConstructorWithNativeAttributeListInAutoPointerClass (C_Compiler & COMMA_LOCATION_ARGS) ;
...
class GGS_objectPredefinedTypeAST : public GGS_semanticDeclarationAST {
//--- Default constructor
...
class cPtr_objectPredefinedTypeAST : public cPtr_semanticDeclarationAST {
  private : typedef cPtr_semanticDeclarationAST inherited ;
//--- Constructor
  public : cPtr_objectPredefinedTypeAST (LOCATION_ARGS) ;
