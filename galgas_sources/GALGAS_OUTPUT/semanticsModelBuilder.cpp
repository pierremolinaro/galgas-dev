  ...
  { bool syntaxRepeat_12 = true ;
    while (syntaxRepeat_12) {
      switch (select_repeat_semanticsModelBuilder_12 (_inLexique)) {
        ...
        case 8 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_message) COMMA_HERE) ;
          if (((var_cas_mClassMessage.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (505)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the class message is already defined") COMMA_SOURCE_FILE_AT_LINE (507)) ;
          }
          GGS_lstring  var_cas_classMessage ;
          _inLexique._assignFromAttribute_tokenString (var_cas_classMessage) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
          if (((var_cas_classMessage.ggs_string ().reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (510)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
            var_cas_classMessage.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the class message string should be not empty") COMMA_SOURCE_FILE_AT_LINE (512)) ;
          }
...
pr_enum_case_message_semanticsModelBuilder_686_24_ (galgas_scanner & _inLexique,
  ...
  switch (select_semanticsModelBuilder_19 (_inLexique)) {
    case 1 : {
...
pr_enum_method_semanticsModelBuilder_745_18_ (galgas_scanner & _inLexique,
  ...
  _inLexique._assignFromAttribute_tokenString (var_cas_typeName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  if (((var_cas_typeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (750)))._operator_isNotEqual (GGS_string (true, "location"))).isBuiltAndTrue ()) {
...
pr_enum_operator_semanticsModelBuilder_778_20_ (galgas_scanner & _inLexique,
  ...
  _inLexique._assignFromAttribute_tokenString (var_cas_typeName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  if (((var_cas_typeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (783)))._operator_isNotEqual (GGS_string (true, "location"))).isBuiltAndTrue ()) {
    var_cas_typeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only '@location' type is allowed here") COMMA_SOURCE_FILE_AT_LINE (785)) ;
  }
  GGS_lstring  var_cas_mLocationFormalArgumentName ;
  _inLexique._assignFromAttribute_tokenString (var_cas_mLocationFormalArgumentName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
pr_semantic_declaration_semanticsModelBuilder_816_27_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_23 = true ;
    while (syntaxRepeat_23) {
        switch (select_semanticsModelBuilder_24 (_inLexique)) {
          case 1 : {
