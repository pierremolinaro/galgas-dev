...
void semanticsModelBuilder::
pr_enum_case_message_semanticsModelBuilder_647_4_ (galgas_scanner & _inLexique,
...
void semanticsModelBuilder::
pr_enum_modifier_semanticsModelBuilder_671_4_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  if (((var_cas_typeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (676)))._operator_isNotEqual (GGS_string (true, "location"))).isBuiltAndTrue ()) {
    var_cas_typeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only '@location' type is allowed here") COMMA_SOURCE_FILE_AT_LINE (677)) ;
  }
...
void semanticsModelBuilder::
pr_enum_method_semanticsModelBuilder_706_4_ (galgas_scanner & _inLexique,
  ...
  _inLexique._assignFromAttribute_tokenString (var_cas_typeName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  if (((var_cas_typeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (711)))._operator_isNotEqual (GGS_string (true, "location"))).isBuiltAndTrue ()) {
    var_cas_typeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only '@location' type is allowed here") COMMA_SOURCE_FILE_AT_LINE (712)) ;
  }
  GGS_lstring  var_cas_mLocationFormalArgumentName ;
  _inLexique._assignFromAttribute_tokenString (var_cas_mLocationFormalArgumentName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void semanticsModelBuilder::
pr_enum_operator_semanticsModelBuilder_739_4_ (galgas_scanner & _inLexique,
  ...
  _inLexique._assignFromAttribute_tokenString (var_cas_typeName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  if (((var_cas_typeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (744)))._operator_isNotEqual (GGS_string (true, "location"))).isBuiltAndTrue ()) {
    var_cas_typeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only '@location' type is allowed here") COMMA_SOURCE_FILE_AT_LINE (745)) ;
  }
  GGS_lstring  var_cas_mLocationFormalArgumentName ;
  _inLexique._assignFromAttribute_tokenString (var_cas_mLocationFormalArgumentName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void semanticsModelBuilder::
pr_semantic_declaration_semanticsModelBuilder_777_4_ (galgas_scanner & _inLexique,
                                GGS_semanticDeclarationStruct &var_cas_ioSemanticDeclarations) {
...
void semanticsModelBuilder::
pr_semantic_declaration_semanticsModelBuilder_841_4_ (galgas_scanner & _inLexique,
                                GGS_semanticDeclarationStruct &var_cas_ioSemanticDeclarations) {
...
void semanticsModelBuilder::
pr_semantic_declaration_semanticsModelBuilder_889_4_ (galgas_scanner & _inLexique,
                                GGS_semanticDeclarationStruct &var_cas_ioSemanticDeclarations) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_abstract) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_method) COMMA_HERE) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mAbstractCategoryMethodListMap._addAssign_operation (var_cas_mClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (900)), var_cas_mMethodName, var_cas_mFormalParameterList) ;
}
...
void semanticsModelBuilder::
pr_semantic_declaration_semanticsModelBuilder_909_4_ (galgas_scanner & _inLexique,
                                GGS_semanticDeclarationStruct &var_cas_ioSemanticDeclarations) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_method) COMMA_HERE) ;
  GGS_lstring  var_cas_mClassName ;
  _inLexique._assignFromAttribute_tokenString (var_cas_mClassName) ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mCategoryMethodListMap._addAssign_operation (var_cas_mClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (923)), var_cas_mMethodName, var_cas_mFormalParameterList, var_cas_mRoutineInstructionList) ;
}
...
void semanticsModelBuilder::
pr_semantic_declaration_semanticsModelBuilder_936_4_ (galgas_scanner & _inLexique,
                                GGS_semanticDeclarationStruct &var_cas_ioSemanticDeclarations) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_override) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_method) COMMA_HERE) ;
  GGS_lstring  var_cas_mClassName ;
  ...
  nt_semantic_instruction_list_ (_inLexique, var_cas_mRoutineInstructionList) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mOverridingCategoryMethodListMap._addAssign_operation (var_cas_mClassName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (951)), var_cas_mMethodName, var_cas_mFormalParameterList, var_cas_mRoutineInstructionList) ;
}
