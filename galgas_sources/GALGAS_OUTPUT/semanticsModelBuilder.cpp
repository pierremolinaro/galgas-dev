...
pr_semantic_declaration_semanticsModelBuilder_883_27_ (galgas_scanner & inLexique,
  ...
  switch (select_semanticsModelBuilder_29 (inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
  ...
  { bool syntaxRepeat_31 = true ;
    while (syntaxRepeat_31) {
      switch (select_repeat_semanticsModelBuilder_31 (inLexique)) {
        case 2 : {
...
void semanticsModelBuilder::
pr_semantic_declaration_semanticsModelBuilder_934_27_ (galgas_scanner & inLexique,
                                GGS_semanticDeclarationStruct &var_cas_ioSemanticDeclarations) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_abstract) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_method) COMMA_HERE) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mAbstractCategoryMethodListMap._addAssign_operation (var_cas_mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (944)), var_cas_mMethodName, var_cas_mFormalParameterList) ;
}
...
void semanticsModelBuilder::
pr_semantic_declaration_semanticsModelBuilder_953_27_ (galgas_scanner & inLexique,
                                GGS_semanticDeclarationStruct &var_cas_ioSemanticDeclarations) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_method) COMMA_HERE) ;
  GGS_lstring  var_cas_mClassName ;
  inLexique._assignFromAttribute_tokenString (var_cas_mClassName) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_method) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mCategoryMethodListMap._addAssign_operation (var_cas_mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (968)), var_cas_mMethodName, var_cas_mFormalParameterList, var_cas_mRoutineInstructionList) ;
}
...
void semanticsModelBuilder::
pr_semantic_declaration_semanticsModelBuilder_981_27_ (galgas_scanner & inLexique,
                                GGS_semanticDeclarationStruct &var_cas_ioSemanticDeclarations) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_override) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_method) COMMA_HERE) ;
  GGS_lstring  var_cas_mClassName ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_method) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  var_cas_ioSemanticDeclarations.mOverridingCategoryMethodListMap._addAssign_operation (var_cas_mClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (997)), var_cas_mMethodName, var_cas_mFormalParameterList, var_cas_mRoutineInstructionList) ;
}
