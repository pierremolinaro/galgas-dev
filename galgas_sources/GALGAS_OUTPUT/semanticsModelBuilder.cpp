...
pr_semantic_declaration_semanticsModelBuilder_856_4_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
  var_cas_outSemanticDeclaration = GGS_categoryMethodDeclaration ::constructor_new (_inLexique, var_cas_mClassName, var_cas_mMethodName, var_cas_mFormalParameterList, var_cas_mRoutineInstructionList COMMA_HERE) ;
}
