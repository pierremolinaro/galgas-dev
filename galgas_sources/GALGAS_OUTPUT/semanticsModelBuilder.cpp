...
pr_semantic_declaration_semanticsModelBuilder_846_4_ (galgas_scanner & _inLexique,
                                GGS_semanticDeclaration  &var_cas_outSemanticDeclaration) {
  GGS_bool var_cas_mIsOverride ;
  switch (select_semanticsModelBuilder_29 (_inLexique)) {
    case 1 : {
      var_cas_mIsOverride = GGS_bool (true, false) ;
      } break ;
    case 2 : {
      var_cas_mIsOverride = GGS_bool (true, true) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_override) COMMA_HERE) ;
      } break ;
    default :
      break ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7D) COMMA_HERE) ;
  var_cas_outSemanticDeclaration = GGS_categoryMethodDeclaration ::constructor_new (_inLexique, var_cas_mIsOverride, var_cas_mClassName, var_cas_mMethodName, var_cas_mFormalParameterList, var_cas_mRoutineInstructionList COMMA_HERE) ;
}
