...
void semanticsModelBuilder::rule_semanticsModelBuilder_semantics_5F_component_5F_start_5F_symbol_i0_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_semanticsModelBuilder_0 (inLexique)) {
        case 2 : {
