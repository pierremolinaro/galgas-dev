...
//--- Find method
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, io_ioGeneratedCode, io_ioInclusionSet, io_ioTemporaryVariableIndex, io_ioUnusedVariableCppNameSet, constin_inCppTargetVar, inCompiler COMMA_THERE) ;
    }
  }
}
...
static void categoryMethod_expressionCollectionValueForGeneration_generateCollectionElementCode (const cPtr_abstractCollectionValueElementForGeneration * inObject,
  ...
  ioArgument_ioGeneratedCode.dotAssign_operation (constinArgument_inCppTargetVar  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1150)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string (".dotAssign_operation (").operator_concat (var_sourceVar  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1151)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1151)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mExpressionLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1151))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1151)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1151))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1151)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_expressionListCollectionForGeneration_generateCollectionElementCode (const cPtr_abstractCollectionValueElementForGeneration * inObject,
  ...
  GALGAS_stringlist var_parameterList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1164)) ;
  cEnumerator_semanticExpressionListForGeneration enumerator_48776 (object->mAttribute_mExpressionList, kEnumeration_up) ;
  while (enumerator_48776.hasCurrentObject ()) {
    GALGAS_string var_parameter ;
    callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) enumerator_48776.current_mExpression (HERE).ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_parameter, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1166)) ;
    var_parameterList.addAssign_operation (var_parameter  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1173)) ;
    enumerator_48776.gotoNextObject () ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (constinArgument_inCppTargetVar  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1176)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string (".addAssign_operation (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1178)) ;
  cEnumerator_stringlist enumerator_49175 (var_parameterList, kEnumeration_up) ;
  while (enumerator_49175.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_49175.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1180)) ;
    if (enumerator_49175.hasNextObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1181)) ;
    }
    enumerator_49175.gotoNextObject () ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string (" ").operator_concat (categoryReader_commaSourceFile (object->mAttribute_mExpressionLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1183))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1183)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1183))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1183)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_expressionCollectionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mType, ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1211)) ;
  outArgument_outCppExpression = GALGAS_string ("temp_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1213))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1213)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1213)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (object->mAttribute_mType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1215))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1215)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1215)).operator_concat (outArgument_outCppExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1215)).operator_concat (GALGAS_string (" = GALGAS_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1215)).operator_concat (object->mAttribute_mType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1216))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1216)).operator_concat (GALGAS_string ("::constructor_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1216)).operator_concat (object->mAttribute_mType.reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1216)).reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1216))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1216)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1216)).operator_concat (categoryReader_sourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1216))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1216)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1216))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1215)) ;
  cEnumerator_collectionValueElementListForGeneration enumerator_50566 (object->mAttribute_mElementList, kEnumeration_up) ;
  while (enumerator_50566.hasCurrentObject ()) {
    callCategoryMethod_generateCollectionElementCode ((const cPtr_abstractCollectionValueElementForGeneration *) enumerator_50566.current_mElement (HERE).ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, outArgument_outCppExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1219)) ;
