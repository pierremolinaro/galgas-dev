...
static void categoryMethod_filewrapperInExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  ioArgument_ioInclusionSet.addAssign_operation (GALGAS_string ("filewrapper-").operator_concat (object->mAttribute_mFilewrapperName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1053))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1053)) ;
  outArgument_outCppExpression = GALGAS_string ("GALGAS_filewrapper (gWrapperDirectory_0_").operator_concat (object->mAttribute_mFilewrapperName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1054))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1054)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1054)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperTemplateInExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  ioArgument_ioInclusionSet.addAssign_operation (GALGAS_string ("filewrapper-").operator_concat (object->mAttribute_mFilewrapperName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1067))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1067)) ;
  GALGAS_stringlist var_parameterList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1068)) ;
  cEnumerator_semanticExpressionListForGeneration enumerator_45229 (object->mAttribute_mActualOutputParameterList, kEnumeration_up) ;
  while (enumerator_45229.hasCurrentObject ()) {
    GALGAS_string var_parameter ;
    callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) enumerator_45229.current_mExpression (HERE).ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_parameter, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1071)) ;
    var_parameterList.addAssign_operation (var_parameter  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1078)) ;
    enumerator_45229.gotoNextObject () ;
  }
  outArgument_outCppExpression = GALGAS_string ("GALGAS_string (filewrapperTemplate_").operator_concat (object->mAttribute_mFilewrapperName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1080))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1080)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1080)).operator_concat (object->mAttribute_mFilewrapperTemplateName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1080))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1080)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1080)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1081))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1081)) ;
  cEnumerator_stringlist enumerator_45722 (var_parameterList, kEnumeration_up) ;
  while (enumerator_45722.hasCurrentObject ()) {
    outArgument_outCppExpression.dotAssign_operation (GALGAS_string (", ").operator_concat (enumerator_45722.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1083))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1083)) ;
    enumerator_45722.gotoNextObject () ;
  }
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1085)) COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1085)) ;
  }
  outArgument_outCppExpression.dotAssign_operation (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1086)).operator_concat (GALGAS_string ("))")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1086))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1086)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperStaticPathInExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  ioArgument_ioInclusionSet.addAssign_operation (GALGAS_string ("filewrapper-").operator_concat (object->mAttribute_mFilewrapperName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1099))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1099)) ;
  ...
  outArgument_outCppExpression.dotAssign_operation (GALGAS_string (" (gWrapperFileContent_").operator_concat (object->mAttribute_mFilewrapperFileIndex.reader_string (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1101))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1101)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1101)).operator_concat (object->mAttribute_mFilewrapperName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1101))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1101)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1101))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1101)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_expressionCollectionValueForGeneration_generateCollectionElementCode (const cPtr_abstractCollectionValueElementForGeneration * inObject,
  ...
  ioArgument_ioGeneratedCode.dotAssign_operation (constinArgument_inCppTargetVar  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1152)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string (".dotAssign_operation (").operator_concat (var_sourceVar  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1153)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1153)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mExpressionLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1153))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1153)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1153))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1153)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_expressionListCollectionForGeneration_generateCollectionElementCode (const cPtr_abstractCollectionValueElementForGeneration * inObject,
  ...
  GALGAS_stringlist var_parameterList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1167)) ;
  cEnumerator_semanticExpressionListForGeneration enumerator_48897 (object->mAttribute_mExpressionList, kEnumeration_up) ;
  while (enumerator_48897.hasCurrentObject ()) {
    GALGAS_string var_parameter ;
    callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) enumerator_48897.current_mExpression (HERE).ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_parameter, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1169)) ;
    var_parameterList.addAssign_operation (var_parameter  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1176)) ;
    enumerator_48897.gotoNextObject () ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (constinArgument_inCppTargetVar  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1179)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string (".addAssign_operation (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1181)) ;
  cEnumerator_stringlist enumerator_49296 (var_parameterList, kEnumeration_up) ;
  while (enumerator_49296.hasCurrentObject ()) {
    ioArgument_ioGeneratedCode.dotAssign_operation (enumerator_49296.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1183)) ;
    if (enumerator_49296.hasNextObject ()) {
      ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1184)) ;
    }
    enumerator_49296.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, constinArgument_inTargetType.reader_mHandledOperatorFlags (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1186)).operator_and (function_plusEqualOperatorWithFieldListNeedsCompilerArg (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1186)) COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1186)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string (", ").operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1187))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1187))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1187)) ;
    {
    ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1188)) COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1188)) ;
    }
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string (" ").operator_concat (categoryReader_commaSourceFile (object->mAttribute_mExpressionLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1190))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1190)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1190))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1190)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_expressionCollectionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mType, ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1203)) ;
  outArgument_outCppExpression = GALGAS_string ("temp_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1205))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1205)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1205)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (object->mAttribute_mType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1207))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1207)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1207)).operator_concat (outArgument_outCppExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1207)).operator_concat (GALGAS_string (" = GALGAS_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1207)).operator_concat (object->mAttribute_mType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1208))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1208)).operator_concat (GALGAS_string ("::constructor_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1208)).operator_concat (object->mAttribute_mType.reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1208)).reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1208))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1208)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1208)).operator_concat (categoryReader_sourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1208))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1208)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1208))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1207)) ;
  cEnumerator_collectionValueElementListForGeneration enumerator_50583 (object->mAttribute_mElementList, kEnumeration_up) ;
  while (enumerator_50583.hasCurrentObject ()) {
    callCategoryMethod_generateCollectionElementCode ((const cPtr_abstractCollectionValueElementForGeneration *) enumerator_50583.current_mElement (HERE).ptr (), object->mAttribute_mType, ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, outArgument_outCppExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1211)) ;
