...
static void categoryMethod_readerCallExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  GALGAS_stringlist var_readerArgumentCppNameList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 292)) ;
  cEnumerator_semanticExpressionListForGeneration enumerator_11383 (object->mAttribute_mExpressions, kEnumeration_up) ;
  while (enumerator_11383.hasCurrentObject ()) {
    GALGAS_string var_argumentCppName ;
    callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) enumerator_11383.current_mExpression (HERE).ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_argumentCppName, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 295)) ;
    var_readerArgumentCppNameList.addAssign_operation (var_argumentCppName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 296)) ;
  ...
  if (object->mAttribute_mKind.isValid ()) {
    ...
    case GALGAS_methodKind::kEnum_definedAsCategory: {
      ioArgument_ioInclusionSet.addAssign_operation (GALGAS_string ("getter-").operator_concat (categoryReader_baseType (object->mAttribute_mReceiverExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 301)), inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 301)).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 301))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 301)).operator_concat (GALGAS_string ("-")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 301)).operator_concat (object->mAttribute_mReaderName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 301))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 301)) ;
      {
      ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (var_receiverCppName COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 302)) ;
      }
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mReceiverExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 303)).reader_mTypeKindEnum (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 303)).objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 303)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        outArgument_outCppExpression = GALGAS_string ("callCategoryReader_").operator_concat (object->mAttribute_mReaderName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 304))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 304)).operator_concat (GALGAS_string (" ((const cPtr_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 304)).operator_concat (object->mAttribute_mReceiverExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 305)).reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 305))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 305)).operator_concat (GALGAS_string (" *) ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 305)).operator_concat (var_receiverCppName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 305)).operator_concat (GALGAS_string (".ptr (), ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 305)) ;
      }else if (kBoolFalse == test_0) {
        categoryMethod_addHeaderFileName (object->mAttribute_mReceiverExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 307)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 307)) ;
        outArgument_outCppExpression = GALGAS_string ("categoryReader_").operator_concat (object->mAttribute_mReaderName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 308))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 308)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 308)).operator_concat (var_receiverCppName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 308)).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 308)) ;
      }
      } break ;
    case GALGAS_methodKind::kEnum_definedAsMember: {
      outArgument_outCppExpression = var_receiverCppName ;
      cEnumerator_stringlist enumerator_12471 (object->mAttribute_mFieldList, kEnumeration_up) ;
      while (enumerator_12471.hasCurrentObject ()) {
        outArgument_outCppExpression.dotAssign_operation (GALGAS_string (".mAttribute_").operator_concat (enumerator_12471.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 313))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 313))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 313)) ;
        enumerator_12471.gotoNextObject () ;
      }
      categoryMethod_addHeaderFileName (object->mAttribute_mType, ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 315)) ;
      outArgument_outCppExpression.dotAssign_operation (GALGAS_string (".reader_").operator_concat (object->mAttribute_mReaderName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 316))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 316)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 316))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 316)) ;
      } break ;
    }
  }
  cEnumerator_stringlist enumerator_12757 (var_readerArgumentCppNameList, kEnumeration_up) ;
  while (enumerator_12757.hasCurrentObject ()) {
    outArgument_outCppExpression.dotAssign_operation (enumerator_12757.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 319)) ;
    if (enumerator_12757.hasNextObject ()) {
      outArgument_outCppExpression.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 320)) ;
    }
    enumerator_12757.gotoNextObject () ;
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_readerArgumentCppNameList.reader_length (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 322)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    const enumGalgasBool test_2 = object->mAttribute_mHasCompilerArgument.boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 324)) COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 324)) ;
      }
      outArgument_outCppExpression.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 325)).operator_concat (GALGAS_string (" COMMA_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 325))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 325)) ;
    }
  }else if (kBoolFalse == test_1) {
    const enumGalgasBool test_3 = object->mAttribute_mHasCompilerArgument.boolEnum () ;
    if (kBoolTrue == test_3) {
      {
      ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 328)) COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 328)) ;
      }
      outArgument_outCppExpression.dotAssign_operation (GALGAS_string (", ").operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 329))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 329)).operator_concat (GALGAS_string (" COMMA_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 329))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 329)) ;
    }else if (kBoolFalse == test_3) {
      outArgument_outCppExpression.dotAssign_operation (GALGAS_string (" COMMA_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 331)) ;
    }
  }
  outArgument_outCppExpression.dotAssign_operation (categoryReader_sourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 333)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 333))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 333)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_optionValueExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  const enumGalgasBool test_0 = object->mAttribute_mOptionComponentIsPredefined.operator_not (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 349)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioInclusionSet.addAssign_operation (GALGAS_string ("option-").operator_concat (object->mAttribute_mOptionComponentName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 350))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 350)) ;
  }
  outArgument_outCppExpression = GALGAS_string ("GALGAS_").operator_concat (object->mAttribute_mType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 352))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 352)).operator_concat (GALGAS_string (" (gOption_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 352)).operator_concat (object->mAttribute_mOptionComponentName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 352))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 352)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 352)).operator_concat (object->mAttribute_mOptionEntryName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 353))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 353)).operator_concat (GALGAS_string (".reader_value ())")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 353)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_optionCharExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  const enumGalgasBool test_0 = object->mAttribute_mOptionComponentIsPredefined.operator_not (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 365)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioInclusionSet.addAssign_operation (GALGAS_string ("option-").operator_concat (object->mAttribute_mOptionComponentName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 366))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 366)) ;
  }
  outArgument_outCppExpression = GALGAS_string ("GALGAS_char (gOption_").operator_concat (object->mAttribute_mOptionComponentName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 368))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 368)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 368)).operator_concat (object->mAttribute_mOptionEntryName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 369))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 369)).operator_concat (GALGAS_string (".reader_char ())")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 369)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_optionStringExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  const enumGalgasBool test_0 = object->mAttribute_mOptionComponentIsPredefined.operator_not (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 381)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioInclusionSet.addAssign_operation (GALGAS_string ("option-").operator_concat (object->mAttribute_mOptionComponentName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 382))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 382)) ;
  }
  outArgument_outCppExpression = GALGAS_string ("GALGAS_string (gOption_").operator_concat (object->mAttribute_mOptionComponentName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 384))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 384)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 384)).operator_concat (object->mAttribute_mOptionEntryName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 385))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 385)).operator_concat (GALGAS_string (".reader_string ())")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 385)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_optionCommentExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  const enumGalgasBool test_0 = object->mAttribute_mOptionComponentIsPredefined.operator_not (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 397)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioInclusionSet.addAssign_operation (GALGAS_string ("option-").operator_concat (object->mAttribute_mOptionComponentName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 398))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 398)) ;
  }
  outArgument_outCppExpression = GALGAS_string ("gOption_").operator_concat (object->mAttribute_mOptionComponentName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 400))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 400)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 400)).operator_concat (object->mAttribute_mOptionEntryName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 401))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 401)).operator_concat (GALGAS_string (".reader_comment ()")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 401)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_concatExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  outArgument_outCppExpression = var_leftTemporaryOperand.operator_concat (GALGAS_string (".operator_concat (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 420)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 420)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 421)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 421))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 421)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 421)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_orExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 433)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 433)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 436)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 439)) ;
  outArgument_outCppExpression = var_leftTemporaryOperand.operator_concat (GALGAS_string (".operator_or (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 441)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 441)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 442))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 442)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 442)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_xorExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 454)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 454)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 457)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 460)) ;
  outArgument_outCppExpression = var_leftTemporaryOperand.operator_concat (GALGAS_string (".operator_xor (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 462)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 462)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 463))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 463)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 463)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_andExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 475)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 475)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 478)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 481)) ;
  outArgument_outCppExpression = var_leftTemporaryOperand.operator_concat (GALGAS_string (".operator_and (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 483)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 483)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 484))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 484)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 484)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_equalExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 496)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 496)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 499)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 502)) ;
  outArgument_outCppExpression = GALGAS_string ("GALGAS_bool (kIsEqual, ").operator_concat (var_leftTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 504)).operator_concat (GALGAS_string (".objectCompare (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 504)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 504)).operator_concat (GALGAS_string ("))")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 504)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_notEqualExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 516)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 516)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 519)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 522)) ;
...
static void categoryMethod_lowerOrEqualExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 536)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 536)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 539)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 542)) ;
  outArgument_outCppExpression = GALGAS_string ("GALGAS_bool (kIsInfOrEqual, ").operator_concat (var_leftTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 544)).operator_concat (GALGAS_string (".objectCompare (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 544)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 544)).operator_concat (GALGAS_string ("))")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 544)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_greaterOrEqualExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 556)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 556)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 559)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 562)) ;
  outArgument_outCppExpression = GALGAS_string ("GALGAS_bool (kIsSupOrEqual, ").operator_concat (var_leftTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 564)).operator_concat (GALGAS_string (".objectCompare (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 564)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 564)).operator_concat (GALGAS_string ("))")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 564)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_strictGreaterExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 576)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 576)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 579)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 582)) ;
  outArgument_outCppExpression = GALGAS_string ("GALGAS_bool (kIsStrictSup, ").operator_concat (var_leftTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 584)).operator_concat (GALGAS_string (".objectCompare (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 584)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 584)).operator_concat (GALGAS_string ("))")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 584)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_strictLowerExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 596)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 596)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 599)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 602)) ;
  outArgument_outCppExpression = GALGAS_string ("GALGAS_bool (kIsStrictInf, ").operator_concat (var_leftTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 604)).operator_concat (GALGAS_string (".objectCompare (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 604)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 604)).operator_concat (GALGAS_string ("))")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 604)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_rightShiftExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 616)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 616)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 619)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 622)) ;
  outArgument_outCppExpression = var_leftTemporaryOperand.operator_concat (GALGAS_string (".right_shift_operation (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 624)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 624)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 625))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 625)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 625)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_leftShiftExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 637)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 637)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 640)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 643)) ;
  outArgument_outCppExpression = var_leftTemporaryOperand.operator_concat (GALGAS_string (".left_shift_operation (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 645)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 645)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 646))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 646)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 646)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_addExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 658)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 658)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 661)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 664)) ;
  outArgument_outCppExpression = var_leftTemporaryOperand.operator_concat (GALGAS_string (".add_operation (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 666)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 666)).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 667)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 667))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 667)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 667))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 667)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 667)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 668)) COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 668)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_subExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 680)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 680)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 683)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 686)) ;
  outArgument_outCppExpression = var_leftTemporaryOperand.operator_concat (GALGAS_string (".substract_operation (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 688)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 688)).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 689)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 689))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 689)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 689))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 689)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 689)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 690)) COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 690)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_multiplicationExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 702)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 702)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 705)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 708)) ;
  outArgument_outCppExpression = var_leftTemporaryOperand.operator_concat (GALGAS_string (".multiply_operation (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 710)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 710)).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 711)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 711))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 711)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 711))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 711)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 711)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 712)) COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 712)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_divisionExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 724)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 724)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 727)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 730)) ;
  outArgument_outCppExpression = var_leftTemporaryOperand.operator_concat (GALGAS_string (".divide_operation (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 732)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 732)).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 733)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 733))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 733)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 733))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 733)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 733)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 734)) COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 734)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_moduloExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mLeftExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 746)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 746)) ;
  GALGAS_string var_leftTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mLeftExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_leftTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 749)) ;
  GALGAS_string var_rightTemporaryOperand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mRightExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_rightTemporaryOperand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 752)) ;
  outArgument_outCppExpression = var_leftTemporaryOperand.operator_concat (GALGAS_string (".modulo_operation (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 754)).operator_concat (var_rightTemporaryOperand  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 754)).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 755)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 755))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 755)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 755))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 755)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 755)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 756)) COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 756)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_unaryMinusExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  outArgument_outCppExpression = var_operand.operator_concat (GALGAS_string (".operator_unary_minus (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 773)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 774))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 773)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 774))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 774)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 774)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 775)) COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 775)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_notExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 787)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 787)) ;
  GALGAS_string var_operand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_operand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 790)) ;
  outArgument_outCppExpression = var_operand.operator_concat (GALGAS_string (".operator_not (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 792)).operator_concat (categoryReader_sourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 792))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 792)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 792)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structFieldAccessExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mType, ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 805)) ;
  GALGAS_string var_operand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_operand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 807)) ;
  outArgument_outCppExpression = var_operand.operator_concat (GALGAS_string (".mAttribute_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 809)).operator_concat (object->mAttribute_mStructFieldName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 809))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 809)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_tildeExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 821)), ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 821)) ;
  GALGAS_string var_operand ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_operand, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 824)) ;
  outArgument_outCppExpression = var_operand.operator_concat (GALGAS_string (".operator_tilde (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 826)).operator_concat (categoryReader_sourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 826))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 826)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 826)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_ifExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  outArgument_outCppExpression = GALGAS_string ("temp_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 842))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 842)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 842)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (object->mAttribute_mThenExpression.reader_mType (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 843)).reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 843))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 843)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 843)).operator_concat (outArgument_outCppExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 843)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 843))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 843)) ;
  GALGAS_string var_testVar = GALGAS_string ("test_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 844))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 844)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 844)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("const enumGalgasBool ").operator_concat (var_testVar  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 845)).operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 845)).operator_concat (var_ifExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 845)).operator_concat (GALGAS_string (".boolEnum () ;\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 845))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 845)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (kBoolTrue == ").operator_concat (var_testVar  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 846)).operator_concat (GALGAS_string (") {\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 846))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 846)) ;
  GALGAS_string var_thenExpression ;
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 849)) ;
  }
  ...
  ioArgument_ioGeneratedCode.dotAssign_operation (outArgument_outCppExpression.operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 851)).operator_concat (var_thenExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 851)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 851))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 851)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 852)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}else if (kBoolFalse == ").operator_concat (var_testVar  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 854)).operator_concat (GALGAS_string (") {\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 854))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 854)) ;
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 855)) ;
  }
  ...
  ioArgument_ioGeneratedCode.dotAssign_operation (outArgument_outCppExpression.operator_concat (GALGAS_string (" = ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 858)).operator_concat (var_elseExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 858)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 858))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 858)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 859)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 860)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_extractObjectInExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  outArgument_outCppExpression = GALGAS_string ("temp_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 885))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 885)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 885)) ;
  ...
  outArgument_outCppExpression = GALGAS_string ("GALGAS_").operator_concat (object->mAttribute_mType.reader_identifierRepresentation (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 895))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 895)).operator_concat (GALGAS_string ("::extractObject (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 895)).operator_concat (var_receiverExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 896)).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 896)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 897))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 897)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 898))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 897)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 898)) ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 899)) COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 899)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_testDynamicClassInExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  if (object->mAttribute_mTypeComparisonKind.isValid ()) {
    ...
    case GALGAS_dynamicTypeComparisonKind::kEnum_equal: {
      outArgument_outCppExpression = GALGAS_string ("GALGAS_bool (").operator_concat (var_receiverExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 922)).operator_concat (GALGAS_string (".dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 922)).operator_concat (object->mAttribute_mTypeName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 924))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 923)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 924)) ;
      } break ;
    case GALGAS_dynamicTypeComparisonKind::kEnum_inherited: {
      outArgument_outCppExpression = GALGAS_string ("GALGAS_bool (NULL != dynamic_cast <const cPtr_").operator_concat (object->mAttribute_mTypeName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 927))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 926)).operator_concat (GALGAS_string (" *> (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 927)).operator_concat (var_receiverExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 928)).operator_concat (GALGAS_string (".ptr ()))")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 928)) ;
      } break ;
    case GALGAS_dynamicTypeComparisonKind::kEnum_strictlyInherited: {
      outArgument_outCppExpression = GALGAS_string ("GALGAS_bool ((").operator_concat (var_receiverExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 930)).operator_concat (GALGAS_string (".dynamicTypeDescriptor () != & kTypeDescriptor_GALGAS_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 930)).operator_concat (object->mAttribute_mTypeName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 932))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 931)).operator_concat (GALGAS_string (") && (NULL != dynamic_cast <const cPtr_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 932)).operator_concat (object->mAttribute_mTypeName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 933))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 932)).operator_concat (GALGAS_string (" *> (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 933)).operator_concat (var_receiverExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 934)).operator_concat (GALGAS_string (".ptr ())))")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 934)) ;
      } break ;
    }
  }
}
...
static void categoryMethod_castInExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  outArgument_outCppExpression = GALGAS_string ("temp_").operator_concat (ioArgument_ioTemporaryVariableIndex.reader_string (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 947))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 947)) ;
  ioArgument_ioTemporaryVariableIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 948)) ;
  GALGAS_string var_receiverExpression ;
  callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) object->mAttribute_mReceiverExpression.ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_receiverExpression, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 950)) ;
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("GALGAS_").operator_concat (object->mAttribute_mTypeName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 958))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 958)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 958)).operator_concat (outArgument_outCppExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 959)).operator_concat (GALGAS_string (" ;\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 959)).operator_concat (GALGAS_string ("if (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 959)).operator_concat (var_receiverExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 960)).operator_concat (GALGAS_string (".isValid ()) {\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 960))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 958)) ;
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 961)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("if (NULL != dynamic_cast <const cPtr_").operator_concat (object->mAttribute_mTypeName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 965))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 964)).operator_concat (GALGAS_string (" *> (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 965)).operator_concat (var_receiverExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 966)).operator_concat (GALGAS_string (".ptr ())) {\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 966)).operator_concat (GALGAS_string ("  ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 966)).operator_concat (outArgument_outCppExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 967)).operator_concat (GALGAS_string (" = (cPtr_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 967)).operator_concat (object->mAttribute_mTypeName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 967))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 967)).operator_concat (GALGAS_string (" *) ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 967)).operator_concat (var_receiverExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 967)).operator_concat (GALGAS_string (".ptr () ;\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 968)).operator_concat (GALGAS_string ("}else{\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 968))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 963)) ;
  {
  ioArgument_ioGeneratedCode.modifier_incIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 970)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 972)).operator_concat (GALGAS_string ("->castError (\"")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 972)).operator_concat (object->mAttribute_mTypeName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 973))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 972)).operator_concat (GALGAS_string ("\", ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 973)).operator_concat (var_receiverExpression  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 974)).operator_concat (GALGAS_string (".ptr ()->classDescriptor ()")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 974)).operator_concat (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 975))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 974)).operator_concat (GALGAS_string (") ;\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 975))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 971)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 977)) ;
  }
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 978)) COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 978)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 979)) ;
  {
  ioArgument_ioGeneratedCode.modifier_decIndentation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 980)) ;
  }
  ioArgument_ioGeneratedCode.dotAssign_operation (GALGAS_string ("}\n")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 981)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_functionCallExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  ioArgument_ioInclusionSet.addAssign_operation (GALGAS_string ("func-").operator_concat (object->mAttribute_mFunctionName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 993))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 993)) ;
  GALGAS_stringlist var_parameterList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 995)) ;
  cEnumerator_semanticExpressionListForGeneration enumerator_42395 (object->mAttribute_mExpressions, kEnumeration_up) ;
  while (enumerator_42395.hasCurrentObject ()) {
    GALGAS_string var_parameter ;
    callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) enumerator_42395.current_mExpression (HERE).ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_parameter, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 998)) ;
    var_parameterList.addAssign_operation (var_parameter  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 999)) ;
    enumerator_42395.gotoNextObject () ;
  }
  outArgument_outCppExpression = GALGAS_string ("function_").operator_concat (object->mAttribute_mFunctionName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1001))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1001)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1001)) ;
  cEnumerator_stringlist enumerator_42725 (var_parameterList, kEnumeration_up) ;
  while (enumerator_42725.hasCurrentObject ()) {
    outArgument_outCppExpression.dotAssign_operation (enumerator_42725.current_mValue (HERE).operator_concat (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1003))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1003)) ;
    enumerator_42725.gotoNextObject () ;
  }
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1005)) COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1005)) ;
  }
  outArgument_outCppExpression.dotAssign_operation (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1006))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1006)) ;
...
static void categoryMethod_varInExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  categoryMethod_addHeaderFileName (object->mAttribute_mType, ioArgument_ioInclusionSet, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1019)) ;
  outArgument_outCppExpression = object->mAttribute_mCppVarName ;
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (object->mAttribute_mNameForCheckingFormalParameterUsing COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1021)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperInExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  ioArgument_ioInclusionSet.addAssign_operation (GALGAS_string ("filewrapper-").operator_concat (object->mAttribute_mFilewrapperName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1037))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1037)) ;
  outArgument_outCppExpression = GALGAS_string ("GALGAS_filewrapper (gWrapperDirectory_0_").operator_concat (object->mAttribute_mFilewrapperName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1038))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1038)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1038)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperTemplateInExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  ioArgument_ioInclusionSet.addAssign_operation (GALGAS_string ("filewrapper-").operator_concat (object->mAttribute_mFilewrapperName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1051))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1051)) ;
  GALGAS_stringlist var_parameterList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1052)) ;
  cEnumerator_semanticExpressionListForGeneration enumerator_44556 (object->mAttribute_mActualOutputParameterList, kEnumeration_up) ;
  while (enumerator_44556.hasCurrentObject ()) {
    GALGAS_string var_parameter ;
    callCategoryMethod_generateExpression ((const cPtr_semanticExpressionForGeneration *) enumerator_44556.current_mExpression (HERE).ptr (), ioArgument_ioGeneratedCode, ioArgument_ioInclusionSet, ioArgument_ioTemporaryVariableIndex, ioArgument_ioUnusedVariableCppNameSet, var_parameter, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1055)) ;
    var_parameterList.addAssign_operation (var_parameter  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1062)) ;
    enumerator_44556.gotoNextObject () ;
  }
  outArgument_outCppExpression = GALGAS_string ("GALGAS_string (filewrapperTemplate_").operator_concat (object->mAttribute_mFilewrapperName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1064))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1064)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1064)).operator_concat (object->mAttribute_mFilewrapperTemplateName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1064))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1064)).operator_concat (GALGAS_string (" (")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1064)).operator_concat (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1065))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1065)) ;
  cEnumerator_stringlist enumerator_45049 (var_parameterList, kEnumeration_up) ;
  while (enumerator_45049.hasCurrentObject ()) {
    outArgument_outCppExpression.dotAssign_operation (GALGAS_string (", ").operator_concat (enumerator_45049.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1067))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1067)) ;
    enumerator_45049.gotoNextObject () ;
  }
  {
  ioArgument_ioUnusedVariableCppNameSet.modifier_removeKey (function_compilerCppName (inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1069)) COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1069)) ;
  }
  outArgument_outCppExpression.dotAssign_operation (categoryReader_commaSourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1070)).operator_concat (GALGAS_string ("))")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1070))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1070)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperStaticPathInExpressionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  ioArgument_ioInclusionSet.addAssign_operation (GALGAS_string ("filewrapper-").operator_concat (object->mAttribute_mFilewrapperName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1083))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1083)) ;
  ...
  outArgument_outCppExpression.dotAssign_operation (GALGAS_string (" (gWrapperFileContent_").operator_concat (object->mAttribute_mFilewrapperFileIndex.reader_string (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1085))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1085)).operator_concat (GALGAS_string ("_")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1085)).operator_concat (object->mAttribute_mFilewrapperName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1085))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1085)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1085))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1085)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_lexiqueIntrospectionForGeneration_generateExpression (const cPtr_semanticExpressionForGeneration * inObject,
  ...
  ioArgument_ioInclusionSet.addAssign_operation (GALGAS_string ("lexique-").operator_concat (object->mAttribute_mLexiqueComponentName  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1098))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1098)) ;
  outArgument_outCppExpression = GALGAS_string ("C_Lexique_").operator_concat (object->mAttribute_mLexiqueComponentName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1099))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1099)).operator_concat (GALGAS_string ("::")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1099)).operator_concat (object->mAttribute_mLexiqueReaderName.reader_identifierRepresentation (SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1100))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1099)).operator_concat (GALGAS_string ("(")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1100)).operator_concat (categoryReader_sourceFile (object->mAttribute_mLocation, inCompiler COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1101))  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1101)).operator_concat (GALGAS_string (")")  COMMA_SOURCE_FILE ("semanticExpressionGeneration.gSemantics", 1101)) ;
}
//-----------------------------------------------------------------------------*
