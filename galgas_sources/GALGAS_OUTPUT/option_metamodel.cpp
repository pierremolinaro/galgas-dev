...
//---------------------------------------------------------------------------*
  ...
  static const char gGGSsourceFile [] = "option_metamodel.ggs" ;
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    equal = (mOptionComponentName == _p->mOptionComponentName).boolValue ()
         && (mOptions == _p->mOptions).boolValue () ;
  }
  return equal ;
}
...
operator == (const GGS_optionComponentRootList & inOperand) const {
...
operator == (const GGS_optionComponentRoot & inOperand) const {
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (_p) ;
    equal = (mOptionTypeName == _p->mOptionTypeName).boolValue ()
         && (mOptionInternalName == _p->mOptionInternalName).boolValue ()
         && (mOptionInvocationLetter == _p->mOptionInvocationLetter).boolValue ()
         && (mOptionInvocationString == _p->mOptionInvocationString).boolValue ()
         && (mOptionComment == _p->mOptionComment).boolValue ()
         && (mDefaultValue == _p->mDefaultValue).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mDefaultValue.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
}
...
_cloneObject (void) const {
  ...
  macroMyNew (_p, cPtr_commandLineOption (mOptionTypeName, mOptionInternalName, mOptionInvocationLetter, mOptionInvocationString, mOptionComment, mDefaultValue COMMA_HERE)) ;
  return _p ;
}
...
operator == (const GGS_commandLineOptionList & inOperand) const {
  return GGS_bool (_isBuilt () && inOperand._isBuilt (), isEqualToList (inOperand)) ;
}
...
reader_mDefaultValue (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string  result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    result = mPointer->mDefaultValue ;
  }
  return result ;
}
...
operator == (const GGS_commandLineOption & inOperand) const {
  bool equal = mPointer == inOperand.mPointer ;
  if (_isBuilt () && inOperand._isBuilt () && ! equal) {
    equal = mPointer->isEqualToObject (inOperand.mPointer) ;
  }
