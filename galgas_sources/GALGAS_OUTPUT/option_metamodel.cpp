...
isEqualToObject (C_Compiler & _inLexique, const  cListElement * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const cPtr_optionComponentRoot * _p = dynamic_cast <const cPtr_optionComponentRoot *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mOptionComponentName._operator_isEqual (_inLexique, _p->mOptionComponentName THERE).boolValue ()
         && mOptions._operator_isEqual (_inLexique, _p->mOptions THERE).boolValue () ;
  }
  return equal ;
}
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_optionComponentRootList & inOperand
                   COMMA_LOCATION_ARGS) const {
...
GGS_bool GGS_optionComponentRootList::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_optionComponentRootList & inOperand COMMA_LOCATION_ARGS) const {
  return GGS_bool (_isBuilt (THERE) && inOperand._isBuilt (THERE), ! isEqualToList (_inLexique, inOperand THERE)) ;
}
...
_operator_concat (C_Compiler & _inLexique, const GGS_optionComponentRootList & inOperand COMMA_LOCATION_ARGS) const {
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_optionComponentRoot & inOperand
                   COMMA_LOCATION_ARGS) const {
...
GGS_bool GGS_optionComponentRoot::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_optionComponentRoot & inOperand COMMA_LOCATION_ARGS) const {
...
isEqualToObject (C_Compiler & _inLexique, const  cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (_p) ;
    equal = mOptionTypeName._operator_isEqual (_inLexique, _p->mOptionTypeName THERE).boolValue ()
         && mOptionInternalName._operator_isEqual (_inLexique, _p->mOptionInternalName THERE).boolValue ()
         && mOptionInvocationLetter._operator_isEqual (_inLexique, _p->mOptionInvocationLetter THERE).boolValue ()
         && mOptionInvocationString._operator_isEqual (_inLexique, _p->mOptionInvocationString THERE).boolValue ()
         && mOptionComment._operator_isEqual (_inLexique, _p->mOptionComment THERE).boolValue () ;
  }
  return equal ;
}
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_commandLineOptionList & inOperand
                   COMMA_LOCATION_ARGS) const {
  return GGS_bool (_isBuilt (THERE) && inOperand._isBuilt (THERE), isEqualToList (_inLexique, inOperand THERE)) ;
}
...
GGS_bool GGS_commandLineOptionList::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_commandLineOptionList & inOperand COMMA_LOCATION_ARGS) const {
  return GGS_bool (_isBuilt (THERE) && inOperand._isBuilt (THERE), ! isEqualToList (_inLexique, inOperand THERE)) ;
}
...
_operator_concat (C_Compiler & _inLexique, const GGS_commandLineOptionList & inOperand COMMA_LOCATION_ARGS) const {
  GGS_commandLineOptionList result ;
  if (_isBuilt (THERE) && inOperand._isBuilt (THERE)) {
    if (count () == 0) {
      result = inOperand ;
...
_operator_isEqual (C_Compiler & _inLexique,
                   const GGS_commandLineOption & inOperand
                   COMMA_LOCATION_ARGS) const {
  bool built = _isBuilt (THERE) && inOperand._isBuilt (THERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
...
GGS_bool GGS_commandLineOption::
_operator_isNotEqual (C_Compiler & _inLexique, const GGS_commandLineOption & inOperand COMMA_LOCATION_ARGS) const {
  bool built = _isBuilt (HERE) && inOperand._isBuilt (HERE) ;
  bool equal = mPointer == inOperand.mPointer ;
  if (built && ! equal) {
    equal = mPointer->isEqualToObject (_inLexique, inOperand.mPointer THERE) ;
