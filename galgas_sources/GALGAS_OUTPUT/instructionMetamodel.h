...
//--- Readers
  public : GGS_lstringlist  reader_mMatchedEntryList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
...
//--- Attributes
  public : GGS_lstringlist  mMatchedEntryList ;
  public : GGS_semanticInstructions  mMatchBranchInstructionList ;
//--- Constructor
  public : cPtr_matchInstructionBranch (const GGS_lstringlist & ,
                                const GGS_semanticInstructions & 
                                COMMA_LOCATION_ARGS) ;
