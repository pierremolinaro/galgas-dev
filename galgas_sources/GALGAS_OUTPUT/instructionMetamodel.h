...
class GGS_abstractCategoryMethodListMap : public AC_galgas_maplist {
//--- Node class
...
class GGS_categoryMethodListMap : public AC_galgas_maplist {
//--- Node class
  public : class cElement : public cNode {
    public : cElement (const GGS_string & inKey) ;
...
class GGS_overridingCategoryMethodListMap : public AC_galgas_maplist {
//--- Node class
  public : class cElement : public cNode {
    public : cElement (const GGS_string & inKey) ;
