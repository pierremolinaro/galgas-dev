...
//--- Pointer assignment constructor
  public : GGS_removeInstruction (cPtr__AC_galgas_class * inPointer) ;
...
//--- Pointer assignment constructor
  public : GGS_withInstruction (cPtr__AC_galgas_class * inPointer) ;
...
class cPtr_removeInstruction : public cPtr_semanticInstruction {
  private : typedef cPtr_semanticInstruction inherited ;
//--- Constructor
  public : cPtr_removeInstruction (const GGS_lstring & ,
                                const GGS_lstringlist & ,
                                const GGS_semanticExpression & 
                                COMMA_LOCATION_ARGS) ;
...
class cPtr_withInstruction : public cPtr_semanticInstruction {
  private : typedef cPtr_semanticInstruction inherited ;
//--- Constructor
  public : cPtr_withInstruction (const GGS_lstring & ,
                                const GGS_lstring & ,
                                const GGS_lstringlist & ,
                                const GGS_lstring & ,
                                const GGS_semanticExpression & ,
