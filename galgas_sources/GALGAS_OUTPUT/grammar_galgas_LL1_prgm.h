...
class grammar_galgas_LL1_prgm : public C_defaultUserSemanticActions {
...
//--- Constructor
  public : grammar_galgas_LL1_prgm (C_galgas_io * inParametersPtr
                                  COMMA_LOCATION_ARGS) ;
...
//--- Prologue and epilogue
  public : inline void _prologue (void) {
    _mScannerPtr->mPerformGeneration = ! _mScannerPtr->ioParametersPtr ()->boolOptionValueFromKeys ("galgas_cli_options", "doNotGenerateFiles" COMMA_HERE) ;
  }
...
//--- Destructor
  public : virtual ~grammar_galgas_LL1_prgm (void) ;
} ;
