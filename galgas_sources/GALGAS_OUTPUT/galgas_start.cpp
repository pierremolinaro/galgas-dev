...
void galgas_start::
pr_galgas_start_symbol_galgas_start_89_26_ (galgas_scanner & inLexique,
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_89_26_compileFile (galgas_scanner & inLexique) {
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_89_26_importForGrammarAnalysis (galgas_scanner & inLexique,
                                GGS_syntaxRuleList  &var_cas_ioSyntaxRuleList) {
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_repeat_galgas_start_0 (inLexique)) {
        case 2 : {
          nt_galgas_component_importForGrammarAnalysis (inLexique, var_cas_ioSyntaxRuleList) ;
          } break ;
        default :
          syntaxRepeat_0 = false ;
          break ;
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_89_26_importGrammarForSemantics (galgas_scanner & inLexique,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_89_26_importLexique (galgas_scanner & inLexique,
                                GGS_M_lexiqueComponents  &var_cas_ioLexiqueMapForUse) {
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_repeat_galgas_start_0 (inLexique)) {
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_89_26_importOptions (galgas_scanner & inLexique,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_repeat_galgas_start_0 (inLexique)) {
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_89_26_importSemantics (galgas_scanner & inLexique,
                                GGS_M_semanticsComponents  &var_cas_ioSemanticsComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext,
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_89_26_importSyntax (galgas_scanner & inLexique,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext) {
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
