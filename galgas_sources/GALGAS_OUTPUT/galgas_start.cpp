...
void galgas_start::
pr_galgas_start_symbol_galgas_start_83_4_ (galgas_scanner & _inLexique,
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_83_4_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &var_cas_ioLexiqueMapForUse) {
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_repeat_galgas_start_0 (_inLexique)) {
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_83_4_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext) {
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_83_4_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &var_cas_ioSemanticsComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext,
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_83_4_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_83_4_compileFile (galgas_scanner & _inLexique) {
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_83_4_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_repeat_galgas_start_0 (_inLexique)) {
