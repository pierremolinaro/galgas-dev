...
void galgas_start::
pr_galgas_start_symbol_galgas_start_84_26_ (C_Lexique_galgas_5F_scanner & inLexique,
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_84_26_compileFile (C_Lexique_galgas_5F_scanner & inLexique) {
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_84_26_importGrammarForSemantics (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_84_26_importLexique (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_M_lexiqueComponents  &var_cas_ioLexiqueMapForUse) {
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_galgas_5F_start_0 (inLexique)) {
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_84_26_importOptions (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_galgas_5F_start_0 (inLexique)) {
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_84_26_importSemantics (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_M_semanticsComponents  &var_cas_ioSemanticsComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext,
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_84_26_importSyntax (C_Lexique_galgas_5F_scanner & inLexique,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext) {
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
