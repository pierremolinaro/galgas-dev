...
void galgas_start::
pr_galgas_start_symbol_galgas_start_84_26_ (galgas_scanner & inLexique,
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_galgas_start_0 (inLexique)) {
        case 2 : {
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_84_26_compileFile (galgas_scanner & inLexique) {
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_84_26_importGrammarForSemantics (galgas_scanner & inLexique,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_84_26_importLexique (galgas_scanner & inLexique,
                                GGS_M_lexiqueComponents  &var_cas_ioLexiqueMapForUse) {
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_galgas_start_0 (inLexique)) {
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_84_26_importOptions (galgas_scanner & inLexique,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_galgas_start_0 (inLexique)) {
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_84_26_importSemantics (galgas_scanner & inLexique,
                                GGS_M_semanticsComponents  &var_cas_ioSemanticsComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext,
...
void galgas_start::
pr_galgas_start_symbol_galgas_start_84_26_importSyntax (galgas_scanner & inLexique,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext) {
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
