...
void galgas_start::
galgas_start::
pr_galgas_start_symbol_galgas_start_99_4_ (galgas_scanner & _inLexique,
...
void galgas_start::
galgas_start::
pr_galgas_start_symbol_galgas_start_99_4_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &var_cas_ioLexiqueMapForUse) {
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_repeat_galgas_start_0 (_inLexique)) {
...
void galgas_start::
galgas_start::
pr_galgas_start_symbol_galgas_start_99_4_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &var_cas_ioSyntaxComponentsMap,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_treewalkingComponents  &var_cas_ioTreewalkingComponentMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext) {
...
void galgas_start::
galgas_start::
pr_galgas_start_symbol_galgas_start_99_4_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &var_cas_ioSemanticsComponentsMap,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_treewalkingComponents  &var_cas_ioTreewalkingComponentMap,
                                GGS_EXsemanticContext &var_cas_ioSemanticContext,
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_repeat_galgas_start_0 (_inLexique)) {
        case 2 : {
          nt_galgas_component_importSemantics (_inLexique, var_cas_ioSemanticsComponentsMap, var_cas_ioMetamodelComponentMap, var_cas_ioTreewalkingComponentMap, var_cas_ioSemanticContext, var_cas_ioImportedSemanticsComponentNameSet) ;
          } break ;
        default :
          syntaxRepeat_0 = false ;
          break ;
...
void galgas_start::
galgas_start::
pr_galgas_start_symbol_galgas_start_99_4_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &var_cas_ioGrammarComponentsMap,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
...
void galgas_start::
galgas_start::
pr_galgas_start_symbol_galgas_start_99_4_compileFile (galgas_scanner & _inLexique) {
...
void galgas_start::
galgas_start::
pr_galgas_start_symbol_galgas_start_99_4_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &var_cas_ioOptionsComponentsMap) {
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_repeat_galgas_start_0 (_inLexique)) {
