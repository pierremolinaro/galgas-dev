//---------------------------------------------------------------------------*
//                                                                           *
//                File 'include_typeLexicalLogInstruction.h'                 *
...
class cPtr_typeLexicalLogInstruction : public cPtr_typeInstructionLexicale {
...
//--- Constructor
  public : cPtr_typeLexicalLogInstruction (LOCATION_ARGS) ;

//--- Declaring a protected virtual destructor enables the compiler to raise
//    an error if a direct delete is performed; only the static method
//    C_GGS_Object::detachPointer may invoke delete.
  #ifndef DO_NOT_GENERATE_CHECKINGS
    protected : virtual ~cPtr_typeLexicalLogInstruction (void) {}
  #endif
