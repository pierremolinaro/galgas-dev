...
pr_parse_metamodel_metamodel_parser_114_23_ (galgas_scanner & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_6877 = var_cas_entityMap.firstObject () ;
  while ((operand_6877 != NULL)) {
    macroValidPointer (operand_6877) ;
    GGS_entityPropertyMap::element_type * operand_7110 = operand_6877->mInfo.mEntityPropertiesMap.firstObject () ;
    while ((operand_7110 != NULL)) {
      macroValidPointer (operand_7110) ;
      if (((((operand_7110->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE))) || ((operand_7110->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (_inLexique COMMA_HERE))))).isBuiltAndTrue ()) {
        GGS_entityPropertyMap  var_cas_7450 ;
        GGS_bool var_cas_7453 ;
        GGS_entityPropertyMap  var_cas_7456 ;
        GGS_lstring  var_cas_7459 ;
        if (var_cas_entityMap.isBuilt ()) {
          var_cas_entityMap (HERE)->method_searchKey (_inLexique, operand_7110->mInfo.mTypeName, var_cas_7450, var_cas_7453, var_cas_7456, var_cas_7459 SOURCE_FILE_AT_LINE (188)) ;
        }
        var_cas_multiReferencedEntities.addAssign_operation (operand_7110->mInfo.mTypeName.reader_value (_inLexique SOURCE_FILE_AT_LINE (189))) ;
      }
      operand_7110 = operand_7110->nextObject () ;
    }
    operand_6877 = operand_6877->nextObject () ;
  }
  if (var_cas_entityMap.isBuilt () &&
...
pr_entity_declaration_metamodel_parser_234_26_ (galgas_scanner & _inLexique,
  ...
  switch (select_metamodel_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_entityPropertyMap  var_cas_9284 ;
      GGS_bool var_cas_9293 ;
      GGS_lstring  var_cas_9324 ;
      if (var_cas_ioEntityMap.isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_9284, var_cas_9293, var_cas_allPropertyMap, var_cas_9324 SOURCE_FILE_AT_LINE (262)) ;
      }
      } break ;
    default :
      break ;
