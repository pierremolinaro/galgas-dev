...
pr_entity_declaration_metamodel_parser_225_6_ (galgas_scanner & _inLexique,
            ...
            case 1 : {
              ...
              if ((var_cas_inMetamodelClassSet.reader_hasKey (_inLexique, var_cas_propertyOrEntityTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (281)) SOURCE_FILE_AT_LINE (281))).isBuiltAndTrue ()) {
                ...
                if (var_cas_inSemanticsEntitiesMap._isBuilt ()) {
                  var_cas_inSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_propertyOrEntityTypeName, var_cas_entity SOURCE_FILE_AT_LINE (288)) ;
                }
  ...
  var_cas_def = GGS_C_metamodelEntityToImplement::constructor_new (_inLexique, var_cas_entityName, var_cas_isAbstract, var_cas_listeTousAttributsSemantiques, var_cas_listeAttributsSemantiquesCourants, var_cas_superEntityMap, var_cas_metamodelClassID.reader_uint (_inLexique SOURCE_FILE_AT_LINE (360)) COMMA_HERE) ;
