...
pr_parse_metamodel_metamodel_parser_172_4_ (galgas_scanner & _inLexique,
  ...
  {
    GGS_M_semanticsComponents::cEnumerator enumerator_9990 (var_cas_semanticsComponentsMap, true) ;
    const GGS_M_semanticsComponents::cElement * operand_9990 = NULL ;
    while (((operand_9990 = (GGS_M_semanticsComponents::cElement *) enumerator_9990.nextObject ()))) {
      macroValidPointer (operand_9990) ;
      var_cas_headerInclusionList._addAssign_operation (operand_9990->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (267))) ;
    }
  }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_10295 (var_cas_superMetamodelList, true) ;
    const GGS_lstringlist::cElement * operand_10295 = NULL ;
    while (((operand_10295 = (GGS_lstringlist::cElement *) enumerator_10295.nextObject ()))) {
      macroValidPointer (operand_10295) ;
      var_cas_headerInclusionList._addAssign_operation (operand_10295->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (273))) ;
      ::routine_performMetamodelInclusion (_inLexique,  var_cas_ioMetamodelComponentMap,  operand_10295->mValue,  var_cas_superMetamodels,  var_cas_allEntityMap COMMA_SOURCE_FILE_AT_LINE (273)) ;
    }
  }
  ...
  {
    GGS_entityToImplementMap::cEnumerator enumerator_10883 (var_cas_entityMap, true) ;
    const GGS_entityToImplementMap::cElement * operand_10883 = NULL ;
    while (((operand_10883 = (GGS_entityToImplementMap::cElement *) enumerator_10883.nextObject ()))) {
      macroValidPointer (operand_10883) ;
      {
        GGS_entityPropertyMap::cEnumerator enumerator_11097 (operand_10883->mInfo.mCurrentMetamodelPropertyMap, true) ;
        const GGS_entityPropertyMap::cElement * operand_11097 = NULL ;
        while (((operand_11097 = (GGS_entityPropertyMap::cElement *) enumerator_11097.nextObject ()))) {
          macroValidPointer (operand_11097) ;
          { const GGS_AC_galgasType _var_11476 = operand_11097->mInfo.mPropertyType ; // CAST instruction
            if (_var_11476.getPtr () != NULL) {
              macroValidPointer (_var_11476.getPtr ()) ;
              if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_11476.getPtr ()) != NULL) {
                const GGS_typeGalgas_singleReferenceEntity var_cas_e (_var_11476.getPtr ()) ;
                ...
                const GGS_entityToImplementMap  _temp_11312 = var_cas_allEntityMap ;
                if (_temp_11312._isBuilt ()) {
                  _temp_11312 (HERE)->method_searchKey (_inLexique, var_cas_e.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (301)), automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (301)) ;
                }
              }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_11476.getPtr ()) != NULL) {
                const GGS_typeGalgas_multipleReferenceEntity var_cas_e (_var_11476.getPtr ()) ;
                ...
                const GGS_entityToImplementMap  _temp_11427 = var_cas_allEntityMap ;
                if (_temp_11427._isBuilt ()) {
                  _temp_11427 (HERE)->method_searchKey (_inLexique, var_cas_e.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (303)), automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (303)) ;
                }
              }else{
              }
            }
...
pr_entity_declaration_list_metamodel_parser_334_4_ (galgas_scanner & _inLexique,
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_12847 = _inLexique.parsingContext () ;
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_12847) ;
...
pr_entity_declaration_metamodel_parser_369_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_metamodel_parser_8 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_entityToImplementMap  _temp_14155 = var_cas_ioAllEntityMap ;
      if (_temp_14155._isBuilt ()) {
        _temp_14155 (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, automatic_var_16, automatic_var_17, automatic_var_18, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, automatic_var_19, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (409)) ;
      }
          ...
          switch (select_metamodel_parser_10 (_inLexique)) {
            case 1 : {
              ...
              if ((var_cas_inMetamodelClassSet.reader_hasKey (_inLexique, var_cas_propertyOrEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (431)) COMMA_SOURCE_FILE_AT_LINE (431))).isBuiltAndTrue ()) {
                ...
                const GGS_M_semanticsEntitiesForUse  _temp_15290 = var_cas_inSemanticsEntitiesMap ;
                if (_temp_15290._isBuilt ()) {
                  _temp_15290 (HERE)->method_searchKey (_inLexique, var_cas_propertyOrEntityTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (441)) ;
                }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_17454 (var_cas_entityNameList, true) ;
    const GGS_lstringlist::cElement * operand_17454 = NULL ;
    while (((operand_17454 = (GGS_lstringlist::cElement *) enumerator_17454.nextObject ()))) {
      macroValidPointer (operand_17454) ;
      var_cas_ioEntityMap.modifier_insertKey (_inLexique, operand_17454->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (494)) ;
      var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, operand_17454->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (505)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
      var_cas_def = GGS_C_metamodelEntityToImplement ::constructor_new (_inLexique, operand_17454->mValue, var_cas_isAbstract, var_cas_listeTousAttributsSemantiques, var_cas_listeAttributsSemantiquesCourants, var_cas_superEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (522)), var_cas_ioEntityID COMMA_HERE) ;
