...
pr_parse_metamodel_metamodel_parser_159_6_ (galgas_scanner & _inLexique,
  ...
  const GGS_M_semanticsComponents::element_type * operand_9286 = _var_9286.firstObject () ;
  ...
  const GGS_lstringlist::element_type * operand_9590 = _var_9590.firstObject () ;
  ...
  const GGS_entityToImplementMap::element_type * operand_10177 = _var_10177.firstObject () ;
  while ((operand_10177 != NULL)) {
    ...
    const GGS_entityPropertyMap::element_type * operand_10390 = _var_10390.firstObject () ;
...
pr_entity_declaration_metamodel_parser_351_6_ (galgas_scanner & _inLexique,
                  ...
                  switch (select_metamodel_parser_12 (_inLexique)) {
                      ...
                      switch (select_metamodel_parser_13 (_inLexique)) {
                        case 1 : {
                          ...
                          if ((((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (441)))._operator_isEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_higherBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (441)))._operator_isEqual (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if lower bound is zero, higher bound should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (443)) ;
                            ...
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "higher bound should be greater or equal than lower bound") COMMA_SOURCE_FILE_AT_LINE (445)) ;
                          }
                          } break ;
                        case 2 : {
                    ...
                    case 2 : {
                      ...
                      if (((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (452)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                        var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if higher bound is implicit, lower bound should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (454)) ;
                      }
                      } break ;
                    default :
                      break ;
  ...
  const GGS_lstringlist _var_16946 = var_cas_entityNameList ;
  const GGS_lstringlist::element_type * operand_16946 = _var_16946.firstObject () ;
  while ((operand_16946 != NULL)) {
    macroValidPointer (operand_16946) ;
    var_cas_ioEntityMap.modifier_insertKey (_inLexique, operand_16946->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (477)) ;
    var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, operand_16946->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (488)) ;
    GGS_typeEntityToGenerate  var_cas_def ;
    var_cas_def = GGS_C_metamodelEntityToImplement::constructor_new (_inLexique, operand_16946->mValue, var_cas_isAbstract, var_cas_listeTousAttributsSemantiques, var_cas_listeAttributsSemantiquesCourants, var_cas_superEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (505)), var_cas_ioEntityID COMMA_HERE) ;
    ...
    operand_16946 = operand_16946->nextObject () ;
  }
}
