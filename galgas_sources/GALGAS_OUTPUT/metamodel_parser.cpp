...
pr_parse_metamodel_metamodel_parser_169_4_ (galgas_scanner & _inLexique,
  ...
  GGS_M_semanticsComponents::cEnumerator enumerator_9803 (var_cas_semanticsComponentsMap, true) ;
  const GGS_M_semanticsComponents::cElement * operand_9803 = NULL ;
  while (((operand_9803 = (GGS_M_semanticsComponents::cElement *) enumerator_9803.nextObject ()))) {
    macroValidPointer (operand_9803) ;
    var_cas_headerInclusionList._addAssign_operation (operand_9803->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (263))) ;
  }
  enumerator_9803.reset () ;
  ...
  GGS_lstringlist::cEnumerator enumerator_10107 (var_cas_superMetamodelList, true) ;
  const GGS_lstringlist::cElement * operand_10107 = NULL ;
  while (((operand_10107 = (GGS_lstringlist::cElement *) enumerator_10107.nextObject ()))) {
    macroValidPointer (operand_10107) ;
    var_cas_headerInclusionList._addAssign_operation (operand_10107->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (269))) ;
    ::routine_performMetamodelInclusion (_inLexique,  var_cas_ioMetamodelComponentMap,  operand_10107->mValue,  var_cas_superMetamodels,  var_cas_allEntityMap COMMA_SOURCE_FILE_AT_LINE (269)) ;
  }
  enumerator_10107.reset () ;
  ...
  nt_entity_declaration_list_ (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (281)), var_cas_semanticsEntitiesMap, var_cas_entityMap, var_cas_allEntityMap, var_cas_listeEntitesAengendrer) ;
  GGS_entityToImplementMap::cEnumerator enumerator_10694 (var_cas_entityMap, true) ;
  const GGS_entityToImplementMap::cElement * operand_10694 = NULL ;
  while (((operand_10694 = (GGS_entityToImplementMap::cElement *) enumerator_10694.nextObject ()))) {
    macroValidPointer (operand_10694) ;
    GGS_entityPropertyMap::cEnumerator enumerator_10907 (operand_10694->mInfo.mCurrentMetamodelPropertyMap, true) ;
    const GGS_entityPropertyMap::cElement * operand_10907 = NULL ;
    while (((operand_10907 = (GGS_entityPropertyMap::cElement *) enumerator_10907.nextObject ()))) {
      macroValidPointer (operand_10907) ;
      { const GGS_AC_galgasType _var_11369 = operand_10907->mInfo.mPropertyType ; // CAST instruction
        if (_var_11369.getPtr () != NULL) {
          macroValidPointer (_var_11369.getPtr ()) ;
          if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_11369.getPtr ()) != NULL) {
            const GGS_typeGalgas_singleReferenceEntity var_cas_e (_var_11369.getPtr ()) ;
            ...
            const GGS_entityToImplementMap  _temp_11163 = var_cas_allEntityMap ;
            if (_temp_11163._isBuilt ()) {
              _temp_11163 (HERE)->method_searchKey (_inLexique, var_cas_e.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (297)), automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (297)) ;
            }
          }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_11369.getPtr ()) != NULL) {
            const GGS_typeGalgas_multipleReferenceEntity var_cas_e (_var_11369.getPtr ()) ;
            ...
            const GGS_entityToImplementMap  _temp_11320 = var_cas_allEntityMap ;
            if (_temp_11320._isBuilt ()) {
              _temp_11320 (HERE)->method_searchKey (_inLexique, var_cas_e.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (299)), automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (299)) ;
            }
          }else{
          }
        }
    ...
    enumerator_10907.reset () ;
  }
  enumerator_10694.reset () ;
  if ((var_cas_inGenerateMetamodelCode).isBuiltAndTrue ()) {
    if (var_cas_entityMap._isBuilt () &&
      ...
      ::routine_generate_metamodel (_inLexique,  var_cas_entityMap,  var_cas_metamodelName,  var_cas_listeEntitesAengendrer,  var_cas_rootEntityName,  var_cas_headerInclusionList COMMA_SOURCE_FILE_AT_LINE (305)) ;
    }
  }
  if (((var_cas_ioMetamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (315)) COMMA_SOURCE_FILE_AT_LINE (315)))._operator_not ()).isBuiltAndTrue ()) {
    var_cas_ioMetamodelComponentMap.modifier_insertKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, var_cas_entityMap, var_cas_superMetamodels COMMA_SOURCE_FILE_AT_LINE (316)) ;
  }
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_list_metamodel_parser_330_4_ (galgas_scanner & _inLexique,
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_12740 = _inLexique.parsingContext () ;
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_12740) ;
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_330_4_parse (galgas_scanner & _inLexique) {
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_12740 = _inLexique.parsingContext () ;
    { bool syntaxRepeat_5 = true ;
      while (syntaxRepeat_5) {
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_365_4_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inCurrentMetamodelName,
  ...
  switch (select_metamodel_parser_8 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_entityToImplementMap  _temp_14048 = var_cas_ioAllEntityMap ;
      if (_temp_14048._isBuilt ()) {
        _temp_14048 (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, automatic_var_16, automatic_var_17, automatic_var_18, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, automatic_var_19, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (405)) ;
      }
      var_cas_superEntityMap.modifier_insertKey (_inLexique, var_cas_superEntity COMMA_SOURCE_FILE_AT_LINE (413)) ;
      } break ;
    default :
      break ;
  }
        ...
        case 2 : {
          ...
          switch (select_metamodel_parser_10 (_inLexique)) {
            case 1 : {
              ...
              if ((var_cas_inMetamodelClassSet.reader_hasKey (_inLexique, var_cas_propertyOrEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (427)) COMMA_SOURCE_FILE_AT_LINE (427))).isBuiltAndTrue ()) {
                ...
                var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (433)) ;
                var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (434)) ;
              }else{
                GGS_AC_semanticsEntity  var_cas_theEntity ;
                const GGS_M_semanticsEntitiesForUse  _temp_15183 = var_cas_inSemanticsEntitiesMap ;
                if (_temp_15183._isBuilt ()) {
                  _temp_15183 (HERE)->method_searchKey (_inLexique, var_cas_propertyOrEntityTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (437)) ;
                }
                var_cas_propertyType = GGS_typeEntiteType::_castFrom (_inLexique, var_cas_theEntity.getPtr (), true, var_cas_propertyOrEntityTypeName COMMA_SOURCE_FILE_AT_LINE (438)).reader_aDefType (_inLexique COMMA_SOURCE_FILE_AT_LINE (438)) ;
                var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (439)) ;
                var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (440)) ;
              }
            ...
            case 2 : {
                ...
                case 1 : {
                  ...
                  switch (select_metamodel_parser_12 (_inLexique)) {
                    case 1 : {
                      ...
                      switch (select_metamodel_parser_13 (_inLexique)) {
                        case 1 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
                          if ((((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (454)))._operator_isEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_higherBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (454)))._operator_isEqual (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if lower bound is zero, higher bound should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (455)) ;
                          }else if ((((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (456)))._operator_strictSup (GGS_uint (true, 0U)))._operator_and ((var_cas_higherBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (456)))._operator_strictInf (var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (456))))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "higher bound should be greater or equal than lower bound") COMMA_SOURCE_FILE_AT_LINE (457)) ;
                          }
                          } break ;
                        case 2 : {
                    ...
                    case 2 : {
                      ...
                      if (((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (465)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                        var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if higher bound is implicit, lower bound should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (466)) ;
                      }
                      } break ;
                    default :
                      break ;
              ...
              var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (481)) ;
              var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (482)) ;
              var_cas_listeTousAttributsSemantiques._addAssign_operation (var_cas_propertyType, var_cas_attributeName) ;
              var_cas_listeAttributsSemantiquesCourants._addAssign_operation (var_cas_propertyType, var_cas_attributeName) ;
              } break ;
            default :
  ...
  GGS_lstringlist::cEnumerator enumerator_17347 (var_cas_entityNameList, true) ;
  const GGS_lstringlist::cElement * operand_17347 = NULL ;
  while (((operand_17347 = (GGS_lstringlist::cElement *) enumerator_17347.nextObject ()))) {
    macroValidPointer (operand_17347) ;
    var_cas_ioEntityMap.modifier_insertKey (_inLexique, operand_17347->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (490)) ;
    var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, operand_17347->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (501)) ;
    GGS_typeEntityToGenerate  var_cas_def ;
    var_cas_def = GGS_C_metamodelEntityToImplement::constructor_new (_inLexique, operand_17347->mValue, var_cas_isAbstract, var_cas_listeTousAttributsSemantiques, var_cas_listeAttributsSemantiquesCourants, var_cas_superEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (518)), var_cas_ioEntityID COMMA_HERE) ;
    var_cas_listeEntitesAengendrer._addAssign_operation (var_cas_def) ;
    var_cas_ioEntityID._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (522)) ;
  }
  enumerator_17347.reset () ;
}
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_365_4_parseForEnumeratingClasses (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_7 = true ;
    while (syntaxRepeat_7) {
        ...
        _inLexique._assignFromAttribute_tokenString (var_cas_entityName) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
        var_cas_ioMetamodelClassSet._addAssign_operation (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (537))) ;
      switch (select_repeat_metamodel_parser_7 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
          } break ;
...
void metamodel_parser::
pr_entity_declaration_metamodel_parser_365_4_parse (galgas_scanner & _inLexique) {
  switch (select_metamodel_parser_6 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
