...
metamodel_parser::
pr_galgas_component_metamodel_parser_120_4_ (galgas_scanner & _inLexique,
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_120_4_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_120_4_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_120_4_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_120_4_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_120_4_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  nt_parse_metamodel_parse (_inLexique) ;
}
...
void metamodel_parser::
metamodel_parser::
pr_parse_metamodel_metamodel_parser_162_4_ (galgas_scanner & _inLexique,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
  ...
  {
    GGS_M_semanticsComponents::cEnumerator enumerator_9375 (var_cas_semanticsComponentsMap, true) ;
    const GGS_M_semanticsComponents::cElement * operand_9375 = NULL ;
    while (((operand_9375 = (GGS_M_semanticsComponents::cElement *) enumerator_9375.nextObject ()))) {
      macroValidPointer (operand_9375) ;
      var_cas_headerInclusionList._addAssign_operation (operand_9375->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (256))) ;
    }
  }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_9680 (var_cas_superMetamodelList, true) ;
    const GGS_lstringlist::cElement * operand_9680 = NULL ;
    while (((operand_9680 = (GGS_lstringlist::cElement *) enumerator_9680.nextObject ()))) {
      macroValidPointer (operand_9680) ;
      var_cas_headerInclusionList._addAssign_operation (operand_9680->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (262))) ;
      ::routine_performMetamodelInclusion (_inLexique,  var_cas_ioMetamodelComponentMap,  operand_9680->mValue,  var_cas_superMetamodels,  var_cas_allEntityMap COMMA_SOURCE_FILE_AT_LINE (262)) ;
    }
  }
  ...
  nt_entity_declaration_list_ (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (274)), var_cas_semanticsEntitiesMap, var_cas_entityMap, var_cas_allEntityMap, var_cas_listeEntitesAengendrer) ;
  {
    GGS_entityToImplementMap::cEnumerator enumerator_10268 (var_cas_entityMap, true) ;
    const GGS_entityToImplementMap::cElement * operand_10268 = NULL ;
    while (((operand_10268 = (GGS_entityToImplementMap::cElement *) enumerator_10268.nextObject ()))) {
      macroValidPointer (operand_10268) ;
      {
        GGS_entityPropertyMap::cEnumerator enumerator_10482 (operand_10268->mInfo.mCurrentMetamodelPropertyMap, true) ;
        const GGS_entityPropertyMap::cElement * operand_10482 = NULL ;
        while (((operand_10482 = (GGS_entityPropertyMap::cElement *) enumerator_10482.nextObject ()))) {
          macroValidPointer (operand_10482) ;
          { const GGS_AC_galgasType _var_10861 = operand_10482->mInfo.mPropertyType ; // CAST instruction
            if (_var_10861.getPtr () != NULL) {
              macroValidPointer (_var_10861.getPtr ()) ;
              if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_10861.getPtr ()) != NULL) {
                const GGS_typeGalgas_singleReferenceEntity var_cas_e (_var_10861.getPtr ()) ;
                ...
                const GGS_entityToImplementMap  _temp_10697 = var_cas_allEntityMap ;
                if (_temp_10697._isBuilt ()) {
                  _temp_10697 (HERE)->method_searchKey (_inLexique, var_cas_e.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (290)), automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (290)) ;
                }
              }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_10861.getPtr ()) != NULL) {
                const GGS_typeGalgas_multipleReferenceEntity var_cas_e (_var_10861.getPtr ()) ;
                ...
                const GGS_entityToImplementMap  _temp_10812 = var_cas_allEntityMap ;
                if (_temp_10812._isBuilt ()) {
                  _temp_10812 (HERE)->method_searchKey (_inLexique, var_cas_e.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (292)), automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (292)) ;
                }
              }else{
              }
            }
  ...
  if ((var_cas_inGenerateMetamodelCode).isBuiltAndTrue ()) {
    if (var_cas_entityMap._isBuilt () &&
      ...
      ::routine_generate_metamodel (_inLexique,  var_cas_entityMap,  var_cas_metamodelName,  var_cas_listeEntitesAengendrer,  var_cas_rootEntityName,  var_cas_headerInclusionList COMMA_SOURCE_FILE_AT_LINE (298)) ;
    }
  }
  if (((var_cas_ioMetamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (308)) COMMA_SOURCE_FILE_AT_LINE (308)))._operator_not ()).isBuiltAndTrue ()) {
    var_cas_ioMetamodelComponentMap.modifier_insertKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, var_cas_entityMap, var_cas_superMetamodels COMMA_SOURCE_FILE_AT_LINE (309)) ;
  }
...
void metamodel_parser::
pr_parse_metamodel_metamodel_parser_162_4_parse (galgas_scanner & _inLexique) {
  switch (select_metamodel_parser_0 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_abstract) COMMA_HERE) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_metamodel) COMMA_HERE) ;
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_list_metamodel_parser_323_4_ (galgas_scanner & _inLexique,
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_12232 = _inLexique.parsingContext () ;
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_12232) ;
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_323_4_parse (galgas_scanner & _inLexique) {
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_12232 = _inLexique.parsingContext () ;
    { bool syntaxRepeat_5 = true ;
      while (syntaxRepeat_5) {
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_358_4_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inCurrentMetamodelName,
  ...
  switch (select_metamodel_parser_8 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_entityToImplementMap  _temp_13540 = var_cas_ioAllEntityMap ;
      if (_temp_13540._isBuilt ()) {
        _temp_13540 (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, automatic_var_16, automatic_var_17, automatic_var_18, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, automatic_var_19, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (398)) ;
      }
      var_cas_superEntityMap.modifier_insertKey (_inLexique, var_cas_superEntity COMMA_SOURCE_FILE_AT_LINE (406)) ;
      } break ;
    default :
      break ;
  }
        ...
        case 2 : {
          ...
          switch (select_metamodel_parser_10 (_inLexique)) {
            case 1 : {
              ...
              if ((var_cas_inMetamodelClassSet.reader_hasKey (_inLexique, var_cas_propertyOrEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (420)) COMMA_SOURCE_FILE_AT_LINE (420))).isBuiltAndTrue ()) {
                ...
                var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (426)) ;
                var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (427)) ;
              }else{
                GGS_AC_semanticsEntity  var_cas_theEntity ;
                const GGS_M_semanticsEntitiesForUse  _temp_14675 = var_cas_inSemanticsEntitiesMap ;
                if (_temp_14675._isBuilt ()) {
                  _temp_14675 (HERE)->method_searchKey (_inLexique, var_cas_propertyOrEntityTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (430)) ;
                }
                var_cas_propertyType = GGS_typeEntiteType::_castFrom (_inLexique, var_cas_theEntity.getPtr (), true, var_cas_propertyOrEntityTypeName COMMA_SOURCE_FILE_AT_LINE (431)).reader_aDefType (_inLexique COMMA_SOURCE_FILE_AT_LINE (431)) ;
                var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (432)) ;
                var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (433)) ;
              }
            ...
            case 2 : {
                ...
                case 1 : {
                  ...
                  switch (select_metamodel_parser_12 (_inLexique)) {
                    case 1 : {
                      ...
                      switch (select_metamodel_parser_13 (_inLexique)) {
                        case 1 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
                          if ((((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (447)))._operator_isEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_higherBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (447)))._operator_isEqual (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if lower bound is zero, higher bound should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (448)) ;
                          }else if ((((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (449)))._operator_strictSup (GGS_uint (true, 0U)))._operator_and ((var_cas_higherBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (449)))._operator_strictInf (var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (449))))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "higher bound should be greater or equal than lower bound") COMMA_SOURCE_FILE_AT_LINE (450)) ;
                          }
                          } break ;
                        case 2 : {
                    ...
                    case 2 : {
                      ...
                      if (((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (458)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                        var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if higher bound is implicit, lower bound should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (459)) ;
                      }
                      } break ;
                    default :
                      break ;
              ...
              var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (474)) ;
              var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (475)) ;
              var_cas_listeTousAttributsSemantiques._addAssign_operation (var_cas_propertyType, var_cas_attributeName) ;
              var_cas_listeAttributsSemantiquesCourants._addAssign_operation (var_cas_propertyType, var_cas_attributeName) ;
              } break ;
            default :
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_16839 (var_cas_entityNameList, true) ;
    const GGS_lstringlist::cElement * operand_16839 = NULL ;
    while (((operand_16839 = (GGS_lstringlist::cElement *) enumerator_16839.nextObject ()))) {
      macroValidPointer (operand_16839) ;
      var_cas_ioEntityMap.modifier_insertKey (_inLexique, operand_16839->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (483)) ;
      var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, operand_16839->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (494)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
      var_cas_def = GGS_C_metamodelEntityToImplement ::constructor_new (_inLexique, operand_16839->mValue, var_cas_isAbstract, var_cas_listeTousAttributsSemantiques, var_cas_listeAttributsSemantiquesCourants, var_cas_superEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (511)), var_cas_ioEntityID COMMA_HERE) ;
      var_cas_listeEntitesAengendrer._addAssign_operation (var_cas_def) ;
      var_cas_ioEntityID._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (515)) ;
    }
  }
}
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_358_4_parseForEnumeratingClasses (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_7 = true ;
    while (syntaxRepeat_7) {
        ...
        _inLexique._assignFromAttribute_tokenString (var_cas_entityName) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
        var_cas_ioMetamodelClassSet._addAssign_operation (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (530))) ;
      switch (select_repeat_metamodel_parser_7 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
          } break ;
...
void metamodel_parser::
pr_entity_declaration_metamodel_parser_358_4_parse (galgas_scanner & _inLexique) {
  switch (select_metamodel_parser_6 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
