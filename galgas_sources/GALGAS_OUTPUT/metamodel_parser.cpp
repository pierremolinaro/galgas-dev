...
pr_parse_metamodel_metamodel_parser_159_6_ (galgas_scanner & _inLexique,
  ...
  while ((operand_8769 != NULL)) {
    ...
    var_cas_headerInclusionList._addAssign_operation (operand_8769->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (229))) ;
  ...
  while ((operand_9069 != NULL)) {
    ...
    var_cas_headerInclusionList._addAssign_operation (operand_9069->mValue.reader_string (_inLexique SOURCE_FILE_AT_LINE (235))) ;
    ::routine_performMetamodelInclusion (_inLexique,  var_cas_ioMetamodelComponentMap,  operand_9069->mValue,  var_cas_superMetamodels,  var_cas_allEntityMap SOURCE_FILE_AT_LINE (236)) ;
  ...
  ::routine_enterBuiltinTypes (_inLexique,  var_cas_semanticsEntitiesMap SOURCE_FILE_AT_LINE (247)) ;
  nt_entity_declaration_list_ (_inLexique, var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (249)), var_cas_semanticsEntitiesMap, var_cas_entityMap, var_cas_allEntityMap, var_cas_listeEntitesAengendrer) ;
      ...
      if (operand_9967->mInfo.mPropertyType._isBuilt ()) {
        ...
        if (operand_10099 != NULL) {
          ...
          if (var_cas_allEntityMap._isBuilt ()) {
            var_cas_allEntityMap (HERE)->method_searchKey (_inLexique, operand_10099->mEntityTypeName, automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7 SOURCE_FILE_AT_LINE (265)) ;
          }
        }else{
          ...
          if (operand_10240 != NULL) {
            ...
            if (var_cas_allEntityMap._isBuilt ()) {
              var_cas_allEntityMap (HERE)->method_searchKey (_inLexique, operand_10240->mEntityTypeName, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15 SOURCE_FILE_AT_LINE (267)) ;
            }
          }else{ // Else part
          }
        }
  ...
  if ((var_cas_inGenerateMetamodelCode).isBuiltAndTrue ()) {
    if (var_cas_entityMap._isBuilt () &&
      ...
      ::routine_generate_metamodel (_inLexique,  var_cas_entityMap,  var_cas_metamodelName,  var_cas_listeEntitesAengendrer,  var_cas_rootEntityName,  var_cas_headerInclusionList SOURCE_FILE_AT_LINE (274)) ;
    }
  }
  if (((! (var_cas_ioMetamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (283)) SOURCE_FILE_AT_LINE (283))))).isBuiltAndTrue ()) {
    var_cas_ioMetamodelComponentMap.modifier_insertKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, var_cas_entityMap, var_cas_superMetamodels SOURCE_FILE_AT_LINE (284)) ;
  }
...
pr_entity_declaration_metamodel_parser_333_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_metamodel_parser_4 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_ioAllEntityMap._isBuilt ()) {
        var_cas_ioAllEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, automatic_var_16, automatic_var_17, automatic_var_18, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, automatic_var_19, automatic_var_20 SOURCE_FILE_AT_LINE (367)) ;
      }
      var_cas_superEntityMap.modifier_insertKey (_inLexique, var_cas_superEntity SOURCE_FILE_AT_LINE (375)) ;
      } break ;
    default :
      break ;
  }
        ...
        case 2 : {
          ...
          switch (select_metamodel_parser_6 (_inLexique)) {
            case 1 : {
              ...
              if ((var_cas_inMetamodelClassSet.reader_hasKey (_inLexique, var_cas_propertyOrEntityTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (389)) SOURCE_FILE_AT_LINE (389))).isBuiltAndTrue ()) {
                ...
                var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType SOURCE_FILE_AT_LINE (391)) ;
                var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType SOURCE_FILE_AT_LINE (392)) ;
              }else{
                GGS_AC_semanticsEntity  var_cas_theEntity ;
                if (var_cas_inSemanticsEntitiesMap._isBuilt ()) {
                  var_cas_inSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_propertyOrEntityTypeName, var_cas_theEntity SOURCE_FILE_AT_LINE (395)) ;
                }
                { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_theEntity.getPtr ()) ;
                  if (ptrExtraire_ == NULL) {
                    ...
                    if (var_cas_theEntity.getPtr () != NULL) {
                      ...
                      var_cas_propertyOrEntityTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (396)) ;
                    }
                  }else{
                ...
                var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType SOURCE_FILE_AT_LINE (397)) ;
                var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType SOURCE_FILE_AT_LINE (398)) ;
              }
            ...
            case 2 : {
                ...
                case 1 : {
                  ...
                  switch (select_metamodel_parser_8 (_inLexique)) {
                    case 1 : {
                      ...
                      switch (select_metamodel_parser_9 (_inLexique)) {
                        case 1 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
                          if (((((var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (412))) == (GGS_uint (true, 0U))) & ((var_cas_higherBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (412))) == (GGS_uint (true, 0U))))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if lower bound is zero, higher bound should be greater than zero") SOURCE_FILE_AT_LINE (414)) ;
                          }else if (((((var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (414))) > (GGS_uint (true, 0U))) & ((var_cas_higherBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (414))) < (var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (414)))))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "higher bound should be greater or equal than lower bound") SOURCE_FILE_AT_LINE (416)) ;
                          }
                          } break ;
                        case 2 : {
                    ...
                    case 2 : {
                      ...
                      if (((var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (423))) == (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                        var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if higher bound is implicit, lower bound should be greater than zero") SOURCE_FILE_AT_LINE (425)) ;
                      }
                      } break ;
                    default :
                      break ;
              ...
              var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType SOURCE_FILE_AT_LINE (439)) ;
              var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType SOURCE_FILE_AT_LINE (440)) ;
              var_cas_listeTousAttributsSemantiques._addAssign_operation (var_cas_propertyType, var_cas_attributeName) ;
              var_cas_listeAttributsSemantiquesCourants._addAssign_operation (var_cas_propertyType, var_cas_attributeName) ;
              } break ;
            default :
  ...
  var_cas_ioEntityMap.modifier_insertKey (_inLexique, var_cas_entityName, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID SOURCE_FILE_AT_LINE (447)) ;
  var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, var_cas_entityName, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID SOURCE_FILE_AT_LINE (458)) ;
  GGS_typeEntityToGenerate  var_cas_def ;
  var_cas_def = GGS_C_metamodelEntityToImplement::constructor_new (_inLexique, var_cas_entityName, var_cas_isAbstract, var_cas_listeTousAttributsSemantiques, var_cas_listeAttributsSemantiquesCourants, var_cas_superEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (475)), var_cas_ioEntityID COMMA_HERE) ;
  var_cas_listeEntitesAengendrer._addAssign_operation (var_cas_def) ;
  var_cas_ioEntityID._increment_operation (_inLexique SOURCE_FILE_AT_LINE (479)) ;
}
...
pr_entity_declaration_metamodel_parser_333_6_parseForEnumeratingClasses (galgas_scanner & _inLexique,
  ...
  _inLexique._assignFromAttribute_tokenString (var_cas_entityName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  var_cas_ioMetamodelClassSet._addAssign_operation (var_cas_entityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (492))) ;
  switch (select_metamodel_parser_4 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
