...
//                    february 18th, 2007, at 12h19'28"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_parse_metamodel_metamodel_parser_116_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_entityMap._isBuilt ()) {
    var_cas_entityMap (HERE)->method_searchKey (_inLexique, var_cas_rootEntityName, automatic_var_0, var_cas_isAbstract, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6 SOURCE_FILE_AT_LINE (152)) ;
  }
  if ((var_cas_isAbstract).isBuiltAndTrue ()) {
    var_cas_rootEntityName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the root entity cannot be abstract") SOURCE_FILE_AT_LINE (155)) ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_6283 = var_cas_entityMap.firstObject () ;
  while ((operand_6283 != NULL)) {
    macroValidPointer (operand_6283) ;
    GGS_entityPropertyMap::element_type * operand_6598 = operand_6283->mInfo.mCurrentMetamodelPropertyMap.firstObject () ;
    while ((operand_6598 != NULL)) {
      macroValidPointer (operand_6598) ;
      if (operand_6598->mInfo.mProperty._isBuilt ()) {
        cPtr_metamodelSingleReferenceProperty * operand_6726 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_6598->mInfo.mProperty.getPtr ()) ;
        if (operand_6726 != NULL) {
          macroValidPointer (operand_6726) ; 
          ...
          if (var_cas_entityMap._isBuilt ()) {
            var_cas_entityMap (HERE)->method_searchKey (_inLexique, operand_6726->mReferenceEntityName, automatic_var_7, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14 SOURCE_FILE_AT_LINE (171)) ;
          }
        }else{
          cPtr_metamodelMultipleReferenceProperty * operand_6884 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_6598->mInfo.mProperty.getPtr ()) ;
          if (operand_6884 != NULL) {
            macroValidPointer (operand_6884) ; 
            ...
            if (var_cas_entityMap._isBuilt ()) {
              var_cas_entityMap (HERE)->method_searchKey (_inLexique, operand_6884->mReferenceEntityName, automatic_var_15, automatic_var_16, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20, automatic_var_21, automatic_var_22 SOURCE_FILE_AT_LINE (173)) ;
            }
            var_cas_multiReferencedEntities._addAssign_operation (operand_6884->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (174))) ;
          }else{ // Else part
          }
        }
      }
      operand_6598 = operand_6598->nextObject () ;
    }
    operand_6283 = operand_6283->nextObject () ;
  }
  if ((var_cas_inGenerateMetamodelCode).isBuiltAndTrue ()) {
    if (var_cas_entityMap._isBuilt () &&
      ...
      ::routine_generate_metamodel (_inLexique,  var_cas_entityMap,  var_cas_metamodelName,  var_cas_multiReferencedEntities,  var_cas_rootEntityName SOURCE_FILE_AT_LINE (181)) ;
    }
  }
  if (((! (var_cas_ioMetamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (189)) SOURCE_FILE_AT_LINE (189))))).isBuiltAndTrue ()) {
    var_cas_ioMetamodelComponentMap.modifier_insertKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, var_cas_entityMap, var_cas_multiReferencedEntities SOURCE_FILE_AT_LINE (190)) ;
  }
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_list_metamodel_parser_204_6_ (galgas_scanner & _inLexique,
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_204_6_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_0 (_inLexique)) {
        case 2 : {
  ...
  switch (select_metamodel_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_ioEntityMap._isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, automatic_var_23, automatic_var_24, automatic_var_25, automatic_var_26, var_cas_superEntitySet, automatic_var_27, automatic_var_28 SOURCE_FILE_AT_LINE (250)) ;
      }
      var_cas_superEntitySet._addAssign_operation (var_cas_superEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (261))) ;
      } break ;
    default :
      break ;
  }
    ...
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_3 (_inLexique)) {
        case 2 : {
          ...
          if (((! (var_cas_ioPrimitiveTypeAttributeNameSet.reader_hasKey (_inLexique, var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (270)) SOURCE_FILE_AT_LINE (270))))).isBuiltAndTrue ()) {
            var_cas_propertyTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (271))))) + (GGS_string (true, "' is not a predefined type name"))) SOURCE_FILE_AT_LINE (273)) ;
          }
          ...
          var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (277)) ;
          var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (278)) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          } break ;
        case 3 : {
          GGS_lstring  var_cas_propertyTypeName ;
                ...
                case 1 : {
                  ...
                  switch (select_metamodel_parser_6 (_inLexique)) {
                    case 1 : {
                      ...
                      switch (select_metamodel_parser_7 (_inLexique)) {
                        case 1 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
                          if (((((var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (296))) == (GGS_uint (true, 0U))) & ((var_cas_higherBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (296))) == (GGS_uint (true, 0U))))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if lower bound is zero, higher bound should be greater than zero") SOURCE_FILE_AT_LINE (298)) ;
                          }else if (((((var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (298))) > (GGS_uint (true, 0U))) & ((var_cas_higherBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (298))) < (var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (298)))))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "higher bound should be greater or equal than lower bound") SOURCE_FILE_AT_LINE (300)) ;
                          }
                          } break ;
                        case 2 : {
                    ...
                    case 2 : {
                      ...
                      if (((var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (307))) == (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                        var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if higher bound is implicit, lower bound should be greater than zero") SOURCE_FILE_AT_LINE (309)) ;
                      }
                      } break ;
                    default :
                      break ;
          ...
          var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (323)) ;
          var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (324)) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          } break ;
        default :
          syntaxRepeat = false ;
