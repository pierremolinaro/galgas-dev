...
pr_parse_metamodel_metamodel_parser_159_6_ (galgas_scanner & _inLexique,
  ...
  while ((operand_10177 != NULL)) {
    ...
    while ((operand_10390 != NULL)) {
      ...
      if (operand_10390->mInfo.mPropertyType._isBuilt ()) {
        cPtr_typeGalgas_singleReferenceEntity * operand_10543 = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (operand_10390->mInfo.mPropertyType.getPtr ()) ;
        if (operand_10543 != NULL) {
          ...
          cPtr_typeGalgas_multipleReferenceEntity * operand_10687 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (operand_10390->mInfo.mPropertyType.getPtr ()) ;
