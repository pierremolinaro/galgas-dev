        ...
        if (_var_11292.getPtr () != NULL) {
          ...
          if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_11292.getPtr ()) != NULL) {
            ...
            if (var_cas_allEntityMap._isBuilt ()) {
              var_cas_allEntityMap (HERE)->method_searchKey (_inLexique, var_cas_e.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (295)), automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (295)) ;
            }
            ...
            if (var_cas_allEntityMap._isBuilt ()) {
              var_cas_allEntityMap (HERE)->method_searchKey (_inLexique, var_cas_e.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (297)), automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (297)) ;
            }
          }else{
          }
        }
  ...
  switch (select_metamodel_parser_8 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_ioAllEntityMap._isBuilt ()) {
        var_cas_ioAllEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, automatic_var_16, automatic_var_17, automatic_var_18, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, automatic_var_19, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (403)) ;
      }
            ...
            case 1 : {
              ...
              if ((var_cas_inMetamodelClassSet.reader_hasKey (_inLexique, var_cas_propertyOrEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (425)) COMMA_SOURCE_FILE_AT_LINE (425))).isBuiltAndTrue ()) {
                ...
                if (var_cas_inSemanticsEntitiesMap._isBuilt ()) {
                  var_cas_inSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_propertyOrEntityTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (435)) ;
                }
