...
void metamodel_parser::
metamodel_parser::
pr_parse_metamodel_metamodel_parser_117_6_ (galgas_scanner & _inLexique,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
  ...
  ::routine_enterBuiltinTypes (_inLexique, var_cas_semanticsEntitiesMap SOURCE_FILE_AT_LINE (134)) ;
  ...
  if (var_cas_entityMap._isBuilt ()) {
    var_cas_entityMap (HERE)->method_searchKey (_inLexique, var_cas_rootEntityName, automatic_var_0, var_cas_isAbstract, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4 SOURCE_FILE_AT_LINE (142)) ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_5738 = var_cas_entityMap.firstObject () ;
  while ((operand_5738 != NULL)) {
    macroValidPointer (operand_5738) ;
    GGS_entityPropertyMap::element_type * operand_5962 = operand_5738->mInfo.mCurrentMetamodelPropertyMap.firstObject () ;
    while ((operand_5962 != NULL)) {
      macroValidPointer (operand_5962) ;
      if (operand_5962->mInfo.mProperty._isBuilt ()) {
        cPtr_metamodelSingleReferenceProperty * operand_6090 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_5962->mInfo.mProperty.getPtr ()) ;
        if (operand_6090 != NULL) {
          macroValidPointer (operand_6090) ; 
          ...
          if (var_cas_entityMap._isBuilt ()) {
            var_cas_entityMap (HERE)->method_searchKey (_inLexique, operand_6090->mReferenceEntityName, automatic_var_5, automatic_var_6, automatic_var_7, automatic_var_8, automatic_var_9, automatic_var_10 SOURCE_FILE_AT_LINE (157)) ;
          }
        }else{
          cPtr_metamodelMultipleReferenceProperty * operand_6228 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_5962->mInfo.mProperty.getPtr ()) ;
          if (operand_6228 != NULL) {
            macroValidPointer (operand_6228) ; 
            ...
            if (var_cas_entityMap._isBuilt ()) {
              var_cas_entityMap (HERE)->method_searchKey (_inLexique, operand_6228->mReferenceEntityName, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15, automatic_var_16 SOURCE_FILE_AT_LINE (159)) ;
            }
            var_cas_multiReferencedEntities._addAssign_operation (operand_6228->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (160))) ;
          }else{ // Else part
          }
        }
      }
      operand_5962 = operand_5962->nextObject () ;
    }
    operand_5738 = operand_5738->nextObject () ;
  }
  if ((var_cas_inGenerateMetamodelCode).isBuiltAndTrue ()) {
    if (var_cas_entityMap._isBuilt () &&
      ...
      ::routine_generate_metamodel (_inLexique,  var_cas_entityMap,  var_cas_metamodelName,  var_cas_listeEntitesAengendrer,  var_cas_rootEntityName SOURCE_FILE_AT_LINE (167)) ;
    }
  }
  if (((! (var_cas_ioMetamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (175)) SOURCE_FILE_AT_LINE (175))))).isBuiltAndTrue ()) {
    var_cas_ioMetamodelComponentMap.modifier_insertKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, var_cas_entityMap, var_cas_multiReferencedEntities SOURCE_FILE_AT_LINE (176)) ;
  }
...
void metamodel_parser::
pr_parse_metamodel_metamodel_parser_117_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_metamodel) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_root) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_list_metamodel_parser_190_6_ (galgas_scanner & _inLexique,
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_7711 = _inLexique.parsingContext () ;
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_7711) ;
    { bool syntaxRepeat = true ;
      while (syntaxRepeat) {
        switch (select_repeat_metamodel_parser_0 (_inLexique)) {
          case 2 : {
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_190_6_parse (galgas_scanner & _inLexique) {
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_7711 = _inLexique.parsingContext () ;
    { bool syntaxRepeat = true ;
      while (syntaxRepeat) {
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_221_6_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  var_cas_ioMapAndEntityUniqueMap.modifier_insertKey (_inLexique, var_cas_entityName SOURCE_FILE_AT_LINE (240)) ;
          ...
          switch (select_metamodel_parser_4 (_inLexique)) {
            case 1 : {
              ...
              if ((var_cas_inMetamodelClassSet.reader_hasKey (_inLexique, var_cas_propertyOrEntityTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (277)) SOURCE_FILE_AT_LINE (277))).isBuiltAndTrue ()) {
                ...
                var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (279)) ;
                var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (280)) ;
                ...
                if (var_cas_inSemanticsEntitiesMap._isBuilt ()) {
                  var_cas_inSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_propertyOrEntityTypeName, var_cas_theEntity SOURCE_FILE_AT_LINE (284)) ;
                }
                { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_theEntity.getPtr ()) ;
                  if (ptrExtraire_ == NULL) {
                    ...
                    if (var_cas_theEntity.getPtr () != NULL) {
                      ...
                      var_cas_propertyOrEntityTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (285)) ;
                    }
                  }else{
                ...
                var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (287)) ;
                var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (288)) ;
              }
            ...
            case 2 : {
                ...
                case 1 : {
                  ...
                  switch (select_metamodel_parser_6 (_inLexique)) {
                    case 1 : {
                      ...
                      switch (select_metamodel_parser_7 (_inLexique)) {
                        case 1 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
                          if (((((var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (302))) == (GGS_uint (true, 0U))) & ((var_cas_higherBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (302))) == (GGS_uint (true, 0U))))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if lower bound is zero, higher bound should be greater than zero") SOURCE_FILE_AT_LINE (304)) ;
                          }else if (((((var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (304))) > (GGS_uint (true, 0U))) & ((var_cas_higherBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (304))) < (var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (304)))))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "higher bound should be greater or equal than lower bound") SOURCE_FILE_AT_LINE (306)) ;
                          }
                          } break ;
                        case 2 : {
                    ...
                    case 2 : {
                      ...
                      if (((var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (313))) == (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                        var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if higher bound is implicit, lower bound should be greater than zero") SOURCE_FILE_AT_LINE (315)) ;
                      }
                      } break ;
                    default :
                      break ;
              ...
              var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (325)) ;
              var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (326)) ;
              GGS_AC_galgasType  var_cas_propertyType ;
  ...
  var_cas_ioEntityMap.modifier_insertKeyAndGetID (_inLexique, var_cas_entityName, var_cas_metamodelClassID, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques SOURCE_FILE_AT_LINE (339)) ;
  GGS_typeEntityToGenerate  var_cas_def ;
  var_cas_def = GGS_C_metamodelEntityToImplement::constructor_new (_inLexique, var_cas_entityName, var_cas_isAbstract, var_cas_listeTousAttributsSemantiques, var_cas_listeAttributsSemantiquesCourants, var_cas_superEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (355)), var_cas_metamodelClassID.reader_uint (_inLexique SOURCE_FILE_AT_LINE (356)) COMMA_HERE) ;
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_221_6_parseForEnumeratingClasses (galgas_scanner & _inLexique,
  ...
  _inLexique._assignFromAttribute_tokenString (var_cas_entityName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  var_cas_ioMetamodelClassSet._addAssign_operation (var_cas_entityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (371))) ;
  switch (select_metamodel_parser_2 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
...
void metamodel_parser::
pr_entity_declaration_metamodel_parser_221_6_parse (galgas_scanner & _inLexique) {
  switch (select_metamodel_parser_1 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
