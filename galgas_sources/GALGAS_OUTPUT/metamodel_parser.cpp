...
pr_parse_metamodel_metamodel_parser_114_23_ (galgas_scanner & _inLexique,
  ...
  GGS_entityToImplementMap::element_type * operand_6956 = var_cas_entityMap.firstObject () ;
  while ((operand_6956 != NULL)) {
    macroValidPointer (operand_6956) ;
    GGS_entityPropertyMap::element_type * operand_7339 = operand_6956->mInfo.mEntityPropertiesMap.firstObject () ;
    while ((operand_7339 != NULL)) {
      macroValidPointer (operand_7339) ;
      switch (operand_7339->mInfo.mKind.enumValue ()) {
      ...
      case GGS_metamodelPropertyKind::enum_singleReferenceProperty:
        {
        GGS_entityPropertyMap  var_cas_7666 ;
        GGS_bool var_cas_7669 ;
        GGS_entityPropertyMap  var_cas_7672 ;
        GGS_lstring  var_cas_7675 ;
        GGS_stringset  var_cas_7678 ;
        GGS_bool var_cas_7681 ;
        GGS_constrainedPropertyList  var_cas_7684 ;
        GGS_constrainedPropertyList  var_cas_7687 ;
        GGS_indexMap  var_cas_7690 ;
        GGS_indexMap  var_cas_7693 ;
        if (var_cas_entityMap._isBuilt ()) {
          var_cas_entityMap (HERE)->method_searchKey (_inLexique, operand_7339->mInfo.mTypeName, var_cas_7666, var_cas_7669, var_cas_7672, var_cas_7675, var_cas_7678, var_cas_7681, var_cas_7684, var_cas_7687, var_cas_7690, var_cas_7693 SOURCE_FILE_AT_LINE (199)) ;
        }
        var_cas_multiReferencedEntities._addAssign_operation (operand_7339->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (200))) ;
        }
        break ;
      case GGS_metamodelPropertyKind::kNotBuilt:
        break ;
      }
      operand_7339 = operand_7339->nextObject () ;
    }
    operand_6956 = operand_6956->nextObject () ;
  }
  if (var_cas_entityMap._isBuilt () &&
...
pr_entity_declaration_metamodel_parser_245_26_ (galgas_scanner & _inLexique,
  ...
  switch (select_metamodel_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_entityPropertyMap  var_cas_9600 ;
      GGS_bool var_cas_9609 ;
      GGS_lstring  var_cas_9640 ;
      GGS_bool var_cas_9671 ;
      GGS_constrainedPropertyList  var_cas_9680 ;
      GGS_constrainedPropertyList  var_cas_9689 ;
      GGS_indexMap  var_cas_9698 ;
      GGS_indexMap  var_cas_9707 ;
      if (var_cas_ioEntityMap._isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_9600, var_cas_9609, var_cas_allPropertyMap, var_cas_9640, var_cas_superEntitySet, var_cas_9671, var_cas_9680, var_cas_9689, var_cas_9698, var_cas_9707 SOURCE_FILE_AT_LINE (275)) ;
      }
