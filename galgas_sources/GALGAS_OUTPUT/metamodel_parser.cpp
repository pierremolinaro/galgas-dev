  ...
  while ((operand_6876 != NULL)) {
    ...
    while ((operand_7109 != NULL)) {
      ...
      if (((((operand_7109->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE))) | ((operand_7109->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (_inLexique COMMA_HERE))))).isBuiltAndTrue ()) {
        ...
        var_cas_multiReferencedEntities._addAssign_operation (operand_7109->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (189))) ;
      }
...
pr_entity_declaration_metamodel_parser_234_26_ (galgas_scanner & _inLexique,
  ...
  switch (select_metamodel_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_entityPropertyMap  var_cas_9285 ;
      GGS_bool var_cas_9294 ;
      GGS_lstring  var_cas_9325 ;
      if (var_cas_ioEntityMap._isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_9285, var_cas_9294, var_cas_allPropertyMap, var_cas_9325 SOURCE_FILE_AT_LINE (262)) ;
      }
      } break ;
    default :
      break ;
        ...
        case 2 : {
          ...
          switch (select_metamodel_parser_4 (_inLexique)) {
            case 1 : {
              ...
              if ((var_cas_ioPrimitiveTypeAttributeNameSet.reader_hasKey (_inLexique, var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (282)) SOURCE_FILE_AT_LINE (282))).isBuiltAndTrue ()) {
                var_cas_propertyTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (283))))) + (GGS_string (true, "' is not an entity name, but a predefined type name"))) SOURCE_FILE_AT_LINE (285)) ;
              }
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
            ...
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_attributeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
              if ((var_cas_ioPrimitiveTypeAttributeNameSet.reader_hasKey (_inLexique, var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (291)) SOURCE_FILE_AT_LINE (291))).isBuiltAndTrue ()) {
