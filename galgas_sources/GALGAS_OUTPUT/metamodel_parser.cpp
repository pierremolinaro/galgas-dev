...
pr_parse_metamodel_metamodel_parser_159_6_ (galgas_scanner & _inLexique,
  ...
  GGS_M_semanticsComponents::element_type * operand_8769 = var_cas_semanticsComponentsMap.firstObject () ;
  while ((operand_8769 != NULL)) {
    macroValidPointer (operand_8769) ;
    var_cas_headerInclusionList._addAssign_operation (operand_8769->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (229))) ;
    operand_8769 = operand_8769->nextObject () ;
  }
  ...
  GGS_lstringlist::element_type * operand_9069 = var_cas_superMetamodelList.firstObject () ;
  while ((operand_9069 != NULL)) {
    macroValidPointer (operand_9069) ;
    var_cas_headerInclusionList._addAssign_operation (operand_9069->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (235))) ;
    ::routine_performMetamodelInclusion (_inLexique,  var_cas_ioMetamodelComponentMap,  operand_9069->mValue,  var_cas_superMetamodels,  var_cas_allEntityMap COMMA_SOURCE_FILE_AT_LINE (236)) ;
    operand_9069 = operand_9069->nextObject () ;
  }
  ...
  ::routine_enterBuiltinTypes (_inLexique,  var_cas_semanticsEntitiesMap COMMA_SOURCE_FILE_AT_LINE (247)) ;
  nt_entity_declaration_list_ (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (249)), var_cas_semanticsEntitiesMap, var_cas_entityMap, var_cas_allEntityMap, var_cas_listeEntitesAengendrer) ;
  GGS_entityToImplementMap::element_type * operand_9743 = var_cas_entityMap.firstObject () ;
  while ((operand_9743 != NULL)) {
    macroValidPointer (operand_9743) ;
    GGS_entityPropertyMap::element_type * operand_9967 = operand_9743->mInfo.mCurrentMetamodelPropertyMap.firstObject () ;
    while ((operand_9967 != NULL)) {
      macroValidPointer (operand_9967) ;
      if (operand_9967->mInfo.mPropertyType._isBuilt (SOURCE_FILE_AT_LINE (261))) {
        cPtr_typeGalgas_singleReferenceEntity * operand_10099 = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (operand_9967->mInfo.mPropertyType.getPtr ()) ;
        if (operand_10099 != NULL) {
          macroValidPointer (operand_10099) ; 
          ...
          if (var_cas_allEntityMap._isBuilt (HERE)) {
            var_cas_allEntityMap (HERE)->method_searchKey (_inLexique, operand_10099->mEntityTypeName, automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (265)) ;
          }
        }else{
          cPtr_typeGalgas_multipleReferenceEntity * operand_10240 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (operand_9967->mInfo.mPropertyType.getPtr ()) ;
          if (operand_10240 != NULL) {
            macroValidPointer (operand_10240) ; 
            ...
            if (var_cas_allEntityMap._isBuilt (HERE)) {
              var_cas_allEntityMap (HERE)->method_searchKey (_inLexique, operand_10240->mEntityTypeName, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (267)) ;
            }
          }else{ // Else part
          }
        }
      }
      operand_9967 = operand_9967->nextObject () ;
    }
    operand_9743 = operand_9743->nextObject () ;
  }
  if ((var_cas_inGenerateMetamodelCode).isBuiltAndTrue ()) {
    if (var_cas_entityMap._isBuilt (HERE) &&
        var_cas_metamodelName._isBuilt (HERE) &&
        var_cas_listeEntitesAengendrer._isBuilt (HERE) &&
        var_cas_rootEntityName._isBuilt (HERE) &&
        var_cas_headerInclusionList._isBuilt (HERE)) {
      ::routine_generate_metamodel (_inLexique,  var_cas_entityMap,  var_cas_metamodelName,  var_cas_listeEntitesAengendrer,  var_cas_rootEntityName,  var_cas_headerInclusionList COMMA_SOURCE_FILE_AT_LINE (274)) ;
    }
  }
  if (((var_cas_ioMetamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (283)) COMMA_SOURCE_FILE_AT_LINE (283)))._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (283))).isBuiltAndTrue ()) {
    var_cas_ioMetamodelComponentMap.modifier_insertKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, var_cas_entityMap, var_cas_superMetamodels COMMA_SOURCE_FILE_AT_LINE (284)) ;
  }
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_list_metamodel_parser_298_6_ (galgas_scanner & _inLexique,
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_11760 = _inLexique.parsingContext () ;
    { bool syntaxRepeat = true ;
      while (syntaxRepeat) {
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_11760) ;
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_298_6_parse (galgas_scanner & _inLexique) {
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_11760 = _inLexique.parsingContext () ;
    { bool syntaxRepeat = true ;
      while (syntaxRepeat) {
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_333_6_ (galgas_scanner & _inLexique,
                                const GGS_string &var_cas_inCurrentMetamodelName,
  ...
  switch (select_metamodel_parser_4 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_ioAllEntityMap._isBuilt (HERE)) {
        var_cas_ioAllEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, automatic_var_16, automatic_var_17, automatic_var_18, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, automatic_var_19, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (367)) ;
      }
      var_cas_superEntityMap.modifier_insertKey (_inLexique, var_cas_superEntity COMMA_SOURCE_FILE_AT_LINE (375)) ;
      } break ;
    default :
      break ;
  }
        ...
        case 2 : {
          ...
          switch (select_metamodel_parser_6 (_inLexique)) {
            case 1 : {
              ...
              if ((var_cas_inMetamodelClassSet.reader_hasKey (_inLexique, var_cas_propertyOrEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (389)) COMMA_SOURCE_FILE_AT_LINE (389))).isBuiltAndTrue ()) {
                ...
                var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (393)) ;
                var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (394)) ;
              }else{
                GGS_AC_semanticsEntity  var_cas_theEntity ;
                if (var_cas_inSemanticsEntitiesMap._isBuilt (HERE)) {
                  var_cas_inSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_propertyOrEntityTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (397)) ;
                }
                { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_theEntity.getPtr ()) ;
                  if (ptrExtraire_ == NULL) {
                    ...
                    if (var_cas_theEntity.getPtr () != NULL) {
                      ...
                      var_cas_propertyOrEntityTypeName.signalExtractError (_inLexique, message1_, message2_ COMMA_SOURCE_FILE_AT_LINE (398)) ;
                    }
                  }else{
                ...
                var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (399)) ;
                var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (400)) ;
              }
            ...
            case 2 : {
                ...
                case 1 : {
                  ...
                  switch (select_metamodel_parser_8 (_inLexique)) {
                    case 1 : {
                      ...
                      switch (select_metamodel_parser_9 (_inLexique)) {
                        case 1 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
                          if ((((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (414)))._operator_isEqual (_inLexique, GGS_uint (true, 0U) SOURCE_FILE_AT_LINE (414)))._operator_and (_inLexique, (var_cas_higherBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (414)))._operator_isEqual (_inLexique, GGS_uint (true, 0U) SOURCE_FILE_AT_LINE (414)) COMMA_SOURCE_FILE_AT_LINE (414))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if lower bound is zero, higher bound should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (416)) ;
                          }else if ((((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)))._operator_strictSup (_inLexique, GGS_uint (true, 0U) SOURCE_FILE_AT_LINE (416)))._operator_and (_inLexique, (var_cas_higherBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)))._operator_strictInf (_inLexique, var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)) SOURCE_FILE_AT_LINE (416)) COMMA_SOURCE_FILE_AT_LINE (416))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "higher bound should be greater or equal than lower bound") COMMA_SOURCE_FILE_AT_LINE (418)) ;
                          }
                          } break ;
                        case 2 : {
                    ...
                    case 2 : {
                      ...
                      if (((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (425)))._operator_isEqual (_inLexique, GGS_uint (true, 0U) SOURCE_FILE_AT_LINE (425))).isBuiltAndTrue ()) {
                        var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if higher bound is implicit, lower bound should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (427)) ;
                      }
                      } break ;
                    default :
                      break ;
              ...
              var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (441)) ;
              var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (442)) ;
              var_cas_listeTousAttributsSemantiques._addAssign_operation (var_cas_propertyType, var_cas_attributeName) ;
              var_cas_listeAttributsSemantiquesCourants._addAssign_operation (var_cas_propertyType, var_cas_attributeName) ;
              } break ;
            default :
  ...
  var_cas_ioEntityMap.modifier_insertKey (_inLexique, var_cas_entityName, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (449)) ;
  var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, var_cas_entityName, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (460)) ;
  GGS_typeEntityToGenerate  var_cas_def ;
  var_cas_def = GGS_C_metamodelEntityToImplement::constructor_new (_inLexique, var_cas_entityName, var_cas_isAbstract, var_cas_listeTousAttributsSemantiques, var_cas_listeAttributsSemantiquesCourants, var_cas_superEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (477)), var_cas_ioEntityID COMMA_HERE) ;
  var_cas_listeEntitesAengendrer._addAssign_operation (var_cas_def) ;
  var_cas_ioEntityID._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (481)) ;
}
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_333_6_parseForEnumeratingClasses (galgas_scanner & _inLexique,
  ...
  _inLexique._assignFromAttribute_tokenString (var_cas_entityName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  var_cas_ioMetamodelClassSet._addAssign_operation (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (494))) ;
  switch (select_metamodel_parser_4 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
...
void metamodel_parser::
pr_entity_declaration_metamodel_parser_333_6_parse (galgas_scanner & _inLexique) {
  switch (select_metamodel_parser_3 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
