...
pr_parse_metamodel_metamodel_parser_159_6_ (galgas_scanner & _inLexique,
  ...
  if (((! (var_cas_ioMetamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (283)) COMMA_SOURCE_FILE_AT_LINE (283))))).isBuiltAndTrue ()) {
                ...
                case 1 : {
                  ...
                  switch (select_metamodel_parser_8 (_inLexique)) {
                    case 1 : {
                      ...
                      switch (select_metamodel_parser_9 (_inLexique)) {
                        case 1 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
                          if (((((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (414))) == (GGS_uint (true, 0U))) & ((var_cas_higherBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (414))) == (GGS_uint (true, 0U))))).isBuiltAndTrue ()) {
                          ...
                          }else if (((((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (416))) > (GGS_uint (true, 0U))) & ((var_cas_higherBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (416))) < (var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)))))).isBuiltAndTrue ()) {
                    ...
                    case 2 : {
                      ...
                      if (((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (425))) == (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
