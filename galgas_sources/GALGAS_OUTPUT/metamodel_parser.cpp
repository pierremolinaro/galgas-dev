...
pr_parse_metamodel_metamodel_parser_112_23_ (galgas_scanner & lexique_var_,
  ...
  GGS_entityToImplementMap::element_type * operand_6610 = var_cas_entityMap.firstObject () ;
  while ((operand_6610 != NULL)) {
    macroValidPointer (operand_6610) ;
    GGS_stringset  var_cas_superEntitySet ;
    var_cas_superEntitySet = GGS_stringset::constructor_empty (HERE) ;
    ::routine_buildSuperEntitySet (lexique_var_,  var_cas_entityMap,  operand_6610->mInfo.mSuperEntityName,  var_cas_superEntitySet) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_singleEntity::constructor_new (operand_6610->mKey, operand_6610->mInfo.mAllPropertiesMap, operand_6610->mInfo.mIsAbstract, operand_6610->mInfo.mEntityPropertiesMap, operand_6610->mInfo.mSuperEntityName, var_cas_superEntitySet COMMA_HERE) ;
    GGS_AC_semanticsEntity  var_cas_e ;
    var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
    var_cas_semanticsEntityMap.methode_insertKey (lexique_var_, operand_6610->mKey, var_cas_e) ;
    operand_6610 = operand_6610->nextObject () ;
  }
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_list_metamodel_parser_206_31_ (galgas_scanner & lexique_var_,
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_206_31_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_0 (lexique_var_)) {
        case 2 : {
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_222_26_ (galgas_scanner & lexique_var_,
  ...
  switch (select_metamodel_parser_2 (lexique_var_)) {
    ...
    case 2 : {
      ...
      GGS_entityPropertyMap  var_cas_8646 ;
      GGS_bool var_cas_8649 ;
      GGS_lstring  var_cas_8668 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_superEntity, var_cas_8646, var_cas_8649, var_cas_allPropertyMap, var_cas_8668) ;
      } break ;
    default :
      break ;
  }
...
void metamodel_parser::
pr_entity_declaration_metamodel_parser_222_26_parse (galgas_scanner & lexique_var_) {
  switch (select_metamodel_parser_1 (lexique_var_)) {
    case 1 : {
      } break ;
    case 2 : {
