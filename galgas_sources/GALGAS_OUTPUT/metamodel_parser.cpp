...
pr_galgas_component_metamodel_parser_65_24_ (galgas_scanner & lexique_var_,
  ...
  if (var_cas_entityMap.isBuilt ()) {
    ::routine_generate_metamodel (lexique_var_,  var_cas_entityMap) ;
  }
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_186_31_ (galgas_scanner & lexique_var_,
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_186_31_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_0 (lexique_var_)) {
        case 2 : {
...
void metamodel_parser::
pr_entity_declaration_metamodel_parser_202_26_ (galgas_scanner & lexique_var_,
  ...
  switch (select_metamodel_parser_2 (lexique_var_)) {
    ...
    case 2 : {
      ...
      GGS_lstring  var_cas_7535 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_superEntity, var_cas_7532, var_cas_7535, var_cas_entityAttributeMap, var_cas_singleReferenceMap, var_cas_multipleReferenceMap, var_cas_m) ;
      } break ;
    default :
      break ;
  }
...
void metamodel_parser::
pr_entity_declaration_metamodel_parser_202_26_parse (galgas_scanner & lexique_var_) {
  switch (select_metamodel_parser_1 (lexique_var_)) {
    case 1 : {
      } break ;
    case 2 : {
