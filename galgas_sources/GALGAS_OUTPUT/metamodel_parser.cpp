...
pr_parse_metamodel_metamodel_parser_114_23_ (galgas_scanner & _inLexique,
  ...
  GGS_stringset  var_cas_5876 ;
  GGS_bool var_cas_5879 ;
  GGS_constrainedPropertyList  var_cas_5882 ;
  GGS_constrainedPropertyList  var_cas_5885 ;
  GGS_indexMap  var_cas_5888 ;
  GGS_indexMap  var_cas_5891 ;
  if (var_cas_entityMap._isBuilt ()) {
    var_cas_entityMap (HERE)->method_searchKey (_inLexique, var_cas_rootEntityName, var_cas_5855, var_cas_isAbstract, var_cas_5870, var_cas_5873, var_cas_5876, var_cas_5879, var_cas_5882, var_cas_5885, var_cas_5888, var_cas_5891 SOURCE_FILE_AT_LINE (149)) ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_6106 = var_cas_entityMap.firstObject () ;
  while ((operand_6106 != NULL)) {
    macroValidPointer (operand_6106) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_singleEntity::constructor_new (_inLexique, operand_6106->mKey, operand_6106->mInfo.mAllPropertiesMap, operand_6106->mInfo.mIsAbstract, operand_6106->mInfo.mEntityPropertiesMap, operand_6106->mInfo.mSuperEntityName, operand_6106->mInfo.mSuperClassSet COMMA_HERE) ;
    GGS_AC_semanticsEntity  var_cas_e ;
    var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
    var_cas_semanticsEntityMap.method_insertKey (_inLexique, operand_6106->mKey, var_cas_e SOURCE_FILE_AT_LINE (176)) ;
    operand_6106 = operand_6106->nextObject () ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_6934 = var_cas_entityMap.firstObject () ;
  while ((operand_6934 != NULL)) {
    macroValidPointer (operand_6934) ;
    GGS_entityPropertyMap::element_type * operand_7295 = operand_6934->mInfo.mEntityPropertiesMap.firstObject () ;
    while ((operand_7295 != NULL)) {
      macroValidPointer (operand_7295) ;
      switch (operand_7295->mInfo.mKind.enumValue ()) {
      ...
      case GGS_metamodelPropertyKind::enum_singleReferenceProperty:
        {
        GGS_entityPropertyMap  var_cas_7616 ;
        GGS_bool var_cas_7619 ;
        GGS_entityPropertyMap  var_cas_7622 ;
        GGS_lstring  var_cas_7625 ;
        GGS_stringset  var_cas_7628 ;
        GGS_bool var_cas_7631 ;
        GGS_constrainedPropertyList  var_cas_7634 ;
        GGS_constrainedPropertyList  var_cas_7637 ;
        GGS_indexMap  var_cas_7640 ;
        GGS_indexMap  var_cas_7643 ;
        if (var_cas_entityMap._isBuilt ()) {
          var_cas_entityMap (HERE)->method_searchKey (_inLexique, operand_7295->mInfo.mTypeName, var_cas_7616, var_cas_7619, var_cas_7622, var_cas_7625, var_cas_7628, var_cas_7631, var_cas_7634, var_cas_7637, var_cas_7640, var_cas_7643 SOURCE_FILE_AT_LINE (199)) ;
        }
        var_cas_multiReferencedEntities._addAssign_operation (operand_7295->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (200))) ;
        }
        break ;
      case GGS_metamodelPropertyKind::kNotBuilt:
        break ;
      }
      operand_7295 = operand_7295->nextObject () ;
    }
    operand_6934 = operand_6934->nextObject () ;
  }
  if (var_cas_entityMap._isBuilt () &&
      var_cas_metamodelName._isBuilt () &&
      var_cas_multiReferencedEntities._isBuilt () &&
      var_cas_rootEntityName._isBuilt ()) {
    ::routine_generate_metamodel (_inLexique,  var_cas_entityMap,  var_cas_metamodelName,  var_cas_multiReferencedEntities,  var_cas_rootEntityName SOURCE_FILE_AT_LINE (206)) ;
  }
  if (((! (var_cas_ioMetamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (212)) SOURCE_FILE_AT_LINE (212))))).isBuiltAndTrue ()) {
    var_cas_ioMetamodelComponentMap.method_insertKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, var_cas_semanticsEntityMap, var_cas_entityMap, var_cas_multiReferencedEntities SOURCE_FILE_AT_LINE (214)) ;
  }
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_list_metamodel_parser_228_31_ (galgas_scanner & _inLexique,
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_228_31_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_0 (_inLexique)) {
        case 2 : {
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_245_26_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioMapAndEntityUniqueMap.method_insertKey (_inLexique, var_cas_entityName SOURCE_FILE_AT_LINE (262)) ;
  ...
  switch (select_metamodel_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_entityPropertyMap  var_cas_9550 ;
      GGS_bool var_cas_9559 ;
      GGS_lstring  var_cas_9590 ;
      GGS_bool var_cas_9621 ;
      GGS_constrainedPropertyList  var_cas_9630 ;
      GGS_constrainedPropertyList  var_cas_9639 ;
      GGS_indexMap  var_cas_9648 ;
      GGS_indexMap  var_cas_9657 ;
      if (var_cas_ioEntityMap._isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_9550, var_cas_9559, var_cas_allPropertyMap, var_cas_9590, var_cas_superEntitySet, var_cas_9621, var_cas_9630, var_cas_9639, var_cas_9648, var_cas_9657 SOURCE_FILE_AT_LINE (275)) ;
      }
      var_cas_superEntitySet._addAssign_operation (var_cas_superEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (287))) ;
      } break ;
    default :
      break ;
  }
        ...
        case 2 : {
          ...
          switch (select_metamodel_parser_4 (_inLexique)) {
            case 1 : {
              ...
              if ((var_cas_ioPrimitiveTypeAttributeNameSet.reader_hasKey (_inLexique, var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (302)) SOURCE_FILE_AT_LINE (302))).isBuiltAndTrue ()) {
                var_cas_propertyTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (303))))) + (GGS_string (true, "' is not an entity name, but a predefined type name"))) SOURCE_FILE_AT_LINE (305)) ;
              }
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
            ...
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_attributeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
              if ((var_cas_ioPrimitiveTypeAttributeNameSet.reader_hasKey (_inLexique, var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (311)) SOURCE_FILE_AT_LINE (311))).isBuiltAndTrue ()) {
          ...
          var_cas_entityPropertyMap.method_insertKey (_inLexique, var_cas_attributeName, var_cas_k, var_cas_propertyTypeName SOURCE_FILE_AT_LINE (319)) ;
          var_cas_allPropertyMap.method_insertKey (_inLexique, var_cas_attributeName, var_cas_k, var_cas_propertyTypeName SOURCE_FILE_AT_LINE (320)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        default :
          syntaxRepeat = false ;
  ...
  var_cas_ioEntityMap.method_insertKey (_inLexique, var_cas_entityName, var_cas_allPropertyMap, var_cas_isAbstract, var_cas_entityPropertyMap, var_cas_superEntity, var_cas_superEntitySet, GGS_bool (true, false), GGS_constrainedPropertyList::constructor_emptyList (_inLexique COMMA_HERE), GGS_constrainedPropertyList::constructor_emptyList (_inLexique COMMA_HERE), GGS_indexMap::constructor_emptyMap (_inLexique COMMA_HERE), GGS_indexMap::constructor_emptyMap (_inLexique COMMA_HERE) SOURCE_FILE_AT_LINE (325)) ;
}

//---------------------------------------------------------------------------*

void metamodel_parser::
pr_entity_declaration_metamodel_parser_245_26_parse (galgas_scanner & _inLexique) {
  switch (select_metamodel_parser_1 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
