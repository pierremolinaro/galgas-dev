...
metamodel_parser::
pr_galgas_component_metamodel_parser_76_6_ (galgas_scanner & _inLexique,
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_76_6_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_76_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap) {
  nt_parse_metamodel_ (_inLexique, var_cas_ioMetamodelComponentMap) ;
}
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_76_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_constraintComponents  &/* var_cas_ioConstraintComponentMap */) {
  nt_parse_metamodel_ (_inLexique, var_cas_ioMetamodelComponentMap) ;
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_76_6_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_constraintComponents  &/* var_cas_ioConstraintComponentMap */) {
  nt_parse_metamodel_ (_inLexique, var_cas_ioMetamodelComponentMap) ;
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_76_6_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  nt_parse_metamodel_parse (_inLexique) ;
}
...
pr_parse_metamodel_metamodel_parser_115_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_entityMap._isBuilt ()) {
    var_cas_entityMap (HERE)->method_searchKey (_inLexique, var_cas_rootEntityName, automatic_var_0, var_cas_isAbstract, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6 SOURCE_FILE_AT_LINE (150)) ;
  }
  if ((var_cas_isAbstract).isBuiltAndTrue ()) {
    var_cas_rootEntityName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the root entity cannot be abstract") SOURCE_FILE_AT_LINE (153)) ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_6188 = var_cas_entityMap.firstObject () ;
  while ((operand_6188 != NULL)) {
    macroValidPointer (operand_6188) ;
    GGS_entityPropertyMap::element_type * operand_6503 = operand_6188->mInfo.mCurrentMetamodelPropertyMap.firstObject () ;
    while ((operand_6503 != NULL)) {
      macroValidPointer (operand_6503) ;
      if (operand_6503->mInfo.mProperty._isBuilt ()) {
        cPtr_metamodelSingleReferenceProperty * operand_6631 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_6503->mInfo.mProperty.getPtr ()) ;
        if (operand_6631 != NULL) {
          macroValidPointer (operand_6631) ; 
          ...
          if (var_cas_entityMap._isBuilt ()) {
            var_cas_entityMap (HERE)->method_searchKey (_inLexique, operand_6631->mReferenceEntityName, automatic_var_7, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14 SOURCE_FILE_AT_LINE (169)) ;
          }
        }else{
          cPtr_metamodelMultipleReferenceProperty * operand_6789 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_6503->mInfo.mProperty.getPtr ()) ;
          if (operand_6789 != NULL) {
            macroValidPointer (operand_6789) ; 
            ...
            if (var_cas_entityMap._isBuilt ()) {
              var_cas_entityMap (HERE)->method_searchKey (_inLexique, operand_6789->mReferenceEntityName, automatic_var_15, automatic_var_16, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20, automatic_var_21, automatic_var_22 SOURCE_FILE_AT_LINE (171)) ;
            }
            var_cas_multiReferencedEntities._addAssign_operation (operand_6789->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (172))) ;
          }else{ // Else part
          }
        }
      }
      operand_6503 = operand_6503->nextObject () ;
    }
    operand_6188 = operand_6188->nextObject () ;
  }
  if (var_cas_entityMap._isBuilt () &&
  ...
  if (((! (var_cas_ioMetamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (185)) SOURCE_FILE_AT_LINE (185))))).isBuiltAndTrue ()) {
    var_cas_ioMetamodelComponentMap.modifier_insertKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, var_cas_entityMap, var_cas_multiReferencedEntities SOURCE_FILE_AT_LINE (186)) ;
  }
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_list_metamodel_parser_200_6_ (galgas_scanner & _inLexique,
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_200_6_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_0 (_inLexique)) {
        case 2 : {
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_217_6_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_mda_5Ftype_5Fname) COMMA_HERE) ;
  var_cas_ioMapAndEntityUniqueMap.modifier_insertKey (_inLexique, var_cas_entityName SOURCE_FILE_AT_LINE (234)) ;
  ...
  switch (select_metamodel_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_ioEntityMap._isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, automatic_var_23, automatic_var_24, automatic_var_25, automatic_var_26, var_cas_superEntitySet, automatic_var_27, automatic_var_28 SOURCE_FILE_AT_LINE (246)) ;
      }
      var_cas_superEntitySet._addAssign_operation (var_cas_superEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (257))) ;
      } break ;
    default :
      break ;
  }
    ...
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_3 (_inLexique)) {
        case 2 : {
          ...
          if (((! (var_cas_ioPrimitiveTypeAttributeNameSet.reader_hasKey (_inLexique, var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (266)) SOURCE_FILE_AT_LINE (266))))).isBuiltAndTrue ()) {
            var_cas_propertyTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (267))))) + (GGS_string (true, "' is not a predefined type name"))) SOURCE_FILE_AT_LINE (269)) ;
          }
          ...
          var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (273)) ;
          var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (274)) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          } break ;
        case 3 : {
          GGS_lstring  var_cas_propertyTypeName ;
          ...
          var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (319)) ;
          var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (320)) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          } break ;
        default :
          syntaxRepeat = false ;
...
void metamodel_parser::
pr_entity_declaration_metamodel_parser_217_6_parse (galgas_scanner & _inLexique) {
  switch (select_metamodel_parser_1 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
