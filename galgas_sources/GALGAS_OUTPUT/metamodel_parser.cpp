...
metamodel_parser::
pr_galgas_component_metamodel_parser_118_4_ (galgas_scanner & _inLexique,
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_118_4_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_118_4_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_treewalkingComponents  &/* var_cas_ioTreewalkingComponentMap */) {
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_118_4_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_treewalkingComponents  &/* var_cas_ioTreewalkingComponentMap */) {
  nt_parse_metamodel_ (_inLexique, var_cas_ioMetamodelComponentMap, GGS_bool (true, false)) ;
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_118_4_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_M_treewalkingComponents  &/* var_cas_ioTreewalkingComponentMap */) {
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_118_4_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  nt_parse_metamodel_parse (_inLexique) ;
}
...
void metamodel_parser::
metamodel_parser::
pr_parse_metamodel_metamodel_parser_159_4_ (galgas_scanner & _inLexique,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
  ...
  GGS_M_semanticsComponents::cEnumerator enumerator_9285 (var_cas_semanticsComponentsMap, true) ;
  const GGS_M_semanticsComponents::cElement * operand_9285 = NULL ;
  while (((operand_9285 = (GGS_M_semanticsComponents::cElement *) enumerator_9285.nextObject ()))) {
    macroValidPointer (operand_9285) ;
    var_cas_headerInclusionList._addAssign_operation (operand_9285->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (249))) ;
  }
  enumerator_9285.reset () ;
  ...
  GGS_lstringlist::cEnumerator enumerator_9589 (var_cas_superMetamodelList, true) ;
  const GGS_lstringlist::cElement * operand_9589 = NULL ;
  while (((operand_9589 = (GGS_lstringlist::cElement *) enumerator_9589.nextObject ()))) {
    macroValidPointer (operand_9589) ;
    var_cas_headerInclusionList._addAssign_operation (operand_9589->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (255))) ;
    ::routine_performMetamodelInclusion (_inLexique,  var_cas_ioMetamodelComponentMap,  operand_9589->mValue,  var_cas_superMetamodels,  var_cas_allEntityMap COMMA_SOURCE_FILE_AT_LINE (255)) ;
  }
  enumerator_9589.reset () ;
  ...
  GGS_entityToImplementMap::cEnumerator enumerator_10176 (var_cas_entityMap, true) ;
  const GGS_entityToImplementMap::cElement * operand_10176 = NULL ;
  while (((operand_10176 = (GGS_entityToImplementMap::cElement *) enumerator_10176.nextObject ()))) {
    macroValidPointer (operand_10176) ;
    GGS_entityPropertyMap::cEnumerator enumerator_10389 (operand_10176->mInfo.mCurrentMetamodelPropertyMap, true) ;
    const GGS_entityPropertyMap::cElement * operand_10389 = NULL ;
    while (((operand_10389 = (GGS_entityPropertyMap::cElement *) enumerator_10389.nextObject ()))) {
      macroValidPointer (operand_10389) ;
      { const GGS_AC_galgasType _var_10851 = operand_10389->mInfo.mPropertyType ; // CAST instruction
        if (_var_10851.getPtr () != NULL) {
          macroValidPointer (_var_10851.getPtr ()) ;
          if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_10851.getPtr ()) != NULL) {
            const GGS_typeGalgas_singleReferenceEntity var_cas_e (_var_10851.getPtr ()) ;
          ...
          }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_10851.getPtr ()) != NULL) {
            const GGS_typeGalgas_multipleReferenceEntity var_cas_e (_var_10851.getPtr ()) ;
    ...
    enumerator_10389.reset () ;
  }
  enumerator_10176.reset () ;
  if ((var_cas_inGenerateMetamodelCode).isBuiltAndTrue ()) {
    if (var_cas_entityMap._isBuilt () &&
      ...
      ::routine_generate_metamodel (_inLexique,  var_cas_entityMap,  var_cas_metamodelName,  var_cas_listeEntitesAengendrer,  var_cas_rootEntityName,  var_cas_headerInclusionList COMMA_SOURCE_FILE_AT_LINE (291)) ;
    }
  }
...
void metamodel_parser::
pr_parse_metamodel_metamodel_parser_159_4_parse (galgas_scanner & _inLexique) {
  switch (select_metamodel_parser_0 (_inLexique)) {
    case 1 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_abstract) COMMA_HERE) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_metamodel) COMMA_HERE) ;
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_list_metamodel_parser_316_4_ (galgas_scanner & _inLexique,
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_12222 = _inLexique.parsingContext () ;
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_12222) ;
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_316_4_parse (galgas_scanner & _inLexique) {
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_12222 = _inLexique.parsingContext () ;
    { bool syntaxRepeat_5 = true ;
      while (syntaxRepeat_5) {
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_351_4_ (galgas_scanner & _inLexique,
                                const GGS_string var_cas_inCurrentMetamodelName,
  ...
  switch (select_metamodel_parser_8 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_ioAllEntityMap._isBuilt ()) {
        var_cas_ioAllEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, automatic_var_16, automatic_var_17, automatic_var_18, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, automatic_var_19, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (391)) ;
      }
      var_cas_superEntityMap.modifier_insertKey (_inLexique, var_cas_superEntity COMMA_SOURCE_FILE_AT_LINE (399)) ;
      } break ;
    default :
      break ;
  }
        ...
        case 2 : {
          ...
          switch (select_metamodel_parser_10 (_inLexique)) {
            case 1 : {
              ...
              if ((var_cas_inMetamodelClassSet.reader_hasKey (_inLexique, var_cas_propertyOrEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (413)) COMMA_SOURCE_FILE_AT_LINE (413))).isBuiltAndTrue ()) {
                ...
                if (var_cas_inSemanticsEntitiesMap._isBuilt ()) {
                  var_cas_inSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_propertyOrEntityTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (423)) ;
                }
                var_cas_propertyType = GGS_typeEntiteType::_castFrom (_inLexique, var_cas_theEntity.getPtr (), true, var_cas_propertyOrEntityTypeName COMMA_SOURCE_FILE_AT_LINE (424)).reader_aDefType (_inLexique COMMA_SOURCE_FILE_AT_LINE (424)) ;
                var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (425)) ;
                var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (426)) ;
              }
            ...
            case 2 : {
                ...
                case 1 : {
                  ...
                  switch (select_metamodel_parser_12 (_inLexique)) {
                    case 1 : {
                      ...
                      switch (select_metamodel_parser_13 (_inLexique)) {
                        case 1 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
                          if ((((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (440)))._operator_isEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_higherBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (440)))._operator_isEqual (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if lower bound is zero, higher bound should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (441)) ;
                          }else if ((((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (442)))._operator_strictSup (GGS_uint (true, 0U)))._operator_and ((var_cas_higherBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (442)))._operator_strictInf (var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (442))))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "higher bound should be greater or equal than lower bound") COMMA_SOURCE_FILE_AT_LINE (443)) ;
                          }
                          } break ;
                        case 2 : {
                    ...
                    case 2 : {
                      ...
                      if (((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (451)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                        var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if higher bound is implicit, lower bound should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (452)) ;
                      }
                      } break ;
                    default :
                      break ;
              ...
              var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (467)) ;
              var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (468)) ;
              var_cas_listeTousAttributsSemantiques._addAssign_operation (var_cas_propertyType, var_cas_attributeName) ;
              var_cas_listeAttributsSemantiquesCourants._addAssign_operation (var_cas_propertyType, var_cas_attributeName) ;
              } break ;
            default :
  ...
  GGS_lstringlist::cEnumerator enumerator_16829 (var_cas_entityNameList, true) ;
  const GGS_lstringlist::cElement * operand_16829 = NULL ;
  while (((operand_16829 = (GGS_lstringlist::cElement *) enumerator_16829.nextObject ()))) {
    macroValidPointer (operand_16829) ;
    var_cas_ioEntityMap.modifier_insertKey (_inLexique, operand_16829->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (476)) ;
    var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, operand_16829->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (487)) ;
    GGS_typeEntityToGenerate  var_cas_def ;
    var_cas_def = GGS_C_metamodelEntityToImplement::constructor_new (_inLexique, operand_16829->mValue, var_cas_isAbstract, var_cas_listeTousAttributsSemantiques, var_cas_listeAttributsSemantiquesCourants, var_cas_superEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (504)), var_cas_ioEntityID COMMA_HERE) ;
    var_cas_listeEntitesAengendrer._addAssign_operation (var_cas_def) ;
    var_cas_ioEntityID._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (508)) ;
  }
  enumerator_16829.reset () ;
}
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_351_4_parseForEnumeratingClasses (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_7 = true ;
    while (syntaxRepeat_7) {
        ...
        _inLexique._assignFromAttribute_tokenString (var_cas_entityName) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
        var_cas_ioMetamodelClassSet._addAssign_operation (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (523))) ;
      switch (select_repeat_metamodel_parser_7 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
          } break ;
...
void metamodel_parser::
pr_entity_declaration_metamodel_parser_351_4_parse (galgas_scanner & _inLexique) {
  switch (select_metamodel_parser_6 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
