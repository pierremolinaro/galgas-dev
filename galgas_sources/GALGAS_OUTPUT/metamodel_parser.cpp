...
pr_entity_declaration_metamodel_parser_351_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_lstringlist _var_16829 = var_cas_entityNameList ;
  const GGS_lstringlist::element_type * operand_16829 = _var_16829.firstObject () ;
  while ((operand_16829 != NULL)) {
    ...
    operand_16829 = operand_16829->nextObject () ;
  }
}
