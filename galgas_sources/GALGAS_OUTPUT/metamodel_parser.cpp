...
pr_parse_metamodel_metamodel_parser_169_4_ (galgas_scanner & _inLexique,
  ...
  GGS_lstringlist::cEnumerator enumerator_10108 (var_cas_superMetamodelList, true) ;
  const GGS_lstringlist::cElement * operand_10108 = NULL ;
  while (((operand_10108 = (GGS_lstringlist::cElement *) enumerator_10108.nextObject ()))) {
    macroValidPointer (operand_10108) ;
    var_cas_headerInclusionList._addAssign_operation (operand_10108->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (269))) ;
    ::routine_performMetamodelInclusion (_inLexique,  var_cas_ioMetamodelComponentMap,  operand_10108->mValue,  var_cas_superMetamodels,  var_cas_allEntityMap COMMA_SOURCE_FILE_AT_LINE (269)) ;
  }
  enumerator_10108.reset () ;
  ...
  GGS_entityToImplementMap::cEnumerator enumerator_10696 (var_cas_entityMap, true) ;
  const GGS_entityToImplementMap::cElement * operand_10696 = NULL ;
  while (((operand_10696 = (GGS_entityToImplementMap::cElement *) enumerator_10696.nextObject ()))) {
    macroValidPointer (operand_10696) ;
    GGS_entityPropertyMap::cEnumerator enumerator_10910 (operand_10696->mInfo.mCurrentMetamodelPropertyMap, true) ;
    const GGS_entityPropertyMap::cElement * operand_10910 = NULL ;
    while (((operand_10910 = (GGS_entityPropertyMap::cElement *) enumerator_10910.nextObject ()))) {
      macroValidPointer (operand_10910) ;
      { const GGS_AC_galgasType _var_11373 = operand_10910->mInfo.mPropertyType ; // CAST instruction
        if (_var_11373.getPtr () != NULL) {
          macroValidPointer (_var_11373.getPtr ()) ;
          if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_11373.getPtr ()) != NULL) {
            const GGS_typeGalgas_singleReferenceEntity var_cas_e (_var_11373.getPtr ()) ;
            ...
            const GGS_entityToImplementMap  _temp_11167 = var_cas_allEntityMap ;
            if (_temp_11167._isBuilt ()) {
              _temp_11167 (HERE)->method_searchKey (_inLexique, var_cas_e.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (297)), automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (297)) ;
            }
          }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_11373.getPtr ()) != NULL) {
            const GGS_typeGalgas_multipleReferenceEntity var_cas_e (_var_11373.getPtr ()) ;
            ...
            const GGS_entityToImplementMap  _temp_11324 = var_cas_allEntityMap ;
            if (_temp_11324._isBuilt ()) {
              _temp_11324 (HERE)->method_searchKey (_inLexique, var_cas_e.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (299)), automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (299)) ;
            }
          }else{
          }
        }
    ...
    enumerator_10910.reset () ;
  }
  enumerator_10696.reset () ;
...
pr_entity_declaration_list_metamodel_parser_330_4_ (galgas_scanner & _inLexique,
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_12744 = _inLexique.parsingContext () ;
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_12744) ;
...
pr_entity_declaration_metamodel_parser_365_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_metamodel_parser_8 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_entityToImplementMap  _temp_14052 = var_cas_ioAllEntityMap ;
      if (_temp_14052._isBuilt ()) {
        _temp_14052 (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, automatic_var_16, automatic_var_17, automatic_var_18, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, automatic_var_19, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (405)) ;
      }
          ...
          switch (select_metamodel_parser_10 (_inLexique)) {
            case 1 : {
              ...
              if ((var_cas_inMetamodelClassSet.reader_hasKey (_inLexique, var_cas_propertyOrEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (427)) COMMA_SOURCE_FILE_AT_LINE (427))).isBuiltAndTrue ()) {
                ...
                const GGS_M_semanticsEntitiesForUse  _temp_15187 = var_cas_inSemanticsEntitiesMap ;
                if (_temp_15187._isBuilt ()) {
                  _temp_15187 (HERE)->method_searchKey (_inLexique, var_cas_propertyOrEntityTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (437)) ;
                }
  ...
  GGS_lstringlist::cEnumerator enumerator_17351 (var_cas_entityNameList, true) ;
  const GGS_lstringlist::cElement * operand_17351 = NULL ;
  while (((operand_17351 = (GGS_lstringlist::cElement *) enumerator_17351.nextObject ()))) {
    macroValidPointer (operand_17351) ;
    var_cas_ioEntityMap.modifier_insertKey (_inLexique, operand_17351->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (490)) ;
    var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, operand_17351->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (501)) ;
    GGS_typeEntityToGenerate  var_cas_def ;
    var_cas_def = GGS_C_metamodelEntityToImplement::constructor_new (_inLexique, operand_17351->mValue, var_cas_isAbstract, var_cas_listeTousAttributsSemantiques, var_cas_listeAttributsSemantiquesCourants, var_cas_superEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (518)), var_cas_ioEntityID COMMA_HERE) ;
