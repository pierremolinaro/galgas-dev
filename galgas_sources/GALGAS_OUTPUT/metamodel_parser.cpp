...
metamodel_parser::
pr_galgas_component_metamodel_parser_75_6_ (galgas_scanner & _inLexique,
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_75_6_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_75_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap) {
  nt_parse_metamodel_ (_inLexique, var_cas_ioMetamodelComponentMap) ;
}
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_75_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_constraintComponents  &/* var_cas_ioConstraintComponentMap */) {
  nt_parse_metamodel_ (_inLexique, var_cas_ioMetamodelComponentMap) ;
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_75_6_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap,
                                GGS_M_constraintComponents  &/* var_cas_ioConstraintComponentMap */) {
  nt_parse_metamodel_ (_inLexique, var_cas_ioMetamodelComponentMap) ;
...
void metamodel_parser::
metamodel_parser::
pr_galgas_component_metamodel_parser_75_6_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  nt_parse_metamodel_parse (_inLexique) ;
}
...
void metamodel_parser::
metamodel_parser::
pr_parse_metamodel_metamodel_parser_114_6_ (galgas_scanner & _inLexique,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap) {
  ...
  if (var_cas_entityMap._isBuilt ()) {
    var_cas_entityMap (HERE)->method_searchKey (_inLexique, var_cas_rootEntityName, automatic_var_0, var_cas_isAbstract, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6 SOURCE_FILE_AT_LINE (149)) ;
  }
    ...
    while ((operand_6397 != NULL)) {
      ...
      if (operand_6397->mInfo.mProperty._isBuilt ()) {
        ...
        if (operand_6525 != NULL) {
          ...
          if (var_cas_entityMap._isBuilt ()) {
            var_cas_entityMap (HERE)->method_searchKey (_inLexique, operand_6525->mReferenceEntityName, automatic_var_7, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14 SOURCE_FILE_AT_LINE (168)) ;
          }
        }else{
          ...
          if (operand_6683 != NULL) {
            ...
            if (var_cas_entityMap._isBuilt ()) {
              var_cas_entityMap (HERE)->method_searchKey (_inLexique, operand_6683->mReferenceEntityName, automatic_var_15, automatic_var_16, automatic_var_17, automatic_var_18, automatic_var_19, automatic_var_20, automatic_var_21, automatic_var_22 SOURCE_FILE_AT_LINE (170)) ;
            }
  ...
  if (var_cas_entityMap._isBuilt () &&
    ...
    ::routine_generate_metamodel (_inLexique,  var_cas_entityMap,  var_cas_metamodelName,  var_cas_multiReferencedEntities,  var_cas_rootEntityName SOURCE_FILE_AT_LINE (177)) ;
  }
  if (((! (var_cas_ioMetamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (184)) SOURCE_FILE_AT_LINE (184))))).isBuiltAndTrue ()) {
    var_cas_ioMetamodelComponentMap.modifier_insertKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, var_cas_entityMap, var_cas_multiReferencedEntities SOURCE_FILE_AT_LINE (185)) ;
  }
...
void metamodel_parser::
pr_parse_metamodel_metamodel_parser_114_6_parse (galgas_scanner & _inLexique) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_metamodel) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_root) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_mda_5Ftype_5Fname) COMMA_HERE) ;
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_list_metamodel_parser_199_6_ (galgas_scanner & _inLexique,
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_199_6_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_0 (_inLexique)) {
        case 2 : {
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_216_6_ (galgas_scanner & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_mda_5Ftype_5Fname) COMMA_HERE) ;
  var_cas_ioMapAndEntityUniqueMap.modifier_insertKey (_inLexique, var_cas_entityName SOURCE_FILE_AT_LINE (233)) ;
  ...
  switch (select_metamodel_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_ioEntityMap._isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, automatic_var_23, automatic_var_24, automatic_var_25, automatic_var_26, var_cas_superEntitySet, automatic_var_27, automatic_var_28 SOURCE_FILE_AT_LINE (245)) ;
      }
    ...
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_3 (_inLexique)) {
        ...
        case 3 : {
          ...
          var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (318)) ;
          var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (319)) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          } break ;
        default :
          syntaxRepeat = false ;
