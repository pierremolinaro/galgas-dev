...
pr_parse_metamodel_metamodel_parser_114_23_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_entityMap._isBuilt ()) {
    var_cas_entityMap (HERE)->method_searchKey (_inLexique, var_cas_rootEntityName, var_cas_5855, var_cas_isAbstract, var_cas_5870, var_cas_5873, var_cas_5876, var_cas_5879, var_cas_5882, var_cas_5885 SOURCE_FILE_AT_LINE (149)) ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_6100 = var_cas_entityMap.firstObject () ;
  while ((operand_6100 != NULL)) {
    macroValidPointer (operand_6100) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_singleEntity::constructor_new (_inLexique, operand_6100->mKey, operand_6100->mInfo.mAllPropertiesMap, operand_6100->mInfo.mIsAbstract, operand_6100->mInfo.mEntityPropertiesMap, operand_6100->mInfo.mSuperEntityName, operand_6100->mInfo.mSuperClassSet COMMA_HERE) ;
    GGS_AC_semanticsEntity  var_cas_e ;
    var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
    var_cas_semanticsEntityMap.method_insertKey (_inLexique, operand_6100->mKey, var_cas_e SOURCE_FILE_AT_LINE (174)) ;
    operand_6100 = operand_6100->nextObject () ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_6900 = var_cas_entityMap.firstObject () ;
  while ((operand_6900 != NULL)) {
    macroValidPointer (operand_6900) ;
    GGS_entityPropertyMap::element_type * operand_7233 = operand_6900->mInfo.mEntityPropertiesMap.firstObject () ;
    while ((operand_7233 != NULL)) {
      macroValidPointer (operand_7233) ;
      switch (operand_7233->mInfo.mKind.enumValue ()) {
      ...
      case GGS_metamodelPropertyKind::enum_singleReferenceProperty:
        ...
        GGS_bool var_cas_7544 ;
        GGS_entityPropertyMap  var_cas_7547 ;
        GGS_lstring  var_cas_7550 ;
        GGS_stringset  var_cas_7553 ;
        GGS_bool var_cas_7556 ;
        GGS_constrainedPropertyList  var_cas_7559 ;
        GGS_constrainedPropertyList  var_cas_7562 ;
        if (var_cas_entityMap._isBuilt ()) {
          var_cas_entityMap (HERE)->method_searchKey (_inLexique, operand_7233->mInfo.mTypeName, var_cas_7541, var_cas_7544, var_cas_7547, var_cas_7550, var_cas_7553, var_cas_7556, var_cas_7559, var_cas_7562 SOURCE_FILE_AT_LINE (195)) ;
        }
        var_cas_multiReferencedEntities._addAssign_operation (operand_7233->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (196))) ;
        }
        break ;
      case GGS_metamodelPropertyKind::kNotBuilt:
        break ;
      }
      operand_7233 = operand_7233->nextObject () ;
    }
    operand_6900 = operand_6900->nextObject () ;
  }
  if (var_cas_entityMap._isBuilt () &&
      var_cas_metamodelName._isBuilt () &&
      var_cas_multiReferencedEntities._isBuilt () &&
      var_cas_rootEntityName._isBuilt ()) {
    ::routine_generate_metamodel (_inLexique,  var_cas_entityMap,  var_cas_metamodelName,  var_cas_multiReferencedEntities,  var_cas_rootEntityName SOURCE_FILE_AT_LINE (202)) ;
  }
  if (((! (var_cas_ioMetamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (208)) SOURCE_FILE_AT_LINE (208))))).isBuiltAndTrue ()) {
    var_cas_ioMetamodelComponentMap.method_insertKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, var_cas_semanticsEntityMap, var_cas_entityMap, var_cas_multiReferencedEntities SOURCE_FILE_AT_LINE (210)) ;
  }
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_list_metamodel_parser_224_31_ (galgas_scanner & _inLexique,
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_224_31_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_0 (_inLexique)) {
        case 2 : {
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_241_26_ (galgas_scanner & _inLexique,
  ...
  var_cas_ioMapAndEntityUniqueMap.method_insertKey (_inLexique, var_cas_entityName SOURCE_FILE_AT_LINE (258)) ;
  ...
  switch (select_metamodel_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_entityPropertyMap  var_cas_9469 ;
      GGS_bool var_cas_9478 ;
      GGS_lstring  var_cas_9509 ;
      GGS_bool var_cas_9540 ;
      GGS_constrainedPropertyList  var_cas_9549 ;
      GGS_constrainedPropertyList  var_cas_9558 ;
      if (var_cas_ioEntityMap._isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_9469, var_cas_9478, var_cas_allPropertyMap, var_cas_9509, var_cas_superEntitySet, var_cas_9540, var_cas_9549, var_cas_9558 SOURCE_FILE_AT_LINE (271)) ;
      }
      var_cas_superEntitySet._addAssign_operation (var_cas_superEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (281))) ;
      } break ;
    default :
      break ;
  }
        ...
        case 2 : {
          ...
          switch (select_metamodel_parser_4 (_inLexique)) {
            case 1 : {
              ...
              if ((var_cas_ioPrimitiveTypeAttributeNameSet.reader_hasKey (_inLexique, var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (296)) SOURCE_FILE_AT_LINE (296))).isBuiltAndTrue ()) {
                var_cas_propertyTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (297))))) + (GGS_string (true, "' is not an entity name, but a predefined type name"))) SOURCE_FILE_AT_LINE (299)) ;
              }
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
            ...
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_attributeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
              if ((var_cas_ioPrimitiveTypeAttributeNameSet.reader_hasKey (_inLexique, var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (305)) SOURCE_FILE_AT_LINE (305))).isBuiltAndTrue ()) {
          ...
          var_cas_entityPropertyMap.method_insertKey (_inLexique, var_cas_attributeName, var_cas_k, var_cas_propertyTypeName SOURCE_FILE_AT_LINE (313)) ;
          var_cas_allPropertyMap.method_insertKey (_inLexique, var_cas_attributeName, var_cas_k, var_cas_propertyTypeName SOURCE_FILE_AT_LINE (314)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        default :
          syntaxRepeat = false ;
