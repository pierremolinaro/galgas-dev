...
pr_parse_metamodel_metamodel_parser_111_23_ (galgas_scanner & lexique_var_,
  ...
  GGS_entityToImplementMap::element_type * operand_5610 = var_cas_entityMap.firstObject () ;
  while ((operand_5610 != NULL)) {
    macroValidPointer (operand_5610) ;
    GGS_entityPropertyMap::element_type * operand_5833 = operand_5610->mInfo.mEntityPropertiesMap.firstObject () ;
    while ((operand_5833 != NULL)) {
      macroValidPointer (operand_5833) ;
      if (((operand_5833->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE))).isBuiltAndTrue ()) {
        GGS_entityPropertyMap  var_cas_6010 ;
        GGS_bool var_cas_6013 ;
        GGS_entityPropertyMap  var_cas_6016 ;
        GGS_lstring  var_cas_6019 ;
        GGS_mapPropertyMap  var_cas_6022 ;
        var_cas_entityMap.methode_searchKey (lexique_var_, operand_5833->mInfo.mTypeName, var_cas_6010, var_cas_6013, var_cas_6016, var_cas_6019, var_cas_6022) ;
      }else if (((operand_5833->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (HERE))).isBuiltAndTrue ()) {
        GGS_entityPropertyMap  var_cas_6147 ;
        GGS_bool var_cas_6150 ;
        GGS_entityPropertyMap  var_cas_6153 ;
        GGS_lstring  var_cas_6156 ;
        GGS_mapPropertyMap  var_cas_6159 ;
        var_cas_entityMap.methode_searchKey (lexique_var_, operand_5833->mInfo.mTypeName, var_cas_6147, var_cas_6150, var_cas_6153, var_cas_6156, var_cas_6159) ;
        var_cas_multiReferencedEntities.addAssign_operation (operand_5833->mInfo.mTypeName.reader_value ()) ;
      }
      operand_5833 = operand_5833->nextObject () ;
    }
    operand_5610 = operand_5610->nextObject () ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_6494 = var_cas_entityMap.firstObject () ;
  while ((operand_6494 != NULL)) {
    ...
    ::routine_buildSuperEntitySet (lexique_var_,  var_cas_entityMap,  operand_6494->mInfo.mSuperEntityName,  var_cas_superEntitySet) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_singleEntity::constructor_new (operand_6494->mKey, operand_6494->mInfo.mAllPropertiesMap, operand_6494->mInfo.mIsAbstract, operand_6494->mInfo.mEntityPropertiesMap, operand_6494->mInfo.mSuperEntityName, var_cas_superEntitySet COMMA_HERE) ;
    GGS_AC_semanticsEntity  var_cas_e ;
    var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
    var_cas_semanticsEntityMap.methode_insertKey (lexique_var_, operand_6494->mKey, var_cas_e) ;
    operand_6494 = operand_6494->nextObject () ;
  }
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_list_metamodel_parser_207_31_ (galgas_scanner & lexique_var_,
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_207_31_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_0 (lexique_var_)) {
        case 2 : {
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_223_26_ (galgas_scanner & lexique_var_,
  ...
  switch (select_metamodel_parser_2 (lexique_var_)) {
    ...
    case 2 : {
      ...
      GGS_entityPropertyMap  var_cas_8555 ;
      GGS_bool var_cas_8558 ;
      GGS_lstring  var_cas_8577 ;
      GGS_mapPropertyMap  var_cas_8580 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_superEntity, var_cas_8555, var_cas_8558, var_cas_allPropertyMap, var_cas_8577, var_cas_8580) ;
      } break ;
    default :
      break ;
  }
        ...
        case 3 : {
          ...
          { bool syntaxRepeat = true ;
            while (syntaxRepeat) {
                ...
                var_cas_listOfPropertyPathes.addAssign_operation (var_cas_path) ;
...
void metamodel_parser::
pr_entity_declaration_metamodel_parser_223_26_parse (galgas_scanner & lexique_var_) {
  switch (select_metamodel_parser_1 (lexique_var_)) {
    case 1 : {
      } break ;
    case 2 : {
...
void metamodel_parser::
metamodel_parser::
pr_property_path_metamodel_parser_335_21_ (galgas_scanner & lexique_var_,
...
void metamodel_parser::
pr_property_path_metamodel_parser_335_21_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
      switch (select_repeat_metamodel_parser_6 (lexique_var_)) {
