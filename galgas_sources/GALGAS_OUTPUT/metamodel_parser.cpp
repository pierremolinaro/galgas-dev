...
pr_parse_metamodel_metamodel_parser_159_6_ (galgas_scanner & _inLexique,
  ...
  GGS_M_semanticsComponents::element_type * operand_8774 = var_cas_semanticsComponentsMap.firstObject () ;
  while ((operand_8774 != NULL)) {
    macroValidPointer (operand_8774) ;
    var_cas_headerInclusionList._addAssign_operation (operand_8774->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (229))) ;
    operand_8774 = operand_8774->nextObject () ;
  }
  ...
  GGS_lstringlist::element_type * operand_9074 = var_cas_superMetamodelList.firstObject () ;
  while ((operand_9074 != NULL)) {
    macroValidPointer (operand_9074) ;
    var_cas_headerInclusionList._addAssign_operation (operand_9074->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (235))) ;
    ::routine_performMetamodelInclusion (_inLexique,  var_cas_ioMetamodelComponentMap,  operand_9074->mValue,  var_cas_superMetamodels,  var_cas_allEntityMap COMMA_SOURCE_FILE_AT_LINE (236)) ;
    operand_9074 = operand_9074->nextObject () ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_9748 = var_cas_entityMap.firstObject () ;
  while ((operand_9748 != NULL)) {
    macroValidPointer (operand_9748) ;
    GGS_entityPropertyMap::element_type * operand_9972 = operand_9748->mInfo.mCurrentMetamodelPropertyMap.firstObject () ;
    while ((operand_9972 != NULL)) {
      macroValidPointer (operand_9972) ;
      if (operand_9972->mInfo.mPropertyType._isBuilt ()) {
        cPtr_typeGalgas_singleReferenceEntity * operand_10104 = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (operand_9972->mInfo.mPropertyType.getPtr ()) ;
        if (operand_10104 != NULL) {
          macroValidPointer (operand_10104) ; 
          ...
          if (var_cas_allEntityMap._isBuilt ()) {
            var_cas_allEntityMap (HERE)->method_searchKey (_inLexique, operand_10104->mEntityTypeName, automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (265)) ;
          }
        }else{
          cPtr_typeGalgas_multipleReferenceEntity * operand_10245 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (operand_9972->mInfo.mPropertyType.getPtr ()) ;
          if (operand_10245 != NULL) {
            macroValidPointer (operand_10245) ; 
            ...
            if (var_cas_allEntityMap._isBuilt ()) {
              var_cas_allEntityMap (HERE)->method_searchKey (_inLexique, operand_10245->mEntityTypeName, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (267)) ;
            }
          }else{ // Else part
          }
        }
      }
      operand_9972 = operand_9972->nextObject () ;
    }
    operand_9748 = operand_9748->nextObject () ;
  }
  ...
  if (((var_cas_ioMetamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (283)) COMMA_SOURCE_FILE_AT_LINE (283)))._operator_not ()).isBuiltAndTrue ()) {
...
pr_entity_declaration_list_metamodel_parser_298_6_ (galgas_scanner & _inLexique,
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_11765 = _inLexique.parsingContext () ;
    { bool syntaxRepeat = true ;
      while (syntaxRepeat) {
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_11765) ;
                ...
                case 1 : {
                  ...
                  switch (select_metamodel_parser_8 (_inLexique)) {
                    case 1 : {
                      ...
                      switch (select_metamodel_parser_9 (_inLexique)) {
                        case 1 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
                          if ((((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (414)))._operator_isEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_higherBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (414)))._operator_isEqual (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
                          ...
                          }else if ((((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)))._operator_strictSup (GGS_uint (true, 0U)))._operator_and ((var_cas_higherBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (416)))._operator_strictInf (var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (416))))).isBuiltAndTrue ()) {
                    ...
                    case 2 : {
                      ...
                      if (((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (425)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
