...
void metamodel_parser::
pr_galgas_component_metamodel_parser_75_24_importMetamodels (galgas_scanner & lexique_var_,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap) {
  nt_parse_metamodel_ (lexique_var_, var_cas_ioMetamodelComponentMap) ;
}
...
pr_parse_metamodel_metamodel_parser_112_23_ (galgas_scanner & lexique_var_,
  ...
  GGS_entityPropertyMap  var_cas_5351 ;
  GGS_entityPropertyMap  var_cas_5366 ;
  GGS_lstring  var_cas_5369 ;
  var_cas_entityMap.methode_searchKey (lexique_var_, var_cas_rootEntityName, var_cas_5351, var_cas_isAbstract, var_cas_5366, var_cas_5369) ;
  ...
  GGS_entityToImplementMap::element_type * operand_5585 = var_cas_entityMap.firstObject () ;
  while ((operand_5585 != NULL)) {
    macroValidPointer (operand_5585) ;
    GGS_entityPropertyMap::element_type * operand_5783 = operand_5585->mInfo.mEntityPropertiesMap.firstObject () ;
    while ((operand_5783 != NULL)) {
      macroValidPointer (operand_5783) ;
      if (((operand_5783->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE))).isBuiltAndTrue ()) {
        GGS_entityPropertyMap  var_cas_5960 ;
        GGS_bool var_cas_5963 ;
        GGS_entityPropertyMap  var_cas_5966 ;
        GGS_lstring  var_cas_5969 ;
        var_cas_entityMap.methode_searchKey (lexique_var_, operand_5783->mInfo.mTypeName, var_cas_5960, var_cas_5963, var_cas_5966, var_cas_5969) ;
      }else if (((operand_5783->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (HERE))).isBuiltAndTrue ()) {
        GGS_entityPropertyMap  var_cas_6094 ;
        GGS_bool var_cas_6097 ;
        GGS_entityPropertyMap  var_cas_6100 ;
        GGS_lstring  var_cas_6103 ;
        var_cas_entityMap.methode_searchKey (lexique_var_, operand_5783->mInfo.mTypeName, var_cas_6094, var_cas_6097, var_cas_6100, var_cas_6103) ;
        var_cas_multiReferencedEntities.addAssign_operation (operand_5783->mInfo.mTypeName.reader_value ()) ;
      }
      operand_5783 = operand_5783->nextObject () ;
    }
    operand_5585 = operand_5585->nextObject () ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_6418 = var_cas_entityMap.firstObject () ;
  while ((operand_6418 != NULL)) {
    macroValidPointer (operand_6418) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_entity::constructor_new (operand_6418->mKey, operand_6418->mInfo.mAllPropertiesMap, operand_6418->mInfo.mIsAbstract, operand_6418->mInfo.mEntityPropertiesMap, operand_6418->mInfo.mSuperEntityName COMMA_HERE) ;
    GGS_AC_semanticsEntity  var_cas_e ;
    var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
    var_cas_semanticsEntityMap.methode_insertKey (lexique_var_, operand_6418->mKey, var_cas_e) ;
    operand_6418 = operand_6418->nextObject () ;
  }
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_200_31_ (galgas_scanner & lexique_var_,
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_200_31_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_0 (lexique_var_)) {
        case 2 : {
...
void metamodel_parser::
pr_entity_declaration_metamodel_parser_216_26_ (galgas_scanner & lexique_var_,
  ...
  switch (select_metamodel_parser_2 (lexique_var_)) {
    ...
    case 2 : {
      ...
      GGS_entityPropertyMap  var_cas_8222 ;
      GGS_bool var_cas_8225 ;
      GGS_lstring  var_cas_8244 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_superEntity, var_cas_8222, var_cas_8225, var_cas_allPropertyMap, var_cas_8244) ;
      } break ;
    default :
      break ;
  }
...
void metamodel_parser::
pr_entity_declaration_metamodel_parser_216_26_parse (galgas_scanner & lexique_var_) {
  switch (select_metamodel_parser_1 (lexique_var_)) {
    case 1 : {
      } break ;
    case 2 : {
