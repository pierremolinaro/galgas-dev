...
pr_parse_metamodel_metamodel_parser_159_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_M_semanticsComponents _var_9285 = var_cas_semanticsComponentsMap ;
  const GGS_M_semanticsComponents::element_type * operand_9285 = _var_9285.firstObject () ;
  while ((operand_9285 != NULL)) {
    ...
    operand_9285 = operand_9285->nextObject () ;
  }
  ...
  const GGS_lstringlist _var_9589 = var_cas_superMetamodelList ;
  const GGS_lstringlist::element_type * operand_9589 = _var_9589.firstObject () ;
  ...
  const GGS_entityToImplementMap _var_10176 = var_cas_entityMap ;
  const GGS_entityToImplementMap::element_type * operand_10176 = _var_10176.firstObject () ;
  while ((operand_10176 != NULL)) {
    macroValidPointer (operand_10176) ;
    const GGS_entityPropertyMap _var_10389 = operand_10176->mInfo.mCurrentMetamodelPropertyMap ;
    const GGS_entityPropertyMap::element_type * operand_10389 = _var_10389.firstObject () ;
    while ((operand_10389 != NULL)) {
      ...
      operand_10389 = operand_10389->nextObject () ;
    }
    operand_10176 = operand_10176->nextObject () ;
  }
...
pr_entity_declaration_metamodel_parser_351_4_ (galgas_scanner & _inLexique,
        ...
        case 2 : {
          ...
          switch (select_metamodel_parser_10 (_inLexique)) {
            ...
            case 2 : {
                ...
                case 1 : {
                  ...
                  switch (select_metamodel_parser_12 (_inLexique)) {
                    case 1 : {
                      ...
                      switch (select_metamodel_parser_13 (_inLexique)) {
                        case 1 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
                          if ((((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (441)))._operator_isEqual (GGS_uint (true, 0U)))._operator_and ((var_cas_higherBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (441)))._operator_isEqual (GGS_uint (true, 0U)))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if lower bound is zero, higher bound should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (442)) ;
                          }else if ((((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (443)))._operator_strictSup (GGS_uint (true, 0U)))._operator_and ((var_cas_higherBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (443)))._operator_strictInf (var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (443))))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "higher bound should be greater or equal than lower bound") COMMA_SOURCE_FILE_AT_LINE (444)) ;
                          }
                          } break ;
                        case 2 : {
                    ...
                    case 2 : {
                      ...
                      if (((var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (452)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                        var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if higher bound is implicit, lower bound should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (453)) ;
                      }
                      } break ;
                    default :
                      break ;
              ...
              var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (468)) ;
              var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_propertyType COMMA_SOURCE_FILE_AT_LINE (469)) ;
              var_cas_listeTousAttributsSemantiques._addAssign_operation (var_cas_propertyType, var_cas_attributeName) ;
              var_cas_listeAttributsSemantiquesCourants._addAssign_operation (var_cas_propertyType, var_cas_attributeName) ;
              } break ;
            default :
  ...
  const GGS_lstringlist _var_16945 = var_cas_entityNameList ;
  const GGS_lstringlist::element_type * operand_16945 = _var_16945.firstObject () ;
  while ((operand_16945 != NULL)) {
    macroValidPointer (operand_16945) ;
    var_cas_ioEntityMap.modifier_insertKey (_inLexique, operand_16945->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (477)) ;
    var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, operand_16945->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (488)) ;
    GGS_typeEntityToGenerate  var_cas_def ;
    var_cas_def = GGS_C_metamodelEntityToImplement::constructor_new (_inLexique, operand_16945->mValue, var_cas_isAbstract, var_cas_listeTousAttributsSemantiques, var_cas_listeAttributsSemantiquesCourants, var_cas_superEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (505)), var_cas_ioEntityID COMMA_HERE) ;
    var_cas_listeEntitesAengendrer._addAssign_operation (var_cas_def) ;
    var_cas_ioEntityID._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (509)) ;
    operand_16945 = operand_16945->nextObject () ;
  }
}
...
pr_entity_declaration_metamodel_parser_351_4_parseForEnumeratingClasses (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat_7 = true ;
    while (syntaxRepeat_7) {
        ...
        _inLexique._assignFromAttribute_tokenString (var_cas_entityName) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
        var_cas_ioMetamodelClassSet._addAssign_operation (var_cas_entityName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (524))) ;
      switch (select_repeat_metamodel_parser_7 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
          } break ;
