...
pr_entity_declaration_metamodel_parser_305_26_ (galgas_scanner & lexique_var_,
  ...
  switch (select_metamodel_parser_2 (lexique_var_)) {
    ...
    case 2 : {
      ...
      GGS_entityPropertyMap  var_cas_12948 ;
      GGS_bool var_cas_12951 ;
      GGS_lstring  var_cas_12970 ;
      GGS_mapPropertyMap  var_cas_12973 ;
      GGS_contextPropertyMap  var_cas_12976 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_superEntity, var_cas_12948, var_cas_12951, var_cas_allPropertyMap, var_cas_12970, var_cas_12973, var_cas_12976, var_cas_allContextPropertyMap) ;
      } break ;
    case 3 : {
      var_cas_superEntity = GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (lexique_var_) COMMA_HERE) ;
      var_cas_allPropertyMap = GGS_entityPropertyMap::constructor_empty (HERE) ;
  ...
  GGS_contextPropertyMap::element_type * operand_13596 = var_cas_currentClassContextPropertyMap.firstObject () ;
  while ((operand_13596 != NULL)) {
    macroValidPointer (operand_13596) ;
    var_cas_allContextPropertyMap.methode_insertKey (lexique_var_, operand_13596->mKey, operand_13596->mInfo.mTypeName) ;
    var_cas_allPropertyMap.methode_insertKey (lexique_var_, operand_13596->mKey, GGS_metamodelPropertyKind::constructor_contextProperty (HERE), operand_13596->mInfo.mTypeName, GGS_L_ListOfPropertyPathes::constructor_empty (HERE)) ;
    var_cas_entityPropertyMap.methode_insertKey (lexique_var_, operand_13596->mKey, GGS_metamodelPropertyKind::constructor_contextProperty (HERE), operand_13596->mInfo.mTypeName, GGS_L_ListOfPropertyPathes::constructor_empty (HERE)) ;
    operand_13596 = operand_13596->nextObject () ;
  }
          ...
          switch (select_metamodel_parser_6 (lexique_var_)) {
            ...
            case 2 : {
              ...
              if (((var_cas_propertyTypeName.reader_value ()) != (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
                  GGS_location (lexique_var_).reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "only an '@lstring' attribute accepts the 'in' option")) ;
              }
...
void metamodel_parser::
metamodel_parser::
pr_property_path_metamodel_parser_494_21_ (galgas_scanner & lexique_var_,
...
void metamodel_parser::
pr_property_path_metamodel_parser_494_21_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
      switch (select_repeat_metamodel_parser_10 (lexique_var_)) {
