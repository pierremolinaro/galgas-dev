...
pr_parse_metamodel_metamodel_parser_111_23_ (galgas_scanner & lexique_var_,
  ...
  var_cas_entityMap.methode_searchKey (lexique_var_, var_cas_rootEntityName, var_cas_5373, var_cas_isAbstract, var_cas_5388, var_cas_5391, var_cas_5394) ;
  ...
  GGS_entityToImplementMap::element_type * operand_5606 = var_cas_entityMap.firstObject () ;
  while ((operand_5606 != NULL)) {
    ...
    ::routine_buildSuperEntitySet (lexique_var_,  var_cas_entityMap,  operand_5606->mInfo.mSuperEntityName,  var_cas_superEntitySet) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_singleEntity::constructor_new (operand_5606->mKey, operand_5606->mInfo.mAllPropertiesMap, operand_5606->mInfo.mIsAbstract, operand_5606->mInfo.mEntityPropertiesMap, operand_5606->mInfo.mSuperEntityName, var_cas_superEntitySet COMMA_HERE) ;
    GGS_AC_semanticsEntity  var_cas_e ;
    var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
    var_cas_semanticsEntityMap.methode_insertKey (lexique_var_, operand_5606->mKey, var_cas_e) ;
    operand_5606 = operand_5606->nextObject () ;
  }
  GGS_stringset  var_cas_multiReferencedEntities ;
  var_cas_multiReferencedEntities = GGS_stringset::constructor_empty (HERE) ;
  GGS_entityToImplementMap::element_type * operand_6440 = var_cas_entityMap.firstObject () ;
  while ((operand_6440 != NULL)) {
    macroValidPointer (operand_6440) ;
    GGS_entityPropertyMap::element_type * operand_6663 = operand_6440->mInfo.mEntityPropertiesMap.firstObject () ;
    while ((operand_6663 != NULL)) {
      macroValidPointer (operand_6663) ;
      if (((operand_6663->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE))).isBuiltAndTrue ()) {
        GGS_entityPropertyMap  var_cas_6840 ;
        GGS_bool var_cas_6843 ;
        GGS_entityPropertyMap  var_cas_6846 ;
        GGS_lstring  var_cas_6849 ;
        GGS_mapPropertyMap  var_cas_6852 ;
        var_cas_entityMap.methode_searchKey (lexique_var_, operand_6663->mInfo.mTypeName, var_cas_6840, var_cas_6843, var_cas_6846, var_cas_6849, var_cas_6852) ;
      }else if (((operand_6663->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (HERE))).isBuiltAndTrue ()) {
        GGS_entityPropertyMap  var_cas_6977 ;
        GGS_bool var_cas_6980 ;
        GGS_entityPropertyMap  var_cas_6983 ;
        GGS_lstring  var_cas_6986 ;
        GGS_mapPropertyMap  var_cas_6989 ;
        var_cas_entityMap.methode_searchKey (lexique_var_, operand_6663->mInfo.mTypeName, var_cas_6977, var_cas_6980, var_cas_6983, var_cas_6986, var_cas_6989) ;
        var_cas_multiReferencedEntities.addAssign_operation (operand_6663->mInfo.mTypeName.reader_value ()) ;
      }
      operand_6663 = operand_6663->nextObject () ;
    }
    operand_6440 = operand_6440->nextObject () ;
  }
  GGS_entityToImplementMap::element_type * operand_7144 = var_cas_entityMap.firstObject () ;
  while ((operand_7144 != NULL)) {
    macroValidPointer (operand_7144) ;
    GGS_mapPropertyMap::element_type * operand_7392 = operand_7144->mInfo.mMapOfPropertyMaps.firstObject () ;
    while ((operand_7392 != NULL)) {
      macroValidPointer (operand_7392) ;
      GGS_L_ListOfPropertyPathes::element_type * operand_7614 = operand_7392->mInfo.mListOfPropertyPathes.firstObject () ;
      while ((operand_7614 != NULL)) {
        macroValidPointer (operand_7614) ;
        GGS_entityPropertyMap  var_cas_currentMap ;
        var_cas_currentMap = operand_7144->mInfo.mAllPropertiesMap ;
        GGS_lstring  var_cas_lastEntityName ;
        var_cas_lastEntityName = operand_7144->mKey ;
        GGS_string var_cas_returnedTypeName ;
        var_cas_returnedTypeName = GGS_string (true, "") ;
        GGS_L_propertyPath::element_type * operand_7848 = operand_7614->mPath.firstObject () ;
        while ((operand_7848 != NULL)) {
          macroValidPointer (operand_7848) ;
          GGS_metamodelPropertyKind var_cas_kind ;
          GGS_lstring  var_cas_typeName ;
          var_cas_currentMap.methode_searchKey (lexique_var_, operand_7848->mPathElement, var_cas_kind, var_cas_typeName) ;
          if (((var_cas_kind) == (GGS_metamodelPropertyKind::constructor_attributeProperty (HERE))).isBuiltAndTrue ()) {
            ...
            GGS_bool var_cas_8367 ;
            GGS_entityPropertyMap  var_cas_8370 ;
            GGS_lstring  var_cas_8373 ;
            GGS_mapPropertyMap  var_cas_8376 ;
            var_cas_entityMap.methode_searchKey (lexique_var_, var_cas_typeName, var_cas_currentMap, var_cas_8367, var_cas_8370, var_cas_8373, var_cas_8376) ;
          }else if (((var_cas_kind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (HERE))).isBuiltAndTrue ()) {
            var_cas_lastEntityName = var_cas_typeName ;
            GGS_bool var_cas_8560 ;
            GGS_entityPropertyMap  var_cas_8563 ;
            GGS_lstring  var_cas_8566 ;
            GGS_mapPropertyMap  var_cas_8569 ;
            var_cas_entityMap.methode_searchKey (lexique_var_, var_cas_typeName, var_cas_currentMap, var_cas_8560, var_cas_8563, var_cas_8566, var_cas_8569) ;
          }else if (((var_cas_kind) == (GGS_metamodelPropertyKind::constructor_mapProperty (HERE))).isBuiltAndTrue ()) {
              operand_7848->mPathElement.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "A map property can be named in a property path")) ;
            var_cas_currentMap = GGS_entityPropertyMap::constructor_empty (HERE) ;
          }
          operand_7848 = operand_7848->nextObject () ;
        }
        if (((var_cas_returnedTypeName) != (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
            operand_7614->mEndOfPathLocation.reader_location ().signalGGSSemanticError (lexique_var_, GGS_string (true, "the path does not specify an @lstring attribute")) ;
        }
        GGS_stringset  var_cas_superEntitySet ;
        var_cas_superEntitySet = GGS_stringset::constructor_empty (HERE) ;
        ::routine_buildSuperEntitySet (lexique_var_,  var_cas_entityMap,  var_cas_lastEntityName,  var_cas_superEntitySet) ;
        if (((! var_cas_superEntitySet.reader_hasKey (operand_7392->mInfo.mEntityName.reader_value ()))).isBuiltAndTrue ()) {
            operand_7614->mEndOfPathLocation.reader_location ().signalGGSSemanticError (lexique_var_, ((((((((GGS_string (true, "the path names an attribute whose owner entity ('@")) + (var_cas_lastEntityName.reader_value ()))) + (GGS_string (true, "') does not inherit from '@")))) + (operand_7392->mInfo.mEntityName.reader_value ()))) + (GGS_string (true, "'")))) ;
        }
        operand_7614 = operand_7614->nextObject () ;
      }
      operand_7392 = operand_7392->nextObject () ;
    }
    operand_7144 = operand_7144->nextObject () ;
  }
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_list_metamodel_parser_255_31_ (galgas_scanner & lexique_var_,
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_255_31_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_0 (lexique_var_)) {
        case 2 : {
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_271_26_ (galgas_scanner & lexique_var_,
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_contextPropertyMap.methode_insertKey (lexique_var_, var_cas_contextPropertyName, var_cas_entityName) ;
  ...
  switch (select_metamodel_parser_4 (lexique_var_)) {
    ...
    case 2 : {
      ...
      GGS_entityPropertyMap  var_cas_11307 ;
      GGS_bool var_cas_11310 ;
      GGS_lstring  var_cas_11329 ;
      GGS_mapPropertyMap  var_cas_11332 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_superEntity, var_cas_11307, var_cas_11310, var_cas_allPropertyMap, var_cas_11329, var_cas_11332) ;
      } break ;
    default :
      break ;
  }
  ...
  GGS_contextPropertyMap::element_type * operand_11458 = var_cas_contextPropertyMap.firstObject () ;
  while ((operand_11458 != NULL)) {
    macroValidPointer (operand_11458) ;
    var_cas_allPropertyMap.methode_insertKey (lexique_var_, operand_11458->mKey, GGS_metamodelPropertyKind::constructor_contextProperty (HERE), operand_11458->mInfo.mTypeName) ;
    var_cas_entityPropertyMap.methode_insertKey (lexique_var_, operand_11458->mKey, GGS_metamodelPropertyKind::constructor_contextProperty (HERE), operand_11458->mInfo.mTypeName) ;
    operand_11458 = operand_11458->nextObject () ;
  }
    ...
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_5 (lexique_var_)) {
        ...
        case 3 : {
          ...
          var_cas_allPropertyMap.methode_insertKey (lexique_var_, var_cas_mapPropertyName, var_cas_k, var_cas_entityName) ;
          var_cas_entityPropertyMap.methode_insertKey (lexique_var_, var_cas_mapPropertyName, var_cas_k, var_cas_entityName) ;
          lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7B) ;
  ...
  lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1__7D) ;
  var_cas_ioEntityMap.methode_insertKey (lexique_var_, var_cas_entityName, var_cas_allPropertyMap, var_cas_isAbstract, var_cas_entityPropertyMap, var_cas_superEntity, var_cas_mapPropertyMap) ;
}

//---------------------------------------------------------------------------*

void metamodel_parser::
pr_entity_declaration_metamodel_parser_271_26_parse (galgas_scanner & lexique_var_) {
  switch (select_metamodel_parser_1 (lexique_var_)) {
    case 1 : {
      } break ;
    case 2 : {
...
void metamodel_parser::
metamodel_parser::
pr_property_path_metamodel_parser_427_21_ (galgas_scanner & lexique_var_,
...
void metamodel_parser::
pr_property_path_metamodel_parser_427_21_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        lexique_var_.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
      switch (select_repeat_metamodel_parser_10 (lexique_var_)) {
