...
pr_parse_metamodel_metamodel_parser_159_6_ (galgas_scanner & _inLexique,
  ...
  GGS_M_semanticsComponents::element_type * operand_8781 = var_cas_semanticsComponentsMap.firstObject () ;
  while ((operand_8781 != NULL)) {
    macroValidPointer (operand_8781) ;
    var_cas_headerInclusionList._addAssign_operation (operand_8781->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (229))) ;
    operand_8781 = operand_8781->nextObject () ;
  }
  ...
  GGS_lstringlist::element_type * operand_9081 = var_cas_superMetamodelList.firstObject () ;
  while ((operand_9081 != NULL)) {
    macroValidPointer (operand_9081) ;
    var_cas_headerInclusionList._addAssign_operation (operand_9081->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (235))) ;
    ::routine_performMetamodelInclusion (_inLexique,  var_cas_ioMetamodelComponentMap,  operand_9081->mValue,  var_cas_superMetamodels,  var_cas_allEntityMap COMMA_SOURCE_FILE_AT_LINE (236)) ;
    operand_9081 = operand_9081->nextObject () ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_9755 = var_cas_entityMap.firstObject () ;
  while ((operand_9755 != NULL)) {
    macroValidPointer (operand_9755) ;
    GGS_entityPropertyMap::element_type * operand_9979 = operand_9755->mInfo.mCurrentMetamodelPropertyMap.firstObject () ;
    while ((operand_9979 != NULL)) {
      macroValidPointer (operand_9979) ;
      if (operand_9979->mInfo.mPropertyType._isBuilt ()) {
        cPtr_typeGalgas_singleReferenceEntity * operand_10111 = dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (operand_9979->mInfo.mPropertyType.getPtr ()) ;
        if (operand_10111 != NULL) {
          macroValidPointer (operand_10111) ; 
          ...
          if (var_cas_allEntityMap._isBuilt ()) {
            var_cas_allEntityMap (HERE)->method_searchKey (_inLexique, operand_10111->mEntityTypeName, automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (265)) ;
          }
        }else{
          cPtr_typeGalgas_multipleReferenceEntity * operand_10252 = dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (operand_9979->mInfo.mPropertyType.getPtr ()) ;
          if (operand_10252 != NULL) {
            ...
            if (var_cas_allEntityMap._isBuilt ()) {
              var_cas_allEntityMap (HERE)->method_searchKey (_inLexique, operand_10252->mEntityTypeName, automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (267)) ;
            }
          }else{ // Else part
          }
        }
      }
      operand_9979 = operand_9979->nextObject () ;
    }
    operand_9755 = operand_9755->nextObject () ;
  }
...
pr_entity_declaration_list_metamodel_parser_298_6_ (galgas_scanner & _inLexique,
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_11772 = _inLexique.parsingContext () ;
    { bool syntaxRepeat = true ;
      while (syntaxRepeat) {
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_11772) ;
