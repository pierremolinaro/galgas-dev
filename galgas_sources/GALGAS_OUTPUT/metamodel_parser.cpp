...
pr_galgas_component_metamodel_parser_74_24_ (galgas_scanner & lexique_var_,
...
void metamodel_parser::
pr_galgas_component_metamodel_parser_74_24_importLexique (galgas_scanner & lexique_var_,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
...
void metamodel_parser::
pr_galgas_component_metamodel_parser_74_24_importSyntax (galgas_scanner & lexique_var_,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */) {
  nt_parse_metamodel_parse (lexique_var_) ;
}
...
void metamodel_parser::
pr_galgas_component_metamodel_parser_74_24_importSemantics (galgas_scanner & lexique_var_,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &var_cas_ioMetamodelComponentMap) {
  nt_parse_metamodel_ (lexique_var_, var_cas_ioMetamodelComponentMap) ;
}
...
void metamodel_parser::
pr_galgas_component_metamodel_parser_74_24_importGrammarForSemantics (galgas_scanner & lexique_var_,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */) {
  nt_parse_metamodel_parse (lexique_var_) ;
}
...
void metamodel_parser::
pr_galgas_component_metamodel_parser_74_24_importOptions (galgas_scanner & lexique_var_,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  nt_parse_metamodel_parse (lexique_var_) ;
}
...
pr_parse_metamodel_metamodel_parser_108_23_ (galgas_scanner & lexique_var_,
  ...
  GGS_entityPropertyMap  var_cas_5275 ;
  GGS_entityPropertyMap  var_cas_5290 ;
  GGS_lstring  var_cas_5293 ;
  var_cas_entityMap.methode_searchKey (lexique_var_, var_cas_rootEntityName, var_cas_5275, var_cas_isAbstract, var_cas_5290, var_cas_5293) ;
  ...
  GGS_entityToImplementMap::element_type * operand_5509 = var_cas_entityMap.firstObject () ;
  while ((operand_5509 != NULL)) {
    macroValidPointer (operand_5509) ;
    GGS_entityPropertyMap::element_type * operand_5707 = operand_5509->mInfo.mEntityPropertiesMap.firstObject () ;
    while ((operand_5707 != NULL)) {
      macroValidPointer (operand_5707) ;
      if (((operand_5707->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_singleReferenceProperty (HERE))).isBuiltAndTrue ()) {
        GGS_entityPropertyMap  var_cas_5884 ;
        GGS_bool var_cas_5887 ;
        GGS_entityPropertyMap  var_cas_5890 ;
        GGS_lstring  var_cas_5893 ;
        var_cas_entityMap.methode_searchKey (lexique_var_, operand_5707->mInfo.mTypeName, var_cas_5884, var_cas_5887, var_cas_5890, var_cas_5893) ;
      }else if (((operand_5707->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (HERE))).isBuiltAndTrue ()) {
        GGS_entityPropertyMap  var_cas_6018 ;
        GGS_bool var_cas_6021 ;
        GGS_entityPropertyMap  var_cas_6024 ;
        GGS_lstring  var_cas_6027 ;
        var_cas_entityMap.methode_searchKey (lexique_var_, operand_5707->mInfo.mTypeName, var_cas_6018, var_cas_6021, var_cas_6024, var_cas_6027) ;
        var_cas_multiReferencedEntities.addAssign_operation (operand_5707->mInfo.mTypeName.reader_value ()) ;
      }
      operand_5707 = operand_5707->nextObject () ;
    }
    operand_5509 = operand_5509->nextObject () ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_6342 = var_cas_entityMap.firstObject () ;
  while ((operand_6342 != NULL)) {
    ...
    ::routine_buildSuperEntitySet (lexique_var_,  var_cas_entityMap,  operand_6342->mInfo.mSuperEntityName,  var_cas_superEntitySet) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_singleEntity::constructor_new (operand_6342->mKey, operand_6342->mInfo.mAllPropertiesMap, operand_6342->mInfo.mIsAbstract, operand_6342->mInfo.mEntityPropertiesMap, operand_6342->mInfo.mSuperEntityName, var_cas_superEntitySet COMMA_HERE) ;
    GGS_AC_semanticsEntity  var_cas_e ;
    var_cas_e = GGS_typeEntiteType::constructor_new (var_cas_t COMMA_HERE) ;
    var_cas_semanticsEntityMap.methode_insertKey (lexique_var_, operand_6342->mKey, var_cas_e) ;
    operand_6342 = operand_6342->nextObject () ;
  }
  ...
  lexique_var_.printMessage (var_cas_ioMetamodelComponentMap.reader_description ()) ;
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_202_31_ (galgas_scanner & lexique_var_,
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_202_31_parse (galgas_scanner & lexique_var_) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_0 (lexique_var_)) {
        case 2 : {
...
void metamodel_parser::
pr_entity_declaration_metamodel_parser_218_26_ (galgas_scanner & lexique_var_,
  ...
  switch (select_metamodel_parser_2 (lexique_var_)) {
    ...
    case 2 : {
      ...
      GGS_entityPropertyMap  var_cas_8428 ;
      GGS_bool var_cas_8431 ;
      GGS_lstring  var_cas_8450 ;
      var_cas_ioEntityMap.methode_searchKey (lexique_var_, var_cas_superEntity, var_cas_8428, var_cas_8431, var_cas_allPropertyMap, var_cas_8450) ;
      } break ;
    default :
      break ;
  }
...
void metamodel_parser::
pr_entity_declaration_metamodel_parser_218_26_parse (galgas_scanner & lexique_var_) {
  switch (select_metamodel_parser_1 (lexique_var_)) {
    case 1 : {
      } break ;
    case 2 : {
