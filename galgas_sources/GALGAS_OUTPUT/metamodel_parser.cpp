...
pr_parse_metamodel_metamodel_parser_114_23_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_entityMap._isBuilt ()) {
    var_cas_entityMap (HERE)->method_searchKey (_inLexique, var_cas_rootEntityName, var_cas_5855, var_cas_isAbstract, var_cas_5870, var_cas_5873, var_cas_5876 SOURCE_FILE_AT_LINE (149)) ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_6091 = var_cas_entityMap.firstObject () ;
  while ((operand_6091 != NULL)) {
    macroValidPointer (operand_6091) ;
    GGS_AC_galgasType  var_cas_t ;
    var_cas_t = GGS_typeGalgas_singleEntity::constructor_new (_inLexique, operand_6091->mKey, operand_6091->mInfo.mAllPropertiesMap, operand_6091->mInfo.mIsAbstract, operand_6091->mInfo.mEntityPropertiesMap, operand_6091->mInfo.mSuperEntityName, operand_6091->mInfo.mSuperClassSet COMMA_HERE) ;
    GGS_AC_semanticsEntity  var_cas_e ;
    var_cas_e = GGS_typeEntiteType::constructor_new (_inLexique, var_cas_t COMMA_HERE) ;
    var_cas_semanticsEntityMap.method_insertKey (_inLexique, operand_6091->mKey, var_cas_e SOURCE_FILE_AT_LINE (171)) ;
    operand_6091 = operand_6091->nextObject () ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_6816 = var_cas_entityMap.firstObject () ;
  while ((operand_6816 != NULL)) {
    macroValidPointer (operand_6816) ;
    GGS_entityPropertyMap::element_type * operand_7074 = operand_6816->mInfo.mEntityPropertiesMap.firstObject () ;
    while ((operand_7074 != NULL)) {
      macroValidPointer (operand_7074) ;
      if (((((operand_7074->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_singleReferenceProperty (_inLexique COMMA_HERE))) | ((operand_7074->mInfo.mKind) == (GGS_metamodelPropertyKind::constructor_multipleReferenceProperty (_inLexique COMMA_HERE))))).isBuiltAndTrue ()) {
        GGS_entityPropertyMap  var_cas_7414 ;
        GGS_bool var_cas_7417 ;
        GGS_entityPropertyMap  var_cas_7420 ;
        GGS_lstring  var_cas_7423 ;
        GGS_stringset  var_cas_7426 ;
        if (var_cas_entityMap._isBuilt ()) {
          var_cas_entityMap (HERE)->method_searchKey (_inLexique, operand_7074->mInfo.mTypeName, var_cas_7414, var_cas_7417, var_cas_7420, var_cas_7423, var_cas_7426 SOURCE_FILE_AT_LINE (188)) ;
        }
        var_cas_multiReferencedEntities._addAssign_operation (operand_7074->mInfo.mTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (189))) ;
      }
      operand_7074 = operand_7074->nextObject () ;
    }
    operand_6816 = operand_6816->nextObject () ;
  }
  if (var_cas_entityMap._isBuilt () &&
  ...
  if (((! (var_cas_ioMetamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (201)) SOURCE_FILE_AT_LINE (201))))).isBuiltAndTrue ()) {
...
pr_entity_declaration_metamodel_parser_234_26_ (galgas_scanner & _inLexique,
  ...
  switch (select_metamodel_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      GGS_entityPropertyMap  var_cas_9329 ;
      GGS_bool var_cas_9338 ;
      GGS_lstring  var_cas_9369 ;
      if (var_cas_ioEntityMap._isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_9329, var_cas_9338, var_cas_allPropertyMap, var_cas_9369, var_cas_superEntitySet SOURCE_FILE_AT_LINE (264)) ;
      }
      var_cas_superEntitySet._addAssign_operation (var_cas_superEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (271))) ;
      } break ;
    default :
      break ;
  }
        ...
        case 2 : {
          ...
          switch (select_metamodel_parser_4 (_inLexique)) {
            case 1 : {
              ...
              if ((var_cas_ioPrimitiveTypeAttributeNameSet.reader_hasKey (_inLexique, var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (286)) SOURCE_FILE_AT_LINE (286))).isBuiltAndTrue ()) {
                var_cas_propertyTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '@")) + (var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (287))))) + (GGS_string (true, "' is not an entity name, but a predefined type name"))) SOURCE_FILE_AT_LINE (289)) ;
              }
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
            ...
            case 2 : {
              _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
              var_cas_attributeName.defineAttributeFromScanner (_inLexique.tokenString, _inLexique) ;
              if ((var_cas_ioPrimitiveTypeAttributeNameSet.reader_hasKey (_inLexique, var_cas_propertyTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (295)) SOURCE_FILE_AT_LINE (295))).isBuiltAndTrue ()) {
          ...
          var_cas_entityPropertyMap.method_insertKey (_inLexique, var_cas_attributeName, var_cas_k, var_cas_propertyTypeName SOURCE_FILE_AT_LINE (303)) ;
          var_cas_allPropertyMap.method_insertKey (_inLexique, var_cas_attributeName, var_cas_k, var_cas_propertyTypeName SOURCE_FILE_AT_LINE (304)) ;
          _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
          } break ;
        default :
          syntaxRepeat = false ;
  ...
  var_cas_ioEntityMap.method_insertKey (_inLexique, var_cas_entityName, var_cas_allPropertyMap, var_cas_isAbstract, var_cas_entityPropertyMap, var_cas_superEntity, var_cas_superEntitySet SOURCE_FILE_AT_LINE (309)) ;
}
