    ...
    while (((operand_10883 = (GGS_entityToImplementMap::cElement *) enumerator_10883.nextObject ()))) {
      macroValidPointer (operand_10883) ;
      {
        ...
        while (((operand_11097 = (GGS_entityPropertyMap::cElement *) enumerator_11097.nextObject ()))) {
          ...
          { const GGS_AC_galgasType _var_11560 = operand_11097->mInfo.mPropertyType ; // CAST instruction
            if (_var_11560.getPtr () != NULL) {
              macroValidPointer (_var_11560.getPtr ()) ;
              if (dynamic_cast <cPtr_typeGalgas_singleReferenceEntity *> (_var_11560.getPtr ()) != NULL) {
                const GGS_typeGalgas_singleReferenceEntity var_cas_e (_var_11560.getPtr ()) ;
                ...
                const GGS_entityToImplementMap  _temp_11354 = var_cas_allEntityMap ;
                if (_temp_11354._isBuilt ()) {
                  _temp_11354 (HERE)->method_searchKey (_inLexique, var_cas_e.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (301)), automatic_var_0, automatic_var_1, automatic_var_2, automatic_var_3, automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7 COMMA_SOURCE_FILE_AT_LINE (301)) ;
                }
              }else if (dynamic_cast <cPtr_typeGalgas_multipleReferenceEntity *> (_var_11560.getPtr ()) != NULL) {
                const GGS_typeGalgas_multipleReferenceEntity var_cas_e (_var_11560.getPtr ()) ;
                ...
                const GGS_entityToImplementMap  _temp_11511 = var_cas_allEntityMap ;
                if (_temp_11511._isBuilt ()) {
                  _temp_11511 (HERE)->method_searchKey (_inLexique, var_cas_e.reader_mEntityTypeName (_inLexique COMMA_SOURCE_FILE_AT_LINE (303)), automatic_var_8, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13, automatic_var_14, automatic_var_15 COMMA_SOURCE_FILE_AT_LINE (303)) ;
                }
              }else{
              }
            }
...
pr_entity_declaration_list_metamodel_parser_334_4_ (galgas_scanner & _inLexique,
  ...
  //--- First branch of parse/rewind instruction
    const C_parsingContext context_12931 = _inLexique.parsingContext () ;
  ...
  //--- Branch of parse/rewind instruction
    _inLexique.setParsingContext (context_12931) ;
...
pr_entity_declaration_metamodel_parser_369_4_ (galgas_scanner & _inLexique,
  ...
  switch (select_metamodel_parser_8 (_inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_entityToImplementMap  _temp_14239 = var_cas_ioAllEntityMap ;
      if (_temp_14239._isBuilt ()) {
        _temp_14239 (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, automatic_var_16, automatic_var_17, automatic_var_18, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, automatic_var_19, automatic_var_20 COMMA_SOURCE_FILE_AT_LINE (409)) ;
      }
          ...
          switch (select_metamodel_parser_10 (_inLexique)) {
            case 1 : {
              ...
              if ((var_cas_inMetamodelClassSet.reader_hasKey (_inLexique, var_cas_propertyOrEntityTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (431)) COMMA_SOURCE_FILE_AT_LINE (431))).isBuiltAndTrue ()) {
                ...
                const GGS_M_semanticsEntitiesForUse  _temp_15374 = var_cas_inSemanticsEntitiesMap ;
                if (_temp_15374._isBuilt ()) {
                  _temp_15374 (HERE)->method_searchKey (_inLexique, var_cas_propertyOrEntityTypeName, var_cas_theEntity COMMA_SOURCE_FILE_AT_LINE (441)) ;
                }
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_17538 (var_cas_entityNameList, true) ;
    const GGS_lstringlist::cElement * operand_17538 = NULL ;
    while (((operand_17538 = (GGS_lstringlist::cElement *) enumerator_17538.nextObject ()))) {
      macroValidPointer (operand_17538) ;
      var_cas_ioEntityMap.modifier_insertKey (_inLexique, operand_17538->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (494)) ;
      var_cas_ioAllEntityMap.modifier_insertKey (_inLexique, operand_17538->mValue, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntityMap, var_cas_listeTousAttributsSemantiques, var_cas_inCurrentMetamodelName, var_cas_ioEntityID COMMA_SOURCE_FILE_AT_LINE (505)) ;
      GGS_typeEntityToGenerate  var_cas_def ;
      var_cas_def = GGS_C_metamodelEntityToImplement::constructor_new (_inLexique, operand_17538->mValue, var_cas_isAbstract, var_cas_listeTousAttributsSemantiques, var_cas_listeAttributsSemantiquesCourants, var_cas_superEntity.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (522)), var_cas_ioEntityID COMMA_HERE) ;
