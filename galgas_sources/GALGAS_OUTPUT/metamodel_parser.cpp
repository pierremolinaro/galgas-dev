...
//                    february 22th, 2007, at 11h17'10"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_parse_metamodel_metamodel_parser_116_6_ (galgas_scanner & _inLexique,
  ...
  if (var_cas_entityMap._isBuilt ()) {
    var_cas_entityMap (HERE)->method_searchKey (_inLexique, var_cas_rootEntityName, automatic_var_0, var_cas_isAbstract, automatic_var_1, automatic_var_2, automatic_var_3 SOURCE_FILE_AT_LINE (139)) ;
  }
  ...
  GGS_entityToImplementMap::element_type * operand_5665 = var_cas_entityMap.firstObject () ;
  while ((operand_5665 != NULL)) {
    macroValidPointer (operand_5665) ;
    GGS_entityPropertyMap::element_type * operand_5911 = operand_5665->mInfo.mCurrentMetamodelPropertyMap.firstObject () ;
    while ((operand_5911 != NULL)) {
      macroValidPointer (operand_5911) ;
      if (operand_5911->mInfo.mProperty._isBuilt ()) {
        cPtr_metamodelSingleReferenceProperty * operand_6039 = dynamic_cast <cPtr_metamodelSingleReferenceProperty *> (operand_5911->mInfo.mProperty.getPtr ()) ;
        if (operand_6039 != NULL) {
          macroValidPointer (operand_6039) ; 
          ...
          if (var_cas_entityMap._isBuilt ()) {
            var_cas_entityMap (HERE)->method_searchKey (_inLexique, operand_6039->mReferenceEntityName, automatic_var_4, automatic_var_5, automatic_var_6, automatic_var_7, automatic_var_8 SOURCE_FILE_AT_LINE (155)) ;
          }
        }else{
          cPtr_metamodelMultipleReferenceProperty * operand_6177 = dynamic_cast <cPtr_metamodelMultipleReferenceProperty *> (operand_5911->mInfo.mProperty.getPtr ()) ;
          if (operand_6177 != NULL) {
            ...
            if (var_cas_entityMap._isBuilt ()) {
              var_cas_entityMap (HERE)->method_searchKey (_inLexique, operand_6177->mReferenceEntityName, automatic_var_9, automatic_var_10, automatic_var_11, automatic_var_12, automatic_var_13 SOURCE_FILE_AT_LINE (157)) ;
            }
            var_cas_multiReferencedEntities._addAssign_operation (operand_6177->mReferenceEntityName.reader_string (_inLexique SOURCE_FILE_AT_LINE (158))) ;
          }else{ // Else part
          }
        }
      }
      operand_5911 = operand_5911->nextObject () ;
    }
    operand_5665 = operand_5665->nextObject () ;
  }
  if ((var_cas_inGenerateMetamodelCode).isBuiltAndTrue ()) {
    if (var_cas_entityMap._isBuilt () &&
      ...
      ::routine_generate_metamodel (_inLexique,  var_cas_entityMap,  var_cas_metamodelName,  var_cas_multiReferencedEntities,  var_cas_rootEntityName SOURCE_FILE_AT_LINE (165)) ;
    }
  }
  if (((! (var_cas_ioMetamodelComponentMap.reader_hasKey (_inLexique, var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (173)) SOURCE_FILE_AT_LINE (173))))).isBuiltAndTrue ()) {
    var_cas_ioMetamodelComponentMap.modifier_insertKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, var_cas_entityMap, var_cas_multiReferencedEntities SOURCE_FILE_AT_LINE (174)) ;
  }
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_list_metamodel_parser_188_6_ (galgas_scanner & _inLexique,
...
void metamodel_parser::
pr_entity_declaration_list_metamodel_parser_188_6_parse (galgas_scanner & _inLexique) {
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_parser_0 (_inLexique)) {
        case 2 : {
...
void metamodel_parser::
metamodel_parser::
pr_entity_declaration_metamodel_parser_205_6_ (galgas_scanner & _inLexique,
                                const GGS_M_semanticsEntitiesForUse  &var_cas_inSemanticsEntitiesMap,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_mda_5Ftype_5Fname) COMMA_HERE) ;
  var_cas_ioMapAndEntityUniqueMap.modifier_insertKey (_inLexique, var_cas_entityName SOURCE_FILE_AT_LINE (222)) ;
  ...
  switch (select_metamodel_parser_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (var_cas_ioEntityMap._isBuilt ()) {
        var_cas_ioEntityMap (HERE)->method_searchKey (_inLexique, var_cas_superEntity, var_cas_allMetamodelPropertyMap, automatic_var_14, automatic_var_15, automatic_var_16, var_cas_superEntitySet SOURCE_FILE_AT_LINE (234)) ;
      }
      var_cas_superEntitySet._addAssign_operation (var_cas_superEntity.reader_string (_inLexique SOURCE_FILE_AT_LINE (242))) ;
      } break ;
    default :
      break ;
  }
      ...
      switch (select_repeat_metamodel_parser_3 (_inLexique)) {
        case 2 : {
          ...
          if (var_cas_inSemanticsEntitiesMap._isBuilt ()) {
            var_cas_inSemanticsEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_propertyTypeName, var_cas_entity SOURCE_FILE_AT_LINE (252)) ;
          }
          ...
          { cPtr_typeEntiteType * ptrExtraire_ = dynamic_cast <cPtr_typeEntiteType *> (var_cas_entity.getPtr ()) ;
            if (ptrExtraire_ == NULL) {
              ...
              if (var_cas_entity.getPtr () != NULL) {
                ...
                var_cas_propertyTypeName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (254)) ;
              }
            }else{
          ...
          var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (258)) ;
          var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (259)) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          } break ;
        case 3 : {
          GGS_lstring  var_cas_propertyTypeName ;
                ...
                case 1 : {
                  ...
                  switch (select_metamodel_parser_6 (_inLexique)) {
                    case 1 : {
                      ...
                      switch (select_metamodel_parser_7 (_inLexique)) {
                        case 1 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
                          if (((((var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (277))) == (GGS_uint (true, 0U))) & ((var_cas_higherBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (277))) == (GGS_uint (true, 0U))))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if lower bound is zero, higher bound should be greater than zero") SOURCE_FILE_AT_LINE (279)) ;
                          }else if (((((var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (279))) > (GGS_uint (true, 0U))) & ((var_cas_higherBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (279))) < (var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (279)))))).isBuiltAndTrue ()) {
                            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "higher bound should be greater or equal than lower bound") SOURCE_FILE_AT_LINE (281)) ;
                          }
                          } break ;
                        case 2 : {
                    ...
                    case 2 : {
                      ...
                      if (((var_cas_lowerBound.reader_uint (_inLexique SOURCE_FILE_AT_LINE (288))) == (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                        var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "if higher bound is implicit, lower bound should be greater than zero") SOURCE_FILE_AT_LINE (290)) ;
                      }
                      } break ;
                    default :
                      break ;
          ...
          var_cas_currentEntityPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (304)) ;
          var_cas_allMetamodelPropertyMap.modifier_insertKey (_inLexique, var_cas_attributeName, var_cas_k SOURCE_FILE_AT_LINE (305)) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
          } break ;
        default :
          syntaxRepeat = false ;
  ...
  var_cas_ioEntityMap.modifier_insertKey (_inLexique, var_cas_entityName, var_cas_allMetamodelPropertyMap, var_cas_isAbstract, var_cas_currentEntityPropertyMap, var_cas_superEntity, var_cas_superEntitySet SOURCE_FILE_AT_LINE (309)) ;
}

//---------------------------------------------------------------------------*

void metamodel_parser::
pr_entity_declaration_metamodel_parser_205_6_parse (galgas_scanner & _inLexique) {
  switch (select_metamodel_parser_1 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
