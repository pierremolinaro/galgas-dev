...
class GALGAS_templateExpressionListAST_3A_element ;
...
class GALGAS_templateInstructionIfBranchListAST_3A_element ;
class GALGAS_templateInstructionListAST ;
class GALGAS_templateInstructionListAST_3A_element ;
...
class GALGAS_templateInstructionSwitchBranchListAST_3A_element ;
