...
//--- Non terminal declarations
  protected : virtual void nt_concatenation_5F_term_ (class GALGAS_templateExpressionAST & outArgument0,
                                                      class C_Lexique_galgasTemplateScanner * inLexique) = 0 ;

  protected : virtual void nt_concatenation_5F_term_parse (class C_Lexique_galgasTemplateScanner * inLexique) = 0 ;
