...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_syntax_5F_instruction_5F_list_i5_ (GALGAS_syntaxInstructionList & outArgument_outSyntaxInstructionList,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken__3B_) COMMA_SOURCE_FILE_AT_LINE (186)) ;
    } break ;
    case 3: {
      GALGAS_localVariableDeclarationListAST var_localVariableDeclarationList = GALGAS_localVariableDeclarationListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (188)) ;
      ...
      cEnumerator_localVariableDeclarationListAST enumerator_7438 (var_localVariableDeclarationList, kEnumeration_up) ;
      while (enumerator_7438.hasCurrentObject ()) {
        outArgument_outSyntaxInstructionList.addAssign_operation (GALGAS_localVariableDeclarationAST::constructor_new (enumerator_7438.current_mTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (191)), enumerator_7438.current_mTypeName (HERE), enumerator_7438.current_mVariableName (HERE), enumerator_7438.current_mIsUndefinedConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (191)) COMMA_SOURCE_FILE_AT_LINE (191)) ;
        enumerator_7438.gotoNextObject () ;
      }
      outArgument_outSyntaxInstructionList.addAssign_operation (var_instruction COMMA_SOURCE_FILE_AT_LINE (193)) ;
    } break ;
    case 4: {
      ...
      cEnumerator_localVariableDeclarationListAST enumerator_7871 (var_localVariableDeclarationList, kEnumeration_up) ;
      while (enumerator_7871.hasCurrentObject ()) {
        outArgument_outSyntaxInstructionList.addAssign_operation (GALGAS_localVariableDeclarationAST::constructor_new (enumerator_7871.current_mTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (198)), enumerator_7871.current_mTypeName (HERE), enumerator_7871.current_mVariableName (HERE), enumerator_7871.current_mIsUndefinedConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (198)) COMMA_SOURCE_FILE_AT_LINE (198)) ;
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_syntax_5F_instruction_i10_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
  ...
  outArgument_outInstruction = GALGAS_parseRewindInstruction::constructor_new (var_instructionLocation, var_mParseDoBranchList, var_endOfInstruction COMMA_SOURCE_FILE_AT_LINE (406)) ;
}
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_branchOfParseWhenInstruction_i11_ (GALGAS_syntaxInstructionList & outArgument_outElseInstructionList,
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_else) COMMA_SOURCE_FILE_AT_LINE (420)) ;
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_branchOfParseWhenInstruction_i12_ (GALGAS_syntaxInstructionList & outArgument_outElseInstructionList,
                                                                                                                      C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outElseInstructionList.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_when) COMMA_SOURCE_FILE_AT_LINE (427)) ;
  GALGAS_location var_instructionLocation = inCompiler->here () ;
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken__3A_) COMMA_SOURCE_FILE_AT_LINE (432)) ;
  ...
  outArgument_outElseInstructionList = GALGAS_syntaxInstructionList::constructor_emptyList (SOURCE_FILE_AT_LINE (440)) ;
  outArgument_outElseInstructionList.addAssign_operation (GALGAS_parseWhenInstruction::constructor_new (var_instructionLocation, var_whenExpression, var_endOfWhenExpression, var_whenInstructionList, var_endOfWhenInstructions, var_elseInstructionList, var_endOfElseInstructions COMMA_SOURCE_FILE_AT_LINE (441)) COMMA_SOURCE_FILE_AT_LINE (441)) ;
}
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_syntax_5F_instruction_i13_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
                                                                                                               ...
                                                                                                               C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outInstruction.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_parse) COMMA_SOURCE_FILE_AT_LINE (458)) ;
  GALGAS_location var_instructionLocation = inCompiler->here () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_when) COMMA_SOURCE_FILE_AT_LINE (460)) ;
  GALGAS_semanticExpressionAST var_whenExpression ;
  nt_expression_ (var_whenExpression, inCompiler) ;
  GALGAS_location var_endOfWhenExpression = inCompiler->here () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken__3A_) COMMA_SOURCE_FILE_AT_LINE (463)) ;
  GALGAS_syntaxInstructionList var_whenInstructionList ;
  nt_syntax_5F_instruction_5F_list_ (var_whenInstructionList, inCompiler) ;
  GALGAS_location var_endOfWhenInstructions = inCompiler->here () ;
  GALGAS_syntaxInstructionList var_elseInstructionList ;
  nt_branchOfParseWhenInstruction_ (var_elseInstructionList, inCompiler) ;
  GALGAS_location var_endOfElseInstructions = inCompiler->here () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_end) COMMA_SOURCE_FILE_AT_LINE (469)) ;
  outArgument_outInstruction = GALGAS_parseWhenInstruction::constructor_new (var_instructionLocation, var_whenExpression, var_endOfWhenExpression, var_whenInstructionList, var_endOfWhenInstructions, var_elseInstructionList, var_endOfElseInstructions COMMA_SOURCE_FILE_AT_LINE (470)) ;
}
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_syntax_5F_instruction_i14_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
                                                                                                               ...
                                                                                                               C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outInstruction.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_parse) COMMA_SOURCE_FILE_AT_LINE (491)) ;
  GALGAS_location var_instructionLocation = inCompiler->here () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_loop) COMMA_SOURCE_FILE_AT_LINE (493)) ;
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_while) COMMA_SOURCE_FILE_AT_LINE (496)) ;
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_do) COMMA_SOURCE_FILE_AT_LINE (499)) ;
  GALGAS_syntaxInstructionList var_instructionList ;
  nt_syntax_5F_instruction_5F_list_ (var_instructionList, inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_end) COMMA_SOURCE_FILE_AT_LINE (501)) ;
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_syntax_5F_instruction_i15_ (GALGAS_syntaxInstructionAST & outArgument_outInstruction,
                                                                                                               ...
                                                                                                               C_Lexique_galgas_33_Scanner * inCompiler) {
  outArgument_outInstruction.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken_send) COMMA_SOURCE_FILE_AT_LINE (528)) ;
  GALGAS_location var_instructionLocation = inCompiler->here () ;
  GALGAS_semanticExpressionAST var_sentExpression ;
  nt_expression_ (var_sentExpression, inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_33_Scanner::kToken__3B_) COMMA_SOURCE_FILE_AT_LINE (531)) ;
  outArgument_outInstruction = GALGAS_syntaxSendInstruction::constructor_new (var_instructionLocation, var_sentExpression COMMA_SOURCE_FILE_AT_LINE (532)) ;
}
