...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_declaration_i0_ (GALGAS_galgas_33_DeclarationAST & ioArgument_ioDeclarations,
  ...
  ioArgument_ioDeclarations.mAttribute_mSyntaxComponentList.addAssign_operation (var_mSyntaxComponentName, var_importedLexiqueReference, var_mNonterminalDeclarationList, var_mRuleList, var_endOfSource, var_hasTranslateFeature COMMA_SOURCE_FILE_AT_LINE (82)) ;
}
...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_syntax_5F_instruction_5F_list_i5_ (GALGAS_syntaxInstructionList & outArgument_outSyntaxInstructionList,
  ...
  while (repeatFlag_0) {
    ...
    case 3: {
      ...
      cEnumerator_localVariableDeclarationListAST enumerator_7352 (var_localVariableDeclarationList, kEnumeration_up) ;
      while (enumerator_7352.hasCurrentObject ()) {
        outArgument_outSyntaxInstructionList.addAssign_operation (GALGAS_localVariableDeclarationAST::constructor_new (enumerator_7352.current_mTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (185)), enumerator_7352.current_mTypeName (HERE), enumerator_7352.current_mVariableName (HERE), enumerator_7352.current_mIsUndefinedConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)) ;
    ...
    case 4: {
      ...
      cEnumerator_localVariableDeclarationListAST enumerator_7785 (var_localVariableDeclarationList, kEnumeration_up) ;
      while (enumerator_7785.hasCurrentObject ()) {
        outArgument_outSyntaxInstructionList.addAssign_operation (GALGAS_localVariableDeclarationAST::constructor_new (enumerator_7785.current_mTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (192)), enumerator_7785.current_mTypeName (HERE), enumerator_7785.current_mVariableName (HERE), enumerator_7785.current_mIsUndefinedConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (192)) COMMA_SOURCE_FILE_AT_LINE (192)) ;
