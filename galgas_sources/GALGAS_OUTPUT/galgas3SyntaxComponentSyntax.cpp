...
void cParser_galgas_33_SyntaxComponentSyntax::rule_galgas_33_SyntaxComponentSyntax_syntax_5F_instruction_5F_list_i5_ (GALGAS_syntaxInstructionList & outArgument_outSyntaxInstructionList,
  ...
  while (repeatFlag_0) {
    ...
    case 3: {
      ...
      cEnumerator_localVariableDeclarationListAST enumerator_7389 (var_localVariableDeclarationList, kEnumeration_up) ;
      while (enumerator_7389.hasCurrentObject ()) {
        outArgument_outSyntaxInstructionList.addAssign_operation (GALGAS_localVariableDeclarationAST::constructor_new (enumerator_7389.current_mTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (186)), enumerator_7389.current_mTypeName (HERE), enumerator_7389.current_mVariableName (HERE), enumerator_7389.current_mIsUndefinedConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (186)) COMMA_SOURCE_FILE_AT_LINE (186)) ;
    ...
    case 4: {
      ...
      cEnumerator_localVariableDeclarationListAST enumerator_7822 (var_localVariableDeclarationList, kEnumeration_up) ;
      while (enumerator_7822.hasCurrentObject ()) {
        outArgument_outSyntaxInstructionList.addAssign_operation (GALGAS_localVariableDeclarationAST::constructor_new (enumerator_7822.current_mTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (193)), enumerator_7822.current_mTypeName (HERE), enumerator_7822.current_mVariableName (HERE), enumerator_7822.current_mIsUndefinedConstant (HERE) COMMA_SOURCE_FILE_AT_LINE (193)) COMMA_SOURCE_FILE_AT_LINE (193)) ;
