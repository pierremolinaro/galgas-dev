...
pr_multiple_reference_declaration_metamodel_model_builder_130_6_ (galgas_scanner & _inLexique,
  ...
  switch (select_metamodel_model_builder_8 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_mLowerBound = var_cas_lowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
      switch (select_metamodel_model_builder_9 (_inLexique)) {
        case 1 : {
          ...
          if (((var_cas_mLowerBound)._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
            var_cas_lowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "multiplicity should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (142)) ;
          }
          } break ;
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
          switch (select_metamodel_model_builder_10 (_inLexique)) {
            case 1 : {
              GGS_luint  var_cas_upperBound ;
              _inLexique._assignFromAttribute_uint32value (var_cas_upperBound) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
              var_cas_mUpperBound = var_cas_upperBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
              if (((var_cas_mUpperBound)._operator_strictInf (var_cas_mLowerBound)).isBuiltAndTrue ()) {
                var_cas_upperBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "upper bound should be greater or equal to lower bound") COMMA_SOURCE_FILE_AT_LINE (151)) ;
                ...
                var_cas_upperBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "lower bound and upper bound should not to be both zero") COMMA_SOURCE_FILE_AT_LINE (153)) ;
              }
              } break ;
            case 2 : {
