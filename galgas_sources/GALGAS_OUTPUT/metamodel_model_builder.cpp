//---------------------------------------------------------------------------*
//                                                                           *
//                    File 'metamodel_model_builder.cpp'                     *
//         Generated by version GALGAS_BETA_VERSION (LL(1) grammar)          *
//                      march 24th, 2007, at 12h54'47"                       *
//                                                                           *
//---------------------------------------------------------------------------*
...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "metamodel_model_builder.ggs", line
...
GGS_metamodelComponentRoot metamodel_model_builder::
metamodel_model_builder::
pr_metamodel_component_start_symbol_metamodel_model_builder_36_6_ (galgas_scanner & _inLexique) {
  ...
  switch (select_metamodel_model_builder_0 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
          ...
          switch (select_repeat_metamodel_model_builder_1 (_inLexique)) {
            case 2 : {
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_model_builder_2 (_inLexique)) {
        case 2 : {
...
void metamodel_model_builder::
metamodel_model_builder::
pr_component_importation_metamodel_model_builder_72_6_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      ...
      switch (select_repeat_metamodel_model_builder_3 (_inLexique)) {
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
          } break ;
        default :
...
GGS_metamodelEntity metamodel_model_builder::
metamodel_model_builder::
pr_entity_declaration_metamodel_model_builder_86_6_ (galgas_scanner & _inLexique) {
  ...
  switch (select_metamodel_model_builder_4 (_inLexique)) {
    case 1 : {
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
  switch (select_metamodel_model_builder_5 (_inLexique)) {
    case 1 : {
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
      switch (select_repeat_metamodel_model_builder_6 (_inLexique)) {
        case 2 : {
          GGS_lstring  var_cas_propertyTypeName ;
          _inLexique._assignFromAttribute_tokenString (var_cas_propertyTypeName) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_type_5Fname) COMMA_HERE) ;
          switch (select_metamodel_model_builder_7 (_inLexique)) {
            case 1 : {
...
GGS_metamodelAttribute metamodel_model_builder::
metamodel_model_builder::
pr_attribute_or_single_reference_declaration_metamodel_model_builder_123_6_ (galgas_scanner & _inLexique,
...
GGS_metamodelMultipleReference metamodel_model_builder::
metamodel_model_builder::
pr_multiple_reference_declaration_metamodel_model_builder_130_6_ (galgas_scanner & _inLexique,
                                const GGS_lstring  &var_cas_inPropertyTypeName) {
  GGS_lstring  var_cas_mAttributeTypeName ;
  GGS_lstring  var_cas_mAttributeName ;
  GGS_luint  var_cas_mLowerBound ;
  GGS_luint  var_cas_mUpperBound ;
  switch (select_metamodel_model_builder_8 (_inLexique)) {
    case 1 : {
      var_cas_mLowerBound = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 0U), GGS_location (_inLexique) COMMA_HERE) ;
      var_cas_mUpperBound = GGS_luint::constructor_new (_inLexique, GGS_uint (true, 0U), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    case 2 : {
      _inLexique._assignFromAttribute_uint32value (var_cas_mLowerBound) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
      switch (select_metamodel_model_builder_9 (_inLexique)) {
        case 1 : {
          var_cas_mUpperBound = var_cas_mLowerBound ;
          if (((var_cas_mLowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (138)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
            var_cas_mLowerBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "multiplicity should be greater than zero") COMMA_SOURCE_FILE_AT_LINE (140)) ;
            var_cas_mLowerBound._drop_operation () ;
            var_cas_mUpperBound._drop_operation () ;
          }
          } break ;
        case 2 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
          _inLexique._assignFromAttribute_uint32value (var_cas_mUpperBound) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
          if (((var_cas_mUpperBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (144)))._operator_strictInf (var_cas_mLowerBound.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (144)))).isBuiltAndTrue ()) {
            var_cas_mUpperBound.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "upper bound should be greater or equal to lower bound") COMMA_SOURCE_FILE_AT_LINE (146)) ;
            var_cas_mLowerBound._drop_operation () ;
            var_cas_mUpperBound._drop_operation () ;
          }
          } break ;
