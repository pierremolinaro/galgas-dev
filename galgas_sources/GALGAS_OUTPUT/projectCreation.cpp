...
void routine_performProjectCreation (C_Compiler & _inLexique,
  ...
  const GGS_string _temp_4785 = var_cas_common_files_for_make_DIR ;
  if (_temp_4785._isBuilt ()) {
    _temp_4785 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (68)) ;
  }
  const GGS_string _temp_4883 = _template_filewrapper_projectCreationFileWrapper_commonMakefileProject (var_cas_inProjectName) ;
  if (_temp_4883._isBuilt ()) {
    _temp_4883 (HERE)->method_writeToFile (_inLexique, (var_cas_common_files_for_make_DIR)._operator_concat (GGS_string (true, "/makefile.mke")) COMMA_SOURCE_FILE_AT_LINE (69)) ;
  }
  ...
  const GGS_string _temp_5051 = var_cas_galgas_sources_DIR ;
  if (_temp_5051._isBuilt ()) {
    _temp_5051 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (72)) ;
  }
  const GGS_string _temp_5135 = _template_filewrapper_projectCreationFileWrapper_all_ggs (var_cas_inProjectName) ;
  if (_temp_5135._isBuilt ()) {
    _temp_5135 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/_all_")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".ggs")) COMMA_SOURCE_FILE_AT_LINE (73)) ;
  }
  const GGS_string _temp_5276 = _template_filewrapper_projectCreationFileWrapper_PROJECT_cocoa (var_cas_inProjectName) ;
  if (_temp_5276._isBuilt ()) {
    _temp_5276 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_cocoa.ggs")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
  }
  const GGS_string _temp_5420 = _template_filewrapper_projectCreationFileWrapper_PROJECT_grammar (var_cas_inProjectName) ;
  if (_temp_5420._isBuilt ()) {
    _temp_5420 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_grammar.ggs")) COMMA_SOURCE_FILE_AT_LINE (75)) ;
  }
  const GGS_string _temp_5566 = _template_filewrapper_projectCreationFileWrapper_PROJECT_lexique (var_cas_inProjectName) ;
  if (_temp_5566._isBuilt ()) {
    _temp_5566 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_lexique.ggs")) COMMA_SOURCE_FILE_AT_LINE (76)) ;
  }
  const GGS_string _temp_5712 = _template_filewrapper_projectCreationFileWrapper_PROJECT_options (var_cas_inProjectName) ;
  if (_temp_5712._isBuilt ()) {
    _temp_5712 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_options.ggs")) COMMA_SOURCE_FILE_AT_LINE (77)) ;
  }
  const GGS_string _temp_5858 = _template_filewrapper_projectCreationFileWrapper_PROJECT_program (var_cas_inProjectName) ;
  if (_temp_5858._isBuilt ()) {
    _temp_5858 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_program.ggs")) COMMA_SOURCE_FILE_AT_LINE (78)) ;
  }
  const GGS_string _temp_6006 = _template_filewrapper_projectCreationFileWrapper_PROJECT_semantics (var_cas_inProjectName) ;
  if (_temp_6006._isBuilt ()) {
    _temp_6006 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_semantics.ggs")) COMMA_SOURCE_FILE_AT_LINE (79)) ;
  }
  const GGS_string _temp_6153 = _template_filewrapper_projectCreationFileWrapper_PROJECT_syntax (var_cas_inProjectName) ;
  if (_temp_6153._isBuilt ()) {
    _temp_6153 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_syntax.ggs")) COMMA_SOURCE_FILE_AT_LINE (80)) ;
  }
  const GGS_string _temp_6292 = _template_filewrapper_projectCreationFileWrapper_build_bat (var_cas_inProjectName) ;
  if (_temp_6292._isBuilt ()) {
    _temp_6292 (HERE)->method_writeToFile (_inLexique, (var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/build.bat")) COMMA_SOURCE_FILE_AT_LINE (81)) ;
  }
  ...
  const GGS_string _temp_6466 = var_cas_hand_coded_sources_DIR ;
  if (_temp_6466._isBuilt ()) {
    _temp_6466 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (84)) ;
  }
  const GGS_string _temp_6563 = _template_filewrapper_projectCreationFileWrapper_PROJECT_computations (var_cas_inProjectName) ;
  if (_temp_6563._isBuilt ()) {
    _temp_6563 (HERE)->method_writeToFile (_inLexique, (((var_cas_hand_coded_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_computations.cpp")) COMMA_SOURCE_FILE_AT_LINE (85)) ;
  }
  ...
  const GGS_string _temp_6756 = var_cas_makefile_macosx_DIR ;
  if (_temp_6756._isBuilt ()) {
    _temp_6756 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (88)) ;
  }
  const GGS_string _temp_6850 = GGS_string (gWrapperFileContent_0_projectCreationFileWrapper) ;
  if (_temp_6850._isBuilt ()) {
    _temp_6850 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (89)) ;
  }
  const GGS_string _temp_6991 = GGS_string (gWrapperFileContent_2_projectCreationFileWrapper) ;
  if (_temp_6991._isBuilt ()) {
    _temp_6991 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (90)) ;
  }
  const GGS_string _temp_7134 = GGS_string (gWrapperFileContent_1_projectCreationFileWrapper) ;
  if (_temp_7134._isBuilt ()) {
    _temp_7134 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (91)) ;
  }
  const GGS_string _temp_7279 = GGS_string (gWrapperFileContent_3_projectCreationFileWrapper) ;
  if (_temp_7279._isBuilt ()) {
    _temp_7279 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (92)) ;
  }
  const GGS_string _temp_7429 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_7429._isBuilt ()) {
    _temp_7429 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (93)) ;
  }
  const GGS_string _temp_7564 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile64 (var_cas_inProjectName) ;
  if (_temp_7564._isBuilt ()) {
    _temp_7564 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (94)) ;
  }
  ...
  const GGS_string _temp_7744 = var_cas_makefile_macosx_ppc_DIR ;
  if (_temp_7744._isBuilt ()) {
    _temp_7744 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (97)) ;
  }
  const GGS_string _temp_7842 = GGS_string (gWrapperFileContent_8_projectCreationFileWrapper) ;
  if (_temp_7842._isBuilt ()) {
    _temp_7842 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (98)) ;
  }
  const GGS_string _temp_7991 = GGS_string (gWrapperFileContent_10_projectCreationFileWrapper) ;
  if (_temp_7991._isBuilt ()) {
    _temp_7991 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (99)) ;
  }
  const GGS_string _temp_8142 = GGS_string (gWrapperFileContent_9_projectCreationFileWrapper) ;
  if (_temp_8142._isBuilt ()) {
    _temp_8142 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (100)) ;
  }
  const GGS_string _temp_8295 = GGS_string (gWrapperFileContent_11_projectCreationFileWrapper) ;
  if (_temp_8295._isBuilt ()) {
    _temp_8295 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (101)) ;
  }
  const GGS_string _temp_8453 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_ppc_makefile (var_cas_inProjectName) ;
  if (_temp_8453._isBuilt ()) {
    _temp_8453 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (102)) ;
  }
  const GGS_string _temp_8596 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_ppc_makefile64 (var_cas_inProjectName) ;
  if (_temp_8596._isBuilt ()) {
    _temp_8596 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (103)) ;
  }
  ...
  const GGS_string _temp_8784 = var_cas_makefile_macosx_i386_DIR ;
  if (_temp_8784._isBuilt ()) {
    _temp_8784 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (106)) ;
  }
  const GGS_string _temp_8883 = GGS_string (gWrapperFileContent_4_projectCreationFileWrapper) ;
  if (_temp_8883._isBuilt ()) {
    _temp_8883 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (107)) ;
  }
  const GGS_string _temp_9034 = GGS_string (gWrapperFileContent_6_projectCreationFileWrapper) ;
  if (_temp_9034._isBuilt ()) {
    _temp_9034 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (108)) ;
  }
  const GGS_string _temp_9187 = GGS_string (gWrapperFileContent_5_projectCreationFileWrapper) ;
  if (_temp_9187._isBuilt ()) {
    _temp_9187 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (109)) ;
  }
  const GGS_string _temp_9342 = GGS_string (gWrapperFileContent_7_projectCreationFileWrapper) ;
  if (_temp_9342._isBuilt ()) {
    _temp_9342 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (110)) ;
  }
  const GGS_string _temp_9502 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_i386_makefile (var_cas_inProjectName) ;
  if (_temp_9502._isBuilt ()) {
    _temp_9502 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (111)) ;
  }
  const GGS_string _temp_9647 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_i386_makefile64 (var_cas_inProjectName) ;
  if (_temp_9647._isBuilt ()) {
    _temp_9647 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (112)) ;
  }
  ...
  const GGS_string _temp_9856 = var_cas_makefile_macosx_universal_DIR ;
  if (_temp_9856._isBuilt ()) {
    _temp_9856 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (115)) ;
  }
  const GGS_string _temp_9960 = GGS_string (gWrapperFileContent_12_projectCreationFileWrapper) ;
  if (_temp_9960._isBuilt ()) {
    _temp_9960 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (116)) ;
  }
  const GGS_string _temp_10122 = GGS_string (gWrapperFileContent_14_projectCreationFileWrapper) ;
  if (_temp_10122._isBuilt ()) {
    _temp_10122 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (117)) ;
  }
  const GGS_string _temp_10286 = GGS_string (gWrapperFileContent_13_projectCreationFileWrapper) ;
  if (_temp_10286._isBuilt ()) {
    _temp_10286 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (118)) ;
  }
  const GGS_string _temp_10451 = GGS_string (gWrapperFileContent_15_projectCreationFileWrapper) ;
  if (_temp_10451._isBuilt ()) {
    _temp_10451 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (119)) ;
  }
  const GGS_string _temp_10622 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_universal_makefile (var_cas_inProjectName) ;
  if (_temp_10622._isBuilt ()) {
    _temp_10622 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (120)) ;
  }
  const GGS_string _temp_10778 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_universal_makefile64 (var_cas_inProjectName) ;
  if (_temp_10778._isBuilt ()) {
    _temp_10778 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (121)) ;
  }
  ...
  const GGS_string _temp_10989 = var_cas_makefile_mingw_on_macosx_DIR ;
  if (_temp_10989._isBuilt ()) {
    _temp_10989 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (124)) ;
  }
  const GGS_string _temp_11092 = GGS_string (gWrapperFileContent_16_projectCreationFileWrapper) ;
  if (_temp_11092._isBuilt ()) {
    _temp_11092 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (125)) ;
  }
  const GGS_string _temp_11251 = GGS_string (gWrapperFileContent_17_projectCreationFileWrapper) ;
  if (_temp_11251._isBuilt ()) {
    _temp_11251 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (126)) ;
  }
  const GGS_string _temp_11417 = _template_filewrapper_projectCreationFileWrapper_makefile_mingw_on_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_11417._isBuilt ()) {
    _temp_11417 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (127)) ;
  }
  ...
  const GGS_string _temp_11618 = var_cas_makefile_mingw_on_win32_DIR ;
  if (_temp_11618._isBuilt ()) {
    _temp_11618 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
  }
  const GGS_string _temp_11715 = GGS_string (gWrapperFileContent_18_projectCreationFileWrapper) ;
  if (_temp_11715._isBuilt ()) {
    _temp_11715 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/build.bat")) COMMA_SOURCE_FILE_AT_LINE (131)) ;
  }
  const GGS_string _temp_11853 = GGS_string (gWrapperFileContent_19_projectCreationFileWrapper) ;
  if (_temp_11853._isBuilt ()) {
    _temp_11853 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/clean.bat")) COMMA_SOURCE_FILE_AT_LINE (132)) ;
  }
  const GGS_string _temp_11993 = GGS_string (gWrapperFileContent_20_projectCreationFileWrapper) ;
  if (_temp_11993._isBuilt ()) {
    _temp_11993 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/install.bat")) COMMA_SOURCE_FILE_AT_LINE (133)) ;
  }
  const GGS_string _temp_12144 = _template_filewrapper_projectCreationFileWrapper_makefile_msys_on_win32_makefile (var_cas_inProjectName) ;
  if (_temp_12144._isBuilt ()) {
    _temp_12144 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/makefile.mke")) COMMA_SOURCE_FILE_AT_LINE (134)) ;
  }
  ...
  const GGS_string _temp_12310 = var_cas_makefile_unix_DIR ;
  if (_temp_12310._isBuilt ()) {
    _temp_12310 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
  }
  const GGS_string _temp_12409 = _template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile (var_cas_inProjectName) ;
  if (_temp_12409._isBuilt ()) {
    _temp_12409 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (138)) ;
  }
  const GGS_string _temp_12540 = _template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile64 (var_cas_inProjectName) ;
  if (_temp_12540._isBuilt ()) {
    _temp_12540 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (139)) ;
  }
  ...
  const GGS_string _temp_12754 = var_cas_makefile_x86linux_on_macosx_DIR ;
  if (_temp_12754._isBuilt ()) {
    _temp_12754 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (142)) ;
  }
  const GGS_string _temp_12860 = GGS_string (gWrapperFileContent_21_projectCreationFileWrapper) ;
  if (_temp_12860._isBuilt ()) {
    _temp_12860 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (143)) ;
  }
  const GGS_string _temp_13026 = GGS_string (gWrapperFileContent_22_projectCreationFileWrapper) ;
  if (_temp_13026._isBuilt ()) {
    _temp_13026 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (144)) ;
  }
  const GGS_string _temp_13199 = _template_filewrapper_projectCreationFileWrapper_makefile_x86linux_on_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_13199._isBuilt ()) {
    _temp_13199 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (145)) ;
  }
  ...
  const GGS_string _temp_13397 = (((var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".xcodeproj")) ;
  if (_temp_13397._isBuilt ()) {
    _temp_13397 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (148)) ;
  }
  const GGS_string _temp_13486 = _template_filewrapper_projectCreationFileWrapper_xcodeProject (var_cas_inProjectName) ;
  if (_temp_13486._isBuilt ()) {
    _temp_13486 (HERE)->method_writeToFile (_inLexique, (((var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".xcodeproj/project.pbxproj")) COMMA_SOURCE_FILE_AT_LINE (149)) ;
  }
  const GGS_string _temp_13640 = _template_filewrapper_projectCreationFileWrapper_info_plist (var_cas_inProjectName) ;
  if (_temp_13640._isBuilt ()) {
    _temp_13640 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/Info.plist")) COMMA_SOURCE_FILE_AT_LINE (150)) ;
  }
  const GGS_string _temp_13756 = GGS_string (gWrapperFileContent_23_projectCreationFileWrapper) ;
  if (_temp_13756._isBuilt ()) {
    _temp_13756 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/main.m")) COMMA_SOURCE_FILE_AT_LINE (151)) ;
  }
  const GGS_string _temp_13838 = (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj")) ;
  if (_temp_13838._isBuilt ()) {
    _temp_13838 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (152)) ;
  }
  const GGS_string _temp_13942 = GGS_string (gWrapperFileContent_24_projectCreationFileWrapper) ;
  if (_temp_13942._isBuilt ()) {
    _temp_13942 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/Credits.rtf")) COMMA_SOURCE_FILE_AT_LINE (153)) ;
  }
  const GGS_string _temp_14098 = GGS_string (gWrapperFileContent_25_projectCreationFileWrapper) ;
  if (_temp_14098._isBuilt ()) {
    _temp_14098 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/InfoPlist.strings")) COMMA_SOURCE_FILE_AT_LINE (154)) ;
  }
...
void routine_projectCreation (C_Compiler & _inLexique,
  ...
  if (((var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (164)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_uint _variant_14854 = var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (169)) ;
    GGS_bool _condition_14854 (_variant_14854._isBuilt (), true) ;
    while (_condition_14854.isBuiltAndTrue ()) {
      _condition_14854 = ((var_cas_index)._operator_strictInf (var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (170))))._operator_and (var_cas_ok) ;
