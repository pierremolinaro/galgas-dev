...
GALGAS_string filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_computations (C_Compiler * inCompiler,
  ...
  result << "//-----------------------------------------------------------------------------*\n"
    "//                                                                             *\n"
    "//" ;
  result << in_PROJECT_5F_NAME.add_operation (GALGAS_string (" Project"), inCompiler COMMA_SOURCE_FILE_AT_LINE (3)).reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE_AT_LINE (3)).stringValue () ;
  result << "*\n"
