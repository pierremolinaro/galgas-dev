...
const char * gWrapperFileContent_0_projectCreationFileWrapper = // 71 bytes
  "3533479810511047115104\n"
  "99100329610010511411097109101323648963238383211610510910132109971071013245451199711411045117110100101102105110101100451189711410597981081011153297108108\n"
;
...
const char * gWrapperFileContent_1_projectCreationFileWrapper = // 85 bytes
  "3533479810511047115104\n"
  "99100329610010511411097109101323648963238383211610510910132109971071013245451199711411045117110100101102105110101100451189711410597981081011153245102321099710710110210510810154523297108108\n"
;
...
const char * gWrapperFileContent_2_projectCreationFileWrapper = // 73 bytes
  "3533479810511047115104\n"
  "9910032961001051141109710910132364896323838321161051091013210997107101324545119971141104511711010010110210511010110045118971141059798108101115329910810197110\n"
;
...
const char * gWrapperFileContent_3_projectCreationFileWrapper = // 87 bytes
  "3533479810511047115104\n"
  "9910032961001051141109710910132364896323838321161051091013210997107101324545119971141104511711010010110210511010110045118971141059798108101115324510232109971071011021051081015452329910810197110\n"
;
...
const char * gWrapperFileContent_18_projectCreationFileWrapper = // 88 bytes
  "80658472616758\\109115121115\\494648\\98105110596758\\771051107187\\9810511059378065847237\n"
  "11510432459932\"10997107101324545119971141104511711010010110210511010110045118971141059798108101115\"\n"
  "11297117115101\n"
;
...
const char * gWrapperFileContent_19_projectCreationFileWrapper = // 94 bytes
  "80658472616758\\109115121115\\494648\\98105110596758\\771051107187\\9810511059378065847237\n"
  "11510432459932\"10997107101329910810197110324545119971141104511711010010110210511010110045118971141059798108101115\"\n"
  "11297117115101\n"
;
...
const char * gWrapperFileContent_20_projectCreationFileWrapper = // 96 bytes
  "80658472616758\\109115121115\\494648\\98105110596758\\771051107187\\9810511059378065847237\n"
  "11510432459932\"109971071013210511011511697108108324545119971141104511711010010110210511010110045118971141059798108101115\"\n"
  "11297117115101\n"
;
...
const char * gWrapperFileContent_23_projectCreationFileWrapper = // 311 bytes
  "123\\11411610249\\1099799\\97110115105991121034948484848\\991119911197114116102565052\\99111991119711511798114116102515648\n"
  "123\\10211111011611698108\\10248\\102115119105115115\\1029910497114115101116555532721011081181011161059997456611110810059125\n"
  "123\\991111081111141169810859\\114101100505353\\103114101101110505353\\9810811710150535359125\n"
  "\\11810510111911957484848\\11810510111910456524848\\11810510111910710511010048\n"
  "\\11297114100\\116120535448\\11612049495048\\11612049545648\\11612050505248\\11612050564848\\11612051515448\\11612051575048\\11612052525648\\11612053485248\\11612053544848\\11612054495448\\11612054555048\\113108\\1131109711611711497108\n"
  "\n"
  "\\10248\\98\\102115505232\\99102483271657671658332671119911197328011411110610199116\\\n"
  "125\n"
;
...
const char * gWrapperFileContent_24_projectCreationFileWrapper = // 308 bytes
  "474232761119997108105122101100321181011141151051111101153211110232731101021114611210810511511632107101121115324247\n"
  "6770661171101001081017897109101326132\"9911199111973780827974696784957865776937\"59\n"
  "677066117110100108101831041111141168610111411510511111083116114105110103326132\"4946484648\"59\n"
  "677066117110100108101711011167311010211183116114105110103326132\"671119911197323780827974696784957865776937321181011141151051111103249464846484432671111121211141051031041163295957712167111109112971101217897109101959546\"59\n"
  "788372117109971108210197100979810810167111112121114105103104116326132\"671111121211141051031041163295957712167111109112971101217897109101959546\"59\n"
  "7683771051101051091171098312111511610110986101114115105111110326132\"494846514657\"59\n"
  "\n"
;
...
//---------------------------------------------------------------------------*
//                                                                           *
//           Implementation of routine "performProjectCreation34             *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_performProjectCreation (C_Compiler & _inLexique,
  ...
  if (_temp_4695._isBuilt ()) {
    _temp_4695 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (67)) ;
  }
  const GGS_string _temp_4777 = _template_filewrapper_projectCreationFileWrapper_all_ggs (var_cas_inProjectName) ;
  if (_temp_4777._isBuilt ()) {
    _temp_4777 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/all_")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".ggs")) COMMA_SOURCE_FILE_AT_LINE (68)) ;
  }
  const GGS_string _temp_4917 = _template_filewrapper_projectCreationFileWrapper_PROJECT_cocoa (var_cas_inProjectName) ;
  if (_temp_4917._isBuilt ()) {
    _temp_4917 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_cocoa.ggs")) COMMA_SOURCE_FILE_AT_LINE (69)) ;
  }
  const GGS_string _temp_5061 = _template_filewrapper_projectCreationFileWrapper_PROJECT_grammar (var_cas_inProjectName) ;
  if (_temp_5061._isBuilt ()) {
    _temp_5061 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_grammar.ggs")) COMMA_SOURCE_FILE_AT_LINE (70)) ;
  }
  const GGS_string _temp_5207 = _template_filewrapper_projectCreationFileWrapper_PROJECT_lexique (var_cas_inProjectName) ;
  if (_temp_5207._isBuilt ()) {
    _temp_5207 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_lexique.ggs")) COMMA_SOURCE_FILE_AT_LINE (71)) ;
  }
  const GGS_string _temp_5353 = _template_filewrapper_projectCreationFileWrapper_PROJECT_options (var_cas_inProjectName) ;
  if (_temp_5353._isBuilt ()) {
    _temp_5353 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_options.ggs")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
  }
  const GGS_string _temp_5499 = _template_filewrapper_projectCreationFileWrapper_PROJECT_program (var_cas_inProjectName) ;
  if (_temp_5499._isBuilt ()) {
    _temp_5499 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_program.ggs")) COMMA_SOURCE_FILE_AT_LINE (73)) ;
  }
  const GGS_string _temp_5647 = _template_filewrapper_projectCreationFileWrapper_PROJECT_semantics (var_cas_inProjectName) ;
  if (_temp_5647._isBuilt ()) {
    _temp_5647 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_semantics.ggs")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
  }
  const GGS_string _temp_5794 = _template_filewrapper_projectCreationFileWrapper_PROJECT_syntax (var_cas_inProjectName) ;
  if (_temp_5794._isBuilt ()) {
    _temp_5794 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_syntax.ggs")) COMMA_SOURCE_FILE_AT_LINE (75)) ;
  }
  const GGS_string _temp_5933 = _template_filewrapper_projectCreationFileWrapper_build_bat (var_cas_inProjectName) ;
  if (_temp_5933._isBuilt ()) {
    _temp_5933 (HERE)->method_writeToFile (_inLexique, (var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/build.bat")) COMMA_SOURCE_FILE_AT_LINE (76)) ;
  }
  ...
  if (_temp_6109._isBuilt ()) {
    _temp_6109 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (79)) ;
  }
  ...
  if (_temp_6204._isBuilt ()) {
    _temp_6204 (HERE)->method_writeToFile (_inLexique, (((var_cas_hand_coded_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_computations.cpp")) COMMA_SOURCE_FILE_AT_LINE (80)) ;
  }
  ...
  if (_temp_6399._isBuilt ()) {
    _temp_6399 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
  }
  const GGS_string _temp_6501 = GGS_string (gWrapperFileContent_0_projectCreationFileWrapper) ;
  if (_temp_6501._isBuilt ()) {
    _temp_6501 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (84)) ;
  }
  const GGS_string _temp_6642 = GGS_string (gWrapperFileContent_2_projectCreationFileWrapper) ;
  if (_temp_6642._isBuilt ()) {
    _temp_6642 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (85)) ;
  }
  const GGS_string _temp_6785 = GGS_string (gWrapperFileContent_1_projectCreationFileWrapper) ;
  if (_temp_6785._isBuilt ()) {
    _temp_6785 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (86)) ;
  }
  const GGS_string _temp_6930 = GGS_string (gWrapperFileContent_3_projectCreationFileWrapper) ;
  if (_temp_6930._isBuilt ()) {
    _temp_6930 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (87)) ;
  }
  ...
  if (_temp_7070._isBuilt ()) {
    _temp_7070 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (88)) ;
  }
  ...
  if (_temp_7205._isBuilt ()) {
    _temp_7205 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (89)) ;
  }
  ...
  if (_temp_7387._isBuilt ()) {
    _temp_7387 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (92)) ;
  }
  const GGS_string _temp_7493 = GGS_string (gWrapperFileContent_8_projectCreationFileWrapper) ;
  if (_temp_7493._isBuilt ()) {
    _temp_7493 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (93)) ;
  }
  const GGS_string _temp_7642 = GGS_string (gWrapperFileContent_10_projectCreationFileWrapper) ;
  if (_temp_7642._isBuilt ()) {
    _temp_7642 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (94)) ;
  }
  const GGS_string _temp_7793 = GGS_string (gWrapperFileContent_9_projectCreationFileWrapper) ;
  if (_temp_7793._isBuilt ()) {
    _temp_7793 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (95)) ;
  }
  const GGS_string _temp_7946 = GGS_string (gWrapperFileContent_11_projectCreationFileWrapper) ;
  if (_temp_7946._isBuilt ()) {
    _temp_7946 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (96)) ;
  }
  ...
  if (_temp_8094._isBuilt ()) {
    _temp_8094 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (97)) ;
  }
  ...
  if (_temp_8237._isBuilt ()) {
    _temp_8237 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (98)) ;
  }
  ...
  if (_temp_8427._isBuilt ()) {
    _temp_8427 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (101)) ;
  }
  const GGS_string _temp_8534 = GGS_string (gWrapperFileContent_4_projectCreationFileWrapper) ;
  if (_temp_8534._isBuilt ()) {
    _temp_8534 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (102)) ;
  }
  const GGS_string _temp_8685 = GGS_string (gWrapperFileContent_6_projectCreationFileWrapper) ;
  if (_temp_8685._isBuilt ()) {
    _temp_8685 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (103)) ;
  }
  const GGS_string _temp_8838 = GGS_string (gWrapperFileContent_5_projectCreationFileWrapper) ;
  if (_temp_8838._isBuilt ()) {
    _temp_8838 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (104)) ;
  }
  const GGS_string _temp_8993 = GGS_string (gWrapperFileContent_7_projectCreationFileWrapper) ;
  if (_temp_8993._isBuilt ()) {
    _temp_8993 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (105)) ;
  }
  ...
  if (_temp_9143._isBuilt ()) {
    _temp_9143 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (106)) ;
  }
  ...
  if (_temp_9288._isBuilt ()) {
    _temp_9288 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (107)) ;
  }
  ...
  if (_temp_9499._isBuilt ()) {
    _temp_9499 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (110)) ;
  }
  const GGS_string _temp_9611 = GGS_string (gWrapperFileContent_12_projectCreationFileWrapper) ;
  if (_temp_9611._isBuilt ()) {
    _temp_9611 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (111)) ;
  }
  const GGS_string _temp_9773 = GGS_string (gWrapperFileContent_14_projectCreationFileWrapper) ;
  if (_temp_9773._isBuilt ()) {
    _temp_9773 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (112)) ;
  }
  const GGS_string _temp_9937 = GGS_string (gWrapperFileContent_13_projectCreationFileWrapper) ;
  if (_temp_9937._isBuilt ()) {
    _temp_9937 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (113)) ;
  }
  const GGS_string _temp_10102 = GGS_string (gWrapperFileContent_15_projectCreationFileWrapper) ;
  if (_temp_10102._isBuilt ()) {
    _temp_10102 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (114)) ;
  }
  ...
  if (_temp_10263._isBuilt ()) {
    _temp_10263 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (115)) ;
  }
  ...
  if (_temp_10419._isBuilt ()) {
    _temp_10419 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (116)) ;
  }
  ...
  if (_temp_10632._isBuilt ()) {
    _temp_10632 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (119)) ;
  }
  const GGS_string _temp_10743 = GGS_string (gWrapperFileContent_16_projectCreationFileWrapper) ;
  if (_temp_10743._isBuilt ()) {
    _temp_10743 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (120)) ;
  }
  const GGS_string _temp_10902 = GGS_string (gWrapperFileContent_17_projectCreationFileWrapper) ;
  if (_temp_10902._isBuilt ()) {
    _temp_10902 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (121)) ;
  }
  ...
  if (_temp_11058._isBuilt ()) {
    _temp_11058 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (122)) ;
  }
  ...
  if (_temp_11261._isBuilt ()) {
    _temp_11261 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
  }
  const GGS_string _temp_11356 = GGS_string (gWrapperFileContent_18_projectCreationFileWrapper) ;
  if (_temp_11356._isBuilt ()) {
    _temp_11356 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/build.bat")) COMMA_SOURCE_FILE_AT_LINE (126)) ;
  }
  const GGS_string _temp_11494 = GGS_string (gWrapperFileContent_19_projectCreationFileWrapper) ;
  if (_temp_11494._isBuilt ()) {
    _temp_11494 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/clean.bat")) COMMA_SOURCE_FILE_AT_LINE (127)) ;
  }
  const GGS_string _temp_11634 = GGS_string (gWrapperFileContent_20_projectCreationFileWrapper) ;
  if (_temp_11634._isBuilt ()) {
    _temp_11634 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/install.bat")) COMMA_SOURCE_FILE_AT_LINE (128)) ;
  }
  ...
  if (_temp_11785._isBuilt ()) {
    _temp_11785 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (129)) ;
  }
  ...
  if (_temp_11949._isBuilt ()) {
    _temp_11949 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
  }
  ...
  if (_temp_12046._isBuilt ()) {
    _temp_12046 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (133)) ;
  }
  ...
  if (_temp_12177._isBuilt ()) {
    _temp_12177 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (134)) ;
  }
  ...
  if (_temp_12393._isBuilt ()) {
    _temp_12393 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
  }
  const GGS_string _temp_12507 = GGS_string (gWrapperFileContent_21_projectCreationFileWrapper) ;
  if (_temp_12507._isBuilt ()) {
    _temp_12507 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (138)) ;
  }
  const GGS_string _temp_12673 = GGS_string (gWrapperFileContent_22_projectCreationFileWrapper) ;
  if (_temp_12673._isBuilt ()) {
    _temp_12673 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (139)) ;
  }
  ...
  if (_temp_12836._isBuilt ()) {
    _temp_12836 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (140)) ;
  }
  ...
  const GGS_string _temp_13036 = (((var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".xcodeproj")) ;
  if (_temp_13036._isBuilt ()) {
    _temp_13036 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
  }
  const GGS_string _temp_13121 = _template_filewrapper_projectCreationFileWrapper_info_plist (var_cas_inProjectName) ;
  if (_temp_13121._isBuilt ()) {
    _temp_13121 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/Info.plist")) COMMA_SOURCE_FILE_AT_LINE (144)) ;
  }
  const GGS_string _temp_13209 = (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj")) ;
  if (_temp_13209._isBuilt ()) {
    _temp_13209 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (145)) ;
  }
  const GGS_string _temp_13311 = GGS_string (gWrapperFileContent_23_projectCreationFileWrapper) ;
  if (_temp_13311._isBuilt ()) {
    _temp_13311 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/Credits.rtf")) COMMA_SOURCE_FILE_AT_LINE (146)) ;
  }
  ...
  if (_temp_13457._isBuilt ()) {
    _temp_13457 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/InfoPlist.strings")) COMMA_SOURCE_FILE_AT_LINE (147)) ;
  }
...
//---------------------------------------------------------------------------*
//                                                                           *
//               Implementation of routine "projectCreation34                *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_projectCreation (C_Compiler & _inLexique,
  ...
  if (((var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (157)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_uint _variant_14209 = var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)) ;
    GGS_bool _condition_14209 (_variant_14209._isBuilt (), true) ;
    while (_condition_14209.isBuiltAndTrue ()) {
      _condition_14209 = ((var_cas_index)._operator_strictInf (var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (163))))._operator_and (var_cas_ok) ;
      if (_condition_14209.isBuiltAndTrue ()) {
        if (_variant_14209.uintValue () == 0) {
          ...
          _condition_14209 = GGS_bool (true, false) ;
        }else{
