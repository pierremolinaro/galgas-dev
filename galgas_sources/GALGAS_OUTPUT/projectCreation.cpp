...
void routine_performProjectCreation (C_Compiler & inLexique,
  ...
  const GGS_string temp_4628 = var_cas_galgas_sources_DIR ;
  if (temp_4628.isBuilt ()) {
    temp_4628 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (65)) ;
  }
  const GGS_string temp_4718 = template_filewrapper_projectCreationFileWrapper_PROJECT_project (inLexique, var_cas_inProjectName) ;
  if (temp_4718.isBuilt ()) {
    temp_4718 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/all_"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string (".gProject")) COMMA_SOURCE_FILE_AT_LINE (66)) ;
  }
  const GGS_string temp_4863 = template_filewrapper_projectCreationFileWrapper_PROJECT_cocoa (inLexique, var_cas_inProjectName) ;
  if (temp_4863.isBuilt ()) {
    temp_4863 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_cocoa.gGui")) COMMA_SOURCE_FILE_AT_LINE (67)) ;
  }
  const GGS_string temp_5008 = template_filewrapper_projectCreationFileWrapper_PROJECT_grammar (inLexique, var_cas_inProjectName) ;
  if (temp_5008.isBuilt ()) {
    temp_5008 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_grammar.gGrammar")) COMMA_SOURCE_FILE_AT_LINE (68)) ;
  }
  const GGS_string temp_5159 = template_filewrapper_projectCreationFileWrapper_PROJECT_lexique (inLexique, var_cas_inProjectName) ;
  if (temp_5159.isBuilt ()) {
    temp_5159 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_lexique.gLexique")) COMMA_SOURCE_FILE_AT_LINE (69)) ;
  }
  const GGS_string temp_5310 = template_filewrapper_projectCreationFileWrapper_PROJECT_options (inLexique, var_cas_inProjectName) ;
  if (temp_5310.isBuilt ()) {
    temp_5310 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_options.gOption")) COMMA_SOURCE_FILE_AT_LINE (70)) ;
  }
  const GGS_string temp_5460 = template_filewrapper_projectCreationFileWrapper_PROJECT_program (inLexique, var_cas_inProjectName) ;
  if (temp_5460.isBuilt ()) {
    temp_5460 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_program.gProgram")) COMMA_SOURCE_FILE_AT_LINE (71)) ;
  }
  const GGS_string temp_5613 = template_filewrapper_projectCreationFileWrapper_PROJECT_semantics (inLexique, var_cas_inProjectName) ;
  if (temp_5613.isBuilt ()) {
    temp_5613 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_semantics.gSemantics")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
  }
  const GGS_string temp_5767 = template_filewrapper_projectCreationFileWrapper_PROJECT_syntax (inLexique, var_cas_inProjectName) ;
  if (temp_5767.isBuilt ()) {
    temp_5767 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_syntax.gSyntax")) COMMA_SOURCE_FILE_AT_LINE (73)) ;
  }
  const GGS_string temp_5910 = template_filewrapper_projectCreationFileWrapper_build_bat (inLexique, var_cas_inProjectName) ;
  if (temp_5910.isBuilt ()) {
    temp_5910 (HERE)->method_writeToFile (inLexique, (var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/build.bat")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
  }
  GGS_string var_cas_hand_coded_sources_DIR = (var_cas_inProjectName).operator_concat (GGS_string ("/hand_coded_sources")) ;
  const GGS_string temp_6086 = var_cas_hand_coded_sources_DIR ;
  if (temp_6086.isBuilt ()) {
    temp_6086 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (77)) ;
  }
  const GGS_string temp_6181 = template_filewrapper_projectCreationFileWrapper_PROJECT_computations (inLexique, var_cas_inProjectName) ;
  if (temp_6181.isBuilt ()) {
    temp_6181 (HERE)->method_writeToFile (inLexique, (((var_cas_hand_coded_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_computations.cpp")) COMMA_SOURCE_FILE_AT_LINE (78)) ;
  }
  GGS_string var_cas_makefile_macosx_DIR = (var_cas_inProjectName).operator_concat (GGS_string ("/makefile_macosx")) ;
  const GGS_string temp_6376 = var_cas_makefile_macosx_DIR ;
  if (temp_6376.isBuilt ()) {
    temp_6376 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (81)) ;
  }
  const GGS_string temp_6478 = GGS_string (gWrapperFileContent_0_projectCreationFileWrapper) ;
  if (temp_6478.isBuilt ()) {
    temp_6478 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_DIR).operator_concat (GGS_string ("/build.command")) COMMA_SOURCE_FILE_AT_LINE (82)) ;
  }
  const GGS_string temp_6619 = GGS_string (gWrapperFileContent_2_projectCreationFileWrapper) ;
  if (temp_6619.isBuilt ()) {
    temp_6619 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_DIR).operator_concat (GGS_string ("/clean.command")) COMMA_SOURCE_FILE_AT_LINE (83)) ;
  }
  const GGS_string temp_6762 = GGS_string (gWrapperFileContent_1_projectCreationFileWrapper) ;
  if (temp_6762.isBuilt ()) {
    temp_6762 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_DIR).operator_concat (GGS_string ("/build64.command")) COMMA_SOURCE_FILE_AT_LINE (84)) ;
  }
  const GGS_string temp_6907 = GGS_string (gWrapperFileContent_3_projectCreationFileWrapper) ;
  if (temp_6907.isBuilt ()) {
    temp_6907 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_DIR).operator_concat (GGS_string ("/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (85)) ;
  }
  const GGS_string temp_7047 = template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_7047.isBuilt ()) {
    temp_7047 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (86)) ;
  }
  const GGS_string temp_7182 = template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile64 (inLexique, var_cas_inProjectName) ;
  if (temp_7182.isBuilt ()) {
    temp_7182 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_DIR).operator_concat (GGS_string ("/makefile64")) COMMA_SOURCE_FILE_AT_LINE (87)) ;
  }
  GGS_string var_cas_makefile_macosx_ppc_DIR = (var_cas_inProjectName).operator_concat (GGS_string ("/makefile_macosx_ppc")) ;
  const GGS_string temp_7364 = var_cas_makefile_macosx_ppc_DIR ;
  if (temp_7364.isBuilt ()) {
    temp_7364 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (90)) ;
  }
  const GGS_string temp_7470 = GGS_string (gWrapperFileContent_8_projectCreationFileWrapper) ;
  if (temp_7470.isBuilt ()) {
    temp_7470 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_ppc_DIR).operator_concat (GGS_string ("/build.command")) COMMA_SOURCE_FILE_AT_LINE (91)) ;
  }
  const GGS_string temp_7619 = GGS_string (gWrapperFileContent_10_projectCreationFileWrapper) ;
  if (temp_7619.isBuilt ()) {
    temp_7619 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_ppc_DIR).operator_concat (GGS_string ("/clean.command")) COMMA_SOURCE_FILE_AT_LINE (92)) ;
  }
  const GGS_string temp_7770 = GGS_string (gWrapperFileContent_9_projectCreationFileWrapper) ;
  if (temp_7770.isBuilt ()) {
    temp_7770 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_ppc_DIR).operator_concat (GGS_string ("/build64.command")) COMMA_SOURCE_FILE_AT_LINE (93)) ;
  }
  const GGS_string temp_7923 = GGS_string (gWrapperFileContent_11_projectCreationFileWrapper) ;
  if (temp_7923.isBuilt ()) {
    temp_7923 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_ppc_DIR).operator_concat (GGS_string ("/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (94)) ;
  }
  const GGS_string temp_8071 = template_filewrapper_projectCreationFileWrapper_makefile_macosx_ppc_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_8071.isBuilt ()) {
    temp_8071 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_ppc_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (95)) ;
  }
  const GGS_string temp_8214 = template_filewrapper_projectCreationFileWrapper_makefile_macosx_ppc_makefile64 (inLexique, var_cas_inProjectName) ;
  if (temp_8214.isBuilt ()) {
    temp_8214 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_ppc_DIR).operator_concat (GGS_string ("/makefile64")) COMMA_SOURCE_FILE_AT_LINE (96)) ;
  }
  GGS_string var_cas_makefile_macosx_i386_DIR = (var_cas_inProjectName).operator_concat (GGS_string ("/makefile_macosx_i386")) ;
  const GGS_string temp_8404 = var_cas_makefile_macosx_i386_DIR ;
  if (temp_8404.isBuilt ()) {
    temp_8404 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (99)) ;
  }
  const GGS_string temp_8511 = GGS_string (gWrapperFileContent_4_projectCreationFileWrapper) ;
  if (temp_8511.isBuilt ()) {
    temp_8511 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_i386_DIR).operator_concat (GGS_string ("/build.command")) COMMA_SOURCE_FILE_AT_LINE (100)) ;
  }
  const GGS_string temp_8662 = GGS_string (gWrapperFileContent_6_projectCreationFileWrapper) ;
  if (temp_8662.isBuilt ()) {
    temp_8662 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_i386_DIR).operator_concat (GGS_string ("/clean.command")) COMMA_SOURCE_FILE_AT_LINE (101)) ;
  }
  const GGS_string temp_8815 = GGS_string (gWrapperFileContent_5_projectCreationFileWrapper) ;
  if (temp_8815.isBuilt ()) {
    temp_8815 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_i386_DIR).operator_concat (GGS_string ("/build64.command")) COMMA_SOURCE_FILE_AT_LINE (102)) ;
  }
  const GGS_string temp_8970 = GGS_string (gWrapperFileContent_7_projectCreationFileWrapper) ;
  if (temp_8970.isBuilt ()) {
    temp_8970 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_i386_DIR).operator_concat (GGS_string ("/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (103)) ;
  }
  const GGS_string temp_9120 = template_filewrapper_projectCreationFileWrapper_makefile_macosx_i386_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_9120.isBuilt ()) {
    temp_9120 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_i386_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (104)) ;
  }
  const GGS_string temp_9265 = template_filewrapper_projectCreationFileWrapper_makefile_macosx_i386_makefile64 (inLexique, var_cas_inProjectName) ;
  if (temp_9265.isBuilt ()) {
    temp_9265 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_i386_DIR).operator_concat (GGS_string ("/makefile64")) COMMA_SOURCE_FILE_AT_LINE (105)) ;
  }
  ...
  const GGS_string temp_9476 = var_cas_makefile_macosx_universal_DIR ;
  if (temp_9476.isBuilt ()) {
    temp_9476 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (108)) ;
  }
  const GGS_string temp_9588 = GGS_string (gWrapperFileContent_12_projectCreationFileWrapper) ;
  if (temp_9588.isBuilt ()) {
    temp_9588 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_universal_DIR).operator_concat (GGS_string ("/build.command")) COMMA_SOURCE_FILE_AT_LINE (109)) ;
  }
  const GGS_string temp_9750 = GGS_string (gWrapperFileContent_14_projectCreationFileWrapper) ;
  if (temp_9750.isBuilt ()) {
    temp_9750 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_universal_DIR).operator_concat (GGS_string ("/clean.command")) COMMA_SOURCE_FILE_AT_LINE (110)) ;
  }
  const GGS_string temp_9914 = GGS_string (gWrapperFileContent_13_projectCreationFileWrapper) ;
  if (temp_9914.isBuilt ()) {
    temp_9914 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_universal_DIR).operator_concat (GGS_string ("/build64.command")) COMMA_SOURCE_FILE_AT_LINE (111)) ;
  }
  const GGS_string temp_10079 = GGS_string (gWrapperFileContent_15_projectCreationFileWrapper) ;
  if (temp_10079.isBuilt ()) {
    temp_10079 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_universal_DIR).operator_concat (GGS_string ("/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (112)) ;
  }
  const GGS_string temp_10240 = template_filewrapper_projectCreationFileWrapper_makefile_macosx_universal_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_10240.isBuilt ()) {
    temp_10240 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_universal_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (113)) ;
  }
  const GGS_string temp_10396 = template_filewrapper_projectCreationFileWrapper_makefile_macosx_universal_makefile64 (inLexique, var_cas_inProjectName) ;
  if (temp_10396.isBuilt ()) {
    temp_10396 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_universal_DIR).operator_concat (GGS_string ("/makefile64")) COMMA_SOURCE_FILE_AT_LINE (114)) ;
  }
  ...
  const GGS_string temp_10609 = var_cas_makefile_mingw_on_macosx_DIR ;
  if (temp_10609.isBuilt ()) {
    temp_10609 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (117)) ;
  }
  const GGS_string temp_10720 = GGS_string (gWrapperFileContent_16_projectCreationFileWrapper) ;
  if (temp_10720.isBuilt ()) {
    temp_10720 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_mingw_on_macosx_DIR).operator_concat (GGS_string ("/build.command")) COMMA_SOURCE_FILE_AT_LINE (118)) ;
  }
  const GGS_string temp_10879 = GGS_string (gWrapperFileContent_17_projectCreationFileWrapper) ;
  if (temp_10879.isBuilt ()) {
    temp_10879 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_mingw_on_macosx_DIR).operator_concat (GGS_string ("/clean.command")) COMMA_SOURCE_FILE_AT_LINE (119)) ;
  }
  const GGS_string temp_11035 = template_filewrapper_projectCreationFileWrapper_makefile_mingw_on_macosx_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_11035.isBuilt ()) {
    temp_11035 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_mingw_on_macosx_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (120)) ;
  }
  GGS_string var_cas_makefile_mingw_on_win32_DIR = (var_cas_inProjectName).operator_concat (GGS_string ("/makefile_msys_on_win32")) ;
  const GGS_string temp_11238 = var_cas_makefile_mingw_on_win32_DIR ;
  if (temp_11238.isBuilt ()) {
    temp_11238 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (123)) ;
  }
  const GGS_string temp_11333 = GGS_string (gWrapperFileContent_18_projectCreationFileWrapper) ;
  if (temp_11333.isBuilt ()) {
    temp_11333 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_mingw_on_win32_DIR).operator_concat (GGS_string ("/build.bat")) COMMA_SOURCE_FILE_AT_LINE (124)) ;
  }
  const GGS_string temp_11471 = GGS_string (gWrapperFileContent_19_projectCreationFileWrapper) ;
  if (temp_11471.isBuilt ()) {
    temp_11471 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_mingw_on_win32_DIR).operator_concat (GGS_string ("/clean.bat")) COMMA_SOURCE_FILE_AT_LINE (125)) ;
  }
  const GGS_string temp_11611 = GGS_string (gWrapperFileContent_20_projectCreationFileWrapper) ;
  if (temp_11611.isBuilt ()) {
    temp_11611 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_mingw_on_win32_DIR).operator_concat (GGS_string ("/install.bat")) COMMA_SOURCE_FILE_AT_LINE (126)) ;
  }
  const GGS_string temp_11762 = template_filewrapper_projectCreationFileWrapper_makefile_msys_on_win32_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_11762.isBuilt ()) {
    temp_11762 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_mingw_on_win32_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (127)) ;
  }
  GGS_string var_cas_makefile_unix_DIR = (var_cas_inProjectName).operator_concat (GGS_string ("/makefile_unix")) ;
  const GGS_string temp_11926 = var_cas_makefile_unix_DIR ;
  if (temp_11926.isBuilt ()) {
    temp_11926 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
  }
  const GGS_string temp_12023 = template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_12023.isBuilt ()) {
    temp_12023 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_unix_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (131)) ;
  }
  const GGS_string temp_12154 = template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile64 (inLexique, var_cas_inProjectName) ;
  if (temp_12154.isBuilt ()) {
    temp_12154 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_unix_DIR).operator_concat (GGS_string ("/makefile64")) COMMA_SOURCE_FILE_AT_LINE (132)) ;
  }
  ...
  const GGS_string temp_12370 = var_cas_makefile_x86linux_on_macosx_DIR ;
  if (temp_12370.isBuilt ()) {
    temp_12370 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (135)) ;
  }
  const GGS_string temp_12484 = GGS_string (gWrapperFileContent_21_projectCreationFileWrapper) ;
  if (temp_12484.isBuilt ()) {
    temp_12484 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_x86linux_on_macosx_DIR).operator_concat (GGS_string ("/build.command")) COMMA_SOURCE_FILE_AT_LINE (136)) ;
  }
  const GGS_string temp_12650 = GGS_string (gWrapperFileContent_22_projectCreationFileWrapper) ;
  if (temp_12650.isBuilt ()) {
    temp_12650 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_x86linux_on_macosx_DIR).operator_concat (GGS_string ("/clean.command")) COMMA_SOURCE_FILE_AT_LINE (137)) ;
  }
  const GGS_string temp_12813 = template_filewrapper_projectCreationFileWrapper_makefile_x86linux_on_macosx_makefile (inLexique, var_cas_inProjectName) ;
  if (temp_12813.isBuilt ()) {
    temp_12813 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_x86linux_on_macosx_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (138)) ;
  }
  GGS_string var_cas_projectxcode_DIR = (var_cas_inProjectName).operator_concat (GGS_string ("/project_xcode")) ;
  const GGS_string temp_13013 = (((var_cas_projectxcode_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string (".xcodeproj")) ;
  if (temp_13013.isBuilt ()) {
    temp_13013 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (141)) ;
  }
  const GGS_string temp_13098 = template_filewrapper_projectCreationFileWrapper_info_plist (inLexique, var_cas_inProjectName) ;
  if (temp_13098.isBuilt ()) {
    temp_13098 (HERE)->method_writeToFile (inLexique, (var_cas_projectxcode_DIR).operator_concat (GGS_string ("/Info.plist")) COMMA_SOURCE_FILE_AT_LINE (142)) ;
  }
  const GGS_string temp_13186 = (var_cas_projectxcode_DIR).operator_concat (GGS_string ("/English.lproj")) ;
  if (temp_13186.isBuilt ()) {
    temp_13186 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
  }
  const GGS_string temp_13288 = GGS_string (gWrapperFileContent_23_projectCreationFileWrapper) ;
  if (temp_13288.isBuilt ()) {
    temp_13288 (HERE)->method_writeToFile (inLexique, (var_cas_projectxcode_DIR).operator_concat (GGS_string ("/English.lproj/Credits.rtf")) COMMA_SOURCE_FILE_AT_LINE (144)) ;
  }
  const GGS_string temp_13434 = template_filewrapper_projectCreationFileWrapper_cocoa_infoPlist_strings (inLexique, var_cas_inProjectName) ;
  if (temp_13434.isBuilt ()) {
    temp_13434 (HERE)->method_writeToFile (inLexique, (var_cas_projectxcode_DIR).operator_concat (GGS_string ("/English.lproj/InfoPlist.strings")) COMMA_SOURCE_FILE_AT_LINE (145)) ;
  }
...
void routine_projectCreation (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_14729 = (var_cas_inProjectName.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_14729.isBuiltAndTrue ()) {
    ...
    GGS_uint _variant_14178 = var_cas_inProjectName.reader_length () ;
    GGS_bool _condition_14178 (_variant_14178.isBuilt (), true) ;
    while (_condition_14178.isBuiltAndTrue ()) {
      _condition_14178 = ((var_cas_idx).operator_strictInf (var_cas_inProjectName.reader_length ())).operator_and (var_cas_ok) ;
      if (_condition_14178.isBuiltAndTrue ()) {
        if (_variant_14178.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (165)) ;
          _condition_14178 = GGS_bool (false) ;
        }else{
          _variant_14178.decrement_operation (inLexique COMMA_HERE) ;
    ...
    const GGS_bool cond_14423 = (var_cas_ok).operator_not () ;
    ...
    const GGS_bool cond_14644 = var_cas_ok ;
    if (cond_14644.isBuiltAndTrue ()) {
      var_cas_ok = (var_cas_inProjectName.reader_directoryExists ()).operator_not () ;
      const GGS_bool cond_14631 = (var_cas_ok).operator_not () ;
    ...
    const GGS_bool cond_14718 = var_cas_ok ;
