...
void routine_performProjectCreation (C_Compiler & _inLexique,
  ...
  const GGS_string _temp_4673 = var_cas_galgas_sources_DIR ;
  if (_temp_4673._isBuilt ()) {
    _temp_4673 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (67)) ;
  }
  const GGS_string _temp_4755 = _template_filewrapper_projectCreationFileWrapper_all_ggs (var_cas_inProjectName) ;
  if (_temp_4755._isBuilt ()) {
    _temp_4755 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/_all_")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".ggs")) COMMA_SOURCE_FILE_AT_LINE (68)) ;
  }
  const GGS_string _temp_4896 = _template_filewrapper_projectCreationFileWrapper_PROJECT_cocoa (var_cas_inProjectName) ;
  if (_temp_4896._isBuilt ()) {
    _temp_4896 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_cocoa.ggs")) COMMA_SOURCE_FILE_AT_LINE (69)) ;
  }
  const GGS_string _temp_5040 = _template_filewrapper_projectCreationFileWrapper_PROJECT_grammar (var_cas_inProjectName) ;
  if (_temp_5040._isBuilt ()) {
    _temp_5040 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_grammar.ggs")) COMMA_SOURCE_FILE_AT_LINE (70)) ;
  }
  const GGS_string _temp_5186 = _template_filewrapper_projectCreationFileWrapper_PROJECT_lexique (var_cas_inProjectName) ;
  if (_temp_5186._isBuilt ()) {
    _temp_5186 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_lexique.ggs")) COMMA_SOURCE_FILE_AT_LINE (71)) ;
  }
  const GGS_string _temp_5332 = _template_filewrapper_projectCreationFileWrapper_PROJECT_options (var_cas_inProjectName) ;
  if (_temp_5332._isBuilt ()) {
    _temp_5332 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_options.ggs")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
  }
  const GGS_string _temp_5478 = _template_filewrapper_projectCreationFileWrapper_PROJECT_program (var_cas_inProjectName) ;
  if (_temp_5478._isBuilt ()) {
    _temp_5478 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_program.ggs")) COMMA_SOURCE_FILE_AT_LINE (73)) ;
  }
  const GGS_string _temp_5626 = _template_filewrapper_projectCreationFileWrapper_PROJECT_semantics (var_cas_inProjectName) ;
  if (_temp_5626._isBuilt ()) {
    _temp_5626 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_semantics.ggs")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
  }
  const GGS_string _temp_5773 = _template_filewrapper_projectCreationFileWrapper_PROJECT_syntax (var_cas_inProjectName) ;
  if (_temp_5773._isBuilt ()) {
    _temp_5773 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_syntax.ggs")) COMMA_SOURCE_FILE_AT_LINE (75)) ;
  }
  const GGS_string _temp_5912 = _template_filewrapper_projectCreationFileWrapper_build_bat (var_cas_inProjectName) ;
  if (_temp_5912._isBuilt ()) {
    _temp_5912 (HERE)->method_writeToFile (_inLexique, (var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/build.bat")) COMMA_SOURCE_FILE_AT_LINE (76)) ;
  }
  ...
  const GGS_string _temp_6088 = var_cas_hand_coded_sources_DIR ;
  if (_temp_6088._isBuilt ()) {
    _temp_6088 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (79)) ;
  }
  const GGS_string _temp_6183 = _template_filewrapper_projectCreationFileWrapper_PROJECT_computations (var_cas_inProjectName) ;
  if (_temp_6183._isBuilt ()) {
    _temp_6183 (HERE)->method_writeToFile (_inLexique, (((var_cas_hand_coded_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_computations.cpp")) COMMA_SOURCE_FILE_AT_LINE (80)) ;
  }
  ...
  const GGS_string _temp_6378 = var_cas_makefile_macosx_DIR ;
  if (_temp_6378._isBuilt ()) {
    _temp_6378 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
  }
  const GGS_string _temp_6480 = GGS_string (gWrapperFileContent_0_projectCreationFileWrapper) ;
  if (_temp_6480._isBuilt ()) {
    _temp_6480 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (84)) ;
  }
  const GGS_string _temp_6621 = GGS_string (gWrapperFileContent_2_projectCreationFileWrapper) ;
  if (_temp_6621._isBuilt ()) {
    _temp_6621 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (85)) ;
  }
  const GGS_string _temp_6764 = GGS_string (gWrapperFileContent_1_projectCreationFileWrapper) ;
  if (_temp_6764._isBuilt ()) {
    _temp_6764 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (86)) ;
  }
  const GGS_string _temp_6909 = GGS_string (gWrapperFileContent_3_projectCreationFileWrapper) ;
  if (_temp_6909._isBuilt ()) {
    _temp_6909 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (87)) ;
  }
  const GGS_string _temp_7049 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_7049._isBuilt ()) {
    _temp_7049 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (88)) ;
  }
  const GGS_string _temp_7184 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile64 (var_cas_inProjectName) ;
  if (_temp_7184._isBuilt ()) {
    _temp_7184 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (89)) ;
  }
  ...
  const GGS_string _temp_7366 = var_cas_makefile_macosx_ppc_DIR ;
  if (_temp_7366._isBuilt ()) {
    _temp_7366 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (92)) ;
  }
  const GGS_string _temp_7472 = GGS_string (gWrapperFileContent_8_projectCreationFileWrapper) ;
  if (_temp_7472._isBuilt ()) {
    _temp_7472 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (93)) ;
  }
  const GGS_string _temp_7621 = GGS_string (gWrapperFileContent_10_projectCreationFileWrapper) ;
  if (_temp_7621._isBuilt ()) {
    _temp_7621 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (94)) ;
  }
  const GGS_string _temp_7772 = GGS_string (gWrapperFileContent_9_projectCreationFileWrapper) ;
  if (_temp_7772._isBuilt ()) {
    _temp_7772 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (95)) ;
  }
  const GGS_string _temp_7925 = GGS_string (gWrapperFileContent_11_projectCreationFileWrapper) ;
  if (_temp_7925._isBuilt ()) {
    _temp_7925 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (96)) ;
  }
  const GGS_string _temp_8073 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_ppc_makefile (var_cas_inProjectName) ;
  if (_temp_8073._isBuilt ()) {
    _temp_8073 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (97)) ;
  }
  const GGS_string _temp_8216 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_ppc_makefile64 (var_cas_inProjectName) ;
  if (_temp_8216._isBuilt ()) {
    _temp_8216 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (98)) ;
  }
  ...
  const GGS_string _temp_8406 = var_cas_makefile_macosx_i386_DIR ;
  if (_temp_8406._isBuilt ()) {
    _temp_8406 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (101)) ;
  }
  const GGS_string _temp_8513 = GGS_string (gWrapperFileContent_4_projectCreationFileWrapper) ;
  if (_temp_8513._isBuilt ()) {
    _temp_8513 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (102)) ;
  }
  const GGS_string _temp_8664 = GGS_string (gWrapperFileContent_6_projectCreationFileWrapper) ;
  if (_temp_8664._isBuilt ()) {
    _temp_8664 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (103)) ;
  }
  const GGS_string _temp_8817 = GGS_string (gWrapperFileContent_5_projectCreationFileWrapper) ;
  if (_temp_8817._isBuilt ()) {
    _temp_8817 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (104)) ;
  }
  const GGS_string _temp_8972 = GGS_string (gWrapperFileContent_7_projectCreationFileWrapper) ;
  if (_temp_8972._isBuilt ()) {
    _temp_8972 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (105)) ;
  }
  const GGS_string _temp_9122 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_i386_makefile (var_cas_inProjectName) ;
  if (_temp_9122._isBuilt ()) {
    _temp_9122 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (106)) ;
  }
  const GGS_string _temp_9267 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_i386_makefile64 (var_cas_inProjectName) ;
  if (_temp_9267._isBuilt ()) {
    _temp_9267 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (107)) ;
  }
  ...
  const GGS_string _temp_9478 = var_cas_makefile_macosx_universal_DIR ;
  if (_temp_9478._isBuilt ()) {
    _temp_9478 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (110)) ;
  }
  const GGS_string _temp_9590 = GGS_string (gWrapperFileContent_12_projectCreationFileWrapper) ;
  if (_temp_9590._isBuilt ()) {
    _temp_9590 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (111)) ;
  }
  const GGS_string _temp_9752 = GGS_string (gWrapperFileContent_14_projectCreationFileWrapper) ;
  if (_temp_9752._isBuilt ()) {
    _temp_9752 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (112)) ;
  }
  const GGS_string _temp_9916 = GGS_string (gWrapperFileContent_13_projectCreationFileWrapper) ;
  if (_temp_9916._isBuilt ()) {
    _temp_9916 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (113)) ;
  }
  const GGS_string _temp_10081 = GGS_string (gWrapperFileContent_15_projectCreationFileWrapper) ;
  if (_temp_10081._isBuilt ()) {
    _temp_10081 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (114)) ;
  }
  const GGS_string _temp_10242 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_universal_makefile (var_cas_inProjectName) ;
  if (_temp_10242._isBuilt ()) {
    _temp_10242 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (115)) ;
  }
  const GGS_string _temp_10398 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_universal_makefile64 (var_cas_inProjectName) ;
  if (_temp_10398._isBuilt ()) {
    _temp_10398 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (116)) ;
  }
  ...
  const GGS_string _temp_10611 = var_cas_makefile_mingw_on_macosx_DIR ;
  if (_temp_10611._isBuilt ()) {
    _temp_10611 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (119)) ;
  }
  const GGS_string _temp_10722 = GGS_string (gWrapperFileContent_16_projectCreationFileWrapper) ;
  if (_temp_10722._isBuilt ()) {
    _temp_10722 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (120)) ;
  }
  const GGS_string _temp_10881 = GGS_string (gWrapperFileContent_17_projectCreationFileWrapper) ;
  if (_temp_10881._isBuilt ()) {
    _temp_10881 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (121)) ;
  }
  const GGS_string _temp_11037 = _template_filewrapper_projectCreationFileWrapper_makefile_mingw_on_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_11037._isBuilt ()) {
    _temp_11037 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (122)) ;
  }
  ...
  const GGS_string _temp_11240 = var_cas_makefile_mingw_on_win32_DIR ;
  if (_temp_11240._isBuilt ()) {
    _temp_11240 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
  }
  const GGS_string _temp_11335 = GGS_string (gWrapperFileContent_18_projectCreationFileWrapper) ;
  if (_temp_11335._isBuilt ()) {
    _temp_11335 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/build.bat")) COMMA_SOURCE_FILE_AT_LINE (126)) ;
  }
  const GGS_string _temp_11473 = GGS_string (gWrapperFileContent_19_projectCreationFileWrapper) ;
  if (_temp_11473._isBuilt ()) {
    _temp_11473 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/clean.bat")) COMMA_SOURCE_FILE_AT_LINE (127)) ;
  }
  const GGS_string _temp_11613 = GGS_string (gWrapperFileContent_20_projectCreationFileWrapper) ;
  if (_temp_11613._isBuilt ()) {
    _temp_11613 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/install.bat")) COMMA_SOURCE_FILE_AT_LINE (128)) ;
  }
  const GGS_string _temp_11764 = _template_filewrapper_projectCreationFileWrapper_makefile_msys_on_win32_makefile (var_cas_inProjectName) ;
  if (_temp_11764._isBuilt ()) {
    _temp_11764 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/makefile.mke")) COMMA_SOURCE_FILE_AT_LINE (129)) ;
  }
  ...
  const GGS_string _temp_11932 = var_cas_makefile_unix_DIR ;
  if (_temp_11932._isBuilt ()) {
    _temp_11932 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
  }
  const GGS_string _temp_12029 = _template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile (var_cas_inProjectName) ;
  if (_temp_12029._isBuilt ()) {
    _temp_12029 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (133)) ;
  }
  const GGS_string _temp_12160 = _template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile64 (var_cas_inProjectName) ;
  if (_temp_12160._isBuilt ()) {
    _temp_12160 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (134)) ;
  }
  ...
  const GGS_string _temp_12376 = var_cas_makefile_x86linux_on_macosx_DIR ;
  if (_temp_12376._isBuilt ()) {
    _temp_12376 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
  }
  const GGS_string _temp_12490 = GGS_string (gWrapperFileContent_21_projectCreationFileWrapper) ;
  if (_temp_12490._isBuilt ()) {
    _temp_12490 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (138)) ;
  }
  const GGS_string _temp_12656 = GGS_string (gWrapperFileContent_22_projectCreationFileWrapper) ;
  if (_temp_12656._isBuilt ()) {
    _temp_12656 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (139)) ;
  }
  const GGS_string _temp_12819 = _template_filewrapper_projectCreationFileWrapper_makefile_x86linux_on_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_12819._isBuilt ()) {
    _temp_12819 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (140)) ;
  }
  ...
  const GGS_string _temp_13019 = (((var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".xcodeproj")) ;
  if (_temp_13019._isBuilt ()) {
    _temp_13019 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
  }
  const GGS_string _temp_13106 = _template_filewrapper_projectCreationFileWrapper_xcodeProject (var_cas_inProjectName) ;
  if (_temp_13106._isBuilt ()) {
    _temp_13106 (HERE)->method_writeToFile (_inLexique, (((var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".xcodeproj/project.pbxproj")) COMMA_SOURCE_FILE_AT_LINE (144)) ;
  }
  const GGS_string _temp_13260 = _template_filewrapper_projectCreationFileWrapper_info_plist (var_cas_inProjectName) ;
  if (_temp_13260._isBuilt ()) {
    _temp_13260 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/Info.plist")) COMMA_SOURCE_FILE_AT_LINE (145)) ;
  }
  const GGS_string _temp_13376 = GGS_string (gWrapperFileContent_23_projectCreationFileWrapper) ;
  if (_temp_13376._isBuilt ()) {
    _temp_13376 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/main.m")) COMMA_SOURCE_FILE_AT_LINE (146)) ;
  }
  const GGS_string _temp_13460 = (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj")) ;
  if (_temp_13460._isBuilt ()) {
    _temp_13460 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (147)) ;
  }
  const GGS_string _temp_13562 = GGS_string (gWrapperFileContent_24_projectCreationFileWrapper) ;
  if (_temp_13562._isBuilt ()) {
    _temp_13562 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/Credits.rtf")) COMMA_SOURCE_FILE_AT_LINE (148)) ;
  }
  const GGS_string _temp_13718 = GGS_string (gWrapperFileContent_25_projectCreationFileWrapper) ;
  if (_temp_13718._isBuilt ()) {
    _temp_13718 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/InfoPlist.strings")) COMMA_SOURCE_FILE_AT_LINE (149)) ;
  }
...
void routine_projectCreation (C_Compiler & _inLexique,
  ...
  if (((var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_uint _variant_14470 = var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
    GGS_bool _condition_14470 (_variant_14470._isBuilt (), true) ;
    while (_condition_14470.isBuiltAndTrue ()) {
      _condition_14470 = ((var_cas_index)._operator_strictInf (var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (165))))._operator_and (var_cas_ok) ;
      if (_condition_14470.isBuiltAndTrue ()) {
        if (_variant_14470.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (169)) ;
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ::routine_performProjectCreation (_inLexique,  var_cas_inProjectName COMMA_SOURCE_FILE_AT_LINE (183)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
