...
void routine_projectCreation (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_14661 = (var_cas_inProjectName.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (155))).operator_strictSup (GGS_uint (0U)) ;
  if (cond_14661.isBuiltAndTrue ()) {
    ...
    GGS_uint _variant_14110 = var_cas_inProjectName.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
    GGS_bool _condition_14110 (_variant_14110.isBuilt (), true) ;
    while (_condition_14110.isBuiltAndTrue ()) {
      _condition_14110 = ((var_cas_idx).operator_strictInf (var_cas_inProjectName.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (161)))).operator_and (var_cas_ok) ;
      if (_condition_14110.isBuiltAndTrue ()) {
        if (_variant_14110.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (165)) ;
          _condition_14110 = GGS_bool (false) ;
        }else{
          _variant_14110.decrement_operation (inLexique COMMA_HERE) ;
    ...
    const GGS_bool cond_14355 = (var_cas_ok).operator_not () ;
    ...
    const GGS_bool cond_14576 = var_cas_ok ;
    if (cond_14576.isBuiltAndTrue ()) {
      var_cas_ok = (var_cas_inProjectName.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (173))).operator_not () ;
      const GGS_bool cond_14563 = (var_cas_ok).operator_not () ;
      if (cond_14563.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_14650 = var_cas_ok ;
    if (cond_14650.isBuiltAndTrue ()) {
