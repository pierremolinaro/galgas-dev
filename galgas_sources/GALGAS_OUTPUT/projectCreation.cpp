...
GALGAS_string filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_project (C_Compiler * /* inCompiler */,
  ...
  result << " (0:0:1) -> " ;
  result << in_PROJECT_5F_NAME.reader_utf_38_Representation (SOURCE_FILE ("all_PROJECT.gProject.gTemplate", 1)).stringValue () ;
  result << ":\n"
    "#--- Targets\n"
...
GALGAS_string filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_computations (C_Compiler * inCompiler,
  ...
  result << "//---------------------------------------------------------------------------------------------------------------------*\n"
    "//                                                                                                                     *\n"
    "//" ;
  result << in_PROJECT_5F_NAME.add_operation (GALGAS_string (" Project"), inCompiler COMMA_SOURCE_FILE ("PROJECT_computations.cpp.gTemplate", 3)).reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 77U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("PROJECT_computations.cpp.gTemplate", 3)).stringValue () ;
  result << "*\n"
...
void routine_performProjectCreation (const GALGAS_string constinArgument_inProjectPath,
  ...
  GALGAS_string var_galgas_5F_sources_5F_DIR = constinArgument_inProjectPath.operator_concat (GALGAS_string ("/galgas_sources")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 48)) ;
  var_galgas_5F_sources_5F_DIR.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("projectCreation.gSemantics", 49)) ;
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_project (inCompiler, var_projectName COMMA_SOURCE_FILE ("projectCreation.gSemantics", 50))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/all_")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 50)).operator_concat (var_projectName  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 50)).operator_concat (GALGAS_string (".gProject")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 50)), inCompiler COMMA_SOURCE_FILE ("projectCreation.gSemantics", 50)) ;
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_cocoa (inCompiler, var_projectName COMMA_SOURCE_FILE ("projectCreation.gSemantics", 51))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 51)).operator_concat (var_projectName  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 51)).operator_concat (GALGAS_string ("_cocoa.gGui")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 51)), inCompiler COMMA_SOURCE_FILE ("projectCreation.gSemantics", 51)) ;
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_grammar (inCompiler, var_projectName COMMA_SOURCE_FILE ("projectCreation.gSemantics", 52))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 52)).operator_concat (var_projectName  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 52)).operator_concat (GALGAS_string ("_grammar.gGrammar")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 52)), inCompiler COMMA_SOURCE_FILE ("projectCreation.gSemantics", 52)) ;
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_lexique (inCompiler, var_projectName COMMA_SOURCE_FILE ("projectCreation.gSemantics", 53))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 53)).operator_concat (var_projectName  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 53)).operator_concat (GALGAS_string ("_lexique.gLexique")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 53)), inCompiler COMMA_SOURCE_FILE ("projectCreation.gSemantics", 53)) ;
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_options (inCompiler, var_projectName COMMA_SOURCE_FILE ("projectCreation.gSemantics", 54))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 54)).operator_concat (var_projectName  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 54)).operator_concat (GALGAS_string ("_options.gOption")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 54)), inCompiler COMMA_SOURCE_FILE ("projectCreation.gSemantics", 54)) ;
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_program (inCompiler, var_projectName COMMA_SOURCE_FILE ("projectCreation.gSemantics", 55))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 55)).operator_concat (var_projectName  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 55)).operator_concat (GALGAS_string ("_program.gProgram")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 55)), inCompiler COMMA_SOURCE_FILE ("projectCreation.gSemantics", 55)) ;
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_semantics (inCompiler, var_projectName COMMA_SOURCE_FILE ("projectCreation.gSemantics", 56))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 56)).operator_concat (var_projectName  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 56)).operator_concat (GALGAS_string ("_semantics.gSemantics")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 56)), inCompiler COMMA_SOURCE_FILE ("projectCreation.gSemantics", 56)) ;
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_syntax (inCompiler, var_projectName COMMA_SOURCE_FILE ("projectCreation.gSemantics", 57))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 57)).operator_concat (var_projectName  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 57)).operator_concat (GALGAS_string ("_syntax.gSyntax")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 57)), inCompiler COMMA_SOURCE_FILE ("projectCreation.gSemantics", 57)) ;
  GALGAS_string var_hand_5F_coded_5F_sources_5F_DIR = constinArgument_inProjectPath.operator_concat (GALGAS_string ("/hand_coded_sources")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 59)) ;
  var_hand_5F_coded_5F_sources_5F_DIR.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("projectCreation.gSemantics", 60)) ;
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_computations (inCompiler, var_projectName COMMA_SOURCE_FILE ("projectCreation.gSemantics", 61))).method_writeToFile (var_hand_5F_coded_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 61)).operator_concat (var_projectName  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 61)).operator_concat (GALGAS_string ("_computations.cpp")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 61)), inCompiler COMMA_SOURCE_FILE ("projectCreation.gSemantics", 61)) ;
...
void routine_projectCreation (const GALGAS_string constinArgument_inProjectPath,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (var_projectName.reader_length (SOURCE_FILE ("projectCreation.gSemantics", 77)).isValid ()) {
      uint32_t variant_5007 = var_projectName.reader_length (SOURCE_FILE ("projectCreation.gSemantics", 77)).uintValue () ;
      bool loop_5007 = true ;
      while (loop_5007) {
        loop_5007 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (var_projectName.reader_length (SOURCE_FILE ("projectCreation.gSemantics", 78)))).operator_and (var_ok COMMA_SOURCE_FILE ("projectCreation.gSemantics", 78)).isValid () ;
        if (loop_5007) {
          loop_5007 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (var_projectName.reader_length (SOURCE_FILE ("projectCreation.gSemantics", 78)))).operator_and (var_ok COMMA_SOURCE_FILE ("projectCreation.gSemantics", 78)).boolValue () ;
        }
