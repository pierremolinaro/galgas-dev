...
void routine_performProjectCreation (C_Compiler & _inLexique,
  ...
  const GGS_string _temp_4097 = var_cas_common_files_for_make_DIR ;
  if (_temp_4097._isBuilt ()) {
    _temp_4097 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (61)) ;
  }
  const GGS_string _temp_4195 = _template_filewrapper_projectCreationFileWrapper_commonMakefileProject (var_cas_inProjectName) ;
  if (_temp_4195._isBuilt ()) {
    _temp_4195 (HERE)->method_writeToFile (_inLexique, (var_cas_common_files_for_make_DIR)._operator_concat (GGS_string (true, "/makefile.mke")) COMMA_SOURCE_FILE_AT_LINE (62)) ;
  }
  ...
  const GGS_string _temp_4365 = var_cas_galgas_sources_DIR ;
  if (_temp_4365._isBuilt ()) {
    _temp_4365 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (65)) ;
  }
  const GGS_string _temp_4449 = _template_filewrapper_projectCreationFileWrapper_all_ggs (var_cas_inProjectName) ;
  if (_temp_4449._isBuilt ()) {
    _temp_4449 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/_all_")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".ggs")) COMMA_SOURCE_FILE_AT_LINE (66)) ;
  }
  const GGS_string _temp_4593 = _template_filewrapper_projectCreationFileWrapper_PROJECT_cocoa (var_cas_inProjectName) ;
  if (_temp_4593._isBuilt ()) {
    _temp_4593 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_cocoa.ggs")) COMMA_SOURCE_FILE_AT_LINE (67)) ;
  }
  const GGS_string _temp_4740 = _template_filewrapper_projectCreationFileWrapper_PROJECT_grammar (var_cas_inProjectName) ;
  if (_temp_4740._isBuilt ()) {
    _temp_4740 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_grammar.ggs")) COMMA_SOURCE_FILE_AT_LINE (68)) ;
  }
  const GGS_string _temp_4889 = _template_filewrapper_projectCreationFileWrapper_PROJECT_lexique (var_cas_inProjectName) ;
  if (_temp_4889._isBuilt ()) {
    _temp_4889 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_lexique.ggs")) COMMA_SOURCE_FILE_AT_LINE (69)) ;
  }
  const GGS_string _temp_5038 = _template_filewrapper_projectCreationFileWrapper_PROJECT_options (var_cas_inProjectName) ;
  if (_temp_5038._isBuilt ()) {
    _temp_5038 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_options.ggs")) COMMA_SOURCE_FILE_AT_LINE (70)) ;
  }
  const GGS_string _temp_5187 = _template_filewrapper_projectCreationFileWrapper_PROJECT_program (var_cas_inProjectName) ;
  if (_temp_5187._isBuilt ()) {
    _temp_5187 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_program.ggs")) COMMA_SOURCE_FILE_AT_LINE (71)) ;
  }
  const GGS_string _temp_5338 = _template_filewrapper_projectCreationFileWrapper_PROJECT_semantics (var_cas_inProjectName) ;
  if (_temp_5338._isBuilt ()) {
    _temp_5338 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_semantics.ggs")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
  }
  const GGS_string _temp_5488 = _template_filewrapper_projectCreationFileWrapper_PROJECT_syntax (var_cas_inProjectName) ;
  if (_temp_5488._isBuilt ()) {
    _temp_5488 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_syntax.ggs")) COMMA_SOURCE_FILE_AT_LINE (73)) ;
  }
  ...
  const GGS_string _temp_5687 = var_cas_hand_coded_sources_DIR ;
  if (_temp_5687._isBuilt ()) {
    _temp_5687 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (76)) ;
  }
  const GGS_string _temp_5784 = _template_filewrapper_projectCreationFileWrapper_PROJECT_computations (var_cas_inProjectName) ;
  if (_temp_5784._isBuilt ()) {
    _temp_5784 (HERE)->method_writeToFile (_inLexique, (((var_cas_hand_coded_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_computations.cpp")) COMMA_SOURCE_FILE_AT_LINE (77)) ;
  }
  ...
  const GGS_string _temp_5981 = var_cas_makefile_macosx_DIR ;
  if (_temp_5981._isBuilt ()) {
    _temp_5981 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (80)) ;
  }
  const GGS_string _temp_6075 = GGS_string (gWrapperFileContent_0_projectCreationFileWrapper) ;
  if (_temp_6075._isBuilt ()) {
    _temp_6075 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (81)) ;
  }
  const GGS_string _temp_6207 = GGS_string (gWrapperFileContent_2_projectCreationFileWrapper) ;
  if (_temp_6207._isBuilt ()) {
    _temp_6207 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (82)) ;
  }
  const GGS_string _temp_6341 = GGS_string (gWrapperFileContent_1_projectCreationFileWrapper) ;
  if (_temp_6341._isBuilt ()) {
    _temp_6341 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (83)) ;
  }
  const GGS_string _temp_6477 = GGS_string (gWrapperFileContent_3_projectCreationFileWrapper) ;
  if (_temp_6477._isBuilt ()) {
    _temp_6477 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (84)) ;
  }
  const GGS_string _temp_6618 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_6618._isBuilt ()) {
    _temp_6618 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (85)) ;
  }
  const GGS_string _temp_6754 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile64 (var_cas_inProjectName) ;
  if (_temp_6754._isBuilt ()) {
    _temp_6754 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (86)) ;
  }
  ...
  const GGS_string _temp_6956 = var_cas_makefile_mingw_on_macosx_DIR ;
  if (_temp_6956._isBuilt ()) {
    _temp_6956 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (89)) ;
  }
  const GGS_string _temp_7059 = GGS_string (gWrapperFileContent_4_projectCreationFileWrapper) ;
  if (_temp_7059._isBuilt ()) {
    _temp_7059 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (90)) ;
  }
  const GGS_string _temp_7209 = GGS_string (gWrapperFileContent_5_projectCreationFileWrapper) ;
  if (_temp_7209._isBuilt ()) {
    _temp_7209 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (91)) ;
  }
  const GGS_string _temp_7366 = _template_filewrapper_projectCreationFileWrapper_makefile_mingw_on_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_7366._isBuilt ()) {
    _temp_7366 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (92)) ;
  }
  ...
  const GGS_string _temp_7569 = var_cas_makefile_mingw_on_win32_DIR ;
  if (_temp_7569._isBuilt ()) {
    _temp_7569 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (95)) ;
  }
  const GGS_string _temp_7666 = GGS_string (gWrapperFileContent_6_projectCreationFileWrapper) ;
  if (_temp_7666._isBuilt ()) {
    _temp_7666 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/build.bat")) COMMA_SOURCE_FILE_AT_LINE (96)) ;
  }
  const GGS_string _temp_7805 = GGS_string (gWrapperFileContent_7_projectCreationFileWrapper) ;
  if (_temp_7805._isBuilt ()) {
    _temp_7805 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/clean.bat")) COMMA_SOURCE_FILE_AT_LINE (97)) ;
  }
  const GGS_string _temp_7946 = GGS_string (gWrapperFileContent_8_projectCreationFileWrapper) ;
  if (_temp_7946._isBuilt ()) {
    _temp_7946 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/install.bat")) COMMA_SOURCE_FILE_AT_LINE (98)) ;
  }
  const GGS_string _temp_8098 = _template_filewrapper_projectCreationFileWrapper_makefile_msys_on_win32_makefile (var_cas_inProjectName) ;
  if (_temp_8098._isBuilt ()) {
    _temp_8098 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/makefile.mke")) COMMA_SOURCE_FILE_AT_LINE (99)) ;
  }
  ...
  const GGS_string _temp_8266 = var_cas_makefile_unix_DIR ;
  if (_temp_8266._isBuilt ()) {
    _temp_8266 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (102)) ;
  }
  const GGS_string _temp_8365 = _template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile (var_cas_inProjectName) ;
  if (_temp_8365._isBuilt ()) {
    _temp_8365 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (103)) ;
  }
  const GGS_string _temp_8497 = _template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile64 (var_cas_inProjectName) ;
  if (_temp_8497._isBuilt ()) {
    _temp_8497 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (104)) ;
  }
  ...
  const GGS_string _temp_8713 = var_cas_makefile_x86linux_on_macosx_DIR ;
  if (_temp_8713._isBuilt ()) {
    _temp_8713 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (107)) ;
  }
  const GGS_string _temp_8819 = GGS_string (gWrapperFileContent_9_projectCreationFileWrapper) ;
  if (_temp_8819._isBuilt ()) {
    _temp_8819 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (108)) ;
  }
  const GGS_string _temp_8976 = GGS_string (gWrapperFileContent_10_projectCreationFileWrapper) ;
  if (_temp_8976._isBuilt ()) {
    _temp_8976 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (109)) ;
  }
  const GGS_string _temp_9140 = _template_filewrapper_projectCreationFileWrapper_makefile_x86linux_on_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_9140._isBuilt ()) {
    _temp_9140 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (110)) ;
  }
  ...
  const GGS_string _temp_9343 = (((var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".xcodeproj")) ;
  if (_temp_9343._isBuilt ()) {
    _temp_9343 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (113)) ;
  }
  const GGS_string _temp_9432 = _template_filewrapper_projectCreationFileWrapper_xcodeProject (var_cas_inProjectName) ;
  if (_temp_9432._isBuilt ()) {
    _temp_9432 (HERE)->method_writeToFile (_inLexique, (((var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".xcodeproj/project.pbxproj")) COMMA_SOURCE_FILE_AT_LINE (114)) ;
  }
  const GGS_string _temp_9589 = _template_filewrapper_projectCreationFileWrapper_info_plist (var_cas_inProjectName) ;
  if (_temp_9589._isBuilt ()) {
    _temp_9589 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/Info.plist")) COMMA_SOURCE_FILE_AT_LINE (115)) ;
  }
  const GGS_string _temp_9706 = GGS_string (gWrapperFileContent_11_projectCreationFileWrapper) ;
  if (_temp_9706._isBuilt ()) {
    _temp_9706 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/main.m")) COMMA_SOURCE_FILE_AT_LINE (116)) ;
  }
  const GGS_string _temp_9790 = (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj")) ;
  if (_temp_9790._isBuilt ()) {
    _temp_9790 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (117)) ;
  }
  const GGS_string _temp_9894 = GGS_string (gWrapperFileContent_12_projectCreationFileWrapper) ;
  if (_temp_9894._isBuilt ()) {
    _temp_9894 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/Credits.rtf")) COMMA_SOURCE_FILE_AT_LINE (118)) ;
  }
  const GGS_string _temp_10051 = GGS_string (gWrapperFileContent_13_projectCreationFileWrapper) ;
  if (_temp_10051._isBuilt ()) {
    _temp_10051 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/InfoPlist.strings")) COMMA_SOURCE_FILE_AT_LINE (119)) ;
  }
...
void routine_projectCreation (C_Compiler & _inLexique,
                                ...
                                const GGS_string  /* var_cas_inLIBPMlocation */ COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_projectCreation at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  if (((var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (130)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_ok ;
    var_cas_ok = var_cas_inProjectName.reader_characterAtIndex (_inLexique, GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (133)).reader_isalpha (_inLexique COMMA_SOURCE_FILE_AT_LINE (133)) ;
    GGS_uint  var_cas_index ;
    var_cas_index = GGS_uint (true, 1U) ;
    GGS_uint _variant_10845 = var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (135)) ;
    GGS_bool _condition_10845 (_variant_10845._isBuilt (), true) ;
    while (_condition_10845.isBuiltAndTrue ()) {
      _condition_10845 = ((var_cas_index)._operator_strictInf (var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (136))))._operator_and (var_cas_ok) ;
      if (_condition_10845.isBuiltAndTrue ()) {
        if (_variant_10845.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (139)) ;
          _condition_10845 = GGS_bool (true, false) ;
        }else{
          _variant_10845._decrement_operation (_inLexique COMMA_HERE) ;
          GGS_char var_cas_c ;
          var_cas_c = var_cas_inProjectName.reader_characterAtIndex (_inLexique, var_cas_index COMMA_SOURCE_FILE_AT_LINE (137)) ;
          var_cas_ok = (var_cas_c.reader_isalnum (_inLexique COMMA_SOURCE_FILE_AT_LINE (138)))._operator_or ((var_cas_c)._operator_isEqual (GGS_char (true, '_'))) ;
          var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (139)) ;
        }
      }
    }
    if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
      _inLexique.printMessage (GGS_string (true, "** Cannot create GALGAS project: the project name should begin by a letter followed by zero, one or more letters, digits and underscore character.\n"
        "") COMMA_SOURCE_FILE_AT_LINE (142)) ;
    }
    if ((var_cas_ok).isBuiltAndTrue ()) {
      var_cas_ok = (var_cas_inProjectName.reader_directoryExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (145)))._operator_not () ;
      if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ::routine_performProjectCreation (_inLexique,  var_cas_inProjectName COMMA_SOURCE_FILE_AT_LINE (150)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
