...
const char * gWrapperFileContent_6_projectCreationFileWrapper = // 104 bytes
...
const char * gWrapperFileContent_7_projectCreationFileWrapper = // 110 bytes
  "PATH=C:\\msys\\1.0\\bin;C:\\MinGW\\bin;%PATH%\n"
...
const char * gWrapperFileContent_8_projectCreationFileWrapper = // 112 bytes
  "PATH=C:\\msys\\1.0\\bin;C:\\MinGW\\bin;%PATH%\n"
...
static const cRegularFileWrapper * gWrapperAllFiles_projectCreationFileWrapper_6 [4] = {
...
const char * gWrapperFileContent_9_projectCreationFileWrapper = // 71 bytes
  "#!/bin/sh\n"
  "cd `dirname $0` && time make --warn-undefined-variables all\n"
;
...
const char * gWrapperFileContent_12_projectCreationFileWrapper = // 311 bytes
...
const char * gWrapperFileContent_13_projectCreationFileWrapper = // 294 bytes
...
const char * gWrapperFileContent_11_projectCreationFileWrapper = // 123 bytes
...
static const cRegularFileWrapper * gWrapperAllFiles_projectCreationFileWrapper_9 [2] = {
...
static const cDirectoryWrapper * gWrapperAllDirectories_projectCreationFileWrapper_9 [2] = {
...
void routine_performProjectCreation (C_Compiler & _inLexique,
  ...
  const GGS_string _temp_4174 = var_cas_common_files_for_make_DIR ;
  if (_temp_4174._isBuilt ()) {
    _temp_4174 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (62)) ;
  }
  const GGS_string _temp_4272 = _template_filewrapper_projectCreationFileWrapper_commonMakefileProject (var_cas_inProjectName) ;
  if (_temp_4272._isBuilt ()) {
    _temp_4272 (HERE)->method_writeToFile (_inLexique, (var_cas_common_files_for_make_DIR)._operator_concat (GGS_string (true, "/makefile.mke")) COMMA_SOURCE_FILE_AT_LINE (63)) ;
  }
  ...
  const GGS_string _temp_4442 = var_cas_galgas_sources_DIR ;
  if (_temp_4442._isBuilt ()) {
    _temp_4442 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (66)) ;
  }
  const GGS_string _temp_4526 = _template_filewrapper_projectCreationFileWrapper_all_ggs (var_cas_inProjectName) ;
  if (_temp_4526._isBuilt ()) {
    _temp_4526 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/_all_")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".ggs")) COMMA_SOURCE_FILE_AT_LINE (67)) ;
  }
  const GGS_string _temp_4670 = _template_filewrapper_projectCreationFileWrapper_PROJECT_cocoa (var_cas_inProjectName) ;
  if (_temp_4670._isBuilt ()) {
    _temp_4670 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_cocoa.ggs")) COMMA_SOURCE_FILE_AT_LINE (68)) ;
  }
  const GGS_string _temp_4817 = _template_filewrapper_projectCreationFileWrapper_PROJECT_grammar (var_cas_inProjectName) ;
  if (_temp_4817._isBuilt ()) {
    _temp_4817 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_grammar.ggs")) COMMA_SOURCE_FILE_AT_LINE (69)) ;
  }
  const GGS_string _temp_4966 = _template_filewrapper_projectCreationFileWrapper_PROJECT_lexique (var_cas_inProjectName) ;
  if (_temp_4966._isBuilt ()) {
    _temp_4966 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_lexique.ggs")) COMMA_SOURCE_FILE_AT_LINE (70)) ;
  }
  const GGS_string _temp_5115 = _template_filewrapper_projectCreationFileWrapper_PROJECT_options (var_cas_inProjectName) ;
  if (_temp_5115._isBuilt ()) {
    _temp_5115 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_options.ggs")) COMMA_SOURCE_FILE_AT_LINE (71)) ;
  }
  const GGS_string _temp_5264 = _template_filewrapper_projectCreationFileWrapper_PROJECT_program (var_cas_inProjectName) ;
  if (_temp_5264._isBuilt ()) {
    _temp_5264 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_program.ggs")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
  }
  const GGS_string _temp_5415 = _template_filewrapper_projectCreationFileWrapper_PROJECT_semantics (var_cas_inProjectName) ;
  if (_temp_5415._isBuilt ()) {
    _temp_5415 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_semantics.ggs")) COMMA_SOURCE_FILE_AT_LINE (73)) ;
  }
  const GGS_string _temp_5565 = _template_filewrapper_projectCreationFileWrapper_PROJECT_syntax (var_cas_inProjectName) ;
  if (_temp_5565._isBuilt ()) {
    _temp_5565 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_syntax.ggs")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
  }
  const GGS_string _temp_5707 = _template_filewrapper_projectCreationFileWrapper_build_bat (var_cas_inProjectName) ;
  if (_temp_5707._isBuilt ()) {
    _temp_5707 (HERE)->method_writeToFile (_inLexique, (var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/build.bat")) COMMA_SOURCE_FILE_AT_LINE (75)) ;
  }
  ...
  const GGS_string _temp_5883 = var_cas_hand_coded_sources_DIR ;
  if (_temp_5883._isBuilt ()) {
    _temp_5883 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (78)) ;
  }
  const GGS_string _temp_5980 = _template_filewrapper_projectCreationFileWrapper_PROJECT_computations (var_cas_inProjectName) ;
  if (_temp_5980._isBuilt ()) {
    _temp_5980 (HERE)->method_writeToFile (_inLexique, (((var_cas_hand_coded_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_computations.cpp")) COMMA_SOURCE_FILE_AT_LINE (79)) ;
  }
  ...
  const GGS_string _temp_6177 = var_cas_makefile_macosx_DIR ;
  if (_temp_6177._isBuilt ()) {
    _temp_6177 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (82)) ;
  }
  const GGS_string _temp_6271 = GGS_string (gWrapperFileContent_0_projectCreationFileWrapper) ;
  if (_temp_6271._isBuilt ()) {
    _temp_6271 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (83)) ;
  }
  const GGS_string _temp_6403 = GGS_string (gWrapperFileContent_2_projectCreationFileWrapper) ;
  if (_temp_6403._isBuilt ()) {
    _temp_6403 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (84)) ;
  }
  const GGS_string _temp_6537 = GGS_string (gWrapperFileContent_1_projectCreationFileWrapper) ;
  if (_temp_6537._isBuilt ()) {
    _temp_6537 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (85)) ;
  }
  const GGS_string _temp_6673 = GGS_string (gWrapperFileContent_3_projectCreationFileWrapper) ;
  if (_temp_6673._isBuilt ()) {
    _temp_6673 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (86)) ;
  }
  const GGS_string _temp_6814 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_6814._isBuilt ()) {
    _temp_6814 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (87)) ;
  }
  const GGS_string _temp_6950 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile64 (var_cas_inProjectName) ;
  if (_temp_6950._isBuilt ()) {
    _temp_6950 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (88)) ;
  }
  ...
  const GGS_string _temp_7152 = var_cas_makefile_mingw_on_macosx_DIR ;
  if (_temp_7152._isBuilt ()) {
    _temp_7152 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (91)) ;
  }
  const GGS_string _temp_7255 = GGS_string (gWrapperFileContent_4_projectCreationFileWrapper) ;
  if (_temp_7255._isBuilt ()) {
    _temp_7255 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (92)) ;
  }
  const GGS_string _temp_7405 = GGS_string (gWrapperFileContent_5_projectCreationFileWrapper) ;
  if (_temp_7405._isBuilt ()) {
    _temp_7405 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (93)) ;
  }
  const GGS_string _temp_7562 = _template_filewrapper_projectCreationFileWrapper_makefile_mingw_on_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_7562._isBuilt ()) {
    _temp_7562 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (94)) ;
  }
  ...
  const GGS_string _temp_7765 = var_cas_makefile_mingw_on_win32_DIR ;
  if (_temp_7765._isBuilt ()) {
    _temp_7765 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (97)) ;
  }
  const GGS_string _temp_7862 = GGS_string (gWrapperFileContent_6_projectCreationFileWrapper) ;
  if (_temp_7862._isBuilt ()) {
    _temp_7862 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/build.bat")) COMMA_SOURCE_FILE_AT_LINE (98)) ;
  }
  const GGS_string _temp_8001 = GGS_string (gWrapperFileContent_7_projectCreationFileWrapper) ;
  if (_temp_8001._isBuilt ()) {
    _temp_8001 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/clean.bat")) COMMA_SOURCE_FILE_AT_LINE (99)) ;
  }
  const GGS_string _temp_8142 = GGS_string (gWrapperFileContent_8_projectCreationFileWrapper) ;
  if (_temp_8142._isBuilt ()) {
    _temp_8142 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/install.bat")) COMMA_SOURCE_FILE_AT_LINE (100)) ;
  }
  const GGS_string _temp_8294 = _template_filewrapper_projectCreationFileWrapper_makefile_msys_on_win32_makefile (var_cas_inProjectName) ;
  if (_temp_8294._isBuilt ()) {
    _temp_8294 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/makefile.mke")) COMMA_SOURCE_FILE_AT_LINE (101)) ;
  }
  ...
  const GGS_string _temp_8462 = var_cas_makefile_unix_DIR ;
  if (_temp_8462._isBuilt ()) {
    _temp_8462 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (104)) ;
  }
  const GGS_string _temp_8561 = _template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile (var_cas_inProjectName) ;
  if (_temp_8561._isBuilt ()) {
    _temp_8561 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (105)) ;
  }
  const GGS_string _temp_8693 = _template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile64 (var_cas_inProjectName) ;
  if (_temp_8693._isBuilt ()) {
    _temp_8693 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (106)) ;
  }
  ...
  const GGS_string _temp_8909 = var_cas_makefile_x86linux_on_macosx_DIR ;
  if (_temp_8909._isBuilt ()) {
    _temp_8909 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (109)) ;
  }
  const GGS_string _temp_9015 = GGS_string (gWrapperFileContent_9_projectCreationFileWrapper) ;
  if (_temp_9015._isBuilt ()) {
    _temp_9015 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (110)) ;
  }
  const GGS_string _temp_9172 = GGS_string (gWrapperFileContent_10_projectCreationFileWrapper) ;
  if (_temp_9172._isBuilt ()) {
    _temp_9172 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (111)) ;
  }
  const GGS_string _temp_9336 = _template_filewrapper_projectCreationFileWrapper_makefile_x86linux_on_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_9336._isBuilt ()) {
    _temp_9336 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (112)) ;
  }
  ...
  const GGS_string _temp_9539 = (((var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".xcodeproj")) ;
  if (_temp_9539._isBuilt ()) {
    _temp_9539 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (115)) ;
  }
  const GGS_string _temp_9628 = _template_filewrapper_projectCreationFileWrapper_xcodeProject (var_cas_inProjectName) ;
  if (_temp_9628._isBuilt ()) {
    _temp_9628 (HERE)->method_writeToFile (_inLexique, (((var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".xcodeproj/project.pbxproj")) COMMA_SOURCE_FILE_AT_LINE (116)) ;
  }
  const GGS_string _temp_9785 = _template_filewrapper_projectCreationFileWrapper_info_plist (var_cas_inProjectName) ;
  if (_temp_9785._isBuilt ()) {
    _temp_9785 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/Info.plist")) COMMA_SOURCE_FILE_AT_LINE (117)) ;
  }
  const GGS_string _temp_9902 = GGS_string (gWrapperFileContent_11_projectCreationFileWrapper) ;
  if (_temp_9902._isBuilt ()) {
    _temp_9902 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/main.m")) COMMA_SOURCE_FILE_AT_LINE (118)) ;
  }
  const GGS_string _temp_9986 = (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj")) ;
  if (_temp_9986._isBuilt ()) {
    _temp_9986 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (119)) ;
  }
  const GGS_string _temp_10090 = GGS_string (gWrapperFileContent_12_projectCreationFileWrapper) ;
  if (_temp_10090._isBuilt ()) {
    _temp_10090 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/Credits.rtf")) COMMA_SOURCE_FILE_AT_LINE (120)) ;
  }
  const GGS_string _temp_10247 = GGS_string (gWrapperFileContent_13_projectCreationFileWrapper) ;
  if (_temp_10247._isBuilt ()) {
    _temp_10247 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/InfoPlist.strings")) COMMA_SOURCE_FILE_AT_LINE (121)) ;
  }
...
void routine_projectCreation (C_Compiler & _inLexique,
  ...
  #endif
  if (((var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (131)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_ok ;
    var_cas_ok = var_cas_inProjectName.reader_characterAtIndex (_inLexique, GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (134)).reader_isalpha (_inLexique COMMA_SOURCE_FILE_AT_LINE (134)) ;
    GGS_uint  var_cas_index ;
    var_cas_index = GGS_uint (true, 1U) ;
    GGS_uint _variant_11006 = var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (136)) ;
    GGS_bool _condition_11006 (_variant_11006._isBuilt (), true) ;
    while (_condition_11006.isBuiltAndTrue ()) {
      _condition_11006 = ((var_cas_index)._operator_strictInf (var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (137))))._operator_and (var_cas_ok) ;
      if (_condition_11006.isBuiltAndTrue ()) {
        if (_variant_11006.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (140)) ;
          _condition_11006 = GGS_bool (true, false) ;
        }else{
          _variant_11006._decrement_operation (_inLexique COMMA_HERE) ;
          GGS_char var_cas_c ;
          var_cas_c = var_cas_inProjectName.reader_characterAtIndex (_inLexique, var_cas_index COMMA_SOURCE_FILE_AT_LINE (138)) ;
          var_cas_ok = (var_cas_c.reader_isalnum (_inLexique COMMA_SOURCE_FILE_AT_LINE (139)))._operator_or ((var_cas_c)._operator_isEqual (GGS_char (true, '_'))) ;
          var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (140)) ;
        }
      }
    }
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      var_cas_ok = (var_cas_inProjectName.reader_directoryExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (149)))._operator_not () ;
      if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ::routine_performProjectCreation (_inLexique,  var_cas_inProjectName COMMA_SOURCE_FILE_AT_LINE (154)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
