...
void routine_projectCreation (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_14671 = (var_cas_inProjectName.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_14671.isBuiltAndTrue ()) {
    ...
    GGS_uint _variant_14120 = var_cas_inProjectName.reader_length () ;
    GGS_bool _condition_14120 (_variant_14120.isBuilt (), true) ;
    while (_condition_14120.isBuiltAndTrue ()) {
      _condition_14120 = ((var_cas_idx).operator_strictInf (var_cas_inProjectName.reader_length ())).operator_and (var_cas_ok) ;
