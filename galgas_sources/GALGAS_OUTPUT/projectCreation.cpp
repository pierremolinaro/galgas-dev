...
void routine_projectCreation (const GALGAS_string constinArgument_inProjectPath,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (var_projectName.reader_length (SOURCE_FILE ("projectCreation.gSemantics", 77)).isValid ()) {
      uint32_t variant_5036 = var_projectName.reader_length (SOURCE_FILE ("projectCreation.gSemantics", 77)).uintValue () ;
      bool loop_5036 = true ;
      while (loop_5036) {
        loop_5036 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (var_projectName.reader_length (SOURCE_FILE ("projectCreation.gSemantics", 78)))).operator_and (var_ok COMMA_SOURCE_FILE ("projectCreation.gSemantics", 78)).isValid () ;
        if (loop_5036) {
          loop_5036 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (var_projectName.reader_length (SOURCE_FILE ("projectCreation.gSemantics", 78)))).operator_and (var_ok COMMA_SOURCE_FILE ("projectCreation.gSemantics", 78)).boolValue () ;
        }
        if (loop_5036 && (0 == variant_5036)) {
          loop_5036 = false ;
