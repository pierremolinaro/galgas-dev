...
void routine_projectCreation (C_Compiler & _inLexique,
  ...
  #endif
  if (((var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (157)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_ok ;
    var_cas_ok = var_cas_inProjectName.reader_characterAtIndex (_inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (160)).reader_isalpha (_inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
