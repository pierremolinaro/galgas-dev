...
void routine_projectCreation (const GALGAS_string constinArgument_inProjectPath,
  ...
  if (GALGAS_bool (kIsStrictSup, constinArgument_inProjectPath.reader_length (SOURCE_FILE_AT_LINE (72)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @messageInstructionForGeneration
    ...
    //-------- @ifInstructionForGeneration
    if (var_ok.operator_not (SOURCE_FILE_AT_LINE (84)).isValidAndTrue ()) {
      //-------- @messageInstructionForGeneration
    ...
    if (var_ok.isValidAndTrue ()) {
      ...
      //-------- @ifInstructionForGeneration
      if (var_ok.operator_not (SOURCE_FILE_AT_LINE (92)).isValidAndTrue ()) {
        //-------- @messageInstructionForGeneration
