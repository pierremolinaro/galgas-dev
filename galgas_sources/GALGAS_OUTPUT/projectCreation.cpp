...
void routine_projectCreation (const GALGAS_string constinArgument_inProjectPath,
  ...
  const GALGAS_bool test_0 (GALGAS_bool (kIsStrictSup, constinArgument_inProjectPath.reader_length (SOURCE_FILE_AT_LINE (72)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_1 (var_ok.operator_not (SOURCE_FILE_AT_LINE (84))) ;
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (var_ok) ;
    if (test_2.isValidAndTrue ()) {
      ...
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_3 (var_ok.operator_not (SOURCE_FILE_AT_LINE (92))) ;
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_4 (var_ok) ;
