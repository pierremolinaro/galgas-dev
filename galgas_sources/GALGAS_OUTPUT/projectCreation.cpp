...
void routine_performProjectCreation (C_Compiler & _inLexique,
  ...
  const GGS_string _temp_13348 = (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj")) ;
  if (_temp_13348._isBuilt ()) {
    _temp_13348 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (146)) ;
  }
  const GGS_string _temp_13450 = GGS_string (gWrapperFileContent_23_projectCreationFileWrapper) ;
  if (_temp_13450._isBuilt ()) {
    _temp_13450 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/Credits.rtf")) COMMA_SOURCE_FILE_AT_LINE (147)) ;
  }
  const GGS_string _temp_13606 = GGS_string (gWrapperFileContent_24_projectCreationFileWrapper) ;
  if (_temp_13606._isBuilt ()) {
    _temp_13606 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/InfoPlist.strings")) COMMA_SOURCE_FILE_AT_LINE (148)) ;
  }
...
void routine_projectCreation (C_Compiler & _inLexique,
  ...
  #endif
  if (((var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (158)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_ok ;
    var_cas_ok = var_cas_inProjectName.reader_characterAtIndex (_inLexique, GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (161)).reader_isalpha (_inLexique COMMA_SOURCE_FILE_AT_LINE (161)) ;
    GGS_uint  var_cas_index ;
    var_cas_index = GGS_uint (true, 1U) ;
    GGS_uint _variant_14358 = var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (163)) ;
    GGS_bool _condition_14358 (_variant_14358._isBuilt (), true) ;
    while (_condition_14358.isBuiltAndTrue ()) {
      _condition_14358 = ((var_cas_index)._operator_strictInf (var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (164))))._operator_and (var_cas_ok) ;
      if (_condition_14358.isBuiltAndTrue ()) {
        if (_variant_14358.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (168)) ;
          _condition_14358 = GGS_bool (true, false) ;
        }else{
          _variant_14358._decrement_operation (_inLexique COMMA_HERE) ;
          GGS_char var_cas_c ;
          var_cas_c = var_cas_inProjectName.reader_characterAtIndex (_inLexique, var_cas_index COMMA_SOURCE_FILE_AT_LINE (165)) ;
          var_cas_ok = (var_cas_c.reader_isalnum (_inLexique COMMA_SOURCE_FILE_AT_LINE (166)))._operator_or ((var_cas_c)._operator_isEqual (GGS_char (true, '_'))) ;
          var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (167)) ;
        }
      }
    }
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      var_cas_ok = (var_cas_inProjectName.reader_directoryExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (176)))._operator_not () ;
      if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
