...
void routine_performProjectCreation (C_Compiler & _inLexique,
  ...
  const GGS_string _temp_4700 = var_cas_galgas_sources_DIR ;
  if (_temp_4700._isBuilt ()) {
    _temp_4700 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (67)) ;
  }
  const GGS_string _temp_4782 = _template_filewrapper_projectCreationFileWrapper_all_ggs (var_cas_inProjectName) ;
  if (_temp_4782._isBuilt ()) {
    _temp_4782 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/_all_")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".ggs")) COMMA_SOURCE_FILE_AT_LINE (68)) ;
  }
  const GGS_string _temp_4923 = _template_filewrapper_projectCreationFileWrapper_PROJECT_cocoa (var_cas_inProjectName) ;
  if (_temp_4923._isBuilt ()) {
    _temp_4923 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_cocoa.ggs")) COMMA_SOURCE_FILE_AT_LINE (69)) ;
  }
  const GGS_string _temp_5067 = _template_filewrapper_projectCreationFileWrapper_PROJECT_grammar (var_cas_inProjectName) ;
  if (_temp_5067._isBuilt ()) {
    _temp_5067 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_grammar.ggs")) COMMA_SOURCE_FILE_AT_LINE (70)) ;
  }
  const GGS_string _temp_5213 = _template_filewrapper_projectCreationFileWrapper_PROJECT_lexique (var_cas_inProjectName) ;
  if (_temp_5213._isBuilt ()) {
    _temp_5213 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_lexique.ggs")) COMMA_SOURCE_FILE_AT_LINE (71)) ;
  }
  const GGS_string _temp_5359 = _template_filewrapper_projectCreationFileWrapper_PROJECT_options (var_cas_inProjectName) ;
  if (_temp_5359._isBuilt ()) {
    _temp_5359 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_options.ggs")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
  }
  const GGS_string _temp_5505 = _template_filewrapper_projectCreationFileWrapper_PROJECT_program (var_cas_inProjectName) ;
  if (_temp_5505._isBuilt ()) {
    _temp_5505 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_program.ggs")) COMMA_SOURCE_FILE_AT_LINE (73)) ;
  }
  const GGS_string _temp_5653 = _template_filewrapper_projectCreationFileWrapper_PROJECT_semantics (var_cas_inProjectName) ;
  if (_temp_5653._isBuilt ()) {
    _temp_5653 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_semantics.ggs")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
  }
  const GGS_string _temp_5800 = _template_filewrapper_projectCreationFileWrapper_PROJECT_syntax (var_cas_inProjectName) ;
  if (_temp_5800._isBuilt ()) {
    _temp_5800 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_syntax.ggs")) COMMA_SOURCE_FILE_AT_LINE (75)) ;
  }
  const GGS_string _temp_5939 = _template_filewrapper_projectCreationFileWrapper_build_bat (var_cas_inProjectName) ;
  if (_temp_5939._isBuilt ()) {
    _temp_5939 (HERE)->method_writeToFile (_inLexique, (var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/build.bat")) COMMA_SOURCE_FILE_AT_LINE (76)) ;
  }
  ...
  const GGS_string _temp_6115 = var_cas_hand_coded_sources_DIR ;
  if (_temp_6115._isBuilt ()) {
    _temp_6115 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (79)) ;
  }
  const GGS_string _temp_6210 = _template_filewrapper_projectCreationFileWrapper_PROJECT_computations (var_cas_inProjectName) ;
  if (_temp_6210._isBuilt ()) {
    _temp_6210 (HERE)->method_writeToFile (_inLexique, (((var_cas_hand_coded_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_computations.cpp")) COMMA_SOURCE_FILE_AT_LINE (80)) ;
  }
  ...
  const GGS_string _temp_6405 = var_cas_makefile_macosx_DIR ;
  if (_temp_6405._isBuilt ()) {
    _temp_6405 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
  }
  const GGS_string _temp_6507 = GGS_string (gWrapperFileContent_0_projectCreationFileWrapper) ;
  if (_temp_6507._isBuilt ()) {
    _temp_6507 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (84)) ;
  }
  const GGS_string _temp_6648 = GGS_string (gWrapperFileContent_2_projectCreationFileWrapper) ;
  if (_temp_6648._isBuilt ()) {
    _temp_6648 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (85)) ;
  }
  const GGS_string _temp_6791 = GGS_string (gWrapperFileContent_1_projectCreationFileWrapper) ;
  if (_temp_6791._isBuilt ()) {
    _temp_6791 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (86)) ;
  }
  const GGS_string _temp_6936 = GGS_string (gWrapperFileContent_3_projectCreationFileWrapper) ;
  if (_temp_6936._isBuilt ()) {
    _temp_6936 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (87)) ;
  }
  const GGS_string _temp_7076 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_7076._isBuilt ()) {
    _temp_7076 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (88)) ;
  }
  const GGS_string _temp_7211 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile64 (var_cas_inProjectName) ;
  if (_temp_7211._isBuilt ()) {
    _temp_7211 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (89)) ;
  }
  ...
  const GGS_string _temp_7393 = var_cas_makefile_macosx_ppc_DIR ;
  if (_temp_7393._isBuilt ()) {
    _temp_7393 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (92)) ;
  }
  const GGS_string _temp_7499 = GGS_string (gWrapperFileContent_8_projectCreationFileWrapper) ;
  if (_temp_7499._isBuilt ()) {
    _temp_7499 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (93)) ;
  }
  const GGS_string _temp_7648 = GGS_string (gWrapperFileContent_10_projectCreationFileWrapper) ;
  if (_temp_7648._isBuilt ()) {
    _temp_7648 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (94)) ;
  }
  const GGS_string _temp_7799 = GGS_string (gWrapperFileContent_9_projectCreationFileWrapper) ;
  if (_temp_7799._isBuilt ()) {
    _temp_7799 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (95)) ;
  }
  const GGS_string _temp_7952 = GGS_string (gWrapperFileContent_11_projectCreationFileWrapper) ;
  if (_temp_7952._isBuilt ()) {
    _temp_7952 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (96)) ;
  }
  const GGS_string _temp_8100 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_ppc_makefile (var_cas_inProjectName) ;
  if (_temp_8100._isBuilt ()) {
    _temp_8100 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (97)) ;
  }
  const GGS_string _temp_8243 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_ppc_makefile64 (var_cas_inProjectName) ;
  if (_temp_8243._isBuilt ()) {
    _temp_8243 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (98)) ;
  }
  ...
  const GGS_string _temp_8433 = var_cas_makefile_macosx_i386_DIR ;
  if (_temp_8433._isBuilt ()) {
    _temp_8433 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (101)) ;
  }
  const GGS_string _temp_8540 = GGS_string (gWrapperFileContent_4_projectCreationFileWrapper) ;
  if (_temp_8540._isBuilt ()) {
    _temp_8540 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (102)) ;
  }
  const GGS_string _temp_8691 = GGS_string (gWrapperFileContent_6_projectCreationFileWrapper) ;
  if (_temp_8691._isBuilt ()) {
    _temp_8691 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (103)) ;
  }
  const GGS_string _temp_8844 = GGS_string (gWrapperFileContent_5_projectCreationFileWrapper) ;
  if (_temp_8844._isBuilt ()) {
    _temp_8844 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (104)) ;
  }
  const GGS_string _temp_8999 = GGS_string (gWrapperFileContent_7_projectCreationFileWrapper) ;
  if (_temp_8999._isBuilt ()) {
    _temp_8999 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (105)) ;
  }
  const GGS_string _temp_9149 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_i386_makefile (var_cas_inProjectName) ;
  if (_temp_9149._isBuilt ()) {
    _temp_9149 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (106)) ;
  }
  const GGS_string _temp_9294 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_i386_makefile64 (var_cas_inProjectName) ;
  if (_temp_9294._isBuilt ()) {
    _temp_9294 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (107)) ;
  }
  ...
  const GGS_string _temp_9505 = var_cas_makefile_macosx_universal_DIR ;
  if (_temp_9505._isBuilt ()) {
    _temp_9505 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (110)) ;
  }
  const GGS_string _temp_9617 = GGS_string (gWrapperFileContent_12_projectCreationFileWrapper) ;
  if (_temp_9617._isBuilt ()) {
    _temp_9617 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (111)) ;
  }
  const GGS_string _temp_9779 = GGS_string (gWrapperFileContent_14_projectCreationFileWrapper) ;
  if (_temp_9779._isBuilt ()) {
    _temp_9779 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (112)) ;
  }
  const GGS_string _temp_9943 = GGS_string (gWrapperFileContent_13_projectCreationFileWrapper) ;
  if (_temp_9943._isBuilt ()) {
    _temp_9943 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (113)) ;
  }
  const GGS_string _temp_10108 = GGS_string (gWrapperFileContent_15_projectCreationFileWrapper) ;
  if (_temp_10108._isBuilt ()) {
    _temp_10108 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (114)) ;
  }
  const GGS_string _temp_10269 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_universal_makefile (var_cas_inProjectName) ;
  if (_temp_10269._isBuilt ()) {
    _temp_10269 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (115)) ;
  }
  const GGS_string _temp_10425 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_universal_makefile64 (var_cas_inProjectName) ;
  if (_temp_10425._isBuilt ()) {
    _temp_10425 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (116)) ;
  }
  ...
  const GGS_string _temp_10638 = var_cas_makefile_mingw_on_macosx_DIR ;
  if (_temp_10638._isBuilt ()) {
    _temp_10638 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (119)) ;
  }
  const GGS_string _temp_10749 = GGS_string (gWrapperFileContent_16_projectCreationFileWrapper) ;
  if (_temp_10749._isBuilt ()) {
    _temp_10749 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (120)) ;
  }
  const GGS_string _temp_10908 = GGS_string (gWrapperFileContent_17_projectCreationFileWrapper) ;
  if (_temp_10908._isBuilt ()) {
    _temp_10908 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (121)) ;
  }
  const GGS_string _temp_11064 = _template_filewrapper_projectCreationFileWrapper_makefile_mingw_on_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_11064._isBuilt ()) {
    _temp_11064 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (122)) ;
  }
  ...
  const GGS_string _temp_11267 = var_cas_makefile_mingw_on_win32_DIR ;
  if (_temp_11267._isBuilt ()) {
    _temp_11267 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
  }
  const GGS_string _temp_11362 = GGS_string (gWrapperFileContent_18_projectCreationFileWrapper) ;
  if (_temp_11362._isBuilt ()) {
    _temp_11362 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/build.bat")) COMMA_SOURCE_FILE_AT_LINE (126)) ;
  }
  const GGS_string _temp_11500 = GGS_string (gWrapperFileContent_19_projectCreationFileWrapper) ;
  if (_temp_11500._isBuilt ()) {
    _temp_11500 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/clean.bat")) COMMA_SOURCE_FILE_AT_LINE (127)) ;
  }
  const GGS_string _temp_11640 = GGS_string (gWrapperFileContent_20_projectCreationFileWrapper) ;
  if (_temp_11640._isBuilt ()) {
    _temp_11640 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/install.bat")) COMMA_SOURCE_FILE_AT_LINE (128)) ;
  }
  const GGS_string _temp_11791 = _template_filewrapper_projectCreationFileWrapper_makefile_msys_on_win32_makefile (var_cas_inProjectName) ;
  if (_temp_11791._isBuilt ()) {
    _temp_11791 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/makefile.mke")) COMMA_SOURCE_FILE_AT_LINE (129)) ;
  }
  ...
  const GGS_string _temp_11959 = var_cas_makefile_unix_DIR ;
  if (_temp_11959._isBuilt ()) {
    _temp_11959 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
  }
  const GGS_string _temp_12056 = _template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile (var_cas_inProjectName) ;
  if (_temp_12056._isBuilt ()) {
    _temp_12056 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (133)) ;
  }
  const GGS_string _temp_12187 = _template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile64 (var_cas_inProjectName) ;
  if (_temp_12187._isBuilt ()) {
    _temp_12187 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (134)) ;
  }
  ...
  const GGS_string _temp_12403 = var_cas_makefile_x86linux_on_macosx_DIR ;
  if (_temp_12403._isBuilt ()) {
    _temp_12403 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
  }
  const GGS_string _temp_12517 = GGS_string (gWrapperFileContent_21_projectCreationFileWrapper) ;
  if (_temp_12517._isBuilt ()) {
    _temp_12517 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (138)) ;
  }
  const GGS_string _temp_12683 = GGS_string (gWrapperFileContent_22_projectCreationFileWrapper) ;
  if (_temp_12683._isBuilt ()) {
    _temp_12683 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (139)) ;
  }
  const GGS_string _temp_12846 = _template_filewrapper_projectCreationFileWrapper_makefile_x86linux_on_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_12846._isBuilt ()) {
    _temp_12846 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (140)) ;
  }
  ...
  const GGS_string _temp_13046 = (((var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".xcodeproj")) ;
  if (_temp_13046._isBuilt ()) {
    _temp_13046 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
  }
  const GGS_string _temp_13131 = _template_filewrapper_projectCreationFileWrapper_info_plist (var_cas_inProjectName) ;
  if (_temp_13131._isBuilt ()) {
    _temp_13131 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/Info.plist")) COMMA_SOURCE_FILE_AT_LINE (144)) ;
  }
  const GGS_string _temp_13219 = (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj")) ;
  if (_temp_13219._isBuilt ()) {
    _temp_13219 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (145)) ;
  }
  const GGS_string _temp_13321 = GGS_string (gWrapperFileContent_23_projectCreationFileWrapper) ;
  if (_temp_13321._isBuilt ()) {
    _temp_13321 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/Credits.rtf")) COMMA_SOURCE_FILE_AT_LINE (146)) ;
  }
  const GGS_string _temp_13467 = _template_filewrapper_projectCreationFileWrapper_cocoa_infoPlist_strings (var_cas_inProjectName) ;
  if (_temp_13467._isBuilt ()) {
    _temp_13467 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/InfoPlist.strings")) COMMA_SOURCE_FILE_AT_LINE (147)) ;
  }
...
void routine_projectCreation (C_Compiler & _inLexique,
  ...
  #endif
  if (((var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (157)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_ok ;
    var_cas_ok = var_cas_inProjectName.reader_characterAtIndex (_inLexique, GGS_uint (true, 0U) COMMA_SOURCE_FILE_AT_LINE (160)).reader_isalpha (_inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
    GGS_uint  var_cas_index ;
    var_cas_index = GGS_uint (true, 1U) ;
    GGS_uint _variant_14219 = var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)) ;
    GGS_bool _condition_14219 (_variant_14219._isBuilt (), true) ;
    while (_condition_14219.isBuiltAndTrue ()) {
      _condition_14219 = ((var_cas_index)._operator_strictInf (var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (163))))._operator_and (var_cas_ok) ;
      if (_condition_14219.isBuiltAndTrue ()) {
        if (_variant_14219.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (167)) ;
          _condition_14219 = GGS_bool (true, false) ;
        }else{
          _variant_14219._decrement_operation (_inLexique COMMA_HERE) ;
          GGS_char var_cas_c ;
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      var_cas_ok = (var_cas_inProjectName.reader_directoryExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (175)))._operator_not () ;
      if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
    ...
    if ((var_cas_ok).isBuiltAndTrue ()) {
      ::routine_performProjectCreation (_inLexique,  var_cas_inProjectName COMMA_SOURCE_FILE_AT_LINE (181)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
