...
GALGAS_string filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_project (C_Compiler * /* inCompiler */,
  ...
  result << ":\n"
    ...
    "  %makefile-macosx\n"
    "  %makefile-unix\n"
    "  %makefile-x86-linux32-on-macosx\n"
    "  %makefile-x86-linux64-on-macosx\n"
    "  %makefile-win32-on-macosx\n"
    "  %makefile-msys32-on-windonws\n"
    "  %SnowLeopard\n"
  ...
  result << "-program.galgas\"\n"
    "\n"
    "#--- Extern source file\n"
    "  %tool-source : \"hand-coded-sources/" ;
  result << in_PROJECT_5F_NAME.stringValue () ;
  result << "-computations.cpp\" ;\n"
    "end project ;\n" ;
...
GALGAS_string filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_computations (C_Compiler * inCompiler,
  ...
  result << "//---------------------------------------------------------------------------------------------------------------------*\n"
    "//                                                                                                                     *\n"
    "//" ;
  result << in_PROJECT_5F_NAME.add_operation (GALGAS_string (" Project"), inCompiler COMMA_SOURCE_FILE ("PROJECT-computations.cpp.gTemplate", 3)).reader_stringByLeftAndRightPadding (GALGAS_uint ((uint32_t) 117U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("PROJECT-computations.cpp.gTemplate", 3)).stringValue () ;
  result << "*\n"
...
void routine_performProjectCreation (const GALGAS_string constinArgument_inProjectPath,
  ...
  GALGAS_string var_hand_5F_coded_5F_sources_5F_DIR = constinArgument_inProjectPath.operator_concat (GALGAS_string ("/hand-coded-sources")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 59)) ;
  var_hand_5F_coded_5F_sources_5F_DIR.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("projectCreation.gSemantics", 60)) ;
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_computations (inCompiler, var_projectName COMMA_SOURCE_FILE ("projectCreation.gSemantics", 61))).method_writeToFile (var_hand_5F_coded_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 61)).operator_concat (var_projectName  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 61)).operator_concat (GALGAS_string ("-computations.cpp")  COMMA_SOURCE_FILE ("projectCreation.gSemantics", 61)), inCompiler COMMA_SOURCE_FILE ("projectCreation.gSemantics", 61)) ;
...
void routine_projectCreation (const GALGAS_string constinArgument_inProjectPath,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (var_projectName.reader_length (SOURCE_FILE ("projectCreation.gSemantics", 77)).isValid ()) {
      uint32_t variant_4986 = var_projectName.reader_length (SOURCE_FILE ("projectCreation.gSemantics", 77)).uintValue () ;
      bool loop_4986 = true ;
      while (loop_4986) {
        loop_4986 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (var_projectName.reader_length (SOURCE_FILE ("projectCreation.gSemantics", 78)))).operator_and (var_ok COMMA_SOURCE_FILE ("projectCreation.gSemantics", 78)).isValid () ;
        if (loop_4986) {
          loop_4986 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (var_projectName.reader_length (SOURCE_FILE ("projectCreation.gSemantics", 78)))).operator_and (var_ok COMMA_SOURCE_FILE ("projectCreation.gSemantics", 78)).boolValue () ;
        }
        if (loop_4986 && (0 == variant_4986)) {
          loop_4986 = false ;
