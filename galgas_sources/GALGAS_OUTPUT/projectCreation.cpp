...
_template_filewrapper_projectCreationFileWrapper_all_ggs (const GGS_string& var_cas_PROJECT_NAME) {
  ...
  if (isBuilt) {
    ...
    "  option \"" ;
    _result << var_cas_PROJECT_NAME ;
    _result << "_options.gOption\" : makefile, xcode_tool, xcode_app ;\n"
    "  semantics \"" ;
    _result << var_cas_PROJECT_NAME ;
...
void routine_performProjectCreation (C_Compiler & inLexique,
  ...
  if (_temp_4699.isBuilt ()) {
    _temp_4699 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (67)) ;
  }
  const GGS_string _temp_4781 = _template_filewrapper_projectCreationFileWrapper_all_ggs (var_cas_inProjectName) ;
  if (_temp_4781.isBuilt ()) {
    _temp_4781 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/all_"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string (".ggs")) COMMA_SOURCE_FILE_AT_LINE (68)) ;
  }
  const GGS_string _temp_4921 = _template_filewrapper_projectCreationFileWrapper_PROJECT_cocoa (var_cas_inProjectName) ;
  if (_temp_4921.isBuilt ()) {
    _temp_4921 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_cocoa.ggs")) COMMA_SOURCE_FILE_AT_LINE (69)) ;
  }
  const GGS_string _temp_5065 = _template_filewrapper_projectCreationFileWrapper_PROJECT_grammar (var_cas_inProjectName) ;
  if (_temp_5065.isBuilt ()) {
    _temp_5065 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_grammar.ggs")) COMMA_SOURCE_FILE_AT_LINE (70)) ;
  }
  const GGS_string _temp_5211 = _template_filewrapper_projectCreationFileWrapper_PROJECT_lexique (var_cas_inProjectName) ;
  if (_temp_5211.isBuilt ()) {
    _temp_5211 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_lexique.ggs")) COMMA_SOURCE_FILE_AT_LINE (71)) ;
  }
  const GGS_string _temp_5357 = _template_filewrapper_projectCreationFileWrapper_PROJECT_options (var_cas_inProjectName) ;
  if (_temp_5357.isBuilt ()) {
    _temp_5357 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_options.gOption")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
  }
  const GGS_string _temp_5507 = _template_filewrapper_projectCreationFileWrapper_PROJECT_program (var_cas_inProjectName) ;
  if (_temp_5507.isBuilt ()) {
    _temp_5507 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_program.ggs")) COMMA_SOURCE_FILE_AT_LINE (73)) ;
  }
  const GGS_string _temp_5655 = _template_filewrapper_projectCreationFileWrapper_PROJECT_semantics (var_cas_inProjectName) ;
  if (_temp_5655.isBuilt ()) {
    _temp_5655 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_semantics.ggs")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
  }
  const GGS_string _temp_5802 = _template_filewrapper_projectCreationFileWrapper_PROJECT_syntax (var_cas_inProjectName) ;
  if (_temp_5802.isBuilt ()) {
    _temp_5802 (HERE)->method_writeToFile (inLexique, (((var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_syntax.ggs")) COMMA_SOURCE_FILE_AT_LINE (75)) ;
  }
  const GGS_string _temp_5941 = _template_filewrapper_projectCreationFileWrapper_build_bat (var_cas_inProjectName) ;
  if (_temp_5941.isBuilt ()) {
    _temp_5941 (HERE)->method_writeToFile (inLexique, (var_cas_galgas_sources_DIR).operator_concat (GGS_string ("/build.bat")) COMMA_SOURCE_FILE_AT_LINE (76)) ;
  }
  ...
  const GGS_string _temp_6117 = var_cas_hand_coded_sources_DIR ;
  if (_temp_6117.isBuilt ()) {
    _temp_6117 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (79)) ;
  }
  const GGS_string _temp_6212 = _template_filewrapper_projectCreationFileWrapper_PROJECT_computations (var_cas_inProjectName) ;
  if (_temp_6212.isBuilt ()) {
    _temp_6212 (HERE)->method_writeToFile (inLexique, (((var_cas_hand_coded_sources_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string ("_computations.cpp")) COMMA_SOURCE_FILE_AT_LINE (80)) ;
  }
  ...
  const GGS_string _temp_6407 = var_cas_makefile_macosx_DIR ;
  if (_temp_6407.isBuilt ()) {
    _temp_6407 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
  }
  const GGS_string _temp_6509 = GGS_string (gWrapperFileContent_0_projectCreationFileWrapper) ;
  if (_temp_6509.isBuilt ()) {
    _temp_6509 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_DIR).operator_concat (GGS_string ("/build.command")) COMMA_SOURCE_FILE_AT_LINE (84)) ;
  }
  const GGS_string _temp_6650 = GGS_string (gWrapperFileContent_2_projectCreationFileWrapper) ;
  if (_temp_6650.isBuilt ()) {
    _temp_6650 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_DIR).operator_concat (GGS_string ("/clean.command")) COMMA_SOURCE_FILE_AT_LINE (85)) ;
  }
  const GGS_string _temp_6793 = GGS_string (gWrapperFileContent_1_projectCreationFileWrapper) ;
  if (_temp_6793.isBuilt ()) {
    _temp_6793 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_DIR).operator_concat (GGS_string ("/build64.command")) COMMA_SOURCE_FILE_AT_LINE (86)) ;
  }
  const GGS_string _temp_6938 = GGS_string (gWrapperFileContent_3_projectCreationFileWrapper) ;
  if (_temp_6938.isBuilt ()) {
    _temp_6938 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_DIR).operator_concat (GGS_string ("/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (87)) ;
  }
  const GGS_string _temp_7078 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_7078.isBuilt ()) {
    _temp_7078 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (88)) ;
  }
  const GGS_string _temp_7213 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile64 (var_cas_inProjectName) ;
  if (_temp_7213.isBuilt ()) {
    _temp_7213 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_DIR).operator_concat (GGS_string ("/makefile64")) COMMA_SOURCE_FILE_AT_LINE (89)) ;
  }
  ...
  const GGS_string _temp_7395 = var_cas_makefile_macosx_ppc_DIR ;
  if (_temp_7395.isBuilt ()) {
    _temp_7395 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (92)) ;
  }
  const GGS_string _temp_7501 = GGS_string (gWrapperFileContent_8_projectCreationFileWrapper) ;
  if (_temp_7501.isBuilt ()) {
    _temp_7501 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_ppc_DIR).operator_concat (GGS_string ("/build.command")) COMMA_SOURCE_FILE_AT_LINE (93)) ;
  }
  const GGS_string _temp_7650 = GGS_string (gWrapperFileContent_10_projectCreationFileWrapper) ;
  if (_temp_7650.isBuilt ()) {
    _temp_7650 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_ppc_DIR).operator_concat (GGS_string ("/clean.command")) COMMA_SOURCE_FILE_AT_LINE (94)) ;
  }
  const GGS_string _temp_7801 = GGS_string (gWrapperFileContent_9_projectCreationFileWrapper) ;
  if (_temp_7801.isBuilt ()) {
    _temp_7801 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_ppc_DIR).operator_concat (GGS_string ("/build64.command")) COMMA_SOURCE_FILE_AT_LINE (95)) ;
  }
  const GGS_string _temp_7954 = GGS_string (gWrapperFileContent_11_projectCreationFileWrapper) ;
  if (_temp_7954.isBuilt ()) {
    _temp_7954 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_ppc_DIR).operator_concat (GGS_string ("/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (96)) ;
  }
  const GGS_string _temp_8102 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_ppc_makefile (var_cas_inProjectName) ;
  if (_temp_8102.isBuilt ()) {
    _temp_8102 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_ppc_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (97)) ;
  }
  const GGS_string _temp_8245 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_ppc_makefile64 (var_cas_inProjectName) ;
  if (_temp_8245.isBuilt ()) {
    _temp_8245 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_ppc_DIR).operator_concat (GGS_string ("/makefile64")) COMMA_SOURCE_FILE_AT_LINE (98)) ;
  }
  ...
  const GGS_string _temp_8435 = var_cas_makefile_macosx_i386_DIR ;
  if (_temp_8435.isBuilt ()) {
    _temp_8435 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (101)) ;
  }
  const GGS_string _temp_8542 = GGS_string (gWrapperFileContent_4_projectCreationFileWrapper) ;
  if (_temp_8542.isBuilt ()) {
    _temp_8542 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_i386_DIR).operator_concat (GGS_string ("/build.command")) COMMA_SOURCE_FILE_AT_LINE (102)) ;
  }
  const GGS_string _temp_8693 = GGS_string (gWrapperFileContent_6_projectCreationFileWrapper) ;
  if (_temp_8693.isBuilt ()) {
    _temp_8693 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_i386_DIR).operator_concat (GGS_string ("/clean.command")) COMMA_SOURCE_FILE_AT_LINE (103)) ;
  }
  const GGS_string _temp_8846 = GGS_string (gWrapperFileContent_5_projectCreationFileWrapper) ;
  if (_temp_8846.isBuilt ()) {
    _temp_8846 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_i386_DIR).operator_concat (GGS_string ("/build64.command")) COMMA_SOURCE_FILE_AT_LINE (104)) ;
  }
  const GGS_string _temp_9001 = GGS_string (gWrapperFileContent_7_projectCreationFileWrapper) ;
  if (_temp_9001.isBuilt ()) {
    _temp_9001 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_i386_DIR).operator_concat (GGS_string ("/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (105)) ;
  }
  const GGS_string _temp_9151 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_i386_makefile (var_cas_inProjectName) ;
  if (_temp_9151.isBuilt ()) {
    _temp_9151 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_i386_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (106)) ;
  }
  const GGS_string _temp_9296 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_i386_makefile64 (var_cas_inProjectName) ;
  if (_temp_9296.isBuilt ()) {
    _temp_9296 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_i386_DIR).operator_concat (GGS_string ("/makefile64")) COMMA_SOURCE_FILE_AT_LINE (107)) ;
  }
  ...
  const GGS_string _temp_9507 = var_cas_makefile_macosx_universal_DIR ;
  if (_temp_9507.isBuilt ()) {
    _temp_9507 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (110)) ;
  }
  const GGS_string _temp_9619 = GGS_string (gWrapperFileContent_12_projectCreationFileWrapper) ;
  if (_temp_9619.isBuilt ()) {
    _temp_9619 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_universal_DIR).operator_concat (GGS_string ("/build.command")) COMMA_SOURCE_FILE_AT_LINE (111)) ;
  }
  const GGS_string _temp_9781 = GGS_string (gWrapperFileContent_14_projectCreationFileWrapper) ;
  if (_temp_9781.isBuilt ()) {
    _temp_9781 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_universal_DIR).operator_concat (GGS_string ("/clean.command")) COMMA_SOURCE_FILE_AT_LINE (112)) ;
  }
  const GGS_string _temp_9945 = GGS_string (gWrapperFileContent_13_projectCreationFileWrapper) ;
  if (_temp_9945.isBuilt ()) {
    _temp_9945 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_universal_DIR).operator_concat (GGS_string ("/build64.command")) COMMA_SOURCE_FILE_AT_LINE (113)) ;
  }
  const GGS_string _temp_10110 = GGS_string (gWrapperFileContent_15_projectCreationFileWrapper) ;
  if (_temp_10110.isBuilt ()) {
    _temp_10110 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_macosx_universal_DIR).operator_concat (GGS_string ("/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (114)) ;
  }
  const GGS_string _temp_10271 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_universal_makefile (var_cas_inProjectName) ;
  if (_temp_10271.isBuilt ()) {
    _temp_10271 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_universal_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (115)) ;
  }
  const GGS_string _temp_10427 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_universal_makefile64 (var_cas_inProjectName) ;
  if (_temp_10427.isBuilt ()) {
    _temp_10427 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_macosx_universal_DIR).operator_concat (GGS_string ("/makefile64")) COMMA_SOURCE_FILE_AT_LINE (116)) ;
  }
  ...
  const GGS_string _temp_10640 = var_cas_makefile_mingw_on_macosx_DIR ;
  if (_temp_10640.isBuilt ()) {
    _temp_10640 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (119)) ;
  }
  const GGS_string _temp_10751 = GGS_string (gWrapperFileContent_16_projectCreationFileWrapper) ;
  if (_temp_10751.isBuilt ()) {
    _temp_10751 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_mingw_on_macosx_DIR).operator_concat (GGS_string ("/build.command")) COMMA_SOURCE_FILE_AT_LINE (120)) ;
  }
  const GGS_string _temp_10910 = GGS_string (gWrapperFileContent_17_projectCreationFileWrapper) ;
  if (_temp_10910.isBuilt ()) {
    _temp_10910 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_mingw_on_macosx_DIR).operator_concat (GGS_string ("/clean.command")) COMMA_SOURCE_FILE_AT_LINE (121)) ;
  }
  const GGS_string _temp_11066 = _template_filewrapper_projectCreationFileWrapper_makefile_mingw_on_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_11066.isBuilt ()) {
    _temp_11066 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_mingw_on_macosx_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (122)) ;
  }
  ...
  const GGS_string _temp_11269 = var_cas_makefile_mingw_on_win32_DIR ;
  if (_temp_11269.isBuilt ()) {
    _temp_11269 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
  }
  const GGS_string _temp_11364 = GGS_string (gWrapperFileContent_18_projectCreationFileWrapper) ;
  if (_temp_11364.isBuilt ()) {
    _temp_11364 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_mingw_on_win32_DIR).operator_concat (GGS_string ("/build.bat")) COMMA_SOURCE_FILE_AT_LINE (126)) ;
  }
  const GGS_string _temp_11502 = GGS_string (gWrapperFileContent_19_projectCreationFileWrapper) ;
  if (_temp_11502.isBuilt ()) {
    _temp_11502 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_mingw_on_win32_DIR).operator_concat (GGS_string ("/clean.bat")) COMMA_SOURCE_FILE_AT_LINE (127)) ;
  }
  const GGS_string _temp_11642 = GGS_string (gWrapperFileContent_20_projectCreationFileWrapper) ;
  if (_temp_11642.isBuilt ()) {
    _temp_11642 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_mingw_on_win32_DIR).operator_concat (GGS_string ("/install.bat")) COMMA_SOURCE_FILE_AT_LINE (128)) ;
  }
  const GGS_string _temp_11793 = _template_filewrapper_projectCreationFileWrapper_makefile_msys_on_win32_makefile (var_cas_inProjectName) ;
  if (_temp_11793.isBuilt ()) {
    _temp_11793 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_mingw_on_win32_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (129)) ;
  }
  ...
  if (_temp_11957.isBuilt ()) {
    _temp_11957 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
  }
  ...
  if (_temp_12054.isBuilt ()) {
    _temp_12054 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_unix_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (133)) ;
  }
  ...
  if (_temp_12185.isBuilt ()) {
    _temp_12185 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_unix_DIR).operator_concat (GGS_string ("/makefile64")) COMMA_SOURCE_FILE_AT_LINE (134)) ;
  }
  ...
  if (_temp_12401.isBuilt ()) {
    _temp_12401 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
  }
  const GGS_string _temp_12515 = GGS_string (gWrapperFileContent_21_projectCreationFileWrapper) ;
  if (_temp_12515.isBuilt ()) {
    _temp_12515 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_x86linux_on_macosx_DIR).operator_concat (GGS_string ("/build.command")) COMMA_SOURCE_FILE_AT_LINE (138)) ;
  }
  const GGS_string _temp_12681 = GGS_string (gWrapperFileContent_22_projectCreationFileWrapper) ;
  if (_temp_12681.isBuilt ()) {
    _temp_12681 (HERE)->method_writeToExecutableFile (inLexique, (var_cas_makefile_x86linux_on_macosx_DIR).operator_concat (GGS_string ("/clean.command")) COMMA_SOURCE_FILE_AT_LINE (139)) ;
  }
  ...
  if (_temp_12844.isBuilt ()) {
    _temp_12844 (HERE)->method_writeToFile (inLexique, (var_cas_makefile_x86linux_on_macosx_DIR).operator_concat (GGS_string ("/makefile")) COMMA_SOURCE_FILE_AT_LINE (140)) ;
  }
  ...
  const GGS_string _temp_13044 = (((var_cas_projectxcode_DIR).operator_concat (GGS_string ("/"))).operator_concat (var_cas_inProjectName)).operator_concat (GGS_string (".xcodeproj")) ;
  if (_temp_13044.isBuilt ()) {
    _temp_13044 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
  }
  const GGS_string _temp_13129 = _template_filewrapper_projectCreationFileWrapper_info_plist (var_cas_inProjectName) ;
  if (_temp_13129.isBuilt ()) {
    _temp_13129 (HERE)->method_writeToFile (inLexique, (var_cas_projectxcode_DIR).operator_concat (GGS_string ("/Info.plist")) COMMA_SOURCE_FILE_AT_LINE (144)) ;
  }
  const GGS_string _temp_13217 = (var_cas_projectxcode_DIR).operator_concat (GGS_string ("/English.lproj")) ;
  if (_temp_13217.isBuilt ()) {
    _temp_13217 (HERE)->method_makeDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (145)) ;
  }
  const GGS_string _temp_13319 = GGS_string (gWrapperFileContent_23_projectCreationFileWrapper) ;
  if (_temp_13319.isBuilt ()) {
    _temp_13319 (HERE)->method_writeToFile (inLexique, (var_cas_projectxcode_DIR).operator_concat (GGS_string ("/English.lproj/Credits.rtf")) COMMA_SOURCE_FILE_AT_LINE (146)) ;
  }
  ...
  if (_temp_13465.isBuilt ()) {
    _temp_13465 (HERE)->method_writeToFile (inLexique, (var_cas_projectxcode_DIR).operator_concat (GGS_string ("/English.lproj/InfoPlist.strings")) COMMA_SOURCE_FILE_AT_LINE (147)) ;
  }
...
void routine_projectCreation (C_Compiler & inLexique,
  ...
  if (((var_cas_inProjectName.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (157))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    GGS_uint _variant_14217 = var_cas_inProjectName.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (162)) ;
    GGS_bool _condition_14217 (_variant_14217.isBuilt (), true) ;
    while (_condition_14217.isBuiltAndTrue ()) {
      _condition_14217 = ((var_cas_index).operator_strictInf (var_cas_inProjectName.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (163)))).operator_and (var_cas_ok) ;
      if (_condition_14217.isBuiltAndTrue ()) {
        if (_variant_14217.uintValue () == 0) {
          ...
          _condition_14217 = GGS_bool (false) ;
        }else{
          _variant_14217.decrement_operation (inLexique COMMA_HERE) ;
          GGS_char var_cas_c ;
