...
void routine_performProjectCreation (C_Compiler & _inLexique,
  ...
  const GGS_string _temp_4699 = var_cas_galgas_sources_DIR ;
  if (_temp_4699._isBuilt ()) {
    _temp_4699 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (67)) ;
  }
  const GGS_string _temp_4781 = _template_filewrapper_projectCreationFileWrapper_all_ggs (var_cas_inProjectName) ;
  if (_temp_4781._isBuilt ()) {
    _temp_4781 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/all_")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".ggs")) COMMA_SOURCE_FILE_AT_LINE (68)) ;
  }
  const GGS_string _temp_4921 = _template_filewrapper_projectCreationFileWrapper_PROJECT_cocoa (var_cas_inProjectName) ;
  if (_temp_4921._isBuilt ()) {
    _temp_4921 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_cocoa.ggs")) COMMA_SOURCE_FILE_AT_LINE (69)) ;
  }
  const GGS_string _temp_5065 = _template_filewrapper_projectCreationFileWrapper_PROJECT_grammar (var_cas_inProjectName) ;
  if (_temp_5065._isBuilt ()) {
    _temp_5065 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_grammar.ggs")) COMMA_SOURCE_FILE_AT_LINE (70)) ;
  }
  const GGS_string _temp_5211 = _template_filewrapper_projectCreationFileWrapper_PROJECT_lexique (var_cas_inProjectName) ;
  if (_temp_5211._isBuilt ()) {
    _temp_5211 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_lexique.ggs")) COMMA_SOURCE_FILE_AT_LINE (71)) ;
  }
  const GGS_string _temp_5357 = _template_filewrapper_projectCreationFileWrapper_PROJECT_options (var_cas_inProjectName) ;
  if (_temp_5357._isBuilt ()) {
    _temp_5357 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_options.ggs")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
  }
  const GGS_string _temp_5503 = _template_filewrapper_projectCreationFileWrapper_PROJECT_program (var_cas_inProjectName) ;
  if (_temp_5503._isBuilt ()) {
    _temp_5503 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_program.ggs")) COMMA_SOURCE_FILE_AT_LINE (73)) ;
  }
  const GGS_string _temp_5651 = _template_filewrapper_projectCreationFileWrapper_PROJECT_semantics (var_cas_inProjectName) ;
  if (_temp_5651._isBuilt ()) {
    _temp_5651 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_semantics.ggs")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
  }
  const GGS_string _temp_5798 = _template_filewrapper_projectCreationFileWrapper_PROJECT_syntax (var_cas_inProjectName) ;
  if (_temp_5798._isBuilt ()) {
    _temp_5798 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_syntax.ggs")) COMMA_SOURCE_FILE_AT_LINE (75)) ;
  }
  const GGS_string _temp_5937 = _template_filewrapper_projectCreationFileWrapper_build_bat (var_cas_inProjectName) ;
  if (_temp_5937._isBuilt ()) {
    _temp_5937 (HERE)->method_writeToFile (_inLexique, (var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/build.bat")) COMMA_SOURCE_FILE_AT_LINE (76)) ;
  }
  ...
  const GGS_string _temp_6113 = var_cas_hand_coded_sources_DIR ;
  if (_temp_6113._isBuilt ()) {
    _temp_6113 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (79)) ;
  }
  const GGS_string _temp_6208 = _template_filewrapper_projectCreationFileWrapper_PROJECT_computations (var_cas_inProjectName) ;
  if (_temp_6208._isBuilt ()) {
    _temp_6208 (HERE)->method_writeToFile (_inLexique, (((var_cas_hand_coded_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_computations.cpp")) COMMA_SOURCE_FILE_AT_LINE (80)) ;
  }
  ...
  const GGS_string _temp_6403 = var_cas_makefile_macosx_DIR ;
  if (_temp_6403._isBuilt ()) {
    _temp_6403 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
  }
  const GGS_string _temp_6505 = GGS_string (gWrapperFileContent_0_projectCreationFileWrapper) ;
  if (_temp_6505._isBuilt ()) {
    _temp_6505 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (84)) ;
  }
  const GGS_string _temp_6646 = GGS_string (gWrapperFileContent_2_projectCreationFileWrapper) ;
  if (_temp_6646._isBuilt ()) {
    _temp_6646 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (85)) ;
  }
  const GGS_string _temp_6789 = GGS_string (gWrapperFileContent_1_projectCreationFileWrapper) ;
  if (_temp_6789._isBuilt ()) {
    _temp_6789 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (86)) ;
  }
  const GGS_string _temp_6934 = GGS_string (gWrapperFileContent_3_projectCreationFileWrapper) ;
  if (_temp_6934._isBuilt ()) {
    _temp_6934 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (87)) ;
  }
  const GGS_string _temp_7074 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_7074._isBuilt ()) {
    _temp_7074 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (88)) ;
  }
  const GGS_string _temp_7209 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile64 (var_cas_inProjectName) ;
  if (_temp_7209._isBuilt ()) {
    _temp_7209 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (89)) ;
  }
  ...
  const GGS_string _temp_7391 = var_cas_makefile_macosx_ppc_DIR ;
  if (_temp_7391._isBuilt ()) {
    _temp_7391 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (92)) ;
  }
  const GGS_string _temp_7497 = GGS_string (gWrapperFileContent_8_projectCreationFileWrapper) ;
  if (_temp_7497._isBuilt ()) {
    _temp_7497 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (93)) ;
  }
  const GGS_string _temp_7646 = GGS_string (gWrapperFileContent_10_projectCreationFileWrapper) ;
  if (_temp_7646._isBuilt ()) {
    _temp_7646 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (94)) ;
  }
  const GGS_string _temp_7797 = GGS_string (gWrapperFileContent_9_projectCreationFileWrapper) ;
  if (_temp_7797._isBuilt ()) {
    _temp_7797 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (95)) ;
  }
  const GGS_string _temp_7950 = GGS_string (gWrapperFileContent_11_projectCreationFileWrapper) ;
  if (_temp_7950._isBuilt ()) {
    _temp_7950 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (96)) ;
  }
  const GGS_string _temp_8098 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_ppc_makefile (var_cas_inProjectName) ;
  if (_temp_8098._isBuilt ()) {
    _temp_8098 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (97)) ;
  }
  const GGS_string _temp_8241 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_ppc_makefile64 (var_cas_inProjectName) ;
  if (_temp_8241._isBuilt ()) {
    _temp_8241 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (98)) ;
  }
  ...
  const GGS_string _temp_8431 = var_cas_makefile_macosx_i386_DIR ;
  if (_temp_8431._isBuilt ()) {
    _temp_8431 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (101)) ;
  }
  const GGS_string _temp_8538 = GGS_string (gWrapperFileContent_4_projectCreationFileWrapper) ;
  if (_temp_8538._isBuilt ()) {
    _temp_8538 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (102)) ;
  }
  const GGS_string _temp_8689 = GGS_string (gWrapperFileContent_6_projectCreationFileWrapper) ;
  if (_temp_8689._isBuilt ()) {
    _temp_8689 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (103)) ;
  }
  const GGS_string _temp_8842 = GGS_string (gWrapperFileContent_5_projectCreationFileWrapper) ;
  if (_temp_8842._isBuilt ()) {
    _temp_8842 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (104)) ;
  }
  const GGS_string _temp_8997 = GGS_string (gWrapperFileContent_7_projectCreationFileWrapper) ;
  if (_temp_8997._isBuilt ()) {
    _temp_8997 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (105)) ;
  }
  const GGS_string _temp_9147 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_i386_makefile (var_cas_inProjectName) ;
  if (_temp_9147._isBuilt ()) {
    _temp_9147 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (106)) ;
  }
  const GGS_string _temp_9292 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_i386_makefile64 (var_cas_inProjectName) ;
  if (_temp_9292._isBuilt ()) {
    _temp_9292 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (107)) ;
  }
  ...
  const GGS_string _temp_9503 = var_cas_makefile_macosx_universal_DIR ;
  if (_temp_9503._isBuilt ()) {
    _temp_9503 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (110)) ;
  }
  const GGS_string _temp_9615 = GGS_string (gWrapperFileContent_12_projectCreationFileWrapper) ;
  if (_temp_9615._isBuilt ()) {
    _temp_9615 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (111)) ;
  }
  const GGS_string _temp_9777 = GGS_string (gWrapperFileContent_14_projectCreationFileWrapper) ;
  if (_temp_9777._isBuilt ()) {
    _temp_9777 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (112)) ;
  }
  const GGS_string _temp_9941 = GGS_string (gWrapperFileContent_13_projectCreationFileWrapper) ;
  if (_temp_9941._isBuilt ()) {
    _temp_9941 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (113)) ;
  }
  const GGS_string _temp_10106 = GGS_string (gWrapperFileContent_15_projectCreationFileWrapper) ;
  if (_temp_10106._isBuilt ()) {
    _temp_10106 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (114)) ;
  }
  const GGS_string _temp_10267 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_universal_makefile (var_cas_inProjectName) ;
  if (_temp_10267._isBuilt ()) {
    _temp_10267 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (115)) ;
  }
  const GGS_string _temp_10423 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_universal_makefile64 (var_cas_inProjectName) ;
  if (_temp_10423._isBuilt ()) {
    _temp_10423 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (116)) ;
  }
  ...
  const GGS_string _temp_10636 = var_cas_makefile_mingw_on_macosx_DIR ;
  if (_temp_10636._isBuilt ()) {
    _temp_10636 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (119)) ;
  }
  const GGS_string _temp_10747 = GGS_string (gWrapperFileContent_16_projectCreationFileWrapper) ;
  if (_temp_10747._isBuilt ()) {
    _temp_10747 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (120)) ;
  }
  const GGS_string _temp_10906 = GGS_string (gWrapperFileContent_17_projectCreationFileWrapper) ;
  if (_temp_10906._isBuilt ()) {
    _temp_10906 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (121)) ;
  }
  const GGS_string _temp_11062 = _template_filewrapper_projectCreationFileWrapper_makefile_mingw_on_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_11062._isBuilt ()) {
    _temp_11062 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (122)) ;
  }
  ...
  const GGS_string _temp_11265 = var_cas_makefile_mingw_on_win32_DIR ;
  if (_temp_11265._isBuilt ()) {
    _temp_11265 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
  }
  const GGS_string _temp_11360 = GGS_string (gWrapperFileContent_18_projectCreationFileWrapper) ;
  if (_temp_11360._isBuilt ()) {
    _temp_11360 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/build.bat")) COMMA_SOURCE_FILE_AT_LINE (126)) ;
  }
  const GGS_string _temp_11498 = GGS_string (gWrapperFileContent_19_projectCreationFileWrapper) ;
  if (_temp_11498._isBuilt ()) {
    _temp_11498 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/clean.bat")) COMMA_SOURCE_FILE_AT_LINE (127)) ;
  }
  const GGS_string _temp_11638 = GGS_string (gWrapperFileContent_20_projectCreationFileWrapper) ;
  if (_temp_11638._isBuilt ()) {
    _temp_11638 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/install.bat")) COMMA_SOURCE_FILE_AT_LINE (128)) ;
  }
  const GGS_string _temp_11789 = _template_filewrapper_projectCreationFileWrapper_makefile_msys_on_win32_makefile (var_cas_inProjectName) ;
  if (_temp_11789._isBuilt ()) {
    _temp_11789 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/makefile.mke")) COMMA_SOURCE_FILE_AT_LINE (129)) ;
  }
  ...
  const GGS_string _temp_11957 = var_cas_makefile_unix_DIR ;
  if (_temp_11957._isBuilt ()) {
    _temp_11957 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
  }
  const GGS_string _temp_12054 = _template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile (var_cas_inProjectName) ;
  if (_temp_12054._isBuilt ()) {
    _temp_12054 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (133)) ;
  }
  const GGS_string _temp_12185 = _template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile64 (var_cas_inProjectName) ;
  if (_temp_12185._isBuilt ()) {
    _temp_12185 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (134)) ;
  }
  ...
  const GGS_string _temp_12401 = var_cas_makefile_x86linux_on_macosx_DIR ;
  if (_temp_12401._isBuilt ()) {
    _temp_12401 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
  }
  const GGS_string _temp_12515 = GGS_string (gWrapperFileContent_21_projectCreationFileWrapper) ;
  if (_temp_12515._isBuilt ()) {
    _temp_12515 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (138)) ;
  }
  const GGS_string _temp_12681 = GGS_string (gWrapperFileContent_22_projectCreationFileWrapper) ;
  if (_temp_12681._isBuilt ()) {
    _temp_12681 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (139)) ;
  }
  const GGS_string _temp_12844 = _template_filewrapper_projectCreationFileWrapper_makefile_x86linux_on_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_12844._isBuilt ()) {
    _temp_12844 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (140)) ;
  }
  ...
  const GGS_string _temp_13044 = (((var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".xcodeproj")) ;
  if (_temp_13044._isBuilt ()) {
    _temp_13044 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
  }
  const GGS_string _temp_13129 = _template_filewrapper_projectCreationFileWrapper_info_plist (var_cas_inProjectName) ;
  if (_temp_13129._isBuilt ()) {
    _temp_13129 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/Info.plist")) COMMA_SOURCE_FILE_AT_LINE (144)) ;
  }
  const GGS_string _temp_13217 = (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj")) ;
  if (_temp_13217._isBuilt ()) {
    _temp_13217 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (145)) ;
  }
  const GGS_string _temp_13319 = GGS_string (gWrapperFileContent_23_projectCreationFileWrapper) ;
  if (_temp_13319._isBuilt ()) {
    _temp_13319 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/Credits.rtf")) COMMA_SOURCE_FILE_AT_LINE (146)) ;
  }
  const GGS_string _temp_13465 = _template_filewrapper_projectCreationFileWrapper_cocoa_infoPlist_strings (var_cas_inProjectName) ;
  if (_temp_13465._isBuilt ()) {
    _temp_13465 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/InfoPlist.strings")) COMMA_SOURCE_FILE_AT_LINE (147)) ;
  }
...
void routine_projectCreation (C_Compiler & _inLexique,
  ...
  if (((var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (157)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_uint _variant_14217 = var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (162)) ;
    GGS_bool _condition_14217 (_variant_14217._isBuilt (), true) ;
    while (_condition_14217.isBuiltAndTrue ()) {
      _condition_14217 = ((var_cas_index)._operator_strictInf (var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (163))))._operator_and (var_cas_ok) ;
      if (_condition_14217.isBuiltAndTrue ()) {
        if (_variant_14217.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (167)) ;
          _condition_14217 = GGS_bool (true, false) ;
        }else{
          _variant_14217._decrement_operation (_inLexique COMMA_HERE) ;
          GGS_char var_cas_c ;
