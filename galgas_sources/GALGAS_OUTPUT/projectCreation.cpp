...
void routine_projectCreation (const GALGAS_string constinArgument_inProjectPath,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inProjectPath.reader_length (SOURCE_FILE_AT_LINE (71)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @messageInstructionForGeneration
    ...
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_ok = var_projectName.reader_characterAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (75)).reader_isalpha (SOURCE_FILE_AT_LINE (75)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    if (var_projectName.reader_length (SOURCE_FILE_AT_LINE (77)).isValid ()) {
      PMUInt32 variant_5009 = var_projectName.reader_length (SOURCE_FILE_AT_LINE (77)).uintValue () ;
      bool loop_5009 = true ;
      while (loop_5009) {
        loop_5009 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (var_projectName.reader_length (SOURCE_FILE_AT_LINE (78)))).operator_and (var_ok COMMA_SOURCE_FILE_AT_LINE (78)).isValid () ;
        if (loop_5009) {
          loop_5009 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (var_projectName.reader_length (SOURCE_FILE_AT_LINE (78)))).operator_and (var_ok COMMA_SOURCE_FILE_AT_LINE (78)).boolValue () ;
        }
        if (loop_5009 && (0 == variant_5009)) {
          loop_5009 = false ;
    ...
    if (kBoolTrue == test_1) {
      //-------- @messageInstructionForGeneration
      inCompiler->printMessage (GALGAS_string ("** Cannot create GALGAS project: the project name '").operator_concat (var_projectName COMMA_SOURCE_FILE_AT_LINE (85)).operator_concat (GALGAS_string ("' should begin by a letter followed by zero, one or more letters, digits and underscore character.\n") COMMA_SOURCE_FILE_AT_LINE (86)) COMMA_SOURCE_FILE_AT_LINE (84)) ;
    }
    //-------- @ifInstructionForGeneration
