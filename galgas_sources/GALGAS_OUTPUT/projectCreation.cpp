...
_template_filewrapper_projectCreationFileWrapper_xcodeProject (const GGS_string& var_cas_PROJECT_NAME) {
  ...
  if (_isBuilt) {
    ...
    "\t\tCFD7912C0E45FCCC00F64F50 /* AC_galgas_listmap.cpp */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.cpp.cpp; path = AC_galgas_listmap.cpp; sourceTree = \"<group>\"; };\n"
    "\t\tCFD7912D0E45FCCC00F64F50 /* AC_galgas_listmap.h */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.c.h; path = AC_galgas_listmap.h; sourceTree = \"<group>\"; };\n"
    "\t\tCFD7912E0E45FCCC00F64F50 /* PM_C_Array.cpp */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.cpp.cpp; path = PM_C_Array.cpp; sourceTree = \"<group>\"; };\n"
    "\t\tCFD7912F0E45FCCC00F64F50 /* PM_C_Array.h */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.c.h; path = PM_C_Array.h; sourceTree = \"<group>\"; };\n"
    "\t\tCFD791300E45FCCC00F64F50 /* PM_C_Dictionary.cpp */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.cpp.cpp; path = PM_C_Dictionary.cpp; sourceTree = \"<group>\"; };\n"
    "\t\tCFD791310E45FCCC00F64F50 /* PM_C_Dictionary.h */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.c.h; path = PM_C_Dictionary.h; sourceTree = \"<group>\"; };\n"
    "\t\tCFD791320E45FCCC00F64F50 /* PM_C_Object.cpp */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.cpp.cpp; path = PM_C_Object.cpp; sourceTree = \"<group>\"; };\n"
    "\t\tCFD791330E45FCCC00F64F50 /* PM_C_Object.h */ = {isa = PBXFileReference; fileEncoding = 4; lastKnownFileType = sourcecode.c.h; path = PM_C_Object.h; sourceTree = \"<group>\"; };\n"
...
void routine_performProjectCreation (C_Compiler & _inLexique,
  ...
  const GGS_string _temp_4645 = var_cas_galgas_sources_DIR ;
  if (_temp_4645._isBuilt ()) {
    _temp_4645 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (67)) ;
  }
  const GGS_string _temp_4729 = _template_filewrapper_projectCreationFileWrapper_all_ggs (var_cas_inProjectName) ;
  if (_temp_4729._isBuilt ()) {
    _temp_4729 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/_all_")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".ggs")) COMMA_SOURCE_FILE_AT_LINE (68)) ;
  }
  const GGS_string _temp_4870 = _template_filewrapper_projectCreationFileWrapper_PROJECT_cocoa (var_cas_inProjectName) ;
  if (_temp_4870._isBuilt ()) {
    _temp_4870 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_cocoa.ggs")) COMMA_SOURCE_FILE_AT_LINE (69)) ;
  }
  const GGS_string _temp_5014 = _template_filewrapper_projectCreationFileWrapper_PROJECT_grammar (var_cas_inProjectName) ;
  if (_temp_5014._isBuilt ()) {
    _temp_5014 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_grammar.ggs")) COMMA_SOURCE_FILE_AT_LINE (70)) ;
  }
  const GGS_string _temp_5160 = _template_filewrapper_projectCreationFileWrapper_PROJECT_lexique (var_cas_inProjectName) ;
  if (_temp_5160._isBuilt ()) {
    _temp_5160 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_lexique.ggs")) COMMA_SOURCE_FILE_AT_LINE (71)) ;
  }
  const GGS_string _temp_5306 = _template_filewrapper_projectCreationFileWrapper_PROJECT_options (var_cas_inProjectName) ;
  if (_temp_5306._isBuilt ()) {
    _temp_5306 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_options.ggs")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
  }
  const GGS_string _temp_5452 = _template_filewrapper_projectCreationFileWrapper_PROJECT_program (var_cas_inProjectName) ;
  if (_temp_5452._isBuilt ()) {
    _temp_5452 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_program.ggs")) COMMA_SOURCE_FILE_AT_LINE (73)) ;
  }
  const GGS_string _temp_5600 = _template_filewrapper_projectCreationFileWrapper_PROJECT_semantics (var_cas_inProjectName) ;
  if (_temp_5600._isBuilt ()) {
    _temp_5600 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_semantics.ggs")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
  }
  const GGS_string _temp_5747 = _template_filewrapper_projectCreationFileWrapper_PROJECT_syntax (var_cas_inProjectName) ;
  if (_temp_5747._isBuilt ()) {
    _temp_5747 (HERE)->method_writeToFile (_inLexique, (((var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_syntax.ggs")) COMMA_SOURCE_FILE_AT_LINE (75)) ;
  }
  const GGS_string _temp_5886 = _template_filewrapper_projectCreationFileWrapper_build_bat (var_cas_inProjectName) ;
  if (_temp_5886._isBuilt ()) {
    _temp_5886 (HERE)->method_writeToFile (_inLexique, (var_cas_galgas_sources_DIR)._operator_concat (GGS_string (true, "/build.bat")) COMMA_SOURCE_FILE_AT_LINE (76)) ;
  }
  ...
  const GGS_string _temp_6060 = var_cas_hand_coded_sources_DIR ;
  if (_temp_6060._isBuilt ()) {
    _temp_6060 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (79)) ;
  }
  const GGS_string _temp_6157 = _template_filewrapper_projectCreationFileWrapper_PROJECT_computations (var_cas_inProjectName) ;
  if (_temp_6157._isBuilt ()) {
    _temp_6157 (HERE)->method_writeToFile (_inLexique, (((var_cas_hand_coded_sources_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, "_computations.cpp")) COMMA_SOURCE_FILE_AT_LINE (80)) ;
  }
  ...
  const GGS_string _temp_6350 = var_cas_makefile_macosx_DIR ;
  if (_temp_6350._isBuilt ()) {
    _temp_6350 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
  }
  const GGS_string _temp_6444 = GGS_string (gWrapperFileContent_0_projectCreationFileWrapper) ;
  if (_temp_6444._isBuilt ()) {
    _temp_6444 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (84)) ;
  }
  const GGS_string _temp_6585 = GGS_string (gWrapperFileContent_2_projectCreationFileWrapper) ;
  if (_temp_6585._isBuilt ()) {
    _temp_6585 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (85)) ;
  }
  const GGS_string _temp_6728 = GGS_string (gWrapperFileContent_1_projectCreationFileWrapper) ;
  if (_temp_6728._isBuilt ()) {
    _temp_6728 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (86)) ;
  }
  const GGS_string _temp_6873 = GGS_string (gWrapperFileContent_3_projectCreationFileWrapper) ;
  if (_temp_6873._isBuilt ()) {
    _temp_6873 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (87)) ;
  }
  const GGS_string _temp_7023 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_7023._isBuilt ()) {
    _temp_7023 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (88)) ;
  }
  const GGS_string _temp_7158 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_makefile64 (var_cas_inProjectName) ;
  if (_temp_7158._isBuilt ()) {
    _temp_7158 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (89)) ;
  }
  ...
  const GGS_string _temp_7338 = var_cas_makefile_macosx_ppc_DIR ;
  if (_temp_7338._isBuilt ()) {
    _temp_7338 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (92)) ;
  }
  const GGS_string _temp_7436 = GGS_string (gWrapperFileContent_8_projectCreationFileWrapper) ;
  if (_temp_7436._isBuilt ()) {
    _temp_7436 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (93)) ;
  }
  const GGS_string _temp_7585 = GGS_string (gWrapperFileContent_10_projectCreationFileWrapper) ;
  if (_temp_7585._isBuilt ()) {
    _temp_7585 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (94)) ;
  }
  const GGS_string _temp_7736 = GGS_string (gWrapperFileContent_9_projectCreationFileWrapper) ;
  if (_temp_7736._isBuilt ()) {
    _temp_7736 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (95)) ;
  }
  const GGS_string _temp_7889 = GGS_string (gWrapperFileContent_11_projectCreationFileWrapper) ;
  if (_temp_7889._isBuilt ()) {
    _temp_7889 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (96)) ;
  }
  const GGS_string _temp_8047 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_ppc_makefile (var_cas_inProjectName) ;
  if (_temp_8047._isBuilt ()) {
    _temp_8047 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (97)) ;
  }
  const GGS_string _temp_8190 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_ppc_makefile64 (var_cas_inProjectName) ;
  if (_temp_8190._isBuilt ()) {
    _temp_8190 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_ppc_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (98)) ;
  }
  ...
  const GGS_string _temp_8378 = var_cas_makefile_macosx_i386_DIR ;
  if (_temp_8378._isBuilt ()) {
    _temp_8378 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (101)) ;
  }
  const GGS_string _temp_8477 = GGS_string (gWrapperFileContent_4_projectCreationFileWrapper) ;
  if (_temp_8477._isBuilt ()) {
    _temp_8477 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (102)) ;
  }
  const GGS_string _temp_8628 = GGS_string (gWrapperFileContent_6_projectCreationFileWrapper) ;
  if (_temp_8628._isBuilt ()) {
    _temp_8628 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (103)) ;
  }
  const GGS_string _temp_8781 = GGS_string (gWrapperFileContent_5_projectCreationFileWrapper) ;
  if (_temp_8781._isBuilt ()) {
    _temp_8781 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (104)) ;
  }
  const GGS_string _temp_8936 = GGS_string (gWrapperFileContent_7_projectCreationFileWrapper) ;
  if (_temp_8936._isBuilt ()) {
    _temp_8936 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (105)) ;
  }
  const GGS_string _temp_9096 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_i386_makefile (var_cas_inProjectName) ;
  if (_temp_9096._isBuilt ()) {
    _temp_9096 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (106)) ;
  }
  const GGS_string _temp_9241 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_i386_makefile64 (var_cas_inProjectName) ;
  if (_temp_9241._isBuilt ()) {
    _temp_9241 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_i386_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (107)) ;
  }
  ...
  const GGS_string _temp_9450 = var_cas_makefile_macosx_universal_DIR ;
  if (_temp_9450._isBuilt ()) {
    _temp_9450 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (110)) ;
  }
  const GGS_string _temp_9554 = GGS_string (gWrapperFileContent_12_projectCreationFileWrapper) ;
  if (_temp_9554._isBuilt ()) {
    _temp_9554 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (111)) ;
  }
  const GGS_string _temp_9716 = GGS_string (gWrapperFileContent_14_projectCreationFileWrapper) ;
  if (_temp_9716._isBuilt ()) {
    _temp_9716 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (112)) ;
  }
  const GGS_string _temp_9880 = GGS_string (gWrapperFileContent_13_projectCreationFileWrapper) ;
  if (_temp_9880._isBuilt ()) {
    _temp_9880 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/build64.command")) COMMA_SOURCE_FILE_AT_LINE (113)) ;
  }
  const GGS_string _temp_10045 = GGS_string (gWrapperFileContent_15_projectCreationFileWrapper) ;
  if (_temp_10045._isBuilt ()) {
    _temp_10045 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/clean64.command")) COMMA_SOURCE_FILE_AT_LINE (114)) ;
  }
  const GGS_string _temp_10216 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_universal_makefile (var_cas_inProjectName) ;
  if (_temp_10216._isBuilt ()) {
    _temp_10216 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (115)) ;
  }
  const GGS_string _temp_10372 = _template_filewrapper_projectCreationFileWrapper_makefile_macosx_universal_makefile64 (var_cas_inProjectName) ;
  if (_temp_10372._isBuilt ()) {
    _temp_10372 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_macosx_universal_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (116)) ;
  }
  ...
  const GGS_string _temp_10583 = var_cas_makefile_mingw_on_macosx_DIR ;
  if (_temp_10583._isBuilt ()) {
    _temp_10583 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (119)) ;
  }
  const GGS_string _temp_10686 = GGS_string (gWrapperFileContent_16_projectCreationFileWrapper) ;
  if (_temp_10686._isBuilt ()) {
    _temp_10686 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (120)) ;
  }
  const GGS_string _temp_10845 = GGS_string (gWrapperFileContent_17_projectCreationFileWrapper) ;
  if (_temp_10845._isBuilt ()) {
    _temp_10845 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (121)) ;
  }
  const GGS_string _temp_11011 = _template_filewrapper_projectCreationFileWrapper_makefile_mingw_on_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_11011._isBuilt ()) {
    _temp_11011 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (122)) ;
  }
  ...
  const GGS_string _temp_11212 = var_cas_makefile_mingw_on_win32_DIR ;
  if (_temp_11212._isBuilt ()) {
    _temp_11212 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (125)) ;
  }
  const GGS_string _temp_11309 = GGS_string (gWrapperFileContent_18_projectCreationFileWrapper) ;
  if (_temp_11309._isBuilt ()) {
    _temp_11309 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/build.bat")) COMMA_SOURCE_FILE_AT_LINE (126)) ;
  }
  const GGS_string _temp_11447 = GGS_string (gWrapperFileContent_19_projectCreationFileWrapper) ;
  if (_temp_11447._isBuilt ()) {
    _temp_11447 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/clean.bat")) COMMA_SOURCE_FILE_AT_LINE (127)) ;
  }
  const GGS_string _temp_11587 = GGS_string (gWrapperFileContent_20_projectCreationFileWrapper) ;
  if (_temp_11587._isBuilt ()) {
    _temp_11587 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/install.bat")) COMMA_SOURCE_FILE_AT_LINE (128)) ;
  }
  const GGS_string _temp_11738 = _template_filewrapper_projectCreationFileWrapper_makefile_msys_on_win32_makefile (var_cas_inProjectName) ;
  if (_temp_11738._isBuilt ()) {
    _temp_11738 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_mingw_on_win32_DIR)._operator_concat (GGS_string (true, "/makefile.mke")) COMMA_SOURCE_FILE_AT_LINE (129)) ;
  }
  ...
  const GGS_string _temp_11904 = var_cas_makefile_unix_DIR ;
  if (_temp_11904._isBuilt ()) {
    _temp_11904 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
  }
  const GGS_string _temp_12003 = _template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile (var_cas_inProjectName) ;
  if (_temp_12003._isBuilt ()) {
    _temp_12003 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (133)) ;
  }
  const GGS_string _temp_12134 = _template_filewrapper_projectCreationFileWrapper_makefile_unix_makefile64 (var_cas_inProjectName) ;
  if (_temp_12134._isBuilt ()) {
    _temp_12134 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_unix_DIR)._operator_concat (GGS_string (true, "/makefile64")) COMMA_SOURCE_FILE_AT_LINE (134)) ;
  }
  ...
  const GGS_string _temp_12348 = var_cas_makefile_x86linux_on_macosx_DIR ;
  if (_temp_12348._isBuilt ()) {
    _temp_12348 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
  }
  const GGS_string _temp_12454 = GGS_string (gWrapperFileContent_21_projectCreationFileWrapper) ;
  if (_temp_12454._isBuilt ()) {
    _temp_12454 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/build.command")) COMMA_SOURCE_FILE_AT_LINE (138)) ;
  }
  const GGS_string _temp_12620 = GGS_string (gWrapperFileContent_22_projectCreationFileWrapper) ;
  if (_temp_12620._isBuilt ()) {
    _temp_12620 (HERE)->method_writeToExecutableFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/clean.command")) COMMA_SOURCE_FILE_AT_LINE (139)) ;
  }
  const GGS_string _temp_12793 = _template_filewrapper_projectCreationFileWrapper_makefile_x86linux_on_macosx_makefile (var_cas_inProjectName) ;
  if (_temp_12793._isBuilt ()) {
    _temp_12793 (HERE)->method_writeToFile (_inLexique, (var_cas_makefile_x86linux_on_macosx_DIR)._operator_concat (GGS_string (true, "/makefile")) COMMA_SOURCE_FILE_AT_LINE (140)) ;
  }
  ...
  const GGS_string _temp_12991 = (((var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".xcodeproj")) ;
  if (_temp_12991._isBuilt ()) {
    _temp_12991 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
  }
  const GGS_string _temp_13080 = _template_filewrapper_projectCreationFileWrapper_xcodeProject (var_cas_inProjectName) ;
  if (_temp_13080._isBuilt ()) {
    _temp_13080 (HERE)->method_writeToFile (_inLexique, (((var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/")))._operator_concat (var_cas_inProjectName))._operator_concat (GGS_string (true, ".xcodeproj/project.pbxproj")) COMMA_SOURCE_FILE_AT_LINE (144)) ;
  }
  const GGS_string _temp_13234 = _template_filewrapper_projectCreationFileWrapper_info_plist (var_cas_inProjectName) ;
  if (_temp_13234._isBuilt ()) {
    _temp_13234 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/Info.plist")) COMMA_SOURCE_FILE_AT_LINE (145)) ;
  }
  const GGS_string _temp_13350 = GGS_string (gWrapperFileContent_23_projectCreationFileWrapper) ;
  if (_temp_13350._isBuilt ()) {
    _temp_13350 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/main.m")) COMMA_SOURCE_FILE_AT_LINE (146)) ;
  }
  const GGS_string _temp_13432 = (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj")) ;
  if (_temp_13432._isBuilt ()) {
    _temp_13432 (HERE)->method_makeDirectory (_inLexique COMMA_SOURCE_FILE_AT_LINE (147)) ;
  }
  const GGS_string _temp_13536 = GGS_string (gWrapperFileContent_24_projectCreationFileWrapper) ;
  if (_temp_13536._isBuilt ()) {
    _temp_13536 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/Credits.rtf")) COMMA_SOURCE_FILE_AT_LINE (148)) ;
  }
  const GGS_string _temp_13692 = GGS_string (gWrapperFileContent_25_projectCreationFileWrapper) ;
  if (_temp_13692._isBuilt ()) {
    _temp_13692 (HERE)->method_writeToFile (_inLexique, (var_cas_projectxcode_DIR)._operator_concat (GGS_string (true, "/English.lproj/InfoPlist.strings")) COMMA_SOURCE_FILE_AT_LINE (149)) ;
  }
...
void routine_projectCreation (C_Compiler & _inLexique,
  ...
  if (((var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    GGS_uint _variant_14448 = var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ;
    GGS_bool _condition_14448 (_variant_14448._isBuilt (), true) ;
    while (_condition_14448.isBuiltAndTrue ()) {
      _condition_14448 = ((var_cas_index)._operator_strictInf (var_cas_inProjectName.reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (165))))._operator_and (var_cas_ok) ;
      if (_condition_14448.isBuiltAndTrue ()) {
        if (_variant_14448.uintValue () == 0) {
          _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (168)) ;
          _condition_14448 = GGS_bool (true, false) ;
        }else{
          _variant_14448._decrement_operation (_inLexique COMMA_HERE) ;
          GGS_char var_cas_c ;
