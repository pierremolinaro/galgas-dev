    ...
    while (_condition_14209.isBuiltAndTrue ()) {
      ...
      if (_condition_14209.isBuiltAndTrue ()) {
        if (_variant_14209.uintValue () == 0) {
          ...
          var_cas_ok = (var_cas_c.reader_isalnum (_inLexique COMMA_SOURCE_FILE_AT_LINE (165)))._operator_or ((var_cas_c)._operator_isEqual (GGS_char (true, TO_UNICODE ('_')))) ;
