...
void routine_performProjectCreation (const GALGAS_string constinArgument_inProjectPath,
  ...
  GALGAS_string var_projectName = constinArgument_inProjectPath.reader_lastPathComponent (SOURCE_FILE_AT_LINE (47)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_galgas_5F_sources_5F_DIR = constinArgument_inProjectPath.operator_concat (GALGAS_string ("/galgas_sources") COMMA_SOURCE_FILE_AT_LINE (49)) ;
  //-------- @methodCallInstructionForGeneration
  var_galgas_5F_sources_5F_DIR.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (50)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_project (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (51))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/all_") COMMA_SOURCE_FILE_AT_LINE (51)).operator_concat (var_projectName COMMA_SOURCE_FILE_AT_LINE (51)).operator_concat (GALGAS_string (".gProject") COMMA_SOURCE_FILE_AT_LINE (51)), inCompiler COMMA_SOURCE_FILE_AT_LINE (51)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_cocoa (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (52))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (52)).operator_concat (var_projectName COMMA_SOURCE_FILE_AT_LINE (52)).operator_concat (GALGAS_string ("_cocoa.gGui") COMMA_SOURCE_FILE_AT_LINE (52)), inCompiler COMMA_SOURCE_FILE_AT_LINE (52)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_grammar (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (53))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (53)).operator_concat (var_projectName COMMA_SOURCE_FILE_AT_LINE (53)).operator_concat (GALGAS_string ("_grammar.gGrammar") COMMA_SOURCE_FILE_AT_LINE (53)), inCompiler COMMA_SOURCE_FILE_AT_LINE (53)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_lexique (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (54))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (54)).operator_concat (var_projectName COMMA_SOURCE_FILE_AT_LINE (54)).operator_concat (GALGAS_string ("_lexique.gLexique") COMMA_SOURCE_FILE_AT_LINE (54)), inCompiler COMMA_SOURCE_FILE_AT_LINE (54)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_options (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (55))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (55)).operator_concat (var_projectName COMMA_SOURCE_FILE_AT_LINE (55)).operator_concat (GALGAS_string ("_options.gOption") COMMA_SOURCE_FILE_AT_LINE (55)), inCompiler COMMA_SOURCE_FILE_AT_LINE (55)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_program (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (56))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (56)).operator_concat (var_projectName COMMA_SOURCE_FILE_AT_LINE (56)).operator_concat (GALGAS_string ("_program.gProgram") COMMA_SOURCE_FILE_AT_LINE (56)), inCompiler COMMA_SOURCE_FILE_AT_LINE (56)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_semantics (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (57))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (57)).operator_concat (var_projectName COMMA_SOURCE_FILE_AT_LINE (57)).operator_concat (GALGAS_string ("_semantics.gSemantics") COMMA_SOURCE_FILE_AT_LINE (57)), inCompiler COMMA_SOURCE_FILE_AT_LINE (57)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_syntax (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (58))).method_writeToFile (var_galgas_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (58)).operator_concat (var_projectName COMMA_SOURCE_FILE_AT_LINE (58)).operator_concat (GALGAS_string ("_syntax.gSyntax") COMMA_SOURCE_FILE_AT_LINE (58)), inCompiler COMMA_SOURCE_FILE_AT_LINE (58)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_hand_5F_coded_5F_sources_5F_DIR = constinArgument_inProjectPath.operator_concat (GALGAS_string ("/hand_coded_sources") COMMA_SOURCE_FILE_AT_LINE (61)) ;
  //-------- @methodCallInstructionForGeneration
  var_hand_5F_coded_5F_sources_5F_DIR.method_makeDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (62)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_string (filewrapperTemplate_projectCreationFileWrapper_PROJECT_5F_computations (inCompiler, var_projectName COMMA_SOURCE_FILE_AT_LINE (63))).method_writeToFile (var_hand_5F_coded_5F_sources_5F_DIR.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (63)).operator_concat (var_projectName COMMA_SOURCE_FILE_AT_LINE (63)).operator_concat (GALGAS_string ("_computations.cpp") COMMA_SOURCE_FILE_AT_LINE (63)), inCompiler COMMA_SOURCE_FILE_AT_LINE (63)) ;
  //-------- END @methodCallInstructionForGeneration
...
void routine_projectCreation (const GALGAS_string constinArgument_inProjectPath,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inProjectPath.reader_length (SOURCE_FILE_AT_LINE (73)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @messageInstructionForGeneration
    inCompiler->printMessage (GALGAS_string ("*** PERFORM PROJECT CREATION (--create-project=").operator_concat (constinArgument_inProjectPath COMMA_SOURCE_FILE_AT_LINE (74)).operator_concat (GALGAS_string (" option) ***\n") COMMA_SOURCE_FILE_AT_LINE (74)) COMMA_SOURCE_FILE_AT_LINE (74)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_projectName = constinArgument_inProjectPath.reader_lastPathComponent (SOURCE_FILE_AT_LINE (76)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_ok = var_projectName.reader_characterAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (77)).reader_isalpha (SOURCE_FILE_AT_LINE (77)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 1U) ;
    //-------- @loopInstructionForGeneration
    if (var_projectName.reader_length (SOURCE_FILE_AT_LINE (79)).isValid ()) {
      PMUInt32 variant_5199 = var_projectName.reader_length (SOURCE_FILE_AT_LINE (79)).uintValue () ;
      bool loop_5199 = true ;
      while (loop_5199) {
        loop_5199 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (var_projectName.reader_length (SOURCE_FILE_AT_LINE (80)))).operator_and (var_ok COMMA_SOURCE_FILE_AT_LINE (80)).isValid () ;
        if (loop_5199) {
          loop_5199 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (var_projectName.reader_length (SOURCE_FILE_AT_LINE (80)))).operator_and (var_ok COMMA_SOURCE_FILE_AT_LINE (80)).boolValue () ;
        }
        if (loop_5199 && (0 == variant_5199)) {
          loop_5199 = false ;
          inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (79)) ;
        }
        if (loop_5199) {
          variant_5199 -- ;
          //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
          GALGAS_char var_c = var_projectName.reader_characterAtIndex (var_idx, inCompiler COMMA_SOURCE_FILE_AT_LINE (81)) ;
          //-------- @assignmentInstructionForGeneration
          var_ok = var_c.reader_isalnum (SOURCE_FILE_AT_LINE (82)).operator_or (GALGAS_bool (kIsEqual, var_c.objectCompare (GALGAS_char (TO_UNICODE (95)))) COMMA_SOURCE_FILE_AT_LINE (82)) ;
          //-------- @incrementInstructionForGeneration
          var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (83)) ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = var_ok.operator_not (SOURCE_FILE_AT_LINE (85)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @messageInstructionForGeneration
      inCompiler->printMessage (GALGAS_string ("** Cannot create GALGAS project: the project name '").operator_concat (var_projectName COMMA_SOURCE_FILE_AT_LINE (87)).operator_concat (GALGAS_string ("' should begin by a letter followed by zero, one or more letters, digits and underscore character.\n") COMMA_SOURCE_FILE_AT_LINE (88)) COMMA_SOURCE_FILE_AT_LINE (86)) ;
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_ok.boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @assignmentInstructionForGeneration
      var_ok = constinArgument_inProjectPath.reader_directoryExists (SOURCE_FILE_AT_LINE (92)).operator_not (SOURCE_FILE_AT_LINE (92)) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_3 = var_ok.operator_not (SOURCE_FILE_AT_LINE (93)).boolEnum () ;
      if (kBoolTrue == test_3) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (GALGAS_string ("*** Cannot create GALGAS project: '").operator_concat (constinArgument_inProjectPath COMMA_SOURCE_FILE_AT_LINE (94)).operator_concat (GALGAS_string ("' directory already exists.***\n") COMMA_SOURCE_FILE_AT_LINE (94)) COMMA_SOURCE_FILE_AT_LINE (94)) ;
      }
    }
    //-------- @ifInstructionForGeneration
    ...
    if (kBoolTrue == test_4) {
      ...
      routine_performProjectCreation (constinArgument_inProjectPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (98)) ;
      } //-------- @routineCallInstructionForGeneration
    }
  }
}
