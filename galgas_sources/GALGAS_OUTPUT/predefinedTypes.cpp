...
void routine_appendPredefinedTypesASTs (C_Compiler & inLexique,
  ...
  var_cas_searchMethodList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("searchKey"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (122)), GGS_lstring ::constructor_new (inLexique, GGS_string ("%K unknown et %% !"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (123))) ;
  GGS_mapMethodListAST  var_cas_removeMethodList = GGS_mapMethodListAST ::constructor_emptyList () ;
  var_cas_removeMethodList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("removeKey"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (127)), GGS_lstring ::constructor_new (inLexique, GGS_string ("%K unknown et %% !"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (128))) ;
  ...
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_mapDeclarationAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("zeMap"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (132)), var_cas_attributeList, var_cas_insertMethodList, var_cas_searchMethodList, var_cas_removeMethodList, var_cas_insertOrReplaceDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (131))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_listmapDeclarationAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("zeListMap"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (142)), GGS_lstring ::constructor_new (inLexique, GGS_string ("uintlist"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (143)) COMMA_SOURCE_FILE_AT_LINE (141))) ;
  var_cas_attributeList = GGS_attributeInCollectionListAST ::constructor_emptyList () ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("uint"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (148)), GGS_lstring ::constructor_new (inLexique, GGS_string ("toto"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (148))) ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("string"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (149)), GGS_lstring ::constructor_new (inLexique, GGS_string ("tutu"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (149))) ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("char"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (150)), GGS_lstring ::constructor_new (inLexique, GGS_string ("tata"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (150))) ;
  GGS_sortedListSortDescriptorListAST  var_cas_sortAttributeList = GGS_sortedListSortDescriptorListAST ::constructor_emptyList () ;
  var_cas_sortAttributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("toto"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (152)), GGS_bool (true)) ;
  var_cas_sortAttributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("tata"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (153)), GGS_bool (false)) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_sortedListDeclarationAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("Ze_Sorted_List"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (155)), var_cas_attributeList, var_cas_sortAttributeList COMMA_SOURCE_FILE_AT_LINE (154))) ;
  GGS_lstringlist  var_cas_constantList = GGS_lstringlist ::constructor_emptyList () ;
  var_cas_constantList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_First"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (162))) ;
  var_cas_constantList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_Second"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (163))) ;
  var_cas_constantList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_Third"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (164))) ;
  ...
  var_cas_enumMessageAssociationListAST.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_Third"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (167)), GGS_lstring ::constructor_new (inLexique, GGS_string ("third"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (167))) ;
  var_cas_enumMessageAssociationListAST.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_First"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (168)), GGS_lstring ::constructor_new (inLexique, GGS_string ("first"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (168))) ;
  var_cas_enumMessageAssociationListAST.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_Second"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (169)), GGS_lstring ::constructor_new (inLexique, GGS_string ("second"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (169))) ;
  var_cas_enumMessageListAST.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_message"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (170)), var_cas_enumMessageAssociationListAST) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_enumDeclarationAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("Ze_enumeration"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (172)), var_cas_constantList, var_cas_enumMessageListAST COMMA_SOURCE_FILE_AT_LINE (171))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_12057 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_12057.isBuiltAndTrue ()) {
    const GGS_bool cond_10169 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_10169.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (204)) ;
    }else if (cond_10169.isBuiltAndFalse ()) {
      GGS_semanticDeclarationListAST  var_cas_predefinedTypeASTlist = GGS_semanticDeclarationListAST ::constructor_emptyList () ;
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (207)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (210)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (217)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypesHeader (inLexique, var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (224)).reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (224))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11025 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_11025 = NULL ;
        while (((operand_11025 = enumerator_11025.nextObject ()))) {
          macroValidPointer (operand_11025) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_11025->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11025->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (227)))) ;
        }
      }
      const GGS_bool cond_11392 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (229))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_11392.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11587 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_11587 = NULL ;
        while (((operand_11587 = enumerator_11587.nextObject ()))) {
          macroValidPointer (operand_11587) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_11587->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11587->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (243)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_11587->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11587->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (244)))) ;
        }
      }
      const GGS_bool cond_12033 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (246))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_12033.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (247)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
