...
void routine_appendPredefinedTypesASTs (C_Compiler & inLexique,
  ...
  GGS_mapMethodListAST  var_cas_insertMethodList = GGS_mapMethodListAST ::constructor_emptyList () ;
...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_11676 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_11676.isBuiltAndTrue ()) {
    const GGS_bool cond_9788 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_9788.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (191)) ;
    }else if (cond_9788.isBuiltAndFalse ()) {
      GGS_semanticDeclarationListAST  var_cas_predefinedTypeASTlist = GGS_semanticDeclarationListAST ::constructor_emptyList () ;
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (194)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (197)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (204)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypesHeader (inLexique, var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (211)).reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (211))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_10644 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_10644 = NULL ;
        while (((operand_10644 = enumerator_10644.nextObject ()))) {
          macroValidPointer (operand_10644) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_10644->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_10644->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (214)))) ;
        }
      }
      const GGS_bool cond_11011 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (216))).operator_isEqual (GGS_uint (0U)) ;
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11206 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_11206 = NULL ;
        while (((operand_11206 = enumerator_11206.nextObject ()))) {
          macroValidPointer (operand_11206) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_11206->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11206->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (230)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_11206->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11206->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (231)))) ;
        }
      }
      const GGS_bool cond_11652 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (233))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_11652.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (234)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
