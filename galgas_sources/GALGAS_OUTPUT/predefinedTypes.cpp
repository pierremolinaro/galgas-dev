...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_10333 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_10333.isBuiltAndTrue ()) {
    const GGS_bool cond_7469 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_7469.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (144)) ;
    }else if (cond_7469.isBuiltAndFalse ()) {
      GGS_semanticDeclarationListAST  var_cas_predefinedTypeASTlist = GGS_semanticDeclarationListAST ::constructor_emptyList () ;
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (147)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (150)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (157)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedAPTypesHeaderPrologue (inLexique, var_cas_semanticContext.mTypeMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (164))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_8376 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_8376 = NULL ;
        while (((operand_8376 = enumerator_8376.nextObject ()))) {
          macroValidPointer (operand_8376) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassDeclaration (operand_8376->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8376->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (167)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificDeclaration (operand_8376->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8376->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (168)))) ;
        }
      }
      ...
      const GGS_bool cond_8939 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (172))).operator_isEqual (GGS_uint (0U)) ;
      ...
      var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypesHeaderPrologue (inLexique, var_cas_semanticContext.mTypeMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (185))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_9205 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_9205 = NULL ;
        while (((operand_9205 = enumerator_9205.nextObject ()))) {
          macroValidPointer (operand_9205) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_9205->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9205->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (188)))) ;
        }
      }
      const GGS_bool cond_9572 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (190))).operator_isEqual (GGS_uint (0U)) ;
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_9784 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_9784 = NULL ;
        while (((operand_9784 = enumerator_9784.nextObject ()))) {
          macroValidPointer (operand_9784) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassImplementation (operand_9784->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9784->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (204)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_9784->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9784->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (205)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_9784->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9784->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (206)))) ;
        }
      }
      const GGS_bool cond_10309 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (208))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_10309.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (209)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
