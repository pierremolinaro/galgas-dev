...
//                    september 28th, 2010, at 20h42'54"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_appendPredefinedTypesASTs (C_Compiler & inLexique,
  ...
  GGS_attributeInCollectionListAST  var_cas_attributeList = GGS_attributeInCollectionListAST ::constructor_emptyList () ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("uint"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (115)), GGS_lstring ::constructor_new (inLexique, GGS_string ("mFirst"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (115))) ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("char"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (116)), GGS_lstring ::constructor_new (inLexique, GGS_string ("mSecond"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (116))) ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("string"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (117)), GGS_lstring ::constructor_new (inLexique, GGS_string ("mThird"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (117))) ;
  ...
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_sortedListDeclarationAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("0sortedlist"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (122)), var_cas_attributeList, var_cas_sortDescriptorList COMMA_SOURCE_FILE_AT_LINE (121))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
template_filewrapper_predefinedTypeGenerationTemplate_primitiveTypesHeaderPrologue (C_Compiler & /* inLexique */,
  ...
  if (isBuilt) {
    result << "\n"
      ...
      "#include \"GALGAS__root.h\"\n"
      "#include \"C_galgas_type_descriptor.h\"\n"
      "#include \"enumComparisonResult.h\"\n"
      "#include \"AC_GALGAS_Enumerator.h\"\n"
      "#include \"GALGAS_list.h\"\n"
      "#include \"GALGAS_sortedlist.h\"\n"
      "\n"
      "//---------------------------------------------------------------------------*\n"
      "\n"
      "class C_Compiler ;\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_stringset::cEnumerator enumerator_566 (var_cas_TYPE_LIST, true) ;
    while (enumerator_566.hasCurrentObject ()) {
      result << "class GALGAS_" ;
      result << enumerator_566._key (HERE).reader_identifierRepresentation () ;
      result << " ;\n" ;
      enumerator_566.next () ;
    }
    result << "\n" ;
...
template_filewrapper_predefinedTypeGenerationTemplate_object_type (C_Compiler & /* inLexique */) {
  ...
  result << "*\n"
    ...
    "\n"
    "//--------------------------------- Native constructor\n"
    "  public : GALGAS_object (const C_SharedObject * inObject) ;\n"
    "\n" ;
  return GGS_string (true, result) ;
}
...
category_reader__semanticDeclarationForGeneration__appendPrimitiveTypeDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_8992
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_8992 != NULL) {
...
category_reader__primitiveTypeForGeneration__appendPrimitiveTypeDeclaration (C_Compiler & inLexique,
                                const cPtr_primitiveTypeForGeneration * operand_9202
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_9202 != NULL) {
    switch (operand_9202->mKind.enumValue ()) {
    ...
    var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_9202->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (215)), operand_9202->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (216)), operand_9202->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (217)), operand_9202->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (218)), operand_9202->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (219)), operand_9202->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (220)), operand_9202->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (221)), operand_9202->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (222)), operand_9202->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (223)), operand_9202->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (224)), operand_9202->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (225)), operand_9202->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (226)))) ;
  }
  return var_cas_outHeader ;
}
...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_14038 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_14038.isBuiltAndTrue ()) {
    const GGS_bool cond_11951 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_11951.isBuiltAndTrue ()) {
    ...
    }else if (cond_11951.isBuiltAndFalse ()) {
      ...
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_primitiveTypesHeaderPrologue (inLexique, var_cas_semanticContext.mTypeMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (260))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_12841 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_12841 = NULL ;
        while (((operand_12841 = enumerator_12841.nextObject ()))) {
          macroValidPointer (operand_12841) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendPrimitiveTypeDeclaration (operand_12841->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12841->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (263)))) ;
        }
      }
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_12989 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_12989 = NULL ;
        while (((operand_12989 = enumerator_12989.nextObject ()))) {
          macroValidPointer (operand_12989) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_12989->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12989->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (266)))) ;
        }
      }
      const GGS_bool cond_13356 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (268))).operator_isEqual (GGS_uint (0U)) ;
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13568 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_13568 = NULL ;
        while (((operand_13568 = enumerator_13568.nextObject ()))) {
          macroValidPointer (operand_13568) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13568->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13568->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (282)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13568->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13568->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (283)))) ;
        }
      }
      const GGS_bool cond_14014 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (285))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_14014.isBuiltAndTrue ()) {
