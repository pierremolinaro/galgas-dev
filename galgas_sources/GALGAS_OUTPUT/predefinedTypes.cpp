...
//                    november 14th, 2010, at 15h37'48"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_printFeaturesOfType (C_CompilerEx & inLexique,
  ...
  var_cas_s.appendCString (";\n") ;
  {
    GGS_typedAttributeList::cEnumerator enumerator_18775 (var_cas_inAllTypedAttributeList, true) ;
    const GGS_typedAttributeList::cElement * operand_18775 = enumerator_18775.nextObject () ;
    if ((operand_18775 != NULL)) {
      var_cas_s.appendCString (" - attribute(s):\n") ;
      bool _foreach_loop_18775 ;
      do{
        macroValidPointer (operand_18775) ;
        var_cas_s.appendCString ("    @") ;
        var_cas_s.dotAssign_operation (operand_18775->mAttributeTypeProxy.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (424))) ;
        var_cas_s.appendCString (" ") ;
        var_cas_s.dotAssign_operation (operand_18775->mAttributeName) ;
        var_cas_s.appendCString ("\n") ;
        operand_18775 = enumerator_18775.nextObject () ;
        _foreach_loop_18775 = ((operand_18775 != NULL)) ;
        if (_foreach_loop_18775) {
        }
      }while (_foreach_loop_18775) ;
    }
  }
  {
    GGS_constructorMap::cEnumerator enumerator_18946 (var_cas_inConstructorMap, true) ;
    const GGS_constructorMap::cElement * operand_18946 = enumerator_18946.nextObject () ;
    if ((operand_18946 != NULL)) {
      var_cas_s.appendCString (" - constructor(s):\n") ;
      bool _foreach_loop_18946 ;
      do{
        macroValidPointer (operand_18946) ;
        var_cas_s.appendCString ("    ") ;
        var_cas_s.dotAssign_operation (operand_18946->mKey) ;
        {
          GGS_unifiedTypeMapProxyList::cEnumerator enumerator_19049 (operand_18946->mInfo.mArgumentTypeList, true) ;
          const GGS_unifiedTypeMapProxyList::cElement * operand_19049 = NULL ;
          while (((operand_19049 = enumerator_19049.nextObject ()))) {
            macroValidPointer (operand_19049) ;
            var_cas_s.appendCString (" \?@") ;
            var_cas_s.dotAssign_operation (operand_19049->mType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (433))) ;
          }
        }
        var_cas_s.appendCString (" -> @") ;
        var_cas_s.dotAssign_operation (operand_18946->mInfo.mReturnedType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (435))) ;
        var_cas_s.appendCString ("\n") ;
        operand_18946 = enumerator_18946.nextObject () ;
        _foreach_loop_18946 = ((operand_18946 != NULL)) ;
        if (_foreach_loop_18946) {
        }
      }while (_foreach_loop_18946) ;
    }
  }
  {
    GGS_readerMap::cEnumerator enumerator_19194 (var_cas_inReaderMap, true) ;
    const GGS_readerMap::cElement * operand_19194 = enumerator_19194.nextObject () ;
    if ((operand_19194 != NULL)) {
      var_cas_s.appendCString (" - readers(s):\n") ;
      bool _foreach_loop_19194 ;
      do{
        macroValidPointer (operand_19194) ;
        var_cas_s.appendCString ("    ") ;
        var_cas_s.dotAssign_operation (operand_19194->mKey) ;
        {
          GGS_unifiedTypeMapProxyList::cEnumerator enumerator_19293 (operand_19194->mInfo.mArgumentTypeList, true) ;
          const GGS_unifiedTypeMapProxyList::cElement * operand_19293 = NULL ;
          while (((operand_19293 = enumerator_19293.nextObject ()))) {
            macroValidPointer (operand_19293) ;
            var_cas_s.appendCString (" \?@") ;
            var_cas_s.dotAssign_operation (operand_19293->mType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (444))) ;
          }
        }
        var_cas_s.appendCString (" -> @") ;
        var_cas_s.dotAssign_operation (operand_19194->mInfo.mReturnedType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (446))) ;
        var_cas_s.appendCString ("\n") ;
        operand_19194 = enumerator_19194.nextObject () ;
        _foreach_loop_19194 = ((operand_19194 != NULL)) ;
        if (_foreach_loop_19194) {
        }
      }while (_foreach_loop_19194) ;
    }
  }
  {
    GGS_modifierMap::cEnumerator enumerator_19440 (var_cas_inModifierMap, true) ;
    const GGS_modifierMap::cElement * operand_19440 = enumerator_19440.nextObject () ;
    if ((operand_19440 != NULL)) {
      var_cas_s.appendCString (" - modifiers(s):\n") ;
      bool _foreach_loop_19440 ;
      do{
        macroValidPointer (operand_19440) ;
        var_cas_s.appendCString ("    ") ;
        var_cas_s.dotAssign_operation (operand_19440->mKey) ;
        {
          GGS_formalParameterSignature::cEnumerator enumerator_19538 (operand_19440->mInfo.mParameterList, true) ;
          const GGS_formalParameterSignature::cElement * operand_19538 = NULL ;
          while (((operand_19538 = enumerator_19538.nextObject ()))) {
            macroValidPointer (operand_19538) ;
            var_cas_s.appendCString (" ") ;
            var_cas_s.dotAssign_operation (operand_19538->mFormalArgumentPassingMode.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (455))) ;
            var_cas_s.appendCString ("@") ;
            var_cas_s.dotAssign_operation (operand_19538->mFormalArgumentType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (455))) ;
          }
        }
        var_cas_s.appendCString ("\n") ;
        operand_19440 = enumerator_19440.nextObject () ;
        _foreach_loop_19440 = ((operand_19440 != NULL)) ;
        if (_foreach_loop_19440) {
        }
      }while (_foreach_loop_19440) ;
    }
  }
  {
    GGS_instanceMethodMap::cEnumerator enumerator_19715 (var_cas_inInstanceMethodMap, true) ;
    const GGS_instanceMethodMap::cElement * operand_19715 = enumerator_19715.nextObject () ;
    if ((operand_19715 != NULL)) {
      var_cas_s.appendCString (" - instance method(s):\n") ;
      bool _foreach_loop_19715 ;
      do{
        macroValidPointer (operand_19715) ;
        var_cas_s.appendCString ("    ") ;
        var_cas_s.dotAssign_operation (operand_19715->mKey) ;
        {
          GGS_formalParameterSignature::cEnumerator enumerator_19819 (operand_19715->mInfo.mParameterList, true) ;
          const GGS_formalParameterSignature::cElement * operand_19819 = NULL ;
          while (((operand_19819 = enumerator_19819.nextObject ()))) {
            macroValidPointer (operand_19819) ;
            var_cas_s.appendCString (" ") ;
            var_cas_s.dotAssign_operation (operand_19819->mFormalArgumentPassingMode.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (466))) ;
            var_cas_s.appendCString ("@") ;
            var_cas_s.dotAssign_operation (operand_19819->mFormalArgumentType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (466))) ;
          }
        }
        var_cas_s.appendCString ("\n") ;
        operand_19715 = enumerator_19715.nextObject () ;
        _foreach_loop_19715 = ((operand_19715 != NULL)) ;
        if (_foreach_loop_19715) {
        }
      }while (_foreach_loop_19715) ;
    }
  }
  {
    GGS_classMethodMap::cEnumerator enumerator_19993 (var_cas_inClassMethodMap, true) ;
    const GGS_classMethodMap::cElement * operand_19993 = enumerator_19993.nextObject () ;
    if ((operand_19993 != NULL)) {
      var_cas_s.appendCString (" - class method(s):\n") ;
      bool _foreach_loop_19993 ;
      do{
        macroValidPointer (operand_19993) ;
        var_cas_s.appendCString ("    ") ;
        var_cas_s.dotAssign_operation (operand_19993->mKey) ;
        {
          GGS_formalParameterSignature::cEnumerator enumerator_20094 (operand_19993->mInfo.mParameterList, true) ;
          const GGS_formalParameterSignature::cElement * operand_20094 = NULL ;
          while (((operand_20094 = enumerator_20094.nextObject ()))) {
            macroValidPointer (operand_20094) ;
            var_cas_s.appendCString (" ") ;
            var_cas_s.dotAssign_operation (operand_20094->mFormalArgumentPassingMode.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (477))) ;
            var_cas_s.appendCString ("@") ;
            var_cas_s.dotAssign_operation (operand_20094->mFormalArgumentType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (477))) ;
          }
        }
        var_cas_s.appendCString ("\n") ;
        operand_19993 = enumerator_19993.nextObject () ;
        _foreach_loop_19993 = ((operand_19993 != NULL)) ;
        if (_foreach_loop_19993) {
        }
      }while (_foreach_loop_19993) ;
    }
  }
  var_cas_s.appendCString (" - operators(s):\n") ;
  const GGS_bool cond_20424 = ((var_cas_inHandledOperatorFlags).operator_and (function_binaryAddOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (483)))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_20424.isBuiltAndTrue ()) {
    var_cas_s.appendCString ("    @") ;
  ...
  const GGS_bool cond_20582 = ((var_cas_inHandledOperatorFlags).operator_and (function_binarySubOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (486)))).operator_isNotEqual (GGS_uint (0U)) ;
  ...
  const GGS_bool cond_20740 = ((var_cas_inHandledOperatorFlags).operator_and (function_binaryMulOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (489)))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_20740.isBuiltAndTrue ()) {
    var_cas_s.appendCString ("    @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
    var_cas_s.appendCString (" * @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
  ...
  const GGS_bool cond_20898 = ((var_cas_inHandledOperatorFlags).operator_and (function_binaryDivOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (492)))).operator_isNotEqual (GGS_uint (0U)) ;
  ...
  const GGS_bool cond_21056 = ((var_cas_inHandledOperatorFlags).operator_and (function_binaryModOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (495)))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_21056.isBuiltAndTrue ()) {
    var_cas_s.appendCString ("    @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
    var_cas_s.appendCString (" % @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
  ...
  const GGS_bool cond_21214 = ((var_cas_inHandledOperatorFlags).operator_and (function_binaryAndOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (498)))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_21214.isBuiltAndTrue ()) {
    var_cas_s.appendCString ("    @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
    var_cas_s.appendCString (" & @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
  ...
  const GGS_bool cond_21371 = ((var_cas_inHandledOperatorFlags).operator_and (function_binaryOrOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (501)))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_21371.isBuiltAndTrue ()) {
    var_cas_s.appendCString ("    @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
    var_cas_s.appendCString (" | @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
  ...
  const GGS_bool cond_21529 = ((var_cas_inHandledOperatorFlags).operator_and (function_binaryXorOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (504)))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_21529.isBuiltAndTrue ()) {
    var_cas_s.appendCString ("    @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
    var_cas_s.appendCString (" ^ @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
  ...
  const GGS_bool cond_21690 = ((var_cas_inHandledOperatorFlags).operator_and (function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (507)))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_21690.isBuiltAndTrue ()) {
    var_cas_s.appendCString ("    @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
    var_cas_s.appendCString (" . @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
  ...
  const GGS_bool cond_21908 = ((var_cas_inHandledOperatorFlags).operator_and (function_binaryShiftOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (510)))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_21908.isBuiltAndTrue ()) {
    var_cas_s.appendCString ("    @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
  ...
  const GGS_bool cond_22046 = ((var_cas_inHandledOperatorFlags).operator_and (function_unaryPlusOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (514)))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_22046.isBuiltAndTrue ()) {
    var_cas_s.appendCString ("    + @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
    var_cas_s.appendCString (" -> @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
  ...
  const GGS_bool cond_22185 = ((var_cas_inHandledOperatorFlags).operator_and (function_unaryMinusOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (517)))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_22185.isBuiltAndTrue ()) {
    var_cas_s.appendCString ("    - @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
    var_cas_s.appendCString (" -> @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
  ...
  const GGS_bool cond_22324 = ((var_cas_inHandledOperatorFlags).operator_and (function_unaryTildeOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (520)))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_22324.isBuiltAndTrue ()) {
    var_cas_s.appendCString ("    ~ @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
    var_cas_s.appendCString (" -> @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
  ...
  const GGS_bool cond_22463 = ((var_cas_inHandledOperatorFlags).operator_and (function_unaryNotOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (523)))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_22463.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_22664 = ((var_cas_inHandledOperatorFlags).operator_and (function_incDecOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (526)))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_22664.isBuiltAndTrue ()) {
    var_cas_s.appendCString ("    @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
    var_cas_s.appendCString (" ++ -> @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
  ...
  {
    GGS_unifiedTypeMapProxyList::cEnumerator enumerator_22708 (var_cas_inAddAssignOperatorArguments, true) ;
    const GGS_unifiedTypeMapProxyList::cElement * operand_22708 = enumerator_22708.nextObject () ;
    if ((operand_22708 != NULL)) {
      var_cas_s.appendCString ("    @") ;
      var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
      var_cas_s.appendCString (" +=") ;
      bool _foreach_loop_22708 ;
      do{
        macroValidPointer (operand_22708) ;
        var_cas_s.appendCString (" !@") ;
        var_cas_s.dotAssign_operation (operand_22708->mType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (534))) ;
        operand_22708 = enumerator_22708.nextObject () ;
        _foreach_loop_22708 = ((operand_22708 != NULL)) ;
        if (_foreach_loop_22708) {
        }
      }while (_foreach_loop_22708) ;
      var_cas_s.appendCString ("\n") ;
    }
  }
  const GGS_bool cond_22964 = ((var_cas_inHandledOperatorFlags).operator_and (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (538)))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_22964.isBuiltAndTrue ()) {
    var_cas_s.appendCString ("    @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
    var_cas_s.appendCString (" .= @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
  ...
  const GGS_bool cond_23317 = ((var_cas_inHandledOperatorFlags).operator_and (function_isComparable (inLexique COMMA_SOURCE_FILE_AT_LINE (541)))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_23317.isBuiltAndTrue ()) {
    var_cas_s.appendCString ("    @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
    var_cas_s.appendCString (" <  @") ;
    var_cas_s.dotAssign_operation (var_cas_inTypeName) ;
  ...
  var_cas_s.appendCString (" -> @bool\n") ;
  {
    GGS_withAccessorMap::cEnumerator enumerator_23493 (var_cas_inWithAccessorMap, true) ;
    const GGS_withAccessorMap::cElement * operand_23493 = enumerator_23493.nextObject () ;
    if ((operand_23493 != NULL)) {
      var_cas_s.appendCString (" - 'with' accessor method(s):\n") ;
      bool _foreach_loop_23493 ;
      do{
        macroValidPointer (operand_23493) ;
        var_cas_s.appendCString ("    ") ;
        var_cas_s.dotAssign_operation (operand_23493->mKey) ;
        var_cas_s.appendCString ("\?@") ;
        var_cas_s.dotAssign_operation (operand_23493->mInfo.mArgumentType.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (554))) ;
        var_cas_s.appendCString ("\n") ;
        operand_23493 = enumerator_23493.nextObject () ;
        _foreach_loop_23493 = ((operand_23493 != NULL)) ;
        if (_foreach_loop_23493) {
        }
      }while (_foreach_loop_23493) ;
    }
  }
...
void routine_printPredefinedTypeFeature (C_CompilerEx & inLexique,
  ...
  const GGS_bool cond_24505 = (var_cas_inTypeName).operator_isEqual (GGS_string ("*")) ;
  if (cond_24505.isBuiltAndTrue ()) {
    {
      GGS_unifiedTypeMap::cEnumerator enumerator_24150 (var_cas_semanticContext.mTypeMap, true) ;
      const GGS_unifiedTypeMap::cElement * operand_24150 = NULL ;
      while (((operand_24150 = enumerator_24150.nextObject ()))) {
        macroValidPointer (operand_24150) ;
        ::routine_printFeaturesOfType (inLexique,  operand_24150->mKey,  operand_24150->mInfo.mTypeKindEnum,  operand_24150->mInfo.mAllTypedAttributeList,  operand_24150->mInfo.mConstructorMap,  operand_24150->mInfo.mReaderMap,  operand_24150->mInfo.mModifierMap,  operand_24150->mInfo.mInstanceMethodMap,  operand_24150->mInfo.mClassMethodMap,  operand_24150->mInfo.mHandledOperatorFlags,  operand_24150->mInfo.mAddAssignOperatorArguments,  operand_24150->mInfo.mWithAccessorMap COMMA_SOURCE_FILE_AT_LINE (578)) ;
      }
    }
  }else if (cond_24505.isBuiltAndFalse ()) {
    elementOf_GGS_unifiedTypeMap * operand_24540 = (elementOf_GGS_unifiedTypeMap *) var_cas_semanticContext.mTypeMap.searchForReadWithInstruction (var_cas_inTypeName) ;
    if (NULL != operand_24540) {
      ::routine_printFeaturesOfType (inLexique,  operand_24540->mKey,  operand_24540->mInfo.mTypeKindEnum,  operand_24540->mInfo.mAllTypedAttributeList,  operand_24540->mInfo.mConstructorMap,  operand_24540->mInfo.mReaderMap,  operand_24540->mInfo.mModifierMap,  operand_24540->mInfo.mInstanceMethodMap,  operand_24540->mInfo.mClassMethodMap,  operand_24540->mInfo.mHandledOperatorFlags,  operand_24540->mInfo.mAddAssignOperatorArguments,  operand_24540->mInfo.mWithAccessorMap COMMA_SOURCE_FILE_AT_LINE (594)) ;
    }else{
