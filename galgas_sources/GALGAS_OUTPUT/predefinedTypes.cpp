...
void routine_generatePredefinedTypeFiles (C_CompilerEx & inLexique,
  ...
  #endif
  const GGS_bool cond_17125 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_17125.isBuiltAndTrue ()) {
    ...
    if (cond_14773.isBuiltAndTrue ()) {
      ...
      var_cas_generatedCode.dotAssign_operation (template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypeSeparation (inLexique)) ;
      {
        ...
        while (((operand_16062 = enumerator_16062.nextObject ()))) {
          ...
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration2 (operand_16062->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_16062->mDeclaration.getPtr (), var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (339)))) ;
        }
      }
      const GGS_bool cond_16443 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (341))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_16443.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_16655 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_16655 = NULL ;
        while (((operand_16655 = enumerator_16655.nextObject ()))) {
          macroValidPointer (operand_16655) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_16655->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_16655->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (355)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_16655->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_16655->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (356)))) ;
        }
      }
      const GGS_bool cond_17101 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (358))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_17101.isBuiltAndTrue ()) {
