...
template_filewrapper_predefinedTypeGenerationTemplate_primitiveTypesHeaderPrologue (C_Compiler & /* inLexique */,
  ...
  if (isBuilt) {
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_stringset::cEnumerator enumerator_718 (var_cas_TYPE_LIST, true) ;
    while (enumerator_718.hasCurrentObject ()) {
      result << "class GALGAS_" ;
      result << enumerator_718._key (HERE).reader_identifierRepresentation () ;
      result << " ;\n" ;
      enumerator_718.next () ;
    }
    result << "\n" ;
...
template_filewrapper_predefinedTypeGenerationTemplate_sint_type (C_Compiler & /* inLexique */) {
  ...
  result << "*\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n"
    "class GALGAS_sint : public GALGAS__root {\n"
...
template_filewrapper_predefinedTypeGenerationTemplate_sint64_type (C_Compiler & /* inLexique */) {
  ...
  result << "*\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n"
    "class GALGAS_sint_36__34_ : public GALGAS__root {\n"
    "//--------------------------------- Private data members\n"
    "  private : bool mIsValid ;\n"
...
template_filewrapper_predefinedTypeGenerationTemplate_object_type (C_Compiler & /* inLexique */) {
  ...
  result << "*\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n"
    "class GALGAS_object : public GALGAS__root {\n"
    "//--------------------------------- Private data member\n"
    ...
    "  public : GALGAS_object (GALGAS__root * inObjectPointer\n"
    "                          COMMA_LOCATION_ARGS) ;\n"
    "\n"
    ...
    "\n"
    "//--------------------------------- Embedded Object\n"
    "  public : const GALGAS__root * embeddedObject (void) const ;\n"
    "\n" ;
  return GGS_string (true, result) ;
}
...
template_filewrapper_predefinedTypeGenerationTemplate_bool_type (C_Compiler & /* inLexique */) {
  ...
  result << "*\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n"
    "class GALGAS_bool : public GALGAS__root {\n"
    "//--------------------------------- Private data members\n"
    "  private : bool mIsValid ;\n"
...
template_filewrapper_predefinedTypeGenerationTemplate_binaryset_type (C_Compiler & /* inLexique */) {
  ...
  result << "*\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n"
    "class GALGAS_binaryset : public GALGAS__root {\n"
    "//--------------------------------- Private data members\n"
    "  private : bool mIsValid ;\n"
    "  private : C_BDD mBDD ;\n"
    "\n"
...
template_filewrapper_predefinedTypeGenerationTemplate_function_type (C_Compiler & /* inLexique */) {
  ...
  result << "*\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n"
    "class GALGAS_function : public GALGAS__root {\n"
    "//--------------------------------- Private data member\n"
...
template_filewrapper_predefinedTypeGenerationTemplate_type_type (C_Compiler & /* inLexique */) {
  ...
  result << "*\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n"
    "class GALGAS_type : public GALGAS__root\n"
    " {\n"
    "//--------------------------------- Private data members\n"
...
template_filewrapper_predefinedTypeGenerationTemplate_location_type (C_Compiler & /* inLexique */) {
  ...
  result << "*\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n"
    "class GALGAS_location : public GALGAS__root {\n"
    "//--------------------------------- Private data members\n"
...
template_filewrapper_predefinedTypeGenerationTemplate_data_type (C_Compiler & /* inLexique */) {
  ...
  result << "*\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n"
    "class GALGAS_data : public GALGAS__root {\n"
    "//--------------------------------- Private data members\n"
    "  private : bool mIsValid ;\n"
...
template_filewrapper_predefinedTypeGenerationTemplate_char_type (C_Compiler & /* inLexique */) {
  ...
  result << "*\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n"
    "class GALGAS_char : public GALGAS__root {\n"
    "//--------------------------------- Private data members\n"
    "  private : bool mIsValid ;\n"
...
template_filewrapper_predefinedTypeGenerationTemplate_string_type (C_Compiler & /* inLexique */) {
  ...
  result << "*\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n"
    "class GALGAS_string : public GALGAS__root\n"
    " {\n"
    "//--------------------------------- Private data members\n"
    "  private : bool mIsValid ;\n"
...
template_filewrapper_predefinedTypeGenerationTemplate_stringset_type (C_Compiler & /* inLexique */) {
  ...
  result << "*\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n"
    "class GALGAS_stringset : public GALGAS__root\n"
    " {\n"
    "//--------------------------------- Private data members\n"
...
category_reader__semanticDeclarationForGeneration__appendPrimitiveTypeDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_10570
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_10570 != NULL) {
...
category_reader__primitiveTypeForGeneration__appendPrimitiveTypeDeclaration (C_Compiler & inLexique,
                                const cPtr_primitiveTypeForGeneration * operand_10780
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_10780 != NULL) {
    switch (operand_10780->mKind.enumValue ()) {
    ...
    var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_10780->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (251)), operand_10780->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (252)), operand_10780->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (253)), operand_10780->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (254)), operand_10780->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (255)), operand_10780->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (256)), operand_10780->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (257)), operand_10780->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (258)), operand_10780->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (259)), operand_10780->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (260)), operand_10780->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (261)), operand_10780->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (262)))) ;
  }
  return var_cas_outHeader ;
}
...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_15850 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_15850.isBuiltAndTrue ()) {
    const GGS_bool cond_13529 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_13529.isBuiltAndTrue ()) {
    ...
    }else if (cond_13529.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_14419 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_14419 = NULL ;
        while (((operand_14419 = enumerator_14419.nextObject ()))) {
          macroValidPointer (operand_14419) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendPrimitiveTypeDeclaration (operand_14419->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_14419->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (299)))) ;
        }
      }
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_14567 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_14567 = NULL ;
        while (((operand_14567 = enumerator_14567.nextObject ()))) {
          macroValidPointer (operand_14567) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration1 (operand_14567->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_14567->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (302)))) ;
        }
      }
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_14800 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_14800 = NULL ;
        while (((operand_14800 = enumerator_14800.nextObject ()))) {
          macroValidPointer (operand_14800) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration2 (operand_14800->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_14800->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (306)))) ;
        }
      }
      const GGS_bool cond_15168 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (308))).operator_isEqual (GGS_uint (0U)) ;
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_15380 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_15380 = NULL ;
        while (((operand_15380 = enumerator_15380.nextObject ()))) {
          macroValidPointer (operand_15380) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_15380->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_15380->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (322)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_15380->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_15380->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (323)))) ;
        }
      }
      const GGS_bool cond_15826 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (325))).operator_isEqual (GGS_uint (0U)) ;
