...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_11679 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_11679.isBuiltAndTrue ()) {
    const GGS_bool cond_9791 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_9791.isBuiltAndTrue ()) {
    ...
    }else if (cond_9791.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_10647 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_10647 = NULL ;
        while (((operand_10647 = enumerator_10647.nextObject ()))) {
          macroValidPointer (operand_10647) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_10647->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_10647->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (214)))) ;
        }
      }
      const GGS_bool cond_11014 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (216))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_11014.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11209 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_11209 = NULL ;
        while (((operand_11209 = enumerator_11209.nextObject ()))) {
          macroValidPointer (operand_11209) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_11209->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11209->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (230)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_11209->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11209->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (231)))) ;
        }
      }
      const GGS_bool cond_11655 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (233))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_11655.isBuiltAndTrue ()) {
