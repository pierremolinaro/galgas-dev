...
void routine_appendStructASTForTypeWithLocation (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_lstringlist  var_cas_featureList = GGS_lstringlist ::constructor_emptyList () ;
  var_cas_featureList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("setter"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (76))) ;
  GGS_attributeInCollectionListAST  var_cas_attributeList = GGS_attributeInCollectionListAST ::constructor_emptyList () ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, var_cas_inElementTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (78)), GGS_lstring ::constructor_new (inLexique, var_cas_inElementTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (78)), var_cas_featureList) ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("location"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (79)), GGS_lstring ::constructor_new (inLexique, GGS_string ("location"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (79)), var_cas_featureList) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_structDeclarationAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("l")).operator_concat (var_cas_inElementTypeName), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (81)), var_cas_attributeList COMMA_SOURCE_FILE_AT_LINE (80))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_appendPredefinedTypesASTs (C_CompilerEx & inLexique,
  ...
  #endif
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_applicationPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("application"), GGS_predefinedTypeKindEnum::constructor_predefined_application (inLexique COMMA_SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_filewrapperPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("filewrapper"), GGS_predefinedTypeKindEnum::constructor_predefined_filewrapper (inLexique COMMA_SOURCE_FILE_AT_LINE (92)) COMMA_SOURCE_FILE_AT_LINE (92))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_objectPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("object"), GGS_predefinedTypeKindEnum::constructor_predefined_object (inLexique COMMA_SOURCE_FILE_AT_LINE (93)) COMMA_SOURCE_FILE_AT_LINE (93))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_boolPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("bool"), GGS_predefinedTypeKindEnum::constructor_predefined_bool (inLexique COMMA_SOURCE_FILE_AT_LINE (94)) COMMA_SOURCE_FILE_AT_LINE (94))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_uintPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("uint"), GGS_predefinedTypeKindEnum::constructor_predefined_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (95)) COMMA_SOURCE_FILE_AT_LINE (95))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_uint64PredefinedTypeAST ::constructor_new (inLexique, GGS_string ("uint64"), GGS_predefinedTypeKindEnum::constructor_predefined_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (96)) COMMA_SOURCE_FILE_AT_LINE (96))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_sintPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("sint"), GGS_predefinedTypeKindEnum::constructor_predefined_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (97)) COMMA_SOURCE_FILE_AT_LINE (97))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_sint64PredefinedTypeAST ::constructor_new (inLexique, GGS_string ("sint64"), GGS_predefinedTypeKindEnum::constructor_predefined_sint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_charPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("char"), GGS_predefinedTypeKindEnum::constructor_predefined_char (inLexique COMMA_SOURCE_FILE_AT_LINE (99)) COMMA_SOURCE_FILE_AT_LINE (99))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_doublePredefinedTypeAST ::constructor_new (inLexique, GGS_string ("double"), GGS_predefinedTypeKindEnum::constructor_predefined_double (inLexique COMMA_SOURCE_FILE_AT_LINE (100)) COMMA_SOURCE_FILE_AT_LINE (100))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_stringPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("string"), GGS_predefinedTypeKindEnum::constructor_predefined_string (inLexique COMMA_SOURCE_FILE_AT_LINE (101)) COMMA_SOURCE_FILE_AT_LINE (101))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_locationPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("location"), GGS_predefinedTypeKindEnum::constructor_predefined_location (inLexique COMMA_SOURCE_FILE_AT_LINE (102)) COMMA_SOURCE_FILE_AT_LINE (102))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_stringsetPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("stringset"), GGS_predefinedTypeKindEnum::constructor_predefined_stringset (inLexique COMMA_SOURCE_FILE_AT_LINE (103)) COMMA_SOURCE_FILE_AT_LINE (103))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_functionPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("function"), GGS_predefinedTypeKindEnum::constructor_predefined_function (inLexique COMMA_SOURCE_FILE_AT_LINE (104)) COMMA_SOURCE_FILE_AT_LINE (104))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_typePredefinedTypeAST ::constructor_new (inLexique, GGS_string ("type"), GGS_predefinedTypeKindEnum::constructor_predefined_type (inLexique COMMA_SOURCE_FILE_AT_LINE (105)) COMMA_SOURCE_FILE_AT_LINE (105))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_binarysetPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("binaryset"), GGS_predefinedTypeKindEnum::constructor_predefined_binaryset (inLexique COMMA_SOURCE_FILE_AT_LINE (106)) COMMA_SOURCE_FILE_AT_LINE (106))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_dataPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("data"), GGS_predefinedTypeKindEnum::constructor_predefined_data (inLexique COMMA_SOURCE_FILE_AT_LINE (107)) COMMA_SOURCE_FILE_AT_LINE (107))) ;
  ...
  ::routine_appendPredefinedListTypeAST (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("function") COMMA_SOURCE_FILE_AT_LINE (112)) ;
  ::routine_appendPredefinedListTypeAST (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("string") COMMA_SOURCE_FILE_AT_LINE (113)) ;
  ::routine_appendPredefinedListTypeAST (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("lstring") COMMA_SOURCE_FILE_AT_LINE (114)) ;
  ::routine_appendPredefinedListTypeAST (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("type") COMMA_SOURCE_FILE_AT_LINE (115)) ;
  ::routine_appendPredefinedListTypeAST (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("object") COMMA_SOURCE_FILE_AT_LINE (116)) ;
  ::routine_appendStructASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("bool") COMMA_SOURCE_FILE_AT_LINE (118)) ;
  ::routine_appendStructASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("uint") COMMA_SOURCE_FILE_AT_LINE (119)) ;
  ::routine_appendStructASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("uint64") COMMA_SOURCE_FILE_AT_LINE (120)) ;
  ::routine_appendStructASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("sint") COMMA_SOURCE_FILE_AT_LINE (121)) ;
  ::routine_appendStructASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("sint64") COMMA_SOURCE_FILE_AT_LINE (122)) ;
  ::routine_appendStructASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("char") COMMA_SOURCE_FILE_AT_LINE (123)) ;
  ::routine_appendStructASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("double") COMMA_SOURCE_FILE_AT_LINE (124)) ;
  ::routine_appendStructASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("string") COMMA_SOURCE_FILE_AT_LINE (125)) ;
  ::routine_appendPredefined2StringListTypeAST (inLexique,  var_cas_ioDeclarationListASTs COMMA_SOURCE_FILE_AT_LINE (127)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
category_reader__semanticDeclarationForGeneration__appendPrimitiveTypeDeclaration (C_CompilerEx &,
                                const cPtr_semanticDeclarationForGeneration * operand_11937
                                COMMA_UNUSED_LOCATION_ARGS) {
...
category_reader__primitiveTypeForGeneration__appendPrimitiveTypeDeclaration (C_CompilerEx & inLexique,
                                const cPtr_primitiveTypeForGeneration * operand_12147
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_12147 != NULL) {
    switch (operand_12147->mKind.enumValue ()) {
    ...
    var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_12147->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (292)), operand_12147->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (293)), operand_12147->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (294)), operand_12147->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (295)), operand_12147->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (296)), operand_12147->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (297)), operand_12147->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (298)), operand_12147->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (299)), operand_12147->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (300)), operand_12147->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (301)), operand_12147->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (302)), operand_12147->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (303)))) ;
  }
  return var_cas_outHeader ;
}
...
void routine_generatePredefinedTypeFiles (C_CompilerEx & inLexique,
  ...
  #endif
  const GGS_bool cond_17478 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_17478.isBuiltAndTrue ()) {
    const GGS_bool cond_15126 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_15126.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (317)) ;
      ...
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (320)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  GGS_string (""),  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (323)) ;
      GGS_semanticDeclarationSortedListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (331)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_primitiveTypesHeaderPrologue (inLexique, var_cas_semanticContext.mTypeMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (338))) ;
      {
        GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_16034 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_16034 = NULL ;
        while (((operand_16034 = enumerator_16034.nextObject ()))) {
          macroValidPointer (operand_16034) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendPrimitiveTypeDeclaration (operand_16034->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_16034->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (341)))) ;
        }
      }
      {
        GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_16182 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_16182 = NULL ;
        while (((operand_16182 = enumerator_16182.nextObject ()))) {
          macroValidPointer (operand_16182) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration1 (operand_16182->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_16182->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (344)))) ;
        }
      }
      ...
      {
        GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_16415 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_16415 = NULL ;
        while (((operand_16415 = enumerator_16415.nextObject ()))) {
          macroValidPointer (operand_16415) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration2 (operand_16415->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_16415->mDeclaration.getPtr (), var_cas_inDirectory COMMA_SOURCE_FILE_AT_LINE (348)))) ;
        }
      }
      const GGS_bool cond_16796 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (350))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_16796.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_17008 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_17008 = NULL ;
        while (((operand_17008 = enumerator_17008.nextObject ()))) {
          macroValidPointer (operand_17008) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_17008->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_17008->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (364)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_17008->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_17008->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (365)))) ;
        }
      }
      const GGS_bool cond_17454 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (367))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_17454.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (368)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
