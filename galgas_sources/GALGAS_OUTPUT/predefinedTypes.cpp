...
//                    september 25th, 2010, at 21h13'47"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
template_filewrapper_predefinedTypeGenerationTemplate_primitiveTypesHeaderPrologue (C_Compiler & /* inLexique */,
  ...
  if (isBuilt) {
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_stringset::cEnumerator enumerator_535 (var_cas_TYPE_LIST, true) ;
    while (enumerator_535.hasCurrentObject ()) {
      result << "class GALGAS_" ;
      result << enumerator_535._key (HERE).reader_identifierRepresentation () ;
      result << " ;\n" ;
      enumerator_535.next () ;
    }
    result << "\n" ;
...
template_filewrapper_predefinedTypeGenerationTemplate_stringset_type (C_Compiler & /* inLexique */) {
  ...
  result << "*\n"
    ...
    "//---------------------------------------------------------------------------*\n"
    "\n"
    "class GALGAS_stringset : public GALGAS_enumerable {\n"
    "//--------------------------------- Private data members\n"
    "  private : cStringsetNode * mRoot ;\n"
    "\n"
    "//--------------------------------- Accessors\n"
    "  public : VIRTUAL_IN_DEBUG inline bool isValid (void) const { return mRoot != NULL ; }\n"
    "  public : VIRTUAL_IN_DEBUG void drop (void) ;\n"
    "\n"
    "//--------------------------------- Default constructor\n"
...
category_reader__semanticDeclarationForGeneration__appendPrimitiveTypeDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_7454
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_7454 != NULL) {
...
category_reader__primitiveTypeForGeneration__appendPrimitiveTypeDeclaration (C_Compiler & inLexique,
                                const cPtr_primitiveTypeForGeneration * operand_7664
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_7664 != NULL) {
    switch (operand_7664->mKind.enumValue ()) {
    ...
    var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_7664->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (188)), operand_7664->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (189)), operand_7664->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (190)), operand_7664->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (191)), operand_7664->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (192)), operand_7664->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (193)), operand_7664->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (194)), operand_7664->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (195)), operand_7664->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (196)), operand_7664->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (197)), operand_7664->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (198)), operand_7664->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (199)))) ;
  }
  return var_cas_outHeader ;
}
...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_12500 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_12500.isBuiltAndTrue ()) {
    const GGS_bool cond_10413 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_10413.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (213)) ;
    }else if (cond_10413.isBuiltAndFalse ()) {
      GGS_semanticDeclarationListAST  var_cas_predefinedTypeASTlist = GGS_semanticDeclarationListAST ::constructor_emptyList () ;
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (216)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (219)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (226)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_primitiveTypesHeaderPrologue (inLexique, var_cas_semanticContext.mTypeMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (233))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11303 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_11303 = NULL ;
        while (((operand_11303 = enumerator_11303.nextObject ()))) {
          macroValidPointer (operand_11303) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendPrimitiveTypeDeclaration (operand_11303->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11303->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (236)))) ;
        }
      }
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11451 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_11451 = NULL ;
        while (((operand_11451 = enumerator_11451.nextObject ()))) {
          macroValidPointer (operand_11451) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_11451->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11451->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (239)))) ;
        }
      }
      const GGS_bool cond_11818 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (241))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_11818.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_12030 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_12030 = NULL ;
        while (((operand_12030 = enumerator_12030.nextObject ()))) {
          macroValidPointer (operand_12030) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_12030->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12030->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (255)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_12030->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12030->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (256)))) ;
        }
      }
      const GGS_bool cond_12476 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (258))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_12476.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (259)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
