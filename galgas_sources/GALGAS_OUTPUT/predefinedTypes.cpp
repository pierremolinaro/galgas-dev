...
//                    september 30th, 2010, at 13h40'24"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
template_filewrapper_predefinedTypeGenerationTemplate_primitiveTypesHeaderPrologue (C_Compiler & /* inLexique */,
  ...
  if (isBuilt) {
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_stringset::cEnumerator enumerator_572 (var_cas_TYPE_LIST, true) ;
    while (enumerator_572.hasCurrentObject ()) {
      result << "class GALGAS_" ;
      result << enumerator_572._key (HERE).reader_identifierRepresentation () ;
      result << " ;\n" ;
      enumerator_572.next () ;
    }
    result << "\n" ;
