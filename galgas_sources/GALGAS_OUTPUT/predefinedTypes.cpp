...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_10134 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_10134.isBuiltAndTrue ()) {
    const GGS_bool cond_7379 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_7379.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (141)) ;
      ...
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (144)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (147)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (154)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedAPTypesHeaderPrologue (inLexique, var_cas_semanticContext.mTypeMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (161))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_8286 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_8286 = NULL ;
        while (((operand_8286 = enumerator_8286.nextObject ()))) {
          macroValidPointer (operand_8286) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassDeclaration (operand_8286->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8286->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (164)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificDeclaration (operand_8286->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8286->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (165)))) ;
        }
      }
      const GGS_bool cond_8740 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (167))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_8740.isBuiltAndTrue ()) {
      ...
      var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypesHeaderPrologue (inLexique, var_cas_semanticContext.mTypeMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (180))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_9006 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_9006 = NULL ;
        while (((operand_9006 = enumerator_9006.nextObject ()))) {
          macroValidPointer (operand_9006) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_9006->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9006->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (183)))) ;
        }
      }
      const GGS_bool cond_9373 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (185))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_9373.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_9585 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_9585 = NULL ;
        while (((operand_9585 = enumerator_9585.nextObject ()))) {
          macroValidPointer (operand_9585) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassImplementation (operand_9585->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9585->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (199)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_9585->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9585->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (200)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_9585->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9585->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (201)))) ;
        }
      }
      const GGS_bool cond_10110 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (203))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_10110.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (204)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
