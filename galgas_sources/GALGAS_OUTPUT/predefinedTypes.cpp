...
void routine_appendPredefinedTypesASTs (C_Compiler & inLexique,
  ...
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_classDeclarationAST ::constructor_new (inLexique, GGS_bool (true), GGS_lstring ::constructor_new (inLexique, GGS_string ("Ze-abstract-class"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (188)), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (189)), GGS_lstringlist ::constructor_emptyList (), var_cas_attributeList, GGS_abstractMethodDefinitionListAST ::constructor_emptyList (), GGS_methodDefinitionListAST ::constructor_emptyList (), GGS_lazyAttributeListAST ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (186))) ;
  var_cas_attributeList = GGS_attributeInCollectionListAST ::constructor_emptyList () ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("luint"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (198)), GGS_lstring ::constructor_new (inLexique, GGS_string ("toto2"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (198))) ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("lstring"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (199)), GGS_lstring ::constructor_new (inLexique, GGS_string ("tutu2"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (199))) ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("lchar"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (200)), GGS_lstring ::constructor_new (inLexique, GGS_string ("tata2"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (200))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_classDeclarationAST ::constructor_new (inLexique, GGS_bool (false), GGS_lstring ::constructor_new (inLexique, GGS_string ("Ze-class"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (203)), GGS_lstring ::constructor_new (inLexique, GGS_string ("Ze-abstract-class"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (204)), GGS_lstringlist ::constructor_emptyList (), var_cas_attributeList, GGS_abstractMethodDefinitionListAST ::constructor_emptyList (), GGS_methodDefinitionListAST ::constructor_emptyList (), GGS_lazyAttributeListAST ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (201))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_13488 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_13488.isBuiltAndTrue ()) {
    const GGS_bool cond_11600 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_11600.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (240)) ;
    }else if (cond_11600.isBuiltAndFalse ()) {
      GGS_semanticDeclarationListAST  var_cas_predefinedTypeASTlist = GGS_semanticDeclarationListAST ::constructor_emptyList () ;
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (243)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (246)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (253)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypesHeader (inLexique, var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (260)).reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (260))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_12456 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_12456 = NULL ;
        while (((operand_12456 = enumerator_12456.nextObject ()))) {
          macroValidPointer (operand_12456) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_12456->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12456->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (263)))) ;
        }
      }
      const GGS_bool cond_12823 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (265))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_12823.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13018 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_13018 = NULL ;
        while (((operand_13018 = enumerator_13018.nextObject ()))) {
          macroValidPointer (operand_13018) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13018->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13018->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (279)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13018->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13018->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (280)))) ;
        }
      }
      const GGS_bool cond_13464 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (282))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_13464.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (283)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
