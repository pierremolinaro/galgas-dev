...
template_filewrapper_predefinedTypeGenerationTemplate_primitiveTypesHeaderPrologue (C_Compiler & /* inLexique */,
  ...
  if (isBuilt) {
    result << "\n"
      ...
      "//---------------------------------------------------------------------------*\n"
      "\n" ;
    GGS_stringset::cEnumerator enumerator_596 (var_cas_TYPE_LIST, true) ;
    while (enumerator_596.hasCurrentObject ()) {
      result << "class GALGAS_" ;
      result << enumerator_596._key (HERE).reader_identifierRepresentation () ;
      result << " ;\n" ;
      enumerator_596.next () ;
    }
    result << "\n" ;
