...
void routine_appendPredefinedTypesASTs (C_Compiler & inLexique,
  ...
  var_cas_insertMethodList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("insertKey"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (120)), GGS_lstring ::constructor_new (inLexique, GGS_string ("redefinition of %K (first definition was in %L) et %% !"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (121)), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (122))) ;
  GGS_mapMethodListAST  var_cas_searchMethodList = GGS_mapMethodListAST ::constructor_emptyList () ;
  var_cas_searchMethodList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("searchKey"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (126)), GGS_lstring ::constructor_new (inLexique, GGS_string ("%K unknown et %% !"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (127))) ;
  GGS_mapMethodListAST  var_cas_removeMethodList = GGS_mapMethodListAST ::constructor_emptyList () ;
  var_cas_removeMethodList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("removeKey"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (131)), GGS_lstring ::constructor_new (inLexique, GGS_string ("%K unknown et %% !"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (132))) ;
  ...
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_mapDeclarationAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("ze-Map"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (136)), var_cas_attributeList, var_cas_insertMethodList, var_cas_searchMethodList, var_cas_removeMethodList, var_cas_insertOrReplaceDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (135))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_listmapDeclarationAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("ze-List-Map"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (146)), GGS_lstring ::constructor_new (inLexique, GGS_string ("uintlist"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (145))) ;
  var_cas_attributeList = GGS_attributeInCollectionListAST ::constructor_emptyList () ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("uint"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (152)), GGS_lstring ::constructor_new (inLexique, GGS_string ("toto"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (152))) ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("string"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (153)), GGS_lstring ::constructor_new (inLexique, GGS_string ("tutu"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (153))) ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("char"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (154)), GGS_lstring ::constructor_new (inLexique, GGS_string ("tata"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (154))) ;
  GGS_sortedListSortDescriptorListAST  var_cas_sortAttributeList = GGS_sortedListSortDescriptorListAST ::constructor_emptyList () ;
  var_cas_sortAttributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("toto"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (156)), GGS_bool (true)) ;
  var_cas_sortAttributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("tata"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (157)), GGS_bool (false)) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_sortedListDeclarationAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("Ze-Sorted-List"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (159)), var_cas_attributeList, var_cas_sortAttributeList COMMA_SOURCE_FILE_AT_LINE (158))) ;
  GGS_lstringlist  var_cas_constantList = GGS_lstringlist ::constructor_emptyList () ;
  var_cas_constantList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_First"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (166))) ;
  var_cas_constantList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_Second"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (167))) ;
  var_cas_constantList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_Third"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (168))) ;
  ...
  var_cas_enumMessageAssociationListAST.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_Third"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (171)), GGS_lstring ::constructor_new (inLexique, GGS_string ("third"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (171))) ;
  var_cas_enumMessageAssociationListAST.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_First"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (172)), GGS_lstring ::constructor_new (inLexique, GGS_string ("first"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (172))) ;
  var_cas_enumMessageAssociationListAST.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_Second"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (173)), GGS_lstring ::constructor_new (inLexique, GGS_string ("second"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (173))) ;
  var_cas_enumMessageListAST.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_message"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (174)), var_cas_enumMessageAssociationListAST) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_enumDeclarationAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("Ze-enumeration"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (176)), var_cas_constantList, var_cas_enumMessageListAST COMMA_SOURCE_FILE_AT_LINE (175))) ;
  var_cas_attributeList = GGS_attributeInCollectionListAST ::constructor_emptyList () ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("uint"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (183)), GGS_lstring ::constructor_new (inLexique, GGS_string ("toto"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (183))) ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("string"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (184)), GGS_lstring ::constructor_new (inLexique, GGS_string ("tutu"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (184))) ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("char"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (185)), GGS_lstring ::constructor_new (inLexique, GGS_string ("tata"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (185))) ;
  ...
  var_cas_firstMethodFormalParameters.addAssign_operation (GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (189)), GGS_lstring ::constructor_new (inLexique, GGS_string ("string"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (190)), GGS_lstring ::constructor_new (inLexique, GGS_string ("parameter"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (191)), GGS_bool (false)) ;
  var_cas_abstractMethodDefinitionListAST.addAssign_operation (GGS_bool (false), GGS_lstring ::constructor_new (inLexique, GGS_string ("first_method"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (196)), var_cas_firstMethodFormalParameters) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_classDeclarationAST ::constructor_new (inLexique, GGS_bool (true), GGS_lstring ::constructor_new (inLexique, GGS_string ("Ze-abstract-class"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (201)), GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (202)), GGS_lstringlist ::constructor_emptyList (), var_cas_attributeList, var_cas_abstractMethodDefinitionListAST, GGS_methodDefinitionListAST ::constructor_emptyList (), GGS_lazyAttributeListAST ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (199))) ;
  var_cas_attributeList = GGS_attributeInCollectionListAST ::constructor_emptyList () ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("luint"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (211)), GGS_lstring ::constructor_new (inLexique, GGS_string ("toto2"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (211))) ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("lstring"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (212)), GGS_lstring ::constructor_new (inLexique, GGS_string ("tutu2"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (212))) ;
  var_cas_attributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("lchar"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (213)), GGS_lstring ::constructor_new (inLexique, GGS_string ("tata2"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (213))) ;
  GGS_methodDefinitionListAST  var_cas_concreteMethodDefinitionListAST = GGS_methodDefinitionListAST ::constructor_emptyList () ;
  var_cas_concreteMethodDefinitionListAST.addAssign_operation (GGS_bool (true), GGS_lstring ::constructor_new (inLexique, GGS_string ("first_method"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (217)), var_cas_firstMethodFormalParameters, GGS_semanticInstructionListAST ::constructor_emptyList ()) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_classDeclarationAST ::constructor_new (inLexique, GGS_bool (false), GGS_lstring ::constructor_new (inLexique, GGS_string ("Ze-class"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (223)), GGS_lstring ::constructor_new (inLexique, GGS_string ("Ze-abstract-class"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (224)), GGS_lstringlist ::constructor_emptyList (), var_cas_attributeList, GGS_abstractMethodDefinitionListAST ::constructor_emptyList (), var_cas_concreteMethodDefinitionListAST, GGS_lazyAttributeListAST ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (221))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_14198 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_14198.isBuiltAndTrue ()) {
    const GGS_bool cond_12310 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_12310.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (260)) ;
    }else if (cond_12310.isBuiltAndFalse ()) {
      GGS_semanticDeclarationListAST  var_cas_predefinedTypeASTlist = GGS_semanticDeclarationListAST ::constructor_emptyList () ;
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (263)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (266)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (273)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypesHeader (inLexique, var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (280)).reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (280))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13166 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_13166 = NULL ;
        while (((operand_13166 = enumerator_13166.nextObject ()))) {
          macroValidPointer (operand_13166) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_13166->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13166->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (283)))) ;
        }
      }
      const GGS_bool cond_13533 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (285))).operator_isEqual (GGS_uint (0U)) ;
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13728 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_13728 = NULL ;
        while (((operand_13728 = enumerator_13728.nextObject ()))) {
          macroValidPointer (operand_13728) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13728->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13728->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (299)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13728->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13728->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (300)))) ;
        }
      }
      const GGS_bool cond_14174 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (302))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_14174.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (303)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
