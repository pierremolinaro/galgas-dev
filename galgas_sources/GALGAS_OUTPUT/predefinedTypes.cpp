...
void routine_appendPredefinedTypesASTs (C_Compiler & inLexique,
  ...
  var_cas_sortAttributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("toto"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (114)), GGS_bool (true)) ;
  var_cas_sortAttributeList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("tata"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (115)), GGS_bool (false)) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_sortedListDeclarationAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("Ze_Sorted_List"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (117)), var_cas_attributeList, var_cas_sortAttributeList COMMA_SOURCE_FILE_AT_LINE (116))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
//--- All files of 'dossier sans titre' directory

static const cRegularFileWrapper * gWrapperAllFiles_predefinedTypeGenerationTemplate_1 [1] = {
  NULL
} ;

//---------------------------------------------------------------------------*

//--- All sub-directories of 'dossier sans titre' directory

static const cDirectoryWrapper * gWrapperAllDirectories_predefinedTypeGenerationTemplate_1 [1] = {
  NULL
} ;

//---------------------------------------------------------------------------*

//--- Directory 'dossier sans titre'

const cDirectoryWrapper gWrapperDirectory_1_predefinedTypeGenerationTemplate (
  "dossier sans titre",
  0,
  gWrapperAllFiles_predefinedTypeGenerationTemplate_1,
  0,
  gWrapperAllDirectories_predefinedTypeGenerationTemplate_1
) ;
...
static const cDirectoryWrapper * gWrapperAllDirectories_predefinedTypeGenerationTemplate_0 [2] = {
  & gWrapperDirectory_1_predefinedTypeGenerationTemplate,
  NULL
} ;
...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_9747 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_9747.isBuiltAndTrue ()) {
    const GGS_bool cond_7859 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_7859.isBuiltAndTrue ()) {
    ...
    }else if (cond_7859.isBuiltAndFalse ()) {
      ...
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypesHeader (inLexique, var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (169)).reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (169))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_8715 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_8715 = NULL ;
        while (((operand_8715 = enumerator_8715.nextObject ()))) {
          macroValidPointer (operand_8715) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_8715->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8715->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (172)))) ;
        }
      }
      const GGS_bool cond_9082 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (174))).operator_isEqual (GGS_uint (0U)) ;
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_9277 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_9277 = NULL ;
        while (((operand_9277 = enumerator_9277.nextObject ()))) {
          macroValidPointer (operand_9277) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_9277->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9277->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (188)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_9277->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9277->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (189)))) ;
        }
      }
      const GGS_bool cond_9723 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (191))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_9723.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (192)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
