...
void routine_appendPredefinedTypesASTs (C_Compiler & inLexique,
  ...
  var_cas_constantList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_First"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (125))) ;
  var_cas_constantList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_Second"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (126))) ;
  var_cas_constantList.addAssign_operation (GGS_lstring ::constructor_new (inLexique, GGS_string ("ze_Third"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (127))) ;
  GGS_enumMessageListAST  var_cas_enumMessageListAST = GGS_enumMessageListAST ::constructor_emptyList () ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_enumDeclarationAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("Ze_enumeration"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (130)), var_cas_constantList, var_cas_enumMessageListAST COMMA_SOURCE_FILE_AT_LINE (129))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_10214 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_10214.isBuiltAndTrue ()) {
    const GGS_bool cond_8326 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_8326.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (162)) ;
    }else if (cond_8326.isBuiltAndFalse ()) {
      GGS_semanticDeclarationListAST  var_cas_predefinedTypeASTlist = GGS_semanticDeclarationListAST ::constructor_emptyList () ;
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (165)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (168)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (175)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypesHeader (inLexique, var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (182)).reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (182))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_9182 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_9182 = NULL ;
        while (((operand_9182 = enumerator_9182.nextObject ()))) {
          macroValidPointer (operand_9182) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_9182->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9182->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (185)))) ;
        }
      }
      const GGS_bool cond_9549 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (187))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_9549.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_9744 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_9744 = NULL ;
        while (((operand_9744 = enumerator_9744.nextObject ()))) {
          macroValidPointer (operand_9744) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_9744->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9744->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (201)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_9744->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9744->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (202)))) ;
        }
      }
      const GGS_bool cond_10190 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (204))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_10190.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (205)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
