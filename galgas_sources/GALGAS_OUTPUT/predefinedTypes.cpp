...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_10707 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_10707.isBuiltAndTrue ()) {
    const GGS_bool cond_8819 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_8819.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (167)) ;
      ...
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (170)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (173)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (180)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypesHeader (inLexique, var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (187)).reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (187))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_9675 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_9675 = NULL ;
        while (((operand_9675 = enumerator_9675.nextObject ()))) {
          macroValidPointer (operand_9675) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_9675->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9675->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (190)))) ;
        }
      }
      const GGS_bool cond_10042 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (192))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_10042.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_10237 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_10237 = NULL ;
        while (((operand_10237 = enumerator_10237.nextObject ()))) {
          macroValidPointer (operand_10237) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_10237->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_10237->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (206)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_10237->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_10237->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (207)))) ;
        }
      }
      const GGS_bool cond_10683 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (209))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_10683.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (210)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
