...
//                    september 26th, 2010, at 14h30'59"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_reader__semanticDeclarationForGeneration__appendPrimitiveTypeDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_7327
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_7327 != NULL) {
...
category_reader__primitiveTypeForGeneration__appendPrimitiveTypeDeclaration (C_Compiler & inLexique,
                                const cPtr_primitiveTypeForGeneration * operand_7537
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_7537 != NULL) {
    switch (operand_7537->mKind.enumValue ()) {
    ...
    var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_7537->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (184)), operand_7537->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (185)), operand_7537->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (186)), operand_7537->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (187)), operand_7537->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (188)), operand_7537->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (189)), operand_7537->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (190)), operand_7537->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (191)), operand_7537->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (192)), operand_7537->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (193)), operand_7537->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (194)), operand_7537->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (195)))) ;
  }
  return var_cas_outHeader ;
}
...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_12373 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_12373.isBuiltAndTrue ()) {
    const GGS_bool cond_10286 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_10286.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (209)) ;
    }else if (cond_10286.isBuiltAndFalse ()) {
      GGS_semanticDeclarationListAST  var_cas_predefinedTypeASTlist = GGS_semanticDeclarationListAST ::constructor_emptyList () ;
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (212)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (215)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (222)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_primitiveTypesHeaderPrologue (inLexique, var_cas_semanticContext.mTypeMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (229))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11176 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_11176 = NULL ;
        while (((operand_11176 = enumerator_11176.nextObject ()))) {
          macroValidPointer (operand_11176) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendPrimitiveTypeDeclaration (operand_11176->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11176->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (232)))) ;
        }
      }
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11324 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_11324 = NULL ;
        while (((operand_11324 = enumerator_11324.nextObject ()))) {
          macroValidPointer (operand_11324) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_11324->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11324->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (235)))) ;
        }
      }
      const GGS_bool cond_11691 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (237))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_11691.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11903 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_11903 = NULL ;
        while (((operand_11903 = enumerator_11903.nextObject ()))) {
          macroValidPointer (operand_11903) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_11903->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11903->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (251)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_11903->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11903->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (252)))) ;
        }
      }
      const GGS_bool cond_12349 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (254))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_12349.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (255)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
