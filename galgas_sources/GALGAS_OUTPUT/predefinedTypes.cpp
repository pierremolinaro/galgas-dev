...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_14334 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_14334.isBuiltAndTrue ()) {
    const GGS_bool cond_12446 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_12446.isBuiltAndTrue ()) {
    ...
    }else if (cond_12446.isBuiltAndFalse ()) {
      ...
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypesHeader (inLexique, var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (284)).reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (284))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13302 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_13302 = NULL ;
        while (((operand_13302 = enumerator_13302.nextObject ()))) {
          macroValidPointer (operand_13302) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_13302->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13302->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (287)))) ;
        }
      }
      const GGS_bool cond_13669 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (289))).operator_isEqual (GGS_uint (0U)) ;
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13864 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_13864 = NULL ;
        while (((operand_13864 = enumerator_13864.nextObject ()))) {
          macroValidPointer (operand_13864) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13864->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13864->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (303)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13864->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13864->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (304)))) ;
        }
      }
      const GGS_bool cond_14310 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (306))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_14310.isBuiltAndTrue ()) {
