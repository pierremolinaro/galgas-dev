...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_14403 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_14403.isBuiltAndTrue ()) {
    ...
    if (cond_12457.isBuiltAndTrue ()) {
      ...
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_optionComponentMapForSemanticAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (272)),  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (270)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (278)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypesHeader (inLexique, var_cas_semanticContext.mTypeMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (285))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13371 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_13371 = NULL ;
        while (((operand_13371 = enumerator_13371.nextObject ()))) {
          macroValidPointer (operand_13371) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_13371->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13371->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (288)))) ;
        }
      }
      const GGS_bool cond_13738 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (290))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_13738.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13933 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_13933 = NULL ;
        while (((operand_13933 = enumerator_13933.nextObject ()))) {
          macroValidPointer (operand_13933) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13933->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13933->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (304)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13933->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13933->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (305)))) ;
        }
      }
      const GGS_bool cond_14379 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (307))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_14379.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (308)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
