...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_14345 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_14345.isBuiltAndTrue ()) {
    ...
    if (cond_12457.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13313 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_13313 = NULL ;
        while (((operand_13313 = enumerator_13313.nextObject ()))) {
          macroValidPointer (operand_13313) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_13313->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13313->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (287)))) ;
        }
      }
      const GGS_bool cond_13680 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (289))).operator_isEqual (GGS_uint (0U)) ;
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13875 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_13875 = NULL ;
        while (((operand_13875 = enumerator_13875.nextObject ()))) {
          macroValidPointer (operand_13875) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_13875->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13875->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (303)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_13875->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13875->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (304)))) ;
        }
      }
      const GGS_bool cond_14321 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (306))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_14321.isBuiltAndTrue ()) {
