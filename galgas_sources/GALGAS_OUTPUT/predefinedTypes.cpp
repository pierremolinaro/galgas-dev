...
void routine_appendPredefinedTypesASTs (C_Compiler & inLexique,
  ...
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_functionPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("function") COMMA_SOURCE_FILE_AT_LINE (83))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_typePredefinedTypeAST ::constructor_new (inLexique, GGS_string ("type") COMMA_SOURCE_FILE_AT_LINE (84))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_binarysetPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("binaryset") COMMA_SOURCE_FILE_AT_LINE (85))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_dataPredefinedTypeAST ::constructor_new (inLexique, GGS_string ("data") COMMA_SOURCE_FILE_AT_LINE (86))) ;
...
template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypesHeaderPrologue (C_Compiler & /* inLexique */,
  ...
  if (isBuilt) {
    result << "\n"
      ...
      "\n"
      "//--- Constructor\n"
      "  public : cCollectionElement_stringset (const GALGASap_string & inKey\n"
      "                                         COMMA_LOCATION_ARGS) ;\n"
      "\n"
      ...
      "\n"
      "//--- Constructor\n"
      "  public : cCollectionElement_data (const GALGASap_uint & inData\n"
      "                                    COMMA_LOCATION_ARGS) ;\n"
      "\n"
      "//--- Virtual method that checks that all attributes are valid\n"
      "  public : virtual bool isValid (void) const ;\n"
...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_9901 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_9901.isBuiltAndTrue ()) {
    const GGS_bool cond_7146 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_7146.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (135)) ;
    }else if (cond_7146.isBuiltAndFalse ()) {
      GGS_semanticDeclarationListAST  var_cas_predefinedTypeASTlist = GGS_semanticDeclarationListAST ::constructor_emptyList () ;
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (138)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (141)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (148)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedAPTypesHeaderPrologue (inLexique, var_cas_semanticContext.mTypeMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (155))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_8053 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_8053 = NULL ;
        while (((operand_8053 = enumerator_8053.nextObject ()))) {
          macroValidPointer (operand_8053) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassDeclaration (operand_8053->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8053->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (158)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificDeclaration (operand_8053->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8053->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (159)))) ;
        }
      }
      const GGS_bool cond_8507 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (161))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_8507.isBuiltAndTrue ()) {
      ...
      var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypesHeaderPrologue (inLexique, var_cas_semanticContext.mTypeMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (174))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_8773 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_8773 = NULL ;
        while (((operand_8773 = enumerator_8773.nextObject ()))) {
          macroValidPointer (operand_8773) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_8773->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_8773->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (177)))) ;
        }
      }
      const GGS_bool cond_9140 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (179))).operator_isEqual (GGS_uint (0U)) ;
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_9352 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_9352 = NULL ;
        while (((operand_9352 = enumerator_9352.nextObject ()))) {
          macroValidPointer (operand_9352) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassImplementation (operand_9352->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9352->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (193)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_9352->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9352->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (194)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_9352->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9352->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (195)))) ;
        }
      }
      const GGS_bool cond_9877 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (197))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_9877.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (198)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
