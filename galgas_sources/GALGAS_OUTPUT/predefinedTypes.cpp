...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_16176 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_16176.isBuiltAndTrue ()) {
    ...
    if (cond_13837.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_14745 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_14745 = NULL ;
        while (((operand_14745 = enumerator_14745.nextObject ()))) {
          macroValidPointer (operand_14745) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendPrimitiveTypeDeclaration (operand_14745->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_14745->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (305)))) ;
        }
      }
      {
        GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_14893 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_14893 = NULL ;
        while (((operand_14893 = enumerator_14893.nextObject ()))) {
          macroValidPointer (operand_14893) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration1 (operand_14893->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_14893->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (308)))) ;
        }
      }
      ...
      {
        GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_15126 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_15126 = NULL ;
        while (((operand_15126 = enumerator_15126.nextObject ()))) {
          macroValidPointer (operand_15126) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration2 (operand_15126->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_15126->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (312)))) ;
        }
      }
      const GGS_bool cond_15494 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (314))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_15494.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationSortedListForGeneration::cEnumerator enumerator_15706 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationSortedListForGeneration::cElement * operand_15706 = NULL ;
        while (((operand_15706 = enumerator_15706.nextObject ()))) {
          macroValidPointer (operand_15706) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_15706->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_15706->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (328)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_15706->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_15706->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (329)))) ;
        }
      }
      const GGS_bool cond_16152 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (331))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_16152.isBuiltAndTrue ()) {
