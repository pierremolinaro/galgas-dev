...
//---------------------------------------------------------------------------*
//                                                                           *
//      Implementation of routine "appendPredefinedString2ListTypeAST"       *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_appendPredefinedString2ListTypeAST (C_Compiler & inLexique,
                                GGS_semanticDeclarationListAST  & var_cas_ioDeclarationListASTs
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_appendPredefinedString2ListTypeAST at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_attributeInCollectionListAST  var_cas_attributeList = GGS_attributeInCollectionListAST ::constructor_emptyList () ;
  ...
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_listDeclarationAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("string2list"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (57)), var_cas_attributeList COMMA_SOURCE_FILE_AT_LINE (56))) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_appendPredefinedString2ListTypeAST\n") ;
  #endif
}
...
void routine_appendPredefinedTypesASTs (C_Compiler & inLexique,
  ...
  ::routine_appendPredefinedString2ListTypeAST (inLexique,  var_cas_ioDeclarationListASTs COMMA_SOURCE_FILE_AT_LINE (118)) ;
  #ifdef DEBUG_TRACE_ENABLED
