...
//                    september 26th, 2010, at 18h57'46"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_reader__semanticDeclarationForGeneration__appendPrimitiveTypeDeclaration (C_Compiler &,
                                const cPtr_semanticDeclarationForGeneration * operand_8258
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_8258 != NULL) {
...
category_reader__primitiveTypeForGeneration__appendPrimitiveTypeDeclaration (C_Compiler & inLexique,
                                const cPtr_primitiveTypeForGeneration * operand_8468
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_string var_cas_outHeader ;
  if (operand_8468 != NULL) {
    switch (operand_8468->mKind.enumValue ()) {
    ...
    var_cas_outHeader.dotAssign_operation (template_filewrapper_typeGenerationTemplate_unifiedClassBodyForType (inLexique, operand_8468->mTypeIndex.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (201)), operand_8468->mTypeIndex.reader_identifierRepresentation (inLexique COMMA_SOURCE_FILE_AT_LINE (202)), operand_8468->mTypeIndex.reader_mIsConcrete (inLexique COMMA_SOURCE_FILE_AT_LINE (203)), operand_8468->mTypeIndex.reader_mConstructorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (204)), operand_8468->mTypeIndex.reader_mReaderMap (inLexique COMMA_SOURCE_FILE_AT_LINE (205)), operand_8468->mTypeIndex.reader_mModifierMap (inLexique COMMA_SOURCE_FILE_AT_LINE (206)), operand_8468->mTypeIndex.reader_mInstanceMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (207)), operand_8468->mTypeIndex.reader_mClassMethodMap (inLexique COMMA_SOURCE_FILE_AT_LINE (208)), operand_8468->mTypeIndex.reader_mEnumerationDescriptor (inLexique COMMA_SOURCE_FILE_AT_LINE (209)), operand_8468->mTypeIndex.reader_mHandledOperatorFlags (inLexique COMMA_SOURCE_FILE_AT_LINE (210)), operand_8468->mTypeIndex.reader_mAddAssignOperatorArguments (inLexique COMMA_SOURCE_FILE_AT_LINE (211)), operand_8468->mTypeIndex.reader_mWithAccessorMap (inLexique COMMA_SOURCE_FILE_AT_LINE (212)))) ;
  }
  return var_cas_outHeader ;
}
...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_13304 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_13304.isBuiltAndTrue ()) {
    const GGS_bool cond_11217 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_11217.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (226)) ;
    }else if (cond_11217.isBuiltAndFalse ()) {
      GGS_semanticDeclarationListAST  var_cas_predefinedTypeASTlist = GGS_semanticDeclarationListAST ::constructor_emptyList () ;
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (229)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (232)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (239)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_primitiveTypesHeaderPrologue (inLexique, var_cas_semanticContext.mTypeMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (246))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_12107 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_12107 = NULL ;
        while (((operand_12107 = enumerator_12107.nextObject ()))) {
          macroValidPointer (operand_12107) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendPrimitiveTypeDeclaration (operand_12107->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12107->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (249)))) ;
        }
      }
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_12255 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_12255 = NULL ;
        while (((operand_12255 = enumerator_12255.nextObject ()))) {
          macroValidPointer (operand_12255) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_12255->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12255->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (252)))) ;
        }
      }
      const GGS_bool cond_12622 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (254))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_12622.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_12834 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_12834 = NULL ;
        while (((operand_12834 = enumerator_12834.nextObject ()))) {
          macroValidPointer (operand_12834) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_12834->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12834->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (268)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_12834->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_12834->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (269)))) ;
        }
      }
      const GGS_bool cond_13280 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (271))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_13280.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (272)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
