...
void routine_appendPredefinedTypesASTs (C_Compiler & inLexique,
  ...
  #endif
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_genericTypeTypeAST ::constructor_new (inLexique, GGS_string ("root"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (68))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_genericTypeTypeAST ::constructor_new (inLexique, GGS_string ("enumerable"), GGS_string ("root") COMMA_SOURCE_FILE_AT_LINE (69))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_genericTypeTypeAST ::constructor_new (inLexique, GGS_string ("class"), GGS_string ("root") COMMA_SOURCE_FILE_AT_LINE (70))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_genericTypeTypeAST ::constructor_new (inLexique, GGS_string ("struct"), GGS_string ("root") COMMA_SOURCE_FILE_AT_LINE (71))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_genericTypeTypeAST ::constructor_new (inLexique, GGS_string ("enum"), GGS_string ("root") COMMA_SOURCE_FILE_AT_LINE (72))) ;
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_genericTypeTypeAST ::constructor_new (inLexique, GGS_string ("mapproxy"), GGS_string ("root") COMMA_SOURCE_FILE_AT_LINE (73))) ;
  ...
  ::routine_appendClassASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("bool") COMMA_SOURCE_FILE_AT_LINE (102)) ;
  ::routine_appendClassASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("uint") COMMA_SOURCE_FILE_AT_LINE (103)) ;
  ::routine_appendClassASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("uint64") COMMA_SOURCE_FILE_AT_LINE (104)) ;
  ::routine_appendClassASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("sint") COMMA_SOURCE_FILE_AT_LINE (105)) ;
  ::routine_appendClassASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("sint64") COMMA_SOURCE_FILE_AT_LINE (106)) ;
  ::routine_appendClassASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("char") COMMA_SOURCE_FILE_AT_LINE (107)) ;
  ::routine_appendClassASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("double") COMMA_SOURCE_FILE_AT_LINE (108)) ;
  ::routine_appendClassASTForTypeWithLocation (inLexique,  var_cas_ioDeclarationListASTs,  GGS_string ("string") COMMA_SOURCE_FILE_AT_LINE (109)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_15692 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_15692.isBuiltAndTrue ()) {
    const GGS_bool cond_12896 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_12896.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (273)) ;
    }else if (cond_12896.isBuiltAndFalse ()) {
      GGS_semanticDeclarationListAST  var_cas_predefinedTypeASTlist = GGS_semanticDeclarationListAST ::constructor_emptyList () ;
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (276)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (279)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (286)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedAPTypesHeaderPrologue (inLexique, var_cas_semanticContext.mTypeMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (293))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_13803 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_13803 = NULL ;
        while (((operand_13803 = enumerator_13803.nextObject ()))) {
          macroValidPointer (operand_13803) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassDeclaration (operand_13803->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_13803->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (296)))) ;
        }
      }
      ...
      const GGS_bool cond_14298 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (300))).operator_isEqual (GGS_uint (0U)) ;
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_14564 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_14564 = NULL ;
        while (((operand_14564 = enumerator_14564.nextObject ()))) {
          macroValidPointer (operand_14564) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_14564->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_14564->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (316)))) ;
        }
      }
      const GGS_bool cond_14931 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (318))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_14931.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_15143 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_15143 = NULL ;
        while (((operand_15143 = enumerator_15143.nextObject ()))) {
          macroValidPointer (operand_15143) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendAutoPointerClassImplementation (operand_15143->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_15143->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (332)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_15143->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_15143->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (333)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_15143->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_15143->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (334)))) ;
        }
      }
      const GGS_bool cond_15668 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (336))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_15668.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (337)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
