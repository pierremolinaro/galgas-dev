...
void routine_appendPredefinedTypesASTs (C_Compiler & inLexique,
  ...
  var_cas_ioDeclarationListASTs.addAssign_operation (GGS_listmapDeclarationAST ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("zeListMap"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (111)), GGS_lstring ::constructor_new (inLexique, GGS_string ("uintlist"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (110))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_10875 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_10875.isBuiltAndTrue ()) {
    const GGS_bool cond_8987 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_8987.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (172)) ;
    }else if (cond_8987.isBuiltAndFalse ()) {
      GGS_semanticDeclarationListAST  var_cas_predefinedTypeASTlist = GGS_semanticDeclarationListAST ::constructor_emptyList () ;
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (175)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (178)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (185)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypesHeader (inLexique, var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (192)).reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (192))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_9843 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_9843 = NULL ;
        while (((operand_9843 = enumerator_9843.nextObject ()))) {
          macroValidPointer (operand_9843) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_9843->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_9843->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (195)))) ;
        }
      }
      const GGS_bool cond_10210 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (197))).operator_isEqual (GGS_uint (0U)) ;
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_10405 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_10405 = NULL ;
        while (((operand_10405 = enumerator_10405.nextObject ()))) {
          macroValidPointer (operand_10405) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_10405->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_10405->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (211)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_10405->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_10405->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (212)))) ;
        }
      }
      const GGS_bool cond_10851 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (214))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_10851.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (215)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
