...
void routine_generatePredefinedTypeFiles (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_12098 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
  if (cond_12098.isBuiltAndTrue ()) {
    const GGS_bool cond_10210 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
    if (cond_10210.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (208)) ;
    }else if (cond_10210.isBuiltAndFalse ()) {
      GGS_semanticDeclarationListAST  var_cas_predefinedTypeASTlist = GGS_semanticDeclarationListAST ::constructor_emptyList () ;
      ::routine_appendPredefinedTypesASTs (inLexique,  var_cas_predefinedTypeASTlist COMMA_SOURCE_FILE_AT_LINE (211)) ;
      GGS_semanticContext var_cas_semanticContext ;
      ::routine_buildSemanticContext (inLexique,  var_cas_predefinedTypeASTlist,  GGS_location (inLexique),  var_cas_semanticContext COMMA_SOURCE_FILE_AT_LINE (214)) ;
      GGS_semanticDeclarationListForGeneration  var_cas_decoratedDeclarationListForGeneration ;
      ::routine_performSemanticAnalysis (inLexique,  var_cas_predefinedTypeASTlist,  var_cas_semanticContext,  var_cas_decoratedDeclarationListForGeneration COMMA_SOURCE_FILE_AT_LINE (221)) ;
      GGS_string var_cas_generatedCode = template_filewrapper_predefinedTypeGenerationTemplate_predefinedTypesHeader (inLexique, var_cas_semanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (228)).reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (228))) ;
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11066 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_11066 = NULL ;
        while (((operand_11066 = enumerator_11066.nextObject ()))) {
          macroValidPointer (operand_11066) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendDeclaration (operand_11066->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11066->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (231)))) ;
        }
      }
      const GGS_bool cond_11433 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (233))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_11433.isBuiltAndTrue ()) {
      ...
      {
        GGS_semanticDeclarationListForGeneration::cEnumerator enumerator_11628 (var_cas_decoratedDeclarationListForGeneration, true) ;
        const GGS_semanticDeclarationListForGeneration::cElement * operand_11628 = NULL ;
        while (((operand_11628 = enumerator_11628.nextObject ()))) {
          macroValidPointer (operand_11628) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendTypeGenericImplementation (operand_11628->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11628->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (247)))) ;
          var_cas_generatedCode.dotAssign_operation ((findCategoryReader__semanticDeclarationForGeneration__appendSpecificImplementation (operand_11628->mDeclaration (HERE)->galgasRTTI ()) (inLexique, operand_11628->mDeclaration.getPtr () COMMA_SOURCE_FILE_AT_LINE (248)))) ;
        }
      }
      const GGS_bool cond_12074 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (250))).operator_isEqual (GGS_uint (0U)) ;
      if (cond_12074.isBuiltAndTrue ()) {
        GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
          "\n"), var_cas_generatedCode, GGS_string ("\n"
          "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (251)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
