...
void routine_generateHeadersOfBuiltinTypes (C_Compiler & inLexique,
  ...
  #endif
const GGS_bool cond_19932 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
if (cond_19932.isBuiltAndTrue ()) {
...
{
GGS_typeMap::cEnumerator enumerator_19611 (function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (450)), true) ;
const GGS_typeMap::cElement * operand_19611 = NULL ;
while (((operand_19611 = enumerator_19611.nextObject ()))) {
  macroValidPointer (operand_19611) ;
const GGS_ACGalgasType  temp_19662 = operand_19611->mInfo.mType ;
if (temp_19662.isBuilt ()) {
  typeCategoryMethod__ACGalgasType__appendGeneratedImplementation method = findCategoryMethod__ACGalgasType__appendGeneratedImplementation (temp_19662.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, temp_19662 (HERE), var_cas_generatedCode COMMA_SOURCE_FILE_AT_LINE (451)) ;
  }
}
}
}
