...
result << "//--------------------------------- Enumeration handling\n"
  "  protected : virtual void populateEnumerationArray (const AC_GALGAS__root * ioEnumerationArray [],\n"
...
result << " * inEnumeratedObject,\n"
  ...
  "  \n"
  "  //--- Attribute access\n" ;
GGS_enumerableTypeDescriptionList::cEnumerator enumerator_18092 ((findCategoryReader__ACGalgasType__enumerable (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (442))), true) ;
const GGS_enumerableTypeDescriptionList::cElement * operand_18092 = NULL ;
while (((operand_18092 = enumerator_18092.nextObject ()))) {
macroValidPointer (operand_18092) ;
result << "    public : const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18092->mType (HERE)->galgasRTTI ()) (inLexique, operand_18092->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (443))) ;
result << " * attribute_" ;
result << operand_18092->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
result << "} ;\n"
  "\n" ;
GGS_modifierMap::cEnumerator enumerator_18348 ((findCategoryReader__ACGalgasType__modifierMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (451))), true) ;
const GGS_modifierMap::cElement * operand_18348 = NULL ;
while (((operand_18348 = enumerator_18348.nextObject ()))) {
macroValidPointer (operand_18348) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "inline void modifier_" ;
result << operand_18348->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << " * & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_18562 (operand_18348->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_18562 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_18562 = enumerator_18562.nextObject ()))) {
macroValidPointer (operand_18562) ;
result << ",\n" ;
result << var_cas_COL ;
if ((operand_18562->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18562->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_18562->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (457))) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (457)) ;
}else if ((operand_18562->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18562->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_18562->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (459))) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (459)) ;
}else if ((operand_18562->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18562->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_18562->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (461))) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (461)) ;
}else {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18562->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_18562->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (463))) ;
result << " * inArgument" ;
...
if (operand_18348->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << operand_18348->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_19619 (operand_18348->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_19619 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_19619 = enumerator_19619.nextObject ()))) {
macroValidPointer (operand_19619) ;
if ((operand_19619->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (478)) ;
}else if ((operand_19619->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (480)) ;
}else if ((operand_19619->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "outArgument" ;
...
if (enumerator_19619.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if ((operand_18348->mInfo.mParameterList.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if (operand_18348->mInfo.mHasCompilerArgument.boolValue ()) {
...
GGS_modifierMap::cEnumerator enumerator_20421 ((findCategoryReader__ACGalgasType__instanceMethodMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (506))), true) ;
const GGS_modifierMap::cElement * operand_20421 = NULL ;
while (((operand_20421 = enumerator_20421.nextObject ()))) {
macroValidPointer (operand_20421) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "inline void method_" ;
result << operand_20421->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << " * inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_20631 (operand_20421->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_20631 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_20631 = enumerator_20631.nextObject ()))) {
macroValidPointer (operand_20631) ;
result << ",\n" ;
result << var_cas_COL ;
if ((operand_20631->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_20631->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_20631->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (512))) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (512)) ;
}else if ((operand_20631->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_20631->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_20631->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (514))) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (514)) ;
}else if ((operand_20631->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_20631->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_20631->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (516))) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (516)) ;
}else {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_20631->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_20631->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (518))) ;
result << " * inArgument" ;
...
if (operand_20421->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << operand_20421->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_21667 (operand_20421->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_21667 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_21667 = enumerator_21667.nextObject ()))) {
macroValidPointer (operand_21667) ;
if ((operand_21667->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (533)) ;
}else if ((operand_21667->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (535)) ;
}else if ((operand_21667->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "outArgument" ;
...
if (enumerator_21667.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if ((operand_20421->mInfo.mParameterList.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if (operand_20421->mInfo.mHasCompilerArgument.boolValue ()) {
result << ", inCompiler COMMA_THERE" ;
}else {
result << " COMMA_THERE" ;
