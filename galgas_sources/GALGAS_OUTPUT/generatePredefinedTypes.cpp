...
result << "\n"
  "//--------------------------------- Instance Methods\n" ;
GGS_modifierMap::cEnumerator enumerator_4853 ((findCategoryReader__ACGalgasType__instanceMethodMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (132))), true) ;
const GGS_modifierMap::cElement * operand_4853 = NULL ;
...
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
GGS_formalParameterSignature::cEnumerator enumerator_4951 (operand_4853->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_4951 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "\n"
  "//--------------------------------- Class Methods\n" ;
GGS_modifierMap::cEnumerator enumerator_6172 ((findCategoryReader__ACGalgasType__classMethodMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (166))), true) ;
const GGS_modifierMap::cElement * operand_6172 = NULL ;
...
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
GGS_formalParameterSignature::cEnumerator enumerator_6280 (operand_6172->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_6280 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << "\n"
  "//--------------------------------- Readers\n" ;
GGS_readerMap::cEnumerator enumerator_7484 ((findCategoryReader__ACGalgasType__readerMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (200))), true) ;
const GGS_readerMap::cElement * operand_7484 = NULL ;
while (((operand_7484 = enumerator_7484.nextObject ()))) {
macroValidPointer (operand_7484) ;
if (((operand_7484->mInfo.mQualifier).operator_isNotEqual (GGS_readerQualifier::constructor_isInherited (inLexique COMMA_HERE))).operator_and ((operand_7484->mInfo.mImplicitConversionReader).operator_isEqual (GGS_string (""))).boolValue ()) {
...
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
GGS_typeList::cEnumerator enumerator_7752 (operand_7484->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_7752 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7752 = enumerator_7752.nextObject ()))) {
macroValidPointer (operand_7752) ;
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_7752->mType (HERE)->galgasRTTI ()) (inLexique, operand_7752->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (204))) ;
result << " * inOperand" ;
...
result << ") const" ;
if ((operand_7484->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_HERE)).boolValue ()) {
result << " = 0" ;
}else {
}
result << " ;\n"
...
GGS_builtinTypeAttributeList::cEnumerator enumerator_14190 ((findCategoryReader__ACGalgasType__attributeDescriptionList (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (360))), true) ;
const GGS_builtinTypeAttributeList::cElement * operand_14190 = NULL ;
while (((operand_14190 = enumerator_14190.nextObject ()))) {
macroValidPointer (operand_14190) ;
result << "  private : " ;
if (operand_14190->mIsPointer.boolValue ()) {
result << "const " ;
}else {
}
result << operand_14190->mCppClassName ;
result << " " ;
if (operand_14190->mIsPointer.boolValue ()) {
result << "* " ;
}else {
}
result << operand_14190->mAttributeName ;
result << " ;\n" ;
if ((operand_14190->mGetterName.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
...
result << operand_14190->mGetterName ;
...
result << "\n"
  ...
  "\n" ;
GGS_modifierMap::cEnumerator enumerator_14645 ((findCategoryReader__ACGalgasType__instanceMethodMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (368))), true) ;
const GGS_modifierMap::cElement * operand_14645 = NULL ;
while (((operand_14645 = enumerator_14645.nextObject ()))) {
macroValidPointer (operand_14645) ;
result << "  friend inline void method_" ;
result << operand_14645->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << " * inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_14777 (operand_14645->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_14777 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_14777 = enumerator_14777.nextObject ()))) {
macroValidPointer (operand_14777) ;
result << ",\n" ;
result << var_cas_COL ;
if ((operand_14777->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_14777->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_14777->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (373))) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (373)) ;
}else if ((operand_14777->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_14777->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_14777->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (375))) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (375)) ;
}else if ((operand_14777->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_14777->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_14777->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (377))) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (377)) ;
}else {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_14777->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_14777->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (379))) ;
result << " * inArgument" ;
...
if (operand_14645->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
GGS_modifierMap::cEnumerator enumerator_15775 ((findCategoryReader__ACGalgasType__modifierMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (391))), true) ;
const GGS_modifierMap::cElement * operand_15775 = NULL ;
while (((operand_15775 = enumerator_15775.nextObject ()))) {
macroValidPointer (operand_15775) ;
result << "  friend inline void modifier_" ;
result << operand_15775->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << " * & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_15911 (operand_15775->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_15911 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_15911 = enumerator_15911.nextObject ()))) {
macroValidPointer (operand_15911) ;
result << ",\n" ;
result << var_cas_COL ;
if ((operand_15911->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_15911->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_15911->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (396))) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (396)) ;
}else if ((operand_15911->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_15911->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_15911->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (398))) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (398)) ;
}else if ((operand_15911->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_15911->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_15911->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (400))) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (400)) ;
}else {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_15911->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_15911->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (402))) ;
result << " * inArgument" ;
...
if (operand_15775->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
GGS_readerMap::cEnumerator enumerator_16917 ((findCategoryReader__ACGalgasType__readerMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (414))), true) ;
const GGS_readerMap::cElement * operand_16917 = NULL ;
while (((operand_16917 = enumerator_16917.nextObject ()))) {
macroValidPointer (operand_16917) ;
if ((operand_16917->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_HERE)).boolValue ()) {
result << "  friend GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_16917->mInfo.mReturnedType (HERE)->galgasRTTI ()) (inLexique, operand_16917->mInfo.mReturnedType.getPtr () COMMA_SOURCE_FILE_AT_LINE (416))) ;
result << " * readerCall_" ;
result << operand_16917->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "const GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << " * inObject" ;
GGS_typeList::cEnumerator enumerator_17177 (operand_16917->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_17177 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_COL ;
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_17177->mType (HERE)->galgasRTTI ()) (inLexique, operand_17177->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (419))) ;
result << " * inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (419)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if (operand_16917->mInfo.mHasLexiqueArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << " * inEnumeratedObject,\n"
  ...
  "  \n"
  "  //--- Attribute access\n" ;
GGS_enumerableTypeDescriptionList::cEnumerator enumerator_18136 ((findCategoryReader__ACGalgasType__enumerable (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (441))), true) ;
const GGS_enumerableTypeDescriptionList::cElement * operand_18136 = NULL ;
while (((operand_18136 = enumerator_18136.nextObject ()))) {
macroValidPointer (operand_18136) ;
result << "    public : const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18136->mType (HERE)->galgasRTTI ()) (inLexique, operand_18136->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (442))) ;
result << " * attribute_" ;
result << operand_18136->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
result << "} ;\n"
  "\n" ;
GGS_modifierMap::cEnumerator enumerator_18392 ((findCategoryReader__ACGalgasType__modifierMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (450))), true) ;
const GGS_modifierMap::cElement * operand_18392 = NULL ;
while (((operand_18392 = enumerator_18392.nextObject ()))) {
macroValidPointer (operand_18392) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "inline void modifier_" ;
result << operand_18392->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << " * & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_18606 (operand_18392->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_18606 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_18606 = enumerator_18606.nextObject ()))) {
macroValidPointer (operand_18606) ;
result << ",\n" ;
result << var_cas_COL ;
if ((operand_18606->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18606->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_18606->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (456))) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (456)) ;
}else if ((operand_18606->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18606->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_18606->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (458))) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (458)) ;
}else if ((operand_18606->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18606->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_18606->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (460))) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (460)) ;
}else {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18606->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_18606->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (462))) ;
result << " * inArgument" ;
...
if (operand_18392->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << operand_18392->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_19672 (operand_18392->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_19672 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_19672 = enumerator_19672.nextObject ()))) {
macroValidPointer (operand_19672) ;
if ((operand_19672->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (477)) ;
}else if ((operand_19672->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (479)) ;
}else if ((operand_19672->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "outArgument" ;
...
if ((operand_18392->mInfo.mParameterList.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if (operand_18392->mInfo.mHasCompilerArgument.boolValue ()) {
...
GGS_modifierMap::cEnumerator enumerator_20483 ((findCategoryReader__ACGalgasType__instanceMethodMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (505))), true) ;
const GGS_modifierMap::cElement * operand_20483 = NULL ;
while (((operand_20483 = enumerator_20483.nextObject ()))) {
macroValidPointer (operand_20483) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "inline void method_" ;
result << operand_20483->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << " * inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_20693 (operand_20483->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_20693 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_20693 = enumerator_20693.nextObject ()))) {
macroValidPointer (operand_20693) ;
result << ",\n" ;
result << var_cas_COL ;
if ((operand_20693->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_20693->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_20693->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (511))) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (511)) ;
}else if ((operand_20693->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_20693->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_20693->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (513))) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (513)) ;
}else if ((operand_20693->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_20693->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_20693->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (515))) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (515)) ;
}else {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_20693->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_20693->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (517))) ;
result << " * inArgument" ;
...
if (operand_20483->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << operand_20483->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_21738 (operand_20483->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_21738 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_21738 = enumerator_21738.nextObject ()))) {
macroValidPointer (operand_21738) ;
if ((operand_21738->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (532)) ;
}else if ((operand_21738->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (534)) ;
}else if ((operand_21738->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "outArgument" ;
...
if (enumerator_21738.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if ((operand_20483->mInfo.mParameterList.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if (operand_20483->mInfo.mHasCompilerArgument.boolValue ()) {
result << ", inCompiler COMMA_THERE" ;
}else {
result << " COMMA_THERE" ;
