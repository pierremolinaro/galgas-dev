...
template_filewrapper_builtinTypeGenerationTemplate_primitiveTypeHeader (C_Compiler & inLexique,
  ...
  if (isBuilt) {
    ...
    GGS_constructorMap::cEnumerator enumerator_1713 ((findCategoryReader__ACGalgasType__constructorMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (45))), true) ;
    const GGS_constructorMap::cElement * operand_1713 = NULL ;
...
result << "\n"
  "//--------------------------------- Modifiers\n" ;
GGS_modifierMap::cEnumerator enumerator_3532 ((findCategoryReader__ACGalgasType__modifierMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (98))), true) ;
const GGS_modifierMap::cElement * operand_3532 = NULL ;
...
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
GGS_formalParameterSignature::cEnumerator enumerator_3632 (operand_3532->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_3632 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_3632 = enumerator_3632.nextObject ()))) {
macroValidPointer (operand_3632) ;
if ((operand_3632->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "const GALGAS_" ;
...
}else if ((operand_3632->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
...
}else if ((operand_3632->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
...
result << "\n"
  "//--------------------------------- Instance Methods\n" ;
GGS_modifierMap::cEnumerator enumerator_4844 ((findCategoryReader__ACGalgasType__instanceMethodMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (132))), true) ;
const GGS_modifierMap::cElement * operand_4844 = NULL ;
while (((operand_4844 = enumerator_4844.nextObject ()))) {
macroValidPointer (operand_4844) ;
result << "  protected : void method_" ;
result << operand_4844->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
GGS_formalParameterSignature::cEnumerator enumerator_4942 (operand_4844->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_4942 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4942 = enumerator_4942.nextObject ()))) {
macroValidPointer (operand_4942) ;
if ((operand_4942->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_4942->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_4942->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (136))) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (136)) ;
}else if ((operand_4942->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_4942->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_4942->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (138))) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (138)) ;
}else if ((operand_4942->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_4942->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_4942->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (140))) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (140)) ;
}else {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_4942->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_4942->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (142))) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (142)) ;
}
if (enumerator_4942.hasNextObject ()) {
result << ",\n" ;
result << var_cas_COL ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_4844->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_4844->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << "\n"
  "//--------------------------------- Class Methods\n" ;
GGS_modifierMap::cEnumerator enumerator_6154 ((findCategoryReader__ACGalgasType__classMethodMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (166))), true) ;
const GGS_modifierMap::cElement * operand_6154 = NULL ;
while (((operand_6154 = enumerator_6154.nextObject ()))) {
macroValidPointer (operand_6154) ;
result << "  public : static void class_method_" ;
result << operand_6154->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
GGS_formalParameterSignature::cEnumerator enumerator_6262 (operand_6154->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_6262 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_6262 = enumerator_6262.nextObject ()))) {
macroValidPointer (operand_6262) ;
if ((operand_6262->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_6262->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_6262->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (170))) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (170)) ;
}else if ((operand_6262->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_6262->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_6262->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (172))) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (172)) ;
}else if ((operand_6262->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_6262->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_6262->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (174))) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (174)) ;
}else {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_6262->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_6262->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (176))) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (176)) ;
}
if (enumerator_6262.hasNextObject ()) {
result << ",\n" ;
result << var_cas_COL ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_6154->mInfo.mParameterList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_6154->mInfo.mHasCompilerArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << "\n"
  "//--------------------------------- Readers\n" ;
GGS_readerMap::cEnumerator enumerator_7457 ((findCategoryReader__ACGalgasType__readerMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (200))), true) ;
const GGS_readerMap::cElement * operand_7457 = NULL ;
while (((operand_7457 = enumerator_7457.nextObject ()))) {
macroValidPointer (operand_7457) ;
if (((operand_7457->mInfo.mQualifier).operator_isNotEqual (GGS_readerQualifier::constructor_isInherited (inLexique COMMA_HERE))).operator_and ((operand_7457->mInfo.mImplicitConversionReader).operator_isEqual (GGS_string (""))).boolValue ()) {
result << "  protected : virtual GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_7457->mInfo.mReturnedType (HERE)->galgasRTTI ()) (inLexique, operand_7457->mInfo.mReturnedType.getPtr () COMMA_SOURCE_FILE_AT_LINE (202))) ;
result << " * reader_" ;
result << operand_7457->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
GGS_typeList::cEnumerator enumerator_7725 (operand_7457->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_7725 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_7725 = enumerator_7725.nextObject ()))) {
macroValidPointer (operand_7725) ;
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_7725->mType (HERE)->galgasRTTI ()) (inLexique, operand_7725->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (204))) ;
result << " * inOperand" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (204)) ;
if (enumerator_7725.hasNextObject ()) {
result << ",\n" ;
result << var_cas_COL ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
...
if ((operand_7457->mInfo.mArgumentTypeList.reader_length ()).operator_isEqual (GGS_uint (0U)).boolValue ()) {
if (operand_7457->mInfo.mHasLexiqueArgument.boolValue ()) {
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
result << "COMMA_LOCATION_ARGS" ;
}else {
...
result << ") const" ;
if ((operand_7457->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_HERE)).boolValue ()) {
result << " = 0" ;
}else {
}
result << " ;\n"
...
GGS_builtinTypeAttributeList::cEnumerator enumerator_14163 ((findCategoryReader__ACGalgasType__attributeDescriptionList (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (360))), true) ;
...
result << "\n"
  ...
  "\n" ;
GGS_modifierMap::cEnumerator enumerator_14618 ((findCategoryReader__ACGalgasType__instanceMethodMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (368))), true) ;
...
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_14750->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_14750->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (373))) ;
result << " * inArgument" ;
...
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_14750->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_14750->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (375))) ;
result << " * & ioArgument" ;
...
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_14750->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_14750->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (377))) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (377)) ;
}else {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_14750->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_14750->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (379))) ;
result << " * inArgument" ;
...
GGS_modifierMap::cEnumerator enumerator_15739 ((findCategoryReader__ACGalgasType__modifierMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (391))), true) ;
...
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_15875->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_15875->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (396))) ;
result << " * inArgument" ;
...
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_15875->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_15875->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (398))) ;
result << " * & ioArgument" ;
...
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_15875->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_15875->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (400))) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (400)) ;
}else {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_15875->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_15875->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (402))) ;
result << " * inArgument" ;
...
GGS_readerMap::cEnumerator enumerator_16872 ((findCategoryReader__ACGalgasType__readerMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (414))), true) ;
...
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_16872->mInfo.mReturnedType (HERE)->galgasRTTI ()) (inLexique, operand_16872->mInfo.mReturnedType.getPtr () COMMA_SOURCE_FILE_AT_LINE (416))) ;
result << " * readerCall_" ;
...
result << var_cas_COL ;
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_17132->mType (HERE)->galgasRTTI ()) (inLexique, operand_17132->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (419))) ;
result << " * inOperand" ;
...
result << " * inEnumeratedObject,\n"
  ...
  "  \n"
  "  //--- Attribute access\n" ;
GGS_enumerableTypeDescriptionList::cEnumerator enumerator_18091 ((findCategoryReader__ACGalgasType__enumerable (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (441))), true) ;
const GGS_enumerableTypeDescriptionList::cElement * operand_18091 = NULL ;
while (((operand_18091 = enumerator_18091.nextObject ()))) {
macroValidPointer (operand_18091) ;
result << "    public : const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18091->mType (HERE)->galgasRTTI ()) (inLexique, operand_18091->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (442))) ;
result << " * attribute_" ;
result << operand_18091->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
result << "} ;\n"
  "\n" ;
GGS_modifierMap::cEnumerator enumerator_18347 ((findCategoryReader__ACGalgasType__modifierMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (450))), true) ;
const GGS_modifierMap::cElement * operand_18347 = NULL ;
while (((operand_18347 = enumerator_18347.nextObject ()))) {
macroValidPointer (operand_18347) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "inline void modifier_" ;
result << operand_18347->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << " * & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_18561 (operand_18347->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_18561 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_18561 = enumerator_18561.nextObject ()))) {
macroValidPointer (operand_18561) ;
result << ",\n" ;
result << var_cas_COL ;
if ((operand_18561->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18561->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_18561->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (456))) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (456)) ;
}else if ((operand_18561->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18561->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_18561->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (458))) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (458)) ;
}else if ((operand_18561->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18561->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_18561->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (460))) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (460)) ;
}else {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18561->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_18561->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (462))) ;
result << " * inArgument" ;
...
if (operand_18347->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << operand_18347->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_19618 (operand_18347->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_19618 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_19618 = enumerator_19618.nextObject ()))) {
macroValidPointer (operand_19618) ;
if ((operand_19618->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (477)) ;
}else if ((operand_19618->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (479)) ;
}else if ((operand_19618->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "outArgument" ;
...
if (enumerator_19618.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if ((operand_18347->mInfo.mParameterList.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if (operand_18347->mInfo.mHasCompilerArgument.boolValue ()) {
...
GGS_modifierMap::cEnumerator enumerator_20420 ((findCategoryReader__ACGalgasType__instanceMethodMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (505))), true) ;
const GGS_modifierMap::cElement * operand_20420 = NULL ;
while (((operand_20420 = enumerator_20420.nextObject ()))) {
macroValidPointer (operand_20420) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "inline void method_" ;
result << operand_20420->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << " * inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_20630 (operand_20420->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_20630 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_20630 = enumerator_20630.nextObject ()))) {
macroValidPointer (operand_20630) ;
result << ",\n" ;
result << var_cas_COL ;
if ((operand_20630->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_20630->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_20630->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (511))) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (511)) ;
}else if ((operand_20630->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_20630->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_20630->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (513))) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (513)) ;
}else if ((operand_20630->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_20630->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_20630->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (515))) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (515)) ;
}else {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_20630->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_20630->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (517))) ;
result << " * inArgument" ;
...
if (operand_20420->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << operand_20420->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_21666 (operand_20420->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_21666 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_21666 = enumerator_21666.nextObject ()))) {
macroValidPointer (operand_21666) ;
if ((operand_21666->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (532)) ;
}else if ((operand_21666->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (534)) ;
}else if ((operand_21666->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "outArgument" ;
...
if (enumerator_21666.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if ((operand_20420->mInfo.mParameterList.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if (operand_20420->mInfo.mHasCompilerArgument.boolValue ()) {
result << ", inCompiler COMMA_THERE" ;
}else {
result << " COMMA_THERE" ;
...
GGS_readerMap::cEnumerator enumerator_2543 ((findCategoryReader__ACGalgasType__readerMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (64))), true) ;
const GGS_readerMap::cElement * operand_2543 = NULL ;
while (((operand_2543 = enumerator_2543.nextObject ()))) {
macroValidPointer (operand_2543) ;
if ((operand_2543->mInfo.mQualifier).operator_isEqual (GGS_readerQualifier::constructor_isBasic (inLexique COMMA_HERE)).boolValue ()) {
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "GALGAS_" ;
...
result << var_cas_TYPE_NAME ;
result << " * inObject" ;
GGS_typeList::cEnumerator enumerator_2883 (operand_2543->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_2883 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_2883 = enumerator_2883.nextObject ()))) {
macroValidPointer (operand_2883) ;
result << ",\n" ;
result << var_cas_COL ;
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_2883->mType (HERE)->galgasRTTI ()) (inLexique, operand_2883->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (70))) ;
result << " * inOperand_" ;
...
result << operand_2543->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_typeList::cEnumerator enumerator_3454 (operand_2543->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_3454 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
if (enumerator_3454.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
result << " (THERE)" ;
GGS_typeList::cEnumerator enumerator_4042 (operand_2543->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_4042 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4042 = enumerator_4042.nextObject ()))) {
macroValidPointer (operand_4042) ;
result << ", inOperand_" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (102)) ;
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
...
GGS_enumerableTypeDescriptionList::cEnumerator enumerator_4380 ((findCategoryReader__ACGalgasType__enumerable (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (118))), true) ;
const GGS_enumerableTypeDescriptionList::cElement * operand_4380 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_4380 = enumerator_4380.nextObject ()))) {
macroValidPointer (operand_4380) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_4380->mType (HERE)->galgasRTTI ()) (inLexique, operand_4380->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (120))) ;
result << " * GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << "::cEnumerator::attribute_" ;
result << operand_4380->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const {\n"
  "  const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_4380->mType (HERE)->galgasRTTI ()) (inLexique, operand_4380->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (121))) ;
...
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_4380->mType (HERE)->galgasRTTI ()) (inLexique, operand_4380->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (122))) ;
result << ") ;\n"
  "  return result ;\n"
  "}\n"
  "\n" ;
