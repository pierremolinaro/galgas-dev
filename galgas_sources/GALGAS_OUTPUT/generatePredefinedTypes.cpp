...
result << var_cas_TYPE_NAME ;
result << " * inObject" ;
GGS_typeList::cEnumerator enumerator_18475 (operand_18215->mInfo.mArgumentTypeList, true) ;
const GGS_typeList::cElement * operand_18475 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
...
result << var_cas_COL ;
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_18475->mType (HERE)->galgasRTTI ()) (inLexique, operand_18475->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (447))) ;
result << " * inOperand" ;
...
result << " * inEnumeratedObject,\n"
  ...
  "  \n"
  "  //--- Attribute access\n" ;
GGS_enumerableTypeDescriptionList::cEnumerator enumerator_19348 ((findCategoryReader__ACGalgasType__enumerable (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (468))), true) ;
const GGS_enumerableTypeDescriptionList::cElement * operand_19348 = NULL ;
while (((operand_19348 = enumerator_19348.nextObject ()))) {
macroValidPointer (operand_19348) ;
result << "    public : const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_19348->mType (HERE)->galgasRTTI ()) (inLexique, operand_19348->mType.getPtr () COMMA_SOURCE_FILE_AT_LINE (469))) ;
result << " * attribute_" ;
result << operand_19348->mEnumerationName.reader_identifierRepresentation () ;
result << " (void) const ;\n" ;
}
result << "\n"
  "  } ;\n" ;
...
result << "} ;\n"
  "\n" ;
GGS_modifierMap::cEnumerator enumerator_19604 ((findCategoryReader__ACGalgasType__modifierMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (477))), true) ;
const GGS_modifierMap::cElement * operand_19604 = NULL ;
while (((operand_19604 = enumerator_19604.nextObject ()))) {
macroValidPointer (operand_19604) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "inline void modifier_" ;
result << operand_19604->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << " * & ioResult" ;
GGS_formalParameterSignature::cEnumerator enumerator_19818 (operand_19604->mInfo.mParameterList, true) ;
...
result << ",\n" ;
result << var_cas_COL ;
if ((operand_19818->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_19818->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_19818->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (483))) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (483)) ;
}else if ((operand_19818->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_19818->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_19818->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (485))) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (485)) ;
}else if ((operand_19818->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_19818->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_19818->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (487))) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (487)) ;
}else {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_19818->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_19818->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (489))) ;
result << " * inArgument" ;
...
if (operand_19604->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << operand_19604->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_20875 (operand_19604->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_20875 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_20875 = enumerator_20875.nextObject ()))) {
macroValidPointer (operand_20875) ;
if ((operand_20875->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (504)) ;
}else if ((operand_20875->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (506)) ;
}else if ((operand_20875->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "outArgument" ;
...
if (enumerator_20875.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if ((operand_19604->mInfo.mParameterList.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if (operand_19604->mInfo.mHasCompilerArgument.boolValue ()) {
...
GGS_modifierMap::cEnumerator enumerator_21677 ((findCategoryReader__ACGalgasType__instanceMethodMap (var_cas_TYPE (HERE)->galgasRTTI ()) (inLexique, var_cas_TYPE.getPtr () COMMA_SOURCE_FILE_AT_LINE (532))), true) ;
const GGS_modifierMap::cElement * operand_21677 = NULL ;
while (((operand_21677 = enumerator_21677.nextObject ()))) {
macroValidPointer (operand_21677) ;
result << "//---------------------------------------------------------------------------*\n"
  "\n"
  "inline void method_" ;
result << operand_21677->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
const GGS_string var_cas_COL = GGS_string::stringWithColumnCount (result) ;
result << "GALGAS_" ;
result << var_cas_TYPE_NAME ;
result << " * inObject" ;
GGS_formalParameterSignature::cEnumerator enumerator_21887 (operand_21677->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_21887 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_21887 = enumerator_21887.nextObject ()))) {
macroValidPointer (operand_21887) ;
result << ",\n" ;
result << var_cas_COL ;
if ((operand_21887->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "const GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_21887->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_21887->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (538))) ;
result << " * inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (538)) ;
}else if ((operand_21887->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_21887->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_21887->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (540))) ;
result << " * & ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (540)) ;
}else if ((operand_21887->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_21887->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_21887->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (542))) ;
result << " * & outArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (542)) ;
}else {
result << "GALGAS_" ;
result << (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (operand_21887->mParameterType (HERE)->galgasRTTI ()) (inLexique, operand_21887->mParameterType.getPtr () COMMA_SOURCE_FILE_AT_LINE (544))) ;
result << " * inArgument" ;
...
if (operand_21677->mInfo.mHasCompilerArgument.boolValue ()) {
result << ",\n" ;
result << var_cas_COL ;
result << "C_Compiler * inCompiler\n" ;
result << var_cas_COL ;
...
result << operand_21677->mKey.ggs_string ().reader_identifierRepresentation () ;
result << " (" ;
GGS_formalParameterSignature::cEnumerator enumerator_22923 (operand_21677->mInfo.mParameterList, true) ;
const GGS_formalParameterSignature::cElement * operand_22923 = NULL ;
{ GGS_uint var_cas_IDX (true, 0) ;
while (((operand_22923 = enumerator_22923.nextObject ()))) {
macroValidPointer (operand_22923) ;
if ((operand_22923->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentConstantIn (inLexique COMMA_HERE)).boolValue ()) {
result << "inArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (559)) ;
}else if ((operand_22923->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentInOut (inLexique COMMA_HERE)).boolValue ()) {
result << "ioArgument" ;
result << var_cas_IDX.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (561)) ;
}else if ((operand_22923->mFormalParameterPassingMode).operator_isEqual (GGS_formalArgumentPassingMode::constructor_argumentOut (inLexique COMMA_HERE)).boolValue ()) {
result << "outArgument" ;
...
if (enumerator_22923.hasNextObject ()) {
result << ", " ;
}
var_cas_IDX.increment_operation (inLexique COMMA_HERE) ;
}
}
if ((operand_21677->mInfo.mParameterList.reader_length ()).operator_strictSup (GGS_uint (0U)).boolValue ()) {
if (operand_21677->mInfo.mHasCompilerArgument.boolValue ()) {
result << ", inCompiler COMMA_THERE" ;
}else {
result << " COMMA_THERE" ;
