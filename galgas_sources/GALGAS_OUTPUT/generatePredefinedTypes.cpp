...
//                    february 10th, 2010, at 10h49'15"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__listGalgasType__appendGeneratedHeader (C_Compiler & inLexique,
                                const cPtr_listGalgasType * operand_16748,
                                GGS_string & var_cas_ioHeader
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_16748 != NULL) {
GGS_ACGalgasType  var_cas_t = operand_16748 ;
GGS_listGalgasType  var_cas_tt = operand_16748 ;
...
category_method__ACGalgasType__appendGeneratedImplementation (C_Compiler &,
                                const cPtr_ACGalgasType * operand_17453,
                                GGS_string & /* var_cas_ioImplementation */
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17453 != NULL) {
  }
}
...
category_method__listGalgasType__appendGeneratedImplementation (C_Compiler & inLexique,
                                const cPtr_listGalgasType * operand_17644,
                                GGS_string & var_cas_ioImplementation
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_17644 != NULL) {
GGS_ACGalgasType  var_cas_t = operand_17644 ;
GGS_listGalgasType  var_cas_tt = operand_17644 ;
var_cas_ioImplementation.dotAssign_operation (template_filewrapper_typeGenerationTemplate_listTypeImplementation (inLexique, (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (var_cas_t (HERE)->galgasRTTI ()) (inLexique, var_cas_t.getPtr () COMMA_SOURCE_FILE_AT_LINE (406))), var_cas_tt.reader_mAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (407)))) ;
  }
}
...
category_method__primitiveGalgasType__appendGeneratedImplementation (C_Compiler & inLexique,
                                const cPtr_primitiveGalgasType * operand_18077,
                                GGS_string & var_cas_ioImplementation
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_18077 != NULL) {
GGS_ACGalgasType  var_cas_t = operand_18077 ;
var_cas_ioImplementation.dotAssign_operation (template_filewrapper_builtinTypeGenerationTemplate_primitiveTypeImplementation (inLexique, (findCategoryReader__ACGalgasType__typeIdentifierRepresentation (var_cas_t (HERE)->galgasRTTI ()) (inLexique, var_cas_t.getPtr () COMMA_SOURCE_FILE_AT_LINE (416))), var_cas_t)) ;
  }
}
...
void routine_generateHeadersOfBuiltinTypes (C_Compiler & inLexique,
  ...
  #endif
const GGS_bool cond_19939 = (var_cas_inDirectory).operator_isNotEqual (GGS_string ("")) ;
if (cond_19939.isBuiltAndTrue ()) {
const GGS_bool cond_18919 = (var_cas_inDirectory.reader_directoryExists ()).operator_not () ;
if (cond_18919.isBuiltAndTrue ()) {
GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (var_cas_inDirectory)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (431)) ;
}else if (cond_18919.isBuiltAndFalse ()) {
GGS_string var_cas_generatedCode = template_filewrapper_builtinTypeGenerationTemplate_predefinedTypesHeader (inLexique, function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (434))) ;
{
GGS_typeMap::cEnumerator enumerator_19133 (function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (436)), true) ;
const GGS_typeMap::cElement * operand_19133 = NULL ;
while (((operand_19133 = enumerator_19133.nextObject ()))) {
  macroValidPointer (operand_19133) ;
const GGS_ACGalgasType  temp_19176 = operand_19133->mInfo.mType ;
if (temp_19176.isBuilt ()) {
  typeCategoryMethod__ACGalgasType__appendGeneratedHeader method = findCategoryMethod__ACGalgasType__appendGeneratedHeader (temp_19176.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, temp_19176 (HERE), var_cas_generatedCode COMMA_SOURCE_FILE_AT_LINE (437)) ;
  }
}
}
}
...
{
GGS_typeMap::cEnumerator enumerator_19618 (function_constructBuiltinTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (451)), true) ;
const GGS_typeMap::cElement * operand_19618 = NULL ;
while (((operand_19618 = enumerator_19618.nextObject ()))) {
  macroValidPointer (operand_19618) ;
const GGS_ACGalgasType  temp_19669 = operand_19618->mInfo.mType ;
if (temp_19669.isBuilt ()) {
  typeCategoryMethod__ACGalgasType__appendGeneratedImplementation method = findCategoryMethod__ACGalgasType__appendGeneratedImplementation (temp_19669.galgasObjectRunTimeInfo ()) ;
  if (method != NULL) {
    method (inLexique, temp_19669 (HERE), var_cas_generatedCode COMMA_SOURCE_FILE_AT_LINE (452)) ;
  }
}
}
}
GGS_string::class_method_generateFile (inLexique, var_cas_inDirectory, GGS_string ("predefined-types.cpp"), GGS_string ("//"), GGS_string ("\n"
  "\n"), var_cas_generatedCode, GGS_string ("\n"
  "\n"), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (454)) ;
}
}
  #ifdef DEBUG_TRACE_ENABLED
