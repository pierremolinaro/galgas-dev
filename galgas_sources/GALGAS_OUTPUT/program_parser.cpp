...
void program_parser::
program_parser::
pr_galgas_component_program_parser_117_4_ (galgas_scanner & _inLexique,
  ...
  var_cas_inclusionsForImplementationFile._addAssign_operation ((var_cas_nomPRGMprincipal.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (171)))._operator_concat (GGS_string (true, ".h"))) ;
  GGS_stringset::cEnumerator enumerator_6990 (var_cas_includedSemanticsComponents, true) ;
  const GGS_stringset::cElement * operand_6990 = NULL ;
  while (((operand_6990 = (GGS_stringset::cElement *) enumerator_6990.nextObject ()))) {
    macroValidPointer (operand_6990) ;
    var_cas_inclusionsForImplementationFile._addAssign_operation ((operand_6990->mKey)._operator_concat (GGS_string (true, ".h"))) ;
  }
  enumerator_6990.reset () ;
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
        if (((var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (194)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (194)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should not be empty") COMMA_SOURCE_FILE_AT_LINE (195)) ;
        }else{
          GGS_uint  var_cas_index ;
          var_cas_index = GGS_uint (true, 0U) ;
          GGS_bool var_cas_ok ;
          var_cas_ok = GGS_bool (true, true) ;
          GGS_uint _variant_8206 = var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (199)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (199))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (199)) ;
          GGS_bool _condition_8206 (_variant_8206._isBuilt (), true) ;
          while (_condition_8206.isBuiltAndTrue ()) {
            _condition_8206 = ((var_cas_index)._operator_strictInf (var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (200)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (200))))._operator_and (var_cas_ok) ;
            if (_condition_8206.isBuiltAndTrue ()) {
              if (_variant_8206.uintValue () == 0) {
                _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (203)) ;
                _condition_8206 = GGS_bool (true, false) ;
              }else{
                _variant_8206._decrement_operation (_inLexique COMMA_HERE) ;
                GGS_char var_cas_c ;
                var_cas_c = var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (201)).reader_characterAtIndex (_inLexique, var_cas_index COMMA_SOURCE_FILE_AT_LINE (201)) ;
                ...
                var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
              }
            }
          }
          if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
            var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should contains only lower case letters, upper case letters, digits and underscore characters") COMMA_SOURCE_FILE_AT_LINE (206)) ;
          }
        }
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
        var_cas_helpMessage = var_cas_messageString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (214)) ;
        ...
        if (((var_cas_parameterTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (220)))._operator_isNotEqual (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
          var_cas_parameterTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only the '@lstring' type is allowed here") COMMA_SOURCE_FILE_AT_LINE (221)) ;
        }
        GGS_lstring  var_cas_argumentName ;
        _inLexique._assignFromAttribute_tokenString (var_cas_argumentName) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertConstInArgument (_inLexique, var_cas_argumentName, GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE), GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_argumentName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (228)), var_cas_argumentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (228)) COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (225)) ;
  ...
  if (var_cas_nomPRGMprincipal._isBuilt () &&
    ...
    ::routine_generatePRGM (_inLexique,  var_cas_nomPRGMprincipal,  var_cas_versionString,  var_cas_ruleDescriptorForProgramList,  var_cas_nombreMaxErreurs,  var_cas_nombreMaxAlertes,  var_cas_optionsComponentsMap,  var_cas_inclusionsForImplementationFile COMMA_SOURCE_FILE_AT_LINE (257)) ;
  }
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_117_4_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_117_4_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_treewalkingComponents  &/* var_cas_ioTreewalkingComponentMap */,
                                GGS_M_filewrappers  &/* var_cas_ioFileWrappers */) {
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_117_4_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_treewalkingComponents  &/* var_cas_ioTreewalkingComponentMap */,
                                GGS_M_filewrappers  &/* var_cas_ioFileWrappers */) {
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_117_4_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_M_treewalkingComponents  &/* var_cas_ioTreewalkingComponentMap */,
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_117_4_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
