...
void program_parser::
pr_galgas_component_program_parser_107_23_ (galgas_scanner & inLexique,
  ...
  GGS_string var_cas_basename = GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (120)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (120)) ;
  const GGS_bool cond_5455 = (var_cas_nomPRGMprincipal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (121))).operator_isNotEqual (var_cas_basename) ;
  if (cond_5455.isBuiltAndTrue ()) {
    var_cas_nomPRGMprincipal.reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, ((((GGS_string ("GALGAS 1.7.5 and later checks "
      "the component name ('")).operator_concat (var_cas_nomPRGMprincipal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (123)))).operator_concat (GGS_string ("') against the source file base name ('"))).operator_concat (var_cas_basename)).operator_concat (GGS_string ("'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (125)) ;
  }
  ...
  var_cas_inclusionsForImplementationFile.addAssign_operation ((var_cas_nomPRGMprincipal.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (162))).operator_concat (GGS_string (".h"))) ;
  {
    GGS_stringset::cEnumerator enumerator_6659 (var_cas_includedSemanticsComponents, true) ;
    while (enumerator_6659.hasCurrentObject ()) {
      var_cas_inclusionsForImplementationFile.addAssign_operation ((enumerator_6659._key (HERE)).operator_concat (GGS_string (".h"))) ;
      enumerator_6659.next () ;
    }
  }
  switch (select_program_parser_0 (inLexique)) {
    case 1 : {
      ...
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("in GALGAS 1.7.2 and later, the 'error ... ;' declaration is obsolete and should be removed") COMMA_SOURCE_FILE_AT_LINE (170)) ;
  ...
  switch (select_program_parser_1 (inLexique)) {
    case 1 : {
      ...
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("in GALGAS 1.7.2 and later, the 'warning ... ;' declaration is obsolete and should be removed") COMMA_SOURCE_FILE_AT_LINE (178)) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
      } break ;
    case 2 : {
  ...
  switch (select_program_parser_2 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("in GALGAS 1.7.5 and later, the 'routine' keyword that introduces the prologue routine has been replaced by the 'before' keyword") COMMA_SOURCE_FILE_AT_LINE (187)) ;
      } break ;
    default :
      break ;
  }
  ...
  { bool syntaxRepeat_3 = true ;
    while (syntaxRepeat_3) {
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
        const GGS_bool cond_8193 = (var_cas_sourceExtension.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (211)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (211))).operator_isEqual (GGS_uint (0U)) ;
        if (cond_8193.isBuiltAndTrue ()) {
          var_cas_sourceExtension.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the source extension should not be empty") COMMA_SOURCE_FILE_AT_LINE (213)) ;
        }else if (cond_8193.isBuiltAndFalse ()) {
          GGS_uint  var_cas_idx = GGS_uint (0U) ;
          GGS_bool var_cas_ok = GGS_bool (true) ;
          GGS_uint _variant_8562 = var_cas_sourceExtension.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (216)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (216)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (216)) ;
          GGS_bool _condition_8562 (_variant_8562.isBuilt (), true) ;
          while (_condition_8562.isBuiltAndTrue ()) {
            _condition_8562 = ((var_cas_idx).operator_strictInf (var_cas_sourceExtension.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (217)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (217)))).operator_and (var_cas_ok) ;
            if (_condition_8562.isBuiltAndTrue ()) {
              if (_variant_8562.uintValue () == 0) {
                inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (221)) ;
                _condition_8562 = GGS_bool (false) ;
              }else{
                _variant_8562.decrement_operation (inLexique COMMA_HERE) ;
                GGS_char var_cas_c = var_cas_sourceExtension.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (218)).reader_characterAtIndex (inLexique, var_cas_idx COMMA_SOURCE_FILE_AT_LINE (218)) ;
                ...
                var_cas_idx.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
              }
            }
          }
          const GGS_bool cond_8750 = (var_cas_ok).operator_not () ;
          if (cond_8750.isBuiltAndTrue ()) {
            var_cas_sourceExtension.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the source extension should contains only lower case letters, upper case letters, digits and underscore characters") COMMA_SOURCE_FILE_AT_LINE (224)) ;
          }
        }
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
        var_cas_helpMessage = var_cas_messageString.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ;
        ...
        const GGS_bool cond_9224 = (var_cas_parameterTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (237))).operator_isNotEqual (GGS_string ("lstring")) ;
        if (cond_9224.isBuiltAndTrue ()) {
          var_cas_parameterTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("only the '@lstring' type is allowed here") COMMA_SOURCE_FILE_AT_LINE (239)) ;
        }
        GGS_lstring  var_cas_argumentName ;
        inLexique.assignFromAttribute_tokenString (var_cas_argumentName) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertConstInArgument (inLexique, var_cas_argumentName, GGS_typeGalgas_lstring ::constructor_new (inLexique COMMA_HERE), GGS_typeAutomaticName ::constructor_new (inLexique, var_cas_argumentName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (245)), var_cas_argumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (245)) COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (242)) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__7B_) COMMA_HERE) ;
  ...
  switch (select_program_parser_4 (inLexique)) {
    ...
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_routine) COMMA_HERE) ;
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("in GALGAS 1.7.5 and later, the 'routine' keyword that introduces the epilogue routine has been replaced by the 'after' keyword") COMMA_SOURCE_FILE_AT_LINE (275)) ;
      } break ;
    default :
      break ;
  }
  ...
  if (var_cas_nomPRGMprincipal.isBuilt () &&
    ...
    ::routine_generatePRGM (inLexique,  var_cas_nomPRGMprincipal,  var_cas_versionString,  var_cas_prologueInstructionList,  var_cas_epilogueInstructionList,  var_cas_ruleDescriptorForProgramList,  var_cas_optionsComponentsMap,  var_cas_inclusionsForImplementationFile COMMA_SOURCE_FILE_AT_LINE (290)) ;
  }
...
void program_parser::
pr_galgas_component_program_parser_107_23_importForGrammarAnalysis (galgas_scanner & inLexique,
...
void program_parser::
pr_galgas_component_program_parser_107_23_importGrammarForSemantics (galgas_scanner & inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
...
void program_parser::
pr_galgas_component_program_parser_107_23_importLexique (galgas_scanner & inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
...
void program_parser::
pr_galgas_component_program_parser_107_23_importOptions (galgas_scanner & inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
...
void program_parser::
pr_galgas_component_program_parser_107_23_importSemantics (galgas_scanner & inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */,
...
void program_parser::
pr_galgas_component_program_parser_107_23_importSyntax (galgas_scanner & inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_EXsemanticContext &/* var_cas_ioSemanticContext */) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
