...
pr_galgas_component_program_parser_85_24_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_listeDesAttributs.reader_length (_inLexique SOURCE_FILE_AT_LINE (185))) < (var_cas_startSymbolSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (185)))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (187)) ;
    ...
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much parameters") SOURCE_FILE_AT_LINE (189)) ;
  }
  ...
  switch (select_program_parser_5 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (((var_cas_metamodelName.reader_value (_inLexique SOURCE_FILE_AT_LINE (214))) != (var_cas_returnedMetamodel.reader_value (_inLexique SOURCE_FILE_AT_LINE (214)))).isBuiltAndTrue ()) {
        var_cas_metamodelName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (var_cas_returnedMetamodel.reader_value (_inLexique SOURCE_FILE_AT_LINE (215))))) + (GGS_string (true, "' metamodel was expected here"))) SOURCE_FILE_AT_LINE (216)) ;
      }
