...
pr_galgas_component_program_parser_83_24_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (((var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (179)).reader_length (_inLexique SOURCE_FILE_AT_LINE (179))) == (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should not be empty") SOURCE_FILE_AT_LINE (181)) ;
        }else{
          GGS_uint  var_cas_index ;
          var_cas_index = GGS_uint (true, 0U) ;
          GGS_bool var_cas_ok ;
          var_cas_ok = GGS_bool (true, true) ;
          GGS_uint _variant_6598 = var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (184)).reader_length (_inLexique SOURCE_FILE_AT_LINE (184))._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (184)) ;
          GGS_bool _condition_6598 (_variant_6598._isBuilt (), true) ;
          while (_condition_6598.isBuiltAndTrue ()) {
            if (_variant_6598.uintValue () == 0) {
              _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (189)) ;
              _condition_6598 = GGS_bool (true, false) ;
            }else{
              _variant_6598._decrement_operation (_inLexique COMMA_HERE) ;
              _condition_6598 = (((var_cas_index) < (var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (185)).reader_length (_inLexique SOURCE_FILE_AT_LINE (185)))) & (var_cas_ok))  ;
              if (_condition_6598.isBuiltAndTrue ()) {
                GGS_char var_cas_c ;
                var_cas_c = var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (186)).reader_characterAtIndex (_inLexique, var_cas_index SOURCE_FILE_AT_LINE (186)) ;
                ...
                var_cas_index._increment_operation (_inLexique SOURCE_FILE_AT_LINE (188)) ;
              }
            }
          }
          if (((! (var_cas_ok))).isBuiltAndTrue ()) {
            var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should contains only lower case letters, upper case letters, digits and underscore characters") SOURCE_FILE_AT_LINE (192)) ;
          }
        }
        _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3A) ;
        ...
        switch (select_program_parser_6 (_inLexique)) {
          ...
          case 2 : {
            ...
            var_cas_helpMessage = var_cas_messageString.reader_string (_inLexique SOURCE_FILE_AT_LINE (202)) ;
            } break ;
          default :
            break ;
        }
        ...
        if (var_cas_grammarComponentsMap._isBuilt ()) {
          var_cas_grammarComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap SOURCE_FILE_AT_LINE (210)) ;
        }
        ...
        if (var_cas_nonterminalSymbolParametersMap._isBuilt ()) {
          var_cas_nonterminalSymbolParametersMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_startSymbolSignature, var_cas_returnedMetamodel SOURCE_FILE_AT_LINE (214)) ;
        }
        ...
        if (((var_cas_listeDesAttributs.reader_length (_inLexique SOURCE_FILE_AT_LINE (219))) < (var_cas_startSymbolSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (219)))).isBuiltAndTrue ()) {
        ...
        }else if (((var_cas_listeDesAttributs.reader_length (_inLexique SOURCE_FILE_AT_LINE (221))) > (var_cas_startSymbolSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (221)))).isBuiltAndTrue ()) {
        ...
        switch (select_program_parser_7 (_inLexique)) {
          ...
          case 2 : {
            ...
            if (((var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (247))) != (var_cas_returnedMetamodel.reader_string (_inLexique SOURCE_FILE_AT_LINE (247)))).isBuiltAndTrue ()) {
              var_cas_metamodelName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (var_cas_returnedMetamodel.reader_string (_inLexique SOURCE_FILE_AT_LINE (248))))) + (GGS_string (true, "' metamodel was expected here"))) SOURCE_FILE_AT_LINE (249)) ;
            }
            GGS_M_semanticsEntitiesForUse  var_cas_8977 ;
            GGS_entityToImplementMap  var_cas_8980 ;
            GGS_stringset  var_cas_8983 ;
            if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
              var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, var_cas_8977, var_cas_8980, var_cas_8983 SOURCE_FILE_AT_LINE (250)) ;
            }
            } break ;
          default :
            break ;
  ...
  if (var_cas_nomPRGMprincipal._isBuilt () &&
    ...
    ::routine_generatePRGM (_inLexique,  var_cas_nomPRGMprincipal,  var_cas_versionString,  var_cas_grammarDescriptorForProgramList,  var_cas_nombreMaxErreurs,  var_cas_nombreMaxAlertes SOURCE_FILE_AT_LINE (272)) ;
  }
...
void program_parser::
program_parser::
pr_program_attributes_declaration_program_parser_729_38_ (galgas_scanner & _inLexique,
                                GGS_typeListeAttributsAxiome  &var_cas_listeDesAttributs) {
...
void program_parser::
pr_program_attributes_declaration_program_parser_729_38_parse (galgas_scanner & _inLexique) {
  switch (select_program_parser_10 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
