...
pr_galgas_component_program_parser_111_6_ (galgas_scanner & _inLexique,
  ...
  var_cas_inclusionsForImplementationFile._addAssign_operation (((var_cas_nomPRGMprincipal.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (163))) + (GGS_string (true, ".h")))) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
        if (((var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (183)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (183))) == (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          ...
          while (_condition_7760.isBuiltAndTrue ()) {
            _condition_7760 = (((var_cas_index) < (var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (189)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (189)))) & (var_cas_ok)) ;
        ...
        if (((var_cas_parameterTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (209))) != (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
