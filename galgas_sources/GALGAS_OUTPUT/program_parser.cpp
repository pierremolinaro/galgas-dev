...
pr_galgas_component_program_parser_111_4_ (galgas_scanner & _inLexique,
  ...
  const GGS_stringset _var_6724 = var_cas_includedSemanticsComponents ;
  const GGS_stringset::element_type * operand_6724 = _var_6724.firstObject () ;
  while ((operand_6724 != NULL)) {
    ...
    operand_6724 = operand_6724->nextObject () ;
  }
