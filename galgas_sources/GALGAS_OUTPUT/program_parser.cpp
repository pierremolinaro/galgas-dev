...
void program_parser::
program_parser::
pr_galgas_component_program_parser_116_4_ (galgas_scanner & _inLexique,
  ...
  GGS_stringset::cEnumerator enumerator_7004 (var_cas_includedSemanticsComponents, true) ;
  const GGS_stringset::cElement * operand_7004 = NULL ;
  while (((operand_7004 = (GGS_stringset::cElement *) enumerator_7004.nextObject ()))) {
    macroValidPointer (operand_7004) ;
    var_cas_inclusionsForImplementationFile._addAssign_operation ((operand_7004->mKey)._operator_concat (GGS_string (true, ".h"))) ;
  }
  enumerator_7004.reset () ;
  switch (select_program_parser_0 (_inLexique)) {
    case 1 : {
      ...
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "the 'error ... ;' declaration is obsolete and should be removed") COMMA_SOURCE_FILE_AT_LINE (177)) ;
  ...
  switch (select_program_parser_1 (_inLexique)) {
    case 1 : {
      ...
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string (true, "the 'warning ... ;' declaration is obsolete and should be removed") COMMA_SOURCE_FILE_AT_LINE (185)) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
      } break ;
    case 2 : {
  ...
  { bool syntaxRepeat_2 = true ;
    while (syntaxRepeat_2) {
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
        if (((var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (199)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (199)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should not be empty") COMMA_SOURCE_FILE_AT_LINE (200)) ;
        }else{
          GGS_uint  var_cas_index ;
          var_cas_index = GGS_uint (true, 0U) ;
          GGS_bool var_cas_ok ;
          var_cas_ok = GGS_bool (true, true) ;
          GGS_uint _variant_8324 = var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (204)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (204))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (204)) ;
          GGS_bool _condition_8324 (_variant_8324._isBuilt (), true) ;
          while (_condition_8324.isBuiltAndTrue ()) {
            _condition_8324 = ((var_cas_index)._operator_strictInf (var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (205)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (205))))._operator_and (var_cas_ok) ;
            if (_condition_8324.isBuiltAndTrue ()) {
              if (_variant_8324.uintValue () == 0) {
                _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (208)) ;
                _condition_8324 = GGS_bool (true, false) ;
              }else{
                _variant_8324._decrement_operation (_inLexique COMMA_HERE) ;
                GGS_char var_cas_c ;
                var_cas_c = var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (206)).reader_characterAtIndex (_inLexique, var_cas_index COMMA_SOURCE_FILE_AT_LINE (206)) ;
                ...
                var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (208)) ;
              }
            }
          }
          if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
            var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should contains only lower case letters, upper case letters, digits and underscore characters") COMMA_SOURCE_FILE_AT_LINE (211)) ;
          }
        }
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
        var_cas_helpMessage = var_cas_messageString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (219)) ;
        ...
        if (((var_cas_parameterTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (225)))._operator_isNotEqual (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
          var_cas_parameterTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only the '@lstring' type is allowed here") COMMA_SOURCE_FILE_AT_LINE (226)) ;
        }
        GGS_lstring  var_cas_argumentName ;
        _inLexique._assignFromAttribute_tokenString (var_cas_argumentName) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertConstInArgument (_inLexique, var_cas_argumentName, GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE), GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_argumentName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (233)), var_cas_argumentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (233)) COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (230)) ;
  ...
  if (var_cas_nomPRGMprincipal._isBuilt () &&
    ...
    ::routine_generatePRGM (_inLexique,  var_cas_nomPRGMprincipal,  var_cas_versionString,  var_cas_ruleDescriptorForProgramList,  var_cas_optionsComponentsMap,  var_cas_inclusionsForImplementationFile COMMA_SOURCE_FILE_AT_LINE (263)) ;
  }
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_116_4_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_116_4_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_treewalkingComponents  &/* var_cas_ioTreewalkingComponentMap */,
                                GGS_semanticContext &/* var_cas_ioSemanticContext */) {
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_116_4_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_treewalkingComponents  &/* var_cas_ioTreewalkingComponentMap */,
                                GGS_semanticContext &/* var_cas_ioSemanticContext */) {
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_116_4_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */,
                                GGS_M_treewalkingComponents  &/* var_cas_ioTreewalkingComponentMap */,
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_116_4_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
