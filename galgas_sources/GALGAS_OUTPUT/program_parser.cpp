...
pr_galgas_component_program_parser_117_6_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
        if (((var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (188)).reader_length (_inLexique SOURCE_FILE_AT_LINE (188))) == (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should not be empty") SOURCE_FILE_AT_LINE (190)) ;
        }else{
          GGS_uint  var_cas_index ;
          var_cas_index = GGS_uint (true, 0U) ;
          GGS_bool var_cas_ok ;
          var_cas_ok = GGS_bool (true, true) ;
          GGS_uint _variant_7883 = var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (193)).reader_length (_inLexique SOURCE_FILE_AT_LINE (193))._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (193)) ;
          GGS_bool _condition_7883 (_variant_7883._isBuilt (), true) ;
          while (_condition_7883.isBuiltAndTrue ()) {
            _condition_7883 = (((var_cas_index) < (var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (194)).reader_length (_inLexique SOURCE_FILE_AT_LINE (194)))) & (var_cas_ok)) ;
            if (_condition_7883.isBuiltAndTrue ()) {
              if (_variant_7883.uintValue () == 0) {
                _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (198)) ;
                _condition_7883 = GGS_bool (true, false) ;
              }else{
                _variant_7883._decrement_operation (_inLexique COMMA_HERE) ;
                GGS_char var_cas_c ;
                var_cas_c = var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (195)).reader_characterAtIndex (_inLexique, var_cas_index SOURCE_FILE_AT_LINE (195)) ;
                ...
                var_cas_index._increment_operation (_inLexique SOURCE_FILE_AT_LINE (197)) ;
              }
            }
          }
          if (((! (var_cas_ok))).isBuiltAndTrue ()) {
            var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should contains only lower case letters, upper case letters, digits and underscore characters") SOURCE_FILE_AT_LINE (201)) ;
          }
        }
        switch (select_program_parser_1 (_inLexique)) {
          case 1 : {
            ...
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
            var_cas_helpMessage = var_cas_messageString.reader_string (_inLexique SOURCE_FILE_AT_LINE (209)) ;
            ...
            if (((var_cas_parameterTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (215))) != (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
              var_cas_parameterTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only the '@lstring' type is allowed here") SOURCE_FILE_AT_LINE (217)) ;
            }
            GGS_lstring  var_cas_argumentName ;
            _inLexique._assignFromAttribute_tokenString (var_cas_argumentName) ;
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertConstInArgument (_inLexique, var_cas_argumentName, GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE), GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_argumentName COMMA_HERE) SOURCE_FILE_AT_LINE (220)) ;
          ...
          case 2 : {
            ...
            switch (select_program_parser_2 (_inLexique)) {
              ...
              case 2 : {
                ...
                _inLexique._assignFromAttribute_tokenString (var_cas_messageString) ;
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
                var_cas_helpMessage = var_cas_messageString.reader_string (_inLexique SOURCE_FILE_AT_LINE (259)) ;
                } break ;
              default :
                break ;
            }
            ...
            if (var_cas_componentEntitiesMap._isBuilt ()) {
              var_cas_componentEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_e SOURCE_FILE_AT_LINE (265)) ;
            }
            ...
            { cPtr_C_grammarForSemantics * ptrExtraire_ = dynamic_cast <cPtr_C_grammarForSemantics *> (var_cas_e.getPtr ()) ;
              if (ptrExtraire_ == NULL) {
                ...
                if (var_cas_e.getPtr () != NULL) {
                  ...
                  var_cas_grammarName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (268)) ;
                }
              }else{
            ...
            if (var_cas_grammarAltMap._isBuilt ()) {
              var_cas_grammarAltMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_startSymbolSignature, var_cas_returnedMetamodel SOURCE_FILE_AT_LINE (272)) ;
            }
            ...
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((((((((((((((((((GGS_string (true, "old style construct; now use the following construct:\n")) + (GGS_string (true, "  when . \"")))) + (var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (281))))) + (GGS_string (true, "\" message \"an '.")))) + (var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (281))))) + (GGS_string (true, "' source file\" \?\?@lstring inSourceFile {\n")))) + (GGS_string (true, "    grammar ")))) + (var_cas_grammarName.reader_string (_inLexique SOURCE_FILE_AT_LINE (282))))) + (GGS_string (true, " in inSourceFile;\n")))) + (GGS_string (true, "  }\n"))) SOURCE_FILE_AT_LINE (283)) ;
            if (((var_cas_grammarAttributeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (285))) < (var_cas_startSymbolSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (285)))).isBuiltAndTrue ()) {
              GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (287)) ;
            }else if (((var_cas_grammarAttributeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (287))) > (var_cas_startSymbolSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (287)))).isBuiltAndTrue ()) {
              GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much parameters") SOURCE_FILE_AT_LINE (289)) ;
            }
            ...
            switch (select_program_parser_3 (_inLexique)) {
              ...
              case 2 : {
                  ...
                  case 2 : {
                    ...
                    { bool syntaxRepeat = true ;
                      while (syntaxRepeat) {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
                          var_cas_contraintStringsetForMetamodel._addAssign_operation (var_cas_constraintComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (307))) ;
                ...
                if (((var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (313))) != (var_cas_returnedMetamodel.reader_string (_inLexique SOURCE_FILE_AT_LINE (313)))).isBuiltAndTrue ()) {
                  var_cas_metamodelName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (var_cas_returnedMetamodel.reader_string (_inLexique SOURCE_FILE_AT_LINE (314))))) + (GGS_string (true, "' metamodel was expected here"))) SOURCE_FILE_AT_LINE (315)) ;
                }
                GGS_entityToImplementMap  automatic_var_0 ;
                GGS_stringset  automatic_var_1 ;
                if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
                  var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, automatic_var_0, automatic_var_1 SOURCE_FILE_AT_LINE (316)) ;
                }
                } break ;
              default :
                break ;
  ...
  GGS_M_grammarComponents::element_type * operand_12823 = var_cas_ioGrammarComponentsMap.firstObject () ;
  while ((operand_12823 != NULL)) {
    macroValidPointer (operand_12823) ;
    var_cas_grammarNameList._addAssign_operation (operand_12823->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (338))) ;
    operand_12823 = operand_12823->nextObject () ;
  }
  if (var_cas_nomPRGMprincipal._isBuilt () &&
    ...
    ::routine_generatePRGM (_inLexique,  var_cas_nomPRGMprincipal,  var_cas_versionString,  var_cas_grammarDescriptorForProgramList,  var_cas_ruleDescriptorForProgramList,  var_cas_nombreMaxErreurs,  var_cas_nombreMaxAlertes,  var_cas_grammarNameList,  var_cas_optionsComponentsMap SOURCE_FILE_AT_LINE (341)) ;
  }
...
void program_parser::
program_parser::
pr_program_attributes_declaration_program_parser_707_6_ (galgas_scanner & _inLexique,
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_outAttributeSet._addAssign_operation (var_cas_attributeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (720))) ;
...
void program_parser::
pr_program_attributes_declaration_program_parser_707_6_parse (galgas_scanner & _inLexique) {
  switch (select_program_parser_6 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
