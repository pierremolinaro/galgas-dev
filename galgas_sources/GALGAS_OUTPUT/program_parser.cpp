...
pr_galgas_component_program_parser_120_4_ (galgas_scanner & _inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_7208 (var_cas_includedSemanticsComponents, true) ;
    const GGS_stringset::cElement * operand_7208 = NULL ;
    while (((operand_7208 = (GGS_stringset::cElement *) enumerator_7208.nextObject ()))) {
      macroValidPointer (operand_7208) ;
      var_cas_inclusionsForImplementationFile._addAssign_operation ((operand_7208->mKey)._operator_concat (GGS_string (true, ".h"))) ;
    }
  }
  ...
  { bool syntaxRepeat_3 = true ;
    while (syntaxRepeat_3) {
        ...
        if (((var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (230)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (230)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          ...
          GGS_uint _variant_9530 = var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (235)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (235))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (235)) ;
          GGS_bool _condition_9530 (_variant_9530._isBuilt (), true) ;
          while (_condition_9530.isBuiltAndTrue ()) {
            _condition_9530 = ((var_cas_index)._operator_strictInf (var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (236)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (236))))._operator_and (var_cas_ok) ;
            if (_condition_9530.isBuiltAndTrue ()) {
              if (_variant_9530.uintValue () == 0) {
                _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (239)) ;
                _condition_9530 = GGS_bool (true, false) ;
              }else{
                _variant_9530._decrement_operation (_inLexique COMMA_HERE) ;
                GGS_char var_cas_c ;
