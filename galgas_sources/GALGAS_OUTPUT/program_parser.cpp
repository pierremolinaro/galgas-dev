    ...
    while (syntaxRepeat) {
        ...
        switch (select_program_parser_7 (_inLexique)) {
          ...
          case 2 : {
            ...
            GGS_entityToImplementMap  var_cas_8977 ;
            GGS_stringset  var_cas_8980 ;
            if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
              var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, var_cas_8977, var_cas_8980 SOURCE_FILE_AT_LINE (250)) ;
            }
            } break ;
          default :
            break ;
