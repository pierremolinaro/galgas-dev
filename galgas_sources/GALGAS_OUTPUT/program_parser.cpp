...
pr_galgas_component_program_parser_111_6_ (galgas_scanner & _inLexique,
  ...
  #ifdef DEBUG_TRACE_ENABLED
    { C_String message_ ;
      _inLexique.didParseTerminal ("$program$", message_) ;
    }
  #endif
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        #endif
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
        if (((var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (183)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (183)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          ...
          GGS_uint _variant_7772 = var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (188)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (188))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (188)) ;
          GGS_bool _condition_7772 (_variant_7772._isBuilt (), true) ;
          while (_condition_7772.isBuiltAndTrue ()) {
            _condition_7772 = ((var_cas_index)._operator_strictInf (var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (189)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (189))))._operator_and (var_cas_ok) ;
            if (_condition_7772.isBuiltAndTrue ()) {
              if (_variant_7772.uintValue () == 0) {
                _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (193)) ;
                _condition_7772 = GGS_bool (true, false) ;
              }else{
                _variant_7772._decrement_operation (_inLexique COMMA_HERE) ;
                GGS_char var_cas_c ;
        ...
        if (((var_cas_parameterTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (209)))._operator_isNotEqual (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
