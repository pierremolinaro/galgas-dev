...
pr_galgas_component_program_parser_85_24_ (galgas_scanner & _inLexique,
  ...
  switch (select_program_parser_5 (_inLexique)) {
    ...
    case 2 : {
      ...
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1__3B) ;
      if (((var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (214))) != (var_cas_returnedMetamodel.reader_string (_inLexique SOURCE_FILE_AT_LINE (214)))).isBuiltAndTrue ()) {
        var_cas_metamodelName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (var_cas_returnedMetamodel.reader_string (_inLexique SOURCE_FILE_AT_LINE (215))))) + (GGS_string (true, "' metamodel was expected here"))) SOURCE_FILE_AT_LINE (216)) ;
      }
      GGS_M_semanticsEntitiesForUse  var_cas_7807 ;
      GGS_entityToImplementMap  var_cas_7810 ;
      GGS_stringset  var_cas_7813 ;
      if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
        var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, var_cas_7807, var_cas_7810, var_cas_7813 SOURCE_FILE_AT_LINE (217)) ;
      }
      } break ;
    default :
      break ;
