...
void program_parser::
program_parser::
pr_galgas_component_program_parser_85_6_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
        if (((var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (164)).reader_length (_inLexique SOURCE_FILE_AT_LINE (164))) == (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should not be empty") SOURCE_FILE_AT_LINE (166)) ;
        }else{
          GGS_uint  var_cas_index ;
          var_cas_index = GGS_uint (true, 0U) ;
          GGS_bool var_cas_ok ;
          var_cas_ok = GGS_bool (true, true) ;
          GGS_uint _variant_6258 = var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (169)).reader_length (_inLexique SOURCE_FILE_AT_LINE (169))._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (169)) ;
          GGS_bool _condition_6258 (_variant_6258._isBuilt (), true) ;
          while (_condition_6258.isBuiltAndTrue ()) {
            _condition_6258 = (((var_cas_index) < (var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (170)).reader_length (_inLexique SOURCE_FILE_AT_LINE (170)))) & (var_cas_ok)) ;
            if (_condition_6258.isBuiltAndTrue ()) {
              if (_variant_6258.uintValue () == 0) {
                _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (174)) ;
                _condition_6258 = GGS_bool (true, false) ;
              }else{
                _variant_6258._decrement_operation (_inLexique COMMA_HERE) ;
                GGS_char var_cas_c ;
                var_cas_c = var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (171)).reader_characterAtIndex (_inLexique, var_cas_index SOURCE_FILE_AT_LINE (171)) ;
                ...
                var_cas_index._increment_operation (_inLexique SOURCE_FILE_AT_LINE (173)) ;
              }
            }
          }
          if (((! (var_cas_ok))).isBuiltAndTrue ()) {
            var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should contains only lower case letters, upper case letters, digits and underscore characters") SOURCE_FILE_AT_LINE (177)) ;
          }
        }
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3A) COMMA_HERE) ;
        ...
        switch (select_program_parser_5 (_inLexique)) {
          ...
          case 2 : {
            ...
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
            var_cas_helpMessage = var_cas_messageString.reader_string (_inLexique SOURCE_FILE_AT_LINE (187)) ;
            } break ;
          default :
            break ;
        }
        ...
        if (var_cas_grammarComponentsMap._isBuilt ()) {
          var_cas_grammarComponentsMap (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap SOURCE_FILE_AT_LINE (195)) ;
        }
        ...
        if (var_cas_nonterminalSymbolParametersMap._isBuilt ()) {
          var_cas_nonterminalSymbolParametersMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_startSymbolSignature, var_cas_returnedMetamodel SOURCE_FILE_AT_LINE (199)) ;
        }
        ...
        if (((var_cas_grammarAttributeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (208))) < (var_cas_startSymbolSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (208)))).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (210)) ;
        }else if (((var_cas_grammarAttributeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (210))) > (var_cas_startSymbolSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (210)))).isBuiltAndTrue ()) {
          GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much parameters") SOURCE_FILE_AT_LINE (212)) ;
        }
        ...
        switch (select_program_parser_6 (_inLexique)) {
          ...
          case 2 : {
              ...
              case 2 : {
                ...
                { bool syntaxRepeat = true ;
                  while (syntaxRepeat) {
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
                      var_cas_contraintStringsetForMetamodel._addAssign_operation (var_cas_constraintComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (230))) ;
            ...
            if (((var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (236))) != (var_cas_returnedMetamodel.reader_string (_inLexique SOURCE_FILE_AT_LINE (236)))).isBuiltAndTrue ()) {
              var_cas_metamodelName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (var_cas_returnedMetamodel.reader_string (_inLexique SOURCE_FILE_AT_LINE (237))))) + (GGS_string (true, "' metamodel was expected here"))) SOURCE_FILE_AT_LINE (238)) ;
            }
            GGS_entityToImplementMap  automatic_var_0 ;
            GGS_stringset  automatic_var_1 ;
            if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
              var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, automatic_var_0, automatic_var_1 SOURCE_FILE_AT_LINE (239)) ;
            }
            } break ;
          default :
            break ;
          ...
          while (syntaxRepeat) {
            switch (select_repeat_program_parser_9 (_inLexique)) {
              case 2 : {
                ...
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
                if (((var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (247))) == (var_cas_loggedObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (247)))).isBuiltAndTrue ()) {
                ...
                }else if ((var_cas_contraintStringsetForMetamodel.reader_hasKey (_inLexique, var_cas_loggedObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (249)) SOURCE_FILE_AT_LINE (249))).isBuiltAndTrue ()) {
                ...
                }else if ((var_cas_grammarAttributeSet.reader_hasKey (_inLexique, var_cas_loggedObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (251)) SOURCE_FILE_AT_LINE (251))).isBuiltAndTrue ()) {
                  ...
                  var_cas_loggedObjectName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this object cannot be logged") SOURCE_FILE_AT_LINE (255)) ;
                }
                } break ;
              default :
                syntaxRepeat = false ;
  ...
  if (var_cas_nomPRGMprincipal._isBuilt () &&
    ...
    ::routine_generatePRGM (_inLexique,  var_cas_nomPRGMprincipal,  var_cas_versionString,  var_cas_grammarDescriptorForProgramList,  var_cas_nombreMaxErreurs,  var_cas_nombreMaxAlertes SOURCE_FILE_AT_LINE (276)) ;
  }
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_85_6_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_85_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_85_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_constraintComponents  &/* var_cas_ioConstraintComponentMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_85_6_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_constraintComponents  &/* var_cas_ioConstraintComponentMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_85_6_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void program_parser::
program_parser::
pr_program_attributes_declaration_program_parser_714_6_ (galgas_scanner & _inLexique,
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_outAttributeSet._addAssign_operation (var_cas_attributeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (727))) ;
          switch (select_repeat_program_parser_11 (_inLexique)) {
            case 2 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2C) COMMA_HERE) ;
              } break ;
            default :
...
void program_parser::
pr_program_attributes_declaration_program_parser_714_6_parse (galgas_scanner & _inLexique) {
  switch (select_program_parser_10 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
