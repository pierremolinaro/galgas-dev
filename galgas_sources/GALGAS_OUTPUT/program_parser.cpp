  ...
  { bool syntaxRepeat_3 = true ;
    while (syntaxRepeat_3) {
        ...
        if (((var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (227)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (227)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          ...
          GGS_uint _variant_9352 = var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (232)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (232))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (232)) ;
          GGS_bool _condition_9352 (_variant_9352._isBuilt (), true) ;
          while (_condition_9352.isBuiltAndTrue ()) {
            _condition_9352 = ((var_cas_index)._operator_strictInf (var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (233)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (233))))._operator_and (var_cas_ok) ;
            if (_condition_9352.isBuiltAndTrue ()) {
              if (_variant_9352.uintValue () == 0) {
                _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (236)) ;
                _condition_9352 = GGS_bool (true, false) ;
              }else{
                _variant_9352._decrement_operation (_inLexique COMMA_HERE) ;
                GGS_char var_cas_c ;
