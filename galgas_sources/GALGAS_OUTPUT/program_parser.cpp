...
pr_galgas_component_program_parser_85_24_ (galgas_scanner & _inLexique,
  ...
  var_cas_grammarComponentsMap.methode_searchKey (_inLexique, var_cas_grammarName, var_cas_nonterminalSymbolParametersMap, var_cas_lexiqueClassName, var_cas_optionsComponentsMap SOURCE_FILE_AT_LINE (176)) ;
  ...
  var_cas_nonterminalSymbolParametersMap.methode_searchKey (_inLexique, var_cas_altName, var_cas_startSymbolSignature, var_cas_returnedMetamodel SOURCE_FILE_AT_LINE (180)) ;
  ...
  switch (select_program_parser_5 (_inLexique)) {
    case 1 : {
      var_cas_metamodelName = GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) ;
      var_cas_rootEntityName = GGS_lstring::constructor_new (GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_metamodel) ;
      _inLexique.acceptTerminal (galgas_scanner::galgas_scanner_1_identifier) ;
      ...
      var_cas_ioMetamodelComponentMap.methode_searchKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, var_cas_7795, var_cas_7798, var_cas_7801 SOURCE_FILE_AT_LINE (217)) ;
      } break ;
    default :
      break ;
  }
