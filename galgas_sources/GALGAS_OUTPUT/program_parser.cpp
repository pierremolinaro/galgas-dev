...
pr_galgas_component_program_parser_104_23_ (galgas_scanner & inLexique,
  ...
  GGS_string var_cas_basename = GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (117)).reader_stringByDeletingPathExtension (inLexique COMMA_SOURCE_FILE_AT_LINE (117)) ;
  ...
  { bool syntaxRepeat_3 = true ;
    while (syntaxRepeat_3) {
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5F_string) COMMA_HERE) ;
        const GGS_bool cond_8051 = (var_cas_sourceExtension.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (208)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (208))).operator_isEqual (GGS_uint (0U)) ;
        if (cond_8051.isBuiltAndTrue ()) {
          ...
          GGS_uint _variant_8420 = var_cas_sourceExtension.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (213)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (213)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (213)) ;
          GGS_bool _condition_8420 (_variant_8420.isBuilt (), true) ;
          while (_condition_8420.isBuiltAndTrue ()) {
            _condition_8420 = ((var_cas_idx).operator_strictInf (var_cas_sourceExtension.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (214)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (214)))).operator_and (var_cas_ok) ;
