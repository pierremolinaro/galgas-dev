...
pr_galgas_component_program_parser_103_23_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_nomPRGMprincipal.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (117)))._operator_isNotEqual (var_cas_basename)).isBuiltAndTrue ()) {
    var_cas_nomPRGMprincipal.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((((GGS_string (true, "GALGAS 1.7.5 and later checks "
      "the component name ('"))._operator_concat (var_cas_nomPRGMprincipal.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (119))))._operator_concat (GGS_string (true, "') against the source file base name ('")))._operator_concat (var_cas_basename))._operator_concat (GGS_string (true, "'): they should be identical")) COMMA_SOURCE_FILE_AT_LINE (121)) ;
  }
  ...
  var_cas_inclusionsForImplementationFile._addAssign_operation ((var_cas_nomPRGMprincipal.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (158)))._operator_concat (GGS_string (true, ".h"))) ;
  {
    ...
    while (enumerator_6482.hc ()) {
      var_cas_inclusionsForImplementationFile._addAssign_operation ((enumerator_6482._key (HERE))._operator_concat (GGS_string (true, ".h"))) ;
  ...
  switch (select_program_parser_0 (_inLexique)) {
    case 1 : {
      ...
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.7.2 and later, the 'error ... ;' declaration is obsolete and should be removed") COMMA_SOURCE_FILE_AT_LINE (166)) ;
  ...
  switch (select_program_parser_1 (_inLexique)) {
    case 1 : {
      ...
      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "in GALGAS 1.7.2 and later, the 'warning ... ;' declaration is obsolete and should be removed") COMMA_SOURCE_FILE_AT_LINE (174)) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5Fliteral_5Finteger) COMMA_HERE) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
      } break ;
    case 2 : {
  ...
  { bool syntaxRepeat_3 = true ;
    while (syntaxRepeat_3) {
        ...
        if (((var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (207)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (207)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should not be empty") COMMA_SOURCE_FILE_AT_LINE (209)) ;
        }else{
          ...
          if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
            var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should contains only lower case letters, upper case letters, digits and underscore characters") COMMA_SOURCE_FILE_AT_LINE (220)) ;
          }
        }
        ...
        if (((var_cas_parameterTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (233)))._operator_isNotEqual (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
          var_cas_parameterTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only the '@lstring' type is allowed here") COMMA_SOURCE_FILE_AT_LINE (235)) ;
        }
