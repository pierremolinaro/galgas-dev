...
void program_parser::rule_program_5F_parser_galgas_5F_component_i0_ (C_Lexique_galgas_5F_scanner & inLexique,
  ...
  const GGS_bool cond_5125 = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_SOURCE_FILE_AT_LINE (117)).reader_pathExtension ()).operator_isNotEqual (GGS_string ("gProgram")) ;
  ...
  const GGS_string var_cas_basename = GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_SOURCE_FILE_AT_LINE (120)).reader_lastPathComponent ().reader_stringByDeletingPathExtension () ;
  ...
  GGS_ModelMap  var_cas_modelMap = GGS_ModelMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (131)) ;
  GGS_ActionMap  var_cas_actionMap = GGS_ActionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (132)) ;
  ...
  GGS_typeTableEnAvant  var_cas_tableEnAvant0 = GGS_typeTableEnAvant ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
  ...
  GGS_typeVariablesMap  var_cas_prologueVariablesMap = GGS_typeVariablesMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (190)) ;
  GGS_typeTableEnAvant  var_cas_prologueTableEnAvant = GGS_typeTableEnAvant ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (191)) ;
  ...
  { bool syntaxRepeat_3 = true ;
    while (syntaxRepeat_3) {
        ...
        GGS_typeVariablesMap  var_cas_variablesMap = GGS_typeVariablesMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (232)) ;
        ...
        inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertConstInArgument (inLexique, var_cas_argumentName, GGS_typeGalgas_lstring ::constructor_new (inLexique COMMA_SOURCE_FILE_AT_LINE (243)), GGS_typeAutomaticName ::constructor_new (inLexique, var_cas_argumentName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (244)), var_cas_argumentName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (244)) COMMA_SOURCE_FILE_AT_LINE (244)) COMMA_SOURCE_FILE_AT_LINE (241)) ;
        inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7B_) COMMA_HERE) ;
        GGS_typeInstructionList  var_cas_instructionList = GGS_typeInstructionList ::constructor_emptyList () ;
        GGS_typeTableEnAvant  var_cas_tableEnAvant = GGS_typeTableEnAvant ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (249)) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_galgas_5F_scanner::kToken__7B_) COMMA_HERE) ;
  GGS_typeVariablesMap  var_cas_variablesMap = GGS_typeVariablesMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (277)) ;
  GGS_typeTableEnAvant  var_cas_epilogueTableEnAvant = GGS_typeTableEnAvant ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (278)) ;
