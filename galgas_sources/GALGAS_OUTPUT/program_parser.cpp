...
pr_galgas_component_program_parser_118_4_ (galgas_scanner & _inLexique,
  ...
  GGS_stringset::cEnumerator enumerator_7025 (var_cas_includedSemanticsComponents, true) ;
  const GGS_stringset::cElement * operand_7025 = NULL ;
  while (((operand_7025 = (GGS_stringset::cElement *) enumerator_7025.nextObject ()))) {
    macroValidPointer (operand_7025) ;
    var_cas_inclusionsForImplementationFile._addAssign_operation ((operand_7025->mKey)._operator_concat (GGS_string (true, ".h"))) ;
  }
  enumerator_7025.reset () ;
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
        ...
        if (((var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (195)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (195)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          ...
          GGS_uint _variant_8241 = var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (200)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (200))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (200)) ;
          GGS_bool _condition_8241 (_variant_8241._isBuilt (), true) ;
          while (_condition_8241.isBuiltAndTrue ()) {
            _condition_8241 = ((var_cas_index)._operator_strictInf (var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (201)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (201))))._operator_and (var_cas_ok) ;
            if (_condition_8241.isBuiltAndTrue ()) {
              if (_variant_8241.uintValue () == 0) {
                _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (204)) ;
                _condition_8241 = GGS_bool (true, false) ;
              }else{
                _variant_8241._decrement_operation (_inLexique COMMA_HERE) ;
                GGS_char var_cas_c ;
