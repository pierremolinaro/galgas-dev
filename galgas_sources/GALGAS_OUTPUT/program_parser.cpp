...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "program_parser.ggs", line
...
pr_galgas_component_program_parser_111_6_ (galgas_scanner & _inLexique,
  ...
  var_cas_inclusionsForImplementationFile._addAssign_operation ((var_cas_nomPRGMprincipal.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (163)))._operator_concat (_inLexique, GGS_string (true, ".h") COMMA_SOURCE_FILE_AT_LINE (163))) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
        if (((var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (183)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (183)))._operator_isEqual (_inLexique, GGS_uint (true, 0U) SOURCE_FILE_AT_LINE (183))).isBuiltAndTrue ()) {
          var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should not be empty") COMMA_SOURCE_FILE_AT_LINE (185)) ;
        }else{
          GGS_uint  var_cas_index ;
          var_cas_index = GGS_uint (true, 0U) ;
          GGS_bool var_cas_ok ;
          var_cas_ok = GGS_bool (true, true) ;
          GGS_uint _variant_7760 = var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (188)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (188))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (188)) ;
          GGS_bool _condition_7760 (_variant_7760._isBuilt (SOURCE_FILE_AT_LINE (193)), true) ;
          while (_condition_7760.isBuiltAndTrue ()) {
            _condition_7760 = ((var_cas_index)._operator_strictInf (_inLexique, var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (189)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (189)) SOURCE_FILE_AT_LINE (189)))._operator_and (_inLexique, var_cas_ok COMMA_SOURCE_FILE_AT_LINE (189)) ;
            if (_condition_7760.isBuiltAndTrue ()) {
              if (_variant_7760.uintValue () == 0) {
                _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (193)) ;
                _condition_7760 = GGS_bool (true, false) ;
              }else{
                _variant_7760._decrement_operation (_inLexique COMMA_HERE) ;
                GGS_char var_cas_c ;
                var_cas_c = var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (190)).reader_characterAtIndex (_inLexique, var_cas_index COMMA_SOURCE_FILE_AT_LINE (190)) ;
                var_cas_ok = (((((var_cas_c)._operator_supOrEqual (_inLexique, GGS_char (true, 'a') SOURCE_FILE_AT_LINE (191)))._operator_and (_inLexique, (var_cas_c)._operator_infOrEqual (_inLexique, GGS_char (true, 'z') SOURCE_FILE_AT_LINE (191)) COMMA_SOURCE_FILE_AT_LINE (191)))._operator_or (_inLexique, ((var_cas_c)._operator_supOrEqual (_inLexique, GGS_char (true, 'A') SOURCE_FILE_AT_LINE (191)))._operator_and (_inLexique, (var_cas_c)._operator_infOrEqual (_inLexique, GGS_char (true, 'Z') SOURCE_FILE_AT_LINE (191)) COMMA_SOURCE_FILE_AT_LINE (191)) COMMA_SOURCE_FILE_AT_LINE (191)))._operator_or (_inLexique, ((var_cas_c)._operator_supOrEqual (_inLexique, GGS_char (true, '0') SOURCE_FILE_AT_LINE (191)))._operator_and (_inLexique, (var_cas_c)._operator_infOrEqual (_inLexique, GGS_char (true, '9') SOURCE_FILE_AT_LINE (191)) COMMA_SOURCE_FILE_AT_LINE (191)) COMMA_SOURCE_FILE_AT_LINE (191)))._operator_or (_inLexique, (var_cas_c)._operator_isEqual (_inLexique, GGS_char (true, '_') SOURCE_FILE_AT_LINE (191)) COMMA_SOURCE_FILE_AT_LINE (191)) ;
                var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (192)) ;
              }
            }
          }
          if (((var_cas_ok)._operator_not (_inLexique COMMA_SOURCE_FILE_AT_LINE (194))).isBuiltAndTrue ()) {
            var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should contains only lower case letters, upper case letters, digits and underscore characters") COMMA_SOURCE_FILE_AT_LINE (196)) ;
          }
        }
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
        var_cas_helpMessage = var_cas_messageString.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (203)) ;
        ...
        if (((var_cas_parameterTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (209)))._operator_isNotEqual (_inLexique, GGS_string (true, "lstring") SOURCE_FILE_AT_LINE (209))).isBuiltAndTrue ()) {
          var_cas_parameterTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only the '@lstring' type is allowed here") COMMA_SOURCE_FILE_AT_LINE (211)) ;
        }
        GGS_lstring  var_cas_argumentName ;
        _inLexique._assignFromAttribute_tokenString (var_cas_argumentName) ;
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
        var_cas_variablesMap.modifier_insertConstInArgument (_inLexique, var_cas_argumentName, GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE), GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_argumentName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (217)), var_cas_argumentName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (217)) COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (214)) ;
  ...
  if (var_cas_nomPRGMprincipal._isBuilt (HERE) &&
      var_cas_versionString._isBuilt (HERE) &&
      var_cas_ruleDescriptorForProgramList._isBuilt (HERE) &&
      var_cas_nombreMaxErreurs._isBuilt (HERE) &&
      var_cas_nombreMaxAlertes._isBuilt (HERE) &&
      var_cas_optionsComponentsMap._isBuilt (HERE) &&
      var_cas_inclusionsForImplementationFile._isBuilt (HERE)) {
    ::routine_generatePRGM (_inLexique,  var_cas_nomPRGMprincipal,  var_cas_versionString,  var_cas_ruleDescriptorForProgramList,  var_cas_nombreMaxErreurs,  var_cas_nombreMaxAlertes,  var_cas_optionsComponentsMap,  var_cas_inclusionsForImplementationFile COMMA_SOURCE_FILE_AT_LINE (247)) ;
  }
