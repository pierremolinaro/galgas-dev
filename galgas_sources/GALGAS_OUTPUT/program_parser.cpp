  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (((var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (183)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (183)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          ...
          GGS_uint _variant_7765 = var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (188)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (188))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (188)) ;
          GGS_bool _condition_7765 (_variant_7765._isBuilt (), true) ;
          while (_condition_7765.isBuiltAndTrue ()) {
            _condition_7765 = ((var_cas_index)._operator_strictInf (var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (189)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (189))))._operator_and (var_cas_ok) ;
            if (_condition_7765.isBuiltAndTrue ()) {
              if (_variant_7765.uintValue () == 0) {
                _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (193)) ;
                _condition_7765 = GGS_bool (true, false) ;
              }else{
                _variant_7765._decrement_operation (_inLexique COMMA_HERE) ;
                GGS_char var_cas_c ;
