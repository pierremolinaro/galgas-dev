...
pr_galgas_component_program_parser_85_6_ (galgas_scanner & _inLexique,
    ...
    while (syntaxRepeat) {
        ...
        switch (select_program_parser_6 (_inLexique)) {
          ...
          case 2 : {
              ...
              case 2 : {
                ...
                { bool syntaxRepeat = true ;
                  while (syntaxRepeat) {
                      ...
                      var_cas_contraintStringsetForMetamodel._addAssign_operation (var_cas_constraintComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (232))) ;
            ...
            if (((var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (238))) != (var_cas_returnedMetamodel.reader_string (_inLexique SOURCE_FILE_AT_LINE (238)))).isBuiltAndTrue ()) {
              var_cas_metamodelName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (var_cas_returnedMetamodel.reader_string (_inLexique SOURCE_FILE_AT_LINE (239))))) + (GGS_string (true, "' metamodel was expected here"))) SOURCE_FILE_AT_LINE (240)) ;
            }
            GGS_entityToImplementMap  automatic_var_0 ;
            GGS_stringset  automatic_var_1 ;
            if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
              var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, automatic_var_0, automatic_var_1 SOURCE_FILE_AT_LINE (241)) ;
            }
            } break ;
          default :
            break ;
          ...
          while (syntaxRepeat) {
            switch (select_repeat_program_parser_9 (_inLexique)) {
              case 2 : {
                ...
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
                if (((var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (249))) == (var_cas_loggedObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (249)))).isBuiltAndTrue ()) {
                ...
                }else if ((var_cas_contraintStringsetForMetamodel.reader_hasKey (_inLexique, var_cas_loggedObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (251)) SOURCE_FILE_AT_LINE (251))).isBuiltAndTrue ()) {
                ...
                }else if ((var_cas_grammarAttributeSet.reader_hasKey (_inLexique, var_cas_loggedObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (253)) SOURCE_FILE_AT_LINE (253))).isBuiltAndTrue ()) {
                  ...
                  var_cas_loggedObjectName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this object cannot be logged") SOURCE_FILE_AT_LINE (257)) ;
                }
                } break ;
              default :
                syntaxRepeat = false ;
  ...
  if (var_cas_nomPRGMprincipal._isBuilt () &&
    ...
    ::routine_generatePRGM (_inLexique,  var_cas_nomPRGMprincipal,  var_cas_versionString,  var_cas_grammarDescriptorForProgramList,  var_cas_nombreMaxErreurs,  var_cas_nombreMaxAlertes SOURCE_FILE_AT_LINE (279)) ;
  }
...
void program_parser::
program_parser::
pr_program_attributes_declaration_program_parser_717_6_ (galgas_scanner & _inLexique,
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_outAttributeSet._addAssign_operation (var_cas_attributeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (730))) ;
...
void program_parser::
pr_program_attributes_declaration_program_parser_717_6_parse (galgas_scanner & _inLexique) {
  switch (select_program_parser_10 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
