...
pr_galgas_component_program_parser_111_4_ (galgas_scanner & _inLexique,
  ...
  GGS_stringset::cEnumerator enumerator_6724 (var_cas_includedSemanticsComponents, true) ;
  const GGS_stringset::cElement * operand_6724 = NULL ;
  while (((operand_6724 = (GGS_stringset::cElement *) enumerator_6724.nextObject ()))) {
    macroValidPointer (operand_6724) ;
    var_cas_inclusionsForImplementationFile._addAssign_operation ((operand_6724->mKey)._operator_concat (GGS_string (true, ".h"))) ;
  }
  enumerator_6724.reset () ;
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
        ...
        if (((var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (186)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (186)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should not be empty") COMMA_SOURCE_FILE_AT_LINE (187)) ;
        }else{
          GGS_uint  var_cas_index ;
          var_cas_index = GGS_uint (true, 0U) ;
          GGS_bool var_cas_ok ;
          var_cas_ok = GGS_bool (true, true) ;
          GGS_uint _variant_7940 = var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (191)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (191))._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (191)) ;
          GGS_bool _condition_7940 (_variant_7940._isBuilt (), true) ;
          while (_condition_7940.isBuiltAndTrue ()) {
            _condition_7940 = ((var_cas_index)._operator_strictInf (var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (192)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (192))))._operator_and (var_cas_ok) ;
            if (_condition_7940.isBuiltAndTrue ()) {
              if (_variant_7940.uintValue () == 0) {
                _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (195)) ;
                _condition_7940 = GGS_bool (true, false) ;
              }else{
                _variant_7940._decrement_operation (_inLexique COMMA_HERE) ;
                GGS_char var_cas_c ;
          ...
          if (((var_cas_ok)._operator_not ()).isBuiltAndTrue ()) {
            var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should contains only lower case letters, upper case letters, digits and underscore characters") COMMA_SOURCE_FILE_AT_LINE (198)) ;
          }
        }
        ...
        if (((var_cas_parameterTypeName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (212)))._operator_isNotEqual (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
          var_cas_parameterTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only the '@lstring' type is allowed here") COMMA_SOURCE_FILE_AT_LINE (213)) ;
        }
  ...
  if (var_cas_nomPRGMprincipal._isBuilt () &&
    ...
    ::routine_generatePRGM (_inLexique,  var_cas_nomPRGMprincipal,  var_cas_versionString,  var_cas_ruleDescriptorForProgramList,  var_cas_nombreMaxErreurs,  var_cas_nombreMaxAlertes,  var_cas_optionsComponentsMap,  var_cas_inclusionsForImplementationFile COMMA_SOURCE_FILE_AT_LINE (249)) ;
  }
