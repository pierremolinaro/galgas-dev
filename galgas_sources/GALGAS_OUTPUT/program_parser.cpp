  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        if (((var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (183)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (183)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          ...
          GGS_bool _condition_7760 (_variant_7760._isBuilt (), true) ;
          while (_condition_7760.isBuiltAndTrue ()) {
            _condition_7760 = ((var_cas_index)._operator_strictInf (var_cas_sourceExtension.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (189)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (189))))._operator_and (var_cas_ok) ;
