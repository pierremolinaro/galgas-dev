...
pr_galgas_component_program_parser_85_24_ (galgas_scanner & _inLexique,
  ...
  if (((var_cas_listeDesAttributs.reader_length ()) < (var_cas_startSymbolSignature.reader_length ())).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (186)) ;
  }else if (((var_cas_listeDesAttributs.reader_length ()) > (var_cas_startSymbolSignature.reader_length ())).isBuiltAndTrue ()) {
      GGS_location (_inLexique).reader_location ().signalGGSSemanticError (_inLexique, GGS_string (true, "too much parameters") SOURCE_FILE_AT_LINE (188)) ;
  }
  ...
  switch (select_program_parser_5 (_inLexique)) {
    ...
    case 2 : {
      ...
      if (((var_cas_metamodelName.reader_value ()) != (var_cas_returnedMetamodel.reader_value ())).isBuiltAndTrue ()) {
          var_cas_metamodelName.reader_location ().signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (var_cas_returnedMetamodel.reader_value ()))) + (GGS_string (true, "' metamodel was expected here"))) SOURCE_FILE_AT_LINE (215)) ;
      }
