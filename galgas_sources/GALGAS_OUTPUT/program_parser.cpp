...
pr_galgas_component_program_parser_118_6_ (galgas_scanner & _inLexique,
  ...
  var_cas_inclusionsForImplementationFile._addAssign_operation (((var_cas_nomPRGMprincipal.reader_string (_inLexique SOURCE_FILE_AT_LINE (170))) + (GGS_string (true, ".h")))) ;
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
        if (((var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (191)).reader_length (_inLexique SOURCE_FILE_AT_LINE (191))) == (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should not be empty") SOURCE_FILE_AT_LINE (193)) ;
        }else{
          GGS_uint  var_cas_index ;
          var_cas_index = GGS_uint (true, 0U) ;
          GGS_bool var_cas_ok ;
          var_cas_ok = GGS_bool (true, true) ;
          GGS_uint _variant_8033 = var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (196)).reader_length (_inLexique SOURCE_FILE_AT_LINE (196))._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (196)) ;
          GGS_bool _condition_8033 (_variant_8033._isBuilt (), true) ;
          while (_condition_8033.isBuiltAndTrue ()) {
            _condition_8033 = (((var_cas_index) < (var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (197)).reader_length (_inLexique SOURCE_FILE_AT_LINE (197)))) & (var_cas_ok)) ;
            if (_condition_8033.isBuiltAndTrue ()) {
              if (_variant_8033.uintValue () == 0) {
                _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (201)) ;
                _condition_8033 = GGS_bool (true, false) ;
              }else{
                _variant_8033._decrement_operation (_inLexique COMMA_HERE) ;
                GGS_char var_cas_c ;
                var_cas_c = var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (198)).reader_characterAtIndex (_inLexique, var_cas_index SOURCE_FILE_AT_LINE (198)) ;
                ...
                var_cas_index._increment_operation (_inLexique SOURCE_FILE_AT_LINE (200)) ;
              }
            }
          }
          if (((! (var_cas_ok))).isBuiltAndTrue ()) {
            var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should contains only lower case letters, upper case letters, digits and underscore characters") SOURCE_FILE_AT_LINE (204)) ;
          }
        }
        switch (select_program_parser_1 (_inLexique)) {
          case 1 : {
            ...
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
            var_cas_helpMessage = var_cas_messageString.reader_string (_inLexique SOURCE_FILE_AT_LINE (212)) ;
            ...
            if (((var_cas_parameterTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (218))) != (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
              var_cas_parameterTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only the '@lstring' type is allowed here") SOURCE_FILE_AT_LINE (220)) ;
            }
            GGS_lstring  var_cas_argumentName ;
            _inLexique._assignFromAttribute_tokenString (var_cas_argumentName) ;
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertConstInArgument (_inLexique, var_cas_argumentName, GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE), GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_argumentName COMMA_HERE) SOURCE_FILE_AT_LINE (223)) ;
          ...
          case 2 : {
            ...
            switch (select_program_parser_2 (_inLexique)) {
              ...
              case 2 : {
                ...
                _inLexique._assignFromAttribute_tokenString (var_cas_messageString) ;
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
                var_cas_helpMessage = var_cas_messageString.reader_string (_inLexique SOURCE_FILE_AT_LINE (262)) ;
                } break ;
              default :
                break ;
            }
            ...
            if (var_cas_componentEntitiesMap._isBuilt ()) {
              var_cas_componentEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_e SOURCE_FILE_AT_LINE (268)) ;
            }
            ...
            { cPtr_C_grammarForSemantics * ptrExtraire_ = dynamic_cast <cPtr_C_grammarForSemantics *> (var_cas_e.getPtr ()) ;
              if (ptrExtraire_ == NULL) {
                ...
                if (var_cas_e.getPtr () != NULL) {
                  ...
                  var_cas_grammarName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (271)) ;
                }
              }else{
            ...
            if (var_cas_grammarAltMap._isBuilt ()) {
              var_cas_grammarAltMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_startSymbolSignature, var_cas_returnedMetamodel SOURCE_FILE_AT_LINE (275)) ;
            }
            ...
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((((((((((((((((((GGS_string (true, "old style construct; now use the following construct:\n")) + (GGS_string (true, "  when . \"")))) + (var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (284))))) + (GGS_string (true, "\" message \"an '.")))) + (var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (284))))) + (GGS_string (true, "' source file\" \?\?@lstring inSourceFile {\n")))) + (GGS_string (true, "    grammar ")))) + (var_cas_grammarName.reader_string (_inLexique SOURCE_FILE_AT_LINE (285))))) + (GGS_string (true, " in inSourceFile;\n")))) + (GGS_string (true, "  }\n"))) SOURCE_FILE_AT_LINE (286)) ;
            if (((var_cas_grammarAttributeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (288))) < (var_cas_startSymbolSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (288)))).isBuiltAndTrue ()) {
              GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (290)) ;
            }else if (((var_cas_grammarAttributeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (290))) > (var_cas_startSymbolSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (290)))).isBuiltAndTrue ()) {
              GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much parameters") SOURCE_FILE_AT_LINE (292)) ;
            }
            ...
            switch (select_program_parser_3 (_inLexique)) {
              ...
              case 2 : {
                  ...
                  case 2 : {
                    ...
                    { bool syntaxRepeat = true ;
                      while (syntaxRepeat) {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
                          var_cas_contraintStringsetForMetamodel._addAssign_operation (var_cas_constraintComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (310))) ;
                ...
                if (((var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (316))) != (var_cas_returnedMetamodel.reader_string (_inLexique SOURCE_FILE_AT_LINE (316)))).isBuiltAndTrue ()) {
                  var_cas_metamodelName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (var_cas_returnedMetamodel.reader_string (_inLexique SOURCE_FILE_AT_LINE (317))))) + (GGS_string (true, "' metamodel was expected here"))) SOURCE_FILE_AT_LINE (318)) ;
                }
                GGS_entityToImplementMap  automatic_var_0 ;
                GGS_stringset  automatic_var_1 ;
                if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
                  var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, automatic_var_0, automatic_var_1 SOURCE_FILE_AT_LINE (319)) ;
                }
                } break ;
              default :
                break ;
  ...
  if (var_cas_nomPRGMprincipal._isBuilt () &&
    ...
    ::routine_generatePRGM (_inLexique,  var_cas_nomPRGMprincipal,  var_cas_versionString,  var_cas_grammarDescriptorForProgramList,  var_cas_ruleDescriptorForProgramList,  var_cas_nombreMaxErreurs,  var_cas_nombreMaxAlertes,  var_cas_optionsComponentsMap,  var_cas_inclusionsForImplementationFile SOURCE_FILE_AT_LINE (338)) ;
  }
...
void program_parser::
program_parser::
pr_program_attributes_declaration_program_parser_705_6_ (galgas_scanner & _inLexique,
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_outAttributeSet._addAssign_operation (var_cas_attributeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (718))) ;
...
void program_parser::
pr_program_attributes_declaration_program_parser_705_6_parse (galgas_scanner & _inLexique) {
  switch (select_program_parser_6 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
