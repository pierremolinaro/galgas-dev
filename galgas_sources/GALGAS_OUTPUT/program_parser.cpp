  ...
  { bool syntaxRepeat_3 = true ;
    while (syntaxRepeat_3) {
        ...
        if (((var_cas_sourceExtension.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (208)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (208))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
          ...
          GGS_uint  var_cas_index = GGS_uint (0U) ;
          GGS_bool var_cas_ok = GGS_bool (true) ;
          GGS_uint _variant_8426 = var_cas_sourceExtension.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (213)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (213)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (213)) ;
          GGS_bool _condition_8426 (_variant_8426.isBuilt (), true) ;
          while (_condition_8426.isBuiltAndTrue ()) {
            _condition_8426 = ((var_cas_index).operator_strictInf (var_cas_sourceExtension.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (214)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (214)))).operator_and (var_cas_ok) ;
            if (_condition_8426.isBuiltAndTrue ()) {
              if (_variant_8426.uintValue () == 0) {
                inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (218)) ;
                _condition_8426 = GGS_bool (false) ;
              }else{
                _variant_8426.decrement_operation (inLexique COMMA_HERE) ;
                GGS_char var_cas_c = var_cas_sourceExtension.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (215)).reader_characterAtIndex (inLexique, var_cas_index COMMA_SOURCE_FILE_AT_LINE (215)) ;
