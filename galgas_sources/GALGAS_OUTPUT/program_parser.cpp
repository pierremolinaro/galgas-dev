...
void program_parser::
program_parser::
pr_galgas_component_program_parser_117_6_ (galgas_scanner & _inLexique,
  ...
  { bool syntaxRepeat = true ;
    while (syntaxRepeat) {
        ...
        _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
        if (((var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (187)).reader_length (_inLexique SOURCE_FILE_AT_LINE (187))) == (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should not be empty") SOURCE_FILE_AT_LINE (189)) ;
        }else{
          GGS_uint  var_cas_index ;
          var_cas_index = GGS_uint (true, 0U) ;
          GGS_bool var_cas_ok ;
          var_cas_ok = GGS_bool (true, true) ;
          GGS_uint _variant_7662 = var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (192)).reader_length (_inLexique SOURCE_FILE_AT_LINE (192))._add_operation (_inLexique, GGS_uint (true, 1U) SOURCE_FILE_AT_LINE (192)) ;
          GGS_bool _condition_7662 (_variant_7662._isBuilt (), true) ;
          while (_condition_7662.isBuiltAndTrue ()) {
            _condition_7662 = (((var_cas_index) < (var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (193)).reader_length (_inLexique SOURCE_FILE_AT_LINE (193)))) & (var_cas_ok)) ;
            if (_condition_7662.isBuiltAndTrue ()) {
              if (_variant_7662.uintValue () == 0) {
                _inLexique.onTheFlyRunTimeError ("loop variant error" SOURCE_FILE_AT_LINE (197)) ;
                _condition_7662 = GGS_bool (true, false) ;
              }else{
                _variant_7662._decrement_operation (_inLexique COMMA_HERE) ;
                GGS_char var_cas_c ;
                var_cas_c = var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (194)).reader_characterAtIndex (_inLexique, var_cas_index SOURCE_FILE_AT_LINE (194)) ;
                ...
                var_cas_index._increment_operation (_inLexique SOURCE_FILE_AT_LINE (196)) ;
              }
            }
          }
          if (((! (var_cas_ok))).isBuiltAndTrue ()) {
            var_cas_sourceExtension.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the source extension should contains only lower case letters, upper case letters, digits and underscore characters") SOURCE_FILE_AT_LINE (200)) ;
          }
        }
        switch (select_program_parser_1 (_inLexique)) {
          case 1 : {
            ...
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
            var_cas_helpMessage = var_cas_messageString.reader_string (_inLexique SOURCE_FILE_AT_LINE (208)) ;
            ...
            if (((var_cas_parameterTypeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (214))) != (GGS_string (true, "lstring"))).isBuiltAndTrue ()) {
              var_cas_parameterTypeName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "only the '@lstring' type is allowed here") SOURCE_FILE_AT_LINE (216)) ;
            }
            GGS_lstring  var_cas_argumentName ;
            _inLexique._assignFromAttribute_tokenString (var_cas_argumentName) ;
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
            var_cas_variablesMap.modifier_insertConstInArgument (_inLexique, var_cas_argumentName, GGS_typeGalgas_lstring::constructor_new (_inLexique COMMA_HERE), GGS_typeAutomaticName::constructor_new (_inLexique, var_cas_argumentName COMMA_HERE) SOURCE_FILE_AT_LINE (219)) ;
          ...
          case 2 : {
            ...
            switch (select_program_parser_2 (_inLexique)) {
              ...
              case 2 : {
                ...
                _inLexique._assignFromAttribute_tokenString (var_cas_messageString) ;
                _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
                var_cas_helpMessage = var_cas_messageString.reader_string (_inLexique SOURCE_FILE_AT_LINE (257)) ;
                } break ;
              default :
                break ;
            }
            ...
            if (var_cas_componentEntitiesMap._isBuilt ()) {
              var_cas_componentEntitiesMap (HERE)->method_searchKey (_inLexique, var_cas_grammarName, var_cas_e SOURCE_FILE_AT_LINE (263)) ;
            }
            ...
            { cPtr_C_grammarForSemantics * ptrExtraire_ = dynamic_cast <cPtr_C_grammarForSemantics *> (var_cas_e.getPtr ()) ;
              if (ptrExtraire_ == NULL) {
                ...
                if (var_cas_e.getPtr () != NULL) {
                  ...
                  var_cas_grammarName.signalExtractError (_inLexique, message1_, message2_ SOURCE_FILE_AT_LINE (266)) ;
                }
              }else{
            ...
            if (var_cas_grammarAltMap._isBuilt ()) {
              var_cas_grammarAltMap (HERE)->method_searchKey (_inLexique, var_cas_altName, var_cas_startSymbolSignature, var_cas_returnedMetamodel SOURCE_FILE_AT_LINE (270)) ;
            }
            ...
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((((((((((((((((((GGS_string (true, "old style construct; now use the following construct:\n")) + (GGS_string (true, "  when . \"")))) + (var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (279))))) + (GGS_string (true, "\" message \"an '.")))) + (var_cas_sourceExtension.reader_string (_inLexique SOURCE_FILE_AT_LINE (279))))) + (GGS_string (true, "' source file\" \?\?@lstring inSourceFile {\n")))) + (GGS_string (true, "    grammar ")))) + (var_cas_grammarName.reader_string (_inLexique SOURCE_FILE_AT_LINE (280))))) + (GGS_string (true, " in inSourceFile;\n")))) + (GGS_string (true, "  }\n"))) SOURCE_FILE_AT_LINE (281)) ;
            if (((var_cas_grammarAttributeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (283))) < (var_cas_startSymbolSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (283)))).isBuiltAndTrue ()) {
              GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "one or more parameters missing") SOURCE_FILE_AT_LINE (285)) ;
            }else if (((var_cas_grammarAttributeList.reader_length (_inLexique SOURCE_FILE_AT_LINE (285))) > (var_cas_startSymbolSignature.reader_length (_inLexique SOURCE_FILE_AT_LINE (285)))).isBuiltAndTrue ()) {
              GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "too much parameters") SOURCE_FILE_AT_LINE (287)) ;
            }
            ...
            switch (select_program_parser_3 (_inLexique)) {
              ...
              case 2 : {
                  ...
                  case 2 : {
                    ...
                    { bool syntaxRepeat = true ;
                      while (syntaxRepeat) {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
                          var_cas_contraintStringsetForMetamodel._addAssign_operation (var_cas_constraintComponentName.reader_string (_inLexique SOURCE_FILE_AT_LINE (305))) ;
                ...
                if (((var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (311))) != (var_cas_returnedMetamodel.reader_string (_inLexique SOURCE_FILE_AT_LINE (311)))).isBuiltAndTrue ()) {
                  var_cas_metamodelName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((((GGS_string (true, "the '")) + (var_cas_returnedMetamodel.reader_string (_inLexique SOURCE_FILE_AT_LINE (312))))) + (GGS_string (true, "' metamodel was expected here"))) SOURCE_FILE_AT_LINE (313)) ;
                }
                GGS_entityToImplementMap  automatic_var_0 ;
                GGS_stringset  automatic_var_1 ;
                if (var_cas_ioMetamodelComponentMap._isBuilt ()) {
                  var_cas_ioMetamodelComponentMap (HERE)->method_searchKey (_inLexique, var_cas_metamodelName, var_cas_rootEntityName, automatic_var_0, automatic_var_1 SOURCE_FILE_AT_LINE (314)) ;
                }
                } break ;
              default :
                break ;
              ...
              while (syntaxRepeat) {
                switch (select_repeat_program_parser_6 (_inLexique)) {
                  case 2 : {
                    ...
                    _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
                    if (((var_cas_metamodelName.reader_string (_inLexique SOURCE_FILE_AT_LINE (322))) == (var_cas_loggedObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (322)))).isBuiltAndTrue ()) {
                    ...
                    }else if ((var_cas_contraintStringsetForMetamodel.reader_hasKey (_inLexique, var_cas_loggedObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (324)) SOURCE_FILE_AT_LINE (324))).isBuiltAndTrue ()) {
                    ...
                    }else if ((var_cas_grammarAttributeSet.reader_hasKey (_inLexique, var_cas_loggedObjectName.reader_string (_inLexique SOURCE_FILE_AT_LINE (326)) SOURCE_FILE_AT_LINE (326))).isBuiltAndTrue ()) {
                      ...
                      var_cas_loggedObjectName.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "this object cannot be logged") SOURCE_FILE_AT_LINE (330)) ;
                    }
                    } break ;
                  default :
                    syntaxRepeat = false ;
            ...
            _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B) COMMA_HERE) ;
            var_cas_grammarDescriptorForProgramList._addAssign_operation (var_cas_postfix, var_cas_grammarName, var_cas_startSymbolSignature, var_cas_grammarAttributeList, var_cas_lexiqueClassName, var_cas_returnedMetamodel, var_cas_rootEntityName, var_cas_sourceExtension, var_cas_helpMessage, var_cas_loggableObjectList) ;
            } break ;
          default :
            break ;
        }
  ...
  GGS_stringlist  var_cas_grammarNameList ;
  var_cas_grammarNameList = GGS_stringlist::constructor_emptyList (_inLexique COMMA_HERE) ;
  GGS_M_grammarComponents::element_type * operand_13369 = var_cas_ioGrammarComponentsMap.firstObject () ;
  while ((operand_13369 != NULL)) {
    macroValidPointer (operand_13369) ;
    var_cas_grammarNameList._addAssign_operation (operand_13369->mKey.reader_string (_inLexique SOURCE_FILE_AT_LINE (353))) ;
    operand_13369 = operand_13369->nextObject () ;
  }
  if (var_cas_nomPRGMprincipal._isBuilt () &&
      ...
      var_cas_grammarNameList._isBuilt () &&
      var_cas_optionsComponentsMap._isBuilt ()) {
    ::routine_generatePRGM (_inLexique,  var_cas_nomPRGMprincipal,  var_cas_versionString,  var_cas_grammarDescriptorForProgramList,  var_cas_ruleDescriptorForProgramList,  var_cas_nombreMaxErreurs,  var_cas_nombreMaxAlertes,  var_cas_grammarNameList,  var_cas_optionsComponentsMap SOURCE_FILE_AT_LINE (356)) ;
  }
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_117_6_importLexique (galgas_scanner & _inLexique,
                                GGS_M_lexiqueComponents  &/* var_cas_ioLexiqueMapForUse */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_117_6_importSyntax (galgas_scanner & _inLexique,
                                GGS_M_syntaxComponents  &/* var_cas_ioSyntaxComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_117_6_importSemantics (galgas_scanner & _inLexique,
                                GGS_M_semanticsComponents  &/* var_cas_ioSemanticsComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_117_6_importGrammarForSemantics (galgas_scanner & _inLexique,
                                GGS_M_grammarComponents  &/* var_cas_ioGrammarComponentsMap */,
                                GGS_M_metamodelsComponents  &/* var_cas_ioMetamodelComponentMap */,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
...
void program_parser::
program_parser::
pr_galgas_component_program_parser_117_6_importOptions (galgas_scanner & _inLexique,
                                GGS_M_optionComponents  &/* var_cas_ioOptionsComponentsMap */) {
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_program) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_literal_5Fstring) COMMA_HERE) ;
...
void program_parser::
program_parser::
pr_program_attributes_declaration_program_parser_744_6_ (galgas_scanner & _inLexique,
    ...
    case 2 : {
      ...
      { bool syntaxRepeat = true ;
        while (syntaxRepeat) {
            ...
            var_cas_outAttributeSet._addAssign_operation (var_cas_attributeName.reader_string (_inLexique SOURCE_FILE_AT_LINE (757))) ;
...
void program_parser::
pr_program_attributes_declaration_program_parser_744_6_parse (galgas_scanner & _inLexique) {
  switch (select_program_parser_7 (_inLexique)) {
    case 1 : {
      } break ;
    case 2 : {
