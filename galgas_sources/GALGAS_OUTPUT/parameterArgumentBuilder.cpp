...
pr_formal_parameter_list_parameterArgumentBuilder_42_6_ (galgas_scanner & _inLexique) {
...
parameterArgumentBuilder::
pr_formal_parameter_parameterArgumentBuilder_51_6_ (galgas_scanner & _inLexique) {
...
parameterArgumentBuilder::
pr_actual_parameter_list_parameterArgumentBuilder_81_6_ (galgas_scanner & _inLexique) {
          ...
          switch (select_parameterArgumentBuilder_4 (_inLexique)) {
            ...
            case 2 : {
              ...
              if (((var_cas_n)._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                var_cas_count.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the count value should be > 0") COMMA_SOURCE_FILE_AT_LINE (95)) ;
              }else{
                GGS_uint _variant_4180 = var_cas_n ;
                GGS_bool _condition_4180 (_variant_4180._isBuilt (), true) ;
                while (_condition_4180.isBuiltAndTrue ()) {
                  _condition_4180 = (var_cas_n)._operator_strictSup (GGS_uint (true, 0U)) ;
                  if (_condition_4180.isBuiltAndTrue ()) {
                    if (_variant_4180.uintValue () == 0) {
                      _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (100)) ;
                      _condition_4180 = GGS_bool (true, false) ;
                    }else{
                      _variant_4180._decrement_operation (_inLexique COMMA_HERE) ;
                      var_cas_mActualParameter._addAssign_operation (GGS_inputJokerActualParameter::constructor_new (_inLexique COMMA_HERE)) ;
