...
pr_formal_parameter_list_parameterArgumentBuilder_48_4_ (galgas_scanner & _inLexique,
...
void parameterArgumentBuilder::
parameterArgumentBuilder::
pr_actual_parameter_list_parameterArgumentBuilder_90_4_ (galgas_scanner & _inLexique,
        ...
        case 2 : {
          ...
          switch (select_parameterArgumentBuilder_4 (_inLexique)) {
            ...
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2A) COMMA_HERE) ;
              GGS_uint  var_cas_n ;
              var_cas_n = var_cas_count.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (102)) ;
              if (((var_cas_n)._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                ...
                GGS_uint _variant_5001 = var_cas_n ;
                GGS_bool _condition_5001 (_variant_5001._isBuilt (), true) ;
                while (_condition_5001.isBuiltAndTrue ()) {
                  _condition_5001 = (var_cas_n)._operator_strictSup (GGS_uint (true, 0U)) ;
                  if (_condition_5001.isBuiltAndTrue ()) {
                    if (_variant_5001.uintValue () == 0) {
                      _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (109)) ;
                      _condition_5001 = GGS_bool (true, false) ;
                    }else{
                      _variant_5001._decrement_operation (_inLexique COMMA_HERE) ;
                      var_cas_outActualParameterList._addAssign_operation (GGS_inputJokerActualParameter ::constructor_new (_inLexique COMMA_HERE)) ;
                      var_cas_n._decrement_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (109)) ;
                    }
                  }
                }
              }
...
void parameterArgumentBuilder::
parameterArgumentBuilder::
pr_formal_input_parameter_list_parameterArgumentBuilder_137_4_ (galgas_scanner & _inLexique,
...
void parameterArgumentBuilder::
parameterArgumentBuilder::
pr_actual_input_parameter_list_parameterArgumentBuilder_165_4_ (galgas_scanner & _inLexique,
