...
pr_formal_parameter_list_parameterArgumentBuilder_44_4_ (galgas_scanner & _inLexique) {
...
parameterArgumentBuilder::
pr_formal_parameter_parameterArgumentBuilder_53_4_ (galgas_scanner & _inLexique) {
...
parameterArgumentBuilder::
pr_actual_parameter_list_parameterArgumentBuilder_83_4_ (galgas_scanner & _inLexique) {
        ...
        case 2 : {
          ...
          switch (select_parameterArgumentBuilder_4 (_inLexique)) {
            ...
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2A) COMMA_HERE) ;
              GGS_uint  var_cas_n ;
              var_cas_n = var_cas_count.reader_uint (_inLexique COMMA_SOURCE_FILE_AT_LINE (94)) ;
              if (((var_cas_n)._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                var_cas_count.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "the count value should be > 0") COMMA_SOURCE_FILE_AT_LINE (96)) ;
              }else{
                GGS_uint _variant_4253 = var_cas_n ;
                GGS_bool _condition_4253 (_variant_4253._isBuilt (), true) ;
                while (_condition_4253.isBuiltAndTrue ()) {
                  _condition_4253 = (var_cas_n)._operator_strictSup (GGS_uint (true, 0U)) ;
                  if (_condition_4253.isBuiltAndTrue ()) {
                    if (_variant_4253.uintValue () == 0) {
                      _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (101)) ;
                      _condition_4253 = GGS_bool (true, false) ;
                    }else{
                      _variant_4253._decrement_operation (_inLexique COMMA_HERE) ;
                      var_cas_mActualParameter._addAssign_operation (GGS_inputJokerActualParameter::constructor_new (_inLexique COMMA_HERE)) ;
                      var_cas_n._decrement_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (101)) ;
                    }
                  }
                }
              }
...
GGS_formalInputParameterList parameterArgumentBuilder::
parameterArgumentBuilder::
pr_formal_input_parameter_list_parameterArgumentBuilder_133_4_ (galgas_scanner & _inLexique) {
  GGS__list_formalInputParameter  var_cas_mFormalInputParameterList ;
  var_cas_mFormalInputParameterList = GGS__list_formalInputParameter::constructor_emptyList (_inLexique COMMA_HERE) ;
  { bool syntaxRepeat_5 = true ;
    while (syntaxRepeat_5) {
        var_cas_mFormalInputParameterList._addAssign_operation (nt_formal_input_parameter_ (_inLexique)) ;
  ...
  GGS_formalInputParameterList _entityInstance = GGS_formalInputParameterList::constructor_new (_inLexique, var_cas_mFormalInputParameterList COMMA_HERE) ;
  return _entityInstance ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//        Implementation of production rule 'formal_input_parameter'         *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_formalInputParameter parameterArgumentBuilder::
parameterArgumentBuilder::
pr_formal_input_parameter_parameterArgumentBuilder_142_4_ (galgas_scanner & _inLexique) {
  GGS_lstring  var_cas_mFormalParameterName ;
  GGS_lstring  var_cas_mFormalParameterTypeName ;
  GGS_bool var_cas_mIsUnused ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3F) COMMA_HERE) ;
  ...
  _inLexique._assignFromAttribute_tokenString (var_cas_mFormalParameterName) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  GGS_formalInputParameter _entityInstance = GGS_formalInputParameter::constructor_new (_inLexique, var_cas_mFormalParameterTypeName, var_cas_mFormalParameterName, var_cas_mIsUnused COMMA_HERE) ;
  return _entityInstance ;
}
