...
//--- Construction from GALGAS constructor
  ...
  public : static inline GGS_variableStateAutomaton  constructor_localConstantDefined (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_variableStateAutomaton (enum_localConstantDefined) ;
  }
  public : static inline GGS_variableStateAutomaton  constructor_localContantUsed (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) {
    return GGS_variableStateAutomaton (enum_localContantUsed) ;
  }
