...
//--- END OF USER ZONE 2
  ...
  public : cPtr_typeMessageInstruction (const GGS_typeExpression &  COMMA_LOCATION_ARGS) ;
  public : GGS_typeExpression  mMessageExpression ;
} ;

//---------------------------------------------------------------------------*

/* class GGG_typeMessageInstruction : public GGG_typeInstruction {
  private : typedef GGG_typeInstruction inherited ;
  public : GGG_typeMessageInstruction (const GGS_typeExpression &  COMMA_LOCATION_ARGS) ;
} ; */
