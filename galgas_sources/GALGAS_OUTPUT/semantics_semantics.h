...
public : void method_insertUsedConstInArgumentGetIndex (C_Lexique & inLexique,
                                ...
                                const GGS_typeCplusPlusName &  inParameter1 COMMA_LOCATION_ARGS) ;
//---
public : void method_insertUsedConstInArgumentNoShadow (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                const GGS_AC_galgasType &  inParameter0,
                                const GGS_typeCplusPlusName &  inParameter1 COMMA_LOCATION_ARGS) ;
public : void method_insertUsedConstInArgumentNoShadowGetIndex (C_Lexique & inLexique,
                                const GGS_lstring & inKey,
                                GGS_luint & outIndex,
                                const GGS_AC_galgasType &  inParameter0,
                                const GGS_typeCplusPlusName &  inParameter1 COMMA_LOCATION_ARGS) ;
...
//--- Copy constructor
  public : GGS_typeReaderCallInstruction (const GGS_typeReaderCallInstruction &) ;
//--- Virtual destructor
  public : virtual ~GGS_typeReaderCallInstruction (void) ;
//--- 'new' constructor
...
//--- Assignment operator
  public : void operator = (const GGS_typeReaderCallInstruction &) ;
//--- Comparison methods
  public : GGS_bool operator == (const GGS_typeReaderCallInstruction & inOperand) const ;
  public : GGS_bool operator != (const GGS_typeReaderCallInstruction & inOperand) const ;
//--- 'description' reader
  public : GGS_string reader_description (C_Lexique & _inLexique
                                          COMMA_LOCATION_ARGS,
