...
class GGS_typeStructuredCastBranchList : public AC_galgas_list {
  public : typedef elementOf_GGS_typeStructuredCastBranchList element_type ;
...
class GGS_EXsortDescriptorList : public AC_galgas_list {
  public : typedef elementOf_GGS_EXsortDescriptorList element_type ;
