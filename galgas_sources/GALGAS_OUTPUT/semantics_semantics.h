...
class GGS_typeEntiteActionExterne {
  #ifndef DO_NOT_GENERATE_MEMORY_CHECK_CODE
    public : static cPtr_typeEntiteActionExterne * constructor_new (const GGS_L_EXsignature & argument_0) ;
  #else
    public : inline static cPtr_typeEntiteActionExterne * constructor_new (const GGS_L_EXsignature & argument_0) {
