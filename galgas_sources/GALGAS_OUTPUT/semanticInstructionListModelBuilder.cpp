...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_1098_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_1145_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_1182_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  const GGS_location  var_cas_instructionLocation = GGS_location (inLexique) ;
  GGS_lstring  var_cas_mTypeName ;
