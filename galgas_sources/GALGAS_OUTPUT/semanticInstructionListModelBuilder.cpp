        ...
        while (syntaxRepeat_4) {
          switch (select_repeat_semanticInstructionListModelBuilder_4 (inLexique)) {
            ...
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2A_) COMMA_HERE) ;
              GGS_uint  var_cas_n = var_cas_count.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (283)) ;
    ...
    while (syntaxRepeat_20) {
      switch (select_repeat_semanticInstructionListModelBuilder_20 (inLexique)) {
        ...
        case 3 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2A_) COMMA_HERE) ;
          GGS_uint  var_cas_n = var_cas_count.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (632)) ;
          if (((var_cas_n).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
          ...
          GGS_uint _variant_23160 = var_cas_n ;
          GGS_bool _condition_23160 (_variant_23160.isBuilt (), true) ;
          while (_condition_23160.isBuiltAndTrue ()) {
            _condition_23160 = (var_cas_n).operator_strictSup (GGS_uint (0U)) ;
            if (_condition_23160.isBuiltAndTrue ()) {
              if (_variant_23160.uintValue () == 0) {
                inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (640)) ;
                _condition_23160 = GGS_bool (false) ;
              }else{
                _variant_23160.decrement_operation (inLexique COMMA_HERE) ;
                var_cas_mElements.addAssign_operation (GGS_foreachInstructionJoker ::constructor_new (inLexique COMMA_HERE)) ;
