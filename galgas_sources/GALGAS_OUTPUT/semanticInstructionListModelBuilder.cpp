...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_196_27_ (galgas_scanner & inLexique,
  ...
  switch (select_semanticInstructionListModelBuilder_1 (inLexique)) {
    case 1 : {
      var_cas_outInstruction = GGS_localVariableDeclaration ::constructor_new (inLexique, var_cas_typeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (200)), var_cas_typeName, var_cas_variableName COMMA_HERE) ;
      } break ;
    case 2 : {
      ...
      var_cas_outInstruction = GGS_localVariableDeclarationWithAssignment ::constructor_new (inLexique, var_cas_typeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (205)), var_cas_typeName, var_cas_variableName, var_cas_sourceExpression COMMA_HERE) ;
      } break ;
    case 3 : {
      ...
      var_cas_outInstruction = GGS_localVariableDeclarationWithInitialization ::constructor_new (inLexique, var_cas_typeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (212)), var_cas_typeName, var_cas_variableName, var_cas_constructorName, var_cas_expressionList COMMA_HERE) ;
...
pr_semantic_instruction_semanticInstructionListModelBuilder_224_27_ (galgas_scanner & inLexique,
  ...
  switch (select_semanticInstructionListModelBuilder_2 (inLexique)) {
    case 1 : {
      ...
      GGS_semanticExpression  var_cas_sourceExpression ;
      nt_expression_ (inLexique, var_cas_sourceExpression) ;
      var_cas_outInstruction = GGS_localConstantDeclarationWithSourceExpression ::constructor_new (inLexique, var_cas_typeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (232)), var_cas_typeName, var_cas_variableName, var_cas_sourceExpression COMMA_HERE) ;
      } break ;
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
      GGS_lstring  var_cas_constructorName ;
      ...
      GGS_outExpressionList  var_cas_expressionList ;
      nt_output_expression_list_ (inLexique, var_cas_expressionList) ;
      var_cas_outInstruction = GGS_localConstantDeclarationWithConstructorCall ::constructor_new (inLexique, var_cas_typeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (239)), var_cas_typeName, var_cas_variableName, var_cas_constructorName, var_cas_expressionList COMMA_HERE) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5D_) COMMA_HERE) ;
      } break ;
    default :
      break ;
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_251_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_assignmentInstruction ::constructor_new (inLexique, var_cas_mTargetVariableName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (258)), var_cas_mTargetVariableName, var_cas_mSourceExpression COMMA_HERE) ;
}
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_270_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_incrementInstruction ::constructor_new (inLexique, var_cas_mReceiverName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (274)), var_cas_mReceiverName COMMA_HERE) ;
}
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_283_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
  GGS_lstring  var_cas_mReceiverName ;
  inLexique.assignFromAttribute_tokenString (var_cas_mReceiverName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_decrementInstruction ::constructor_new (inLexique, var_cas_mReceiverName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (287)), var_cas_mReceiverName COMMA_HERE) ;
}
...
void semanticInstructionListModelBuilder::
pr_foreach_enumerated_object_semanticInstructionListModelBuilder_302_32_ (galgas_scanner & inLexique,
        ...
        while (syntaxRepeat_5) {
          switch (select_repeat_semanticInstructionListModelBuilder_5 (inLexique)) {
            ...
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2A_) COMMA_HERE) ;
              GGS_uint  var_cas_n = var_cas_count.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (338)) ;
              const GGS_bool cond_13977 = (var_cas_n).operator_isEqual (GGS_uint (0U)) ;
              if (cond_13977.isBuiltAndTrue ()) {
                var_cas_count.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this value should be > 0") COMMA_SOURCE_FILE_AT_LINE (341)) ;
              }
              GGS_uint _variant_14101 = var_cas_n ;
              GGS_bool _condition_14101 (_variant_14101.isBuilt (), true) ;
              while (_condition_14101.isBuiltAndTrue ()) {
                _condition_14101 = (var_cas_n).operator_strictSup (GGS_uint (0U)) ;
                if (_condition_14101.isBuiltAndTrue ()) {
                  if (_variant_14101.uintValue () == 0) {
                    inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (346)) ;
                    _condition_14101 = GGS_bool (false) ;
                  }else{
                    _variant_14101.decrement_operation (inLexique COMMA_HERE) ;
                    var_cas_mElementList.addAssign_operation (GGS_foreachInstructionJoker ::constructor_new (inLexique COMMA_HERE)) ;
                    var_cas_n.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (345)) ;
                  }
                }
              }
              } break ;
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_374_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_442_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_460_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_497_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  const GGS_location  var_cas_instructionLocation = GGS_location (inLexique) ;
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_521_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  const GGS_location  var_cas_instructionLocation = GGS_location (inLexique) ;
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_553_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_588_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_610_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
  GGS_lstring  var_cas_mRoutineName ;
  inLexique.assignFromAttribute_tokenString (var_cas_mRoutineName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  ...
  nt_actual_parameter_list_ (inLexique, var_cas_mActualParameterList) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_routineCallInstruction ::constructor_new (inLexique, var_cas_mRoutineName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (616)), var_cas_mRoutineName, var_cas_mActualParameterList COMMA_HERE) ;
}
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_628_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
...
void semanticInstructionListModelBuilder::
pr_match_entry_semanticInstructionListModelBuilder_686_18_ (galgas_scanner & inLexique,
...
void semanticInstructionListModelBuilder::
pr_match_entry_semanticInstructionListModelBuilder_693_18_ (galgas_scanner & inLexique,
                                GGS_matchEntryList  &var_cas_ioMatchEntryList) {
    ...
    while (syntaxRepeat_21) {
      switch (select_repeat_semanticInstructionListModelBuilder_21 (inLexique)) {
        ...
        case 3 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_unsigned_5F_literal_5F_integer) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__2A_) COMMA_HERE) ;
          GGS_uint  var_cas_n = var_cas_count.reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (705)) ;
          const GGS_bool cond_25948 = (var_cas_n).operator_isEqual (GGS_uint (0U)) ;
          if (cond_25948.isBuiltAndTrue ()) {
            var_cas_count.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("this value should be > 0") COMMA_SOURCE_FILE_AT_LINE (708)) ;
          }
          GGS_uint _variant_26059 = var_cas_n ;
          GGS_bool _condition_26059 (_variant_26059.isBuilt (), true) ;
          while (_condition_26059.isBuiltAndTrue ()) {
            _condition_26059 = (var_cas_n).operator_strictSup (GGS_uint (0U)) ;
            if (_condition_26059.isBuiltAndTrue ()) {
              if (_variant_26059.uintValue () == 0) {
                inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (713)) ;
                _condition_26059 = GGS_bool (false) ;
              }else{
                _variant_26059.decrement_operation (inLexique COMMA_HERE) ;
                var_cas_mElements.addAssign_operation (GGS_foreachInstructionJoker ::constructor_new (inLexique COMMA_HERE)) ;
                var_cas_n.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (712)) ;
              }
            }
          }
          } break ;
...
void semanticInstructionListModelBuilder::
pr_match_instruction_branch_semanticInstructionListModelBuilder_743_31_ (galgas_scanner & inLexique,
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_762_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
...
void semanticInstructionListModelBuilder::
pr_cast_instruction_branch_semanticInstructionListModelBuilder_810_30_ (galgas_scanner & inLexique,
...
void semanticInstructionListModelBuilder::
pr_cast_else_or_default_semanticInstructionListModelBuilder_852_27_ (galgas_scanner & inLexique,
...
void semanticInstructionListModelBuilder::
pr_cast_else_or_default_semanticInstructionListModelBuilder_862_27_ (galgas_scanner & inLexique,
                                GGS_elseOrDefaultForCastInstruction  &var_cas_outElseOrDefault) {
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_872_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_902_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
  GGS_lstring  var_cas_mReceiverName ;
  inLexique.assignFromAttribute_tokenString (var_cas_mReceiverName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_931_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
  GGS_lstring  var_cas_mReceiverName ;
  inLexique.assignFromAttribute_tokenString (var_cas_mReceiverName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_961_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
  GGS_lstring  var_cas_mTargetVariableName ;
  inLexique.assignFromAttribute_tokenString (var_cas_mTargetVariableName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1_identifier) COMMA_HERE) ;
  ...
  nt_expression_ (inLexique, var_cas_mSourceExpression) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_appendInstruction ::constructor_new (inLexique, var_cas_mTargetVariableName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (975)), var_cas_mTargetVariableName, var_cas_mStructAttributeList, var_cas_mSourceExpression COMMA_HERE) ;
}
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_1020_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_1038_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_1062_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_1109_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
...
void semanticInstructionListModelBuilder::
pr_semantic_instruction_semanticInstructionListModelBuilder_1146_27_ (galgas_scanner & inLexique,
                                GGS_semanticInstruction  &var_cas_outInstruction) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__5B_) COMMA_HERE) ;
  const GGS_location  var_cas_instructionLocation = GGS_location (inLexique) ;
  GGS_lstring  var_cas_mTypeName ;
