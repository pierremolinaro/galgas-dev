...
pr_semantic_instruction_semanticInstructionListModelBuilder_972_27_ (galgas_scanner & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (galgas_scanner::galgas_scanner_1__3B_) COMMA_HERE) ;
  var_cas_outInstruction = GGS_grammarInstruction ::constructor_new (inLexique, var_cas_mGrammarComponentName, var_cas_mLabelName, var_cas_mSourceExpression, var_cas_sourceExpressionIsFile, var_cas_mActualParameterList COMMA_HERE) ;
}
