...
//--- Non terminal declarations
  protected : virtual void nt_program_5F_component_5F_start_5F_symbol_ (GALGAS_programComponentAST & outArgument0,
                                                                        C_Lexique_galgas_5F_scanner * inLexique) = 0 ;

  protected : virtual void nt_program_5F_component_5F_start_5F_symbol_parse (C_Lexique_galgas_5F_scanner * inLexique) = 0 ;

  protected : virtual void nt_program_5F_component_5F_start_5F_symbol_indexing (C_Lexique_galgas_5F_scanner * inLexique) = 0 ;
...
//--- Rule declarations
  ...
  protected : void rule_programModelBuilder_program_5F_component_5F_start_5F_symbol_i0_parse (C_Lexique_galgas_5F_scanner * inLexique) ;
