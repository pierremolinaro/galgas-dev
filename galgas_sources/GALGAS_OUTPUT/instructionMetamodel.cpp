...
cPtr_localConstantDeclarationWithSourceExpression (const GGS_lstring & argument_0,
                                const GGS_lstring & argument_1,
                                const GGS_semanticExpression & argument_2
                                COMMA_LOCATION_ARGS)
:cPtr_semanticInstruction (THERE),
...
cPtr__AC_galgas_class * cPtr_localConstantDeclarationWithSourceExpression::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_localConstantDeclarationWithSourceExpression (mTypeName, mVariableName, mSourceExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr_localConstantDeclarationWithConstructorCall (const GGS_lstring & argument_0,
                                const GGS_lstring & argument_1,
                                const GGS_lstring & argument_2,
                                const GGS_outExpressionList & argument_3
                                COMMA_LOCATION_ARGS)
...
cPtr__AC_galgas_class * cPtr_localConstantDeclarationWithConstructorCall::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_localConstantDeclarationWithConstructorCall (mTypeName, mVariableName, mConstructorName, mConstructorArguments COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_grammarInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_grammarInstruction (mGrammarComponentName, mLabelName, mSourceExpression, mSourceExpressionIsFile, mActualParameterList COMMA_HERE)) ;
  return result ;
}
