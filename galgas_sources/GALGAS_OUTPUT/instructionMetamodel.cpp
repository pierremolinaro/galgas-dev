...
cPtr_sendInstruction (const GGS_semanticExpression & argument_0
                                COMMA_LOCATION_ARGS)
:cPtr_semanticInstruction (THERE),
...
cPtr__AC_galgas_class * cPtr_sendInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_sendInstruction (mSourceExpression COMMA_HERE)) ;
  return result ;
}
...
GGS_sendInstruction::
GGS_sendInstruction (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
constructor_new (C_Compiler & /* inLexique */,
                 const GGS_semanticExpression & argument_0
                                COMMA_LOCATION_ARGS) {
  GGS_sendInstruction result ;
  macroMyNew (result.mPointer, cPtr_sendInstruction (argument_0 COMMA_THERE)) ;
  return result ;
}
...
/* const */ GGS_bool & GGS_foreachInstructionEnumeratedObjectList::cEnumerator::_mIsAscending (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mIsAscending ;
}
