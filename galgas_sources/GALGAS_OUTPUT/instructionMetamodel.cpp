...
GGS_semanticInstructionList::cElement * GGS_semanticInstructionList::
...
GGS_semanticDeclarationList::cElement * GGS_semanticDeclarationList::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
const GGS_semanticDeclaration  * GGS_semanticDeclarationList::cEnumerator::_mSemanticDeclaration (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mSemanticDeclaration) ;
}
...
GGS_foreachInstructionEnumeratedObjectElementList::cElement * GGS_foreachInstructionEnumeratedObjectElementList::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
const GGS_foreachInstructionEnumeratedObjectElement  * GGS_foreachInstructionEnumeratedObjectElementList::cEnumerator::_mElement (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mElement) ;
}
...
GGS_foreachInstructionEnumeratedObjectList::cElement * GGS_foreachInstructionEnumeratedObjectList::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
const GGS_semanticExpression  * GGS_foreachInstructionEnumeratedObjectList::cEnumerator::_mEnumeratedExpression (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mEnumeratedExpression) ;
}
...
const GGS_foreachInstructionEnumeratedObjectElementList  * GGS_foreachInstructionEnumeratedObjectList::cEnumerator::_mElementList (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mElementList) ;
}
...
const GGS_bool * GGS_foreachInstructionEnumeratedObjectList::cEnumerator::_mEndsWithEllipsis (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mEndsWithEllipsis) ;
}
...
GGS_ifBranchList::cElement * GGS_ifBranchList::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
const GGS_semanticExpression  * GGS_ifBranchList::cEnumerator::_mIFexpression (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mIFexpression) ;
}
...
const GGS_semanticInstructionList  * GGS_ifBranchList::cEnumerator::_mIFinstructionList (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mIFinstructionList) ;
}
...
GGS_matchEntryList::cElement * GGS_matchEntryList::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
const GGS_matchEntry  * GGS_matchEntryList::cEnumerator::_mEntry (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mEntry) ;
}
...
GGS_matchInstructionBranchList::cElement * GGS_matchInstructionBranchList::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
const GGS_matchEntryList  * GGS_matchInstructionBranchList::cEnumerator::_mMatchEntryList (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mMatchEntryList) ;
}
...
const GGS_semanticInstructionList  * GGS_matchInstructionBranchList::cEnumerator::_mMatchBranchInstructionList (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mMatchBranchInstructionList) ;
}
...
GGS_castInstructionBranchList::cElement * GGS_castInstructionBranchList::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
const GGS_bool * GGS_castInstructionBranchList::cEnumerator::_mUseKindOfClass (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mUseKindOfClass) ;
}
...
const GGS_lstring  * GGS_castInstructionBranchList::cEnumerator::_mConstantVarName (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mConstantVarName) ;
}
...
const GGS_bool * GGS_castInstructionBranchList::cEnumerator::_mConstantVarNameIsUnused (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mConstantVarNameIsUnused) ;
}
...
const GGS_semanticInstructionList  * GGS_castInstructionBranchList::cEnumerator::_mCastBranchInstructionList (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mCastBranchInstructionList) ;
}
...
GGS_abstractCategoryMethodList::cElement * GGS_abstractCategoryMethodList::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
      ...
      * this = inOperand ;
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          ...
          GGS_formalParameterList  p_1 = p->mFormalParameterList ;
          _internalAppendValues (p_0, p_1 COMMA_HERE) ;
          p = p->nextObject () ;
        }
      }
...
internalSubListWithRange (GGS_abstractCategoryMethodList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mMethodName, _p->mFormalParameterList) ;
      _p = _p->nextObject () ;
    }
  }
}
...
const GGS_lstring  * GGS_abstractCategoryMethodList::cEnumerator::_mMethodName (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
...
const GGS_formalParameterList  * GGS_abstractCategoryMethodList::cEnumerator::_mFormalParameterList (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                list map '@abstractCategoryMethodListMap'                  *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_abstractCategoryMethodListMap::cElement::cElement (const GGS_string & inKey) :
cNode (inKey),
object (GGS_abstractCategoryMethodList::constructor_emptyList ()) {
}

//---------------------------------------------------------------------------*

GGS_string GGS_abstractCategoryMethodListMap::cElement::
...
GGS_abstractCategoryMethodListMap::cNode * GGS_abstractCategoryMethodListMap::_allocNewNode (const GGS_string & inKey) {
  cNode * result = NULL ;
...
GGS_abstractCategoryMethodListMap::cNode * GGS_abstractCategoryMethodListMap::cElement::_nodeClone (void) {
...
GGS_string GGS_abstractCategoryMethodListMap::
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@abstractCategoryMethodListMap", inIndentation COMMA_THERE) ;
}
...
_addAssign_operation (const GGS_string & inKey,
  ...
  if (_isBuilt () && inKey._isBuilt () && inAttribute0._isBuilt () && inAttribute1._isBuilt ()) {
    ...
    node->object._addAssign_operation (inAttribute0, inAttribute1) ;
  }
}
...
GGS_categoryMethodList::cElement * GGS_categoryMethodList::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
internalSubListWithRange (GGS_categoryMethodList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (_p) ;
      ioList._addAssign_operation (_p->mMethodName, _p->mFormalParameterList, _p->mRoutineInstructionList) ;
      _p = _p->nextObject () ;
    }
  }
}
...
const GGS_lstring  * GGS_categoryMethodList::cEnumerator::_mMethodName (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mMethodName) ;
}
...
const GGS_formalParameterList  * GGS_categoryMethodList::cEnumerator::_mFormalParameterList (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mFormalParameterList) ;
}
...
const GGS_semanticInstructionList  * GGS_categoryMethodList::cEnumerator::_mRoutineInstructionList (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mRoutineInstructionList) ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//                    list map '@categoryMethodListMap'                      *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_categoryMethodListMap::cElement::cElement (const GGS_string & inKey) :
cNode (inKey),
object (GGS_categoryMethodList::constructor_emptyList ()) {
}

//---------------------------------------------------------------------------*

GGS_string GGS_categoryMethodListMap::cElement::
_description (C_Compiler & _inLexique,
              const sint32 inIndentation
              COMMA_LOCATION_ARGS) const {
  return object.reader_description (_inLexique COMMA_THERE, inIndentation) ;
...
GGS_categoryMethodListMap::cNode * GGS_categoryMethodListMap::_allocNewNode (const GGS_string & inKey) {
  cNode * result = NULL ;
  macroMyNew (result, cElement (inKey)) ;
  return result ;
}
...
GGS_categoryMethodListMap::cNode * GGS_categoryMethodListMap::cElement::_nodeClone (void) {
  cElement * result = NULL ;
  macroMyNew (result, cElement (key)) ;
  result->object = object ;
  return result ;
...
GGS_string GGS_categoryMethodListMap::
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@categoryMethodListMap", inIndentation COMMA_THERE) ;
}
...
_addAssign_operation (const GGS_string & inKey,
  ...
  if (_isBuilt () && inKey._isBuilt () && inAttribute0._isBuilt () && inAttribute1._isBuilt () && inAttribute2._isBuilt ()) {
    ...
    bool extension ; // unused
    cElement * node = (cElement *) internalSearchOrAdd (inKey, mSharedMapObject->_mRoot, extension) ;
    node->object._addAssign_operation (inAttribute0, inAttribute1, inAttribute2) ;
  }
}
...
GGS_overridingCategoryMethodList::cElement * GGS_overridingCategoryMethodList::
operator () (const sint32 inIndex COMMA_LOCATION_ARGS) const {
  MF_AssertThere (inIndex >= 0, "inIndex (%ld) < 0", inIndex, 0) ;
  MF_AssertThere (inIndex < count (), "inIndex (%ld) >= mCount (%ld)", inIndex, count ()) ;
  return (cElement *) objectAtIndexOrNULL (inIndex) ;
...
const GGS_lstring  * GGS_overridingCategoryMethodList::cEnumerator::_mMethodName (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mMethodName) ;
}
...
const GGS_formalParameterList  * GGS_overridingCategoryMethodList::cEnumerator::_mFormalParameterList (LOCATION_ARGS) const {
  macroValidPointerThere (mNextEnumeratedObject) ;
  return & (((cElement *) mNextEnumeratedObject)->mFormalParameterList) ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//               list map '@overridingCategoryMethodListMap'                 *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_overridingCategoryMethodListMap::cElement::cElement (const GGS_string & inKey) :
cNode (inKey),
object (GGS_overridingCategoryMethodList::constructor_emptyList ()) {
}

//---------------------------------------------------------------------------*

GGS_string GGS_overridingCategoryMethodListMap::cElement::
_description (C_Compiler & _inLexique,
              const sint32 inIndentation
              COMMA_LOCATION_ARGS) const {
  return object.reader_description (_inLexique COMMA_THERE, inIndentation) ;
...
GGS_overridingCategoryMethodListMap::cNode * GGS_overridingCategoryMethodListMap::_allocNewNode (const GGS_string & inKey) {
  cNode * result = NULL ;
  macroMyNew (result, cElement (inKey)) ;
  return result ;
}
...
GGS_overridingCategoryMethodListMap::cNode * GGS_overridingCategoryMethodListMap::cElement::_nodeClone (void) {
  cElement * result = NULL ;
  macroMyNew (result, cElement (key)) ;
  result->object = object ;
  return result ;
...
GGS_string GGS_overridingCategoryMethodListMap::
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@overridingCategoryMethodListMap", inIndentation COMMA_THERE) ;
}
