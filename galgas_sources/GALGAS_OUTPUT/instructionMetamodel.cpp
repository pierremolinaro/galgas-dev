...
mElements (argument_1),
mEndsWithEllipsis (argument_2),
mExtractBranchInstructionList (argument_3) {
}
...
_cloneObject (void) const {
  ...
  macroMyNew (_p, cPtr_extractInstructionBranch (mExtractBranchTypeName, mElements, mEndsWithEllipsis, mExtractBranchInstructionList COMMA_HERE)) ;
  return _p ;
}
    ...
    if (count () == 0) {
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          ...
          GGS_foreachInstructionEnumeratedObjectElementList  p_1 = p->mElements ;
          GGS_bool p_2 = p->mEndsWithEllipsis ;
          GGS_semanticInstructions  p_3 = p->mExtractBranchInstructionList ;
          result._internalAppendValues (p_0, p_1, p_2, p_3) ;
          p = p->nextObject () ;
        }
      }
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    ...
    _out_1 = _p->mElements ;
    _out_2 = _p->mEndsWithEllipsis ;
    _out_3 = _p->mExtractBranchInstructionList ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
...
GGS_foreachInstructionEnumeratedObjectElementList  GGS_extractInstructionBranch::
reader_mElements (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_foreachInstructionEnumeratedObjectElementList   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_extractInstructionBranch *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_extractInstructionBranch *) mPointer)->mElements ;
  }
  return result ;
}
...
GGS_bool GGS_extractInstructionBranch::
reader_mEndsWithEllipsis (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_bool  result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_extractInstructionBranch *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_extractInstructionBranch *) mPointer)->mEndsWithEllipsis ;
  }
  return result ;
}
