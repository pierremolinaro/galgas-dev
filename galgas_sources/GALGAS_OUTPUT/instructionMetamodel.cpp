...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    _out_0 = _p->mTypeName ;
    _out_1 = _p->mVariableName ;
    _out_2 = _p->mConstructorName ;
    _out_3 = _p->mConstructorArguments ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
...
_cloneObject (void) const {
  ...
  macroMyNew (_p, cPtr_foreachInstructionEnumeratedObject (mEnumeratedExpression, mElement COMMA_HERE)) ;
  return _p ;
}
...
void GGS_elseForCastInstructionList::
_addAssign_operation (const GGS_semanticInstructions & argument_0) {
  if (_isBuilt ()) {
    _insulateList () ;
    _internalAppendValues (argument_0) ;
  }
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    _out_0 = _p->mElseInstructionList ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    _out_0 = _p->mErrorLocationExpression ;
  }else{
    _out_0._drop_operation () ;
  }
}
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    ...
    _out_1 = _p->mCastInstructionBranchList ;
    _out_2 = _p->mElseOrDefault ;
  }else{
    _out_0._drop_operation () ;
    _out_1._drop_operation () ;
    _out_2._drop_operation () ;
