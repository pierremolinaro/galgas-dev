...
GGS_semanticInstructionList::GGS_semanticInstructionList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_semanticDeclarationList::GGS_semanticDeclarationList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_foreachInstructionEnumeratedObjectElementList::GGS_foreachInstructionEnumeratedObjectElementList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_foreachInstructionEnumeratedObjectList::GGS_foreachInstructionEnumeratedObjectList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_ifBranchList::GGS_ifBranchList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_matchEntryList::GGS_matchEntryList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_matchInstructionBranchList::GGS_matchInstructionBranchList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_castInstructionBranchList::GGS_castInstructionBranchList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
GGS_abstractCategoryMethodList::GGS_abstractCategoryMethodList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
//---------------------------------------------------------------------------*
//                                                                           *
//                  list map '@abstractCategoryMethodMap'                    *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_abstractCategoryMethodMap GGS_abstractCategoryMethodMap::
...
GGS_string GGS_abstractCategoryMethodMap::
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@abstractCategoryMethodMap", "@abstractCategoryMethodList", inIndentation COMMA_THERE) ;
}

//---------------------------------------------------------------------------*

void GGS_abstractCategoryMethodMap::
_addAssign_operation (const GGS_string & inKey,
  ...
  if (_isBuilt () && inKey._isBuilt () && inAttribute0._isBuilt () && inAttribute1._isBuilt ()) {
    ...
    if (node->mListRoot == NULL) {
      macroMyNew (node->mListRoot, GGS_abstractCategoryMethodList (true)) ;
    }
    GGS_abstractCategoryMethodList * listPtr = (GGS_abstractCategoryMethodList *) node->mListRoot ;
...
//--- Reader 'listForKey'
GGS_abstractCategoryMethodList GGS_abstractCategoryMethodMap::
reader_listForKey (C_Compiler & inLexique,
  ...
  if (_isBuilt () && inKey._isBuilt ()) {
    ...
    if (node == NULL) {
      result = GGS_abstractCategoryMethodList::constructor_emptyList (inLexique COMMA_THERE) ;
    }else{
      result = * ((GGS_abstractCategoryMethodList *) node->mListRoot) ;
    }
  }
  return result ;
}
...
GGS_categoryMethodList::GGS_categoryMethodList (const bool inBuildObject) :
AC_galgas_list () {
  if (inBuildObject) {
    _alloc () ;
  }
...
//---------------------------------------------------------------------------*
//                                                                           *
//                      list map '@categoryMethodMap'                        *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_categoryMethodMap GGS_categoryMethodMap::
constructor_emptyMap (C_Compiler & /* inLexique */
                  COMMA_UNUSED_LOCATION_ARGS) {
  GGS_categoryMethodMap result ;
  macroMyNew (result.mSharedMapObject, cRoot) ;
  return result ;
}
...
GGS_string GGS_categoryMethodMap::
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@categoryMethodMap", "@categoryMethodList", inIndentation COMMA_THERE) ;
}

//---------------------------------------------------------------------------*

void GGS_categoryMethodMap::
_addAssign_operation (const GGS_string & inKey,
                      const GGS_lstring & inAttribute0,
                      const GGS_formalParameterList & inAttribute1,
  ...
  if (_isBuilt () && inKey._isBuilt () && inAttribute0._isBuilt () && inAttribute1._isBuilt () && inAttribute2._isBuilt ()) {
    ...
    cElement * node = internalSearchOrAdd (inKey, mSharedMapObject->_mRoot, extension) ;
    if (node->mListRoot == NULL) {
      macroMyNew (node->mListRoot, GGS_categoryMethodList (true)) ;
    }
    GGS_categoryMethodList * listPtr = (GGS_categoryMethodList *) node->mListRoot ;
...
//--- Reader 'listForKey'
GGS_categoryMethodList GGS_categoryMethodMap::
reader_listForKey (C_Compiler & inLexique,
                   const GGS_string & inKey
                   COMMA_LOCATION_ARGS) const {
  GGS_categoryMethodList result ;
  if (_isBuilt () && inKey._isBuilt ()) {
    cElement * node = nodeForKey (inKey.string ()) ; 
    if (node == NULL) {
      result = GGS_categoryMethodList::constructor_emptyList (inLexique COMMA_THERE) ;
    }else{
      result = * ((GGS_categoryMethodList *) node->mListRoot) ;
    }
  }
  return result ;
}
...
void GGS_semanticDeclarationStruct::_drop_operation (void) {
  ...
  mAbstractCategoryMethodMap._drop_operation () ;
}
...
bool GGS_semanticDeclarationStruct::_isBuilt (void) const {
  return mSemanticDeclarationList._isBuilt ()
    && mAbstractCategoryMethodMap._isBuilt () ;
}
...
_operator_isEqual (const GGS_semanticDeclarationStruct & inOperand) const {
  return mSemanticDeclarationList._operator_isEqual (inOperand.mSemanticDeclarationList)
    ._operator_and (mAbstractCategoryMethodMap._operator_isEqual (inOperand.mAbstractCategoryMethodMap)) ;
}
...
_operator_isNotEqual (const GGS_semanticDeclarationStruct & inOperand) const {
  return mSemanticDeclarationList._operator_isNotEqual (inOperand.mSemanticDeclarationList)
    ._operator_or (mAbstractCategoryMethodMap._operator_isNotEqual (inOperand.mAbstractCategoryMethodMap)) ;
}
...
constructor_new (C_Compiler & /* inLexique */,
  ...
  result.mAbstractCategoryMethodMap = argument_1 ;
  return result ;
}
...
reader_description (C_Compiler & _inLexique
  ...
  if (_isBuilt ()) {
    ...
    _s << "\n" ;
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mAbstractCategoryMethodMap " ;
    _s << mAbstractCategoryMethodMap.reader_description (_inLexique COMMA_THERE, inIndentation + 1) ;
  }else{
    _s << "not built" ;
  }
  _s << "\n" ;
