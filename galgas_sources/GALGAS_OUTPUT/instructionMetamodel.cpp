...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mTargetVariableName.operator_isEqual (ptr->mTargetVariableName).boolValue ()
         && mSourceExpression.operator_isEqual (ptr->mSourceExpression).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mEnumeratedExpression.operator_isEqual (ptr->mEnumeratedExpression).boolValue ()
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mEnumeratedObjectList.operator_isEqual (ptr->mEnumeratedObjectList).boolValue ()
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mReceiverName.operator_isEqual (ptr->mReceiverName).boolValue ()
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mMatchedVariableNameList.operator_isEqual (ptr->mMatchedVariableNameList).boolValue ()
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mLoggedVariableList.operator_isEqual (ptr->mLoggedVariableList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mGrammarComponentName.operator_isEqual (ptr->mGrammarComponentName).boolValue ()
         ...
         && mActualParameterList.operator_isEqual (ptr->mActualParameterList).boolValue ()
         && mReturnedModelName.operator_isEqual (ptr->mReturnedModelName).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mPrefix.operator_isEqual (ptr->mPrefix).boolValue ()
...
/* const */ GGS_lstring  & GGS_abstractCategoryReaderList::cEnumerator::_mAbstractCategoryReaderName (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mAbstractCategoryReaderName ;
}
...
/* const */ GGS_formalInputParameterList  & GGS_abstractCategoryReaderList::cEnumerator::_mAbstractCategoryFormalInputParameterList (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mAbstractCategoryFormalInputParameterList ;
}
...
/* const */ GGS_lstring  & GGS_abstractCategoryReaderList::cEnumerator::_mReturnedTypeName (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mReturnedTypeName ;
}
...
/* const */ GGS_lstring  & GGS_categoryReaderList::cEnumerator::_mCategoryReaderName (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mCategoryReaderName ;
}
...
/* const */ GGS_formalInputParameterList  & GGS_categoryReaderList::cEnumerator::_mReaderCategoryFormalInputParameterList (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mReaderCategoryFormalInputParameterList ;
}
...
/* const */ GGS_lstring  & GGS_categoryReaderList::cEnumerator::_mReturnedVariableName (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mReturnedVariableName ;
}
...
_addAssign_operation (const GGS_string & inKey,
  ...
  if (isBuilt () && inKey.isBuilt () && inAttribute0.isBuilt () && inAttribute1.isBuilt () && inAttribute2.isBuilt () && inAttribute3.isBuilt () && inAttribute4.isBuilt ()) {
    ...
    GGS_categoryReaderList & listPtr = macroPtr (nodePtr->mObject, cElement)->mListObject ;
    listPtr._addAssign_operation (inAttribute0, inAttribute1, inAttribute2, inAttribute3, inAttribute4) ;
  }
}
...
/* const */ GGS_lstring  & GGS_overridingCategoryReaderList::cEnumerator::_mOverridingCategoryReaderName (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mOverridingCategoryReaderName ;
}
...
/* const */ GGS_formalInputParameterList  & GGS_overridingCategoryReaderList::cEnumerator::_mOverridingReaderFormalInputParameterList (LOCATION_ARGS) const {
  macroValidPointerThere (mCurrentEnumeratedObject) ;
  return ((cElement *) mCurrentEnumeratedObject)->mOverridingReaderFormalInputParameterList ;
}
