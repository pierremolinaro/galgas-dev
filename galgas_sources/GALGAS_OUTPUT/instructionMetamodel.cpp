...
void GGS_semanticDeclarationStruct::_drop_operation (void) {
  mSemanticDeclarationList._drop_operation () ;
  mAbstractCategoryMethodListMap._drop_operation () ;
  mCategoryMethodListMap._drop_operation () ;
  mOverridingCategoryMethodListMap._drop_operation () ;
}
