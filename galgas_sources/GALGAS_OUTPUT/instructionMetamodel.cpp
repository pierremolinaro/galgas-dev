...
GGS_abstractCategoryMethodMap::cElement::cElement (const GGS_string & inKey) :
cNode (inKey),
...
GGS_string GGS_abstractCategoryMethodMap::cElement::
...
GGS_abstractCategoryMethodMap::cNode * GGS_abstractCategoryMethodMap::_allocNewNode (const GGS_string & inKey) {
  cNode * result = NULL ;
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@abstractCategoryMethodMap", inIndentation COMMA_THERE) ;
}
...
GGS_categoryMethodMap::cElement::cElement (const GGS_string & inKey) :
cNode (inKey),
...
GGS_string GGS_categoryMethodMap::cElement::
_description (C_Compiler & _inLexique,
              const sint32 inIndentation
              COMMA_LOCATION_ARGS) const {
  return object.reader_description (_inLexique COMMA_THERE, inIndentation) ;
...
GGS_categoryMethodMap::cNode * GGS_categoryMethodMap::_allocNewNode (const GGS_string & inKey) {
  cNode * result = NULL ;
  macroMyNew (result, cElement (inKey)) ;
  return result ;
}
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (inLexique, "@categoryMethodMap", inIndentation COMMA_THERE) ;
}
