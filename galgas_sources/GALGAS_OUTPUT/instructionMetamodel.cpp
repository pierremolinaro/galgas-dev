  ...
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          macroValidPointer (p) ;
          GGS__list_semanticInstruction  p_0 = p->mInstruction ;
    ...
    if (count () == 0) {
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          ...
          GGS__list_foreachInstructionEnumeratedObjectElement  p_1 = p->mElements ;
  ...
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          macroValidPointer (p) ;
          GGS__list_foreachInstructionEnumeratedObject  p_0 = p->mEnumeratedObjects ;
  ...
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          macroValidPointer (p) ;
          GGS__list_semanticExpression  p_0 = p->mIFexpressionList ;
          GGS__list_semanticInstructions  p_1 = p->mIFinstructionListList ;
          GGS__list_semanticInstructions  p_2 = p->mElseInstructionList ;
          result._internalAppendValues (p_0, p_1, p_2) ;
          p = p->nextObject () ;
        }
      }
  ...
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          macroValidPointer (p) ;
          GGS__list_matchEntry  p_0 = p->mMatchedEntryList ;
    ...
    if (count () == 0) {
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          ...
          GGS__list_matchInstructionBranch  p_1 = p->mMatchInstructionBranchList ;
          GGS__list_semanticInstructions  p_2 = p->mElseInstructionList ;
          result._internalAppendValues (p_0, p_1, p_2) ;
          p = p->nextObject () ;
        }
    ...
    if (count () == 0) {
      ...
      if (inOperand.count () > 0) {
        ...
        while (p != NULL) {
          ...
          GGS__list_castInstructionBranch  p_1 = p->mCastInstructionBranchList ;
