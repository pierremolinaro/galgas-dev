...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mSemanticDeclaration._operator_isEqual (ptr->mSemanticDeclaration).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mRoutineName._operator_isEqual (ptr->mRoutineName).boolValue ()
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mRoutineName._operator_isEqual (ptr->mRoutineName).boolValue ()
         && mFormalParameterList._operator_isEqual (ptr->mFormalParameterList).boolValue ()
         && mRoutineInstructionList._operator_isEqual (ptr->mRoutineInstructionList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mFunctionName._operator_isEqual (ptr->mFunctionName).boolValue ()
         && mFormalParameterList._operator_isEqual (ptr->mFormalParameterList).boolValue ()
         && mResultTypeName._operator_isEqual (ptr->mResultTypeName).boolValue ()
         && mResultVariableName._operator_isEqual (ptr->mResultVariableName).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mFunctionName._operator_isEqual (ptr->mFunctionName).boolValue ()
         ...
         && mResultTypeName._operator_isEqual (ptr->mResultTypeName).boolValue ()
         && mResultVariableName._operator_isEqual (ptr->mResultVariableName).boolValue ()
         && mFunctionInstructionList._operator_isEqual (ptr->mFunctionInstructionList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mTypeName._operator_isEqual (ptr->mTypeName).boolValue ()
         && mVariableName._operator_isEqual (ptr->mVariableName).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_localVariableDeclaration::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_localVariableDeclaration (mTypeName, mVariableName COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mTypeName._operator_isEqual (ptr->mTypeName).boolValue ()
         ...
         && mConstructorArguments._operator_isEqual (ptr->mConstructorArguments).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_localVariableDeclarationWithInitialization::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_localVariableDeclarationWithInitialization (mTypeName, mVariableName, mConstructorName, mConstructorArguments COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mTypeName._operator_isEqual (ptr->mTypeName).boolValue ()
         && mVariableName._operator_isEqual (ptr->mVariableName).boolValue ()
         && mSourceExpression._operator_isEqual (ptr->mSourceExpression).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_localVariableDeclarationWithAssignment::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_localVariableDeclarationWithAssignment (mTypeName, mVariableName, mSourceExpression COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mTargetVariableName._operator_isEqual (ptr->mTargetVariableName).boolValue ()
         && mSourceExpression._operator_isEqual (ptr->mSourceExpression).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_assignmentInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_assignmentInstruction (mTargetVariableName, mSourceExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_appendInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_appendInstruction (mTargetVariableName, mStructAttributeList, mSourceExpression COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mTypeName._operator_isEqual (ptr->mTypeName).boolValue ()
         && mConstantName._operator_isEqual (ptr->mConstantName).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mElement._operator_isEqual (ptr->mElement).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mEnumeratedExpression._operator_isEqual (ptr->mEnumeratedExpression).boolValue ()
         && mElementList._operator_isEqual (ptr->mElementList).boolValue ()
         && mEndsWithEllipsis._operator_isEqual (ptr->mEndsWithEllipsis).boolValue () ;
  }
  return equal ;
}
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (ptr != NULL) {
      macroValidPointer (ptr) ;
      _internalAppendValues (ptr->mEnumeratedExpression,
                                ptr->mElementList,
...
internalSubListWithRange (GGS_foreachInstructionEnumeratedObjectList & ioList,
  ...
  if (inCount > 0) {
    ...
    for (sint32 i=0 ; i<inCount ; i++) {
      macroValidPointer (ptr) ;
      ioList._addAssign_operation (ptr->mEnumeratedExpression, ptr->mElementList, ptr->mEndsWithEllipsis) ;
      ptr = ptr->nextObject () ;
    }
  }
}
...
method_first (C_Compiler & inLexique,
  ...
  if (ptr != NULL) {
    _out_0 = ptr->mEnumeratedExpression ;
    _out_1 = ptr->mElementList ;
    _out_2 = ptr->mEndsWithEllipsis ;
  }else{
    _out_0.drop () ;
    _out_1.drop () ;
    _out_2.drop () ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mEnumeratedObjectList._operator_isEqual (ptr->mEnumeratedObjectList).boolValue ()
         && mIndexVariableName._operator_isEqual (ptr->mIndexVariableName).boolValue ()
         && mWhileExpression._operator_isEqual (ptr->mWhileExpression).boolValue ()
         && mBeforeInstructionList._operator_isEqual (ptr->mBeforeInstructionList).boolValue ()
         && mBetweenInstructionList._operator_isEqual (ptr->mBetweenInstructionList).boolValue ()
         && mDoInstructionList._operator_isEqual (ptr->mDoInstructionList).boolValue ()
         && mAfterInstructionList._operator_isEqual (ptr->mAfterInstructionList).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_foreachInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_foreachInstruction (mEnumeratedObjectList, mIndexVariableName, mWhileExpression, mBeforeInstructionList, mBetweenInstructionList, mDoInstructionList, mAfterInstructionList COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mIFexpression._operator_isEqual (ptr->mIFexpression).boolValue ()
         && mIFinstructionList._operator_isEqual (ptr->mIFinstructionList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mBranchList._operator_isEqual (ptr->mBranchList).boolValue ()
         && mElseInstructionList._operator_isEqual (ptr->mElseInstructionList).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_ifInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_ifInstruction (mBranchList, mElseInstructionList COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mReceiverExpression._operator_isEqual (ptr->mReceiverExpression).boolValue ()
         && mMethodName._operator_isEqual (ptr->mMethodName).boolValue ()
...
cPtr__AC_galgas_class * cPtr_methodCallInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_methodCallInstruction (mReceiverExpression, mMethodName, mActualParameterList COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mReceiverName._operator_isEqual (ptr->mReceiverName).boolValue ()
         && mReceiverStructAttributes._operator_isEqual (ptr->mReceiverStructAttributes).boolValue ()
         && mModifierName._operator_isEqual (ptr->mModifierName).boolValue ()
         && mActualParameterList._operator_isEqual (ptr->mActualParameterList).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_modifierCallInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_modifierCallInstruction (mReceiverName, mReceiverStructAttributes, mModifierName, mActualParameterList COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mReceiverExpression._operator_isEqual (ptr->mReceiverExpression).boolValue ()
         && mErrorExpression._operator_isEqual (ptr->mErrorExpression).boolValue ()
         && mBuiltVariableList._operator_isEqual (ptr->mBuiltVariableList).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_errorInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_errorInstruction (mReceiverExpression, mErrorExpression, mBuiltVariableList COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mReceiverExpression._operator_isEqual (ptr->mReceiverExpression).boolValue ()
         && mWarningExpression._operator_isEqual (ptr->mWarningExpression).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_warningInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_warningInstruction (mReceiverExpression, mWarningExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_routineCallInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_routineCallInstruction (mRoutineName, mActualParameterList COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mEntry._operator_isEqual (ptr->mEntry).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mClassName._operator_isEqual (ptr->mClassName).boolValue ()
         && mElements._operator_isEqual (ptr->mElements).boolValue ()
         && mEndsWithEllipsis._operator_isEqual (ptr->mEndsWithEllipsis).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mMatchEntryList._operator_isEqual (ptr->mMatchEntryList).boolValue ()
         && mMatchBranchInstructionList._operator_isEqual (ptr->mMatchBranchInstructionList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mMatchedVariableNameList._operator_isEqual (ptr->mMatchedVariableNameList).boolValue ()
         && mMatchInstructionBranchList._operator_isEqual (ptr->mMatchInstructionBranchList).boolValue ()
         && mElseInstructionList._operator_isEqual (ptr->mElseInstructionList).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_matchInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_matchInstruction (mMatchedVariableNameList, mMatchInstructionBranchList, mElseInstructionList COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mUseKindOfClass._operator_isEqual (ptr->mUseKindOfClass).boolValue ()
         && mTypeName._operator_isEqual (ptr->mTypeName).boolValue ()
         && mConstantVarName._operator_isEqual (ptr->mConstantVarName).boolValue ()
         && mConstantVarNameIsUnused._operator_isEqual (ptr->mConstantVarNameIsUnused).boolValue ()
         && mCastBranchInstructionList._operator_isEqual (ptr->mCastBranchInstructionList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mElseInstructionList._operator_isEqual (ptr->mElseInstructionList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mErrorLocationExpression._operator_isEqual (ptr->mErrorLocationExpression).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mExpression._operator_isEqual (ptr->mExpression).boolValue ()
         && mCastInstructionBranchList._operator_isEqual (ptr->mCastInstructionBranchList).boolValue ()
         && mElseOrDefault._operator_isEqual (ptr->mElseOrDefault).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_castInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_castInstruction (mExpression, mCastInstructionBranchList, mElseOrDefault COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = mReceiverName._operator_isEqual (ptr->mReceiverName).boolValue ()
         && mStructAttributeList._operator_isEqual (ptr->mStructAttributeList).boolValue ()
         && mExpressionList._operator_isEqual (ptr->mExpressionList).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_addInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_addInstruction (mReceiverName, mStructAttributeList, mExpressionList COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_removeInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_removeInstruction (mReceiverName, mStructAttributeList, mExpression COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_incrementInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_incrementInstruction (mReceiverName COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_decrementInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_decrementInstruction (mReceiverName COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mVariantExpression._operator_isEqual (ptr->mVariantExpression).boolValue ()
         && mFirstInstructions._operator_isEqual (ptr->mFirstInstructions).boolValue ()
         && mLoopExpression._operator_isEqual (ptr->mLoopExpression).boolValue ()
         && mSecondInstructions._operator_isEqual (ptr->mSecondInstructions).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_loopInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_loopInstruction (mVariantExpression, mFirstInstructions, mLoopExpression, mSecondInstructions COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_messageInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_messageInstruction (mExpression COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mLoggedVariableList._operator_isEqual (ptr->mLoggedVariableList).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_logInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_logInstruction (mLoggedVariableList COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mGrammarComponentName._operator_isEqual (ptr->mGrammarComponentName).boolValue ()
         && mLabelName._operator_isEqual (ptr->mLabelName).boolValue ()
         && mSourceExpression._operator_isEqual (ptr->mSourceExpression).boolValue ()
         && mSourceExpressionIsFile._operator_isEqual (ptr->mSourceExpressionIsFile).boolValue ()
         && mActualParameterList._operator_isEqual (ptr->mActualParameterList).boolValue ()
         && mReturnedModelName._operator_isEqual (ptr->mReturnedModelName).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@grammarInstruction:"
           ...
           << mActualParameterList.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << mReturnedModelName.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
cPtr__AC_galgas_class * cPtr_grammarInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_grammarInstruction (mGrammarComponentName, mLabelName, mSourceExpression, mSourceExpressionIsFile, mActualParameterList, mReturnedModelName COMMA_HERE)) ;
  return result ;
}
...
cPtr_withInstruction (const GGS_lstring & argument_0,
                                const GGS_lstring & argument_1,
                                const GGS_lstringlist & argument_2,
                                const GGS_lstring & argument_3,
                                const GGS_semanticExpression & argument_4,
                                const GGS_semanticInstructionList & argument_5,
                                const GGS_semanticInstructionList & argument_6
                                COMMA_LOCATION_ARGS)
:cPtr_semanticInstruction (THERE),
mPrefix (argument_0),
mTargetObjectName (argument_1),
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mPrefix._operator_isEqual (ptr->mPrefix).boolValue ()
         && mTargetObjectName._operator_isEqual (ptr->mTargetObjectName).boolValue ()
         && mStructAttributeList._operator_isEqual (ptr->mStructAttributeList).boolValue ()
         && mSearchMethodName._operator_isEqual (ptr->mSearchMethodName).boolValue ()
         && mKeyExpression._operator_isEqual (ptr->mKeyExpression).boolValue ()
         && mDoBranchInstructions._operator_isEqual (ptr->mDoBranchInstructions).boolValue ()
         && mElseBranchInstructions._operator_isEqual (ptr->mElseBranchInstructions).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_withInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_withInstruction (mPrefix, mTargetObjectName, mStructAttributeList, mSearchMethodName, mKeyExpression, mDoBranchInstructions, mElseBranchInstructions COMMA_HERE)) ;
  return result ;
}
...
GGS_withInstruction::
GGS_withInstruction (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_withInstruction (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mSwitchConstantList._operator_isEqual (ptr->mSwitchConstantList).boolValue ()
         && mInstructions._operator_isEqual (ptr->mInstructions).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mSwitchExpression._operator_isEqual (ptr->mSwitchExpression).boolValue ()
         && mBranches._operator_isEqual (ptr->mBranches).boolValue () ;
  }
  return equal ;
}
...
cPtr__AC_galgas_class * cPtr_switchInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_switchInstruction (mSwitchExpression, mBranches COMMA_HERE)) ;
  return result ;
}
...
cPtr__AC_galgas_class * cPtr_typeMethodInstruction::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_typeMethodInstruction (mTypeName, mMethodName, mActualParameterList COMMA_HERE)) ;
  return result ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mAbstractCategoryMethodName._operator_isEqual (ptr->mAbstractCategoryMethodName).boolValue ()
         && mAbstractCategoryFormalParameterList._operator_isEqual (ptr->mAbstractCategoryFormalParameterList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mCategoryMethodName._operator_isEqual (ptr->mCategoryMethodName).boolValue ()
         && mCategoryFormalParameterList._operator_isEqual (ptr->mCategoryFormalParameterList).boolValue ()
         && mRoutineInstructionList._operator_isEqual (ptr->mRoutineInstructionList).boolValue () ;
  }
  return equal ;
}
...
isEqualToObject (const cListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    macroValidPointer (ptr) ;
    equal = mOverridingCategoryMethodName._operator_isEqual (ptr->mOverridingCategoryMethodName).boolValue ()
         && mOverridingCategoryFormalParameterList._operator_isEqual (ptr->mOverridingCategoryFormalParameterList).boolValue ()
         && mRoutineInstructionList._operator_isEqual (ptr->mRoutineInstructionList).boolValue () ;
  }
  return equal ;
}
