...
class syntaxModelBuilder {
  ...
  protected : void pr_syntax_instruction_syntaxModelBuilder_325_25_ (galgas_scanner &,
                                GGS_syntaxInstruction  &) ;

  protected : virtual PMSInt16 select_repeat_syntaxModelBuilder_9 (galgas_scanner &) = 0 ;

  protected : void pr_syntax_instruction_syntaxModelBuilder_353_25_ (galgas_scanner &,
                                GGS_syntaxInstruction  &) ;

  protected : virtual PMSInt16 select_repeat_syntaxModelBuilder_10 (galgas_scanner &) = 0 ;

  protected : void pr_syntax_instruction_syntaxModelBuilder_380_25_ (galgas_scanner &,
                                GGS_syntaxInstruction  &) ;
