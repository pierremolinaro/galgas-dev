...
GALGAS_semanticInstructionListForGeneration function_syntaxSignatureOfInstructionList (const GALGAS_semanticInstructionListForGeneration & constinArgument0,
...
typedef void (*categoryMethodSignature_semanticInstructionForGeneration_appendSyntaxSignature) (const cPtr_semanticInstructionForGeneration * inObject,
                                                                                                GALGAS_semanticInstructionListForGeneration & ioArgument0,
                                                                                                C_Compiler * inCompiler
                                                                                                COMMA_LOCATION_ARGS) ;
