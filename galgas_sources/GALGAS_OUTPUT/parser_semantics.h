...
//--- Constructor 'emptyList'
  ...
  public : static GGS_L_parse_rewind_signature_list constructor_listWithValue (const GGS_L_ruleSyntaxSignature & argument_0,
                                const GGS_location & argument_1) ;
//--- Get sublist
  protected : void
...
//--------------------------------- List Enumerator
  ...
  public : const GGS_L_ruleSyntaxSignature   * _mSignature (LOCATION_ARGS) const ;
...
public : void modifier_setAListeDeTypesEffectifsForKey (C_Compiler & inLexique,                        const GGS_typeListeTypesEtNomsArgMethode & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) ;
public : void modifier_setMAllInstructionsListForKey (C_Compiler & inLexique,                        const GGS_typeInstructionList & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) ;
public : void modifier_setMSyntaxSignatureForKey (C_Compiler & inLexique,                        const GGS_L_ruleSyntaxSignature & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) ;
public : void modifier_setMEndOfInstructionListLocationForKey (C_Compiler & inLexique,                        const GGS_location & inValue,
                        const GGS_string & inKey
                        COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Map Enumerator
  ...
  //--- Iterator method
    ...
    public : const GGS_L_ruleSyntaxSignature   * _mSyntaxSignature (LOCATION_ARGS) const ;
