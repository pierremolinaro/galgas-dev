...
//--- Internal Methods
  ...
  protected : void _internalPrependItem (const GGS_typeInstructionList & argument_0) ;
...
//--- Internal Methods
  protected : void _internalAppendItem (const GGS_L_ruleSyntaxSignature & argument_0,
                                const GGS_location & argument_1) ;
  protected : void _internalPrependItem (const GGS_L_ruleSyntaxSignature & argument_0,
                                const GGS_location & argument_1) ;
  protected : void _insulateList (void) ;
//--- '_isBuilt' method
  public : inline bool _isBuilt (void) const {
...
class elementOf_GGS_typeListeBranchesInstructions {
  ...
  private : elementOf_GGS_typeListeBranchesInstructions * mPreviousItem ;
  ...
  public : inline elementOf_GGS_typeListeBranchesInstructions * previousObject (void) const { return mPreviousItem ; }
...
class elementOf_GGS_L_parse_rewind_signature_list {
  ...
  private : elementOf_GGS_L_parse_rewind_signature_list * mPreviousItem ;
  ...
  public : inline elementOf_GGS_L_parse_rewind_signature_list * previousObject (void) const { return mPreviousItem ; }
