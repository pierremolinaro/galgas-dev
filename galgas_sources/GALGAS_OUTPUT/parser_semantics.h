...
class GGS_typeInstructionAppelNonTerminal {
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : static cPtr_typeInstructionAppelNonTerminal * constructor_new (C_Lexique & inLexique,
  ...
  #else
    public : inline static cPtr_typeInstructionAppelNonTerminal * constructor_new (C_Lexique & /* inLexique */,
                                const GGS_lstring & argument_0,
                                const GGS_typeExpressionList & argument_1,
                                const GGS_lstring & argument_2,
                                const GGS_lstring & argument_3,
...
class GGS_typeInstructionVerifSyntaxique {
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : static cPtr_typeInstructionVerifSyntaxique * constructor_new (C_Lexique & inLexique,
                                const GGS_lstring & argument_0,
                                const GGS_L_assignedVariables & argument_1 COMMA_LOCATION_ARGS) ;
  #else
    public : inline static cPtr_typeInstructionVerifSyntaxique * constructor_new (C_Lexique & /* inLexique */,
                                const GGS_lstring & argument_0,
                                const GGS_L_assignedVariables & argument_1 COMMA_LOCATION_ARGS) {
...
class GGS_C_select_instruction {
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : static cPtr_C_select_instruction * constructor_new (C_Lexique & inLexique,
                                const GGS_typeListeBranchesInstructions & argument_0,
                                const GGS_location & argument_1 COMMA_LOCATION_ARGS) ;
  #else
    public : inline static cPtr_C_select_instruction * constructor_new (C_Lexique & /* inLexique */,
                                const GGS_typeListeBranchesInstructions & argument_0,
                                const GGS_location & argument_1 COMMA_LOCATION_ARGS) {
...
class GGS_C_repeat_instruction {
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : static cPtr_C_repeat_instruction * constructor_new (C_Lexique & inLexique,
                                const GGS_typeListeBranchesInstructions & argument_0,
                                const GGS_location & argument_1 COMMA_LOCATION_ARGS) ;
  #else
    public : inline static cPtr_C_repeat_instruction * constructor_new (C_Lexique & /* inLexique */,
                                const GGS_typeListeBranchesInstructions & argument_0,
                                const GGS_location & argument_1 COMMA_LOCATION_ARGS) {
...
class GGS_C_parse_rewind_instruction {
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : static cPtr_C_parse_rewind_instruction * constructor_new (C_Lexique & inLexique,
                                const GGS_location & argument_0,
                                const GGS_typeListeBranchesInstructions & argument_1 COMMA_LOCATION_ARGS) ;
  #else
    public : inline static cPtr_C_parse_rewind_instruction * constructor_new (C_Lexique & /* inLexique */,
                                const GGS_location & argument_0,
                                const GGS_typeListeBranchesInstructions & argument_1 COMMA_LOCATION_ARGS) {
...
class GGS_C_parse_when_else_instruction {
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : static cPtr_C_parse_when_else_instruction * constructor_new (C_Lexique & inLexique,
                                const GGS_L_expression_instructionsList_list & argument_0,
                                const GGS_typeInstructionList & argument_1 COMMA_LOCATION_ARGS) ;
  #else
    public : inline static cPtr_C_parse_when_else_instruction * constructor_new (C_Lexique & /* inLexique */,
                                const GGS_L_expression_instructionsList_list & argument_0,
                                const GGS_typeInstructionList & argument_1 COMMA_LOCATION_ARGS) {
...
class GGS_typeNonterminalToGenerate {
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : static cPtr_typeNonterminalToGenerate * constructor_new (C_Lexique & inLexique,
                                const GGS_lstring & argument_0,
                                const GGS_M_nonterminalSymbolAlts & argument_1 COMMA_LOCATION_ARGS) ;
  #else
    public : inline static cPtr_typeNonterminalToGenerate * constructor_new (C_Lexique & /* inLexique */,
                                const GGS_lstring & argument_0,
                                const GGS_M_nonterminalSymbolAlts & argument_1 COMMA_LOCATION_ARGS) {
...
class GGS_typeProductionAengendrer {
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : static cPtr_typeProductionAengendrer * constructor_new (C_Lexique & inLexique,
                                const GGS_lstring & argument_0,
                                const GGS_typeAltProductionsMap & argument_1,
                                const GGS_string& argument_2,
                                const GGS_bool& argument_3 COMMA_LOCATION_ARGS) ;
  #else
    public : inline static cPtr_typeProductionAengendrer * constructor_new (C_Lexique & /* inLexique */,
                                const GGS_lstring & argument_0,
                                const GGS_typeAltProductionsMap & argument_1,
                                const GGS_string& argument_2,
                                const GGS_bool& argument_3 COMMA_LOCATION_ARGS) {
