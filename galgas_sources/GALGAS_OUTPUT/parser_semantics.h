...
//--- Readers
  ...
  public : GGS_typeExpression  reader_mConditionalExpression (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
  public : GGS_typeInstructionList  reader_mInstructionsList (C_Compiler & inLexique COMMA_LOCATION_ARGS) const ;
