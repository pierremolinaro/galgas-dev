...
class GALGAS_string function_compilerCppName (C_Compiler * inCompiler
                                              COMMA_LOCATION_ARGS) ;
...
class GALGAS_string function_syntaxDirectedTranslationResultVarName (C_Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) ;
