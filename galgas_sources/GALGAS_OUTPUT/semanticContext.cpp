...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  ioArgument_ioWrapperDirectoryIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1872)) ;
  GALGAS_stringlist var_files = constinArgument_inAbsoluteSourcePath.reader_regularFiles (GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1874)) ;
  outArgument_outWrapperFileMap = GALGAS_wrapperFileMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1875)) ;
  cEnumerator_stringlist enumerator_76222 (var_files, kEnumeration_up) ;
  while (enumerator_76222.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_76222.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1877)) COMMA_SOURCE_FILE_AT_LINE (1877)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1878)).operator_concat (enumerator_76222.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1878)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76222.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1880)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1879)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1886)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_76222.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1887)) COMMA_SOURCE_FILE_AT_LINE (1887)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1888)).operator_concat (enumerator_76222.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1888)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76222.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1890)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1889)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1896)) ;
      }
    }
    enumerator_76222.gotoNextObject () ;
  }
  GALGAS_stringlist var_directories = constinArgument_inAbsoluteSourcePath.reader_directories (GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1900)) ;
  outArgument_outWrapperDirectoryMap = GALGAS_wrapperDirectoryMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1901)) ;
  cEnumerator_stringlist enumerator_77187 (var_directories, kEnumeration_up) ;
  while (enumerator_77187.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1907)).operator_concat (enumerator_77187.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1907)), constinArgument_inPathInWrapper.operator_concat (enumerator_77187.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1908)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1908)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1906)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_77187.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1917)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1916)) ;
    }
    enumerator_77187.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147281 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147281.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_147281.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3578)) ;
    enumerator_147281.gotoNextObject () ;
  }
  GALGAS_semanticTypePrecedenceGraph var_semanticTypePrecedenceGraph = GALGAS_semanticTypePrecedenceGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (3584)) ;
  GALGAS_categoryMethodMapForBuildingContext var_categoryMethodMapForBuildingContext = GALGAS_categoryMethodMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3585)) ;
  GALGAS_categoryReaderMapForBuildingContext var_categoryReaderMapForBuildingContext = GALGAS_categoryReaderMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3586)) ;
  GALGAS_categoryModifierMapForBuildingContext var_categoryModifierMapForBuildingContext = GALGAS_categoryModifierMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3587)) ;
  GALGAS_semanticDeclarationListAST var_categoryOverrideDefinitionList = GALGAS_semanticDeclarationListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3588)) ;
  cEnumerator_semanticDeclarationListAST enumerator_148014 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_148014.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_148014.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3590)) ;
    enumerator_148014.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (3598)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_148434 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3599)), kEnumeration_up) ;
    while (enumerator_148434.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_148434.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_148434.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3600)) COMMA_SOURCE_FILE_AT_LINE (3600)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3600)) COMMA_SOURCE_FILE_AT_LINE (3600)) ;
      enumerator_148434.gotoNextObject () ;
    }
    inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("semantic analysis not performed, due to undefined type error(s)") COMMA_SOURCE_FILE_AT_LINE (3602)) ;
    ...
    GALGAS_lstringlist joker_148772_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_148772_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3604)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3610)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string ("semantic analysis not performed, ").operator_concat (var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3611)).reader_string (SOURCE_FILE_AT_LINE (3611)) COMMA_SOURCE_FILE_AT_LINE (3611)).operator_concat (GALGAS_string (" declarations are involved in circular definition:") COMMA_SOURCE_FILE_AT_LINE (3611)) ;
      cEnumerator_semanticDeclarationListAST enumerator_149167 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149167.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_149167.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3613)) COMMA_SOURCE_FILE_AT_LINE (3613)) COMMA_SOURCE_FILE_AT_LINE (3613)) ;
        enumerator_149167.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (3615)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      var_sortedSemanticDeclarationListAST.dotAssign_operation (var_categoryOverrideDefinitionList COMMA_SOURCE_FILE_AT_LINE (3618)) ;
      outArgument_outSemanticContext = GALGAS_semanticContext::constructor_new (constinArgument_inSourceFile, GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3622)), GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3623)), GALGAS_functionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3624)), GALGAS_filewrapperMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3625)), GALGAS_grammarMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3626)), GALGAS_optionComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3627)), GALGAS_lexiqueComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3628)), GALGAS_optionMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3629)) COMMA_SOURCE_FILE_AT_LINE (3620)) ;
      cEnumerator_semanticDeclarationListAST enumerator_149975 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149975.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_149975.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3633)) ;
        enumerator_149975.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("bool"), var_boolTypeIndex COMMA_SOURCE_FILE_AT_LINE (808)) ;
  }
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (811)) ;
  }
  GALGAS_unifiedTypeMapProxy var_locationTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("location"), var_locationTypeProxy COMMA_SOURCE_FILE_AT_LINE (814)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstring"), var_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (817)) ;
  }
  GALGAS_unifiedTypeMapProxy var_currentMapTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mMapTypeName, var_currentMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (820)) ;
  }
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_listWithValue (var_lstringTypeIndex, GALGAS_string ("lkey") COMMA_SOURCE_FILE_AT_LINE (822)) ;
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (823)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (824)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (825)) ;
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (827)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (828)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (829)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (830)) ;
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyMap"), object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (832)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (832)) ;
  }
  {
  routine_enterConstructorWithArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("mapWithMapToOverride"), object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (833)), GALGAS_string ("inMap"), object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (833)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (833)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("levels"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (835)) ;
  }
  {
  routine_enterInheritedReaderWith_32_Arguments (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("hasKeyAtLevel"), GALGAS_string ("string"), GALGAS_string ("inKey"), GALGAS_string ("uint"), GALGAS_string ("inLevel"), GALGAS_string ("bool"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (836)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keySet"), GALGAS_string ("stringset"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (837)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keyList"), GALGAS_string ("lstringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (838)) ;
  }
  {
  routine_enterInheritedReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("hasKey"), GALGAS_string ("string"), GALGAS_string ("inKey"), GALGAS_string ("bool"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (839)) ;
  }
  {
  routine_enterInheritedReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("locationForKey"), GALGAS_string ("string"), GALGAS_string ("inKey"), GALGAS_string ("location"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (840)) ;
  }
  {
  routine_enterBaseReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("overriddenMap"), object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (841)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (841)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("count"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (842)) ;
  }
  GALGAS_formalParameterSignature var_insertMethodFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (844)) ;
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (845)) ;
  var_insertMethodFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (846)), GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (846)) ;
  GALGAS_formalParameterSignature var_removeMethodFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (847)) ;
  var_removeMethodFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (848)), GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (848)) ;
  cEnumerator_attributeInCollectionListAST enumerator_35961 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_35961.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_35961.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (851)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_35961.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (854)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_35961.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (855)) COMMA_SOURCE_FILE_AT_LINE (855)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (856)), enumerator_35961.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (856)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (857)), enumerator_35961.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (857)) ;
    enumerator_35961.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_36679 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_36679.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_36679.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (861)) COMMA_SOURCE_FILE_AT_LINE (861)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_36679.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_36679.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (862)) COMMA_SOURCE_FILE_AT_LINE (862)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (862)) COMMA_SOURCE_FILE_AT_LINE (862)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_36679.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (866)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (869)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (864)) ;
      }
    }
    enumerator_36679.gotoNextObject () ;
  }
  cEnumerator_mapRemoveMethodListAST enumerator_37153 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  while (enumerator_37153.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_modifierMap.reader_hasKey (enumerator_37153.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (876)) COMMA_SOURCE_FILE_AT_LINE (876)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_37153.current_mMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_37153.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (877)) COMMA_SOURCE_FILE_AT_LINE (877)).operator_concat (GALGAS_string ("' method is already declared as an insert modifier or a remove modifier") COMMA_SOURCE_FILE_AT_LINE (877)) COMMA_SOURCE_FILE_AT_LINE (877)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_37153.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (881)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (884)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (879)) ;
      }
    }
    enumerator_37153.gotoNextObject () ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_37680 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_37680.hasCurrentObject ()) {
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_37680.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (893)), var_removeMethodFormalArgumentList, enumerator_37680.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (895)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (897)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (891)) ;
    }
    enumerator_37680.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_38015 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_38015.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_38015.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (903)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (903)), enumerator_38015.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (903)) COMMA_SOURCE_FILE_AT_LINE (903)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_38015.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (905)) ;
    }
    {
    var_readerMap.modifier_insertOrReplace (var_accessorName, GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (908)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_listWithValue (var_stringTypeIndex, GALGAS_string ("inKey") COMMA_SOURCE_FILE_AT_LINE (909)), inCompiler->here (), GALGAS_bool (true), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (913)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (906)) ;
    }
    enumerator_38015.gotoNextObject () ;
  }
  const enumGalgasBool test_4 = GALGAS_bool (kIsSupOrEqual, object->mAttribute_mInsertOrReplaceDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (918)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
  if (kBoolTrue == test_4) {
    GALGAS_location var_insertOrReplaceLocation ;
    object->mAttribute_mInsertOrReplaceDeclarationListAST.method_first (var_insertOrReplaceLocation, inCompiler COMMA_SOURCE_FILE_AT_LINE (920)) ;
    {
    var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("insertOrReplace"), var_insertOrReplaceLocation COMMA_SOURCE_FILE_AT_LINE (922)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (923)), var_insertMethodFormalArgumentList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (926)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (921)) ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_39162 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_39162.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_39162.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (932)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (932)) COMMA_SOURCE_FILE_AT_LINE (932)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (932)), enumerator_39162.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (932)) COMMA_SOURCE_FILE_AT_LINE (932)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_39162.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (934)) ;
    }
    GALGAS_formalParameterSignature var_accessorFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (935)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (936)), enumerator_39162.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (936)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (937)), enumerator_39162.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (937)) ;
    {
    var_modifierMap.modifier_insertOrReplace (var_accessorName, GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (940)), var_accessorFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (943)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (938)) ;
    }
    enumerator_39162.gotoNextObject () ;
  }
  GALGAS_withAccessorMap var_withAccessorMap = GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (948)) ;
  {
  var_withAccessorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("hasKey"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (949)), var_stringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (949)) ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_40215 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_40215.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_40215.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (951)) ;
    }
    enumerator_40215.gotoNextObject () ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mMapTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (957)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratorTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mMapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (970)) COMMA_SOURCE_FILE_AT_LINE (970)), object->mAttribute_mMapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (970)), var_enumeratorTypeIndex COMMA_SOURCE_FILE_AT_LINE (968)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mMapTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (977)), GALGAS_typeKindEnum::constructor_mapType (SOURCE_FILE_AT_LINE (978)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (979)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (980)), var_typedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (986)), var_enumerationDescriptor, var_enumerationVariants, function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (989)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (990)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (991)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (992)), object->mAttribute_mSearchMethodList, GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (994)), var_withAccessorMap, GALGAS_bool (false), var_enumeratorTypeIndex, GALGAS_string ("emptyMap"), inCompiler COMMA_SOURCE_FILE_AT_LINE (974)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1012)) ;
  }
  GALGAS_unifiedTypeMapProxy var_locationTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("location"), var_locationTypeProxy COMMA_SOURCE_FILE_AT_LINE (1015)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstring"), var_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1018)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringlistTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstringlist"), var_lstringlistTypeIndex COMMA_SOURCE_FILE_AT_LINE (1021)) ;
  }
  GALGAS_unifiedTypeMapProxy var_currentMapTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mMapTypeName, var_currentMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (1024)) ;
  }
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_listWithValue (var_lstringTypeIndex, GALGAS_string ("lkey") COMMA_SOURCE_FILE_AT_LINE (1026)) ;
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1027)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (1028)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (1029)) ;
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1031)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1032)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1033)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1034)) ;
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyMap"), object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (1036)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1036)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("allKeys"), GALGAS_string ("stringset"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1038)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("allKeyList"), GALGAS_string ("lstringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1039)) ;
  }
  {
  routine_enterInheritedReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("hasKey"), GALGAS_string ("string"), GALGAS_string ("inKey"), GALGAS_string ("bool"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1040)) ;
  }
  {
  routine_enterInheritedReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("locationForKey"), GALGAS_string ("string"), GALGAS_string ("inKey"), GALGAS_string ("location"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1041)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("count"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1042)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("unsolvedProxyCount"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1043)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("unsolvedProxyList"), GALGAS_string ("lstringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1044)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("edgeGraphvizRepresentation"), GALGAS_string ("string"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1045)) ;
  }
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1047)) ;
  GALGAS_formalParameterSignature var_insertMethodFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1048)) ;
  var_insertMethodFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1049)), GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (1049)) ;
  GALGAS_formalParameterSignature var_removeMethodFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1050)) ;
  var_removeMethodFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1051)), GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (1051)) ;
  cEnumerator_attributeInCollectionListAST enumerator_45035 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_45035.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_45035.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1054)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_45035.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1057)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_45035.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1058)) COMMA_SOURCE_FILE_AT_LINE (1058)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1059)), enumerator_45035.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1059)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1060)), enumerator_45035.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1060)) ;
    enumerator_45035.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_45769 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_45769.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_45769.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1064)) COMMA_SOURCE_FILE_AT_LINE (1064)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_45769.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_45769.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1065)) COMMA_SOURCE_FILE_AT_LINE (1065)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (1065)) COMMA_SOURCE_FILE_AT_LINE (1065)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_45769.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1069)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1072)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1067)) ;
      }
    }
    enumerator_45769.gotoNextObject () ;
  }
  GALGAS_formalParameterSignature var_enterEdgeFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1078)) ;
  var_enterEdgeFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1079)), GALGAS_string ("inSource") COMMA_SOURCE_FILE_AT_LINE (1079)) ;
  var_enterEdgeFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1080)), GALGAS_string ("inTarget") COMMA_SOURCE_FILE_AT_LINE (1080)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_string ("enterEdge").reader_nowhere (SOURCE_FILE_AT_LINE (1082)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1083)), var_enterEdgeFormalArgumentList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1086)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1081)) ;
  }
  GALGAS_formalParameterSignature var_topologicalSortFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1090)) ;
  var_topologicalSortFormalArgumentList.addAssign_operation (var_lstringlistTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1091)), GALGAS_string ("outSortedLKeys") COMMA_SOURCE_FILE_AT_LINE (1091)) ;
  var_topologicalSortFormalArgumentList.addAssign_operation (var_lstringlistTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1092)), GALGAS_string ("outUnsortedLKeys") COMMA_SOURCE_FILE_AT_LINE (1092)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_string ("topologicalSort").reader_nowhere (SOURCE_FILE_AT_LINE (1094)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1095)), var_topologicalSortFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1099)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1093)) ;
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, object->mAttribute_mMapStateList.reader_length (SOURCE_FILE_AT_LINE (1103)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_47514 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_47514.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_47514.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1107)), var_removeMethodFormalArgumentList, enumerator_47514.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (1109)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1111)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1105)) ;
      }
    ...
    while (enumerator_47844.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_47844.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1119)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1122)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1117)) ;
      }
      enumerator_47844.gotoNextObject () ;
    }
  }
  const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, object->mAttribute_mMapStateList.reader_length (SOURCE_FILE_AT_LINE (1128)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_3) {
    GALGAS_unifiedTypeMapProxy var_locationTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("location"), var_locationTypeIndex COMMA_SOURCE_FILE_AT_LINE (1130)) ;
    }
    {
    var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openBranch"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1132)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1133)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1134)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1136)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1131)) ;
    }
    {
    var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("closeBranch"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1140)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1141)), GALGAS_formalParameterSignature::constructor_listWithValue (var_locationTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1142)), GALGAS_string ("inErrorLocation") COMMA_SOURCE_FILE_AT_LINE (1142)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1144)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1139)) ;
    }
    {
    var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("closeOverride"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1148)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1149)), GALGAS_formalParameterSignature::constructor_listWithValue (var_locationTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1150)), GALGAS_string ("inErrorLocation") COMMA_SOURCE_FILE_AT_LINE (1150)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1152)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1147)) ;
    }
    {
    var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("checkAutomatonStates"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1156)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1157)), GALGAS_formalParameterSignature::constructor_listWithValue (var_locationTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1158)), GALGAS_string ("inErrorLocation") COMMA_SOURCE_FILE_AT_LINE (1158)), inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1161)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1155)) ;
    }
    cEnumerator_mapOverrideBlockListAST enumerator_49654 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    while (enumerator_49654.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_49654.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1166)) COMMA_SOURCE_FILE_AT_LINE (1166)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1166)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1167)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1168)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1170)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1165)) ;
      }
      enumerator_49654.gotoNextObject () ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_50063 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_50063.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_50063.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1177)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1177)), enumerator_50063.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1177)) COMMA_SOURCE_FILE_AT_LINE (1177)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_50063.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1179)) ;
    }
    {
    var_readerMap.modifier_insertOrReplace (var_accessorName, GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1182)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_listWithValue (var_stringTypeIndex, GALGAS_string ("inKey") COMMA_SOURCE_FILE_AT_LINE (1183)), inCompiler->here (), GALGAS_bool (true), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1187)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1180)) ;
    }
    enumerator_50063.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_50720 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_50720.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_50720.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1193)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1193)) COMMA_SOURCE_FILE_AT_LINE (1193)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1193)), enumerator_50720.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1193)) COMMA_SOURCE_FILE_AT_LINE (1193)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_50720.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1195)) ;
    }
    GALGAS_formalParameterSignature var_accessorFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1196)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1197)), enumerator_50720.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1197)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1198)), enumerator_50720.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1198)) ;
    {
    var_modifierMap.modifier_insertOrReplace (var_accessorName, GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1201)), var_accessorFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1204)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1199)) ;
    }
    enumerator_50720.gotoNextObject () ;
  }
  GALGAS_withAccessorMap var_withAccessorMap = GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1209)) ;
  {
  var_withAccessorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("hasKey"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1210)), var_stringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1210)) ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_51773 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_51773.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_51773.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1212)) ;
    }
    enumerator_51773.gotoNextObject () ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mMapTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1218)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mMapTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1232)), GALGAS_typeKindEnum::constructor_uniqueMapType (SOURCE_FILE_AT_LINE (1233)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1234)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1235)), var_typedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1241)), var_enumerationDescriptor, var_enumerationVariants, function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (1244)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1245)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1246)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1247)), object->mAttribute_mSearchMethodList, GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1249)), var_withAccessorMap, GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1252)), GALGAS_string ("emptyMap"), inCompiler COMMA_SOURCE_FILE_AT_LINE (1229)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_53529_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_53529_1 ; // Joker input parameter
  GALGAS_typedAttributeList joker_53569_2 ; // Joker input parameter
  GALGAS_attributeMap joker_53569_1 ; // Joker input parameter
  GALGAS_constructorMap joker_53624_11 ; // Joker input parameter
  GALGAS_readerMap joker_53624_10 ; // Joker input parameter
  GALGAS_modifierMap joker_53624_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_53624_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_53624_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_53624_6 ; // Joker input parameter
  GALGAS_stringlist joker_53624_5 ; // Joker input parameter
  GALGAS_uint joker_53624_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_53624_3 ; // Joker input parameter
  GALGAS_stringset joker_53624_2 ; // Joker input parameter
  GALGAS_lstringlist joker_53624_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_53679_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_53679_4 ; // Joker input parameter
  GALGAS_bool joker_53679_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_53679_2 ; // Joker input parameter
  GALGAS_string joker_53679_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_53529_2, joker_53529_1, var_typeKindEnum, joker_53569_2, joker_53569_1, var_mapTypedAttributeList, joker_53624_11, joker_53624_10, joker_53624_9, joker_53624_8, joker_53624_7, joker_53624_6, joker_53624_5, joker_53624_4, joker_53624_3, joker_53624_2, joker_53624_1, var_searchMethodList, joker_53679_5, joker_53679_4, joker_53679_3, joker_53679_2, joker_53679_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1266)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_uniqueMapType (SOURCE_FILE_AT_LINE (1276)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mAssociatedMapTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the @").operator_concat (object->mAttribute_mAssociatedMapTypeName.reader_string (SOURCE_FILE_AT_LINE (1277)) COMMA_SOURCE_FILE_AT_LINE (1277)).operator_concat (GALGAS_string (" should be an unique map type") COMMA_SOURCE_FILE_AT_LINE (1277)) COMMA_SOURCE_FILE_AT_LINE (1277)) ;
    var_mapTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1278)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1281)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1282)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1283)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1284)) ;
  GALGAS_classMethodMap var_classMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1285)) ;
  GALGAS_unifiedTypeMapProxy var_associatedMapTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedMapTypeName, var_associatedMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (1288)) ;
  }
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1291)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstring"), var_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1294)) ;
  }
  GALGAS_unifiedTypeMapProxy var_mapProxyTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mMapProxyTypeName, var_mapProxyTypeProxy COMMA_SOURCE_FILE_AT_LINE (1297)) ;
  }
  GALGAS_formalParameterSignature var_argList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1299)) ;
  var_argList.addAssign_operation (var_associatedMapTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (1300)), GALGAS_string ("ioMap") COMMA_SOURCE_FILE_AT_LINE (1300)) ;
  var_argList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1301)), GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (1301)) ;
  var_argList.addAssign_operation (var_mapProxyTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1302)), GALGAS_string ("outProxy") COMMA_SOURCE_FILE_AT_LINE (1302)) ;
  {
  var_classMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("makeProxy"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1304)), var_argList, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1303)) ;
  }
  var_argList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1309)) ;
  var_argList.addAssign_operation (var_associatedMapTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (1310)), GALGAS_string ("ioMap") COMMA_SOURCE_FILE_AT_LINE (1310)) ;
  var_argList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1311)), GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (1311)) ;
  var_argList.addAssign_operation (var_mapProxyTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1312)), GALGAS_string ("outProxy") COMMA_SOURCE_FILE_AT_LINE (1312)) ;
  {
  var_classMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("makeProxyFromString"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1314)), var_argList, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1313)) ;
  }
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("null"), object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE_AT_LINE (1319)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1319)) ;
  }
  GALGAS_unifiedTypeMapProxyAndParameterList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1321)) ;
  var_constructorAttributeTypeList.addAssign_operation (var_associatedMapTypeIndex, GALGAS_string ("inMap") COMMA_SOURCE_FILE_AT_LINE (1322)) ;
  var_constructorAttributeTypeList.addAssign_operation (var_lstringTypeIndex, GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (1323)) ;
  cEnumerator_mapSearchMethodListAST enumerator_56287 (var_searchMethodList, kEnumeration_up) ;
  while (enumerator_56287.hasCurrentObject ()) {
    {
    var_constructorMap.modifier_insertKey (enumerator_56287.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1325)) ;
    }
    enumerator_56287.gotoNextObject () ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("isSolved"), GALGAS_string ("bool"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1333)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("isNull"), GALGAS_string ("bool"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1334)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("isRegular"), GALGAS_string ("bool"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1335)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lkey"), GALGAS_string ("lstring"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1336)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("key"), GALGAS_string ("string"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1337)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("identifierRepresentation"), GALGAS_string ("string"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1338)) ;
  }
  GALGAS_readerMap var_inheritedReaderMap = var_readerMap ;
  cEnumerator_typedAttributeList enumerator_57258 (var_mapTypedAttributeList, kEnumeration_up) ;
  while (enumerator_57258.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_57258.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1342)) COMMA_SOURCE_FILE_AT_LINE (1342)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_57392 (var_inheritedReaderMap.reader_keySet (SOURCE_FILE_AT_LINE (1344)), kEnumeration_up) ;
      while (enumerator_57392.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_57392.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (1345)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1345)) COMMA_SOURCE_FILE_AT_LINE (1345)) ;
        if (enumerator_57392.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (1346)) ;
        }
        enumerator_57392.gotoNextObject () ;
      }
      GALGAS_location location_3 (enumerator_57258.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the map has a associated map proxy, which has predefined readers: ").operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (1348)).operator_concat (GALGAS_string ("; you cannot use theses names for naming an attribute of this map") COMMA_SOURCE_FILE_AT_LINE (1348)) COMMA_SOURCE_FILE_AT_LINE (1348)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_readerMap.modifier_insertKey (enumerator_57258.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1353)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1354)), inCompiler->here (), GALGAS_bool (true), enumerator_57258.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1358)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1351)) ;
      }
    }
    enumerator_57258.gotoNextObject () ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mMapProxyTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1364)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mMapProxyTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1378)), GALGAS_typeKindEnum::constructor_mapProxyType (SOURCE_FILE_AT_LINE (1379)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1380)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1381)), var_mapTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, var_classMethodMap, GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1388)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1389)), function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (1390)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1391)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1392)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1393)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1394)), var_searchMethodList, GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1396)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1398)), GALGAS_string ("null"), inCompiler COMMA_SOURCE_FILE_AT_LINE (1375)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externTypeDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1412)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1413)) ;
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1414)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1415)) ;
  GALGAS_classMethodMap var_classMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1416)) ;
  cEnumerator_externTypeConstructorList enumerator_59912 (object->mAttribute_mExternTypeConstructorList, kEnumeration_up) ;
  while (enumerator_59912.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59912.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1420)) ;
    }
    GALGAS_unifiedTypeMapProxyAndParameterList var_arguments = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1422)) ;
    cEnumerator_typeNameFormalParameterNameList enumerator_60164 (enumerator_59912.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_60164.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60164.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1425)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_60164.current_mFormalParameterName (HERE) COMMA_SOURCE_FILE_AT_LINE (1426)) ;
      enumerator_60164.gotoNextObject () ;
    }
    {
    var_constructorMap.modifier_insertKey (enumerator_59912.current_mConstructorName (HERE), var_arguments, GALGAS_bool (true), var_returnedTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1429)) ;
    }
    enumerator_59912.gotoNextObject () ;
  }
  cEnumerator_externTypeReaderList enumerator_60630 (object->mAttribute_mExternTypeReaderList, kEnumeration_up) ;
  while (enumerator_60630.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60630.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1439)) ;
    }
    GALGAS_unifiedTypeMapProxyAndParameterList var_arguments = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1441)) ;
    cEnumerator_typeNameFormalParameterNameList enumerator_60882 (enumerator_60630.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_60882.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60882.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1444)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_60882.current_mFormalParameterName (HERE) COMMA_SOURCE_FILE_AT_LINE (1445)) ;
      enumerator_60882.gotoNextObject () ;
    }
    {
    var_readerMap.modifier_insertKey (enumerator_60630.current_mReaderName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1450)), var_arguments, inCompiler->here (), GALGAS_bool (true), var_returnedTypeProxy, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1455)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1448)) ;
    }
    enumerator_60630.gotoNextObject () ;
  }
  cEnumerator_externTypeModifierList enumerator_61459 (object->mAttribute_mExternTypeModifierList, kEnumeration_up) ;
  while (enumerator_61459.hasCurrentObject ()) {
    GALGAS_formalParameterSignature var_routineSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1461)) ;
    cEnumerator_formalParameterListAST enumerator_61556 (enumerator_61459.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_61556.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61556.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1463)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_61556.current_mFormalArgumentPassingMode (HERE), enumerator_61556.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1468)) ;
      enumerator_61556.gotoNextObject () ;
    }
    {
    var_modifierMap.modifier_insertKey (enumerator_61459.current_mModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1473)), var_routineSignature, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1476)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1471)) ;
    }
    enumerator_61459.gotoNextObject () ;
  }
  cEnumerator_externTypeMethodList enumerator_62152 (object->mAttribute_mExternTypeMethodList, kEnumeration_up) ;
  while (enumerator_62152.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_62249 (enumerator_62152.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_62249.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_62249.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1485)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_62249.current_mFormalArgumentPassingMode (HERE), enumerator_62249.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1490)) ;
      enumerator_62249.gotoNextObject () ;
    }
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_62152.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1495)), var_routineSignature, enumerator_62152.current_mDeclarationLocation (HERE), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1499)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1493)) ;
    }
    enumerator_62152.gotoNextObject () ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mExternTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1507)), GALGAS_typeKindEnum::constructor_graphType (SOURCE_FILE_AT_LINE (1508)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1509)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1510)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1511)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1516)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1517)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1518)), GALGAS_uint ((uint32_t) 0U), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1520)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1521)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1522)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1523)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1524)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1525)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1527)), GALGAS_string ("default"), inCompiler COMMA_SOURCE_FILE_AT_LINE (1504)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeProxy COMMA_SOURCE_FILE_AT_LINE (1542)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstring"), var_lstringTypeProxy COMMA_SOURCE_FILE_AT_LINE (1545)) ;
  }
  GALGAS_unifiedTypeMapProxy var_graphTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mGraphTypeName, var_graphTypeProxy COMMA_SOURCE_FILE_AT_LINE (1548)) ;
  }
  GALGAS_unifiedTypeMapProxy var_associatedListTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedListTypeName, var_associatedListTypeProxy COMMA_SOURCE_FILE_AT_LINE (1551)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringListTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstringlist"), var_lstringListTypeProxy COMMA_SOURCE_FILE_AT_LINE (1554)) ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1556)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1557)) ;
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1558)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1559)) ;
  GALGAS_classMethodMap var_classMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1560)) ;
  GALGAS_formalParameterSignature var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1562)) ;
  var_formalParameterList.addAssign_operation (var_associatedListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1563)), GALGAS_string ("outSortedInformationList") COMMA_SOURCE_FILE_AT_LINE (1563)) ;
  var_formalParameterList.addAssign_operation (var_lstringListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1564)), GALGAS_string ("outSortedLKeyList") COMMA_SOURCE_FILE_AT_LINE (1564)) ;
  var_formalParameterList.addAssign_operation (var_associatedListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1565)), GALGAS_string ("outUnsortedInformationList") COMMA_SOURCE_FILE_AT_LINE (1565)) ;
  var_formalParameterList.addAssign_operation (var_lstringListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1566)), GALGAS_string ("outUnsortedLKeyList") COMMA_SOURCE_FILE_AT_LINE (1566)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("topologicalSort"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1568)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1569)), var_formalParameterList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1573)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1567)) ;
  }
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("depthFirstTopologicalSort"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1577)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1578)), var_formalParameterList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1582)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1576)) ;
  }
  var_formalParameterList.drop () ; // drop instruction
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1587)) ;
  var_formalParameterList.addAssign_operation (var_associatedListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1588)), GALGAS_string ("outInformationList") COMMA_SOURCE_FILE_AT_LINE (1588)) ;
  var_formalParameterList.addAssign_operation (var_lstringListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1589)), GALGAS_string ("outLKeyList") COMMA_SOURCE_FILE_AT_LINE (1589)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("nodesWithNoSuccessor"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1591)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1592)), var_formalParameterList, inCompiler->here (), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1596)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1590)) ;
  }
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("nodesWithNoPredecessor"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1600)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1601)), var_formalParameterList, inCompiler->here (), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1605)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1599)) ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
  routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("reversedGraph"), object->mAttribute_mGraphTypeName.mAttribute_string, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1610)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("undefinedNodeCount"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1618)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("undefinedNodeKeyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1626)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("undefinedNodeReferenceList"), GALGAS_string ("lstringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1634)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("graphviz"), GALGAS_string ("string"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1642)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1650)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("edges"), GALGAS_string ("2stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1658)) ;
  }
  {
  routine_enterBaseReaderWith_32_Arguments (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("subgraphFromNodes"), GALGAS_string ("lstringlist"), GALGAS_string ("inStartNodeLStringList"), GALGAS_string ("stringset"), GALGAS_string ("inNodesToExclude"), object->mAttribute_mGraphTypeName.mAttribute_string, GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1666)) ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("emptyGraph"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1679)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1680)), GALGAS_bool (false), var_graphTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1678)) ;
  }
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1685)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1686)), GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (1686)) ;
  cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_69490 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE_AT_LINE (1687)), kEnumeration_up) ;
  while (enumerator_69490.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (enumerator_69490.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1688)), enumerator_69490.current_mFormalParameterName (HERE) COMMA_SOURCE_FILE_AT_LINE (1688)) ;
    enumerator_69490.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_69641 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_69641.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_69641.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1693)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1696)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1691)) ;
    }
    enumerator_69641.gotoNextObject () ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("removeEdgesToDominators"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1703)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1704)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1705)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1707)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1702)) ;
  }
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1711)) ;
  var_formalParameterList.addAssign_operation (var_stringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1712)), GALGAS_string ("inNodeName") COMMA_SOURCE_FILE_AT_LINE (1712)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("removeEdgesToNode"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1714)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1715)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1718)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1713)) ;
  }
  var_formalParameterList.drop () ; // drop instruction
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1723)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1724)), GALGAS_string ("inSourceNodeLKey") COMMA_SOURCE_FILE_AT_LINE (1724)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1725)), GALGAS_string ("inTargetNodeLKey") COMMA_SOURCE_FILE_AT_LINE (1725)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("addEdge"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1727)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1728)), var_formalParameterList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1731)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1726)) ;
  }
  var_formalParameterList.drop () ; // drop instruction
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1736)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1737)), GALGAS_string ("inNodeLKey") COMMA_SOURCE_FILE_AT_LINE (1737)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("noteNode"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1739)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1740)), var_formalParameterList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1743)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1738)) ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mGraphTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1748)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mGraphTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1762)), GALGAS_typeKindEnum::constructor_graphType (SOURCE_FILE_AT_LINE (1763)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1764)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1765)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1766)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1771)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1772)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1773)), function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (1774)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1775)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1776)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1777)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1778)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1779)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1780)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1782)), GALGAS_string ("emptyGraph"), inCompiler COMMA_SOURCE_FILE_AT_LINE (1759)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_enumDeclarationAST * object = (const cPtr_enumDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_enumDeclarationAST) ;
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1797)) ;
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1798)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1799)) ;
  GALGAS_classMethodMap var_classMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1800)) ;
  GALGAS_unifiedTypeMapProxy var_currentTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumTypeName, var_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1803)) ;
  }
  GALGAS_stringset var_constantSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1805)) ;
  cEnumerator_lstringlist enumerator_73816 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_73816.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_73816.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1807)) COMMA_SOURCE_FILE_AT_LINE (1807)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_73816.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1808)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1808)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1808)) ;
    }
    enumerator_73816.gotoNextObject () ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1812)) ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mEnumTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1814)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mEnumTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1828)), GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE_AT_LINE (1829)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1830)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1831)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1832)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1837)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1838)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1839)), function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (1840)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1840)) COMMA_SOURCE_FILE_AT_LINE (1840)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1841)), var_constantSet, object->mAttribute_mConstantList, GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1844)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1845)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1846)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1848)), object->mAttribute_mConstantList.reader_mValueAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1849)).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1825)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_filewrapperDeclarationAST * object = (const cPtr_filewrapperDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_filewrapperDeclarationAST) ;
  GALGAS_filewrapperTemplateMap var_filewrapperTemplateMap = GALGAS_filewrapperTemplateMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1934)) ;
  cEnumerator_filewrapperTemplateListAST enumerator_78421 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_78421.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxyList var_templateSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1936)) ;
    cEnumerator_formalTemplateInputParameterListAST enumerator_78539 (enumerator_78421.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_78539.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_78539.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1939)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1940)) ;
      enumerator_78539.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_78421.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_78421.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1942)) ;
    }
    enumerator_78421.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_textExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1949)) ;
  cEnumerator_lstringlist enumerator_79058 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_79058.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_79058.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1951)) ;
    }
    enumerator_79058.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_binaryFileExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1954)) ;
  cEnumerator_lstringlist enumerator_79264 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_79264.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_79264.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1956)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_79264.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_79264.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1957)) COMMA_SOURCE_FILE_AT_LINE (1957)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1957)) COMMA_SOURCE_FILE_AT_LINE (1957)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_79264.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1959)) ;
      }
    }
    enumerator_79264.gotoNextObject () ;
  }
  ...
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1966)).reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1966)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
  if (kBoolTrue == test_2) {
    var_absoluteSourcePath = object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1967)) ;
  }else if (kBoolFalse == test_2) {
    var_absoluteSourcePath = object->mAttribute_mSourceFileAbsolutePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (1969)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1969)).operator_concat (object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1969)) COMMA_SOURCE_FILE_AT_LINE (1969)) ;
  }
  const enumGalgasBool test_3 = var_absoluteSourcePath.reader_directoryExists (SOURCE_FILE_AT_LINE (1971)).operator_not (SOURCE_FILE_AT_LINE (1971)).boolEnum () ;
  if (kBoolTrue == test_3) {
    GALGAS_location location_4 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_4, GALGAS_string ("The '").operator_concat (var_absoluteSourcePath COMMA_SOURCE_FILE_AT_LINE (1972)).operator_concat (GALGAS_string ("' directory does not exist") COMMA_SOURCE_FILE_AT_LINE (1972)) COMMA_SOURCE_FILE_AT_LINE (1972)) ;
    ...
    {
    routine_recursivelyEnumerateDirectories (var_absoluteSourcePath, GALGAS_string ("/"), var_textExtensionMap, var_binaryFileExtensionMap, var_regularRootFileMap, var_wrapperDirectoryMap, var_wrapperFileIndex, var_wrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1978)) ;
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFilewrapperMap.modifier_insertKey (object->mAttribute_mFilewrapperName, object->mAttribute_mFilewrapperPath, object->mAttribute_mFilewrapperTextFileExtensionList, var_regularRootFileMap, var_wrapperDirectoryMap, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1990)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listDeclarationAST) ;
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2009)) ;
  cEnumerator_attributeInCollectionListAST enumerator_81214 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_81214.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_81214.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2012)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_81458 (enumerator_81214.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_81458.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_81458.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_81458.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_81458.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_81214.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2022)) ;
    enumerator_81214.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2026)) ;
  }
  GALGAS_unifiedTypeMapProxy var_listTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListTypeName, var_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (2029)) ;
  }
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2031)) ;
  GALGAS_unifiedTypeMapProxyAndParameterList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2032)) ;
  GALGAS_formalParameterSignature var_modifierOutputFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2033)) ;
  GALGAS_formalParameterSignature var_modifierInputFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2034)) ;
  cEnumerator_typedAttributeList enumerator_82402 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_82402.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_82402.current_mAttributeTypeProxy (HERE), enumerator_82402.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2036)) COMMA_SOURCE_FILE_AT_LINE (2036)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_82402.current_mAttributeTypeProxy (HERE), enumerator_82402.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2037)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_82402.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2038)), enumerator_82402.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2038)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_82402.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2039)), enumerator_82402.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2039)) ;
    enumerator_82402.gotoNextObject () ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2042)) ;
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyList"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2043)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2043)) ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("listWithValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2045)), var_constructorAttributeTypeList, GALGAS_bool (false), var_listTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2044)) ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2051)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("length"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2052)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("range"), GALGAS_string ("range"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2053)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("subListFromIndex"), GALGAS_string ("uint"), GALGAS_string ("inIndex"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2054)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2054)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("subListWithRange"), GALGAS_string ("range"), GALGAS_string ("inRange"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2055)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2055)) ;
  }
  cEnumerator_typedAttributeList enumerator_83811 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_83811.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_83811.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_83811.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2059)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2059)), enumerator_83811.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2059)) COMMA_SOURCE_FILE_AT_LINE (2059)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2060)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_listWithValue (var_uintType, GALGAS_string ("inIndex") COMMA_SOURCE_FILE_AT_LINE (2061)), inCompiler->here (), GALGAS_bool (true), enumerator_83811.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2065)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2058)) ;
      }
    }
    enumerator_83811.gotoNextObject () ;
  }
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2071)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("first"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2073)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2074)), var_modifierOutputFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2078)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2072)) ;
  }
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("last"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2082)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2083)), var_modifierOutputFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2087)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2081)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2091)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popFirst"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2093)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2094)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2097)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2092)) ;
  }
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popLast"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2101)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2102)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2105)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2100)) ;
  }
  var_modifierOutputFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2108)), GALGAS_string ("inIndex") COMMA_SOURCE_FILE_AT_LINE (2108)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("removeAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2110)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2111)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2114)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2109)) ;
  }
  var_modifierOutputFormalArgumentList.drop () ; // drop instruction
  cEnumerator_typedAttributeList enumerator_85635 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_85635.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_85635.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_formalParameterSignature var_setterFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2120)) ;
      var_setterFormalArgumentList.addAssign_operation (enumerator_85635.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2121)), enumerator_85635.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2121)) ;
      var_setterFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2122)), enumerator_85635.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2122)) ;
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_85635.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2124)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2124)) COMMA_SOURCE_FILE_AT_LINE (2124)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2124)), enumerator_85635.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2124)) COMMA_SOURCE_FILE_AT_LINE (2124)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2125)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2128)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2123)) ;
      }
    }
    enumerator_85635.gotoNextObject () ;
  }
  var_modifierInputFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2134)), GALGAS_string ("inInsertionIndex") COMMA_SOURCE_FILE_AT_LINE (2134)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("insertAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2136)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2137)), var_modifierInputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2140)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2135)) ;
  }
  var_modifierInputFormalArgumentList.drop () ; // drop instruction
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2145)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2146)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2147)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mListTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2149)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2162)) COMMA_SOURCE_FILE_AT_LINE (2162)), object->mAttribute_mListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2162)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2160)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2169)), GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (2170)), var_typedAttributeList, GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2172)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2173)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2178)), var_enumerationDescriptor, var_enumerationVariants, function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2181)).operator_or (function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2181)) COMMA_SOURCE_FILE_AT_LINE (2181)).operator_or (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2181)) COMMA_SOURCE_FILE_AT_LINE (2181)).operator_or (function_addAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2181)) COMMA_SOURCE_FILE_AT_LINE (2181)).operator_or (function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2181)) COMMA_SOURCE_FILE_AT_LINE (2181)), var_constructorAttributeTypeList, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2183)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2184)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2185)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2186)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2187)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptyList"), inCompiler COMMA_SOURCE_FILE_AT_LINE (2166)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2204)) ;
  }
  GALGAS_unifiedTypeMapProxy var_listTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mSortedListTypeName, var_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (2207)) ;
  }
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2209)) ;
  GALGAS_unifiedTypeMapProxyAndParameterList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2210)) ;
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2211)) ;
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2212)) ;
  cEnumerator_attributeInCollectionListAST enumerator_89481 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_89481.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_89481.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2215)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_89481.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2218)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_89481.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2219)) ;
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_89481.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2220)) ;
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2221)), enumerator_89481.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2221)) ;
    enumerator_89481.gotoNextObject () ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2224)) ;
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptySortedList"), object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2225)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2225)) ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("sortedListWithValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2227)), var_constructorAttributeTypeList, GALGAS_bool (false), var_listTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2226)) ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2233)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("length"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2234)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2236)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popGreatest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2238)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2239)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2242)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2237)) ;
  }
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popSmallest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2246)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2247)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2250)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2245)) ;
  }
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2254)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("greatest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2256)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2257)), var_modifierFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2261)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2255)) ;
  }
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("smallest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2265)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2266)), var_modifierFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2270)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2264)) ;
  }
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2274)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2275)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2276)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mSortedListTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2278)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mSortedListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2292)) COMMA_SOURCE_FILE_AT_LINE (2292)), object->mAttribute_mSortedListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2292)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2290)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mSortedListTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2299)), GALGAS_typeKindEnum::constructor_sortedListType (SOURCE_FILE_AT_LINE (2300)), var_typedAttributeList, GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2302)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2303)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2308)), var_enumerationDescriptor, var_enumerationVariants, function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2311)).operator_or (function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2311)) COMMA_SOURCE_FILE_AT_LINE (2311)).operator_or (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2311)) COMMA_SOURCE_FILE_AT_LINE (2311)), var_constructorAttributeTypeList, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2313)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2314)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2315)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2316)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2317)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptySortedList"), inCompiler COMMA_SOURCE_FILE_AT_LINE (2296)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mStructTypeName, var_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (2334)) ;
  }
  GALGAS_attributeMap var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2336)) ;
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2337)) ;
  GALGAS_unifiedTypeMapProxyAndParameterList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2338)) ;
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2339)) ;
  ...
  while (enumerator_94136.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_94136.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2342)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_94136.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2343)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_94136.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2346)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_94136.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2347)) ;
    }
    enumerator_94136.gotoNextObject () ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2350)), var_constructorAttributeTypeList, GALGAS_bool (false), var_structTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2349)) ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2357)) ;
  }
  cEnumerator_typedAttributeList enumerator_94882 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_94882.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_94882.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2364)), enumerator_94882.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2365)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2361)) ;
    }
    enumerator_94882.gotoNextObject () ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2371)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2373)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mStructTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2375)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    var_enumeratedType = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2388)) ;
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumeratedElementTypeName, var_enumeratedType COMMA_SOURCE_FILE_AT_LINE (2390)) ;
    }
  }
  GALGAS_string var_defaultConstructorName = GALGAS_string ("default") ;
  cEnumerator_typedAttributeList enumerator_96064 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_96064.hasCurrentObject () && bool_1) {
    while (enumerator_96064.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_96064.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2399)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_96064.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2399)).operator_not (SOURCE_FILE_AT_LINE (2399)) COMMA_SOURCE_FILE_AT_LINE (2399)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_96064.gotoNextObject () ;
      if (enumerator_96064.hasCurrentObject ()) {
        bool_1 = GALGAS_bool (kIsNotEqual, var_defaultConstructorName.objectCompare (GALGAS_string::makeEmptyString ())).isValidAndTrue () ;
      }
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mStructTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2407)), GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (2408)), var_typedAttributeList, var_attributeMap, var_typedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2416)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2417)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2418)), function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (2419)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2420)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2421)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2422)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2423)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2424)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2425)), GALGAS_bool (false), var_enumeratedType, var_defaultConstructorName, inCompiler COMMA_SOURCE_FILE_AT_LINE (2404)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2441)) ;
  }
  GALGAS_readerMap var_readerMap ;
  GALGAS_modifierMap var_modifierMap ;
  GALGAS_instanceMethodMap var_instanceMethodMap ;
  GALGAS_typedAttributeList var_inheritedTypedAttributeList ;
  GALGAS_attributeMap var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2447)) ;
  GALGAS_unifiedTypeMapProxy var_superClassIndex ;
  GALGAS_bool var_generateHeaderInSeparateFile ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2451)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_superClassIndex = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2452)) ;
    {
    routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2453)) ;
    }
    var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2454)) ;
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2455)) ;
    var_inheritedTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2456)) ;
    var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2457)) ;
    var_generateHeaderInSeparateFile = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_98476 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_98476.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_98476.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2460)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_98476.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mSuperClassName, var_superClassIndex COMMA_SOURCE_FILE_AT_LINE (2465)) ;
    }
    GALGAS_typeKindEnum var_typeKindEnum ;
    ...
    GALGAS_bool joker_98955_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_98955_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_99040_2 ; // Joker input parameter
    GALGAS_constructorMap joker_99040_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_99130_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_99130_9 ; // Joker input parameter
    GALGAS_stringlist joker_99130_8 ; // Joker input parameter
    GALGAS_uint joker_99130_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_99130_6 ; // Joker input parameter
    GALGAS_stringset joker_99130_5 ; // Joker input parameter
    GALGAS_lstringlist joker_99130_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_99130_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_99130_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_99130_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_99177_2 ; // Joker input parameter
    GALGAS_string joker_99177_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_98955_2, joker_98955_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_99040_2, joker_99040_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_99130_10, joker_99130_9, joker_99130_8, joker_99130_7, joker_99130_6, joker_99130_5, joker_99130_4, joker_99130_3, joker_99130_2, joker_99130_1, var_generateHeaderInSeparateFile, joker_99177_2, joker_99177_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2470)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2485)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (object->mAttribute_mSuperClassName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the @").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2486)) COMMA_SOURCE_FILE_AT_LINE (2486)).operator_concat (GALGAS_string (" should be a class type") COMMA_SOURCE_FILE_AT_LINE (2486)) COMMA_SOURCE_FILE_AT_LINE (2486)) ;
    }
    var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2489)) ;
    cEnumerator_modifierMap enumerator_99464 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_99464.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_99464.current_lkey (HERE), enumerator_99464.current_mKind (HERE), enumerator_99464.current_mParameterList (HERE), enumerator_99464.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2496)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2491)) ;
      }
      enumerator_99464.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2501)) ;
    cEnumerator_readerMap enumerator_99790 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_99790.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_99790.current_lkey (HERE), enumerator_99790.current_mKind (HERE), enumerator_99790.current_mArgumentTypeList (HERE), enumerator_99790.current_mDeclarationLocation (HERE), enumerator_99790.current_mHasCompilerArgument (HERE), enumerator_99790.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2510)), enumerator_99790.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2503)) ;
      }
      enumerator_99790.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2515)) ;
    cEnumerator_instanceMethodMap enumerator_100178 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_100178.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_100178.current_lkey (HERE), enumerator_100178.current_mKind (HERE), enumerator_100178.current_mParameterList (HERE), enumerator_100178.current_mDeclarationLocation (HERE), enumerator_100178.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2523)), enumerator_100178.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2517)) ;
      }
      enumerator_100178.gotoNextObject () ;
    }
  }
  GALGAS_unifiedTypeMapProxyAndParameterList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2529)) ;
  cEnumerator_typedAttributeList enumerator_100609 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_100609.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_100609.current_mAttributeTypeProxy (HERE), enumerator_100609.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2531)) ;
    enumerator_100609.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_100736 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_100736.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_100736.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2535)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_100736.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2536)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_100736.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2537)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_100736.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2538)) COMMA_SOURCE_FILE_AT_LINE (2538)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_100736.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_100736.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2539)) COMMA_SOURCE_FILE_AT_LINE (2539)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader") COMMA_SOURCE_FILE_AT_LINE (2539)) COMMA_SOURCE_FILE_AT_LINE (2539)) ;
    }
    enumerator_100736.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_classIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mClassTypeName, var_classIndex COMMA_SOURCE_FILE_AT_LINE (2543)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2549)) ;
  const enumGalgasBool test_6 = object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (2550)).boolEnum () ;
  if (kBoolTrue == test_6) {
    {
    var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2552)), var_constructorAttributeTypeList, GALGAS_bool (false), var_classIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2551)) ;
    }
  }
  GALGAS_typedAttributeList var_currentClassTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2559)) ;
  GALGAS_typedAttributeList var_allTypedAttributeList = var_inheritedTypedAttributeList ;
  cEnumerator_attributeInCollectionListAST enumerator_101836 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_101836.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_101836.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2563)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_102080 (enumerator_101836.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_102080.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_102080.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2567)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_102080.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2569)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_102080.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_101836.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2573)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_101836.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2574)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_101836.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2578)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2579)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2583)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2576)) ;
      }
    }
    enumerator_101836.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_103148 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_103148.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_103148.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_103148.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2598)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2598)) COMMA_SOURCE_FILE_AT_LINE (2598)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2598)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2599)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_103148.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2600)), enumerator_103148.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2600)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2602)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2597)) ;
      }
    }
    enumerator_103148.gotoNextObject () ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mClassTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2608)) ;
  }
  GALGAS_string var_defaultConstructorName ;
  const enumGalgasBool test_11 = var_superClassIndex.reader_isNull (SOURCE_FILE_AT_LINE (2620)).boolEnum () ;
  if (kBoolTrue == test_11) {
    var_defaultConstructorName = GALGAS_string ("default") ;
  }else if (kBoolFalse == test_11) {
    var_defaultConstructorName = var_superClassIndex.reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2623)) ;
  }
  cEnumerator_typedAttributeList enumerator_104190 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_104190.hasCurrentObject () && bool_12) {
    while (enumerator_104190.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_104190.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2626)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_104190.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2626)).operator_not (SOURCE_FILE_AT_LINE (2626)) COMMA_SOURCE_FILE_AT_LINE (2626)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_104190.gotoNextObject () ;
      if (enumerator_104190.hasCurrentObject ()) {
        bool_12 = GALGAS_bool (kIsNotEqual, var_defaultConstructorName.objectCompare (GALGAS_string::makeEmptyString ())).isValidAndTrue () ;
      }
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mClassTypeName, object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (2633)), var_superClassIndex, GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2635)), var_allTypedAttributeList, var_attributeMap, var_currentClassTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2643)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2644)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2645)), GALGAS_uint ((uint32_t) 0U), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2647)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2648)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2649)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2650)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2651)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2652)), var_generateHeaderInSeparateFile, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2654)), var_defaultConstructorName, inCompiler COMMA_SOURCE_FILE_AT_LINE (2631)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externRoutineDeclarationAST * object = (const cPtr_externRoutineDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_externRoutineDeclarationAST) ;
  GALGAS_formalParameterSignature var_routineSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2668)) ;
  cEnumerator_formalParameterListAST enumerator_105853 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_105853.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_105853.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2671)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_105853.current_mFormalArgumentPassingMode (HERE), enumerator_105853.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2672)) ;
    enumerator_105853.gotoNextObject () ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mRoutineMap.modifier_insertKey (object->mAttribute_mRoutineName, var_routineSignature, inCompiler COMMA_SOURCE_FILE_AT_LINE (2675)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externFunctionDeclarationAST * object = (const cPtr_externFunctionDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_externFunctionDeclarationAST) ;
  GALGAS_unifiedTypeMapProxyList var_functionSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2687)) ;
  cEnumerator_formalInputParameterListAST enumerator_106861 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_106861.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_106861.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2690)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2691)) ;
    enumerator_106861.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName, var_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2695)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2697)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName, var_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2709)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2711)), var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2711)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayDeclarationAST) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2723)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mDimension.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the dimension of an array should be > 0") COMMA_SOURCE_FILE_AT_LINE (2724)) ;
  }
  GALGAS_unifiedTypeMapProxy var_arrayTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mArrayTypeName, var_arrayTypeIndex COMMA_SOURCE_FILE_AT_LINE (2728)) ;
  }
  GALGAS_unifiedTypeMapProxy var_elementTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mElementTypeName, var_elementTypeIndex COMMA_SOURCE_FILE_AT_LINE (2731)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2733)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2734)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2735)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2736)) ;
  GALGAS_unifiedTypeMapProxy var_boolType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("bool"), var_boolType COMMA_SOURCE_FILE_AT_LINE (2739)) ;
  }
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2742)) ;
  }
  GALGAS_unifiedTypeMapProxyAndParameterList var_uintArgs = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2744)) ;
  GALGAS_uint var_idx = GALGAS_uint ((uint32_t) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2746)).isValid ()) {
    uint32_t variant_109618 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2746)).uintValue () ;
    bool loop_109618 = true ;
    while (loop_109618) {
      loop_109618 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2746)))).isValid () ;
      if (loop_109618) {
        loop_109618 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2746)))).boolValue () ;
      }
      if (loop_109618 && (0 == variant_109618)) {
        loop_109618 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2746)) ;
      }
      if (loop_109618) {
        variant_109618 -- ;
        var_uintArgs.addAssign_operation (var_uintType, GALGAS_string ("inSize").operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (2747)) COMMA_SOURCE_FILE_AT_LINE (2747)) COMMA_SOURCE_FILE_AT_LINE (2747)) ;
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (2748)) ;
      }
    }
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2752)), var_uintArgs, GALGAS_bool (false), var_arrayTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2751)) ;
  }
  {
  routine_enterBaseReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("axisCount"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2758)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("sizeForAxis"), GALGAS_string ("uint"), GALGAS_string ("inAxisIndex"), GALGAS_string ("uint"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2759)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("rangeForAxis"), GALGAS_string ("uint"), GALGAS_string ("inAxisIndex"), GALGAS_string ("range"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2760)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("isValueValidAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2762)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2763)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_boolType, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2768)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2761)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("valueAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2772)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2773)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_elementTypeIndex, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2778)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2771)) ;
  }
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2782)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_elementTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2783)), GALGAS_string ("InValue") COMMA_SOURCE_FILE_AT_LINE (2783)) ;
  var_idx = GALGAS_uint ((uint32_t) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2785)).isValid ()) {
    uint32_t variant_110930 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2785)).uintValue () ;
    bool loop_110930 = true ;
    while (loop_110930) {
      loop_110930 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2785)))).isValid () ;
      if (loop_110930) {
        loop_110930 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2785)))).boolValue () ;
      }
      if (loop_110930 && (0 == variant_110930)) {
        loop_110930 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2785)) ;
      }
      if (loop_110930) {
        variant_110930 -- ;
        var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2786)), GALGAS_string ("inIndex").operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (2786)) COMMA_SOURCE_FILE_AT_LINE (2786)) COMMA_SOURCE_FILE_AT_LINE (2786)) ;
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (2787)) ;
      }
    }
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2790)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2791)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2794)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2789)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("forceValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2798)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2799)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2802)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2797)) ;
  }
  {
  GALGAS_unifiedTypeMapProxy joker_111545_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_111545_2 ; // Joker input parameter
  GALGAS_string joker_111545_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_111545_3, joker_111545_2, joker_111545_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2805)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("invalidateValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2807)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2808)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2811)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2806)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSize").reader_nowhere (SOURCE_FILE_AT_LINE (2815)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2816)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2819)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2814)) ;
  }
  var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2822)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2823)), GALGAS_string ("inSize") COMMA_SOURCE_FILE_AT_LINE (2823)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2824)), GALGAS_string ("inAxisIndex") COMMA_SOURCE_FILE_AT_LINE (2824)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSizeForAxis").reader_nowhere (SOURCE_FILE_AT_LINE (2826)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2827)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2830)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2825)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mArrayTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2837)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE_AT_LINE (2838)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2839)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2840)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2841)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2846)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2847)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2848)), GALGAS_uint ((uint32_t) 0U), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2850)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2851)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2852)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2853)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2854)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2855)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2857)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2834)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_113967_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_113967_1 ; // Joker input parameter
  GALGAS_attributeMap joker_114055_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_114055_18 ; // Joker input parameter
  GALGAS_constructorMap joker_114055_17 ; // Joker input parameter
  GALGAS_readerMap joker_114055_16 ; // Joker input parameter
  GALGAS_modifierMap joker_114055_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_114055_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_114055_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_114055_12 ; // Joker input parameter
  GALGAS_stringlist joker_114055_11 ; // Joker input parameter
  GALGAS_uint joker_114055_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_114055_9 ; // Joker input parameter
  GALGAS_stringset joker_114055_8 ; // Joker input parameter
  GALGAS_lstringlist joker_114055_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_114055_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_114055_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_114055_4 ; // Joker input parameter
  GALGAS_bool joker_114055_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_114055_2 ; // Joker input parameter
  GALGAS_string joker_114055_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_113967_2, joker_113967_1, var_typeKindEnum, var_listTypedAttributeList, joker_114055_19, joker_114055_18, joker_114055_17, joker_114055_16, joker_114055_15, joker_114055_14, joker_114055_13, joker_114055_12, joker_114055_11, joker_114055_10, joker_114055_9, joker_114055_8, joker_114055_7, joker_114055_6, joker_114055_5, joker_114055_4, joker_114055_3, joker_114055_2, joker_114055_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2872)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (2879)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2880)) COMMA_SOURCE_FILE_AT_LINE (2880)).operator_concat (GALGAS_string ("' type should be a list type") COMMA_SOURCE_FILE_AT_LINE (2880)) COMMA_SOURCE_FILE_AT_LINE (2880)) ;
    var_listTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2881)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2884)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2885)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2886)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2887)) ;
  GALGAS_unifiedTypeMapProxy var_associatedListTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedListTypeName, var_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (2890)) ;
  }
  GALGAS_unifiedTypeMapProxy var_currentTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListmapTypeName, var_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (2893)) ;
  }
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2896)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("count"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2898)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("allKeys"), GALGAS_string ("stringset"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2899)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2900)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("listForKey"), GALGAS_string ("string"), GALGAS_string ("inKey"), object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2901)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2901)) ;
  }
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyMap"), object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2903)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2903)) ;
  }
  GALGAS_enumerationDescriptorList var_enumeratorDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2905)) ;
  var_enumeratorDescriptor.addAssign_operation (var_stringTypeIndex, GALGAS_string ("key") COMMA_SOURCE_FILE_AT_LINE (2906)) ;
  var_enumeratorDescriptor.addAssign_operation (var_associatedListTypeIndex, GALGAS_string ("mList") COMMA_SOURCE_FILE_AT_LINE (2907)) ;
  GALGAS_unifiedTypeMapProxyAndParameterList var_addAssignOperatorDescription = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2909)) ;
  var_addAssignOperatorDescription.addAssign_operation (var_stringTypeIndex, GALGAS_string ("inKey") COMMA_SOURCE_FILE_AT_LINE (2910)) ;
  cEnumerator_typedAttributeList enumerator_116126 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_116126.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_116126.current_mAttributeTypeProxy (HERE), enumerator_116126.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2912)) ;
    enumerator_116126.gotoNextObject () ;
  }
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2915)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2916)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2917)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mListmapTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2919)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2933)) COMMA_SOURCE_FILE_AT_LINE (2933)), object->mAttribute_mListmapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2933)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2931)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListmapTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2940)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE_AT_LINE (2941)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2942)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2943)), var_listTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2949)), var_enumeratorDescriptor, var_enumerationVariants, function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2952)), var_addAssignOperatorDescription, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2954)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2955)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2956)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2957)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2958)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptyMap"), inCompiler COMMA_SOURCE_FILE_AT_LINE (2937)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_predefinedTypeAST * object = (const cPtr_predefinedTypeAST *) inObject ;
  macroValidSharedObject (object, cPtr_predefinedTypeAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mPredefinedTypeName COMMA_SOURCE_FILE_AT_LINE (2994)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2994)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_predefinedTypeAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2995)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_classDeclarationAST * object = (const cPtr_classDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_classDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (3007)) COMMA_SOURCE_FILE_AT_LINE (3007)), object->mAttribute_mClassTypeName.reader_location (SOURCE_FILE_AT_LINE (3007)) COMMA_SOURCE_FILE_AT_LINE (3007)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (3010)) COMMA_SOURCE_FILE_AT_LINE (3010)), object->mAttribute_mSuperClassName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3010)) COMMA_SOURCE_FILE_AT_LINE (3010)) ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_120387 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_120387.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_120387.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3013)) COMMA_SOURCE_FILE_AT_LINE (3013)), object->mAttribute_mSuperClassName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3013)) COMMA_SOURCE_FILE_AT_LINE (3013)) ;
    }
    enumerator_120387.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (3026)) COMMA_SOURCE_FILE_AT_LINE (3026)), object->mAttribute_mListTypeName.reader_location (SOURCE_FILE_AT_LINE (3026)) COMMA_SOURCE_FILE_AT_LINE (3026)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_listDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3027)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_121245 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121245.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121245.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3029)) COMMA_SOURCE_FILE_AT_LINE (3029)), enumerator_121245.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3029)) COMMA_SOURCE_FILE_AT_LINE (3029)) COMMA_SOURCE_FILE_AT_LINE (3029)) ;
    }
    enumerator_121245.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_structDeclarationAST * object = (const cPtr_structDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_structDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (3042)) COMMA_SOURCE_FILE_AT_LINE (3042)), object->mAttribute_mStructTypeName.reader_location (SOURCE_FILE_AT_LINE (3042)) COMMA_SOURCE_FILE_AT_LINE (3042)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_structDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3043)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_122109 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_122109.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_122109.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3045)) COMMA_SOURCE_FILE_AT_LINE (3045)), enumerator_122109.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3045)) COMMA_SOURCE_FILE_AT_LINE (3045)) COMMA_SOURCE_FILE_AT_LINE (3045)) ;
    }
    enumerator_122109.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_enumDeclarationAST * object = (const cPtr_enumDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_enumDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (3058)) COMMA_SOURCE_FILE_AT_LINE (3058)), object->mAttribute_mEnumTypeName.reader_location (SOURCE_FILE_AT_LINE (3058)) COMMA_SOURCE_FILE_AT_LINE (3058)) ;
  {
  //--- @selfCopyInExpressionForGeneration
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_sortedListDeclarationAST * object = (const cPtr_sortedListDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_sortedListDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (3071)) COMMA_SOURCE_FILE_AT_LINE (3071)), object->mAttribute_mSortedListTypeName.reader_location (SOURCE_FILE_AT_LINE (3071)) COMMA_SOURCE_FILE_AT_LINE (3071)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  cEnumerator_attributeInCollectionListAST enumerator_123681 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123681.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123681.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3074)) COMMA_SOURCE_FILE_AT_LINE (3074)), enumerator_123681.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3074)) COMMA_SOURCE_FILE_AT_LINE (3074)) COMMA_SOURCE_FILE_AT_LINE (3074)) ;
    }
    enumerator_123681.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mArrayTypeName.reader_string (SOURCE_FILE_AT_LINE (3087)) COMMA_SOURCE_FILE_AT_LINE (3087)), object->mAttribute_mArrayTypeName.reader_location (SOURCE_FILE_AT_LINE (3087)) COMMA_SOURCE_FILE_AT_LINE (3087)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_arrayDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3088)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mElementTypeName.reader_string (SOURCE_FILE_AT_LINE (3089)) COMMA_SOURCE_FILE_AT_LINE (3089)), object->mAttribute_mElementTypeName.reader_location (SOURCE_FILE_AT_LINE (3089)) COMMA_SOURCE_FILE_AT_LINE (3089)) COMMA_SOURCE_FILE_AT_LINE (3089)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listmapDeclarationAST * object = (const cPtr_listmapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listmapDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (3101)) COMMA_SOURCE_FILE_AT_LINE (3101)), object->mAttribute_mListmapTypeName.reader_location (SOURCE_FILE_AT_LINE (3101)) COMMA_SOURCE_FILE_AT_LINE (3101)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (3103)) COMMA_SOURCE_FILE_AT_LINE (3103)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (3103)) COMMA_SOURCE_FILE_AT_LINE (3103)) COMMA_SOURCE_FILE_AT_LINE (3103)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapDeclarationAST * object = (const cPtr_mapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_mapDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (3115)) COMMA_SOURCE_FILE_AT_LINE (3115)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (3115)) COMMA_SOURCE_FILE_AT_LINE (3115)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_mapDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3116)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_126186 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126186.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126186.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3118)) COMMA_SOURCE_FILE_AT_LINE (3118)), enumerator_126186.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3118)) COMMA_SOURCE_FILE_AT_LINE (3118)) COMMA_SOURCE_FILE_AT_LINE (3118)) ;
    }
    enumerator_126186.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_uniqueMapDeclarationAST * object = (const cPtr_uniqueMapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_uniqueMapDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (3131)) COMMA_SOURCE_FILE_AT_LINE (3131)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (3131)) COMMA_SOURCE_FILE_AT_LINE (3131)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_uniqueMapDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3132)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_127047 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_127047.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_127047.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3134)) COMMA_SOURCE_FILE_AT_LINE (3134)), enumerator_127047.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3134)) COMMA_SOURCE_FILE_AT_LINE (3134)) COMMA_SOURCE_FILE_AT_LINE (3134)) ;
    }
    enumerator_127047.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapProxyDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapProxyDeclarationAST * object = (const cPtr_mapProxyDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_mapProxyDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE_AT_LINE (3147)) COMMA_SOURCE_FILE_AT_LINE (3147)), object->mAttribute_mMapProxyTypeName.reader_location (SOURCE_FILE_AT_LINE (3147)) COMMA_SOURCE_FILE_AT_LINE (3147)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedMapTypeName.reader_string (SOURCE_FILE_AT_LINE (3149)) COMMA_SOURCE_FILE_AT_LINE (3149)), object->mAttribute_mAssociatedMapTypeName.reader_location (SOURCE_FILE_AT_LINE (3149)) COMMA_SOURCE_FILE_AT_LINE (3149)) COMMA_SOURCE_FILE_AT_LINE (3149)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_graphDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_graphDeclarationAST * object = (const cPtr_graphDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_graphDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mGraphTypeName.reader_string (SOURCE_FILE_AT_LINE (3161)) COMMA_SOURCE_FILE_AT_LINE (3161)), object->mAttribute_mGraphTypeName.reader_location (SOURCE_FILE_AT_LINE (3161)) COMMA_SOURCE_FILE_AT_LINE (3161)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (3163)) COMMA_SOURCE_FILE_AT_LINE (3163)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (3163)) COMMA_SOURCE_FILE_AT_LINE (3163)) COMMA_SOURCE_FILE_AT_LINE (3163)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externTypeDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externTypeDeclarationAST * object = (const cPtr_externTypeDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_externTypeDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mExternTypeName.reader_string (SOURCE_FILE_AT_LINE (3175)) COMMA_SOURCE_FILE_AT_LINE (3175)), object->mAttribute_mExternTypeName.reader_location (SOURCE_FILE_AT_LINE (3175)) COMMA_SOURCE_FILE_AT_LINE (3175)) ;
  {
  //--- @selfCopyInExpressionForGeneration
...
static void categoryMethod_externFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3188)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3200)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3212)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3224)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3236)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3248)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3260)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3272)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3284)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryReaderAST * object = (const cPtr_categoryReaderAST *) inObject ;
  macroValidSharedObject (object, cPtr_categoryReaderAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3296)) COMMA_SOURCE_FILE_AT_LINE (3296)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3296)).operator_concat (object->mAttribute_mCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (3296)) COMMA_SOURCE_FILE_AT_LINE (3296)), object->mAttribute_mCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (3296)) COMMA_SOURCE_FILE_AT_LINE (3296)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryReaderAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3297)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3298)) COMMA_SOURCE_FILE_AT_LINE (3298)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3298)) COMMA_SOURCE_FILE_AT_LINE (3298)) COMMA_SOURCE_FILE_AT_LINE (3298)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3300)) COMMA_SOURCE_FILE_AT_LINE (3300)).operator_not (SOURCE_FILE_AT_LINE (3300)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3303)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3301)) ;
    }
  }
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_136144 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3306)) ;
  if (NULL != objectArray_136144) {
      macroValidSharedObject (objectArray_136144, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_136144->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3307)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryMethodAST * object = (const cPtr_categoryMethodAST *) inObject ;
  macroValidSharedObject (object, cPtr_categoryMethodAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3324)) COMMA_SOURCE_FILE_AT_LINE (3324)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3324)).operator_concat (object->mAttribute_mCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (3324)) COMMA_SOURCE_FILE_AT_LINE (3324)), object->mAttribute_mCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (3324)) COMMA_SOURCE_FILE_AT_LINE (3324)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryMethodAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3325)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3326)) COMMA_SOURCE_FILE_AT_LINE (3326)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3326)) COMMA_SOURCE_FILE_AT_LINE (3326)) COMMA_SOURCE_FILE_AT_LINE (3326)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3328)) COMMA_SOURCE_FILE_AT_LINE (3328)).operator_not (SOURCE_FILE_AT_LINE (3328)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3331)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3329)) ;
    }
  }
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_137449 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3334)) ;
  if (NULL != objectArray_137449) {
      macroValidSharedObject (objectArray_137449, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_137449->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3335)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryModifierAST * object = (const cPtr_categoryModifierAST *) inObject ;
  macroValidSharedObject (object, cPtr_categoryModifierAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3351)) COMMA_SOURCE_FILE_AT_LINE (3351)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3351)).operator_concat (object->mAttribute_mCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (3351)) COMMA_SOURCE_FILE_AT_LINE (3351)), object->mAttribute_mCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (3351)) COMMA_SOURCE_FILE_AT_LINE (3351)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryModifierAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3352)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3353)) COMMA_SOURCE_FILE_AT_LINE (3353)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3353)) COMMA_SOURCE_FILE_AT_LINE (3353)) COMMA_SOURCE_FILE_AT_LINE (3353)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3355)) COMMA_SOURCE_FILE_AT_LINE (3355)).operator_not (SOURCE_FILE_AT_LINE (3355)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3358)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3356)) ;
    }
  }
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_138724 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3361)) ;
  if (NULL != objectArray_138724) {
      macroValidSharedObject (objectArray_138724, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_138724->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3362)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3378)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryReaderAST * object = (const cPtr_abstractCategoryReaderAST *) inObject ;
  macroValidSharedObject (object, cPtr_abstractCategoryReaderAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3390)) COMMA_SOURCE_FILE_AT_LINE (3390)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3390)).operator_concat (object->mAttribute_mAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (3390)) COMMA_SOURCE_FILE_AT_LINE (3390)), object->mAttribute_mAbstractCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (3390)) COMMA_SOURCE_FILE_AT_LINE (3390)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_abstractCategoryReaderAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3391)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3392)) COMMA_SOURCE_FILE_AT_LINE (3392)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3392)) COMMA_SOURCE_FILE_AT_LINE (3392)) COMMA_SOURCE_FILE_AT_LINE (3392)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3394)) COMMA_SOURCE_FILE_AT_LINE (3394)).operator_not (SOURCE_FILE_AT_LINE (3394)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3397)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3395)) ;
    }
  }
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_140628 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3400)) ;
  if (NULL != objectArray_140628) {
      macroValidSharedObject (objectArray_140628, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_140628->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3401)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryMethodAST * object = (const cPtr_abstractCategoryMethodAST *) inObject ;
  macroValidSharedObject (object, cPtr_abstractCategoryMethodAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3418)) COMMA_SOURCE_FILE_AT_LINE (3418)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3418)).operator_concat (object->mAttribute_mAbstractCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (3418)) COMMA_SOURCE_FILE_AT_LINE (3418)), object->mAttribute_mAbstractCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (3418)) COMMA_SOURCE_FILE_AT_LINE (3418)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_abstractCategoryMethodAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3419)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3420)) COMMA_SOURCE_FILE_AT_LINE (3420)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3420)) COMMA_SOURCE_FILE_AT_LINE (3420)) COMMA_SOURCE_FILE_AT_LINE (3420)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3422)) COMMA_SOURCE_FILE_AT_LINE (3422)).operator_not (SOURCE_FILE_AT_LINE (3422)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3425)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3423)) ;
    }
  }
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_141981 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3428)) ;
  if (NULL != objectArray_141981) {
      macroValidSharedObject (objectArray_141981, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_141981->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3429)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryModifierAST * object = (const cPtr_abstractCategoryModifierAST *) inObject ;
  macroValidSharedObject (object, cPtr_abstractCategoryModifierAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3445)) COMMA_SOURCE_FILE_AT_LINE (3445)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3445)).operator_concat (object->mAttribute_mAbstractCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (3445)) COMMA_SOURCE_FILE_AT_LINE (3445)), object->mAttribute_mAbstractCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (3445)) COMMA_SOURCE_FILE_AT_LINE (3445)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_abstractCategoryModifierAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3446)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3447)) COMMA_SOURCE_FILE_AT_LINE (3447)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3447)) COMMA_SOURCE_FILE_AT_LINE (3447)) COMMA_SOURCE_FILE_AT_LINE (3447)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3449)) COMMA_SOURCE_FILE_AT_LINE (3449)).operator_not (SOURCE_FILE_AT_LINE (3449)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3452)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3450)) ;
    }
  }
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_143296 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3455)) ;
  if (NULL != objectArray_143296) {
      macroValidSharedObject (objectArray_143296, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_143296->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3456)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapDeclarationAST * object = (const cPtr_mapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_mapDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3475)) ;
  var_structAttributeList.addAssign_operation (GALGAS_string ("lstring").reader_nowhere (SOURCE_FILE_AT_LINE (3477)), GALGAS_string ("lkey").reader_nowhere (SOURCE_FILE_AT_LINE (3478)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3479)) COMMA_SOURCE_FILE_AT_LINE (3476)) ;
  cEnumerator_attributeInCollectionListAST enumerator_144135 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_144135.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_144135.current_mAttributeTypeName (HERE), enumerator_144135.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3485)) COMMA_SOURCE_FILE_AT_LINE (3482)) ;
    enumerator_144135.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mMapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3490)) COMMA_SOURCE_FILE_AT_LINE (3490)), object->mAttribute_mMapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3490)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3488)) COMMA_SOURCE_FILE_AT_LINE (3488)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3501)) ;
  cEnumerator_attributeInCollectionListAST enumerator_144778 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_144778.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_144778.current_mAttributeTypeName (HERE), enumerator_144778.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3506)) COMMA_SOURCE_FILE_AT_LINE (3503)) ;
    enumerator_144778.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3511)) COMMA_SOURCE_FILE_AT_LINE (3511)), object->mAttribute_mListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3511)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3509)) COMMA_SOURCE_FILE_AT_LINE (3509)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_sortedListDeclarationAST * object = (const cPtr_sortedListDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_sortedListDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3522)) ;
  cEnumerator_attributeInCollectionListAST enumerator_145429 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145429.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145429.current_mAttributeTypeName (HERE), enumerator_145429.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3527)) COMMA_SOURCE_FILE_AT_LINE (3524)) ;
    enumerator_145429.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mSortedListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3532)) COMMA_SOURCE_FILE_AT_LINE (3532)), object->mAttribute_mSortedListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3532)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3530)) COMMA_SOURCE_FILE_AT_LINE (3530)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listmapDeclarationAST * object = (const cPtr_listmapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listmapDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3543)) ;
  var_structAttributeList.addAssign_operation (GALGAS_string ("string").reader_nowhere (SOURCE_FILE_AT_LINE (3545)), GALGAS_string ("key").reader_nowhere (SOURCE_FILE_AT_LINE (3546)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3547)) COMMA_SOURCE_FILE_AT_LINE (3544)) ;
  var_structAttributeList.addAssign_operation (object->mAttribute_mAssociatedListTypeName, GALGAS_string ("mList").reader_nowhere (SOURCE_FILE_AT_LINE (3551)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3552)) COMMA_SOURCE_FILE_AT_LINE (3549)) ;
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3557)) COMMA_SOURCE_FILE_AT_LINE (3557)), object->mAttribute_mListmapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3557)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3555)) COMMA_SOURCE_FILE_AT_LINE (3555)) ;
}
//-----------------------------------------------------------------------------*
