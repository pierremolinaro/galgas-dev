...
//                    november 13th, 2010, at 16h25'41"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__predefinedTypeAST__enterInSemanticContext (C_CompilerEx & inLexique,
  ...
  if (operand_32151 != NULL) {
    ...
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_32151->mPredefinedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (780)), GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (782)), GGS_typeKindEnum::constructor_predefinedType (inLexique COMMA_SOURCE_FILE_AT_LINE (783)), GGS_typedAttributeList ::constructor_listWithValue (var_cas_selfTypeProxy, GGS_lstring ::constructor_new (inLexique, operand_32151->mPredefinedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (784)), GGS_bool (true), GGS_bool (true)), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (785)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, var_cas_classMethodMap, var_cas_enumerationList, (findCategoryReader__predefinedTypeAST__getSupportedOperatorFlags (var_cas_t (HERE)->galgasRTTI ()) (inLexique, var_cas_t.getPtr () COMMA_SOURCE_FILE_AT_LINE (793))), var_cas_addAssignArgumentList, (findCategoryReader__predefinedTypeAST__getNativeAttributeList (var_cas_t (HERE)->galgasRTTI ()) (inLexique, var_cas_t.getPtr () COMMA_SOURCE_FILE_AT_LINE (795))), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (801)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (779)) ;
  }
}
...
category_method__mapDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_mapDeclarationAST * operand_34398,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_34398 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (815)) ;
    GGS_unifiedTypeMapProxy  var_cas_locationTypeProxy ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("location"), var_cas_locationTypeProxy COMMA_SOURCE_FILE_AT_LINE (818)) ;
    GGS_unifiedTypeMapProxy  var_cas_lstringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("lstring"), var_cas_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (821)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentMapTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_34398->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (824)), var_cas_currentMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (824)) ;
    ...
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (828)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (829)) ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("location"), var_cas_locationTypeIndex COMMA_SOURCE_FILE_AT_LINE (833)) ;
    ...
    var_cas_insertFakeKeyFormalArgumentList.addAssign_operation (var_cas_locationTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (836))) ;
    var_cas_insertFakeKeyFormalArgumentList.addAssign_operation (var_cas_stringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (837))) ;
    var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("insertFakeKey"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (839)), var_cas_insertFakeKeyFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (842)) COMMA_SOURCE_FILE_AT_LINE (838)) ;
    var_cas_insertFakeKeyFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
    var_cas_insertFakeKeyFormalArgumentList.addAssign_operation (var_cas_stringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (846))) ;
    var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("insertSilentFakeKey"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (848)), var_cas_insertFakeKeyFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (851)) COMMA_SOURCE_FILE_AT_LINE (847)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_34398->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (854)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (854)) ;
    ::routine_enterConstructorWithArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("mapWithMapToOverride"),  operand_34398->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (855)),  operand_34398->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (855)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (855)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("allKeys"),  GGS_string ("stringset"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (857)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("allKeyList"),  GGS_string ("lstringlist"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (858)) ;
    ::routine_enterInheritedReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("hasKey"),  GGS_string ("string"),  GGS_string ("bool"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (859)) ;
    ::routine_enterInheritedReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("locationForKey"),  GGS_string ("string"),  GGS_string ("location"),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (860)) ;
    ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("overriddenMap"),  operand_34398->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (861)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (861)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("count"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (862)) ;
    ...
    var_cas_insertMethodFormalArgumentList.addAssign_operation (var_cas_lstringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (866))) ;
    GGS_formalParameterSignature  var_cas_removeMethodFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
    var_cas_removeMethodFormalArgumentList.addAssign_operation (var_cas_lstringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (868))) ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_38229 (operand_34398->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_38229 = NULL ;
      while (((operand_38229 = enumerator_38229.nextObject ()))) {
        macroValidPointer (operand_38229) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_38229->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (871)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (871)) ;
        GGS_bool var_cas_hasGetter = GGS_bool (true) ;
        GGS_bool var_cas_hasSetter = GGS_bool (true) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_38229->mAttributeName, var_cas_hasSetter, var_cas_hasGetter) ;
        var_cas_enumerationDescriptor.addAssign_operation (var_cas_attributeTypeIndex, operand_38229->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (875))) ;
        var_cas_insertMethodFormalArgumentList.addAssign_operation (var_cas_attributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (876))) ;
        var_cas_removeMethodFormalArgumentList.addAssign_operation (var_cas_attributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (877))) ;
      }
    }
    {
      GGS_insertMethodListAST::cEnumerator enumerator_38915 (operand_34398->mInsertMethodList, true) ;
      const GGS_insertMethodListAST::cElement * operand_38915 = NULL ;
      while (((operand_38915 = enumerator_38915.nextObject ()))) {
        macroValidPointer (operand_38915) ;
        const GGS_bool cond_39088 = var_cas_modifierMap.reader_hasKey (operand_38915->mInsertMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (881))) ;
        if (cond_39088.isBuiltAndTrue ()) {
          operand_38915->mInsertMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_38915->mInsertMethodName)).operator_concat (GGS_string ("' insert method is already declared")) COMMA_SOURCE_FILE_AT_LINE (883)) ;
        }else if (cond_39088.isBuiltAndFalse ()) {
          var_cas_modifierMap.modifier_insertOrReplace (inLexique, operand_38915->mInsertMethodName, var_cas_insertMethodFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (888)) COMMA_SOURCE_FILE_AT_LINE (884)) ;
        }
      }
    }
    {
      GGS_mapRemoveMethodListAST::cEnumerator enumerator_39338 (operand_34398->mRemoveMethodList, true) ;
      const GGS_mapRemoveMethodListAST::cElement * operand_39338 = NULL ;
      while (((operand_39338 = enumerator_39338.nextObject ()))) {
        macroValidPointer (operand_39338) ;
        const GGS_bool cond_39529 = var_cas_modifierMap.reader_hasKey (operand_39338->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (894))) ;
        if (cond_39529.isBuiltAndTrue ()) {
          operand_39338->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_39338->mMethodName)).operator_concat (GGS_string ("' method is already declared as an insert modifier or a remove modifier")) COMMA_SOURCE_FILE_AT_LINE (896)) ;
        }else if (cond_39529.isBuiltAndFalse ()) {
          var_cas_modifierMap.modifier_insertOrReplace (inLexique, operand_39338->mMethodName, var_cas_removeMethodFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (901)) COMMA_SOURCE_FILE_AT_LINE (897)) ;
        }
      }
    }
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_39814 (operand_34398->mSearchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_39814 = NULL ;
      while (((operand_39814 = enumerator_39814.nextObject ()))) {
        macroValidPointer (operand_39814) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_39814->mSearchMethodName, GGS_bool (false), var_cas_removeMethodFormalArgumentList, operand_39814->mSearchMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (911)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (913)) COMMA_SOURCE_FILE_AT_LINE (907)) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_40116 (operand_34398->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_40116 = NULL ;
      while (((operand_40116 = enumerator_40116.nextObject ()))) {
        macroValidPointer (operand_40116) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, (operand_40116->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (918))).operator_concat (GGS_string ("ForKey")), operand_40116->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (918)) COMMA_SOURCE_FILE_AT_LINE (918)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_40116->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (920)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (920)) ;
    ...
    const GGS_bool cond_41071 = (operand_34398->mInsertOrReplaceDeclarationListAST.reader_length ()).operator_supOrEqual (GGS_uint (1U)) ;
    if (cond_41071.isBuiltAndTrue ()) {
      GGS_location  var_cas_insertOrReplaceLocation ;
      if (operand_34398->mInsertOrReplaceDeclarationListAST.isBuilt ()) {
        operand_34398->mInsertOrReplaceDeclarationListAST (HERE)->method_first (inLexique, var_cas_insertOrReplaceLocation COMMA_SOURCE_FILE_AT_LINE (934)) ;
      }
      var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("insertOrReplace"), var_cas_insertOrReplaceLocation COMMA_SOURCE_FILE_AT_LINE (936)), var_cas_insertMethodFormalArgumentList, GGS_bool (false), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (939)) COMMA_SOURCE_FILE_AT_LINE (935)) ;
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_41156 (operand_34398->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_41156 = NULL ;
      while (((operand_41156 = enumerator_41156.nextObject ()))) {
        macroValidPointer (operand_41156) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_41156->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (944)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")), operand_41156->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (944)) COMMA_SOURCE_FILE_AT_LINE (944)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_41156->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (946)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (946)) ;
        GGS_formalParameterSignature  var_cas_accessorFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        var_cas_accessorFormalArgumentList.addAssign_operation (var_cas_attributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (948))) ;
        var_cas_accessorFormalArgumentList.addAssign_operation (var_cas_stringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (949))) ;
        var_cas_modifierMap.modifier_insertOrReplace (inLexique, var_cas_accessorName, var_cas_accessorFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (954)) COMMA_SOURCE_FILE_AT_LINE (950)) ;
      }
    }
    GGS_withAccessorMap  var_cas_withAccessorMap = GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (958)) ;
    var_cas_withAccessorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("hasKey"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (959)), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (959)) ;
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_42108 (operand_34398->mSearchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_42108 = NULL ;
      while (((operand_42108 = enumerator_42108.nextObject ()))) {
        macroValidPointer (operand_42108) ;
        var_cas_withAccessorMap.modifier_insertKey (inLexique, operand_42108->mSearchMethodName, var_cas_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (961)) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_34398->mMapTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (970)), GGS_typeKindEnum::constructor_mapType (inLexique COMMA_SOURCE_FILE_AT_LINE (971)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (973)), var_cas_typedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (979)), var_cas_enumerationDescriptor, function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (981)), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), operand_34398->mSearchMethodList, GGS_mapSearchMethodListAST ::constructor_emptyList (), var_cas_withAccessorMap, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (967)) ;
  }
}
...
category_method__uniqueMapDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_uniqueMapDeclarationAST * operand_43126,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_43126 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1003)) ;
    GGS_unifiedTypeMapProxy  var_cas_locationTypeProxy ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("location"), var_cas_locationTypeProxy COMMA_SOURCE_FILE_AT_LINE (1006)) ;
    GGS_unifiedTypeMapProxy  var_cas_lstringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("lstring"), var_cas_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1009)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentMapTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_43126->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1012)), var_cas_currentMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (1012)) ;
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1014)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1015)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1016)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1017)) ;
    GGS_enumerationDescriptorList  var_cas_enumerationDescriptor = GGS_enumerationDescriptorList ::constructor_listWithValue (var_cas_lstringTypeIndex, GGS_string ("lkey")) ;
    GGS_unifiedTypeMapProxy  var_cas_locationTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("location"), var_cas_locationTypeIndex COMMA_SOURCE_FILE_AT_LINE (1021)) ;
    GGS_formalParameterSignature  var_cas_insertFakeKeyFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
    var_cas_insertFakeKeyFormalArgumentList.addAssign_operation (var_cas_stringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1023))) ;
    var_cas_insertFakeKeyFormalArgumentList.addAssign_operation (var_cas_locationTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1024))) ;
    var_cas_insertFakeKeyFormalArgumentList.addAssign_operation (var_cas_stringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1025))) ;
    var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("insertFakeKey"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1027)), var_cas_insertFakeKeyFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1030)) COMMA_SOURCE_FILE_AT_LINE (1026)) ;
    var_cas_insertFakeKeyFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
    var_cas_insertFakeKeyFormalArgumentList.addAssign_operation (var_cas_stringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1034))) ;
    var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("insertSilentFakeKey"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1036)), var_cas_insertFakeKeyFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1039)) COMMA_SOURCE_FILE_AT_LINE (1035)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_43126->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1042)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1042)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("allKeys"),  GGS_string ("stringset"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1044)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("allKeyList"),  GGS_string ("lstringlist"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1045)) ;
    ::routine_enterInheritedReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("hasKey"),  GGS_string ("string"),  GGS_string ("bool"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1046)) ;
    ::routine_enterInheritedReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("locationForKey"),  GGS_string ("string"),  GGS_string ("location"),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1047)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("count"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1048)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("unsolvedProxyCount"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1049)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("unsolvedProxyKeyList"),  GGS_string ("stringlist"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1050)) ;
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    GGS_formalParameterSignature  var_cas_insertMethodFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
    var_cas_insertMethodFormalArgumentList.addAssign_operation (var_cas_lstringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1054))) ;
    GGS_formalParameterSignature  var_cas_removeMethodFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
    var_cas_removeMethodFormalArgumentList.addAssign_operation (var_cas_lstringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1056))) ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_46922 (operand_43126->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_46922 = NULL ;
      while (((operand_46922 = enumerator_46922.nextObject ()))) {
        macroValidPointer (operand_46922) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_46922->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1059)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1059)) ;
        GGS_bool var_cas_hasGetter = GGS_bool (true) ;
        GGS_bool var_cas_hasSetter = GGS_bool (true) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_46922->mAttributeName, var_cas_hasSetter, var_cas_hasGetter) ;
        var_cas_enumerationDescriptor.addAssign_operation (var_cas_attributeTypeIndex, operand_46922->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1063))) ;
        var_cas_insertMethodFormalArgumentList.addAssign_operation (var_cas_attributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1064))) ;
        var_cas_removeMethodFormalArgumentList.addAssign_operation (var_cas_attributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (1065))) ;
      }
    }
    {
      GGS_insertMethodListAST::cEnumerator enumerator_47608 (operand_43126->mInsertMethodList, true) ;
      const GGS_insertMethodListAST::cElement * operand_47608 = NULL ;
      while (((operand_47608 = enumerator_47608.nextObject ()))) {
        macroValidPointer (operand_47608) ;
        const GGS_bool cond_47781 = var_cas_modifierMap.reader_hasKey (operand_47608->mInsertMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1069))) ;
        if (cond_47781.isBuiltAndTrue ()) {
          operand_47608->mInsertMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_47608->mInsertMethodName)).operator_concat (GGS_string ("' insert method is already declared")) COMMA_SOURCE_FILE_AT_LINE (1071)) ;
        }else if (cond_47781.isBuiltAndFalse ()) {
          var_cas_modifierMap.modifier_insertOrReplace (inLexique, operand_47608->mInsertMethodName, var_cas_insertMethodFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1076)) COMMA_SOURCE_FILE_AT_LINE (1072)) ;
        }
      }
    }
    const GGS_bool cond_48377 = (operand_43126->mMapStateList.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
    if (cond_48377.isBuiltAndTrue ()) {
      {
        GGS_mapSearchMethodListAST::cEnumerator enumerator_48112 (operand_43126->mSearchMethodList, true) ;
        const GGS_mapSearchMethodListAST::cElement * operand_48112 = NULL ;
        while (((operand_48112 = enumerator_48112.nextObject ()))) {
          macroValidPointer (operand_48112) ;
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_48112->mSearchMethodName, GGS_bool (false), var_cas_removeMethodFormalArgumentList, operand_48112->mSearchMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1087)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1089)) COMMA_SOURCE_FILE_AT_LINE (1083)) ;
        }
      }
    }else if (cond_48377.isBuiltAndFalse ()) {
      {
        GGS_mapSearchMethodListAST::cEnumerator enumerator_48407 (operand_43126->mSearchMethodList, true) ;
        const GGS_mapSearchMethodListAST::cElement * operand_48407 = NULL ;
        while (((operand_48407 = enumerator_48407.nextObject ()))) {
          macroValidPointer (operand_48407) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, operand_48407->mSearchMethodName, var_cas_removeMethodFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1098)) COMMA_SOURCE_FILE_AT_LINE (1094)) ;
        }
      }
    }
    const GGS_bool cond_50128 = (operand_43126->mMapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_50128.isBuiltAndTrue ()) {
      GGS_unifiedTypeMapProxy  var_cas_locationTypeIndex ;
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("location"), var_cas_locationTypeIndex COMMA_SOURCE_FILE_AT_LINE (1105)) ;
      var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("openBranch"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1107)), GGS_formalParameterSignature ::constructor_emptyList (), GGS_bool (true), GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1110)) COMMA_SOURCE_FILE_AT_LINE (1106)) ;
      var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("closeBranch"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1113)), GGS_formalParameterSignature ::constructor_listWithValue (var_cas_locationTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1114))), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1116)) COMMA_SOURCE_FILE_AT_LINE (1112)) ;
      var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("closeOverride"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1119)), GGS_formalParameterSignature ::constructor_listWithValue (var_cas_locationTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1120))), GGS_bool (true), GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1122)) COMMA_SOURCE_FILE_AT_LINE (1118)) ;
      var_cas_instanceMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("checkAutomatonStates"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1125)), GGS_bool (false), GGS_formalParameterSignature ::constructor_listWithValue (var_cas_locationTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1127))), GGS_location (inLexique), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1130)) COMMA_SOURCE_FILE_AT_LINE (1124)) ;
      {
        GGS_mapOverrideBlockListAST::cEnumerator enumerator_49856 (operand_43126->mMapOverrideBlockListAST, true) ;
        const GGS_mapOverrideBlockListAST::cElement * operand_49856 = NULL ;
        while (((operand_49856 = enumerator_49856.nextObject ()))) {
          macroValidPointer (operand_49856) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("openOverrideFor")).operator_concat (operand_49856->mOverrideBlockName.ggs_string ().reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1134)), GGS_formalParameterSignature ::constructor_emptyList (), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1137)) COMMA_SOURCE_FILE_AT_LINE (1133)) ;
        }
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_50195 (operand_43126->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_50195 = NULL ;
      while (((operand_50195 = enumerator_50195.nextObject ()))) {
        macroValidPointer (operand_50195) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, (operand_50195->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1143))).operator_concat (GGS_string ("ForKey")), operand_50195->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1143)) COMMA_SOURCE_FILE_AT_LINE (1143)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_50195->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1145)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1145)) ;
        var_cas_readerMap.modifier_insertOrReplace (inLexique, var_cas_accessorName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_listWithValue (var_cas_stringTypeIndex), GGS_location (inLexique), GGS_bool (true), var_cas_attributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1153)) COMMA_SOURCE_FILE_AT_LINE (1146)) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_50811 (operand_43126->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_50811 = NULL ;
      while (((operand_50811 = enumerator_50811.nextObject ()))) {
        macroValidPointer (operand_50811) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_50811->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1158)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")), operand_50811->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1158)) COMMA_SOURCE_FILE_AT_LINE (1158)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_50811->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1160)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1160)) ;
        GGS_formalParameterSignature  var_cas_accessorFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        var_cas_accessorFormalArgumentList.addAssign_operation (var_cas_attributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1162))) ;
        var_cas_accessorFormalArgumentList.addAssign_operation (var_cas_stringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1163))) ;
        var_cas_modifierMap.modifier_insertOrReplace (inLexique, var_cas_accessorName, var_cas_accessorFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1168)) COMMA_SOURCE_FILE_AT_LINE (1164)) ;
      }
    }
    GGS_withAccessorMap  var_cas_withAccessorMap = GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1172)) ;
    var_cas_withAccessorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("hasKey"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1173)), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1173)) ;
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_51763 (operand_43126->mSearchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_51763 = NULL ;
      while (((operand_51763 = enumerator_51763.nextObject ()))) {
        macroValidPointer (operand_51763) ;
        var_cas_withAccessorMap.modifier_insertKey (inLexique, operand_51763->mSearchMethodName, var_cas_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1175)) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_43126->mMapTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1184)), GGS_typeKindEnum::constructor_uniqueMapType (inLexique COMMA_SOURCE_FILE_AT_LINE (1185)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1187)), var_cas_typedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1193)), var_cas_enumerationDescriptor, function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1195)), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), operand_43126->mSearchMethodList, GGS_mapSearchMethodListAST ::constructor_emptyList (), var_cas_withAccessorMap, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1181)) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_52786,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_52786 != NULL) {
    ...
    GGS_bool automatic_var_53400_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_53400_1 ;
    GGS_typedAttributeList  automatic_var_53400_2 ;
    GGS_attributeMap  automatic_var_53400_3 ;
    GGS_constructorMap  automatic_var_53400_4 ;
    GGS_readerMap  automatic_var_53400_5 ;
    GGS_modifierMap  automatic_var_53400_6 ;
    GGS_instanceMethodMap  automatic_var_53400_7 ;
    GGS_classMethodMap  automatic_var_53400_8 ;
    GGS_enumerationDescriptorList  automatic_var_53400_9 ;
    GGS_uint  automatic_var_53400_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_53400_11 ;
    GGS_nativeAttributeList  automatic_var_53400_12 ;
    GGS_stringset  automatic_var_53400_13 ;
    GGS_lstringlist  automatic_var_53400_14 ;
    GGS_typedAttributeList  automatic_var_53400_15 ;
    GGS_mapSearchMethodListAST  automatic_var_53400_16 ;
    GGS_withAccessorMap  automatic_var_53400_17 ;
    GGS_bool automatic_var_53400_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_52786->mAssociatedMapTypeName, automatic_var_53400_0, automatic_var_53400_1, var_cas_typeKindEnum, automatic_var_53400_2, automatic_var_53400_3, var_cas_mapTypedAttributeList, automatic_var_53400_4, automatic_var_53400_5, automatic_var_53400_6, automatic_var_53400_7, automatic_var_53400_8, automatic_var_53400_9, automatic_var_53400_10, automatic_var_53400_11, automatic_var_53400_12, automatic_var_53400_13, automatic_var_53400_14, automatic_var_53400_15, var_cas_searchMethodList, automatic_var_53400_16, automatic_var_53400_17, automatic_var_53400_18 COMMA_SOURCE_FILE_AT_LINE (1220)) ;
    }
    const GGS_bool cond_53631 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_uniqueMapType (inLexique COMMA_SOURCE_FILE_AT_LINE (1230))) ;
    if (cond_53631.isBuiltAndTrue ()) {
      operand_52786->mAssociatedMapTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_52786->mAssociatedMapTypeName)).operator_concat (GGS_string (" should be an unique map type")) COMMA_SOURCE_FILE_AT_LINE (1232)) ;
      var_cas_mapTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1235)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1236)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1237)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1238)) ;
    GGS_classMethodMap  var_cas_classMethodMap = GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1239)) ;
    GGS_unifiedTypeMapProxy  var_cas_associatedMapTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_52786->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1242)), var_cas_associatedMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (1242)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1245)) ;
    GGS_unifiedTypeMapProxy  var_cas_lstringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("lstring"), var_cas_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1248)) ;
    GGS_unifiedTypeMapProxy  var_cas_mapProxyTypeProxy ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_52786->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1251)), var_cas_mapProxyTypeProxy COMMA_SOURCE_FILE_AT_LINE (1251)) ;
    GGS_formalParameterSignature  var_cas_argList = GGS_formalParameterSignature ::constructor_emptyList () ;
    var_cas_argList.addAssign_operation (var_cas_associatedMapTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (1254))) ;
    var_cas_argList.addAssign_operation (var_cas_stringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1255))) ;
    var_cas_argList.addAssign_operation (var_cas_mapProxyTypeProxy, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (1256))) ;
    var_cas_classMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("makeRegularProxy"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1258)), var_cas_argList, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1257)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("null"),  operand_52786->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1263)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1263)) ;
    ...
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_55431 (var_cas_searchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_55431 = NULL ;
      while (((operand_55431 = enumerator_55431.nextObject ()))) {
        macroValidPointer (operand_55431) ;
        var_cas_constructorMap.modifier_insertKey (inLexique, operand_55431->mSearchMethodName, var_cas_constructorAttributeTypeList, GGS_bool (true), var_cas_mapProxyTypeProxy COMMA_SOURCE_FILE_AT_LINE (1269)) ;
      }
    }
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("isSolved"),  GGS_string ("bool"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1277)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("isNull"),  GGS_string ("bool"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1278)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("isRegular"),  GGS_string ("bool"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1279)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("lkey"),  GGS_string ("lstring"),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1280)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("key"),  GGS_string ("string"),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1281)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("identifierRepresentation"),  GGS_string ("string"),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1282)) ;
    const GGS_readerMap  var_cas_inheritedReaderMap = var_cas_readerMap ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_56403 (var_cas_mapTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_56403 = NULL ;
      while (((operand_56403 = enumerator_56403.nextObject ()))) {
        macroValidPointer (operand_56403) ;
        const GGS_bool cond_56810 = var_cas_inheritedReaderMap.reader_hasKey (operand_56403->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1286))) ;
        if (cond_56810.isBuiltAndTrue ()) {
          GGS_string var_cas_s = GGS_string ("") ;
          {
            GGS_stringset::cEnumerator enumerator_56511 (var_cas_inheritedReaderMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (1288)), true) ;
            if (enumerator_56511 .hasCurrentObject ()) {
              bool _foreach_loop_56511 ;
              do{
                var_cas_s.appendCString ("'") ;
                var_cas_s.dotAssign_operation (enumerator_56511._key (HERE)) ;
                var_cas_s.appendCString ("'") ;
                enumerator_56511.next () ;
                _foreach_loop_56511 = (enumerator_56511 .hasCurrentObject ()) ;
                if (_foreach_loop_56511) {
                  var_cas_s.appendCString (", ") ;
                }
              }while (_foreach_loop_56511) ;
            }
          }
          operand_56403->mAttributeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the map has a associated map proxy, which has predefined readers: ")).operator_concat (var_cas_s)).operator_concat (GGS_string ("; you cannot use theses names for naming an attribute of this map")) COMMA_SOURCE_FILE_AT_LINE (1294)) ;
        }else if (cond_56810.isBuiltAndFalse ()) {
          var_cas_readerMap.modifier_insertKey (inLexique, operand_56403->mAttributeName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_location (inLexique), GGS_bool (true), operand_56403->mAttributeTypeProxy, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1302)) COMMA_SOURCE_FILE_AT_LINE (1295)) ;
        }
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_52786->mMapProxyTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1310)), GGS_typeKindEnum::constructor_mapProxyType (inLexique COMMA_SOURCE_FILE_AT_LINE (1311)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1313)), var_cas_mapTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, var_cas_classMethodMap, GGS_enumerationDescriptorList ::constructor_emptyList (), function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1321)), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), var_cas_searchMethodList, GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1329)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1307)) ;
  }
}
...
category_method__enumDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_enumDeclarationAST * operand_58014,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58014 != NULL) {
    ...
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1344)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1345)) ;
    GGS_classMethodMap  var_cas_classMethodMap = GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1346)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_58014->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1349)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1349)) ;
    GGS_stringset  var_cas_constantSet = GGS_stringset ::constructor_emptySet () ;
    {
      GGS_lstringlist::cEnumerator enumerator_58742 (operand_58014->mConstantList, true) ;
      const GGS_lstringlist::cElement * operand_58742 = NULL ;
      while (((operand_58742 = enumerator_58742.nextObject ()))) {
        macroValidPointer (operand_58742) ;
        var_cas_constantSet.addAssign_operation (operand_58742->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1353))) ;
        ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  operand_58742->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1354)),  operand_58014->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1354)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1354)) ;
      }
    }
    GGS_readerMap  var_cas_readerMap ;
    ::routine_commonReaderMapForAllTypes (inLexique,  var_cas_ioSemanticContext.mTypeMap,  var_cas_readerMap COMMA_SOURCE_FILE_AT_LINE (1358)) ;
    {
      GGS_enumMessageListAST::cEnumerator enumerator_59070 (operand_58014->mEnumMessageList, true) ;
      const GGS_enumMessageListAST::cElement * operand_59070 = NULL ;
      while (((operand_59070 = enumerator_59070.nextObject ()))) {
        macroValidPointer (operand_59070) ;
        ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_59070->mEnumMessageName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1360)),  GGS_string ("string"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1360)) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_58014->mEnumTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1366)), GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1367)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1369)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1375)), GGS_enumerationDescriptorList ::constructor_emptyList (), (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1377))).operator_or (function_isComparable (inLexique COMMA_SOURCE_FILE_AT_LINE (1377))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), var_cas_constantSet, operand_58014->mConstantList, GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1385)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1363)) ;
  }
}
...
void routine_recursivelyEnumerateDirectories (C_CompilerEx & inLexique,
  ...
  var_cas_ioWrapperDirectoryIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1408)) ;
  GGS_stringlist  var_cas_files = var_cas_inAbsoluteSourcePath.reader_regularFiles (GGS_bool (false)) ;
  var_cas_outWrapperFileMap = GGS_wrapperFileMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1411)) ;
  {
    GGS_stringlist::cEnumerator enumerator_60868 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_60868 = NULL ;
    while (((operand_60868 = enumerator_60868.nextObject ()))) {
      macroValidPointer (operand_60868) ;
      const GGS_bool cond_61211 = var_cas_inExtensionMap.reader_hasKey (operand_60868->mValue.reader_pathExtension ()) ;
      if (cond_61211.isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_60868->mValue) ;
        var_cas_outWrapperFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_60868->mValue, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1416)), var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1415)) ;
        var_cas_ioWrapperFileIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1421)) ;
      }
    }
  }
  GGS_stringlist  var_cas_directories = var_cas_inAbsoluteSourcePath.reader_directories (GGS_bool (false)) ;
  var_cas_outWrapperDirectoryMap = GGS_wrapperDirectoryMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1426)) ;
  {
    GGS_stringlist::cEnumerator enumerator_61425 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_61425 = NULL ;
    while (((operand_61425 = enumerator_61425.nextObject ()))) {
      macroValidPointer (operand_61425) ;
      ...
      ::routine_recursivelyEnumerateDirectories (inLexique,  ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_61425->mValue),  ((var_cas_inPathInWrapper).operator_concat (operand_61425->mValue)).operator_concat (GGS_string ("/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileMap,  var_cas_internalWrapperDirectoryMap,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex COMMA_SOURCE_FILE_AT_LINE (1431)) ;
      var_cas_outWrapperDirectoryMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_61425->mValue, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1441)), var_cas_internalWrapperFileMap, var_cas_internalWrapperDirectoryMap, var_cas_theDirectoryIndex COMMA_SOURCE_FILE_AT_LINE (1440)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__filewrapperDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_filewrapperDeclarationAST * operand_62204,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62204 != NULL) {
    GGS_filewrapperTemplateMap  var_cas_filewrapperTemplateMap = GGS_filewrapperTemplateMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1457)) ;
    {
      GGS_filewrapperTemplateListAST::cEnumerator enumerator_62529 (operand_62204->mFilewrapperTemplateList, true) ;
      const GGS_filewrapperTemplateListAST::cElement * operand_62529 = NULL ;
      while (((operand_62529 = enumerator_62529.nextObject ()))) {
        macroValidPointer (operand_62529) ;
        GGS_unifiedTypeMapProxyList  var_cas_templateSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
        {
          GGS_formalTemplateInputParameterListAST::cEnumerator enumerator_62647 (operand_62529->mFilewrapperTemplateFormalInputParameters, true) ;
          const GGS_formalTemplateInputParameterListAST::cElement * operand_62647 = NULL ;
          while (((operand_62647 = enumerator_62647.nextObject ()))) {
            macroValidPointer (operand_62647) ;
            GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_62647->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1462)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1462)) ;
            var_cas_templateSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
          }
        }
        var_cas_filewrapperTemplateMap.modifier_insertKey (inLexique, operand_62529->mFilewrapperTemplateName, var_cas_templateSignature, operand_62529->mFilewrapperTemplatePath COMMA_SOURCE_FILE_AT_LINE (1465)) ;
      }
    }
    GGS_wrapperExtensionMap  var_cas_extensionMap = GGS_wrapperExtensionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1472)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_63160 (operand_62204->mFilewrapperExtensionList, true) ;
      const GGS_lstringlist::cElement * operand_63160 = NULL ;
      while (((operand_63160 = enumerator_63160.nextObject ()))) {
        macroValidPointer (operand_63160) ;
        var_cas_extensionMap.modifier_insertKey (inLexique, operand_63160->mValue COMMA_SOURCE_FILE_AT_LINE (1474)) ;
      }
    }
    ...
    const GGS_bool cond_63494 = (operand_62204->mFilewrapperPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1480)).reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
    if (cond_63494.isBuiltAndTrue ()) {
      var_cas_absoluteSourcePath = operand_62204->mFilewrapperPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1481)) ;
    }else if (cond_63494.isBuiltAndFalse ()) {
      var_cas_absoluteSourcePath = ((operand_62204->mSourceFileAbsolutePath.reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/"))).operator_concat (operand_62204->mFilewrapperPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1483))) ;
    }
    const GGS_bool cond_63822 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
    if (cond_63822.isBuiltAndTrue ()) {
      operand_62204->mFilewrapperPath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("The '")).operator_concat (var_cas_absoluteSourcePath)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (1488)) ;
      var_cas_regularRootFileMap.drop () ;
      var_cas_wrapperDirectoryMap.drop () ;
    }else if (cond_63822.isBuiltAndFalse ()) {
      GGS_uint  var_cas_wrapperFileIndex = GGS_uint (0U) ;
      GGS_uint  var_cas_wrapperDirectoryIndex = GGS_uint (0U) ;
      ::routine_recursivelyEnumerateDirectories (inLexique,  var_cas_absoluteSourcePath,  GGS_string ("/"),  var_cas_extensionMap,  var_cas_regularRootFileMap,  var_cas_wrapperDirectoryMap,  var_cas_wrapperFileIndex,  var_cas_wrapperDirectoryIndex COMMA_SOURCE_FILE_AT_LINE (1492)) ;
    }
    var_cas_ioSemanticContext.mFilewrapperMap.modifier_insertKey (inLexique, operand_62204->mFilewrapperName, operand_62204->mFilewrapperPath, operand_62204->mFilewrapperExtensionList, var_cas_regularRootFileMap, var_cas_wrapperDirectoryMap, var_cas_filewrapperTemplateMap COMMA_SOURCE_FILE_AT_LINE (1503)) ;
  }
}
...
category_method__listDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_listDeclarationAST * operand_64513,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64513 != NULL) {
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_64889 (operand_64513->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_64889 = NULL ;
      while (((operand_64889 = enumerator_64889.nextObject ()))) {
        macroValidPointer (operand_64889) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_64889->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1525)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1525)) ;
        GGS_bool var_cas_hasGetter = GGS_bool (true) ;
        GGS_bool var_cas_hasSetter = GGS_bool (true) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_64889->mAttributeName, var_cas_hasSetter, var_cas_hasGetter) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("uint"), var_cas_uintType COMMA_SOURCE_FILE_AT_LINE (1532)) ;
    GGS_unifiedTypeMapProxy  var_cas_listTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_64513->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1535)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (1535)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_65888 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_65888 = NULL ;
      while (((operand_65888 = enumerator_65888.nextObject ()))) {
        macroValidPointer (operand_65888) ;
        var_cas_enumerationDescriptor.addAssign_operation (operand_65888->mAttributeTypeProxy, operand_65888->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1542))) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_65888->mAttributeTypeProxy) ;
        var_cas_modifierOutputFormalArgumentList.addAssign_operation (operand_65888->mAttributeTypeProxy, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (1544))) ;
        var_cas_modifierInputFormalArgumentList.addAssign_operation (operand_65888->mAttributeTypeProxy, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1545))) ;
      }
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1548)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyList"),  operand_64513->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1549)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1549)) ;
    var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("listWithValue"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1551)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (1550)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1557)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("length"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1558)) ;
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListFromIndex"),  GGS_string ("uint"),  operand_64513->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1559)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1559)) ;
    ::routine_enterBaseReaderWith2Arguments (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListWithRange"),  GGS_string ("uint"),  GGS_string ("uint"),  operand_64513->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1560)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1560)) ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_67058 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_67058 = NULL ;
      while (((operand_67058 = enumerator_67058.nextObject ()))) {
        macroValidPointer (operand_67058) ;
        var_cas_readerMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, (operand_67058->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1563))).operator_concat (GGS_string ("AtIndex")), operand_67058->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1563)) COMMA_SOURCE_FILE_AT_LINE (1563)), GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_listWithValue (var_cas_uintType), GGS_location (inLexique), GGS_bool (true), operand_67058->mAttributeTypeProxy, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1569)) COMMA_SOURCE_FILE_AT_LINE (1562)) ;
      }
    }
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1573)) ;
    var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("popFirst"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1575)), var_cas_modifierOutputFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1578)) COMMA_SOURCE_FILE_AT_LINE (1574)) ;
    var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("popLast"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1581)), var_cas_modifierOutputFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1584)) COMMA_SOURCE_FILE_AT_LINE (1580)) ;
    var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("prependValue"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1587)), var_cas_modifierInputFormalArgumentList, GGS_bool (false), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1590)) COMMA_SOURCE_FILE_AT_LINE (1586)) ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_67938 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_67938 = NULL ;
      while (((operand_67938 = enumerator_67938.nextObject ()))) {
        macroValidPointer (operand_67938) ;
        GGS_formalParameterSignature  var_cas_setterFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        var_cas_setterFormalArgumentList.addAssign_operation (operand_67938->mAttributeTypeProxy, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1594))) ;
        var_cas_setterFormalArgumentList.addAssign_operation (var_cas_uintType, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1595))) ;
        var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_67938->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1597)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("AtIndex")), operand_67938->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1597)) COMMA_SOURCE_FILE_AT_LINE (1597)), var_cas_setterFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1600)) COMMA_SOURCE_FILE_AT_LINE (1596)) ;
      }
    }
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1604)) ;
    var_cas_instanceMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("first"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1606)), GGS_bool (false), var_cas_modifierOutputFormalArgumentList, GGS_location (inLexique), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1611)) COMMA_SOURCE_FILE_AT_LINE (1605)) ;
    var_cas_instanceMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("last"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1614)), GGS_bool (false), var_cas_modifierOutputFormalArgumentList, GGS_location (inLexique), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1619)) COMMA_SOURCE_FILE_AT_LINE (1613)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_64513->mListTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1625)), GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1626)), var_cas_typedAttributeList, GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1628)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1634)), var_cas_enumerationDescriptor, ((function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1636))).operator_or (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1636)))).operator_or (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1636))), var_cas_constructorAttributeTypeList, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1644)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1622)) ;
  }
}
...
category_method__sortedListDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_69927,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_69927 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("uint"), var_cas_uintType COMMA_SOURCE_FILE_AT_LINE (1658)) ;
    GGS_unifiedTypeMapProxy  var_cas_listTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_69927->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1661)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (1661)) ;
    GGS_enumerationDescriptorList  var_cas_enumerationDescriptor = GGS_enumerationDescriptorList ::constructor_emptyList () ;
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    GGS_formalParameterSignature  var_cas_modifierFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_70826 (operand_69927->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_70826 = NULL ;
      while (((operand_70826 = enumerator_70826.nextObject ()))) {
        macroValidPointer (operand_70826) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_70826->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1669)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1669)) ;
        GGS_bool var_cas_hasGetter = GGS_bool (true) ;
        GGS_bool var_cas_hasSetter = GGS_bool (true) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_70826->mAttributeName, var_cas_hasSetter, var_cas_hasGetter) ;
        var_cas_enumerationDescriptor.addAssign_operation (var_cas_attributeTypeIndex, operand_70826->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1673))) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_modifierFormalArgumentList.addAssign_operation (var_cas_attributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (1675))) ;
      }
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1678)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptySortedList"),  operand_69927->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1679)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1679)) ;
    var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("sortedListWithValue"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1681)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (1680)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1687)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("length"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1688)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1690)) ;
    var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("popGreatest"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1692)), var_cas_modifierFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1695)) COMMA_SOURCE_FILE_AT_LINE (1691)) ;
    var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("popSmallest"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1698)), var_cas_modifierFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)) COMMA_SOURCE_FILE_AT_LINE (1697)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1704)) ;
    var_cas_instanceMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("greatest"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1706)), GGS_bool (false), var_cas_modifierFormalArgumentList, GGS_location (inLexique), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1711)) COMMA_SOURCE_FILE_AT_LINE (1705)) ;
    var_cas_instanceMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("smallest"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1714)), GGS_bool (false), var_cas_modifierFormalArgumentList, GGS_location (inLexique), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1719)) COMMA_SOURCE_FILE_AT_LINE (1713)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_69927->mSortedListTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1725)), GGS_typeKindEnum::constructor_sortedListType (inLexique COMMA_SOURCE_FILE_AT_LINE (1726)), var_cas_typedAttributeList, GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1728)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1734)), var_cas_enumerationDescriptor, ((function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1736))).operator_or (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1736)))).operator_or (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1736))), var_cas_constructorAttributeTypeList, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1744)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1722)) ;
  }
}
...
category_method__structDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_structDeclarationAST * operand_73717,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_73717 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_structTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_73717->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1759)), var_cas_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (1759)) ;
    GGS_attributeMap  var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1761)) ;
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1762)) ;
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_74447 (operand_73717->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_74447 = NULL ;
      while (((operand_74447 = enumerator_74447.nextObject ()))) {
        macroValidPointer (operand_74447) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_74447->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1767)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1767)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        GGS_bool var_cas_hasSetter = GGS_bool (false) ;
        GGS_bool var_cas_hasGetter = GGS_bool (true) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_74447->mAttributeName, var_cas_hasSetter, var_cas_hasGetter) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_74447->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1772)) ;
      }
    }
    var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1775)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (1774)) ;
    GGS_readerMap  var_cas_readerMap ;
    ::routine_commonReaderMapForAllTypes (inLexique,  var_cas_ioSemanticContext.mTypeMap,  var_cas_readerMap COMMA_SOURCE_FILE_AT_LINE (1782)) ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_75185 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_75185 = NULL ;
      while (((operand_75185 = enumerator_75185.nextObject ()))) {
        macroValidPointer (operand_75185) ;
        ::routine_enterBaseFinalReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_75185->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1789)),  operand_75185->mAttributeTypeProxy.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1790)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1786)) ;
      }
    }
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1796)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1798)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_73717->mStructTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1803)), GGS_typeKindEnum::constructor_structType (inLexique COMMA_SOURCE_FILE_AT_LINE (1804)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_attributeMap, var_cas_typedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1812)), GGS_enumerationDescriptorList ::constructor_emptyList (), function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1814)), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_typedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1822)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1800)) ;
  }
}
...
category_method__classDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_classDeclarationAST * operand_76586,
                                const GGS_categoryMethodMapForBuildingContext   var_cas_inCategoryMethodMapForBuildingContext,
                                const GGS_categoryReaderMapForBuildingContext   var_cas_inCategoryReaderMapForBuildingContext,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_76586 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("uint"), var_cas_uintType COMMA_SOURCE_FILE_AT_LINE (1835)) ;
    GGS_readerMap  var_cas_readerMap ;
    GGS_modifierMap  var_cas_modifierMap ;
    GGS_instanceMethodMap  var_cas_inheritedInstanceMethodMap ;
    GGS_typedAttributeList  var_cas_inheritedTypedAttributeList ;
    GGS_attributeMap  var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1841)) ;
    GGS_unifiedTypeMapProxy  var_cas_superClassIndex ;
    GGS_bool var_cas_generateHeaderInSeparateFile ;
    const GGS_bool cond_77803 = (operand_76586->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1845))).operator_isEqual (GGS_string ("")) ;
    if (cond_77803.isBuiltAndTrue ()) {
      var_cas_superClassIndex = GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1846)) ;
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1847)) ;
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1848)) ;
      var_cas_inheritedInstanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1849)) ;
      var_cas_inheritedTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
      var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1851)) ;
      var_cas_generateHeaderInSeparateFile = GGS_bool (false) ;
      {
        GGS_lstringlist::cEnumerator enumerator_77654 (operand_76586->mClassFeatureList, true) ;
        const GGS_lstringlist::cElement * operand_77654 = NULL ;
        while (((operand_77654 = enumerator_77654.nextObject ()))) {
          macroValidPointer (operand_77654) ;
          const GGS_bool cond_77773 = (operand_77654->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1854))).operator_isEqual (GGS_string ("generatedInSeparateFile")) ;
          if (cond_77773.isBuiltAndTrue ()) {
            var_cas_generateHeaderInSeparateFile = GGS_bool (true) ;
          }
        }
      }
    }else if (cond_77803.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_76586->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1859)), var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (1859)) ;
      GGS_typeKindEnum var_cas_typeKindEnum ;
      GGS_readerMap  var_cas_inheritedReaderMap ;
      GGS_modifierMap  var_cas_inheritedModifierMap ;
      GGS_bool automatic_var_78333_0 ;
      GGS_unifiedTypeMapProxy  automatic_var_78333_1 ;
      GGS_typedAttributeList  automatic_var_78333_2 ;
      GGS_constructorMap  automatic_var_78333_3 ;
      GGS_classMethodMap  automatic_var_78333_4 ;
      GGS_enumerationDescriptorList  automatic_var_78333_5 ;
      GGS_uint  automatic_var_78333_6 ;
      GGS_unifiedTypeMapProxyList  automatic_var_78333_7 ;
      GGS_nativeAttributeList  automatic_var_78333_8 ;
      GGS_stringset  automatic_var_78333_9 ;
      GGS_lstringlist  automatic_var_78333_10 ;
      GGS_typedAttributeList  automatic_var_78333_11 ;
      GGS_mapSearchMethodListAST  automatic_var_78333_12 ;
      GGS_mapSearchMethodListAST  automatic_var_78333_13 ;
      GGS_withAccessorMap  automatic_var_78333_14 ;
      if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
        var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_76586->mSuperClassName, automatic_var_78333_0, automatic_var_78333_1, var_cas_typeKindEnum, var_cas_inheritedTypedAttributeList, var_cas_attributeMap, automatic_var_78333_2, automatic_var_78333_3, var_cas_inheritedReaderMap, var_cas_inheritedModifierMap, var_cas_inheritedInstanceMethodMap, automatic_var_78333_4, automatic_var_78333_5, automatic_var_78333_6, automatic_var_78333_7, automatic_var_78333_8, automatic_var_78333_9, automatic_var_78333_10, automatic_var_78333_11, automatic_var_78333_12, automatic_var_78333_13, automatic_var_78333_14, var_cas_generateHeaderInSeparateFile COMMA_SOURCE_FILE_AT_LINE (1863)) ;
      }
      const GGS_bool cond_78490 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1877))) ;
      if (cond_78490.isBuiltAndTrue ()) {
        operand_76586->mSuperClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_76586->mSuperClassName)).operator_concat (GGS_string (" should be a class type")) COMMA_SOURCE_FILE_AT_LINE (1879)) ;
      }
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1881)) ;
      {
        GGS_modifierMap::cEnumerator enumerator_78612 (var_cas_inheritedModifierMap, true) ;
        const GGS_modifierMap::cElement * operand_78612 = NULL ;
        while (((operand_78612 = enumerator_78612.nextObject ()))) {
          macroValidPointer (operand_78612) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, operand_78612->mKey, operand_78612->mInfo.mParameterList, operand_78612->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1887)) COMMA_SOURCE_FILE_AT_LINE (1883)) ;
        }
      }
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1891)) ;
      {
        GGS_readerMap::cEnumerator enumerator_78892 (var_cas_inheritedReaderMap, true) ;
        const GGS_readerMap::cElement * operand_78892 = NULL ;
        while (((operand_78892 = enumerator_78892.nextObject ()))) {
          macroValidPointer (operand_78892) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_78892->mKey, operand_78892->mInfo.mIsCategory, operand_78892->mInfo.mArgumentTypeList, operand_78892->mInfo.mDeclarationLocation, operand_78892->mInfo.mHasCompilerArgument, operand_78892->mInfo.mReturnedType, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1900)) COMMA_SOURCE_FILE_AT_LINE (1893)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_79312 (var_cas_inheritedTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_79312 = NULL ;
      while (((operand_79312 = enumerator_79312.nextObject ()))) {
        macroValidPointer (operand_79312) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_79312->mAttributeTypeProxy) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_79415 (operand_76586->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_79415 = NULL ;
      while (((operand_79415 = enumerator_79415.nextObject ()))) {
        macroValidPointer (operand_79415) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_79415->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1911)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1911)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_79415->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1913)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_classIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_76586->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1917)), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1917)) ;
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1919)) ;
    const GGS_bool cond_80141 = (operand_76586->mIsAbstract).operator_not () ;
    if (cond_80141.isBuiltAndTrue ()) {
      var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1922)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1921)) ;
    }
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1929)) ;
    {
      GGS_instanceMethodMap::cEnumerator enumerator_80272 (var_cas_inheritedInstanceMethodMap, true) ;
      const GGS_instanceMethodMap::cElement * operand_80272 = NULL ;
      while (((operand_80272 = enumerator_80272.nextObject ()))) {
        macroValidPointer (operand_80272) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_80272->mKey, operand_80272->mInfo.mIsCategory, operand_80272->mInfo.mParameterList, operand_80272->mInfo.mDeclarationLocation, operand_80272->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1937)) COMMA_SOURCE_FILE_AT_LINE (1931)) ;
      }
    }
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_80554 (operand_76586->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_80554 = NULL ;
      while (((operand_80554 = enumerator_80554.nextObject ()))) {
        macroValidPointer (operand_80554) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_80643 (operand_80554->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_80643 = NULL ;
          while (((operand_80643 = enumerator_80643.nextObject ()))) {
            macroValidPointer (operand_80643) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_80643->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1945)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1945)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_80643->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_80924 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_80554->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1948))) ;
        if (NULL != operand_80924) {
          operand_80924->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1949)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_80554->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_80554->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1955)), GGS_bool (true), GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1957)) COMMA_SOURCE_FILE_AT_LINE (1951)) ;
        }
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_81341 (operand_76586->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_81341 = NULL ;
      while (((operand_81341 = enumerator_81341.nextObject ()))) {
        macroValidPointer (operand_81341) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_81430 (operand_81341->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_81430 = NULL ;
          while (((operand_81430 = enumerator_81430.nextObject ()))) {
            macroValidPointer (operand_81430) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_81430->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1966)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1966)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_81430->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_81711 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_81341->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1969))) ;
        if (NULL != operand_81711) {
          operand_81711->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverriding (inLexique COMMA_SOURCE_FILE_AT_LINE (1970)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_81341->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_81341->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1976)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1978)) COMMA_SOURCE_FILE_AT_LINE (1972)) ;
        }
      }
    }
    const GGS_bool cond_82949 = var_cas_inCategoryMethodMapForBuildingContext.reader_hasKey (operand_76586->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1983))) ;
    if (cond_82949.isBuiltAndTrue ()) {
      GGS_categoryMethodMapForType  var_cas_categoryMethodMapForType ;
      if (var_cas_inCategoryMethodMapForBuildingContext.isBuilt ()) {
        var_cas_inCategoryMethodMapForBuildingContext (HERE)->method_searchKey (inLexique, operand_76586->mClassTypeName, var_cas_categoryMethodMapForType COMMA_SOURCE_FILE_AT_LINE (1985)) ;
      }
      {
        GGS_categoryMethodMapForType::cEnumerator enumerator_82368 (var_cas_categoryMethodMapForType, true) ;
        const GGS_categoryMethodMapForType::cElement * operand_82368 = NULL ;
        while (((operand_82368 = enumerator_82368.nextObject ()))) {
          macroValidPointer (operand_82368) ;
          GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
          {
            GGS_formalParameterListAST::cEnumerator enumerator_82471 (operand_82368->mInfo.mFormalParameterList, true) ;
            const GGS_formalParameterListAST::cElement * operand_82471 = NULL ;
            while (((operand_82471 = enumerator_82471.nextObject ()))) {
              macroValidPointer (operand_82471) ;
              GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
              GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_82471->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1990)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1990)) ;
              var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_82471->mFormalArgumentPassingMode) ;
            }
          }
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_82368->mKey, GGS_bool (true), var_cas_formalArgumentList, operand_82368->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1997)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1999)) COMMA_SOURCE_FILE_AT_LINE (1993)) ;
        }
      }
    }
    const GGS_bool cond_84003 = var_cas_inCategoryReaderMapForBuildingContext.reader_hasKey (operand_76586->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2004))) ;
    if (cond_84003.isBuiltAndTrue ()) {
      GGS_categoryReaderMapForType  var_cas_categoryReaderMapForType ;
      if (var_cas_inCategoryReaderMapForBuildingContext.isBuilt ()) {
        var_cas_inCategoryReaderMapForBuildingContext (HERE)->method_searchKey (inLexique, operand_76586->mClassTypeName, var_cas_categoryReaderMapForType COMMA_SOURCE_FILE_AT_LINE (2006)) ;
      }
      {
        GGS_categoryReaderMapForType::cEnumerator enumerator_83272 (var_cas_categoryReaderMapForType, true) ;
        const GGS_categoryReaderMapForType::cElement * operand_83272 = NULL ;
        while (((operand_83272 = enumerator_83272.nextObject ()))) {
          macroValidPointer (operand_83272) ;
          GGS_unifiedTypeMapProxyList  var_cas_formalArgumentList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
          {
            GGS_formalInputParameterListAST::cEnumerator enumerator_83379 (operand_83272->mInfo.mInputFormalParameterList, true) ;
            const GGS_formalInputParameterListAST::cElement * operand_83379 = NULL ;
            while (((operand_83379 = enumerator_83379.nextObject ()))) {
              macroValidPointer (operand_83379) ;
              GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
              GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_83379->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2011)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (2011)) ;
              var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex) ;
            }
          }
          GGS_unifiedTypeMapProxy  var_cas_returnedType ;
          GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_83272->mInfo.mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2015)), var_cas_returnedType COMMA_SOURCE_FILE_AT_LINE (2015)) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_83272->mKey, GGS_bool (true), var_cas_formalArgumentList, operand_83272->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (2020)), GGS_bool (true), var_cas_returnedType, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (2023)) COMMA_SOURCE_FILE_AT_LINE (2016)) ;
        }
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_84203 (operand_76586->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_84203 = NULL ;
      while (((operand_84203 = enumerator_84203.nextObject ()))) {
        macroValidPointer (operand_84203) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_84203->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2032)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2032)) ;
        GGS_bool var_cas_hasSetter = GGS_bool (false) ;
        GGS_bool var_cas_hasGetter = GGS_bool (true) ;
        {
          GGS_lstringlist::cEnumerator enumerator_84463 (operand_84203->mFeatureList, true) ;
          const GGS_lstringlist::cElement * operand_84463 = NULL ;
          while (((operand_84463 = enumerator_84463.nextObject ()))) {
            macroValidPointer (operand_84463) ;
            const GGS_bool cond_84548 = (operand_84463->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2036))).operator_isEqual (GGS_string ("setter")) ;
            if (cond_84548.isBuiltAndTrue ()) {
              var_cas_hasSetter = GGS_bool (true) ;
            }else if (cond_84548.isBuiltAndFalse ()) {
              const GGS_bool cond_84622 = (operand_84463->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2038))).operator_isEqual (GGS_string ("nogetter")) ;
        ...
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_84203->mAttributeName, var_cas_hasSetter, var_cas_hasGetter) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_84203->mAttributeName, var_cas_hasSetter, var_cas_hasGetter) ;
        const GGS_bool cond_85392 = var_cas_hasGetter ;
        if (cond_85392.isBuiltAndTrue ()) {
          var_cas_readerMap.modifier_insertKey (inLexique, operand_84203->mAttributeName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_location (inLexique), GGS_bool (false), var_cas_attributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (2052)) COMMA_SOURCE_FILE_AT_LINE (2045)) ;
        }
      }
    }
    {
      GGS_typedAttributeList::cEnumerator enumerator_85484 (var_cas_currentClassTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_85484 = NULL ;
      while (((operand_85484 = enumerator_85484.nextObject ()))) {
        macroValidPointer (operand_85484) ;
        const GGS_bool cond_85853 = operand_85484->mHasSetter ;
        if (cond_85853.isBuiltAndTrue ()) {
          var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_85484->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2066)).reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (2066)), GGS_formalParameterSignature ::constructor_listWithValue (operand_85484->mAttributeTypeProxy, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (2067))), GGS_bool (false), GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (2069)) COMMA_SOURCE_FILE_AT_LINE (2065)) ;
        }
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_76586->mClassTypeName, (operand_76586->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (2078)), var_cas_allTypedAttributeList, var_cas_attributeMap, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2086)), GGS_enumerationDescriptorList ::constructor_emptyList (), GGS_uint (0U), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_currentClassTypedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2096)), var_cas_generateHeaderInSeparateFile COMMA_SOURCE_FILE_AT_LINE (2074)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_86777,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_86777 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_87135 (operand_86777->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_87135 = NULL ;
      while (((operand_87135 = enumerator_87135.nextObject ()))) {
        macroValidPointer (operand_87135) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_87135->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2112)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2112)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_87135->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_86777->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (2116)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_87681,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_87681 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_88040 (operand_87681->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_88040 = NULL ;
      while (((operand_88040 = enumerator_88040.nextObject ()))) {
        macroValidPointer (operand_88040) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_88040->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2130)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2130)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_87681->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2135)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2135)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_87681->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2137)) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_88753,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_88753 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_88753->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2149)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2149)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_88753->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2151)) ;
  }
}
...
category_method__listmapDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_listmapDeclarationAST * operand_89451,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_89451 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_90021_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_90021_1 ;
    GGS_attributeMap  automatic_var_90021_2 ;
    GGS_typedAttributeList  automatic_var_90021_3 ;
    GGS_constructorMap  automatic_var_90021_4 ;
    GGS_readerMap  automatic_var_90021_5 ;
    GGS_modifierMap  automatic_var_90021_6 ;
    GGS_instanceMethodMap  automatic_var_90021_7 ;
    GGS_classMethodMap  automatic_var_90021_8 ;
    GGS_enumerationDescriptorList  automatic_var_90021_9 ;
    GGS_uint  automatic_var_90021_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_90021_11 ;
    GGS_nativeAttributeList  automatic_var_90021_12 ;
    GGS_stringset  automatic_var_90021_13 ;
    GGS_lstringlist  automatic_var_90021_14 ;
    GGS_typedAttributeList  automatic_var_90021_15 ;
    GGS_mapSearchMethodListAST  automatic_var_90021_16 ;
    GGS_mapSearchMethodListAST  automatic_var_90021_17 ;
    GGS_withAccessorMap  automatic_var_90021_18 ;
    GGS_bool automatic_var_90021_19 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_89451->mAssociatedListTypeName, automatic_var_90021_0, automatic_var_90021_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_90021_2, automatic_var_90021_3, automatic_var_90021_4, automatic_var_90021_5, automatic_var_90021_6, automatic_var_90021_7, automatic_var_90021_8, automatic_var_90021_9, automatic_var_90021_10, automatic_var_90021_11, automatic_var_90021_12, automatic_var_90021_13, automatic_var_90021_14, automatic_var_90021_15, automatic_var_90021_16, automatic_var_90021_17, automatic_var_90021_18, automatic_var_90021_19 COMMA_SOURCE_FILE_AT_LINE (2165)) ;
    }
    const GGS_bool cond_90250 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (2172))) ;
    if (cond_90250.isBuiltAndTrue ()) {
      operand_89451->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_89451->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (2174)) ;
      var_cas_listTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2177)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2178)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2179)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2180)) ;
    GGS_unifiedTypeMapProxy  var_cas_associatedListTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_89451->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2183)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (2183)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_89451->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2186)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (2186)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2189)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("count"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2191)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("allKeys"),  GGS_string ("stringset"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2192)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("keyList"),  GGS_string ("stringlist"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2193)) ;
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("listForKey"),  GGS_string ("string"),  operand_89451->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2194)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2194)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_89451->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2196)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2196)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_92037 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_92037 = NULL ;
      while (((operand_92037 = enumerator_92037.nextObject ()))) {
        macroValidPointer (operand_92037) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_92037->mAttributeTypeProxy) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_89451->mListmapTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (2211)), GGS_typeKindEnum::constructor_listMapType (inLexique COMMA_SOURCE_FILE_AT_LINE (2212)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2214)), var_cas_listTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2220)), var_cas_enumeratorDescriptor, function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (2222)), var_cas_addAssignOperatorDescription, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2230)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2208)) ;
  }
}
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_CompilerEx &,
                                const cPtr_predefinedTypeAST * operand_93875,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_93875 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_93875 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_93875->mPredefinedTypeName, operand_93875) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_classDeclarationAST * operand_94244,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_94244 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_94244->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2270)), operand_94244->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2270)), operand_94244) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_listDeclarationAST * operand_94583,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_94583 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_94583->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2278)), operand_94583) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_structDeclarationAST * operand_94901,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_94901 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_94901->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2286)), operand_94901) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_enumDeclarationAST * operand_95219,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_95219 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_95219->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2294)), operand_95219) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_95541,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_95541 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_95541->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2302)), operand_95541) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_listmapDeclarationAST * operand_95866,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_95866 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_95866->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2310)), operand_95866->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2310)), operand_95866) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_mapDeclarationAST * operand_96214,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_96214 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_96214->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2318)), operand_96214) ;
  }
}
...
category_method__uniqueMapDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_uniqueMapDeclarationAST * operand_96534,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_96534 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_96534->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2326)), operand_96534) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_96853,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_96853 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_96853->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2334)), operand_96853->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2334)), operand_96853) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_CompilerEx &,
                                const cPtr_externFunctionDeclarationAST * operand_97212,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_97212 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_97212) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterOrderedDeclaration (C_CompilerEx &,
                                const cPtr_onceFunctionDeclarationAST * operand_97516,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_97516 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_97516) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_CompilerEx &,
                                const cPtr_externRoutineDeclarationAST * operand_97821,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_97821 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_97821) ;
  }
}
...
category_method__filewrapperDeclarationAST__enterOrderedDeclaration (C_CompilerEx &,
                                const cPtr_filewrapperDeclarationAST * operand_98124,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_98124 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_98124) ;
  }
}
...
void routine_buildSemanticContext (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_collectedTypeMap  var_cas_collectedTypeMap = GGS_collectedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2382)) ;
  GGS_categoryMethodMapForBuildingContext  var_cas_categoryMethodMapForBuildingContext = GGS_categoryMethodMapForBuildingContext ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2383)) ;
  GGS_categoryReaderMapForBuildingContext  var_cas_categoryReaderMapForBuildingContext = GGS_categoryReaderMapForBuildingContext ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2384)) ;
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_99183 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_99183 = NULL ;
    while (((operand_99183 = enumerator_99183.nextObject ()))) {
      macroValidPointer (operand_99183) ;
      { typeCategoryMethod__semanticDeclarationAST__collectTypes method = findCategoryMethod__semanticDeclarationAST__collectTypes (operand_99183->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_99183->mSemanticDeclaration (HERE), var_cas_collectedTypeMap, var_cas_categoryMethodMapForBuildingContext, var_cas_categoryReaderMapForBuildingContext COMMA_SOURCE_FILE_AT_LINE (2386)) ;
        }
      }
    }
  }
  GGS_stringlist  var_cas_undefinedClasses = var_cas_collectedTypeMap.reader_unsolvedProxyKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (2393)) ;
  const GGS_bool cond_99742 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_99742.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_99605 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_99605 = NULL ;
      while (((operand_99605 = enumerator_99605.nextObject ()))) {
        macroValidPointer (operand_99605) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_99605->mValue) ;
      }
    }
    var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (2400)) ;
    var_cas_outSemanticContext.drop () ;
  }else if (cond_99742.isBuiltAndFalse ()) {
    const GGS_bool cond_100044 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_100044.isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = ((GGS_string ("there are ")).operator_concat (var_cas_undefinedClasses.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2401)))).operator_concat (GGS_string (" undefined types:")) ;
      {
        GGS_stringlist::cEnumerator enumerator_99908 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_99908 = NULL ;
        while (((operand_99908 = enumerator_99908.nextObject ()))) {
          macroValidPointer (operand_99908) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_99908->mValue) ;
        }
      }
      var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (2406)) ;
      var_cas_outSemanticContext.drop () ;
    }else if (cond_100044.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_100407 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_100407 = NULL ;
        while (((operand_100407 = enumerator_100407.nextObject ()))) {
          macroValidPointer (operand_100407) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_100407->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_100407->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (2413)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_101521 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_101521 (_variant_101521.isBuilt (), true) ;
      while (_condition_101521.isBuiltAndTrue ()) {
        _condition_101521 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_101521.isBuiltAndTrue ()) {
          if (_variant_101521.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2434)) ;
            _condition_101521 = GGS_bool (false) ;
          }else{
            _variant_101521.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_101136 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_101136 = NULL ;
              while (((operand_101136 = enumerator_101136.nextObject ()))) {
                macroValidPointer (operand_101136) ;
                const GGS_bool cond_101364 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_101136->mDependanceString) ;
                if (cond_101364.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_101136->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_101136->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_101364.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_101136->mDependanceString, operand_101136->mTypeString, operand_101136->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_102361 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_102361.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_102020 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_102020 = enumerator_102020.nextObject () ;
          if ((operand_102020 != NULL)) {
            bool _foreach_loop_102020 ;
            do{
              macroValidPointer (operand_102020) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_102020->mTypeString) ;
              operand_102020 = enumerator_102020.nextObject () ;
              _foreach_loop_102020 = ((operand_102020 != NULL)) ;
              if (_foreach_loop_102020) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_102020) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_102193 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_102193 = NULL ;
          while (((operand_102193 = enumerator_102193.nextObject ()))) {
            macroValidPointer (operand_102193) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_102193->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_102193->mDependanceString) ;
          }
        }
        var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (2453)) ;
        var_cas_outSemanticContext.drop () ;
      }else if (cond_102361.isBuiltAndFalse ()) {
        var_cas_outSemanticContext = GGS_semanticContext::constructor_new (var_cas_inSourceFile, GGS_unifiedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2457)), GGS_routineMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2458)), GGS_functionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2459)), GGS_filewrapperMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2460)), GGS_grammarMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2461)), GGS_optionComponentMapForSemanticAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2462))) ;
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_102799 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_102799 = NULL ;
          while (((operand_102799 = enumerator_102799.nextObject ()))) {
            macroValidPointer (operand_102799) ;
            { typeCategoryMethod__semanticDeclarationAST__enterInSemanticContext method = findCategoryMethod__semanticDeclarationAST__enterInSemanticContext (operand_102799->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_102799->mSemanticDeclaration (HERE), var_cas_categoryMethodMapForBuildingContext, var_cas_categoryReaderMapForBuildingContext, var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (2466)) ;
              }
            }
          }
        }
