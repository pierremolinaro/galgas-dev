...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_69722 (var_files, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_69722.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_69722.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1715)) COMMA_SOURCE_FILE_AT_LINE (1715)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1716)).operator_concat (enumerator_69722.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1716)) ;
      { //-------- @modifierCallInstructionForGeneration
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_69722.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1718)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1717)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @incrementInstructionForGeneration
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1724)) ;
    }else if (kBoolFalse == test_0) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_69722.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1725)) COMMA_SOURCE_FILE_AT_LINE (1725)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1726)).operator_concat (enumerator_69722.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1726)) ;
        { //-------- @modifierCallInstructionForGeneration
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_69722.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1728)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1727)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @incrementInstructionForGeneration
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1734)) ;
      }
    }
    enumerator_69722.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_70687 (var_directories, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_70687.hasCurrentObject ()) {
    ...
    { //-------- @routineCallInstructionForGeneration
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1745)).operator_concat (enumerator_70687.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1745)), constinArgument_inPathInWrapper.operator_concat (enumerator_70687.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1746)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1746)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1744)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_70687.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1755)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1754)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticDeclarationListAST enumerator_138439 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_138439.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_138439.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3368)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_138439.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticDeclarationListAST enumerator_139172 (var_semanticDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_139172.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_139172.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3380)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_139172.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_0) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_139592 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3389)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_139592.hasCurrentObject ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_139592.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_139592.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3390)) COMMA_SOURCE_FILE_AT_LINE (3390)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3390)) COMMA_SOURCE_FILE_AT_LINE (3390)) ;
      enumerator_139592.gotoNextObject () ;
    }
    //-------- @errorInstructionForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_lstringlist joker_140075_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_140075_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3397)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    ...
    if (kBoolTrue == test_2) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_140619 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_140619.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_140619.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3411)) COMMA_SOURCE_FILE_AT_LINE (3411)) COMMA_SOURCE_FILE_AT_LINE (3411)) ;
        enumerator_140619.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_141427 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_141427.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_141427.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3431)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_141427.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_unifiedTypeMapProxyList enumerator_64032 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE_AT_LINE (1551)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_64032.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_formalParameterList.addAssign_operation (enumerator_64032.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1552)) COMMA_SOURCE_FILE_AT_LINE (1552)) ;
    enumerator_64032.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_graphInsertModifierList enumerator_64161 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_64161.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertOrReplace (enumerator_64161.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1557)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1560)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1555)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_64161.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_67396 (object->mAttribute_mConstantList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_67396.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_constantSet.addAssign_operation (enumerator_67396.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1646)) COMMA_SOURCE_FILE_AT_LINE (1646)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_67396.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1647)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1647)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1647)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_67396.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_readerMap var_readerMap ;
  { //-------- @routineCallInstructionForGeneration
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_filewrapperTemplateListAST enumerator_71921 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_71921.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_formalTemplateInputParameterListAST enumerator_72039 (enumerator_71921.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_72039.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_72039.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1777)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1777)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_templateSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1778)) ;
      enumerator_72039.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_71921.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_71921.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1780)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_71921.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_wrapperExtensionMap var_textExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1787)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_72574 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_72574.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_textExtensionMap.modifier_insertKey (enumerator_72574.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1789)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_72574.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_72780 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_72780.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_72780.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1794)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_72780.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_72780.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1795)) COMMA_SOURCE_FILE_AT_LINE (1795)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1795)) COMMA_SOURCE_FILE_AT_LINE (1795)) ;
    }else if (kBoolFalse == test_0) {
      { //-------- @modifierCallInstructionForGeneration
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_72780.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1797)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_72780.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_74730 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_74730.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_74730.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1850)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1850)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_74990 (enumerator_74730.current_mFeatureList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_74990.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_74990.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @assignmentInstructionForGeneration
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_74990.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          //-------- @assignmentInstructionForGeneration
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_74990.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_74730.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1860)) ;
    enumerator_74730.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_75935 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_75935.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (enumerator_75935.current_mAttributeTypeProxy (HERE), enumerator_75935.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1874)) COMMA_SOURCE_FILE_AT_LINE (1874)) ;
    //-------- @plusEqualnstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (enumerator_75935.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (1875)) ;
    //-------- @plusEqualnstructionForGeneration
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_75935.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1876)) COMMA_SOURCE_FILE_AT_LINE (1876)) ;
    //-------- @plusEqualnstructionForGeneration
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_75935.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1877)) COMMA_SOURCE_FILE_AT_LINE (1877)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_77203 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_77203.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = enumerator_77203.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_77203.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1897)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1897)), enumerator_77203.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1897)) COMMA_SOURCE_FILE_AT_LINE (1897)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1898)), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_uintType COMMA_SOURCE_FILE_AT_LINE (1899)), inCompiler->here (), GALGAS_bool (true), enumerator_77203.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1903)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1896)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_77203.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_78320 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_78320.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = enumerator_78320.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      ...
      //-------- @plusEqualnstructionForGeneration
      var_setterFormalArgumentList.addAssign_operation (enumerator_78320.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1937)) COMMA_SOURCE_FILE_AT_LINE (1937)) ;
      //-------- @plusEqualnstructionForGeneration
      ...
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_78320.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1940)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1940)) COMMA_SOURCE_FILE_AT_LINE (1940)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1940)), enumerator_78320.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1940)) COMMA_SOURCE_FILE_AT_LINE (1940)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1941)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1944)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1939)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_78320.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_82054 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_82054.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_82054.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2035)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2035)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    //-------- @plusEqualnstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_82054.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2038)) ;
    //-------- @plusEqualnstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_82054.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2039)) COMMA_SOURCE_FILE_AT_LINE (2039)) ;
    //-------- @plusEqualnstructionForGeneration
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_86597 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_86597.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_86597.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2158)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2158)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    ...
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @plusEqualnstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_86597.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2162)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_attributeMap.modifier_insertKey (enumerator_86597.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2163)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_87335 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_87335.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_87335.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2180)), enumerator_87335.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2181)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2177)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_87335.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_90574 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_90574.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_90574.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2269)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @assignmentInstructionForGeneration
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_90574.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    { //-------- @typeMethodInstructionForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_91067_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_91067_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_91152_2 ; // Joker input parameter
    GALGAS_constructorMap joker_91152_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_91243_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_91243_9 ; // Joker input parameter
    GALGAS_stringlist joker_91243_8 ; // Joker input parameter
    GALGAS_uint joker_91243_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_91243_6 ; // Joker input parameter
    GALGAS_stringset joker_91243_5 ; // Joker input parameter
    GALGAS_lstringlist joker_91243_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_91243_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_91243_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_91243_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_91289_0 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_91067_2, joker_91067_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_91152_2, joker_91152_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_91243_10, joker_91243_9, joker_91243_8, joker_91243_7, joker_91243_6, joker_91243_5, joker_91243_4, joker_91243_3, joker_91243_2, joker_91243_1, var_generateHeaderInSeparateFile, joker_91289_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2279)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_modifierMap enumerator_91577 (var_inheritedModifierMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_91577.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (enumerator_91577.current_lkey (HERE), enumerator_91577.current_mKind (HERE), enumerator_91577.current_mParameterList (HERE), enumerator_91577.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2305)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2300)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_91577.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2310)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_readerMap enumerator_91903 (var_inheritedReaderMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_91903.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_91903.current_lkey (HERE), enumerator_91903.current_mKind (HERE), enumerator_91903.current_mArgumentTypeList (HERE), enumerator_91903.current_mDeclarationLocation (HERE), enumerator_91903.current_mHasCompilerArgument (HERE), enumerator_91903.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2319)), enumerator_91903.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2312)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_91903.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2324)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_instanceMethodMap enumerator_92291 (var_inheritedMethodMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_92291.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_instanceMethodMap.modifier_insertKey (enumerator_92291.current_lkey (HERE), enumerator_92291.current_mKind (HERE), enumerator_92291.current_mParameterList (HERE), enumerator_92291.current_mDeclarationLocation (HERE), enumerator_92291.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2332)), enumerator_92291.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2326)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_92291.gotoNextObject () ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_92710 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_92710.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (enumerator_92710.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2340)) ;
    enumerator_92710.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_92813 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_92813.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_92813.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2344)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2344)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2345)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_attributeMap.modifier_insertKey (enumerator_92813.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2346)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_92813.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2347)) COMMA_SOURCE_FILE_AT_LINE (2347)).boolEnum () ;
    if (kBoolTrue == test_4) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_5 (enumerator_92813.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_92813.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2348)) COMMA_SOURCE_FILE_AT_LINE (2348)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader") COMMA_SOURCE_FILE_AT_LINE (2348)) COMMA_SOURCE_FILE_AT_LINE (2348)) ;
    }
    enumerator_92813.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_93918 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_93918.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_93918.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2369)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2369)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_94178 (enumerator_93918.current_mFeatureList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_94178.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_94178.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2373)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        //-------- @assignmentInstructionForGeneration
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_94178.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2375)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          //-------- @assignmentInstructionForGeneration
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_94178.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_93918.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2379)) ;
    //-------- @plusEqualnstructionForGeneration
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_93918.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2380)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_93918.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2384)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2385)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2389)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2382)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_93918.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_95234 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_95234.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_10 = enumerator_95234.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_95234.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2404)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2404)) COMMA_SOURCE_FILE_AT_LINE (2404)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2404)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2405)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_95234.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2406)) COMMA_SOURCE_FILE_AT_LINE (2406)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2408)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2403)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_95234.gotoNextObject () ;
  }
  { //-------- @routineCallInstructionForGeneration
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListAST enumerator_97358 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_97358.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_97358.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2464)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2464)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_97358.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (2465)) ;
    enumerator_97358.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalInputParameterListAST enumerator_98353 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_98353.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_98353.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2483)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2483)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2484)) ;
    enumerator_98353.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2540)).isValid ()) {
    PMUInt32 variant_101143 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2540)).uintValue () ;
    bool loop_101143 = true ;
    while (loop_101143) {
      loop_101143 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2540)))).isValid () ;
      if (loop_101143) {
        loop_101143 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2540)))).boolValue () ;
      }
      if (loop_101143 && (0 == variant_101143)) {
        loop_101143 = false ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2579)).isValid ()) {
    PMUInt32 variant_102396 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2579)).uintValue () ;
    bool loop_102396 = true ;
    while (loop_102396) {
      loop_102396 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2579)))).isValid () ;
      if (loop_102396) {
        loop_102396 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2579)))).boolValue () ;
      }
      if (loop_102396 && (0 == variant_102396)) {
        loop_102396 = false ;
  ...
  { //-------- @modifierCallInstructionForGeneration
  GALGAS_unifiedTypeMapProxy joker_102991_0 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_102994_0 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_102991_0, joker_102994_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2599)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_typeKindEnum var_typeKindEnum ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_105423_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_105423_1 ; // Joker input parameter
  GALGAS_attributeMap joker_105478_18 ; // Joker input parameter
  GALGAS_typedAttributeList joker_105478_17 ; // Joker input parameter
  GALGAS_constructorMap joker_105478_16 ; // Joker input parameter
  GALGAS_readerMap joker_105478_15 ; // Joker input parameter
  GALGAS_modifierMap joker_105478_14 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_105478_13 ; // Joker input parameter
  GALGAS_classMethodMap joker_105478_12 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_105478_11 ; // Joker input parameter
  GALGAS_stringlist joker_105478_10 ; // Joker input parameter
  GALGAS_uint joker_105478_9 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_105478_8 ; // Joker input parameter
  GALGAS_stringset joker_105478_7 ; // Joker input parameter
  GALGAS_lstringlist joker_105478_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_105478_5 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_105478_4 ; // Joker input parameter
  GALGAS_withAccessorMap joker_105478_3 ; // Joker input parameter
  GALGAS_bool joker_105478_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_105478_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_105423_2, joker_105423_1, var_typeKindEnum, var_listTypedAttributeList, joker_105478_18, joker_105478_17, joker_105478_16, joker_105478_15, joker_105478_14, joker_105478_13, joker_105478_12, joker_105478_11, joker_105478_10, joker_105478_9, joker_105478_8, joker_105478_7, joker_105478_6, joker_105478_5, joker_105478_4, joker_105478_3, joker_105478_2, joker_105478_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2667)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_107502 (var_listTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_107502.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_addAssignOperatorDescription.addAssign_operation (enumerator_107502.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2707)) ;
    enumerator_107502.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_111643 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_111643.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_111643.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2803)) COMMA_SOURCE_FILE_AT_LINE (2803)), enumerator_111643.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2803)) COMMA_SOURCE_FILE_AT_LINE (2803)) COMMA_SOURCE_FILE_AT_LINE (2803)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_111643.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_112498 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_112498.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_112498.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2819)) COMMA_SOURCE_FILE_AT_LINE (2819)), enumerator_112498.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2819)) COMMA_SOURCE_FILE_AT_LINE (2819)) COMMA_SOURCE_FILE_AT_LINE (2819)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_112498.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_113359 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_113359.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_113359.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2835)) COMMA_SOURCE_FILE_AT_LINE (2835)), enumerator_113359.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2835)) COMMA_SOURCE_FILE_AT_LINE (2835)) COMMA_SOURCE_FILE_AT_LINE (2835)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_113359.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_114924 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_114924.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_114924.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2864)) COMMA_SOURCE_FILE_AT_LINE (2864)), enumerator_114924.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2864)) COMMA_SOURCE_FILE_AT_LINE (2864)) COMMA_SOURCE_FILE_AT_LINE (2864)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_114924.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_117418 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_117418.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_117418.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2908)) COMMA_SOURCE_FILE_AT_LINE (2908)), enumerator_117418.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2908)) COMMA_SOURCE_FILE_AT_LINE (2908)) COMMA_SOURCE_FILE_AT_LINE (2908)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_117418.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_118276 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_118276.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_118276.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2924)) COMMA_SOURCE_FILE_AT_LINE (2924)), enumerator_118276.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2924)) COMMA_SOURCE_FILE_AT_LINE (2924)) COMMA_SOURCE_FILE_AT_LINE (2924)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_118276.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_127358 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3096)) ;
  if (NULL != objectArray_127358) {
      macroValidSharedObject (objectArray_127358, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_127358->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3097)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_128659 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3124)) ;
  if (NULL != objectArray_128659) {
      macroValidSharedObject (objectArray_128659, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_128659->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3125)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_129930 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3151)) ;
  if (NULL != objectArray_129930) {
      macroValidSharedObject (objectArray_129930, cMapElement_categoryModifierMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_129930->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3152)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_131830 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3190)) ;
  if (NULL != objectArray_131830) {
      macroValidSharedObject (objectArray_131830, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_131830->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3191)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_133179 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3218)) ;
  if (NULL != objectArray_133179) {
      macroValidSharedObject (objectArray_133179, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_133179->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3219)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_134490 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3245)) ;
  if (NULL != objectArray_134490) {
      macroValidSharedObject (objectArray_134490, cMapElement_categoryModifierMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_134490->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3246)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_135329 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_135329.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_structAttributeList.addAssign_operation (enumerator_135329.current_mAttributeTypeName (HERE), enumerator_135329.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3275)) COMMA_SOURCE_FILE_AT_LINE (3272)) ;
    enumerator_135329.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_135963 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_135963.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_structAttributeList.addAssign_operation (enumerator_135963.current_mAttributeTypeName (HERE), enumerator_135963.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3296)) COMMA_SOURCE_FILE_AT_LINE (3293)) ;
    enumerator_135963.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_136605 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_136605.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_structAttributeList.addAssign_operation (enumerator_136605.current_mAttributeTypeName (HERE), enumerator_136605.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3317)) COMMA_SOURCE_FILE_AT_LINE (3314)) ;
    enumerator_136605.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
