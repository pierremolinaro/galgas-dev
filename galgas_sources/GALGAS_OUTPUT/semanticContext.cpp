...
category_method__classDeclarationAST__enterType (C_Compiler & inLexique,
  ...
  if (operand_43534 != NULL) {
    ...
    if (cond_44435.isBuiltAndTrue ()) {
      ...
      {
        GGS_readerMap::cEnumerator enumerator_45496 (var_cas_inheritedReaderMap, true) ;
        const GGS_readerMap::cElement * operand_45496 = NULL ;
        while (((operand_45496 = enumerator_45496.nextObject ()))) {
          macroValidPointer (operand_45496) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_45496->mKey, operand_45496->mInfo.mArgumentTypeList, operand_45496->mInfo.mHasCompilerArgument, operand_45496->mInfo.mReturnedType, GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1143)) COMMA_SOURCE_FILE_AT_LINE (1138)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_45865 (var_cas_inheritedTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_45865 = NULL ;
      while (((operand_45865 = enumerator_45865.nextObject ()))) {
        macroValidPointer (operand_45865) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_45865->mAttributeTypeIndex) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_45968 (operand_43534->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_45968 = NULL ;
      while (((operand_45968 = enumerator_45968.nextObject ()))) {
        macroValidPointer (operand_45968) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_45968->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1154)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1154)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_45968->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1156)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_classIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_43534->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1160)), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1160)) ;
    ...
    const GGS_bool cond_46694 = (operand_43534->mIsAbstract).operator_not () ;
    if (cond_46694.isBuiltAndTrue ()) {
    ...
    {
      GGS_instanceMethodMap::cEnumerator enumerator_46825 (var_cas_inheritedInstanceMethodMap, true) ;
      const GGS_instanceMethodMap::cElement * operand_46825 = NULL ;
      while (((operand_46825 = enumerator_46825.nextObject ()))) {
        macroValidPointer (operand_46825) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_46825->mKey, operand_46825->mInfo.mParameterList, operand_46825->mInfo.mDeclarationLocation, operand_46825->mInfo.mHasCompilerArgument, GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1179)) COMMA_SOURCE_FILE_AT_LINE (1174)) ;
      }
    }
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_47088 (operand_43534->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_47088 = NULL ;
      while (((operand_47088 = enumerator_47088.nextObject ()))) {
        macroValidPointer (operand_47088) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_47177 (operand_47088->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_47177 = NULL ;
          while (((operand_47177 = enumerator_47177.nextObject ()))) {
            macroValidPointer (operand_47177) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_47177->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1187)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1187)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_47177->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_47458 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_47088->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1190))) ;
        if (NULL != operand_47458) {
          operand_47458->mInfo.mQualifier = GGS_readerQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1191)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_47088->mMethodName, var_cas_formalArgumentList, operand_47088->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1196)), GGS_bool (true), GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1198)) COMMA_SOURCE_FILE_AT_LINE (1193)) ;
        }
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_47840 (operand_43534->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_47840 = NULL ;
      while (((operand_47840 = enumerator_47840.nextObject ()))) {
        macroValidPointer (operand_47840) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_47929 (operand_47840->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_47929 = NULL ;
          while (((operand_47929 = enumerator_47929.nextObject ()))) {
            macroValidPointer (operand_47929) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_47929->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1207)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1207)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_47929->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_48210 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_47840->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1210))) ;
        if (NULL != operand_48210) {
          operand_48210->mInfo.mQualifier = GGS_readerQualifier::constructor_isOverriding (inLexique COMMA_SOURCE_FILE_AT_LINE (1211)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_47840->mMethodName, var_cas_formalArgumentList, operand_47840->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1216)), GGS_bool (true), GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1218)) COMMA_SOURCE_FILE_AT_LINE (1213)) ;
        }
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_48709 (operand_43534->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_48709 = NULL ;
      while (((operand_48709 = enumerator_48709.nextObject ()))) {
        macroValidPointer (operand_48709) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_48709->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1227)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1227)) ;
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_48709->mAttributeName) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_48709->mAttributeName) ;
        var_cas_readerMap.modifier_insertKey (inLexique, operand_48709->mAttributeName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1235)) COMMA_SOURCE_FILE_AT_LINE (1230)) ;
      }
    }
    const GGS_bool cond_49710 = (operand_43534->mIsAbstract).operator_not () ;
    if (cond_49710.isBuiltAndTrue ()) {
      {
        GGS_typedAttributeList::cEnumerator enumerator_49361 (var_cas_allTypedAttributeList, true) ;
        const GGS_typedAttributeList::cElement * operand_49361 = NULL ;
        while (((operand_49361 = enumerator_49361.nextObject ()))) {
          macroValidPointer (operand_49361) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_49361->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1242)), GGS_formalParameterSignature ::constructor_listWithValue (operand_49361->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1243))), GGS_bool (false), GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1245)) COMMA_SOURCE_FILE_AT_LINE (1241)) ;
        }
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_43534->mClassTypeName, (operand_43534->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1254)), var_cas_allTypedAttributeList, var_cas_attributeMap, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1262)), GGS_enumerationDescriptorList ::constructor_emptyList (), ((function_generateCppConstructorWithAllAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1264))).operator_or (function_generateVirtualDestructor (inLexique COMMA_SOURCE_FILE_AT_LINE (1264)))).operator_or (((operand_43534->mIsAbstract).isBuiltAndTrue () ? (GGS_uint (0U)) : (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1264))))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_currentClassTypedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1272)) COMMA_SOURCE_FILE_AT_LINE (1250)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_50721,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_50721 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_50907 (operand_50721->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_50907 = NULL ;
      while (((operand_50907 = enumerator_50907.nextObject ()))) {
        macroValidPointer (operand_50907) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_50907->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1285)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1285)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_50907->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_50721->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1289)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_51440,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_51440 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_51627 (operand_51440->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_51627 = NULL ;
      while (((operand_51627 = enumerator_51627.nextObject ()))) {
        macroValidPointer (operand_51627) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51627->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1301)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1301)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51440->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1306)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1306)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_51440->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1308)) ;
  }
}
...
category_method__lazyFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_lazyFunctionDeclarationAST * operand_52327,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_52327 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_52327->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1319)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1319)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_52327->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1321)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_52895,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_52895 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_53280_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_53280_1 ;
    GGS_attributeMap  automatic_var_53280_2 ;
    GGS_typedAttributeList  automatic_var_53280_3 ;
    GGS_constructorMap  automatic_var_53280_4 ;
    GGS_readerMap  automatic_var_53280_5 ;
    GGS_modifierMap  automatic_var_53280_6 ;
    GGS_instanceMethodMap  automatic_var_53280_7 ;
    GGS_classMethodMap  automatic_var_53280_8 ;
    GGS_enumerationDescriptorList  automatic_var_53280_9 ;
    GGS_uint  automatic_var_53280_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_53280_11 ;
    GGS_nativeAttributeList  automatic_var_53280_12 ;
    GGS_stringset  automatic_var_53280_13 ;
    GGS_lstringlist  automatic_var_53280_14 ;
    GGS_typedAttributeList  automatic_var_53280_15 ;
    GGS_mapSearchMethodListAST  automatic_var_53280_16 ;
    GGS_mapSearchMethodListAST  automatic_var_53280_17 ;
    GGS_withAccessorMap  automatic_var_53280_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_52895->mAssociatedListTypeName, automatic_var_53280_0, automatic_var_53280_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_53280_2, automatic_var_53280_3, automatic_var_53280_4, automatic_var_53280_5, automatic_var_53280_6, automatic_var_53280_7, automatic_var_53280_8, automatic_var_53280_9, automatic_var_53280_10, automatic_var_53280_11, automatic_var_53280_12, automatic_var_53280_13, automatic_var_53280_14, automatic_var_53280_15, automatic_var_53280_16, automatic_var_53280_17, automatic_var_53280_18 COMMA_SOURCE_FILE_AT_LINE (1333)) ;
    }
    const GGS_bool cond_53509 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1340))) ;
    if (cond_53509.isBuiltAndTrue ()) {
      operand_52895->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_52895->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1342)) ;
      var_cas_listTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1345)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1346)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1347)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1348)) ;
    GGS_unifiedTypeMapProxy  var_cas_associatedListTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_52895->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1351)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1351)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_52895->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1354)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1354)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1357)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("count"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1359)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_52895->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1361)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1361)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_54930 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_54930 = NULL ;
      while (((operand_54930 = enumerator_54930.nextObject ()))) {
        macroValidPointer (operand_54930) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_54930->mAttributeTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("listmap"), var_cas_superTypeProxy COMMA_SOURCE_FILE_AT_LINE (1374)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_52895->mListmapTypeName, GGS_bool (true), var_cas_superTypeProxy, GGS_typeKindEnum::constructor_listMapType (inLexique COMMA_SOURCE_FILE_AT_LINE (1379)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1381)), var_cas_listTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1387)), var_cas_enumeratorDescriptor, (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1389))).operator_or (function_generateCppConstructorWithNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1389))), var_cas_addAssignOperatorDescription, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1397)) COMMA_SOURCE_FILE_AT_LINE (1375)) ;
  }
}
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_56894,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_56894 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_56894 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation ((findCategoryReader__predefinedTypeAST__getSuperTypeName (var_cas_t (HERE)->galgasRTTI ()) (inLexique, var_cas_t.getPtr () COMMA_SOURCE_FILE_AT_LINE (1428))), operand_56894->mPredefinedTypeName, operand_56894) ;
  }
}
...
category_method__objectPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_objectPredefinedTypeAST * operand_57277,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57277 != NULL) {
    GGS_objectPredefinedTypeAST  var_cas_t = operand_57277 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string ("object"), operand_57277) ;
  }
}
...
category_method__stringsetPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_stringsetPredefinedTypeAST * operand_57640,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57640 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enumerable"), operand_57640->mPredefinedTypeName, operand_57640) ;
  }
}
...
category_method__genericTypeTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_genericTypeTypeAST * operand_57959,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57959 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_57959->mSuperTypeName, operand_57959->mTypeName, operand_57959) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_58271,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58271 != NULL) {
    const GGS_string var_cas_actualSuperTypeName = (((operand_58271->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1461))).operator_isEqual (GGS_string (""))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_58271->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1461)))) ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (var_cas_actualSuperTypeName, operand_58271->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1462)), operand_58271) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_58723,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58723 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("list"), operand_58723->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1470)), operand_58723) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_59041,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59041 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("struct"), operand_59041->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1478)), operand_59041) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_59361,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59361 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enum"), operand_59361->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1486)), operand_59361) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_59683,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59683 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("sortedlist"), operand_59683->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1494)), operand_59683) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_60014,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60014 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_60014->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1502)), operand_60014->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1502)), operand_60014) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_60358,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60358 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("map"), operand_60358->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1510)), operand_60358) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_60676,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60676 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_60676->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1518)), operand_60676->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1518)), operand_60676) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externFunctionDeclarationAST * operand_61031,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61031 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_61031) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externRoutineDeclarationAST * operand_61332,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61332 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_61332) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  #endif
  GGS_collectedTypeMap  var_cas_collectedTypeMap = GGS_collectedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1549)) ;
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_62186 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_62186 = NULL ;
    while (((operand_62186 = enumerator_62186.nextObject ()))) {
      macroValidPointer (operand_62186) ;
      { typeCategoryMethod__semanticDeclarationAST__collectType method = findCategoryMethod__semanticDeclarationAST__collectType (operand_62186->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_62186->mSemanticDeclaration (HERE), var_cas_collectedTypeMap COMMA_SOURCE_FILE_AT_LINE (1551)) ;
        }
      }
    }
  }
  GGS_stringlist  var_cas_undefinedClasses = var_cas_collectedTypeMap.reader_unsolvedIndexKeyStringList (inLexique COMMA_SOURCE_FILE_AT_LINE (1554)) ;
  const GGS_bool cond_62651 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_62651.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_62514 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_62514 = NULL ;
      while (((operand_62514 = enumerator_62514.nextObject ()))) {
        macroValidPointer (operand_62514) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_62514->mValue) ;
      }
    }
    var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (1561)) ;
    var_cas_outSemanticContext.drop () ;
  }else if (cond_62651.isBuiltAndFalse ()) {
    const GGS_bool cond_62953 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_62953.isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = ((GGS_string ("there are ")).operator_concat (var_cas_undefinedClasses.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1562)))).operator_concat (GGS_string (" undefined types:")) ;
      {
        GGS_stringlist::cEnumerator enumerator_62817 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_62817 = NULL ;
        while (((operand_62817 = enumerator_62817.nextObject ()))) {
          macroValidPointer (operand_62817) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_62817->mValue) ;
        }
      }
      ...
      var_cas_outSemanticContext.drop () ;
    }else if (cond_62953.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_63316 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_63316 = NULL ;
        while (((operand_63316 = enumerator_63316.nextObject ()))) {
          macroValidPointer (operand_63316) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_63316->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_63316->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (1574)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_64430 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_64430 (_variant_64430.isBuilt (), true) ;
      while (_condition_64430.isBuiltAndTrue ()) {
        _condition_64430 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_64430.isBuiltAndTrue ()) {
          if (_variant_64430.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1595)) ;
            _condition_64430 = GGS_bool (false) ;
          }else{
            _variant_64430.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_64045 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_64045 = NULL ;
              while (((operand_64045 = enumerator_64045.nextObject ()))) {
                macroValidPointer (operand_64045) ;
                const GGS_bool cond_64273 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_64045->mDependanceString) ;
                if (cond_64273.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_64045->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_64045->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_64273.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_64045->mDependanceString, operand_64045->mTypeString, operand_64045->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_65053 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_65053.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_64712 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_64712 = enumerator_64712.nextObject () ;
          if ((operand_64712 != NULL)) {
            bool _foreach_loop_64712 ;
            do{
              macroValidPointer (operand_64712) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_64712->mTypeString) ;
              operand_64712 = enumerator_64712.nextObject () ;
              _foreach_loop_64712 = ((operand_64712 != NULL)) ;
              if (_foreach_loop_64712) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_64712) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_64885 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_64885 = NULL ;
          while (((operand_64885 = enumerator_64885.nextObject ()))) {
            macroValidPointer (operand_64885) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_64885->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_64885->mDependanceString) ;
          }
        }
        var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (1608)) ;
        var_cas_outSemanticContext.drop () ;
      }else if (cond_65053.isBuiltAndFalse ()) {
        var_cas_outSemanticContext = GGS_semanticContext::constructor_new (GGS_unifiedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1611)), GGS_routineMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1612)), GGS_functionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1613)), GGS_filewrapperMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1614)), GGS_grammarMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1615)), GGS_optionComponentMapForSemanticAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1616))) ;
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_65469 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_65469 = NULL ;
          while (((operand_65469 = enumerator_65469.nextObject ()))) {
            macroValidPointer (operand_65469) ;
            { typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (operand_65469->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_65469->mSemanticDeclaration (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (1620)) ;
              }
            }
          }
        }
