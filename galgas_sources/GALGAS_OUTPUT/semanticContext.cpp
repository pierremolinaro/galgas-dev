...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  ioArgument_ioWrapperDirectoryIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1710)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_stringlist var_files = constinArgument_inAbsoluteSourcePath.reader_regularFiles (GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1712)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outWrapperFileMap = GALGAS_wrapperFileMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1713)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_69692 (var_files, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_69692.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_69692.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1715)) COMMA_SOURCE_FILE_AT_LINE (1715)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1716)).operator_concat (enumerator_69692.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1716)) ;
      { //-------- @modifierCallInstructionForGeneration
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_69692.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1718)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1717)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @incrementInstructionForGeneration
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1724)) ;
    }else if (kBoolFalse == test_0) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_69692.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1725)) COMMA_SOURCE_FILE_AT_LINE (1725)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1726)).operator_concat (enumerator_69692.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1726)) ;
        { //-------- @modifierCallInstructionForGeneration
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_69692.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1728)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1727)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @incrementInstructionForGeneration
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1734)) ;
      }
    }
    enumerator_69692.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_stringlist var_directories = constinArgument_inAbsoluteSourcePath.reader_directories (GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1738)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outWrapperDirectoryMap = GALGAS_wrapperDirectoryMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1739)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_70657 (var_directories, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_70657.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    ...
    { //-------- @routineCallInstructionForGeneration
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1745)).operator_concat (enumerator_70657.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1745)), constinArgument_inPathInWrapper.operator_concat (enumerator_70657.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1746)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1746)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1744)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_70657.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1755)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1754)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_70657.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticDeclarationListAST enumerator_138409 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_138409.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_138409.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3368)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_138409.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_semanticTypePrecedenceGraph var_semanticTypePrecedenceGraph = GALGAS_semanticTypePrecedenceGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (3374)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_categoryMethodMapForBuildingContext var_categoryMethodMapForBuildingContext = GALGAS_categoryMethodMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3375)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_categoryReaderMapForBuildingContext var_categoryReaderMapForBuildingContext = GALGAS_categoryReaderMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3376)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_categoryModifierMapForBuildingContext var_categoryModifierMapForBuildingContext = GALGAS_categoryModifierMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3377)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_semanticDeclarationListAST var_categoryOverrideDefinitionList = GALGAS_semanticDeclarationListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3378)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticDeclarationListAST enumerator_139142 (var_semanticDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_139142.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_139142.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3380)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_139142.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (3388)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_139562 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3389)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_139562.hasCurrentObject ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_139562.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_139562.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3390)) COMMA_SOURCE_FILE_AT_LINE (3390)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3390)) COMMA_SOURCE_FILE_AT_LINE (3390)) ;
      enumerator_139562.gotoNextObject () ;
    }
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("semantic analysis not performed, due to undefined type error(s)") COMMA_SOURCE_FILE_AT_LINE (3392)) ;
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_lstringlist joker_140045_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_140045_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3397)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3408)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("semantic analysis not performed, ").operator_concat (var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3409)).reader_string (SOURCE_FILE_AT_LINE (3409)) COMMA_SOURCE_FILE_AT_LINE (3409)).operator_concat (GALGAS_string (" declarations are involved in circular definition:") COMMA_SOURCE_FILE_AT_LINE (3409)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_140589 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_140589.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_140589.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3411)) COMMA_SOURCE_FILE_AT_LINE (3411)) COMMA_SOURCE_FILE_AT_LINE (3411)) ;
        enumerator_140589.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (3413)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      //-------- @concatInstructionForGeneration
      var_sortedSemanticDeclarationListAST.dotAssign_operation (var_categoryOverrideDefinitionList COMMA_SOURCE_FILE_AT_LINE (3416)) ;
      //-------- @assignmentInstructionForGeneration
      outArgument_outSemanticContext = GALGAS_semanticContext::constructor_new (constinArgument_inSourceFile, GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3420)), GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3421)), GALGAS_functionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3422)), GALGAS_filewrapperMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3423)), GALGAS_grammarMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3424)), GALGAS_optionComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3425)), GALGAS_lexiqueComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3426)), GALGAS_optionMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3427)) COMMA_SOURCE_FILE_AT_LINE (3418)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_141397 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_141397.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_141397.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3431)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_141397.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  { //-------- @modifierCallInstructionForGeneration
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("emptyGraph"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1543)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1544)), GALGAS_bool (false), var_graphTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1542)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1549)) ;
  //-------- @plusEqualnstructionForGeneration
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1550)) COMMA_SOURCE_FILE_AT_LINE (1550)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_unifiedTypeMapProxyList enumerator_64002 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE_AT_LINE (1551)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_64002.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_formalParameterList.addAssign_operation (enumerator_64002.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1552)) COMMA_SOURCE_FILE_AT_LINE (1552)) ;
    enumerator_64002.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_graphInsertModifierList enumerator_64131 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_64131.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertOrReplace (enumerator_64131.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1557)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1560)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1555)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @plusEqualnstructionForGeneration
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1567)) COMMA_SOURCE_FILE_AT_LINE (1567)) ;
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("addArc"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1569)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1570)), var_formalParameterList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1573)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1568)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1577)) ;
  //-------- @plusEqualnstructionForGeneration
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1578)) COMMA_SOURCE_FILE_AT_LINE (1578)) ;
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("noteNode"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1580)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1581)), var_formalParameterList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1584)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1579)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mGraphTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1588)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mGraphTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1602)), GALGAS_typeKindEnum::constructor_graphType (SOURCE_FILE_AT_LINE (1603)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1604)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1605)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1606)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1611)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1612)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1613)), function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (1614)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1615)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1616)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1617)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1618)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1619)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1620)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1622)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1599)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1636)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1637)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1638)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_classMethodMap var_classMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1639)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_currentTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1642)), var_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1642)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_constantSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1644)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_67366 (object->mAttribute_mConstantList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_67366.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_constantSet.addAssign_operation (enumerator_67366.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1646)) COMMA_SOURCE_FILE_AT_LINE (1646)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_67366.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1647)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1647)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1647)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_67366.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_readerMap var_readerMap ;
  { //-------- @routineCallInstructionForGeneration
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1651)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mEnumTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1653)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mEnumTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1667)), GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE_AT_LINE (1668)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1669)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1670)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1671)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1676)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1677)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1678)), function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (1679)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1679)) COMMA_SOURCE_FILE_AT_LINE (1679)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1680)), var_constantSet, object->mAttribute_mConstantList, GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1683)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1684)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1685)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1687)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1664)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_filewrapperDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_filewrapperTemplateMap var_filewrapperTemplateMap = GALGAS_filewrapperTemplateMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1772)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_filewrapperTemplateListAST enumerator_71891 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_71891.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_unifiedTypeMapProxyList var_templateSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1774)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_formalTemplateInputParameterListAST enumerator_72009 (enumerator_71891.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_72009.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_72009.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1777)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1777)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_templateSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1778)) ;
      enumerator_72009.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_71891.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_71891.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1780)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_71891.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_wrapperExtensionMap var_textExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1787)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_72544 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_72544.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_textExtensionMap.modifier_insertKey (enumerator_72544.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1789)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_72544.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_wrapperExtensionMap var_binaryFileExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1792)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_72750 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_72750.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_72750.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1794)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_72750.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_72750.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1795)) COMMA_SOURCE_FILE_AT_LINE (1795)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1795)) COMMA_SOURCE_FILE_AT_LINE (1795)) ;
    }else if (kBoolFalse == test_0) {
      { //-------- @modifierCallInstructionForGeneration
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_72750.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1797)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_72750.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1804)).reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1804)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @assignmentInstructionForGeneration
    var_absoluteSourcePath = object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1805)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @assignmentInstructionForGeneration
    var_absoluteSourcePath = object->mAttribute_mSourceFileAbsolutePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (1807)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1807)).operator_concat (object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1807)) COMMA_SOURCE_FILE_AT_LINE (1807)) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_3 = var_absoluteSourcePath.reader_directoryExists (SOURCE_FILE_AT_LINE (1809)).operator_not (SOURCE_FILE_AT_LINE (1809)).boolEnum () ;
  if (kBoolTrue == test_3) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_4 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_4, GALGAS_string ("The '").operator_concat (var_absoluteSourcePath COMMA_SOURCE_FILE_AT_LINE (1810)).operator_concat (GALGAS_string ("' directory does not exist") COMMA_SOURCE_FILE_AT_LINE (1810)) COMMA_SOURCE_FILE_AT_LINE (1810)) ;
    ...
    { //-------- @routineCallInstructionForGeneration
    routine_recursivelyEnumerateDirectories (var_absoluteSourcePath, GALGAS_string ("/"), var_textExtensionMap, var_binaryFileExtensionMap, var_regularRootFileMap, var_wrapperDirectoryMap, var_wrapperFileIndex, var_wrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1816)) ;
    } //-------- @routineCallInstructionForGeneration
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mFilewrapperMap.modifier_insertKey (object->mAttribute_mFilewrapperName, object->mAttribute_mFilewrapperPath, object->mAttribute_mFilewrapperTextFileExtensionList, var_regularRootFileMap, var_wrapperDirectoryMap, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1828)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_74700 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_74700.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_74700.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1850)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1850)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_74960 (enumerator_74700.current_mFeatureList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_74960.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_74960.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @assignmentInstructionForGeneration
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_74960.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          //-------- @assignmentInstructionForGeneration
    ...
    //-------- @plusEqualnstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_74700.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1860)) ;
    enumerator_74700.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_uintType ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (1864)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_listTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (1867)), var_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (1867)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1869)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1870)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formalParameterSignature var_modifierOutputFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1871)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formalParameterSignature var_modifierInputFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1872)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_75905 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_75905.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (enumerator_75905.current_mAttributeTypeProxy (HERE), enumerator_75905.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1874)) COMMA_SOURCE_FILE_AT_LINE (1874)) ;
    //-------- @plusEqualnstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (enumerator_75905.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (1875)) ;
    //-------- @plusEqualnstructionForGeneration
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_75905.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1876)) COMMA_SOURCE_FILE_AT_LINE (1876)) ;
    //-------- @plusEqualnstructionForGeneration
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_75905.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1877)) COMMA_SOURCE_FILE_AT_LINE (1877)) ;
    enumerator_75905.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1880)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyList"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (1881)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1881)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("listWithValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1883)), var_constructorAttributeTypeList, GALGAS_bool (false), var_listTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1882)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  { //-------- @routineCallInstructionForGeneration
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("range"), GALGAS_string ("range"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1891)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("subListFromIndex"), GALGAS_string ("uint"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (1892)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1892)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("subListWithRange"), GALGAS_string ("range"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (1893)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1893)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_77173 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_77173.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = enumerator_77173.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_77173.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1897)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1897)), enumerator_77173.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1897)) COMMA_SOURCE_FILE_AT_LINE (1897)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1898)), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_uintType COMMA_SOURCE_FILE_AT_LINE (1899)), inCompiler->here (), GALGAS_bool (true), enumerator_77173.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1903)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1896)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_77173.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1909)) ;
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popFirst"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1911)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1912)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1915)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1910)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popLast"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1919)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1920)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1923)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1918)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("prependValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1927)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1928)), var_modifierInputFormalArgumentList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1931)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1926)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_78290 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_78290.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = enumerator_78290.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_formalParameterSignature var_setterFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1936)) ;
      //-------- @plusEqualnstructionForGeneration
      var_setterFormalArgumentList.addAssign_operation (enumerator_78290.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1937)) COMMA_SOURCE_FILE_AT_LINE (1937)) ;
      //-------- @plusEqualnstructionForGeneration
      var_setterFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1938)) COMMA_SOURCE_FILE_AT_LINE (1938)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_78290.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1940)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1940)) COMMA_SOURCE_FILE_AT_LINE (1940)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1940)), enumerator_78290.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1940)) COMMA_SOURCE_FILE_AT_LINE (1940)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1941)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1944)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1939)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_78290.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1950)) ;
  { //-------- @modifierCallInstructionForGeneration
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("first"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1952)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1953)), var_modifierOutputFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1957)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1951)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("last"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1961)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1962)), var_modifierOutputFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1966)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1960)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1969)) ;
  //-------- @plusEqualnstructionForGeneration
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (1970)) ;
  //-------- @plusEqualnstructionForGeneration
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (1971)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mListTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1973)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (1985)) COMMA_SOURCE_FILE_AT_LINE (1985)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (1985)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1990)), GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (1991)), var_typedAttributeList, GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1993)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1994)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1999)), var_enumerationDescriptor, var_enumerationVariants, function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2002)).operator_or (function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2002)) COMMA_SOURCE_FILE_AT_LINE (2002)).operator_or (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2002)) COMMA_SOURCE_FILE_AT_LINE (2002)), var_constructorAttributeTypeList, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2004)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2005)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2006)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2007)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2008)), GALGAS_bool (false), var_enumeratedTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1987)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_uintType ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2024)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_listTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2027)), var_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (2027)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2029)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2030)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2031)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2032)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_82024 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_82024.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_82024.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2035)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2035)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    //-------- @plusEqualnstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_82024.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2038)) ;
    //-------- @plusEqualnstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_82024.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2039)) COMMA_SOURCE_FILE_AT_LINE (2039)) ;
    //-------- @plusEqualnstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2040)) ;
    //-------- @plusEqualnstructionForGeneration
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2041)) COMMA_SOURCE_FILE_AT_LINE (2041)) ;
    enumerator_82024.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2044)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptySortedList"), object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2045)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2045)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("sortedListWithValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2047)), var_constructorAttributeTypeList, GALGAS_bool (false), var_listTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2046)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2053)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("length"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2054)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2056)) ;
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popGreatest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2058)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2059)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2062)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2057)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popSmallest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2066)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2067)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2070)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2065)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2074)) ;
  { //-------- @modifierCallInstructionForGeneration
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("greatest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2076)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2077)), var_modifierFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2081)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2075)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("smallest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2085)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2086)), var_modifierFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2090)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2084)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2094)) ;
  //-------- @plusEqualnstructionForGeneration
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2095)) ;
  //-------- @plusEqualnstructionForGeneration
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2096)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mSortedListTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2098)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mSortedListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2110)) COMMA_SOURCE_FILE_AT_LINE (2110)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2110)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mSortedListTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2115)), GALGAS_typeKindEnum::constructor_sortedListType (SOURCE_FILE_AT_LINE (2116)), var_typedAttributeList, GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2118)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2119)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2124)), var_enumerationDescriptor, var_enumerationVariants, function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2127)).operator_or (function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2127)) COMMA_SOURCE_FILE_AT_LINE (2127)).operator_or (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2127)) COMMA_SOURCE_FILE_AT_LINE (2127)), var_constructorAttributeTypeList, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2129)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2130)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2131)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2132)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2133)), GALGAS_bool (false), var_enumeratedTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2112)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (2150)), var_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (2150)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeMap var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2152)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2153)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2154)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2155)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_86567 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_86567.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_86567.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2158)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2158)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2159)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @plusEqualnstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_86567.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2162)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_attributeMap.modifier_insertKey (enumerator_86567.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2163)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_86567.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2166)), var_constructorAttributeTypeList, GALGAS_bool (false), var_structTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2165)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_readerMap var_readerMap ;
  { //-------- @routineCallInstructionForGeneration
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2173)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_87305 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_87305.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_87305.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2180)), enumerator_87305.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2181)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2177)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_87305.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2187)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2189)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mStructTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2191)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  ...
  if (kBoolTrue == test_0) {
    //-------- @assignmentInstructionForGeneration
    var_enumeratedType = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2204)) ;
  }else if (kBoolFalse == test_0) {
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumeratedElementTypeName, var_enumeratedType COMMA_SOURCE_FILE_AT_LINE (2206)) ;
    } //-------- @routineCallInstructionForGeneration
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mStructTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2216)), GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (2217)), var_typedAttributeList, var_attributeMap, var_typedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2225)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2226)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2227)), function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (2228)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2229)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2230)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2231)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2232)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2233)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2234)), GALGAS_bool (false), var_enumeratedType, inCompiler COMMA_SOURCE_FILE_AT_LINE (2213)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_uintType ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2249)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_readerMap var_readerMap ;
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeMap var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2255)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_superClassIndex ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_bool var_generateHeaderInSeparateFile ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2259)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @assignmentInstructionForGeneration
    var_superClassIndex = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2260)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2262)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2263)) ;
    //-------- @assignmentInstructionForGeneration
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2264)) ;
    //-------- @assignmentInstructionForGeneration
    var_inheritedTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2265)) ;
    //-------- @assignmentInstructionForGeneration
    var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2266)) ;
    //-------- @assignmentInstructionForGeneration
    var_generateHeaderInSeparateFile = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_90544 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_90544.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_90544.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2269)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @assignmentInstructionForGeneration
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_90544.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2274)), var_superClassIndex COMMA_SOURCE_FILE_AT_LINE (2274)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_typeKindEnum var_typeKindEnum ;
    //-------- @localVariableDeclarationForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_91037_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_91037_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_91122_2 ; // Joker input parameter
    GALGAS_constructorMap joker_91122_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_91213_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_91213_9 ; // Joker input parameter
    GALGAS_stringlist joker_91213_8 ; // Joker input parameter
    GALGAS_uint joker_91213_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_91213_6 ; // Joker input parameter
    GALGAS_stringset joker_91213_5 ; // Joker input parameter
    GALGAS_lstringlist joker_91213_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_91213_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_91213_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_91213_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_91259_0 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_91037_2, joker_91037_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_91122_2, joker_91122_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_91213_10, joker_91213_9, joker_91213_8, joker_91213_7, joker_91213_6, joker_91213_5, joker_91213_4, joker_91213_3, joker_91213_2, joker_91213_1, var_generateHeaderInSeparateFile, joker_91259_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2279)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2294)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (object->mAttribute_mSuperClassName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the @").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2295)) COMMA_SOURCE_FILE_AT_LINE (2295)).operator_concat (GALGAS_string (" should be a class type") COMMA_SOURCE_FILE_AT_LINE (2295)) COMMA_SOURCE_FILE_AT_LINE (2295)) ;
    }
    //-------- @assignmentInstructionForGeneration
    var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2298)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_modifierMap enumerator_91547 (var_inheritedModifierMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_91547.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (enumerator_91547.current_lkey (HERE), enumerator_91547.current_mKind (HERE), enumerator_91547.current_mParameterList (HERE), enumerator_91547.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2305)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2300)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_91547.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2310)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_readerMap enumerator_91873 (var_inheritedReaderMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_91873.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_91873.current_lkey (HERE), enumerator_91873.current_mKind (HERE), enumerator_91873.current_mArgumentTypeList (HERE), enumerator_91873.current_mDeclarationLocation (HERE), enumerator_91873.current_mHasCompilerArgument (HERE), enumerator_91873.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2319)), enumerator_91873.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2312)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_91873.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2324)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_instanceMethodMap enumerator_92261 (var_inheritedMethodMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_92261.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_instanceMethodMap.modifier_insertKey (enumerator_92261.current_lkey (HERE), enumerator_92261.current_mKind (HERE), enumerator_92261.current_mParameterList (HERE), enumerator_92261.current_mDeclarationLocation (HERE), enumerator_92261.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2332)), enumerator_92261.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2326)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_92261.gotoNextObject () ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2338)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_92680 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_92680.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (enumerator_92680.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2340)) ;
    enumerator_92680.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_92783 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_92783.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_92783.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2344)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2344)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2345)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_attributeMap.modifier_insertKey (enumerator_92783.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2346)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_92783.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2347)) COMMA_SOURCE_FILE_AT_LINE (2347)).boolEnum () ;
    if (kBoolTrue == test_4) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_5 (enumerator_92783.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_92783.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2348)) COMMA_SOURCE_FILE_AT_LINE (2348)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader") COMMA_SOURCE_FILE_AT_LINE (2348)) COMMA_SOURCE_FILE_AT_LINE (2348)) ;
    }
    enumerator_92783.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_classIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (2353)), var_classIndex COMMA_SOURCE_FILE_AT_LINE (2353)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2355)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_6 = object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (2356)).boolEnum () ;
  if (kBoolTrue == test_6) {
    { //-------- @modifierCallInstructionForGeneration
    var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2358)), var_constructorAttributeTypeList, GALGAS_bool (false), var_classIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2357)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_typedAttributeList var_currentClassTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2365)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_typedAttributeList var_allTypedAttributeList = var_inheritedTypedAttributeList ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_93888 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_93888.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_93888.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2369)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2369)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_94148 (enumerator_93888.current_mFeatureList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_94148.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_94148.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2373)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        //-------- @assignmentInstructionForGeneration
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_94148.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2375)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          //-------- @assignmentInstructionForGeneration
          var_hasGetter = GALGAS_bool (false) ;
        }
    ...
    //-------- @plusEqualnstructionForGeneration
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_93888.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2379)) ;
    //-------- @plusEqualnstructionForGeneration
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_93888.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2380)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_93888.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2384)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2385)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2389)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2382)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_93888.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_95204 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_95204.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_10 = enumerator_95204.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_95204.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2404)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2404)) COMMA_SOURCE_FILE_AT_LINE (2404)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2404)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2405)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_95204.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2406)) COMMA_SOURCE_FILE_AT_LINE (2406)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2408)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2403)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_95204.gotoNextObject () ;
  }
  { //-------- @routineCallInstructionForGeneration
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mClassTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2414)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mClassTypeName, object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (2427)), var_superClassIndex, GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2429)), var_allTypedAttributeList, var_attributeMap, var_currentClassTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2437)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2438)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2439)), GALGAS_uint ((PMUInt32) 0U), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2441)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2442)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2443)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2444)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2445)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2446)), var_generateHeaderInSeparateFile, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2448)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2425)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_externRoutineDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formalParameterSignature var_routineSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2461)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListAST enumerator_97328 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_97328.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_97328.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2464)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2464)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_97328.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (2465)) ;
    enumerator_97328.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mRoutineMap.modifier_insertKey (object->mAttribute_mRoutineName, var_routineSignature, inCompiler COMMA_SOURCE_FILE_AT_LINE (2468)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_externFunctionDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unifiedTypeMapProxyList var_functionSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2480)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalInputParameterListAST enumerator_98323 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_98323.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_98323.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2483)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2483)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2484)) ;
    enumerator_98323.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName.reader_string (SOURCE_FILE_AT_LINE (2488)), var_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2488)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2490)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName.reader_string (SOURCE_FILE_AT_LINE (2503)), var_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2503)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2505)), var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2505)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_arrayDeclarationAST) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2517)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mDimension.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the dimension of an array should be > 0") COMMA_SOURCE_FILE_AT_LINE (2518)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_arrayTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mArrayTypeName.reader_string (SOURCE_FILE_AT_LINE (2522)), var_arrayTypeIndex COMMA_SOURCE_FILE_AT_LINE (2522)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_elementTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mElementTypeName.reader_string (SOURCE_FILE_AT_LINE (2525)), var_elementTypeIndex COMMA_SOURCE_FILE_AT_LINE (2525)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("bool"), var_boolType COMMA_SOURCE_FILE_AT_LINE (2533)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_uintType ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2536)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unifiedTypeMapProxyList var_uintArgs = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2538)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  //-------- @loopInstructionForGeneration
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2540)).isValid ()) {
    PMUInt32 variant_101113 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2540)).uintValue () ;
    bool loop_101113 = true ;
    while (loop_101113) {
      loop_101113 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2540)))).isValid () ;
      if (loop_101113) {
        loop_101113 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2540)))).boolValue () ;
      }
      if (loop_101113 && (0 == variant_101113)) {
        loop_101113 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2540)) ;
      }
      if (loop_101113) {
        variant_101113 -- ;
        //-------- @plusEqualnstructionForGeneration
        var_uintArgs.addAssign_operation (var_uintType COMMA_SOURCE_FILE_AT_LINE (2541)) ;
        //-------- @incrementInstructionForGeneration
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (2542)) ;
      }
    }
  }
  { //-------- @modifierCallInstructionForGeneration
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2546)), var_uintArgs, GALGAS_bool (false), var_arrayTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2545)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterBaseReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("axisCount"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2552)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("sizeForAxis"), GALGAS_string ("uint"), GALGAS_string ("uint"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2553)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("rangeForAxis"), GALGAS_string ("uint"), GALGAS_string ("range"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2554)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("isValueValidAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2556)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2557)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_boolType, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2562)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2555)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("valueAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2566)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2567)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_elementTypeIndex, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2572)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2565)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2576)) ;
  //-------- @plusEqualnstructionForGeneration
  var_modifierFormalArgumentList.addAssign_operation (var_elementTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2577)) COMMA_SOURCE_FILE_AT_LINE (2577)) ;
  //-------- @assignmentInstructionForGeneration
  var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  //-------- @loopInstructionForGeneration
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2579)).isValid ()) {
    PMUInt32 variant_102366 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2579)).uintValue () ;
    bool loop_102366 = true ;
    while (loop_102366) {
      loop_102366 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2579)))).isValid () ;
      if (loop_102366) {
        loop_102366 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2579)))).boolValue () ;
      }
      if (loop_102366 && (0 == variant_102366)) {
        loop_102366 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2579)) ;
      }
      if (loop_102366) {
        variant_102366 -- ;
        //-------- @plusEqualnstructionForGeneration
        var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2580)) COMMA_SOURCE_FILE_AT_LINE (2580)) ;
        //-------- @incrementInstructionForGeneration
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (2581)) ;
      }
    }
  }
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertKey (GALGAS_string ("setValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2584)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2585)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2588)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2583)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertKey (GALGAS_string ("forceValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2592)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2593)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2596)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2591)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  GALGAS_unifiedTypeMapProxy joker_102961_0 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_102964_0 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_102961_0, joker_102964_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2599)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertKey (GALGAS_string ("invalidateValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2601)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2602)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2605)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2600)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSize").reader_nowhere (SOURCE_FILE_AT_LINE (2609)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2610)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2613)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2608)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2616)) ;
  //-------- @plusEqualnstructionForGeneration
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2617)) COMMA_SOURCE_FILE_AT_LINE (2617)) ;
  //-------- @plusEqualnstructionForGeneration
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2618)) COMMA_SOURCE_FILE_AT_LINE (2618)) ;
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSizeForAxis").reader_nowhere (SOURCE_FILE_AT_LINE (2620)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2621)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2624)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2619)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mArrayTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2631)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE_AT_LINE (2632)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2633)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2634)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2635)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2640)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2641)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2642)), GALGAS_uint ((PMUInt32) 0U), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2644)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2645)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2646)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2647)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2648)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2649)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2651)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2628)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_typeKindEnum var_typeKindEnum ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_105393_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_105393_1 ; // Joker input parameter
  GALGAS_attributeMap joker_105448_18 ; // Joker input parameter
  GALGAS_typedAttributeList joker_105448_17 ; // Joker input parameter
  GALGAS_constructorMap joker_105448_16 ; // Joker input parameter
  GALGAS_readerMap joker_105448_15 ; // Joker input parameter
  GALGAS_modifierMap joker_105448_14 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_105448_13 ; // Joker input parameter
  GALGAS_classMethodMap joker_105448_12 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_105448_11 ; // Joker input parameter
  GALGAS_stringlist joker_105448_10 ; // Joker input parameter
  GALGAS_uint joker_105448_9 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_105448_8 ; // Joker input parameter
  GALGAS_stringset joker_105448_7 ; // Joker input parameter
  GALGAS_lstringlist joker_105448_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_105448_5 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_105448_4 ; // Joker input parameter
  GALGAS_withAccessorMap joker_105448_3 ; // Joker input parameter
  GALGAS_bool joker_105448_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_105448_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_105393_2, joker_105393_1, var_typeKindEnum, var_listTypedAttributeList, joker_105448_18, joker_105448_17, joker_105448_16, joker_105448_15, joker_105448_14, joker_105448_13, joker_105448_12, joker_105448_11, joker_105448_10, joker_105448_9, joker_105448_8, joker_105448_7, joker_105448_6, joker_105448_5, joker_105448_4, joker_105448_3, joker_105448_2, joker_105448_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2667)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (2674)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2675)) COMMA_SOURCE_FILE_AT_LINE (2675)).operator_concat (GALGAS_string ("' type should be a list type") COMMA_SOURCE_FILE_AT_LINE (2675)) COMMA_SOURCE_FILE_AT_LINE (2675)) ;
    //-------- @assignmentInstructionForGeneration
    var_listTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2676)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2679)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2680)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2681)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2682)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_associatedListTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2685)), var_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (2685)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_currentTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2688)), var_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (2688)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2691)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("count"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2693)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("allKeys"), GALGAS_string ("stringset"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2694)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2695)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("listForKey"), GALGAS_string ("string"), object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2696)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2696)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyMap"), object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2698)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2698)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_enumerationDescriptorList var_enumeratorDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2700)) ;
  //-------- @plusEqualnstructionForGeneration
  var_enumeratorDescriptor.addAssign_operation (var_stringTypeIndex, GALGAS_string ("key") COMMA_SOURCE_FILE_AT_LINE (2701)) ;
  //-------- @plusEqualnstructionForGeneration
  var_enumeratorDescriptor.addAssign_operation (var_associatedListTypeIndex, GALGAS_string ("mList") COMMA_SOURCE_FILE_AT_LINE (2702)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unifiedTypeMapProxyList var_addAssignOperatorDescription = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2704)) ;
  //-------- @plusEqualnstructionForGeneration
  var_addAssignOperatorDescription.addAssign_operation (var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2705)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_107472 (var_listTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_107472.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_addAssignOperatorDescription.addAssign_operation (enumerator_107472.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2707)) ;
    enumerator_107472.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2710)) ;
  //-------- @plusEqualnstructionForGeneration
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2711)) ;
  //-------- @plusEqualnstructionForGeneration
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2712)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mListmapTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2714)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2726)) COMMA_SOURCE_FILE_AT_LINE (2726)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2726)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListmapTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2731)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE_AT_LINE (2732)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2733)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2734)), var_listTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2740)), var_enumeratorDescriptor, var_enumerationVariants, function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2743)), var_addAssignOperatorDescription, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2745)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2746)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2747)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2748)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2749)), GALGAS_bool (false), var_enumeratedTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2728)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_predefinedTypeAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mPredefinedTypeName COMMA_SOURCE_FILE_AT_LINE (2784)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2784)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_predefinedTypeAST temp_0 = object ;
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_classDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (2797)) COMMA_SOURCE_FILE_AT_LINE (2797)), object->mAttribute_mClassTypeName.reader_location (SOURCE_FILE_AT_LINE (2797)) COMMA_SOURCE_FILE_AT_LINE (2797)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_classDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2798)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2800)) COMMA_SOURCE_FILE_AT_LINE (2800)), object->mAttribute_mSuperClassName.reader_location (SOURCE_FILE_AT_LINE (2800)) COMMA_SOURCE_FILE_AT_LINE (2800)) COMMA_SOURCE_FILE_AT_LINE (2800)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_111613 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_111613.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_111613.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2803)) COMMA_SOURCE_FILE_AT_LINE (2803)), enumerator_111613.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2803)) COMMA_SOURCE_FILE_AT_LINE (2803)) COMMA_SOURCE_FILE_AT_LINE (2803)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_111613.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_listDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2816)) COMMA_SOURCE_FILE_AT_LINE (2816)), object->mAttribute_mListTypeName.reader_location (SOURCE_FILE_AT_LINE (2816)) COMMA_SOURCE_FILE_AT_LINE (2816)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_112468 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_112468.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_112468.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2819)) COMMA_SOURCE_FILE_AT_LINE (2819)), enumerator_112468.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2819)) COMMA_SOURCE_FILE_AT_LINE (2819)) COMMA_SOURCE_FILE_AT_LINE (2819)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_112468.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_structDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (2832)) COMMA_SOURCE_FILE_AT_LINE (2832)), object->mAttribute_mStructTypeName.reader_location (SOURCE_FILE_AT_LINE (2832)) COMMA_SOURCE_FILE_AT_LINE (2832)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_113329 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_113329.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_113329.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2835)) COMMA_SOURCE_FILE_AT_LINE (2835)), enumerator_113329.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2835)) COMMA_SOURCE_FILE_AT_LINE (2835)) COMMA_SOURCE_FILE_AT_LINE (2835)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_113329.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (2848)) COMMA_SOURCE_FILE_AT_LINE (2848)), object->mAttribute_mEnumTypeName.reader_location (SOURCE_FILE_AT_LINE (2848)) COMMA_SOURCE_FILE_AT_LINE (2848)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_sortedListDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2861)) COMMA_SOURCE_FILE_AT_LINE (2861)), object->mAttribute_mSortedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2861)) COMMA_SOURCE_FILE_AT_LINE (2861)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_sortedListDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2862)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_114894 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_114894.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_114894.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2864)) COMMA_SOURCE_FILE_AT_LINE (2864)), enumerator_114894.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2864)) COMMA_SOURCE_FILE_AT_LINE (2864)) COMMA_SOURCE_FILE_AT_LINE (2864)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_114894.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_arrayDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mArrayTypeName.reader_string (SOURCE_FILE_AT_LINE (2877)) COMMA_SOURCE_FILE_AT_LINE (2877)), object->mAttribute_mArrayTypeName.reader_location (SOURCE_FILE_AT_LINE (2877)) COMMA_SOURCE_FILE_AT_LINE (2877)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mElementTypeName.reader_string (SOURCE_FILE_AT_LINE (2879)) COMMA_SOURCE_FILE_AT_LINE (2879)), object->mAttribute_mElementTypeName.reader_location (SOURCE_FILE_AT_LINE (2879)) COMMA_SOURCE_FILE_AT_LINE (2879)) COMMA_SOURCE_FILE_AT_LINE (2879)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_listmapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2891)) COMMA_SOURCE_FILE_AT_LINE (2891)), object->mAttribute_mListmapTypeName.reader_location (SOURCE_FILE_AT_LINE (2891)) COMMA_SOURCE_FILE_AT_LINE (2891)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_listmapDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2892)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2893)) COMMA_SOURCE_FILE_AT_LINE (2893)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2893)) COMMA_SOURCE_FILE_AT_LINE (2893)) COMMA_SOURCE_FILE_AT_LINE (2893)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_mapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2905)) COMMA_SOURCE_FILE_AT_LINE (2905)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2905)) COMMA_SOURCE_FILE_AT_LINE (2905)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_mapDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2906)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_117388 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_117388.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_117388.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2908)) COMMA_SOURCE_FILE_AT_LINE (2908)), enumerator_117388.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2908)) COMMA_SOURCE_FILE_AT_LINE (2908)) COMMA_SOURCE_FILE_AT_LINE (2908)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_117388.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_118246 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_118246.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_118246.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2924)) COMMA_SOURCE_FILE_AT_LINE (2924)), enumerator_118246.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2924)) COMMA_SOURCE_FILE_AT_LINE (2924)) COMMA_SOURCE_FILE_AT_LINE (2924)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_118246.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapProxyDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_mapProxyDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE_AT_LINE (2937)) COMMA_SOURCE_FILE_AT_LINE (2937)), object->mAttribute_mMapProxyTypeName.reader_location (SOURCE_FILE_AT_LINE (2937)) COMMA_SOURCE_FILE_AT_LINE (2937)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2939)) COMMA_SOURCE_FILE_AT_LINE (2939)), object->mAttribute_mAssociatedMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2939)) COMMA_SOURCE_FILE_AT_LINE (2939)) COMMA_SOURCE_FILE_AT_LINE (2939)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_graphDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_graphDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mGraphTypeName.reader_string (SOURCE_FILE_AT_LINE (2951)) COMMA_SOURCE_FILE_AT_LINE (2951)), object->mAttribute_mGraphTypeName.reader_location (SOURCE_FILE_AT_LINE (2951)) COMMA_SOURCE_FILE_AT_LINE (2951)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_graphDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2952)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2953)) COMMA_SOURCE_FILE_AT_LINE (2953)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2953)) COMMA_SOURCE_FILE_AT_LINE (2953)) COMMA_SOURCE_FILE_AT_LINE (2953)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externTypeDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_externTypeDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mExternTypeName.reader_string (SOURCE_FILE_AT_LINE (2965)) COMMA_SOURCE_FILE_AT_LINE (2965)), object->mAttribute_mExternTypeName.reader_location (SOURCE_FILE_AT_LINE (2965)) COMMA_SOURCE_FILE_AT_LINE (2965)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_externTypeDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2966)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (2978)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (2990)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3002)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3014)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3026)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3038)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3050)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3062)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3074)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_categoryReaderAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3086)) COMMA_SOURCE_FILE_AT_LINE (3086)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3086)).operator_concat (object->mAttribute_mCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (3086)) COMMA_SOURCE_FILE_AT_LINE (3086)), object->mAttribute_mCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (3086)) COMMA_SOURCE_FILE_AT_LINE (3086)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryReaderAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3087)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3088)) COMMA_SOURCE_FILE_AT_LINE (3088)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3088)) COMMA_SOURCE_FILE_AT_LINE (3088)) COMMA_SOURCE_FILE_AT_LINE (3088)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3090)) COMMA_SOURCE_FILE_AT_LINE (3090)).operator_not (SOURCE_FILE_AT_LINE (3090)).boolEnum () ;
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3093)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3091)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_127328 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3096)) ;
  if (NULL != objectArray_127328) {
      macroValidSharedObject (objectArray_127328, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_127328->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3097)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_categoryMethodAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3114)) COMMA_SOURCE_FILE_AT_LINE (3114)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3114)).operator_concat (object->mAttribute_mCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (3114)) COMMA_SOURCE_FILE_AT_LINE (3114)), object->mAttribute_mCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (3114)) COMMA_SOURCE_FILE_AT_LINE (3114)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3116)) COMMA_SOURCE_FILE_AT_LINE (3116)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3116)) COMMA_SOURCE_FILE_AT_LINE (3116)) COMMA_SOURCE_FILE_AT_LINE (3116)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3118)) COMMA_SOURCE_FILE_AT_LINE (3118)).operator_not (SOURCE_FILE_AT_LINE (3118)).boolEnum () ;
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3121)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3119)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_128629 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3124)) ;
  if (NULL != objectArray_128629) {
      macroValidSharedObject (objectArray_128629, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_128629->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3125)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_categoryModifierAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3141)) COMMA_SOURCE_FILE_AT_LINE (3141)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3141)).operator_concat (object->mAttribute_mCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (3141)) COMMA_SOURCE_FILE_AT_LINE (3141)), object->mAttribute_mCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (3141)) COMMA_SOURCE_FILE_AT_LINE (3141)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3145)) COMMA_SOURCE_FILE_AT_LINE (3145)).operator_not (SOURCE_FILE_AT_LINE (3145)).boolEnum () ;
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3148)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3146)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_129900 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3151)) ;
  if (NULL != objectArray_129900) {
      macroValidSharedObject (objectArray_129900, cMapElement_categoryModifierMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_129900->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3152)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3168)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_abstractCategoryReaderAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3180)) COMMA_SOURCE_FILE_AT_LINE (3180)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3180)).operator_concat (object->mAttribute_mAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (3180)) COMMA_SOURCE_FILE_AT_LINE (3180)), object->mAttribute_mAbstractCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (3180)) COMMA_SOURCE_FILE_AT_LINE (3180)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_abstractCategoryReaderAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3181)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3182)) COMMA_SOURCE_FILE_AT_LINE (3182)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3182)) COMMA_SOURCE_FILE_AT_LINE (3182)) COMMA_SOURCE_FILE_AT_LINE (3182)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3184)) COMMA_SOURCE_FILE_AT_LINE (3184)).operator_not (SOURCE_FILE_AT_LINE (3184)).boolEnum () ;
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3187)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3185)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_131800 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3190)) ;
  if (NULL != objectArray_131800) {
      macroValidSharedObject (objectArray_131800, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_131800->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3191)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_abstractCategoryMethodAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3208)) COMMA_SOURCE_FILE_AT_LINE (3208)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3208)).operator_concat (object->mAttribute_mAbstractCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (3208)) COMMA_SOURCE_FILE_AT_LINE (3208)), object->mAttribute_mAbstractCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (3208)) COMMA_SOURCE_FILE_AT_LINE (3208)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_abstractCategoryMethodAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3209)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3210)) COMMA_SOURCE_FILE_AT_LINE (3210)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3210)) COMMA_SOURCE_FILE_AT_LINE (3210)) COMMA_SOURCE_FILE_AT_LINE (3210)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3212)) COMMA_SOURCE_FILE_AT_LINE (3212)).operator_not (SOURCE_FILE_AT_LINE (3212)).boolEnum () ;
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3215)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3213)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_133149 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3218)) ;
  if (NULL != objectArray_133149) {
      macroValidSharedObject (objectArray_133149, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_133149->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3219)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_abstractCategoryModifierAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3235)) COMMA_SOURCE_FILE_AT_LINE (3235)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3235)).operator_concat (object->mAttribute_mAbstractCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (3235)) COMMA_SOURCE_FILE_AT_LINE (3235)), object->mAttribute_mAbstractCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (3235)) COMMA_SOURCE_FILE_AT_LINE (3235)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3237)) COMMA_SOURCE_FILE_AT_LINE (3237)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3237)) COMMA_SOURCE_FILE_AT_LINE (3237)) COMMA_SOURCE_FILE_AT_LINE (3237)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3239)) COMMA_SOURCE_FILE_AT_LINE (3239)).operator_not (SOURCE_FILE_AT_LINE (3239)).boolEnum () ;
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3242)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3240)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_134460 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3245)) ;
  if (NULL != objectArray_134460) {
      macroValidSharedObject (objectArray_134460, cMapElement_categoryModifierMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_134460->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3246)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_mapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3265)) ;
  //-------- @plusEqualnstructionForGeneration
  var_structAttributeList.addAssign_operation (GALGAS_string ("lstring").reader_nowhere (SOURCE_FILE_AT_LINE (3267)), GALGAS_string ("lkey").reader_nowhere (SOURCE_FILE_AT_LINE (3268)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3269)) COMMA_SOURCE_FILE_AT_LINE (3266)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_135299 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_135299.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_structAttributeList.addAssign_operation (enumerator_135299.current_mAttributeTypeName (HERE), enumerator_135299.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3275)) COMMA_SOURCE_FILE_AT_LINE (3272)) ;
    enumerator_135299.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mMapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3280)) COMMA_SOURCE_FILE_AT_LINE (3280)), object->mAttribute_mMapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3280)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3278)) COMMA_SOURCE_FILE_AT_LINE (3278)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_listDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3291)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_135933 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_135933.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_structAttributeList.addAssign_operation (enumerator_135933.current_mAttributeTypeName (HERE), enumerator_135933.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3296)) COMMA_SOURCE_FILE_AT_LINE (3293)) ;
    enumerator_135933.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3301)) COMMA_SOURCE_FILE_AT_LINE (3301)), object->mAttribute_mListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3301)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3299)) COMMA_SOURCE_FILE_AT_LINE (3299)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_sortedListDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3312)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_136575 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_136575.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_structAttributeList.addAssign_operation (enumerator_136575.current_mAttributeTypeName (HERE), enumerator_136575.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3317)) COMMA_SOURCE_FILE_AT_LINE (3314)) ;
    enumerator_136575.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mSortedListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3322)) COMMA_SOURCE_FILE_AT_LINE (3322)), object->mAttribute_mSortedListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3322)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3320)) COMMA_SOURCE_FILE_AT_LINE (3320)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_listmapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3333)) ;
  //-------- @plusEqualnstructionForGeneration
  var_structAttributeList.addAssign_operation (GALGAS_string ("string").reader_nowhere (SOURCE_FILE_AT_LINE (3335)), GALGAS_string ("key").reader_nowhere (SOURCE_FILE_AT_LINE (3336)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3337)) COMMA_SOURCE_FILE_AT_LINE (3334)) ;
  //-------- @plusEqualnstructionForGeneration
  var_structAttributeList.addAssign_operation (object->mAttribute_mAssociatedListTypeName, GALGAS_string ("mList").reader_nowhere (SOURCE_FILE_AT_LINE (3341)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3342)) COMMA_SOURCE_FILE_AT_LINE (3339)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3347)) COMMA_SOURCE_FILE_AT_LINE (3347)), object->mAttribute_mListmapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3347)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3345)) COMMA_SOURCE_FILE_AT_LINE (3345)) ;
}
//---------------------------------------------------------------------------*
