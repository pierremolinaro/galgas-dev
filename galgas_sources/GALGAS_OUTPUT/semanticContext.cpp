...
category_method__mapDeclarationAST__enterType (C_Compiler & inLexique,
  ...
  if (operand_16863 != NULL) {
    ...
    ::routine_enterInheritedReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("locationForKey"),  GGS_string ("string"),  GGS_string ("location"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (446)) ;
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_19182 (operand_16863->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_19182 = NULL ;
      while (((operand_19182 = enumerator_19182.nextObject ()))) {
        macroValidPointer (operand_19182) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_19182->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (456)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (456)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_19182->mAttributeName) ;
        var_cas_enumerationDescriptor.addAssign_operation (var_cas_attributeTypeIndex, operand_19182->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (458))) ;
    ...
    {
      GGS_insertMethodListAST::cEnumerator enumerator_19786 (operand_16863->mInsertMethodList, true) ;
      const GGS_insertMethodListAST::cElement * operand_19786 = NULL ;
      while (((operand_19786 = enumerator_19786.nextObject ()))) {
        macroValidPointer (operand_19786) ;
        const GGS_bool cond_19941 = var_cas_modifierMap.reader_hasKey (operand_19786->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (464))) ;
        if (cond_19941.isBuiltAndTrue ()) {
          operand_19786->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_19786->mMethodName)).operator_concat (GGS_string ("' insert method is already declared")) COMMA_SOURCE_FILE_AT_LINE (466)) ;
        }else if (cond_19941.isBuiltAndFalse ()) {
          var_cas_modifierMap.modifier_insertOrReplace (inLexique, operand_19786->mMethodName, var_cas_insertMethodFormalArgumentList, GGS_bool (true), GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (471)) COMMA_SOURCE_FILE_AT_LINE (467)) ;
        }
      }
    }
    {
      GGS_mapRemoveMethodListAST::cEnumerator enumerator_20185 (operand_16863->mRemoveMethodList, true) ;
      const GGS_mapRemoveMethodListAST::cElement * operand_20185 = NULL ;
      while (((operand_20185 = enumerator_20185.nextObject ()))) {
        macroValidPointer (operand_20185) ;
        const GGS_bool cond_20376 = var_cas_modifierMap.reader_hasKey (operand_20185->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (477))) ;
        if (cond_20376.isBuiltAndTrue ()) {
          operand_20185->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_20185->mMethodName)).operator_concat (GGS_string ("' method is already declared as an insert modifier or a remove modifier")) COMMA_SOURCE_FILE_AT_LINE (479)) ;
        }else if (cond_20376.isBuiltAndFalse ()) {
          var_cas_modifierMap.modifier_insertOrReplace (inLexique, operand_20185->mMethodName, var_cas_removeMethodFormalArgumentList, GGS_bool (true), GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (484)) COMMA_SOURCE_FILE_AT_LINE (480)) ;
        }
      }
    }
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_20618 (operand_16863->mSearchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_20618 = NULL ;
      while (((operand_20618 = enumerator_20618.nextObject ()))) {
        macroValidPointer (operand_20618) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_20618->mMethodName, var_cas_removeMethodFormalArgumentList, operand_20618->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (493)), GGS_bool (true), GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (495)) COMMA_SOURCE_FILE_AT_LINE (490)) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_20875 (operand_16863->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_20875 = NULL ;
      while (((operand_20875 = enumerator_20875.nextObject ()))) {
        macroValidPointer (operand_20875) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, (operand_20875->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (500))).operator_concat (GGS_string ("ForKey")), operand_20875->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (500)) COMMA_SOURCE_FILE_AT_LINE (500)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_20875->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (502)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (502)) ;
    ...
    const GGS_bool cond_21785 = (operand_16863->mInsertOrReplaceDeclarationListAST.reader_length ()).operator_supOrEqual (GGS_uint (1U)) ;
    if (cond_21785.isBuiltAndTrue ()) {
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_21870 (operand_16863->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_21870 = NULL ;
      while (((operand_21870 = enumerator_21870.nextObject ()))) {
        macroValidPointer (operand_21870) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_21870->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")), operand_21870->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (524)) COMMA_SOURCE_FILE_AT_LINE (524)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_21870->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (526)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (526)) ;
    ...
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_22813 (operand_16863->mSearchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_22813 = NULL ;
      while (((operand_22813 = enumerator_22813.nextObject ()))) {
        macroValidPointer (operand_22813) ;
        var_cas_withAccessorMap.modifier_insertKey (inLexique, operand_22813->mMethodName, var_cas_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (541)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
...
category_method__mapProxyDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_23933,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_23933 != NULL) {
    ...
    GGS_bool automatic_var_24362_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_24362_1 ;
    GGS_typedAttributeList  automatic_var_24362_2 ;
    GGS_attributeMap  automatic_var_24362_3 ;
    GGS_constructorMap  automatic_var_24362_4 ;
    GGS_readerMap  automatic_var_24362_5 ;
    GGS_modifierMap  automatic_var_24362_6 ;
    GGS_instanceMethodMap  automatic_var_24362_7 ;
    GGS_classMethodMap  automatic_var_24362_8 ;
    GGS_enumerationDescriptorList  automatic_var_24362_9 ;
    GGS_uint  automatic_var_24362_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_24362_11 ;
    GGS_nativeAttributeList  automatic_var_24362_12 ;
    GGS_stringset  automatic_var_24362_13 ;
    GGS_lstringlist  automatic_var_24362_14 ;
    GGS_typedAttributeList  automatic_var_24362_15 ;
    GGS_mapSearchMethodListAST  automatic_var_24362_16 ;
    GGS_withAccessorMap  automatic_var_24362_17 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_23933->mAssociatedMapTypeName, automatic_var_24362_0, automatic_var_24362_1, var_cas_typeKindEnum, automatic_var_24362_2, automatic_var_24362_3, var_cas_mapTypedAttributeList, automatic_var_24362_4, automatic_var_24362_5, automatic_var_24362_6, automatic_var_24362_7, automatic_var_24362_8, automatic_var_24362_9, automatic_var_24362_10, automatic_var_24362_11, automatic_var_24362_12, automatic_var_24362_13, automatic_var_24362_14, automatic_var_24362_15, var_cas_searchMethodList, automatic_var_24362_16, automatic_var_24362_17 COMMA_SOURCE_FILE_AT_LINE (585)) ;
    }
    const GGS_bool cond_24579 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_mapType (inLexique COMMA_SOURCE_FILE_AT_LINE (595))) ;
    if (cond_24579.isBuiltAndTrue ()) {
      operand_23933->mAssociatedMapTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_23933->mAssociatedMapTypeName)).operator_concat (GGS_string (" should be a map type")) COMMA_SOURCE_FILE_AT_LINE (597)) ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_23933->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (607)), var_cas_associatedMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (607)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_23933->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (616)), var_cas_mapProxyTypeProxy COMMA_SOURCE_FILE_AT_LINE (616)) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("null"),  operand_23933->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (628)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (628)) ;
    ...
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_26379 (var_cas_searchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_26379 = NULL ;
      while (((operand_26379 = enumerator_26379.nextObject ()))) {
        macroValidPointer (operand_26379) ;
        var_cas_constructorMap.modifier_insertKey (inLexique, operand_26379->mMethodName, var_cas_constructorAttributeTypeList, GGS_bool (true), var_cas_mapProxyTypeProxy COMMA_SOURCE_FILE_AT_LINE (634)) ;
      }
    }
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_27353 (var_cas_mapTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_27353 = NULL ;
      while (((operand_27353 = enumerator_27353.nextObject ()))) {
        macroValidPointer (operand_27353) ;
        const GGS_bool cond_27760 = var_cas_inheritedReaderMap.reader_hasKey (operand_27353->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (651))) ;
        if (cond_27760.isBuiltAndTrue ()) {
          GGS_string var_cas_s = GGS_string ("") ;
          {
            GGS_stringset::cEnumerator enumerator_27461 (var_cas_inheritedReaderMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (653)), true) ;
            if (enumerator_27461 .hasCurrentObject ()) {
              bool _foreach_loop_27461 ;
              do{
                var_cas_s.appendCString ("'") ;
                var_cas_s.dotAssign_operation (enumerator_27461._key (HERE)) ;
                var_cas_s.appendCString ("'") ;
                enumerator_27461.next () ;
                _foreach_loop_27461 = (enumerator_27461 .hasCurrentObject ()) ;
                if (_foreach_loop_27461) {
                  var_cas_s.appendCString (", ") ;
                }
              }while (_foreach_loop_27461) ;
            }
          }
          operand_27353->mAttributeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the map has a associated map proxy, which has predefined readers: ")).operator_concat (var_cas_s)).operator_concat (GGS_string ("; you cannot use theses names for naming an attribute of this map")) COMMA_SOURCE_FILE_AT_LINE (659)) ;
        }else if (cond_27760.isBuiltAndFalse ()) {
          var_cas_readerMap.modifier_insertKey (inLexique, operand_27353->mAttributeName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (true), operand_27353->mAttributeTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (665)) COMMA_SOURCE_FILE_AT_LINE (660)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
...
category_method__enumDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_29029,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_29029 != NULL) {
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_29029->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (712)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (712)) ;
    GGS_stringset  var_cas_constantSet = GGS_stringset ::constructor_emptySet () ;
    {
      GGS_lstringlist::cEnumerator enumerator_29608 (operand_29029->mConstantList, true) ;
      const GGS_lstringlist::cElement * operand_29608 = NULL ;
      while (((operand_29608 = enumerator_29608.nextObject ()))) {
        macroValidPointer (operand_29608) ;
        var_cas_constantSet.addAssign_operation (operand_29608->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (716))) ;
        ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  operand_29608->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (717)),  operand_29029->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (717)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (717)) ;
      }
    }
    {
      GGS_enumMessageListAST::cEnumerator enumerator_29838 (operand_29029->mEnumMessageList, true) ;
      const GGS_enumMessageListAST::cElement * operand_29838 = NULL ;
      while (((operand_29838 = enumerator_29838.nextObject ()))) {
        macroValidPointer (operand_29838) ;
        ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_29838->mEnumMessageName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (721)),  GGS_string ("string"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (721)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
...
category_method__filewrapperDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationAST * operand_31027,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_31027 != NULL) {
    ...
    {
      GGS_filewrapperTemplateListAST::cEnumerator enumerator_31219 (operand_31027->mFilewrapperTemplateList, true) ;
      const GGS_filewrapperTemplateListAST::cElement * operand_31219 = NULL ;
      while (((operand_31219 = enumerator_31219.nextObject ()))) {
        macroValidPointer (operand_31219) ;
        GGS_unifiedTypeMapProxyList  var_cas_templateSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
        {
          GGS_formalInputParameterListAST::cEnumerator enumerator_31337 (operand_31219->mFilewrapperTemplateFormalInputParameters, true) ;
          const GGS_formalInputParameterListAST::cElement * operand_31337 = NULL ;
          while (((operand_31337 = enumerator_31337.nextObject ()))) {
            macroValidPointer (operand_31337) ;
            GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_31337->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (764)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (764)) ;
            var_cas_templateSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
          }
        }
        var_cas_filewrapperTemplateMap.modifier_insertKey (inLexique, operand_31219->mFilewrapperTemplateName, var_cas_templateSignature, operand_31219->mFilewrapperTemplatePath COMMA_SOURCE_FILE_AT_LINE (767)) ;
      }
    }
    var_cas_ioSemanticContext.mFilewrapperMap.modifier_insertKey (inLexique, operand_31027->mFilewrapperName, operand_31027->mFilewrapperPath, operand_31027->mFilewrapperExtensionList, var_cas_filewrapperTemplateMap COMMA_SOURCE_FILE_AT_LINE (773)) ;
  }
}
...
category_method__listDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_32038,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_32038 != NULL) {
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_32229 (operand_32038->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_32229 = NULL ;
      while (((operand_32229 = enumerator_32229.nextObject ()))) {
        macroValidPointer (operand_32229) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_32229->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (791)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (791)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_32229->mAttributeName) ;
      }
    }
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_32038->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (799)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (799)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_33146 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_33146 = NULL ;
      while (((operand_33146 = enumerator_33146.nextObject ()))) {
        macroValidPointer (operand_33146) ;
        var_cas_enumerationDescriptor.addAssign_operation (operand_33146->mAttributeTypeIndex, operand_33146->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (806))) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_33146->mAttributeTypeIndex) ;
        var_cas_modifierOutputFormalArgumentList.addAssign_operation (operand_33146->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (808))) ;
        var_cas_modifierInputFormalArgumentList.addAssign_operation (operand_33146->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (809))) ;
      }
    }
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyList"),  operand_32038->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (813)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (813)) ;
    ...
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListFromIndex"),  GGS_string ("uint"),  operand_32038->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (823)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (823)) ;
    ::routine_enterBaseReaderWith2Arguments (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListWithRange"),  GGS_string ("uint"),  GGS_string ("uint"),  operand_32038->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (824)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (824)) ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_34316 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_34316 = NULL ;
      while (((operand_34316 = enumerator_34316.nextObject ()))) {
        macroValidPointer (operand_34316) ;
        var_cas_readerMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, (operand_34316->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (827))).operator_concat (GGS_string ("AtIndex")), operand_34316->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (827)) COMMA_SOURCE_FILE_AT_LINE (827)), GGS_unifiedTypeMapProxyList ::constructor_listWithValue (var_cas_uintType), GGS_bool (true), operand_34316->mAttributeTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (831)) COMMA_SOURCE_FILE_AT_LINE (826)) ;
      }
    }
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_35151 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_35151 = NULL ;
      while (((operand_35151 = enumerator_35151.nextObject ()))) {
        macroValidPointer (operand_35151) ;
        GGS_formalParameterSignature  var_cas_setterFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        var_cas_setterFormalArgumentList.addAssign_operation (operand_35151->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (856))) ;
        ...
        var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_35151->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("AtIndex")), operand_35151->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (859)) COMMA_SOURCE_FILE_AT_LINE (859)), var_cas_setterFormalArgumentList, GGS_bool (true), GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (862)) COMMA_SOURCE_FILE_AT_LINE (858)) ;
      }
    }
...
category_method__sortedListDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_37179,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_37179 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    ...
    GGS_unifiedTypeMapProxy  var_cas_listTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_37179->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (920)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (920)) ;
    GGS_enumerationDescriptorList  var_cas_enumerationDescriptor = GGS_enumerationDescriptorList ::constructor_emptyList () ;
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    GGS_formalParameterSignature  var_cas_modifierFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_37893 (operand_37179->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_37893 = NULL ;
      while (((operand_37893 = enumerator_37893.nextObject ()))) {
        macroValidPointer (operand_37893) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_37893->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (928)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (928)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_37893->mAttributeName) ;
        var_cas_enumerationDescriptor.addAssign_operation (var_cas_attributeTypeIndex, operand_37893->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (930))) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptySortedList"),  operand_37179->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (936)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (936)) ;
...
category_method__structDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_40802,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_40802 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_structTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_40802->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1014)), var_cas_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (1014)) ;
    ...
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_41347 (operand_40802->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_41347 = NULL ;
      while (((operand_41347 = enumerator_41347.nextObject ()))) {
        macroValidPointer (operand_41347) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_41347->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1022)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1022)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_41347->mAttributeName) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_41347->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1025)) ;
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_41937 (operand_40802->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_41937 = NULL ;
      while (((operand_41937 = enumerator_41937.nextObject ()))) {
        macroValidPointer (operand_41937) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_41937->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1037)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1037)) ;
        var_cas_readerMap.modifier_insertOrReplace (inLexique, operand_41937->mAttributeName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1043)) COMMA_SOURCE_FILE_AT_LINE (1038)) ;
      }
    }
...
category_method__classDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_43535,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_43535 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    ...
    const GGS_bool cond_44436 = (operand_43535->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1097))).operator_isEqual (GGS_string ("")) ;
    if (cond_44436.isBuiltAndTrue ()) {
    ...
    }else if (cond_44436.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_43535->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1105)), var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (1105)) ;
      GGS_typeKindEnum var_cas_typeKindEnum ;
      GGS_readerMap  var_cas_inheritedReaderMap ;
      GGS_modifierMap  var_cas_inheritedModifierMap ;
      GGS_bool automatic_var_44930_0 ;
      GGS_unifiedTypeMapProxy  automatic_var_44930_1 ;
      GGS_typedAttributeList  automatic_var_44930_2 ;
      GGS_constructorMap  automatic_var_44930_3 ;
      GGS_classMethodMap  automatic_var_44930_4 ;
      GGS_enumerationDescriptorList  automatic_var_44930_5 ;
      GGS_uint  automatic_var_44930_6 ;
      GGS_unifiedTypeMapProxyList  automatic_var_44930_7 ;
      GGS_nativeAttributeList  automatic_var_44930_8 ;
      GGS_stringset  automatic_var_44930_9 ;
      GGS_lstringlist  automatic_var_44930_10 ;
      GGS_typedAttributeList  automatic_var_44930_11 ;
      GGS_mapSearchMethodListAST  automatic_var_44930_12 ;
      GGS_mapSearchMethodListAST  automatic_var_44930_13 ;
      GGS_withAccessorMap  automatic_var_44930_14 ;
      if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
        var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_43535->mSuperClassName, automatic_var_44930_0, automatic_var_44930_1, var_cas_typeKindEnum, var_cas_inheritedTypedAttributeList, var_cas_attributeMap, automatic_var_44930_2, automatic_var_44930_3, var_cas_inheritedReaderMap, var_cas_inheritedModifierMap, var_cas_inheritedInstanceMethodMap, automatic_var_44930_4, automatic_var_44930_5, automatic_var_44930_6, automatic_var_44930_7, automatic_var_44930_8, automatic_var_44930_9, automatic_var_44930_10, automatic_var_44930_11, automatic_var_44930_12, automatic_var_44930_13, automatic_var_44930_14 COMMA_SOURCE_FILE_AT_LINE (1109)) ;
      }
      const GGS_bool cond_45087 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1122))) ;
      if (cond_45087.isBuiltAndTrue ()) {
        operand_43535->mSuperClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_43535->mSuperClassName)).operator_concat (GGS_string (" should be a class type")) COMMA_SOURCE_FILE_AT_LINE (1124)) ;
      }
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1126)) ;
      {
        GGS_modifierMap::cEnumerator enumerator_45209 (var_cas_inheritedModifierMap, true) ;
        const GGS_modifierMap::cElement * operand_45209 = NULL ;
        while (((operand_45209 = enumerator_45209.nextObject ()))) {
          macroValidPointer (operand_45209) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, operand_45209->mKey, operand_45209->mInfo.mParameterList, operand_45209->mInfo.mHasCompilerArgument, GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1132)) COMMA_SOURCE_FILE_AT_LINE (1128)) ;
        }
      }
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1136)) ;
      {
        GGS_readerMap::cEnumerator enumerator_45489 (var_cas_inheritedReaderMap, true) ;
        const GGS_readerMap::cElement * operand_45489 = NULL ;
        while (((operand_45489 = enumerator_45489.nextObject ()))) {
          macroValidPointer (operand_45489) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_45489->mKey, operand_45489->mInfo.mArgumentTypeList, operand_45489->mInfo.mHasCompilerArgument, operand_45489->mInfo.mReturnedType, GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1143)) COMMA_SOURCE_FILE_AT_LINE (1138)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_46177 (var_cas_inheritedTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_46177 = NULL ;
      while (((operand_46177 = enumerator_46177.nextObject ()))) {
        macroValidPointer (operand_46177) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_46177->mAttributeTypeIndex) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_46280 (operand_43535->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_46280 = NULL ;
      while (((operand_46280 = enumerator_46280.nextObject ()))) {
        macroValidPointer (operand_46280) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_46280->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1164)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1164)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_46280->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1166)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_classIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_43535->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1170)), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1170)) ;
    ...
    const GGS_bool cond_47006 = (operand_43535->mIsAbstract).operator_not () ;
    if (cond_47006.isBuiltAndTrue ()) {
    ...
    {
      GGS_instanceMethodMap::cEnumerator enumerator_47137 (var_cas_inheritedInstanceMethodMap, true) ;
      const GGS_instanceMethodMap::cElement * operand_47137 = NULL ;
      while (((operand_47137 = enumerator_47137.nextObject ()))) {
        macroValidPointer (operand_47137) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_47137->mKey, operand_47137->mInfo.mParameterList, operand_47137->mInfo.mDeclarationLocation, operand_47137->mInfo.mHasCompilerArgument, GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1189)) COMMA_SOURCE_FILE_AT_LINE (1184)) ;
      }
    }
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_47400 (operand_43535->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_47400 = NULL ;
      while (((operand_47400 = enumerator_47400.nextObject ()))) {
        ...
        {
          GGS_formalParameterListAST::cEnumerator enumerator_47489 (operand_47400->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_47489 = NULL ;
          while (((operand_47489 = enumerator_47489.nextObject ()))) {
            macroValidPointer (operand_47489) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_47489->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1197)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1197)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_47489->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_47770 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_47400->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1200))) ;
        if (NULL != operand_47770) {
          operand_47770->mInfo.mQualifier = GGS_readerQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1201)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_47400->mMethodName, var_cas_formalArgumentList, operand_47400->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1206)), GGS_bool (true), GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1208)) COMMA_SOURCE_FILE_AT_LINE (1203)) ;
        }
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_48152 (operand_43535->mMethodList, true) ;
      ...
      while (((operand_48152 = enumerator_48152.nextObject ()))) {
        ...
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_48241 (operand_48152->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_48241 = NULL ;
          while (((operand_48241 = enumerator_48241.nextObject ()))) {
            macroValidPointer (operand_48241) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_48241->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1217)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1217)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_48241->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_48522 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_48152->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1220))) ;
        if (NULL != operand_48522) {
          operand_48522->mInfo.mQualifier = GGS_readerQualifier::constructor_isOverriding (inLexique COMMA_SOURCE_FILE_AT_LINE (1221)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_48152->mMethodName, var_cas_formalArgumentList, operand_48152->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1226)), GGS_bool (true), GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1228)) COMMA_SOURCE_FILE_AT_LINE (1223)) ;
        }
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_49021 (operand_43535->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_49021 = NULL ;
      while (((operand_49021 = enumerator_49021.nextObject ()))) {
        macroValidPointer (operand_49021) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_49021->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1237)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1237)) ;
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_49021->mAttributeName) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_49021->mAttributeName) ;
        var_cas_readerMap.modifier_insertKey (inLexique, operand_49021->mAttributeName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1245)) COMMA_SOURCE_FILE_AT_LINE (1240)) ;
        var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_49021->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1249)), GGS_formalParameterSignature ::constructor_listWithValue (var_cas_attributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1250))), GGS_bool (false), GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1252)) COMMA_SOURCE_FILE_AT_LINE (1248)) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_43535->mClassTypeName, (operand_43535->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1260)), var_cas_allTypedAttributeList, var_cas_attributeMap, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1268)), GGS_enumerationDescriptorList ::constructor_emptyList (), ((function_generateCppConstructorWithAllAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1270))).operator_or (function_generateVirtualDestructor (inLexique COMMA_SOURCE_FILE_AT_LINE (1270)))).operator_or (((operand_43535->mIsAbstract).isBuiltAndTrue () ? (GGS_uint (0U)) : (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1270))))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_currentClassTypedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1278)) COMMA_SOURCE_FILE_AT_LINE (1256)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_50928,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_50928 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_51114 (operand_50928->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_51114 = NULL ;
      while (((operand_51114 = enumerator_51114.nextObject ()))) {
        macroValidPointer (operand_51114) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51114->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1291)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1291)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_51114->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_50928->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1295)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_51647,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_51647 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_51834 (operand_51647->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_51834 = NULL ;
      while (((operand_51834 = enumerator_51834.nextObject ()))) {
        macroValidPointer (operand_51834) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51834->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1307)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1307)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51647->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1312)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1312)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_51647->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1314)) ;
  }
}
...
category_method__lazyFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_lazyFunctionDeclarationAST * operand_52534,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_52534 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_52534->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1325)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1325)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_52534->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1327)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_53102,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_53102 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_53487_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_53487_1 ;
    GGS_attributeMap  automatic_var_53487_2 ;
    GGS_typedAttributeList  automatic_var_53487_3 ;
    GGS_constructorMap  automatic_var_53487_4 ;
    GGS_readerMap  automatic_var_53487_5 ;
    GGS_modifierMap  automatic_var_53487_6 ;
    GGS_instanceMethodMap  automatic_var_53487_7 ;
    GGS_classMethodMap  automatic_var_53487_8 ;
    GGS_enumerationDescriptorList  automatic_var_53487_9 ;
    GGS_uint  automatic_var_53487_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_53487_11 ;
    GGS_nativeAttributeList  automatic_var_53487_12 ;
    GGS_stringset  automatic_var_53487_13 ;
    GGS_lstringlist  automatic_var_53487_14 ;
    GGS_typedAttributeList  automatic_var_53487_15 ;
    GGS_mapSearchMethodListAST  automatic_var_53487_16 ;
    GGS_mapSearchMethodListAST  automatic_var_53487_17 ;
    GGS_withAccessorMap  automatic_var_53487_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_53102->mAssociatedListTypeName, automatic_var_53487_0, automatic_var_53487_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_53487_2, automatic_var_53487_3, automatic_var_53487_4, automatic_var_53487_5, automatic_var_53487_6, automatic_var_53487_7, automatic_var_53487_8, automatic_var_53487_9, automatic_var_53487_10, automatic_var_53487_11, automatic_var_53487_12, automatic_var_53487_13, automatic_var_53487_14, automatic_var_53487_15, automatic_var_53487_16, automatic_var_53487_17, automatic_var_53487_18 COMMA_SOURCE_FILE_AT_LINE (1339)) ;
    }
    const GGS_bool cond_53716 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1346))) ;
    if (cond_53716.isBuiltAndTrue ()) {
      operand_53102->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_53102->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1348)) ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_53102->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1357)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1357)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_53102->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1360)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1360)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_53102->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1367)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1367)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_55137 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_55137 = NULL ;
      while (((operand_55137 = enumerator_55137.nextObject ()))) {
        macroValidPointer (operand_55137) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_55137->mAttributeTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_57101,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57101 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_57101 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation ((findCategoryReader__predefinedTypeAST__getSuperTypeName (var_cas_t (HERE)->galgasRTTI ()) (inLexique, var_cas_t.getPtr () COMMA_SOURCE_FILE_AT_LINE (1434))), operand_57101->mPredefinedTypeName, operand_57101) ;
  }
}
...
category_method__objectPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_objectPredefinedTypeAST * operand_57484,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57484 != NULL) {
    GGS_objectPredefinedTypeAST  var_cas_t = operand_57484 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string ("object"), operand_57484) ;
  }
}
...
category_method__stringsetPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_stringsetPredefinedTypeAST * operand_57847,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57847 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enumerable"), operand_57847->mPredefinedTypeName, operand_57847) ;
  }
}
...
category_method__genericTypeTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_genericTypeTypeAST * operand_58166,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58166 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_58166->mSuperTypeName, operand_58166->mTypeName, operand_58166) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_58478,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58478 != NULL) {
    const GGS_string var_cas_actualSuperTypeName = (((operand_58478->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1467))).operator_isEqual (GGS_string (""))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_58478->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1467)))) ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (var_cas_actualSuperTypeName, operand_58478->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1468)), operand_58478) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_58930,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58930 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("list"), operand_58930->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1476)), operand_58930) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_59248,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59248 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("struct"), operand_59248->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1484)), operand_59248) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_59568,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59568 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enum"), operand_59568->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1492)), operand_59568) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_59890,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59890 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("sortedlist"), operand_59890->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1500)), operand_59890) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_60221,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60221 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_60221->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1508)), operand_60221->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1508)), operand_60221) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_60565,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60565 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("map"), operand_60565->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1516)), operand_60565) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_60883,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60883 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_60883->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1524)), operand_60883->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1524)), operand_60883) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externFunctionDeclarationAST * operand_61238,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61238 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_61238) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externRoutineDeclarationAST * operand_61539,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61539 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_61539) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_62393 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_62393 = NULL ;
    while (((operand_62393 = enumerator_62393.nextObject ()))) {
      macroValidPointer (operand_62393) ;
      { typeCategoryMethod__semanticDeclarationAST__collectType method = findCategoryMethod__semanticDeclarationAST__collectType (operand_62393->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_62393->mSemanticDeclaration (HERE), var_cas_collectedTypeMap COMMA_SOURCE_FILE_AT_LINE (1557)) ;
        }
      }
    }
  }
  ...
  const GGS_bool cond_62858 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_62858.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_62721 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_62721 = NULL ;
      while (((operand_62721 = enumerator_62721.nextObject ()))) {
        macroValidPointer (operand_62721) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_62721->mValue) ;
      }
    }
    ...
    const GGS_bool cond_63160 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_63160.isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_63024 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_63024 = NULL ;
        while (((operand_63024 = enumerator_63024.nextObject ()))) {
          macroValidPointer (operand_63024) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_63024->mValue) ;
        }
      }
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_63523 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_63523 = NULL ;
        while (((operand_63523 = enumerator_63523.nextObject ()))) {
          macroValidPointer (operand_63523) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_63523->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_63523->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (1580)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_64637 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_64637 (_variant_64637.isBuilt (), true) ;
      while (_condition_64637.isBuiltAndTrue ()) {
        _condition_64637 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_64637.isBuiltAndTrue ()) {
          if (_variant_64637.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1601)) ;
            _condition_64637 = GGS_bool (false) ;
          }else{
            _variant_64637.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_64252 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_64252 = NULL ;
              while (((operand_64252 = enumerator_64252.nextObject ()))) {
                macroValidPointer (operand_64252) ;
                const GGS_bool cond_64480 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_64252->mDependanceString) ;
                if (cond_64480.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_64252->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_64252->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_64480.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_64252->mDependanceString, operand_64252->mTypeString, operand_64252->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_65260 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_65260.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_64919 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_64919 = enumerator_64919.nextObject () ;
          if ((operand_64919 != NULL)) {
            bool _foreach_loop_64919 ;
            do{
              macroValidPointer (operand_64919) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_64919->mTypeString) ;
              operand_64919 = enumerator_64919.nextObject () ;
              _foreach_loop_64919 = ((operand_64919 != NULL)) ;
              if (_foreach_loop_64919) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_64919) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_65092 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_65092 = NULL ;
          while (((operand_65092 = enumerator_65092.nextObject ()))) {
            macroValidPointer (operand_65092) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_65092->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_65092->mDependanceString) ;
          }
        }
        ...
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_65676 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_65676 = NULL ;
          while (((operand_65676 = enumerator_65676.nextObject ()))) {
            macroValidPointer (operand_65676) ;
            { typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (operand_65676->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_65676->mSemanticDeclaration (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (1626)) ;
              }
            }
          }
        }
