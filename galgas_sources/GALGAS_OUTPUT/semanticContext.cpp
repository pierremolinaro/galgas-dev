...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147821 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147821.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_147821.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3601)) ;
    enumerator_147821.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_148554 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_148554.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_148554.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3613)) ;
    enumerator_148554.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_148974 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE ("semanticContext.gSemantics", 3622)), kEnumeration_up) ;
    while (enumerator_148974.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_148974.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_148974.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3623))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3623)).operator_concat (GALGAS_string ("' type is not defined")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3623))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3623)) ;
      enumerator_148974.gotoNextObject () ;
    }
    ...
    GALGAS_lstringlist joker_149312_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_149312_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3627)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_149707 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149707.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_149707.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3636))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3636))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3636)) ;
        enumerator_149707.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_150465 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_150465.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_150465.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3655)) ;
        enumerator_150465.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_95461.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_95461.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2379)), enumerator_95461.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2380)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2376)) ;
    }
  ...
  cEnumerator_typedAttributeList enumerator_96511 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_96511.hasCurrentObject () && bool_1) {
    while (enumerator_96511.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_96511.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2413)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_96511.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2413)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2413)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2413)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_96511.gotoNextObject () ;
      if (enumerator_96511.hasCurrentObject ()) {
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_99004 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_99004.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_99004.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2477)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_99004.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    ...
    GALGAS_bool joker_99483_3 ; // Joker input parameter
    GALGAS_bool joker_99483_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_99483_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_99568_2 ; // Joker input parameter
    GALGAS_constructorMap joker_99568_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_99658_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_99658_9 ; // Joker input parameter
    GALGAS_stringlist joker_99658_8 ; // Joker input parameter
    GALGAS_uint joker_99658_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_99658_6 ; // Joker input parameter
    GALGAS_stringset joker_99658_5 ; // Joker input parameter
    GALGAS_lstringlist joker_99658_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_99658_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_99658_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_99658_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_99705_4 ; // Joker input parameter
    GALGAS_string joker_99705_3 ; // Joker input parameter
    GALGAS_string joker_99705_2 ; // Joker input parameter
    GALGAS_headerKind joker_99705_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_99483_3, joker_99483_2, joker_99483_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_99568_2, joker_99568_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_99658_10, joker_99658_9, joker_99658_8, joker_99658_7, joker_99658_6, joker_99658_5, joker_99658_4, joker_99658_3, joker_99658_2, joker_99658_1, var_generateHeaderInSeparateFile, joker_99705_4, joker_99705_3, joker_99705_2, joker_99705_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2487)) ;
    ...
    cEnumerator_modifierMap enumerator_99992 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_99992.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_99992.current_lkey (HERE), enumerator_99992.current_mKind (HERE), enumerator_99992.current_mParameterList (HERE), enumerator_99992.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2513)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2508)) ;
      }
      enumerator_99992.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2518)) ;
    cEnumerator_readerMap enumerator_100318 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_100318.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_100318.current_lkey (HERE), enumerator_100318.current_mKind (HERE), enumerator_100318.current_mArgumentTypeList (HERE), enumerator_100318.current_mDeclarationLocation (HERE), enumerator_100318.current_mHasCompilerArgument (HERE), enumerator_100318.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2527)), enumerator_100318.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2520)) ;
      }
      enumerator_100318.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2532)) ;
    cEnumerator_instanceMethodMap enumerator_100706 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_100706.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_100706.current_lkey (HERE), enumerator_100706.current_mKind (HERE), enumerator_100706.current_mParameterList (HERE), enumerator_100706.current_mDeclarationLocation (HERE), enumerator_100706.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2540)), enumerator_100706.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2534)) ;
      }
      enumerator_100706.gotoNextObject () ;
    }
  }
  ...
  cEnumerator_typedAttributeList enumerator_101137 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_101137.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_101137.current_mAttributeTypeProxy (HERE), enumerator_101137.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2548)) ;
    enumerator_101137.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_101264 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_101264.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_101264.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2552)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_101264.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2553)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_101264.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2554)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_101264.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2555)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2555)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_101264.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_101264.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2556))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2556)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2556))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2556)) ;
    }
    enumerator_101264.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_102364 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_102364.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_102364.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2580)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_102608 (enumerator_102364.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_102608.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_102608.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2584)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_102608.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2586)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_102608.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_102364.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2590)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_102364.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2591)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_102364.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2595)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2596)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2600)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2593)) ;
      }
    }
    enumerator_102364.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_103676 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_103676.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_103676.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_103676.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2615)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2615))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2615)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2615)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2616)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_103676.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 2617)), enumerator_103676.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2617)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2619)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2614)) ;
      }
    }
    enumerator_103676.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_104718 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_104718.hasCurrentObject () && bool_12) {
    while (enumerator_104718.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_104718.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2643)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_104718.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2643)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2643)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2643)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_104718.gotoNextObject () ;
      if (enumerator_104718.hasCurrentObject ()) {
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_106461 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_106461.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_106461.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2691)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_106461.current_mFormalArgumentPassingMode (HERE), enumerator_106461.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2692)) ;
    enumerator_106461.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_107469 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_107469.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_107469.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2710)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2711)) ;
    enumerator_107469.gotoNextObject () ;
  }
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2766)).isValid ()) {
    uint32_t variant_110226 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2766)).uintValue () ;
    bool loop_110226 = true ;
    while (loop_110226) {
      loop_110226 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2766)))).isValid () ;
      if (loop_110226) {
        loop_110226 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2766)))).boolValue () ;
      }
      if (loop_110226 && (0 == variant_110226)) {
        loop_110226 = false ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2805)).isValid ()) {
    uint32_t variant_111538 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2805)).uintValue () ;
    bool loop_111538 = true ;
    while (loop_111538) {
      loop_111538 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2805)))).isValid () ;
      if (loop_111538) {
        loop_111538 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2805)))).boolValue () ;
      }
      if (loop_111538 && (0 == variant_111538)) {
        loop_111538 = false ;
  ...
  {
  GALGAS_unifiedTypeMapProxy joker_112153_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_112153_2 ; // Joker input parameter
  GALGAS_string joker_112153_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_112153_3, joker_112153_2, joker_112153_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2825)) ;
  }
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_114556_3 ; // Joker input parameter
  GALGAS_bool joker_114556_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_114556_1 ; // Joker input parameter
  GALGAS_attributeMap joker_114644_21 ; // Joker input parameter
  GALGAS_typedAttributeList joker_114644_20 ; // Joker input parameter
  GALGAS_constructorMap joker_114644_19 ; // Joker input parameter
  GALGAS_readerMap joker_114644_18 ; // Joker input parameter
  GALGAS_modifierMap joker_114644_17 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_114644_16 ; // Joker input parameter
  GALGAS_classMethodMap joker_114644_15 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_114644_14 ; // Joker input parameter
  GALGAS_stringlist joker_114644_13 ; // Joker input parameter
  GALGAS_uint joker_114644_12 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_114644_11 ; // Joker input parameter
  GALGAS_stringset joker_114644_10 ; // Joker input parameter
  GALGAS_lstringlist joker_114644_9 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_114644_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_114644_7 ; // Joker input parameter
  GALGAS_withAccessorMap joker_114644_6 ; // Joker input parameter
  GALGAS_bool joker_114644_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_114644_4 ; // Joker input parameter
  GALGAS_string joker_114644_3 ; // Joker input parameter
  GALGAS_string joker_114644_2 ; // Joker input parameter
  GALGAS_headerKind joker_114644_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_114556_3, joker_114556_2, joker_114556_1, var_typeKindEnum, var_listTypedAttributeList, joker_114644_21, joker_114644_20, joker_114644_19, joker_114644_18, joker_114644_17, joker_114644_16, joker_114644_15, joker_114644_14, joker_114644_13, joker_114644_12, joker_114644_11, joker_114644_10, joker_114644_9, joker_114644_8, joker_114644_7, joker_114644_6, joker_114644_5, joker_114644_4, joker_114644_3, joker_114644_2, joker_114644_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2894)) ;
  ...
  cEnumerator_typedAttributeList enumerator_116496 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_116496.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_116496.current_mAttributeTypeProxy (HERE), enumerator_116496.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2929)) ;
    enumerator_116496.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_120927 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_120927.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_120927.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3036))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3036)), object->mAttribute_mSuperClassName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3036)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3036)) ;
    }
    enumerator_120927.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121785 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121785.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121785.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3052))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3052)), enumerator_121785.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3052))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3052)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3052)) ;
    }
    enumerator_121785.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_122649 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_122649.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_122649.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3068))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3068)), enumerator_122649.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3068))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3068)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3068)) ;
    }
    enumerator_122649.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_124221 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_124221.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_124221.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3097))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3097)), enumerator_124221.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3097))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3097)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3097)) ;
    }
    enumerator_124221.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_126726 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126726.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126726.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3141))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3141)), enumerator_126726.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3141))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3141)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3141)) ;
    }
    enumerator_126726.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_127587 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_127587.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_127587.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3157))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3157)), enumerator_127587.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3157))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3157)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3157)) ;
    }
    enumerator_127587.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_136684 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3329)) ;
  if (NULL != objectArray_136684) {
      macroValidSharedObject (objectArray_136684, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_136684->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3330)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_137989 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3357)) ;
  if (NULL != objectArray_137989) {
      macroValidSharedObject (objectArray_137989, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_137989->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3358)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_139264 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3384)) ;
  if (NULL != objectArray_139264) {
      macroValidSharedObject (objectArray_139264, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_139264->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3385)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_141168 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3423)) ;
  if (NULL != objectArray_141168) {
      macroValidSharedObject (objectArray_141168, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_141168->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3424)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_142521 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3451)) ;
  if (NULL != objectArray_142521) {
      macroValidSharedObject (objectArray_142521, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_142521->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3452)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_143836 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3478)) ;
  if (NULL != objectArray_143836) {
      macroValidSharedObject (objectArray_143836, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_143836->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3479)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_144675 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_144675.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_144675.current_mAttributeTypeName (HERE), enumerator_144675.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3508))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3505)) ;
    enumerator_144675.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_145318 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145318.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145318.current_mAttributeTypeName (HERE), enumerator_145318.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3529))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3526)) ;
    enumerator_145318.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_145969 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145969.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145969.current_mAttributeTypeName (HERE), enumerator_145969.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3550))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3547)) ;
    enumerator_145969.gotoNextObject () ;
  }
