...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_77266 (var_files, kEnumeration_up) ;
  while (enumerator_77266.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_77266.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("semanticContext.gSemantics", 1881)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1881)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1882)).operator_concat (enumerator_77266.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1882)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_77266.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1884)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1883)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1890)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_77266.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("semanticContext.gSemantics", 1891)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1891)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1892)).operator_concat (enumerator_77266.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1892)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_77266.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1894)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1893)) ;
        }
  ...
  cEnumerator_stringlist enumerator_78231 (var_directories, kEnumeration_up) ;
  while (enumerator_78231.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1911)).operator_concat (enumerator_78231.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1911)), constinArgument_inPathInWrapper.operator_concat (enumerator_78231.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1912)).operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1912)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1910)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_78231.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1921)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1920)) ;
    }
    enumerator_78231.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_semanticDeclarationListAST constinArgument_inSemanticDeclarationList,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_148334 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_148334.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_148334.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3592)) ;
    enumerator_148334.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_149067 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_149067.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_149067.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3604)) ;
    enumerator_149067.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_149542 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE ("semanticContext.gSemantics", 3614)), kEnumeration_up) ;
    while (enumerator_149542.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_149542.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_149542.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3615))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3615)).operator_concat (GALGAS_string ("' type is not defined")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3615))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3615)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
      enumerator_149542.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    ...
    GALGAS_lstringlist joker_149782_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_149782_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3618)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_150177 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_150177.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_150177.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3627))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3627))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3627)) ;
        enumerator_150177.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_150908 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_150908.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_150908.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3645)) ;
        enumerator_150908.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_externTypeDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_externTypeConstructorList enumerator_60629 (object->mAttribute_mExternTypeConstructorList, kEnumeration_up) ;
  while (enumerator_60629.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60629.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1420)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_60863 (enumerator_60629.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_60863.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60863.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1425)) ;
      }
      var_arguments.addAssign_operation (enumerator_60863.current_mFormalSelector (HERE), var_argumentTypeProxy, enumerator_60863.current_mFormalParameterName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1426)) ;
      enumerator_60863.gotoNextObject () ;
    }
    {
    var_constructorMap.modifier_insertKey (enumerator_60629.current_mConstructorName (HERE), var_arguments, GALGAS_bool (true), var_returnedTypeProxy, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1429)) ;
    }
    enumerator_60629.gotoNextObject () ;
  }
  cEnumerator_externTypeReaderList enumerator_61354 (object->mAttribute_mExternTypeReaderList, kEnumeration_up) ;
  while (enumerator_61354.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61354.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1439)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_61582 (enumerator_61354.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_61582.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61582.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1444)) ;
      }
      var_arguments.addAssign_operation (enumerator_61582.current_mFormalSelector (HERE), var_argumentTypeProxy, enumerator_61582.current_mFormalParameterName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1445)) ;
      enumerator_61582.gotoNextObject () ;
    }
    {
    var_readerMap.modifier_insertKey (enumerator_61354.current_mReaderName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1450)), var_arguments, inCompiler->here (), GALGAS_bool (true), var_returnedTypeProxy, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1455)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1448)) ;
    }
    enumerator_61354.gotoNextObject () ;
  }
  cEnumerator_externTypeModifierList enumerator_62184 (object->mAttribute_mExternTypeModifierList, kEnumeration_up) ;
  while (enumerator_62184.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_62281 (enumerator_62184.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_62281.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_62281.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1463)) ;
      }
      var_routineSignature.addAssign_operation (enumerator_62281.current_mFormalSelector (HERE), var_parameterTypeIndex, enumerator_62281.current_mFormalArgumentPassingMode (HERE), enumerator_62281.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1468)) ;
      enumerator_62281.gotoNextObject () ;
    }
    {
    var_modifierMap.modifier_insertKey (enumerator_62184.current_mModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1473)), var_routineSignature, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1476)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1471)) ;
    }
    enumerator_62184.gotoNextObject () ;
  }
  cEnumerator_externTypeMethodList enumerator_62894 (object->mAttribute_mExternTypeMethodList, kEnumeration_up) ;
  while (enumerator_62894.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_62991 (enumerator_62894.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_62991.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_62991.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1485)) ;
      }
      var_routineSignature.addAssign_operation (enumerator_62991.current_mFormalSelector (HERE), var_parameterTypeIndex, enumerator_62991.current_mFormalArgumentPassingMode (HERE), enumerator_62991.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1490)) ;
      enumerator_62991.gotoNextObject () ;
    }
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_62894.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1495)), var_routineSignature, enumerator_62894.current_mDeclarationLocation (HERE), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1499)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1493)) ;
    }
    enumerator_62894.gotoNextObject () ;
  }
  {
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_functionSignature enumerator_70303 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1685)), kEnumeration_up) ;
  while (enumerator_70303.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 1686)), enumerator_70303.current_mFormalArgumentType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 1686)), enumerator_70303.current_mFormalArgumentName (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1686)) ;
    enumerator_70303.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_70481 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_70481.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_70481.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1691)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1694)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1689)) ;
    }
    enumerator_70481.gotoNextObject () ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_74787 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_74787.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_74787.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1808))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1808)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_74787.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1809)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1809)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1809)) ;
    }
    enumerator_74787.gotoNextObject () ;
  }
  GALGAS_readerMap var_readerMap ;
  {
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_filewrapperTemplateListAST enumerator_79465 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_79465.hasCurrentObject ()) {
    ...
    cEnumerator_formalTemplateInputParameterListAST enumerator_79583 (enumerator_79465.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_79583.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_79583.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1943)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1944)) ;
      enumerator_79583.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_79465.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_79465.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1946)) ;
    }
    enumerator_79465.gotoNextObject () ;
  }
  ...
  cEnumerator_lstringlist enumerator_80102 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_80102.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_80102.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1955)) ;
    }
  ...
  cEnumerator_lstringlist enumerator_80308 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_80308.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_80308.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1960)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_80308.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_80308.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1961))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1961)).operator_concat (GALGAS_string ("' extension is already used for text files")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1961))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1961)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_80308.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1963)) ;
      }
    }
    enumerator_80308.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_82275 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_82275.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_82275.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2016)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_82495 (enumerator_82275.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_82495.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_82495.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_82495.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_82495.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_82275.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2026)) ;
    enumerator_82275.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_83630 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_83630.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_83630.current_mAttributeTypeProxy (HERE), enumerator_83630.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2044))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2044)) ;
    var_constructorAttributeTypeList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2045)), enumerator_83630.current_mAttributeTypeProxy (HERE), enumerator_83630.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2045)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2046)), enumerator_83630.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 2046)), enumerator_83630.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2046)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2047)), enumerator_83630.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2047)), enumerator_83630.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2047)) ;
    enumerator_83630.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_85081 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_85081.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_85081.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      ...
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_85081.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2067)).operator_concat (GALGAS_string ("AtIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2067)), enumerator_85081.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 2067))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2067)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2068)), temp_3, inCompiler->here (), GALGAS_bool (true), enumerator_85081.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2073)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2066)) ;
      }
    }
    enumerator_85081.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_86901 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_86901.hasCurrentObject ()) {
    const enumGalgasBool test_4 = enumerator_86901.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_4) {
      ...
      var_setterFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2129)), enumerator_86901.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2129)), enumerator_86901.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2129)) ;
      var_setterFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2130)), var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2130)), enumerator_86901.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2130)) ;
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_86901.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2132)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2132))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2132)).operator_concat (GALGAS_string ("AtIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2132)), enumerator_86901.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 2132))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2132)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2133)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2136)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2131)) ;
      }
    }
    enumerator_86901.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_90638 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_90638.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_90638.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2221)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_90638.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2224)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_90638.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2225)) ;
    var_constructorAttributeTypeList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2226)), var_attributeTypeIndex, enumerator_90638.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2226)) ;
    var_modifierFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2227)), var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 2227)), enumerator_90638.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2227)) ;
    enumerator_90638.gotoNextObject () ;
  }
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_95270 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_95270.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_95270.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2346)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2347)), var_attributeTypeIndex, enumerator_95270.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2347)) ;
    ...
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_95270.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2351)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_95270.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2352)) ;
    }
    enumerator_95270.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_96069 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_96069.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_96069.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2367)), enumerator_96069.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2368)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2364)) ;
    }
    enumerator_96069.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_97119 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_97119.hasCurrentObject () && bool_1) {
    while (enumerator_97119.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_97119.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2401)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_97119.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2401)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2401)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2401)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_97119.gotoNextObject () ;
      if (enumerator_97119.hasCurrentObject ()) {
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_99608 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_99608.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_99608.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2465)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
    ...
    GALGAS_bool joker_100087_3 ; // Joker input parameter
    GALGAS_bool joker_100087_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_100087_1 ; // Joker input parameter
    GALGAS_bool joker_100117_0 ; // Joker input parameter
    GALGAS_typedAttributeList joker_100181_2 ; // Joker input parameter
    GALGAS_constructorMap joker_100181_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_100271_9 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_100271_8 ; // Joker input parameter
    GALGAS_stringlist joker_100271_7 ; // Joker input parameter
    GALGAS_uint joker_100271_6 ; // Joker input parameter
    GALGAS_functionSignature joker_100271_5 ; // Joker input parameter
    GALGAS_stringset joker_100271_4 ; // Joker input parameter
    GALGAS_lstringlist joker_100271_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_100271_2 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_100271_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_100317_4 ; // Joker input parameter
    GALGAS_string joker_100317_3 ; // Joker input parameter
    GALGAS_string joker_100317_2 ; // Joker input parameter
    GALGAS_headerKind joker_100317_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_100087_3, joker_100087_2, joker_100087_1, var_typeKindEnum, joker_100117_0, var_inheritedTypedAttributeList, var_attributeMap, joker_100181_2, joker_100181_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_100271_9, joker_100271_8, joker_100271_7, joker_100271_6, joker_100271_5, joker_100271_4, joker_100271_3, joker_100271_2, joker_100271_1, var_generateHeaderInSeparateFile, joker_100317_4, joker_100317_3, joker_100317_2, joker_100317_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2475)) ;
    ...
    cEnumerator_modifierMap enumerator_100604 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_100604.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_100604.current_lkey (HERE), enumerator_100604.current_mKind (HERE), enumerator_100604.current_mParameterList (HERE), enumerator_100604.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2502)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2497)) ;
      }
    ...
    cEnumerator_readerMap enumerator_100930 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_100930.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_100930.current_lkey (HERE), enumerator_100930.current_mKind (HERE), enumerator_100930.current_mArgumentTypeList (HERE), enumerator_100930.current_mDeclarationLocation (HERE), enumerator_100930.current_mHasCompilerArgument (HERE), enumerator_100930.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2516)), enumerator_100930.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2509)) ;
      }
    ...
    cEnumerator_instanceMethodMap enumerator_101318 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_101318.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_101318.current_lkey (HERE), enumerator_101318.current_mKind (HERE), enumerator_101318.current_mParameterList (HERE), enumerator_101318.current_mDeclarationLocation (HERE), enumerator_101318.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2529)), enumerator_101318.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2523)) ;
      }
      enumerator_101318.gotoNextObject () ;
    }
  }
  ...
  cEnumerator_typedAttributeList enumerator_101731 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_101731.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2537)), enumerator_101731.current_mAttributeTypeProxy (HERE), enumerator_101731.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2537)) ;
    enumerator_101731.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_101872 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_101872.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_101872.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2541)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2542)), var_attributeTypeIndex, enumerator_101872.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2542)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_101872.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2543)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_101872.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2544)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2544)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_101872.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_101872.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2545))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2545)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2545))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2545)) ;
    }
    enumerator_101872.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_102986 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_102986.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_102986.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2569)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_103230 (enumerator_102986.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_103230.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_103230.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2573)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_103230.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2575)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_103230.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_102986.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2579)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_102986.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2580)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_102986.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2584)), GALGAS_functionSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2585)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2589)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2582)) ;
      }
    }
    enumerator_102986.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_104031 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_104031.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_104031.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_104031.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2598)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2598))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2598)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2598)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2599)), GALGAS_formalParameterSignature::constructor_listWithValue (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2600)), enumerator_104031.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 2600)), enumerator_104031.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2600)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2602)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2597)) ;
      }
    }
    enumerator_104031.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_105087 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_105087.hasCurrentObject () && bool_12) {
    while (enumerator_105087.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_105087.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2626)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_105087.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2626)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2626)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2626)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_105087.gotoNextObject () ;
      if (enumerator_105087.hasCurrentObject ()) {
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_106826 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_106826.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_106826.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2674)) ;
    }
    var_routineSignature.addAssign_operation (enumerator_106826.current_mFormalSelector (HERE), var_parameterTypeIndex, enumerator_106826.current_mFormalArgumentPassingMode (HERE), enumerator_106826.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2675)) ;
    enumerator_106826.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_107873 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_107873.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_107873.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2697)) ;
    }
    var_functionSignature.addAssign_operation (enumerator_107873.current_mFormalSelector (HERE), var_parameterTypeIndex, enumerator_107873.current_mFormalArgumentTypeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2698)) ;
    enumerator_107873.gotoNextObject () ;
  }
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2758)).isValid ()) {
    uint32_t variant_110713 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2758)).uintValue () ;
    bool loop_110713 = true ;
    while (loop_110713) {
      loop_110713 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2758)))).isValid () ;
      if (loop_110713) {
        loop_110713 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2758)))).boolValue () ;
      }
      if (loop_110713 && (0 == variant_110713)) {
        loop_110713 = false ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2797)).isValid ()) {
    uint32_t variant_112053 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2797)).uintValue () ;
    bool loop_112053 = true ;
    while (loop_112053) {
      loop_112053 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2797)))).isValid () ;
      if (loop_112053) {
        loop_112053 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2797)))).boolValue () ;
      }
      if (loop_112053 && (0 == variant_112053)) {
        loop_112053 = false ;
  ...
  {
  GALGAS_lstring joker_112682_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_112682_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_112682_2 ; // Joker input parameter
  GALGAS_string joker_112682_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_112682_4, joker_112682_3, joker_112682_2, joker_112682_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2817)) ;
  }
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_115108_3 ; // Joker input parameter
  GALGAS_bool joker_115108_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_115108_1 ; // Joker input parameter
  GALGAS_bool joker_115148_0 ; // Joker input parameter
  GALGAS_attributeMap joker_115203_20 ; // Joker input parameter
  GALGAS_typedAttributeList joker_115203_19 ; // Joker input parameter
  GALGAS_constructorMap joker_115203_18 ; // Joker input parameter
  GALGAS_readerMap joker_115203_17 ; // Joker input parameter
  GALGAS_modifierMap joker_115203_16 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_115203_15 ; // Joker input parameter
  GALGAS_classMethodMap joker_115203_14 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_115203_13 ; // Joker input parameter
  GALGAS_stringlist joker_115203_12 ; // Joker input parameter
  GALGAS_uint joker_115203_11 ; // Joker input parameter
  GALGAS_functionSignature joker_115203_10 ; // Joker input parameter
  GALGAS_stringset joker_115203_9 ; // Joker input parameter
  GALGAS_lstringlist joker_115203_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_115203_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_115203_6 ; // Joker input parameter
  GALGAS_bool joker_115203_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_115203_4 ; // Joker input parameter
  GALGAS_string joker_115203_3 ; // Joker input parameter
  GALGAS_string joker_115203_2 ; // Joker input parameter
  GALGAS_headerKind joker_115203_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_115108_3, joker_115108_2, joker_115108_1, var_typeKindEnum, joker_115148_0, var_listTypedAttributeList, joker_115203_20, joker_115203_19, joker_115203_18, joker_115203_17, joker_115203_16, joker_115203_15, joker_115203_14, joker_115203_13, joker_115203_12, joker_115203_11, joker_115203_10, joker_115203_9, joker_115203_8, joker_115203_7, joker_115203_6, joker_115203_5, joker_115203_4, joker_115203_3, joker_115203_2, joker_115203_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2886)) ;
  ...
  cEnumerator_typedAttributeList enumerator_117051 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_117051.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2922)), enumerator_117051.current_mAttributeTypeProxy (HERE), enumerator_117051.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2922)) ;
    enumerator_117051.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121497 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121497.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121497.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3029))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3029)), object->mAttribute_mSuperClassName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3029)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3029)) ;
    }
    enumerator_121497.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_122355 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_122355.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_122355.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3045))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3045)), enumerator_122355.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3045))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3045)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3045)) ;
    }
    enumerator_122355.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_123219 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123219.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123219.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3061))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3061)), enumerator_123219.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3061))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3061)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3061)) ;
    }
    enumerator_123219.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_124791 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_124791.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_124791.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3090))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3090)), enumerator_124791.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3090))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3090)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3090)) ;
    }
    enumerator_124791.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_127296 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_127296.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_127296.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3134))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3134)), enumerator_127296.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3134))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3134)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3134)) ;
    }
    enumerator_127296.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_128157 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_128157.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_128157.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3150))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3150)), enumerator_128157.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3150))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3150)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3150)) ;
    }
    enumerator_128157.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_137254 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryReaderMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3322)) ;
  if (NULL != objectArray_137254) {
      macroValidSharedObject (objectArray_137254, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_137254->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3323)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_138559 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryMethodMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3350)) ;
  if (NULL != objectArray_138559) {
      macroValidSharedObject (objectArray_138559, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_138559->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3351)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_139834 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryModifierMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3377)) ;
  if (NULL != objectArray_139834) {
      macroValidSharedObject (objectArray_139834, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_139834->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3378)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_143091 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryMethodMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3444)) ;
  if (NULL != objectArray_143091) {
      macroValidSharedObject (objectArray_143091, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_143091->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3445)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (NULL != objectArray_144406) {
      macroValidSharedObject (objectArray_144406, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_144406->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3472)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_145245 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145245.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145245.current_mAttributeTypeName (HERE), enumerator_145245.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3501))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3498)) ;
    enumerator_145245.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_145888 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145888.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145888.current_mAttributeTypeName (HERE), enumerator_145888.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3522))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3519)) ;
    enumerator_145888.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_146539 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_146539.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_146539.current_mAttributeTypeName (HERE), enumerator_146539.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3543))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3540)) ;
    enumerator_146539.gotoNextObject () ;
  }
