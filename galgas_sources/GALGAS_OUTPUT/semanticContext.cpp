...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_149862 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_149862.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_149862.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3638)) ;
    enumerator_149862.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_150595 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_150595.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_150595.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3650)) ;
    enumerator_150595.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_151015 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE ("semanticContext.gSemantics", 3659)), kEnumeration_up) ;
    while (enumerator_151015.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_151015.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_151015.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3660))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3660)).operator_concat (GALGAS_string ("' type is not defined")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3660))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3660)) ;
      enumerator_151015.gotoNextObject () ;
    }
    ...
    GALGAS_lstringlist joker_151353_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_151353_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3664)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_151748 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_151748.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_151748.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3673))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3673))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3673)) ;
        enumerator_151748.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_152556 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_152556.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_152556.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3693)) ;
        enumerator_152556.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_typedAttributeList enumerator_106210 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_106210.hasCurrentObject () && bool_12) {
    while (enumerator_106210.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_106210.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2670)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_106210.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2670)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2670)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2670)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_106210.gotoNextObject () ;
      if (enumerator_106210.hasCurrentObject ()) {
        bool_12 = GALGAS_bool (kIsNotEqual, var_defaultConstructorName.objectCompare (GALGAS_string::makeEmptyString ())).isValidAndTrue () ;
      }
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mClassTypeName, object->mAttribute_mIsPredefined, object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2678)), var_superClassIndex, GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE ("semanticContext.gSemantics", 2680)), var_allTypedAttributeList, var_attributeMap, var_currentClassTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2688)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2689)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2690)), GALGAS_uint ((uint32_t) 0U), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2692)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticContext.gSemantics", 2693)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2694)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2695)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2696)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2697)), var_generateHeaderInSeparateFile, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticContext.gSemantics", 2699)), var_defaultConstructorName, GALGAS_string ("class-").operator_concat (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2701))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2701)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2702)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2703)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2675)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externRoutineDeclarationAST * object = (const cPtr_externRoutineDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_externRoutineDeclarationAST) ;
  GALGAS_formalParameterSignature var_routineSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2716)) ;
  cEnumerator_formalParameterListAST enumerator_108007 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_108007.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_108007.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2719)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_108007.current_mFormalArgumentPassingMode (HERE), enumerator_108007.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2720)) ;
    enumerator_108007.gotoNextObject () ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mRoutineMap.modifier_insertKey (object->mAttribute_mRoutineName, var_routineSignature, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2723)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externFunctionDeclarationAST * object = (const cPtr_externFunctionDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_externFunctionDeclarationAST) ;
  GALGAS_unifiedTypeMapProxyList var_functionSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2735)) ;
  cEnumerator_formalInputParameterListAST enumerator_109015 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_109015.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_109015.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2738)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2739)) ;
    enumerator_109015.gotoNextObject () ;
  }
  ...
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2745)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName, var_resultTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2757)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2759)), var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2759)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayDeclarationAST) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2771)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mDimension.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the dimension of an array should be > 0")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2772)) ;
  }
  GALGAS_unifiedTypeMapProxy var_arrayTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mArrayTypeName, var_arrayTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2776)) ;
  }
  GALGAS_unifiedTypeMapProxy var_elementTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mElementTypeName, var_elementTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2779)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2781)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2782)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2783)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2784)) ;
  GALGAS_unifiedTypeMapProxy var_boolType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("bool"), var_boolType COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2787)) ;
  }
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2790)) ;
  }
  GALGAS_unifiedTypeMapProxyAndParameterList var_uintArgs = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2792)) ;
  GALGAS_uint var_idx = GALGAS_uint ((uint32_t) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2794)).isValid ()) {
    uint32_t variant_111772 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2794)).uintValue () ;
    bool loop_111772 = true ;
    while (loop_111772) {
      loop_111772 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2794)))).isValid () ;
      if (loop_111772) {
        loop_111772 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2794)))).boolValue () ;
      }
      if (loop_111772 && (0 == variant_111772)) {
        loop_111772 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticContext.gSemantics", 2794)) ;
      }
      if (loop_111772) {
        variant_111772 -- ;
        var_uintArgs.addAssign_operation (var_uintType, GALGAS_string ("inSize").operator_concat (var_idx.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2795))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2795))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2795)) ;
        var_idx.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2796)) ;
      }
    }
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2800)), var_uintArgs, GALGAS_bool (false), var_arrayTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2799)) ;
  }
  {
  routine_enterBaseReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("axisCount"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2806)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("sizeForAxis"), GALGAS_string ("uint"), GALGAS_string ("inAxisIndex"), GALGAS_string ("uint"), GALGAS_bool (true), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2807)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("rangeForAxis"), GALGAS_string ("uint"), GALGAS_string ("inAxisIndex"), GALGAS_string ("range"), GALGAS_bool (true), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2808)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("isValueValidAtIndex"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2810)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2811)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_boolType, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2816)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2809)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("valueAtIndex"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2820)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2821)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_elementTypeIndex, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2826)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2819)) ;
  }
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2830)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_elementTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2831)), GALGAS_string ("InValue")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2831)) ;
  var_idx = GALGAS_uint ((uint32_t) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2833)).isValid ()) {
    uint32_t variant_113084 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2833)).uintValue () ;
    bool loop_113084 = true ;
    while (loop_113084) {
      loop_113084 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2833)))).isValid () ;
      if (loop_113084) {
        loop_113084 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2833)))).boolValue () ;
      }
      if (loop_113084 && (0 == variant_113084)) {
        loop_113084 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticContext.gSemantics", 2833)) ;
      }
      if (loop_113084) {
        variant_113084 -- ;
        var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2834)), GALGAS_string ("inIndex").operator_concat (var_idx.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2834))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2834))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2834)) ;
        var_idx.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2835)) ;
      }
    }
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setValueAtIndex").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2838)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2839)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2842)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2837)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("forceValueAtIndex").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2846)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2847)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2850)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2845)) ;
  }
  {
  GALGAS_unifiedTypeMapProxy joker_113699_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_113699_2 ; // Joker input parameter
  GALGAS_string joker_113699_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_113699_3, joker_113699_2, joker_113699_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2853)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("invalidateValueAtIndex").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2855)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2856)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2859)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2854)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSize").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2863)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2864)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2867)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2862)) ;
  }
  var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2870)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2871)), GALGAS_string ("inSize")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2871)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2872)), GALGAS_string ("inAxisIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2872)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSizeForAxis").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2874)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2875)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2878)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2873)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mArrayTypeName, object->mAttribute_mIsPredefined, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticContext.gSemantics", 2886)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE ("semanticContext.gSemantics", 2887)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2888)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2889)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2890)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2895)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2896)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2897)), GALGAS_uint ((uint32_t) 0U), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2899)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticContext.gSemantics", 2900)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2901)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2902)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2903)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2904)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticContext.gSemantics", 2906)), GALGAS_string::makeEmptyString (), GALGAS_string ("array-").operator_concat (object->mAttribute_mArrayTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2908))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2908)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2909)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2910)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2882)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_116255_3 ; // Joker input parameter
  GALGAS_bool joker_116255_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_116255_1 ; // Joker input parameter
  GALGAS_attributeMap joker_116343_22 ; // Joker input parameter
  GALGAS_typedAttributeList joker_116343_21 ; // Joker input parameter
  GALGAS_constructorMap joker_116343_20 ; // Joker input parameter
  GALGAS_readerMap joker_116343_19 ; // Joker input parameter
  GALGAS_modifierMap joker_116343_18 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_116343_17 ; // Joker input parameter
  GALGAS_classMethodMap joker_116343_16 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_116343_15 ; // Joker input parameter
  GALGAS_stringlist joker_116343_14 ; // Joker input parameter
  GALGAS_uint joker_116343_13 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_116343_12 ; // Joker input parameter
  GALGAS_stringset joker_116343_11 ; // Joker input parameter
  GALGAS_lstringlist joker_116343_10 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_116343_9 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_116343_8 ; // Joker input parameter
  GALGAS_withAccessorMap joker_116343_7 ; // Joker input parameter
  GALGAS_bool joker_116343_6 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_116343_5 ; // Joker input parameter
  GALGAS_string joker_116343_4 ; // Joker input parameter
  GALGAS_string joker_116343_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_116343_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_116343_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_116255_3, joker_116255_2, joker_116255_1, var_typeKindEnum, var_listTypedAttributeList, joker_116343_22, joker_116343_21, joker_116343_20, joker_116343_19, joker_116343_18, joker_116343_17, joker_116343_16, joker_116343_15, joker_116343_14, joker_116343_13, joker_116343_12, joker_116343_11, joker_116343_10, joker_116343_9, joker_116343_8, joker_116343_7, joker_116343_6, joker_116343_5, joker_116343_4, joker_116343_3, joker_116343_2, joker_116343_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2924)) ;
  ...
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedListTypeName, var_associatedListTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2942)) ;
  }
  GALGAS_unifiedTypeMapProxy var_currentTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListmapTypeName, var_currentTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2945)) ;
  }
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2948)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("count"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2950)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("allKeys"), GALGAS_string ("stringset"), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2951)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2952)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("listForKey"), GALGAS_string ("string"), GALGAS_string ("inKey"), object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2953)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2953)) ;
  }
  {
  ...
  GALGAS_enumerationDescriptorList var_enumeratorDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2957)) ;
  var_enumeratorDescriptor.addAssign_operation (var_stringTypeIndex, GALGAS_string ("key")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2958)) ;
  var_enumeratorDescriptor.addAssign_operation (var_associatedListTypeIndex, GALGAS_string ("mList")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2959)) ;
  GALGAS_unifiedTypeMapProxyAndParameterList var_addAssignOperatorDescription = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2961)) ;
  var_addAssignOperatorDescription.addAssign_operation (var_stringTypeIndex, GALGAS_string ("inKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2962)) ;
  cEnumerator_typedAttributeList enumerator_118414 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_118414.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_118414.current_mAttributeTypeProxy (HERE), enumerator_118414.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2964)) ;
    enumerator_118414.gotoNextObject () ;
  }
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2967)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2968)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2969)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mListmapTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2971)) ;
  }
  GALGAS_unifiedTypeMapProxy var_listElementTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2984))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2984)), object->mAttribute_mListmapTypeName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2984)), var_listElementTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2982)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListmapTypeName, object->mAttribute_mIsPredefined, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticContext.gSemantics", 2992)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE ("semanticContext.gSemantics", 2993)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2994)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2995)), var_listTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3001)), var_enumeratorDescriptor, var_enumerationVariants, function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3004)), var_addAssignOperatorDescription, GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticContext.gSemantics", 3006)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3007)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3008)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3009)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3010)), GALGAS_bool (false), var_listElementTypeIndex, GALGAS_string ("emptyMap"), GALGAS_string ("listmap-").operator_concat (object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3014))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3014)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3015)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3016)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2988)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_122968 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_122968.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_122968.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3073))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3073)), object->mAttribute_mSuperClassName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3073)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3073)) ;
    }
    enumerator_122968.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_123826 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123826.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123826.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3089))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3089)), enumerator_123826.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3089))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3089)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3089)) ;
    }
    enumerator_123826.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_124690 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_124690.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_124690.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3105))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3105)), enumerator_124690.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3105))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3105)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3105)) ;
    }
    enumerator_124690.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_126262 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126262.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126262.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3134))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3134)), enumerator_126262.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3134))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3134)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3134)) ;
    }
    enumerator_126262.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_128767 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_128767.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_128767.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3178))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3178)), enumerator_128767.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3178))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3178)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3178)) ;
    }
    enumerator_128767.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_129628 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_129628.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_129628.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3194))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3194)), enumerator_129628.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3194))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3194)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3194)) ;
    }
    enumerator_129628.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_138725 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3366)) ;
  if (NULL != objectArray_138725) {
      macroValidSharedObject (objectArray_138725, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_138725->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3367)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_140030 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3394)) ;
  if (NULL != objectArray_140030) {
      macroValidSharedObject (objectArray_140030, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_140030->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3395)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_141305 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3421)) ;
  if (NULL != objectArray_141305) {
      macroValidSharedObject (objectArray_141305, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_141305->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3422)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_143209 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3460)) ;
  if (NULL != objectArray_143209) {
      macroValidSharedObject (objectArray_143209, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_143209->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3461)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_144562 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3488)) ;
  if (NULL != objectArray_144562) {
      macroValidSharedObject (objectArray_144562, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_144562->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3489)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (NULL != objectArray_145877) {
      macroValidSharedObject (objectArray_145877, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_145877->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3516)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_146716 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_146716.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_146716.current_mAttributeTypeName (HERE), enumerator_146716.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3545))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3542)) ;
    enumerator_146716.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_147359 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_147359.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_147359.current_mAttributeTypeName (HERE), enumerator_147359.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3566))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3563)) ;
    enumerator_147359.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_148010 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_148010.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_148010.current_mAttributeTypeName (HERE), enumerator_148010.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3587))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3584)) ;
    enumerator_148010.gotoNextObject () ;
  }
