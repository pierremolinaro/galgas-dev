...
static void
category_method__abstractCategoryMethodAST__enterInSemanticContext (C_Compiler &,
...
static void
category_method__categoryMethodAST__enterInSemanticContext (C_Compiler &,
...
static void
category_method__overridingCategoryMethodAST__enterInSemanticContext (C_Compiler &,
...
static void
category_method__overridingAbstractCategoryMethodAST__enterInSemanticContext (C_Compiler &,
...
static void
category_method__abstractCategoryReaderAST__enterInSemanticContext (C_Compiler &,
...
static void
category_method__categoryReaderAST__enterInSemanticContext (C_Compiler &,
...
static void
category_method__overridingCategoryReaderAST__enterInSemanticContext (C_Compiler &,
...
static void
category_method__overridingAbstractCategoryReaderAST__enterInSemanticContext (C_Compiler &,
...
category_method__mapDeclarationAST__enterInSemanticContext (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_33623,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_33623 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (795)) ;
    GGS_unifiedTypeMapProxy  var_cas_lstringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("lstring"), var_cas_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (798)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentMapTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_33623->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (801)), var_cas_currentMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (801)) ;
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (803)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (804)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (805)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (806)) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_33623->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (809)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (809)) ;
    ::routine_enterConstructorWithArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("mapWithMapToOverride"),  operand_33623->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (810)),  operand_33623->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (810)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (810)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("allKeys"),  GGS_string ("stringset"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (812)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("allKeyList"),  GGS_string ("lstringlist"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (813)) ;
    ::routine_enterInheritedReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("hasKey"),  GGS_string ("string"),  GGS_string ("bool"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (814)) ;
    ::routine_enterInheritedReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("locationForKey"),  GGS_string ("string"),  GGS_string ("location"),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (815)) ;
    ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("overriddenMap"),  operand_33623->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (816)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (816)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("count"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (817)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("unsolvedProxyCount"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (818)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("unsolvedProxyKeyList"),  GGS_string ("stringlist"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (819)) ;
    ...
    var_cas_insertMethodFormalArgumentList.addAssign_operation (var_cas_lstringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (823))) ;
    GGS_formalParameterSignature  var_cas_removeMethodFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
    var_cas_removeMethodFormalArgumentList.addAssign_operation (var_cas_lstringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (825))) ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_36359 (operand_33623->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_36359 = NULL ;
      while (((operand_36359 = enumerator_36359.nextObject ()))) {
        macroValidPointer (operand_36359) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_36359->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (828)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (828)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_36359->mAttributeName) ;
        var_cas_enumerationDescriptor.addAssign_operation (var_cas_attributeTypeIndex, operand_36359->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (830))) ;
        var_cas_insertMethodFormalArgumentList.addAssign_operation (var_cas_attributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (831))) ;
        var_cas_removeMethodFormalArgumentList.addAssign_operation (var_cas_attributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (832))) ;
      }
    }
    {
      GGS_insertMethodListAST::cEnumerator enumerator_36963 (operand_33623->mInsertMethodList, true) ;
      const GGS_insertMethodListAST::cElement * operand_36963 = NULL ;
      while (((operand_36963 = enumerator_36963.nextObject ()))) {
        macroValidPointer (operand_36963) ;
        const GGS_bool cond_37118 = var_cas_modifierMap.reader_hasKey (operand_36963->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (836))) ;
        if (cond_37118.isBuiltAndTrue ()) {
          operand_36963->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_36963->mMethodName)).operator_concat (GGS_string ("' insert method is already declared")) COMMA_SOURCE_FILE_AT_LINE (838)) ;
        }else if (cond_37118.isBuiltAndFalse ()) {
          var_cas_modifierMap.modifier_insertOrReplace (inLexique, operand_36963->mMethodName, var_cas_insertMethodFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (843)) COMMA_SOURCE_FILE_AT_LINE (839)) ;
        }
      }
    }
    {
      GGS_mapRemoveMethodListAST::cEnumerator enumerator_37362 (operand_33623->mRemoveMethodList, true) ;
      const GGS_mapRemoveMethodListAST::cElement * operand_37362 = NULL ;
      while (((operand_37362 = enumerator_37362.nextObject ()))) {
        macroValidPointer (operand_37362) ;
        const GGS_bool cond_37553 = var_cas_modifierMap.reader_hasKey (operand_37362->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (849))) ;
        if (cond_37553.isBuiltAndTrue ()) {
          operand_37362->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_37362->mMethodName)).operator_concat (GGS_string ("' method is already declared as an insert modifier or a remove modifier")) COMMA_SOURCE_FILE_AT_LINE (851)) ;
        }else if (cond_37553.isBuiltAndFalse ()) {
          var_cas_modifierMap.modifier_insertOrReplace (inLexique, operand_37362->mMethodName, var_cas_removeMethodFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (856)) COMMA_SOURCE_FILE_AT_LINE (852)) ;
        }
      }
    }
    const GGS_bool cond_38131 = (operand_33623->mMapStateList.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
    if (cond_38131.isBuiltAndTrue ()) {
      {
        GGS_mapSearchMethodListAST::cEnumerator enumerator_37878 (operand_33623->mSearchMethodList, true) ;
        const GGS_mapSearchMethodListAST::cElement * operand_37878 = NULL ;
        while (((operand_37878 = enumerator_37878.nextObject ()))) {
          macroValidPointer (operand_37878) ;
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_37878->mMethodName, GGS_bool (false), var_cas_removeMethodFormalArgumentList, operand_37878->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (867)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (863)) ;
        }
      }
    }else if (cond_38131.isBuiltAndFalse ()) {
      {
        GGS_mapSearchMethodListAST::cEnumerator enumerator_38161 (operand_33623->mSearchMethodList, true) ;
        const GGS_mapSearchMethodListAST::cElement * operand_38161 = NULL ;
        while (((operand_38161 = enumerator_38161.nextObject ()))) {
          macroValidPointer (operand_38161) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, operand_38161->mMethodName, var_cas_removeMethodFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (878)) COMMA_SOURCE_FILE_AT_LINE (874)) ;
        }
      }
    }
    const GGS_bool cond_39866 = (operand_33623->mMapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_39866.isBuiltAndTrue ()) {
      GGS_unifiedTypeMapProxy  var_cas_locationTypeIndex ;
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("location"), var_cas_locationTypeIndex COMMA_SOURCE_FILE_AT_LINE (885)) ;
      var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("beginBranch"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (887)), GGS_formalParameterSignature ::constructor_emptyList (), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (890)) COMMA_SOURCE_FILE_AT_LINE (886)) ;
      var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("endBranch"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (893)), GGS_formalParameterSignature ::constructor_listWithValue (var_cas_locationTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (894))), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (896)) COMMA_SOURCE_FILE_AT_LINE (892)) ;
      var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("endOverride"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (899)), GGS_formalParameterSignature ::constructor_listWithValue (var_cas_locationTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (900))), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (902)) COMMA_SOURCE_FILE_AT_LINE (898)) ;
      var_cas_instanceMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("checkAutomatonStates"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (905)), GGS_bool (false), GGS_formalParameterSignature ::constructor_listWithValue (var_cas_locationTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (907))), GGS_location (inLexique), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (910)) COMMA_SOURCE_FILE_AT_LINE (904)) ;
      {
        GGS_mapOverrideBlockListAST::cEnumerator enumerator_39593 (operand_33623->mMapOverrideBlockListAST, true) ;
        const GGS_mapOverrideBlockListAST::cElement * operand_39593 = NULL ;
        while (((operand_39593 = enumerator_39593.nextObject ()))) {
          macroValidPointer (operand_39593) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("beginOverrideFor")).operator_concat (operand_39593->mOverrideBlockName.ggs_string ().reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (914)), GGS_formalParameterSignature ::constructor_emptyList (), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (917)) COMMA_SOURCE_FILE_AT_LINE (913)) ;
        }
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_39933 (operand_33623->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_39933 = NULL ;
      while (((operand_39933 = enumerator_39933.nextObject ()))) {
        macroValidPointer (operand_39933) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, (operand_39933->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (923))).operator_concat (GGS_string ("ForKey")), operand_39933->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (923)) COMMA_SOURCE_FILE_AT_LINE (923)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_39933->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (925)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (925)) ;
        var_cas_readerMap.modifier_insertOrReplace (inLexique, var_cas_accessorName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_listWithValue (var_cas_stringTypeIndex), GGS_location (inLexique), GGS_bool (true), var_cas_attributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (933)) COMMA_SOURCE_FILE_AT_LINE (926)) ;
      }
    }
    const GGS_bool cond_40888 = (operand_33623->mInsertOrReplaceDeclarationListAST.reader_length ()).operator_supOrEqual (GGS_uint (1U)) ;
    if (cond_40888.isBuiltAndTrue ()) {
      GGS_location  var_cas_insertOrReplaceLocation ;
      if (operand_33623->mInsertOrReplaceDeclarationListAST.isBuilt ()) {
        operand_33623->mInsertOrReplaceDeclarationListAST (HERE)->method_first (inLexique, var_cas_insertOrReplaceLocation COMMA_SOURCE_FILE_AT_LINE (939)) ;
      }
      var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("insertOrReplace"), var_cas_insertOrReplaceLocation COMMA_SOURCE_FILE_AT_LINE (941)), var_cas_insertMethodFormalArgumentList, GGS_bool (false), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (944)) COMMA_SOURCE_FILE_AT_LINE (940)) ;
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_40973 (operand_33623->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_40973 = NULL ;
      while (((operand_40973 = enumerator_40973.nextObject ()))) {
        macroValidPointer (operand_40973) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_40973->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (949)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")), operand_40973->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (949)) COMMA_SOURCE_FILE_AT_LINE (949)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_40973->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (951)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (951)) ;
        GGS_formalParameterSignature  var_cas_accessorFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        var_cas_accessorFormalArgumentList.addAssign_operation (var_cas_attributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (953))) ;
        var_cas_accessorFormalArgumentList.addAssign_operation (var_cas_stringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (954))) ;
        var_cas_modifierMap.modifier_insertOrReplace (inLexique, var_cas_accessorName, var_cas_accessorFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (959)) COMMA_SOURCE_FILE_AT_LINE (955)) ;
      }
    }
    GGS_withAccessorMap  var_cas_withAccessorMap = GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (963)) ;
    var_cas_withAccessorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("hasKey"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (964)), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (964)) ;
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_41925 (operand_33623->mSearchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_41925 = NULL ;
      while (((operand_41925 = enumerator_41925.nextObject ()))) {
        macroValidPointer (operand_41925) ;
        var_cas_withAccessorMap.modifier_insertKey (inLexique, operand_41925->mMethodName, var_cas_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (966)) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_33623->mMapTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (975)), GGS_typeKindEnum::constructor_mapType (inLexique COMMA_SOURCE_FILE_AT_LINE (976)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (978)), var_cas_typedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (984)), var_cas_enumerationDescriptor, (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (986))).operator_or (function_generateCppConstructorWithNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (986))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), operand_33623->mSearchMethodList, GGS_mapSearchMethodListAST ::constructor_emptyList (), var_cas_withAccessorMap COMMA_SOURCE_FILE_AT_LINE (972)) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterInSemanticContext (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_42934,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_42934 != NULL) {
    ...
    GGS_bool automatic_var_43548_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_43548_1 ;
    GGS_typedAttributeList  automatic_var_43548_2 ;
    GGS_attributeMap  automatic_var_43548_3 ;
    GGS_constructorMap  automatic_var_43548_4 ;
    GGS_readerMap  automatic_var_43548_5 ;
    GGS_modifierMap  automatic_var_43548_6 ;
    GGS_instanceMethodMap  automatic_var_43548_7 ;
    GGS_classMethodMap  automatic_var_43548_8 ;
    GGS_enumerationDescriptorList  automatic_var_43548_9 ;
    GGS_uint  automatic_var_43548_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_43548_11 ;
    GGS_nativeAttributeList  automatic_var_43548_12 ;
    GGS_stringset  automatic_var_43548_13 ;
    GGS_lstringlist  automatic_var_43548_14 ;
    GGS_typedAttributeList  automatic_var_43548_15 ;
    GGS_mapSearchMethodListAST  automatic_var_43548_16 ;
    GGS_withAccessorMap  automatic_var_43548_17 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_42934->mAssociatedMapTypeName, automatic_var_43548_0, automatic_var_43548_1, var_cas_typeKindEnum, automatic_var_43548_2, automatic_var_43548_3, var_cas_mapTypedAttributeList, automatic_var_43548_4, automatic_var_43548_5, automatic_var_43548_6, automatic_var_43548_7, automatic_var_43548_8, automatic_var_43548_9, automatic_var_43548_10, automatic_var_43548_11, automatic_var_43548_12, automatic_var_43548_13, automatic_var_43548_14, automatic_var_43548_15, var_cas_searchMethodList, automatic_var_43548_16, automatic_var_43548_17 COMMA_SOURCE_FILE_AT_LINE (1010)) ;
    }
    const GGS_bool cond_43765 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_mapType (inLexique COMMA_SOURCE_FILE_AT_LINE (1020))) ;
    if (cond_43765.isBuiltAndTrue ()) {
      operand_42934->mAssociatedMapTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_42934->mAssociatedMapTypeName)).operator_concat (GGS_string (" should be a map type")) COMMA_SOURCE_FILE_AT_LINE (1022)) ;
      var_cas_mapTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1025)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1026)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1027)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1028)) ;
    GGS_classMethodMap  var_cas_classMethodMap = GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1029)) ;
    GGS_unifiedTypeMapProxy  var_cas_associatedMapTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_42934->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1032)), var_cas_associatedMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (1032)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1035)) ;
    GGS_unifiedTypeMapProxy  var_cas_lstringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("lstring"), var_cas_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1038)) ;
    GGS_unifiedTypeMapProxy  var_cas_mapProxyTypeProxy ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_42934->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1041)), var_cas_mapProxyTypeProxy COMMA_SOURCE_FILE_AT_LINE (1041)) ;
    GGS_formalParameterSignature  var_cas_argList = GGS_formalParameterSignature ::constructor_emptyList () ;
    var_cas_argList.addAssign_operation (var_cas_associatedMapTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentInOut (inLexique COMMA_SOURCE_FILE_AT_LINE (1044))) ;
    var_cas_argList.addAssign_operation (var_cas_stringTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1045))) ;
    var_cas_argList.addAssign_operation (var_cas_mapProxyTypeProxy, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (1046))) ;
    var_cas_classMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("makeRegularProxy"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1048)), var_cas_argList, GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1047)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("null"),  operand_42934->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1053)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1053)) ;
    ...
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_45565 (var_cas_searchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_45565 = NULL ;
      while (((operand_45565 = enumerator_45565.nextObject ()))) {
        macroValidPointer (operand_45565) ;
        var_cas_constructorMap.modifier_insertKey (inLexique, operand_45565->mMethodName, var_cas_constructorAttributeTypeList, GGS_bool (true), var_cas_mapProxyTypeProxy COMMA_SOURCE_FILE_AT_LINE (1059)) ;
      }
    }
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("isSolved"),  GGS_string ("bool"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1067)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("isNull"),  GGS_string ("bool"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1068)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("isRegular"),  GGS_string ("bool"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1069)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("lkey"),  GGS_string ("lstring"),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1070)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("key"),  GGS_string ("string"),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1071)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("identifierRepresentation"),  GGS_string ("string"),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1072)) ;
    const GGS_readerMap  var_cas_inheritedReaderMap = var_cas_readerMap ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_46531 (var_cas_mapTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_46531 = NULL ;
      while (((operand_46531 = enumerator_46531.nextObject ()))) {
        macroValidPointer (operand_46531) ;
        const GGS_bool cond_46938 = var_cas_inheritedReaderMap.reader_hasKey (operand_46531->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1076))) ;
        if (cond_46938.isBuiltAndTrue ()) {
          GGS_string var_cas_s = GGS_string ("") ;
          {
            GGS_stringset::cEnumerator enumerator_46639 (var_cas_inheritedReaderMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (1078)), true) ;
            if (enumerator_46639 .hasCurrentObject ()) {
              bool _foreach_loop_46639 ;
              do{
                var_cas_s.appendCString ("'") ;
                var_cas_s.dotAssign_operation (enumerator_46639._key (HERE)) ;
                var_cas_s.appendCString ("'") ;
                enumerator_46639.next () ;
                _foreach_loop_46639 = (enumerator_46639 .hasCurrentObject ()) ;
                if (_foreach_loop_46639) {
                  var_cas_s.appendCString (", ") ;
                }
              }while (_foreach_loop_46639) ;
            }
          }
          operand_46531->mAttributeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the map has a associated map proxy, which has predefined readers: ")).operator_concat (var_cas_s)).operator_concat (GGS_string ("; you cannot use theses names for naming an attribute of this map")) COMMA_SOURCE_FILE_AT_LINE (1084)) ;
        }else if (cond_46938.isBuiltAndFalse ()) {
          var_cas_readerMap.modifier_insertKey (inLexique, operand_46531->mAttributeName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_location (inLexique), GGS_bool (true), operand_46531->mAttributeTypeProxy, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1092)) COMMA_SOURCE_FILE_AT_LINE (1085)) ;
        }
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_42934->mMapProxyTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1100)), GGS_typeKindEnum::constructor_mapProxyType (inLexique COMMA_SOURCE_FILE_AT_LINE (1101)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1103)), var_cas_mapTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, var_cas_classMethodMap, GGS_enumerationDescriptorList ::constructor_emptyList (), (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1111))).operator_or (function_generateCppConstructorWithNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1111))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), var_cas_searchMethodList, GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1119)) COMMA_SOURCE_FILE_AT_LINE (1097)) ;
  }
}
...
category_method__enumDeclarationAST__enterInSemanticContext (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_48140,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_48140 != NULL) {
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1132)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1133)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1134)) ;
    GGS_classMethodMap  var_cas_classMethodMap = GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1135)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_48140->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1138)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1138)) ;
    GGS_stringset  var_cas_constantSet = GGS_stringset ::constructor_emptySet () ;
    {
      GGS_lstringlist::cEnumerator enumerator_48868 (operand_48140->mConstantList, true) ;
      const GGS_lstringlist::cElement * operand_48868 = NULL ;
      while (((operand_48868 = enumerator_48868.nextObject ()))) {
        macroValidPointer (operand_48868) ;
        var_cas_constantSet.addAssign_operation (operand_48868->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1142))) ;
        ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  operand_48868->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1143)),  operand_48140->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1143)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1143)) ;
      }
    }
    GGS_readerMap  var_cas_readerMap ;
    ::routine_commonReaderMapForAllTypes (inLexique,  var_cas_ioSemanticContext.mTypeMap,  var_cas_readerMap COMMA_SOURCE_FILE_AT_LINE (1147)) ;
    {
      GGS_enumMessageListAST::cEnumerator enumerator_49196 (operand_48140->mEnumMessageList, true) ;
      const GGS_enumMessageListAST::cElement * operand_49196 = NULL ;
      while (((operand_49196 = enumerator_49196.nextObject ()))) {
        macroValidPointer (operand_49196) ;
        ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_49196->mEnumMessageName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1149)),  GGS_string ("string"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1149)) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_48140->mEnumTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1155)), GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1156)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1158)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1164)), GGS_enumerationDescriptorList ::constructor_emptyList (), (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1166))).operator_or (function_isComparable (inLexique COMMA_SOURCE_FILE_AT_LINE (1166))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), var_cas_constantSet, operand_48140->mConstantList, GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1174)) COMMA_SOURCE_FILE_AT_LINE (1152)) ;
  }
}
...
void routine_recursivelyEnumerateDirectories (C_Compiler & inLexique,
  ...
  var_cas_ioWrapperDirectoryIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1196)) ;
  GGS_stringlist  var_cas_files = var_cas_inAbsoluteSourcePath.reader_regularFiles (GGS_bool (false)) ;
  var_cas_outWrapperFileMap = GGS_wrapperFileMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1199)) ;
  {
    GGS_stringlist::cEnumerator enumerator_50941 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_50941 = NULL ;
    while (((operand_50941 = enumerator_50941.nextObject ()))) {
      macroValidPointer (operand_50941) ;
      const GGS_bool cond_51284 = var_cas_inExtensionMap.reader_hasKey (operand_50941->mValue.reader_pathExtension ()) ;
      if (cond_51284.isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_50941->mValue) ;
        var_cas_outWrapperFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_50941->mValue, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1204)), var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1203)) ;
        var_cas_ioWrapperFileIndex.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1209)) ;
      }
    }
  }
  GGS_stringlist  var_cas_directories = var_cas_inAbsoluteSourcePath.reader_directories (GGS_bool (false)) ;
  var_cas_outWrapperDirectoryMap = GGS_wrapperDirectoryMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1214)) ;
  {
    GGS_stringlist::cEnumerator enumerator_51498 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_51498 = NULL ;
    while (((operand_51498 = enumerator_51498.nextObject ()))) {
      macroValidPointer (operand_51498) ;
      ...
      ::routine_recursivelyEnumerateDirectories (inLexique,  ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_51498->mValue),  ((var_cas_inPathInWrapper).operator_concat (operand_51498->mValue)).operator_concat (GGS_string ("/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileMap,  var_cas_internalWrapperDirectoryMap,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex COMMA_SOURCE_FILE_AT_LINE (1219)) ;
      var_cas_outWrapperDirectoryMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_51498->mValue, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1229)), var_cas_internalWrapperFileMap, var_cas_internalWrapperDirectoryMap, var_cas_theDirectoryIndex COMMA_SOURCE_FILE_AT_LINE (1228)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__filewrapperDeclarationAST__enterInSemanticContext (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationAST * operand_52277,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_52277 != NULL) {
    GGS_filewrapperTemplateMap  var_cas_filewrapperTemplateMap = GGS_filewrapperTemplateMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1245)) ;
    {
      GGS_filewrapperTemplateListAST::cEnumerator enumerator_52602 (operand_52277->mFilewrapperTemplateList, true) ;
      const GGS_filewrapperTemplateListAST::cElement * operand_52602 = NULL ;
      while (((operand_52602 = enumerator_52602.nextObject ()))) {
        macroValidPointer (operand_52602) ;
        GGS_unifiedTypeMapProxyList  var_cas_templateSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
        {
          GGS_formalTemplateInputParameterListAST::cEnumerator enumerator_52720 (operand_52602->mFilewrapperTemplateFormalInputParameters, true) ;
          const GGS_formalTemplateInputParameterListAST::cElement * operand_52720 = NULL ;
          while (((operand_52720 = enumerator_52720.nextObject ()))) {
            ...
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_52720->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1250)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1250)) ;
            var_cas_templateSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
          }
        }
        var_cas_filewrapperTemplateMap.modifier_insertKey (inLexique, operand_52602->mFilewrapperTemplateName, var_cas_templateSignature, operand_52602->mFilewrapperTemplatePath COMMA_SOURCE_FILE_AT_LINE (1253)) ;
      }
    }
    GGS_wrapperExtensionMap  var_cas_extensionMap = GGS_wrapperExtensionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1260)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_53233 (operand_52277->mFilewrapperExtensionList, true) ;
      const GGS_lstringlist::cElement * operand_53233 = NULL ;
      while (((operand_53233 = enumerator_53233.nextObject ()))) {
        macroValidPointer (operand_53233) ;
        var_cas_extensionMap.modifier_insertKey (inLexique, operand_53233->mValue COMMA_SOURCE_FILE_AT_LINE (1262)) ;
      }
    }
    ...
    const GGS_bool cond_53567 = (operand_52277->mFilewrapperPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1268)).reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
    if (cond_53567.isBuiltAndTrue ()) {
      var_cas_absoluteSourcePath = operand_52277->mFilewrapperPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1269)) ;
    }else if (cond_53567.isBuiltAndFalse ()) {
      var_cas_absoluteSourcePath = ((operand_52277->mSourceFileAbsolutePath.reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/"))).operator_concat (operand_52277->mFilewrapperPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1271))) ;
    }
    const GGS_bool cond_53895 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
    if (cond_53895.isBuiltAndTrue ()) {
      operand_52277->mFilewrapperPath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("The '")).operator_concat (var_cas_absoluteSourcePath)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (1276)) ;
      var_cas_regularRootFileMap.drop () ;
      var_cas_wrapperDirectoryMap.drop () ;
    }else if (cond_53895.isBuiltAndFalse ()) {
      GGS_uint  var_cas_wrapperFileIndex = GGS_uint (0U) ;
      GGS_uint  var_cas_wrapperDirectoryIndex = GGS_uint (0U) ;
      ::routine_recursivelyEnumerateDirectories (inLexique,  var_cas_absoluteSourcePath,  GGS_string ("/"),  var_cas_extensionMap,  var_cas_regularRootFileMap,  var_cas_wrapperDirectoryMap,  var_cas_wrapperFileIndex,  var_cas_wrapperDirectoryIndex COMMA_SOURCE_FILE_AT_LINE (1280)) ;
    }
    var_cas_ioSemanticContext.mFilewrapperMap.modifier_insertKey (inLexique, operand_52277->mFilewrapperName, operand_52277->mFilewrapperPath, operand_52277->mFilewrapperExtensionList, var_cas_regularRootFileMap, var_cas_wrapperDirectoryMap, var_cas_filewrapperTemplateMap COMMA_SOURCE_FILE_AT_LINE (1291)) ;
  }
}
...
category_method__listDeclarationAST__enterInSemanticContext (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_54586,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_54586 != NULL) {
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_54962 (operand_54586->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_54962 = NULL ;
      while (((operand_54962 = enumerator_54962.nextObject ()))) {
        macroValidPointer (operand_54962) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54962->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1313)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1313)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_54962->mAttributeName) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("uint"), var_cas_uintType COMMA_SOURCE_FILE_AT_LINE (1318)) ;
    GGS_unifiedTypeMapProxy  var_cas_listTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54586->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1321)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (1321)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_55879 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_55879 = NULL ;
      while (((operand_55879 = enumerator_55879.nextObject ()))) {
        macroValidPointer (operand_55879) ;
        var_cas_enumerationDescriptor.addAssign_operation (operand_55879->mAttributeTypeProxy, operand_55879->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1328))) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_55879->mAttributeTypeProxy) ;
        var_cas_modifierOutputFormalArgumentList.addAssign_operation (operand_55879->mAttributeTypeProxy, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (1330))) ;
        var_cas_modifierInputFormalArgumentList.addAssign_operation (operand_55879->mAttributeTypeProxy, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1331))) ;
      }
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1334)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyList"),  operand_54586->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1335)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1335)) ;
    var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("listWithValue"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1337)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (1336)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1343)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("length"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1344)) ;
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListFromIndex"),  GGS_string ("uint"),  operand_54586->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1345)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1345)) ;
    ::routine_enterBaseReaderWith2Arguments (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListWithRange"),  GGS_string ("uint"),  GGS_string ("uint"),  operand_54586->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1346)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1346)) ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_57049 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_57049 = NULL ;
      while (((operand_57049 = enumerator_57049.nextObject ()))) {
        macroValidPointer (operand_57049) ;
        var_cas_readerMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, (operand_57049->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1349))).operator_concat (GGS_string ("AtIndex")), operand_57049->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1349)) COMMA_SOURCE_FILE_AT_LINE (1349)), GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_listWithValue (var_cas_uintType), GGS_location (inLexique), GGS_bool (true), operand_57049->mAttributeTypeProxy, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1355)) COMMA_SOURCE_FILE_AT_LINE (1348)) ;
      }
    }
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1359)) ;
    var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("popFirst"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1361)), var_cas_modifierOutputFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1364)) COMMA_SOURCE_FILE_AT_LINE (1360)) ;
    var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("popLast"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1367)), var_cas_modifierOutputFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1370)) COMMA_SOURCE_FILE_AT_LINE (1366)) ;
    var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("prependValue"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1373)), var_cas_modifierInputFormalArgumentList, GGS_bool (false), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1376)) COMMA_SOURCE_FILE_AT_LINE (1372)) ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_57929 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_57929 = NULL ;
      while (((operand_57929 = enumerator_57929.nextObject ()))) {
        macroValidPointer (operand_57929) ;
        GGS_formalParameterSignature  var_cas_setterFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        var_cas_setterFormalArgumentList.addAssign_operation (operand_57929->mAttributeTypeProxy, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1380))) ;
        var_cas_setterFormalArgumentList.addAssign_operation (var_cas_uintType, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1381))) ;
        var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_57929->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1383)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("AtIndex")), operand_57929->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1383)) COMMA_SOURCE_FILE_AT_LINE (1383)), var_cas_setterFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1386)) COMMA_SOURCE_FILE_AT_LINE (1382)) ;
      }
    }
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1390)) ;
    var_cas_instanceMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("first"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1392)), GGS_bool (false), var_cas_modifierOutputFormalArgumentList, GGS_location (inLexique), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1397)) COMMA_SOURCE_FILE_AT_LINE (1391)) ;
    var_cas_instanceMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("last"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1400)), GGS_bool (false), var_cas_modifierOutputFormalArgumentList, GGS_location (inLexique), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1405)) COMMA_SOURCE_FILE_AT_LINE (1399)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_54586->mListTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1411)), GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1412)), var_cas_typedAttributeList, GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1414)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1420)), var_cas_enumerationDescriptor, (((function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1422))).operator_or (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1422)))).operator_or (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1422)))).operator_or (function_generateCppConstructorWithNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1422))), var_cas_constructorAttributeTypeList, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1430)) COMMA_SOURCE_FILE_AT_LINE (1408)) ;
  }
}
...
category_method__sortedListDeclarationAST__enterInSemanticContext (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_59916,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59916 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("uint"), var_cas_uintType COMMA_SOURCE_FILE_AT_LINE (1443)) ;
    GGS_unifiedTypeMapProxy  var_cas_listTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_59916->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1446)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (1446)) ;
    GGS_enumerationDescriptorList  var_cas_enumerationDescriptor = GGS_enumerationDescriptorList ::constructor_emptyList () ;
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    GGS_formalParameterSignature  var_cas_modifierFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_60815 (operand_59916->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_60815 = NULL ;
      while (((operand_60815 = enumerator_60815.nextObject ()))) {
        macroValidPointer (operand_60815) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_60815->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1454)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1454)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_60815->mAttributeName) ;
        var_cas_enumerationDescriptor.addAssign_operation (var_cas_attributeTypeIndex, operand_60815->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1456))) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_modifierFormalArgumentList.addAssign_operation (var_cas_attributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (1458))) ;
      }
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1461)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptySortedList"),  operand_59916->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1462)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1462)) ;
    var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("sortedListWithValue"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1464)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (1463)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1470)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("length"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1471)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1473)) ;
    var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("popGreatest"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1475)), var_cas_modifierFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1478)) COMMA_SOURCE_FILE_AT_LINE (1474)) ;
    var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("popSmallest"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1481)), var_cas_modifierFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1484)) COMMA_SOURCE_FILE_AT_LINE (1480)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1487)) ;
    var_cas_instanceMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("greatest"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1489)), GGS_bool (false), var_cas_modifierFormalArgumentList, GGS_location (inLexique), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1494)) COMMA_SOURCE_FILE_AT_LINE (1488)) ;
    var_cas_instanceMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("smallest"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1497)), GGS_bool (false), var_cas_modifierFormalArgumentList, GGS_location (inLexique), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1502)) COMMA_SOURCE_FILE_AT_LINE (1496)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_59916->mSortedListTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1508)), GGS_typeKindEnum::constructor_sortedListType (inLexique COMMA_SOURCE_FILE_AT_LINE (1509)), var_cas_typedAttributeList, GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1511)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1517)), var_cas_enumerationDescriptor, (((function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1519))).operator_or (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1519)))).operator_or (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1519)))).operator_or (function_generateCppConstructorWithNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1520))), var_cas_constructorAttributeTypeList, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1528)) COMMA_SOURCE_FILE_AT_LINE (1505)) ;
  }
}
...
category_method__structDeclarationAST__enterInSemanticContext (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_63628,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63628 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_structTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_63628->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1542)), var_cas_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (1542)) ;
    GGS_attributeMap  var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1544)) ;
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1545)) ;
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_64358 (operand_63628->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_64358 = NULL ;
      while (((operand_64358 = enumerator_64358.nextObject ()))) {
        macroValidPointer (operand_64358) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_64358->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1550)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1550)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_64358->mAttributeName) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_64358->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1553)) ;
      }
    }
    var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1556)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (1555)) ;
    GGS_readerMap  var_cas_readerMap ;
    ::routine_commonReaderMapForAllTypes (inLexique,  var_cas_ioSemanticContext.mTypeMap,  var_cas_readerMap COMMA_SOURCE_FILE_AT_LINE (1563)) ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_65009 (operand_63628->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_65009 = NULL ;
      while (((operand_65009 = enumerator_65009.nextObject ()))) {
        macroValidPointer (operand_65009) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_65009->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1566)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1566)) ;
        ::routine_enterBaseFinalReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_65009->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1570)),  operand_65009->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1571)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1567)) ;
      }
    }
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1576)) ;
    ...
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_63628->mStructTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1583)), GGS_typeKindEnum::constructor_structType (inLexique COMMA_SOURCE_FILE_AT_LINE (1584)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_attributeMap, var_cas_typedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1592)), GGS_enumerationDescriptorList ::constructor_emptyList (), (function_generateCppConstructorWithCurrentAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1594))).operator_or (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1595))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_typedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1603)) COMMA_SOURCE_FILE_AT_LINE (1580)) ;
  }
}
...
category_method__classDeclarationAST__enterInSemanticContext (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_66456,
                                const GGS_categoryMethodMapForBuildingContext   var_cas_inCategoryMethodMapForBuildingContext,
                                const GGS_categoryReaderMapForBuildingContext   var_cas_inCategoryReaderMapForBuildingContext,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_66456 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("uint"), var_cas_uintType COMMA_SOURCE_FILE_AT_LINE (1615)) ;
    GGS_readerMap  var_cas_readerMap ;
    GGS_modifierMap  var_cas_modifierMap ;
    GGS_instanceMethodMap  var_cas_inheritedInstanceMethodMap ;
    GGS_typedAttributeList  var_cas_inheritedTypedAttributeList ;
    GGS_attributeMap  var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1621)) ;
    GGS_unifiedTypeMapProxy  var_cas_superClassIndex ;
    const GGS_bool cond_67418 = (operand_66456->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1624))).operator_isEqual (GGS_string ("")) ;
    if (cond_67418.isBuiltAndTrue ()) {
      var_cas_superClassIndex = GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1625)) ;
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1626)) ;
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1627)) ;
      var_cas_inheritedInstanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1628)) ;
      var_cas_inheritedTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
      var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1630)) ;
    }else if (cond_67418.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_66456->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1632)), var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (1632)) ;
      GGS_typeKindEnum var_cas_typeKindEnum ;
      GGS_readerMap  var_cas_inheritedReaderMap ;
      GGS_modifierMap  var_cas_inheritedModifierMap ;
      GGS_bool automatic_var_67912_0 ;
      GGS_unifiedTypeMapProxy  automatic_var_67912_1 ;
      GGS_typedAttributeList  automatic_var_67912_2 ;
      GGS_constructorMap  automatic_var_67912_3 ;
      GGS_classMethodMap  automatic_var_67912_4 ;
      GGS_enumerationDescriptorList  automatic_var_67912_5 ;
      GGS_uint  automatic_var_67912_6 ;
      GGS_unifiedTypeMapProxyList  automatic_var_67912_7 ;
      GGS_nativeAttributeList  automatic_var_67912_8 ;
      GGS_stringset  automatic_var_67912_9 ;
      GGS_lstringlist  automatic_var_67912_10 ;
      GGS_typedAttributeList  automatic_var_67912_11 ;
      GGS_mapSearchMethodListAST  automatic_var_67912_12 ;
      GGS_mapSearchMethodListAST  automatic_var_67912_13 ;
      GGS_withAccessorMap  automatic_var_67912_14 ;
      if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
        var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_66456->mSuperClassName, automatic_var_67912_0, automatic_var_67912_1, var_cas_typeKindEnum, var_cas_inheritedTypedAttributeList, var_cas_attributeMap, automatic_var_67912_2, automatic_var_67912_3, var_cas_inheritedReaderMap, var_cas_inheritedModifierMap, var_cas_inheritedInstanceMethodMap, automatic_var_67912_4, automatic_var_67912_5, automatic_var_67912_6, automatic_var_67912_7, automatic_var_67912_8, automatic_var_67912_9, automatic_var_67912_10, automatic_var_67912_11, automatic_var_67912_12, automatic_var_67912_13, automatic_var_67912_14 COMMA_SOURCE_FILE_AT_LINE (1636)) ;
      }
      const GGS_bool cond_68069 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1649))) ;
      if (cond_68069.isBuiltAndTrue ()) {
        operand_66456->mSuperClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_66456->mSuperClassName)).operator_concat (GGS_string (" should be a class type")) COMMA_SOURCE_FILE_AT_LINE (1651)) ;
      }
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1653)) ;
      {
        GGS_modifierMap::cEnumerator enumerator_68191 (var_cas_inheritedModifierMap, true) ;
        const GGS_modifierMap::cElement * operand_68191 = NULL ;
        while (((operand_68191 = enumerator_68191.nextObject ()))) {
          macroValidPointer (operand_68191) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, operand_68191->mKey, operand_68191->mInfo.mParameterList, operand_68191->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1659)) COMMA_SOURCE_FILE_AT_LINE (1655)) ;
        }
      }
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)) ;
      {
        GGS_readerMap::cEnumerator enumerator_68471 (var_cas_inheritedReaderMap, true) ;
        const GGS_readerMap::cElement * operand_68471 = NULL ;
        while (((operand_68471 = enumerator_68471.nextObject ()))) {
          macroValidPointer (operand_68471) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_68471->mKey, operand_68471->mInfo.mIsCategory, operand_68471->mInfo.mArgumentTypeList, operand_68471->mInfo.mDeclarationLocation, operand_68471->mInfo.mHasCompilerArgument, operand_68471->mInfo.mReturnedType, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1672)) COMMA_SOURCE_FILE_AT_LINE (1665)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_68891 (var_cas_inheritedTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_68891 = NULL ;
      while (((operand_68891 = enumerator_68891.nextObject ()))) {
        macroValidPointer (operand_68891) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_68891->mAttributeTypeProxy) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_68994 (operand_66456->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_68994 = NULL ;
      while (((operand_68994 = enumerator_68994.nextObject ()))) {
        macroValidPointer (operand_68994) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_68994->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1683)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1683)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_68994->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1685)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_classIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_66456->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1689)), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1689)) ;
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1691)) ;
    const GGS_bool cond_69720 = (operand_66456->mIsAbstract).operator_not () ;
    if (cond_69720.isBuiltAndTrue ()) {
      var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1694)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1693)) ;
    }
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)) ;
    {
      GGS_instanceMethodMap::cEnumerator enumerator_69851 (var_cas_inheritedInstanceMethodMap, true) ;
      const GGS_instanceMethodMap::cElement * operand_69851 = NULL ;
      while (((operand_69851 = enumerator_69851.nextObject ()))) {
        macroValidPointer (operand_69851) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_69851->mKey, operand_69851->mInfo.mIsCategory, operand_69851->mInfo.mParameterList, operand_69851->mInfo.mDeclarationLocation, operand_69851->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1709)) COMMA_SOURCE_FILE_AT_LINE (1703)) ;
      }
    }
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_70133 (operand_66456->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_70133 = NULL ;
      while (((operand_70133 = enumerator_70133.nextObject ()))) {
        macroValidPointer (operand_70133) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_70222 (operand_70133->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_70222 = NULL ;
          while (((operand_70222 = enumerator_70222.nextObject ()))) {
            macroValidPointer (operand_70222) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_70222->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1717)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1717)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_70222->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_70503 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_70133->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1720))) ;
        if (NULL != operand_70503) {
          operand_70503->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1721)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_70133->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_70133->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1727)), GGS_bool (true), GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1729)) COMMA_SOURCE_FILE_AT_LINE (1723)) ;
        }
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_70920 (operand_66456->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_70920 = NULL ;
      while (((operand_70920 = enumerator_70920.nextObject ()))) {
        macroValidPointer (operand_70920) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_71009 (operand_70920->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_71009 = NULL ;
          while (((operand_71009 = enumerator_71009.nextObject ()))) {
            macroValidPointer (operand_71009) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_71009->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1738)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1738)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_71009->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_71290 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_70920->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1741))) ;
        if (NULL != operand_71290) {
          operand_71290->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverriding (inLexique COMMA_SOURCE_FILE_AT_LINE (1742)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_70920->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_70920->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1748)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1750)) COMMA_SOURCE_FILE_AT_LINE (1744)) ;
        }
      }
    }
    const GGS_bool cond_72528 = var_cas_inCategoryMethodMapForBuildingContext.reader_hasKey (operand_66456->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1755))) ;
    if (cond_72528.isBuiltAndTrue ()) {
      ...
      if (var_cas_inCategoryMethodMapForBuildingContext.isBuilt ()) {
        var_cas_inCategoryMethodMapForBuildingContext (HERE)->method_searchKey (inLexique, operand_66456->mClassTypeName, var_cas_categoryMethodMapForType COMMA_SOURCE_FILE_AT_LINE (1757)) ;
      }
      {
        GGS_categoryMethodMapForType::cEnumerator enumerator_71947 (var_cas_categoryMethodMapForType, true) ;
        const GGS_categoryMethodMapForType::cElement * operand_71947 = NULL ;
        while (((operand_71947 = enumerator_71947.nextObject ()))) {
          macroValidPointer (operand_71947) ;
          GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
          {
            GGS_formalParameterListAST::cEnumerator enumerator_72050 (operand_71947->mInfo.mFormalParameterList, true) ;
            const GGS_formalParameterListAST::cElement * operand_72050 = NULL ;
            while (((operand_72050 = enumerator_72050.nextObject ()))) {
              macroValidPointer (operand_72050) ;
              GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
              GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_72050->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1762)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1762)) ;
              var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_72050->mFormalArgumentPassingMode) ;
            }
          }
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_71947->mKey, GGS_bool (true), var_cas_formalArgumentList, operand_71947->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1769)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1771)) COMMA_SOURCE_FILE_AT_LINE (1765)) ;
        }
      }
    }
    const GGS_bool cond_73582 = var_cas_inCategoryReaderMapForBuildingContext.reader_hasKey (operand_66456->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1776))) ;
    if (cond_73582.isBuiltAndTrue ()) {
      GGS_categoryReaderMapForType  var_cas_categoryReaderMapForType ;
      if (var_cas_inCategoryReaderMapForBuildingContext.isBuilt ()) {
        var_cas_inCategoryReaderMapForBuildingContext (HERE)->method_searchKey (inLexique, operand_66456->mClassTypeName, var_cas_categoryReaderMapForType COMMA_SOURCE_FILE_AT_LINE (1778)) ;
      }
      {
        GGS_categoryReaderMapForType::cEnumerator enumerator_72851 (var_cas_categoryReaderMapForType, true) ;
        const GGS_categoryReaderMapForType::cElement * operand_72851 = NULL ;
        while (((operand_72851 = enumerator_72851.nextObject ()))) {
          macroValidPointer (operand_72851) ;
          GGS_unifiedTypeMapProxyList  var_cas_formalArgumentList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
          {
            GGS_formalInputParameterListAST::cEnumerator enumerator_72958 (operand_72851->mInfo.mInputFormalParameterList, true) ;
            const GGS_formalInputParameterListAST::cElement * operand_72958 = NULL ;
            while (((operand_72958 = enumerator_72958.nextObject ()))) {
              macroValidPointer (operand_72958) ;
              GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
              GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_72958->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1783)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1783)) ;
              var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex) ;
            }
          }
          GGS_unifiedTypeMapProxy  var_cas_returnedType ;
          GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_72851->mInfo.mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1787)), var_cas_returnedType COMMA_SOURCE_FILE_AT_LINE (1787)) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_72851->mKey, GGS_bool (true), var_cas_formalArgumentList, operand_72851->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1792)), GGS_bool (true), var_cas_returnedType, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1795)) COMMA_SOURCE_FILE_AT_LINE (1788)) ;
        }
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_73782 (operand_66456->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_73782 = NULL ;
      while (((operand_73782 = enumerator_73782.nextObject ()))) {
        macroValidPointer (operand_73782) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_73782->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1804)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1804)) ;
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_73782->mAttributeName) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_73782->mAttributeName) ;
        var_cas_readerMap.modifier_insertKey (inLexique, operand_73782->mAttributeName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_location (inLexique), GGS_bool (false), var_cas_attributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1814)) COMMA_SOURCE_FILE_AT_LINE (1807)) ;
      }
    }
    {
      GGS_typedAttributeList::cEnumerator enumerator_74458 (var_cas_currentClassTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_74458 = NULL ;
      while (((operand_74458 = enumerator_74458.nextObject ()))) {
        macroValidPointer (operand_74458) ;
        var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_74458->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1820)).reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1820)), GGS_formalParameterSignature ::constructor_listWithValue (operand_74458->mAttributeTypeProxy, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1821))), GGS_bool (false), GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (1823)) COMMA_SOURCE_FILE_AT_LINE (1819)) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_66456->mClassTypeName, (operand_66456->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1831)), var_cas_allTypedAttributeList, var_cas_attributeMap, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1839)), GGS_enumerationDescriptorList ::constructor_emptyList (), function_generateCppConstructorWithAllAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1841)), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_currentClassTypedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1849)) COMMA_SOURCE_FILE_AT_LINE (1827)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterInSemanticContext (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_75714,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_75714 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_76072 (operand_75714->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_76072 = NULL ;
      while (((operand_76072 = enumerator_76072.nextObject ()))) {
        macroValidPointer (operand_76072) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_76072->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1864)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1864)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_76072->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_75714->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1868)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterInSemanticContext (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_76618,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_76618 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_76977 (operand_76618->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_76977 = NULL ;
      while (((operand_76977 = enumerator_76977.nextObject ()))) {
        macroValidPointer (operand_76977) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_76977->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1882)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1882)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_76618->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1887)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1887)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_76618->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1889)) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterInSemanticContext (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_77690,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_77690 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_77690->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1901)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1901)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_77690->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1903)) ;
  }
}
...
category_method__listmapDeclarationAST__enterInSemanticContext (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_78388,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_78388 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_78958_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_78958_1 ;
    GGS_attributeMap  automatic_var_78958_2 ;
    GGS_typedAttributeList  automatic_var_78958_3 ;
    GGS_constructorMap  automatic_var_78958_4 ;
    GGS_readerMap  automatic_var_78958_5 ;
    GGS_modifierMap  automatic_var_78958_6 ;
    GGS_instanceMethodMap  automatic_var_78958_7 ;
    GGS_classMethodMap  automatic_var_78958_8 ;
    GGS_enumerationDescriptorList  automatic_var_78958_9 ;
    GGS_uint  automatic_var_78958_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_78958_11 ;
    GGS_nativeAttributeList  automatic_var_78958_12 ;
    GGS_stringset  automatic_var_78958_13 ;
    GGS_lstringlist  automatic_var_78958_14 ;
    GGS_typedAttributeList  automatic_var_78958_15 ;
    GGS_mapSearchMethodListAST  automatic_var_78958_16 ;
    GGS_mapSearchMethodListAST  automatic_var_78958_17 ;
    GGS_withAccessorMap  automatic_var_78958_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_78388->mAssociatedListTypeName, automatic_var_78958_0, automatic_var_78958_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_78958_2, automatic_var_78958_3, automatic_var_78958_4, automatic_var_78958_5, automatic_var_78958_6, automatic_var_78958_7, automatic_var_78958_8, automatic_var_78958_9, automatic_var_78958_10, automatic_var_78958_11, automatic_var_78958_12, automatic_var_78958_13, automatic_var_78958_14, automatic_var_78958_15, automatic_var_78958_16, automatic_var_78958_17, automatic_var_78958_18 COMMA_SOURCE_FILE_AT_LINE (1917)) ;
    }
    const GGS_bool cond_79187 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1924))) ;
    if (cond_79187.isBuiltAndTrue ()) {
      operand_78388->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_78388->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1926)) ;
      var_cas_listTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1929)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1930)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1931)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1932)) ;
    GGS_unifiedTypeMapProxy  var_cas_associatedListTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_78388->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1935)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1935)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_78388->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1938)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1938)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1941)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("count"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1943)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("allKeys"),  GGS_string ("stringset"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1944)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("keyList"),  GGS_string ("stringlist"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1945)) ;
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("listForKey"),  GGS_string ("string"),  operand_78388->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1946)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1946)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_78388->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1948)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1948)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_80974 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_80974 = NULL ;
      while (((operand_80974 = enumerator_80974.nextObject ()))) {
        macroValidPointer (operand_80974) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_80974->mAttributeTypeProxy) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_78388->mListmapTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1963)), GGS_typeKindEnum::constructor_listMapType (inLexique COMMA_SOURCE_FILE_AT_LINE (1964)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1966)), var_cas_listTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1972)), var_cas_enumeratorDescriptor, (((function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1974))).operator_or (function_generateCppConstructorWithNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1974)))).operator_or (function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1974)))).operator_or (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1974))), var_cas_addAssignOperatorDescription, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1982)) COMMA_SOURCE_FILE_AT_LINE (1960)) ;
  }
}
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_82859,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_82859 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_82859 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_82859->mPredefinedTypeName, operand_82859) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_83228,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_83228 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_83228->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2021)), operand_83228->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2021)), operand_83228) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_83567,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_83567 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_83567->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2029)), operand_83567) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_83885,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_83885 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_83885->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2037)), operand_83885) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_84203,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_84203 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_84203->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2045)), operand_84203) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_84525,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_84525 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_84525->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2053)), operand_84525) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_84850,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_84850 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_84850->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2061)), operand_84850->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2061)), operand_84850) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_85198,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_85198 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_85198->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2069)), operand_85198) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_85517,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_85517 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_85517->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2077)), operand_85517->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2077)), operand_85517) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externFunctionDeclarationAST * operand_85876,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_85876 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_85876) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_onceFunctionDeclarationAST * operand_86180,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_86180 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_86180) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externRoutineDeclarationAST * operand_86485,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_86485 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_86485) ;
  }
}
...
category_method__filewrapperDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_filewrapperDeclarationAST * operand_86788,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_86788 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_86788) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  #endif
  GGS_collectedTypeMap  var_cas_collectedTypeMap = GGS_collectedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2125)) ;
  GGS_categoryMethodMapForBuildingContext  var_cas_categoryMethodMapForBuildingContext = GGS_categoryMethodMapForBuildingContext ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2126)) ;
  GGS_categoryReaderMapForBuildingContext  var_cas_categoryReaderMapForBuildingContext = GGS_categoryReaderMapForBuildingContext ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2127)) ;
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_87847 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_87847 = NULL ;
    while (((operand_87847 = enumerator_87847.nextObject ()))) {
      macroValidPointer (operand_87847) ;
      { typeCategoryMethod__semanticDeclarationAST__collectTypes method = findCategoryMethod__semanticDeclarationAST__collectTypes (operand_87847->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_87847->mSemanticDeclaration (HERE), var_cas_collectedTypeMap, var_cas_categoryMethodMapForBuildingContext, var_cas_categoryReaderMapForBuildingContext COMMA_SOURCE_FILE_AT_LINE (2129)) ;
        }
      }
    }
  }
  GGS_stringlist  var_cas_undefinedClasses = var_cas_collectedTypeMap.reader_unsolvedProxyKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (2136)) ;
  const GGS_bool cond_88406 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_88406.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_88269 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_88269 = NULL ;
      while (((operand_88269 = enumerator_88269.nextObject ()))) {
        macroValidPointer (operand_88269) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_88269->mValue) ;
      }
    }
    var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (2143)) ;
    var_cas_outSemanticContext.drop () ;
  }else if (cond_88406.isBuiltAndFalse ()) {
    const GGS_bool cond_88708 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_88708.isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = ((GGS_string ("there are ")).operator_concat (var_cas_undefinedClasses.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2144)))).operator_concat (GGS_string (" undefined types:")) ;
      {
        GGS_stringlist::cEnumerator enumerator_88572 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_88572 = NULL ;
        while (((operand_88572 = enumerator_88572.nextObject ()))) {
          macroValidPointer (operand_88572) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_88572->mValue) ;
        }
      }
      var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (2149)) ;
      var_cas_outSemanticContext.drop () ;
    }else if (cond_88708.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_89071 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_89071 = NULL ;
        while (((operand_89071 = enumerator_89071.nextObject ()))) {
          macroValidPointer (operand_89071) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_89071->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_89071->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (2156)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_90185 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_90185 (_variant_90185.isBuilt (), true) ;
      while (_condition_90185.isBuiltAndTrue ()) {
        _condition_90185 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_90185.isBuiltAndTrue ()) {
          if (_variant_90185.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2177)) ;
            _condition_90185 = GGS_bool (false) ;
          }else{
            _variant_90185.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_89800 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_89800 = NULL ;
              while (((operand_89800 = enumerator_89800.nextObject ()))) {
                macroValidPointer (operand_89800) ;
                const GGS_bool cond_90028 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_89800->mDependanceString) ;
                if (cond_90028.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_89800->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_89800->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_90028.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_89800->mDependanceString, operand_89800->mTypeString, operand_89800->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_91025 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_91025.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_90684 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_90684 = enumerator_90684.nextObject () ;
          if ((operand_90684 != NULL)) {
            bool _foreach_loop_90684 ;
            do{
              macroValidPointer (operand_90684) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_90684->mTypeString) ;
              operand_90684 = enumerator_90684.nextObject () ;
              _foreach_loop_90684 = ((operand_90684 != NULL)) ;
              if (_foreach_loop_90684) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_90684) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_90857 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_90857 = NULL ;
          while (((operand_90857 = enumerator_90857.nextObject ()))) {
            macroValidPointer (operand_90857) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_90857->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_90857->mDependanceString) ;
          }
        }
        var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (2196)) ;
        var_cas_outSemanticContext.drop () ;
      }else if (cond_91025.isBuiltAndFalse ()) {
        var_cas_outSemanticContext = GGS_semanticContext::constructor_new (var_cas_inSourceFile, GGS_unifiedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2200)), GGS_routineMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2201)), GGS_functionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2202)), GGS_filewrapperMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2203)), GGS_grammarMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2204)), GGS_optionComponentMapForSemanticAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2205))) ;
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_91463 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_91463 = NULL ;
          while (((operand_91463 = enumerator_91463.nextObject ()))) {
            macroValidPointer (operand_91463) ;
            { typeCategoryMethod__semanticDeclarationAST__enterInSemanticContext method = findCategoryMethod__semanticDeclarationAST__enterInSemanticContext (operand_91463->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_91463->mSemanticDeclaration (HERE), var_cas_categoryMethodMapForBuildingContext, var_cas_categoryReaderMapForBuildingContext, var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (2209)) ;
              }
            }
          }
        }
