...
category_method__classDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_43550,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_43550 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    ...
    const GGS_bool cond_44451 = (operand_43550->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1097))).operator_isEqual (GGS_string ("")) ;
    if (cond_44451.isBuiltAndTrue ()) {
    ...
    }else if (cond_44451.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_43550->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1105)), var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (1105)) ;
      GGS_typeKindEnum var_cas_typeKindEnum ;
      GGS_readerMap  var_cas_inheritedReaderMap ;
      GGS_modifierMap  var_cas_inheritedModifierMap ;
      GGS_bool automatic_var_44945_0 ;
      GGS_unifiedTypeMapProxy  automatic_var_44945_1 ;
      GGS_typedAttributeList  automatic_var_44945_2 ;
      GGS_constructorMap  automatic_var_44945_3 ;
      GGS_classMethodMap  automatic_var_44945_4 ;
      GGS_enumerationDescriptorList  automatic_var_44945_5 ;
      GGS_uint  automatic_var_44945_6 ;
      GGS_unifiedTypeMapProxyList  automatic_var_44945_7 ;
      GGS_nativeAttributeList  automatic_var_44945_8 ;
      GGS_stringset  automatic_var_44945_9 ;
      GGS_lstringlist  automatic_var_44945_10 ;
      GGS_typedAttributeList  automatic_var_44945_11 ;
      GGS_mapSearchMethodListAST  automatic_var_44945_12 ;
      GGS_mapSearchMethodListAST  automatic_var_44945_13 ;
      GGS_withAccessorMap  automatic_var_44945_14 ;
      if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
        var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_43550->mSuperClassName, automatic_var_44945_0, automatic_var_44945_1, var_cas_typeKindEnum, var_cas_inheritedTypedAttributeList, var_cas_attributeMap, automatic_var_44945_2, automatic_var_44945_3, var_cas_inheritedReaderMap, var_cas_inheritedModifierMap, var_cas_inheritedInstanceMethodMap, automatic_var_44945_4, automatic_var_44945_5, automatic_var_44945_6, automatic_var_44945_7, automatic_var_44945_8, automatic_var_44945_9, automatic_var_44945_10, automatic_var_44945_11, automatic_var_44945_12, automatic_var_44945_13, automatic_var_44945_14 COMMA_SOURCE_FILE_AT_LINE (1109)) ;
      }
      const GGS_bool cond_45102 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1122))) ;
      if (cond_45102.isBuiltAndTrue ()) {
        operand_43550->mSuperClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_43550->mSuperClassName)).operator_concat (GGS_string (" should be a class type")) COMMA_SOURCE_FILE_AT_LINE (1124)) ;
      }
      ...
      {
        GGS_readerMap::cEnumerator enumerator_45512 (var_cas_inheritedReaderMap, true) ;
        const GGS_readerMap::cElement * operand_45512 = NULL ;
        while (((operand_45512 = enumerator_45512.nextObject ()))) {
          macroValidPointer (operand_45512) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_45512->mKey, operand_45512->mInfo.mArgumentTypeList, operand_45512->mInfo.mHasCompilerArgument, operand_45512->mInfo.mReturnedType, GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1143)) COMMA_SOURCE_FILE_AT_LINE (1138)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_45881 (var_cas_inheritedTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_45881 = NULL ;
      while (((operand_45881 = enumerator_45881.nextObject ()))) {
        macroValidPointer (operand_45881) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_45881->mAttributeTypeIndex) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_45984 (operand_43550->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_45984 = NULL ;
      while (((operand_45984 = enumerator_45984.nextObject ()))) {
        macroValidPointer (operand_45984) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_45984->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1154)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1154)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_45984->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1156)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_classIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_43550->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1160)), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1160)) ;
    ...
    const GGS_bool cond_46710 = (operand_43550->mIsAbstract).operator_not () ;
    if (cond_46710.isBuiltAndTrue ()) {
    ...
    {
      GGS_instanceMethodMap::cEnumerator enumerator_46841 (var_cas_inheritedInstanceMethodMap, true) ;
      const GGS_instanceMethodMap::cElement * operand_46841 = NULL ;
      while (((operand_46841 = enumerator_46841.nextObject ()))) {
        macroValidPointer (operand_46841) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_46841->mKey, operand_46841->mInfo.mParameterList, operand_46841->mInfo.mDeclarationLocation, operand_46841->mInfo.mHasCompilerArgument, GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1179)) COMMA_SOURCE_FILE_AT_LINE (1174)) ;
      }
    }
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_47104 (operand_43550->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_47104 = NULL ;
      while (((operand_47104 = enumerator_47104.nextObject ()))) {
        macroValidPointer (operand_47104) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_47193 (operand_47104->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_47193 = NULL ;
          while (((operand_47193 = enumerator_47193.nextObject ()))) {
            macroValidPointer (operand_47193) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_47193->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1187)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1187)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_47193->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_47474 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_47104->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1190))) ;
        if (NULL != operand_47474) {
          operand_47474->mInfo.mQualifier = GGS_readerQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1191)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_47104->mMethodName, var_cas_formalArgumentList, operand_47104->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1196)), GGS_bool (true), GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1198)) COMMA_SOURCE_FILE_AT_LINE (1193)) ;
        }
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_47856 (operand_43550->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_47856 = NULL ;
      while (((operand_47856 = enumerator_47856.nextObject ()))) {
        macroValidPointer (operand_47856) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_47945 (operand_47856->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_47945 = NULL ;
          while (((operand_47945 = enumerator_47945.nextObject ()))) {
            macroValidPointer (operand_47945) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_47945->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1207)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1207)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_47945->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_48226 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_47856->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1210))) ;
        if (NULL != operand_48226) {
          operand_48226->mInfo.mQualifier = GGS_readerQualifier::constructor_isOverriding (inLexique COMMA_SOURCE_FILE_AT_LINE (1211)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_47856->mMethodName, var_cas_formalArgumentList, operand_47856->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1216)), GGS_bool (true), GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1218)) COMMA_SOURCE_FILE_AT_LINE (1213)) ;
        }
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_48725 (operand_43550->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_48725 = NULL ;
      while (((operand_48725 = enumerator_48725.nextObject ()))) {
        macroValidPointer (operand_48725) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_48725->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1227)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1227)) ;
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_48725->mAttributeName) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_48725->mAttributeName) ;
        var_cas_readerMap.modifier_insertKey (inLexique, operand_48725->mAttributeName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1235)) COMMA_SOURCE_FILE_AT_LINE (1230)) ;
      }
    }
    const GGS_bool cond_49726 = (operand_43550->mIsAbstract).operator_not () ;
    if (cond_49726.isBuiltAndTrue ()) {
      {
        GGS_typedAttributeList::cEnumerator enumerator_49377 (var_cas_allTypedAttributeList, true) ;
        const GGS_typedAttributeList::cElement * operand_49377 = NULL ;
        while (((operand_49377 = enumerator_49377.nextObject ()))) {
          macroValidPointer (operand_49377) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_49377->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1242)), GGS_formalParameterSignature ::constructor_listWithValue (operand_49377->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1243))), GGS_bool (false), GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1245)) COMMA_SOURCE_FILE_AT_LINE (1241)) ;
        }
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_43550->mClassTypeName, (operand_43550->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1254)), var_cas_allTypedAttributeList, var_cas_attributeMap, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1262)), GGS_enumerationDescriptorList ::constructor_emptyList (), ((function_generateCppConstructorWithAllAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1264))).operator_or (function_generateVirtualDestructor (inLexique COMMA_SOURCE_FILE_AT_LINE (1264)))).operator_or (((operand_43550->mIsAbstract).isBuiltAndTrue () ? (GGS_uint (0U)) : (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1264))))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_currentClassTypedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1272)) COMMA_SOURCE_FILE_AT_LINE (1250)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_50737,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_50737 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_50923 (operand_50737->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_50923 = NULL ;
      while (((operand_50923 = enumerator_50923.nextObject ()))) {
        macroValidPointer (operand_50923) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_50923->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1285)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1285)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_50923->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_50737->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1289)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_51456,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_51456 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_51643 (operand_51456->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_51643 = NULL ;
      while (((operand_51643 = enumerator_51643.nextObject ()))) {
        macroValidPointer (operand_51643) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51643->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1301)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1301)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51456->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1306)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1306)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_51456->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1308)) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_52343,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_52343 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_52343->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1318)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1318)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_52343->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1320)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_52856,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_52856 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_53241_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_53241_1 ;
    GGS_attributeMap  automatic_var_53241_2 ;
    GGS_typedAttributeList  automatic_var_53241_3 ;
    GGS_constructorMap  automatic_var_53241_4 ;
    GGS_readerMap  automatic_var_53241_5 ;
    GGS_modifierMap  automatic_var_53241_6 ;
    GGS_instanceMethodMap  automatic_var_53241_7 ;
    GGS_classMethodMap  automatic_var_53241_8 ;
    GGS_enumerationDescriptorList  automatic_var_53241_9 ;
    GGS_uint  automatic_var_53241_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_53241_11 ;
    GGS_nativeAttributeList  automatic_var_53241_12 ;
    GGS_stringset  automatic_var_53241_13 ;
    GGS_lstringlist  automatic_var_53241_14 ;
    GGS_typedAttributeList  automatic_var_53241_15 ;
    GGS_mapSearchMethodListAST  automatic_var_53241_16 ;
    GGS_mapSearchMethodListAST  automatic_var_53241_17 ;
    GGS_withAccessorMap  automatic_var_53241_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_52856->mAssociatedListTypeName, automatic_var_53241_0, automatic_var_53241_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_53241_2, automatic_var_53241_3, automatic_var_53241_4, automatic_var_53241_5, automatic_var_53241_6, automatic_var_53241_7, automatic_var_53241_8, automatic_var_53241_9, automatic_var_53241_10, automatic_var_53241_11, automatic_var_53241_12, automatic_var_53241_13, automatic_var_53241_14, automatic_var_53241_15, automatic_var_53241_16, automatic_var_53241_17, automatic_var_53241_18 COMMA_SOURCE_FILE_AT_LINE (1332)) ;
    }
    const GGS_bool cond_53470 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1339))) ;
    if (cond_53470.isBuiltAndTrue ()) {
      operand_52856->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_52856->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1341)) ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_52856->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1350)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1350)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_52856->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1353)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1353)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_52856->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1360)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1360)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_54891 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_54891 = NULL ;
      while (((operand_54891 = enumerator_54891.nextObject ()))) {
        macroValidPointer (operand_54891) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_54891->mAttributeTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("listmap"), var_cas_superTypeProxy COMMA_SOURCE_FILE_AT_LINE (1373)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_52856->mListmapTypeName, GGS_bool (true), var_cas_superTypeProxy, GGS_typeKindEnum::constructor_listMapType (inLexique COMMA_SOURCE_FILE_AT_LINE (1378)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1380)), var_cas_listTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1386)), var_cas_enumeratorDescriptor, (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1388))).operator_or (function_generateCppConstructorWithNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1388))), var_cas_addAssignOperatorDescription, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1396)) COMMA_SOURCE_FILE_AT_LINE (1374)) ;
  }
}
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_56855,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_56855 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_56855 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation ((findCategoryReader__predefinedTypeAST__getSuperTypeName (var_cas_t (HERE)->galgasRTTI ()) (inLexique, var_cas_t.getPtr () COMMA_SOURCE_FILE_AT_LINE (1427))), operand_56855->mPredefinedTypeName, operand_56855) ;
  }
}
...
category_method__objectPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_objectPredefinedTypeAST * operand_57238,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57238 != NULL) {
    GGS_objectPredefinedTypeAST  var_cas_t = operand_57238 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string ("object"), operand_57238) ;
  }
}
...
category_method__stringsetPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_stringsetPredefinedTypeAST * operand_57601,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57601 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enumerable"), operand_57601->mPredefinedTypeName, operand_57601) ;
  }
}
...
category_method__genericTypeTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_genericTypeTypeAST * operand_57920,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57920 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_57920->mSuperTypeName, operand_57920->mTypeName, operand_57920) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_58232,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58232 != NULL) {
    const GGS_string var_cas_actualSuperTypeName = (((operand_58232->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1460))).operator_isEqual (GGS_string (""))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_58232->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1460)))) ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (var_cas_actualSuperTypeName, operand_58232->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1461)), operand_58232) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_58684,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58684 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("list"), operand_58684->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1469)), operand_58684) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_59002,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59002 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("struct"), operand_59002->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1477)), operand_59002) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_59322,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59322 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enum"), operand_59322->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1485)), operand_59322) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_59644,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59644 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("sortedlist"), operand_59644->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1493)), operand_59644) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_59975,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59975 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_59975->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1501)), operand_59975->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1501)), operand_59975) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_60319,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60319 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("map"), operand_60319->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1509)), operand_60319) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_60637,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60637 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_60637->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1517)), operand_60637->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1517)), operand_60637) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externFunctionDeclarationAST * operand_60992,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60992 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_60992) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externRoutineDeclarationAST * operand_61293,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61293 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_61293) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  #endif
  GGS_collectedTypeMap  var_cas_collectedTypeMap = GGS_collectedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1548)) ;
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_62147 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_62147 = NULL ;
    while (((operand_62147 = enumerator_62147.nextObject ()))) {
      macroValidPointer (operand_62147) ;
      { typeCategoryMethod__semanticDeclarationAST__collectType method = findCategoryMethod__semanticDeclarationAST__collectType (operand_62147->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_62147->mSemanticDeclaration (HERE), var_cas_collectedTypeMap COMMA_SOURCE_FILE_AT_LINE (1550)) ;
        }
      }
    }
  }
  GGS_stringlist  var_cas_undefinedClasses = var_cas_collectedTypeMap.reader_unsolvedIndexKeyStringList (inLexique COMMA_SOURCE_FILE_AT_LINE (1553)) ;
  const GGS_bool cond_62612 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_62612.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_62475 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_62475 = NULL ;
      while (((operand_62475 = enumerator_62475.nextObject ()))) {
        macroValidPointer (operand_62475) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_62475->mValue) ;
      }
    }
    var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (1560)) ;
    var_cas_outSemanticContext.drop () ;
  }else if (cond_62612.isBuiltAndFalse ()) {
    const GGS_bool cond_62914 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_62914.isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = ((GGS_string ("there are ")).operator_concat (var_cas_undefinedClasses.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1561)))).operator_concat (GGS_string (" undefined types:")) ;
      {
        GGS_stringlist::cEnumerator enumerator_62778 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_62778 = NULL ;
        while (((operand_62778 = enumerator_62778.nextObject ()))) {
          macroValidPointer (operand_62778) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_62778->mValue) ;
        }
      }
      var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (1566)) ;
      var_cas_outSemanticContext.drop () ;
    }else if (cond_62914.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_63277 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_63277 = NULL ;
        while (((operand_63277 = enumerator_63277.nextObject ()))) {
          macroValidPointer (operand_63277) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_63277->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_63277->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (1573)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_64391 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_64391 (_variant_64391.isBuilt (), true) ;
      while (_condition_64391.isBuiltAndTrue ()) {
        _condition_64391 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_64391.isBuiltAndTrue ()) {
          if (_variant_64391.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1594)) ;
            _condition_64391 = GGS_bool (false) ;
          }else{
            _variant_64391.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_64006 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_64006 = NULL ;
              while (((operand_64006 = enumerator_64006.nextObject ()))) {
                macroValidPointer (operand_64006) ;
                const GGS_bool cond_64234 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_64006->mDependanceString) ;
                if (cond_64234.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_64006->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_64006->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_64234.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_64006->mDependanceString, operand_64006->mTypeString, operand_64006->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_65014 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_65014.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_64673 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_64673 = enumerator_64673.nextObject () ;
          if ((operand_64673 != NULL)) {
            bool _foreach_loop_64673 ;
            do{
              macroValidPointer (operand_64673) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_64673->mTypeString) ;
              operand_64673 = enumerator_64673.nextObject () ;
              _foreach_loop_64673 = ((operand_64673 != NULL)) ;
              if (_foreach_loop_64673) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_64673) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_64846 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_64846 = NULL ;
          while (((operand_64846 = enumerator_64846.nextObject ()))) {
            macroValidPointer (operand_64846) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_64846->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_64846->mDependanceString) ;
          }
        }
        var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (1607)) ;
        var_cas_outSemanticContext.drop () ;
      }else if (cond_65014.isBuiltAndFalse ()) {
        var_cas_outSemanticContext = GGS_semanticContext::constructor_new (GGS_unifiedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1610)), GGS_routineMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1611)), GGS_functionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1612)), GGS_filewrapperMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1613)), GGS_grammarMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1614)), GGS_optionComponentMapForSemanticAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1615))) ;
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_65430 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_65430 = NULL ;
          while (((operand_65430 = enumerator_65430.nextObject ()))) {
            macroValidPointer (operand_65430) ;
            { typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (operand_65430->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_65430->mSemanticDeclaration (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (1619)) ;
              }
            }
          }
        }
