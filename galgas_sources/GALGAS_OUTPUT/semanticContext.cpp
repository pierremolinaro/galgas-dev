...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_148445 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_148445.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_148445.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3615)) ;
    enumerator_148445.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_149178 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_149178.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_149178.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3627)) ;
    enumerator_149178.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_149653 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE ("semanticContext.gSemantics", 3637)), kEnumeration_up) ;
    while (enumerator_149653.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_149653.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_149653.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3638))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3638)).operator_concat (GALGAS_string ("' type is not defined")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3638))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3638)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
      enumerator_149653.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    ...
    GALGAS_lstringlist joker_149893_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_149893_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3641)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_150288 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_150288.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_150288.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3650))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3650))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3650)) ;
        enumerator_150288.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_151041 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_151041.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_151041.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3669)) ;
        enumerator_151041.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_90563 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_90563.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_90563.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2243)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_90563.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2246)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_90563.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2247)) ;
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_90563.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2248)) ;
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 2249)), enumerator_90563.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2249)) ;
    enumerator_90563.gotoNextObject () ;
  }
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_95142 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_95142.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_95142.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2367)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_95142.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2368)) ;
    ...
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_95142.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2372)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_95142.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2373)) ;
    }
    enumerator_95142.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_95927 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_95927.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_95927.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2388)), enumerator_95927.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2389)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2385)) ;
    }
    enumerator_95927.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_96977 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_96977.hasCurrentObject () && bool_1) {
    while (enumerator_96977.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_96977.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2422)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_96977.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2422)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2422)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2422)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_96977.gotoNextObject () ;
      if (enumerator_96977.hasCurrentObject ()) {
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_99517 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_99517.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_99517.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2487)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_99517.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    ...
    GALGAS_bool joker_99996_3 ; // Joker input parameter
    GALGAS_bool joker_99996_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_99996_1 ; // Joker input parameter
    GALGAS_bool joker_100026_0 ; // Joker input parameter
    GALGAS_typedAttributeList joker_100090_2 ; // Joker input parameter
    GALGAS_constructorMap joker_100090_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_100180_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_100180_9 ; // Joker input parameter
    GALGAS_stringlist joker_100180_8 ; // Joker input parameter
    GALGAS_uint joker_100180_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_100180_6 ; // Joker input parameter
    GALGAS_stringset joker_100180_5 ; // Joker input parameter
    GALGAS_lstringlist joker_100180_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_100180_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_100180_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_100180_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_100227_4 ; // Joker input parameter
    GALGAS_string joker_100227_3 ; // Joker input parameter
    GALGAS_string joker_100227_2 ; // Joker input parameter
    GALGAS_headerKind joker_100227_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_99996_3, joker_99996_2, joker_99996_1, var_typeKindEnum, joker_100026_0, var_inheritedTypedAttributeList, var_attributeMap, joker_100090_2, joker_100090_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_100180_10, joker_100180_9, joker_100180_8, joker_100180_7, joker_100180_6, joker_100180_5, joker_100180_4, joker_100180_3, joker_100180_2, joker_100180_1, var_generateHeaderInSeparateFile, joker_100227_4, joker_100227_3, joker_100227_2, joker_100227_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2497)) ;
    ...
    cEnumerator_modifierMap enumerator_100514 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_100514.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_100514.current_lkey (HERE), enumerator_100514.current_mKind (HERE), enumerator_100514.current_mParameterList (HERE), enumerator_100514.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2524)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2519)) ;
      }
      enumerator_100514.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2529)) ;
    cEnumerator_readerMap enumerator_100840 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_100840.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_100840.current_lkey (HERE), enumerator_100840.current_mKind (HERE), enumerator_100840.current_mArgumentTypeList (HERE), enumerator_100840.current_mDeclarationLocation (HERE), enumerator_100840.current_mHasCompilerArgument (HERE), enumerator_100840.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2538)), enumerator_100840.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2531)) ;
      }
      enumerator_100840.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2543)) ;
    cEnumerator_instanceMethodMap enumerator_101228 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_101228.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_101228.current_lkey (HERE), enumerator_101228.current_mKind (HERE), enumerator_101228.current_mParameterList (HERE), enumerator_101228.current_mDeclarationLocation (HERE), enumerator_101228.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2551)), enumerator_101228.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2545)) ;
      }
      enumerator_101228.gotoNextObject () ;
    }
  }
  ...
  cEnumerator_typedAttributeList enumerator_101659 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_101659.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_101659.current_mAttributeTypeProxy (HERE), enumerator_101659.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2559)) ;
    enumerator_101659.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_101786 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_101786.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_101786.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2563)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_101786.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2564)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_101786.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2565)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_101786.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2566)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2566)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_101786.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_101786.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2567))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2567)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2567))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2567)) ;
    }
    enumerator_101786.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_102886 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_102886.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_102886.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2591)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_103130 (enumerator_102886.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_103130.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_103130.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2595)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_103130.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2597)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_103130.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_102886.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2601)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_102886.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2602)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_102886.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2606)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2607)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2611)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2604)) ;
      }
    }
    enumerator_102886.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_104198 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_104198.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_104198.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_104198.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2626)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2626))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2626)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2626)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2627)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_104198.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 2628)), enumerator_104198.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2628)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2630)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2625)) ;
      }
    }
    enumerator_104198.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_105240 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_105240.hasCurrentObject () && bool_12) {
    while (enumerator_105240.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_105240.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2654)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_105240.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2654)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2654)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2654)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_105240.gotoNextObject () ;
      if (enumerator_105240.hasCurrentObject ()) {
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_107030 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_107030.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_107030.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2703)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_107030.current_mFormalArgumentPassingMode (HERE), enumerator_107030.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2704)) ;
    enumerator_107030.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_108038 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_108038.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_108038.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2722)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2723)) ;
    enumerator_108038.gotoNextObject () ;
  }
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2778)).isValid ()) {
    uint32_t variant_110795 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2778)).uintValue () ;
    bool loop_110795 = true ;
    while (loop_110795) {
      loop_110795 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2778)))).isValid () ;
      if (loop_110795) {
        loop_110795 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2778)))).boolValue () ;
      }
      if (loop_110795 && (0 == variant_110795)) {
        loop_110795 = false ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2817)).isValid ()) {
    uint32_t variant_112107 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2817)).uintValue () ;
    bool loop_112107 = true ;
    while (loop_112107) {
      loop_112107 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2817)))).isValid () ;
      if (loop_112107) {
        loop_112107 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2817)))).boolValue () ;
      }
      if (loop_112107 && (0 == variant_112107)) {
        loop_112107 = false ;
  ...
  {
  GALGAS_unifiedTypeMapProxy joker_112722_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_112722_2 ; // Joker input parameter
  GALGAS_string joker_112722_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_112722_3, joker_112722_2, joker_112722_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2837)) ;
  }
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_115171_3 ; // Joker input parameter
  GALGAS_bool joker_115171_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_115171_1 ; // Joker input parameter
  GALGAS_bool joker_115211_0 ; // Joker input parameter
  GALGAS_attributeMap joker_115266_21 ; // Joker input parameter
  GALGAS_typedAttributeList joker_115266_20 ; // Joker input parameter
  GALGAS_constructorMap joker_115266_19 ; // Joker input parameter
  GALGAS_readerMap joker_115266_18 ; // Joker input parameter
  GALGAS_modifierMap joker_115266_17 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_115266_16 ; // Joker input parameter
  GALGAS_classMethodMap joker_115266_15 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_115266_14 ; // Joker input parameter
  GALGAS_stringlist joker_115266_13 ; // Joker input parameter
  GALGAS_uint joker_115266_12 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_115266_11 ; // Joker input parameter
  GALGAS_stringset joker_115266_10 ; // Joker input parameter
  GALGAS_lstringlist joker_115266_9 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_115266_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_115266_7 ; // Joker input parameter
  GALGAS_withAccessorMap joker_115266_6 ; // Joker input parameter
  GALGAS_bool joker_115266_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_115266_4 ; // Joker input parameter
  GALGAS_string joker_115266_3 ; // Joker input parameter
  GALGAS_string joker_115266_2 ; // Joker input parameter
  GALGAS_headerKind joker_115266_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_115171_3, joker_115171_2, joker_115171_1, var_typeKindEnum, joker_115211_0, var_listTypedAttributeList, joker_115266_21, joker_115266_20, joker_115266_19, joker_115266_18, joker_115266_17, joker_115266_16, joker_115266_15, joker_115266_14, joker_115266_13, joker_115266_12, joker_115266_11, joker_115266_10, joker_115266_9, joker_115266_8, joker_115266_7, joker_115266_6, joker_115266_5, joker_115266_4, joker_115266_3, joker_115266_2, joker_115266_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2907)) ;
  ...
  cEnumerator_typedAttributeList enumerator_117118 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_117118.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_117118.current_mAttributeTypeProxy (HERE), enumerator_117118.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2943)) ;
    enumerator_117118.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121583 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121583.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121583.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3051))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3051)), object->mAttribute_mSuperClassName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3051)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3051)) ;
    }
    enumerator_121583.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_122441 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_122441.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_122441.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3067))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3067)), enumerator_122441.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3067))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3067)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3067)) ;
    }
    enumerator_122441.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_123305 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123305.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123305.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3083))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3083)), enumerator_123305.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3083))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3083)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3083)) ;
    }
    enumerator_123305.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_124877 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_124877.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_124877.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3112))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3112)), enumerator_124877.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3112))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3112)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3112)) ;
    }
    enumerator_124877.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_127382 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_127382.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_127382.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3156))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3156)), enumerator_127382.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3156))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3156)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3156)) ;
    }
    enumerator_127382.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_128243 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_128243.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_128243.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3172))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3172)), enumerator_128243.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3172))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3172)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3172)) ;
    }
    enumerator_128243.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_137340 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3344)) ;
  if (NULL != objectArray_137340) {
      macroValidSharedObject (objectArray_137340, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_137340->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3345)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_138645 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3372)) ;
  if (NULL != objectArray_138645) {
      macroValidSharedObject (objectArray_138645, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_138645->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3373)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_139920 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3399)) ;
  if (NULL != objectArray_139920) {
      macroValidSharedObject (objectArray_139920, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_139920->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3400)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_141824 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3438)) ;
  if (NULL != objectArray_141824) {
      macroValidSharedObject (objectArray_141824, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_141824->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3439)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_143177 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3466)) ;
  if (NULL != objectArray_143177) {
      macroValidSharedObject (objectArray_143177, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_143177->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3467)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_144492 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3493)) ;
  if (NULL != objectArray_144492) {
      macroValidSharedObject (objectArray_144492, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_144492->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3494)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_145331 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145331.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145331.current_mAttributeTypeName (HERE), enumerator_145331.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3523))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3520)) ;
    enumerator_145331.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_145974 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145974.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145974.current_mAttributeTypeName (HERE), enumerator_145974.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3544))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3541)) ;
    enumerator_145974.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_146625 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_146625.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_146625.current_mAttributeTypeName (HERE), enumerator_146625.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3565))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3562)) ;
    enumerator_146625.gotoNextObject () ;
  }
