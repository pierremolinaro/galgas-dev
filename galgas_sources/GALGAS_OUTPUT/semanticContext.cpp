...
category_method__classDeclarationAST__enterType (C_Compiler & inLexique,
  ...
  if (operand_45727 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("uint"), var_cas_uintType COMMA_SOURCE_FILE_AT_LINE (1113)) ;
    GGS_readerMap  var_cas_readerMap ;
    GGS_modifierMap  var_cas_modifierMap ;
    GGS_instanceMethodMap  var_cas_inheritedInstanceMethodMap ;
    GGS_typedAttributeList  var_cas_inheritedTypedAttributeList ;
    GGS_attributeMap  var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1119)) ;
    GGS_unifiedTypeMapProxy  var_cas_superClassIndex ;
    const GGS_bool cond_46652 = (operand_45727->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1122))).operator_isEqual (GGS_string ("")) ;
    if (cond_46652.isBuiltAndTrue ()) {
      var_cas_superClassIndex = GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1123)) ;
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1124)) ;
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1125)) ;
      var_cas_inheritedInstanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1126)) ;
      var_cas_inheritedTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
      var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1128)) ;
    }else if (cond_46652.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_45727->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1130)), var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (1130)) ;
      GGS_typeKindEnum var_cas_typeKindEnum ;
      GGS_readerMap  var_cas_inheritedReaderMap ;
      GGS_modifierMap  var_cas_inheritedModifierMap ;
      GGS_bool automatic_var_47146_0 ;
      GGS_unifiedTypeMapProxy  automatic_var_47146_1 ;
      GGS_typedAttributeList  automatic_var_47146_2 ;
      GGS_constructorMap  automatic_var_47146_3 ;
      GGS_classMethodMap  automatic_var_47146_4 ;
      GGS_enumerationDescriptorList  automatic_var_47146_5 ;
      GGS_uint  automatic_var_47146_6 ;
      GGS_unifiedTypeMapProxyList  automatic_var_47146_7 ;
      GGS_nativeAttributeList  automatic_var_47146_8 ;
      GGS_stringset  automatic_var_47146_9 ;
      GGS_lstringlist  automatic_var_47146_10 ;
      GGS_typedAttributeList  automatic_var_47146_11 ;
      GGS_mapSearchMethodListAST  automatic_var_47146_12 ;
      GGS_mapSearchMethodListAST  automatic_var_47146_13 ;
      GGS_withAccessorMap  automatic_var_47146_14 ;
      if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
        var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_45727->mSuperClassName, automatic_var_47146_0, automatic_var_47146_1, var_cas_typeKindEnum, var_cas_inheritedTypedAttributeList, var_cas_attributeMap, automatic_var_47146_2, automatic_var_47146_3, var_cas_inheritedReaderMap, var_cas_inheritedModifierMap, var_cas_inheritedInstanceMethodMap, automatic_var_47146_4, automatic_var_47146_5, automatic_var_47146_6, automatic_var_47146_7, automatic_var_47146_8, automatic_var_47146_9, automatic_var_47146_10, automatic_var_47146_11, automatic_var_47146_12, automatic_var_47146_13, automatic_var_47146_14 COMMA_SOURCE_FILE_AT_LINE (1134)) ;
      }
      const GGS_bool cond_47303 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1147))) ;
      if (cond_47303.isBuiltAndTrue ()) {
        operand_45727->mSuperClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_45727->mSuperClassName)).operator_concat (GGS_string (" should be a class type")) COMMA_SOURCE_FILE_AT_LINE (1149)) ;
      }
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1151)) ;
      {
        GGS_modifierMap::cEnumerator enumerator_47425 (var_cas_inheritedModifierMap, true) ;
        const GGS_modifierMap::cElement * operand_47425 = NULL ;
        while (((operand_47425 = enumerator_47425.nextObject ()))) {
          macroValidPointer (operand_47425) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, operand_47425->mKey, operand_47425->mInfo.mParameterList, operand_47425->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1157)) COMMA_SOURCE_FILE_AT_LINE (1153)) ;
        }
      }
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1161)) ;
      {
        GGS_readerMap::cEnumerator enumerator_47705 (var_cas_inheritedReaderMap, true) ;
        const GGS_readerMap::cElement * operand_47705 = NULL ;
        while (((operand_47705 = enumerator_47705.nextObject ()))) {
          macroValidPointer (operand_47705) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_47705->mKey, operand_47705->mInfo.mIsCategory, operand_47705->mInfo.mArgumentTypeList, operand_47705->mInfo.mHasCompilerArgument, operand_47705->mInfo.mReturnedType, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1169)) COMMA_SOURCE_FILE_AT_LINE (1163)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_48095 (var_cas_inheritedTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_48095 = NULL ;
      while (((operand_48095 = enumerator_48095.nextObject ()))) {
        macroValidPointer (operand_48095) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_48095->mAttributeTypeIndex) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_48198 (operand_45727->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_48198 = NULL ;
      while (((operand_48198 = enumerator_48198.nextObject ()))) {
        macroValidPointer (operand_48198) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_48198->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1180)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1180)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_48198->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1182)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_classIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_45727->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1186)), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1186)) ;
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1188)) ;
    const GGS_bool cond_48924 = (operand_45727->mIsAbstract).operator_not () ;
    if (cond_48924.isBuiltAndTrue ()) {
      var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1191)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1190)) ;
    }
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1198)) ;
    {
      GGS_instanceMethodMap::cEnumerator enumerator_49055 (var_cas_inheritedInstanceMethodMap, true) ;
      const GGS_instanceMethodMap::cElement * operand_49055 = NULL ;
      while (((operand_49055 = enumerator_49055.nextObject ()))) {
        macroValidPointer (operand_49055) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_49055->mKey, GGS_bool (false), operand_49055->mInfo.mParameterList, operand_49055->mInfo.mDeclarationLocation, operand_49055->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1206)) COMMA_SOURCE_FILE_AT_LINE (1200)) ;
      }
    }
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_49351 (operand_45727->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_49351 = NULL ;
      while (((operand_49351 = enumerator_49351.nextObject ()))) {
        macroValidPointer (operand_49351) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_49440 (operand_49351->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_49440 = NULL ;
          while (((operand_49440 = enumerator_49440.nextObject ()))) {
            macroValidPointer (operand_49440) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_49440->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1214)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1214)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_49440->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_49721 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_49351->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1217))) ;
        if (NULL != operand_49721) {
          operand_49721->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1218)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_49351->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_49351->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1224)), GGS_bool (true), GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1226)) COMMA_SOURCE_FILE_AT_LINE (1220)) ;
        }
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_50138 (operand_45727->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_50138 = NULL ;
      while (((operand_50138 = enumerator_50138.nextObject ()))) {
        macroValidPointer (operand_50138) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_50227 (operand_50138->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_50227 = NULL ;
          while (((operand_50227 = enumerator_50227.nextObject ()))) {
            macroValidPointer (operand_50227) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_50227->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1235)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1235)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_50227->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_50508 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_50138->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1238))) ;
        if (NULL != operand_50508) {
          operand_50508->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverriding (inLexique COMMA_SOURCE_FILE_AT_LINE (1239)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_50138->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_50138->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1245)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1247)) COMMA_SOURCE_FILE_AT_LINE (1241)) ;
        }
      }
    }
    const GGS_bool cond_51724 = var_cas_inMultiMethodMapForBuildingContext.reader_hasKey (operand_45727->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1252))) ;
    if (cond_51724.isBuiltAndTrue ()) {
      GGS_multiMethodMapForType  var_cas_multiMethodMapForType ;
      if (var_cas_inMultiMethodMapForBuildingContext.isBuilt ()) {
        var_cas_inMultiMethodMapForBuildingContext (HERE)->method_searchKey (inLexique, operand_45727->mClassTypeName, var_cas_multiMethodMapForType COMMA_SOURCE_FILE_AT_LINE (1254)) ;
      }
      {
        GGS_multiMethodMapForType::cEnumerator enumerator_51143 (var_cas_multiMethodMapForType, true) ;
        const GGS_multiMethodMapForType::cElement * operand_51143 = NULL ;
        while (((operand_51143 = enumerator_51143.nextObject ()))) {
          macroValidPointer (operand_51143) ;
          GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
          {
            GGS_formalParameterListAST::cEnumerator enumerator_51246 (operand_51143->mInfo.mFormalParameterList, true) ;
            const GGS_formalParameterListAST::cElement * operand_51246 = NULL ;
            while (((operand_51246 = enumerator_51246.nextObject ()))) {
              macroValidPointer (operand_51246) ;
              GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
              GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51246->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1259)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1259)) ;
              var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_51246->mFormalArgumentPassingMode) ;
            }
          }
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_51143->mKey, GGS_bool (true), var_cas_formalArgumentList, operand_51143->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1266)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1268)) COMMA_SOURCE_FILE_AT_LINE (1262)) ;
        }
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_51924 (operand_45727->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_51924 = NULL ;
      while (((operand_51924 = enumerator_51924.nextObject ()))) {
        macroValidPointer (operand_51924) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51924->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1277)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1277)) ;
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_51924->mAttributeName) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_51924->mAttributeName) ;
        var_cas_readerMap.modifier_insertKey (inLexique, operand_51924->mAttributeName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1286)) COMMA_SOURCE_FILE_AT_LINE (1280)) ;
      }
    }
    {
      GGS_typedAttributeList::cEnumerator enumerator_52588 (var_cas_currentClassTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_52588 = NULL ;
      while (((operand_52588 = enumerator_52588.nextObject ()))) {
        macroValidPointer (operand_52588) ;
        var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_52588->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1292)), GGS_formalParameterSignature ::constructor_listWithValue (operand_52588->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1293))), GGS_bool (false), GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (1295)) COMMA_SOURCE_FILE_AT_LINE (1291)) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_45727->mClassTypeName, (operand_45727->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1303)), var_cas_allTypedAttributeList, var_cas_attributeMap, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1311)), GGS_enumerationDescriptorList ::constructor_emptyList (), (function_generateCppConstructorWithAllAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1313))).operator_or (((var_cas_superClassIndex.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1313))).isBuiltAndTrue () ? (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1313))) : (GGS_uint (0U)))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_currentClassTypedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1321)) COMMA_SOURCE_FILE_AT_LINE (1299)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_53910,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_53910 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_54176 (operand_53910->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_54176 = NULL ;
      while (((operand_54176 = enumerator_54176.nextObject ()))) {
        macroValidPointer (operand_54176) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54176->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1335)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1335)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_54176->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_53910->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1339)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_54709,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_54709 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_54976 (operand_54709->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_54976 = NULL ;
      while (((operand_54976 = enumerator_54976.nextObject ()))) {
        macroValidPointer (operand_54976) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54976->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1352)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1352)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54709->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1357)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1357)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_54709->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1359)) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_55676,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_55676 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_55676->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1370)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1370)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_55676->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1372)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_56269,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_56269 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_56734_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_56734_1 ;
    GGS_attributeMap  automatic_var_56734_2 ;
    GGS_typedAttributeList  automatic_var_56734_3 ;
    GGS_constructorMap  automatic_var_56734_4 ;
    GGS_readerMap  automatic_var_56734_5 ;
    GGS_modifierMap  automatic_var_56734_6 ;
    GGS_instanceMethodMap  automatic_var_56734_7 ;
    GGS_classMethodMap  automatic_var_56734_8 ;
    GGS_enumerationDescriptorList  automatic_var_56734_9 ;
    GGS_uint  automatic_var_56734_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_56734_11 ;
    GGS_nativeAttributeList  automatic_var_56734_12 ;
    GGS_stringset  automatic_var_56734_13 ;
    GGS_lstringlist  automatic_var_56734_14 ;
    GGS_typedAttributeList  automatic_var_56734_15 ;
    GGS_mapSearchMethodListAST  automatic_var_56734_16 ;
    GGS_mapSearchMethodListAST  automatic_var_56734_17 ;
    GGS_withAccessorMap  automatic_var_56734_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_56269->mAssociatedListTypeName, automatic_var_56734_0, automatic_var_56734_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_56734_2, automatic_var_56734_3, automatic_var_56734_4, automatic_var_56734_5, automatic_var_56734_6, automatic_var_56734_7, automatic_var_56734_8, automatic_var_56734_9, automatic_var_56734_10, automatic_var_56734_11, automatic_var_56734_12, automatic_var_56734_13, automatic_var_56734_14, automatic_var_56734_15, automatic_var_56734_16, automatic_var_56734_17, automatic_var_56734_18 COMMA_SOURCE_FILE_AT_LINE (1385)) ;
    }
    const GGS_bool cond_56963 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1392))) ;
    if (cond_56963.isBuiltAndTrue ()) {
      operand_56269->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_56269->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1394)) ;
      var_cas_listTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1397)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1398)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1399)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1400)) ;
    GGS_unifiedTypeMapProxy  var_cas_associatedListTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56269->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1403)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1403)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56269->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1406)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1406)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1409)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("count"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1411)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("allKeys"),  GGS_string ("stringset"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1412)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("keyList"),  GGS_string ("stringlist"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1413)) ;
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("listForKey"),  GGS_string ("string"),  operand_56269->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1414)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1414)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_56269->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1416)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1416)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_58750 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_58750 = NULL ;
      while (((operand_58750 = enumerator_58750.nextObject ()))) {
        macroValidPointer (operand_58750) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_58750->mAttributeTypeIndex) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_56269->mListmapTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1431)), GGS_typeKindEnum::constructor_listMapType (inLexique COMMA_SOURCE_FILE_AT_LINE (1432)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1434)), var_cas_listTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1440)), var_cas_enumeratorDescriptor, (((function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1442))).operator_or (function_generateCppConstructorWithNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1442)))).operator_or (function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1442)))).operator_or (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1442))), var_cas_addAssignOperatorDescription, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1450)) COMMA_SOURCE_FILE_AT_LINE (1428)) ;
  }
}
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_60635,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60635 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_60635 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_60635->mPredefinedTypeName, operand_60635) ;
  }
}
...
category_method__objectPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_objectPredefinedTypeAST * operand_61000,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61000 != NULL) {
    GGS_objectPredefinedTypeAST  var_cas_t = operand_61000 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string ("object"), operand_61000) ;
  }
}
...
category_method__stringsetPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_stringsetPredefinedTypeAST * operand_61363,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61363 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_61363->mPredefinedTypeName, operand_61363) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_61673,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61673 != NULL) {
    const GGS_string var_cas_actualSuperTypeName = operand_61673->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1506)) ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (var_cas_actualSuperTypeName, operand_61673->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1507)), operand_61673) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_62069,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62069 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62069->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1515)), operand_62069) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_62383,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62383 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62383->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1523)), operand_62383) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_62697,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62697 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62697->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1531)), operand_62697) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_63015,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63015 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_63015->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1539)), operand_63015) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_63336,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63336 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_63336->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1547)), operand_63336->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1547)), operand_63336) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_63680,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63680 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_63680->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1555)), operand_63680) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_63995,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63995 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_63995->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1563)), operand_63995->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1563)), operand_63995) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externFunctionDeclarationAST * operand_64350,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64350 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_64350) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externRoutineDeclarationAST * operand_64651,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64651 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_64651) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  #endif
  GGS_collectedTypeMap  var_cas_collectedTypeMap = GGS_collectedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1594)) ;
  GGS_multiMethodMapForBuildingContext  var_cas_multiMethodMapForBuildingContext = GGS_multiMethodMapForBuildingContext ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1595)) ;
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_65587 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_65587 = NULL ;
    while (((operand_65587 = enumerator_65587.nextObject ()))) {
      macroValidPointer (operand_65587) ;
      { typeCategoryMethod__semanticDeclarationAST__collectTypes method = findCategoryMethod__semanticDeclarationAST__collectTypes (operand_65587->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_65587->mSemanticDeclaration (HERE), var_cas_collectedTypeMap, var_cas_multiMethodMapForBuildingContext COMMA_SOURCE_FILE_AT_LINE (1597)) ;
        }
      }
    }
  }
  GGS_stringlist  var_cas_undefinedClasses = var_cas_collectedTypeMap.reader_unsolvedProxyKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1603)) ;
  const GGS_bool cond_66099 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_66099.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_65962 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_65962 = NULL ;
      while (((operand_65962 = enumerator_65962.nextObject ()))) {
        macroValidPointer (operand_65962) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_65962->mValue) ;
      }
    }
    var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (1610)) ;
    var_cas_outSemanticContext.drop () ;
  }else if (cond_66099.isBuiltAndFalse ()) {
    const GGS_bool cond_66401 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_66401.isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = ((GGS_string ("there are ")).operator_concat (var_cas_undefinedClasses.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1611)))).operator_concat (GGS_string (" undefined types:")) ;
      {
        GGS_stringlist::cEnumerator enumerator_66265 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_66265 = NULL ;
        while (((operand_66265 = enumerator_66265.nextObject ()))) {
          macroValidPointer (operand_66265) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_66265->mValue) ;
        }
      }
      var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (1616)) ;
      var_cas_outSemanticContext.drop () ;
    }else if (cond_66401.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_66764 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_66764 = NULL ;
        while (((operand_66764 = enumerator_66764.nextObject ()))) {
          macroValidPointer (operand_66764) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_66764->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_66764->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (1623)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_67878 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_67878 (_variant_67878.isBuilt (), true) ;
      while (_condition_67878.isBuiltAndTrue ()) {
        _condition_67878 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_67878.isBuiltAndTrue ()) {
          if (_variant_67878.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1644)) ;
            _condition_67878 = GGS_bool (false) ;
          }else{
            _variant_67878.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_67493 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_67493 = NULL ;
              while (((operand_67493 = enumerator_67493.nextObject ()))) {
                macroValidPointer (operand_67493) ;
                const GGS_bool cond_67721 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_67493->mDependanceString) ;
                if (cond_67721.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_67493->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_67493->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_67721.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_67493->mDependanceString, operand_67493->mTypeString, operand_67493->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_68501 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_68501.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_68160 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_68160 = enumerator_68160.nextObject () ;
          if ((operand_68160 != NULL)) {
            bool _foreach_loop_68160 ;
            do{
              macroValidPointer (operand_68160) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_68160->mTypeString) ;
              operand_68160 = enumerator_68160.nextObject () ;
              _foreach_loop_68160 = ((operand_68160 != NULL)) ;
              if (_foreach_loop_68160) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_68160) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_68333 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_68333 = NULL ;
          while (((operand_68333 = enumerator_68333.nextObject ()))) {
            macroValidPointer (operand_68333) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_68333->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_68333->mDependanceString) ;
          }
        }
        var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (1657)) ;
        var_cas_outSemanticContext.drop () ;
      }else if (cond_68501.isBuiltAndFalse ()) {
        var_cas_outSemanticContext = GGS_semanticContext::constructor_new (GGS_unifiedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)), GGS_routineMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1661)), GGS_functionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1662)), GGS_filewrapperMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)), GGS_grammarMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1664)), GGS_optionComponentMapForSemanticAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1665))) ;
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_68917 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_68917 = NULL ;
          while (((operand_68917 = enumerator_68917.nextObject ()))) {
            macroValidPointer (operand_68917) ;
            { typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (operand_68917->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_68917->mSemanticDeclaration (HERE), var_cas_multiMethodMapForBuildingContext, var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (1669)) ;
              }
            }
          }
        }
