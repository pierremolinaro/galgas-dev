...
category_method__mapDeclarationAST__enterType (C_Compiler & inLexique,
  ...
  if (operand_16863 != NULL) {
    ...
    ::routine_enterInheritedReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("locationForKey"),  GGS_string ("string"),  GGS_string ("location"),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (446)) ;
    ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("overriddenMap"),  operand_16863->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (447)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (447)) ;
...
category_method__filewrapperDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationAST * operand_31026,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_31026 != NULL) {
    ...
    {
      GGS_filewrapperTemplateListAST::cEnumerator enumerator_31218 (operand_31026->mFilewrapperTemplateList, true) ;
      const GGS_filewrapperTemplateListAST::cElement * operand_31218 = NULL ;
      while (((operand_31218 = enumerator_31218.nextObject ()))) {
        macroValidPointer (operand_31218) ;
        GGS_unifiedTypeMapProxyList  var_cas_templateSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
        {
          GGS_formalInputParameterListAST::cEnumerator enumerator_31336 (operand_31218->mFilewrapperTemplateFormalInputParameters, true) ;
          const GGS_formalInputParameterListAST::cElement * operand_31336 = NULL ;
          while (((operand_31336 = enumerator_31336.nextObject ()))) {
            macroValidPointer (operand_31336) ;
            GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_31336->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (764)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (764)) ;
            var_cas_templateSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
          }
        }
        var_cas_filewrapperTemplateMap.modifier_insertKey (inLexique, operand_31218->mFilewrapperTemplateName, var_cas_templateSignature, operand_31218->mFilewrapperTemplatePath COMMA_SOURCE_FILE_AT_LINE (767)) ;
      }
    }
    var_cas_ioSemanticContext.mFilewrapperMap.modifier_insertKey (inLexique, operand_31026->mFilewrapperName, operand_31026->mFilewrapperPath, operand_31026->mFilewrapperExtensionList, var_cas_filewrapperTemplateMap COMMA_SOURCE_FILE_AT_LINE (773)) ;
  }
}
...
category_method__listDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_32037,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_32037 != NULL) {
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_32228 (operand_32037->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_32228 = NULL ;
      while (((operand_32228 = enumerator_32228.nextObject ()))) {
        macroValidPointer (operand_32228) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_32228->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (791)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (791)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_32228->mAttributeName) ;
      }
    }
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_32037->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (799)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (799)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_33145 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_33145 = NULL ;
      while (((operand_33145 = enumerator_33145.nextObject ()))) {
        macroValidPointer (operand_33145) ;
        var_cas_enumerationDescriptor.addAssign_operation (operand_33145->mAttributeTypeIndex, operand_33145->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (806))) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_33145->mAttributeTypeIndex) ;
        var_cas_modifierOutputFormalArgumentList.addAssign_operation (operand_33145->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (808))) ;
        var_cas_modifierInputFormalArgumentList.addAssign_operation (operand_33145->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (809))) ;
      }
    }
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyList"),  operand_32037->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (813)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (813)) ;
    ...
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListFromIndex"),  GGS_string ("uint"),  operand_32037->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (823)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (823)) ;
    ::routine_enterBaseReaderWith2Arguments (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListWithRange"),  GGS_string ("uint"),  GGS_string ("uint"),  operand_32037->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (824)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (824)) ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_34315 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_34315 = NULL ;
      while (((operand_34315 = enumerator_34315.nextObject ()))) {
        macroValidPointer (operand_34315) ;
        var_cas_readerMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, (operand_34315->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (827))).operator_concat (GGS_string ("AtIndex")), operand_34315->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (827)) COMMA_SOURCE_FILE_AT_LINE (827)), GGS_unifiedTypeMapProxyList ::constructor_listWithValue (var_cas_uintType), GGS_bool (true), operand_34315->mAttributeTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (831)) COMMA_SOURCE_FILE_AT_LINE (826)) ;
      }
    }
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_35150 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_35150 = NULL ;
      while (((operand_35150 = enumerator_35150.nextObject ()))) {
        macroValidPointer (operand_35150) ;
        GGS_formalParameterSignature  var_cas_setterFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        var_cas_setterFormalArgumentList.addAssign_operation (operand_35150->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (856))) ;
        ...
        var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_35150->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("AtIndex")), operand_35150->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (859)) COMMA_SOURCE_FILE_AT_LINE (859)), var_cas_setterFormalArgumentList, GGS_bool (true), GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (862)) COMMA_SOURCE_FILE_AT_LINE (858)) ;
      }
    }
...
category_method__sortedListDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_37178,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_37178 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    ...
    GGS_unifiedTypeMapProxy  var_cas_listTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_37178->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (920)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (920)) ;
    GGS_enumerationDescriptorList  var_cas_enumerationDescriptor = GGS_enumerationDescriptorList ::constructor_emptyList () ;
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    GGS_formalParameterSignature  var_cas_modifierFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_37892 (operand_37178->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_37892 = NULL ;
      while (((operand_37892 = enumerator_37892.nextObject ()))) {
        macroValidPointer (operand_37892) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_37892->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (928)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (928)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_37892->mAttributeName) ;
        var_cas_enumerationDescriptor.addAssign_operation (var_cas_attributeTypeIndex, operand_37892->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (930))) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptySortedList"),  operand_37178->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (936)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (936)) ;
...
category_method__structDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_40801,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_40801 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_structTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_40801->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1014)), var_cas_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (1014)) ;
    ...
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_41346 (operand_40801->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_41346 = NULL ;
      while (((operand_41346 = enumerator_41346.nextObject ()))) {
        macroValidPointer (operand_41346) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_41346->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1022)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1022)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_41346->mAttributeName) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_41346->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1025)) ;
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_41936 (operand_40801->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_41936 = NULL ;
      while (((operand_41936 = enumerator_41936.nextObject ()))) {
        macroValidPointer (operand_41936) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_41936->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1037)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1037)) ;
        var_cas_readerMap.modifier_insertOrReplace (inLexique, operand_41936->mAttributeName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1043)) COMMA_SOURCE_FILE_AT_LINE (1038)) ;
      }
    }
...
category_method__classDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_43534,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_43534 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    ...
    const GGS_bool cond_44435 = (operand_43534->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1097))).operator_isEqual (GGS_string ("")) ;
    if (cond_44435.isBuiltAndTrue ()) {
    ...
    }else if (cond_44435.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_43534->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1105)), var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (1105)) ;
      GGS_typeKindEnum var_cas_typeKindEnum ;
      GGS_readerMap  var_cas_inheritedReaderMap ;
      GGS_modifierMap  var_cas_inheritedModifierMap ;
      GGS_bool automatic_var_44929_0 ;
      GGS_unifiedTypeMapProxy  automatic_var_44929_1 ;
      GGS_typedAttributeList  automatic_var_44929_2 ;
      GGS_constructorMap  automatic_var_44929_3 ;
      GGS_classMethodMap  automatic_var_44929_4 ;
      GGS_enumerationDescriptorList  automatic_var_44929_5 ;
      GGS_uint  automatic_var_44929_6 ;
      GGS_unifiedTypeMapProxyList  automatic_var_44929_7 ;
      GGS_nativeAttributeList  automatic_var_44929_8 ;
      GGS_stringset  automatic_var_44929_9 ;
      GGS_lstringlist  automatic_var_44929_10 ;
      GGS_typedAttributeList  automatic_var_44929_11 ;
      GGS_mapSearchMethodListAST  automatic_var_44929_12 ;
      GGS_mapSearchMethodListAST  automatic_var_44929_13 ;
      GGS_withAccessorMap  automatic_var_44929_14 ;
      if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
        var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_43534->mSuperClassName, automatic_var_44929_0, automatic_var_44929_1, var_cas_typeKindEnum, var_cas_inheritedTypedAttributeList, var_cas_attributeMap, automatic_var_44929_2, automatic_var_44929_3, var_cas_inheritedReaderMap, var_cas_inheritedModifierMap, var_cas_inheritedInstanceMethodMap, automatic_var_44929_4, automatic_var_44929_5, automatic_var_44929_6, automatic_var_44929_7, automatic_var_44929_8, automatic_var_44929_9, automatic_var_44929_10, automatic_var_44929_11, automatic_var_44929_12, automatic_var_44929_13, automatic_var_44929_14 COMMA_SOURCE_FILE_AT_LINE (1109)) ;
      }
      const GGS_bool cond_45086 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1122))) ;
      if (cond_45086.isBuiltAndTrue ()) {
        operand_43534->mSuperClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_43534->mSuperClassName)).operator_concat (GGS_string (" should be a class type")) COMMA_SOURCE_FILE_AT_LINE (1124)) ;
      }
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1126)) ;
      {
        GGS_modifierMap::cEnumerator enumerator_45208 (var_cas_inheritedModifierMap, true) ;
        const GGS_modifierMap::cElement * operand_45208 = NULL ;
        while (((operand_45208 = enumerator_45208.nextObject ()))) {
          macroValidPointer (operand_45208) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, operand_45208->mKey, operand_45208->mInfo.mParameterList, operand_45208->mInfo.mHasCompilerArgument, GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1132)) COMMA_SOURCE_FILE_AT_LINE (1128)) ;
        }
      }
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1136)) ;
      {
        GGS_readerMap::cEnumerator enumerator_45488 (var_cas_inheritedReaderMap, true) ;
        const GGS_readerMap::cElement * operand_45488 = NULL ;
        while (((operand_45488 = enumerator_45488.nextObject ()))) {
          macroValidPointer (operand_45488) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_45488->mKey, operand_45488->mInfo.mArgumentTypeList, operand_45488->mInfo.mHasCompilerArgument, operand_45488->mInfo.mReturnedType, GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1143)) COMMA_SOURCE_FILE_AT_LINE (1138)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_46176 (var_cas_inheritedTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_46176 = NULL ;
      while (((operand_46176 = enumerator_46176.nextObject ()))) {
        macroValidPointer (operand_46176) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_46176->mAttributeTypeIndex) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_46279 (operand_43534->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_46279 = NULL ;
      while (((operand_46279 = enumerator_46279.nextObject ()))) {
        macroValidPointer (operand_46279) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_46279->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1164)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1164)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_46279->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1166)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_classIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_43534->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1170)), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1170)) ;
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1172)) ;
    const GGS_bool cond_47005 = (operand_43534->mIsAbstract).operator_not () ;
    if (cond_47005.isBuiltAndTrue ()) {
      var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1175)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1174)) ;
    }
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1182)) ;
    {
      GGS_instanceMethodMap::cEnumerator enumerator_47136 (var_cas_inheritedInstanceMethodMap, true) ;
      const GGS_instanceMethodMap::cElement * operand_47136 = NULL ;
      while (((operand_47136 = enumerator_47136.nextObject ()))) {
        macroValidPointer (operand_47136) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_47136->mKey, operand_47136->mInfo.mParameterList, operand_47136->mInfo.mDeclarationLocation, operand_47136->mInfo.mHasCompilerArgument, GGS_readerQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1189)) COMMA_SOURCE_FILE_AT_LINE (1184)) ;
      }
    }
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_47399 (operand_43534->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_47399 = NULL ;
      while (((operand_47399 = enumerator_47399.nextObject ()))) {
        macroValidPointer (operand_47399) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_47488 (operand_47399->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_47488 = NULL ;
          while (((operand_47488 = enumerator_47488.nextObject ()))) {
            macroValidPointer (operand_47488) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_47488->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1197)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1197)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_47488->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_47769 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_47399->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1200))) ;
        if (NULL != operand_47769) {
          operand_47769->mInfo.mQualifier = GGS_readerQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1201)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_47399->mMethodName, var_cas_formalArgumentList, operand_47399->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1206)), GGS_bool (true), GGS_readerQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1208)) COMMA_SOURCE_FILE_AT_LINE (1203)) ;
        }
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_48151 (operand_43534->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_48151 = NULL ;
      while (((operand_48151 = enumerator_48151.nextObject ()))) {
        macroValidPointer (operand_48151) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_48240 (operand_48151->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_48240 = NULL ;
          while (((operand_48240 = enumerator_48240.nextObject ()))) {
            macroValidPointer (operand_48240) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_48240->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1217)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1217)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_48240->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_48521 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_48151->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1220))) ;
        if (NULL != operand_48521) {
          operand_48521->mInfo.mQualifier = GGS_readerQualifier::constructor_isOverriding (inLexique COMMA_SOURCE_FILE_AT_LINE (1221)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_48151->mMethodName, var_cas_formalArgumentList, operand_48151->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1226)), GGS_bool (true), GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1228)) COMMA_SOURCE_FILE_AT_LINE (1223)) ;
        }
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_49020 (operand_43534->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_49020 = NULL ;
      while (((operand_49020 = enumerator_49020.nextObject ()))) {
        macroValidPointer (operand_49020) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_49020->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1237)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1237)) ;
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_49020->mAttributeName) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_49020->mAttributeName) ;
        var_cas_readerMap.modifier_insertKey (inLexique, operand_49020->mAttributeName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1245)) COMMA_SOURCE_FILE_AT_LINE (1240)) ;
        var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_49020->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1249)), GGS_formalParameterSignature ::constructor_listWithValue (var_cas_attributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1250))), GGS_bool (false), GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1252)) COMMA_SOURCE_FILE_AT_LINE (1248)) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_43534->mClassTypeName, (operand_43534->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1260)), var_cas_allTypedAttributeList, var_cas_attributeMap, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1268)), GGS_enumerationDescriptorList ::constructor_emptyList (), ((function_generateCppConstructorWithAllAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1270))).operator_or (function_generateVirtualDestructor (inLexique COMMA_SOURCE_FILE_AT_LINE (1270)))).operator_or (((operand_43534->mIsAbstract).isBuiltAndTrue () ? (GGS_uint (0U)) : (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1270))))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_currentClassTypedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1278)) COMMA_SOURCE_FILE_AT_LINE (1256)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_50927,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_50927 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_51113 (operand_50927->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_51113 = NULL ;
      while (((operand_51113 = enumerator_51113.nextObject ()))) {
        macroValidPointer (operand_51113) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51113->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1291)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1291)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_51113->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_50927->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1295)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_51646,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_51646 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_51833 (operand_51646->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_51833 = NULL ;
      while (((operand_51833 = enumerator_51833.nextObject ()))) {
        macroValidPointer (operand_51833) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51833->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1307)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1307)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51646->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1312)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1312)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_51646->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1314)) ;
  }
}
...
category_method__lazyFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_lazyFunctionDeclarationAST * operand_52533,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_52533 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_52533->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1325)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1325)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_52533->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1327)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_53101,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_53101 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_53486_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_53486_1 ;
    GGS_attributeMap  automatic_var_53486_2 ;
    GGS_typedAttributeList  automatic_var_53486_3 ;
    GGS_constructorMap  automatic_var_53486_4 ;
    GGS_readerMap  automatic_var_53486_5 ;
    GGS_modifierMap  automatic_var_53486_6 ;
    GGS_instanceMethodMap  automatic_var_53486_7 ;
    GGS_classMethodMap  automatic_var_53486_8 ;
    GGS_enumerationDescriptorList  automatic_var_53486_9 ;
    GGS_uint  automatic_var_53486_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_53486_11 ;
    GGS_nativeAttributeList  automatic_var_53486_12 ;
    GGS_stringset  automatic_var_53486_13 ;
    GGS_lstringlist  automatic_var_53486_14 ;
    GGS_typedAttributeList  automatic_var_53486_15 ;
    GGS_mapSearchMethodListAST  automatic_var_53486_16 ;
    GGS_mapSearchMethodListAST  automatic_var_53486_17 ;
    GGS_withAccessorMap  automatic_var_53486_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_53101->mAssociatedListTypeName, automatic_var_53486_0, automatic_var_53486_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_53486_2, automatic_var_53486_3, automatic_var_53486_4, automatic_var_53486_5, automatic_var_53486_6, automatic_var_53486_7, automatic_var_53486_8, automatic_var_53486_9, automatic_var_53486_10, automatic_var_53486_11, automatic_var_53486_12, automatic_var_53486_13, automatic_var_53486_14, automatic_var_53486_15, automatic_var_53486_16, automatic_var_53486_17, automatic_var_53486_18 COMMA_SOURCE_FILE_AT_LINE (1339)) ;
    }
    const GGS_bool cond_53715 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1346))) ;
    if (cond_53715.isBuiltAndTrue ()) {
      operand_53101->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_53101->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1348)) ;
      var_cas_listTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1351)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1352)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1353)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1354)) ;
    GGS_unifiedTypeMapProxy  var_cas_associatedListTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_53101->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1357)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1357)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_53101->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1360)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1360)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1363)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("count"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1365)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_53101->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1367)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1367)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_55136 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_55136 = NULL ;
      while (((operand_55136 = enumerator_55136.nextObject ()))) {
        macroValidPointer (operand_55136) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_55136->mAttributeTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("listmap"), var_cas_superTypeProxy COMMA_SOURCE_FILE_AT_LINE (1380)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_53101->mListmapTypeName, GGS_bool (true), var_cas_superTypeProxy, GGS_typeKindEnum::constructor_listMapType (inLexique COMMA_SOURCE_FILE_AT_LINE (1385)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1387)), var_cas_listTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1393)), var_cas_enumeratorDescriptor, (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1395))).operator_or (function_generateCppConstructorWithNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1395))), var_cas_addAssignOperatorDescription, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1403)) COMMA_SOURCE_FILE_AT_LINE (1381)) ;
  }
}
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_57100,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57100 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_57100 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation ((findCategoryReader__predefinedTypeAST__getSuperTypeName (var_cas_t (HERE)->galgasRTTI ()) (inLexique, var_cas_t.getPtr () COMMA_SOURCE_FILE_AT_LINE (1434))), operand_57100->mPredefinedTypeName, operand_57100) ;
  }
}
...
category_method__objectPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_objectPredefinedTypeAST * operand_57483,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57483 != NULL) {
    GGS_objectPredefinedTypeAST  var_cas_t = operand_57483 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string ("object"), operand_57483) ;
  }
}
...
category_method__stringsetPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_stringsetPredefinedTypeAST * operand_57846,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57846 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enumerable"), operand_57846->mPredefinedTypeName, operand_57846) ;
  }
}
...
category_method__genericTypeTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_genericTypeTypeAST * operand_58165,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58165 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_58165->mSuperTypeName, operand_58165->mTypeName, operand_58165) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_58477,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58477 != NULL) {
    const GGS_string var_cas_actualSuperTypeName = (((operand_58477->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1467))).operator_isEqual (GGS_string (""))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_58477->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1467)))) ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (var_cas_actualSuperTypeName, operand_58477->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1468)), operand_58477) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_58929,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58929 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("list"), operand_58929->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1476)), operand_58929) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_59247,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59247 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("struct"), operand_59247->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1484)), operand_59247) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_59567,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59567 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enum"), operand_59567->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1492)), operand_59567) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_59889,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59889 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("sortedlist"), operand_59889->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1500)), operand_59889) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_60220,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60220 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_60220->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1508)), operand_60220->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1508)), operand_60220) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_60564,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60564 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("map"), operand_60564->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1516)), operand_60564) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_60882,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60882 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_60882->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1524)), operand_60882->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1524)), operand_60882) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externFunctionDeclarationAST * operand_61237,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61237 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_61237) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externRoutineDeclarationAST * operand_61538,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61538 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_61538) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  #endif
  GGS_collectedTypeMap  var_cas_collectedTypeMap = GGS_collectedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1555)) ;
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_62392 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_62392 = NULL ;
    while (((operand_62392 = enumerator_62392.nextObject ()))) {
      macroValidPointer (operand_62392) ;
      { typeCategoryMethod__semanticDeclarationAST__collectType method = findCategoryMethod__semanticDeclarationAST__collectType (operand_62392->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_62392->mSemanticDeclaration (HERE), var_cas_collectedTypeMap COMMA_SOURCE_FILE_AT_LINE (1557)) ;
        }
      }
    }
  }
  GGS_stringlist  var_cas_undefinedClasses = var_cas_collectedTypeMap.reader_unsolvedIndexKeyStringList (inLexique COMMA_SOURCE_FILE_AT_LINE (1560)) ;
  const GGS_bool cond_62857 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_62857.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_62720 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_62720 = NULL ;
      while (((operand_62720 = enumerator_62720.nextObject ()))) {
        macroValidPointer (operand_62720) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_62720->mValue) ;
      }
    }
    var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (1567)) ;
    var_cas_outSemanticContext.drop () ;
  }else if (cond_62857.isBuiltAndFalse ()) {
    const GGS_bool cond_63159 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_63159.isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = ((GGS_string ("there are ")).operator_concat (var_cas_undefinedClasses.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1568)))).operator_concat (GGS_string (" undefined types:")) ;
      {
        GGS_stringlist::cEnumerator enumerator_63023 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_63023 = NULL ;
        while (((operand_63023 = enumerator_63023.nextObject ()))) {
          macroValidPointer (operand_63023) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_63023->mValue) ;
        }
      }
      var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (1573)) ;
      var_cas_outSemanticContext.drop () ;
    }else if (cond_63159.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_63522 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_63522 = NULL ;
        while (((operand_63522 = enumerator_63522.nextObject ()))) {
          macroValidPointer (operand_63522) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_63522->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_63522->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (1580)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_64636 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_64636 (_variant_64636.isBuilt (), true) ;
      while (_condition_64636.isBuiltAndTrue ()) {
        _condition_64636 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_64636.isBuiltAndTrue ()) {
          if (_variant_64636.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1601)) ;
            _condition_64636 = GGS_bool (false) ;
          }else{
            _variant_64636.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_64251 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_64251 = NULL ;
              while (((operand_64251 = enumerator_64251.nextObject ()))) {
                macroValidPointer (operand_64251) ;
                const GGS_bool cond_64479 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_64251->mDependanceString) ;
                if (cond_64479.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_64251->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_64251->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_64479.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_64251->mDependanceString, operand_64251->mTypeString, operand_64251->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_65259 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_65259.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_64918 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_64918 = enumerator_64918.nextObject () ;
          if ((operand_64918 != NULL)) {
            bool _foreach_loop_64918 ;
            do{
              macroValidPointer (operand_64918) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_64918->mTypeString) ;
              operand_64918 = enumerator_64918.nextObject () ;
              _foreach_loop_64918 = ((operand_64918 != NULL)) ;
              if (_foreach_loop_64918) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_64918) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_65091 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_65091 = NULL ;
          while (((operand_65091 = enumerator_65091.nextObject ()))) {
            macroValidPointer (operand_65091) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_65091->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_65091->mDependanceString) ;
          }
        }
        var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (1614)) ;
        var_cas_outSemanticContext.drop () ;
      }else if (cond_65259.isBuiltAndFalse ()) {
        var_cas_outSemanticContext = GGS_semanticContext::constructor_new (GGS_unifiedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1617)), GGS_routineMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1618)), GGS_functionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1619)), GGS_filewrapperMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1620)), GGS_grammarMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1621)), GGS_optionComponentMapForSemanticAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1622))) ;
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_65675 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_65675 = NULL ;
          while (((operand_65675 = enumerator_65675.nextObject ()))) {
            macroValidPointer (operand_65675) ;
            { typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (operand_65675->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_65675->mSemanticDeclaration (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (1626)) ;
              }
            }
          }
        }
