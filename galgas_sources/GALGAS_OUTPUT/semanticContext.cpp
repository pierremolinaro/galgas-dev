...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_77738 (var_files, kEnumeration_up) ;
  while (enumerator_77738.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_77738.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("semanticContext.gSemantics", 1913)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1913)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1914)).operator_concat (enumerator_77738.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1914)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_77738.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1916)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1915)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1922)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_77738.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("semanticContext.gSemantics", 1923)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1923)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1924)).operator_concat (enumerator_77738.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1924)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_77738.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1926)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1925)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1932)) ;
      }
    }
    enumerator_77738.gotoNextObject () ;
  }
  ...
  cEnumerator_stringlist enumerator_78703 (var_directories, kEnumeration_up) ;
  while (enumerator_78703.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1943)).operator_concat (enumerator_78703.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1943)), constinArgument_inPathInWrapper.operator_concat (enumerator_78703.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1944)).operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1944)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1942)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_78703.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1953)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1952)) ;
    }
    enumerator_78703.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_149541 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_149541.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_149541.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3634)) ;
    enumerator_149541.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_150694 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE ("semanticContext.gSemantics", 3655)), kEnumeration_up) ;
    while (enumerator_150694.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_150694.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_150694.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3656))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3656)).operator_concat (GALGAS_string ("' type is not defined")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3656))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3656)) ;
      enumerator_150694.gotoNextObject () ;
    }
    ...
    GALGAS_lstringlist joker_151032_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_151032_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3660)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_151427 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_151427.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_151427.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3669))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3669))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3669)) ;
        enumerator_151427.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_152235 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_152235.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_152235.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3689)) ;
        enumerator_152235.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_75200 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_75200.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_75200.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1839))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1839)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_75200.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1840)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1840)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1840)) ;
    }
    enumerator_75200.gotoNextObject () ;
  }
  GALGAS_readerMap var_readerMap ;
  {
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_filewrapperTemplateListAST enumerator_79937 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_79937.hasCurrentObject ()) {
    ...
    cEnumerator_formalTemplateInputParameterListAST enumerator_80055 (enumerator_79937.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_80055.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_80055.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1975)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1976)) ;
      enumerator_80055.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_79937.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_79937.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1978)) ;
    }
    enumerator_79937.gotoNextObject () ;
  }
  ...
  cEnumerator_lstringlist enumerator_80574 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_80574.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_80574.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1987)) ;
    }
  ...
  cEnumerator_lstringlist enumerator_80780 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_80780.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_80780.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1992)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_80780.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_80780.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1993))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1993)).operator_concat (GALGAS_string ("' extension is already used for text files")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1993))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1993)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_80780.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1995)) ;
      }
    }
    enumerator_80780.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_82730 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_82730.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_82730.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2047)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_82950 (enumerator_82730.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_82950.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_82950.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_82950.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_82950.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_82730.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2057)) ;
    enumerator_82730.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_84103 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_84103.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_84103.current_mAttributeTypeProxy (HERE), enumerator_84103.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2075))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2075)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_84103.current_mAttributeTypeProxy (HERE), enumerator_84103.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2076)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_84103.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 2077)), enumerator_84103.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2077)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_84103.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2078)), enumerator_84103.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2078)) ;
    enumerator_84103.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_85512 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_85512.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_85512.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_85512.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2098)).operator_concat (GALGAS_string ("AtIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2098)), enumerator_85512.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 2098))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2098)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2099)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_listWithValue (var_uintType, GALGAS_string ("inIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2100)), inCompiler->here (), GALGAS_bool (true), enumerator_85512.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2104)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2097)) ;
      }
    }
  ...
  cEnumerator_typedAttributeList enumerator_87336 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_87336.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_87336.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      ...
      var_setterFormalArgumentList.addAssign_operation (enumerator_87336.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2160)), enumerator_87336.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2160)) ;
      var_setterFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2161)), enumerator_87336.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2161)) ;
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_87336.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2163)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2163))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2163)).operator_concat (GALGAS_string ("AtIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2163)), enumerator_87336.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 2163))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2163)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2164)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2167)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2162)) ;
      }
    }
    enumerator_87336.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_91109 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_91109.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_91109.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2253)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_91109.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2256)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_91109.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2257)) ;
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_91109.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2258)) ;
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 2259)), enumerator_91109.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2259)) ;
    enumerator_91109.gotoNextObject () ;
  }
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_95729 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_95729.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_95729.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2378)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_95729.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2379)) ;
    ...
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_95729.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2383)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_95729.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2384)) ;
    }
    enumerator_95729.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_96514 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_96514.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_96514.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2401)), enumerator_96514.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2402)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2398)) ;
    }
    enumerator_96514.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_97696 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_97696.hasCurrentObject () && bool_1) {
    while (enumerator_97696.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_97696.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2436)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_97696.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2436)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2436)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2436)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_97696.gotoNextObject () ;
      if (enumerator_97696.hasCurrentObject ()) {
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_100244 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_100244.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_100244.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2501)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_100244.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    ...
    GALGAS_bool joker_100723_3 ; // Joker input parameter
    GALGAS_bool joker_100723_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_100723_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_100808_2 ; // Joker input parameter
    GALGAS_constructorMap joker_100808_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_100898_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_100898_9 ; // Joker input parameter
    GALGAS_stringlist joker_100898_8 ; // Joker input parameter
    GALGAS_uint joker_100898_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_100898_6 ; // Joker input parameter
    GALGAS_stringset joker_100898_5 ; // Joker input parameter
    GALGAS_lstringlist joker_100898_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_100898_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_100898_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_100898_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_100945_5 ; // Joker input parameter
    GALGAS_string joker_100945_4 ; // Joker input parameter
    GALGAS_string joker_100945_3 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_100945_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_100945_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_100723_3, joker_100723_2, joker_100723_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_100808_2, joker_100808_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_100898_10, joker_100898_9, joker_100898_8, joker_100898_7, joker_100898_6, joker_100898_5, joker_100898_4, joker_100898_3, joker_100898_2, joker_100898_1, var_generateHeaderInSeparateFile, joker_100945_5, joker_100945_4, joker_100945_3, joker_100945_2, joker_100945_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2511)) ;
    ...
    cEnumerator_modifierMap enumerator_101232 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_101232.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_101232.current_lkey (HERE), enumerator_101232.current_mKind (HERE), enumerator_101232.current_mParameterList (HERE), enumerator_101232.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2537)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2532)) ;
      }
      enumerator_101232.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2542)) ;
    cEnumerator_readerMap enumerator_101558 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_101558.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_101558.current_lkey (HERE), enumerator_101558.current_mKind (HERE), enumerator_101558.current_mArgumentTypeList (HERE), enumerator_101558.current_mDeclarationLocation (HERE), enumerator_101558.current_mHasCompilerArgument (HERE), enumerator_101558.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2551)), enumerator_101558.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2544)) ;
      }
      enumerator_101558.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2556)) ;
    cEnumerator_instanceMethodMap enumerator_101946 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_101946.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_101946.current_lkey (HERE), enumerator_101946.current_mKind (HERE), enumerator_101946.current_mParameterList (HERE), enumerator_101946.current_mDeclarationLocation (HERE), enumerator_101946.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2564)), enumerator_101946.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2558)) ;
      }
      enumerator_101946.gotoNextObject () ;
    }
  }
  ...
  cEnumerator_typedAttributeList enumerator_102377 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_102377.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_102377.current_mAttributeTypeProxy (HERE), enumerator_102377.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2572)) ;
    enumerator_102377.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_102504 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_102504.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_102504.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2576)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_102504.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2577)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_102504.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2578)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_102504.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2579)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2579)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_102504.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_102504.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2580))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2580)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2580))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2580)) ;
    }
    enumerator_102504.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_103604 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_103604.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_103604.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2604)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_103848 (enumerator_103604.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_103848.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_103848.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2608)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_103848.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2610)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
    ...
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_103604.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2614)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_103604.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2615)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_103604.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2619)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2620)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2624)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2617)) ;
      }
    }
    enumerator_103604.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_104916 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_104916.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_104916.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_104916.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2639)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2639))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2639)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2639)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2640)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_104916.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 2641)), enumerator_104916.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2641)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2643)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2638)) ;
      }
    }
    enumerator_104916.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_105958 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_105958.hasCurrentObject () && bool_12) {
    while (enumerator_105958.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_105958.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2667)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_105958.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2667)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2667)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2667)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_105958.gotoNextObject () ;
      if (enumerator_105958.hasCurrentObject ()) {
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_107755 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_107755.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_107755.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2716)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_107755.current_mFormalArgumentPassingMode (HERE), enumerator_107755.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2717)) ;
    enumerator_107755.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_108763 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_108763.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_108763.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2735)) ;
    }
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2791)).isValid ()) {
    uint32_t variant_111520 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2791)).uintValue () ;
    bool loop_111520 = true ;
    while (loop_111520) {
      loop_111520 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2791)))).isValid () ;
      if (loop_111520) {
        loop_111520 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2791)))).boolValue () ;
      }
      if (loop_111520 && (0 == variant_111520)) {
        loop_111520 = false ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2830)).isValid ()) {
    uint32_t variant_112832 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2830)).uintValue () ;
    bool loop_112832 = true ;
    while (loop_112832) {
      loop_112832 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2830)))).isValid () ;
      if (loop_112832) {
        loop_112832 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2830)))).boolValue () ;
      }
      if (loop_112832 && (0 == variant_112832)) {
        loop_112832 = false ;
  ...
  {
  GALGAS_unifiedTypeMapProxy joker_113447_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_113447_2 ; // Joker input parameter
  GALGAS_string joker_113447_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_113447_3, joker_113447_2, joker_113447_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2850)) ;
  }
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_116003_3 ; // Joker input parameter
  GALGAS_bool joker_116003_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_116003_1 ; // Joker input parameter
  GALGAS_attributeMap joker_116091_22 ; // Joker input parameter
  GALGAS_typedAttributeList joker_116091_21 ; // Joker input parameter
  GALGAS_constructorMap joker_116091_20 ; // Joker input parameter
  GALGAS_readerMap joker_116091_19 ; // Joker input parameter
  GALGAS_modifierMap joker_116091_18 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_116091_17 ; // Joker input parameter
  GALGAS_classMethodMap joker_116091_16 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_116091_15 ; // Joker input parameter
  GALGAS_stringlist joker_116091_14 ; // Joker input parameter
  GALGAS_uint joker_116091_13 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_116091_12 ; // Joker input parameter
  GALGAS_stringset joker_116091_11 ; // Joker input parameter
  GALGAS_lstringlist joker_116091_10 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_116091_9 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_116091_8 ; // Joker input parameter
  GALGAS_withAccessorMap joker_116091_7 ; // Joker input parameter
  GALGAS_bool joker_116091_6 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_116091_5 ; // Joker input parameter
  GALGAS_string joker_116091_4 ; // Joker input parameter
  GALGAS_string joker_116091_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_116091_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_116091_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_116003_3, joker_116003_2, joker_116003_1, var_typeKindEnum, var_listTypedAttributeList, joker_116091_22, joker_116091_21, joker_116091_20, joker_116091_19, joker_116091_18, joker_116091_17, joker_116091_16, joker_116091_15, joker_116091_14, joker_116091_13, joker_116091_12, joker_116091_11, joker_116091_10, joker_116091_9, joker_116091_8, joker_116091_7, joker_116091_6, joker_116091_5, joker_116091_4, joker_116091_3, joker_116091_2, joker_116091_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2921)) ;
  ...
  cEnumerator_typedAttributeList enumerator_118162 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_118162.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_118162.current_mAttributeTypeProxy (HERE), enumerator_118162.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2961)) ;
    enumerator_118162.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_122647 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_122647.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_122647.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3069))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3069)), object->mAttribute_mSuperClassName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3069)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3069)) ;
    }
    enumerator_122647.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_123505 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123505.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123505.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3085))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3085)), enumerator_123505.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3085))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3085)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3085)) ;
    }
    enumerator_123505.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_124369 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_124369.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_124369.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3101))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3101)), enumerator_124369.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3101))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3101)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3101)) ;
    }
    enumerator_124369.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_125941 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_125941.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_125941.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3130))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3130)), enumerator_125941.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3130))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3130)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3130)) ;
    }
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_128446 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_128446.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_128446.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3174))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3174)), enumerator_128446.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3174))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3174)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3174)) ;
    }
    enumerator_128446.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_129307 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_129307.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_129307.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3190))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3190)), enumerator_129307.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3190))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3190)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3190)) ;
    }
    enumerator_129307.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_138404 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3362)) ;
  if (NULL != objectArray_138404) {
      macroValidSharedObject (objectArray_138404, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_138404->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3363)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_139709 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3390)) ;
  if (NULL != objectArray_139709) {
      macroValidSharedObject (objectArray_139709, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_139709->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3391)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_140984 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3417)) ;
  if (NULL != objectArray_140984) {
      macroValidSharedObject (objectArray_140984, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_140984->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3418)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_142888 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3456)) ;
  if (NULL != objectArray_142888) {
      macroValidSharedObject (objectArray_142888, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_142888->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3457)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_144241 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3484)) ;
  if (NULL != objectArray_144241) {
      macroValidSharedObject (objectArray_144241, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_144241->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3485)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_145556 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3511)) ;
  if (NULL != objectArray_145556) {
      macroValidSharedObject (objectArray_145556, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_145556->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3512)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_146395 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_146395.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_146395.current_mAttributeTypeName (HERE), enumerator_146395.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3541))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3538)) ;
    enumerator_146395.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_147038 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_147038.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_147038.current_mAttributeTypeName (HERE), enumerator_147038.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3562))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3559)) ;
    enumerator_147038.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_147689 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_147689.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_147689.current_mAttributeTypeName (HERE), enumerator_147689.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3583))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3580)) ;
    enumerator_147689.gotoNextObject () ;
  }
