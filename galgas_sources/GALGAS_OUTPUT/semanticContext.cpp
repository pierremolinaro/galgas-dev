...
category_method__mapDeclarationAST__enterType (C_Compiler & inLexique,
  ...
  if (operand_16863 != NULL) {
    ...
    }
    {
      ...
      while (((operand_19785 = enumerator_19785.nextObject ()))) {
        ...
        if (cond_19940.isBuiltAndTrue ()) {
          ...
          var_cas_modifierMap.modifier_insertOrReplace (inLexique, operand_19785->mMethodName, var_cas_insertMethodFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (471)) COMMA_SOURCE_FILE_AT_LINE (467)) ;
        }
      }
    }
    {
      ...
      while (((operand_20184 = enumerator_20184.nextObject ()))) {
        ...
        if (cond_20375.isBuiltAndTrue ()) {
          ...
          var_cas_modifierMap.modifier_insertOrReplace (inLexique, operand_20184->mMethodName, var_cas_removeMethodFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (484)) COMMA_SOURCE_FILE_AT_LINE (480)) ;
        }
      }
    }
    {
      ...
      while (((operand_20617 = enumerator_20617.nextObject ()))) {
        ...
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_20617->mMethodName, var_cas_removeMethodFormalArgumentList, operand_20617->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (493)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (495)) COMMA_SOURCE_FILE_AT_LINE (490)) ;
      }
    }
    {
    ...
    if (cond_21784.isBuiltAndTrue ()) {
      ...
      var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("insertOrReplace"), var_cas_insertOrReplaceLocation COMMA_SOURCE_FILE_AT_LINE (516)), var_cas_insertMethodFormalArgumentList, GGS_bool (false), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (519)) COMMA_SOURCE_FILE_AT_LINE (515)) ;
    }
    {
      ...
      while (((operand_21869 = enumerator_21869.nextObject ()))) {
        ...
        var_cas_modifierMap.modifier_insertOrReplace (inLexique, var_cas_accessorName, var_cas_accessorFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (534)) COMMA_SOURCE_FILE_AT_LINE (530)) ;
      }
    }
    ...
    const GGS_readerMap  var_cas_inheritedReaderMap = var_cas_readerMap ;
    {
      ...
      while (((operand_27352 = enumerator_27352.nextObject ()))) {
        ...
        if (cond_27759.isBuiltAndTrue ()) {
          ...
          var_cas_readerMap.modifier_insertKey (inLexique, operand_27352->mAttributeName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (true), operand_27352->mAttributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (665)) COMMA_SOURCE_FILE_AT_LINE (660)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
  ...
  if (operand_32055 != NULL) {
    ...
    ::routine_enterBaseReaderWith2Arguments (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListWithRange"),  GGS_string ("uint"),  GGS_string ("uint"),  operand_32055->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (824)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (824)) ;
    {
      ...
      while (((operand_34333 = enumerator_34333.nextObject ()))) {
        ...
        var_cas_readerMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, (operand_34333->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (827))).operator_concat (GGS_string ("AtIndex")), operand_34333->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (827)) COMMA_SOURCE_FILE_AT_LINE (827)), GGS_unifiedTypeMapProxyList ::constructor_listWithValue (var_cas_uintType), GGS_bool (true), operand_34333->mAttributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (831)) COMMA_SOURCE_FILE_AT_LINE (826)) ;
      }
    }
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (835)) ;
    var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("popFirst"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (837)), var_cas_modifierOutputFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (836)) ;
    var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("popLast"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (843)), var_cas_modifierOutputFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (846)) COMMA_SOURCE_FILE_AT_LINE (842)) ;
    var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("prependValue"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (849)), var_cas_modifierInputFormalArgumentList, GGS_bool (false), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (852)) COMMA_SOURCE_FILE_AT_LINE (848)) ;
    {
      ...
      while (((operand_35168 = enumerator_35168.nextObject ()))) {
        ...
        var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_35168->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("AtIndex")), operand_35168->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (859)) COMMA_SOURCE_FILE_AT_LINE (859)), var_cas_setterFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (862)) COMMA_SOURCE_FILE_AT_LINE (858)) ;
      }
    }
    ...
    var_cas_instanceMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("first"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (868)), var_cas_modifierOutputFormalArgumentList, GGS_location (inLexique), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (872)) COMMA_SOURCE_FILE_AT_LINE (867)) ;
    var_cas_instanceMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("last"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (875)), var_cas_modifierOutputFormalArgumentList, GGS_location (inLexique), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (879)) COMMA_SOURCE_FILE_AT_LINE (874)) ;
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
...
category_method__sortedListDeclarationAST__enterType (C_Compiler & inLexique,
  ...
  if (operand_37196 != NULL) {
    ...
    var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("popGreatest"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (949)), var_cas_modifierFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (952)) COMMA_SOURCE_FILE_AT_LINE (948)) ;
    var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("popSmallest"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (955)), var_cas_modifierFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (958)) COMMA_SOURCE_FILE_AT_LINE (954)) ;
    ...
    var_cas_instanceMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("greatest"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (963)), var_cas_modifierFormalArgumentList, GGS_location (inLexique), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (967)) COMMA_SOURCE_FILE_AT_LINE (962)) ;
    var_cas_instanceMethodMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("smallest"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (970)), var_cas_modifierFormalArgumentList, GGS_location (inLexique), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (974)) COMMA_SOURCE_FILE_AT_LINE (969)) ;
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
  ...
  if (operand_40819 != NULL) {
    ...
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1034)) ;
    {
      ...
      while (((operand_41954 = enumerator_41954.nextObject ()))) {
        ...
        ::routine_enterBaseFinalReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_41954->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1041)),  operand_41954->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1042)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1038)) ;
      }
    }
  ...
  if (operand_43568 != NULL) {
    ...
    if (cond_44469.isBuiltAndTrue ()) {
      ...
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1136)) ;
      {
        ...
        while (((operand_45530 = enumerator_45530.nextObject ()))) {
          ...
          var_cas_readerMap.modifier_insertKey (inLexique, operand_45530->mKey, operand_45530->mInfo.mArgumentTypeList, operand_45530->mInfo.mHasCompilerArgument, operand_45530->mInfo.mReturnedType, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1143)) COMMA_SOURCE_FILE_AT_LINE (1138)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    ...
    }
    {
      ...
      while (((operand_47122 = enumerator_47122.nextObject ()))) {
        ...
        if (NULL != operand_47492) {
          operand_47492->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1191)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_47122->mMethodName, var_cas_formalArgumentList, operand_47122->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1196)), GGS_bool (true), GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1198)) COMMA_SOURCE_FILE_AT_LINE (1193)) ;
        }
      }
    }
    {
    ...
    GGS_typedAttributeList  var_cas_allTypedAttributeList = var_cas_inheritedTypedAttributeList ;
    {
      ...
      while (((operand_48743 = enumerator_48743.nextObject ()))) {
        ...
        var_cas_readerMap.modifier_insertKey (inLexique, operand_48743->mAttributeName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1235)) COMMA_SOURCE_FILE_AT_LINE (1230)) ;
      }
    }
    ...
    if (cond_49744.isBuiltAndTrue ()) {
      {
        ...
        while (((operand_49395 = enumerator_49395.nextObject ()))) {
          ...
          var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_49395->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1242)), GGS_formalParameterSignature ::constructor_listWithValue (operand_49395->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1243))), GGS_bool (false), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1245)) COMMA_SOURCE_FILE_AT_LINE (1241)) ;
        }
      }
    }
