...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticDeclarationListAST enumerator_105259 (constinArgument_inSemanticDeclarationList, true) ;
  //--- simple foreach instruction
  while (enumerator_105259.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_105259.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2501)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_105259.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (2508)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_105633 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (2509)), true) ;
    //--- simple foreach instruction
    while (enumerator_105633.hasCurrentObject ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_0 (enumerator_105633.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (enumerator_105633.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2510)) COMMA_SOURCE_FILE_AT_LINE (2510)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (2510)) COMMA_SOURCE_FILE_AT_LINE (2510)) ;
      enumerator_105633.gotoNextObject () ;
    }
    //-------- @errorInstructionForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_lstringlist joker_106116_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_106116_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2517)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (2528)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_106660 (var_unsortedSemanticDeclarationListAST, true) ;
      //--- simple foreach instruction
      while (enumerator_106660.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_106660.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2531)) COMMA_SOURCE_FILE_AT_LINE (2531)) COMMA_SOURCE_FILE_AT_LINE (2531)) ;
        enumerator_106660.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_107358 (var_sortedSemanticDeclarationListAST, true) ;
      //--- simple foreach instruction
      while (enumerator_107358.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_107358.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (2549)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_107358.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_listDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2156)) COMMA_SOURCE_FILE_AT_LINE (2156)), object->mAttribute_mListTypeName.reader_location (SOURCE_FILE_AT_LINE (2156)) COMMA_SOURCE_FILE_AT_LINE (2156)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2157)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_87787 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_87787.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_87787.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2159)) COMMA_SOURCE_FILE_AT_LINE (2159)), enumerator_87787.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2159)) COMMA_SOURCE_FILE_AT_LINE (2159)) COMMA_SOURCE_FILE_AT_LINE (2159)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_87787.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_structDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (2171)) COMMA_SOURCE_FILE_AT_LINE (2171)), object->mAttribute_mStructTypeName.reader_location (SOURCE_FILE_AT_LINE (2171)) COMMA_SOURCE_FILE_AT_LINE (2171)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2172)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_88558 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_88558.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_88558.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2174)) COMMA_SOURCE_FILE_AT_LINE (2174)), enumerator_88558.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2174)) COMMA_SOURCE_FILE_AT_LINE (2174)) COMMA_SOURCE_FILE_AT_LINE (2174)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_88558.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (2186)) COMMA_SOURCE_FILE_AT_LINE (2186)), object->mAttribute_mEnumTypeName.reader_location (SOURCE_FILE_AT_LINE (2186)) COMMA_SOURCE_FILE_AT_LINE (2186)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2187)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_sortedListDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2198)) COMMA_SOURCE_FILE_AT_LINE (2198)), object->mAttribute_mSortedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2198)) COMMA_SOURCE_FILE_AT_LINE (2198)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2199)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_89943 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_89943.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_89943.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2201)) COMMA_SOURCE_FILE_AT_LINE (2201)), enumerator_89943.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2201)) COMMA_SOURCE_FILE_AT_LINE (2201)) COMMA_SOURCE_FILE_AT_LINE (2201)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_89943.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_listmapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2213)) COMMA_SOURCE_FILE_AT_LINE (2213)), object->mAttribute_mListmapTypeName.reader_location (SOURCE_FILE_AT_LINE (2213)) COMMA_SOURCE_FILE_AT_LINE (2213)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2214)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2215)) COMMA_SOURCE_FILE_AT_LINE (2215)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2215)) COMMA_SOURCE_FILE_AT_LINE (2215)) COMMA_SOURCE_FILE_AT_LINE (2215)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_mapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2226)) COMMA_SOURCE_FILE_AT_LINE (2226)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2226)) COMMA_SOURCE_FILE_AT_LINE (2226)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2227)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_91446 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_91446.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_91446.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2229)) COMMA_SOURCE_FILE_AT_LINE (2229)), enumerator_91446.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2229)) COMMA_SOURCE_FILE_AT_LINE (2229)) COMMA_SOURCE_FILE_AT_LINE (2229)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_91446.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_uniqueMapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2241)) COMMA_SOURCE_FILE_AT_LINE (2241)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2241)) COMMA_SOURCE_FILE_AT_LINE (2241)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2242)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_92214 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_92214.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_92214.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2244)) COMMA_SOURCE_FILE_AT_LINE (2244)), enumerator_92214.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2244)) COMMA_SOURCE_FILE_AT_LINE (2244)) COMMA_SOURCE_FILE_AT_LINE (2244)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_92214.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapProxyDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_mapProxyDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE_AT_LINE (2256)) COMMA_SOURCE_FILE_AT_LINE (2256)), object->mAttribute_mMapProxyTypeName.reader_location (SOURCE_FILE_AT_LINE (2256)) COMMA_SOURCE_FILE_AT_LINE (2256)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2257)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2258)) COMMA_SOURCE_FILE_AT_LINE (2258)), object->mAttribute_mAssociatedMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2258)) COMMA_SOURCE_FILE_AT_LINE (2258)) COMMA_SOURCE_FILE_AT_LINE (2258)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_graphDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_graphDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mGraphTypeName.reader_string (SOURCE_FILE_AT_LINE (2269)) COMMA_SOURCE_FILE_AT_LINE (2269)), object->mAttribute_mGraphTypeName.reader_location (SOURCE_FILE_AT_LINE (2269)) COMMA_SOURCE_FILE_AT_LINE (2269)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2270)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2271)) COMMA_SOURCE_FILE_AT_LINE (2271)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2271)) COMMA_SOURCE_FILE_AT_LINE (2271)) COMMA_SOURCE_FILE_AT_LINE (2271)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_externFunctionDeclarationAST) ;
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (object COMMA_SOURCE_FILE_AT_LINE (2282)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_onceFunctionDeclarationAST) ;
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (object COMMA_SOURCE_FILE_AT_LINE (2293)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_externRoutineDeclarationAST) ;
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (object COMMA_SOURCE_FILE_AT_LINE (2304)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_filewrapperDeclarationAST) ;
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (object COMMA_SOURCE_FILE_AT_LINE (2315)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_overridingAbstractCategoryReaderAST) ;
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (object COMMA_SOURCE_FILE_AT_LINE (2343)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_overridingAbstractCategoryMethodAST) ;
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (object COMMA_SOURCE_FILE_AT_LINE (2357)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_categoryReaderAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2368)) COMMA_SOURCE_FILE_AT_LINE (2368)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2368)).operator_concat (object->mAttribute_mCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2368)) COMMA_SOURCE_FILE_AT_LINE (2368)), object->mAttribute_mCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (2368)) COMMA_SOURCE_FILE_AT_LINE (2368)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2369)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2370)) COMMA_SOURCE_FILE_AT_LINE (2370)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (2370)) COMMA_SOURCE_FILE_AT_LINE (2370)) COMMA_SOURCE_FILE_AT_LINE (2370)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2372)) COMMA_SOURCE_FILE_AT_LINE (2372)).operator_not (SOURCE_FILE_AT_LINE (2372)).isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (2375)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2373)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_99392 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2378)) ;
  if (NULL != objectArray_99392) {
      macroValidSharedObject (objectArray_99392, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_99392->mAttribute_mCategoryReaderMapForType.modifier_insertOrReplace (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList COMMA_SOURCE_FILE_AT_LINE (2379)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_categoryMethodAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2395)) COMMA_SOURCE_FILE_AT_LINE (2395)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2395)).operator_concat (object->mAttribute_mCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (2395)) COMMA_SOURCE_FILE_AT_LINE (2395)), object->mAttribute_mCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (2395)) COMMA_SOURCE_FILE_AT_LINE (2395)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2396)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2397)) COMMA_SOURCE_FILE_AT_LINE (2397)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (2397)) COMMA_SOURCE_FILE_AT_LINE (2397)) COMMA_SOURCE_FILE_AT_LINE (2397)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2399)) COMMA_SOURCE_FILE_AT_LINE (2399)).operator_not (SOURCE_FILE_AT_LINE (2399)).isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (2402)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2400)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_100609 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2405)) ;
  if (NULL != objectArray_100609) {
      macroValidSharedObject (objectArray_100609, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_100609->mAttribute_mCategoryMethodMapForType.modifier_insertOrReplace (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2406)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_overridingCategoryReaderAST) ;
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (object COMMA_SOURCE_FILE_AT_LINE (2424)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2436)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  if (ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2439)) COMMA_SOURCE_FILE_AT_LINE (2439)).operator_not (SOURCE_FILE_AT_LINE (2439)).isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
  ...
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_102638 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2445)) ;
  if (NULL != objectArray_102638) {
      macroValidSharedObject (objectArray_102638, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_102638->mAttribute_mCategoryReaderMapForType.modifier_insertOrReplace (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList COMMA_SOURCE_FILE_AT_LINE (2446)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  if (ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2466)) COMMA_SOURCE_FILE_AT_LINE (2466)).operator_not (SOURCE_FILE_AT_LINE (2466)).isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
  ...
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_103903 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2472)) ;
  if (NULL != objectArray_103903) {
      macroValidSharedObject (objectArray_103903, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_103903->mAttribute_mCategoryMethodMapForType.modifier_insertOrReplace (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2473)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
