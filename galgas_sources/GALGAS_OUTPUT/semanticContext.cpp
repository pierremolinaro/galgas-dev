...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticDeclarationListAST enumerator_102943 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_102943.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_102943.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2477)) ;
  ...
  if (kBoolTrue == test_0) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_103317 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (2485)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_103317.hasCurrentObject ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_103317.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_103317.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2486)) COMMA_SOURCE_FILE_AT_LINE (2486)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (2486)) COMMA_SOURCE_FILE_AT_LINE (2486)) ;
      enumerator_103317.gotoNextObject () ;
    }
    //-------- @errorInstructionForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_lstringlist joker_103800_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_103800_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2493)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    ...
    if (kBoolTrue == test_2) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_104344 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_104344.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_104344.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2507)) COMMA_SOURCE_FILE_AT_LINE (2507)) COMMA_SOURCE_FILE_AT_LINE (2507)) ;
        enumerator_104344.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_105042 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_105042.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_105042.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (2525)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_105042.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_53178 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_53178.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_extensionMap.modifier_insertKey (enumerator_53178.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1300)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_53178.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_54915 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_54915.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_54915.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1351)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1351)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_54915.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1354)) ;
    enumerator_54915.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_55914 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_55914.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (enumerator_55914.current_mAttributeTypeProxy (HERE), enumerator_55914.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1368)) COMMA_SOURCE_FILE_AT_LINE (1368)) ;
    //-------- @addAssignInstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (enumerator_55914.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (1369)) ;
    //-------- @addAssignInstructionForGeneration
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_55914.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1370)) COMMA_SOURCE_FILE_AT_LINE (1370)) ;
    //-------- @addAssignInstructionForGeneration
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_55914.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1371)) COMMA_SOURCE_FILE_AT_LINE (1371)) ;
    enumerator_55914.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_57084 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_57084.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_57084.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1389)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1389)), enumerator_57084.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1389)) COMMA_SOURCE_FILE_AT_LINE (1389)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_uintType COMMA_SOURCE_FILE_AT_LINE (1391)), inCompiler->here (), GALGAS_bool (true), enumerator_57084.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1395)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1388)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_57084.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_58036 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_58036.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @addAssignInstructionForGeneration
    var_setterFormalArgumentList.addAssign_operation (enumerator_58036.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1424)) COMMA_SOURCE_FILE_AT_LINE (1424)) ;
    //-------- @addAssignInstructionForGeneration
    ...
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_58036.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1427)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1427)) COMMA_SOURCE_FILE_AT_LINE (1427)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1427)), enumerator_58036.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1427)) COMMA_SOURCE_FILE_AT_LINE (1427)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1430)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1426)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_58036.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_61035 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_61035.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61035.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1504)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1504)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_61035.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1507)) ;
    //-------- @addAssignInstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_61035.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1508)) COMMA_SOURCE_FILE_AT_LINE (1508)) ;
    //-------- @addAssignInstructionForGeneration
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_64856 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_64856.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_64856.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1609)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1609)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    ...
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_64856.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1613)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_attributeMap.modifier_insertKey (enumerator_64856.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1614)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_64856.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_65594 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_65594.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_65594.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1631)), enumerator_65594.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1632)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1628)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_65594.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_68030 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_68030.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_68030.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1695)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @assignmentInstructionForGeneration
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_68030.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    { //-------- @typeMethodInstructionForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_68479_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_68479_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_68564_2 ; // Joker input parameter
    GALGAS_constructorMap joker_68564_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_68663_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_68663_9 ; // Joker input parameter
    GALGAS_stringlist joker_68663_8 ; // Joker input parameter
    GALGAS_uint joker_68663_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_68663_6 ; // Joker input parameter
    GALGAS_stringset joker_68663_5 ; // Joker input parameter
    GALGAS_lstringlist joker_68663_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_68663_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_68663_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_68663_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_68479_2, joker_68479_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_68564_2, joker_68564_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedInstanceMethodMap, joker_68663_10, joker_68663_9, joker_68663_8, joker_68663_7, joker_68663_6, joker_68663_5, joker_68663_4, joker_68663_3, joker_68663_2, joker_68663_1, var_generateHeaderInSeparateFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (1704)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_modifierMap enumerator_68988 (var_inheritedModifierMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_68988.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (enumerator_68988.current_lkey (HERE), enumerator_68988.current_mParameterList (HERE), enumerator_68988.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1728)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1724)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_68988.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1733)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_readerMap enumerator_69299 (var_inheritedReaderMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_69299.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_69299.current_lkey (HERE), enumerator_69299.current_mIsCategory (HERE), enumerator_69299.current_mArgumentTypeList (HERE), enumerator_69299.current_mDeclarationLocation (HERE), enumerator_69299.current_mHasCompilerArgument (HERE), enumerator_69299.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1742)), enumerator_69299.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1735)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_69299.gotoNextObject () ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_69742 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_69742.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (enumerator_69742.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (1750)) ;
    enumerator_69742.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_69845 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_69845.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_69845.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1754)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1754)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1755)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_attributeMap.modifier_insertKey (enumerator_69845.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1756)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_69845.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_instanceMethodMap enumerator_70702 (var_inheritedInstanceMethodMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_70702.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_instanceMethodMap.modifier_insertKey (enumerator_70702.current_lkey (HERE), enumerator_70702.current_mIsCategory (HERE), enumerator_70702.current_mParameterList (HERE), enumerator_70702.current_mDeclarationLocation (HERE), enumerator_70702.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1780)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1774)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_70702.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_abstractMethodDefinitionListAST enumerator_71013 (object->mAttribute_mAbstractMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_71013.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_formalParameterListAST enumerator_71102 (enumerator_71013.current_mSignature (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_71102.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_typeIndex ;
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_71102.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1789)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (1789)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_71102.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1790)) ;
      enumerator_71102.gotoNextObject () ;
    }
    ...
    cMapElement_instanceMethodMap * objectArray_71363 = (cMapElement_instanceMethodMap *) var_instanceMethodMap.readWriteAccessForWithInstruction_hasKey (inCompiler, enumerator_71013.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1792)) COMMA_SOURCE_FILE_AT_LINE (1792)) ;
    if (NULL != objectArray_71363) {
        macroValidSharedObject (objectArray_71363, cMapElement_instanceMethodMap) ;
      //-------- @assignmentInstructionForGeneration
      objectArray_71363->mAttribute_mQualifier = GALGAS_methodQualifier::constructor_isOverridingAbstract (SOURCE_FILE_AT_LINE (1793)) ;
    }else{
      { //-------- @modifierCallInstructionForGeneration
      var_instanceMethodMap.modifier_insertKey (enumerator_71013.current_mMethodName (HERE), GALGAS_bool (false), var_formalArgumentList, enumerator_71013.current_mMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (1799)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isAbstract (SOURCE_FILE_AT_LINE (1801)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1795)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_71013.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_methodDefinitionListAST enumerator_71831 (object->mAttribute_mMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_71831.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_formalParameterListAST enumerator_71920 (enumerator_71831.current_mSignature (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_71920.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_typeIndex ;
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_71920.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1811)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (1811)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_71920.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1812)) ;
      enumerator_71920.gotoNextObject () ;
    }
    //-------- @readWriteWithInstructionForGeneration
    // index 1: attribute 'mIsCategory', type @bool
    // index 2: attribute 'mParameterList', type @formalParameterSignature
    ...
    // index 5: attribute 'mQualifier', type @methodQualifier
    // index 6: attribute 'mErrorMessage', type @string
    cMapElement_instanceMethodMap * objectArray_72181 = (cMapElement_instanceMethodMap *) var_instanceMethodMap.readWriteAccessForWithInstruction_hasKey (inCompiler, enumerator_71831.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1814)) COMMA_SOURCE_FILE_AT_LINE (1814)) ;
    if (NULL != objectArray_72181) {
        macroValidSharedObject (objectArray_72181, cMapElement_instanceMethodMap) ;
      //-------- @assignmentInstructionForGeneration
      objectArray_72181->mAttribute_mQualifier = GALGAS_methodQualifier::constructor_isOverriding (SOURCE_FILE_AT_LINE (1815)) ;
    }else{
      { //-------- @modifierCallInstructionForGeneration
      var_instanceMethodMap.modifier_insertKey (enumerator_71831.current_mMethodName (HERE), GALGAS_bool (false), var_formalArgumentList, enumerator_71831.current_mMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (1821)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1823)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1817)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
  ...
  if (kBoolTrue == test_5) {
    ...
    //-------- END @methodCallInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_categoryMethodMapForType enumerator_72889 (var_categoryMethodMapForType, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_72889.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_72992 (enumerator_72889.current_mFormalParameterList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_72992.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        { //-------- @typeMethodInstructionForGeneration
        GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_72992.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1836)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (1836)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @addAssignInstructionForGeneration
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_72992.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1837)) ;
        enumerator_72992.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_instanceMethodMap.modifier_insertKey (enumerator_72889.current_lkey (HERE), GALGAS_bool (true), var_formalArgumentList, enumerator_72889.current_lkey (HERE).reader_location (SOURCE_FILE_AT_LINE (1843)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1845)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1839)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_72889.gotoNextObject () ;
    }
  }
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_6) {
    ...
    //-------- END @methodCallInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_categoryReaderMapForType enumerator_73824 (var_categoryReaderMapForType, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_73824.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalInputParameterListAST enumerator_73931 (enumerator_73824.current_mInputFormalParameterList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_73931.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        { //-------- @typeMethodInstructionForGeneration
        GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_73931.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1858)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (1858)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @addAssignInstructionForGeneration
        var_formalArgumentList.addAssign_operation (var_typeIndex COMMA_SOURCE_FILE_AT_LINE (1859)) ;
        enumerator_73931.gotoNextObject () ;
      }
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_returnedType ;
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_73824.current_mResultTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1862)), var_returnedType COMMA_SOURCE_FILE_AT_LINE (1862)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_73824.current_lkey (HERE), GALGAS_bool (true), var_formalArgumentList, enumerator_73824.current_lkey (HERE).reader_location (SOURCE_FILE_AT_LINE (1867)), GALGAS_bool (true), var_returnedType, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1870)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1863)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_73824.gotoNextObject () ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_74786 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_74786.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_74786.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1880)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1880)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_75046 (enumerator_74786.current_mFeatureList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_75046.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_75046.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1884)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        //-------- @assignmentInstructionForGeneration
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_75046.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1886)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          //-------- @assignmentInstructionForGeneration
    ...
    //-------- @addAssignInstructionForGeneration
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_74786.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1890)) ;
    //-------- @addAssignInstructionForGeneration
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_74786.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1891)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_74786.current_mAttributeName (HERE), GALGAS_bool (false), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1896)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1900)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1893)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_74786.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_76098 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_76098.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_10 = enumerator_76098.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_76098.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1915)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1915)) COMMA_SOURCE_FILE_AT_LINE (1915)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1915)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_76098.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1916)) COMMA_SOURCE_FILE_AT_LINE (1916)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1918)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1914)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_76098.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListAST enumerator_77735 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_77735.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_77735.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1961)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1961)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_77735.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1962)) ;
    enumerator_77735.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalInputParameterListAST enumerator_78640 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_78640.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_78640.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1979)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1979)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1980)) ;
    enumerator_78640.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_typeKindEnum var_typeKindEnum ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_80558_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_80558_1 ; // Joker input parameter
  GALGAS_attributeMap joker_80613_17 ; // Joker input parameter
  GALGAS_typedAttributeList joker_80613_16 ; // Joker input parameter
  GALGAS_constructorMap joker_80613_15 ; // Joker input parameter
  GALGAS_readerMap joker_80613_14 ; // Joker input parameter
  GALGAS_modifierMap joker_80613_13 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_80613_12 ; // Joker input parameter
  GALGAS_classMethodMap joker_80613_11 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_80613_10 ; // Joker input parameter
  GALGAS_stringlist joker_80613_9 ; // Joker input parameter
  GALGAS_uint joker_80613_8 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_80613_7 ; // Joker input parameter
  GALGAS_stringset joker_80613_6 ; // Joker input parameter
  GALGAS_lstringlist joker_80613_5 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_80613_4 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_80613_3 ; // Joker input parameter
  GALGAS_withAccessorMap joker_80613_2 ; // Joker input parameter
  GALGAS_bool joker_80613_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_80558_2, joker_80558_1, var_typeKindEnum, var_listTypedAttributeList, joker_80613_17, joker_80613_16, joker_80613_15, joker_80613_14, joker_80613_13, joker_80613_12, joker_80613_11, joker_80613_10, joker_80613_9, joker_80613_8, joker_80613_7, joker_80613_6, joker_80613_5, joker_80613_4, joker_80613_3, joker_80613_2, joker_80613_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2014)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_82637 (var_listTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_82637.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_addAssignOperatorDescription.addAssign_operation (enumerator_82637.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2054)) ;
    enumerator_82637.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_85946 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_85946.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_85946.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2132)) COMMA_SOURCE_FILE_AT_LINE (2132)), enumerator_85946.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2132)) COMMA_SOURCE_FILE_AT_LINE (2132)) COMMA_SOURCE_FILE_AT_LINE (2132)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_86711 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_86711.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_86711.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2147)) COMMA_SOURCE_FILE_AT_LINE (2147)), enumerator_86711.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2147)) COMMA_SOURCE_FILE_AT_LINE (2147)) COMMA_SOURCE_FILE_AT_LINE (2147)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_86711.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_87482 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_87482.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_87482.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2162)) COMMA_SOURCE_FILE_AT_LINE (2162)), enumerator_87482.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2162)) COMMA_SOURCE_FILE_AT_LINE (2162)) COMMA_SOURCE_FILE_AT_LINE (2162)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_87482.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_88867 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_88867.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_88867.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2189)) COMMA_SOURCE_FILE_AT_LINE (2189)), enumerator_88867.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2189)) COMMA_SOURCE_FILE_AT_LINE (2189)) COMMA_SOURCE_FILE_AT_LINE (2189)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_88867.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_90370 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_90370.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_90370.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2217)) COMMA_SOURCE_FILE_AT_LINE (2217)), enumerator_90370.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2217)) COMMA_SOURCE_FILE_AT_LINE (2217)) COMMA_SOURCE_FILE_AT_LINE (2217)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_90370.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_91138 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_91138.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_91138.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2232)) COMMA_SOURCE_FILE_AT_LINE (2232)), enumerator_91138.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2232)) COMMA_SOURCE_FILE_AT_LINE (2232)) COMMA_SOURCE_FILE_AT_LINE (2232)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_91138.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_97387 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2357)) ;
  if (NULL != objectArray_97387) {
      macroValidSharedObject (objectArray_97387, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_97387->mAttribute_mCategoryReaderMapForType.modifier_insertOrReplace (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList COMMA_SOURCE_FILE_AT_LINE (2358)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_98604 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2384)) ;
  if (NULL != objectArray_98604) {
      macroValidSharedObject (objectArray_98604, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_98604->mAttribute_mCategoryMethodMapForType.modifier_insertOrReplace (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2385)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_100322 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2421)) ;
  if (NULL != objectArray_100322) {
      macroValidSharedObject (objectArray_100322, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_100322->mAttribute_mCategoryReaderMapForType.modifier_insertOrReplace (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList COMMA_SOURCE_FILE_AT_LINE (2422)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_101587 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2448)) ;
  if (NULL != objectArray_101587) {
      macroValidSharedObject (objectArray_101587, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_101587->mAttribute_mCategoryMethodMapForType.modifier_insertOrReplace (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2449)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
