...
category_method__structDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_43017,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_43017 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_structTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_43017->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1040)), var_cas_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (1040)) ;
    ...
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_43642 (operand_43017->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_43642 = NULL ;
      while (((operand_43642 = enumerator_43642.nextObject ()))) {
        macroValidPointer (operand_43642) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_43642->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1048)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1048)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_43642->mAttributeName) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_43642->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1051)) ;
      }
    }
    ...
    GGS_readerMap  var_cas_readerMap ;
    ::routine_commonReaderMapForAllTypes (inLexique,  var_cas_ioSemanticContext.mTypeMap,  var_cas_readerMap COMMA_SOURCE_FILE_AT_LINE (1061)) ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_44293 (operand_43017->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_44293 = NULL ;
      while (((operand_44293 = enumerator_44293.nextObject ()))) {
        macroValidPointer (operand_44293) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_44293->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1064)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1064)) ;
        ::routine_enterBaseFinalReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_44293->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1068)),  operand_44293->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1069)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1065)) ;
      }
    }
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1074)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1076)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_43017->mStructTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1081)), GGS_typeKindEnum::constructor_structType (inLexique COMMA_SOURCE_FILE_AT_LINE (1082)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_attributeMap, var_cas_typedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1090)), GGS_enumerationDescriptorList ::constructor_emptyList (), (function_generateCppConstructorWithCurrentAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1092))).operator_or (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1093))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_typedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1101)) COMMA_SOURCE_FILE_AT_LINE (1078)) ;
  }
}
...
category_method__classDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_45727,
                                const GGS_multiMethodMapForBuildingContext   var_cas_inMultiMethodMapForBuildingContext,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_45727 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("uint"), var_cas_uintType COMMA_SOURCE_FILE_AT_LINE (1112)) ;
    GGS_readerMap  var_cas_readerMap ;
    GGS_modifierMap  var_cas_modifierMap ;
    GGS_instanceMethodMap  var_cas_inheritedInstanceMethodMap ;
    GGS_typedAttributeList  var_cas_inheritedTypedAttributeList ;
    GGS_attributeMap  var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1118)) ;
    GGS_unifiedTypeMapProxy  var_cas_superClassIndex ;
    const GGS_bool cond_46604 = (operand_45727->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1121))).operator_isEqual (GGS_string ("")) ;
    if (cond_46604.isBuiltAndTrue ()) {
      var_cas_superClassIndex = GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1122)) ;
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1123)) ;
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1124)) ;
      var_cas_inheritedInstanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1125)) ;
      var_cas_inheritedTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
      var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1127)) ;
    }else if (cond_46604.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_45727->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1129)), var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (1129)) ;
      GGS_typeKindEnum var_cas_typeKindEnum ;
      GGS_readerMap  var_cas_inheritedReaderMap ;
      GGS_modifierMap  var_cas_inheritedModifierMap ;
      GGS_bool automatic_var_47098_0 ;
      GGS_unifiedTypeMapProxy  automatic_var_47098_1 ;
      GGS_typedAttributeList  automatic_var_47098_2 ;
      GGS_constructorMap  automatic_var_47098_3 ;
      GGS_classMethodMap  automatic_var_47098_4 ;
      GGS_enumerationDescriptorList  automatic_var_47098_5 ;
      GGS_uint  automatic_var_47098_6 ;
      GGS_unifiedTypeMapProxyList  automatic_var_47098_7 ;
      GGS_nativeAttributeList  automatic_var_47098_8 ;
      GGS_stringset  automatic_var_47098_9 ;
      GGS_lstringlist  automatic_var_47098_10 ;
      GGS_typedAttributeList  automatic_var_47098_11 ;
      GGS_mapSearchMethodListAST  automatic_var_47098_12 ;
      GGS_mapSearchMethodListAST  automatic_var_47098_13 ;
      GGS_withAccessorMap  automatic_var_47098_14 ;
      if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
        var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_45727->mSuperClassName, automatic_var_47098_0, automatic_var_47098_1, var_cas_typeKindEnum, var_cas_inheritedTypedAttributeList, var_cas_attributeMap, automatic_var_47098_2, automatic_var_47098_3, var_cas_inheritedReaderMap, var_cas_inheritedModifierMap, var_cas_inheritedInstanceMethodMap, automatic_var_47098_4, automatic_var_47098_5, automatic_var_47098_6, automatic_var_47098_7, automatic_var_47098_8, automatic_var_47098_9, automatic_var_47098_10, automatic_var_47098_11, automatic_var_47098_12, automatic_var_47098_13, automatic_var_47098_14 COMMA_SOURCE_FILE_AT_LINE (1133)) ;
      }
      const GGS_bool cond_47255 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1146))) ;
      if (cond_47255.isBuiltAndTrue ()) {
        operand_45727->mSuperClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_45727->mSuperClassName)).operator_concat (GGS_string (" should be a class type")) COMMA_SOURCE_FILE_AT_LINE (1148)) ;
      }
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1150)) ;
      {
        GGS_modifierMap::cEnumerator enumerator_47377 (var_cas_inheritedModifierMap, true) ;
        const GGS_modifierMap::cElement * operand_47377 = NULL ;
        while (((operand_47377 = enumerator_47377.nextObject ()))) {
          macroValidPointer (operand_47377) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, operand_47377->mKey, operand_47377->mInfo.mParameterList, operand_47377->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1156)) COMMA_SOURCE_FILE_AT_LINE (1152)) ;
        }
      }
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1160)) ;
      {
        GGS_readerMap::cEnumerator enumerator_47657 (var_cas_inheritedReaderMap, true) ;
        const GGS_readerMap::cElement * operand_47657 = NULL ;
        while (((operand_47657 = enumerator_47657.nextObject ()))) {
          macroValidPointer (operand_47657) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_47657->mKey, operand_47657->mInfo.mIsCategory, operand_47657->mInfo.mArgumentTypeList, operand_47657->mInfo.mHasCompilerArgument, operand_47657->mInfo.mReturnedType, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1168)) COMMA_SOURCE_FILE_AT_LINE (1162)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_48047 (var_cas_inheritedTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_48047 = NULL ;
      while (((operand_48047 = enumerator_48047.nextObject ()))) {
        macroValidPointer (operand_48047) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_48047->mAttributeTypeIndex) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_48150 (operand_45727->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_48150 = NULL ;
      while (((operand_48150 = enumerator_48150.nextObject ()))) {
        macroValidPointer (operand_48150) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_48150->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1179)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1179)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_48150->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1181)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_classIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_45727->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1185)), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1185)) ;
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1187)) ;
    const GGS_bool cond_48876 = (operand_45727->mIsAbstract).operator_not () ;
    if (cond_48876.isBuiltAndTrue ()) {
      var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1190)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1189)) ;
    }
    ...
    {
      GGS_instanceMethodMap::cEnumerator enumerator_49007 (var_cas_inheritedInstanceMethodMap, true) ;
      const GGS_instanceMethodMap::cElement * operand_49007 = NULL ;
      while (((operand_49007 = enumerator_49007.nextObject ()))) {
        macroValidPointer (operand_49007) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_49007->mKey, GGS_bool (false), operand_49007->mInfo.mParameterList, operand_49007->mInfo.mDeclarationLocation, operand_49007->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1205)) COMMA_SOURCE_FILE_AT_LINE (1199)) ;
      }
    }
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_49303 (operand_45727->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_49303 = NULL ;
      while (((operand_49303 = enumerator_49303.nextObject ()))) {
        macroValidPointer (operand_49303) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_49392 (operand_49303->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_49392 = NULL ;
          while (((operand_49392 = enumerator_49392.nextObject ()))) {
            macroValidPointer (operand_49392) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_49392->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1213)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1213)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_49392->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_49673 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_49303->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1216))) ;
        if (NULL != operand_49673) {
          operand_49673->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1217)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_49303->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_49303->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1223)), GGS_bool (true), GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1225)) COMMA_SOURCE_FILE_AT_LINE (1219)) ;
        }
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_50090 (operand_45727->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_50090 = NULL ;
      while (((operand_50090 = enumerator_50090.nextObject ()))) {
        macroValidPointer (operand_50090) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_50179 (operand_50090->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_50179 = NULL ;
          while (((operand_50179 = enumerator_50179.nextObject ()))) {
            macroValidPointer (operand_50179) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_50179->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1234)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1234)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_50179->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_50460 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_50090->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1237))) ;
        if (NULL != operand_50460) {
          operand_50460->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverriding (inLexique COMMA_SOURCE_FILE_AT_LINE (1238)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_50090->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_50090->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1244)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1246)) COMMA_SOURCE_FILE_AT_LINE (1240)) ;
        }
      }
    }
    const GGS_bool cond_51676 = var_cas_inMultiMethodMapForBuildingContext.reader_hasKey (operand_45727->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1251))) ;
    if (cond_51676.isBuiltAndTrue ()) {
      GGS_multiMethodMapForType  var_cas_multiMethodMapForType ;
      if (var_cas_inMultiMethodMapForBuildingContext.isBuilt ()) {
        var_cas_inMultiMethodMapForBuildingContext (HERE)->method_searchKey (inLexique, operand_45727->mClassTypeName, var_cas_multiMethodMapForType COMMA_SOURCE_FILE_AT_LINE (1253)) ;
      }
      {
        GGS_multiMethodMapForType::cEnumerator enumerator_51095 (var_cas_multiMethodMapForType, true) ;
        const GGS_multiMethodMapForType::cElement * operand_51095 = NULL ;
        while (((operand_51095 = enumerator_51095.nextObject ()))) {
          macroValidPointer (operand_51095) ;
          GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
          {
            GGS_formalParameterListAST::cEnumerator enumerator_51198 (operand_51095->mInfo.mFormalParameterList, true) ;
            const GGS_formalParameterListAST::cElement * operand_51198 = NULL ;
            while (((operand_51198 = enumerator_51198.nextObject ()))) {
              macroValidPointer (operand_51198) ;
              GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
              GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51198->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1258)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1258)) ;
              var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_51198->mFormalArgumentPassingMode) ;
            }
          }
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_51095->mKey, GGS_bool (true), var_cas_formalArgumentList, operand_51095->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1265)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1267)) COMMA_SOURCE_FILE_AT_LINE (1261)) ;
        }
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_51876 (operand_45727->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_51876 = NULL ;
      while (((operand_51876 = enumerator_51876.nextObject ()))) {
        macroValidPointer (operand_51876) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51876->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1276)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1276)) ;
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_51876->mAttributeName) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_51876->mAttributeName) ;
        var_cas_readerMap.modifier_insertKey (inLexique, operand_51876->mAttributeName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1285)) COMMA_SOURCE_FILE_AT_LINE (1279)) ;
      }
    }
    {
      GGS_typedAttributeList::cEnumerator enumerator_52540 (var_cas_currentClassTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_52540 = NULL ;
      while (((operand_52540 = enumerator_52540.nextObject ()))) {
        macroValidPointer (operand_52540) ;
        var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_52540->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1291)), GGS_formalParameterSignature ::constructor_listWithValue (operand_52540->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1292))), GGS_bool (false), GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (1294)) COMMA_SOURCE_FILE_AT_LINE (1290)) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_45727->mClassTypeName, (operand_45727->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1302)), var_cas_allTypedAttributeList, var_cas_attributeMap, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1310)), GGS_enumerationDescriptorList ::constructor_emptyList (), ((function_generateCppConstructorWithAllAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1312))).operator_or (function_doNotGenerateTypeDescriptorMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1312)))).operator_or (((var_cas_superClassIndex.reader_isNull (inLexique COMMA_SOURCE_FILE_AT_LINE (1312))).isBuiltAndTrue () ? (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1312))) : (GGS_uint (0U)))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_currentClassTypedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1320)) COMMA_SOURCE_FILE_AT_LINE (1298)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_53901,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_53901 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_54167 (operand_53901->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_54167 = NULL ;
      while (((operand_54167 = enumerator_54167.nextObject ()))) {
        macroValidPointer (operand_54167) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54167->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1334)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1334)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_54167->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_53901->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1338)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_54700,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_54700 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_54967 (operand_54700->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_54967 = NULL ;
      while (((operand_54967 = enumerator_54967.nextObject ()))) {
        macroValidPointer (operand_54967) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54967->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1351)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1351)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54700->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1356)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1356)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_54700->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1358)) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_55667,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_55667 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_55667->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1369)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1369)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_55667->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1371)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_56260,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_56260 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_56725_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_56725_1 ;
    GGS_attributeMap  automatic_var_56725_2 ;
    GGS_typedAttributeList  automatic_var_56725_3 ;
    GGS_constructorMap  automatic_var_56725_4 ;
    GGS_readerMap  automatic_var_56725_5 ;
    GGS_modifierMap  automatic_var_56725_6 ;
    GGS_instanceMethodMap  automatic_var_56725_7 ;
    GGS_classMethodMap  automatic_var_56725_8 ;
    GGS_enumerationDescriptorList  automatic_var_56725_9 ;
    GGS_uint  automatic_var_56725_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_56725_11 ;
    GGS_nativeAttributeList  automatic_var_56725_12 ;
    GGS_stringset  automatic_var_56725_13 ;
    GGS_lstringlist  automatic_var_56725_14 ;
    GGS_typedAttributeList  automatic_var_56725_15 ;
    GGS_mapSearchMethodListAST  automatic_var_56725_16 ;
    GGS_mapSearchMethodListAST  automatic_var_56725_17 ;
    GGS_withAccessorMap  automatic_var_56725_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_56260->mAssociatedListTypeName, automatic_var_56725_0, automatic_var_56725_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_56725_2, automatic_var_56725_3, automatic_var_56725_4, automatic_var_56725_5, automatic_var_56725_6, automatic_var_56725_7, automatic_var_56725_8, automatic_var_56725_9, automatic_var_56725_10, automatic_var_56725_11, automatic_var_56725_12, automatic_var_56725_13, automatic_var_56725_14, automatic_var_56725_15, automatic_var_56725_16, automatic_var_56725_17, automatic_var_56725_18 COMMA_SOURCE_FILE_AT_LINE (1384)) ;
    }
    const GGS_bool cond_56954 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1391))) ;
    if (cond_56954.isBuiltAndTrue ()) {
      operand_56260->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_56260->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1393)) ;
      var_cas_listTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1396)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1397)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1398)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1399)) ;
    GGS_unifiedTypeMapProxy  var_cas_associatedListTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56260->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1402)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1402)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56260->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1405)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1405)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1408)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("count"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1410)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("allKeys"),  GGS_string ("stringset"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1411)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("keyList"),  GGS_string ("stringlist"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1412)) ;
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("listForKey"),  GGS_string ("string"),  operand_56260->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1413)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1413)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_56260->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1415)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1415)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_58741 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_58741 = NULL ;
      while (((operand_58741 = enumerator_58741.nextObject ()))) {
        macroValidPointer (operand_58741) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_58741->mAttributeTypeIndex) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_56260->mListmapTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1430)), GGS_typeKindEnum::constructor_listMapType (inLexique COMMA_SOURCE_FILE_AT_LINE (1431)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1433)), var_cas_listTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1439)), var_cas_enumeratorDescriptor, (((function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1441))).operator_or (function_generateCppConstructorWithNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1441)))).operator_or (function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1441)))).operator_or (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1441))), var_cas_addAssignOperatorDescription, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1449)) COMMA_SOURCE_FILE_AT_LINE (1427)) ;
  }
}
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_60626,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60626 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_60626 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_60626->mPredefinedTypeName, operand_60626) ;
  }
}
...
category_method__objectPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_objectPredefinedTypeAST * operand_60991,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60991 != NULL) {
    GGS_objectPredefinedTypeAST  var_cas_t = operand_60991 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string ("object"), operand_60991) ;
  }
}
...
category_method__stringsetPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_stringsetPredefinedTypeAST * operand_61354,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61354 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_61354->mPredefinedTypeName, operand_61354) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_61664,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61664 != NULL) {
    const GGS_string var_cas_actualSuperTypeName = operand_61664->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1505)) ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (var_cas_actualSuperTypeName, operand_61664->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1506)), operand_61664) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_62060,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62060 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62060->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1514)), operand_62060) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_62374,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62374 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62374->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1522)), operand_62374) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_62688,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62688 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62688->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1530)), operand_62688) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_63006,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63006 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_63006->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1538)), operand_63006) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_63327,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63327 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_63327->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1546)), operand_63327->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1546)), operand_63327) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_63671,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63671 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_63671->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1554)), operand_63671) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_63986,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63986 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_63986->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1562)), operand_63986->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1562)), operand_63986) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externFunctionDeclarationAST * operand_64341,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64341 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_64341) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externRoutineDeclarationAST * operand_64642,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64642 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_64642) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  #endif
  GGS_collectedTypeMap  var_cas_collectedTypeMap = GGS_collectedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1593)) ;
  GGS_multiMethodMapForBuildingContext  var_cas_multiMethodMapForBuildingContext = GGS_multiMethodMapForBuildingContext ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1594)) ;
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_65578 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_65578 = NULL ;
    while (((operand_65578 = enumerator_65578.nextObject ()))) {
      macroValidPointer (operand_65578) ;
      { typeCategoryMethod__semanticDeclarationAST__collectTypes method = findCategoryMethod__semanticDeclarationAST__collectTypes (operand_65578->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_65578->mSemanticDeclaration (HERE), var_cas_collectedTypeMap, var_cas_multiMethodMapForBuildingContext COMMA_SOURCE_FILE_AT_LINE (1596)) ;
        }
      }
    }
  }
  GGS_stringlist  var_cas_undefinedClasses = var_cas_collectedTypeMap.reader_unsolvedProxyKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1602)) ;
  const GGS_bool cond_66090 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_66090.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_65953 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_65953 = NULL ;
      while (((operand_65953 = enumerator_65953.nextObject ()))) {
        macroValidPointer (operand_65953) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_65953->mValue) ;
      }
    }
    var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (1609)) ;
    var_cas_outSemanticContext.drop () ;
  }else if (cond_66090.isBuiltAndFalse ()) {
    const GGS_bool cond_66392 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_66392.isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = ((GGS_string ("there are ")).operator_concat (var_cas_undefinedClasses.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1610)))).operator_concat (GGS_string (" undefined types:")) ;
      {
        GGS_stringlist::cEnumerator enumerator_66256 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_66256 = NULL ;
        while (((operand_66256 = enumerator_66256.nextObject ()))) {
          macroValidPointer (operand_66256) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_66256->mValue) ;
        }
      }
      var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (1615)) ;
      var_cas_outSemanticContext.drop () ;
    }else if (cond_66392.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_66755 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_66755 = NULL ;
        while (((operand_66755 = enumerator_66755.nextObject ()))) {
          macroValidPointer (operand_66755) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_66755->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_66755->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (1622)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_67869 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_67869 (_variant_67869.isBuilt (), true) ;
      while (_condition_67869.isBuiltAndTrue ()) {
        _condition_67869 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_67869.isBuiltAndTrue ()) {
          if (_variant_67869.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1643)) ;
            _condition_67869 = GGS_bool (false) ;
          }else{
            _variant_67869.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_67484 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_67484 = NULL ;
              while (((operand_67484 = enumerator_67484.nextObject ()))) {
                macroValidPointer (operand_67484) ;
                const GGS_bool cond_67712 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_67484->mDependanceString) ;
                if (cond_67712.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_67484->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_67484->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_67712.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_67484->mDependanceString, operand_67484->mTypeString, operand_67484->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_68492 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_68492.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_68151 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_68151 = enumerator_68151.nextObject () ;
          if ((operand_68151 != NULL)) {
            bool _foreach_loop_68151 ;
            do{
              macroValidPointer (operand_68151) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_68151->mTypeString) ;
              operand_68151 = enumerator_68151.nextObject () ;
              _foreach_loop_68151 = ((operand_68151 != NULL)) ;
              if (_foreach_loop_68151) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_68151) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_68324 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_68324 = NULL ;
          while (((operand_68324 = enumerator_68324.nextObject ()))) {
            macroValidPointer (operand_68324) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_68324->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_68324->mDependanceString) ;
          }
        }
        var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (1656)) ;
        var_cas_outSemanticContext.drop () ;
      }else if (cond_68492.isBuiltAndFalse ()) {
        var_cas_outSemanticContext = GGS_semanticContext::constructor_new (GGS_unifiedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1659)), GGS_routineMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)), GGS_functionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1661)), GGS_filewrapperMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1662)), GGS_grammarMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)), GGS_optionComponentMapForSemanticAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1664))) ;
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_68908 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_68908 = NULL ;
          while (((operand_68908 = enumerator_68908.nextObject ()))) {
            macroValidPointer (operand_68908) ;
            { typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (operand_68908->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_68908->mSemanticDeclaration (HERE), var_cas_multiMethodMapForBuildingContext, var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (1668)) ;
              }
            }
          }
        }
