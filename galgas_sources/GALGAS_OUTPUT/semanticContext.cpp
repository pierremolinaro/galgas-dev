...
void routine_addCategories (const GALGAS_categoryMethodMapForBuildingContext constinArgument_inCategoryMethodMapForBuildingContext,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_categoryMethodMapForType enumerator_19854 (var_categoryMethodMapForType, kEnumeration_up) ;
    while (enumerator_19854.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_19957 (enumerator_19854.current_mFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_19957.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_19957.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 503)) ;
        }
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_19957.current_mFormalArgumentPassingMode (HERE), enumerator_19957.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 508)) ;
        enumerator_19957.gotoNextObject () ;
      }
      {
      ioArgument_ioInstanceMethodMap.modifier_insertKey (enumerator_19854.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE ("semanticContext.gSemantics", 512)), var_formalArgumentList, enumerator_19854.current_lkey (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 514)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 516)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 510)) ;
      }
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_categoryReaderMapForType enumerator_20827 (var_categoryReaderMapForType, kEnumeration_up) ;
    while (enumerator_20827.hasCurrentObject ()) {
      ...
      cEnumerator_formalInputParameterListAST enumerator_20946 (enumerator_20827.current_mInputFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_20946.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_20946.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 529)) ;
        }
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_20946.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 530)) ;
        enumerator_20946.gotoNextObject () ;
      }
      GALGAS_unifiedTypeMapProxy var_returnedType ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_20827.current_mResultTypeName (HERE), var_returnedType COMMA_SOURCE_FILE ("semanticContext.gSemantics", 533)) ;
      }
      {
      ioArgument_ioReaderMap.modifier_insertKey (enumerator_20827.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE ("semanticContext.gSemantics", 536)), var_formalArgumentList, enumerator_20827.current_lkey (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 538)), GALGAS_bool (true), var_returnedType, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 541)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 534)) ;
      }
  ...
  if (kBoolTrue == test_2) {
    ...
    cEnumerator_categoryModifierMapForType enumerator_21940 (var_categoryModifierMapForType, kEnumeration_up) ;
    while (enumerator_21940.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_22043 (enumerator_21940.current_mFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_22043.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_22043.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 554)) ;
        }
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_22043.current_mFormalArgumentPassingMode (HERE), enumerator_22043.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 555)) ;
        enumerator_22043.gotoNextObject () ;
      }
      {
      ioArgument_ioModifierMap.modifier_insertKey (enumerator_21940.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE ("semanticContext.gSemantics", 559)), var_formalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 562)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 557)) ;
      }
...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_78181 (var_files, kEnumeration_up) ;
  while (enumerator_78181.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_78181.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("semanticContext.gSemantics", 1914)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1914)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1915)).operator_concat (enumerator_78181.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1915)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_78181.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1917)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1916)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1923)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_78181.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("semanticContext.gSemantics", 1924)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1924)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1925)).operator_concat (enumerator_78181.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1925)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_78181.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1927)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1926)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1933)) ;
      }
    }
    enumerator_78181.gotoNextObject () ;
  }
  ...
  cEnumerator_stringlist enumerator_79146 (var_directories, kEnumeration_up) ;
  while (enumerator_79146.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1944)).operator_concat (enumerator_79146.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1944)), constinArgument_inPathInWrapper.operator_concat (enumerator_79146.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1945)).operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1945)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1943)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_79146.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1954)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1953)) ;
    }
    enumerator_79146.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_semanticDeclarationListAST constinArgument_inSemanticDeclarationList,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_149648 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_149648.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_149648.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3638)) ;
    enumerator_149648.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    outArgument_outSemanticContext = GALGAS_semanticContext::constructor_default (SOURCE_FILE ("semanticContext.gSemantics", 3659)) ;
    cEnumerator_lstringlist enumerator_150856 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE ("semanticContext.gSemantics", 3660)), kEnumeration_up) ;
    while (enumerator_150856.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_150856.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_150856.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3661))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3661)).operator_concat (GALGAS_string ("' type is not defined")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3661))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3661)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
      enumerator_150856.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    ...
    GALGAS_lstringlist joker_151096_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_151096_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3664)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_151491 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_151491.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_151491.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3673))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3673))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3673)) ;
        enumerator_151491.gotoNextObject () ;
      }
      GALGAS_location location_3 (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 3675)).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, var_s  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3675)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
      ...
      outArgument_outSemanticContext = GALGAS_semanticContext::constructor_new (GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3681)), GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3682)), GALGAS_functionMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3683)), GALGAS_filewrapperMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3684)), GALGAS_grammarMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3685)), GALGAS_optionComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3686)), GALGAS_lexiqueComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3687))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3680)) ;
      cEnumerator_semanticDeclarationListAST enumerator_152222 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_152222.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_152222.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3691)) ;
        enumerator_152222.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_predefinedTypeAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (GALGAS_lstring::constructor_new (object->mAttribute_mPredefinedTypeName, inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 769)), object->mAttribute_mIsPredefined, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticContext.gSemantics", 772)), GALGAS_typeKindEnum::constructor_predefinedType (SOURCE_FILE ("semanticContext.gSemantics", 773)), GALGAS_bool (kIsEqual, object->mAttribute_mPredefinedTypeName.objectCompare (GALGAS_string ("stringset"))), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 775)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 776)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 777)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, var_classMethodMap, var_enumerationList, var_enumerationVariants, callCategoryReader_getSupportedOperatorFlags ((const cPtr_predefinedTypeAST *) temp_8.ptr (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 785)), var_addAssignArgumentList, GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticContext.gSemantics", 787)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 788)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 789)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 790)), GALGAS_bool (false), var_enumeratedTypeProxy, categoryReader_defaultConstructorName (object->mAttribute_mKind, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 793)), GALGAS_string ("galgas2/predefined-types"), GALGAS_headerKind::constructor_twoHeaders (SOURCE_FILE ("semanticContext.gSemantics", 795)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 768)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_36432 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_36432.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_36432.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 860)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_argumentTypeListForAddAssignWithFieldExpressionList.addAssign_operation (var_attributeTypeIndex, enumerator_36432.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 863)) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_36432.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 864)) ;
    ...
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_36432.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 866))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 866)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 867)), enumerator_36432.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 867)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 868)), enumerator_36432.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 868)) ;
    enumerator_36432.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_37294 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_37294.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_37294.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 872)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 872)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_37294.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_37294.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 873))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 873)).operator_concat (GALGAS_string ("' insert method is already declared")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 873))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 873)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_37294.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 877)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 880)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 875)) ;
      }
    }
    enumerator_37294.gotoNextObject () ;
  }
  cEnumerator_mapRemoveMethodListAST enumerator_37768 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  while (enumerator_37768.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_modifierMap.reader_hasKey (enumerator_37768.current_mMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 887)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 887)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_37768.current_mMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_37768.current_mMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 888))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 888)).operator_concat (GALGAS_string ("' method is already declared as an insert modifier or a remove modifier")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 888))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 888)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_37768.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 892)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 895)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 890)) ;
      }
    }
    enumerator_37768.gotoNextObject () ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_38295 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_38295.hasCurrentObject ()) {
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_38295.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 904)), var_removeMethodFormalArgumentList, enumerator_38295.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 906)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 908)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 902)) ;
    }
    enumerator_38295.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_38630 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_38630.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_38630.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 914)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 914)), enumerator_38630.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 914))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 914)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_38630.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 916)) ;
    }
    {
  ...
  cEnumerator_attributeInCollectionListAST enumerator_39901 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_39901.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_39901.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 944)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 944))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 944)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 944)), enumerator_39901.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 944))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 944)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_39901.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 945)) ;
    }
    ...
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 948)), enumerator_39901.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 948)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 949)), enumerator_39901.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 949)) ;
    {
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_46056 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_46056.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_46056.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1071)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_46056.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1074)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_46056.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1075))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1075)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1076)), enumerator_46056.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1076)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 1077)), enumerator_46056.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1077)) ;
    enumerator_46056.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_46790 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_46790.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_46790.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1081)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1081)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_46790.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_46790.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1082))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1082)).operator_concat (GALGAS_string ("' insert method is already declared")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1082))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1082)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_46790.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1086)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1089)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1084)) ;
      }
    }
    enumerator_46790.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_48535 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_48535.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_48535.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1124)), var_removeMethodFormalArgumentList, enumerator_48535.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 1126)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1128)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1122)) ;
      }
      enumerator_48535.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_48865 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_48865.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_48865.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1136)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1139)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1134)) ;
      }
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_mapOverrideBlockListAST enumerator_50675 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    while (enumerator_50675.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_50675.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 1183))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1183)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1183)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1184)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 1185)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1187)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1182)) ;
      }
      enumerator_50675.gotoNextObject () ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_51084 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_51084.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_51084.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1194)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1194)), enumerator_51084.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 1194))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1194)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_51084.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1196)) ;
    }
    {
    ...
    enumerator_51084.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_51875 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_51875.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_51875.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1211)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 1211))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1211)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1211)), enumerator_51875.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 1211))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1211)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_51875.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1212)) ;
    }
    ...
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1215)), enumerator_51875.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1215)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1216)), enumerator_51875.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1216)) ;
    {
    ...
    enumerator_51875.gotoNextObject () ;
  }
  {
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_54935_3 ; // Joker input parameter
  GALGAS_bool joker_54935_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_54935_1 ; // Joker input parameter
  GALGAS_bool joker_54975_3 ; // Joker input parameter
  GALGAS_typedAttributeList joker_54975_2 ; // Joker input parameter
  GALGAS_attributeMap joker_54975_1 ; // Joker input parameter
  GALGAS_constructorMap joker_55030_11 ; // Joker input parameter
  GALGAS_readerMap joker_55030_10 ; // Joker input parameter
  GALGAS_modifierMap joker_55030_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_55030_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_55030_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_55030_6 ; // Joker input parameter
  GALGAS_stringlist joker_55030_5 ; // Joker input parameter
  GALGAS_uint joker_55030_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_55030_3 ; // Joker input parameter
  GALGAS_stringset joker_55030_2 ; // Joker input parameter
  GALGAS_lstringlist joker_55030_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_55085_6 ; // Joker input parameter
  GALGAS_bool joker_55085_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_55085_4 ; // Joker input parameter
  GALGAS_string joker_55085_3 ; // Joker input parameter
  GALGAS_string joker_55085_2 ; // Joker input parameter
  GALGAS_headerKind joker_55085_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_54935_3, joker_54935_2, joker_54935_1, var_typeKindEnum, joker_54975_3, joker_54975_2, joker_54975_1, var_mapTypedAttributeList, joker_55030_11, joker_55030_10, joker_55030_9, joker_55030_8, joker_55030_7, joker_55030_6, joker_55030_5, joker_55030_4, joker_55030_3, joker_55030_2, joker_55030_1, var_searchMethodList, joker_55085_6, joker_55085_5, joker_55085_4, joker_55085_3, joker_55085_2, joker_55085_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1289)) ;
  ...
  cEnumerator_mapSearchMethodListAST enumerator_57667 (var_searchMethodList, kEnumeration_up) ;
  while (enumerator_57667.hasCurrentObject ()) {
    {
    var_constructorMap.modifier_insertKey (enumerator_57667.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1347)) ;
    }
  ...
  cEnumerator_typedAttributeList enumerator_58638 (var_mapTypedAttributeList, kEnumeration_up) ;
  while (enumerator_58638.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_58638.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1364)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1364)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_58772 (var_inheritedReaderMap.reader_keySet (SOURCE_FILE ("semanticContext.gSemantics", 1366)), kEnumeration_up) ;
      while (enumerator_58772.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_58772.current_key (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1367)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1367))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1367)) ;
        if (enumerator_58772.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1368)) ;
        }
        enumerator_58772.gotoNextObject () ;
      }
      GALGAS_location location_3 (enumerator_58638.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      {
      var_readerMap.modifier_insertKey (enumerator_58638.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1375)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 1376)), inCompiler->here (), GALGAS_bool (true), enumerator_58638.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1380)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1373)) ;
      }
    }
    enumerator_58638.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externTypeDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_externTypeConstructorList enumerator_61467 (object->mAttribute_mExternTypeConstructorList, kEnumeration_up) ;
  while (enumerator_61467.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61467.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1447)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_61719 (enumerator_61467.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_61719.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61719.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1452)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_61719.current_mFormalParameterName (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1453)) ;
      enumerator_61719.gotoNextObject () ;
    }
    {
    var_constructorMap.modifier_insertKey (enumerator_61467.current_mConstructorName (HERE), var_arguments, GALGAS_bool (true), var_returnedTypeProxy, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1456)) ;
    }
    enumerator_61467.gotoNextObject () ;
  }
  cEnumerator_externTypeReaderList enumerator_62185 (object->mAttribute_mExternTypeReaderList, kEnumeration_up) ;
  while (enumerator_62185.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_62185.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1466)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_62437 (enumerator_62185.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_62437.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_62437.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1471)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_62437.current_mFormalParameterName (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1472)) ;
      enumerator_62437.gotoNextObject () ;
    }
    {
    var_readerMap.modifier_insertKey (enumerator_62185.current_mReaderName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1477)), var_arguments, inCompiler->here (), GALGAS_bool (true), var_returnedTypeProxy, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1482)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1475)) ;
    }
    enumerator_62185.gotoNextObject () ;
  }
  cEnumerator_externTypeModifierList enumerator_63014 (object->mAttribute_mExternTypeModifierList, kEnumeration_up) ;
  while (enumerator_63014.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_63111 (enumerator_63014.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_63111.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_63111.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1490)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_63111.current_mFormalArgumentPassingMode (HERE), enumerator_63111.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1495)) ;
      enumerator_63111.gotoNextObject () ;
    }
    {
    var_modifierMap.modifier_insertKey (enumerator_63014.current_mModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1500)), var_routineSignature, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1503)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1498)) ;
    }
    enumerator_63014.gotoNextObject () ;
  }
  cEnumerator_externTypeMethodList enumerator_63707 (object->mAttribute_mExternTypeMethodList, kEnumeration_up) ;
  while (enumerator_63707.hasCurrentObject ()) {
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_71113 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1714)), kEnumeration_up) ;
  while (enumerator_71113.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (enumerator_71113.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 1715)), enumerator_71113.current_mFormalParameterName (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1715)) ;
    enumerator_71113.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_71264 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_71264.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_71264.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1720)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1723)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1718)) ;
    }
    enumerator_71264.gotoNextObject () ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_75608 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_75608.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_75608.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1839))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1839)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_75608.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1840)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1840)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1840)) ;
    }
    enumerator_75608.gotoNextObject () ;
  }
  GALGAS_readerMap var_readerMap ;
  {
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_filewrapperTemplateListAST enumerator_80380 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_80380.hasCurrentObject ()) {
    ...
    cEnumerator_formalTemplateInputParameterListAST enumerator_80498 (enumerator_80380.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_80498.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_80498.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1976)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1977)) ;
      enumerator_80498.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_80380.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_80380.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1979)) ;
    }
    enumerator_80380.gotoNextObject () ;
  }
  ...
  cEnumerator_lstringlist enumerator_81017 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_81017.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_81017.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1988)) ;
    }
    enumerator_81017.gotoNextObject () ;
  }
  ...
  cEnumerator_lstringlist enumerator_81223 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_81223.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_81223.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1993)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_81223.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_81223.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1994))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1994)).operator_concat (GALGAS_string ("' extension is already used for text files")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1994))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1994)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_81223.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1996)) ;
      }
    }
    enumerator_81223.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_83173 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_83173.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_83173.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2048)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_83393 (enumerator_83173.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_83393.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_83393.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_83393.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
    ...
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_83173.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2058)) ;
    enumerator_83173.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_84546 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_84546.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_84546.current_mAttributeTypeProxy (HERE), enumerator_84546.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2076))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2076)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_84546.current_mAttributeTypeProxy (HERE), enumerator_84546.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2077)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_84546.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 2078)), enumerator_84546.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2078)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_84546.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2079)), enumerator_84546.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2079)) ;
    enumerator_84546.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_85955 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_85955.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_85955.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_85955.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2099)).operator_concat (GALGAS_string ("AtIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2099)), enumerator_85955.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 2099))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2099)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2100)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_listWithValue (var_uintType, GALGAS_string ("inIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2101)), inCompiler->here (), GALGAS_bool (true), enumerator_85955.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2105)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2098)) ;
      }
    }
    enumerator_85955.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_87779 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_87779.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_87779.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      ...
      var_setterFormalArgumentList.addAssign_operation (enumerator_87779.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2161)), enumerator_87779.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2161)) ;
      var_setterFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2162)), enumerator_87779.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2162)) ;
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_87779.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2164)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2164))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2164)).operator_concat (GALGAS_string ("AtIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2164)), enumerator_87779.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 2164))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2164)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2165)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2168)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2163)) ;
      }
    }
    enumerator_87779.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_91568 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_91568.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_91568.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2255)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_91568.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2258)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_91568.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2259)) ;
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_91568.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2260)) ;
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 2261)), enumerator_91568.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2261)) ;
    enumerator_91568.gotoNextObject () ;
  }
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_96190 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_96190.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_96190.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2380)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_96190.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2381)) ;
    ...
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_96190.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2385)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_96190.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2386)) ;
    }
    enumerator_96190.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_96975 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_96975.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_96975.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2401)), enumerator_96975.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2402)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2398)) ;
    }
  ...
  cEnumerator_typedAttributeList enumerator_98025 (var_typedAttributeList, kEnumeration_up) ;
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_100608 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_100608.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_100608.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2501)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_100608.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    ...
    GALGAS_bool joker_101087_3 ; // Joker input parameter
    GALGAS_bool joker_101087_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_101087_1 ; // Joker input parameter
    GALGAS_bool joker_101117_0 ; // Joker input parameter
    GALGAS_typedAttributeList joker_101181_2 ; // Joker input parameter
    GALGAS_constructorMap joker_101181_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_101271_9 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_101271_8 ; // Joker input parameter
    GALGAS_stringlist joker_101271_7 ; // Joker input parameter
    GALGAS_uint joker_101271_6 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_101271_5 ; // Joker input parameter
    GALGAS_stringset joker_101271_4 ; // Joker input parameter
    GALGAS_lstringlist joker_101271_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_101271_2 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_101271_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_101317_4 ; // Joker input parameter
    GALGAS_string joker_101317_3 ; // Joker input parameter
    GALGAS_string joker_101317_2 ; // Joker input parameter
    GALGAS_headerKind joker_101317_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_101087_3, joker_101087_2, joker_101087_1, var_typeKindEnum, joker_101117_0, var_inheritedTypedAttributeList, var_attributeMap, joker_101181_2, joker_101181_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_101271_9, joker_101271_8, joker_101271_7, joker_101271_6, joker_101271_5, joker_101271_4, joker_101271_3, joker_101271_2, joker_101271_1, var_generateHeaderInSeparateFile, joker_101317_4, joker_101317_3, joker_101317_2, joker_101317_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2511)) ;
    ...
    cEnumerator_modifierMap enumerator_101604 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_101604.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_101604.current_lkey (HERE), enumerator_101604.current_mKind (HERE), enumerator_101604.current_mParameterList (HERE), enumerator_101604.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2538)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2533)) ;
      }
    ...
    cEnumerator_readerMap enumerator_101930 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_101930.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_101930.current_lkey (HERE), enumerator_101930.current_mKind (HERE), enumerator_101930.current_mArgumentTypeList (HERE), enumerator_101930.current_mDeclarationLocation (HERE), enumerator_101930.current_mHasCompilerArgument (HERE), enumerator_101930.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2552)), enumerator_101930.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2545)) ;
      }
      enumerator_101930.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2557)) ;
    cEnumerator_instanceMethodMap enumerator_102318 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_102318.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_102318.current_lkey (HERE), enumerator_102318.current_mKind (HERE), enumerator_102318.current_mParameterList (HERE), enumerator_102318.current_mDeclarationLocation (HERE), enumerator_102318.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2565)), enumerator_102318.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2559)) ;
      }
      enumerator_102318.gotoNextObject () ;
    }
  }
  ...
  cEnumerator_typedAttributeList enumerator_102749 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_102749.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_102749.current_mAttributeTypeProxy (HERE), enumerator_102749.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2573)) ;
    enumerator_102749.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_102876 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_102876.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_102876.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2577)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_102876.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2578)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_102876.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2579)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_102876.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2580)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2580)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_102876.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_102876.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2581))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2581)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2581))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2581)) ;
    }
    enumerator_102876.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_103976 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_103976.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_103976.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2605)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_104220 (enumerator_103976.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_104220.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_104220.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2609)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_104220.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2611)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_104220.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_103976.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2615)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_103976.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2616)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_103976.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2620)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2621)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2625)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2618)) ;
      }
    }
    enumerator_103976.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_105288 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_105288.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_105288.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_105288.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2640)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2640))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2640)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2640)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2641)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_105288.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 2642)), enumerator_105288.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2642)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2644)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2639)) ;
      }
    }
    enumerator_105288.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_106330 (var_currentClassTypedAttributeList, kEnumeration_up) ;
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_108087 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_108087.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_108087.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2716)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_108087.current_mFormalArgumentPassingMode (HERE), enumerator_108087.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2717)) ;
    enumerator_108087.gotoNextObject () ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mRoutineMap.modifier_insertKey (object->mAttribute_mRoutineName, var_routineSignature, object->mAttribute_mIsInternal, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2720)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_109123 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_109123.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_109123.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2739)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2740)) ;
    enumerator_109123.gotoNextObject () ;
  }
  ...
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultTypeIndex, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2746)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName, var_resultTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2763)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2765)), var_resultTypeIndex, object->mAttribute_mIsInternal, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2765)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayDeclarationAST) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2777)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mDimension.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the dimension of an array should be > 0")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2778)) ;
  }
  GALGAS_unifiedTypeMapProxy var_arrayTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mArrayTypeName, var_arrayTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2782)) ;
  }
  GALGAS_unifiedTypeMapProxy var_elementTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mElementTypeName, var_elementTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2785)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2787)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2788)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2789)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2790)) ;
  GALGAS_unifiedTypeMapProxy var_boolType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("bool"), var_boolType COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2793)) ;
  }
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2796)) ;
  }
  GALGAS_unifiedTypeMapProxyAndParameterList var_uintArgs = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2798)) ;
  GALGAS_uint var_idx = GALGAS_uint ((uint32_t) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2800)).isValid ()) {
    uint32_t variant_111937 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2800)).uintValue () ;
    bool loop_111937 = true ;
    while (loop_111937) {
      loop_111937 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2800)))).isValid () ;
      if (loop_111937) {
        loop_111937 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2800)))).boolValue () ;
      }
      if (loop_111937 && (0 == variant_111937)) {
        loop_111937 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticContext.gSemantics", 2800)) ;
      }
      if (loop_111937) {
        variant_111937 -- ;
        var_uintArgs.addAssign_operation (var_uintType, GALGAS_string ("inSize").operator_concat (var_idx.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2801))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2801))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2801)) ;
        var_idx.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2802)) ;
      }
    }
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2806)), var_uintArgs, GALGAS_bool (false), var_arrayTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2805)) ;
  }
  {
  routine_enterBaseReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("axisCount"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2812)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("sizeForAxis"), GALGAS_string ("uint"), GALGAS_string ("inAxisIndex"), GALGAS_string ("uint"), GALGAS_bool (true), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2813)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("rangeForAxis"), GALGAS_string ("uint"), GALGAS_string ("inAxisIndex"), GALGAS_string ("range"), GALGAS_bool (true), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2814)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("isValueValidAtIndex"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2816)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2817)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_boolType, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2822)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2815)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("valueAtIndex"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2826)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2827)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_elementTypeIndex, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2832)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2825)) ;
  }
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2836)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_elementTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2837)), GALGAS_string ("InValue")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2837)) ;
  var_idx = GALGAS_uint ((uint32_t) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2839)).isValid ()) {
    uint32_t variant_113249 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2839)).uintValue () ;
    bool loop_113249 = true ;
    while (loop_113249) {
      loop_113249 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2839)))).isValid () ;
      if (loop_113249) {
        loop_113249 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2839)))).boolValue () ;
      }
      if (loop_113249 && (0 == variant_113249)) {
        loop_113249 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticContext.gSemantics", 2839)) ;
      }
      if (loop_113249) {
        variant_113249 -- ;
        var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2840)), GALGAS_string ("inIndex").operator_concat (var_idx.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2840))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2840))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2840)) ;
        var_idx.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2841)) ;
      }
    }
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setValueAtIndex").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2844)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2845)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2848)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2843)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("forceValueAtIndex").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2852)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2853)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2856)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2851)) ;
  }
  {
  GALGAS_unifiedTypeMapProxy joker_113864_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_113864_2 ; // Joker input parameter
  GALGAS_string joker_113864_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_113864_3, joker_113864_2, joker_113864_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2859)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("invalidateValueAtIndex").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2861)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2862)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2865)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2860)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSize").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2869)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2870)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2873)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2868)) ;
  }
  var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2876)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2877)), GALGAS_string ("inSize")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2877)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2878)), GALGAS_string ("inAxisIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2878)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSizeForAxis").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2880)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2881)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2884)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2879)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mArrayTypeName, object->mAttribute_mIsPredefined, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticContext.gSemantics", 2892)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE ("semanticContext.gSemantics", 2893)), GALGAS_bool (false), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2895)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2896)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2897)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2902)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2903)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2904)), GALGAS_uint ((uint32_t) 0U), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2906)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticContext.gSemantics", 2907)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2908)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2909)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2910)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticContext.gSemantics", 2914)), GALGAS_string::makeEmptyString (), GALGAS_string ("array-").operator_concat (object->mAttribute_mArrayTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2916))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2916)), GALGAS_headerKind::constructor_oneHeader (SOURCE_FILE ("semanticContext.gSemantics", 2917)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2888)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_116356_3 ; // Joker input parameter
  GALGAS_bool joker_116356_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_116356_1 ; // Joker input parameter
  GALGAS_bool joker_116396_0 ; // Joker input parameter
  GALGAS_attributeMap joker_116451_20 ; // Joker input parameter
  GALGAS_typedAttributeList joker_116451_19 ; // Joker input parameter
  GALGAS_constructorMap joker_116451_18 ; // Joker input parameter
  GALGAS_readerMap joker_116451_17 ; // Joker input parameter
  GALGAS_modifierMap joker_116451_16 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_116451_15 ; // Joker input parameter
  GALGAS_classMethodMap joker_116451_14 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_116451_13 ; // Joker input parameter
  GALGAS_stringlist joker_116451_12 ; // Joker input parameter
  GALGAS_uint joker_116451_11 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_116451_10 ; // Joker input parameter
  GALGAS_stringset joker_116451_9 ; // Joker input parameter
  GALGAS_lstringlist joker_116451_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_116451_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_116451_6 ; // Joker input parameter
  GALGAS_bool joker_116451_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_116451_4 ; // Joker input parameter
  GALGAS_string joker_116451_3 ; // Joker input parameter
  GALGAS_string joker_116451_2 ; // Joker input parameter
  GALGAS_headerKind joker_116451_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_116356_3, joker_116356_2, joker_116356_1, var_typeKindEnum, joker_116396_0, var_listTypedAttributeList, joker_116451_20, joker_116451_19, joker_116451_18, joker_116451_17, joker_116451_16, joker_116451_15, joker_116451_14, joker_116451_13, joker_116451_12, joker_116451_11, joker_116451_10, joker_116451_9, joker_116451_8, joker_116451_7, joker_116451_6, joker_116451_5, joker_116451_4, joker_116451_3, joker_116451_2, joker_116451_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2930)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE ("semanticContext.gSemantics", 2938)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2939))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2939)).operator_concat (GALGAS_string ("' type should be a list type")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2939))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2939)) ;
    var_listTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2940)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2943)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2944)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2945)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2946)) ;
  GALGAS_unifiedTypeMapProxy var_associatedListTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedListTypeName, var_associatedListTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2948)) ;
  }
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  ...
  cEnumerator_typedAttributeList enumerator_118303 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_118303.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_118303.current_mAttributeTypeProxy (HERE), enumerator_118303.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2966)) ;
    enumerator_118303.gotoNextObject () ;
  }
  ...
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListmapTypeName, object->mAttribute_mIsPredefined, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticContext.gSemantics", 2994)), GALGAS_typeKindEnum::constructor_arrayType (SOURCE_FILE ("semanticContext.gSemantics", 2995)), GALGAS_bool (true), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2997)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2998)), var_listTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3004)), var_enumeratorDescriptor, var_enumerationVariants, function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3007)), var_addAssignOperatorDescription, GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticContext.gSemantics", 3009)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3010)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3011)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3012)), GALGAS_bool (false), var_listElementTypeIndex, GALGAS_string ("emptyMap"), GALGAS_string ("listmap-").operator_concat (object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3018))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3018)), GALGAS_headerKind::constructor_oneHeader (SOURCE_FILE ("semanticContext.gSemantics", 3019)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2990)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_predefinedTypeAST * object = (const cPtr_predefinedTypeAST *) inObject ;
  macroValidSharedObject (object, cPtr_predefinedTypeAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mPredefinedTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3056)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3056)) ;
  {
  const GALGAS_predefinedTypeAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3057)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_classDeclarationAST * object = (const cPtr_classDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_classDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3069))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3069)), object->mAttribute_mClassTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3069))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3069)) ;
  {
  const GALGAS_classDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3070)) ;
  }
  ...
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3072))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3072)), object->mAttribute_mSuperClassName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3072)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3072)) ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_122811 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_122811.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_122811.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3075))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3075)), object->mAttribute_mSuperClassName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3075)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3075)) ;
    }
    enumerator_122811.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3088))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3088)), object->mAttribute_mListTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3088))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3088)) ;
  {
  const GALGAS_listDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3089)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_123669 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123669.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123669.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3091))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3091)), enumerator_123669.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3091))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3091)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3091)) ;
    }
    enumerator_123669.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_124533 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_124533.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_124533.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3107))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3107)), enumerator_124533.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3107))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3107)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3107)) ;
    }
    enumerator_124533.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_enumDeclarationAST * object = (const cPtr_enumDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_enumDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3120))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3120)), object->mAttribute_mEnumTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3120))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3120)) ;
  {
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_126105 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126105.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126105.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3136))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3136)), enumerator_126105.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3136))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3136)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3136)) ;
    }
    enumerator_126105.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mArrayTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3149))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3149)), object->mAttribute_mArrayTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3149))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3149)) ;
  {
  const GALGAS_arrayDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3150)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mElementTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3151))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3151)), object->mAttribute_mElementTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3151))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3151)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3151)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listmapDeclarationAST * object = (const cPtr_listmapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listmapDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3163))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3163)), object->mAttribute_mListmapTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3163))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3163)) ;
  {
  ...
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3165))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3165)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3165))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3165)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3165)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_128610 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_128610.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_128610.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3180))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3180)), enumerator_128610.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3180))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3180)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3180)) ;
    }
    enumerator_128610.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_uniqueMapDeclarationAST * object = (const cPtr_uniqueMapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_uniqueMapDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3193))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3193)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3193))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3193)) ;
  {
  ...
  cEnumerator_attributeInCollectionListAST enumerator_129471 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_129471.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_129471.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3196))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3196)), enumerator_129471.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3196))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3196)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3196)) ;
    }
...
static void categoryMethod_mapProxyDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapProxyDeclarationAST * object = (const cPtr_mapProxyDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_mapProxyDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3209))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3209)), object->mAttribute_mMapProxyTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3209))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3209)) ;
  {
  const GALGAS_mapProxyDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3210)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedMapTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3211))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3211)), object->mAttribute_mAssociatedMapTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3211))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3211)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3211)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_graphDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_graphDeclarationAST * object = (const cPtr_graphDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_graphDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mGraphTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3223))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3223)), object->mAttribute_mGraphTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3223))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3223)) ;
  {
  const GALGAS_graphDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3224)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3225))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3225)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3225))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3225)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3225)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externTypeDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externTypeDeclarationAST * object = (const cPtr_externTypeDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_externTypeDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mExternTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3237))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3237)), object->mAttribute_mExternTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3237))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3237)) ;
  {
  const GALGAS_externTypeDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3238)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryReaderAST * object = (const cPtr_categoryReaderAST *) inObject ;
  macroValidSharedObject (object, cPtr_categoryReaderAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3358))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3358)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3358)).operator_concat (object->mAttribute_mCategoryReaderName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3358))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3358)), object->mAttribute_mCategoryReaderName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3358))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3358)) ;
  {
  const GALGAS_categoryReaderAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3359)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3360))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3360)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3360))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3360)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3360)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3362)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3362)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 3362)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3365)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3363)) ;
    }
  }
  cMapElement_categoryReaderMapForBuildingContext * objectArray_138568 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryReaderMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3368)) ;
  if (NULL != objectArray_138568) {
      macroValidSharedObject (objectArray_138568, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_138568->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3369)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryMethodAST * object = (const cPtr_categoryMethodAST *) inObject ;
  macroValidSharedObject (object, cPtr_categoryMethodAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3386))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3386)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3386)).operator_concat (object->mAttribute_mCategoryMethodName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3386))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3386)), object->mAttribute_mCategoryMethodName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3386))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3386)) ;
  {
  const GALGAS_categoryMethodAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3387)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3388))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3388)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3388))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3388)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3388)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3390)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3390)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 3390)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3393)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3391)) ;
    }
  }
  cMapElement_categoryMethodMapForBuildingContext * objectArray_139873 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryMethodMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3396)) ;
  if (NULL != objectArray_139873) {
      macroValidSharedObject (objectArray_139873, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_139873->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3397)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryModifierAST * object = (const cPtr_categoryModifierAST *) inObject ;
  macroValidSharedObject (object, cPtr_categoryModifierAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3413))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3413)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3413)).operator_concat (object->mAttribute_mCategoryModifierName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3413))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3413)), object->mAttribute_mCategoryModifierName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3413))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3413)) ;
  {
  ...
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3417)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3417)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 3417)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3420)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3418)) ;
    }
  }
  cMapElement_categoryModifierMapForBuildingContext * objectArray_141148 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryModifierMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3423)) ;
  if (NULL != objectArray_141148) {
      macroValidSharedObject (objectArray_141148, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_141148->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3424)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3440)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryReaderAST * object = (const cPtr_abstractCategoryReaderAST *) inObject ;
  macroValidSharedObject (object, cPtr_abstractCategoryReaderAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3452))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3452)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3452)).operator_concat (object->mAttribute_mAbstractCategoryReaderName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3452))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3452)), object->mAttribute_mAbstractCategoryReaderName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3452))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3452)) ;
  {
  ...
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3454))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3454)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3454))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3454)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3454)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3456)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3456)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 3456)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3459)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3457)) ;
    }
  }
  cMapElement_categoryReaderMapForBuildingContext * objectArray_143052 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryReaderMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3462)) ;
  if (NULL != objectArray_143052) {
      macroValidSharedObject (objectArray_143052, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_143052->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3463)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryMethodAST * object = (const cPtr_abstractCategoryMethodAST *) inObject ;
  macroValidSharedObject (object, cPtr_abstractCategoryMethodAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3480))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3480)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3480)).operator_concat (object->mAttribute_mAbstractCategoryMethodName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3480))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3480)), object->mAttribute_mAbstractCategoryMethodName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3480))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3480)) ;
  {
  const GALGAS_abstractCategoryMethodAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3481)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3482))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3482)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3482))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3482)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3482)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3484)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3484)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 3484)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3487)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3485)) ;
    }
  }
  cMapElement_categoryMethodMapForBuildingContext * objectArray_144405 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryMethodMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3490)) ;
  if (NULL != objectArray_144405) {
      macroValidSharedObject (objectArray_144405, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_144405->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3491)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryModifierAST * object = (const cPtr_abstractCategoryModifierAST *) inObject ;
  macroValidSharedObject (object, cPtr_abstractCategoryModifierAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3507))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3507)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3507)).operator_concat (object->mAttribute_mAbstractCategoryModifierName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3507))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3507)), object->mAttribute_mAbstractCategoryModifierName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3507))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3507)) ;
  {
  const GALGAS_abstractCategoryModifierAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3508)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3509))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3509)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3509))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3509)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3509)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3511)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3511)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 3511)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3514)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3512)) ;
    }
  }
  cMapElement_categoryModifierMapForBuildingContext * objectArray_145720 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryModifierMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3517)) ;
  if (NULL != objectArray_145720) {
      macroValidSharedObject (objectArray_145720, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_145720->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3518)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapDeclarationAST * object = (const cPtr_mapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_mapDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3537)) ;
  var_structAttributeList.addAssign_operation (GALGAS_string ("lstring").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 3539)), GALGAS_string ("lkey").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 3540)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3541))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3538)) ;
  cEnumerator_attributeInCollectionListAST enumerator_146559 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_146559.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_146559.current_mAttributeTypeName (HERE), enumerator_146559.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3547))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3544)) ;
    enumerator_146559.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mMapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3552))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3552)), object->mAttribute_mMapTypeName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3552)), var_structAttributeList, GALGAS_string::makeEmptyString ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3550))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3550)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_147202 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_147202.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_147202.current_mAttributeTypeName (HERE), enumerator_147202.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3568))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3565)) ;
    enumerator_147202.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3573))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3573)), object->mAttribute_mListTypeName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3573)), var_structAttributeList, GALGAS_string::makeEmptyString ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3571))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3571)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_147853 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_147853.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_147853.current_mAttributeTypeName (HERE), enumerator_147853.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3589))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3586)) ;
    enumerator_147853.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mSortedListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3594))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3594)), object->mAttribute_mSortedListTypeName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3594)), var_structAttributeList, GALGAS_string::makeEmptyString ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3592))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3592)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listmapDeclarationAST * object = (const cPtr_listmapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listmapDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3605)) ;
  var_structAttributeList.addAssign_operation (GALGAS_string ("string").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 3607)), GALGAS_string ("key").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 3608)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3609))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3606)) ;
  var_structAttributeList.addAssign_operation (object->mAttribute_mAssociatedListTypeName, GALGAS_string ("mList").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 3613)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3614))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3611)) ;
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3619))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3619)), object->mAttribute_mListmapTypeName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3619)), var_structAttributeList, GALGAS_string::makeEmptyString ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3617))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3617)) ;
}
//-----------------------------------------------------------------------------*
