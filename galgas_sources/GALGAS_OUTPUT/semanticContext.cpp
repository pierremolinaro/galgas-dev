...
void routine_addCategories (const GALGAS_categoryMethodMapForBuildingContext constinArgument_inCategoryMethodMapForBuildingContext,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_categoryMethodMapForType enumerator_19732 (var_categoryMethodMapForType, kEnumeration_up) ;
    while (enumerator_19732.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_19835 (enumerator_19732.current_mFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_19835.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_19835.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (498)) ;
        }
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_19835.current_mFormalArgumentPassingMode (HERE), enumerator_19835.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (503)) ;
        enumerator_19835.gotoNextObject () ;
      }
      {
      ioArgument_ioInstanceMethodMap.modifier_insertKey (enumerator_19732.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE_AT_LINE (507)), var_formalArgumentList, enumerator_19732.current_lkey (HERE).reader_location (SOURCE_FILE_AT_LINE (509)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (511)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (505)) ;
      }
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_categoryReaderMapForType enumerator_20705 (var_categoryReaderMapForType, kEnumeration_up) ;
    while (enumerator_20705.hasCurrentObject ()) {
      ...
      cEnumerator_formalInputParameterListAST enumerator_20824 (enumerator_20705.current_mInputFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_20824.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_20824.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (524)) ;
        }
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_20824.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (525)) ;
        enumerator_20824.gotoNextObject () ;
      }
      GALGAS_unifiedTypeMapProxy var_returnedType ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_20705.current_mResultTypeName (HERE), var_returnedType COMMA_SOURCE_FILE_AT_LINE (528)) ;
      }
      {
      ioArgument_ioReaderMap.modifier_insertKey (enumerator_20705.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE_AT_LINE (531)), var_formalArgumentList, enumerator_20705.current_lkey (HERE).reader_location (SOURCE_FILE_AT_LINE (533)), GALGAS_bool (true), var_returnedType, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (536)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (529)) ;
      }
  ...
  if (kBoolTrue == test_2) {
    ...
    cEnumerator_categoryModifierMapForType enumerator_21818 (var_categoryModifierMapForType, kEnumeration_up) ;
    while (enumerator_21818.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_21921 (enumerator_21818.current_mFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_21921.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_21921.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (549)) ;
        }
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_21921.current_mFormalArgumentPassingMode (HERE), enumerator_21921.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (550)) ;
        enumerator_21921.gotoNextObject () ;
      }
      {
      ioArgument_ioModifierMap.modifier_insertKey (enumerator_21818.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE_AT_LINE (554)), var_formalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (557)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (552)) ;
      }
      enumerator_21818.gotoNextObject () ;
    }
  }
}
...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_76063 (var_files, kEnumeration_up) ;
  while (enumerator_76063.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_76063.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1872)) COMMA_SOURCE_FILE_AT_LINE (1872)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1873)).operator_concat (enumerator_76063.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1873)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76063.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1875)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1874)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1881)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_76063.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1882)) COMMA_SOURCE_FILE_AT_LINE (1882)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1883)).operator_concat (enumerator_76063.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1883)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76063.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1885)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1884)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1891)) ;
      }
    }
    enumerator_76063.gotoNextObject () ;
  }
  ...
  cEnumerator_stringlist enumerator_77028 (var_directories, kEnumeration_up) ;
  while (enumerator_77028.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1902)).operator_concat (enumerator_77028.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1902)), constinArgument_inPathInWrapper.operator_concat (enumerator_77028.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1903)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1903)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1901)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_77028.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1912)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1911)) ;
    }
    enumerator_77028.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147045 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147045.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_147045.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3573)) ;
    enumerator_147045.gotoNextObject () ;
  }
  GALGAS_semanticTypePrecedenceGraph var_semanticTypePrecedenceGraph = GALGAS_semanticTypePrecedenceGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (3579)) ;
  GALGAS_categoryMethodMapForBuildingContext var_categoryMethodMapForBuildingContext = GALGAS_categoryMethodMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3580)) ;
  GALGAS_categoryReaderMapForBuildingContext var_categoryReaderMapForBuildingContext = GALGAS_categoryReaderMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3581)) ;
  GALGAS_categoryModifierMapForBuildingContext var_categoryModifierMapForBuildingContext = GALGAS_categoryModifierMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3582)) ;
  GALGAS_semanticDeclarationListAST var_categoryOverrideDefinitionList = GALGAS_semanticDeclarationListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3583)) ;
  cEnumerator_semanticDeclarationListAST enumerator_147778 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147778.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_147778.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3585)) ;
    enumerator_147778.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (3593)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_148198 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3594)), kEnumeration_up) ;
    while (enumerator_148198.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_148198.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_148198.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3595)) COMMA_SOURCE_FILE_AT_LINE (3595)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3595)) COMMA_SOURCE_FILE_AT_LINE (3595)) ;
      enumerator_148198.gotoNextObject () ;
    }
    inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("semantic analysis not performed, due to undefined type error(s)") COMMA_SOURCE_FILE_AT_LINE (3597)) ;
    ...
    GALGAS_lstringlist joker_148536_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_148536_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3599)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_149119 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149119.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_149119.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3613)) COMMA_SOURCE_FILE_AT_LINE (3613)) COMMA_SOURCE_FILE_AT_LINE (3613)) ;
        enumerator_149119.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_149927 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149927.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_149927.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3633)) ;
        enumerator_149927.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_35802 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_35802.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_35802.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (846)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_35802.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (849)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_35802.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (850)) COMMA_SOURCE_FILE_AT_LINE (850)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (851)), enumerator_35802.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (851)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (852)), enumerator_35802.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (852)) ;
    enumerator_35802.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_36520 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_36520.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_36520.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (856)) COMMA_SOURCE_FILE_AT_LINE (856)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_36520.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_36520.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (857)) COMMA_SOURCE_FILE_AT_LINE (857)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (857)) COMMA_SOURCE_FILE_AT_LINE (857)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_36520.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (861)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (864)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (859)) ;
      }
    }
    enumerator_36520.gotoNextObject () ;
  }
  cEnumerator_mapRemoveMethodListAST enumerator_36994 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  while (enumerator_36994.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_modifierMap.reader_hasKey (enumerator_36994.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (871)) COMMA_SOURCE_FILE_AT_LINE (871)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_36994.current_mMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_36994.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (872)) COMMA_SOURCE_FILE_AT_LINE (872)).operator_concat (GALGAS_string ("' method is already declared as an insert modifier or a remove modifier") COMMA_SOURCE_FILE_AT_LINE (872)) COMMA_SOURCE_FILE_AT_LINE (872)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_36994.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (876)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (879)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (874)) ;
      }
    }
    enumerator_36994.gotoNextObject () ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_37521 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_37521.hasCurrentObject ()) {
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_37521.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (888)), var_removeMethodFormalArgumentList, enumerator_37521.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (890)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (892)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (886)) ;
    }
    enumerator_37521.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_37856 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_37856.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_37856.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (898)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (898)), enumerator_37856.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (898)) COMMA_SOURCE_FILE_AT_LINE (898)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_37856.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (900)) ;
    }
    {
    ...
    enumerator_37856.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_39003 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_39003.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_39003.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (927)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (927)) COMMA_SOURCE_FILE_AT_LINE (927)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (927)), enumerator_39003.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (927)) COMMA_SOURCE_FILE_AT_LINE (927)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_39003.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (929)) ;
    }
    ...
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (931)), enumerator_39003.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (931)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (932)), enumerator_39003.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (932)) ;
    {
    ...
    enumerator_39003.gotoNextObject () ;
  }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_40056 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_40056.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_40056.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (946)) ;
    }
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_44876 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_44876.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_44876.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1049)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_44876.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1052)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_44876.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1053)) COMMA_SOURCE_FILE_AT_LINE (1053)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1054)), enumerator_44876.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1054)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1055)), enumerator_44876.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1055)) ;
    enumerator_44876.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_45610 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_45610.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_45610.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1059)) COMMA_SOURCE_FILE_AT_LINE (1059)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_45610.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_45610.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1060)) COMMA_SOURCE_FILE_AT_LINE (1060)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (1060)) COMMA_SOURCE_FILE_AT_LINE (1060)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_45610.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1064)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1067)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1062)) ;
      }
    }
    enumerator_45610.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_47355 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_47355.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_47355.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1102)), var_removeMethodFormalArgumentList, enumerator_47355.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (1104)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1106)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1100)) ;
      }
      enumerator_47355.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_47685 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_47685.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_47685.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1114)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1117)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1112)) ;
      }
      enumerator_47685.gotoNextObject () ;
    }
  }
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_mapOverrideBlockListAST enumerator_49495 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    while (enumerator_49495.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_49495.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1161)) COMMA_SOURCE_FILE_AT_LINE (1161)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1161)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1162)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1163)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1165)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1160)) ;
      }
      enumerator_49495.gotoNextObject () ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_49904 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_49904.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_49904.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1172)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1172)), enumerator_49904.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1172)) COMMA_SOURCE_FILE_AT_LINE (1172)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_49904.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1174)) ;
    }
    {
  ...
  cEnumerator_attributeInCollectionListAST enumerator_50561 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_50561.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_50561.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1188)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1188)) COMMA_SOURCE_FILE_AT_LINE (1188)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1188)), enumerator_50561.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1188)) COMMA_SOURCE_FILE_AT_LINE (1188)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_50561.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1190)) ;
    }
    ...
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1192)), enumerator_50561.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1192)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1193)), enumerator_50561.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1193)) ;
    {
    ...
    enumerator_50561.gotoNextObject () ;
  }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_51614 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_51614.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_51614.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1207)) ;
    }
    enumerator_51614.gotoNextObject () ;
  }
  {
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_53370_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_53370_1 ; // Joker input parameter
  GALGAS_typedAttributeList joker_53410_2 ; // Joker input parameter
  GALGAS_attributeMap joker_53410_1 ; // Joker input parameter
  GALGAS_constructorMap joker_53465_11 ; // Joker input parameter
  GALGAS_readerMap joker_53465_10 ; // Joker input parameter
  GALGAS_modifierMap joker_53465_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_53465_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_53465_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_53465_6 ; // Joker input parameter
  GALGAS_stringlist joker_53465_5 ; // Joker input parameter
  GALGAS_uint joker_53465_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_53465_3 ; // Joker input parameter
  GALGAS_stringset joker_53465_2 ; // Joker input parameter
  GALGAS_lstringlist joker_53465_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_53520_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_53520_4 ; // Joker input parameter
  GALGAS_bool joker_53520_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_53520_2 ; // Joker input parameter
  GALGAS_string joker_53520_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_53370_2, joker_53370_1, var_typeKindEnum, joker_53410_2, joker_53410_1, var_mapTypedAttributeList, joker_53465_11, joker_53465_10, joker_53465_9, joker_53465_8, joker_53465_7, joker_53465_6, joker_53465_5, joker_53465_4, joker_53465_3, joker_53465_2, joker_53465_1, var_searchMethodList, joker_53520_5, joker_53520_4, joker_53520_3, joker_53520_2, joker_53520_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1261)) ;
  ...
  cEnumerator_mapSearchMethodListAST enumerator_56128 (var_searchMethodList, kEnumeration_up) ;
  while (enumerator_56128.hasCurrentObject ()) {
    {
    var_constructorMap.modifier_insertKey (enumerator_56128.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1320)) ;
    }
  ...
  cEnumerator_typedAttributeList enumerator_57099 (var_mapTypedAttributeList, kEnumeration_up) ;
  while (enumerator_57099.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_57099.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1337)) COMMA_SOURCE_FILE_AT_LINE (1337)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_57233 (var_inheritedReaderMap.reader_keySet (SOURCE_FILE_AT_LINE (1339)), kEnumeration_up) ;
      while (enumerator_57233.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_57233.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (1340)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1340)) COMMA_SOURCE_FILE_AT_LINE (1340)) ;
        if (enumerator_57233.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (1341)) ;
        }
        enumerator_57233.gotoNextObject () ;
      }
      GALGAS_location location_3 (enumerator_57099.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      {
      var_readerMap.modifier_insertKey (enumerator_57099.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1348)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1349)), inCompiler->here (), GALGAS_bool (true), enumerator_57099.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1353)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1346)) ;
      }
    }
    enumerator_57099.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externTypeDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_externTypeConstructorList enumerator_59753 (object->mAttribute_mExternTypeConstructorList, kEnumeration_up) ;
  while (enumerator_59753.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59753.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1415)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_60005 (enumerator_59753.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_60005.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60005.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1420)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_60005.current_mFormalParameterName (HERE) COMMA_SOURCE_FILE_AT_LINE (1421)) ;
      enumerator_60005.gotoNextObject () ;
    }
    {
    var_constructorMap.modifier_insertKey (enumerator_59753.current_mConstructorName (HERE), var_arguments, GALGAS_bool (true), var_returnedTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1424)) ;
    }
    enumerator_59753.gotoNextObject () ;
  }
  cEnumerator_externTypeReaderList enumerator_60471 (object->mAttribute_mExternTypeReaderList, kEnumeration_up) ;
  while (enumerator_60471.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60471.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1434)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_60723 (enumerator_60471.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_60723.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60723.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1439)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_60723.current_mFormalParameterName (HERE) COMMA_SOURCE_FILE_AT_LINE (1440)) ;
      enumerator_60723.gotoNextObject () ;
    }
    {
    var_readerMap.modifier_insertKey (enumerator_60471.current_mReaderName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1445)), var_arguments, inCompiler->here (), GALGAS_bool (true), var_returnedTypeProxy, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1450)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1443)) ;
    }
    enumerator_60471.gotoNextObject () ;
  }
  cEnumerator_externTypeModifierList enumerator_61300 (object->mAttribute_mExternTypeModifierList, kEnumeration_up) ;
  while (enumerator_61300.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_61397 (enumerator_61300.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_61397.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61397.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1458)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_61397.current_mFormalArgumentPassingMode (HERE), enumerator_61397.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1463)) ;
      enumerator_61397.gotoNextObject () ;
    }
    {
    var_modifierMap.modifier_insertKey (enumerator_61300.current_mModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1468)), var_routineSignature, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1471)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1466)) ;
    }
    enumerator_61300.gotoNextObject () ;
  }
  cEnumerator_externTypeMethodList enumerator_61993 (object->mAttribute_mExternTypeMethodList, kEnumeration_up) ;
  while (enumerator_61993.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_62090 (enumerator_61993.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_62090.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_62090.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1480)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_62090.current_mFormalArgumentPassingMode (HERE), enumerator_62090.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1485)) ;
      enumerator_62090.gotoNextObject () ;
    }
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_61993.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1490)), var_routineSignature, enumerator_61993.current_mDeclarationLocation (HERE), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1494)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1488)) ;
    }
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_69331 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE_AT_LINE (1682)), kEnumeration_up) ;
  while (enumerator_69331.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (enumerator_69331.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1683)), enumerator_69331.current_mFormalParameterName (HERE) COMMA_SOURCE_FILE_AT_LINE (1683)) ;
    enumerator_69331.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_69482 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_69482.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_69482.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1688)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1691)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1686)) ;
    }
    enumerator_69482.gotoNextObject () ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_73657 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_73657.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_73657.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1802)) COMMA_SOURCE_FILE_AT_LINE (1802)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_73657.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1803)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1803)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1803)) ;
    }
    enumerator_73657.gotoNextObject () ;
  }
  GALGAS_readerMap var_readerMap ;
  {
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_filewrapperTemplateListAST enumerator_78262 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_78262.hasCurrentObject ()) {
    ...
    cEnumerator_formalTemplateInputParameterListAST enumerator_78380 (enumerator_78262.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_78380.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_78380.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1934)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1935)) ;
      enumerator_78380.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_78262.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_78262.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1937)) ;
    }
    enumerator_78262.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_textExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1944)) ;
  cEnumerator_lstringlist enumerator_78899 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_78899.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_78899.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1946)) ;
    }
  ...
  cEnumerator_lstringlist enumerator_79105 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_79105.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_79105.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1951)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_79105.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_79105.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1952)) COMMA_SOURCE_FILE_AT_LINE (1952)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1952)) COMMA_SOURCE_FILE_AT_LINE (1952)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_79105.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1954)) ;
      }
    }
    enumerator_79105.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_81055 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_81055.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_81055.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2007)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_81299 (enumerator_81055.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_81299.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_81299.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_81299.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_81299.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_81055.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2017)) ;
    enumerator_81055.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_82243 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_82243.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_82243.current_mAttributeTypeProxy (HERE), enumerator_82243.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2031)) COMMA_SOURCE_FILE_AT_LINE (2031)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_82243.current_mAttributeTypeProxy (HERE), enumerator_82243.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2032)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_82243.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2033)), enumerator_82243.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2033)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_82243.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2034)), enumerator_82243.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2034)) ;
    enumerator_82243.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_83652 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_83652.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_83652.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_83652.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2054)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2054)), enumerator_83652.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2054)) COMMA_SOURCE_FILE_AT_LINE (2054)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2055)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_listWithValue (var_uintType, GALGAS_string ("inIndex") COMMA_SOURCE_FILE_AT_LINE (2056)), inCompiler->here (), GALGAS_bool (true), enumerator_83652.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2060)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2053)) ;
      }
    }
    enumerator_83652.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_85476 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_85476.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_85476.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      ...
      var_setterFormalArgumentList.addAssign_operation (enumerator_85476.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2116)), enumerator_85476.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2116)) ;
      var_setterFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2117)), enumerator_85476.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2117)) ;
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_85476.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2119)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2119)) COMMA_SOURCE_FILE_AT_LINE (2119)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2119)), enumerator_85476.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2119)) COMMA_SOURCE_FILE_AT_LINE (2119)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2120)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2123)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2118)) ;
      }
    }
    enumerator_85476.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_89276 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_89276.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_89276.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2210)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_89276.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2213)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_89276.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2214)) ;
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_89276.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2215)) ;
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2216)), enumerator_89276.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2216)) ;
    enumerator_89276.gotoNextObject () ;
  }
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_93931 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_93931.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_93931.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2337)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_93931.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2338)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_93931.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2341)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_93931.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2342)) ;
    }
  ...
  cEnumerator_typedAttributeList enumerator_94677 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_94677.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_94677.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2359)), enumerator_94677.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2360)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2356)) ;
    }
    enumerator_94677.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_95859 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_95859.hasCurrentObject () && bool_1) {
    while (enumerator_95859.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_95859.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2394)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_95859.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2394)).operator_not (SOURCE_FILE_AT_LINE (2394)) COMMA_SOURCE_FILE_AT_LINE (2394)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_95859.gotoNextObject () ;
      if (enumerator_95859.hasCurrentObject ()) {
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_98271 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_98271.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_98271.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2455)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
    ...
    GALGAS_bool joker_98750_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_98750_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_98835_2 ; // Joker input parameter
    GALGAS_constructorMap joker_98835_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_98925_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_98925_9 ; // Joker input parameter
    GALGAS_stringlist joker_98925_8 ; // Joker input parameter
    GALGAS_uint joker_98925_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_98925_6 ; // Joker input parameter
    GALGAS_stringset joker_98925_5 ; // Joker input parameter
    GALGAS_lstringlist joker_98925_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_98925_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_98925_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_98925_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_98972_2 ; // Joker input parameter
    GALGAS_string joker_98972_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_98750_2, joker_98750_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_98835_2, joker_98835_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_98925_10, joker_98925_9, joker_98925_8, joker_98925_7, joker_98925_6, joker_98925_5, joker_98925_4, joker_98925_3, joker_98925_2, joker_98925_1, var_generateHeaderInSeparateFile, joker_98972_2, joker_98972_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2465)) ;
    ...
    cEnumerator_modifierMap enumerator_99259 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_99259.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_99259.current_lkey (HERE), enumerator_99259.current_mKind (HERE), enumerator_99259.current_mParameterList (HERE), enumerator_99259.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2491)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2486)) ;
      }
      enumerator_99259.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2496)) ;
    cEnumerator_readerMap enumerator_99585 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_99585.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_99585.current_lkey (HERE), enumerator_99585.current_mKind (HERE), enumerator_99585.current_mArgumentTypeList (HERE), enumerator_99585.current_mDeclarationLocation (HERE), enumerator_99585.current_mHasCompilerArgument (HERE), enumerator_99585.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2505)), enumerator_99585.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2498)) ;
      }
      enumerator_99585.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2510)) ;
    cEnumerator_instanceMethodMap enumerator_99973 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_99973.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_99973.current_lkey (HERE), enumerator_99973.current_mKind (HERE), enumerator_99973.current_mParameterList (HERE), enumerator_99973.current_mDeclarationLocation (HERE), enumerator_99973.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2518)), enumerator_99973.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2512)) ;
      }
      enumerator_99973.gotoNextObject () ;
    }
  }
  ...
  cEnumerator_typedAttributeList enumerator_100404 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_100404.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_100404.current_mAttributeTypeProxy (HERE), enumerator_100404.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2526)) ;
    enumerator_100404.gotoNextObject () ;
  }
  ...
  while (enumerator_100531.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_100531.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2530)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_100531.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2531)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_100531.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2532)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_100531.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2533)) COMMA_SOURCE_FILE_AT_LINE (2533)).boolEnum () ;
    if (kBoolTrue == test_4) {
      ...
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_100531.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2534)) COMMA_SOURCE_FILE_AT_LINE (2534)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader") COMMA_SOURCE_FILE_AT_LINE (2534)) COMMA_SOURCE_FILE_AT_LINE (2534)) ;
    }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_101631 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_101631.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_101631.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2558)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_101875 (enumerator_101631.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_101875.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_101875.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2562)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_101875.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2564)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_101875.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_101631.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2568)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_101631.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2569)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_101631.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2573)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2574)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2578)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2571)) ;
      }
    }
    enumerator_101631.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_102943 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_102943.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_102943.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_102943.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2593)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2593)) COMMA_SOURCE_FILE_AT_LINE (2593)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2593)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2594)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_102943.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2595)), enumerator_102943.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2595)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2597)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2592)) ;
      }
    }
    enumerator_102943.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_103985 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_103985.hasCurrentObject () && bool_12) {
    while (enumerator_103985.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_103985.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2621)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_103985.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2621)).operator_not (SOURCE_FILE_AT_LINE (2621)) COMMA_SOURCE_FILE_AT_LINE (2621)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_103985.gotoNextObject () ;
      if (enumerator_103985.hasCurrentObject ()) {
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_105648 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_105648.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_105648.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2666)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_105648.current_mFormalArgumentPassingMode (HERE), enumerator_105648.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2667)) ;
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_106656 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_106656.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_106656.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2685)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2686)) ;
    enumerator_106656.gotoNextObject () ;
  }
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2741)).isValid ()) {
    uint32_t variant_109413 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2741)).uintValue () ;
    bool loop_109413 = true ;
    while (loop_109413) {
      loop_109413 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2741)))).isValid () ;
      if (loop_109413) {
        loop_109413 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2741)))).boolValue () ;
      }
      if (loop_109413 && (0 == variant_109413)) {
        loop_109413 = false ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2780)).isValid ()) {
    uint32_t variant_110725 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2780)).uintValue () ;
    bool loop_110725 = true ;
    while (loop_110725) {
      loop_110725 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2780)))).isValid () ;
      if (loop_110725) {
        loop_110725 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2780)))).boolValue () ;
      }
      if (loop_110725 && (0 == variant_110725)) {
        loop_110725 = false ;
  ...
  {
  GALGAS_unifiedTypeMapProxy joker_111340_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_111340_2 ; // Joker input parameter
  GALGAS_string joker_111340_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_111340_3, joker_111340_2, joker_111340_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2800)) ;
  }
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_113762_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_113762_1 ; // Joker input parameter
  GALGAS_attributeMap joker_113850_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_113850_18 ; // Joker input parameter
  GALGAS_constructorMap joker_113850_17 ; // Joker input parameter
  GALGAS_readerMap joker_113850_16 ; // Joker input parameter
  GALGAS_modifierMap joker_113850_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_113850_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_113850_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_113850_12 ; // Joker input parameter
  GALGAS_stringlist joker_113850_11 ; // Joker input parameter
  GALGAS_uint joker_113850_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_113850_9 ; // Joker input parameter
  GALGAS_stringset joker_113850_8 ; // Joker input parameter
  GALGAS_lstringlist joker_113850_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_113850_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_113850_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_113850_4 ; // Joker input parameter
  GALGAS_bool joker_113850_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_113850_2 ; // Joker input parameter
  GALGAS_string joker_113850_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_113762_2, joker_113762_1, var_typeKindEnum, var_listTypedAttributeList, joker_113850_19, joker_113850_18, joker_113850_17, joker_113850_16, joker_113850_15, joker_113850_14, joker_113850_13, joker_113850_12, joker_113850_11, joker_113850_10, joker_113850_9, joker_113850_8, joker_113850_7, joker_113850_6, joker_113850_5, joker_113850_4, joker_113850_3, joker_113850_2, joker_113850_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2867)) ;
  ...
  cEnumerator_typedAttributeList enumerator_115921 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_115921.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_115921.current_mAttributeTypeProxy (HERE), enumerator_115921.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2907)) ;
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_120183 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_120183.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_120183.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3008)) COMMA_SOURCE_FILE_AT_LINE (3008)), enumerator_120183.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3008)) COMMA_SOURCE_FILE_AT_LINE (3008)) COMMA_SOURCE_FILE_AT_LINE (3008)) ;
    }
    enumerator_120183.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121045 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121045.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121045.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3024)) COMMA_SOURCE_FILE_AT_LINE (3024)), enumerator_121045.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3024)) COMMA_SOURCE_FILE_AT_LINE (3024)) COMMA_SOURCE_FILE_AT_LINE (3024)) ;
    }
    enumerator_121045.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121909 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121909.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121909.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3040)) COMMA_SOURCE_FILE_AT_LINE (3040)), enumerator_121909.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3040)) COMMA_SOURCE_FILE_AT_LINE (3040)) COMMA_SOURCE_FILE_AT_LINE (3040)) ;
    }
    enumerator_121909.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_123481 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123481.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123481.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3069)) COMMA_SOURCE_FILE_AT_LINE (3069)), enumerator_123481.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3069)) COMMA_SOURCE_FILE_AT_LINE (3069)) COMMA_SOURCE_FILE_AT_LINE (3069)) ;
    }
    enumerator_123481.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_125986 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_125986.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_125986.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3113)) COMMA_SOURCE_FILE_AT_LINE (3113)), enumerator_125986.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3113)) COMMA_SOURCE_FILE_AT_LINE (3113)) COMMA_SOURCE_FILE_AT_LINE (3113)) ;
    }
    enumerator_125986.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_126847 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126847.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126847.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3129)) COMMA_SOURCE_FILE_AT_LINE (3129)), enumerator_126847.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3129)) COMMA_SOURCE_FILE_AT_LINE (3129)) COMMA_SOURCE_FILE_AT_LINE (3129)) ;
    }
    enumerator_126847.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_135944 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3301)) ;
  if (NULL != objectArray_135944) {
      macroValidSharedObject (objectArray_135944, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_135944->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3302)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_137249 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3329)) ;
  if (NULL != objectArray_137249) {
      macroValidSharedObject (objectArray_137249, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_137249->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3330)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_138524 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3356)) ;
  if (NULL != objectArray_138524) {
      macroValidSharedObject (objectArray_138524, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_138524->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3357)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_140428 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3395)) ;
  if (NULL != objectArray_140428) {
      macroValidSharedObject (objectArray_140428, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_140428->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3396)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_141781 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3423)) ;
  if (NULL != objectArray_141781) {
      macroValidSharedObject (objectArray_141781, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_141781->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3424)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_143096 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3450)) ;
  if (NULL != objectArray_143096) {
      macroValidSharedObject (objectArray_143096, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_143096->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3451)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_143935 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_143935.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_143935.current_mAttributeTypeName (HERE), enumerator_143935.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3480)) COMMA_SOURCE_FILE_AT_LINE (3477)) ;
    enumerator_143935.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mMapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3485)) COMMA_SOURCE_FILE_AT_LINE (3485)), object->mAttribute_mMapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3485)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3483)) COMMA_SOURCE_FILE_AT_LINE (3483)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3496)) ;
  cEnumerator_attributeInCollectionListAST enumerator_144569 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_144569.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_144569.current_mAttributeTypeName (HERE), enumerator_144569.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3501)) COMMA_SOURCE_FILE_AT_LINE (3498)) ;
    enumerator_144569.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3506)) COMMA_SOURCE_FILE_AT_LINE (3506)), object->mAttribute_mListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3506)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3504)) COMMA_SOURCE_FILE_AT_LINE (3504)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_sortedListDeclarationAST * object = (const cPtr_sortedListDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_sortedListDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3517)) ;
  cEnumerator_attributeInCollectionListAST enumerator_145211 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145211.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145211.current_mAttributeTypeName (HERE), enumerator_145211.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3522)) COMMA_SOURCE_FILE_AT_LINE (3519)) ;
    enumerator_145211.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mSortedListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3527)) COMMA_SOURCE_FILE_AT_LINE (3527)), object->mAttribute_mSortedListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3527)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3525)) COMMA_SOURCE_FILE_AT_LINE (3525)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listmapDeclarationAST * object = (const cPtr_listmapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listmapDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3538)) ;
  var_structAttributeList.addAssign_operation (GALGAS_string ("string").reader_nowhere (SOURCE_FILE_AT_LINE (3540)), GALGAS_string ("key").reader_nowhere (SOURCE_FILE_AT_LINE (3541)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3542)) COMMA_SOURCE_FILE_AT_LINE (3539)) ;
  var_structAttributeList.addAssign_operation (object->mAttribute_mAssociatedListTypeName, GALGAS_string ("mList").reader_nowhere (SOURCE_FILE_AT_LINE (3546)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3547)) COMMA_SOURCE_FILE_AT_LINE (3544)) ;
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3552)) COMMA_SOURCE_FILE_AT_LINE (3552)), object->mAttribute_mListmapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3552)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3550)) COMMA_SOURCE_FILE_AT_LINE (3550)) ;
}
//-----------------------------------------------------------------------------*
