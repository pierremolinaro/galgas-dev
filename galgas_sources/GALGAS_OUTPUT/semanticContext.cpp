...
category_method__classDeclarationAST__enterType (C_Compiler & inLexique,
  ...
  if (operand_45727 != NULL) {
    ...
    if (cond_46652.isBuiltAndTrue ()) {
      ...
      {
        GGS_readerMap::cEnumerator enumerator_47713 (var_cas_inheritedReaderMap, true) ;
        const GGS_readerMap::cElement * operand_47713 = NULL ;
        while (((operand_47713 = enumerator_47713.nextObject ()))) {
          macroValidPointer (operand_47713) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_47713->mKey, operand_47713->mInfo.mIsCategory, operand_47713->mInfo.mArgumentTypeList, operand_47713->mInfo.mHasCompilerArgument, operand_47713->mInfo.mReturnedType, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1169)) COMMA_SOURCE_FILE_AT_LINE (1163)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_48103 (var_cas_inheritedTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_48103 = NULL ;
      while (((operand_48103 = enumerator_48103.nextObject ()))) {
        macroValidPointer (operand_48103) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_48103->mAttributeTypeIndex) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_48206 (operand_45727->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_48206 = NULL ;
      while (((operand_48206 = enumerator_48206.nextObject ()))) {
        macroValidPointer (operand_48206) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_48206->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1180)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1180)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_48206->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1182)) ;
      }
    }
    ...
    const GGS_bool cond_48932 = (operand_45727->mIsAbstract).operator_not () ;
    if (cond_48932.isBuiltAndTrue ()) {
    ...
    {
      GGS_instanceMethodMap::cEnumerator enumerator_49063 (var_cas_inheritedInstanceMethodMap, true) ;
      const GGS_instanceMethodMap::cElement * operand_49063 = NULL ;
      while (((operand_49063 = enumerator_49063.nextObject ()))) {
        macroValidPointer (operand_49063) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_49063->mKey, GGS_bool (false), operand_49063->mInfo.mParameterList, operand_49063->mInfo.mDeclarationLocation, operand_49063->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1206)) COMMA_SOURCE_FILE_AT_LINE (1200)) ;
      }
    }
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_49359 (operand_45727->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_49359 = NULL ;
      while (((operand_49359 = enumerator_49359.nextObject ()))) {
        macroValidPointer (operand_49359) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_49448 (operand_49359->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_49448 = NULL ;
          while (((operand_49448 = enumerator_49448.nextObject ()))) {
            macroValidPointer (operand_49448) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_49448->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1214)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1214)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_49448->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_49729 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_49359->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1217))) ;
        if (NULL != operand_49729) {
          operand_49729->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1218)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_49359->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_49359->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1224)), GGS_bool (true), GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1226)) COMMA_SOURCE_FILE_AT_LINE (1220)) ;
        }
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_50146 (operand_45727->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_50146 = NULL ;
      while (((operand_50146 = enumerator_50146.nextObject ()))) {
        macroValidPointer (operand_50146) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_50235 (operand_50146->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_50235 = NULL ;
          while (((operand_50235 = enumerator_50235.nextObject ()))) {
            macroValidPointer (operand_50235) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_50235->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1235)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1235)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_50235->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_50516 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_50146->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1238))) ;
        if (NULL != operand_50516) {
          operand_50516->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverriding (inLexique COMMA_SOURCE_FILE_AT_LINE (1239)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_50146->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_50146->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1245)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1247)) COMMA_SOURCE_FILE_AT_LINE (1241)) ;
        }
      }
    }
    const GGS_bool cond_51732 = var_cas_inMultiMethodMapForBuildingContext.reader_hasKey (operand_45727->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1252))) ;
    if (cond_51732.isBuiltAndTrue ()) {
      ...
      {
        GGS_multiMethodMapForType::cEnumerator enumerator_51151 (var_cas_multiMethodMapForType, true) ;
        const GGS_multiMethodMapForType::cElement * operand_51151 = NULL ;
        while (((operand_51151 = enumerator_51151.nextObject ()))) {
          macroValidPointer (operand_51151) ;
          GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
          {
            GGS_formalParameterListAST::cEnumerator enumerator_51254 (operand_51151->mInfo.mFormalParameterList, true) ;
            const GGS_formalParameterListAST::cElement * operand_51254 = NULL ;
            while (((operand_51254 = enumerator_51254.nextObject ()))) {
              macroValidPointer (operand_51254) ;
              GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
              GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51254->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1259)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1259)) ;
              var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_51254->mFormalArgumentPassingMode) ;
            }
          }
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_51151->mKey, GGS_bool (true), var_cas_formalArgumentList, operand_51151->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1266)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1268)) COMMA_SOURCE_FILE_AT_LINE (1262)) ;
        }
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_51932 (operand_45727->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_51932 = NULL ;
      while (((operand_51932 = enumerator_51932.nextObject ()))) {
        macroValidPointer (operand_51932) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51932->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1277)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1277)) ;
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_51932->mAttributeName) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_51932->mAttributeName) ;
        var_cas_readerMap.modifier_insertKey (inLexique, operand_51932->mAttributeName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1286)) COMMA_SOURCE_FILE_AT_LINE (1280)) ;
      }
    }
    const GGS_bool cond_52966 = (operand_45727->mIsAbstract).operator_not () ;
    if (cond_52966.isBuiltAndTrue ()) {
      {
        GGS_typedAttributeList::cEnumerator enumerator_52617 (var_cas_allTypedAttributeList, true) ;
        const GGS_typedAttributeList::cElement * operand_52617 = NULL ;
        while (((operand_52617 = enumerator_52617.nextObject ()))) {
          macroValidPointer (operand_52617) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_52617->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1293)), GGS_formalParameterSignature ::constructor_listWithValue (operand_52617->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1294))), GGS_bool (false), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1296)) COMMA_SOURCE_FILE_AT_LINE (1292)) ;
        }
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_45727->mClassTypeName, (operand_45727->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1305)), var_cas_allTypedAttributeList, var_cas_attributeMap, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1313)), GGS_enumerationDescriptorList ::constructor_emptyList (), (function_generateCppConstructorWithAllAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1315))).operator_or (((operand_45727->mIsAbstract).isBuiltAndTrue () ? (GGS_uint (0U)) : (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1315))))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_currentClassTypedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1323)) COMMA_SOURCE_FILE_AT_LINE (1301)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_53946,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_53946 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_54212 (operand_53946->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_54212 = NULL ;
      while (((operand_54212 = enumerator_54212.nextObject ()))) {
        macroValidPointer (operand_54212) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54212->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1337)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1337)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_54212->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_53946->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1341)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_54745,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_54745 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_55012 (operand_54745->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_55012 = NULL ;
      while (((operand_55012 = enumerator_55012.nextObject ()))) {
        macroValidPointer (operand_55012) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_55012->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1354)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1354)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54745->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1359)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1359)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_54745->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1361)) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_55712,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_55712 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_55712->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1372)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1372)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_55712->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1374)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_56305,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_56305 != NULL) {
    ...
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_56770_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_56770_1 ;
    GGS_attributeMap  automatic_var_56770_2 ;
    GGS_typedAttributeList  automatic_var_56770_3 ;
    GGS_constructorMap  automatic_var_56770_4 ;
    GGS_readerMap  automatic_var_56770_5 ;
    GGS_modifierMap  automatic_var_56770_6 ;
    GGS_instanceMethodMap  automatic_var_56770_7 ;
    GGS_classMethodMap  automatic_var_56770_8 ;
    GGS_enumerationDescriptorList  automatic_var_56770_9 ;
    GGS_uint  automatic_var_56770_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_56770_11 ;
    GGS_nativeAttributeList  automatic_var_56770_12 ;
    GGS_stringset  automatic_var_56770_13 ;
    GGS_lstringlist  automatic_var_56770_14 ;
    GGS_typedAttributeList  automatic_var_56770_15 ;
    GGS_mapSearchMethodListAST  automatic_var_56770_16 ;
    GGS_mapSearchMethodListAST  automatic_var_56770_17 ;
    GGS_withAccessorMap  automatic_var_56770_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_56305->mAssociatedListTypeName, automatic_var_56770_0, automatic_var_56770_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_56770_2, automatic_var_56770_3, automatic_var_56770_4, automatic_var_56770_5, automatic_var_56770_6, automatic_var_56770_7, automatic_var_56770_8, automatic_var_56770_9, automatic_var_56770_10, automatic_var_56770_11, automatic_var_56770_12, automatic_var_56770_13, automatic_var_56770_14, automatic_var_56770_15, automatic_var_56770_16, automatic_var_56770_17, automatic_var_56770_18 COMMA_SOURCE_FILE_AT_LINE (1387)) ;
    }
    const GGS_bool cond_56999 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1394))) ;
    if (cond_56999.isBuiltAndTrue ()) {
      operand_56305->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_56305->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1396)) ;
      var_cas_listTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1399)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1400)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1401)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1402)) ;
    GGS_unifiedTypeMapProxy  var_cas_associatedListTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56305->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1405)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1405)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56305->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1408)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1408)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1411)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("count"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1413)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("allKeys"),  GGS_string ("stringset"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1414)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("keyList"),  GGS_string ("stringlist"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1415)) ;
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("listForKey"),  GGS_string ("string"),  operand_56305->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1416)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1416)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_56305->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1418)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1418)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_58786 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_58786 = NULL ;
      while (((operand_58786 = enumerator_58786.nextObject ()))) {
        macroValidPointer (operand_58786) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_58786->mAttributeTypeIndex) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_56305->mListmapTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1433)), GGS_typeKindEnum::constructor_listMapType (inLexique COMMA_SOURCE_FILE_AT_LINE (1434)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1436)), var_cas_listTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1442)), var_cas_enumeratorDescriptor, (((function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1444))).operator_or (function_generateCppConstructorWithNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1444)))).operator_or (function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1444)))).operator_or (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1444))), var_cas_addAssignOperatorDescription, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1452)) COMMA_SOURCE_FILE_AT_LINE (1430)) ;
  }
}
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_60671,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60671 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_60671 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_60671->mPredefinedTypeName, operand_60671) ;
  }
}
...
category_method__objectPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_objectPredefinedTypeAST * operand_61036,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61036 != NULL) {
    GGS_objectPredefinedTypeAST  var_cas_t = operand_61036 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string ("object"), operand_61036) ;
  }
}
...
category_method__stringsetPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_stringsetPredefinedTypeAST * operand_61399,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61399 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_61399->mPredefinedTypeName, operand_61399) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_61709,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61709 != NULL) {
    const GGS_string var_cas_actualSuperTypeName = operand_61709->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1508)) ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (var_cas_actualSuperTypeName, operand_61709->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1509)), operand_61709) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_62105,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62105 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62105->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1517)), operand_62105) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_62419,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62419 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62419->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1525)), operand_62419) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_62733,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62733 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62733->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1533)), operand_62733) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_63051,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63051 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_63051->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1541)), operand_63051) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_63372,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63372 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_63372->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1549)), operand_63372->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1549)), operand_63372) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_63716,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63716 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_63716->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1557)), operand_63716) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_64031,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64031 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_64031->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1565)), operand_64031->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1565)), operand_64031) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externFunctionDeclarationAST * operand_64386,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64386 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_64386) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externRoutineDeclarationAST * operand_64687,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64687 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_64687) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  #endif
  GGS_collectedTypeMap  var_cas_collectedTypeMap = GGS_collectedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1596)) ;
  GGS_multiMethodMapForBuildingContext  var_cas_multiMethodMapForBuildingContext = GGS_multiMethodMapForBuildingContext ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1597)) ;
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_65623 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_65623 = NULL ;
    while (((operand_65623 = enumerator_65623.nextObject ()))) {
      macroValidPointer (operand_65623) ;
      { typeCategoryMethod__semanticDeclarationAST__collectTypes method = findCategoryMethod__semanticDeclarationAST__collectTypes (operand_65623->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_65623->mSemanticDeclaration (HERE), var_cas_collectedTypeMap, var_cas_multiMethodMapForBuildingContext COMMA_SOURCE_FILE_AT_LINE (1599)) ;
        }
      }
    }
  }
  GGS_stringlist  var_cas_undefinedClasses = var_cas_collectedTypeMap.reader_unsolvedProxyKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1605)) ;
  const GGS_bool cond_66135 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_66135.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_65998 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_65998 = NULL ;
      while (((operand_65998 = enumerator_65998.nextObject ()))) {
        macroValidPointer (operand_65998) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_65998->mValue) ;
      }
    }
    var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (1612)) ;
    var_cas_outSemanticContext.drop () ;
  }else if (cond_66135.isBuiltAndFalse ()) {
    const GGS_bool cond_66437 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_66437.isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = ((GGS_string ("there are ")).operator_concat (var_cas_undefinedClasses.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1613)))).operator_concat (GGS_string (" undefined types:")) ;
      {
        GGS_stringlist::cEnumerator enumerator_66301 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_66301 = NULL ;
        while (((operand_66301 = enumerator_66301.nextObject ()))) {
          macroValidPointer (operand_66301) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_66301->mValue) ;
        }
      }
      var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (1618)) ;
      var_cas_outSemanticContext.drop () ;
    }else if (cond_66437.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_66800 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_66800 = NULL ;
        while (((operand_66800 = enumerator_66800.nextObject ()))) {
          macroValidPointer (operand_66800) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_66800->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_66800->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (1625)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_67914 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_67914 (_variant_67914.isBuilt (), true) ;
      while (_condition_67914.isBuiltAndTrue ()) {
        _condition_67914 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_67914.isBuiltAndTrue ()) {
          if (_variant_67914.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1646)) ;
            _condition_67914 = GGS_bool (false) ;
          }else{
            _variant_67914.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_67529 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_67529 = NULL ;
              while (((operand_67529 = enumerator_67529.nextObject ()))) {
                macroValidPointer (operand_67529) ;
                const GGS_bool cond_67757 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_67529->mDependanceString) ;
                if (cond_67757.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_67529->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_67529->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_67757.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_67529->mDependanceString, operand_67529->mTypeString, operand_67529->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_68537 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_68537.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_68196 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_68196 = enumerator_68196.nextObject () ;
          if ((operand_68196 != NULL)) {
            bool _foreach_loop_68196 ;
            do{
              macroValidPointer (operand_68196) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_68196->mTypeString) ;
              operand_68196 = enumerator_68196.nextObject () ;
              _foreach_loop_68196 = ((operand_68196 != NULL)) ;
              if (_foreach_loop_68196) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_68196) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_68369 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_68369 = NULL ;
          while (((operand_68369 = enumerator_68369.nextObject ()))) {
            macroValidPointer (operand_68369) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_68369->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_68369->mDependanceString) ;
          }
        }
        var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (1659)) ;
        var_cas_outSemanticContext.drop () ;
      }else if (cond_68537.isBuiltAndFalse ()) {
        var_cas_outSemanticContext = GGS_semanticContext::constructor_new (GGS_unifiedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1662)), GGS_routineMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)), GGS_functionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1664)), GGS_filewrapperMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1665)), GGS_grammarMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1666)), GGS_optionComponentMapForSemanticAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1667))) ;
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_68953 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_68953 = NULL ;
          while (((operand_68953 = enumerator_68953.nextObject ()))) {
            macroValidPointer (operand_68953) ;
            { typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (operand_68953->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_68953->mSemanticDeclaration (HERE), var_cas_multiMethodMapForBuildingContext, var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (1671)) ;
              }
            }
          }
        }
