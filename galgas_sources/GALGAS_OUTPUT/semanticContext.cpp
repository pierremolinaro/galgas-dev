...
void routine_addCategories (const GALGAS_categoryMethodMapForBuildingContext constinArgument_inCategoryMethodMapForBuildingContext,
  ...
  if (kBoolTrue == test_0) {
    ...
    while (enumerator_19870.hasCurrentObject ()) {
      ...
      while (enumerator_19973.hasCurrentObject ()) {
        ...
        var_formalArgumentList.addAssign_operation (enumerator_19973.current_mFormalSelector (HERE), var_typeIndex, enumerator_19973.current_mFormalArgumentPassingMode (HERE), enumerator_19973.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 509)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_categoryReaderMapForType enumerator_20860 (var_categoryReaderMapForType, kEnumeration_up) ;
    while (enumerator_20860.hasCurrentObject ()) {
      ...
      cEnumerator_formalInputParameterListAST enumerator_20961 (enumerator_20860.current_mInputFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_20961.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_20961.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 530)) ;
        }
        var_formalArgumentList.addAssign_operation (enumerator_20961.current_mFormalSelector (HERE), var_typeIndex, enumerator_20961.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 531)) ;
        enumerator_20961.gotoNextObject () ;
      }
      GALGAS_unifiedTypeMapProxy var_returnedType ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_20860.current_mResultTypeName (HERE), var_returnedType COMMA_SOURCE_FILE ("semanticContext.gSemantics", 534)) ;
      }
      {
      ioArgument_ioReaderMap.modifier_insertKey (enumerator_20860.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE ("semanticContext.gSemantics", 537)), var_formalArgumentList, enumerator_20860.current_lkey (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 539)), GALGAS_bool (true), var_returnedType, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 542)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 535)) ;
      }
      enumerator_20860.gotoNextObject () ;
    }
  }
  ...
  if (kBoolTrue == test_2) {
    ...
    cEnumerator_categoryModifierMapForType enumerator_21972 (var_categoryModifierMapForType, kEnumeration_up) ;
    while (enumerator_21972.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_22075 (enumerator_21972.current_mFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_22075.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_22075.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 555)) ;
        }
        var_formalArgumentList.addAssign_operation (enumerator_22075.current_mFormalSelector (HERE), var_typeIndex, enumerator_22075.current_mFormalArgumentPassingMode (HERE), enumerator_22075.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 556)) ;
        enumerator_22075.gotoNextObject () ;
      }
      {
      ioArgument_ioModifierMap.modifier_insertKey (enumerator_21972.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE ("semanticContext.gSemantics", 560)), var_formalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 563)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 558)) ;
      }
      enumerator_21972.gotoNextObject () ;
    }
  }
}
...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_77243 (var_files, kEnumeration_up) ;
  while (enumerator_77243.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_77243.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("semanticContext.gSemantics", 1881)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1881)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1882)).operator_concat (enumerator_77243.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1882)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_77243.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1884)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1883)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1890)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_77243.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("semanticContext.gSemantics", 1891)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1891)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1892)).operator_concat (enumerator_77243.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1892)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_77243.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1894)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1893)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1900)) ;
      }
    }
    enumerator_77243.gotoNextObject () ;
  }
  ...
  cEnumerator_stringlist enumerator_78208 (var_directories, kEnumeration_up) ;
  while (enumerator_78208.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1911)).operator_concat (enumerator_78208.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1911)), constinArgument_inPathInWrapper.operator_concat (enumerator_78208.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1912)).operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1912)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1910)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_78208.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1921)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1920)) ;
    }
...
void routine_buildSemanticContext (const GALGAS_semanticDeclarationListAST constinArgument_inSemanticDeclarationList,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_148311 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_148311.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_148311.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3592)) ;
    enumerator_148311.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_149044 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_149044.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_149044.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3604)) ;
    enumerator_149044.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_149519 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE ("semanticContext.gSemantics", 3614)), kEnumeration_up) ;
    while (enumerator_149519.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_149519.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_149519.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3615))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3615)).operator_concat (GALGAS_string ("' type is not defined")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3615))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3615)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
      enumerator_149519.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    ...
    GALGAS_lstringlist joker_149759_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_149759_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3618)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_150154 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_150154.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_150154.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3627))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3627))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3627)) ;
        enumerator_150154.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_150885 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_150885.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_150885.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3645)) ;
        enumerator_150885.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_36483 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_36483.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_36483.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 861)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_argumentTypeListForAddAssignWithFieldExpressionList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 864)), var_attributeTypeIndex, enumerator_36483.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 864)) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_36483.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 865)) ;
    ...
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_36483.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 867))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 867)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 868)), var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 868)), enumerator_36483.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 868)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 869)), var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 869)), enumerator_36483.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 869)) ;
    enumerator_36483.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_37387 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_37387.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_37387.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 873)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 873)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_37387.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_37387.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 874))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 874)).operator_concat (GALGAS_string ("' insert method is already declared")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 874))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 874)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_37387.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 878)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 881)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 876)) ;
      }
    }
    enumerator_37387.gotoNextObject () ;
  }
  cEnumerator_mapRemoveMethodListAST enumerator_37861 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  while (enumerator_37861.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_modifierMap.reader_hasKey (enumerator_37861.current_mMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 888)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 888)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_37861.current_mMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_37861.current_mMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 889))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 889)).operator_concat (GALGAS_string ("' method is already declared as an insert modifier or a remove modifier")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 889))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 889)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_37861.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 893)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 896)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 891)) ;
      }
    }
    enumerator_37861.gotoNextObject () ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_38388 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_38388.hasCurrentObject ()) {
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_38388.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 905)), var_removeMethodFormalArgumentList, enumerator_38388.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 907)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 909)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 903)) ;
    }
    enumerator_38388.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_38723 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_38723.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_38723.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 915)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 915)), enumerator_38723.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 915))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 915)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_38723.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 917)) ;
    }
    {
    ...
    enumerator_38723.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_39873 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_39873.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_39873.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 944)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 944))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 944)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 944)), enumerator_39873.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 944))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 944)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_39873.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 945)) ;
    }
    ...
    enumerator_39873.gotoNextObject () ;
  }
  {
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_45645 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_45645.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_45645.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1059)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_45645.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1062)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_45645.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1063))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1063)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 1064)), var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1064)), enumerator_45645.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1064)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 1065)), var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 1065)), enumerator_45645.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1065)) ;
    enumerator_45645.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_46407 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_46407.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_46407.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1069)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1069)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_46407.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_46407.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1070))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1070)).operator_concat (GALGAS_string ("' insert method is already declared")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1070))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1070)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_46407.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1074)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1077)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1072)) ;
      }
    }
    enumerator_46407.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_mapOverrideBlockListAST enumerator_50390 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    while (enumerator_50390.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_50390.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 1171))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1171)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1171)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1172)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 1173)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1175)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1170)) ;
      }
      enumerator_50390.gotoNextObject () ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_50799 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_50799.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_50799.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1182)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1182)), enumerator_50799.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 1182))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1182)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_50799.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1184)) ;
    }
    {
    ...
    enumerator_50799.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_51469 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_51469.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_51469.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1198)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 1198))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1198)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1198)), enumerator_51469.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 1198))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1198)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_51469.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1199)) ;
    }
    ...
    enumerator_51469.gotoNextObject () ;
  }
  {
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_54101_3 ; // Joker input parameter
  GALGAS_bool joker_54101_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_54101_1 ; // Joker input parameter
  GALGAS_bool joker_54141_3 ; // Joker input parameter
  GALGAS_typedAttributeList joker_54141_2 ; // Joker input parameter
  GALGAS_attributeMap joker_54141_1 ; // Joker input parameter
  GALGAS_constructorMap joker_54196_11 ; // Joker input parameter
  GALGAS_readerMap joker_54196_10 ; // Joker input parameter
  GALGAS_modifierMap joker_54196_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_54196_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_54196_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_54196_6 ; // Joker input parameter
  GALGAS_stringlist joker_54196_5 ; // Joker input parameter
  GALGAS_uint joker_54196_4 ; // Joker input parameter
  GALGAS_functionSignature joker_54196_3 ; // Joker input parameter
  GALGAS_stringset joker_54196_2 ; // Joker input parameter
  GALGAS_lstringlist joker_54196_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_54251_6 ; // Joker input parameter
  GALGAS_bool joker_54251_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_54251_4 ; // Joker input parameter
  GALGAS_string joker_54251_3 ; // Joker input parameter
  GALGAS_string joker_54251_2 ; // Joker input parameter
  GALGAS_headerKind joker_54251_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_54101_3, joker_54101_2, joker_54101_1, var_typeKindEnum, joker_54141_3, joker_54141_2, joker_54141_1, var_mapTypedAttributeList, joker_54196_11, joker_54196_10, joker_54196_9, joker_54196_8, joker_54196_7, joker_54196_6, joker_54196_5, joker_54196_4, joker_54196_3, joker_54196_2, joker_54196_1, var_searchMethodList, joker_54251_6, joker_54251_5, joker_54251_4, joker_54251_3, joker_54251_2, joker_54251_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1264)) ;
  ...
  cEnumerator_mapSearchMethodListAST enumerator_56927 (var_searchMethodList, kEnumeration_up) ;
  while (enumerator_56927.hasCurrentObject ()) {
    {
    var_constructorMap.modifier_insertKey (enumerator_56927.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1322)) ;
    }
    enumerator_56927.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_57898 (var_mapTypedAttributeList, kEnumeration_up) ;
  while (enumerator_57898.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_57898.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1339)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1339)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_58032 (var_inheritedReaderMap.reader_keySet (SOURCE_FILE ("semanticContext.gSemantics", 1341)), kEnumeration_up) ;
      while (enumerator_58032.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_58032.current_key (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1342)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1342))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1342)) ;
        if (enumerator_58032.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1343)) ;
        }
        enumerator_58032.gotoNextObject () ;
      }
      GALGAS_location location_3 (enumerator_57898.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      {
      var_readerMap.modifier_insertKey (enumerator_57898.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1350)), GALGAS_functionSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 1351)), inCompiler->here (), GALGAS_bool (true), enumerator_57898.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1355)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1348)) ;
      }
    }
    enumerator_57898.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externTypeDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_externTypeConstructorList enumerator_60606 (object->mAttribute_mExternTypeConstructorList, kEnumeration_up) ;
  while (enumerator_60606.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60606.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1420)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_60840 (enumerator_60606.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_60840.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60840.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1425)) ;
      }
      var_arguments.addAssign_operation (enumerator_60840.current_mFormalSelector (HERE), var_argumentTypeProxy, enumerator_60840.current_mFormalParameterName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1426)) ;
      enumerator_60840.gotoNextObject () ;
    }
    {
    var_constructorMap.modifier_insertKey (enumerator_60606.current_mConstructorName (HERE), var_arguments, GALGAS_bool (true), var_returnedTypeProxy, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1429)) ;
    }
    enumerator_60606.gotoNextObject () ;
  }
  cEnumerator_externTypeReaderList enumerator_61331 (object->mAttribute_mExternTypeReaderList, kEnumeration_up) ;
  while (enumerator_61331.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61331.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1439)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_61559 (enumerator_61331.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_61559.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61559.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1444)) ;
      }
      var_arguments.addAssign_operation (enumerator_61559.current_mFormalSelector (HERE), var_argumentTypeProxy, enumerator_61559.current_mFormalParameterName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1445)) ;
      enumerator_61559.gotoNextObject () ;
    }
    {
    var_readerMap.modifier_insertKey (enumerator_61331.current_mReaderName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1450)), var_arguments, inCompiler->here (), GALGAS_bool (true), var_returnedTypeProxy, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1455)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1448)) ;
    }
    enumerator_61331.gotoNextObject () ;
  }
  cEnumerator_externTypeModifierList enumerator_62161 (object->mAttribute_mExternTypeModifierList, kEnumeration_up) ;
  while (enumerator_62161.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_62258 (enumerator_62161.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_62258.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_62258.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1463)) ;
      }
      var_routineSignature.addAssign_operation (enumerator_62258.current_mFormalSelector (HERE), var_parameterTypeIndex, enumerator_62258.current_mFormalArgumentPassingMode (HERE), enumerator_62258.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1468)) ;
      enumerator_62258.gotoNextObject () ;
    }
    {
    var_modifierMap.modifier_insertKey (enumerator_62161.current_mModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1473)), var_routineSignature, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1476)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1471)) ;
    }
    enumerator_62161.gotoNextObject () ;
  }
  cEnumerator_externTypeMethodList enumerator_62871 (object->mAttribute_mExternTypeMethodList, kEnumeration_up) ;
  while (enumerator_62871.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_62968 (enumerator_62871.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_62968.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_62968.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1485)) ;
      }
      var_routineSignature.addAssign_operation (enumerator_62968.current_mFormalSelector (HERE), var_parameterTypeIndex, enumerator_62968.current_mFormalArgumentPassingMode (HERE), enumerator_62968.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1490)) ;
      enumerator_62968.gotoNextObject () ;
    }
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_62871.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1495)), var_routineSignature, enumerator_62871.current_mDeclarationLocation (HERE), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1499)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1493)) ;
    }
    enumerator_62871.gotoNextObject () ;
  }
  {
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_functionSignature enumerator_70280 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1685)), kEnumeration_up) ;
  while (enumerator_70280.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 1686)), enumerator_70280.current_mFormalArgumentType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 1686)), enumerator_70280.current_mFormalArgumentName (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1686)) ;
    enumerator_70280.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_70458 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_70458.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_70458.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1691)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1694)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1689)) ;
    }
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_74764 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_74764.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_74764.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1808))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1808)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_74764.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1809)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1809)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1809)) ;
    }
    enumerator_74764.gotoNextObject () ;
  }
  GALGAS_readerMap var_readerMap ;
  {
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_filewrapperTemplateListAST enumerator_79442 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_79442.hasCurrentObject ()) {
    ...
    cEnumerator_formalTemplateInputParameterListAST enumerator_79560 (enumerator_79442.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_79560.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_79560.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1943)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1944)) ;
      enumerator_79560.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_79442.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_79442.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1946)) ;
    }
  ...
  cEnumerator_lstringlist enumerator_80079 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_80079.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_80079.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1955)) ;
    }
  ...
  cEnumerator_lstringlist enumerator_80285 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_80285.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_80285.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1960)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_80285.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_80285.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1961))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1961)).operator_concat (GALGAS_string ("' extension is already used for text files")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1961))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1961)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_80285.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1963)) ;
      }
    }
    enumerator_80285.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_82252 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_82252.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_82252.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2016)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_82472 (enumerator_82252.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_82472.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_82472.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_82472.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_82472.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_82252.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2026)) ;
    enumerator_82252.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_83607 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_83607.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_83607.current_mAttributeTypeProxy (HERE), enumerator_83607.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2044))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2044)) ;
    var_constructorAttributeTypeList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2045)), enumerator_83607.current_mAttributeTypeProxy (HERE), enumerator_83607.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2045)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2046)), enumerator_83607.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 2046)), enumerator_83607.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2046)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2047)), enumerator_83607.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2047)), enumerator_83607.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2047)) ;
    enumerator_83607.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_85058 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_85058.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_85058.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      ...
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_85058.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2067)).operator_concat (GALGAS_string ("AtIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2067)), enumerator_85058.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 2067))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2067)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2068)), temp_3, inCompiler->here (), GALGAS_bool (true), enumerator_85058.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2073)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2066)) ;
      }
    }
    enumerator_85058.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_86878 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_86878.hasCurrentObject ()) {
    const enumGalgasBool test_4 = enumerator_86878.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_4) {
      ...
      var_setterFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2129)), enumerator_86878.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2129)), enumerator_86878.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2129)) ;
      var_setterFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2130)), var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2130)), enumerator_86878.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2130)) ;
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_86878.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2132)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2132))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2132)).operator_concat (GALGAS_string ("AtIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2132)), enumerator_86878.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 2132))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2132)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2133)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2136)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2131)) ;
      }
    }
    enumerator_86878.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_90615 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_90615.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_90615.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2221)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_90615.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2224)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_90615.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2225)) ;
    var_constructorAttributeTypeList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2226)), var_attributeTypeIndex, enumerator_90615.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2226)) ;
    var_modifierFormalArgumentList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2227)), var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 2227)), enumerator_90615.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2227)) ;
    enumerator_90615.gotoNextObject () ;
  }
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_95247 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_95247.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_95247.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2346)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2347)), var_attributeTypeIndex, enumerator_95247.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2347)) ;
    ...
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_95247.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2351)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_95247.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2352)) ;
    }
  ...
  cEnumerator_typedAttributeList enumerator_96046 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_96046.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_96046.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2367)), enumerator_96046.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2368)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2364)) ;
    }
    enumerator_96046.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_97096 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_97096.hasCurrentObject () && bool_1) {
    while (enumerator_97096.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_97096.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2401)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_97096.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2401)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2401)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2401)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_97096.gotoNextObject () ;
      if (enumerator_97096.hasCurrentObject ()) {
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_99585 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_99585.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_99585.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2465)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
    ...
    GALGAS_bool joker_100064_3 ; // Joker input parameter
    GALGAS_bool joker_100064_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_100064_1 ; // Joker input parameter
    GALGAS_bool joker_100094_0 ; // Joker input parameter
    GALGAS_typedAttributeList joker_100158_2 ; // Joker input parameter
    GALGAS_constructorMap joker_100158_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_100248_9 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_100248_8 ; // Joker input parameter
    GALGAS_stringlist joker_100248_7 ; // Joker input parameter
    GALGAS_uint joker_100248_6 ; // Joker input parameter
    GALGAS_functionSignature joker_100248_5 ; // Joker input parameter
    GALGAS_stringset joker_100248_4 ; // Joker input parameter
    GALGAS_lstringlist joker_100248_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_100248_2 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_100248_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_100294_4 ; // Joker input parameter
    GALGAS_string joker_100294_3 ; // Joker input parameter
    GALGAS_string joker_100294_2 ; // Joker input parameter
    GALGAS_headerKind joker_100294_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_100064_3, joker_100064_2, joker_100064_1, var_typeKindEnum, joker_100094_0, var_inheritedTypedAttributeList, var_attributeMap, joker_100158_2, joker_100158_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_100248_9, joker_100248_8, joker_100248_7, joker_100248_6, joker_100248_5, joker_100248_4, joker_100248_3, joker_100248_2, joker_100248_1, var_generateHeaderInSeparateFile, joker_100294_4, joker_100294_3, joker_100294_2, joker_100294_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2475)) ;
    ...
    cEnumerator_modifierMap enumerator_100581 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_100581.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_100581.current_lkey (HERE), enumerator_100581.current_mKind (HERE), enumerator_100581.current_mParameterList (HERE), enumerator_100581.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2502)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2497)) ;
      }
    ...
    cEnumerator_readerMap enumerator_100907 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_100907.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_100907.current_lkey (HERE), enumerator_100907.current_mKind (HERE), enumerator_100907.current_mArgumentTypeList (HERE), enumerator_100907.current_mDeclarationLocation (HERE), enumerator_100907.current_mHasCompilerArgument (HERE), enumerator_100907.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2516)), enumerator_100907.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2509)) ;
      }
      enumerator_100907.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2521)) ;
    cEnumerator_instanceMethodMap enumerator_101295 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_101295.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_101295.current_lkey (HERE), enumerator_101295.current_mKind (HERE), enumerator_101295.current_mParameterList (HERE), enumerator_101295.current_mDeclarationLocation (HERE), enumerator_101295.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2529)), enumerator_101295.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2523)) ;
      }
      enumerator_101295.gotoNextObject () ;
    }
  }
  ...
  cEnumerator_typedAttributeList enumerator_101708 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_101708.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2537)), enumerator_101708.current_mAttributeTypeProxy (HERE), enumerator_101708.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2537)) ;
    enumerator_101708.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_101849 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_101849.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_101849.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2541)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2542)), var_attributeTypeIndex, enumerator_101849.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2542)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_101849.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2543)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_101849.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2544)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2544)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_101849.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_101849.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2545))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2545)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2545))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2545)) ;
    }
    enumerator_101849.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_102963 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_102963.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_102963.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2569)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_103207 (enumerator_102963.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_103207.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_103207.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2573)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_103207.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2575)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_103207.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_102963.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2579)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_102963.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2580)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_102963.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2584)), GALGAS_functionSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2585)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2589)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2582)) ;
      }
    }
    enumerator_102963.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_104008 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_104008.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_104008.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_104008.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2598)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2598))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2598)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2598)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2599)), GALGAS_formalParameterSignature::constructor_listWithValue (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2600)), enumerator_104008.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 2600)), enumerator_104008.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2600)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2602)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2597)) ;
      }
    }
    enumerator_104008.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_105064 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_105064.hasCurrentObject () && bool_12) {
    while (enumerator_105064.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_105064.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2626)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_105064.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2626)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2626)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2626)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_105064.gotoNextObject () ;
      if (enumerator_105064.hasCurrentObject ()) {
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_106803 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_106803.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_106803.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2674)) ;
    }
    var_routineSignature.addAssign_operation (enumerator_106803.current_mFormalSelector (HERE), var_parameterTypeIndex, enumerator_106803.current_mFormalArgumentPassingMode (HERE), enumerator_106803.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2675)) ;
    enumerator_106803.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_107850 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_107850.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_107850.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2697)) ;
    }
    var_functionSignature.addAssign_operation (enumerator_107850.current_mFormalSelector (HERE), var_parameterTypeIndex, enumerator_107850.current_mFormalArgumentTypeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2698)) ;
    enumerator_107850.gotoNextObject () ;
  }
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2758)).isValid ()) {
    uint32_t variant_110690 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2758)).uintValue () ;
    bool loop_110690 = true ;
    while (loop_110690) {
      loop_110690 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2758)))).isValid () ;
      if (loop_110690) {
        loop_110690 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2758)))).boolValue () ;
      }
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2797)).isValid ()) {
    uint32_t variant_112030 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2797)).uintValue () ;
    bool loop_112030 = true ;
    while (loop_112030) {
      loop_112030 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2797)))).isValid () ;
      if (loop_112030) {
        loop_112030 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2797)))).boolValue () ;
      }
      if (loop_112030 && (0 == variant_112030)) {
        loop_112030 = false ;
  ...
  {
  GALGAS_lstring joker_112659_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_112659_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_112659_2 ; // Joker input parameter
  GALGAS_string joker_112659_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_112659_4, joker_112659_3, joker_112659_2, joker_112659_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2817)) ;
  }
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_115085_3 ; // Joker input parameter
  GALGAS_bool joker_115085_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_115085_1 ; // Joker input parameter
  GALGAS_bool joker_115125_0 ; // Joker input parameter
  GALGAS_attributeMap joker_115180_20 ; // Joker input parameter
  GALGAS_typedAttributeList joker_115180_19 ; // Joker input parameter
  GALGAS_constructorMap joker_115180_18 ; // Joker input parameter
  GALGAS_readerMap joker_115180_17 ; // Joker input parameter
  GALGAS_modifierMap joker_115180_16 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_115180_15 ; // Joker input parameter
  GALGAS_classMethodMap joker_115180_14 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_115180_13 ; // Joker input parameter
  GALGAS_stringlist joker_115180_12 ; // Joker input parameter
  GALGAS_uint joker_115180_11 ; // Joker input parameter
  GALGAS_functionSignature joker_115180_10 ; // Joker input parameter
  GALGAS_stringset joker_115180_9 ; // Joker input parameter
  GALGAS_lstringlist joker_115180_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_115180_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_115180_6 ; // Joker input parameter
  GALGAS_bool joker_115180_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_115180_4 ; // Joker input parameter
  GALGAS_string joker_115180_3 ; // Joker input parameter
  GALGAS_string joker_115180_2 ; // Joker input parameter
  GALGAS_headerKind joker_115180_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_115085_3, joker_115085_2, joker_115085_1, var_typeKindEnum, joker_115125_0, var_listTypedAttributeList, joker_115180_20, joker_115180_19, joker_115180_18, joker_115180_17, joker_115180_16, joker_115180_15, joker_115180_14, joker_115180_13, joker_115180_12, joker_115180_11, joker_115180_10, joker_115180_9, joker_115180_8, joker_115180_7, joker_115180_6, joker_115180_5, joker_115180_4, joker_115180_3, joker_115180_2, joker_115180_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2886)) ;
  ...
  cEnumerator_typedAttributeList enumerator_117028 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_117028.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2922)), enumerator_117028.current_mAttributeTypeProxy (HERE), enumerator_117028.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2922)) ;
    enumerator_117028.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121474 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121474.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121474.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3029))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3029)), object->mAttribute_mSuperClassName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3029)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3029)) ;
    }
    enumerator_121474.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_122332 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_122332.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_122332.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3045))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3045)), enumerator_122332.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3045))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3045)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3045)) ;
    }
    enumerator_122332.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_123196 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123196.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123196.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3061))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3061)), enumerator_123196.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3061))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3061)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3061)) ;
    }
    enumerator_123196.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_124768 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_124768.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_124768.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3090))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3090)), enumerator_124768.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3090))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3090)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3090)) ;
    }
    enumerator_124768.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_127273 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_127273.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_127273.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3134))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3134)), enumerator_127273.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3134))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3134)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3134)) ;
    }
    enumerator_127273.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_128134 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_128134.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_128134.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3150))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3150)), enumerator_128134.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3150))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3150)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3150)) ;
    }
    enumerator_128134.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_137231 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryReaderMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3322)) ;
  if (NULL != objectArray_137231) {
      macroValidSharedObject (objectArray_137231, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_137231->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3323)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_138536 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryMethodMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3350)) ;
  if (NULL != objectArray_138536) {
      macroValidSharedObject (objectArray_138536, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_138536->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3351)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_139811 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryModifierMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3377)) ;
  if (NULL != objectArray_139811) {
      macroValidSharedObject (objectArray_139811, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_139811->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3378)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_141715 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryReaderMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3416)) ;
  if (NULL != objectArray_141715) {
      macroValidSharedObject (objectArray_141715, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_141715->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3417)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_143068 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryMethodMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3444)) ;
  if (NULL != objectArray_143068) {
      macroValidSharedObject (objectArray_143068, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_143068->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3445)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_144383 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryModifierMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3471)) ;
  if (NULL != objectArray_144383) {
      macroValidSharedObject (objectArray_144383, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_144383->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3472)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_145222 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145222.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145222.current_mAttributeTypeName (HERE), enumerator_145222.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3501))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3498)) ;
    enumerator_145222.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_145865 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145865.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145865.current_mAttributeTypeName (HERE), enumerator_145865.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3522))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3519)) ;
    enumerator_145865.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_146516 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_146516.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_146516.current_mAttributeTypeName (HERE), enumerator_146516.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3543))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3540)) ;
    enumerator_146516.gotoNextObject () ;
  }
