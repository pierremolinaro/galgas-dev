...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  ioArgument_ioWrapperDirectoryIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1741)) ;
  GALGAS_stringlist var_files = constinArgument_inAbsoluteSourcePath.reader_regularFiles (GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1743)) ;
  outArgument_outWrapperFileMap = GALGAS_wrapperFileMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1744)) ;
  cEnumerator_stringlist enumerator_70411 (var_files, kEnumeration_up) ;
  while (enumerator_70411.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_70411.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1746)) COMMA_SOURCE_FILE_AT_LINE (1746)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1747)).operator_concat (enumerator_70411.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1747)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_70411.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1749)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1748)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1755)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_70411.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1756)) COMMA_SOURCE_FILE_AT_LINE (1756)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1757)).operator_concat (enumerator_70411.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1757)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_70411.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1759)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1758)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1765)) ;
      }
    }
    enumerator_70411.gotoNextObject () ;
  }
  GALGAS_stringlist var_directories = constinArgument_inAbsoluteSourcePath.reader_directories (GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1769)) ;
  outArgument_outWrapperDirectoryMap = GALGAS_wrapperDirectoryMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1770)) ;
  cEnumerator_stringlist enumerator_71376 (var_directories, kEnumeration_up) ;
  while (enumerator_71376.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1776)).operator_concat (enumerator_71376.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1776)), constinArgument_inPathInWrapper.operator_concat (enumerator_71376.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1777)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1777)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1775)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_71376.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1786)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1785)) ;
    }
    enumerator_71376.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_140180 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_140180.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_140180.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3427)) ;
    enumerator_140180.gotoNextObject () ;
  }
  GALGAS_semanticTypePrecedenceGraph var_semanticTypePrecedenceGraph = GALGAS_semanticTypePrecedenceGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (3433)) ;
  GALGAS_categoryMethodMapForBuildingContext var_categoryMethodMapForBuildingContext = GALGAS_categoryMethodMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3434)) ;
  GALGAS_categoryReaderMapForBuildingContext var_categoryReaderMapForBuildingContext = GALGAS_categoryReaderMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3435)) ;
  GALGAS_categoryModifierMapForBuildingContext var_categoryModifierMapForBuildingContext = GALGAS_categoryModifierMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3436)) ;
  GALGAS_semanticDeclarationListAST var_categoryOverrideDefinitionList = GALGAS_semanticDeclarationListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3437)) ;
  cEnumerator_semanticDeclarationListAST enumerator_140913 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_140913.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_140913.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3439)) ;
    enumerator_140913.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (3447)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_141333 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3448)), kEnumeration_up) ;
    while (enumerator_141333.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_141333.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_141333.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3449)) COMMA_SOURCE_FILE_AT_LINE (3449)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3449)) COMMA_SOURCE_FILE_AT_LINE (3449)) ;
      enumerator_141333.gotoNextObject () ;
    }
    inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("semantic analysis not performed, due to undefined type error(s)") COMMA_SOURCE_FILE_AT_LINE (3451)) ;
    ...
    GALGAS_lstringlist joker_141669_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_141669_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3453)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3464)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string ("semantic analysis not performed, ").operator_concat (var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3465)).reader_string (SOURCE_FILE_AT_LINE (3465)) COMMA_SOURCE_FILE_AT_LINE (3465)).operator_concat (GALGAS_string (" declarations are involved in circular definition:") COMMA_SOURCE_FILE_AT_LINE (3465)) ;
      cEnumerator_semanticDeclarationListAST enumerator_142254 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_142254.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_142254.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3467)) COMMA_SOURCE_FILE_AT_LINE (3467)) COMMA_SOURCE_FILE_AT_LINE (3467)) ;
        enumerator_142254.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (3469)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      var_sortedSemanticDeclarationListAST.dotAssign_operation (var_categoryOverrideDefinitionList COMMA_SOURCE_FILE_AT_LINE (3472)) ;
      outArgument_outSemanticContext = GALGAS_semanticContext::constructor_new (constinArgument_inSourceFile, GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3476)), GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3477)), GALGAS_functionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3478)), GALGAS_filewrapperMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3479)), GALGAS_grammarMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3480)), GALGAS_optionComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3481)), GALGAS_lexiqueComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3482)), GALGAS_optionMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3483)) COMMA_SOURCE_FILE_AT_LINE (3474)) ;
      cEnumerator_semanticDeclarationListAST enumerator_143062 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_143062.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_143062.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3487)) ;
        enumerator_143062.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_35587 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_35587.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_35587.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (842)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (842)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_35587.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (845)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_35587.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (846)) COMMA_SOURCE_FILE_AT_LINE (846)) ;
  ...
  cEnumerator_insertMethodListAST enumerator_36273 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_36273.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_36273.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (852)) COMMA_SOURCE_FILE_AT_LINE (852)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_36273.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_36273.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (853)) COMMA_SOURCE_FILE_AT_LINE (853)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (853)) COMMA_SOURCE_FILE_AT_LINE (853)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_36273.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (857)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (860)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (855)) ;
      }
    }
    enumerator_36273.gotoNextObject () ;
  }
  cEnumerator_mapRemoveMethodListAST enumerator_36747 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  while (enumerator_36747.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_modifierMap.reader_hasKey (enumerator_36747.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (867)) COMMA_SOURCE_FILE_AT_LINE (867)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_36747.current_mMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_36747.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (868)) COMMA_SOURCE_FILE_AT_LINE (868)).operator_concat (GALGAS_string ("' method is already declared as an insert modifier or a remove modifier") COMMA_SOURCE_FILE_AT_LINE (868)) COMMA_SOURCE_FILE_AT_LINE (868)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_36747.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (872)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (875)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (870)) ;
      }
    }
    enumerator_36747.gotoNextObject () ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_37274 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_37274.hasCurrentObject ()) {
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_37274.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (884)), var_removeMethodFormalArgumentList, enumerator_37274.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (886)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (888)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (882)) ;
    }
    enumerator_37274.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_37609 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_37609.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_37609.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (894)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (894)), enumerator_37609.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (894)) COMMA_SOURCE_FILE_AT_LINE (894)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_37609.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (896)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (896)) ;
    }
    {
    ...
    enumerator_37609.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_38748 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_38748.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_38748.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (923)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (923)) COMMA_SOURCE_FILE_AT_LINE (923)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (923)), enumerator_38748.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (923)) COMMA_SOURCE_FILE_AT_LINE (923)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_38748.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (925)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (925)) ;
    }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_39766 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_39766.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_39766.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (942)) ;
    }
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1003)) ;
  }
  GALGAS_unifiedTypeMapProxy var_locationTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("location"), var_locationTypeProxy COMMA_SOURCE_FILE_AT_LINE (1006)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstring"), var_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1009)) ;
  }
  GALGAS_unifiedTypeMapProxy var_currentMapTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (1012)), var_currentMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (1012)) ;
  }
  ...
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("unsolvedProxyKeyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1032)) ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_44148 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_44148.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_44148.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1041)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1041)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_44148.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1044)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_44148.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1045)) COMMA_SOURCE_FILE_AT_LINE (1045)) ;
    ...
    enumerator_44148.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_44834 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_44834.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_44834.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1051)) COMMA_SOURCE_FILE_AT_LINE (1051)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_44834.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_44834.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1052)) COMMA_SOURCE_FILE_AT_LINE (1052)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (1052)) COMMA_SOURCE_FILE_AT_LINE (1052)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_44834.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1056)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1059)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1054)) ;
      }
    }
  ...
  if (kBoolTrue == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_45408 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_45408.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_45408.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1069)), var_removeMethodFormalArgumentList, enumerator_45408.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (1071)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1073)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1067)) ;
      }
      enumerator_45408.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_45738 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_45738.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_45738.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1081)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1084)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1079)) ;
      }
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_mapOverrideBlockListAST enumerator_47488 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    while (enumerator_47488.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_47488.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1128)) COMMA_SOURCE_FILE_AT_LINE (1128)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1128)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1129)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1130)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1132)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1127)) ;
      }
      enumerator_47488.gotoNextObject () ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_47897 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_47897.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_47897.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1139)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1139)), enumerator_47897.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1139)) COMMA_SOURCE_FILE_AT_LINE (1139)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_47897.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1141)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1141)) ;
    }
    {
  ...
  cEnumerator_attributeInCollectionListAST enumerator_48546 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_48546.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_48546.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1155)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1155)) COMMA_SOURCE_FILE_AT_LINE (1155)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1155)), enumerator_48546.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1155)) COMMA_SOURCE_FILE_AT_LINE (1155)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_48546.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1157)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1157)) ;
    }
    ...
    enumerator_48546.gotoNextObject () ;
  }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_49564 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_49564.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_49564.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1174)) ;
    }
    enumerator_49564.gotoNextObject () ;
  }
  {
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_51370_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_51370_1 ; // Joker input parameter
  GALGAS_typedAttributeList joker_51410_2 ; // Joker input parameter
  GALGAS_attributeMap joker_51410_1 ; // Joker input parameter
  GALGAS_constructorMap joker_51466_11 ; // Joker input parameter
  GALGAS_readerMap joker_51466_10 ; // Joker input parameter
  GALGAS_modifierMap joker_51466_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_51466_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_51466_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_51466_6 ; // Joker input parameter
  GALGAS_stringlist joker_51466_5 ; // Joker input parameter
  GALGAS_uint joker_51466_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_51466_3 ; // Joker input parameter
  GALGAS_stringset joker_51466_2 ; // Joker input parameter
  GALGAS_lstringlist joker_51466_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_51520_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_51520_4 ; // Joker input parameter
  GALGAS_bool joker_51520_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_51520_2 ; // Joker input parameter
  GALGAS_string joker_51520_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_51370_2, joker_51370_1, var_typeKindEnum, joker_51410_2, joker_51410_1, var_mapTypedAttributeList, joker_51466_11, joker_51466_10, joker_51466_9, joker_51466_8, joker_51466_7, joker_51466_6, joker_51466_5, joker_51466_4, joker_51466_3, joker_51466_2, joker_51466_1, var_searchMethodList, joker_51520_5, joker_51520_4, joker_51520_3, joker_51520_2, joker_51520_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1229)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_uniqueMapType (SOURCE_FILE_AT_LINE (1239)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mAssociatedMapTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the @").operator_concat (object->mAttribute_mAssociatedMapTypeName.reader_string (SOURCE_FILE_AT_LINE (1240)) COMMA_SOURCE_FILE_AT_LINE (1240)).operator_concat (GALGAS_string (" should be an unique map type") COMMA_SOURCE_FILE_AT_LINE (1240)) COMMA_SOURCE_FILE_AT_LINE (1240)) ;
    var_mapTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1241)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1244)) ;
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1245)) ;
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1246)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1247)) ;
  GALGAS_classMethodMap var_classMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1248)) ;
  GALGAS_unifiedTypeMapProxy var_associatedMapTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedMapTypeName.reader_string (SOURCE_FILE_AT_LINE (1251)), var_associatedMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (1251)) ;
  }
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1254)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstring"), var_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1257)) ;
  }
  GALGAS_unifiedTypeMapProxy var_mapProxyTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE_AT_LINE (1260)), var_mapProxyTypeProxy COMMA_SOURCE_FILE_AT_LINE (1260)) ;
  }
  GALGAS_formalParameterSignature var_argList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1262)) ;
  var_argList.addAssign_operation (var_associatedMapTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (1263)) COMMA_SOURCE_FILE_AT_LINE (1263)) ;
  var_argList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1264)) COMMA_SOURCE_FILE_AT_LINE (1264)) ;
  var_argList.addAssign_operation (var_mapProxyTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1265)) COMMA_SOURCE_FILE_AT_LINE (1265)) ;
  {
  var_classMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("makeRegularProxy"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1267)), var_argList, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1266)) ;
  }
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("null"), object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE_AT_LINE (1272)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1272)) ;
  }
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1274)) ;
  var_constructorAttributeTypeList.addAssign_operation (var_associatedMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (1275)) ;
  var_constructorAttributeTypeList.addAssign_operation (var_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1276)) ;
  cEnumerator_mapSearchMethodListAST enumerator_53559 (var_searchMethodList, kEnumeration_up) ;
  while (enumerator_53559.hasCurrentObject ()) {
    {
    var_constructorMap.modifier_insertKey (enumerator_53559.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1278)) ;
    }
    enumerator_53559.gotoNextObject () ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("isSolved"), GALGAS_string ("bool"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1286)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("isNull"), GALGAS_string ("bool"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1287)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("isRegular"), GALGAS_string ("bool"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1288)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lkey"), GALGAS_string ("lstring"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1289)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("key"), GALGAS_string ("string"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1290)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("identifierRepresentation"), GALGAS_string ("string"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1291)) ;
  }
  GALGAS_readerMap var_inheritedReaderMap = var_readerMap ;
  cEnumerator_typedAttributeList enumerator_54530 (var_mapTypedAttributeList, kEnumeration_up) ;
  while (enumerator_54530.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_54530.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1295)) COMMA_SOURCE_FILE_AT_LINE (1295)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_54672 (var_inheritedReaderMap.reader_keySet (SOURCE_FILE_AT_LINE (1297)), kEnumeration_up) ;
      while (enumerator_54672.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_54672.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (1298)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1298)) COMMA_SOURCE_FILE_AT_LINE (1298)) ;
        if (enumerator_54672.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (1299)) ;
        }
        enumerator_54672.gotoNextObject () ;
      }
      GALGAS_location location_3 (enumerator_54530.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the map has a associated map proxy, which has predefined readers: ").operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (1301)).operator_concat (GALGAS_string ("; you cannot use theses names for naming an attribute of this map") COMMA_SOURCE_FILE_AT_LINE (1302)) COMMA_SOURCE_FILE_AT_LINE (1301)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_readerMap.modifier_insertKey (enumerator_54530.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1306)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1307)), inCompiler->here (), GALGAS_bool (true), enumerator_54530.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1311)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1304)) ;
      }
    }
    enumerator_54530.gotoNextObject () ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mMapProxyTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1317)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mMapProxyTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1331)), GALGAS_typeKindEnum::constructor_mapProxyType (SOURCE_FILE_AT_LINE (1332)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1333)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1334)), var_mapTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, var_classMethodMap, GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1341)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1342)), function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (1343)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1344)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1345)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1346)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1347)), var_searchMethodList, GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1349)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1351)), GALGAS_string ("null"), inCompiler COMMA_SOURCE_FILE_AT_LINE (1328)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externTypeDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externTypeDeclarationAST * object = (const cPtr_externTypeDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_externTypeDeclarationAST) ;
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1365)) ;
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1366)) ;
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1367)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1368)) ;
  GALGAS_classMethodMap var_classMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1369)) ;
  cEnumerator_externTypeConstructorList enumerator_57113 (object->mAttribute_mExternTypeConstructorList, kEnumeration_up) ;
  while (enumerator_57113.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_57113.current_mResultTypeName (HERE).mAttribute_string, var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1373)) ;
    }
    GALGAS_unifiedTypeMapProxyList var_arguments = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1375)) ;
    cEnumerator_lstringlist enumerator_57375 (enumerator_57113.current_mArgumentTypeNameList (HERE), kEnumeration_up) ;
    while (enumerator_57375.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_57375.current_mValue (HERE).mAttribute_string, var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1378)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1379)) ;
      enumerator_57375.gotoNextObject () ;
    }
    {
    var_constructorMap.modifier_insertKey (enumerator_57113.current_mConstructorName (HERE), var_arguments, GALGAS_bool (true), var_returnedTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1382)) ;
    }
    enumerator_57113.gotoNextObject () ;
  }
  cEnumerator_externTypeReaderList enumerator_57816 (object->mAttribute_mExternTypeReaderList, kEnumeration_up) ;
  while (enumerator_57816.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_57816.current_mResultTypeName (HERE).mAttribute_string, var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1392)) ;
    }
    GALGAS_unifiedTypeMapProxyList var_arguments = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1394)) ;
    cEnumerator_lstringlist enumerator_58078 (enumerator_57816.current_mArgumentTypeNameList (HERE), kEnumeration_up) ;
    while (enumerator_58078.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_58078.current_mValue (HERE).mAttribute_string, var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1397)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1398)) ;
      enumerator_58078.gotoNextObject () ;
    }
    {
    var_readerMap.modifier_insertKey (enumerator_57816.current_mReaderName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1403)), var_arguments, inCompiler->here (), GALGAS_bool (true), var_returnedTypeProxy, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1408)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1401)) ;
    }
    enumerator_57816.gotoNextObject () ;
  }
  cEnumerator_externTypeModifierList enumerator_58630 (object->mAttribute_mExternTypeModifierList, kEnumeration_up) ;
  while (enumerator_58630.hasCurrentObject ()) {
    GALGAS_formalParameterSignature var_routineSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1414)) ;
    cEnumerator_formalParameterListAST enumerator_58727 (enumerator_58630.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_58727.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_58727.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1419)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1417)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_58727.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1422)) ;
      enumerator_58727.gotoNextObject () ;
    }
    {
    var_modifierMap.modifier_insertKey (enumerator_58630.current_mModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1427)), var_routineSignature, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1430)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1425)) ;
    }
    enumerator_58630.gotoNextObject () ;
  }
  cEnumerator_externTypeMethodList enumerator_59336 (object->mAttribute_mExternTypeMethodList, kEnumeration_up) ;
  while (enumerator_59336.hasCurrentObject ()) {
    GALGAS_formalParameterSignature var_routineSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1436)) ;
    cEnumerator_formalParameterListAST enumerator_59433 (enumerator_59336.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_59433.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59433.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1441)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1439)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_59433.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1444)) ;
      enumerator_59433.gotoNextObject () ;
    }
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_59336.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1449)), var_routineSignature, enumerator_59336.current_mDeclarationLocation (HERE), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1453)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1447)) ;
    }
    enumerator_59336.gotoNextObject () ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mExternTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1461)), GALGAS_typeKindEnum::constructor_graphType (SOURCE_FILE_AT_LINE (1462)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1463)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1464)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1465)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1470)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1471)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1472)), GALGAS_uint ((PMUInt32) 0U), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1474)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1475)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1476)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1477)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1478)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1479)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1481)), GALGAS_string ("default"), inCompiler COMMA_SOURCE_FILE_AT_LINE (1458)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeProxy COMMA_SOURCE_FILE_AT_LINE (1496)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstring"), var_lstringTypeProxy COMMA_SOURCE_FILE_AT_LINE (1499)) ;
  }
  GALGAS_unifiedTypeMapProxy var_graphTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mGraphTypeName.mAttribute_string, var_graphTypeProxy COMMA_SOURCE_FILE_AT_LINE (1502)) ;
  }
  GALGAS_unifiedTypeMapProxy var_associatedListTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (1505)), var_associatedListTypeProxy COMMA_SOURCE_FILE_AT_LINE (1505)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringListTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstringlist"), var_lstringListTypeProxy COMMA_SOURCE_FILE_AT_LINE (1508)) ;
  }
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1510)) ;
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1511)) ;
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1512)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1513)) ;
  GALGAS_classMethodMap var_classMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1514)) ;
  GALGAS_formalParameterSignature var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1516)) ;
  var_formalParameterList.addAssign_operation (var_associatedListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1517)) COMMA_SOURCE_FILE_AT_LINE (1517)) ;
  var_formalParameterList.addAssign_operation (var_lstringListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1518)) COMMA_SOURCE_FILE_AT_LINE (1518)) ;
  var_formalParameterList.addAssign_operation (var_associatedListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1519)) COMMA_SOURCE_FILE_AT_LINE (1519)) ;
  var_formalParameterList.addAssign_operation (var_lstringListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1520)) COMMA_SOURCE_FILE_AT_LINE (1520)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("topologicalSort"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1522)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1523)), var_formalParameterList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1527)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1521)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("undefinedNodeCount"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1531)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("undefinedNodeKeyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1539)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("undefinedNodeReferenceList"), GALGAS_string ("lstringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1547)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("graphviz"), GALGAS_string ("string"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1555)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("arcs"), GALGAS_string ("2stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1563)) ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("emptyGraph"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1572)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1573)), GALGAS_bool (false), var_graphTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1571)) ;
  }
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1578)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1579)) COMMA_SOURCE_FILE_AT_LINE (1579)) ;
  cEnumerator_unifiedTypeMapProxyList enumerator_64613 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE_AT_LINE (1580)), kEnumeration_up) ;
  while (enumerator_64613.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (enumerator_64613.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1581)) COMMA_SOURCE_FILE_AT_LINE (1581)) ;
    enumerator_64613.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_64742 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_64742.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_64742.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1586)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1589)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1584)) ;
    }
    enumerator_64742.gotoNextObject () ;
  }
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1594)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1595)) COMMA_SOURCE_FILE_AT_LINE (1595)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1596)) COMMA_SOURCE_FILE_AT_LINE (1596)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("addArc"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1598)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1599)), var_formalParameterList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1602)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1597)) ;
  }
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1606)) ;
  ...
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("noteNode"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1609)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1610)), var_formalParameterList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1613)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1608)) ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mGraphTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1617)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mGraphTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1631)), GALGAS_typeKindEnum::constructor_graphType (SOURCE_FILE_AT_LINE (1632)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1633)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1634)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1635)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1640)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1641)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1642)), function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (1643)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1644)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1645)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1646)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1647)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1648)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1649)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1651)), GALGAS_string ("emptyGraph"), inCompiler COMMA_SOURCE_FILE_AT_LINE (1628)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1667)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1668)) ;
  GALGAS_classMethodMap var_classMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1669)) ;
  GALGAS_unifiedTypeMapProxy var_currentTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1672)), var_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1672)) ;
  }
  GALGAS_stringset var_constantSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1674)) ;
  cEnumerator_lstringlist enumerator_68017 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_68017.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_68017.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1676)) COMMA_SOURCE_FILE_AT_LINE (1676)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_68017.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1677)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1677)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1677)) ;
    }
    enumerator_68017.gotoNextObject () ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1681)) ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mEnumTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1683)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mEnumTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1697)), GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE_AT_LINE (1698)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1699)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1700)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1701)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1706)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1707)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1708)), function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (1709)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1709)) COMMA_SOURCE_FILE_AT_LINE (1709)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1710)), var_constantSet, object->mAttribute_mConstantList, GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1713)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1714)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1715)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1717)), object->mAttribute_mConstantList.reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1718)).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1694)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_filewrapperDeclarationAST * object = (const cPtr_filewrapperDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_filewrapperDeclarationAST) ;
  GALGAS_filewrapperTemplateMap var_filewrapperTemplateMap = GALGAS_filewrapperTemplateMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1803)) ;
  cEnumerator_filewrapperTemplateListAST enumerator_72610 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_72610.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxyList var_templateSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1805)) ;
    cEnumerator_formalTemplateInputParameterListAST enumerator_72728 (enumerator_72610.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_72728.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_72728.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1808)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1808)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1809)) ;
      enumerator_72728.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_72610.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_72610.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1811)) ;
    }
    enumerator_72610.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_textExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1818)) ;
  cEnumerator_lstringlist enumerator_73263 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_73263.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_73263.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1820)) ;
    }
    enumerator_73263.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_binaryFileExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1823)) ;
  cEnumerator_lstringlist enumerator_73469 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_73469.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_73469.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1825)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_73469.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_73469.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1826)) COMMA_SOURCE_FILE_AT_LINE (1826)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1826)) COMMA_SOURCE_FILE_AT_LINE (1826)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_73469.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1828)) ;
      }
    }
    enumerator_73469.gotoNextObject () ;
  }
  ...
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1835)).reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1835)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
  if (kBoolTrue == test_2) {
    var_absoluteSourcePath = object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1836)) ;
  }else if (kBoolFalse == test_2) {
    var_absoluteSourcePath = object->mAttribute_mSourceFileAbsolutePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (1838)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1838)).operator_concat (object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1838)) COMMA_SOURCE_FILE_AT_LINE (1838)) ;
  }
  const enumGalgasBool test_3 = var_absoluteSourcePath.reader_directoryExists (SOURCE_FILE_AT_LINE (1840)).operator_not (SOURCE_FILE_AT_LINE (1840)).boolEnum () ;
  if (kBoolTrue == test_3) {
    GALGAS_location location_4 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_4, GALGAS_string ("The '").operator_concat (var_absoluteSourcePath COMMA_SOURCE_FILE_AT_LINE (1841)).operator_concat (GALGAS_string ("' directory does not exist") COMMA_SOURCE_FILE_AT_LINE (1841)) COMMA_SOURCE_FILE_AT_LINE (1841)) ;
    ...
    {
    routine_recursivelyEnumerateDirectories (var_absoluteSourcePath, GALGAS_string ("/"), var_textExtensionMap, var_binaryFileExtensionMap, var_regularRootFileMap, var_wrapperDirectoryMap, var_wrapperFileIndex, var_wrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1847)) ;
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFilewrapperMap.modifier_insertKey (object->mAttribute_mFilewrapperName, object->mAttribute_mFilewrapperPath, object->mAttribute_mFilewrapperTextFileExtensionList, var_regularRootFileMap, var_wrapperDirectoryMap, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1859)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_listDeclarationAST) ;
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1878)) ;
  cEnumerator_attributeInCollectionListAST enumerator_75419 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_75419.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_75419.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1881)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1881)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_75679 (enumerator_75419.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_75679.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_75679.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_75679.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_75679.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_75419.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1891)) ;
    enumerator_75419.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (1895)) ;
  }
  GALGAS_unifiedTypeMapProxy var_listTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (1898)), var_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (1898)) ;
  }
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1900)) ;
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1901)) ;
  GALGAS_formalParameterSignature var_modifierOutputFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1902)) ;
  GALGAS_formalParameterSignature var_modifierInputFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1903)) ;
  cEnumerator_typedAttributeList enumerator_76624 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_76624.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_76624.current_mAttributeTypeProxy (HERE), enumerator_76624.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1905)) COMMA_SOURCE_FILE_AT_LINE (1905)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_76624.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (1906)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_76624.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1907)) COMMA_SOURCE_FILE_AT_LINE (1907)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_76624.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1908)) COMMA_SOURCE_FILE_AT_LINE (1908)) ;
    enumerator_76624.gotoNextObject () ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1911)) ;
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyList"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (1912)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1912)) ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("listWithValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1914)), var_constructorAttributeTypeList, GALGAS_bool (false), var_listTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1913)) ;
  }
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1920)) ;
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("length"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1921)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("range"), GALGAS_string ("range"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1922)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("subListFromIndex"), GALGAS_string ("uint"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (1923)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1923)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("subListWithRange"), GALGAS_string ("range"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (1924)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1924)) ;
  }
  cEnumerator_typedAttributeList enumerator_77892 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_77892.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_77892.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_77892.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1928)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1928)), enumerator_77892.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1928)) COMMA_SOURCE_FILE_AT_LINE (1928)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1929)), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_uintType COMMA_SOURCE_FILE_AT_LINE (1930)), inCompiler->here (), GALGAS_bool (true), enumerator_77892.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1934)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1927)) ;
      }
    }
    enumerator_77892.gotoNextObject () ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1940)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popFirst"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1942)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1943)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1946)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1941)) ;
  }
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popLast"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1950)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1951)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1954)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1949)) ;
  }
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("prependValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1958)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1959)), var_modifierInputFormalArgumentList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1962)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1957)) ;
  }
  cEnumerator_typedAttributeList enumerator_79009 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_79009.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_79009.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_formalParameterSignature var_setterFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1967)) ;
      var_setterFormalArgumentList.addAssign_operation (enumerator_79009.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1968)) COMMA_SOURCE_FILE_AT_LINE (1968)) ;
      var_setterFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1969)) COMMA_SOURCE_FILE_AT_LINE (1969)) ;
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_79009.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1971)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1971)) COMMA_SOURCE_FILE_AT_LINE (1971)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1971)), enumerator_79009.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1971)) COMMA_SOURCE_FILE_AT_LINE (1971)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1972)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1975)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1970)) ;
      }
    }
    enumerator_79009.gotoNextObject () ;
  }
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1981)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("first"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1983)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1984)), var_modifierOutputFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1988)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1982)) ;
  }
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("last"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1992)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1993)), var_modifierOutputFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1997)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1991)) ;
  }
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2000)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2001)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2002)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mListTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2004)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2017)) COMMA_SOURCE_FILE_AT_LINE (2017)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2015)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2024)), GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (2025)), var_typedAttributeList, GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2027)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2028)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2033)), var_enumerationDescriptor, var_enumerationVariants, function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2036)).operator_or (function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2036)) COMMA_SOURCE_FILE_AT_LINE (2036)).operator_or (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2036)) COMMA_SOURCE_FILE_AT_LINE (2036)), var_constructorAttributeTypeList, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2038)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2039)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2040)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2041)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2042)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptyList"), inCompiler COMMA_SOURCE_FILE_AT_LINE (2021)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2059)) ;
  }
  GALGAS_unifiedTypeMapProxy var_listTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2062)), var_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (2062)) ;
  }
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2064)) ;
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2065)) ;
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2066)) ;
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2067)) ;
  cEnumerator_attributeInCollectionListAST enumerator_82773 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_82773.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_82773.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2070)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2070)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_82773.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2073)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_82773.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2074)) COMMA_SOURCE_FILE_AT_LINE (2074)) ;
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2075)) ;
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2076)) COMMA_SOURCE_FILE_AT_LINE (2076)) ;
    enumerator_82773.gotoNextObject () ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2079)) ;
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptySortedList"), object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2080)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2080)) ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("sortedListWithValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2082)), var_constructorAttributeTypeList, GALGAS_bool (false), var_listTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2081)) ;
  }
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2088)) ;
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("length"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2089)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2091)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popGreatest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2093)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2094)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2097)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2092)) ;
  }
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popSmallest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2101)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2102)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2105)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2100)) ;
  }
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2109)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("greatest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2111)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2112)), var_modifierFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2116)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2110)) ;
  }
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("smallest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2120)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2121)), var_modifierFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2125)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2119)) ;
  }
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2129)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2130)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2131)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mSortedListTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2133)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mSortedListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2145)) COMMA_SOURCE_FILE_AT_LINE (2145)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2145)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mSortedListTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2150)), GALGAS_typeKindEnum::constructor_sortedListType (SOURCE_FILE_AT_LINE (2151)), var_typedAttributeList, GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2153)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2154)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2159)), var_enumerationDescriptor, var_enumerationVariants, function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2162)).operator_or (function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2162)) COMMA_SOURCE_FILE_AT_LINE (2162)).operator_or (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2162)) COMMA_SOURCE_FILE_AT_LINE (2162)), var_constructorAttributeTypeList, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2164)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2165)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2166)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2167)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2168)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptySortedList"), inCompiler COMMA_SOURCE_FILE_AT_LINE (2147)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (2185)), var_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (2185)) ;
  }
  GALGAS_attributeMap var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2187)) ;
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2188)) ;
  ...
  cEnumerator_attributeInCollectionListAST enumerator_87299 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_87299.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_87299.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2193)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2193)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2194)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_87299.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2197)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_87299.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2198)) ;
    }
    enumerator_87299.gotoNextObject () ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2201)), var_constructorAttributeTypeList, GALGAS_bool (false), var_structTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2200)) ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2208)) ;
  }
  cEnumerator_typedAttributeList enumerator_88037 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_88037.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_88037.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2215)), enumerator_88037.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2216)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2212)) ;
    }
    enumerator_88037.gotoNextObject () ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2222)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2224)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mStructTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2226)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    var_enumeratedType = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2239)) ;
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumeratedElementTypeName, var_enumeratedType COMMA_SOURCE_FILE_AT_LINE (2241)) ;
    }
  }
  GALGAS_string var_defaultConstructorName = GALGAS_string ("default") ;
  cEnumerator_typedAttributeList enumerator_89219 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_89219.hasCurrentObject () && bool_1) {
    while (enumerator_89219.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_89219.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2250)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_89219.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2250)).operator_not (SOURCE_FILE_AT_LINE (2250)) COMMA_SOURCE_FILE_AT_LINE (2250)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_89219.gotoNextObject () ;
      if (enumerator_89219.hasCurrentObject ()) {
        bool_1 = GALGAS_bool (kIsNotEqual, var_defaultConstructorName.objectCompare (GALGAS_string::makeEmptyString ())).isValidAndTrue () ;
      }
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mStructTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2258)), GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (2259)), var_typedAttributeList, var_attributeMap, var_typedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2267)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2268)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2269)), function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (2270)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2271)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2272)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2273)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2274)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2275)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2276)), GALGAS_bool (false), var_enumeratedType, var_defaultConstructorName, inCompiler COMMA_SOURCE_FILE_AT_LINE (2255)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2292)) ;
  }
  GALGAS_readerMap var_readerMap ;
  GALGAS_modifierMap var_modifierMap ;
  GALGAS_instanceMethodMap var_instanceMethodMap ;
  GALGAS_typedAttributeList var_inheritedTypedAttributeList ;
  GALGAS_attributeMap var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2298)) ;
  GALGAS_unifiedTypeMapProxy var_superClassIndex ;
  GALGAS_bool var_generateHeaderInSeparateFile ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2302)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_superClassIndex = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2303)) ;
    {
    routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2304)) ;
    }
    var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2305)) ;
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2306)) ;
    var_inheritedTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2307)) ;
    var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2308)) ;
    var_generateHeaderInSeparateFile = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_91613 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_91613.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_91613.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2311)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_91613.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2316)), var_superClassIndex COMMA_SOURCE_FILE_AT_LINE (2316)) ;
    }
    GALGAS_typeKindEnum var_typeKindEnum ;
    ...
    GALGAS_bool joker_92106_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_92106_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_92191_2 ; // Joker input parameter
    GALGAS_constructorMap joker_92191_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_92282_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_92282_9 ; // Joker input parameter
    GALGAS_stringlist joker_92282_8 ; // Joker input parameter
    GALGAS_uint joker_92282_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_92282_6 ; // Joker input parameter
    GALGAS_stringset joker_92282_5 ; // Joker input parameter
    GALGAS_lstringlist joker_92282_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_92282_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_92282_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_92282_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_92328_2 ; // Joker input parameter
    GALGAS_string joker_92328_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_92106_2, joker_92106_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_92191_2, joker_92191_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_92282_10, joker_92282_9, joker_92282_8, joker_92282_7, joker_92282_6, joker_92282_5, joker_92282_4, joker_92282_3, joker_92282_2, joker_92282_1, var_generateHeaderInSeparateFile, joker_92328_2, joker_92328_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2321)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2336)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (object->mAttribute_mSuperClassName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the @").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2337)) COMMA_SOURCE_FILE_AT_LINE (2337)).operator_concat (GALGAS_string (" should be a class type") COMMA_SOURCE_FILE_AT_LINE (2337)) COMMA_SOURCE_FILE_AT_LINE (2337)) ;
    }
    var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2340)) ;
    cEnumerator_modifierMap enumerator_92617 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_92617.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_92617.current_lkey (HERE), enumerator_92617.current_mKind (HERE), enumerator_92617.current_mParameterList (HERE), enumerator_92617.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2347)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2342)) ;
      }
      enumerator_92617.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2352)) ;
    cEnumerator_readerMap enumerator_92943 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_92943.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_92943.current_lkey (HERE), enumerator_92943.current_mKind (HERE), enumerator_92943.current_mArgumentTypeList (HERE), enumerator_92943.current_mDeclarationLocation (HERE), enumerator_92943.current_mHasCompilerArgument (HERE), enumerator_92943.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2361)), enumerator_92943.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2354)) ;
      }
      enumerator_92943.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2366)) ;
    cEnumerator_instanceMethodMap enumerator_93331 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_93331.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_93331.current_lkey (HERE), enumerator_93331.current_mKind (HERE), enumerator_93331.current_mParameterList (HERE), enumerator_93331.current_mDeclarationLocation (HERE), enumerator_93331.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2374)), enumerator_93331.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2368)) ;
      }
      enumerator_93331.gotoNextObject () ;
    }
  }
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2380)) ;
  cEnumerator_typedAttributeList enumerator_93750 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_93750.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_93750.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2382)) ;
    enumerator_93750.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_93853 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_93853.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_93853.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2386)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2386)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2387)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_93853.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2388)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_93853.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2389)) COMMA_SOURCE_FILE_AT_LINE (2389)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_93853.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_93853.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2390)) COMMA_SOURCE_FILE_AT_LINE (2390)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader") COMMA_SOURCE_FILE_AT_LINE (2390)) COMMA_SOURCE_FILE_AT_LINE (2390)) ;
    }
    enumerator_93853.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_classIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (2396)), var_classIndex COMMA_SOURCE_FILE_AT_LINE (2394)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2400)) ;
  const enumGalgasBool test_6 = object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (2401)).boolEnum () ;
  if (kBoolTrue == test_6) {
    {
    var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2403)), var_constructorAttributeTypeList, GALGAS_bool (false), var_classIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2402)) ;
    }
  }
  GALGAS_typedAttributeList var_currentClassTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2410)) ;
  GALGAS_typedAttributeList var_allTypedAttributeList = var_inheritedTypedAttributeList ;
  cEnumerator_attributeInCollectionListAST enumerator_94961 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_94961.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_94961.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2414)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2414)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_95221 (enumerator_94961.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_95221.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_95221.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2418)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_95221.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2420)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_95221.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_94961.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2424)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_94961.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2425)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_94961.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2429)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2430)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2434)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2427)) ;
      }
    }
    enumerator_94961.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_96277 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_96277.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_96277.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_96277.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2449)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2449)) COMMA_SOURCE_FILE_AT_LINE (2449)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2449)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2450)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_96277.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2451)) COMMA_SOURCE_FILE_AT_LINE (2451)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2453)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2448)) ;
      }
    }
    enumerator_96277.gotoNextObject () ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mClassTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2459)) ;
  }
  GALGAS_string var_defaultConstructorName ;
  const enumGalgasBool test_11 = var_superClassIndex.reader_isNull (SOURCE_FILE_AT_LINE (2471)).boolEnum () ;
  if (kBoolTrue == test_11) {
    var_defaultConstructorName = GALGAS_string ("default") ;
  }else if (kBoolFalse == test_11) {
    var_defaultConstructorName = var_superClassIndex.reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2474)) ;
  }
  cEnumerator_typedAttributeList enumerator_97298 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_97298.hasCurrentObject () && bool_12) {
    while (enumerator_97298.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_97298.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2477)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_97298.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2477)).operator_not (SOURCE_FILE_AT_LINE (2477)) COMMA_SOURCE_FILE_AT_LINE (2477)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_97298.gotoNextObject () ;
      if (enumerator_97298.hasCurrentObject ()) {
        bool_12 = GALGAS_bool (kIsNotEqual, var_defaultConstructorName.objectCompare (GALGAS_string::makeEmptyString ())).isValidAndTrue () ;
      }
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mClassTypeName, object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (2484)), var_superClassIndex, GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2486)), var_allTypedAttributeList, var_attributeMap, var_currentClassTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2494)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2495)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2496)), GALGAS_uint ((PMUInt32) 0U), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2498)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2499)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2500)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2501)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2502)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2503)), var_generateHeaderInSeparateFile, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2505)), var_defaultConstructorName, inCompiler COMMA_SOURCE_FILE_AT_LINE (2482)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externRoutineDeclarationAST * object = (const cPtr_externRoutineDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_externRoutineDeclarationAST) ;
  GALGAS_formalParameterSignature var_routineSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2519)) ;
  cEnumerator_formalParameterListAST enumerator_98946 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_98946.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_98946.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2522)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2522)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_98946.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (2523)) ;
    enumerator_98946.gotoNextObject () ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mRoutineMap.modifier_insertKey (object->mAttribute_mRoutineName, var_routineSignature, inCompiler COMMA_SOURCE_FILE_AT_LINE (2526)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externFunctionDeclarationAST * object = (const cPtr_externFunctionDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_externFunctionDeclarationAST) ;
  GALGAS_unifiedTypeMapProxyList var_functionSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2538)) ;
  cEnumerator_formalInputParameterListAST enumerator_99941 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_99941.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_99941.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2541)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2541)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2542)) ;
    enumerator_99941.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName.reader_string (SOURCE_FILE_AT_LINE (2546)), var_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2546)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2548)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName.reader_string (SOURCE_FILE_AT_LINE (2561)), var_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2561)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2563)), var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2563)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_arrayDeclarationAST) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2575)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mDimension.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the dimension of an array should be > 0") COMMA_SOURCE_FILE_AT_LINE (2576)) ;
  }
  GALGAS_unifiedTypeMapProxy var_arrayTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mArrayTypeName.reader_string (SOURCE_FILE_AT_LINE (2580)), var_arrayTypeIndex COMMA_SOURCE_FILE_AT_LINE (2580)) ;
  }
  GALGAS_unifiedTypeMapProxy var_elementTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mElementTypeName.reader_string (SOURCE_FILE_AT_LINE (2583)), var_elementTypeIndex COMMA_SOURCE_FILE_AT_LINE (2583)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2585)) ;
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2586)) ;
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2587)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2588)) ;
  GALGAS_unifiedTypeMapProxy var_boolType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("bool"), var_boolType COMMA_SOURCE_FILE_AT_LINE (2591)) ;
  }
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2594)) ;
  }
  GALGAS_unifiedTypeMapProxyList var_uintArgs = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2596)) ;
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2598)).isValid ()) {
    PMUInt32 variant_102731 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2598)).uintValue () ;
    bool loop_102731 = true ;
    while (loop_102731) {
      loop_102731 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2598)))).isValid () ;
      if (loop_102731) {
        loop_102731 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2598)))).boolValue () ;
      }
      if (loop_102731 && (0 == variant_102731)) {
        loop_102731 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2598)) ;
      }
      if (loop_102731) {
        variant_102731 -- ;
        var_uintArgs.addAssign_operation (var_uintType COMMA_SOURCE_FILE_AT_LINE (2599)) ;
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (2600)) ;
      }
    }
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2604)), var_uintArgs, GALGAS_bool (false), var_arrayTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2603)) ;
  }
  {
  routine_enterBaseReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("axisCount"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2610)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("sizeForAxis"), GALGAS_string ("uint"), GALGAS_string ("uint"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2611)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("rangeForAxis"), GALGAS_string ("uint"), GALGAS_string ("range"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2612)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("isValueValidAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2614)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2615)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_boolType, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2620)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2613)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("valueAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2624)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2625)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_elementTypeIndex, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2630)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2623)) ;
  }
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2634)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_elementTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2635)) COMMA_SOURCE_FILE_AT_LINE (2635)) ;
  var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2637)).isValid ()) {
    PMUInt32 variant_103984 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2637)).uintValue () ;
    bool loop_103984 = true ;
    while (loop_103984) {
      loop_103984 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2637)))).isValid () ;
      if (loop_103984) {
        loop_103984 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2637)))).boolValue () ;
      }
      if (loop_103984 && (0 == variant_103984)) {
        loop_103984 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2637)) ;
      }
      if (loop_103984) {
        variant_103984 -- ;
        var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2638)) COMMA_SOURCE_FILE_AT_LINE (2638)) ;
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (2639)) ;
      }
    }
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2642)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2643)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2646)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2641)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("forceValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2650)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2651)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2654)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2649)) ;
  }
  {
  GALGAS_unifiedTypeMapProxy joker_104579_0 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_104582_0 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_104579_0, joker_104582_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2657)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("invalidateValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2659)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2660)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2663)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2658)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSize").reader_nowhere (SOURCE_FILE_AT_LINE (2667)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2668)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2671)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2666)) ;
  }
  var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2674)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2675)) COMMA_SOURCE_FILE_AT_LINE (2675)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2676)) COMMA_SOURCE_FILE_AT_LINE (2676)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSizeForAxis").reader_nowhere (SOURCE_FILE_AT_LINE (2678)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2679)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2682)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2677)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mArrayTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2689)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE_AT_LINE (2690)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2691)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2692)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2693)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2698)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2699)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2700)), GALGAS_uint ((PMUInt32) 0U), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2702)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2703)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2704)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2705)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2706)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2707)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2709)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2686)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_106966_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_106966_1 ; // Joker input parameter
  GALGAS_attributeMap joker_107055_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_107055_18 ; // Joker input parameter
  GALGAS_constructorMap joker_107055_17 ; // Joker input parameter
  GALGAS_readerMap joker_107055_16 ; // Joker input parameter
  GALGAS_modifierMap joker_107055_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_107055_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_107055_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_107055_12 ; // Joker input parameter
  GALGAS_stringlist joker_107055_11 ; // Joker input parameter
  GALGAS_uint joker_107055_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_107055_9 ; // Joker input parameter
  GALGAS_stringset joker_107055_8 ; // Joker input parameter
  GALGAS_lstringlist joker_107055_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_107055_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_107055_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_107055_4 ; // Joker input parameter
  GALGAS_bool joker_107055_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_107055_2 ; // Joker input parameter
  GALGAS_string joker_107055_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_106966_2, joker_106966_1, var_typeKindEnum, var_listTypedAttributeList, joker_107055_19, joker_107055_18, joker_107055_17, joker_107055_16, joker_107055_15, joker_107055_14, joker_107055_13, joker_107055_12, joker_107055_11, joker_107055_10, joker_107055_9, joker_107055_8, joker_107055_7, joker_107055_6, joker_107055_5, joker_107055_4, joker_107055_3, joker_107055_2, joker_107055_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2724)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (2731)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2732)) COMMA_SOURCE_FILE_AT_LINE (2732)).operator_concat (GALGAS_string ("' type should be a list type") COMMA_SOURCE_FILE_AT_LINE (2732)) COMMA_SOURCE_FILE_AT_LINE (2732)) ;
    var_listTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2733)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2736)) ;
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2737)) ;
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2738)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2739)) ;
  GALGAS_unifiedTypeMapProxy var_associatedListTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2742)), var_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (2742)) ;
  }
  GALGAS_unifiedTypeMapProxy var_currentTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2745)), var_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (2745)) ;
  }
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2748)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("count"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2750)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("allKeys"), GALGAS_string ("stringset"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2751)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2752)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("listForKey"), GALGAS_string ("string"), object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2753)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2753)) ;
  }
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyMap"), object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2755)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2755)) ;
  }
  GALGAS_enumerationDescriptorList var_enumeratorDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2757)) ;
  var_enumeratorDescriptor.addAssign_operation (var_stringTypeIndex, GALGAS_string ("key") COMMA_SOURCE_FILE_AT_LINE (2758)) ;
  var_enumeratorDescriptor.addAssign_operation (var_associatedListTypeIndex, GALGAS_string ("mList") COMMA_SOURCE_FILE_AT_LINE (2759)) ;
  GALGAS_unifiedTypeMapProxyList var_addAssignOperatorDescription = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2761)) ;
  var_addAssignOperatorDescription.addAssign_operation (var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2762)) ;
  cEnumerator_typedAttributeList enumerator_109079 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_109079.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_109079.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2764)) ;
    enumerator_109079.gotoNextObject () ;
  }
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2767)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2768)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2769)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mListmapTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2771)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2783)) COMMA_SOURCE_FILE_AT_LINE (2783)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2783)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListmapTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2788)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE_AT_LINE (2789)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2790)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2791)), var_listTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2797)), var_enumeratorDescriptor, var_enumerationVariants, function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2800)), var_addAssignOperatorDescription, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2802)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2803)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2804)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2805)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2806)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptyMap"), inCompiler COMMA_SOURCE_FILE_AT_LINE (2785)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_predefinedTypeAST * object = (const cPtr_predefinedTypeAST *) inObject ;
  macroValidSharedObject (object, const cPtr_predefinedTypeAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mPredefinedTypeName COMMA_SOURCE_FILE_AT_LINE (2842)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2842)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_predefinedTypeAST temp_0 = object ;
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_classDeclarationAST * object = (const cPtr_classDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_classDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (2855)) COMMA_SOURCE_FILE_AT_LINE (2855)), object->mAttribute_mClassTypeName.reader_location (SOURCE_FILE_AT_LINE (2855)) COMMA_SOURCE_FILE_AT_LINE (2855)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_classDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2856)) ;
  }
  ...
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2858)) COMMA_SOURCE_FILE_AT_LINE (2858)), object->mAttribute_mSuperClassName.reader_location (SOURCE_FILE_AT_LINE (2858)) COMMA_SOURCE_FILE_AT_LINE (2858)) COMMA_SOURCE_FILE_AT_LINE (2858)) ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_113258 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_113258.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_113258.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2861)) COMMA_SOURCE_FILE_AT_LINE (2861)), enumerator_113258.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2861)) COMMA_SOURCE_FILE_AT_LINE (2861)) COMMA_SOURCE_FILE_AT_LINE (2861)) ;
    }
    enumerator_113258.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_listDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2875)) COMMA_SOURCE_FILE_AT_LINE (2875)), object->mAttribute_mListTypeName.reader_location (SOURCE_FILE_AT_LINE (2875)) COMMA_SOURCE_FILE_AT_LINE (2875)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_listDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2876)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_114239 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_114239.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_114239.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2878)) COMMA_SOURCE_FILE_AT_LINE (2878)), enumerator_114239.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2878)) COMMA_SOURCE_FILE_AT_LINE (2878)) COMMA_SOURCE_FILE_AT_LINE (2878)) ;
    }
    enumerator_114239.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_structDeclarationAST * object = (const cPtr_structDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_structDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (2891)) COMMA_SOURCE_FILE_AT_LINE (2891)), object->mAttribute_mStructTypeName.reader_location (SOURCE_FILE_AT_LINE (2891)) COMMA_SOURCE_FILE_AT_LINE (2891)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  cEnumerator_attributeInCollectionListAST enumerator_115100 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_115100.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_115100.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2894)) COMMA_SOURCE_FILE_AT_LINE (2894)), enumerator_115100.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2894)) COMMA_SOURCE_FILE_AT_LINE (2894)) COMMA_SOURCE_FILE_AT_LINE (2894)) ;
    }
    enumerator_115100.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_enumDeclarationAST * object = (const cPtr_enumDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_enumDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (2907)) COMMA_SOURCE_FILE_AT_LINE (2907)), object->mAttribute_mEnumTypeName.reader_location (SOURCE_FILE_AT_LINE (2907)) COMMA_SOURCE_FILE_AT_LINE (2907)) ;
  {
  //--- @selfCopyInExpressionForGeneration
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_sortedListDeclarationAST * object = (const cPtr_sortedListDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_sortedListDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2920)) COMMA_SOURCE_FILE_AT_LINE (2920)), object->mAttribute_mSortedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2920)) COMMA_SOURCE_FILE_AT_LINE (2920)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  cEnumerator_attributeInCollectionListAST enumerator_116665 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_116665.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_116665.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2923)) COMMA_SOURCE_FILE_AT_LINE (2923)), enumerator_116665.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2923)) COMMA_SOURCE_FILE_AT_LINE (2923)) COMMA_SOURCE_FILE_AT_LINE (2923)) ;
    }
    enumerator_116665.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_arrayDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mArrayTypeName.reader_string (SOURCE_FILE_AT_LINE (2936)) COMMA_SOURCE_FILE_AT_LINE (2936)), object->mAttribute_mArrayTypeName.reader_location (SOURCE_FILE_AT_LINE (2936)) COMMA_SOURCE_FILE_AT_LINE (2936)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mElementTypeName.reader_string (SOURCE_FILE_AT_LINE (2938)) COMMA_SOURCE_FILE_AT_LINE (2938)), object->mAttribute_mElementTypeName.reader_location (SOURCE_FILE_AT_LINE (2938)) COMMA_SOURCE_FILE_AT_LINE (2938)) COMMA_SOURCE_FILE_AT_LINE (2938)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listmapDeclarationAST * object = (const cPtr_listmapDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_listmapDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2950)) COMMA_SOURCE_FILE_AT_LINE (2950)), object->mAttribute_mListmapTypeName.reader_location (SOURCE_FILE_AT_LINE (2950)) COMMA_SOURCE_FILE_AT_LINE (2950)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_listmapDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2951)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2952)) COMMA_SOURCE_FILE_AT_LINE (2952)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2952)) COMMA_SOURCE_FILE_AT_LINE (2952)) COMMA_SOURCE_FILE_AT_LINE (2952)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapDeclarationAST * object = (const cPtr_mapDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_mapDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2964)) COMMA_SOURCE_FILE_AT_LINE (2964)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2964)) COMMA_SOURCE_FILE_AT_LINE (2964)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  cEnumerator_attributeInCollectionListAST enumerator_119159 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_119159.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_119159.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2967)) COMMA_SOURCE_FILE_AT_LINE (2967)), enumerator_119159.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2967)) COMMA_SOURCE_FILE_AT_LINE (2967)) COMMA_SOURCE_FILE_AT_LINE (2967)) ;
    }
    enumerator_119159.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_uniqueMapDeclarationAST * object = (const cPtr_uniqueMapDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_uniqueMapDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2980)) COMMA_SOURCE_FILE_AT_LINE (2980)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2980)) COMMA_SOURCE_FILE_AT_LINE (2980)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  cEnumerator_attributeInCollectionListAST enumerator_120017 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_120017.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_120017.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2983)) COMMA_SOURCE_FILE_AT_LINE (2983)), enumerator_120017.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2983)) COMMA_SOURCE_FILE_AT_LINE (2983)) COMMA_SOURCE_FILE_AT_LINE (2983)) ;
    }
    enumerator_120017.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapProxyDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapProxyDeclarationAST * object = (const cPtr_mapProxyDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_mapProxyDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE_AT_LINE (2996)) COMMA_SOURCE_FILE_AT_LINE (2996)), object->mAttribute_mMapProxyTypeName.reader_location (SOURCE_FILE_AT_LINE (2996)) COMMA_SOURCE_FILE_AT_LINE (2996)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2998)) COMMA_SOURCE_FILE_AT_LINE (2998)), object->mAttribute_mAssociatedMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2998)) COMMA_SOURCE_FILE_AT_LINE (2998)) COMMA_SOURCE_FILE_AT_LINE (2998)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_graphDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_graphDeclarationAST * object = (const cPtr_graphDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_graphDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mGraphTypeName.reader_string (SOURCE_FILE_AT_LINE (3010)) COMMA_SOURCE_FILE_AT_LINE (3010)), object->mAttribute_mGraphTypeName.reader_location (SOURCE_FILE_AT_LINE (3010)) COMMA_SOURCE_FILE_AT_LINE (3010)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (3012)) COMMA_SOURCE_FILE_AT_LINE (3012)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (3012)) COMMA_SOURCE_FILE_AT_LINE (3012)) COMMA_SOURCE_FILE_AT_LINE (3012)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externTypeDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externTypeDeclarationAST * object = (const cPtr_externTypeDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_externTypeDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mExternTypeName.reader_string (SOURCE_FILE_AT_LINE (3024)) COMMA_SOURCE_FILE_AT_LINE (3024)), object->mAttribute_mExternTypeName.reader_location (SOURCE_FILE_AT_LINE (3024)) COMMA_SOURCE_FILE_AT_LINE (3024)) ;
  {
  //--- @selfCopyInExpressionForGeneration
...
static void categoryMethod_externFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3037)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3049)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3061)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3073)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3085)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3097)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3109)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3121)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryReaderAST * object = (const cPtr_categoryReaderAST *) inObject ;
  macroValidSharedObject (object, const cPtr_categoryReaderAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3145)) COMMA_SOURCE_FILE_AT_LINE (3145)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3145)).operator_concat (object->mAttribute_mCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (3145)) COMMA_SOURCE_FILE_AT_LINE (3145)), object->mAttribute_mCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (3145)) COMMA_SOURCE_FILE_AT_LINE (3145)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3147)) COMMA_SOURCE_FILE_AT_LINE (3147)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3147)) COMMA_SOURCE_FILE_AT_LINE (3147)) COMMA_SOURCE_FILE_AT_LINE (3147)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3149)) COMMA_SOURCE_FILE_AT_LINE (3149)).operator_not (SOURCE_FILE_AT_LINE (3149)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3152)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3150)) ;
    }
  }
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_129099 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3155)) ;
  if (NULL != objectArray_129099) {
      macroValidSharedObject (objectArray_129099, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_129099->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3156)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryMethodAST * object = (const cPtr_categoryMethodAST *) inObject ;
  macroValidSharedObject (object, const cPtr_categoryMethodAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3173)) COMMA_SOURCE_FILE_AT_LINE (3173)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3173)).operator_concat (object->mAttribute_mCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (3173)) COMMA_SOURCE_FILE_AT_LINE (3173)), object->mAttribute_mCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (3173)) COMMA_SOURCE_FILE_AT_LINE (3173)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryMethodAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3174)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3175)) COMMA_SOURCE_FILE_AT_LINE (3175)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3175)) COMMA_SOURCE_FILE_AT_LINE (3175)) COMMA_SOURCE_FILE_AT_LINE (3175)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3177)) COMMA_SOURCE_FILE_AT_LINE (3177)).operator_not (SOURCE_FILE_AT_LINE (3177)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3180)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3178)) ;
    }
  }
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_130400 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3183)) ;
  if (NULL != objectArray_130400) {
      macroValidSharedObject (objectArray_130400, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_130400->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3184)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryModifierAST * object = (const cPtr_categoryModifierAST *) inObject ;
  macroValidSharedObject (object, const cPtr_categoryModifierAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3200)) COMMA_SOURCE_FILE_AT_LINE (3200)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3200)).operator_concat (object->mAttribute_mCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (3200)) COMMA_SOURCE_FILE_AT_LINE (3200)), object->mAttribute_mCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (3200)) COMMA_SOURCE_FILE_AT_LINE (3200)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryModifierAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3201)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3202)) COMMA_SOURCE_FILE_AT_LINE (3202)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3202)) COMMA_SOURCE_FILE_AT_LINE (3202)) COMMA_SOURCE_FILE_AT_LINE (3202)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3204)) COMMA_SOURCE_FILE_AT_LINE (3204)).operator_not (SOURCE_FILE_AT_LINE (3204)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3207)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3205)) ;
    }
  }
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_131671 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3210)) ;
  if (NULL != objectArray_131671) {
      macroValidSharedObject (objectArray_131671, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_131671->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3211)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3227)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryReaderAST * object = (const cPtr_abstractCategoryReaderAST *) inObject ;
  macroValidSharedObject (object, const cPtr_abstractCategoryReaderAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3239)) COMMA_SOURCE_FILE_AT_LINE (3239)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3239)).operator_concat (object->mAttribute_mAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (3239)) COMMA_SOURCE_FILE_AT_LINE (3239)), object->mAttribute_mAbstractCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (3239)) COMMA_SOURCE_FILE_AT_LINE (3239)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_abstractCategoryReaderAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3240)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3241)) COMMA_SOURCE_FILE_AT_LINE (3241)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3241)) COMMA_SOURCE_FILE_AT_LINE (3241)) COMMA_SOURCE_FILE_AT_LINE (3241)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3243)) COMMA_SOURCE_FILE_AT_LINE (3243)).operator_not (SOURCE_FILE_AT_LINE (3243)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3246)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3244)) ;
    }
  }
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_133571 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3249)) ;
  if (NULL != objectArray_133571) {
      macroValidSharedObject (objectArray_133571, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_133571->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3250)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryMethodAST * object = (const cPtr_abstractCategoryMethodAST *) inObject ;
  macroValidSharedObject (object, const cPtr_abstractCategoryMethodAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3267)) COMMA_SOURCE_FILE_AT_LINE (3267)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3267)).operator_concat (object->mAttribute_mAbstractCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (3267)) COMMA_SOURCE_FILE_AT_LINE (3267)), object->mAttribute_mAbstractCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (3267)) COMMA_SOURCE_FILE_AT_LINE (3267)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_abstractCategoryMethodAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3268)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3269)) COMMA_SOURCE_FILE_AT_LINE (3269)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3269)) COMMA_SOURCE_FILE_AT_LINE (3269)) COMMA_SOURCE_FILE_AT_LINE (3269)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3271)) COMMA_SOURCE_FILE_AT_LINE (3271)).operator_not (SOURCE_FILE_AT_LINE (3271)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3274)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3272)) ;
    }
  }
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_134920 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3277)) ;
  if (NULL != objectArray_134920) {
      macroValidSharedObject (objectArray_134920, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_134920->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3278)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryModifierAST * object = (const cPtr_abstractCategoryModifierAST *) inObject ;
  macroValidSharedObject (object, const cPtr_abstractCategoryModifierAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3294)) COMMA_SOURCE_FILE_AT_LINE (3294)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3294)).operator_concat (object->mAttribute_mAbstractCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (3294)) COMMA_SOURCE_FILE_AT_LINE (3294)), object->mAttribute_mAbstractCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (3294)) COMMA_SOURCE_FILE_AT_LINE (3294)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_abstractCategoryModifierAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3295)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3296)) COMMA_SOURCE_FILE_AT_LINE (3296)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3296)) COMMA_SOURCE_FILE_AT_LINE (3296)) COMMA_SOURCE_FILE_AT_LINE (3296)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3298)) COMMA_SOURCE_FILE_AT_LINE (3298)).operator_not (SOURCE_FILE_AT_LINE (3298)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3301)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3299)) ;
    }
  }
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_136231 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3304)) ;
  if (NULL != objectArray_136231) {
      macroValidSharedObject (objectArray_136231, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_136231->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3305)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapDeclarationAST * object = (const cPtr_mapDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_mapDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3324)) ;
  var_structAttributeList.addAssign_operation (GALGAS_string ("lstring").reader_nowhere (SOURCE_FILE_AT_LINE (3326)), GALGAS_string ("lkey").reader_nowhere (SOURCE_FILE_AT_LINE (3327)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3328)) COMMA_SOURCE_FILE_AT_LINE (3325)) ;
  cEnumerator_attributeInCollectionListAST enumerator_137070 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_137070.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_137070.current_mAttributeTypeName (HERE), enumerator_137070.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3334)) COMMA_SOURCE_FILE_AT_LINE (3331)) ;
    enumerator_137070.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mMapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3339)) COMMA_SOURCE_FILE_AT_LINE (3339)), object->mAttribute_mMapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3339)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3337)) COMMA_SOURCE_FILE_AT_LINE (3337)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_listDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3350)) ;
  cEnumerator_attributeInCollectionListAST enumerator_137704 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_137704.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_137704.current_mAttributeTypeName (HERE), enumerator_137704.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3355)) COMMA_SOURCE_FILE_AT_LINE (3352)) ;
    enumerator_137704.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3360)) COMMA_SOURCE_FILE_AT_LINE (3360)), object->mAttribute_mListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3360)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3358)) COMMA_SOURCE_FILE_AT_LINE (3358)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_sortedListDeclarationAST * object = (const cPtr_sortedListDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_sortedListDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3371)) ;
  cEnumerator_attributeInCollectionListAST enumerator_138346 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_138346.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_138346.current_mAttributeTypeName (HERE), enumerator_138346.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3376)) COMMA_SOURCE_FILE_AT_LINE (3373)) ;
    enumerator_138346.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mSortedListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3381)) COMMA_SOURCE_FILE_AT_LINE (3381)), object->mAttribute_mSortedListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3381)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3379)) COMMA_SOURCE_FILE_AT_LINE (3379)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listmapDeclarationAST * object = (const cPtr_listmapDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_listmapDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3392)) ;
  var_structAttributeList.addAssign_operation (GALGAS_string ("string").reader_nowhere (SOURCE_FILE_AT_LINE (3394)), GALGAS_string ("key").reader_nowhere (SOURCE_FILE_AT_LINE (3395)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3396)) COMMA_SOURCE_FILE_AT_LINE (3393)) ;
  var_structAttributeList.addAssign_operation (object->mAttribute_mAssociatedListTypeName, GALGAS_string ("mList").reader_nowhere (SOURCE_FILE_AT_LINE (3400)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3401)) COMMA_SOURCE_FILE_AT_LINE (3398)) ;
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3406)) COMMA_SOURCE_FILE_AT_LINE (3406)), object->mAttribute_mListmapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3406)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3404)) COMMA_SOURCE_FILE_AT_LINE (3404)) ;
}
//---------------------------------------------------------------------------*
