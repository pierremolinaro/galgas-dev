...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_76830 (var_files, kEnumeration_up) ;
  while (enumerator_76830.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_76830.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("semanticContext.gSemantics", 1896)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1896)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1897)).operator_concat (enumerator_76830.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1897)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76830.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1899)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1898)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1905)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_76830.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("semanticContext.gSemantics", 1906)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1906)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1907)).operator_concat (enumerator_76830.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1907)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76830.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1909)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1908)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1915)) ;
      }
    }
    enumerator_76830.gotoNextObject () ;
  }
  ...
  cEnumerator_stringlist enumerator_77795 (var_directories, kEnumeration_up) ;
  while (enumerator_77795.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1926)).operator_concat (enumerator_77795.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1926)), constinArgument_inPathInWrapper.operator_concat (enumerator_77795.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1927)).operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1927)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1925)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_77795.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1936)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1935)) ;
    }
    enumerator_77795.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147954 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147954.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_147954.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3604)) ;
    enumerator_147954.gotoNextObject () ;
  }
  GALGAS_semanticTypePrecedenceGraph var_semanticTypePrecedenceGraph = GALGAS_semanticTypePrecedenceGraph::constructor_emptyGraph (SOURCE_FILE ("semanticContext.gSemantics", 3610)) ;
  GALGAS_categoryMethodMapForBuildingContext var_categoryMethodMapForBuildingContext = GALGAS_categoryMethodMapForBuildingContext::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3611)) ;
  GALGAS_categoryReaderMapForBuildingContext var_categoryReaderMapForBuildingContext = GALGAS_categoryReaderMapForBuildingContext::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3612)) ;
  GALGAS_categoryModifierMapForBuildingContext var_categoryModifierMapForBuildingContext = GALGAS_categoryModifierMapForBuildingContext::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3613)) ;
  GALGAS_semanticDeclarationListAST var_categoryOverrideDefinitionList = GALGAS_semanticDeclarationListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3614)) ;
  cEnumerator_semanticDeclarationListAST enumerator_148687 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_148687.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_148687.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3616)) ;
    enumerator_148687.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE ("semanticContext.gSemantics", 3624)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_149107 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE ("semanticContext.gSemantics", 3625)), kEnumeration_up) ;
    while (enumerator_149107.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_149107.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_149107.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3626))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3626)).operator_concat (GALGAS_string ("' type is not defined")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3626))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3626)) ;
      enumerator_149107.gotoNextObject () ;
    }
    inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("semantic analysis not performed, due to undefined type error(s)")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3628)) ;
    ...
    GALGAS_lstringlist joker_149445_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_149445_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3630)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE ("semanticContext.gSemantics", 3636)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string ("semantic analysis not performed, ").operator_concat (var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE ("semanticContext.gSemantics", 3637)).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3637))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3637)).operator_concat (GALGAS_string (" declarations are involved in circular definition:")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3637)) ;
      cEnumerator_semanticDeclarationListAST enumerator_149840 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149840.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_149840.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3639))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3639))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3639)) ;
        enumerator_149840.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3641)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      var_sortedSemanticDeclarationListAST.dotAssign_operation (var_categoryOverrideDefinitionList  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3644)) ;
      outArgument_outSemanticContext = GALGAS_semanticContext::constructor_new (constinArgument_inSourceFile, GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3648)), GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3649)), GALGAS_functionMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3650)), GALGAS_filewrapperMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3651)), GALGAS_grammarMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3652)), GALGAS_optionComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3653)), GALGAS_lexiqueComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3654))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3646)) ;
      cEnumerator_semanticDeclarationListAST enumerator_150598 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_150598.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_150598.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3658)) ;
        enumerator_150598.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_externTypeDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_externTypeConstructorList enumerator_60384 (object->mAttribute_mExternTypeConstructorList, kEnumeration_up) ;
  while (enumerator_60384.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60384.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1435)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_60636 (enumerator_60384.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_60636.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60636.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1440)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_60636.current_mFormalParameterName (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1441)) ;
      enumerator_60636.gotoNextObject () ;
    }
    {
    var_constructorMap.modifier_insertKey (enumerator_60384.current_mConstructorName (HERE), var_arguments, GALGAS_bool (true), var_returnedTypeProxy, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1444)) ;
    }
    enumerator_60384.gotoNextObject () ;
  }
  cEnumerator_externTypeReaderList enumerator_61102 (object->mAttribute_mExternTypeReaderList, kEnumeration_up) ;
  while (enumerator_61102.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61102.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1454)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_61354 (enumerator_61102.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_61354.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61354.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1459)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_61354.current_mFormalParameterName (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1460)) ;
      enumerator_61354.gotoNextObject () ;
    }
    {
    var_readerMap.modifier_insertKey (enumerator_61102.current_mReaderName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1465)), var_arguments, inCompiler->here (), GALGAS_bool (true), var_returnedTypeProxy, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1470)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1463)) ;
    }
    enumerator_61102.gotoNextObject () ;
  }
  cEnumerator_externTypeModifierList enumerator_61931 (object->mAttribute_mExternTypeModifierList, kEnumeration_up) ;
  while (enumerator_61931.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_62028 (enumerator_61931.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_62028.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_62028.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1478)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_62028.current_mFormalArgumentPassingMode (HERE), enumerator_62028.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1483)) ;
      enumerator_62028.gotoNextObject () ;
    }
    {
    var_modifierMap.modifier_insertKey (enumerator_61931.current_mModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1488)), var_routineSignature, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1491)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1486)) ;
    }
    enumerator_61931.gotoNextObject () ;
  }
  cEnumerator_externTypeMethodList enumerator_62624 (object->mAttribute_mExternTypeMethodList, kEnumeration_up) ;
  while (enumerator_62624.hasCurrentObject ()) {
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_69940 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1700)), kEnumeration_up) ;
  while (enumerator_69940.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (enumerator_69940.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 1701)), enumerator_69940.current_mFormalParameterName (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1701)) ;
    enumerator_69940.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_70091 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_70091.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_70091.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1706)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1709)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1704)) ;
    }
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_74346 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_74346.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_74346.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1823))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1823)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_74346.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1824)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1824)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1824)) ;
    }
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_filewrapperTemplateListAST enumerator_79029 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_79029.hasCurrentObject ()) {
    ...
    cEnumerator_formalTemplateInputParameterListAST enumerator_79147 (enumerator_79029.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_79147.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_79147.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1958)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1959)) ;
      enumerator_79147.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_79029.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_79029.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1961)) ;
    }
    enumerator_79029.gotoNextObject () ;
  }
  ...
  cEnumerator_lstringlist enumerator_79666 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_79666.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_79666.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1970)) ;
    }
    enumerator_79666.gotoNextObject () ;
  }
  ...
  cEnumerator_lstringlist enumerator_79872 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_79872.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_79872.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1975)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_79872.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_79872.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1976))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1976)).operator_concat (GALGAS_string ("' extension is already used for text files")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1976))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1976)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_79872.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1978)) ;
      }
    }
    enumerator_79872.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_81822 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_81822.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_81822.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2030)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_82042 (enumerator_81822.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_82042.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_82042.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_82042.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_82042.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_81822.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2040)) ;
  ...
  cEnumerator_typedAttributeList enumerator_83195 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_83195.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_83195.current_mAttributeTypeProxy (HERE), enumerator_83195.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2058))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2058)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_83195.current_mAttributeTypeProxy (HERE), enumerator_83195.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2059)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_83195.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 2060)), enumerator_83195.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2060)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_83195.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2061)), enumerator_83195.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2061)) ;
    enumerator_83195.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_84604 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_84604.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_84604.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_84604.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2081)).operator_concat (GALGAS_string ("AtIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2081)), enumerator_84604.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 2081))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2081)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2082)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_listWithValue (var_uintType, GALGAS_string ("inIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2083)), inCompiler->here (), GALGAS_bool (true), enumerator_84604.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2087)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2080)) ;
      }
    }
    enumerator_84604.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_86428 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_86428.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_86428.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      ...
      var_setterFormalArgumentList.addAssign_operation (enumerator_86428.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2143)), enumerator_86428.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2143)) ;
      var_setterFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2144)), enumerator_86428.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2144)) ;
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_86428.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2146)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2146))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2146)).operator_concat (GALGAS_string ("AtIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2146)), enumerator_86428.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 2146))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2146)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2147)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2150)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2145)) ;
      }
    }
    enumerator_86428.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_90147 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_90147.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_90147.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2235)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_90147.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2238)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_90147.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2239)) ;
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_90147.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2240)) ;
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 2241)), enumerator_90147.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2241)) ;
    enumerator_90147.gotoNextObject () ;
  }
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_94676 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_94676.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_94676.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2358)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_94676.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2359)) ;
    ...
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_94676.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2363)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_94676.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2364)) ;
    }
    enumerator_94676.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_95461 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_95461.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_95461.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2381)), enumerator_95461.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2382)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2378)) ;
    }
    enumerator_95461.gotoNextObject () ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2388)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2390)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mStructTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2392)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    var_enumeratedType = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticContext.gSemantics", 2405)) ;
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumeratedElementTypeName, var_enumeratedType COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2407)) ;
    }
  }
  GALGAS_string var_defaultConstructorName = GALGAS_string ("default") ;
  cEnumerator_typedAttributeList enumerator_96643 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_96643.hasCurrentObject () && bool_1) {
    while (enumerator_96643.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_96643.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2416)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_96643.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2416)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2416)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2416)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_96643.gotoNextObject () ;
      if (enumerator_96643.hasCurrentObject ()) {
        bool_1 = GALGAS_bool (kIsNotEqual, var_defaultConstructorName.objectCompare (GALGAS_string::makeEmptyString ())).isValidAndTrue () ;
      }
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mStructTypeName, object->mAttribute_mIsPredefined, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticContext.gSemantics", 2425)), GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE ("semanticContext.gSemantics", 2426)), var_typedAttributeList, var_attributeMap, var_typedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2434)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2435)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2436)), function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2437)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2438)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticContext.gSemantics", 2439)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2440)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2441)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2442)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2443)), GALGAS_bool (false), var_enumeratedType, var_defaultConstructorName, GALGAS_string ("struct-").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2447))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2447)), GALGAS_headerKind::constructor_twoHeaders (SOURCE_FILE ("semanticContext.gSemantics", 2448)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2421)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2461)) ;
  }
  GALGAS_readerMap var_readerMap ;
  GALGAS_modifierMap var_modifierMap ;
  GALGAS_instanceMethodMap var_instanceMethodMap ;
  GALGAS_typedAttributeList var_inheritedTypedAttributeList ;
  GALGAS_attributeMap var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2467)) ;
  GALGAS_unifiedTypeMapProxy var_superClassIndex ;
  GALGAS_bool var_generateHeaderInSeparateFile ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2471)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_superClassIndex = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticContext.gSemantics", 2472)) ;
    {
    routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2473)) ;
    }
    var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2474)) ;
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2475)) ;
    var_inheritedTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2476)) ;
    var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2477)) ;
    var_generateHeaderInSeparateFile = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_99137 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_99137.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_99137.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2480)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_99137.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mSuperClassName, var_superClassIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2485)) ;
    }
    GALGAS_typeKindEnum var_typeKindEnum ;
    ...
    GALGAS_bool joker_99616_3 ; // Joker input parameter
    GALGAS_bool joker_99616_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_99616_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_99701_2 ; // Joker input parameter
    GALGAS_constructorMap joker_99701_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_99791_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_99791_9 ; // Joker input parameter
    GALGAS_stringlist joker_99791_8 ; // Joker input parameter
    GALGAS_uint joker_99791_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_99791_6 ; // Joker input parameter
    GALGAS_stringset joker_99791_5 ; // Joker input parameter
    GALGAS_lstringlist joker_99791_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_99791_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_99791_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_99791_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_99838_4 ; // Joker input parameter
    GALGAS_string joker_99838_3 ; // Joker input parameter
    GALGAS_string joker_99838_2 ; // Joker input parameter
    GALGAS_headerKind joker_99838_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_99616_3, joker_99616_2, joker_99616_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_99701_2, joker_99701_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_99791_10, joker_99791_9, joker_99791_8, joker_99791_7, joker_99791_6, joker_99791_5, joker_99791_4, joker_99791_3, joker_99791_2, joker_99791_1, var_generateHeaderInSeparateFile, joker_99838_4, joker_99838_3, joker_99838_2, joker_99838_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2490)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE ("semanticContext.gSemantics", 2505)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (object->mAttribute_mSuperClassName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the @").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2506))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2506)).operator_concat (GALGAS_string (" should be a class type")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2506))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2506)) ;
    }
    var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2509)) ;
    cEnumerator_modifierMap enumerator_100125 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_100125.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_100125.current_lkey (HERE), enumerator_100125.current_mKind (HERE), enumerator_100125.current_mParameterList (HERE), enumerator_100125.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2516)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2511)) ;
      }
      enumerator_100125.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2521)) ;
    cEnumerator_readerMap enumerator_100451 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_100451.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_100451.current_lkey (HERE), enumerator_100451.current_mKind (HERE), enumerator_100451.current_mArgumentTypeList (HERE), enumerator_100451.current_mDeclarationLocation (HERE), enumerator_100451.current_mHasCompilerArgument (HERE), enumerator_100451.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2530)), enumerator_100451.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2523)) ;
      }
      enumerator_100451.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2535)) ;
    cEnumerator_instanceMethodMap enumerator_100839 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_100839.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_100839.current_lkey (HERE), enumerator_100839.current_mKind (HERE), enumerator_100839.current_mParameterList (HERE), enumerator_100839.current_mDeclarationLocation (HERE), enumerator_100839.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2543)), enumerator_100839.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2537)) ;
      }
      enumerator_100839.gotoNextObject () ;
    }
  }
  GALGAS_unifiedTypeMapProxyAndParameterList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2549)) ;
  cEnumerator_typedAttributeList enumerator_101270 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_101270.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_101270.current_mAttributeTypeProxy (HERE), enumerator_101270.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2551)) ;
    enumerator_101270.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_101397 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_101397.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_101397.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2555)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_101397.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2556)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_101397.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2557)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_101397.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2558)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2558)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_101397.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_101397.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2559))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2559)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2559))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2559)) ;
    }
    enumerator_101397.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_classIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mClassTypeName, var_classIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2563)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2569)) ;
  const enumGalgasBool test_6 = object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2570)).boolEnum () ;
  if (kBoolTrue == test_6) {
    {
    var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2572)), var_constructorAttributeTypeList, GALGAS_bool (false), var_classIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2571)) ;
    }
  }
  GALGAS_typedAttributeList var_currentClassTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2579)) ;
  GALGAS_typedAttributeList var_allTypedAttributeList = var_inheritedTypedAttributeList ;
  cEnumerator_attributeInCollectionListAST enumerator_102497 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_102497.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_102497.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2583)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_102741 (enumerator_102497.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_102741.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_102741.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2587)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_102741.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2589)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
    ...
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_102497.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2593)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_102497.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2594)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_102497.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2598)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2599)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2603)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2596)) ;
      }
    }
    enumerator_102497.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_103809 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_103809.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_103809.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_103809.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2618)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2618))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2618)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2618)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2619)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_103809.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 2620)), enumerator_103809.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2620)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2622)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2617)) ;
      }
    }
    enumerator_103809.gotoNextObject () ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mClassTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2628)) ;
  }
  GALGAS_string var_defaultConstructorName ;
  const enumGalgasBool test_11 = var_superClassIndex.reader_isNull (SOURCE_FILE ("semanticContext.gSemantics", 2640)).boolEnum () ;
  if (kBoolTrue == test_11) {
    var_defaultConstructorName = GALGAS_string ("default") ;
  }else if (kBoolFalse == test_11) {
    var_defaultConstructorName = var_superClassIndex.reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2643)) ;
  }
  cEnumerator_typedAttributeList enumerator_104851 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_104851.hasCurrentObject () && bool_12) {
    while (enumerator_104851.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_104851.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2646)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_104851.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2646)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2646)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2646)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_104851.gotoNextObject () ;
      if (enumerator_104851.hasCurrentObject ()) {
        bool_12 = GALGAS_bool (kIsNotEqual, var_defaultConstructorName.objectCompare (GALGAS_string::makeEmptyString ())).isValidAndTrue () ;
      }
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mClassTypeName, object->mAttribute_mIsPredefined, object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2654)), var_superClassIndex, GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE ("semanticContext.gSemantics", 2656)), var_allTypedAttributeList, var_attributeMap, var_currentClassTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2664)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2665)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2666)), GALGAS_uint ((uint32_t) 0U), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2668)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticContext.gSemantics", 2669)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2670)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2671)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2672)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2673)), var_generateHeaderInSeparateFile, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticContext.gSemantics", 2675)), var_defaultConstructorName, GALGAS_string ("class-").operator_concat (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2677))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2677)), GALGAS_headerKind::constructor_twoHeaders (SOURCE_FILE ("semanticContext.gSemantics", 2678)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2651)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externRoutineDeclarationAST * object = (const cPtr_externRoutineDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_externRoutineDeclarationAST) ;
  GALGAS_formalParameterSignature var_routineSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2691)) ;
  cEnumerator_formalParameterListAST enumerator_106594 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_106594.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_106594.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2694)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_106594.current_mFormalArgumentPassingMode (HERE), enumerator_106594.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2695)) ;
    enumerator_106594.gotoNextObject () ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mRoutineMap.modifier_insertKey (object->mAttribute_mRoutineName, var_routineSignature, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2698)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externFunctionDeclarationAST * object = (const cPtr_externFunctionDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_externFunctionDeclarationAST) ;
  GALGAS_unifiedTypeMapProxyList var_functionSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2710)) ;
  cEnumerator_formalInputParameterListAST enumerator_107602 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_107602.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_107602.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2713)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2714)) ;
    enumerator_107602.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName, var_resultTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2718)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2720)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName, var_resultTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2732)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2734)), var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2734)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayDeclarationAST) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2746)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mDimension.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the dimension of an array should be > 0")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2747)) ;
  }
  GALGAS_unifiedTypeMapProxy var_arrayTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mArrayTypeName, var_arrayTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2751)) ;
  }
  GALGAS_unifiedTypeMapProxy var_elementTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mElementTypeName, var_elementTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2754)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2756)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2757)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2758)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2759)) ;
  GALGAS_unifiedTypeMapProxy var_boolType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("bool"), var_boolType COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2762)) ;
  }
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2765)) ;
  }
  GALGAS_unifiedTypeMapProxyAndParameterList var_uintArgs = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2767)) ;
  GALGAS_uint var_idx = GALGAS_uint ((uint32_t) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2769)).isValid ()) {
    uint32_t variant_110359 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2769)).uintValue () ;
    bool loop_110359 = true ;
    while (loop_110359) {
      loop_110359 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2769)))).isValid () ;
      if (loop_110359) {
        loop_110359 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2769)))).boolValue () ;
      }
      if (loop_110359 && (0 == variant_110359)) {
        loop_110359 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticContext.gSemantics", 2769)) ;
      }
      if (loop_110359) {
        variant_110359 -- ;
        var_uintArgs.addAssign_operation (var_uintType, GALGAS_string ("inSize").operator_concat (var_idx.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2770))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2770))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2770)) ;
        var_idx.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2771)) ;
      }
    }
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2775)), var_uintArgs, GALGAS_bool (false), var_arrayTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2774)) ;
  }
  {
  routine_enterBaseReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("axisCount"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2781)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("sizeForAxis"), GALGAS_string ("uint"), GALGAS_string ("inAxisIndex"), GALGAS_string ("uint"), GALGAS_bool (true), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2782)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("rangeForAxis"), GALGAS_string ("uint"), GALGAS_string ("inAxisIndex"), GALGAS_string ("range"), GALGAS_bool (true), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2783)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("isValueValidAtIndex"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2785)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2786)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_boolType, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2791)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2784)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("valueAtIndex"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2795)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2796)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_elementTypeIndex, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2801)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2794)) ;
  }
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2805)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_elementTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2806)), GALGAS_string ("InValue")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2806)) ;
  var_idx = GALGAS_uint ((uint32_t) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2808)).isValid ()) {
    uint32_t variant_111671 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2808)).uintValue () ;
    bool loop_111671 = true ;
    while (loop_111671) {
      loop_111671 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2808)))).isValid () ;
      if (loop_111671) {
        loop_111671 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2808)))).boolValue () ;
      }
      if (loop_111671 && (0 == variant_111671)) {
        loop_111671 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("semanticContext.gSemantics", 2808)) ;
      }
      if (loop_111671) {
        variant_111671 -- ;
        var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2809)), GALGAS_string ("inIndex").operator_concat (var_idx.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2809))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2809))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2809)) ;
        var_idx.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2810)) ;
      }
    }
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setValueAtIndex").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2813)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2814)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2817)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2812)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("forceValueAtIndex").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2821)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2822)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2825)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2820)) ;
  }
  {
  GALGAS_unifiedTypeMapProxy joker_112286_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_112286_2 ; // Joker input parameter
  GALGAS_string joker_112286_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_112286_3, joker_112286_2, joker_112286_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2828)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("invalidateValueAtIndex").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2830)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2831)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2834)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2829)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSize").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2838)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2839)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2842)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2837)) ;
  }
  var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2845)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2846)), GALGAS_string ("inSize")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2846)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2847)), GALGAS_string ("inAxisIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2847)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSizeForAxis").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2849)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2850)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2853)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2848)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mArrayTypeName, object->mAttribute_mIsPredefined, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticContext.gSemantics", 2861)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE ("semanticContext.gSemantics", 2862)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2863)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2864)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2865)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2870)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2871)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2872)), GALGAS_uint ((uint32_t) 0U), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2874)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticContext.gSemantics", 2875)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2876)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2877)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2878)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2879)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticContext.gSemantics", 2881)), GALGAS_string::makeEmptyString (), GALGAS_string ("array-").operator_concat (object->mAttribute_mArrayTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2883))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2883)), GALGAS_headerKind::constructor_twoHeaders (SOURCE_FILE ("semanticContext.gSemantics", 2884)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2857)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_114689_3 ; // Joker input parameter
  GALGAS_bool joker_114689_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_114689_1 ; // Joker input parameter
  GALGAS_attributeMap joker_114777_21 ; // Joker input parameter
  GALGAS_typedAttributeList joker_114777_20 ; // Joker input parameter
  GALGAS_constructorMap joker_114777_19 ; // Joker input parameter
  GALGAS_readerMap joker_114777_18 ; // Joker input parameter
  GALGAS_modifierMap joker_114777_17 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_114777_16 ; // Joker input parameter
  GALGAS_classMethodMap joker_114777_15 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_114777_14 ; // Joker input parameter
  GALGAS_stringlist joker_114777_13 ; // Joker input parameter
  GALGAS_uint joker_114777_12 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_114777_11 ; // Joker input parameter
  GALGAS_stringset joker_114777_10 ; // Joker input parameter
  GALGAS_lstringlist joker_114777_9 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_114777_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_114777_7 ; // Joker input parameter
  GALGAS_withAccessorMap joker_114777_6 ; // Joker input parameter
  GALGAS_bool joker_114777_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_114777_4 ; // Joker input parameter
  GALGAS_string joker_114777_3 ; // Joker input parameter
  GALGAS_string joker_114777_2 ; // Joker input parameter
  GALGAS_headerKind joker_114777_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_114689_3, joker_114689_2, joker_114689_1, var_typeKindEnum, var_listTypedAttributeList, joker_114777_21, joker_114777_20, joker_114777_19, joker_114777_18, joker_114777_17, joker_114777_16, joker_114777_15, joker_114777_14, joker_114777_13, joker_114777_12, joker_114777_11, joker_114777_10, joker_114777_9, joker_114777_8, joker_114777_7, joker_114777_6, joker_114777_5, joker_114777_4, joker_114777_3, joker_114777_2, joker_114777_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2897)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE ("semanticContext.gSemantics", 2904)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2905))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2905)).operator_concat (GALGAS_string ("' type should be a list type")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2905))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2905)) ;
    var_listTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2906)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2909)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2910)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2911)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2912)) ;
  GALGAS_unifiedTypeMapProxy var_associatedListTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedListTypeName, var_associatedListTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2914)) ;
  }
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2916)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("count"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2918)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("allKeys"), GALGAS_string ("stringset"), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2919)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2920)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("listForKey"), GALGAS_string ("string"), GALGAS_string ("inKey"), object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2921)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2921)) ;
  }
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyMap"), object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2923)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2923)) ;
  }
  GALGAS_enumerationDescriptorList var_enumeratorDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2925)) ;
  var_enumeratorDescriptor.addAssign_operation (var_stringTypeIndex, GALGAS_string ("key")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2926)) ;
  var_enumeratorDescriptor.addAssign_operation (var_associatedListTypeIndex, GALGAS_string ("mList")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2927)) ;
  GALGAS_unifiedTypeMapProxyAndParameterList var_addAssignOperatorDescription = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2929)) ;
  var_addAssignOperatorDescription.addAssign_operation (var_stringTypeIndex, GALGAS_string ("inKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2930)) ;
  cEnumerator_typedAttributeList enumerator_116629 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_116629.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_116629.current_mAttributeTypeProxy (HERE), enumerator_116629.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2932)) ;
    enumerator_116629.gotoNextObject () ;
  }
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2935)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2936)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2937)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mListmapTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2939)) ;
  }
  GALGAS_unifiedTypeMapProxy var_listElementTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2952))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2952)), object->mAttribute_mListmapTypeName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2952)), var_listElementTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2950)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListmapTypeName, object->mAttribute_mIsPredefined, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE ("semanticContext.gSemantics", 2960)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE ("semanticContext.gSemantics", 2961)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2962)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2963)), var_listTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2969)), var_enumeratorDescriptor, var_enumerationVariants, function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2972)), var_addAssignOperatorDescription, GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("semanticContext.gSemantics", 2974)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2975)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2976)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2977)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2978)), GALGAS_bool (false), var_listElementTypeIndex, GALGAS_string ("emptyMap"), GALGAS_string ("listmap-").operator_concat (object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2982))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2982)), GALGAS_headerKind::constructor_twoHeaders (SOURCE_FILE ("semanticContext.gSemantics", 2983)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2956)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_predefinedTypeAST * object = (const cPtr_predefinedTypeAST *) inObject ;
  macroValidSharedObject (object, cPtr_predefinedTypeAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mPredefinedTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3020)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3020)) ;
  {
  const GALGAS_predefinedTypeAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3021)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_classDeclarationAST * object = (const cPtr_classDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_classDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3033))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3033)), object->mAttribute_mClassTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3033))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3033)) ;
  {
  const GALGAS_classDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3034)) ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121060 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121060.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121060.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3039))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3039)), object->mAttribute_mSuperClassName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3039)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3039)) ;
    }
    enumerator_121060.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3052))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3052)), object->mAttribute_mListTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3052))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3052)) ;
  {
  const GALGAS_listDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3053)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_121918 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121918.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121918.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3055))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3055)), enumerator_121918.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3055))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3055)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3055)) ;
    }
    enumerator_121918.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_structDeclarationAST * object = (const cPtr_structDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_structDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3068))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3068)), object->mAttribute_mStructTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3068))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3068)) ;
  {
  ...
  cEnumerator_attributeInCollectionListAST enumerator_122782 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_122782.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_122782.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3071))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3071)), enumerator_122782.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3071))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3071)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3071)) ;
    }
    enumerator_122782.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_enumDeclarationAST * object = (const cPtr_enumDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_enumDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3084))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3084)), object->mAttribute_mEnumTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3084))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3084)) ;
  {
  const GALGAS_enumDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3085)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_sortedListDeclarationAST * object = (const cPtr_sortedListDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_sortedListDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3097))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3097)), object->mAttribute_mSortedListTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3097))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3097)) ;
  {
  ...
  cEnumerator_attributeInCollectionListAST enumerator_124354 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_124354.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_124354.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3100))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3100)), enumerator_124354.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3100))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3100)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3100)) ;
    }
    enumerator_124354.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mArrayTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3113))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3113)), object->mAttribute_mArrayTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3113))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3113)) ;
  {
  ...
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mElementTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3115))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3115)), object->mAttribute_mElementTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3115))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3115)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3115)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3129))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3129)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3129))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3129)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3129)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_126859 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126859.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126859.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3144))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3144)), enumerator_126859.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3144))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3144)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3144)) ;
    }
    enumerator_126859.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_uniqueMapDeclarationAST * object = (const cPtr_uniqueMapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_uniqueMapDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3157))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3157)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3157))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3157)) ;
  {
  const GALGAS_uniqueMapDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3158)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_127720 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_127720.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_127720.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3160))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3160)), enumerator_127720.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3160))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3160)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3160)) ;
    }
    enumerator_127720.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapProxyDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapProxyDeclarationAST * object = (const cPtr_mapProxyDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_mapProxyDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3173))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3173)), object->mAttribute_mMapProxyTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3173))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3173)) ;
  {
  const GALGAS_mapProxyDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3174)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedMapTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3175))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3175)), object->mAttribute_mAssociatedMapTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3175))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3175)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3175)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_graphDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_graphDeclarationAST * object = (const cPtr_graphDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_graphDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mGraphTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3187))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3187)), object->mAttribute_mGraphTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3187))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3187)) ;
  {
  ...
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3189))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3189)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3189))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3189)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3189)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externTypeDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externTypeDeclarationAST * object = (const cPtr_externTypeDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_externTypeDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mExternTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3201))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3201)), object->mAttribute_mExternTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3201))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3201)) ;
  {
...
static void categoryMethod_externFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3214)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryReaderAST * object = (const cPtr_categoryReaderAST *) inObject ;
  macroValidSharedObject (object, cPtr_categoryReaderAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3322))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3322)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3322)).operator_concat (object->mAttribute_mCategoryReaderName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3322))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3322)), object->mAttribute_mCategoryReaderName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3322))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3322)) ;
  {
  const GALGAS_categoryReaderAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3323)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3324))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3324)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3324))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3324)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3324)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3326)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3326)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 3326)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3329)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3327)) ;
    }
  }
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_136817 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3332)) ;
  if (NULL != objectArray_136817) {
      macroValidSharedObject (objectArray_136817, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_136817->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3333)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryMethodAST * object = (const cPtr_categoryMethodAST *) inObject ;
  macroValidSharedObject (object, cPtr_categoryMethodAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3350))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3350)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3350)).operator_concat (object->mAttribute_mCategoryMethodName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3350))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3350)), object->mAttribute_mCategoryMethodName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3350))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3350)) ;
  {
  const GALGAS_categoryMethodAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3351)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3352))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3352)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3352))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3352)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3352)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3354)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3354)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 3354)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3357)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3355)) ;
    }
  }
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_138122 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3360)) ;
  if (NULL != objectArray_138122) {
      macroValidSharedObject (objectArray_138122, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_138122->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3361)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryModifierAST * object = (const cPtr_categoryModifierAST *) inObject ;
  macroValidSharedObject (object, cPtr_categoryModifierAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3377))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3377)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3377)).operator_concat (object->mAttribute_mCategoryModifierName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3377))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3377)), object->mAttribute_mCategoryModifierName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3377))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3377)) ;
  {
  const GALGAS_categoryModifierAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3378)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3379))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3379)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3379))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3379)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3379)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3381)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3381)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 3381)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3384)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3382)) ;
    }
  }
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_139397 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3387)) ;
  if (NULL != objectArray_139397) {
      macroValidSharedObject (objectArray_139397, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_139397->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3388)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3404)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryReaderAST * object = (const cPtr_abstractCategoryReaderAST *) inObject ;
  macroValidSharedObject (object, cPtr_abstractCategoryReaderAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3416))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3416)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3416)).operator_concat (object->mAttribute_mAbstractCategoryReaderName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3416))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3416)), object->mAttribute_mAbstractCategoryReaderName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3416))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3416)) ;
  {
  const GALGAS_abstractCategoryReaderAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3417)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3418))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3418)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3418))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3418)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3418)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3420)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3420)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 3420)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3423)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3421)) ;
    }
  }
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_141301 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3426)) ;
  if (NULL != objectArray_141301) {
      macroValidSharedObject (objectArray_141301, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_141301->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3427)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryMethodAST * object = (const cPtr_abstractCategoryMethodAST *) inObject ;
  macroValidSharedObject (object, cPtr_abstractCategoryMethodAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3444))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3444)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3444)).operator_concat (object->mAttribute_mAbstractCategoryMethodName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3444))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3444)), object->mAttribute_mAbstractCategoryMethodName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3444))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3444)) ;
  {
  const GALGAS_abstractCategoryMethodAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3445)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3446))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3446)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3446))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3446)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3446)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3448)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3448)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 3448)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3451)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3449)) ;
    }
  }
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_142654 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3454)) ;
  if (NULL != objectArray_142654) {
      macroValidSharedObject (objectArray_142654, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_142654->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3455)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryModifierAST * object = (const cPtr_abstractCategoryModifierAST *) inObject ;
  macroValidSharedObject (object, cPtr_abstractCategoryModifierAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3471))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3471)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3471)).operator_concat (object->mAttribute_mAbstractCategoryModifierName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3471))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3471)), object->mAttribute_mAbstractCategoryModifierName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3471))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3471)) ;
  {
  const GALGAS_abstractCategoryModifierAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3472)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3473))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3473)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3473))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3473)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3473)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3475)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3475)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 3475)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3478)), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3476)) ;
    }
  }
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_143969 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3481)) ;
  if (NULL != objectArray_143969) {
      macroValidSharedObject (objectArray_143969, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_143969->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3482)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapDeclarationAST * object = (const cPtr_mapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_mapDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3501)) ;
  var_structAttributeList.addAssign_operation (GALGAS_string ("lstring").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 3503)), GALGAS_string ("lkey").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 3504)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3505))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3502)) ;
  cEnumerator_attributeInCollectionListAST enumerator_144808 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_144808.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_144808.current_mAttributeTypeName (HERE), enumerator_144808.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3511))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3508)) ;
    enumerator_144808.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mMapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3516))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3516)), object->mAttribute_mMapTypeName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3516)), var_structAttributeList, GALGAS_string::makeEmptyString ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3514))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3514)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3527)) ;
  cEnumerator_attributeInCollectionListAST enumerator_145451 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145451.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145451.current_mAttributeTypeName (HERE), enumerator_145451.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3532))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3529)) ;
    enumerator_145451.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3537))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3537)), object->mAttribute_mListTypeName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3537)), var_structAttributeList, GALGAS_string::makeEmptyString ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3535))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3535)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_sortedListDeclarationAST * object = (const cPtr_sortedListDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_sortedListDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3548)) ;
  cEnumerator_attributeInCollectionListAST enumerator_146102 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_146102.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_146102.current_mAttributeTypeName (HERE), enumerator_146102.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3553))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3550)) ;
    enumerator_146102.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mSortedListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3558))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3558)), object->mAttribute_mSortedListTypeName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3558)), var_structAttributeList, GALGAS_string::makeEmptyString ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3556))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3556)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listmapDeclarationAST * object = (const cPtr_listmapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listmapDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3569)) ;
  var_structAttributeList.addAssign_operation (GALGAS_string ("string").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 3571)), GALGAS_string ("key").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 3572)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3573))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3570)) ;
  var_structAttributeList.addAssign_operation (object->mAttribute_mAssociatedListTypeName, GALGAS_string ("mList").reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 3577)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3578))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3575)) ;
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3583))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3583)), object->mAttribute_mListmapTypeName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3583)), var_structAttributeList, GALGAS_string::makeEmptyString ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3581))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3581)) ;
}
//-----------------------------------------------------------------------------*
