...
category_method__predefinedTypeAST__enterType (C_Compiler & inLexique,
  ...
  if (operand_10202 != NULL) {
    ...
    if (temp_11268.isBuilt ()) {
      ...
      if (method != NULL) {
        method (inLexique, temp_11268 (HERE), var_cas_ioSemanticContext.mTypeMap, var_cas_superTypeIndex COMMA_SOURCE_FILE_AT_LINE (259)) ;
      }
    }
...
category_method__genericTypeTypeAST__enterType (C_Compiler & inLexique,
                                const cPtr_genericTypeTypeAST * operand_12013,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_12013 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_superTypeIndex ;
    const GGS_bool cond_12377 = (operand_12013->mSuperTypeName).operator_isEqual (GGS_string ("")) ;
    ...
    }else if (cond_12377.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_12013->mSuperTypeName, var_cas_superTypeIndex COMMA_SOURCE_FILE_AT_LINE (295)) ;
    }
...
category_method__mapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_13586,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_13586 != NULL) {
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (341)) ;
    GGS_unifiedTypeMapProxy  var_cas_lstringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("lstring"), var_cas_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (344)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentMapTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_13586->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (347)), var_cas_currentMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (347)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_13586->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (349)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (349)) ;
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_15118 (operand_13586->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_15118 = NULL ;
      while (((operand_15118 = enumerator_15118.nextObject ()))) {
        ...
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_15118->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (360)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (360)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_15118->mAttributeName) ;
        var_cas_enumerationDescriptor.addAssign_operation (var_cas_attributeTypeIndex, operand_15118->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (362))) ;
    ...
    {
      GGS_insertMethodListAST::cEnumerator enumerator_15722 (operand_13586->mInsertMethodList, true) ;
      const GGS_insertMethodListAST::cElement * operand_15722 = NULL ;
      while (((operand_15722 = enumerator_15722.nextObject ()))) {
        macroValidPointer (operand_15722) ;
        const GGS_bool cond_15877 = var_cas_modifierMap.reader_hasKey (operand_15722->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (368))) ;
        if (cond_15877.isBuiltAndTrue ()) {
          operand_15722->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_15722->mMethodName)).operator_concat (GGS_string ("' insert method is already declared")) COMMA_SOURCE_FILE_AT_LINE (370)) ;
        }else if (cond_15877.isBuiltAndFalse ()) {
          var_cas_modifierMap.modifier_insertOrReplace (inLexique, operand_15722->mMethodName, var_cas_insertMethodFormalArgumentList, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (371)) ;
        }
      }
    }
    {
      GGS_mapMethodListAST::cEnumerator enumerator_16085 (operand_13586->mRemoveMethodList, true) ;
      const GGS_mapMethodListAST::cElement * operand_16085 = NULL ;
      while (((operand_16085 = enumerator_16085.nextObject ()))) {
        macroValidPointer (operand_16085) ;
        const GGS_bool cond_16276 = var_cas_modifierMap.reader_hasKey (operand_16085->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (380))) ;
        if (cond_16276.isBuiltAndTrue ()) {
          operand_16085->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_16085->mMethodName)).operator_concat (GGS_string ("' method is already declared as an insert modifier or a remove modifier")) COMMA_SOURCE_FILE_AT_LINE (382)) ;
        }else if (cond_16276.isBuiltAndFalse ()) {
          var_cas_modifierMap.modifier_insertOrReplace (inLexique, operand_16085->mMethodName, var_cas_removeMethodFormalArgumentList, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (383)) ;
        }
      }
    }
    {
      GGS_mapMethodListAST::cEnumerator enumerator_16482 (operand_13586->mSearchMethodList, true) ;
      const GGS_mapMethodListAST::cElement * operand_16482 = NULL ;
      while (((operand_16482 = enumerator_16482.nextObject ()))) {
        macroValidPointer (operand_16482) ;
        var_cas_instanceMethodMap.modifier_insertOrReplace (inLexique, operand_16482->mMethodName, var_cas_removeMethodFormalArgumentList, operand_16482->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (395)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (392)) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_16711 (operand_13586->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_16711 = NULL ;
      while (((operand_16711 = enumerator_16711.nextObject ()))) {
        macroValidPointer (operand_16711) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, (operand_16711->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (401))).operator_concat (GGS_string ("ForKey")), operand_16711->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (401)) COMMA_SOURCE_FILE_AT_LINE (401)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_16711->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (403)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (403)) ;
    ...
    const GGS_bool cond_17597 = (operand_13586->mInsertOrReplaceDeclarationListAST.reader_length ()).operator_supOrEqual (GGS_uint (1U)) ;
    if (cond_17597.isBuiltAndTrue ()) {
      GGS_location  var_cas_insertOrReplaceLocation ;
      const GGS_insertOrReplaceDeclarationListAST  temp_17403 = operand_13586->mInsertOrReplaceDeclarationListAST ;
      if (temp_17403.isBuilt ()) {
        temp_17403 (HERE)->method_first (inLexique, var_cas_insertOrReplaceLocation COMMA_SOURCE_FILE_AT_LINE (416)) ;
      }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_17682 (operand_13586->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_17682 = NULL ;
      while (((operand_17682 = enumerator_17682.nextObject ()))) {
        macroValidPointer (operand_17682) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_17682->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")), operand_17682->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (425)) COMMA_SOURCE_FILE_AT_LINE (425)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_17682->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (427)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (427)) ;
...
category_method__mapProxyDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_19321,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19321 != NULL) {
    GGS_typedAttributeList  var_cas_mapTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_19624_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_19624_1 ;
    GGS_typedAttributeList  automatic_var_19624_2 ;
    GGS_constructorMap  automatic_var_19624_3 ;
    GGS_readerMap  automatic_var_19624_4 ;
    GGS_modifierMap  automatic_var_19624_5 ;
    GGS_instanceMethodMap  automatic_var_19624_6 ;
    GGS_classMethodMap  automatic_var_19624_7 ;
    GGS_enumerationDescriptorList  automatic_var_19624_8 ;
    GGS_uint  automatic_var_19624_9 ;
    GGS_unifiedTypeMapProxyList  automatic_var_19624_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_19624_11 ;
    GGS_nativeAttributeList  automatic_var_19624_12 ;
    GGS_lstringlist  automatic_var_19624_13 ;
    GGS_typedAttributeList  automatic_var_19624_14 ;
    const GGS_unifiedTypeMap  temp_19523 = var_cas_ioSemanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (470)) ;
    if (temp_19523.isBuilt ()) {
      temp_19523 (HERE)->method_searchKey (inLexique, operand_19321->mAssociatedMapTypeName, automatic_var_19624_0, automatic_var_19624_1, var_cas_typeKindEnum, automatic_var_19624_2, var_cas_mapTypedAttributeList, automatic_var_19624_3, automatic_var_19624_4, automatic_var_19624_5, automatic_var_19624_6, automatic_var_19624_7, automatic_var_19624_8, automatic_var_19624_9, automatic_var_19624_10, automatic_var_19624_11, automatic_var_19624_12, automatic_var_19624_13, automatic_var_19624_14 COMMA_SOURCE_FILE_AT_LINE (470)) ;
    }
    const GGS_bool cond_19841 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_mapType (inLexique COMMA_SOURCE_FILE_AT_LINE (478))) ;
    if (cond_19841.isBuiltAndTrue ()) {
      operand_19321->mAssociatedMapTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_19321->mAssociatedMapTypeName)).operator_concat (GGS_string (" should be a map type")) COMMA_SOURCE_FILE_AT_LINE (480)) ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_19321->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (490)), var_cas_associatedMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (490)) ;
    GGS_unifiedTypeMapProxy  var_cas_lstringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("lstring"), var_cas_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (493)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("lstring"), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (496)) ;
    GGS_unifiedTypeMapProxy  var_cas_mapTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_19321->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (499)), var_cas_mapTypeIndex COMMA_SOURCE_FILE_AT_LINE (499)) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("null"),  operand_19321->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (511)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (511)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_21694 (var_cas_mapTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_21694 = NULL ;
      while (((operand_21694 = enumerator_21694.nextObject ()))) {
        macroValidPointer (operand_21694) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, (operand_21694->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (517))).operator_concat (GGS_string ("ForKey")), operand_21694->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (517)) COMMA_SOURCE_FILE_AT_LINE (517)) ;
        var_cas_readerMap.modifier_insertOrReplace (inLexique, var_cas_accessorName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (true), operand_21694->mAttributeTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (523)), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (518)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("root"), var_cas_superTypeIndex COMMA_SOURCE_FILE_AT_LINE (530)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_19321->mMapProxyTypeName, GGS_bool (true), var_cas_superTypeIndex, GGS_typeKindEnum::constructor_mapIndexType (inLexique COMMA_SOURCE_FILE_AT_LINE (535)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_mapTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (542)), GGS_enumerationDescriptorList ::constructor_emptyList (), GGS_uint (0U), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (531)) ;
  }
}
...
category_method__enumDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_22897,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22897 != NULL) {
    ...
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_22897->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (566)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (566)) ;
    {
      GGS_lstringlist::cEnumerator enumerator_23391 (operand_22897->mConstantList, true) ;
      const GGS_lstringlist::cElement * operand_23391 = NULL ;
      while (((operand_23391 = enumerator_23391.nextObject ()))) {
        macroValidPointer (operand_23391) ;
        ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  operand_23391->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (569)),  operand_22897->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (569)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (569)) ;
      }
    }
    {
      GGS_enumMessageListAST::cEnumerator enumerator_23583 (operand_22897->mEnumMessageList, true) ;
      const GGS_enumMessageListAST::cElement * operand_23583 = NULL ;
      while (((operand_23583 = enumerator_23583.nextObject ()))) {
        macroValidPointer (operand_23583) ;
        ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_23583->mEnumMessageName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (573)),  GGS_string ("string"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (573)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("enum"), var_cas_superTypeIndex COMMA_SOURCE_FILE_AT_LINE (578)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_22897->mEnumTypeName, GGS_bool (true), var_cas_superTypeIndex, GGS_typeKindEnum::constructor_mapIndexType (inLexique COMMA_SOURCE_FILE_AT_LINE (583)), GGS_typedAttributeList ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (590)), GGS_enumerationDescriptorList ::constructor_emptyList (), function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (592)), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), operand_22897->mConstantList, GGS_typedAttributeList ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (579)) ;
  }
}
...
category_method__filewrapperDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationAST * operand_24656,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_24656 != NULL) {
    ...
    {
      GGS_filewrapperTemplateListAST::cEnumerator enumerator_24794 (operand_24656->mFilewrapperTemplateList, true) ;
      const GGS_filewrapperTemplateListAST::cElement * operand_24794 = NULL ;
      while (((operand_24794 = enumerator_24794.nextObject ()))) {
        macroValidPointer (operand_24794) ;
        GGS_unifiedTypeMapProxyList  var_cas_templateSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
        {
          GGS_formalInputParameterListAST::cEnumerator enumerator_24912 (operand_24794->mFilewrapperTemplateFormalInputParameters, true) ;
          const GGS_formalInputParameterListAST::cElement * operand_24912 = NULL ;
          while (((operand_24912 = enumerator_24912.nextObject ()))) {
            macroValidPointer (operand_24912) ;
            GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_24912->mFormalParameterTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (611)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (611)) ;
            var_cas_templateSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
          }
        }
        var_cas_filewrapperTemplateMap.modifier_insertKey (inLexique, operand_24794->mFilewrapperTemplateName, var_cas_templateSignature, operand_24794->mFilewrapperTemplatePath COMMA_SOURCE_FILE_AT_LINE (614)) ;
      }
    }
    var_cas_ioSemanticContext.mFilewrapperMap.modifier_insertKey (inLexique, operand_24656->mFilewrapperName, operand_24656->mFilewrapperPath, operand_24656->mFilewrapperExtensionList, var_cas_filewrapperTemplateMap COMMA_SOURCE_FILE_AT_LINE (620)) ;
  }
}
...
category_method__listDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_25614,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_25614 != NULL) {
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_25758 (operand_25614->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_25758 = NULL ;
      while (((operand_25758 = enumerator_25758.nextObject ()))) {
        macroValidPointer (operand_25758) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_25758->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (637)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (637)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_25758->mAttributeName) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("uint"), var_cas_uintType COMMA_SOURCE_FILE_AT_LINE (642)) ;
    GGS_unifiedTypeMapProxy  var_cas_listTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_25614->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (645)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (645)) ;
    GGS_enumerationDescriptorList  var_cas_enumerationDescriptor = GGS_enumerationDescriptorList ::constructor_emptyList () ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_26675 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_26675 = NULL ;
      while (((operand_26675 = enumerator_26675.nextObject ()))) {
        macroValidPointer (operand_26675) ;
        var_cas_enumerationDescriptor.addAssign_operation (operand_26675->mAttributeTypeIndex, operand_26675->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (652))) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_26675->mAttributeTypeIndex) ;
        var_cas_modifierOutputFormalArgumentList.addAssign_operation (operand_26675->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (654))) ;
        var_cas_modifierInputFormalArgumentList.addAssign_operation (operand_26675->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (655))) ;
      }
    }
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyList"),  operand_25614->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (659)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (659)) ;
    ...
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListFromIndex"),  GGS_string ("uint"),  operand_25614->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (669)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (669)) ;
    ::routine_enterBaseReaderWith2Arguments (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListWithRange"),  GGS_string ("uint"),  GGS_string ("uint"),  operand_25614->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (670)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (670)) ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_27845 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_27845 = NULL ;
      while (((operand_27845 = enumerator_27845.nextObject ()))) {
        macroValidPointer (operand_27845) ;
        var_cas_readerMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, (operand_27845->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (673))).operator_concat (GGS_string ("AtIndex")), operand_27845->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (673)) COMMA_SOURCE_FILE_AT_LINE (673)), GGS_unifiedTypeMapProxyList ::constructor_listWithValue (var_cas_uintType), GGS_bool (true), operand_27845->mAttributeTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (677)), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (672)) ;
      }
    }
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_28594 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_28594 = NULL ;
      while (((operand_28594 = enumerator_28594.nextObject ()))) {
        macroValidPointer (operand_28594) ;
        GGS_formalParameterSignature  var_cas_setterFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        var_cas_setterFormalArgumentList.addAssign_operation (operand_28594->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (700))) ;
        ...
        var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_28594->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("AtIndex")), operand_28594->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (703)) COMMA_SOURCE_FILE_AT_LINE (703)), var_cas_setterFormalArgumentList, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (702)) ;
      }
    }
...
category_method__sortedListDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_30406,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_30406 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("uint"), var_cas_uintType COMMA_SOURCE_FILE_AT_LINE (753)) ;
    GGS_unifiedTypeMapProxy  var_cas_listTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_30406->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (756)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (756)) ;
    GGS_enumerationDescriptorList  var_cas_enumerationDescriptor = GGS_enumerationDescriptorList ::constructor_emptyList () ;
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    GGS_formalParameterSignature  var_cas_modifierFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_31067 (operand_30406->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_31067 = NULL ;
      while (((operand_31067 = enumerator_31067.nextObject ()))) {
        macroValidPointer (operand_31067) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_31067->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (764)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (764)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_31067->mAttributeName) ;
        var_cas_enumerationDescriptor.addAssign_operation (var_cas_attributeTypeIndex, operand_31067->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (766))) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptySortedList"),  operand_30406->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (772)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (772)) ;
...
category_method__structDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_33730,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_33730 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_structTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_33730->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (841)), var_cas_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (841)) ;
    ...
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_34166 (operand_33730->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_34166 = NULL ;
      while (((operand_34166 = enumerator_34166.nextObject ()))) {
        macroValidPointer (operand_34166) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_34166->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (848)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (848)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_34166->mAttributeName) ;
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_34687 (operand_33730->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_34687 = NULL ;
      while (((operand_34687 = enumerator_34687.nextObject ()))) {
        macroValidPointer (operand_34687) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_34687->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (862)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (862)) ;
        var_cas_readerMap.modifier_insertOrReplace (inLexique, operand_34687->mAttributeName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (868)), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (863)) ;
      }
    }
...
category_method__classDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_36170,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_36170 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("uint"), var_cas_uintType COMMA_SOURCE_FILE_AT_LINE (909)) ;
    GGS_readerMap  var_cas_readerMap ;
    GGS_modifierMap  var_cas_modifierMap ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap ;
    GGS_classMethodMap  var_cas_classMethodMap ;
    ...
    const GGS_bool cond_37002 = (operand_36170->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (918))).operator_isEqual (GGS_string ("")) ;
    if (cond_37002.isBuiltAndTrue ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("class"), var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (919)) ;
    ...
    }else if (cond_37002.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_36170->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (926)), var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (926)) ;
      GGS_typeKindEnum var_cas_typeKindEnum ;
      GGS_bool automatic_var_37403_0 ;
      GGS_unifiedTypeMapProxy  automatic_var_37403_1 ;
      GGS_typedAttributeList  automatic_var_37403_2 ;
      GGS_constructorMap  automatic_var_37403_3 ;
      GGS_enumerationDescriptorList  automatic_var_37403_4 ;
      GGS_uint  automatic_var_37403_5 ;
      GGS_unifiedTypeMapProxyList  automatic_var_37403_6 ;
      GGS_unifiedTypeMapProxyList  automatic_var_37403_7 ;
      GGS_nativeAttributeList  automatic_var_37403_8 ;
      GGS_lstringlist  automatic_var_37403_9 ;
      GGS_typedAttributeList  automatic_var_37403_10 ;
      const GGS_unifiedTypeMap  temp_37198 = var_cas_ioSemanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (928)) ;
      if (temp_37198.isBuilt ()) {
        temp_37198 (HERE)->method_searchKey (inLexique, operand_36170->mSuperClassName, automatic_var_37403_0, automatic_var_37403_1, var_cas_typeKindEnum, automatic_var_37403_2, var_cas_inheritedTypedAttributeList, automatic_var_37403_3, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, var_cas_classMethodMap, automatic_var_37403_4, automatic_var_37403_5, automatic_var_37403_6, automatic_var_37403_7, automatic_var_37403_8, automatic_var_37403_9, automatic_var_37403_10 COMMA_SOURCE_FILE_AT_LINE (928)) ;
      }
      const GGS_bool cond_37553 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (941))) ;
      if (cond_37553.isBuiltAndTrue ()) {
        operand_36170->mSuperClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_36170->mSuperClassName)).operator_concat (GGS_string (" should be a class type")) COMMA_SOURCE_FILE_AT_LINE (943)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_classIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_36170->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (947)), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (947)) ;
    ...
    const GGS_bool cond_38454 = (operand_36170->mIsAbstract).operator_not () ;
    if (cond_38454.isBuiltAndTrue ()) {
      GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
      {
        GGS_typedAttributeList::cEnumerator enumerator_37942 (var_cas_inheritedTypedAttributeList, true) ;
        const GGS_typedAttributeList::cElement * operand_37942 = NULL ;
        while (((operand_37942 = enumerator_37942.nextObject ()))) {
          macroValidPointer (operand_37942) ;
          var_cas_constructorAttributeTypeList.addAssign_operation (operand_37942->mAttributeTypeIndex) ;
        }
      }
      {
        GGS_attributeInCollectionListAST::cEnumerator enumerator_38051 (operand_36170->mAttributeList, true) ;
        const GGS_attributeInCollectionListAST::cElement * operand_38051 = NULL ;
        while (((operand_38051 = enumerator_38051.nextObject ()))) {
          macroValidPointer (operand_38051) ;
          GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
          GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_38051->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (957)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (957)) ;
          var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        }
      }
    ...
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_38509 (operand_36170->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_38509 = NULL ;
      while (((operand_38509 = enumerator_38509.nextObject ()))) {
        macroValidPointer (operand_38509) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_38598 (operand_38509->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_38598 = NULL ;
          while (((operand_38598 = enumerator_38598.nextObject ()))) {
            macroValidPointer (operand_38598) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_38598->mFormalParameterTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (972)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (972)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_38598->mFormalParameterPassingMode) ;
          }
        }
        var_cas_instanceMethodMap.modifier_insertOrReplace (inLexique, operand_38509->mMethodName, var_cas_formalArgumentList, operand_38509->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (978)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (975)) ;
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_39026 (operand_36170->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_39026 = NULL ;
      while (((operand_39026 = enumerator_39026.nextObject ()))) {
        macroValidPointer (operand_39026) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_39115 (operand_39026->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_39115 = NULL ;
          while (((operand_39115 = enumerator_39115.nextObject ()))) {
            macroValidPointer (operand_39115) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_39115->mFormalParameterTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (986)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (986)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_39115->mFormalParameterPassingMode) ;
          }
        }
        var_cas_instanceMethodMap.modifier_insertOrReplace (inLexique, operand_39026->mMethodName, var_cas_formalArgumentList, operand_39026->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (992)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (989)) ;
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_39716 (operand_36170->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_39716 = NULL ;
      while (((operand_39716 = enumerator_39716.nextObject ()))) {
        macroValidPointer (operand_39716) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_39716->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1001)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1001)) ;
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_39716->mAttributeName) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_39716->mAttributeName) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_36170->mClassTypeName, (operand_36170->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1011)), var_cas_allTypedAttributeList, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1018)), GGS_enumerationDescriptorList ::constructor_emptyList (), GGS_uint (0U), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (1007)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_40810,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_40810 != NULL) {
    ...
    {
      GGS_formalParameterListAST::cEnumerator enumerator_40997 (operand_40810->mFormalParameterList, true) ;
      const GGS_formalParameterListAST::cElement * operand_40997 = NULL ;
      while (((operand_40997 = enumerator_40997.nextObject ()))) {
        macroValidPointer (operand_40997) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_40997->mFormalParameterTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1038)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1038)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_40997->mFormalParameterPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_40810->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1042)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_41532,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_41532 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_41720 (operand_41532->mFormalParameterList, true) ;
      const GGS_formalParameterListAST::cElement * operand_41720 = NULL ;
      while (((operand_41720 = enumerator_41720.nextObject ()))) {
        macroValidPointer (operand_41720) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_41720->mFormalParameterTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1054)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1054)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_41532->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1059)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1059)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_41532->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1061)) ;
  }
}
...
category_method__lazyFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_lazyFunctionDeclarationAST * operand_42421,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_42421 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_42421->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1071)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1071)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_42421->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1073)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_42934,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_42934 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_43234_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_43234_1 ;
    GGS_typedAttributeList  automatic_var_43234_2 ;
    GGS_constructorMap  automatic_var_43234_3 ;
    GGS_readerMap  automatic_var_43234_4 ;
    GGS_modifierMap  automatic_var_43234_5 ;
    GGS_instanceMethodMap  automatic_var_43234_6 ;
    GGS_classMethodMap  automatic_var_43234_7 ;
    GGS_enumerationDescriptorList  automatic_var_43234_8 ;
    GGS_uint  automatic_var_43234_9 ;
    GGS_unifiedTypeMapProxyList  automatic_var_43234_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_43234_11 ;
    GGS_nativeAttributeList  automatic_var_43234_12 ;
    GGS_lstringlist  automatic_var_43234_13 ;
    GGS_typedAttributeList  automatic_var_43234_14 ;
    const GGS_unifiedTypeMap  temp_43138 = var_cas_ioSemanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1084)) ;
    if (temp_43138.isBuilt ()) {
      temp_43138 (HERE)->method_searchKey (inLexique, operand_42934->mAssociatedListTypeName, automatic_var_43234_0, automatic_var_43234_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_43234_2, automatic_var_43234_3, automatic_var_43234_4, automatic_var_43234_5, automatic_var_43234_6, automatic_var_43234_7, automatic_var_43234_8, automatic_var_43234_9, automatic_var_43234_10, automatic_var_43234_11, automatic_var_43234_12, automatic_var_43234_13, automatic_var_43234_14 COMMA_SOURCE_FILE_AT_LINE (1084)) ;
    }
    const GGS_bool cond_43463 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1091))) ;
    if (cond_43463.isBuiltAndTrue ()) {
      operand_42934->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_42934->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1093)) ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_42934->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1103)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1103)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_42934->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1106)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1106)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1109)) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_42934->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1113)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1113)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_44930 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_44930 = NULL ;
      while (((operand_44930 = enumerator_44930.nextObject ()))) {
        macroValidPointer (operand_44930) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_44930->mAttributeTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("listmap"), var_cas_superTypeIndex COMMA_SOURCE_FILE_AT_LINE (1126)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_42934->mListmapTypeName, GGS_bool (true), var_cas_superTypeIndex, GGS_typeKindEnum::constructor_mapIndexType (inLexique COMMA_SOURCE_FILE_AT_LINE (1131)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_listTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1138)), var_cas_enumeratorDescriptor, (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1140))).operator_or (function_generateCppConstructorWithNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1140))), var_cas_addAssignOperatorDescription, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (1127)) ;
  }
}
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_46765,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_46765 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("root"), operand_46765->mPredefinedTypeName, operand_46765) ;
  }
}
...
category_method__stringsetPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_stringsetPredefinedTypeAST * operand_47086,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_47086 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enumerable"), operand_47086->mPredefinedTypeName, operand_47086) ;
  }
}
...
category_method__genericTypeTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_genericTypeTypeAST * operand_47405,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_47405 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_47405->mSuperTypeName, operand_47405->mTypeName, operand_47405) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_47717,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_47717 != NULL) {
    const GGS_string var_cas_actualSuperTypeName = (((operand_47717->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1199))).operator_isEqual (GGS_string (""))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_47717->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1199)))) ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (var_cas_actualSuperTypeName, operand_47717->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1200)), operand_47717) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_48169,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_48169 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("list"), operand_48169->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1208)), operand_48169) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_48487,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_48487 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("struct"), operand_48487->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1216)), operand_48487) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_48807,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_48807 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enum"), operand_48807->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1224)), operand_48807) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_49129,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_49129 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("sortedlist"), operand_49129->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1232)), operand_49129) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_49460,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_49460 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_49460->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1240)), operand_49460->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1240)), operand_49460) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_49804,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_49804 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("map"), operand_49804->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1248)), operand_49804) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_50122,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_50122 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_50122->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1256)), operand_50122->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1256)), operand_50122) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_51029 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_51029 = NULL ;
    while (((operand_51029 = enumerator_51029.nextObject ()))) {
      macroValidPointer (operand_51029) ;
      const GGS_semanticDeclarationAST  temp_51070 = operand_51029->mSemanticDeclaration ;
      if (temp_51070.isBuilt ()) {
        typeCategoryMethod__semanticDeclarationAST__collectType method = findCategoryMethod__semanticDeclarationAST__collectType (temp_51070.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_51070 (HERE), var_cas_collectedTypeMap COMMA_SOURCE_FILE_AT_LINE (1273)) ;
        }
      }
    }
  }
  ...
  const GGS_bool cond_51473 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_51473.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_51357 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_51357 = NULL ;
      while (((operand_51357 = enumerator_51357.nextObject ()))) {
        macroValidPointer (operand_51357) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_51357->mValue) ;
      }
    }
  ...
  }else if (cond_51473.isBuiltAndFalse ()) {
    const GGS_bool cond_51753 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_51753.isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_51639 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_51639 = NULL ;
        while (((operand_51639 = enumerator_51639.nextObject ()))) {
          macroValidPointer (operand_51639) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_51639->mValue) ;
        }
      }
  ...
  const GGS_bool cond_52253 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (1295))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_52253.isBuiltAndTrue ()) {
    {
      GGS_semanticDeclarationListAST::cEnumerator enumerator_52124 (var_cas_inSemanticDeclarationList, true) ;
      const GGS_semanticDeclarationListAST::cElement * operand_52124 = NULL ;
      while (((operand_52124 = enumerator_52124.nextObject ()))) {
        macroValidPointer (operand_52124) ;
        const GGS_semanticDeclarationAST  temp_52179 = operand_52124->mSemanticDeclaration ;
        if (temp_52179.isBuilt ()) {
          typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (temp_52179.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_52179 (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (1297)) ;
          }
        }
      }
    }
  ...
  GGS_uint _variant_53262 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
  GGS_bool _condition_53262 (_variant_53262.isBuilt (), true) ;
  while (_condition_53262.isBuiltAndTrue ()) {
    _condition_53262 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
    if (_condition_53262.isBuiltAndTrue ()) {
      if (_variant_53262.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1320)) ;
        _condition_53262 = GGS_bool (false) ;
      }else{
        _variant_53262.decrement_operation (inLexique COMMA_HERE) ;
        ...
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_52842 (var_cas_r, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_52842 = NULL ;
          while (((operand_52842 = enumerator_52842.nextObject ()))) {
            macroValidPointer (operand_52842) ;
            const GGS_bool cond_53113 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_52842->mDependanceString) ;
            if (cond_53113.isBuiltAndTrue ()) {
              var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_52842->mSemanticDeclaration) ;
              var_cas_alreadyDefinedTypes.addAssign_operation (operand_52842->mTypeString) ;
              var_cas_progress = GGS_bool (true) ;
            }else if (cond_53113.isBuiltAndFalse ()) {
              var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_52842->mDependanceString, operand_52842->mTypeString, operand_52842->mSemanticDeclaration) ;
            }
          }
        }
      }
  ...
  const GGS_bool cond_53829 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_53829.isBuiltAndTrue ()) {
    GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
    {
      GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_53541 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
      const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_53541 = enumerator_53541.nextObject () ;
      if ((operand_53541 != NULL)) {
        bool _foreach_loop_53541 ;
        do{
          macroValidPointer (operand_53541) ;
          var_cas_s.appendCString ("@") ;
          var_cas_s.dotAssign_operation (operand_53541->mTypeString) ;
          operand_53541 = enumerator_53541.nextObject () ;
          _foreach_loop_53541 = ((operand_53541 != NULL)) ;
          if (_foreach_loop_53541) {
            var_cas_s.appendCString (", ") ;
          }
        }while (_foreach_loop_53541) ;
      }
    }
    var_cas_s.appendCString (" classes; detail:") ;
    {
      GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_53704 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
      const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_53704 = NULL ;
      while (((operand_53704 = enumerator_53704.nextObject ()))) {
        macroValidPointer (operand_53704) ;
        var_cas_s.appendCString ("\n"
          "  - @") ;
        var_cas_s.dotAssign_operation (operand_53704->mTypeString) ;
        var_cas_s.appendCString (" inherits from @") ;
        var_cas_s.dotAssign_operation (operand_53704->mDependanceString) ;
      }
    }
  ...
  const GGS_bool cond_54392 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (1343))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_54392.isBuiltAndTrue ()) {
    {
      GGS_semanticDeclarationListAST::cEnumerator enumerator_54230 (var_cas_orderedSemanticDeclarationListAST, true) ;
      const GGS_semanticDeclarationListAST::cElement * operand_54230 = NULL ;
      while (((operand_54230 = enumerator_54230.nextObject ()))) {
        macroValidPointer (operand_54230) ;
        const GGS_semanticDeclarationAST  temp_54271 = operand_54230->mSemanticDeclaration ;
        if (temp_54271.isBuilt ()) {
          typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (temp_54271.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_54271 (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (1346)) ;
          }
        }
      }
    }
