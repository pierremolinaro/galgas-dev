...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticDeclarationListAST enumerator_141011 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_141011.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_141011.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3446)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_141011.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_semanticTypePrecedenceGraph var_semanticTypePrecedenceGraph = GALGAS_semanticTypePrecedenceGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (3452)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_categoryMethodMapForBuildingContext var_categoryMethodMapForBuildingContext = GALGAS_categoryMethodMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3453)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_categoryReaderMapForBuildingContext var_categoryReaderMapForBuildingContext = GALGAS_categoryReaderMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3454)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_categoryModifierMapForBuildingContext var_categoryModifierMapForBuildingContext = GALGAS_categoryModifierMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3455)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_semanticDeclarationListAST var_categoryOverrideDefinitionList = GALGAS_semanticDeclarationListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3456)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticDeclarationListAST enumerator_141744 (var_semanticDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_141744.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_141744.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3458)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_141744.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (3466)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_142164 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3467)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_142164.hasCurrentObject ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_142164.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_142164.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3468)) COMMA_SOURCE_FILE_AT_LINE (3468)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3468)) COMMA_SOURCE_FILE_AT_LINE (3468)) ;
      enumerator_142164.gotoNextObject () ;
    }
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("semantic analysis not performed, due to undefined type error(s)") COMMA_SOURCE_FILE_AT_LINE (3470)) ;
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_lstringlist joker_142500_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_142500_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3472)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3483)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("semantic analysis not performed, ").operator_concat (var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3484)).reader_string (SOURCE_FILE_AT_LINE (3484)) COMMA_SOURCE_FILE_AT_LINE (3484)).operator_concat (GALGAS_string (" declarations are involved in circular definition:") COMMA_SOURCE_FILE_AT_LINE (3484)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_143085 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_143085.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_143085.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3486)) COMMA_SOURCE_FILE_AT_LINE (3486)) COMMA_SOURCE_FILE_AT_LINE (3486)) ;
        enumerator_143085.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (3488)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      //-------- @concatInstructionForGeneration
      var_sortedSemanticDeclarationListAST.dotAssign_operation (var_categoryOverrideDefinitionList COMMA_SOURCE_FILE_AT_LINE (3491)) ;
      //-------- @assignmentInstructionForGeneration
      outArgument_outSemanticContext = GALGAS_semanticContext::constructor_new (constinArgument_inSourceFile, GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3495)), GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3496)), GALGAS_functionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3497)), GALGAS_filewrapperMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3498)), GALGAS_grammarMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3499)), GALGAS_optionComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3500)), GALGAS_lexiqueComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3501)), GALGAS_optionMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3502)) COMMA_SOURCE_FILE_AT_LINE (3493)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_143893 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_143893.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_143893.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3506)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_143893.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mClassTypeName, object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (2503)), var_superClassIndex, GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2505)), var_allTypedAttributeList, var_attributeMap, var_currentClassTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2513)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2514)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2515)), GALGAS_uint ((PMUInt32) 0U), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2517)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2518)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2519)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2520)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2521)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2522)), var_generateHeaderInSeparateFile, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2524)), var_defaultConstructorName, inCompiler COMMA_SOURCE_FILE_AT_LINE (2501)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_externRoutineDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formalParameterSignature var_routineSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2538)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListAST enumerator_99777 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_99777.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_99777.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2541)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2541)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_99777.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (2542)) ;
    enumerator_99777.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mRoutineMap.modifier_insertKey (object->mAttribute_mRoutineName, var_routineSignature, inCompiler COMMA_SOURCE_FILE_AT_LINE (2545)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_externFunctionDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unifiedTypeMapProxyList var_functionSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2557)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalInputParameterListAST enumerator_100772 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_100772.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_100772.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2560)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2560)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2561)) ;
    enumerator_100772.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName.reader_string (SOURCE_FILE_AT_LINE (2565)), var_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2565)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2567)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName.reader_string (SOURCE_FILE_AT_LINE (2580)), var_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2580)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2582)), var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2582)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_arrayDeclarationAST) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2594)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mDimension.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the dimension of an array should be > 0") COMMA_SOURCE_FILE_AT_LINE (2595)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_arrayTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mArrayTypeName.reader_string (SOURCE_FILE_AT_LINE (2599)), var_arrayTypeIndex COMMA_SOURCE_FILE_AT_LINE (2599)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_elementTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mElementTypeName.reader_string (SOURCE_FILE_AT_LINE (2602)), var_elementTypeIndex COMMA_SOURCE_FILE_AT_LINE (2602)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2604)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2605)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2606)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2607)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_boolType ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("bool"), var_boolType COMMA_SOURCE_FILE_AT_LINE (2610)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_uintType ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2613)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unifiedTypeMapProxyList var_uintArgs = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2615)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  //-------- @loopInstructionForGeneration
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2617)).isValid ()) {
    PMUInt32 variant_103562 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2617)).uintValue () ;
    bool loop_103562 = true ;
    while (loop_103562) {
      loop_103562 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2617)))).isValid () ;
      if (loop_103562) {
        loop_103562 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2617)))).boolValue () ;
      }
      if (loop_103562 && (0 == variant_103562)) {
        loop_103562 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2617)) ;
      }
      if (loop_103562) {
        variant_103562 -- ;
        //-------- @plusEqualnstructionForGeneration
        var_uintArgs.addAssign_operation (var_uintType COMMA_SOURCE_FILE_AT_LINE (2618)) ;
        //-------- @incrementInstructionForGeneration
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (2619)) ;
      }
    }
  }
  { //-------- @modifierCallInstructionForGeneration
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2623)), var_uintArgs, GALGAS_bool (false), var_arrayTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2622)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterBaseReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("axisCount"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2629)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("sizeForAxis"), GALGAS_string ("uint"), GALGAS_string ("uint"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2630)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("rangeForAxis"), GALGAS_string ("uint"), GALGAS_string ("range"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2631)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("isValueValidAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2633)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2634)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_boolType, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2639)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2632)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("valueAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2643)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2644)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_elementTypeIndex, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2649)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2642)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2653)) ;
  //-------- @plusEqualnstructionForGeneration
  var_modifierFormalArgumentList.addAssign_operation (var_elementTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2654)) COMMA_SOURCE_FILE_AT_LINE (2654)) ;
  //-------- @assignmentInstructionForGeneration
  var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  //-------- @loopInstructionForGeneration
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2656)).isValid ()) {
    PMUInt32 variant_104815 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2656)).uintValue () ;
    bool loop_104815 = true ;
    while (loop_104815) {
      loop_104815 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2656)))).isValid () ;
      if (loop_104815) {
        loop_104815 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2656)))).boolValue () ;
      }
      if (loop_104815 && (0 == variant_104815)) {
        loop_104815 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2656)) ;
      }
      if (loop_104815) {
        variant_104815 -- ;
        //-------- @plusEqualnstructionForGeneration
        var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2657)) COMMA_SOURCE_FILE_AT_LINE (2657)) ;
        //-------- @incrementInstructionForGeneration
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (2658)) ;
      }
    }
  }
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertKey (GALGAS_string ("setValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2661)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2662)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2665)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2660)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertKey (GALGAS_string ("forceValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2669)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2670)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2673)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2668)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  GALGAS_unifiedTypeMapProxy joker_105410_0 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_105413_0 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_105410_0, joker_105413_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2676)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertKey (GALGAS_string ("invalidateValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2678)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2679)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2682)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2677)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSize").reader_nowhere (SOURCE_FILE_AT_LINE (2686)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2687)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2690)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2685)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2693)) ;
  //-------- @plusEqualnstructionForGeneration
  ...
  //-------- @plusEqualnstructionForGeneration
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2695)) COMMA_SOURCE_FILE_AT_LINE (2695)) ;
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSizeForAxis").reader_nowhere (SOURCE_FILE_AT_LINE (2697)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2698)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2701)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2696)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mArrayTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2708)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE_AT_LINE (2709)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2710)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2711)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2712)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2717)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2718)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2719)), GALGAS_uint ((PMUInt32) 0U), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2721)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2722)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2723)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2724)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2725)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2726)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2728)), GALGAS_string ("new"), inCompiler COMMA_SOURCE_FILE_AT_LINE (2705)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_107797_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_107797_1 ; // Joker input parameter
  GALGAS_attributeMap joker_107886_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_107886_18 ; // Joker input parameter
  GALGAS_constructorMap joker_107886_17 ; // Joker input parameter
  GALGAS_readerMap joker_107886_16 ; // Joker input parameter
  GALGAS_modifierMap joker_107886_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_107886_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_107886_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_107886_12 ; // Joker input parameter
  GALGAS_stringlist joker_107886_11 ; // Joker input parameter
  GALGAS_uint joker_107886_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_107886_9 ; // Joker input parameter
  GALGAS_stringset joker_107886_8 ; // Joker input parameter
  GALGAS_lstringlist joker_107886_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_107886_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_107886_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_107886_4 ; // Joker input parameter
  GALGAS_bool joker_107886_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_107886_2 ; // Joker input parameter
  GALGAS_string joker_107886_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_107797_2, joker_107797_1, var_typeKindEnum, var_listTypedAttributeList, joker_107886_19, joker_107886_18, joker_107886_17, joker_107886_16, joker_107886_15, joker_107886_14, joker_107886_13, joker_107886_12, joker_107886_11, joker_107886_10, joker_107886_9, joker_107886_8, joker_107886_7, joker_107886_6, joker_107886_5, joker_107886_4, joker_107886_3, joker_107886_2, joker_107886_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2743)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (2750)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2751)) COMMA_SOURCE_FILE_AT_LINE (2751)).operator_concat (GALGAS_string ("' type should be a list type") COMMA_SOURCE_FILE_AT_LINE (2751)) COMMA_SOURCE_FILE_AT_LINE (2751)) ;
    //-------- @assignmentInstructionForGeneration
    var_listTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2752)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2755)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2756)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2757)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2758)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_associatedListTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2761)), var_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (2761)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_currentTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2764)), var_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (2764)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2767)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("count"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2769)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("allKeys"), GALGAS_string ("stringset"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2770)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2771)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("listForKey"), GALGAS_string ("string"), object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2772)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2772)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyMap"), object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2774)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2774)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_enumerationDescriptorList var_enumeratorDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2776)) ;
  //-------- @plusEqualnstructionForGeneration
  var_enumeratorDescriptor.addAssign_operation (var_stringTypeIndex, GALGAS_string ("key") COMMA_SOURCE_FILE_AT_LINE (2777)) ;
  //-------- @plusEqualnstructionForGeneration
  var_enumeratorDescriptor.addAssign_operation (var_associatedListTypeIndex, GALGAS_string ("mList") COMMA_SOURCE_FILE_AT_LINE (2778)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unifiedTypeMapProxyList var_addAssignOperatorDescription = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2780)) ;
  //-------- @plusEqualnstructionForGeneration
  var_addAssignOperatorDescription.addAssign_operation (var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2781)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_109910 (var_listTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_109910.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_addAssignOperatorDescription.addAssign_operation (enumerator_109910.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2783)) ;
    enumerator_109910.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2786)) ;
  //-------- @plusEqualnstructionForGeneration
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2787)) ;
  //-------- @plusEqualnstructionForGeneration
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2788)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mListmapTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2790)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2802)) COMMA_SOURCE_FILE_AT_LINE (2802)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2802)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListmapTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2807)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE_AT_LINE (2808)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2809)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2810)), var_listTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2816)), var_enumeratorDescriptor, var_enumerationVariants, function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2819)), var_addAssignOperatorDescription, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2821)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2822)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2823)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2824)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2825)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptyMap"), inCompiler COMMA_SOURCE_FILE_AT_LINE (2804)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_predefinedTypeAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mPredefinedTypeName COMMA_SOURCE_FILE_AT_LINE (2861)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2861)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_predefinedTypeAST temp_0 = object ;
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_classDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (2874)) COMMA_SOURCE_FILE_AT_LINE (2874)), object->mAttribute_mClassTypeName.reader_location (SOURCE_FILE_AT_LINE (2874)) COMMA_SOURCE_FILE_AT_LINE (2874)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_classDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2875)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2877)) COMMA_SOURCE_FILE_AT_LINE (2877)), object->mAttribute_mSuperClassName.reader_location (SOURCE_FILE_AT_LINE (2877)) COMMA_SOURCE_FILE_AT_LINE (2877)) COMMA_SOURCE_FILE_AT_LINE (2877)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_114089 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_114089.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_114089.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2880)) COMMA_SOURCE_FILE_AT_LINE (2880)), enumerator_114089.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2880)) COMMA_SOURCE_FILE_AT_LINE (2880)) COMMA_SOURCE_FILE_AT_LINE (2880)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_114089.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_listDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2894)) COMMA_SOURCE_FILE_AT_LINE (2894)), object->mAttribute_mListTypeName.reader_location (SOURCE_FILE_AT_LINE (2894)) COMMA_SOURCE_FILE_AT_LINE (2894)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_listDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2895)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_115070 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_115070.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_115070.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2897)) COMMA_SOURCE_FILE_AT_LINE (2897)), enumerator_115070.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2897)) COMMA_SOURCE_FILE_AT_LINE (2897)) COMMA_SOURCE_FILE_AT_LINE (2897)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_115070.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_structDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (2910)) COMMA_SOURCE_FILE_AT_LINE (2910)), object->mAttribute_mStructTypeName.reader_location (SOURCE_FILE_AT_LINE (2910)) COMMA_SOURCE_FILE_AT_LINE (2910)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_115931 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_115931.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_115931.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2913)) COMMA_SOURCE_FILE_AT_LINE (2913)), enumerator_115931.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2913)) COMMA_SOURCE_FILE_AT_LINE (2913)) COMMA_SOURCE_FILE_AT_LINE (2913)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_115931.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (2926)) COMMA_SOURCE_FILE_AT_LINE (2926)), object->mAttribute_mEnumTypeName.reader_location (SOURCE_FILE_AT_LINE (2926)) COMMA_SOURCE_FILE_AT_LINE (2926)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_enumDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2927)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_sortedListDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2939)) COMMA_SOURCE_FILE_AT_LINE (2939)), object->mAttribute_mSortedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2939)) COMMA_SOURCE_FILE_AT_LINE (2939)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_117496 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_117496.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_117496.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2942)) COMMA_SOURCE_FILE_AT_LINE (2942)), enumerator_117496.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2942)) COMMA_SOURCE_FILE_AT_LINE (2942)) COMMA_SOURCE_FILE_AT_LINE (2942)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_117496.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_arrayDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mArrayTypeName.reader_string (SOURCE_FILE_AT_LINE (2955)) COMMA_SOURCE_FILE_AT_LINE (2955)), object->mAttribute_mArrayTypeName.reader_location (SOURCE_FILE_AT_LINE (2955)) COMMA_SOURCE_FILE_AT_LINE (2955)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mElementTypeName.reader_string (SOURCE_FILE_AT_LINE (2957)) COMMA_SOURCE_FILE_AT_LINE (2957)), object->mAttribute_mElementTypeName.reader_location (SOURCE_FILE_AT_LINE (2957)) COMMA_SOURCE_FILE_AT_LINE (2957)) COMMA_SOURCE_FILE_AT_LINE (2957)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_listmapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2969)) COMMA_SOURCE_FILE_AT_LINE (2969)), object->mAttribute_mListmapTypeName.reader_location (SOURCE_FILE_AT_LINE (2969)) COMMA_SOURCE_FILE_AT_LINE (2969)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2971)) COMMA_SOURCE_FILE_AT_LINE (2971)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2971)) COMMA_SOURCE_FILE_AT_LINE (2971)) COMMA_SOURCE_FILE_AT_LINE (2971)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_mapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2983)) COMMA_SOURCE_FILE_AT_LINE (2983)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2983)) COMMA_SOURCE_FILE_AT_LINE (2983)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_119990 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_119990.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_119990.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2986)) COMMA_SOURCE_FILE_AT_LINE (2986)), enumerator_119990.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2986)) COMMA_SOURCE_FILE_AT_LINE (2986)) COMMA_SOURCE_FILE_AT_LINE (2986)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_119990.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_uniqueMapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2999)) COMMA_SOURCE_FILE_AT_LINE (2999)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2999)) COMMA_SOURCE_FILE_AT_LINE (2999)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_uniqueMapDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3000)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_120848 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_120848.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_120848.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3002)) COMMA_SOURCE_FILE_AT_LINE (3002)), enumerator_120848.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3002)) COMMA_SOURCE_FILE_AT_LINE (3002)) COMMA_SOURCE_FILE_AT_LINE (3002)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_120848.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapProxyDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_mapProxyDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE_AT_LINE (3015)) COMMA_SOURCE_FILE_AT_LINE (3015)), object->mAttribute_mMapProxyTypeName.reader_location (SOURCE_FILE_AT_LINE (3015)) COMMA_SOURCE_FILE_AT_LINE (3015)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
...
static void categoryMethod_graphDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_graphDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mGraphTypeName.reader_string (SOURCE_FILE_AT_LINE (3029)) COMMA_SOURCE_FILE_AT_LINE (3029)), object->mAttribute_mGraphTypeName.reader_location (SOURCE_FILE_AT_LINE (3029)) COMMA_SOURCE_FILE_AT_LINE (3029)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_graphDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3030)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (3031)) COMMA_SOURCE_FILE_AT_LINE (3031)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (3031)) COMMA_SOURCE_FILE_AT_LINE (3031)) COMMA_SOURCE_FILE_AT_LINE (3031)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externTypeDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_externTypeDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mExternTypeName.reader_string (SOURCE_FILE_AT_LINE (3043)) COMMA_SOURCE_FILE_AT_LINE (3043)), object->mAttribute_mExternTypeName.reader_location (SOURCE_FILE_AT_LINE (3043)) COMMA_SOURCE_FILE_AT_LINE (3043)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
...
static void categoryMethod_externFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3056)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3068)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3080)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3092)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3104)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3116)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3128)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3140)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3152)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_categoryReaderAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3164)) COMMA_SOURCE_FILE_AT_LINE (3164)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3164)).operator_concat (object->mAttribute_mCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (3164)) COMMA_SOURCE_FILE_AT_LINE (3164)), object->mAttribute_mCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (3164)) COMMA_SOURCE_FILE_AT_LINE (3164)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryReaderAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3165)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3166)) COMMA_SOURCE_FILE_AT_LINE (3166)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3166)) COMMA_SOURCE_FILE_AT_LINE (3166)) COMMA_SOURCE_FILE_AT_LINE (3166)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3168)) COMMA_SOURCE_FILE_AT_LINE (3168)).operator_not (SOURCE_FILE_AT_LINE (3168)).boolEnum () ;
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3171)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3169)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_129930 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3174)) ;
  if (NULL != objectArray_129930) {
      macroValidSharedObject (objectArray_129930, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_129930->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3175)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_categoryMethodAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3192)) COMMA_SOURCE_FILE_AT_LINE (3192)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3192)).operator_concat (object->mAttribute_mCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (3192)) COMMA_SOURCE_FILE_AT_LINE (3192)), object->mAttribute_mCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (3192)) COMMA_SOURCE_FILE_AT_LINE (3192)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryMethodAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3193)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3194)) COMMA_SOURCE_FILE_AT_LINE (3194)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3194)) COMMA_SOURCE_FILE_AT_LINE (3194)) COMMA_SOURCE_FILE_AT_LINE (3194)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3196)) COMMA_SOURCE_FILE_AT_LINE (3196)).operator_not (SOURCE_FILE_AT_LINE (3196)).boolEnum () ;
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3199)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3197)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_131231 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3202)) ;
  if (NULL != objectArray_131231) {
      macroValidSharedObject (objectArray_131231, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_131231->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3203)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_categoryModifierAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3219)) COMMA_SOURCE_FILE_AT_LINE (3219)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3219)).operator_concat (object->mAttribute_mCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (3219)) COMMA_SOURCE_FILE_AT_LINE (3219)), object->mAttribute_mCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (3219)) COMMA_SOURCE_FILE_AT_LINE (3219)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3223)) COMMA_SOURCE_FILE_AT_LINE (3223)).operator_not (SOURCE_FILE_AT_LINE (3223)).boolEnum () ;
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3226)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3224)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_132502 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3229)) ;
  if (NULL != objectArray_132502) {
      macroValidSharedObject (objectArray_132502, cMapElement_categoryModifierMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_132502->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3230)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3246)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_abstractCategoryReaderAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3258)) COMMA_SOURCE_FILE_AT_LINE (3258)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3258)).operator_concat (object->mAttribute_mAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (3258)) COMMA_SOURCE_FILE_AT_LINE (3258)), object->mAttribute_mAbstractCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (3258)) COMMA_SOURCE_FILE_AT_LINE (3258)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_abstractCategoryReaderAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3259)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3260)) COMMA_SOURCE_FILE_AT_LINE (3260)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3260)) COMMA_SOURCE_FILE_AT_LINE (3260)) COMMA_SOURCE_FILE_AT_LINE (3260)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3262)) COMMA_SOURCE_FILE_AT_LINE (3262)).operator_not (SOURCE_FILE_AT_LINE (3262)).boolEnum () ;
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3265)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3263)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_134402 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3268)) ;
  if (NULL != objectArray_134402) {
      macroValidSharedObject (objectArray_134402, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_134402->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3269)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_abstractCategoryMethodAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3286)) COMMA_SOURCE_FILE_AT_LINE (3286)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3286)).operator_concat (object->mAttribute_mAbstractCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (3286)) COMMA_SOURCE_FILE_AT_LINE (3286)), object->mAttribute_mAbstractCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (3286)) COMMA_SOURCE_FILE_AT_LINE (3286)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3290)) COMMA_SOURCE_FILE_AT_LINE (3290)).operator_not (SOURCE_FILE_AT_LINE (3290)).boolEnum () ;
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3293)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3291)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_135751 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3296)) ;
  if (NULL != objectArray_135751) {
      macroValidSharedObject (objectArray_135751, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_135751->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3297)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_abstractCategoryModifierAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3313)) COMMA_SOURCE_FILE_AT_LINE (3313)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3313)).operator_concat (object->mAttribute_mAbstractCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (3313)) COMMA_SOURCE_FILE_AT_LINE (3313)), object->mAttribute_mAbstractCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (3313)) COMMA_SOURCE_FILE_AT_LINE (3313)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3317)) COMMA_SOURCE_FILE_AT_LINE (3317)).operator_not (SOURCE_FILE_AT_LINE (3317)).boolEnum () ;
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3320)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3318)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_137062 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3323)) ;
  if (NULL != objectArray_137062) {
      macroValidSharedObject (objectArray_137062, cMapElement_categoryModifierMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_137062->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3324)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_mapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3343)) ;
  //-------- @plusEqualnstructionForGeneration
  var_structAttributeList.addAssign_operation (GALGAS_string ("lstring").reader_nowhere (SOURCE_FILE_AT_LINE (3345)), GALGAS_string ("lkey").reader_nowhere (SOURCE_FILE_AT_LINE (3346)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3347)) COMMA_SOURCE_FILE_AT_LINE (3344)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_137901 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_137901.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_structAttributeList.addAssign_operation (enumerator_137901.current_mAttributeTypeName (HERE), enumerator_137901.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3353)) COMMA_SOURCE_FILE_AT_LINE (3350)) ;
    enumerator_137901.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mMapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3358)) COMMA_SOURCE_FILE_AT_LINE (3358)), object->mAttribute_mMapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3358)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3356)) COMMA_SOURCE_FILE_AT_LINE (3356)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_listDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3369)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_138535 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_138535.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_structAttributeList.addAssign_operation (enumerator_138535.current_mAttributeTypeName (HERE), enumerator_138535.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3374)) COMMA_SOURCE_FILE_AT_LINE (3371)) ;
    enumerator_138535.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3379)) COMMA_SOURCE_FILE_AT_LINE (3379)), object->mAttribute_mListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3379)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3377)) COMMA_SOURCE_FILE_AT_LINE (3377)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_sortedListDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3390)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_139177 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_139177.hasCurrentObject ()) {
    //-------- @plusEqualnstructionForGeneration
    var_structAttributeList.addAssign_operation (enumerator_139177.current_mAttributeTypeName (HERE), enumerator_139177.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3395)) COMMA_SOURCE_FILE_AT_LINE (3392)) ;
    enumerator_139177.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mSortedListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3400)) COMMA_SOURCE_FILE_AT_LINE (3400)), object->mAttribute_mSortedListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3400)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3398)) COMMA_SOURCE_FILE_AT_LINE (3398)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_listmapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3411)) ;
  //-------- @plusEqualnstructionForGeneration
  var_structAttributeList.addAssign_operation (GALGAS_string ("string").reader_nowhere (SOURCE_FILE_AT_LINE (3413)), GALGAS_string ("key").reader_nowhere (SOURCE_FILE_AT_LINE (3414)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3415)) COMMA_SOURCE_FILE_AT_LINE (3412)) ;
  //-------- @plusEqualnstructionForGeneration
  var_structAttributeList.addAssign_operation (object->mAttribute_mAssociatedListTypeName, GALGAS_string ("mList").reader_nowhere (SOURCE_FILE_AT_LINE (3419)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3420)) COMMA_SOURCE_FILE_AT_LINE (3417)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3425)) COMMA_SOURCE_FILE_AT_LINE (3425)), object->mAttribute_mListmapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3425)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3423)) COMMA_SOURCE_FILE_AT_LINE (3423)) ;
}
//---------------------------------------------------------------------------*
