...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_53862,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_53862 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_54128 (operand_53862->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_54128 = NULL ;
      while (((operand_54128 = enumerator_54128.nextObject ()))) {
        macroValidPointer (operand_54128) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54128->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1334)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1334)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_54128->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_53862->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1338)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_54661,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_54661 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_54928 (operand_54661->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_54928 = NULL ;
      while (((operand_54928 = enumerator_54928.nextObject ()))) {
        macroValidPointer (operand_54928) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54928->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1351)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1351)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54661->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1356)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1356)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_54661->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1358)) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_55628,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_55628 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_55628->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1369)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1369)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_55628->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1371)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_56221,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_56221 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_56686_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_56686_1 ;
    GGS_attributeMap  automatic_var_56686_2 ;
    GGS_typedAttributeList  automatic_var_56686_3 ;
    GGS_constructorMap  automatic_var_56686_4 ;
    GGS_readerMap  automatic_var_56686_5 ;
    GGS_modifierMap  automatic_var_56686_6 ;
    GGS_instanceMethodMap  automatic_var_56686_7 ;
    GGS_classMethodMap  automatic_var_56686_8 ;
    GGS_enumerationDescriptorList  automatic_var_56686_9 ;
    GGS_uint  automatic_var_56686_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_56686_11 ;
    GGS_nativeAttributeList  automatic_var_56686_12 ;
    GGS_stringset  automatic_var_56686_13 ;
    GGS_lstringlist  automatic_var_56686_14 ;
    GGS_typedAttributeList  automatic_var_56686_15 ;
    GGS_mapSearchMethodListAST  automatic_var_56686_16 ;
    GGS_mapSearchMethodListAST  automatic_var_56686_17 ;
    GGS_withAccessorMap  automatic_var_56686_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_56221->mAssociatedListTypeName, automatic_var_56686_0, automatic_var_56686_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_56686_2, automatic_var_56686_3, automatic_var_56686_4, automatic_var_56686_5, automatic_var_56686_6, automatic_var_56686_7, automatic_var_56686_8, automatic_var_56686_9, automatic_var_56686_10, automatic_var_56686_11, automatic_var_56686_12, automatic_var_56686_13, automatic_var_56686_14, automatic_var_56686_15, automatic_var_56686_16, automatic_var_56686_17, automatic_var_56686_18 COMMA_SOURCE_FILE_AT_LINE (1384)) ;
    }
    const GGS_bool cond_56915 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1391))) ;
    if (cond_56915.isBuiltAndTrue ()) {
      operand_56221->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_56221->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1393)) ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56221->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1402)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1402)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56221->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1405)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1405)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    ...
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("listForKey"),  GGS_string ("string"),  operand_56221->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1413)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1413)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_56221->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1415)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1415)) ;
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_60587,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60587 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_60587 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_60587->mPredefinedTypeName, operand_60587) ;
  }
}
...
category_method__objectPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_objectPredefinedTypeAST * operand_60952,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60952 != NULL) {
    GGS_objectPredefinedTypeAST  var_cas_t = operand_60952 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string ("object"), operand_60952) ;
  }
}
...
category_method__stringsetPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_stringsetPredefinedTypeAST * operand_61315,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61315 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_61315->mPredefinedTypeName, operand_61315) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_61625,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61625 != NULL) {
    const GGS_string var_cas_actualSuperTypeName = operand_61625->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1505)) ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (var_cas_actualSuperTypeName, operand_61625->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1506)), operand_61625) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_62021,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62021 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62021->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1514)), operand_62021) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_62335,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62335 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62335->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1522)), operand_62335) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_62649,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62649 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62649->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1530)), operand_62649) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_62967,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62967 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62967->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1538)), operand_62967) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_63288,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63288 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_63288->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1546)), operand_63288->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1546)), operand_63288) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_63632,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63632 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_63632->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1554)), operand_63632) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_63947,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63947 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_63947->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1562)), operand_63947->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1562)), operand_63947) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externFunctionDeclarationAST * operand_64302,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64302 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_64302) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externRoutineDeclarationAST * operand_64603,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64603 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_64603) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_65539 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_65539 = NULL ;
    while (((operand_65539 = enumerator_65539.nextObject ()))) {
      macroValidPointer (operand_65539) ;
      { typeCategoryMethod__semanticDeclarationAST__collectTypes method = findCategoryMethod__semanticDeclarationAST__collectTypes (operand_65539->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_65539->mSemanticDeclaration (HERE), var_cas_collectedTypeMap, var_cas_multiMethodMapForBuildingContext COMMA_SOURCE_FILE_AT_LINE (1596)) ;
        }
      }
    }
  }
  ...
  const GGS_bool cond_66051 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_66051.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_65914 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_65914 = NULL ;
      while (((operand_65914 = enumerator_65914.nextObject ()))) {
        macroValidPointer (operand_65914) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_65914->mValue) ;
      }
    }
  ...
  }else if (cond_66051.isBuiltAndFalse ()) {
    const GGS_bool cond_66353 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_66353.isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_66217 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_66217 = NULL ;
        while (((operand_66217 = enumerator_66217.nextObject ()))) {
          macroValidPointer (operand_66217) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_66217->mValue) ;
        }
      }
      ...
      var_cas_outSemanticContext.drop () ;
    }else if (cond_66353.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_66716 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_66716 = NULL ;
        while (((operand_66716 = enumerator_66716.nextObject ()))) {
          macroValidPointer (operand_66716) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_66716->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_66716->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (1622)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_67830 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_67830 (_variant_67830.isBuilt (), true) ;
      while (_condition_67830.isBuiltAndTrue ()) {
        _condition_67830 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_67830.isBuiltAndTrue ()) {
          if (_variant_67830.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1643)) ;
            _condition_67830 = GGS_bool (false) ;
          }else{
            _variant_67830.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_67445 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_67445 = NULL ;
              while (((operand_67445 = enumerator_67445.nextObject ()))) {
                macroValidPointer (operand_67445) ;
                const GGS_bool cond_67673 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_67445->mDependanceString) ;
                if (cond_67673.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_67445->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_67445->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_67673.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_67445->mDependanceString, operand_67445->mTypeString, operand_67445->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_68453 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_68453.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_68112 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_68112 = enumerator_68112.nextObject () ;
          if ((operand_68112 != NULL)) {
            bool _foreach_loop_68112 ;
            do{
              macroValidPointer (operand_68112) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_68112->mTypeString) ;
              operand_68112 = enumerator_68112.nextObject () ;
              _foreach_loop_68112 = ((operand_68112 != NULL)) ;
              if (_foreach_loop_68112) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_68112) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_68285 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_68285 = NULL ;
          while (((operand_68285 = enumerator_68285.nextObject ()))) {
            macroValidPointer (operand_68285) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_68285->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_68285->mDependanceString) ;
          }
        }
        ...
        var_cas_outSemanticContext.drop () ;
      }else if (cond_68453.isBuiltAndFalse ()) {
        ...
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_68869 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_68869 = NULL ;
          while (((operand_68869 = enumerator_68869.nextObject ()))) {
            macroValidPointer (operand_68869) ;
            { typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (operand_68869->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_68869->mSemanticDeclaration (HERE), var_cas_multiMethodMapForBuildingContext, var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (1668)) ;
              }
            }
          }
        }
