...
category_method__mapDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
  ...
  if (operand_33694 != NULL) {
    ...
    const GGS_bool cond_41412 = (operand_33694->mMapStateList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
    if (cond_41412.isBuiltAndTrue ()) {
      GGS_unifiedTypeMapProxy  var_cas_locationTypeIndex ;
      ...
      var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("openBranch"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (915)), GGS_formalParameterSignature ::constructor_emptyList (), GGS_bool (true), GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (918)) COMMA_SOURCE_FILE_AT_LINE (914)) ;
      var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("closeBranch"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (921)), GGS_formalParameterSignature ::constructor_listWithValue (var_cas_locationTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (922))), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (924)) COMMA_SOURCE_FILE_AT_LINE (920)) ;
      var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("closeOverride"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (927)), GGS_formalParameterSignature ::constructor_listWithValue (var_cas_locationTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (928))), GGS_bool (true), GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (930)) COMMA_SOURCE_FILE_AT_LINE (926)) ;
      ...
      {
        GGS_mapOverrideBlockListAST::cEnumerator enumerator_41140 (operand_33694->mMapOverrideBlockListAST, true) ;
        const GGS_mapOverrideBlockListAST::cElement * operand_41140 = NULL ;
        while (((operand_41140 = enumerator_41140.nextObject ()))) {
          macroValidPointer (operand_41140) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("openOverrideFor")).operator_concat (operand_41140->mOverrideBlockName.ggs_string ().reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (942)), GGS_formalParameterSignature ::constructor_emptyList (), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (945)) COMMA_SOURCE_FILE_AT_LINE (941)) ;
        }
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_41479 (operand_33694->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_41479 = NULL ;
      while (((operand_41479 = enumerator_41479.nextObject ()))) {
        macroValidPointer (operand_41479) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, (operand_41479->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (951))).operator_concat (GGS_string ("ForKey")), operand_41479->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (951)) COMMA_SOURCE_FILE_AT_LINE (951)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_41479->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (953)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (953)) ;
    ...
    const GGS_bool cond_42434 = (operand_33694->mInsertOrReplaceDeclarationListAST.reader_length ()).operator_supOrEqual (GGS_uint (1U)) ;
    if (cond_42434.isBuiltAndTrue ()) {
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_42519 (operand_33694->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_42519 = NULL ;
      while (((operand_42519 = enumerator_42519.nextObject ()))) {
        macroValidPointer (operand_42519) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_42519->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (977)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")), operand_42519->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (977)) COMMA_SOURCE_FILE_AT_LINE (977)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_42519->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (979)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (979)) ;
...
category_method__mapProxyDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_44488,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_44488 != NULL) {
    ...
    GGS_bool automatic_var_45102_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_45102_1 ;
    GGS_typedAttributeList  automatic_var_45102_2 ;
    GGS_attributeMap  automatic_var_45102_3 ;
    GGS_constructorMap  automatic_var_45102_4 ;
    GGS_readerMap  automatic_var_45102_5 ;
    GGS_modifierMap  automatic_var_45102_6 ;
    GGS_instanceMethodMap  automatic_var_45102_7 ;
    GGS_classMethodMap  automatic_var_45102_8 ;
    GGS_enumerationDescriptorList  automatic_var_45102_9 ;
    GGS_uint  automatic_var_45102_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_45102_11 ;
    GGS_nativeAttributeList  automatic_var_45102_12 ;
    GGS_stringset  automatic_var_45102_13 ;
    GGS_lstringlist  automatic_var_45102_14 ;
    GGS_typedAttributeList  automatic_var_45102_15 ;
    GGS_mapSearchMethodListAST  automatic_var_45102_16 ;
    GGS_withAccessorMap  automatic_var_45102_17 ;
    GGS_bool automatic_var_45102_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_44488->mAssociatedMapTypeName, automatic_var_45102_0, automatic_var_45102_1, var_cas_typeKindEnum, automatic_var_45102_2, automatic_var_45102_3, var_cas_mapTypedAttributeList, automatic_var_45102_4, automatic_var_45102_5, automatic_var_45102_6, automatic_var_45102_7, automatic_var_45102_8, automatic_var_45102_9, automatic_var_45102_10, automatic_var_45102_11, automatic_var_45102_12, automatic_var_45102_13, automatic_var_45102_14, automatic_var_45102_15, var_cas_searchMethodList, automatic_var_45102_16, automatic_var_45102_17, automatic_var_45102_18 COMMA_SOURCE_FILE_AT_LINE (1039)) ;
    }
    const GGS_bool cond_45319 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_mapType (inLexique COMMA_SOURCE_FILE_AT_LINE (1049))) ;
    if (cond_45319.isBuiltAndTrue ()) {
      operand_44488->mAssociatedMapTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_44488->mAssociatedMapTypeName)).operator_concat (GGS_string (" should be a map type")) COMMA_SOURCE_FILE_AT_LINE (1051)) ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_44488->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1061)), var_cas_associatedMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (1061)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_44488->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1070)), var_cas_mapProxyTypeProxy COMMA_SOURCE_FILE_AT_LINE (1070)) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("null"),  operand_44488->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1082)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1082)) ;
    ...
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_47119 (var_cas_searchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_47119 = NULL ;
      while (((operand_47119 = enumerator_47119.nextObject ()))) {
        macroValidPointer (operand_47119) ;
        var_cas_constructorMap.modifier_insertKey (inLexique, operand_47119->mSearchMethodName, var_cas_constructorAttributeTypeList, GGS_bool (true), var_cas_mapProxyTypeProxy COMMA_SOURCE_FILE_AT_LINE (1088)) ;
      }
    }
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_48091 (var_cas_mapTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_48091 = NULL ;
      while (((operand_48091 = enumerator_48091.nextObject ()))) {
        macroValidPointer (operand_48091) ;
        const GGS_bool cond_48498 = var_cas_inheritedReaderMap.reader_hasKey (operand_48091->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1105))) ;
        if (cond_48498.isBuiltAndTrue ()) {
          GGS_string var_cas_s = GGS_string ("") ;
          {
            GGS_stringset::cEnumerator enumerator_48199 (var_cas_inheritedReaderMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (1107)), true) ;
            if (enumerator_48199 .hasCurrentObject ()) {
              bool _foreach_loop_48199 ;
              do{
                var_cas_s.appendCString ("'") ;
                var_cas_s.dotAssign_operation (enumerator_48199._key (HERE)) ;
                var_cas_s.appendCString ("'") ;
                enumerator_48199.next () ;
                _foreach_loop_48199 = (enumerator_48199 .hasCurrentObject ()) ;
                if (_foreach_loop_48199) {
                  var_cas_s.appendCString (", ") ;
                }
              }while (_foreach_loop_48199) ;
            }
          }
          operand_48091->mAttributeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the map has a associated map proxy, which has predefined readers: ")).operator_concat (var_cas_s)).operator_concat (GGS_string ("; you cannot use theses names for naming an attribute of this map")) COMMA_SOURCE_FILE_AT_LINE (1113)) ;
        }else if (cond_48498.isBuiltAndFalse ()) {
          var_cas_readerMap.modifier_insertKey (inLexique, operand_48091->mAttributeName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_location (inLexique), GGS_bool (true), operand_48091->mAttributeTypeProxy, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1121)) COMMA_SOURCE_FILE_AT_LINE (1114)) ;
        }
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_44488->mMapProxyTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1129)), GGS_typeKindEnum::constructor_mapProxyType (inLexique COMMA_SOURCE_FILE_AT_LINE (1130)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1132)), var_cas_mapTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, var_cas_classMethodMap, GGS_enumerationDescriptorList ::constructor_emptyList (), function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1140)), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), var_cas_searchMethodList, GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1148)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1126)) ;
  }
}
...
category_method__enumDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_enumDeclarationAST * operand_49702,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_49702 != NULL) {
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_49702->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1168)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1168)) ;
    GGS_stringset  var_cas_constantSet = GGS_stringset ::constructor_emptySet () ;
    {
      GGS_lstringlist::cEnumerator enumerator_50430 (operand_49702->mConstantList, true) ;
      const GGS_lstringlist::cElement * operand_50430 = NULL ;
      while (((operand_50430 = enumerator_50430.nextObject ()))) {
        macroValidPointer (operand_50430) ;
        var_cas_constantSet.addAssign_operation (operand_50430->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1172))) ;
        ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  operand_50430->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1173)),  operand_49702->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1173)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1173)) ;
      }
    }
    GGS_readerMap  var_cas_readerMap ;
    ...
    {
      GGS_enumMessageListAST::cEnumerator enumerator_50758 (operand_49702->mEnumMessageList, true) ;
      const GGS_enumMessageListAST::cElement * operand_50758 = NULL ;
      while (((operand_50758 = enumerator_50758.nextObject ()))) {
        macroValidPointer (operand_50758) ;
        ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_50758->mEnumMessageName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1179)),  GGS_string ("string"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1179)) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_49702->mEnumTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1185)), GGS_typeKindEnum::constructor_enumType (inLexique COMMA_SOURCE_FILE_AT_LINE (1186)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1188)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1194)), GGS_enumerationDescriptorList ::constructor_emptyList (), (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1196))).operator_or (function_isComparable (inLexique COMMA_SOURCE_FILE_AT_LINE (1196))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), var_cas_constantSet, operand_49702->mConstantList, GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1204)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1182)) ;
  }
}
...
void routine_recursivelyEnumerateDirectories (C_CompilerEx & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_52556 (var_cas_files, true) ;
    const GGS_stringlist::cElement * operand_52556 = NULL ;
    while (((operand_52556 = enumerator_52556.nextObject ()))) {
      macroValidPointer (operand_52556) ;
      const GGS_bool cond_52899 = var_cas_inExtensionMap.reader_hasKey (operand_52556->mValue.reader_pathExtension ()) ;
      if (cond_52899.isBuiltAndTrue ()) {
        GGS_string var_cas_absoluteFilePath = ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_52556->mValue) ;
        var_cas_outWrapperFileMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_52556->mValue, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1235)), var_cas_absoluteFilePath, var_cas_currentDirectoryIndex, var_cas_ioWrapperFileIndex COMMA_SOURCE_FILE_AT_LINE (1234)) ;
  ...
  {
    GGS_stringlist::cEnumerator enumerator_53113 (var_cas_directories, true) ;
    const GGS_stringlist::cElement * operand_53113 = NULL ;
    while (((operand_53113 = enumerator_53113.nextObject ()))) {
      macroValidPointer (operand_53113) ;
      ...
      ::routine_recursivelyEnumerateDirectories (inLexique,  ((var_cas_inAbsoluteSourcePath).operator_concat (GGS_string ("/"))).operator_concat (operand_53113->mValue),  ((var_cas_inPathInWrapper).operator_concat (operand_53113->mValue)).operator_concat (GGS_string ("/")),  var_cas_inExtensionMap,  var_cas_internalWrapperFileMap,  var_cas_internalWrapperDirectoryMap,  var_cas_ioWrapperFileIndex,  var_cas_ioWrapperDirectoryIndex COMMA_SOURCE_FILE_AT_LINE (1250)) ;
      var_cas_outWrapperDirectoryMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, operand_53113->mValue, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1260)), var_cas_internalWrapperFileMap, var_cas_internalWrapperDirectoryMap, var_cas_theDirectoryIndex COMMA_SOURCE_FILE_AT_LINE (1259)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
category_method__filewrapperDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_filewrapperDeclarationAST * operand_53892,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_53892 != NULL) {
    ...
    {
      GGS_filewrapperTemplateListAST::cEnumerator enumerator_54217 (operand_53892->mFilewrapperTemplateList, true) ;
      const GGS_filewrapperTemplateListAST::cElement * operand_54217 = NULL ;
      while (((operand_54217 = enumerator_54217.nextObject ()))) {
        macroValidPointer (operand_54217) ;
        GGS_unifiedTypeMapProxyList  var_cas_templateSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
        {
          GGS_formalTemplateInputParameterListAST::cEnumerator enumerator_54335 (operand_54217->mFilewrapperTemplateFormalInputParameters, true) ;
          const GGS_formalTemplateInputParameterListAST::cElement * operand_54335 = NULL ;
          while (((operand_54335 = enumerator_54335.nextObject ()))) {
            macroValidPointer (operand_54335) ;
            GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54335->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1281)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1281)) ;
            var_cas_templateSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
          }
        }
        var_cas_filewrapperTemplateMap.modifier_insertKey (inLexique, operand_54217->mFilewrapperTemplateName, var_cas_templateSignature, operand_54217->mFilewrapperTemplatePath COMMA_SOURCE_FILE_AT_LINE (1284)) ;
      }
    }
    ...
    {
      GGS_lstringlist::cEnumerator enumerator_54848 (operand_53892->mFilewrapperExtensionList, true) ;
      const GGS_lstringlist::cElement * operand_54848 = NULL ;
      while (((operand_54848 = enumerator_54848.nextObject ()))) {
        macroValidPointer (operand_54848) ;
        var_cas_extensionMap.modifier_insertKey (inLexique, operand_54848->mValue COMMA_SOURCE_FILE_AT_LINE (1293)) ;
      }
    }
    ...
    const GGS_bool cond_55182 = (operand_53892->mFilewrapperPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1299)).reader_firstCharacterOrNul ()).operator_isEqual (GGS_char (TO_UNICODE ('/'))) ;
    if (cond_55182.isBuiltAndTrue ()) {
      var_cas_absoluteSourcePath = operand_53892->mFilewrapperPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1300)) ;
    }else if (cond_55182.isBuiltAndFalse ()) {
      var_cas_absoluteSourcePath = ((operand_53892->mSourceFileAbsolutePath.reader_stringByDeletingLastPathComponent ()).operator_concat (GGS_string ("/"))).operator_concat (operand_53892->mFilewrapperPath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1302))) ;
    }
    const GGS_bool cond_55510 = (var_cas_absoluteSourcePath.reader_directoryExists ()).operator_not () ;
    if (cond_55510.isBuiltAndTrue ()) {
      operand_53892->mFilewrapperPath.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("The '")).operator_concat (var_cas_absoluteSourcePath)).operator_concat (GGS_string ("' directory does not exist")) COMMA_SOURCE_FILE_AT_LINE (1307)) ;
      var_cas_regularRootFileMap.drop () ;
      var_cas_wrapperDirectoryMap.drop () ;
    }else if (cond_55510.isBuiltAndFalse ()) {
    ...
    var_cas_ioSemanticContext.mFilewrapperMap.modifier_insertKey (inLexique, operand_53892->mFilewrapperName, operand_53892->mFilewrapperPath, operand_53892->mFilewrapperExtensionList, var_cas_regularRootFileMap, var_cas_wrapperDirectoryMap, var_cas_filewrapperTemplateMap COMMA_SOURCE_FILE_AT_LINE (1322)) ;
  }
}
...
category_method__listDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_listDeclarationAST * operand_56201,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_56201 != NULL) {
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_56577 (operand_56201->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_56577 = NULL ;
      while (((operand_56577 = enumerator_56577.nextObject ()))) {
        macroValidPointer (operand_56577) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56577->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1344)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1344)) ;
        GGS_bool var_cas_hasGetter = GGS_bool (true) ;
        GGS_bool var_cas_hasSetter = GGS_bool (true) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_56577->mAttributeName, var_cas_hasSetter, var_cas_hasGetter) ;
      }
    }
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56201->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1354)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (1354)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_57576 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_57576 = NULL ;
      while (((operand_57576 = enumerator_57576.nextObject ()))) {
        macroValidPointer (operand_57576) ;
        var_cas_enumerationDescriptor.addAssign_operation (operand_57576->mAttributeTypeProxy, operand_57576->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1361))) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_57576->mAttributeTypeProxy) ;
        var_cas_modifierOutputFormalArgumentList.addAssign_operation (operand_57576->mAttributeTypeProxy, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (1363))) ;
        var_cas_modifierInputFormalArgumentList.addAssign_operation (operand_57576->mAttributeTypeProxy, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1364))) ;
      }
    }
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyList"),  operand_56201->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1368)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1368)) ;
    ...
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListFromIndex"),  GGS_string ("uint"),  operand_56201->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1378)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1378)) ;
    ::routine_enterBaseReaderWith2Arguments (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListWithRange"),  GGS_string ("uint"),  GGS_string ("uint"),  operand_56201->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1379)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1379)) ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_58746 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_58746 = NULL ;
      while (((operand_58746 = enumerator_58746.nextObject ()))) {
        macroValidPointer (operand_58746) ;
        var_cas_readerMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, (operand_58746->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1382))).operator_concat (GGS_string ("AtIndex")), operand_58746->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1382)) COMMA_SOURCE_FILE_AT_LINE (1382)), GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_listWithValue (var_cas_uintType), GGS_location (inLexique), GGS_bool (true), operand_58746->mAttributeTypeProxy, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1388)) COMMA_SOURCE_FILE_AT_LINE (1381)) ;
      }
    }
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_59626 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_59626 = NULL ;
      while (((operand_59626 = enumerator_59626.nextObject ()))) {
        macroValidPointer (operand_59626) ;
        GGS_formalParameterSignature  var_cas_setterFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        var_cas_setterFormalArgumentList.addAssign_operation (operand_59626->mAttributeTypeProxy, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1413))) ;
        ...
        var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_59626->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1416)).reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("AtIndex")), operand_59626->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1416)) COMMA_SOURCE_FILE_AT_LINE (1416)), var_cas_setterFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1419)) COMMA_SOURCE_FILE_AT_LINE (1415)) ;
      }
    }
    ...
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_56201->mListTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1444)), GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1445)), var_cas_typedAttributeList, GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1447)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1453)), var_cas_enumerationDescriptor, ((function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1455))).operator_or (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1455)))).operator_or (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1455))), var_cas_constructorAttributeTypeList, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1463)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1441)) ;
  }
}
...
category_method__sortedListDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_61615,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61615 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    ...
    GGS_unifiedTypeMapProxy  var_cas_listTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_61615->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1480)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (1480)) ;
    GGS_enumerationDescriptorList  var_cas_enumerationDescriptor = GGS_enumerationDescriptorList ::constructor_emptyList () ;
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    GGS_formalParameterSignature  var_cas_modifierFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_62514 (operand_61615->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_62514 = NULL ;
      while (((operand_62514 = enumerator_62514.nextObject ()))) {
        macroValidPointer (operand_62514) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_62514->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1488)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1488)) ;
        GGS_bool var_cas_hasGetter = GGS_bool (true) ;
        GGS_bool var_cas_hasSetter = GGS_bool (true) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_62514->mAttributeName, var_cas_hasSetter, var_cas_hasGetter) ;
        var_cas_enumerationDescriptor.addAssign_operation (var_cas_attributeTypeIndex, operand_62514->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1492))) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptySortedList"),  operand_61615->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1498)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1498)) ;
    ...
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_61615->mSortedListTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1544)), GGS_typeKindEnum::constructor_sortedListType (inLexique COMMA_SOURCE_FILE_AT_LINE (1545)), var_cas_typedAttributeList, GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1547)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1553)), var_cas_enumerationDescriptor, ((function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1555))).operator_or (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1555)))).operator_or (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1555))), var_cas_constructorAttributeTypeList, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1563)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1541)) ;
  }
}
...
category_method__structDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_structDeclarationAST * operand_65405,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_65405 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_structTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_65405->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1578)), var_cas_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (1578)) ;
    GGS_attributeMap  var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1580)) ;
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1581)) ;
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_66135 (operand_65405->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_66135 = NULL ;
      while (((operand_66135 = enumerator_66135.nextObject ()))) {
        macroValidPointer (operand_66135) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_66135->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1586)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1586)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        GGS_bool var_cas_hasSetter = GGS_bool (false) ;
        GGS_bool var_cas_hasGetter = GGS_bool (true) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_66135->mAttributeName, var_cas_hasSetter, var_cas_hasGetter) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_66135->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1591)) ;
      }
    }
    var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1594)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (1593)) ;
    GGS_readerMap  var_cas_readerMap ;
    ::routine_commonReaderMapForAllTypes (inLexique,  var_cas_ioSemanticContext.mTypeMap,  var_cas_readerMap COMMA_SOURCE_FILE_AT_LINE (1601)) ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_66873 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_66873 = NULL ;
      while (((operand_66873 = enumerator_66873.nextObject ()))) {
        macroValidPointer (operand_66873) ;
        inLexique.printMessage (C_String ("LOGGING ATTRIBUTE: ") + operand_66873->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1603)).reader_description ().string () + "\n" COMMA_SOURCE_FILE_AT_LINE (1603)) ;
        inLexique.printMessage (C_String ("LOGGING TYPE: ") + operand_66873->mAttributeTypeProxy.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1604)).reader_description ().string () + "\n" COMMA_SOURCE_FILE_AT_LINE (1604)) ;
        ::routine_enterBaseFinalReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_66873->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1608)),  operand_66873->mAttributeTypeProxy.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1609)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1605)) ;
      }
    }
    inLexique.printMessage (C_String ("LOGGING mStructTypeName: ") + operand_65405->mStructTypeName.reader_description ().string () + "\n" COMMA_SOURCE_FILE_AT_LINE (1613)) ;
    inLexique.printMessage (C_String ("LOGGING readerMap: ") + var_cas_readerMap.reader_description ().string () + "\n" COMMA_SOURCE_FILE_AT_LINE (1613)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1615)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1617)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_65405->mStructTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1622)), GGS_typeKindEnum::constructor_structType (inLexique COMMA_SOURCE_FILE_AT_LINE (1623)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_attributeMap, var_cas_typedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1631)), GGS_enumerationDescriptorList ::constructor_emptyList (), function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1633)), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_typedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1641)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1619)) ;
  }
}
...
category_method__classDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_classDeclarationAST * operand_68271,
                                const GGS_categoryMethodMapForBuildingContext   var_cas_inCategoryMethodMapForBuildingContext,
                                const GGS_categoryReaderMapForBuildingContext   var_cas_inCategoryReaderMapForBuildingContext,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_68271 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("uint"), var_cas_uintType COMMA_SOURCE_FILE_AT_LINE (1654)) ;
    GGS_readerMap  var_cas_readerMap ;
    GGS_modifierMap  var_cas_modifierMap ;
    GGS_instanceMethodMap  var_cas_inheritedInstanceMethodMap ;
    GGS_typedAttributeList  var_cas_inheritedTypedAttributeList ;
    GGS_attributeMap  var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)) ;
    GGS_unifiedTypeMapProxy  var_cas_superClassIndex ;
    GGS_bool var_cas_generateHeaderInSeparateFile ;
    const GGS_bool cond_69488 = (operand_68271->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1664))).operator_isEqual (GGS_string ("")) ;
    if (cond_69488.isBuiltAndTrue ()) {
      var_cas_superClassIndex = GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1665)) ;
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1666)) ;
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1667)) ;
      var_cas_inheritedInstanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1668)) ;
      var_cas_inheritedTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
      var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1670)) ;
      var_cas_generateHeaderInSeparateFile = GGS_bool (false) ;
      {
        GGS_lstringlist::cEnumerator enumerator_69339 (operand_68271->mClassFeatureList, true) ;
        const GGS_lstringlist::cElement * operand_69339 = NULL ;
        while (((operand_69339 = enumerator_69339.nextObject ()))) {
          macroValidPointer (operand_69339) ;
          const GGS_bool cond_69458 = (operand_69339->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1673))).operator_isEqual (GGS_string ("generatedInSeparateFile")) ;
          if (cond_69458.isBuiltAndTrue ()) {
            var_cas_generateHeaderInSeparateFile = GGS_bool (true) ;
          }
        }
      }
    }else if (cond_69488.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_68271->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1678)), var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (1678)) ;
      GGS_typeKindEnum var_cas_typeKindEnum ;
      GGS_readerMap  var_cas_inheritedReaderMap ;
      GGS_modifierMap  var_cas_inheritedModifierMap ;
      GGS_bool automatic_var_70018_0 ;
      GGS_unifiedTypeMapProxy  automatic_var_70018_1 ;
      GGS_typedAttributeList  automatic_var_70018_2 ;
      GGS_constructorMap  automatic_var_70018_3 ;
      GGS_classMethodMap  automatic_var_70018_4 ;
      GGS_enumerationDescriptorList  automatic_var_70018_5 ;
      GGS_uint  automatic_var_70018_6 ;
      GGS_unifiedTypeMapProxyList  automatic_var_70018_7 ;
      GGS_nativeAttributeList  automatic_var_70018_8 ;
      GGS_stringset  automatic_var_70018_9 ;
      GGS_lstringlist  automatic_var_70018_10 ;
      GGS_typedAttributeList  automatic_var_70018_11 ;
      GGS_mapSearchMethodListAST  automatic_var_70018_12 ;
      GGS_mapSearchMethodListAST  automatic_var_70018_13 ;
      GGS_withAccessorMap  automatic_var_70018_14 ;
      if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
        var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_68271->mSuperClassName, automatic_var_70018_0, automatic_var_70018_1, var_cas_typeKindEnum, var_cas_inheritedTypedAttributeList, var_cas_attributeMap, automatic_var_70018_2, automatic_var_70018_3, var_cas_inheritedReaderMap, var_cas_inheritedModifierMap, var_cas_inheritedInstanceMethodMap, automatic_var_70018_4, automatic_var_70018_5, automatic_var_70018_6, automatic_var_70018_7, automatic_var_70018_8, automatic_var_70018_9, automatic_var_70018_10, automatic_var_70018_11, automatic_var_70018_12, automatic_var_70018_13, automatic_var_70018_14, var_cas_generateHeaderInSeparateFile COMMA_SOURCE_FILE_AT_LINE (1682)) ;
      }
      const GGS_bool cond_70175 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1696))) ;
      if (cond_70175.isBuiltAndTrue ()) {
        operand_68271->mSuperClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_68271->mSuperClassName)).operator_concat (GGS_string (" should be a class type")) COMMA_SOURCE_FILE_AT_LINE (1698)) ;
      }
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1700)) ;
      {
        GGS_modifierMap::cEnumerator enumerator_70297 (var_cas_inheritedModifierMap, true) ;
        const GGS_modifierMap::cElement * operand_70297 = NULL ;
        while (((operand_70297 = enumerator_70297.nextObject ()))) {
          macroValidPointer (operand_70297) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, operand_70297->mKey, operand_70297->mInfo.mParameterList, operand_70297->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1706)) COMMA_SOURCE_FILE_AT_LINE (1702)) ;
        }
      }
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1710)) ;
      {
        GGS_readerMap::cEnumerator enumerator_70577 (var_cas_inheritedReaderMap, true) ;
        const GGS_readerMap::cElement * operand_70577 = NULL ;
        while (((operand_70577 = enumerator_70577.nextObject ()))) {
          macroValidPointer (operand_70577) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_70577->mKey, operand_70577->mInfo.mIsCategory, operand_70577->mInfo.mArgumentTypeList, operand_70577->mInfo.mDeclarationLocation, operand_70577->mInfo.mHasCompilerArgument, operand_70577->mInfo.mReturnedType, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1719)) COMMA_SOURCE_FILE_AT_LINE (1712)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_70997 (var_cas_inheritedTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_70997 = NULL ;
      while (((operand_70997 = enumerator_70997.nextObject ()))) {
        macroValidPointer (operand_70997) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_70997->mAttributeTypeProxy) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_71100 (operand_68271->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_71100 = NULL ;
      while (((operand_71100 = enumerator_71100.nextObject ()))) {
        macroValidPointer (operand_71100) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_71100->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1730)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1730)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_71100->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1732)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_classIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_68271->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1736)), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1736)) ;
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1738)) ;
    const GGS_bool cond_71826 = (operand_68271->mIsAbstract).operator_not () ;
    if (cond_71826.isBuiltAndTrue ()) {
      var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1741)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1740)) ;
    }
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1748)) ;
    {
      GGS_instanceMethodMap::cEnumerator enumerator_71957 (var_cas_inheritedInstanceMethodMap, true) ;
      const GGS_instanceMethodMap::cElement * operand_71957 = NULL ;
      while (((operand_71957 = enumerator_71957.nextObject ()))) {
        macroValidPointer (operand_71957) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_71957->mKey, operand_71957->mInfo.mIsCategory, operand_71957->mInfo.mParameterList, operand_71957->mInfo.mDeclarationLocation, operand_71957->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1756)) COMMA_SOURCE_FILE_AT_LINE (1750)) ;
      }
    }
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_72239 (operand_68271->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_72239 = NULL ;
      while (((operand_72239 = enumerator_72239.nextObject ()))) {
        macroValidPointer (operand_72239) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_72328 (operand_72239->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_72328 = NULL ;
          while (((operand_72328 = enumerator_72328.nextObject ()))) {
            macroValidPointer (operand_72328) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_72328->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1764)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1764)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_72328->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_72609 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_72239->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1767))) ;
        if (NULL != operand_72609) {
          operand_72609->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1768)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_72239->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_72239->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1774)), GGS_bool (true), GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1776)) COMMA_SOURCE_FILE_AT_LINE (1770)) ;
        }
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_73026 (operand_68271->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_73026 = NULL ;
      while (((operand_73026 = enumerator_73026.nextObject ()))) {
        macroValidPointer (operand_73026) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_73115 (operand_73026->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_73115 = NULL ;
          while (((operand_73115 = enumerator_73115.nextObject ()))) {
            macroValidPointer (operand_73115) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_73115->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1785)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1785)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_73115->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_73396 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_73026->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1788))) ;
        if (NULL != operand_73396) {
          operand_73396->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverriding (inLexique COMMA_SOURCE_FILE_AT_LINE (1789)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_73026->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_73026->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1795)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1797)) COMMA_SOURCE_FILE_AT_LINE (1791)) ;
        }
      }
    }
    const GGS_bool cond_74634 = var_cas_inCategoryMethodMapForBuildingContext.reader_hasKey (operand_68271->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1802))) ;
    if (cond_74634.isBuiltAndTrue ()) {
      GGS_categoryMethodMapForType  var_cas_categoryMethodMapForType ;
      if (var_cas_inCategoryMethodMapForBuildingContext.isBuilt ()) {
        var_cas_inCategoryMethodMapForBuildingContext (HERE)->method_searchKey (inLexique, operand_68271->mClassTypeName, var_cas_categoryMethodMapForType COMMA_SOURCE_FILE_AT_LINE (1804)) ;
      }
      {
        GGS_categoryMethodMapForType::cEnumerator enumerator_74053 (var_cas_categoryMethodMapForType, true) ;
        const GGS_categoryMethodMapForType::cElement * operand_74053 = NULL ;
        while (((operand_74053 = enumerator_74053.nextObject ()))) {
          macroValidPointer (operand_74053) ;
          GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
          {
            GGS_formalParameterListAST::cEnumerator enumerator_74156 (operand_74053->mInfo.mFormalParameterList, true) ;
            const GGS_formalParameterListAST::cElement * operand_74156 = NULL ;
            while (((operand_74156 = enumerator_74156.nextObject ()))) {
              macroValidPointer (operand_74156) ;
              GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
              GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_74156->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1809)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1809)) ;
              var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_74156->mFormalArgumentPassingMode) ;
            }
          }
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_74053->mKey, GGS_bool (true), var_cas_formalArgumentList, operand_74053->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1816)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1818)) COMMA_SOURCE_FILE_AT_LINE (1812)) ;
        }
      }
    }
    const GGS_bool cond_75688 = var_cas_inCategoryReaderMapForBuildingContext.reader_hasKey (operand_68271->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1823))) ;
    if (cond_75688.isBuiltAndTrue ()) {
      GGS_categoryReaderMapForType  var_cas_categoryReaderMapForType ;
      if (var_cas_inCategoryReaderMapForBuildingContext.isBuilt ()) {
        var_cas_inCategoryReaderMapForBuildingContext (HERE)->method_searchKey (inLexique, operand_68271->mClassTypeName, var_cas_categoryReaderMapForType COMMA_SOURCE_FILE_AT_LINE (1825)) ;
      }
      {
        GGS_categoryReaderMapForType::cEnumerator enumerator_74957 (var_cas_categoryReaderMapForType, true) ;
        const GGS_categoryReaderMapForType::cElement * operand_74957 = NULL ;
        while (((operand_74957 = enumerator_74957.nextObject ()))) {
          macroValidPointer (operand_74957) ;
          GGS_unifiedTypeMapProxyList  var_cas_formalArgumentList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
          {
            GGS_formalInputParameterListAST::cEnumerator enumerator_75064 (operand_74957->mInfo.mInputFormalParameterList, true) ;
            const GGS_formalInputParameterListAST::cElement * operand_75064 = NULL ;
            while (((operand_75064 = enumerator_75064.nextObject ()))) {
              macroValidPointer (operand_75064) ;
              GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
              GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_75064->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1830)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1830)) ;
              var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex) ;
            }
          }
          GGS_unifiedTypeMapProxy  var_cas_returnedType ;
          GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_74957->mInfo.mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1834)), var_cas_returnedType COMMA_SOURCE_FILE_AT_LINE (1834)) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_74957->mKey, GGS_bool (true), var_cas_formalArgumentList, operand_74957->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1839)), GGS_bool (true), var_cas_returnedType, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1842)) COMMA_SOURCE_FILE_AT_LINE (1835)) ;
        }
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_75888 (operand_68271->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_75888 = NULL ;
      while (((operand_75888 = enumerator_75888.nextObject ()))) {
        macroValidPointer (operand_75888) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_75888->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1851)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1851)) ;
        GGS_bool var_cas_hasSetter = GGS_bool (false) ;
        GGS_bool var_cas_hasGetter = GGS_bool (true) ;
        {
          GGS_lstringlist::cEnumerator enumerator_76148 (operand_75888->mFeatureList, true) ;
          const GGS_lstringlist::cElement * operand_76148 = NULL ;
          while (((operand_76148 = enumerator_76148.nextObject ()))) {
            macroValidPointer (operand_76148) ;
            const GGS_bool cond_76233 = (operand_76148->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1855))).operator_isEqual (GGS_string ("setter")) ;
            if (cond_76233.isBuiltAndTrue ()) {
              var_cas_hasSetter = GGS_bool (true) ;
            }else if (cond_76233.isBuiltAndFalse ()) {
              const GGS_bool cond_76307 = (operand_76148->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1857))).operator_isEqual (GGS_string ("nogetter")) ;
              if (cond_76307.isBuiltAndTrue ()) {
                var_cas_hasGetter = GGS_bool (false) ;
              }
            }
          }
        }
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_75888->mAttributeName, var_cas_hasSetter, var_cas_hasGetter) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_75888->mAttributeName, var_cas_hasSetter, var_cas_hasGetter) ;
        const GGS_bool cond_77077 = var_cas_hasGetter ;
        if (cond_77077.isBuiltAndTrue ()) {
          var_cas_readerMap.modifier_insertKey (inLexique, operand_75888->mAttributeName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_location (inLexique), GGS_bool (false), var_cas_attributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1871)) COMMA_SOURCE_FILE_AT_LINE (1864)) ;
        }
      }
    }
    {
      GGS_typedAttributeList::cEnumerator enumerator_77169 (var_cas_currentClassTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_77169 = NULL ;
      while (((operand_77169 = enumerator_77169.nextObject ()))) {
        macroValidPointer (operand_77169) ;
        const GGS_bool cond_77538 = operand_77169->mHasSetter ;
        if (cond_77538.isBuiltAndTrue ()) {
          var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_77169->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1885)).reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1885)), GGS_formalParameterSignature ::constructor_listWithValue (operand_77169->mAttributeTypeProxy, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1886))), GGS_bool (false), GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (1888)) COMMA_SOURCE_FILE_AT_LINE (1884)) ;
        }
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_68271->mClassTypeName, (operand_68271->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1897)), var_cas_allTypedAttributeList, var_cas_attributeMap, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1905)), GGS_enumerationDescriptorList ::constructor_emptyList (), GGS_uint (0U), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_currentClassTypedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1915)), var_cas_generateHeaderInSeparateFile COMMA_SOURCE_FILE_AT_LINE (1893)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_78462,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_78462 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_78820 (operand_78462->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_78820 = NULL ;
      while (((operand_78820 = enumerator_78820.nextObject ()))) {
        macroValidPointer (operand_78820) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_78820->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1931)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1931)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_78820->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_78462->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1935)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_79366,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_79366 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_79725 (operand_79366->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_79725 = NULL ;
      while (((operand_79725 = enumerator_79725.nextObject ()))) {
        macroValidPointer (operand_79725) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_79725->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1949)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1949)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_79366->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1954)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1954)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_79366->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1956)) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_80438,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_80438 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_80438->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1968)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1968)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_80438->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1970)) ;
  }
}
...
category_method__listmapDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_listmapDeclarationAST * operand_81136,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_81136 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_81706_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_81706_1 ;
    GGS_attributeMap  automatic_var_81706_2 ;
    GGS_typedAttributeList  automatic_var_81706_3 ;
    GGS_constructorMap  automatic_var_81706_4 ;
    GGS_readerMap  automatic_var_81706_5 ;
    GGS_modifierMap  automatic_var_81706_6 ;
    GGS_instanceMethodMap  automatic_var_81706_7 ;
    GGS_classMethodMap  automatic_var_81706_8 ;
    GGS_enumerationDescriptorList  automatic_var_81706_9 ;
    GGS_uint  automatic_var_81706_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_81706_11 ;
    GGS_nativeAttributeList  automatic_var_81706_12 ;
    GGS_stringset  automatic_var_81706_13 ;
    GGS_lstringlist  automatic_var_81706_14 ;
    GGS_typedAttributeList  automatic_var_81706_15 ;
    GGS_mapSearchMethodListAST  automatic_var_81706_16 ;
    GGS_mapSearchMethodListAST  automatic_var_81706_17 ;
    GGS_withAccessorMap  automatic_var_81706_18 ;
    GGS_bool automatic_var_81706_19 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_81136->mAssociatedListTypeName, automatic_var_81706_0, automatic_var_81706_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_81706_2, automatic_var_81706_3, automatic_var_81706_4, automatic_var_81706_5, automatic_var_81706_6, automatic_var_81706_7, automatic_var_81706_8, automatic_var_81706_9, automatic_var_81706_10, automatic_var_81706_11, automatic_var_81706_12, automatic_var_81706_13, automatic_var_81706_14, automatic_var_81706_15, automatic_var_81706_16, automatic_var_81706_17, automatic_var_81706_18, automatic_var_81706_19 COMMA_SOURCE_FILE_AT_LINE (1984)) ;
    }
    const GGS_bool cond_81935 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1991))) ;
    if (cond_81935.isBuiltAndTrue ()) {
      operand_81136->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_81136->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1993)) ;
      var_cas_listTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1996)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1997)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1998)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1999)) ;
    GGS_unifiedTypeMapProxy  var_cas_associatedListTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_81136->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2002)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (2002)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_81136->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2005)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (2005)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2008)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("count"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2010)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("allKeys"),  GGS_string ("stringset"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2011)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("keyList"),  GGS_string ("stringlist"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2012)) ;
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("listForKey"),  GGS_string ("string"),  operand_81136->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2013)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2013)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_81136->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2015)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2015)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_83722 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_83722 = NULL ;
      while (((operand_83722 = enumerator_83722.nextObject ()))) {
        macroValidPointer (operand_83722) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_83722->mAttributeTypeProxy) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_81136->mListmapTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (2030)), GGS_typeKindEnum::constructor_listMapType (inLexique COMMA_SOURCE_FILE_AT_LINE (2031)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2033)), var_cas_listTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2039)), var_cas_enumeratorDescriptor, function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (2041)), var_cas_addAssignOperatorDescription, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2049)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2027)) ;
  }
}
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_CompilerEx &,
                                const cPtr_predefinedTypeAST * operand_85560,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_85560 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_85560 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_85560->mPredefinedTypeName, operand_85560) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_classDeclarationAST * operand_85929,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_85929 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_85929->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2089)), operand_85929->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2089)), operand_85929) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_listDeclarationAST * operand_86268,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_86268 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_86268->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2097)), operand_86268) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_structDeclarationAST * operand_86586,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_86586 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_86586->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2105)), operand_86586) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_enumDeclarationAST * operand_86904,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_86904 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_86904->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2113)), operand_86904) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_87226,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_87226 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_87226->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2121)), operand_87226) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_listmapDeclarationAST * operand_87551,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_87551 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_87551->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2129)), operand_87551->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2129)), operand_87551) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_mapDeclarationAST * operand_87899,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_87899 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_87899->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2137)), operand_87899) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_88218,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_88218 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_88218->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2145)), operand_88218->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2145)), operand_88218) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_CompilerEx &,
                                const cPtr_externFunctionDeclarationAST * operand_88577,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_88577 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_88577) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterOrderedDeclaration (C_CompilerEx &,
                                const cPtr_onceFunctionDeclarationAST * operand_88881,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_88881 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_88881) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_CompilerEx &,
                                const cPtr_externRoutineDeclarationAST * operand_89186,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_89186 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_89186) ;
  }
}
...
category_method__filewrapperDeclarationAST__enterOrderedDeclaration (C_CompilerEx &,
                                const cPtr_filewrapperDeclarationAST * operand_89489,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_89489 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_89489) ;
  }
}
...
void routine_buildSemanticContext (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_collectedTypeMap  var_cas_collectedTypeMap = GGS_collectedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2193)) ;
  GGS_categoryMethodMapForBuildingContext  var_cas_categoryMethodMapForBuildingContext = GGS_categoryMethodMapForBuildingContext ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2194)) ;
  GGS_categoryReaderMapForBuildingContext  var_cas_categoryReaderMapForBuildingContext = GGS_categoryReaderMapForBuildingContext ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2195)) ;
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_90548 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_90548 = NULL ;
    while (((operand_90548 = enumerator_90548.nextObject ()))) {
      macroValidPointer (operand_90548) ;
      { typeCategoryMethod__semanticDeclarationAST__collectTypes method = findCategoryMethod__semanticDeclarationAST__collectTypes (operand_90548->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_90548->mSemanticDeclaration (HERE), var_cas_collectedTypeMap, var_cas_categoryMethodMapForBuildingContext, var_cas_categoryReaderMapForBuildingContext COMMA_SOURCE_FILE_AT_LINE (2197)) ;
        }
      }
    }
  }
  GGS_stringlist  var_cas_undefinedClasses = var_cas_collectedTypeMap.reader_unsolvedProxyKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (2204)) ;
  const GGS_bool cond_91107 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_91107.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_90970 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_90970 = NULL ;
      while (((operand_90970 = enumerator_90970.nextObject ()))) {
        macroValidPointer (operand_90970) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_90970->mValue) ;
      }
    }
    var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (2211)) ;
    var_cas_outSemanticContext.drop () ;
  }else if (cond_91107.isBuiltAndFalse ()) {
    const GGS_bool cond_91409 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_91409.isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = ((GGS_string ("there are ")).operator_concat (var_cas_undefinedClasses.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2212)))).operator_concat (GGS_string (" undefined types:")) ;
      {
        GGS_stringlist::cEnumerator enumerator_91273 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_91273 = NULL ;
        while (((operand_91273 = enumerator_91273.nextObject ()))) {
          macroValidPointer (operand_91273) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_91273->mValue) ;
        }
      }
      var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (2217)) ;
      var_cas_outSemanticContext.drop () ;
    }else if (cond_91409.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_91772 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_91772 = NULL ;
        while (((operand_91772 = enumerator_91772.nextObject ()))) {
          macroValidPointer (operand_91772) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_91772->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_91772->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (2224)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_92886 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_92886 (_variant_92886.isBuilt (), true) ;
      while (_condition_92886.isBuiltAndTrue ()) {
        _condition_92886 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_92886.isBuiltAndTrue ()) {
          if (_variant_92886.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2245)) ;
            _condition_92886 = GGS_bool (false) ;
          }else{
            _variant_92886.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_92501 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_92501 = NULL ;
              while (((operand_92501 = enumerator_92501.nextObject ()))) {
                macroValidPointer (operand_92501) ;
                const GGS_bool cond_92729 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_92501->mDependanceString) ;
                if (cond_92729.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_92501->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_92501->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_92729.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_92501->mDependanceString, operand_92501->mTypeString, operand_92501->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_93726 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_93726.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_93385 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_93385 = enumerator_93385.nextObject () ;
          if ((operand_93385 != NULL)) {
            bool _foreach_loop_93385 ;
            do{
              macroValidPointer (operand_93385) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_93385->mTypeString) ;
              operand_93385 = enumerator_93385.nextObject () ;
              _foreach_loop_93385 = ((operand_93385 != NULL)) ;
              if (_foreach_loop_93385) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_93385) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_93558 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_93558 = NULL ;
          while (((operand_93558 = enumerator_93558.nextObject ()))) {
            macroValidPointer (operand_93558) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_93558->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_93558->mDependanceString) ;
          }
        }
        var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (2264)) ;
        var_cas_outSemanticContext.drop () ;
      }else if (cond_93726.isBuiltAndFalse ()) {
        var_cas_outSemanticContext = GGS_semanticContext::constructor_new (var_cas_inSourceFile, GGS_unifiedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2268)), GGS_routineMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2269)), GGS_functionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2270)), GGS_filewrapperMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2271)), GGS_grammarMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2272)), GGS_optionComponentMapForSemanticAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2273))) ;
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_94164 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_94164 = NULL ;
          while (((operand_94164 = enumerator_94164.nextObject ()))) {
            macroValidPointer (operand_94164) ;
            { typeCategoryMethod__semanticDeclarationAST__enterInSemanticContext method = findCategoryMethod__semanticDeclarationAST__enterInSemanticContext (operand_94164->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_94164->mSemanticDeclaration (HERE), var_cas_categoryMethodMapForBuildingContext, var_cas_categoryReaderMapForBuildingContext, var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (2277)) ;
              }
            }
          }
        }
