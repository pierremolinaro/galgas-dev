...
//                    september 23th, 2010, at 18h30'9"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__genericTypeTypeAST__enterType (C_Compiler & inLexique,
                                const cPtr_genericTypeTypeAST * operand_19298,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19298 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
    const GGS_bool cond_19618 = (operand_19298->mSuperTypeName).operator_isEqual (GGS_string ("")) ;
    if (cond_19618.isBuiltAndTrue ()) {
      var_cas_superTypeProxy = GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (461)) ;
    }else if (cond_19618.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_19298->mSuperTypeName, var_cas_superTypeProxy COMMA_SOURCE_FILE_AT_LINE (463)) ;
    }
...
category_method__objectPredefinedTypeAST__enterType (C_Compiler & inLexique,
                                const cPtr_objectPredefinedTypeAST * operand_20860,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20860 != NULL) {
...
category_method__mapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_22171,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22171 != NULL) {
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_22171->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (556)), var_cas_currentMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (556)) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_22171->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (564)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (564)) ;
    ::routine_enterConstructorWithArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("mapWithMapToOverride"),  operand_22171->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (565)),  operand_22171->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (565)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (565)) ;
    ...
    ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("overriddenMap"),  operand_22171->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (571)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (571)) ;
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_24815 (operand_22171->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_24815 = NULL ;
      while (((operand_24815 = enumerator_24815.nextObject ()))) {
        macroValidPointer (operand_24815) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_24815->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (583)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (583)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_24815->mAttributeName) ;
        var_cas_enumerationDescriptor.addAssign_operation (var_cas_attributeTypeIndex, operand_24815->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (585))) ;
    ...
    {
      GGS_insertMethodListAST::cEnumerator enumerator_25419 (operand_22171->mInsertMethodList, true) ;
      const GGS_insertMethodListAST::cElement * operand_25419 = NULL ;
      while (((operand_25419 = enumerator_25419.nextObject ()))) {
        macroValidPointer (operand_25419) ;
        const GGS_bool cond_25574 = var_cas_modifierMap.reader_hasKey (operand_25419->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (591))) ;
        if (cond_25574.isBuiltAndTrue ()) {
          operand_25419->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_25419->mMethodName)).operator_concat (GGS_string ("' insert method is already declared")) COMMA_SOURCE_FILE_AT_LINE (593)) ;
        }else if (cond_25574.isBuiltAndFalse ()) {
          var_cas_modifierMap.modifier_insertOrReplace (inLexique, operand_25419->mMethodName, var_cas_insertMethodFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (598)) COMMA_SOURCE_FILE_AT_LINE (594)) ;
        }
      }
    }
    {
      GGS_mapRemoveMethodListAST::cEnumerator enumerator_25818 (operand_22171->mRemoveMethodList, true) ;
      const GGS_mapRemoveMethodListAST::cElement * operand_25818 = NULL ;
      while (((operand_25818 = enumerator_25818.nextObject ()))) {
        macroValidPointer (operand_25818) ;
        const GGS_bool cond_26009 = var_cas_modifierMap.reader_hasKey (operand_25818->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (604))) ;
        if (cond_26009.isBuiltAndTrue ()) {
          operand_25818->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_25818->mMethodName)).operator_concat (GGS_string ("' method is already declared as an insert modifier or a remove modifier")) COMMA_SOURCE_FILE_AT_LINE (606)) ;
        }else if (cond_26009.isBuiltAndFalse ()) {
          var_cas_modifierMap.modifier_insertOrReplace (inLexique, operand_25818->mMethodName, var_cas_removeMethodFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (611)) COMMA_SOURCE_FILE_AT_LINE (607)) ;
        }
      }
    }
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_26251 (operand_22171->mSearchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_26251 = NULL ;
      while (((operand_26251 = enumerator_26251.nextObject ()))) {
        macroValidPointer (operand_26251) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_26251->mMethodName, GGS_bool (false), var_cas_removeMethodFormalArgumentList, operand_26251->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (621)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (623)) COMMA_SOURCE_FILE_AT_LINE (617)) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_26541 (operand_22171->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_26541 = NULL ;
      while (((operand_26541 = enumerator_26541.nextObject ()))) {
        macroValidPointer (operand_26541) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, (operand_26541->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (628))).operator_concat (GGS_string ("ForKey")), operand_26541->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (628)) COMMA_SOURCE_FILE_AT_LINE (628)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_26541->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (630)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (630)) ;
    ...
    const GGS_bool cond_27484 = (operand_22171->mInsertOrReplaceDeclarationListAST.reader_length ()).operator_supOrEqual (GGS_uint (1U)) ;
    if (cond_27484.isBuiltAndTrue ()) {
      GGS_location  var_cas_insertOrReplaceLocation ;
      if (operand_22171->mInsertOrReplaceDeclarationListAST.isBuilt ()) {
        operand_22171->mInsertOrReplaceDeclarationListAST (HERE)->method_first (inLexique, var_cas_insertOrReplaceLocation COMMA_SOURCE_FILE_AT_LINE (643)) ;
      }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_27569 (operand_22171->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_27569 = NULL ;
      while (((operand_27569 = enumerator_27569.nextObject ()))) {
        macroValidPointer (operand_27569) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_27569->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")), operand_27569->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (653)) COMMA_SOURCE_FILE_AT_LINE (653)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_27569->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (655)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (655)) ;
    ...
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_28512 (operand_22171->mSearchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_28512 = NULL ;
      while (((operand_28512 = enumerator_28512.nextObject ()))) {
        macroValidPointer (operand_28512) ;
        var_cas_withAccessorMap.modifier_insertKey (inLexique, operand_28512->mMethodName, var_cas_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (670)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
...
category_method__mapProxyDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_29632,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_29632 != NULL) {
    ...
    GGS_bool automatic_var_30141_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_30141_1 ;
    GGS_typedAttributeList  automatic_var_30141_2 ;
    GGS_attributeMap  automatic_var_30141_3 ;
    GGS_constructorMap  automatic_var_30141_4 ;
    GGS_readerMap  automatic_var_30141_5 ;
    GGS_modifierMap  automatic_var_30141_6 ;
    GGS_instanceMethodMap  automatic_var_30141_7 ;
    GGS_classMethodMap  automatic_var_30141_8 ;
    GGS_enumerationDescriptorList  automatic_var_30141_9 ;
    GGS_uint  automatic_var_30141_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_30141_11 ;
    GGS_nativeAttributeList  automatic_var_30141_12 ;
    GGS_stringset  automatic_var_30141_13 ;
    GGS_lstringlist  automatic_var_30141_14 ;
    GGS_typedAttributeList  automatic_var_30141_15 ;
    GGS_mapSearchMethodListAST  automatic_var_30141_16 ;
    GGS_withAccessorMap  automatic_var_30141_17 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_29632->mAssociatedMapTypeName, automatic_var_30141_0, automatic_var_30141_1, var_cas_typeKindEnum, automatic_var_30141_2, automatic_var_30141_3, var_cas_mapTypedAttributeList, automatic_var_30141_4, automatic_var_30141_5, automatic_var_30141_6, automatic_var_30141_7, automatic_var_30141_8, automatic_var_30141_9, automatic_var_30141_10, automatic_var_30141_11, automatic_var_30141_12, automatic_var_30141_13, automatic_var_30141_14, automatic_var_30141_15, var_cas_searchMethodList, automatic_var_30141_16, automatic_var_30141_17 COMMA_SOURCE_FILE_AT_LINE (715)) ;
    }
    const GGS_bool cond_30358 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_mapType (inLexique COMMA_SOURCE_FILE_AT_LINE (725))) ;
    if (cond_30358.isBuiltAndTrue ()) {
      operand_29632->mAssociatedMapTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_29632->mAssociatedMapTypeName)).operator_concat (GGS_string (" should be a map type")) COMMA_SOURCE_FILE_AT_LINE (727)) ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_29632->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (737)), var_cas_associatedMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (737)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_29632->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (746)), var_cas_mapProxyTypeProxy COMMA_SOURCE_FILE_AT_LINE (746)) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("null"),  operand_29632->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (758)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (758)) ;
    ...
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_32158 (var_cas_searchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_32158 = NULL ;
      while (((operand_32158 = enumerator_32158.nextObject ()))) {
        macroValidPointer (operand_32158) ;
        var_cas_constructorMap.modifier_insertKey (inLexique, operand_32158->mMethodName, var_cas_constructorAttributeTypeList, GGS_bool (true), var_cas_mapProxyTypeProxy COMMA_SOURCE_FILE_AT_LINE (764)) ;
      }
    }
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_33124 (var_cas_mapTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_33124 = NULL ;
      while (((operand_33124 = enumerator_33124.nextObject ()))) {
        macroValidPointer (operand_33124) ;
        const GGS_bool cond_33531 = var_cas_inheritedReaderMap.reader_hasKey (operand_33124->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (781))) ;
        if (cond_33531.isBuiltAndTrue ()) {
          GGS_string var_cas_s = GGS_string ("") ;
          {
            GGS_stringset::cEnumerator enumerator_33232 (var_cas_inheritedReaderMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (783)), true) ;
            if (enumerator_33232 .hasCurrentObject ()) {
              bool _foreach_loop_33232 ;
              do{
                var_cas_s.appendCString ("'") ;
                var_cas_s.dotAssign_operation (enumerator_33232._key (HERE)) ;
                var_cas_s.appendCString ("'") ;
                enumerator_33232.next () ;
                _foreach_loop_33232 = (enumerator_33232 .hasCurrentObject ()) ;
                if (_foreach_loop_33232) {
                  var_cas_s.appendCString (", ") ;
                }
              }while (_foreach_loop_33232) ;
            }
          }
          operand_33124->mAttributeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the map has a associated map proxy, which has predefined readers: ")).operator_concat (var_cas_s)).operator_concat (GGS_string ("; you cannot use theses names for naming an attribute of this map")) COMMA_SOURCE_FILE_AT_LINE (789)) ;
        }else if (cond_33531.isBuiltAndFalse ()) {
          var_cas_readerMap.modifier_insertKey (inLexique, operand_33124->mAttributeName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (true), operand_33124->mAttributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (796)) COMMA_SOURCE_FILE_AT_LINE (790)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
...
category_method__enumDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_34835,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_34835 != NULL) {
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_34835->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (844)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (844)) ;
    GGS_stringset  var_cas_constantSet = GGS_stringset ::constructor_emptySet () ;
    {
      GGS_lstringlist::cEnumerator enumerator_35494 (operand_34835->mConstantList, true) ;
      const GGS_lstringlist::cElement * operand_35494 = NULL ;
      while (((operand_35494 = enumerator_35494.nextObject ()))) {
        macroValidPointer (operand_35494) ;
        var_cas_constantSet.addAssign_operation (operand_35494->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (848))) ;
        ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  operand_35494->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (849)),  operand_34835->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (849)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (849)) ;
      }
    }
    {
      GGS_enumMessageListAST::cEnumerator enumerator_35724 (operand_34835->mEnumMessageList, true) ;
      const GGS_enumMessageListAST::cElement * operand_35724 = NULL ;
      while (((operand_35724 = enumerator_35724.nextObject ()))) {
        macroValidPointer (operand_35724) ;
        ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_35724->mEnumMessageName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (853)),  GGS_string ("string"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (853)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
...
category_method__filewrapperDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationAST * operand_36931,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_36931 != NULL) {
    ...
    {
      GGS_filewrapperTemplateListAST::cEnumerator enumerator_37203 (operand_36931->mFilewrapperTemplateList, true) ;
      const GGS_filewrapperTemplateListAST::cElement * operand_37203 = NULL ;
      while (((operand_37203 = enumerator_37203.nextObject ()))) {
        ...
        {
          GGS_formalInputParameterListAST::cEnumerator enumerator_37321 (operand_37203->mFilewrapperTemplateFormalInputParameters, true) ;
          const GGS_formalInputParameterListAST::cElement * operand_37321 = NULL ;
          while (((operand_37321 = enumerator_37321.nextObject ()))) {
            macroValidPointer (operand_37321) ;
            GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_37321->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (897)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (897)) ;
            var_cas_templateSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
          }
        }
        var_cas_filewrapperTemplateMap.modifier_insertKey (inLexique, operand_37203->mFilewrapperTemplateName, var_cas_templateSignature, operand_37203->mFilewrapperTemplatePath COMMA_SOURCE_FILE_AT_LINE (900)) ;
      }
    }
    var_cas_ioSemanticContext.mFilewrapperMap.modifier_insertKey (inLexique, operand_36931->mFilewrapperName, operand_36931->mFilewrapperPath, operand_36931->mFilewrapperExtensionList, var_cas_filewrapperTemplateMap COMMA_SOURCE_FILE_AT_LINE (906)) ;
  }
}
...
category_method__listDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_38022,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_38022 != NULL) {
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_38293 (operand_38022->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_38293 = NULL ;
      while (((operand_38293 = enumerator_38293.nextObject ()))) {
        macroValidPointer (operand_38293) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_38293->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (925)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (925)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_38293->mAttributeName) ;
      }
    }
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_38022->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (933)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (933)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_39210 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_39210 = NULL ;
      while (((operand_39210 = enumerator_39210.nextObject ()))) {
        macroValidPointer (operand_39210) ;
        var_cas_enumerationDescriptor.addAssign_operation (operand_39210->mAttributeTypeIndex, operand_39210->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (940))) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_39210->mAttributeTypeIndex) ;
        var_cas_modifierOutputFormalArgumentList.addAssign_operation (operand_39210->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (942))) ;
        var_cas_modifierInputFormalArgumentList.addAssign_operation (operand_39210->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (943))) ;
      }
    }
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyList"),  operand_38022->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (947)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (947)) ;
    ...
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListFromIndex"),  GGS_string ("uint"),  operand_38022->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (957)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (957)) ;
    ::routine_enterBaseReaderWith2Arguments (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListWithRange"),  GGS_string ("uint"),  GGS_string ("uint"),  operand_38022->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (958)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (958)) ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_40380 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_40380 = NULL ;
      while (((operand_40380 = enumerator_40380.nextObject ()))) {
        macroValidPointer (operand_40380) ;
        var_cas_readerMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, (operand_40380->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (961))).operator_concat (GGS_string ("AtIndex")), operand_40380->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (961)) COMMA_SOURCE_FILE_AT_LINE (961)), GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_listWithValue (var_cas_uintType), GGS_bool (true), operand_40380->mAttributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (966)) COMMA_SOURCE_FILE_AT_LINE (960)) ;
      }
    }
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_41248 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_41248 = NULL ;
      while (((operand_41248 = enumerator_41248.nextObject ()))) {
        macroValidPointer (operand_41248) ;
        GGS_formalParameterSignature  var_cas_setterFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        var_cas_setterFormalArgumentList.addAssign_operation (operand_41248->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (991))) ;
        ...
        var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_41248->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("AtIndex")), operand_41248->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (994)) COMMA_SOURCE_FILE_AT_LINE (994)), var_cas_setterFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (997)) COMMA_SOURCE_FILE_AT_LINE (993)) ;
      }
    }
...
category_method__sortedListDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_43338,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_43338 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    ...
    GGS_unifiedTypeMapProxy  var_cas_listTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_43338->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1058)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (1058)) ;
    GGS_enumerationDescriptorList  var_cas_enumerationDescriptor = GGS_enumerationDescriptorList ::constructor_emptyList () ;
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    GGS_formalParameterSignature  var_cas_modifierFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_44132 (operand_43338->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_44132 = NULL ;
      while (((operand_44132 = enumerator_44132.nextObject ()))) {
        macroValidPointer (operand_44132) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_44132->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1066)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1066)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_44132->mAttributeName) ;
        var_cas_enumerationDescriptor.addAssign_operation (var_cas_attributeTypeIndex, operand_44132->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1068))) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptySortedList"),  operand_43338->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1074)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1074)) ;
...
category_method__structDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_47103,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_47103 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_structTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_47103->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1155)), var_cas_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (1155)) ;
    ...
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_47728 (operand_47103->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_47728 = NULL ;
      while (((operand_47728 = enumerator_47728.nextObject ()))) {
        macroValidPointer (operand_47728) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_47728->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1163)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1163)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_47728->mAttributeName) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_47728->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1166)) ;
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_48318 (operand_47103->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_48318 = NULL ;
      while (((operand_48318 = enumerator_48318.nextObject ()))) {
        macroValidPointer (operand_48318) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_48318->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1178)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1178)) ;
        ::routine_enterBaseFinalReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_48318->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1182)),  operand_48318->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1183)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1179)) ;
      }
    }
...
category_method__classDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_49932,
                                const GGS_multiMethodMapForBuildingContext   var_cas_inMultiMethodMapForBuildingContext,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_49932 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    ...
    const GGS_bool cond_50906 = (operand_49932->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1239))).operator_isEqual (GGS_string ("")) ;
    if (cond_50906.isBuiltAndTrue ()) {
    ...
    }else if (cond_50906.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_49932->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1247)), var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (1247)) ;
      GGS_typeKindEnum var_cas_typeKindEnum ;
      GGS_readerMap  var_cas_inheritedReaderMap ;
      GGS_modifierMap  var_cas_inheritedModifierMap ;
      GGS_bool automatic_var_51400_0 ;
      GGS_unifiedTypeMapProxy  automatic_var_51400_1 ;
      GGS_typedAttributeList  automatic_var_51400_2 ;
      GGS_constructorMap  automatic_var_51400_3 ;
      GGS_classMethodMap  automatic_var_51400_4 ;
      GGS_enumerationDescriptorList  automatic_var_51400_5 ;
      GGS_uint  automatic_var_51400_6 ;
      GGS_unifiedTypeMapProxyList  automatic_var_51400_7 ;
      GGS_nativeAttributeList  automatic_var_51400_8 ;
      GGS_stringset  automatic_var_51400_9 ;
      GGS_lstringlist  automatic_var_51400_10 ;
      GGS_typedAttributeList  automatic_var_51400_11 ;
      GGS_mapSearchMethodListAST  automatic_var_51400_12 ;
      GGS_mapSearchMethodListAST  automatic_var_51400_13 ;
      GGS_withAccessorMap  automatic_var_51400_14 ;
      if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
        var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_49932->mSuperClassName, automatic_var_51400_0, automatic_var_51400_1, var_cas_typeKindEnum, var_cas_inheritedTypedAttributeList, var_cas_attributeMap, automatic_var_51400_2, automatic_var_51400_3, var_cas_inheritedReaderMap, var_cas_inheritedModifierMap, var_cas_inheritedInstanceMethodMap, automatic_var_51400_4, automatic_var_51400_5, automatic_var_51400_6, automatic_var_51400_7, automatic_var_51400_8, automatic_var_51400_9, automatic_var_51400_10, automatic_var_51400_11, automatic_var_51400_12, automatic_var_51400_13, automatic_var_51400_14 COMMA_SOURCE_FILE_AT_LINE (1251)) ;
      }
      const GGS_bool cond_51557 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1264))) ;
      if (cond_51557.isBuiltAndTrue ()) {
        operand_49932->mSuperClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_49932->mSuperClassName)).operator_concat (GGS_string (" should be a class type")) COMMA_SOURCE_FILE_AT_LINE (1266)) ;
      }
      ...
      {
        GGS_readerMap::cEnumerator enumerator_51967 (var_cas_inheritedReaderMap, true) ;
        const GGS_readerMap::cElement * operand_51967 = NULL ;
        while (((operand_51967 = enumerator_51967.nextObject ()))) {
          macroValidPointer (operand_51967) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_51967->mKey, operand_51967->mInfo.mIsCategory, operand_51967->mInfo.mArgumentTypeList, operand_51967->mInfo.mHasCompilerArgument, operand_51967->mInfo.mReturnedType, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1286)) COMMA_SOURCE_FILE_AT_LINE (1280)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_52357 (var_cas_inheritedTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_52357 = NULL ;
      while (((operand_52357 = enumerator_52357.nextObject ()))) {
        macroValidPointer (operand_52357) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_52357->mAttributeTypeIndex) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_52460 (operand_49932->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_52460 = NULL ;
      while (((operand_52460 = enumerator_52460.nextObject ()))) {
        macroValidPointer (operand_52460) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_52460->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1297)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1297)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_52460->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1299)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_classIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_49932->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1303)), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1303)) ;
    ...
    const GGS_bool cond_53186 = (operand_49932->mIsAbstract).operator_not () ;
    if (cond_53186.isBuiltAndTrue ()) {
    ...
    {
      GGS_instanceMethodMap::cEnumerator enumerator_53317 (var_cas_inheritedInstanceMethodMap, true) ;
      const GGS_instanceMethodMap::cElement * operand_53317 = NULL ;
      while (((operand_53317 = enumerator_53317.nextObject ()))) {
        macroValidPointer (operand_53317) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_53317->mKey, GGS_bool (false), operand_53317->mInfo.mParameterList, operand_53317->mInfo.mDeclarationLocation, operand_53317->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1323)) COMMA_SOURCE_FILE_AT_LINE (1317)) ;
      }
    }
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_53613 (operand_49932->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_53613 = NULL ;
      while (((operand_53613 = enumerator_53613.nextObject ()))) {
        macroValidPointer (operand_53613) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_53702 (operand_53613->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_53702 = NULL ;
          while (((operand_53702 = enumerator_53702.nextObject ()))) {
            macroValidPointer (operand_53702) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_53702->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1331)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1331)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_53702->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_53983 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_53613->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1334))) ;
        if (NULL != operand_53983) {
          operand_53983->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1335)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_53613->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_53613->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1341)), GGS_bool (true), GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1343)) COMMA_SOURCE_FILE_AT_LINE (1337)) ;
        }
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_54400 (operand_49932->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_54400 = NULL ;
      while (((operand_54400 = enumerator_54400.nextObject ()))) {
        macroValidPointer (operand_54400) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_54489 (operand_54400->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_54489 = NULL ;
          while (((operand_54489 = enumerator_54489.nextObject ()))) {
            macroValidPointer (operand_54489) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54489->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1352)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1352)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_54489->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_54770 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_54400->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1355))) ;
        if (NULL != operand_54770) {
          operand_54770->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverriding (inLexique COMMA_SOURCE_FILE_AT_LINE (1356)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_54400->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_54400->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1362)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1364)) COMMA_SOURCE_FILE_AT_LINE (1358)) ;
        }
      }
    }
    const GGS_bool cond_55986 = var_cas_inMultiMethodMapForBuildingContext.reader_hasKey (operand_49932->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1369))) ;
    if (cond_55986.isBuiltAndTrue ()) {
      GGS_multiMethodMapForType  var_cas_multiMethodMapForType ;
      if (var_cas_inMultiMethodMapForBuildingContext.isBuilt ()) {
        var_cas_inMultiMethodMapForBuildingContext (HERE)->method_searchKey (inLexique, operand_49932->mClassTypeName, var_cas_multiMethodMapForType COMMA_SOURCE_FILE_AT_LINE (1371)) ;
      }
      {
        GGS_multiMethodMapForType::cEnumerator enumerator_55405 (var_cas_multiMethodMapForType, true) ;
        const GGS_multiMethodMapForType::cElement * operand_55405 = NULL ;
        while (((operand_55405 = enumerator_55405.nextObject ()))) {
          macroValidPointer (operand_55405) ;
          GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
          {
            GGS_formalParameterListAST::cEnumerator enumerator_55508 (operand_55405->mInfo.mFormalParameterList, true) ;
            const GGS_formalParameterListAST::cElement * operand_55508 = NULL ;
            while (((operand_55508 = enumerator_55508.nextObject ()))) {
              macroValidPointer (operand_55508) ;
              GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
              GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_55508->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1376)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1376)) ;
              var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_55508->mFormalArgumentPassingMode) ;
            }
          }
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_55405->mKey, GGS_bool (true), var_cas_formalArgumentList, operand_55405->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1383)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1385)) COMMA_SOURCE_FILE_AT_LINE (1379)) ;
        }
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_56186 (operand_49932->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_56186 = NULL ;
      while (((operand_56186 = enumerator_56186.nextObject ()))) {
        macroValidPointer (operand_56186) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56186->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1394)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1394)) ;
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_56186->mAttributeName) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_56186->mAttributeName) ;
        var_cas_readerMap.modifier_insertKey (inLexique, operand_56186->mAttributeName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1403)) COMMA_SOURCE_FILE_AT_LINE (1397)) ;
      }
    }
    const GGS_bool cond_57220 = (operand_49932->mIsAbstract).operator_not () ;
    if (cond_57220.isBuiltAndTrue ()) {
      {
        GGS_typedAttributeList::cEnumerator enumerator_56871 (var_cas_allTypedAttributeList, true) ;
        const GGS_typedAttributeList::cElement * operand_56871 = NULL ;
        while (((operand_56871 = enumerator_56871.nextObject ()))) {
          macroValidPointer (operand_56871) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_56871->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1410)), GGS_formalParameterSignature ::constructor_listWithValue (operand_56871->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1411))), GGS_bool (false), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1413)) COMMA_SOURCE_FILE_AT_LINE (1409)) ;
        }
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_49932->mClassTypeName, (operand_49932->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1422)), var_cas_allTypedAttributeList, var_cas_attributeMap, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1430)), GGS_enumerationDescriptorList ::constructor_emptyList (), ((function_generateCppConstructorWithAllAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1432))).operator_or (function_generateVirtualDestructor (inLexique COMMA_SOURCE_FILE_AT_LINE (1432)))).operator_or (((operand_49932->mIsAbstract).isBuiltAndTrue () ? (GGS_uint (0U)) : (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1432))))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_currentClassTypedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1440)) COMMA_SOURCE_FILE_AT_LINE (1418)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_58231,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58231 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_58497 (operand_58231->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_58497 = NULL ;
      while (((operand_58497 = enumerator_58497.nextObject ()))) {
        macroValidPointer (operand_58497) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_58497->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1454)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1454)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_58497->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_58231->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1458)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_59030,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59030 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_59297 (operand_59030->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_59297 = NULL ;
      while (((operand_59297 = enumerator_59297.nextObject ()))) {
        macroValidPointer (operand_59297) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_59297->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1471)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1471)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_59030->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1476)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1476)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_59030->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1478)) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_59997,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59997 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_59997->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1489)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1489)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_59997->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1491)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_60590,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60590 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_61055_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_61055_1 ;
    GGS_attributeMap  automatic_var_61055_2 ;
    GGS_typedAttributeList  automatic_var_61055_3 ;
    GGS_constructorMap  automatic_var_61055_4 ;
    GGS_readerMap  automatic_var_61055_5 ;
    GGS_modifierMap  automatic_var_61055_6 ;
    GGS_instanceMethodMap  automatic_var_61055_7 ;
    GGS_classMethodMap  automatic_var_61055_8 ;
    GGS_enumerationDescriptorList  automatic_var_61055_9 ;
    GGS_uint  automatic_var_61055_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_61055_11 ;
    GGS_nativeAttributeList  automatic_var_61055_12 ;
    GGS_stringset  automatic_var_61055_13 ;
    GGS_lstringlist  automatic_var_61055_14 ;
    GGS_typedAttributeList  automatic_var_61055_15 ;
    GGS_mapSearchMethodListAST  automatic_var_61055_16 ;
    GGS_mapSearchMethodListAST  automatic_var_61055_17 ;
    GGS_withAccessorMap  automatic_var_61055_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_60590->mAssociatedListTypeName, automatic_var_61055_0, automatic_var_61055_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_61055_2, automatic_var_61055_3, automatic_var_61055_4, automatic_var_61055_5, automatic_var_61055_6, automatic_var_61055_7, automatic_var_61055_8, automatic_var_61055_9, automatic_var_61055_10, automatic_var_61055_11, automatic_var_61055_12, automatic_var_61055_13, automatic_var_61055_14, automatic_var_61055_15, automatic_var_61055_16, automatic_var_61055_17, automatic_var_61055_18 COMMA_SOURCE_FILE_AT_LINE (1504)) ;
    }
    const GGS_bool cond_61284 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1511))) ;
    if (cond_61284.isBuiltAndTrue ()) {
      operand_60590->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_60590->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1513)) ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_60590->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1522)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1522)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_60590->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1525)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1525)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    ...
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("listForKey"),  GGS_string ("string"),  operand_60590->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1533)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1533)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_60590->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1535)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1535)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_63071 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_63071 = NULL ;
      while (((operand_63071 = enumerator_63071.nextObject ()))) {
        macroValidPointer (operand_63071) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_63071->mAttributeTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_65084,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_65084 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_65084 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation ((findCategoryReader__predefinedTypeAST__getSuperTypeName (var_cas_t (HERE)->galgasRTTI ()) (inLexique, var_cas_t.getPtr () COMMA_SOURCE_FILE_AT_LINE (1602))), operand_65084->mPredefinedTypeName, operand_65084) ;
  }
}
...
category_method__objectPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_objectPredefinedTypeAST * operand_65467,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_65467 != NULL) {
    GGS_objectPredefinedTypeAST  var_cas_t = operand_65467 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string ("object"), operand_65467) ;
  }
}
...
category_method__stringsetPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_stringsetPredefinedTypeAST * operand_65830,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_65830 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enumerable"), operand_65830->mPredefinedTypeName, operand_65830) ;
  }
}
...
category_method__genericTypeTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_genericTypeTypeAST * operand_66149,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_66149 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_66149->mSuperTypeName, operand_66149->mTypeName, operand_66149) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_66461,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_66461 != NULL) {
    const GGS_string var_cas_actualSuperTypeName = (((operand_66461->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1635))).operator_isEqual (GGS_string (""))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_66461->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1635)))) ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (var_cas_actualSuperTypeName, operand_66461->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1636)), operand_66461) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_66913,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_66913 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("list"), operand_66913->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1644)), operand_66913) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_67231,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_67231 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("struct"), operand_67231->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1652)), operand_67231) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_67551,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_67551 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enum"), operand_67551->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)), operand_67551) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_67873,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_67873 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("sortedlist"), operand_67873->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1668)), operand_67873) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_68204,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_68204 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_68204->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1676)), operand_68204->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1676)), operand_68204) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_68548,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_68548 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("map"), operand_68548->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1684)), operand_68548) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_68866,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_68866 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_68866->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1692)), operand_68866->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1692)), operand_68866) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externFunctionDeclarationAST * operand_69221,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_69221 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_69221) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externRoutineDeclarationAST * operand_69522,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_69522 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_69522) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_70458 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_70458 = NULL ;
    while (((operand_70458 = enumerator_70458.nextObject ()))) {
      macroValidPointer (operand_70458) ;
      { typeCategoryMethod__semanticDeclarationAST__collectTypes method = findCategoryMethod__semanticDeclarationAST__collectTypes (operand_70458->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_70458->mSemanticDeclaration (HERE), var_cas_collectedTypeMap, var_cas_multiMethodMapForBuildingContext COMMA_SOURCE_FILE_AT_LINE (1726)) ;
        }
      }
    }
  }
  ...
  const GGS_bool cond_70970 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_70970.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_70833 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_70833 = NULL ;
      while (((operand_70833 = enumerator_70833.nextObject ()))) {
        macroValidPointer (operand_70833) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_70833->mValue) ;
      }
    }
  ...
  }else if (cond_70970.isBuiltAndFalse ()) {
    const GGS_bool cond_71272 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_71272.isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_71136 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_71136 = NULL ;
        while (((operand_71136 = enumerator_71136.nextObject ()))) {
          macroValidPointer (operand_71136) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_71136->mValue) ;
        }
      }
      ...
      var_cas_outSemanticContext.drop () ;
    }else if (cond_71272.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_71635 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_71635 = NULL ;
        while (((operand_71635 = enumerator_71635.nextObject ()))) {
          macroValidPointer (operand_71635) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_71635->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_71635->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (1752)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_72749 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_72749 (_variant_72749.isBuilt (), true) ;
      while (_condition_72749.isBuiltAndTrue ()) {
        _condition_72749 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_72749.isBuiltAndTrue ()) {
          if (_variant_72749.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1773)) ;
            _condition_72749 = GGS_bool (false) ;
          }else{
            _variant_72749.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_72364 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_72364 = NULL ;
              while (((operand_72364 = enumerator_72364.nextObject ()))) {
                macroValidPointer (operand_72364) ;
                const GGS_bool cond_72592 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_72364->mDependanceString) ;
                if (cond_72592.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_72364->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_72364->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_72592.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_72364->mDependanceString, operand_72364->mTypeString, operand_72364->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_73372 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_73372.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_73031 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_73031 = enumerator_73031.nextObject () ;
          if ((operand_73031 != NULL)) {
            bool _foreach_loop_73031 ;
            do{
              macroValidPointer (operand_73031) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_73031->mTypeString) ;
              operand_73031 = enumerator_73031.nextObject () ;
              _foreach_loop_73031 = ((operand_73031 != NULL)) ;
              if (_foreach_loop_73031) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_73031) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_73204 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_73204 = NULL ;
          while (((operand_73204 = enumerator_73204.nextObject ()))) {
            macroValidPointer (operand_73204) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_73204->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_73204->mDependanceString) ;
          }
        }
        ...
        var_cas_outSemanticContext.drop () ;
      }else if (cond_73372.isBuiltAndFalse ()) {
        ...
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_73788 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_73788 = NULL ;
          while (((operand_73788 = enumerator_73788.nextObject ()))) {
            macroValidPointer (operand_73788) ;
            { typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (operand_73788->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_73788->mSemanticDeclaration (HERE), var_cas_multiMethodMapForBuildingContext, var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (1798)) ;
              }
            }
          }
        }
