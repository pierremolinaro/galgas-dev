...
//                    november 23th, 2010, at 12h16'18"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_52670 (var_files, true) ;
  //--- simple foreach instruction
  while (enumerator_52670.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    if (constinArgument_inExtensionMap.reader_hasKey (enumerator_52670.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1270)) COMMA_SOURCE_FILE_AT_LINE (1270)).isValidAndTrue ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1271)).operator_concat (enumerator_52670.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1271)) ;
      { //-------- @modifierCallInstructionForGeneration
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_52670.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1273)), var_absoluteFilePath, var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1272)) ;
    ...
    enumerator_52670.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_53227 (var_directories, true) ;
  //--- simple foreach instruction
  while (enumerator_53227.hasCurrentObject ()) {
    ...
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1289)).operator_concat (enumerator_53227.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1289)), constinArgument_inPathInWrapper.operator_concat (enumerator_53227.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1290)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1290)), constinArgument_inExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1288)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_53227.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1298)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1297)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_53227.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticDeclarationListAST enumerator_103637 (constinArgument_inSemanticDeclarationList, true) ;
  //--- simple foreach instruction
  while (enumerator_103637.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_103637.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (2476)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_103637.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (2482)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_103972 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (2483)), true) ;
    //--- simple foreach instruction
    while (enumerator_103972.hasCurrentObject ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_0 (enumerator_103972.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (enumerator_103972.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2484)) COMMA_SOURCE_FILE_AT_LINE (2484)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (2484)) COMMA_SOURCE_FILE_AT_LINE (2484)) ;
      enumerator_103972.gotoNextObject () ;
    }
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("semantic analysis not performed, due to undefined type error(s)") COMMA_SOURCE_FILE_AT_LINE (2486)) ;
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_lstringlist joker_104455_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_104455_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2491)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    if (GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (2502)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("semantic analysis not performed, ").operator_concat (var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (2503)).reader_string (SOURCE_FILE_AT_LINE (2503)) COMMA_SOURCE_FILE_AT_LINE (2503)).operator_concat (GALGAS_string (" declarations are involved in circular definition:") COMMA_SOURCE_FILE_AT_LINE (2503)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_104999 (var_unsortedSemanticDeclarationListAST, true) ;
      //--- simple foreach instruction
      while (enumerator_104999.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_104999.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2505)) COMMA_SOURCE_FILE_AT_LINE (2505)) COMMA_SOURCE_FILE_AT_LINE (2505)) ;
        enumerator_104999.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (2507)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
    }else{
      //-------- @assignmentInstructionForGeneration
      outArgument_outSemanticContext = GALGAS_semanticContext::constructor_new (constinArgument_inSourceFile, GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2513)), GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2514)), GALGAS_functionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2515)), GALGAS_filewrapperMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2516)), GALGAS_grammarMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2517)), GALGAS_optionComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (2518)) COMMA_SOURCE_FILE_AT_LINE (2511)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_105598 (var_sortedSemanticDeclarationListAST, true) ;
      //--- simple foreach instruction
      while (enumerator_105598.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_105598.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (2522)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_105598.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_33412 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_33412.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_33412.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (775)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (775)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_33412.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (778)) ;
    //-------- @addAssignInstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_33412.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (779)) COMMA_SOURCE_FILE_AT_LINE (779)) ;
    //-------- @addAssignInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_insertMethodListAST enumerator_34098 (object->mAttribute_mInsertMethodList, true) ;
  //--- simple foreach instruction
  while (enumerator_34098.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    if (var_modifierMap.reader_hasKey (enumerator_34098.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (785)) COMMA_SOURCE_FILE_AT_LINE (785)).isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_0 (enumerator_34098.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_0, GALGAS_string ("the '").operator_concat (enumerator_34098.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (786)) COMMA_SOURCE_FILE_AT_LINE (786)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (786)) COMMA_SOURCE_FILE_AT_LINE (786)) ;
    }else{
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertOrReplace (enumerator_34098.current_mInsertMethodName (HERE), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (792)), GALGAS_string ("") COMMA_SOURCE_FILE_AT_LINE (788)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_34098.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, object->mAttribute_mMapStateList.reader_length (SOURCE_FILE_AT_LINE (798)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_mapSearchMethodListAST enumerator_34633 (object->mAttribute_mSearchMethodList, true) ;
    //--- simple foreach instruction
    while (enumerator_34633.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_instanceMethodMap.modifier_insertKey (enumerator_34633.current_mSearchMethodName (HERE), GALGAS_bool (false), var_removeMethodFormalArgumentList, enumerator_34633.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (804)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (806)), GALGAS_string (""), inCompiler COMMA_SOURCE_FILE_AT_LINE (800)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_34633.gotoNextObject () ;
    }
  }else{
    //-------- @foreachInstructionForGeneration
    cEnumerator_mapSearchMethodListAST enumerator_34959 (object->mAttribute_mSearchMethodList, true) ;
    //--- simple foreach instruction
    while (enumerator_34959.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (enumerator_34959.current_mSearchMethodName (HERE), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (816)), GALGAS_string (""), inCompiler COMMA_SOURCE_FILE_AT_LINE (812)) ;
      } //-------- END @typeMethodInstructionForGeneration
  ...
  if (GALGAS_bool (kIsStrictSup, object->mAttribute_mMapStateList.reader_length (SOURCE_FILE_AT_LINE (822)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_mapOverrideBlockListAST enumerator_36555 (object->mAttribute_mMapOverrideBlockListAST, true) ;
    //--- simple foreach instruction
    while (enumerator_36555.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_36555.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (857)) COMMA_SOURCE_FILE_AT_LINE (857)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (857)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (858)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (860)), GALGAS_string (""), inCompiler COMMA_SOURCE_FILE_AT_LINE (856)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_36555.gotoNextObject () ;
    }
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_36925 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_36925.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_36925.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (867)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (867)), enumerator_36925.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (867)) COMMA_SOURCE_FILE_AT_LINE (867)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_36925.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (869)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (869)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    ...
    enumerator_36925.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_37570 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_37570.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_37570.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (883)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (883)) COMMA_SOURCE_FILE_AT_LINE (883)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (883)), enumerator_37570.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (883)) COMMA_SOURCE_FILE_AT_LINE (883)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_37570.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (885)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (885)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_mapSearchMethodListAST enumerator_38551 (object->mAttribute_mSearchMethodList, true) ;
  //--- simple foreach instruction
  while (enumerator_38551.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_withAccessorMap.modifier_insertKey (enumerator_38551.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (901)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_38551.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_40013_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_40013_1 ; // Joker input parameter
  GALGAS_typedAttributeList joker_40039_2 ; // Joker input parameter
  GALGAS_attributeMap joker_40039_1 ; // Joker input parameter
  GALGAS_constructorMap joker_40075_10 ; // Joker input parameter
  GALGAS_readerMap joker_40075_9 ; // Joker input parameter
  GALGAS_modifierMap joker_40075_8 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_40075_7 ; // Joker input parameter
  GALGAS_classMethodMap joker_40075_6 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_40075_5 ; // Joker input parameter
  GALGAS_uint joker_40075_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_40075_3 ; // Joker input parameter
  GALGAS_stringset joker_40075_2 ; // Joker input parameter
  GALGAS_lstringlist joker_40075_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_40105_3 ; // Joker input parameter
  GALGAS_withAccessorMap joker_40105_2 ; // Joker input parameter
  GALGAS_bool joker_40105_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_40013_2, joker_40013_1, var_typeKindEnum, joker_40039_2, joker_40039_1, var_mapTypedAttributeList, joker_40075_10, joker_40075_9, joker_40075_8, joker_40075_7, joker_40075_6, joker_40075_5, joker_40075_4, joker_40075_3, joker_40075_2, joker_40075_1, var_searchMethodList, joker_40105_3, joker_40105_2, joker_40105_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (944)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_mapSearchMethodListAST enumerator_42144 (var_searchMethodList, true) ;
  //--- simple foreach instruction
  while (enumerator_42144.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_constructorMap.modifier_insertKey (enumerator_42144.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (993)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_42144.gotoNextObject () ;
  }
  { //-------- @routineCallInstructionForGeneration
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("isSolved"), GALGAS_string ("bool"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1001)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_43115 (var_mapTypedAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_43115.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    if (var_inheritedReaderMap.reader_hasKey (enumerator_43115.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1010)) COMMA_SOURCE_FILE_AT_LINE (1010)).isValidAndTrue ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_43258 (var_inheritedReaderMap.reader_allKeys (SOURCE_FILE_AT_LINE (1012)), true) ;
      //--- simple foreach instruction
      while (enumerator_43258.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_43258.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (1013)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1013)) COMMA_SOURCE_FILE_AT_LINE (1013)) ;
        if (enumerator_43258.hasNextObject ()) {
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (1014)) ;
        }
        enumerator_43258.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_43115.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_43115.current_mAttributeName (HERE), GALGAS_bool (false), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1022)), inCompiler->here (), GALGAS_bool (true), enumerator_43115.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1026)), GALGAS_string (""), inCompiler COMMA_SOURCE_FILE_AT_LINE (1019)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_unifiedTypeMapProxyList enumerator_47818 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE_AT_LINE (1134)), true) ;
  //--- simple foreach instruction
  while (enumerator_47818.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_formalParameterList.addAssign_operation (enumerator_47818.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1135)) COMMA_SOURCE_FILE_AT_LINE (1135)) ;
    enumerator_47818.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_graphInsertModifierList enumerator_47947 (object->mAttribute_mInsertModifierList, true) ;
  //--- simple foreach instruction
  while (enumerator_47947.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertOrReplace (enumerator_47947.current_mInsertModifierName (HERE), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1142)), GALGAS_string ("") COMMA_SOURCE_FILE_AT_LINE (1138)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @addAssignInstructionForGeneration
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1159)) COMMA_SOURCE_FILE_AT_LINE (1159)) ;
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_50619 (object->mAttribute_mConstantList, true) ;
  //--- simple foreach instruction
  while (enumerator_50619.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_constantSet.addAssign_operation (enumerator_50619.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1212)) COMMA_SOURCE_FILE_AT_LINE (1212)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_50619.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1213)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1213)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1213)) ;
    } //-------- @routineCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_enumMessageListAST enumerator_50947 (object->mAttribute_mEnumMessageList, true) ;
  //--- simple foreach instruction
  while (enumerator_50947.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_enterBaseReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_50947.current_mEnumMessageName (HERE).reader_string (SOURCE_FILE_AT_LINE (1219)), GALGAS_string ("string"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1219)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_50947.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_filewrapperTemplateListAST enumerator_54331 (object->mAttribute_mFilewrapperTemplateList, true) ;
  //--- simple foreach instruction
  while (enumerator_54331.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_formalTemplateInputParameterListAST enumerator_54449 (enumerator_54331.current_mFilewrapperTemplateFormalInputParameters (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_54449.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_54449.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1319)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1319)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_templateSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1320)) ;
      enumerator_54449.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_54331.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_54331.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1322)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_54331.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_wrapperExtensionMap var_extensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1329)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_54962 (object->mAttribute_mFilewrapperExtensionList, true) ;
  //--- simple foreach instruction
  while (enumerator_54962.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_extensionMap.modifier_insertKey (enumerator_54962.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1331)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_54962.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_56691 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_56691.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_56691.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1382)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1382)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_56691.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1385)) ;
    enumerator_56691.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_57690 (var_typedAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_57690.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (enumerator_57690.current_mAttributeTypeProxy (HERE), enumerator_57690.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1399)) COMMA_SOURCE_FILE_AT_LINE (1399)) ;
    //-------- @addAssignInstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (enumerator_57690.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (1400)) ;
    //-------- @addAssignInstructionForGeneration
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_57690.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1401)) COMMA_SOURCE_FILE_AT_LINE (1401)) ;
    //-------- @addAssignInstructionForGeneration
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_57690.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1402)) COMMA_SOURCE_FILE_AT_LINE (1402)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_58860 (var_typedAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_58860.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_58860.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1420)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1420)), enumerator_58860.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1420)) COMMA_SOURCE_FILE_AT_LINE (1420)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_uintType COMMA_SOURCE_FILE_AT_LINE (1422)), inCompiler->here (), GALGAS_bool (true), enumerator_58860.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1426)), GALGAS_string ("") COMMA_SOURCE_FILE_AT_LINE (1419)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_59812 (var_typedAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_59812.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @addAssignInstructionForGeneration
    var_setterFormalArgumentList.addAssign_operation (enumerator_59812.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1455)) COMMA_SOURCE_FILE_AT_LINE (1455)) ;
    //-------- @addAssignInstructionForGeneration
    ...
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_59812.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1458)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1458)) COMMA_SOURCE_FILE_AT_LINE (1458)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1458)), enumerator_59812.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1458)) COMMA_SOURCE_FILE_AT_LINE (1458)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1461)), GALGAS_string ("") COMMA_SOURCE_FILE_AT_LINE (1457)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_59812.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_62670 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_62670.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_62670.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1531)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1531)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_62670.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1534)) ;
    //-------- @addAssignInstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_62670.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1535)) COMMA_SOURCE_FILE_AT_LINE (1535)) ;
    //-------- @addAssignInstructionForGeneration
    ...
    enumerator_62670.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_66324 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_66324.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_66324.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1631)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1631)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    ...
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_66324.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1635)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_attributeMap.modifier_insertKey (enumerator_66324.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1636)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_66324.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_67062 (var_typedAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_67062.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_67062.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1653)), enumerator_67062.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1654)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1650)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_67062.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (GALGAS_bool (kIsEqual, object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (1707)).objectCompare (GALGAS_string (""))).isValidAndTrue ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_69469 (object->mAttribute_mClassFeatureList, true) ;
    //--- simple foreach instruction
    while (enumerator_69469.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsEqual, enumerator_69469.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1716)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).isValidAndTrue ()) {
        //-------- @assignmentInstructionForGeneration
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_69469.gotoNextObject () ;
    }
  }else{
    { //-------- @typeMethodInstructionForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_69918_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_69918_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_70003_2 ; // Joker input parameter
    GALGAS_constructorMap joker_70003_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_70101_9 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_70101_8 ; // Joker input parameter
    GALGAS_uint joker_70101_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_70101_6 ; // Joker input parameter
    GALGAS_stringset joker_70101_5 ; // Joker input parameter
    GALGAS_lstringlist joker_70101_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_70101_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_70101_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_70101_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_69918_2, joker_69918_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_70003_2, joker_70003_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedInstanceMethodMap, joker_70101_9, joker_70101_8, joker_70101_7, joker_70101_6, joker_70101_5, joker_70101_4, joker_70101_3, joker_70101_2, joker_70101_1, var_generateHeaderInSeparateFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (1725)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_modifierMap enumerator_70426 (var_inheritedModifierMap, true) ;
    //--- simple foreach instruction
    while (enumerator_70426.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (enumerator_70426.current_lkey (HERE), enumerator_70426.current_mParameterList (HERE), enumerator_70426.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1749)), GALGAS_string (""), inCompiler COMMA_SOURCE_FILE_AT_LINE (1745)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_70426.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1754)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_readerMap enumerator_70737 (var_inheritedReaderMap, true) ;
    //--- simple foreach instruction
    while (enumerator_70737.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_70737.current_lkey (HERE), enumerator_70737.current_mIsCategory (HERE), enumerator_70737.current_mArgumentTypeList (HERE), enumerator_70737.current_mDeclarationLocation (HERE), enumerator_70737.current_mHasCompilerArgument (HERE), enumerator_70737.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1763)), enumerator_70737.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1756)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_70737.gotoNextObject () ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_71180 (var_inheritedTypedAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_71180.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (enumerator_71180.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (1771)) ;
    enumerator_71180.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_71283 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_71283.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_71283.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1775)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1775)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1776)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_attributeMap.modifier_insertKey (enumerator_71283.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1777)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_71283.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_instanceMethodMap enumerator_72140 (var_inheritedInstanceMethodMap, true) ;
  //--- simple foreach instruction
  while (enumerator_72140.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_instanceMethodMap.modifier_insertKey (enumerator_72140.current_lkey (HERE), enumerator_72140.current_mIsCategory (HERE), enumerator_72140.current_mParameterList (HERE), enumerator_72140.current_mDeclarationLocation (HERE), enumerator_72140.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1801)), GALGAS_string (""), inCompiler COMMA_SOURCE_FILE_AT_LINE (1795)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_72140.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_abstractMethodDefinitionListAST enumerator_72451 (object->mAttribute_mAbstractMethodList, true) ;
  //--- simple foreach instruction
  while (enumerator_72451.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_formalParameterListAST enumerator_72540 (enumerator_72451.current_mSignature (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_72540.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_typeIndex ;
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_72540.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1810)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (1810)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_72540.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1811)) ;
      enumerator_72540.gotoNextObject () ;
    }
    ...
    cMapElement_instanceMethodMap * objectArray_72801 = (cMapElement_instanceMethodMap *) var_instanceMethodMap.readWriteAccessForWithInstruction_hasKey (inCompiler, enumerator_72451.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1813)) COMMA_SOURCE_FILE_AT_LINE (1813)) ;
    if (NULL != objectArray_72801) {
        macroValidSharedObject (objectArray_72801, cMapElement_instanceMethodMap) ;
      //-------- @assignmentInstructionForGeneration
      objectArray_72801->mAttribute_mQualifier = GALGAS_methodQualifier::constructor_isOverridingAbstract (SOURCE_FILE_AT_LINE (1814)) ;
    }else{
      { //-------- @modifierCallInstructionForGeneration
      var_instanceMethodMap.modifier_insertKey (enumerator_72451.current_mMethodName (HERE), GALGAS_bool (false), var_formalArgumentList, enumerator_72451.current_mMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (1820)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isAbstract (SOURCE_FILE_AT_LINE (1822)), GALGAS_string (""), inCompiler COMMA_SOURCE_FILE_AT_LINE (1816)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_72451.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_methodDefinitionListAST enumerator_73269 (object->mAttribute_mMethodList, true) ;
  //--- simple foreach instruction
  while (enumerator_73269.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_formalParameterListAST enumerator_73358 (enumerator_73269.current_mSignature (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_73358.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_typeIndex ;
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_73358.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1832)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (1832)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_73358.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1833)) ;
      enumerator_73358.gotoNextObject () ;
    }
    //-------- @readWriteWithInstructionForGeneration
    // index 1: attribute 'mIsCategory', type @bool
    // index 2: attribute 'mParameterList', type @formalParameterSignature
    ...
    // index 5: attribute 'mQualifier', type @methodQualifier
    // index 6: attribute 'mErrorMessage', type @string
    cMapElement_instanceMethodMap * objectArray_73619 = (cMapElement_instanceMethodMap *) var_instanceMethodMap.readWriteAccessForWithInstruction_hasKey (inCompiler, enumerator_73269.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1835)) COMMA_SOURCE_FILE_AT_LINE (1835)) ;
    if (NULL != objectArray_73619) {
        macroValidSharedObject (objectArray_73619, cMapElement_instanceMethodMap) ;
      //-------- @assignmentInstructionForGeneration
      objectArray_73619->mAttribute_mQualifier = GALGAS_methodQualifier::constructor_isOverriding (SOURCE_FILE_AT_LINE (1836)) ;
    }else{
      { //-------- @modifierCallInstructionForGeneration
      var_instanceMethodMap.modifier_insertKey (enumerator_73269.current_mMethodName (HERE), GALGAS_bool (false), var_formalArgumentList, enumerator_73269.current_mMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (1842)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1844)), GALGAS_string (""), inCompiler COMMA_SOURCE_FILE_AT_LINE (1838)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
  ...
  if (constinArgument_inCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (1850)) COMMA_SOURCE_FILE_AT_LINE (1850)).isValidAndTrue ()) {
    ...
    //-------- END @methodCallInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_categoryMethodMapForType enumerator_74327 (var_categoryMethodMapForType, true) ;
    //--- simple foreach instruction
    while (enumerator_74327.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_74430 (enumerator_74327.current_mFormalParameterList (HERE), true) ;
      //--- simple foreach instruction
      while (enumerator_74430.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        { //-------- @typeMethodInstructionForGeneration
        GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_74430.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1857)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (1857)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @addAssignInstructionForGeneration
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_74430.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1858)) ;
        enumerator_74430.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_instanceMethodMap.modifier_insertKey (enumerator_74327.current_lkey (HERE), GALGAS_bool (true), var_formalArgumentList, enumerator_74327.current_lkey (HERE).reader_location (SOURCE_FILE_AT_LINE (1864)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1866)), GALGAS_string (""), inCompiler COMMA_SOURCE_FILE_AT_LINE (1860)) ;
      } //-------- END @typeMethodInstructionForGeneration
  ...
  if (constinArgument_inCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (1872)) COMMA_SOURCE_FILE_AT_LINE (1872)).isValidAndTrue ()) {
    ...
    //-------- END @methodCallInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_categoryReaderMapForType enumerator_75262 (var_categoryReaderMapForType, true) ;
    //--- simple foreach instruction
    while (enumerator_75262.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalInputParameterListAST enumerator_75369 (enumerator_75262.current_mInputFormalParameterList (HERE), true) ;
      //--- simple foreach instruction
      while (enumerator_75369.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        { //-------- @typeMethodInstructionForGeneration
        GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_75369.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1879)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (1879)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @addAssignInstructionForGeneration
        var_formalArgumentList.addAssign_operation (var_typeIndex COMMA_SOURCE_FILE_AT_LINE (1880)) ;
        enumerator_75369.gotoNextObject () ;
      }
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_returnedType ;
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_75262.current_mResultTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1883)), var_returnedType COMMA_SOURCE_FILE_AT_LINE (1883)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_75262.current_lkey (HERE), GALGAS_bool (true), var_formalArgumentList, enumerator_75262.current_lkey (HERE).reader_location (SOURCE_FILE_AT_LINE (1888)), GALGAS_bool (true), var_returnedType, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1891)), GALGAS_string (""), inCompiler COMMA_SOURCE_FILE_AT_LINE (1884)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_75262.gotoNextObject () ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_76224 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_76224.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_76224.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1901)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1901)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_76484 (enumerator_76224.current_mFeatureList (HERE), true) ;
    //--- simple foreach instruction
    while (enumerator_76484.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsEqual, enumerator_76484.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1905)).objectCompare (GALGAS_string ("setter"))).isValidAndTrue ()) {
        //-------- @assignmentInstructionForGeneration
        var_hasSetter = GALGAS_bool (true) ;
      }else{
        //-------- @ifInstructionForGeneration
        if (GALGAS_bool (kIsEqual, enumerator_76484.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1907)).objectCompare (GALGAS_string ("nogetter"))).isValidAndTrue ()) {
          //-------- @assignmentInstructionForGeneration
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_76484.gotoNextObject () ;
    }
    //-------- @addAssignInstructionForGeneration
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_76224.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1911)) ;
    //-------- @addAssignInstructionForGeneration
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_76224.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1912)) ;
    //-------- @ifInstructionForGeneration
    if (var_hasGetter.isValidAndTrue ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_76224.current_mAttributeName (HERE), GALGAS_bool (false), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1917)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1921)), GALGAS_string (""), inCompiler COMMA_SOURCE_FILE_AT_LINE (1914)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_76224.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_77536 (var_currentClassTypedAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_77536.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    if (enumerator_77536.current_mHasSetter (HERE).isValidAndTrue ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_77536.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1936)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1936)) COMMA_SOURCE_FILE_AT_LINE (1936)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1936)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_77536.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1937)) COMMA_SOURCE_FILE_AT_LINE (1937)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1939)), GALGAS_string (""), inCompiler COMMA_SOURCE_FILE_AT_LINE (1935)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_77536.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListAST enumerator_79144 (object->mAttribute_mFormalArgumentList, true) ;
  //--- simple foreach instruction
  while (enumerator_79144.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_79144.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1981)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1981)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_79144.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1982)) ;
    enumerator_79144.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalInputParameterListAST enumerator_80049 (object->mAttribute_mFormalArgumentList, true) ;
  //--- simple foreach instruction
  while (enumerator_80049.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_80049.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1999)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1999)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_typeKindEnum var_typeKindEnum ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_81967_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_81967_1 ; // Joker input parameter
  GALGAS_attributeMap joker_82022_16 ; // Joker input parameter
  GALGAS_typedAttributeList joker_82022_15 ; // Joker input parameter
  GALGAS_constructorMap joker_82022_14 ; // Joker input parameter
  GALGAS_readerMap joker_82022_13 ; // Joker input parameter
  GALGAS_modifierMap joker_82022_12 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_82022_11 ; // Joker input parameter
  GALGAS_classMethodMap joker_82022_10 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_82022_9 ; // Joker input parameter
  GALGAS_uint joker_82022_8 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_82022_7 ; // Joker input parameter
  GALGAS_stringset joker_82022_6 ; // Joker input parameter
  GALGAS_lstringlist joker_82022_5 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_82022_4 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_82022_3 ; // Joker input parameter
  GALGAS_withAccessorMap joker_82022_2 ; // Joker input parameter
  GALGAS_bool joker_82022_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_81967_2, joker_81967_1, var_typeKindEnum, var_listTypedAttributeList, joker_82022_16, joker_82022_15, joker_82022_14, joker_82022_13, joker_82022_12, joker_82022_11, joker_82022_10, joker_82022_9, joker_82022_8, joker_82022_7, joker_82022_6, joker_82022_5, joker_82022_4, joker_82022_3, joker_82022_2, joker_82022_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2034)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_84046 (var_listTypedAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_84046.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_addAssignOperatorDescription.addAssign_operation (enumerator_84046.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2074)) ;
    enumerator_84046.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_87506 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_87506.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_87506.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2155)) COMMA_SOURCE_FILE_AT_LINE (2155)), enumerator_87506.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2155)) COMMA_SOURCE_FILE_AT_LINE (2155)) COMMA_SOURCE_FILE_AT_LINE (2155)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_87506.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_structDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (2166)) COMMA_SOURCE_FILE_AT_LINE (2166)), object->mAttribute_mStructTypeName.reader_location (SOURCE_FILE_AT_LINE (2166)) COMMA_SOURCE_FILE_AT_LINE (2166)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2167)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_88205 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_88205.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_88205.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2169)) COMMA_SOURCE_FILE_AT_LINE (2169)), enumerator_88205.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2169)) COMMA_SOURCE_FILE_AT_LINE (2169)) COMMA_SOURCE_FILE_AT_LINE (2169)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_88205.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (2180)) COMMA_SOURCE_FILE_AT_LINE (2180)), object->mAttribute_mEnumTypeName.reader_location (SOURCE_FILE_AT_LINE (2180)) COMMA_SOURCE_FILE_AT_LINE (2180)) ;
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_sortedListDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2191)) COMMA_SOURCE_FILE_AT_LINE (2191)), object->mAttribute_mSortedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2191)) COMMA_SOURCE_FILE_AT_LINE (2191)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2192)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_89446 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_89446.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_89446.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2194)) COMMA_SOURCE_FILE_AT_LINE (2194)), enumerator_89446.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2194)) COMMA_SOURCE_FILE_AT_LINE (2194)) COMMA_SOURCE_FILE_AT_LINE (2194)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_89446.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_listmapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2205)) COMMA_SOURCE_FILE_AT_LINE (2205)), object->mAttribute_mListmapTypeName.reader_location (SOURCE_FILE_AT_LINE (2205)) COMMA_SOURCE_FILE_AT_LINE (2205)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2206)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2207)) COMMA_SOURCE_FILE_AT_LINE (2207)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2207)) COMMA_SOURCE_FILE_AT_LINE (2207)) COMMA_SOURCE_FILE_AT_LINE (2207)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_mapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2217)) COMMA_SOURCE_FILE_AT_LINE (2217)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2217)) COMMA_SOURCE_FILE_AT_LINE (2217)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2218)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_90805 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_90805.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_90805.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2220)) COMMA_SOURCE_FILE_AT_LINE (2220)), enumerator_90805.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2220)) COMMA_SOURCE_FILE_AT_LINE (2220)) COMMA_SOURCE_FILE_AT_LINE (2220)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_90805.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_uniqueMapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2231)) COMMA_SOURCE_FILE_AT_LINE (2231)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2231)) COMMA_SOURCE_FILE_AT_LINE (2231)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2232)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_91501 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_91501.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_91501.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2234)) COMMA_SOURCE_FILE_AT_LINE (2234)), enumerator_91501.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2234)) COMMA_SOURCE_FILE_AT_LINE (2234)) COMMA_SOURCE_FILE_AT_LINE (2234)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_91501.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapProxyDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_mapProxyDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE_AT_LINE (2245)) COMMA_SOURCE_FILE_AT_LINE (2245)), object->mAttribute_mMapProxyTypeName.reader_location (SOURCE_FILE_AT_LINE (2245)) COMMA_SOURCE_FILE_AT_LINE (2245)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2246)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2247)) COMMA_SOURCE_FILE_AT_LINE (2247)), object->mAttribute_mAssociatedMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2247)) COMMA_SOURCE_FILE_AT_LINE (2247)) COMMA_SOURCE_FILE_AT_LINE (2247)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_externFunctionDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("function ").operator_concat (object->mAttribute_mFunctionName.reader_string (SOURCE_FILE_AT_LINE (2269)) COMMA_SOURCE_FILE_AT_LINE (2269)), object->mAttribute_mFunctionName.reader_location (SOURCE_FILE_AT_LINE (2269)) COMMA_SOURCE_FILE_AT_LINE (2269)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2270)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_onceFunctionDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("function ").operator_concat (object->mAttribute_mFunctionName.reader_string (SOURCE_FILE_AT_LINE (2280)) COMMA_SOURCE_FILE_AT_LINE (2280)), object->mAttribute_mFunctionName.reader_location (SOURCE_FILE_AT_LINE (2280)) COMMA_SOURCE_FILE_AT_LINE (2280)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2281)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_externRoutineDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("routine ").operator_concat (object->mAttribute_mRoutineName.reader_string (SOURCE_FILE_AT_LINE (2291)) COMMA_SOURCE_FILE_AT_LINE (2291)), object->mAttribute_mRoutineName.reader_location (SOURCE_FILE_AT_LINE (2291)) COMMA_SOURCE_FILE_AT_LINE (2291)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2292)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_filewrapperDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("filewrapper ").operator_concat (object->mAttribute_mFilewrapperName.reader_string (SOURCE_FILE_AT_LINE (2302)) COMMA_SOURCE_FILE_AT_LINE (2302)), object->mAttribute_mFilewrapperName.reader_location (SOURCE_FILE_AT_LINE (2302)) COMMA_SOURCE_FILE_AT_LINE (2302)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2303)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_overridingCategoryMethodAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2313)) COMMA_SOURCE_FILE_AT_LINE (2313)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2313)).operator_concat (object->mAttribute_mOverridingCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (2313)) COMMA_SOURCE_FILE_AT_LINE (2313)), object->mAttribute_mOverridingCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (2313)) COMMA_SOURCE_FILE_AT_LINE (2313)) ;
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_overridingAbstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_overridingAbstractCategoryReaderAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2325)) COMMA_SOURCE_FILE_AT_LINE (2325)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2325)).operator_concat (object->mAttribute_mAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2325)) COMMA_SOURCE_FILE_AT_LINE (2325)), object->mAttribute_mAbstractCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (2325)) COMMA_SOURCE_FILE_AT_LINE (2325)) ;
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_overridingAbstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_overridingAbstractCategoryMethodAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2337)) COMMA_SOURCE_FILE_AT_LINE (2337)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2337)).operator_concat (object->mAttribute_mOverridingCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (2337)) COMMA_SOURCE_FILE_AT_LINE (2337)), object->mAttribute_mOverridingCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (2337)) COMMA_SOURCE_FILE_AT_LINE (2337)) ;
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_categoryReaderAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2349)) COMMA_SOURCE_FILE_AT_LINE (2349)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2349)).operator_concat (object->mAttribute_mCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2349)) COMMA_SOURCE_FILE_AT_LINE (2349)), object->mAttribute_mCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (2349)) COMMA_SOURCE_FILE_AT_LINE (2349)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2350)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2351)) COMMA_SOURCE_FILE_AT_LINE (2351)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (2351)) COMMA_SOURCE_FILE_AT_LINE (2351)) COMMA_SOURCE_FILE_AT_LINE (2351)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2353)) COMMA_SOURCE_FILE_AT_LINE (2353)).operator_not (SOURCE_FILE_AT_LINE (2353)).isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (2356)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2354)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_98186 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2359)) ;
  if (NULL != objectArray_98186) {
      macroValidSharedObject (objectArray_98186, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_98186->mAttribute_mCategoryReaderMapForType.modifier_insertOrReplace (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList COMMA_SOURCE_FILE_AT_LINE (2360)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_categoryMethodAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2375)) COMMA_SOURCE_FILE_AT_LINE (2375)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2375)).operator_concat (object->mAttribute_mCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (2375)) COMMA_SOURCE_FILE_AT_LINE (2375)), object->mAttribute_mCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (2375)) COMMA_SOURCE_FILE_AT_LINE (2375)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2376)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2377)) COMMA_SOURCE_FILE_AT_LINE (2377)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (2377)) COMMA_SOURCE_FILE_AT_LINE (2377)) COMMA_SOURCE_FILE_AT_LINE (2377)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2379)) COMMA_SOURCE_FILE_AT_LINE (2379)).operator_not (SOURCE_FILE_AT_LINE (2379)).isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (2382)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2380)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_99331 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2385)) ;
  if (NULL != objectArray_99331) {
      macroValidSharedObject (objectArray_99331, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_99331->mAttribute_mCategoryMethodMapForType.modifier_insertOrReplace (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2386)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_abstractCategoryReaderAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2412)) COMMA_SOURCE_FILE_AT_LINE (2412)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2412)).operator_concat (object->mAttribute_mAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2412)) COMMA_SOURCE_FILE_AT_LINE (2412)), object->mAttribute_mAbstractCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (2412)) COMMA_SOURCE_FILE_AT_LINE (2412)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2413)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2414)) COMMA_SOURCE_FILE_AT_LINE (2414)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (2414)) COMMA_SOURCE_FILE_AT_LINE (2414)) COMMA_SOURCE_FILE_AT_LINE (2414)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  if (ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2416)) COMMA_SOURCE_FILE_AT_LINE (2416)).operator_not (SOURCE_FILE_AT_LINE (2416)).isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (2419)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2417)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_101163 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2422)) ;
  if (NULL != objectArray_101163) {
      macroValidSharedObject (objectArray_101163, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_101163->mAttribute_mCategoryReaderMapForType.modifier_insertOrReplace (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList COMMA_SOURCE_FILE_AT_LINE (2423)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2439)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  if (ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2442)) COMMA_SOURCE_FILE_AT_LINE (2442)).operator_not (SOURCE_FILE_AT_LINE (2442)).isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
  ...
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_102356 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2448)) ;
  if (NULL != objectArray_102356) {
      macroValidSharedObject (objectArray_102356, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_102356->mAttribute_mCategoryMethodMapForType.modifier_insertOrReplace (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2449)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
