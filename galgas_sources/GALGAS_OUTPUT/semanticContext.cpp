...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_53774,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_53774 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_54040 (operand_53774->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_54040 = NULL ;
      while (((operand_54040 = enumerator_54040.nextObject ()))) {
        macroValidPointer (operand_54040) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54040->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1334)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1334)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_54040->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_53774->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1338)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_54573,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_54573 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_54840 (operand_54573->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_54840 = NULL ;
      while (((operand_54840 = enumerator_54840.nextObject ()))) {
        macroValidPointer (operand_54840) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54840->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1351)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1351)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54573->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1356)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1356)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_54573->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1358)) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_55540,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_55540 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_55540->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1369)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1369)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_55540->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1371)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_56133,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_56133 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_56598_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_56598_1 ;
    GGS_attributeMap  automatic_var_56598_2 ;
    GGS_typedAttributeList  automatic_var_56598_3 ;
    GGS_constructorMap  automatic_var_56598_4 ;
    GGS_readerMap  automatic_var_56598_5 ;
    GGS_modifierMap  automatic_var_56598_6 ;
    GGS_instanceMethodMap  automatic_var_56598_7 ;
    GGS_classMethodMap  automatic_var_56598_8 ;
    GGS_enumerationDescriptorList  automatic_var_56598_9 ;
    GGS_uint  automatic_var_56598_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_56598_11 ;
    GGS_nativeAttributeList  automatic_var_56598_12 ;
    GGS_stringset  automatic_var_56598_13 ;
    GGS_lstringlist  automatic_var_56598_14 ;
    GGS_typedAttributeList  automatic_var_56598_15 ;
    GGS_mapSearchMethodListAST  automatic_var_56598_16 ;
    GGS_mapSearchMethodListAST  automatic_var_56598_17 ;
    GGS_withAccessorMap  automatic_var_56598_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_56133->mAssociatedListTypeName, automatic_var_56598_0, automatic_var_56598_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_56598_2, automatic_var_56598_3, automatic_var_56598_4, automatic_var_56598_5, automatic_var_56598_6, automatic_var_56598_7, automatic_var_56598_8, automatic_var_56598_9, automatic_var_56598_10, automatic_var_56598_11, automatic_var_56598_12, automatic_var_56598_13, automatic_var_56598_14, automatic_var_56598_15, automatic_var_56598_16, automatic_var_56598_17, automatic_var_56598_18 COMMA_SOURCE_FILE_AT_LINE (1384)) ;
    }
    const GGS_bool cond_56827 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1391))) ;
    if (cond_56827.isBuiltAndTrue ()) {
      operand_56133->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_56133->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1393)) ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56133->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1402)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1402)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56133->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1405)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1405)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    ...
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("listForKey"),  GGS_string ("string"),  operand_56133->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1413)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1413)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_56133->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1415)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1415)) ;
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_60499,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60499 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_60499 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_60499->mPredefinedTypeName, operand_60499) ;
  }
}
...
category_method__objectPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_objectPredefinedTypeAST * operand_60864,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60864 != NULL) {
    GGS_objectPredefinedTypeAST  var_cas_t = operand_60864 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string ("object"), operand_60864) ;
  }
}
...
category_method__stringsetPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_stringsetPredefinedTypeAST * operand_61227,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61227 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_61227->mPredefinedTypeName, operand_61227) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_61537,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61537 != NULL) {
    const GGS_string var_cas_actualSuperTypeName = operand_61537->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1505)) ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (var_cas_actualSuperTypeName, operand_61537->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1506)), operand_61537) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_61933,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61933 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_61933->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1514)), operand_61933) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_62247,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62247 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62247->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1522)), operand_62247) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_62561,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62561 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62561->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1530)), operand_62561) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_62879,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62879 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62879->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1538)), operand_62879) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_63200,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63200 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_63200->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1546)), operand_63200->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1546)), operand_63200) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_63544,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63544 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_63544->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1554)), operand_63544) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_63859,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63859 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_63859->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1562)), operand_63859->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1562)), operand_63859) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externFunctionDeclarationAST * operand_64214,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64214 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_64214) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externRoutineDeclarationAST * operand_64515,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64515 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_64515) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_65451 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_65451 = NULL ;
    while (((operand_65451 = enumerator_65451.nextObject ()))) {
      macroValidPointer (operand_65451) ;
      { typeCategoryMethod__semanticDeclarationAST__collectTypes method = findCategoryMethod__semanticDeclarationAST__collectTypes (operand_65451->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_65451->mSemanticDeclaration (HERE), var_cas_collectedTypeMap, var_cas_multiMethodMapForBuildingContext COMMA_SOURCE_FILE_AT_LINE (1596)) ;
        }
      }
    }
  }
  ...
  const GGS_bool cond_65963 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_65963.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_65826 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_65826 = NULL ;
      while (((operand_65826 = enumerator_65826.nextObject ()))) {
        macroValidPointer (operand_65826) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_65826->mValue) ;
      }
    }
  ...
  }else if (cond_65963.isBuiltAndFalse ()) {
    const GGS_bool cond_66265 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_66265.isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_66129 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_66129 = NULL ;
        while (((operand_66129 = enumerator_66129.nextObject ()))) {
          macroValidPointer (operand_66129) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_66129->mValue) ;
        }
      }
      ...
      var_cas_outSemanticContext.drop () ;
    }else if (cond_66265.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_66628 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_66628 = NULL ;
        while (((operand_66628 = enumerator_66628.nextObject ()))) {
          macroValidPointer (operand_66628) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_66628->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_66628->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (1622)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_67742 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_67742 (_variant_67742.isBuilt (), true) ;
      while (_condition_67742.isBuiltAndTrue ()) {
        _condition_67742 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_67742.isBuiltAndTrue ()) {
          if (_variant_67742.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1643)) ;
            _condition_67742 = GGS_bool (false) ;
          }else{
            _variant_67742.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_67357 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_67357 = NULL ;
              while (((operand_67357 = enumerator_67357.nextObject ()))) {
                macroValidPointer (operand_67357) ;
                const GGS_bool cond_67585 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_67357->mDependanceString) ;
                if (cond_67585.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_67357->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_67357->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_67585.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_67357->mDependanceString, operand_67357->mTypeString, operand_67357->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_68365 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_68365.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_68024 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_68024 = enumerator_68024.nextObject () ;
          if ((operand_68024 != NULL)) {
            bool _foreach_loop_68024 ;
            do{
              macroValidPointer (operand_68024) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_68024->mTypeString) ;
              operand_68024 = enumerator_68024.nextObject () ;
              _foreach_loop_68024 = ((operand_68024 != NULL)) ;
              if (_foreach_loop_68024) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_68024) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_68197 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_68197 = NULL ;
          while (((operand_68197 = enumerator_68197.nextObject ()))) {
            macroValidPointer (operand_68197) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_68197->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_68197->mDependanceString) ;
          }
        }
        ...
        var_cas_outSemanticContext.drop () ;
      }else if (cond_68365.isBuiltAndFalse ()) {
        ...
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_68781 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_68781 = NULL ;
          while (((operand_68781 = enumerator_68781.nextObject ()))) {
            macroValidPointer (operand_68781) ;
            { typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (operand_68781->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_68781->mSemanticDeclaration (HERE), var_cas_multiMethodMapForBuildingContext, var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (1668)) ;
              }
            }
          }
        }
