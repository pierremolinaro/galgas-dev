...
void routine_addCategories (const GALGAS_categoryMethodMapForBuildingContext constinArgument_inCategoryMethodMapForBuildingContext,
  ...
  if (kBoolTrue == test_1) {
    ...
    while (enumerator_20673.hasCurrentObject ()) {
      ...
      cEnumerator_formalInputParameterListAST enumerator_20792 (enumerator_20673.current_mInputFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_20792.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_20792.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (523)) ;
        }
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_20792.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (524)) ;
  ...
  if (kBoolTrue == test_2) {
    ...
    cEnumerator_categoryModifierMapForType enumerator_21786 (var_categoryModifierMapForType, kEnumeration_up) ;
    while (enumerator_21786.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_21889 (enumerator_21786.current_mFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_21889.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_21889.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (548)) ;
        }
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_21889.current_mFormalArgumentPassingMode (HERE), enumerator_21889.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (549)) ;
        enumerator_21889.gotoNextObject () ;
      }
      {
      ioArgument_ioModifierMap.modifier_insertKey (enumerator_21786.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE_AT_LINE (553)), var_formalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (556)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (551)) ;
      }
...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_76019 (var_files, kEnumeration_up) ;
  while (enumerator_76019.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_76019.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1871)) COMMA_SOURCE_FILE_AT_LINE (1871)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1872)).operator_concat (enumerator_76019.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1872)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76019.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1874)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1873)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1880)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_76019.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1881)) COMMA_SOURCE_FILE_AT_LINE (1881)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1882)).operator_concat (enumerator_76019.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1882)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76019.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1884)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1883)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1890)) ;
      }
    }
    enumerator_76019.gotoNextObject () ;
  }
  ...
  cEnumerator_stringlist enumerator_76984 (var_directories, kEnumeration_up) ;
  while (enumerator_76984.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1901)).operator_concat (enumerator_76984.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1901)), constinArgument_inPathInWrapper.operator_concat (enumerator_76984.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1902)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1902)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1900)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76984.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1911)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1910)) ;
    }
    enumerator_76984.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147086 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147086.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_147086.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3574)) ;
    enumerator_147086.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147819 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147819.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_147819.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3586)) ;
    enumerator_147819.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (3594)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_148239 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3595)), kEnumeration_up) ;
    while (enumerator_148239.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_148239.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_148239.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3596)) COMMA_SOURCE_FILE_AT_LINE (3596)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3596)) COMMA_SOURCE_FILE_AT_LINE (3596)) ;
      enumerator_148239.gotoNextObject () ;
    }
    ...
    GALGAS_lstringlist joker_148575_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_148575_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3600)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3611)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string ("semantic analysis not performed, ").operator_concat (var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3612)).reader_string (SOURCE_FILE_AT_LINE (3612)) COMMA_SOURCE_FILE_AT_LINE (3612)).operator_concat (GALGAS_string (" declarations are involved in circular definition:") COMMA_SOURCE_FILE_AT_LINE (3612)) ;
      cEnumerator_semanticDeclarationListAST enumerator_149160 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149160.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_149160.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3614)) COMMA_SOURCE_FILE_AT_LINE (3614)) COMMA_SOURCE_FILE_AT_LINE (3614)) ;
        enumerator_149160.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (3616)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      var_sortedSemanticDeclarationListAST.dotAssign_operation (var_categoryOverrideDefinitionList COMMA_SOURCE_FILE_AT_LINE (3619)) ;
      outArgument_outSemanticContext = GALGAS_semanticContext::constructor_new (constinArgument_inSourceFile, GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3623)), GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3624)), GALGAS_functionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3625)), GALGAS_filewrapperMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3626)), GALGAS_grammarMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3627)), GALGAS_optionComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3628)), GALGAS_lexiqueComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3629)), GALGAS_optionMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3630)) COMMA_SOURCE_FILE_AT_LINE (3621)) ;
      cEnumerator_semanticDeclarationListAST enumerator_149968 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149968.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_149968.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3634)) ;
        enumerator_149968.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  routine_enterConstructorWithArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("inMap"), GALGAS_string ("mapWithMapToOverride"), object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (827)), object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (827)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (827)) ;
  }
  {
  ...
  cEnumerator_attributeInCollectionListAST enumerator_35770 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_35770.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_35770.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (845)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_35770.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (848)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_35770.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (849)) COMMA_SOURCE_FILE_AT_LINE (849)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (850)), enumerator_35770.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (850)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (851)), enumerator_35770.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (851)) ;
    enumerator_35770.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_36488 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_36488.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_36488.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (855)) COMMA_SOURCE_FILE_AT_LINE (855)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_36488.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_36488.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (856)) COMMA_SOURCE_FILE_AT_LINE (856)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (856)) COMMA_SOURCE_FILE_AT_LINE (856)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_36488.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (860)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (863)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (858)) ;
      }
    }
    enumerator_36488.gotoNextObject () ;
  }
  cEnumerator_mapRemoveMethodListAST enumerator_36962 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  while (enumerator_36962.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_modifierMap.reader_hasKey (enumerator_36962.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (870)) COMMA_SOURCE_FILE_AT_LINE (870)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_36962.current_mMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_36962.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (871)) COMMA_SOURCE_FILE_AT_LINE (871)).operator_concat (GALGAS_string ("' method is already declared as an insert modifier or a remove modifier") COMMA_SOURCE_FILE_AT_LINE (871)) COMMA_SOURCE_FILE_AT_LINE (871)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_36962.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (875)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (878)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (873)) ;
      }
    }
    enumerator_36962.gotoNextObject () ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_37489 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_37489.hasCurrentObject ()) {
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_37489.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (887)), var_removeMethodFormalArgumentList, enumerator_37489.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (889)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (891)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (885)) ;
    }
    enumerator_37489.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_37824 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_37824.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_37824.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (897)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (897)), enumerator_37824.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (897)) COMMA_SOURCE_FILE_AT_LINE (897)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_37824.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (899)) ;
    }
    {
    ...
    enumerator_37824.gotoNextObject () ;
  }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_40018 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_40018.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_40018.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (945)) ;
    }
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_44838 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_44838.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_44838.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1048)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_44838.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1051)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_44838.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1052)) COMMA_SOURCE_FILE_AT_LINE (1052)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1053)), enumerator_44838.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1053)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1054)), enumerator_44838.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1054)) ;
    enumerator_44838.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_45572 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_45572.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_45572.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1058)) COMMA_SOURCE_FILE_AT_LINE (1058)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_45572.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_45572.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1059)) COMMA_SOURCE_FILE_AT_LINE (1059)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (1059)) COMMA_SOURCE_FILE_AT_LINE (1059)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_45572.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1063)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1066)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1061)) ;
      }
    }
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_mapOverrideBlockListAST enumerator_49457 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    while (enumerator_49457.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_49457.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1160)) COMMA_SOURCE_FILE_AT_LINE (1160)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1160)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1161)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1162)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1164)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1159)) ;
      }
      enumerator_49457.gotoNextObject () ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_49866 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_49866.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_49866.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1171)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1171)), enumerator_49866.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1171)) COMMA_SOURCE_FILE_AT_LINE (1171)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_49866.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1173)) ;
    }
    {
    ...
    enumerator_49866.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_50520 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_50520.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_50520.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1187)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1187)), enumerator_50520.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_50520.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1189)) ;
    }
    ...
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1191)), enumerator_50520.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1191)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1192)), enumerator_50520.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1192)) ;
    {
  ...
  cEnumerator_mapSearchMethodListAST enumerator_51570 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_51570.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_51570.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1206)) ;
    }
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_53324_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_53324_1 ; // Joker input parameter
  GALGAS_typedAttributeList joker_53364_2 ; // Joker input parameter
  GALGAS_attributeMap joker_53364_1 ; // Joker input parameter
  GALGAS_constructorMap joker_53420_11 ; // Joker input parameter
  GALGAS_readerMap joker_53420_10 ; // Joker input parameter
  GALGAS_modifierMap joker_53420_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_53420_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_53420_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_53420_6 ; // Joker input parameter
  GALGAS_stringlist joker_53420_5 ; // Joker input parameter
  GALGAS_uint joker_53420_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_53420_3 ; // Joker input parameter
  GALGAS_stringset joker_53420_2 ; // Joker input parameter
  GALGAS_lstringlist joker_53420_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_53474_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_53474_4 ; // Joker input parameter
  GALGAS_bool joker_53474_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_53474_2 ; // Joker input parameter
  GALGAS_string joker_53474_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_53324_2, joker_53324_1, var_typeKindEnum, joker_53364_2, joker_53364_1, var_mapTypedAttributeList, joker_53420_11, joker_53420_10, joker_53420_9, joker_53420_8, joker_53420_7, joker_53420_6, joker_53420_5, joker_53420_4, joker_53420_3, joker_53420_2, joker_53420_1, var_searchMethodList, joker_53474_5, joker_53474_4, joker_53474_3, joker_53474_2, joker_53474_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1260)) ;
  ...
  cEnumerator_mapSearchMethodListAST enumerator_56084 (var_searchMethodList, kEnumeration_up) ;
  while (enumerator_56084.hasCurrentObject ()) {
    {
    var_constructorMap.modifier_insertKey (enumerator_56084.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1319)) ;
    }
    enumerator_56084.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_57055 (var_mapTypedAttributeList, kEnumeration_up) ;
  while (enumerator_57055.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_57055.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1336)) COMMA_SOURCE_FILE_AT_LINE (1336)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_57197 (var_inheritedReaderMap.reader_keySet (SOURCE_FILE_AT_LINE (1338)), kEnumeration_up) ;
      while (enumerator_57197.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_57197.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (1339)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1339)) COMMA_SOURCE_FILE_AT_LINE (1339)) ;
        if (enumerator_57197.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (1340)) ;
        }
        enumerator_57197.gotoNextObject () ;
      }
      GALGAS_location location_3 (enumerator_57055.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      {
      var_readerMap.modifier_insertKey (enumerator_57055.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1347)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1348)), inCompiler->here (), GALGAS_bool (true), enumerator_57055.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1352)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1345)) ;
      }
    }
    enumerator_57055.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externTypeDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_externTypeConstructorList enumerator_59709 (object->mAttribute_mExternTypeConstructorList, kEnumeration_up) ;
  while (enumerator_59709.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59709.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1414)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_59961 (enumerator_59709.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_59961.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59961.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1419)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_59961.current_mFormalParameterName (HERE) COMMA_SOURCE_FILE_AT_LINE (1420)) ;
      enumerator_59961.gotoNextObject () ;
    }
    {
    var_constructorMap.modifier_insertKey (enumerator_59709.current_mConstructorName (HERE), var_arguments, GALGAS_bool (true), var_returnedTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1423)) ;
    }
    enumerator_59709.gotoNextObject () ;
  }
  cEnumerator_externTypeReaderList enumerator_60427 (object->mAttribute_mExternTypeReaderList, kEnumeration_up) ;
  while (enumerator_60427.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60427.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1433)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_60679 (enumerator_60427.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_60679.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60679.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1438)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_60679.current_mFormalParameterName (HERE) COMMA_SOURCE_FILE_AT_LINE (1439)) ;
      enumerator_60679.gotoNextObject () ;
    }
    {
    var_readerMap.modifier_insertKey (enumerator_60427.current_mReaderName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1444)), var_arguments, inCompiler->here (), GALGAS_bool (true), var_returnedTypeProxy, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1449)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1442)) ;
    }
    enumerator_60427.gotoNextObject () ;
  }
  cEnumerator_externTypeModifierList enumerator_61256 (object->mAttribute_mExternTypeModifierList, kEnumeration_up) ;
  while (enumerator_61256.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_61353 (enumerator_61256.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_61353.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61353.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1457)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_61353.current_mFormalArgumentPassingMode (HERE), enumerator_61353.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1462)) ;
      enumerator_61353.gotoNextObject () ;
    }
    {
    var_modifierMap.modifier_insertKey (enumerator_61256.current_mModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1467)), var_routineSignature, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1470)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1465)) ;
    }
    enumerator_61256.gotoNextObject () ;
  }
  cEnumerator_externTypeMethodList enumerator_61949 (object->mAttribute_mExternTypeMethodList, kEnumeration_up) ;
  while (enumerator_61949.hasCurrentObject ()) {
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_69287 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE_AT_LINE (1681)), kEnumeration_up) ;
  while (enumerator_69287.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (enumerator_69287.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1682)), enumerator_69287.current_mFormalParameterName (HERE) COMMA_SOURCE_FILE_AT_LINE (1682)) ;
    enumerator_69287.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_69438 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_69438.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_69438.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1687)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1690)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1685)) ;
    }
    enumerator_69438.gotoNextObject () ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_73613 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_73613.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_73613.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1801)) COMMA_SOURCE_FILE_AT_LINE (1801)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_73613.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1802)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1802)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1802)) ;
    }
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_filewrapperTemplateListAST enumerator_78218 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_78218.hasCurrentObject ()) {
    ...
    cEnumerator_formalTemplateInputParameterListAST enumerator_78336 (enumerator_78218.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_78336.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_78336.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1933)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1934)) ;
      enumerator_78336.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_78218.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_78218.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1936)) ;
    }
    enumerator_78218.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_textExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1943)) ;
  cEnumerator_lstringlist enumerator_78855 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_78855.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_78855.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1945)) ;
    }
  ...
  cEnumerator_lstringlist enumerator_79061 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_79061.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_79061.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1950)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_79061.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_79061.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1951)) COMMA_SOURCE_FILE_AT_LINE (1951)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1951)) COMMA_SOURCE_FILE_AT_LINE (1951)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_79061.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1953)) ;
      }
    }
    enumerator_79061.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_81011 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_81011.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_81011.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2006)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_81255 (enumerator_81011.current_mFeatureList (HERE), kEnumeration_up) ;
    ...
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_81011.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2016)) ;
    enumerator_81011.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_82199 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_82199.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_82199.current_mAttributeTypeProxy (HERE), enumerator_82199.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2030)) COMMA_SOURCE_FILE_AT_LINE (2030)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_82199.current_mAttributeTypeProxy (HERE), enumerator_82199.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2031)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_82199.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2032)), enumerator_82199.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2032)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_82199.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2033)), enumerator_82199.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2033)) ;
    enumerator_82199.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_83608 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_83608.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_83608.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_83608.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2053)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2053)), enumerator_83608.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2053)) COMMA_SOURCE_FILE_AT_LINE (2053)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2054)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_listWithValue (var_uintType, GALGAS_string ("inIndex") COMMA_SOURCE_FILE_AT_LINE (2055)), inCompiler->here (), GALGAS_bool (true), enumerator_83608.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2059)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2052)) ;
      }
    }
  ...
  cEnumerator_typedAttributeList enumerator_85432 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_85432.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_85432.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      ...
      var_setterFormalArgumentList.addAssign_operation (enumerator_85432.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2115)), enumerator_85432.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2115)) ;
      var_setterFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2116)), enumerator_85432.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2116)) ;
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_85432.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2118)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2118)) COMMA_SOURCE_FILE_AT_LINE (2118)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2118)), enumerator_85432.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2118)) COMMA_SOURCE_FILE_AT_LINE (2118)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2119)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2122)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2117)) ;
      }
    }
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_89232 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_89232.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_89232.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2209)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_89232.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2212)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_89232.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2213)) ;
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_89232.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2214)) ;
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2215)), enumerator_89232.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2215)) ;
    enumerator_89232.gotoNextObject () ;
  }
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_93887 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_93887.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_93887.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2336)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_93887.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2337)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_93887.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2340)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_93887.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2341)) ;
    }
    enumerator_93887.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_94633 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_94633.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_94633.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2358)), enumerator_94633.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2359)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2355)) ;
    }
    enumerator_94633.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_95818 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_95818.hasCurrentObject () && bool_1) {
    while (enumerator_95818.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_95818.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2393)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_95818.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2393)).operator_not (SOURCE_FILE_AT_LINE (2393)) COMMA_SOURCE_FILE_AT_LINE (2393)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_95818.gotoNextObject () ;
      if (enumerator_95818.hasCurrentObject ()) {
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_98227 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_98227.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_98227.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2454)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_98227.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    ...
    GALGAS_bool joker_98704_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_98704_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_98789_2 ; // Joker input parameter
    GALGAS_constructorMap joker_98789_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_98880_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_98880_9 ; // Joker input parameter
    GALGAS_stringlist joker_98880_8 ; // Joker input parameter
    GALGAS_uint joker_98880_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_98880_6 ; // Joker input parameter
    GALGAS_stringset joker_98880_5 ; // Joker input parameter
    GALGAS_lstringlist joker_98880_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_98880_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_98880_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_98880_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_98926_2 ; // Joker input parameter
    GALGAS_string joker_98926_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_98704_2, joker_98704_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_98789_2, joker_98789_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_98880_10, joker_98880_9, joker_98880_8, joker_98880_7, joker_98880_6, joker_98880_5, joker_98880_4, joker_98880_3, joker_98880_2, joker_98880_1, var_generateHeaderInSeparateFile, joker_98926_2, joker_98926_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2464)) ;
    ...
    cEnumerator_modifierMap enumerator_99215 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_99215.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_99215.current_lkey (HERE), enumerator_99215.current_mKind (HERE), enumerator_99215.current_mParameterList (HERE), enumerator_99215.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2490)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2485)) ;
      }
      enumerator_99215.gotoNextObject () ;
    }
    ...
    cEnumerator_instanceMethodMap enumerator_99929 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_99929.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_99929.current_lkey (HERE), enumerator_99929.current_mKind (HERE), enumerator_99929.current_mParameterList (HERE), enumerator_99929.current_mDeclarationLocation (HERE), enumerator_99929.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2517)), enumerator_99929.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2511)) ;
      }
      enumerator_99929.gotoNextObject () ;
    }
  }
  ...
  cEnumerator_typedAttributeList enumerator_100360 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_100360.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_100360.current_mAttributeTypeProxy (HERE), enumerator_100360.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2525)) ;
    enumerator_100360.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_100487 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_100487.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_100487.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2529)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_100487.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2530)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_100487.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2531)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_100487.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2532)) COMMA_SOURCE_FILE_AT_LINE (2532)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_100487.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_100487.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2533)) COMMA_SOURCE_FILE_AT_LINE (2533)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader") COMMA_SOURCE_FILE_AT_LINE (2533)) COMMA_SOURCE_FILE_AT_LINE (2533)) ;
    }
    enumerator_100487.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_101587 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_101587.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_101587.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2557)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_101831 (enumerator_101587.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_101831.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_101831.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2561)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_101831.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2563)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_101831.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_101587.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2567)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_101587.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2568)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_101587.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2572)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2573)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2577)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2570)) ;
      }
    }
    enumerator_101587.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_102899 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_102899.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_102899.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_102899.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2592)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2592)) COMMA_SOURCE_FILE_AT_LINE (2592)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2592)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2593)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_102899.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2594)), enumerator_102899.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2594)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2596)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2591)) ;
      }
    }
    enumerator_102899.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_103944 (var_currentClassTypedAttributeList, kEnumeration_up) ;
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_105604 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_105604.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_105604.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2665)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_105604.current_mFormalArgumentPassingMode (HERE), enumerator_105604.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2666)) ;
    enumerator_105604.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_106612 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_106612.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_106612.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2684)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2685)) ;
    enumerator_106612.gotoNextObject () ;
  }
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_arrayDeclarationAST) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2718)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2741)).isValid ()) {
    PMUInt32 variant_109387 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2741)).uintValue () ;
    bool loop_109387 = true ;
    while (loop_109387) {
      loop_109387 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2741)))).isValid () ;
      if (loop_109387) {
        loop_109387 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2741)))).boolValue () ;
      }
      if (loop_109387 && (0 == variant_109387)) {
        loop_109387 = false ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2780)).isValid ()) {
    PMUInt32 variant_110699 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2780)).uintValue () ;
    bool loop_110699 = true ;
    while (loop_110699) {
      loop_110699 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2780)))).isValid () ;
      if (loop_110699) {
        loop_110699 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2780)))).boolValue () ;
      }
      if (loop_110699 && (0 == variant_110699)) {
        loop_110699 = false ;
  ...
  {
  GALGAS_unifiedTypeMapProxy joker_111313_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_111313_2 ; // Joker input parameter
  GALGAS_string joker_111313_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_111313_3, joker_111313_2, joker_111313_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2800)) ;
  }
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_113735_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_113735_1 ; // Joker input parameter
  GALGAS_attributeMap joker_113824_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_113824_18 ; // Joker input parameter
  GALGAS_constructorMap joker_113824_17 ; // Joker input parameter
  GALGAS_readerMap joker_113824_16 ; // Joker input parameter
  GALGAS_modifierMap joker_113824_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_113824_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_113824_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_113824_12 ; // Joker input parameter
  GALGAS_stringlist joker_113824_11 ; // Joker input parameter
  GALGAS_uint joker_113824_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_113824_9 ; // Joker input parameter
  GALGAS_stringset joker_113824_8 ; // Joker input parameter
  GALGAS_lstringlist joker_113824_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_113824_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_113824_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_113824_4 ; // Joker input parameter
  GALGAS_bool joker_113824_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_113824_2 ; // Joker input parameter
  GALGAS_string joker_113824_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_113735_2, joker_113735_1, var_typeKindEnum, var_listTypedAttributeList, joker_113824_19, joker_113824_18, joker_113824_17, joker_113824_16, joker_113824_15, joker_113824_14, joker_113824_13, joker_113824_12, joker_113824_11, joker_113824_10, joker_113824_9, joker_113824_8, joker_113824_7, joker_113824_6, joker_113824_5, joker_113824_4, joker_113824_3, joker_113824_2, joker_113824_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2867)) ;
  ...
  cEnumerator_typedAttributeList enumerator_115896 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_115896.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_115896.current_mAttributeTypeProxy (HERE), enumerator_115896.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2907)) ;
    enumerator_115896.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_120152 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_120152.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_120152.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3008)) COMMA_SOURCE_FILE_AT_LINE (3008)), enumerator_120152.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3008)) COMMA_SOURCE_FILE_AT_LINE (3008)) COMMA_SOURCE_FILE_AT_LINE (3008)) ;
    }
    enumerator_120152.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121134 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121134.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121134.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3025)) COMMA_SOURCE_FILE_AT_LINE (3025)), enumerator_121134.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3025)) COMMA_SOURCE_FILE_AT_LINE (3025)) COMMA_SOURCE_FILE_AT_LINE (3025)) ;
    }
    enumerator_121134.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121995 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121995.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121995.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3041)) COMMA_SOURCE_FILE_AT_LINE (3041)), enumerator_121995.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3041)) COMMA_SOURCE_FILE_AT_LINE (3041)) COMMA_SOURCE_FILE_AT_LINE (3041)) ;
    }
    enumerator_121995.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_123561 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123561.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123561.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3070)) COMMA_SOURCE_FILE_AT_LINE (3070)), enumerator_123561.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3070)) COMMA_SOURCE_FILE_AT_LINE (3070)) COMMA_SOURCE_FILE_AT_LINE (3070)) ;
    }
    enumerator_123561.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_126057 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126057.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126057.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3114)) COMMA_SOURCE_FILE_AT_LINE (3114)), enumerator_126057.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3114)) COMMA_SOURCE_FILE_AT_LINE (3114)) COMMA_SOURCE_FILE_AT_LINE (3114)) ;
    }
    enumerator_126057.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_126915 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126915.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126915.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3130)) COMMA_SOURCE_FILE_AT_LINE (3130)), enumerator_126915.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3130)) COMMA_SOURCE_FILE_AT_LINE (3130)) COMMA_SOURCE_FILE_AT_LINE (3130)) ;
    }
    enumerator_126915.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_136000 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3302)) ;
  if (NULL != objectArray_136000) {
      macroValidSharedObject (objectArray_136000, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_136000->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3303)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_137302 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3330)) ;
  if (NULL != objectArray_137302) {
      macroValidSharedObject (objectArray_137302, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_137302->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3331)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_138574 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3357)) ;
  if (NULL != objectArray_138574) {
      macroValidSharedObject (objectArray_138574, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_138574->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3358)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_140475 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3396)) ;
  if (NULL != objectArray_140475) {
      macroValidSharedObject (objectArray_140475, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_140475->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3397)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_141825 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3424)) ;
  if (NULL != objectArray_141825) {
      macroValidSharedObject (objectArray_141825, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_141825->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3425)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_143137 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3451)) ;
  if (NULL != objectArray_143137) {
      macroValidSharedObject (objectArray_143137, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_143137->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3452)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_143976 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_143976.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_143976.current_mAttributeTypeName (HERE), enumerator_143976.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3481)) COMMA_SOURCE_FILE_AT_LINE (3478)) ;
    enumerator_143976.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_144610 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_144610.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_144610.current_mAttributeTypeName (HERE), enumerator_144610.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3502)) COMMA_SOURCE_FILE_AT_LINE (3499)) ;
    enumerator_144610.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_145252 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145252.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145252.current_mAttributeTypeName (HERE), enumerator_145252.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3523)) COMMA_SOURCE_FILE_AT_LINE (3520)) ;
    enumerator_145252.gotoNextObject () ;
  }
