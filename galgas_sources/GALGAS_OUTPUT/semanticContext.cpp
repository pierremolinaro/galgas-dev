...
//                    november 27th, 2010, at 19h48'32"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  while (enumerator_52693.hasCurrentObject ()) {
    ...
    const GALGAS_bool test_0 (constinArgument_inExtensionMap.reader_hasKey (enumerator_52693.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1271)) COMMA_SOURCE_FILE_AT_LINE (1271))) ;
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (2500)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @foreachInstructionForGeneration
    ...
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (2520)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_25285.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_0 (var_modifierMap.reader_hasKey (enumerator_25285.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (592)) COMMA_SOURCE_FILE_AT_LINE (592))) ;
    if (test_0.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
  ...
  while (enumerator_25720.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (var_modifierMap.reader_hasKey (enumerator_25720.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (606)) COMMA_SOURCE_FILE_AT_LINE (606))) ;
    if (test_2.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_4 (GALGAS_bool (kIsSupOrEqual, object->mAttribute_mInsertOrReplaceDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (647)).objectCompare (GALGAS_uint ((PMUInt32) 1U)))) ;
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_34121.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_0 (var_modifierMap.reader_hasKey (enumerator_34121.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (786)) COMMA_SOURCE_FILE_AT_LINE (786))) ;
    if (test_0.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_2 (GALGAS_bool (kIsEqual, object->mAttribute_mMapStateList.reader_length (SOURCE_FILE_AT_LINE (799)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_2.isValidAndTrue ()) {
    //-------- @foreachInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_3 (GALGAS_bool (kIsStrictSup, object->mAttribute_mMapStateList.reader_length (SOURCE_FILE_AT_LINE (823)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_uniqueMapType (SOURCE_FILE_AT_LINE (955))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
  ...
  while (enumerator_43138.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (var_inheritedReaderMap.reader_hasKey (enumerator_43138.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1011)) COMMA_SOURCE_FILE_AT_LINE (1011))) ;
    if (test_2.isValidAndTrue ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1338)).reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1338)).objectCompare (GALGAS_char (TO_UNICODE (47))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_1 (var_absoluteSourcePath.reader_directoryExists (SOURCE_FILE_AT_LINE (1343)).operator_not (SOURCE_FILE_AT_LINE (1343))) ;
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (1708)).objectCompare (GALGAS_string::makeEmptyString ()))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
    ...
    while (enumerator_69492.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_1 (GALGAS_bool (kIsEqual, enumerator_69492.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1717)).objectCompare (GALGAS_string ("generatedInSeparateFile")))) ;
      if (test_1.isValidAndTrue ()) {
        //-------- @assignmentInstructionForGeneration
    ...
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (1740))))) ;
    if (test_2.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_4 (object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (1785))) ;
  if (test_4.isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_5 (constinArgument_inCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (1851)) COMMA_SOURCE_FILE_AT_LINE (1851))) ;
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_6 (constinArgument_inCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (1873)) COMMA_SOURCE_FILE_AT_LINE (1873))) ;
  ...
  while (enumerator_76247.hasCurrentObject ()) {
    ...
    while (enumerator_76507.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_7 (GALGAS_bool (kIsEqual, enumerator_76507.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1906)).objectCompare (GALGAS_string ("setter")))) ;
      if (test_7.isValidAndTrue ()) {
        //-------- @assignmentInstructionForGeneration
        var_hasSetter = GALGAS_bool (true) ;
      }else if (test_7.isValid ()) {
        //-------- @ifInstructionForGeneration
        const GALGAS_bool test_8 (GALGAS_bool (kIsEqual, enumerator_76507.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1908)).objectCompare (GALGAS_string ("nogetter")))) ;
    ...
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_9 (var_hasGetter) ;
  ...
  while (enumerator_77559.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_10 (enumerator_77559.current_mHasSetter (HERE)) ;
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (2042))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, object->mAttribute_mSuperClassName.mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ()))) ;
  if (test_0.isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2367)) COMMA_SOURCE_FILE_AT_LINE (2367)).operator_not (SOURCE_FILE_AT_LINE (2367))) ;
  if (test_0.isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2394)) COMMA_SOURCE_FILE_AT_LINE (2394)).operator_not (SOURCE_FILE_AT_LINE (2394))) ;
  if (test_0.isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2431)) COMMA_SOURCE_FILE_AT_LINE (2431)).operator_not (SOURCE_FILE_AT_LINE (2431))) ;
  if (test_0.isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2458)) COMMA_SOURCE_FILE_AT_LINE (2458)).operator_not (SOURCE_FILE_AT_LINE (2458))) ;
  if (test_0.isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
