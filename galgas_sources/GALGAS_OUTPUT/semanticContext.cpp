...
category_method__mapDeclarationAST__enterType (C_Compiler & inLexique,
  ...
  if (operand_13588 != NULL) {
    ...
    {
      GGS_insertMethodListAST::cEnumerator enumerator_15750 (operand_13588->mInsertMethodList, true) ;
      const GGS_insertMethodListAST::cElement * operand_15750 = NULL ;
