...
void routine_addCategories (const GALGAS_categoryMethodMapForBuildingContext constinArgument_inCategoryMethodMapForBuildingContext,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_categoryMethodMapForType enumerator_19876 (var_categoryMethodMapForType, kEnumeration_up) ;
    while (enumerator_19876.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_19979 (enumerator_19876.current_mFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_19979.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_19979.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 504)) ;
        }
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_19979.current_mFormalArgumentPassingMode (HERE), enumerator_19979.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 509)) ;
        enumerator_19979.gotoNextObject () ;
      }
      {
      ioArgument_ioInstanceMethodMap.modifier_insertKey (enumerator_19876.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE ("semanticContext.gSemantics", 513)), var_formalArgumentList, enumerator_19876.current_lkey (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 515)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 517)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 511)) ;
      }
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_categoryReaderMapForType enumerator_20849 (var_categoryReaderMapForType, kEnumeration_up) ;
    while (enumerator_20849.hasCurrentObject ()) {
      ...
      cEnumerator_formalInputParameterListAST enumerator_20968 (enumerator_20849.current_mInputFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_20968.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_20968.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 530)) ;
        }
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_20968.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 531)) ;
        enumerator_20968.gotoNextObject () ;
      }
      GALGAS_unifiedTypeMapProxy var_returnedType ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_20849.current_mResultTypeName (HERE), var_returnedType COMMA_SOURCE_FILE ("semanticContext.gSemantics", 534)) ;
      }
      {
      ioArgument_ioReaderMap.modifier_insertKey (enumerator_20849.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE ("semanticContext.gSemantics", 537)), var_formalArgumentList, enumerator_20849.current_lkey (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 539)), GALGAS_bool (true), var_returnedType, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 542)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 535)) ;
      }
  ...
  if (kBoolTrue == test_2) {
    ...
    cEnumerator_categoryModifierMapForType enumerator_21962 (var_categoryModifierMapForType, kEnumeration_up) ;
    while (enumerator_21962.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_22065 (enumerator_21962.current_mFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_22065.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_22065.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 555)) ;
        }
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_22065.current_mFormalArgumentPassingMode (HERE), enumerator_22065.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 556)) ;
        enumerator_22065.gotoNextObject () ;
      }
      {
      ioArgument_ioModifierMap.modifier_insertKey (enumerator_21962.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE ("semanticContext.gSemantics", 560)), var_formalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 563)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 558)) ;
      }
      enumerator_21962.gotoNextObject () ;
    }
  }
}
...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_78203 (var_files, kEnumeration_up) ;
  while (enumerator_78203.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_78203.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("semanticContext.gSemantics", 1915)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1915)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1916)).operator_concat (enumerator_78203.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1916)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_78203.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1918)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1917)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1924)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_78203.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("semanticContext.gSemantics", 1925)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1925)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1926)).operator_concat (enumerator_78203.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1926)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_78203.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1928)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1927)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1934)) ;
      }
    }
    enumerator_78203.gotoNextObject () ;
  }
  ...
  cEnumerator_stringlist enumerator_79168 (var_directories, kEnumeration_up) ;
  while (enumerator_79168.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1945)).operator_concat (enumerator_79168.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1945)), constinArgument_inPathInWrapper.operator_concat (enumerator_79168.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1946)).operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1946)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1944)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_79168.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1955)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1954)) ;
    }
...
void routine_buildSemanticContext (const GALGAS_semanticDeclarationListAST constinArgument_inSemanticDeclarationList,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_149687 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_149687.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_149687.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3640)) ;
    enumerator_149687.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_150420 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_150420.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_150420.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3652)) ;
    enumerator_150420.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_150895 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE ("semanticContext.gSemantics", 3662)), kEnumeration_up) ;
    while (enumerator_150895.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_150895.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_150895.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3663))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3663)).operator_concat (GALGAS_string ("' type is not defined")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3663))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3663)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
      enumerator_150895.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    ...
    GALGAS_lstringlist joker_151135_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_151135_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3666)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_151530 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_151530.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_151530.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3675))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3675))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3675)) ;
        enumerator_151530.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_152261 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_152261.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_152261.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3693)) ;
        enumerator_152261.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_36454 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_36454.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_36454.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 861)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_argumentTypeListForAddAssignWithFieldExpressionList.addAssign_operation (var_attributeTypeIndex, enumerator_36454.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 864)) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_36454.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 865)) ;
    ...
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_36454.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 867))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 867)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 868)), enumerator_36454.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 868)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 869)), enumerator_36454.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 869)) ;
    enumerator_36454.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_37316 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_37316.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_37316.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 873)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 873)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_37316.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_37316.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 874))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 874)).operator_concat (GALGAS_string ("' insert method is already declared")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 874))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 874)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_37316.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 878)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 881)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 876)) ;
      }
    }
    enumerator_37316.gotoNextObject () ;
  }
  cEnumerator_mapRemoveMethodListAST enumerator_37790 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  while (enumerator_37790.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_modifierMap.reader_hasKey (enumerator_37790.current_mMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 888)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 888)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_37790.current_mMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_37790.current_mMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 889))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 889)).operator_concat (GALGAS_string ("' method is already declared as an insert modifier or a remove modifier")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 889))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 889)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_37790.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 893)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 896)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 891)) ;
      }
    }
    enumerator_37790.gotoNextObject () ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_38317 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_38317.hasCurrentObject ()) {
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_38317.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 905)), var_removeMethodFormalArgumentList, enumerator_38317.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 907)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 909)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 903)) ;
    }
    enumerator_38317.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_38652 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_38652.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_38652.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 915)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 915)), enumerator_38652.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 915))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 915)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_38652.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 917)) ;
    }
    {
  ...
  cEnumerator_attributeInCollectionListAST enumerator_39923 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_39923.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_39923.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 945)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 945))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 945)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 945)), enumerator_39923.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 945))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 945)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_39923.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 946)) ;
    }
    ...
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 949)), enumerator_39923.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 949)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 950)), enumerator_39923.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 950)) ;
    {
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_46078 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_46078.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_46078.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1072)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_46078.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1075)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_46078.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1076))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1076)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1077)), enumerator_46078.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1077)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 1078)), enumerator_46078.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1078)) ;
    enumerator_46078.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_46812 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_46812.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_46812.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1082)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1082)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_46812.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_46812.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1083))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1083)).operator_concat (GALGAS_string ("' insert method is already declared")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1083))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1083)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_46812.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1087)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1090)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1085)) ;
      }
    }
  ...
  if (kBoolTrue == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_48557 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_48557.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_48557.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1125)), var_removeMethodFormalArgumentList, enumerator_48557.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 1127)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1129)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1123)) ;
      }
      enumerator_48557.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_48887 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_48887.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_48887.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1137)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1140)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1135)) ;
      }
      enumerator_48887.gotoNextObject () ;
    }
  }
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_mapOverrideBlockListAST enumerator_50697 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    while (enumerator_50697.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_50697.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 1184))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1184)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1184)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1185)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 1186)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1188)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1183)) ;
      }
      enumerator_50697.gotoNextObject () ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_51106 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_51106.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_51106.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1195)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1195)), enumerator_51106.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 1195))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1195)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_51106.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1197)) ;
    }
    {
  ...
  cEnumerator_attributeInCollectionListAST enumerator_51897 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_51897.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_51897.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1212)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 1212))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1212)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1212)), enumerator_51897.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 1212))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1212)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_51897.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1213)) ;
    }
    ...
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1216)), enumerator_51897.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1216)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1217)), enumerator_51897.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1217)) ;
    {
    ...
    enumerator_51897.gotoNextObject () ;
  }
  {
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_54957_3 ; // Joker input parameter
  GALGAS_bool joker_54957_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_54957_1 ; // Joker input parameter
  GALGAS_bool joker_54997_3 ; // Joker input parameter
  GALGAS_typedAttributeList joker_54997_2 ; // Joker input parameter
  GALGAS_attributeMap joker_54997_1 ; // Joker input parameter
  GALGAS_constructorMap joker_55052_11 ; // Joker input parameter
  GALGAS_readerMap joker_55052_10 ; // Joker input parameter
  GALGAS_modifierMap joker_55052_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_55052_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_55052_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_55052_6 ; // Joker input parameter
  GALGAS_stringlist joker_55052_5 ; // Joker input parameter
  GALGAS_uint joker_55052_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_55052_3 ; // Joker input parameter
  GALGAS_stringset joker_55052_2 ; // Joker input parameter
  GALGAS_lstringlist joker_55052_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_55107_6 ; // Joker input parameter
  GALGAS_bool joker_55107_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_55107_4 ; // Joker input parameter
  GALGAS_string joker_55107_3 ; // Joker input parameter
  GALGAS_string joker_55107_2 ; // Joker input parameter
  GALGAS_headerKind joker_55107_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_54957_3, joker_54957_2, joker_54957_1, var_typeKindEnum, joker_54997_3, joker_54997_2, joker_54997_1, var_mapTypedAttributeList, joker_55052_11, joker_55052_10, joker_55052_9, joker_55052_8, joker_55052_7, joker_55052_6, joker_55052_5, joker_55052_4, joker_55052_3, joker_55052_2, joker_55052_1, var_searchMethodList, joker_55107_6, joker_55107_5, joker_55107_4, joker_55107_3, joker_55107_2, joker_55107_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1290)) ;
  ...
  cEnumerator_mapSearchMethodListAST enumerator_57689 (var_searchMethodList, kEnumeration_up) ;
  while (enumerator_57689.hasCurrentObject ()) {
    {
    var_constructorMap.modifier_insertKey (enumerator_57689.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1348)) ;
    }
  ...
  cEnumerator_typedAttributeList enumerator_58660 (var_mapTypedAttributeList, kEnumeration_up) ;
  while (enumerator_58660.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_58660.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1365)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1365)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_58794 (var_inheritedReaderMap.reader_keySet (SOURCE_FILE ("semanticContext.gSemantics", 1367)), kEnumeration_up) ;
      while (enumerator_58794.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_58794.current_key (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1368)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1368))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1368)) ;
        if (enumerator_58794.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1369)) ;
        }
        enumerator_58794.gotoNextObject () ;
      }
      GALGAS_location location_3 (enumerator_58660.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      {
      var_readerMap.modifier_insertKey (enumerator_58660.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1376)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 1377)), inCompiler->here (), GALGAS_bool (true), enumerator_58660.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1381)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1374)) ;
      }
    }
    enumerator_58660.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externTypeDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_externTypeConstructorList enumerator_61489 (object->mAttribute_mExternTypeConstructorList, kEnumeration_up) ;
  while (enumerator_61489.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61489.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1448)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_61741 (enumerator_61489.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_61741.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61741.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1453)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_61741.current_mFormalParameterName (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1454)) ;
      enumerator_61741.gotoNextObject () ;
    }
    {
    var_constructorMap.modifier_insertKey (enumerator_61489.current_mConstructorName (HERE), var_arguments, GALGAS_bool (true), var_returnedTypeProxy, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1457)) ;
    }
    enumerator_61489.gotoNextObject () ;
  }
  cEnumerator_externTypeReaderList enumerator_62207 (object->mAttribute_mExternTypeReaderList, kEnumeration_up) ;
  while (enumerator_62207.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_62207.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1467)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_62459 (enumerator_62207.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_62459.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_62459.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1472)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_62459.current_mFormalParameterName (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1473)) ;
      enumerator_62459.gotoNextObject () ;
    }
    {
    var_readerMap.modifier_insertKey (enumerator_62207.current_mReaderName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1478)), var_arguments, inCompiler->here (), GALGAS_bool (true), var_returnedTypeProxy, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1483)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1476)) ;
    }
    enumerator_62207.gotoNextObject () ;
  }
  cEnumerator_externTypeModifierList enumerator_63036 (object->mAttribute_mExternTypeModifierList, kEnumeration_up) ;
  while (enumerator_63036.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_63133 (enumerator_63036.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_63133.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_63133.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1491)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_63133.current_mFormalArgumentPassingMode (HERE), enumerator_63133.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1496)) ;
      enumerator_63133.gotoNextObject () ;
    }
    {
    var_modifierMap.modifier_insertKey (enumerator_63036.current_mModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1501)), var_routineSignature, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1504)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1499)) ;
    }
    enumerator_63036.gotoNextObject () ;
  }
  cEnumerator_externTypeMethodList enumerator_63729 (object->mAttribute_mExternTypeMethodList, kEnumeration_up) ;
  while (enumerator_63729.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_63826 (enumerator_63729.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_63826.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_63826.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1513)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_63826.current_mFormalArgumentPassingMode (HERE), enumerator_63826.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1518)) ;
      enumerator_63826.gotoNextObject () ;
    }
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_63729.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1523)), var_routineSignature, enumerator_63729.current_mDeclarationLocation (HERE), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1527)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1521)) ;
    }
    enumerator_63729.gotoNextObject () ;
  }
  {
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_71135 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1715)), kEnumeration_up) ;
  while (enumerator_71135.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (enumerator_71135.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 1716)), enumerator_71135.current_mFormalParameterName (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1716)) ;
    enumerator_71135.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_71286 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_71286.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_71286.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1721)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1724)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1719)) ;
    }
    enumerator_71286.gotoNextObject () ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_75630 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_75630.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_75630.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1840))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1840)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_75630.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1841)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1841)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1841)) ;
    }
    enumerator_75630.gotoNextObject () ;
  }
  GALGAS_readerMap var_readerMap ;
  {
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_filewrapperTemplateListAST enumerator_80402 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_80402.hasCurrentObject ()) {
    ...
    cEnumerator_formalTemplateInputParameterListAST enumerator_80520 (enumerator_80402.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_80520.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_80520.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1977)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1978)) ;
      enumerator_80520.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_80402.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_80402.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1980)) ;
    }
    enumerator_80402.gotoNextObject () ;
  }
  ...
  cEnumerator_lstringlist enumerator_81039 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_81039.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_81039.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1989)) ;
    }
    enumerator_81039.gotoNextObject () ;
  }
  ...
  cEnumerator_lstringlist enumerator_81245 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_81245.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_81245.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1994)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_81245.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_81245.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1995))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1995)).operator_concat (GALGAS_string ("' extension is already used for text files")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1995))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1995)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_81245.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1997)) ;
      }
    }
    enumerator_81245.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_83212 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_83212.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_83212.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2050)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_83432 (enumerator_83212.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_83432.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_83432.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_83432.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_83432.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_83212.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2060)) ;
    enumerator_83212.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_84585 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_84585.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_84585.current_mAttributeTypeProxy (HERE), enumerator_84585.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2078))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2078)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_84585.current_mAttributeTypeProxy (HERE), enumerator_84585.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2079)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_84585.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 2080)), enumerator_84585.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2080)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_84585.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2081)), enumerator_84585.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2081)) ;
    enumerator_84585.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_85994 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_85994.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_85994.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_85994.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2101)).operator_concat (GALGAS_string ("AtIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2101)), enumerator_85994.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 2101))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2101)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2102)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_listWithValue (var_uintType, GALGAS_string ("inIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2103)), inCompiler->here (), GALGAS_bool (true), enumerator_85994.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2107)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2100)) ;
      }
    }
    enumerator_85994.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_87818 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_87818.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_87818.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      ...
      var_setterFormalArgumentList.addAssign_operation (enumerator_87818.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2163)), enumerator_87818.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2163)) ;
      var_setterFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2164)), enumerator_87818.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2164)) ;
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_87818.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2166)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2166))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2166)).operator_concat (GALGAS_string ("AtIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2166)), enumerator_87818.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 2166))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2166)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2167)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2170)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2165)) ;
      }
    }
    enumerator_87818.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_91607 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_91607.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_91607.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2257)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_91607.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2260)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_91607.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2261)) ;
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_91607.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2262)) ;
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 2263)), enumerator_91607.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2263)) ;
    enumerator_91607.gotoNextObject () ;
  }
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_96229 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_96229.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_96229.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2382)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_96229.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2383)) ;
    ...
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_96229.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2387)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_96229.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2388)) ;
    }
    enumerator_96229.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_97014 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_97014.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_97014.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2403)), enumerator_97014.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2404)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2400)) ;
    }
    enumerator_97014.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_98064 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_98064.hasCurrentObject () && bool_1) {
    while (enumerator_98064.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_98064.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2437)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_98064.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2437)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2437)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2437)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_98064.gotoNextObject () ;
      if (enumerator_98064.hasCurrentObject ()) {
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_100647 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_100647.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_100647.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2503)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_100647.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    ...
    GALGAS_bool joker_101126_3 ; // Joker input parameter
    GALGAS_bool joker_101126_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_101126_1 ; // Joker input parameter
    GALGAS_bool joker_101156_0 ; // Joker input parameter
    GALGAS_typedAttributeList joker_101220_2 ; // Joker input parameter
    GALGAS_constructorMap joker_101220_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_101310_9 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_101310_8 ; // Joker input parameter
    GALGAS_stringlist joker_101310_7 ; // Joker input parameter
    GALGAS_uint joker_101310_6 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_101310_5 ; // Joker input parameter
    GALGAS_stringset joker_101310_4 ; // Joker input parameter
    GALGAS_lstringlist joker_101310_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_101310_2 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_101310_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_101356_4 ; // Joker input parameter
    GALGAS_string joker_101356_3 ; // Joker input parameter
    GALGAS_string joker_101356_2 ; // Joker input parameter
    GALGAS_headerKind joker_101356_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_101126_3, joker_101126_2, joker_101126_1, var_typeKindEnum, joker_101156_0, var_inheritedTypedAttributeList, var_attributeMap, joker_101220_2, joker_101220_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_101310_9, joker_101310_8, joker_101310_7, joker_101310_6, joker_101310_5, joker_101310_4, joker_101310_3, joker_101310_2, joker_101310_1, var_generateHeaderInSeparateFile, joker_101356_4, joker_101356_3, joker_101356_2, joker_101356_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2513)) ;
    ...
    cEnumerator_modifierMap enumerator_101643 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_101643.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_101643.current_lkey (HERE), enumerator_101643.current_mKind (HERE), enumerator_101643.current_mParameterList (HERE), enumerator_101643.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2540)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2535)) ;
      }
      enumerator_101643.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2545)) ;
    cEnumerator_readerMap enumerator_101969 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_101969.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_101969.current_lkey (HERE), enumerator_101969.current_mKind (HERE), enumerator_101969.current_mArgumentTypeList (HERE), enumerator_101969.current_mDeclarationLocation (HERE), enumerator_101969.current_mHasCompilerArgument (HERE), enumerator_101969.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2554)), enumerator_101969.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2547)) ;
      }
      enumerator_101969.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2559)) ;
    cEnumerator_instanceMethodMap enumerator_102357 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_102357.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_102357.current_lkey (HERE), enumerator_102357.current_mKind (HERE), enumerator_102357.current_mParameterList (HERE), enumerator_102357.current_mDeclarationLocation (HERE), enumerator_102357.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2567)), enumerator_102357.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2561)) ;
      }
      enumerator_102357.gotoNextObject () ;
    }
  }
  ...
  cEnumerator_typedAttributeList enumerator_102788 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_102788.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_102788.current_mAttributeTypeProxy (HERE), enumerator_102788.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2575)) ;
    enumerator_102788.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_102915 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_102915.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_102915.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2579)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_102915.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2580)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_102915.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2581)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_102915.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2582)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2582)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_102915.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_102915.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2583))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2583)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2583))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2583)) ;
    }
    enumerator_102915.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_104015 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_104015.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_104015.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2607)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_104259 (enumerator_104015.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_104259.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_104259.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2611)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_104259.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2613)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_104259.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_104015.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2617)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_104015.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2618)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_104015.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2622)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2623)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2627)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2620)) ;
      }
    }
    enumerator_104015.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_105327 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_105327.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_105327.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_105327.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2642)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2642))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2642)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2642)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2643)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_105327.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 2644)), enumerator_105327.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2644)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2646)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2641)) ;
      }
    }
    enumerator_105327.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_106369 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_106369.hasCurrentObject () && bool_12) {
    while (enumerator_106369.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_106369.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2670)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_106369.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2670)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2670)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2670)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_106369.gotoNextObject () ;
      if (enumerator_106369.hasCurrentObject ()) {
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_108126 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_108126.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_108126.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2718)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_108126.current_mFormalArgumentPassingMode (HERE), enumerator_108126.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2719)) ;
    enumerator_108126.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externFunctionDeclarationAST * object = (const cPtr_externFunctionDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_externFunctionDeclarationAST) ;
  GALGAS_unifiedTypeMapProxyList var_functionSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2738)) ;
  cEnumerator_formalInputParameterListAST enumerator_109162 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_109162.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_109162.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2741)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2742)) ;
    enumerator_109162.gotoNextObject () ;
  }
...
static void categoryMethod_onceFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2767)), var_resultTypeIndex, object->mAttribute_mIsInternal, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2767)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2802)).isValid ()) {
    uint32_t variant_111976 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2802)).uintValue () ;
    bool loop_111976 = true ;
    while (loop_111976) {
      loop_111976 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2802)))).isValid () ;
      if (loop_111976) {
        loop_111976 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2802)))).boolValue () ;
      }
      if (loop_111976 && (0 == variant_111976)) {
        loop_111976 = false ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2841)).isValid ()) {
    uint32_t variant_113288 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2841)).uintValue () ;
    bool loop_113288 = true ;
    while (loop_113288) {
      loop_113288 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2841)))).isValid () ;
      if (loop_113288) {
        loop_113288 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2841)))).boolValue () ;
      }
      if (loop_113288 && (0 == variant_113288)) {
        loop_113288 = false ;
  ...
  {
  GALGAS_unifiedTypeMapProxy joker_113903_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_113903_2 ; // Joker input parameter
  GALGAS_string joker_113903_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_113903_3, joker_113903_2, joker_113903_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2861)) ;
  }
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_116395_3 ; // Joker input parameter
  GALGAS_bool joker_116395_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_116395_1 ; // Joker input parameter
  GALGAS_bool joker_116435_0 ; // Joker input parameter
  GALGAS_attributeMap joker_116490_20 ; // Joker input parameter
  GALGAS_typedAttributeList joker_116490_19 ; // Joker input parameter
  GALGAS_constructorMap joker_116490_18 ; // Joker input parameter
  GALGAS_readerMap joker_116490_17 ; // Joker input parameter
  GALGAS_modifierMap joker_116490_16 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_116490_15 ; // Joker input parameter
  GALGAS_classMethodMap joker_116490_14 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_116490_13 ; // Joker input parameter
  GALGAS_stringlist joker_116490_12 ; // Joker input parameter
  GALGAS_uint joker_116490_11 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_116490_10 ; // Joker input parameter
  GALGAS_stringset joker_116490_9 ; // Joker input parameter
  GALGAS_lstringlist joker_116490_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_116490_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_116490_6 ; // Joker input parameter
  GALGAS_bool joker_116490_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_116490_4 ; // Joker input parameter
  GALGAS_string joker_116490_3 ; // Joker input parameter
  GALGAS_string joker_116490_2 ; // Joker input parameter
  GALGAS_headerKind joker_116490_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_116395_3, joker_116395_2, joker_116395_1, var_typeKindEnum, joker_116435_0, var_listTypedAttributeList, joker_116490_20, joker_116490_19, joker_116490_18, joker_116490_17, joker_116490_16, joker_116490_15, joker_116490_14, joker_116490_13, joker_116490_12, joker_116490_11, joker_116490_10, joker_116490_9, joker_116490_8, joker_116490_7, joker_116490_6, joker_116490_5, joker_116490_4, joker_116490_3, joker_116490_2, joker_116490_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2932)) ;
  ...
  cEnumerator_typedAttributeList enumerator_118342 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_118342.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_118342.current_mAttributeTypeProxy (HERE), enumerator_118342.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2968)) ;
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_122850 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_122850.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_122850.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3077))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3077)), object->mAttribute_mSuperClassName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3077)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3077)) ;
    }
    enumerator_122850.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_123708 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123708.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123708.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3093))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3093)), enumerator_123708.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3093))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3093)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3093)) ;
    }
    enumerator_123708.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_124572 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_124572.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_124572.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3109))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3109)), enumerator_124572.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3109))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3109)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3109)) ;
    }
    enumerator_124572.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_126144 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126144.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126144.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3138))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3138)), enumerator_126144.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3138))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3138)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3138)) ;
    }
    enumerator_126144.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_128649 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_128649.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_128649.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3182))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3182)), enumerator_128649.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3182))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3182)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3182)) ;
    }
    enumerator_128649.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_129510 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_129510.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_129510.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3198))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3198)), enumerator_129510.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3198))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3198)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3198)) ;
    }
    enumerator_129510.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_138607 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryReaderMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3370)) ;
  if (NULL != objectArray_138607) {
      macroValidSharedObject (objectArray_138607, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_138607->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3371)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_139912 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryMethodMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3398)) ;
  if (NULL != objectArray_139912) {
      macroValidSharedObject (objectArray_139912, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_139912->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3399)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_141187 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryModifierMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3425)) ;
  if (NULL != objectArray_141187) {
      macroValidSharedObject (objectArray_141187, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_141187->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3426)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_143091 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryReaderMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3464)) ;
  if (NULL != objectArray_143091) {
      macroValidSharedObject (objectArray_143091, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_143091->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3465)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_144444 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryMethodMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3492)) ;
  if (NULL != objectArray_144444) {
      macroValidSharedObject (objectArray_144444, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_144444->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3493)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_145759 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryModifierMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3519)) ;
  if (NULL != objectArray_145759) {
      macroValidSharedObject (objectArray_145759, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_145759->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3520)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_146598 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_146598.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_146598.current_mAttributeTypeName (HERE), enumerator_146598.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3549))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3546)) ;
    enumerator_146598.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_147241 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_147241.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_147241.current_mAttributeTypeName (HERE), enumerator_147241.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3570))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3567)) ;
    enumerator_147241.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_147892 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_147892.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_147892.current_mAttributeTypeName (HERE), enumerator_147892.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3591))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3588)) ;
    enumerator_147892.gotoNextObject () ;
  }
