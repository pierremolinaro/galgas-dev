...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  while (enumerator_52670.hasCurrentObject ()) {
    ...
    const GALGAS_bool test_0 (constinArgument_inExtensionMap.reader_hasKey (enumerator_52670.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1270)) COMMA_SOURCE_FILE_AT_LINE (1270))) ;
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  GALGAS_semanticTypePrecedenceGraph var_semanticTypePrecedenceGraph = GALGAS_semanticTypePrecedenceGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (2487)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_categoryMethodMapForBuildingContext var_categoryMethodMapForBuildingContext = GALGAS_categoryMethodMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (2488)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_categoryReaderMapForBuildingContext var_categoryReaderMapForBuildingContext = GALGAS_categoryReaderMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (2489)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_semanticDeclarationListAST var_categoryOverrideDefinitionList = GALGAS_semanticDeclarationListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2490)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticDeclarationListAST enumerator_104185 (constinArgument_inSemanticDeclarationList, true) ;
  //--- simple foreach instruction
  while (enumerator_104185.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_104185.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2492)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_104185.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (2499)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_104559 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (2500)), true) ;
    //--- simple foreach instruction
    while (enumerator_104559.hasCurrentObject ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_104559.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_104559.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2501)) COMMA_SOURCE_FILE_AT_LINE (2501)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (2501)) COMMA_SOURCE_FILE_AT_LINE (2501)) ;
      enumerator_104559.gotoNextObject () ;
    }
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("semantic analysis not performed, due to undefined type error(s)") COMMA_SOURCE_FILE_AT_LINE (2503)) ;
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_lstringlist joker_105042_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_105042_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2508)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (2519)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
    if (test_2.isValidAndTrue ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("semantic analysis not performed, ").operator_concat (var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (2520)).reader_string (SOURCE_FILE_AT_LINE (2520)) COMMA_SOURCE_FILE_AT_LINE (2520)).operator_concat (GALGAS_string (" declarations are involved in circular definition:") COMMA_SOURCE_FILE_AT_LINE (2520)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_105586 (var_unsortedSemanticDeclarationListAST, true) ;
      //--- simple foreach instruction
      while (enumerator_105586.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_105586.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2522)) COMMA_SOURCE_FILE_AT_LINE (2522)) COMMA_SOURCE_FILE_AT_LINE (2522)) ;
        enumerator_105586.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (2524)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
    }else if (test_2.isValid ()) {
      //-------- @appendInstructionForGeneration
      var_sortedSemanticDeclarationListAST.dotAssign_operation (var_categoryOverrideDefinitionList COMMA_SOURCE_FILE_AT_LINE (2527)) ;
      //-------- @assignmentInstructionForGeneration
      outArgument_outSemanticContext = GALGAS_semanticContext::constructor_new (constinArgument_inSourceFile, GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2531)), GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2532)), GALGAS_functionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2533)), GALGAS_filewrapperMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2534)), GALGAS_grammarMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2535)), GALGAS_optionComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (2536)) COMMA_SOURCE_FILE_AT_LINE (2529)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_106284 (var_sortedSemanticDeclarationListAST, true) ;
      //--- simple foreach instruction
      while (enumerator_106284.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_106284.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (2540)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_106284.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_25262.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_0 (var_modifierMap.reader_hasKey (enumerator_25262.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (591)) COMMA_SOURCE_FILE_AT_LINE (591))) ;
    if (test_0.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_25262.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_25262.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (592)) COMMA_SOURCE_FILE_AT_LINE (592)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (592)) COMMA_SOURCE_FILE_AT_LINE (592)) ;
    }else if (test_0.isValid ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertOrReplace (enumerator_25262.current_mInsertMethodName (HERE), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (598)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (594)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
  ...
  while (enumerator_25697.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (var_modifierMap.reader_hasKey (enumerator_25697.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (605)) COMMA_SOURCE_FILE_AT_LINE (605))) ;
    if (test_2.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (enumerator_25697.current_mMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_25697.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (606)) COMMA_SOURCE_FILE_AT_LINE (606)).operator_concat (GALGAS_string ("' method is already declared as an insert modifier or a remove modifier") COMMA_SOURCE_FILE_AT_LINE (606)) COMMA_SOURCE_FILE_AT_LINE (606)) ;
    }else if (test_2.isValid ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertOrReplace (enumerator_25697.current_mMethodName (HERE), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (612)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (608)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
  ...
  while (enumerator_26516.hasCurrentObject ()) {
    ...
    { //-------- @modifierCallInstructionForGeneration
    var_readerMap.modifier_insertOrReplace (var_accessorName, GALGAS_bool (false), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (637)), inCompiler->here (), GALGAS_bool (true), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (641)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (634)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_26516.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_4 (GALGAS_bool (kIsSupOrEqual, object->mAttribute_mInsertOrReplaceDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (646)).objectCompare (GALGAS_uint ((PMUInt32) 1U)))) ;
  ...
  while (enumerator_27614.hasCurrentObject ()) {
    ...
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertOrReplace (var_accessorName, var_accessorFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (669)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (665)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_34098.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_0 (var_modifierMap.reader_hasKey (enumerator_34098.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (785)) COMMA_SOURCE_FILE_AT_LINE (785))) ;
    if (test_0.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_34098.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_34098.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (786)) COMMA_SOURCE_FILE_AT_LINE (786)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (786)) COMMA_SOURCE_FILE_AT_LINE (786)) ;
    }else if (test_0.isValid ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertOrReplace (enumerator_34098.current_mInsertMethodName (HERE), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (792)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (788)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_34098.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_2 (GALGAS_bool (kIsEqual, object->mAttribute_mMapStateList.reader_length (SOURCE_FILE_AT_LINE (798)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  if (test_2.isValidAndTrue ()) {
    //-------- @foreachInstructionForGeneration
    ...
    while (enumerator_34959.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (enumerator_34959.current_mSearchMethodName (HERE), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (816)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (812)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_34959.gotoNextObject () ;
    }
  }
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_3 (GALGAS_bool (kIsStrictSup, object->mAttribute_mMapStateList.reader_length (SOURCE_FILE_AT_LINE (822)).objectCompare (GALGAS_uint ((PMUInt32) 0U)))) ;
  ...
  while (enumerator_36925.hasCurrentObject ()) {
    ...
    { //-------- @modifierCallInstructionForGeneration
    var_readerMap.modifier_insertOrReplace (var_accessorName, GALGAS_bool (false), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (873)), inCompiler->here (), GALGAS_bool (true), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (877)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (870)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  while (enumerator_37570.hasCurrentObject ()) {
    ...
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertOrReplace (var_accessorName, var_accessorFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (893)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (889)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_uniqueMapType (SOURCE_FILE_AT_LINE (954))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
  ...
  while (enumerator_43115.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (var_inheritedReaderMap.reader_hasKey (enumerator_43115.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1010)) COMMA_SOURCE_FILE_AT_LINE (1010))) ;
    if (test_2.isValidAndTrue ()) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      ...
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (enumerator_43115.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_47947.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertOrReplace (enumerator_47947.current_mInsertModifierName (HERE), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1142)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1138)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1337)).reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1337)).objectCompare (GALGAS_char (TO_UNICODE (47))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_1 (var_absoluteSourcePath.reader_directoryExists (SOURCE_FILE_AT_LINE (1342)).operator_not (SOURCE_FILE_AT_LINE (1342))) ;
  if (test_1.isValidAndTrue ()) {
    ...
    inCompiler->emitSemanticError (location_2, GALGAS_string ("The '").operator_concat (var_absoluteSourcePath COMMA_SOURCE_FILE_AT_LINE (1343)).operator_concat (GALGAS_string ("' directory does not exist") COMMA_SOURCE_FILE_AT_LINE (1343)) COMMA_SOURCE_FILE_AT_LINE (1343)) ;
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popLast"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1440)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1443)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1439)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("prependValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1447)), var_modifierInputFormalArgumentList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1450)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1446)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsEqual, object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (1707)).objectCompare (GALGAS_string::makeEmptyString ()))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @assignmentInstructionForGeneration
    ...
    while (enumerator_69469.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_1 (GALGAS_bool (kIsEqual, enumerator_69469.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1716)).objectCompare (GALGAS_string ("generatedInSeparateFile")))) ;
      if (test_1.isValidAndTrue ()) {
        //-------- @assignmentInstructionForGeneration
    ...
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const GALGAS_bool test_2 (GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (1739))))) ;
    if (test_2.isValidAndTrue ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (object->mAttribute_mSuperClassName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the @").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (1740)) COMMA_SOURCE_FILE_AT_LINE (1740)).operator_concat (GALGAS_string (" should be a class type") COMMA_SOURCE_FILE_AT_LINE (1740)) COMMA_SOURCE_FILE_AT_LINE (1740)) ;
    }
    //-------- @assignmentInstructionForGeneration
    ...
    while (enumerator_70426.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (enumerator_70426.current_lkey (HERE), enumerator_70426.current_mParameterList (HERE), enumerator_70426.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1749)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1745)) ;
      } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_4 (object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (1784))) ;
  if (test_4.isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_5 (constinArgument_inCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (1850)) COMMA_SOURCE_FILE_AT_LINE (1850))) ;
  ...
  if (test_6.isValidAndTrue ()) {
    ...
    while (enumerator_75262.hasCurrentObject ()) {
      ...
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_75262.current_lkey (HERE), GALGAS_bool (true), var_formalArgumentList, enumerator_75262.current_lkey (HERE).reader_location (SOURCE_FILE_AT_LINE (1888)), GALGAS_bool (true), var_returnedType, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1891)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1884)) ;
      } //-------- END @typeMethodInstructionForGeneration
  ...
  while (enumerator_76224.hasCurrentObject ()) {
    ...
    while (enumerator_76484.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const GALGAS_bool test_7 (GALGAS_bool (kIsEqual, enumerator_76484.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1905)).objectCompare (GALGAS_string ("setter")))) ;
      if (test_7.isValidAndTrue ()) {
        //-------- @assignmentInstructionForGeneration
        var_hasSetter = GALGAS_bool (true) ;
      }else if (test_7.isValid ()) {
        //-------- @ifInstructionForGeneration
        const GALGAS_bool test_8 (GALGAS_bool (kIsEqual, enumerator_76484.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1907)).objectCompare (GALGAS_string ("nogetter")))) ;
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (2041))))) ;
  if (test_0.isValidAndTrue ()) {
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2042)) COMMA_SOURCE_FILE_AT_LINE (2042)).operator_concat (GALGAS_string ("' type should be a list type") COMMA_SOURCE_FILE_AT_LINE (2042)) COMMA_SOURCE_FILE_AT_LINE (2042)) ;
    //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_predefinedTypeAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_predefinedTypeAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mPredefinedTypeName COMMA_SOURCE_FILE_AT_LINE (2129)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2129)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2130)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_classDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (2141)) COMMA_SOURCE_FILE_AT_LINE (2141)), object->mAttribute_mClassTypeName.reader_location (SOURCE_FILE_AT_LINE (2141)) COMMA_SOURCE_FILE_AT_LINE (2141)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2142)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  if (test_0.isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2144)) COMMA_SOURCE_FILE_AT_LINE (2144)), object->mAttribute_mSuperClassName.reader_location (SOURCE_FILE_AT_LINE (2144)) COMMA_SOURCE_FILE_AT_LINE (2144)) COMMA_SOURCE_FILE_AT_LINE (2144)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_87188 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_87188.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_87188.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2147)) COMMA_SOURCE_FILE_AT_LINE (2147)), enumerator_87188.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2147)) COMMA_SOURCE_FILE_AT_LINE (2147)) COMMA_SOURCE_FILE_AT_LINE (2147)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_87188.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_listDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2159)) COMMA_SOURCE_FILE_AT_LINE (2159)), object->mAttribute_mListTypeName.reader_location (SOURCE_FILE_AT_LINE (2159)) COMMA_SOURCE_FILE_AT_LINE (2159)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2160)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_87953 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_87953.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_87953.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2162)) COMMA_SOURCE_FILE_AT_LINE (2162)), enumerator_87953.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2162)) COMMA_SOURCE_FILE_AT_LINE (2162)) COMMA_SOURCE_FILE_AT_LINE (2162)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_87953.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_structDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (2174)) COMMA_SOURCE_FILE_AT_LINE (2174)), object->mAttribute_mStructTypeName.reader_location (SOURCE_FILE_AT_LINE (2174)) COMMA_SOURCE_FILE_AT_LINE (2174)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2175)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_88724 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_88724.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_88724.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2177)) COMMA_SOURCE_FILE_AT_LINE (2177)), enumerator_88724.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2177)) COMMA_SOURCE_FILE_AT_LINE (2177)) COMMA_SOURCE_FILE_AT_LINE (2177)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_88724.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (2189)) COMMA_SOURCE_FILE_AT_LINE (2189)), object->mAttribute_mEnumTypeName.reader_location (SOURCE_FILE_AT_LINE (2189)) COMMA_SOURCE_FILE_AT_LINE (2189)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2190)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_sortedListDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2201)) COMMA_SOURCE_FILE_AT_LINE (2201)), object->mAttribute_mSortedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2201)) COMMA_SOURCE_FILE_AT_LINE (2201)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2202)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_90109 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_90109.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_90109.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2204)) COMMA_SOURCE_FILE_AT_LINE (2204)), enumerator_90109.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2204)) COMMA_SOURCE_FILE_AT_LINE (2204)) COMMA_SOURCE_FILE_AT_LINE (2204)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2230)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_91612 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_91612.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_91612.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2232)) COMMA_SOURCE_FILE_AT_LINE (2232)), enumerator_91612.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2232)) COMMA_SOURCE_FILE_AT_LINE (2232)) COMMA_SOURCE_FILE_AT_LINE (2232)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_91612.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_uniqueMapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2244)) COMMA_SOURCE_FILE_AT_LINE (2244)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2244)) COMMA_SOURCE_FILE_AT_LINE (2244)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2245)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_92380 (object->mAttribute_mAttributeList, true) ;
  //--- simple foreach instruction
  while (enumerator_92380.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_92380.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2247)) COMMA_SOURCE_FILE_AT_LINE (2247)), enumerator_92380.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2247)) COMMA_SOURCE_FILE_AT_LINE (2247)) COMMA_SOURCE_FILE_AT_LINE (2247)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
static void categoryMethod_mapProxyDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_mapProxyDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE_AT_LINE (2259)) COMMA_SOURCE_FILE_AT_LINE (2259)), object->mAttribute_mMapProxyTypeName.reader_location (SOURCE_FILE_AT_LINE (2259)) COMMA_SOURCE_FILE_AT_LINE (2259)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2260)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2261)) COMMA_SOURCE_FILE_AT_LINE (2261)), object->mAttribute_mAssociatedMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2261)) COMMA_SOURCE_FILE_AT_LINE (2261)) COMMA_SOURCE_FILE_AT_LINE (2261)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_graphDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_graphDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mGraphTypeName.reader_string (SOURCE_FILE_AT_LINE (2272)) COMMA_SOURCE_FILE_AT_LINE (2272)), object->mAttribute_mGraphTypeName.reader_location (SOURCE_FILE_AT_LINE (2272)) COMMA_SOURCE_FILE_AT_LINE (2272)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2273)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2274)) COMMA_SOURCE_FILE_AT_LINE (2274)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2274)) COMMA_SOURCE_FILE_AT_LINE (2274)) COMMA_SOURCE_FILE_AT_LINE (2274)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_externFunctionDeclarationAST) ;
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (object COMMA_SOURCE_FILE_AT_LINE (2285)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_onceFunctionDeclarationAST) ;
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (object COMMA_SOURCE_FILE_AT_LINE (2296)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_externRoutineDeclarationAST) ;
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (object COMMA_SOURCE_FILE_AT_LINE (2307)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_filewrapperDeclarationAST) ;
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (object COMMA_SOURCE_FILE_AT_LINE (2318)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_overridingCategoryMethodAST) ;
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (object COMMA_SOURCE_FILE_AT_LINE (2329)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_overridingAbstractCategoryReaderAST) ;
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (object COMMA_SOURCE_FILE_AT_LINE (2340)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_overridingAbstractCategoryMethodAST) ;
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (object COMMA_SOURCE_FILE_AT_LINE (2351)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_categoryReaderAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2362)) COMMA_SOURCE_FILE_AT_LINE (2362)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2362)).operator_concat (object->mAttribute_mCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2362)) COMMA_SOURCE_FILE_AT_LINE (2362)), object->mAttribute_mCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (2362)) COMMA_SOURCE_FILE_AT_LINE (2362)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2363)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2364)) COMMA_SOURCE_FILE_AT_LINE (2364)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (2364)) COMMA_SOURCE_FILE_AT_LINE (2364)) COMMA_SOURCE_FILE_AT_LINE (2364)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2366)) COMMA_SOURCE_FILE_AT_LINE (2366)).operator_not (SOURCE_FILE_AT_LINE (2366))) ;
  if (test_0.isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (2369)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2367)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_98629 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2372)) ;
  if (NULL != objectArray_98629) {
      macroValidSharedObject (objectArray_98629, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_98629->mAttribute_mCategoryReaderMapForType.modifier_insertOrReplace (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList COMMA_SOURCE_FILE_AT_LINE (2373)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_categoryMethodAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2389)) COMMA_SOURCE_FILE_AT_LINE (2389)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2389)).operator_concat (object->mAttribute_mCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (2389)) COMMA_SOURCE_FILE_AT_LINE (2389)), object->mAttribute_mCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (2389)) COMMA_SOURCE_FILE_AT_LINE (2389)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2390)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2391)) COMMA_SOURCE_FILE_AT_LINE (2391)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (2391)) COMMA_SOURCE_FILE_AT_LINE (2391)) COMMA_SOURCE_FILE_AT_LINE (2391)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2393)) COMMA_SOURCE_FILE_AT_LINE (2393)).operator_not (SOURCE_FILE_AT_LINE (2393))) ;
  if (test_0.isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (2396)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2394)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_99846 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2399)) ;
  if (NULL != objectArray_99846) {
      macroValidSharedObject (objectArray_99846, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_99846->mAttribute_mCategoryMethodMapForType.modifier_insertOrReplace (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2400)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_overridingCategoryReaderAST) ;
  //-------- @addAssignInstructionForGeneration
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (object COMMA_SOURCE_FILE_AT_LINE (2415)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_abstractCategoryReaderAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2426)) COMMA_SOURCE_FILE_AT_LINE (2426)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2426)).operator_concat (object->mAttribute_mAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2426)) COMMA_SOURCE_FILE_AT_LINE (2426)), object->mAttribute_mAbstractCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (2426)) COMMA_SOURCE_FILE_AT_LINE (2426)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2427)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2428)) COMMA_SOURCE_FILE_AT_LINE (2428)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (2428)) COMMA_SOURCE_FILE_AT_LINE (2428)) COMMA_SOURCE_FILE_AT_LINE (2428)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2430)) COMMA_SOURCE_FILE_AT_LINE (2430)).operator_not (SOURCE_FILE_AT_LINE (2430))) ;
  if (test_0.isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (2433)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2431)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_101564 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2436)) ;
  if (NULL != objectArray_101564) {
      macroValidSharedObject (objectArray_101564, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_101564->mAttribute_mCategoryReaderMapForType.modifier_insertOrReplace (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList COMMA_SOURCE_FILE_AT_LINE (2437)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_abstractCategoryMethodAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2453)) COMMA_SOURCE_FILE_AT_LINE (2453)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2453)).operator_concat (object->mAttribute_mAbstractCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (2453)) COMMA_SOURCE_FILE_AT_LINE (2453)), object->mAttribute_mAbstractCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (2453)) COMMA_SOURCE_FILE_AT_LINE (2453)) ;
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, object, inCompiler COMMA_SOURCE_FILE_AT_LINE (2454)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2455)) COMMA_SOURCE_FILE_AT_LINE (2455)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (2455)) COMMA_SOURCE_FILE_AT_LINE (2455)) COMMA_SOURCE_FILE_AT_LINE (2455)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const GALGAS_bool test_0 (ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2457)) COMMA_SOURCE_FILE_AT_LINE (2457)).operator_not (SOURCE_FILE_AT_LINE (2457))) ;
  if (test_0.isValidAndTrue ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (2460)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2458)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_102829 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2463)) ;
  if (NULL != objectArray_102829) {
      macroValidSharedObject (objectArray_102829, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_102829->mAttribute_mCategoryMethodMapForType.modifier_insertOrReplace (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2464)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
