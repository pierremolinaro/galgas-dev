...
//                    september 23th, 2010, at 15h51'56"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__genericTypeTypeAST__enterType (C_Compiler & inLexique,
                                const cPtr_genericTypeTypeAST * operand_19318,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_19318 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
    const GGS_bool cond_19638 = (operand_19318->mSuperTypeName).operator_isEqual (GGS_string ("")) ;
    if (cond_19638.isBuiltAndTrue ()) {
      var_cas_superTypeProxy = GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (461)) ;
    }else if (cond_19638.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_19318->mSuperTypeName, var_cas_superTypeProxy COMMA_SOURCE_FILE_AT_LINE (463)) ;
    }
...
category_method__objectPredefinedTypeAST__enterType (C_Compiler & inLexique,
                                const cPtr_objectPredefinedTypeAST * operand_20880,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_20880 != NULL) {
...
category_method__mapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_22191,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_22191 != NULL) {
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_22191->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (556)), var_cas_currentMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (556)) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_22191->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (564)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (564)) ;
    ::routine_enterConstructorWithArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("mapWithMapToOverride"),  operand_22191->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (565)),  operand_22191->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (565)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (565)) ;
    ...
    ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("overriddenMap"),  operand_22191->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (571)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (571)) ;
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_24835 (operand_22191->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_24835 = NULL ;
      while (((operand_24835 = enumerator_24835.nextObject ()))) {
        macroValidPointer (operand_24835) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_24835->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (583)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (583)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_24835->mAttributeName) ;
        var_cas_enumerationDescriptor.addAssign_operation (var_cas_attributeTypeIndex, operand_24835->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (585))) ;
    ...
    {
      GGS_insertMethodListAST::cEnumerator enumerator_25439 (operand_22191->mInsertMethodList, true) ;
      const GGS_insertMethodListAST::cElement * operand_25439 = NULL ;
      while (((operand_25439 = enumerator_25439.nextObject ()))) {
        macroValidPointer (operand_25439) ;
        const GGS_bool cond_25594 = var_cas_modifierMap.reader_hasKey (operand_25439->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (591))) ;
        if (cond_25594.isBuiltAndTrue ()) {
          operand_25439->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_25439->mMethodName)).operator_concat (GGS_string ("' insert method is already declared")) COMMA_SOURCE_FILE_AT_LINE (593)) ;
        }else if (cond_25594.isBuiltAndFalse ()) {
          var_cas_modifierMap.modifier_insertOrReplace (inLexique, operand_25439->mMethodName, var_cas_insertMethodFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (598)) COMMA_SOURCE_FILE_AT_LINE (594)) ;
        }
      }
    }
    {
      GGS_mapRemoveMethodListAST::cEnumerator enumerator_25838 (operand_22191->mRemoveMethodList, true) ;
      const GGS_mapRemoveMethodListAST::cElement * operand_25838 = NULL ;
      while (((operand_25838 = enumerator_25838.nextObject ()))) {
        macroValidPointer (operand_25838) ;
        const GGS_bool cond_26029 = var_cas_modifierMap.reader_hasKey (operand_25838->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (604))) ;
        if (cond_26029.isBuiltAndTrue ()) {
          operand_25838->mMethodName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '")).operator_concat (operand_25838->mMethodName)).operator_concat (GGS_string ("' method is already declared as an insert modifier or a remove modifier")) COMMA_SOURCE_FILE_AT_LINE (606)) ;
        }else if (cond_26029.isBuiltAndFalse ()) {
          var_cas_modifierMap.modifier_insertOrReplace (inLexique, operand_25838->mMethodName, var_cas_removeMethodFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (611)) COMMA_SOURCE_FILE_AT_LINE (607)) ;
        }
      }
    }
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_26271 (operand_22191->mSearchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_26271 = NULL ;
      while (((operand_26271 = enumerator_26271.nextObject ()))) {
        macroValidPointer (operand_26271) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_26271->mMethodName, GGS_bool (false), var_cas_removeMethodFormalArgumentList, operand_26271->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (621)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (623)) COMMA_SOURCE_FILE_AT_LINE (617)) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_26561 (operand_22191->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_26561 = NULL ;
      while (((operand_26561 = enumerator_26561.nextObject ()))) {
        macroValidPointer (operand_26561) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, (operand_26561->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (628))).operator_concat (GGS_string ("ForKey")), operand_26561->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (628)) COMMA_SOURCE_FILE_AT_LINE (628)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_26561->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (630)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (630)) ;
    ...
    const GGS_bool cond_27504 = (operand_22191->mInsertOrReplaceDeclarationListAST.reader_length ()).operator_supOrEqual (GGS_uint (1U)) ;
    if (cond_27504.isBuiltAndTrue ()) {
      GGS_location  var_cas_insertOrReplaceLocation ;
      if (operand_22191->mInsertOrReplaceDeclarationListAST.isBuilt ()) {
        operand_22191->mInsertOrReplaceDeclarationListAST (HERE)->method_first (inLexique, var_cas_insertOrReplaceLocation COMMA_SOURCE_FILE_AT_LINE (643)) ;
      }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_27589 (operand_22191->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_27589 = NULL ;
      while (((operand_27589 = enumerator_27589.nextObject ()))) {
        macroValidPointer (operand_27589) ;
        const GGS_lstring  var_cas_accessorName = GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_27589->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("ForKey")), operand_27589->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (653)) COMMA_SOURCE_FILE_AT_LINE (653)) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_27589->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (655)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (655)) ;
    ...
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_28532 (operand_22191->mSearchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_28532 = NULL ;
      while (((operand_28532 = enumerator_28532.nextObject ()))) {
        macroValidPointer (operand_28532) ;
        var_cas_withAccessorMap.modifier_insertKey (inLexique, operand_28532->mMethodName, var_cas_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (670)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
...
category_method__mapProxyDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_29652,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_29652 != NULL) {
    ...
    GGS_bool automatic_var_30161_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_30161_1 ;
    GGS_typedAttributeList  automatic_var_30161_2 ;
    GGS_attributeMap  automatic_var_30161_3 ;
    GGS_constructorMap  automatic_var_30161_4 ;
    GGS_readerMap  automatic_var_30161_5 ;
    GGS_modifierMap  automatic_var_30161_6 ;
    GGS_instanceMethodMap  automatic_var_30161_7 ;
    GGS_classMethodMap  automatic_var_30161_8 ;
    GGS_enumerationDescriptorList  automatic_var_30161_9 ;
    GGS_uint  automatic_var_30161_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_30161_11 ;
    GGS_nativeAttributeList  automatic_var_30161_12 ;
    GGS_stringset  automatic_var_30161_13 ;
    GGS_lstringlist  automatic_var_30161_14 ;
    GGS_typedAttributeList  automatic_var_30161_15 ;
    GGS_mapSearchMethodListAST  automatic_var_30161_16 ;
    GGS_withAccessorMap  automatic_var_30161_17 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_29652->mAssociatedMapTypeName, automatic_var_30161_0, automatic_var_30161_1, var_cas_typeKindEnum, automatic_var_30161_2, automatic_var_30161_3, var_cas_mapTypedAttributeList, automatic_var_30161_4, automatic_var_30161_5, automatic_var_30161_6, automatic_var_30161_7, automatic_var_30161_8, automatic_var_30161_9, automatic_var_30161_10, automatic_var_30161_11, automatic_var_30161_12, automatic_var_30161_13, automatic_var_30161_14, automatic_var_30161_15, var_cas_searchMethodList, automatic_var_30161_16, automatic_var_30161_17 COMMA_SOURCE_FILE_AT_LINE (715)) ;
    }
    const GGS_bool cond_30378 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_mapType (inLexique COMMA_SOURCE_FILE_AT_LINE (725))) ;
    if (cond_30378.isBuiltAndTrue ()) {
      operand_29652->mAssociatedMapTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_29652->mAssociatedMapTypeName)).operator_concat (GGS_string (" should be a map type")) COMMA_SOURCE_FILE_AT_LINE (727)) ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_29652->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (737)), var_cas_associatedMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (737)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_29652->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (746)), var_cas_mapProxyTypeProxy COMMA_SOURCE_FILE_AT_LINE (746)) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("null"),  operand_29652->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (758)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (758)) ;
    ...
    {
      GGS_mapSearchMethodListAST::cEnumerator enumerator_32178 (var_cas_searchMethodList, true) ;
      const GGS_mapSearchMethodListAST::cElement * operand_32178 = NULL ;
      while (((operand_32178 = enumerator_32178.nextObject ()))) {
        macroValidPointer (operand_32178) ;
        var_cas_constructorMap.modifier_insertKey (inLexique, operand_32178->mMethodName, var_cas_constructorAttributeTypeList, GGS_bool (true), var_cas_mapProxyTypeProxy COMMA_SOURCE_FILE_AT_LINE (764)) ;
      }
    }
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_33144 (var_cas_mapTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_33144 = NULL ;
      while (((operand_33144 = enumerator_33144.nextObject ()))) {
        macroValidPointer (operand_33144) ;
        const GGS_bool cond_33551 = var_cas_inheritedReaderMap.reader_hasKey (operand_33144->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (781))) ;
        if (cond_33551.isBuiltAndTrue ()) {
          GGS_string var_cas_s = GGS_string ("") ;
          {
            GGS_stringset::cEnumerator enumerator_33252 (var_cas_inheritedReaderMap.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (783)), true) ;
            if (enumerator_33252 .hasCurrentObject ()) {
              bool _foreach_loop_33252 ;
              do{
                var_cas_s.appendCString ("'") ;
                var_cas_s.dotAssign_operation (enumerator_33252._key (HERE)) ;
                var_cas_s.appendCString ("'") ;
                enumerator_33252.next () ;
                _foreach_loop_33252 = (enumerator_33252 .hasCurrentObject ()) ;
                if (_foreach_loop_33252) {
                  var_cas_s.appendCString (", ") ;
                }
              }while (_foreach_loop_33252) ;
            }
          }
          operand_33144->mAttributeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the map has a associated map proxy, which has predefined readers: ")).operator_concat (var_cas_s)).operator_concat (GGS_string ("; you cannot use theses names for naming an attribute of this map")) COMMA_SOURCE_FILE_AT_LINE (789)) ;
        }else if (cond_33551.isBuiltAndFalse ()) {
          var_cas_readerMap.modifier_insertKey (inLexique, operand_33144->mAttributeName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (true), operand_33144->mAttributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (796)) COMMA_SOURCE_FILE_AT_LINE (790)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
...
category_method__enumDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_34855,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_34855 != NULL) {
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_34855->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (844)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (844)) ;
    GGS_stringset  var_cas_constantSet = GGS_stringset ::constructor_emptySet () ;
    {
      GGS_lstringlist::cEnumerator enumerator_35514 (operand_34855->mConstantList, true) ;
      const GGS_lstringlist::cElement * operand_35514 = NULL ;
      while (((operand_35514 = enumerator_35514.nextObject ()))) {
        macroValidPointer (operand_35514) ;
        var_cas_constantSet.addAssign_operation (operand_35514->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (848))) ;
        ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  operand_35514->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (849)),  operand_34855->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (849)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (849)) ;
      }
    }
    {
      GGS_enumMessageListAST::cEnumerator enumerator_35744 (operand_34855->mEnumMessageList, true) ;
      const GGS_enumMessageListAST::cElement * operand_35744 = NULL ;
      while (((operand_35744 = enumerator_35744.nextObject ()))) {
        macroValidPointer (operand_35744) ;
        ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_35744->mEnumMessageName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (853)),  GGS_string ("string"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (853)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
...
category_method__filewrapperDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_filewrapperDeclarationAST * operand_36951,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_36951 != NULL) {
    ...
    {
      GGS_filewrapperTemplateListAST::cEnumerator enumerator_37223 (operand_36951->mFilewrapperTemplateList, true) ;
      const GGS_filewrapperTemplateListAST::cElement * operand_37223 = NULL ;
      while (((operand_37223 = enumerator_37223.nextObject ()))) {
        macroValidPointer (operand_37223) ;
        GGS_unifiedTypeMapProxyList  var_cas_templateSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
        {
          GGS_formalInputParameterListAST::cEnumerator enumerator_37341 (operand_37223->mFilewrapperTemplateFormalInputParameters, true) ;
          const GGS_formalInputParameterListAST::cElement * operand_37341 = NULL ;
          while (((operand_37341 = enumerator_37341.nextObject ()))) {
            ...
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_37341->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (897)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (897)) ;
            var_cas_templateSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
          }
        }
        var_cas_filewrapperTemplateMap.modifier_insertKey (inLexique, operand_37223->mFilewrapperTemplateName, var_cas_templateSignature, operand_37223->mFilewrapperTemplatePath COMMA_SOURCE_FILE_AT_LINE (900)) ;
      }
    }
    var_cas_ioSemanticContext.mFilewrapperMap.modifier_insertKey (inLexique, operand_36951->mFilewrapperName, operand_36951->mFilewrapperPath, operand_36951->mFilewrapperExtensionList, var_cas_filewrapperTemplateMap COMMA_SOURCE_FILE_AT_LINE (906)) ;
  }
}
...
category_method__listDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_38042,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_38042 != NULL) {
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_38313 (operand_38042->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_38313 = NULL ;
      while (((operand_38313 = enumerator_38313.nextObject ()))) {
        macroValidPointer (operand_38313) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_38313->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (925)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (925)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_38313->mAttributeName) ;
      }
    }
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_38042->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (933)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (933)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_39230 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_39230 = NULL ;
      while (((operand_39230 = enumerator_39230.nextObject ()))) {
        macroValidPointer (operand_39230) ;
        var_cas_enumerationDescriptor.addAssign_operation (operand_39230->mAttributeTypeIndex, operand_39230->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (940))) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_39230->mAttributeTypeIndex) ;
        var_cas_modifierOutputFormalArgumentList.addAssign_operation (operand_39230->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentOut (inLexique COMMA_SOURCE_FILE_AT_LINE (942))) ;
        var_cas_modifierInputFormalArgumentList.addAssign_operation (operand_39230->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (943))) ;
      }
    }
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyList"),  operand_38042->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (947)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (947)) ;
    ...
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListFromIndex"),  GGS_string ("uint"),  operand_38042->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (957)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (957)) ;
    ::routine_enterBaseReaderWith2Arguments (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("subListWithRange"),  GGS_string ("uint"),  GGS_string ("uint"),  operand_38042->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (958)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (958)) ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_40400 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_40400 = NULL ;
      while (((operand_40400 = enumerator_40400.nextObject ()))) {
        macroValidPointer (operand_40400) ;
        var_cas_readerMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, (operand_40400->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (961))).operator_concat (GGS_string ("AtIndex")), operand_40400->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (961)) COMMA_SOURCE_FILE_AT_LINE (961)), GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_listWithValue (var_cas_uintType), GGS_bool (true), operand_40400->mAttributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (966)) COMMA_SOURCE_FILE_AT_LINE (960)) ;
      }
    }
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_41268 (var_cas_typedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_41268 = NULL ;
      while (((operand_41268 = enumerator_41268.nextObject ()))) {
        macroValidPointer (operand_41268) ;
        GGS_formalParameterSignature  var_cas_setterFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        var_cas_setterFormalArgumentList.addAssign_operation (operand_41268->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentConstantIn (inLexique COMMA_SOURCE_FILE_AT_LINE (991))) ;
        ...
        var_cas_modifierMap.modifier_insertOrReplace (inLexique, GGS_lstring ::constructor_new (inLexique, ((GGS_string ("set")).operator_concat (operand_41268->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ())).operator_concat (GGS_string ("AtIndex")), operand_41268->mAttributeName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (994)) COMMA_SOURCE_FILE_AT_LINE (994)), var_cas_setterFormalArgumentList, GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (997)) COMMA_SOURCE_FILE_AT_LINE (993)) ;
      }
    }
...
category_method__sortedListDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_43358,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_43358 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    ...
    GGS_unifiedTypeMapProxy  var_cas_listTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_43358->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1058)), var_cas_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (1058)) ;
    GGS_enumerationDescriptorList  var_cas_enumerationDescriptor = GGS_enumerationDescriptorList ::constructor_emptyList () ;
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    GGS_formalParameterSignature  var_cas_modifierFormalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_44152 (operand_43358->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_44152 = NULL ;
      while (((operand_44152 = enumerator_44152.nextObject ()))) {
        macroValidPointer (operand_44152) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_44152->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1066)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1066)) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_44152->mAttributeName) ;
        var_cas_enumerationDescriptor.addAssign_operation (var_cas_attributeTypeIndex, operand_44152->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1068))) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptySortedList"),  operand_43358->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1074)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1074)) ;
...
category_method__structDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_47123,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_47123 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_structTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_47123->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1155)), var_cas_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (1155)) ;
    ...
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_47748 (operand_47123->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_47748 = NULL ;
      while (((operand_47748 = enumerator_47748.nextObject ()))) {
        macroValidPointer (operand_47748) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_47748->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1163)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1163)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_47748->mAttributeName) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_47748->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1166)) ;
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_48338 (operand_47123->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_48338 = NULL ;
      while (((operand_48338 = enumerator_48338.nextObject ()))) {
        macroValidPointer (operand_48338) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_48338->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1178)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1178)) ;
        ::routine_enterBaseFinalReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_48338->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1182)),  operand_48338->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1183)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1179)) ;
      }
    }
...
category_method__classDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_49952,
                                const GGS_multiMethodMapForBuildingContext   var_cas_inMultiMethodMapForBuildingContext,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_49952 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    ...
    const GGS_bool cond_50926 = (operand_49952->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1239))).operator_isEqual (GGS_string ("")) ;
    if (cond_50926.isBuiltAndTrue ()) {
    ...
    }else if (cond_50926.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_49952->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1247)), var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (1247)) ;
      GGS_typeKindEnum var_cas_typeKindEnum ;
      GGS_readerMap  var_cas_inheritedReaderMap ;
      GGS_modifierMap  var_cas_inheritedModifierMap ;
      GGS_bool automatic_var_51420_0 ;
      GGS_unifiedTypeMapProxy  automatic_var_51420_1 ;
      GGS_typedAttributeList  automatic_var_51420_2 ;
      GGS_constructorMap  automatic_var_51420_3 ;
      GGS_classMethodMap  automatic_var_51420_4 ;
      GGS_enumerationDescriptorList  automatic_var_51420_5 ;
      GGS_uint  automatic_var_51420_6 ;
      GGS_unifiedTypeMapProxyList  automatic_var_51420_7 ;
      GGS_nativeAttributeList  automatic_var_51420_8 ;
      GGS_stringset  automatic_var_51420_9 ;
      GGS_lstringlist  automatic_var_51420_10 ;
      GGS_typedAttributeList  automatic_var_51420_11 ;
      GGS_mapSearchMethodListAST  automatic_var_51420_12 ;
      GGS_mapSearchMethodListAST  automatic_var_51420_13 ;
      GGS_withAccessorMap  automatic_var_51420_14 ;
      if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
        var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_49952->mSuperClassName, automatic_var_51420_0, automatic_var_51420_1, var_cas_typeKindEnum, var_cas_inheritedTypedAttributeList, var_cas_attributeMap, automatic_var_51420_2, automatic_var_51420_3, var_cas_inheritedReaderMap, var_cas_inheritedModifierMap, var_cas_inheritedInstanceMethodMap, automatic_var_51420_4, automatic_var_51420_5, automatic_var_51420_6, automatic_var_51420_7, automatic_var_51420_8, automatic_var_51420_9, automatic_var_51420_10, automatic_var_51420_11, automatic_var_51420_12, automatic_var_51420_13, automatic_var_51420_14 COMMA_SOURCE_FILE_AT_LINE (1251)) ;
      }
      const GGS_bool cond_51577 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1264))) ;
      if (cond_51577.isBuiltAndTrue ()) {
        operand_49952->mSuperClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_49952->mSuperClassName)).operator_concat (GGS_string (" should be a class type")) COMMA_SOURCE_FILE_AT_LINE (1266)) ;
      }
      ...
      {
        GGS_readerMap::cEnumerator enumerator_51987 (var_cas_inheritedReaderMap, true) ;
        const GGS_readerMap::cElement * operand_51987 = NULL ;
        while (((operand_51987 = enumerator_51987.nextObject ()))) {
          macroValidPointer (operand_51987) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_51987->mKey, operand_51987->mInfo.mIsCategory, operand_51987->mInfo.mArgumentTypeList, operand_51987->mInfo.mHasCompilerArgument, operand_51987->mInfo.mReturnedType, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1286)) COMMA_SOURCE_FILE_AT_LINE (1280)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_52377 (var_cas_inheritedTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_52377 = NULL ;
      while (((operand_52377 = enumerator_52377.nextObject ()))) {
        macroValidPointer (operand_52377) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_52377->mAttributeTypeIndex) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_52480 (operand_49952->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_52480 = NULL ;
      while (((operand_52480 = enumerator_52480.nextObject ()))) {
        macroValidPointer (operand_52480) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_52480->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1297)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1297)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_52480->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1299)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_classIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_49952->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1303)), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1303)) ;
    ...
    const GGS_bool cond_53206 = (operand_49952->mIsAbstract).operator_not () ;
    if (cond_53206.isBuiltAndTrue ()) {
    ...
    {
      GGS_instanceMethodMap::cEnumerator enumerator_53337 (var_cas_inheritedInstanceMethodMap, true) ;
      const GGS_instanceMethodMap::cElement * operand_53337 = NULL ;
      while (((operand_53337 = enumerator_53337.nextObject ()))) {
        macroValidPointer (operand_53337) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_53337->mKey, GGS_bool (false), operand_53337->mInfo.mParameterList, operand_53337->mInfo.mDeclarationLocation, operand_53337->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1323)) COMMA_SOURCE_FILE_AT_LINE (1317)) ;
      }
    }
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_53633 (operand_49952->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_53633 = NULL ;
      while (((operand_53633 = enumerator_53633.nextObject ()))) {
        macroValidPointer (operand_53633) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_53722 (operand_53633->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_53722 = NULL ;
          while (((operand_53722 = enumerator_53722.nextObject ()))) {
            macroValidPointer (operand_53722) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_53722->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1331)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1331)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_53722->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_54003 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_53633->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1334))) ;
        if (NULL != operand_54003) {
          operand_54003->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1335)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_53633->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_53633->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1341)), GGS_bool (true), GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1343)) COMMA_SOURCE_FILE_AT_LINE (1337)) ;
        }
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_54420 (operand_49952->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_54420 = NULL ;
      while (((operand_54420 = enumerator_54420.nextObject ()))) {
        macroValidPointer (operand_54420) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_54509 (operand_54420->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_54509 = NULL ;
          while (((operand_54509 = enumerator_54509.nextObject ()))) {
            macroValidPointer (operand_54509) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54509->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1352)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1352)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_54509->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_54790 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_54420->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1355))) ;
        if (NULL != operand_54790) {
          operand_54790->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverriding (inLexique COMMA_SOURCE_FILE_AT_LINE (1356)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_54420->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_54420->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1362)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1364)) COMMA_SOURCE_FILE_AT_LINE (1358)) ;
        }
      }
    }
    const GGS_bool cond_56006 = var_cas_inMultiMethodMapForBuildingContext.reader_hasKey (operand_49952->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1369))) ;
    if (cond_56006.isBuiltAndTrue ()) {
      GGS_multiMethodMapForType  var_cas_multiMethodMapForType ;
      if (var_cas_inMultiMethodMapForBuildingContext.isBuilt ()) {
        var_cas_inMultiMethodMapForBuildingContext (HERE)->method_searchKey (inLexique, operand_49952->mClassTypeName, var_cas_multiMethodMapForType COMMA_SOURCE_FILE_AT_LINE (1371)) ;
      }
      {
        GGS_multiMethodMapForType::cEnumerator enumerator_55425 (var_cas_multiMethodMapForType, true) ;
        const GGS_multiMethodMapForType::cElement * operand_55425 = NULL ;
        while (((operand_55425 = enumerator_55425.nextObject ()))) {
          macroValidPointer (operand_55425) ;
          GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
          {
            GGS_formalParameterListAST::cEnumerator enumerator_55528 (operand_55425->mInfo.mFormalParameterList, true) ;
            const GGS_formalParameterListAST::cElement * operand_55528 = NULL ;
            while (((operand_55528 = enumerator_55528.nextObject ()))) {
              macroValidPointer (operand_55528) ;
              GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
              GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_55528->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1376)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1376)) ;
              var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_55528->mFormalArgumentPassingMode) ;
            }
          }
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_55425->mKey, GGS_bool (true), var_cas_formalArgumentList, operand_55425->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1383)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1385)) COMMA_SOURCE_FILE_AT_LINE (1379)) ;
        }
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_56206 (operand_49952->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_56206 = NULL ;
      while (((operand_56206 = enumerator_56206.nextObject ()))) {
        macroValidPointer (operand_56206) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56206->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1394)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1394)) ;
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_56206->mAttributeName) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_56206->mAttributeName) ;
        var_cas_readerMap.modifier_insertKey (inLexique, operand_56206->mAttributeName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1403)) COMMA_SOURCE_FILE_AT_LINE (1397)) ;
      }
    }
    const GGS_bool cond_57240 = (operand_49952->mIsAbstract).operator_not () ;
    if (cond_57240.isBuiltAndTrue ()) {
      {
        GGS_typedAttributeList::cEnumerator enumerator_56891 (var_cas_allTypedAttributeList, true) ;
        const GGS_typedAttributeList::cElement * operand_56891 = NULL ;
        while (((operand_56891 = enumerator_56891.nextObject ()))) {
          macroValidPointer (operand_56891) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_56891->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1410)), GGS_formalParameterSignature ::constructor_listWithValue (operand_56891->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1411))), GGS_bool (false), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1413)) COMMA_SOURCE_FILE_AT_LINE (1409)) ;
        }
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_49952->mClassTypeName, (operand_49952->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1422)), var_cas_allTypedAttributeList, var_cas_attributeMap, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1430)), GGS_enumerationDescriptorList ::constructor_emptyList (), ((function_generateCppConstructorWithAllAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1432))).operator_or (function_generateVirtualDestructor (inLexique COMMA_SOURCE_FILE_AT_LINE (1432)))).operator_or (((operand_49952->mIsAbstract).isBuiltAndTrue () ? (GGS_uint (0U)) : (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1432))))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_currentClassTypedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1440)) COMMA_SOURCE_FILE_AT_LINE (1418)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_58251,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_58251 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_58517 (operand_58251->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_58517 = NULL ;
      while (((operand_58517 = enumerator_58517.nextObject ()))) {
        macroValidPointer (operand_58517) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_58517->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1454)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1454)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_58517->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_58251->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1458)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_59050,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_59050 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_59317 (operand_59050->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_59317 = NULL ;
      while (((operand_59317 = enumerator_59317.nextObject ()))) {
        macroValidPointer (operand_59317) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_59317->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1471)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1471)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_59050->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1476)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1476)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_59050->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1478)) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_60017,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60017 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_60017->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1489)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1489)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_60017->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1491)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_60610,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60610 != NULL) {
    ...
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_61075_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_61075_1 ;
    GGS_attributeMap  automatic_var_61075_2 ;
    GGS_typedAttributeList  automatic_var_61075_3 ;
    GGS_constructorMap  automatic_var_61075_4 ;
    GGS_readerMap  automatic_var_61075_5 ;
    GGS_modifierMap  automatic_var_61075_6 ;
    GGS_instanceMethodMap  automatic_var_61075_7 ;
    GGS_classMethodMap  automatic_var_61075_8 ;
    GGS_enumerationDescriptorList  automatic_var_61075_9 ;
    GGS_uint  automatic_var_61075_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_61075_11 ;
    GGS_nativeAttributeList  automatic_var_61075_12 ;
    GGS_stringset  automatic_var_61075_13 ;
    GGS_lstringlist  automatic_var_61075_14 ;
    GGS_typedAttributeList  automatic_var_61075_15 ;
    GGS_mapSearchMethodListAST  automatic_var_61075_16 ;
    GGS_mapSearchMethodListAST  automatic_var_61075_17 ;
    GGS_withAccessorMap  automatic_var_61075_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_60610->mAssociatedListTypeName, automatic_var_61075_0, automatic_var_61075_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_61075_2, automatic_var_61075_3, automatic_var_61075_4, automatic_var_61075_5, automatic_var_61075_6, automatic_var_61075_7, automatic_var_61075_8, automatic_var_61075_9, automatic_var_61075_10, automatic_var_61075_11, automatic_var_61075_12, automatic_var_61075_13, automatic_var_61075_14, automatic_var_61075_15, automatic_var_61075_16, automatic_var_61075_17, automatic_var_61075_18 COMMA_SOURCE_FILE_AT_LINE (1504)) ;
    }
    const GGS_bool cond_61304 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1511))) ;
    if (cond_61304.isBuiltAndTrue ()) {
      operand_60610->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_60610->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1513)) ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_60610->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1522)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1522)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_60610->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1525)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1525)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    ...
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("listForKey"),  GGS_string ("string"),  operand_60610->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1533)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1533)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_60610->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1535)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1535)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_63091 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_63091 = NULL ;
      while (((operand_63091 = enumerator_63091.nextObject ()))) {
        macroValidPointer (operand_63091) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_63091->mAttributeTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_predefinedTypeAST * operand_65104,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_65104 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_65104 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation ((findCategoryReader__predefinedTypeAST__getSuperTypeName (var_cas_t (HERE)->galgasRTTI ()) (inLexique, var_cas_t.getPtr () COMMA_SOURCE_FILE_AT_LINE (1602))), operand_65104->mPredefinedTypeName, operand_65104) ;
  }
}
...
category_method__objectPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_objectPredefinedTypeAST * operand_65487,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_65487 != NULL) {
    GGS_objectPredefinedTypeAST  var_cas_t = operand_65487 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string ("object"), operand_65487) ;
  }
}
...
category_method__stringsetPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_stringsetPredefinedTypeAST * operand_65850,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_65850 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enumerable"), operand_65850->mPredefinedTypeName, operand_65850) ;
  }
}
...
category_method__genericTypeTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_genericTypeTypeAST * operand_66169,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_66169 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_66169->mSuperTypeName, operand_66169->mTypeName, operand_66169) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_66481,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_66481 != NULL) {
    const GGS_string var_cas_actualSuperTypeName = (((operand_66481->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1635))).operator_isEqual (GGS_string (""))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_66481->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1635)))) ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (var_cas_actualSuperTypeName, operand_66481->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1636)), operand_66481) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_66933,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_66933 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("list"), operand_66933->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1644)), operand_66933) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_67251,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_67251 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("struct"), operand_67251->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1652)), operand_67251) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_67571,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_67571 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enum"), operand_67571->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)), operand_67571) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_67893,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_67893 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("sortedlist"), operand_67893->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1668)), operand_67893) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_68224,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_68224 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_68224->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1676)), operand_68224->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1676)), operand_68224) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_68568,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_68568 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("map"), operand_68568->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1684)), operand_68568) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_68886,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_68886 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_68886->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1692)), operand_68886->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1692)), operand_68886) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externFunctionDeclarationAST * operand_69241,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_69241 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_69241) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externRoutineDeclarationAST * operand_69542,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_69542 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_69542) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_70478 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_70478 = NULL ;
    while (((operand_70478 = enumerator_70478.nextObject ()))) {
      macroValidPointer (operand_70478) ;
      { typeCategoryMethod__semanticDeclarationAST__collectTypes method = findCategoryMethod__semanticDeclarationAST__collectTypes (operand_70478->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_70478->mSemanticDeclaration (HERE), var_cas_collectedTypeMap, var_cas_multiMethodMapForBuildingContext COMMA_SOURCE_FILE_AT_LINE (1726)) ;
        }
      }
    }
  }
  ...
  const GGS_bool cond_70990 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_70990.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_70853 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_70853 = NULL ;
      while (((operand_70853 = enumerator_70853.nextObject ()))) {
        macroValidPointer (operand_70853) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_70853->mValue) ;
      }
    }
  ...
  }else if (cond_70990.isBuiltAndFalse ()) {
    const GGS_bool cond_71292 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_71292.isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_71156 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_71156 = NULL ;
        while (((operand_71156 = enumerator_71156.nextObject ()))) {
          macroValidPointer (operand_71156) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_71156->mValue) ;
        }
      }
      ...
      var_cas_outSemanticContext.drop () ;
    }else if (cond_71292.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_71655 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_71655 = NULL ;
        while (((operand_71655 = enumerator_71655.nextObject ()))) {
          macroValidPointer (operand_71655) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_71655->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_71655->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (1752)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_72769 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_72769 (_variant_72769.isBuilt (), true) ;
      while (_condition_72769.isBuiltAndTrue ()) {
        _condition_72769 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_72769.isBuiltAndTrue ()) {
          if (_variant_72769.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1773)) ;
            _condition_72769 = GGS_bool (false) ;
          }else{
            _variant_72769.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_72384 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_72384 = NULL ;
              while (((operand_72384 = enumerator_72384.nextObject ()))) {
                macroValidPointer (operand_72384) ;
                const GGS_bool cond_72612 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_72384->mDependanceString) ;
                if (cond_72612.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_72384->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_72384->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_72612.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_72384->mDependanceString, operand_72384->mTypeString, operand_72384->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_73392 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_73392.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_73051 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_73051 = enumerator_73051.nextObject () ;
          if ((operand_73051 != NULL)) {
            bool _foreach_loop_73051 ;
            do{
              macroValidPointer (operand_73051) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_73051->mTypeString) ;
              operand_73051 = enumerator_73051.nextObject () ;
              _foreach_loop_73051 = ((operand_73051 != NULL)) ;
              if (_foreach_loop_73051) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_73051) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_73224 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_73224 = NULL ;
          while (((operand_73224 = enumerator_73224.nextObject ()))) {
            macroValidPointer (operand_73224) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_73224->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_73224->mDependanceString) ;
          }
        }
        ...
        var_cas_outSemanticContext.drop () ;
      }else if (cond_73392.isBuiltAndFalse ()) {
        ...
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_73808 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_73808 = NULL ;
          while (((operand_73808 = enumerator_73808.nextObject ()))) {
            macroValidPointer (operand_73808) ;
            { typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (operand_73808->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_73808->mSemanticDeclaration (HERE), var_cas_multiMethodMapForBuildingContext, var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (1798)) ;
              }
            }
          }
        }
