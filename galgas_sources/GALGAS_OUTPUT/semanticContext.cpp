...
//                    september 26th, 2010, at 19h29'43"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
category_method__sortedListDeclarationAST__enterType (C_Compiler & inLexique,
  ...
  if (operand_39676 != NULL) {
    ...
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("sortedlist"), var_cas_superTypeProxy COMMA_SOURCE_FILE_AT_LINE (1009)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_39676->mSortedListTypeName, GGS_bool (true), var_cas_superTypeProxy, GGS_typeKindEnum::constructor_sortedListType (inLexique COMMA_SOURCE_FILE_AT_LINE (1014)), var_cas_typedAttributeList, GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1016)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1022)), var_cas_enumerationDescriptor, ((((function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1024))).operator_or (function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1024)))).operator_or (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1024)))).operator_or (function_generateCppConstructorWithNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1025)))).operator_or (function_generateSortedListComparisonMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1025))), var_cas_constructorAttributeTypeList, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1033)) COMMA_SOURCE_FILE_AT_LINE (1010)) ;
  }
}
...
category_method__structDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_43441,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_43441 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_structTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_43441->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1046)), var_cas_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (1046)) ;
    GGS_attributeMap  var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1048)) ;
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1049)) ;
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_44066 (operand_43441->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_44066 = NULL ;
      while (((operand_44066 = enumerator_44066.nextObject ()))) {
        macroValidPointer (operand_44066) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_44066->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1054)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1054)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_44066->mAttributeName) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_44066->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1057)) ;
      }
    }
    var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1060)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (1059)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1066)) ;
    ::routine_enterBaseFinalReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("description"),  GGS_string ("string"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1067)) ;
    ::routine_enterBaseFinalReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("object"),  GGS_string ("object"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1068)) ;
    ::routine_enterBaseFinalReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("objectDynamicType"),  GGS_string ("type"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1069)) ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_44997 (operand_43441->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_44997 = NULL ;
      while (((operand_44997 = enumerator_44997.nextObject ()))) {
        macroValidPointer (operand_44997) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_44997->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1072)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1072)) ;
        ::routine_enterBaseFinalReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_44997->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1076)),  operand_44997->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1077)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1073)) ;
      }
    }
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1082)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1084)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_43441->mStructTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1089)), GGS_typeKindEnum::constructor_structType (inLexique COMMA_SOURCE_FILE_AT_LINE (1090)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_attributeMap, var_cas_typedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1098)), GGS_enumerationDescriptorList ::constructor_emptyList (), (function_generateCppConstructorWithCurrentAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1100))).operator_or (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1101))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_typedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1109)) COMMA_SOURCE_FILE_AT_LINE (1086)) ;
  }
}
...
category_method__classDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_46431,
                                const GGS_multiMethodMapForBuildingContext   var_cas_inMultiMethodMapForBuildingContext,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_46431 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("uint"), var_cas_uintType COMMA_SOURCE_FILE_AT_LINE (1121)) ;
    GGS_readerMap  var_cas_readerMap ;
    GGS_modifierMap  var_cas_modifierMap ;
    GGS_instanceMethodMap  var_cas_inheritedInstanceMethodMap ;
    GGS_typedAttributeList  var_cas_inheritedTypedAttributeList ;
    GGS_attributeMap  var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1127)) ;
    GGS_unifiedTypeMapProxy  var_cas_superClassIndex ;
    const GGS_bool cond_47356 = (operand_46431->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1130))).operator_isEqual (GGS_string ("")) ;
    if (cond_47356.isBuiltAndTrue ()) {
      var_cas_superClassIndex = GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1131)) ;
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1132)) ;
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1133)) ;
      var_cas_inheritedInstanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1134)) ;
      var_cas_inheritedTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
      var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1136)) ;
    }else if (cond_47356.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_46431->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1138)), var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (1138)) ;
      GGS_typeKindEnum var_cas_typeKindEnum ;
      GGS_readerMap  var_cas_inheritedReaderMap ;
      GGS_modifierMap  var_cas_inheritedModifierMap ;
      GGS_bool automatic_var_47850_0 ;
      GGS_unifiedTypeMapProxy  automatic_var_47850_1 ;
      GGS_typedAttributeList  automatic_var_47850_2 ;
      GGS_constructorMap  automatic_var_47850_3 ;
      GGS_classMethodMap  automatic_var_47850_4 ;
      GGS_enumerationDescriptorList  automatic_var_47850_5 ;
      GGS_uint  automatic_var_47850_6 ;
      GGS_unifiedTypeMapProxyList  automatic_var_47850_7 ;
      GGS_nativeAttributeList  automatic_var_47850_8 ;
      GGS_stringset  automatic_var_47850_9 ;
      GGS_lstringlist  automatic_var_47850_10 ;
      GGS_typedAttributeList  automatic_var_47850_11 ;
      GGS_mapSearchMethodListAST  automatic_var_47850_12 ;
      GGS_mapSearchMethodListAST  automatic_var_47850_13 ;
      GGS_withAccessorMap  automatic_var_47850_14 ;
      if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
        var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_46431->mSuperClassName, automatic_var_47850_0, automatic_var_47850_1, var_cas_typeKindEnum, var_cas_inheritedTypedAttributeList, var_cas_attributeMap, automatic_var_47850_2, automatic_var_47850_3, var_cas_inheritedReaderMap, var_cas_inheritedModifierMap, var_cas_inheritedInstanceMethodMap, automatic_var_47850_4, automatic_var_47850_5, automatic_var_47850_6, automatic_var_47850_7, automatic_var_47850_8, automatic_var_47850_9, automatic_var_47850_10, automatic_var_47850_11, automatic_var_47850_12, automatic_var_47850_13, automatic_var_47850_14 COMMA_SOURCE_FILE_AT_LINE (1142)) ;
      }
      const GGS_bool cond_48007 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1155))) ;
      if (cond_48007.isBuiltAndTrue ()) {
        operand_46431->mSuperClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_46431->mSuperClassName)).operator_concat (GGS_string (" should be a class type")) COMMA_SOURCE_FILE_AT_LINE (1157)) ;
      }
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1159)) ;
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1169)) ;
      {
        GGS_readerMap::cEnumerator enumerator_48417 (var_cas_inheritedReaderMap, true) ;
        const GGS_readerMap::cElement * operand_48417 = NULL ;
        while (((operand_48417 = enumerator_48417.nextObject ()))) {
          macroValidPointer (operand_48417) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_48417->mKey, operand_48417->mInfo.mIsCategory, operand_48417->mInfo.mArgumentTypeList, operand_48417->mInfo.mHasCompilerArgument, operand_48417->mInfo.mReturnedType, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1177)) COMMA_SOURCE_FILE_AT_LINE (1171)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_48807 (var_cas_inheritedTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_48807 = NULL ;
      while (((operand_48807 = enumerator_48807.nextObject ()))) {
        macroValidPointer (operand_48807) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_48807->mAttributeTypeIndex) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_48910 (operand_46431->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_48910 = NULL ;
      while (((operand_48910 = enumerator_48910.nextObject ()))) {
        macroValidPointer (operand_48910) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_48910->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1188)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1188)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_48910->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1190)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_classIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_46431->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1194)), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1194)) ;
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1196)) ;
    const GGS_bool cond_49636 = (operand_46431->mIsAbstract).operator_not () ;
    if (cond_49636.isBuiltAndTrue ()) {
      var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1199)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1198)) ;
    }
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1206)) ;
    {
      GGS_instanceMethodMap::cEnumerator enumerator_49767 (var_cas_inheritedInstanceMethodMap, true) ;
      const GGS_instanceMethodMap::cElement * operand_49767 = NULL ;
      while (((operand_49767 = enumerator_49767.nextObject ()))) {
        macroValidPointer (operand_49767) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_49767->mKey, GGS_bool (false), operand_49767->mInfo.mParameterList, operand_49767->mInfo.mDeclarationLocation, operand_49767->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1214)) COMMA_SOURCE_FILE_AT_LINE (1208)) ;
      }
    }
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_50063 (operand_46431->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_50063 = NULL ;
      while (((operand_50063 = enumerator_50063.nextObject ()))) {
        ...
        {
          GGS_formalParameterListAST::cEnumerator enumerator_50152 (operand_50063->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_50152 = NULL ;
          while (((operand_50152 = enumerator_50152.nextObject ()))) {
            macroValidPointer (operand_50152) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_50152->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1222)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1222)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_50152->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_50433 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_50063->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1225))) ;
        if (NULL != operand_50433) {
          operand_50433->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1226)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_50063->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_50063->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1232)), GGS_bool (true), GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1234)) COMMA_SOURCE_FILE_AT_LINE (1228)) ;
        }
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_50850 (operand_46431->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_50850 = NULL ;
      while (((operand_50850 = enumerator_50850.nextObject ()))) {
        macroValidPointer (operand_50850) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_50939 (operand_50850->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_50939 = NULL ;
          while (((operand_50939 = enumerator_50939.nextObject ()))) {
            macroValidPointer (operand_50939) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_50939->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1243)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1243)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_50939->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_51220 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_50850->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1246))) ;
        if (NULL != operand_51220) {
          operand_51220->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverriding (inLexique COMMA_SOURCE_FILE_AT_LINE (1247)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_50850->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_50850->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1253)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1255)) COMMA_SOURCE_FILE_AT_LINE (1249)) ;
        }
      }
    }
    const GGS_bool cond_52436 = var_cas_inMultiMethodMapForBuildingContext.reader_hasKey (operand_46431->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1260))) ;
    if (cond_52436.isBuiltAndTrue ()) {
      GGS_multiMethodMapForType  var_cas_multiMethodMapForType ;
      if (var_cas_inMultiMethodMapForBuildingContext.isBuilt ()) {
        var_cas_inMultiMethodMapForBuildingContext (HERE)->method_searchKey (inLexique, operand_46431->mClassTypeName, var_cas_multiMethodMapForType COMMA_SOURCE_FILE_AT_LINE (1262)) ;
      }
      {
        GGS_multiMethodMapForType::cEnumerator enumerator_51855 (var_cas_multiMethodMapForType, true) ;
        const GGS_multiMethodMapForType::cElement * operand_51855 = NULL ;
        while (((operand_51855 = enumerator_51855.nextObject ()))) {
          macroValidPointer (operand_51855) ;
          GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
          {
            GGS_formalParameterListAST::cEnumerator enumerator_51958 (operand_51855->mInfo.mFormalParameterList, true) ;
            const GGS_formalParameterListAST::cElement * operand_51958 = NULL ;
            while (((operand_51958 = enumerator_51958.nextObject ()))) {
              macroValidPointer (operand_51958) ;
              GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
              GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_51958->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1267)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1267)) ;
              var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_51958->mFormalArgumentPassingMode) ;
            }
          }
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_51855->mKey, GGS_bool (true), var_cas_formalArgumentList, operand_51855->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1274)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1276)) COMMA_SOURCE_FILE_AT_LINE (1270)) ;
        }
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_52636 (operand_46431->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_52636 = NULL ;
      while (((operand_52636 = enumerator_52636.nextObject ()))) {
        macroValidPointer (operand_52636) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_52636->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1285)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1285)) ;
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_52636->mAttributeName) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_52636->mAttributeName) ;
        var_cas_readerMap.modifier_insertKey (inLexique, operand_52636->mAttributeName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1294)) COMMA_SOURCE_FILE_AT_LINE (1288)) ;
      }
    }
    const GGS_bool cond_53670 = (operand_46431->mIsAbstract).operator_not () ;
    if (cond_53670.isBuiltAndTrue ()) {
      {
        GGS_typedAttributeList::cEnumerator enumerator_53321 (var_cas_allTypedAttributeList, true) ;
        const GGS_typedAttributeList::cElement * operand_53321 = NULL ;
        while (((operand_53321 = enumerator_53321.nextObject ()))) {
          macroValidPointer (operand_53321) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_53321->mAttributeName.ggs_string ().reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1301)), GGS_formalParameterSignature ::constructor_listWithValue (operand_53321->mAttributeTypeIndex, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1302))), GGS_bool (false), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1304)) COMMA_SOURCE_FILE_AT_LINE (1300)) ;
        }
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_46431->mClassTypeName, (operand_46431->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1313)), var_cas_allTypedAttributeList, var_cas_attributeMap, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1321)), GGS_enumerationDescriptorList ::constructor_emptyList (), (function_generateCppConstructorWithAllAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1323))).operator_or (((operand_46431->mIsAbstract).isBuiltAndTrue () ? (GGS_uint (0U)) : (function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1323))))), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_currentClassTypedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1331)) COMMA_SOURCE_FILE_AT_LINE (1309)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_54650,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_54650 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_54916 (operand_54650->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_54916 = NULL ;
      while (((operand_54916 = enumerator_54916.nextObject ()))) {
        macroValidPointer (operand_54916) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54916->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1345)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1345)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_54916->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_54650->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1349)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_55449,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_55449 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_55716 (operand_55449->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_55716 = NULL ;
      while (((operand_55716 = enumerator_55716.nextObject ()))) {
        macroValidPointer (operand_55716) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_55716->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1362)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1362)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_55449->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1367)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1367)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_55449->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1369)) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_56416,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_56416 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56416->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1380)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1380)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_56416->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1382)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_57009,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_57009 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_57474_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_57474_1 ;
    GGS_attributeMap  automatic_var_57474_2 ;
    GGS_typedAttributeList  automatic_var_57474_3 ;
    GGS_constructorMap  automatic_var_57474_4 ;
    GGS_readerMap  automatic_var_57474_5 ;
    GGS_modifierMap  automatic_var_57474_6 ;
    GGS_instanceMethodMap  automatic_var_57474_7 ;
    GGS_classMethodMap  automatic_var_57474_8 ;
    GGS_enumerationDescriptorList  automatic_var_57474_9 ;
    GGS_uint  automatic_var_57474_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_57474_11 ;
    GGS_nativeAttributeList  automatic_var_57474_12 ;
    GGS_stringset  automatic_var_57474_13 ;
    GGS_lstringlist  automatic_var_57474_14 ;
    GGS_typedAttributeList  automatic_var_57474_15 ;
    GGS_mapSearchMethodListAST  automatic_var_57474_16 ;
    GGS_mapSearchMethodListAST  automatic_var_57474_17 ;
    GGS_withAccessorMap  automatic_var_57474_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_57009->mAssociatedListTypeName, automatic_var_57474_0, automatic_var_57474_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_57474_2, automatic_var_57474_3, automatic_var_57474_4, automatic_var_57474_5, automatic_var_57474_6, automatic_var_57474_7, automatic_var_57474_8, automatic_var_57474_9, automatic_var_57474_10, automatic_var_57474_11, automatic_var_57474_12, automatic_var_57474_13, automatic_var_57474_14, automatic_var_57474_15, automatic_var_57474_16, automatic_var_57474_17, automatic_var_57474_18 COMMA_SOURCE_FILE_AT_LINE (1395)) ;
    }
    const GGS_bool cond_57703 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1402))) ;
    if (cond_57703.isBuiltAndTrue ()) {
      operand_57009->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_57009->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1404)) ;
      var_cas_listTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1407)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1408)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1409)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1410)) ;
    GGS_unifiedTypeMapProxy  var_cas_associatedListTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_57009->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1413)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1413)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_57009->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1416)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1416)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1419)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("count"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1421)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("allKeys"),  GGS_string ("stringset"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1422)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("keyList"),  GGS_string ("stringlist"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1423)) ;
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("listForKey"),  GGS_string ("string"),  operand_57009->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1424)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1424)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_57009->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1426)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1426)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_59490 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_59490 = NULL ;
      while (((operand_59490 = enumerator_59490.nextObject ()))) {
        macroValidPointer (operand_59490) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_59490->mAttributeTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_superTypeProxy ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("listmap"), var_cas_superTypeProxy COMMA_SOURCE_FILE_AT_LINE (1439)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_57009->mListmapTypeName, GGS_bool (true), var_cas_superTypeProxy, GGS_typeKindEnum::constructor_listMapType (inLexique COMMA_SOURCE_FILE_AT_LINE (1444)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1446)), var_cas_listTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1452)), var_cas_enumeratorDescriptor, (((function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (1454))).operator_or (function_generateCppConstructorWithNativeAttributeList (inLexique COMMA_SOURCE_FILE_AT_LINE (1454)))).operator_or (function_binaryConcatOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1454)))).operator_or (function_dotAssignOperator (inLexique COMMA_SOURCE_FILE_AT_LINE (1454))), var_cas_addAssignOperatorDescription, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1462)) COMMA_SOURCE_FILE_AT_LINE (1440)) ;
  }
}
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_61503,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61503 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_61503 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_61503->mPredefinedTypeName, operand_61503) ;
  }
}
...
category_method__objectPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_objectPredefinedTypeAST * operand_61868,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61868 != NULL) {
    GGS_objectPredefinedTypeAST  var_cas_t = operand_61868 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string ("object"), operand_61868) ;
  }
}
...
category_method__stringsetPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_stringsetPredefinedTypeAST * operand_62231,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62231 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62231->mPredefinedTypeName, operand_62231) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_62541,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62541 != NULL) {
    const GGS_string var_cas_actualSuperTypeName = operand_62541->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1518)) ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (var_cas_actualSuperTypeName, operand_62541->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1519)), operand_62541) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_62937,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62937 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62937->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1527)), operand_62937) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_63251,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63251 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_63251->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1535)), operand_63251) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_63565,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63565 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_63565->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1543)), operand_63565) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_63883,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63883 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_63883->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1551)), operand_63883) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_64204,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64204 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_64204->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1559)), operand_64204->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1559)), operand_64204) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_64548,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64548 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_64548->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1567)), operand_64548) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_64863,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64863 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_64863->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1575)), operand_64863->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1575)), operand_64863) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externFunctionDeclarationAST * operand_65218,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_65218 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_65218) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externRoutineDeclarationAST * operand_65519,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_65519 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_65519) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  #endif
  GGS_collectedTypeMap  var_cas_collectedTypeMap = GGS_collectedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1606)) ;
  GGS_multiMethodMapForBuildingContext  var_cas_multiMethodMapForBuildingContext = GGS_multiMethodMapForBuildingContext ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1607)) ;
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_66455 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_66455 = NULL ;
    while (((operand_66455 = enumerator_66455.nextObject ()))) {
      macroValidPointer (operand_66455) ;
      { typeCategoryMethod__semanticDeclarationAST__collectTypes method = findCategoryMethod__semanticDeclarationAST__collectTypes (operand_66455->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_66455->mSemanticDeclaration (HERE), var_cas_collectedTypeMap, var_cas_multiMethodMapForBuildingContext COMMA_SOURCE_FILE_AT_LINE (1609)) ;
        }
      }
    }
  }
  GGS_stringlist  var_cas_undefinedClasses = var_cas_collectedTypeMap.reader_unsolvedProxyKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1615)) ;
  const GGS_bool cond_66967 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_66967.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_66830 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_66830 = NULL ;
      while (((operand_66830 = enumerator_66830.nextObject ()))) {
        macroValidPointer (operand_66830) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_66830->mValue) ;
      }
    }
    var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (1622)) ;
    var_cas_outSemanticContext.drop () ;
  }else if (cond_66967.isBuiltAndFalse ()) {
    const GGS_bool cond_67269 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_67269.isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = ((GGS_string ("there are ")).operator_concat (var_cas_undefinedClasses.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1623)))).operator_concat (GGS_string (" undefined types:")) ;
      {
        GGS_stringlist::cEnumerator enumerator_67133 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_67133 = NULL ;
        while (((operand_67133 = enumerator_67133.nextObject ()))) {
          macroValidPointer (operand_67133) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_67133->mValue) ;
        }
      }
      var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (1628)) ;
      var_cas_outSemanticContext.drop () ;
    }else if (cond_67269.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_67632 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_67632 = NULL ;
        while (((operand_67632 = enumerator_67632.nextObject ()))) {
          macroValidPointer (operand_67632) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_67632->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_67632->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (1635)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_68746 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_68746 (_variant_68746.isBuilt (), true) ;
      while (_condition_68746.isBuiltAndTrue ()) {
        _condition_68746 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_68746.isBuiltAndTrue ()) {
          if (_variant_68746.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1656)) ;
            _condition_68746 = GGS_bool (false) ;
          }else{
            _variant_68746.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_68361 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_68361 = NULL ;
              while (((operand_68361 = enumerator_68361.nextObject ()))) {
                macroValidPointer (operand_68361) ;
                const GGS_bool cond_68589 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_68361->mDependanceString) ;
                if (cond_68589.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_68361->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_68361->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_68589.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_68361->mDependanceString, operand_68361->mTypeString, operand_68361->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_69369 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_69369.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_69028 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_69028 = enumerator_69028.nextObject () ;
          if ((operand_69028 != NULL)) {
            bool _foreach_loop_69028 ;
            do{
              macroValidPointer (operand_69028) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_69028->mTypeString) ;
              operand_69028 = enumerator_69028.nextObject () ;
              _foreach_loop_69028 = ((operand_69028 != NULL)) ;
              if (_foreach_loop_69028) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_69028) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_69201 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_69201 = NULL ;
          while (((operand_69201 = enumerator_69201.nextObject ()))) {
            macroValidPointer (operand_69201) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_69201->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_69201->mDependanceString) ;
          }
        }
        var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (1669)) ;
        var_cas_outSemanticContext.drop () ;
      }else if (cond_69369.isBuiltAndFalse ()) {
        var_cas_outSemanticContext = GGS_semanticContext::constructor_new (GGS_unifiedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1672)), GGS_routineMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1673)), GGS_functionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1674)), GGS_filewrapperMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1675)), GGS_grammarMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1676)), GGS_optionComponentMapForSemanticAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1677))) ;
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_69785 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_69785 = NULL ;
          while (((operand_69785 = enumerator_69785.nextObject ()))) {
            macroValidPointer (operand_69785) ;
            { typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (operand_69785->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_69785->mSemanticDeclaration (HERE), var_cas_multiMethodMapForBuildingContext, var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (1681)) ;
              }
            }
          }
        }
