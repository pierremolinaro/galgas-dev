...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_53897,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_53897 != NULL) {
    ...
    {
      GGS_formalParameterListAST::cEnumerator enumerator_54163 (operand_53897->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_54163 = NULL ;
      while (((operand_54163 = enumerator_54163.nextObject ()))) {
        macroValidPointer (operand_54163) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54163->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1335)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1335)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_54163->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_53897->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1339)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_54696,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_54696 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_54963 (operand_54696->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_54963 = NULL ;
      while (((operand_54963 = enumerator_54963.nextObject ()))) {
        macroValidPointer (operand_54963) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54963->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1352)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1352)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_54696->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1357)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1357)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_54696->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1359)) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_55663,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_55663 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_55663->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1370)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1370)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_55663->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1372)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_56256,
                                const GGS_multiMethodMapForBuildingContext   /* var_cas_inMultiMethodMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_56256 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_56721_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_56721_1 ;
    GGS_attributeMap  automatic_var_56721_2 ;
    GGS_typedAttributeList  automatic_var_56721_3 ;
    GGS_constructorMap  automatic_var_56721_4 ;
    GGS_readerMap  automatic_var_56721_5 ;
    GGS_modifierMap  automatic_var_56721_6 ;
    GGS_instanceMethodMap  automatic_var_56721_7 ;
    GGS_classMethodMap  automatic_var_56721_8 ;
    GGS_enumerationDescriptorList  automatic_var_56721_9 ;
    GGS_uint  automatic_var_56721_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_56721_11 ;
    GGS_nativeAttributeList  automatic_var_56721_12 ;
    GGS_stringset  automatic_var_56721_13 ;
    GGS_lstringlist  automatic_var_56721_14 ;
    GGS_typedAttributeList  automatic_var_56721_15 ;
    GGS_mapSearchMethodListAST  automatic_var_56721_16 ;
    GGS_mapSearchMethodListAST  automatic_var_56721_17 ;
    GGS_withAccessorMap  automatic_var_56721_18 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_56256->mAssociatedListTypeName, automatic_var_56721_0, automatic_var_56721_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_56721_2, automatic_var_56721_3, automatic_var_56721_4, automatic_var_56721_5, automatic_var_56721_6, automatic_var_56721_7, automatic_var_56721_8, automatic_var_56721_9, automatic_var_56721_10, automatic_var_56721_11, automatic_var_56721_12, automatic_var_56721_13, automatic_var_56721_14, automatic_var_56721_15, automatic_var_56721_16, automatic_var_56721_17, automatic_var_56721_18 COMMA_SOURCE_FILE_AT_LINE (1385)) ;
    }
    const GGS_bool cond_56950 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1392))) ;
    if (cond_56950.isBuiltAndTrue ()) {
      operand_56256->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_56256->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1394)) ;
    ...
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56256->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1403)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1403)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_56256->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1406)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1406)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    ...
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("listForKey"),  GGS_string ("string"),  operand_56256->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1414)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1414)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_56256->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1416)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1416)) ;
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_60622,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60622 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_60622 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_60622->mPredefinedTypeName, operand_60622) ;
  }
}
...
category_method__objectPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_objectPredefinedTypeAST * operand_60987,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_60987 != NULL) {
    GGS_objectPredefinedTypeAST  var_cas_t = operand_60987 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string ("object"), operand_60987) ;
  }
}
...
category_method__stringsetPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_stringsetPredefinedTypeAST * operand_61350,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61350 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_61350->mPredefinedTypeName, operand_61350) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_61660,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_61660 != NULL) {
    const GGS_string var_cas_actualSuperTypeName = operand_61660->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1506)) ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (var_cas_actualSuperTypeName, operand_61660->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1507)), operand_61660) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_62056,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62056 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62056->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1515)), operand_62056) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_62370,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62370 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62370->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1523)), operand_62370) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_62684,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_62684 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_62684->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1531)), operand_62684) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_63002,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63002 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_63002->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1539)), operand_63002) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_63323,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63323 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_63323->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1547)), operand_63323->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1547)), operand_63323) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_63667,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63667 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_63667->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1555)), operand_63667) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_63982,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_63982 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_63982->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1563)), operand_63982->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1563)), operand_63982) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externFunctionDeclarationAST * operand_64337,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64337 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_64337) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_externRoutineDeclarationAST * operand_64638,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_64638 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_64638) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_65574 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_65574 = NULL ;
    while (((operand_65574 = enumerator_65574.nextObject ()))) {
      macroValidPointer (operand_65574) ;
      { typeCategoryMethod__semanticDeclarationAST__collectTypes method = findCategoryMethod__semanticDeclarationAST__collectTypes (operand_65574->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_65574->mSemanticDeclaration (HERE), var_cas_collectedTypeMap, var_cas_multiMethodMapForBuildingContext COMMA_SOURCE_FILE_AT_LINE (1597)) ;
        }
      }
    }
  }
  ...
  const GGS_bool cond_66086 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_66086.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_65949 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_65949 = NULL ;
      while (((operand_65949 = enumerator_65949.nextObject ()))) {
        macroValidPointer (operand_65949) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_65949->mValue) ;
      }
    }
  ...
  }else if (cond_66086.isBuiltAndFalse ()) {
    const GGS_bool cond_66388 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_66388.isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_66252 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_66252 = NULL ;
        while (((operand_66252 = enumerator_66252.nextObject ()))) {
          macroValidPointer (operand_66252) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_66252->mValue) ;
        }
      }
      ...
      var_cas_outSemanticContext.drop () ;
    }else if (cond_66388.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_66751 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_66751 = NULL ;
        while (((operand_66751 = enumerator_66751.nextObject ()))) {
          macroValidPointer (operand_66751) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_66751->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_66751->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (1623)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_67865 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_67865 (_variant_67865.isBuilt (), true) ;
      while (_condition_67865.isBuiltAndTrue ()) {
        _condition_67865 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_67865.isBuiltAndTrue ()) {
          if (_variant_67865.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1644)) ;
            _condition_67865 = GGS_bool (false) ;
          }else{
            _variant_67865.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_67480 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_67480 = NULL ;
              while (((operand_67480 = enumerator_67480.nextObject ()))) {
                macroValidPointer (operand_67480) ;
                const GGS_bool cond_67708 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_67480->mDependanceString) ;
                if (cond_67708.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_67480->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_67480->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_67708.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_67480->mDependanceString, operand_67480->mTypeString, operand_67480->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_68488 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_68488.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_68147 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_68147 = enumerator_68147.nextObject () ;
          if ((operand_68147 != NULL)) {
            bool _foreach_loop_68147 ;
            do{
              macroValidPointer (operand_68147) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_68147->mTypeString) ;
              operand_68147 = enumerator_68147.nextObject () ;
              _foreach_loop_68147 = ((operand_68147 != NULL)) ;
              if (_foreach_loop_68147) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_68147) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_68320 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_68320 = NULL ;
          while (((operand_68320 = enumerator_68320.nextObject ()))) {
            macroValidPointer (operand_68320) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_68320->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_68320->mDependanceString) ;
          }
        }
        ...
        var_cas_outSemanticContext.drop () ;
      }else if (cond_68488.isBuiltAndFalse ()) {
        ...
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_68904 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_68904 = NULL ;
          while (((operand_68904 = enumerator_68904.nextObject ()))) {
            macroValidPointer (operand_68904) ;
            { typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (operand_68904->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_68904->mSemanticDeclaration (HERE), var_cas_multiMethodMapForBuildingContext, var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (1669)) ;
              }
            }
          }
        }
