...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147093 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147093.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_147093.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3573)) ;
    enumerator_147093.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147826 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147826.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_147826.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3585)) ;
    enumerator_147826.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_148246 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3594)), kEnumeration_up) ;
    while (enumerator_148246.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_148246.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_148246.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3595)) COMMA_SOURCE_FILE_AT_LINE (3595)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3595)) COMMA_SOURCE_FILE_AT_LINE (3595)) ;
      enumerator_148246.gotoNextObject () ;
    }
    ...
    GALGAS_lstringlist joker_148584_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_148584_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3599)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3605)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string ("semantic analysis not performed, ").operator_concat (var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3606)).reader_string (SOURCE_FILE_AT_LINE (3606)) COMMA_SOURCE_FILE_AT_LINE (3606)).operator_concat (GALGAS_string (" declarations are involved in circular definition:") COMMA_SOURCE_FILE_AT_LINE (3606)) ;
      cEnumerator_semanticDeclarationListAST enumerator_148979 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_148979.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_148979.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3608)) COMMA_SOURCE_FILE_AT_LINE (3608)) COMMA_SOURCE_FILE_AT_LINE (3608)) ;
        enumerator_148979.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (3610)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      var_sortedSemanticDeclarationListAST.dotAssign_operation (var_categoryOverrideDefinitionList COMMA_SOURCE_FILE_AT_LINE (3613)) ;
      outArgument_outSemanticContext = GALGAS_semanticContext::constructor_new (constinArgument_inSourceFile, GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3617)), GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3618)), GALGAS_functionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3619)), GALGAS_filewrapperMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3620)), GALGAS_grammarMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3621)), GALGAS_optionComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3622)), GALGAS_lexiqueComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3623)), GALGAS_optionMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3624)) COMMA_SOURCE_FILE_AT_LINE (3615)) ;
      cEnumerator_semanticDeclarationListAST enumerator_149787 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149787.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_149787.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3628)) ;
        enumerator_149787.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_89293 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_89293.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_89293.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2210)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_89293.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2213)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_89293.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2214)) ;
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_89293.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2215)) ;
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2216)), enumerator_89293.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2216)) ;
    enumerator_89293.gotoNextObject () ;
  }
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_93948 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_93948.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_93948.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2337)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_93948.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2338)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_93948.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2341)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_93948.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2342)) ;
    }
    enumerator_93948.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_94694 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_94694.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_94694.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2359)), enumerator_94694.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2360)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2356)) ;
    }
    enumerator_94694.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_95876 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_95876.hasCurrentObject () && bool_1) {
    while (enumerator_95876.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_95876.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2394)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_95876.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2394)).operator_not (SOURCE_FILE_AT_LINE (2394)) COMMA_SOURCE_FILE_AT_LINE (2394)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_95876.gotoNextObject () ;
      if (enumerator_95876.hasCurrentObject ()) {
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_98288 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_98288.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_98288.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2455)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
    ...
    GALGAS_bool joker_98767_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_98767_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_98852_2 ; // Joker input parameter
    GALGAS_constructorMap joker_98852_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_98942_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_98942_9 ; // Joker input parameter
    GALGAS_stringlist joker_98942_8 ; // Joker input parameter
    GALGAS_uint joker_98942_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_98942_6 ; // Joker input parameter
    GALGAS_stringset joker_98942_5 ; // Joker input parameter
    GALGAS_lstringlist joker_98942_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_98942_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_98942_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_98942_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_98989_2 ; // Joker input parameter
    GALGAS_string joker_98989_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_98767_2, joker_98767_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_98852_2, joker_98852_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_98942_10, joker_98942_9, joker_98942_8, joker_98942_7, joker_98942_6, joker_98942_5, joker_98942_4, joker_98942_3, joker_98942_2, joker_98942_1, var_generateHeaderInSeparateFile, joker_98989_2, joker_98989_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2465)) ;
    ...
    cEnumerator_modifierMap enumerator_99276 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_99276.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_99276.current_lkey (HERE), enumerator_99276.current_mKind (HERE), enumerator_99276.current_mParameterList (HERE), enumerator_99276.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2491)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2486)) ;
      }
      enumerator_99276.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2496)) ;
    cEnumerator_readerMap enumerator_99602 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_99602.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_99602.current_lkey (HERE), enumerator_99602.current_mKind (HERE), enumerator_99602.current_mArgumentTypeList (HERE), enumerator_99602.current_mDeclarationLocation (HERE), enumerator_99602.current_mHasCompilerArgument (HERE), enumerator_99602.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2505)), enumerator_99602.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2498)) ;
      }
      enumerator_99602.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2510)) ;
    cEnumerator_instanceMethodMap enumerator_99990 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_99990.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_99990.current_lkey (HERE), enumerator_99990.current_mKind (HERE), enumerator_99990.current_mParameterList (HERE), enumerator_99990.current_mDeclarationLocation (HERE), enumerator_99990.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2518)), enumerator_99990.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2512)) ;
      }
      enumerator_99990.gotoNextObject () ;
    }
  }
  ...
  cEnumerator_typedAttributeList enumerator_100421 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_100421.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_100421.current_mAttributeTypeProxy (HERE), enumerator_100421.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2526)) ;
    enumerator_100421.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_100548 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_100548.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_100548.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2530)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_100548.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2531)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_100548.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2532)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_100548.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2533)) COMMA_SOURCE_FILE_AT_LINE (2533)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_100548.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_100548.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2534)) COMMA_SOURCE_FILE_AT_LINE (2534)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader") COMMA_SOURCE_FILE_AT_LINE (2534)) COMMA_SOURCE_FILE_AT_LINE (2534)) ;
    }
    enumerator_100548.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_101648 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_101648.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_101648.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2558)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_101892 (enumerator_101648.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_101892.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_101892.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2562)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_101892.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2564)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_101892.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_101648.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2568)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_101648.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2569)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_101648.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2573)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2574)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2578)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2571)) ;
      }
    }
    enumerator_101648.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_102960 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_102960.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_102960.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_102960.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2593)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2593)) COMMA_SOURCE_FILE_AT_LINE (2593)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2593)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2594)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_102960.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2595)), enumerator_102960.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2595)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2597)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2592)) ;
      }
    }
    enumerator_102960.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_104002 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_104002.hasCurrentObject () && bool_12) {
    while (enumerator_104002.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_104002.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2621)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_104002.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2621)).operator_not (SOURCE_FILE_AT_LINE (2621)) COMMA_SOURCE_FILE_AT_LINE (2621)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_104002.gotoNextObject () ;
      if (enumerator_104002.hasCurrentObject ()) {
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_105665 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_105665.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_105665.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2666)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_105665.current_mFormalArgumentPassingMode (HERE), enumerator_105665.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2667)) ;
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_106673 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_106673.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_106673.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2685)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2686)) ;
    enumerator_106673.gotoNextObject () ;
  }
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2741)).isValid ()) {
    uint32_t variant_109430 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2741)).uintValue () ;
    bool loop_109430 = true ;
    while (loop_109430) {
      loop_109430 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2741)))).isValid () ;
      if (loop_109430) {
        loop_109430 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2741)))).boolValue () ;
      }
      if (loop_109430 && (0 == variant_109430)) {
        loop_109430 = false ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2780)).isValid ()) {
    uint32_t variant_110742 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2780)).uintValue () ;
    bool loop_110742 = true ;
    while (loop_110742) {
      loop_110742 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2780)))).isValid () ;
      if (loop_110742) {
        loop_110742 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2780)))).boolValue () ;
      }
      if (loop_110742 && (0 == variant_110742)) {
        loop_110742 = false ;
  ...
  {
  GALGAS_unifiedTypeMapProxy joker_111357_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_111357_2 ; // Joker input parameter
  GALGAS_string joker_111357_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_111357_3, joker_111357_2, joker_111357_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2800)) ;
  }
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_113779_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_113779_1 ; // Joker input parameter
  GALGAS_attributeMap joker_113867_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_113867_18 ; // Joker input parameter
  GALGAS_constructorMap joker_113867_17 ; // Joker input parameter
  GALGAS_readerMap joker_113867_16 ; // Joker input parameter
  GALGAS_modifierMap joker_113867_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_113867_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_113867_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_113867_12 ; // Joker input parameter
  GALGAS_stringlist joker_113867_11 ; // Joker input parameter
  GALGAS_uint joker_113867_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_113867_9 ; // Joker input parameter
  GALGAS_stringset joker_113867_8 ; // Joker input parameter
  GALGAS_lstringlist joker_113867_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_113867_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_113867_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_113867_4 ; // Joker input parameter
  GALGAS_bool joker_113867_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_113867_2 ; // Joker input parameter
  GALGAS_string joker_113867_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_113779_2, joker_113779_1, var_typeKindEnum, var_listTypedAttributeList, joker_113867_19, joker_113867_18, joker_113867_17, joker_113867_16, joker_113867_15, joker_113867_14, joker_113867_13, joker_113867_12, joker_113867_11, joker_113867_10, joker_113867_9, joker_113867_8, joker_113867_7, joker_113867_6, joker_113867_5, joker_113867_4, joker_113867_3, joker_113867_2, joker_113867_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2867)) ;
  ...
  cEnumerator_typedAttributeList enumerator_115938 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_115938.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_115938.current_mAttributeTypeProxy (HERE), enumerator_115938.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2907)) ;
    enumerator_115938.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (3005)) COMMA_SOURCE_FILE_AT_LINE (3005)), object->mAttribute_mSuperClassName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3005)) COMMA_SOURCE_FILE_AT_LINE (3005)) ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_120199 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_120199.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_120199.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3008)) COMMA_SOURCE_FILE_AT_LINE (3008)), object->mAttribute_mSuperClassName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3008)) COMMA_SOURCE_FILE_AT_LINE (3008)) ;
    }
    enumerator_120199.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121057 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121057.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121057.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3024)) COMMA_SOURCE_FILE_AT_LINE (3024)), enumerator_121057.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3024)) COMMA_SOURCE_FILE_AT_LINE (3024)) COMMA_SOURCE_FILE_AT_LINE (3024)) ;
    }
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121921 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121921.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121921.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3040)) COMMA_SOURCE_FILE_AT_LINE (3040)), enumerator_121921.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3040)) COMMA_SOURCE_FILE_AT_LINE (3040)) COMMA_SOURCE_FILE_AT_LINE (3040)) ;
    }
    enumerator_121921.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_123493 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123493.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123493.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3069)) COMMA_SOURCE_FILE_AT_LINE (3069)), enumerator_123493.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3069)) COMMA_SOURCE_FILE_AT_LINE (3069)) COMMA_SOURCE_FILE_AT_LINE (3069)) ;
    }
    enumerator_123493.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_125998 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_125998.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_125998.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3113)) COMMA_SOURCE_FILE_AT_LINE (3113)), enumerator_125998.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3113)) COMMA_SOURCE_FILE_AT_LINE (3113)) COMMA_SOURCE_FILE_AT_LINE (3113)) ;
    }
    enumerator_125998.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_135956 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3301)) ;
  if (NULL != objectArray_135956) {
      macroValidSharedObject (objectArray_135956, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_135956->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3302)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_137261 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3329)) ;
  if (NULL != objectArray_137261) {
      macroValidSharedObject (objectArray_137261, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_137261->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3330)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_138536 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3356)) ;
  if (NULL != objectArray_138536) {
      macroValidSharedObject (objectArray_138536, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_138536->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3357)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_140440 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3395)) ;
  if (NULL != objectArray_140440) {
      macroValidSharedObject (objectArray_140440, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_140440->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3396)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_141793 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3423)) ;
  if (NULL != objectArray_141793) {
      macroValidSharedObject (objectArray_141793, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_141793->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3424)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_143108 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3450)) ;
  if (NULL != objectArray_143108) {
      macroValidSharedObject (objectArray_143108, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_143108->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3451)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_143947 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_143947.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_143947.current_mAttributeTypeName (HERE), enumerator_143947.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3480)) COMMA_SOURCE_FILE_AT_LINE (3477)) ;
    enumerator_143947.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_144590 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_144590.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_144590.current_mAttributeTypeName (HERE), enumerator_144590.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3501)) COMMA_SOURCE_FILE_AT_LINE (3498)) ;
    enumerator_144590.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_145241 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145241.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145241.current_mAttributeTypeName (HERE), enumerator_145241.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3522)) COMMA_SOURCE_FILE_AT_LINE (3519)) ;
    enumerator_145241.gotoNextObject () ;
  }
