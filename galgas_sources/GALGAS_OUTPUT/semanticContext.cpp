...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_56315 (var_files, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_56315.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_56315.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1361)) COMMA_SOURCE_FILE_AT_LINE (1361)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1362)).operator_concat (enumerator_56315.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1362)) ;
      { //-------- @modifierCallInstructionForGeneration
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_56315.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1364)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1363)) ;
      ...
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_56315.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1371)) COMMA_SOURCE_FILE_AT_LINE (1371)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1372)).operator_concat (enumerator_56315.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1372)) ;
        { //-------- @modifierCallInstructionForGeneration
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_56315.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1374)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1373)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @incrementInstructionForGeneration
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1380)) ;
      }
    }
    enumerator_56315.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_57280 (var_directories, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_57280.hasCurrentObject ()) {
    ...
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1391)).operator_concat (enumerator_57280.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1391)), constinArgument_inPathInWrapper.operator_concat (enumerator_57280.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1392)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1392)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1390)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_57280.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1401)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1400)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_57280.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  GALGAS_semanticTypePrecedenceGraph var_semanticTypePrecedenceGraph = GALGAS_semanticTypePrecedenceGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (2756)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_categoryMethodMapForBuildingContext var_categoryMethodMapForBuildingContext = GALGAS_categoryMethodMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (2757)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_categoryReaderMapForBuildingContext var_categoryReaderMapForBuildingContext = GALGAS_categoryReaderMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (2758)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_categoryModifierMapForBuildingContext var_categoryModifierMapForBuildingContext = GALGAS_categoryModifierMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (2759)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_semanticDeclarationListAST var_categoryOverrideDefinitionList = GALGAS_semanticDeclarationListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2760)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticDeclarationListAST enumerator_117161 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_117161.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_117161.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2762)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_117161.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (2770)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_117581 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (2771)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_117581.hasCurrentObject ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_117581.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_117581.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2772)) COMMA_SOURCE_FILE_AT_LINE (2772)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (2772)) COMMA_SOURCE_FILE_AT_LINE (2772)) ;
      enumerator_117581.gotoNextObject () ;
    }
    //-------- @errorInstructionForGeneration
    inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("semantic analysis not performed, due to undefined type error(s)") COMMA_SOURCE_FILE_AT_LINE (2774)) ;
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_lstringlist joker_118064_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_118064_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2779)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (2790)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("semantic analysis not performed, ").operator_concat (var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (2791)).reader_string (SOURCE_FILE_AT_LINE (2791)) COMMA_SOURCE_FILE_AT_LINE (2791)).operator_concat (GALGAS_string (" declarations are involved in circular definition:") COMMA_SOURCE_FILE_AT_LINE (2791)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_118608 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_118608.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_118608.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2793)) COMMA_SOURCE_FILE_AT_LINE (2793)) COMMA_SOURCE_FILE_AT_LINE (2793)) ;
        enumerator_118608.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (2795)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      //-------- @appendInstructionForGeneration
      var_sortedSemanticDeclarationListAST.dotAssign_operation (var_categoryOverrideDefinitionList COMMA_SOURCE_FILE_AT_LINE (2798)) ;
      //-------- @assignmentInstructionForGeneration
      outArgument_outSemanticContext = GALGAS_semanticContext::constructor_new (constinArgument_inSourceFile, GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2802)), GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2803)), GALGAS_functionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2804)), GALGAS_filewrapperMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2805)), GALGAS_grammarMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2806)), GALGAS_optionComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (2807)) COMMA_SOURCE_FILE_AT_LINE (2800)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_119306 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_119306.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_119306.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (2811)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_119306.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_29135.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      ...
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertOrReplace (enumerator_29135.current_mInsertMethodName (HERE), GALGAS_bool (false), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (685)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (680)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_29135.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_mapRemoveMethodListAST enumerator_29585 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29585.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_modifierMap.reader_hasKey (enumerator_29585.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (692)) COMMA_SOURCE_FILE_AT_LINE (692)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (enumerator_29585.current_mMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_29585.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (693)) COMMA_SOURCE_FILE_AT_LINE (693)).operator_concat (GALGAS_string ("' method is already declared as an insert modifier or a remove modifier") COMMA_SOURCE_FILE_AT_LINE (693)) COMMA_SOURCE_FILE_AT_LINE (693)) ;
    }else if (kBoolFalse == test_2) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertOrReplace (enumerator_29585.current_mMethodName (HERE), GALGAS_bool (false), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (700)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (695)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_29585.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_mapSearchMethodListAST enumerator_30088 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_30088.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_instanceMethodMap.modifier_insertKey (enumerator_30088.current_mSearchMethodName (HERE), GALGAS_bool (false), var_removeMethodFormalArgumentList, enumerator_30088.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (711)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (713)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (707)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_30088.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_30419 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_30419.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_30419.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (719)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (719)), enumerator_30419.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (719)) COMMA_SOURCE_FILE_AT_LINE (719)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_30419.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (721)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (721)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
  ...
  if (kBoolTrue == test_4) {
    ...
    //-------- END @methodCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("insertOrReplace"), var_insertOrReplaceLocation COMMA_SOURCE_FILE_AT_LINE (738)), GALGAS_bool (false), var_insertMethodFormalArgumentList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (742)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (737)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_31530 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_31530.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_31530.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (748)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (748)) COMMA_SOURCE_FILE_AT_LINE (748)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (748)), enumerator_31530.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (748)) COMMA_SOURCE_FILE_AT_LINE (748)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_31530.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (750)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (750)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertOrReplace (var_accessorName, GALGAS_bool (false), var_accessorFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (759)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (754)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_31530.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_mapSearchMethodListAST enumerator_32524 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_32524.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_withAccessorMap.modifier_insertKey (enumerator_32524.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (767)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_36485 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_36485.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_36485.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (848)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (848)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_36485.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (851)) ;
    //-------- @addAssignInstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_36485.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (852)) COMMA_SOURCE_FILE_AT_LINE (852)) ;
    //-------- @addAssignInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_insertMethodListAST enumerator_37171 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_37171.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_37171.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (858)) COMMA_SOURCE_FILE_AT_LINE (858)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_37171.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_37171.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (859)) COMMA_SOURCE_FILE_AT_LINE (859)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (859)) COMMA_SOURCE_FILE_AT_LINE (859)) ;
    }else if (kBoolFalse == test_0) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertOrReplace (enumerator_37171.current_mInsertMethodName (HERE), GALGAS_bool (false), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (866)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (861)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
  ...
  if (kBoolTrue == test_2) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_mapSearchMethodListAST enumerator_37721 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_37721.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_instanceMethodMap.modifier_insertKey (enumerator_37721.current_mSearchMethodName (HERE), GALGAS_bool (false), var_removeMethodFormalArgumentList, enumerator_37721.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (878)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (880)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (874)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_37721.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_2) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_mapSearchMethodListAST enumerator_38047 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_38047.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (enumerator_38047.current_mSearchMethodName (HERE), GALGAS_bool (false), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (891)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (886)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_38047.gotoNextObject () ;
    }
  }
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_3) {
    ...
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openBranch"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (901)), GALGAS_bool (false), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (903)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (905)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (900)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("closeBranch"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (909)), GALGAS_bool (false), GALGAS_formalParameterSignature::constructor_listWithValue (var_locationTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (911)) COMMA_SOURCE_FILE_AT_LINE (911)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (913)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (908)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("closeOverride"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (917)), GALGAS_bool (false), GALGAS_formalParameterSignature::constructor_listWithValue (var_locationTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (919)) COMMA_SOURCE_FILE_AT_LINE (919)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (921)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (916)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("checkAutomatonStates"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (925)), GALGAS_bool (false), GALGAS_formalParameterSignature::constructor_listWithValue (var_locationTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (927)) COMMA_SOURCE_FILE_AT_LINE (927)), inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (930)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (924)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_mapOverrideBlockListAST enumerator_39697 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_39697.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_39697.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (935)) COMMA_SOURCE_FILE_AT_LINE (935)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (935)), GALGAS_bool (false), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (937)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (939)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (934)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_39697.gotoNextObject () ;
    }
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_40082 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_40082.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_40082.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (946)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (946)), enumerator_40082.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (946)) COMMA_SOURCE_FILE_AT_LINE (946)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_40082.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (948)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (948)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_40727 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_40727.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_40727.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (962)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (962)) COMMA_SOURCE_FILE_AT_LINE (962)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (962)), enumerator_40727.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (962)) COMMA_SOURCE_FILE_AT_LINE (962)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_40727.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (964)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (964)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertOrReplace (var_accessorName, GALGAS_bool (false), var_accessorFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (973)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (968)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_40727.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_mapSearchMethodListAST enumerator_41721 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_41721.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_withAccessorMap.modifier_insertKey (enumerator_41721.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (981)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_43298_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_43298_1 ; // Joker input parameter
  GALGAS_typedAttributeList joker_43324_2 ; // Joker input parameter
  GALGAS_attributeMap joker_43324_1 ; // Joker input parameter
  GALGAS_constructorMap joker_43360_11 ; // Joker input parameter
  GALGAS_readerMap joker_43360_10 ; // Joker input parameter
  GALGAS_modifierMap joker_43360_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_43360_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_43360_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_43360_6 ; // Joker input parameter
  GALGAS_stringlist joker_43360_5 ; // Joker input parameter
  GALGAS_uint joker_43360_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_43360_3 ; // Joker input parameter
  GALGAS_stringset joker_43360_2 ; // Joker input parameter
  GALGAS_lstringlist joker_43360_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_43390_3 ; // Joker input parameter
  GALGAS_withAccessorMap joker_43390_2 ; // Joker input parameter
  GALGAS_bool joker_43390_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_43298_2, joker_43298_1, var_typeKindEnum, joker_43324_2, joker_43324_1, var_mapTypedAttributeList, joker_43360_11, joker_43360_10, joker_43360_9, joker_43360_8, joker_43360_7, joker_43360_6, joker_43360_5, joker_43360_4, joker_43360_3, joker_43360_2, joker_43360_1, var_searchMethodList, joker_43390_3, joker_43390_2, joker_43390_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1026)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_mapSearchMethodListAST enumerator_45429 (var_searchMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_45429.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_constructorMap.modifier_insertKey (enumerator_45429.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1075)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_46400 (var_mapTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_46400.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_46400.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1092)) COMMA_SOURCE_FILE_AT_LINE (1092)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_46543 (var_inheritedReaderMap.reader_allKeys (SOURCE_FILE_AT_LINE (1094)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_46543.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_46543.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (1095)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1095)) COMMA_SOURCE_FILE_AT_LINE (1095)) ;
        if (enumerator_46543.hasNextObject ()) {
          //-------- @appendInstructionForGeneration
      ...
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (enumerator_46400.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_46400.current_mAttributeName (HERE), GALGAS_bool (false), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1104)), inCompiler->here (), GALGAS_bool (true), enumerator_46400.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1108)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1101)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  { //-------- @modifierCallInstructionForGeneration
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("topologicalSort"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1176)), GALGAS_bool (false), var_formalParameterList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1181)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1175)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_unifiedTypeMapProxyList enumerator_51222 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE_AT_LINE (1218)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_51222.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_formalParameterList.addAssign_operation (enumerator_51222.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1219)) COMMA_SOURCE_FILE_AT_LINE (1219)) ;
    enumerator_51222.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_graphInsertModifierList enumerator_51351 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_51351.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertOrReplace (enumerator_51351.current_mInsertModifierName (HERE), GALGAS_bool (false), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1227)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1222)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("addArc"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1236)), GALGAS_bool (false), var_formalParameterList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1240)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1235)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  ...
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("noteNode"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1247)), GALGAS_bool (false), var_formalParameterList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1251)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1246)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_54177 (object->mAttribute_mConstantList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_54177.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_constantSet.addAssign_operation (enumerator_54177.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1301)) COMMA_SOURCE_FILE_AT_LINE (1301)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_54177.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1302)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1302)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1302)) ;
    } //-------- @routineCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_enumMessageListAST enumerator_54505 (object->mAttribute_mEnumMessageList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_54505.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_enterBaseReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_54505.current_mEnumMessageName (HERE).reader_string (SOURCE_FILE_AT_LINE (1308)), GALGAS_string ("string"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1308)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_54505.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_filewrapperTemplateListAST enumerator_58514 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_58514.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_formalTemplateInputParameterListAST enumerator_58632 (enumerator_58514.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_58632.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_58632.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1423)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1423)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
    ...
    { //-------- @modifierCallInstructionForGeneration
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_58514.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_58514.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1426)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_58514.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_wrapperExtensionMap var_textExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1433)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_59167 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_59167.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_textExtensionMap.modifier_insertKey (enumerator_59167.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1435)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_59373 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_59373.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_59373.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1440)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_59373.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_59373.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1441)) COMMA_SOURCE_FILE_AT_LINE (1441)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1441)) COMMA_SOURCE_FILE_AT_LINE (1441)) ;
    }else if (kBoolFalse == test_0) {
      { //-------- @modifierCallInstructionForGeneration
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_59373.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1443)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_59373.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_61404 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_61404.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61404.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1497)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1497)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_61404.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1500)) ;
    enumerator_61404.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_62403 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_62403.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (enumerator_62403.current_mAttributeTypeProxy (HERE), enumerator_62403.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1514)) COMMA_SOURCE_FILE_AT_LINE (1514)) ;
    //-------- @addAssignInstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (enumerator_62403.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (1515)) ;
    //-------- @addAssignInstructionForGeneration
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_62403.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1516)) COMMA_SOURCE_FILE_AT_LINE (1516)) ;
    //-------- @addAssignInstructionForGeneration
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_62403.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1517)) COMMA_SOURCE_FILE_AT_LINE (1517)) ;
    enumerator_62403.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_63573 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_63573.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_63573.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1535)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1535)), enumerator_63573.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1535)) COMMA_SOURCE_FILE_AT_LINE (1535)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_uintType COMMA_SOURCE_FILE_AT_LINE (1537)), inCompiler->here (), GALGAS_bool (true), enumerator_63573.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1541)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1534)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popFirst"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1548)), GALGAS_bool (false), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1552)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1547)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popLast"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1556)), GALGAS_bool (false), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1560)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1555)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("prependValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1564)), GALGAS_bool (false), var_modifierInputFormalArgumentList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1568)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1563)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_64558 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_64558.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @addAssignInstructionForGeneration
    var_setterFormalArgumentList.addAssign_operation (enumerator_64558.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1573)) COMMA_SOURCE_FILE_AT_LINE (1573)) ;
    //-------- @addAssignInstructionForGeneration
    ...
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_64558.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1576)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1576)) COMMA_SOURCE_FILE_AT_LINE (1576)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1576)), enumerator_64558.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1576)) COMMA_SOURCE_FILE_AT_LINE (1576)), GALGAS_bool (false), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1580)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1575)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_64558.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  { //-------- @modifierCallInstructionForGeneration
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("last"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1596)), GALGAS_bool (false), var_modifierOutputFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1601)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1595)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_67660 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_67660.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_67660.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1655)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1655)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_67660.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1658)) ;
    //-------- @addAssignInstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_67660.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1659)) COMMA_SOURCE_FILE_AT_LINE (1659)) ;
    //-------- @addAssignInstructionForGeneration
    ...
    enumerator_67660.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_71593 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_71593.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_71593.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1763)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1763)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    ...
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_71593.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1767)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_attributeMap.modifier_insertKey (enumerator_71593.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1768)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_72331 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_72331.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_72331.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1785)), enumerator_72331.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1786)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1782)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_72331.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @assignmentInstructionForGeneration
    var_inheritedInstanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1845)) ;
    //-------- @assignmentInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_74850 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_74850.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_74850.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1850)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @assignmentInstructionForGeneration
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_74850.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    { //-------- @typeMethodInstructionForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_75299_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_75299_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_75384_2 ; // Joker input parameter
    GALGAS_constructorMap joker_75384_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_75483_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_75483_9 ; // Joker input parameter
    GALGAS_stringlist joker_75483_8 ; // Joker input parameter
    GALGAS_uint joker_75483_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_75483_6 ; // Joker input parameter
    GALGAS_stringset joker_75483_5 ; // Joker input parameter
    GALGAS_lstringlist joker_75483_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_75483_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_75483_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_75483_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_75299_2, joker_75299_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_75384_2, joker_75384_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedInstanceMethodMap, joker_75483_10, joker_75483_9, joker_75483_8, joker_75483_7, joker_75483_6, joker_75483_5, joker_75483_4, joker_75483_3, joker_75483_2, joker_75483_1, var_generateHeaderInSeparateFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (1859)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (1873)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (object->mAttribute_mSuperClassName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the @").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (1874)) COMMA_SOURCE_FILE_AT_LINE (1874)).operator_concat (GALGAS_string (" should be a class type") COMMA_SOURCE_FILE_AT_LINE (1874)) COMMA_SOURCE_FILE_AT_LINE (1874)) ;
    }
    //-------- @assignmentInstructionForGeneration
    var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1877)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_modifierMap enumerator_75808 (var_inheritedModifierMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_75808.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (enumerator_75808.current_lkey (HERE), GALGAS_bool (false), enumerator_75808.current_mParameterList (HERE), enumerator_75808.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1884)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1879)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_75808.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1889)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_readerMap enumerator_76134 (var_inheritedReaderMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_76134.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_76134.current_lkey (HERE), enumerator_76134.current_mIsCategory (HERE), enumerator_76134.current_mArgumentTypeList (HERE), enumerator_76134.current_mDeclarationLocation (HERE), enumerator_76134.current_mHasCompilerArgument (HERE), enumerator_76134.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1898)), enumerator_76134.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1891)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_76134.gotoNextObject () ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1904)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_76577 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_76577.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (enumerator_76577.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (1906)) ;
    enumerator_76577.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_76680 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_76680.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_76680.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1910)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1910)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1911)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_attributeMap.modifier_insertKey (enumerator_76680.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1912)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (1916)), var_classIndex COMMA_SOURCE_FILE_AT_LINE (1916)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1918)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_4 = object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (1919)).boolEnum () ;
  if (kBoolTrue == test_4) {
    { //-------- @modifierCallInstructionForGeneration
    var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1921)), var_constructorAttributeTypeList, GALGAS_bool (false), var_classIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1920)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1928)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_instanceMethodMap enumerator_77537 (var_inheritedInstanceMethodMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_77537.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_instanceMethodMap.modifier_insertKey (enumerator_77537.current_lkey (HERE), enumerator_77537.current_mIsCategory (HERE), enumerator_77537.current_mParameterList (HERE), enumerator_77537.current_mDeclarationLocation (HERE), enumerator_77537.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1936)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1930)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_77537.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_abstractMethodDefinitionListAST enumerator_77848 (object->mAttribute_mAbstractMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_77848.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_formalParameterSignature var_formalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1942)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_formalParameterListAST enumerator_77937 (enumerator_77848.current_mSignature (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_77937.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_typeIndex ;
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_77937.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1945)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (1945)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_77937.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1946)) ;
    ...
    cMapElement_instanceMethodMap * objectArray_78198 = (cMapElement_instanceMethodMap *) var_instanceMethodMap.readWriteAccessForWithInstruction_hasKey (inCompiler, enumerator_77848.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1948)) COMMA_SOURCE_FILE_AT_LINE (1948)) ;
    if (NULL != objectArray_78198) {
        macroValidSharedObject (objectArray_78198, cMapElement_instanceMethodMap) ;
      //-------- @assignmentInstructionForGeneration
      objectArray_78198->mAttribute_mQualifier = GALGAS_methodQualifier::constructor_isOverridingAbstract (SOURCE_FILE_AT_LINE (1949)) ;
    }else{
      { //-------- @modifierCallInstructionForGeneration
      var_instanceMethodMap.modifier_insertKey (enumerator_77848.current_mMethodName (HERE), GALGAS_bool (false), var_formalArgumentList, enumerator_77848.current_mMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (1955)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isAbstract (SOURCE_FILE_AT_LINE (1957)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1951)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_77848.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_methodDefinitionListAST enumerator_78666 (object->mAttribute_mMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_78666.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_formalParameterSignature var_formalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1964)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_formalParameterListAST enumerator_78755 (enumerator_78666.current_mSignature (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_78755.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_typeIndex ;
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_78755.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1967)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (1967)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_78755.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1968)) ;
      enumerator_78755.gotoNextObject () ;
    }
    //-------- @readWriteWithInstructionForGeneration
    // index 1: attribute 'mIsCategory', type @bool
    // index 2: attribute 'mParameterList', type @formalParameterSignature
    ...
    // index 5: attribute 'mQualifier', type @methodQualifier
    // index 6: attribute 'mErrorMessage', type @string
    cMapElement_instanceMethodMap * objectArray_79016 = (cMapElement_instanceMethodMap *) var_instanceMethodMap.readWriteAccessForWithInstruction_hasKey (inCompiler, enumerator_78666.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1970)) COMMA_SOURCE_FILE_AT_LINE (1970)) ;
    if (NULL != objectArray_79016) {
        macroValidSharedObject (objectArray_79016, cMapElement_instanceMethodMap) ;
      //-------- @assignmentInstructionForGeneration
      objectArray_79016->mAttribute_mQualifier = GALGAS_methodQualifier::constructor_isOverriding (SOURCE_FILE_AT_LINE (1971)) ;
    }else{
      { //-------- @modifierCallInstructionForGeneration
      var_instanceMethodMap.modifier_insertKey (enumerator_78666.current_mMethodName (HERE), GALGAS_bool (false), var_formalArgumentList, enumerator_78666.current_mMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (1977)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1979)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1973)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_78666.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_5 = constinArgument_inCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (1985)) COMMA_SOURCE_FILE_AT_LINE (1985)).boolEnum () ;
  if (kBoolTrue == test_5) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_categoryMethodMapForType var_categoryMethodMapForType ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inCategoryMethodMapForBuildingContext.method_searchKey (object->mAttribute_mClassTypeName, var_categoryMethodMapForType, inCompiler COMMA_SOURCE_FILE_AT_LINE (1987)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_categoryMethodMapForType enumerator_79724 (var_categoryMethodMapForType, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_79724.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_formalParameterSignature var_formalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1989)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_79827 (enumerator_79724.current_mFormalParameterList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_79827.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        { //-------- @typeMethodInstructionForGeneration
        GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_79827.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1992)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (1992)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @addAssignInstructionForGeneration
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_79827.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1993)) ;
        enumerator_79827.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_instanceMethodMap.modifier_insertKey (enumerator_79724.current_lkey (HERE), GALGAS_bool (true), var_formalArgumentList, enumerator_79724.current_lkey (HERE).reader_location (SOURCE_FILE_AT_LINE (1999)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2001)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1995)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_79724.gotoNextObject () ;
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_6 = constinArgument_inCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (2007)) COMMA_SOURCE_FILE_AT_LINE (2007)).boolEnum () ;
  if (kBoolTrue == test_6) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_categoryReaderMapForType var_categoryReaderMapForType ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inCategoryReaderMapForBuildingContext.method_searchKey (object->mAttribute_mClassTypeName, var_categoryReaderMapForType, inCompiler COMMA_SOURCE_FILE_AT_LINE (2009)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_categoryReaderMapForType enumerator_80659 (var_categoryReaderMapForType, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_80659.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_unifiedTypeMapProxyList var_formalArgumentList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2011)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalInputParameterListAST enumerator_80766 (enumerator_80659.current_mInputFormalParameterList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_80766.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        { //-------- @typeMethodInstructionForGeneration
        GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_80766.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2014)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (2014)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @addAssignInstructionForGeneration
        var_formalArgumentList.addAssign_operation (var_typeIndex COMMA_SOURCE_FILE_AT_LINE (2015)) ;
        enumerator_80766.gotoNextObject () ;
      }
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_returnedType ;
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_80659.current_mResultTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2018)), var_returnedType COMMA_SOURCE_FILE_AT_LINE (2018)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_80659.current_lkey (HERE), GALGAS_bool (true), var_formalArgumentList, enumerator_80659.current_lkey (HERE).reader_location (SOURCE_FILE_AT_LINE (2023)), GALGAS_bool (true), var_returnedType, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2026)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2019)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_80659.gotoNextObject () ;
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_7 = constinArgument_inCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (2032)) COMMA_SOURCE_FILE_AT_LINE (2032)).boolEnum () ;
  if (kBoolTrue == test_7) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_categoryModifierMapForType var_categoryModifierMapForType ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inCategoryModifierMapForBuildingContext.method_searchKey (object->mAttribute_mClassTypeName, var_categoryModifierMapForType, inCompiler COMMA_SOURCE_FILE_AT_LINE (2034)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_categoryModifierMapForType enumerator_81758 (var_categoryModifierMapForType, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_81758.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_formalParameterSignature var_formalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2036)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_81861 (enumerator_81758.current_mFormalParameterList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_81861.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        { //-------- @typeMethodInstructionForGeneration
        GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_81861.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2039)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (2039)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @addAssignInstructionForGeneration
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_81861.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (2040)) ;
        enumerator_81861.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (enumerator_81758.current_lkey (HERE), GALGAS_bool (true), var_formalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2047)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2042)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_81758.gotoNextObject () ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_typedAttributeList var_currentClassTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2053)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_typedAttributeList var_allTypedAttributeList = var_inheritedTypedAttributeList ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_82539 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_82539.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_82539.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2057)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2057)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_82799 (enumerator_82539.current_mFeatureList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_82799.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_82799.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2061)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_8) {
        //-------- @assignmentInstructionForGeneration
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_8) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, enumerator_82799.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2063)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_9) {
          //-------- @assignmentInstructionForGeneration
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_82799.gotoNextObject () ;
    }
    //-------- @addAssignInstructionForGeneration
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_82539.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2067)) ;
    //-------- @addAssignInstructionForGeneration
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_82539.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2068)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_10 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_10) {
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_82539.current_mAttributeName (HERE), GALGAS_bool (false), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2073)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2077)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2070)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_82539.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_83851 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_83851.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_11 = enumerator_83851.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_11) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_83851.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2092)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2092)) COMMA_SOURCE_FILE_AT_LINE (2092)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2092)), GALGAS_bool (false), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_83851.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2094)) COMMA_SOURCE_FILE_AT_LINE (2094)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2096)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2091)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_83851.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mClassTypeName, object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (2104)), var_superClassIndex, GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2106)), var_allTypedAttributeList, var_attributeMap, var_currentClassTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2114)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2115)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2116)), GALGAS_uint ((PMUInt32) 0U), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2118)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2119)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2120)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2121)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2122)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2123)), var_generateHeaderInSeparateFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (2102)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_externRoutineDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formalParameterSignature var_routineSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2137)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListAST enumerator_85593 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_85593.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_85593.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2140)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2140)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_85593.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (2141)) ;
    enumerator_85593.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mRoutineMap.modifier_insertKey (object->mAttribute_mRoutineName, var_routineSignature, inCompiler COMMA_SOURCE_FILE_AT_LINE (2144)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_externFunctionDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unifiedTypeMapProxyList var_functionSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2156)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalInputParameterListAST enumerator_86588 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_86588.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_86588.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2159)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2159)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2160)) ;
    enumerator_86588.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName.reader_string (SOURCE_FILE_AT_LINE (2164)), var_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2164)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2166)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName.reader_string (SOURCE_FILE_AT_LINE (2179)), var_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2179)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2181)), var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2181)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_typeKindEnum var_typeKindEnum ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_88686_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_88686_1 ; // Joker input parameter
  GALGAS_attributeMap joker_88741_17 ; // Joker input parameter
  GALGAS_typedAttributeList joker_88741_16 ; // Joker input parameter
  GALGAS_constructorMap joker_88741_15 ; // Joker input parameter
  GALGAS_readerMap joker_88741_14 ; // Joker input parameter
  GALGAS_modifierMap joker_88741_13 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_88741_12 ; // Joker input parameter
  GALGAS_classMethodMap joker_88741_11 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_88741_10 ; // Joker input parameter
  GALGAS_stringlist joker_88741_9 ; // Joker input parameter
  GALGAS_uint joker_88741_8 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_88741_7 ; // Joker input parameter
  GALGAS_stringset joker_88741_6 ; // Joker input parameter
  GALGAS_lstringlist joker_88741_5 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_88741_4 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_88741_3 ; // Joker input parameter
  GALGAS_withAccessorMap joker_88741_2 ; // Joker input parameter
  GALGAS_bool joker_88741_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_88686_2, joker_88686_1, var_typeKindEnum, var_listTypedAttributeList, joker_88741_17, joker_88741_16, joker_88741_15, joker_88741_14, joker_88741_13, joker_88741_12, joker_88741_11, joker_88741_10, joker_88741_9, joker_88741_8, joker_88741_7, joker_88741_6, joker_88741_5, joker_88741_4, joker_88741_3, joker_88741_2, joker_88741_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2196)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (2203)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2204)) COMMA_SOURCE_FILE_AT_LINE (2204)).operator_concat (GALGAS_string ("' type should be a list type") COMMA_SOURCE_FILE_AT_LINE (2204)) COMMA_SOURCE_FILE_AT_LINE (2204)) ;
    //-------- @assignmentInstructionForGeneration
    var_listTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2205)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2208)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2209)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2210)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2211)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_associatedListTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2214)), var_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (2214)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_currentTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2217)), var_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (2217)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2220)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("count"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2222)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("allKeys"), GALGAS_string ("stringset"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2223)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2224)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("listForKey"), GALGAS_string ("string"), object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2225)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2225)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyMap"), object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2227)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2227)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_enumerationDescriptorList var_enumeratorDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2229)) ;
  //-------- @addAssignInstructionForGeneration
  var_enumeratorDescriptor.addAssign_operation (var_stringTypeIndex, GALGAS_string ("key") COMMA_SOURCE_FILE_AT_LINE (2230)) ;
  //-------- @addAssignInstructionForGeneration
  var_enumeratorDescriptor.addAssign_operation (var_associatedListTypeIndex, GALGAS_string ("mList") COMMA_SOURCE_FILE_AT_LINE (2231)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_unifiedTypeMapProxyList var_addAssignOperatorDescription = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2233)) ;
  //-------- @addAssignInstructionForGeneration
  var_addAssignOperatorDescription.addAssign_operation (var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2234)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_90765 (var_listTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_90765.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_addAssignOperatorDescription.addAssign_operation (enumerator_90765.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2236)) ;
    enumerator_90765.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListmapTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2246)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE_AT_LINE (2247)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2248)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2249)), var_listTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2255)), var_enumeratorDescriptor, var_enumerationVariants, function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2258)), var_addAssignOperatorDescription, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2260)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2261)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2262)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2263)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2264)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2243)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_predefinedTypeAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mPredefinedTypeName COMMA_SOURCE_FILE_AT_LINE (2298)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2298)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_predefinedTypeAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2299)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_classDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (2311)) COMMA_SOURCE_FILE_AT_LINE (2311)), object->mAttribute_mClassTypeName.reader_location (SOURCE_FILE_AT_LINE (2311)) COMMA_SOURCE_FILE_AT_LINE (2311)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_classDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2312)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2314)) COMMA_SOURCE_FILE_AT_LINE (2314)), object->mAttribute_mSuperClassName.reader_location (SOURCE_FILE_AT_LINE (2314)) COMMA_SOURCE_FILE_AT_LINE (2314)) COMMA_SOURCE_FILE_AT_LINE (2314)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_94337 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_94337.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_94337.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2317)) COMMA_SOURCE_FILE_AT_LINE (2317)), enumerator_94337.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2317)) COMMA_SOURCE_FILE_AT_LINE (2317)) COMMA_SOURCE_FILE_AT_LINE (2317)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_94337.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_listDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2330)) COMMA_SOURCE_FILE_AT_LINE (2330)), object->mAttribute_mListTypeName.reader_location (SOURCE_FILE_AT_LINE (2330)) COMMA_SOURCE_FILE_AT_LINE (2330)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_listDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2331)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_95192 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_95192.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_95192.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2333)) COMMA_SOURCE_FILE_AT_LINE (2333)), enumerator_95192.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2333)) COMMA_SOURCE_FILE_AT_LINE (2333)) COMMA_SOURCE_FILE_AT_LINE (2333)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_95192.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_structDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (2346)) COMMA_SOURCE_FILE_AT_LINE (2346)), object->mAttribute_mStructTypeName.reader_location (SOURCE_FILE_AT_LINE (2346)) COMMA_SOURCE_FILE_AT_LINE (2346)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_structDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2347)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_96053 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_96053.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_96053.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2349)) COMMA_SOURCE_FILE_AT_LINE (2349)), enumerator_96053.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2349)) COMMA_SOURCE_FILE_AT_LINE (2349)) COMMA_SOURCE_FILE_AT_LINE (2349)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_96053.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (2362)) COMMA_SOURCE_FILE_AT_LINE (2362)), object->mAttribute_mEnumTypeName.reader_location (SOURCE_FILE_AT_LINE (2362)) COMMA_SOURCE_FILE_AT_LINE (2362)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_sortedListDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2375)) COMMA_SOURCE_FILE_AT_LINE (2375)), object->mAttribute_mSortedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2375)) COMMA_SOURCE_FILE_AT_LINE (2375)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_sortedListDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2376)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_97618 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_97618.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_97618.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2378)) COMMA_SOURCE_FILE_AT_LINE (2378)), enumerator_97618.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2378)) COMMA_SOURCE_FILE_AT_LINE (2378)) COMMA_SOURCE_FILE_AT_LINE (2378)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_97618.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_listmapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2391)) COMMA_SOURCE_FILE_AT_LINE (2391)), object->mAttribute_mListmapTypeName.reader_location (SOURCE_FILE_AT_LINE (2391)) COMMA_SOURCE_FILE_AT_LINE (2391)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_listmapDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2392)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2393)) COMMA_SOURCE_FILE_AT_LINE (2393)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2393)) COMMA_SOURCE_FILE_AT_LINE (2393)) COMMA_SOURCE_FILE_AT_LINE (2393)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_mapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2405)) COMMA_SOURCE_FILE_AT_LINE (2405)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2405)) COMMA_SOURCE_FILE_AT_LINE (2405)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_99301 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_99301.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_99301.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2408)) COMMA_SOURCE_FILE_AT_LINE (2408)), enumerator_99301.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2408)) COMMA_SOURCE_FILE_AT_LINE (2408)) COMMA_SOURCE_FILE_AT_LINE (2408)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_99301.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_uniqueMapDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2421)) COMMA_SOURCE_FILE_AT_LINE (2421)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2421)) COMMA_SOURCE_FILE_AT_LINE (2421)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_uniqueMapDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2422)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_100159 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_100159.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_100159.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2424)) COMMA_SOURCE_FILE_AT_LINE (2424)), enumerator_100159.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2424)) COMMA_SOURCE_FILE_AT_LINE (2424)) COMMA_SOURCE_FILE_AT_LINE (2424)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_100159.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapProxyDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_mapProxyDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE_AT_LINE (2437)) COMMA_SOURCE_FILE_AT_LINE (2437)), object->mAttribute_mMapProxyTypeName.reader_location (SOURCE_FILE_AT_LINE (2437)) COMMA_SOURCE_FILE_AT_LINE (2437)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_mapProxyDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2438)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedMapTypeName.reader_string (SOURCE_FILE_AT_LINE (2439)) COMMA_SOURCE_FILE_AT_LINE (2439)), object->mAttribute_mAssociatedMapTypeName.reader_location (SOURCE_FILE_AT_LINE (2439)) COMMA_SOURCE_FILE_AT_LINE (2439)) COMMA_SOURCE_FILE_AT_LINE (2439)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_graphDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_graphDeclarationAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mGraphTypeName.reader_string (SOURCE_FILE_AT_LINE (2451)) COMMA_SOURCE_FILE_AT_LINE (2451)), object->mAttribute_mGraphTypeName.reader_location (SOURCE_FILE_AT_LINE (2451)) COMMA_SOURCE_FILE_AT_LINE (2451)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_graphDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2452)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2453)) COMMA_SOURCE_FILE_AT_LINE (2453)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (2453)) COMMA_SOURCE_FILE_AT_LINE (2453)) COMMA_SOURCE_FILE_AT_LINE (2453)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (2465)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (2477)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (2489)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (2501)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (2513)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (2525)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (2537)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (2549)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (2561)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_categoryReaderAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2573)) COMMA_SOURCE_FILE_AT_LINE (2573)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2573)).operator_concat (object->mAttribute_mCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2573)) COMMA_SOURCE_FILE_AT_LINE (2573)), object->mAttribute_mCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (2573)) COMMA_SOURCE_FILE_AT_LINE (2573)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryReaderAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2574)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2575)) COMMA_SOURCE_FILE_AT_LINE (2575)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (2575)) COMMA_SOURCE_FILE_AT_LINE (2575)) COMMA_SOURCE_FILE_AT_LINE (2575)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2577)) COMMA_SOURCE_FILE_AT_LINE (2577)).operator_not (SOURCE_FILE_AT_LINE (2577)).boolEnum () ;
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (2580)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2578)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_108542 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2583)) ;
  if (NULL != objectArray_108542) {
      macroValidSharedObject (objectArray_108542, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_108542->mAttribute_mCategoryReaderMapForType.modifier_insertOrReplace (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList COMMA_SOURCE_FILE_AT_LINE (2584)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_categoryMethodAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2601)) COMMA_SOURCE_FILE_AT_LINE (2601)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2601)).operator_concat (object->mAttribute_mCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (2601)) COMMA_SOURCE_FILE_AT_LINE (2601)), object->mAttribute_mCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (2601)) COMMA_SOURCE_FILE_AT_LINE (2601)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryMethodAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2602)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2603)) COMMA_SOURCE_FILE_AT_LINE (2603)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (2603)) COMMA_SOURCE_FILE_AT_LINE (2603)) COMMA_SOURCE_FILE_AT_LINE (2603)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2605)) COMMA_SOURCE_FILE_AT_LINE (2605)).operator_not (SOURCE_FILE_AT_LINE (2605)).boolEnum () ;
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (2608)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2606)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_109849 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2611)) ;
  if (NULL != objectArray_109849) {
      macroValidSharedObject (objectArray_109849, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_109849->mAttribute_mCategoryMethodMapForType.modifier_insertOrReplace (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2612)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_categoryModifierAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2628)) COMMA_SOURCE_FILE_AT_LINE (2628)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2628)).operator_concat (object->mAttribute_mCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (2628)) COMMA_SOURCE_FILE_AT_LINE (2628)), object->mAttribute_mCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (2628)) COMMA_SOURCE_FILE_AT_LINE (2628)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryModifierAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2629)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2630)) COMMA_SOURCE_FILE_AT_LINE (2630)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (2630)) COMMA_SOURCE_FILE_AT_LINE (2630)) COMMA_SOURCE_FILE_AT_LINE (2630)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2632)) COMMA_SOURCE_FILE_AT_LINE (2632)).operator_not (SOURCE_FILE_AT_LINE (2632)).boolEnum () ;
  if (kBoolTrue == test_1) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (2635)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2633)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_111126 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2638)) ;
  if (NULL != objectArray_111126) {
      macroValidSharedObject (objectArray_111126, cMapElement_categoryModifierMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_111126->mAttribute_mCategoryModifierMapForType.modifier_insertOrReplace (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2639)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_abstractCategoryReaderAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2667)) COMMA_SOURCE_FILE_AT_LINE (2667)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2667)).operator_concat (object->mAttribute_mAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (2667)) COMMA_SOURCE_FILE_AT_LINE (2667)), object->mAttribute_mAbstractCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (2667)) COMMA_SOURCE_FILE_AT_LINE (2667)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_113032 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2677)) ;
  if (NULL != objectArray_113032) {
      macroValidSharedObject (objectArray_113032, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_113032->mAttribute_mCategoryReaderMapForType.modifier_insertOrReplace (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList COMMA_SOURCE_FILE_AT_LINE (2678)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_abstractCategoryMethodAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2695)) COMMA_SOURCE_FILE_AT_LINE (2695)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2695)).operator_concat (object->mAttribute_mAbstractCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (2695)) COMMA_SOURCE_FILE_AT_LINE (2695)), object->mAttribute_mAbstractCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (2695)) COMMA_SOURCE_FILE_AT_LINE (2695)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_114387 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2705)) ;
  if (NULL != objectArray_114387) {
      macroValidSharedObject (objectArray_114387, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_114387->mAttribute_mCategoryMethodMapForType.modifier_insertOrReplace (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2706)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, const cPtr_abstractCategoryModifierAST) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (2722)) COMMA_SOURCE_FILE_AT_LINE (2722)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (2722)).operator_concat (object->mAttribute_mAbstractCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (2722)) COMMA_SOURCE_FILE_AT_LINE (2722)), object->mAttribute_mAbstractCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (2722)) COMMA_SOURCE_FILE_AT_LINE (2722)) ;
  { //-------- @modifierCallInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  ...
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_115704 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2732)) ;
  if (NULL != objectArray_115704) {
      macroValidSharedObject (objectArray_115704, cMapElement_categoryModifierMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_115704->mAttribute_mCategoryModifierMapForType.modifier_insertOrReplace (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2733)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
