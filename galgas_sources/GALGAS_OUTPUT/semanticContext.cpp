...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  ioArgument_ioWrapperDirectoryIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1850)) ;
  GALGAS_stringlist var_files = constinArgument_inAbsoluteSourcePath.reader_regularFiles (GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1852)) ;
  outArgument_outWrapperFileMap = GALGAS_wrapperFileMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1853)) ;
  cEnumerator_stringlist enumerator_74143 (var_files, kEnumeration_up) ;
  while (enumerator_74143.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_74143.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1855)) COMMA_SOURCE_FILE_AT_LINE (1855)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1856)).operator_concat (enumerator_74143.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1856)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_74143.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1858)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1857)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1864)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_74143.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1865)) COMMA_SOURCE_FILE_AT_LINE (1865)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1866)).operator_concat (enumerator_74143.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1866)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_74143.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1868)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1867)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1874)) ;
      }
    }
    enumerator_74143.gotoNextObject () ;
  }
  GALGAS_stringlist var_directories = constinArgument_inAbsoluteSourcePath.reader_directories (GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1878)) ;
  outArgument_outWrapperDirectoryMap = GALGAS_wrapperDirectoryMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1879)) ;
  cEnumerator_stringlist enumerator_75108 (var_directories, kEnumeration_up) ;
  while (enumerator_75108.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1885)).operator_concat (enumerator_75108.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1885)), constinArgument_inPathInWrapper.operator_concat (enumerator_75108.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1886)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1886)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1884)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_75108.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1895)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1894)) ;
    }
    enumerator_75108.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_144269 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_144269.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_144269.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3555)) ;
    enumerator_144269.gotoNextObject () ;
  }
  GALGAS_semanticTypePrecedenceGraph var_semanticTypePrecedenceGraph = GALGAS_semanticTypePrecedenceGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (3561)) ;
  GALGAS_categoryMethodMapForBuildingContext var_categoryMethodMapForBuildingContext = GALGAS_categoryMethodMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3562)) ;
  GALGAS_categoryReaderMapForBuildingContext var_categoryReaderMapForBuildingContext = GALGAS_categoryReaderMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3563)) ;
  GALGAS_categoryModifierMapForBuildingContext var_categoryModifierMapForBuildingContext = GALGAS_categoryModifierMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3564)) ;
  GALGAS_semanticDeclarationListAST var_categoryOverrideDefinitionList = GALGAS_semanticDeclarationListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3565)) ;
  cEnumerator_semanticDeclarationListAST enumerator_145002 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_145002.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_145002.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3567)) ;
    enumerator_145002.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (3575)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_145422 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3576)), kEnumeration_up) ;
    while (enumerator_145422.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_145422.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_145422.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3577)) COMMA_SOURCE_FILE_AT_LINE (3577)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3577)) COMMA_SOURCE_FILE_AT_LINE (3577)) ;
      enumerator_145422.gotoNextObject () ;
    }
    inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("semantic analysis not performed, due to undefined type error(s)") COMMA_SOURCE_FILE_AT_LINE (3579)) ;
    ...
    GALGAS_lstringlist joker_145758_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_145758_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3581)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3592)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string ("semantic analysis not performed, ").operator_concat (var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3593)).reader_string (SOURCE_FILE_AT_LINE (3593)) COMMA_SOURCE_FILE_AT_LINE (3593)).operator_concat (GALGAS_string (" declarations are involved in circular definition:") COMMA_SOURCE_FILE_AT_LINE (3593)) ;
      cEnumerator_semanticDeclarationListAST enumerator_146343 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_146343.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_146343.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3595)) COMMA_SOURCE_FILE_AT_LINE (3595)) COMMA_SOURCE_FILE_AT_LINE (3595)) ;
        enumerator_146343.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (3597)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      var_sortedSemanticDeclarationListAST.dotAssign_operation (var_categoryOverrideDefinitionList COMMA_SOURCE_FILE_AT_LINE (3600)) ;
      outArgument_outSemanticContext = GALGAS_semanticContext::constructor_new (constinArgument_inSourceFile, GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3604)), GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3605)), GALGAS_functionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3606)), GALGAS_filewrapperMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3607)), GALGAS_grammarMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3608)), GALGAS_optionComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3609)), GALGAS_lexiqueComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3610)), GALGAS_optionMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3611)) COMMA_SOURCE_FILE_AT_LINE (3602)) ;
      cEnumerator_semanticDeclarationListAST enumerator_147151 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_147151.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_147151.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3615)) ;
        enumerator_147151.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_35525 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_35525.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_35525.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (842)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_35525.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (845)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_35525.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (846)) COMMA_SOURCE_FILE_AT_LINE (846)) ;
  ...
  cEnumerator_insertMethodListAST enumerator_36195 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_36195.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_36195.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (852)) COMMA_SOURCE_FILE_AT_LINE (852)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_36195.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_36195.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (853)) COMMA_SOURCE_FILE_AT_LINE (853)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (853)) COMMA_SOURCE_FILE_AT_LINE (853)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_36195.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (857)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (860)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (855)) ;
      }
    }
    enumerator_36195.gotoNextObject () ;
  }
  cEnumerator_mapRemoveMethodListAST enumerator_36669 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  while (enumerator_36669.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_modifierMap.reader_hasKey (enumerator_36669.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (867)) COMMA_SOURCE_FILE_AT_LINE (867)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_36669.current_mMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_36669.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (868)) COMMA_SOURCE_FILE_AT_LINE (868)).operator_concat (GALGAS_string ("' method is already declared as an insert modifier or a remove modifier") COMMA_SOURCE_FILE_AT_LINE (868)) COMMA_SOURCE_FILE_AT_LINE (868)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_36669.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (872)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (875)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (870)) ;
      }
    }
    enumerator_36669.gotoNextObject () ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_37196 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_37196.hasCurrentObject ()) {
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_37196.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (884)), var_removeMethodFormalArgumentList, enumerator_37196.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (886)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (888)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (882)) ;
    }
    enumerator_37196.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_37531 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_37531.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_37531.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (894)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (894)), enumerator_37531.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (894)) COMMA_SOURCE_FILE_AT_LINE (894)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_37531.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (896)) ;
    }
    {
    ...
    enumerator_37531.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_38654 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_38654.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_38654.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (923)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (923)) COMMA_SOURCE_FILE_AT_LINE (923)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (923)), enumerator_38654.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (923)) COMMA_SOURCE_FILE_AT_LINE (923)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_38654.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (925)) ;
    }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_39656 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_39656.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_39656.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (942)) ;
    }
    enumerator_39656.gotoNextObject () ;
  }
  {
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1023)) ;
  ...
  cEnumerator_attributeInCollectionListAST enumerator_44379 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_44379.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_44379.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1045)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_44379.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1048)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_44379.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1049)) COMMA_SOURCE_FILE_AT_LINE (1049)) ;
  ...
  cEnumerator_insertMethodListAST enumerator_45065 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_45065.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_45065.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1055)) COMMA_SOURCE_FILE_AT_LINE (1055)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_45065.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_45065.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1056)) COMMA_SOURCE_FILE_AT_LINE (1056)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (1056)) COMMA_SOURCE_FILE_AT_LINE (1056)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_45065.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1060)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1063)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1058)) ;
      }
    }
    enumerator_45065.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_46748 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_46748.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_46748.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1098)), var_removeMethodFormalArgumentList, enumerator_46748.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (1100)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1102)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1096)) ;
      }
      enumerator_46748.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_47078 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_47078.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_47078.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1110)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1113)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1108)) ;
      }
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_mapOverrideBlockListAST enumerator_48831 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    while (enumerator_48831.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_48831.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1157)) COMMA_SOURCE_FILE_AT_LINE (1157)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1157)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1158)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1159)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1161)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1156)) ;
      }
      enumerator_48831.gotoNextObject () ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_49240 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_49240.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_49240.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1168)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1168)), enumerator_49240.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1168)) COMMA_SOURCE_FILE_AT_LINE (1168)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_49240.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1170)) ;
    }
    {
  ...
  cEnumerator_attributeInCollectionListAST enumerator_49873 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_49873.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_49873.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1184)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1184)) COMMA_SOURCE_FILE_AT_LINE (1184)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1184)), enumerator_49873.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1184)) COMMA_SOURCE_FILE_AT_LINE (1184)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_49873.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1186)) ;
    }
    ...
    enumerator_49873.gotoNextObject () ;
  }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_50875 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_50875.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_50875.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1203)) ;
    }
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_52617_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_52617_1 ; // Joker input parameter
  GALGAS_typedAttributeList joker_52657_2 ; // Joker input parameter
  GALGAS_attributeMap joker_52657_1 ; // Joker input parameter
  GALGAS_constructorMap joker_52713_11 ; // Joker input parameter
  GALGAS_readerMap joker_52713_10 ; // Joker input parameter
  GALGAS_modifierMap joker_52713_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_52713_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_52713_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_52713_6 ; // Joker input parameter
  GALGAS_stringlist joker_52713_5 ; // Joker input parameter
  GALGAS_uint joker_52713_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_52713_3 ; // Joker input parameter
  GALGAS_stringset joker_52713_2 ; // Joker input parameter
  GALGAS_lstringlist joker_52713_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_52767_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_52767_4 ; // Joker input parameter
  GALGAS_bool joker_52767_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_52767_2 ; // Joker input parameter
  GALGAS_string joker_52767_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_52617_2, joker_52617_1, var_typeKindEnum, joker_52657_2, joker_52657_1, var_mapTypedAttributeList, joker_52713_11, joker_52713_10, joker_52713_9, joker_52713_8, joker_52713_7, joker_52713_6, joker_52713_5, joker_52713_4, joker_52713_3, joker_52713_2, joker_52713_1, var_searchMethodList, joker_52767_5, joker_52767_4, joker_52767_3, joker_52767_2, joker_52767_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1257)) ;
  ...
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1273)) ;
  ...
  cEnumerator_mapSearchMethodListAST enumerator_55237 (var_searchMethodList, kEnumeration_up) ;
  while (enumerator_55237.hasCurrentObject ()) {
    {
    var_constructorMap.modifier_insertKey (enumerator_55237.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1316)) ;
    }
    enumerator_55237.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_56208 (var_mapTypedAttributeList, kEnumeration_up) ;
  while (enumerator_56208.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_56208.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1333)) COMMA_SOURCE_FILE_AT_LINE (1333)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_56350 (var_inheritedReaderMap.reader_keySet (SOURCE_FILE_AT_LINE (1335)), kEnumeration_up) ;
      while (enumerator_56350.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_56350.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (1336)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1336)) COMMA_SOURCE_FILE_AT_LINE (1336)) ;
        if (enumerator_56350.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (1337)) ;
        }
        enumerator_56350.gotoNextObject () ;
      }
      GALGAS_location location_3 (enumerator_56208.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      {
      var_readerMap.modifier_insertKey (enumerator_56208.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1344)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1345)), inCompiler->here (), GALGAS_bool (true), enumerator_56208.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1349)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1342)) ;
      }
    }
...
static void categoryMethod_externTypeDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externTypeDeclarationAST * object = (const cPtr_externTypeDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_externTypeDeclarationAST) ;
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1403)) ;
  ...
  cEnumerator_externTypeConstructorList enumerator_58791 (object->mAttribute_mExternTypeConstructorList, kEnumeration_up) ;
  while (enumerator_58791.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_58791.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1411)) ;
    }
    ...
    cEnumerator_lstringlist enumerator_59038 (enumerator_58791.current_mArgumentTypeNameList (HERE), kEnumeration_up) ;
    while (enumerator_59038.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59038.current_mValue (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1416)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1417)) ;
      enumerator_59038.gotoNextObject () ;
    }
    {
    var_constructorMap.modifier_insertKey (enumerator_58791.current_mConstructorName (HERE), var_arguments, GALGAS_bool (true), var_returnedTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1420)) ;
    }
    enumerator_58791.gotoNextObject () ;
  }
  cEnumerator_externTypeReaderList enumerator_59464 (object->mAttribute_mExternTypeReaderList, kEnumeration_up) ;
  while (enumerator_59464.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59464.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1430)) ;
    }
    ...
    cEnumerator_lstringlist enumerator_59711 (enumerator_59464.current_mArgumentTypeNameList (HERE), kEnumeration_up) ;
    while (enumerator_59711.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59711.current_mValue (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1435)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1436)) ;
      enumerator_59711.gotoNextObject () ;
    }
    {
    var_readerMap.modifier_insertKey (enumerator_59464.current_mReaderName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1441)), var_arguments, inCompiler->here (), GALGAS_bool (true), var_returnedTypeProxy, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1446)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1439)) ;
    }
    enumerator_59464.gotoNextObject () ;
  }
  cEnumerator_externTypeModifierList enumerator_60248 (object->mAttribute_mExternTypeModifierList, kEnumeration_up) ;
  while (enumerator_60248.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_60345 (enumerator_60248.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_60345.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60345.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1455)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_60345.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1460)) ;
      enumerator_60345.gotoNextObject () ;
    }
    {
    var_modifierMap.modifier_insertKey (enumerator_60248.current_mModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1465)), var_routineSignature, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1468)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1463)) ;
    }
    enumerator_60248.gotoNextObject () ;
  }
  cEnumerator_externTypeMethodList enumerator_60938 (object->mAttribute_mExternTypeMethodList, kEnumeration_up) ;
  while (enumerator_60938.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_61035 (enumerator_60938.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_61035.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61035.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1477)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_61035.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1482)) ;
      enumerator_61035.gotoNextObject () ;
    }
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_60938.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1487)), var_routineSignature, enumerator_60938.current_mDeclarationLocation (HERE), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1491)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1485)) ;
    }
    enumerator_60938.gotoNextObject () ;
  }
  {
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1548)) ;
  ...
  cEnumerator_unifiedTypeMapProxyList enumerator_67973 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE_AT_LINE (1677)), kEnumeration_up) ;
  while (enumerator_67973.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (enumerator_67973.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1678)) COMMA_SOURCE_FILE_AT_LINE (1678)) ;
    enumerator_67973.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_68102 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_68102.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_68102.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1683)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1686)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1681)) ;
    }
    enumerator_68102.gotoNextObject () ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
  ...
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1702)) COMMA_SOURCE_FILE_AT_LINE (1702)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1703)) COMMA_SOURCE_FILE_AT_LINE (1703)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("addEdge"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1705)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1706)), var_formalParameterList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1709)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1704)) ;
  }
  var_formalParameterList.drop () ; // drop instruction
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1714)) ;
  ...
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("noteNode"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1717)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1718)), var_formalParameterList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1721)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1716)) ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mGraphTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1726)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mGraphTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1740)), GALGAS_typeKindEnum::constructor_graphType (SOURCE_FILE_AT_LINE (1741)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1742)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1743)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1744)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1749)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1750)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1751)), function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (1752)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1753)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1754)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1755)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1756)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1757)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1758)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1760)), GALGAS_string ("emptyGraph"), inCompiler COMMA_SOURCE_FILE_AT_LINE (1737)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_enumDeclarationAST * object = (const cPtr_enumDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_enumDeclarationAST) ;
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1775)) ;
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1776)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1777)) ;
  GALGAS_classMethodMap var_classMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1778)) ;
  GALGAS_unifiedTypeMapProxy var_currentTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumTypeName, var_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1781)) ;
  }
  GALGAS_stringset var_constantSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1783)) ;
  cEnumerator_lstringlist enumerator_71749 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_71749.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_71749.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1785)) COMMA_SOURCE_FILE_AT_LINE (1785)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_71749.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1786)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1786)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1786)) ;
    }
    enumerator_71749.gotoNextObject () ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1790)) ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mEnumTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1792)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mEnumTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1806)), GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE_AT_LINE (1807)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1808)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1809)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1810)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1815)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1816)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1817)), function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (1818)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1818)) COMMA_SOURCE_FILE_AT_LINE (1818)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1819)), var_constantSet, object->mAttribute_mConstantList, GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1822)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1823)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1824)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1826)), object->mAttribute_mConstantList.reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1827)).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1803)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_filewrapperDeclarationAST * object = (const cPtr_filewrapperDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_filewrapperDeclarationAST) ;
  GALGAS_filewrapperTemplateMap var_filewrapperTemplateMap = GALGAS_filewrapperTemplateMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1912)) ;
  cEnumerator_filewrapperTemplateListAST enumerator_76342 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_76342.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxyList var_templateSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1914)) ;
    cEnumerator_formalTemplateInputParameterListAST enumerator_76460 (enumerator_76342.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_76460.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_76460.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1917)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1918)) ;
      enumerator_76460.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_76342.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_76342.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1920)) ;
    }
    enumerator_76342.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_textExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1927)) ;
  cEnumerator_lstringlist enumerator_76979 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_76979.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_76979.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1929)) ;
    }
    enumerator_76979.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_binaryFileExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1932)) ;
  cEnumerator_lstringlist enumerator_77185 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_77185.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_77185.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1934)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_77185.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_77185.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1935)) COMMA_SOURCE_FILE_AT_LINE (1935)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1935)) COMMA_SOURCE_FILE_AT_LINE (1935)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_77185.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1937)) ;
      }
    }
    enumerator_77185.gotoNextObject () ;
  }
  ...
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1944)).reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1944)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
  if (kBoolTrue == test_2) {
    var_absoluteSourcePath = object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1945)) ;
  }else if (kBoolFalse == test_2) {
    var_absoluteSourcePath = object->mAttribute_mSourceFileAbsolutePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (1947)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1947)).operator_concat (object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1947)) COMMA_SOURCE_FILE_AT_LINE (1947)) ;
  }
  const enumGalgasBool test_3 = var_absoluteSourcePath.reader_directoryExists (SOURCE_FILE_AT_LINE (1949)).operator_not (SOURCE_FILE_AT_LINE (1949)).boolEnum () ;
  if (kBoolTrue == test_3) {
    GALGAS_location location_4 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_4, GALGAS_string ("The '").operator_concat (var_absoluteSourcePath COMMA_SOURCE_FILE_AT_LINE (1950)).operator_concat (GALGAS_string ("' directory does not exist") COMMA_SOURCE_FILE_AT_LINE (1950)) COMMA_SOURCE_FILE_AT_LINE (1950)) ;
    ...
    {
    routine_recursivelyEnumerateDirectories (var_absoluteSourcePath, GALGAS_string ("/"), var_textExtensionMap, var_binaryFileExtensionMap, var_regularRootFileMap, var_wrapperDirectoryMap, var_wrapperFileIndex, var_wrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1956)) ;
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFilewrapperMap.modifier_insertKey (object->mAttribute_mFilewrapperName, object->mAttribute_mFilewrapperPath, object->mAttribute_mFilewrapperTextFileExtensionList, var_regularRootFileMap, var_wrapperDirectoryMap, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1968)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_79135 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_79135.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_79135.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1990)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_79379 (enumerator_79135.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_79379.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_79379.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_79379.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
    ...
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_79135.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2000)) ;
    enumerator_79135.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2004)) ;
  }
  GALGAS_unifiedTypeMapProxy var_listTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListTypeName, var_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (2007)) ;
  }
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2009)) ;
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2010)) ;
  GALGAS_formalParameterSignature var_modifierOutputFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2011)) ;
  GALGAS_formalParameterSignature var_modifierInputFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2012)) ;
  cEnumerator_typedAttributeList enumerator_80311 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_80311.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_80311.current_mAttributeTypeProxy (HERE), enumerator_80311.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2014)) COMMA_SOURCE_FILE_AT_LINE (2014)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_80311.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2015)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_80311.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2016)) COMMA_SOURCE_FILE_AT_LINE (2016)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_80311.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2017)) COMMA_SOURCE_FILE_AT_LINE (2017)) ;
    enumerator_80311.gotoNextObject () ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2020)) ;
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyList"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2021)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2021)) ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("listWithValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2023)), var_constructorAttributeTypeList, GALGAS_bool (false), var_listTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2022)) ;
  }
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2029)) ;
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("length"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2030)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("range"), GALGAS_string ("range"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2031)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("subListFromIndex"), GALGAS_string ("uint"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2032)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2032)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("subListWithRange"), GALGAS_string ("range"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2033)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2033)) ;
  }
  cEnumerator_typedAttributeList enumerator_81579 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_81579.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_81579.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_81579.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2037)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2037)), enumerator_81579.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2037)) COMMA_SOURCE_FILE_AT_LINE (2037)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2038)), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_uintType COMMA_SOURCE_FILE_AT_LINE (2039)), inCompiler->here (), GALGAS_bool (true), enumerator_81579.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2043)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2036)) ;
      }
    }
    enumerator_81579.gotoNextObject () ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2049)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popFirst"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2051)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2052)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2055)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2050)) ;
  }
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popLast"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2059)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2060)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2063)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2058)) ;
  }
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("prependValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2067)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2068)), var_modifierInputFormalArgumentList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2071)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2066)) ;
  }
  cEnumerator_typedAttributeList enumerator_82734 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_82734.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_82734.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_formalParameterSignature var_setterFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2076)) ;
      var_setterFormalArgumentList.addAssign_operation (enumerator_82734.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2077)) COMMA_SOURCE_FILE_AT_LINE (2077)) ;
      var_setterFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2078)) COMMA_SOURCE_FILE_AT_LINE (2078)) ;
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_82734.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2080)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2080)) COMMA_SOURCE_FILE_AT_LINE (2080)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2080)), enumerator_82734.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2080)) COMMA_SOURCE_FILE_AT_LINE (2080)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2081)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2084)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2079)) ;
      }
    }
    enumerator_82734.gotoNextObject () ;
  }
  var_modifierInputFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2090)) COMMA_SOURCE_FILE_AT_LINE (2090)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("insertAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2092)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2093)), var_modifierInputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2096)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2091)) ;
  }
  var_modifierInputFormalArgumentList.drop () ; // drop instruction
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2101)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("first"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2103)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2104)), var_modifierOutputFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2108)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2102)) ;
  }
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("last"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2112)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2113)), var_modifierOutputFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2117)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2111)) ;
  }
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2120)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2121)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2122)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mListTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2124)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2137)) COMMA_SOURCE_FILE_AT_LINE (2137)), object->mAttribute_mListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2137)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2135)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2144)), GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (2145)), var_typedAttributeList, GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2147)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2148)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2153)), var_enumerationDescriptor, var_enumerationVariants, function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2156)).operator_or (function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2156)) COMMA_SOURCE_FILE_AT_LINE (2156)).operator_or (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2156)) COMMA_SOURCE_FILE_AT_LINE (2156)), var_constructorAttributeTypeList, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2158)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2159)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2160)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2161)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2162)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptyList"), inCompiler COMMA_SOURCE_FILE_AT_LINE (2141)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2179)) ;
  }
  GALGAS_unifiedTypeMapProxy var_listTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mSortedListTypeName, var_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (2182)) ;
  }
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2184)) ;
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2185)) ;
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2186)) ;
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2187)) ;
  cEnumerator_attributeInCollectionListAST enumerator_86967 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_86967.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_86967.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2190)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_86967.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2193)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_86967.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2194)) COMMA_SOURCE_FILE_AT_LINE (2194)) ;
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2195)) ;
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2196)) COMMA_SOURCE_FILE_AT_LINE (2196)) ;
    enumerator_86967.gotoNextObject () ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2199)) ;
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptySortedList"), object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2200)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2200)) ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("sortedListWithValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2202)), var_constructorAttributeTypeList, GALGAS_bool (false), var_listTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2201)) ;
  }
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2208)) ;
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("length"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2209)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2211)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popGreatest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2213)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2214)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2217)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2212)) ;
  }
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popSmallest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2221)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2222)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2225)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2220)) ;
  }
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2229)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("greatest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2231)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2232)), var_modifierFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2236)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2230)) ;
  }
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("smallest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2240)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2241)), var_modifierFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2245)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2239)) ;
  }
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2249)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2250)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2251)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mSortedListTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2253)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mSortedListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2267)) COMMA_SOURCE_FILE_AT_LINE (2267)), object->mAttribute_mSortedListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2267)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2265)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mSortedListTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2274)), GALGAS_typeKindEnum::constructor_sortedListType (SOURCE_FILE_AT_LINE (2275)), var_typedAttributeList, GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2277)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2278)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2283)), var_enumerationDescriptor, var_enumerationVariants, function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2286)).operator_or (function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2286)) COMMA_SOURCE_FILE_AT_LINE (2286)).operator_or (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2286)) COMMA_SOURCE_FILE_AT_LINE (2286)), var_constructorAttributeTypeList, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2288)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2289)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2290)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2291)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2292)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptySortedList"), inCompiler COMMA_SOURCE_FILE_AT_LINE (2271)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mStructTypeName, var_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (2309)) ;
  }
  GALGAS_attributeMap var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2311)) ;
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2312)) ;
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2313)) ;
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2314)) ;
  cEnumerator_attributeInCollectionListAST enumerator_91516 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_91516.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_91516.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2317)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2318)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_91516.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2321)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_91516.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2322)) ;
    }
    enumerator_91516.gotoNextObject () ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2325)), var_constructorAttributeTypeList, GALGAS_bool (false), var_structTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2324)) ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2332)) ;
  }
  cEnumerator_typedAttributeList enumerator_92238 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_92238.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_92238.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2339)), enumerator_92238.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2340)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2336)) ;
    }
    enumerator_92238.gotoNextObject () ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2346)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2348)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mStructTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2350)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    var_enumeratedType = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2363)) ;
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumeratedElementTypeName, var_enumeratedType COMMA_SOURCE_FILE_AT_LINE (2365)) ;
    }
  }
  GALGAS_string var_defaultConstructorName = GALGAS_string ("default") ;
  cEnumerator_typedAttributeList enumerator_93423 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_93423.hasCurrentObject () && bool_1) {
    while (enumerator_93423.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_93423.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2374)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_93423.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2374)).operator_not (SOURCE_FILE_AT_LINE (2374)) COMMA_SOURCE_FILE_AT_LINE (2374)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_93423.gotoNextObject () ;
      if (enumerator_93423.hasCurrentObject ()) {
        bool_1 = GALGAS_bool (kIsNotEqual, var_defaultConstructorName.objectCompare (GALGAS_string::makeEmptyString ())).isValidAndTrue () ;
      }
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mStructTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2382)), GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (2383)), var_typedAttributeList, var_attributeMap, var_typedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2391)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2392)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2393)), function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (2394)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2395)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2396)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2397)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2398)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2399)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2400)), GALGAS_bool (false), var_enumeratedType, var_defaultConstructorName, inCompiler COMMA_SOURCE_FILE_AT_LINE (2379)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2416)) ;
  }
  GALGAS_readerMap var_readerMap ;
  GALGAS_modifierMap var_modifierMap ;
  GALGAS_instanceMethodMap var_instanceMethodMap ;
  GALGAS_typedAttributeList var_inheritedTypedAttributeList ;
  GALGAS_attributeMap var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2422)) ;
  GALGAS_unifiedTypeMapProxy var_superClassIndex ;
  GALGAS_bool var_generateHeaderInSeparateFile ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2426)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_superClassIndex = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2427)) ;
    {
    routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2428)) ;
    }
    var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2429)) ;
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2430)) ;
    var_inheritedTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2431)) ;
    var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2432)) ;
    var_generateHeaderInSeparateFile = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_95820 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_95820.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_95820.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2435)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_95820.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mSuperClassName, var_superClassIndex COMMA_SOURCE_FILE_AT_LINE (2440)) ;
    }
    GALGAS_typeKindEnum var_typeKindEnum ;
    ...
    GALGAS_bool joker_96297_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_96297_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_96382_2 ; // Joker input parameter
    GALGAS_constructorMap joker_96382_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_96473_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_96473_9 ; // Joker input parameter
    GALGAS_stringlist joker_96473_8 ; // Joker input parameter
    GALGAS_uint joker_96473_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_96473_6 ; // Joker input parameter
    GALGAS_stringset joker_96473_5 ; // Joker input parameter
    GALGAS_lstringlist joker_96473_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_96473_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_96473_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_96473_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_96519_2 ; // Joker input parameter
    GALGAS_string joker_96519_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_96297_2, joker_96297_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_96382_2, joker_96382_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_96473_10, joker_96473_9, joker_96473_8, joker_96473_7, joker_96473_6, joker_96473_5, joker_96473_4, joker_96473_3, joker_96473_2, joker_96473_1, var_generateHeaderInSeparateFile, joker_96519_2, joker_96519_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2445)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2460)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (object->mAttribute_mSuperClassName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the @").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2461)) COMMA_SOURCE_FILE_AT_LINE (2461)).operator_concat (GALGAS_string (" should be a class type") COMMA_SOURCE_FILE_AT_LINE (2461)) COMMA_SOURCE_FILE_AT_LINE (2461)) ;
    }
    var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2464)) ;
    cEnumerator_modifierMap enumerator_96808 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_96808.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_96808.current_lkey (HERE), enumerator_96808.current_mKind (HERE), enumerator_96808.current_mParameterList (HERE), enumerator_96808.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2471)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2466)) ;
      }
      enumerator_96808.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2476)) ;
    cEnumerator_readerMap enumerator_97134 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_97134.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_97134.current_lkey (HERE), enumerator_97134.current_mKind (HERE), enumerator_97134.current_mArgumentTypeList (HERE), enumerator_97134.current_mDeclarationLocation (HERE), enumerator_97134.current_mHasCompilerArgument (HERE), enumerator_97134.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2485)), enumerator_97134.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2478)) ;
      }
      enumerator_97134.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2490)) ;
    cEnumerator_instanceMethodMap enumerator_97522 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_97522.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_97522.current_lkey (HERE), enumerator_97522.current_mKind (HERE), enumerator_97522.current_mParameterList (HERE), enumerator_97522.current_mDeclarationLocation (HERE), enumerator_97522.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2498)), enumerator_97522.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2492)) ;
      }
      enumerator_97522.gotoNextObject () ;
    }
  }
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2504)) ;
  cEnumerator_typedAttributeList enumerator_97941 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_97941.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_97941.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2506)) ;
    enumerator_97941.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_98044 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_98044.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_98044.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2510)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2511)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_98044.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2512)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_98044.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2513)) COMMA_SOURCE_FILE_AT_LINE (2513)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_98044.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_98044.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2514)) COMMA_SOURCE_FILE_AT_LINE (2514)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader") COMMA_SOURCE_FILE_AT_LINE (2514)) COMMA_SOURCE_FILE_AT_LINE (2514)) ;
    }
    enumerator_98044.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_classIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mClassTypeName, var_classIndex COMMA_SOURCE_FILE_AT_LINE (2518)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2524)) ;
  const enumGalgasBool test_6 = object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (2525)).boolEnum () ;
  if (kBoolTrue == test_6) {
    {
    var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2527)), var_constructorAttributeTypeList, GALGAS_bool (false), var_classIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2526)) ;
    }
  }
  GALGAS_typedAttributeList var_currentClassTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2534)) ;
  GALGAS_typedAttributeList var_allTypedAttributeList = var_inheritedTypedAttributeList ;
  cEnumerator_attributeInCollectionListAST enumerator_99120 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_99120.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_99120.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2538)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_99364 (enumerator_99120.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_99364.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_99364.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2542)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_99364.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2544)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_99364.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_99120.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2548)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_99120.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2549)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_99120.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2553)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2554)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2558)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2551)) ;
      }
    }
    enumerator_99120.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_100420 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_100420.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_100420.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_100420.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2573)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2573)) COMMA_SOURCE_FILE_AT_LINE (2573)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2573)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2574)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_100420.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2575)) COMMA_SOURCE_FILE_AT_LINE (2575)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2577)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2572)) ;
      }
    }
    enumerator_100420.gotoNextObject () ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mClassTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2583)) ;
  }
  GALGAS_string var_defaultConstructorName ;
  const enumGalgasBool test_11 = var_superClassIndex.reader_isNull (SOURCE_FILE_AT_LINE (2595)).boolEnum () ;
  if (kBoolTrue == test_11) {
    var_defaultConstructorName = GALGAS_string ("default") ;
  }else if (kBoolFalse == test_11) {
    var_defaultConstructorName = var_superClassIndex.reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2598)) ;
  }
  cEnumerator_typedAttributeList enumerator_101441 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_101441.hasCurrentObject () && bool_12) {
    while (enumerator_101441.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_101441.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2601)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_101441.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2601)).operator_not (SOURCE_FILE_AT_LINE (2601)) COMMA_SOURCE_FILE_AT_LINE (2601)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_101441.gotoNextObject () ;
      if (enumerator_101441.hasCurrentObject ()) {
        bool_12 = GALGAS_bool (kIsNotEqual, var_defaultConstructorName.objectCompare (GALGAS_string::makeEmptyString ())).isValidAndTrue () ;
      }
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mClassTypeName, object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (2608)), var_superClassIndex, GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2610)), var_allTypedAttributeList, var_attributeMap, var_currentClassTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2618)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2619)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2620)), GALGAS_uint ((PMUInt32) 0U), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2622)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2623)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2624)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2625)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2626)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2627)), var_generateHeaderInSeparateFile, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2629)), var_defaultConstructorName, inCompiler COMMA_SOURCE_FILE_AT_LINE (2606)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externRoutineDeclarationAST * object = (const cPtr_externRoutineDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_externRoutineDeclarationAST) ;
  GALGAS_formalParameterSignature var_routineSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2643)) ;
  cEnumerator_formalParameterListAST enumerator_103089 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_103089.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_103089.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2646)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_103089.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (2647)) ;
    enumerator_103089.gotoNextObject () ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mRoutineMap.modifier_insertKey (object->mAttribute_mRoutineName, var_routineSignature, inCompiler COMMA_SOURCE_FILE_AT_LINE (2650)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externFunctionDeclarationAST * object = (const cPtr_externFunctionDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_externFunctionDeclarationAST) ;
  GALGAS_unifiedTypeMapProxyList var_functionSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2662)) ;
  cEnumerator_formalInputParameterListAST enumerator_104068 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_104068.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_104068.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2665)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2666)) ;
    enumerator_104068.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName, var_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2670)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2672)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2687)), var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2687)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_arrayDeclarationAST) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2699)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mDimension.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the dimension of an array should be > 0") COMMA_SOURCE_FILE_AT_LINE (2700)) ;
  }
  GALGAS_unifiedTypeMapProxy var_arrayTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mArrayTypeName, var_arrayTypeIndex COMMA_SOURCE_FILE_AT_LINE (2704)) ;
  }
  GALGAS_unifiedTypeMapProxy var_elementTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mElementTypeName, var_elementTypeIndex COMMA_SOURCE_FILE_AT_LINE (2707)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2709)) ;
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2710)) ;
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2711)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2712)) ;
  GALGAS_unifiedTypeMapProxy var_boolType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("bool"), var_boolType COMMA_SOURCE_FILE_AT_LINE (2715)) ;
  }
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2718)) ;
  }
  GALGAS_unifiedTypeMapProxyList var_uintArgs = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2720)) ;
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2722)).isValid ()) {
    PMUInt32 variant_106784 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2722)).uintValue () ;
    bool loop_106784 = true ;
    while (loop_106784) {
      loop_106784 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2722)))).isValid () ;
      if (loop_106784) {
        loop_106784 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2722)))).boolValue () ;
      }
      if (loop_106784 && (0 == variant_106784)) {
        loop_106784 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2722)) ;
      }
      if (loop_106784) {
        variant_106784 -- ;
        var_uintArgs.addAssign_operation (var_uintType COMMA_SOURCE_FILE_AT_LINE (2723)) ;
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (2724)) ;
      }
    }
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2728)), var_uintArgs, GALGAS_bool (false), var_arrayTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2727)) ;
  }
  {
  routine_enterBaseReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("axisCount"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2734)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("sizeForAxis"), GALGAS_string ("uint"), GALGAS_string ("uint"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2735)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("rangeForAxis"), GALGAS_string ("uint"), GALGAS_string ("range"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2736)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("isValueValidAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2738)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2739)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_boolType, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2744)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2737)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("valueAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2748)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2749)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_elementTypeIndex, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2754)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2747)) ;
  }
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2758)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_elementTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2759)) COMMA_SOURCE_FILE_AT_LINE (2759)) ;
  var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2761)).isValid ()) {
    PMUInt32 variant_108037 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2761)).uintValue () ;
    bool loop_108037 = true ;
    while (loop_108037) {
      loop_108037 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2761)))).isValid () ;
      if (loop_108037) {
        loop_108037 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2761)))).boolValue () ;
      }
      if (loop_108037 && (0 == variant_108037)) {
        loop_108037 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2761)) ;
      }
      if (loop_108037) {
        variant_108037 -- ;
        var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2762)) COMMA_SOURCE_FILE_AT_LINE (2762)) ;
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (2763)) ;
      }
    }
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2766)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2767)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2770)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2765)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("forceValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2774)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2775)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2778)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2773)) ;
  }
  {
  GALGAS_unifiedTypeMapProxy joker_108632_0 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_108635_0 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_108632_0, joker_108635_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2781)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("invalidateValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2783)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2784)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2787)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2782)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSize").reader_nowhere (SOURCE_FILE_AT_LINE (2791)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2792)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2795)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2790)) ;
  }
  var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2798)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2799)) COMMA_SOURCE_FILE_AT_LINE (2799)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2800)) COMMA_SOURCE_FILE_AT_LINE (2800)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSizeForAxis").reader_nowhere (SOURCE_FILE_AT_LINE (2802)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2803)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2806)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2801)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mArrayTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2813)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE_AT_LINE (2814)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2815)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2816)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2817)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2822)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2823)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2824)), GALGAS_uint ((PMUInt32) 0U), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2826)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2827)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2828)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2829)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2830)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2831)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2833)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2810)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_111019_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_111019_1 ; // Joker input parameter
  GALGAS_attributeMap joker_111108_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_111108_18 ; // Joker input parameter
  GALGAS_constructorMap joker_111108_17 ; // Joker input parameter
  GALGAS_readerMap joker_111108_16 ; // Joker input parameter
  GALGAS_modifierMap joker_111108_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_111108_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_111108_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_111108_12 ; // Joker input parameter
  GALGAS_stringlist joker_111108_11 ; // Joker input parameter
  GALGAS_uint joker_111108_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_111108_9 ; // Joker input parameter
  GALGAS_stringset joker_111108_8 ; // Joker input parameter
  GALGAS_lstringlist joker_111108_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_111108_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_111108_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_111108_4 ; // Joker input parameter
  GALGAS_bool joker_111108_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_111108_2 ; // Joker input parameter
  GALGAS_string joker_111108_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_111019_2, joker_111019_1, var_typeKindEnum, var_listTypedAttributeList, joker_111108_19, joker_111108_18, joker_111108_17, joker_111108_16, joker_111108_15, joker_111108_14, joker_111108_13, joker_111108_12, joker_111108_11, joker_111108_10, joker_111108_9, joker_111108_8, joker_111108_7, joker_111108_6, joker_111108_5, joker_111108_4, joker_111108_3, joker_111108_2, joker_111108_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2848)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (2855)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2856)) COMMA_SOURCE_FILE_AT_LINE (2856)).operator_concat (GALGAS_string ("' type should be a list type") COMMA_SOURCE_FILE_AT_LINE (2856)) COMMA_SOURCE_FILE_AT_LINE (2856)) ;
    var_listTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2857)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2860)) ;
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2861)) ;
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2862)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2863)) ;
  GALGAS_unifiedTypeMapProxy var_associatedListTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedListTypeName, var_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (2866)) ;
  }
  GALGAS_unifiedTypeMapProxy var_currentTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListmapTypeName, var_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (2869)) ;
  }
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2872)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("count"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2874)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("allKeys"), GALGAS_string ("stringset"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2875)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2876)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("listForKey"), GALGAS_string ("string"), object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2877)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2877)) ;
  }
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyMap"), object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2879)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2879)) ;
  }
  GALGAS_enumerationDescriptorList var_enumeratorDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2881)) ;
  var_enumeratorDescriptor.addAssign_operation (var_stringTypeIndex, GALGAS_string ("key") COMMA_SOURCE_FILE_AT_LINE (2882)) ;
  var_enumeratorDescriptor.addAssign_operation (var_associatedListTypeIndex, GALGAS_string ("mList") COMMA_SOURCE_FILE_AT_LINE (2883)) ;
  GALGAS_unifiedTypeMapProxyList var_addAssignOperatorDescription = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2885)) ;
  var_addAssignOperatorDescription.addAssign_operation (var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2886)) ;
  cEnumerator_typedAttributeList enumerator_113103 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_113103.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_113103.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2888)) ;
    enumerator_113103.gotoNextObject () ;
  }
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2891)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2892)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2893)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mListmapTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2895)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2909)) COMMA_SOURCE_FILE_AT_LINE (2909)), object->mAttribute_mListmapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2909)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2907)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListmapTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2916)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE_AT_LINE (2917)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2918)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2919)), var_listTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2925)), var_enumeratorDescriptor, var_enumerationVariants, function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2928)), var_addAssignOperatorDescription, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2930)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2931)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2932)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2933)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2934)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptyMap"), inCompiler COMMA_SOURCE_FILE_AT_LINE (2913)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_predefinedTypeAST * object = (const cPtr_predefinedTypeAST *) inObject ;
  macroValidSharedObject (object, const cPtr_predefinedTypeAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mPredefinedTypeName COMMA_SOURCE_FILE_AT_LINE (2970)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2970)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_predefinedTypeAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2971)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_classDeclarationAST * object = (const cPtr_classDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_classDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (2983)) COMMA_SOURCE_FILE_AT_LINE (2983)), object->mAttribute_mClassTypeName.reader_location (SOURCE_FILE_AT_LINE (2983)) COMMA_SOURCE_FILE_AT_LINE (2983)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_classDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2984)) ;
  }
  ...
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2986)) COMMA_SOURCE_FILE_AT_LINE (2986)), object->mAttribute_mSuperClassName.reader_location (SOURCE_FILE_AT_LINE (2986)) COMMA_SOURCE_FILE_AT_LINE (2986)) COMMA_SOURCE_FILE_AT_LINE (2986)) ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_117335 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_117335.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_117335.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2989)) COMMA_SOURCE_FILE_AT_LINE (2989)), enumerator_117335.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2989)) COMMA_SOURCE_FILE_AT_LINE (2989)) COMMA_SOURCE_FILE_AT_LINE (2989)) ;
    }
    enumerator_117335.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_listDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (3003)) COMMA_SOURCE_FILE_AT_LINE (3003)), object->mAttribute_mListTypeName.reader_location (SOURCE_FILE_AT_LINE (3003)) COMMA_SOURCE_FILE_AT_LINE (3003)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  cEnumerator_attributeInCollectionListAST enumerator_118317 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_118317.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_118317.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3006)) COMMA_SOURCE_FILE_AT_LINE (3006)), enumerator_118317.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3006)) COMMA_SOURCE_FILE_AT_LINE (3006)) COMMA_SOURCE_FILE_AT_LINE (3006)) ;
    }
    enumerator_118317.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_structDeclarationAST * object = (const cPtr_structDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_structDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (3019)) COMMA_SOURCE_FILE_AT_LINE (3019)), object->mAttribute_mStructTypeName.reader_location (SOURCE_FILE_AT_LINE (3019)) COMMA_SOURCE_FILE_AT_LINE (3019)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_structDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3020)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_119178 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_119178.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_119178.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3022)) COMMA_SOURCE_FILE_AT_LINE (3022)), enumerator_119178.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3022)) COMMA_SOURCE_FILE_AT_LINE (3022)) COMMA_SOURCE_FILE_AT_LINE (3022)) ;
    }
    enumerator_119178.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_enumDeclarationAST * object = (const cPtr_enumDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_enumDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (3035)) COMMA_SOURCE_FILE_AT_LINE (3035)), object->mAttribute_mEnumTypeName.reader_location (SOURCE_FILE_AT_LINE (3035)) COMMA_SOURCE_FILE_AT_LINE (3035)) ;
  {
  //--- @selfCopyInExpressionForGeneration
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_sortedListDeclarationAST * object = (const cPtr_sortedListDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_sortedListDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (3048)) COMMA_SOURCE_FILE_AT_LINE (3048)), object->mAttribute_mSortedListTypeName.reader_location (SOURCE_FILE_AT_LINE (3048)) COMMA_SOURCE_FILE_AT_LINE (3048)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_sortedListDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3049)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_120744 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_120744.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_120744.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3051)) COMMA_SOURCE_FILE_AT_LINE (3051)), enumerator_120744.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3051)) COMMA_SOURCE_FILE_AT_LINE (3051)) COMMA_SOURCE_FILE_AT_LINE (3051)) ;
    }
    enumerator_120744.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_arrayDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mArrayTypeName.reader_string (SOURCE_FILE_AT_LINE (3064)) COMMA_SOURCE_FILE_AT_LINE (3064)), object->mAttribute_mArrayTypeName.reader_location (SOURCE_FILE_AT_LINE (3064)) COMMA_SOURCE_FILE_AT_LINE (3064)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_arrayDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3065)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mElementTypeName.reader_string (SOURCE_FILE_AT_LINE (3066)) COMMA_SOURCE_FILE_AT_LINE (3066)), object->mAttribute_mElementTypeName.reader_location (SOURCE_FILE_AT_LINE (3066)) COMMA_SOURCE_FILE_AT_LINE (3066)) COMMA_SOURCE_FILE_AT_LINE (3066)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listmapDeclarationAST * object = (const cPtr_listmapDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_listmapDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (3078)) COMMA_SOURCE_FILE_AT_LINE (3078)), object->mAttribute_mListmapTypeName.reader_location (SOURCE_FILE_AT_LINE (3078)) COMMA_SOURCE_FILE_AT_LINE (3078)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_listmapDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3079)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (3080)) COMMA_SOURCE_FILE_AT_LINE (3080)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (3080)) COMMA_SOURCE_FILE_AT_LINE (3080)) COMMA_SOURCE_FILE_AT_LINE (3080)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapDeclarationAST * object = (const cPtr_mapDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_mapDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (3092)) COMMA_SOURCE_FILE_AT_LINE (3092)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (3092)) COMMA_SOURCE_FILE_AT_LINE (3092)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_mapDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3093)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_123240 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123240.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123240.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3095)) COMMA_SOURCE_FILE_AT_LINE (3095)), enumerator_123240.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3095)) COMMA_SOURCE_FILE_AT_LINE (3095)) COMMA_SOURCE_FILE_AT_LINE (3095)) ;
    }
    enumerator_123240.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_uniqueMapDeclarationAST * object = (const cPtr_uniqueMapDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_uniqueMapDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (3108)) COMMA_SOURCE_FILE_AT_LINE (3108)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (3108)) COMMA_SOURCE_FILE_AT_LINE (3108)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_uniqueMapDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3109)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_124098 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_124098.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_124098.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3111)) COMMA_SOURCE_FILE_AT_LINE (3111)), enumerator_124098.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3111)) COMMA_SOURCE_FILE_AT_LINE (3111)) COMMA_SOURCE_FILE_AT_LINE (3111)) ;
    }
    enumerator_124098.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapProxyDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapProxyDeclarationAST * object = (const cPtr_mapProxyDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_mapProxyDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE_AT_LINE (3124)) COMMA_SOURCE_FILE_AT_LINE (3124)), object->mAttribute_mMapProxyTypeName.reader_location (SOURCE_FILE_AT_LINE (3124)) COMMA_SOURCE_FILE_AT_LINE (3124)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_mapProxyDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3125)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedMapTypeName.reader_string (SOURCE_FILE_AT_LINE (3126)) COMMA_SOURCE_FILE_AT_LINE (3126)), object->mAttribute_mAssociatedMapTypeName.reader_location (SOURCE_FILE_AT_LINE (3126)) COMMA_SOURCE_FILE_AT_LINE (3126)) COMMA_SOURCE_FILE_AT_LINE (3126)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_graphDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_graphDeclarationAST * object = (const cPtr_graphDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_graphDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mGraphTypeName.reader_string (SOURCE_FILE_AT_LINE (3138)) COMMA_SOURCE_FILE_AT_LINE (3138)), object->mAttribute_mGraphTypeName.reader_location (SOURCE_FILE_AT_LINE (3138)) COMMA_SOURCE_FILE_AT_LINE (3138)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_graphDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3139)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (3140)) COMMA_SOURCE_FILE_AT_LINE (3140)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (3140)) COMMA_SOURCE_FILE_AT_LINE (3140)) COMMA_SOURCE_FILE_AT_LINE (3140)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externTypeDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externTypeDeclarationAST * object = (const cPtr_externTypeDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_externTypeDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mExternTypeName.reader_string (SOURCE_FILE_AT_LINE (3152)) COMMA_SOURCE_FILE_AT_LINE (3152)), object->mAttribute_mExternTypeName.reader_location (SOURCE_FILE_AT_LINE (3152)) COMMA_SOURCE_FILE_AT_LINE (3152)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_externTypeDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3153)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryReaderAST * object = (const cPtr_categoryReaderAST *) inObject ;
  macroValidSharedObject (object, const cPtr_categoryReaderAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3273)) COMMA_SOURCE_FILE_AT_LINE (3273)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3273)).operator_concat (object->mAttribute_mCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (3273)) COMMA_SOURCE_FILE_AT_LINE (3273)), object->mAttribute_mCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (3273)) COMMA_SOURCE_FILE_AT_LINE (3273)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryReaderAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3274)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3275)) COMMA_SOURCE_FILE_AT_LINE (3275)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3275)) COMMA_SOURCE_FILE_AT_LINE (3275)) COMMA_SOURCE_FILE_AT_LINE (3275)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3277)) COMMA_SOURCE_FILE_AT_LINE (3277)).operator_not (SOURCE_FILE_AT_LINE (3277)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3280)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3278)) ;
    }
  }
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_133183 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3283)) ;
  if (NULL != objectArray_133183) {
      macroValidSharedObject (objectArray_133183, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_133183->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3284)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryMethodAST * object = (const cPtr_categoryMethodAST *) inObject ;
  macroValidSharedObject (object, const cPtr_categoryMethodAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3301)) COMMA_SOURCE_FILE_AT_LINE (3301)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3301)).operator_concat (object->mAttribute_mCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (3301)) COMMA_SOURCE_FILE_AT_LINE (3301)), object->mAttribute_mCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (3301)) COMMA_SOURCE_FILE_AT_LINE (3301)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryMethodAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3302)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3303)) COMMA_SOURCE_FILE_AT_LINE (3303)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3303)) COMMA_SOURCE_FILE_AT_LINE (3303)) COMMA_SOURCE_FILE_AT_LINE (3303)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3305)) COMMA_SOURCE_FILE_AT_LINE (3305)).operator_not (SOURCE_FILE_AT_LINE (3305)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3308)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3306)) ;
    }
  }
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_134485 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3311)) ;
  if (NULL != objectArray_134485) {
      macroValidSharedObject (objectArray_134485, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_134485->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3312)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryModifierAST * object = (const cPtr_categoryModifierAST *) inObject ;
  macroValidSharedObject (object, const cPtr_categoryModifierAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3328)) COMMA_SOURCE_FILE_AT_LINE (3328)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3328)).operator_concat (object->mAttribute_mCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (3328)) COMMA_SOURCE_FILE_AT_LINE (3328)), object->mAttribute_mCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (3328)) COMMA_SOURCE_FILE_AT_LINE (3328)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryModifierAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3329)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3330)) COMMA_SOURCE_FILE_AT_LINE (3330)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3330)) COMMA_SOURCE_FILE_AT_LINE (3330)) COMMA_SOURCE_FILE_AT_LINE (3330)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3332)) COMMA_SOURCE_FILE_AT_LINE (3332)).operator_not (SOURCE_FILE_AT_LINE (3332)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3335)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3333)) ;
    }
  }
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_135757 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3338)) ;
  if (NULL != objectArray_135757) {
      macroValidSharedObject (objectArray_135757, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_135757->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3339)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3355)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryReaderAST * object = (const cPtr_abstractCategoryReaderAST *) inObject ;
  macroValidSharedObject (object, const cPtr_abstractCategoryReaderAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3367)) COMMA_SOURCE_FILE_AT_LINE (3367)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3367)).operator_concat (object->mAttribute_mAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (3367)) COMMA_SOURCE_FILE_AT_LINE (3367)), object->mAttribute_mAbstractCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (3367)) COMMA_SOURCE_FILE_AT_LINE (3367)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_abstractCategoryReaderAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3368)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3369)) COMMA_SOURCE_FILE_AT_LINE (3369)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3369)) COMMA_SOURCE_FILE_AT_LINE (3369)) COMMA_SOURCE_FILE_AT_LINE (3369)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3371)) COMMA_SOURCE_FILE_AT_LINE (3371)).operator_not (SOURCE_FILE_AT_LINE (3371)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3374)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3372)) ;
    }
  }
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_137658 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3377)) ;
  if (NULL != objectArray_137658) {
      macroValidSharedObject (objectArray_137658, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_137658->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3378)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryMethodAST * object = (const cPtr_abstractCategoryMethodAST *) inObject ;
  macroValidSharedObject (object, const cPtr_abstractCategoryMethodAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3395)) COMMA_SOURCE_FILE_AT_LINE (3395)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3395)).operator_concat (object->mAttribute_mAbstractCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (3395)) COMMA_SOURCE_FILE_AT_LINE (3395)), object->mAttribute_mAbstractCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (3395)) COMMA_SOURCE_FILE_AT_LINE (3395)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_abstractCategoryMethodAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3396)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3397)) COMMA_SOURCE_FILE_AT_LINE (3397)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3397)) COMMA_SOURCE_FILE_AT_LINE (3397)) COMMA_SOURCE_FILE_AT_LINE (3397)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3399)) COMMA_SOURCE_FILE_AT_LINE (3399)).operator_not (SOURCE_FILE_AT_LINE (3399)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3402)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3400)) ;
    }
  }
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_139008 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3405)) ;
  if (NULL != objectArray_139008) {
      macroValidSharedObject (objectArray_139008, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_139008->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3406)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryModifierAST * object = (const cPtr_abstractCategoryModifierAST *) inObject ;
  macroValidSharedObject (object, const cPtr_abstractCategoryModifierAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3422)) COMMA_SOURCE_FILE_AT_LINE (3422)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3422)).operator_concat (object->mAttribute_mAbstractCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (3422)) COMMA_SOURCE_FILE_AT_LINE (3422)), object->mAttribute_mAbstractCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (3422)) COMMA_SOURCE_FILE_AT_LINE (3422)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_abstractCategoryModifierAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3423)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3424)) COMMA_SOURCE_FILE_AT_LINE (3424)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3424)) COMMA_SOURCE_FILE_AT_LINE (3424)) COMMA_SOURCE_FILE_AT_LINE (3424)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3426)) COMMA_SOURCE_FILE_AT_LINE (3426)).operator_not (SOURCE_FILE_AT_LINE (3426)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3429)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3427)) ;
    }
  }
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_140320 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3432)) ;
  if (NULL != objectArray_140320) {
      macroValidSharedObject (objectArray_140320, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_140320->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3433)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapDeclarationAST * object = (const cPtr_mapDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_mapDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3452)) ;
  var_structAttributeList.addAssign_operation (GALGAS_string ("lstring").reader_nowhere (SOURCE_FILE_AT_LINE (3454)), GALGAS_string ("lkey").reader_nowhere (SOURCE_FILE_AT_LINE (3455)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3456)) COMMA_SOURCE_FILE_AT_LINE (3453)) ;
  cEnumerator_attributeInCollectionListAST enumerator_141159 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_141159.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_141159.current_mAttributeTypeName (HERE), enumerator_141159.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3462)) COMMA_SOURCE_FILE_AT_LINE (3459)) ;
    enumerator_141159.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mMapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3467)) COMMA_SOURCE_FILE_AT_LINE (3467)), object->mAttribute_mMapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3467)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3465)) COMMA_SOURCE_FILE_AT_LINE (3465)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_listDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3478)) ;
  cEnumerator_attributeInCollectionListAST enumerator_141793 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_141793.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_141793.current_mAttributeTypeName (HERE), enumerator_141793.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3483)) COMMA_SOURCE_FILE_AT_LINE (3480)) ;
    enumerator_141793.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3488)) COMMA_SOURCE_FILE_AT_LINE (3488)), object->mAttribute_mListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3488)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3486)) COMMA_SOURCE_FILE_AT_LINE (3486)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_sortedListDeclarationAST * object = (const cPtr_sortedListDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_sortedListDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3499)) ;
  cEnumerator_attributeInCollectionListAST enumerator_142435 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_142435.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_142435.current_mAttributeTypeName (HERE), enumerator_142435.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3504)) COMMA_SOURCE_FILE_AT_LINE (3501)) ;
    enumerator_142435.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mSortedListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3509)) COMMA_SOURCE_FILE_AT_LINE (3509)), object->mAttribute_mSortedListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3509)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3507)) COMMA_SOURCE_FILE_AT_LINE (3507)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listmapDeclarationAST * object = (const cPtr_listmapDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_listmapDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3520)) ;
  var_structAttributeList.addAssign_operation (GALGAS_string ("string").reader_nowhere (SOURCE_FILE_AT_LINE (3522)), GALGAS_string ("key").reader_nowhere (SOURCE_FILE_AT_LINE (3523)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3524)) COMMA_SOURCE_FILE_AT_LINE (3521)) ;
  var_structAttributeList.addAssign_operation (object->mAttribute_mAssociatedListTypeName, GALGAS_string ("mList").reader_nowhere (SOURCE_FILE_AT_LINE (3528)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3529)) COMMA_SOURCE_FILE_AT_LINE (3526)) ;
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (GALGAS_bool (true), GALGAS_lstring::constructor_new (object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3534)) COMMA_SOURCE_FILE_AT_LINE (3534)), object->mAttribute_mListmapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3534)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3532)) COMMA_SOURCE_FILE_AT_LINE (3532)) ;
}
//---------------------------------------------------------------------------*
