...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_149073 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149073.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_149073.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3609)) COMMA_SOURCE_FILE_AT_LINE (3609)) COMMA_SOURCE_FILE_AT_LINE (3609)) ;
        enumerator_149073.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_149881 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149881.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_149881.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3629)) ;
        enumerator_149881.gotoNextObject () ;
      }
    }
  }
}
