...
void routine_addCategories (const GALGAS_categoryMethodMapForBuildingContext constinArgument_inCategoryMethodMapForBuildingContext,
  ...
  if (kBoolTrue == test_0) {
    ...
    while (enumerator_19700.hasCurrentObject ()) {
      ...
      while (enumerator_19803.hasCurrentObject ()) {
        ...
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_19803.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (497)) ;
        }
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_19803.current_mFormalArgumentPassingMode (HERE), enumerator_19803.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (502)) ;
        enumerator_19803.gotoNextObject () ;
      }
      {
      ioArgument_ioInstanceMethodMap.modifier_insertKey (enumerator_19700.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE_AT_LINE (506)), var_formalArgumentList, enumerator_19700.current_lkey (HERE).reader_location (SOURCE_FILE_AT_LINE (508)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (510)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (504)) ;
      }
  ...
  if (kBoolTrue == test_1) {
    ...
    cEnumerator_categoryReaderMapForType enumerator_20673 (var_categoryReaderMapForType, kEnumeration_up) ;
    while (enumerator_20673.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxyList var_formalArgumentList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (520)) ;
      cEnumerator_formalInputParameterListAST enumerator_20780 (enumerator_20673.current_mInputFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_20780.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_20780.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (523)) ;
        }
        var_formalArgumentList.addAssign_operation (var_typeIndex COMMA_SOURCE_FILE_AT_LINE (524)) ;
        enumerator_20780.gotoNextObject () ;
      }
      GALGAS_unifiedTypeMapProxy var_returnedType ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_20673.current_mResultTypeName (HERE), var_returnedType COMMA_SOURCE_FILE_AT_LINE (527)) ;
      }
      {
      ioArgument_ioReaderMap.modifier_insertKey (enumerator_20673.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE_AT_LINE (530)), var_formalArgumentList, enumerator_20673.current_lkey (HERE).reader_location (SOURCE_FILE_AT_LINE (532)), GALGAS_bool (true), var_returnedType, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (535)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (528)) ;
      }
  ...
  if (kBoolTrue == test_2) {
    ...
    cEnumerator_categoryModifierMapForType enumerator_21745 (var_categoryModifierMapForType, kEnumeration_up) ;
    while (enumerator_21745.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_21848 (enumerator_21745.current_mFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_21848.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_21848.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (548)) ;
        }
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_21848.current_mFormalArgumentPassingMode (HERE), enumerator_21848.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (549)) ;
        enumerator_21848.gotoNextObject () ;
      }
      {
      ioArgument_ioModifierMap.modifier_insertKey (enumerator_21745.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE_AT_LINE (553)), var_formalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (556)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (551)) ;
      }
...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  ioArgument_ioWrapperDirectoryIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1864)) ;
  GALGAS_stringlist var_files = constinArgument_inAbsoluteSourcePath.reader_regularFiles (GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1866)) ;
  outArgument_outWrapperFileMap = GALGAS_wrapperFileMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1867)) ;
  cEnumerator_stringlist enumerator_75604 (var_files, kEnumeration_up) ;
  while (enumerator_75604.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_75604.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1869)) COMMA_SOURCE_FILE_AT_LINE (1869)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1870)).operator_concat (enumerator_75604.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1870)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_75604.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1872)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1871)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1878)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_75604.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1879)) COMMA_SOURCE_FILE_AT_LINE (1879)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1880)).operator_concat (enumerator_75604.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1880)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_75604.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1882)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1881)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1888)) ;
      }
    }
    enumerator_75604.gotoNextObject () ;
  }
  GALGAS_stringlist var_directories = constinArgument_inAbsoluteSourcePath.reader_directories (GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1892)) ;
  outArgument_outWrapperDirectoryMap = GALGAS_wrapperDirectoryMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1893)) ;
  cEnumerator_stringlist enumerator_76569 (var_directories, kEnumeration_up) ;
  while (enumerator_76569.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1899)).operator_concat (enumerator_76569.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1899)), constinArgument_inPathInWrapper.operator_concat (enumerator_76569.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1900)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1900)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1898)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76569.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1909)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1908)) ;
    }
    enumerator_76569.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_146299 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_146299.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_146299.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3572)) ;
    enumerator_146299.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147032 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147032.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_147032.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3584)) ;
    enumerator_147032.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (3592)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_147452 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3593)), kEnumeration_up) ;
    while (enumerator_147452.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_147452.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_147452.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3594)) COMMA_SOURCE_FILE_AT_LINE (3594)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3594)) COMMA_SOURCE_FILE_AT_LINE (3594)) ;
      enumerator_147452.gotoNextObject () ;
    }
    ...
    GALGAS_lstringlist joker_147788_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_147788_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3598)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3609)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_148373 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_148373.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_148373.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3612)) COMMA_SOURCE_FILE_AT_LINE (3612)) COMMA_SOURCE_FILE_AT_LINE (3612)) ;
        enumerator_148373.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_149181 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149181.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_149181.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3632)) ;
        enumerator_149181.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  routine_enterInheritedReaderWith_32_Arguments (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("hasKeyAtLevel"), GALGAS_string ("string"), GALGAS_string ("uint"), GALGAS_string ("bool"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (830)) ;
  }
  {
  ...
  {
  routine_enterInheritedReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("hasKey"), GALGAS_string ("string"), GALGAS_string ("bool"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (833)) ;
  }
  {
  routine_enterInheritedReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("locationForKey"), GALGAS_string ("string"), GALGAS_string ("location"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (834)) ;
  }
  {
  ...
  cEnumerator_attributeInCollectionListAST enumerator_35670 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_35670.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_35670.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (845)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_35670.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (848)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_35670.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (849)) COMMA_SOURCE_FILE_AT_LINE (849)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (850)), enumerator_35670.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (850)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (851)), enumerator_35670.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (851)) ;
    enumerator_35670.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_36388 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_36388.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_36388.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (855)) COMMA_SOURCE_FILE_AT_LINE (855)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_36388.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_36388.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (856)) COMMA_SOURCE_FILE_AT_LINE (856)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (856)) COMMA_SOURCE_FILE_AT_LINE (856)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_36388.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (860)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (863)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (858)) ;
      }
    }
    enumerator_36388.gotoNextObject () ;
  }
  cEnumerator_mapRemoveMethodListAST enumerator_36862 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  while (enumerator_36862.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_modifierMap.reader_hasKey (enumerator_36862.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (870)) COMMA_SOURCE_FILE_AT_LINE (870)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_36862.current_mMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_36862.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (871)) COMMA_SOURCE_FILE_AT_LINE (871)).operator_concat (GALGAS_string ("' method is already declared as an insert modifier or a remove modifier") COMMA_SOURCE_FILE_AT_LINE (871)) COMMA_SOURCE_FILE_AT_LINE (871)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_36862.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (875)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (878)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (873)) ;
      }
    }
    enumerator_36862.gotoNextObject () ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_37389 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_37389.hasCurrentObject ()) {
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_37389.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (887)), var_removeMethodFormalArgumentList, enumerator_37389.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (889)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (891)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (885)) ;
    }
    enumerator_37389.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_37724 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_37724.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_37724.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (897)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (897)), enumerator_37724.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (897)) COMMA_SOURCE_FILE_AT_LINE (897)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_37724.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (899)) ;
    }
    {
    var_readerMap.modifier_insertOrReplace (var_accessorName, GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (902)), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (903)), inCompiler->here (), GALGAS_bool (true), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (907)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (900)) ;
    }
    enumerator_37724.gotoNextObject () ;
  }
  const enumGalgasBool test_4 = GALGAS_bool (kIsSupOrEqual, object->mAttribute_mInsertOrReplaceDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (912)).objectCompare (GALGAS_uint ((PMUInt32) 1U))).boolEnum () ;
  if (kBoolTrue == test_4) {
  ...
  cEnumerator_attributeInCollectionListAST enumerator_38847 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_38847.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_38847.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (926)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (926)) COMMA_SOURCE_FILE_AT_LINE (926)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (926)), enumerator_38847.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (926)) COMMA_SOURCE_FILE_AT_LINE (926)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_38847.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (928)) ;
    }
    ...
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (930)), enumerator_38847.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (930)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (931)), enumerator_38847.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (931)) ;
    {
    ...
    enumerator_38847.gotoNextObject () ;
  }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_39897 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_39897.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_39897.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (945)) ;
    }
    enumerator_39897.gotoNextObject () ;
  }
  {
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  routine_enterInheritedReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("hasKey"), GALGAS_string ("string"), GALGAS_string ("bool"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1034)) ;
  }
  {
  routine_enterInheritedReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("locationForKey"), GALGAS_string ("string"), GALGAS_string ("location"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1035)) ;
  }
  {
  ...
  cEnumerator_attributeInCollectionListAST enumerator_44687 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_44687.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_44687.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1048)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_44687.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1051)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_44687.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1052)) COMMA_SOURCE_FILE_AT_LINE (1052)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1053)), enumerator_44687.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1053)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1054)), enumerator_44687.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1054)) ;
    enumerator_44687.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_45421 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_45421.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_45421.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1058)) COMMA_SOURCE_FILE_AT_LINE (1058)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_45421.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_45421.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1059)) COMMA_SOURCE_FILE_AT_LINE (1059)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (1059)) COMMA_SOURCE_FILE_AT_LINE (1059)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_45421.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1063)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1066)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1061)) ;
      }
    }
  ...
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, object->mAttribute_mMapStateList.reader_length (SOURCE_FILE_AT_LINE (1097)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_mapOverrideBlockListAST enumerator_49306 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    while (enumerator_49306.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_49306.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1160)) COMMA_SOURCE_FILE_AT_LINE (1160)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1160)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1161)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1162)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1164)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1159)) ;
      }
      enumerator_49306.gotoNextObject () ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_49715 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_49715.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_49715.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1171)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1171)), enumerator_49715.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1171)) COMMA_SOURCE_FILE_AT_LINE (1171)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_49715.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1173)) ;
    }
    {
    var_readerMap.modifier_insertOrReplace (var_accessorName, GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1176)), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1177)), inCompiler->here (), GALGAS_bool (true), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1181)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1174)) ;
    }
    enumerator_49715.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_50348 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_50348.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_50348.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1187)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1187)), enumerator_50348.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_50348.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1189)) ;
    }
    ...
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1191)), enumerator_50348.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1191)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1192)), enumerator_50348.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1192)) ;
    {
  ...
  cEnumerator_mapSearchMethodListAST enumerator_51398 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_51398.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_51398.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1206)) ;
    }
    enumerator_51398.gotoNextObject () ;
  }
  {
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_53140_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_53140_1 ; // Joker input parameter
  GALGAS_typedAttributeList joker_53180_2 ; // Joker input parameter
  GALGAS_attributeMap joker_53180_1 ; // Joker input parameter
  GALGAS_constructorMap joker_53236_11 ; // Joker input parameter
  GALGAS_readerMap joker_53236_10 ; // Joker input parameter
  GALGAS_modifierMap joker_53236_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_53236_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_53236_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_53236_6 ; // Joker input parameter
  GALGAS_stringlist joker_53236_5 ; // Joker input parameter
  GALGAS_uint joker_53236_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_53236_3 ; // Joker input parameter
  GALGAS_stringset joker_53236_2 ; // Joker input parameter
  GALGAS_lstringlist joker_53236_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_53290_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_53290_4 ; // Joker input parameter
  GALGAS_bool joker_53290_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_53290_2 ; // Joker input parameter
  GALGAS_string joker_53290_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_53140_2, joker_53140_1, var_typeKindEnum, joker_53180_2, joker_53180_1, var_mapTypedAttributeList, joker_53236_11, joker_53236_10, joker_53236_9, joker_53236_8, joker_53236_7, joker_53236_6, joker_53236_5, joker_53236_4, joker_53236_3, joker_53236_2, joker_53236_1, var_searchMethodList, joker_53290_5, joker_53290_4, joker_53290_3, joker_53290_2, joker_53290_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1260)) ;
  ...
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1315)) ;
  var_constructorAttributeTypeList.addAssign_operation (var_associatedMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (1316)) ;
  var_constructorAttributeTypeList.addAssign_operation (var_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1317)) ;
  cEnumerator_mapSearchMethodListAST enumerator_55869 (var_searchMethodList, kEnumeration_up) ;
  while (enumerator_55869.hasCurrentObject ()) {
    {
    var_constructorMap.modifier_insertKey (enumerator_55869.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1319)) ;
    }
    enumerator_55869.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_56840 (var_mapTypedAttributeList, kEnumeration_up) ;
  while (enumerator_56840.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_56840.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1336)) COMMA_SOURCE_FILE_AT_LINE (1336)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_56982 (var_inheritedReaderMap.reader_keySet (SOURCE_FILE_AT_LINE (1338)), kEnumeration_up) ;
      while (enumerator_56982.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_56982.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (1339)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1339)) COMMA_SOURCE_FILE_AT_LINE (1339)) ;
        if (enumerator_56982.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (1340)) ;
        }
        enumerator_56982.gotoNextObject () ;
      }
      GALGAS_location location_3 (enumerator_56840.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the map has a associated map proxy, which has predefined readers: ").operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (1342)).operator_concat (GALGAS_string ("; you cannot use theses names for naming an attribute of this map") COMMA_SOURCE_FILE_AT_LINE (1343)) COMMA_SOURCE_FILE_AT_LINE (1342)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_readerMap.modifier_insertKey (enumerator_56840.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1347)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1348)), inCompiler->here (), GALGAS_bool (true), enumerator_56840.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1352)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1345)) ;
      }
    }
    enumerator_56840.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externTypeDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_externTypeConstructorList enumerator_59470 (object->mAttribute_mExternTypeConstructorList, kEnumeration_up) ;
  while (enumerator_59470.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59470.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1414)) ;
    }
    GALGAS_unifiedTypeMapProxyList var_arguments = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1416)) ;
    cEnumerator_lstringlist enumerator_59717 (enumerator_59470.current_mArgumentTypeNameList (HERE), kEnumeration_up) ;
    while (enumerator_59717.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59717.current_mValue (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1419)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1420)) ;
      enumerator_59717.gotoNextObject () ;
    }
    {
    var_constructorMap.modifier_insertKey (enumerator_59470.current_mConstructorName (HERE), var_arguments, GALGAS_bool (true), var_returnedTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1423)) ;
    }
    enumerator_59470.gotoNextObject () ;
  }
  cEnumerator_externTypeReaderList enumerator_60143 (object->mAttribute_mExternTypeReaderList, kEnumeration_up) ;
  while (enumerator_60143.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60143.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1433)) ;
    }
    GALGAS_unifiedTypeMapProxyList var_arguments = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1435)) ;
    cEnumerator_lstringlist enumerator_60390 (enumerator_60143.current_mArgumentTypeNameList (HERE), kEnumeration_up) ;
    while (enumerator_60390.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60390.current_mValue (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1438)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1439)) ;
      enumerator_60390.gotoNextObject () ;
    }
    {
    var_readerMap.modifier_insertKey (enumerator_60143.current_mReaderName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1444)), var_arguments, inCompiler->here (), GALGAS_bool (true), var_returnedTypeProxy, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1449)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1442)) ;
    }
    enumerator_60143.gotoNextObject () ;
  }
  cEnumerator_externTypeModifierList enumerator_60927 (object->mAttribute_mExternTypeModifierList, kEnumeration_up) ;
  while (enumerator_60927.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_61024 (enumerator_60927.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_61024.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61024.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1457)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_61024.current_mFormalArgumentPassingMode (HERE), enumerator_61024.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1462)) ;
      enumerator_61024.gotoNextObject () ;
    }
    {
    var_modifierMap.modifier_insertKey (enumerator_60927.current_mModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1467)), var_routineSignature, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1470)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1465)) ;
    }
    enumerator_60927.gotoNextObject () ;
  }
  cEnumerator_externTypeMethodList enumerator_61620 (object->mAttribute_mExternTypeMethodList, kEnumeration_up) ;
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  routine_enterBaseReaderWith_32_Arguments (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("subgraphFromNodes"), GALGAS_string ("lstringlist"), GALGAS_string ("stringset"), object->mAttribute_mGraphTypeName.mAttribute_string, GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1660)) ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("emptyGraph"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1671)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1672)), GALGAS_bool (false), var_graphTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1670)) ;
  }
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1677)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1678)), GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (1678)) ;
  cEnumerator_unifiedTypeMapProxyList enumerator_68880 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE_AT_LINE (1679)), kEnumeration_up) ;
  while (enumerator_68880.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (enumerator_68880.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1680)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1680)) ;
    enumerator_68880.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_69047 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_69047.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_69047.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1685)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1688)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1683)) ;
    }
    enumerator_69047.gotoNextObject () ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("removeEdgesToDominators"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1695)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1696)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1697)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1699)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1694)) ;
  }
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1703)) ;
  var_formalParameterList.addAssign_operation (var_stringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1704)), GALGAS_string ("inNodeName") COMMA_SOURCE_FILE_AT_LINE (1704)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("removeEdgesToNode"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1706)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1707)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1710)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1705)) ;
  }
  var_formalParameterList.drop () ; // drop instruction
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1715)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1716)), GALGAS_string ("inSourceNodeLKey") COMMA_SOURCE_FILE_AT_LINE (1716)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1717)), GALGAS_string ("inTargetNodeLKey") COMMA_SOURCE_FILE_AT_LINE (1717)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("addEdge"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1719)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1720)), var_formalParameterList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1723)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1718)) ;
  }
  var_formalParameterList.drop () ; // drop instruction
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1728)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1729)), GALGAS_string ("inNodeLKey") COMMA_SOURCE_FILE_AT_LINE (1729)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("noteNode"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1731)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1732)), var_formalParameterList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1735)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1730)) ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mGraphTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1740)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mGraphTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1754)), GALGAS_typeKindEnum::constructor_graphType (SOURCE_FILE_AT_LINE (1755)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1756)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1757)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1758)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1763)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1764)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1765)), function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (1766)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1767)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1768)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1769)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1770)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1771)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1772)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1774)), GALGAS_string ("emptyGraph"), inCompiler COMMA_SOURCE_FILE_AT_LINE (1751)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_enumDeclarationAST * object = (const cPtr_enumDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_enumDeclarationAST) ;
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1789)) ;
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1790)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1791)) ;
  GALGAS_classMethodMap var_classMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1792)) ;
  GALGAS_unifiedTypeMapProxy var_currentTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumTypeName, var_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1795)) ;
  }
  GALGAS_stringset var_constantSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1797)) ;
  cEnumerator_lstringlist enumerator_73210 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_73210.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_73210.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1799)) COMMA_SOURCE_FILE_AT_LINE (1799)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_73210.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1800)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1800)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1800)) ;
    }
    enumerator_73210.gotoNextObject () ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1804)) ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mEnumTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1806)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mEnumTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1820)), GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE_AT_LINE (1821)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1822)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1823)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1824)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1829)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1830)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1831)), function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (1832)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1832)) COMMA_SOURCE_FILE_AT_LINE (1832)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1833)), var_constantSet, object->mAttribute_mConstantList, GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1836)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1837)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1838)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1840)), object->mAttribute_mConstantList.reader_mValueAtIndex (GALGAS_uint ((PMUInt32) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1841)).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1817)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_filewrapperDeclarationAST * object = (const cPtr_filewrapperDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_filewrapperDeclarationAST) ;
  GALGAS_filewrapperTemplateMap var_filewrapperTemplateMap = GALGAS_filewrapperTemplateMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1926)) ;
  cEnumerator_filewrapperTemplateListAST enumerator_77803 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_77803.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxyList var_templateSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1928)) ;
    cEnumerator_formalTemplateInputParameterListAST enumerator_77921 (enumerator_77803.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_77921.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_77921.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1931)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1932)) ;
      enumerator_77921.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_77803.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_77803.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1934)) ;
    }
    enumerator_77803.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_textExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1941)) ;
  cEnumerator_lstringlist enumerator_78440 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_78440.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_78440.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1943)) ;
    }
    enumerator_78440.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_binaryFileExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1946)) ;
  cEnumerator_lstringlist enumerator_78646 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_78646.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_78646.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1948)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_78646.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_78646.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1949)) COMMA_SOURCE_FILE_AT_LINE (1949)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1949)) COMMA_SOURCE_FILE_AT_LINE (1949)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_78646.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1951)) ;
      }
    }
    enumerator_78646.gotoNextObject () ;
  }
  ...
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1958)).reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1958)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
  if (kBoolTrue == test_2) {
    var_absoluteSourcePath = object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1959)) ;
  }else if (kBoolFalse == test_2) {
    var_absoluteSourcePath = object->mAttribute_mSourceFileAbsolutePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (1961)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1961)).operator_concat (object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1961)) COMMA_SOURCE_FILE_AT_LINE (1961)) ;
  }
  const enumGalgasBool test_3 = var_absoluteSourcePath.reader_directoryExists (SOURCE_FILE_AT_LINE (1963)).operator_not (SOURCE_FILE_AT_LINE (1963)).boolEnum () ;
  if (kBoolTrue == test_3) {
    GALGAS_location location_4 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_4, GALGAS_string ("The '").operator_concat (var_absoluteSourcePath COMMA_SOURCE_FILE_AT_LINE (1964)).operator_concat (GALGAS_string ("' directory does not exist") COMMA_SOURCE_FILE_AT_LINE (1964)) COMMA_SOURCE_FILE_AT_LINE (1964)) ;
    ...
    {
    routine_recursivelyEnumerateDirectories (var_absoluteSourcePath, GALGAS_string ("/"), var_textExtensionMap, var_binaryFileExtensionMap, var_regularRootFileMap, var_wrapperDirectoryMap, var_wrapperFileIndex, var_wrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1970)) ;
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFilewrapperMap.modifier_insertKey (object->mAttribute_mFilewrapperName, object->mAttribute_mFilewrapperPath, object->mAttribute_mFilewrapperTextFileExtensionList, var_regularRootFileMap, var_wrapperDirectoryMap, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1982)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_listDeclarationAST) ;
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2001)) ;
  cEnumerator_attributeInCollectionListAST enumerator_80596 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_80596.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_80596.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2004)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_80840 (enumerator_80596.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_80840.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_80840.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_80840.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_80840.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_80596.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2014)) ;
    enumerator_80596.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2018)) ;
  }
  GALGAS_unifiedTypeMapProxy var_listTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListTypeName, var_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (2021)) ;
  }
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2023)) ;
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2024)) ;
  GALGAS_formalParameterSignature var_modifierOutputFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2025)) ;
  GALGAS_formalParameterSignature var_modifierInputFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2026)) ;
  cEnumerator_typedAttributeList enumerator_81772 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_81772.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_81772.current_mAttributeTypeProxy (HERE), enumerator_81772.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2028)) COMMA_SOURCE_FILE_AT_LINE (2028)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_81772.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2029)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_81772.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2030)), enumerator_81772.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2030)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_81772.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2031)), enumerator_81772.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2031)) ;
    enumerator_81772.gotoNextObject () ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2034)) ;
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyList"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2035)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2035)) ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("listWithValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2037)), var_constructorAttributeTypeList, GALGAS_bool (false), var_listTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2036)) ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2043)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("length"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2044)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("range"), GALGAS_string ("range"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2045)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("subListFromIndex"), GALGAS_string ("uint"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2046)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2046)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("subListWithRange"), GALGAS_string ("range"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2047)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2047)) ;
  }
  cEnumerator_typedAttributeList enumerator_83135 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_83135.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_83135.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_83135.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2051)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2051)), enumerator_83135.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2051)) COMMA_SOURCE_FILE_AT_LINE (2051)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2052)), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_uintType COMMA_SOURCE_FILE_AT_LINE (2053)), inCompiler->here (), GALGAS_bool (true), enumerator_83135.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2057)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2050)) ;
      }
    }
    enumerator_83135.gotoNextObject () ;
  }
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2063)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("first"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2065)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2066)), var_modifierOutputFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2070)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2064)) ;
  }
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("last"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2074)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2075)), var_modifierOutputFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2079)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2073)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2083)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popFirst"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2085)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2086)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2089)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2084)) ;
  }
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popLast"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2093)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2094)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2097)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2092)) ;
  }
  var_modifierOutputFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2100)), GALGAS_string ("inIndex") COMMA_SOURCE_FILE_AT_LINE (2100)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("removeAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2102)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2103)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2106)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2101)) ;
  }
  var_modifierOutputFormalArgumentList.drop () ; // drop instruction
  cEnumerator_typedAttributeList enumerator_84936 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_84936.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_84936.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_formalParameterSignature var_setterFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2112)) ;
      var_setterFormalArgumentList.addAssign_operation (enumerator_84936.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2113)), enumerator_84936.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2113)) ;
      var_setterFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2114)), enumerator_84936.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2114)) ;
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_84936.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2116)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2116)) COMMA_SOURCE_FILE_AT_LINE (2116)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2116)), enumerator_84936.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2116)) COMMA_SOURCE_FILE_AT_LINE (2116)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2117)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2120)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2115)) ;
      }
    }
    enumerator_84936.gotoNextObject () ;
  }
  var_modifierInputFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2126)), GALGAS_string ("inInsertionIndex") COMMA_SOURCE_FILE_AT_LINE (2126)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("insertAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2128)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2129)), var_modifierInputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2132)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2127)) ;
  }
  var_modifierInputFormalArgumentList.drop () ; // drop instruction
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2137)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2138)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2139)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mListTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2141)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2154)) COMMA_SOURCE_FILE_AT_LINE (2154)), object->mAttribute_mListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2154)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2152)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2161)), GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (2162)), var_typedAttributeList, GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2164)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2165)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2170)), var_enumerationDescriptor, var_enumerationVariants, function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2173)).operator_or (function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2173)) COMMA_SOURCE_FILE_AT_LINE (2173)).operator_or (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2173)) COMMA_SOURCE_FILE_AT_LINE (2173)), var_constructorAttributeTypeList, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2175)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2176)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2177)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2178)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2179)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptyList"), inCompiler COMMA_SOURCE_FILE_AT_LINE (2158)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2196)) ;
  }
  GALGAS_unifiedTypeMapProxy var_listTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mSortedListTypeName, var_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (2199)) ;
  }
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2201)) ;
  ...
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2203)) ;
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2204)) ;
  cEnumerator_attributeInCollectionListAST enumerator_88724 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_88724.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_88724.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2207)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_88724.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2210)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_88724.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2211)) COMMA_SOURCE_FILE_AT_LINE (2211)) ;
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2212)) ;
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2213)), enumerator_88724.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2213)) ;
    enumerator_88724.gotoNextObject () ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2216)) ;
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptySortedList"), object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2217)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2217)) ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("sortedListWithValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2219)), var_constructorAttributeTypeList, GALGAS_bool (false), var_listTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2218)) ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2225)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("length"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2226)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2228)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popGreatest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2230)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2231)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2234)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2229)) ;
  }
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popSmallest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2238)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2239)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2242)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2237)) ;
  }
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2246)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("greatest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2248)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2249)), var_modifierFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2253)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2247)) ;
  }
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("smallest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2257)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2258)), var_modifierFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2262)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2256)) ;
  }
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2266)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2267)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2268)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mSortedListTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2270)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mSortedListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2284)) COMMA_SOURCE_FILE_AT_LINE (2284)), object->mAttribute_mSortedListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2284)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2282)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mSortedListTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2291)), GALGAS_typeKindEnum::constructor_sortedListType (SOURCE_FILE_AT_LINE (2292)), var_typedAttributeList, GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2294)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2295)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2300)), var_enumerationDescriptor, var_enumerationVariants, function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2303)).operator_or (function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2303)) COMMA_SOURCE_FILE_AT_LINE (2303)).operator_or (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2303)) COMMA_SOURCE_FILE_AT_LINE (2303)), var_constructorAttributeTypeList, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2305)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2306)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2307)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2308)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2309)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptySortedList"), inCompiler COMMA_SOURCE_FILE_AT_LINE (2288)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mStructTypeName, var_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (2326)) ;
  }
  GALGAS_attributeMap var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2328)) ;
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2329)) ;
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2330)) ;
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2331)) ;
  cEnumerator_attributeInCollectionListAST enumerator_93344 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_93344.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_93344.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2334)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2335)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_93344.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2338)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_93344.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2339)) ;
    }
    enumerator_93344.gotoNextObject () ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2342)), var_constructorAttributeTypeList, GALGAS_bool (false), var_structTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2341)) ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2349)) ;
  }
  cEnumerator_typedAttributeList enumerator_94066 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_94066.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_94066.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2356)), enumerator_94066.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2357)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2353)) ;
    }
    enumerator_94066.gotoNextObject () ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2363)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2365)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mStructTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2367)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    var_enumeratedType = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2380)) ;
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumeratedElementTypeName, var_enumeratedType COMMA_SOURCE_FILE_AT_LINE (2382)) ;
    }
  }
  GALGAS_string var_defaultConstructorName = GALGAS_string ("default") ;
  cEnumerator_typedAttributeList enumerator_95251 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_95251.hasCurrentObject () && bool_1) {
    while (enumerator_95251.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_95251.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2391)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_95251.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2391)).operator_not (SOURCE_FILE_AT_LINE (2391)) COMMA_SOURCE_FILE_AT_LINE (2391)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_95251.gotoNextObject () ;
      if (enumerator_95251.hasCurrentObject ()) {
        bool_1 = GALGAS_bool (kIsNotEqual, var_defaultConstructorName.objectCompare (GALGAS_string::makeEmptyString ())).isValidAndTrue () ;
      }
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mStructTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2399)), GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (2400)), var_typedAttributeList, var_attributeMap, var_typedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2408)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2409)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2410)), function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (2411)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2412)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2413)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2414)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2415)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2416)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2417)), GALGAS_bool (false), var_enumeratedType, var_defaultConstructorName, inCompiler COMMA_SOURCE_FILE_AT_LINE (2396)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2433)) ;
  }
  GALGAS_readerMap var_readerMap ;
  GALGAS_modifierMap var_modifierMap ;
  GALGAS_instanceMethodMap var_instanceMethodMap ;
  GALGAS_typedAttributeList var_inheritedTypedAttributeList ;
  GALGAS_attributeMap var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2439)) ;
  GALGAS_unifiedTypeMapProxy var_superClassIndex ;
  GALGAS_bool var_generateHeaderInSeparateFile ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2443)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_superClassIndex = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2444)) ;
    {
    routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2445)) ;
    }
    var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2446)) ;
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2447)) ;
    var_inheritedTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2448)) ;
    var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2449)) ;
    var_generateHeaderInSeparateFile = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_97648 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_97648.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_97648.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2452)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_97648.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mSuperClassName, var_superClassIndex COMMA_SOURCE_FILE_AT_LINE (2457)) ;
    }
    GALGAS_typeKindEnum var_typeKindEnum ;
    ...
    GALGAS_bool joker_98125_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_98125_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_98210_2 ; // Joker input parameter
    GALGAS_constructorMap joker_98210_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_98301_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_98301_9 ; // Joker input parameter
    GALGAS_stringlist joker_98301_8 ; // Joker input parameter
    GALGAS_uint joker_98301_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_98301_6 ; // Joker input parameter
    GALGAS_stringset joker_98301_5 ; // Joker input parameter
    GALGAS_lstringlist joker_98301_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_98301_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_98301_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_98301_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_98347_2 ; // Joker input parameter
    GALGAS_string joker_98347_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_98125_2, joker_98125_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_98210_2, joker_98210_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_98301_10, joker_98301_9, joker_98301_8, joker_98301_7, joker_98301_6, joker_98301_5, joker_98301_4, joker_98301_3, joker_98301_2, joker_98301_1, var_generateHeaderInSeparateFile, joker_98347_2, joker_98347_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2462)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2477)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (object->mAttribute_mSuperClassName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the @").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2478)) COMMA_SOURCE_FILE_AT_LINE (2478)).operator_concat (GALGAS_string (" should be a class type") COMMA_SOURCE_FILE_AT_LINE (2478)) COMMA_SOURCE_FILE_AT_LINE (2478)) ;
    }
    var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2481)) ;
    cEnumerator_modifierMap enumerator_98636 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_98636.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_98636.current_lkey (HERE), enumerator_98636.current_mKind (HERE), enumerator_98636.current_mParameterList (HERE), enumerator_98636.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2488)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2483)) ;
      }
      enumerator_98636.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2493)) ;
    cEnumerator_readerMap enumerator_98962 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_98962.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_98962.current_lkey (HERE), enumerator_98962.current_mKind (HERE), enumerator_98962.current_mArgumentTypeList (HERE), enumerator_98962.current_mDeclarationLocation (HERE), enumerator_98962.current_mHasCompilerArgument (HERE), enumerator_98962.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2502)), enumerator_98962.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2495)) ;
      }
      enumerator_98962.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2507)) ;
    cEnumerator_instanceMethodMap enumerator_99350 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_99350.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_99350.current_lkey (HERE), enumerator_99350.current_mKind (HERE), enumerator_99350.current_mParameterList (HERE), enumerator_99350.current_mDeclarationLocation (HERE), enumerator_99350.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2515)), enumerator_99350.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2509)) ;
      }
      enumerator_99350.gotoNextObject () ;
    }
  }
  GALGAS_unifiedTypeMapProxyList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2521)) ;
  cEnumerator_typedAttributeList enumerator_99769 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_99769.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_99769.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2523)) ;
    enumerator_99769.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_99872 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_99872.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_99872.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2527)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2528)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_99872.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2529)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_99872.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2530)) COMMA_SOURCE_FILE_AT_LINE (2530)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_99872.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_99872.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2531)) COMMA_SOURCE_FILE_AT_LINE (2531)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader") COMMA_SOURCE_FILE_AT_LINE (2531)) COMMA_SOURCE_FILE_AT_LINE (2531)) ;
    }
    enumerator_99872.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_classIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mClassTypeName, var_classIndex COMMA_SOURCE_FILE_AT_LINE (2535)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2541)) ;
  const enumGalgasBool test_6 = object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (2542)).boolEnum () ;
  if (kBoolTrue == test_6) {
    {
    var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2544)), var_constructorAttributeTypeList, GALGAS_bool (false), var_classIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2543)) ;
    }
  }
  GALGAS_typedAttributeList var_currentClassTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2551)) ;
  GALGAS_typedAttributeList var_allTypedAttributeList = var_inheritedTypedAttributeList ;
  cEnumerator_attributeInCollectionListAST enumerator_100948 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_100948.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_100948.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2555)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_101192 (enumerator_100948.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_101192.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_101192.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2559)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_101192.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2561)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_101192.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_100948.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2565)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_100948.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2566)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_100948.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2570)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2571)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2575)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2568)) ;
      }
    }
    enumerator_100948.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_102248 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_102248.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_102248.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_102248.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2590)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2590)) COMMA_SOURCE_FILE_AT_LINE (2590)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2590)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2591)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_102248.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2592)), enumerator_102248.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2592)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2594)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2589)) ;
      }
    }
    enumerator_102248.gotoNextObject () ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mClassTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2600)) ;
  }
  GALGAS_string var_defaultConstructorName ;
  const enumGalgasBool test_11 = var_superClassIndex.reader_isNull (SOURCE_FILE_AT_LINE (2612)).boolEnum () ;
  if (kBoolTrue == test_11) {
    var_defaultConstructorName = GALGAS_string ("default") ;
  }else if (kBoolFalse == test_11) {
    var_defaultConstructorName = var_superClassIndex.reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2615)) ;
  }
  cEnumerator_typedAttributeList enumerator_103293 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_103293.hasCurrentObject () && bool_12) {
    while (enumerator_103293.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_103293.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2618)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_103293.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2618)).operator_not (SOURCE_FILE_AT_LINE (2618)) COMMA_SOURCE_FILE_AT_LINE (2618)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_103293.gotoNextObject () ;
      if (enumerator_103293.hasCurrentObject ()) {
        bool_12 = GALGAS_bool (kIsNotEqual, var_defaultConstructorName.objectCompare (GALGAS_string::makeEmptyString ())).isValidAndTrue () ;
      }
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mClassTypeName, object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (2625)), var_superClassIndex, GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2627)), var_allTypedAttributeList, var_attributeMap, var_currentClassTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2635)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2636)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2637)), GALGAS_uint ((PMUInt32) 0U), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2639)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2640)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2641)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2642)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2643)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2644)), var_generateHeaderInSeparateFile, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2646)), var_defaultConstructorName, inCompiler COMMA_SOURCE_FILE_AT_LINE (2623)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externRoutineDeclarationAST * object = (const cPtr_externRoutineDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_externRoutineDeclarationAST) ;
  GALGAS_formalParameterSignature var_routineSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2660)) ;
  cEnumerator_formalParameterListAST enumerator_104941 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_104941.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_104941.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2663)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_104941.current_mFormalArgumentPassingMode (HERE), enumerator_104941.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2664)) ;
    enumerator_104941.gotoNextObject () ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mRoutineMap.modifier_insertKey (object->mAttribute_mRoutineName, var_routineSignature, inCompiler COMMA_SOURCE_FILE_AT_LINE (2667)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externFunctionDeclarationAST * object = (const cPtr_externFunctionDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_externFunctionDeclarationAST) ;
  GALGAS_unifiedTypeMapProxyList var_functionSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2679)) ;
  cEnumerator_formalInputParameterListAST enumerator_105949 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_105949.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_105949.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2682)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2683)) ;
    enumerator_105949.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName, var_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2687)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2689)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName, var_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2702)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2704)), var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2704)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_arrayDeclarationAST) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2716)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mDimension.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the dimension of an array should be > 0") COMMA_SOURCE_FILE_AT_LINE (2717)) ;
  }
  GALGAS_unifiedTypeMapProxy var_arrayTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mArrayTypeName, var_arrayTypeIndex COMMA_SOURCE_FILE_AT_LINE (2721)) ;
  }
  GALGAS_unifiedTypeMapProxy var_elementTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mElementTypeName, var_elementTypeIndex COMMA_SOURCE_FILE_AT_LINE (2724)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2726)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2727)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2728)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2729)) ;
  GALGAS_unifiedTypeMapProxy var_boolType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("bool"), var_boolType COMMA_SOURCE_FILE_AT_LINE (2732)) ;
  }
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2735)) ;
  }
  GALGAS_unifiedTypeMapProxyList var_uintArgs = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2737)) ;
  GALGAS_uint var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2739)).isValid ()) {
    PMUInt32 variant_108712 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2739)).uintValue () ;
    bool loop_108712 = true ;
    while (loop_108712) {
      loop_108712 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2739)))).isValid () ;
      if (loop_108712) {
        loop_108712 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2739)))).boolValue () ;
      }
      if (loop_108712 && (0 == variant_108712)) {
        loop_108712 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2739)) ;
      }
      if (loop_108712) {
        variant_108712 -- ;
        var_uintArgs.addAssign_operation (var_uintType COMMA_SOURCE_FILE_AT_LINE (2740)) ;
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (2741)) ;
      }
    }
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2745)), var_uintArgs, GALGAS_bool (false), var_arrayTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2744)) ;
  }
  {
  routine_enterBaseReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("axisCount"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2751)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("sizeForAxis"), GALGAS_string ("uint"), GALGAS_string ("uint"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2752)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("rangeForAxis"), GALGAS_string ("uint"), GALGAS_string ("range"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2753)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("isValueValidAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2755)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2756)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_boolType, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2761)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2754)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("valueAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2765)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2766)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_elementTypeIndex, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2771)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2764)) ;
  }
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2775)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_elementTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2776)), GALGAS_string ("InValue") COMMA_SOURCE_FILE_AT_LINE (2776)) ;
  var_idx = GALGAS_uint ((PMUInt32) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2778)).isValid ()) {
    PMUInt32 variant_109978 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2778)).uintValue () ;
    bool loop_109978 = true ;
    while (loop_109978) {
      loop_109978 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2778)))).isValid () ;
      if (loop_109978) {
        loop_109978 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2778)))).boolValue () ;
      }
      if (loop_109978 && (0 == variant_109978)) {
        loop_109978 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2778)) ;
      }
      if (loop_109978) {
        variant_109978 -- ;
        var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2779)), GALGAS_string ("inIndex").operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (2779)) COMMA_SOURCE_FILE_AT_LINE (2779)) COMMA_SOURCE_FILE_AT_LINE (2779)) ;
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (2780)) ;
      }
    }
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2783)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2784)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2787)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2782)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("forceValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2791)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2792)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2795)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2790)) ;
  }
  {
  GALGAS_unifiedTypeMapProxy joker_110592_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_110592_2 ; // Joker input parameter
  GALGAS_string joker_110592_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_110592_3, joker_110592_2, joker_110592_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2798)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("invalidateValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2800)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2801)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2804)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2799)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSize").reader_nowhere (SOURCE_FILE_AT_LINE (2808)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2809)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2812)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2807)) ;
  }
  var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2815)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2816)), GALGAS_string ("inSize") COMMA_SOURCE_FILE_AT_LINE (2816)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2817)), GALGAS_string ("inAxisIndex") COMMA_SOURCE_FILE_AT_LINE (2817)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSizeForAxis").reader_nowhere (SOURCE_FILE_AT_LINE (2819)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2820)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2823)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2818)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mArrayTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2830)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE_AT_LINE (2831)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2832)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2833)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2834)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2839)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2840)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2841)), GALGAS_uint ((PMUInt32) 0U), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2843)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2844)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2845)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2846)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2847)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2848)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2850)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2827)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_113002_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_113002_1 ; // Joker input parameter
  GALGAS_attributeMap joker_113091_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_113091_18 ; // Joker input parameter
  GALGAS_constructorMap joker_113091_17 ; // Joker input parameter
  GALGAS_readerMap joker_113091_16 ; // Joker input parameter
  GALGAS_modifierMap joker_113091_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_113091_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_113091_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_113091_12 ; // Joker input parameter
  GALGAS_stringlist joker_113091_11 ; // Joker input parameter
  GALGAS_uint joker_113091_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_113091_9 ; // Joker input parameter
  GALGAS_stringset joker_113091_8 ; // Joker input parameter
  GALGAS_lstringlist joker_113091_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_113091_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_113091_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_113091_4 ; // Joker input parameter
  GALGAS_bool joker_113091_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_113091_2 ; // Joker input parameter
  GALGAS_string joker_113091_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_113002_2, joker_113002_1, var_typeKindEnum, var_listTypedAttributeList, joker_113091_19, joker_113091_18, joker_113091_17, joker_113091_16, joker_113091_15, joker_113091_14, joker_113091_13, joker_113091_12, joker_113091_11, joker_113091_10, joker_113091_9, joker_113091_8, joker_113091_7, joker_113091_6, joker_113091_5, joker_113091_4, joker_113091_3, joker_113091_2, joker_113091_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2865)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (2872)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2873)) COMMA_SOURCE_FILE_AT_LINE (2873)).operator_concat (GALGAS_string ("' type should be a list type") COMMA_SOURCE_FILE_AT_LINE (2873)) COMMA_SOURCE_FILE_AT_LINE (2873)) ;
    var_listTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2874)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2877)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2878)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2879)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2880)) ;
  GALGAS_unifiedTypeMapProxy var_associatedListTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedListTypeName, var_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (2883)) ;
  }
  GALGAS_unifiedTypeMapProxy var_currentTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListmapTypeName, var_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (2886)) ;
  }
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2889)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("count"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2891)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("allKeys"), GALGAS_string ("stringset"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2892)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2893)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("listForKey"), GALGAS_string ("string"), object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2894)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2894)) ;
  }
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyMap"), object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2896)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2896)) ;
  }
  GALGAS_enumerationDescriptorList var_enumeratorDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2898)) ;
  var_enumeratorDescriptor.addAssign_operation (var_stringTypeIndex, GALGAS_string ("key") COMMA_SOURCE_FILE_AT_LINE (2899)) ;
  var_enumeratorDescriptor.addAssign_operation (var_associatedListTypeIndex, GALGAS_string ("mList") COMMA_SOURCE_FILE_AT_LINE (2900)) ;
  GALGAS_unifiedTypeMapProxyList var_addAssignOperatorDescription = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2902)) ;
  var_addAssignOperatorDescription.addAssign_operation (var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2903)) ;
  cEnumerator_typedAttributeList enumerator_115133 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_115133.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_115133.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2905)) ;
    enumerator_115133.gotoNextObject () ;
  }
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2908)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2909)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2910)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mListmapTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2912)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2926)) COMMA_SOURCE_FILE_AT_LINE (2926)), object->mAttribute_mListmapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2926)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2924)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListmapTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2933)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE_AT_LINE (2934)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2935)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2936)), var_listTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2942)), var_enumeratorDescriptor, var_enumerationVariants, function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2945)), var_addAssignOperatorDescription, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2947)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2948)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2949)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2950)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2951)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptyMap"), inCompiler COMMA_SOURCE_FILE_AT_LINE (2930)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_predefinedTypeAST * object = (const cPtr_predefinedTypeAST *) inObject ;
  macroValidSharedObject (object, const cPtr_predefinedTypeAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mPredefinedTypeName COMMA_SOURCE_FILE_AT_LINE (2987)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2987)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_predefinedTypeAST temp_0 = object ;
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_classDeclarationAST * object = (const cPtr_classDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_classDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (3000)) COMMA_SOURCE_FILE_AT_LINE (3000)), object->mAttribute_mClassTypeName.reader_location (SOURCE_FILE_AT_LINE (3000)) COMMA_SOURCE_FILE_AT_LINE (3000)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_classDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3001)) ;
  }
  ...
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (3003)) COMMA_SOURCE_FILE_AT_LINE (3003)), object->mAttribute_mSuperClassName.reader_location (SOURCE_FILE_AT_LINE (3003)) COMMA_SOURCE_FILE_AT_LINE (3003)) COMMA_SOURCE_FILE_AT_LINE (3003)) ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_119365 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_119365.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_119365.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3006)) COMMA_SOURCE_FILE_AT_LINE (3006)), enumerator_119365.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3006)) COMMA_SOURCE_FILE_AT_LINE (3006)) COMMA_SOURCE_FILE_AT_LINE (3006)) ;
    }
    enumerator_119365.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_120347 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_120347.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_120347.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3023)) COMMA_SOURCE_FILE_AT_LINE (3023)), enumerator_120347.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3023)) COMMA_SOURCE_FILE_AT_LINE (3023)) COMMA_SOURCE_FILE_AT_LINE (3023)) ;
    }
    enumerator_120347.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121208 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121208.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121208.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3039)) COMMA_SOURCE_FILE_AT_LINE (3039)), enumerator_121208.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3039)) COMMA_SOURCE_FILE_AT_LINE (3039)) COMMA_SOURCE_FILE_AT_LINE (3039)) ;
    }
    enumerator_121208.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_122774 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_122774.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_122774.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3068)) COMMA_SOURCE_FILE_AT_LINE (3068)), enumerator_122774.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3068)) COMMA_SOURCE_FILE_AT_LINE (3068)) COMMA_SOURCE_FILE_AT_LINE (3068)) ;
    }
    enumerator_122774.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_125270 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_125270.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_125270.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3112)) COMMA_SOURCE_FILE_AT_LINE (3112)), enumerator_125270.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3112)) COMMA_SOURCE_FILE_AT_LINE (3112)) COMMA_SOURCE_FILE_AT_LINE (3112)) ;
    }
    enumerator_125270.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_126128 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126128.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126128.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3128)) COMMA_SOURCE_FILE_AT_LINE (3128)), enumerator_126128.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3128)) COMMA_SOURCE_FILE_AT_LINE (3128)) COMMA_SOURCE_FILE_AT_LINE (3128)) ;
    }
    enumerator_126128.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_135213 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3300)) ;
  if (NULL != objectArray_135213) {
      macroValidSharedObject (objectArray_135213, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_135213->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3301)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_136515 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3328)) ;
  if (NULL != objectArray_136515) {
      macroValidSharedObject (objectArray_136515, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_136515->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3329)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_137787 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3355)) ;
  if (NULL != objectArray_137787) {
      macroValidSharedObject (objectArray_137787, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_137787->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3356)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_139688 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3394)) ;
  if (NULL != objectArray_139688) {
      macroValidSharedObject (objectArray_139688, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_139688->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3395)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_141038 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3422)) ;
  if (NULL != objectArray_141038) {
      macroValidSharedObject (objectArray_141038, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_141038->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3423)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_142350 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3449)) ;
  if (NULL != objectArray_142350) {
      macroValidSharedObject (objectArray_142350, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_142350->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3450)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_143189 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_143189.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_143189.current_mAttributeTypeName (HERE), enumerator_143189.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3479)) COMMA_SOURCE_FILE_AT_LINE (3476)) ;
    enumerator_143189.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_143823 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_143823.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_143823.current_mAttributeTypeName (HERE), enumerator_143823.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3500)) COMMA_SOURCE_FILE_AT_LINE (3497)) ;
    enumerator_143823.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_144465 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_144465.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_144465.current_mAttributeTypeName (HERE), enumerator_144465.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3521)) COMMA_SOURCE_FILE_AT_LINE (3518)) ;
    enumerator_144465.gotoNextObject () ;
  }
