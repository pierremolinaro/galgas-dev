...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147814 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147814.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_147814.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3601)) ;
    enumerator_147814.gotoNextObject () ;
  }
  GALGAS_semanticTypePrecedenceGraph var_semanticTypePrecedenceGraph = GALGAS_semanticTypePrecedenceGraph::constructor_emptyGraph (SOURCE_FILE ("semanticContext.gSemantics", 3607)) ;
  GALGAS_categoryMethodMapForBuildingContext var_categoryMethodMapForBuildingContext = GALGAS_categoryMethodMapForBuildingContext::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3608)) ;
  GALGAS_categoryReaderMapForBuildingContext var_categoryReaderMapForBuildingContext = GALGAS_categoryReaderMapForBuildingContext::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3609)) ;
  GALGAS_categoryModifierMapForBuildingContext var_categoryModifierMapForBuildingContext = GALGAS_categoryModifierMapForBuildingContext::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3610)) ;
  GALGAS_semanticDeclarationListAST var_categoryOverrideDefinitionList = GALGAS_semanticDeclarationListAST::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3611)) ;
  cEnumerator_semanticDeclarationListAST enumerator_148547 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_148547.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_148547.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3613)) ;
    enumerator_148547.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE ("semanticContext.gSemantics", 3621)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_148967 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE ("semanticContext.gSemantics", 3622)), kEnumeration_up) ;
    while (enumerator_148967.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_148967.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_148967.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3623))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3623)).operator_concat (GALGAS_string ("' type is not defined")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3623))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3623)) ;
      enumerator_148967.gotoNextObject () ;
    }
    inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("semantic analysis not performed, due to undefined type error(s)")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3625)) ;
    ...
    GALGAS_lstringlist joker_149305_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_149305_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3627)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE ("semanticContext.gSemantics", 3633)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string ("semantic analysis not performed, ").operator_concat (var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE ("semanticContext.gSemantics", 3634)).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3634))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3634)).operator_concat (GALGAS_string (" declarations are involved in circular definition:")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3634)) ;
      cEnumerator_semanticDeclarationListAST enumerator_149700 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149700.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_149700.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3636))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3636))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3636)) ;
        enumerator_149700.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3638)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      var_sortedSemanticDeclarationListAST.dotAssign_operation (var_categoryOverrideDefinitionList  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3641)) ;
      outArgument_outSemanticContext = GALGAS_semanticContext::constructor_new (constinArgument_inSourceFile, GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3645)), GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3646)), GALGAS_functionMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3647)), GALGAS_filewrapperMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3648)), GALGAS_grammarMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3649)), GALGAS_optionComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3650)), GALGAS_lexiqueComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 3651))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3643)) ;
      cEnumerator_semanticDeclarationListAST enumerator_150458 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_150458.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_150458.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3655)) ;
        enumerator_150458.gotoNextObject () ;
      }
    }
  }
}
