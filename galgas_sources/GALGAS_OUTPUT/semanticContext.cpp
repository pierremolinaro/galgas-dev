...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_70821 (var_files, kEnumeration_up) ;
  while (enumerator_70821.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_70821.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1757)) COMMA_SOURCE_FILE_AT_LINE (1757)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1758)).operator_concat (enumerator_70821.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1758)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_70821.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1760)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1759)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1766)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_70821.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1767)) COMMA_SOURCE_FILE_AT_LINE (1767)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1768)).operator_concat (enumerator_70821.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1768)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_70821.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1770)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1769)) ;
        }
  ...
  cEnumerator_stringlist enumerator_71786 (var_directories, kEnumeration_up) ;
  while (enumerator_71786.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1787)).operator_concat (enumerator_71786.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1787)), constinArgument_inPathInWrapper.operator_concat (enumerator_71786.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1788)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1788)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1786)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_71786.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1797)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1796)) ;
    }
    enumerator_71786.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_140590 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_140590.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_140590.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3438)) ;
    enumerator_140590.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_141323 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_141323.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_141323.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3450)) ;
    enumerator_141323.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_141743 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3459)), kEnumeration_up) ;
    while (enumerator_141743.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_141743.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_141743.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3460)) COMMA_SOURCE_FILE_AT_LINE (3460)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3460)) COMMA_SOURCE_FILE_AT_LINE (3460)) ;
      enumerator_141743.gotoNextObject () ;
    }
    ...
    GALGAS_lstringlist joker_142079_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_142079_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3464)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_142664 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_142664.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_142664.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3478)) COMMA_SOURCE_FILE_AT_LINE (3478)) COMMA_SOURCE_FILE_AT_LINE (3478)) ;
        enumerator_142664.gotoNextObject () ;
      }
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_35997 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_35997.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_35997.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (853)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (853)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_35997.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (856)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_35997.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (857)) COMMA_SOURCE_FILE_AT_LINE (857)) ;
    ...
    enumerator_35997.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_36683 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_36683.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_36683.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (863)) COMMA_SOURCE_FILE_AT_LINE (863)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_36683.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_36683.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (864)) COMMA_SOURCE_FILE_AT_LINE (864)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (864)) COMMA_SOURCE_FILE_AT_LINE (864)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_36683.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (868)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (871)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (866)) ;
      }
    }
    enumerator_36683.gotoNextObject () ;
  }
  cEnumerator_mapRemoveMethodListAST enumerator_37157 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  while (enumerator_37157.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_modifierMap.reader_hasKey (enumerator_37157.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (878)) COMMA_SOURCE_FILE_AT_LINE (878)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_37157.current_mMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_37157.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (879)) COMMA_SOURCE_FILE_AT_LINE (879)).operator_concat (GALGAS_string ("' method is already declared as an insert modifier or a remove modifier") COMMA_SOURCE_FILE_AT_LINE (879)) COMMA_SOURCE_FILE_AT_LINE (879)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_37157.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (883)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (886)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (881)) ;
      }
    }
    enumerator_37157.gotoNextObject () ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_37684 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_37684.hasCurrentObject ()) {
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_37684.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (895)), var_removeMethodFormalArgumentList, enumerator_37684.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (897)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (899)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (893)) ;
    }
    enumerator_37684.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_38019 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_38019.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_38019.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (905)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (905)), enumerator_38019.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (905)) COMMA_SOURCE_FILE_AT_LINE (905)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_38019.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (907)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (907)) ;
    }
    {
    ...
    enumerator_38019.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_39158 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_39158.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_39158.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (934)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (934)) COMMA_SOURCE_FILE_AT_LINE (934)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (934)), enumerator_39158.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (934)) COMMA_SOURCE_FILE_AT_LINE (934)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_39158.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (936)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (936)) ;
    }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_40176 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_40176.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_40176.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (953)) ;
    }
    enumerator_40176.gotoNextObject () ;
  }
  {
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_44558 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_44558.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_44558.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1052)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1052)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_44558.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1055)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_44558.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1056)) COMMA_SOURCE_FILE_AT_LINE (1056)) ;
  ...
  cEnumerator_insertMethodListAST enumerator_45244 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_45244.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_45244.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1062)) COMMA_SOURCE_FILE_AT_LINE (1062)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_45244.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_45244.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1063)) COMMA_SOURCE_FILE_AT_LINE (1063)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (1063)) COMMA_SOURCE_FILE_AT_LINE (1063)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_45244.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1067)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1070)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1065)) ;
      }
    }
  ...
  if (kBoolTrue == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_45818 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_45818.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_45818.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1080)), var_removeMethodFormalArgumentList, enumerator_45818.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (1082)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1084)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1078)) ;
      }
      enumerator_45818.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_46148 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_46148.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_46148.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1092)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1095)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1090)) ;
      }
      enumerator_46148.gotoNextObject () ;
    }
  }
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_mapOverrideBlockListAST enumerator_47898 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    while (enumerator_47898.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_47898.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1139)) COMMA_SOURCE_FILE_AT_LINE (1139)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1139)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1140)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1141)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1143)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1138)) ;
      }
      enumerator_47898.gotoNextObject () ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_48307 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_48307.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_48307.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1150)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1150)), enumerator_48307.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1150)) COMMA_SOURCE_FILE_AT_LINE (1150)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_48307.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1152)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1152)) ;
    }
    {
    ...
    enumerator_48307.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_48956 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_48956.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_48956.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1166)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1166)) COMMA_SOURCE_FILE_AT_LINE (1166)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1166)), enumerator_48956.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1166)) COMMA_SOURCE_FILE_AT_LINE (1166)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_48956.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1168)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1168)) ;
    }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_49974 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_49974.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_49974.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1185)) ;
    }
    enumerator_49974.gotoNextObject () ;
  }
  {
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_51780_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_51780_1 ; // Joker input parameter
  GALGAS_typedAttributeList joker_51820_2 ; // Joker input parameter
  GALGAS_attributeMap joker_51820_1 ; // Joker input parameter
  GALGAS_constructorMap joker_51876_11 ; // Joker input parameter
  GALGAS_readerMap joker_51876_10 ; // Joker input parameter
  GALGAS_modifierMap joker_51876_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_51876_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_51876_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_51876_6 ; // Joker input parameter
  GALGAS_stringlist joker_51876_5 ; // Joker input parameter
  GALGAS_uint joker_51876_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_51876_3 ; // Joker input parameter
  GALGAS_stringset joker_51876_2 ; // Joker input parameter
  GALGAS_lstringlist joker_51876_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_51930_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_51930_4 ; // Joker input parameter
  GALGAS_bool joker_51930_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_51930_2 ; // Joker input parameter
  GALGAS_string joker_51930_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_51780_2, joker_51780_1, var_typeKindEnum, joker_51820_2, joker_51820_1, var_mapTypedAttributeList, joker_51876_11, joker_51876_10, joker_51876_9, joker_51876_8, joker_51876_7, joker_51876_6, joker_51876_5, joker_51876_4, joker_51876_3, joker_51876_2, joker_51876_1, var_searchMethodList, joker_51930_5, joker_51930_4, joker_51930_3, joker_51930_2, joker_51930_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1240)) ;
  ...
  cEnumerator_mapSearchMethodListAST enumerator_53969 (var_searchMethodList, kEnumeration_up) ;
  while (enumerator_53969.hasCurrentObject ()) {
    {
    var_constructorMap.modifier_insertKey (enumerator_53969.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1289)) ;
    }
    enumerator_53969.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_54940 (var_mapTypedAttributeList, kEnumeration_up) ;
  while (enumerator_54940.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_54940.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1306)) COMMA_SOURCE_FILE_AT_LINE (1306)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_55082 (var_inheritedReaderMap.reader_keySet (SOURCE_FILE_AT_LINE (1308)), kEnumeration_up) ;
      while (enumerator_55082.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_55082.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (1309)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1309)) COMMA_SOURCE_FILE_AT_LINE (1309)) ;
        if (enumerator_55082.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (1310)) ;
        }
        enumerator_55082.gotoNextObject () ;
      }
      GALGAS_location location_3 (enumerator_54940.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      {
      var_readerMap.modifier_insertKey (enumerator_54940.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1317)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1318)), inCompiler->here (), GALGAS_bool (true), enumerator_54940.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1322)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1315)) ;
      }
    }
    enumerator_54940.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externTypeDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_externTypeConstructorList enumerator_57523 (object->mAttribute_mExternTypeConstructorList, kEnumeration_up) ;
  while (enumerator_57523.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_57523.current_mResultTypeName (HERE).mAttribute_string, var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1384)) ;
    }
    ...
    cEnumerator_lstringlist enumerator_57785 (enumerator_57523.current_mArgumentTypeNameList (HERE), kEnumeration_up) ;
    while (enumerator_57785.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_57785.current_mValue (HERE).mAttribute_string, var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1389)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1390)) ;
      enumerator_57785.gotoNextObject () ;
    }
    {
    var_constructorMap.modifier_insertKey (enumerator_57523.current_mConstructorName (HERE), var_arguments, GALGAS_bool (true), var_returnedTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1393)) ;
    }
    enumerator_57523.gotoNextObject () ;
  }
  cEnumerator_externTypeReaderList enumerator_58226 (object->mAttribute_mExternTypeReaderList, kEnumeration_up) ;
  while (enumerator_58226.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_58226.current_mResultTypeName (HERE).mAttribute_string, var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1403)) ;
    }
    ...
    cEnumerator_lstringlist enumerator_58488 (enumerator_58226.current_mArgumentTypeNameList (HERE), kEnumeration_up) ;
    while (enumerator_58488.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_58488.current_mValue (HERE).mAttribute_string, var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1408)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1409)) ;
      enumerator_58488.gotoNextObject () ;
    }
    {
    var_readerMap.modifier_insertKey (enumerator_58226.current_mReaderName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1414)), var_arguments, inCompiler->here (), GALGAS_bool (true), var_returnedTypeProxy, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1419)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1412)) ;
    }
    enumerator_58226.gotoNextObject () ;
  }
  cEnumerator_externTypeModifierList enumerator_59040 (object->mAttribute_mExternTypeModifierList, kEnumeration_up) ;
  while (enumerator_59040.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_59137 (enumerator_59040.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_59137.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59137.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1430)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1428)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_59137.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1433)) ;
      enumerator_59137.gotoNextObject () ;
    }
    {
    var_modifierMap.modifier_insertKey (enumerator_59040.current_mModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1438)), var_routineSignature, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1441)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1436)) ;
    }
    enumerator_59040.gotoNextObject () ;
  }
  cEnumerator_externTypeMethodList enumerator_59746 (object->mAttribute_mExternTypeMethodList, kEnumeration_up) ;
  while (enumerator_59746.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_59843 (enumerator_59746.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_59843.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59843.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1452)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1450)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_59843.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (1455)) ;
      enumerator_59843.gotoNextObject () ;
    }
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_59746.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1460)), var_routineSignature, enumerator_59746.current_mDeclarationLocation (HERE), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1464)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1458)) ;
    }
    enumerator_59746.gotoNextObject () ;
  }
  {
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_unifiedTypeMapProxyList enumerator_65023 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE_AT_LINE (1591)), kEnumeration_up) ;
  while (enumerator_65023.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (enumerator_65023.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1592)) COMMA_SOURCE_FILE_AT_LINE (1592)) ;
    enumerator_65023.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_65152 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_65152.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_65152.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1597)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1600)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1595)) ;
    }
    enumerator_65152.gotoNextObject () ;
  }
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_68427 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_68427.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_68427.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1687)) COMMA_SOURCE_FILE_AT_LINE (1687)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_68427.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1688)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1688)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1688)) ;
    }
    enumerator_68427.gotoNextObject () ;
  }
  GALGAS_readerMap var_readerMap ;
  {
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_filewrapperTemplateListAST enumerator_73020 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_73020.hasCurrentObject ()) {
    ...
    cEnumerator_formalTemplateInputParameterListAST enumerator_73138 (enumerator_73020.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_73138.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_73138.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1819)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1819)) ;
      }
    ...
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_73020.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_73020.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1822)) ;
    }
    enumerator_73020.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_textExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1829)) ;
  cEnumerator_lstringlist enumerator_73673 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_73673.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_73673.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1831)) ;
    }
    enumerator_73673.gotoNextObject () ;
  }
  ...
  cEnumerator_lstringlist enumerator_73879 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_73879.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_73879.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1836)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_73879.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_73879.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1837)) COMMA_SOURCE_FILE_AT_LINE (1837)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1837)) COMMA_SOURCE_FILE_AT_LINE (1837)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_73879.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1839)) ;
      }
    }
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_75829 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_75829.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_75829.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1892)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1892)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_76089 (enumerator_75829.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_76089.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_76089.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_76089.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_76089.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_75829.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1902)) ;
    enumerator_75829.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_77034 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_77034.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_77034.current_mAttributeTypeProxy (HERE), enumerator_77034.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1916)) COMMA_SOURCE_FILE_AT_LINE (1916)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_77034.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (1917)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_77034.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1918)) COMMA_SOURCE_FILE_AT_LINE (1918)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_77034.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1919)) COMMA_SOURCE_FILE_AT_LINE (1919)) ;
    enumerator_77034.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_78302 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_78302.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_78302.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_78302.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1939)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1939)), enumerator_78302.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1939)) COMMA_SOURCE_FILE_AT_LINE (1939)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1940)), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_uintType COMMA_SOURCE_FILE_AT_LINE (1941)), inCompiler->here (), GALGAS_bool (true), enumerator_78302.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1945)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1938)) ;
      }
    }
    enumerator_78302.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_79419 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_79419.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_79419.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      ...
      var_setterFormalArgumentList.addAssign_operation (enumerator_79419.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1979)) COMMA_SOURCE_FILE_AT_LINE (1979)) ;
      ...
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_79419.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1982)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1982)) COMMA_SOURCE_FILE_AT_LINE (1982)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1982)), enumerator_79419.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1982)) COMMA_SOURCE_FILE_AT_LINE (1982)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1983)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1986)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1981)) ;
      }
    }
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_83183 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_83183.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_83183.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2081)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2081)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_83183.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2084)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_83183.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2085)) COMMA_SOURCE_FILE_AT_LINE (2085)) ;
    ...
    enumerator_83183.gotoNextObject () ;
  }
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_87709 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_87709.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_87709.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2204)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2204)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2205)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_87709.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2208)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_87709.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2209)) ;
    }
    enumerator_87709.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_88447 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_88447.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_88447.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2226)), enumerator_88447.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2227)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2223)) ;
    }
    enumerator_88447.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_89629 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_89629.hasCurrentObject () && bool_1) {
    while (enumerator_89629.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_89629.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2261)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_89629.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2261)).operator_not (SOURCE_FILE_AT_LINE (2261)) COMMA_SOURCE_FILE_AT_LINE (2261)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_89629.gotoNextObject () ;
      if (enumerator_89629.hasCurrentObject ()) {
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_92023 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_92023.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_92023.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2322)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
    ...
    GALGAS_bool joker_92516_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_92516_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_92601_2 ; // Joker input parameter
    GALGAS_constructorMap joker_92601_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_92692_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_92692_9 ; // Joker input parameter
    GALGAS_stringlist joker_92692_8 ; // Joker input parameter
    GALGAS_uint joker_92692_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_92692_6 ; // Joker input parameter
    GALGAS_stringset joker_92692_5 ; // Joker input parameter
    GALGAS_lstringlist joker_92692_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_92692_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_92692_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_92692_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_92738_2 ; // Joker input parameter
    GALGAS_string joker_92738_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_92516_2, joker_92516_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_92601_2, joker_92601_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_92692_10, joker_92692_9, joker_92692_8, joker_92692_7, joker_92692_6, joker_92692_5, joker_92692_4, joker_92692_3, joker_92692_2, joker_92692_1, var_generateHeaderInSeparateFile, joker_92738_2, joker_92738_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2332)) ;
    ...
    cEnumerator_modifierMap enumerator_93027 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_93027.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_93027.current_lkey (HERE), enumerator_93027.current_mKind (HERE), enumerator_93027.current_mParameterList (HERE), enumerator_93027.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2358)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2353)) ;
      }
      enumerator_93027.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2363)) ;
    cEnumerator_readerMap enumerator_93353 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_93353.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_93353.current_lkey (HERE), enumerator_93353.current_mKind (HERE), enumerator_93353.current_mArgumentTypeList (HERE), enumerator_93353.current_mDeclarationLocation (HERE), enumerator_93353.current_mHasCompilerArgument (HERE), enumerator_93353.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2372)), enumerator_93353.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2365)) ;
      }
    ...
    cEnumerator_instanceMethodMap enumerator_93741 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_93741.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_93741.current_lkey (HERE), enumerator_93741.current_mKind (HERE), enumerator_93741.current_mParameterList (HERE), enumerator_93741.current_mDeclarationLocation (HERE), enumerator_93741.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2385)), enumerator_93741.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2379)) ;
      }
      enumerator_93741.gotoNextObject () ;
    }
  }
  ...
  cEnumerator_typedAttributeList enumerator_94160 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_94160.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_94160.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2393)) ;
    enumerator_94160.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_94263 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_94263.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_94263.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2397)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2397)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2398)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_94263.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2399)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_94263.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2400)) COMMA_SOURCE_FILE_AT_LINE (2400)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_94263.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_94263.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2401)) COMMA_SOURCE_FILE_AT_LINE (2401)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader") COMMA_SOURCE_FILE_AT_LINE (2401)) COMMA_SOURCE_FILE_AT_LINE (2401)) ;
    }
    enumerator_94263.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_95371 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_95371.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_95371.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2425)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2425)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_95631 (enumerator_95371.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_95631.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_95631.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2429)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_95631.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2431)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_95631.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_95371.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2435)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_95371.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2436)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_95371.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2440)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2441)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2445)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2438)) ;
      }
    }
    enumerator_95371.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_96687 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_96687.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_96687.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_96687.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2460)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2460)) COMMA_SOURCE_FILE_AT_LINE (2460)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2460)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2461)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_96687.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2462)) COMMA_SOURCE_FILE_AT_LINE (2462)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2464)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2459)) ;
      }
    }
    enumerator_96687.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_97708 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_97708.hasCurrentObject () && bool_12) {
    while (enumerator_97708.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_97708.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2488)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_97708.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2488)).operator_not (SOURCE_FILE_AT_LINE (2488)) COMMA_SOURCE_FILE_AT_LINE (2488)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_97708.gotoNextObject () ;
      if (enumerator_97708.hasCurrentObject ()) {
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_99356 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_99356.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_99356.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2533)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2533)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_99356.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (2534)) ;
    enumerator_99356.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_100351 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_100351.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_100351.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2552)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2552)) ;
    }
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2609)).isValid ()) {
    PMUInt32 variant_103141 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2609)).uintValue () ;
    bool loop_103141 = true ;
    while (loop_103141) {
      loop_103141 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2609)))).isValid () ;
      if (loop_103141) {
        loop_103141 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2609)))).boolValue () ;
      }
      if (loop_103141 && (0 == variant_103141)) {
        loop_103141 = false ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2648)).isValid ()) {
    PMUInt32 variant_104394 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2648)).uintValue () ;
    bool loop_104394 = true ;
    while (loop_104394) {
      loop_104394 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2648)))).isValid () ;
      if (loop_104394) {
        loop_104394 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2648)))).boolValue () ;
      }
      if (loop_104394 && (0 == variant_104394)) {
        loop_104394 = false ;
  ...
  {
  GALGAS_unifiedTypeMapProxy joker_104989_0 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_104992_0 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_104989_0, joker_104992_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2668)) ;
  }
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_107376_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_107376_1 ; // Joker input parameter
  GALGAS_attributeMap joker_107465_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_107465_18 ; // Joker input parameter
  GALGAS_constructorMap joker_107465_17 ; // Joker input parameter
  GALGAS_readerMap joker_107465_16 ; // Joker input parameter
  GALGAS_modifierMap joker_107465_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_107465_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_107465_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_107465_12 ; // Joker input parameter
  GALGAS_stringlist joker_107465_11 ; // Joker input parameter
  GALGAS_uint joker_107465_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_107465_9 ; // Joker input parameter
  GALGAS_stringset joker_107465_8 ; // Joker input parameter
  GALGAS_lstringlist joker_107465_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_107465_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_107465_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_107465_4 ; // Joker input parameter
  GALGAS_bool joker_107465_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_107465_2 ; // Joker input parameter
  GALGAS_string joker_107465_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_107376_2, joker_107376_1, var_typeKindEnum, var_listTypedAttributeList, joker_107465_19, joker_107465_18, joker_107465_17, joker_107465_16, joker_107465_15, joker_107465_14, joker_107465_13, joker_107465_12, joker_107465_11, joker_107465_10, joker_107465_9, joker_107465_8, joker_107465_7, joker_107465_6, joker_107465_5, joker_107465_4, joker_107465_3, joker_107465_2, joker_107465_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2735)) ;
  ...
  cEnumerator_typedAttributeList enumerator_109489 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_109489.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_109489.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2775)) ;
    enumerator_109489.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_113668 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_113668.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_113668.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2872)) COMMA_SOURCE_FILE_AT_LINE (2872)), enumerator_113668.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2872)) COMMA_SOURCE_FILE_AT_LINE (2872)) COMMA_SOURCE_FILE_AT_LINE (2872)) ;
    }
    enumerator_113668.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_114649 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_114649.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_114649.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2889)) COMMA_SOURCE_FILE_AT_LINE (2889)), enumerator_114649.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2889)) COMMA_SOURCE_FILE_AT_LINE (2889)) COMMA_SOURCE_FILE_AT_LINE (2889)) ;
    }
    enumerator_114649.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_115510 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_115510.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_115510.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2905)) COMMA_SOURCE_FILE_AT_LINE (2905)), enumerator_115510.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2905)) COMMA_SOURCE_FILE_AT_LINE (2905)) COMMA_SOURCE_FILE_AT_LINE (2905)) ;
    }
    enumerator_115510.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_117075 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_117075.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_117075.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2934)) COMMA_SOURCE_FILE_AT_LINE (2934)), enumerator_117075.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2934)) COMMA_SOURCE_FILE_AT_LINE (2934)) COMMA_SOURCE_FILE_AT_LINE (2934)) ;
    }
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_119569 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_119569.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_119569.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2978)) COMMA_SOURCE_FILE_AT_LINE (2978)), enumerator_119569.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2978)) COMMA_SOURCE_FILE_AT_LINE (2978)) COMMA_SOURCE_FILE_AT_LINE (2978)) ;
    }
    enumerator_119569.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_120427 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_120427.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_120427.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2994)) COMMA_SOURCE_FILE_AT_LINE (2994)), enumerator_120427.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2994)) COMMA_SOURCE_FILE_AT_LINE (2994)) COMMA_SOURCE_FILE_AT_LINE (2994)) ;
    }
    enumerator_120427.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_129509 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3166)) ;
  if (NULL != objectArray_129509) {
      macroValidSharedObject (objectArray_129509, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_129509->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3167)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_130810 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3194)) ;
  if (NULL != objectArray_130810) {
      macroValidSharedObject (objectArray_130810, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_130810->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3195)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_132081 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3221)) ;
  if (NULL != objectArray_132081) {
      macroValidSharedObject (objectArray_132081, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_132081->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3222)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_133981 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3260)) ;
  if (NULL != objectArray_133981) {
      macroValidSharedObject (objectArray_133981, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_133981->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3261)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_135330 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3288)) ;
  if (NULL != objectArray_135330) {
      macroValidSharedObject (objectArray_135330, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_135330->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3289)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_136641 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3315)) ;
  if (NULL != objectArray_136641) {
      macroValidSharedObject (objectArray_136641, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_136641->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3316)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_137480 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_137480.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_137480.current_mAttributeTypeName (HERE), enumerator_137480.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3345)) COMMA_SOURCE_FILE_AT_LINE (3342)) ;
    enumerator_137480.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_138114 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_138114.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_138114.current_mAttributeTypeName (HERE), enumerator_138114.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3366)) COMMA_SOURCE_FILE_AT_LINE (3363)) ;
    enumerator_138114.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_138756 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_138756.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_138756.current_mAttributeTypeName (HERE), enumerator_138756.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3387)) COMMA_SOURCE_FILE_AT_LINE (3384)) ;
    enumerator_138756.gotoNextObject () ;
  }
