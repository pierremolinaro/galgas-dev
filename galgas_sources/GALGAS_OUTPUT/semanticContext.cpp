...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147067 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147067.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_147067.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3573)) ;
    enumerator_147067.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147800 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147800.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_147800.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3585)) ;
    enumerator_147800.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (3593)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_148220 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3594)), kEnumeration_up) ;
    while (enumerator_148220.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_148220.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_148220.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3595)) COMMA_SOURCE_FILE_AT_LINE (3595)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3595)) COMMA_SOURCE_FILE_AT_LINE (3595)) ;
      enumerator_148220.gotoNextObject () ;
    }
    ...
    GALGAS_lstringlist joker_148556_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_148556_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3599)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3610)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_149141 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149141.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_149141.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3613)) COMMA_SOURCE_FILE_AT_LINE (3613)) COMMA_SOURCE_FILE_AT_LINE (3613)) ;
        enumerator_149141.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_149949 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149949.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_149949.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3633)) ;
        enumerator_149949.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, const cPtr_arrayDeclarationAST) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2717)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2740)).isValid ()) {
    PMUInt32 variant_109368 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2740)).uintValue () ;
    bool loop_109368 = true ;
    while (loop_109368) {
      loop_109368 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2740)))).isValid () ;
      if (loop_109368) {
        loop_109368 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2740)))).boolValue () ;
      }
      if (loop_109368 && (0 == variant_109368)) {
        loop_109368 = false ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2779)).isValid ()) {
    PMUInt32 variant_110680 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2779)).uintValue () ;
    bool loop_110680 = true ;
    while (loop_110680) {
      loop_110680 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2779)))).isValid () ;
      if (loop_110680) {
        loop_110680 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2779)))).boolValue () ;
      }
      if (loop_110680 && (0 == variant_110680)) {
        loop_110680 = false ;
  ...
  {
  GALGAS_unifiedTypeMapProxy joker_111294_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_111294_2 ; // Joker input parameter
  GALGAS_string joker_111294_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_111294_3, joker_111294_2, joker_111294_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2799)) ;
  }
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_113716_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_113716_1 ; // Joker input parameter
  GALGAS_attributeMap joker_113805_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_113805_18 ; // Joker input parameter
  GALGAS_constructorMap joker_113805_17 ; // Joker input parameter
  GALGAS_readerMap joker_113805_16 ; // Joker input parameter
  GALGAS_modifierMap joker_113805_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_113805_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_113805_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_113805_12 ; // Joker input parameter
  GALGAS_stringlist joker_113805_11 ; // Joker input parameter
  GALGAS_uint joker_113805_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_113805_9 ; // Joker input parameter
  GALGAS_stringset joker_113805_8 ; // Joker input parameter
  GALGAS_lstringlist joker_113805_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_113805_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_113805_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_113805_4 ; // Joker input parameter
  GALGAS_bool joker_113805_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_113805_2 ; // Joker input parameter
  GALGAS_string joker_113805_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_113716_2, joker_113716_1, var_typeKindEnum, var_listTypedAttributeList, joker_113805_19, joker_113805_18, joker_113805_17, joker_113805_16, joker_113805_15, joker_113805_14, joker_113805_13, joker_113805_12, joker_113805_11, joker_113805_10, joker_113805_9, joker_113805_8, joker_113805_7, joker_113805_6, joker_113805_5, joker_113805_4, joker_113805_3, joker_113805_2, joker_113805_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2866)) ;
  ...
  cEnumerator_typedAttributeList enumerator_115877 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_115877.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_115877.current_mAttributeTypeProxy (HERE), enumerator_115877.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2906)) ;
    enumerator_115877.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_120133 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_120133.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_120133.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3007)) COMMA_SOURCE_FILE_AT_LINE (3007)), enumerator_120133.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3007)) COMMA_SOURCE_FILE_AT_LINE (3007)) COMMA_SOURCE_FILE_AT_LINE (3007)) ;
    }
    enumerator_120133.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121115 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121115.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121115.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3024)) COMMA_SOURCE_FILE_AT_LINE (3024)), enumerator_121115.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3024)) COMMA_SOURCE_FILE_AT_LINE (3024)) COMMA_SOURCE_FILE_AT_LINE (3024)) ;
    }
    enumerator_121115.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121976 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121976.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121976.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3040)) COMMA_SOURCE_FILE_AT_LINE (3040)), enumerator_121976.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3040)) COMMA_SOURCE_FILE_AT_LINE (3040)) COMMA_SOURCE_FILE_AT_LINE (3040)) ;
    }
    enumerator_121976.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_123542 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123542.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123542.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3069)) COMMA_SOURCE_FILE_AT_LINE (3069)), enumerator_123542.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3069)) COMMA_SOURCE_FILE_AT_LINE (3069)) COMMA_SOURCE_FILE_AT_LINE (3069)) ;
    }
    enumerator_123542.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_126038 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126038.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126038.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3113)) COMMA_SOURCE_FILE_AT_LINE (3113)), enumerator_126038.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3113)) COMMA_SOURCE_FILE_AT_LINE (3113)) COMMA_SOURCE_FILE_AT_LINE (3113)) ;
    }
    enumerator_126038.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_126896 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126896.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126896.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3129)) COMMA_SOURCE_FILE_AT_LINE (3129)), enumerator_126896.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3129)) COMMA_SOURCE_FILE_AT_LINE (3129)) COMMA_SOURCE_FILE_AT_LINE (3129)) ;
    }
    enumerator_126896.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_135981 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3301)) ;
  if (NULL != objectArray_135981) {
      macroValidSharedObject (objectArray_135981, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_135981->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3302)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_137283 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3329)) ;
  if (NULL != objectArray_137283) {
      macroValidSharedObject (objectArray_137283, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_137283->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3330)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_138555 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3356)) ;
  if (NULL != objectArray_138555) {
      macroValidSharedObject (objectArray_138555, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_138555->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3357)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_140456 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3395)) ;
  if (NULL != objectArray_140456) {
      macroValidSharedObject (objectArray_140456, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_140456->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3396)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_141806 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3423)) ;
  if (NULL != objectArray_141806) {
      macroValidSharedObject (objectArray_141806, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_141806->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3424)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_143118 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3450)) ;
  if (NULL != objectArray_143118) {
      macroValidSharedObject (objectArray_143118, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_143118->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3451)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_143957 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_143957.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_143957.current_mAttributeTypeName (HERE), enumerator_143957.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3480)) COMMA_SOURCE_FILE_AT_LINE (3477)) ;
    enumerator_143957.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_144591 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_144591.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_144591.current_mAttributeTypeName (HERE), enumerator_144591.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3501)) COMMA_SOURCE_FILE_AT_LINE (3498)) ;
    enumerator_144591.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_145233 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145233.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145233.current_mAttributeTypeName (HERE), enumerator_145233.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3522)) COMMA_SOURCE_FILE_AT_LINE (3519)) ;
    enumerator_145233.gotoNextObject () ;
  }
