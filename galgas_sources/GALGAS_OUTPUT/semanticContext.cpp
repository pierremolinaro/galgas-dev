...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_74597 (var_files, kEnumeration_up) ;
  while (enumerator_74597.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_74597.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1867)) COMMA_SOURCE_FILE_AT_LINE (1867)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1868)).operator_concat (enumerator_74597.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1868)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_74597.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1870)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1869)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1876)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_74597.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1877)) COMMA_SOURCE_FILE_AT_LINE (1877)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1878)).operator_concat (enumerator_74597.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1878)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_74597.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1880)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1879)) ;
        }
  ...
  cEnumerator_stringlist enumerator_75562 (var_directories, kEnumeration_up) ;
  while (enumerator_75562.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1897)).operator_concat (enumerator_75562.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1897)), constinArgument_inPathInWrapper.operator_concat (enumerator_75562.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1898)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1898)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1896)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_75562.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1907)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1906)) ;
    }
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_144875 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_144875.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_144875.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3570)) ;
    enumerator_144875.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_145608 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_145608.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_145608.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3582)) ;
    enumerator_145608.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_146028 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3591)), kEnumeration_up) ;
    while (enumerator_146028.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_146028.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_146028.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3592)) COMMA_SOURCE_FILE_AT_LINE (3592)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3592)) COMMA_SOURCE_FILE_AT_LINE (3592)) ;
      enumerator_146028.gotoNextObject () ;
    }
    ...
    GALGAS_lstringlist joker_146364_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_146364_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3596)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_146949 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_146949.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_146949.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3610)) COMMA_SOURCE_FILE_AT_LINE (3610)) COMMA_SOURCE_FILE_AT_LINE (3610)) ;
        enumerator_146949.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_147757 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_147757.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_147757.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3630)) ;
        enumerator_147757.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_72203 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_72203.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_72203.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1797)) COMMA_SOURCE_FILE_AT_LINE (1797)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_72203.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1798)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1798)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1798)) ;
    }
    enumerator_72203.gotoNextObject () ;
  }
  GALGAS_readerMap var_readerMap ;
  {
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_filewrapperTemplateListAST enumerator_76796 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_76796.hasCurrentObject ()) {
    ...
    cEnumerator_formalTemplateInputParameterListAST enumerator_76914 (enumerator_76796.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_76914.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_76914.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1929)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1930)) ;
      enumerator_76914.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_76796.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_76796.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1932)) ;
    }
    enumerator_76796.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_textExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1939)) ;
  cEnumerator_lstringlist enumerator_77433 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_77433.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_77433.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1941)) ;
    }
    enumerator_77433.gotoNextObject () ;
  }
  ...
  cEnumerator_lstringlist enumerator_77639 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_77639.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_77639.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1946)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_77639.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_77639.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1947)) COMMA_SOURCE_FILE_AT_LINE (1947)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1947)) COMMA_SOURCE_FILE_AT_LINE (1947)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_77639.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1949)) ;
      }
    }
    enumerator_77639.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_79589 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_79589.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_79589.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2002)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_79833 (enumerator_79589.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_79833.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_79833.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_79833.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_79833.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_79589.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2012)) ;
    enumerator_79589.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_80765 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_80765.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_80765.current_mAttributeTypeProxy (HERE), enumerator_80765.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2026)) COMMA_SOURCE_FILE_AT_LINE (2026)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_80765.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2027)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_80765.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2028)) COMMA_SOURCE_FILE_AT_LINE (2028)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_80765.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2029)) COMMA_SOURCE_FILE_AT_LINE (2029)) ;
    enumerator_80765.gotoNextObject () ;
  }
  ...
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2041)) ;
  {
  ...
  cEnumerator_typedAttributeList enumerator_82033 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_82033.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_82033.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_82033.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2049)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2049)), enumerator_82033.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2049)) COMMA_SOURCE_FILE_AT_LINE (2049)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2050)), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_uintType COMMA_SOURCE_FILE_AT_LINE (2051)), inCompiler->here (), GALGAS_bool (true), enumerator_82033.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2055)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2048)) ;
      }
    }
  ...
  cEnumerator_typedAttributeList enumerator_83823 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_83823.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_83823.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      ...
      var_setterFormalArgumentList.addAssign_operation (enumerator_83823.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2111)) COMMA_SOURCE_FILE_AT_LINE (2111)) ;
      ...
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_83823.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2114)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2114)) COMMA_SOURCE_FILE_AT_LINE (2114)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2114)), enumerator_83823.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2114)) COMMA_SOURCE_FILE_AT_LINE (2114)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2115)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2118)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2113)) ;
      }
    }
    enumerator_83823.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_87573 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_87573.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_87573.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2205)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_87573.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2208)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_87573.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2209)) COMMA_SOURCE_FILE_AT_LINE (2209)) ;
    ...
    enumerator_87573.gotoNextObject () ;
  }
  ...
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2223)) ;
  {
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_92122 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_92122.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_92122.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2332)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2333)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_92122.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2336)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_92122.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2337)) ;
    }
  ...
  cEnumerator_typedAttributeList enumerator_92844 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_92844.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_92844.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2354)), enumerator_92844.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2355)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2351)) ;
    }
    enumerator_92844.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_94029 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_94029.hasCurrentObject () && bool_1) {
    while (enumerator_94029.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_94029.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2389)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_94029.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2389)).operator_not (SOURCE_FILE_AT_LINE (2389)) COMMA_SOURCE_FILE_AT_LINE (2389)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_94029.gotoNextObject () ;
      if (enumerator_94029.hasCurrentObject ()) {
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_96426 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_96426.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_96426.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2450)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_96426.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    ...
    GALGAS_bool joker_96903_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_96903_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_96988_2 ; // Joker input parameter
    GALGAS_constructorMap joker_96988_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_97079_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_97079_9 ; // Joker input parameter
    GALGAS_stringlist joker_97079_8 ; // Joker input parameter
    GALGAS_uint joker_97079_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_97079_6 ; // Joker input parameter
    GALGAS_stringset joker_97079_5 ; // Joker input parameter
    GALGAS_lstringlist joker_97079_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_97079_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_97079_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_97079_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_97125_2 ; // Joker input parameter
    GALGAS_string joker_97125_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_96903_2, joker_96903_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_96988_2, joker_96988_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_97079_10, joker_97079_9, joker_97079_8, joker_97079_7, joker_97079_6, joker_97079_5, joker_97079_4, joker_97079_3, joker_97079_2, joker_97079_1, var_generateHeaderInSeparateFile, joker_97125_2, joker_97125_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2460)) ;
    ...
    cEnumerator_modifierMap enumerator_97414 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_97414.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_97414.current_lkey (HERE), enumerator_97414.current_mKind (HERE), enumerator_97414.current_mParameterList (HERE), enumerator_97414.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2486)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2481)) ;
      }
      enumerator_97414.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2491)) ;
    cEnumerator_readerMap enumerator_97740 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_97740.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_97740.current_lkey (HERE), enumerator_97740.current_mKind (HERE), enumerator_97740.current_mArgumentTypeList (HERE), enumerator_97740.current_mDeclarationLocation (HERE), enumerator_97740.current_mHasCompilerArgument (HERE), enumerator_97740.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2500)), enumerator_97740.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2493)) ;
      }
      enumerator_97740.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2505)) ;
    cEnumerator_instanceMethodMap enumerator_98128 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_98128.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_98128.current_lkey (HERE), enumerator_98128.current_mKind (HERE), enumerator_98128.current_mParameterList (HERE), enumerator_98128.current_mDeclarationLocation (HERE), enumerator_98128.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2513)), enumerator_98128.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2507)) ;
      }
  ...
  cEnumerator_typedAttributeList enumerator_98547 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_98547.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_98547.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2521)) ;
    enumerator_98547.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_98650 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_98650.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_98650.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2525)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2526)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_98650.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2527)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_98650.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2528)) COMMA_SOURCE_FILE_AT_LINE (2528)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_98650.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_98650.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2529)) COMMA_SOURCE_FILE_AT_LINE (2529)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader") COMMA_SOURCE_FILE_AT_LINE (2529)) COMMA_SOURCE_FILE_AT_LINE (2529)) ;
    }
    enumerator_98650.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_99726 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_99726.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_99726.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2553)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_99970 (enumerator_99726.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_99970.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_99970.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2557)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_99970.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2559)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_99970.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_99726.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2563)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_99726.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2564)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_99726.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2568)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2569)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2573)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2566)) ;
      }
    }
    enumerator_99726.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_101026 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_101026.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_101026.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_101026.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2588)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2588)) COMMA_SOURCE_FILE_AT_LINE (2588)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2588)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2589)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_101026.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2590)) COMMA_SOURCE_FILE_AT_LINE (2590)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2592)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2587)) ;
      }
    }
    enumerator_101026.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_102047 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_102047.hasCurrentObject () && bool_12) {
    while (enumerator_102047.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_102047.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2616)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_102047.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2616)).operator_not (SOURCE_FILE_AT_LINE (2616)) COMMA_SOURCE_FILE_AT_LINE (2616)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_102047.gotoNextObject () ;
      if (enumerator_102047.hasCurrentObject ()) {
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_103695 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_103695.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_103695.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2661)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_103695.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (2662)) ;
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_104674 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_104674.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_104674.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2680)) ;
    }
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2725)) ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2737)).isValid ()) {
    PMUInt32 variant_107390 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2737)).uintValue () ;
    bool loop_107390 = true ;
    while (loop_107390) {
      loop_107390 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2737)))).isValid () ;
      if (loop_107390) {
        loop_107390 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2737)))).boolValue () ;
      }
      if (loop_107390 && (0 == variant_107390)) {
        loop_107390 = false ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2776)).isValid ()) {
    PMUInt32 variant_108643 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2776)).uintValue () ;
    bool loop_108643 = true ;
    while (loop_108643) {
      loop_108643 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2776)))).isValid () ;
      if (loop_108643) {
        loop_108643 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2776)))).boolValue () ;
      }
      if (loop_108643 && (0 == variant_108643)) {
        loop_108643 = false ;
  ...
  {
  GALGAS_unifiedTypeMapProxy joker_109238_0 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_109241_0 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_109238_0, joker_109241_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2796)) ;
  }
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_111625_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_111625_1 ; // Joker input parameter
  GALGAS_attributeMap joker_111714_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_111714_18 ; // Joker input parameter
  GALGAS_constructorMap joker_111714_17 ; // Joker input parameter
  GALGAS_readerMap joker_111714_16 ; // Joker input parameter
  GALGAS_modifierMap joker_111714_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_111714_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_111714_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_111714_12 ; // Joker input parameter
  GALGAS_stringlist joker_111714_11 ; // Joker input parameter
  GALGAS_uint joker_111714_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_111714_9 ; // Joker input parameter
  GALGAS_stringset joker_111714_8 ; // Joker input parameter
  GALGAS_lstringlist joker_111714_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_111714_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_111714_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_111714_4 ; // Joker input parameter
  GALGAS_bool joker_111714_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_111714_2 ; // Joker input parameter
  GALGAS_string joker_111714_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_111625_2, joker_111625_1, var_typeKindEnum, var_listTypedAttributeList, joker_111714_19, joker_111714_18, joker_111714_17, joker_111714_16, joker_111714_15, joker_111714_14, joker_111714_13, joker_111714_12, joker_111714_11, joker_111714_10, joker_111714_9, joker_111714_8, joker_111714_7, joker_111714_6, joker_111714_5, joker_111714_4, joker_111714_3, joker_111714_2, joker_111714_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2863)) ;
  ...
  GALGAS_readerMap var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2876)) ;
  ...
  cEnumerator_typedAttributeList enumerator_113709 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_113709.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_113709.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2903)) ;
    enumerator_113709.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_117941 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_117941.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_117941.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3004)) COMMA_SOURCE_FILE_AT_LINE (3004)), enumerator_117941.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3004)) COMMA_SOURCE_FILE_AT_LINE (3004)) COMMA_SOURCE_FILE_AT_LINE (3004)) ;
    }
    enumerator_117941.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_118923 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_118923.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_118923.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3021)) COMMA_SOURCE_FILE_AT_LINE (3021)), enumerator_118923.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3021)) COMMA_SOURCE_FILE_AT_LINE (3021)) COMMA_SOURCE_FILE_AT_LINE (3021)) ;
    }
    enumerator_118923.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_119784 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_119784.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_119784.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3037)) COMMA_SOURCE_FILE_AT_LINE (3037)), enumerator_119784.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3037)) COMMA_SOURCE_FILE_AT_LINE (3037)) COMMA_SOURCE_FILE_AT_LINE (3037)) ;
    }
    enumerator_119784.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121350 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121350.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121350.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3066)) COMMA_SOURCE_FILE_AT_LINE (3066)), enumerator_121350.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3066)) COMMA_SOURCE_FILE_AT_LINE (3066)) COMMA_SOURCE_FILE_AT_LINE (3066)) ;
    }
    enumerator_121350.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_123846 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123846.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123846.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3110)) COMMA_SOURCE_FILE_AT_LINE (3110)), enumerator_123846.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3110)) COMMA_SOURCE_FILE_AT_LINE (3110)) COMMA_SOURCE_FILE_AT_LINE (3110)) ;
    }
    enumerator_123846.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_124704 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_124704.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_124704.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3126)) COMMA_SOURCE_FILE_AT_LINE (3126)), enumerator_124704.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3126)) COMMA_SOURCE_FILE_AT_LINE (3126)) COMMA_SOURCE_FILE_AT_LINE (3126)) ;
    }
    enumerator_124704.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_133789 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3298)) ;
  if (NULL != objectArray_133789) {
      macroValidSharedObject (objectArray_133789, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_133789->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3299)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_135091 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3326)) ;
  if (NULL != objectArray_135091) {
      macroValidSharedObject (objectArray_135091, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_135091->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3327)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_136363 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3353)) ;
  if (NULL != objectArray_136363) {
      macroValidSharedObject (objectArray_136363, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_136363->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3354)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_138264 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3392)) ;
  if (NULL != objectArray_138264) {
      macroValidSharedObject (objectArray_138264, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_138264->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3393)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_139614 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3420)) ;
  if (NULL != objectArray_139614) {
      macroValidSharedObject (objectArray_139614, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_139614->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3421)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_140926 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3447)) ;
  if (NULL != objectArray_140926) {
      macroValidSharedObject (objectArray_140926, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_140926->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3448)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_141765 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_141765.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_141765.current_mAttributeTypeName (HERE), enumerator_141765.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3477)) COMMA_SOURCE_FILE_AT_LINE (3474)) ;
    enumerator_141765.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_142399 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_142399.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_142399.current_mAttributeTypeName (HERE), enumerator_142399.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3498)) COMMA_SOURCE_FILE_AT_LINE (3495)) ;
    enumerator_142399.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_143041 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_143041.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_143041.current_mAttributeTypeName (HERE), enumerator_143041.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3519)) COMMA_SOURCE_FILE_AT_LINE (3516)) ;
    enumerator_143041.gotoNextObject () ;
  }
