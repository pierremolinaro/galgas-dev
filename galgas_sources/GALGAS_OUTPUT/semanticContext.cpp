...
void routine_addCategories (const GALGAS_categoryMethodMapForBuildingContext constinArgument_inCategoryMethodMapForBuildingContext,
  ...
  if (kBoolTrue == test_1) {
    ...
    while (enumerator_20843.hasCurrentObject ()) {
      ...
      cEnumerator_formalInputParameterListAST enumerator_20944 (enumerator_20843.current_mInputFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_20944.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_20944.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 530)) ;
        }
        var_formalArgumentList.addAssign_operation (enumerator_20944.current_mFormalSelector (HERE), var_typeIndex, enumerator_20944.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 531)) ;
  ...
  if (kBoolTrue == test_2) {
    ...
    cEnumerator_categoryModifierMapForType enumerator_21955 (var_categoryModifierMapForType, kEnumeration_up) ;
    while (enumerator_21955.hasCurrentObject ()) {
      ...
      cEnumerator_formalParameterListAST enumerator_22058 (enumerator_21955.current_mFormalParameterList (HERE), kEnumeration_up) ;
      while (enumerator_22058.hasCurrentObject ()) {
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        {
        GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_22058.current_mFormalArgumentTypeName (HERE), var_typeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 555)) ;
        }
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_22058.current_mFormalArgumentPassingMode (HERE), enumerator_22058.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 556)) ;
        enumerator_22058.gotoNextObject () ;
      }
      {
      ioArgument_ioModifierMap.modifier_insertKey (enumerator_21955.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE ("semanticContext.gSemantics", 560)), var_formalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 563)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 558)) ;
      }
...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_76657 (var_files, kEnumeration_up) ;
  while (enumerator_76657.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_76657.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("semanticContext.gSemantics", 1881)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1881)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1882)).operator_concat (enumerator_76657.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1882)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76657.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1884)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1883)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1890)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_76657.current_mValue (HERE).reader_pathExtension (SOURCE_FILE ("semanticContext.gSemantics", 1891)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1891)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1892)).operator_concat (enumerator_76657.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1892)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76657.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1894)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1893)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1900)) ;
      }
    }
    enumerator_76657.gotoNextObject () ;
  }
  ...
  cEnumerator_stringlist enumerator_77622 (var_directories, kEnumeration_up) ;
  while (enumerator_77622.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1911)).operator_concat (enumerator_77622.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1911)), constinArgument_inPathInWrapper.operator_concat (enumerator_77622.current_mValue (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1912)).operator_concat (GALGAS_string ("/")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1912)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1910)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_77622.current_mValue (HERE), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1921)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1920)) ;
    }
    enumerator_77622.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_semanticDeclarationListAST constinArgument_inSemanticDeclarationList,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147540 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147540.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_147540.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3592)) ;
    enumerator_147540.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_148273 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_148273.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_148273.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3604)) ;
    enumerator_148273.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_148748 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE ("semanticContext.gSemantics", 3614)), kEnumeration_up) ;
    while (enumerator_148748.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_148748.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_148748.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3615))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3615)).operator_concat (GALGAS_string ("' type is not defined")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3615))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3615)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
      enumerator_148748.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    ...
    GALGAS_lstringlist joker_148988_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_148988_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3618)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_149383 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149383.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_149383.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3627))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3627))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3627)) ;
        enumerator_149383.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_150114 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_150114.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_150114.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3645)) ;
        enumerator_150114.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  while (enumerator_36421.hasCurrentObject ()) {
    ...
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_36421.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 861)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_argumentTypeListForAddAssignWithFieldExpressionList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 864)), var_attributeTypeIndex, enumerator_36421.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 864)) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_36421.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 865)) ;
    ...
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_36421.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 867))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 867)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 868)), enumerator_36421.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 868)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 869)), enumerator_36421.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 869)) ;
    enumerator_36421.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_37297 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_37297.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_37297.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 873)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 873)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_37297.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_37297.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 874))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 874)).operator_concat (GALGAS_string ("' insert method is already declared")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 874))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 874)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_37297.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 878)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 881)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 876)) ;
      }
    }
    enumerator_37297.gotoNextObject () ;
  }
  cEnumerator_mapRemoveMethodListAST enumerator_37771 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  while (enumerator_37771.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_modifierMap.reader_hasKey (enumerator_37771.current_mMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 888)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 888)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_37771.current_mMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_37771.current_mMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 889))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 889)).operator_concat (GALGAS_string ("' method is already declared as an insert modifier or a remove modifier")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 889))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 889)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_37771.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 893)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 896)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 891)) ;
      }
    }
    enumerator_37771.gotoNextObject () ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_38298 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_38298.hasCurrentObject ()) {
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_38298.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 905)), var_removeMethodFormalArgumentList, enumerator_38298.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 907)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 909)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 903)) ;
    }
  ...
  while (enumerator_38633.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_38633.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 915)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 915)), enumerator_38633.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 915))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 915)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_38633.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 917)) ;
    }
    {
  ...
  cEnumerator_attributeInCollectionListAST enumerator_39783 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_39783.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_39783.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 944)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 944))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 944)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 944)), enumerator_39783.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 944))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 944)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_39783.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 945)) ;
    }
    ...
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 947)), enumerator_39783.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 947)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 948)), enumerator_39783.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 948)) ;
    {
    ...
    enumerator_39783.gotoNextObject () ;
  }
  {
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  var_insertMethodFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1054)), GALGAS_string ("inLKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1054)) ;
  ...
  var_removeMethodFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1056)), GALGAS_string ("inLKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1056)) ;
  cEnumerator_attributeInCollectionListAST enumerator_45499 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_45499.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_45499.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1059)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_45499.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1062)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_45499.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1063))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1063)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1064)), enumerator_45499.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1064)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 1065)), enumerator_45499.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1065)) ;
    enumerator_45499.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_46233 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_46233.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_46233.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1069)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1069)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_46233.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_46233.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1070))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1070)).operator_concat (GALGAS_string ("' insert method is already declared")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1070))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1070)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_46233.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1074)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1077)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1072)) ;
      }
    }
    enumerator_46233.gotoNextObject () ;
  }
  ...
  var_enterEdgeFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1084)), GALGAS_string ("inSource")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1084)) ;
  var_enterEdgeFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1085)), GALGAS_string ("inTarget")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1085)) ;
  {
  ...
  var_topologicalSortFormalArgumentList.addAssign_operation (var_lstringlistTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 1096)), GALGAS_string ("outSortedLKeys")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1096)) ;
  var_topologicalSortFormalArgumentList.addAssign_operation (var_lstringlistTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 1097)), GALGAS_string ("outUnsortedLKeys")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1097)) ;
  {
  ...
  if (kBoolTrue == test_3) {
    ...
    {
    var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("closeBranch"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1145)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1146)), GALGAS_formalParameterSignature::constructor_listWithValue (var_locationTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 1147)), GALGAS_string ("inErrorLocation")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1147)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1149)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1144)) ;
    }
    {
    var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("closeOverride"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1153)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1154)), GALGAS_formalParameterSignature::constructor_listWithValue (var_locationTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 1155)), GALGAS_string ("inErrorLocation")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1155)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 1157)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1152)) ;
    }
    {
    var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("checkAutomatonStates"), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1161)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1162)), GALGAS_formalParameterSignature::constructor_listWithValue (var_locationTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 1163)), GALGAS_string ("inErrorLocation")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1163)), inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1166)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1160)) ;
    }
    cEnumerator_mapOverrideBlockListAST enumerator_50118 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    while (enumerator_50118.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_50118.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 1171))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1171)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1171)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1172)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 1173)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1175)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1170)) ;
      }
      enumerator_50118.gotoNextObject () ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_50527 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_50527.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_50527.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1182)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1182)), enumerator_50527.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 1182))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1182)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_50527.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1184)) ;
    }
    {
    ...
    enumerator_50527.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_51197 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_51197.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_51197.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1198)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 1198))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1198)).operator_concat (GALGAS_string ("ForKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1198)), enumerator_51197.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 1198))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1198)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_51197.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1199)) ;
    }
    ...
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1201)), enumerator_51197.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1201)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1202)), enumerator_51197.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1202)) ;
    {
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_53801_3 ; // Joker input parameter
  GALGAS_bool joker_53801_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_53801_1 ; // Joker input parameter
  GALGAS_bool joker_53841_3 ; // Joker input parameter
  GALGAS_typedAttributeList joker_53841_2 ; // Joker input parameter
  GALGAS_attributeMap joker_53841_1 ; // Joker input parameter
  GALGAS_constructorMap joker_53896_11 ; // Joker input parameter
  GALGAS_readerMap joker_53896_10 ; // Joker input parameter
  GALGAS_modifierMap joker_53896_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_53896_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_53896_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_53896_6 ; // Joker input parameter
  GALGAS_stringlist joker_53896_5 ; // Joker input parameter
  GALGAS_uint joker_53896_4 ; // Joker input parameter
  GALGAS_functionSignature joker_53896_3 ; // Joker input parameter
  GALGAS_stringset joker_53896_2 ; // Joker input parameter
  GALGAS_lstringlist joker_53896_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_53951_6 ; // Joker input parameter
  GALGAS_bool joker_53951_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_53951_4 ; // Joker input parameter
  GALGAS_string joker_53951_3 ; // Joker input parameter
  GALGAS_string joker_53951_2 ; // Joker input parameter
  GALGAS_headerKind joker_53951_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_53801_3, joker_53801_2, joker_53801_1, var_typeKindEnum, joker_53841_3, joker_53841_2, joker_53841_1, var_mapTypedAttributeList, joker_53896_11, joker_53896_10, joker_53896_9, joker_53896_8, joker_53896_7, joker_53896_6, joker_53896_5, joker_53896_4, joker_53896_3, joker_53896_2, joker_53896_1, var_searchMethodList, joker_53951_6, joker_53951_5, joker_53951_4, joker_53951_3, joker_53951_2, joker_53951_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1264)) ;
  ...
  var_argList.addAssign_operation (var_associatedMapTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE ("semanticContext.gSemantics", 1297)), GALGAS_string ("ioMap")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1297)) ;
  var_argList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1298)), GALGAS_string ("inLKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1298)) ;
  var_argList.addAssign_operation (var_mapProxyTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 1299)), GALGAS_string ("outProxy")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1299)) ;
  {
  ...
  var_argList.addAssign_operation (var_associatedMapTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE ("semanticContext.gSemantics", 1307)), GALGAS_string ("ioMap")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1307)) ;
  var_argList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 1308)), GALGAS_string ("inLKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1308)) ;
  var_argList.addAssign_operation (var_mapProxyTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 1309)), GALGAS_string ("outProxy")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1309)) ;
  {
  ...
  cEnumerator_mapSearchMethodListAST enumerator_56543 (var_searchMethodList, kEnumeration_up) ;
  while (enumerator_56543.hasCurrentObject ()) {
    {
    var_constructorMap.modifier_insertKey (enumerator_56543.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1322)) ;
    }
    enumerator_56543.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_57514 (var_mapTypedAttributeList, kEnumeration_up) ;
  while (enumerator_57514.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_57514.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1339)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1339)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_57648 (var_inheritedReaderMap.reader_keySet (SOURCE_FILE ("semanticContext.gSemantics", 1341)), kEnumeration_up) ;
      while (enumerator_57648.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_57648.current_key (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1342)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1342))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1342)) ;
        if (enumerator_57648.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1343)) ;
        }
        enumerator_57648.gotoNextObject () ;
      }
      GALGAS_location location_3 (enumerator_57514.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      {
      var_readerMap.modifier_insertKey (enumerator_57514.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1350)), GALGAS_functionSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 1351)), inCompiler->here (), GALGAS_bool (true), enumerator_57514.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1355)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1348)) ;
      }
    }
...
static void categoryMethod_externTypeDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_externTypeConstructorList enumerator_60222 (object->mAttribute_mExternTypeConstructorList, kEnumeration_up) ;
  while (enumerator_60222.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60222.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1420)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_60456 (enumerator_60222.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_60456.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60456.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1425)) ;
      }
      var_arguments.addAssign_operation (enumerator_60456.current_mFormalSelector (HERE), var_argumentTypeProxy, enumerator_60456.current_mFormalParameterName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1426)) ;
      enumerator_60456.gotoNextObject () ;
    }
    {
    var_constructorMap.modifier_insertKey (enumerator_60222.current_mConstructorName (HERE), var_arguments, GALGAS_bool (true), var_returnedTypeProxy, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1429)) ;
    }
    enumerator_60222.gotoNextObject () ;
  }
  cEnumerator_externTypeReaderList enumerator_60947 (object->mAttribute_mExternTypeReaderList, kEnumeration_up) ;
  while (enumerator_60947.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60947.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1439)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_61175 (enumerator_60947.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_61175.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61175.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1444)) ;
      }
      var_arguments.addAssign_operation (enumerator_61175.current_mFormalSelector (HERE), var_argumentTypeProxy, enumerator_61175.current_mFormalParameterName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1445)) ;
      enumerator_61175.gotoNextObject () ;
    }
    {
    var_readerMap.modifier_insertKey (enumerator_60947.current_mReaderName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1450)), var_arguments, inCompiler->here (), GALGAS_bool (true), var_returnedTypeProxy, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1455)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1448)) ;
    }
    enumerator_60947.gotoNextObject () ;
  }
  cEnumerator_externTypeModifierList enumerator_61777 (object->mAttribute_mExternTypeModifierList, kEnumeration_up) ;
  while (enumerator_61777.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_61874 (enumerator_61777.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_61874.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61874.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1463)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_61874.current_mFormalArgumentPassingMode (HERE), enumerator_61874.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1468)) ;
      enumerator_61874.gotoNextObject () ;
    }
    {
    var_modifierMap.modifier_insertKey (enumerator_61777.current_mModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1473)), var_routineSignature, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1476)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1471)) ;
    }
    enumerator_61777.gotoNextObject () ;
  }
  cEnumerator_externTypeMethodList enumerator_62470 (object->mAttribute_mExternTypeMethodList, kEnumeration_up) ;
  while (enumerator_62470.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_62567 (enumerator_62470.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_62567.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_62567.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1485)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_62567.current_mFormalArgumentPassingMode (HERE), enumerator_62567.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1490)) ;
      enumerator_62567.gotoNextObject () ;
    }
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_62470.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1495)), var_routineSignature, enumerator_62470.current_mDeclarationLocation (HERE), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 1499)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1493)) ;
    }
    enumerator_62470.gotoNextObject () ;
  }
  {
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  var_formalParameterList.addAssign_operation (var_associatedListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 1561)), GALGAS_string ("outSortedInformationList")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1561)) ;
  var_formalParameterList.addAssign_operation (var_lstringListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 1562)), GALGAS_string ("outSortedLKeyList")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1562)) ;
  var_formalParameterList.addAssign_operation (var_associatedListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 1563)), GALGAS_string ("outUnsortedInformationList")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1563)) ;
  var_formalParameterList.addAssign_operation (var_lstringListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 1564)), GALGAS_string ("outUnsortedLKeyList")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1564)) ;
  {
  ...
  var_formalParameterList.addAssign_operation (var_associatedListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 1586)), GALGAS_string ("outInformationList")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1586)) ;
  var_formalParameterList.addAssign_operation (var_lstringListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 1587)), GALGAS_string ("outLKeyList")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1587)) ;
  {
  ...
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 1684)), GALGAS_string ("inLKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1684)) ;
  cEnumerator_functionSignature enumerator_69764 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1685)), kEnumeration_up) ;
  while (enumerator_69764.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (enumerator_69764.current_mFormalArgumentType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 1686)), enumerator_69764.current_mFormalArgumentName (HERE)  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1686)) ;
    enumerator_69764.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_69928 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_69928.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_69928.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 1691)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 1694)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1689)) ;
    }
  ...
  var_formalParameterList.addAssign_operation (var_stringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 1710)), GALGAS_string ("inNodeName")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1710)) ;
  {
  ...
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 1722)), GALGAS_string ("inSourceNodeLKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1722)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 1723)), GALGAS_string ("inTargetNodeLKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1723)) ;
  {
  ...
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 1735)), GALGAS_string ("inNodeLKey")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1735)) ;
  {
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_74178 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_74178.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_74178.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1808))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1808)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_74178.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1809)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1809)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1809)) ;
    }
    enumerator_74178.gotoNextObject () ;
  }
  GALGAS_readerMap var_readerMap ;
  {
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_filewrapperTemplateListAST enumerator_78856 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_78856.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxyList var_templateSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 1940)) ;
    cEnumerator_formalTemplateInputParameterListAST enumerator_78974 (enumerator_78856.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_78974.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_78974.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1943)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1944)) ;
      enumerator_78974.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_78856.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_78856.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1946)) ;
    }
    enumerator_78856.gotoNextObject () ;
  }
  ...
  cEnumerator_lstringlist enumerator_79493 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_79493.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_79493.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1955)) ;
    }
  ...
  cEnumerator_lstringlist enumerator_79699 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_79699.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_79699.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1960)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_79699.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_79699.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 1961))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1961)).operator_concat (GALGAS_string ("' extension is already used for text files")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1961))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1961)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_79699.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 1963)) ;
      }
    }
    enumerator_79699.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_81666 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_81666.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_81666.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2016)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_81886 (enumerator_81666.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_81886.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_81886.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_81886.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_81886.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_81666.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2026)) ;
    enumerator_81666.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_83021 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_83021.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_83021.current_mAttributeTypeProxy (HERE), enumerator_83021.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2044))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2044)) ;
    var_constructorAttributeTypeList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2045)), enumerator_83021.current_mAttributeTypeProxy (HERE), enumerator_83021.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2045)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_83021.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 2046)), enumerator_83021.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2046)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_83021.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2047)), enumerator_83021.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2047)) ;
    enumerator_83021.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_84444 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_84444.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_84444.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      ...
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_84444.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2067)).operator_concat (GALGAS_string ("AtIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2067)), enumerator_84444.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 2067))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2067)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2068)), temp_3, inCompiler->here (), GALGAS_bool (true), enumerator_84444.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2073)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2066)) ;
      }
    }
    enumerator_84444.gotoNextObject () ;
  }
  ...
  var_modifierOutputFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2116)), GALGAS_string ("inIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2116)) ;
  {
  ...
  cEnumerator_typedAttributeList enumerator_86250 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_86250.hasCurrentObject ()) {
    const enumGalgasBool test_4 = enumerator_86250.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_4) {
      ...
      var_setterFormalArgumentList.addAssign_operation (enumerator_86250.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2129)), enumerator_86250.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2129)) ;
      var_setterFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2130)), enumerator_86250.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2130)) ;
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_86250.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2132)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2132))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2132)).operator_concat (GALGAS_string ("AtIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2132)), enumerator_86250.current_mAttributeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 2132))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2132)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2133)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2136)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2131)) ;
      }
    }
    enumerator_86250.gotoNextObject () ;
  }
  var_modifierInputFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2142)), GALGAS_string ("inInsertionIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2142)) ;
  {
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_89945 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_89945.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_89945.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2221)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_89945.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2224)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_89945.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2225)) ;
    var_constructorAttributeTypeList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2226)), var_attributeTypeIndex, enumerator_89945.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2226)) ;
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE ("semanticContext.gSemantics", 2227)), enumerator_89945.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2227)) ;
    enumerator_89945.gotoNextObject () ;
  }
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_94563 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_94563.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_94563.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2346)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2347)), var_attributeTypeIndex, enumerator_94563.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2347)) ;
    ...
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_94563.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2351)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_94563.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2352)) ;
    }
    enumerator_94563.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_95362 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_95362.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_95362.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2367)), enumerator_95362.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2368)), GALGAS_bool (false), inCompiler  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2364)) ;
    }
    enumerator_95362.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_96412 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_96412.hasCurrentObject () && bool_1) {
    while (enumerator_96412.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_96412.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2401)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_96412.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2401)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2401)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2401)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_96412.gotoNextObject () ;
      if (enumerator_96412.hasCurrentObject ()) {
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_98901 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_98901.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_98901.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2465)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_98901.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    ...
    GALGAS_bool joker_99380_3 ; // Joker input parameter
    GALGAS_bool joker_99380_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_99380_1 ; // Joker input parameter
    GALGAS_bool joker_99410_0 ; // Joker input parameter
    GALGAS_typedAttributeList joker_99474_2 ; // Joker input parameter
    GALGAS_constructorMap joker_99474_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_99564_9 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_99564_8 ; // Joker input parameter
    GALGAS_stringlist joker_99564_7 ; // Joker input parameter
    GALGAS_uint joker_99564_6 ; // Joker input parameter
    GALGAS_functionSignature joker_99564_5 ; // Joker input parameter
    GALGAS_stringset joker_99564_4 ; // Joker input parameter
    GALGAS_lstringlist joker_99564_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_99564_2 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_99564_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_99610_4 ; // Joker input parameter
    GALGAS_string joker_99610_3 ; // Joker input parameter
    GALGAS_string joker_99610_2 ; // Joker input parameter
    GALGAS_headerKind joker_99610_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_99380_3, joker_99380_2, joker_99380_1, var_typeKindEnum, joker_99410_0, var_inheritedTypedAttributeList, var_attributeMap, joker_99474_2, joker_99474_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_99564_9, joker_99564_8, joker_99564_7, joker_99564_6, joker_99564_5, joker_99564_4, joker_99564_3, joker_99564_2, joker_99564_1, var_generateHeaderInSeparateFile, joker_99610_4, joker_99610_3, joker_99610_2, joker_99610_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2475)) ;
    ...
    cEnumerator_modifierMap enumerator_99897 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_99897.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_99897.current_lkey (HERE), enumerator_99897.current_mKind (HERE), enumerator_99897.current_mParameterList (HERE), enumerator_99897.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2502)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2497)) ;
      }
      enumerator_99897.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2507)) ;
    cEnumerator_readerMap enumerator_100223 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_100223.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_100223.current_lkey (HERE), enumerator_100223.current_mKind (HERE), enumerator_100223.current_mArgumentTypeList (HERE), enumerator_100223.current_mDeclarationLocation (HERE), enumerator_100223.current_mHasCompilerArgument (HERE), enumerator_100223.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2516)), enumerator_100223.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2509)) ;
      }
      enumerator_100223.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE ("semanticContext.gSemantics", 2521)) ;
    cEnumerator_instanceMethodMap enumerator_100611 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_100611.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_100611.current_lkey (HERE), enumerator_100611.current_mKind (HERE), enumerator_100611.current_mParameterList (HERE), enumerator_100611.current_mDeclarationLocation (HERE), enumerator_100611.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE ("semanticContext.gSemantics", 2529)), enumerator_100611.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2523)) ;
      }
      enumerator_100611.gotoNextObject () ;
    }
  }
  ...
  cEnumerator_typedAttributeList enumerator_101024 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_101024.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2537)), enumerator_101024.current_mAttributeTypeProxy (HERE), enumerator_101024.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2537)) ;
    enumerator_101024.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_101165 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_101165.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_101165.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2541)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2542)), var_attributeTypeIndex, enumerator_101165.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2542)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_101165.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2543)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_101165.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2544)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2544)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_101165.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_101165.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2545))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2545)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2545))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2545)) ;
    }
    enumerator_101165.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_102279 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_102279.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_102279.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2569)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_102523 (enumerator_102279.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_102523.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_102523.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2573)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_102523.current_mValue (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2575)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_102523.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_102279.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2579)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_102279.current_mAttributeName (HERE), var_hasSetter, var_hasGetter  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2580)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_102279.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2584)), GALGAS_functionSignature::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 2585)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE ("semanticContext.gSemantics", 2589)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2582)) ;
      }
    }
    enumerator_102279.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_103324 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_103324.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_103324.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_103324.current_mAttributeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 2598)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE ("semanticContext.gSemantics", 2598))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2598)), inCompiler->here ()  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2598)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE ("semanticContext.gSemantics", 2599)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_103324.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE ("semanticContext.gSemantics", 2600)), enumerator_103324.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2600)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE ("semanticContext.gSemantics", 2602)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2597)) ;
      }
    }
    enumerator_103324.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_104366 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_104366.hasCurrentObject () && bool_12) {
    while (enumerator_104366.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_104366.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2626)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_104366.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2626)).operator_not (SOURCE_FILE ("semanticContext.gSemantics", 2626)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2626)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_104366.gotoNextObject () ;
      if (enumerator_104366.hasCurrentObject ()) {
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_106105 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_106105.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_106105.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2674)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_106105.current_mFormalArgumentPassingMode (HERE), enumerator_106105.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2675)) ;
    enumerator_106105.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_107135 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_107135.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_107135.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2697)) ;
    }
    var_functionSignature.addAssign_operation (enumerator_107135.current_mFormalSelector (HERE), var_parameterTypeIndex, enumerator_107135.current_mFormalArgumentTypeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2698)) ;
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2758)).isValid ()) {
    uint32_t variant_109975 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2758)).uintValue () ;
    bool loop_109975 = true ;
    while (loop_109975) {
      loop_109975 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2758)))).isValid () ;
      if (loop_109975) {
        loop_109975 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2758)))).boolValue () ;
      }
      if (loop_109975 && (0 == variant_109975)) {
        loop_109975 = false ;
  ...
  var_modifierFormalArgumentList.addAssign_operation (var_elementTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2795)), GALGAS_string ("InValue")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2795)) ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2797)).isValid ()) {
    uint32_t variant_111301 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2797)).uintValue () ;
    bool loop_111301 = true ;
    while (loop_111301) {
      loop_111301 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2797)))).isValid () ;
      if (loop_111301) {
        loop_111301 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE ("semanticContext.gSemantics", 2797)))).boolValue () ;
      }
      if (loop_111301 && (0 == variant_111301)) {
        loop_111301 = false ;
  ...
  {
  GALGAS_unifiedTypeMapProxy joker_111916_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_111916_2 ; // Joker input parameter
  GALGAS_string joker_111916_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_111916_3, joker_111916_2, joker_111916_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2817)) ;
  }
  {
  ...
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2835)), GALGAS_string ("inSize")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2835)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE ("semanticContext.gSemantics", 2836)), GALGAS_string ("inAxisIndex")  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2836)) ;
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_114314_3 ; // Joker input parameter
  GALGAS_bool joker_114314_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_114314_1 ; // Joker input parameter
  GALGAS_bool joker_114354_0 ; // Joker input parameter
  GALGAS_attributeMap joker_114409_20 ; // Joker input parameter
  GALGAS_typedAttributeList joker_114409_19 ; // Joker input parameter
  GALGAS_constructorMap joker_114409_18 ; // Joker input parameter
  GALGAS_readerMap joker_114409_17 ; // Joker input parameter
  GALGAS_modifierMap joker_114409_16 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_114409_15 ; // Joker input parameter
  GALGAS_classMethodMap joker_114409_14 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_114409_13 ; // Joker input parameter
  GALGAS_stringlist joker_114409_12 ; // Joker input parameter
  GALGAS_uint joker_114409_11 ; // Joker input parameter
  GALGAS_functionSignature joker_114409_10 ; // Joker input parameter
  GALGAS_stringset joker_114409_9 ; // Joker input parameter
  GALGAS_lstringlist joker_114409_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_114409_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_114409_6 ; // Joker input parameter
  GALGAS_bool joker_114409_5 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_114409_4 ; // Joker input parameter
  GALGAS_string joker_114409_3 ; // Joker input parameter
  GALGAS_string joker_114409_2 ; // Joker input parameter
  GALGAS_headerKind joker_114409_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_114314_3, joker_114314_2, joker_114314_1, var_typeKindEnum, joker_114354_0, var_listTypedAttributeList, joker_114409_20, joker_114409_19, joker_114409_18, joker_114409_17, joker_114409_16, joker_114409_15, joker_114409_14, joker_114409_13, joker_114409_12, joker_114409_11, joker_114409_10, joker_114409_9, joker_114409_8, joker_114409_7, joker_114409_6, joker_114409_5, joker_114409_4, joker_114409_3, joker_114409_2, joker_114409_1, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2886)) ;
  ...
  cEnumerator_typedAttributeList enumerator_116257 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_116257.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (GALGAS_string::makeEmptyString ().reader_nowhere (SOURCE_FILE ("semanticContext.gSemantics", 2922)), enumerator_116257.current_mAttributeTypeProxy (HERE), enumerator_116257.current_mAttributeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 2922)) ;
    enumerator_116257.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_120703 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_120703.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_120703.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3029))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3029)), object->mAttribute_mSuperClassName.mAttribute_location  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3029)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3029)) ;
    }
    enumerator_120703.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121561 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121561.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121561.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3045))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3045)), enumerator_121561.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3045))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3045)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3045)) ;
    }
    enumerator_121561.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_122425 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_122425.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_122425.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3061))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3061)), enumerator_122425.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3061))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3061)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3061)) ;
    }
    enumerator_122425.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_123997 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123997.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123997.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3090))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3090)), enumerator_123997.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3090))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3090)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3090)) ;
    }
    enumerator_123997.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_126502 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126502.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126502.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3134))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3134)), enumerator_126502.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3134))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3134)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3134)) ;
    }
    enumerator_126502.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_127363 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_127363.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_127363.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE ("semanticContext.gSemantics", 3150))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3150)), enumerator_127363.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE ("semanticContext.gSemantics", 3150))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3150)) COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3150)) ;
    }
    enumerator_127363.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_136460 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryReaderMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3322)) ;
  if (NULL != objectArray_136460) {
      macroValidSharedObject (objectArray_136460, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_136460->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3323)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_137765 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryMethodMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3350)) ;
  if (NULL != objectArray_137765) {
      macroValidSharedObject (objectArray_137765, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_137765->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3351)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_139040 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryModifierMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3377)) ;
  if (NULL != objectArray_139040) {
      macroValidSharedObject (objectArray_139040, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_139040->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3378)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_140944 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryReaderMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3416)) ;
  if (NULL != objectArray_140944) {
      macroValidSharedObject (objectArray_140944, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_140944->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3417)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_142297 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryMethodMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3444)) ;
  if (NULL != objectArray_142297) {
      macroValidSharedObject (objectArray_142297, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_142297->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3445)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_143612 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, object->mAttribute_mTypeName, kSearchErrorMessage_categoryModifierMapForBuildingContext_searchKey  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3471)) ;
  if (NULL != objectArray_143612) {
      macroValidSharedObject (objectArray_143612, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_143612->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3472)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_144451 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_144451.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_144451.current_mAttributeTypeName (HERE), enumerator_144451.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3501))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3498)) ;
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_145094 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145094.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145094.current_mAttributeTypeName (HERE), enumerator_145094.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3522))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3519)) ;
    enumerator_145094.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_145745 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145745.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145745.current_mAttributeTypeName (HERE), enumerator_145745.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("semanticContext.gSemantics", 3543))  COMMA_SOURCE_FILE ("semanticContext.gSemantics", 3540)) ;
    enumerator_145745.gotoNextObject () ;
  }
