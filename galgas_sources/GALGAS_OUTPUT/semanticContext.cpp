...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  ioArgument_ioWrapperDirectoryIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1879)) ;
  GALGAS_stringlist var_files = constinArgument_inAbsoluteSourcePath.reader_regularFiles (GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1881)) ;
  outArgument_outWrapperFileMap = GALGAS_wrapperFileMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1882)) ;
  cEnumerator_stringlist enumerator_76440 (var_files, kEnumeration_up) ;
  while (enumerator_76440.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_76440.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1884)) COMMA_SOURCE_FILE_AT_LINE (1884)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1885)).operator_concat (enumerator_76440.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1885)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76440.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1887)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1886)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1893)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_76440.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1894)) COMMA_SOURCE_FILE_AT_LINE (1894)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1895)).operator_concat (enumerator_76440.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1895)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76440.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1897)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1896)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1903)) ;
      }
    }
    enumerator_76440.gotoNextObject () ;
  }
  GALGAS_stringlist var_directories = constinArgument_inAbsoluteSourcePath.reader_directories (GALGAS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1907)) ;
  outArgument_outWrapperDirectoryMap = GALGAS_wrapperDirectoryMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1908)) ;
  cEnumerator_stringlist enumerator_77405 (var_directories, kEnumeration_up) ;
  while (enumerator_77405.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1914)).operator_concat (enumerator_77405.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1914)), constinArgument_inPathInWrapper.operator_concat (enumerator_77405.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1915)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1915)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1913)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_77405.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1924)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1923)) ;
    }
    enumerator_77405.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147699 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147699.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_147699.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3591)) ;
    enumerator_147699.gotoNextObject () ;
  }
  GALGAS_semanticTypePrecedenceGraph var_semanticTypePrecedenceGraph = GALGAS_semanticTypePrecedenceGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (3597)) ;
  GALGAS_categoryMethodMapForBuildingContext var_categoryMethodMapForBuildingContext = GALGAS_categoryMethodMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3598)) ;
  GALGAS_categoryReaderMapForBuildingContext var_categoryReaderMapForBuildingContext = GALGAS_categoryReaderMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3599)) ;
  GALGAS_categoryModifierMapForBuildingContext var_categoryModifierMapForBuildingContext = GALGAS_categoryModifierMapForBuildingContext::constructor_emptyMap (SOURCE_FILE_AT_LINE (3600)) ;
  GALGAS_semanticDeclarationListAST var_categoryOverrideDefinitionList = GALGAS_semanticDeclarationListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3601)) ;
  cEnumerator_semanticDeclarationListAST enumerator_148432 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_148432.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_148432.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3603)) ;
    enumerator_148432.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_semanticTypePrecedenceGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (3611)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_148852 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3612)), kEnumeration_up) ;
    while (enumerator_148852.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_148852.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_148852.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3613)) COMMA_SOURCE_FILE_AT_LINE (3613)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3613)) COMMA_SOURCE_FILE_AT_LINE (3613)) ;
      enumerator_148852.gotoNextObject () ;
    }
    inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("semantic analysis not performed, due to undefined type error(s)") COMMA_SOURCE_FILE_AT_LINE (3615)) ;
    ...
    GALGAS_lstringlist joker_149190_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_149190_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3617)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3623)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string ("semantic analysis not performed, ").operator_concat (var_unsortedSemanticDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (3624)).reader_string (SOURCE_FILE_AT_LINE (3624)) COMMA_SOURCE_FILE_AT_LINE (3624)).operator_concat (GALGAS_string (" declarations are involved in circular definition:") COMMA_SOURCE_FILE_AT_LINE (3624)) ;
      cEnumerator_semanticDeclarationListAST enumerator_149585 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149585.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_149585.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3626)) COMMA_SOURCE_FILE_AT_LINE (3626)) COMMA_SOURCE_FILE_AT_LINE (3626)) ;
        enumerator_149585.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (3628)) ;
      outArgument_outSemanticContext.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      var_sortedSemanticDeclarationListAST.dotAssign_operation (var_categoryOverrideDefinitionList COMMA_SOURCE_FILE_AT_LINE (3631)) ;
      outArgument_outSemanticContext = GALGAS_semanticContext::constructor_new (constinArgument_inSourceFile, GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3635)), GALGAS_routineMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3636)), GALGAS_functionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3637)), GALGAS_filewrapperMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3638)), GALGAS_grammarMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (3639)), GALGAS_optionComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3640)), GALGAS_lexiqueComponentMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3641)), GALGAS_optionMapForSemanticAnalysis::constructor_emptyMap (SOURCE_FILE_AT_LINE (3642)) COMMA_SOURCE_FILE_AT_LINE (3633)) ;
      cEnumerator_semanticDeclarationListAST enumerator_150393 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_150393.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_150393.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3646)) ;
        enumerator_150393.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_predefinedTypeAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (GALGAS_lstring::constructor_new (object->mAttribute_mPredefinedTypeName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (765)), GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (767)), GALGAS_typeKindEnum::constructor_predefinedType (SOURCE_FILE_AT_LINE (768)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (769)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (770)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (771)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, var_classMethodMap, var_enumerationList, var_enumerationVariants, callCategoryReader_getSupportedOperatorFlags ((const cPtr_predefinedTypeAST *) temp_8.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (779)), var_addAssignArgumentList, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (781)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (782)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (783)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (784)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (785)), GALGAS_bool (false), var_enumeratedTypeProxy, categoryReader_defaultConstructorName (object->mAttribute_mKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (788)), GALGAS_string ("predefined-types"), inCompiler COMMA_SOURCE_FILE_AT_LINE (764)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("bool"), var_boolTypeIndex COMMA_SOURCE_FILE_AT_LINE (809)) ;
  }
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (812)) ;
  }
  GALGAS_unifiedTypeMapProxy var_locationTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("location"), var_locationTypeProxy COMMA_SOURCE_FILE_AT_LINE (815)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstring"), var_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (818)) ;
  }
  GALGAS_unifiedTypeMapProxy var_currentMapTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mMapTypeName, var_currentMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (821)) ;
  }
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_listWithValue (var_lstringTypeIndex, GALGAS_string ("lkey") COMMA_SOURCE_FILE_AT_LINE (823)) ;
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (824)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (825)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (826)) ;
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (828)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (829)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (830)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (831)) ;
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyMap"), object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (833)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (833)) ;
  }
  {
  routine_enterConstructorWithArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("mapWithMapToOverride"), object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (834)), GALGAS_string ("inMap"), object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (834)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (834)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("levels"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (836)) ;
  }
  {
  routine_enterInheritedReaderWith_32_Arguments (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("hasKeyAtLevel"), GALGAS_string ("string"), GALGAS_string ("inKey"), GALGAS_string ("uint"), GALGAS_string ("inLevel"), GALGAS_string ("bool"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (837)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keySet"), GALGAS_string ("stringset"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (838)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keyList"), GALGAS_string ("lstringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (839)) ;
  }
  {
  routine_enterInheritedReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("hasKey"), GALGAS_string ("string"), GALGAS_string ("inKey"), GALGAS_string ("bool"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (840)) ;
  }
  {
  routine_enterInheritedReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("locationForKey"), GALGAS_string ("string"), GALGAS_string ("inKey"), GALGAS_string ("location"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (841)) ;
  }
  {
  routine_enterBaseReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("overriddenMap"), object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (842)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (842)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("count"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (843)) ;
  }
  GALGAS_formalParameterSignature var_insertMethodFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (845)) ;
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (846)) ;
  var_insertMethodFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (847)), GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (847)) ;
  GALGAS_formalParameterSignature var_removeMethodFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (848)) ;
  var_removeMethodFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (849)), GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (849)) ;
  cEnumerator_attributeInCollectionListAST enumerator_35985 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_35985.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_35985.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (852)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_35985.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (855)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_35985.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (856)) COMMA_SOURCE_FILE_AT_LINE (856)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (857)), enumerator_35985.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (857)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (858)), enumerator_35985.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (858)) ;
    enumerator_35985.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_36703 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_36703.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_36703.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (862)) COMMA_SOURCE_FILE_AT_LINE (862)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_36703.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_36703.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (863)) COMMA_SOURCE_FILE_AT_LINE (863)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (863)) COMMA_SOURCE_FILE_AT_LINE (863)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_36703.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (867)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (870)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (865)) ;
      }
    }
    enumerator_36703.gotoNextObject () ;
  }
  cEnumerator_mapRemoveMethodListAST enumerator_37177 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  while (enumerator_37177.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_modifierMap.reader_hasKey (enumerator_37177.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (877)) COMMA_SOURCE_FILE_AT_LINE (877)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_37177.current_mMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_37177.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (878)) COMMA_SOURCE_FILE_AT_LINE (878)).operator_concat (GALGAS_string ("' method is already declared as an insert modifier or a remove modifier") COMMA_SOURCE_FILE_AT_LINE (878)) COMMA_SOURCE_FILE_AT_LINE (878)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_37177.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (882)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (885)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (880)) ;
      }
    }
    enumerator_37177.gotoNextObject () ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_37704 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_37704.hasCurrentObject ()) {
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_37704.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (894)), var_removeMethodFormalArgumentList, enumerator_37704.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (896)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (898)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (892)) ;
    }
    enumerator_37704.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_38039 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_38039.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_38039.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (904)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (904)), enumerator_38039.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (904)) COMMA_SOURCE_FILE_AT_LINE (904)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_38039.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (906)) ;
    }
    {
    var_readerMap.modifier_insertOrReplace (var_accessorName, GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (909)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_listWithValue (var_stringTypeIndex, GALGAS_string ("inKey") COMMA_SOURCE_FILE_AT_LINE (910)), inCompiler->here (), GALGAS_bool (true), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (914)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (907)) ;
    }
    enumerator_38039.gotoNextObject () ;
  }
  const enumGalgasBool test_4 = GALGAS_bool (kIsSupOrEqual, object->mAttribute_mInsertOrReplaceDeclarationListAST.reader_length (SOURCE_FILE_AT_LINE (919)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
  if (kBoolTrue == test_4) {
    GALGAS_location var_insertOrReplaceLocation ;
    object->mAttribute_mInsertOrReplaceDeclarationListAST.method_first (var_insertOrReplaceLocation, inCompiler COMMA_SOURCE_FILE_AT_LINE (921)) ;
    {
    var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("insertOrReplace"), var_insertOrReplaceLocation COMMA_SOURCE_FILE_AT_LINE (923)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (924)), var_insertMethodFormalArgumentList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (927)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (922)) ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_39186 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_39186.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_39186.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (933)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (933)) COMMA_SOURCE_FILE_AT_LINE (933)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (933)), enumerator_39186.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (933)) COMMA_SOURCE_FILE_AT_LINE (933)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_39186.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (935)) ;
    }
    ...
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (937)), enumerator_39186.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (937)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (938)), enumerator_39186.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (938)) ;
    {
    var_modifierMap.modifier_insertOrReplace (var_accessorName, GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (941)), var_accessorFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (944)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (939)) ;
    }
    enumerator_39186.gotoNextObject () ;
  }
  GALGAS_withAccessorMap var_withAccessorMap = GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (949)) ;
  {
  var_withAccessorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("hasKey"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (950)), var_stringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (950)) ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_40239 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_40239.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_40239.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (952)) ;
    }
    enumerator_40239.gotoNextObject () ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mMapTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (958)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratorTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mMapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (971)) COMMA_SOURCE_FILE_AT_LINE (971)), object->mAttribute_mMapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (971)), var_enumeratorTypeIndex COMMA_SOURCE_FILE_AT_LINE (969)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mMapTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (978)), GALGAS_typeKindEnum::constructor_mapType (SOURCE_FILE_AT_LINE (979)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (980)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (981)), var_typedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (987)), var_enumerationDescriptor, var_enumerationVariants, function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (990)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (991)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (992)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (993)), object->mAttribute_mSearchMethodList, GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (995)), var_withAccessorMap, GALGAS_bool (false), var_enumeratorTypeIndex, GALGAS_string ("emptyMap"), GALGAS_string ("map-").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (1000)) COMMA_SOURCE_FILE_AT_LINE (1000)), inCompiler COMMA_SOURCE_FILE_AT_LINE (975)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1014)) ;
  }
  GALGAS_unifiedTypeMapProxy var_locationTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("location"), var_locationTypeProxy COMMA_SOURCE_FILE_AT_LINE (1017)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstring"), var_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1020)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringlistTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstringlist"), var_lstringlistTypeIndex COMMA_SOURCE_FILE_AT_LINE (1023)) ;
  }
  GALGAS_unifiedTypeMapProxy var_currentMapTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mMapTypeName, var_currentMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (1026)) ;
  }
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_listWithValue (var_lstringTypeIndex, GALGAS_string ("lkey") COMMA_SOURCE_FILE_AT_LINE (1028)) ;
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1029)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (1030)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (1031)) ;
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1033)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1034)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1035)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1036)) ;
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyMap"), object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (1038)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1038)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("allKeys"), GALGAS_string ("stringset"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1040)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("allKeyList"), GALGAS_string ("lstringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1041)) ;
  }
  {
  routine_enterInheritedReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("hasKey"), GALGAS_string ("string"), GALGAS_string ("inKey"), GALGAS_string ("bool"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1042)) ;
  }
  {
  routine_enterInheritedReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("locationForKey"), GALGAS_string ("string"), GALGAS_string ("inKey"), GALGAS_string ("location"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1043)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("count"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1044)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("unsolvedProxyCount"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1045)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("unsolvedProxyList"), GALGAS_string ("lstringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1046)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("edgeGraphvizRepresentation"), GALGAS_string ("string"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1047)) ;
  }
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1049)) ;
  GALGAS_formalParameterSignature var_insertMethodFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1050)) ;
  var_insertMethodFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1051)), GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (1051)) ;
  GALGAS_formalParameterSignature var_removeMethodFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1052)) ;
  var_removeMethodFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1053)), GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (1053)) ;
  cEnumerator_attributeInCollectionListAST enumerator_45086 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_45086.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_45086.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1056)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_45086.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1059)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_45086.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1060)) COMMA_SOURCE_FILE_AT_LINE (1060)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1061)), enumerator_45086.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1061)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1062)), enumerator_45086.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1062)) ;
    enumerator_45086.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_45820 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_45820.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_45820.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1066)) COMMA_SOURCE_FILE_AT_LINE (1066)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_45820.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_45820.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1067)) COMMA_SOURCE_FILE_AT_LINE (1067)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (1067)) COMMA_SOURCE_FILE_AT_LINE (1067)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_45820.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1071)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1074)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1069)) ;
      }
    }
    enumerator_45820.gotoNextObject () ;
  }
  GALGAS_formalParameterSignature var_enterEdgeFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1080)) ;
  var_enterEdgeFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1081)), GALGAS_string ("inSource") COMMA_SOURCE_FILE_AT_LINE (1081)) ;
  var_enterEdgeFormalArgumentList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1082)), GALGAS_string ("inTarget") COMMA_SOURCE_FILE_AT_LINE (1082)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_string ("enterEdge").reader_nowhere (SOURCE_FILE_AT_LINE (1084)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1085)), var_enterEdgeFormalArgumentList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1088)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1083)) ;
  }
  GALGAS_formalParameterSignature var_topologicalSortFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1092)) ;
  var_topologicalSortFormalArgumentList.addAssign_operation (var_lstringlistTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1093)), GALGAS_string ("outSortedLKeys") COMMA_SOURCE_FILE_AT_LINE (1093)) ;
  var_topologicalSortFormalArgumentList.addAssign_operation (var_lstringlistTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1094)), GALGAS_string ("outUnsortedLKeys") COMMA_SOURCE_FILE_AT_LINE (1094)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_string ("topologicalSort").reader_nowhere (SOURCE_FILE_AT_LINE (1096)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1097)), var_topologicalSortFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1101)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1095)) ;
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, object->mAttribute_mMapStateList.reader_length (SOURCE_FILE_AT_LINE (1105)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_47565 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_47565.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_47565.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1109)), var_removeMethodFormalArgumentList, enumerator_47565.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (1111)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1113)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1107)) ;
      }
      enumerator_47565.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_47895 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_47895.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_47895.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1121)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1124)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1119)) ;
      }
      enumerator_47895.gotoNextObject () ;
    }
  }
  const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, object->mAttribute_mMapStateList.reader_length (SOURCE_FILE_AT_LINE (1130)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_3) {
    GALGAS_unifiedTypeMapProxy var_locationTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("location"), var_locationTypeIndex COMMA_SOURCE_FILE_AT_LINE (1132)) ;
    }
    {
    var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openBranch"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1134)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1135)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1136)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1138)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1133)) ;
    }
    {
    var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("closeBranch"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1142)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1143)), GALGAS_formalParameterSignature::constructor_listWithValue (var_locationTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1144)), GALGAS_string ("inErrorLocation") COMMA_SOURCE_FILE_AT_LINE (1144)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1146)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1141)) ;
    }
    {
    var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("closeOverride"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1150)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1151)), GALGAS_formalParameterSignature::constructor_listWithValue (var_locationTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1152)), GALGAS_string ("inErrorLocation") COMMA_SOURCE_FILE_AT_LINE (1152)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1154)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1149)) ;
    }
    {
    var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("checkAutomatonStates"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1158)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1159)), GALGAS_formalParameterSignature::constructor_listWithValue (var_locationTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1160)), GALGAS_string ("inErrorLocation") COMMA_SOURCE_FILE_AT_LINE (1160)), inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1163)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1157)) ;
    }
    cEnumerator_mapOverrideBlockListAST enumerator_49705 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    while (enumerator_49705.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_49705.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1168)) COMMA_SOURCE_FILE_AT_LINE (1168)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1168)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1169)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1170)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1172)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1167)) ;
      }
      enumerator_49705.gotoNextObject () ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_50114 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_50114.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_50114.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1179)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1179)), enumerator_50114.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1179)) COMMA_SOURCE_FILE_AT_LINE (1179)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_50114.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1181)) ;
    }
    {
    var_readerMap.modifier_insertOrReplace (var_accessorName, GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1184)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_listWithValue (var_stringTypeIndex, GALGAS_string ("inKey") COMMA_SOURCE_FILE_AT_LINE (1185)), inCompiler->here (), GALGAS_bool (true), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1189)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1182)) ;
    }
    enumerator_50114.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_50771 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_50771.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_50771.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1195)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1195)) COMMA_SOURCE_FILE_AT_LINE (1195)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1195)), enumerator_50771.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1195)) COMMA_SOURCE_FILE_AT_LINE (1195)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_50771.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1197)) ;
    }
    GALGAS_formalParameterSignature var_accessorFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1198)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1199)), enumerator_50771.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1199)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1200)), enumerator_50771.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1200)) ;
    {
    var_modifierMap.modifier_insertOrReplace (var_accessorName, GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1203)), var_accessorFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1206)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1201)) ;
    }
    enumerator_50771.gotoNextObject () ;
  }
  GALGAS_withAccessorMap var_withAccessorMap = GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1211)) ;
  {
  var_withAccessorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("hasKey"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1212)), var_stringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1212)) ;
  }
  cEnumerator_mapSearchMethodListAST enumerator_51824 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_51824.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_51824.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1214)) ;
    }
    enumerator_51824.gotoNextObject () ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mMapTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1220)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mMapTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1234)), GALGAS_typeKindEnum::constructor_uniqueMapType (SOURCE_FILE_AT_LINE (1235)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1236)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1237)), var_typedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1243)), var_enumerationDescriptor, var_enumerationVariants, function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (1246)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1247)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1248)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1249)), object->mAttribute_mSearchMethodList, GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1251)), var_withAccessorMap, GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1254)), GALGAS_string ("emptyMap"), GALGAS_string ("uniquemap-").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (1256)) COMMA_SOURCE_FILE_AT_LINE (1256)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1231)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_53613_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_53613_1 ; // Joker input parameter
  GALGAS_typedAttributeList joker_53653_2 ; // Joker input parameter
  GALGAS_attributeMap joker_53653_1 ; // Joker input parameter
  GALGAS_constructorMap joker_53708_11 ; // Joker input parameter
  GALGAS_readerMap joker_53708_10 ; // Joker input parameter
  GALGAS_modifierMap joker_53708_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_53708_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_53708_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_53708_6 ; // Joker input parameter
  GALGAS_stringlist joker_53708_5 ; // Joker input parameter
  GALGAS_uint joker_53708_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_53708_3 ; // Joker input parameter
  GALGAS_stringset joker_53708_2 ; // Joker input parameter
  GALGAS_lstringlist joker_53708_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_53763_6 ; // Joker input parameter
  GALGAS_withAccessorMap joker_53763_5 ; // Joker input parameter
  GALGAS_bool joker_53763_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_53763_3 ; // Joker input parameter
  GALGAS_string joker_53763_2 ; // Joker input parameter
  GALGAS_string joker_53763_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_53613_2, joker_53613_1, var_typeKindEnum, joker_53653_2, joker_53653_1, var_mapTypedAttributeList, joker_53708_11, joker_53708_10, joker_53708_9, joker_53708_8, joker_53708_7, joker_53708_6, joker_53708_5, joker_53708_4, joker_53708_3, joker_53708_2, joker_53708_1, var_searchMethodList, joker_53763_6, joker_53763_5, joker_53763_4, joker_53763_3, joker_53763_2, joker_53763_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1269)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_uniqueMapType (SOURCE_FILE_AT_LINE (1279)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mAssociatedMapTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the @").operator_concat (object->mAttribute_mAssociatedMapTypeName.reader_string (SOURCE_FILE_AT_LINE (1280)) COMMA_SOURCE_FILE_AT_LINE (1280)).operator_concat (GALGAS_string (" should be an unique map type") COMMA_SOURCE_FILE_AT_LINE (1280)) COMMA_SOURCE_FILE_AT_LINE (1280)) ;
    var_mapTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1281)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1284)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1285)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1286)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1287)) ;
  GALGAS_classMethodMap var_classMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1288)) ;
  GALGAS_unifiedTypeMapProxy var_associatedMapTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedMapTypeName, var_associatedMapTypeIndex COMMA_SOURCE_FILE_AT_LINE (1291)) ;
  }
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1294)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstring"), var_lstringTypeIndex COMMA_SOURCE_FILE_AT_LINE (1297)) ;
  }
  GALGAS_unifiedTypeMapProxy var_mapProxyTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mMapProxyTypeName, var_mapProxyTypeProxy COMMA_SOURCE_FILE_AT_LINE (1300)) ;
  }
  GALGAS_formalParameterSignature var_argList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1302)) ;
  var_argList.addAssign_operation (var_associatedMapTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (1303)), GALGAS_string ("ioMap") COMMA_SOURCE_FILE_AT_LINE (1303)) ;
  var_argList.addAssign_operation (var_lstringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1304)), GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (1304)) ;
  var_argList.addAssign_operation (var_mapProxyTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1305)), GALGAS_string ("outProxy") COMMA_SOURCE_FILE_AT_LINE (1305)) ;
  {
  var_classMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("makeProxy"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1307)), var_argList, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1306)) ;
  }
  var_argList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1312)) ;
  var_argList.addAssign_operation (var_associatedMapTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentInOut (SOURCE_FILE_AT_LINE (1313)), GALGAS_string ("ioMap") COMMA_SOURCE_FILE_AT_LINE (1313)) ;
  var_argList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1314)), GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (1314)) ;
  var_argList.addAssign_operation (var_mapProxyTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1315)), GALGAS_string ("outProxy") COMMA_SOURCE_FILE_AT_LINE (1315)) ;
  {
  var_classMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("makeProxyFromString"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1317)), var_argList, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1316)) ;
  }
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("null"), object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE_AT_LINE (1322)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1322)) ;
  }
  GALGAS_unifiedTypeMapProxyAndParameterList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1324)) ;
  var_constructorAttributeTypeList.addAssign_operation (var_associatedMapTypeIndex, GALGAS_string ("inMap") COMMA_SOURCE_FILE_AT_LINE (1325)) ;
  var_constructorAttributeTypeList.addAssign_operation (var_lstringTypeIndex, GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (1326)) ;
  cEnumerator_mapSearchMethodListAST enumerator_56371 (var_searchMethodList, kEnumeration_up) ;
  while (enumerator_56371.hasCurrentObject ()) {
    {
    var_constructorMap.modifier_insertKey (enumerator_56371.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1328)) ;
    }
    enumerator_56371.gotoNextObject () ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("isSolved"), GALGAS_string ("bool"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1336)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("isNull"), GALGAS_string ("bool"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1337)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("isRegular"), GALGAS_string ("bool"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1338)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lkey"), GALGAS_string ("lstring"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1339)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("key"), GALGAS_string ("string"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1340)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("identifierRepresentation"), GALGAS_string ("string"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1341)) ;
  }
  GALGAS_readerMap var_inheritedReaderMap = var_readerMap ;
  cEnumerator_typedAttributeList enumerator_57342 (var_mapTypedAttributeList, kEnumeration_up) ;
  while (enumerator_57342.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_57342.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1345)) COMMA_SOURCE_FILE_AT_LINE (1345)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_57476 (var_inheritedReaderMap.reader_keySet (SOURCE_FILE_AT_LINE (1347)), kEnumeration_up) ;
      while (enumerator_57476.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_57476.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (1348)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1348)) COMMA_SOURCE_FILE_AT_LINE (1348)) ;
        if (enumerator_57476.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (1349)) ;
        }
        enumerator_57476.gotoNextObject () ;
      }
      GALGAS_location location_3 (enumerator_57342.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the map has a associated map proxy, which has predefined readers: ").operator_concat (var_s COMMA_SOURCE_FILE_AT_LINE (1351)).operator_concat (GALGAS_string ("; you cannot use theses names for naming an attribute of this map") COMMA_SOURCE_FILE_AT_LINE (1351)) COMMA_SOURCE_FILE_AT_LINE (1351)) ;
    }else if (kBoolFalse == test_2) {
      {
      var_readerMap.modifier_insertKey (enumerator_57342.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1356)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1357)), inCompiler->here (), GALGAS_bool (true), enumerator_57342.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1361)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1354)) ;
      }
    }
    enumerator_57342.gotoNextObject () ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mMapProxyTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1367)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mMapProxyTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1381)), GALGAS_typeKindEnum::constructor_mapProxyType (SOURCE_FILE_AT_LINE (1382)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1383)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1384)), var_mapTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, var_classMethodMap, GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1391)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1392)), function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (1393)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1394)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1395)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1396)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1397)), var_searchMethodList, GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1399)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1401)), GALGAS_string ("null"), GALGAS_string ("mapproxy-").operator_concat (object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE_AT_LINE (1403)) COMMA_SOURCE_FILE_AT_LINE (1403)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1378)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externTypeDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1416)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1417)) ;
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1418)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1419)) ;
  GALGAS_classMethodMap var_classMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1420)) ;
  cEnumerator_externTypeConstructorList enumerator_60033 (object->mAttribute_mExternTypeConstructorList, kEnumeration_up) ;
  while (enumerator_60033.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60033.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1424)) ;
    }
    GALGAS_unifiedTypeMapProxyAndParameterList var_arguments = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1426)) ;
    cEnumerator_typeNameFormalParameterNameList enumerator_60285 (enumerator_60033.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_60285.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60285.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1429)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_60285.current_mFormalParameterName (HERE) COMMA_SOURCE_FILE_AT_LINE (1430)) ;
      enumerator_60285.gotoNextObject () ;
    }
    {
    var_constructorMap.modifier_insertKey (enumerator_60033.current_mConstructorName (HERE), var_arguments, GALGAS_bool (true), var_returnedTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1433)) ;
    }
    enumerator_60033.gotoNextObject () ;
  }
  cEnumerator_externTypeReaderList enumerator_60751 (object->mAttribute_mExternTypeReaderList, kEnumeration_up) ;
  while (enumerator_60751.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60751.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1443)) ;
    }
    GALGAS_unifiedTypeMapProxyAndParameterList var_arguments = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1445)) ;
    cEnumerator_typeNameFormalParameterNameList enumerator_61003 (enumerator_60751.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_61003.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61003.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1448)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_61003.current_mFormalParameterName (HERE) COMMA_SOURCE_FILE_AT_LINE (1449)) ;
      enumerator_61003.gotoNextObject () ;
    }
    {
    var_readerMap.modifier_insertKey (enumerator_60751.current_mReaderName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1454)), var_arguments, inCompiler->here (), GALGAS_bool (true), var_returnedTypeProxy, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1459)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1452)) ;
    }
    enumerator_60751.gotoNextObject () ;
  }
  cEnumerator_externTypeModifierList enumerator_61580 (object->mAttribute_mExternTypeModifierList, kEnumeration_up) ;
  while (enumerator_61580.hasCurrentObject ()) {
    GALGAS_formalParameterSignature var_routineSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1465)) ;
    cEnumerator_formalParameterListAST enumerator_61677 (enumerator_61580.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_61677.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61677.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1467)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_61677.current_mFormalArgumentPassingMode (HERE), enumerator_61677.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1472)) ;
      enumerator_61677.gotoNextObject () ;
    }
    {
    var_modifierMap.modifier_insertKey (enumerator_61580.current_mModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1477)), var_routineSignature, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1480)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1475)) ;
    }
    enumerator_61580.gotoNextObject () ;
  }
  cEnumerator_externTypeMethodList enumerator_62273 (object->mAttribute_mExternTypeMethodList, kEnumeration_up) ;
  while (enumerator_62273.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_62370 (enumerator_62273.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_62370.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_62370.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1489)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_62370.current_mFormalArgumentPassingMode (HERE), enumerator_62370.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1494)) ;
      enumerator_62370.gotoNextObject () ;
    }
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_62273.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1499)), var_routineSignature, enumerator_62273.current_mDeclarationLocation (HERE), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1503)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1497)) ;
    }
    enumerator_62273.gotoNextObject () ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mExternTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1511)), GALGAS_typeKindEnum::constructor_graphType (SOURCE_FILE_AT_LINE (1512)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1513)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1514)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1515)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1520)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1521)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1522)), GALGAS_uint ((uint32_t) 0U), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1524)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1525)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1526)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1527)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1528)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1529)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1531)), GALGAS_string ("default"), GALGAS_string ("externtype-").operator_concat (object->mAttribute_mExternTypeName.reader_string (SOURCE_FILE_AT_LINE (1533)) COMMA_SOURCE_FILE_AT_LINE (1533)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1508)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeProxy COMMA_SOURCE_FILE_AT_LINE (1547)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstring"), var_lstringTypeProxy COMMA_SOURCE_FILE_AT_LINE (1550)) ;
  }
  GALGAS_unifiedTypeMapProxy var_graphTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mGraphTypeName, var_graphTypeProxy COMMA_SOURCE_FILE_AT_LINE (1553)) ;
  }
  GALGAS_unifiedTypeMapProxy var_associatedListTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedListTypeName, var_associatedListTypeProxy COMMA_SOURCE_FILE_AT_LINE (1556)) ;
  }
  GALGAS_unifiedTypeMapProxy var_lstringListTypeProxy ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("lstringlist"), var_lstringListTypeProxy COMMA_SOURCE_FILE_AT_LINE (1559)) ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1561)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1562)) ;
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1563)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1564)) ;
  GALGAS_classMethodMap var_classMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1565)) ;
  GALGAS_formalParameterSignature var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1567)) ;
  var_formalParameterList.addAssign_operation (var_associatedListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1568)), GALGAS_string ("outSortedInformationList") COMMA_SOURCE_FILE_AT_LINE (1568)) ;
  var_formalParameterList.addAssign_operation (var_lstringListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1569)), GALGAS_string ("outSortedLKeyList") COMMA_SOURCE_FILE_AT_LINE (1569)) ;
  var_formalParameterList.addAssign_operation (var_associatedListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1570)), GALGAS_string ("outUnsortedInformationList") COMMA_SOURCE_FILE_AT_LINE (1570)) ;
  var_formalParameterList.addAssign_operation (var_lstringListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1571)), GALGAS_string ("outUnsortedLKeyList") COMMA_SOURCE_FILE_AT_LINE (1571)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("topologicalSort"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1573)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1574)), var_formalParameterList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1578)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1572)) ;
  }
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("depthFirstTopologicalSort"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1582)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1583)), var_formalParameterList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1587)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1581)) ;
  }
  var_formalParameterList.drop () ; // drop instruction
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1592)) ;
  var_formalParameterList.addAssign_operation (var_associatedListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1593)), GALGAS_string ("outInformationList") COMMA_SOURCE_FILE_AT_LINE (1593)) ;
  var_formalParameterList.addAssign_operation (var_lstringListTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1594)), GALGAS_string ("outLKeyList") COMMA_SOURCE_FILE_AT_LINE (1594)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("nodesWithNoSuccessor"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1596)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1597)), var_formalParameterList, inCompiler->here (), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1601)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1595)) ;
  }
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("nodesWithNoPredecessor"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1605)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1606)), var_formalParameterList, inCompiler->here (), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1610)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1604)) ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
  routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("reversedGraph"), object->mAttribute_mGraphTypeName.mAttribute_string, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1615)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("undefinedNodeCount"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1623)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("undefinedNodeKeyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1631)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("undefinedNodeReferenceList"), GALGAS_string ("lstringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1639)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("graphviz"), GALGAS_string ("string"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1647)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1655)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("edges"), GALGAS_string ("2stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1663)) ;
  }
  {
  routine_enterBaseReaderWith_32_Arguments (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("subgraphFromNodes"), GALGAS_string ("lstringlist"), GALGAS_string ("inStartNodeLStringList"), GALGAS_string ("stringset"), GALGAS_string ("inNodesToExclude"), object->mAttribute_mGraphTypeName.mAttribute_string, GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (1671)) ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("emptyGraph"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1684)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1685)), GALGAS_bool (false), var_graphTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1683)) ;
  }
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1690)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1691)), GALGAS_string ("inLKey") COMMA_SOURCE_FILE_AT_LINE (1691)) ;
  cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_69648 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE_AT_LINE (1692)), kEnumeration_up) ;
  while (enumerator_69648.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (enumerator_69648.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1693)), enumerator_69648.current_mFormalParameterName (HERE) COMMA_SOURCE_FILE_AT_LINE (1693)) ;
    enumerator_69648.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_69799 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_69799.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_69799.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1698)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1701)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1696)) ;
    }
    enumerator_69799.gotoNextObject () ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("removeEdgesToDominators"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1708)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1709)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1710)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1712)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1707)) ;
  }
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1716)) ;
  var_formalParameterList.addAssign_operation (var_stringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1717)), GALGAS_string ("inNodeName") COMMA_SOURCE_FILE_AT_LINE (1717)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("removeEdgesToNode"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1719)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1720)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1723)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1718)) ;
  }
  var_formalParameterList.drop () ; // drop instruction
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1728)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1729)), GALGAS_string ("inSourceNodeLKey") COMMA_SOURCE_FILE_AT_LINE (1729)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1730)), GALGAS_string ("inTargetNodeLKey") COMMA_SOURCE_FILE_AT_LINE (1730)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("addEdge"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1732)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1733)), var_formalParameterList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1736)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1731)) ;
  }
  var_formalParameterList.drop () ; // drop instruction
  var_formalParameterList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1741)) ;
  var_formalParameterList.addAssign_operation (var_lstringTypeProxy, GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1742)), GALGAS_string ("inNodeLKey") COMMA_SOURCE_FILE_AT_LINE (1742)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("noteNode"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1744)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1745)), var_formalParameterList, GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1748)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1743)) ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mGraphTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1753)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mGraphTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1767)), GALGAS_typeKindEnum::constructor_graphType (SOURCE_FILE_AT_LINE (1768)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1769)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1770)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1771)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1776)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1777)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1778)), function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (1779)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1780)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1781)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1782)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1783)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1784)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1785)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1787)), GALGAS_string ("emptyGraph"), GALGAS_string ("graph-").operator_concat (object->mAttribute_mGraphTypeName.reader_string (SOURCE_FILE_AT_LINE (1789)) COMMA_SOURCE_FILE_AT_LINE (1789)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1764)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_enumDeclarationAST * object = (const cPtr_enumDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_enumDeclarationAST) ;
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1803)) ;
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1804)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1805)) ;
  GALGAS_classMethodMap var_classMethodMap = GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1806)) ;
  GALGAS_unifiedTypeMapProxy var_currentTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumTypeName, var_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1809)) ;
  }
  GALGAS_stringset var_constantSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1811)) ;
  cEnumerator_lstringlist enumerator_74005 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_74005.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_74005.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1813)) COMMA_SOURCE_FILE_AT_LINE (1813)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_74005.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1814)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1814)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1814)) ;
    }
    enumerator_74005.gotoNextObject () ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1818)) ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mEnumTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1820)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mEnumTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1834)), GALGAS_typeKindEnum::constructor_enumType (SOURCE_FILE_AT_LINE (1835)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1836)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1837)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (1838)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1843)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (1844)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1845)), function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (1846)).operator_or (function_isComparable (inCompiler COMMA_SOURCE_FILE_AT_LINE (1846)) COMMA_SOURCE_FILE_AT_LINE (1846)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1847)), var_constantSet, object->mAttribute_mConstantList, GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1850)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (1851)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1852)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (1854)), object->mAttribute_mConstantList.reader_mValueAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1855)).mAttribute_string, GALGAS_string ("enum-").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1856)) COMMA_SOURCE_FILE_AT_LINE (1856)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1831)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_filewrapperDeclarationAST * object = (const cPtr_filewrapperDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_filewrapperDeclarationAST) ;
  GALGAS_filewrapperTemplateMap var_filewrapperTemplateMap = GALGAS_filewrapperTemplateMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1941)) ;
  cEnumerator_filewrapperTemplateListAST enumerator_78639 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_78639.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxyList var_templateSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1943)) ;
    cEnumerator_formalTemplateInputParameterListAST enumerator_78757 (enumerator_78639.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_78757.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_78757.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1946)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1947)) ;
      enumerator_78757.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_78639.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_78639.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1949)) ;
    }
    enumerator_78639.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_textExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1956)) ;
  cEnumerator_lstringlist enumerator_79276 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_79276.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_79276.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1958)) ;
    }
    enumerator_79276.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_binaryFileExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1961)) ;
  cEnumerator_lstringlist enumerator_79482 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_79482.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_79482.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1963)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_79482.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_79482.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1964)) COMMA_SOURCE_FILE_AT_LINE (1964)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1964)) COMMA_SOURCE_FILE_AT_LINE (1964)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_79482.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1966)) ;
      }
    }
    enumerator_79482.gotoNextObject () ;
  }
  ...
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1973)).reader_firstCharacterOrNul (SOURCE_FILE_AT_LINE (1973)).objectCompare (GALGAS_char (TO_UNICODE (47)))).boolEnum () ;
  if (kBoolTrue == test_2) {
    var_absoluteSourcePath = object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1974)) ;
  }else if (kBoolFalse == test_2) {
    var_absoluteSourcePath = object->mAttribute_mSourceFileAbsolutePath.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (1976)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1976)).operator_concat (object->mAttribute_mFilewrapperPath.reader_string (SOURCE_FILE_AT_LINE (1976)) COMMA_SOURCE_FILE_AT_LINE (1976)) ;
  }
  const enumGalgasBool test_3 = var_absoluteSourcePath.reader_directoryExists (SOURCE_FILE_AT_LINE (1978)).operator_not (SOURCE_FILE_AT_LINE (1978)).boolEnum () ;
  if (kBoolTrue == test_3) {
    GALGAS_location location_4 (object->mAttribute_mFilewrapperPath.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_4, GALGAS_string ("The '").operator_concat (var_absoluteSourcePath COMMA_SOURCE_FILE_AT_LINE (1979)).operator_concat (GALGAS_string ("' directory does not exist") COMMA_SOURCE_FILE_AT_LINE (1979)) COMMA_SOURCE_FILE_AT_LINE (1979)) ;
    ...
    {
    routine_recursivelyEnumerateDirectories (var_absoluteSourcePath, GALGAS_string ("/"), var_textExtensionMap, var_binaryFileExtensionMap, var_regularRootFileMap, var_wrapperDirectoryMap, var_wrapperFileIndex, var_wrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1985)) ;
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFilewrapperMap.modifier_insertKey (object->mAttribute_mFilewrapperName, object->mAttribute_mFilewrapperPath, object->mAttribute_mFilewrapperTextFileExtensionList, var_regularRootFileMap, var_wrapperDirectoryMap, var_filewrapperTemplateMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1997)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listDeclarationAST) ;
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2016)) ;
  cEnumerator_attributeInCollectionListAST enumerator_81432 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_81432.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_81432.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2019)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_81676 (enumerator_81432.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_81676.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_81676.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_81676.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_81676.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_81432.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2029)) ;
    enumerator_81432.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2033)) ;
  }
  GALGAS_unifiedTypeMapProxy var_listTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListTypeName, var_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (2036)) ;
  }
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2038)) ;
  GALGAS_unifiedTypeMapProxyAndParameterList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2039)) ;
  GALGAS_formalParameterSignature var_modifierOutputFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2040)) ;
  GALGAS_formalParameterSignature var_modifierInputFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2041)) ;
  cEnumerator_typedAttributeList enumerator_82620 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_82620.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_82620.current_mAttributeTypeProxy (HERE), enumerator_82620.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2043)) COMMA_SOURCE_FILE_AT_LINE (2043)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_82620.current_mAttributeTypeProxy (HERE), enumerator_82620.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2044)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_82620.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2045)), enumerator_82620.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2045)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_82620.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2046)), enumerator_82620.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2046)) ;
    enumerator_82620.gotoNextObject () ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2049)) ;
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyList"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2050)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2050)) ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("listWithValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2052)), var_constructorAttributeTypeList, GALGAS_bool (false), var_listTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2051)) ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2058)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("length"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2059)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("range"), GALGAS_string ("range"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2060)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("subListFromIndex"), GALGAS_string ("uint"), GALGAS_string ("inIndex"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2061)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2061)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("subListWithRange"), GALGAS_string ("range"), GALGAS_string ("inRange"), object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2062)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2062)) ;
  }
  cEnumerator_typedAttributeList enumerator_84029 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_84029.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_84029.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_84029.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2066)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2066)), enumerator_84029.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2066)) COMMA_SOURCE_FILE_AT_LINE (2066)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2067)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_listWithValue (var_uintType, GALGAS_string ("inIndex") COMMA_SOURCE_FILE_AT_LINE (2068)), inCompiler->here (), GALGAS_bool (true), enumerator_84029.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2072)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2065)) ;
      }
    }
    enumerator_84029.gotoNextObject () ;
  }
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2078)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("first"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2080)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2081)), var_modifierOutputFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2085)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2079)) ;
  }
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("last"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2089)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2090)), var_modifierOutputFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2094)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2088)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2098)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popFirst"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2100)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2101)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2104)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2099)) ;
  }
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popLast"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2108)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2109)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2112)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2107)) ;
  }
  var_modifierOutputFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2115)), GALGAS_string ("inIndex") COMMA_SOURCE_FILE_AT_LINE (2115)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("removeAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2117)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2118)), var_modifierOutputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2121)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2116)) ;
  }
  var_modifierOutputFormalArgumentList.drop () ; // drop instruction
  cEnumerator_typedAttributeList enumerator_85853 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_85853.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_85853.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_formalParameterSignature var_setterFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2127)) ;
      var_setterFormalArgumentList.addAssign_operation (enumerator_85853.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2128)), enumerator_85853.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2128)) ;
      var_setterFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2129)), enumerator_85853.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2129)) ;
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_85853.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2131)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2131)) COMMA_SOURCE_FILE_AT_LINE (2131)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2131)), enumerator_85853.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2131)) COMMA_SOURCE_FILE_AT_LINE (2131)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2132)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2135)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2130)) ;
      }
    }
    enumerator_85853.gotoNextObject () ;
  }
  var_modifierInputFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2141)), GALGAS_string ("inInsertionIndex") COMMA_SOURCE_FILE_AT_LINE (2141)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("insertAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2143)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2144)), var_modifierInputFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2147)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2142)) ;
  }
  var_modifierInputFormalArgumentList.drop () ; // drop instruction
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2152)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2153)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2154)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mListTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2156)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2169)) COMMA_SOURCE_FILE_AT_LINE (2169)), object->mAttribute_mListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2169)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2167)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2176)), GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (2177)), var_typedAttributeList, GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2179)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2180)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2185)), var_enumerationDescriptor, var_enumerationVariants, function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2188)).operator_or (function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2188)) COMMA_SOURCE_FILE_AT_LINE (2188)).operator_or (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2188)) COMMA_SOURCE_FILE_AT_LINE (2188)).operator_or (function_addAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2188)) COMMA_SOURCE_FILE_AT_LINE (2188)).operator_or (function_binaryAddOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2188)) COMMA_SOURCE_FILE_AT_LINE (2188)), var_constructorAttributeTypeList, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2190)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2191)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2192)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2193)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2194)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptyList"), GALGAS_string ("list-").operator_concat (object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (2198)) COMMA_SOURCE_FILE_AT_LINE (2198)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2173)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2212)) ;
  }
  GALGAS_unifiedTypeMapProxy var_listTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mSortedListTypeName, var_listTypeIndex COMMA_SOURCE_FILE_AT_LINE (2215)) ;
  }
  GALGAS_enumerationDescriptorList var_enumerationDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2217)) ;
  GALGAS_unifiedTypeMapProxyAndParameterList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2218)) ;
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2219)) ;
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2220)) ;
  cEnumerator_attributeInCollectionListAST enumerator_89728 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_89728.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_89728.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2223)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_89728.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2226)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_89728.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2227)) ;
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_89728.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2228)) ;
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2229)), enumerator_89728.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2229)) ;
    enumerator_89728.gotoNextObject () ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2232)) ;
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptySortedList"), object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2233)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2233)) ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("sortedListWithValue"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2235)), var_constructorAttributeTypeList, GALGAS_bool (false), var_listTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2234)) ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2241)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("length"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2242)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2244)) ;
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popGreatest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2246)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2247)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2250)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2245)) ;
  }
  {
  var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("popSmallest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2254)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2255)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2258)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2253)) ;
  }
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2262)) ;
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("greatest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2264)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2265)), var_modifierFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2269)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2263)) ;
  }
  {
  var_instanceMethodMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("smallest"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2273)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2274)), var_modifierFormalArgumentList, inCompiler->here (), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2278)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2272)) ;
  }
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2282)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2283)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2284)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mSortedListTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2286)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mSortedListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2300)) COMMA_SOURCE_FILE_AT_LINE (2300)), object->mAttribute_mSortedListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2300)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2298)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mSortedListTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2307)), GALGAS_typeKindEnum::constructor_sortedListType (SOURCE_FILE_AT_LINE (2308)), var_typedAttributeList, GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2310)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2311)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2316)), var_enumerationDescriptor, var_enumerationVariants, function_binaryConcatOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2319)).operator_or (function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2319)) COMMA_SOURCE_FILE_AT_LINE (2319)).operator_or (function_dotAssignOperator (inCompiler COMMA_SOURCE_FILE_AT_LINE (2319)) COMMA_SOURCE_FILE_AT_LINE (2319)), var_constructorAttributeTypeList, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2321)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2322)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2323)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2324)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2325)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptySortedList"), GALGAS_string ("sortedlist-").operator_concat (object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2329)) COMMA_SOURCE_FILE_AT_LINE (2329)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2304)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mStructTypeName, var_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (2343)) ;
  }
  GALGAS_attributeMap var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2345)) ;
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2346)) ;
  GALGAS_unifiedTypeMapProxyAndParameterList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2347)) ;
  GALGAS_typedAttributeList var_typedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2348)) ;
  cEnumerator_attributeInCollectionListAST enumerator_94424 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_94424.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_94424.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2351)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_94424.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2352)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_94424.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2355)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_94424.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2356)) ;
    }
    enumerator_94424.gotoNextObject () ;
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2359)), var_constructorAttributeTypeList, GALGAS_bool (false), var_structTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2358)) ;
  }
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2366)) ;
  }
  cEnumerator_typedAttributeList enumerator_95170 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_95170.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_95170.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2373)), enumerator_95170.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2374)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2370)) ;
    }
    enumerator_95170.gotoNextObject () ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2380)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2382)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mStructTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2384)) ;
  }
  ...
  if (kBoolTrue == test_0) {
    var_enumeratedType = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2397)) ;
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mEnumeratedElementTypeName, var_enumeratedType COMMA_SOURCE_FILE_AT_LINE (2399)) ;
    }
  }
  GALGAS_string var_defaultConstructorName = GALGAS_string ("default") ;
  cEnumerator_typedAttributeList enumerator_96352 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_96352.hasCurrentObject () && bool_1) {
    while (enumerator_96352.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_96352.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2408)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_96352.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2408)).operator_not (SOURCE_FILE_AT_LINE (2408)) COMMA_SOURCE_FILE_AT_LINE (2408)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_96352.gotoNextObject () ;
      if (enumerator_96352.hasCurrentObject ()) {
        bool_1 = GALGAS_bool (kIsNotEqual, var_defaultConstructorName.objectCompare (GALGAS_string::makeEmptyString ())).isValidAndTrue () ;
      }
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mStructTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2416)), GALGAS_typeKindEnum::constructor_structType (SOURCE_FILE_AT_LINE (2417)), var_typedAttributeList, var_attributeMap, var_typedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2425)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2426)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2427)), function_generateDescriptionReaderUtilityMethod (inCompiler COMMA_SOURCE_FILE_AT_LINE (2428)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2429)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2430)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2431)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2432)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2433)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2434)), GALGAS_bool (false), var_enumeratedType, var_defaultConstructorName, GALGAS_string ("struct-").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (2438)) COMMA_SOURCE_FILE_AT_LINE (2438)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2413)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2451)) ;
  }
  GALGAS_readerMap var_readerMap ;
  GALGAS_modifierMap var_modifierMap ;
  GALGAS_instanceMethodMap var_instanceMethodMap ;
  GALGAS_typedAttributeList var_inheritedTypedAttributeList ;
  GALGAS_attributeMap var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2457)) ;
  GALGAS_unifiedTypeMapProxy var_superClassIndex ;
  GALGAS_bool var_generateHeaderInSeparateFile ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2461)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    var_superClassIndex = GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2462)) ;
    {
    routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2463)) ;
    }
    var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2464)) ;
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2465)) ;
    var_inheritedTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2466)) ;
    var_attributeMap = GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2467)) ;
    var_generateHeaderInSeparateFile = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_98797 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_98797.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_98797.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2470)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_98797.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mSuperClassName, var_superClassIndex COMMA_SOURCE_FILE_AT_LINE (2475)) ;
    }
    GALGAS_typeKindEnum var_typeKindEnum ;
    ...
    GALGAS_bool joker_99276_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_99276_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_99361_2 ; // Joker input parameter
    GALGAS_constructorMap joker_99361_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_99451_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_99451_9 ; // Joker input parameter
    GALGAS_stringlist joker_99451_8 ; // Joker input parameter
    GALGAS_uint joker_99451_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_99451_6 ; // Joker input parameter
    GALGAS_stringset joker_99451_5 ; // Joker input parameter
    GALGAS_lstringlist joker_99451_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_99451_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_99451_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_99451_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_99498_3 ; // Joker input parameter
    GALGAS_string joker_99498_2 ; // Joker input parameter
    GALGAS_string joker_99498_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_99276_2, joker_99276_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_99361_2, joker_99361_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_99451_10, joker_99451_9, joker_99451_8, joker_99451_7, joker_99451_6, joker_99451_5, joker_99451_4, joker_99451_3, joker_99451_2, joker_99451_1, var_generateHeaderInSeparateFile, joker_99498_3, joker_99498_2, joker_99498_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2480)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2495)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (object->mAttribute_mSuperClassName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the @").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (2496)) COMMA_SOURCE_FILE_AT_LINE (2496)).operator_concat (GALGAS_string (" should be a class type") COMMA_SOURCE_FILE_AT_LINE (2496)) COMMA_SOURCE_FILE_AT_LINE (2496)) ;
    }
    var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2499)) ;
    cEnumerator_modifierMap enumerator_99785 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_99785.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_99785.current_lkey (HERE), enumerator_99785.current_mKind (HERE), enumerator_99785.current_mParameterList (HERE), enumerator_99785.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2506)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2501)) ;
      }
      enumerator_99785.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2511)) ;
    cEnumerator_readerMap enumerator_100111 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_100111.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_100111.current_lkey (HERE), enumerator_100111.current_mKind (HERE), enumerator_100111.current_mArgumentTypeList (HERE), enumerator_100111.current_mDeclarationLocation (HERE), enumerator_100111.current_mHasCompilerArgument (HERE), enumerator_100111.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2520)), enumerator_100111.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2513)) ;
      }
      enumerator_100111.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2525)) ;
    cEnumerator_instanceMethodMap enumerator_100499 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_100499.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_100499.current_lkey (HERE), enumerator_100499.current_mKind (HERE), enumerator_100499.current_mParameterList (HERE), enumerator_100499.current_mDeclarationLocation (HERE), enumerator_100499.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2533)), enumerator_100499.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2527)) ;
      }
      enumerator_100499.gotoNextObject () ;
    }
  }
  GALGAS_unifiedTypeMapProxyAndParameterList var_constructorAttributeTypeList = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2539)) ;
  cEnumerator_typedAttributeList enumerator_100930 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_100930.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_100930.current_mAttributeTypeProxy (HERE), enumerator_100930.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2541)) ;
    enumerator_100930.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_101057 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_101057.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_101057.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2545)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_101057.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2546)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_101057.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2547)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_101057.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2548)) COMMA_SOURCE_FILE_AT_LINE (2548)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_101057.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_101057.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2549)) COMMA_SOURCE_FILE_AT_LINE (2549)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader") COMMA_SOURCE_FILE_AT_LINE (2549)) COMMA_SOURCE_FILE_AT_LINE (2549)) ;
    }
    enumerator_101057.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_classIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mClassTypeName, var_classIndex COMMA_SOURCE_FILE_AT_LINE (2553)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2559)) ;
  const enumGalgasBool test_6 = object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (2560)).boolEnum () ;
  if (kBoolTrue == test_6) {
    {
    var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2562)), var_constructorAttributeTypeList, GALGAS_bool (false), var_classIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2561)) ;
    }
  }
  GALGAS_typedAttributeList var_currentClassTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2569)) ;
  GALGAS_typedAttributeList var_allTypedAttributeList = var_inheritedTypedAttributeList ;
  cEnumerator_attributeInCollectionListAST enumerator_102157 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_102157.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_102157.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2573)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_102401 (enumerator_102157.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_102401.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_102401.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2577)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_102401.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2579)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_102401.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_102157.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2583)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_102157.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2584)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_102157.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2588)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2589)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2593)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2586)) ;
      }
    }
    enumerator_102157.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_103469 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_103469.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_103469.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_103469.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2608)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2608)) COMMA_SOURCE_FILE_AT_LINE (2608)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2608)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2609)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_103469.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2610)), enumerator_103469.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2610)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2612)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2607)) ;
      }
    }
    enumerator_103469.gotoNextObject () ;
  }
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mClassTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2618)) ;
  }
  GALGAS_string var_defaultConstructorName ;
  const enumGalgasBool test_11 = var_superClassIndex.reader_isNull (SOURCE_FILE_AT_LINE (2630)).boolEnum () ;
  if (kBoolTrue == test_11) {
    var_defaultConstructorName = GALGAS_string ("default") ;
  }else if (kBoolFalse == test_11) {
    var_defaultConstructorName = var_superClassIndex.reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2633)) ;
  }
  cEnumerator_typedAttributeList enumerator_104511 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_104511.hasCurrentObject () && bool_12) {
    while (enumerator_104511.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_104511.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2636)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_104511.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2636)).operator_not (SOURCE_FILE_AT_LINE (2636)) COMMA_SOURCE_FILE_AT_LINE (2636)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_104511.gotoNextObject () ;
      if (enumerator_104511.hasCurrentObject ()) {
        bool_12 = GALGAS_bool (kIsNotEqual, var_defaultConstructorName.objectCompare (GALGAS_string::makeEmptyString ())).isValidAndTrue () ;
      }
    }
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mClassTypeName, object->mAttribute_mIsAbstract.operator_not (SOURCE_FILE_AT_LINE (2643)), var_superClassIndex, GALGAS_typeKindEnum::constructor_classType (SOURCE_FILE_AT_LINE (2645)), var_allTypedAttributeList, var_attributeMap, var_currentClassTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2653)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2654)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2655)), GALGAS_uint ((uint32_t) 0U), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2657)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2658)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2659)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2660)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2661)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2662)), var_generateHeaderInSeparateFile, GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2664)), var_defaultConstructorName, GALGAS_string ("class-").operator_concat (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (2666)) COMMA_SOURCE_FILE_AT_LINE (2666)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2641)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externRoutineDeclarationAST * object = (const cPtr_externRoutineDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_externRoutineDeclarationAST) ;
  GALGAS_formalParameterSignature var_routineSignature = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2679)) ;
  cEnumerator_formalParameterListAST enumerator_106205 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_106205.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_106205.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2682)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_106205.current_mFormalArgumentPassingMode (HERE), enumerator_106205.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2683)) ;
    enumerator_106205.gotoNextObject () ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mRoutineMap.modifier_insertKey (object->mAttribute_mRoutineName, var_routineSignature, inCompiler COMMA_SOURCE_FILE_AT_LINE (2686)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externFunctionDeclarationAST * object = (const cPtr_externFunctionDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_externFunctionDeclarationAST) ;
  GALGAS_unifiedTypeMapProxyList var_functionSignature = GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2698)) ;
  cEnumerator_formalInputParameterListAST enumerator_107213 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_107213.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_107213.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2701)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2702)) ;
    enumerator_107213.gotoNextObject () ;
  }
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName, var_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2706)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, var_functionSignature, var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2708)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_unifiedTypeMapProxy var_resultTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mResultTypeName, var_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (2720)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mFunctionMap.modifier_insertKey (object->mAttribute_mFunctionName, GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2722)), var_resultTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2722)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayDeclarationAST) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2734)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mDimension.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the dimension of an array should be > 0") COMMA_SOURCE_FILE_AT_LINE (2735)) ;
  }
  GALGAS_unifiedTypeMapProxy var_arrayTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mArrayTypeName, var_arrayTypeIndex COMMA_SOURCE_FILE_AT_LINE (2739)) ;
  }
  GALGAS_unifiedTypeMapProxy var_elementTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mElementTypeName, var_elementTypeIndex COMMA_SOURCE_FILE_AT_LINE (2742)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2744)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2745)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2746)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2747)) ;
  GALGAS_unifiedTypeMapProxy var_boolType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("bool"), var_boolType COMMA_SOURCE_FILE_AT_LINE (2750)) ;
  }
  GALGAS_unifiedTypeMapProxy var_uintType ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("uint"), var_uintType COMMA_SOURCE_FILE_AT_LINE (2753)) ;
  }
  GALGAS_unifiedTypeMapProxyAndParameterList var_uintArgs = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2755)) ;
  GALGAS_uint var_idx = GALGAS_uint ((uint32_t) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2757)).isValid ()) {
    uint32_t variant_109970 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2757)).uintValue () ;
    bool loop_109970 = true ;
    while (loop_109970) {
      loop_109970 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2757)))).isValid () ;
      if (loop_109970) {
        loop_109970 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2757)))).boolValue () ;
      }
      if (loop_109970 && (0 == variant_109970)) {
        loop_109970 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2757)) ;
      }
      if (loop_109970) {
        variant_109970 -- ;
        var_uintArgs.addAssign_operation (var_uintType, GALGAS_string ("inSize").operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (2758)) COMMA_SOURCE_FILE_AT_LINE (2758)) COMMA_SOURCE_FILE_AT_LINE (2758)) ;
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (2759)) ;
      }
    }
  }
  {
  var_constructorMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("new"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2763)), var_uintArgs, GALGAS_bool (false), var_arrayTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2762)) ;
  }
  {
  routine_enterBaseReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("axisCount"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2769)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("sizeForAxis"), GALGAS_string ("uint"), GALGAS_string ("inAxisIndex"), GALGAS_string ("uint"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2770)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("rangeForAxis"), GALGAS_string ("uint"), GALGAS_string ("inAxisIndex"), GALGAS_string ("range"), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (2771)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("isValueValidAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2773)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2774)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_boolType, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2779)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2772)) ;
  }
  {
  var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("valueAtIndex"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2783)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2784)), var_uintArgs, inCompiler->here (), GALGAS_bool (true), var_elementTypeIndex, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2789)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2782)) ;
  }
  GALGAS_formalParameterSignature var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2793)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_elementTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2794)), GALGAS_string ("InValue") COMMA_SOURCE_FILE_AT_LINE (2794)) ;
  var_idx = GALGAS_uint ((uint32_t) 0U) ;
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2796)).isValid ()) {
    uint32_t variant_111282 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2796)).uintValue () ;
    bool loop_111282 = true ;
    while (loop_111282) {
      loop_111282 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2796)))).isValid () ;
      if (loop_111282) {
        loop_111282 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2796)))).boolValue () ;
      }
      if (loop_111282 && (0 == variant_111282)) {
        loop_111282 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (2796)) ;
      }
      if (loop_111282) {
        variant_111282 -- ;
        var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2797)), GALGAS_string ("inIndex").operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (2797)) COMMA_SOURCE_FILE_AT_LINE (2797)) COMMA_SOURCE_FILE_AT_LINE (2797)) ;
        var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (2798)) ;
      }
    }
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2801)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2802)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2805)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2800)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("forceValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2809)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2810)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2813)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2808)) ;
  }
  {
  GALGAS_unifiedTypeMapProxy joker_111897_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_111897_2 ; // Joker input parameter
  GALGAS_string joker_111897_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_111897_3, joker_111897_2, joker_111897_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2816)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("invalidateValueAtIndex").reader_nowhere (SOURCE_FILE_AT_LINE (2818)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2819)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2822)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2817)) ;
  }
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSize").reader_nowhere (SOURCE_FILE_AT_LINE (2826)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2827)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2830)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2825)) ;
  }
  var_modifierFormalArgumentList = GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (2833)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2834)), GALGAS_string ("inSize") COMMA_SOURCE_FILE_AT_LINE (2834)) ;
  var_modifierFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2835)), GALGAS_string ("inAxisIndex") COMMA_SOURCE_FILE_AT_LINE (2835)) ;
  {
  var_modifierMap.modifier_insertKey (GALGAS_string ("setSizeForAxis").reader_nowhere (SOURCE_FILE_AT_LINE (2837)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2838)), var_modifierFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2841)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2836)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mArrayTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2848)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE_AT_LINE (2849)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2850)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2851)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2852)), var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2857)), GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2858)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2859)), GALGAS_uint ((uint32_t) 0U), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2861)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2862)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2863)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2864)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2865)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2866)), GALGAS_bool (false), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2868)), GALGAS_string::makeEmptyString (), GALGAS_string ("array-").operator_concat (object->mAttribute_mArrayTypeName.reader_string (SOURCE_FILE_AT_LINE (2870)) COMMA_SOURCE_FILE_AT_LINE (2870)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2845)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_114350_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_114350_1 ; // Joker input parameter
  GALGAS_attributeMap joker_114438_20 ; // Joker input parameter
  GALGAS_typedAttributeList joker_114438_19 ; // Joker input parameter
  GALGAS_constructorMap joker_114438_18 ; // Joker input parameter
  GALGAS_readerMap joker_114438_17 ; // Joker input parameter
  GALGAS_modifierMap joker_114438_16 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_114438_15 ; // Joker input parameter
  GALGAS_classMethodMap joker_114438_14 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_114438_13 ; // Joker input parameter
  GALGAS_stringlist joker_114438_12 ; // Joker input parameter
  GALGAS_uint joker_114438_11 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_114438_10 ; // Joker input parameter
  GALGAS_stringset joker_114438_9 ; // Joker input parameter
  GALGAS_lstringlist joker_114438_8 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_114438_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_114438_6 ; // Joker input parameter
  GALGAS_withAccessorMap joker_114438_5 ; // Joker input parameter
  GALGAS_bool joker_114438_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_114438_3 ; // Joker input parameter
  GALGAS_string joker_114438_2 ; // Joker input parameter
  GALGAS_string joker_114438_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_114350_2, joker_114350_1, var_typeKindEnum, var_listTypedAttributeList, joker_114438_20, joker_114438_19, joker_114438_18, joker_114438_17, joker_114438_16, joker_114438_15, joker_114438_14, joker_114438_13, joker_114438_12, joker_114438_11, joker_114438_10, joker_114438_9, joker_114438_8, joker_114438_7, joker_114438_6, joker_114438_5, joker_114438_4, joker_114438_3, joker_114438_2, joker_114438_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2884)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKindEnum.objectCompare (GALGAS_typeKindEnum::constructor_listType (SOURCE_FILE_AT_LINE (2891)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2892)) COMMA_SOURCE_FILE_AT_LINE (2892)).operator_concat (GALGAS_string ("' type should be a list type") COMMA_SOURCE_FILE_AT_LINE (2892)) COMMA_SOURCE_FILE_AT_LINE (2892)) ;
    var_listTypedAttributeList = GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2893)) ;
  }
  GALGAS_constructorMap var_constructorMap = GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2896)) ;
  GALGAS_readerMap var_readerMap ;
  {
  routine_commonReaderMapForAllTypes (ioArgument_ioSemanticContext.mAttribute_mTypeMap, var_readerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2897)) ;
  }
  GALGAS_modifierMap var_modifierMap = GALGAS_modifierMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2898)) ;
  GALGAS_instanceMethodMap var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2899)) ;
  GALGAS_unifiedTypeMapProxy var_associatedListTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mAssociatedListTypeName, var_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (2902)) ;
  }
  GALGAS_unifiedTypeMapProxy var_currentTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, object->mAttribute_mListmapTypeName, var_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (2905)) ;
  }
  GALGAS_unifiedTypeMapProxy var_stringTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxyFromString (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("string"), var_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2908)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("count"), GALGAS_string ("uint"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2910)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("allKeys"), GALGAS_string ("stringset"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2911)) ;
  }
  {
  routine_enterInheritedReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("keyList"), GALGAS_string ("stringlist"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2912)) ;
  }
  {
  routine_enterBaseReaderWithArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("listForKey"), GALGAS_string ("string"), GALGAS_string ("inKey"), object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (2913)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2913)) ;
  }
  {
  routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_string ("emptyMap"), object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2915)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2915)) ;
  }
  GALGAS_enumerationDescriptorList var_enumeratorDescriptor = GALGAS_enumerationDescriptorList::constructor_emptyList (SOURCE_FILE_AT_LINE (2917)) ;
  var_enumeratorDescriptor.addAssign_operation (var_stringTypeIndex, GALGAS_string ("key") COMMA_SOURCE_FILE_AT_LINE (2918)) ;
  var_enumeratorDescriptor.addAssign_operation (var_associatedListTypeIndex, GALGAS_string ("mList") COMMA_SOURCE_FILE_AT_LINE (2919)) ;
  GALGAS_unifiedTypeMapProxyAndParameterList var_addAssignOperatorDescription = GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2921)) ;
  var_addAssignOperatorDescription.addAssign_operation (var_stringTypeIndex, GALGAS_string ("inKey") COMMA_SOURCE_FILE_AT_LINE (2922)) ;
  cEnumerator_typedAttributeList enumerator_116509 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_116509.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_116509.current_mAttributeTypeProxy (HERE), enumerator_116509.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2924)) ;
    enumerator_116509.gotoNextObject () ;
  }
  GALGAS_stringlist var_enumerationVariants = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2927)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("up") COMMA_SOURCE_FILE_AT_LINE (2928)) ;
  var_enumerationVariants.addAssign_operation (GALGAS_string ("down") COMMA_SOURCE_FILE_AT_LINE (2929)) ;
  {
  routine_addCategories (constinArgument_inCategoryMethodMapForBuildingContext, constinArgument_inCategoryReaderMapForBuildingContext, constinArgument_inCategoryModifierMapForBuildingContext, ioArgument_ioSemanticContext, object->mAttribute_mListmapTypeName, var_readerMap, var_modifierMap, var_instanceMethodMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (2931)) ;
  }
  GALGAS_unifiedTypeMapProxy var_enumeratedTypeIndex ;
  {
  GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, GALGAS_lstring::constructor_new (object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (2945)) COMMA_SOURCE_FILE_AT_LINE (2945)), object->mAttribute_mListmapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (2945)), var_enumeratedTypeIndex COMMA_SOURCE_FILE_AT_LINE (2943)) ;
  }
  {
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.modifier_insertKey (object->mAttribute_mListmapTypeName, GALGAS_bool (true), GALGAS_unifiedTypeMapProxy::constructor_null (SOURCE_FILE_AT_LINE (2952)), GALGAS_typeKindEnum::constructor_listMapType (SOURCE_FILE_AT_LINE (2953)), GALGAS_typedAttributeList::constructor_emptyList (SOURCE_FILE_AT_LINE (2954)), GALGAS_attributeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2955)), var_listTypedAttributeList, var_constructorMap, var_readerMap, var_modifierMap, var_instanceMethodMap, GALGAS_classMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2961)), var_enumeratorDescriptor, var_enumerationVariants, function_doNotGenererateObjectCompare (inCompiler COMMA_SOURCE_FILE_AT_LINE (2964)), var_addAssignOperatorDescription, GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (2966)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (2967)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2968)), GALGAS_mapSearchMethodListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (2969)), GALGAS_withAccessorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2970)), GALGAS_bool (false), var_enumeratedTypeIndex, GALGAS_string ("emptyMap"), GALGAS_string ("listmap-").operator_concat (object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (2974)) COMMA_SOURCE_FILE_AT_LINE (2974)), inCompiler COMMA_SOURCE_FILE_AT_LINE (2949)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_predefinedTypeAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_predefinedTypeAST * object = (const cPtr_predefinedTypeAST *) inObject ;
  macroValidSharedObject (object, cPtr_predefinedTypeAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mPredefinedTypeName COMMA_SOURCE_FILE_AT_LINE (3007)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (3007)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_predefinedTypeAST temp_0 = object ;
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_classDeclarationAST * object = (const cPtr_classDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_classDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mClassTypeName.reader_string (SOURCE_FILE_AT_LINE (3020)) COMMA_SOURCE_FILE_AT_LINE (3020)), object->mAttribute_mClassTypeName.reader_location (SOURCE_FILE_AT_LINE (3020)) COMMA_SOURCE_FILE_AT_LINE (3020)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (3023)) COMMA_SOURCE_FILE_AT_LINE (3023)), object->mAttribute_mSuperClassName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3023)) COMMA_SOURCE_FILE_AT_LINE (3023)) ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_120805 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_120805.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_120805.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3026)) COMMA_SOURCE_FILE_AT_LINE (3026)), object->mAttribute_mSuperClassName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3026)) COMMA_SOURCE_FILE_AT_LINE (3026)) ;
    }
    enumerator_120805.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListTypeName.reader_string (SOURCE_FILE_AT_LINE (3039)) COMMA_SOURCE_FILE_AT_LINE (3039)), object->mAttribute_mListTypeName.reader_location (SOURCE_FILE_AT_LINE (3039)) COMMA_SOURCE_FILE_AT_LINE (3039)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_listDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3040)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_121663 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121663.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121663.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3042)) COMMA_SOURCE_FILE_AT_LINE (3042)), enumerator_121663.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3042)) COMMA_SOURCE_FILE_AT_LINE (3042)) COMMA_SOURCE_FILE_AT_LINE (3042)) ;
    }
    enumerator_121663.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_structDeclarationAST * object = (const cPtr_structDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_structDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (3055)) COMMA_SOURCE_FILE_AT_LINE (3055)), object->mAttribute_mStructTypeName.reader_location (SOURCE_FILE_AT_LINE (3055)) COMMA_SOURCE_FILE_AT_LINE (3055)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_structDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3056)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_122527 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_122527.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_122527.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3058)) COMMA_SOURCE_FILE_AT_LINE (3058)), enumerator_122527.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3058)) COMMA_SOURCE_FILE_AT_LINE (3058)) COMMA_SOURCE_FILE_AT_LINE (3058)) ;
    }
    enumerator_122527.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_enumDeclarationAST * object = (const cPtr_enumDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_enumDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (3071)) COMMA_SOURCE_FILE_AT_LINE (3071)), object->mAttribute_mEnumTypeName.reader_location (SOURCE_FILE_AT_LINE (3071)) COMMA_SOURCE_FILE_AT_LINE (3071)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_enumDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3072)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_sortedListDeclarationAST * object = (const cPtr_sortedListDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_sortedListDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mSortedListTypeName.reader_string (SOURCE_FILE_AT_LINE (3084)) COMMA_SOURCE_FILE_AT_LINE (3084)), object->mAttribute_mSortedListTypeName.reader_location (SOURCE_FILE_AT_LINE (3084)) COMMA_SOURCE_FILE_AT_LINE (3084)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_sortedListDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3085)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_124099 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_124099.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_124099.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3087)) COMMA_SOURCE_FILE_AT_LINE (3087)), enumerator_124099.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3087)) COMMA_SOURCE_FILE_AT_LINE (3087)) COMMA_SOURCE_FILE_AT_LINE (3087)) ;
    }
    enumerator_124099.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_arrayDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_arrayDeclarationAST * object = (const cPtr_arrayDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mArrayTypeName.reader_string (SOURCE_FILE_AT_LINE (3100)) COMMA_SOURCE_FILE_AT_LINE (3100)), object->mAttribute_mArrayTypeName.reader_location (SOURCE_FILE_AT_LINE (3100)) COMMA_SOURCE_FILE_AT_LINE (3100)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  ...
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mElementTypeName.reader_string (SOURCE_FILE_AT_LINE (3102)) COMMA_SOURCE_FILE_AT_LINE (3102)), object->mAttribute_mElementTypeName.reader_location (SOURCE_FILE_AT_LINE (3102)) COMMA_SOURCE_FILE_AT_LINE (3102)) COMMA_SOURCE_FILE_AT_LINE (3102)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listmapDeclarationAST * object = (const cPtr_listmapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listmapDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mListmapTypeName.reader_string (SOURCE_FILE_AT_LINE (3114)) COMMA_SOURCE_FILE_AT_LINE (3114)), object->mAttribute_mListmapTypeName.reader_location (SOURCE_FILE_AT_LINE (3114)) COMMA_SOURCE_FILE_AT_LINE (3114)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_listmapDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3115)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (3116)) COMMA_SOURCE_FILE_AT_LINE (3116)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (3116)) COMMA_SOURCE_FILE_AT_LINE (3116)) COMMA_SOURCE_FILE_AT_LINE (3116)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapDeclarationAST * object = (const cPtr_mapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_mapDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (3128)) COMMA_SOURCE_FILE_AT_LINE (3128)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (3128)) COMMA_SOURCE_FILE_AT_LINE (3128)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_mapDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3129)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_126604 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126604.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126604.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3131)) COMMA_SOURCE_FILE_AT_LINE (3131)), enumerator_126604.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3131)) COMMA_SOURCE_FILE_AT_LINE (3131)) COMMA_SOURCE_FILE_AT_LINE (3131)) ;
    }
    enumerator_126604.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_uniqueMapDeclarationAST * object = (const cPtr_uniqueMapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_uniqueMapDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapTypeName.reader_string (SOURCE_FILE_AT_LINE (3144)) COMMA_SOURCE_FILE_AT_LINE (3144)), object->mAttribute_mMapTypeName.reader_location (SOURCE_FILE_AT_LINE (3144)) COMMA_SOURCE_FILE_AT_LINE (3144)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_uniqueMapDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3145)) ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_127465 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_127465.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_127465.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3147)) COMMA_SOURCE_FILE_AT_LINE (3147)), enumerator_127465.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3147)) COMMA_SOURCE_FILE_AT_LINE (3147)) COMMA_SOURCE_FILE_AT_LINE (3147)) ;
    }
    enumerator_127465.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapProxyDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapProxyDeclarationAST * object = (const cPtr_mapProxyDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_mapProxyDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mMapProxyTypeName.reader_string (SOURCE_FILE_AT_LINE (3160)) COMMA_SOURCE_FILE_AT_LINE (3160)), object->mAttribute_mMapProxyTypeName.reader_location (SOURCE_FILE_AT_LINE (3160)) COMMA_SOURCE_FILE_AT_LINE (3160)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_mapProxyDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3161)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedMapTypeName.reader_string (SOURCE_FILE_AT_LINE (3162)) COMMA_SOURCE_FILE_AT_LINE (3162)), object->mAttribute_mAssociatedMapTypeName.reader_location (SOURCE_FILE_AT_LINE (3162)) COMMA_SOURCE_FILE_AT_LINE (3162)) COMMA_SOURCE_FILE_AT_LINE (3162)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_graphDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_graphDeclarationAST * object = (const cPtr_graphDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_graphDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mGraphTypeName.reader_string (SOURCE_FILE_AT_LINE (3174)) COMMA_SOURCE_FILE_AT_LINE (3174)), object->mAttribute_mGraphTypeName.reader_location (SOURCE_FILE_AT_LINE (3174)) COMMA_SOURCE_FILE_AT_LINE (3174)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_graphDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3175)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mAssociatedListTypeName.reader_string (SOURCE_FILE_AT_LINE (3176)) COMMA_SOURCE_FILE_AT_LINE (3176)), object->mAttribute_mAssociatedListTypeName.reader_location (SOURCE_FILE_AT_LINE (3176)) COMMA_SOURCE_FILE_AT_LINE (3176)) COMMA_SOURCE_FILE_AT_LINE (3176)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externTypeDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_externTypeDeclarationAST * object = (const cPtr_externTypeDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_externTypeDeclarationAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mExternTypeName.reader_string (SOURCE_FILE_AT_LINE (3188)) COMMA_SOURCE_FILE_AT_LINE (3188)), object->mAttribute_mExternTypeName.reader_location (SOURCE_FILE_AT_LINE (3188)) COMMA_SOURCE_FILE_AT_LINE (3188)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_externTypeDeclarationAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3189)) ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3201)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_onceFunctionDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3213)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_externRoutineDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3225)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_filewrapperDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3237)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3249)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3261)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3273)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3285)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingAbstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3297)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryReaderAST * object = (const cPtr_categoryReaderAST *) inObject ;
  macroValidSharedObject (object, cPtr_categoryReaderAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3309)) COMMA_SOURCE_FILE_AT_LINE (3309)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3309)).operator_concat (object->mAttribute_mCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (3309)) COMMA_SOURCE_FILE_AT_LINE (3309)), object->mAttribute_mCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (3309)) COMMA_SOURCE_FILE_AT_LINE (3309)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryReaderAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3310)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3311)) COMMA_SOURCE_FILE_AT_LINE (3311)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3311)) COMMA_SOURCE_FILE_AT_LINE (3311)) COMMA_SOURCE_FILE_AT_LINE (3311)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3313)) COMMA_SOURCE_FILE_AT_LINE (3313)).operator_not (SOURCE_FILE_AT_LINE (3313)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3316)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3314)) ;
    }
  }
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_136562 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3319)) ;
  if (NULL != objectArray_136562) {
      macroValidSharedObject (objectArray_136562, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_136562->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3320)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryMethodAST * object = (const cPtr_categoryMethodAST *) inObject ;
  macroValidSharedObject (object, cPtr_categoryMethodAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3337)) COMMA_SOURCE_FILE_AT_LINE (3337)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3337)).operator_concat (object->mAttribute_mCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (3337)) COMMA_SOURCE_FILE_AT_LINE (3337)), object->mAttribute_mCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (3337)) COMMA_SOURCE_FILE_AT_LINE (3337)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryMethodAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3338)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3339)) COMMA_SOURCE_FILE_AT_LINE (3339)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3339)) COMMA_SOURCE_FILE_AT_LINE (3339)) COMMA_SOURCE_FILE_AT_LINE (3339)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3341)) COMMA_SOURCE_FILE_AT_LINE (3341)).operator_not (SOURCE_FILE_AT_LINE (3341)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3344)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3342)) ;
    }
  }
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_137867 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3347)) ;
  if (NULL != objectArray_137867) {
      macroValidSharedObject (objectArray_137867, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_137867->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3348)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_categoryModifierAST * object = (const cPtr_categoryModifierAST *) inObject ;
  macroValidSharedObject (object, cPtr_categoryModifierAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3364)) COMMA_SOURCE_FILE_AT_LINE (3364)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3364)).operator_concat (object->mAttribute_mCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (3364)) COMMA_SOURCE_FILE_AT_LINE (3364)), object->mAttribute_mCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (3364)) COMMA_SOURCE_FILE_AT_LINE (3364)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_categoryModifierAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3365)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3366)) COMMA_SOURCE_FILE_AT_LINE (3366)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3366)) COMMA_SOURCE_FILE_AT_LINE (3366)) COMMA_SOURCE_FILE_AT_LINE (3366)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3368)) COMMA_SOURCE_FILE_AT_LINE (3368)).operator_not (SOURCE_FILE_AT_LINE (3368)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3371)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3369)) ;
    }
  }
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_139142 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3374)) ;
  if (NULL != objectArray_139142) {
      macroValidSharedObject (objectArray_139142, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_139142->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3375)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_overridingCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  ioArgument_ioCategoryOverrideDefinitionList.addAssign_operation (temp_0 COMMA_SOURCE_FILE_AT_LINE (3391)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryReaderAST * object = (const cPtr_abstractCategoryReaderAST *) inObject ;
  macroValidSharedObject (object, cPtr_abstractCategoryReaderAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category reader @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3403)) COMMA_SOURCE_FILE_AT_LINE (3403)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3403)).operator_concat (object->mAttribute_mAbstractCategoryReaderName.reader_string (SOURCE_FILE_AT_LINE (3403)) COMMA_SOURCE_FILE_AT_LINE (3403)), object->mAttribute_mAbstractCategoryReaderName.reader_location (SOURCE_FILE_AT_LINE (3403)) COMMA_SOURCE_FILE_AT_LINE (3403)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_abstractCategoryReaderAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3404)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3405)) COMMA_SOURCE_FILE_AT_LINE (3405)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3405)) COMMA_SOURCE_FILE_AT_LINE (3405)) COMMA_SOURCE_FILE_AT_LINE (3405)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryReaderMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3407)) COMMA_SOURCE_FILE_AT_LINE (3407)).operator_not (SOURCE_FILE_AT_LINE (3407)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryReaderMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryReaderMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3410)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3408)) ;
    }
  }
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_141046 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3413)) ;
  if (NULL != objectArray_141046) {
      macroValidSharedObject (objectArray_141046, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_141046->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3414)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryMethodAST * object = (const cPtr_abstractCategoryMethodAST *) inObject ;
  macroValidSharedObject (object, cPtr_abstractCategoryMethodAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category method @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3431)) COMMA_SOURCE_FILE_AT_LINE (3431)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3431)).operator_concat (object->mAttribute_mAbstractCategoryMethodName.reader_string (SOURCE_FILE_AT_LINE (3431)) COMMA_SOURCE_FILE_AT_LINE (3431)), object->mAttribute_mAbstractCategoryMethodName.reader_location (SOURCE_FILE_AT_LINE (3431)) COMMA_SOURCE_FILE_AT_LINE (3431)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_abstractCategoryMethodAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3432)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3433)) COMMA_SOURCE_FILE_AT_LINE (3433)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3433)) COMMA_SOURCE_FILE_AT_LINE (3433)) COMMA_SOURCE_FILE_AT_LINE (3433)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryMethodMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3435)) COMMA_SOURCE_FILE_AT_LINE (3435)).operator_not (SOURCE_FILE_AT_LINE (3435)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryMethodMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryMethodMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3438)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3436)) ;
    }
  }
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_142399 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3441)) ;
  if (NULL != objectArray_142399) {
      macroValidSharedObject (objectArray_142399, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_142399->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3442)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_abstractCategoryModifierAST * object = (const cPtr_abstractCategoryModifierAST *) inObject ;
  macroValidSharedObject (object, cPtr_abstractCategoryModifierAST) ;
  GALGAS_lstring var_key = GALGAS_lstring::constructor_new (GALGAS_string ("category modifier @").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3458)) COMMA_SOURCE_FILE_AT_LINE (3458)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (3458)).operator_concat (object->mAttribute_mAbstractCategoryModifierName.reader_string (SOURCE_FILE_AT_LINE (3458)) COMMA_SOURCE_FILE_AT_LINE (3458)), object->mAttribute_mAbstractCategoryModifierName.reader_location (SOURCE_FILE_AT_LINE (3458)) COMMA_SOURCE_FILE_AT_LINE (3458)) ;
  {
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_abstractCategoryModifierAST temp_0 = object ;
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addNode (var_key, temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (3459)) ;
  }
  {
  ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3460)) COMMA_SOURCE_FILE_AT_LINE (3460)), object->mAttribute_mTypeName.reader_location (SOURCE_FILE_AT_LINE (3460)) COMMA_SOURCE_FILE_AT_LINE (3460)) COMMA_SOURCE_FILE_AT_LINE (3460)) ;
  }
  const enumGalgasBool test_1 = ioArgument_ioCategoryModifierMapForBuildingContext.reader_hasKey (object->mAttribute_mTypeName.reader_string (SOURCE_FILE_AT_LINE (3462)) COMMA_SOURCE_FILE_AT_LINE (3462)).operator_not (SOURCE_FILE_AT_LINE (3462)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    ioArgument_ioCategoryModifierMapForBuildingContext.modifier_insertKey (object->mAttribute_mTypeName, GALGAS_categoryModifierMapForType::constructor_emptyMap (SOURCE_FILE_AT_LINE (3465)), inCompiler COMMA_SOURCE_FILE_AT_LINE (3463)) ;
    }
  }
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_143714 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3468)) ;
  if (NULL != objectArray_143714) {
      macroValidSharedObject (objectArray_143714, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_143714->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3469)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_mapDeclarationAST * object = (const cPtr_mapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_mapDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3488)) ;
  var_structAttributeList.addAssign_operation (GALGAS_string ("lstring").reader_nowhere (SOURCE_FILE_AT_LINE (3490)), GALGAS_string ("lkey").reader_nowhere (SOURCE_FILE_AT_LINE (3491)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3492)) COMMA_SOURCE_FILE_AT_LINE (3489)) ;
  cEnumerator_attributeInCollectionListAST enumerator_144553 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_144553.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_144553.current_mAttributeTypeName (HERE), enumerator_144553.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3498)) COMMA_SOURCE_FILE_AT_LINE (3495)) ;
    enumerator_144553.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mMapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3503)) COMMA_SOURCE_FILE_AT_LINE (3503)), object->mAttribute_mMapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3503)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3501)) COMMA_SOURCE_FILE_AT_LINE (3501)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listDeclarationAST * object = (const cPtr_listDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3514)) ;
  cEnumerator_attributeInCollectionListAST enumerator_145196 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145196.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145196.current_mAttributeTypeName (HERE), enumerator_145196.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3519)) COMMA_SOURCE_FILE_AT_LINE (3516)) ;
    enumerator_145196.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3524)) COMMA_SOURCE_FILE_AT_LINE (3524)), object->mAttribute_mListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3524)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3522)) COMMA_SOURCE_FILE_AT_LINE (3522)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_sortedListDeclarationAST * object = (const cPtr_sortedListDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_sortedListDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3535)) ;
  cEnumerator_attributeInCollectionListAST enumerator_145847 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145847.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145847.current_mAttributeTypeName (HERE), enumerator_145847.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3540)) COMMA_SOURCE_FILE_AT_LINE (3537)) ;
    enumerator_145847.gotoNextObject () ;
  }
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mSortedListTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3545)) COMMA_SOURCE_FILE_AT_LINE (3545)), object->mAttribute_mSortedListTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3545)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3543)) COMMA_SOURCE_FILE_AT_LINE (3543)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listmapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  const cPtr_listmapDeclarationAST * object = (const cPtr_listmapDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_listmapDeclarationAST) ;
  GALGAS_attributeInCollectionListAST var_structAttributeList = GALGAS_attributeInCollectionListAST::constructor_emptyList (SOURCE_FILE_AT_LINE (3556)) ;
  var_structAttributeList.addAssign_operation (GALGAS_string ("string").reader_nowhere (SOURCE_FILE_AT_LINE (3558)), GALGAS_string ("key").reader_nowhere (SOURCE_FILE_AT_LINE (3559)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3560)) COMMA_SOURCE_FILE_AT_LINE (3557)) ;
  var_structAttributeList.addAssign_operation (object->mAttribute_mAssociatedListTypeName, GALGAS_string ("mList").reader_nowhere (SOURCE_FILE_AT_LINE (3564)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3565)) COMMA_SOURCE_FILE_AT_LINE (3562)) ;
  ioArgument_ioSemanticDeclarationList.addAssign_operation (GALGAS_structDeclarationAST::constructor_new (object->mAttribute_mIsPredefined, GALGAS_lstring::constructor_new (object->mAttribute_mListmapTypeName.mAttribute_string.operator_concat (function_elementTypeNameSuffix (inCompiler COMMA_SOURCE_FILE_AT_LINE (3570)) COMMA_SOURCE_FILE_AT_LINE (3570)), object->mAttribute_mListmapTypeName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (3570)), var_structAttributeList, GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (3568)) COMMA_SOURCE_FILE_AT_LINE (3568)) ;
}
//-----------------------------------------------------------------------------*
