...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_76016 (var_files, kEnumeration_up) ;
  while (enumerator_76016.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_76016.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1871)) COMMA_SOURCE_FILE_AT_LINE (1871)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1872)).operator_concat (enumerator_76016.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1872)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76016.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1874)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1873)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1880)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_76016.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1881)) COMMA_SOURCE_FILE_AT_LINE (1881)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1882)).operator_concat (enumerator_76016.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1882)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76016.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1884)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1883)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1890)) ;
      }
    }
    enumerator_76016.gotoNextObject () ;
  }
  ...
  cEnumerator_stringlist enumerator_76981 (var_directories, kEnumeration_up) ;
  while (enumerator_76981.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1901)).operator_concat (enumerator_76981.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1901)), constinArgument_inPathInWrapper.operator_concat (enumerator_76981.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1902)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1902)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1900)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_76981.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1911)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1910)) ;
    }
    enumerator_76981.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147064 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147064.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_147064.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3573)) ;
    enumerator_147064.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_147797 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_147797.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_147797.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3585)) ;
    enumerator_147797.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_148217 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3594)), kEnumeration_up) ;
    while (enumerator_148217.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_148217.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_148217.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3595)) COMMA_SOURCE_FILE_AT_LINE (3595)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3595)) COMMA_SOURCE_FILE_AT_LINE (3595)) ;
      enumerator_148217.gotoNextObject () ;
    }
    ...
    GALGAS_lstringlist joker_148555_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_148555_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3599)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_149138 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149138.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_149138.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3613)) COMMA_SOURCE_FILE_AT_LINE (3613)) COMMA_SOURCE_FILE_AT_LINE (3613)) ;
        enumerator_149138.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_149946 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_149946.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_149946.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3633)) ;
        enumerator_149946.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_38965 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_38965.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_38965.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (926)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (926)) COMMA_SOURCE_FILE_AT_LINE (926)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (926)), enumerator_38965.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (926)) COMMA_SOURCE_FILE_AT_LINE (926)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_38965.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (928)) ;
    }
    ...
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (930)), enumerator_38965.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (930)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (931)), enumerator_38965.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (931)) ;
    {
    ...
    enumerator_38965.gotoNextObject () ;
  }
  ...
  cEnumerator_mapSearchMethodListAST enumerator_40015 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_40015.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_40015.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (945)) ;
    }
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_44835 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_44835.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_44835.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1048)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_44835.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1051)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_44835.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1052)) COMMA_SOURCE_FILE_AT_LINE (1052)) ;
    var_insertMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1053)), enumerator_44835.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1053)) ;
    var_removeMethodFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1054)), enumerator_44835.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1054)) ;
    enumerator_44835.gotoNextObject () ;
  }
  cEnumerator_insertMethodListAST enumerator_45569 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  while (enumerator_45569.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_45569.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1058)) COMMA_SOURCE_FILE_AT_LINE (1058)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_45569.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_45569.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (1059)) COMMA_SOURCE_FILE_AT_LINE (1059)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (1059)) COMMA_SOURCE_FILE_AT_LINE (1059)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_modifierMap.modifier_insertOrReplace (enumerator_45569.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1063)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1066)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1061)) ;
      }
    }
    enumerator_45569.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_47314 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_47314.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_47314.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1101)), var_removeMethodFormalArgumentList, enumerator_47314.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (1103)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1105)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1099)) ;
      }
      enumerator_47314.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_2) {
    cEnumerator_mapSearchMethodListAST enumerator_47644 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    while (enumerator_47644.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_47644.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1113)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1116)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1111)) ;
      }
      enumerator_47644.gotoNextObject () ;
    }
  }
  ...
  if (kBoolTrue == test_3) {
    ...
    cEnumerator_mapOverrideBlockListAST enumerator_49454 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    while (enumerator_49454.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_49454.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1160)) COMMA_SOURCE_FILE_AT_LINE (1160)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1160)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1161)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1162)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1164)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1159)) ;
      }
      enumerator_49454.gotoNextObject () ;
    }
  }
  cEnumerator_attributeInCollectionListAST enumerator_49863 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_49863.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_49863.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1171)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1171)), enumerator_49863.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1171)) COMMA_SOURCE_FILE_AT_LINE (1171)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_49863.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1173)) ;
    }
    {
  ...
  cEnumerator_attributeInCollectionListAST enumerator_50517 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_50517.hasCurrentObject ()) {
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_50517.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1187)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1187)), enumerator_50517.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)) ;
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_50517.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1189)) ;
    }
    ...
    var_accessorFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1191)), enumerator_50517.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1191)) ;
    var_accessorFormalArgumentList.addAssign_operation (var_stringTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1192)), enumerator_50517.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1192)) ;
    {
  ...
  cEnumerator_mapSearchMethodListAST enumerator_51567 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  while (enumerator_51567.hasCurrentObject ()) {
    {
    var_withAccessorMap.modifier_insertKey (enumerator_51567.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1206)) ;
    }
    enumerator_51567.gotoNextObject () ;
  }
  {
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_53323_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_53323_1 ; // Joker input parameter
  GALGAS_typedAttributeList joker_53363_2 ; // Joker input parameter
  GALGAS_attributeMap joker_53363_1 ; // Joker input parameter
  GALGAS_constructorMap joker_53418_11 ; // Joker input parameter
  GALGAS_readerMap joker_53418_10 ; // Joker input parameter
  GALGAS_modifierMap joker_53418_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_53418_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_53418_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_53418_6 ; // Joker input parameter
  GALGAS_stringlist joker_53418_5 ; // Joker input parameter
  GALGAS_uint joker_53418_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_53418_3 ; // Joker input parameter
  GALGAS_stringset joker_53418_2 ; // Joker input parameter
  GALGAS_lstringlist joker_53418_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_53473_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_53473_4 ; // Joker input parameter
  GALGAS_bool joker_53473_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_53473_2 ; // Joker input parameter
  GALGAS_string joker_53473_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_53323_2, joker_53323_1, var_typeKindEnum, joker_53363_2, joker_53363_1, var_mapTypedAttributeList, joker_53418_11, joker_53418_10, joker_53418_9, joker_53418_8, joker_53418_7, joker_53418_6, joker_53418_5, joker_53418_4, joker_53418_3, joker_53418_2, joker_53418_1, var_searchMethodList, joker_53473_5, joker_53473_4, joker_53473_3, joker_53473_2, joker_53473_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1260)) ;
  ...
  cEnumerator_mapSearchMethodListAST enumerator_56081 (var_searchMethodList, kEnumeration_up) ;
  while (enumerator_56081.hasCurrentObject ()) {
    {
    var_constructorMap.modifier_insertKey (enumerator_56081.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1319)) ;
    }
    enumerator_56081.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_57052 (var_mapTypedAttributeList, kEnumeration_up) ;
  while (enumerator_57052.hasCurrentObject ()) {
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_57052.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1336)) COMMA_SOURCE_FILE_AT_LINE (1336)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      cEnumerator_stringset enumerator_57186 (var_inheritedReaderMap.reader_keySet (SOURCE_FILE_AT_LINE (1338)), kEnumeration_up) ;
      while (enumerator_57186.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_57186.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (1339)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1339)) COMMA_SOURCE_FILE_AT_LINE (1339)) ;
        if (enumerator_57186.hasNextObject ()) {
          var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (1340)) ;
        }
        enumerator_57186.gotoNextObject () ;
      }
      GALGAS_location location_3 (enumerator_57052.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      {
      var_readerMap.modifier_insertKey (enumerator_57052.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1347)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (1348)), inCompiler->here (), GALGAS_bool (true), enumerator_57052.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1352)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1345)) ;
      }
    }
...
static void categoryMethod_externTypeDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_externTypeConstructorList enumerator_59706 (object->mAttribute_mExternTypeConstructorList, kEnumeration_up) ;
  while (enumerator_59706.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59706.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1414)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_59958 (enumerator_59706.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_59958.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59958.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1419)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_59958.current_mFormalParameterName (HERE) COMMA_SOURCE_FILE_AT_LINE (1420)) ;
      enumerator_59958.gotoNextObject () ;
    }
    {
    var_constructorMap.modifier_insertKey (enumerator_59706.current_mConstructorName (HERE), var_arguments, GALGAS_bool (true), var_returnedTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1423)) ;
    }
    enumerator_59706.gotoNextObject () ;
  }
  cEnumerator_externTypeReaderList enumerator_60424 (object->mAttribute_mExternTypeReaderList, kEnumeration_up) ;
  while (enumerator_60424.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_returnedTypeProxy ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60424.current_mResultTypeName (HERE), var_returnedTypeProxy COMMA_SOURCE_FILE_AT_LINE (1433)) ;
    }
    ...
    cEnumerator_typeNameFormalParameterNameList enumerator_60676 (enumerator_60424.current_mParameterList (HERE), kEnumeration_up) ;
    while (enumerator_60676.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_argumentTypeProxy ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_60676.current_mFormalParameterTypeName (HERE), var_argumentTypeProxy COMMA_SOURCE_FILE_AT_LINE (1438)) ;
      }
      var_arguments.addAssign_operation (var_argumentTypeProxy, enumerator_60676.current_mFormalParameterName (HERE) COMMA_SOURCE_FILE_AT_LINE (1439)) ;
      enumerator_60676.gotoNextObject () ;
    }
    {
    var_readerMap.modifier_insertKey (enumerator_60424.current_mReaderName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1444)), var_arguments, inCompiler->here (), GALGAS_bool (true), var_returnedTypeProxy, GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1449)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1442)) ;
    }
    enumerator_60424.gotoNextObject () ;
  }
  cEnumerator_externTypeModifierList enumerator_61253 (object->mAttribute_mExternTypeModifierList, kEnumeration_up) ;
  while (enumerator_61253.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_61350 (enumerator_61253.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_61350.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_61350.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1457)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_61350.current_mFormalArgumentPassingMode (HERE), enumerator_61350.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1462)) ;
      enumerator_61350.gotoNextObject () ;
    }
    {
    var_modifierMap.modifier_insertKey (enumerator_61253.current_mModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1467)), var_routineSignature, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1470)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1465)) ;
    }
    enumerator_61253.gotoNextObject () ;
  }
  cEnumerator_externTypeMethodList enumerator_61946 (object->mAttribute_mExternTypeMethodList, kEnumeration_up) ;
  while (enumerator_61946.hasCurrentObject ()) {
    ...
    cEnumerator_formalParameterListAST enumerator_62043 (enumerator_61946.current_mFormalParameterList (HERE), kEnumeration_up) ;
    while (enumerator_62043.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_62043.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1479)) ;
      }
      var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_62043.current_mFormalArgumentPassingMode (HERE), enumerator_62043.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1484)) ;
      enumerator_62043.gotoNextObject () ;
    }
    {
    var_instanceMethodMap.modifier_insertKey (enumerator_61946.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1489)), var_routineSignature, enumerator_61946.current_mDeclarationLocation (HERE), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (1493)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1487)) ;
    }
    enumerator_61946.gotoNextObject () ;
  }
  {
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_unifiedTypeMapProxyAndParameterList enumerator_69284 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE_AT_LINE (1681)), kEnumeration_up) ;
  while (enumerator_69284.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (enumerator_69284.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1682)), enumerator_69284.current_mFormalParameterName (HERE) COMMA_SOURCE_FILE_AT_LINE (1682)) ;
    enumerator_69284.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_69435 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_69435.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_69435.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1687)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1690)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1685)) ;
    }
    enumerator_69435.gotoNextObject () ;
  }
  var_formalParameterList.drop () ; // drop instruction
  {
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_73610 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_73610.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_73610.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1801)) COMMA_SOURCE_FILE_AT_LINE (1801)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_73610.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1802)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1802)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1802)) ;
    }
    enumerator_73610.gotoNextObject () ;
  }
  GALGAS_readerMap var_readerMap ;
  {
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_filewrapperTemplateListAST enumerator_78215 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_78215.hasCurrentObject ()) {
    ...
    cEnumerator_formalTemplateInputParameterListAST enumerator_78333 (enumerator_78215.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_78333.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_78333.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1933)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1934)) ;
      enumerator_78333.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_78215.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_78215.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1936)) ;
    }
    enumerator_78215.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_textExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1943)) ;
  cEnumerator_lstringlist enumerator_78852 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_78852.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_78852.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1945)) ;
    }
    enumerator_78852.gotoNextObject () ;
  }
  ...
  cEnumerator_lstringlist enumerator_79058 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_79058.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_79058.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1950)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_79058.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_79058.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1951)) COMMA_SOURCE_FILE_AT_LINE (1951)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1951)) COMMA_SOURCE_FILE_AT_LINE (1951)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_79058.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1953)) ;
      }
    }
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_81008 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_81008.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_81008.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2006)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_81252 (enumerator_81008.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_81252.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_81252.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_81252.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_81252.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_81008.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2016)) ;
    enumerator_81008.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_82196 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_82196.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_82196.current_mAttributeTypeProxy (HERE), enumerator_82196.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2030)) COMMA_SOURCE_FILE_AT_LINE (2030)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_82196.current_mAttributeTypeProxy (HERE), enumerator_82196.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2031)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_82196.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2032)), enumerator_82196.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2032)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_82196.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2033)), enumerator_82196.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2033)) ;
    enumerator_82196.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_83605 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_83605.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_83605.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_83605.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2053)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2053)), enumerator_83605.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2053)) COMMA_SOURCE_FILE_AT_LINE (2053)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2054)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_listWithValue (var_uintType, GALGAS_string ("inIndex") COMMA_SOURCE_FILE_AT_LINE (2055)), inCompiler->here (), GALGAS_bool (true), enumerator_83605.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2059)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2052)) ;
      }
    }
    enumerator_83605.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_85429 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_85429.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_85429.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      ...
      var_setterFormalArgumentList.addAssign_operation (enumerator_85429.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2115)), enumerator_85429.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2115)) ;
      var_setterFormalArgumentList.addAssign_operation (var_uintType, GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2116)), enumerator_85429.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2116)) ;
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_85429.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2118)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2118)) COMMA_SOURCE_FILE_AT_LINE (2118)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2118)), enumerator_85429.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2118)) COMMA_SOURCE_FILE_AT_LINE (2118)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2119)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2122)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2117)) ;
      }
    }
    enumerator_85429.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_89229 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_89229.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_89229.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2209)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_89229.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2212)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_89229.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2213)) ;
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_89229.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2214)) ;
    var_modifierFormalArgumentList.addAssign_operation (var_attributeTypeIndex, GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (2215)), enumerator_89229.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2215)) ;
    enumerator_89229.gotoNextObject () ;
  }
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_93884 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_93884.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_93884.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2336)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_93884.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2337)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_93884.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2340)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_93884.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2341)) ;
    }
    enumerator_93884.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_94630 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_94630.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_94630.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2358)), enumerator_94630.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2359)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2355)) ;
    }
    enumerator_94630.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_95812 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_95812.hasCurrentObject () && bool_1) {
    while (enumerator_95812.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_95812.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2393)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_95812.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2393)).operator_not (SOURCE_FILE_AT_LINE (2393)) COMMA_SOURCE_FILE_AT_LINE (2393)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_95812.gotoNextObject () ;
      if (enumerator_95812.hasCurrentObject ()) {
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_98224 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_98224.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_98224.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2454)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_98224.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    ...
    GALGAS_bool joker_98703_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_98703_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_98788_2 ; // Joker input parameter
    GALGAS_constructorMap joker_98788_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_98878_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_98878_9 ; // Joker input parameter
    GALGAS_stringlist joker_98878_8 ; // Joker input parameter
    GALGAS_uint joker_98878_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyAndParameterList joker_98878_6 ; // Joker input parameter
    GALGAS_stringset joker_98878_5 ; // Joker input parameter
    GALGAS_lstringlist joker_98878_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_98878_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_98878_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_98878_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_98925_2 ; // Joker input parameter
    GALGAS_string joker_98925_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_98703_2, joker_98703_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_98788_2, joker_98788_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_98878_10, joker_98878_9, joker_98878_8, joker_98878_7, joker_98878_6, joker_98878_5, joker_98878_4, joker_98878_3, joker_98878_2, joker_98878_1, var_generateHeaderInSeparateFile, joker_98925_2, joker_98925_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2464)) ;
    ...
    cEnumerator_modifierMap enumerator_99212 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_99212.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_99212.current_lkey (HERE), enumerator_99212.current_mKind (HERE), enumerator_99212.current_mParameterList (HERE), enumerator_99212.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2490)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2485)) ;
      }
      enumerator_99212.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2495)) ;
    cEnumerator_readerMap enumerator_99538 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_99538.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_99538.current_lkey (HERE), enumerator_99538.current_mKind (HERE), enumerator_99538.current_mArgumentTypeList (HERE), enumerator_99538.current_mDeclarationLocation (HERE), enumerator_99538.current_mHasCompilerArgument (HERE), enumerator_99538.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2504)), enumerator_99538.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2497)) ;
      }
      enumerator_99538.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2509)) ;
    cEnumerator_instanceMethodMap enumerator_99926 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_99926.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_99926.current_lkey (HERE), enumerator_99926.current_mKind (HERE), enumerator_99926.current_mParameterList (HERE), enumerator_99926.current_mDeclarationLocation (HERE), enumerator_99926.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2517)), enumerator_99926.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2511)) ;
      }
      enumerator_99926.gotoNextObject () ;
    }
  }
  ...
  cEnumerator_typedAttributeList enumerator_100357 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_100357.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_100357.current_mAttributeTypeProxy (HERE), enumerator_100357.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2525)) ;
    enumerator_100357.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_100484 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_100484.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_100484.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2529)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex, enumerator_100484.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2530)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_100484.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2531)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_100484.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2532)) COMMA_SOURCE_FILE_AT_LINE (2532)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_100484.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_100484.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2533)) COMMA_SOURCE_FILE_AT_LINE (2533)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader") COMMA_SOURCE_FILE_AT_LINE (2533)) COMMA_SOURCE_FILE_AT_LINE (2533)) ;
    }
    enumerator_100484.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_101584 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_101584.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_101584.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2557)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_101828 (enumerator_101584.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_101828.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_101828.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2561)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_101828.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2563)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_101828.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_101584.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2567)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_101584.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2568)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_101584.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2572)), GALGAS_unifiedTypeMapProxyAndParameterList::constructor_emptyList (SOURCE_FILE_AT_LINE (2573)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2577)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2570)) ;
      }
    }
    enumerator_101584.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_102896 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_102896.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_102896.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_102896.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2592)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2592)) COMMA_SOURCE_FILE_AT_LINE (2592)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2592)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2593)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_102896.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2594)), enumerator_102896.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2594)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2596)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2591)) ;
      }
    }
    enumerator_102896.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_103938 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_103938.hasCurrentObject () && bool_12) {
    while (enumerator_103938.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_103938.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2620)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_103938.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2620)).operator_not (SOURCE_FILE_AT_LINE (2620)) COMMA_SOURCE_FILE_AT_LINE (2620)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_103938.gotoNextObject () ;
      if (enumerator_103938.hasCurrentObject ()) {
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_105601 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_105601.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_105601.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2665)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_105601.current_mFormalArgumentPassingMode (HERE), enumerator_105601.current_mFormalArgumentName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2666)) ;
    enumerator_105601.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_106609 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_106609.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_106609.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2684)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2685)) ;
    enumerator_106609.gotoNextObject () ;
  }
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2740)).isValid ()) {
    PMUInt32 variant_109366 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2740)).uintValue () ;
    bool loop_109366 = true ;
    while (loop_109366) {
      loop_109366 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2740)))).isValid () ;
      if (loop_109366) {
        loop_109366 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2740)))).boolValue () ;
      }
      if (loop_109366 && (0 == variant_109366)) {
        loop_109366 = false ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2779)).isValid ()) {
    PMUInt32 variant_110678 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2779)).uintValue () ;
    bool loop_110678 = true ;
    while (loop_110678) {
      loop_110678 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2779)))).isValid () ;
      if (loop_110678) {
        loop_110678 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2779)))).boolValue () ;
      }
      if (loop_110678 && (0 == variant_110678)) {
        loop_110678 = false ;
  ...
  {
  GALGAS_unifiedTypeMapProxy joker_111293_3 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_111293_2 ; // Joker input parameter
  GALGAS_string joker_111293_1 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_111293_3, joker_111293_2, joker_111293_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2799)) ;
  }
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_113715_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_113715_1 ; // Joker input parameter
  GALGAS_attributeMap joker_113803_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_113803_18 ; // Joker input parameter
  GALGAS_constructorMap joker_113803_17 ; // Joker input parameter
  GALGAS_readerMap joker_113803_16 ; // Joker input parameter
  GALGAS_modifierMap joker_113803_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_113803_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_113803_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_113803_12 ; // Joker input parameter
  GALGAS_stringlist joker_113803_11 ; // Joker input parameter
  GALGAS_uint joker_113803_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyAndParameterList joker_113803_9 ; // Joker input parameter
  GALGAS_stringset joker_113803_8 ; // Joker input parameter
  GALGAS_lstringlist joker_113803_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_113803_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_113803_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_113803_4 ; // Joker input parameter
  GALGAS_bool joker_113803_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_113803_2 ; // Joker input parameter
  GALGAS_string joker_113803_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_113715_2, joker_113715_1, var_typeKindEnum, var_listTypedAttributeList, joker_113803_19, joker_113803_18, joker_113803_17, joker_113803_16, joker_113803_15, joker_113803_14, joker_113803_13, joker_113803_12, joker_113803_11, joker_113803_10, joker_113803_9, joker_113803_8, joker_113803_7, joker_113803_6, joker_113803_5, joker_113803_4, joker_113803_3, joker_113803_2, joker_113803_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2866)) ;
  ...
  cEnumerator_typedAttributeList enumerator_115874 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_115874.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_115874.current_mAttributeTypeProxy (HERE), enumerator_115874.current_mAttributeName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (2906)) ;
    enumerator_115874.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_120130 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_120130.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_120130.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3007)) COMMA_SOURCE_FILE_AT_LINE (3007)), enumerator_120130.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3007)) COMMA_SOURCE_FILE_AT_LINE (3007)) COMMA_SOURCE_FILE_AT_LINE (3007)) ;
    }
    enumerator_120130.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121112 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121112.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121112.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3024)) COMMA_SOURCE_FILE_AT_LINE (3024)), enumerator_121112.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3024)) COMMA_SOURCE_FILE_AT_LINE (3024)) COMMA_SOURCE_FILE_AT_LINE (3024)) ;
    }
    enumerator_121112.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121973 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121973.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121973.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3040)) COMMA_SOURCE_FILE_AT_LINE (3040)), enumerator_121973.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3040)) COMMA_SOURCE_FILE_AT_LINE (3040)) COMMA_SOURCE_FILE_AT_LINE (3040)) ;
    }
    enumerator_121973.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_123539 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_123539.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_123539.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3069)) COMMA_SOURCE_FILE_AT_LINE (3069)), enumerator_123539.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3069)) COMMA_SOURCE_FILE_AT_LINE (3069)) COMMA_SOURCE_FILE_AT_LINE (3069)) ;
    }
    enumerator_123539.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_126035 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126035.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126035.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3113)) COMMA_SOURCE_FILE_AT_LINE (3113)), enumerator_126035.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3113)) COMMA_SOURCE_FILE_AT_LINE (3113)) COMMA_SOURCE_FILE_AT_LINE (3113)) ;
    }
    enumerator_126035.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_126893 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_126893.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_126893.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3129)) COMMA_SOURCE_FILE_AT_LINE (3129)), enumerator_126893.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3129)) COMMA_SOURCE_FILE_AT_LINE (3129)) COMMA_SOURCE_FILE_AT_LINE (3129)) ;
    }
    enumerator_126893.gotoNextObject () ;
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_135978 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3301)) ;
  if (NULL != objectArray_135978) {
      macroValidSharedObject (objectArray_135978, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_135978->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3302)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_137280 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3329)) ;
  if (NULL != objectArray_137280) {
      macroValidSharedObject (objectArray_137280, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_137280->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3330)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_138552 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3356)) ;
  if (NULL != objectArray_138552) {
      macroValidSharedObject (objectArray_138552, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_138552->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3357)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_140453 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3395)) ;
  if (NULL != objectArray_140453) {
      macroValidSharedObject (objectArray_140453, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_140453->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3396)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_141803 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3423)) ;
  if (NULL != objectArray_141803) {
      macroValidSharedObject (objectArray_141803, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_141803->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3424)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_143115 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3450)) ;
  if (NULL != objectArray_143115) {
      macroValidSharedObject (objectArray_143115, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_143115->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3451)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_143954 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_143954.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_143954.current_mAttributeTypeName (HERE), enumerator_143954.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3480)) COMMA_SOURCE_FILE_AT_LINE (3477)) ;
    enumerator_143954.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_144588 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_144588.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_144588.current_mAttributeTypeName (HERE), enumerator_144588.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3501)) COMMA_SOURCE_FILE_AT_LINE (3498)) ;
    enumerator_144588.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_145230 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_145230.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_145230.current_mAttributeTypeName (HERE), enumerator_145230.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3522)) COMMA_SOURCE_FILE_AT_LINE (3519)) ;
    enumerator_145230.gotoNextObject () ;
  }
