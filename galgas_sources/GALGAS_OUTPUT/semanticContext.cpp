...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_72809 (var_files, kEnumeration_up) ;
  while (enumerator_72809.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_72809.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1813)) COMMA_SOURCE_FILE_AT_LINE (1813)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1814)).operator_concat (enumerator_72809.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1814)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_72809.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1816)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1815)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1822)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_72809.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1823)) COMMA_SOURCE_FILE_AT_LINE (1823)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1824)).operator_concat (enumerator_72809.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1824)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_72809.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1826)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1825)) ;
        }
        ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1832)) ;
      }
    }
    enumerator_72809.gotoNextObject () ;
  }
  ...
  cEnumerator_stringlist enumerator_73774 (var_directories, kEnumeration_up) ;
  while (enumerator_73774.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1843)).operator_concat (enumerator_73774.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1843)), constinArgument_inPathInWrapper.operator_concat (enumerator_73774.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1844)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1844)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1842)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_73774.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1853)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1852)) ;
    }
    enumerator_73774.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_142935 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_142935.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_142935.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3513)) ;
    enumerator_142935.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_143668 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_143668.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_143668.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3525)) ;
    enumerator_143668.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_144088 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3534)), kEnumeration_up) ;
    while (enumerator_144088.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_144088.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_144088.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3535)) COMMA_SOURCE_FILE_AT_LINE (3535)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3535)) COMMA_SOURCE_FILE_AT_LINE (3535)) ;
      enumerator_144088.gotoNextObject () ;
    }
    ...
    GALGAS_lstringlist joker_144424_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_144424_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3539)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_145009 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_145009.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_145009.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3553)) COMMA_SOURCE_FILE_AT_LINE (3553)) COMMA_SOURCE_FILE_AT_LINE (3553)) ;
        enumerator_145009.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_145817 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_145817.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_145817.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3573)) ;
        enumerator_145817.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  {
  var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("removeEdgesToDominators"), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1651)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1652)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1653)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (1655)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1650)) ;
  }
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_70415 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_70415.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_70415.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1743)) COMMA_SOURCE_FILE_AT_LINE (1743)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_70415.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1744)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1744)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1744)) ;
    }
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_filewrapperTemplateListAST enumerator_75008 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_75008.hasCurrentObject ()) {
    ...
    cEnumerator_formalTemplateInputParameterListAST enumerator_75126 (enumerator_75008.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_75126.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_75126.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1875)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1876)) ;
      enumerator_75126.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_75008.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_75008.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1878)) ;
    }
    enumerator_75008.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_textExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1885)) ;
  cEnumerator_lstringlist enumerator_75645 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_75645.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_75645.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1887)) ;
    }
    enumerator_75645.gotoNextObject () ;
  }
  ...
  cEnumerator_lstringlist enumerator_75851 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_75851.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_75851.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1892)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_75851.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_75851.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1893)) COMMA_SOURCE_FILE_AT_LINE (1893)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1893)) COMMA_SOURCE_FILE_AT_LINE (1893)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_75851.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1895)) ;
      }
    }
    enumerator_75851.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_77801 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_77801.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_77801.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1948)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_78045 (enumerator_77801.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_78045.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_78045.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_78045.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
    ...
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_77801.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1958)) ;
    enumerator_77801.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_78977 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_78977.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_78977.current_mAttributeTypeProxy (HERE), enumerator_78977.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1972)) COMMA_SOURCE_FILE_AT_LINE (1972)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_78977.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (1973)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_78977.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1974)) COMMA_SOURCE_FILE_AT_LINE (1974)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_78977.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1975)) COMMA_SOURCE_FILE_AT_LINE (1975)) ;
    enumerator_78977.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_80245 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_80245.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_80245.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_80245.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1995)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1995)), enumerator_80245.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1995)) COMMA_SOURCE_FILE_AT_LINE (1995)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1996)), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_uintType COMMA_SOURCE_FILE_AT_LINE (1997)), inCompiler->here (), GALGAS_bool (true), enumerator_80245.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2001)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1994)) ;
      }
    }
    enumerator_80245.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_81400 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_81400.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_81400.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      ...
      var_setterFormalArgumentList.addAssign_operation (enumerator_81400.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2035)) COMMA_SOURCE_FILE_AT_LINE (2035)) ;
      ...
      {
      var_modifierMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_81400.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2038)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2038)) COMMA_SOURCE_FILE_AT_LINE (2038)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (2038)), enumerator_81400.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2038)) COMMA_SOURCE_FILE_AT_LINE (2038)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2039)), var_setterFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2042)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (2037)) ;
      }
    }
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_85633 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_85633.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_85633.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2148)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_85633.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2151)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_85633.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2152)) COMMA_SOURCE_FILE_AT_LINE (2152)) ;
    ...
    enumerator_85633.gotoNextObject () ;
  }
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_90182 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_90182.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_90182.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2275)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2276)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_90182.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2279)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_90182.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2280)) ;
    }
    enumerator_90182.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_90904 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_90904.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_90904.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2297)), enumerator_90904.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2298)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2294)) ;
    }
    enumerator_90904.gotoNextObject () ;
  }
  ...
  if (enumerator_92089.hasCurrentObject () && bool_1) {
    while (enumerator_92089.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_92089.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2332)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_92089.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2332)).operator_not (SOURCE_FILE_AT_LINE (2332)) COMMA_SOURCE_FILE_AT_LINE (2332)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_92089.gotoNextObject () ;
      if (enumerator_92089.hasCurrentObject ()) {
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_94486 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_94486.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_94486.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2393)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_94486.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    ...
    GALGAS_bool joker_94963_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_94963_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_95048_2 ; // Joker input parameter
    GALGAS_constructorMap joker_95048_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_95139_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_95139_9 ; // Joker input parameter
    GALGAS_stringlist joker_95139_8 ; // Joker input parameter
    GALGAS_uint joker_95139_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_95139_6 ; // Joker input parameter
    GALGAS_stringset joker_95139_5 ; // Joker input parameter
    GALGAS_lstringlist joker_95139_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_95139_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_95139_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_95139_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_95185_2 ; // Joker input parameter
    GALGAS_string joker_95185_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_94963_2, joker_94963_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_95048_2, joker_95048_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_95139_10, joker_95139_9, joker_95139_8, joker_95139_7, joker_95139_6, joker_95139_5, joker_95139_4, joker_95139_3, joker_95139_2, joker_95139_1, var_generateHeaderInSeparateFile, joker_95185_2, joker_95185_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2403)) ;
    ...
    cEnumerator_modifierMap enumerator_95474 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_95474.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_95474.current_lkey (HERE), enumerator_95474.current_mKind (HERE), enumerator_95474.current_mParameterList (HERE), enumerator_95474.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2429)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2424)) ;
      }
      enumerator_95474.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2434)) ;
    cEnumerator_readerMap enumerator_95800 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_95800.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_95800.current_lkey (HERE), enumerator_95800.current_mKind (HERE), enumerator_95800.current_mArgumentTypeList (HERE), enumerator_95800.current_mDeclarationLocation (HERE), enumerator_95800.current_mHasCompilerArgument (HERE), enumerator_95800.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2443)), enumerator_95800.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2436)) ;
      }
      enumerator_95800.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2448)) ;
    cEnumerator_instanceMethodMap enumerator_96188 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_96188.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_96188.current_lkey (HERE), enumerator_96188.current_mKind (HERE), enumerator_96188.current_mParameterList (HERE), enumerator_96188.current_mDeclarationLocation (HERE), enumerator_96188.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2456)), enumerator_96188.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2450)) ;
      }
      enumerator_96188.gotoNextObject () ;
    }
  }
  ...
  cEnumerator_typedAttributeList enumerator_96607 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_96607.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_96607.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2464)) ;
    enumerator_96607.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_96710 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_96710.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_96710.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2468)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2469)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_96710.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2470)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_96710.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2471)) COMMA_SOURCE_FILE_AT_LINE (2471)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_96710.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_96710.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2472)) COMMA_SOURCE_FILE_AT_LINE (2472)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader") COMMA_SOURCE_FILE_AT_LINE (2472)) COMMA_SOURCE_FILE_AT_LINE (2472)) ;
    }
    enumerator_96710.gotoNextObject () ;
  }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_97786 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_97786.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_97786.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2496)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_98030 (enumerator_97786.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_98030.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_98030.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2500)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_98030.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2502)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_98030.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_97786.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2506)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_97786.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2507)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_97786.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2511)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2512)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2516)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2509)) ;
      }
    }
    enumerator_97786.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_99086 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_99086.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_99086.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_99086.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2531)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2531)) COMMA_SOURCE_FILE_AT_LINE (2531)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2531)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2532)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_99086.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2533)) COMMA_SOURCE_FILE_AT_LINE (2533)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2535)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2530)) ;
      }
    }
    enumerator_99086.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_100107 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_100107.hasCurrentObject () && bool_12) {
    while (enumerator_100107.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_100107.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2559)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_100107.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2559)).operator_not (SOURCE_FILE_AT_LINE (2559)) COMMA_SOURCE_FILE_AT_LINE (2559)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_100107.gotoNextObject () ;
      if (enumerator_100107.hasCurrentObject ()) {
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_101755 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_101755.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_101755.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2604)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_101755.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (2605)) ;
    enumerator_101755.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_102734 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_102734.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_102734.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2623)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2624)) ;
    enumerator_102734.gotoNextObject () ;
  }
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2680)).isValid ()) {
    PMUInt32 variant_105450 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2680)).uintValue () ;
    bool loop_105450 = true ;
    while (loop_105450) {
      loop_105450 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2680)))).isValid () ;
      if (loop_105450) {
        loop_105450 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2680)))).boolValue () ;
      }
      if (loop_105450 && (0 == variant_105450)) {
        loop_105450 = false ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2719)).isValid ()) {
    PMUInt32 variant_106703 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2719)).uintValue () ;
    bool loop_106703 = true ;
    while (loop_106703) {
      loop_106703 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2719)))).isValid () ;
      if (loop_106703) {
        loop_106703 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2719)))).boolValue () ;
      }
      if (loop_106703 && (0 == variant_106703)) {
        loop_106703 = false ;
  ...
  {
  GALGAS_unifiedTypeMapProxy joker_107298_0 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_107301_0 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_107298_0, joker_107301_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2739)) ;
  }
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_109685_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_109685_1 ; // Joker input parameter
  GALGAS_attributeMap joker_109774_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_109774_18 ; // Joker input parameter
  GALGAS_constructorMap joker_109774_17 ; // Joker input parameter
  GALGAS_readerMap joker_109774_16 ; // Joker input parameter
  GALGAS_modifierMap joker_109774_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_109774_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_109774_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_109774_12 ; // Joker input parameter
  GALGAS_stringlist joker_109774_11 ; // Joker input parameter
  GALGAS_uint joker_109774_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_109774_9 ; // Joker input parameter
  GALGAS_stringset joker_109774_8 ; // Joker input parameter
  GALGAS_lstringlist joker_109774_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_109774_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_109774_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_109774_4 ; // Joker input parameter
  GALGAS_bool joker_109774_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_109774_2 ; // Joker input parameter
  GALGAS_string joker_109774_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_109685_2, joker_109685_1, var_typeKindEnum, var_listTypedAttributeList, joker_109774_19, joker_109774_18, joker_109774_17, joker_109774_16, joker_109774_15, joker_109774_14, joker_109774_13, joker_109774_12, joker_109774_11, joker_109774_10, joker_109774_9, joker_109774_8, joker_109774_7, joker_109774_6, joker_109774_5, joker_109774_4, joker_109774_3, joker_109774_2, joker_109774_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2806)) ;
  ...
  cEnumerator_typedAttributeList enumerator_111769 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_111769.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_111769.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2846)) ;
    enumerator_111769.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_116001 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_116001.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_116001.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2947)) COMMA_SOURCE_FILE_AT_LINE (2947)), enumerator_116001.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2947)) COMMA_SOURCE_FILE_AT_LINE (2947)) COMMA_SOURCE_FILE_AT_LINE (2947)) ;
    }
    enumerator_116001.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_116983 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_116983.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_116983.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2964)) COMMA_SOURCE_FILE_AT_LINE (2964)), enumerator_116983.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2964)) COMMA_SOURCE_FILE_AT_LINE (2964)) COMMA_SOURCE_FILE_AT_LINE (2964)) ;
    }
    enumerator_116983.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_117844 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_117844.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_117844.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2980)) COMMA_SOURCE_FILE_AT_LINE (2980)), enumerator_117844.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2980)) COMMA_SOURCE_FILE_AT_LINE (2980)) COMMA_SOURCE_FILE_AT_LINE (2980)) ;
    }
    enumerator_117844.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_119410 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_119410.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_119410.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3009)) COMMA_SOURCE_FILE_AT_LINE (3009)), enumerator_119410.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3009)) COMMA_SOURCE_FILE_AT_LINE (3009)) COMMA_SOURCE_FILE_AT_LINE (3009)) ;
    }
    enumerator_119410.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121906 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121906.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121906.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3053)) COMMA_SOURCE_FILE_AT_LINE (3053)), enumerator_121906.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3053)) COMMA_SOURCE_FILE_AT_LINE (3053)) COMMA_SOURCE_FILE_AT_LINE (3053)) ;
    }
    enumerator_121906.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_122764 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_122764.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_122764.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3069)) COMMA_SOURCE_FILE_AT_LINE (3069)), enumerator_122764.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3069)) COMMA_SOURCE_FILE_AT_LINE (3069)) COMMA_SOURCE_FILE_AT_LINE (3069)) ;
    }
    enumerator_122764.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_131849 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3241)) ;
  if (NULL != objectArray_131849) {
      macroValidSharedObject (objectArray_131849, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_131849->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3242)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_133151 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3269)) ;
  if (NULL != objectArray_133151) {
      macroValidSharedObject (objectArray_133151, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_133151->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3270)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_134423 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3296)) ;
  if (NULL != objectArray_134423) {
      macroValidSharedObject (objectArray_134423, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_134423->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3297)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_136324 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3335)) ;
  if (NULL != objectArray_136324) {
      macroValidSharedObject (objectArray_136324, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_136324->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3336)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_137674 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3363)) ;
  if (NULL != objectArray_137674) {
      macroValidSharedObject (objectArray_137674, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_137674->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3364)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_138986 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3390)) ;
  if (NULL != objectArray_138986) {
      macroValidSharedObject (objectArray_138986, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_138986->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3391)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_139825 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_139825.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_139825.current_mAttributeTypeName (HERE), enumerator_139825.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3420)) COMMA_SOURCE_FILE_AT_LINE (3417)) ;
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_140459 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_140459.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_140459.current_mAttributeTypeName (HERE), enumerator_140459.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3441)) COMMA_SOURCE_FILE_AT_LINE (3438)) ;
    enumerator_140459.gotoNextObject () ;
  }
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_141101 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_141101.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_141101.current_mAttributeTypeName (HERE), enumerator_141101.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3462)) COMMA_SOURCE_FILE_AT_LINE (3459)) ;
    enumerator_141101.gotoNextObject () ;
  }
