...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  cEnumerator_stringlist enumerator_72613 (var_files, kEnumeration_up) ;
  while (enumerator_72613.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_72613.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1805)) COMMA_SOURCE_FILE_AT_LINE (1805)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1806)).operator_concat (enumerator_72613.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1806)) ;
      {
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_72613.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1808)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1807)) ;
      }
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1814)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_72613.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1815)) COMMA_SOURCE_FILE_AT_LINE (1815)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1816)).operator_concat (enumerator_72613.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1816)) ;
        {
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_72613.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1818)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1817)) ;
        }
  ...
  cEnumerator_stringlist enumerator_73578 (var_directories, kEnumeration_up) ;
  while (enumerator_73578.hasCurrentObject ()) {
    ...
    {
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1835)).operator_concat (enumerator_73578.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1835)), constinArgument_inPathInWrapper.operator_concat (enumerator_73578.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1836)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1836)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1834)) ;
    }
    {
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_73578.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1845)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1844)) ;
    }
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_semanticDeclarationListAST enumerator_142739 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  while (enumerator_142739.hasCurrentObject ()) {
    callCategoryMethod_addAssociatedElement ((const cPtr_semanticDeclarationAST *) enumerator_142739.current_mSemanticDeclaration (HERE).ptr (), var_semanticDeclarationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3505)) ;
    enumerator_142739.gotoNextObject () ;
  }
  ...
  cEnumerator_semanticDeclarationListAST enumerator_143472 (var_semanticDeclarationList, kEnumeration_up) ;
  while (enumerator_143472.hasCurrentObject ()) {
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_143472.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3517)) ;
    enumerator_143472.gotoNextObject () ;
  }
  ...
  if (kBoolTrue == test_0) {
    cEnumerator_lstringlist enumerator_143892 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (3526)), kEnumeration_up) ;
    while (enumerator_143892.hasCurrentObject ()) {
      GALGAS_location location_1 (enumerator_143892.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_143892.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (3527)) COMMA_SOURCE_FILE_AT_LINE (3527)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (3527)) COMMA_SOURCE_FILE_AT_LINE (3527)) ;
      enumerator_143892.gotoNextObject () ;
    }
    ...
    GALGAS_lstringlist joker_144239_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_breathFirstTopologicalSort (var_sortedSemanticDeclarationListAST, joker_144239_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3531)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_semanticDeclarationListAST enumerator_144824 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_144824.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_144824.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (3545)) COMMA_SOURCE_FILE_AT_LINE (3545)) COMMA_SOURCE_FILE_AT_LINE (3545)) ;
        enumerator_144824.gotoNextObject () ;
      }
      ...
      cEnumerator_semanticDeclarationListAST enumerator_145632 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      while (enumerator_145632.hasCurrentObject ()) {
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_145632.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (3565)) ;
        enumerator_145632.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_unifiedTypeMapProxyList enumerator_66447 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE_AT_LINE (1627)), kEnumeration_up) ;
  while (enumerator_66447.hasCurrentObject ()) {
    var_formalParameterList.addAssign_operation (enumerator_66447.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1628)) COMMA_SOURCE_FILE_AT_LINE (1628)) ;
    enumerator_66447.gotoNextObject () ;
  }
  cEnumerator_graphInsertModifierList enumerator_66576 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  while (enumerator_66576.hasCurrentObject ()) {
    {
    var_modifierMap.modifier_insertOrReplace (enumerator_66576.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1633)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1636)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1631)) ;
    }
    enumerator_66576.gotoNextObject () ;
  }
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_lstringlist enumerator_70219 (object->mAttribute_mConstantList, kEnumeration_up) ;
  while (enumerator_70219.hasCurrentObject ()) {
    var_constantSet.addAssign_operation (enumerator_70219.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1735)) COMMA_SOURCE_FILE_AT_LINE (1735)) ;
    {
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_70219.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1736)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1736)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1736)) ;
    }
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_filewrapperTemplateListAST enumerator_74812 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  while (enumerator_74812.hasCurrentObject ()) {
    ...
    cEnumerator_formalTemplateInputParameterListAST enumerator_74930 (enumerator_74812.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    while (enumerator_74930.hasCurrentObject ()) {
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      {
      GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_74930.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1867)) ;
      }
      var_templateSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1868)) ;
      enumerator_74930.gotoNextObject () ;
    }
    {
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_74812.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_74812.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1870)) ;
    }
    enumerator_74812.gotoNextObject () ;
  }
  GALGAS_wrapperExtensionMap var_textExtensionMap = GALGAS_wrapperExtensionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1877)) ;
  cEnumerator_lstringlist enumerator_75449 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  while (enumerator_75449.hasCurrentObject ()) {
    {
    var_textExtensionMap.modifier_insertKey (enumerator_75449.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1879)) ;
    }
    enumerator_75449.gotoNextObject () ;
  }
  ...
  cEnumerator_lstringlist enumerator_75655 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  while (enumerator_75655.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_75655.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1884)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_75655.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_75655.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1885)) COMMA_SOURCE_FILE_AT_LINE (1885)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1885)) COMMA_SOURCE_FILE_AT_LINE (1885)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_75655.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1887)) ;
      }
    }
    enumerator_75655.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_77605 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_77605.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_77605.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1940)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_77849 (enumerator_77605.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_77849.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_77849.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_hasGetter = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_77849.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("setter"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_hasSetter = GALGAS_bool (true) ;
        }
      }
      enumerator_77849.gotoNextObject () ;
    }
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_77605.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1950)) ;
    enumerator_77605.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_78781 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_78781.hasCurrentObject ()) {
    var_enumerationDescriptor.addAssign_operation (enumerator_78781.current_mAttributeTypeProxy (HERE), enumerator_78781.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1964)) COMMA_SOURCE_FILE_AT_LINE (1964)) ;
    var_constructorAttributeTypeList.addAssign_operation (enumerator_78781.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (1965)) ;
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_78781.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1966)) COMMA_SOURCE_FILE_AT_LINE (1966)) ;
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_78781.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1967)) COMMA_SOURCE_FILE_AT_LINE (1967)) ;
  ...
  cEnumerator_typedAttributeList enumerator_80049 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_80049.hasCurrentObject ()) {
    const enumGalgasBool test_2 = enumerator_80049.current_mHasGetter (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_80049.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1987)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1987)), enumerator_80049.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1987)) COMMA_SOURCE_FILE_AT_LINE (1987)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1988)), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_uintType COMMA_SOURCE_FILE_AT_LINE (1989)), inCompiler->here (), GALGAS_bool (true), enumerator_80049.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1993)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1986)) ;
      }
    }
    enumerator_80049.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_81204 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_81204.hasCurrentObject ()) {
    const enumGalgasBool test_3 = enumerator_81204.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_3) {
      ...
      var_setterFormalArgumentList.addAssign_operation (enumerator_81204.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (2027)) COMMA_SOURCE_FILE_AT_LINE (2027)) ;
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_85437 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_85437.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_85437.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2140)) ;
    }
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_85437.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2143)) ;
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_85437.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2144)) COMMA_SOURCE_FILE_AT_LINE (2144)) ;
    ...
    enumerator_85437.gotoNextObject () ;
  }
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_89986 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_89986.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_89986.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2267)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2268)) ;
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_89986.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2271)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_89986.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2272)) ;
    }
    enumerator_89986.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_90708 (var_typedAttributeList, kEnumeration_up) ;
  while (enumerator_90708.hasCurrentObject ()) {
    {
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_90708.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2289)), enumerator_90708.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (2290)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (2286)) ;
    }
    enumerator_90708.gotoNextObject () ;
  }
  ...
  cEnumerator_typedAttributeList enumerator_91893 (var_typedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_91893.hasCurrentObject () && bool_1) {
    while (enumerator_91893.hasCurrentObject () && bool_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_91893.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2324)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_91893.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2324)).operator_not (SOURCE_FILE_AT_LINE (2324)) COMMA_SOURCE_FILE_AT_LINE (2324)).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_91893.gotoNextObject () ;
      if (enumerator_91893.hasCurrentObject ()) {
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_lstringlist enumerator_94290 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    while (enumerator_94290.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_94290.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2385)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_generateHeaderInSeparateFile = GALGAS_bool (true) ;
      }
      enumerator_94290.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_0) {
    {
    ...
    GALGAS_bool joker_94767_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_94767_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_94852_2 ; // Joker input parameter
    GALGAS_constructorMap joker_94852_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_94943_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_94943_9 ; // Joker input parameter
    GALGAS_stringlist joker_94943_8 ; // Joker input parameter
    GALGAS_uint joker_94943_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_94943_6 ; // Joker input parameter
    GALGAS_stringset joker_94943_5 ; // Joker input parameter
    GALGAS_lstringlist joker_94943_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_94943_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_94943_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_94943_1 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_94989_2 ; // Joker input parameter
    GALGAS_string joker_94989_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_94767_2, joker_94767_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_94852_2, joker_94852_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_94943_10, joker_94943_9, joker_94943_8, joker_94943_7, joker_94943_6, joker_94943_5, joker_94943_4, joker_94943_3, joker_94943_2, joker_94943_1, var_generateHeaderInSeparateFile, joker_94989_2, joker_94989_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2395)) ;
    ...
    cEnumerator_modifierMap enumerator_95278 (var_inheritedModifierMap, kEnumeration_up) ;
    while (enumerator_95278.hasCurrentObject ()) {
      {
      var_modifierMap.modifier_insertKey (enumerator_95278.current_lkey (HERE), enumerator_95278.current_mKind (HERE), enumerator_95278.current_mParameterList (HERE), enumerator_95278.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2421)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2416)) ;
      }
      enumerator_95278.gotoNextObject () ;
    }
    var_readerMap = GALGAS_readerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2426)) ;
    cEnumerator_readerMap enumerator_95604 (var_inheritedReaderMap, kEnumeration_up) ;
    while (enumerator_95604.hasCurrentObject ()) {
      {
      var_readerMap.modifier_insertKey (enumerator_95604.current_lkey (HERE), enumerator_95604.current_mKind (HERE), enumerator_95604.current_mArgumentTypeList (HERE), enumerator_95604.current_mDeclarationLocation (HERE), enumerator_95604.current_mHasCompilerArgument (HERE), enumerator_95604.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2435)), enumerator_95604.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2428)) ;
      }
      enumerator_95604.gotoNextObject () ;
    }
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2440)) ;
    cEnumerator_instanceMethodMap enumerator_95992 (var_inheritedMethodMap, kEnumeration_up) ;
    while (enumerator_95992.hasCurrentObject ()) {
      {
      var_instanceMethodMap.modifier_insertKey (enumerator_95992.current_lkey (HERE), enumerator_95992.current_mKind (HERE), enumerator_95992.current_mParameterList (HERE), enumerator_95992.current_mDeclarationLocation (HERE), enumerator_95992.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2448)), enumerator_95992.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2442)) ;
      }
      enumerator_95992.gotoNextObject () ;
    }
  }
  ...
  cEnumerator_typedAttributeList enumerator_96411 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  while (enumerator_96411.hasCurrentObject ()) {
    var_constructorAttributeTypeList.addAssign_operation (enumerator_96411.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2456)) ;
    enumerator_96411.gotoNextObject () ;
  }
  cEnumerator_attributeInCollectionListAST enumerator_96514 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_96514.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_96514.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2460)) ;
    }
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2461)) ;
    {
    var_attributeMap.modifier_insertKey (enumerator_96514.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2462)) ;
    }
    const enumGalgasBool test_4 = var_readerMap.reader_hasKey (enumerator_96514.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2463)) COMMA_SOURCE_FILE_AT_LINE (2463)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_96514.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("'").operator_concat (enumerator_96514.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2464)) COMMA_SOURCE_FILE_AT_LINE (2464)).operator_concat (GALGAS_string ("' is the name of a prefefined or a user defined reader") COMMA_SOURCE_FILE_AT_LINE (2464)) COMMA_SOURCE_FILE_AT_LINE (2464)) ;
    }
  ...
  cEnumerator_attributeInCollectionListAST enumerator_97590 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_97590.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_97590.current_mAttributeTypeName (HERE), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2488)) ;
    }
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_97834 (enumerator_97590.current_mFeatureList (HERE), kEnumeration_up) ;
    while (enumerator_97834.hasCurrentObject ()) {
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_97834.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2492)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_97834.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2494)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_97834.gotoNextObject () ;
    }
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_97590.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2498)) ;
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_97590.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2499)) ;
    const enumGalgasBool test_9 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_9) {
      {
      var_readerMap.modifier_insertKey (enumerator_97590.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2503)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2504)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2508)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2501)) ;
      }
    }
    enumerator_97590.gotoNextObject () ;
  }
  cEnumerator_typedAttributeList enumerator_98890 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  while (enumerator_98890.hasCurrentObject ()) {
    const enumGalgasBool test_10 = enumerator_98890.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_98890.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2523)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2523)) COMMA_SOURCE_FILE_AT_LINE (2523)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2523)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2524)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_98890.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2525)) COMMA_SOURCE_FILE_AT_LINE (2525)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2527)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2522)) ;
      }
    }
    enumerator_98890.gotoNextObject () ;
  }
  {
  ...
  cEnumerator_typedAttributeList enumerator_99911 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  ...
  if (enumerator_99911.hasCurrentObject () && bool_12) {
    while (enumerator_99911.hasCurrentObject () && bool_12) {
      const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, enumerator_99911.current_mAttributeTypeProxy (HERE).reader_mDefaultConstructorName (inCompiler COMMA_SOURCE_FILE_AT_LINE (2551)).objectCompare (GALGAS_string::makeEmptyString ())).operator_or (enumerator_99911.current_mAttributeTypeProxy (HERE).reader_mIsConcrete (inCompiler COMMA_SOURCE_FILE_AT_LINE (2551)).operator_not (SOURCE_FILE_AT_LINE (2551)) COMMA_SOURCE_FILE_AT_LINE (2551)).boolEnum () ;
      if (kBoolTrue == test_13) {
        var_defaultConstructorName = GALGAS_string::makeEmptyString () ;
      }
      enumerator_99911.gotoNextObject () ;
      if (enumerator_99911.hasCurrentObject ()) {
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalParameterListAST enumerator_101559 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_101559.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_101559.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2596)) ;
    }
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_101559.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (2597)) ;
    enumerator_101559.gotoNextObject () ;
  }
  {
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_formalInputParameterListAST enumerator_102538 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  while (enumerator_102538.hasCurrentObject ()) {
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    {
    GALGAS_unifiedTypeMapProxy::class_method_makeProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_102538.current_mFormalArgumentTypeName (HERE), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2615)) ;
    }
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2616)) ;
    enumerator_102538.gotoNextObject () ;
  }
...
static void categoryMethod_arrayDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2672)).isValid ()) {
    PMUInt32 variant_105254 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2672)).uintValue () ;
    bool loop_105254 = true ;
    while (loop_105254) {
      loop_105254 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2672)))).isValid () ;
      if (loop_105254) {
        loop_105254 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2672)))).boolValue () ;
      }
      if (loop_105254 && (0 == variant_105254)) {
        loop_105254 = false ;
  ...
  if (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2711)).isValid ()) {
    PMUInt32 variant_106507 = object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2711)).uintValue () ;
    bool loop_106507 = true ;
    while (loop_106507) {
      loop_106507 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2711)))).isValid () ;
      if (loop_106507) {
        loop_106507 = GALGAS_bool (kIsStrictInf, var_idx.objectCompare (object->mAttribute_mDimension.reader_uint (SOURCE_FILE_AT_LINE (2711)))).boolValue () ;
      }
      if (loop_106507 && (0 == variant_106507)) {
        loop_106507 = false ;
  ...
  {
  GALGAS_unifiedTypeMapProxy joker_107102_0 ; // Joker input parameter
  GALGAS_formalArgumentPassingModeAST joker_107105_0 ; // Joker input parameter
  var_modifierFormalArgumentList.modifier_popFirst (joker_107102_0, joker_107105_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (2731)) ;
  }
  {
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_bool joker_109489_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_109489_1 ; // Joker input parameter
  GALGAS_attributeMap joker_109578_19 ; // Joker input parameter
  GALGAS_typedAttributeList joker_109578_18 ; // Joker input parameter
  GALGAS_constructorMap joker_109578_17 ; // Joker input parameter
  GALGAS_readerMap joker_109578_16 ; // Joker input parameter
  GALGAS_modifierMap joker_109578_15 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_109578_14 ; // Joker input parameter
  GALGAS_classMethodMap joker_109578_13 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_109578_12 ; // Joker input parameter
  GALGAS_stringlist joker_109578_11 ; // Joker input parameter
  GALGAS_uint joker_109578_10 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_109578_9 ; // Joker input parameter
  GALGAS_stringset joker_109578_8 ; // Joker input parameter
  GALGAS_lstringlist joker_109578_7 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_109578_6 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_109578_5 ; // Joker input parameter
  GALGAS_withAccessorMap joker_109578_4 ; // Joker input parameter
  GALGAS_bool joker_109578_3 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_109578_2 ; // Joker input parameter
  GALGAS_string joker_109578_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_109489_2, joker_109489_1, var_typeKindEnum, var_listTypedAttributeList, joker_109578_19, joker_109578_18, joker_109578_17, joker_109578_16, joker_109578_15, joker_109578_14, joker_109578_13, joker_109578_12, joker_109578_11, joker_109578_10, joker_109578_9, joker_109578_8, joker_109578_7, joker_109578_6, joker_109578_5, joker_109578_4, joker_109578_3, joker_109578_2, joker_109578_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2798)) ;
  ...
  cEnumerator_typedAttributeList enumerator_111573 (var_listTypedAttributeList, kEnumeration_up) ;
  while (enumerator_111573.hasCurrentObject ()) {
    var_addAssignOperatorDescription.addAssign_operation (enumerator_111573.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2838)) ;
    enumerator_111573.gotoNextObject () ;
  }
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_115805 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_115805.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_115805.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2939)) COMMA_SOURCE_FILE_AT_LINE (2939)), enumerator_115805.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2939)) COMMA_SOURCE_FILE_AT_LINE (2939)) COMMA_SOURCE_FILE_AT_LINE (2939)) ;
    }
    enumerator_115805.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_116787 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_116787.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_116787.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2956)) COMMA_SOURCE_FILE_AT_LINE (2956)), enumerator_116787.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2956)) COMMA_SOURCE_FILE_AT_LINE (2956)) COMMA_SOURCE_FILE_AT_LINE (2956)) ;
    }
    enumerator_116787.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_117648 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_117648.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addEdge (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_117648.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2972)) COMMA_SOURCE_FILE_AT_LINE (2972)), enumerator_117648.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2972)) COMMA_SOURCE_FILE_AT_LINE (2972)) COMMA_SOURCE_FILE_AT_LINE (2972)) ;
    }
    enumerator_117648.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_119214 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_119214.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_119214.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3001)) COMMA_SOURCE_FILE_AT_LINE (3001)), enumerator_119214.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3001)) COMMA_SOURCE_FILE_AT_LINE (3001)) COMMA_SOURCE_FILE_AT_LINE (3001)) ;
    }
    enumerator_119214.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_121710 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_121710.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_121710.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3045)) COMMA_SOURCE_FILE_AT_LINE (3045)), enumerator_121710.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3045)) COMMA_SOURCE_FILE_AT_LINE (3045)) COMMA_SOURCE_FILE_AT_LINE (3045)) ;
    }
    enumerator_121710.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_122568 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_122568.hasCurrentObject ()) {
    {
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_122568.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (3061)) COMMA_SOURCE_FILE_AT_LINE (3061)), enumerator_122568.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (3061)) COMMA_SOURCE_FILE_AT_LINE (3061)) COMMA_SOURCE_FILE_AT_LINE (3061)) ;
    }
    enumerator_122568.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_131653 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3233)) ;
  if (NULL != objectArray_131653) {
      macroValidSharedObject (objectArray_131653, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_131653->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3234)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_132955 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3261)) ;
  if (NULL != objectArray_132955) {
      macroValidSharedObject (objectArray_132955, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_132955->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3262)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_134227 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3288)) ;
  if (NULL != objectArray_134227) {
      macroValidSharedObject (objectArray_134227, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_134227->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3289)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_136128 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3327)) ;
  if (NULL != objectArray_136128) {
      macroValidSharedObject (objectArray_136128, cMapElement_categoryReaderMapForBuildingContext) ;
    {
    objectArray_136128->mAttribute_mCategoryReaderMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3328)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_137478 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3355)) ;
  if (NULL != objectArray_137478) {
      macroValidSharedObject (objectArray_137478, cMapElement_categoryMethodMapForBuildingContext) ;
    {
    objectArray_137478->mAttribute_mCategoryMethodMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3356)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_138790 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (3382)) ;
  if (NULL != objectArray_138790) {
      macroValidSharedObject (objectArray_138790, cMapElement_categoryModifierMapForBuildingContext) ;
    {
    objectArray_138790->mAttribute_mCategoryModifierMapForType.modifier_insertKey (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList, inCompiler COMMA_SOURCE_FILE_AT_LINE (3383)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_139629 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_139629.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_139629.current_mAttributeTypeName (HERE), enumerator_139629.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3412)) COMMA_SOURCE_FILE_AT_LINE (3409)) ;
    enumerator_139629.gotoNextObject () ;
  }
...
static void categoryMethod_listDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_140263 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_140263.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_140263.current_mAttributeTypeName (HERE), enumerator_140263.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3433)) COMMA_SOURCE_FILE_AT_LINE (3430)) ;
...
static void categoryMethod_sortedListDeclarationAST_addAssociatedElement (const cPtr_semanticDeclarationAST * inObject,
  ...
  cEnumerator_attributeInCollectionListAST enumerator_140905 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  while (enumerator_140905.hasCurrentObject ()) {
    var_structAttributeList.addAssign_operation (enumerator_140905.current_mAttributeTypeName (HERE), enumerator_140905.current_mAttributeName (HERE), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (3454)) COMMA_SOURCE_FILE_AT_LINE (3451)) ;
    enumerator_140905.gotoNextObject () ;
  }
