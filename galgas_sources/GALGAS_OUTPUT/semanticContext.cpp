...
category_method__sortedListDeclarationAST__enterType (C_Compiler & inLexique,
  ...
  if (operand_29603 != NULL) {
    ...
    ::routine_enterBaseReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("length"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (759)) ;
...
category_method__structDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_32882,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_32882 != NULL) {
    GGS_unifiedTypeMapIndex  var_cas_structTypeIndex ;
    GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_32882->mStructTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_structTypeIndex COMMA_SOURCE_FILE_AT_LINE (817)) ;
    ...
    GGS_typedAttributeList  var_cas_typedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_33309 (operand_32882->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_33309 = NULL ;
      while (((operand_33309 = enumerator_33309.nextObject ()))) {
        macroValidPointer (operand_33309) ;
        GGS_unifiedTypeMapIndex  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_33309->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (824)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_typedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_33309->mAttributeName) ;
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_33821 (operand_32882->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_33821 = NULL ;
      while (((operand_33821 = enumerator_33821.nextObject ()))) {
        macroValidPointer (operand_33821) ;
        GGS_unifiedTypeMapIndex  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_33821->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (838)) ;
        var_cas_readerMap.modifier_insertOrReplace (inLexique, operand_33821->mAttributeName, GGS_unifiedTypeMapIndexList ::constructor_emptyList (), GGS_bool (false), var_cas_attributeTypeIndex, GGS_readerQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (844)), GGS_string ("") COMMA_SOURCE_FILE_AT_LINE (839)) ;
      }
    }
...
category_method__classDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_35263,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_35263 != NULL) {
    GGS_unifiedTypeMapIndex  var_cas_uintType ;
    ...
    const GGS_bool cond_36139 = (operand_35263->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (892))).operator_isEqual (GGS_string ("")) ;
    if (cond_36139.isBuiltAndTrue ()) {
    ...
    }else if (cond_36139.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_35263->mSuperClassName, var_cas_ioSemanticContext.mTypeMap, var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (900)) ;
      GGS_typeKindEnum var_cas_typeKindEnum ;
      GGS_bool automatic_var_36531_0 ;
      GGS_unifiedTypeMapIndex  automatic_var_36531_1 ;
      GGS_typedAttributeList  automatic_var_36531_2 ;
      GGS_constructorMap  automatic_var_36531_3 ;
      GGS_enumerationDescriptorList  automatic_var_36531_4 ;
      GGS_uint  automatic_var_36531_5 ;
      GGS_unifiedTypeMapIndexList  automatic_var_36531_6 ;
      GGS_unifiedTypeMapIndexList  automatic_var_36531_7 ;
      GGS_nativeAttributeList  automatic_var_36531_8 ;
      const GGS_unifiedTypeMap  temp_36326 = var_cas_ioSemanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (902)) ;
      if (temp_36326.isBuilt ()) {
        temp_36326 (HERE)->method_searchKey (inLexique, operand_35263->mSuperClassName, automatic_var_36531_0, automatic_var_36531_1, var_cas_typeKindEnum, automatic_var_36531_2, var_cas_inheritedTypedAttributeList, automatic_var_36531_3, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, var_cas_classMethodMap, automatic_var_36531_4, automatic_var_36531_5, automatic_var_36531_6, automatic_var_36531_7, automatic_var_36531_8 COMMA_SOURCE_FILE_AT_LINE (902)) ;
      }
      const GGS_bool cond_36681 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (915))) ;
      if (cond_36681.isBuiltAndTrue ()) {
        operand_35263->mSuperClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_35263->mSuperClassName)).operator_concat (GGS_string (" should be a class type")) COMMA_SOURCE_FILE_AT_LINE (917)) ;
      }
    }
    GGS_unifiedTypeMapIndex  var_cas_classIndex ;
    GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_35263->mClassTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (921)) ;
    ...
    const GGS_bool cond_37564 = (operand_35263->mIsAbstract).operator_not () ;
    if (cond_37564.isBuiltAndTrue ()) {
      GGS_unifiedTypeMapIndexList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapIndexList ::constructor_emptyList () ;
      {
        GGS_typedAttributeList::cEnumerator enumerator_37061 (var_cas_inheritedTypedAttributeList, true) ;
        const GGS_typedAttributeList::cElement * operand_37061 = NULL ;
        while (((operand_37061 = enumerator_37061.nextObject ()))) {
          macroValidPointer (operand_37061) ;
          var_cas_constructorAttributeTypeList.addAssign_operation (operand_37061->mAttributeTypeIndex) ;
        }
      }
      {
        GGS_attributeInCollectionListAST::cEnumerator enumerator_37170 (operand_35263->mAttributeList, true) ;
        const GGS_attributeInCollectionListAST::cElement * operand_37170 = NULL ;
        while (((operand_37170 = enumerator_37170.nextObject ()))) {
          macroValidPointer (operand_37170) ;
          GGS_unifiedTypeMapIndex  var_cas_attributeTypeIndex ;
          GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_37170->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (931)) ;
          var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        }
      }
    ...
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_37619 (operand_35263->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_37619 = NULL ;
      while (((operand_37619 = enumerator_37619.nextObject ()))) {
        macroValidPointer (operand_37619) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_37708 (operand_37619->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_37708 = NULL ;
          while (((operand_37708 = enumerator_37708.nextObject ()))) {
            macroValidPointer (operand_37708) ;
            GGS_unifiedTypeMapIndex  var_cas_typeIndex ;
            GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_37708->mFormalParameterTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (946)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_37708->mFormalParameterPassingMode) ;
          }
        }
        var_cas_instanceMethodMap.modifier_insertOrReplace (inLexique, operand_37619->mMethodName, var_cas_formalArgumentList, operand_37619->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (952)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (949)) ;
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_38127 (operand_35263->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_38127 = NULL ;
      while (((operand_38127 = enumerator_38127.nextObject ()))) {
        macroValidPointer (operand_38127) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_38216 (operand_38127->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_38216 = NULL ;
          while (((operand_38216 = enumerator_38216.nextObject ()))) {
            macroValidPointer (operand_38216) ;
            GGS_unifiedTypeMapIndex  var_cas_typeIndex ;
            GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_38216->mFormalParameterTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (960)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_38216->mFormalParameterPassingMode) ;
          }
        }
        var_cas_instanceMethodMap.modifier_insertOrReplace (inLexique, operand_38127->mMethodName, var_cas_formalArgumentList, operand_38127->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (966)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (963)) ;
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_38808 (operand_35263->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_38808 = NULL ;
      while (((operand_38808 = enumerator_38808.nextObject ()))) {
        macroValidPointer (operand_38808) ;
        GGS_unifiedTypeMapIndex  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_38808->mAttributeTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (975)) ;
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_38808->mAttributeName) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_38808->mAttributeName) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_35263->mClassTypeName, (operand_35263->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (985)), var_cas_allTypedAttributeList, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (992)), GGS_enumerationDescriptorList ::constructor_emptyList (), GGS_uint (0U), GGS_unifiedTypeMapIndexList ::constructor_emptyList (), GGS_unifiedTypeMapIndexList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (981)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_39826,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_39826 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_40013 (operand_39826->mFormalParameterList, true) ;
      const GGS_formalParameterListAST::cElement * operand_40013 = NULL ;
      while (((operand_40013 = enumerator_40013.nextObject ()))) {
        macroValidPointer (operand_40013) ;
        GGS_unifiedTypeMapIndex  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_40013->mFormalParameterTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1010)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_40013->mFormalParameterPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_39826->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1014)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_40539,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_40539 != NULL) {
    GGS_unifiedTypeMapIndexList  var_cas_functionSignature = GGS_unifiedTypeMapIndexList ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_40727 (operand_40539->mFormalParameterList, true) ;
      const GGS_formalParameterListAST::cElement * operand_40727 = NULL ;
      while (((operand_40727 = enumerator_40727.nextObject ()))) {
        macroValidPointer (operand_40727) ;
        GGS_unifiedTypeMapIndex  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_40727->mFormalParameterTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1026)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapIndex  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_40539->mResultTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1031)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_40539->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1033)) ;
  }
}
...
category_method__lazyFunctionDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_lazyFunctionDeclarationAST * operand_41410,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_41410 != NULL) {
    GGS_unifiedTypeMapIndex  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_41410->mResultTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1043)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_41410->mFunctionName, GGS_unifiedTypeMapIndexList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1045)) ;
  }
}
...
category_method__listmapDeclarationAST__enterType (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_41914,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_41914 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_42221_0 ;
    GGS_unifiedTypeMapIndex  automatic_var_42221_1 ;
    GGS_typedAttributeList  automatic_var_42221_2 ;
    GGS_constructorMap  automatic_var_42221_3 ;
    GGS_readerMap  automatic_var_42221_4 ;
    GGS_modifierMap  automatic_var_42221_5 ;
    GGS_instanceMethodMap  automatic_var_42221_6 ;
    GGS_classMethodMap  automatic_var_42221_7 ;
    GGS_enumerationDescriptorList  automatic_var_42221_8 ;
    GGS_uint  automatic_var_42221_9 ;
    GGS_unifiedTypeMapIndexList  automatic_var_42221_10 ;
    GGS_unifiedTypeMapIndexList  automatic_var_42221_11 ;
    GGS_nativeAttributeList  automatic_var_42221_12 ;
    const GGS_unifiedTypeMap  temp_42118 = var_cas_ioSemanticContext.reader_mTypeMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1056)) ;
    if (temp_42118.isBuilt ()) {
      temp_42118 (HERE)->method_searchKey (inLexique, operand_41914->mAssociatedListTypeName, automatic_var_42221_0, automatic_var_42221_1, var_cas_typeKindEnum, automatic_var_42221_2, var_cas_listTypedAttributeList, automatic_var_42221_3, automatic_var_42221_4, automatic_var_42221_5, automatic_var_42221_6, automatic_var_42221_7, automatic_var_42221_8, automatic_var_42221_9, automatic_var_42221_10, automatic_var_42221_11, automatic_var_42221_12 COMMA_SOURCE_FILE_AT_LINE (1056)) ;
    }
    const GGS_bool cond_42450 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1064))) ;
    if (cond_42450.isBuiltAndTrue ()) {
      operand_41914->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_41914->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1066)) ;
    ...
    GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_41914->mAssociatedListTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1076)) ;
    GGS_unifiedTypeMapIndex  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapIndex::class_method_makeRegularIndex (inLexique, operand_41914->mListmapTypeName, var_cas_ioSemanticContext.mTypeMap, var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (1079)) ;
    GGS_unifiedTypeMapIndex  var_cas_stringTypeIndex ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_43774 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_43774 = NULL ;
      while (((operand_43774 = enumerator_43774.nextObject ()))) {
        macroValidPointer (operand_43774) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_43774->mAttributeTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapIndex  var_cas_superTypeIndex ;
    ...
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_41914->mListmapTypeName, GGS_bool (true), var_cas_superTypeIndex, GGS_typeKindEnum::constructor_mapIndexType (inLexique COMMA_SOURCE_FILE_AT_LINE (1102)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_listTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1109)), var_cas_enumeratorDescriptor, GGS_uint (0U), var_cas_addAssignOperatorDescription, GGS_unifiedTypeMapIndexList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (1098)) ;
  }
}
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_predefinedTypeAST * operand_45483,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_45483 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("root"), operand_45483->mPredefinedTypeName, operand_45483) ;
  }
}
...
category_method__stringsetPredefinedTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_stringsetPredefinedTypeAST * operand_45804,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_45804 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enumerable"), operand_45804->mPredefinedTypeName, operand_45804) ;
  }
}
...
category_method__genericTypeTypeAST__enterOrderedDeclaration (C_Compiler &,
                                const cPtr_genericTypeTypeAST * operand_46123,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_46123 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_46123->mSuperTypeName, operand_46123->mTypeName, operand_46123) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_classDeclarationAST * operand_46435,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_46435 != NULL) {
    const GGS_string var_cas_actualSuperTypeName = (((operand_46435->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1168))).operator_isEqual (GGS_string (""))).isBuiltAndTrue () ? (GGS_string ("class")) : (operand_46435->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1168)))) ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (var_cas_actualSuperTypeName, operand_46435->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1169)), operand_46435) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listDeclarationAST * operand_46887,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_46887 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("list"), operand_46887->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1177)), operand_46887) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_structDeclarationAST * operand_47205,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_47205 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("struct"), operand_47205->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1185)), operand_47205) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_enumDeclarationAST * operand_47525,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_47525 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("enum"), operand_47525->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1193)), operand_47525) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_47847,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_47847 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("sortedlist"), operand_47847->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1201)), operand_47847) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_listmapDeclarationAST * operand_48178,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_48178 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_48178->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1209)), operand_48178->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1209)), operand_48178) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapDeclarationAST * operand_48522,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_48522 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string ("map"), operand_48522->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1217)), operand_48522) ;
  }
}
...
category_method__mapindexDeclarationAST__enterOrderedDeclaration (C_Compiler & inLexique,
                                const cPtr_mapindexDeclarationAST * operand_48840,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_48840 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_48840->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1225)), operand_48840->mMapIndexTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1225)), operand_48840) ;
  }
}
...
void routine_buildSemanticContext (C_Compiler & inLexique,
  ...
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_49747 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_49747 = NULL ;
    while (((operand_49747 = enumerator_49747.nextObject ()))) {
      macroValidPointer (operand_49747) ;
      const GGS_semanticDeclarationAST  temp_49788 = operand_49747->mSemanticDeclaration ;
      if (temp_49788.isBuilt ()) {
        typeCategoryMethod__semanticDeclarationAST__collectType method = findCategoryMethod__semanticDeclarationAST__collectType (temp_49788.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, temp_49788 (HERE), var_cas_collectedTypeMap COMMA_SOURCE_FILE_AT_LINE (1242)) ;
        }
      }
    }
  }
  ...
  const GGS_bool cond_50191 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_50191.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_50075 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_50075 = NULL ;
      while (((operand_50075 = enumerator_50075.nextObject ()))) {
        macroValidPointer (operand_50075) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_50075->mValue) ;
      }
    }
  ...
  }else if (cond_50191.isBuiltAndFalse ()) {
    const GGS_bool cond_50471 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_50471.isBuiltAndTrue ()) {
      ...
      {
        GGS_stringlist::cEnumerator enumerator_50357 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_50357 = NULL ;
        while (((operand_50357 = enumerator_50357.nextObject ()))) {
          macroValidPointer (operand_50357) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_50357->mValue) ;
        }
      }
  ...
  const GGS_bool cond_50971 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (1264))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_50971.isBuiltAndTrue ()) {
    {
      GGS_semanticDeclarationListAST::cEnumerator enumerator_50842 (var_cas_inSemanticDeclarationList, true) ;
      const GGS_semanticDeclarationListAST::cElement * operand_50842 = NULL ;
      while (((operand_50842 = enumerator_50842.nextObject ()))) {
        macroValidPointer (operand_50842) ;
        const GGS_semanticDeclarationAST  temp_50897 = operand_50842->mSemanticDeclaration ;
        if (temp_50897.isBuilt ()) {
          typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (temp_50897.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_50897 (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (1266)) ;
          }
        }
      }
    }
  ...
  GGS_uint _variant_51980 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
  GGS_bool _condition_51980 (_variant_51980.isBuilt (), true) ;
  while (_condition_51980.isBuiltAndTrue ()) {
    _condition_51980 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
    if (_condition_51980.isBuiltAndTrue ()) {
      if (_variant_51980.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1289)) ;
        _condition_51980 = GGS_bool (false) ;
      }else{
        _variant_51980.decrement_operation (inLexique COMMA_HERE) ;
        ...
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_51560 (var_cas_r, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_51560 = NULL ;
          while (((operand_51560 = enumerator_51560.nextObject ()))) {
            macroValidPointer (operand_51560) ;
            const GGS_bool cond_51831 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_51560->mDependanceString) ;
            if (cond_51831.isBuiltAndTrue ()) {
              var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_51560->mSemanticDeclaration) ;
              var_cas_alreadyDefinedTypes.addAssign_operation (operand_51560->mTypeString) ;
              var_cas_progress = GGS_bool (true) ;
            }else if (cond_51831.isBuiltAndFalse ()) {
              var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_51560->mDependanceString, operand_51560->mTypeString, operand_51560->mSemanticDeclaration) ;
            }
          }
        }
      }
  ...
  const GGS_bool cond_52547 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_52547.isBuiltAndTrue ()) {
    GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
    {
      GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_52259 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
      const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_52259 = enumerator_52259.nextObject () ;
      if ((operand_52259 != NULL)) {
        bool _foreach_loop_52259 ;
        do{
          macroValidPointer (operand_52259) ;
          var_cas_s.appendCString ("@") ;
          var_cas_s.dotAssign_operation (operand_52259->mTypeString) ;
          operand_52259 = enumerator_52259.nextObject () ;
          _foreach_loop_52259 = ((operand_52259 != NULL)) ;
          if (_foreach_loop_52259) {
            var_cas_s.appendCString (", ") ;
          }
        }while (_foreach_loop_52259) ;
      }
    }
    var_cas_s.appendCString (" classes; detail:") ;
    {
      GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_52422 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
      const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_52422 = NULL ;
      while (((operand_52422 = enumerator_52422.nextObject ()))) {
        macroValidPointer (operand_52422) ;
        var_cas_s.appendCString ("\n"
          "  - @") ;
        var_cas_s.dotAssign_operation (operand_52422->mTypeString) ;
        var_cas_s.appendCString (" inherits from @") ;
        var_cas_s.dotAssign_operation (operand_52422->mDependanceString) ;
      }
    }
  ...
  const GGS_bool cond_53110 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (1312))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_53110.isBuiltAndTrue ()) {
    {
      GGS_semanticDeclarationListAST::cEnumerator enumerator_52948 (var_cas_orderedSemanticDeclarationListAST, true) ;
      const GGS_semanticDeclarationListAST::cElement * operand_52948 = NULL ;
      while (((operand_52948 = enumerator_52948.nextObject ()))) {
        macroValidPointer (operand_52948) ;
        const GGS_semanticDeclarationAST  temp_52989 = operand_52948->mSemanticDeclaration ;
        if (temp_52989.isBuilt ()) {
          typeCategoryMethod__semanticDeclarationAST__enterType method = findCategoryMethod__semanticDeclarationAST__enterType (temp_52989.galgasObjectRunTimeInfo ()) ;
          if (method != NULL) {
            method (inLexique, temp_52989 (HERE), var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (1315)) ;
          }
        }
      }
    }
