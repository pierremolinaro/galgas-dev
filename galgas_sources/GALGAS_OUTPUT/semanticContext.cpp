  ...
  if (operand_65405 != NULL) {
    ...
    ::routine_commonReaderMapForAllTypes (inLexique,  var_cas_ioSemanticContext.mTypeMap,  var_cas_readerMap COMMA_SOURCE_FILE_AT_LINE (1601)) ;
    {
      ...
      while (((operand_66873 = enumerator_66873.nextObject ()))) {
        ...
        ::routine_enterBaseFinalReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  operand_66873->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1606)),  operand_66873->mAttributeTypeProxy.reader_key (inLexique COMMA_SOURCE_FILE_AT_LINE (1607)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1603)) ;
      }
    }
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1612)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1614)) ;
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_65405->mStructTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1619)), GGS_typeKindEnum::constructor_structType (inLexique COMMA_SOURCE_FILE_AT_LINE (1620)), GGS_typedAttributeList ::constructor_emptyList (), var_cas_attributeMap, var_cas_typedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1628)), GGS_enumerationDescriptorList ::constructor_emptyList (), function_generateDescriptionReaderUtilityMethod (inLexique COMMA_SOURCE_FILE_AT_LINE (1630)), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_typedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1638)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1616)) ;
  }
}
...
category_method__classDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_classDeclarationAST * operand_68142,
                                const GGS_categoryMethodMapForBuildingContext   var_cas_inCategoryMethodMapForBuildingContext,
                                const GGS_categoryReaderMapForBuildingContext   var_cas_inCategoryReaderMapForBuildingContext,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_68142 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_uintType ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("uint"), var_cas_uintType COMMA_SOURCE_FILE_AT_LINE (1651)) ;
    GGS_readerMap  var_cas_readerMap ;
    GGS_modifierMap  var_cas_modifierMap ;
    GGS_instanceMethodMap  var_cas_inheritedInstanceMethodMap ;
    GGS_typedAttributeList  var_cas_inheritedTypedAttributeList ;
    GGS_attributeMap  var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1657)) ;
    GGS_unifiedTypeMapProxy  var_cas_superClassIndex ;
    GGS_bool var_cas_generateHeaderInSeparateFile ;
    const GGS_bool cond_69359 = (operand_68142->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1661))).operator_isEqual (GGS_string ("")) ;
    if (cond_69359.isBuiltAndTrue ()) {
      var_cas_superClassIndex = GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (1662)) ;
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)) ;
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1664)) ;
      var_cas_inheritedInstanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1665)) ;
      var_cas_inheritedTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
      var_cas_attributeMap = GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1667)) ;
      var_cas_generateHeaderInSeparateFile = GGS_bool (false) ;
      {
        GGS_lstringlist::cEnumerator enumerator_69210 (operand_68142->mClassFeatureList, true) ;
        const GGS_lstringlist::cElement * operand_69210 = NULL ;
        while (((operand_69210 = enumerator_69210.nextObject ()))) {
          macroValidPointer (operand_69210) ;
          const GGS_bool cond_69329 = (operand_69210->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1670))).operator_isEqual (GGS_string ("generatedInSeparateFile")) ;
          if (cond_69329.isBuiltAndTrue ()) {
            var_cas_generateHeaderInSeparateFile = GGS_bool (true) ;
          }
        }
      }
    }else if (cond_69359.isBuiltAndFalse ()) {
      GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_68142->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1675)), var_cas_superClassIndex COMMA_SOURCE_FILE_AT_LINE (1675)) ;
      GGS_typeKindEnum var_cas_typeKindEnum ;
      GGS_readerMap  var_cas_inheritedReaderMap ;
      GGS_modifierMap  var_cas_inheritedModifierMap ;
      GGS_bool automatic_var_69889_0 ;
      GGS_unifiedTypeMapProxy  automatic_var_69889_1 ;
      GGS_typedAttributeList  automatic_var_69889_2 ;
      GGS_constructorMap  automatic_var_69889_3 ;
      GGS_classMethodMap  automatic_var_69889_4 ;
      GGS_enumerationDescriptorList  automatic_var_69889_5 ;
      GGS_uint  automatic_var_69889_6 ;
      GGS_unifiedTypeMapProxyList  automatic_var_69889_7 ;
      GGS_nativeAttributeList  automatic_var_69889_8 ;
      GGS_stringset  automatic_var_69889_9 ;
      GGS_lstringlist  automatic_var_69889_10 ;
      GGS_typedAttributeList  automatic_var_69889_11 ;
      GGS_mapSearchMethodListAST  automatic_var_69889_12 ;
      GGS_mapSearchMethodListAST  automatic_var_69889_13 ;
      GGS_withAccessorMap  automatic_var_69889_14 ;
      if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
        var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_68142->mSuperClassName, automatic_var_69889_0, automatic_var_69889_1, var_cas_typeKindEnum, var_cas_inheritedTypedAttributeList, var_cas_attributeMap, automatic_var_69889_2, automatic_var_69889_3, var_cas_inheritedReaderMap, var_cas_inheritedModifierMap, var_cas_inheritedInstanceMethodMap, automatic_var_69889_4, automatic_var_69889_5, automatic_var_69889_6, automatic_var_69889_7, automatic_var_69889_8, automatic_var_69889_9, automatic_var_69889_10, automatic_var_69889_11, automatic_var_69889_12, automatic_var_69889_13, automatic_var_69889_14, var_cas_generateHeaderInSeparateFile COMMA_SOURCE_FILE_AT_LINE (1679)) ;
      }
      const GGS_bool cond_70046 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1693))) ;
      if (cond_70046.isBuiltAndTrue ()) {
        operand_68142->mSuperClassName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the @")).operator_concat (operand_68142->mSuperClassName)).operator_concat (GGS_string (" should be a class type")) COMMA_SOURCE_FILE_AT_LINE (1695)) ;
      }
      var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1697)) ;
      {
        GGS_modifierMap::cEnumerator enumerator_70168 (var_cas_inheritedModifierMap, true) ;
        const GGS_modifierMap::cElement * operand_70168 = NULL ;
        while (((operand_70168 = enumerator_70168.nextObject ()))) {
          macroValidPointer (operand_70168) ;
          var_cas_modifierMap.modifier_insertKey (inLexique, operand_70168->mKey, operand_70168->mInfo.mParameterList, operand_70168->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1703)) COMMA_SOURCE_FILE_AT_LINE (1699)) ;
        }
      }
      var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1707)) ;
      {
        GGS_readerMap::cEnumerator enumerator_70448 (var_cas_inheritedReaderMap, true) ;
        const GGS_readerMap::cElement * operand_70448 = NULL ;
        while (((operand_70448 = enumerator_70448.nextObject ()))) {
          macroValidPointer (operand_70448) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_70448->mKey, operand_70448->mInfo.mIsCategory, operand_70448->mInfo.mArgumentTypeList, operand_70448->mInfo.mDeclarationLocation, operand_70448->mInfo.mHasCompilerArgument, operand_70448->mInfo.mReturnedType, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1716)) COMMA_SOURCE_FILE_AT_LINE (1709)) ;
        }
      }
    }
    GGS_unifiedTypeMapProxyList  var_cas_constructorAttributeTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_typedAttributeList::cEnumerator enumerator_70868 (var_cas_inheritedTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_70868 = NULL ;
      while (((operand_70868 = enumerator_70868.nextObject ()))) {
        macroValidPointer (operand_70868) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (operand_70868->mAttributeTypeProxy) ;
      }
    }
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_70971 (operand_68142->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_70971 = NULL ;
      while (((operand_70971 = enumerator_70971.nextObject ()))) {
        macroValidPointer (operand_70971) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_70971->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1727)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1727)) ;
        var_cas_constructorAttributeTypeList.addAssign_operation (var_cas_attributeTypeIndex) ;
        var_cas_attributeMap.modifier_insertKey (inLexique, operand_70971->mAttributeName, var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1729)) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_classIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_68142->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1733)), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1733)) ;
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1735)) ;
    const GGS_bool cond_71697 = (operand_68142->mIsAbstract).operator_not () ;
    if (cond_71697.isBuiltAndTrue ()) {
      var_cas_constructorMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1738)), var_cas_constructorAttributeTypeList, GGS_bool (false), var_cas_classIndex COMMA_SOURCE_FILE_AT_LINE (1737)) ;
    }
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1745)) ;
    {
      GGS_instanceMethodMap::cEnumerator enumerator_71828 (var_cas_inheritedInstanceMethodMap, true) ;
      const GGS_instanceMethodMap::cElement * operand_71828 = NULL ;
      while (((operand_71828 = enumerator_71828.nextObject ()))) {
        macroValidPointer (operand_71828) ;
        var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_71828->mKey, operand_71828->mInfo.mIsCategory, operand_71828->mInfo.mParameterList, operand_71828->mInfo.mDeclarationLocation, operand_71828->mInfo.mHasCompilerArgument, GGS_methodQualifier::constructor_isInherited (inLexique COMMA_SOURCE_FILE_AT_LINE (1753)) COMMA_SOURCE_FILE_AT_LINE (1747)) ;
      }
    }
    {
      GGS_abstractMethodDefinitionListAST::cEnumerator enumerator_72110 (operand_68142->mAbstractMethodList, true) ;
      const GGS_abstractMethodDefinitionListAST::cElement * operand_72110 = NULL ;
      while (((operand_72110 = enumerator_72110.nextObject ()))) {
        macroValidPointer (operand_72110) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_72199 (operand_72110->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_72199 = NULL ;
          while (((operand_72199 = enumerator_72199.nextObject ()))) {
            macroValidPointer (operand_72199) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_72199->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1761)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1761)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_72199->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_72480 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_72110->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1764))) ;
        if (NULL != operand_72480) {
          operand_72480->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverridingAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1765)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_72110->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_72110->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1771)), GGS_bool (true), GGS_methodQualifier::constructor_isAbstract (inLexique COMMA_SOURCE_FILE_AT_LINE (1773)) COMMA_SOURCE_FILE_AT_LINE (1767)) ;
        }
      }
    }
    {
      GGS_methodDefinitionListAST::cEnumerator enumerator_72897 (operand_68142->mMethodList, true) ;
      const GGS_methodDefinitionListAST::cElement * operand_72897 = NULL ;
      while (((operand_72897 = enumerator_72897.nextObject ()))) {
        macroValidPointer (operand_72897) ;
        GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
        {
          GGS_formalParameterListAST::cEnumerator enumerator_72986 (operand_72897->mSignature, true) ;
          const GGS_formalParameterListAST::cElement * operand_72986 = NULL ;
          while (((operand_72986 = enumerator_72986.nextObject ()))) {
            macroValidPointer (operand_72986) ;
            GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
            GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_72986->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1782)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1782)) ;
            var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_72986->mFormalArgumentPassingMode) ;
          }
        }
        elementOf_GGS_instanceMethodMap * operand_73267 = (elementOf_GGS_instanceMethodMap *) var_cas_instanceMethodMap.searchForReadWriteWithInstruction (operand_72897->mMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1785))) ;
        if (NULL != operand_73267) {
          operand_73267->mInfo.mQualifier = GGS_methodQualifier::constructor_isOverriding (inLexique COMMA_SOURCE_FILE_AT_LINE (1786)) ;
        }else{
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_72897->mMethodName, GGS_bool (false), var_cas_formalArgumentList, operand_72897->mMethodName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1792)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1794)) COMMA_SOURCE_FILE_AT_LINE (1788)) ;
        }
      }
    }
    const GGS_bool cond_74505 = var_cas_inCategoryMethodMapForBuildingContext.reader_hasKey (operand_68142->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1799))) ;
    if (cond_74505.isBuiltAndTrue ()) {
      GGS_categoryMethodMapForType  var_cas_categoryMethodMapForType ;
      if (var_cas_inCategoryMethodMapForBuildingContext.isBuilt ()) {
        var_cas_inCategoryMethodMapForBuildingContext (HERE)->method_searchKey (inLexique, operand_68142->mClassTypeName, var_cas_categoryMethodMapForType COMMA_SOURCE_FILE_AT_LINE (1801)) ;
      }
      {
        GGS_categoryMethodMapForType::cEnumerator enumerator_73924 (var_cas_categoryMethodMapForType, true) ;
        const GGS_categoryMethodMapForType::cElement * operand_73924 = NULL ;
        while (((operand_73924 = enumerator_73924.nextObject ()))) {
          macroValidPointer (operand_73924) ;
          GGS_formalParameterSignature  var_cas_formalArgumentList = GGS_formalParameterSignature ::constructor_emptyList () ;
          {
            GGS_formalParameterListAST::cEnumerator enumerator_74027 (operand_73924->mInfo.mFormalParameterList, true) ;
            const GGS_formalParameterListAST::cElement * operand_74027 = NULL ;
            while (((operand_74027 = enumerator_74027.nextObject ()))) {
              macroValidPointer (operand_74027) ;
              GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
              GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_74027->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1806)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1806)) ;
              var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex, operand_74027->mFormalArgumentPassingMode) ;
            }
          }
          var_cas_instanceMethodMap.modifier_insertKey (inLexique, operand_73924->mKey, GGS_bool (true), var_cas_formalArgumentList, operand_73924->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1813)), GGS_bool (true), GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1815)) COMMA_SOURCE_FILE_AT_LINE (1809)) ;
        }
      }
    }
    const GGS_bool cond_75559 = var_cas_inCategoryReaderMapForBuildingContext.reader_hasKey (operand_68142->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1820))) ;
    if (cond_75559.isBuiltAndTrue ()) {
      ...
      if (var_cas_inCategoryReaderMapForBuildingContext.isBuilt ()) {
        var_cas_inCategoryReaderMapForBuildingContext (HERE)->method_searchKey (inLexique, operand_68142->mClassTypeName, var_cas_categoryReaderMapForType COMMA_SOURCE_FILE_AT_LINE (1822)) ;
      }
      {
        GGS_categoryReaderMapForType::cEnumerator enumerator_74828 (var_cas_categoryReaderMapForType, true) ;
        const GGS_categoryReaderMapForType::cElement * operand_74828 = NULL ;
        while (((operand_74828 = enumerator_74828.nextObject ()))) {
          macroValidPointer (operand_74828) ;
          GGS_unifiedTypeMapProxyList  var_cas_formalArgumentList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
          {
            GGS_formalInputParameterListAST::cEnumerator enumerator_74935 (operand_74828->mInfo.mInputFormalParameterList, true) ;
            const GGS_formalInputParameterListAST::cElement * operand_74935 = NULL ;
            while (((operand_74935 = enumerator_74935.nextObject ()))) {
              macroValidPointer (operand_74935) ;
              GGS_unifiedTypeMapProxy  var_cas_typeIndex ;
              GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_74935->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1827)), var_cas_typeIndex COMMA_SOURCE_FILE_AT_LINE (1827)) ;
              var_cas_formalArgumentList.addAssign_operation (var_cas_typeIndex) ;
            }
          }
          GGS_unifiedTypeMapProxy  var_cas_returnedType ;
          GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_74828->mInfo.mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1831)), var_cas_returnedType COMMA_SOURCE_FILE_AT_LINE (1831)) ;
          var_cas_readerMap.modifier_insertKey (inLexique, operand_74828->mKey, GGS_bool (true), var_cas_formalArgumentList, operand_74828->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1836)), GGS_bool (true), var_cas_returnedType, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1839)) COMMA_SOURCE_FILE_AT_LINE (1832)) ;
        }
      }
    }
    ...
    {
      GGS_attributeInCollectionListAST::cEnumerator enumerator_75759 (operand_68142->mAttributeList, true) ;
      const GGS_attributeInCollectionListAST::cElement * operand_75759 = NULL ;
      while (((operand_75759 = enumerator_75759.nextObject ()))) {
        macroValidPointer (operand_75759) ;
        GGS_unifiedTypeMapProxy  var_cas_attributeTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_75759->mAttributeTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1848)), var_cas_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1848)) ;
        GGS_bool var_cas_hasSetter = GGS_bool (false) ;
        GGS_bool var_cas_hasGetter = GGS_bool (true) ;
        {
          GGS_lstringlist::cEnumerator enumerator_76019 (operand_75759->mFeatureList, true) ;
          const GGS_lstringlist::cElement * operand_76019 = NULL ;
          while (((operand_76019 = enumerator_76019.nextObject ()))) {
            macroValidPointer (operand_76019) ;
            const GGS_bool cond_76104 = (operand_76019->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1852))).operator_isEqual (GGS_string ("setter")) ;
            if (cond_76104.isBuiltAndTrue ()) {
              var_cas_hasSetter = GGS_bool (true) ;
            }else if (cond_76104.isBuiltAndFalse ()) {
              const GGS_bool cond_76178 = (operand_76019->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1854))).operator_isEqual (GGS_string ("nogetter")) ;
              if (cond_76178.isBuiltAndTrue ()) {
                var_cas_hasGetter = GGS_bool (false) ;
              }
            }
          }
        }
        var_cas_currentClassTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_75759->mAttributeName, var_cas_hasSetter, var_cas_hasGetter) ;
        var_cas_allTypedAttributeList.addAssign_operation (var_cas_attributeTypeIndex, operand_75759->mAttributeName, var_cas_hasSetter, var_cas_hasGetter) ;
        const GGS_bool cond_76948 = var_cas_hasGetter ;
        if (cond_76948.isBuiltAndTrue ()) {
          var_cas_readerMap.modifier_insertKey (inLexique, operand_75759->mAttributeName, GGS_bool (false), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_location (inLexique), GGS_bool (false), var_cas_attributeTypeIndex, GGS_methodQualifier::constructor_isBasic (inLexique COMMA_SOURCE_FILE_AT_LINE (1868)) COMMA_SOURCE_FILE_AT_LINE (1861)) ;
        }
      }
    }
    {
      GGS_typedAttributeList::cEnumerator enumerator_77040 (var_cas_currentClassTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_77040 = NULL ;
      while (((operand_77040 = enumerator_77040.nextObject ()))) {
        macroValidPointer (operand_77040) ;
        const GGS_bool cond_77409 = operand_77040->mHasSetter ;
        if (cond_77409.isBuiltAndTrue ()) {
          var_cas_modifierMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (GGS_string ("set")).operator_concat (operand_77040->mAttributeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1882)).reader_stringByCapitalizingFirstCharacter ()), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1882)), GGS_formalParameterSignature ::constructor_listWithValue (operand_77040->mAttributeTypeProxy, GGS_formalArgumentPassingModeAST::constructor_argumentIn (inLexique COMMA_SOURCE_FILE_AT_LINE (1883))), GGS_bool (false), GGS_methodQualifier::constructor_isBasicFinal (inLexique COMMA_SOURCE_FILE_AT_LINE (1885)) COMMA_SOURCE_FILE_AT_LINE (1881)) ;
        }
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_68142->mClassTypeName, (operand_68142->mIsAbstract).operator_not (), var_cas_superClassIndex, GGS_typeKindEnum::constructor_classType (inLexique COMMA_SOURCE_FILE_AT_LINE (1894)), var_cas_allTypedAttributeList, var_cas_attributeMap, var_cas_currentClassTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1902)), GGS_enumerationDescriptorList ::constructor_emptyList (), GGS_uint (0U), GGS_unifiedTypeMapProxyList ::constructor_emptyList (), GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), var_cas_currentClassTypedAttributeList, GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1912)), var_cas_generateHeaderInSeparateFile COMMA_SOURCE_FILE_AT_LINE (1890)) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_externRoutineDeclarationAST * operand_78333,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_78333 != NULL) {
    GGS_formalParameterSignature  var_cas_routineSignature = GGS_formalParameterSignature ::constructor_emptyList () ;
    {
      GGS_formalParameterListAST::cEnumerator enumerator_78691 (operand_78333->mFormalArgumentList, true) ;
      const GGS_formalParameterListAST::cElement * operand_78691 = NULL ;
      while (((operand_78691 = enumerator_78691.nextObject ()))) {
        macroValidPointer (operand_78691) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_78691->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1928)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1928)) ;
        var_cas_routineSignature.addAssign_operation (var_cas_parameterTypeIndex, operand_78691->mFormalArgumentPassingMode) ;
      }
    }
    var_cas_ioSemanticContext.mRoutineMap.modifier_insertKey (inLexique, operand_78333->mRoutineName, var_cas_routineSignature COMMA_SOURCE_FILE_AT_LINE (1932)) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_externFunctionDeclarationAST * operand_79237,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_79237 != NULL) {
    GGS_unifiedTypeMapProxyList  var_cas_functionSignature = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
    {
      GGS_formalInputParameterListAST::cEnumerator enumerator_79596 (operand_79237->mFormalArgumentList, true) ;
      const GGS_formalInputParameterListAST::cElement * operand_79596 = NULL ;
      while (((operand_79596 = enumerator_79596.nextObject ()))) {
        macroValidPointer (operand_79596) ;
        GGS_unifiedTypeMapProxy  var_cas_parameterTypeIndex ;
        GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_79596->mFormalArgumentTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1946)), var_cas_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1946)) ;
        var_cas_functionSignature.addAssign_operation (var_cas_parameterTypeIndex) ;
      }
    }
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_79237->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1951)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1951)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_79237->mFunctionName, var_cas_functionSignature, var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1953)) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_onceFunctionDeclarationAST * operand_80309,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_80309 != NULL) {
    GGS_unifiedTypeMapProxy  var_cas_resultTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_80309->mResultTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1965)), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1965)) ;
    var_cas_ioSemanticContext.mFunctionMap.modifier_insertKey (inLexique, operand_80309->mFunctionName, GGS_unifiedTypeMapProxyList ::constructor_emptyList (), var_cas_resultTypeIndex COMMA_SOURCE_FILE_AT_LINE (1967)) ;
  }
}
...
category_method__listmapDeclarationAST__enterInSemanticContext (C_CompilerEx & inLexique,
                                const cPtr_listmapDeclarationAST * operand_81007,
                                const GGS_categoryMethodMapForBuildingContext   /* var_cas_inCategoryMethodMapForBuildingContext */,
                                const GGS_categoryReaderMapForBuildingContext   /* var_cas_inCategoryReaderMapForBuildingContext */,
                                GGS_semanticContext & var_cas_ioSemanticContext
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_81007 != NULL) {
    GGS_typedAttributeList  var_cas_listTypedAttributeList ;
    GGS_typeKindEnum var_cas_typeKindEnum ;
    GGS_bool automatic_var_81577_0 ;
    GGS_unifiedTypeMapProxy  automatic_var_81577_1 ;
    GGS_attributeMap  automatic_var_81577_2 ;
    GGS_typedAttributeList  automatic_var_81577_3 ;
    GGS_constructorMap  automatic_var_81577_4 ;
    GGS_readerMap  automatic_var_81577_5 ;
    GGS_modifierMap  automatic_var_81577_6 ;
    GGS_instanceMethodMap  automatic_var_81577_7 ;
    GGS_classMethodMap  automatic_var_81577_8 ;
    GGS_enumerationDescriptorList  automatic_var_81577_9 ;
    GGS_uint  automatic_var_81577_10 ;
    GGS_unifiedTypeMapProxyList  automatic_var_81577_11 ;
    GGS_nativeAttributeList  automatic_var_81577_12 ;
    GGS_stringset  automatic_var_81577_13 ;
    GGS_lstringlist  automatic_var_81577_14 ;
    GGS_typedAttributeList  automatic_var_81577_15 ;
    GGS_mapSearchMethodListAST  automatic_var_81577_16 ;
    GGS_mapSearchMethodListAST  automatic_var_81577_17 ;
    GGS_withAccessorMap  automatic_var_81577_18 ;
    GGS_bool automatic_var_81577_19 ;
    if (var_cas_ioSemanticContext.mTypeMap.isBuilt ()) {
      var_cas_ioSemanticContext.mTypeMap (HERE)->method_searchKey (inLexique, operand_81007->mAssociatedListTypeName, automatic_var_81577_0, automatic_var_81577_1, var_cas_typeKindEnum, var_cas_listTypedAttributeList, automatic_var_81577_2, automatic_var_81577_3, automatic_var_81577_4, automatic_var_81577_5, automatic_var_81577_6, automatic_var_81577_7, automatic_var_81577_8, automatic_var_81577_9, automatic_var_81577_10, automatic_var_81577_11, automatic_var_81577_12, automatic_var_81577_13, automatic_var_81577_14, automatic_var_81577_15, automatic_var_81577_16, automatic_var_81577_17, automatic_var_81577_18, automatic_var_81577_19 COMMA_SOURCE_FILE_AT_LINE (1981)) ;
    }
    const GGS_bool cond_81806 = (var_cas_typeKindEnum).operator_isNotEqual (GGS_typeKindEnum::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (1988))) ;
    if (cond_81806.isBuiltAndTrue ()) {
      operand_81007->mAssociatedListTypeName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '@")).operator_concat (operand_81007->mAssociatedListTypeName)).operator_concat (GGS_string ("' type should be a list type")) COMMA_SOURCE_FILE_AT_LINE (1990)) ;
      var_cas_listTypedAttributeList = GGS_typedAttributeList ::constructor_emptyList () ;
    }
    GGS_constructorMap  var_cas_constructorMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1993)) ;
    GGS_readerMap  var_cas_readerMap = GGS_readerMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1994)) ;
    GGS_modifierMap  var_cas_modifierMap = GGS_modifierMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1995)) ;
    GGS_instanceMethodMap  var_cas_instanceMethodMap = GGS_instanceMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1996)) ;
    GGS_unifiedTypeMapProxy  var_cas_associatedListTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_81007->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1999)), var_cas_associatedListTypeIndex COMMA_SOURCE_FILE_AT_LINE (1999)) ;
    GGS_unifiedTypeMapProxy  var_cas_currentTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, operand_81007->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2002)), var_cas_currentTypeIndex COMMA_SOURCE_FILE_AT_LINE (2002)) ;
    GGS_unifiedTypeMapProxy  var_cas_stringTypeIndex ;
    GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioSemanticContext.mTypeMap, GGS_string ("string"), var_cas_stringTypeIndex COMMA_SOURCE_FILE_AT_LINE (2005)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("count"),  GGS_string ("uint"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2007)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("allKeys"),  GGS_string ("stringset"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2008)) ;
    ::routine_enterInheritedReaderWithoutArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("keyList"),  GGS_string ("stringlist"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2009)) ;
    ::routine_enterBaseReaderWithArgument (inLexique,  var_cas_readerMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("listForKey"),  GGS_string ("string"),  operand_81007->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2010)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2010)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_constructorMap,  var_cas_ioSemanticContext.mTypeMap,  GGS_string ("emptyMap"),  operand_81007->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2012)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2012)) ;
    ...
    {
      GGS_typedAttributeList::cEnumerator enumerator_83593 (var_cas_listTypedAttributeList, true) ;
      const GGS_typedAttributeList::cElement * operand_83593 = NULL ;
      while (((operand_83593 = enumerator_83593.nextObject ()))) {
        macroValidPointer (operand_83593) ;
        var_cas_addAssignOperatorDescription.addAssign_operation (operand_83593->mAttributeTypeProxy) ;
      }
    }
    var_cas_ioSemanticContext.mTypeMap.modifier_insertKey (inLexique, operand_81007->mListmapTypeName, GGS_bool (true), GGS_unifiedTypeMapProxy ::constructor_null (inLexique COMMA_SOURCE_FILE_AT_LINE (2027)), GGS_typeKindEnum::constructor_listMapType (inLexique COMMA_SOURCE_FILE_AT_LINE (2028)), GGS_typedAttributeList ::constructor_emptyList (), GGS_attributeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2030)), var_cas_listTypedAttributeList, var_cas_constructorMap, var_cas_readerMap, var_cas_modifierMap, var_cas_instanceMethodMap, GGS_classMethodMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2036)), var_cas_enumeratorDescriptor, function_doNotGenererateObjectCompare (inLexique COMMA_SOURCE_FILE_AT_LINE (2038)), var_cas_addAssignOperatorDescription, GGS_nativeAttributeList ::constructor_emptyList (), GGS_stringset ::constructor_emptySet (), GGS_lstringlist ::constructor_emptyList (), GGS_typedAttributeList ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_mapSearchMethodListAST ::constructor_emptyList (), GGS_withAccessorMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2046)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (2024)) ;
  }
}
...
category_method__predefinedTypeAST__enterOrderedDeclaration (C_CompilerEx &,
                                const cPtr_predefinedTypeAST * operand_85431,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_85431 != NULL) {
    GGS_predefinedTypeAST  var_cas_t = operand_85431 ;
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_85431->mPredefinedTypeName, operand_85431) ;
  }
}
...
category_method__classDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_classDeclarationAST * operand_85800,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_85800 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_85800->mSuperClassName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2086)), operand_85800->mClassTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2086)), operand_85800) ;
  }
}
...
category_method__listDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_listDeclarationAST * operand_86139,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_86139 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_86139->mListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2094)), operand_86139) ;
  }
}
...
category_method__structDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_structDeclarationAST * operand_86457,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_86457 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_86457->mStructTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2102)), operand_86457) ;
  }
}
...
category_method__enumDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_enumDeclarationAST * operand_86775,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_86775 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_86775->mEnumTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2110)), operand_86775) ;
  }
}
...
category_method__sortedListDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_sortedListDeclarationAST * operand_87097,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_87097 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_87097->mSortedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2118)), operand_87097) ;
  }
}
...
category_method__listmapDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_listmapDeclarationAST * operand_87422,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_87422 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_87422->mAssociatedListTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2126)), operand_87422->mListmapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2126)), operand_87422) ;
  }
}
...
category_method__mapDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_mapDeclarationAST * operand_87770,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_87770 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), operand_87770->mMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2134)), operand_87770) ;
  }
}
...
category_method__mapProxyDeclarationAST__enterOrderedDeclaration (C_CompilerEx & inLexique,
                                const cPtr_mapProxyDeclarationAST * operand_88089,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_88089 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (operand_88089->mAssociatedMapTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2142)), operand_88089->mMapProxyTypeName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2142)), operand_88089) ;
  }
}
...
category_method__externFunctionDeclarationAST__enterOrderedDeclaration (C_CompilerEx &,
                                const cPtr_externFunctionDeclarationAST * operand_88448,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_88448 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_88448) ;
  }
}
...
category_method__onceFunctionDeclarationAST__enterOrderedDeclaration (C_CompilerEx &,
                                const cPtr_onceFunctionDeclarationAST * operand_88752,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_88752 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_88752) ;
  }
}
...
category_method__externRoutineDeclarationAST__enterOrderedDeclaration (C_CompilerEx &,
                                const cPtr_externRoutineDeclarationAST * operand_89057,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_89057 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_89057) ;
  }
}
...
category_method__filewrapperDeclarationAST__enterOrderedDeclaration (C_CompilerEx &,
                                const cPtr_filewrapperDeclarationAST * operand_89360,
                                GGS_partiallyOrderedSemanticDeclarationListAST  & var_cas_ioPartiallyOrderedDeclarationList
                                COMMA_UNUSED_LOCATION_ARGS) {
  if (operand_89360 != NULL) {
    var_cas_ioPartiallyOrderedDeclarationList.addAssign_operation (GGS_string (""), GGS_string (""), operand_89360) ;
  }
}
...
void routine_buildSemanticContext (C_CompilerEx & inLexique,
  ...
  #endif
  GGS_collectedTypeMap  var_cas_collectedTypeMap = GGS_collectedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2190)) ;
  GGS_categoryMethodMapForBuildingContext  var_cas_categoryMethodMapForBuildingContext = GGS_categoryMethodMapForBuildingContext ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2191)) ;
  GGS_categoryReaderMapForBuildingContext  var_cas_categoryReaderMapForBuildingContext = GGS_categoryReaderMapForBuildingContext ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2192)) ;
  {
    GGS_semanticDeclarationListAST::cEnumerator enumerator_90419 (var_cas_inSemanticDeclarationList, true) ;
    const GGS_semanticDeclarationListAST::cElement * operand_90419 = NULL ;
    while (((operand_90419 = enumerator_90419.nextObject ()))) {
      macroValidPointer (operand_90419) ;
      { typeCategoryMethod__semanticDeclarationAST__collectTypes method = findCategoryMethod__semanticDeclarationAST__collectTypes (operand_90419->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
        if (method != NULL) {
          method (inLexique, operand_90419->mSemanticDeclaration (HERE), var_cas_collectedTypeMap, var_cas_categoryMethodMapForBuildingContext, var_cas_categoryReaderMapForBuildingContext COMMA_SOURCE_FILE_AT_LINE (2194)) ;
        }
      }
    }
  }
  GGS_stringlist  var_cas_undefinedClasses = var_cas_collectedTypeMap.reader_unsolvedProxyKeyList (inLexique COMMA_SOURCE_FILE_AT_LINE (2201)) ;
  const GGS_bool cond_90978 = (var_cas_undefinedClasses.reader_length ()).operator_isEqual (GGS_uint (1U)) ;
  if (cond_90978.isBuiltAndTrue ()) {
    GGS_string var_cas_errorMessage = GGS_string ("there is 1 undefined type:") ;
    {
      GGS_stringlist::cEnumerator enumerator_90841 (var_cas_undefinedClasses, true) ;
      const GGS_stringlist::cElement * operand_90841 = NULL ;
      while (((operand_90841 = enumerator_90841.nextObject ()))) {
        macroValidPointer (operand_90841) ;
        var_cas_errorMessage.appendCString ("\n"
          "-  @") ;
        var_cas_errorMessage.dotAssign_operation (operand_90841->mValue) ;
      }
    }
    var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (2208)) ;
    var_cas_outSemanticContext.drop () ;
  }else if (cond_90978.isBuiltAndFalse ()) {
    const GGS_bool cond_91280 = (var_cas_undefinedClasses.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
    if (cond_91280.isBuiltAndTrue ()) {
      GGS_string var_cas_errorMessage = ((GGS_string ("there are ")).operator_concat (var_cas_undefinedClasses.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (2209)))).operator_concat (GGS_string (" undefined types:")) ;
      {
        GGS_stringlist::cEnumerator enumerator_91144 (var_cas_undefinedClasses, true) ;
        const GGS_stringlist::cElement * operand_91144 = NULL ;
        while (((operand_91144 = enumerator_91144.nextObject ()))) {
          macroValidPointer (operand_91144) ;
          var_cas_errorMessage.appendCString ("\n"
            "-  @") ;
          var_cas_errorMessage.dotAssign_operation (operand_91144->mValue) ;
        }
      }
      var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_errorMessage COMMA_SOURCE_FILE_AT_LINE (2214)) ;
      var_cas_outSemanticContext.drop () ;
    }else if (cond_91280.isBuiltAndFalse ()) {
      ...
      {
        GGS_semanticDeclarationListAST::cEnumerator enumerator_91643 (var_cas_inSemanticDeclarationList, true) ;
        const GGS_semanticDeclarationListAST::cElement * operand_91643 = NULL ;
        while (((operand_91643 = enumerator_91643.nextObject ()))) {
          macroValidPointer (operand_91643) ;
          { typeCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration method = findCategoryMethod__semanticDeclarationAST__enterOrderedDeclaration (operand_91643->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
            if (method != NULL) {
              method (inLexique, operand_91643->mSemanticDeclaration (HERE), var_cas_partiallyOrderedSemanticDeclarationListAST COMMA_SOURCE_FILE_AT_LINE (2221)) ;
            }
          }
        }
      }
      ...
      GGS_uint _variant_92757 = var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length () ;
      GGS_bool _condition_92757 (_variant_92757.isBuilt (), true) ;
      while (_condition_92757.isBuiltAndTrue ()) {
        _condition_92757 = ((var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_progress) ;
        if (_condition_92757.isBuiltAndTrue ()) {
          if (_variant_92757.uintValue () == 0) {
            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (2242)) ;
            _condition_92757 = GGS_bool (false) ;
          }else{
            _variant_92757.decrement_operation (inLexique COMMA_HERE) ;
            ...
            {
              GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_92372 (var_cas_r, true) ;
              const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_92372 = NULL ;
              while (((operand_92372 = enumerator_92372.nextObject ()))) {
                macroValidPointer (operand_92372) ;
                const GGS_bool cond_92600 = var_cas_alreadyDefinedTypes.reader_hasKey (operand_92372->mDependanceString) ;
                if (cond_92600.isBuiltAndTrue ()) {
                  var_cas_orderedSemanticDeclarationListAST.addAssign_operation (operand_92372->mSemanticDeclaration) ;
                  var_cas_alreadyDefinedTypes.addAssign_operation (operand_92372->mTypeString) ;
                  var_cas_progress = GGS_bool (true) ;
                }else if (cond_92600.isBuiltAndFalse ()) {
                  var_cas_partiallyOrderedSemanticDeclarationListAST.addAssign_operation (operand_92372->mDependanceString, operand_92372->mTypeString, operand_92372->mSemanticDeclaration) ;
                }
              }
            }
          }
      ...
      const GGS_bool cond_93597 = (var_cas_partiallyOrderedSemanticDeclarationListAST.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_93597.isBuiltAndTrue ()) {
        GGS_string var_cas_s = GGS_string ("inheritance circularities involving the ") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_93256 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_93256 = enumerator_93256.nextObject () ;
          if ((operand_93256 != NULL)) {
            bool _foreach_loop_93256 ;
            do{
              macroValidPointer (operand_93256) ;
              var_cas_s.appendCString ("@") ;
              var_cas_s.dotAssign_operation (operand_93256->mTypeString) ;
              operand_93256 = enumerator_93256.nextObject () ;
              _foreach_loop_93256 = ((operand_93256 != NULL)) ;
              if (_foreach_loop_93256) {
                var_cas_s.appendCString (", ") ;
              }
            }while (_foreach_loop_93256) ;
          }
        }
        var_cas_s.appendCString (" classes; detail:") ;
        {
          GGS_partiallyOrderedSemanticDeclarationListAST::cEnumerator enumerator_93429 (var_cas_partiallyOrderedSemanticDeclarationListAST, true) ;
          const GGS_partiallyOrderedSemanticDeclarationListAST::cElement * operand_93429 = NULL ;
          while (((operand_93429 = enumerator_93429.nextObject ()))) {
            macroValidPointer (operand_93429) ;
            var_cas_s.appendCString ("\n"
              "  - @") ;
            var_cas_s.dotAssign_operation (operand_93429->mTypeString) ;
            var_cas_s.appendCString (" inherits from @") ;
            var_cas_s.dotAssign_operation (operand_93429->mDependanceString) ;
          }
        }
        var_cas_inEndOfSourceFile.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (2261)) ;
        var_cas_outSemanticContext.drop () ;
      }else if (cond_93597.isBuiltAndFalse ()) {
        var_cas_outSemanticContext = GGS_semanticContext::constructor_new (var_cas_inSourceFile, GGS_unifiedTypeMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2265)), GGS_routineMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2266)), GGS_functionMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2267)), GGS_filewrapperMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2268)), GGS_grammarMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2269)), GGS_optionComponentMapForSemanticAnalysis ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (2270))) ;
        {
          GGS_semanticDeclarationListAST::cEnumerator enumerator_94035 (var_cas_orderedSemanticDeclarationListAST, true) ;
          const GGS_semanticDeclarationListAST::cElement * operand_94035 = NULL ;
          while (((operand_94035 = enumerator_94035.nextObject ()))) {
            macroValidPointer (operand_94035) ;
            { typeCategoryMethod__semanticDeclarationAST__enterInSemanticContext method = findCategoryMethod__semanticDeclarationAST__enterInSemanticContext (operand_94035->mSemanticDeclaration.galgasObjectRunTimeInfo ()) ;
              if (method != NULL) {
                method (inLexique, operand_94035->mSemanticDeclaration (HERE), var_cas_categoryMethodMapForBuildingContext, var_cas_categoryReaderMapForBuildingContext, var_cas_outSemanticContext COMMA_SOURCE_FILE_AT_LINE (2274)) ;
              }
            }
          }
        }
