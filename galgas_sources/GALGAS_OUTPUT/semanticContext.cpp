...
void routine_addCategories (const GALGAS_categoryMethodMapForBuildingContext constinArgument_inCategoryMethodMapForBuildingContext,
  ...
  if (kBoolTrue == test_0) {
    ...
    cEnumerator_categoryMethodMapForType enumerator_17873 (var_categoryMethodMapForType, kEnumeration_up) ;
    ...
    while (enumerator_17873.hasCurrentObject ()) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_17976 (enumerator_17873.current_mFormalParameterList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_17976.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        { //-------- @typeMethodInstructionForGeneration
        GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_17976.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (457)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (457)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @addAssignInstructionForGeneration
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_17976.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (458)) ;
        enumerator_17976.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      ioArgument_ioInstanceMethodMap.modifier_insertKey (enumerator_17873.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE_AT_LINE (462)), var_formalArgumentList, enumerator_17873.current_lkey (HERE).reader_location (SOURCE_FILE_AT_LINE (464)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (466)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (460)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    //-------- END @methodCallInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_categoryReaderMapForType enumerator_18813 (var_categoryReaderMapForType, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_18813.hasCurrentObject ()) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalInputParameterListAST enumerator_18920 (enumerator_18813.current_mInputFormalParameterList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_18920.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        { //-------- @typeMethodInstructionForGeneration
        GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_18920.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (479)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (479)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @addAssignInstructionForGeneration
      ...
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_18813.current_mResultTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (483)), var_returnedType COMMA_SOURCE_FILE_AT_LINE (483)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      ioArgument_ioReaderMap.modifier_insertKey (enumerator_18813.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE_AT_LINE (486)), var_formalArgumentList, enumerator_18813.current_lkey (HERE).reader_location (SOURCE_FILE_AT_LINE (488)), GALGAS_bool (true), var_returnedType, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (491)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (484)) ;
      } //-------- END @typeMethodInstructionForGeneration
  ...
  if (kBoolTrue == test_2) {
    ...
    //-------- END @methodCallInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_categoryModifierMapForType enumerator_19917 (var_categoryModifierMapForType, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_19917.hasCurrentObject ()) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_formalParameterListAST enumerator_20020 (enumerator_19917.current_mFormalParameterList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_20020.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_unifiedTypeMapProxy var_typeIndex ;
        { //-------- @typeMethodInstructionForGeneration
        GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_20020.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (504)), var_typeIndex COMMA_SOURCE_FILE_AT_LINE (504)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @addAssignInstructionForGeneration
        var_formalArgumentList.addAssign_operation (var_typeIndex, enumerator_20020.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (505)) ;
        enumerator_20020.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      ioArgument_ioModifierMap.modifier_insertKey (enumerator_19917.current_lkey (HERE), GALGAS_methodKind::constructor_definedAsCategory (SOURCE_FILE_AT_LINE (509)), var_formalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (512)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (507)) ;
      } //-------- END @typeMethodInstructionForGeneration
...
void routine_recursivelyEnumerateDirectories (const GALGAS_string constinArgument_inAbsoluteSourcePath,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_61703 (var_files, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_61703.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = constinArgument_inTextFileExtensionMap.reader_hasKey (enumerator_61703.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1510)) COMMA_SOURCE_FILE_AT_LINE (1510)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1511)).operator_concat (enumerator_61703.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1511)) ;
      { //-------- @modifierCallInstructionForGeneration
      outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_61703.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1513)), var_absoluteFilePath, GALGAS_bool (true), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1512)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @incrementInstructionForGeneration
      ioArgument_ioWrapperFileIndex.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1519)) ;
    }else if (kBoolFalse == test_0) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = constinArgument_inBinaryFileExtensionMap.reader_hasKey (enumerator_61703.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (1520)) COMMA_SOURCE_FILE_AT_LINE (1520)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_absoluteFilePath = constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1521)).operator_concat (enumerator_61703.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1521)) ;
        { //-------- @modifierCallInstructionForGeneration
        outArgument_outWrapperFileMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_61703.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1523)), var_absoluteFilePath, GALGAS_bool (false), var_currentDirectoryIndex, ioArgument_ioWrapperFileIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1522)) ;
        } //-------- END @typeMethodInstructionForGeneration
        //-------- @incrementInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_62668 (var_directories, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_62668.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    ...
    { //-------- @routineCallInstructionForGeneration
    routine_recursivelyEnumerateDirectories (constinArgument_inAbsoluteSourcePath.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1540)).operator_concat (enumerator_62668.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1540)), constinArgument_inPathInWrapper.operator_concat (enumerator_62668.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1541)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1541)), constinArgument_inTextFileExtensionMap, constinArgument_inBinaryFileExtensionMap, var_internalWrapperFileMap, var_internalWrapperDirectoryMap, ioArgument_ioWrapperFileIndex, ioArgument_ioWrapperDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1539)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outWrapperDirectoryMap.modifier_insertKey (GALGAS_lstring::constructor_new (enumerator_62668.current_mValue (HERE), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1550)), var_internalWrapperFileMap, var_internalWrapperDirectoryMap, var_theDirectoryIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1549)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_62668.gotoNextObject () ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_string constinArgument_inSourceFile,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_semanticDeclarationListAST enumerator_119478 (constinArgument_inSemanticDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_119478.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_enterDeclarationInGraph ((const cPtr_semanticDeclarationAST *) enumerator_119478.current_mSemanticDeclaration (HERE).ptr (), var_semanticTypePrecedenceGraph, var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, var_categoryOverrideDefinitionList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2855)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_119478.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_0) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_119898 (var_semanticTypePrecedenceGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (2864)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_119898.hasCurrentObject ()) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_119898.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_119898.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2865)) COMMA_SOURCE_FILE_AT_LINE (2865)).operator_concat (GALGAS_string ("' type is not defined") COMMA_SOURCE_FILE_AT_LINE (2865)) COMMA_SOURCE_FILE_AT_LINE (2865)) ;
      enumerator_119898.gotoNextObject () ;
    }
    //-------- @errorInstructionForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_lstringlist joker_120381_0 ; // Joker input parameter
    var_semanticTypePrecedenceGraph.method_topologicalSort (var_sortedSemanticDeclarationListAST, joker_120381_0, var_unsortedSemanticDeclarationListAST, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (2872)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    ...
    if (kBoolTrue == test_2) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_120925 (var_unsortedSemanticDeclarationListAST, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_120925.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-  ").operator_concat (callCategoryReader_keyRepresentation ((const cPtr_semanticDeclarationAST *) enumerator_120925.current_mSemanticDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2886)) COMMA_SOURCE_FILE_AT_LINE (2886)) COMMA_SOURCE_FILE_AT_LINE (2886)) ;
        enumerator_120925.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_semanticDeclarationListAST enumerator_121623 (var_sortedSemanticDeclarationListAST, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_121623.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_enterInSemanticContext ((const cPtr_semanticDeclarationAST *) enumerator_121623.current_mSemanticDeclaration (HERE).ptr (), var_categoryMethodMapForBuildingContext, var_categoryReaderMapForBuildingContext, var_categoryModifierMapForBuildingContext, outArgument_outSemanticContext, inCompiler COMMA_SOURCE_FILE_AT_LINE (2904)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_121623.gotoNextObject () ;
      }
    }
  }
}
...
static void categoryMethod_mapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_32194 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_32194.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_32194.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (761)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (761)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_32194.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (764)) ;
    //-------- @addAssignInstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_32194.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (765)) COMMA_SOURCE_FILE_AT_LINE (765)) ;
    //-------- @addAssignInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_insertMethodListAST enumerator_32880 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_32880.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_32880.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (771)) COMMA_SOURCE_FILE_AT_LINE (771)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_32880.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_32880.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (772)) COMMA_SOURCE_FILE_AT_LINE (772)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (772)) COMMA_SOURCE_FILE_AT_LINE (772)) ;
    }else if (kBoolFalse == test_0) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertOrReplace (enumerator_32880.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (776)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (779)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (774)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_32880.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_mapRemoveMethodListAST enumerator_33354 (object->mAttribute_mRemoveMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_33354.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_modifierMap.reader_hasKey (enumerator_33354.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (786)) COMMA_SOURCE_FILE_AT_LINE (786)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (enumerator_33354.current_mMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the '").operator_concat (enumerator_33354.current_mMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (787)) COMMA_SOURCE_FILE_AT_LINE (787)).operator_concat (GALGAS_string ("' method is already declared as an insert modifier or a remove modifier") COMMA_SOURCE_FILE_AT_LINE (787)) COMMA_SOURCE_FILE_AT_LINE (787)) ;
    }else if (kBoolFalse == test_2) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertOrReplace (enumerator_33354.current_mMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (791)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (794)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (789)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_33354.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_mapSearchMethodListAST enumerator_33881 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_33881.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_instanceMethodMap.modifier_insertKey (enumerator_33881.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (803)), var_removeMethodFormalArgumentList, enumerator_33881.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (805)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (807)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (801)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_33881.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_34216 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_34216.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_34216.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (813)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (813)), enumerator_34216.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (813)) COMMA_SOURCE_FILE_AT_LINE (813)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_34216.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (815)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (815)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_35355 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_35355.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_35355.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (842)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (842)) COMMA_SOURCE_FILE_AT_LINE (842)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (842)), enumerator_35355.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (842)) COMMA_SOURCE_FILE_AT_LINE (842)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_35355.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (844)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (844)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_mapSearchMethodListAST enumerator_36373 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_36373.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_withAccessorMap.modifier_insertKey (enumerator_36373.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (861)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
static void categoryMethod_uniqueMapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_40584 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_40584.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_40584.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (953)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (953)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_40584.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (956)) ;
    //-------- @addAssignInstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_40584.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (957)) COMMA_SOURCE_FILE_AT_LINE (957)) ;
    //-------- @addAssignInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_insertMethodListAST enumerator_41270 (object->mAttribute_mInsertMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_41270.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_modifierMap.reader_hasKey (enumerator_41270.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (963)) COMMA_SOURCE_FILE_AT_LINE (963)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_41270.current_mInsertMethodName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_41270.current_mInsertMethodName (HERE).reader_string (SOURCE_FILE_AT_LINE (964)) COMMA_SOURCE_FILE_AT_LINE (964)).operator_concat (GALGAS_string ("' insert method is already declared") COMMA_SOURCE_FILE_AT_LINE (964)) COMMA_SOURCE_FILE_AT_LINE (964)) ;
    }else if (kBoolFalse == test_0) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertOrReplace (enumerator_41270.current_mInsertMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (968)), var_insertMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (971)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (966)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_41270.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_2) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_mapSearchMethodListAST enumerator_41844 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_41844.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_instanceMethodMap.modifier_insertKey (enumerator_41844.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (981)), var_removeMethodFormalArgumentList, enumerator_41844.current_mSearchMethodName (HERE).reader_location (SOURCE_FILE_AT_LINE (983)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (985)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (979)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_41844.gotoNextObject () ;
    }
  }else if (kBoolFalse == test_2) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_mapSearchMethodListAST enumerator_42174 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_42174.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (enumerator_42174.current_mSearchMethodName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (993)), var_removeMethodFormalArgumentList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (996)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (991)) ;
      } //-------- END @typeMethodInstructionForGeneration
  ...
  if (kBoolTrue == test_3) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_mapOverrideBlockListAST enumerator_43924 (object->mAttribute_mMapOverrideBlockListAST, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_43924.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("openOverrideFor").operator_concat (enumerator_43924.current_mOverrideBlockName (HERE).mAttribute_string.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1040)) COMMA_SOURCE_FILE_AT_LINE (1040)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1040)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1041)), GALGAS_formalParameterSignature::constructor_emptyList (SOURCE_FILE_AT_LINE (1042)), GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1044)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1039)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_43924.gotoNextObject () ;
    }
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_44333 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_44333.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (enumerator_44333.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1051)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1051)), enumerator_44333.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1051)) COMMA_SOURCE_FILE_AT_LINE (1051)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_44333.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1053)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1053)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    ...
    enumerator_44333.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_44982 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_44982.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_accessorName = GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_44982.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1067)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (1067)) COMMA_SOURCE_FILE_AT_LINE (1067)).operator_concat (GALGAS_string ("ForKey") COMMA_SOURCE_FILE_AT_LINE (1067)), enumerator_44982.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1067)) COMMA_SOURCE_FILE_AT_LINE (1067)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_44982.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1069)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1069)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_mapSearchMethodListAST enumerator_46000 (object->mAttribute_mSearchMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_46000.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_withAccessorMap.modifier_insertKey (enumerator_46000.current_mSearchMethodName (HERE), var_lstringTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1086)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_46000.gotoNextObject () ;
  }
  { //-------- @routineCallInstructionForGeneration
...
static void categoryMethod_mapProxyDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_47827_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_47827_1 ; // Joker input parameter
  GALGAS_typedAttributeList joker_47853_2 ; // Joker input parameter
  GALGAS_attributeMap joker_47853_1 ; // Joker input parameter
  GALGAS_constructorMap joker_47889_11 ; // Joker input parameter
  GALGAS_readerMap joker_47889_10 ; // Joker input parameter
  GALGAS_modifierMap joker_47889_9 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_47889_8 ; // Joker input parameter
  GALGAS_classMethodMap joker_47889_7 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_47889_6 ; // Joker input parameter
  GALGAS_stringlist joker_47889_5 ; // Joker input parameter
  GALGAS_uint joker_47889_4 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_47889_3 ; // Joker input parameter
  GALGAS_stringset joker_47889_2 ; // Joker input parameter
  GALGAS_lstringlist joker_47889_1 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_47919_3 ; // Joker input parameter
  GALGAS_withAccessorMap joker_47919_2 ; // Joker input parameter
  GALGAS_bool joker_47919_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedMapTypeName, joker_47827_2, joker_47827_1, var_typeKindEnum, joker_47853_2, joker_47853_1, var_mapTypedAttributeList, joker_47889_11, joker_47889_10, joker_47889_9, joker_47889_8, joker_47889_7, joker_47889_6, joker_47889_5, joker_47889_4, joker_47889_3, joker_47889_2, joker_47889_1, var_searchMethodList, joker_47919_3, joker_47919_2, joker_47919_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1142)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_mapSearchMethodListAST enumerator_49958 (var_searchMethodList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_49958.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_constructorMap.modifier_insertKey (enumerator_49958.current_mSearchMethodName (HERE), var_constructorAttributeTypeList, GALGAS_bool (true), var_mapProxyTypeProxy, inCompiler COMMA_SOURCE_FILE_AT_LINE (1191)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_50929 (var_mapTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_50929.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_inheritedReaderMap.reader_hasKey (enumerator_50929.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1208)) COMMA_SOURCE_FILE_AT_LINE (1208)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string::makeEmptyString () ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringset enumerator_51072 (var_inheritedReaderMap.reader_allKeys (SOURCE_FILE_AT_LINE (1210)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_51072.hasCurrentObject ()) {
        //-------- @appendInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_51072.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (1211)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1211)) COMMA_SOURCE_FILE_AT_LINE (1211)) ;
        if (enumerator_51072.hasNextObject ()) {
          //-------- @appendInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (1212)) ;
        }
        enumerator_51072.gotoNextObject () ;
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (enumerator_50929.current_mAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_50929.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1219)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1220)), inCompiler->here (), GALGAS_bool (true), enumerator_50929.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1224)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1217)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_50929.gotoNextObject () ;
  }
  { //-------- @routineCallInstructionForGeneration
...
static void categoryMethod_graphDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_unifiedTypeMapProxyList enumerator_56014 (var_associatedListTypeProxy.reader_mAddAssignOperatorArguments (inCompiler COMMA_SOURCE_FILE_AT_LINE (1345)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_56014.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_formalParameterList.addAssign_operation (enumerator_56014.current_mType (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (1346)) COMMA_SOURCE_FILE_AT_LINE (1346)) ;
    enumerator_56014.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_graphInsertModifierList enumerator_56143 (object->mAttribute_mInsertModifierList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_56143.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_modifierMap.modifier_insertOrReplace (enumerator_56143.current_mInsertModifierName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1351)), var_formalParameterList, GALGAS_bool (true), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1354)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1349)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
static void categoryMethod_enumDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_59293 (object->mAttribute_mConstantList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_59293.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_constantSet.addAssign_operation (enumerator_59293.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1439)) COMMA_SOURCE_FILE_AT_LINE (1439)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_enterConstructorWithoutArgument (var_constructorMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59293.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1440)), object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (1440)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1440)) ;
    } //-------- @routineCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_enumMessageListAST enumerator_59621 (object->mAttribute_mEnumMessageList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_59621.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_enterBaseReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_59621.current_mEnumMessageName (HERE).reader_string (SOURCE_FILE_AT_LINE (1446)), GALGAS_string ("string"), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1446)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_59621.gotoNextObject () ;
  }
  { //-------- @routineCallInstructionForGeneration
...
static void categoryMethod_filewrapperDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_filewrapperTemplateListAST enumerator_63902 (object->mAttribute_mFilewrapperTemplateList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_63902.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_formalTemplateInputParameterListAST enumerator_64020 (enumerator_63902.current_mFilewrapperTemplateFormalInputParameters (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_64020.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_64020.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1572)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1572)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @addAssignInstructionForGeneration
      var_templateSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (1573)) ;
      enumerator_64020.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_filewrapperTemplateMap.modifier_insertKey (enumerator_63902.current_mFilewrapperTemplateName (HERE), var_templateSignature, enumerator_63902.current_mFilewrapperTemplatePath (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1575)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_64555 (object->mAttribute_mFilewrapperTextFileExtensionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_64555.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_textExtensionMap.modifier_insertKey (enumerator_64555.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1584)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_64555.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_64761 (object->mAttribute_mFilewrapperBinaryFileExtensionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_64761.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_textExtensionMap.reader_hasKey (enumerator_64761.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1589)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_64761.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_64761.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1590)) COMMA_SOURCE_FILE_AT_LINE (1590)).operator_concat (GALGAS_string ("' extension is already used for text files") COMMA_SOURCE_FILE_AT_LINE (1590)) COMMA_SOURCE_FILE_AT_LINE (1590)) ;
    }else if (kBoolFalse == test_0) {
      { //-------- @modifierCallInstructionForGeneration
      var_binaryFileExtensionMap.modifier_insertKey (enumerator_64761.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1592)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_64761.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
...
static void categoryMethod_listDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_66771 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_66771.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_66771.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1646)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1646)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_66771.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1649)) ;
    enumerator_66771.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_67770 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_67770.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (enumerator_67770.current_mAttributeTypeProxy (HERE), enumerator_67770.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1663)) COMMA_SOURCE_FILE_AT_LINE (1663)) ;
    //-------- @addAssignInstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (enumerator_67770.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (1664)) ;
    //-------- @addAssignInstructionForGeneration
    var_modifierOutputFormalArgumentList.addAssign_operation (enumerator_67770.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentOut (SOURCE_FILE_AT_LINE (1665)) COMMA_SOURCE_FILE_AT_LINE (1665)) ;
    //-------- @addAssignInstructionForGeneration
    var_modifierInputFormalArgumentList.addAssign_operation (enumerator_67770.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1666)) COMMA_SOURCE_FILE_AT_LINE (1666)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_68940 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_68940.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_readerMap.modifier_insertOrReplace (GALGAS_lstring::constructor_new (enumerator_68940.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1684)).operator_concat (GALGAS_string ("AtIndex") COMMA_SOURCE_FILE_AT_LINE (1684)), enumerator_68940.current_mAttributeName (HERE).reader_location (SOURCE_FILE_AT_LINE (1684)) COMMA_SOURCE_FILE_AT_LINE (1684)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (1685)), GALGAS_unifiedTypeMapProxyList::constructor_listWithValue (var_uintType COMMA_SOURCE_FILE_AT_LINE (1686)), inCompiler->here (), GALGAS_bool (true), enumerator_68940.current_mAttributeTypeProxy (HERE), GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (1690)), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1683)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_70001 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_70001.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @addAssignInstructionForGeneration
    var_setterFormalArgumentList.addAssign_operation (enumerator_70001.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentConstantIn (SOURCE_FILE_AT_LINE (1722)) COMMA_SOURCE_FILE_AT_LINE (1722)) ;
    //-------- @addAssignInstructionForGeneration
...
static void categoryMethod_sortedListDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_73386 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_73386.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_73386.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1815)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1815)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (true) ;
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_73386.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1818)) ;
    //-------- @addAssignInstructionForGeneration
    var_enumerationDescriptor.addAssign_operation (var_attributeTypeIndex, enumerator_73386.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1819)) COMMA_SOURCE_FILE_AT_LINE (1819)) ;
    //-------- @addAssignInstructionForGeneration
    ...
    enumerator_73386.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_structDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_77632 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_77632.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_77632.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1934)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (1934)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    ...
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @addAssignInstructionForGeneration
    var_typedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_77632.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (1938)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_attributeMap.modifier_insertKey (enumerator_77632.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (1939)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_78370 (var_typedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_78370.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_enterBaseFinalReaderWithoutArgument (var_readerMap, ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_78370.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1956)), enumerator_78370.current_mAttributeTypeProxy (HERE).reader_key (inCompiler COMMA_SOURCE_FILE_AT_LINE (1957)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1953)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_78370.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_classDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_81145 (object->mAttribute_mClassFeatureList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_81145.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_81145.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2032)).objectCompare (GALGAS_string ("generatedInSeparateFile"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @assignmentInstructionForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_81638_2 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxy joker_81638_1 ; // Joker input parameter
    GALGAS_typedAttributeList joker_81723_2 ; // Joker input parameter
    GALGAS_constructorMap joker_81723_1 ; // Joker input parameter
    GALGAS_classMethodMap joker_81814_10 ; // Joker input parameter
    GALGAS_enumerationDescriptorList joker_81814_9 ; // Joker input parameter
    GALGAS_stringlist joker_81814_8 ; // Joker input parameter
    GALGAS_uint joker_81814_7 ; // Joker input parameter
    GALGAS_unifiedTypeMapProxyList joker_81814_6 ; // Joker input parameter
    GALGAS_stringset joker_81814_5 ; // Joker input parameter
    GALGAS_lstringlist joker_81814_4 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_81814_3 ; // Joker input parameter
    GALGAS_mapSearchMethodListAST joker_81814_2 ; // Joker input parameter
    GALGAS_withAccessorMap joker_81814_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mSuperClassName, joker_81638_2, joker_81638_1, var_typeKindEnum, var_inheritedTypedAttributeList, var_attributeMap, joker_81723_2, joker_81723_1, var_inheritedReaderMap, var_inheritedModifierMap, var_inheritedMethodMap, joker_81814_10, joker_81814_9, joker_81814_8, joker_81814_7, joker_81814_6, joker_81814_5, joker_81814_4, joker_81814_3, joker_81814_2, joker_81814_1, var_generateHeaderInSeparateFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (2042)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_modifierMap enumerator_82139 (var_inheritedModifierMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_82139.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (enumerator_82139.current_lkey (HERE), enumerator_82139.current_mKind (HERE), enumerator_82139.current_mParameterList (HERE), enumerator_82139.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2067)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2062)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_readerMap enumerator_82465 (var_inheritedReaderMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_82465.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_82465.current_lkey (HERE), enumerator_82465.current_mKind (HERE), enumerator_82465.current_mArgumentTypeList (HERE), enumerator_82465.current_mDeclarationLocation (HERE), enumerator_82465.current_mHasCompilerArgument (HERE), enumerator_82465.current_mReturnedType (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2081)), enumerator_82465.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2074)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_82465.gotoNextObject () ;
    }
    //-------- @assignmentInstructionForGeneration
    var_instanceMethodMap = GALGAS_instanceMethodMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (2086)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_instanceMethodMap enumerator_82853 (var_inheritedMethodMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_82853.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_instanceMethodMap.modifier_insertKey (enumerator_82853.current_lkey (HERE), enumerator_82853.current_mKind (HERE), enumerator_82853.current_mParameterList (HERE), enumerator_82853.current_mDeclarationLocation (HERE), enumerator_82853.current_mHasCompilerArgument (HERE), GALGAS_methodQualifier::constructor_isInherited (SOURCE_FILE_AT_LINE (2094)), enumerator_82853.current_mErrorMessage (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (2088)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_82853.gotoNextObject () ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_83272 (var_inheritedTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_83272.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (enumerator_83272.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2102)) ;
    enumerator_83272.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_83375 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_83375.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_83375.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2106)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2106)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_constructorAttributeTypeList.addAssign_operation (var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2107)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_attributeMap.modifier_insertKey (enumerator_83375.current_mAttributeName (HERE), var_attributeTypeIndex, inCompiler COMMA_SOURCE_FILE_AT_LINE (2108)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_83375.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_84301 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_84301.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_attributeTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_84301.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2128)), var_attributeTypeIndex COMMA_SOURCE_FILE_AT_LINE (2128)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasSetter = GALGAS_bool (false) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_hasGetter = GALGAS_bool (true) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_84561 (enumerator_84301.current_mFeatureList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_84561.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_84561.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2132)).objectCompare (GALGAS_string ("setter"))).boolEnum () ;
      if (kBoolTrue == test_5) {
        //-------- @assignmentInstructionForGeneration
        var_hasSetter = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_5) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_84561.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (2134)).objectCompare (GALGAS_string ("nogetter"))).boolEnum () ;
        if (kBoolTrue == test_6) {
          //-------- @assignmentInstructionForGeneration
          var_hasGetter = GALGAS_bool (false) ;
        }
      }
      enumerator_84561.gotoNextObject () ;
    }
    //-------- @addAssignInstructionForGeneration
    var_currentClassTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_84301.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2138)) ;
    //-------- @addAssignInstructionForGeneration
    var_allTypedAttributeList.addAssign_operation (var_attributeTypeIndex, enumerator_84301.current_mAttributeName (HERE), var_hasSetter, var_hasGetter COMMA_SOURCE_FILE_AT_LINE (2139)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_7 = var_hasGetter.boolEnum () ;
    if (kBoolTrue == test_7) {
      { //-------- @modifierCallInstructionForGeneration
      var_readerMap.modifier_insertKey (enumerator_84301.current_mAttributeName (HERE), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2143)), GALGAS_unifiedTypeMapProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (2144)), inCompiler->here (), GALGAS_bool (false), var_attributeTypeIndex, GALGAS_methodQualifier::constructor_isBasic (SOURCE_FILE_AT_LINE (2148)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2141)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_84301.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_85617 (var_currentClassTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_85617.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_8 = enumerator_85617.current_mHasSetter (HERE).boolEnum () ;
    if (kBoolTrue == test_8) {
      { //-------- @modifierCallInstructionForGeneration
      var_modifierMap.modifier_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("set").operator_concat (enumerator_85617.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2163)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (2163)) COMMA_SOURCE_FILE_AT_LINE (2163)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (2163)), GALGAS_methodKind::constructor_definedAsMember (SOURCE_FILE_AT_LINE (2164)), GALGAS_formalParameterSignature::constructor_listWithValue (enumerator_85617.current_mAttributeTypeProxy (HERE), GALGAS_formalArgumentPassingModeAST::constructor_argumentIn (SOURCE_FILE_AT_LINE (2165)) COMMA_SOURCE_FILE_AT_LINE (2165)), GALGAS_bool (false), GALGAS_methodQualifier::constructor_isBasicFinal (SOURCE_FILE_AT_LINE (2167)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (2162)) ;
      } //-------- END @typeMethodInstructionForGeneration
    }
    enumerator_85617.gotoNextObject () ;
  }
  { //-------- @routineCallInstructionForGeneration
...
static void categoryMethod_externRoutineDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalParameterListAST enumerator_87656 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_87656.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_87656.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2222)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2222)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_routineSignature.addAssign_operation (var_parameterTypeIndex, enumerator_87656.current_mFormalArgumentPassingMode (HERE) COMMA_SOURCE_FILE_AT_LINE (2223)) ;
    enumerator_87656.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_externFunctionDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_formalInputParameterListAST enumerator_88651 (object->mAttribute_mFormalArgumentList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_88651.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_unifiedTypeMapProxy var_parameterTypeIndex ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_unifiedTypeMapProxy::class_method_makeRegularProxy (ioArgument_ioSemanticContext.mAttribute_mTypeMap, enumerator_88651.current_mFormalArgumentTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2241)), var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2241)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @addAssignInstructionForGeneration
    var_functionSignature.addAssign_operation (var_parameterTypeIndex COMMA_SOURCE_FILE_AT_LINE (2242)) ;
    enumerator_88651.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
...
static void categoryMethod_listmapDeclarationAST_enterInSemanticContext (const cPtr_semanticDeclarationAST * inObject,
  ...
  GALGAS_typeKindEnum var_typeKindEnum ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_90728_2 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxy joker_90728_1 ; // Joker input parameter
  GALGAS_attributeMap joker_90783_17 ; // Joker input parameter
  GALGAS_typedAttributeList joker_90783_16 ; // Joker input parameter
  GALGAS_constructorMap joker_90783_15 ; // Joker input parameter
  GALGAS_readerMap joker_90783_14 ; // Joker input parameter
  GALGAS_modifierMap joker_90783_13 ; // Joker input parameter
  GALGAS_instanceMethodMap joker_90783_12 ; // Joker input parameter
  GALGAS_classMethodMap joker_90783_11 ; // Joker input parameter
  GALGAS_enumerationDescriptorList joker_90783_10 ; // Joker input parameter
  GALGAS_stringlist joker_90783_9 ; // Joker input parameter
  GALGAS_uint joker_90783_8 ; // Joker input parameter
  GALGAS_unifiedTypeMapProxyList joker_90783_7 ; // Joker input parameter
  GALGAS_stringset joker_90783_6 ; // Joker input parameter
  GALGAS_lstringlist joker_90783_5 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_90783_4 ; // Joker input parameter
  GALGAS_mapSearchMethodListAST joker_90783_3 ; // Joker input parameter
  GALGAS_withAccessorMap joker_90783_2 ; // Joker input parameter
  GALGAS_bool joker_90783_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.mAttribute_mTypeMap.method_searchKey (object->mAttribute_mAssociatedListTypeName, joker_90728_2, joker_90728_1, var_typeKindEnum, var_listTypedAttributeList, joker_90783_17, joker_90783_16, joker_90783_15, joker_90783_14, joker_90783_13, joker_90783_12, joker_90783_11, joker_90783_10, joker_90783_9, joker_90783_8, joker_90783_7, joker_90783_6, joker_90783_5, joker_90783_4, joker_90783_3, joker_90783_2, joker_90783_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (2278)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_typedAttributeList enumerator_92807 (var_listTypedAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_92807.hasCurrentObject ()) {
    //-------- @addAssignInstructionForGeneration
    var_addAssignOperatorDescription.addAssign_operation (enumerator_92807.current_mAttributeTypeProxy (HERE) COMMA_SOURCE_FILE_AT_LINE (2318)) ;
    enumerator_92807.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
static void categoryMethod_classDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_96654 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_96654.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_96654.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2410)) COMMA_SOURCE_FILE_AT_LINE (2410)), enumerator_96654.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2410)) COMMA_SOURCE_FILE_AT_LINE (2410)) COMMA_SOURCE_FILE_AT_LINE (2410)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_96654.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_listDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_97509 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_97509.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_97509.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2426)) COMMA_SOURCE_FILE_AT_LINE (2426)), enumerator_97509.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2426)) COMMA_SOURCE_FILE_AT_LINE (2426)) COMMA_SOURCE_FILE_AT_LINE (2426)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_97509.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_structDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_98370 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_98370.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_addArc (var_key, GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_98370.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2442)) COMMA_SOURCE_FILE_AT_LINE (2442)), enumerator_98370.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2442)) COMMA_SOURCE_FILE_AT_LINE (2442)) COMMA_SOURCE_FILE_AT_LINE (2442)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_98370.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_sortedListDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_99935 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_99935.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_99935.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2471)) COMMA_SOURCE_FILE_AT_LINE (2471)), enumerator_99935.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2471)) COMMA_SOURCE_FILE_AT_LINE (2471)) COMMA_SOURCE_FILE_AT_LINE (2471)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_99935.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_mapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_101618 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_101618.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_101618.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2501)) COMMA_SOURCE_FILE_AT_LINE (2501)), enumerator_101618.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2501)) COMMA_SOURCE_FILE_AT_LINE (2501)) COMMA_SOURCE_FILE_AT_LINE (2501)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_101618.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_uniqueMapDeclarationAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeInCollectionListAST enumerator_102476 (object->mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_102476.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSemanticTypePrecedenceGraph.modifier_noteNode (GALGAS_lstring::constructor_new (GALGAS_string ("@").operator_concat (enumerator_102476.current_mAttributeTypeName (HERE).reader_string (SOURCE_FILE_AT_LINE (2517)) COMMA_SOURCE_FILE_AT_LINE (2517)), enumerator_102476.current_mAttributeTypeName (HERE).reader_location (SOURCE_FILE_AT_LINE (2517)) COMMA_SOURCE_FILE_AT_LINE (2517)) COMMA_SOURCE_FILE_AT_LINE (2517)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_102476.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryReaderMapForBuildingContext * objectArray_110859 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2676)) ;
  if (NULL != objectArray_110859) {
      macroValidSharedObject (objectArray_110859, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_110859->mAttribute_mCategoryReaderMapForType.modifier_insertOrReplace (object->mAttribute_mCategoryReaderName, object->mAttribute_mCategoryReaderReturnedTypeName, object->mAttribute_mCategoryReaderFormalInputParameterList COMMA_SOURCE_FILE_AT_LINE (2677)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryMethodMapForBuildingContext * objectArray_112166 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2704)) ;
  if (NULL != objectArray_112166) {
      macroValidSharedObject (objectArray_112166, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_112166->mAttribute_mCategoryMethodMapForType.modifier_insertOrReplace (object->mAttribute_mCategoryMethodName, object->mAttribute_mCategoryMethodFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2705)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_categoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  cMapElement_categoryModifierMapForBuildingContext * objectArray_113443 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2731)) ;
  if (NULL != objectArray_113443) {
      macroValidSharedObject (objectArray_113443, cMapElement_categoryModifierMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_113443->mAttribute_mCategoryModifierMapForType.modifier_insertOrReplace (object->mAttribute_mCategoryModifierName, object->mAttribute_mCategoryModifierFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2732)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryReaderAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryReaderMapForType', type @categoryReaderMapForType
  cMapElement_categoryReaderMapForBuildingContext * objectArray_115349 = (cMapElement_categoryReaderMapForBuildingContext *) ioArgument_ioCategoryReaderMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2770)) ;
  if (NULL != objectArray_115349) {
      macroValidSharedObject (objectArray_115349, cMapElement_categoryReaderMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_115349->mAttribute_mCategoryReaderMapForType.modifier_insertOrReplace (object->mAttribute_mAbstractCategoryReaderName, object->mAttribute_mAbstractCategoryReaderReturnedTypeName, object->mAttribute_mAbstractCategoryReaderFormalInputParameterList COMMA_SOURCE_FILE_AT_LINE (2771)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryMethodAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryMethodMapForType', type @categoryMethodMapForType
  cMapElement_categoryMethodMapForBuildingContext * objectArray_116704 = (cMapElement_categoryMethodMapForBuildingContext *) ioArgument_ioCategoryMethodMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2798)) ;
  if (NULL != objectArray_116704) {
      macroValidSharedObject (objectArray_116704, cMapElement_categoryMethodMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_116704->mAttribute_mCategoryMethodMapForType.modifier_insertOrReplace (object->mAttribute_mAbstractCategoryMethodName, object->mAttribute_mAbstractCategoryMethodFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2799)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_abstractCategoryModifierAST_enterDeclarationInGraph (const cPtr_semanticDeclarationAST * inObject,
  ...
  //-------- @readWriteWithInstructionForGeneration
  // index 1: attribute 'mCategoryModifierMapForType', type @categoryModifierMapForType
  cMapElement_categoryModifierMapForBuildingContext * objectArray_118021 = (cMapElement_categoryModifierMapForBuildingContext *) ioArgument_ioCategoryModifierMapForBuildingContext.readWriteAccessForWithInstruction_searchKey (inCompiler, object->mAttribute_mTypeName COMMA_SOURCE_FILE_AT_LINE (2825)) ;
  if (NULL != objectArray_118021) {
      macroValidSharedObject (objectArray_118021, cMapElement_categoryModifierMapForBuildingContext) ;
    { //-------- @modifierCallInstructionForGeneration
    objectArray_118021->mAttribute_mCategoryModifierMapForType.modifier_insertOrReplace (object->mAttribute_mAbstractCategoryModifierName, object->mAttribute_mAbstractCategoryModifierFormalParameterList COMMA_SOURCE_FILE_AT_LINE (2826)) ;
    } //-------- END @typeMethodInstructionForGeneration
  }
}
//---------------------------------------------------------------------------*
