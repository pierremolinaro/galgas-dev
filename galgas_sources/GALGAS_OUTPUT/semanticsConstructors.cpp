...
category_method__applicationPredefinedTypeAST__getConstructorMap (C_Compiler & inLexique,
  ...
  if (operand_7147 != NULL) {
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  var_cas_ioUnifiedTypeMap,  GGS_string ("boolOptionNameList"),  GGS_string ("string2list"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (153)) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  var_cas_ioUnifiedTypeMap,  GGS_string ("uintOptionNameList"),  GGS_string ("string2list"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (158)) ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  var_cas_ioUnifiedTypeMap,  GGS_string ("stringOptionNameList"),  GGS_string ("string2list"),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (163)) ;
