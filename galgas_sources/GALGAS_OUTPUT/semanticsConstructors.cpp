...
category_reader__lstringGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_lstringGalgasType * operand_11930
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
...
category_reader__lcharGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_lcharGalgasType * operand_12513
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
...
category_reader__lboolGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_lboolGalgasType * operand_13094
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
...
category_reader__luintGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_luintGalgasType * operand_13675
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_13675 != NULL) {
...
category_reader__lsintGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_lsintGalgasType * operand_14256
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_14256 != NULL) {
...
category_reader__luint64GalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_luint64GalgasType * operand_14845
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_14845 != NULL) {
...
category_reader__lsint64GalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_lsint64GalgasType * operand_15436
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
...
category_reader__ldoubleGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_ldoubleGalgasType * operand_16027
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_16027 != NULL) {
...
category_reader__stringsetGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_stringsetGalgasType * operand_16626
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_16626 != NULL) {
...
category_reader__binarysetGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_binarysetGalgasType * operand_19168
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
...
category_reader__typeGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_typeGalgasType * operand_19655
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_19655 != NULL) {
...
category_reader__objectGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_objectGalgasType * operand_19864
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_19864 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  }
  return var_cas_outMap ;
}
...
category_reader__dataGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_dataGalgasType * operand_20347
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_20347 != NULL) {
...
category_reader__functionGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_functionGalgasType * operand_21046
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_21046 != NULL) {
...
category_reader__classGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_classGalgasType * operand_21258
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_21258 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    GGS_ACGalgasType  var_cas_selfType = operand_21258 ;
    const GGS_bool cond_21720 = (operand_21258->mIsAbstract).operator_not () ;
    if (cond_21720.isBuiltAndTrue ()) {
      GGS_typeList  var_cas_typeList = GGS_typeList ::constructor_emptyList () ;
      {
        GGS_attributeList::cEnumerator enumerator_21517 (operand_21258->mAttributeList, true) ;
        const GGS_attributeList::cElement * operand_21517 = NULL ;
        while (((operand_21517 = enumerator_21517.nextObject ()))) {
          macroValidPointer (operand_21517) ;
          GGS_ACGalgasType  var_cas_t ;
          GGS_lstring  automatic_var_21588_0 ;
          const GGS_typeMapIndex  temp_21581 = operand_21517->mAttributeTypeIndex ;
          if (temp_21581.isBuilt ()) {
            temp_21581 (HERE)->method_searchKey (inLexique, automatic_var_21588_0, var_cas_t COMMA_SOURCE_FILE_AT_LINE (516)) ;
          }
...
category_reader__listGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_listGalgasType * operand_21865
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_21865 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("emptyList"),  operand_21865,  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (527)) ;
    GGS_typeList  var_cas_typeList = GGS_typeList ::constructor_emptyList () ;
    {
      GGS_attributeList::cEnumerator enumerator_22064 (operand_21865->mAttributeList, true) ;
      const GGS_attributeList::cElement * operand_22064 = NULL ;
      while (((operand_22064 = enumerator_22064.nextObject ()))) {
        macroValidPointer (operand_22064) ;
        GGS_ACGalgasType  var_cas_t ;
        GGS_lstring  automatic_var_22131_0 ;
        const GGS_typeMapIndex  temp_22124 = operand_22064->mAttributeTypeIndex ;
        if (temp_22124.isBuilt ()) {
          temp_22124 (HERE)->method_searchKey (inLexique, automatic_var_22131_0, var_cas_t COMMA_SOURCE_FILE_AT_LINE (531)) ;
        }
        var_cas_typeList.addAssign_operation (var_cas_t) ;
      }
    }
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("listWithValue"), GGS_location (inLexique) COMMA_HERE), var_cas_typeList, GGS_bool (false), operand_21865 COMMA_SOURCE_FILE_AT_LINE (534)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__listmapGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_listmapGalgasType * operand_22400
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_22400 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("emptyMap"),  operand_22400,  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (541)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__structGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_structGalgasType * operand_22680
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_22680 != NULL) {
    ...
    GGS_typeList  var_cas_typeList = GGS_typeList ::constructor_emptyList () ;
    {
      GGS_attributeList::cEnumerator enumerator_22808 (operand_22680->mAttributeList, true) ;
      const GGS_attributeList::cElement * operand_22808 = NULL ;
      while (((operand_22808 = enumerator_22808.nextObject ()))) {
        macroValidPointer (operand_22808) ;
        GGS_ACGalgasType  var_cas_t ;
        GGS_lstring  automatic_var_22875_0 ;
        const GGS_typeMapIndex  temp_22868 = operand_22808->mAttributeTypeIndex ;
        if (temp_22868.isBuilt ()) {
          temp_22868 (HERE)->method_searchKey (inLexique, automatic_var_22875_0, var_cas_t COMMA_SOURCE_FILE_AT_LINE (551)) ;
        }
        var_cas_typeList.addAssign_operation (var_cas_t) ;
      }
    }
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_HERE), var_cas_typeList, GGS_bool (false), operand_22680 COMMA_SOURCE_FILE_AT_LINE (554)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__sortedlistGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_sortedlistGalgasType * operand_23137
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_23137 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("emptySortedList"),  operand_23137,  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (561)) ;
    GGS_typeList  var_cas_typeList = GGS_typeList ::constructor_emptyList () ;
    {
      GGS_attributeList::cEnumerator enumerator_23342 (operand_23137->mAttributeList, true) ;
      const GGS_attributeList::cElement * operand_23342 = NULL ;
      while (((operand_23342 = enumerator_23342.nextObject ()))) {
        macroValidPointer (operand_23342) ;
        GGS_ACGalgasType  var_cas_t ;
        GGS_lstring  automatic_var_23409_0 ;
        const GGS_typeMapIndex  temp_23402 = operand_23342->mAttributeTypeIndex ;
        if (temp_23402.isBuilt ()) {
          temp_23402 (HERE)->method_searchKey (inLexique, automatic_var_23409_0, var_cas_t COMMA_SOURCE_FILE_AT_LINE (565)) ;
        }
        var_cas_typeList.addAssign_operation (var_cas_t) ;
      }
    }
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("sortedListWithValue"), GGS_location (inLexique) COMMA_HERE), var_cas_typeList, GGS_bool (false), operand_23137 COMMA_SOURCE_FILE_AT_LINE (568)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__mapType__constructorMap (C_Compiler & inLexique,
                                const cPtr_mapType * operand_23674
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_23674 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("emptyMap"),  operand_23674,  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (575)) ;
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("mapWithMapToOverride"), GGS_location (inLexique) COMMA_HERE), GGS_typeList ::constructor_listWithValue (operand_23674), GGS_bool (false), operand_23674 COMMA_SOURCE_FILE_AT_LINE (576)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__mapindexType__constructorMap (C_Compiler & inLexique,
                                const cPtr_mapindexType * operand_24067
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_24067 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("null"),  operand_24067,  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (583)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__enumType__constructorMap (C_Compiler & inLexique,
                                const cPtr_enumType * operand_24335
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_24335 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    GGS_ACGalgasType  var_cas_selfType = operand_24335 ;
    {
      GGS_enumConstructorMap::cEnumerator enumerator_24534 (operand_24335->mEnumConstructorMap, true) ;
      const GGS_enumConstructorMap::cElement * operand_24534 = NULL ;
      while (((operand_24534 = enumerator_24534.nextObject ()))) {
        macroValidPointer (operand_24534) ;
        ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  operand_24534->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (592)),  var_cas_selfType,  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (592)) ;
      }
    }
  }
  return var_cas_outMap ;
