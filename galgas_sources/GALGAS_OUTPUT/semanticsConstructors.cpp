...
const C_galgas_type_descriptor kTypeDescriptor_GGS_constructorMap ("constructorMap", false, NULL) ;
...
/* const */ GGS_bool & GGS_constructorMap::cEnumerator::_mHasLexiqueAndLocationArguments (LOCATION_ARGS) const {
...
const C_galgas_type_descriptor * GGS_constructorMap::typeDescriptor (void) const {
...
findCategoryReader__ACGalgasType__constructorMap (AC_galgasClassRunTimeInformation * inClassPtr) {
...
category_reader__locationGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_locationGalgasType * operand_5470
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_5470 != NULL) {
...
GGS_constructorMap  function_constructorMapFor_string (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    ...
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("stringWithSourceFilePath"),  GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (171)) ;
    ...
    var_cas_t.addAssign_operation (GGS_uintGalgasType ::constructor_new (inLexique COMMA_HERE)) ;
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("stringWithSequenceOfCharacters"), GGS_location (inLexique) COMMA_HERE), var_cas_t, GGS_bool (false), GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (176)) ;
    ::routine_enterConstructorWithStringArgument (inLexique,  var_cas_outMap,  GGS_string ("stringWithContentsOfFile"),  GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (177)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("stringWithCurrentDateTime"),  GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (178)) ;
    ::routine_enterConstructorWithStringArgument (inLexique,  var_cas_outMap,  GGS_string ("stringWithEnvironmentVariable"),  GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (179)) ;
    ::routine_enterConstructorWithStringArgument (inLexique,  var_cas_outMap,  GGS_string ("stringWithEnvironmentVariableOrEmpty"),  GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (180)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("CppLineComment"),  GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (181)) ;
    ::routine_enterConstructorWithStringArgument (inLexique,  var_cas_outMap,  GGS_string ("CppTitleComment"),  GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (182)) ;
    ::routine_enterConstructorWithStringArgument (inLexique,  var_cas_outMap,  GGS_string ("CppString"),  GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (183)) ;
    ::routine_enterConstructorWithCharArgument (inLexique,  var_cas_outMap,  GGS_string ("CppChar"),  GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (184)) ;
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("componentsJoinedByString"), GGS_location (inLexique) COMMA_HERE), GGS_typeList ::constructor_listWithValue (function_build_stringlist_type (inLexique COMMA_SOURCE_FILE_AT_LINE (185))), GGS_bool (false), GGS_stringGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (185)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__stringGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_stringGalgasType * operand_7376
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_7376 != NULL) {
    var_cas_outMap = function_constructorMapFor_string (inLexique COMMA_SOURCE_FILE_AT_LINE (191)) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_char (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("replacementCharacter"),  GGS_charGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (198)) ;
    ::routine_enterConstructorWithUintArgument (inLexique,  var_cas_outMap,  GGS_string ("unicodeCharacterWithUnsigned"),  GGS_charGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (199)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__charGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_charGalgasType * operand_7979
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_7979 != NULL) {
    var_cas_outMap = function_constructorMapFor_char (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__boolGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_boolGalgasType * operand_8186
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
...
GGS_constructorMap  function_constructorMapFor_uint (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("max"),  GGS_uintGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (218)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("sequenceNumber"),  GGS_uintGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (219)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("errorCount"),  GGS_uintGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (220)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("warningCount"),  GGS_uintGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (221)) ;
    ::routine_enterConstructorWith2UintArguments (inLexique,  var_cas_outMap,  GGS_string ("valueWithMask"),  GGS_uintGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (222)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__uintGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_uintGalgasType * operand_9033
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_9033 != NULL) {
    var_cas_outMap = function_constructorMapFor_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (228)) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_sint (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("max"),  GGS_sintGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (235)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("min"),  GGS_sintGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (236)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__sintGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_sintGalgasType * operand_9591
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_9591 != NULL) {
    var_cas_outMap = function_constructorMapFor_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (242)) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_uint64 (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("max"),  GGS_uint64GalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (249)) ;
    ::routine_enterConstructorWithStringArgument (inLexique,  var_cas_outMap,  GGS_string ("uint64MaskWithCompressedBitString"),  GGS_uint64GalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (250)) ;
    ::routine_enterConstructorWithStringArgument (inLexique,  var_cas_outMap,  GGS_string ("uint64WithBitString"),  GGS_uint64GalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (251)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__uint64GalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_uint64GalgasType * operand_10293
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_10293 != NULL) {
    var_cas_outMap = function_constructorMapFor_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (257)) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_sint64 (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("max"),  GGS_sint64GalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (264)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("min"),  GGS_sint64GalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (265)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__sint64GalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_sint64GalgasType * operand_10861
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_10861 != NULL) {
    var_cas_outMap = function_constructorMapFor_sint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (271)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__doubleGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_doubleGalgasType * operand_11072
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_11072 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_lstring (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    ...
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_HERE), var_cas_t, GGS_bool (false), GGS_lstringGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (287)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("retrieveAndResetTemplateString"),  GGS_lstringGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (288)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__lstringGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_lstringGalgasType * operand_11773
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_11773 != NULL) {
    var_cas_outMap = function_constructorMapFor_lstring (inLexique COMMA_SOURCE_FILE_AT_LINE (294)) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_lchar (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    ...
    var_cas_t.addAssign_operation (GGS_charGalgasType ::constructor_new (inLexique COMMA_HERE)) ;
    var_cas_t.addAssign_operation (GGS_locationGalgasType ::constructor_new (inLexique COMMA_HERE)) ;
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_HERE), var_cas_t, GGS_bool (false), GGS_lcharGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (304)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__lcharGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_lcharGalgasType * operand_12356
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_12356 != NULL) {
    var_cas_outMap = function_constructorMapFor_lchar (inLexique COMMA_SOURCE_FILE_AT_LINE (310)) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_lbool (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    ...
    var_cas_t.addAssign_operation (GGS_locationGalgasType ::constructor_new (inLexique COMMA_HERE)) ;
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_HERE), var_cas_t, GGS_bool (false), GGS_lboolGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (320)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__lboolGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_lboolGalgasType * operand_12937
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_12937 != NULL) {
    var_cas_outMap = function_constructorMapFor_lbool (inLexique COMMA_SOURCE_FILE_AT_LINE (326)) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_luint (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    ...
    var_cas_t.addAssign_operation (GGS_uintGalgasType ::constructor_new (inLexique COMMA_HERE)) ;
    var_cas_t.addAssign_operation (GGS_locationGalgasType ::constructor_new (inLexique COMMA_HERE)) ;
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_HERE), var_cas_t, GGS_bool (false), GGS_luintGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (336)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__luintGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_luintGalgasType * operand_13518
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_13518 != NULL) {
    var_cas_outMap = function_constructorMapFor_luint (inLexique COMMA_SOURCE_FILE_AT_LINE (342)) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_lsint (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    ...
    var_cas_t.addAssign_operation (GGS_locationGalgasType ::constructor_new (inLexique COMMA_HERE)) ;
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_HERE), var_cas_t, GGS_bool (false), GGS_lsintGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (352)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__lsintGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_lsintGalgasType * operand_14099
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_14099 != NULL) {
    var_cas_outMap = function_constructorMapFor_lsint (inLexique COMMA_SOURCE_FILE_AT_LINE (358)) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_luint64 (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    ...
    var_cas_t.addAssign_operation (GGS_uint64GalgasType ::constructor_new (inLexique COMMA_HERE)) ;
    var_cas_t.addAssign_operation (GGS_locationGalgasType ::constructor_new (inLexique COMMA_HERE)) ;
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_HERE), var_cas_t, GGS_bool (false), GGS_luint64GalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (368)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__luint64GalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_luint64GalgasType * operand_14688
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_14688 != NULL) {
    var_cas_outMap = function_constructorMapFor_luint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (374)) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_lsint64 (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    ...
    var_cas_t.addAssign_operation (GGS_locationGalgasType ::constructor_new (inLexique COMMA_HERE)) ;
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_HERE), var_cas_t, GGS_bool (false), GGS_lsint64GalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (384)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__lsint64GalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_lsint64GalgasType * operand_15279
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_15279 != NULL) {
    var_cas_outMap = function_constructorMapFor_lsint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (390)) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_ldouble (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    ...
    var_cas_t.addAssign_operation (GGS_locationGalgasType ::constructor_new (inLexique COMMA_HERE)) ;
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_HERE), var_cas_t, GGS_bool (false), GGS_ldoubleGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (400)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__ldoubleGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_ldoubleGalgasType * operand_15870
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_15870 != NULL) {
    var_cas_outMap = function_constructorMapFor_ldouble (inLexique COMMA_SOURCE_FILE_AT_LINE (406)) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_stringset (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("emptySet"),  GGS_stringsetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (413)) ;
    ::routine_enterConstructorWithStringArgument (inLexique,  var_cas_outMap,  GGS_string ("setWithString"),  GGS_stringsetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (414)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__stringsetGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_stringsetGalgasType * operand_16469
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_16469 != NULL) {
    var_cas_outMap = function_constructorMapFor_stringset (inLexique COMMA_SOURCE_FILE_AT_LINE (420)) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_binaryset (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithUintArgument (inLexique,  var_cas_outMap,  GGS_string ("emptySet"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (427)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("emptyBinarySet"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (428)) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("fullBinarySet"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (429)) ;
    ::routine_enterConstructorWithStringArgument (inLexique,  var_cas_outMap,  GGS_string ("binarySetWithPredicateString"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (430)) ;
    ::routine_enterConstructorWith3UintArguments (inLexique,  var_cas_outMap,  GGS_string ("binarySetWithNotEqualComparison"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (431)) ;
    ::routine_enterConstructorWith3UintArguments (inLexique,  var_cas_outMap,  GGS_string ("binarySetWithEqualComparison"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (432)) ;
    ::routine_enterConstructorWith3UintArguments (inLexique,  var_cas_outMap,  GGS_string ("binarySetWithStrictLowerComparison"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (433)) ;
    ::routine_enterConstructorWith3UintArguments (inLexique,  var_cas_outMap,  GGS_string ("binarySetWithStrictGreaterComparison"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (434)) ;
    ::routine_enterConstructorWith3UintArguments (inLexique,  var_cas_outMap,  GGS_string ("binarySetWithLowerOrEqualComparison"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (435)) ;
    ::routine_enterConstructorWith3UintArguments (inLexique,  var_cas_outMap,  GGS_string ("binarySetWithGreaterOrEqualComparison"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (436)) ;
    ::routine_enterConstructorWith2UintUint64Arguments (inLexique,  var_cas_outMap,  GGS_string ("binarySetWithEqualToConstant"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (437)) ;
    ::routine_enterConstructorWith2UintUint64Arguments (inLexique,  var_cas_outMap,  GGS_string ("binarySetWithNotEqualToConstant"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (438)) ;
    ::routine_enterConstructorWith2UintUint64Arguments (inLexique,  var_cas_outMap,  GGS_string ("binarySetWithStrictLowerThanConstant"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (439)) ;
    ::routine_enterConstructorWith2UintUint64Arguments (inLexique,  var_cas_outMap,  GGS_string ("binarySetWithStrictGreaterThanConstant"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (440)) ;
    ::routine_enterConstructorWith2UintUint64Arguments (inLexique,  var_cas_outMap,  GGS_string ("binarySetWithLowerOrEqualToConstant"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (441)) ;
    ::routine_enterConstructorWith2UintUint64Arguments (inLexique,  var_cas_outMap,  GGS_string ("binarySetWithGreaterOrEqualToConstant"),  GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (442)) ;
    GGS_typeList  var_cas_t = GGS_typeList ::constructor_emptyList () ;
    var_cas_t.addAssign_operation (GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE)) ;
    var_cas_t.addAssign_operation (GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE)) ;
    var_cas_t.addAssign_operation (GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE)) ;
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("binarySetWithITE"), GGS_location (inLexique) COMMA_HERE), var_cas_t, GGS_bool (false), GGS_binarysetGalgasType ::constructor_new (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (447)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__binarysetGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_binarysetGalgasType * operand_19011
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_19011 != NULL) {
    var_cas_outMap = function_constructorMapFor_binaryset (inLexique COMMA_SOURCE_FILE_AT_LINE (453)) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_type (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("typeList"),  function_build_typelist_type (inLexique COMMA_SOURCE_FILE_AT_LINE (460)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (460)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__typeGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_typeGalgasType * operand_19498
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_19498 != NULL) {
    var_cas_outMap = function_constructorMapFor_type (inLexique COMMA_SOURCE_FILE_AT_LINE (466)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__objectGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_objectGalgasType * operand_19707
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
...
GGS_constructorMap  function_constructorMapFor_data (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("emptyData"),  GGS_dataGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (479)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__dataGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_dataGalgasType * operand_20190
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_20190 != NULL) {
    var_cas_outMap = function_constructorMapFor_data (inLexique COMMA_SOURCE_FILE_AT_LINE (485)) ;
  }
  return var_cas_outMap ;
}
...
GGS_constructorMap  function_constructorMapFor_function (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_constructorMap  var_cas_outMap ;
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("functionList"),  function_build_functionlist_type (inLexique COMMA_SOURCE_FILE_AT_LINE (492)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (492)) ;
    ::routine_enterConstructorWithStringArgument (inLexique,  var_cas_outMap,  GGS_string ("functionWithName"),  GGS_functionGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (493)) ;
    ::routine_enterConstructorWithStringArgument (inLexique,  var_cas_outMap,  GGS_string ("isFunctionDefined"),  GGS_boolGalgasType ::constructor_new (inLexique COMMA_HERE),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (494)) ;
    #ifdef DEBUG_TRACE_ENABLED
...
category_reader__functionGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_functionGalgasType * operand_20889
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_20889 != NULL) {
    var_cas_outMap = function_constructorMapFor_function (inLexique COMMA_SOURCE_FILE_AT_LINE (500)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__classGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_classGalgasType * operand_21101
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_21101 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    GGS_ACGalgasType  var_cas_selfType = operand_21101 ;
    const GGS_bool cond_21563 = (operand_21101->mIsAbstract).operator_not () ;
    if (cond_21563.isBuiltAndTrue ()) {
      GGS_typeList  var_cas_typeList = GGS_typeList ::constructor_emptyList () ;
      {
        GGS_attributeList::cEnumerator enumerator_21360 (operand_21101->mAttributeList, true) ;
        const GGS_attributeList::cElement * operand_21360 = NULL ;
        while (((operand_21360 = enumerator_21360.nextObject ()))) {
          macroValidPointer (operand_21360) ;
          GGS_ACGalgasType  var_cas_t ;
          GGS_lstring  automatic_var_21431_0 ;
          const GGS_typeMapIndex  temp_21424 = operand_21360->mAttributeTypeIndex ;
          if (temp_21424.isBuilt ()) {
            temp_21424 (HERE)->method_searchKey (inLexique, automatic_var_21431_0, var_cas_t COMMA_SOURCE_FILE_AT_LINE (512)) ;
          }
          var_cas_typeList.addAssign_operation (var_cas_t) ;
        }
      }
      var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_HERE), var_cas_typeList, GGS_bool (false), var_cas_selfType COMMA_SOURCE_FILE_AT_LINE (515)) ;
    }
  }
  return var_cas_outMap ;
}
...
category_reader__listGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_listGalgasType * operand_21708
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_21708 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("emptyList"),  operand_21708,  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (523)) ;
    GGS_typeList  var_cas_typeList = GGS_typeList ::constructor_emptyList () ;
    {
      GGS_attributeList::cEnumerator enumerator_21907 (operand_21708->mAttributeList, true) ;
      const GGS_attributeList::cElement * operand_21907 = NULL ;
      while (((operand_21907 = enumerator_21907.nextObject ()))) {
        macroValidPointer (operand_21907) ;
        GGS_ACGalgasType  var_cas_t ;
        GGS_lstring  automatic_var_21974_0 ;
        const GGS_typeMapIndex  temp_21967 = operand_21907->mAttributeTypeIndex ;
        if (temp_21967.isBuilt ()) {
          temp_21967 (HERE)->method_searchKey (inLexique, automatic_var_21974_0, var_cas_t COMMA_SOURCE_FILE_AT_LINE (527)) ;
        }
        var_cas_typeList.addAssign_operation (var_cas_t) ;
      }
    }
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("listWithValue"), GGS_location (inLexique) COMMA_HERE), var_cas_typeList, GGS_bool (false), operand_21708 COMMA_SOURCE_FILE_AT_LINE (530)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__listmapGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_listmapGalgasType * operand_22243
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_22243 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("emptyMap"),  operand_22243,  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (537)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__structGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_structGalgasType * operand_22523
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_22523 != NULL) {
    ...
    GGS_typeList  var_cas_typeList = GGS_typeList ::constructor_emptyList () ;
    {
      GGS_attributeList::cEnumerator enumerator_22651 (operand_22523->mAttributeList, true) ;
      const GGS_attributeList::cElement * operand_22651 = NULL ;
      while (((operand_22651 = enumerator_22651.nextObject ()))) {
        macroValidPointer (operand_22651) ;
        GGS_ACGalgasType  var_cas_t ;
        GGS_lstring  automatic_var_22718_0 ;
        const GGS_typeMapIndex  temp_22711 = operand_22651->mAttributeTypeIndex ;
        if (temp_22711.isBuilt ()) {
          temp_22711 (HERE)->method_searchKey (inLexique, automatic_var_22718_0, var_cas_t COMMA_SOURCE_FILE_AT_LINE (547)) ;
        }
        var_cas_typeList.addAssign_operation (var_cas_t) ;
      }
    }
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("new"), GGS_location (inLexique) COMMA_HERE), var_cas_typeList, GGS_bool (false), operand_22523 COMMA_SOURCE_FILE_AT_LINE (550)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__sortedlistGalgasType__constructorMap (C_Compiler & inLexique,
                                const cPtr_sortedlistGalgasType * operand_22980
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_22980 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("emptySortedList"),  operand_22980,  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (557)) ;
    GGS_typeList  var_cas_typeList = GGS_typeList ::constructor_emptyList () ;
    {
      GGS_attributeList::cEnumerator enumerator_23185 (operand_22980->mAttributeList, true) ;
      const GGS_attributeList::cElement * operand_23185 = NULL ;
      while (((operand_23185 = enumerator_23185.nextObject ()))) {
        macroValidPointer (operand_23185) ;
        GGS_ACGalgasType  var_cas_t ;
        GGS_lstring  automatic_var_23252_0 ;
        const GGS_typeMapIndex  temp_23245 = operand_23185->mAttributeTypeIndex ;
        if (temp_23245.isBuilt ()) {
          temp_23245 (HERE)->method_searchKey (inLexique, automatic_var_23252_0, var_cas_t COMMA_SOURCE_FILE_AT_LINE (561)) ;
        }
        var_cas_typeList.addAssign_operation (var_cas_t) ;
      }
    }
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("sortedListWithValue"), GGS_location (inLexique) COMMA_HERE), var_cas_typeList, GGS_bool (false), operand_22980 COMMA_SOURCE_FILE_AT_LINE (564)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__mapType__constructorMap (C_Compiler & inLexique,
                                const cPtr_mapType * operand_23517
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_23517 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("emptyMap"),  operand_23517,  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (571)) ;
    var_cas_outMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("mapWithMapToOverride"), GGS_location (inLexique) COMMA_HERE), GGS_typeList ::constructor_listWithValue (operand_23517), GGS_bool (false), operand_23517 COMMA_SOURCE_FILE_AT_LINE (572)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__mapindexType__constructorMap (C_Compiler & inLexique,
                                const cPtr_mapindexType * operand_23910
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_23910 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  GGS_string ("null"),  operand_23910,  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (579)) ;
  }
  return var_cas_outMap ;
}
...
category_reader__enumType__constructorMap (C_Compiler & inLexique,
                                const cPtr_enumType * operand_24178
                                COMMA_UNUSED_LOCATION_ARGS) {
  GGS_constructorMap  var_cas_outMap ;
  if (operand_24178 != NULL) {
    var_cas_outMap = GGS_constructorMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
    GGS_ACGalgasType  var_cas_selfType = operand_24178 ;
    {
      GGS_enumConstructorMap::cEnumerator enumerator_24377 (operand_24178->mEnumConstructorMap, true) ;
      const GGS_enumConstructorMap::cElement * operand_24377 = NULL ;
      while (((operand_24377 = enumerator_24377.nextObject ()))) {
        macroValidPointer (operand_24377) ;
        ::routine_enterConstructorWithoutArgument (inLexique,  var_cas_outMap,  operand_24377->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (588)),  var_cas_selfType,  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (588)) ;
      }
    }
  }
  return var_cas_outMap ;
