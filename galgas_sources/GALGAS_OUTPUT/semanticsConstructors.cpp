...
void routine_enterConstructorWithoutArgument (C_Compiler & inLexique,
  ...
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inReturnedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (33)), var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (33)) ;
...
void routine_enterConstructorWithArgument (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapProxy  var_cas_returnedTypeIndex ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inReturnedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (53)), var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (53)) ;
  GGS_unifiedTypeMapProxy  var_cas_t ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument1TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (55)), var_cas_t COMMA_SOURCE_FILE_AT_LINE (55)) ;
...
void routine_enterConstructorWith2Arguments (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapProxy  var_cas_returnedTypeIndex ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inReturnedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (76)), var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (76)) ;
  GGS_unifiedTypeMapProxyList  var_cas_argumentTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
  GGS_unifiedTypeMapProxy  var_cas_t ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument1TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (79)), var_cas_t COMMA_SOURCE_FILE_AT_LINE (79)) ;
  var_cas_argumentTypeList.addAssign_operation (var_cas_t) ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument2TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (81)), var_cas_t COMMA_SOURCE_FILE_AT_LINE (81)) ;
  var_cas_argumentTypeList.addAssign_operation (var_cas_t) ;
...
void routine_enterConstructorWith3Arguments (C_Compiler & inLexique,
  ...
  #endif
  GGS_unifiedTypeMapProxy  var_cas_returnedTypeIndex ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inReturnedTypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (104)), var_cas_returnedTypeIndex COMMA_SOURCE_FILE_AT_LINE (104)) ;
  GGS_unifiedTypeMapProxy  var_cas_t ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument1TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (106)), var_cas_t COMMA_SOURCE_FILE_AT_LINE (106)) ;
  GGS_unifiedTypeMapProxyList  var_cas_argumentTypeList = GGS_unifiedTypeMapProxyList ::constructor_emptyList () ;
  var_cas_argumentTypeList.addAssign_operation (var_cas_t) ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument2TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (109)), var_cas_t COMMA_SOURCE_FILE_AT_LINE (109)) ;
  var_cas_argumentTypeList.addAssign_operation (var_cas_t) ;
  GGS_unifiedTypeMapProxy::class_method_makeRegularProxy (inLexique, var_cas_ioUnifiedTypeMap, GGS_lstring ::constructor_new (inLexique, var_cas_inArgument3TypeName, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (111)), var_cas_t COMMA_SOURCE_FILE_AT_LINE (111)) ;
  var_cas_argumentTypeList.addAssign_operation (var_cas_t) ;
