...
static C_MetamodelManager gMetamodelManager ("parameterArgumentMetamodel", 10) ;
...
cPtr_formalInputParameterList::
cPtr_formalInputParameterList (const GGS__list_formalInputParameter & argument_0
                                COMMA_LOCATION_ARGS) :
cPtr_entity (THERE),
mFormalInputParameterList (argument_0) {
}

//---------------------------------------------------------------------------*

bool cPtr_formalInputParameterList::
isEqualToObject (const cPtr_entity * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const cPtr_formalInputParameterList * _p = dynamic_cast <const cPtr_formalInputParameterList *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = mFormalInputParameterList._operator_isEqual (_p->mFormalInputParameterList).boolValue () ;
  }
  return equal ;
}
...
void cPtr_formalInputParameterList::
appendForDescription (C_Compiler & _inLexique,
                      C_String & ioString,
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "-> instance of @formalInputParameterList" ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mFormalInputParameterList.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
}

//---------------------------------------------------------------------------*

sint32 cPtr_formalInputParameterList::_metamodelComponentIndex (const sint32 inLevel) const {
  sint32 result = gMetamodelManager.mMetamodelComponentIndex ;
  if (inLevel > 0) {
    result = -1 ;
  }
...
const char * cPtr_formalInputParameterList::_metamodelComponentName (const sint32 inLevel) const {
  const char * result = gMetamodelManager.mMetamodelComponentName ;
  if (inLevel > 0) {
    result = NULL ;
  }
...
sint32 cPtr_formalInputParameterList::_metamodelClassID (const sint32 inLevel) const {
  sint32 result = 2 ;
  if (inLevel > 0) {
    result = -1 ;
  }
...
const char * cPtr_formalInputParameterList::_metamodelClassName (const sint32 inLevel) const {
  const char * result = "formalInputParameterList" ;
  if (inLevel > 0) {
    result = NULL ;
  }
  return result ;
...
/*cPtr_formalInputParameterList * cPtr_formalInputParameterList::
_cloneObject (void) const {
  cPtr_formalInputParameterList * _p = NULL ;
  macroMyNew (_p, cPtr_formalInputParameterList (mFormalInputParameterList COMMA_HERE)) ;
  return _p ;
} */

//---------------------------------------------------------------------------*
//                                                                           *
//                  List '@_list_formalInputParameterList'                   *
//                                                                           *
//---------------------------------------------------------------------------*

/* void GGS__list_formalInputParameterList::
_internalAppendValues (const GGS__list_formalInputParameter & argument_0) {
  cElement * nouvelElement = (cElement *) NULL ;
  macroMyNew (nouvelElement, cElement (argument_0
                                COMMA_HERE)) ;
  _internalAppendItem (nouvelElement) ;
...
/* void GGS__list_formalInputParameterList::
_internalPrependValues (const GGS__list_formalInputParameter & argument_0) {
  cElement * nouvelElement = (cElement *) NULL ;
  macroMyNew (nouvelElement, cElement (argument_0
                                COMMA_HERE)) ;
  _internalPrependItem (nouvelElement) ;
...
void GGS__list_formalInputParameterList::
_addAssign_operation (const GGS_formalInputParameterList & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
GGS__list_formalInputParameterList GGS__list_formalInputParameterList::
_operator_concat (const GGS__list_formalInputParameterList & inOperand) const {
  GGS__list_formalInputParameterList result ;
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      result = inOperand ;
    }else{
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (_p != NULL) {
      macroValidPointer (_p) ;
      _internalAppendValues (_p->mFormalInputParameterList) ;
      _p = _p->nextObject () ;
    }
  }
} */
...
GGS_string GGS__list_formalInputParameterList::
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@_list_formalInputParameterList", inIndentation COMMA_THERE) ;
}

//---------------------------------------------------------------------------*

/* void GGS__list_formalInputParameterList::
_addModel (const GGS_formalInputParameterList & inOperand) {
  if (_isBuilt () && inOperand._isBuilt ()) {
    _insulateList () ;
    _internalAppendItem (inOperand (HERE)->_cloneObject ()) ;
  }
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    outElement = GGS_formalInputParameterList::constructor_new (_inLexique,
       _p->mFormalInputParameterList) ;
  }else{
    outElement._drop_operation () ;
  }
} */
...
constructor_new (C_Compiler & /* inLexique */,
  ...
  macroMyNew (result.mPointer, cPtr_formalInputParameterList (argument_0 COMMA_THERE)) ;
  return result ;
}

//---------------------------------------------------------------------------*

GGS__list_formalInputParameter  GGS_formalInputParameterList::
reader_mFormalInputParameterList (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS__list_formalInputParameter   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_formalInputParameterList *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_formalInputParameterList *) mPointer)->mFormalInputParameterList ;
  }
  return result ;
}
...
const char * GGS_formalInputParameterList::actualTypeName (void) const {
 return "formalInputParameterList" ;
}

//---------------------------------------------------------------------------*

#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_formalInputParameterList * GGS_formalInputParameterList::operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
...
cPtr_formalInputParameter::
cPtr_formalInputParameter (const GGS_lstring & argument_0,
                                const GGS_lstring & argument_1,
...
bool cPtr_formalInputParameter::
isEqualToObject (const cPtr_entity * inOperand) const {
  bool equal = inOperand == this ;
  if (! equal) {
    const cPtr_formalInputParameter * _p = dynamic_cast <const cPtr_formalInputParameter *> (inOperand) ;
    macroValidPointer (_p) ;
...
void cPtr_formalInputParameter::
appendForDescription (C_Compiler & _inLexique,
                      C_String & ioString,
                      const sint32 inIndentation
                      COMMA_LOCATION_ARGS) const {
  ioString << "-> instance of @formalInputParameter" ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mFormalParameterTypeName.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
...
sint32 cPtr_formalInputParameter::_metamodelComponentIndex (const sint32 inLevel) const {
  sint32 result = gMetamodelManager.mMetamodelComponentIndex ;
  if (inLevel > 0) {
    result = -1 ;
  }
...
const char * cPtr_formalInputParameter::_metamodelComponentName (const sint32 inLevel) const {
  const char * result = gMetamodelManager.mMetamodelComponentName ;
  if (inLevel > 0) {
    result = NULL ;
  }
...
sint32 cPtr_formalInputParameter::_metamodelClassID (const sint32 inLevel) const {
  sint32 result = 3 ;
  if (inLevel > 0) {
    result = -1 ;
  }
...
const char * cPtr_formalInputParameter::_metamodelClassName (const sint32 inLevel) const {
  const char * result = "formalInputParameter" ;
  if (inLevel > 0) {
    result = NULL ;
  }
  return result ;
...
/*cPtr_formalInputParameter * cPtr_formalInputParameter::
_cloneObject (void) const {
  cPtr_formalInputParameter * _p = NULL ;
  macroMyNew (_p, cPtr_formalInputParameter (mFormalParameterTypeName, mFormalParameterName, mIsUnused COMMA_HERE)) ;
  return _p ;
} */

//---------------------------------------------------------------------------*
//                                                                           *
//                    List '@_list_formalInputParameter'                     *
//                                                                           *
//---------------------------------------------------------------------------*

/* void GGS__list_formalInputParameter::
...
void GGS__list_formalInputParameter::
_addAssign_operation (const GGS_formalInputParameter & inObject) {
   _insulateList () ;
   _internalAppendItem (inObject._ptr ()) ;
}
...
GGS__list_formalInputParameter GGS__list_formalInputParameter::
_operator_concat (const GGS__list_formalInputParameter & inOperand) const {
  GGS__list_formalInputParameter result ;
  if (_isBuilt () && inOperand._isBuilt ()) {
    if (count () == 0) {
      result = inOperand ;
...
GGS_string GGS__list_formalInputParameter::
reader_description (C_Compiler & _inLexique
                    COMMA_LOCATION_ARGS,
                    const sint32 inIndentation) const {
  return _description (_inLexique, "@_list_formalInputParameter", inIndentation COMMA_THERE) ;
}

//---------------------------------------------------------------------------*

/* void GGS__list_formalInputParameter::
_addModel (const GGS_formalInputParameter & inOperand) {
  if (_isBuilt () && inOperand._isBuilt ()) {
    _insulateList () ;
    _internalAppendItem (inOperand (HERE)->_cloneObject ()) ;
  }
...
method_first (C_Compiler & _inLexique,
  ...
  if (_p != NULL) {
    outElement = GGS_formalInputParameter::constructor_new (_inLexique,
       _p->mFormalParameterTypeName,
       _p->mFormalParameterName,
       _p->mIsUnused) ;
  }else{
...
GGS_formalInputParameter GGS_formalInputParameter::
constructor_new (C_Compiler & /* inLexique */,
                 const GGS_lstring & argument_0,
                 const GGS_lstring & argument_1,
                 const GGS_bool& argument_2
                                COMMA_LOCATION_ARGS) {
  GGS_formalInputParameter result ;
  macroMyNew (result.mPointer, cPtr_formalInputParameter (argument_0,
                                argument_1,
...
GGS_lstring  GGS_formalInputParameter::
reader_mFormalParameterTypeName (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_lstring   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_formalInputParameter *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_formalInputParameter *) mPointer)->mFormalParameterTypeName ;
  }
  return result ;
}
...
reader_mFormalParameterName (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  ...
  if (mPointer != NULL) {
    ...
    MF_Assert (dynamic_cast <cPtr_formalInputParameter *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_formalInputParameter *) mPointer)->mFormalParameterName ;
  }
  return result ;
}
...
GGS_bool GGS_formalInputParameter::
reader_mIsUnused (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_bool  result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_formalInputParameter *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_formalInputParameter *) mPointer)->mIsUnused ;
  }
  return result ;
}
...
const char * GGS_formalInputParameter::actualTypeName (void) const {
 return "formalInputParameter" ;
}

//---------------------------------------------------------------------------*

#ifndef DO_NOT_GENERATE_CHECKINGS
  cPtr_formalInputParameter * GGS_formalInputParameter::operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
