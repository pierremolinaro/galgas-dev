...
GGS_object GGS_formalArgumentPassingMode::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_formalArgumentPassingMode * p = NULL ;
    macroMyNew (p, GGS_formalArgumentPassingMode (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_formalArgumentPassingMode GGS_formalArgumentPassingMode::castFromObject (C_Compiler & inLexique,
  ...
  if (NULL != embeddedObject) {
    const GGS_formalArgumentPassingMode * p = dynamic_cast <const GGS_formalArgumentPassingMode *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_formalArgumentPassingMode, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
GGS_object GGS_formalParameterList::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_formalParameterList * p = NULL ;
    macroMyNew (p, GGS_formalParameterList (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_formalParameterList GGS_formalParameterList::castFromObject (C_Compiler & inLexique,
  ...
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_formalParameterList * p = dynamic_cast <const GGS_formalParameterList *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_formalParameterList, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
GGS_object GGS_formalInputParameterList::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_formalInputParameterList * p = NULL ;
    macroMyNew (p, GGS_formalInputParameterList (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_formalInputParameterList GGS_formalInputParameterList::castFromObject (C_Compiler & inLexique,
  ...
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_formalInputParameterList * p = dynamic_cast <const GGS_formalInputParameterList *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_formalInputParameterList, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_actualParameter) ;
...
GGS_object GGS_actualParameter::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_actualParameter * p = NULL ;
    macroMyNew (p, GGS_actualParameter (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_actualParameter GGS_actualParameter::castFromObject (C_Compiler & inLexique,
  ...
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_actualParameter * p = dynamic_cast <const GGS_actualParameter *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_actualParameter, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_outputActualParameter) ;
...
GGS_object GGS_outputActualParameter::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_outputActualParameter * p = NULL ;
    macroMyNew (p, GGS_outputActualParameter (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_outputActualParameter GGS_outputActualParameter::castFromObject (C_Compiler & inLexique,
  ...
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_outputActualParameter * p = dynamic_cast <const GGS_outputActualParameter *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_outputActualParameter, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_outputInputActualParameter) ;
...
GGS_object GGS_outputInputActualParameter::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_outputInputActualParameter * p = NULL ;
    macroMyNew (p, GGS_outputInputActualParameter (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_outputInputActualParameter GGS_outputInputActualParameter::castFromObject (C_Compiler & inLexique,
  ...
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_outputInputActualParameter * p = dynamic_cast <const GGS_outputInputActualParameter *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_outputInputActualParameter, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_inputActualParameter) ;
...
GGS_object GGS_inputActualParameter::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_inputActualParameter * p = NULL ;
    macroMyNew (p, GGS_inputActualParameter (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_inputActualParameter GGS_inputActualParameter::castFromObject (C_Compiler & inLexique,
  ...
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_inputActualParameter * p = dynamic_cast <const GGS_inputActualParameter *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_inputActualParameter, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_inputJokerActualParameter) ;
...
constructor_new (C_Compiler & /* inLexique */
  ...
  if (NULL == gSingleton_inputJokerActualParameter) {
    ...
    macroRetainObject (gSingleton_inputJokerActualParameter) ;
  }
  macroAssignObject (result.mPointer, gSingleton_inputJokerActualParameter) ;
  return result ;
}
...
GGS_object GGS_inputJokerActualParameter::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_inputJokerActualParameter * p = NULL ;
    macroMyNew (p, GGS_inputJokerActualParameter (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_inputJokerActualParameter GGS_inputJokerActualParameter::castFromObject (C_Compiler & inLexique,
  ...
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_inputJokerActualParameter * p = dynamic_cast <const GGS_inputJokerActualParameter *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_inputJokerActualParameter, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
GGS_object GGS_actualParameterList::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_actualParameterList * p = NULL ;
    macroMyNew (p, GGS_actualParameterList (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_actualParameterList GGS_actualParameterList::castFromObject (C_Compiler & inLexique,
  ...
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_actualParameterList * p = dynamic_cast <const GGS_actualParameterList *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_actualParameterList, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
GGS_object GGS_actualInputParameterList::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_actualInputParameterList * p = NULL ;
    macroMyNew (p, GGS_actualInputParameterList (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_actualInputParameterList GGS_actualInputParameterList::castFromObject (C_Compiler & inLexique,
  ...
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_actualInputParameterList * p = dynamic_cast <const GGS_actualInputParameterList *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_actualInputParameterList, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
static void epilogueRoutineFor_parameterArgumentMetamodel (void) {
  macroReleaseObject (gSingleton_inputJokerActualParameter) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue prologueEpilogueObjectFor_parameterArgumentMetamodel (NULL, epilogueRoutineFor_parameterArgumentMetamodel) ;
