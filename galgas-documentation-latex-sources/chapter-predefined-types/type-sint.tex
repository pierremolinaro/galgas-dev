...
An \galgas{@sint} object value is a 32-bit signed integer value. You can initialize an \galgas{@sint} object from an 32-bit signed integer constant:\\
...
{1.3.0}
{sint}
{Returns an \galgas{@sint} object that the minimum value of the 32-bit signed range.}
...
{1.3.0}
{sint}
{Returns an \galgas{@sint} object that the maximum value of the 32-bit signed range.}
...
The \galgas{@sint} type supports the five arithmetic diadic operators:\newline
...
Theses operators require both arguments to be \galgas{@sint} objects.\newline
...
This operator returns the receiver's value (an \galgas{@sint} object). A run-time error is raised if "-" operator is invoked on an object whose value is $-2^{31}$.
...
The \galgas{@sint} type supports right and left shift operators:\newline
...
Theses operators require the right argument to be \galgas{@sint} object, and the left argument to be \galgas{@uint} object.\newline
...
The \galgas{@sint} type supports the three bit-wise logical operators:\newline
...
The \galgas{@sint} type supports the bit-wise logical unary operator:\newline
...
This operator returns an \galgas{@sint} object.
...
The \galgas{@sint} type supports the six comparison operators:\newline
...
Theses operators require both arguments to be \galgas{@sint} objects, and return a \galgas{@bool} object.
