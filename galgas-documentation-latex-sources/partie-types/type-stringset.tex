...
Returns a boolean value that indicates whether the value of \emph{inString} argument is present in the set: \galgas{true} if the value of \emph{inString} argument is present in the set, \galgas{false} otherwise.
