...
La comparaison implémentée est une comparaison de références. Chaque référence est convertie en un entier non signé. La valeur \ggs=nil= est convertie en la valeur entière \ggs=0=. L'égalité entre deux références signifie qu'elles désignent le même objet. 
