...
\subsection{Option \texttt{\%location}}

À partir de la version 3.2.13, la déclaration d'une méthode de recherche peut comporter l'option \ggs=%location=, placée juste après le nom de la méthode~:
