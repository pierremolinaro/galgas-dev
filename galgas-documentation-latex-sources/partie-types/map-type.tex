...
Le \emph{getter} \galgas{hasKey} retourne un \ggs+@bool+ qui est \galgas{true} si la clé \galgas{inKey} est dans la table de premier niveau du receveur, \galgas{false} dans le cas contraire.
