...
An \ggs+@bool+ object has a boolean value. The two keywords \galgas{true} and \galgas{false} belong to the \ggs+@bool+ type, and denotes the true and false values. No constructor is defined for the \ggs+@bool+ type.
