...
An \galgas{@sint64} object value is a 64-bit signed integer value. You can initialize an \galgas{@sint64} object from an 64-bit signed integer constant:\\
...
{1.3.0}
{sint64}
{Returns an \galgas{@sint64} object that the minimum value of the 64-bit signed range.}
...
{1.3.0}
{sint64}
{Returns an \galgas{@sint64} object that the maximum value of the 64-bit signed range.}
...
The \galgas{@sint64} type supports the five arithmetic diadic operators:\newline
...
Theses operators require both arguments to be \galgas{@sint64} objects.\newline

A run-time error is raised if the operation leads to a 64-bit signed overflow.

The \galgas{@sint} type supports the following arithmetic unary operators:\newline
...
This operator returns the receiver's value (an \galgas{@sint} object). A run-time error is raised if "-" operator is invoked on an object whose value is $-2^{63}$.
...
The \galgas{@sint64} type supports right and left shift operators:\newline
...
Theses operators require the right argument to be \galgas{@sint64} object, and the left argument to be \galgas{@uint} object.\newline
...
The \galgas{@sint64} type supports the three bit-wise logical operators:\newline
...
The \galgas{@sint64} type supports the bit-wise logical unary operator:\newline
...
This operator returns an \galgas{@sint64} object.
...
The \galgas{@sint64} type supports the six comparison operators:\newline
...
Theses operators require both arguments to be \galgas{@sint64} objects, and return a \galgas{@bool} object.
