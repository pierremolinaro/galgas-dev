...
Une classe non abstraite définit implicitement le constructeur \galgas{new}, et des \emph{readers} pour lire les attributs, et des \emph{modifiers} pour les écrire. On ne peut pas définir explicitement d'autres constructeurs, \emph{readers} ou \emph{modifiers} à l'intérieur de la classe. Cependant,  les extensions (\refChapterPage{extensions}) permettent de définir \emph{readers}, \emph{méthodes} et \emph{modifiers} associés à une classe.
