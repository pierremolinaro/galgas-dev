...
\subsectionGetter{extractBytesForUnsignedRepresentation}{bigint}
...
\begin{galgas}
@uintlist a = [0G extractBytesForUnsignedRepresentation]
var s = ""
for (n) in a
  do s += [n hexString]
  between s += " "
...
\begin{galgas}
# Parcours dans le sens des indices croissants : little endian
@uintlist a = [-0x4433_2211G extractBytesForSignedRepresentation]
var s = ""
for (n) in a
  do s += [n hexString]
  between s += " "
