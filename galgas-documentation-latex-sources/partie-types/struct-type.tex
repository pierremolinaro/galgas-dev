...
%
%Le constructeur \ggs+new+ est implicitement défini pour toute structure. Ce constructeur présente un argument par propriété déclaré dans la structure instanciée, dans l'ordre de la déclaration des propriétés. Par exemple~:
%
%\begin{galgas}
%@MaStructure s = @MaStructure.new {
%  !0    # Propriété mProp1
%  !true # Propriété mProp2
%}
%\end{galgas}
%
%Dans l'exemple ci-dessus, les annotations de type apparaissent deux fois, à la déclaration de la variable et devant le constructeur \ggs=new=. L'une d'entre elles peut être omise~:
%
%\begin{galgas}
%var s = @MaStructure.new {
%  !0    # Propriété mProp1
%  !true # Propriété mProp2
%}
%\end{galgas}
