...
%  * the name of the class is the name of the \ggst+lexique+ component;
%  * this class is declared in a header file that is named the name of the \ggst+lexique+ component with the ''\textquotesingle.h\textquotesingle'' extension;
%  * this class is implemented in a file that is named the name of the \ggst+lexique+ component with the ''\textquotesingle.cpp\textquotesingle'' extension;
