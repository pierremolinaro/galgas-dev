...
By default, no modifier is provided for performing a direct write access to an attribute at a given index. You should use the «~\galgas{@feature setter}~» qualifier for enabling setter generation for a given attribute.
