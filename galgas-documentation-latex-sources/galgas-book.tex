...
\part{Le système de types}
  ...
  \input{partie-types/predefined-types.tex}
  ...
  \input{partie-types/class-type.tex}
  \input{partie-types/enum-type.tex}
  \input{partie-types/graph-type.tex}
  \input{partie-types/map-type.tex}
%  \input{partie-types/mapproxy-type.tex}
  \input{partie-types/struct-type.tex}
  \input{partie-types/extern-type.tex}
  \input{partie-types/predefined-structure-types.tex}

\part{Sous-programmes}
\input{partie-sous-programmes/sous-programmes.tex}
\input{partie-sous-programmes/fonctions.tex}
\input{partie-sous-programmes/routines.tex}
\input{partie-sous-programmes/categories.tex}
...
\input{chapter-semantic-instructions/semantic-expressions.tex}
\input{chapter-semantic-instructions/semantic-instructions.tex}
\input{chapter-semantic-instructions/syntax-instructions.tex}
