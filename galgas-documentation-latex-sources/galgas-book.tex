...
\fancyfoot[C]{GALGAS GALGASCURRENTVERSION}
...
\title{\Huge{\textbf{GALGAS Book}}\\~\\ \normalsize{For release GALGASCURRENTVERSION}}
...
\input{chapter-user-types/list-type.tex}

\input{chapter-user-types/sortedlist-type.tex}

\input{chapter-user-types/array-type.tex}

\input{chapter-user-types/class-type.tex}

\input{chapter-user-types/map-type.tex}

\input{chapter-user-types/mapproxy-type.tex}

\input{chapter-user-types/struct-type.tex}

\input{chapter-predefined-types/predefined-structure-types.tex}

\input{chapter-user-types/graph-type.tex}
...
\input{chapter-cocoa-features/chapter-cocoa-features.tex}
