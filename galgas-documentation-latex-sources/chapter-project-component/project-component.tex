...
L'option \ggs!%codeblocks-linux-mac! engendre une cible qui peut être compilée indifféremment sur Linux ou sur Mac, utilisant \texttt{Code::Blocks}\footnote{\url{http://www.codeblocks.org}}.
\begin{galgas}
project (0:0:1) -> "logo" {
  %codeblocks-linux-mac
  ...
...
La déclaration \ggs!%makefile-unix! engendre une cible qui peut être compilée indifféremment sur Linux ou sur Mac.
\begin{galgas}
project (0:0:1) -> "logo" {
  %makefile-unix
  ...
