...
Voici un exemple extrait de la section décrivant les \emph{extensions de getter} (\refSectionPage{categoryReader}) :
...
\lstset{emph={@T.constructeur, exp0, exp1}, emphstyle=\emph}
\begin{galgascode}
...
%  \rowcolors{2}{\fondTableau}{}
  ...
  2 & \galgas{==}, \galgas{\!=} & Comparaison & \refSubsectionPage{operateursComparaison}\\
