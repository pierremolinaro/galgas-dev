...
\begin{table}[t!]
  ...
  \ggst+@boolset @T+ & Équivalent au constructeur \ggst+.none+ (\refSubsectionPage{constructeurBoolsetDefault}) \\
  ...
  \ggst+enum @T+ & Voir \refSectionPage{valeurDefautTypeEnumere} \\
