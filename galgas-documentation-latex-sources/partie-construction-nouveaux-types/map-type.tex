...
map @MaTable {
  ...
  %searchMethodAndGetter searchKey %errorMessage "the '%K' key is not defined"
...
\begin{galgas4}
%searchMethodAndGetter identificateurRecherche %errorMessage "message_erreur_associe"
\end{galgas4}
