...
Tout caractère Unicode dont le point de code est compris entre \texttt{0x21} (« \texttt{!} ») et \texttt{0xFFFD}, sauf le caractère «~\texttt{\$}~», peut apparaître dans un terminal :
\begin{galgas}
 $=$, $($, $--$, $≠$
\end{galgas}
