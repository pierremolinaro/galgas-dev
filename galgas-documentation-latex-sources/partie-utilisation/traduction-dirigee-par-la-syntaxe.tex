...
La chaîne traduite est obtenue en modifiant l'instruction \galgas{grammar} (\refSectionPage{instruction-grammar}). Comme on l'a vu, celle-ci est : 
\begin{galgascode}
grammar expGrammar in inSourceFile
\end{galgascode}
