...
Prenons un exemple. On suppose que la chaîne source est : \tpp{@1@a+@2@b@3@}, les commentaires étant constitués des séquences \tpp{@...@}. Cet exemple considère des commentaires, mais il en est de même pour les séparateurs (espaces, retours à la ligne). La séquence des terminaux encontrés lors de l'analyse de cette phrase est :
...
Mentionner \ggs+s+ dans l'instruction \ggs+send+ permet de transmettre les séparateurs qui précèdent les parenthèses. Ainsi à partir de la chaîne source \tpp{(@1@a+@2@b)@3@}, on obtient \tpp{\{@1@a+@2@b\}@3@}.
