...
\optionGGS{-{-}emit-syntax-diagrams} Cette option provoquent l'émission de fichiers \LaTeX qui contiennent les diagrammes syntaxiques. Son utilisation est détaillée au \refChapterPage{chapitreDiagrammesSyntaxiques}. C'est ainsi que les diagrammes du langage GALGAS présentés au \refChapterPage{grammairesGALGAS} ont été obtenus.
