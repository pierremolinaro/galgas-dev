...
\begin{table}[t]
  ...
  \begin{tabular}{llllllll}
    \input{partie-utilisation/included-keyword-list-3.tex}
  \end{tabular}
...
\begin{table}[t]
  ...
  \begin{tabular}{lllllllllllllllll}
    \input{partie-utilisation/included-delimiter-list-3.tex}
  \end{tabular}
...
\begin{table}[t]
  ...
  \begin{tabular}{llllllllllllll}
    ...
    \emph{Pas de suffixe}  & \ggst=@uint=  & \ggst=1_234=, \ggst=0x1234_5678= \\
    \texttt{L}  & \ggst=@uint64=  & \ggst=1_234L=, \ggst=0x1234_5678L= \\
    \texttt{S}  & \ggst=@sint=  & \ggst=1_234S=, \ggst=0x1234_5678S= \\
    \texttt{LS}  & \ggst=@sint64=  & \ggst=1_234LS=, \ggst=0x1234_5678LS= \\
    \texttt{G}  & \ggst=@bigint=  & \ggst=1_234G=, \ggst=0x1234_5678G= \\
   \end{tabular}
...
\begin{table}[ht]
  \centering
  \begin{tabular}{llllllll}
    \input{partie-utilisation/included-attribute-list-3.tex}
  \end{tabular}
