...
Les séparateurs sont tous les caractères compris entre le point de code Unicode \texttt{\textquotesingle\textbackslash u0001\textquotesingle} et l’espace (point de code Unicode \texttt{\textquotesingle\textbackslash 0020\textquotesingle}), ce qui inclut la tabulation horizontale et les différentes formes de la fin de ligne.
...
Par défaut dans le fichier \texttt{logo\_syntax.galgas}, seul le non terminal \ggs+<start_symbol>+ est déclaré, et une règle de production vide est écrite.
...
Il faut modifier la méthode \ggs+codeDisplay+ de la classe \ggs+@forward+ pour ajouter la génération de code :
