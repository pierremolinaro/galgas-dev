...
{\lstset{emph={readerName, methodName, modifierName}, emphstyle=\galgasEmphStyle}
\begin{lstlisting}[language=galgas]
...
{\lstset{emph={instructions, readerName, methodName, modifierName}, emphstyle=\galgasEmphStyle}
\begin{lstlisting}[language=galgas]
