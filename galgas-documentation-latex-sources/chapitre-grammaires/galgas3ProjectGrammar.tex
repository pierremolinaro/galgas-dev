...
\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    & & & & & & & & & & & & \node (p4-12) [point] {}; & \\
    & & & & & & & \node (p3-7) [terminal] {literal\_string}; & \\
    & & & & & & & & & \node (p2-9) [point] {}; & \\
...
\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    \node (P0start) [firstPoint] {}; & & \node (p0-2) [terminal] {project}; & \node (p0-3) [terminal] {(}; & \node (p0-4) [terminal] {literal\_uint32}; & \node (p0-5) [terminal] {:}; & \node (p0-6) [terminal] {literal\_uint32}; & \node (p0-7) [terminal] {:}; & \node (p0-8) [terminal] {literal\_uint32}; & \node (p0-9) [terminal] {)}; & \node (p0-10) [terminal] {->}; & \node (p0-11) [terminal] {literal\_string}; & \node (p0-12) [lastPoint] {}; & \\
  };
  \draw[->] (P0start) -- (p0-2) ;
  \draw[->] (p0-2) -- (p0-3) ;
  \draw[->] (p0-3) -- (p0-4) ;
