...
\newcommand \readerSansArgument[6] {
  ...
  \newline
  \begin{tabular}{|l}
  \colorbox{yellow}{\texttt{\emph{reader} \nomType{#2} #1 -> #4 ;}}
  \end{tabular}
  \newline
  \newline
...
\newcommand \readerUnArgument[7] {
  ...
  \begin{tabular}{|l}
  \colorbox{yellow}{\texttt{\emph{reader} \nomType{#2} #1}}\\
  \colorbox{yellow}{\texttt{\ \ ?#5}}\\
  \colorbox{yellow}{\texttt{\ \ -> #4 ;}}
  \end{tabular}
  \newline
  \newline
  \textbf{Availability:} available in GALGAS #3 and later.
...
\newcommand \lienConstructeur[2] {\hyperref[constructor #1 #2]{\texttt{#2} constructor (page \pageref{constructor #1 #2})}}
...
\newcommand \constructeurSansArgument[6] {
  ...
  \newline
  \begin{tabular}{|l}
  \colorbox{yellow}{\texttt{\emph{constructor} \nomType{#2} #1 -> #4 ;}}
  \end{tabular}
  \newline
  \newline
  \textbf{Availability:} available in GALGAS #3 and later.
...
\newcommand \modifierUnArgument[6] {
  ...
  \newline
  \begin{tabular}{|l}
  \colorbox{yellow}{\texttt{\emph{modifier} \nomType{#2} #1}}\\
  \colorbox{yellow}{\texttt{\ \ ?#4}}\\
  \end{tabular}
  \newline
  \newline
