...
\newcommand\sectionConstructor[2]{\section{Constructeur \texttt{#1}}\label{constructor:#2:#1}\index{#1!constructeur "@#2}}

\newcommand\subsectionConstructor[2]{\subsection{Constructeur \texttt{#1}}\label{constructor:#2:#1}\index{#1!constructeur "@#2}}
