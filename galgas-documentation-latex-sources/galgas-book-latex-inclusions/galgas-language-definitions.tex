...
%  keywordsprefix=\@,
  morekeywords=[2]{abstract, after, before, between, block, cast, class, const, default, do, drop, else, elsif, end, enum,
...
\newcommand \refTypePredefini[1] {\hyperref[type:#1]{@#1 type (page \pageref{type:#1})}}
