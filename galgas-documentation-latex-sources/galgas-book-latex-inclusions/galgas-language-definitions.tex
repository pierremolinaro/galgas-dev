...
%  keywordsprefix=\@,
  morekeywords=[2]{abstract, after, array, as, before, between, block, case, cast, class, constructor, default, do, drop, else, elsif, end, enum,
    ...
    in, indexing, insert, internal, is, label, lexique, list, listmap, let, log, loop, map, mapproxy,
    message, method, mod, not, on, operator, option, or, override, parse, proc,
...
\newcommand\galgast[1]{\colorbox{\couleurCodeGALGAS}{\ttfamily\smaller{#1}}}
