...
\newenvironment{galgas}{%
  ...
  {\medskip\begin{siderules}\ttfamily\NoAutoSpacing\input{temp.galgas.tex}\end{siderules}}
}
\makeatother
...
\newenvironment{galgasbox}{%
  ...
  \endgroup
  \immediate\write18{galgas -q --mode=latex:Galgas temp.galgas}
  {\singlespacing\begin{boxrules}\ttfamily\NoAutoSpacing\input{temp.galgas.tex}\end{boxrules}}
}
\makeatother
...
\newcommand\@ggs[2]{%
  ...
  \lowercase{%
    \def\@tempa##1~{%
      ...
      \immediate\closeout\tempfile%
      \immediate\write18{galgas -q --mode=latex:Galgas temp.galgas}%
      \colorbox{gray!6}{\ttfamily\NoAutoSpacing\input{temp.galgas.tex}\unskip}%
    }%
  }%
