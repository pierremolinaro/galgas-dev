...
\newcommand\selectorStyle[1]{\textcolor{green}{#1}}
\newcommand\terminalStyle[1]{#1}
\newcommand\nonTerminalStyle[1]{#1}
\newcommand\integerStyle[1]{#1}
\newcommand\floatStyle[1]{#1}
\newcommand\characterStyle[1]{#1}
...
%--- Définition d'un getter sans argument
% Exemple d'appel :
% \readerSansArgument{line} % Nom du getter
% {@location} % Nom du type
% {1.8.2} % Première version GALGAS qui implémente ce getter
% {@uint} % Type renvoyé
% {Returns the line of the receiver's value.} % Description
% {this getter raises a run-time error if ...} % Discussion
...
\newcommand\readerSansArgument[6] {
  \subsection{Getter \texttt{#1}}\label{getter:#2:#1}\index{#1!"@#2 getter}
  #5
  \newline
  \newline
...
% Exemple d'appel : \refReaderPage{bool}{string} -- affiche --> @bool string getter (page xx)
\newcommand \refReaderPage[2] {\hyperref[getter:#1:#2]{@#1 #2 getter (page \pageref{getter:#1:#2})}}

%---------------------------------------------------------------------*

%--- Définition d'un getter à 1 argument
% Exemple d'appel :
% \readerUnArgument{line} % Nom du getter
% {location} % Nom du type
% {1.8.2} % Première version GALGAS qui implémente ce getter
% {uint} % Type renvoyé
% {Returns the line of the receiver's value.} % Description
...
%--- Définition d'un getter à 2 arguments
% Exemple d'appel :
% \readerSansArgument{line} % Nom du getter
% {location} % Nom du type
% {1.8.2} % Première version GALGAS qui implémente ce getter
...
%--- Définition d'un getter à 3 arguments
...
%{The returned object responds \motCle{true} to the isNowhere getter.} % Discussion
...
%--- Définition d'un setter à 1 argument

\newcommand \modifierUnArgument[6] {
  \subsection{Setter \texttt{#1}}\label{setter:#2:#1}\index{#1!"@#2 setter}
  #5
  \newline
  \newline
  \colorbox{\couleurCodeGALGAS}{
