...
\newenvironment{galgas}{%
  ...
  {\linespread{1.25}\begin{siderules}\ttfamily\input{temp.galgas.tex}\end{siderules}}
}
\makeatother

%-----------------------------------------------------------------------------------------------------------------------*
% ENVIRONNEMENT \galgasbox : affichage de code galgas encadré                                                           *
%-----------------------------------------------------------------------------------------------------------------------*
...
\newenvironment{galgasbox}{%
  ...
  \endgroup
  \immediate\write18{galgas -q --mode=latex:Galgas temp.galgas}
  {\linespread{1.25}\begin{boxrules}\ttfamily\input{temp.galgas.tex}\end{boxrules}}
}
\makeatother
...
\newcommand\sectionGetter[2]{\section{Getter \texttt{#1}}\label{getter:#2:#1}\index{#1!"@#2 getter}}
...
\newcommand\subsectionMethod[2]{\subsection{Méthode \texttt{#1}}\label{method:#2:#1}\index{#1!"@#2 méthode}}
...
\newcommand\sectionConstructor[2]{\section{Constructeur \texttt{#1}}\label{constructor:#2:#1}\index{#1!"@#2 constructeur}}

\newcommand\subsectionConstructor[2]{\subsection{Constructeur \texttt{#1}}\label{constructor:#2:#1}\index{#1!"@#2 constructeur}}

%-----------------------------------------------------------------------------------------------------------------------*

\newcommand \refConstructorPage[2] {\hyperref[constructor:#1:#2]{\em constructeur \texttt{#2} du type \texttt{@#1} (page \pageref{constructor:#1:#2})}}
