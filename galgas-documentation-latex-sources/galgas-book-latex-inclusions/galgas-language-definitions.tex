...
\newcommand\attributeStyleGalgas[1]{\textcolor{Purple}{\textbf{#1}}}
...
\newenvironment{galgas}{%
  ...
  {\medskip\begin{siderules}\zeroEspaceAvantPonctuation{\tt{\input{temp.galgas.tex}}}\end{siderules}}
}
\makeatother
...
\newenvironment{galgasbox}{%
  ...
  \endgroup
  \immediate\write18{galgas -q --mode=latex:Galgas temp.galgas}
  {\singlespacing\begin{boxrules}\zeroEspaceAvantPonctuation{\tt{\input{temp.galgas.tex}}}\end{boxrules}}
}
\makeatother
