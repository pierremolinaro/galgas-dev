...
\newcommand\bigintStyleGalgas[1]{\textcolor{Mulberry}{#1}}
...
\newcommand\refGetterPage[2] {\hyperref[getter:#1:#2]{\em getter \texttt{#2} du type \texttt{@#1} (page \pageref{getter:#1:#2})}}
...
\newcommand\refSetterPage[2] {\hyperref[setter:#1:#2]{\em setter \texttt{#2} du type \texttt{@#1} (page \pageref{setter:#1:#2})}}
...
% Exemple d'appel : \refSetterPage{bool}{string} -- affiche --> @bool string setter (page xx)
\newcommand\refMethodPage[2] {\hyperref[setter:#1:#2]{\em méthode \texttt{#2} du type \texttt{@#1} (page \pageref{method:#1:#2})}}
