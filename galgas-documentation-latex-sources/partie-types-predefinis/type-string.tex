...
\subsectionGetter{capitalizingFirstCharacter}{string}
...
\subsectionGetter{deletingPathExtension}{string}
...
\subsectionGetter{hasPrefix}{string}
...
\subsectionGetter{hasSuffix}{string}
...
\subsectionGetter{removingFirst}{string}
