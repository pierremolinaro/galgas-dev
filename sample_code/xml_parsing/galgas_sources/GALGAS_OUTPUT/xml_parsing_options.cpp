...
const char * xml_parsing_options::getBoolOptionString (const sint32 inIndex) const {
  const char * kStringArray [2] = {"dump-unicode",
    ""} ;
...
const char * xml_parsing_options::getBoolOptionDescription (const sint32 inIndex) const {
  const char * kDescriptionArray [2] = {"List all unicode character properties",
    ""} ;
...
boolOptionValueFromKeys (const char * inModuleName,
                         ...
                         bool * outFound) const {
  const char * kKeyArray [2] = {"dumpUnicode",
    ""} ;
  bool result = false ;
