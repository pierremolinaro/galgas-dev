...
getCurrentTokenString (const cToken * inTokenPtr) const {
  cTokenFor_xml_parsing_lexique * ptr = (cTokenFor_xml_parsing_lexique *) inTokenPtr ;
  C_String s ;
  if (ptr == NULL) {
    s << "$$" ;
  }else{
...
void xml_parsing_lexique::enterToken (const cTokenFor_xml_parsing_lexique & inToken) {
  cTokenFor_xml_parsing_lexique * ptr = NULL ;
  macroMyNew (ptr, cTokenFor_xml_parsing_lexique ()) ;
...
_assignFromAttribute_tokenString (GGS_lstring & outValue) const {
  cTokenFor_xml_parsing_lexique * ptr = (cTokenFor_xml_parsing_lexique *) mCurrentTokenPtr ;
