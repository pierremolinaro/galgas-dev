...
//--- Message 0
static const utf32 gErrorMessage_0 [] = {UNICODE_NEW ('i'), UNICODE_NEW ('n'), UNICODE_NEW ('c'), UNICODE_NEW ('o'), UNICODE_NEW ('r'), UNICODE_NEW ('r'), UNICODE_NEW ('e'), UNICODE_NEW ('c'), UNICODE_NEW ('t'), UNICODE_NEW (' '), UNICODE_NEW ('X'), UNICODE_NEW ('M'), UNICODE_NEW ('L'), UNICODE_NEW (' '), UNICODE_NEW ('c'), UNICODE_NEW ('o'), UNICODE_NEW ('m'), UNICODE_NEW ('m'), UNICODE_NEW ('e'), UNICODE_NEW ('n'), UNICODE_NEW ('t'), UNICODE_NEW (0)} ;
//--- Message 1
static const utf32 gErrorMessage_1 [] = {UNICODE_NEW ('a'), UNICODE_NEW ('t'), UNICODE_NEW ('t'), UNICODE_NEW ('r'), UNICODE_NEW ('i'), UNICODE_NEW ('b'), UNICODE_NEW ('u'), UNICODE_NEW ('t'), UNICODE_NEW ('e'), UNICODE_NEW (' '), UNICODE_NEW ('v'), UNICODE_NEW ('a'), UNICODE_NEW ('l'), UNICODE_NEW ('u'), UNICODE_NEW ('e'), UNICODE_NEW (' '), UNICODE_NEW ('s'), UNICODE_NEW ('h'), UNICODE_NEW ('o'), UNICODE_NEW ('u'), UNICODE_NEW ('l'), UNICODE_NEW ('d'), UNICODE_NEW (' '), UNICODE_NEW ('b'), UNICODE_NEW ('e'), UNICODE_NEW (' '), UNICODE_NEW ('e'), UNICODE_NEW ('n'), UNICODE_NEW ('c'), UNICODE_NEW ('l'), UNICODE_NEW ('o'), UNICODE_NEW ('s'), UNICODE_NEW ('e'), UNICODE_NEW ('d'), UNICODE_NEW (' '), UNICODE_NEW ('b'), UNICODE_NEW ('e'), UNICODE_NEW ('t'), UNICODE_NEW ('w'), UNICODE_NEW ('e'), UNICODE_NEW ('e'), UNICODE_NEW ('n'), UNICODE_NEW (' '), UNICODE_NEW ('a'), UNICODE_NEW ('p'), UNICODE_NEW ('o'), UNICODE_NEW ('s'), UNICODE_NEW ('t'), UNICODE_NEW ('r'), UNICODE_NEW ('o'), UNICODE_NEW ('p'), UNICODE_NEW ('h'), UNICODE_NEW ('e'), UNICODE_NEW ('s'), UNICODE_NEW (' '), UNICODE_NEW ('('), UNICODE_NEW ('\''), UNICODE_NEW (')'), UNICODE_NEW (' '), UNICODE_NEW ('o'), UNICODE_NEW ('r'), UNICODE_NEW (' '), UNICODE_NEW ('q'), UNICODE_NEW ('u'), UNICODE_NEW ('o'), UNICODE_NEW ('t'), UNICODE_NEW ('a'), UNICODE_NEW ('t'), UNICODE_NEW ('i'), UNICODE_NEW ('o'), UNICODE_NEW ('n'), UNICODE_NEW (' '), UNICODE_NEW ('m'), UNICODE_NEW ('a'), UNICODE_NEW ('r'), UNICODE_NEW ('k'), UNICODE_NEW ('s'), UNICODE_NEW (' '), UNICODE_NEW ('('), UNICODE_NEW ('\"'), UNICODE_NEW (')'), UNICODE_NEW (0)} ;
...
static const utf32 kEntry_0_forTable_xmlDelimitorsList [] = {UNICODE_NEW ('<'), UNICODE_NEW (0)}; 

static const utf32 kEntry_1_forTable_xmlDelimitorsList [] = {UNICODE_NEW ('='), UNICODE_NEW (0)}; 

static const utf32 kEntry_2_forTable_xmlDelimitorsList [] = {UNICODE_NEW ('>'), UNICODE_NEW (0)}; 

static const utf32 kEntry_3_forTable_xmlDelimitorsList [] = {UNICODE_NEW ('/'), UNICODE_NEW ('>'), UNICODE_NEW (0)}; 

static const utf32 kEntry_4_forTable_xmlDelimitorsList [] = {UNICODE_NEW ('<'), UNICODE_NEW ('/'), UNICODE_NEW (0)}; 

static const utf32 kEntry_5_forTable_xmlDelimitorsList [] = {UNICODE_NEW ('<'), UNICODE_NEW ('\?'), UNICODE_NEW (0)}; 

static const utf32 kEntry_6_forTable_xmlDelimitorsList [] = {UNICODE_NEW ('\?'), UNICODE_NEW ('>'), UNICODE_NEW (0)}; 
          ...
          do {
            if (testForInputString ("&amp;", 5, true)) {
              ...
              scanner_action_enterCharacterIntoString (_token.tokenString, UNICODE_NEW ('\'')) ;
                ...
                testForInputCharRange (UNICODE_NEW ('.'), UNICODE_NEW (255))) {
