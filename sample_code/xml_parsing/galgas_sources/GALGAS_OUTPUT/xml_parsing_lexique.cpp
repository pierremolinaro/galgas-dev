...
static const templateDelimiterStruct kTemplateReplacementArray [6] = {
  ...
  {kTemplateReplacementArray_5_startString, 2, kTemplateReplacementArray_5_endString, 1, true},
} ;
  ...
  while ((_token.mTokenCode < 0) && (UNICODE_VALUE (mCurrentChar) != '\0')) {
    ...
    while ((_mMatchedTemplateDelimiterIndex < 0) && (UNICODE_VALUE (mCurrentChar) != '\0')) {
      ...
      while (_replacementIndex >= 0) {
       _replacementIndex = findTemplateDelimiterIndex (kTemplateReplacementArray, 6) ;
