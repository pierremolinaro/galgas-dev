      ...
      while (_replacementIndex >= 0) {
       _replacementIndex = findTemplateDelimiterIndex (kTemplateReplacementArray, 5) ;
         if (_replacementIndex >= 0) {
           _token._mTemplateStringBeforeToken.appendCString (kTemplateReplacementArray [_replacementIndex].mEndString) ;
           printf ("APPEND '%s'\n", kTemplateReplacementArray [_replacementIndex].mEndString) ;
        }
      }
