...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "xml_type.ggs", line
  ...
  #endif
  {
    ...
    while (((operand_983 = enumerator_983.nextObject ()))) {
      ...
      case GGS_xmlNodeType::enum_element:
        ...
        var_cas_ioString.appendCstring (" {") ;
        {
          GGS_xmlAttributeMap::cEnumerator enumerator_1267 (operand_983->node.reader_attributeMap (_inLexique COMMA_SOURCE_FILE_AT_LINE (51)), true) ;
          const GGS_xmlAttributeMap::cElement * operand_1267 = enumerator_1267.nextObject () ;
          if ((operand_1267 != NULL)) {
            bool _foreach_loop_1267 ;
            do{
              macroValidPointer (operand_1267) ;
              var_cas_ioString.appendCstring ("'") ;
              var_cas_ioString._dotAssign_operation (operand_1267->mKey) ;
              var_cas_ioString.appendCstring ("' ") ;
              var_cas_ioString._dotAssign_operation (operand_1267->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (53)).reader_line (_inLexique COMMA_SOURCE_FILE_AT_LINE (53)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (53))) ;
              var_cas_ioString.appendCstring (":") ;
              var_cas_ioString._dotAssign_operation (operand_1267->mKey.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (54)).reader_column (_inLexique COMMA_SOURCE_FILE_AT_LINE (54)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (54))) ;
              var_cas_ioString.appendCstring (" -> ") ;
              var_cas_ioString.appendCstring ("'") ;
              var_cas_ioString._dotAssign_operation (operand_1267->mInfo.value) ;
              var_cas_ioString.appendCstring ("' ") ;
              var_cas_ioString._dotAssign_operation (operand_1267->mInfo.value.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (56)).reader_line (_inLexique COMMA_SOURCE_FILE_AT_LINE (56)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (56))) ;
              var_cas_ioString.appendCstring (":") ;
              var_cas_ioString._dotAssign_operation (operand_1267->mInfo.value.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (57)).reader_column (_inLexique COMMA_SOURCE_FILE_AT_LINE (57)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (57))) ;
              operand_1267 = enumerator_1267.nextObject () ;
              _foreach_loop_1267 = ((operand_1267 != NULL)) ;
              if (_foreach_loop_1267) {
                var_cas_ioString.appendCstring (", ") ;
              }
            }while (_foreach_loop_1267) ;
          }
        }
        var_cas_ioString.appendCstring ("}\n") ;
        ::routine_internal_logXMLNodes (_inLexique,  operand_983->node.reader_nodeList (_inLexique COMMA_SOURCE_FILE_AT_LINE (61)),  (var_cas_inIndentationString)._operator_concat (GGS_string (true, " ")),  var_cas_ioString COMMA_SOURCE_FILE_AT_LINE (61)) ;
        }
        break ;
      case GGS_xmlNodeType::enum_text:
        {
        var_cas_ioString.appendCstring ("TEXT '") ;
        var_cas_ioString._dotAssign_operation (operand_983->node.reader_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (63))) ;
        var_cas_ioString.appendCstring ("' ") ;
        var_cas_ioString._dotAssign_operation (operand_983->node.reader_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (64)).reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (64)).reader_line (_inLexique COMMA_SOURCE_FILE_AT_LINE (64)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (64))) ;
        var_cas_ioString.appendCstring (":") ;
        var_cas_ioString._dotAssign_operation (operand_983->node.reader_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (65)).reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (65)).reader_column (_inLexique COMMA_SOURCE_FILE_AT_LINE (65)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (65))) ;
        var_cas_ioString.appendCstring ("\n") ;
        }
        break ;
      case GGS_xmlNodeType::enum_comment:
        ...
        var_cas_ioString._dotAssign_operation (operand_983->node.reader_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (67))) ;
        var_cas_ioString.appendCstring ("' ") ;
        var_cas_ioString._dotAssign_operation (operand_983->node.reader_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (68)).reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (68)).reader_line (_inLexique COMMA_SOURCE_FILE_AT_LINE (68)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (68))) ;
        var_cas_ioString.appendCstring (":") ;
        var_cas_ioString._dotAssign_operation (operand_983->node.reader_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (69)).reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (69)).reader_column (_inLexique COMMA_SOURCE_FILE_AT_LINE (69)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (69))) ;
        var_cas_ioString.appendCstring ("\n") ;
        }
        break ;
...
void routine_logXMLNodes (C_Compiler & _inLexique,
  ...
  ::routine_internal_logXMLNodes (_inLexique,  var_cas_inNodeList,  GGS_string (true, ""),  var_cas_s COMMA_SOURCE_FILE_AT_LINE (78)) ;
  _inLexique.printMessage (var_cas_s COMMA_SOURCE_FILE_AT_LINE (79)) ;
  #ifdef DEBUG_TRACE_ENABLED
