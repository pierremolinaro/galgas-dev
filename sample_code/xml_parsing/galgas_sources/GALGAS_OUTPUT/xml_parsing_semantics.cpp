...
void routine_listUnicodeCharacterProperties (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_bool _condition_1227 (_variant_1227.isBuilt (), true) ;
  ...
  GGS_bool _condition_1641 (_variant_1641.isBuilt (), true) ;
  ...
  GGS_bool _condition_2060 (_variant_2060.isBuilt (), true) ;
  ...
  GGS_bool _condition_2842 (_variant_2842.isBuilt (), true) ;
  ...
  GGS_bool _condition_3759 (_variant_3759.isBuilt (), true) ;
  ...
  GGS_bool _condition_4670 (_variant_4670.isBuilt (), true) ;
