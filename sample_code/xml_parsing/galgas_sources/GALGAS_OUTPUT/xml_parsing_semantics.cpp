...
void routine_listUnicodeCharacterProperties (C_Compiler & _inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_uint _variant_670 = GGS_uint (65536U)._substract_operation (_inLexique, var_cas_unicodeValue COMMA_SOURCE_FILE_AT_LINE (10)) ;
  ...
  if ((var_cas_found).isBuiltAndTrue ()) {
    _inLexique.printMessage (((((GGS_string ("  - ["))._operator_concat (var_cas_matchedValue.reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (24))))._operator_concat (GGS_string (", ")))._operator_concat (var_cas_unicodeValue._substract_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (24)).reader_hexString (_inLexique COMMA_SOURCE_FILE_AT_LINE (24))))._operator_concat (GGS_string ("]\n")) COMMA_SOURCE_FILE_AT_LINE (24)) ;
    var_cas_found = GGS_bool (false) ;
  }
  _inLexique.printMessage (GGS_string ("---- Unicode Letters\n") COMMA_SOURCE_FILE_AT_LINE (28)) ;
  var_cas_unicodeValue = GGS_uint (0U) ;
  GGS_uint _variant_1408 = GGS_uint (65536U)._substract_operation (_inLexique, var_cas_unicodeValue COMMA_SOURCE_FILE_AT_LINE (30)) ;
  ...
  var_cas_unicodeValue = GGS_uint (0U) ;
  GGS_uint _variant_1855 = GGS_uint (65536U)._substract_operation (_inLexique, var_cas_unicodeValue COMMA_SOURCE_FILE_AT_LINE (48)) ;
  ...
  var_cas_unicodeValue = GGS_uint (0U) ;
  GGS_uint _variant_2308 = GGS_uint (65536U)._substract_operation (_inLexique, var_cas_unicodeValue COMMA_SOURCE_FILE_AT_LINE (61)) ;
  ...
  var_cas_unicodeValue = GGS_uint (0U) ;
  GGS_uint _variant_2743 = GGS_uint (65536U)._substract_operation (_inLexique, var_cas_unicodeValue COMMA_SOURCE_FILE_AT_LINE (74)) ;
  ...
  var_cas_unicodeValue = GGS_uint (0U) ;
  GGS_uint _variant_3170 = GGS_uint (65536U)._substract_operation (_inLexique, var_cas_unicodeValue COMMA_SOURCE_FILE_AT_LINE (87)) ;
  ...
  var_cas_unicodeValue = GGS_uint (0U) ;
  GGS_uint _variant_3591 = GGS_uint (65536U)._substract_operation (_inLexique, var_cas_unicodeValue COMMA_SOURCE_FILE_AT_LINE (100)) ;
