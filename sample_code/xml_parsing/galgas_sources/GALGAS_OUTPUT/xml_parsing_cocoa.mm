...
#import "xml_parsing_lexique.h"
#import "xml_parsing_options.h"
...
static const unsigned kBoolOptionCount = 10 ;
...
static xml_parsing_options gOption0 ;
...
static xml_parsing_lexique * gScannerPtr = NULL ;
...
sint32 getStylesCount (void) {
  return xml_parsing_lexique::getStylesCount () ;
}

//---------------------------------------------------------------------------*

const char * getStyleName (const sint32 inIndex) {
  return xml_parsing_lexique::getStyleName (inIndex) ;
}

//---------------------------------------------------------------------------*

const char * getStyleIdentifier (const sint32 inIndex) {
  return xml_parsing_lexique::getStyleIdentifier (inIndex) ;
}
...
scanThenGetStyledRangeArray (NSString * inSourceString,
  ...
  if (gScannerPtr == NULL) {
    ...
    macroMyNew (gScannerPtr, xml_parsing_lexique (NULL, "", "", gIOParametersPtr, "" COMMA_HERE)) ;
  }
