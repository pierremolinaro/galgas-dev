...
class xml_parsing_syntax {
  ...
  protected : void pr_start_symbol_xml_parsing_syntax_32_19_ (xml_parsing_lexique &,
                                GGS_xmlNodeList  &,
                                const GGS_bool ,
                                const GGS_bool ,
                                const GGS_bool ) ;
  ...
  protected : void pr_element_list_xml_parsing_syntax_65_19_ (xml_parsing_lexique &,
                                GGS_xmlNodeList  &,
                                const GGS_bool ,
                                const GGS_bool ,
                                const GGS_bool ,
  ...
  protected : void pr_element_xml_parsing_syntax_110_14_ (xml_parsing_lexique &,
                                GGS_xmlNodeList  &,
                                const GGS_bool ,
                                const GGS_bool ,
                                const GGS_bool ,
  ...
  protected : void pr_element_xml_parsing_syntax_144_14_ (xml_parsing_lexique &,
                                GGS_xmlNodeList  &,
                                const GGS_bool ,
                                const GGS_bool ,
                                const GGS_bool ,
