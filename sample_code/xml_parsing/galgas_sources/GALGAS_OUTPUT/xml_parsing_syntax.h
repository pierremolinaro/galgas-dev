...
class xml_parsing_syntax {
  ...
  protected : void pr_element_list_xml_parsing_syntax_99_19_ (xml_parsing_lexique &,
                                GGS_xmlNodeList  &,
                                const GGS_bool ,
                                const GGS_bool ,
                                const GGS_bool ,
  ...
  protected : void pr_element_xml_parsing_syntax_126_14_ (xml_parsing_lexique &,
                                GGS_xmlNodeList  &,
                                const GGS_bool ,
                                const GGS_bool ,
                                const GGS_bool ,
  ...
  protected : void pr_element_xml_parsing_syntax_160_14_ (xml_parsing_lexique &,
                                GGS_xmlNodeList  &,
                                const GGS_bool ,
                                const GGS_bool ,
                                const GGS_bool ,
