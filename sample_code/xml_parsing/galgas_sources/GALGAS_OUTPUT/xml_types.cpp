  ...
  #endif
  {
    ...
    while (((operand_984 = enumerator_984.nextObject ()))) {
      ...
      case GGS_xmlNodeType::enum_element:
        ...
        var_cas_ioString.appendCString ("}\n") ;
        ::routine_internal_logXMLNodes (_inLexique,  operand_984->node.reader_nodeList (_inLexique COMMA_SOURCE_FILE_AT_LINE (64)),  (var_cas_inIndentationString)._operator_concat (GGS_string (" ")),  var_cas_ioString COMMA_SOURCE_FILE_AT_LINE (64)) ;
        }
        break ;
