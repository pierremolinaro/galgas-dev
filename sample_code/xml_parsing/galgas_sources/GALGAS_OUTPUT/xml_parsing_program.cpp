...
static void
xml_parsing_program_prologue (C_Compiler & inLexique,
                     const TC_UniqueArray <C_String> & /* inSourceFilesArray */) {
  if ((GGS_bool (inLexique.boolOptionValueFromKeys ("xml_parsing_options", "dumpUnicode" COMMA_SOURCE_FILE_AT_LINE (11)))).isBuiltAndTrue ()) {
    ::routine_listUnicodeCharacterProperties (inLexique COMMA_SOURCE_FILE_AT_LINE (12)) ;
  }
}
...
static void
xml_parsing_program_epilogue (C_Compiler & /* inLexique */,
                     const TC_UniqueArray <C_String> & /* inSourceFilesArray */) {
}
        ...
        try {
          ...
          if (fileExtension.compare ("xml_file") == 0) {
            ...
            if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
              xml_parsing_grammar::_performSourceFileParsing_ (inLexique,
                                            ...
                                            GGS_bool (false),
                                            GGS_bool (true)
                                            COMMA_SOURCE_FILE_AT_LINE (21)) ;
            }
            inLexique.printMessage (C_String ("LOGGING rootNodes: ") + var_cas_rootNodes.reader_description (inLexique COMMA_HERE).string () + "\n" COMMA_SOURCE_FILE_AT_LINE (27)) ;
            ::routine_logXMLNodes (inLexique,  var_cas_rootNodes COMMA_SOURCE_FILE_AT_LINE (28)) ;
            if (verboseOptionOn) {
