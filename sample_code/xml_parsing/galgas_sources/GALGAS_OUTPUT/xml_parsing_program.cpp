...
//--- Fix parameters for BDD package
  ...
  //--- Input/output parameters
    ...
    const char * extensions [] = {"epc", NULL} ;
    const char * helpMessages [] = {"an XML text file with the .epc extension", NULL} ;
    ...
    try{
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          sint16 r = 0 ;
          if (fileExtension.compare ("epc") == 0) {
            ...
            if (var_cas_inSourceFile._isBuilt ()) {
              ::routine_temporaryParseXML (_inLexique,  var_cas_inSourceFile,  var_cas_rootNodes COMMA_SOURCE_FILE_AT_LINE (17)) ;
            }
            ::routine_logXMLNodes (_inLexique,  var_cas_rootNodes COMMA_SOURCE_FILE_AT_LINE (19)) ;
            if (verboseOptionOn) {
