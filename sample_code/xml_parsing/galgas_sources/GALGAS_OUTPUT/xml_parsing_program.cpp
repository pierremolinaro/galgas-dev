        ...
        try {
          ...
          if (fileExtension.compare ("xml_file") == 0) {
            ...
            if (var_cas_inSourceFile._isBuilt () &&
                GGS_bool (true, true)._isBuilt () &&
                GGS_bool (true, false)._isBuilt () &&
                GGS_bool (true, true)._isBuilt ()) {
              ::routine_parseXMLFile (_inLexique,  var_cas_inSourceFile,  var_cas_rootNodes,  GGS_bool (true, true),  GGS_bool (true, false),  GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (16)) ;
            }
