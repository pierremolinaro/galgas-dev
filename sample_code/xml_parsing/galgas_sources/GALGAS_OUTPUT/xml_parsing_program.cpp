...
xml_parsing_program_prologue (C_Compiler & _inLexique,
  ...
  if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("xml_parsing_options", "dumpUnicode" COMMA_SOURCE_FILE_AT_LINE (11)))).isBuiltAndTrue ()) {
    ::routine_listUnicodeCharacterProperties (_inLexique COMMA_SOURCE_FILE_AT_LINE (12)) ;
  }
}
      ...
      for (sint32 i=0 ; i<sourceFilesArray.count () ; i++) {
        try {
          ...
          if (fileExtension.compare ("xml_file") == 0) {
            ...
            ::routine_logXMLNodes (_inLexique,  var_cas_rootNodes COMMA_SOURCE_FILE_AT_LINE (28)) ;
            if (verboseOptionOn) {
