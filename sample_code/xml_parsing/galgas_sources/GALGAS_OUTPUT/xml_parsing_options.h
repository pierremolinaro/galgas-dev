...
#ifndef xml_parsing_options_0_DEFINED
#define xml_parsing_options_0_DEFINED
...
class xml_parsing_options : public AC_CLI_Options {
//--- Constructor
  public : xml_parsing_options (void) ;
...
//--- Private arraies : current options values
  private : bool mBoolOptionValues [2] ;
