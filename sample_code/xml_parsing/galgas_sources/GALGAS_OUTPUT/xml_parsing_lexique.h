...
//--- Key words table 'xmlDelimitorsList'
  public : static const sint16 xml_parsing_lexique_table_size_xmlDelimitorsList ;
  private : static const C_lexique_table_entry xml_parsing_lexique_table_for_xmlDelimitorsList [7] ;
