...
$DIR/../makefile-macosx/galgas --generate-many-cpp-files --Werror ${DIR}/dangling_else_solution/+dangling_else_solution.galgasProject &&
python ${DIR}/dangling_else_solution/makefile-macosx/build.py &&
#----------------- SLR_expression
$DIR/../makefile-macosx/galgas --generate-many-cpp-files --Werror ${DIR}/SLR_expression/+SLR_expression.galgasProject &&
python ${DIR}/SLR_expression/makefile-macosx/build.py &&
#----------------- LL1_expression
$DIR/../makefile-macosx/galgas --generate-many-cpp-files --Werror ${DIR}/LL1_expression/+LL1_expression.galgasProject &&
python ${DIR}/LL1_expression/makefile-macosx/build.py &&
#----------------- LR1_grammar
$DIR/../makefile-macosx/galgas --generate-many-cpp-files --Werror ${DIR}/LR1_grammar/+LR1_grammar.galgasProject &&
python ${DIR}/LR1_grammar/makefile-macosx/build.py &&
#----------------- XML Parsing
$DIR/../makefile-macosx/galgas --generate-many-cpp-files --Werror ${DIR}/xml_parsing/+xml_parsing.galgasProject &&
