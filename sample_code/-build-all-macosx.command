...
#----------------- Assignment language
$DIR/../makefile-macosx/galgas --Werror ${DIR}/assignment_language/+asl.galgasProject &&
...
#----------------- LOGO
$DIR/../makefile-macosx/galgas --Werror ${DIR}/logo/+logo.galgasProject &&
python ${DIR}/logo/makefile-macosx/build.py &&
${DIR}/logo/makefile-macosx/logo  ${DIR}/logo/exemples-logo/carre.logo &&
${DIR}/logo/makefile-macosx/logo  ${DIR}/logo/exemples-logo/etoile.logo &&
${DIR}/logo/makefile-macosx/logo  ${DIR}/logo/exemples-logo/hexagone.logo &&
...
#----------------- LBB
$DIR/../makefile-macosx/galgas --Werror ${DIR}/lbb/+lbb.galgasProject &&
python ${DIR}/lbb/makefile-macosx/build.py &&
#----------------- class_sample_language
$DIR/../makefile-macosx/galgas --Werror ${DIR}/class_sample_language/+class_sample_language.galgasProject &&
...
$DIR/../makefile-macosx/galgas --Werror ${DIR}/dangling_else_solution/+dangling_else_solution.galgasProject &&
python ${DIR}/dangling_else_solution/makefile-macosx/build.py &&
#----------------- SLR_expression
$DIR/../makefile-macosx/galgas --Werror ${DIR}/SLR_expression/+SLR_expression.galgasProject &&
python ${DIR}/SLR_expression/makefile-macosx/build.py &&
#----------------- LL1_expression
$DIR/../makefile-macosx/galgas --Werror ${DIR}/LL1_expression/+LL1_expression.galgasProject &&
python ${DIR}/LL1_expression/makefile-macosx/build.py &&
#----------------- LR1_grammar
$DIR/../makefile-macosx/galgas --Werror ${DIR}/LR1_grammar/+LR1_grammar.galgasProject &&
python ${DIR}/LR1_grammar/makefile-macosx/build.py &&
#----------------- XML Parsing
$DIR/../makefile-macosx/galgas --Werror ${DIR}/xml_parsing/+xml_parsing.galgasProject &&
