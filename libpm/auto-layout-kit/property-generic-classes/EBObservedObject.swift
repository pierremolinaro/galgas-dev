...
public class EBObservedObject : EBObservableObjectProtocol {
  ...
  public final func startsBeingObserved (by inObserver : any EBObserverProtocol) {
  ...
  public final func stopsBeingObserved (by inObserver : any EBObserverProtocol) {
    let key = ObjectIdentifier (inObserver)
  ...
  public var mObserverCallback : (() -> Void)? = nil
