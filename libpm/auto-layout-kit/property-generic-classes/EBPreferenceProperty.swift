...
public final class EBPreferenceProperty <T : EBStoredPropertyProtocol> : EBObservableMutableProperty <T> {
  ...
  public init (defaultValue inValue : T, prefKey inPreferenceKey : String) {
  ...
  public var propval : T { return self.mValue }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  public override var selection : EBSelection <T> { return .single (self.propval) }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  public override func setProp (_ inValue : T) {
