...
COMPILER_TOOL := gcc -m64 -mdynamic-no-pic -arch i386
LINKER_TOOL   := g++ -m64 -arch i386
STRIP_TOOL    := strip -A -n -r -u
SUDO_TOOL     := sudo
COMPILATION_MESSAGE := 64-Bit Compiling for Intel Mac
LINKING_MESSAGE := 64-Bit Linking for Intel Mac
