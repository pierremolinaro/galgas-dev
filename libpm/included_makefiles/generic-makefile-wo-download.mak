...
$(EXECUTABLE):$(OBJECT_FILES_LIST)
	...
	$(SILENT_CHAR)$(LINKER_TOOL) $(OBJECT_FILES_LIST) -o $(EXECUTABLE) $(LINKER_OPTIONS) $(PLATFORM_LINKER_OPTIONS) $(USER_LINK_OPTIONS) && $(STRIP_TOOL) $(STRIP_OPTION) $(EXECUTABLE)
...
$(EXECUTABLE_DEBUG):$(DEBUG_OBJECT_FILES_LIST)
	...
	$(SILENT_CHAR)$(LINKER_TOOL) $(DEBUG_OBJECT_FILES_LIST) -o $(EXECUTABLE_DEBUG) $(LINKER_OPTIONS) $(PLATFORM_LINKER_OPTIONS) $(USER_LINK_OPTIONS)
...
include $(LIBPM_DIRECTORY_PATH)/included_makefiles/compiler-calls-wo-download.mak
