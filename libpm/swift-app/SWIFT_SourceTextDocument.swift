//
//  SWIFT_SourceTextDocument.swift
//  galgas-ide
//
...
@MainActor final class SWIFT_SourceTextDocument : NSDocument { // NSTextStorageDelegate
...
//  var mTokenRangeArray = [SWIFT_Token] ()
  ...
  let mSourceTextManager = SWIFT_SourceTextManager ()
 ...
 //····················································································································
  ...
  override init () {
    ...
    self.mSourceTextManager.setDocument (self)
...
//  override class var autosavesInPlace: Bool { return true }
  ...
  override func read (from inData : Data, ofType inTypeName : String) throws {
    ...
    DispatchQueue.main.async {
      self.mSourceTextManager.setContentString (str)
    }
//    DispatchQueue.main.async {
