...
class SWIFT_SingleWindow : NSWindow { //, AutoLayoutTableViewDelegate, NSWindowDelegate {
...
//    self.mMainHorizontalSplitView.autosaveName = "HSplitFor_" + (inDocument.fileURL?.path ?? "")
  ...
  func appendTab (document inDocument : SWIFT_SingleDocument, select inSelect : Bool) {
