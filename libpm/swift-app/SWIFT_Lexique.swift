...
@MainActor class SWIFT_Lexique {
  ...
  func testForChar_isUnicodeLetter () -> Bool {
...
fileprivate let kHTMLtoUnicodeConversionArray : [String : UInt32] = [
  "AElig" : 0xC6,
  "Aacute" : 0xC1,
  "Abreve" : 0x102,
  "Acirc" : 0xC2,
...
func scanner_cocoa_routine_convertHTMLSequenceToUnicodeCharacter (_ ioScanningOk : inout Bool,
                                                                  ...
                                                                  _ outUnicodeCharacter : inout UInt32) {
  outUnicodeCharacter = kHTMLtoUnicodeConversionArray [ioStringValue] ?? 0
