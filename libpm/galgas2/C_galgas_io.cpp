...
void constructErrorOrWarningLocationMessage (C_String & ioMessage, 
  ...
  //--- Construct message
    ...
    if (! gOption_galgas_5F_builtin_5F_options_quiet_5F_output.mValue) {
      ioMessage << "\n" << textLine << "\n" ;
...
//--- Add warning
  warningMessage << (! gOption_galgas_5F_builtin_5F_options_quiet_5F_output.mValue ? "lexical " : "")
...
//--- Construct parsing error message
  ...
  errorMessage << (! gOption_galgas_5F_builtin_5F_options_quiet_5F_output.mValue ? "lexical " : "")
...
//--- Construct location error message
  C_String errorMessage ;
//--- Construct parsing error message
  errorMessage << (! gOption_galgas_5F_builtin_5F_options_quiet_5F_output.mValue ? "syntax " : "")
...
//--- Construct location error message
  C_String errorMessage ;
//--- Print extract error
  errorMessage << (!gOption_galgas_5F_builtin_5F_options_quiet_5F_output.mValue ? "semantic " : "")
               << "error: I have found:\n" ;
  if (gOption_galgas_5F_builtin_5F_options_quiet_5F_output.mValue) {
...
//--- Construct location error message
  C_String warningMessage ;
//--- Add warning
  warningMessage << (!gOption_galgas_5F_builtin_5F_options_quiet_5F_output.mValue ? "semantic " : "")
