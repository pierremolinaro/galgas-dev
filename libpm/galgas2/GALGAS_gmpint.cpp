...
GALGAS_gmpint::GALGAS_gmpint (void) :
AC_GALGAS_root (),
mIsValid (false),
mValue (0) {
}
...
void GALGAS_gmpint::drop (void) {
  mIsValid = false ;
}

//---------------------------------------------------------------------------------------------------------------------*

void GALGAS_gmpint::description (C_String & ioString,
...
GALGAS_gmpint GALGAS_gmpint::constructor_zero (UNUSED_LOCATION_ARGS) {
...
/* void GALGAS_gmpint::modifier_orInPlaceWith (GALGAS_uint_36__34_ inValue,
...
/*GALGAS_uint GALGAS_gmpint::reader_size (UNUSED_LOCATION_ARGS) const {
  GALGAS_uint result ;
  if (isValid ()) {
...
/*GALGAS_bool GALGAS_gmpint::reader_bitAtIndex (const GALGAS_uint & inBitIndex COMMA_LOCATION_ARGS) const {
  GALGAS_bool result ;
...
/*GALGAS_uint GALGAS_gmpint::reader_uintAtIndex (const GALGAS_uint & inUint32Index COMMA_LOCATION_ARGS) const {
  GALGAS_uint result ;
...
/*GALGAS_uint_36__34_ GALGAS_gmpint::reader_uint_36__34_AtIndex (const GALGAS_uint & inUint64Index COMMA_LOCATION_ARGS) const {
...
/* GALGAS_uint GALGAS_gmpint::reader_byteAtIndex (const GALGAS_uint & inByteIndex COMMA_LOCATION_ARGS) const {
  GALGAS_uint result ;
...
/* GALGAS_bool GALGAS_gmpint::reader_isZero (UNUSED_LOCATION_ARGS) const {
  GALGAS_bool result ;
  if (isValid ()) {
