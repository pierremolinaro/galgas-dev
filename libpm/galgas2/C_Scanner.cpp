//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//  'C_Scanner' : an abstract lexique class ;                                                                          *
...
void C_Scanner::enterTokenFromPointer (cToken * inToken) {
...
int32_t C_Scanner::findTemplateDelimiterIndex (const cTemplateDelimiter inTemplateDelimiterArray [],
...
void C_Scanner::performLexicalAnalysis (void) {
  if (executionModeIsLexicalAnalysisOnly ()) {
...
void C_Scanner::advance (const int32_t inCount) {
...
bool C_Scanner::testForInputUTF32CharRange (const utf32 inLowBound,
...
bool C_Scanner::testForInputUTF32Char (const utf32 inChar) {
...
bool C_Scanner::testForCharWithFunction (bool (*inFunction) (const utf32 inUnicodeCharacter)) {
...
bool C_Scanner::notTestForInputUTF32String (const utf32 * inTestCstring,
                                            const int32_t inStringLength,
...
void C_Scanner::lexicalLog (LOCATION_ARGS) {
  C_String message ;
  message << "LEXICAL LOG:'" ;
...
int16_t C_Scanner::searchInList (const C_String & inString,
...
void C_Scanner::internalBottomUpParserError (LOCATION_ARGS) {
  #ifndef DO_NOT_GENERATE_CHECKINGS
...
void C_Scanner::unknownCharacterLexicalError (LOCATION_ARGS) {
  C_String errorMessage ;
...
void C_Scanner::lexicalError (const C_String & inLexicalErrorMessage
                              COMMA_LOCATION_ARGS) {
...
void C_Scanner::parsingError (const TC_UniqueArray <int16_t> & inExpectedTerminalsArray,
...
void C_Scanner::lexicalWarning (const C_String & inLexicalWarningMessage
                                COMMA_LOCATION_ARGS) { // §
...
bool C_Scanner::acceptTerminalForErrorSignaling (const int16_t inTerminal,
...
void C_Scanner::buildExpectedTerminalsArrayOnSyntaxError (const int16_t inErrorProgramCounter,
...
static void indentForParseOnlyAnalysis (const int32_t inIndentation) {
...
bool C_Scanner::performTopDownParsing (const int16_t inProductions [],
    ...
    //--- Instruction is non terminal call ?
      ...
      //--- Get entry of nonterminal symbol to parse
        ...
        if (inDecisionTable [nonTerminalEntry] < 0) { // Means only one production : don't make any choice
          ...
          if (executionModeIsSyntaxAnalysisOnly ()) {
            indentForParseOnlyAnalysis (indentationForParseOnly) ;
...
static bool acceptExpectedTerminalForBottomUpParsingErrorNew (const int16_t inExpectedTerminal,
...
bool C_Scanner::performBottomUpParsing (const int16_t inActionTable [],
     ...
     //--- Get Successor state
      ...
      //---
        ...
        while ((* actionTable) >= 0) {
          ...
          actionTable ++ ;
          const bool terminalAccepted = acceptExpectedTerminalForBottomUpParsingErrorNew (
            expectedTerminal,
            expectedAction,
            actualErrorStack,
            inActionTable,
...
int16_t C_Scanner::nextProductionIndex (void) {
  int16_t result = 0 ;
...
C_String C_Scanner::preceedingSeparatorString (void) const {
  C_String result ;
  if (mCurrentTokenPtr != NULL) {
...
C_String C_Scanner::tokenString (void) const {
  C_String result ;
  if (mCurrentTokenPtr != NULL) {
...
void C_Scanner::acceptTerminal (FORMAL_ARG_ACCEPT_TERMINAL COMMA_LOCATION_ARGS) {
  #ifndef DO_NOT_GENERATE_CHECKINGS
...
void C_Scanner::enableIndexing (void) {
...
void C_Scanner::enterProduction (const char * inProductionName,
                                 const char * inLabel,
                                 const char * inTag) {
...
void C_Scanner::exitProduction (void) {
  if (mDebugIsRunning) {
    mDebugDepthCounter -- ;
...
void C_Scanner::didParseTerminal (const char * inTerminalName,
...
void C_Scanner::appendCharacterToLatexFile (const utf32 inUnicodeCharacter) {
...
void C_Scanner::signalLexicalErrorInLatexOutput (void) {
