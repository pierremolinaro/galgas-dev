...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG GALGAS_stringlist reader_allFilePathes (LOCATION_ARGS) const ;
  ...
  public : VIRTUAL_IN_DEBUG GALGAS_string reader_fileContentsAtPath (const GALGAS_string & constinOperand0,
                                                                     C_Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) const ;
