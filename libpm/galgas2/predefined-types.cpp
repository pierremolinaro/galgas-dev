...
//                    february 18th, 2012, at 11h29'17"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
/* GALGAS_range::GALGAS_range (const GALGAS_range & inSource) :
//mAttribute_location (inSource.mAttribute_location),
//mAttribute_length (inSource.mAttribute_length) {
} */
...
bool GALGAS_range::isValid (void) const {
  return mAttribute_location.isValid () && mAttribute_length.isValid () ;
}
...
GALGAS_uint GALGAS_range::reader_location (UNUSED_LOCATION_ARGS) const {
  return mAttribute_location ;
}
