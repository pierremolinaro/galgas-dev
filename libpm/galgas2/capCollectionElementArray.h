...
//--- Default constructor
  public : capCollectionElementArray (const int32_t inCapacity) ;
...
//--- Get object
    ...
    public : capCollectionElement objectAtIndex (const int32_t inIndex COMMA_LOCATION_ARGS) const ;
  #else
    public : inline capCollectionElement objectAtIndex (const int32_t inIndex) const {
      return mArray [inIndex] ;
    }
  #endif

//--- Get object pointer for writing (perform implicitly an "insulate" action)
  public : cCollectionElement * pointerAtIndex (const int32_t inIndex
                                                COMMA_LOCATION_ARGS) ;

//--- Get object pointer for reading
  public : const cCollectionElement * pointerAtIndexForReadAccess (const int32_t inIndex
