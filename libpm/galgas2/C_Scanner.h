//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//  'C_Scanner' : an abstract scanner class ;                                                                          *
...
#ifndef GALGAS_SCANNER_CLASS_DEFINED
#define GALGAS_SCANNER_CLASS_DEFINED
...
//--- Constructors and destructor
  ...
  public : virtual ~C_Scanner (void) ;

//--- No copy
  private : C_Scanner (const C_Scanner &) ;
  private : C_Scanner & operator = (const C_Scanner &) ;
