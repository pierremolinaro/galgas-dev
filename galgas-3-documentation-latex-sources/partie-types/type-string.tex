...
\item un chiffre décimal est inchangé ;
\item tout autre caractère est traduit en son point de code en hexadécimal, précédé par le caractère « - ».
\end{itemize}

Par exemple :
\begin{galgas}
let x = ["Z23" fileNameRepresentation] # "-5A23"
...
let y = ["Exemple" fileNameRepresentation] # "-45xemple"
\end{galgas}
